...
__terminate() _GLIBCXX_USE_NOEXCEPT {
  void terminate() _GLIBCXX_USE_NOEXCEPT
...
__attribute__((__always_inline__)) _GLIBCXX_CONSTEXPR inline bool
...
#if __DBL_MANT_DIG__ == 53 && __DBL_MIN_EXP__ == -1021 &&                      \
    __DBL_MAX_EXP__ == 1024
// Define if double has the IEEE binary64 format.
#define _GLIBCXX_DOUBLE_IS_IEEE_BINARY64 1
#elif __FLT_MANT_DIG__ == 24 && __FLT_MIN_EXP__ == -125 &&                     \
    __FLT_MAX_EXP__ == 128
