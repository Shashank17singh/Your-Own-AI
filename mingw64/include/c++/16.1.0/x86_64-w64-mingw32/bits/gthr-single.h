...
__GTHREAD_INLINE int __gthread_active_p(void) { return 0; }

__GTHREAD_INLINE int __gthread_once(__gthread_once_t *__once _GLIBCXX_UNUSED,
...
__gthread_setspecific(__gthread_key_t __key _GLIBCXX_UNUSED,
