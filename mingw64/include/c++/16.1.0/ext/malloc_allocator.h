...
public:
  ...
  _GLIBCXX20_CONSTEXPR
  malloc_allocator(const malloc_allocator<_Tp1> &) _GLIBCXX_USE_NOEXCEPT {}
  ...
  _GLIBCXX_NODISCARD _Tp *allocate(size_type __n, const void * = 0) {
#if __cplusplus >= 201103L
    // _GLIBCXX_RESOLVE_LIB_DEFECTS
...
#undef _GLIBCXX_CHECK_MALLOC_RESULT
  ...
  void construct(_Up *__p, _Args &&...__args) noexcept(
      std::__is_nothrow_new_constructible<_Up, _Args...>) {
  ...
  operator==(const malloc_allocator &,
