...
PB_DS_CLASS_C_DEC::split_prep(key_const_reference r_key,
...
PB_DS_CLASS_C_DEC::rec_split(node_pointer p_nd, a_const_iterator b_it,
                             a_const_iterator e_it, PB_DS_CLASS_C_DEC &other,
                             branch_bag &r_bag) {
