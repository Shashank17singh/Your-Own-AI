...
PB_DS_CLASS_C_DEC::common_prefix_len(node_iterator nd_it, e_const_iterator b_r,
...
PB_DS_CLASS_C_DEC::leftmost_it(node_iterator nd_it) {
...
PB_DS_CLASS_T_DEC
typename PB_DS_CLASS_C_DEC::iterator
PB_DS_CLASS_C_DEC::rightmost_it(node_iterator nd_it) {
