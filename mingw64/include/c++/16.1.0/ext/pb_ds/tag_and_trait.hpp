...
template <> struct container_traits_base<cc_hash_tag> {
...
template <> struct container_traits_base<gp_hash_tag> {
...
template <> struct container_traits_base<pat_trie_tag> {
...
template <> struct container_traits_base<list_update_tag> {
...
template <> struct container_traits_base<pairing_heap_tag> {
...
template <> struct container_traits_base<thin_heap_tag> {
...
template <> struct container_traits_base<binomial_heap_tag> {
...
template <> struct container_traits_base<rc_binomial_heap_tag> {
...
template <> struct container_traits_base<binary_heap_tag> {
