...
template <class _CharT, class _Alloc>
inline _Rope_iterator<_CharT, _Alloc>::_Rope_iterator(rope<_CharT, _Alloc> &__r,
                                                      std::size_t __pos)
...
template <class _CharT, class _Alloc>
inline void _Rope_RopeRep<_CharT, _Alloc>::_S_free_string(const _CharT *,
                                                          std::size_t,
                                                          allocator_type) {}
...
rope<_CharT, _Alloc>::_S_leaf_concat_char_iter(_RopeLeaf *__r,
                                               const _CharT *__iter,
                                               std::size_t __len) {
  ...
  __try {
    __result =
        _S_new_RopeLeaf(__new_data, __old_len + __len, __r->_M_get_allocator());
  }
  __catch(...) {
...
template <class _CharT, class _Alloc>
typename rope<_CharT, _Alloc>::_RopeLeaf *
rope<_CharT, _Alloc>::_S_destr_leaf_concat_char_iter(_RopeLeaf *__r,
                                                     const _CharT *__iter,
                                                     std::size_t __len) {
...
template <class _CharT, class _Alloc>
typename rope<_CharT, _Alloc>::_RopeRep *
rope<_CharT, _Alloc>::_S_destr_concat_char_iter(_RopeRep *__r,
                                                const _CharT *__s,
                                                std::size_t __slen,
                                                allocator_type &__a) {
  using std::size_t;
...
template <class _CharT, class _Alloc>
typename rope<_CharT, _Alloc>::_RopeRep *
rope<_CharT, _Alloc>::_S_substring(_RopeRep *__base, std::size_t __start,
                                   std::size_t __endp1) {
  using std::size_t;
  if (0 == __base)
    return 0;
  ...
  case __detail::_S_leaf: {
    ...
    __result =
        _S_new_RopeLeaf(__section, __result_len, __base->_M_get_allocator());
    ...
    // Avoid introducing multiple layers of substring nodes.
    {
      ...
      if (__result_len > __lazy_threshold) {
        _RopeSubstring *__result = _S_new_RopeSubstring(
            __old->_M_base, __start + __old->_M_start, __adj_endp1 - __start,
...
template <class _CharT, class _Alloc>
bool rope<_CharT, _Alloc>::_S_apply_to_pieces(_Rope_char_consumer<_CharT> &__c,
                                              const _RopeRep *__r,
                                              std::size_t __begin,
                                              std::size_t __end) {
  using std::size_t;
...
_CharT *rope<_CharT, _Alloc>::_S_flatten(_RopeRep *__r, std::size_t __start,
                                         std::size_t __len, _CharT *__buffer) {
...
template <class _CharT, class _Alloc>
std::size_t rope<_CharT, _Alloc>::find(_CharT __pattern,
                                       std::size_t __start) const {
