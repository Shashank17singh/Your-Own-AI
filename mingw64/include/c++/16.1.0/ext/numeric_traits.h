...
#define _GLIBCXX_INT_N_TRAITS(T, WIDTH)                                        \
  __extension__ template <> struct __is_integer_nonstrict<T> {                 \
    enum { __value = 1 };                                                      \
    typedef std::__true_type __type;                                           \
    enum { __width = WIDTH };                                                  \
  };                                                                           \
  __extension__ template <> struct __is_integer_nonstrict<unsigned T> {        \
    enum { __value = 1 };                                                      \
    typedef std::__true_type __type;                                           \
    enum { __width = WIDTH };                                                  \
  };
...
template <> struct __numeric_traits_floating<__ibm128> {
...
template <>
struct __numeric_traits<__ibm128> : public __numeric_traits_floating<__ibm128> {
};
#elif defined __LONG_DOUBLE_IBM128__
// long double is __ibm128, define traits for __ieee128
template <> struct __numeric_traits_floating<__ieee128> {
