...
inline float decimal32_to_float(decimal32 __d) { return (float)__d.__getval(); }

inline float decimal64_to_float(decimal64 __d) { return (float)__d.__getval(); }
...
inline float decimal_to_float(decimal128 __d) { return (float)__d.__getval(); }
