...
template <typename _Tp> constexpr auto __get_sve_value_type() {
...
template <typename _Tp, size_t _Np> struct __sve_vector_type;

template <typename _Tp, size_t _Np>
using __sve_vector_type_t = typename __sve_vector_type<_Tp, _Np>::type;

template <size_t _Np> struct __sve_vector_type<int8_t, _Np> {
  typedef svint8_t __sve_vlst_type
      __attribute__((arm_sve_vector_bits(__ARM_FEATURE_SVE_BITS)));

  inline static __sve_vlst_type __sve_broadcast(int8_t __dup) {
    return svdup_s8(__dup);
  }

  inline static __sve_bool_type __sve_active_mask() {
...
template <size_t _Np> struct __sve_vector_type<uint8_t, _Np> {
  typedef svuint8_t __sve_vlst_type
      __attribute__((arm_sve_vector_bits(__ARM_FEATURE_SVE_BITS)));

  inline static __sve_vlst_type __sve_broadcast(uint8_t __dup) {
...
template <size_t _Np> struct __sve_vector_type<int16_t, _Np> {
  typedef svint16_t __sve_vlst_type
      __attribute__((arm_sve_vector_bits(__ARM_FEATURE_SVE_BITS)));

  inline static __sve_vlst_type __sve_broadcast(int16_t __dup) {
...
template <size_t _Np> struct __sve_vector_type<uint16_t, _Np> {
  typedef svuint16_t __sve_vlst_type
      __attribute__((arm_sve_vector_bits(__ARM_FEATURE_SVE_BITS)));

  inline static __sve_vlst_type __sve_broadcast(uint16_t __dup) {
...
template <size_t _Np> struct __sve_vector_type<int32_t, _Np> {
  typedef svint32_t __sve_vlst_type
      __attribute__((arm_sve_vector_bits(__ARM_FEATURE_SVE_BITS)));

  inline static __sve_vlst_type __sve_broadcast(int32_t __dup) {
...
template <size_t _Np> struct __sve_vector_type<uint32_t, _Np> {
  typedef svuint32_t __sve_vlst_type
      __attribute__((arm_sve_vector_bits(__ARM_FEATURE_SVE_BITS)));

  inline static __sve_vlst_type __sve_broadcast(uint32_t __dup) {
...
template <size_t _Np> struct __sve_vector_type<int64_t, _Np> {
  typedef svint64_t __sve_vlst_type
      __attribute__((arm_sve_vector_bits(__ARM_FEATURE_SVE_BITS)));

  inline static __sve_vlst_type __sve_broadcast(int64_t __dup) {
...
template <size_t _Np> struct __sve_vector_type<uint64_t, _Np> {
  typedef svuint64_t __sve_vlst_type
      __attribute__((arm_sve_vector_bits(__ARM_FEATURE_SVE_BITS)));

  inline static __sve_vlst_type __sve_broadcast(uint64_t __dup) {
...
template <size_t _Np> struct __sve_vector_type<float, _Np> {
  typedef svfloat32_t __sve_vlst_type
      __attribute__((arm_sve_vector_bits(__ARM_FEATURE_SVE_BITS)));

  inline static __sve_vlst_type __sve_broadcast(float __dup) {
...
template <size_t _Np> struct __sve_vector_type<double, _Np> {
  typedef svfloat64_t __sve_vlst_type
      __attribute__((arm_sve_vector_bits(__ARM_FEATURE_SVE_BITS)));

  inline static __sve_vlst_type __sve_broadcast(double __dup) {
...
template <typename _Tp, size_t _Np>
struct __sve_vector_type : __sve_vector_type<__get_sve_value_type_t<_Tp>, _Np> {
};

template <size_t _Size> struct __sve_mask_type {
  static_assert((_Size & (_Size - 1)) != 0,
                "This trait may only be used for non-power-of-2 "
...
template <> struct __sve_mask_type<1> {
  ...
  inline static auto __sve_mask_active_count(type __active_mask, type __pred) {
    return svcntp_b8(__active_mask, __pred);
  }

  inline static type __sve_mask_first_true() { return svptrue_pat_b8(SV_VL1); }

  inline static type __sve_mask_next_true(type __active_mask, type __pred) {
    return svpnext_b8(__active_mask, __pred);
  }

  inline static bool __sve_mask_get(type __active_mask, size_t __i) {
...
template <> struct __sve_mask_type<2> {
  using type = __sve_bool_type;
  ...
  inline static type __sve_mask_first_true() { return svptrue_pat_b16(SV_VL1); }
...
template <> struct __sve_mask_type<4> {
  using type = __sve_bool_type;
  ...
  inline static type __sve_mask_first_true() { return svptrue_pat_b32(SV_VL1); }
...
template <> struct __sve_mask_type<8> {
  using type = __sve_bool_type;
  ...
  inline static type __sve_mask_first_true() { return svptrue_pat_b64(SV_VL1); }
...
_GLIBCXX_SIMD_INTRINSIC constexpr auto __sve_reinterpret_cast(_From __v) {
...
template <typename _Tp, size_t _Width> struct _SveSimdWrapper {
  ...
  _GLIBCXX_SIMD_INTRINSIC constexpr _SveSimdWrapper() = default;

  _GLIBCXX_SIMD_INTRINSIC constexpr _SveSimdWrapper(const _SveSimdWrapper &) =
      default;

  _GLIBCXX_SIMD_INTRINSIC constexpr _SveSimdWrapper(_SveSimdWrapper &&) =
      default;
  ...
  _GLIBCXX_SIMD_INTRINSIC constexpr _SveSimdWrapper(
      __sve_vector_type_t<_Tp, _Width> __x)
      : _M_data(__x) {}
...
template <size_t _Bits, size_t _Width> struct _SveMaskWrapper {
  ...
  _GLIBCXX_SIMD_INTRINSIC constexpr _SveMaskWrapper() = default;

  _GLIBCXX_SIMD_INTRINSIC constexpr _SveMaskWrapper(_BuiltinType __k)
      : _M_data(__k){};
  ...
  _GLIBCXX_SIMD_INTRINSIC constexpr void _M_set(size_t __i, value_type __x) {
    ...
    if (__x)
      _M_data =
          svorr_z(_BuiltinSveVectorType::__sve_active_mask(), _M_data, __index);
    else
      _M_data =
          svbic_z(_BuiltinSveVectorType::__sve_active_mask(), _M_data, __index);
  }
...
template <typename _Abi, typename = __detail::__odr_helper> struct _SimdImplSve;

template <typename _Abi, typename = __detail::__odr_helper> struct _MaskImplSve;

template <int _UsedBytes, int> struct simd_abi::_SveAbi {
  template <typename _Tp>
  ...
  template <typename _Tp> struct __traits<_Tp, true> {
    ...
    using _MaskMember =
        _SveMaskWrapper<sizeof(_Tp), _S_size<_Tp>>; // sve mask type
    ...
    struct _SimdBase {
      ...
      operator __sve_vector_type_t<_Tp, _S_size<_Tp>>() const {
        return __data(
            *static_cast<const simd<_Tp, _SveAbi<_UsedBytes>> *>(this));
      }
    };
    ...
    public:
      _GLIBCXX_SIMD_ALWAYS_INLINE constexpr _SimdCastType(_Ap __a)
          : _M_data(__a) {}

      _GLIBCXX_SIMD_ALWAYS_INLINE constexpr operator _SimdMember() const {
        return _M_data;
      }
    };
    ...
    struct _MaskBase {
      ...
      operator __sve_mask_type_t<sizeof(_Tp)>() const {
        return __data(
            *static_cast<const simd_mask<_Tp, _SveAbi<_UsedBytes>> *>(this));
      }
    };
    ...
    public:
      _GLIBCXX_SIMD_ALWAYS_INLINE constexpr _MaskCastType(_Ap __a)
          : _M_data(__a) {}

      _GLIBCXX_SIMD_ALWAYS_INLINE constexpr operator _MaskMember() const {
        return _M_data;
      }
    };
  };
...
struct _CommonImplSve {
  ...
  template <typename _Tp, size_t _Np>
  _GLIBCXX_SIMD_INTRINSIC static constexpr __sve_vector_type_t<_Tp, _Np>
  _S_blend(_SveMaskWrapper<sizeof(_Tp), _Np> __k,
           _SveSimdWrapper<_Tp, _Np> __at0, _SveSimdWrapper<_Tp, _Np> __at1) {
...
template <typename _Abi, typename> struct _SimdImplSve {
  template <typename _Tp>
  ...
  template <typename _Tp>
  _GLIBCXX_SIMD_INTRINSIC static constexpr auto _S_broadcast(_Tp __x) noexcept {
    return __sve_vector_type<_Tp, __sve_vectorized_size_bytes /
                                      sizeof(_Tp)>::__sve_broadcast(__x);
  }
  ...
  inline static constexpr _SimdMember<_Tp> _S_generator(_Fp &&__gen,
    ...
    __execute_n_times<_S_size<_Tp>>([&](auto __i)
  ...
  _S_masked_load(_SveSimdWrapper<_Tp, _Np> __merge, _MaskMember<_Tp> __k,
                 const _Up *__mem) noexcept {
    __sve_vector_type_t<_Tp, _Np> __v =
        _CommonImpl::template _S_load<_Tp, _Up, _Np>(__mem, __k);
    __sve_vector_type_t<_Tp, _Np> __ret =
        svsel(__k._M_data, __v, __merge._M_data);
    return __ret;
  }
  ...
  _S_reduce(simd<_Tp, _Abi> __x, _BinaryOperation &&__binary_op) {
    ...
    for (; (__i % 2) != 1; __i /= 2) {
      __x_data =
          __binary_op(simd<_Tp, _Abi>(__private_init,
                                      _SveSimdWrapper<_Tp, _Np>(__sve_vec_t(
                                          svuzp1(__x_data, __x_data)))),
                      simd<_Tp, _Abi>(__private_init,
                                      _SveSimdWrapper<_Tp, _Np>(__sve_vec_t(
                                          svuzp2(__x_data, __x_data)))))
              ._M_data;
    }
  ...
  _GLIBCXX_SIMD_INTRINSIC static constexpr _Tp _S_reduce(simd<_Tp, _Abi> __x,
                                                         plus<>) {
    return svaddv(__sve_vector_type<_Tp, _S_size<_Tp>>::__sve_active_mask(),
                  __x._M_data);
  }
  ...
  _GLIBCXX_SIMD_INTRINSIC static constexpr _Tp _S_reduce(simd<_Tp, _Abi> __x,
                                                         bit_and<>) {
    return svandv(__sve_vector_type<_Tp, _S_size<_Tp>>::__sve_active_mask(),
                  __x._M_data);
  }
  ...
  _GLIBCXX_SIMD_INTRINSIC static constexpr _Tp _S_reduce(simd<_Tp, _Abi> __x,
                                                         bit_xor<>) {
    return sveorv(__sve_vector_type<_Tp, _S_size<_Tp>>::__sve_active_mask(),
                  __x._M_data);
  }
  ...
  _GLIBCXX_SIMD_INTRINSIC static constexpr _Tp _S_reduce(simd<_Tp, _Abi> __x,
                                                         __detail::_Maximum()) {
    return svmaxv(__sve_vector_type<_Tp, _S_size<_Tp>>::__sve_active_mask(),
                  __x._M_data);
  }
  ...
  _GLIBCXX_SIMD_INTRINSIC static constexpr _Tp _S_reduce(simd<_Tp, _Abi> __x,
                                                         __detail::_Minimum()) {
    return svminv(__sve_vector_type<_Tp, _S_size<_Tp>>::__sve_active_mask(),
                  __x._M_data);
  }
  ...
  template <typename _Tp, size_t _Np>
  _GLIBCXX_SIMD_NORMAL_MATH
      _GLIBCXX_SIMD_INTRINSIC static constexpr pair<_SveSimdWrapper<_Tp, _Np>,
                                                    _SveSimdWrapper<_Tp, _Np>>
  ...
  _S_divides(_SveSimdWrapper<_Tp, _Np> __x, _SveSimdWrapper<_Tp, _Np> __y) {
    __sve_vector_type_t<_Tp, _Np> __y_padded =
        svsel(__sve_vector_type<_Tp, _Np>::__sve_active_mask(), __y._M_data,
              __sve_vector_type<_Tp, _Np>::__sve_broadcast(1));
  ...
  _S_bit_and(_SveSimdWrapper<_Tp, _Np> __x, _SveSimdWrapper<_Tp, _Np> __y) {
    if constexpr (is_floating_point_v<_Tp>) {
      using _Ip = __get_sve_value_type_t<__int_for_sizeof_t<_Tp>>;
      return __sve_reinterpret_cast<_Tp>(svand_x(
          __sve_vector_type<_Tp, _Np>::__sve_active_mask(),
  ...
  _S_bit_or(_SveSimdWrapper<_Tp, _Np> __x, _SveSimdWrapper<_Tp, _Np> __y) {
    if constexpr (is_floating_point_v<_Tp>) {
      using _Ip = __get_sve_value_type_t<__int_for_sizeof_t<_Tp>>;
      return __sve_reinterpret_cast<_Tp>(svorr_x(
          __sve_vector_type<_Tp, _Np>::__sve_active_mask(),
          __sve_reinterpret_cast<_Ip>(__x), __sve_reinterpret_cast<_Ip>(__y)));
    } else
  ...
  _S_bit_xor(_SveSimdWrapper<_Tp, _Np> __x, _SveSimdWrapper<_Tp, _Np> __y) {
    if constexpr (is_floating_point_v<_Tp>) {
      using _Ip = __get_sve_value_type_t<__int_for_sizeof_t<_Tp>>;
      return __sve_reinterpret_cast<_Tp>(sveor_x(
          __sve_vector_type<_Tp, _Np>::__sve_active_mask(),
          __sve_reinterpret_cast<_Ip>(__x), __sve_reinterpret_cast<_Ip>(__y)));
    } else
  ...
  template <typename _Tp, size_t _Np>
  _GLIBCXX_SIMD_INTRINSIC static constexpr _MaskMember<_Tp>
  _S_not_equal_to(_SveSimdWrapper<_Tp, _Np> __x,
                  _SveSimdWrapper<_Tp, _Np> __y) {
...
#define _GLIBCXX_SIMD_MATH_FALLBACK(__name)                                    \
  ...
  static _SveSimdWrapper<_Tp, _Np> _S_##__name(                                \
      const _SveSimdWrapper<_Tp, _Np> &__x, const _More &...__more) {          \
...
#define _GLIBCXX_SIMD_MATH_FALLBACK_FIXEDRET(_RetTp, __name)                   \
  ...
  _S_remquo(const _SveSimdWrapper<_Tp, _Np> __x,
            const _SveSimdWrapper<_Tp, _Np> __y,
...
#undef _GLIBCXX_SIMD_MATH_FALLBACK_FIXEDRET
  ...
  static constexpr _MaskMember<_Tp> __fp_cmp(_SveSimdWrapper<_Tp, _Np> __x,
                                             _SveSimdWrapper<_Tp, _Np> __y,
                                             _Op __op) {
    using _Ip = __get_sve_value_type_t<__int_for_sizeof_t<_Tp>>;
    ...
    const _WI __fmv =
        __sve_vector_type<_Ip, _Np>::__sve_broadcast(__finite_max_v<_Ip>);
    ...
    const _WI __xp = svsel(_S_less(__xn, __zerov),
                           _S_unary_minus(_WI(_S_bit_and(__xn, __fmv))), __xn);
    const _WI __yp = svsel(_S_less(__yn, __zerov),
  ...
  _S_isgreater(_SveSimdWrapper<_Tp, _Np> __x,
               _SveSimdWrapper<_Tp, _Np> __y) noexcept {
    return __fp_cmp(__x, __y,
                    [](auto __xp, auto __yp) { return _S_less(__yp, __xp); });
  }
  ...
  _S_isgreaterequal(_SveSimdWrapper<_Tp, _Np> __x,
                    _SveSimdWrapper<_Tp, _Np> __y) noexcept {
    return __fp_cmp(__x, __y, [](auto __xp, auto __yp) {
      return _S_less_equal(__yp, __xp);
    });
  }

  template <typename _Tp, size_t _Np>
  static constexpr _MaskMember<_Tp>
  _S_isless(_SveSimdWrapper<_Tp, _Np> __x,
            _SveSimdWrapper<_Tp, _Np> __y) noexcept {
    return __fp_cmp(__x, __y,
                    [](auto __xp, auto __yp) { return _S_less(__xp, __yp); });
  }

  template <typename _Tp, size_t _Np>
  static constexpr _MaskMember<_Tp>
  _S_islessequal(_SveSimdWrapper<_Tp, _Np> __x,
                 _SveSimdWrapper<_Tp, _Np> __y) noexcept {
    return __fp_cmp(__x, __y, [](auto __xp, auto __yp) {
      return _S_less_equal(__xp, __yp);
    });
  }

  template <typename _Tp, size_t _Np>
  static constexpr _MaskMember<_Tp>
  _S_islessgreater(_SveSimdWrapper<_Tp, _Np> __x,
                   _SveSimdWrapper<_Tp, _Np> __y) noexcept {
  ...
  template <typename _Tp, size_t _Np>
  _GLIBCXX_SIMD_INTRINSIC static _SveSimdWrapper<_Tp, _Np>
  _S_ldexp(_SveSimdWrapper<_Tp, _Np> __x,
           __fixed_size_storage_t<int, _Np> __y) noexcept {
  ...
  _S_isfinite([[maybe_unused]] _SveSimdWrapper<_Tp, _Np> __x) {
    ...
    const __sve_vector_type_t<_Ip, _Np> __maxn = __sve_reinterpret_cast<_Ip>(
  ...
  _GLIBCXX_SIMD_INTRINSIC static constexpr void _S_masked_cassign(
      const _SveMaskWrapper<_Bits, _Np> __k, _SveSimdWrapper<_Tp, _Np> &__lhs,
  ...
  template <template <typename> class _Op, typename _Tp, size_t _Bits,
            size_t _Np>
  _GLIBCXX_SIMD_INTRINSIC static constexpr _SveSimdWrapper<_Tp, _Np>
  _S_masked_unary(const _SveMaskWrapper<_Bits, _Np> __k,
                  const _SveSimdWrapper<_Tp, _Np> __v) {
...
template <typename _Abi, typename> struct _MaskImplSve {
  template <typename _Tp>
  using _MaskMember = typename _Abi::template _MaskMember<_Tp>;
  ...
  _S_load(const bool *__mem) {
    ...
    __sve_bool_type __u8_active_mask =
        __sve_vector_type<uint8_t, _Np>::__sve_active_mask();
    __sve_vector_type_t<uint8_t, _Np> __u8_vec_mask_load =
        svld1(__u8_active_mask, __p);
    __sve_bool_type __u8_mask =
        svcmpne(__u8_active_mask, __u8_vec_mask_load, 0);
  ...
  _S_convert(simd_mask<_Up, _UAbi> __x) {
    ...
    if constexpr (__is_sve_abi<_UAbi>()) {
      ...
      if constexpr (sizeof(_Up) < sizeof(_Tp)) {
        ...
        for (size_t __up_size = sizeof(_Up); __up_size != sizeof(_Tp);
             __up_size *= 2) {
          __r = svunpklo(__r);
        }
        return _R{__r};
        ...
        __execute_n_times<__min_size>([&](auto __i)
                                          _GLIBCXX_SIMD_ALWAYS_INLINE_LAMBDA {
  ...
  _S_logical_and(const _SveMaskWrapper<_Bits, _Np> &__x,
                 const _SveMaskWrapper<_Bits, _Np> &__y) {
    return svand_z(
        _SveMaskWrapper<_Bits, _Np>::_BuiltinSveVectorType::__sve_active_mask(),
        __x._M_data, __y._M_data);
  }

  template <size_t _Bits, size_t _Np>
  _GLIBCXX_SIMD_INTRINSIC static constexpr _SveMaskWrapper<_Bits, _Np>
  _S_logical_or(const _SveMaskWrapper<_Bits, _Np> &__x,
                const _SveMaskWrapper<_Bits, _Np> &__y) {
    return svorr_z(
        _SveMaskWrapper<_Bits, _Np>::_BuiltinSveVectorType::__sve_active_mask(),
        __x._M_data, __y._M_data);
  ...
  template <size_t _Bits, size_t _Np>
  _GLIBCXX_SIMD_INTRINSIC static constexpr _SveMaskWrapper<_Bits, _Np>
  _S_bit_and(const _SveMaskWrapper<_Bits, _Np> &__x,
             const _SveMaskWrapper<_Bits, _Np> &__y) {
    return svand_z(
        _SveMaskWrapper<_Bits, _Np>::_BuiltinSveVectorType::__sve_active_mask(),
        __x._M_data, __y._M_data);
  ...
  template <size_t _Bits, size_t _Np>
  _GLIBCXX_SIMD_INTRINSIC static constexpr _SveMaskWrapper<_Bits, _Np>
  _S_bit_or(const _SveMaskWrapper<_Bits, _Np> &__x,
            const _SveMaskWrapper<_Bits, _Np> &__y) {
    return svorr_z(
        _SveMaskWrapper<_Bits, _Np>::_BuiltinSveVectorType::__sve_active_mask(),
        __x._M_data, __y._M_data);
  ...
  template <size_t _Bits, size_t _Np>
  _GLIBCXX_SIMD_INTRINSIC static constexpr _SveMaskWrapper<_Bits, _Np>
  _S_bit_xor(const _SveMaskWrapper<_Bits, _Np> &__x,
             const _SveMaskWrapper<_Bits, _Np> &__y) {
    return sveor_z(
        _SveMaskWrapper<_Bits, _Np>::_BuiltinSveVectorType::__sve_active_mask(),
        __x._M_data, __y._M_data);
  ...
  template <size_t _Bits, size_t _Np>
  static constexpr void _S_set(_SveMaskWrapper<_Bits, _Np> &__k, int __i,
                               bool __x) noexcept {
    auto __index = svcmpeq(
        _SveMaskWrapper<_Bits, _Np>::_BuiltinSveVectorType::__sve_active_mask(),
        __sve_mask_type<_Bits>::__index0123,
        typename __sve_mask_type<_Bits>::__sve_mask_uint_type(__i));
    if (__x)
      __k._M_data = svorr_z(
          _SveMaskWrapper<_Bits,
  ...
  _GLIBCXX_SIMD_INTRINSIC static void
  _S_masked_assign(_SveMaskWrapper<_Bits, _Np> __k,
                   _SveMaskWrapper<_Bits, _Np> &__lhs, bool __rhs) {
    __lhs._M_data =
        svsel(__k._M_data, _S_broadcast<__int_with_sizeof_t<_Bits>>(__rhs),
              __lhs._M_data);
  }
  ...
  _GLIBCXX_SIMD_INTRINSIC static bool _S_any_of(simd_mask<_Tp, _Abi> __k) {
    return svptest_any(
        __sve_vector_type<_Tp, simd_size_v<_Tp, _Abi>>::__sve_active_mask(),
        __k._M_data);
  }
  ...
  _S_find_first_set(simd_mask<_Tp, _Abi> __k) {
    return svclastb(svpfirst(__k._M_data, svpfalse()), -1,
                    __sve_mask_type<sizeof(_Tp)>::__index0123);
  }
