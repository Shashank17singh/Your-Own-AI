...
__mismatch_switch(_RAIter1 __begin1, _RAIter1 __end1, _RAIter2 __begin2,
...
inline bool __equal_switch(_RAIter1 __begin1, _RAIter1 __end1,
  ...
  if (_GLIBCXX_PARALLEL_CONDITION(true)) {
    ...
    return __gnu_parallel::mismatch(__begin1, __end1, __begin2, __end2, __pred)
               .first == __end1;
  } else
    return _GLIBCXX_STD_A::equal(__begin1, __end1, __begin2, __end2, __pred);
}
...
lexicographical_compare(_IIter1 __begin1, _IIter1 __end1, _IIter2 __begin2,
                        _IIter2 __end2) {
#if __cplusplus > 201703L
  if (std::is_constant_evaluated())
    return _GLIBCXX_STD_A::lexicographical_compare(__begin1, __end1, __begin2,
...
_RAIter1 __search_switch(_RAIter1 __begin1, _RAIter1 __end1, _RAIter2 __begin2,
                         _RAIter2 __end2, _BinaryPredicate __pred,
                         random_access_iterator_tag,
                         random_access_iterator_tag) {
...
// Public interface
template <typename _FIterator1, typename _FIterator2, typename _BinaryPredicate>
_GLIBCXX20_CONSTEXPR inline _FIterator1
search(_FIterator1 __begin1, _FIterator1 __end1, _FIterator2 __begin2,
