...
private:
  ...
  template <typename _DiffType> struct _DiffTraits<_DiffType, void> {
...
_GLIBCXX_CONSTEXPR inline bool __check_singular(_Tp *const &__ptr) {
  return __ptr == 0;
}
...
template <typename _Integral>
inline bool __valid_range_aux(_Integral, _Integral, std::__true_type) {
  return true;
}
...
_GLIBCXX_CONSTEXPR inline bool __valid_range_aux(_InputIterator __first,
  ...
  return __first == __last || (!__gnu_debug::__check_singular(__first) &&
...
__valid_range(_InputIterator __first, _InputIterator __last,
  ...
  return __gnu_debug::__valid_range_aux(__first, __last, __dist, _Integral());
}
#endif
...
template <typename _Iterator, typename _Sequence, typename _Category,
          typename _Size>
_GLIBCXX20_CONSTEXPR bool
__can_advance(const _Safe_iterator<_Iterator, _Sequence, _Category> &, _Size);

template <typename _InputIterator, typename _Diff>
_GLIBCXX_CONSTEXPR inline bool
__can_advance(_InputIterator, const std::pair<_Diff, _Distance_precision> &,
              int) {
  return true;
}
...
template <typename _Iterator>
_GLIBCXX_CONSTEXPR inline _Iterator __unsafe(_Iterator __it) {
  return __it;
}
} // namespace __gnu_debug
