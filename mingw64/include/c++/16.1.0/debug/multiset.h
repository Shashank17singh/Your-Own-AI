...
class multiset
    : public __gnu_debug::_Safe_container<multiset<_Key, _Compare, _Allocator>,
                                          _Allocator,
...
public:
  ...
  multiset(std::from_range_t __t, _Rg &&__rg, const _Compare &__c,
           const allocator_type &__a = allocator_type())
  ...
  multiset(_Base_ref __x) : _Base(__x._M_ref) {}
...
#ifdef __glibcxx_associative_heterogeneous_erasure
  template <__heterogeneous_tree_key<multiset> _Kt> size_type erase(_Kt &&__x) {
...
multiset(_InputIterator, _InputIterator, _Compare = _Compare(),
    ...
    -> multiset<typename iterator_traits<_InputIterator>::value_type, _Compare,
                _Allocator>;
