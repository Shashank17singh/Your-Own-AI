...
public:
  ...
  multimap(std::from_range_t __t, _Rg &&__rg, const _Compare &__c,
           const allocator_type &__a = allocator_type())
  ...
  multimap(_Base_ref __x) : _Base(__x._M_ref) {}
...
#ifdef __glibcxx_associative_heterogeneous_erasure
  template <__heterogeneous_tree_key<multimap> _Kt> size_type erase(_Kt &&__x) {
...
multimap(from_range_t, _Rg &&, _Compare = _Compare(), _Alloc = _Alloc())
    -> multimap<__detail::__range_key_type<_Rg>,
                __detail::__range_mapped_type<_Rg>, _Compare, _Alloc>;
