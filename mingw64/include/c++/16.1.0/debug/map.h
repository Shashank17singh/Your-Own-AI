...
class map
    : public __gnu_debug::_Safe_container<map<_Key, _Tp, _Compare, _Allocator>,
                                          _Allocator,
...
public:
  ...
  map(map &&__m, const __type_identity_t<allocator_type> &__a) noexcept(
      noexcept(_Base(std::move(__m), __a)))
      : _Safe(std::move(__m), __a), _Base(std::move(__m), __a) {}
  ...
  map(std::from_range_t __t, _Rg &&__rg, const _Compare &__c,
      const allocator_type &__a = allocator_type())
  ...
  map(_Base_ref __x) : _Base(__x._M_ref) {}
  ...
  map(_InputIterator __first, _InputIterator __last,
      const _Compare &__comp = _Compare(), const _Allocator &__a = _Allocator())
      : _Base(__gnu_debug::__base(
                  __glibcxx_check_valid_constructor_range(__first, __last)),
  ...
  // iterators:
  iterator begin() _GLIBCXX_NOEXCEPT { return iterator(_Base::begin(), this); }
  ...
  iterator try_emplace(const_iterator __hint, const key_type &__k,
    ...
    auto __it =
        _Base::try_emplace(__hint.base(), __k, std::forward<_Args>(__args)...);
    return {__it, this};
  }
  ...
  iterator try_emplace(const_iterator __hint, _Kt &&__k, _Args &&...__args) {
    __glibcxx_check_insert(__hint);
    auto __it = _Base::try_emplace(__hint.base(), std::forward<_Kt>(__k),
                                   std::forward<_Args>(__args)...);
    return {__it, this};
  }
#endif
  ...
  std::pair<iterator, bool> insert_or_assign(_Kt &&__k, _Obj &&__obj) {
    auto __res = _Base::insert_or_assign(std::forward<_Kt>(__k),
  ...
  iterator insert_or_assign(const_iterator __hint, const key_type &__k,
    ...
    __glibcxx_check_insert(__hint);
    auto __it =
        _Base::insert_or_assign(__hint.base(), __k, std::forward<_Obj>(__obj));
    return {__it, this};
  }
  ...
  iterator insert_or_assign(const_iterator __hint, _Kt &&__k, _Obj &&__obj) {
    __glibcxx_check_insert(__hint);
    auto __it = _Base::insert_or_assign(__hint.base(), std::forward<_Kt>(__k),
                                        std::forward<_Obj>(__obj));
    return {__it, this};
  }
#endif
  ...
  template <__heterogeneous_tree_key<map> _Kt> node_type extract(_Kt &&__key) {
    const auto __position = find(__key);
    if (__position != end())
      return extract(__position);
    return {};
  ...
  // of the key.
  template <__heterogeneous_tree_key<map> _Kt> size_type erase(_Kt &&__x) {
...
map(_InputIterator, _InputIterator, _Compare = _Compare(),
    ...
    -> map<__iter_key_t<_InputIterator>, __iter_val_t<_InputIterator>, _Compare,
           _Allocator>;
...
map(from_range_t, _Rg &&, _Compare = _Compare(), _Alloc = _Alloc())
    -> map<__detail::__range_key_type<_Rg>, __detail::__range_mapped_type<_Rg>,
           _Compare, _Alloc>;

template <ranges::input_range _Rg, __allocator_like _Alloc>
map(from_range_t, _Rg &&, _Alloc)
    -> map<__detail::__range_key_type<_Rg>, __detail::__range_mapped_type<_Rg>,
           less<__detail::__range_key_type<_Rg>>, _Alloc>;
#endif
