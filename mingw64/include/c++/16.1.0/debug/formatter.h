...
int __glibcxx_backtrace_full(struct __glibcxx_backtrace_state *, int,
...
template <typename _Iterator, typename _UContainer> class _Safe_local_iterator;
...
public:
  ...
  _GLIBCXX_NORETURN __attribute__((__cold__)) void _M_error() const;
