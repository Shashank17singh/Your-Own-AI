...
private:
  ...
  void _M_attach_single(_Safe_sequence_base *__seq, bool __constant) noexcept;
  /***************************************************************/
#endif
};
...
protected:
  ...
  _Safe_unordered_container_base(
      const _Safe_unordered_container_base &) noexcept
      : _Safe_unordered_container_base() {}
...
private:
  ...
  void _M_attach_local(_Safe_iterator_base *__it, bool __constant) const;
  ...
  void _M_detach_local(_Safe_iterator_base *__it) const;

  /** Likewise but not thread safe. */
  void _M_detach_local_single(_Safe_iterator_base *__it) const noexcept;
};

inline const _Safe_unordered_container_base *
_Safe_local_iterator_base::_M_safe_container() const noexcept {
