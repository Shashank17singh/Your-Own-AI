...
class _Safe_local_iterator : private _Iterator,
  ...
  using _IsConstant =
      std::__are_same<typename _UContainer::_Base::const_local_iterator,
                      _Iterator>;

  using _OtherIterator =
      std::__conditional_t<_IsConstant::__value,
...
public:
  ...
  std::__conditional_t<_IsConstant::__value, const _UContainer *, _UContainer *>
  ...
  bool _M_in_same_bucket(
      const _Safe_local_iterator<_Other, _UContainer> &__other) const {
