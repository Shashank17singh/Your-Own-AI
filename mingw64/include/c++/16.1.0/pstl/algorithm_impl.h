...
bool __brick_any_of(const _RandomAccessIterator __first,
                    const _RandomAccessIterator __last, _Pred __pred,
...
template <class _Tag, class _ExecutionPolicy, class _ForwardIterator,
          class _Pred>
bool __pattern_any_of(_Tag, _ExecutionPolicy &&, _ForwardIterator __first,
                      _ForwardIterator __last, _Pred __pred) noexcept {
  return __internal::__brick_any_of(__first, __last, __pred,
...
bool __pattern_any_of(__parallel_tag<_IsVector> __tag,
  ...
  return __internal::__except_handler([&]() {
    return __internal::__parallel_or(
        __backend_tag{}, std::forward<_ExecutionPolicy>(__exec), __first,
        __last, [__pred](_RandomAccessIterator __i, _RandomAccessIterator __j) {
...
template <class _Tag, class _ExecutionPolicy, class _ForwardIterator,
          class _Function>
void __pattern_walk1(_Tag, _ExecutionPolicy &&, _ForwardIterator __first,
...
template <class _IsVector, class _ExecutionPolicy, class _RandomAccessIterator,
          class _Function>
void __pattern_walk1(__parallel_tag<_IsVector> __tag, _ExecutionPolicy &&__exec,
  ...
  __internal::__except_handler([&]() {
    __par_backend::__parallel_for(
        __backend_tag{}, std::forward<_ExecutionPolicy>(__exec), __first,
        __last, [__f](_RandomAccessIterator __i, _RandomAccessIterator __j) {
...
template <class _Tag, class _ExecutionPolicy, class _ForwardIterator,
          class _Brick>
void __pattern_walk_brick(_Tag, _ExecutionPolicy &&, _ForwardIterator __first,
                          _ForwardIterator __last, _Brick __brick) noexcept {
  __brick(__first, __last);
}

template <class _IsVector, class _ExecutionPolicy, class _RandomAccessIterator,
          class _Brick>
void __pattern_walk_brick(__parallel_tag<_IsVector> __tag,
...
template <class _Tag, class _ExecutionPolicy, class _ForwardIterator,
          class _Size, class _Function>
_ForwardIterator __pattern_walk1_n(_Tag, _ExecutionPolicy &&,
                                   _ForwardIterator __first, _Size __n,
                                   _Function __f) noexcept {
  return __internal::__brick_walk1_n(__first, __n, __f,
                                     typename _Tag::__is_vector{});
}
...
__pattern_walk1_n(__parallel_tag<_IsVector> __tag, _ExecutionPolicy &&__exec,
                  _RandomAccessIterator __first, _Size __n, _Function __f) {
  __internal::__pattern_walk1(__tag, std::forward<_ExecutionPolicy>(__exec),
...
template <class _Tag, class _ExecutionPolicy, class _ForwardIterator,
          class _Size, class _Brick>
_ForwardIterator __pattern_walk_brick_n(_Tag, _ExecutionPolicy &&,
                                        _ForwardIterator __first, _Size __n,
...
template <class _IsVector, class _ExecutionPolicy, class _RandomAccessIterator,
          class _Size, class _Brick>
_RandomAccessIterator __pattern_walk_brick_n(__parallel_tag<_IsVector> __tag,
                                             _ExecutionPolicy &&__exec,
                                             _RandomAccessIterator __first,
...
__brick_walk2(_RandomAccessIterator1 __first1, _RandomAccessIterator1 __last1,
              _RandomAccessIterator2 __first2, _Function __f,
              /*vector=*/std::true_type) noexcept {
...
template <class _RandomAccessIterator1, class _Size,
          class _RandomAccessIterator2, class _Function>
_RandomAccessIterator2
__brick_walk2_n(_RandomAccessIterator1 __first1, _Size __n,
                _RandomAccessIterator2 __first2, _Function __f,
                /*vector=*/std::true_type) noexcept {
  return __unseq_backend::__simd_walk_2(__first1, __n, __first2, __f);
}

template <class _Tag, class _ExecutionPolicy, class _ForwardIterator1,
          class _ForwardIterator2, class _Function>
_ForwardIterator2
__pattern_walk2(_Tag, _ExecutionPolicy &&, _ForwardIterator1 __first1,
...
template <class _IsVector, class _ExecutionPolicy, class _RandomAccessIterator1,
          class _RandomAccessIterator2, class _Function>
_RandomAccessIterator2
__pattern_walk2(__parallel_tag<_IsVector> __tag, _ExecutionPolicy &&__exec,
  ...
  return __internal::__except_handler([&]() {
    __par_backend::__parallel_for(
        __backend_tag{}, std::forward<_ExecutionPolicy>(__exec), __first1,
        __last1,
        [__f, __first1, __first2](_RandomAccessIterator1 __i,
...
template <class _Tag, class _ExecutionPolicy, class _ForwardIterator1,
          class _Size, class _ForwardIterator2, class _Function>
_ForwardIterator2 __pattern_walk2_n(_Tag, _ExecutionPolicy &&,
...
template <class _IsVector, class _ExecutionPolicy, class _RandomAccessIterator1,
          class _Size, class _RandomAccessIterator2, class _Function>
_RandomAccessIterator2
__pattern_walk2_n(__parallel_tag<_IsVector> __tag, _ExecutionPolicy &&__exec,
                  _RandomAccessIterator1 __first1, _Size __n,
                  _RandomAccessIterator2 __first2, _Function __f) {
  return __internal::__pattern_walk2(__tag,
...
_ForwardIterator2
__pattern_walk2_brick(_Tag, _ExecutionPolicy &&, _ForwardIterator1 __first1,
                      _ForwardIterator1 __last1, _ForwardIterator2 __first2,
                      _Brick __brick) noexcept {
...
_RandomAccessIterator2 __pattern_walk2_brick(__parallel_tag<_IsVector> __tag,
                                             _ExecutionPolicy &&__exec,
...
template <class _Tag, class _ExecutionPolicy, class _ForwardIterator1,
          class _Size, class _ForwardIterator2, class _Brick>
_ForwardIterator2 __pattern_walk2_brick_n(_Tag, _ExecutionPolicy &&,
                                          _ForwardIterator1 __first1, _Size __n,
                                          _ForwardIterator2 __first2,
                                          _Brick __brick) noexcept {
...
template <class _IsVector, class _ExecutionPolicy, class _RandomAccessIterator1,
          class _Size, class _RandomAccessIterator2, class _Brick>
_RandomAccessIterator2
__pattern_walk2_brick_n(__parallel_tag<_IsVector> __tag,
                        _ExecutionPolicy &&__exec,
                        _RandomAccessIterator1 __first1, _Size __n,
...
__brick_walk3(_RandomAccessIterator1 __first1, _RandomAccessIterator1 __last1,
              ...
              _Function __f, /*vector=*/std::true_type) noexcept {
...
_ForwardIterator3
__pattern_walk3(_Tag, _ExecutionPolicy &&, _ForwardIterator1 __first1,
                _ForwardIterator1 __last1, _ForwardIterator2 __first2,
                _ForwardIterator3 __first3, _Function __f) noexcept {
...
template <class _IsVector, class _ExecutionPolicy, class _RandomAccessIterator1,
          ...
          class _Function>
_RandomAccessIterator3
__pattern_walk3(__parallel_tag<_IsVector> __tag, _ExecutionPolicy &&__exec,
                _RandomAccessIterator1 __first1, _RandomAccessIterator1 __last1,
                _RandomAccessIterator2 __first2,
  ...
  return __internal::__except_handler([&]() {
    __par_backend::__parallel_for(
        __backend_tag{}, std::forward<_ExecutionPolicy>(__exec), __first1,
        __last1,
        [__f, __first1, __first2, __first3](_RandomAccessIterator1 __i,
                                            _RandomAccessIterator1 __j) {
...
bool __pattern_equal(_Tag, _ExecutionPolicy &&, _ForwardIterator1 __first1,
                     _ForwardIterator1 __last1, _ForwardIterator2 __first2,
...
bool __pattern_equal(__parallel_tag<_IsVector> __tag, _ExecutionPolicy &&__exec,
                     _RandomAccessIterator1 __first1,
                     _RandomAccessIterator1 __last1,
                     _RandomAccessIterator2 __first2,
                     _RandomAccessIterator2 __last2, _BinaryPredicate __p) {
  ...
  return __internal::__except_handler([&]() {
    return !__internal::__parallel_or(
        __backend_tag{}, std::forward<_ExecutionPolicy>(__exec), __first1,
        __last1,
        [__first1, __first2, __p](_RandomAccessIterator1 __i,
                                  _RandomAccessIterator1 __j) {
  ...
  return __internal::__except_handler([&]() {
    return !__internal::__parallel_or(
        ...
        [__first1, __first2, __p](_RandomAccessIterator1 __i,
                                  _RandomAccessIterator1 __j) {
          return !__internal::__brick_equal(
              __i, __j, __first2 + (__i - __first1), __p, _IsVector{});
        });
  });
}
...
template <class _Tag, class _ExecutionPolicy, class _ForwardIterator,
          class _Predicate>
_ForwardIterator
__pattern_find_if(_Tag __tag, _ExecutionPolicy &&, _ForwardIterator __first,
                  _ForwardIterator __last, _Predicate __pred) noexcept {
  return __internal::__brick_find_if(__first, __last, __pred,
                                     typename _Tag::__is_vector{});
}
...
template <class _RandomAccessIterator1, class _RandomAccessIterator2,
          class _BinaryPredicate>
_RandomAccessIterator1
__brick_find_end(_RandomAccessIterator1 __first, _RandomAccessIterator1 __last,
                 _RandomAccessIterator2 __s_first,
                 _RandomAccessIterator2 __s_last, _BinaryPredicate __pred,
                 /*__is_vector=*/std::true_type) noexcept {
...
template <class _Tag, class _ExecutionPolicy, class _ForwardIterator1,
          class _ForwardIterator2, class _BinaryPredicate>
_ForwardIterator1
__pattern_find_end(_Tag, _ExecutionPolicy &&, _ForwardIterator1 __first,
  ...
  return __internal::__brick_find_end(__first, __last, __s_first, __s_last,
                                      __pred, typename _Tag::__is_vector{});
}

template <class _IsVector, class _ExecutionPolicy, class _RandomAccessIterator1,
          class _RandomAccessIterator2, class _BinaryPredicate>
_RandomAccessIterator1 __pattern_find_end(__parallel_tag<_IsVector> __tag,
                                          _ExecutionPolicy &&__exec,
  ...
  if (__last - __first == __s_last - __s_first) {
    ...
    return __internal::__except_handler([&]() {
      return __internal::__parallel_find(
          __backend_tag{}, std::forward<_ExecutionPolicy>(__exec), __first,
          __last,
          [__last, __s_first, __s_last, __pred](_RandomAccessIterator1 __i,
                                                _RandomAccessIterator1 __j) {
...
_RandomAccessIterator1 __brick_find_first_of(
    ...
    _RandomAccessIterator2 __s_first, _RandomAccessIterator2 __s_last,
...
template <class _Tag, class _ExecutionPolicy, class _ForwardIterator1,
          class _ForwardIterator2, class _BinaryPredicate>
_ForwardIterator1
__pattern_find_first_of(_Tag, _ExecutionPolicy &&, _ForwardIterator1 __first,
                        _ForwardIterator1 __last, _ForwardIterator2 __s_first,
                        _ForwardIterator2 __s_last,
                        _BinaryPredicate __pred) noexcept {
...
_RandomAccessIterator1 __pattern_find_first_of(
  ...
  return __internal::__except_handler([&]() {
    return __internal::__parallel_find(
        __backend_tag{}, std::forward<_ExecutionPolicy>(__exec), __first,
        __last,
        [__s_first, __s_last, __pred](_RandomAccessIterator1 __i,
                                      _RandomAccessIterator1 __j) {
          return __internal::__brick_find_first_of(
              __i, __j, __s_first, __s_last, __pred, _IsVector{});
        },
        std::less<typename std::iterator_traits<
            _RandomAccessIterator1>::difference_type>(),
        /*is_first=*/true);
...
template <class _RandomAccessIterator1, class _RandomAccessIterator2,
          class _BinaryPredicate>
_RandomAccessIterator1
__brick_search(_RandomAccessIterator1 __first, _RandomAccessIterator1 __last,
               _RandomAccessIterator2 __s_first,
               _RandomAccessIterator2 __s_last, _BinaryPredicate __pred,
               /*vector=*/std::false_type) noexcept {
...
template <class _Tag, class _ExecutionPolicy, class _ForwardIterator1,
          class _ForwardIterator2, class _BinaryPredicate>
_ForwardIterator1
__pattern_search(_Tag, _ExecutionPolicy &&, _ForwardIterator1 __first,
                 _ForwardIterator1 __last, _ForwardIterator2 __s_first,
...
template <class _IsVector, class _ExecutionPolicy, class _RandomAccessIterator1,
          class _RandomAccessIterator2, class _BinaryPredicate>
_RandomAccessIterator1
__pattern_search(__parallel_tag<_IsVector> __tag, _ExecutionPolicy &&__exec,
                 _RandomAccessIterator1 __first, _RandomAccessIterator1 __last,
                 _RandomAccessIterator2 __s_first,
                 _RandomAccessIterator2 __s_last,
                 _BinaryPredicate __pred) noexcept {
...
template <class _RandomAccessIterator, class _Size, class _Tp,
          class _BinaryPredicate>
_RandomAccessIterator
__brick_search_n(_RandomAccessIterator __first, _RandomAccessIterator __last,
...
template <class _Tag, class _ExecutionPolicy, class _ForwardIterator,
          class _Size, class _Tp, class _BinaryPredicate>
_ForwardIterator
__pattern_search_n(_Tag, _ExecutionPolicy &&, _ForwardIterator __first,
...
template <class _IsVector, class _ExecutionPolicy, class _RandomAccessIterator,
          class _Size, class _Tp, class _BinaryPredicate>
_RandomAccessIterator
__pattern_search_n(__parallel_tag<_IsVector> __tag, _ExecutionPolicy &&__exec,
                   _RandomAccessIterator __first, _RandomAccessIterator __last,
...
_RandomAccessIterator2 __brick_copy_n(_RandomAccessIterator1 __first, _Size __n,
...
template <class _RandomAccessIterator1, class _RandomAccessIterator2>
_RandomAccessIterator2 __brick_copy(_RandomAccessIterator1 __first,
                                    _RandomAccessIterator1 __last,
                                    _RandomAccessIterator2 __result,
                                    /*vector=*/std::true_type) noexcept {
  return __unseq_backend::__simd_assign(
...
template <class _RandomAccessIterator1, class _RandomAccessIterator2>
_RandomAccessIterator2 __brick_move(_RandomAccessIterator1 __first,
                                    _RandomAccessIterator1 __last,
                                    _RandomAccessIterator2 __result,
                                    /*vector=*/std::true_type) noexcept {
  return __unseq_backend::__simd_assign(
...
struct __brick_move_destroy {
  ...
  _RandomAccessIterator2 operator()(_RandomAccessIterator1 __first,
    ...
    using _IteratorValueType =
        typename std::iterator_traits<_RandomAccessIterator1>::value_type;
...
template <class _RandomAccessIterator1, class _RandomAccessIterator2>
_RandomAccessIterator2 __brick_swap_ranges(_RandomAccessIterator1 __first,
                                           _RandomAccessIterator1 __last,
                                           _RandomAccessIterator2 __result,
                                           /*vector=*/std::true_type) noexcept {
  using std::iter_swap;
...
_RandomAccessIterator2
__brick_copy_if(_RandomAccessIterator1 __first, _RandomAccessIterator1 __last,
                _RandomAccessIterator2 __result, _UnaryPredicate __pred,
                /*vector=*/std::true_type) noexcept {
...
void __brick_copy_by_mask(_RandomAccessIterator1 __first,
                          _RandomAccessIterator1 __last,
                          _RandomAccessIterator2 __result,
                          bool *__restrict __mask, _Assigner __assigner,
                          /*vector=*/std::true_type) noexcept {
#if defined(_PSTL_MONOTONIC_PRESENT)
...
void __brick_partition_by_mask(_RandomAccessIterator1 __first,
                               ...
                               _RandomAccessIterator3 __out_false, bool *__mask,
                               /*vector=*/std::true_type) noexcept {
#if defined(_PSTL_MONOTONIC_PRESENT)
...
template <class _Tag, class _ExecutionPolicy, class _ForwardIterator,
          class _OutputIterator, class _UnaryPredicate>
_OutputIterator
__pattern_copy_if(_Tag, _ExecutionPolicy &&, _ForwardIterator __first,
...
_RandomAccessIterator2
__pattern_copy_if(__parallel_tag<_IsVector> __tag, _ExecutionPolicy &&__exec,
                  _RandomAccessIterator1 __first, _RandomAccessIterator1 __last,
                  _RandomAccessIterator2 __result, _UnaryPredicate __pred) {
  using __backend_tag = typename decltype(__tag)::__backend_tag;
          ...
          __par_backend::__parallel_strict_scan(
              ...
              [=](_DifferenceType __i, _DifferenceType __len,
                ...
                __internal::__brick_copy_by_mask(
                    ...
                    [](_RandomAccessIterator1 __x, _RandomAccessIterator2 __z) {
                      *__z = *__x;
                    },
                    _IsVector{});
              },
...
__brick_count(_RandomAccessIterator __first, _RandomAccessIterator __last,
              _Predicate __pred,
              /* is_vector = */ std::true_type) noexcept {
...
template <class _Tag, class _ExecutionPolicy, class _ForwardIterator,
          class _Predicate>
typename std::iterator_traits<_ForwardIterator>::difference_type
__pattern_count(_Tag, _ExecutionPolicy &&, _ForwardIterator __first,
                _ForwardIterator __last, _Predicate __pred) noexcept {
  return __internal::__brick_count(__first, __last, __pred,
                                   typename _Tag::__is_vector{});
}
...
template <class _IsVector, class _ExecutionPolicy, class _RandomAccessIterator,
          class _Predicate>
typename std::iterator_traits<_RandomAccessIterator>::difference_type
__pattern_count(__parallel_tag<_IsVector> __tag, _ExecutionPolicy &&__exec,
                _RandomAccessIterator __first, _RandomAccessIterator __last,
                _Predicate __pred) {
  using __backend_tag = typename decltype(__tag)::__backend_tag;
  ...
  return __internal::__except_handler([&]() {
    return __par_backend::__parallel_reduce(
        __backend_tag{}, std::forward<_ExecutionPolicy>(__exec), __first,
        __last, _SizeType(0),
        [__pred](_RandomAccessIterator __begin, _RandomAccessIterator __end,
                 _SizeType __value) -> _SizeType {
          return __value +
                 __internal::__brick_count(__begin, __end, __pred, _IsVector{});
        },
        std::plus<_SizeType>());
  });
}
...
_RandomAccessIterator __brick_unique(_RandomAccessIterator __first,
                                     _RandomAccessIterator __last,
                                     _BinaryPredicate __pred,
                                     /*is_vector=*/std::false_type) noexcept {
...
template <class _Tag, class _ExecutionPolicy, class _ForwardIterator,
          class _BinaryPredicate>
_ForwardIterator
__pattern_unique(_Tag, _ExecutionPolicy &&, _ForwardIterator __first,
                 _ForwardIterator __last, _BinaryPredicate __pred) noexcept {
  return __internal::__brick_unique(__first, __last, __pred,
                                    typename _Tag::__is_vector{});
}
...
template <class _IsVector, class _ExecutionPolicy, class _ForwardIterator,
          class _CalcMask>
_ForwardIterator
__remove_elements(__parallel_tag<_IsVector> __tag, _ExecutionPolicy &&__exec,
  ...
  return __internal::__except_handler([&]() {
    ...
    _DifferenceType __min = __par_backend::__parallel_reduce(
        ...
        _DifferenceType(0), __n, __n,
        [__first, __mask,
         &__calc_mask](_DifferenceType __i, _DifferenceType __j,
    ...
    __par_backend::__parallel_strict_scan(
        ...
        [__mask](_DifferenceType __i, _DifferenceType __len) {
          return __internal::__brick_count(
              ...
              [](bool __val) { return __val; }, _IsVector{});
        },
    ...
    __par_backend::__parallel_for(
        __backend_tag{}, std::forward<_ExecutionPolicy>(__exec), __result,
...
template <class _IsVector, class _ExecutionPolicy, class _RandomAccessIterator,
          class _BinaryPredicate>
_RandomAccessIterator
__pattern_unique(__parallel_tag<_IsVector> __tag, _ExecutionPolicy &&__exec,
                 _RandomAccessIterator __first, _RandomAccessIterator __last,
                 _BinaryPredicate __pred) noexcept {
  typedef typename std::iterator_traits<_RandomAccessIterator>::reference
      _ReferenceType;
...
template <class _RandomAccessIterator1, class _RandomAccessIterator2,
          class _BinaryPredicate>
_RandomAccessIterator2 __brick_unique_copy(_RandomAccessIterator1 __first,
                                           _RandomAccessIterator1 __last,
                                           _RandomAccessIterator2 __result,
                                           _BinaryPredicate __pred,
                                           /*vector=*/std::true_type) noexcept {
...
_OutputIterator
__pattern_unique_copy(_Tag, _ExecutionPolicy &&, _ForwardIterator __first,
                      _ForwardIterator __last, _OutputIterator __result,
                      _BinaryPredicate __pred) noexcept {
...
template <class _IsVector, class _ExecutionPolicy, class _RandomAccessIterator1,
          class _RandomAccessIterator2, class _BinaryPredicate>
_RandomAccessIterator2 __pattern_unique_copy(__parallel_tag<_IsVector> __tag,
                                             _ExecutionPolicy &&__exec,
                                             _RandomAccessIterator1 __first,
                                             _RandomAccessIterator1 __last,
                                             _RandomAccessIterator2 __result,
            ...
            __par_backend::__parallel_strict_scan(
                ...
                [=](_DifferenceType __i, _DifferenceType __len,
                  ...
                  __internal::__brick_copy_by_mask(
                      __first + __i, __first + (__i + __len),
                      __result + __initial, __mask + __i,
                      [](_RandomAccessIterator1 __x,
                         _RandomAccessIterator2 __z) { *__z = *__x; },
                      _IsVector{});
                },
                [&__m](_DifferenceType __total) { __m = __total; });
            return __result + __m;
...
void __brick_reverse(_RandomAccessIterator __first,
  ...
  __unseq_backend::__simd_walk_2(
      __first, __n, std::reverse_iterator<_RandomAccessIterator>(__last),
...
void __pattern_reverse(_Tag, _ExecutionPolicy &&,
                       _BidirectionalIterator __first,
                       _BidirectionalIterator __last) noexcept {
...
void __pattern_reverse(__parallel_tag<_IsVector> __tag,
  ...
  __par_backend::__parallel_for(
      ...
      [__first, __last](_RandomAccessIterator __inner_first,
                        _RandomAccessIterator __inner_last) {
...
template <class _RandomAccessIterator1, class _RandomAccessIterator2>
_RandomAccessIterator2
__brick_reverse_copy(_RandomAccessIterator1 __first,
                     _RandomAccessIterator1 __last,
                     _RandomAccessIterator2 __d_first,
                     /*is_vector=*/std::true_type) noexcept {
  typedef typename std::iterator_traits<_RandomAccessIterator1>::reference
      _ReferenceType1;
  typedef typename std::iterator_traits<_RandomAccessIterator2>::reference
      _ReferenceType2;

  return __unseq_backend::__simd_walk_2(
      std::reverse_iterator<_RandomAccessIterator1>(__last), __last - __first,
      __d_first, [](_ReferenceType1 __x, _ReferenceType2 __y) { __y = __x; });
}

template <class _Tag, class _ExecutionPolicy, class _BidirectionalIterator,
          class _OutputIterator>
_OutputIterator __pattern_reverse_copy(_Tag, _ExecutionPolicy &&,
                                       _BidirectionalIterator __first,
                                       _BidirectionalIterator __last,
...
_RandomAccessIterator2 __pattern_reverse_copy(
  ...
  __par_backend::__parallel_for(
      ...
      [__first, __len, __d_first](_RandomAccessIterator1 __inner_first,
...
template <class _RandomAccessIterator>
_RandomAccessIterator __brick_rotate(_RandomAccessIterator __first,
...
template <class _Tag, class _ExecutionPolicy, class _ForwardIterator>
_ForwardIterator
__pattern_rotate(_Tag, _ExecutionPolicy &&, _ForwardIterator __first,
                 _ForwardIterator __middle, _ForwardIterator __last) noexcept {
  return __internal::__brick_rotate(__first, __middle, __last,
                                    typename _Tag::__is_vector{});
}

template <class _IsVector, class _ExecutionPolicy, class _RandomAccessIterator>
_RandomAccessIterator
__pattern_rotate(__parallel_tag<_IsVector> __tag, _ExecutionPolicy &&__exec,
  ...
  if (__m <= __n / 2) {
    ...
    return __internal::__except_handler(
        [&__exec, __n, __m, __first, __middle, __last, &__buf]() {
          _Tp *__result = __buf.get();
          __par_backend::__parallel_for(
              __backend_tag{}, std::forward<_ExecutionPolicy>(__exec), __middle,
              __last,
              [__middle, __result](_RandomAccessIterator __b,
                                   _RandomAccessIterator __e) {
          ...
          __par_backend::__parallel_for(
              __backend_tag{}, std::forward<_ExecutionPolicy>(__exec), __first,
              __middle,
              [__last, __middle](_RandomAccessIterator __b,
                                 _RandomAccessIterator __e) {
    ...
    return __internal::__except_handler([&__exec, __n, __m, __first, __middle,
      ...
      __par_backend::__parallel_for(
          __backend_tag{}, std::forward<_ExecutionPolicy>(__exec), __first,
          __middle,
          [__first, __result](_RandomAccessIterator __b,
                              _RandomAccessIterator __e) {
            __internal::__brick_uninitialized_move(
      ...
      __par_backend::__parallel_for(
          __backend_tag{}, std::forward<_ExecutionPolicy>(__exec), __middle,
          __last,
          [__first, __middle](_RandomAccessIterator __b,
                              _RandomAccessIterator __e) {
...
_RandomAccessIterator2 __brick_rotate_copy(
    _RandomAccessIterator1 __first, _RandomAccessIterator1 __middle,
...
template <class _Tag, class _ExecutionPolicy, class _ForwardIterator,
          class _OutputIterator>
_OutputIterator
__pattern_rotate_copy(_Tag, _ExecutionPolicy &&, _ForwardIterator __first,
...
template <class _IsVector, class _ExecutionPolicy, class _RandomAccessIterator1,
          class _RandomAccessIterator2>
_RandomAccessIterator2 __pattern_rotate_copy(__parallel_tag<_IsVector> __tag,
                                             _ExecutionPolicy &&__exec,
                                             _RandomAccessIterator1 __first,
  ...
  __par_backend::__parallel_for(
      __backend_tag{}, std::forward<_ExecutionPolicy>(__exec), __first, __last,
      [__first, __last, __middle, __result](_RandomAccessIterator1 __b,
                                            _RandomAccessIterator1 __e) {
        if (__b > __middle) {
          __internal::__brick_copy(__b, __e, __result + (__b - __middle),
                                   _IsVector{});
        } else {
          _RandomAccessIterator2 __new_result =
...
template <class _Tag, class _ExecutionPolicy, class _ForwardIterator,
          class _UnaryPredicate>
bool __pattern_is_partitioned(_Tag, _ExecutionPolicy &&,
                              _ForwardIterator __first, _ForwardIterator __last,
                              _UnaryPredicate __pred) noexcept {
...
template <class _IsVector, class _ExecutionPolicy, class _RandomAccessIterator,
          class _UnaryPredicate>
bool __pattern_is_partitioned(__parallel_tag<_IsVector> __tag,
                              _ExecutionPolicy &&__exec,
                              _RandomAccessIterator __first,
                              _RandomAccessIterator __last,
                              _UnaryPredicate __pred) {
  if (__first == __last) {
    ...
    return __internal::__except_handler([&]() {
      ...
      __init = __par_backend::__parallel_reduce(
          __backend_tag{}, std::forward<_ExecutionPolicy>(__exec), __first,
          __last, __init,
          [&__pred, &__table](_RandomAccessIterator __i,
                              _RandomAccessIterator __j,
            ...
            if (__pred(*__i)) {
              ...
              _RandomAccessIterator __x = __internal::__brick_find_if(
                  __i + 1, __j, std::not_fn(__pred), _IsVector{});
              if (__x != __j) {
                // find first element after "x" that satisfy pred
                _RandomAccessIterator __y = __internal::__brick_find_if(
                    __x + 1, __j, __pred, _IsVector{});
...
template <class _RandomAccessIterator, class _UnaryPredicate>
_RandomAccessIterator __brick_partition(_RandomAccessIterator __first,
                                        _RandomAccessIterator __last,
                                        _UnaryPredicate __pred,
                                        /*is_vector=*/std::true_type) noexcept {
  _PSTL_PRAGMA_MESSAGE(
...
template <class _Tag, class _ExecutionPolicy, class _ForwardIterator,
          class _UnaryPredicate>
_ForwardIterator
__pattern_partition(_Tag, _ExecutionPolicy &&, _ForwardIterator __first,
                    _ForwardIterator __last, _UnaryPredicate __pred) noexcept {
  return __internal::__brick_partition(__first, __last, __pred,
                                       typename _Tag::__is_vector{});
}
...
template <class _IsVector, class _ExecutionPolicy, class _RandomAccessIterator,
          class _UnaryPredicate>
_RandomAccessIterator
__pattern_partition(__parallel_tag<_IsVector> __tag, _ExecutionPolicy &&__exec,
                    _RandomAccessIterator __first, _RandomAccessIterator __last,
                    _UnaryPredicate __pred) {
  using __backend_tag = typename decltype(__tag)::__backend_tag;
  ...
  return __internal::__except_handler([&]() {
    ...
    auto __reductor = [&__exec](_PartitionRange __val1,
      ...
      // part of right range
        ...
        __par_backend::__parallel_for(
            ...
            [__val1, __val2, __size1](_RandomAccessIterator __i,
                                      _RandomAccessIterator __j) {
      ...
      // part of right range
        ...
        __par_backend::__parallel_for(
            ...
            [__val1, __val2](_RandomAccessIterator __i,
                             _RandomAccessIterator __j) {
              __internal::__brick_swap_ranges(
    ...
    _PartitionRange __result = __par_backend::__parallel_reduce(
        __backend_tag{}, std::forward<_ExecutionPolicy>(__exec), __first,
        __last, __init,
        [__pred, __reductor](_RandomAccessIterator __i,
                             _RandomAccessIterator __j,
                             _PartitionRange __value) -> _PartitionRange {
          // 1. serial partition
          _RandomAccessIterator __pivot =
              __internal::__brick_partition(__i, __j, __pred, _IsVector{});
...
__brick_stable_partition(_BidirectionalIterator __first,
...
template <class _RandomAccessIterator, class _UnaryPredicate>
_RandomAccessIterator
__brick_stable_partition(_RandomAccessIterator __first,
...
_BidirectionalIterator __pattern_stable_partition(
    _Tag, _ExecutionPolicy &&, _BidirectionalIterator __first,
    _BidirectionalIterator __last, _UnaryPredicate __pred) noexcept {
...
_RandomAccessIterator __pattern_stable_partition(
  ...
  return __internal::__except_handler([&]() {
    ...
    // lambda for merging two partitioned ranges to one partitioned range
    auto __reductor = [](_PartitionRange __val1,
                         _PartitionRange __val2) -> _PartitionRange {
      auto __size1 = __val1.__end - __val1.__pivot;
      auto __new_begin = __val2.__begin - (__val1.__end - __val1.__begin);
    ...
    _PartitionRange __result = __par_backend::__parallel_reduce(
        ...
        [&__pred, __reductor](_RandomAccessIterator __i,
          ...
          _RandomAccessIterator __pivot = __internal::__brick_stable_partition(
              __i, __j, __pred, _IsVector{});
...
std::pair<_OutputIterator1, _OutputIterator2>
__pattern_partition_copy(_Tag, _ExecutionPolicy &&, _ForwardIterator __first,
...
template <class _IsVector, class _ExecutionPolicy, class _RandomAccessIterator1,
          ...
          class _UnaryPredicate>
std::pair<_RandomAccessIterator2, _RandomAccessIterator3>
__pattern_partition_copy(__parallel_tag<_IsVector> __tag,
                         _ExecutionPolicy &&__exec,
                         _RandomAccessIterator1 __first,
                         _RandomAccessIterator1 __last,
                         _RandomAccessIterator2 __out_true,
...
template <class _Tag, class _ExecutionPolicy, class _RandomAccessIterator,
          class _Compare, class _IsMoveConstructible>
void __pattern_sort(_Tag, _ExecutionPolicy &&, _RandomAccessIterator __first,
...
template <class _IsVector, class _ExecutionPolicy, class _RandomAccessIterator,
          class _Compare>
void __pattern_sort(__parallel_tag<_IsVector> __tag, _ExecutionPolicy &&__exec,
                    _RandomAccessIterator __first, _RandomAccessIterator __last,
...
template <class _Tag, class _ExecutionPolicy, class _RandomAccessIterator,
          class _Compare>
void __pattern_stable_sort(_Tag, _ExecutionPolicy &&,
                           _RandomAccessIterator __first,
                           _RandomAccessIterator __last,
...
template <class _IsVector, class _ExecutionPolicy, class _RandomAccessIterator,
          class _Compare>
void __pattern_stable_sort(__parallel_tag<_IsVector> __tag,
                           _ExecutionPolicy &&__exec,
                           _RandomAccessIterator __first,
                           _RandomAccessIterator __last, _Compare __comp) {
  using __backend_tag = typename decltype(__tag)::__backend_tag;
...
template <class _Tag, class _ExecutionPolicy, class _RandomAccessIterator,
          class _Compare>
void __pattern_partial_sort(_Tag, _ExecutionPolicy &&,
                            _RandomAccessIterator __first,
                            _RandomAccessIterator __middle,
                            _RandomAccessIterator __last,
                            _Compare __comp) noexcept {
...
template <class _IsVector, class _ExecutionPolicy, class _RandomAccessIterator,
          class _Compare>
void __pattern_partial_sort(__parallel_tag<_IsVector> __tag,
                            _ExecutionPolicy &&__exec,
                            _RandomAccessIterator __first,
                            _RandomAccessIterator __middle,
                            _RandomAccessIterator __last, _Compare __comp) {
...
_RandomAccessIterator __pattern_partial_sort_copy(
    _Tag, _ExecutionPolicy &&, _ForwardIterator __first,
    _ForwardIterator __last, _RandomAccessIterator __d_first,
    _RandomAccessIterator __d_last, _Compare __comp) noexcept {
  return std::partial_sort_copy(__first, __last, __d_first, __d_last, __comp);
}

template <class _IsVector, class _ExecutionPolicy, class _RandomAccessIterator1,
          class _RandomAccessIterator2, class _Compare>
_RandomAccessIterator2 __pattern_partial_sort_copy(
    __parallel_tag<_IsVector> __tag, _ExecutionPolicy &&__exec,
    _RandomAccessIterator1 __first, _RandomAccessIterator1 __last,
    _RandomAccessIterator2 __d_first, _RandomAccessIterator2 __d_last,
    _Compare __comp) {
  using __backend_tag = typename decltype(__tag)::__backend_tag;
  ...
  return __internal::__except_handler([&]() {
    if (__n2 >= __n1) {
      __par_backend::__parallel_stable_sort(
          __backend_tag{}, std::forward<_ExecutionPolicy>(__exec), __d_first,
          __d_first + __n1, __comp,
          [__first, __d_first](_RandomAccessIterator2 __i,
                               _RandomAccessIterator2 __j, _Compare __comp) {
      ...
      typedef
          typename std::iterator_traits<_RandomAccessIterator1>::value_type _T1;
      typedef
          typename std::iterator_traits<_RandomAccessIterator2>::value_type _T2;
      __par_backend::__buffer<_T1> __buf(__n1);
      _T1 *__r = __buf.get();

      __par_backend::__parallel_stable_sort(
          __backend_tag{}, std::forward<_ExecutionPolicy>(__exec), __r,
          __r + __n1, __comp,
      ...
      __par_backend::__parallel_for(
          __backend_tag{}, std::forward<_ExecutionPolicy>(__exec), __r,
          __r + __n2, [__r, __d_first](_T1 *__i, _T1 *__j) {
            __brick_move_destroy()(__i, __j, __d_first + (__i - __r),
                                   _IsVector{});
          });
      __par_backend::__parallel_for(
          __backend_tag{}, std::forward<_ExecutionPolicy>(__exec), __r + __n2,
          __r + __n1,
...
//------------------------------------------------------------------------
template <class _RandomAccessIterator, class _BinaryPredicate>
_RandomAccessIterator __brick_adjacent_find(_RandomAccessIterator __first,
                                            _RandomAccessIterator __last,
                                            _BinaryPredicate __pred,
...
template <class _Tag, class _ExecutionPolicy, class _ForwardIterator,
          class _BinaryPredicate>
_ForwardIterator
__pattern_adjacent_find(_Tag, _ExecutionPolicy &&, _ForwardIterator __first,
                        _ForwardIterator __last, _BinaryPredicate __pred,
                        bool __or_semantic) noexcept {
  return __internal::__brick_adjacent_find(
      __first, __last, __pred, typename _Tag::__is_vector{}, __or_semantic);
}

template <class _IsVector, class _ExecutionPolicy, class _RandomAccessIterator,
          class _BinaryPredicate>
_RandomAccessIterator __pattern_adjacent_find(__parallel_tag<_IsVector> __tag,
                                              _ExecutionPolicy &&__exec,
                                              _RandomAccessIterator __first,
                                              _RandomAccessIterator __last,
                                              _BinaryPredicate __pred,
...
template <class _Tag, class _ExecutionPolicy, class _RandomAccessIterator,
          class _Compare>
void __pattern_nth_element(_Tag, _ExecutionPolicy &&,
                           _RandomAccessIterator __first,
...
template <class _IsVector, class _ExecutionPolicy, class _RandomAccessIterator,
          class _Compare>
void __pattern_nth_element(__parallel_tag<_IsVector> __tag,
                           _ExecutionPolicy &&__exec,
                           _RandomAccessIterator __first,
                           _RandomAccessIterator __nth,
                           _RandomAccessIterator __last,
...
void __brick_fill(_RandomAccessIterator __first, _RandomAccessIterator __last,
                  const _Tp &__value,
                  /* __is_vector = */ std::true_type) noexcept {
...
void __pattern_fill(_Tag, _ExecutionPolicy &&, _ForwardIterator __first,
                    _ForwardIterator __last, const _Tp &__value) noexcept {
  __internal::__brick_fill(__first, __last, __value,
                           typename _Tag::__is_vector{});
}
...
template <class _IsVector, class _ExecutionPolicy, class _RandomAccessIterator,
          class _Tp>
_RandomAccessIterator
__pattern_fill(__parallel_tag<_IsVector> __tag, _ExecutionPolicy &&__exec,
               _RandomAccessIterator __first, _RandomAccessIterator __last,
               const _Tp &__value) {
  using __backend_tag = typename decltype(__tag)::__backend_tag;
...
template <class _Tag, class _ExecutionPolicy, class _OutputIterator,
          class _Size, class _Tp>
_OutputIterator __pattern_fill_n(_Tag, _ExecutionPolicy &&,
                                 _OutputIterator __first, _Size __count,
                                 const _Tp &__value) noexcept {
  return __internal::__brick_fill_n(__first, __count, __value,
                                    typename _Tag::__is_vector{});
}

template <class _IsVector, class _ExecutionPolicy, class _RandomAccessIterator,
          class _Size, class _Tp>
_RandomAccessIterator __pattern_fill_n(__parallel_tag<_IsVector> __tag,
                                       _ExecutionPolicy &&__exec,
                                       _RandomAccessIterator __first,
                                       _Size __count, const _Tp &__value) {
  return __internal::__pattern_fill(__tag,
                                    std::forward<_ExecutionPolicy>(__exec),
...
template <class _Tag, class _ExecutionPolicy, class _ForwardIterator,
          class _Generator>
void __pattern_generate(_Tag, _ExecutionPolicy &&, _ForwardIterator __first,
                        _ForwardIterator __last, _Generator __g) noexcept {
  __internal::__brick_generate(__first, __last, __g,
                               typename _Tag::__is_vector{});
}
...
template <class _IsVector, class _ExecutionPolicy, class _RandomAccessIterator,
          class _Generator>
_RandomAccessIterator
__pattern_generate(__parallel_tag<_IsVector> __tag, _ExecutionPolicy &&__exec,
                   _RandomAccessIterator __first, _RandomAccessIterator __last,
                   _Generator __g) {
  using __backend_tag = typename decltype(__tag)::__backend_tag;
...
template <class _Tag, class _ExecutionPolicy, class _OutputIterator,
          class _Size, class _Generator>
_OutputIterator __pattern_generate_n(_Tag, _ExecutionPolicy &&,
                                     _OutputIterator __first, _Size __count,
                                     _Generator __g) noexcept {
  return __internal::__brick_generate_n(__first, __count, __g,
                                        typename _Tag::__is_vector{});
}

template <class _IsVector, class _ExecutionPolicy, class _RandomAccessIterator,
          class _Size, class _Generator>
_RandomAccessIterator __pattern_generate_n(__parallel_tag<_IsVector> __tag,
                                           _ExecutionPolicy &&__exec,
                                           _RandomAccessIterator __first,
                                           _Size __count, _Generator __g) {
  static_assert(__are_random_access_iterators<_RandomAccessIterator>::value,
                "Pattern-brick error. Should be a random access iterator.");
  return __internal::__pattern_generate(__tag,
                                        std::forward<_ExecutionPolicy>(__exec),
...
template <class _Tag, class _ExecutionPolicy, class _ForwardIterator,
          class _UnaryPredicate>
_ForwardIterator
__pattern_remove_if(_Tag, _ExecutionPolicy &&, _ForwardIterator __first,
                    _ForwardIterator __last, _UnaryPredicate __pred) noexcept {
  return __internal::__brick_remove_if(__first, __last, __pred,
                                       typename _Tag::__is_vector{});
}
...
template <class _IsVector, class _ExecutionPolicy, class _RandomAccessIterator,
          class _UnaryPredicate>
_RandomAccessIterator
__pattern_remove_if(__parallel_tag<_IsVector> __tag, _ExecutionPolicy &&__exec,
                    _RandomAccessIterator __first, _RandomAccessIterator __last,
                    _UnaryPredicate __pred) noexcept {
  typedef typename std::iterator_traits<_RandomAccessIterator>::reference
      _ReferenceType;
...
_RandomAccessIterator3
__brick_merge(_RandomAccessIterator1 __first1, _RandomAccessIterator1 __last1,
...
_OutputIterator
__pattern_merge(_Tag, _ExecutionPolicy &&, _ForwardIterator1 __first1,
                _ForwardIterator1 __last1, _ForwardIterator2 __first2,
...
template <class _IsVector, class _ExecutionPolicy, class _RandomAccessIterator1,
          ...
          class _Compare>
_RandomAccessIterator3
__pattern_merge(__parallel_tag<_IsVector> __tag, _ExecutionPolicy &&__exec,
                _RandomAccessIterator1 __first1, _RandomAccessIterator1 __last1,
                _RandomAccessIterator2 __first2, _RandomAccessIterator2 __last2,
                _RandomAccessIterator3 __d_first, _Compare __comp) {
  using __backend_tag = typename decltype(__tag)::__backend_tag;
  ...
  __par_backend::__parallel_merge(
      ...
      [](_RandomAccessIterator1 __f1, _RandomAccessIterator1 __l1,
         _RandomAccessIterator2 __f2, _RandomAccessIterator2 __l2,
         _RandomAccessIterator3 __f3, _Compare __comp) {
...
void __brick_inplace_merge(_RandomAccessIterator __first,
                           _RandomAccessIterator __middle,
                           _RandomAccessIterator __last, _Compare __comp,
                           /* __is_vector = */ std::true_type) noexcept {
  _PSTL_PRAGMA_MESSAGE(
...
template <class _Tag, class _ExecutionPolicy, class _BidirectionalIterator,
          class _Compare>
void __pattern_inplace_merge(_Tag, _ExecutionPolicy &&,
                             _BidirectionalIterator __first,
                             _BidirectionalIterator __middle,
                             _BidirectionalIterator __last,
                             _Compare __comp) noexcept {
...
template <class _IsVector, class _ExecutionPolicy, class _RandomAccessIterator,
          class _Compare>
void __pattern_inplace_merge(__parallel_tag<_IsVector> __tag,
                             _ExecutionPolicy &&__exec,
                             _RandomAccessIterator __first,
                             _RandomAccessIterator __middle,
                             _RandomAccessIterator __last, _Compare __comp) {
  ...
  __internal::__except_handler([&]() {
    ...
    auto __move_sequences = [](_RandomAccessIterator __first1,
                               _RandomAccessIterator __last1, _Tp *__first2) {
    ...
    __par_backend::__parallel_merge(
        __backend_tag{}, std::forward<_ExecutionPolicy>(__exec), __first,
        __middle, __middle, __last, __r, __comp,
        [__n, __move_values, __move_sequences](
            _RandomAccessIterator __f1, _RandomAccessIterator __l1,
...
bool __pattern_includes(_Tag, _ExecutionPolicy &&, _ForwardIterator1 __first1,
                        _ForwardIterator1 __last1, _ForwardIterator2 __first2,
                        _ForwardIterator2 __last2, _Compare __comp) noexcept {
  return std::includes(__first1, __last1, __first2, __last2, __comp);
}

template <class _IsVector, class _ExecutionPolicy, class _RandomAccessIterator1,
          class _RandomAccessIterator2, class _Compare>
bool __pattern_includes(__parallel_tag<_IsVector> __tag,
                        _ExecutionPolicy &&__exec,
                        _RandomAccessIterator1 __first1,
                        _RandomAccessIterator1 __last1,
                        _RandomAccessIterator2 __first2,
                        _RandomAccessIterator2 __last2, _Compare __comp) {
  using __backend_tag = typename decltype(__tag)::__backend_tag;
  ...
  return __internal::__except_handler([&]() {
    return !__internal::__parallel_or(
        __backend_tag{}, std::forward<_ExecutionPolicy>(__exec), __first2,
        __last2,
        [__first1, __last1, __first2, __last2,
         &__comp](_RandomAccessIterator2 __i, _RandomAccessIterator2 __j) {
          _PSTL_ASSERT(__j > __i);
          //_PSTL_ASSERT(__j - __i > 1);

          // 1. moving boundaries to "consume" subsequence of equal elements
          auto __is_equal = [&__comp](_RandomAccessIterator2 __a,
...
template <class _IsVector, class _ExecutionPolicy, class _ForwardIterator1,
          class _ForwardIterator2, class _OutputIterator, class _Compare,
...
__parallel_set_op(__parallel_tag<_IsVector> __tag, _ExecutionPolicy &&__exec,
  ...
  return __internal::__except_handler([&__exec, __n1, __first1, __last1,
    ...
    __par_backend::__parallel_strict_scan(
        __backend_tag{}, std::forward<_ExecutionPolicy>(__exec), __n1,
        _SetRange{0, 0, 0},                               //-1, 0},
        [=](_DifferenceType __i, _DifferenceType __len) { // Reduce
...
template <class _Tag, class _ExecutionPolicy, class _ForwardIterator1,
          ...
          class _SetUnionOp>
_OutputIterator
__parallel_set_union_op(_Tag __tag, _ExecutionPolicy &&__exec,
                        _ForwardIterator1 __first1, _ForwardIterator1 __last1,
                        _ForwardIterator2 __first2, _ForwardIterator2 __last2,
                        _OutputIterator __result, _Compare __comp,
  ...
  auto copy_range1 = [](_ForwardIterator1 __begin, _ForwardIterator1 __end,
                        _OutputIterator __res) {
    return __internal::__brick_copy(__begin, __end, __res,
                                    typename _Tag::__is_vector{});
  };
  auto copy_range2 = [](_ForwardIterator2 __begin, _ForwardIterator2 __end,
                        _OutputIterator __res) {
    return __internal::__brick_copy(__begin, __end, __res,
                                    typename _Tag::__is_vector{});
  };
    ...
    __par_backend::__parallel_invoke(
        ...
        [=, &__result] {
          __result = __internal::__parallel_set_op(
              __tag, std::forward<_ExecutionPolicy>(__exec), __left_bound_seq_1,
  ...
  if (__m2 > __set_algo_cut_off) {
    ...
    __par_backend::__parallel_invoke(
        ...
        [=] {
          __internal::__pattern_walk2_brick(
              __tag, std::forward<_ExecutionPolicy>(__exec), __first2,
...
template <class _RandomAccessIterator1, class _RandomAccessIterator2,
          class _OutputIterator, class _Compare>
_OutputIterator __brick_set_union(_RandomAccessIterator1 __first1,
                                  _RandomAccessIterator1 __last1,
                                  _RandomAccessIterator2 __first2,
...
template <class _Tag, class _ExecutionPolicy, class _ForwardIterator1,
          class _ForwardIterator2, class _OutputIterator, class _Compare>
_OutputIterator
__pattern_set_union(_Tag, _ExecutionPolicy &&, _ForwardIterator1 __first1,
                    _ForwardIterator1 __last1, _ForwardIterator2 __first2,
...
_OutputIterator __pattern_set_union(__parallel_tag<_IsVector> __tag,
                                    _ExecutionPolicy &&__exec,
                                    _RandomAccessIterator1 __first1,
                                    _RandomAccessIterator1 __last1,
                                    _RandomAccessIterator2 __first2,
...
template <class _Tag, class _ExecutionPolicy, class _ForwardIterator1,
          class _ForwardIterator2, class _OutputIterator, class _Compare>
_OutputIterator __pattern_set_intersection(_Tag, _ExecutionPolicy &&,
                                           ...
                                           _OutputIterator __result,
                                           _Compare __comp) noexcept {
  return __internal::__brick_set_intersection(__first1, __last1, __first2,
...
template <class _Tag, class _ExecutionPolicy, class _ForwardIterator1,
          class _ForwardIterator2, class _OutputIterator, class _Compare>
_OutputIterator
__pattern_set_difference(_Tag, _ExecutionPolicy &&, _ForwardIterator1 __first1,
                         _ForwardIterator1 __last1, _ForwardIterator2 __first2,
                         _ForwardIterator2 __last2, _OutputIterator __result,
                         _Compare __comp) noexcept {
  return __internal::__brick_set_difference(__first1, __last1, __first2,
                                            __last2, __result, __comp,
                                            typename _Tag::__is_vector{});
}
...
_RandomAccessIterator3 __pattern_set_difference(
  ...
  if (__n2 == 0)
    return __internal::__pattern_walk2_brick(
        __tag, std::forward<_ExecutionPolicy>(__exec), __first1, __last1,
        __result,
        [](_RandomAccessIterator1 __begin, _RandomAccessIterator1 __end,
           _RandomAccessIterator3 __res) {
...
template <class _Tag, class _ExecutionPolicy, class _ForwardIterator1,
          class _ForwardIterator2, class _OutputIterator, class _Compare>
_OutputIterator __pattern_set_symmetric_difference(_Tag, _ExecutionPolicy &&,
                                                   _ForwardIterator1 __first1,
                                                   _ForwardIterator1 __last1,
                                                   _ForwardIterator2 __first2,
                                                   _ForwardIterator2 __last2,
...
template <class _RandomAccessIterator, class _Compare>
_RandomAccessIterator
__brick_is_heap_until(_RandomAccessIterator __first,
                      _RandomAccessIterator __last, _Compare __comp,
                      /* __is_vector = */ std::false_type) noexcept {
...
template <class _Tag, class _ExecutionPolicy, class _RandomAccessIterator,
          class _Compare>
_RandomAccessIterator __pattern_is_heap_until(_Tag, _ExecutionPolicy &&,
                                              _RandomAccessIterator __first,
                                              _RandomAccessIterator __last,
                                              _Compare __comp) noexcept {
...
template <class _IsVector, class _ExecutionPolicy, class _RandomAccessIterator,
          class _Compare>
_RandomAccessIterator __pattern_is_heap_until(__parallel_tag<_IsVector> __tag,
                                              _ExecutionPolicy &&__exec,
                                              _RandomAccessIterator __first,
                                              _RandomAccessIterator __last,
                                              _Compare __comp) noexcept {
  ...
  return __internal::__except_handler([&]() {
    return __parallel_find(
        __backend_tag{}, std::forward<_ExecutionPolicy>(__exec), __first,
        __last,
        [__first, __comp](_RandomAccessIterator __i,
                          _RandomAccessIterator __j) {
          return __internal::__is_heap_until_local(
              __first, __i - __first, __j - __first, __comp, _IsVector{});
        },
        std::less<typename std::iterator_traits<
            _RandomAccessIterator>::difference_type>(),
        /*is_first=*/true);
...
_ForwardIterator
__brick_min_element(_ForwardIterator __first, _ForwardIterator __last,
                    _Compare __comp,
                    /* __is_vector = */ std::false_type) noexcept {
...
_RandomAccessIterator
__brick_min_element(_RandomAccessIterator __first, _RandomAccessIterator __last,
                    _Compare __comp,
                    /* __is_vector = */ std::true_type) noexcept {
...
template <typename _Tag, typename _ExecutionPolicy, typename _ForwardIterator,
          typename _Compare>
_ForwardIterator
__pattern_min_element(_Tag, _ExecutionPolicy &&, _ForwardIterator __first,
                      _ForwardIterator __last, _Compare __comp) noexcept {
  return __internal::__brick_min_element(__first, __last, __comp,
                                         typename _Tag::__is_vector{});
}
...
_RandomAccessIterator
__pattern_min_element(__parallel_tag<_IsVector> __tag,
                      _ExecutionPolicy &&__exec, _RandomAccessIterator __first,
                      _RandomAccessIterator __last, _Compare __comp) {
  if (__first == __last)
    return __last;
  ...
  return __internal::__except_handler([&]() {
    return __par_backend::__parallel_reduce(
        __backend_tag{}, std::forward<_ExecutionPolicy>(__exec), __first + 1,
        __last, __first,
        [=](_RandomAccessIterator __begin, _RandomAccessIterator __end,
...
__brick_minmax_element(_RandomAccessIterator __first,
                       _RandomAccessIterator __last, _Compare __comp,
                       /* __is_vector = */ std::true_type) noexcept {
#if defined(_PSTL_UDR_PRESENT)
...
template <typename _Tag, typename _ExecutionPolicy, typename _ForwardIterator,
          typename _Compare>
std::pair<_ForwardIterator, _ForwardIterator>
__pattern_minmax_element(_Tag, _ExecutionPolicy &&, _ForwardIterator __first,
                         _ForwardIterator __last, _Compare __comp) noexcept {
...
template <typename _IsVector, typename _ExecutionPolicy,
          typename _RandomAccessIterator, typename _Compare>
std::pair<_RandomAccessIterator, _RandomAccessIterator>
__pattern_minmax_element(__parallel_tag<_IsVector> __tag,
                         _ExecutionPolicy &&__exec,
                         _RandomAccessIterator __first,
                         _RandomAccessIterator __last, _Compare __comp) {
  if (__first == __last)
  ...
  return __internal::__except_handler([&]() {
    ...
    return __par_backend::__parallel_reduce(
        __backend_tag{}, std::forward<_ExecutionPolicy>(__exec), __first + 1,
        __last, std::make_pair(__first, __first),
        [=](_RandomAccessIterator __begin, _RandomAccessIterator __end,
...
std::pair<_RandomAccessIterator1, _RandomAccessIterator2> __brick_mismatch(
    _RandomAccessIterator1 __first1, _RandomAccessIterator1 __last1,
    _RandomAccessIterator2 __first2, _RandomAccessIterator2 __last2,
    _Predicate __pred, /* __is_vector = */ std::true_type) noexcept {
...
std::pair<_ForwardIterator1, _ForwardIterator2>
__pattern_mismatch(_Tag, _ExecutionPolicy &&, _ForwardIterator1 __first1,
                   _ForwardIterator1 __last1, _ForwardIterator2 __first2,
                   _ForwardIterator2 __last2, _Predicate __pred) noexcept {
  return __internal::__brick_mismatch(__first1, __last1, __first2, __last2,
                                      __pred, typename _Tag::__is_vector{});
}

template <class _IsVector, class _ExecutionPolicy, class _RandomAccessIterator1,
          class _RandomAccessIterator2, class _Predicate>
std::pair<_RandomAccessIterator1, _RandomAccessIterator2>
__pattern_mismatch(__parallel_tag<_IsVector> __tag, _ExecutionPolicy &&__exec,
                   _RandomAccessIterator1 __first1,
                   _RandomAccessIterator1 __last1,
                   _RandomAccessIterator2 __first2,
                   _RandomAccessIterator2 __last2, _Predicate __pred) noexcept {
  using __backend_tag = typename decltype(__tag)::__backend_tag;
  ...
  return __internal::__except_handler([&]() {
    ...
    auto __result = __internal::__parallel_find(
        __backend_tag{}, std::forward<_ExecutionPolicy>(__exec), __first1,
        __first1 + __n,
        [__first1, __first2, __pred](_RandomAccessIterator1 __i,
                                     _RandomAccessIterator1 __j) {
          return __internal::__brick_mismatch(
                     __i, __j, __first2 + (__i - __first1),
                     __first2 + (__j - __first1), __pred, _IsVector{})
              .first;
        },
        std::less<typename std::iterator_traits<
            _RandomAccessIterator1>::difference_type>(),
...
bool __brick_lexicographical_compare(
  ...
  if (__first2 == __last2) { // if second sequence is empty
    ...
    --__last2;
    auto __n = std::min(__last1 - __first1, __last2 - __first2);
    std::pair<_RandomAccessIterator1, _RandomAccessIterator2> __result =
...
template <class _Tag, class _ExecutionPolicy, class _ForwardIterator1,
          class _ForwardIterator2, class _Compare>
bool __pattern_lexicographical_compare(_Tag, _ExecutionPolicy &&,
                                       _ForwardIterator1 __first1,
                                       _ForwardIterator1 __last1,
                                       _ForwardIterator2 __first2,
                                       _ForwardIterator2 __last2,
...
template <class _IsVector, class _ExecutionPolicy, class _RandomAccessIterator1,
          class _RandomAccessIterator2, class _Compare>
bool __pattern_lexicographical_compare(__parallel_tag<_IsVector> __tag,
                                       _ExecutionPolicy &&__exec,
                                       _RandomAccessIterator1 __first1,
                                       _RandomAccessIterator1 __last1,
                                       _RandomAccessIterator2 __first2,
  ...
  if (__first2 == __last2) { // if second sequence is empty
    ...
    auto __result = __internal::__parallel_find(
        __backend_tag{}, std::forward<_ExecutionPolicy>(__exec), __first1,
        __first1 + __n,
        [__first1, __first2, &__comp](_RandomAccessIterator1 __i,
                                      _RandomAccessIterator1 __j) {
          return __internal::__brick_mismatch(
                     __i, __j, __first2 + (__i - __first1),
