...
_OutputIterator __brick_uninitialized_move(_RandomAccessIterator __first,
  ...
  using _ReferenceType1 =
      typename std::iterator_traits<_RandomAccessIterator>::reference;
...
void __brick_destroy(_RandomAccessIterator __first,
                     _RandomAccessIterator __last,
                     /*vector*/ std::true_type) noexcept {
  using _ValueType =
      typename std::iterator_traits<_RandomAccessIterator>::value_type;
  using _ReferenceType =
      typename std::iterator_traits<_RandomAccessIterator>::reference;
...
template <typename _RandomAccessIterator, typename _OutputIterator>
_OutputIterator __brick_uninitialized_copy(_RandomAccessIterator __first,
                                           _RandomAccessIterator __last,
                                           _OutputIterator __result,
                                           /*vector=*/std::true_type) noexcept {
  using __ValueType =
