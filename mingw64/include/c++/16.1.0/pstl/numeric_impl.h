...
_Tp __brick_transform_reduce(_ForwardIterator1 __first1,
  ...
  return std::inner_product(__first1, __last1, __first2, std::move(__init),
                            __binary_op1, __binary_op2);
}

template <class _RandomAccessIterator1, class _RandomAccessIterator2, class _Tp,
          class _BinaryOperation1, class _BinaryOperation2>
_Tp __brick_transform_reduce(_RandomAccessIterator1 __first1,
...
_Tp __pattern_transform_reduce(_Tag, _ExecutionPolicy &&,
...
template <class _IsVector, class _ExecutionPolicy, class _RandomAccessIterator1,
          ...
          class _BinaryOperation2>
_Tp __pattern_transform_reduce(__parallel_tag<_IsVector> __tag,
        ...
        [__first1, __first2, __binary_op1,
         __binary_op2](_RandomAccessIterator1 __i, _RandomAccessIterator1 __j,
          ...
          return __internal::__brick_transform_reduce(
              __i, __j, __first2 + (__i - __first1), std::move(__init),
...
_Tp __brick_transform_reduce(_ForwardIterator __first, _ForwardIterator __last,
                             ...
                             /*is_vector=*/std::false_type) noexcept {
  return std::transform_reduce(__first, __last, std::move(__init), __binary_op,
                               __unary_op);
}

template <class _RandomAccessIterator, class _Tp, class _UnaryOperation,
          class _BinaryOperation>
_Tp __brick_transform_reduce(_RandomAccessIterator __first,
                             _RandomAccessIterator __last, _Tp __init,
...
_Tp __pattern_transform_reduce(__parallel_tag<_IsVector> __tag,
  ...
  return __internal::__except_handler([&]() {
    return __par_backend::__parallel_transform_reduce(
        ...
        __last,
        [__unary_op](_RandomAccessIterator __i) mutable {
          return __unary_op(*__i);
        },
        std::move(__init), __binary_op,
        [__unary_op, __binary_op](_RandomAccessIterator __i,
                                  _RandomAccessIterator __j, _Tp __init) {
          return __internal::__brick_transform_reduce(
              __i, __j, std::move(__init), __binary_op, __unary_op,
              _IsVector{});
        });
  });
}
...
__brick_transform_scan(_RandomAccessIterator __first,
...
_OutputIterator
__pattern_transform_scan(_Tag, _ExecutionPolicy &&, _ForwardIterator __first,
                         _ForwardIterator __last, _OutputIterator __result,
                         _UnaryOperation __unary_op, _Tp __init,
                         _BinaryOperation __binary_op, _Inclusive) noexcept {
  return __internal::__brick_transform_scan(
             __first, __last, __result, __unary_op, std::move(__init),
             __binary_op, _Inclusive(), typename _Tag::__is_vector{})
      .first;
}
...
__pattern_transform_scan(__parallel_tag<_IsVector> __tag,
                         _ExecutionPolicy &&__exec,
                         _RandomAccessIterator __first,
                         _RandomAccessIterator __last, _OutputIterator __result,
                         _UnaryOperation __unary_op, _Tp __init,
  ...
  return __internal::__except_handler([&]() {
    __par_backend::__parallel_transform_scan(
        ...
        [__first, __unary_op, __binary_op](_DifferenceType __i,
          ...
          return __internal::__brick_transform_reduce(
              __first + __i, __first + __j, std::move(__init), __binary_op,
              __unary_op,
              /*__is_vector*/ std::false_type());
        },
        [__first, __unary_op, __binary_op,
         __result](_DifferenceType __i, _DifferenceType __j, _Tp __init) {
          return __internal::__brick_transform_scan(
...
__pattern_transform_scan(__parallel_tag<_IsVector> __tag,
  ...
  return __internal::__except_handler([&]() {
    __par_backend::__parallel_strict_scan(
        ...
        std::move(__init),
        [__first, __unary_op, __binary_op, __result](_DifferenceType __i,
                                                     _DifferenceType __len) {
          return __internal::__brick_transform_scan(
...
_OutputIterator __pattern_adjacent_difference(_Tag, _ExecutionPolicy &&,
                                              _ForwardIterator __first,
                                              _ForwardIterator __last,
                                              _OutputIterator __d_first,
                                              _BinaryOperation __op) noexcept {
  return __internal::__brick_adjacent_difference(
      __first, __last, __d_first, __op, typename _Tag::__is_vector{});
}

template <class _IsVector, class _ExecutionPolicy, class _RandomAccessIterator1,
          class _RandomAccessIterator2, class _BinaryOperation>
_RandomAccessIterator2 __pattern_adjacent_difference(
  ...
  *__d_first = *__first;
  __par_backend::__parallel_for(
      __backend_tag{}, std::forward<_ExecutionPolicy>(__exec), __first,
      __last - 1,
      [&__op, __d_first, __first](_RandomAccessIterator1 __b,
