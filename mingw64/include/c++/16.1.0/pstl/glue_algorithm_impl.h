...
for_each(_ExecutionPolicy &&__exec, _ForwardIterator __first,
  ...
  __pstl::__internal::__pattern_walk1(__dispatch_tag,
...
find_end(_ExecutionPolicy &&__exec, _ForwardIterator1 __first,
  ...
  auto __dispatch_tag =
      __pstl::__internal::__select_backend(__exec, __first, __s_first);
...
adjacent_find(_ExecutionPolicy &&__exec, _ForwardIterator __first,
  ...
  return __pstl::__internal::__pattern_adjacent_find(
      __dispatch_tag, std::forward<_ExecutionPolicy>(__exec), __first, __last,
      std::equal_to<_ValueType>(), /*first_semantic*/ false);
}
...
copy(_ExecutionPolicy &&__exec, _ForwardIterator1 __first,
  ...
  auto __dispatch_tag =
      __pstl::__internal::__select_backend(__exec, __first, __result);
  ...
  return __pstl::__internal::__pattern_walk2_brick(
      __dispatch_tag, std::forward<_ExecutionPolicy>(__exec), __first, __last,
      __result,
      [](_ForwardIterator1 __begin, _ForwardIterator1 __end,
...
swap_ranges(_ExecutionPolicy &&__exec, _ForwardIterator1 __first1,
  ...
  auto __dispatch_tag =
      __pstl::__internal::__select_backend(__exec, __first1, __first2);

  return __pstl::__internal::__pattern_walk2(
      __dispatch_tag, std::forward<_ExecutionPolicy>(__exec), __first1, __last1,
      __first2, [](_ReferenceType1 __x, _ReferenceType2 __y) {
        using std::swap;
        swap(__x, __y);
      });
}
...
transform(_ExecutionPolicy &&__exec, _ForwardIterator1 __first1,
  ...
  auto __dispatch_tag = __pstl::__internal::__select_backend(
      __exec, __first1, __first2, __result);
...
fill(_ExecutionPolicy &&__exec, _ForwardIterator __first,
  ...
  __pstl::__internal::__pattern_fill(__dispatch_tag,
                                     std::forward<_ExecutionPolicy>(__exec),
...
fill_n(_ExecutionPolicy &&__exec, _ForwardIterator __first, _Size __count,
  ...
  return __pstl::__internal::__pattern_fill_n(
      __dispatch_tag, std::forward<_ExecutionPolicy>(__exec), __first, __count,
      __value);
}
...
generate(_ExecutionPolicy &&__exec, _ForwardIterator __first,
  ...
  __pstl::__internal::__pattern_generate(__dispatch_tag,
                                         std::forward<_ExecutionPolicy>(__exec),
                                         __first, __last, __g);
}
...
reverse_copy(_ExecutionPolicy &&__exec, _BidirectionalIterator __first,
  ...
  auto __dispatch_tag =
      __pstl::__internal::__select_backend(__exec, __first, __d_first);
...
partition_copy(_ExecutionPolicy &&__exec, _ForwardIterator __first,
  ...
  auto __dispatch_tag = __pstl::__internal::__select_backend(
      __exec, __first, __out_true, __out_false);
...
is_sorted(_ExecutionPolicy &&__exec, _ForwardIterator __first,
  ...
  auto __dispatch_tag = __pstl::__internal::__select_backend(__exec, __first);
  return __pstl::__internal::__pattern_adjacent_find(
             __dispatch_tag, std::forward<_ExecutionPolicy>(__exec), __first,
...
merge(_ExecutionPolicy &&__exec, _ForwardIterator1 __first1,
  ...
  auto __dispatch_tag = __pstl::__internal::__select_backend(
      __exec, __first1, __first2, __d_first);

  return __pstl::__internal::__pattern_merge(
      __dispatch_tag, std::forward<_ExecutionPolicy>(__exec), __first1, __last1,
      __first2, __last2, __d_first, __comp);
}
...
nth_element(_ExecutionPolicy &&__exec, _RandomAccessIterator __first,
  ...
  __pstl::__internal::__pattern_nth_element(
      __dispatch_tag, std::forward<_ExecutionPolicy>(__exec), __first, __nth,
      __last, __comp);
}
