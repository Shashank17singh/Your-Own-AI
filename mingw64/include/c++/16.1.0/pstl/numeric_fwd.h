...
_Tp __brick_transform_reduce(_RandomAccessIterator1, _RandomAccessIterator1,
                             _RandomAccessIterator2, _Tp, _BinaryOperation1,
                             _BinaryOperation2,
...
_Tp __pattern_transform_reduce(_Tag, _ExecutionPolicy &&, _ForwardIterator1,
...
template <class _IsVector, class _ExecutionPolicy, class _RandomAccessIterator1,
          ...
          class _BinaryOperation2>
_Tp __pattern_transform_reduce(__parallel_tag<_IsVector>, _ExecutionPolicy &&,
...
_Tp __brick_transform_reduce(_RandomAccessIterator, _RandomAccessIterator, _Tp,
...
_Tp __pattern_transform_reduce(_Tag, _ExecutionPolicy &&, _ForwardIterator,
...
std::pair<_OutputIterator, _Tp>
    __brick_transform_scan(_RandomAccessIterator, _RandomAccessIterator,
...
_OutputIterator __pattern_transform_scan(_Tag, _ExecutionPolicy &&,
...
__pattern_transform_scan(__parallel_tag<_IsVector> __tag, _ExecutionPolicy &&,
                         _RandomAccessIterator, _RandomAccessIterator,
                         _OutputIterator, _UnaryOperation, _Tp,
                         _BinaryOperation, _Inclusive);
...
typename std::enable_if<std::is_floating_point<_Tp>::value,
                        _OutputIterator>::type
__pattern_transform_scan(__parallel_tag<_IsVector>, _ExecutionPolicy &&,
                         _RandomAccessIterator, _RandomAccessIterator,
                         _OutputIterator, _UnaryOperation, _Tp,
                         _BinaryOperation, _Inclusive);
...
_OutputIterator
    __brick_adjacent_difference(_ForwardIterator, _ForwardIterator,
...
template <class _RandomAccessIterator, class _OutputIterator,
          class _BinaryOperation>
_OutputIterator
    __brick_adjacent_difference(_RandomAccessIterator, _RandomAccessIterator,
                                _OutputIterator, _BinaryOperation,
                                /*is_vector*/ std::true_type) noexcept;
