...
template <typename _Tp, typename _BinaryOp> struct _Combiner {
  ...
  _Combiner(const _Tp &__v, const _BinaryOp *__b)
      : __value(__v), __bin_op(const_cast<_BinaryOp *>(__b)) {}
...
__simd_minmax_element(_ForwardIterator __first, _Size __n,
  ...
  struct _ComplexType {
    ...
    _ComplexType(const _ValueType &__min, const _ValueType &__max,
