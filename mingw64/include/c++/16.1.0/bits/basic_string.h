...
private:
  static _GLIBCXX20_CONSTEXPR pointer _S_allocate(_Char_alloc_type &__a,
                                                  size_type __n) {
  ...
  // is provided.
  struct __sv_wrapper {
    _GLIBCXX20_CONSTEXPR explicit __sv_wrapper(__sv_type __sv) noexcept
        : _M_sv(__sv) {}
  ...
  template <typename _InIterator>
  _GLIBCXX20_CONSTEXPR void _M_construct(_InIterator __beg, _InIterator __end,
                                         std::input_iterator_tag);

  // For forward_iterators up to random_access_iterators, used for
  // string::iterator, _CharT*, etc.
  template <typename _FwdIterator>
  _GLIBCXX20_CONSTEXPR void _M_construct(_FwdIterator __beg, _FwdIterator __end,
  ...
  _GLIBCXX20_CONSTEXPR void _M_construct(const _CharT *__c, size_type __n);

#if __cplusplus >= 202302L
  constexpr void _M_construct(basic_string &&__str, size_type __pos,
                              size_type __n);
#endif
  ...
  __attribute__((__always_inline__)) _GLIBCXX14_CONSTEXPR void
  ...
  __attribute__((__always_inline__)) _GLIBCXX14_CONSTEXPR pointer
...
#pragma GCC diagnostic ignored "-Wc++17-extensions"
  ...
  _GLIBCXX20_CONSTEXPR static void _S_copy_chars(_CharT *__p, _Iterator __k1,
                                                 _Iterator __k2) {
#if __cplusplus >= 201103L
...
#pragma GCC diagnostic pop
  ...
  static constexpr void _S_copy_range(pointer __p, _Rg &&__rg, size_type __n) {
...
public:
...
#endif
  _GLIBCXX20_CONSTEXPR basic_string(const _CharT *__s,
                                    const _Alloc &__a = _Alloc())
      : _M_dataplus(_M_local_data(), __a) {
    // NB: Not required, but considered best practice.
    if (__s == 0)
  ...
  template <typename = _RequireAllocator<_Alloc>>
#endif
  _GLIBCXX20_CONSTEXPR basic_string(size_type __n, _CharT __c,
                                    const _Alloc &__a = _Alloc())
      : _M_dataplus(_M_local_data(), __a) {
  ...
  constexpr basic_string(from_range_t, _Rg &&__rg, const _Alloc &__a = _Alloc())
      : basic_string(__a) {
  ...
  template <typename _InputIterator>
#endif
  _GLIBCXX20_CONSTEXPR basic_string(_InputIterator __beg, _InputIterator __end,
                                    const _Alloc &__a = _Alloc())
  ...
  _GLIBCXX20_CONSTEXPR basic_string(const _Tp &__t, size_type __pos,
  ...
  _GLIBCXX20_CONSTEXPR explicit basic_string(const _Tp &__t,
                                             const _Alloc &__a = _Alloc())
   ...
   *  last character in the %string.
   */
  _GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR const_iterator cend() const noexcept {
...
#pragma GCC diagnostic pop
  ...
  template <typename _Operation>
  _GLIBCXX20_CONSTEXPR void __resize_and_overwrite(size_type __n,
                                                   _Operation __op);
#endif
  ...
  capacity() const _GLIBCXX_NOEXCEPT {
    size_t __sz =
        _M_is_local() ? size_type(_S_local_capacity) : _M_allocated_capacity;
   ...
   *  see at().)
   */
  _GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR reference
   ...
   */
  _GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR reference front() noexcept {
   ...
   *  element of the %string.
   */
  _GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR reference back() noexcept {
    __glibcxx_assert(!empty());
   ...
   */
  template <typename _Tp>
  _GLIBCXX20_CONSTEXPR _If_sv<_Tp, basic_string &>
   ...
   */
  template <__detail::__container_compatible_range<_CharT> _Rg>
  constexpr basic_string &append_range(_Rg &&__rg) {
    ...
    if constexpr (ranges::forward_range<_Rg> || ranges::sized_range<_Rg>) {
      ...
      if ((capacity() - size()) >= __len)
        _S_copy_range(_M_data() + size(), std::forward<_Rg>(__rg), __len);
      else {
        _M_check_length(0, __len, "basic_string::append_range");
        basic_string __s(_M_get_allocator());
        __s.reserve(__newlen);
        _S_copy_range(__s._M_data() + size(), std::forward<_Rg>(__rg), __len);
      ...
      basic_string __s(from_range, std::forward<_Rg>(__rg), _M_get_allocator());
      append(__s);
    }
    return *this;
  }
...
#pragma GCC diagnostic ignored "-Wc++17-extensions"
  template <class _InputIterator,
            typename = std::_RequireInputIter<_InputIterator>>
  _GLIBCXX20_CONSTEXPR basic_string &assign(_InputIterator __first,
    ...
    if constexpr (is_pointer<decltype(std::__niter_base(__first))>::value &&
      ...
      return _M_replace(size_type(0), size(), std::__niter_base(__first),
                        __last - __first);
    }
#if __cplusplus >= 202002L
      ...
      __glibcxx_requires_valid_range(__first, __last);
      return _M_replace(size_type(0), size(), std::to_address(__first),
                        __last - __first);
    }
#endif
    else
...
#pragma GCC diagnostic pop
   ...
   */
  template <__detail::__container_compatible_range<_CharT> _Rg>
  constexpr basic_string &assign_range(_Rg &&__rg) {
    basic_string __s(from_range, std::forward<_Rg>(__rg), _M_get_allocator());
    assign(std::move(__s));
    return *this;
  }
  ...
  template <class _InputIterator,
            typename = std::_RequireInputIter<_InputIterator>>
  _GLIBCXX20_CONSTEXPR iterator insert(const_iterator __p, _InputIterator __beg,
   ...
   */
  template <__detail::__container_compatible_range<_CharT> _Rg>
  constexpr iterator insert_range(const_iterator __p, _Rg &&__rg) {
   ...
   */
  template <typename _Tp>
  _GLIBCXX20_CONSTEXPR _If_sv<_Tp, basic_string &> insert(size_type __pos,
                                                          const _Tp &__svt) {
    __sv_type __sv = __svt;
  ...
  insert(size_type __pos1, const _Tp &__svt, size_type __pos2,
    ...
    __sv_type __sv = __svt;
    return this->replace(__pos1, size_type(0),
                         __sv.data() + std::__sv_check(__sv.size(), __pos2,
                                                       "basic_string::insert"),
  ...
  replace(const_iterator __i1, const_iterator __i2, _InputIterator __k1,
          _InputIterator __k2) {
    _GLIBCXX_DEBUG_PEDASSERT(begin() <= __i1 && __i1 <= __i2 && __i2 <= end());
   ...
   */
  template <__detail::__container_compatible_range<_CharT> _Rg>
  constexpr basic_string &replace_with_range(const_iterator __i1,
                                             const_iterator __i2, _Rg &&__rg) {
    if (__i1 == cend())
      append_range(std::forward<_Rg>(__rg));
    else {
      basic_string __s(from_range, std::forward<_Rg>(__rg), _M_get_allocator());
  ...
  template <typename _Tp>
  _GLIBCXX20_CONSTEXPR _If_sv<_Tp, basic_string &>
  replace(size_type __pos1, size_type __n1, const _Tp &__svt, size_type __pos2,
          size_type __n2 = npos) {
    __sv_type __sv = __svt;
    return this->replace(__pos1, __n1,
                         __sv.data() + std::__sv_check(__sv.size(), __pos2,
...
public:
   ...
   */
  _GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR _CharT *data() noexcept {
    return _M_data();
  }
#endif
   ...
   */
  _GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR allocator_type
   ...
   */
  _GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR size_type
  find(const basic_string &__str, size_type __pos = 0) const _GLIBCXX_NOEXCEPT {
   ...
   */
  template <typename _Tp>
  _GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR _If_sv<_Tp, size_type>
   ...
   */
  _GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR size_type
  rfind(const _CharT *__s, size_type __pos,
        size_type __n) const _GLIBCXX_NOEXCEPT;
   ...
   *  npos.
   */
  _GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR size_type find_first_of(
      const basic_string &__str, size_type __pos = 0) const _GLIBCXX_NOEXCEPT {
   ...
   *  the index where it was found.  If not found, returns npos.
   */
  _GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR size_type find_last_of(
   ...
   */
  _GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR size_type find_first_not_of(
      const basic_string &__str, size_type __pos = 0) const _GLIBCXX_NOEXCEPT {
   ...
   *  npos.
   */
  _GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR size_type find_last_not_of(
      const _CharT *__s, size_type __pos = npos) const _GLIBCXX_NOEXCEPT {
    __glibcxx_requires_string(__s);
   ...
   */
  _GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR size_type
  find_last_not_of(_CharT __c, size_type __pos = npos) const _GLIBCXX_NOEXCEPT;
   ...
   */
  _GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR basic_string
...
#if __cplusplus >= 202302L
  _GLIBCXX_NODISCARD
  constexpr basic_string substr(size_type __pos = 0) && {
    return basic_string(std::move(*this), __pos);
  }

  _GLIBCXX_NODISCARD
  constexpr basic_string substr(size_type __pos, size_type __n) && {
   ...
   */
  template <typename _Tp>
  _GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR _If_sv<_Tp, int>
  ...
  template <typename _Tp>
  _GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR _If_sv<_Tp, int>
  compare(size_type __pos1, size_type __n1, const _Tp &__svt, size_type __pos2,
   ...
   *  no special meaning.
   */
  _GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR int compare(size_type __pos,
                                                      size_type __n1,
                                                      const _CharT *__s,
...
basic_string(from_range_t, _Rg &&, _Allocator = _Allocator())
    -> basic_string<ranges::range_value_t<_Rg>,
                    char_traits<ranges::range_value_t<_Rg>>, _Allocator>;
#endif
_GLIBCXX_END_NAMESPACE_CXX11
#endif

template <typename _Str>
_GLIBCXX20_CONSTEXPR inline _Str __str_concat(
    typename _Str::value_type const *__lhs, typename _Str::size_type __lhs_len,
...
_GLIBCXX_NODISCARD
  ...
  return std::__str_concat<_Str>(__lhs.c_str(), __lhs.size(), __rhs,
                                 _Traits::length(__rhs), __lhs.get_allocator());
}
/**
...
operator+(const basic_string<_CharT, _Traits, _Alloc> &__lhs,
  ...
  return std::__str_concat<_Str>(__lhs.data(), __lhs.size(), __rhs.data(),
                                 __rhs.size(), __lhs.get_allocator());
}
 ...
 */
template <typename _CharT, typename _Traits, typename _Alloc>
_GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR inline bool operator==(
...
inline string to_string(float __val) {
  ...
  size_t __len = 15;
  do {
    __str.resize_and_overwrite(__len, [__val, &__len](char *__p, size_t __n) {
...
template <typename _Alloc>
struct __is_fast_hash<hash<basic_string<wchar_t, char_traits<wchar_t>, _Alloc>>>
    : std::false_type {};
...
_GLIBCXX_DEFAULT_ABI_TAG _GLIBCXX_STRING_CONSTEXPR inline basic_string<char16_t>
operator""s(const char16_t *__str, size_t __len) {
  return basic_string<char16_t>{__str, __len};
}

_GLIBCXX_DEFAULT_ABI_TAG _GLIBCXX_STRING_CONSTEXPR inline basic_string<char32_t>
