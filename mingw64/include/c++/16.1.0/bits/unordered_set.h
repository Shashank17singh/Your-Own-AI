...
public:
   ...
   *  @param  __a    An allocator object.
   */
  unordered_set(unordered_set &&__uset, const allocator_type &__a) noexcept(
      noexcept(_Hashtable(std::move(__uset._M_h), __a)))
  ...
  unordered_set(from_range_t, _Rg &&__rg, size_type __n = 0,
                const hasher &__hf = hasher(),
                const key_equal &__eql = key_equal(),
                const allocator_type &__a = allocator_type())
      : _M_h(__n, __hf, __eql, __a) {
  ...
  template <__detail::__container_compatible_range<_Value> _Rg>
  unordered_set(from_range_t, _Rg &&__rg, size_type __n, const hasher &__hf,
                const allocator_type &__a)
...
template <typename _Tp, typename _Hash = hash<_Tp>,
          typename _Pred = equal_to<_Tp>, typename _Allocator = allocator<_Tp>,
          typename = _RequireNotAllocatorOrIntegral<_Hash>,
          typename = _RequireNotAllocator<_Pred>,
          typename = _RequireAllocator<_Allocator>>
...
template <typename _InputIterator, typename _Allocator,
          typename = _RequireInputIter<_InputIterator>,
          typename = _RequireAllocator<_Allocator>>
unordered_set(_InputIterator, _InputIterator, _Allocator) -> unordered_set<
    typename iterator_traits<_InputIterator>::value_type,
    hash<typename iterator_traits<_InputIterator>::value_type>,
...
unordered_set(from_range_t, _Rg &&, unordered_set<int>::size_type, _Allocator)
    -> unordered_set<ranges::range_value_t<_Rg>,
                     hash<ranges::range_value_t<_Rg>>,
                     equal_to<ranges::range_value_t<_Rg>>, _Allocator>;
...
unordered_set(from_range_t, _Rg &&, unordered_set<int>::size_type, _Hash,
              _Allocator)
...
public:
  ...
  unordered_multiset(initializer_list<value_type> __l, size_type __n,
      ...
      : unordered_multiset(__l, __n, __hf, key_equal(), __a) {}
                                 ...
                                 */
  template <__detail::__container_compatible_range<_Value> _Rg>
  unordered_multiset(from_range_t, _Rg &&__rg, size_type __n = 0,
                     const hasher &__hf = hasher(),
                     const key_equal &__eql = key_equal(),
                     const allocator_type &__a = allocator_type())
      : _M_h(__n, __hf, __eql, __a) {
