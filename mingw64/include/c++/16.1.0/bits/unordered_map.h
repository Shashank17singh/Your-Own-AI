...
public:
  ...
  unordered_map(from_range_t, _Rg &&__rg, size_type __n = 0,
                const hasher &__hf = hasher(),
                const key_equal &__eql = key_equal(),
                const allocator_type &__a = allocator_type())
      : _M_h(__n, __hf, __eql, __a) {
  ...
  template <__detail::__container_compatible_range<value_type> _Rg>
  unordered_map(from_range_t, _Rg &&__rg, size_type __n, const hasher &__hf,
                const allocator_type &__a)
  ...
  pair<iterator, bool> try_emplace(_Kt &&__k, _Args &&...__args) {
    return _M_h.try_emplace(cend(), std::forward<_Kt>(__k),
                            std::forward<_Args>(__args)...);
  }
#endif
  ///@}
  ...
  iterator try_emplace(const_iterator __hint, _Kt &&__k, _Args &&...__args) {
    return _M_h
        .try_emplace(__hint, std::forward<_Kt>(__k),
                     std::forward<_Args>(__args)...)
        .first;
  }
#endif
  ...
  pair<iterator, bool> insert_or_assign(_Kt &&__k, _Obj &&__obj) {
    auto __ret = _M_h.try_emplace(cend(), std::forward<_Kt>(__k),
  ...
  iterator insert_or_assign(const_iterator __hint, _Kt &&__k, _Obj &&__obj) {
    auto __ret = _M_h.try_emplace(__hint, std::forward<_Kt>(__k),
                                  std::forward<_Obj>(__obj));
    if (!__ret.second)
      __ret.first->second = std::forward<_Obj>(__obj);
    return __ret.first;
...
unordered_map(_InputIterator, _InputIterator,
              typename unordered_map<int, int>::size_type = {}, _Hash = _Hash(),
...
unordered_map(_InputIterator, _InputIterator,
    ...
    -> unordered_map<__iter_key_t<_InputIterator>, __iter_val_t<_InputIterator>,
                     _Hash, equal_to<__iter_key_t<_InputIterator>>, _Allocator>;
...
unordered_map(from_range_t, _Rg &&, unordered_map<int, int>::size_type = {},
    ...
    -> unordered_map<__detail::__range_key_type<_Rg>,
                     __detail::__range_mapped_type<_Rg>, _Hash, _Pred,
                     _Allocator>;

template <ranges::input_range _Rg, __allocator_like _Allocator>
unordered_map(from_range_t, _Rg &&, unordered_map<int, int>::size_type,
              _Allocator)
    -> unordered_map<__detail::__range_key_type<_Rg>,
                     __detail::__range_mapped_type<_Rg>,
                     hash<__detail::__range_key_type<_Rg>>,
                     equal_to<__detail::__range_key_type<_Rg>>, _Allocator>;
...
template <ranges::input_range _Rg, __not_allocator_like _Hash,
          __allocator_like _Allocator>
unordered_map(from_range_t, _Rg &&, unordered_map<int, int>::size_type, _Hash,
              _Allocator)
    -> unordered_map<__detail::__range_key_type<_Rg>,
                     __detail::__range_mapped_type<_Rg>, _Hash,
                     equal_to<__detail::__range_key_type<_Rg>>, _Allocator>;
#endif
#endif
...
public:
  ...
  unordered_multimap(initializer_list<value_type> __l, size_type __n,
      ...
      : unordered_multimap(__l, __n, __hf, key_equal(), __a) {}
                                 ...
                                 */
  template <__detail::__container_compatible_range<value_type> _Rg>
  unordered_multimap(from_range_t, _Rg &&__rg, size_type __n = 0,
                     const hasher &__hf = hasher(),
                     const key_equal &__eql = key_equal(),
                     const allocator_type &__a = allocator_type())
      : _M_h(__n, __hf, __eql, __a) {
  ...
  template <typename _Key1, typename _Tp1, typename _Hash1, typename _Pred1,
            typename _Alloc1>
  friend bool
  operator==(const unordered_multimap<_Key1, _Tp1, _Hash1, _Pred1, _Alloc1> &,
...
unordered_multimap(from_range_t, _Rg &&,
                   unordered_multimap<int, int>::size_type, _Allocator)
    -> unordered_multimap<
        __detail::__range_key_type<_Rg>, __detail::__range_mapped_type<_Rg>,
        hash<__detail::__range_key_type<_Rg>>,
        equal_to<__detail::__range_key_type<_Rg>>, _Allocator>;

template <ranges::input_range _Rg, __allocator_like _Allocator>
unordered_multimap(from_range_t, _Rg &&, _Allocator) -> unordered_multimap<
    __detail::__range_key_type<_Rg>, __detail::__range_mapped_type<_Rg>,
    hash<__detail::__range_key_type<_Rg>>,
    equal_to<__detail::__range_key_type<_Rg>>, _Allocator>;
...
unordered_multimap(from_range_t, _Rg &&,
    ...
    -> unordered_multimap<
        __detail::__range_key_type<_Rg>, __detail::__range_mapped_type<_Rg>,
        _Hash, equal_to<__detail::__range_key_type<_Rg>>, _Allocator>;
#endif
#endif
