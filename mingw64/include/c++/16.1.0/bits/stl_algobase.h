 ...
 */
template <typename _ForwardIterator1, typename _ForwardIterator2>
_GLIBCXX20_CONSTEXPR _ForwardIterator2 swap_ranges(_ForwardIterator1 __first1,
...
_GLIBCXX_NODISCARD _GLIBCXX14_CONSTEXPR inline const _Tp &min(const _Tp &__a,
                                                              const _Tp &__b) {
  // concept requirements
 ...
 */
template <typename _Tp>
_GLIBCXX_NODISCARD _GLIBCXX14_CONSTEXPR inline const _Tp &max(const _Tp &__a,
                                                              const _Tp &__b) {
  // concept requirements
  __glibcxx_function_requires(_LessThanComparableConcept<_Tp>)
...
concept __memcpyable_iterators =
    ...
    sized_sentinel_for<_Sent, _InIter> && requires(_OutIter __o, _InIter __i) {
...
__attribute__((__always_inline__)) inline void *__ptr_or_null(_Iter) {
  return 0;
}
template <typename _Tp>
__attribute__((__always_inline__)) inline void *__ptr_or_null(_Tp *__p) {
  return (void *)__p;
}
#define _GLIBCXX_TO_ADDR(P) std::__ptr_or_null(P)
// Used to advance output iterators (std::advance requires InputIterator).
template <typename _Iter>
__attribute__((__always_inline__)) inline void __ptr_advance(_Iter &,
                                                             ptrdiff_t) {}
template <typename _Tp>
__attribute__((__always_inline__)) inline void __ptr_advance(_Tp *&__p,
                                                             ptrdiff_t __n) {
  __p += __n;
}
...
_GLIBCXX20_CONSTEXPR inline _OutIter
__copy_move_a2(_InIter __first, _Sent __last, _OutIter __result) {
  ...
  if _GLIBCXX_CONSTEXPR (!__is_trivially_assignable(_OutRef, _InRef)) {
    ...
    if (__builtin_expect(__n > 1, true)) {
      __builtin_memmove(_GLIBCXX_TO_ADDR(__result), _GLIBCXX_TO_ADDR(__first),
                        __n * sizeof(*__first));
...
__attribute__((__always_inline__)) _GLIBCXX20_CONSTEXPR inline _OI
...
#if __cpp_lib_concepts
  else if constexpr (__memcpyable_iterators<_OutputIterator, _InputIterator>) {
    if (__n > 1) [[likely]] {
      void *__dest = std::to_address(__result);
      const void *__src = std::to_address(__first);
...
__copy_n_a(istreambuf_iterator<_CharT, char_traits<_CharT>>, _Size,
           _GLIBCXX_STD_C::_Deque_iterator<_CharT, _CharT &, _CharT *>, bool);
#endif
...
_GLIBCXX20_CONSTEXPR inline _OI copy(_II __first, _II __last, _OI __result) {
  ...
  __glibcxx_function_requires(_InputIteratorConcept<_II>)
      __glibcxx_function_requires(
          _OutputIteratorConcept<_OI, typename iterator_traits<_II>::reference>)
...
template <bool _IsMove, typename _BI1, typename _BI2>
__attribute__((__always_inline__)) _GLIBCXX20_CONSTEXPR inline _BI2
...
template <bool _IsMove, typename _Ite, typename _Seq, typename _Cat,
          typename _OI>
_GLIBCXX20_CONSTEXPR _OI __copy_move_backward_a(
    const ::__gnu_debug::_Safe_iterator<_Ite, _Seq, _Cat> &,
    const ::__gnu_debug::_Safe_iterator<_Ite, _Seq, _Cat> &, _OI);
      ...
      __glibcxx_function_requires(_Mutable_BidirectionalIteratorConcept<_BI2>)
          __glibcxx_function_requires(
              _OutputIteratorConcept<
                  _BI2, typename iterator_traits<_BI1>::value_type &&>)
              __glibcxx_requires_can_decrement_range(__first, __last, __result);
...
_GLIBCXX20_CONSTEXPR inline void __fill_a1(_ForwardIterator __first,
...
#pragma GCC diagnostic pop
  ...
  typedef typename __gnu_cxx::__conditional_type<__load_outside_loop, const _Tp,
...
_GLIBCXX20_CONSTEXPR inline typename __gnu_cxx::__enable_if<
    __is_byte<_Up>::__value && (__are_same<_Up, _Tp>::__value // for std::byte
...
void __fill_a1(_GLIBCXX_STD_C::_Bit_iterator, _GLIBCXX_STD_C::_Bit_iterator,
               const bool &);
...
__extension__ inline _GLIBCXX_CONSTEXPR
    __GLIBCXX_TYPE_INT_N_0 __size_to_integer(__GLIBCXX_TYPE_INT_N_0 __n) {
  return __n;
}
...
__extension__ inline _GLIBCXX_CONSTEXPR
    __GLIBCXX_TYPE_INT_N_1 __size_to_integer(__GLIBCXX_TYPE_INT_N_1 __n) {
  return __n;
}
...
__extension__ inline _GLIBCXX_CONSTEXPR
    __GLIBCXX_TYPE_INT_N_2 __size_to_integer(__GLIBCXX_TYPE_INT_N_2 __n) {
  return __n;
}
...
__extension__ inline _GLIBCXX_CONSTEXPR
    __GLIBCXX_TYPE_INT_N_3 __size_to_integer(__GLIBCXX_TYPE_INT_N_3 __n) {
  return __n;
}
...
__size_to_integer(__int128 __n) {
  return __n;
}
__extension__ inline _GLIBCXX_CONSTEXPR unsigned __int128
__size_to_integer(unsigned __int128 __n) {
  return __n;
}
#endif
...
template <typename _OutputIterator, typename _Size, typename _Tp>
__attribute__((__always_inline__)) _GLIBCXX20_CONSTEXPR inline _OutputIterator
...
typename __gnu_cxx::__enable_if<__is_any_random_access_iter<_II>::__value,
                                bool>::__type
...
template <typename _II1, typename _II2>
__attribute__((__always_inline__)) _GLIBCXX20_CONSTEXPR inline bool
...
struct __lc_rai<random_access_iterator_tag, random_access_iterator_tag> {
  ...
  template <typename _RAI> static _GLIBCXX20_CONSTEXPR bool __cnd2(_RAI, _RAI) {
    return true;
  }
};
...
_GLIBCXX20_CONSTEXPR bool
__lexicographical_compare_impl(_II1 __first1, _II1 __last1, _II2 __first2,
...
template <bool _BoolType> struct __lexicographical_compare {
  ...
  template <typename _II1, typename _II2>
  _GLIBCXX20_CONSTEXPR static int __3way(_II1 __first1, _II1 __last1,
                                         _II2 __first2, _II2 __last2) {
...
template <> struct __lexicographical_compare<true> {
  template <typename _Tp, typename _Up>
  _GLIBCXX20_CONSTEXPR static bool __lc(const _Tp *__first1, const _Tp *__last1,
                                        const _Up *__first2,
                                        const _Up *__last2) {
  ...
  __3way(const _Tp *__first1, const _Tp *__last1, const _Up *__first2,
         const _Up *__last2) {
...
__lexicographical_compare_aux1(_II1 __first1, _II1 __last1, _II2 __first2,
                               _II2 __last2) {
  typedef typename iterator_traits<_II1>::value_type _ValueType1;
...
bool __lexicographical_compare_aux1(
    _GLIBCXX_STD_C::_Deque_iterator<_Tp1, _Ref1, _Ptr1>,
    _GLIBCXX_STD_C::_Deque_iterator<_Tp1, _Ref1, _Ptr1>, _Tp2 *, _Tp2 *);

template <typename _Tp1, typename _Tp2, typename _Ref2, typename _Ptr2>
bool __lexicographical_compare_aux1(
    _Tp1 *, _Tp1 *, _GLIBCXX_STD_C::_Deque_iterator<_Tp2, _Ref2, _Ptr2>,
    _GLIBCXX_STD_C::_Deque_iterator<_Tp2, _Ref2, _Ptr2>);
...
template <typename _II1, typename _II2>
_GLIBCXX20_CONSTEXPR inline bool
__lexicographical_compare_aux(_II1 __first1, _II1 __last1, _II2 __first2,
                              _II2 __last2) {
...
_GLIBCXX20_CONSTEXPR bool __lexicographical_compare_aux(
...
_GLIBCXX20_CONSTEXPR _ForwardIterator __lower_bound(_ForwardIterator __first,
                                                    _ForwardIterator __last,
                                                    const _Tp &__val,
                                                    _Compare __comp) {
  typedef
...
lower_bound(_ForwardIterator __first, _ForwardIterator __last,
  ...
  return std::__lower_bound(__first, __last, __val, __gnu_cxx::__ops::less());
}

/// This is a helper function for the sort routines and for random.tcc.
//  Precondition: __n > 0.
template <typename _Tp> inline _GLIBCXX_CONSTEXPR _Tp __lg(_Tp __n) {
#if __cplusplus >= 201402L
...
#pragma GCC diagnostic ignored "-Wlong-long"
  ...
  return (sizeof(+__n) * __CHAR_BIT__ - 1) -
         (sizeof(+__n) == sizeof(long long)
              ? __builtin_clzll(+__n)
              : (sizeof(+__n) == sizeof(long) ? __builtin_clzl(+__n)
                                              : __builtin_clz(+__n)));
#pragma GCC diagnostic pop
#endif
}
...
_GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR inline bool
equal(_IIter1 __first1, _IIter1 __last1, _IIter2 __first2,
...
template <typename _IIter1, typename _IIter2, typename _BinaryPredicate>
_GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR inline bool
equal(_IIter1 __first1, _IIter1 __last1, _IIter2 __first2, _IIter2 __last2,
      _BinaryPredicate __binary_pred) {
  // concept requirements
  __glibcxx_function_requires(_InputIteratorConcept<_IIter1>)
      __glibcxx_function_requires(_InputIteratorConcept<_IIter2>)
...
template <typename _II1, typename _II2>
_GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR inline bool
lexicographical_compare(_II1 __first1, _II1 __last1, _II2 __first2,
                        _II2 __last2) {
...
lexicographical_compare_three_way(_InputIter1 __first1, _InputIter1 __last1,
    ...
    if constexpr (same_as<_Comp, __detail::_Synth3way> ||
      ...
      if constexpr (__memcmp_ordered_with<_InputIter1, _InputIter2>) {
        const auto [__len, __lencmp] =
            _GLIBCXX_STD_A::__min_cmp(__last1 - __first1, __last2 - __first2);
        if (__len) {
...
lexicographical_compare_three_way(_InputIter1 __first1, _InputIter1 __last1,
                                  _InputIter2 __first2, _InputIter2 __last2) {
  return _GLIBCXX_STD_A::lexicographical_compare_three_way(
      __first1, __last1, __first2, __last2, compare_three_way{});
}
#endif // three_way_comparison

template <typename _InputIterator1, typename _InputIterator2,
          typename _BinaryPredicate>
_GLIBCXX20_CONSTEXPR pair<_InputIterator1, _InputIterator2>
...
template <typename _InputIterator1, typename _InputIterator2>
_GLIBCXX_NODISCARD
    _GLIBCXX20_CONSTEXPR inline pair<_InputIterator1, _InputIterator2>
...
_GLIBCXX_NODISCARD
  ...
  return _GLIBCXX_STD_A::__mismatch(__first1, __last1, __first2, __binary_pred);
}
...
_GLIBCXX20_CONSTEXPR _ForwardIterator __remove_if(_ForwardIterator __first,
                                                  _ForwardIterator __last,
                                                  _Predicate __pred) {
...
template <typename _ForwardIterator1, typename _ForwardIterator2,
          typename _BinaryPredicate>
_GLIBCXX20_CONSTEXPR _ForwardIterator1 __search(_ForwardIterator1 __first1,
                                                _ForwardIterator1 __last1,
                                                _ForwardIterator2 __first2,
  ...
  __decltype(__gnu_cxx::__ops::bind2nd(__predicate,
                                       __first2_val)) __match_first =
      __gnu_cxx::__ops::bind2nd(__predicate, __first2_val);
