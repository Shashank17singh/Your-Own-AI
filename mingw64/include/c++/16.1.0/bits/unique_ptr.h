...
template <typename _Tp> struct default_delete {
  ...
  _GLIBCXX23_CONSTEXPR default_delete(const default_delete<_Up> &) noexcept {}
...
public:
  ...
  _GLIBCXX23_CONSTEXPR __uniq_ptr_impl(pointer __p, _Del &&__d)
...
public:
  ...
  _GLIBCXX23_CONSTEXPR unique_ptr(
      pointer __p,
...
public:
  ...
  _GLIBCXX23_CONSTEXPR explicit unique_ptr(_Up __p) noexcept : _M_t(__p) {}
...
inline
    ...
    _GLIBCXX23_CONSTEXPR typename enable_if<__is_swappable<_Dp>::value>::type
#else
    void
#endif
...
swap(unique_ptr<_Tp, _Dp> &, unique_ptr<_Tp, _Dp> &) = delete;
#endif
...
_GLIBCXX23_CONSTEXPR inline compare_three_way_result_t<
...
struct __uniq_ptr_hash : public __hash_base<size_t, _Up>
...
template <typename _Tp> constexpr bool __is_unique_ptr = false;
