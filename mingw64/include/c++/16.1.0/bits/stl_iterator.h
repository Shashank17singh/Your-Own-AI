...
class reverse_iterator
  ...
  static constexpr bool __convertible =
      !is_same_v<_Iter, _Iterator> && convertible_to<const _Iter &, _Iterator>;
#endif
...
public:
  ...
  reverse_iterator() _GLIBCXX_NOEXCEPT_IF(noexcept(_Iterator())) : current() {}
...
#ifndef __glibcxx_concepts
template <typename _Iterator>
_GLIBCXX_NODISCARD inline _GLIBCXX17_CONSTEXPR bool
...
template <typename _Iterator>
_GLIBCXX_NODISCARD inline _GLIBCXX17_CONSTEXPR reverse_iterator<_Iterator>
...
inline constexpr bool disable_sized_sentinel_for<reverse_iterator<_Iterator1>,
...
public:
  ...
  /// Simply returns *this.
  _GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR back_insert_iterator &operator*() {
    return *this;
  }
 ...
 */
template <typename _Container>
_GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR inline back_insert_iterator<_Container>
...
public:
  ...
  /// Simply returns *this.
  _GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR front_insert_iterator &operator*() {
    return *this;
  }
 ...
 */
template <typename _Container>
_GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR inline front_insert_iterator<_Container>
...
public:
  ...
  /// Simply returns *this.
  _GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR insert_iterator &operator*() {
    return *this;
  }
...
public:
  ...
  _GLIBCXX_CONSTEXPR __normal_iterator() _GLIBCXX_NOEXCEPT : _M_current() {}

  __attribute__((__always_inline__)) explicit _GLIBCXX_CONSTEXPR
  ...
  template <typename _Iter>
  __attribute__((__always_inline__)) __normal_iterator(
  ...
  _GLIBCXX_NODISCARD
      __attribute__((__always_inline__)) _GLIBCXX_CONSTEXPR reference
      operator*() const _GLIBCXX_NOEXCEPT {
    return *_M_current;
  }

  _GLIBCXX_NODISCARD
      __attribute__((__always_inline__)) _GLIBCXX_CONSTEXPR pointer
      operator->() const _GLIBCXX_NOEXCEPT {
    return _M_current;
  }

  __attribute__((__always_inline__)) _GLIBCXX14_CONSTEXPR __normal_iterator &
  ...
  _GLIBCXX_NODISCARD
      __attribute__((__always_inline__)) _GLIBCXX_CONSTEXPR __normal_iterator
      operator+(difference_type __n) const _GLIBCXX_NOEXCEPT {
  ...
  _GLIBCXX_NODISCARD
      __attribute__((__always_inline__)) _GLIBCXX_CONSTEXPR const _Iterator &
...
private:
  ...
  operator==(const __normal_iterator &__lhs,
             const __normal_iterator<_Iter, _Container>
  ...
  friend constexpr bool
  operator==(const __normal_iterator &__lhs,
             const __normal_iterator &__rhs) noexcept(noexcept(__lhs.base() ==
                                                               __rhs.base()))
    requires requires {
      { __lhs.base() == __rhs.base() } -> std::convertible_to<bool>;
    }
  ...
  template <typename _Iter>
  [[nodiscard, __gnu__::__always_inline__]]
  friend constexpr std::__detail::__synth3way_t<_Iterator, _Iter> operator<=>(
  ...
  template <typename _Iter>
  _GLIBCXX_NODISCARD
      __attribute__((__always_inline__)) friend _GLIBCXX_CONSTEXPR bool
      operator==(const __normal_iterator &__lhs,
  ...
  _GLIBCXX_NODISCARD
      __attribute__((__always_inline__)) friend _GLIBCXX_CONSTEXPR bool
      operator==(const __normal_iterator &__lhs,
                 const __normal_iterator &__rhs) _GLIBCXX_NOEXCEPT {
    return __lhs.base() == __rhs.base();
  }
  ...
  template <typename _Iter>
  _GLIBCXX_NODISCARD
      __attribute__((__always_inline__)) friend _GLIBCXX_CONSTEXPR inline bool
      operator<(const __normal_iterator &__lhs,
                const __normal_iterator<_Iter, _Container> &__rhs)
          _GLIBCXX_NOEXCEPT {
    return __lhs.base() < __rhs.base();
  ...
  _GLIBCXX_NODISCARD
      __attribute__((__always_inline__)) friend _GLIBCXX20_CONSTEXPR bool
      operator<(const __normal_iterator &__lhs,
                const __normal_iterator &__rhs) _GLIBCXX_NOEXCEPT {
    return __lhs.base() < __rhs.base();
  }
  ...
  _GLIBCXX_NODISCARD
      __attribute__((__always_inline__)) friend _GLIBCXX_CONSTEXPR
          difference_type
          operator-(const __normal_iterator &__lhs,
                    const __normal_iterator &__rhs) _GLIBCXX_NOEXCEPT {
    return __lhs.base() - __rhs.base();
  ...
  _GLIBCXX_NODISCARD
      __attribute__((__always_inline__)) friend _GLIBCXX_CONSTEXPR
          ...
          operator+(difference_type __n,
                    const __normal_iterator &__i) _GLIBCXX_NOEXCEPT {
...
public:
  constexpr move_sentinel() noexcept(is_nothrow_default_constructible_v<_Sent>)
      : _M_last() {}
...
#ifdef __glibcxx_concepts
  requires requires {
    { __x.base() + __n } -> same_as<_Iterator>;
  }
#endif
{
  return __x + __n;
...
template <typename _Iterator1, typename _Iterator2>
  requires(!sized_sentinel_for<_Iterator1, _Iterator2>)
inline constexpr bool disable_sized_sentinel_for<move_iterator<_Iterator1>,
                                                 move_iterator<_Iterator2>> =
    true;
...
public:
  ...
  constexpr common_iterator(const common_iterator<_It2, _Sent2> &__x) noexcept(
      _S_noexcept<const _It2 &, const _Sent2 &>())
...
namespace __detail {
template <typename _It>
concept __constant_iterator =
    input_iterator<_It> &&
    same_as<iter_const_reference_t<_It>, iter_reference_t<_It>>;

template <typename _Tp> inline constexpr bool __is_const_iterator = false;
...
template <typename _It> struct __basic_const_iterator_iter_cat {};

template <forward_iterator _It> struct __basic_const_iterator_iter_cat<_It> {
  using iterator_category = __iter_category_t<_It>;
};
} // namespace __detail

template <input_iterator _It>
using const_iterator = __conditional_t<__detail::__constant_iterator<_It>, _It,
                                       basic_const_iterator<_It>>;

namespace __detail {
template <typename _Sent> struct __const_sentinel {
  using type = _Sent;
};

template <input_iterator _Sent> struct __const_sentinel<_Sent> {
...
public:
  ...
  constexpr basic_const_iterator(_It __current) noexcept(
      is_nothrow_move_constructible_v<_It>)
      : _M_current(std::move(__current)) {}

  template <convertible_to<_It> _It2>
  constexpr basic_const_iterator(basic_const_iterator<_It2> __current) noexcept(
      is_nothrow_constructible_v<_It, _It2>)
  ...
  constexpr basic_const_iterator(_Tp &&__current) noexcept(
      is_nothrow_constructible_v<_It, _Tp>)
      : _M_current(std::forward<_Tp>(__current)) {}

  constexpr const _It &base() const & noexcept { return _M_current; }
  ...
  constexpr void operator++(int) noexcept(noexcept(++_M_current)) {
    ++_M_current;
  }
  ...
  constexpr basic_const_iterator &operator--() noexcept(noexcept(--_M_current))
    requires bidirectional_iterator<_It>
  {
    --_M_current;
    return *this;
  ...
  constexpr bool operator==(const _Sent &__s) const
  ...
  constexpr operator _CIt() const & {
    return _M_current;
  }

  template <__detail::__not_a_const_iterator _CIt>
    requires __detail::__constant_iterator<_CIt> && convertible_to<_It, _CIt>
  constexpr operator _CIt() && {
    return std::move(_M_current);
  }
  ...
  template <__detail::__different_from<basic_const_iterator> _It2>
  constexpr auto operator<=>(const _It2 &__y) const
      noexcept(noexcept(_M_current <=> __y))
    requires random_access_iterator<_It> && totally_ordered_with<_It, _It2> &&
  ...
  friend constexpr bool
  operator<(const _It2 &__x, const basic_const_iterator<_It3> &__y) noexcept(
  ...
  operator+(const basic_const_iterator &__i, difference_type __n) noexcept(
  ...
  friend constexpr basic_const_iterator
  operator+(difference_type __n, const basic_const_iterator &__i) noexcept(
      noexcept(basic_const_iterator(__i._M_current + __n)))
    requires random_access_iterator<_It>
  {
    return basic_const_iterator(__i._M_current + __n);
  ...
  constexpr difference_type operator-(const _Sent &__y) const
      noexcept(noexcept(_M_current - __y)) {
    return _M_current - __y;
  }
  ...
  operator-(const _Sent &__x, const basic_const_iterator<_It2> &__y) noexcept(
      noexcept(__x - __y._M_current)) {
    return __x - __y._M_current;
  }

  friend constexpr __rvalue_reference
  iter_move(const basic_const_iterator &__i) noexcept(noexcept(
...
template <input_iterator _It>
constexpr const_iterator<_It> make_const_iterator(_It __it) noexcept(
    is_nothrow_convertible_v<_It, const_iterator<_It>>) {
  return __it;
}

template <semiregular _Sent>
constexpr const_sentinel<_Sent> make_const_sentinel(_Sent __s) noexcept(
    is_nothrow_convertible_v<_Sent, const_sentinel<_Sent>>) {
  return __s;
}
...
_Ite __niter_base(const ::__gnu_debug::_Safe_iterator<
                  _Ite, _Seq, std::random_access_iterator_tag> &);
...
#if __cplusplus >= 201103L
template <typename _Iterator>
_GLIBCXX20_CONSTEXPR inline auto __niter_base(reverse_iterator<_Iterator> __it)
    -> decltype(__make_reverse_iterator(__niter_base(__it.base()))) {
  return __make_reverse_iterator(__niter_base(__it.base()));
}

template <typename _Iterator>
_GLIBCXX20_CONSTEXPR inline auto __niter_base(move_iterator<_Iterator> __it)
    -> decltype(make_move_iterator(__niter_base(__it.base()))) {
  return make_move_iterator(__niter_base(__it.base()));
}

template <typename _Iterator>
_GLIBCXX20_CONSTEXPR inline auto __miter_base(reverse_iterator<_Iterator> __it)
    -> decltype(__make_reverse_iterator(__miter_base(__it.base()))) {
  return __make_reverse_iterator(__miter_base(__it.base()));
}

template <typename _Iterator>
_GLIBCXX20_CONSTEXPR inline auto __miter_base(move_iterator<_Iterator> __it)
...
_GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR inline _From __niter_wrap(_From __from,
                                                                  _To __res) {
...
template <typename _Iterator>
_GLIBCXX_NODISCARD
    __attribute__((__always_inline__)) _GLIBCXX20_CONSTEXPR inline _Iterator
