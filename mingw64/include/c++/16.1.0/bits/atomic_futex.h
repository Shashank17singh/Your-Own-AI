...
struct __atomic_futex_unsigned_base {
  ...
  bool _M_futex_wait_until_steady(unsigned *__addr, unsigned __val,
...
private:
  ...
  unsigned _M_load_and_test_until_steady(unsigned __assumed, unsigned __operand,
                                         bool __equal, memory_order __mo,
                                         bool __has_timeout,
                                         chrono::seconds __s,
                                         chrono::nanoseconds __ns) {
...
public:
  ...
  _M_load_when_equal_for(unsigned __val, memory_order __mo,
    ...
    return _M_load_when_equal_until(
        __val, __mo, __clock_t::now() + chrono::__detail::ceil<__dur>(__rtime));
  }
  ...
  _GLIBCXX_ALWAYS_INLINE bool _M_load_when_equal_until(
    ...
    do {
      ...
      const auto __s_atime =
          __s_entry + chrono::__detail::ceil<__clock_t::duration>(__delta);
...
public:
  ...
  _GLIBCXX_ALWAYS_INLINE unsigned _M_load(memory_order) {
  ...
  _GLIBCXX_ALWAYS_INLINE void _M_load_when_equal(unsigned __val, memory_order) {
    unique_lock<mutex> __lock(_M_mutex);
    while (_M_data != __val)
      _M_condvar.wait(__lock);
  }
