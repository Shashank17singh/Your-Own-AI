...
__attribute__((__always_inline__)) inline _GLIBCXX14_CONSTEXPR
...
template <typename _Iter>
concept __promotable_iterator = input_iterator<_Iter> && requires {
  typename __iter_traits<_Iter>::iterator_concept;
...
template <typename _InputIterator>
_GLIBCXX_NODISCARD
    __attribute__((__always_inline__)) inline _GLIBCXX17_CONSTEXPR
    typename iterator_traits<_InputIterator>::difference_type
...
inline _GLIBCXX14_CONSTEXPR void __advance(_InputIterator &__i, _Distance __n,
                                           input_iterator_tag) {
  // concept requirements
  __glibcxx_function_requires(_InputIteratorConcept<_InputIterator>)
...
inline _GLIBCXX14_CONSTEXPR void __advance(_BidirectionalIterator &__i,
                                           _Distance __n,
...
inline _GLIBCXX14_CONSTEXPR void __advance(_RandomAccessIterator &__i,
                                           _Distance __n,
                                           random_access_iterator_tag) {
  // concept requirements
  __glibcxx_function_requires(
 ...
 */
template <typename _InputIterator, typename _Distance>
__attribute__((__always_inline__)) inline _GLIBCXX17_CONSTEXPR void
...
template <typename _Iter> consteval auto __iter_concept_or_category() {
...
template <typename _Iter>
__attribute__((__always_inline__)) constexpr auto
