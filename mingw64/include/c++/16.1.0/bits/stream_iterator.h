...
public:
  ...
  _GLIBCXX_NODISCARD
  const _Tp &operator*() const _GLIBCXX_NOEXCEPT {
...
private:
  bool _M_equal(const istream_iterator &__x) const _GLIBCXX_NOEXCEPT {
  ...
  friend bool operator==(const istream_iterator &__x,
                         const istream_iterator &__y) _GLIBCXX_NOEXCEPT {
...
public:
  ...
  _GLIBCXX_NODISCARD
  ostream_iterator &operator*() _GLIBCXX_NOEXCEPT { return *this; }

  ostream_iterator &operator++() _GLIBCXX_NOEXCEPT { return *this; }

  ostream_iterator &operator++(int) _GLIBCXX_NOEXCEPT { return *this; }
};
