...
private:
  ...
  static constexpr bool __ptr_cmp = requires {
    ...
    } && !requires { std::declval<_Tp>().operator>(std::declval<_Up>()); } &&
  ...
  template <typename _Tp, typename _Up>
  static constexpr bool __ptr_cmp =
...
template <> struct equal_to<void> {
  ...
  template <typename _Tp, typename _Up>
  bool operator()(_Tp &&__t, _Up &&__u) const {
    return __t == __u;
  }
#else // C++98
  template <typename _Tp, typename _Up>
  ...
  template <typename _Tp, typename _Up>
  bool operator()(const _Tp &__t, _Up &__u) const {
    return __t == __u;
  }
  template <typename _Tp, typename _Up>
  bool operator()(_Tp &__t, const _Up &__u) const {
    return __t == __u;
  }
  template <typename _Tp, typename _Up>
  bool operator()(const _Tp &__t, const _Up &__u) const {
    return __t == __u;
  }
#endif
};
...
concept __transparent_comparator = requires { typename _Func::is_transparent; };
#endif
#endif
...
template <> inline constexpr bool __is_std_op_template<std::equal_to> = true;
template <>
inline constexpr bool __is_std_op_template<std::not_equal_to> = true;
template <> inline constexpr bool __is_std_op_template<std::greater> = true;
template <> inline constexpr bool __is_std_op_template<std::less> = true;
template <>
inline constexpr bool __is_std_op_template<std::greater_equal> = true;
template <> inline constexpr bool __is_std_op_template<std::less_equal> = true;
template <> inline constexpr bool __is_std_op_template<std::plus> = true;
template <> inline constexpr bool __is_std_op_template<std::minus> = true;
template <> inline constexpr bool __is_std_op_template<std::multiplies> = true;
template <> inline constexpr bool __is_std_op_template<std::divides> = true;
template <> inline constexpr bool __is_std_op_template<std::modulus> = true;
template <> inline constexpr bool __is_std_op_template<std::negate> = true;
template <> inline constexpr bool __is_std_op_template<std::logical_and> = true;
template <> inline constexpr bool __is_std_op_template<std::logical_or> = true;
template <> inline constexpr bool __is_std_op_template<std::logical_not> = true;
template <> inline constexpr bool __is_std_op_template<std::bit_and> = true;
template <> inline constexpr bool __is_std_op_template<std::bit_or> = true;
template <> inline constexpr bool __is_std_op_template<std::bit_xor> = true;
template <> inline constexpr bool __is_std_op_template<std::bit_not> = true;

template <typename _Fn> constexpr bool __is_std_op_wrapper = false;

template <template <typename> class _Ft, typename _Tp>
constexpr bool __is_std_op_wrapper<_Ft<_Tp>> = __is_std_op_template<_Ft>;
#endif
