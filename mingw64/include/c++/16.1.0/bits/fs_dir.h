...
public:
  ...
  bool is_regular_file() const { return _M_file_type() == file_type::regular; }
...
public:
  ...
  bool operator==(default_sentinel_t) const noexcept { return !_M_dir; }
#endif
...
public:
  ...
  // _GLIBCXX_RESOLVE_LIB_DEFECTS
  // 3719. Directory iterators should be usable with default sentinel
  bool operator==(default_sentinel_t) const noexcept { return !_M_dirs; }
#endif
...
private:
  ...
  recursive_directory_iterator &__erase(error_code * = nullptr);

  friend uintmax_t filesystem::remove_all(const path &, error_code &);
  friend uintmax_t filesystem::remove_all(const path &);
};
