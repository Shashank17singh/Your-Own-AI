...
constexpr basic_vec<_Tp, _Ap> min(const basic_vec<_Tp, _Ap> &__a,
                                  const basic_vec<_Tp, _Ap> &__b) noexcept {
  return __select_impl(__a < __b, __a, __b);
}

template <typename _Tp, typename _Ap>
[[__gnu__::__always_inline__]]
constexpr basic_vec<_Tp, _Ap> max(const basic_vec<_Tp, _Ap> &__a,
                                  const basic_vec<_Tp, _Ap> &__b) noexcept {
...
minmax(const basic_vec<_Tp, _Ap> &__a,
       const basic_vec<_Tp, _Ap> &__b) noexcept {
...
template <typename _Tp, typename _Ap>
[[__gnu__::__always_inline__]]
constexpr basic_vec<_Tp, _Ap> clamp(const basic_vec<_Tp, _Ap> &__v,
                                    const basic_vec<_Tp, _Ap> &__lo,
                                    const basic_vec<_Tp, _Ap> &__hi) {
  __glibcxx_simd_precondition(none_of(__lo > __hi),
...
[[__gnu__::__always_inline__]]
constexpr auto select(const basic_mask<_Bytes, _Ap> &__c, const _Tp &__a,
