...
struct _Rb_tree_node_base {
  ...
  _Base_ptr _M_base_ptr() const _GLIBCXX_NOEXCEPT {
...
template <typename _Val> struct _Rb_tree_node : public _Rb_tree_node_base {
  ...
  _Rb_tree_node *_M_node_ptr() _GLIBCXX_NOEXCEPT { return this; }
};

#if _GLIBCXX_USE_ALLOC_PTR_FOR_RB_TREE
namespace __rb_tree {
template <typename _VoidPtr> struct _Node_base {
...
// Helper type to manage default initialization of node count and header.
template <typename _NodeBase> struct _Header {
private:
...
struct _Node : public __rb_tree::_Node_base<__ptr_rebind<_ValPtr, void>> {
  ...
  value_type *_M_valptr() { return std::addressof(_M_u._M_data); }

  value_type const *_M_valptr() const { return std::addressof(_M_u._M_data); }
...
template <typename _Tp> struct _Rb_tree_iterator {
  ...
  _Rb_tree_iterator &operator++() _GLIBCXX_NOEXCEPT {
    _M_node = _Rb_tree_increment(_M_node);
    return *this;
  }

  _Rb_tree_iterator operator++(int) _GLIBCXX_NOEXCEPT {
...
template <typename _Tp> struct _Rb_tree_const_iterator {
  ...
  _Rb_tree_const_iterator &operator++() _GLIBCXX_NOEXCEPT {
    _M_node = _Rb_tree_increment(_M_node);
    return *this;
  }

  _Rb_tree_const_iterator operator++(int) _GLIBCXX_NOEXCEPT {
...
__attribute__((__nonnull__, __returns_nonnull__)) _Rb_tree_node_base *
_Rb_tree_rebalance_for_erase(_Rb_tree_node_base *const __z,
                             _Rb_tree_node_base &__header) throw();

namespace __rb_tree {
#if _GLIBCXX_USE_ALLOC_PTR_FOR_RB_TREE
template <bool _Const, typename _ValPtr> struct _Iterator {
  ...
  constexpr explicit _Iterator(_Base_ptr __x) noexcept : _M_node(__x) {}
  ...
  constexpr _Iterator(const _Iterator<false, _ValPtr> &__it)
    requires _Const
#else
  template <bool _OtherConst, typename = __enable_if_t<_Const && !_OtherConst>>
  constexpr _Iterator(const _Iterator<_OtherConst, _ValPtr> &__it)
#endif
      : _M_node(__it._M_node) {
  }
  ...
  _GLIBCXX14_CONSTEXPR _Iterator &operator++() noexcept {
    if (_M_node->_M_right) {
  ...
  _GLIBCXX14_CONSTEXPR _Iterator operator++(int) noexcept {
  ...
  [[__nodiscard__]]
  friend bool operator==(const _Iterator &__x,
...
template <typename _Val, typename _Ptr> struct _Node_traits;
...
template <typename _Val> struct _Node_traits<_Val, _Val *> {
  ...
  _S_insert_and_rebalance(const bool __insert_left, _Node_base *__x,
                          _Node_base *__p,
                          _Node_base &__header) _GLIBCXX_USE_NOEXCEPT {
    return _Rb_tree_insert_and_rebalance(__insert_left, __x, __p, __header);
  }

  __attribute__((__nonnull__, __returns_nonnull__)) static _Node_base *
...
struct _Node_traits : _Node_traits<_Val, _Val *> {};
#else
// Primary template used when the allocator uses fancy pointers.
template <typename _Val, typename _ValPtr> struct _Node_traits {
  using _Node = __rb_tree::_Node<_ValPtr>;
  using _Node_ptr = __ptr_rebind<_ValPtr, _Node>;
  using _Node_base = __rb_tree::_Node_base<__ptr_rebind<_ValPtr, void>>;
  ...
  static void _S_insert_and_rebalance(const bool __insert_left, _Base_ptr __x,
                                      _Base_ptr __p, _Node_base &__header) {
  ...
  static _Base_ptr _S_rebalance_for_erase(_Base_ptr __z, _Node_base &__header) {
    ...
    else if (!__y->_M_right) // __z has exactly one non-null child. y == z.
...
class _Rb_tree {
  typedef
      typename __gnu_cxx::__alloc_traits<_Alloc>::template rebind<_Val>::other
          _Val_alloc_type;
  ...
  typedef
      typename __gnu_cxx::__alloc_traits<_Alloc>::template rebind<_Node>::other
          _Node_allocator;
...
private:
  ...
  struct _Reuse_or_alloc_node {
    ...
    template <typename _Arg> _Node_ptr operator()(_GLIBCXX_FWDREF(_Arg) __arg) {
  ...
  struct _Alloc_node {
    ...
    _Node_ptr operator()(_GLIBCXX_FWDREF(_Arg) __arg) const {
      return _M_t._M_create_node(_GLIBCXX_FORWARD(_Arg, __arg));
    }
...
#pragma GCC diagnostic pop
  ...
  void _M_put_node(_Node_ptr __p) _GLIBCXX_NOEXCEPT {
#if __cplusplus < 201102L || _GLIBCXX_USE_ALLOC_PTR_FOR_RB_TREE
...
#pragma GCC diagnostic pop
...
#if __cplusplus < 201103L
  void _M_construct_node(_Node_ptr __node, const value_type &__x) {
    __try {
  ...
  _Node_ptr _M_create_node(const value_type &__x) {
  ...
  void _M_destroy_node(_Node_ptr __p) _GLIBCXX_NOEXCEPT {
#if __cplusplus < 201103L
  ...
  void _M_drop_node(_Node_ptr __p) _GLIBCXX_NOEXCEPT {
    _M_destroy_node(__p);
    _M_put_node(__p);
  }
...
#endif
    _Node_ptr __tmp = __node_gen(_GLIBCXX_FORWARD(_Vp, *__x->_M_valptr()));
  ...
  struct _Rb_tree_impl : public _Node_allocator,
    ...
    _Rb_tree_impl(const _Rb_tree_impl &__x)
        : _Node_allocator(_Node_alloc_traits::_S_select_on_copy(__x)),
          _Base_key_compare(__x._M_key_compare), _Header_t() {}
...
protected:
  ...
  _Base_ptr _M_root() const _GLIBCXX_NOEXCEPT {
    return this->_M_impl._M_header._M_parent;
  }
  ...
  _Base_ptr _M_leftmost() const _GLIBCXX_NOEXCEPT {
    return this->_M_impl._M_header._M_left;
  }
  ...
  _Base_ptr _M_rightmost() const _GLIBCXX_NOEXCEPT {
    return this->_M_impl._M_header._M_right;
  }

  _Base_ptr _M_begin() const _GLIBCXX_NOEXCEPT {
    return this->_M_impl._M_header._M_parent;
  }

  _Node_ptr _M_begin_node() const _GLIBCXX_NOEXCEPT {
    _Base_ptr __begin = this->_M_impl._M_header._M_parent;
    return __begin ? static_cast<_Node &>(*__begin)._M_node_ptr() : _Node_ptr();
  }

  _Base_ptr _M_end() const _GLIBCXX_NOEXCEPT {
  ...
  static const _Key &_S_key(_Node_ptr __x) { return _S_key(*__x); }

  static _Base_ptr _S_left(_Base_ptr __x) _GLIBCXX_NOEXCEPT {
    return __x->_M_left;
  }

  static _Node_ptr _S_left(_Node_ptr __x) {
    return __x->_M_left ? static_cast<_Node &>(*__x->_M_left)._M_node_ptr()
                        : _Node_ptr();
  }

  static _Base_ptr _S_right(_Base_ptr __x) _GLIBCXX_NOEXCEPT {
    return __x->_M_right;
  }

  static _Node_ptr _S_right(_Node_ptr __x) _GLIBCXX_NOEXCEPT {
    return __x->_M_right ? static_cast<_Node &>(*__x->_M_right)._M_node_ptr()
                         : _Node_ptr();
  }
...
public:
  ...
  template <typename... _Args>
  iterator _M_emplace_here(bool __place_left, _Base_ptr __node,
                           _Args &&...__args);

  template <typename _Kt>
  pair<_Base_ptr, _Base_ptr> _M_get_insert_unique_pos_tr(const _Kt &__k);

  template <typename _Kt>
  pair<_Base_ptr, _Base_ptr> _M_get_insert_hint_unique_pos_tr(const_iterator,
                                                              const _Kt &__k);
#endif
...
private:
  ...
  template <typename _Kt>
  _Base_ptr _M_lower_bound_tr(_Base_ptr __x, _Base_ptr __y,
                              const _Kt &__k) const;

  _Base_ptr _M_upper_bound(_Base_ptr __x, _Base_ptr __y, const _Key &__k) const;

  template <typename _Kt>
  _Base_ptr _M_upper_bound_tr(_Base_ptr __x, _Base_ptr __y,
                              const _Kt &__k) const;
...
public:
  ...
  ~_Rb_tree() _GLIBCXX_NOEXCEPT { _M_erase(_M_begin_node()); }
  ...
  iterator end() _GLIBCXX_NOEXCEPT { return iterator(_M_end()); }
...
public:
  ...
  template <typename _Kt> size_type _M_erase_tr(const _Kt &__x);
  ...
  pair<iterator, iterator> _M_equal_range_tr(const _Kt &__k) {
    ...
    return {iterator(__ret.first._M_node), iterator(__ret.second._M_node)};
  }
...
#if __cplusplus >= 201103L
  _Rb_tree &
  operator=(_Rb_tree &&) noexcept(_Node_alloc_traits::_S_nothrow_move() &&
...
public:
  ...
  insert_return_type _M_reinsert_node_unique(node_type &&__nh) {
    ...
    if (__nh.empty())
      ...
      if (__res.second) {
        __ret.position =
            _M_insert_node(__res.first, __res.second, _S_adapt(__nh._M_ptr));
        __nh.release();
        __ret.inserted = true;
      } else {
  ...
  node_type extract(const_iterator __pos) {
    auto __ptr =
        _Node_traits::_S_rebalance_for_erase(__pos._M_node, _M_impl._M_header);
...
#pragma GCC diagnostic pop
  ...
  template <typename _Kt> node_type _M_extract_tr(const _Kt &__k) {
    node_type __nh;
  ...
  template <typename, typename> friend struct _Rb_tree_merge_helper;
  ...
  void _M_merge_unique(_Compatible_tree<_Compare2> &__src) noexcept {
    ...
    for (auto __i = __src.begin(), __end = __src.end(); __i != __end;) {
      ...
      if (__res.second) {
        ...
        auto __ptr = _Node_traits::_S_rebalance_for_erase(__pos._M_node,
...
_Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::operator=(
    _Rb_tree &&__x) noexcept(_Node_alloc_traits::_S_nothrow_move() &&
                             is_nothrow_move_assignable<_Compare>::value) {
  _M_impl._M_key_compare = std::move(__x._M_impl._M_key_compare);
  _M_move_assign(__x, __bool_constant<_Node_alloc_traits::_S_nothrow_move()>());
  return *this;
}
...
_Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::_M_insert_(
  ...
  _Base_ptr __z = __node_gen(_GLIBCXX_FORWARD(_Arg, __v))->_M_base_ptr();

  _Node_traits::_S_insert_and_rebalance(__insert_left, __z, __p,
...
{
  bool __insert_left =
      (__p == _M_end() || !_M_key_compare(_S_key(__p), _KeyOfValue()(__v)));

  _Base_ptr __z = _M_create_node(_GLIBCXX_FORWARD(_Arg, __v))->_M_base_ptr();
  _Node_traits::_S_insert_and_rebalance(__insert_left, __z, __p,
                                        this->_M_impl._M_header);
  ++_M_impl._M_node_count;
  return iterator(__z);
...
#endif
{
  ...
  while (__x) {
    __y = __x;
    __x = !_M_key_compare(_S_key(__x), _KeyOfValue()(__v)) ? _S_left(__x)
                                                           : _S_right(__x);
  }
...
_Rb_tree<_Key, _Val, _KoV, _Compare, _Alloc>::_M_copy(_Node_ptr __x,
                                                      _Base_ptr __p,
                                                      _NodeGen &__node_gen) {
...
_Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::_M_lower_bound(
    _Base_ptr __x, _Base_ptr __y, const _Key &__k) const {
  while (__x)
    if (!_M_key_compare(_S_key(__x), __k))
...
template <typename _Kt>
typename _Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::_Base_ptr
_Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::_M_lower_bound_tr(
    _Base_ptr __x, _Base_ptr __y, const _Kt &__k) const {
  while (__x)
    if (!_M_key_compare(_S_key(__x), __k))
      __y = __x, __x = _S_left(__x);
    else
...
template <typename _Kt>
typename _Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::_Base_ptr
_Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::_M_upper_bound_tr(
    _Base_ptr __x, _Base_ptr __y, const _Kt &__k) const {
  while (__x)
    if (_M_key_compare(__k, _S_key(__x)))
      __y = __x, __x = _S_left(__x);
...
auto _Rb_tree<_Key, _Val, _KeyOfValue, _Compare,
              _Alloc>::_M_get_insert_unique_pos_tr(const _Kt &__k)
...
template <typename _Kt>
auto _Rb_tree<_Key, _Val, _KeyOfValue, _Compare,
              _Alloc>::_M_get_insert_hint_unique_pos_tr(const_iterator __hint,
                                                        const _Kt &__k)
    -> pair<_Base_ptr, _Base_ptr> {
  ...
  if (_M_key_compare(__k, _S_key(__node))) { // First, try before...
  ...
  if (_M_key_compare(_S_key(__node), __k)) { // ... then try after.
...
_Rb_tree<_Key, _Val, _KeyOfValue, _Compare,
  ...
  // end()
  if (__position._M_node == _M_end()) {
    if (size() > 0 && !_M_key_compare(__k, _S_key(_M_rightmost())))
      return _Res(_Base_ptr(), _M_rightmost());
    else
...
auto _Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::_M_insert_node(
    _Base_ptr __x, _Base_ptr __p, _Node_ptr __z) -> iterator {
  bool __insert_left =
      (__x || __p == _M_end() || _M_key_compare(_S_key(__z), _S_key(__p)));

  _Base_ptr __base_z = __z->_M_base_ptr();
  _Node_traits::_S_insert_and_rebalance(__insert_left, __base_z, __p,
                                        this->_M_impl._M_header);
  ++_M_impl._M_node_count;
...
auto _Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::_M_insert_lower_node(
    _Base_ptr __p, _Node_ptr __z) -> iterator {
  bool __insert_left =
      (__p == _M_end() || !_M_key_compare(_S_key(__p), _S_key(__z)));
...
template <typename _Key, typename _Val, typename _KeyOfValue, typename _Compare,
          typename _Alloc>
auto _Rb_tree<_Key, _Val, _KeyOfValue, _Compare,
              _Alloc>::_M_insert_equal_lower_node(_Node_ptr __z) -> iterator {
  _Base_ptr __x = _M_begin();
  _Base_ptr __y = _M_end();
  while (__x) {
    __y = __x;
    __x = !_M_key_compare(_S_key(__x), _S_key(__z)) ? _S_left(__x)
                                                    : _S_right(__x);
  }
...
template <typename _Key, typename _Val, typename _KeyOfValue, typename _Compare,
          typename _Alloc>
template <typename... _Args>
auto _Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::_M_emplace_here(
    bool __place_left, _Base_ptr __node, _Args &&...__args) -> iterator {
  _Auto_node __z(*this, std::forward<_Args>(__args)...);
  _Base_ptr __base_z = __z._M_node->_M_base_ptr();
  _Node_traits::_S_insert_and_rebalance(__place_left, __base_z, __node,
                                        _M_impl._M_header);
  __z._M_node = nullptr;
  ++_M_impl._M_node_count;
  return iterator(__base_z);
...
void _Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::_M_erase_aux(
    const_iterator __position) {
  _Base_ptr __y = _Node_traits::_S_rebalance_for_erase(__position._M_node,
                                                       this->_M_impl._M_header);
...
template <typename _Kt>
typename _Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::size_type
_Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::_M_erase_tr(
    const _Kt &__x) {
...
template <typename _Key, typename _Val, typename _KeyOfValue, typename _Compare,
          typename _Alloc>
typename _Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::size_type
_Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::_M_erase_unique(
    const _Key &__x) {
