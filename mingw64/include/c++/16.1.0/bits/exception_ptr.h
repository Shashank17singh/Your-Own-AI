...
class exception_ptr {
  ...
  template <typename _Ex>
  friend _GLIBCXX26_CONSTEXPR
      exception_ptr std::make_exception_ptr(_Ex) _GLIBCXX_USE_NOEXCEPT;
#if __cpp_lib_exception_ptr_cast >= 202506L
  template <typename _Ex>
  ...
  const void *
  _M_exception_ptr_cast(const type_info &) const _GLIBCXX_USE_NOEXCEPT;
...
public:
...
#if __cplusplus >= 201103L
  _GLIBCXX26_CONSTEXPR exception_ptr &operator=(exception_ptr &&__o) noexcept {
  ...
  _GLIBCXX26_CONSTEXPR void swap(exception_ptr &) _GLIBCXX_USE_NOEXCEPT;
  ...
  operator==(const exception_ptr &__x,
             const exception_ptr &__y) _GLIBCXX_USE_NOEXCEPT {
  ...
  friend _GLIBCXX26_CONSTEXPR void swap(exception_ptr &__lhs,
                                        exception_ptr &__rhs);
...
_GLIBCXX26_CONSTEXPR inline exception_ptr::exception_ptr() _GLIBCXX_USE_NOEXCEPT
    : _M_exception_object(0) {}

_GLIBCXX_EH_PTR_USED
_GLIBCXX26_CONSTEXPR inline exception_ptr::exception_ptr(
...
_GLIBCXX26_CONSTEXPR inline void swap(exception_ptr &__lhs,
                                      exception_ptr &__rhs) {
  __lhs.swap(__rhs);
}
...
/// @cond undocumented
template <typename _Ex>
_GLIBCXX_CDTOR_CALLABI inline void __dest_thunk(void *__x) {
