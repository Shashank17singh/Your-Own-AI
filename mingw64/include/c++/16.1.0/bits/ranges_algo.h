...
template <typename _Comp, typename _Proj> struct _Comp_proj {
  ...
  constexpr _Comp_proj(_Comp &__comp, _Proj &__proj)
...
constexpr _Comp_proj<_Comp, _Proj> __make_comp_proj(_Comp &__comp,
                                                    _Proj &__proj) {
  return {__comp, __proj};
}

template <typename _Pred, typename _Proj> struct _Pred_proj {
  [[no_unique_address]] __by_ref_or_value_fn<_Pred> _M_pred;
  [[no_unique_address]] __by_ref_or_value_fn<_Proj> _M_proj;

  constexpr _Pred_proj(_Pred &__pred, _Proj &__proj)
      : _M_pred(__pred), _M_proj(__proj) {}

  template <typename _Tp> constexpr bool operator()(_Tp &&__x) {
...
constexpr _Pred_proj<_Pred, _Proj> __make_pred_proj(_Pred &__pred,
                                                    _Proj &__proj) {
...
struct __all_of_fn {
  ...
  [[nodiscard]] constexpr bool operator()(_Iter __first, _Sent __last,
                                          _Pred __pred,
                                          _Proj __proj = {}) const {
  ...
  [[nodiscard]] constexpr bool operator()(_Range &&__r, _Pred __pred,
                                          _Proj __proj = {}) const {
...
struct __find_first_of_fn {
  ...
  operator()(_Range1 &&__r1, _Range2 &&__r2, _Pred __pred = {},
    ...
    return (*this)(ranges::begin(__r1), ranges::end(__r1), ranges::begin(__r2),
                   ranges::end(__r2), std::move(__pred), std::move(__proj1),
                   std::move(__proj2));
  }
};
...
struct __count_fn {
  ...
  template <input_range _Range, typename _Proj = identity,
            typename _Tp _GLIBCXX26_RANGE_ALGO_DEF_VAL_T(iterator_t<_Range>,
                                                         _Proj)>
...
struct __search_n_fn {
  ...
  template <forward_range _Range, typename _Pred = ranges::equal_to,
            typename _Proj = identity,
            typename _Tp _GLIBCXX26_RANGE_ALGO_DEF_VAL_T(iterator_t<_Range>,
                                                         _Proj)>
...
struct __starts_with_fn {
  ...
  constexpr bool operator()(_Iter1 __first1, _Sent1 __last1, _Iter2 __first2,
    ...
    return _S_impl(std::move(__first1), __last1, __n1, std::move(__first2),
                   __last2, __n2, std::move(__pred), std::move(__proj1),
                   std::move(__proj2));
  }
...
private:
  ...
  static constexpr bool _S_impl(_Iter1 __first1, _Sent1 __last1,
                                iter_difference_t<_Iter1> __n1, _Iter2 __first2,
                                _Sent2 __last2, iter_difference_t<_Iter2> __n2,
                                _Pred __pred, _Proj1 __proj1, _Proj2 __proj2) {
    if (__first2 == __last2) [[unlikely]]
      return true;
    else if (__n1 == -1 || __n2 == -1)
      return ranges::mismatch(std::move(__first1), __last1, std::move(__first2),
  ...
  static constexpr bool _S_impl(_Iter1 __first1, _Sent1 __last1,
    ...
    if constexpr (!random_access_iterator<_Iter1> &&
      ...
      return starts_with._S_impl(std::make_reverse_iterator(__last1),
                                 std::make_reverse_iterator(__first1), __n1,
                                 std::make_reverse_iterator(__last2),
                                 std::make_reverse_iterator(__first2), __n2,
                                 std::move(__pred), std::move(__proj1),
                                 std::move(__proj2));
    ...
    if (__n1 != -1) {
      ...
      if (random_access_iterator<_Iter1> || !bidirectional_iterator<_Iter1> ||
          !same_as<_Iter1, _Sent1> || __shift < __n2) {
        ranges::advance(__first1, __shift);
        return ranges::equal(std::move(__first1), __last1, std::move(__first2),
                             __last2, std::move(__pred), std::move(__proj1),
                             std::move(__proj2));
      }
    }
    ...
    if constexpr (bidirectional_iterator<_Iter1> && same_as<_Iter1, _Sent1>) {
      ...
      return ranges::equal(__it1, __last1, std::move(__first2), __last2,
                           std::move(__pred), std::move(__proj1),
                           std::move(__proj2));
      ...
      return ranges::equal(__first1, __last1, std::move(__first2), __last2,
                           std::move(__pred), std::move(__proj1),
                           std::move(__proj2));
    } else
...
struct __find_end_fn {
  ...
  operator()(_Iter1 __first1, _Sent1 __last1, _Iter2 __first2, _Sent2 __last2,
    ...
    if constexpr (bidirectional_iterator<_Iter1> &&
      ...
      for (;;) {
        auto __new_range = ranges::search(__first1, __last1, __first2, __last2,
...
struct __is_permutation_fn {
  ...
  operator()(_Iter1 __first1, _Sent1 __last1, _Iter2 __first2, _Sent2 __last2,
    ...
    for (auto __scan = __first1; __scan != __last1; ++__scan) {
      ...
      auto &&__proj_scan = std::__invoke(
          __proj1, std::forward<decltype(__scan_deref)>(__scan_deref));
      ...
      if (__matches == 0 ||
          ranges::count_if(__scan, __last1, __comp_scan, __proj1) != __matches)
        return false;
    }
    return true;
  }
  ...
  template <
      forward_range _Range1, forward_range _Range2, typename _Proj1 = identity,
      typename _Proj2 = identity,
...
struct __copy_if_fn {
  ...
  constexpr copy_if_result<_Iter, _Out> operator()(_Iter __first, _Sent __last,
                                                   _Out __result, _Pred __pred,
                                                   _Proj __proj = {}) const {
    for (; __first != __last; ++__first)
      if (std::__invoke(__pred, std::__invoke(__proj, *__first))) {
        *__result = *__first;
  ...
  template <
      input_range _Range, weakly_incrementable _Out, typename _Proj = identity,
      indirect_unary_predicate<projected<iterator_t<_Range>, _Proj>> _Pred>
...
struct __transform_fn {
  ...
  operator()(_Iter1 __first1, _Sent1 __last1, _Iter2 __first2, _Sent2 __last2,
    ...
    for (; __first1 != __last1 && __first2 != __last2;
      ...
      *__result = std::__invoke(__binary_op, std::__invoke(__proj1, *__first1),
                                std::__invoke(__proj2, *__first2));
    return {std::move(__first1), std::move(__first2), std::move(__result)};
  }

  template <input_range _Range1, input_range _Range2, weakly_incrementable _Out,
            copy_constructible _Fp, typename _Proj1 = identity,
            typename _Proj2 = identity>
    requires indirectly_writable<
  ...
  operator()(_Range1 &&__r1, _Range2 &&__r2, _Out __result, _Fp __binary_op,
             _Proj1 __proj1 = {}, _Proj2 __proj2 = {}) const {
    return (*this)(ranges::begin(__r1), ranges::end(__r1), ranges::begin(__r2),
                   ranges::end(__r2), std::move(__result),
                   std::move(__binary_op), std::move(__proj1),
                   std::move(__proj2));
  }
};
...
struct __replace_fn {
  ...
  template <input_range _Range, typename _Proj = identity,
            typename _Tp1 _GLIBCXX26_RANGE_ALGO_DEF_VAL_T(iterator_t<_Range>,
                                                          _Proj),
...
struct __replace_copy_fn {
  template <input_iterator _Iter, sentinel_for<_Iter> _Sent, typename _Out,
            typename _Proj = identity,
            typename _Tp1 _GLIBCXX26_RANGE_ALGO_DEF_VAL_T(_Iter, _Proj),
  ...
  template <input_range _Range, typename _Out, typename _Proj = identity,
            typename _Tp1 _GLIBCXX26_RANGE_ALGO_DEF_VAL_T(iterator_t<_Range>,
                                                          _Proj),
            typename _Tp2 _GLIBCXX26_DEF_VAL_T(iter_value_t<_Out>)>
    requires indirectly_copyable<iterator_t<_Range>, _Out> &&
...
struct __replace_copy_if_fn {
  ...
  template <
      input_range _Range, typename _Out,
      typename _Tp _GLIBCXX26_DEF_VAL_T(iter_value_t<_Out>),
      typename _Proj = identity,
      indirect_unary_predicate<projected<iterator_t<_Range>, _Proj>> _Pred>
    requires indirectly_copyable<iterator_t<_Range>, _Out> &&
  ...
  operator()(_Range &&__r, _Out __result, _Pred __pred, const _Tp &__new_value,
             _Proj __proj = {}) const {
    return (*this)(ranges::begin(__r), ranges::end(__r), std::move(__result),
...
struct __remove_if_fn {
  template <permutable _Iter, sentinel_for<_Iter> _Sent,
            typename _Proj = identity,
            indirect_unary_predicate<projected<_Iter, _Proj>> _Pred>
  [[nodiscard]] constexpr subrange<_Iter> operator()(_Iter __first,
                                                     _Sent __last, _Pred __pred,
                                                     _Proj __proj = {}) const {
...
struct __remove_copy_fn {
  ...
  template <
      input_range _Range, weakly_incrementable _Out, typename _Proj = identity,
      typename _Tp _GLIBCXX26_RANGE_ALGO_DEF_VAL_T(iterator_t<_Range>, _Proj)>
    requires indirectly_copyable<iterator_t<_Range>, _Out> &&
             indirect_binary_predicate<ranges::equal_to,
                                       projected<iterator_t<_Range>, _Proj>,
                                       const _Tp *>
...
struct __unique_copy_fn {
  ...
  operator()(_Iter __first, _Sent __last, _Out __result, _Comp __comp = {},
    ...
    } else // indirectly_copyable_storable<_Iter, _Out>
    {
      ...
      *__result = __value;
      while (++__first != __last) {
        if (!(bool)std::__invoke(__comp, std::__invoke(__proj, __value),
                                 std::__invoke(__proj, *__first))) {
          __value = *__first;
          *++__result = __value;
        }
...
struct __sample_fn {
  ...
  _Out operator()(_Iter __first, _Sent __last, _Out __out,
    ...
    if constexpr (forward_iterator<_Iter>) {
      ...
      using __distrib_type = uniform_int_distribution<iter_difference_t<_Iter>>;
      using __param_type = typename __distrib_type::param_type;
      __distrib_type __d{};
  ...
  _Out operator()(_Range &&__r, _Out __out, range_difference_t<_Range> __n,
                  _Gen &&__g) const {
    return (*this)(ranges::begin(__r), ranges::end(__r), std::move(__out), __n,
...
struct __shuffle_fn {
  ...
  _Iter operator()(_Iter __first, _Sent __last, _Gen &&__g) const {
    ...
    for (; __i != __last; ++__i)
      ranges::iter_swap(
          __i, ranges::next(__first, __d(__g, __p_type(0, __i - __first))));
  ...
  borrowed_iterator_t<_Range> operator()(_Range &&__r, _Gen &&__g) const {
    if constexpr (sized_range<_Range> &&
                  !sized_sentinel_for<sentinel_t<_Range>, iterator_t<_Range>>)
...
constexpr void __push_heap(_Iter __first, iter_difference_t<_Iter> __holeIndex,
                           iter_difference_t<_Iter> __topIndex,
                           iter_value_t<_Iter> __value, _Comp __comp) {
...
struct __push_heap_fn {
  ...
  constexpr _Iter operator()(_Iter __first, _Sent __last, _Comp __comp = {},
    ...
    if constexpr (!same_as<_Iter, _Sent>)
      return (*this)(__first, ranges::next(__first, __last), std::move(__comp),
                     std::move(__proj));
    else {
      auto __comp_proj = __detail::__make_comp_proj(__comp, __proj);
      iter_value_t<_Iter> __value(ranges::iter_move(ranges::prev(__last)));
      __detail::__push_heap(__first, (__last - __first) - 1, 0,
                            std::move(__value), __comp_proj);
      return __last;
    }
  }
...
namespace __detail {
template <typename _Iter, typename _Comp>
constexpr void __adjust_heap(_Iter __first,
  ...
  __detail::__push_heap(__first, __holeIndex, __topIndex, std::move(__value),
                        __comp);
}

template <typename _Iter, typename _Comp>
constexpr void __pop_heap(_Iter __first, _Iter __last, _Iter __result,
                          _Comp __comp) {
  iter_value_t<_Iter> __value = ranges::iter_move(__result);
  *__result = ranges::iter_move(__first);
  __detail::__adjust_heap(__first, 0, __last - __first, std::move(__value),
                          __comp);
}
} // namespace __detail
  ...
  constexpr _Iter operator()(_Iter __first, _Sent __last, _Comp __comp = {},
    ...
    if constexpr (!same_as<_Iter, _Sent>)
      ...
      while (true) {
        ...
        __detail::__adjust_heap(__first, __parent, __len, std::move(__value),
                                __comp_proj);
        if (__parent == 0)
          break;
        __parent--;
...
struct __is_heap_until_fn {
  template <
      random_access_iterator _Iter, sentinel_for<_Iter> _Sent,
      typename _Proj = identity,
...
struct __is_heap_fn {
  ...
  constexpr bool operator()(_Iter __first, _Sent __last, _Comp __comp = {},
                            _Proj __proj = {}) const {
    return (__last == ranges::is_heap_until(__first, __last, std::move(__comp),
                                            std::move(__proj)));
  }
...
namespace __detail {
template <typename _Iter, typename _Comp>
constexpr void __move_median_to_first(_Iter __result, _Iter __a, _Iter __b,
                                      _Iter __c, _Comp __comp) {
  if (__comp(*__a, *__b)) {
    if (__comp(*__b, *__c))
...
template <typename _Iter, typename _Comp>
constexpr void __unguarded_linear_insert(_Iter __last, _Comp __comp) {
...
template <typename _Iter, typename _Comp>
constexpr void __insertion_sort(_Iter __first, _Iter __last, _Comp __comp) {
  if (__first == __last)
    return;
...
template <typename _Iter, typename _Comp>
constexpr void __unguarded_insertion_sort(_Iter __first, _Iter __last,
                                          _Comp __comp) {
...
template <typename _Iter, typename _Comp>
constexpr void __final_insertion_sort(_Iter __first, _Iter __last,
                                      _Comp __comp) {
  ...
  if (__last - __first > __threshold) {
    ...
    __detail::__unguarded_insertion_sort(__first + __threshold, __last, __comp);
  } else
    __detail::__insertion_sort(__first, __last, __comp);
}

template <typename _Iter, typename _Comp>
constexpr _Iter __unguarded_partition(_Iter __first, _Iter __last,
                                      _Iter __pivot, _Comp __comp) {
  while (true) {
...
template <typename _Iter, typename _Comp>
constexpr _Iter __unguarded_partition_pivot(_Iter __first, _Iter __last,
                                            _Comp __comp) {
  ...
  return __detail::__unguarded_partition(ranges::next(__first), __last, __first,
                                         __comp);
}

template <typename _Iter, typename _Comp>
constexpr void __heap_select(_Iter __first, _Iter __middle, _Iter __last,
                             _Comp __comp) {
...
template <typename _Iter, typename _Comp>
constexpr void __partial_sort(_Iter __first, _Iter __middle, _Iter __last,
                              _Comp __comp) {
...
template <typename _Iter, typename _Comp>
constexpr void __introsort_loop(_Iter __first, _Iter __last,
                                unsigned __depth_limit, _Comp __comp) {
...
_Out __move_merge(_Iter __first1, _Iter __last1, _Iter __first2, _Iter __last2,
  ...
  return ranges::move(__first2, __last2,
                      ranges::move(__first1, __last1, __result).out)
      .out;
}

template <typename _Iter, typename _Out, typename _Distance, typename _Comp>
void __merge_sort_loop(_Iter __first, _Iter __last, _Out __result,
  ...
  __detail::__move_merge(__first, __first + __step_size, __first + __step_size,
                         __last, __result, __comp);
}

template <typename _Iter, typename _Distance, typename _Compare>
constexpr void __chunk_insertion_sort(_Iter __first, _Iter __last,
...
void __merge_sort_with_buffer(_Iter __first, _Iter __last, _Pointer __buffer,
                              _Comp __comp) {
  ...
  while (__step_size < __len) {
    __detail::__merge_sort_loop(__first, __last, __buffer, __step_size, __comp);
    __step_size *= 2;
...
template <typename _Iter, typename _Pointer, typename _Comp>
void __merge_adaptive(_Iter __first, _Iter __middle, _Iter __last,
                      iter_difference_t<_Iter> __len1,
                      iter_difference_t<_Iter> __len2, _Pointer __buffer,
                      _Comp __comp); // defined near inplace_merge

template <typename _Iter, typename _Distance, typename _Pointer, typename _Comp>
void __merge_adaptive_resize(_Iter __first, _Iter __middle, _Iter __last,
...
template <typename _Iter, typename _Pointer, typename _Comp>
void __stable_sort_adaptive(_Iter __first, _Iter __middle, _Iter __last,
  ...
  __detail::__merge_adaptive(__first, __middle, __last, __middle - __first,
                             __last - __middle, __buffer, __comp);
}

template <typename _Iter, typename _Pointer, typename _Distance, typename _Comp>
void __stable_sort_adaptive_resize(_Iter __first, _Iter __last,
                                   _Pointer __buffer, _Distance __buffer_size,
                                   _Comp __comp) {
  ...
  if (__len > __buffer_size) {
    ...
    __detail::__stable_sort_adaptive(__first, __middle, __last, __buffer,
                                     __comp);
}

template <typename _Iter, typename _Comp>
constexpr void __inplace_stable_sort(_Iter __first, _Iter __last,
                                     _Comp __comp) {
  ...
  __detail::__merge_without_buffer(
      __first, __middle, __last, __middle - __first, __last - __middle, __comp);
}
} // namespace __detail
...
struct __stable_sort_fn {
  template <random_access_iterator _Iter, sentinel_for<_Iter> _Sent,
            typename _Comp = ranges::less, typename _Proj = identity>
    requires sortable<_Iter, _Comp, _Proj>
  _GLIBCXX26_CONSTEXPR _Iter operator()(_Iter __first, _Sent __last,
                                        _Comp __comp = {},
                                        _Proj __proj = {}) const {
    if constexpr (!same_as<_Iter, _Sent>)
      return (*this)(__first, ranges::next(__first, __last), std::move(__comp),
  ...
  template <random_access_range _Range, typename _Comp = ranges::less,
            typename _Proj = identity>
    requires sortable<iterator_t<_Range>, _Comp, _Proj>
  _GLIBCXX26_CONSTEXPR borrowed_iterator_t<_Range>
  operator()(_Range &&__r, _Comp __comp = {}, _Proj __proj = {}) const {
    return (*this)(ranges::begin(__r), ranges::end(__r), std::move(__comp),
                   std::move(__proj));
  }
    ...
    for (; __first != __last; ++__first)
      if (std::__invoke(__comp, std::__invoke(__proj1, *__first),
        ...
        *ranges::prev(__result_real_last) = *__first;
        ranges::push_heap(__result_first, __result_real_last, __comp, __proj2);
      }
...
struct __is_sorted_until_fn {
  template <
      ...
      typename _Proj = identity,
      indirect_strict_weak_order<projected<_Iter, _Proj>> _Comp = ranges::less>
  [[nodiscard]] constexpr _Iter operator()(_Iter __first, _Sent __last,
                                           _Comp __comp = {},
                                           _Proj __proj = {}) const {
    if (__first == __last)
      return __first;
...
struct __is_sorted_fn {
  ...
  template <forward_range _Range, typename _Proj = identity,
            indirect_strict_weak_order<projected<iterator_t<_Range>, _Proj>>
                _Comp = ranges::less>
  [[nodiscard]] constexpr bool operator()(_Range &&__r, _Comp __comp = {},
                                          _Proj __proj = {}) const {
    return (*this)(ranges::begin(__r), ranges::end(__r), std::move(__comp),
                   std::move(__proj));
  }
...
namespace __detail {
template <typename _Iter, typename _Comp>
constexpr void __introselect(_Iter __first, _Iter __nth, _Iter __last,
                             iter_difference_t<_Iter> __depth_limit,
                             _Comp __comp) {
  while (__last - __first > 3) {
    if (__depth_limit == 0) {
      __detail::__heap_select(__first, ranges::next(__nth), __last, __comp);
...
struct __nth_element_fn {
  ...
  constexpr _Iter operator()(_Iter __first, _Iter __nth, _Sent __last,
    ...
    if constexpr (!same_as<_Iter, _Sent>)
      ...
      auto __comp_proj = __detail::__make_comp_proj(__comp, __proj);
      auto __n = __detail::__to_unsigned_like(__last - __first);
      __detail::__introselect(__first, __nth, __last, std::__bit_width(__n) * 2,
                              __comp_proj);
      return __last;
    }
  }
...
struct __lower_bound_fn {
  ...
  operator()(_Iter __first, _Sent __last, const _Tp &__value, _Comp __comp = {},
             _Proj __proj = {}) const {
...
struct __binary_search_fn {
  ...
  template <forward_range _Range, typename _Proj = identity,
            ...
            indirect_strict_weak_order<const _Tp *,
                                       projected<iterator_t<_Range>, _Proj>>
                _Comp = ranges::less>
  [[nodiscard]] constexpr bool operator()(_Range &&__r, const _Tp &__value,
                                          _Comp __comp = {},
                                          _Proj __proj = {}) const {
    return (*this)(ranges::begin(__r), ranges::end(__r), __value,
                   std::move(__comp), std::move(__proj));
    ...
    if constexpr (bidirectional_iterator<_Iter>) {
      ...
      for (;;) {
        ...
        for (;;)
          if (__first == __tail)
            return {std::move(__first), std::move(__lasti)};
          else if (!(bool)std::__invoke(__pred, std::__invoke(__proj, *__tail)))
            --__tail;
          else
            break;
        ranges::iter_swap(__first, __tail);
...
constexpr _Iter __find_if_not_n(_Iter __first, _Distance &__len, _Pred __pred) {
...
template <typename _Iter, typename _Sent, typename _Pointer, typename _Pred,
          typename _Distance>
constexpr subrange<_Iter>
__stable_partition_adaptive(_Iter __first, _Sent __last, _Pred __pred,
  ...
  _Iter __right_split =
      __detail::__find_if_not_n(__middle, __right_len, __pred);

  if (__right_len)
    __right_split =
        __detail::__stable_partition_adaptive(
...
struct __stable_partition_fn {
  template <bidirectional_iterator _Iter, sentinel_for<_Iter> _Sent,
            ...
            indirect_unary_predicate<projected<_Iter, _Proj>> _Pred>
    requires permutable<_Iter>
  _GLIBCXX26_CONSTEXPR subrange<_Iter> operator()(_Iter __first, _Sent __last,
                                                  _Pred __pred,
                                                  _Proj __proj = {}) const {
    ...
    if consteval {
      ...
      *__first = std::move(__buf);
      return __detail::__stable_partition_adaptive(
          __first, __last, __pred_proj, __len, &__buf, _DistanceType(1));
    }
#endif

    _Temporary_buffer<_Iter, iter_value_t<_Iter>> __buf(__first,
                                                        ptrdiff_t(__len));
    return __detail::__stable_partition_adaptive(__first, __last, __pred_proj,
                                                 __len, __buf.begin(),
                                                 _DistanceType(__buf.size()));
  }
  ...
  template <
      ...
      indirect_unary_predicate<projected<iterator_t<_Range>, _Proj>> _Pred>
    requires permutable<iterator_t<_Range>>
  _GLIBCXX26_CONSTEXPR borrowed_subrange_t<_Range>
  operator()(_Range &&__r, _Pred __pred, _Proj __proj = {}) const {
    return (*this)(ranges::begin(__r), ranges::end(__r), std::move(__pred),
                   std::move(__proj));
  }
...
struct __partition_copy_fn {
  ...
  operator()(_Range &&__r, _Out1 __out_true, _Out2 __out_false, _Pred __pred,
             _Proj __proj = {}) const {
    return (*this)(ranges::begin(__r), ranges::end(__r), std::move(__out_true),
...
struct __merge_fn {
  ...
  operator()(_Range1 &&__r1, _Range2 &&__r2, _Out __result, _Comp __comp = {},
             _Proj1 __proj1 = {}, _Proj2 __proj2 = {}) const {
    return (*this)(ranges::begin(__r1), ranges::end(__r1), ranges::begin(__r2),
                   ranges::end(__r2), std::move(__result), std::move(__comp),
                   std::move(__proj1), std::move(__proj2));
  }
};
...
void __move_merge_adaptive(_Iter1 __first1, _Iter1 __last1, _Iter2 __first2,
                           _Iter2 __last2, _Out __result, _Comp __comp) {
  while (__first1 != __last1 && __first2 != __last2) {
    if (__comp(*__first2, *__first1)) {
      *__result = ranges::iter_move(__first2);
      ++__first2;
...
void __move_merge_adaptive_backward(_Iter1 __first1, _Iter1 __last1,
...
template <typename _Iter1, typename _Iter2>
_Iter1 __rotate_adaptive(_Iter1 __first, _Iter1 __middle, _Iter1 __last,
                         iter_difference_t<_Iter1> __len1,
                         iter_difference_t<_Iter1> __len2, _Iter2 __buffer,
...
void __merge_adaptive_resize(_Iter __first, _Iter __middle, _Iter __last,
  ...
  if (__len1 <= __buffer_size || __len2 <= __buffer_size)
    ...
    if (__len1 > __len2) {
      ...
      __second_cut =
          ranges::lower_bound(__middle, __last, *__first_cut, __comp);
      __len22 = ranges::distance(__middle, __second_cut);
    } else {
      __len22 = __len2 / 2;
      ranges::advance(__second_cut, __len22);
      __first_cut =
          ranges::upper_bound(__first, __middle, *__second_cut, __comp);
      __len11 = ranges::distance(__first, __first_cut);
    }

    _Iter __new_middle = __detail::__rotate_adaptive(
    ...
    __detail::__merge_adaptive_resize(__first, __first_cut, __new_middle,
                                      __len11, __len22, __buffer, __buffer_size,
                                      __comp);
    __detail::__merge_adaptive_resize(
...
template <typename _Iter, typename _Distance, typename _Comp>
constexpr void __merge_without_buffer(_Iter __first, _Iter __middle,
                                      _Iter __last, _Distance __len1,
                                      _Distance __len2, _Comp __comp) {
  ...
  _Iter __new_middle =
      ranges::rotate(__first_cut, __middle, __second_cut).begin();
  __detail::__merge_without_buffer(__first, __first_cut, __new_middle, __len11,
                                   __len22, __comp);
...
struct __inplace_merge_fn {
  template <bidirectional_iterator _Iter, sentinel_for<_Iter> _Sent,
            typename _Comp = ranges::less, typename _Proj = identity>
    requires sortable<_Iter, _Comp, _Proj>
  _GLIBCXX26_CONSTEXPR _Iter operator()(_Iter __first, _Iter __middle,
                                        _Sent __last, _Comp __comp = {},
                                        _Proj __proj = {}) const {
    if constexpr (!same_as<_Iter, _Sent>)
...
struct __includes_fn {
  ...
  operator()(_Range1 &&__r1, _Range2 &&__r2, _Comp __comp = {},
             _Proj1 __proj1 = {}, _Proj2 __proj2 = {}) const {
    return (*this)(ranges::begin(__r1), ranges::end(__r1), ranges::begin(__r2),
                   ranges::end(__r2), std::move(__comp), std::move(__proj1),
                   std::move(__proj2));
  }
};
...
struct __max_fn {
  template <typename _Tp, typename _Proj = identity,
            indirect_strict_weak_order<projected<const _Tp *, _Proj>> _Comp =
                ranges::less>
  [[nodiscard]] constexpr const _Tp &operator()(const _Tp &__a, const _Tp &__b,
                                                _Comp __comp = {},
                                                _Proj __proj = {}) const {
  ...
  template <copyable _Tp, typename _Proj = identity,
            indirect_strict_weak_order<projected<const _Tp *, _Proj>> _Comp =
                ranges::less>
  [[nodiscard]] constexpr _Tp operator()(initializer_list<_Tp> __r,
                                         _Comp __comp = {},
                                         _Proj __proj = {}) const {
...
struct __minmax_fn {
  ...
  operator()(initializer_list<_Tp> __r, _Comp __comp = {},
             _Proj __proj = {}) const {
    return (*this)(ranges::subrange(__r), std::move(__comp), std::move(__proj));
  }
};
  ...
  operator()(_Iter __first, _Sent __last, const _Tp &__value,
    ...
    if constexpr (same_as<_Iter, _Sent> && bidirectional_iterator<_Iter>) {
      _Iter __found = ranges::find(reverse_iterator<_Iter>{__last},
                                   reverse_iterator<_Iter>{__first}, __value,
                                   std::move(__proj))
                          .base();
      if (__found == __first)
...
struct __find_last_if_fn {
  ...
  [[nodiscard]] constexpr subrange<_Iter> operator()(_Iter __first,
    ...
    if constexpr (same_as<_Iter, _Sent> && bidirectional_iterator<_Iter>) {
      ...
      for (;;) {
        __first =
            ranges::find_if(ranges::next(__first), __last, __pred, __proj);
        if (__first == __last)
          return {__found, __first};
        __found = __first;
      }
...
struct __find_last_if_not_fn {
  ...
  [[nodiscard]] constexpr subrange<_Iter> operator()(_Iter __first,
    ...
    if constexpr (same_as<_Iter, _Sent> && bidirectional_iterator<_Iter>) {
      ...
      for (;;) {
        __first =
            ranges::find_if_not(ranges::next(__first), __last, __pred, __proj);
        if (__first == __last)
          return {__found, __first};
        __found = __first;
      }
...
template <typename _Iter, typename _Tp> struct in_value_result {
  [[no_unique_address]] _Iter in;
  ...
  constexpr operator in_value_result<_Iter2, _Tp2>() const & {
    return {in, value};
  }

  template <typename _Iter2, typename _Tp2>
    requires convertible_to<_Iter, _Iter2> && convertible_to<_Tp, _Tp2>
  constexpr operator in_value_result<_Iter2, _Tp2>() && {
    return {std::move(in), std::move(value)};
  }
};

namespace __detail {
template <typename _Fp> class __flipped {
  _Fp _M_f;

public:
  template <typename _Tp, typename _Up>
    requires invocable<_Fp &, _Up, _Tp>
  invoke_result_t<_Fp &, _Up, _Tp> operator()(_Tp &&, _Up &&); // not defined
};

template <typename _Fp, typename _Tp, typename _Iter, typename _Up>
concept __indirectly_binary_left_foldable_impl =
    movable<_Tp> && movable<_Up> && convertible_to<_Tp, _Up> &&
    invocable<_Fp &, _Up, iter_reference_t<_Iter>> &&
    assignable_from<_Up &,
                    invoke_result_t<_Fp &, _Up, iter_reference_t<_Iter>>>;

template <typename _Fp, typename _Tp, typename _Iter>
concept __indirectly_binary_left_foldable =
    copy_constructible<_Fp> && indirectly_readable<_Iter> &&
    invocable<_Fp &, _Tp, iter_reference_t<_Iter>> &&
    convertible_to<
        invoke_result_t<_Fp &, _Tp, iter_reference_t<_Iter>>,
...
struct __fold_left_with_iter_fn {
  template <typename _Ret_iter, typename _Iter, typename _Sent, typename _Tp,
            typename _Fp>
  static constexpr auto _S_impl(_Iter __first, _Sent __last, _Tp __init,
                                _Fp __f) {
  ...
  constexpr auto operator()(_Iter __first, _Sent __last, _Tp __init,
                            _Fp __f) const {
    using _Ret_iter = _Iter;
    return _S_impl<_Ret_iter>(std::move(__first), __last, std::move(__init),
                              std::move(__f));
  }
  ...
  constexpr auto operator()(_Range &&__r, _Tp __init, _Fp __f) const {
...
struct __fold_left_fn {
  ...
  template <
      ...
      __detail::__indirectly_binary_left_foldable<_Tp, iterator_t<_Range>> _Fp>
  constexpr auto operator()(_Range &&__r, _Tp __init, _Fp __f) const {
    return (*this)(ranges::begin(__r), ranges::end(__r), std::move(__init),
                   std::move(__f));
  }
};
...
struct __fold_left_first_with_iter_fn {
  ...
  static constexpr auto _S_impl(_Iter __first, _Sent __last, _Fp __f) {
  ...
  template <
      ...
      __detail::__indirectly_binary_left_foldable<iter_value_t<_Iter>, _Iter>
          _Fp>
    requires constructible_from<iter_value_t<_Iter>, iter_reference_t<_Iter>>
  constexpr auto operator()(_Iter __first, _Sent __last, _Fp __f) const {
    using _Ret_iter = _Iter;
    return _S_impl<_Ret_iter>(std::move(__first), __last, std::move(__f));
  }

  template <input_range _Range, __detail::__indirectly_binary_left_foldable<
                                    range_value_t<_Range>, iterator_t<_Range>>
                                    _Fp>
    requires constructible_from<range_value_t<_Range>,
                                range_reference_t<_Range>>
  constexpr auto operator()(_Range &&__r, _Fp __f) const {
    using _Ret_iter = borrowed_iterator_t<_Range>;
    return _S_impl<_Ret_iter>(ranges::begin(__r), ranges::end(__r),
                              std::move(__f));
  }
...
struct __fold_right_last_fn {
  template <
      ...
      __detail::__indirectly_binary_right_foldable<iter_value_t<_Iter>, _Iter>
          _Fp>
    requires constructible_from<iter_value_t<_Iter>, iter_reference_t<_Iter>>
  constexpr auto operator()(_Iter __first, _Sent __last, _Fp __f) const {
    using _Up = decltype(ranges::fold_right(
        __first, __last, iter_value_t<_Iter>(*__first), __f));
  ...
  template <bidirectional_range _Range,
            __detail::__indirectly_binary_right_foldable<range_value_t<_Range>,
                                                         iterator_t<_Range>>
                _Fp>
    requires constructible_from<range_value_t<_Range>,
                                range_reference_t<_Range>>
