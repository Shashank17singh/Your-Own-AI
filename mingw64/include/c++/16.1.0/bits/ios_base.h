...
_GLIBCXX_NODISCARD _GLIBCXX_CONSTEXPR inline _Ios_Fmtflags
...
inline const _Ios_Fmtflags &operator|=(_Ios_Fmtflags &__a,
                                       _Ios_Fmtflags __b) _GLIBCXX_NOTHROW {
  return __a = __a | __b;
}
...
_GLIBCXX_NODISCARD _GLIBCXX_CONSTEXPR inline _Ios_Openmode
...
inline const _Ios_Openmode &operator|=(_Ios_Openmode &__a,
                                       _Ios_Openmode __b) _GLIBCXX_NOTHROW {
  return __a = __a | __b;
}
...
_GLIBCXX_NODISCARD _GLIBCXX_CONSTEXPR inline _Ios_Iostate
...
inline const _Ios_Iostate &operator|=(_Ios_Iostate &__a,
                                      _Ios_Iostate __b) _GLIBCXX_NOTHROW {
  return __a = __a | __b;
}
...
public:
  ...
  public:
    ...
    explicit failure(const string &__s, const error_code &) noexcept
        : failure(__s) {}

    explicit failure(const char *__s, const error_code & = error_code{})
        : failure(string(__s)) {}
  ...
  typedef std::streampos
      streampos _GLIBCXX_DEPRECATED_SUGGEST("std::streampos");
  typedef std::streamoff
      streamoff _GLIBCXX_DEPRECATED_SUGGEST("std::streamoff");
#endif
