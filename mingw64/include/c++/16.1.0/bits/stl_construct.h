...
template <typename _Tp, typename... _Args>
_GLIBCXX20_CONSTEXPR inline void _Construct(_Tp *__p, _Args &&...__args) {
#if __cpp_constexpr_dynamic_alloc // >= C++20
...
_GLIBCXX26_CONSTEXPR inline void _Construct_novalue(_T1 *__p) {
...
_Destroy_n(_ForwardIterator __first, _Size __count) {
  ...
  return __first;
#else
  return std::_Destroy_aux<__has_trivial_destructor(_Value_type)>::__destroy_n(
      __first, __count);
#endif
}
...
template <typename _ForwardIterator, typename _Size>
_GLIBCXX20_CONSTEXPR inline _ForwardIterator destroy_n(_ForwardIterator __first,
                                                       _Size __count) {
...
template <typename _Tp>
[[__gnu__::__always_inline__]]
inline const _Tp *start_lifetime_as(const void *__p) noexcept {
#if __glibcxx_is_implicit_lifetime >= 202302L
  static_assert(is_implicit_lifetime_v<_Tp>);
#endif
...
template <typename _Tp>
[[__gnu__::__always_inline__]]
inline volatile _Tp *start_lifetime_as(volatile void *__p) noexcept {
#if __glibcxx_is_implicit_lifetime >= 202302L
  static_assert(is_implicit_lifetime_v<_Tp>);
#endif
...
template <typename _Tp>
[[__gnu__::__always_inline__]]
inline const _Tp *start_lifetime_as_array(const void *__p,
                                          size_t __n) noexcept {
  auto __q = reinterpret_cast<const _Tp *>(__p);
  if (!__n)
    return __q;
  ...
  auto __s =
      (__extension__ reinterpret_cast<_Tp(*)[__n]>(const_cast<void *>(__p)));
...
template <typename _Tp>
[[__gnu__::__always_inline__]]
inline volatile _Tp *start_lifetime_as_array(volatile void *__p,
                                             size_t __n) noexcept {
  auto __q = reinterpret_cast<volatile _Tp *>(__p);
  if (!__n)
    return __q;
...
template <typename _Tp>
[[__gnu__::__always_inline__]]
inline const volatile _Tp *start_lifetime_as_array(const volatile void *__p,
                                                   size_t __n) noexcept {
  auto __q = reinterpret_cast<const volatile _Tp *>(__p);
  if (!__n)
    return __q;
