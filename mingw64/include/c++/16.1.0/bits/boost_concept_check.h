...
template <typename _Tp> struct _Is_vector_bool_iterator {
...
template <> struct _Is_vector_bool_iterator<__cont::_Bit_iterator> {
  static const bool __value = true;
};

// And for vector<bool>::const_iterator.
template <> struct _Is_vector_bool_iterator<__cont::_Bit_const_iterator> {
  static const bool __value = true;
};
...
template <class _Tp> struct _ForwardIteratorReferenceConcept<_Tp, true> {
  void __constraints() {}
};
