...
struct _UninitDestroyGuard {
  ...
  explicit _UninitDestroyGuard(_ForwardIterator &__first, _Alloc &__a)
...
struct _UninitDestroyGuard<_ForwardIterator, void> {
  _GLIBCXX20_CONSTEXPR
  explicit _UninitDestroyGuard(_ForwardIterator &__first)
...
private:
  ...
  static void _S_destroy(_Iter __first, _Iter __last) {
...
_GLIBCXX20_CONSTEXPR _ForwardIterator __do_uninit_copy(
    _InputIterator __first, _Sentinel __last, _ForwardIterator __result) {
...
template <bool _CanMemcpy> struct __uninitialized_copy {
...
template <> struct __uninitialized_copy<true> {
  ...
  static _ForwardIterator __uninit_copy(_InputIterator __first,
    ...
    if (__unwrappable_niter<_InputIterator>::__value &&
      ...
      __uninit_copy(std::__niter_base(__first), std::__niter_base(__last),
  ...
  static _Up *__uninit_copy(_Tp *__first, _Tp *__last, _Up *__result) {
...
uninitialized_copy(_InputIterator __first, _InputIterator __last,
  ...
  if constexpr (!__is_trivially_constructible(_ValT, decltype(*__first)))
    ...
    if (__n > 0) [[__likely__]] {
      ...
      __builtin_memcpy(std::__niter_base(__result), std::__niter_base(__first),
                       __n * sizeof(_ValT));
      __result += __n;
    }
    return __result;
  ...
  return __uninitialized_copy<__can_memcpy>::__uninit_copy(__first, __last,
                                                           __result);
#endif
}
...
_GLIBCXX20_CONSTEXPR void __do_uninit_fill(_ForwardIterator __first,
...
#if __cplusplus < 201103L
// Use template specialization for C++98 when 'if constexpr' can't be used.
template <bool _CanMemset> struct __uninitialized_fill {
  template <typename _ForwardIterator, typename _Tp>
...
template <> struct __uninitialized_fill<true> {
  ...
  static void __uninit_fill(_ForwardIterator __first, _ForwardIterator __last,
    ...
    if (__unwrappable_niter<_ForwardIterator>::__value)
      __uninit_fill(std::__niter_base(__first), std::__niter_base(__last), __x);
    else
      std::__do_uninit_fill(__first, __last, __x);
  }
  ...
  static void __uninit_fill(_Up *__first, _Up *__last, const _Tp &__x) {
...
_GLIBCXX26_CONSTEXPR inline void uninitialized_fill(_ForwardIterator __first,
                                                    _ForwardIterator __last,
                                                    const _Tp &__x) {
...
#pragma GCC diagnostic ignored "-Wclass-memaccess"
  ...
  if constexpr (__is_byte<_ValueType>::__value)
    if constexpr (is_same<_ValueType, _Tp>::value || is_integral<_Tp>::value) {
...
#pragma GCC diagnostic pop
#else // C++98
  const bool __can_memset =
      __is_byte<_ValueType>::__value && __is_integer<_Tp>::__value;
...
#if __cplusplus < 201103L
// Use template specialization for C++98 when 'if constexpr' can't be used.
template <bool _CanMemset> struct __uninitialized_fill_n {
  template <typename _ForwardIterator, typename _Size, typename _Tp>
...
uninitialized_fill_n(_ForwardIterator __first, _Size __n, const _Tp &__x) {
  ...
  return __uninitialized_fill_n<__can_memset>::__uninit_fill_n(__first, __n,
                                                               __x);
#endif
}
#pragma GCC diagnostic pop
...
__uninitialized_copy_a(_InputIterator __first, _Sentinel __last,
  ...
  _UninitDestroyGuard<_ForwardIterator, _Allocator> __guard(__result, __alloc);
...
__uninitialized_copy_a(_InputIterator __first, _Sentinel __last,
  ...
  if constexpr (!is_same_v<_InputIterator, _Sentinel>) {
    ...
    if constexpr (sized_sentinel_for<_Sentinel, _InputIterator> &&
      ...
      return std::uninitialized_copy(__first, __first + (__last - __first),
                                     __result);
...
template <typename _ITp, typename _IRef, typename _IPtr, typename _OTp,
          typename _Tp>
_GLIBCXX_STD_C::_Deque_iterator<_OTp, _OTp &, _OTp *> __uninitialized_copy_a(
...
__uninitialized_copy_a(
    _Iter __first, _Iter __last,
    _GLIBCXX_STD_C::_Deque_iterator<_OTp, _OTp &, _OTp *> __result,
    allocator<_Tp> &);

template <typename _ITp, typename _IRef, typename _IPtr, typename _OTp,
          typename _Tp>
_GLIBCXX_STD_C::_Deque_iterator<_OTp, _OTp &, _OTp *> __uninitialized_move_a(
    _GLIBCXX_STD_C::_Deque_iterator<_ITp, _IRef, _IPtr> __first,
    _GLIBCXX_STD_C::_Deque_iterator<_ITp, _IRef, _IPtr> __last,
    _GLIBCXX_STD_C::_Deque_iterator<_OTp, _OTp &, _OTp *> __result,
    allocator<_Tp> &);
...
template <typename _InputIterator, typename _ForwardIterator,
          typename _Allocator>
_GLIBCXX20_CONSTEXPR inline _ForwardIterator __uninitialized_move_if_noexcept_a(
...
__uninitialized_fill_a(_ForwardIterator __first, _ForwardIterator __last,
  ...
  _UninitDestroyGuard<_ForwardIterator, _Allocator> __guard(__first, __alloc);
...
template <typename _ForwardIterator, typename _Size, typename _Tp,
          typename _Allocator>
_GLIBCXX20_CONSTEXPR _ForwardIterator __uninitialized_fill_n_a(
...
template <typename _ForwardIterator, typename _Size, typename _Tp,
          typename _Tp2>
_GLIBCXX20_CONSTEXPR inline _ForwardIterator
__uninitialized_fill_n_a(_ForwardIterator __first, _Size __n, const _Tp &__x,
                         allocator<_Tp2> &) {
#ifdef __cpp_lib_is_constant_evaluated
  if (std::is_constant_evaluated())
    return std::__do_uninit_fill_n(__first, __n, __x);
...
__uninitialized_copy_move(_InputIterator1 __first1, _InputIterator1 __last1,
...
template <typename _InputIterator1, typename _InputIterator2,
          typename _ForwardIterator, typename _Allocator>
inline _ForwardIterator
__uninitialized_move_copy(_InputIterator1 __first1, _InputIterator1 __last1,
                          _InputIterator2 __first2, _InputIterator2 __last2,
                          _ForwardIterator __result, _Allocator &__alloc) {
  _ForwardIterator __mid =
...
__uninitialized_move_fill(_InputIterator __first1, _InputIterator __last1,
  ...
  _UninitDestroyGuard<_ForwardIterator, _Allocator> __guard(__first2, __alloc);
...
template <bool _TrivialValueType> struct __uninitialized_default_1 {
  template <typename _ForwardIterator>
  _GLIBCXX26_CONSTEXPR static void __uninit_default(_ForwardIterator __first,
                                                    _ForwardIterator __last) {
    _UninitDestroyGuard<_ForwardIterator> __guard(__first);
    for (; __first != __last; ++__first)
...
#ifdef __cpp_lib_is_constant_evaluated
  if (std::is_constant_evaluated())
    return __uninitialized_default_1<false>::__uninit_default(__first, __last);
#endif
...
_GLIBCXX20_CONSTEXPR _ForwardIterator __uninitialized_default_n_a(
...
template <bool _TrivialValueType> struct __uninitialized_default_novalue_1 {
  template <typename _ForwardIterator>
  _GLIBCXX26_CONSTEXPR static void
  __uninit_default_novalue(_ForwardIterator __first, _ForwardIterator __last) {
    _UninitDestroyGuard<_ForwardIterator> __guard(__first);
    for (; __first != __last; ++__first)
...
template <> struct __uninitialized_default_novalue_1<true> {
  template <typename _ForwardIterator>
  _GLIBCXX26_CONSTEXPR static void __uninit_default_novalue(_ForwardIterator,
                                                            _ForwardIterator) {}
};

template <bool _TrivialValueType> struct __uninitialized_default_novalue_n_1 {
  template <typename _ForwardIterator, typename _Size>
  _GLIBCXX26_CONSTEXPR static _ForwardIterator
...
_GLIBCXX26_CONSTEXPR _ForwardIterator
...
template <typename _InputIterator, typename _Size, typename _ForwardIterator>
_GLIBCXX26_CONSTEXPR pair<_InputIterator, _ForwardIterator>
...
template <typename _RandomAccessIterator, typename _Size,
          typename _ForwardIterator>
_GLIBCXX26_CONSTEXPR inline pair<_RandomAccessIterator, _ForwardIterator>
...
/// @cond undocumented
template <typename _InputIterator, typename _Size, typename _ForwardIterator>
_GLIBCXX26_CONSTEXPR inline pair<_InputIterator, _ForwardIterator>
__uninitialized_copy_n_pair(_InputIterator __first, _Size __n,
                            _ForwardIterator __result) {
  return std::__uninitialized_copy_n_pair(
      __first, __n, __result, std::__iter_concept_or_category(__first));
}
/// @endcond
#endif
...
_GLIBCXX20_CONSTEXPR inline void __relocate_object_a(
...
struct __is_bitwise_relocatable : __bool_constant<__is_trivial(_Tp)> {};

template <typename _InputIterator, typename _ForwardIterator,
          typename _Allocator>
_GLIBCXX20_CONSTEXPR inline _ForwardIterator __relocate_a_1(
    _InputIterator __first, _InputIterator __last, _ForwardIterator __result,
  ...
  for (; __first != __last; ++__first, (void)++__cur)
    std::__relocate_object_a(std::addressof(*__cur), std::addressof(*__first),
                             __alloc);
  return __cur;
}
...
#if _GLIBCXX_HOSTED
template <typename _Tp, typename _Up>
_GLIBCXX20_CONSTEXPR inline __enable_if_t<
    std::__is_bitwise_relocatable<_Tp>::value, _Tp *>
...
template <typename _InputIterator, typename _ForwardIterator,
          typename _Allocator>
_GLIBCXX20_CONSTEXPR inline _ForwardIterator __relocate_a(
    _InputIterator __first, _InputIterator __last, _ForwardIterator __result,
    _Allocator
