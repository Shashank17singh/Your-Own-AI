...
public:
  ...
  _GLIBCXX20_CONSTEXPR typename __invoke_result<_Tp &, _Args...>::type
  ...
  friend constexpr bool operator==(reference_wrapper __x, reference_wrapper __y)
    requires requires {
      { __x.get() == __y.get() } -> convertible_to<bool>;
    }
  {
  ...
  friend constexpr bool operator==(reference_wrapper __x, const _Tp &__y)
    requires requires {
      { __x.get() == __y } -> convertible_to<bool>;
    }
  {
    return __x.get() == __y;
  }
  ...
  friend constexpr bool operator==(reference_wrapper __x,
                                   reference_wrapper<const _Tp> __y)
  ...
  friend constexpr auto operator<=>(reference_wrapper __x, const _Tp &__y)
    requires requires {
      { __y < __y } -> __detail::__boolean_testable;
    }
  {
...
template <typename _Tp>
_GLIBCXX20_CONSTEXPR inline reference_wrapper<const _Tp>
...
template <typename _Tp>
_GLIBCXX20_CONSTEXPR inline reference_wrapper<_Tp>
...
namespace __detail {
template <typename _Tp> constexpr bool __is_ref_wrapper = false;
...
template <typename _Rp, typename _Tp, template <typename> class _RQual,
          template <typename> class _TQual>
  requires __detail::__ref_wrap_common_reference_exists_with<
               _Rp, _Tp, _RQual<_Rp>, _TQual<_Tp>> &&
           (!__detail::__ref_wrap_common_reference_exists_with<
               _Tp, _Rp, _TQual<_Tp>, _RQual<_Rp>>)
struct basic_common_reference<_Rp, _Tp, _RQual, _TQual> {
  using type = common_reference_t<typename _Rp::type &, _TQual<_Tp>>;
};

template <typename _Tp, typename _Rp, template <typename> class _TQual,
          template <typename> class _RQual>
  requires __detail::__ref_wrap_common_reference_exists_with<
               _Rp, _Tp, _RQual<_Rp>, _TQual<_Tp>> &&
           (!__detail::__ref_wrap_common_reference_exists_with<
               _Tp, _Rp, _TQual<_Tp>, _RQual<_Rp>>)
