...
public:
  ...
  constexpr __max_size_type(_Tp __i) noexcept : _M_val(__i), _M_msb(__i < 0) {}
  ...
  constexpr __max_size_type &operator*=(__max_size_type __r) noexcept {
    ...
    if (_M_val < __threshold && __r < __threshold)
      ...
      *this >>= 1;
      __r >>= 1;
      _M_val = (2 * _M_val * __r._M_val + _M_val * __rlsb + __r._M_val * __lsb);
      *this <<= 1;
      *this += __rlsb * __lsb;
    }
...
public:
  ...
  constexpr bool operator<(const __max_diff_type &__r) const noexcept {
    const auto __lsign = _M_rep._M_msb;
    const auto __rsign = __r._M_rep._M_msb;
    if (__lsign ^ __rsign)
      return __lsign;
...
constexpr __max_size_type::__max_size_type(const __max_diff_type &__d) noexcept
...
template <> struct numeric_limits<ranges::__detail::__max_size_type> {
  ...
  static constexpr _Sp denorm_min() noexcept { return 0; }

  static constexpr _Sp epsilon() noexcept { return 0; }

  static constexpr _Sp round_error() noexcept { return 0; }

  static constexpr _Sp infinity() noexcept { return 0; }

  static constexpr _Sp quiet_NaN() noexcept { return 0; }

  static constexpr _Sp signaling_NaN() noexcept { return 0; }
};
...
template <> struct numeric_limits<ranges::__detail::__max_diff_type> {
  ...
  static constexpr _Dp denorm_min() noexcept { return 0; }

  static constexpr _Dp epsilon() noexcept { return 0; }

  static constexpr _Dp round_error() noexcept { return 0; }

  static constexpr _Dp infinity() noexcept { return 0; }

  static constexpr _Dp quiet_NaN() noexcept { return 0; }

  static constexpr _Dp signaling_NaN() noexcept { return 0; }
};
