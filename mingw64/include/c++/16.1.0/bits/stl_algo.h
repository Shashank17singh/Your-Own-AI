...
_GLIBCXX20_CONSTEXPR inline _InputIterator __find_if_not(_InputIterator __first,
                                                         _InputIterator __last,
                                                         _Predicate __pred) {
  return std::__find_if(__first, __last, __gnu_cxx::__ops::not1(__pred));
}
...
_GLIBCXX20_CONSTEXPR _InputIterator __find_if_not_n(_InputIterator __first,
                                                    _Distance &__len,
                                                    _Predicate __pred) {
...
template <typename _ForwardIterator, typename _Integer,
          typename _UnaryPredicate>
_GLIBCXX20_CONSTEXPR _ForwardIterator __search_n(_ForwardIterator __first,
...
_GLIBCXX20_CONSTEXPR _ForwardIterator1 __find_end(
    ...
    _ForwardIterator2 __first2, _ForwardIterator2 __last2, forward_iterator_tag,
    forward_iterator_tag, _BinaryPredicate __comp) {
  if (__first2 == __last2)
    return __last1;
...
template <typename _BidirectionalIterator1, typename _BidirectionalIterator2,
          typename _BinaryPredicate>
_GLIBCXX20_CONSTEXPR _BidirectionalIterator1
 ...
 */
template <typename _ForwardIterator1, typename _ForwardIterator2>
_GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR inline _ForwardIterator1
...
find_end(_ForwardIterator1 __first1, _ForwardIterator1 __last1,
  ...
  return std::__find_end(__first1, __last1, __first2, __last2,
                         std::__iter_concept_or_category(__first1),
                         std::__iter_concept_or_category(__first2), __comp);
}
 ...
 */
template <typename _InputIterator, typename _Predicate>
_GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR inline _InputIterator
...
_GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR _ForwardIterator partition_point(
...
template <typename _InputIterator, typename _OutputIterator,
          typename _Predicate>
_GLIBCXX20_CONSTEXPR _OutputIterator __remove_copy_if(_InputIterator __first,
                                                      _InputIterator __last,
...
template <typename _InputIterator, typename _OutputIterator,
          typename _Predicate>
_GLIBCXX20_CONSTEXPR _OutputIterator copy_if(_InputIterator __first,
                                             _InputIterator __last,
                                             _OutputIterator __result,
                                             _Predicate __pred) {
  // concept requirements
...
_GLIBCXX20_CONSTEXPR pair<_OutputIterator1, _OutputIterator2>
...
_GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR inline _ForwardIterator
...
template <typename _ForwardIterator, typename _BinaryPredicate>
_GLIBCXX20_CONSTEXPR _ForwardIterator __unique(_ForwardIterator __first,
                                               _ForwardIterator __last,
                                               _BinaryPredicate __binary_pred) {
...
template <typename _InputIterator, typename _OutputIterator,
          typename _BinaryPredicate>
_GLIBCXX20_CONSTEXPR _OutputIterator __unique_copy_1(
    _InputIterator __first, _InputIterator __last, _OutputIterator __result,
    _BinaryPredicate __binary_pred, __false_type) {
...
template <typename _InputIterator, typename _ForwardIterator,
          typename _BinaryPredicate>
_ForwardIterator __unique_copy_1(_InputIterator __first, _InputIterator __last,
...
_GLIBCXX20_CONSTEXPR _OutputIterator
...
template <typename _ForwardIterator, typename _Predicate>
_GLIBCXX20_CONSTEXPR _ForwardIterator __partition(_ForwardIterator __first,
                                                  _ForwardIterator __last,
                                                  _Predicate __pred,
                                                  forward_iterator_tag) {
  if (__first == __last)
...
template <typename _ForwardIterator, typename _Pointer, typename _Predicate,
          typename _Distance>
_GLIBCXX26_CONSTEXPR _ForwardIterator __stable_partition_adaptive(
    _ForwardIterator __first, _ForwardIterator __last, _Predicate __pred,
...
template <typename _ForwardIterator, typename _Predicate>
_GLIBCXX26_CONSTEXPR _ForwardIterator __stable_partition(
    _ForwardIterator __first, _ForwardIterator __last, _Predicate __pred) {
  ...
  if consteval {
    ...
    *__first = std::move(__buf);
    return std::__stable_partition_adaptive(__first, __last, __pred, __len,
                                            &__buf, _DistanceType(1));
  }
#endif

  _Temporary_buffer<_ForwardIterator, _ValueType> __buf(__first, __len);
  return std::__stable_partition_adaptive(__first, __last, __pred, __len,
                                          __buf.begin(),
 ...
 */
template <typename _ForwardIterator, typename _Predicate>
_GLIBCXX26_CONSTEXPR inline _ForwardIterator
...
_GLIBCXX20_CONSTEXPR void
__heap_select(_RandomAccessIterator __first, _RandomAccessIterator __middle,
...
_GLIBCXX20_CONSTEXPR void __final_insertion_sort(_RandomAccessIterator __first,
                                                 _RandomAccessIterator __last,
                                                 _Compare __comp) {
  typename iterator_traits<_RandomAccessIterator>::difference_type __threshold =
      _S_threshold;

  if (__last - __first > __threshold) {
    std::__insertion_sort(__first, __first + __threshold, __comp);
    std::__unguarded_insertion_sort(__first + __threshold, __last, __comp);
  } else
...
template <typename _RandomAccessIterator, typename _Size, typename _Compare>
_GLIBCXX20_CONSTEXPR void __introselect(_RandomAccessIterator __first,
  ...
  __glibcxx_function_requires(_ForwardIteratorConcept<_ForwardIterator>)
      __glibcxx_function_requires(
          _BinaryPredicateConcept<
              ...
              _Tp>) __glibcxx_requires_partitioned_lower_pred(__first, __last,
                                                              __val, __comp);
...
template <typename _ForwardIterator, typename _Tp, typename _Compare>
_GLIBCXX20_CONSTEXPR _ForwardIterator __upper_bound(_ForwardIterator __first,
                                                    _ForwardIterator __last,
                                                    const _Tp &__val,
                                                    _Compare __comp) {
  typedef
...
upper_bound(_ForwardIterator __first, _ForwardIterator __last,
  ...
  return std::__upper_bound(__first, __last, __val, __gnu_cxx::__ops::less());
}
...
template <typename _ForwardIterator, typename _Tp, typename _Compare>
_GLIBCXX20_CONSTEXPR pair<_ForwardIterator, _ForwardIterator>
...
_GLIBCXX_NODISCARD
  ...
  return std::__equal_range(__first, __last, __val, __gnu_cxx::__ops::less());
}
...
template <typename _BidirectionalIterator, typename _Distance,
          typename _Pointer, typename _Compare>
void __merge_adaptive_resize(_BidirectionalIterator __first,
                             _BidirectionalIterator __middle,
                             _BidirectionalIterator __last, _Distance __len1,
  ...
  if (__len1 <= __buffer_size || __len2 <= __buffer_size)
    ...
    if (__len1 > __len2) {
      ...
      __second_cut = std::__lower_bound(__middle, __last, *__first_cut, __comp);
...
__merge_without_buffer(_BidirectionalIterator __first,
  ...
  if (__len1 > __len2) {
    ...
    __len22 = __len2 / 2;
    std::advance(__second_cut, __len22);
    __first_cut = std::__upper_bound(__first, __middle, *__second_cut, __comp);
    __len11 = std::distance(__first, __first_cut);
  }
...
_GLIBCXX26_CONSTEXPR void
__inplace_merge(_BidirectionalIterator __first, _BidirectionalIterator __middle,
...
#if __glibcxx_constexpr_algorithms >= 202306L // >= C++26
  if consteval {
    return std::__merge_without_buffer(__first, __middle, __last, __len1,
                                       __len2, __comp);
  }
#endif
 ...
 */
template <typename _BidirectionalIterator>
_GLIBCXX26_CONSTEXPR inline void inplace_merge(_BidirectionalIterator __first,
                                               _BidirectionalIterator __middle,
                                               _BidirectionalIterator __last) {
  // concept requirements
  __glibcxx_function_requires(
  ...
  std::__inplace_merge(__first, __middle, __last, __gnu_cxx::__ops::less());
}
...
_GLIBCXX20_CONSTEXPR void __chunk_insertion_sort(_RandomAccessIterator __first,
                                                 _RandomAccessIterator __last,
...
template <typename _RandomAccessIterator, typename _Pointer, typename _Distance,
          typename _Compare>
void __stable_sort_adaptive_resize(_RandomAccessIterator __first,
                                   _RandomAccessIterator __last,
...
template <typename _RandomAccessIterator, typename _Compare>
_GLIBCXX26_CONSTEXPR void __inplace_stable_sort(_RandomAccessIterator __first,
                                                _RandomAccessIterator __last,
                                                _Compare __comp) {
...
_GLIBCXX20_CONSTEXPR _OutputIterator __replace_copy_if(_InputIterator __first,
                                                       _InputIterator __last,
                                                       _OutputIterator __result,
                                                       _Predicate __pred,
...
replace_copy_if(_InputIterator __first, _InputIterator __last,
  ...
  return std::__replace_copy_if(__first, __last, __result, __pred, __new_value);
}
...
is_sorted_until(_ForwardIterator __first, _ForwardIterator __last) {
  ...
  return std::__is_sorted_until(__first, __last, __gnu_cxx::__ops::less());
}
...
_GLIBCXX_NODISCARD _GLIBCXX14_CONSTEXPR inline pair<const _Tp &, const _Tp &>
...
template <typename _Tp>
_GLIBCXX_NODISCARD _GLIBCXX14_CONSTEXPR inline pair<_Tp, _Tp>
minmax(initializer_list<_Tp> __l) {
  __glibcxx_requires_irreflexive(__l.begin(), __l.end());
  pair<const _Tp *, const _Tp *> __p =
      std::__minmax_element(__l.begin(), __l.end(), __gnu_cxx::__ops::less());
...
is_permutation(_ForwardIterator1 __first1, _ForwardIterator1 __last1,
  ...
  return std::__is_permutation(__first1, __last1, __first2, __last2, __pred);
}
 ...
 */
template <typename _Tp>
[[nodiscard]] constexpr const _Tp &clamp(const _Tp &__val, const _Tp &__lo,
                                         const _Tp &__hi) {
...
_GLIBCXX20_CONSTEXPR _Function for_each(_InputIterator __first,
...
_GLIBCXX20_CONSTEXPR _InputIterator for_each_n(_InputIterator __first,
...
find(_InputIterator __first, _InputIterator __last, const _Tp &__val) {
  ...
  __glibcxx_function_requires(_InputIteratorConcept<_InputIterator>)
      __glibcxx_function_requires(
          _EqualOpConcept<typename iterator_traits<_InputIterator>::value_type,
  ...
  return std::__find_if(__first, __last, __gnu_cxx::__ops::__equal_to(__val));
}
 ...
 */
template <typename _InputIterator, typename _ForwardIterator>
_GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR _InputIterator
...
template <typename _InputIterator, typename _ForwardIterator,
          typename _BinaryPredicate>
_GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR _InputIterator find_first_of(
...
adjacent_find(_ForwardIterator __first, _ForwardIterator __last) {
  ...
  return std::__adjacent_find(__first, __last, __gnu_cxx::__ops::equal_to());
}
 ...
 */
template <typename _InputIterator, typename _Tp>
_GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR inline
...
_GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR inline _ForwardIterator
search_n(_ForwardIterator __first, _ForwardIterator __last, _Integer __count,
         const _Tp &__val) {
  // concept requirements
  __glibcxx_function_requires(_ForwardIteratorConcept<_ForwardIterator>)
      __glibcxx_function_requires(
...
_GLIBCXX20_CONSTEXPR _OutputIterator transform(_InputIterator __first,
                                               _InputIterator __last,
                                               _OutputIterator __result,
...
_GLIBCXX20_CONSTEXPR _OutputIterator transform(_InputIterator1 __first1,
...
_GLIBCXX20_CONSTEXPR void replace_if(_ForwardIterator __first,
...
_GLIBCXX20_CONSTEXPR void generate(_ForwardIterator __first,
...
inline void random_shuffle(_RandomAccessIterator __first,
  ...
  typedef
      typename iterator_traits<_RandomAccessIterator>::difference_type _Dist;
...
#endif
{
  ...
  for (_RandomAccessIterator __i = __first + _Dist(1); __i != __last; ++__i) {
    _RandomAccessIterator __j = __first + _Dist(__rand((__i - __first) + 1));
    if (__i != __j)
      std::iter_swap(__i, __j);
  }
}
 ...
 */
template <typename _ForwardIterator, typename _Predicate>
_GLIBCXX20_CONSTEXPR inline _ForwardIterator partition(_ForwardIterator __first,
                                                       _ForwardIterator __last,
                                                       _Predicate __pred) {
  // concept requirements
  __glibcxx_function_requires(_Mutable_ForwardIteratorConcept<_ForwardIterator>)
...
_GLIBCXX20_CONSTEXPR inline void partial_sort(_RandomAccessIterator __first,
  ...
  std::__partial_sort(__first, __middle, __last, __gnu_cxx::__ops::less());
}
...
template <typename _RandomAccessIterator, typename _Compare>
_GLIBCXX26_CONSTEXPR inline void __stable_sort(_RandomAccessIterator __first,
                                               _RandomAccessIterator __last,
                                               _Compare __comp) {
  typedef
      typename iterator_traits<_RandomAccessIterator>::value_type _ValueType;
  ...
  if (__builtin_expect(__buf._M_requested_size() == __buf.size(), true))
    std::__stable_sort_adaptive(__first, __first + _DistanceType(__buf.size()),
 ...
 */
template <typename _RandomAccessIterator>
_GLIBCXX26_CONSTEXPR inline void stable_sort(_RandomAccessIterator __first,
                                             _RandomAccessIterator __last) {
  // concept requirements
  __glibcxx_function_requires(
      _Mutable_RandomAccessIteratorConcept<_RandomAccessIterator>)
  ...
  _GLIBCXX_STD_A::__stable_sort(__first, __last, __gnu_cxx::__ops::less());
}
...
set_intersection(_InputIterator1 __first1, _InputIterator1 __last1,
  ...
  return _GLIBCXX_STD_A::__set_intersection(
      __first1, __last1, __first2, __last2, __result, __gnu_cxx::__ops::less());
}
...
set_intersection(_InputIterator1 __first1, _InputIterator1 __last1,
  ...
  return _GLIBCXX_STD_A::__set_intersection(__first1, __last1, __first2,
...
set_difference(_InputIterator1 __first1, _InputIterator1 __last1,
  ...
  return _GLIBCXX_STD_A::__set_difference(__first1, __last1, __first2, __last2,
                                          __result, __gnu_cxx::__ops::less());
}
...
set_symmetric_difference(_InputIterator1 __first1, _InputIterator1 __last1,
  ...
  return _GLIBCXX_STD_A::__set_symmetric_difference(__first1, __last1, __first2,
                                                    __last2, __result, __comp);
}
 ...
 */
template <typename _ForwardIterator>
_GLIBCXX_NODISCARD _GLIBCXX14_CONSTEXPR inline _ForwardIterator
...
// N2722 + DR 915.
template <typename _Tp>
_GLIBCXX_NODISCARD _GLIBCXX14_CONSTEXPR inline _Tp
...
_RandomAccessIterator __sample(_InputIterator __first, _InputIterator __last,
                               input_iterator_tag, _RandomAccessIterator __out,
                               random_access_iterator_tag, _Size __n,
                               _UniformRandomBitGenerator &&__g) {
