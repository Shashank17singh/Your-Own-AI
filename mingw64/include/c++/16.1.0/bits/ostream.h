...
#pragma GCC diagnostic pop
  ...
  __attribute__((__always_inline__)) __ostream_type &operator<<(_Float16 __f) {
    return _M_insert(_S_cast_flt<double>(__f));
  }
#endif

#if defined(__STDCPP_FLOAT32_T__) && defined(_GLIBCXX_DOUBLE_IS_IEEE_BINARY64)
  __attribute__((__always_inline__)) __ostream_type &operator<<(_Float32 __f) {
    return _M_insert(_S_cast_flt<double>(__f));
  }
#endif

#if defined(__STDCPP_FLOAT64_T__) && defined(_GLIBCXX_DOUBLE_IS_IEEE_BINARY64)
  __attribute__((__always_inline__)) __ostream_type &operator<<(_Float64 __f) {
    return _M_insert(_S_cast_flt<double>(__f));
  }
#endif
  ...
  __attribute__((__always_inline__)) __ostream_type &operator<<(_Float128 __f) {
  ...
  __ostream_type &operator<<(__gnu_cxx::__bfloat16_t __f) {
    return _M_insert(_S_cast_flt<double>(__f));
  }
#endif
  ...
  __attribute__((__always_inline__))
  __ostream_type &operator<<(const volatile void *__p) {
...
#pragma GCC diagnostic ignored "-Wc++17-extensions" // for if-constexpr
  template <typename _To, typename _From> static _To _S_cast_flt(_From __f) {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
  ...
  ~sentry() {
        ...
        !uncaught_exception()) // XXX MT
    {
      ...
      __catch(...) { _M_os.setstate(ios_base::badbit); }
    }
  }
#pragma GCC diagnostic pop
...
template <
    typename _Os, typename _Tp, typename = _Require_derived_from_ios_base<_Os>,
