...
_GLIBCXX20_CONSTEXPR _Distance __is_heap_until(_RandomAccessIterator __first,
                                               _Distance __n,
                                               _Compare &__comp) {
#if __cplusplus >= 201103L
  using _IterTraits = iterator_traits<_RandomAccessIterator>;
  static_assert(
      is_same<typename _IterTraits::difference_type, _Distance>::value,
...
template <typename _RandomAccessIterator, typename _Distance, typename _Tp,
          typename _Compare>
_GLIBCXX20_CONSTEXPR void __adjust_heap(_RandomAccessIterator __first,
 ...
 */
template <typename _RandomAccessIterator>
_GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR inline _RandomAccessIterator
