...
#define __INT_N(TYPE)                                                          \
  __extension__ template <> struct __is_integer<TYPE> {                        \
    enum { __value = 1 };                                                      \
    typedef __true_type __type;                                                \
  };                                                                           \
  __extension__ template <> struct __is_integer<unsigned TYPE> {               \
    enum { __value = 1 };                                                      \
    typedef __true_type __type;                                                \
  };
...
template <> struct __is_floating<__float128> {
  enum { __value = 1 };
  typedef __true_type __type;
};
#endif
...
template <> struct __is_floating<_Float16> {
  enum { __value = 1 };
  typedef __true_type __type;
};
#endif
...
template <> struct __is_floating<_Float32> {
  enum { __value = 1 };
  typedef __true_type __type;
};
#endif
...
template <> struct __is_floating<_Float64> {
  enum { __value = 1 };
  typedef __true_type __type;
};
#endif
...
template <> struct __is_floating<_Float128> {
  enum { __value = 1 };
  typedef __true_type __type;
};
#endif
...
template <> struct __is_floating<__gnu_cxx::__bfloat16_t> {
  enum { __value = 1 };
  typedef __true_type __type;
};
#endif
...
template <typename _Tp, typename _Up> struct __memcpyable<_Tp *, _Up *> {
  enum {
...
template <typename _Tp> struct __memcpyable_integer<volatile _Tp> {
  enum { __width = 0 };
};
...
__extension__ template <> struct __memcpyable_integer<__GLIBCXX_TYPE_INT_N_0> {
...
__extension__ template <> struct __memcpyable_integer<__GLIBCXX_TYPE_INT_N_1> {
...
__extension__ template <> struct __memcpyable_integer<__GLIBCXX_TYPE_INT_N_2> {
...
__extension__ template <> struct __memcpyable_integer<__GLIBCXX_TYPE_INT_N_3> {
...
template <> struct __memcpyable<double *, long double *> {
  enum { __value = true };
};
template <> struct __memcpyable<long double *, double *> {
  enum { __value = true };
};
#endif

#if defined(__STDCPP_FLOAT32_T__) && defined(_GLIBCXX_FLOAT_IS_IEEE_BINARY32)
template <> struct __memcpyable<_Float32 *, float *> {
  enum { __value = true };
};
template <> struct __memcpyable<float *, _Float32 *> {
  enum { __value = true };
};
#endif

#if defined(__STDCPP_FLOAT64_T__) && defined(_GLIBCXX_DOUBLE_IS_IEEE_BINARY64)
template <> struct __memcpyable<_Float64 *, double *> {
  enum { __value = true };
};
template <> struct __memcpyable<double *, _Float64 *> {
  enum { __value = true };
};
#endif
...
template <> struct __memcpyable<_Float128 *, long double *> {
  enum { __value = true };
};
template <> struct __memcpyable<long double *, _Float128 *> {
  enum { __value = true };
};
#endif
...
template <> struct __is_memcmp_ordered<std::byte, false> {
