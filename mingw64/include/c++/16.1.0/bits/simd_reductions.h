...
template <typename _Tp, typename _Ap,
          __reduction_binary_operation<_Tp> _BinaryOperation = plus<>>
[[__gnu__::__always_inline__]]
constexpr _Tp reduce(const basic_vec<_Tp, _Ap> &__x,
...
[[__gnu__::__always_inline__]]
constexpr _Tp reduce_min(const basic_vec<_Tp, _Ap> &__x) noexcept {
...
template <totally_ordered _Tp, typename _Ap>
[[__gnu__::__always_inline__]]
constexpr _Tp reduce_max(const basic_vec<_Tp, _Ap> &__x) noexcept {
  return reduce(__x, []<typename _UV>(const _UV &__a, const _UV &__b) {
