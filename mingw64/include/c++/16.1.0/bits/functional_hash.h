...
constexpr bool __is_hash_enabled_for<
    _Tp, __void_t<decltype(hash<_Tp>()(declval<_Tp>()))>> = true;
#pragma GCC diagnostic pop

// Helper struct for defining disabled specializations of std::hash.
template <typename _Tp> struct __hash_not_enabled {
...
template <typename _Tp>
struct hash : __conditional_t<__is_enum(_Tp), __hash_enum<_Tp>,
...
_Cxx_hashtable_define_trivial_hash(bool)
    ...
    _Cxx_hashtable_define_trivial_hash(unsigned long long)
        ...
        __extension__ _Cxx_hashtable_define_trivial_hash(
            __GLIBCXX_TYPE_INT_N_0) __extension__ _Cxx_hashtable_define_trivial_hash(__GLIBCXX_TYPE_INT_N_0 unsigned)
#endif
#ifdef __GLIBCXX_TYPE_INT_N_1
            __extension__ _Cxx_hashtable_define_trivial_hash(
                __GLIBCXX_TYPE_INT_N_1) __extension__ _Cxx_hashtable_define_trivial_hash(__GLIBCXX_TYPE_INT_N_1 unsigned)
#endif
#ifdef __GLIBCXX_TYPE_INT_N_2
                __extension__ _Cxx_hashtable_define_trivial_hash(
                    __GLIBCXX_TYPE_INT_N_2) __extension__ _Cxx_hashtable_define_trivial_hash(__GLIBCXX_TYPE_INT_N_2 unsigned)
#endif
#ifdef __GLIBCXX_TYPE_INT_N_3
                    __extension__ _Cxx_hashtable_define_trivial_hash(
                        __GLIBCXX_TYPE_INT_N_3) __extension__ _Cxx_hashtable_define_trivial_hash(__GLIBCXX_TYPE_INT_N_3 unsigned)
#endif
    ...
    __extension__ _Cxx_hashtable_define_trivial_hash(
        __int128) __extension__ _Cxx_hashtable_define_trivial_hash(__int128 unsigned)
#endif
