...
struct __cow_constexpr_string {
  ...
  [[__gnu__::__always_inline__]] constexpr __cow_constexpr_string(
      __cow_constexpr_string &&__o) noexcept {
    if consteval {
  ...
  [[__gnu__::__always_inline__]] constexpr const char *c_str() const noexcept {
    if consteval {
      return _M_str->c_str();
    } else {
...
public:
  ...
  constexpr inline explicit logic_error(const string &__arg) _GLIBCXX_TXN_SAFE
      : _M_msg(__arg) {}

  [[__gnu__::__gnu_inline__]]
  constexpr inline explicit logic_error(const char *__arg) _GLIBCXX_TXN_SAFE
      : _M_msg(__arg) {}
...
#if __cpp_lib_constexpr_exceptions >= 202502L
  [[__gnu__::__gnu_inline__]]
  constexpr inline explicit domain_error(const string &__arg) _GLIBCXX_TXN_SAFE
      : logic_error(__arg) {}
  [[__gnu__::__gnu_inline__]]
...
public:
  ...
  constexpr inline explicit invalid_argument(const string &__arg)
      _GLIBCXX_TXN_SAFE : logic_error(__arg) {}
  [[__gnu__::__gnu_inline__]]
...
#if __cpp_lib_constexpr_exceptions >= 202502L
  [[__gnu__::__gnu_inline__]]
  constexpr inline explicit length_error(const string &__arg) _GLIBCXX_TXN_SAFE
      : logic_error(__arg) {}
  [[__gnu__::__gnu_inline__]]
...
#if __cpp_lib_constexpr_exceptions >= 202502L
  [[__gnu__::__gnu_inline__]]
  constexpr inline explicit out_of_range(const string &__arg) _GLIBCXX_TXN_SAFE
      : logic_error(__arg) {}
  [[__gnu__::__gnu_inline__]]
...
#if __cpp_lib_constexpr_exceptions >= 202502L
  [[__gnu__::__gnu_inline__]]
  constexpr inline explicit runtime_error(const string &__arg) _GLIBCXX_TXN_SAFE
      : _M_msg(__arg) {}

  [[__gnu__::__gnu_inline__]]
  constexpr inline explicit runtime_error(const char *__arg) _GLIBCXX_TXN_SAFE
      : _M_msg(__arg) {}
...
#else
  /** Takes a character string describing the error.  */
  explicit runtime_error(const string &__arg) _GLIBCXX_TXN_SAFE;

#if __cplusplus >= 201103L
  explicit runtime_error(const char *) _GLIBCXX_TXN_SAFE;
...
#ifdef _GLIBCXX_TM_TS_INTERNAL
  friend void * ::_txnal_runtime_error_get_msg(void *e);
#endif
};
...
public:
  ...
  constexpr inline explicit overflow_error(const string &__arg)
      _GLIBCXX_TXN_SAFE : runtime_error(__arg) {}
  [[__gnu__::__gnu_inline__]]
  constexpr inline explicit overflow_error(const char *__arg) _GLIBCXX_TXN_SAFE
      : runtime_error(__arg) {}
...
public:
  ...
  constexpr inline explicit underflow_error(const string &__arg)
      _GLIBCXX_TXN_SAFE : runtime_error(__arg) {}
  [[__gnu__::__gnu_inline__]]
  constexpr inline explicit underflow_error(const char *__arg) _GLIBCXX_TXN_SAFE
      : runtime_error(__arg) {}
