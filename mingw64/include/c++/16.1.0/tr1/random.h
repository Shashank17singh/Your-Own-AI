...
template <typename _Engine, typename _Dist> class variate_generator {
  template <typename _Eng> struct _Value {
    typedef _Eng type;

    static const _Eng &_S_ref(const _Eng &__e) { return __e; }
  };

  template <typename _Eng> struct _Value<_Eng *> {
    typedef _Eng type;

    __attribute__((__nonnull__)) static const _Eng &_S_ref(const _Eng *__e) {
      return *__e;
    }
  };
...
public:
   ...
   * object.
   */
  engine_value_type &engine() { return _M_engine._M_g; }

  /**
   * Gets a const reference to the underlying uniform random number
   * generator object.
   */
  const engine_value_type &engine() const { return _M_engine._M_g; }
...
__glibcxx_class_requires(_UIntType, _UnsignedIntegerConcept)
   ...
   */
  template <class _Gen> linear_congruential(_Gen &__g) { this->seed(__g); }
...
__glibcxx_class_requires(_UIntType, _UnsignedIntegerConcept)
  ...
  friend std::basic_ostream<_CharT, _Traits> &
  operator<<(std::basic_ostream<_CharT, _Traits> &__os,
             const mersenne_twister<_UIntType1, __w1, __n1, __m1, __r1, __a1,
                                    __u1, __s1, __b1, __t1, __c1, __l1> &__x);
  ...
  friend std::basic_istream<_CharT, _Traits> &
  operator>>(std::basic_istream<_CharT, _Traits> &__is,
             mersenne_twister<_UIntType1, __w1, __n1, __m1, __r1, __a1, __u1,
...
__glibcxx_class_requires(_IntType, _IntegerConcept)
   ...
   * @param __g The seed generator function.
   */
  template <class _Gen> subtract_with_carry(_Gen &__g) { this->seed(__g); }
