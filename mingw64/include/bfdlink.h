...
bfd_link_hash_lookup(struct bfd_link_hash_table *, const char *, bool create,
...
extern struct bfd_link_hash_entry *
unwrap_hash_lookup(struct bfd_link_info *, bfd *, struct bfd_link_hash_entry *);

/* Traverse a link hash table.  */
extern void
bfd_link_hash_traverse(struct bfd_link_hash_table *,
                       bool (*)(struct bfd_link_hash_entry *, void *), void *);

/* Add an entry to the undefs list.  */
extern void bfd_link_add_undef(struct bfd_link_hash_table *,
                               struct bfd_link_hash_entry *);
...
#define bfd_link_textrel_check(info) (info->textrel_check != textrel_check_none)
...
struct bfd_link_callbacks {
  ...
  bool (*add_archive_element)(struct bfd_link_info *, bfd *abfd,
                              const char *name, bfd **subsbfd);
  ...
  void (*multiple_definition)(struct bfd_link_info *,
  ...
  void (*multiple_common)(struct bfd_link_info *, struct bfd_link_hash_entry *h,
                          bfd *nbfd, enum bfd_link_hash_type ntype,
                          bfd_vma nsize);
  ...
  void (*add_to_set)(struct bfd_link_info *, struct bfd_link_hash_entry *entry,
  ...
  void (*constructor)(struct bfd_link_info *, bool constructor,
  ...
  void (*warning)(struct bfd_link_info *, const char *warning,
  ...
  void (*undefined_symbol)(struct bfd_link_info *, const char *name, bfd *abfd,
  ...
  /* A function which is called when a reloc overflow occurs. ENTRY is
     ...
     ABFD will be NULL.  */
  void (*reloc_overflow)(struct bfd_link_info *,
  ...
  /* A function which is called when a dangerous reloc is performed.
     ...
     bfd_section_reloc_link_order or bfd_symbol_reloc_link_order, then
     ABFD will be NULL.  */
  void (*reloc_dangerous)(struct bfd_link_info *, const char *message,
  ...
  /* A function which is called when a reloc is found to be attached
     ...
     bfd_section_reloc_link_order or bfd_symbol_reloc_link_order, then
     ABFD will be NULL.  */
  void (*unattached_reloc)(struct bfd_link_info *, const char *name, bfd *abfd,
                           asection *section, bfd_vma address);
  ...
  bool (*notice)(struct bfd_link_info *, struct bfd_link_hash_entry *h,
                 struct bfd_link_hash_entry *inh, bfd *abfd, asection *section,
                 bfd_vma address, flagword flags);
  /* Fatal error.  */
  void (*fatal)(const char *fmt, ...) ATTRIBUTE_NORETURN;
  ...
  bool (*override_segment_assignment)(struct bfd_link_info *, bfd *abfd,
  ...
  void (*ctf_new_symbol)(int symidx, struct elf_internal_sym *sym);
  /* Likewise, for dynamic symbols.  */
  void (*ctf_new_dynsym)(int symidx, struct elf_internal_sym *sym);
...
extern bool _bfd_handle_already_linked(struct bfd_section *,
                                       struct bfd_section_already_linked *,
                                       struct bfd_link_info *);
