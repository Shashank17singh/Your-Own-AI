...
#define LINKED_LIST_DECL_APPEND(LWRAPPERTYPE, LTYPE, EXPORT)                   \
  EXPORT void LTYPE##_append(LWRAPPERTYPE *wrapper, LTYPE *new_)
...
#define LINKED_LIST_DECL_PREPEND(LWRAPPERTYPE, LTYPE, EXPORT)                  \
  EXPORT void LTYPE##_prepend(LWRAPPERTYPE *wrapper, LTYPE *new_)
...
#define LINKED_LIST_DECL_INSERT_BEFORE(LWRAPPERTYPE, LTYPE, EXPORT)            \
  EXPORT void LTYPE##_insert_before(LWRAPPERTYPE *wrapper, LTYPE *new_,        \
                                    LTYPE *where)
...
#define LINKED_LIST_DECL_POP_FRONT(LWRAPPERTYPE, LTYPE, EXPORT)                \
  EXPORT LTYPE *LTYPE##_pop_front(LWRAPPERTYPE *wrapper)
...
#define LINKED_LIST_DECL_POP_BACK(LWRAPPERTYPE, LTYPE, EXPORT)                 \
  EXPORT LTYPE *LTYPE##_pop_back(LWRAPPERTYPE *wrapper)
...
#define LINKED_LIST_DECL_REMOVE(LWRAPPERTYPE, LTYPE, EXPORT)                   \
  EXPORT LTYPE *LTYPE##_remove(LWRAPPERTYPE *wrapper, LTYPE *node)
...
#define LINKED_LIST_DECL_SWAP(LWRAPPERTYPE, LTYPE, EXPORT)                     \
  EXPORT void LTYPE##_swap(LWRAPPERTYPE *wrapper, LTYPE *node1, LTYPE *node2)

#define LINKED_LIST_DEFN_SWAP(LWRAPPERTYPE, LTYPE, EXPORT)                     \
  EXPORT void LTYPE##_swap(LWRAPPERTYPE *wrapper, LTYPE *node1,                \
                           LTYPE *node2) {                                     \
...
#define LINKED_LIST_DECL_SWAP_LISTS(LWRAPPERTYPE, LTYPE, EXPORT)               \
  EXPORT void LWRAPPERTYPE##_swap_lists(LWRAPPERTYPE *left_w,                  \
                                        LWRAPPERTYPE *right_w)
...
#define LINKED_LIST_MERGE_SORT_PROTOTYPE_(LTYPE, EXPORT)                       \
  EXPORT LTYPE *LTYPE##_merge_sort_(                                           \
      LTYPE *node, int (*fn_cmp)(const LTYPE *, const LTYPE *))

#define LINKED_LIST_MERGE_SORT_PROTOTYPE(LWRAPPERTYPE, LTYPE, EXPORT)          \
  EXPORT void LTYPE##_merge_sort(LWRAPPERTYPE *wrapper,                        \
...
#define _MERGE_SORT_IMPL_COMPUTE_TURTLE(LTYPE)                                 \
  static inline LTYPE *LTYPE##_merge_sort_compute_turtle_(LTYPE *node) {       \
    if (node == NULL)                                                          \
      return node;                                                             \
                                                                               \
...
#define _MERGE_SORT_IMPL_OUT_APPEND(LTYPE)                                     \
  static inline LTYPE *LTYPE##_merge_sort_out_append_(                         \
      LTYPE **l_out, LTYPE **l_last, LTYPE *n) {                               \
    if (*l_last == NULL) {                                                     \
      *l_last = n;                                                             \
      *l_out = n;                                                              \
      n->prev = NULL;                                                          \
...
#define _MERGE_SORT_IMPL_MERGE(LTYPE)                                          \
  static inline LTYPE *LTYPE##_merge_sort_merge_(                              \
      LTYPE *l_left, LTYPE *l_right,                                           \
      int (*fn_cmp)(const LTYPE *, const LTYPE *)) {                           \
    if (l_left == NULL)                                                        \
      return l_right;                                                          \
...
#define _MERGE_SORT_DEFN_WRAPPER_SORT(LWRAPPERTYPE, LTYPE, EXPORT)             \
  EXPORT void LTYPE##_merge_sort(                                              \
      LWRAPPERTYPE *wrapper, int (*fn_cmp)(const LTYPE *, const LTYPE *)) {    \
    ...
    if (wrapper->first == NULL || wrapper->first->next == NULL)                \
      ...
      for (LTYPE *node = wrapper->first; node != NULL; node = node->next)      \
        wrapper->last = node;                                                  \
  }
