...
#ifndef Py_LIMITED_API
PyAPI_FUNC(int)
    _PyArg_UnpackStack(PyObject *const *args, Py_ssize_t nargs,
...
PyAPI_FUNC(int) _PyArg_ParseStack(PyObject *const *args, Py_ssize_t nargs,
                                  const char *format, ...);
PyAPI_FUNC(int)
    _PyArg_ParseStackAndKeywords(PyObject *const *args, Py_ssize_t nargs,
                                 PyObject *kwnames, struct _PyArg_Parser *,
                                 ...);
PyAPI_FUNC(int)
...
PyAPI_FUNC(PyObject *const *)
    _PyArg_UnpackKeywords(PyObject *const *args, Py_ssize_t nargs,
                          ...
                          struct _PyArg_Parser *parser, int minpos, int maxpos,
                          int minkw, PyObject **buf);
#define _PyArg_UnpackKeywords(args, nargs, kwargs, kwnames, parser, minpos,    \
                              maxpos, minkw, buf)                              \
...
#ifndef Py_LIMITED_API
PyAPI_FUNC(PyObject *)
    _PyModule_CreateInitialized(struct PyModuleDef *, int apiver);
#endif
