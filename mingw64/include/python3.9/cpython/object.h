...
/* This structure helps managing static strings. The basic usage goes like this:
   ...
   interpreter shutdown, all strings are released.
...
PyAPI_FUNC(int)
    _PyObject_LookupAttrId(PyObject *, struct _Py_Identifier *, PyObject **);
...
PyAPI_FUNC(void) _PyDebugAllocatorStats(FILE *out, const char *block_name,
...
#define _PyObject_ASSERT_FROM(obj, expr, msg, filename, lineno, func)          \
  ((expr) ? (void)(0)                                                          \
          : _PyObject_AssertFailed((obj), Py_STRINGIFY(expr), (msg),           \
...
PyAPI_FUNC(int) _PyObject_CheckConsistency(PyObject *op, int check_content);
...
#define Py_TRASHCAN_BEGIN(op, dealloc)                                         \
  Py_TRASHCAN_BEGIN_CONDITION(op, Py_TYPE(op)->tp_dealloc ==                   \
                                      (destructor)(dealloc))
