...
#if SIZEOF_VOID_P == 8
  return (value == 0 || value == (uintptr_t)0xCDCDCDCDCDCDCDCD ||
          value == (uintptr_t)0xDDDDDDDDDDDDDDDD ||
          value == (uintptr_t)0xFDFDFDFDFDFDFDFD);
#elif SIZEOF_VOID_P == 4
  return (value == 0 || value == (uintptr_t)0xCDCDCDCD ||
...
#define _PyTraceMalloc_Config_INIT                                             \
  {.initialized = TRACEMALLOC_NOT_INITIALIZED, .tracing = 0, .max_nframe = 1}
