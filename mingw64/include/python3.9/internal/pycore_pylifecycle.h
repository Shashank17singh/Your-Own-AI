...
extern int _Py_SetFileSystemEncoding(const char *encoding, const char *errors);
...
extern PyStatus _PySys_Create(PyThreadState *tstate, PyObject **sysmod_p);
...
PyAPI_FUNC(PyStatus) _Py_PreInitializeFromPyArgv(const PyPreConfig *src_config,
                                                 const struct _PyArgv *args);
PyAPI_FUNC(PyStatus) _Py_PreInitializeFromConfig(const PyConfig *config,
                                                 const struct _PyArgv *args);
