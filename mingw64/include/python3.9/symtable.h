...
typedef struct _symtable_entry {
  ...
  unsigned ste_comprehension
      : 1;                      /* true if namespace is a list comprehension */
...
PyAPI_FUNC(struct symtable *) PySymtable_Build(
    mod_ty mod, const char *filename, /* decoded from the filesystem encoding */
...
#define DEF_COMP_ITER                                                          \
  2 << 8 /* this name is a comprehension iteration variable */
