...
PyAPI_FUNC(int) PyRun_InteractiveOneObject(FILE *fp, PyObject *filename,
                                           PyCompilerFlags *flags);
...
#endif
    PyAPI_FUNC(struct _node *)
        PyParser_SimpleParseStringFlagsFilename(const char *, const char *, int,
                                                int);
#endif
#ifndef Py_BUILD_CORE
Py_DEPRECATED(3.9)
...
PyAPI_FUNC(PyObject *) PyRun_FileEx(FILE *fp, const char *p, int s, PyObject *g,
                                    PyObject *l, int c);
PyAPI_FUNC(PyObject *)
...
#if defined(WIN32) && !defined(MS_WIN64) && !defined(_M_ARM) &&                \
