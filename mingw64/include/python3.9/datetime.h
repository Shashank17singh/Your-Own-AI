...
#define PyDateTime_FromDateAndTimeAndFold(year, month, day, hour, min, sec,    \
                                          usec, fold)                          \
  PyDateTimeAPI->DateTime_FromDateAndTimeAndFold(year, month, day, hour, min,  \
                                                 sec, usec, Py_None, fold,     \
                                                 PyDateTimeAPI->DateTimeType)
...
#define PyTime_FromTimeAndFold(hour, minute, second, usecond, fold)            \
  PyDateTimeAPI->Time_FromTimeAndFold(hour, minute, second, usecond, Py_None,  \
                                      fold, PyDateTimeAPI->TimeType)
