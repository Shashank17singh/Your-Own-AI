...
#define _CTF_ERRORS                                                            \
  ...
  _CTF_ITEM(ECTF_NOPARENT,                                                     \
            "The parent CTF dictionary is needed but unavailable.")            \
...
typedef int ctf_label_f(const char *name, const ctf_lblinfo_t *info, void *arg);
typedef int ctf_archive_member_f(ctf_dict_t *fp, const char *name, void *arg);
typedef int ctf_archive_raw_member_f(const char *name, const void *content,
                                     size_t len, void *arg);
typedef char *ctf_dump_decorate_f(ctf_sect_names_t sect, char *line, void *arg);
...
extern ctf_archive_t *ctf_open(const char *filename, const char *target,
                               int *errp);
...
extern ctf_dict_t *ctf_dict_open(const ctf_archive_t *, const char *, int *);
...
extern ctf_dict_t *ctf_arc_lookup_symbol(ctf_archive_t *, unsigned long symidx,
                                         ctf_id_t *, int *errp);
extern ctf_dict_t *ctf_arc_lookup_symbol_name(ctf_archive_t *, const char *name,
                                              ctf_id_t *, int *errp);
...
extern ctf_dict_t *ctf_simple_open(const char *ctfsect, size_t ctfsect_size,
                                   ...
                                   size_t symsect_entsize, const char *strsect,
                                   size_t strsect_size, int *errp);
...
extern const char *ctf_enum_next(ctf_dict_t *, ctf_id_t, ctf_next_t **, int *);
...
extern ctf_id_t ctf_arc_lookup_enumerator_next(ctf_archive_t *,
                                               const char *name, ctf_next_t **,
                                               int64_t *enum_value,
...
extern ctf_id_t ctf_type_next(ctf_dict_t *, ctf_next_t **, int *flag,
                              int want_hidden);

extern int ctf_variable_iter(ctf_dict_t *, ctf_variable_f *, void *);
extern ctf_id_t ctf_variable_next(ctf_dict_t *, ctf_next_t **, const char **);
...
extern char *ctf_dump(ctf_dict_t *, ctf_dump_state_t **state,
                      ctf_sect_names_t sect, ctf_dump_decorate_f *, void *arg);
...
extern char *ctf_errwarning_next(ctf_dict_t *, ctf_next_t **, int *is_warning,
                                 int *errp);
...
extern ctf_id_t ctf_add_array(ctf_dict_t *, uint32_t, const ctf_arinfo_t *);
...
extern ctf_id_t ctf_add_float(ctf_dict_t *, uint32_t, const char *,
                              const ctf_encoding_t *);
extern ctf_id_t ctf_add_forward(ctf_dict_t *, uint32_t, const char *, uint32_t);
extern ctf_id_t ctf_add_function(ctf_dict_t *, uint32_t, const ctf_funcinfo_t *,
                                 const ctf_id_t *);
...
extern ctf_id_t ctf_add_slice(ctf_dict_t *, uint32_t, ctf_id_t,
                              const ctf_encoding_t *);
extern ctf_id_t ctf_add_pointer(ctf_dict_t *, uint32_t, ctf_id_t);
extern ctf_id_t ctf_add_type(ctf_dict_t *, ctf_dict_t *, ctf_id_t);
extern ctf_id_t ctf_add_typedef(ctf_dict_t *, uint32_t, const char *, ctf_id_t);
...
extern int ctf_add_member_offset(ctf_dict_t *, ctf_id_t, const char *, ctf_id_t,
                                 unsigned long);
...
extern int ctf_arc_write_fd(int, ctf_dict_t **, size_t, const char **, size_t);
...
typedef char *ctf_link_memb_name_changer_f(ctf_dict_t *, const char *, void *);
extern void ctf_link_set_memb_name_changer(ctf_dict_t *,
...
extern ctf_dict_t *ctf_arc_open_by_name(const ctf_archive_t *, const char *,
                                        int *);
