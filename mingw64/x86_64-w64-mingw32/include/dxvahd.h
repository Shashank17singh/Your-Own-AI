...
typedef HRESULT(CALLBACK *PDXVAHDSW_GetVideoProcessorCustomRates)(
    HANDLE hDevice, const GUID *pVPGuid, UINT Count,
    DXVAHD_CUSTOM_RATE_DATA *pRates);
typedef HRESULT(CALLBACK *PDXVAHDSW_SetVideoProcessBltState)(
    HANDLE hVideoProcessor, DXVAHD_BLT_STATE State, UINT DataSize,
    const void *pData);
...
HRESULT WINAPI DXVAHD_CreateDevice(IDirect3DDevice9Ex *pD3DDevice,
...
DEFINE_GUID(IID_IDXVAHD_Device, 0x95f12dfd, 0xd77e, 0x49be, 0x81, 0x5f, 0x57,
            0xd5, 0x79, 0x63, 0x4d, 0x6d);
...
IDXVAHD_Device : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE CreateVideoSurface(
      UINT Width, UINT Height, D3DFORMAT Format, D3DPOOL Pool, DWORD Usage,
      DXVAHD_SURFACE_TYPE Type, UINT NumSurfaces,
      IDirect3DSurface9 * *ppSurfaces, HANDLE * pSharedHandle) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetVideoProcessorOutputFormats(
      UINT Count, D3DFORMAT * pFormats) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetVideoProcessorInputFormats(
      UINT Count, D3DFORMAT * pFormats) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetVideoProcessorCaps(
      UINT Count, DXVAHD_VPCAPS * pCaps) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetVideoProcessorCustomRates(
      const GUID *pVPGuid, UINT Count, DXVAHD_CUSTOM_RATE_DATA *pRates) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetVideoProcessorFilterRange(
      DXVAHD_FILTER Filter, DXVAHD_FILTER_RANGE_DATA * pRange) = 0;
  virtual HRESULT STDMETHODCALLTYPE CreateVideoProcessor(
      const GUID *pVPGuid, IDXVAHD_VideoProcessor **ppVideoProcessor) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDXVAHD_Device, 0x95f12dfd, 0xd77e, 0x49be, 0x81, 0x5f, 0x57,
                0xd5, 0x79, 0x63, 0x4d, 0x6d)
#endif
#else
typedef struct IDXVAHD_DeviceVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDXVAHD_Device *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *CreateVideoSurface)(
      IDXVAHD_Device *This, UINT Width, UINT Height, D3DFORMAT Format,
      D3DPOOL Pool, DWORD Usage, DXVAHD_SURFACE_TYPE Type, UINT NumSurfaces,
      IDirect3DSurface9 **ppSurfaces, HANDLE *pSharedHandle);
  HRESULT(STDMETHODCALLTYPE *GetVideoProcessorDeviceCaps)(
      IDXVAHD_Device *This, DXVAHD_VPDEVCAPS *pCaps);
  HRESULT(STDMETHODCALLTYPE *GetVideoProcessorOutputFormats)(
      IDXVAHD_Device *This, UINT Count, D3DFORMAT *pFormats);
  HRESULT(STDMETHODCALLTYPE *GetVideoProcessorInputFormats)(
      IDXVAHD_Device *This, UINT Count, D3DFORMAT *pFormats);
  HRESULT(STDMETHODCALLTYPE *GetVideoProcessorCaps)(IDXVAHD_Device *This,
                                                    UINT Count,
                                                    DXVAHD_VPCAPS *pCaps);
  HRESULT(STDMETHODCALLTYPE *GetVideoProcessorCustomRates)(
      IDXVAHD_Device *This, const GUID *pVPGuid, UINT Count,
      DXVAHD_CUSTOM_RATE_DATA *pRates);
  HRESULT(STDMETHODCALLTYPE *GetVideoProcessorFilterRange)(
      IDXVAHD_Device *This, DXVAHD_FILTER Filter,
      DXVAHD_FILTER_RANGE_DATA *pRange);
  HRESULT(STDMETHODCALLTYPE *CreateVideoProcessor)(
      IDXVAHD_Device *This, const GUID *pVPGuid,
      IDXVAHD_VideoProcessor **ppVideoProcessor);
  END_INTERFACE
} IDXVAHD_DeviceVtbl;
interface IDXVAHD_Device { CONST_VTBL IDXVAHD_DeviceVtbl *lpVtbl; };
#ifdef COBJMACROS
...
/*** IDXVAHD_Device methods ***/
#define IDXVAHD_Device_CreateVideoSurface(This, Width, Height, Format, Pool,   \
                                          Usage, Type, NumSurfaces,            \
                                          ppSurfaces, pSharedHandle)           \
  (This)->lpVtbl->CreateVideoSurface(This, Width, Height, Format, Pool, Usage, \
                                     Type, NumSurfaces, ppSurfaces,            \
                                     pSharedHandle)
...
#define IDXVAHD_Device_GetVideoProcessorCustomRates(This, pVPGuid, Count,      \
                                                    pRates)                    \
...
#else
/*** IUnknown methods ***/
static inline HRESULT IDXVAHD_Device_QueryInterface(IDXVAHD_Device *This,
                                                    REFIID riid,
                                                    void **ppvObject) {
...
/*** IDXVAHD_Device methods ***/
static inline HRESULT IDXVAHD_Device_CreateVideoSurface(
    IDXVAHD_Device *This, UINT Width, UINT Height, D3DFORMAT Format,
    D3DPOOL Pool, DWORD Usage, DXVAHD_SURFACE_TYPE Type, UINT NumSurfaces,
    IDirect3DSurface9 **ppSurfaces, HANDLE *pSharedHandle) {
  return This->lpVtbl->CreateVideoSurface(This, Width, Height, Format, Pool,
                                          Usage, Type, NumSurfaces, ppSurfaces,
                                          pSharedHandle);
}
static inline HRESULT
IDXVAHD_Device_GetVideoProcessorDeviceCaps(IDXVAHD_Device *This,
                                           DXVAHD_VPDEVCAPS *pCaps) {
  return This->lpVtbl->GetVideoProcessorDeviceCaps(This, pCaps);
}
static inline HRESULT
IDXVAHD_Device_GetVideoProcessorOutputFormats(IDXVAHD_Device *This, UINT Count,
                                              D3DFORMAT *pFormats) {
  return This->lpVtbl->GetVideoProcessorOutputFormats(This, Count, pFormats);
}
static inline HRESULT
IDXVAHD_Device_GetVideoProcessorInputFormats(IDXVAHD_Device *This, UINT Count,
                                             D3DFORMAT *pFormats) {
  return This->lpVtbl->GetVideoProcessorInputFormats(This, Count, pFormats);
}
static inline HRESULT
IDXVAHD_Device_GetVideoProcessorCaps(IDXVAHD_Device *This, UINT Count,
                                     DXVAHD_VPCAPS *pCaps) {
  return This->lpVtbl->GetVideoProcessorCaps(This, Count, pCaps);
}
static inline HRESULT
IDXVAHD_Device_GetVideoProcessorCustomRates(IDXVAHD_Device *This,
                                            const GUID *pVPGuid, UINT Count,
                                            DXVAHD_CUSTOM_RATE_DATA *pRates) {
  return This->lpVtbl->GetVideoProcessorCustomRates(This, pVPGuid, Count,
                                                    pRates);
}
static inline HRESULT
IDXVAHD_Device_GetVideoProcessorFilterRange(IDXVAHD_Device *This,
                                            DXVAHD_FILTER Filter,
                                            DXVAHD_FILTER_RANGE_DATA *pRange) {
  return This->lpVtbl->GetVideoProcessorFilterRange(This, Filter, pRange);
}
static inline HRESULT
IDXVAHD_Device_CreateVideoProcessor(IDXVAHD_Device *This, const GUID *pVPGuid,
                                    IDXVAHD_VideoProcessor **ppVideoProcessor) {
...
IDXVAHD_VideoProcessor : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE SetVideoProcessBltState(
      DXVAHD_BLT_STATE State, UINT DataSize, const void *pData) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetVideoProcessBltState(
      DXVAHD_BLT_STATE State, UINT DataSize, void *pData) = 0;
...
typedef struct IDXVAHD_VideoProcessorVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDXVAHD_VideoProcessor *This,
  ...
  HRESULT(STDMETHODCALLTYPE *SetVideoProcessBltState)(
      IDXVAHD_VideoProcessor *This, DXVAHD_BLT_STATE State, UINT DataSize,
      const void *pData);
  HRESULT(STDMETHODCALLTYPE *GetVideoProcessBltState)(
      IDXVAHD_VideoProcessor *This, DXVAHD_BLT_STATE State, UINT DataSize,
      void *pData);
  HRESULT(STDMETHODCALLTYPE *SetVideoProcessStreamState)(
      IDXVAHD_VideoProcessor *This, UINT StreamNumber,
      DXVAHD_STREAM_STATE State, UINT DataSize, const void *pData);
  HRESULT(STDMETHODCALLTYPE *GetVideoProcessStreamState)(
      IDXVAHD_VideoProcessor *This, UINT StreamNumber,
      DXVAHD_STREAM_STATE State, UINT DataSize, void *pData);
  HRESULT(STDMETHODCALLTYPE *VideoProcessBltHD)(
      IDXVAHD_VideoProcessor *This, IDirect3DSurface9 *pOutputSurface,
      UINT OutputFrame, UINT StreamCount, const DXVAHD_STREAM_DATA *pStreams);
  END_INTERFACE
...
/*** IDXVAHD_VideoProcessor methods ***/
#define IDXVAHD_VideoProcessor_SetVideoProcessBltState(This, State, DataSize,  \
                                                       pData)                  \
  (This)->lpVtbl->SetVideoProcessBltState(This, State, DataSize, pData)
#define IDXVAHD_VideoProcessor_GetVideoProcessBltState(This, State, DataSize,  \
                                                       pData)                  \
  (This)->lpVtbl->GetVideoProcessBltState(This, State, DataSize, pData)
#define IDXVAHD_VideoProcessor_SetVideoProcessStreamState(                     \
    This, StreamNumber, State, DataSize, pData)                                \
  (This)->lpVtbl->SetVideoProcessStreamState(This, StreamNumber, State,        \
                                             DataSize, pData)
#define IDXVAHD_VideoProcessor_GetVideoProcessStreamState(                     \
    This, StreamNumber, State, DataSize, pData)                                \
  (This)->lpVtbl->GetVideoProcessStreamState(This, StreamNumber, State,        \
                                             DataSize, pData)
#define IDXVAHD_VideoProcessor_VideoProcessBltHD(                              \
    This, pOutputSurface, OutputFrame, StreamCount, pStreams)                  \
  (This)->lpVtbl->VideoProcessBltHD(This, pOutputSurface, OutputFrame,         \
                                    StreamCount, pStreams)
#else
/*** IUnknown methods ***/
static inline HRESULT
IDXVAHD_VideoProcessor_QueryInterface(IDXVAHD_VideoProcessor *This, REFIID riid,
                                      void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IDXVAHD_VideoProcessor_AddRef(IDXVAHD_VideoProcessor *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IDXVAHD_VideoProcessor_Release(IDXVAHD_VideoProcessor *This) {
  return This->lpVtbl->Release(This);
}
/*** IDXVAHD_VideoProcessor methods ***/
static inline HRESULT IDXVAHD_VideoProcessor_SetVideoProcessBltState(
    IDXVAHD_VideoProcessor *This, DXVAHD_BLT_STATE State, UINT DataSize,
    const void *pData) {
  return This->lpVtbl->SetVideoProcessBltState(This, State, DataSize, pData);
}
static inline HRESULT
IDXVAHD_VideoProcessor_GetVideoProcessBltState(IDXVAHD_VideoProcessor *This,
                                               DXVAHD_BLT_STATE State,
                                               UINT DataSize, void *pData) {
  return This->lpVtbl->GetVideoProcessBltState(This, State, DataSize, pData);
}
static inline HRESULT IDXVAHD_VideoProcessor_SetVideoProcessStreamState(
    IDXVAHD_VideoProcessor *This, UINT StreamNumber, DXVAHD_STREAM_STATE State,
    UINT DataSize, const void *pData) {
  return This->lpVtbl->SetVideoProcessStreamState(This, StreamNumber, State,
                                                  DataSize, pData);
}
static inline HRESULT IDXVAHD_VideoProcessor_GetVideoProcessStreamState(
    IDXVAHD_VideoProcessor *This, UINT StreamNumber, DXVAHD_STREAM_STATE State,
    UINT DataSize, void *pData) {
  return This->lpVtbl->GetVideoProcessStreamState(This, StreamNumber, State,
                                                  DataSize, pData);
}
static inline HRESULT IDXVAHD_VideoProcessor_VideoProcessBltHD(
    IDXVAHD_VideoProcessor *This, IDirect3DSurface9 *pOutputSurface,
    UINT OutputFrame, UINT StreamCount, const DXVAHD_STREAM_DATA *pStreams) {
  return This->lpVtbl->VideoProcessBltHD(This, pOutputSurface, OutputFrame,
                                         StreamCount, pStreams);
}
#endif
#endif
