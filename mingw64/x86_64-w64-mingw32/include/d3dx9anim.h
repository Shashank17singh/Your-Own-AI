...
DECLARE_INTERFACE(ID3DXAllocateHierarchy) {
  ...
  STDMETHOD(CreateMeshContainer)(
      THIS_ const char *name, const D3DXMESHDATA *mesh_data,
  ...
  STDMETHOD(DestroyMeshContainer)(THIS_ LPD3DXMESHCONTAINER mesh_container)
      PURE;
};
#undef INTERFACE
...
DECLARE_INTERFACE(ID3DXLoadUserData) {
  ...
  STDMETHOD(LoadFrameChildData)(THIS_ D3DXFRAME * frame,
                                ID3DXFileData * child_data) PURE;
  STDMETHOD(LoadMeshChildData)(THIS_ D3DXMESHCONTAINER * mesh_container,
                               ID3DXFileData * child_data) PURE;
};
#undef INTERFACE
...
DECLARE_INTERFACE(ID3DXSaveUserData) {
  ...
  STDMETHOD(AddFrameChildData)(THIS_ const D3DXFRAME *frame,
                               ID3DXFileSaveObject *save_obj,
                               ID3DXFileSaveData *frame_data) PURE;
  STDMETHOD(AddMeshChildData)(THIS_ const D3DXMESHCONTAINER *mesh_container,
                              ID3DXFileSaveObject *save_obj,
                              ID3DXFileSaveData *mesh_data) PURE;
  STDMETHOD(AddTopLevelDataObjectsPre)(THIS_ ID3DXFileSaveObject * save_obj)
      PURE;
  STDMETHOD(AddTopLevelDataObjectsPost)(THIS_ ID3DXFileSaveObject * save_obj)
      PURE;
...
DECLARE_INTERFACE_(ID3DXAnimationSet, IUnknown) {
  ...
  STDMETHOD(GetSRT)(THIS_ DOUBLE periodic_position, UINT animation,
                    D3DXVECTOR3 * scale, D3DXQUATERNION * rotation,
                    D3DXVECTOR3 * translation) PURE;
  STDMETHOD(GetCallback)(THIS_ double position, DWORD flags,
                         double *callback_position, void **callback_data) PURE;
};
#undef INTERFACE
...
DECLARE_INTERFACE_(ID3DXKeyframedAnimationSet, ID3DXAnimationSet) {
  ...
  STDMETHOD(GetScaleKeys)(THIS_ UINT animation, LPD3DXKEY_VECTOR3 scale_keys)
      PURE;
  STDMETHOD(GetScaleKey)(THIS_ UINT animation, UINT key,
                         LPD3DXKEY_VECTOR3 scale_key) PURE;
  ...
  STDMETHOD(GetRotationKeys)(THIS_ UINT animation,
                             LPD3DXKEY_QUATERNION rotation_keys) PURE;
  STDMETHOD(GetRotationKey)(THIS_ UINT animation, UINT key,
                            LPD3DXKEY_QUATERNION rotation_key) PURE;
  ...
  STDMETHOD(GetTranslationKeys)(THIS_ UINT animation,
                                LPD3DXKEY_VECTOR3 translation_keys) PURE;
  STDMETHOD(GetTranslationKey)(THIS_ UINT animation, UINT key,
                               LPD3DXKEY_VECTOR3 translation_key) PURE;
  ...
  STDMETHOD(GetCallbackKey)(THIS_ UINT key, LPD3DXKEY_CALLBACK callback_key)
      PURE;
  STDMETHOD(SetCallbackKey)(THIS_ UINT key, LPD3DXKEY_CALLBACK callback_key)
      PURE;
  ...
  STDMETHOD(RegisterAnimationSRTKeys)(
      THIS_ const char *name, UINT num_scale_keys, UINT num_rotation_keys,
      UINT num_translation_keys, const D3DXKEY_VECTOR3 *scale_keys,
      const D3DXKEY_QUATERNION *rotation_keys,
      const D3DXKEY_VECTOR3 *translation_keys, DWORD *animation_index) PURE;
...
DECLARE_INTERFACE_(ID3DXAnimationController, IUnknown) {
  ...
  STDMETHOD(RegisterAnimationOutput)(
      THIS_ const char *name, D3DXMATRIX *matrix, D3DXVECTOR3 *scale,
  ...
  STDMETHOD(GetAnimationSet)(THIS_ UINT index, ID3DXAnimationSet * *anim_set)
      PURE;
  STDMETHOD(GetAnimationSetByName)(THIS_ const char *name,
                                   ID3DXAnimationSet **anim_set) PURE;
  STDMETHOD(AdvanceTime)(THIS_ double time_delta,
                         ID3DXAnimationCallbackHandler *callback_handler) PURE;
  ...
  STDMETHOD_(D3DXEVENTHANDLE, KeyTrackSpeed)(
      THIS_ UINT track, float new_speed, double start_time, double duration,
      D3DXTRANSITION_TYPE transition) PURE;
  STDMETHOD_(D3DXEVENTHANDLE, KeyTrackWeight)(
      THIS_ UINT track, float new_weight, double start_time, double duration,
      D3DXTRANSITION_TYPE transition) PURE;
  STDMETHOD_(D3DXEVENTHANDLE, KeyTrackPosition)(
      THIS_ UINT track, double new_position, double start_time) PURE;
  STDMETHOD_(D3DXEVENTHANDLE, KeyTrackEnable)(
      THIS_ UINT track, WINBOOL new_enable, double start_time) PURE;
  STDMETHOD_(D3DXEVENTHANDLE, KeyPriorityBlend)(
      THIS_ float new_blend_weight, double start_time, double duration,
      D3DXTRANSITION_TYPE transition) PURE;
  ...
  STDMETHOD_(D3DXEVENTHANDLE, GetCurrentTrackEvent)(
      THIS_ UINT track, D3DXEVENT_TYPE event_type) PURE;
  STDMETHOD_(D3DXEVENTHANDLE, GetCurrentPriorityBlend)(THIS) PURE;
  STDMETHOD_(D3DXEVENTHANDLE, GetUpcomingTrackEvent)(
      THIS_ UINT track, D3DXEVENTHANDLE event) PURE;
  STDMETHOD_(D3DXEVENTHANDLE,
             GetUpcomingPriorityBlend)(THIS_ D3DXEVENTHANDLE event) PURE;
  STDMETHOD(ValidateEvent)(THIS_ D3DXEVENTHANDLE event) PURE;
  STDMETHOD(GetEventDesc)(THIS_ D3DXEVENTHANDLE event, D3DXEVENT_DESC * desc)
      PURE;
  STDMETHOD(CloneAnimationController)(
      THIS_ UINT max_num_anim_outputs, UINT max_num_anim_sets,
      UINT max_num_tracks, UINT max_num_events,
      ID3DXAnimationController * *anim_controller) PURE;
};
#undef INTERFACE
#ifdef __cplusplus
extern "C" {
...
HRESULT WINAPI D3DXLoadMeshHierarchyFromXA(
    const char *filename, DWORD flags, struct IDirect3DDevice9 *device,
...
HRESULT WINAPI D3DXLoadMeshHierarchyFromXW(
    const WCHAR *filename, DWORD flags, struct IDirect3DDevice9 *device,
    struct ID3DXAllocateHierarchy *alloc,
    struct ID3DXLoadUserData *user_data_loader, D3DXFRAME **frame_hierarchy,
    struct ID3DXAnimationController **animation_controller);
...
HRESULT WINAPI D3DXSaveMeshHierarchyToFileA(
    const char *filename, DWORD format, const D3DXFRAME *frame_root,
...
HRESULT WINAPI D3DXSaveMeshHierarchyToFileW(
    const WCHAR *filename, DWORD format, const D3DXFRAME *frame_root,
    ID3DXAnimationController *animation_controller,
    ID3DXSaveUserData *user_data_saver);
...
HRESULT WINAPI D3DXFrameRegisterNamedMatrices(
    D3DXFRAME *frame_root, ID3DXAnimationController *animation_controller);
...
HRESULT WINAPI D3DXCreateKeyframedAnimationSet(
    const char *name, double ticks_per_second, D3DXPLAYBACK_TYPE playback_type,
    UINT animation_count, UINT callback_key_count,
...
HRESULT WINAPI D3DXCreateCompressedAnimationSet(
    const char *name, double ticks_per_second, D3DXPLAYBACK_TYPE playback_type,
    ID3DXBuffer *compressed_data, UINT callback_key_count,
    const D3DXKEY_CALLBACK *callback_keys,
    ID3DXCompressedAnimationSet **animation_set);
HRESULT WINAPI D3DXCreateAnimationController(
    UINT max_animation_output_count, UINT max_animation_set_count,
    UINT max_track_count, UINT max_event_count,
    ID3DXAnimationController **animation_controller);
#ifdef __cplusplus
}
#endif
