...
#define __CRT_SECURE_CPP_OVERLOAD_STANDARD_NAMES_MEMORY_0_3_(                  \
  ...
  extern "C" {                                                                 \
  _CRTIMP __ret __cdecl                                                        \
  __func(__type1 *__attrib1 __arg1, __type2 __attrib2 __arg2,                  \
         __type3 __attrib3 __arg3) __MINGW_ATTRIB_DEPRECATED_SEC_WARN;         \
  }                                                                            \
  extern "C++" {                                                               \
  template <size_t __size, typename __dsttype>                                 \
  inline typename __if_array<(__size > 1), void *>::__type __cdecl             \
  __func(__dsttype (&__arg1)[__size], __type2 __attrib2(__arg2),               \
         __type3 __attrib3(__arg3)) {                                          \
