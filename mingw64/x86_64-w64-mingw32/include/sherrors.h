...
#define COPYENGINE_S_DONT_PROCESS_CHILDREN                                     \
  _HRESULT_TYPEDEF_(__MSABI_LONG(0x00270008))
...
#define COPYENGINE_S_COLLISIONRESOLVED                                         \
  _HRESULT_TYPEDEF_(__MSABI_LONG(0x0027000e))
...
#define COPYENGINE_E_REQUIRES_ELEVATION                                        \
  _HRESULT_TYPEDEF_(__MSABI_LONG(0x80270002))
...
#define COPYENGINE_E_FLD_IS_FILE_DEST                                          \
  _HRESULT_TYPEDEF_(__MSABI_LONG(0x8027000b))
#define COPYENGINE_E_FILE_IS_FLD_DEST                                          \
  _HRESULT_TYPEDEF_(__MSABI_LONG(0x8027000c))
...
#define COPYENGINE_E_INVALID_FILES_SRC                                         \
  _HRESULT_TYPEDEF_(__MSABI_LONG(0x8027001b))
#define COPYENGINE_E_INVALID_FILES_DEST                                        \
  _HRESULT_TYPEDEF_(__MSABI_LONG(0x8027001c))
#define COPYENGINE_E_PATH_TOO_DEEP_SRC                                         \
  _HRESULT_TYPEDEF_(__MSABI_LONG(0x8027001d))
#define COPYENGINE_E_PATH_TOO_DEEP_DEST                                        \
  _HRESULT_TYPEDEF_(__MSABI_LONG(0x8027001e))
...
#define COPYENGINE_E_ACCESS_DENIED_SRC                                         \
  _HRESULT_TYPEDEF_(__MSABI_LONG(0x80270021))
#define COPYENGINE_E_ACCESS_DENIED_DEST                                        \
  _HRESULT_TYPEDEF_(__MSABI_LONG(0x80270022))
#define COPYENGINE_E_PATH_NOT_FOUND_SRC                                        \
  _HRESULT_TYPEDEF_(__MSABI_LONG(0x80270023))
#define COPYENGINE_E_PATH_NOT_FOUND_DEST                                       \
  _HRESULT_TYPEDEF_(__MSABI_LONG(0x80270024))
#define COPYENGINE_E_NET_DISCONNECT_SRC                                        \
  _HRESULT_TYPEDEF_(__MSABI_LONG(0x80270025))
#define COPYENGINE_E_NET_DISCONNECT_DEST                                       \
  _HRESULT_TYPEDEF_(__MSABI_LONG(0x80270026))
#define COPYENGINE_E_SHARING_VIOLATION_SRC                                     \
  _HRESULT_TYPEDEF_(__MSABI_LONG(0x80270027))
#define COPYENGINE_E_SHARING_VIOLATION_DEST                                    \
  _HRESULT_TYPEDEF_(__MSABI_LONG(0x80270028))
#define COPYENGINE_E_ALREADY_EXISTS_NORMAL                                     \
  _HRESULT_TYPEDEF_(__MSABI_LONG(0x80270029))
#define COPYENGINE_E_ALREADY_EXISTS_READONLY                                   \
  _HRESULT_TYPEDEF_(__MSABI_LONG(0x8027002a))
#define COPYENGINE_E_ALREADY_EXISTS_SYSTEM                                     \
  _HRESULT_TYPEDEF_(__MSABI_LONG(0x8027002b))
#define COPYENGINE_E_ALREADY_EXISTS_FOLDER                                     \
  _HRESULT_TYPEDEF_(__MSABI_LONG(0x8027002c))
...
#define COPYENGINE_E_EA_NOT_SUPPORTED                                          \
  _HRESULT_TYPEDEF_(__MSABI_LONG(0x80270034))
#define COPYENGINE_E_CANT_REACH_SOURCE                                         \
  _HRESULT_TYPEDEF_(__MSABI_LONG(0x80270035))
#define COPYENGINE_E_RECYCLE_UNKNOWN_ERROR                                     \
  _HRESULT_TYPEDEF_(__MSABI_LONG(0x80270035))
#define COPYENGINE_E_RECYCLE_FORCE_NUKE                                        \
  _HRESULT_TYPEDEF_(__MSABI_LONG(0x80270036))
#define COPYENGINE_E_RECYCLE_SIZE_TOO_BIG                                      \
  _HRESULT_TYPEDEF_(__MSABI_LONG(0x80270037))
#define COPYENGINE_E_RECYCLE_PATH_TOO_LONG                                     \
  _HRESULT_TYPEDEF_(__MSABI_LONG(0x80270038))
#define COPYENGINE_E_RECYCLE_BIN_NOT_FOUND                                     \
  _HRESULT_TYPEDEF_(__MSABI_LONG(0x8027003a))
#define COPYENGINE_E_NEWFILE_NAME_TOO_LONG                                     \
  _HRESULT_TYPEDEF_(__MSABI_LONG(0x8027003b))
#define COPYENGINE_E_NEWFOLDER_NAME_TOO_LONG                                   \
  _HRESULT_TYPEDEF_(__MSABI_LONG(0x8027003c))
...
#define COPYENGINE_E_ACCESSDENIED_READONLY                                     \
  _HRESULT_TYPEDEF_(__MSABI_LONG(0x8027003f))
#define COPYENGINE_E_REDIRECTED_TO_WEBPAGE                                     \
  _HRESULT_TYPEDEF_(__MSABI_LONG(0x80270040))
#define COPYENGINE_E_SERVER_BAD_FILE_TYPE                                      \
  _HRESULT_TYPEDEF_(__MSABI_LONG(0x80270041))
...
#define STORE_E_NEWER_VERSION_AVAILABLE                                        \
  _HRESULT_TYPEDEF_(__MSABI_LONG(0x80270104))
#define LIBRARY_E_NO_SAVE_LOCATION _HRESULT_TYPEDEF_(__MSABI_LONG(0x80270200))
#define LIBRARY_E_NO_ACCESSIBLE_LOCATION                                       \
  _HRESULT_TYPEDEF_(__MSABI_LONG(0x80270201))
#define E_USERTILE_UNSUPPORTEDFILETYPE                                         \
  _HRESULT_TYPEDEF_(__MSABI_LONG(0x80270210))
...
#define IMM_ACC_DOCKING_E_INSUFFICIENTHEIGHT                                   \
  _HRESULT_TYPEDEF_(__MSABI_LONG(0x80270230))
#define IMM_ACC_DOCKING_E_DOCKOCCUPIED                                         \
  _HRESULT_TYPEDEF_(__MSABI_LONG(0x80270231))
#define IMSC_E_SHELL_COMPONENT_STARTUP_FAILURE                                 \
  _HRESULT_TYPEDEF_(__MSABI_LONG(0x80270233))
#define E_TILE_NOTIFICATIONS_PLATFORM_FAILURE                                  \
  _HRESULT_TYPEDEF_(__MSABI_LONG(0x80270249))
