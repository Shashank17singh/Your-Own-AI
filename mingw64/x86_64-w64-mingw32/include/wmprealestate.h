...
DEFINE_GUID(IID_IWMPVideoRenderConfig, 0x6d6cf803, 0x1ec0, 0x4c8d, 0xb3, 0xca,
            0xf1, 0x8e, 0x27, 0x28, 0x20, 0x74);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("6d6cf803-1ec0-4c8d-b3ca-f18e27282074")
IWMPVideoRenderConfig : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE put_presenterActivate(IMFActivate *
                                                          activate) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IWMPVideoRenderConfig, 0x6d6cf803, 0x1ec0, 0x4c8d, 0xb3, 0xca,
                0xf1, 0x8e, 0x27, 0x28, 0x20, 0x74)
#endif
#else
typedef struct IWMPVideoRenderConfigVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWMPVideoRenderConfig *This,
  ...
  HRESULT(STDMETHODCALLTYPE *put_presenterActivate)(IWMPVideoRenderConfig *This,
...
/*** IWMPVideoRenderConfig methods ***/
#define IWMPVideoRenderConfig_put_presenterActivate(This, activate)            \
  (This)->lpVtbl->put_presenterActivate(This, activate)
#else
/*** IUnknown methods ***/
static inline HRESULT
IWMPVideoRenderConfig_QueryInterface(IWMPVideoRenderConfig *This, REFIID riid,
                                     void **ppvObject) {
...
/*** IWMPVideoRenderConfig methods ***/
static inline HRESULT
IWMPVideoRenderConfig_put_presenterActivate(IWMPVideoRenderConfig *This,
                                            IMFActivate *activate) {
...
DEFINE_GUID(IID_IWMPRenderConfig, 0x959506c1, 0x0314, 0x4ec5, 0x9e, 0x61, 0x85,
            0x28, 0xdb, 0x5e, 0x54, 0x78);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("959506c1-0314-4ec5-9e61-8528db5e5478")
IWMPRenderConfig : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE put_inProcOnly(WINBOOL fInProc) = 0;
  virtual HRESULT STDMETHODCALLTYPE get_inProcOnly(WINBOOL * pfInProc) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IWMPRenderConfig, 0x959506c1, 0x0314, 0x4ec5, 0x9e, 0x61, 0x85,
                0x28, 0xdb, 0x5e, 0x54, 0x78)
#endif
#else
typedef struct IWMPRenderConfigVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWMPRenderConfig *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *put_inProcOnly)(IWMPRenderConfig *This,
                                             WINBOOL fInProc);
  HRESULT(STDMETHODCALLTYPE *get_inProcOnly)(IWMPRenderConfig *This,
                                             WINBOOL *pfInProc);
  END_INTERFACE
} IWMPRenderConfigVtbl;
interface IWMPRenderConfig { CONST_VTBL IWMPRenderConfigVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IWMPRenderConfig_QueryInterface(IWMPRenderConfig *This,
                                                      REFIID riid,
                                                      void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IWMPRenderConfig methods ***/
static inline HRESULT IWMPRenderConfig_put_inProcOnly(IWMPRenderConfig *This,
                                                      WINBOOL fInProc) {
  return This->lpVtbl->put_inProcOnly(This, fInProc);
}
static inline HRESULT IWMPRenderConfig_get_inProcOnly(IWMPRenderConfig *This,
                                                      WINBOOL *pfInProc) {
