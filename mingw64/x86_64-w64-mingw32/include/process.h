...
#else
int __stdcall DllMain(void *_HDllHandle, unsigned long _Reason,
                      void *_Reserved);
int __stdcall _CRT_INIT(void *_HDllHandle, unsigned long _Reason,
                        void *_Reserved);
int __stdcall _wCRT_INIT(void *_HDllHandle, unsigned long _Reason,
                         void *_Reserved);
...
#endif
_CRTIMP intptr_t __cdecl
spawnv(int, const char *_Filename,
       char *const _ArgList[]) __MINGW_ATTRIB_DEPRECATED_MSVC2005;
_CRTIMP intptr_t __cdecl
spawnve(int, const char *_Filename, char *const _ArgList[],
        char *const _Env[]) __MINGW_ATTRIB_DEPRECATED_MSVC2005;
_CRTIMP intptr_t __cdecl
spawnvp(int, const char *_Filename,
        char *const _ArgList[]) __MINGW_ATTRIB_DEPRECATED_MSVC2005;
_CRTIMP intptr_t __cdecl
