...
typedef struct ITPluggableTerminalEventSinkRegistration
...
public:
  ...
  EnumerateAgentSessions(IEnumAgentSession **ppEnumAgentSession) = 0;
  virtual HRESULT WINAPI CreateSession(ITACDGroup *pACDGroup,
                                       ITAddress *pAddress,
                                       ITAgentSession **ppAgentSession) = 0;
  virtual HRESULT WINAPI
  CreateSessionWithPIN(ITACDGroup *pACDGroup, ITAddress *pAddress, BSTR pPIN,
                       ITAgentSession **ppAgentSession) = 0;
...
typedef struct ITAgentVtbl {
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITAgent *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITAgent *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITAgent *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *EnumerateAgentSessions)(
      ITAgent *This, IEnumAgentSession **ppEnumAgentSession);
  HRESULT(WINAPI *CreateSession)(ITAgent *This, ITACDGroup *pACDGroup,
                                 ITAddress *pAddress,
                                 ITAgentSession **ppAgentSession);
  HRESULT(WINAPI *CreateSessionWithPIN)(ITAgent *This, ITACDGroup *pACDGroup,
                                        ITAddress *pAddress, BSTR pPIN,
                                        ITAgentSession **ppAgentSession);
...
#define ITAgent_Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,    \
...
#define ITAgent_CreateSessionWithPIN(This, pACDGroup, pAddress, pPIN,          \
                                     ppAgentSession)                           \
  (This)->lpVtbl->CreateSessionWithPIN(This, pACDGroup, pAddress, pPIN,        \
                                       ppAgentSession)
...
#endif
#endif
HRESULT WINAPI ITAgent_EnumerateAgentSessions_Proxy(
    ITAgent *This, IEnumAgentSession **ppEnumAgentSession);
...
HRESULT WINAPI ITAgent_CreateSession_Proxy(ITAgent *This, ITACDGroup *pACDGroup,
                                           ITAddress *pAddress,
                                           ITAgentSession **ppAgentSession);
...
HRESULT WINAPI ITAgent_CreateSessionWithPIN_Proxy(
    ITAgent *This, ITACDGroup *pACDGroup, ITAddress *pAddress, BSTR pPIN,
    ITAgentSession **ppAgentSession);
void __RPC_STUB ITAgent_CreateSessionWithPIN_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAgent_get_ID_Proxy(ITAgent *This, BSTR *ppID);
void __RPC_STUB ITAgent_get_ID_Stub(IRpcStubBuffer *This,
                                    IRpcChannelBuffer *_pRpcChannelBuffer,
                                    PRPC_MESSAGE _pRpcMessage,
                                    DWORD *_pdwStubPhase);
HRESULT WINAPI ITAgent_get_User_Proxy(ITAgent *This, BSTR *ppUser);
void __RPC_STUB ITAgent_get_User_Stub(IRpcStubBuffer *This,
                                      IRpcChannelBuffer *_pRpcChannelBuffer,
                                      PRPC_MESSAGE _pRpcMessage,
                                      DWORD *_pdwStubPhase);
HRESULT WINAPI ITAgent_put_State_Proxy(ITAgent *This, AGENT_STATE AgentState);
void __RPC_STUB ITAgent_put_State_Stub(IRpcStubBuffer *This,
                                       IRpcChannelBuffer *_pRpcChannelBuffer,
                                       PRPC_MESSAGE _pRpcMessage,
                                       DWORD *_pdwStubPhase);
HRESULT WINAPI ITAgent_get_State_Proxy(ITAgent *This, AGENT_STATE *pAgentState);
void __RPC_STUB ITAgent_get_State_Stub(IRpcStubBuffer *This,
                                       IRpcChannelBuffer *_pRpcChannelBuffer,
                                       PRPC_MESSAGE _pRpcMessage,
                                       DWORD *_pdwStubPhase);
HRESULT WINAPI ITAgent_put_MeasurementPeriod_Proxy(ITAgent *This,
                                                   __LONG32 lPeriod);
void __RPC_STUB ITAgent_put_MeasurementPeriod_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAgent_get_MeasurementPeriod_Proxy(ITAgent *This,
                                                   __LONG32 *plPeriod);
void __RPC_STUB ITAgent_get_MeasurementPeriod_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAgent_get_OverallCallRate_Proxy(ITAgent *This,
                                                 CURRENCY *pcyCallrate);
void __RPC_STUB ITAgent_get_OverallCallRate_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAgent_get_NumberOfACDCalls_Proxy(ITAgent *This,
                                                  __LONG32 *plCalls);
void __RPC_STUB ITAgent_get_NumberOfACDCalls_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAgent_get_NumberOfIncomingCalls_Proxy(ITAgent *This,
                                                       __LONG32 *plCalls);
void __RPC_STUB ITAgent_get_NumberOfIncomingCalls_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAgent_get_NumberOfOutgoingCalls_Proxy(ITAgent *This,
                                                       __LONG32 *plCalls);
void __RPC_STUB ITAgent_get_NumberOfOutgoingCalls_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAgent_get_TotalACDTalkTime_Proxy(ITAgent *This,
                                                  __LONG32 *plTalkTime);
void __RPC_STUB ITAgent_get_TotalACDTalkTime_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAgent_get_TotalACDCallTime_Proxy(ITAgent *This,
                                                  __LONG32 *plCallTime);
void __RPC_STUB ITAgent_get_TotalACDCallTime_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAgent_get_TotalWrapUpTime_Proxy(ITAgent *This,
                                                 __LONG32 *plWrapUpTime);
void __RPC_STUB ITAgent_get_TotalWrapUpTime_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAgent_get_AgentSessions_Proxy(ITAgent *This,
                                               VARIANT *pVariant);
...
typedef struct ITAgentSessionVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITAgentSession *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITAgentSession *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITAgentSession *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITAgentSession *This, DISPID dispIdMember,
  ...
  HRESULT(WINAPI *put_State)(ITAgentSession *This,
                             AGENT_SESSION_STATE SessionState);
  HRESULT(WINAPI *get_State)(ITAgentSession *This,
                             AGENT_SESSION_STATE *pSessionState);
  HRESULT(WINAPI *get_SessionStartTime)(ITAgentSession *This,
                                        DATE *pdateSessionStart);
  HRESULT(WINAPI *get_SessionDuration)(ITAgentSession *This,
                                       __LONG32 *plDuration);
  HRESULT(WINAPI *get_NumberOfCalls)(ITAgentSession *This, __LONG32 *plCalls);
  HRESULT(WINAPI *get_TotalTalkTime)(ITAgentSession *This,
                                     __LONG32 *plTalkTime);
  HRESULT(WINAPI *get_AverageTalkTime)(ITAgentSession *This,
                                       __LONG32 *plTalkTime);
  HRESULT(WINAPI *get_TotalCallTime)(ITAgentSession *This,
                                     __LONG32 *plCallTime);
  HRESULT(WINAPI *get_AverageCallTime)(ITAgentSession *This,
                                       __LONG32 *plCallTime);
  HRESULT(WINAPI *get_TotalWrapUpTime)(ITAgentSession *This,
                                       __LONG32 *plWrapUpTime);
  HRESULT(WINAPI *get_AverageWrapUpTime)(ITAgentSession *This,
                                         __LONG32 *plWrapUpTime);
  HRESULT(WINAPI *get_ACDCallRate)(ITAgentSession *This, CURRENCY *pcyCallrate);
  HRESULT(WINAPI *get_LongestTimeToAnswer)(ITAgentSession *This,
                                           __LONG32 *plAnswerTime);
  HRESULT(WINAPI *get_AverageTimeToAnswer)(ITAgentSession *This,
                                           __LONG32 *plAnswerTime);
  END_INTERFACE
} ITAgentSessionVtbl;
...
#define ITAgentSession_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITAgentSession_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,      \
                                     rgDispId)                                 \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITAgentSession_Invoke(This, dispIdMember, riid, lcid, wFlags,          \
...
#endif
#endif
HRESULT WINAPI ITAgentSession_get_Agent_Proxy(ITAgentSession *This,
                                              ITAgent **ppAgent);
void __RPC_STUB ITAgentSession_get_Agent_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAgentSession_get_Address_Proxy(ITAgentSession *This,
                                                ITAddress **ppAddress);
void __RPC_STUB ITAgentSession_get_Address_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAgentSession_get_ACDGroup_Proxy(ITAgentSession *This,
                                                 ITACDGroup **ppACDGroup);
void __RPC_STUB ITAgentSession_get_ACDGroup_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAgentSession_put_State_Proxy(ITAgentSession *This,
                                              AGENT_SESSION_STATE SessionState);
void __RPC_STUB ITAgentSession_put_State_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAgentSession_get_State_Proxy(
    ITAgentSession *This, AGENT_SESSION_STATE *pSessionState);
void __RPC_STUB ITAgentSession_get_State_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAgentSession_get_SessionStartTime_Proxy(
    ITAgentSession *This, DATE *pdateSessionStart);
void __RPC_STUB ITAgentSession_get_SessionStartTime_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAgentSession_get_SessionDuration_Proxy(ITAgentSession *This,
                                                        __LONG32 *plDuration);
void __RPC_STUB ITAgentSession_get_SessionDuration_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAgentSession_get_NumberOfCalls_Proxy(ITAgentSession *This,
                                                      __LONG32 *plCalls);
void __RPC_STUB ITAgentSession_get_NumberOfCalls_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAgentSession_get_TotalTalkTime_Proxy(ITAgentSession *This,
                                                      __LONG32 *plTalkTime);
void __RPC_STUB ITAgentSession_get_TotalTalkTime_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAgentSession_get_AverageTalkTime_Proxy(ITAgentSession *This,
                                                        __LONG32 *plTalkTime);
void __RPC_STUB ITAgentSession_get_AverageTalkTime_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAgentSession_get_TotalCallTime_Proxy(ITAgentSession *This,
                                                      __LONG32 *plCallTime);
void __RPC_STUB ITAgentSession_get_TotalCallTime_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAgentSession_get_AverageCallTime_Proxy(ITAgentSession *This,
                                                        __LONG32 *plCallTime);
void __RPC_STUB ITAgentSession_get_AverageCallTime_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAgentSession_get_TotalWrapUpTime_Proxy(ITAgentSession *This,
                                                        __LONG32 *plWrapUpTime);
void __RPC_STUB ITAgentSession_get_TotalWrapUpTime_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAgentSession_get_AverageWrapUpTime_Proxy(
    ITAgentSession *This, __LONG32 *plWrapUpTime);
void __RPC_STUB ITAgentSession_get_AverageWrapUpTime_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAgentSession_get_ACDCallRate_Proxy(ITAgentSession *This,
                                                    CURRENCY *pcyCallrate);
void __RPC_STUB ITAgentSession_get_ACDCallRate_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAgentSession_get_LongestTimeToAnswer_Proxy(
...
typedef struct ITACDGroupVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITACDGroup *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITACDGroup *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITACDGroup *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITACDGroup *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
...
#define ITACDGroup_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                    \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITACDGroup_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,          \
                                 rgDispId)                                     \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITACDGroup_Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr)                    \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
void __RPC_STUB ITACDGroup_get_Name_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
HRESULT WINAPI ITACDGroup_EnumerateQueues_Proxy(ITACDGroup *This,
                                                IEnumQueue **ppEnumQueue);
...
typedef struct ITQueueVtbl {
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITQueue *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITQueue *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITQueue *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  ...
  HRESULT(WINAPI *get_CurrentLongestWaitTime)(ITQueue *This,
                                              __LONG32 *plWaitTime);
...
#define ITQueue_GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)   \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITQueue_Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,    \
                       pVarResult, pExcepInfo, puArgErr)                       \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI ITQueue_put_MeasurementPeriod_Proxy(ITQueue *This,
                                                   __LONG32 lPeriod);
void __RPC_STUB ITQueue_put_MeasurementPeriod_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITQueue_get_MeasurementPeriod_Proxy(ITQueue *This,
                                                   __LONG32 *plPeriod);
void __RPC_STUB ITQueue_get_MeasurementPeriod_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITQueue_get_TotalCallsQueued_Proxy(ITQueue *This,
                                                  __LONG32 *plCalls);
void __RPC_STUB ITQueue_get_TotalCallsQueued_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITQueue_get_CurrentCallsQueued_Proxy(ITQueue *This,
                                                    __LONG32 *plCalls);
void __RPC_STUB ITQueue_get_CurrentCallsQueued_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITQueue_get_TotalCallsAbandoned_Proxy(ITQueue *This,
                                                     __LONG32 *plCalls);
void __RPC_STUB ITQueue_get_TotalCallsAbandoned_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITQueue_get_TotalCallsFlowedIn_Proxy(ITQueue *This,
                                                    __LONG32 *plCalls);
void __RPC_STUB ITQueue_get_TotalCallsFlowedIn_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITQueue_get_TotalCallsFlowedOut_Proxy(ITQueue *This,
                                                     __LONG32 *plCalls);
void __RPC_STUB ITQueue_get_TotalCallsFlowedOut_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITQueue_get_LongestEverWaitTime_Proxy(ITQueue *This,
                                                     __LONG32 *plWaitTime);
void __RPC_STUB ITQueue_get_LongestEverWaitTime_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITQueue_get_CurrentLongestWaitTime_Proxy(ITQueue *This,
                                                        __LONG32 *plWaitTime);
void __RPC_STUB ITQueue_get_CurrentLongestWaitTime_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITQueue_get_AverageWaitTime_Proxy(ITQueue *This,
                                                 __LONG32 *plWaitTime);
void __RPC_STUB ITQueue_get_AverageWaitTime_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITQueue_get_FinalDisposition_Proxy(ITQueue *This,
                                                  __LONG32 *plCalls);
void __RPC_STUB ITQueue_get_FinalDisposition_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITQueue_get_Name_Proxy(ITQueue *This, BSTR *ppName);
void __RPC_STUB ITQueue_get_Name_Stub(IRpcStubBuffer *This,
                                      IRpcChannelBuffer *_pRpcChannelBuffer,
                                      PRPC_MESSAGE _pRpcMessage,
                                      DWORD *_pdwStubPhase);
#endif
...
typedef struct ITAgentEventVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITAgentEvent *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITAgentEvent *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITAgentEvent *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITAgentEvent *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
...
#define ITAgentEvent_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                  \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITAgentEvent_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,        \
                                   rgDispId)                                   \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITAgentEvent_Invoke(This, dispIdMember, riid, lcid, wFlags,            \
                            pDispParams, pVarResult, pExcepInfo, puArgErr)     \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI ITAgentEvent_get_Agent_Proxy(ITAgentEvent *This,
                                            ITAgent **ppAgent);
void __RPC_STUB ITAgentEvent_get_Agent_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAgentEvent_get_Event_Proxy(ITAgentEvent *This,
                                            AGENT_EVENT *pEvent);
...
typedef struct ITAgentSessionEventVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITAgentSessionEvent *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITAgentSessionEvent *This, UINT iTInfo,
                               LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITAgentSessionEvent *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITAgentSessionEvent *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *get_Session)(ITAgentSessionEvent *This,
                               ITAgentSession **ppSession);
  HRESULT(WINAPI *get_Event)(ITAgentSessionEvent *This,
                             AGENT_SESSION_EVENT *pEvent);
  END_INTERFACE
...
#define ITAgentSessionEvent_GetTypeInfo(This, iTInfo, lcid, ppTInfo)           \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITAgentSessionEvent_GetIDsOfNames(This, riid, rgszNames, cNames, lcid, \
                                          rgDispId)                            \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITAgentSessionEvent_Invoke(This, dispIdMember, riid, lcid, wFlags,     \
...
#endif
HRESULT
    WINAPI ITAgentSessionEvent_get_Session_Proxy(ITAgentSessionEvent *This,
                                                 ITAgentSession **ppSession);
void __RPC_STUB ITAgentSessionEvent_get_Session_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAgentSessionEvent_get_Event_Proxy(ITAgentSessionEvent *This,
                                                   AGENT_SESSION_EVENT *pEvent);
...
typedef struct ITACDGroupEventVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITACDGroupEvent *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITACDGroupEvent *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITACDGroupEvent *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITACDGroupEvent *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
...
#define ITACDGroupEvent_GetTypeInfo(This, iTInfo, lcid, ppTInfo)               \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITACDGroupEvent_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,     \
                                      rgDispId)                                \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITACDGroupEvent_Invoke(This, dispIdMember, riid, lcid, wFlags,         \
                               pDispParams, pVarResult, pExcepInfo, puArgErr)  \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI ITACDGroupEvent_get_Group_Proxy(ITACDGroupEvent *This,
                                               ITACDGroup **ppGroup);
void __RPC_STUB ITACDGroupEvent_get_Group_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITACDGroupEvent_get_Event_Proxy(ITACDGroupEvent *This,
                                               ACDGROUP_EVENT *pEvent);
...
typedef struct ITQueueEventVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITQueueEvent *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITQueueEvent *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITQueueEvent *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITQueueEvent *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
...
#define ITQueueEvent_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                  \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITQueueEvent_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,        \
                                   rgDispId)                                   \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITQueueEvent_Invoke(This, dispIdMember, riid, lcid, wFlags,            \
                            pDispParams, pVarResult, pExcepInfo, puArgErr)     \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI ITQueueEvent_get_Queue_Proxy(ITQueueEvent *This,
                                            ITQueue **ppQueue);
void __RPC_STUB ITQueueEvent_get_Queue_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITQueueEvent_get_Event_Proxy(ITQueueEvent *This,
                                            ACDQUEUE_EVENT *pEvent);
...
typedef struct ITAgentHandlerEventVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITAgentHandlerEvent *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITAgentHandlerEvent *This, UINT iTInfo,
                               LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITAgentHandlerEvent *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITAgentHandlerEvent *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *get_AgentHandler)(ITAgentHandlerEvent *This,
                                    ITAgentHandler **ppAgentHandler);
  HRESULT(WINAPI *get_Event)(ITAgentHandlerEvent *This,
                             AGENTHANDLER_EVENT *pEvent);
  END_INTERFACE
...
#define ITAgentHandlerEvent_GetTypeInfo(This, iTInfo, lcid, ppTInfo)           \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITAgentHandlerEvent_GetIDsOfNames(This, riid, rgszNames, cNames, lcid, \
                                          rgDispId)                            \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITAgentHandlerEvent_Invoke(This, dispIdMember, riid, lcid, wFlags,     \
                                   pDispParams, pVarResult, pExcepInfo,        \
                                   puArgErr)                                   \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI ITAgentHandlerEvent_get_AgentHandler_Proxy(
    ITAgentHandlerEvent *This, ITAgentHandler **ppAgentHandler);
void __RPC_STUB ITAgentHandlerEvent_get_AgentHandler_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAgentHandlerEvent_get_Event_Proxy(ITAgentHandlerEvent *This,
                                                   AGENTHANDLER_EVENT *pEvent);
...
public:
  virtual HRESULT WINAPI
  EnumerateAgentHandlers(IEnumAgentHandler **ppEnumHandler) = 0;
  virtual HRESULT WINAPI get_AgentHandlers(VARIANT *pVariant) = 0;
};
#else
typedef struct ITTAPICallCenterVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITTAPICallCenter *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITTAPICallCenter *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITTAPICallCenter *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITTAPICallCenter *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *EnumerateAgentHandlers)(ITTAPICallCenter *This,
                                          IEnumAgentHandler **ppEnumHandler);
...
#define ITTAPICallCenter_GetTypeInfo(This, iTInfo, lcid, ppTInfo)              \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITTAPICallCenter_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,    \
                                       rgDispId)                               \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITTAPICallCenter_Invoke(This, dispIdMember, riid, lcid, wFlags,        \
                                pDispParams, pVarResult, pExcepInfo, puArgErr) \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI ITTAPICallCenter_EnumerateAgentHandlers_Proxy(
    ITTAPICallCenter *This, IEnumAgentHandler **ppEnumHandler);
void __RPC_STUB ITTAPICallCenter_EnumerateAgentHandlers_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITTAPICallCenter_get_AgentHandlers_Proxy(ITTAPICallCenter *This,
                                                        VARIANT *pVariant);
...
public:
  ...
  virtual HRESULT WINAPI CreateAgentWithID(BSTR pID, BSTR pPIN,
                                           ITAgent **ppAgent) = 0;
  virtual HRESULT WINAPI EnumerateACDGroups(IEnumACDGroup **ppEnumACDGroup) = 0;
  virtual HRESULT WINAPI
  EnumerateUsableAddresses(IEnumAddress **ppEnumAddress) = 0;
...
typedef struct ITAgentHandlerVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITAgentHandler *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITAgentHandler *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITAgentHandler *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITAgentHandler *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *get_Name)(ITAgentHandler *This, BSTR *ppName);
  HRESULT(WINAPI *CreateAgent)(ITAgentHandler *This, ITAgent **ppAgent);
  HRESULT(WINAPI *CreateAgentWithID)(ITAgentHandler *This, BSTR pID, BSTR pPIN,
                                     ITAgent **ppAgent);
  HRESULT(WINAPI *EnumerateACDGroups)(ITAgentHandler *This,
                                      IEnumACDGroup **ppEnumACDGroup);
  HRESULT(WINAPI *EnumerateUsableAddresses)(ITAgentHandler *This,
...
#define ITAgentHandler_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITAgentHandler_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,      \
                                     rgDispId)                                 \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITAgentHandler_Invoke(This, dispIdMember, riid, lcid, wFlags,          \
                              pDispParams, pVarResult, pExcepInfo, puArgErr)   \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI ITAgentHandler_get_Name_Proxy(ITAgentHandler *This,
                                             BSTR *ppName);
void __RPC_STUB ITAgentHandler_get_Name_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAgentHandler_CreateAgent_Proxy(ITAgentHandler *This,
                                                ITAgent **ppAgent);
void __RPC_STUB ITAgentHandler_CreateAgent_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAgentHandler_CreateAgentWithID_Proxy(ITAgentHandler *This,
                                                      BSTR pID, BSTR pPIN,
                                                      ITAgent **ppAgent);
void __RPC_STUB ITAgentHandler_CreateAgentWithID_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAgentHandler_EnumerateACDGroups_Proxy(
    ITAgentHandler *This, IEnumACDGroup **ppEnumACDGroup);
void __RPC_STUB ITAgentHandler_EnumerateACDGroups_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAgentHandler_EnumerateUsableAddresses_Proxy(
    ITAgentHandler *This, IEnumAddress **ppEnumAddress);
void __RPC_STUB ITAgentHandler_EnumerateUsableAddresses_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAgentHandler_get_ACDGroups_Proxy(ITAgentHandler *This,
                                                  VARIANT *pVariant);
void __RPC_STUB ITAgentHandler_get_ACDGroups_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAgentHandler_get_UsableAddresses_Proxy(ITAgentHandler *This,
                                                        VARIANT *pVariant);
...
public:
  virtual HRESULT WINAPI Next(ULONG celt, ITAgent **ppElements,
...
typedef struct IEnumAgentVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IEnumAgent *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IEnumAgent *This);
  ULONG(WINAPI *Release)(IEnumAgent *This);
  HRESULT(WINAPI *Next)(IEnumAgent *This, ULONG celt, ITAgent **ppElements,
                        ULONG *pceltFetched);
...
#endif
#endif
HRESULT WINAPI IEnumAgent_Next_Proxy(IEnumAgent *This, ULONG celt,
                                     ITAgent **ppElements, ULONG *pceltFetched);
void __RPC_STUB IEnumAgent_Next_Stub(IRpcStubBuffer *This,
                                     IRpcChannelBuffer *_pRpcChannelBuffer,
                                     PRPC_MESSAGE _pRpcMessage,
                                     DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumAgent_Reset_Proxy(IEnumAgent *This);
void __RPC_STUB IEnumAgent_Reset_Stub(IRpcStubBuffer *This,
                                      IRpcChannelBuffer *_pRpcChannelBuffer,
                                      PRPC_MESSAGE _pRpcMessage,
                                      DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumAgent_Skip_Proxy(IEnumAgent *This, ULONG celt);
void __RPC_STUB IEnumAgent_Skip_Stub(IRpcStubBuffer *This,
                                     IRpcChannelBuffer *_pRpcChannelBuffer,
                                     PRPC_MESSAGE _pRpcMessage,
                                     DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumAgent_Clone_Proxy(IEnumAgent *This, IEnumAgent **ppEnum);
void __RPC_STUB IEnumAgent_Clone_Stub(IRpcStubBuffer *This,
                                      IRpcChannelBuffer *_pRpcChannelBuffer,
                                      PRPC_MESSAGE _pRpcMessage,
                                      DWORD *_pdwStubPhase);
#endif
...
public:
  virtual HRESULT WINAPI Next(ULONG celt, ITAgentSession **ppElements,
                              ULONG *pceltFetched) = 0;
  virtual HRESULT WINAPI Reset(void) = 0;
  virtual HRESULT WINAPI Skip(ULONG celt) = 0;
...
typedef struct IEnumAgentSessionVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IEnumAgentSession *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IEnumAgentSession *This);
  ULONG(WINAPI *Release)(IEnumAgentSession *This);
  HRESULT(WINAPI *Next)(IEnumAgentSession *This, ULONG celt,
                        ITAgentSession **ppElements, ULONG *pceltFetched);
...
#endif
#endif
HRESULT WINAPI IEnumAgentSession_Next_Proxy(IEnumAgentSession *This, ULONG celt,
                                            ITAgentSession **ppElements,
                                            ULONG *pceltFetched);
...
void __RPC_STUB IEnumAgentSession_Reset_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumAgentSession_Skip_Proxy(IEnumAgentSession *This,
                                            ULONG celt);
void __RPC_STUB IEnumAgentSession_Skip_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumAgentSession_Clone_Proxy(IEnumAgentSession *This,
                                             IEnumAgentSession **ppEnum);
...
public:
  virtual HRESULT WINAPI Next(ULONG celt, ITQueue **ppElements,
                              ULONG *pceltFetched) = 0;
  virtual HRESULT WINAPI Reset(void) = 0;
  virtual HRESULT WINAPI Skip(ULONG celt) = 0;
...
typedef struct IEnumQueueVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IEnumQueue *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IEnumQueue *This);
  ULONG(WINAPI *Release)(IEnumQueue *This);
  HRESULT(WINAPI *Next)(IEnumQueue *This, ULONG celt, ITQueue **ppElements,
                        ULONG *pceltFetched);
...
#endif
#endif
HRESULT WINAPI IEnumQueue_Next_Proxy(IEnumQueue *This, ULONG celt,
                                     ITQueue **ppElements, ULONG *pceltFetched);
void __RPC_STUB IEnumQueue_Next_Stub(IRpcStubBuffer *This,
                                     IRpcChannelBuffer *_pRpcChannelBuffer,
                                     PRPC_MESSAGE _pRpcMessage,
                                     DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumQueue_Reset_Proxy(IEnumQueue *This);
void __RPC_STUB IEnumQueue_Reset_Stub(IRpcStubBuffer *This,
                                      IRpcChannelBuffer *_pRpcChannelBuffer,
                                      PRPC_MESSAGE _pRpcMessage,
                                      DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumQueue_Skip_Proxy(IEnumQueue *This, ULONG celt);
void __RPC_STUB IEnumQueue_Skip_Stub(IRpcStubBuffer *This,
                                     IRpcChannelBuffer *_pRpcChannelBuffer,
                                     PRPC_MESSAGE _pRpcMessage,
                                     DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumQueue_Clone_Proxy(IEnumQueue *This, IEnumQueue **ppEnum);
void __RPC_STUB IEnumQueue_Clone_Stub(IRpcStubBuffer *This,
                                      IRpcChannelBuffer *_pRpcChannelBuffer,
                                      PRPC_MESSAGE _pRpcMessage,
                                      DWORD *_pdwStubPhase);
#endif
...
public:
  virtual HRESULT WINAPI Next(ULONG celt, ITACDGroup **ppElements,
                              ULONG *pceltFetched) = 0;
  virtual HRESULT WINAPI Reset(void) = 0;
  virtual HRESULT WINAPI Skip(ULONG celt) = 0;
...
typedef struct IEnumACDGroupVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IEnumACDGroup *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IEnumACDGroup *This);
  ULONG(WINAPI *Release)(IEnumACDGroup *This);
  HRESULT(WINAPI *Next)(IEnumACDGroup *This, ULONG celt,
                        ITACDGroup **ppElements, ULONG *pceltFetched);
...
#endif
#endif
HRESULT WINAPI IEnumACDGroup_Next_Proxy(IEnumACDGroup *This, ULONG celt,
                                        ITACDGroup **ppElements,
                                        ULONG *pceltFetched);
void __RPC_STUB IEnumACDGroup_Next_Stub(IRpcStubBuffer *This,
                                        IRpcChannelBuffer *_pRpcChannelBuffer,
                                        PRPC_MESSAGE _pRpcMessage,
                                        DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumACDGroup_Reset_Proxy(IEnumACDGroup *This);
void __RPC_STUB IEnumACDGroup_Reset_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumACDGroup_Skip_Proxy(IEnumACDGroup *This, ULONG celt);
void __RPC_STUB IEnumACDGroup_Skip_Stub(IRpcStubBuffer *This,
                                        IRpcChannelBuffer *_pRpcChannelBuffer,
                                        PRPC_MESSAGE _pRpcMessage,
                                        DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumACDGroup_Clone_Proxy(IEnumACDGroup *This,
                                         IEnumACDGroup **ppEnum);
void __RPC_STUB IEnumACDGroup_Clone_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
#endif
...
public:
  virtual HRESULT WINAPI Next(ULONG celt, ITAgentHandler **ppElements,
                              ULONG *pceltFetched) = 0;
  virtual HRESULT WINAPI Reset(void) = 0;
  virtual HRESULT WINAPI Skip(ULONG celt) = 0;
...
typedef struct IEnumAgentHandlerVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IEnumAgentHandler *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IEnumAgentHandler *This);
  ULONG(WINAPI *Release)(IEnumAgentHandler *This);
  HRESULT(WINAPI *Next)(IEnumAgentHandler *This, ULONG celt,
                        ITAgentHandler **ppElements, ULONG *pceltFetched);
...
#endif
#endif
HRESULT WINAPI IEnumAgentHandler_Next_Proxy(IEnumAgentHandler *This, ULONG celt,
                                            ITAgentHandler **ppElements,
                                            ULONG *pceltFetched);
...
void __RPC_STUB IEnumAgentHandler_Reset_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumAgentHandler_Skip_Proxy(IEnumAgentHandler *This,
                                            ULONG celt);
void __RPC_STUB IEnumAgentHandler_Skip_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumAgentHandler_Clone_Proxy(IEnumAgentHandler *This,
                                             IEnumAgentHandler **ppEnum);
...
typedef struct ITAMMediaFormatVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITAMMediaFormat *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *put_MediaFormat)(ITAMMediaFormat *This,
...
#endif
#endif
HRESULT WINAPI ITAMMediaFormat_get_MediaFormat_Proxy(ITAMMediaFormat *This,
                                                     AM_MEDIA_TYPE **ppmt);
void __RPC_STUB ITAMMediaFormat_get_MediaFormat_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAMMediaFormat_put_MediaFormat_Proxy(ITAMMediaFormat *This,
                                                     const AM_MEDIA_TYPE *pmt);
...
public:
  virtual HRESULT WINAPI
  SetAllocatorProperties(ALLOCATOR_PROPERTIES *pAllocProperties) = 0;
  virtual HRESULT WINAPI
  GetAllocatorProperties(ALLOCATOR_PROPERTIES *pAllocProperties) = 0;
...
typedef struct ITAllocatorPropertiesVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITAllocatorProperties *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ITAllocatorProperties *This);
  ULONG(WINAPI *Release)(ITAllocatorProperties *This);
  HRESULT(WINAPI *SetAllocatorProperties)(
      ITAllocatorProperties *This, ALLOCATOR_PROPERTIES *pAllocProperties);
  HRESULT(WINAPI *GetAllocatorProperties)(
      ITAllocatorProperties *This, ALLOCATOR_PROPERTIES *pAllocProperties);
  HRESULT(WINAPI *SetAllocateBuffers)(ITAllocatorProperties *This,
                                      WINBOOL bAllocBuffers);
  HRESULT(WINAPI *GetAllocateBuffers)(ITAllocatorProperties *This,
                                      WINBOOL *pbAllocBuffers);
  HRESULT(WINAPI *SetBufferSize)(ITAllocatorProperties *This, DWORD BufferSize);
  HRESULT(WINAPI *GetBufferSize)(ITAllocatorProperties *This,
                                 DWORD *pBufferSize);
  END_INTERFACE
...
#endif
#endif
HRESULT WINAPI ITAllocatorProperties_SetAllocatorProperties_Proxy(
    ITAllocatorProperties *This, ALLOCATOR_PROPERTIES *pAllocProperties);
void __RPC_STUB ITAllocatorProperties_SetAllocatorProperties_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAllocatorProperties_GetAllocatorProperties_Proxy(
    ITAllocatorProperties *This, ALLOCATOR_PROPERTIES *pAllocProperties);
void __RPC_STUB ITAllocatorProperties_GetAllocatorProperties_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAllocatorProperties_SetAllocateBuffers_Proxy(
    ITAllocatorProperties *This, WINBOOL bAllocBuffers);
void __RPC_STUB ITAllocatorProperties_SetAllocateBuffers_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAllocatorProperties_GetAllocateBuffers_Proxy(
    ITAllocatorProperties *This, WINBOOL *pbAllocBuffers);
void __RPC_STUB ITAllocatorProperties_GetAllocateBuffers_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAllocatorProperties_SetBufferSize_Proxy(
    ITAllocatorProperties *This, DWORD BufferSize);
void __RPC_STUB ITAllocatorProperties_SetBufferSize_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAllocatorProperties_GetBufferSize_Proxy(
    ITAllocatorProperties *This, DWORD *pBufferSize);
...
typedef struct ITPluggableTerminalEventSinkVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITPluggableTerminalEventSink *This,
                                  REFIID riid, void **ppvObject);
  ULONG(WINAPI *AddRef)(ITPluggableTerminalEventSink *This);
  ULONG(WINAPI *Release)(ITPluggableTerminalEventSink *This);
  HRESULT(WINAPI *FireEvent)(ITPluggableTerminalEventSink *This,
...
#endif
#endif
HRESULT WINAPI ITPluggableTerminalEventSink_FireEvent_Proxy(
    ITPluggableTerminalEventSink *This, const MSP_EVENT_INFO *pMspEventInfo);
...
public:
  virtual HRESULT WINAPI
  RegisterSink(ITPluggableTerminalEventSink *pEventSink) = 0;
...
typedef struct ITPluggableTerminalEventSinkRegistrationVtbl {
  ...
  HRESULT(WINAPI *QueryInterface)(
      ITPluggableTerminalEventSinkRegistration *This, REFIID riid,
      void **ppvObject);
  ...
  HRESULT(WINAPI *RegisterSink)(ITPluggableTerminalEventSinkRegistration *This,
                                ITPluggableTerminalEventSink *pEventSink);
  HRESULT(WINAPI *UnregisterSink)(
...
#ifdef COBJMACROS
#define ITPluggableTerminalEventSinkRegistration_QueryInterface(This, riid,    \
                                                                ppvObject)     \
  (This)->lpVtbl->QueryInterface(This, riid, ppvObject)
...
#define ITPluggableTerminalEventSinkRegistration_RegisterSink(This,            \
                                                              pEventSink)      \
...
#endif
#endif
HRESULT WINAPI ITPluggableTerminalEventSinkRegistration_RegisterSink_Proxy(
    ITPluggableTerminalEventSinkRegistration *This,
    ITPluggableTerminalEventSink *pEventSink);
void __RPC_STUB ITPluggableTerminalEventSinkRegistration_RegisterSink_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPluggableTerminalEventSinkRegistration_UnregisterSink_Proxy(
    ITPluggableTerminalEventSinkRegistration *This);
...
public:
  ...
  virtual HRESULT WINAPI CreateMSPCall(MSP_HANDLE hCall, DWORD dwReserved,
                                       DWORD dwMediaType,
                                       IUnknown *pOuterUnknown,
                                       IUnknown **ppStreamControl) = 0;
  virtual HRESULT WINAPI ShutdownMSPCall(IUnknown *pStreamControl) = 0;
  virtual HRESULT WINAPI ReceiveTSPData(IUnknown *pMSPCall, BYTE *pBuffer,
                                        DWORD dwSize) = 0;
...
typedef struct ITMSPAddressVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITMSPAddress *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *CreateMSPCall)(ITMSPAddress *This, MSP_HANDLE hCall,
                                 DWORD dwReserved, DWORD dwMediaType,
                                 IUnknown *pOuterUnknown,
                                 IUnknown **ppStreamControl);
  HRESULT(WINAPI *ShutdownMSPCall)(ITMSPAddress *This,
                                   IUnknown *pStreamControl);
  HRESULT(WINAPI *ReceiveTSPData)(ITMSPAddress *This, IUnknown *pMSPCall,
                                  BYTE *pBuffer, DWORD dwSize);
  HRESULT(WINAPI *GetEvent)(ITMSPAddress *This, DWORD *pdwSize,
                            byte *pEventBuffer);
  END_INTERFACE
} ITMSPAddressVtbl;
struct ITMSPAddress {
...
#define ITMSPAddress_CreateMSPCall(This, hCall, dwReserved, dwMediaType,       \
                                   pOuterUnknown, ppStreamControl)             \
  (This)->lpVtbl->CreateMSPCall(This, hCall, dwReserved, dwMediaType,          \
                                pOuterUnknown, ppStreamControl)
...
#endif
#endif
HRESULT WINAPI ITMSPAddress_Initialize_Proxy(ITMSPAddress *This,
                                             MSP_HANDLE hEvent);
...
void __RPC_STUB ITMSPAddress_Shutdown_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITMSPAddress_CreateMSPCall_Proxy(
    ITMSPAddress *This, MSP_HANDLE hCall, DWORD dwReserved, DWORD dwMediaType,
    IUnknown *pOuterUnknown, IUnknown **ppStreamControl);
void __RPC_STUB ITMSPAddress_CreateMSPCall_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITMSPAddress_ShutdownMSPCall_Proxy(ITMSPAddress *This,
                                                  IUnknown *pStreamControl);
void __RPC_STUB ITMSPAddress_ShutdownMSPCall_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITMSPAddress_ReceiveTSPData_Proxy(ITMSPAddress *This,
                                                 IUnknown *pMSPCall,
                                                 BYTE *pBuffer, DWORD dwSize);
void __RPC_STUB ITMSPAddress_ReceiveTSPData_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITMSPAddress_GetEvent_Proxy(ITMSPAddress *This, DWORD *pdwSize,
                                           byte *pEventBuffer);
...
typedef struct ITTAPIDispatchEventNotificationVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITTAPIDispatchEventNotification *This,
                                  REFIID riid, void **ppvObject);
  ULONG(WINAPI *AddRef)(ITTAPIDispatchEventNotification *This);
  ULONG(WINAPI *Release)(ITTAPIDispatchEventNotification *This);
  HRESULT(WINAPI *GetTypeInfoCount)(ITTAPIDispatchEventNotification *This,
                                    UINT *pctinfo);
  HRESULT(WINAPI *GetTypeInfo)(ITTAPIDispatchEventNotification *This,
                               UINT iTInfo, LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITTAPIDispatchEventNotification *This,
                                 REFIID riid, LPOLESTR *rgszNames, UINT cNames,
                                 LCID lcid, DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITTAPIDispatchEventNotification *This,
...
#define ITTAPIDispatchEventNotification_GetTypeInfoCount(This, pctinfo)        \
  (This)->lpVtbl->GetTypeInfoCount(This, pctinfo)
#define ITTAPIDispatchEventNotification_GetTypeInfo(This, iTInfo, lcid,        \
                                                    ppTInfo)                   \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITTAPIDispatchEventNotification_GetIDsOfNames(This, riid, rgszNames,   \
                                                      cNames, lcid, rgDispId)  \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITTAPIDispatchEventNotification_Invoke(                                \
...
const BSTR CLSID_String_VideoWindowTerm =
    L"{F7438990-D6EB-11D0-82A6-00AA00B5CA1B}";
const BSTR CLSID_String_VideoInputTerminal =
    L"{AAF578EC-DC70-11D0-8ED3-00C04FB6809F}";
const BSTR CLSID_String_HandsetTerminal =
    L"{AAF578EB-DC70-11D0-8ED3-00C04FB6809F}";
const BSTR CLSID_String_HeadsetTerminal =
    L"{AAF578ED-DC70-11D0-8ED3-00C04FB6809F}";
const BSTR CLSID_String_SpeakerphoneTerminal =
    L"{AAF578EE-DC70-11D0-8ED3-00C04FB6809F}";
const BSTR CLSID_String_MicrophoneTerminal =
    L"{AAF578EF-DC70-11D0-8ED3-00C04FB6809F}";
const BSTR CLSID_String_SpeakersTerminal =
    L"{AAF578F0-DC70-11D0-8ED3-00C04FB6809F}";
const BSTR CLSID_String_MediaStreamTerminal =
    L"{E2F7AEF7-4971-11D1-A671-006097C9A2E8}";
const BSTR CLSID_String_FileRecordingTerminal =
    L"{521F3D06-C3D0-4511-8617-86B9A783DA77}";
const BSTR CLSID_String_FilePlaybackTerminal =
