...
#define TLMENUF_BACKANDFORTH                                                   \
  (TLMENUF_BACK | TLMENUF_FORE | TLMENUF_INCLUDECURRENT)
...
typedef struct ITravelEntryVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITravelEntry *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *Update)(ITravelEntry *This, IUnknown *punk,
...
void __RPC_STUB ITravelEntry_Invoke_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
HRESULT WINAPI ITravelEntry_Update_Proxy(ITravelEntry *This, IUnknown *punk,
                                         WINBOOL fIsLocalAnchor);
void __RPC_STUB ITravelEntry_Update_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
HRESULT WINAPI ITravelEntry_GetPidl_Proxy(ITravelEntry *This,
                                          LPITEMIDLIST *ppidl);
void __RPC_STUB ITravelEntry_GetPidl_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
#endif
...
public:
  ...
  virtual HRESULT WINAPI UpdateEntry(IUnknown *punk,
                                     WINBOOL fIsLocalAnchor) = 0;
  virtual HRESULT WINAPI UpdateExternal(IUnknown *punk,
                                        IUnknown *punkHLBrowseContext) = 0;
  virtual HRESULT WINAPI Travel(IUnknown *punk, int iOffset) = 0;
  virtual HRESULT WINAPI GetTravelEntry(IUnknown *punk, int iOffset,
                                        ITravelEntry **ppte) = 0;
  virtual HRESULT WINAPI FindTravelEntry(IUnknown *punk, LPCITEMIDLIST pidl,
                                         ITravelEntry **ppte) = 0;
  virtual HRESULT WINAPI GetToolTipText(IUnknown *punk, int iOffset,
                                        int idsTemplate, LPWSTR pwzText,
                                        DWORD cchText) = 0;
  virtual HRESULT WINAPI InsertMenuEntries(IUnknown *punk, HMENU hmenu,
                                           int nPos, int idFirst, int idLast,
                                           DWORD dwFlags) = 0;
...
typedef struct ITravelLogVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITravelLog *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ITravelLog *This);
  ULONG(WINAPI *Release)(ITravelLog *This);
  HRESULT(WINAPI *AddEntry)(ITravelLog *This, IUnknown *punk,
                            WINBOOL fIsLocalAnchor);
  HRESULT(WINAPI *UpdateEntry)(ITravelLog *This, IUnknown *punk,
                               WINBOOL fIsLocalAnchor);
  HRESULT(WINAPI *UpdateExternal)(ITravelLog *This, IUnknown *punk,
                                  IUnknown *punkHLBrowseContext);
  HRESULT(WINAPI *Travel)(ITravelLog *This, IUnknown *punk, int iOffset);
  HRESULT(WINAPI *GetTravelEntry)(ITravelLog *This, IUnknown *punk, int iOffset,
                                  ITravelEntry **ppte);
  HRESULT(WINAPI *FindTravelEntry)(ITravelLog *This, IUnknown *punk,
                                   LPCITEMIDLIST pidl, ITravelEntry **ppte);
  HRESULT(WINAPI *GetToolTipText)(ITravelLog *This, IUnknown *punk, int iOffset,
                                  int idsTemplate, LPWSTR pwzText,
                                  DWORD cchText);
  HRESULT(WINAPI *InsertMenuEntries)(ITravelLog *This, IUnknown *punk,
                                     HMENU hmenu, int nPos, int idFirst,
                                     int idLast, DWORD dwFlags);
...
#define ITravelLog_GetToolTipText(This, punk, iOffset, idsTemplate, pwzText,   \
                                  cchText)                                     \
  (This)->lpVtbl->GetToolTipText(This, punk, iOffset, idsTemplate, pwzText,    \
                                 cchText)
#define ITravelLog_InsertMenuEntries(This, punk, hmenu, nPos, idFirst, idLast, \
                                     dwFlags)                                  \
  (This)->lpVtbl->InsertMenuEntries(This, punk, hmenu, nPos, idFirst, idLast,  \
                                    dwFlags)
...
#endif
#endif
HRESULT WINAPI ITravelLog_AddEntry_Proxy(ITravelLog *This, IUnknown *punk,
                                         WINBOOL fIsLocalAnchor);
void __RPC_STUB ITravelLog_AddEntry_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
HRESULT WINAPI ITravelLog_UpdateEntry_Proxy(ITravelLog *This, IUnknown *punk,
                                            WINBOOL fIsLocalAnchor);
...
HRESULT WINAPI ITravelLog_UpdateExternal_Proxy(ITravelLog *This, IUnknown *punk,
                                               IUnknown *punkHLBrowseContext);
void __RPC_STUB ITravelLog_UpdateExternal_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITravelLog_Travel_Proxy(ITravelLog *This, IUnknown *punk,
                                       int iOffset);
void __RPC_STUB ITravelLog_Travel_Stub(IRpcStubBuffer *This,
                                       IRpcChannelBuffer *_pRpcChannelBuffer,
                                       PRPC_MESSAGE _pRpcMessage,
                                       DWORD *_pdwStubPhase);
HRESULT WINAPI ITravelLog_GetTravelEntry_Proxy(ITravelLog *This, IUnknown *punk,
                                               int iOffset,
                                               ITravelEntry **ppte);
void __RPC_STUB ITravelLog_GetTravelEntry_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITravelLog_FindTravelEntry_Proxy(ITravelLog *This,
                                                IUnknown *punk,
                                                LPCITEMIDLIST pidl,
                                                ITravelEntry **ppte);
void __RPC_STUB ITravelLog_FindTravelEntry_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITravelLog_GetToolTipText_Proxy(ITravelLog *This, IUnknown *punk,
                                               int iOffset, int idsTemplate,
                                               LPWSTR pwzText, DWORD cchText);
void __RPC_STUB ITravelLog_GetToolTipText_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITravelLog_InsertMenuEntries_Proxy(ITravelLog *This,
                                                  IUnknown *punk, HMENU hmenu,
                                                  int nPos, int idFirst,
                                                  int idLast, DWORD dwFlags);
void __RPC_STUB ITravelLog_InsertMenuEntries_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITravelLog_Clone_Proxy(ITravelLog *This, ITravelLog **pptl);
void __RPC_STUB ITravelLog_Clone_Stub(IRpcStubBuffer *This,
                                      IRpcChannelBuffer *_pRpcChannelBuffer,
                                      PRPC_MESSAGE _pRpcMessage,
                                      DWORD *_pdwStubPhase);
...
void __RPC_STUB ITravelLog_Revert_Stub(IRpcStubBuffer *This,
                                       IRpcChannelBuffer *_pRpcChannelBuffer,
                                       PRPC_MESSAGE _pRpcMessage,
                                       DWORD *_pdwStubPhase);
#endif
...
class CIE4ConnectionPoint : public IConnectionPoint {
  virtual HRESULT DoInvokeIE4(WINBOOL *pf, void **ppv, DISPID dispid,
                              DISPPARAMS *pdispparams) PURE;
  virtual HRESULT DoInvokePIDLIE4(DISPID dispid, LPCITEMIDLIST pidl,
                                  WINBOOL fCanCancel) PURE;
};
#else
...
public:
  ...
  FindCIE4ConnectionPoint(REFIID riid, CIE4ConnectionPoint **ppccp) = 0;
  virtual HRESULT WINAPI OnTranslateAccelerator(MSG *pMsg,
                                                DWORD grfModifiers) = 0;
  virtual HRESULT WINAPI OnInvoke(DISPID dispidMember, REFIID iid, LCID lcid,
...
typedef struct IExpDispSupportVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IExpDispSupport *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IExpDispSupport *This);
  ULONG(WINAPI *Release)(IExpDispSupport *This);
  HRESULT(WINAPI *FindCIE4ConnectionPoint)(IExpDispSupport *This, REFIID riid,
                                           CIE4ConnectionPoint **ppccp);
  HRESULT(WINAPI *OnTranslateAccelerator)(IExpDispSupport *This, MSG *pMsg,
                                          DWORD grfModifiers);
  HRESULT(WINAPI *OnInvoke)(IExpDispSupport *This, DISPID dispidMember,
                            REFIID iid, LCID lcid, WORD wFlags,
...
#define IExpDispSupport_OnInvoke(This, dispidMember, iid, lcid, wFlags,        \
                                 pdispparams, pVarResult, pexcepinfo,          \
                                 puArgErr)                                     \
  (This)->lpVtbl->OnInvoke(This, dispidMember, iid, lcid, wFlags, pdispparams, \
                           pVarResult, pexcepinfo, puArgErr)
#endif
#endif
HRESULT WINAPI IExpDispSupport_FindCIE4ConnectionPoint_Proxy(
    IExpDispSupport *This, REFIID riid, CIE4ConnectionPoint **ppccp);
void __RPC_STUB IExpDispSupport_FindCIE4ConnectionPoint_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IExpDispSupport_OnTranslateAccelerator_Proxy(
    IExpDispSupport *This, MSG *pMsg, DWORD grfModifiers);
void __RPC_STUB IExpDispSupport_OnTranslateAccelerator_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IExpDispSupport_OnInvoke_Proxy(
    IExpDispSupport *This, DISPID dispidMember, REFIID iid, LCID lcid,
...
public:
  ...
  virtual HRESULT WINAPI GetTitle(IShellView *psv, LPWSTR pszName,
                                  DWORD cchName) = 0;
  ...
  virtual HRESULT WINAPI IEGetDisplayName(LPCITEMIDLIST pidl, LPWSTR pwszName,
                                          UINT uFlags) = 0;
  virtual HRESULT WINAPI IEParseDisplayName(UINT uiCP, LPCWSTR pwszPath,
  ...
  virtual HRESULT WINAPI NotifyRedirect(IShellView *psv, LPCITEMIDLIST pidl,
                                        WINBOOL *pfDidBrowse) = 0;
  ...
  virtual HRESULT WINAPI GetHistoryObject(IOleObject **ppole, IStream **pstm,
                                          IBindCtx **ppbc) = 0;
  virtual HRESULT WINAPI SetHistoryObject(IOleObject *pole,
                                          WINBOOL fIsLocalAnchor) = 0;
  ...
  virtual HRESULT WINAPI OnHttpEquiv(IShellView *psv, WINBOOL fDone,
                                     VARIANT *pvarargIn,
...
typedef struct IBrowserServiceVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IBrowserService *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IBrowserService *This);
  ULONG(WINAPI *Release)(IBrowserService *This);
  HRESULT(WINAPI *GetParentSite)(IBrowserService *This,
                                 IOleInPlaceSite **ppipsite);
  HRESULT(WINAPI *SetTitle)(IBrowserService *This, IShellView *psv,
                            LPCWSTR pszName);
  HRESULT(WINAPI *GetTitle)(IBrowserService *This, IShellView *psv,
                            LPWSTR pszName, DWORD cchName);
  ...
  HRESULT(WINAPI *ShowControlWindow)(IBrowserService *This, UINT id,
                                     WINBOOL fShow);
  HRESULT(WINAPI *IsControlWindowShown)(IBrowserService *This, UINT id,
                                        WINBOOL *pfShown);
  HRESULT(WINAPI *IEGetDisplayName)(IBrowserService *This, LPCITEMIDLIST pidl,
                                    LPWSTR pwszName, UINT uFlags);
  HRESULT(WINAPI *IEParseDisplayName)(IBrowserService *This, UINT uiCP,
                                      LPCWSTR pwszPath, LPITEMIDLIST *ppidlOut);
  HRESULT(WINAPI *DisplayParseError)(IBrowserService *This, HRESULT hres,
                                     LPCWSTR pwszPath);
  HRESULT(WINAPI *NavigateToPidl)(IBrowserService *This, LPCITEMIDLIST pidl,
                                  DWORD grfHLNF);
  ...
  HRESULT(WINAPI *NotifyRedirect)(IBrowserService *This, IShellView *psv,
                                  LPCITEMIDLIST pidl, WINBOOL *pfDidBrowse);
  HRESULT(WINAPI *UpdateWindowList)(IBrowserService *This);
  HRESULT(WINAPI *UpdateBackForwardState)(IBrowserService *This);
  HRESULT(WINAPI *SetFlags)(IBrowserService *This, DWORD dwFlags,
                            DWORD dwFlagMask);
  ...
  HRESULT(WINAPI *GetBrowserByIndex)(IBrowserService *This, DWORD dwID,
                                     IUnknown **ppunk);
  HRESULT(WINAPI *GetHistoryObject)(IBrowserService *This, IOleObject **ppole,
                                    IStream **pstm, IBindCtx **ppbc);
  HRESULT(WINAPI *SetHistoryObject)(IBrowserService *This, IOleObject *pole,
                                    WINBOOL fIsLocalAnchor);
  HRESULT(WINAPI *CacheOLEServer)(IBrowserService *This, IOleObject *pole);
  HRESULT(WINAPI *GetSetCodePage)(IBrowserService *This, VARIANT *pvarIn,
                                  VARIANT *pvarOut);
  HRESULT(WINAPI *OnHttpEquiv)(IBrowserService *This, IShellView *psv,
                               WINBOOL fDone, VARIANT *pvarargIn,
                               VARIANT *pvarargOut);
  HRESULT(WINAPI *GetPalette)(IBrowserService *This, HPALETTE *hpal);
  HRESULT(WINAPI *RegisterWindow)(IBrowserService *This, WINBOOL fForceRegister,
                                  int swc);
  END_INTERFACE
} IBrowserServiceVtbl;
...
#endif
#endif
HRESULT WINAPI IBrowserService_GetParentSite_Proxy(IBrowserService *This,
                                                   IOleInPlaceSite **ppipsite);
...
void __RPC_STUB IBrowserService_SetTitle_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService_GetTitle_Proxy(IBrowserService *This,
                                              IShellView *psv, LPWSTR pszName,
                                              DWORD cchName);
void __RPC_STUB IBrowserService_GetTitle_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService_GetOleObject_Proxy(IBrowserService *This,
                                                  IOleObject **ppobjv);
void __RPC_STUB IBrowserService_GetOleObject_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService_GetTravelLog_Proxy(IBrowserService *This,
                                                  ITravelLog **pptl);
void __RPC_STUB IBrowserService_GetTravelLog_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService_ShowControlWindow_Proxy(IBrowserService *This,
                                                       UINT id, WINBOOL fShow);
void __RPC_STUB IBrowserService_ShowControlWindow_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService_IsControlWindowShown_Proxy(IBrowserService *This,
                                                          UINT id,
                                                          WINBOOL *pfShown);
void __RPC_STUB IBrowserService_IsControlWindowShown_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService_IEGetDisplayName_Proxy(IBrowserService *This,
                                                      LPCITEMIDLIST pidl,
                                                      LPWSTR pwszName,
                                                      UINT uFlags);
void __RPC_STUB IBrowserService_IEGetDisplayName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService_IEParseDisplayName_Proxy(IBrowserService *This,
                                                        UINT uiCP,
                                                        LPCWSTR pwszPath,
...
void __RPC_STUB IBrowserService_IEParseDisplayName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService_DisplayParseError_Proxy(IBrowserService *This,
                                                       HRESULT hres,
                                                       LPCWSTR pwszPath);
void __RPC_STUB IBrowserService_DisplayParseError_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService_NavigateToPidl_Proxy(IBrowserService *This,
                                                    LPCITEMIDLIST pidl,
                                                    DWORD grfHLNF);
void __RPC_STUB IBrowserService_NavigateToPidl_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService_SetNavigateState_Proxy(IBrowserService *This,
                                                      BNSTATE bnstate);
void __RPC_STUB IBrowserService_SetNavigateState_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService_GetNavigateState_Proxy(IBrowserService *This,
                                                      BNSTATE *pbnstate);
void __RPC_STUB IBrowserService_GetNavigateState_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService_NotifyRedirect_Proxy(IBrowserService *This,
                                                    IShellView *psv,
                                                    LPCITEMIDLIST pidl,
                                                    WINBOOL *pfDidBrowse);
...
void __RPC_STUB IBrowserService_UpdateWindowList_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
IBrowserService_UpdateBackForwardState_Proxy(IBrowserService *This);
void __RPC_STUB IBrowserService_UpdateBackForwardState_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService_SetFlags_Proxy(IBrowserService *This,
                                              DWORD dwFlags, DWORD dwFlagMask);
void __RPC_STUB IBrowserService_SetFlags_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService_GetFlags_Proxy(IBrowserService *This,
                                              DWORD *pdwFlags);
...
void __RPC_STUB IBrowserService_CanNavigateNow_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService_GetPidl_Proxy(IBrowserService *This,
                                             LPITEMIDLIST *ppidl);
void __RPC_STUB IBrowserService_GetPidl_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService_SetReferrer_Proxy(IBrowserService *This,
                                                 LPITEMIDLIST pidl);
...
void __RPC_STUB IBrowserService_GetBrowserIndex_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService_GetBrowserByIndex_Proxy(IBrowserService *This,
                                                       DWORD dwID,
                                                       IUnknown **ppunk);
void __RPC_STUB IBrowserService_GetBrowserByIndex_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService_GetHistoryObject_Proxy(IBrowserService *This,
                                                      IOleObject **ppole,
                                                      IStream **pstm,
                                                      IBindCtx **ppbc);
void __RPC_STUB IBrowserService_GetHistoryObject_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService_SetHistoryObject_Proxy(IBrowserService *This,
                                                      IOleObject *pole,
                                                      WINBOOL fIsLocalAnchor);
void __RPC_STUB IBrowserService_SetHistoryObject_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService_CacheOLEServer_Proxy(IBrowserService *This,
                                                    IOleObject *pole);
void __RPC_STUB IBrowserService_CacheOLEServer_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService_GetSetCodePage_Proxy(IBrowserService *This,
                                                    VARIANT *pvarIn,
                                                    VARIANT *pvarOut);
void __RPC_STUB IBrowserService_GetSetCodePage_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService_OnHttpEquiv_Proxy(IBrowserService *This,
                                                 IShellView *psv, WINBOOL fDone,
                                                 VARIANT *pvarargIn,
                                                 VARIANT *pvarargOut);
void __RPC_STUB IBrowserService_OnHttpEquiv_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService_GetPalette_Proxy(IBrowserService *This,
                                                HPALETTE *hpal);
void __RPC_STUB IBrowserService_GetPalette_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService_RegisterWindow_Proxy(IBrowserService *This,
                                                    WINBOOL fForceRegister,
                                                    int swc);
...
typedef struct IShellServiceVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IShellService *This, REFIID riid,
                                  void **ppvObject);
...
#endif
#endif
HRESULT WINAPI IShellService_SetOwner_Proxy(IShellService *This,
                                            IUnknown *punkOwner);
...
public:
  virtual LRESULT WINAPI WndProcBS(HWND hwnd, UINT uMsg, WPARAM wParam,
                                   LPARAM lParam) = 0;
  ...
  virtual HRESULT WINAPI CreateViewWindow(IShellView *psvNew,
                                          IShellView *psvOld, LPRECT prcView,
                                          HWND *phwnd) = 0;
  ...
  virtual HRESULT WINAPI _NavigateToPidl(LPCITEMIDLIST pidl, DWORD grfHLNF,
                                         DWORD dwFlags) = 0;
  virtual HRESULT WINAPI _TryShell2Rename(IShellView *psv,
                                          LPCITEMIDLIST pidlNew) = 0;
  virtual HRESULT WINAPI _SwitchActivationNow(void) = 0;
  virtual HRESULT WINAPI _ExecChildren(IUnknown *punkBar, WINBOOL fBroadcast,
                                       const GUID *pguidCmdGroup, DWORD nCmdID,
                                       DWORD nCmdexecopt, VARIANTARG *pvarargIn,
                                       VARIANTARG *pvarargOut) = 0;
  virtual HRESULT WINAPI _SendChildren(HWND hwndBar, WINBOOL fBroadcast,
  ...
  virtual HRESULT WINAPI _GetEffectiveClientArea(LPRECT lprectBorder,
                                                 HMONITOR hmon) = 0;
  virtual IStream *WINAPI v_GetViewStream(LPCITEMIDLIST pidl, DWORD grfMode,
                                          LPCWSTR pwszName) = 0;
  virtual LRESULT WINAPI ForwardViewMsg(UINT uMsg, WPARAM wParam,
                                        LPARAM lParam) = 0;
  ...
  virtual HRESULT WINAPI v_MayGetNextToolbarFocus(LPMSG lpMsg, UINT itbNext,
                                                  int citb,
                                                  LPTOOLBARITEM *pptbi,
                                                  HWND *phwnd) = 0;
  virtual HRESULT WINAPI _ResizeNextBorderHelper(UINT itb,
                                                 WINBOOL bUseHmonitor) = 0;
  virtual UINT WINAPI _FindTBar(IUnknown *punkSrc) = 0;
  virtual HRESULT WINAPI _SetFocus(LPTOOLBARITEM ptbi, HWND hwnd,
                                   LPMSG lpMsg) = 0;
  virtual HRESULT WINAPI v_MayTranslateAccelerator(MSG *pmsg) = 0;
  virtual HRESULT WINAPI _GetBorderDWHelper(IUnknown *punkSrc,
                                            LPRECT lprectBorder,
                                            WINBOOL bUseHmonitor) = 0;
...
typedef struct IBrowserService2Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IBrowserService2 *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IBrowserService2 *This);
  ULONG(WINAPI *Release)(IBrowserService2 *This);
  HRESULT(WINAPI *GetParentSite)(IBrowserService2 *This,
                                 IOleInPlaceSite **ppipsite);
  HRESULT(WINAPI *SetTitle)(IBrowserService2 *This, IShellView *psv,
                            LPCWSTR pszName);
  HRESULT(WINAPI *GetTitle)(IBrowserService2 *This, IShellView *psv,
                            LPWSTR pszName, DWORD cchName);
  ...
  HRESULT(WINAPI *ShowControlWindow)(IBrowserService2 *This, UINT id,
                                     WINBOOL fShow);
  HRESULT(WINAPI *IsControlWindowShown)(IBrowserService2 *This, UINT id,
                                        WINBOOL *pfShown);
  HRESULT(WINAPI *IEGetDisplayName)(IBrowserService2 *This, LPCITEMIDLIST pidl,
                                    LPWSTR pwszName, UINT uFlags);
  HRESULT(WINAPI *IEParseDisplayName)(IBrowserService2 *This, UINT uiCP,
                                      LPCWSTR pwszPath, LPITEMIDLIST *ppidlOut);
  HRESULT(WINAPI *DisplayParseError)(IBrowserService2 *This, HRESULT hres,
                                     LPCWSTR pwszPath);
  HRESULT(WINAPI *NavigateToPidl)(IBrowserService2 *This, LPCITEMIDLIST pidl,
                                  DWORD grfHLNF);
  ...
  HRESULT(WINAPI *NotifyRedirect)(IBrowserService2 *This, IShellView *psv,
                                  LPCITEMIDLIST pidl, WINBOOL *pfDidBrowse);
  HRESULT(WINAPI *UpdateWindowList)(IBrowserService2 *This);
  HRESULT(WINAPI *UpdateBackForwardState)(IBrowserService2 *This);
  HRESULT(WINAPI *SetFlags)(IBrowserService2 *This, DWORD dwFlags,
                            DWORD dwFlagMask);
  ...
  HRESULT(WINAPI *GetBrowserByIndex)(IBrowserService2 *This, DWORD dwID,
                                     IUnknown **ppunk);
  HRESULT(WINAPI *GetHistoryObject)(IBrowserService2 *This, IOleObject **ppole,
                                    IStream **pstm, IBindCtx **ppbc);
  HRESULT(WINAPI *SetHistoryObject)(IBrowserService2 *This, IOleObject *pole,
                                    WINBOOL fIsLocalAnchor);
  HRESULT(WINAPI *CacheOLEServer)(IBrowserService2 *This, IOleObject *pole);
  HRESULT(WINAPI *GetSetCodePage)(IBrowserService2 *This, VARIANT *pvarIn,
                                  VARIANT *pvarOut);
  HRESULT(WINAPI *OnHttpEquiv)(IBrowserService2 *This, IShellView *psv,
                               WINBOOL fDone, VARIANT *pvarargIn,
                               VARIANT *pvarargOut);
  HRESULT(WINAPI *GetPalette)(IBrowserService2 *This, HPALETTE *hpal);
  HRESULT(WINAPI *RegisterWindow)(IBrowserService2 *This,
                                  WINBOOL fForceRegister, int swc);
  LRESULT(WINAPI *WndProcBS)(IBrowserService2 *This, HWND hwnd, UINT uMsg,
  ...
  HRESULT(WINAPI *OnCreate)(IBrowserService2 *This,
                            struct tagCREATESTRUCTW *pcs);
  LRESULT(WINAPI *OnCommand)(IBrowserService2 *This, WPARAM wParam,
                             LPARAM lParam);
  ...
  HRESULT(WINAPI *OnFrameWindowActivateBS)(IBrowserService2 *This,
                                           WINBOOL fActive);
  HRESULT(WINAPI *ReleaseShellView)(IBrowserService2 *This);
  HRESULT(WINAPI *ActivatePendingView)(IBrowserService2 *This);
  HRESULT(WINAPI *CreateViewWindow)(IBrowserService2 *This, IShellView *psvNew,
                                    IShellView *psvOld, LPRECT prcView,
                                    HWND *phwnd);
  HRESULT(WINAPI *CreateBrowserPropSheetExt)(IBrowserService2 *This,
                                             REFIID riid, void **ppv);
  HRESULT(WINAPI *GetViewWindow)(IBrowserService2 *This, HWND *phwndView);
  HRESULT(WINAPI *GetBaseBrowserData)(IBrowserService2 *This,
                                      LPCBASEBROWSERDATA *pbbd);
  LPBASEBROWSERDATA(WINAPI *PutBaseBrowserData)(IBrowserService2 *This);
  HRESULT(WINAPI *InitializeTravelLog)(IBrowserService2 *This, ITravelLog *ptl,
                                       DWORD dw);
  ...
  HRESULT(WINAPI *UpdateSecureLockIcon)(IBrowserService2 *This,
                                        int eSecureLock);
  ...
  HRESULT(WINAPI *_Initialize)(IBrowserService2 *This, HWND hwnd,
                               IUnknown *pauto);
  ...
  HRESULT(WINAPI *_NavigateToPidl)(IBrowserService2 *This, LPCITEMIDLIST pidl,
                                   DWORD grfHLNF, DWORD dwFlags);
  HRESULT(WINAPI *_TryShell2Rename)(IBrowserService2 *This, IShellView *psv,
                                    LPCITEMIDLIST pidlNew);
  HRESULT(WINAPI *_SwitchActivationNow)(IBrowserService2 *This);
  HRESULT(WINAPI *_ExecChildren)(IBrowserService2 *This, IUnknown *punkBar,
                                 WINBOOL fBroadcast, const GUID *pguidCmdGroup,
                                 DWORD nCmdID, DWORD nCmdexecopt,
                                 VARIANTARG *pvarargIn, VARIANTARG *pvarargOut);
  HRESULT(WINAPI *_SendChildren)(IBrowserService2 *This, HWND hwndBar,
                                 WINBOOL fBroadcast, UINT uMsg, WPARAM wParam,
                                 LPARAM lParam);
  HRESULT(WINAPI *GetFolderSetData)(IBrowserService2 *This,
                                    struct tagFolderSetData *pfsd);
  HRESULT(WINAPI *_OnFocusChange)(IBrowserService2 *This, UINT itb);
  HRESULT(WINAPI *v_ShowHideChildWindows)(IBrowserService2 *This,
                                          WINBOOL fChildOnly);
  ...
  HRESULT(WINAPI *_GetEffectiveClientArea)(IBrowserService2 *This,
                                           LPRECT lprectBorder, HMONITOR hmon);
  IStream *(WINAPI *v_GetViewStream)(IBrowserService2 *This, LPCITEMIDLIST pidl,
                                     DWORD grfMode, LPCWSTR pwszName);
  LRESULT(WINAPI *ForwardViewMsg)(IBrowserService2 *This, UINT uMsg,
                                  WPARAM wParam, LPARAM lParam);
  ...
  HRESULT(WINAPI *_CloseAndReleaseToolbars)(IBrowserService2 *This,
                                            WINBOOL fClose);
  HRESULT(WINAPI *v_MayGetNextToolbarFocus)(IBrowserService2 *This, LPMSG lpMsg,
                                            UINT itbNext, int citb,
                                            LPTOOLBARITEM *pptbi, HWND *phwnd);
  HRESULT(WINAPI *_ResizeNextBorderHelper)(IBrowserService2 *This, UINT itb,
                                           WINBOOL bUseHmonitor);
  UINT(WINAPI *_FindTBar)(IBrowserService2 *This, IUnknown *punkSrc);
  HRESULT(WINAPI *_SetFocus)(IBrowserService2 *This, LPTOOLBARITEM ptbi,
                             HWND hwnd, LPMSG lpMsg);
  HRESULT(WINAPI *v_MayTranslateAccelerator)(IBrowserService2 *This, MSG *pmsg);
  HRESULT(WINAPI *_GetBorderDWHelper)(IBrowserService2 *This, IUnknown *punkSrc,
                                      LPRECT lprectBorder,
                                      WINBOOL bUseHmonitor);
  HRESULT(WINAPI *v_CheckZoneCrossing)(IBrowserService2 *This,
                                       LPCITEMIDLIST pidl);
  END_INTERFACE
...
#define IBrowserService2_CreateViewWindow(This, psvNew, psvOld, prcView,       \
                                          phwnd)                               \
...
#define IBrowserService2__ExecChildren(This, punkBar, fBroadcast,              \
                                       pguidCmdGroup, nCmdID, nCmdexecopt,     \
                                       pvarargIn, pvarargOut)                  \
  (This)->lpVtbl->_ExecChildren(This, punkBar, fBroadcast, pguidCmdGroup,      \
                                nCmdID, nCmdexecopt, pvarargIn, pvarargOut)
#define IBrowserService2__SendChildren(This, hwndBar, fBroadcast, uMsg,        \
                                       wParam, lParam)                         \
...
#define IBrowserService2_v_MayGetNextToolbarFocus(This, lpMsg, itbNext, citb,  \
                                                  pptbi, phwnd)                \
  (This)->lpVtbl->v_MayGetNextToolbarFocus(This, lpMsg, itbNext, citb, pptbi,  \
                                           phwnd)
...
#define IBrowserService2__GetBorderDWHelper(This, punkSrc, lprectBorder,       \
                                            bUseHmonitor)                      \
...
#endif
#endif
LRESULT WINAPI IBrowserService2_WndProcBS_Proxy(IBrowserService2 *This,
                                                HWND hwnd, UINT uMsg,
                                                WPARAM wParam, LPARAM lParam);
void __RPC_STUB IBrowserService2_WndProcBS_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
IBrowserService2_SetAsDefFolderSettings_Proxy(IBrowserService2 *This);
void __RPC_STUB IBrowserService2_SetAsDefFolderSettings_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService2_GetViewRect_Proxy(IBrowserService2 *This,
                                                  RECT *prc);
void __RPC_STUB IBrowserService2_GetViewRect_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService2_OnSize_Proxy(IBrowserService2 *This,
                                             WPARAM wParam);
void __RPC_STUB IBrowserService2_OnSize_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService2_OnCreate_Proxy(IBrowserService2 *This,
                                               struct tagCREATESTRUCTW *pcs);
void __RPC_STUB IBrowserService2_OnCreate_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
LRESULT WINAPI IBrowserService2_OnCommand_Proxy(IBrowserService2 *This,
                                                WPARAM wParam, LPARAM lParam);
...
void __RPC_STUB IBrowserService2_OnDestroy_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
LRESULT WINAPI IBrowserService2_OnNotify_Proxy(IBrowserService2 *This,
                                               struct tagNMHDR *pnm);
...
void __RPC_STUB IBrowserService2_OnSetFocus_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService2_OnFrameWindowActivateBS_Proxy(
    IBrowserService2 *This, WINBOOL fActive);
...
void __RPC_STUB IBrowserService2_ReleaseShellView_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
IBrowserService2_ActivatePendingView_Proxy(IBrowserService2 *This);
void __RPC_STUB IBrowserService2_ActivatePendingView_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService2_CreateViewWindow_Proxy(IBrowserService2 *This,
                                                       IShellView *psvNew,
                                                       IShellView *psvOld,
                                                       LPRECT prcView,
                                                       HWND *phwnd);
void __RPC_STUB IBrowserService2_CreateViewWindow_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService2_CreateBrowserPropSheetExt_Proxy(
    IBrowserService2 *This, REFIID riid, void **ppv);
void __RPC_STUB IBrowserService2_CreateBrowserPropSheetExt_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService2_GetViewWindow_Proxy(IBrowserService2 *This,
                                                    HWND *phwndView);
void __RPC_STUB IBrowserService2_GetViewWindow_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService2_GetBaseBrowserData_Proxy(
    IBrowserService2 *This, LPCBASEBROWSERDATA *pbbd);
void __RPC_STUB IBrowserService2_GetBaseBrowserData_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
LPBASEBROWSERDATA WINAPI
IBrowserService2_PutBaseBrowserData_Proxy(IBrowserService2 *This);
void __RPC_STUB IBrowserService2_PutBaseBrowserData_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService2_InitializeTravelLog_Proxy(
    IBrowserService2 *This, ITravelLog *ptl, DWORD dw);
...
void __RPC_STUB IBrowserService2_Offline_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService2_AllowViewResize_Proxy(IBrowserService2 *This,
                                                      WINBOOL f);
void __RPC_STUB IBrowserService2_AllowViewResize_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService2_SetActivateState_Proxy(IBrowserService2 *This,
                                                       UINT u);
void __RPC_STUB IBrowserService2_SetActivateState_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService2_UpdateSecureLockIcon_Proxy(
    IBrowserService2 *This, int eSecureLock);
void __RPC_STUB IBrowserService2_UpdateSecureLockIcon_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
IBrowserService2_InitializeDownloadManager_Proxy(IBrowserService2 *This);
void __RPC_STUB IBrowserService2_InitializeDownloadManager_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
IBrowserService2_InitializeTransitionSite_Proxy(IBrowserService2 *This);
void __RPC_STUB IBrowserService2_InitializeTransitionSite_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService2__Initialize_Proxy(IBrowserService2 *This,
                                                  HWND hwnd, IUnknown *pauto);
void __RPC_STUB IBrowserService2__Initialize_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
IBrowserService2__CancelPendingNavigationAsync_Proxy(IBrowserService2 *This);
void __RPC_STUB IBrowserService2__CancelPendingNavigationAsync_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
IBrowserService2__CancelPendingView_Proxy(IBrowserService2 *This);
...
void __RPC_STUB IBrowserService2__MaySaveChanges_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService2__PauseOrResumeView_Proxy(IBrowserService2 *This,
                                                         WINBOOL fPaused);
...
void __RPC_STUB IBrowserService2__DisableModeless_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService2__NavigateToPidl_Proxy(IBrowserService2 *This,
                                                      LPCITEMIDLIST pidl,
                                                      DWORD grfHLNF,
                                                      DWORD dwFlags);
void __RPC_STUB IBrowserService2__NavigateToPidl_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService2__TryShell2Rename_Proxy(IBrowserService2 *This,
                                                       IShellView *psv,
                                                       LPCITEMIDLIST pidlNew);
void __RPC_STUB IBrowserService2__TryShell2Rename_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
IBrowserService2__SwitchActivationNow_Proxy(IBrowserService2 *This);
void __RPC_STUB IBrowserService2__SwitchActivationNow_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService2__ExecChildren_Proxy(
    IBrowserService2 *This, IUnknown *punkBar, WINBOOL fBroadcast,
    const GUID *pguidCmdGroup, DWORD nCmdID, DWORD nCmdexecopt,
    VARIANTARG *pvarargIn, VARIANTARG *pvarargOut);
void __RPC_STUB IBrowserService2__ExecChildren_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService2__SendChildren_Proxy(IBrowserService2 *This,
                                                    HWND hwndBar,
                                                    WINBOOL fBroadcast,
                                                    UINT uMsg, WPARAM wParam,
                                                    LPARAM lParam);
void __RPC_STUB IBrowserService2__SendChildren_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService2_GetFolderSetData_Proxy(
    IBrowserService2 *This, struct tagFolderSetData *pfsd);
void __RPC_STUB IBrowserService2_GetFolderSetData_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService2__OnFocusChange_Proxy(IBrowserService2 *This,
                                                     UINT itb);
void __RPC_STUB IBrowserService2__OnFocusChange_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService2_v_ShowHideChildWindows_Proxy(
    IBrowserService2 *This, WINBOOL fChildOnly);
...
void __RPC_STUB IBrowserService2__get_itbLastFocus_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService2__put_itbLastFocus_Proxy(IBrowserService2 *This,
                                                        UINT itbLastFocus);
void __RPC_STUB IBrowserService2__put_itbLastFocus_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService2__UIActivateView_Proxy(IBrowserService2 *This,
                                                      UINT uState);
void __RPC_STUB IBrowserService2__UIActivateView_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService2__GetViewBorderRect_Proxy(IBrowserService2 *This,
                                                         RECT *prc);
void __RPC_STUB IBrowserService2__GetViewBorderRect_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
IBrowserService2__UpdateViewRectSize_Proxy(IBrowserService2 *This);
void __RPC_STUB IBrowserService2__UpdateViewRectSize_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService2__ResizeNextBorder_Proxy(IBrowserService2 *This,
                                                        UINT itb);
...
void __RPC_STUB IBrowserService2__ResizeView_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService2__GetEffectiveClientArea_Proxy(
    IBrowserService2 *This, LPRECT lprectBorder, HMONITOR hmon);
void __RPC_STUB IBrowserService2__GetEffectiveClientArea_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
IStream *WINAPI IBrowserService2_v_GetViewStream_Proxy(IBrowserService2 *This,
                                                       LPCITEMIDLIST pidl,
                                                       DWORD grfMode,
                                                       LPCWSTR pwszName);
void __RPC_STUB IBrowserService2_v_GetViewStream_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
LRESULT WINAPI IBrowserService2_ForwardViewMsg_Proxy(IBrowserService2 *This,
                                                     UINT uMsg, WPARAM wParam,
                                                     LPARAM lParam);
void __RPC_STUB IBrowserService2_ForwardViewMsg_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService2_SetAcceleratorMenu_Proxy(IBrowserService2 *This,
                                                         HACCEL hacc);
...
IBrowserService2__GetToolbarItem_Proxy(IBrowserService2 *This, int itb);
void __RPC_STUB IBrowserService2__GetToolbarItem_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService2__SaveToolbars_Proxy(IBrowserService2 *This,
                                                    IStream *pstm);
void __RPC_STUB IBrowserService2__SaveToolbars_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService2__LoadToolbars_Proxy(IBrowserService2 *This,
                                                    IStream *pstm);
void __RPC_STUB IBrowserService2__LoadToolbars_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService2__CloseAndReleaseToolbars_Proxy(
    IBrowserService2 *This, WINBOOL fClose);
void __RPC_STUB IBrowserService2__CloseAndReleaseToolbars_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService2_v_MayGetNextToolbarFocus_Proxy(
    IBrowserService2 *This, LPMSG lpMsg, UINT itbNext, int citb,
    LPTOOLBARITEM *pptbi, HWND *phwnd);
void __RPC_STUB IBrowserService2_v_MayGetNextToolbarFocus_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService2__ResizeNextBorderHelper_Proxy(
    IBrowserService2 *This, UINT itb, WINBOOL bUseHmonitor);
void __RPC_STUB IBrowserService2__ResizeNextBorderHelper_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
UINT WINAPI IBrowserService2__FindTBar_Proxy(IBrowserService2 *This,
                                             IUnknown *punkSrc);
void __RPC_STUB IBrowserService2__FindTBar_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService2__SetFocus_Proxy(IBrowserService2 *This,
                                                LPTOOLBARITEM ptbi, HWND hwnd,
                                                LPMSG lpMsg);
void __RPC_STUB IBrowserService2__SetFocus_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService2_v_MayTranslateAccelerator_Proxy(
    IBrowserService2 *This, MSG *pmsg);
void __RPC_STUB IBrowserService2_v_MayTranslateAccelerator_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService2__GetBorderDWHelper_Proxy(IBrowserService2 *This,
                                                         IUnknown *punkSrc,
                                                         LPRECT lprectBorder,
                                                         WINBOOL bUseHmonitor);
void __RPC_STUB IBrowserService2__GetBorderDWHelper_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService2_v_CheckZoneCrossing_Proxy(
...
typedef enum __MIDL_IBrowserService3_0001 { IEPDN_BINDINGUI = 0x1 } IEPDNFLAGS;
...
public:
  ...
  virtual HRESULT WINAPI IEParseDisplayNameEx(UINT uiCP, LPCWSTR pwszPath,
                                              DWORD dwFlags,
                                              LPITEMIDLIST *ppidlOut) = 0;
};
#else
typedef struct IBrowserService3Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IBrowserService3 *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IBrowserService3 *This);
  ULONG(WINAPI *Release)(IBrowserService3 *This);
  HRESULT(WINAPI *GetParentSite)(IBrowserService3 *This,
                                 IOleInPlaceSite **ppipsite);
  HRESULT(WINAPI *SetTitle)(IBrowserService3 *This, IShellView *psv,
                            LPCWSTR pszName);
  HRESULT(WINAPI *GetTitle)(IBrowserService3 *This, IShellView *psv,
                            LPWSTR pszName, DWORD cchName);
  ...
  HRESULT(WINAPI *ShowControlWindow)(IBrowserService3 *This, UINT id,
                                     WINBOOL fShow);
  HRESULT(WINAPI *IsControlWindowShown)(IBrowserService3 *This, UINT id,
                                        WINBOOL *pfShown);
  HRESULT(WINAPI *IEGetDisplayName)(IBrowserService3 *This, LPCITEMIDLIST pidl,
                                    LPWSTR pwszName, UINT uFlags);
  HRESULT(WINAPI *IEParseDisplayName)(IBrowserService3 *This, UINT uiCP,
                                      LPCWSTR pwszPath, LPITEMIDLIST *ppidlOut);
  HRESULT(WINAPI *DisplayParseError)(IBrowserService3 *This, HRESULT hres,
                                     LPCWSTR pwszPath);
  HRESULT(WINAPI *NavigateToPidl)(IBrowserService3 *This, LPCITEMIDLIST pidl,
                                  DWORD grfHLNF);
  ...
  HRESULT(WINAPI *NotifyRedirect)(IBrowserService3 *This, IShellView *psv,
                                  LPCITEMIDLIST pidl, WINBOOL *pfDidBrowse);
  HRESULT(WINAPI *UpdateWindowList)(IBrowserService3 *This);
  HRESULT(WINAPI *UpdateBackForwardState)(IBrowserService3 *This);
  HRESULT(WINAPI *SetFlags)(IBrowserService3 *This, DWORD dwFlags,
                            DWORD dwFlagMask);
  ...
  HRESULT(WINAPI *GetBrowserByIndex)(IBrowserService3 *This, DWORD dwID,
                                     IUnknown **ppunk);
  HRESULT(WINAPI *GetHistoryObject)(IBrowserService3 *This, IOleObject **ppole,
                                    IStream **pstm, IBindCtx **ppbc);
  HRESULT(WINAPI *SetHistoryObject)(IBrowserService3 *This, IOleObject *pole,
                                    WINBOOL fIsLocalAnchor);
  HRESULT(WINAPI *CacheOLEServer)(IBrowserService3 *This, IOleObject *pole);
  HRESULT(WINAPI *GetSetCodePage)(IBrowserService3 *This, VARIANT *pvarIn,
                                  VARIANT *pvarOut);
  HRESULT(WINAPI *OnHttpEquiv)(IBrowserService3 *This, IShellView *psv,
                               WINBOOL fDone, VARIANT *pvarargIn,
                               VARIANT *pvarargOut);
  HRESULT(WINAPI *GetPalette)(IBrowserService3 *This, HPALETTE *hpal);
  HRESULT(WINAPI *RegisterWindow)(IBrowserService3 *This,
                                  WINBOOL fForceRegister, int swc);
  LRESULT(WINAPI *WndProcBS)(IBrowserService3 *This, HWND hwnd, UINT uMsg,
                             WPARAM wParam, LPARAM lParam);
  ...
  HRESULT(WINAPI *OnCreate)(IBrowserService3 *This,
                            struct tagCREATESTRUCTW *pcs);
  LRESULT(WINAPI *OnCommand)(IBrowserService3 *This, WPARAM wParam,
                             LPARAM lParam);
  ...
  HRESULT(WINAPI *OnFrameWindowActivateBS)(IBrowserService3 *This,
                                           WINBOOL fActive);
  HRESULT(WINAPI *ReleaseShellView)(IBrowserService3 *This);
  HRESULT(WINAPI *ActivatePendingView)(IBrowserService3 *This);
  HRESULT(WINAPI *CreateViewWindow)(IBrowserService3 *This, IShellView *psvNew,
                                    IShellView *psvOld, LPRECT prcView,
                                    HWND *phwnd);
  HRESULT(WINAPI *CreateBrowserPropSheetExt)(IBrowserService3 *This,
                                             REFIID riid, void **ppv);
  HRESULT(WINAPI *GetViewWindow)(IBrowserService3 *This, HWND *phwndView);
  HRESULT(WINAPI *GetBaseBrowserData)(IBrowserService3 *This,
                                      LPCBASEBROWSERDATA *pbbd);
  LPBASEBROWSERDATA(WINAPI *PutBaseBrowserData)(IBrowserService3 *This);
  HRESULT(WINAPI *InitializeTravelLog)(IBrowserService3 *This, ITravelLog *ptl,
                                       DWORD dw);
  ...
  HRESULT(WINAPI *UpdateSecureLockIcon)(IBrowserService3 *This,
                                        int eSecureLock);
  ...
  HRESULT(WINAPI *_Initialize)(IBrowserService3 *This, HWND hwnd,
                               IUnknown *pauto);
  ...
  HRESULT(WINAPI *_NavigateToPidl)(IBrowserService3 *This, LPCITEMIDLIST pidl,
                                   DWORD grfHLNF, DWORD dwFlags);
  HRESULT(WINAPI *_TryShell2Rename)(IBrowserService3 *This, IShellView *psv,
                                    LPCITEMIDLIST pidlNew);
  HRESULT(WINAPI *_SwitchActivationNow)(IBrowserService3 *This);
  HRESULT(WINAPI *_ExecChildren)(IBrowserService3 *This, IUnknown *punkBar,
                                 WINBOOL fBroadcast, const GUID *pguidCmdGroup,
                                 DWORD nCmdID, DWORD nCmdexecopt,
                                 VARIANTARG *pvarargIn, VARIANTARG *pvarargOut);
  HRESULT(WINAPI *_SendChildren)(IBrowserService3 *This, HWND hwndBar,
                                 WINBOOL fBroadcast, UINT uMsg, WPARAM wParam,
                                 LPARAM lParam);
  HRESULT(WINAPI *GetFolderSetData)(IBrowserService3 *This,
                                    struct tagFolderSetData *pfsd);
  HRESULT(WINAPI *_OnFocusChange)(IBrowserService3 *This, UINT itb);
  HRESULT(WINAPI *v_ShowHideChildWindows)(IBrowserService3 *This,
                                          WINBOOL fChildOnly);
  ...
  HRESULT(WINAPI *_GetEffectiveClientArea)(IBrowserService3 *This,
                                           LPRECT lprectBorder, HMONITOR hmon);
  IStream *(WINAPI *v_GetViewStream)(IBrowserService3 *This, LPCITEMIDLIST pidl,
                                     DWORD grfMode, LPCWSTR pwszName);
  LRESULT(WINAPI *ForwardViewMsg)(IBrowserService3 *This, UINT uMsg,
                                  WPARAM wParam, LPARAM lParam);
  ...
  HRESULT(WINAPI *_CloseAndReleaseToolbars)(IBrowserService3 *This,
                                            WINBOOL fClose);
  HRESULT(WINAPI *v_MayGetNextToolbarFocus)(IBrowserService3 *This, LPMSG lpMsg,
                                            UINT itbNext, int citb,
                                            LPTOOLBARITEM *pptbi, HWND *phwnd);
  HRESULT(WINAPI *_ResizeNextBorderHelper)(IBrowserService3 *This, UINT itb,
                                           WINBOOL bUseHmonitor);
  UINT(WINAPI *_FindTBar)(IBrowserService3 *This, IUnknown *punkSrc);
  HRESULT(WINAPI *_SetFocus)(IBrowserService3 *This, LPTOOLBARITEM ptbi,
                             HWND hwnd, LPMSG lpMsg);
  HRESULT(WINAPI *v_MayTranslateAccelerator)(IBrowserService3 *This, MSG *pmsg);
  HRESULT(WINAPI *_GetBorderDWHelper)(IBrowserService3 *This, IUnknown *punkSrc,
                                      LPRECT lprectBorder,
                                      WINBOOL bUseHmonitor);
  HRESULT(WINAPI *v_CheckZoneCrossing)(IBrowserService3 *This,
                                       LPCITEMIDLIST pidl);
  HRESULT(WINAPI *_PositionViewWindow)(IBrowserService3 *This, HWND hwnd,
                                       LPRECT prc);
  HRESULT(WINAPI *IEParseDisplayNameEx)(IBrowserService3 *This, UINT uiCP,
                                        LPCWSTR pwszPath, DWORD dwFlags,
                                        LPITEMIDLIST *ppidlOut);
  END_INTERFACE
...
#define IBrowserService3_ActivatePendingView(This)                             \
  (This)->lpVtbl->ActivatePendingView(This)
#define IBrowserService3_CreateViewWindow(This, psvNew, psvOld, prcView,       \
                                          phwnd)                               \
  (This)->lpVtbl->CreateViewWindow(This, psvNew, psvOld, prcView, phwnd)
...
#define IBrowserService3__SwitchActivationNow(This)                            \
  (This)->lpVtbl->_SwitchActivationNow(This)
#define IBrowserService3__ExecChildren(This, punkBar, fBroadcast,              \
                                       pguidCmdGroup, nCmdID, nCmdexecopt,     \
                                       pvarargIn, pvarargOut)                  \
  (This)->lpVtbl->_ExecChildren(This, punkBar, fBroadcast, pguidCmdGroup,      \
                                nCmdID, nCmdexecopt, pvarargIn, pvarargOut)
#define IBrowserService3__SendChildren(This, hwndBar, fBroadcast, uMsg,        \
                                       wParam, lParam)                         \
  (This)->lpVtbl->_SendChildren(This, hwndBar, fBroadcast, uMsg, wParam, lParam)
...
#define IBrowserService3__CloseAndReleaseToolbars(This, fClose)                \
  (This)->lpVtbl->_CloseAndReleaseToolbars(This, fClose)
#define IBrowserService3_v_MayGetNextToolbarFocus(This, lpMsg, itbNext, citb,  \
                                                  pptbi, phwnd)                \
  (This)->lpVtbl->v_MayGetNextToolbarFocus(This, lpMsg, itbNext, citb, pptbi,  \
                                           phwnd)
...
#define IBrowserService3_v_MayTranslateAccelerator(This, pmsg)                 \
  (This)->lpVtbl->v_MayTranslateAccelerator(This, pmsg)
#define IBrowserService3__GetBorderDWHelper(This, punkSrc, lprectBorder,       \
                                            bUseHmonitor)                      \
  (This)->lpVtbl->_GetBorderDWHelper(This, punkSrc, lprectBorder, bUseHmonitor)
...
#define IBrowserService3_IEParseDisplayNameEx(This, uiCP, pwszPath, dwFlags,   \
                                              ppidlOut)                        \
  (This)->lpVtbl->IEParseDisplayNameEx(This, uiCP, pwszPath, dwFlags, ppidlOut)
#endif
#endif
HRESULT
    WINAPI IBrowserService3__PositionViewWindow_Proxy(IBrowserService3 *This,
                                                      HWND hwnd, LPRECT prc);
void __RPC_STUB IBrowserService3__PositionViewWindow_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBrowserService3_IEParseDisplayNameEx_Proxy(
    IBrowserService3 *This, UINT uiCP, LPCWSTR pwszPath, DWORD dwFlags,
    LPITEMIDLIST *ppidlOut);
