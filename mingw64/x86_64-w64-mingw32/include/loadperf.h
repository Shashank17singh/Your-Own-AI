...
LOADPERF_FUNCTION InstallPerfDllW(LPCWSTR szComputerName, LPCWSTR lpIniFile,
                                  ULONG_PTR dwFlags);
LOADPERF_FUNCTION InstallPerfDllA(LPCSTR szComputerName, LPCSTR lpIniFile,
                                  ULONG_PTR dwFlags);
LOADPERF_FUNCTION LoadPerfCounterTextStringsA(LPSTR lpCommandLine,
                                              WINBOOL bQuietModeArg);
LOADPERF_FUNCTION LoadPerfCounterTextStringsW(LPWSTR lpCommandLine,
                                              WINBOOL bQuietModeArg);
LOADPERF_FUNCTION UnloadPerfCounterTextStringsW(LPWSTR lpCommandLine,
                                                WINBOOL bQuietModeArg);
LOADPERF_FUNCTION UnloadPerfCounterTextStringsA(LPSTR lpCommandLine,
                                                WINBOOL bQuietModeArg);
LOADPERF_FUNCTION UpdatePerfNameFilesA(LPCSTR szNewCtrFilePath,
                                       LPCSTR szNewHlpFilePath,
                                       LPSTR szLanguageID, ULONG_PTR dwFlags);
LOADPERF_FUNCTION UpdatePerfNameFilesW(LPCWSTR szNewCtrFilePath,
                                       LPCWSTR szNewHlpFilePath,
                                       LPWSTR szLanguageID, ULONG_PTR dwFlags);
LOADPERF_FUNCTION SetServiceAsTrustedA(LPCSTR szReserved, LPCSTR szServiceName);
LOADPERF_FUNCTION SetServiceAsTrustedW(LPCWSTR szReserved,
...
#define UnloadPerfCounterTextStrings                                           \
  __MINGW_NAME_AW(UnloadPerfCounterTextStrings)
