...
DEFINE_GUID(CLSID_SyncMgr, 0x6295df27, 0x35ee, 0x11d1, 0x87, 0x7, 0x0, 0xc0,
            0x4f, 0xd9, 0x33, 0x27);
DEFINE_GUID(IID_ISyncMgrSynchronize, 0x6295df40, 0x35ee, 0x11d1, 0x87, 0x7, 0x0,
            0xc0, 0x4f, 0xd9, 0x33, 0x27);
DEFINE_GUID(IID_ISyncMgrSynchronizeCallback, 0x6295df41, 0x35ee, 0x11d1, 0x87,
            0x7, 0x0, 0xc0, 0x4f, 0xd9, 0x33, 0x27);
DEFINE_GUID(IID_ISyncMgrRegister, 0x6295df42, 0x35ee, 0x11d1, 0x87, 0x7, 0x0,
            0xc0, 0x4f, 0xd9, 0x33, 0x27);
DEFINE_GUID(IID_ISyncMgrEnumItems, 0x6295df2a, 0x35ee, 0x11d1, 0x87, 0x7, 0x0,
            0xc0, 0x4f, 0xd9, 0x33, 0x27);
DEFINE_GUID(IID_ISyncMgrSynchronizeInvoke, 0x6295df2c, 0x35ee, 0x11d1, 0x87,
            0x7, 0x0, 0xc0, 0x4f, 0xd9, 0x33, 0x27);
#define S_SYNCMGR_MISSINGITEMS                                                 \
  MAKE_SCODE(SEVERITY_SUCCESS, FACILITY_ITF, 0x0201)
...
public:
  virtual HRESULT WINAPI Initialize(DWORD dwReserved, DWORD dwSyncMgrFlags,
                                    DWORD cbCookie, const BYTE *lpCookie) = 0;
  virtual HRESULT WINAPI
  GetHandlerInfo(LPSYNCMGRHANDLERINFO *ppSyncMgrHandlerInfo) = 0;
  virtual HRESULT WINAPI
  EnumSyncMgrItems(ISyncMgrEnumItems **ppSyncMgrEnumItems) = 0;
  virtual HRESULT WINAPI GetItemObject(REFSYNCMGRITEMID ItemID, REFIID riid,
                                       void **ppv) = 0;
  virtual HRESULT WINAPI ShowProperties(HWND hWndParent,
                                        REFSYNCMGRITEMID ItemID) = 0;
  virtual HRESULT WINAPI
  SetProgressCallback(ISyncMgrSynchronizeCallback *lpCallBack) = 0;
  virtual HRESULT WINAPI PrepareForSync(ULONG cbNumItems,
                                        SYNCMGRITEMID *pItemIDs,
                                        HWND hWndParent, DWORD dwReserved) = 0;
  virtual HRESULT WINAPI Synchronize(HWND hWndParent) = 0;
  virtual HRESULT WINAPI SetItemStatus(REFSYNCMGRITEMID pItemID,
                                       DWORD dwSyncMgrStatus) = 0;
  virtual HRESULT WINAPI ShowError(HWND hWndParent,
                                   REFSYNCMGRERRORID ErrorID) = 0;
};
#else
typedef struct ISyncMgrSynchronizeVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ISyncMgrSynchronize *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ISyncMgrSynchronize *This);
  ULONG(WINAPI *Release)(ISyncMgrSynchronize *This);
  HRESULT(WINAPI *Initialize)(ISyncMgrSynchronize *This, DWORD dwReserved,
                              DWORD dwSyncMgrFlags, DWORD cbCookie,
                              const BYTE *lpCookie);
  HRESULT(WINAPI *GetHandlerInfo)(ISyncMgrSynchronize *This,
                                  LPSYNCMGRHANDLERINFO *ppSyncMgrHandlerInfo);
  HRESULT(WINAPI *EnumSyncMgrItems)(ISyncMgrSynchronize *This,
                                    ISyncMgrEnumItems **ppSyncMgrEnumItems);
  HRESULT(WINAPI *GetItemObject)(ISyncMgrSynchronize *This,
                                 REFSYNCMGRITEMID ItemID, REFIID riid,
                                 void **ppv);
  HRESULT(WINAPI *ShowProperties)(ISyncMgrSynchronize *This, HWND hWndParent,
                                  REFSYNCMGRITEMID ItemID);
  HRESULT(WINAPI *SetProgressCallback)(ISyncMgrSynchronize *This,
                                       ISyncMgrSynchronizeCallback *lpCallBack);
  HRESULT(WINAPI *PrepareForSync)(ISyncMgrSynchronize *This, ULONG cbNumItems,
                                  SYNCMGRITEMID *pItemIDs, HWND hWndParent,
                                  DWORD dwReserved);
  HRESULT(WINAPI *Synchronize)(ISyncMgrSynchronize *This, HWND hWndParent);
  HRESULT(WINAPI *SetItemStatus)(ISyncMgrSynchronize *This,
                                 REFSYNCMGRITEMID pItemID,
                                 DWORD dwSyncMgrStatus);
  HRESULT(WINAPI *ShowError)(ISyncMgrSynchronize *This, HWND hWndParent,
...
#define ISyncMgrSynchronize_Initialize(This, dwReserved, dwSyncMgrFlags,       \
                                       cbCookie, lpCookie)                     \
  (This)->lpVtbl->Initialize(This, dwReserved, dwSyncMgrFlags, cbCookie,       \
                             lpCookie)
...
#define ISyncMgrSynchronize_PrepareForSync(This, cbNumItems, pItemIDs,         \
                                           hWndParent, dwReserved)             \
  (This)->lpVtbl->PrepareForSync(This, cbNumItems, pItemIDs, hWndParent,       \
                                 dwReserved)
...
#endif
#endif
HRESULT WINAPI ISyncMgrSynchronize_Initialize_Proxy(ISyncMgrSynchronize *This,
                                                    DWORD dwReserved,
...
HRESULT WINAPI ISyncMgrSynchronize_GetHandlerInfo_Proxy(
    ISyncMgrSynchronize *This, LPSYNCMGRHANDLERINFO *ppSyncMgrHandlerInfo);
void __RPC_STUB ISyncMgrSynchronize_GetHandlerInfo_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISyncMgrSynchronize_EnumSyncMgrItems_Proxy(
    ISyncMgrSynchronize *This, ISyncMgrEnumItems **ppSyncMgrEnumItems);
void __RPC_STUB ISyncMgrSynchronize_EnumSyncMgrItems_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISyncMgrSynchronize_GetItemObject_Proxy(
    ISyncMgrSynchronize *This, REFSYNCMGRITEMID ItemID, REFIID riid,
    void **ppv);
void __RPC_STUB ISyncMgrSynchronize_GetItemObject_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISyncMgrSynchronize_ShowProperties_Proxy(
    ISyncMgrSynchronize *This, HWND hWndParent, REFSYNCMGRITEMID ItemID);
void __RPC_STUB ISyncMgrSynchronize_ShowProperties_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISyncMgrSynchronize_SetProgressCallback_Proxy(
    ISyncMgrSynchronize *This, ISyncMgrSynchronizeCallback *lpCallBack);
void __RPC_STUB ISyncMgrSynchronize_SetProgressCallback_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISyncMgrSynchronize_PrepareForSync_Proxy(
    ISyncMgrSynchronize *This, ULONG cbNumItems, SYNCMGRITEMID *pItemIDs,
    HWND hWndParent, DWORD dwReserved);
void __RPC_STUB ISyncMgrSynchronize_PrepareForSync_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISyncMgrSynchronize_Synchronize_Proxy(ISyncMgrSynchronize *This,
                                                     HWND hWndParent);
void __RPC_STUB ISyncMgrSynchronize_Synchronize_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISyncMgrSynchronize_SetItemStatus_Proxy(
    ISyncMgrSynchronize *This, REFSYNCMGRITEMID pItemID, DWORD dwSyncMgrStatus);
void __RPC_STUB ISyncMgrSynchronize_SetItemStatus_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISyncMgrSynchronize_ShowError_Proxy(ISyncMgrSynchronize *This,
                                                   HWND hWndParent,
                                                   REFSYNCMGRERRORID ErrorID);
...
public:
  ...
  virtual HRESULT WINAPI ShowErrorCompleted(HRESULT hr, ULONG cbNumItems,
                                            SYNCMGRITEMID *pItemIDs) = 0;
  virtual HRESULT WINAPI EnableModeless(WINBOOL fEnable) = 0;
  virtual HRESULT WINAPI Progress(REFSYNCMGRITEMID pItemID,
                                  LPSYNCMGRPROGRESSITEM lpSyncProgressItem) = 0;
  virtual HRESULT WINAPI LogError(DWORD dwErrorLevel, LPCWSTR lpcErrorText,
                                  LPSYNCMGRLOGERRORINFO lpSyncLogError) = 0;
  virtual HRESULT WINAPI DeleteLogError(REFSYNCMGRERRORID ErrorID,
                                        DWORD dwReserved) = 0;
  virtual HRESULT WINAPI EstablishConnection(LPCWSTR lpwszConnection,
                                             DWORD dwReserved) = 0;
};
#else
typedef struct ISyncMgrSynchronizeCallbackVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ISyncMgrSynchronizeCallback *This,
                                  REFIID riid, void **ppvObject);
  ULONG(WINAPI *AddRef)(ISyncMgrSynchronizeCallback *This);
  ULONG(WINAPI *Release)(ISyncMgrSynchronizeCallback *This);
  HRESULT(WINAPI *ShowPropertiesCompleted)(ISyncMgrSynchronizeCallback *This,
                                           HRESULT hr);
  HRESULT(WINAPI *PrepareForSyncCompleted)(ISyncMgrSynchronizeCallback *This,
                                           HRESULT hr);
  HRESULT(WINAPI *SynchronizeCompleted)(ISyncMgrSynchronizeCallback *This,
                                        HRESULT hr);
  HRESULT(WINAPI *ShowErrorCompleted)(ISyncMgrSynchronizeCallback *This,
                                      HRESULT hr, ULONG cbNumItems,
                                      SYNCMGRITEMID *pItemIDs);
  HRESULT(WINAPI *EnableModeless)(ISyncMgrSynchronizeCallback *This,
                                  WINBOOL fEnable);
  HRESULT(WINAPI *Progress)(ISyncMgrSynchronizeCallback *This,
                            REFSYNCMGRITEMID pItemID,
                            LPSYNCMGRPROGRESSITEM lpSyncProgressItem);
  HRESULT(WINAPI *LogError)(ISyncMgrSynchronizeCallback *This,
                            DWORD dwErrorLevel, LPCWSTR lpcErrorText,
                            LPSYNCMGRLOGERRORINFO lpSyncLogError);
  HRESULT(WINAPI *DeleteLogError)(ISyncMgrSynchronizeCallback *This,
                                  REFSYNCMGRERRORID ErrorID, DWORD dwReserved);
  HRESULT(WINAPI *EstablishConnection)(ISyncMgrSynchronizeCallback *This,
                                       LPCWSTR lpwszConnection,
                                       DWORD dwReserved);
  END_INTERFACE
...
#define ISyncMgrSynchronizeCallback_ShowErrorCompleted(This, hr, cbNumItems,   \
                                                       pItemIDs)               \
...
#define ISyncMgrSynchronizeCallback_Progress(This, pItemID,                    \
                                             lpSyncProgressItem)               \
  (This)->lpVtbl->Progress(This, pItemID, lpSyncProgressItem)
#define ISyncMgrSynchronizeCallback_LogError(This, dwErrorLevel, lpcErrorText, \
                                             lpSyncLogError)                   \
...
#define ISyncMgrSynchronizeCallback_EstablishConnection(This, lpwszConnection, \
                                                        dwReserved)            \
...
void __RPC_STUB ISyncMgrSynchronizeCallback_ShowPropertiesCompleted_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISyncMgrSynchronizeCallback_PrepareForSyncCompleted_Proxy(
    ISyncMgrSynchronizeCallback *This, HRESULT hr);
void __RPC_STUB ISyncMgrSynchronizeCallback_PrepareForSyncCompleted_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISyncMgrSynchronizeCallback_SynchronizeCompleted_Proxy(
    ISyncMgrSynchronizeCallback *This, HRESULT hr);
...
HRESULT WINAPI ISyncMgrSynchronizeCallback_ShowErrorCompleted_Proxy(
    ISyncMgrSynchronizeCallback *This, HRESULT hr, ULONG cbNumItems,
    SYNCMGRITEMID *pItemIDs);
void __RPC_STUB ISyncMgrSynchronizeCallback_ShowErrorCompleted_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISyncMgrSynchronizeCallback_EnableModeless_Proxy(
    ISyncMgrSynchronizeCallback *This, WINBOOL fEnable);
void __RPC_STUB ISyncMgrSynchronizeCallback_EnableModeless_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISyncMgrSynchronizeCallback_Progress_Proxy(
    ISyncMgrSynchronizeCallback *This, REFSYNCMGRITEMID pItemID,
    LPSYNCMGRPROGRESSITEM lpSyncProgressItem);
void __RPC_STUB ISyncMgrSynchronizeCallback_Progress_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISyncMgrSynchronizeCallback_LogError_Proxy(
    ISyncMgrSynchronizeCallback *This, DWORD dwErrorLevel, LPCWSTR lpcErrorText,
    LPSYNCMGRLOGERRORINFO lpSyncLogError);
void __RPC_STUB ISyncMgrSynchronizeCallback_LogError_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISyncMgrSynchronizeCallback_DeleteLogError_Proxy(
    ISyncMgrSynchronizeCallback *This, REFSYNCMGRERRORID ErrorID,
    DWORD dwReserved);
void __RPC_STUB ISyncMgrSynchronizeCallback_DeleteLogError_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISyncMgrSynchronizeCallback_EstablishConnection_Proxy(
    ISyncMgrSynchronizeCallback *This, LPCWSTR lpwszConnection,
    DWORD dwReserved);
...
public:
  virtual HRESULT WINAPI Next(ULONG celt, LPSYNCMGRITEM rgelt,
...
typedef struct ISyncMgrEnumItemsVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ISyncMgrEnumItems *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ISyncMgrEnumItems *This);
  ULONG(WINAPI *Release)(ISyncMgrEnumItems *This);
  HRESULT(WINAPI *Next)(ISyncMgrEnumItems *This, ULONG celt,
                        LPSYNCMGRITEM rgelt, ULONG *pceltFetched);
...
#endif
#endif
HRESULT WINAPI ISyncMgrEnumItems_Next_Proxy(ISyncMgrEnumItems *This, ULONG celt,
                                            LPSYNCMGRITEM rgelt,
                                            ULONG *pceltFetched);
void __RPC_STUB ISyncMgrEnumItems_Next_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISyncMgrEnumItems_Skip_Proxy(ISyncMgrEnumItems *This,
                                            ULONG celt);
...
void __RPC_STUB ISyncMgrEnumItems_Reset_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISyncMgrEnumItems_Clone_Proxy(ISyncMgrEnumItems *This,
...
public:
  virtual HRESULT WINAPI UpdateItems(DWORD dwInvokeFlags, REFCLSID rclsid,
                                     DWORD cbCookie, const BYTE *lpCookie) = 0;
...
typedef struct ISyncMgrSynchronizeInvokeVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ISyncMgrSynchronizeInvoke *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ISyncMgrSynchronizeInvoke *This);
  ULONG(WINAPI *Release)(ISyncMgrSynchronizeInvoke *This);
  HRESULT(WINAPI *UpdateItems)(ISyncMgrSynchronizeInvoke *This,
                               DWORD dwInvokeFlags, REFCLSID rclsid,
...
#define ISyncMgrSynchronizeInvoke_UpdateItems(This, dwInvokeFlags, rclsid,     \
                                              cbCookie, lpCookie)              \
...
#endif
#endif
HRESULT WINAPI ISyncMgrSynchronizeInvoke_UpdateItems_Proxy(
    ISyncMgrSynchronizeInvoke *This, DWORD dwInvokeFlags, REFCLSID rclsid,
    DWORD cbCookie, const BYTE *lpCookie);
void __RPC_STUB ISyncMgrSynchronizeInvoke_UpdateItems_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
ISyncMgrSynchronizeInvoke_UpdateAll_Proxy(ISyncMgrSynchronizeInvoke *This);
...
public:
  virtual HRESULT WINAPI
  RegisterSyncMgrHandler(REFCLSID rclsidHandler, LPCWSTR pwszDescription,
                         DWORD dwSyncMgrRegisterFlags) = 0;
  virtual HRESULT WINAPI UnregisterSyncMgrHandler(REFCLSID rclsidHandler,
                                                  DWORD dwReserved) = 0;
  virtual HRESULT WINAPI GetHandlerRegistrationInfo(
      REFCLSID rclsidHandler, LPDWORD pdwSyncMgrRegisterFlags) = 0;
};
#else
typedef struct ISyncMgrRegisterVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ISyncMgrRegister *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ISyncMgrRegister *This);
  ULONG(WINAPI *Release)(ISyncMgrRegister *This);
  HRESULT(WINAPI *RegisterSyncMgrHandler)(ISyncMgrRegister *This,
                                          REFCLSID rclsidHandler,
                                          LPCWSTR pwszDescription,
                                          DWORD dwSyncMgrRegisterFlags);
  HRESULT(WINAPI *UnregisterSyncMgrHandler)(ISyncMgrRegister *This,
                                            REFCLSID rclsidHandler,
                                            DWORD dwReserved);
  HRESULT(WINAPI *GetHandlerRegistrationInfo)(ISyncMgrRegister *This,
                                              REFCLSID rclsidHandler,
...
#define ISyncMgrRegister_RegisterSyncMgrHandler(                               \
    This, rclsidHandler, pwszDescription, dwSyncMgrRegisterFlags)              \
  (This)->lpVtbl->RegisterSyncMgrHandler(This, rclsidHandler, pwszDescription, \
                                         dwSyncMgrRegisterFlags)
#define ISyncMgrRegister_UnregisterSyncMgrHandler(This, rclsidHandler,         \
                                                  dwReserved)                  \
  (This)->lpVtbl->UnregisterSyncMgrHandler(This, rclsidHandler, dwReserved)
#define ISyncMgrRegister_GetHandlerRegistrationInfo(This, rclsidHandler,       \
                                                    pdwSyncMgrRegisterFlags)   \
  (This)->lpVtbl->GetHandlerRegistrationInfo(This, rclsidHandler,              \
                                             pdwSyncMgrRegisterFlags)
#endif
#endif
HRESULT WINAPI ISyncMgrRegister_RegisterSyncMgrHandler_Proxy(
    ISyncMgrRegister *This, REFCLSID rclsidHandler, LPCWSTR pwszDescription,
    DWORD dwSyncMgrRegisterFlags);
void __RPC_STUB ISyncMgrRegister_RegisterSyncMgrHandler_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISyncMgrRegister_UnregisterSyncMgrHandler_Proxy(
    ISyncMgrRegister *This, REFCLSID rclsidHandler, DWORD dwReserved);
void __RPC_STUB ISyncMgrRegister_UnregisterSyncMgrHandler_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISyncMgrRegister_GetHandlerRegistrationInfo_Proxy(
    ISyncMgrRegister *This, REFCLSID rclsidHandler,
    LPDWORD pdwSyncMgrRegisterFlags);
...
typedef WINBOOL(WINAPI *PFNRFCDCALLBACK)(HWND hWnd, UINT uMsg, WPARAM wParam,
                                         LPARAM lParam);
