...
typedef struct ITPluggableTerminalInitialization
...
typedef struct ITPluggableTerminalClassRegistration
...
typedef struct ITPluggableTerminalSuperclassRegistration
...
#define CLSID_String_StreamingSuperclass                                       \
  (L"{214F4ACC-AE0B-4464-8405-07029003F8E2}")
...
public:
  ...
  virtual HRESULT WINAPI ConnectTerminal(IGraphBuilder *pGraph,
                                         DWORD dwTerminalDirection,
                                         DWORD *pdwNumPins, IPin **ppPins) = 0;
  virtual HRESULT WINAPI CompleteConnectTerminal(void) = 0;
  virtual HRESULT WINAPI DisconnectTerminal(IGraphBuilder *pGraph,
                                            DWORD dwReserved) = 0;
...
typedef struct ITTerminalControlVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITTerminalControl *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ITTerminalControl *This);
  ULONG(WINAPI *Release)(ITTerminalControl *This);
  HRESULT(WINAPI *get_AddressHandle)(ITTerminalControl *This,
                                     MSP_HANDLE *phtAddress);
  HRESULT(WINAPI *ConnectTerminal)(ITTerminalControl *This,
                                   IGraphBuilder *pGraph,
                                   DWORD dwTerminalDirection, DWORD *pdwNumPins,
                                   IPin **ppPins);
  HRESULT(WINAPI *CompleteConnectTerminal)(ITTerminalControl *This);
  HRESULT(WINAPI *DisconnectTerminal)(ITTerminalControl *This,
                                      IGraphBuilder *pGraph, DWORD dwReserved);
...
#define ITTerminalControl_ConnectTerminal(This, pGraph, dwTerminalDirection,   \
                                          pdwNumPins, ppPins)                  \
  (This)->lpVtbl->ConnectTerminal(This, pGraph, dwTerminalDirection,           \
                                  pdwNumPins, ppPins)
...
#endif
HRESULT
    WINAPI ITTerminalControl_get_AddressHandle_Proxy(ITTerminalControl *This,
                                                     MSP_HANDLE *phtAddress);
...
HRESULT WINAPI ITTerminalControl_ConnectTerminal_Proxy(
    ITTerminalControl *This, IGraphBuilder *pGraph, DWORD dwTerminalDirection,
    DWORD *pdwNumPins, IPin **ppPins);
void __RPC_STUB ITTerminalControl_ConnectTerminal_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
ITTerminalControl_CompleteConnectTerminal_Proxy(ITTerminalControl *This);
void __RPC_STUB ITTerminalControl_CompleteConnectTerminal_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITTerminalControl_DisconnectTerminal_Proxy(
    ITTerminalControl *This, IGraphBuilder *pGraph, DWORD dwReserved);
...
void __RPC_STUB ITTerminalControl_RunRenderFilter_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
ITTerminalControl_StopRenderFilter_Proxy(ITTerminalControl *This);
...
public:
  virtual HRESULT WINAPI InitializeDynamic(IID iidTerminalClass,
                                           DWORD dwMediaType,
                                           TERMINAL_DIRECTION Direction,
                                           MSP_HANDLE htAddress) = 0;
};
#else
typedef struct ITPluggableTerminalInitializationVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITPluggableTerminalInitialization *This,
  ...
  HRESULT(WINAPI *InitializeDynamic)(ITPluggableTerminalInitialization *This,
                                     IID iidTerminalClass, DWORD dwMediaType,
                                     TERMINAL_DIRECTION Direction,
...
#ifdef COBJMACROS
#define ITPluggableTerminalInitialization_QueryInterface(This, riid,           \
                                                         ppvObject)            \
  (This)->lpVtbl->QueryInterface(This, riid, ppvObject)
...
#define ITPluggableTerminalInitialization_InitializeDynamic(                   \
    This, iidTerminalClass, dwMediaType, Direction, htAddress)                 \
  (This)->lpVtbl->InitializeDynamic(This, iidTerminalClass, dwMediaType,       \
                                    Direction, htAddress)
#endif
#endif
HRESULT WINAPI ITPluggableTerminalInitialization_InitializeDynamic_Proxy(
    ITPluggableTerminalInitialization *This, IID iidTerminalClass,
    DWORD dwMediaType, TERMINAL_DIRECTION Direction, MSP_HANDLE htAddress);
...
public:
  virtual HRESULT WINAPI GetDynamicTerminalClasses(DWORD dwMediaTypes,
                                                   DWORD *pdwNumClasses,
                                                   IID *pTerminalClasses) = 0;
  virtual HRESULT WINAPI CreateDynamicTerminal(IUnknown *pOuterUnknown,
...
typedef struct ITTerminalManagerVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITTerminalManager *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ITTerminalManager *This);
  ULONG(WINAPI *Release)(ITTerminalManager *This);
  HRESULT(WINAPI *GetDynamicTerminalClasses)(ITTerminalManager *This,
                                             DWORD dwMediaTypes,
                                             DWORD *pdwNumClasses,
                                             IID *pTerminalClasses);
  HRESULT(WINAPI *CreateDynamicTerminal)(
      ITTerminalManager *This, IUnknown *pOuterUnknown, IID iidTerminalClass,
      DWORD dwMediaType, TERMINAL_DIRECTION Direction, MSP_HANDLE htAddress,
...
#define ITTerminalManager_GetDynamicTerminalClasses(                           \
    This, dwMediaTypes, pdwNumClasses, pTerminalClasses)                       \
  (This)->lpVtbl->GetDynamicTerminalClasses(This, dwMediaTypes, pdwNumClasses, \
                                            pTerminalClasses)
#define ITTerminalManager_CreateDynamicTerminal(                               \
    This, pOuterUnknown, iidTerminalClass, dwMediaType, Direction, htAddress,  \
    ppTerminal)                                                                \
  (This)->lpVtbl->CreateDynamicTerminal(This, pOuterUnknown, iidTerminalClass, \
                                        dwMediaType, Direction, htAddress,     \
                                        ppTerminal)
#endif
#endif
HRESULT WINAPI ITTerminalManager_GetDynamicTerminalClasses_Proxy(
    ITTerminalManager *This, DWORD dwMediaTypes, DWORD *pdwNumClasses,
    IID *pTerminalClasses);
void __RPC_STUB ITTerminalManager_GetDynamicTerminalClasses_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITTerminalManager_CreateDynamicTerminal_Proxy(
    ITTerminalManager *This, IUnknown *pOuterUnknown, IID iidTerminalClass,
    DWORD dwMediaType, TERMINAL_DIRECTION Direction, MSP_HANDLE htAddress,
    ITTerminal **ppTerminal);
...
public:
  virtual HRESULT WINAPI GetPluggableSuperclasses(DWORD *pdwNumSuperclasses,
                                                  IID *pSuperclasses) = 0;
  virtual HRESULT WINAPI GetPluggableTerminalClasses(IID iidSuperclass,
                                                     DWORD dwMediaTypes,
                                                     DWORD *pdwNumClasses,
                                                     IID *pTerminalClasses) = 0;
};
...
typedef struct ITTerminalManager2Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITTerminalManager2 *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ITTerminalManager2 *This);
  ULONG(WINAPI *Release)(ITTerminalManager2 *This);
  HRESULT(WINAPI *GetDynamicTerminalClasses)(ITTerminalManager2 *This,
                                             DWORD dwMediaTypes,
                                             DWORD *pdwNumClasses,
                                             IID *pTerminalClasses);
  HRESULT(WINAPI *CreateDynamicTerminal)(
      ITTerminalManager2 *This, IUnknown *pOuterUnknown, IID iidTerminalClass,
      DWORD dwMediaType, TERMINAL_DIRECTION Direction, MSP_HANDLE htAddress,
      ITTerminal **ppTerminal);
  HRESULT(WINAPI *GetPluggableSuperclasses)(ITTerminalManager2 *This,
                                            DWORD *pdwNumSuperclasses,
                                            IID *pSuperclasses);
  HRESULT(WINAPI *GetPluggableTerminalClasses)(ITTerminalManager2 *This,
                                               IID iidSuperclass,
                                               DWORD dwMediaTypes,
                                               DWORD *pdwNumClasses,
                                               IID *pTerminalClasses);
...
#define ITTerminalManager2_GetDynamicTerminalClasses(                          \
    This, dwMediaTypes, pdwNumClasses, pTerminalClasses)                       \
  (This)->lpVtbl->GetDynamicTerminalClasses(This, dwMediaTypes, pdwNumClasses, \
                                            pTerminalClasses)
#define ITTerminalManager2_CreateDynamicTerminal(                              \
    This, pOuterUnknown, iidTerminalClass, dwMediaType, Direction, htAddress,  \
    ppTerminal)                                                                \
  (This)->lpVtbl->CreateDynamicTerminal(This, pOuterUnknown, iidTerminalClass, \
                                        dwMediaType, Direction, htAddress,     \
                                        ppTerminal)
#define ITTerminalManager2_GetPluggableSuperclasses(This, pdwNumSuperclasses,  \
                                                    pSuperclasses)             \
  (This)->lpVtbl->GetPluggableSuperclasses(This, pdwNumSuperclasses,           \
                                           pSuperclasses)
#define ITTerminalManager2_GetPluggableTerminalClasses(                        \
    This, iidSuperclass, dwMediaTypes, pdwNumClasses, pTerminalClasses)        \
  (This)->lpVtbl->GetPluggableTerminalClasses(                                 \
      This, iidSuperclass, dwMediaTypes, pdwNumClasses, pTerminalClasses)
#endif
#endif
HRESULT WINAPI ITTerminalManager2_GetPluggableSuperclasses_Proxy(
    ITTerminalManager2 *This, DWORD *pdwNumSuperclasses, IID *pSuperclasses);
void __RPC_STUB ITTerminalManager2_GetPluggableSuperclasses_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITTerminalManager2_GetPluggableTerminalClasses_Proxy(
    ITTerminalManager2 *This, IID iidSuperclass, DWORD dwMediaTypes,
    DWORD *pdwNumClasses, IID *pTerminalClasses);
...
typedef struct ITPluggableTerminalClassRegistrationVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITPluggableTerminalClassRegistration *This,
                                  REFIID riid, void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfoCount)(ITPluggableTerminalClassRegistration *This,
                                    UINT *pctinfo);
  HRESULT(WINAPI *GetTypeInfo)(ITPluggableTerminalClassRegistration *This,
                               UINT iTInfo, LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITPluggableTerminalClassRegistration *This,
                                 REFIID riid, LPOLESTR *rgszNames, UINT cNames,
                                 LCID lcid, DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITPluggableTerminalClassRegistration *This,
                          DISPID dispIdMember, REFIID riid, LCID lcid,
                          WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *get_Name)(ITPluggableTerminalClassRegistration *This,
                            BSTR *pName);
  HRESULT(WINAPI *put_Name)(ITPluggableTerminalClassRegistration *This,
                            BSTR bstrName);
  HRESULT(WINAPI *get_Company)(ITPluggableTerminalClassRegistration *This,
                               BSTR *pCompany);
  HRESULT(WINAPI *put_Company)(ITPluggableTerminalClassRegistration *This,
                               BSTR bstrCompany);
  HRESULT(WINAPI *get_Version)(ITPluggableTerminalClassRegistration *This,
                               BSTR *pVersion);
  HRESULT(WINAPI *put_Version)(ITPluggableTerminalClassRegistration *This,
                               BSTR bstrVersion);
  HRESULT(WINAPI *get_TerminalClass)(ITPluggableTerminalClassRegistration *This,
                                     BSTR *pTerminalClass);
  HRESULT(WINAPI *put_TerminalClass)(ITPluggableTerminalClassRegistration *This,
                                     BSTR bstrTerminalClass);
  HRESULT(WINAPI *get_CLSID)(ITPluggableTerminalClassRegistration *This,
                             BSTR *pCLSID);
  HRESULT(WINAPI *put_CLSID)(ITPluggableTerminalClassRegistration *This,
                             BSTR bstrCLSID);
  HRESULT(WINAPI *get_Direction)(ITPluggableTerminalClassRegistration *This,
                                 TMGR_DIRECTION *pDirection);
  HRESULT(WINAPI *put_Direction)(ITPluggableTerminalClassRegistration *This,
                                 TMGR_DIRECTION nDirection);
  HRESULT(WINAPI *get_MediaTypes)(ITPluggableTerminalClassRegistration *This,
                                  __LONG32 *pMediaTypes);
  HRESULT(WINAPI *put_MediaTypes)(ITPluggableTerminalClassRegistration *This,
                                  __LONG32 nMediaTypes);
  HRESULT(WINAPI *Add)(ITPluggableTerminalClassRegistration *This,
                       BSTR bstrSuperclass);
  HRESULT(WINAPI *Delete)(ITPluggableTerminalClassRegistration *This,
                          BSTR bstrSuperclass);
  HRESULT(WINAPI *GetTerminalClassInfo)(
      ITPluggableTerminalClassRegistration *This, BSTR bstrSuperclass);
  END_INTERFACE
...
#ifdef COBJMACROS
#define ITPluggableTerminalClassRegistration_QueryInterface(This, riid,        \
                                                            ppvObject)         \
  (This)->lpVtbl->QueryInterface(This, riid, ppvObject)
...
#define ITPluggableTerminalClassRegistration_GetTypeInfo(This, iTInfo, lcid,   \
                                                         ppTInfo)              \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITPluggableTerminalClassRegistration_GetIDsOfNames(                    \
    This, riid, rgszNames, cNames, lcid, rgDispId)                             \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITPluggableTerminalClassRegistration_Invoke(                           \
...
#define ITPluggableTerminalClassRegistration_get_TerminalClass(This,           \
                                                               pTerminalClass) \
  (This)->lpVtbl->get_TerminalClass(This, pTerminalClass)
#define ITPluggableTerminalClassRegistration_put_TerminalClass(                \
    This, bstrTerminalClass)                                                   \
...
#define ITPluggableTerminalClassRegistration_GetTerminalClassInfo(             \
    This, bstrSuperclass)                                                      \
  (This)->lpVtbl->GetTerminalClassInfo(This, bstrSuperclass)
#endif
#endif
HRESULT WINAPI ITPluggableTerminalClassRegistration_get_Name_Proxy(
    ITPluggableTerminalClassRegistration *This, BSTR *pName);
void __RPC_STUB ITPluggableTerminalClassRegistration_get_Name_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPluggableTerminalClassRegistration_put_Name_Proxy(
    ITPluggableTerminalClassRegistration *This, BSTR bstrName);
void __RPC_STUB ITPluggableTerminalClassRegistration_put_Name_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPluggableTerminalClassRegistration_get_Company_Proxy(
    ITPluggableTerminalClassRegistration *This, BSTR *pCompany);
void __RPC_STUB ITPluggableTerminalClassRegistration_get_Company_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPluggableTerminalClassRegistration_put_Company_Proxy(
...
void __RPC_STUB ITPluggableTerminalClassRegistration_put_Company_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPluggableTerminalClassRegistration_get_Version_Proxy(
    ITPluggableTerminalClassRegistration *This, BSTR *pVersion);
void __RPC_STUB ITPluggableTerminalClassRegistration_get_Version_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPluggableTerminalClassRegistration_put_Version_Proxy(
    ITPluggableTerminalClassRegistration *This, BSTR bstrVersion);
void __RPC_STUB ITPluggableTerminalClassRegistration_put_Version_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPluggableTerminalClassRegistration_get_TerminalClass_Proxy(
    ITPluggableTerminalClassRegistration *This, BSTR *pTerminalClass);
void __RPC_STUB ITPluggableTerminalClassRegistration_get_TerminalClass_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPluggableTerminalClassRegistration_put_TerminalClass_Proxy(
    ITPluggableTerminalClassRegistration *This, BSTR bstrTerminalClass);
void __RPC_STUB ITPluggableTerminalClassRegistration_put_TerminalClass_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPluggableTerminalClassRegistration_get_CLSID_Proxy(
    ITPluggableTerminalClassRegistration *This, BSTR *pCLSID);
void __RPC_STUB ITPluggableTerminalClassRegistration_get_CLSID_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPluggableTerminalClassRegistration_put_CLSID_Proxy(
    ITPluggableTerminalClassRegistration *This, BSTR bstrCLSID);
void __RPC_STUB ITPluggableTerminalClassRegistration_put_CLSID_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPluggableTerminalClassRegistration_get_Direction_Proxy(
...
void __RPC_STUB ITPluggableTerminalClassRegistration_get_Direction_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPluggableTerminalClassRegistration_put_Direction_Proxy(
    ITPluggableTerminalClassRegistration *This, TMGR_DIRECTION nDirection);
void __RPC_STUB ITPluggableTerminalClassRegistration_put_Direction_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPluggableTerminalClassRegistration_get_MediaTypes_Proxy(
    ITPluggableTerminalClassRegistration *This, __LONG32 *pMediaTypes);
...
void __RPC_STUB ITPluggableTerminalClassRegistration_put_MediaTypes_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPluggableTerminalClassRegistration_Add_Proxy(
    ITPluggableTerminalClassRegistration *This, BSTR bstrSuperclass);
void __RPC_STUB ITPluggableTerminalClassRegistration_Add_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPluggableTerminalClassRegistration_Delete_Proxy(
    ITPluggableTerminalClassRegistration *This, BSTR bstrSuperclass);
void __RPC_STUB ITPluggableTerminalClassRegistration_Delete_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPluggableTerminalClassRegistration_GetTerminalClassInfo_Proxy(
    ITPluggableTerminalClassRegistration *This, BSTR bstrSuperclass);
...
public:
  ...
  EnumerateTerminalClasses(IEnumTerminalClass **ppTerminals) = 0;
};
#else
typedef struct ITPluggableTerminalSuperclassRegistrationVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(
      ITPluggableTerminalSuperclassRegistration *This, REFIID riid,
      void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfoCount)(
      ITPluggableTerminalSuperclassRegistration *This, UINT *pctinfo);
  HRESULT(WINAPI *GetTypeInfo)(ITPluggableTerminalSuperclassRegistration *This,
                               UINT iTInfo, LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(
      ITPluggableTerminalSuperclassRegistration *This, REFIID riid,
      LPOLESTR *rgszNames, UINT cNames, LCID lcid, DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITPluggableTerminalSuperclassRegistration *This,
                          DISPID dispIdMember, REFIID riid, LCID lcid,
                          WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *get_Name)(ITPluggableTerminalSuperclassRegistration *This,
                            BSTR *pName);
  HRESULT(WINAPI *put_Name)(ITPluggableTerminalSuperclassRegistration *This,
                            BSTR bstrName);
  HRESULT(WINAPI *get_CLSID)(ITPluggableTerminalSuperclassRegistration *This,
                             BSTR *pCLSID);
  HRESULT(WINAPI *put_CLSID)(ITPluggableTerminalSuperclassRegistration *This,
                             BSTR bstrCLSID);
  ...
  HRESULT(WINAPI *GetTerminalSuperclassInfo)(
      ITPluggableTerminalSuperclassRegistration *This);
  HRESULT(WINAPI *get_TerminalClasses)(
      ITPluggableTerminalSuperclassRegistration *This, VARIANT *pTerminals);
  HRESULT(WINAPI *EnumerateTerminalClasses)(
      ITPluggableTerminalSuperclassRegistration *This,
      IEnumTerminalClass **ppTerminals);
  END_INTERFACE
...
#ifdef COBJMACROS
#define ITPluggableTerminalSuperclassRegistration_QueryInterface(This, riid,   \
                                                                 ppvObject)    \
  (This)->lpVtbl->QueryInterface(This, riid, ppvObject)
...
#define ITPluggableTerminalSuperclassRegistration_Release(This)                \
  (This)->lpVtbl->Release(This)
#define ITPluggableTerminalSuperclassRegistration_GetTypeInfoCount(This,       \
                                                                   pctinfo)    \
  (This)->lpVtbl->GetTypeInfoCount(This, pctinfo)
#define ITPluggableTerminalSuperclassRegistration_GetTypeInfo(This, iTInfo,    \
                                                              lcid, ppTInfo)   \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITPluggableTerminalSuperclassRegistration_GetIDsOfNames(               \
    This, riid, rgszNames, cNames, lcid, rgDispId)                             \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITPluggableTerminalSuperclassRegistration_Invoke(                      \
    This, dispIdMember, riid, lcid, wFlags, pDispParams, pVarResult,           \
    pExcepInfo, puArgErr)                                                      \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#define ITPluggableTerminalSuperclassRegistration_GetTerminalSuperclassInfo(   \
    This)                                                                      \
  (This)->lpVtbl->GetTerminalSuperclassInfo(This)
#define ITPluggableTerminalSuperclassRegistration_get_TerminalClasses(         \
    This, pTerminals)                                                          \
  (This)->lpVtbl->get_TerminalClasses(This, pTerminals)
#define ITPluggableTerminalSuperclassRegistration_EnumerateTerminalClasses(    \
    This, ppTerminals)                                                         \
  (This)->lpVtbl->EnumerateTerminalClasses(This, ppTerminals)
#endif
#endif
HRESULT WINAPI ITPluggableTerminalSuperclassRegistration_get_Name_Proxy(
    ITPluggableTerminalSuperclassRegistration *This, BSTR *pName);
void __RPC_STUB ITPluggableTerminalSuperclassRegistration_get_Name_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPluggableTerminalSuperclassRegistration_put_Name_Proxy(
    ITPluggableTerminalSuperclassRegistration *This, BSTR bstrName);
...
HRESULT WINAPI ITPluggableTerminalSuperclassRegistration_get_CLSID_Proxy(
    ITPluggableTerminalSuperclassRegistration *This, BSTR *pCLSID);
void __RPC_STUB ITPluggableTerminalSuperclassRegistration_get_CLSID_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPluggableTerminalSuperclassRegistration_put_CLSID_Proxy(
    ITPluggableTerminalSuperclassRegistration *This, BSTR bstrCLSID);
void __RPC_STUB ITPluggableTerminalSuperclassRegistration_put_CLSID_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPluggableTerminalSuperclassRegistration_Add_Proxy(
    ITPluggableTerminalSuperclassRegistration *This);
void __RPC_STUB ITPluggableTerminalSuperclassRegistration_Add_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPluggableTerminalSuperclassRegistration_Delete_Proxy(
    ITPluggableTerminalSuperclassRegistration *This);
void __RPC_STUB ITPluggableTerminalSuperclassRegistration_Delete_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
ITPluggableTerminalSuperclassRegistration_GetTerminalSuperclassInfo_Proxy(
    ITPluggableTerminalSuperclassRegistration *This);
void __RPC_STUB
ITPluggableTerminalSuperclassRegistration_GetTerminalSuperclassInfo_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
ITPluggableTerminalSuperclassRegistration_get_TerminalClasses_Proxy(
    ITPluggableTerminalSuperclassRegistration *This, VARIANT *pTerminals);
void __RPC_STUB
ITPluggableTerminalSuperclassRegistration_get_TerminalClasses_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
ITPluggableTerminalSuperclassRegistration_EnumerateTerminalClasses_Proxy(
    ITPluggableTerminalSuperclassRegistration *This,
    IEnumTerminalClass **ppTerminals);
void __RPC_STUB
ITPluggableTerminalSuperclassRegistration_EnumerateTerminalClasses_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
#endif
