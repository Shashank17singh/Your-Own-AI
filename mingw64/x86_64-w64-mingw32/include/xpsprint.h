...
DEFINE_GUID(IID_IXpsPrintJobStream, 0x7a77dc5f, 0x45d6, 0x4dff, 0x93, 0x07,
            0xd8, 0xcb, 0x84, 0x63, 0x47, 0xca);
...
__CRT_UUID_DECL(IXpsPrintJobStream, 0x7a77dc5f, 0x45d6, 0x4dff, 0x93, 0x07,
                0xd8, 0xcb, 0x84, 0x63, 0x47, 0xca)
#endif
#else
typedef struct IXpsPrintJobStreamVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsPrintJobStream *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IXpsPrintJobStream *This);
  ULONG(STDMETHODCALLTYPE *Release)(IXpsPrintJobStream *This);
  /*** ISequentialStream methods ***/
  HRESULT(STDMETHODCALLTYPE *Read)(IXpsPrintJobStream *This, void *pv, ULONG cb,
                                   ULONG *pcbRead);
  HRESULT(STDMETHODCALLTYPE *Write)(IXpsPrintJobStream *This, const void *pv,
                                    ULONG cb, ULONG *pcbWritten);
  /*** IXpsPrintJobStream methods ***/
  HRESULT(STDMETHODCALLTYPE *Close)(IXpsPrintJobStream *This);
  END_INTERFACE
} IXpsPrintJobStreamVtbl;
interface IXpsPrintJobStream { CONST_VTBL IXpsPrintJobStreamVtbl *lpVtbl; };
#ifdef COBJMACROS
...
IXpsPrintJobStream_QueryInterface(IXpsPrintJobStream *This, REFIID riid,
                                  void **ppvObject) {
...
/*** ISequentialStream methods ***/
static inline HRESULT IXpsPrintJobStream_Read(IXpsPrintJobStream *This,
                                              void *pv, ULONG cb,
                                              ULONG *pcbRead) {
  return This->lpVtbl->Read(This, pv, cb, pcbRead);
}
static inline HRESULT IXpsPrintJobStream_Write(IXpsPrintJobStream *This,
...
DEFINE_GUID(IID_IXpsPrintJob, 0x5ab89b06, 0x8194, 0x425f, 0xab, 0x3b, 0xd7,
            0xa9, 0x6e, 0x35, 0x01, 0x61);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IXpsPrintJob : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE GetJobStatus(XPS_JOB_STATUS *
                                                 jobStatus) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsPrintJob, 0x5ab89b06, 0x8194, 0x425f, 0xab, 0x3b, 0xd7,
                0xa9, 0x6e, 0x35, 0x01, 0x61)
#endif
#else
typedef struct IXpsPrintJobVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsPrintJob *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetJobStatus)(IXpsPrintJob *This,
                                           XPS_JOB_STATUS *jobStatus);
  END_INTERFACE
} IXpsPrintJobVtbl;
interface IXpsPrintJob { CONST_VTBL IXpsPrintJobVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
IXpsPrintJob_QueryInterface(IXpsPrintJob *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
static inline HRESULT IXpsPrintJob_GetJobStatus(IXpsPrintJob *This,
                                                XPS_JOB_STATUS *jobStatus) {
...
HRESULT WINAPI StartXpsPrintJob(LPCWSTR printerName, LPCWSTR jobName,
                                LPCWSTR outputFileName, HANDLE progressEvent,
                                HANDLE completionEvent, UINT8 *printablePagesOn,
                                UINT32 printablePagesOnCount,
                                IXpsPrintJob **xpsPrintJob,
                                IXpsPrintJobStream **documentStream,
                                IXpsPrintJobStream **printTicketStream);
HRESULT WINAPI StartXpsPrintJob1(LPCWSTR printerName, LPCWSTR jobName,
                                 LPCWSTR outputFileName, HANDLE progressEvent,
