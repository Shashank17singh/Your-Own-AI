...
typedef struct IDialEventSinkVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IDialEventSink *This, REFIID riid,
                                  void **ppvObject);
...
#endif
#endif
HRESULT WINAPI IDialEventSink_OnEvent_Proxy(IDialEventSink *This, DWORD dwEvent,
                                            DWORD dwStatus);
...
public:
  virtual HRESULT WINAPI Initialize(LPCWSTR pwzConnectoid,
                                    IDialEventSink *pIDES) = 0;
  virtual HRESULT WINAPI GetProperty(LPCWSTR pwzProperty, LPWSTR pwzValue,
                                     DWORD dwBufSize) = 0;
...
typedef struct IDialEngineVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IDialEngine *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IDialEngine *This);
  ULONG(WINAPI *Release)(IDialEngine *This);
  HRESULT(WINAPI *Initialize)(IDialEngine *This, LPCWSTR pwzConnectoid,
                              IDialEventSink *pIDES);
  HRESULT(WINAPI *GetProperty)(IDialEngine *This, LPCWSTR pwzProperty,
                               LPWSTR pwzValue, DWORD dwBufSize);
  HRESULT(WINAPI *SetProperty)(IDialEngine *This, LPCWSTR pwzProperty,
                               LPCWSTR pwzValue);
...
#endif
#endif
HRESULT WINAPI IDialEngine_Initialize_Proxy(IDialEngine *This,
                                            LPCWSTR pwzConnectoid,
                                            IDialEventSink *pIDES);
void __RPC_STUB IDialEngine_Initialize_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IDialEngine_GetProperty_Proxy(IDialEngine *This,
                                             LPCWSTR pwzProperty,
                                             LPWSTR pwzValue, DWORD dwBufSize);
void __RPC_STUB IDialEngine_GetProperty_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IDialEngine_SetProperty_Proxy(IDialEngine *This,
                                             LPCWSTR pwzProperty,
                                             LPCWSTR pwzValue);
...
void __RPC_STUB IDialEngine_Dial_Stub(IRpcStubBuffer *This,
                                      IRpcChannelBuffer *_pRpcChannelBuffer,
                                      PRPC_MESSAGE _pRpcMessage,
                                      DWORD *_pdwStubPhase);
HRESULT WINAPI IDialEngine_HangUp_Proxy(IDialEngine *This);
void __RPC_STUB IDialEngine_HangUp_Stub(IRpcStubBuffer *This,
                                        IRpcChannelBuffer *_pRpcChannelBuffer,
                                        PRPC_MESSAGE _pRpcMessage,
                                        DWORD *_pdwStubPhase);
HRESULT WINAPI IDialEngine_GetConnectedState_Proxy(IDialEngine *This,
                                                   DWORD *pdwState);
void __RPC_STUB IDialEngine_GetConnectedState_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IDialEngine_GetConnectHandle_Proxy(IDialEngine *This,
                                                  DWORD_PTR *pdwHandle);
...
typedef struct IDialBrandingVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IDialBranding *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetBitmap)(IDialBranding *This, DWORD dwIndex,
                             HBITMAP *phBitmap);
  END_INTERFACE
} IDialBrandingVtbl;
...
#endif
#endif
HRESULT WINAPI IDialBranding_Initialize_Proxy(IDialBranding *This,
                                              LPCWSTR pwzConnectoid);
void __RPC_STUB IDialBranding_Initialize_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IDialBranding_GetBitmap_Proxy(IDialBranding *This, DWORD dwIndex,
                                             HBITMAP *phBitmap);
