...
typedef int(WINAPI *AutoCorrectProc)(LANGID langid, const WCHAR *pszBefore,
                                     WCHAR *pszAfter, LONG cchAfter,
                                     LONG *pcchReplaced);
...
typedef LONG (*EDITWORDBREAKPROCEX)(char *pchText, LONG cchText, BYTE bCharSet,
                                    INT action);
...
#define CFM_EFFECTS2                                                           \
  (CFM_EFFECTS | CFM_DISABLED | CFM_SMALLCAPS | CFM_ALLCAPS | CFM_HIDDEN |     \
   CFM_OUTLINE | CFM_SHADOW | CFM_EMBOSS | CFM_IMPRINT | CFM_REVISED |         \
   CFM_SUBSCRIPT | CFM_SUPERSCRIPT | CFM_BACKCOLOR)
#if _RICHEDIT_VER >= 0x0600
#define CFM_ALL2                                                               \
  (CFM_ALL | CFM_EFFECTS2 | CFM_BACKCOLOR | CFM_LCID | CFM_UNDERLINETYPE |     \
   CFM_WEIGHT | CFM_REVAUTHOR | CFM_SPACING | CFM_KERNING | CFM_STYLE |        \
   CFM_ANIMATION | CFM_COOKIE)
#else
#define CFM_ALL2                                                               \
  (CFM_ALL | CFM_EFFECTS2 | CFM_BACKCOLOR | CFM_LCID | CFM_UNDERLINETYPE |     \
   CFM_WEIGHT | CFM_REVAUTHOR | CFM_SPACING | CFM_KERNING | CFM_STYLE |        \
...
#define CFM_ALLEFFECTS                                                         \
  (CFM_EFFECTS2 | CFM_FONTBOUND | CFM_EXTENDED | CFM_MATHNOBUILDUP |           \
   CFM_MATH | CFM_MATHORDINARY)
...
#endif
typedef DWORD(CALLBACK *EDITSTREAMCALLBACK)(DWORD_PTR dwCookie, LPBYTE pbBuff,
                                            LONG cb, LONG *pcb);
...
#define PFM_ALL                                                                \
  (PFM_STARTINDENT | PFM_RIGHTINDENT | PFM_OFFSET | PFM_ALIGNMENT |            \
   PFM_TABSTOPS | PFM_NUMBERING | PFM_OFFSETINDENT | PFM_RTLPARA)
#define PFM_EFFECTS                                                            \
...
#define PFM_ALL2                                                               \
  (PFM_ALL | PFM_EFFECTS | PFM_SPACEBEFORE | PFM_SPACEAFTER |                  \
   PFM_LINESPACING | PFM_STYLE | PFM_SHADING | PFM_BORDER | PFM_NUMBERINGTAB | \
   PFM_NUMBERINGSTART | PFM_NUMBERINGSTYLE)
...
void WINAPI HyphenateProc(WCHAR *pszWord, LANGID langid, __LONG32 ichExceed,
