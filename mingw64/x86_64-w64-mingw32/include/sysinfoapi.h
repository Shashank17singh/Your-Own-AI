...
WINBASEAPI
    WINBOOL WINAPI IsUserCetAvailableInEnvironment(DWORD UserCetEnvironment);
#endif
...
GetSystemTimeAdjustment(PDWORD lpTimeAdjustment, PDWORD lpTimeIncrement,
...
NTSYSAPI ULONGLONG NTAPI VerSetConditionMask(ULONGLONG ConditionMask,
                                             ULONG TypeMask, UCHAR Condition);
...
#if _WIN32_WINNT >= 0x0600
WINBASEAPI WINBOOL WINAPI GetProductInfo(DWORD dwOSMajorVersion,
