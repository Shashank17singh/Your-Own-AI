...
typedef enum _TRANSMIT_STATE { Idle = 0, SendingBytes } TRANSMIT_STATE;
...
typedef VOID(NTAPI *PI8042_ISR_WRITE_PORT)(PVOID Context, UCHAR Value);
typedef VOID(NTAPI *PI8042_QUEUE_PACKET)(PVOID Context);
typedef NTSTATUS(NTAPI *PI8042_SYNCH_READ_PORT)(PVOID Context, PUCHAR Value,
                                                BOOLEAN WaitForACK);
typedef NTSTATUS(NTAPI *PI8042_SYNCH_WRITE_PORT)(PVOID Context, UCHAR Value,
                                                 BOOLEAN WaitForACK);
typedef NTSTATUS(NTAPI *PI8042_KEYBOARD_INITIALIZATION_ROUTINE)(
    PVOID InitializationContext, PVOID SynchFuncContext,
    PI8042_SYNCH_READ_PORT ReadPort, PI8042_SYNCH_WRITE_PORT WritePort,
    PBOOLEAN TurnTranslationOn);
typedef BOOLEAN(NTAPI *PI8042_KEYBOARD_ISR)(PVOID IsrContext,
...
typedef BOOLEAN(NTAPI *PI8042_MOUSE_ISR)(PVOID IsrContext,
