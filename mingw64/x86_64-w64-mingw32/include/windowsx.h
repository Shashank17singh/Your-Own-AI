...
#define GlobalFreePtr(lp)                                                      \
  (GlobalUnlockPtr(lp), (WINBOOL)(ULONG_PTR)GlobalFree(GlobalPtrHandle(lp)))
...
#define SetWindowRedraw(hwnd, fRedraw)                                         \
  ((void)SNDMSG(hwnd, WM_SETREDRAW, (WPARAM)(WINBOOL)(fRedraw), (LPARAM)0))
...
#define SetDlgMsgResult(hwnd, msg, result)                                     \
  (((msg) == WM_CTLCOLORMSGBOX || (msg) == WM_CTLCOLOREDIT ||                  \
    (msg) == WM_CTLCOLORLISTBOX || (msg) == WM_CTLCOLORBTN ||                  \
    (msg) == WM_CTLCOLORDLG || (msg) == WM_CTLCOLORSCROLLBAR ||                \
    (msg) == WM_CTLCOLORSTATIC || (msg) == WM_COMPAREITEM ||                   \
...
#define HANDLE_WM_COMPACTING(hwnd, wParam, lParam, fn)                         \
  ((fn)((hwnd), (UINT)(wParam)), (LRESULT)0)
#define FORWARD_WM_COMPACTING(hwnd, compactRatio, fn)                          \
  (void)(fn)((hwnd), WM_COMPACTING, (WPARAM)(UINT)(compactRatio), (LPARAM)0)
#define HANDLE_WM_WININICHANGE(hwnd, wParam, lParam, fn)                       \
  ((fn)((hwnd), (LPCTSTR)(lParam)), (LRESULT)0)
#define FORWARD_WM_WININICHANGE(hwnd, lpszSectionName, fn)                     \
  (void)(fn)((hwnd), WM_WININICHANGE, (WPARAM)0,                               \
...
#define FORWARD_WM_CREATE(hwnd, lpCreateStruct, fn)                            \
  (WINBOOL)(DWORD)(fn)((hwnd), WM_CREATE, (WPARAM)0,                           \
...
#define FORWARD_WM_GETTEXTLENGTH(hwnd, fn)                                     \
  (int)(DWORD)(fn)((hwnd), WM_GETTEXTLENGTH, (WPARAM)0, (LPARAM)0)
#define HANDLE_WM_WINDOWPOSCHANGING(hwnd, wParam, lParam, fn)                  \
  (LRESULT)(DWORD)(WINBOOL)(fn)((hwnd), (LPWINDOWPOS)(lParam))
#define FORWARD_WM_WINDOWPOSCHANGING(hwnd, lpwpos, fn)                         \
  (WINBOOL)(DWORD)(fn)((hwnd), WM_WINDOWPOSCHANGING, (WPARAM)0,                \
                       (LPARAM)(LPWINDOWPOS)(lpwpos))
#define HANDLE_WM_WINDOWPOSCHANGED(hwnd, wParam, lParam, fn)                   \
  ((fn)((hwnd), (const LPWINDOWPOS)(lParam)), (LRESULT)0)
#define FORWARD_WM_WINDOWPOSCHANGED(hwnd, lpwpos, fn)                          \
  (void)(fn)((hwnd), WM_WINDOWPOSCHANGED, (WPARAM)0,                           \
             (LPARAM)(const LPWINDOWPOS)(lpwpos))
...
#define FORWARD_WM_MOVE(hwnd, x, y, fn)                                        \
  (void)(fn)((hwnd), WM_MOVE, (WPARAM)0, MAKELPARAM((x), (y)))
...
#define FORWARD_WM_NCHITTEST(hwnd, x, y, fn)                                   \
  (UINT)(DWORD)(fn)((hwnd), WM_NCHITTEST, (WPARAM)0, MAKELPARAM((x), (y)))
#define HANDLE_WM_QUERYDRAGICON(hwnd, wParam, lParam, fn)                      \
  (LRESULT)(DWORD)(UINT)(fn)(hwnd)
#define FORWARD_WM_QUERYDRAGICON(hwnd, fn)                                     \
  (HICON)(UINT)(DWORD)(fn)((hwnd), WM_QUERYDRAGICON, (WPARAM)0, (LPARAM)0)
#ifdef _INC_SHELLAPI
#define HANDLE_WM_DROPFILES(hwnd, wParam, lParam, fn)                          \
  ((fn)((hwnd), (HDROP)(wParam)), (LRESULT)0)
#define FORWARD_WM_DROPFILES(hwnd, hdrop, fn)                                  \
  (void)(fn)((hwnd), WM_DROPFILES, (WPARAM)(HDROP)(hdrop), (LPARAM)0)
#endif
#define HANDLE_WM_ACTIVATE(hwnd, wParam, lParam, fn)                           \
  ((fn)((hwnd), (UINT)LOWORD(wParam), (HWND)(lParam),                          \
        (WINBOOL)HIWORD(wParam)),                                              \
   (LRESULT)0)
...
#define HANDLE_WM_ACTIVATEAPP(hwnd, wParam, lParam, fn)                        \
  ((fn)((hwnd), (WINBOOL)(wParam), (DWORD)(lParam)), (LRESULT)0)
#define FORWARD_WM_ACTIVATEAPP(hwnd, fActivate, dwThreadId, fn)                \
  (void)(fn)((hwnd), WM_ACTIVATEAPP, (WPARAM)(WINBOOL)(fActivate),             \
             (LPARAM)(dwThreadId))
#define HANDLE_WM_NCACTIVATE(hwnd, wParam, lParam, fn)                         \
  (LRESULT)(DWORD)(WINBOOL)(fn)((hwnd), (WINBOOL)(wParam), (WPARAM)0, (LPARAM)0)
#define FORWARD_WM_NCACTIVATE(hwnd, fActive, hwndActDeact, fMinimized, fn)     \
  (WINBOOL)(DWORD)(fn)((hwnd), WM_NCACTIVATE, (WPARAM)(WINBOOL)(fActive),      \
                       (LPARAM)0)
#define HANDLE_WM_SETFOCUS(hwnd, wParam, lParam, fn)                           \
  ((fn)((hwnd), (HWND)(wParam)), (LRESULT)0)
#define FORWARD_WM_SETFOCUS(hwnd, hwndOldFocus, fn)                            \
  (void)(fn)((hwnd), WM_SETFOCUS, (WPARAM)(HWND)(hwndOldFocus), (LPARAM)0)
#define HANDLE_WM_KILLFOCUS(hwnd, wParam, lParam, fn)                          \
  ((fn)((hwnd), (HWND)(wParam)), (LRESULT)0)
#define FORWARD_WM_KILLFOCUS(hwnd, hwndNewFocus, fn)                           \
  (void)(fn)((hwnd), WM_KILLFOCUS, (WPARAM)(HWND)(hwndNewFocus), (LPARAM)0)
...
#define FORWARD_WM_KEYDOWN(hwnd, vk, cRepeat, flags, fn)                       \
  (void)(fn)((hwnd), WM_KEYDOWN, (WPARAM)(UINT)(vk),                           \
...
#define FORWARD_WM_KEYUP(hwnd, vk, cRepeat, flags, fn)                         \
  (void)(fn)((hwnd), WM_KEYUP, (WPARAM)(UINT)(vk),                             \
             MAKELPARAM((cRepeat), (flags)))
...
#define FORWARD_WM_SYSKEYDOWN(hwnd, vk, cRepeat, flags, fn)                    \
  (void)(fn)((hwnd), WM_SYSKEYDOWN, (WPARAM)(UINT)(vk),                        \
             MAKELPARAM((cRepeat), (flags)))
...
#define FORWARD_WM_SYSKEYUP(hwnd, vk, cRepeat, flags, fn)                      \
  (void)(fn)((hwnd), WM_SYSKEYUP, (WPARAM)(UINT)(vk),                          \
             MAKELPARAM((cRepeat), (flags)))
...
#define FORWARD_WM_SYSDEADCHAR(hwnd, ch, cRepeat, fn)                          \
  (void)(fn)((hwnd), WM_SYSDEADCHAR, (WPARAM)(TCHAR)(ch),                      \
             MAKELPARAM((cRepeat), 0))
#define HANDLE_WM_MOUSEMOVE(hwnd, wParam, lParam, fn)                          \
  ((fn)((hwnd), (int)(short)LOWORD(lParam), (int)(short)HIWORD(lParam),        \
        (UINT)(wParam)),                                                       \
   (LRESULT)0)
#define FORWARD_WM_MOUSEMOVE(hwnd, x, y, keyFlags, fn)                         \
  (void)(fn)((hwnd), WM_MOUSEMOVE, (WPARAM)(UINT)(keyFlags),                   \
             MAKELPARAM((x), (y)))
...
#define FORWARD_WM_LBUTTONUP(hwnd, x, y, keyFlags, fn)                         \
  (void)(fn)((hwnd), WM_LBUTTONUP, (WPARAM)(UINT)(keyFlags),                   \
             MAKELPARAM((x), (y)))
...
#define FORWARD_WM_RBUTTONUP(hwnd, x, y, keyFlags, fn)                         \
  (void)(fn)((hwnd), WM_RBUTTONUP, (WPARAM)(UINT)(keyFlags),                   \
             MAKELPARAM((x), (y)))
...
#define FORWARD_WM_MBUTTONUP(hwnd, x, y, keyFlags, fn)                         \
  (void)(fn)((hwnd), WM_MBUTTONUP, (WPARAM)(UINT)(keyFlags),                   \
             MAKELPARAM((x), (y)))
...
#define FORWARD_WM_MOUSEWHEEL(hwnd, xPos, yPos, zDelta, fwKeys, fn)            \
  (void)(fn)((hwnd), WM_MOUSEWHEEL, MAKEWPARAM((fwKeys), (zDelta)),            \
             MAKELPARAM((x), (y)))
...
#define FORWARD_WM_NCMOUSEMOVE(hwnd, x, y, codeHitTest, fn)                    \
  (void)(fn)((hwnd), WM_NCMOUSEMOVE, (WPARAM)(UINT)(codeHitTest),              \
             MAKELPARAM((x), (y)))
...
#define FORWARD_WM_NCLBUTTONUP(hwnd, x, y, codeHitTest, fn)                    \
  (void)(fn)((hwnd), WM_NCLBUTTONUP, (WPARAM)(UINT)(codeHitTest),              \
             MAKELPARAM((x), (y)))
...
#define FORWARD_WM_NCRBUTTONUP(hwnd, x, y, codeHitTest, fn)                    \
  (void)(fn)((hwnd), WM_NCRBUTTONUP, (WPARAM)(UINT)(codeHitTest),              \
             MAKELPARAM((x), (y)))
...
#define FORWARD_WM_NCMBUTTONUP(hwnd, x, y, codeHitTest, fn)                    \
  (void)(fn)((hwnd), WM_NCMBUTTONUP, (WPARAM)(UINT)(codeHitTest),              \
             MAKELPARAM((x), (y)))
...
#define FORWARD_WM_CANCELMODE(hwnd, fn)                                        \
  (void)(fn)((hwnd), WM_CANCELMODE, (WPARAM)0, (LPARAM)0)
#define HANDLE_WM_TIMER(hwnd, wParam, lParam, fn)                              \
  ((fn)((hwnd), (UINT)(wParam)), (LRESULT)0)
#define FORWARD_WM_TIMER(hwnd, id, fn)                                         \
  (void)(fn)((hwnd), WM_TIMER, (WPARAM)(UINT)(id), (LPARAM)0)
#define HANDLE_WM_INITMENU(hwnd, wParam, lParam, fn)                           \
  ((fn)((hwnd), (HMENU)(wParam)), (LRESULT)0)
#define FORWARD_WM_INITMENU(hwnd, hMenu, fn)                                   \
  (void)(fn)((hwnd), WM_INITMENU, (WPARAM)(HMENU)(hMenu), (LPARAM)0)
#define HANDLE_WM_INITMENUPOPUP(hwnd, wParam, lParam, fn)                      \
  ((fn)((hwnd), (HMENU)(wParam), (UINT)LOWORD(lParam),                         \
        (WINBOOL)HIWORD(lParam)),                                              \
   (LRESULT)0)
...
#define HANDLE_WM_VSCROLLCLIPBOARD(hwnd, wParam, lParam, fn)                   \
  ((fn)((hwnd), (HWND)(wParam), (UINT)LOWORD(lParam),                          \
        (int)(short)HIWORD(lParam)),                                           \
   (LRESULT)0)
...
#define HANDLE_WM_ASKCBFORMATNAME(hwnd, wParam, lParam, fn)                    \
  ((fn)((hwnd), (int)(wParam), (LPTSTR)(lParam)), (LRESULT)0)
#define FORWARD_WM_ASKCBFORMATNAME(hwnd, cchMax, rgchName, fn)                 \
  (void)(fn)((hwnd), WM_ASKCBFORMATNAME, (WPARAM)(int)(cchMax),                \
             (LPARAM)(rgchName))
#define HANDLE_WM_CHANGECBCHAIN(hwnd, wParam, lParam, fn)                      \
  ((fn)((hwnd), (HWND)(wParam), (HWND)(lParam)), (LRESULT)0)
...
#define HANDLE_WM_SETCURSOR(hwnd, wParam, lParam, fn)                          \
  (LRESULT)(DWORD)(WINBOOL)(fn)((hwnd), (HWND)(wParam), (UINT)LOWORD(lParam),  \
                                (UINT)HIWORD(lParam))
#define FORWARD_WM_SETCURSOR(hwnd, hwndCursor, codeHitTest, msg, fn)           \
  (WINBOOL)(DWORD)(fn)((hwnd), WM_SETCURSOR, (WPARAM)(HWND)(hwndCursor),       \
                       MAKELPARAM((codeHitTest), (msg)))
...
#define FORWARD_WM_MDICREATE(hwnd, lpmcs, fn)                                  \
  (HWND)(UINT)(DWORD)(fn)((hwnd), WM_MDICREATE, (WPARAM)0,                     \
...
#define FORWARD_WM_MDIDESTROY(hwnd, hwndDestroy, fn)                           \
  (void)(fn)((hwnd), WM_MDIDESTROY, (WPARAM)(hwndDestroy), (LPARAM)0)
#define HANDLE_WM_MDIACTIVATE(hwnd, wParam, lParam, fn)                        \
  ((fn)((hwnd), (WINBOOL)(lParam == (LPARAM)hwnd), (HWND)(lParam),             \
        (HWND)(wParam)),                                                       \
   (LRESULT)0)
#define FORWARD_WM_MDIACTIVATE(hwnd, fActive, hwndActivate, hwndDeactivate,    \
                               fn)                                             \
...
#define FORWARD_WM_MDIRESTORE(hwnd, hwndRestore, fn)                           \
  (void)(fn)((hwnd), WM_MDIRESTORE, (WPARAM)(hwndRestore), (LPARAM)0)
#define HANDLE_WM_MDINEXT(hwnd, wParam, lParam, fn)                            \
  (LRESULT)(HWND)(fn)((hwnd), (HWND)(wParam), (WINBOOL)lParam)
...
#define HANDLE_WM_ENTERIDLE(hwnd, wParam, lParam, fn)                          \
  ((fn)((hwnd), (UINT)(wParam), (HWND)(lParam)), (LRESULT)0)
...
#define HANDLE_WM_CTLCOLORMSGBOX(hwnd, wParam, lParam, fn)                     \
  (LRESULT)(UINT_PTR)(HBRUSH)(fn)((hwnd), (HDC)(wParam), (HWND)(lParam),       \
                                  CTLCOLOR_MSGBOX)
#define FORWARD_WM_CTLCOLORMSGBOX(hwnd, hdc, hwndChild, fn)                    \
  (HBRUSH)(UINT_PTR)(fn)((hwnd), WM_CTLCOLORMSGBOX, (WPARAM)(HDC)(hdc),        \
...
#define HANDLE_WM_MEASUREITEM(hwnd, wParam, lParam, fn)                        \
  ((fn)((hwnd), (MEASUREITEMSTRUCT *)(lParam)), (LRESULT)0)
#define FORWARD_WM_MEASUREITEM(hwnd, lpMeasureItem, fn)                        \
  (void)(fn)((hwnd), WM_MEASUREITEM,                                           \
...
#define HANDLE_WM_DELETEITEM(hwnd, wParam, lParam, fn)                         \
  ((fn)((hwnd), (const DELETEITEMSTRUCT *)(lParam)), (LRESULT)0)
#define FORWARD_WM_DELETEITEM(hwnd, lpDeleteItem, fn)                          \
  (void)(fn)((hwnd), WM_DELETEITEM,                                            \
             (WPARAM)(((const DELETEITEMSTRUCT *)(lpDeleteItem))->CtlID),      \
...
#define FORWARD_WM_COMPAREITEM(hwnd, lpCompareItem, fn)                        \
  (int)(DWORD)(fn)((hwnd), WM_COMPAREITEM,                                     \
                   (WPARAM)(((const COMPAREITEMSTRUCT *)(lpCompareItem))       \
                                ->CtlID),                                      \
...
#define FORWARD_WM_CHARTOITEM(hwnd, ch, hwndListBox, iCaret, fn)               \
  (int)(DWORD)(fn)((hwnd), WM_CHARTOITEM,                                      \
...
#define FORWARD_WM_QUEUESYNC(hwnd, fn)                                         \
  (void)(fn)((hwnd), WM_QUEUESYNC, (WPARAM)0, (LPARAM)0)
#define HANDLE_WM_COMMNOTIFY(hwnd, wParam, lParam, fn)                         \
  ((fn)((hwnd), (int)(wParam), (UINT)LOWORD(lParam)), (LRESULT)0)
...
#define HANDLE_WM_DISPLAYCHANGE(hwnd, wParam, lParam, fn)                      \
  ((fn)((hwnd), (UINT)(wParam), (UINT)LOWORD(lParam), (UINT)HIWORD(wParam)),   \
   (LRESULT)0)
...
#define HANDLE_WM_DEVICECHANGE(hwnd, wParam, lParam, fn)                       \
  (LRESULT)(DWORD)(WINBOOL)(fn)((hwnd), (UINT)(wParam), (DWORD)(wParam))
#define FORWARD_WM_DEVICECHANGE(hwnd, uEvent, dwEventData, fn)                 \
  (WINBOOL)(DWORD)(fn)((hwnd), WM_DEVICECHANGE, (WPARAM)(UINT)(uEvent),        \
...
#define HANDLE_WM_COPYDATA(hwnd, wParam, lParam, fn)                           \
  ((fn)((hwnd), (HWND)(wParam), (PCOPYDATASTRUCT)lParam), (LRESULT)0)
#define FORWARD_WM_COPYDATA(hwnd, hwndFrom, pcds, fn)                          \
  (WINBOOL)(UINT)(DWORD)(fn)((hwnd), WM_COPYDATA, (WPARAM)(hwndFrom),          \
                             (LPARAM)(pcds))
...
#define FORWARD_WM_HOTKEY(hwnd, idHotKey, fuModifiers, vk, fn)                 \
  (void)(fn)((hwnd), WM_HOTKEY, (WPARAM)(idHotKey),                            \
             MAKELPARAM((fuModifiers), (vk)))
...
#define Static_SetIcon(hwndCtl, hIcon)                                         \
  ((HICON)(UINT_PTR)SNDMSG((hwndCtl), STM_SETICON, (WPARAM)(HICON)(hIcon),     \
                           (LPARAM)0))
#define Static_GetIcon(hwndCtl, hIcon)                                         \
  ((HICON)(UINT_PTR)SNDMSG((hwndCtl), STM_GETICON, (WPARAM)0, (LPARAM)0))
...
#define Button_GetCheck(hwndCtl)                                               \
  ((int)(DWORD)SNDMSG((hwndCtl), BM_GETCHECK, (WPARAM)0, (LPARAM)0))
#define Button_SetCheck(hwndCtl, check)                                        \
  ((void)SNDMSG((hwndCtl), BM_SETCHECK, (WPARAM)(int)(check), (LPARAM)0))
#define Button_GetState(hwndCtl)                                               \
  ((int)(DWORD)SNDMSG((hwndCtl), BM_GETSTATE, (WPARAM)0, (LPARAM)0))
#define Button_SetState(hwndCtl, state)                                        \
  ((UINT)(DWORD)SNDMSG((hwndCtl), BM_SETSTATE, (WPARAM)(int)(state), (LPARAM)0))
#define Button_SetStyle(hwndCtl, style, fRedraw)                               \
  ((void)SNDMSG((hwndCtl), BM_SETSTYLE, (WPARAM)LOWORD(style),                 \
                MAKELPARAM(((fRedraw) ? TRUE : FALSE), 0)))
...
#define Edit_LimitText(hwndCtl, cchMax)                                        \
  ((void)SNDMSG((hwndCtl), EM_LIMITTEXT, (WPARAM)(cchMax), (LPARAM)0))
#define Edit_GetLineCount(hwndCtl)                                             \
  ((int)(DWORD)SNDMSG((hwndCtl), EM_GETLINECOUNT, (WPARAM)0, (LPARAM)0))
#define Edit_GetLine(hwndCtl, line, lpch, cchMax)                              \
  ((*((int *)(lpch)) = (cchMax)),                                              \
   ((int)(DWORD)SNDMSG((hwndCtl), EM_GETLINE, (WPARAM)(int)(line),             \
                       (LPARAM)(LPTSTR)(lpch))))
#define Edit_GetRect(hwndCtl, lprc)                                            \
  ((void)SNDMSG((hwndCtl), EM_GETRECT, (LPARAM)0, (LPARAM)(RECT *)(lprc)))
#define Edit_SetRect(hwndCtl, lprc)                                            \
  ((void)SNDMSG((hwndCtl), EM_SETRECT, (LPARAM)0, (LPARAM)(const RECT *)(lprc)))
#define Edit_SetRectNoPaint(hwndCtl, lprc)                                     \
  ((void)SNDMSG((hwndCtl), EM_SETRECTNP, (LPARAM)0,                            \
                (LPARAM)(const RECT *)(lprc)))
#define Edit_GetSel(hwndCtl)                                                   \
  ((DWORD)SNDMSG((hwndCtl), EM_GETSEL, (WPARAM)0, (LPARAM)0))
...
#define Edit_ReplaceSel(hwndCtl, lpszReplace)                                  \
  ((void)SNDMSG((hwndCtl), EM_REPLACESEL, (LPARAM)0,                           \
                (LPARAM)(LPCTSTR)(lpszReplace)))
#define Edit_GetModify(hwndCtl)                                                \
  ((WINBOOL)(DWORD)SNDMSG((hwndCtl), EM_GETMODIFY, (WPARAM)0, (LPARAM)0))
#define Edit_SetModify(hwndCtl, fModified)                                     \
  ((void)SNDMSG((hwndCtl), EM_SETMODIFY, (WPARAM)(UINT)(fModified), (LPARAM)0))
#define Edit_ScrollCaret(hwndCtl)                                              \
  ((WINBOOL)(DWORD)SNDMSG((hwndCtl), EM_SCROLLCARET, (WPARAM)0, (LPARAM)0))
#define Edit_LineFromChar(hwndCtl, ich)                                        \
  ((int)(DWORD)SNDMSG((hwndCtl), EM_LINEFROMCHAR, (WPARAM)(int)(ich),          \
                      (LPARAM)0))
#define Edit_LineIndex(hwndCtl, line)                                          \
  ((int)(DWORD)SNDMSG((hwndCtl), EM_LINEINDEX, (WPARAM)(int)(line), (LPARAM)0))
#define Edit_LineLength(hwndCtl, line)                                         \
  ((int)(DWORD)SNDMSG((hwndCtl), EM_LINELENGTH, (WPARAM)(int)(line), (LPARAM)0))
#define Edit_Scroll(hwndCtl, dv, dh)                                           \
  ((void)SNDMSG((hwndCtl), EM_LINESCROLL, (WPARAM)(dh), (LPARAM)(dv)))
#define Edit_CanUndo(hwndCtl)                                                  \
  ((WINBOOL)(DWORD)SNDMSG((hwndCtl), EM_CANUNDO, (WPARAM)0, (LPARAM)0))
#define Edit_Undo(hwndCtl)                                                     \
  ((WINBOOL)(DWORD)SNDMSG((hwndCtl), EM_UNDO, (WPARAM)0, (LPARAM)0))
#define Edit_EmptyUndoBuffer(hwndCtl)                                          \
  ((void)SNDMSG((hwndCtl), EM_EMPTYUNDOBUFFER, (WPARAM)0, (LPARAM)0))
#define Edit_SetPasswordChar(hwndCtl, ch)                                      \
  ((void)SNDMSG((hwndCtl), EM_SETPASSWORDCHAR, (WPARAM)(UINT)(ch), (LPARAM)0))
#define Edit_SetTabStops(hwndCtl, cTabs, lpTabs)                               \
  ((void)SNDMSG((hwndCtl), EM_SETTABSTOPS, (WPARAM)(int)(cTabs),               \
                (LPARAM)(const int *)(lpTabs)))
#define Edit_FmtLines(hwndCtl, fAddEOL)                                        \
  ((WINBOOL)(DWORD)SNDMSG((hwndCtl), EM_FMTLINES, (WPARAM)(WINBOOL)(fAddEOL),  \
                          (LPARAM)0))
#define Edit_GetHandle(hwndCtl)                                                \
  ((HLOCAL)(UINT_PTR)SNDMSG((hwndCtl), EM_GETHANDLE, (WPARAM)0, (LPARAM)0))
#define Edit_SetHandle(hwndCtl, h)                                             \
  ((void)SNDMSG((hwndCtl), EM_SETHANDLE, (WPARAM)(UINT_PTR)(HLOCAL)(h),        \
                (LPARAM)0))
#define Edit_GetFirstVisibleLine(hwndCtl)                                      \
  ((int)(DWORD)SNDMSG((hwndCtl), EM_GETFIRSTVISIBLELINE, (WPARAM)0, (LPARAM)0))
#define Edit_SetReadOnly(hwndCtl, fReadOnly)                                   \
  ((WINBOOL)(DWORD)SNDMSG((hwndCtl), EM_SETREADONLY,                           \
                          (WPARAM)(WINBOOL)(fReadOnly), (LPARAM)0))
#define Edit_GetPasswordChar(hwndCtl)                                          \
  ((TCHAR)(DWORD)SNDMSG((hwndCtl), EM_GETPASSWORDCHAR, (WPARAM)0, (LPARAM)0))
#define Edit_SetWordBreakProc(hwndCtl, lpfnWordBreak)                          \
  ((void)SNDMSG((hwndCtl), EM_SETWORDBREAKPROC, (LPARAM)0,                     \
                (LPARAM)(EDITWORDBREAKPROC)(lpfnWordBreak)))
#define Edit_GetWordBreakProc(hwndCtl)                                         \
  ((EDITWORDBREAKPROC)SNDMSG((hwndCtl), EM_GETWORDBREAKPROC, (WPARAM)0,        \
                             (LPARAM)0))
...
#define ListBox_GetCount(hwndCtl)                                              \
  ((int)(DWORD)SNDMSG((hwndCtl), LB_GETCOUNT, (WPARAM)0, (LPARAM)0))
#define ListBox_ResetContent(hwndCtl)                                          \
  ((WINBOOL)(DWORD)SNDMSG((hwndCtl), LB_RESETCONTENT, (WPARAM)0, (LPARAM)0))
#define ListBox_AddString(hwndCtl, lpsz)                                       \
  ((int)(DWORD)SNDMSG((hwndCtl), LB_ADDSTRING, (LPARAM)0,                      \
                      (LPARAM)(LPCTSTR)(lpsz)))
#define ListBox_InsertString(hwndCtl, index, lpsz)                             \
  ((int)(DWORD)SNDMSG((hwndCtl), LB_INSERTSTRING, (WPARAM)(int)(index),        \
                      (LPARAM)(LPCTSTR)(lpsz)))
#define ListBox_AddItemData(hwndCtl, data)                                     \
  ((int)(DWORD)SNDMSG((hwndCtl), LB_ADDSTRING, (LPARAM)0, (LPARAM)(data)))
#define ListBox_InsertItemData(hwndCtl, index, data)                           \
  ((int)(DWORD)SNDMSG((hwndCtl), LB_INSERTSTRING, (WPARAM)(int)(index),        \
                      (LPARAM)(data)))
#define ListBox_DeleteString(hwndCtl, index)                                   \
  ((int)(DWORD)SNDMSG((hwndCtl), LB_DELETESTRING, (WPARAM)(int)(index),        \
                      (LPARAM)0))
#define ListBox_GetTextLen(hwndCtl, index)                                     \
  ((int)(DWORD)SNDMSG((hwndCtl), LB_GETTEXTLEN, (WPARAM)(int)(index),          \
                      (LPARAM)0))
#define ListBox_GetText(hwndCtl, index, lpszBuffer)                            \
  ((int)(DWORD)SNDMSG((hwndCtl), LB_GETTEXT, (WPARAM)(int)(index),             \
                      (LPARAM)(LPCTSTR)(lpszBuffer)))
#define ListBox_GetItemData(hwndCtl, index)                                    \
  ((LRESULT)(ULONG_PTR)SNDMSG((hwndCtl), LB_GETITEMDATA, (WPARAM)(int)(index), \
                              (LPARAM)0))
#define ListBox_SetItemData(hwndCtl, index, data)                              \
  ((int)(DWORD)SNDMSG((hwndCtl), LB_SETITEMDATA, (WPARAM)(int)(index),         \
                      (LPARAM)(data)))
#define ListBox_FindString(hwndCtl, indexStart, lpszFind)                      \
  ((int)(DWORD)SNDMSG((hwndCtl), LB_FINDSTRING, (WPARAM)(int)(indexStart),     \
                      (LPARAM)(LPCTSTR)(lpszFind)))
#define ListBox_FindItemData(hwndCtl, indexStart, data)                        \
  ((int)(DWORD)SNDMSG((hwndCtl), LB_FINDSTRING, (WPARAM)(int)(indexStart),     \
                      (LPARAM)(data)))
#define ListBox_SetSel(hwndCtl, fSelect, index)                                \
  ((int)(DWORD)SNDMSG((hwndCtl), LB_SETSEL, (WPARAM)(WINBOOL)(fSelect),        \
                      (LPARAM)(index)))
#define ListBox_SelItemRange(hwndCtl, fSelect, first, last)                    \
  ((int)(DWORD)SNDMSG((hwndCtl), LB_SELITEMRANGE, (WPARAM)(WINBOOL)(fSelect),  \
                      MAKELPARAM((first), (last))))
#define ListBox_GetCurSel(hwndCtl)                                             \
  ((int)(DWORD)SNDMSG((hwndCtl), LB_GETCURSEL, (WPARAM)0, (LPARAM)0))
#define ListBox_SetCurSel(hwndCtl, index)                                      \
  ((int)(DWORD)SNDMSG((hwndCtl), LB_SETCURSEL, (WPARAM)(int)(index), (LPARAM)0))
#define ListBox_SelectString(hwndCtl, indexStart, lpszFind)                    \
  ((int)(DWORD)SNDMSG((hwndCtl), LB_SELECTSTRING, (WPARAM)(int)(indexStart),   \
                      (LPARAM)(LPCTSTR)(lpszFind)))
#define ListBox_SelectItemData(hwndCtl, indexStart, data)                      \
  ((int)(DWORD)SNDMSG((hwndCtl), LB_SELECTSTRING, (WPARAM)(int)(indexStart),   \
                      (LPARAM)(data)))
#define ListBox_GetSel(hwndCtl, index)                                         \
  ((int)(DWORD)SNDMSG((hwndCtl), LB_GETSEL, (WPARAM)(int)(index), (LPARAM)0))
#define ListBox_GetSelCount(hwndCtl)                                           \
  ((int)(DWORD)SNDMSG((hwndCtl), LB_GETSELCOUNT, (WPARAM)0, (LPARAM)0))
#define ListBox_GetTopIndex(hwndCtl)                                           \
  ((int)(DWORD)SNDMSG((hwndCtl), LB_GETTOPINDEX, (WPARAM)0, (LPARAM)0))
#define ListBox_GetSelItems(hwndCtl, cItems, lpItems)                          \
  ((int)(DWORD)SNDMSG((hwndCtl), LB_GETSELITEMS, (WPARAM)(int)(cItems),        \
                      (LPARAM)(int *)(lpItems)))
#define ListBox_SetTopIndex(hwndCtl, indexTop)                                 \
  ((int)(DWORD)SNDMSG((hwndCtl), LB_SETTOPINDEX, (WPARAM)(int)(indexTop),      \
                      (LPARAM)0))
#define ListBox_SetColumnWidth(hwndCtl, cxColumn)                              \
  ((void)SNDMSG((hwndCtl), LB_SETCOLUMNWIDTH, (WPARAM)(int)(cxColumn),         \
                (LPARAM)0))
#define ListBox_GetHorizontalExtent(hwndCtl)                                   \
  ((int)(DWORD)SNDMSG((hwndCtl), LB_GETHORIZONTALEXTENT, (WPARAM)0, (LPARAM)0))
#define ListBox_SetHorizontalExtent(hwndCtl, cxExtent)                         \
  ((void)SNDMSG((hwndCtl), LB_SETHORIZONTALEXTENT, (WPARAM)(int)(cxExtent),    \
                (LPARAM)0))
#define ListBox_SetTabStops(hwndCtl, cTabs, lpTabs)                            \
  ((WINBOOL)(DWORD)SNDMSG((hwndCtl), LB_SETTABSTOPS, (WPARAM)(int)(cTabs),     \
                          (LPARAM)(int *)(lpTabs)))
#define ListBox_GetItemRect(hwndCtl, index, lprc)                              \
  ((int)(DWORD)SNDMSG((hwndCtl), LB_GETITEMRECT, (WPARAM)(int)(index),         \
                      (LPARAM)(RECT *)(lprc)))
#define ListBox_SetCaretIndex(hwndCtl, index)                                  \
  ((int)(DWORD)SNDMSG((hwndCtl), LB_SETCARETINDEX, (WPARAM)(int)(index),       \
                      (LPARAM)0))
#define ListBox_GetCaretIndex(hwndCtl)                                         \
  ((int)(DWORD)SNDMSG((hwndCtl), LB_GETCARETINDEX, (WPARAM)0, (LPARAM)0))
#define ListBox_FindStringExact(hwndCtl, indexStart, lpszFind)                 \
  ((int)(DWORD)SNDMSG((hwndCtl), LB_FINDSTRINGEXACT,                           \
                      (WPARAM)(int)(indexStart), (LPARAM)(LPCTSTR)(lpszFind)))
#define ListBox_SetItemHeight(hwndCtl, index, cy)                              \
  ((int)(DWORD)SNDMSG((hwndCtl), LB_SETITEMHEIGHT, (WPARAM)(int)(index),       \
                      MAKELPARAM((cy), 0)))
#define ListBox_GetItemHeight(hwndCtl, index)                                  \
  ((int)(DWORD)SNDMSG((hwndCtl), LB_GETITEMHEIGHT, (WPARAM)(int)(index),       \
                      (LPARAM)0))
#define ListBox_Dir(hwndCtl, attrs, lpszFileSpec)                              \
  ((int)(DWORD)SNDMSG((hwndCtl), LB_DIR, (WPARAM)(UINT)(attrs),                \
...
#define ComboBox_LimitText(hwndCtl, cchLimit)                                  \
  ((int)(DWORD)SNDMSG((hwndCtl), CB_LIMITTEXT, (WPARAM)(int)(cchLimit),        \
                      (LPARAM)0))
#define ComboBox_GetEditSel(hwndCtl)                                           \
  ((DWORD)SNDMSG((hwndCtl), CB_GETEDITSEL, (WPARAM)0, (LPARAM)0))
#define ComboBox_SetEditSel(hwndCtl, ichStart, ichEnd)                         \
  ((int)(DWORD)SNDMSG((hwndCtl), CB_SETEDITSEL, (LPARAM)0,                     \
                      MAKELPARAM((ichStart), (ichEnd))))
#define ComboBox_GetCount(hwndCtl)                                             \
  ((int)(DWORD)SNDMSG((hwndCtl), CB_GETCOUNT, (WPARAM)0, (LPARAM)0))
#define ComboBox_ResetContent(hwndCtl)                                         \
  ((int)(DWORD)SNDMSG((hwndCtl), CB_RESETCONTENT, (WPARAM)0, (LPARAM)0))
#define ComboBox_AddString(hwndCtl, lpsz)                                      \
  ((int)(DWORD)SNDMSG((hwndCtl), CB_ADDSTRING, (LPARAM)0,                      \
                      (LPARAM)(LPCTSTR)(lpsz)))
#define ComboBox_InsertString(hwndCtl, index, lpsz)                            \
  ((int)(DWORD)SNDMSG((hwndCtl), CB_INSERTSTRING, (WPARAM)(int)(index),        \
                      (LPARAM)(LPCTSTR)(lpsz)))
#define ComboBox_AddItemData(hwndCtl, data)                                    \
  ((int)(DWORD)SNDMSG((hwndCtl), CB_ADDSTRING, (LPARAM)0, (LPARAM)(data)))
#define ComboBox_InsertItemData(hwndCtl, index, data)                          \
  ((int)(DWORD)SNDMSG((hwndCtl), CB_INSERTSTRING, (WPARAM)(int)(index),        \
                      (LPARAM)(data)))
#define ComboBox_DeleteString(hwndCtl, index)                                  \
  ((int)(DWORD)SNDMSG((hwndCtl), CB_DELETESTRING, (WPARAM)(int)(index),        \
                      (LPARAM)0))
#define ComboBox_GetLBTextLen(hwndCtl, index)                                  \
  ((int)(DWORD)SNDMSG((hwndCtl), CB_GETLBTEXTLEN, (WPARAM)(int)(index),        \
                      (LPARAM)0))
#define ComboBox_GetLBText(hwndCtl, index, lpszBuffer)                         \
  ((int)(DWORD)SNDMSG((hwndCtl), CB_GETLBTEXT, (WPARAM)(int)(index),           \
                      (LPARAM)(LPCTSTR)(lpszBuffer)))
#define ComboBox_GetItemData(hwndCtl, index)                                   \
  ((LRESULT)(ULONG_PTR)SNDMSG((hwndCtl), CB_GETITEMDATA, (WPARAM)(int)(index), \
                              (LPARAM)0))
#define ComboBox_SetItemData(hwndCtl, index, data)                             \
  ((int)(DWORD)SNDMSG((hwndCtl), CB_SETITEMDATA, (WPARAM)(int)(index),         \
                      (LPARAM)(data)))
#define ComboBox_FindString(hwndCtl, indexStart, lpszFind)                     \
  ((int)(DWORD)SNDMSG((hwndCtl), CB_FINDSTRING, (WPARAM)(int)(indexStart),     \
                      (LPARAM)(LPCTSTR)(lpszFind)))
#define ComboBox_FindItemData(hwndCtl, indexStart, data)                       \
  ((int)(DWORD)SNDMSG((hwndCtl), CB_FINDSTRING, (WPARAM)(int)(indexStart),     \
                      (LPARAM)(data)))
#define ComboBox_GetCurSel(hwndCtl)                                            \
  ((int)(DWORD)SNDMSG((hwndCtl), CB_GETCURSEL, (WPARAM)0, (LPARAM)0))
#define ComboBox_SetCurSel(hwndCtl, index)                                     \
  ((int)(DWORD)SNDMSG((hwndCtl), CB_SETCURSEL, (WPARAM)(int)(index), (LPARAM)0))
#define ComboBox_SelectString(hwndCtl, indexStart, lpszSelect)                 \
  ((int)(DWORD)SNDMSG((hwndCtl), CB_SELECTSTRING, (WPARAM)(int)(indexStart),   \
...
#define ComboBox_Dir(hwndCtl, attrs, lpszFileSpec)                             \
  ((int)(DWORD)SNDMSG((hwndCtl), CB_DIR, (WPARAM)(UINT)(attrs),                \
                      (LPARAM)(LPCTSTR)(lpszFileSpec)))
#define ComboBox_ShowDropdown(hwndCtl, fShow)                                  \
  ((WINBOOL)(DWORD)SNDMSG((hwndCtl), CB_SHOWDROPDOWN,                          \
                          (WPARAM)(WINBOOL)(fShow), (LPARAM)0))
#define ComboBox_FindStringExact(hwndCtl, indexStart, lpszFind)                \
  ((int)(DWORD)SNDMSG((hwndCtl), CB_FINDSTRINGEXACT,                           \
                      (WPARAM)(int)(indexStart), (LPARAM)(LPCTSTR)(lpszFind)))
#define ComboBox_GetDroppedState(hwndCtl)                                      \
  ((WINBOOL)(DWORD)SNDMSG((hwndCtl), CB_GETDROPPEDSTATE, (WPARAM)0, (LPARAM)0))
#define ComboBox_GetDroppedControlRect(hwndCtl, lprc)                          \
  ((void)SNDMSG((hwndCtl), CB_GETDROPPEDCONTROLRECT, (LPARAM)0,                \
                (LPARAM)(RECT *)(lprc)))
#define ComboBox_GetItemHeight(hwndCtl)                                        \
  ((int)(DWORD)SNDMSG((hwndCtl), CB_GETITEMHEIGHT, (WPARAM)0, (LPARAM)0))
#define ComboBox_SetItemHeight(hwndCtl, index, cyItem)                         \
  ((int)(DWORD)SNDMSG((hwndCtl), CB_SETITEMHEIGHT, (WPARAM)(int)(index),       \
                      (LPARAM)(int)cyItem))
#define ComboBox_GetExtendedUI(hwndCtl)                                        \
  ((UINT)(DWORD)SNDMSG((hwndCtl), CB_GETEXTENDEDUI, (WPARAM)0, (LPARAM)0))
#define ComboBox_SetExtendedUI(hwndCtl, flags)                                 \
  ((int)(DWORD)SNDMSG((hwndCtl), CB_SETEXTENDEDUI, (WPARAM)(UINT)(flags),      \
                      (LPARAM)0))
