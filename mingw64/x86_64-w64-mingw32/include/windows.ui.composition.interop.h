/*** Autogenerated by WIDL 11.5 from include/windows.ui.composition.interop.idl
 * - Do not edit ***/
#ifdef _WIN32
...
#ifdef __cplusplus
#define __x_ABI_CWindows_CUI_CComposition_CICompositorInterop                  \
...
DEFINE_GUID(IID___x_ABI_CWindows_CUI_CComposition_CICompositorInterop,
            0x25297d5c, 0x3ad4, 0x4c9c, 0xb5, 0xcf, 0xe3, 0x6a, 0x38, 0x51,
            0x23, 0x30);
...
__CRT_UUID_DECL(__x_ABI_CWindows_CUI_CComposition_CICompositorInterop,
                0x25297d5c, 0x3ad4, 0x4c9c, 0xb5, 0xcf, 0xe3, 0x6a, 0x38, 0x51,
                0x23, 0x30)
#endif
#else
typedef struct __x_ABI_CWindows_CUI_CComposition_CICompositorInteropVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(
      __x_ABI_CWindows_CUI_CComposition_CICompositorInterop *This, REFIID riid,
      void **ppvObject);
...
#define __x_ABI_CWindows_CUI_CComposition_CICompositorInterop_AddRef(This)     \
  (This)->lpVtbl->AddRef(This)
#define __x_ABI_CWindows_CUI_CComposition_CICompositorInterop_Release(This)    \
  (This)->lpVtbl->Release(This)
/*** ICompositorInterop methods ***/
#define __x_ABI_CWindows_CUI_CComposition_CICompositorInterop_CreateCompositionSurfaceForHandle( \
    This, swapchain, result)                                                                     \
  (This)->lpVtbl->CreateCompositionSurfaceForHandle(This, swapchain, result)
#define __x_ABI_CWindows_CUI_CComposition_CICompositorInterop_CreateCompositionSurfaceForSwapChain( \
    This, swapchain, result)                                                                        \
  (This)->lpVtbl->CreateCompositionSurfaceForSwapChain(This, swapchain, result)
#define __x_ABI_CWindows_CUI_CComposition_CICompositorInterop_CreateGraphicsDevice( \
    This, device, result)                                                           \
  (This)->lpVtbl->CreateGraphicsDevice(This, device, result)
#else
/*** IUnknown methods ***/
static inline HRESULT
__x_ABI_CWindows_CUI_CComposition_CICompositorInterop_QueryInterface(
    __x_ABI_CWindows_CUI_CComposition_CICompositorInterop *This, REFIID riid,
    void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
__x_ABI_CWindows_CUI_CComposition_CICompositorInterop_AddRef(
    __x_ABI_CWindows_CUI_CComposition_CICompositorInterop *This) {
...
/*** ICompositorInterop methods ***/
static inline HRESULT
__x_ABI_CWindows_CUI_CComposition_CICompositorInterop_CreateCompositionSurfaceForHandle(
    __x_ABI_CWindows_CUI_CComposition_CICompositorInterop *This,
    HANDLE swapchain,
    __x_ABI_CWindows_CUI_CComposition_CICompositionSurface **result) {
  return This->lpVtbl->CreateCompositionSurfaceForHandle(This, swapchain,
                                                         result);
}
static inline HRESULT
__x_ABI_CWindows_CUI_CComposition_CICompositorInterop_CreateCompositionSurfaceForSwapChain(
    __x_ABI_CWindows_CUI_CComposition_CICompositorInterop *This,
    IUnknown *swapchain,
    __x_ABI_CWindows_CUI_CComposition_CICompositionSurface **result) {
  return This->lpVtbl->CreateCompositionSurfaceForSwapChain(This, swapchain,
                                                            result);
}
static inline HRESULT
__x_ABI_CWindows_CUI_CComposition_CICompositorInterop_CreateGraphicsDevice(
    __x_ABI_CWindows_CUI_CComposition_CICompositorInterop *This,
    IUnknown *device,
    __x_ABI_CWindows_CUI_CComposition_CICompositionGraphicsDevice **result) {
...
#define IID_ICompositorInterop                                                 \
  IID___x_ABI_CWindows_CUI_CComposition_CICompositorInterop
#define ICompositorInteropVtbl                                                 \
  __x_ABI_CWindows_CUI_CComposition_CICompositorInteropVtbl
#define ICompositorInterop __x_ABI_CWindows_CUI_CComposition_CICompositorInterop
#define ICompositorInterop_QueryInterface                                      \
  __x_ABI_CWindows_CUI_CComposition_CICompositorInterop_QueryInterface
#define ICompositorInterop_AddRef                                              \
  __x_ABI_CWindows_CUI_CComposition_CICompositorInterop_AddRef
#define ICompositorInterop_Release                                             \
  __x_ABI_CWindows_CUI_CComposition_CICompositorInterop_Release
#define ICompositorInterop_CreateCompositionSurfaceForHandle                   \
  __x_ABI_CWindows_CUI_CComposition_CICompositorInterop_CreateCompositionSurfaceForHandle
#define ICompositorInterop_CreateCompositionSurfaceForSwapChain                \
  __x_ABI_CWindows_CUI_CComposition_CICompositorInterop_CreateCompositionSurfaceForSwapChain
