...
DEFINE_GUID(IID_IEnumGUID, 0x0002e000, 0x0000, 0x0000, 0xc0, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x46);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("0002e000-0000-0000-c000-000000000046")
IEnumGUID : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE Next(ULONG celt, GUID * rgelt,
                                         ULONG * pceltFetched) = 0;
  virtual HRESULT STDMETHODCALLTYPE Skip(ULONG celt) = 0;
  virtual HRESULT STDMETHODCALLTYPE Reset() = 0;
  virtual HRESULT STDMETHODCALLTYPE Clone(IEnumGUID * *ppenum) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IEnumGUID, 0x0002e000, 0x0000, 0x0000, 0xc0, 0x00, 0x00, 0x00,
                0x00, 0x00, 0x00, 0x46)
#endif
#else
typedef struct IEnumGUIDVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IEnumGUID *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IEnumGUID *This);
  ULONG(STDMETHODCALLTYPE *Release)(IEnumGUID *This);
  /*** IEnumGUID methods ***/
  HRESULT(STDMETHODCALLTYPE *Next)(IEnumGUID *This, ULONG celt, GUID *rgelt,
                                   ULONG *pceltFetched);
...
interface IEnumGUID { CONST_VTBL IEnumGUIDVtbl *lpVtbl; };
#ifdef COBJMACROS
...
#else
/*** IUnknown methods ***/
static inline HRESULT IEnumGUID_QueryInterface(IEnumGUID *This, REFIID riid,
                                               void **ppvObject) {
...
/*** IEnumGUID methods ***/
static inline HRESULT IEnumGUID_Next(IEnumGUID *This, ULONG celt, GUID *rgelt,
                                     ULONG *pceltFetched) {
...
#endif
#endif
HRESULT STDMETHODCALLTYPE IEnumGUID_RemoteNext_Proxy(IEnumGUID *This,
                                                     ULONG celt, GUID *rgelt,
                                                     ULONG *pceltFetched);
void __RPC_STUB IEnumGUID_RemoteNext_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *pRpcChannelBuffer,
                                          PRPC_MESSAGE pRpcMessage,
                                          DWORD *pdwStubPhase);
HRESULT CALLBACK IEnumGUID_Next_Proxy(IEnumGUID *This, ULONG celt, GUID *rgelt,
                                      ULONG *pceltFetched);
HRESULT __RPC_STUB IEnumGUID_Next_Stub(IEnumGUID *This, ULONG celt, GUID *rgelt,
                                       ULONG *pceltFetched);
...
DEFINE_GUID(IID_IEnumCATEGORYINFO, 0x0002e011, 0x0000, 0x0000, 0xc0, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x46);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("0002e011-0000-0000-c000-000000000046")
IEnumCATEGORYINFO : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE Next(ULONG celt, CATEGORYINFO * rgelt,
                                         ULONG * pceltFetched) = 0;
  virtual HRESULT STDMETHODCALLTYPE Skip(ULONG celt) = 0;
  virtual HRESULT STDMETHODCALLTYPE Reset() = 0;
  virtual HRESULT STDMETHODCALLTYPE Clone(IEnumCATEGORYINFO * *ppenum) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IEnumCATEGORYINFO, 0x0002e011, 0x0000, 0x0000, 0xc0, 0x00, 0x00,
                0x00, 0x00, 0x00, 0x00, 0x46)
#endif
#else
typedef struct IEnumCATEGORYINFOVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IEnumCATEGORYINFO *This,
  ...
  HRESULT(STDMETHODCALLTYPE *Next)(IEnumCATEGORYINFO *This, ULONG celt,
  ...
  HRESULT(STDMETHODCALLTYPE *Clone)(IEnumCATEGORYINFO *This,
                                    IEnumCATEGORYINFO **ppenum);
  END_INTERFACE
} IEnumCATEGORYINFOVtbl;
interface IEnumCATEGORYINFO { CONST_VTBL IEnumCATEGORYINFOVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IEnumCATEGORYINFO_QueryInterface(IEnumCATEGORYINFO *This,
                                                       REFIID riid,
                                                       void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IEnumCATEGORYINFO methods ***/
static inline HRESULT IEnumCATEGORYINFO_Next(IEnumCATEGORYINFO *This,
                                             ULONG celt, CATEGORYINFO *rgelt,
                                             ULONG *pceltFetched) {
  return This->lpVtbl->Next(This, celt, rgelt, pceltFetched);
}
static inline HRESULT IEnumCATEGORYINFO_Skip(IEnumCATEGORYINFO *This,
                                             ULONG celt) {
  return This->lpVtbl->Skip(This, celt);
}
...
static inline HRESULT IEnumCATEGORYINFO_Clone(IEnumCATEGORYINFO *This,
                                              IEnumCATEGORYINFO **ppenum) {
  return This->lpVtbl->Clone(This, ppenum);
}
#endif
...
DEFINE_GUID(IID_ICatRegister, 0x0002e012, 0x0000, 0x0000, 0xc0, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x46);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
ICatRegister : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE RegisterCategories(
      ULONG cCategories, CATEGORYINFO rgCategoryInfo[]) = 0;
  virtual HRESULT STDMETHODCALLTYPE UnRegisterCategories(ULONG cCategories,
                                                         CATID rgcatid[]) = 0;
  virtual HRESULT STDMETHODCALLTYPE RegisterClassImplCategories(
      REFCLSID rclsid, ULONG cCategories, CATID rgcatid[]) = 0;
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ICatRegister, 0x0002e012, 0x0000, 0x0000, 0xc0, 0x00, 0x00,
                0x00, 0x00, 0x00, 0x00, 0x46)
#endif
#else
typedef struct ICatRegisterVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ICatRegister *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(ICatRegister *This);
  ULONG(STDMETHODCALLTYPE *Release)(ICatRegister *This);
  /*** ICatRegister methods ***/
  HRESULT(STDMETHODCALLTYPE *RegisterCategories)(ICatRegister *This,
                                                 ULONG cCategories,
                                                 CATEGORYINFO rgCategoryInfo[]);
  HRESULT(STDMETHODCALLTYPE *UnRegisterCategories)(ICatRegister *This,
                                                   ULONG cCategories,
                                                   CATID rgcatid[]);
  HRESULT(STDMETHODCALLTYPE *RegisterClassImplCategories)(ICatRegister *This,
                                                          REFCLSID rclsid,
                                                          ULONG cCategories,
                                                          CATID rgcatid[]);
  HRESULT(STDMETHODCALLTYPE *UnRegisterClassImplCategories)(ICatRegister *This,
                                                            REFCLSID rclsid,
                                                            ULONG cCategories,
                                                            CATID rgcatid[]);
  HRESULT(STDMETHODCALLTYPE *RegisterClassReqCategories)(ICatRegister *This,
                                                         REFCLSID rclsid,
                                                         ULONG cCategories,
                                                         CATID rgcatid[]);
  HRESULT(STDMETHODCALLTYPE *UnRegisterClassReqCategories)(ICatRegister *This,
                                                           REFCLSID rclsid,
                                                           ULONG cCategories,
                                                           CATID rgcatid[]);
  END_INTERFACE
} ICatRegisterVtbl;
interface ICatRegister { CONST_VTBL ICatRegisterVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define ICatRegister_RegisterClassImplCategories(This, rclsid, cCategories,    \
                                                 rgcatid)                      \
  (This)->lpVtbl->RegisterClassImplCategories(This, rclsid, cCategories,       \
                                              rgcatid)
#define ICatRegister_UnRegisterClassImplCategories(This, rclsid, cCategories,  \
                                                   rgcatid)                    \
  (This)->lpVtbl->UnRegisterClassImplCategories(This, rclsid, cCategories,     \
                                                rgcatid)
#define ICatRegister_RegisterClassReqCategories(This, rclsid, cCategories,     \
                                                rgcatid)                       \
  (This)->lpVtbl->RegisterClassReqCategories(This, rclsid, cCategories, rgcatid)
#define ICatRegister_UnRegisterClassReqCategories(This, rclsid, cCategories,   \
                                                  rgcatid)                     \
  (This)->lpVtbl->UnRegisterClassReqCategories(This, rclsid, cCategories,      \
                                               rgcatid)
#else
/*** IUnknown methods ***/
static inline HRESULT
ICatRegister_QueryInterface(ICatRegister *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ICatRegister methods ***/
static inline HRESULT
ICatRegister_RegisterCategories(ICatRegister *This, ULONG cCategories,
                                CATEGORYINFO rgCategoryInfo[]) {
  return This->lpVtbl->RegisterCategories(This, cCategories, rgCategoryInfo);
}
static inline HRESULT ICatRegister_UnRegisterCategories(ICatRegister *This,
                                                        ULONG cCategories,
                                                        CATID rgcatid[]) {
  return This->lpVtbl->UnRegisterCategories(This, cCategories, rgcatid);
}
static inline HRESULT
ICatRegister_RegisterClassImplCategories(ICatRegister *This, REFCLSID rclsid,
                                         ULONG cCategories, CATID rgcatid[]) {
  return This->lpVtbl->RegisterClassImplCategories(This, rclsid, cCategories,
                                                   rgcatid);
}
static inline HRESULT
ICatRegister_UnRegisterClassImplCategories(ICatRegister *This, REFCLSID rclsid,
                                           ULONG cCategories, CATID rgcatid[]) {
  return This->lpVtbl->UnRegisterClassImplCategories(This, rclsid, cCategories,
                                                     rgcatid);
}
static inline HRESULT
ICatRegister_RegisterClassReqCategories(ICatRegister *This, REFCLSID rclsid,
                                        ULONG cCategories, CATID rgcatid[]) {
  return This->lpVtbl->RegisterClassReqCategories(This, rclsid, cCategories,
                                                  rgcatid);
}
static inline HRESULT
ICatRegister_UnRegisterClassReqCategories(ICatRegister *This, REFCLSID rclsid,
                                          ULONG cCategories, CATID rgcatid[]) {
  return This->lpVtbl->UnRegisterClassReqCategories(This, rclsid, cCategories,
                                                    rgcatid);
}
#endif
#endif
...
DEFINE_GUID(IID_ICatInformation, 0x0002e013, 0x0000, 0x0000, 0xc0, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x46);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
ICatInformation : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE EnumCategories(
      LCID lcid, IEnumCATEGORYINFO * *ppenumCategoryInfo) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetCategoryDesc(REFCATID rcatid, LCID lcid,
                                                    LPWSTR * pszDesc) = 0;
  virtual HRESULT STDMETHODCALLTYPE EnumClassesOfCategories(
      ULONG cImplemented, const CATID rgcatidImpl[], ULONG cRequired,
      const CATID rgcatidReq[], IEnumGUID **ppenumClsid) = 0;
  virtual HRESULT STDMETHODCALLTYPE IsClassOfCategories(
      REFCLSID rclsid, ULONG cImplemented, const CATID rgcatidImpl[],
      ULONG cRequired, const CATID rgcatidReq[]) = 0;
  virtual HRESULT STDMETHODCALLTYPE EnumImplCategoriesOfClass(
      REFCLSID rclsid, IEnumGUID * *ppenumCatid) = 0;
  virtual HRESULT STDMETHODCALLTYPE EnumReqCategoriesOfClass(
      REFCLSID rclsid, IEnumGUID * *ppenumCatid) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ICatInformation, 0x0002e013, 0x0000, 0x0000, 0xc0, 0x00, 0x00,
                0x00, 0x00, 0x00, 0x00, 0x46)
#endif
#else
typedef struct ICatInformationVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ICatInformation *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *EnumCategories)(
      ICatInformation *This, LCID lcid, IEnumCATEGORYINFO **ppenumCategoryInfo);
  HRESULT(STDMETHODCALLTYPE *GetCategoryDesc)(ICatInformation *This,
                                              REFCATID rcatid, LCID lcid,
                                              LPWSTR *pszDesc);
  HRESULT(STDMETHODCALLTYPE *EnumClassesOfCategories)(
      ICatInformation *This, ULONG cImplemented, const CATID rgcatidImpl[],
      ULONG cRequired, const CATID rgcatidReq[], IEnumGUID **ppenumClsid);
  HRESULT(STDMETHODCALLTYPE *IsClassOfCategories)(
      ICatInformation *This, REFCLSID rclsid, ULONG cImplemented,
      const CATID rgcatidImpl[], ULONG cRequired, const CATID rgcatidReq[]);
  HRESULT(STDMETHODCALLTYPE *EnumImplCategoriesOfClass)(
      ICatInformation *This, REFCLSID rclsid, IEnumGUID **ppenumCatid);
  HRESULT(STDMETHODCALLTYPE *EnumReqCategoriesOfClass)(ICatInformation *This,
                                                       REFCLSID rclsid,
                                                       IEnumGUID **ppenumCatid);
  END_INTERFACE
} ICatInformationVtbl;
interface ICatInformation { CONST_VTBL ICatInformationVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define ICatInformation_EnumClassesOfCategories(                               \
    This, cImplemented, rgcatidImpl, cRequired, rgcatidReq, ppenumClsid)       \
  (This)->lpVtbl->EnumClassesOfCategories(This, cImplemented, rgcatidImpl,     \
                                          cRequired, rgcatidReq, ppenumClsid)
#define ICatInformation_IsClassOfCategories(                                   \
    This, rclsid, cImplemented, rgcatidImpl, cRequired, rgcatidReq)            \
  (This)->lpVtbl->IsClassOfCategories(This, rclsid, cImplemented, rgcatidImpl, \
...
#else
/*** IUnknown methods ***/
static inline HRESULT ICatInformation_QueryInterface(ICatInformation *This,
                                                     REFIID riid,
                                                     void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ICatInformation methods ***/
static inline HRESULT
ICatInformation_EnumCategories(ICatInformation *This, LCID lcid,
                               IEnumCATEGORYINFO **ppenumCategoryInfo) {
  return This->lpVtbl->EnumCategories(This, lcid, ppenumCategoryInfo);
}
static inline HRESULT ICatInformation_GetCategoryDesc(ICatInformation *This,
                                                      REFCATID rcatid,
                                                      LCID lcid,
                                                      LPWSTR *pszDesc) {
  return This->lpVtbl->GetCategoryDesc(This, rcatid, lcid, pszDesc);
}
static inline HRESULT ICatInformation_EnumClassesOfCategories(
    ICatInformation *This, ULONG cImplemented, const CATID rgcatidImpl[],
    ULONG cRequired, const CATID rgcatidReq[], IEnumGUID **ppenumClsid) {
  return This->lpVtbl->EnumClassesOfCategories(
      This, cImplemented, rgcatidImpl, cRequired, rgcatidReq, ppenumClsid);
}
static inline HRESULT ICatInformation_IsClassOfCategories(
    ICatInformation *This, REFCLSID rclsid, ULONG cImplemented,
    const CATID rgcatidImpl[], ULONG cRequired, const CATID rgcatidReq[]) {
  return This->lpVtbl->IsClassOfCategories(This, rclsid, cImplemented,
                                           rgcatidImpl, cRequired, rgcatidReq);
}
static inline HRESULT ICatInformation_EnumImplCategoriesOfClass(
    ICatInformation *This, REFCLSID rclsid, IEnumGUID **ppenumCatid) {
  return This->lpVtbl->EnumImplCategoriesOfClass(This, rclsid, ppenumCatid);
}
static inline HRESULT
ICatInformation_EnumReqCategoriesOfClass(ICatInformation *This, REFCLSID rclsid,
                                         IEnumGUID **ppenumCatid) {
