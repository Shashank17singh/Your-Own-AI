...
DEFINE_GUID(IID_IDMOWrapperFilter, 0x52d6f586, 0x9f0f, 0x4824, 0x8f, 0xc8, 0xe3,
            0x2c, 0xa0, 0x49, 0x30, 0xc2);
...
__CRT_UUID_DECL(IDMOWrapperFilter, 0x52d6f586, 0x9f0f, 0x4824, 0x8f, 0xc8, 0xe3,
                0x2c, 0xa0, 0x49, 0x30, 0xc2)
#endif
#else
...
interface IDMOWrapperFilter { CONST_VTBL IDMOWrapperFilterVtbl *lpVtbl; };
#ifdef COBJMACROS
...
#else
/*** IUnknown methods ***/
static inline HRESULT IDMOWrapperFilter_QueryInterface(IDMOWrapperFilter *This,
                                                       REFIID riid,
                                                       void **ppvObject) {
...
/*** IDMOWrapperFilter methods ***/
static inline HRESULT IDMOWrapperFilter_Init(IDMOWrapperFilter *This,
                                             REFCLSID clsidDMO,
                                             REFCLSID catDMO) {
