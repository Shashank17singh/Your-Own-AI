...
typedef struct IDvbHDSimulcastLogicalChannelDescriptor
...
typedef struct IDvbMultilingualServiceNameDescriptor
...
typedef struct IDvbPrivateDataSpecifierDescriptor
...
#endif
/* Guessed from:
 * http://www.java2s.com/Open-Source/CSharp/Game/DirectShow/DirectShowLib/BDA/dvbsiparser.cs.htm
 */
...
DECLARE_INTERFACE_(IDVB_EIT, IUnknown) {
  ...
  STDMETHOD_(HRESULT, GetRecordCountOfDescriptors)(THIS_ DWORD dwRecordIndex,
                                                   DWORD * pdwVal) PURE;
  STDMETHOD_(HRESULT, GetRecordDescriptorByIndex)(
      THIS_ DWORD dwRecordIndex, DWORD dwIndex,
      IGenericDescriptor * *ppDescriptor) PURE;
  STDMETHOD_(HRESULT, GetRecordDescriptorByTag)(
      THIS_ DWORD dwRecordIndex, BYTE bTag, DWORD * pdwCookie,
      IGenericDescriptor * *ppDescriptor) PURE;
  STDMETHOD_(HRESULT, GetRecordDuration)(THIS_ DWORD dwRecordIndex,
                                         MPEG_DURATION * pmdVal) PURE;
  STDMETHOD_(HRESULT, GetRecordEventId)(THIS_ DWORD dwRecordIndex, WORD * pwVal)
      PURE;
  STDMETHOD_(HRESULT, GetRecordFreeCAMode)(THIS_ DWORD dwRecordIndex,
                                           WINBOOL * pfVal) PURE;
  STDMETHOD_(HRESULT, GetRecordRunningStatus)(THIS_ DWORD dwRecordIndex,
                                              BYTE * pbVal) PURE;
  STDMETHOD_(HRESULT, GetRecordStartTime)(THIS_ DWORD dwRecordIndex,
                                          MPEG_DATE_AND_TIME * pmdtVal) PURE;
  ...
  STDMETHOD_(HRESULT, Initialize)(THIS_ ISectionList * pSectionList,
                                  IMpeg2Data * pMPEGData) PURE;
  STDMETHOD_(HRESULT, RegisterForNextTable)(THIS_ HANDLE hNextTableAvailable)
      PURE;
  STDMETHOD_(HRESULT, RegisterForWhenCurrent)(THIS_ HANDLE hNextTableIsCurrent)
      PURE;
  END_INTERFACE
};
#ifdef COBJMACROS
...
#define IDVB_EIT_ConvertNextToCurrent()                                        \
...
#define IDVB_EIT_GetRecordDescriptorByIndex(This, dwRecordIndex, dwIndex,      \
                                            ppDescriptor)                      \
  (This)->lpVtbl->GetRecordDescriptorByIndex(This, dwRecordIndex, dwIndex,     \
                                             ppDescriptor)
#define IDVB_EIT_GetRecordDescriptorByTag(This, dwRecordIndex, bTag,           \
                                          pdwCookie, ppDescriptor)             \
  (This)->lpVtbl->GetRecordDescriptorByTag(This, dwRecordIndex, bTag,          \
                                           pdwCookie, ppDescriptor)
...
#define IDVB_EIT_GetVersionHash(This, pbVal)                                   \
  (This)->lpVtbl->GetVersionHash(This, pbVal)
...
#define IDVB_EIT2_GetRecordCountOfDescriptors(This, dwRecordIndex, pdwVal)     \
  (This)->lpVtbl->GetRecordCountOfDescriptors(This, dwRecordIndex, pdwVal)
#define IDVB_EIT2_GetRecordDescriptorByIndex(This, dwRecordIndex, dwIndex,     \
                                             ppDescriptor)                     \
  (This)->lpVtbl->GetRecordDescriptorByIndex(This, dwRecordIndex, dwIndex,     \
                                             ppDescriptor)
#define IDVB_EIT2_GetRecordDescriptorByTag(This, dwRecordIndex, bTag,          \
                                           pdwCookie, ppDescriptor)            \
  (This)->lpVtbl->GetRecordDescriptorByTag(This, dwRecordIndex, bTag,          \
                                           pdwCookie, ppDescriptor)
...
#define IDVB_EIT2_GetTransportStreamId(This, pwVal)                            \
  (This)->lpVtbl->GetTransportStreamId(This, pwVal)
#define IDVB_EIT2_GetVersionHash(This, pbVal)                                  \
  (This)->lpVtbl->GetVersionHash(This, pbVal)
...
DECLARE_INTERFACE_(IDvbComponentDescriptor, IUnknown) {
  ...
  STDMETHOD_(HRESULT, GetTextW)(THIS_ DVB_STRCONV_MODE convMode,
                                BSTR * pbstrText) PURE;
  END_INTERFACE
};
#ifdef COBJMACROS
...
DECLARE_INTERFACE_(IDvbContentDescriptor, IUnknown) {
  ...
  STDMETHOD_(HRESULT, GetLength)(THIS_ BYTE * pbVal) PURE;
  STDMETHOD_(HRESULT, GetRecordContentNibbles)(
      THIS_ BYTE bRecordIndex, BYTE * pbValLevel1, BYTE * pbValLevel2) PURE;
  STDMETHOD_(HRESULT, GetRecordUserNibbles)(THIS_ BYTE bRecordIndex,
                                            BYTE * pbVal1, BYTE * pbVal2) PURE;
  STDMETHOD_(HRESULT, GetTag)(THIS_ BYTE * pbVal) PURE;
  END_INTERFACE
};
#ifdef COBJMACROS
...
#define IDvbContentDescriptor_GetLength(This, pbVal)                           \
  (This)->lpVtbl->GetLength(This, pbVal)
#define IDvbContentDescriptor_GetRecordContentNibbles(                         \
    This, bRecordIndex, pbValLevel1, pbValLevel2)                              \
  (This)->lpVtbl->GetRecordContentNibbles(This, bRecordIndex, pbValLevel1,     \
                                          pbValLevel2)
#define IDvbContentDescriptor_GetRecordUserNibbles(This, bRecordIndex, pbVal1, \
                                                   pbVal2)                     \
...
DECLARE_INTERFACE_(IDvbContentIdentifierDescriptor, IUnknown) {
  ...
  STDMETHOD_(HRESULT, GetCountOfRecords)(THIS_ BYTE * pbVal) PURE;
  STDMETHOD_(HRESULT, GetLength)(THIS_ BYTE * pbVal) PURE;
  STDMETHOD_(HRESULT, GetRecordCrid)(THIS_ BYTE bRecordIndex, BYTE * pbType,
                                     BYTE * pbLocation, BYTE * pbLength,
                                     BYTE * *ppbBytes) PURE;
  STDMETHOD_(HRESULT, GetTag)(THIS_ BYTE * pbVal) PURE;
  END_INTERFACE
};
...
#define IDvbContentIdentifierDescriptor_GetLength(This, pbVal)                 \
  (This)->lpVtbl->GetLength(This, pbVal)
#define IDvbContentIdentifierDescriptor_GetRecordCrid(                         \
    This, bRecordIndex, pbType, pbLocation, pbLength, ppbBytes)                \
  (This)->lpVtbl->GetRecordCrid(This, bRecordIndex, pbType, pbLocation,        \
                                pbLength, ppbBytes)
...
DECLARE_INTERFACE_(IDvbDataBroadcastIDDescriptor, IUnknown) {
  ...
  STDMETHOD_(HRESULT, GetDataBroadcastID)(THIS_ WORD * pwVal) PURE;
  STDMETHOD_(HRESULT, GetIDSelectorBytes)(THIS_ BYTE * pbLen, BYTE * pbVal)
      PURE;
  STDMETHOD_(HRESULT, GetLength)(THIS_ BYTE * pbVal) PURE;
  STDMETHOD_(HRESULT, GetTag)(THIS_ BYTE * pbVal) PURE;
  END_INTERFACE
...
DECLARE_INTERFACE_(IDvbDefaultAuthorityDescriptor, IUnknown) {
  ...
  STDMETHOD_(HRESULT, GetDefaultAuthority)(THIS_ BYTE * pbLength,
                                           BYTE * *ppbBytes) PURE;
  STDMETHOD_(HRESULT, GetLength)(THIS_ BYTE * pbVal) PURE;
  STDMETHOD_(HRESULT, GetTag)(THIS_ BYTE * pbVal) PURE;
  END_INTERFACE
...
#define IDvbDefaultAuthorityDescriptor_Release(This)                           \
  (This)->lpVtbl->Release(This)
#define IDvbDefaultAuthorityDescriptor_GetDefaultAuthority(This, pbLength,     \
                                                           ppbBytes)           \
...
DECLARE_INTERFACE_(IDvbExtendedEventDescriptor, IUnknown) {
  ...
  STDMETHOD_(HRESULT, GetConcatenatedItemW)(
      THIS_ IDvbExtendedEventDescriptor * pFollowingDescriptor,
      DVB_STRCONV_MODE convMode, BSTR * pbstrDesc, BSTR * pbstrItem) PURE;
  STDMETHOD_(HRESULT, GetConcatenatedTextW)(
      THIS_ IDvbExtendedEventDescriptor * FollowingDescriptor,
      DVB_STRCONV_MODE convMode, BSTR * pbstrText) PURE;
  STDMETHOD_(HRESULT, GetCountOfRecords)(THIS_ BYTE * pbVal) PURE;
  ...
  STDMETHOD_(HRESULT, GetLength)(THIS_ BYTE * pbVal) PURE;
  STDMETHOD_(HRESULT, GetRecordItemRawBytes)(
      THIS_ BYTE bRecordIndex, BYTE * *ppbRawItem, BYTE * pbItemLength) PURE;
  STDMETHOD_(HRESULT, GetRecordItemW)(THIS_ BYTE bRecordIndex,
                                      DVB_STRCONV_MODE convMode,
                                      BSTR * pbstrDesc, BSTR * pbstrItem) PURE;
  STDMETHOD_(HRESULT, GetTag)(THIS_ BYTE * pbVal) PURE;
  STDMETHOD_(HRESULT, GetTextW)(THIS_ DVB_STRCONV_MODE convMode,
                                BSTR * pbstrText) PURE;
  END_INTERFACE
...
#define IDvbExtendedEventDescriptor_GetConcatenatedItemW(                      \
    This, pFollowingDescriptor, convMode, pbstrDesc, pbstrItem)                \
  (This)->lpVtbl->GetConcatenatedItemW(This, pFollowingDescriptor, convMode,   \
                                       pbstrDesc, pbstrItem)
#define IDvbExtendedEventDescriptor_GetConcatenatedTextW(                      \
    This, FollowingDescriptor, convMode, pbstrText)                            \
...
#define IDvbExtendedEventDescriptor_GetLength(This, pbVal)                     \
  (This)->lpVtbl->GetLength(This, pbVal)
#define IDvbExtendedEventDescriptor_GetRecordItemRawBytes(                     \
    This, bRecordIndex, ppbRawItem, pbItemLength)                              \
  (This)->lpVtbl->GetRecordItemRawBytes(This, bRecordIndex, ppbRawItem,        \
                                        pbItemLength)
#define IDvbExtendedEventDescriptor_GetRecordItemW(                            \
    This, bRecordIndex, convMode, pbstrDesc, pbstrItem)                        \
  (This)->lpVtbl->GetRecordItemW(This, bRecordIndex, convMode, pbstrDesc,      \
                                 pbstrItem)
...
DECLARE_INTERFACE_(IDvbLogicalChannelDescriptor, IUnknown) {
  ...
  STDMETHOD_(HRESULT, GetCountOfRecords)(THIS_ BYTE * pbVal) PURE;
  STDMETHOD_(HRESULT, GetLength)(THIS_ BYTE * pbVal) PURE;
  STDMETHOD_(HRESULT, GetRecordLogicalChannelNumber)(THIS_ BYTE bRecordIndex,
                                                     WORD * pwVal) PURE;
  STDMETHOD_(HRESULT, GetRecordServiceId)(THIS_ BYTE bRecordIndex, WORD * pwVal)
      PURE;
  STDMETHOD_(HRESULT, GetTag)(THIS_ BYTE * pbVal) PURE;
  END_INTERFACE
};
...
#define IDvbLogicalChannelDescriptor_GetRecordServiceId(This, bRecordIndex,    \
                                                        pwVal)                 \
...
__MINGW_BROKEN_INTERFACE(INTERFACE)
#endif
DECLARE_INTERFACE_(IDvbHDSimulcastLogicalChannelDescriptor,
...
#ifdef COBJMACROS
#define IDvbHDSimulcastLogicalChannelDescriptor_QueryInterface(This, riid,     \
                                                               ppvObject)      \
  (This)->lpVtbl->QueryInterface(This, riid, ppvObject)
...
__MINGW_BROKEN_INTERFACE(INTERFACE)
#endif
DECLARE_INTERFACE_(IDvbLogicalChannelDescriptor2,
                   IDvbLogicalChannelDescriptor) {
  BEGIN_INTERFACE
  /* IUnknown methods */
  STDMETHOD(QueryInterface)(THIS_ REFIID riid, void **ppvObject) PURE;
  ...
  STDMETHOD_(HRESULT, GetListRecordLogicalChannelAndVisibility)(
      THIS_ BYTE bListIndex, BYTE bRecordIndex, WORD * pwVal) PURE;
  END_INTERFACE
};
#ifdef COBJMACROS
...
#define IDvbLogicalChannelDescriptor2_GetRecordLogicalChannelNumber(           \
    This, bRecordIndex, pwVal)                                                 \
  (This)->lpVtbl->GetRecordLogicalChannelNumber(This, bRecordIndex, pwVal)
#define IDvbLogicalChannelDescriptor2_GetRecordServiceId(This, bRecordIndex,   \
                                                         pwVal)                \
  (This)->lpVtbl->GetRecordServiceId(This, bRecordIndex, pwVal)
#define IDvbLogicalChannelDescriptor2_GetTag(This, pbVal)                      \
  (This)->lpVtbl->GetTag(This, pbVal)
#define IDvbLogicalChannelDescriptor2_GetListRecordLogicalChannelAndVisibility( \
...
__MINGW_BROKEN_INTERFACE(INTERFACE)
#endif
DECLARE_INTERFACE_(IDvbLogicalChannel2Descriptor,
  ...
  STDMETHOD_(HRESULT, GetListCountOfRecords)(THIS_ BYTE bChannelListIndex,
                                             BYTE * pbVal) PURE;
  STDMETHOD_(HRESULT, GetListCountryCode)(THIS_ BYTE bListIndex, char *pszCode)
      PURE;
  STDMETHOD_(HRESULT, GetListId)(THIS_ BYTE bListIndex, BYTE * pbVal) PURE;
  STDMETHOD_(HRESULT, GetListNameW)(
      THIS_ BYTE bListIndex, DVB_STRCONV_MODE convMode, BSTR * pbstrName) PURE;
  STDMETHOD_(HRESULT, GetListRecordLogicalChannelNumber)(
      THIS_ BYTE bListIndex, BYTE bRecordIndex, WORD * pwVal) PURE;
  STDMETHOD_(HRESULT, GetListRecordServiceId)(
      THIS_ BYTE bListIndex, BYTE bRecordIndex, WORD * pwVal) PURE;
  END_INTERFACE
};
#ifdef COBJMACROS
...
#define IDvbLogicalChannel2Descriptor_GetRecordLogicalChannelNumber(           \
    This, bRecordIndex, pwVal)                                                 \
  (This)->lpVtbl->GetRecordLogicalChannelNumber(This, bRecordIndex, pwVal)
#define IDvbLogicalChannel2Descriptor_GetRecordServiceId(This, bRecordIndex,   \
                                                         pwVal)                \
  (This)->lpVtbl->GetRecordServiceId(This, bRecordIndex, pwVal)
...
#define IDvbLogicalChannel2Descriptor_GetListCountOfRecords(                   \
    This, bChannelListIndex, pbVal)                                            \
  (This)->lpVtbl->GetListCountOfRecords(This, bChannelListIndex, pbVal)
#define IDvbLogicalChannel2Descriptor_GetListCountryCode(This, bListIndex,     \
                                                         pszCode)              \
...
#define IDvbLogicalChannel2Descriptor_GetListNameW(This, bListIndex, convMode, \
                                                   pbstrName)                  \
  (This)->lpVtbl->GetListNameW(This, bListIndex, convMode, pbstrName)
#define IDvbLogicalChannel2Descriptor_GetListRecordLogicalChannelNumber(       \
    This, bListIndex, bRecordIndex, pwVal)                                     \
  (This)->lpVtbl->GetListRecordLogicalChannelNumber(This, bListIndex,          \
                                                    bRecordIndex, pwVal)
#define IDvbLogicalChannel2Descriptor_GetListRecordServiceId(                  \
    This, bListIndex, bRecordIndex, pwVal)                                     \
...
DECLARE_INTERFACE_(IDvbMultilingualServiceNameDescriptor, IUnknown) {
  ...
  STDMETHOD_(HRESULT, GetCountOfRecords)(THIS_ BYTE * pbVal) PURE;
  STDMETHOD_(HRESULT, GetLength)(THIS_ BYTE * pbVal) PURE;
  STDMETHOD_(HRESULT, GetRecordLangId)(THIS_ BYTE bRecordIndex, ULONG * ulVal)
      PURE;
  STDMETHOD_(HRESULT, GetRecordServiceNameW)(THIS_ BYTE bRecordIndex,
                                             DVB_STRCONV_MODE convMode,
                                             BSTR * pbstrName) PURE;
  STDMETHOD_(HRESULT, GetRecordServiceProviderNameW)(THIS_ BYTE bRecordIndex,
                                                     DVB_STRCONV_MODE convMode,
                                                     BSTR * pbstrName) PURE;
  STDMETHOD_(HRESULT, GetTag)(THIS_ BYTE * pbVal) PURE;
  END_INTERFACE
...
#ifdef COBJMACROS
#define IDvbMultilingualServiceNameDescriptor_QueryInterface(This, riid,       \
                                                             ppvObject)        \
  (This)->lpVtbl->QueryInterface(This, riid, ppvObject)
...
#define IDvbMultilingualServiceNameDescriptor_GetRecordLangId(                 \
    This, bRecordIndex, ulVal)                                                 \
  (This)->lpVtbl->GetRecordLangId(This, bRecordIndex, ulVal)
#define IDvbMultilingualServiceNameDescriptor_GetRecordServiceNameW(           \
    This, bRecordIndex, convMode, pbstrName)                                   \
  (This)->lpVtbl->GetRecordServiceNameW(This, bRecordIndex, convMode, pbstrName)
#define IDvbMultilingualServiceNameDescriptor_GetRecordServiceProviderNameW(   \
    This, bRecordIndex, convMode, pbstrName)                                   \
  (This)->lpVtbl->GetRecordServiceProviderNameW(This, bRecordIndex, convMode,  \
                                                pbstrName)
...
DECLARE_INTERFACE_(IDvbNetworkNameDescriptor, IUnknown) {
  ...
  STDMETHOD_(HRESULT, GetNetworkNameW)(THIS_ DVB_STRCONV_MODE convMode,
                                       BSTR * pbstrName) PURE;
  STDMETHOD_(HRESULT, GetTag)(THIS_ BYTE * pbVal) PURE;
  END_INTERFACE
};
...
DECLARE_INTERFACE_(IDvbParentalRatingDescriptor, IUnknown) {
  ...
  STDMETHOD_(HRESULT, GetCountOfRecords)(THIS_ BYTE * pbVal) PURE;
  STDMETHOD_(HRESULT, GetLength)(THIS_ BYTE * pbVal) PURE;
  STDMETHOD_(HRESULT, GetRecordRating)(THIS_ BYTE bRecordIndex,
                                       char *pszCountryCode, BYTE *pbVal) PURE;
  STDMETHOD_(HRESULT, GetTag)(THIS_ BYTE * pbVal) PURE;
  END_INTERFACE
};
#ifdef COBJMACROS
...
#define IDvbParentalRatingDescriptor_GetLength(This, pbVal)                    \
  (This)->lpVtbl->GetLength(This, pbVal)
#define IDvbParentalRatingDescriptor_GetRecordRating(This, bRecordIndex,       \
                                                     pszCountryCode, pbVal)    \
...
#ifdef COBJMACROS
#define IDvbPrivateDataSpecifierDescriptor_QueryInterface(This, riid,          \
                                                          ppvObject)           \
  (This)->lpVtbl->QueryInterface(This, riid, ppvObject)
...
#define IDvbPrivateDataSpecifierDescriptor_GetLength(This, pbVal)              \
  (This)->lpVtbl->GetLength(This, pbVal)
#define IDvbPrivateDataSpecifierDescriptor_GetPrivateDataSpecifier(This,       \
                                                                   pdwVal)     \
...
DECLARE_INTERFACE_(IDvbServiceDescriptor2, IDvbServiceDescriptor) {
  ...
  STDMETHOD_(HRESULT, GetServiceNameW)(THIS_ DVB_STRCONV_MODE convMode,
                                       BSTR * pbstrName) PURE;
  /* STDMETHOD_(HRESULT,GetServiceProviderNameW)(THIS_ DVB_STRCONV_MODE
   * convMode,BSTR *pbstrName) PURE; */
  END_INTERFACE
};
#ifdef COBJMACROS
...
#define IDvbServiceDescriptor2_GetServiceProviderNameW(This, convMode,         \
                                                       pbstrName)              \
...
DECLARE_INTERFACE_(IDvbShortEventDescriptor, IUnknown) {
  ...
  STDMETHOD_(HRESULT, GetEventNameW)(THIS_ DVB_STRCONV_MODE convMode,
                                     BSTR * pbstrName) PURE;
  STDMETHOD_(HRESULT, GetLanguageCode)(THIS_ char *pszCode) PURE;
  STDMETHOD_(HRESULT, GetLength)(THIS_ BYTE * pbVal) PURE;
  STDMETHOD_(HRESULT, GetTag)(THIS_ BYTE * pbVal) PURE;
...
DECLARE_INTERFACE_(IDvbSiParser, IUnknown) {
  ...
  STDMETHOD_(HRESULT, GetEIT)(THIS_ TID tableId, WORD * pwServiceId,
                              IDVB_EIT * *ppEIT) PURE;
  STDMETHOD_(HRESULT, GetNIT)(THIS_ TID tableId, WORD * pwNetworkId,
                              IDVB_NIT * *ppNIT) PURE;
  STDMETHOD_(HRESULT, GetPAT)(THIS_ IPAT * *ppPAT) PURE;
  STDMETHOD_(HRESULT, GetPMT)(THIS_ PID pid, WORD * pwProgramNumber,
                              IPMT * *ppPMT) PURE;
  STDMETHOD_(HRESULT, GetRST)(THIS_ DWORD dwTimeout, IDVB_RST * *ppRST) PURE;
  STDMETHOD_(HRESULT, GetSDT)(THIS_ TID tableId, WORD * pwTransportStreamId,
                              IDVB_SDT * *ppSDT) PURE;
  STDMETHOD_(HRESULT, GetSIT)(THIS_ DWORD dwTimeout, IDVB_SIT * *ppSIT) PURE;
  STDMETHOD_(HRESULT, GetST)(THIS_ PID pid, DWORD dwTimeout, IDVB_ST * *ppST)
      PURE;
...
DECLARE_INTERFACE_(IDVB_RST, IUnknown) {
  ...
  STDMETHOD_(HRESULT, GetRecordEventId)(THIS_ DWORD dwRecordIndex, WORD * pwVal)
      PURE;
  STDMETHOD_(HRESULT, GetRecordOriginalNetworkId)(THIS_ DWORD dwRecordIndex,
                                                  WORD * pwVal) PURE;
  STDMETHOD_(HRESULT, GetRecordRunningStatus)(THIS_ DWORD dwRecordIndex,
                                              BYTE * pbVal) PURE;
  STDMETHOD_(HRESULT, GetRecordServiceId)(THIS_ DWORD dwRecordIndex,
                                          WORD * pwVal) PURE;
  STDMETHOD_(HRESULT, GetRecordTransportStreamId)(THIS_ DWORD dwRecordIndex,
                                                  WORD * pwVal) PURE;
...
DECLARE_INTERFACE_(IDVB_SIT, IUnknown) {
  ...
  STDMETHOD_(HRESULT, GetNextTable)(THIS_ DWORD dwTimeout, IDVB_SIT * *ppSIT)
      PURE;
  STDMETHOD_(HRESULT, GetRecordCountOfDescriptors)(THIS_ DWORD dwRecordIndex,
                                                   DWORD * pdwVal) PURE;
  STDMETHOD_(HRESULT, GetRecordDescriptorByIndex)(
  ...
  STDMETHOD_(HRESULT, GetRecordServiceId)(THIS_ DWORD dwRecordIndex,
                                          WORD * pwVal) PURE;
  STDMETHOD_(HRESULT, GetTableDescriptorByIndex)(
      THIS_ DWORD dwIndex, IGenericDescriptor * *ppDescriptor) PURE;
  STDMETHOD_(HRESULT, GetTableDescriptorByTag)(
      THIS_ BYTE bTag, DWORD * pdwCookie, IGenericDescriptor * *ppDescriptor)
      PURE;
  STDMETHOD_(HRESULT, GetVersionNumber)(THIS_ BYTE * pbVal) PURE;
  STDMETHOD_(HRESULT, Initialize)(THIS_ ISectionList * pSectionList,
                                  IMpeg2Data * pMPEGData) PURE;
...
#define IDVB_SIT_ConvertNextToCurrent()                                        \
  (This)->lpVtbl->ConvertNextToCurrent(This)
...
#define IDVB_SIT_GetRecordCountOfDescriptors(This, dwRecordIndex, pdwVal)      \
  (This)->lpVtbl->GetRecordCountOfDescriptors(This, dwRecordIndex, pdwVal)
#define IDVB_SIT_GetRecordDescriptorByIndex(This, dwRecordIndex, dwIndex,      \
                                            ppDescriptor)                      \
  (This)->lpVtbl->GetRecordDescriptorByIndex(This, dwRecordIndex, dwIndex,     \
                                             ppDescriptor)
#define IDVB_SIT_GetRecordDescriptorByTag(This, dwRecordIndex, bTag,           \
                                          pdwCookie, ppDescriptor)             \
  (This)->lpVtbl->GetRecordDescriptorByTag(This, dwRecordIndex, bTag,          \
                                           pdwCookie, ppDescriptor)
...
DECLARE_INTERFACE_(IDvbSiParser2, IDvbSiParser) {
  ...
  STDMETHOD_(HRESULT, GetEIT2)(THIS_ TID tableId, WORD * pwServiceId,
                               BYTE * pbSegment, IDVB_EIT2 * *ppEIT) PURE;
  END_INTERFACE
};
#ifdef COBJMACROS
...
DECLARE_INTERFACE_(IDvbSubtitlingDescriptor, IUnknown) {
  ...
  STDMETHOD_(HRESULT, GetCountOfRecords)(THIS_ BYTE * pbVal) PURE;
  STDMETHOD_(HRESULT, GetLength)(THIS_ BYTE * pbVal) PURE;
  STDMETHOD_(HRESULT, GetRecordAncillaryPageID)(THIS_ BYTE bRecordIndex,
                                                WORD * pwVal) PURE;
  STDMETHOD_(HRESULT, GetRecordCompositionPageID)(THIS_ BYTE bRecordIndex,
                                                  WORD * pwVal) PURE;
  STDMETHOD_(HRESULT, GetRecordLangId)(THIS_ BYTE bRecordIndex, ULONG * pulVal)
      PURE;
  STDMETHOD_(HRESULT, GetRecordSubtitlingType)(THIS_ BYTE bRecordIndex,
                                               BYTE * pbVal) PURE;
  STDMETHOD_(HRESULT, GetTag)(THIS_ BYTE * pbVal) PURE;
  END_INTERFACE
};
...
#define IDvbSubtitlingDescriptor_GetLength(This, pbVal)                        \
  (This)->lpVtbl->GetLength(This, pbVal)
#define IDvbSubtitlingDescriptor_GetRecordAncillaryPageID(This, bRecordIndex,  \
                                                          pwVal)               \
  (This)->lpVtbl->GetRecordAncillaryPageID(This, bRecordIndex, pwVal)
#define IDvbSubtitlingDescriptor_GetRecordCompositionPageID(                   \
    This, bRecordIndex, pwVal)                                                 \
...
#define IDvbSubtitlingDescriptor_GetRecordSubtitlingType(This, bRecordIndex,   \
                                                         pbVal)                \
...
DECLARE_INTERFACE_(IDvbServiceListDescriptor, IUnknown) {
  ...
  STDMETHOD_(HRESULT, GetRecordServiceId)(THIS_ BYTE bRecordIndex, WORD * pwVal)
      PURE;
  STDMETHOD_(HRESULT, GetRecordServiceType)(THIS_ BYTE bRecordIndex,
                                            BYTE * pbVal) PURE;
  STDMETHOD_(HRESULT, GetTag)(THIS_ BYTE * pbVal) PURE;
  END_INTERFACE
};
...
#define IDvbServiceListDescriptor_GetLength(This, pbVal)                       \
  (This)->lpVtbl->GetLength(This, pbVal)
#define IDvbServiceListDescriptor_GetRecordServiceId(This, bRecordIndex,       \
                                                     pwVal)                    \
  (This)->lpVtbl->GetRecordServiceId(This, bRecordIndex, pwVal)
#define IDvbServiceListDescriptor_GetRecordServiceType(This, bRecordIndex,     \
                                                       pbVal)                  \
...
DECLARE_INTERFACE_(IDvbTeletextDescriptor, IUnknown) {
  ...
  STDMETHOD_(HRESULT, GetRecordLangId)(THIS_ BYTE bRecordIndex, ULONG * pulVal)
      PURE;
  STDMETHOD_(HRESULT, GetRecordMagazineNumber)(THIS_ BYTE bRecordIndex,
                                               BYTE * pbVal) PURE;
  STDMETHOD_(HRESULT, GetRecordPageNumber)(THIS_ BYTE bRecordIndex,
                                           BYTE * pbVal) PURE;
  STDMETHOD_(HRESULT, GetRecordTeletextType)(THIS_ BYTE bRecordIndex,
                                             BYTE * pbVal) PURE;
  STDMETHOD_(HRESULT, GetTag)(THIS_ BYTE * pbVal) PURE;
  END_INTERFACE
};
...
#define IDvbTeletextDescriptor_GetRecordLangId(This, bRecordIndex, pulVal)     \
  (This)->lpVtbl->GetRecordLangId(This, bRecordIndex, pulVal)
#define IDvbTeletextDescriptor_GetRecordMagazineNumber(This, bRecordIndex,     \
                                                       pbVal)                  \
...
#define IDvbTeletextDescriptor_GetRecordTeletextType(This, bRecordIndex,       \
                                                     pbVal)                    \
...
#define IDVB_BAT_GetRecordCountOfDescriptors(This, dwRecordIndex, pdwVal)      \
  (This)->lpVtbl->GetRecordCountOfDescriptors(This, dwRecordIndex, pdwVal)
#define IDVB_BAT_GetRecordDescriptorByIndex(This, dwRecordIndex, dwIndex,      \
                                            ppDescriptor)                      \
  (This)->lpVtbl->GetRecordDescriptorByIndex(This, dwRecordIndex, dwIndex,     \
                                             ppDescriptor)
#define IDVB_BAT_GetRecordDescriptorByTag(This, dwRecordIndex, bTag,           \
                                          pdwCookie, ppDescriptor)             \
  (This)->lpVtbl->GetRecordDescriptorByTag(This, dwRecordIndex, bTag,          \
                                           pdwCookie, ppDescriptor)
...
#define IDVB_NIT_ConvertNextToCurrent()                                        \
  (This)->lpVtbl->ConvertNextToCurrent(This)
...
#define IDVB_NIT_GetRecordCountOfDescriptors(This, dwRecordIndex, pdwVal)      \
  (This)->lpVtbl->GetRecordCountOfDescriptors(This, dwRecordIndex, pdwVal)
#define IDVB_NIT_GetRecordDescriptorByIndex(This, dwRecordIndex, dwIndex,      \
                                            ppDescriptor)                      \
  (This)->lpVtbl->GetRecordDescriptorByIndex(This, dwRecordIndex, dwIndex,     \
                                             ppDescriptor)
#define IDVB_NIT_GetRecordDescriptorByTag(This, dwRecordIndex, bTag,           \
                                          pdwCookie, ppDescriptor)             \
  (This)->lpVtbl->GetRecordDescriptorByTag(This, dwRecordIndex, bTag,          \
                                           pdwCookie, ppDescriptor)
...
#define IDVB_NIT_GetTableDescriptorByTag(This, bTag, pdwCookie, ppDescriptor)  \
  (This)->lpVtbl->GetTableDescriptorByTag(This, bTag, pdwCookie, ppDescriptor)
#define IDVB_NIT_GetVersionHash(This, pbVal)                                   \
  (This)->lpVtbl->GetVersionHash(This, pbVal)
...
DECLARE_INTERFACE_(IDVB_SDT, IUnknown) {
  ...
  STDMETHOD_(HRESULT, GetRecordDescriptorByTag)(
      THIS_ DWORD dwRecordIndex, BYTE bTag, DWORD * pdwCookie,
      IGenericDescriptor * *ppDescriptor) PURE;
  STDMETHOD_(HRESULT, GetRecordEITPresentFollowingFlag)(
      THIS_ DWORD dwRecordIndex, WINBOOL * pfVal) PURE;
  STDMETHOD_(HRESULT, GetRecordEITScheduleFlag)(THIS_ DWORD dwRecordIndex,
                                                WINBOOL * pfVal) PURE;
  STDMETHOD_(HRESULT, GetRecordFreeCAMode)(THIS_ DWORD dwRecordIndex,
                                           WINBOOL * pfVal) PURE;
  STDMETHOD_(HRESULT, GetRecordRunningStatus)(THIS_ DWORD dwRecordIndex,
...
#define IDVB_SDT_ConvertNextToCurrent()                                        \
  (This)->lpVtbl->ConvertNextToCurrent(This)
...
#define IDVB_SDT_GetRecordCountOfDescriptors(This, dwRecordIndex, pdwVal)      \
  (This)->lpVtbl->GetRecordCountOfDescriptors(This, dwRecordIndex, pdwVal)
#define IDVB_SDT_GetRecordDescriptorByIndex(This, dwRecordIndex, dwIndex,      \
                                            ppDescriptor)                      \
  (This)->lpVtbl->GetRecordDescriptorByIndex(This, dwRecordIndex, dwIndex,     \
                                             ppDescriptor)
#define IDVB_SDT_GetRecordDescriptorByTag(This, dwRecordIndex, bTag,           \
                                          pdwCookie, ppDescriptor)             \
  (This)->lpVtbl->GetRecordDescriptorByTag(This, dwRecordIndex, bTag,          \
                                           pdwCookie, ppDescriptor)
...
#define IDVB_SDT_GetTransportStreamId(This, pwVal)                             \
  (This)->lpVtbl->GetTransportStreamId(This, pwVal)
#define IDVB_SDT_GetVersionHash(This, pbVal)                                   \
  (This)->lpVtbl->GetVersionHash(This, pbVal)
