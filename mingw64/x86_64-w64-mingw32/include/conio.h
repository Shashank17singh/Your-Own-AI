...
__mingw_ovr __MINGW_ATTRIB_DEPRECATED_SEC_WARN int __cdecl
_cscanf(const char *__restrict__ _Format, ...) {
  __builtin_va_list _ArgList;
  int _Ret;
  __builtin_va_start(_ArgList, _Format);
...
__mingw_ovr __MINGW_ATTRIB_DEPRECATED_SEC_WARN int __cdecl
_cscanf_l(const char *__restrict__ _Format, _locale_t _Locale, ...) {
  __builtin_va_list _ArgList;
  int _Ret;
