...
DEFINE_GUID(IID_ISensorManager, 0xbd77db67, 0x45a8, 0x42dc, 0x8d, 0x00, 0x6d,
            0xcf, 0x15, 0xf8, 0x37, 0x7a);
...
ISensorManager : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE GetSensorsByType(
      REFSENSOR_TYPE_ID sensorType, ISensorCollection * *ppSensorsFound) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetSensorByID(REFSENSOR_ID sensorID,
                                                  ISensor * *ppSensor) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetEventSink(ISensorManagerEvents *
                                                 pEvents) = 0;
  virtual HRESULT STDMETHODCALLTYPE RequestPermissions(
      HWND hParent, ISensorCollection * pSensors, WINBOOL fModal) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ISensorManager, 0xbd77db67, 0x45a8, 0x42dc, 0x8d, 0x00, 0x6d,
                0xcf, 0x15, 0xf8, 0x37, 0x7a)
#endif
#else
typedef struct ISensorManagerVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ISensorManager *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetSensorsByCategory)(
      ISensorManager *This, REFSENSOR_CATEGORY_ID sensorCategory,
      ISensorCollection **ppSensorsFound);
  HRESULT(STDMETHODCALLTYPE *GetSensorsByType)(
      ISensorManager *This, REFSENSOR_TYPE_ID sensorType,
      ISensorCollection **ppSensorsFound);
  HRESULT(STDMETHODCALLTYPE *GetSensorByID)(ISensorManager *This,
                                            REFSENSOR_ID sensorID,
                                            ISensor **ppSensor);
  HRESULT(STDMETHODCALLTYPE *SetEventSink)(ISensorManager *This,
                                           ISensorManagerEvents *pEvents);
  HRESULT(STDMETHODCALLTYPE *RequestPermissions)(ISensorManager *This,
                                                 HWND hParent,
                                                 ISensorCollection *pSensors,
                                                 WINBOOL fModal);
  END_INTERFACE
} ISensorManagerVtbl;
interface ISensorManager { CONST_VTBL ISensorManagerVtbl *lpVtbl; };
#ifdef COBJMACROS
...
/*** ISensorManager methods ***/
#define ISensorManager_GetSensorsByCategory(This, sensorCategory,              \
                                            ppSensorsFound)                    \
...
#else
/*** IUnknown methods ***/
static inline HRESULT ISensorManager_QueryInterface(ISensorManager *This,
                                                    REFIID riid,
                                                    void **ppvObject) {
...
ISensorManager_GetSensorsByCategory(ISensorManager *This,
                                    REFSENSOR_CATEGORY_ID sensorCategory,
                                    ISensorCollection **ppSensorsFound) {
  return This->lpVtbl->GetSensorsByCategory(This, sensorCategory,
                                            ppSensorsFound);
}
static inline HRESULT
ISensorManager_GetSensorsByType(ISensorManager *This,
                                REFSENSOR_TYPE_ID sensorType,
                                ISensorCollection **ppSensorsFound) {
  return This->lpVtbl->GetSensorsByType(This, sensorType, ppSensorsFound);
}
static inline HRESULT ISensorManager_GetSensorByID(ISensorManager *This,
                                                   REFSENSOR_ID sensorID,
                                                   ISensor **ppSensor) {
  return This->lpVtbl->GetSensorByID(This, sensorID, ppSensor);
}
static inline HRESULT
ISensorManager_SetEventSink(ISensorManager *This,
                            ISensorManagerEvents *pEvents) {
  return This->lpVtbl->SetEventSink(This, pEvents);
}
static inline HRESULT
ISensorManager_RequestPermissions(ISensorManager *This, HWND hParent,
                                  ISensorCollection *pSensors, WINBOOL fModal) {
...
DEFINE_GUID(IID_ISensorCollection, 0x23571e11, 0xe545, 0x4dd8, 0xa3, 0x37, 0xb8,
            0x9b, 0xf4, 0x4b, 0x10, 0xdf);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("23571e11-e545-4dd8-a337-b89bf44b10df")
ISensorCollection : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetAt(ULONG ulIndex,
                                          ISensor * *ppSensor) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetCount(ULONG * pCount) = 0;
  virtual HRESULT STDMETHODCALLTYPE Add(ISensor * pSensor) = 0;
  virtual HRESULT STDMETHODCALLTYPE Remove(ISensor * pSensor) = 0;
  virtual HRESULT STDMETHODCALLTYPE RemoveByID(REFSENSOR_ID sensorID) = 0;
  virtual HRESULT STDMETHODCALLTYPE Clear() = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ISensorCollection, 0x23571e11, 0xe545, 0x4dd8, 0xa3, 0x37, 0xb8,
                0x9b, 0xf4, 0x4b, 0x10, 0xdf)
#endif
#else
typedef struct ISensorCollectionVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ISensorCollection *This,
  ...
  HRESULT(STDMETHODCALLTYPE *GetAt)(ISensorCollection *This, ULONG ulIndex,
                                    ISensor **ppSensor);
...
interface ISensorCollection { CONST_VTBL ISensorCollectionVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT ISensorCollection_QueryInterface(ISensorCollection *This,
                                                       REFIID riid,
                                                       void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ISensorCollection methods ***/
static inline HRESULT ISensorCollection_GetAt(ISensorCollection *This,
                                              ULONG ulIndex,
                                              ISensor **ppSensor) {
  return This->lpVtbl->GetAt(This, ulIndex, ppSensor);
}
static inline HRESULT ISensorCollection_GetCount(ISensorCollection *This,
                                                 ULONG *pCount) {
...
static inline HRESULT ISensorCollection_RemoveByID(ISensorCollection *This,
                                                   REFSENSOR_ID sensorID) {
...
DEFINE_GUID(IID_ISensor, 0x5fa08f80, 0x2657, 0x458e, 0xaf, 0x75, 0x46, 0xf7,
            0x3f, 0xa6, 0xac, 0x5c);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("5fa08f80-2657-458e-af75-46f73fa6ac5c")
ISensor : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetID(SENSOR_ID * pID) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetCategory(SENSOR_CATEGORY_ID *
                                                pSensorCategory) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetType(SENSOR_TYPE_ID * pSensorType) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetFriendlyName(BSTR * pFriendlyName) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetProperty(REFPROPERTYKEY key,
  ...
  virtual HRESULT STDMETHODCALLTYPE SupportsDataField(
      REFPROPERTYKEY key, VARIANT_BOOL * pIsSupported) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetState(SensorState * pState) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetData(ISensorDataReport *
                                            *ppDataReport) = 0;
  virtual HRESULT STDMETHODCALLTYPE SupportsEvent(
      REFGUID eventGuid, VARIANT_BOOL * pIsSupported) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetEventInterest(GUID * *ppValues,
                                                     ULONG * pCount) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetEventInterest(GUID * pValues,
                                                     ULONG count) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetEventSink(ISensorEvents * pEvents) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ISensor, 0x5fa08f80, 0x2657, 0x458e, 0xaf, 0x75, 0x46, 0xf7,
                0x3f, 0xa6, 0xac, 0x5c)
#endif
#else
typedef struct ISensorVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ISensor *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetCategory)(ISensor *This,
                                          SENSOR_CATEGORY_ID *pSensorCategory);
  HRESULT(STDMETHODCALLTYPE *GetType)(ISensor *This,
                                      SENSOR_TYPE_ID *pSensorType);
  HRESULT(STDMETHODCALLTYPE *GetFriendlyName)(ISensor *This,
                                              BSTR *pFriendlyName);
  HRESULT(STDMETHODCALLTYPE *GetProperty)(ISensor *This, REFPROPERTYKEY key,
                                          PROPVARIANT *pProperty);
  HRESULT(STDMETHODCALLTYPE *GetProperties)(
      ISensor *This, IPortableDeviceKeyCollection *pKeys,
      IPortableDeviceValues **ppProperties);
  HRESULT(STDMETHODCALLTYPE *GetSupportedDataFields)(
      ISensor *This, IPortableDeviceKeyCollection **ppDataFields);
  HRESULT(STDMETHODCALLTYPE *SetProperties)(ISensor *This,
                                            IPortableDeviceValues *pProperties,
                                            IPortableDeviceValues **ppResults);
  HRESULT(STDMETHODCALLTYPE *SupportsDataField)(ISensor *This,
                                                REFPROPERTYKEY key,
                                                VARIANT_BOOL *pIsSupported);
  HRESULT(STDMETHODCALLTYPE *GetState)(ISensor *This, SensorState *pState);
  HRESULT(STDMETHODCALLTYPE *GetData)(ISensor *This,
                                      ISensorDataReport **ppDataReport);
  HRESULT(STDMETHODCALLTYPE *SupportsEvent)(ISensor *This, REFGUID eventGuid,
                                            VARIANT_BOOL *pIsSupported);
  HRESULT(STDMETHODCALLTYPE *GetEventInterest)(ISensor *This, GUID **ppValues,
                                               ULONG *pCount);
  HRESULT(STDMETHODCALLTYPE *SetEventInterest)(ISensor *This, GUID *pValues,
                                               ULONG count);
  HRESULT(STDMETHODCALLTYPE *SetEventSink)(ISensor *This,
                                           ISensorEvents *pEvents);
  END_INTERFACE
} ISensorVtbl;
interface ISensor { CONST_VTBL ISensorVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT ISensor_QueryInterface(ISensor *This, REFIID riid,
                                             void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
static inline HRESULT ISensor_GetCategory(ISensor *This,
                                          SENSOR_CATEGORY_ID *pSensorCategory) {
  return This->lpVtbl->GetCategory(This, pSensorCategory);
}
static inline HRESULT ISensor_GetType(ISensor *This,
                                      SENSOR_TYPE_ID *pSensorType) {
  return This->lpVtbl->GetType(This, pSensorType);
}
static inline HRESULT ISensor_GetFriendlyName(ISensor *This,
                                              BSTR *pFriendlyName) {
  return This->lpVtbl->GetFriendlyName(This, pFriendlyName);
}
static inline HRESULT ISensor_GetProperty(ISensor *This, REFPROPERTYKEY key,
                                          PROPVARIANT *pProperty) {
  return This->lpVtbl->GetProperty(This, key, pProperty);
}
static inline HRESULT
ISensor_GetProperties(ISensor *This, IPortableDeviceKeyCollection *pKeys,
                      IPortableDeviceValues **ppProperties) {
  return This->lpVtbl->GetProperties(This, pKeys, ppProperties);
}
static inline HRESULT
ISensor_GetSupportedDataFields(ISensor *This,
                               IPortableDeviceKeyCollection **ppDataFields) {
  return This->lpVtbl->GetSupportedDataFields(This, ppDataFields);
}
static inline HRESULT ISensor_SetProperties(ISensor *This,
                                            IPortableDeviceValues *pProperties,
                                            IPortableDeviceValues **ppResults) {
  return This->lpVtbl->SetProperties(This, pProperties, ppResults);
}
static inline HRESULT ISensor_SupportsDataField(ISensor *This,
                                                REFPROPERTYKEY key,
                                                VARIANT_BOOL *pIsSupported) {
...
static inline HRESULT ISensor_GetData(ISensor *This,
                                      ISensorDataReport **ppDataReport) {
  return This->lpVtbl->GetData(This, ppDataReport);
}
static inline HRESULT ISensor_SupportsEvent(ISensor *This, REFGUID eventGuid,
                                            VARIANT_BOOL *pIsSupported) {
  return This->lpVtbl->SupportsEvent(This, eventGuid, pIsSupported);
}
static inline HRESULT ISensor_GetEventInterest(ISensor *This, GUID **ppValues,
                                               ULONG *pCount) {
  return This->lpVtbl->GetEventInterest(This, ppValues, pCount);
}
static inline HRESULT ISensor_SetEventInterest(ISensor *This, GUID *pValues,
                                               ULONG count) {
  return This->lpVtbl->SetEventInterest(This, pValues, count);
}
static inline HRESULT ISensor_SetEventSink(ISensor *This,
                                           ISensorEvents *pEvents) {
  return This->lpVtbl->SetEventSink(This, pEvents);
}
#endif
...
DEFINE_GUID(IID_ISensorDataReport, 0x0ab9df9b, 0xc4b5, 0x4796, 0x88, 0x98, 0x04,
            0x70, 0x70, 0x6a, 0x2e, 0x1d);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("0ab9df9b-c4b5-4796-8898-0470706a2e1d")
ISensorDataReport : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetTimestamp(SYSTEMTIME * pTimeStamp) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetSensorValue(REFPROPERTYKEY pKey,
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ISensorDataReport, 0x0ab9df9b, 0xc4b5, 0x4796, 0x88, 0x98, 0x04,
                0x70, 0x70, 0x6a, 0x2e, 0x1d)
#endif
#else
typedef struct ISensorDataReportVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ISensorDataReport *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTimestamp)(ISensorDataReport *This,
                                           SYSTEMTIME *pTimeStamp);
  HRESULT(STDMETHODCALLTYPE *GetSensorValue)(ISensorDataReport *This,
                                             REFPROPERTYKEY pKey,
                                             PROPVARIANT *pValue);
  HRESULT(STDMETHODCALLTYPE *GetSensorValues)(
      ISensorDataReport *This, IPortableDeviceKeyCollection *pKeys,
      IPortableDeviceValues **ppValues);
  END_INTERFACE
} ISensorDataReportVtbl;
interface ISensorDataReport { CONST_VTBL ISensorDataReportVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT ISensorDataReport_QueryInterface(ISensorDataReport *This,
                                                       REFIID riid,
                                                       void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ISensorDataReport methods ***/
static inline HRESULT ISensorDataReport_GetTimestamp(ISensorDataReport *This,
                                                     SYSTEMTIME *pTimeStamp) {
  return This->lpVtbl->GetTimestamp(This, pTimeStamp);
}
static inline HRESULT ISensorDataReport_GetSensorValue(ISensorDataReport *This,
                                                       REFPROPERTYKEY pKey,
                                                       PROPVARIANT *pValue) {
  return This->lpVtbl->GetSensorValue(This, pKey, pValue);
}
static inline HRESULT
ISensorDataReport_GetSensorValues(ISensorDataReport *This,
                                  IPortableDeviceKeyCollection *pKeys,
                                  IPortableDeviceValues **ppValues) {
...
DEFINE_GUID(IID_ISensorManagerEvents, 0x9b3b0b86, 0x266a, 0x4aad, 0xb2, 0x1f,
            0xfd, 0xe5, 0x50, 0x10, 0x01, 0xb7);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("9b3b0b86-266a-4aad-b21f-fde5501001b7")
ISensorManagerEvents : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE OnSensorEnter(ISensor * pSensor,
                                                  SensorState state) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ISensorManagerEvents, 0x9b3b0b86, 0x266a, 0x4aad, 0xb2, 0x1f,
                0xfd, 0xe5, 0x50, 0x10, 0x01, 0xb7)
#endif
#else
typedef struct ISensorManagerEventsVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ISensorManagerEvents *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *OnSensorEnter)(ISensorManagerEvents *This,
                                            ISensor *pSensor,
                                            SensorState state);
  END_INTERFACE
} ISensorManagerEventsVtbl;
interface ISensorManagerEvents { CONST_VTBL ISensorManagerEventsVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
ISensorManagerEvents_QueryInterface(ISensorManagerEvents *This, REFIID riid,
                                    void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ISensorManagerEvents methods ***/
static inline HRESULT
ISensorManagerEvents_OnSensorEnter(ISensorManagerEvents *This, ISensor *pSensor,
                                   SensorState state) {
...
DEFINE_GUID(IID_ISensorEvents, 0x5d8dcc91, 0x4641, 0x47e7, 0xb7, 0xc3, 0xb7,
            0x4f, 0x48, 0xa6, 0xc3, 0x91);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("5d8dcc91-4641-47e7-b7c3-b74f48a6c391")
ISensorEvents : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE OnStateChanged(ISensor * pSensor,
                                                   SensorState state) = 0;
  virtual HRESULT STDMETHODCALLTYPE OnDataUpdated(
      ISensor * pSensor, ISensorDataReport * pNewData) = 0;
  virtual HRESULT STDMETHODCALLTYPE OnEvent(ISensor * pSensor, REFGUID eventID,
                                            IPortableDeviceValues *
                                                pEventData) = 0;
  virtual HRESULT STDMETHODCALLTYPE OnLeave(REFSENSOR_ID ID) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ISensorEvents, 0x5d8dcc91, 0x4641, 0x47e7, 0xb7, 0xc3, 0xb7,
                0x4f, 0x48, 0xa6, 0xc3, 0x91)
#endif
#else
typedef struct ISensorEventsVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ISensorEvents *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(ISensorEvents *This);
  ULONG(STDMETHODCALLTYPE *Release)(ISensorEvents *This);
  /*** ISensorEvents methods ***/
  HRESULT(STDMETHODCALLTYPE *OnStateChanged)(ISensorEvents *This,
                                             ISensor *pSensor,
                                             SensorState state);
  HRESULT(STDMETHODCALLTYPE *OnDataUpdated)(ISensorEvents *This,
                                            ISensor *pSensor,
                                            ISensorDataReport *pNewData);
  HRESULT(STDMETHODCALLTYPE *OnEvent)(ISensorEvents *This, ISensor *pSensor,
                                      REFGUID eventID,
                                      IPortableDeviceValues *pEventData);
  HRESULT(STDMETHODCALLTYPE *OnLeave)(ISensorEvents *This, REFSENSOR_ID ID);
  END_INTERFACE
} ISensorEventsVtbl;
interface ISensorEvents { CONST_VTBL ISensorEventsVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT ISensorEvents_QueryInterface(ISensorEvents *This,
                                                   REFIID riid,
                                                   void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ISensorEvents methods ***/
static inline HRESULT ISensorEvents_OnStateChanged(ISensorEvents *This,
                                                   ISensor *pSensor,
                                                   SensorState state) {
  return This->lpVtbl->OnStateChanged(This, pSensor, state);
}
static inline HRESULT ISensorEvents_OnDataUpdated(ISensorEvents *This,
                                                  ISensor *pSensor,
                                                  ISensorDataReport *pNewData) {
  return This->lpVtbl->OnDataUpdated(This, pSensor, pNewData);
}
static inline HRESULT ISensorEvents_OnEvent(ISensorEvents *This,
                                            ISensor *pSensor, REFGUID eventID,
                                            IPortableDeviceValues *pEventData) {
  return This->lpVtbl->OnEvent(This, pSensor, eventID, pEventData);
}
static inline HRESULT ISensorEvents_OnLeave(ISensorEvents *This,
                                            REFSENSOR_ID ID) {
...
DEFINE_GUID(LIBID_SensorsApiLib, 0x15092592, 0x5270, 0x4c6c, 0xaa, 0xa0, 0x11,
            0x76, 0x4f, 0x18, 0x9a, 0x8f);
/*****************************************************************************
 * SensorManager coclass
 */
DEFINE_GUID(CLSID_SensorManager, 0x77a1c827, 0xfcd2, 0x4689, 0x89, 0x15, 0x9d,
            0x61, 0x3c, 0xc5, 0xfa, 0x3e);
#ifdef __cplusplus
class DECLSPEC_UUID("77a1c827-fcd2-4689-8915-9d613cc5fa3e") SensorManager;
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(SensorManager, 0x77a1c827, 0xfcd2, 0x4689, 0x89, 0x15, 0x9d,
                0x61, 0x3c, 0xc5, 0xfa, 0x3e)
#endif
#endif
