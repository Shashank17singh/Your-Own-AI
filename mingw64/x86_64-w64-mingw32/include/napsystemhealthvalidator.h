/*** Autogenerated by WIDL 11.5 from include/napsystemhealthvalidator.idl - Do
 * not edit ***/
#ifdef _WIN32
...
DEFINE_GUID(IID_INapSystemHealthValidator, 0xef43d87c, 0x5b6d, 0x4820, 0x86,
            0x20, 0x86, 0x89, 0x07, 0xfe, 0x07, 0xd3);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("ef43d87c-5b6d-4820-8620-868907fe07d3")
INapSystemHealthValidator : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE Validate(
      INapSystemHealthValidationRequest * request, UINT32 hintTimeOutInMsec,
      INapServerCallback * callback) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(INapSystemHealthValidator, 0xef43d87c, 0x5b6d, 0x4820, 0x86,
                0x20, 0x86, 0x89, 0x07, 0xfe, 0x07, 0xd3)
#endif
#else
typedef struct INapSystemHealthValidatorVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INapSystemHealthValidator *This,
...
/*** INapSystemHealthValidator methods ***/
#define INapSystemHealthValidator_Validate(This, request, hintTimeOutInMsec,   \
                                           callback)                           \
  (This)->lpVtbl->Validate(This, request, hintTimeOutInMsec, callback)
#else
/*** IUnknown methods ***/
static inline HRESULT
INapSystemHealthValidator_QueryInterface(INapSystemHealthValidator *This,
                                         REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
INapSystemHealthValidator_AddRef(INapSystemHealthValidator *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
INapSystemHealthValidator_Release(INapSystemHealthValidator *This) {
  return This->lpVtbl->Release(This);
}
/*** INapSystemHealthValidator methods ***/
static inline HRESULT INapSystemHealthValidator_Validate(
    INapSystemHealthValidator *This, INapSystemHealthValidationRequest *request,
    UINT32 hintTimeOutInMsec, INapServerCallback *callback) {
...
DEFINE_GUID(IID_AsyncINapSystemHealthValidator, 0x2516031a, 0xa391, 0x454d,
            0xb5, 0x3d, 0xc5, 0xdc, 0x84, 0xc7, 0xf2, 0xdb);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
AsyncINapSystemHealthValidator : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE Begin_Validate(
      INapSystemHealthValidationRequest * request, UINT32 hintTimeOutInMsec,
      INapServerCallback * callback) = 0;
  virtual HRESULT STDMETHODCALLTYPE Finish_Validate() = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(AsyncINapSystemHealthValidator, 0x2516031a, 0xa391, 0x454d,
                0xb5, 0x3d, 0xc5, 0xdc, 0x84, 0xc7, 0xf2, 0xdb)
#endif
#else
typedef struct AsyncINapSystemHealthValidatorVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(
      AsyncINapSystemHealthValidator *This, REFIID riid, void **ppvObject);
...
/*** AsyncINapSystemHealthValidator methods ***/
#define AsyncINapSystemHealthValidator_Begin_Validate(                         \
    This, request, hintTimeOutInMsec, callback)                                \
...
#else
/*** IUnknown methods ***/
static inline HRESULT AsyncINapSystemHealthValidator_QueryInterface(
    AsyncINapSystemHealthValidator *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
AsyncINapSystemHealthValidator_AddRef(AsyncINapSystemHealthValidator *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
AsyncINapSystemHealthValidator_Release(AsyncINapSystemHealthValidator *This) {
  return This->lpVtbl->Release(This);
}
/*** AsyncINapSystemHealthValidator methods ***/
static inline HRESULT AsyncINapSystemHealthValidator_Begin_Validate(
    AsyncINapSystemHealthValidator *This,
    INapSystemHealthValidationRequest *request, UINT32 hintTimeOutInMsec,
    INapServerCallback *callback) {
  return This->lpVtbl->Begin_Validate(This, request, hintTimeOutInMsec,
                                      callback);
}
static inline HRESULT AsyncINapSystemHealthValidator_Finish_Validate(
    AsyncINapSystemHealthValidator *This) {
...
DEFINE_GUID(IID_INapServerCallback, 0x09c20568, 0xf30c, 0x489b, 0xae, 0x9c,
            0x49, 0x30, 0xad, 0x7f, 0x16, 0x5f);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("09c20568-f30c-489b-ae9c-4930ad7f165f")
INapServerCallback : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE OnComplete(
      INapSystemHealthValidationRequest * request, HRESULT errorCode) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(INapServerCallback, 0x09c20568, 0xf30c, 0x489b, 0xae, 0x9c,
                0x49, 0x30, 0xad, 0x7f, 0x16, 0x5f)
#endif
#else
typedef struct INapServerCallbackVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INapServerCallback *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *OnComplete)(
      INapServerCallback *This, INapSystemHealthValidationRequest *request,
      HRESULT errorCode);
  END_INTERFACE
} INapServerCallbackVtbl;
interface INapServerCallback { CONST_VTBL INapServerCallbackVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
INapServerCallback_QueryInterface(INapServerCallback *This, REFIID riid,
                                  void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** INapServerCallback methods ***/
static inline HRESULT
INapServerCallback_OnComplete(INapServerCallback *This,
...
DEFINE_GUID(IID_INapSystemHealthValidationRequest, 0xadacb3a0, 0xd4f4, 0x4f17,
            0x89, 0x33, 0x51, 0xd6, 0x0f, 0xcc, 0xa6, 0x06);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
INapSystemHealthValidationRequest : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE GetStringCorrelationId(StringCorrelationId *
                                                           *correlationId) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetMachineName(CountedString *
                                                   *machineName) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetSoHRequest(
      SoHRequest * *sohRequest, WINBOOL * napSystemGenerated) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetSoHResponse(
      const SoHResponse *sohResponse) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetSoHResponse(SoHResponse *
                                                   *sohResponse) = 0;
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(INapSystemHealthValidationRequest, 0xadacb3a0, 0xd4f4, 0x4f17,
                0x89, 0x33, 0x51, 0xd6, 0x0f, 0xcc, 0xa6, 0x06)
#endif
#else
typedef struct INapSystemHealthValidationRequestVtbl {
  ...
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(
      INapSystemHealthValidationRequest *This, REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetCorrelationId)(
      INapSystemHealthValidationRequest *This, CorrelationId *correlationId);
  ...
  HRESULT(STDMETHODCALLTYPE *GetMachineName)(
      INapSystemHealthValidationRequest *This, CountedString **machineName);
  HRESULT(STDMETHODCALLTYPE *GetSoHRequest)(
      INapSystemHealthValidationRequest *This, SoHRequest **sohRequest,
      WINBOOL *napSystemGenerated);
  HRESULT(STDMETHODCALLTYPE *SetSoHResponse)(
      INapSystemHealthValidationRequest *This, const SoHResponse *sohResponse);
  HRESULT(STDMETHODCALLTYPE *GetSoHResponse)(
      INapSystemHealthValidationRequest *This, SoHResponse **sohResponse);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(
      INapSystemHealthValidationRequest *This, const PrivateData *privateData);
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(
      INapSystemHealthValidationRequest *This, PrivateData **privateData);
  END_INTERFACE
...
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
#define INapSystemHealthValidationRequest_QueryInterface(This, riid,           \
                                                         ppvObject)            \
  (This)->lpVtbl->QueryInterface(This, riid, ppvObject)
...
#define INapSystemHealthValidationRequest_Release(This)                        \
  (This)->lpVtbl->Release(This)
/*** INapSystemHealthValidationRequest methods ***/
#define INapSystemHealthValidationRequest_GetCorrelationId(This,               \
                                                           correlationId)      \
  (This)->lpVtbl->GetCorrelationId(This, correlationId)
#define INapSystemHealthValidationRequest_GetStringCorrelationId(              \
    This, correlationId)                                                       \
...
#define INapSystemHealthValidationRequest_GetSoHRequest(This, sohRequest,      \
                                                        napSystemGenerated)    \
...
#else
/*** IUnknown methods ***/
static inline HRESULT INapSystemHealthValidationRequest_QueryInterface(
    INapSystemHealthValidationRequest *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG INapSystemHealthValidationRequest_AddRef(
    INapSystemHealthValidationRequest *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG INapSystemHealthValidationRequest_Release(
    INapSystemHealthValidationRequest *This) {
  return This->lpVtbl->Release(This);
}
/*** INapSystemHealthValidationRequest methods ***/
static inline HRESULT INapSystemHealthValidationRequest_GetCorrelationId(
    INapSystemHealthValidationRequest *This, CorrelationId *correlationId) {
  return This->lpVtbl->GetCorrelationId(This, correlationId);
}
static inline HRESULT INapSystemHealthValidationRequest_GetStringCorrelationId(
    INapSystemHealthValidationRequest *This,
    StringCorrelationId **correlationId) {
  return This->lpVtbl->GetStringCorrelationId(This, correlationId);
}
static inline HRESULT INapSystemHealthValidationRequest_GetMachineName(
    INapSystemHealthValidationRequest *This, CountedString **machineName) {
  return This->lpVtbl->GetMachineName(This, machineName);
}
static inline HRESULT INapSystemHealthValidationRequest_GetSoHRequest(
    INapSystemHealthValidationRequest *This, SoHRequest **sohRequest,
    WINBOOL *napSystemGenerated) {
  return This->lpVtbl->GetSoHRequest(This, sohRequest, napSystemGenerated);
}
static inline HRESULT INapSystemHealthValidationRequest_SetSoHResponse(
    INapSystemHealthValidationRequest *This, const SoHResponse *sohResponse) {
  return This->lpVtbl->SetSoHResponse(This, sohResponse);
}
static inline HRESULT INapSystemHealthValidationRequest_GetSoHResponse(
    INapSystemHealthValidationRequest *This, SoHResponse **sohResponse) {
  return This->lpVtbl->GetSoHResponse(This, sohResponse);
}
static inline HRESULT INapSystemHealthValidationRequest_SetPrivateData(
    INapSystemHealthValidationRequest *This, const PrivateData *privateData) {
  return This->lpVtbl->SetPrivateData(This, privateData);
}
static inline HRESULT INapSystemHealthValidationRequest_GetPrivateData(
    INapSystemHealthValidationRequest *This, PrivateData **privateData) {
...
DEFINE_GUID(IID_INapSystemHealthValidationRequest2, 0x91a5d706, 0x0cb4, 0x4a84,
            0x83, 0x15, 0x93, 0x80, 0xd4, 0x53, 0xe3, 0x85);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
INapSystemHealthValidationRequest2 : public INapSystemHealthValidationRequest {
  virtual HRESULT STDMETHODCALLTYPE GetConfigID(UINT32 * configID) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(INapSystemHealthValidationRequest2, 0x91a5d706, 0x0cb4, 0x4a84,
                0x83, 0x15, 0x93, 0x80, 0xd4, 0x53, 0xe3, 0x85)
#endif
#else
typedef struct INapSystemHealthValidationRequest2Vtbl {
  ...
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(
      INapSystemHealthValidationRequest2 *This, REFIID riid, void **ppvObject);
  ...
  /*** INapSystemHealthValidationRequest methods ***/
  HRESULT(STDMETHODCALLTYPE *GetCorrelationId)(
      INapSystemHealthValidationRequest2 *This, CorrelationId *correlationId);
  HRESULT(STDMETHODCALLTYPE *GetStringCorrelationId)(
      INapSystemHealthValidationRequest2 *This,
      StringCorrelationId **correlationId);
  HRESULT(STDMETHODCALLTYPE *GetMachineName)(
      INapSystemHealthValidationRequest2 *This, CountedString **machineName);
  HRESULT(STDMETHODCALLTYPE *GetSoHRequest)(
      INapSystemHealthValidationRequest2 *This, SoHRequest **sohRequest,
      WINBOOL *napSystemGenerated);
  HRESULT(STDMETHODCALLTYPE *SetSoHResponse)(
      INapSystemHealthValidationRequest2 *This, const SoHResponse *sohResponse);
  HRESULT(STDMETHODCALLTYPE *GetSoHResponse)(
      INapSystemHealthValidationRequest2 *This, SoHResponse **sohResponse);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(
      INapSystemHealthValidationRequest2 *This, const PrivateData *privateData);
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(
      INapSystemHealthValidationRequest2 *This, PrivateData **privateData);
  /*** INapSystemHealthValidationRequest2 methods ***/
  HRESULT(STDMETHODCALLTYPE *GetConfigID)(
      INapSystemHealthValidationRequest2 *This, UINT32 *configID);
  END_INTERFACE
...
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
#define INapSystemHealthValidationRequest2_QueryInterface(This, riid,          \
                                                          ppvObject)           \
  (This)->lpVtbl->QueryInterface(This, riid, ppvObject)
...
#define INapSystemHealthValidationRequest2_Release(This)                       \
  (This)->lpVtbl->Release(This)
/*** INapSystemHealthValidationRequest methods ***/
#define INapSystemHealthValidationRequest2_GetCorrelationId(This,              \
                                                            correlationId)     \
  (This)->lpVtbl->GetCorrelationId(This, correlationId)
#define INapSystemHealthValidationRequest2_GetStringCorrelationId(             \
    This, correlationId)                                                       \
  (This)->lpVtbl->GetStringCorrelationId(This, correlationId)
#define INapSystemHealthValidationRequest2_GetMachineName(This, machineName)   \
  (This)->lpVtbl->GetMachineName(This, machineName)
#define INapSystemHealthValidationRequest2_GetSoHRequest(This, sohRequest,     \
                                                         napSystemGenerated)   \
  (This)->lpVtbl->GetSoHRequest(This, sohRequest, napSystemGenerated)
...
#else
/*** IUnknown methods ***/
static inline HRESULT INapSystemHealthValidationRequest2_QueryInterface(
    INapSystemHealthValidationRequest2 *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG INapSystemHealthValidationRequest2_AddRef(
    INapSystemHealthValidationRequest2 *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG INapSystemHealthValidationRequest2_Release(
    INapSystemHealthValidationRequest2 *This) {
  return This->lpVtbl->Release(This);
}
/*** INapSystemHealthValidationRequest methods ***/
static inline HRESULT INapSystemHealthValidationRequest2_GetCorrelationId(
    INapSystemHealthValidationRequest2 *This, CorrelationId *correlationId) {
  return This->lpVtbl->GetCorrelationId(This, correlationId);
}
static inline HRESULT INapSystemHealthValidationRequest2_GetStringCorrelationId(
    INapSystemHealthValidationRequest2 *This,
    StringCorrelationId **correlationId) {
  return This->lpVtbl->GetStringCorrelationId(This, correlationId);
}
static inline HRESULT INapSystemHealthValidationRequest2_GetMachineName(
    INapSystemHealthValidationRequest2 *This, CountedString **machineName) {
  return This->lpVtbl->GetMachineName(This, machineName);
}
static inline HRESULT INapSystemHealthValidationRequest2_GetSoHRequest(
    INapSystemHealthValidationRequest2 *This, SoHRequest **sohRequest,
    WINBOOL *napSystemGenerated) {
  return This->lpVtbl->GetSoHRequest(This, sohRequest, napSystemGenerated);
}
static inline HRESULT INapSystemHealthValidationRequest2_SetSoHResponse(
    INapSystemHealthValidationRequest2 *This, const SoHResponse *sohResponse) {
  return This->lpVtbl->SetSoHResponse(This, sohResponse);
}
static inline HRESULT INapSystemHealthValidationRequest2_GetSoHResponse(
    INapSystemHealthValidationRequest2 *This, SoHResponse **sohResponse) {
  return This->lpVtbl->GetSoHResponse(This, sohResponse);
}
static inline HRESULT INapSystemHealthValidationRequest2_SetPrivateData(
    INapSystemHealthValidationRequest2 *This, const PrivateData *privateData) {
  return This->lpVtbl->SetPrivateData(This, privateData);
}
static inline HRESULT INapSystemHealthValidationRequest2_GetPrivateData(
    INapSystemHealthValidationRequest2 *This, PrivateData **privateData) {
  return This->lpVtbl->GetPrivateData(This, privateData);
}
/*** INapSystemHealthValidationRequest2 methods ***/
static inline HRESULT INapSystemHealthValidationRequest2_GetConfigID(
    INapSystemHealthValidationRequest2 *This, UINT32 *configID) {
