...
#define MD_DEFAULT_EXTLOG_FIELDS                                               \
  (MD_EXTLOG_CLIENT_IP | MD_EXTLOG_TIME | MD_EXTLOG_METHOD |                   \
   MD_EXTLOG_URI_STEM | MD_EXTLOG_HTTP_STATUS | MD_EXTLOG_HTTP_SUB_STATUS |    \
   MD_EXTLOG_SITE_NAME)
...
#define MD_NOTIFY_ORDER_MASK                                                   \
  (MD_NOTIFY_ORDER_HIGH | MD_NOTIFY_ORDER_MEDIUM | MD_NOTIFY_ORDER_LOW)
...
#define MD_NONSSL_ACCESS_MASK                                                  \
  (MD_ACCESS_READ | MD_ACCESS_WRITE | MD_ACCESS_EXECUTE | MD_ACCESS_SOURCE |   \
   MD_ACCESS_SCRIPT | MD_ACCESS_NO_REMOTE_READ | MD_ACCESS_NO_REMOTE_WRITE |   \
   MD_ACCESS_NO_REMOTE_EXECUTE | MD_ACCESS_NO_REMOTE_SCRIPT |                  \
...
#define MD_SSL_ACCESS_MASK                                                     \
  (MD_ACCESS_SSL | MD_ACCESS_NEGO_CERT | MD_ACCESS_REQUIRE_CERT |              \
   MD_ACCESS_MAP_CERT | MD_ACCESS_SSL128)
...
#define MD_DIRBROW_MASK                                                        \
  (MD_DIRBROW_SHOW_DATE | MD_DIRBROW_SHOW_TIME | MD_DIRBROW_SHOW_SIZE |        \
   MD_DIRBROW_SHOW_EXTENSION | MD_DIRBROW_LONG_DATE | MD_DIRBROW_LOADDEFAULT | \
   MD_DIRBROW_ENABLED)
...
#define MD_SERVER_CONFIGURATION_MASK                                           \
  (MD_SERVER_CONFIG_SSL_40 | MD_SERVER_CONFIG_SSL_128 |                        \
   MD_SERVER_CONFIG_ENCRYPT | MD_SERVER_CONFIG_AUTO_PW_SYNC)
