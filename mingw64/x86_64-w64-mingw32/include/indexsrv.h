...
public:
  virtual HRESULT WINAPI PutSmallPhrase(const WCHAR *pwcNoun, ULONG cwcNoun,
...
typedef struct IPhraseSinkVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IPhraseSink *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IPhraseSink *This);
  ULONG(WINAPI *Release)(IPhraseSink *This);
  HRESULT(WINAPI *PutSmallPhrase)(IPhraseSink *This, const WCHAR *pwcNoun,
                                  ULONG cwcNoun, const WCHAR *pwcModifier,
                                  ULONG cwcModifier, ULONG ulAttachmentType);
  HRESULT(WINAPI *PutPhrase)(IPhraseSink *This, const WCHAR *pwcPhrase,
                             ULONG cwcPhrase);
  END_INTERFACE
} IPhraseSinkVtbl;
struct IPhraseSink {
...
#define IPhraseSink_PutSmallPhrase(This, pwcNoun, cwcNoun, pwcModifier,        \
                                   cwcModifier, ulAttachmentType)              \
  (This)->lpVtbl->PutSmallPhrase(This, pwcNoun, cwcNoun, pwcModifier,          \
                                 cwcModifier, ulAttachmentType)
#define IPhraseSink_PutPhrase(This, pwcPhrase, cwcPhrase)                      \
  (This)->lpVtbl->PutPhrase(This, pwcPhrase, cwcPhrase)
#endif
#endif
HRESULT WINAPI IPhraseSink_PutSmallPhrase_Proxy(
    IPhraseSink *This, const WCHAR *pwcNoun, ULONG cwcNoun,
    const WCHAR *pwcModifier, ULONG cwcModifier, ULONG ulAttachmentType);
...
HRESULT WINAPI IPhraseSink_PutPhrase_Proxy(IPhraseSink *This,
...
public:
  virtual HRESULT WINAPI PutWord(ULONG cwc, const WCHAR *pwcInBuf,
                                 ULONG cwcSrcLen, ULONG cwcSrcPos) = 0;
  virtual HRESULT WINAPI PutAltWord(ULONG cwc, const WCHAR *pwcInBuf,
                                    ULONG cwcSrcLen, ULONG cwcSrcPos) = 0;
...
typedef struct IWordSinkVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IWordSink *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IWordSink *This);
  ULONG(WINAPI *Release)(IWordSink *This);
  HRESULT(WINAPI *PutWord)(IWordSink *This, ULONG cwc, const WCHAR *pwcInBuf,
                           ULONG cwcSrcLen, ULONG cwcSrcPos);
  HRESULT(WINAPI *PutAltWord)(IWordSink *This, ULONG cwc, const WCHAR *pwcInBuf,
                              ULONG cwcSrcLen, ULONG cwcSrcPos);
...
#endif
#endif
HRESULT WINAPI IWordSink_PutWord_Proxy(IWordSink *This, ULONG cwc,
                                       const WCHAR *pwcInBuf, ULONG cwcSrcLen,
                                       ULONG cwcSrcPos);
void __RPC_STUB IWordSink_PutWord_Stub(IRpcStubBuffer *This,
                                       IRpcChannelBuffer *_pRpcChannelBuffer,
                                       PRPC_MESSAGE _pRpcMessage,
                                       DWORD *_pdwStubPhase);
HRESULT WINAPI IWordSink_PutAltWord_Proxy(IWordSink *This, ULONG cwc,
                                          const WCHAR *pwcInBuf,
                                          ULONG cwcSrcLen, ULONG cwcSrcPos);
void __RPC_STUB IWordSink_PutAltWord_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
...
void __RPC_STUB IWordSink_EndAltPhrase_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IWordSink_PutBreak_Proxy(IWordSink *This,
                                        WORDREP_BREAK_TYPE breakType);
void __RPC_STUB IWordSink_PutBreak_Stub(IRpcStubBuffer *This,
                                        IRpcChannelBuffer *_pRpcChannelBuffer,
                                        PRPC_MESSAGE _pRpcMessage,
                                        DWORD *_pdwStubPhase);
#endif
...
public:
  virtual HRESULT WINAPI Init(WINBOOL fQuery, ULONG ulMaxTokenSize,
                              WINBOOL *pfLicense) = 0;
  virtual HRESULT WINAPI BreakText(TEXT_SOURCE *pTextSource,
                                   IWordSink *pWordSink,
                                   IPhraseSink *pPhraseSink) = 0;
  virtual HRESULT WINAPI ComposePhrase(const WCHAR *pwcNoun, ULONG cwcNoun,
                                       const WCHAR *pwcModifier,
                                       ULONG cwcModifier,
...
typedef struct IWordBreakerVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IWordBreaker *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IWordBreaker *This);
  ULONG(WINAPI *Release)(IWordBreaker *This);
  HRESULT(WINAPI *Init)(IWordBreaker *This, WINBOOL fQuery,
                        ULONG ulMaxTokenSize, WINBOOL *pfLicense);
  HRESULT(WINAPI *BreakText)(IWordBreaker *This, TEXT_SOURCE *pTextSource,
                             IWordSink *pWordSink, IPhraseSink *pPhraseSink);
  HRESULT(WINAPI *ComposePhrase)(IWordBreaker *This, const WCHAR *pwcNoun,
                                 ULONG cwcNoun, const WCHAR *pwcModifier,
                                 ULONG cwcModifier, ULONG ulAttachmentType,
                                 WCHAR *pwcPhrase, ULONG *pcwcPhrase);
  HRESULT(WINAPI *GetLicenseToUse)(IWordBreaker *This,
...
#define IWordBreaker_ComposePhrase(This, pwcNoun, cwcNoun, pwcModifier,        \
                                   cwcModifier, ulAttachmentType, pwcPhrase,   \
                                   pcwcPhrase)                                 \
  (This)->lpVtbl->ComposePhrase(This, pwcNoun, cwcNoun, pwcModifier,           \
                                cwcModifier, ulAttachmentType, pwcPhrase,      \
                                pcwcPhrase)
...
#endif
#endif
HRESULT WINAPI IWordBreaker_Init_Proxy(IWordBreaker *This, WINBOOL fQuery,
                                       ULONG ulMaxTokenSize,
                                       WINBOOL *pfLicense);
void __RPC_STUB IWordBreaker_Init_Stub(IRpcStubBuffer *This,
                                       IRpcChannelBuffer *_pRpcChannelBuffer,
                                       PRPC_MESSAGE _pRpcMessage,
                                       DWORD *_pdwStubPhase);
HRESULT WINAPI IWordBreaker_BreakText_Proxy(IWordBreaker *This,
...
void __RPC_STUB IWordBreaker_BreakText_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IWordBreaker_ComposePhrase_Proxy(
    IWordBreaker *This, const WCHAR *pwcNoun, ULONG cwcNoun,
    const WCHAR *pwcModifier, ULONG cwcModifier, ULONG ulAttachmentType,
    WCHAR *pwcPhrase, ULONG *pcwcPhrase);
void __RPC_STUB IWordBreaker_ComposePhrase_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IWordBreaker_GetLicenseToUse_Proxy(IWordBreaker *This,
                                                  const WCHAR **ppwcsLicense);
...
typedef struct IWordFormSinkVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IWordFormSink *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IWordFormSink *This);
  ULONG(WINAPI *Release)(IWordFormSink *This);
  HRESULT(WINAPI *PutAltWord)(IWordFormSink *This, const WCHAR *pwcInBuf,
                              ULONG cwc);
  HRESULT(WINAPI *PutWord)(IWordFormSink *This, const WCHAR *pwcInBuf,
                           ULONG cwc);
  END_INTERFACE
} IWordFormSinkVtbl;
...
#endif
#endif
HRESULT WINAPI IWordFormSink_PutAltWord_Proxy(IWordFormSink *This,
                                              const WCHAR *pwcInBuf, ULONG cwc);
void __RPC_STUB IWordFormSink_PutAltWord_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IWordFormSink_PutWord_Proxy(IWordFormSink *This,
                                           const WCHAR *pwcInBuf, ULONG cwc);
...
public:
  ...
  virtual HRESULT WINAPI GenerateWordForms(const WCHAR *pwcInBuf, ULONG cwc,
                                           IWordFormSink *pStemSink) = 0;
  virtual HRESULT WINAPI GetLicenseToUse(const WCHAR **ppwcsLicense) = 0;
};
#else
typedef struct IStemmerVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IStemmer *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IStemmer *This);
  ULONG(WINAPI *Release)(IStemmer *This);
  HRESULT(WINAPI *Init)(IStemmer *This, ULONG ulMaxTokenSize,
                        WINBOOL *pfLicense);
  HRESULT(WINAPI *GenerateWordForms)(IStemmer *This, const WCHAR *pwcInBuf,
                                     ULONG cwc, IWordFormSink *pStemSink);
...
#endif
#endif
HRESULT WINAPI IStemmer_Init_Proxy(IStemmer *This, ULONG ulMaxTokenSize,
                                   WINBOOL *pfLicense);
void __RPC_STUB IStemmer_Init_Stub(IRpcStubBuffer *This,
                                   IRpcChannelBuffer *_pRpcChannelBuffer,
                                   PRPC_MESSAGE _pRpcMessage,
                                   DWORD *_pdwStubPhase);
HRESULT WINAPI IStemmer_GenerateWordForms_Proxy(IStemmer *This,
                                                const WCHAR *pwcInBuf,
                                                ULONG cwc,
...
void __RPC_STUB IStemmer_GenerateWordForms_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IStemmer_GetLicenseToUse_Proxy(IStemmer *This,
                                              const WCHAR **ppwcsLicense);
...
public:
  virtual HRESULT WINAPI CreateICommand(IUnknown **ppIUnknown,
                                        IUnknown *pOuterUnk) = 0;
  virtual HRESULT WINAPI VerifyCatalog(const WCHAR *pwszMachine,
                                       const WCHAR *pwszCatalogName) = 0;
  virtual HRESULT WINAPI GetDefaultCatalog(WCHAR *pwszCatalogName, ULONG cwcIn,
                                           ULONG *pcwcOut) = 0;
};
#else
typedef struct ISimpleCommandCreatorVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ISimpleCommandCreator *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ISimpleCommandCreator *This);
  ULONG(WINAPI *Release)(ISimpleCommandCreator *This);
  HRESULT(WINAPI *CreateICommand)(ISimpleCommandCreator *This,
                                  IUnknown **ppIUnknown, IUnknown *pOuterUnk);
  HRESULT(WINAPI *VerifyCatalog)(ISimpleCommandCreator *This,
                                 const WCHAR *pwszMachine,
                                 const WCHAR *pwszCatalogName);
  HRESULT(WINAPI *GetDefaultCatalog)(ISimpleCommandCreator *This,
                                     WCHAR *pwszCatalogName, ULONG cwcIn,
                                     ULONG *pcwcOut);
  END_INTERFACE
...
#define ISimpleCommandCreator_VerifyCatalog(This, pwszMachine,                 \
                                            pwszCatalogName)                   \
  (This)->lpVtbl->VerifyCatalog(This, pwszMachine, pwszCatalogName)
#define ISimpleCommandCreator_GetDefaultCatalog(This, pwszCatalogName, cwcIn,  \
                                                pcwcOut)                       \
...
HRESULT WINAPI ISimpleCommandCreator_CreateICommand_Proxy(
    ISimpleCommandCreator *This, IUnknown **ppIUnknown, IUnknown *pOuterUnk);
void __RPC_STUB ISimpleCommandCreator_CreateICommand_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISimpleCommandCreator_VerifyCatalog_Proxy(
    ISimpleCommandCreator *This, const WCHAR *pwszMachine,
    const WCHAR *pwszCatalogName);
void __RPC_STUB ISimpleCommandCreator_VerifyCatalog_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISimpleCommandCreator_GetDefaultCatalog_Proxy(
    ISimpleCommandCreator *This, WCHAR *pwszCatalogName, ULONG cwcIn,
    ULONG *pcwcOut);
...
public:
  virtual HRESULT WINAPI GetPropInfoFromName(const WCHAR *wcsPropName,
                                             DBID **ppPropId, DBTYPE *pPropType,
                                             unsigned int *puiWidth) = 0;
  virtual HRESULT WINAPI GetPropInfoFromId(const DBID *pPropId,
                                           WCHAR **pwcsName, DBTYPE *pPropType,
                                           unsigned int *puiWidth) = 0;
...
typedef struct IColumnMapperVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IColumnMapper *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IColumnMapper *This);
  ULONG(WINAPI *Release)(IColumnMapper *This);
  HRESULT(WINAPI *GetPropInfoFromName)(IColumnMapper *This,
                                       const WCHAR *wcsPropName,
                                       DBID **ppPropId, DBTYPE *pPropType,
                                       unsigned int *puiWidth);
  HRESULT(WINAPI *GetPropInfoFromId)(IColumnMapper *This, const DBID *pPropId,
                                     WCHAR **pwcsName, DBTYPE *pPropType,
                                     unsigned int *puiWidth);
  HRESULT(WINAPI *EnumPropInfo)(IColumnMapper *This, ULONG iEntry,
                                const WCHAR **pwcsName, DBID **ppPropId,
                                DBTYPE *pPropType, unsigned int *puiWidth);
...
#define IColumnMapper_GetPropInfoFromName(This, wcsPropName, ppPropId,         \
                                          pPropType, puiWidth)                 \
  (This)->lpVtbl->GetPropInfoFromName(This, wcsPropName, ppPropId, pPropType,  \
                                      puiWidth)
#define IColumnMapper_GetPropInfoFromId(This, pPropId, pwcsName, pPropType,    \
                                        puiWidth)                              \
  (This)->lpVtbl->GetPropInfoFromId(This, pPropId, pwcsName, pPropType,        \
                                    puiWidth)
#define IColumnMapper_EnumPropInfo(This, iEntry, pwcsName, ppPropId,           \
                                   pPropType, puiWidth)                        \
  (This)->lpVtbl->EnumPropInfo(This, iEntry, pwcsName, ppPropId, pPropType,    \
                               puiWidth)
#define IColumnMapper_IsMapUpToDate(This) (This)->lpVtbl->IsMapUpToDate(This)
#endif
#endif
HRESULT WINAPI IColumnMapper_GetPropInfoFromName_Proxy(IColumnMapper *This,
                                                       const WCHAR *wcsPropName,
                                                       DBID **ppPropId,
                                                       DBTYPE *pPropType,
                                                       unsigned int *puiWidth);
void __RPC_STUB IColumnMapper_GetPropInfoFromName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IColumnMapper_GetPropInfoFromId_Proxy(IColumnMapper *This,
                                                     const DBID *pPropId,
                                                     WCHAR **pwcsName,
                                                     DBTYPE *pPropType,
                                                     unsigned int *puiWidth);
void __RPC_STUB IColumnMapper_GetPropInfoFromId_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IColumnMapper_EnumPropInfo_Proxy(
    IColumnMapper *This, ULONG iEntry, const WCHAR **pwcsName, DBID **ppPropId,
    DBTYPE *pPropType, unsigned int *puiWidth);
...
public:
  virtual HRESULT WINAPI GetColumnMapper(const WCHAR *wcsMachineName,
                                         const WCHAR *wcsCatalogName,
                                         IColumnMapper **ppColumnMapper) = 0;
};
#else
typedef struct IColumnMapperCreatorVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IColumnMapperCreator *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IColumnMapperCreator *This);
  ULONG(WINAPI *Release)(IColumnMapperCreator *This);
  HRESULT(WINAPI *GetColumnMapper)(IColumnMapperCreator *This,
...
#define IColumnMapperCreator_GetColumnMapper(This, wcsMachineName,             \
                                             wcsCatalogName, ppColumnMapper)   \
  (This)->lpVtbl->GetColumnMapper(This, wcsMachineName, wcsCatalogName,        \
                                  ppColumnMapper)
#endif
#endif
HRESULT WINAPI IColumnMapperCreator_GetColumnMapper_Proxy(
    IColumnMapperCreator *This, const WCHAR *wcsMachineName,
    const WCHAR *wcsCatalogName, IColumnMapper **ppColumnMapper);
