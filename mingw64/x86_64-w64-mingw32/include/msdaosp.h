...
extern const GUID CLSID_MSDAOSP = {
    ...
    0xe378,
    0x11d0,
    {0x9b, 0x30, 0x0, 0x80, 0xc7, 0xe9, 0xfe, 0x95}};
extern const GUID DBPROPSET_PWROWSET = {
    0xe6e478db,
    0xf226,
    0x11d0,
    {0x94, 0xee, 0x0, 0xc0, 0x4f, 0xb6, 0x6a, 0x50}};
#else
extern const GUID CLSID_MSDAOSP;
extern const GUID DBPROPSET_PWROWSET;
#endif
...
typedef struct DataSourceObjectVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(DataSourceObject *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(DataSourceObject *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(DataSourceObject *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(DataSourceObject *This, DISPID dispIdMember,
...
#define DataSourceObject_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,    \
                                       rgDispId)                               \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define DataSourceObject_Invoke(This, dispIdMember, riid, lcid, wFlags,        \
