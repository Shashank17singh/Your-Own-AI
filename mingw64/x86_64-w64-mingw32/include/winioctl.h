...
#define FAR
#endif
DEFINE_GUID(GUID_DEVINTERFACE_DISK, 0x53f56307, 0xb6bf, 0x11d0, 0x94, 0xf2,
            0x00, 0xa0, 0xc9, 0x1e, 0xfb, 0x8b);
DEFINE_GUID(GUID_DEVINTERFACE_CDROM, 0x53f56308, 0xb6bf, 0x11d0, 0x94, 0xf2,
            0x00, 0xa0, 0xc9, 0x1e, 0xfb, 0x8b);
DEFINE_GUID(GUID_DEVINTERFACE_PARTITION, 0x53f5630a, 0xb6bf, 0x11d0, 0x94, 0xf2,
            0x00, 0xa0, 0xc9, 0x1e, 0xfb, 0x8b);
DEFINE_GUID(GUID_DEVINTERFACE_TAPE, 0x53f5630b, 0xb6bf, 0x11d0, 0x94, 0xf2,
            0x00, 0xa0, 0xc9, 0x1e, 0xfb, 0x8b);
DEFINE_GUID(GUID_DEVINTERFACE_WRITEONCEDISK, 0x53f5630c, 0xb6bf, 0x11d0, 0x94,
            0xf2, 0x00, 0xa0, 0xc9, 0x1e, 0xfb, 0x8b);
DEFINE_GUID(GUID_DEVINTERFACE_VOLUME, 0x53f5630d, 0xb6bf, 0x11d0, 0x94, 0xf2,
            0x00, 0xa0, 0xc9, 0x1e, 0xfb, 0x8b);
DEFINE_GUID(GUID_DEVINTERFACE_MEDIUMCHANGER, 0x53f56310, 0xb6bf, 0x11d0, 0x94,
            0xf2, 0x00, 0xa0, 0xc9, 0x1e, 0xfb, 0x8b);
DEFINE_GUID(GUID_DEVINTERFACE_FLOPPY, 0x53f56311, 0xb6bf, 0x11d0, 0x94, 0xf2,
            0x00, 0xa0, 0xc9, 0x1e, 0xfb, 0x8b);
DEFINE_GUID(GUID_DEVINTERFACE_CDCHANGER, 0x53f56312, 0xb6bf, 0x11d0, 0x94, 0xf2,
            0x00, 0xa0, 0xc9, 0x1e, 0xfb, 0x8b);
DEFINE_GUID(GUID_DEVINTERFACE_STORAGEPORT, 0x2accfe60, 0xc130, 0x11d2, 0xb0,
            0x82, 0x00, 0xa0, 0xc9, 0x1e, 0xfb, 0x8b);
DEFINE_GUID(GUID_DEVINTERFACE_VMLUN, 0x6f416619, 0x9f29, 0x42a5, 0xb2, 0x0b,
            0x37, 0xe2, 0x19, 0xca, 0x02, 0xb0);
DEFINE_GUID(GUID_DEVINTERFACE_SES, 0x1790c9ec, 0x47d5, 0x4df3, 0xb5, 0xaf, 0x9a,
            0xdf, 0x3c, 0xf2, 0x3e, 0x48);
DEFINE_GUID(GUID_DEVINTERFACE_ZNSDISK, 0xb87941c5, 0xffdb, 0x43c7, 0xb6, 0xb1,
            0x20, 0xb6, 0x32, 0xf0, 0xb1, 0x09);
#define WDI_STORAGE_PREDICT_FAILURE_DPS_GUID                                   \
  {0xe9f2d03a,                                                                 \
   0x747c,                                                                     \
   0x41c2,                                                                     \
   {0xbb, 0x9a, 0x02, 0xc6, 0x2b, 0x6d, 0x5f, 0xcb}};
DEFINE_GUID(GUID_DEVINTERFACE_SERVICE_VOLUME, 0x6ead3d82, 0x25ec, 0x46bc, 0xb7,
            0xfd, 0xc1, 0xf0, 0xdf, 0x8f, 0x50, 0x37);
DEFINE_GUID(GUID_DEVINTERFACE_HIDDEN_VOLUME, 0x7f108a28, 0x9833, 0x4b3b, 0xb7,
            0x80, 0x2c, 0x6b, 0x5f, 0xa5, 0xc0, 0x62);
DEFINE_GUID(GUID_DEVINTERFACE_UNIFIED_ACCESS_RPMB, 0x27447c21, 0xbcc3, 0x4d07,
            0xa0, 0x5b, 0xa3, 0x39, 0x5b, 0xb4, 0xee, 0xe7);
DEFINE_GUID(GUID_DEVINTERFACE_SCM_PHYSICAL_DEVICE, 0x4283609d, 0x4dc2, 0x43be,
            0xbb, 0xb4, 0x4f, 0x15, 0xdf, 0xce, 0x2c, 0x61);
DEFINE_GUID(GUID_SCM_PD_HEALTH_NOTIFICATION, 0x9da2d386, 0x72f5, 0x4ee3, 0x81,
            0x55, 0xec, 0xa0, 0x67, 0x8e, 0x3b, 0x6);
DEFINE_GUID(GUID_SCM_PD_PASSTHROUGH_INVDIMM, 0x4309ac30, 0x0d11, 0x11e4, 0x91,
...
DEFINE_DEVPROPKEY(DEVPKEY_Storage_Removable_Media, 0x4d1ebee8, 0x803, 0x4774,
                  0x98, 0x42, 0xb7, 0x7d, 0xb5, 0x2, 0x65, 0xe9, 3);
DEFINE_DEVPROPKEY(DEVPKEY_Storage_System_Critical, 0x4d1ebee8, 0x803, 0x4774,
                  0x98, 0x42, 0xb7, 0x7d, 0xb5, 0x2, 0x65, 0xe9, 4);
DEFINE_DEVPROPKEY(DEVPKEY_Storage_Disk_Number, 0x4d1ebee8, 0x803, 0x4774, 0x98,
                  0x42, 0xb7, 0x7d, 0xb5, 0x2, 0x65, 0xe9, 5);
DEFINE_DEVPROPKEY(DEVPKEY_Storage_Partition_Number, 0x4d1ebee8, 0x803, 0x4774,
                  0x98, 0x42, 0xb7, 0x7d, 0xb5, 0x2, 0x65, 0xe9, 6);
...
#define IOCTL_STORAGE_SET_HOTPLUG_INFO                                         \
  CTL_CODE(IOCTL_STORAGE_BASE, 0x0306, METHOD_BUFFERED,                        \
...
#define IOCTL_STORAGE_PERSISTENT_RESERVE_OUT                                   \
  CTL_CODE(IOCTL_STORAGE_BASE, 0x0407, METHOD_BUFFERED,                        \
           FILE_READ_ACCESS | FILE_WRITE_ACCESS)
...
#define IOCTL_STORAGE_GET_DEVICE_TELEMETRY                                     \
  CTL_CODE(IOCTL_STORAGE_BASE, 0x0470, METHOD_BUFFERED,                        \
           FILE_READ_ACCESS | FILE_WRITE_ACCESS)
#define IOCTL_STORAGE_DEVICE_TELEMETRY_NOTIFY                                  \
  CTL_CODE(IOCTL_STORAGE_BASE, 0x0471, METHOD_BUFFERED,                        \
           FILE_READ_ACCESS | FILE_WRITE_ACCESS)
#define IOCTL_STORAGE_DEVICE_TELEMETRY_QUERY_CAPS                              \
  CTL_CODE(IOCTL_STORAGE_BASE, 0x0472, METHOD_BUFFERED,                        \
           FILE_READ_ACCESS | FILE_WRITE_ACCESS)
#define IOCTL_STORAGE_GET_DEVICE_TELEMETRY_RAW                                 \
  CTL_CODE(IOCTL_STORAGE_BASE, 0x0473, METHOD_BUFFERED,                        \
           FILE_READ_ACCESS | FILE_WRITE_ACCESS)
#define IOCTL_STORAGE_SET_TEMPERATURE_THRESHOLD                                \
  CTL_CODE(IOCTL_STORAGE_BASE, 0x0480, METHOD_BUFFERED,                        \
           FILE_READ_ACCESS | FILE_WRITE_ACCESS)
#define IOCTL_STORAGE_PROTOCOL_COMMAND                                         \
  CTL_CODE(IOCTL_STORAGE_BASE, 0x04F0, METHOD_BUFFERED,                        \
           FILE_READ_ACCESS | FILE_WRITE_ACCESS)
#define IOCTL_STORAGE_SET_PROPERTY                                             \
  CTL_CODE(IOCTL_STORAGE_BASE, 0x04FF, METHOD_BUFFERED, FILE_WRITE_ACCESS)
...
#define IOCTL_STORAGE_REINITIALIZE_MEDIA                                       \
...
#define IOCTL_STORAGE_ALLOCATE_BC_STREAM                                       \
  CTL_CODE(IOCTL_STORAGE_BASE, 0x0601, METHOD_BUFFERED,                        \
           FILE_READ_ACCESS | FILE_WRITE_ACCESS)
#define IOCTL_STORAGE_FREE_BC_STREAM                                           \
  CTL_CODE(IOCTL_STORAGE_BASE, 0x0602, METHOD_BUFFERED,                        \
           FILE_READ_ACCESS | FILE_WRITE_ACCESS)
...
#define IOCTL_STORAGE_START_DATA_INTEGRITY_CHECK                               \
  CTL_CODE(IOCTL_STORAGE_BASE, 0x0621, METHOD_BUFFERED,                        \
           FILE_READ_ACCESS | FILE_WRITE_ACCESS)
#define IOCTL_STORAGE_STOP_DATA_INTEGRITY_CHECK                                \
  CTL_CODE(IOCTL_STORAGE_BASE, 0x0622, METHOD_BUFFERED,                        \
           FILE_READ_ACCESS | FILE_WRITE_ACCESS)
#define OBSOLETE_IOCTL_STORAGE_RESET_BUS                                       \
  CTL_CODE(IOCTL_STORAGE_BASE, 0x0400, METHOD_BUFFERED,                        \
           FILE_READ_ACCESS | FILE_WRITE_ACCESS)
#define OBSOLETE_IOCTL_STORAGE_RESET_DEVICE                                    \
  CTL_CODE(IOCTL_STORAGE_BASE, 0x0401, METHOD_BUFFERED,                        \
           FILE_READ_ACCESS | FILE_WRITE_ACCESS)
...
#define IOCTL_STORAGE_FIRMWARE_ACTIVATE                                        \
  CTL_CODE(IOCTL_STORAGE_BASE, 0x0702, METHOD_BUFFERED,                        \
           FILE_READ_ACCESS | FILE_WRITE_ACCESS)
...
#define IOCTL_STORAGE_ATTRIBUTE_MANAGEMENT                                     \
  CTL_CODE(IOCTL_STORAGE_BASE, 0x0727, METHOD_BUFFERED,                        \
           FILE_READ_ACCESS | FILE_WRITE_ACCESS)
...
#define IsDsmActionNonDestructive(x)                                           \
  ((BOOLEAN)(!!((x) & DeviceDsmActionFlag_NonDestructive)))
...
#define SupportsDeviceSharing(BusType)                                         \
  ((BusType == BusTypeScsi) || (BusType == BusTypeFibre) ||                    \
   (BusType == BusTypeiScsi) || (BusType == BusTypeSas) ||                     \
...
#define IOCTL_DISK_REASSIGN_BLOCKS_EX                                          \
  CTL_CODE(IOCTL_DISK_BASE, 0x0029, METHOD_BUFFERED,                           \
           FILE_READ_ACCESS | FILE_WRITE_ACCESS)
#define IOCTL_DISK_UPDATE_DRIVE_SIZE                                           \
  CTL_CODE(IOCTL_DISK_BASE, 0x0032, METHOD_BUFFERED,                           \
           FILE_READ_ACCESS | FILE_WRITE_ACCESS)
#define IOCTL_DISK_GROW_PARTITION                                              \
  CTL_CODE(IOCTL_DISK_BASE, 0x0034, METHOD_BUFFERED,                           \
           FILE_READ_ACCESS | FILE_WRITE_ACCESS)
...
#define IOCTL_DISK_SET_CACHE_INFORMATION                                       \
  CTL_CODE(IOCTL_DISK_BASE, 0x0036, METHOD_BUFFERED,                           \
           FILE_READ_ACCESS | FILE_WRITE_ACCESS)
...
#define IOCTL_DISK_DELETE_DRIVE_LAYOUT                                         \
  CTL_CODE(IOCTL_DISK_BASE, 0x0040, METHOD_BUFFERED,                           \
           FILE_READ_ACCESS | FILE_WRITE_ACCESS)
...
#define IOCTL_DISK_RESET_SNAPSHOT_INFO                                         \
  CTL_CODE(IOCTL_DISK_BASE, 0x0084, METHOD_BUFFERED,                           \
           FILE_READ_ACCESS | FILE_WRITE_ACCESS)
#define IOCTL_DISK_FORMAT_DRIVE                                                \
  CTL_CODE(IOCTL_DISK_BASE, 0x00f3, METHOD_BUFFERED,                           \
           FILE_READ_ACCESS | FILE_WRITE_ACCESS)
...
#define DiskGeometryGetDetect(Geometry)                                        \
  ((PDISK_DETECTION_INFO)((                                                    \
      (DWORD_PTR)DiskGeometryGetPartition(Geometry) +                          \
...
#define FSCTL_SPARSE_OVERALLOCATE                                              \
  CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 211, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)
...
#define FSCTL_INITIATE_FILE_METADATA_OPTIMIZATION                              \
  CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 215, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)
#define FSCTL_QUERY_FILE_METADATA_OPTIMIZATION                                 \
  CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 216, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)
...
#define FSCTL_START_VIRTUALIZATION_INSTANCE                                    \
  CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 240, METHOD_BUFFERED, FILE_ANY_ACCESS)
...
#define IOCTL_VOLUME_ONLINE                                                    \
  CTL_CODE(IOCTL_VOLUME_BASE, 2, METHOD_BUFFERED,                              \
           FILE_READ_ACCESS | FILE_WRITE_ACCESS)
#define IOCTL_VOLUME_OFFLINE                                                   \
  CTL_CODE(IOCTL_VOLUME_BASE, 3, METHOD_BUFFERED,                              \
           FILE_READ_ACCESS | FILE_WRITE_ACCESS)
