...
NETIO_STATUS NETIOAPI_API_ GetIpInterfaceTable(ADDRESS_FAMILY Family,
                                               PMIB_IPINTERFACE_TABLE *Table);
VOID NETIOAPI_API_ InitializeIpInterfaceEntry(PMIB_IPINTERFACE_ROW Row);
NETIO_STATUS NETIOAPI_API_ NotifyIpInterfaceChange(
    ADDRESS_FAMILY Family, PIPINTERFACE_CHANGE_CALLBACK Callback,
    PVOID CallerContext, BOOLEAN InitialNotification,
    HANDLE *NotificationHandle);
NETIO_STATUS NETIOAPI_API_ SetIpInterfaceEntry(PMIB_IPINTERFACE_ROW Row);
NETIO_STATUS NETIOAPI_API_ GetIpNetworkConnectionBandwidthEstimates(
    NET_IFINDEX InterfaceIndex, ADDRESS_FAMILY AddressFamily,
    PMIB_IP_NETWORK_CONNECTION_BANDWIDTH_ESTIMATES BandwidthEstimates);
NETIO_STATUS NETIOAPI_API_
CreateUnicastIpAddressEntry(CONST MIB_UNICASTIPADDRESS_ROW *Row);
NETIO_STATUS NETIOAPI_API_
DeleteUnicastIpAddressEntry(CONST MIB_UNICASTIPADDRESS_ROW *Row);
NETIO_STATUS NETIOAPI_API_
GetUnicastIpAddressEntry(PMIB_UNICASTIPADDRESS_ROW Row);
NETIO_STATUS NETIOAPI_API_ GetUnicastIpAddressTable(
    ADDRESS_FAMILY Family, PMIB_UNICASTIPADDRESS_TABLE *Table);
VOID NETIOAPI_API_
InitializeUnicastIpAddressEntry(PMIB_UNICASTIPADDRESS_ROW Row);
NETIO_STATUS NETIOAPI_API_ NotifyUnicastIpAddressChange(
    ADDRESS_FAMILY Family, PUNICAST_IPADDRESS_CHANGE_CALLBACK Callback,
    PVOID CallerContext, BOOLEAN InitialNotification,
    HANDLE *NotificationHandle);
NETIO_STATUS NETIOAPI_API_
CreateAnycastIpAddressEntry(CONST MIB_ANYCASTIPADDRESS_ROW *Row);
NETIO_STATUS NETIOAPI_API_
DeleteAnycastIpAddressEntry(CONST MIB_ANYCASTIPADDRESS_ROW *Row);
NETIO_STATUS NETIOAPI_API_
GetAnycastIpAddressEntry(PMIB_ANYCASTIPADDRESS_ROW Row);
NETIO_STATUS NETIOAPI_API_ GetAnycastIpAddressTable(
    ADDRESS_FAMILY Family, PMIB_ANYCASTIPADDRESS_TABLE *Table);
NETIO_STATUS NETIOAPI_API_ NotifyStableUnicastIpAddressTable(
    ADDRESS_FAMILY Family, PMIB_UNICASTIPADDRESS_TABLE *Table,
    PSTABLE_UNICAST_IPADDRESS_TABLE_CALLBACK CallerCallback,
    PVOID CallerContext, HANDLE *NotificationHandle);
NETIO_STATUS NETIOAPI_API_
SetUnicastIpAddressEntry(CONST MIB_UNICASTIPADDRESS_ROW *Row);
NETIO_STATUS NETIOAPI_API_
GetMulticastIpAddressEntry(PMIB_MULTICASTIPADDRESS_ROW Row);
NETIO_STATUS NETIOAPI_API_ GetMulticastIpAddressTable(
    ADDRESS_FAMILY Family, PMIB_MULTICASTIPADDRESS_TABLE *Table);
...
GetBestRoute2(NET_LUID *InterfaceLuid, NET_IFINDEX InterfaceIndex,
              ...
              CONST SOCKADDR_INET *DestinationAddress, ULONG AddressSortOptions,
              PMIB_IPFORWARD_ROW2 BestRoute, SOCKADDR_INET *BestSourceAddress);
NETIO_STATUS NETIOAPI_API_ GetIpForwardEntry2(PMIB_IPFORWARD_ROW2 Row);
NETIO_STATUS NETIOAPI_API_ GetIpForwardTable2(ADDRESS_FAMILY Family,
                                              PMIB_IPFORWARD_TABLE2 *Table);
VOID NETIOAPI_API_ InitializeIpForwardEntry(PMIB_IPFORWARD_ROW2 Row);
NETIO_STATUS NETIOAPI_API_
NotifyRouteChange2(ADDRESS_FAMILY AddressFamily,
                   PIPFORWARD_CHANGE_CALLBACK Callback, PVOID CallerContext,
...
NETIO_STATUS NETIOAPI_API_ GetIpPathTable(ADDRESS_FAMILY Family,
...
NETIO_STATUS NETIOAPI_API_ FlushIpNetTable2(ADDRESS_FAMILY Family,
                                            NET_IFINDEX InterfaceIndex);
NETIO_STATUS NETIOAPI_API_ GetIpNetEntry2(PMIB_IPNET_ROW2 Row);
NETIO_STATUS NETIOAPI_API_ GetIpNetTable2(ADDRESS_FAMILY Family,
...
NETIO_STATUS NETIOAPI_API_ NotifyTeredoPortChange(
    PTEREDO_PORT_CHANGE_CALLBACK Callback, PVOID CallerContext,
    BOOLEAN InitialNotification, HANDLE *NotificationHandle);
...
NETIO_STATUS NETIOAPI_API_ CreateSortedAddressPairs(
    const PSOCKADDR_IN6 SourceAddressList, ULONG SourceAddressCount,
    const PSOCKADDR_IN6 DestinationAddressList, ULONG DestinationAddressCount,
    ULONG AddressSortOptions, PSOCKADDR_IN6_PAIR *SortedAddressPairList,
    ULONG *SortedAddressPairCount);
#endif
NETIO_STATUS NETIOAPI_API_
ConvertInterfaceNameToLuidA(CONST CHAR *InterfaceName, NET_LUID *InterfaceLuid);
NETIO_STATUS NETIOAPI_API_ ConvertInterfaceNameToLuidW(
    CONST WCHAR *InterfaceName, NET_LUID *InterfaceLuid);
NETIO_STATUS NETIOAPI_API_ ConvertInterfaceLuidToNameA(
    CONST NET_LUID *InterfaceLuid, PSTR InterfaceName, SIZE_T Length);
NETIO_STATUS NETIOAPI_API_ ConvertInterfaceLuidToNameW(
    CONST NET_LUID *InterfaceLuid, PWSTR InterfaceName, SIZE_T Length);
NETIO_STATUS NETIOAPI_API_ ConvertInterfaceLuidToIndex(
    CONST NET_LUID *InterfaceLuid, PNET_IFINDEX InterfaceIndex);
NETIO_STATUS NETIOAPI_API_ ConvertInterfaceIndexToLuid(
    NET_IFINDEX InterfaceIndex, PNET_LUID InterfaceLuid);
NETIO_STATUS NETIOAPI_API_ ConvertInterfaceLuidToAlias(
    CONST NET_LUID *InterfaceLuid, PWSTR InterfaceAlias, SIZE_T Length);
NETIO_STATUS NETIOAPI_API_ ConvertInterfaceAliasToLuid(
    CONST WCHAR *InterfaceAlias, PNET_LUID InterfaceLuid);
NETIO_STATUS NETIOAPI_API_
ConvertInterfaceLuidToGuid(CONST NET_LUID *InterfaceLuid, GUID *InterfaceGuid);
NETIO_STATUS NETIOAPI_API_ ConvertInterfaceGuidToLuid(CONST GUID *InterfaceGuid,
                                                      PNET_LUID InterfaceLuid);
NET_IFINDEX NETIOAPI_API_ if_nametoindex(PCSTR InterfaceName);
PCHAR NETIOAPI_API_ if_indextoname(NET_IFINDEX InterfaceIndex,
                                   PCHAR InterfaceName);
...
NETIO_STATUS NETIOAPI_API_
GetNetworkInformation(CONST NET_IF_NETWORK_GUID *NetworkGuid,
                      PNET_IF_COMPARTMENT_ID CompartmentId, PULONG SiteId,
                      PWCHAR NetworkName, ULONG Length);
NETIO_STATUS NETIOAPI_API_ SetNetworkInformation(
    CONST NET_IF_NETWORK_GUID *NetworkGuid, NET_IF_COMPARTMENT_ID CompartmentId,
    CONST WCHAR *NetworkName);
NETIO_STATUS NETIOAPI_API_ ConvertLengthToIpv4Mask(ULONG MaskLength,
                                                   PULONG Mask);
NETIO_STATUS NETIOAPI_API_ ConvertIpv4MaskToLength(ULONG Mask,
                                                   PUINT8 MaskLength);
#ifdef __cplusplus
}
#endif
