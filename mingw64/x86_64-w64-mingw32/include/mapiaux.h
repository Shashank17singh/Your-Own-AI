...
#define MAPI_IMSGSERVICEADMIN_METHODS(IPURE)                                   \
  ...
  #define MAPI_IMSGSERVICEADMIN_METHODS2(IPURE)                                \
      MAPIMETHOD(CreateMsgServiceEx)(                                          \
          THIS_ LPTSTR lpszService, LPTSTR lpszDisplayName,                    \
          ULONG_PTR ulUIParam, ULONG ulFlags, LPMAPIUID lpuidService) IPURE;   \
  #undef INTERFACE
#define INTERFACE IMsgServiceAdmin2
DECLARE_MAPI_INTERFACE_(IMsgServiceAdmin2,
