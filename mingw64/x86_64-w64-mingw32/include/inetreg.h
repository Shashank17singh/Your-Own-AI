...
#define REGSTR_PATH_INETCPL_PS_EXTENTIONS                                      \
  TSZWINCURVERPATH TEXT("\\Controls Folder\\Internet")
...
#define REGSTR_PATH_DEFAULT_HTML_EDITOR                                        \
  TSZIEPATH TEXT("\\") TEXT(SZ_IE_DEFAULT_HTML_EDITOR)
#define REGSTR_KEY_DEFAULT_HTML_EDITOR TEXT(SZ_IE_DEFAULT_HTML_EDITOR)
#define REGSTR_PATH_AUTOCOMPLETE                                               \
  TSZWINCURVERPATH TEXT("\\Explorer\\AutoComplete")
...
#define REGSTR_PATH_INTERNET_LAN_SETTINGS                                      \
  REGSTR_PATH_INTERNETSETTINGS TEXT("\\LAN")
...
#define REGSTR_PATH_INETCPL_RESTRICTIONS                                       \
  TEXT("Software\\Policies\\Microsoft\\Internet Explorer\\Control Panel")
...
#define REGSTR_PATH_SEARCHSTRINGS                                              \
  REGSTR_PATH_MAIN TEXT("\\") TEXT(SZ_IE_SEARCHSTRINGS)
...
#define REGSTR_PATH_THRESHOLDS                                                 \
  REGSTR_PATH_MAIN TEXT("\\") TEXT(SZ_IE_THRESHOLDS)
...
#define REGSTR_PATH_RNACOMPONENT                                               \
  TSZWINCURVERPATH TEXT("\\Setup\\OptionalComponents\\RNA")
...
#define REGSTR_VAL_SECURITYDISABLECACHINGOFSSLPAGES                            \
  TEXT("DisableCachingOfSSLPages")
...
#define TSZSCHANNELPATH                                                        \
  TEXT("SYSTEM\\CurrentControlSet\\Control\\SecurityProviders\\SCHANNEL")
...
#define REGSTR_PATH_UNIHELLO                                                   \
  TSZSCHANNELPROTOCOLSPATH TEXT("\\Multi-Protocol Unified Hello\\Client")
...
#define REGSTR_PATH_INTERNATIONAL_SCRIPTS                                      \
  TSZIEPATH TEXT("\\International\\Scripts")
...
#define REGSTR_KEY_MIME_DATABASE_CHARSET                                       \
  REGSTR_PATH_MIME_DATABASE TEXT("\\Charset")
#define REGSTR_KEY_MIME_DATABASE_CODEPAGE                                      \
  REGSTR_PATH_MIME_DATABASE TEXT("\\CodePage")
#define REGSTR_KEY_MIME_DATABASE_RFC1766                                       \
  REGSTR_PATH_MIME_DATABASE TEXT("\\Rfc1766")
