...
typedef struct _ADODynaCollectionVtbl {
  BEGIN_INTERFACE HRESULT(STDMETHODCALLTYPE *QueryInterface)(
      _ADODynaCollection *This, REFIID riid, _COM_Outptr_ void **ppvObject);
...
typedef struct _ADOVtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(_ADO *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
...
typedef struct ErrorVtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ADOError *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
...
typedef struct ErrorsVtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ADOErrors *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE CreateParameter(
      BSTR Name, DataTypeEnum Type, ParameterDirectionEnum Direction, long Size,
      VARIANT Value, _ADOParameter **ppiprm) = 0;
...
typedef struct Command15Vtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(Command15 *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
...
typedef struct Command25Vtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(Command25 *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
...
typedef struct _CommandVtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(_ADOCommand *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
...
typedef struct ConnectionEventsVtVtbl {
  BEGIN_INTERFACE HRESULT(STDMETHODCALLTYPE *QueryInterface)(
      ConnectionEventsVt *This, REFIID riid, _COM_Outptr_ void **ppvObject);
...
typedef struct RecordsetEventsVtVtbl {
  BEGIN_INTERFACE HRESULT(STDMETHODCALLTYPE *QueryInterface)(
      RecordsetEventsVt *This, REFIID riid, _COM_Outptr_ void **ppvObject);
...
typedef struct ConnectionEventsVtbl {
  BEGIN_INTERFACE HRESULT(STDMETHODCALLTYPE *QueryInterface)(
      ConnectionEvents *This, REFIID riid, _COM_Outptr_ void **ppvObject);
...
typedef struct Connection15Vtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(Connection15 *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
...
typedef struct _RecordVtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(_ADORecord *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
...
typedef struct _StreamVtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(_ADOStream *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
...
typedef struct ADORecordConstructionVtbl {
  BEGIN_INTERFACE HRESULT(STDMETHODCALLTYPE *QueryInterface)(
      ADORecordConstruction *This, REFIID riid, _COM_Outptr_ void **ppvObject);
...
typedef struct ADOStreamConstructionVtbl {
  BEGIN_INTERFACE HRESULT(STDMETHODCALLTYPE *QueryInterface)(
      ADOStreamConstruction *This, REFIID riid, _COM_Outptr_ void **ppvObject);
...
typedef struct ADOCommandConstructionVtbl {
  BEGIN_INTERFACE HRESULT(STDMETHODCALLTYPE *QueryInterface)(
      ADOCommandConstruction *This, REFIID riid, _COM_Outptr_ void **ppvObject);
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE Find(BSTR Criteria, long SkipRecords,
...
typedef struct Recordset15Vtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(Recordset15 *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetRows)(Recordset15 *This, long Rows,
                                      ...
                                      VARIANT *pvar);
  HRESULT(STDMETHODCALLTYPE *Move)(Recordset15 *This, long NumRecords,
                                   VARIANT Start);
...
typedef struct Recordset20Vtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(Recordset20 *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetRows)(Recordset20 *This, long Rows,
                                      VARIANT Start, VARIANT Fields,
                                      VARIANT *pvar);
  HRESULT(STDMETHODCALLTYPE *Move)(Recordset20 *This, long NumRecords,
                                   VARIANT Start);
...
typedef struct Recordset21Vtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(Recordset21 *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetRows)(Recordset21 *This, long Rows,
                                      VARIANT Start, VARIANT Fields,
                                      VARIANT *pvar);
  HRESULT(STDMETHODCALLTYPE *Move)(Recordset21 *This, long NumRecords,
                                   VARIANT Start);
...
typedef struct _RecordsetVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *GetRows)(_ADORecordset *This, long Rows,
                                      VARIANT Start, VARIANT Fields,
                                      VARIANT *pvar);
  HRESULT(STDMETHODCALLTYPE *Move)(_ADORecordset *This, long NumRecords,
                                   VARIANT Start);
...
typedef struct Field15Vtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(Field15 *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
...
typedef struct Field20Vtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(Field20 *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
...
typedef struct FieldVtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ADOField *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
...
typedef struct Fields15Vtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(Fields15 *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
...
public:
  virtual HRESULT STDMETHODCALLTYPE _Append(
      BSTR Name, DataTypeEnum Type, long DefinedSize = 0,
...
typedef struct Fields20Vtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(Fields20 *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *_Append)(Fields20 *This, BSTR Name,
                                      DataTypeEnum Type, long DefinedSize,
...
public:
  virtual HRESULT STDMETHODCALLTYPE Append(
      BSTR Name, DataTypeEnum Type, long DefinedSize, FieldAttributeEnum Attrib,
      VARIANT FieldValue) = 0;
...
typedef struct FieldsVtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ADOFields *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
...
typedef struct PropertyVtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ADOProperty *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
