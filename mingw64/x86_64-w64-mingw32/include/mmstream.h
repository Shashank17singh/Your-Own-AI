...
enum { SSUPDATE_ASYNC = 0x1, SSUPDATE_CONTINUOUS = 0x2 };
#ifndef __IMultiMediaStream_FWD_DEFINED__
#define __IMultiMediaStream_FWD_DEFINED__
typedef interface IMultiMediaStream IMultiMediaStream;
#ifdef __cplusplus
...
DEFINE_GUID(IID_IMultiMediaStream, 0xb502d1bc, 0x9a57, 0x11d0, 0x8f, 0xde, 0x00,
            0xc0, 0x4f, 0xd9, 0x18, 0x9d);
...
IMultiMediaStream : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetInformation(
      DWORD * pdwFlags, STREAM_TYPE * pStreamType) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetState(STREAM_STATE * pCurrentState) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetState(STREAM_STATE NewState) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetTime(STREAM_TIME * pCurrentTime) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetDuration(STREAM_TIME * pDuration) = 0;
  virtual HRESULT STDMETHODCALLTYPE Seek(STREAM_TIME SeekTime) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetEndOfStreamEventHandle(HANDLE *
                                                              phEOS) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IMultiMediaStream, 0xb502d1bc, 0x9a57, 0x11d0, 0x8f, 0xde, 0x00,
                0xc0, 0x4f, 0xd9, 0x18, 0x9d)
#endif
#else
...
interface IMultiMediaStream { CONST_VTBL IMultiMediaStreamVtbl *lpVtbl; };
#ifdef COBJMACROS
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMultiMediaStream_QueryInterface(IMultiMediaStream *This,
                                                       REFIID riid,
                                                       void **ppvObject) {
...
IMultiMediaStream_GetInformation(IMultiMediaStream *This, DWORD *pdwFlags,
                                 STREAM_TYPE *pStreamType) {
  return This->lpVtbl->GetInformation(This, pdwFlags, pStreamType);
}
static inline HRESULT
IMultiMediaStream_GetMediaStream(IMultiMediaStream *This, REFMSPID idPurpose,
                                 IMediaStream **ppMediaStream) {
  return This->lpVtbl->GetMediaStream(This, idPurpose, ppMediaStream);
}
static inline HRESULT
IMultiMediaStream_EnumMediaStreams(IMultiMediaStream *This, LONG Index,
                                   IMediaStream **ppMediaStream) {
  return This->lpVtbl->EnumMediaStreams(This, Index, ppMediaStream);
}
static inline HRESULT IMultiMediaStream_GetState(IMultiMediaStream *This,
                                                 STREAM_STATE *pCurrentState) {
  return This->lpVtbl->GetState(This, pCurrentState);
}
static inline HRESULT IMultiMediaStream_SetState(IMultiMediaStream *This,
                                                 STREAM_STATE NewState) {
  return This->lpVtbl->SetState(This, NewState);
}
static inline HRESULT IMultiMediaStream_GetTime(IMultiMediaStream *This,
                                                STREAM_TIME *pCurrentTime) {
  return This->lpVtbl->GetTime(This, pCurrentTime);
}
static inline HRESULT IMultiMediaStream_GetDuration(IMultiMediaStream *This,
                                                    STREAM_TIME *pDuration) {
  return This->lpVtbl->GetDuration(This, pDuration);
}
static inline HRESULT IMultiMediaStream_Seek(IMultiMediaStream *This,
                                             STREAM_TIME SeekTime) {
  return This->lpVtbl->Seek(This, SeekTime);
}
static inline HRESULT
IMultiMediaStream_GetEndOfStreamEventHandle(IMultiMediaStream *This,
                                            HANDLE *phEOS) {
...
DEFINE_GUID(IID_IMediaStream, 0xb502d1bd, 0x9a57, 0x11d0, 0x8f, 0xde, 0x00,
            0xc0, 0x4f, 0xd9, 0x18, 0x9d);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IMediaStream : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE GetInformation(MSPID * pPurposeId,
                                                   STREAM_TYPE * pType) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetSameFormat(
      IMediaStream * pStreamThatHasDesiredFormat, DWORD dwFlags) = 0;
  virtual HRESULT STDMETHODCALLTYPE AllocateSample(
      DWORD dwFlags, IStreamSample * *ppSample) = 0;
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IMediaStream, 0xb502d1bd, 0x9a57, 0x11d0, 0x8f, 0xde, 0x00,
                0xc0, 0x4f, 0xd9, 0x18, 0x9d)
#endif
#else
typedef struct IMediaStreamVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IMediaStream *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IMediaStream *This);
  ULONG(STDMETHODCALLTYPE *Release)(IMediaStream *This);
  /*** IMediaStream methods ***/
  HRESULT(STDMETHODCALLTYPE *GetMultiMediaStream)(
      IMediaStream *This, IMultiMediaStream **ppMultiMediaStream);
  HRESULT(STDMETHODCALLTYPE *GetInformation)(IMediaStream *This,
                                             MSPID *pPurposeId,
                                             STREAM_TYPE *pType);
  HRESULT(STDMETHODCALLTYPE *SetSameFormat)(
      IMediaStream *This, IMediaStream *pStreamThatHasDesiredFormat,
      DWORD dwFlags);
  HRESULT(STDMETHODCALLTYPE *AllocateSample)(IMediaStream *This, DWORD dwFlags,
                                             IStreamSample **ppSample);
  HRESULT(STDMETHODCALLTYPE *CreateSharedSample)(IMediaStream *This,
                                                 IStreamSample *pExistingSample,
                                                 DWORD dwFlags,
                                                 IStreamSample **ppNewSample);
  HRESULT(STDMETHODCALLTYPE *SendEndOfStream)(IMediaStream *This,
                                              DWORD dwFlags);
  END_INTERFACE
} IMediaStreamVtbl;
interface IMediaStream { CONST_VTBL IMediaStreamVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
IMediaStream_QueryInterface(IMediaStream *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
DEFINE_GUID(IID_IStreamSample, 0xb502d1be, 0x9a57, 0x11d0, 0x8f, 0xde, 0x00,
            0xc0, 0x4f, 0xd9, 0x18, 0x9d);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("b502d1be-9a57-11d0-8fde-00c04fd9189d")
IStreamSample : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetMediaStream(IMediaStream *
                                                   *ppMediaStream) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetSampleTimes(
      STREAM_TIME * pStartTime, STREAM_TIME * pEndTime,
      STREAM_TIME * pCurrentTime) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetSampleTimes(
      const STREAM_TIME *pStartTime, const STREAM_TIME *pEndTime) = 0;
  virtual HRESULT STDMETHODCALLTYPE Update(
      DWORD dwFlags, HANDLE hEvent, PAPCFUNC pfnAPC, DWORD dwAPCData) = 0;
  virtual HRESULT STDMETHODCALLTYPE CompletionStatus(DWORD dwFlags,
                                                     DWORD dwMilliseconds) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IStreamSample, 0xb502d1be, 0x9a57, 0x11d0, 0x8f, 0xde, 0x00,
                0xc0, 0x4f, 0xd9, 0x18, 0x9d)
#endif
#else
typedef struct IStreamSampleVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IStreamSample *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *Update)(IStreamSample *This, DWORD dwFlags,
...
interface IStreamSample { CONST_VTBL IStreamSampleVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IStreamSample_QueryInterface(IStreamSample *This,
                                                   REFIID riid,
                                                   void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IStreamSample methods ***/
static inline HRESULT
IStreamSample_GetMediaStream(IStreamSample *This,
                             IMediaStream **ppMediaStream) {
  return This->lpVtbl->GetMediaStream(This, ppMediaStream);
}
static inline HRESULT IStreamSample_GetSampleTimes(IStreamSample *This,
                                                   STREAM_TIME *pStartTime,
                                                   STREAM_TIME *pEndTime,
                                                   STREAM_TIME *pCurrentTime) {
...
static inline HRESULT
IStreamSample_SetSampleTimes(IStreamSample *This, const STREAM_TIME *pStartTime,
                             const STREAM_TIME *pEndTime) {
  return This->lpVtbl->SetSampleTimes(This, pStartTime, pEndTime);
}
static inline HRESULT IStreamSample_Update(IStreamSample *This, DWORD dwFlags,
                                           HANDLE hEvent, PAPCFUNC pfnAPC,
                                           DWORD dwAPCData) {
  return This->lpVtbl->Update(This, dwFlags, hEvent, pfnAPC, dwAPCData);
}
static inline HRESULT IStreamSample_CompletionStatus(IStreamSample *This,
                                                     DWORD dwFlags,
                                                     DWORD dwMilliseconds) {
