...
#define IOCTL_INTERNAL_USB_GET_ROOTHUB_PDO                                     \
  CTL_CODE(FILE_DEVICE_USB, USB_GET_ROOTHUB_PDO, METHOD_NEITHER,               \
           FILE_ANY_ACCESS)
#define USBD_PORT_ENABLED 0x00000001
#define USBD_PORT_CONNECTED 0x00000002
#define IOCTL_INTERNAL_USB_GET_PORT_STATUS                                     \
  CTL_CODE(FILE_DEVICE_USB, USB_GET_PORT_STATUS, METHOD_NEITHER,               \
           FILE_ANY_ACCESS)
...
#define IOCTL_INTERNAL_USB_GET_BUSGUID_INFO                                    \
  CTL_CODE(FILE_DEVICE_USB, USB_GET_BUSGUID_INFO, METHOD_BUFFERED,             \
           FILE_ANY_ACCESS)
...
#define IOCTL_INTERNAL_USB_REGISTER_COMPOSITE_DEVICE                           \
  CTL_CODE(FILE_DEVICE_USBEX, USB_REGISTER_COMPOSITE_DEVICE, METHOD_NEITHER,   \
           FILE_ANY_ACCESS)
