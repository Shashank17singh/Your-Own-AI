...
#endif
typedef enum tagEBindInfoOptions { BIO_BINDER = 0x1 } EBindInfoOptions;
...
typedef struct IServiceVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IService *This, REFIID riid,
                                  void **ppvObject);
...
#endif
#endif
HRESULT WINAPI IService_InvokeService_Proxy(IService *This,
                                            IUnknown *pUnkInner);
...
public:
  virtual HRESULT WINAPI PromptDataSource(IUnknown *pUnkOuter, HWND hWndParent,
  ...
  virtual HRESULT WINAPI PromptFileName(HWND hWndParent,
                                        DBPROMPTOPTIONS dwPromptOptions,
                                        LPCOLESTR pwszInitialDirectory,
                                        LPCOLESTR pwszInitialFile,
                                        LPOLESTR *ppwszSelectedFile) = 0;
};
#else
typedef struct IDBPromptInitializeVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IDBPromptInitialize *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IDBPromptInitialize *This);
  ULONG(WINAPI *Release)(IDBPromptInitialize *This);
  HRESULT(WINAPI *PromptDataSource)(IDBPromptInitialize *This,
                                    IUnknown *pUnkOuter, HWND hWndParent,
                                    DBPROMPTOPTIONS dwPromptOptions,
                                    ULONG cSourceTypeFilter,
                                    DBSOURCETYPE *rgSourceTypeFilter,
                                    LPCOLESTR pwszszzProviderFilter,
                                    REFIID riid, IUnknown **ppDataSource);
  HRESULT(WINAPI *PromptFileName)(IDBPromptInitialize *This, HWND hWndParent,
                                  DBPROMPTOPTIONS dwPromptOptions,
                                  LPCOLESTR pwszInitialDirectory,
                                  LPCOLESTR pwszInitialFile,
                                  LPOLESTR *ppwszSelectedFile);
  END_INTERFACE
...
#define IDBPromptInitialize_PromptDataSource(                                  \
    This, pUnkOuter, hWndParent, dwPromptOptions, cSourceTypeFilter,           \
    rgSourceTypeFilter, pwszszzProviderFilter, riid, ppDataSource)             \
  (This)->lpVtbl->PromptDataSource(                                            \
      This, pUnkOuter, hWndParent, dwPromptOptions, cSourceTypeFilter,         \
      rgSourceTypeFilter, pwszszzProviderFilter, riid, ppDataSource)
#define IDBPromptInitialize_PromptFileName(This, hWndParent, dwPromptOptions,  \
                                           pwszInitialDirectory,               \
                                           pwszInitialFile, ppwszSelectedFile) \
  (This)->lpVtbl->PromptFileName(This, hWndParent, dwPromptOptions,            \
                                 pwszInitialDirectory, pwszInitialFile,        \
                                 ppwszSelectedFile)
#endif
#endif
HRESULT WINAPI IDBPromptInitialize_PromptDataSource_Proxy(
    IDBPromptInitialize *This, IUnknown *pUnkOuter, HWND hWndParent,
    DBPROMPTOPTIONS dwPromptOptions, ULONG cSourceTypeFilter,
    DBSOURCETYPE *rgSourceTypeFilter, LPCOLESTR pwszszzProviderFilter,
    REFIID riid, IUnknown **ppDataSource);
void __RPC_STUB IDBPromptInitialize_PromptDataSource_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IDBPromptInitialize_PromptFileName_Proxy(
    IDBPromptInitialize *This, HWND hWndParent, DBPROMPTOPTIONS dwPromptOptions,
    LPCOLESTR pwszInitialDirectory, LPCOLESTR pwszInitialFile,
    LPOLESTR *ppwszSelectedFile);
...
public:
  virtual HRESULT WINAPI GetDataSource(IUnknown *pUnkOuter, DWORD dwClsCtx,
                                       LPCOLESTR pwszInitializationString,
                                       REFIID riid,
                                       IUnknown **ppDataSource) = 0;
  virtual HRESULT WINAPI GetInitializationString(IUnknown *pDataSource,
                                                 boolean fIncludePassword,
                                                 LPOLESTR *ppwszInitString) = 0;
  virtual HRESULT WINAPI CreateDBInstance(REFCLSID clsidProvider,
                                          IUnknown *pUnkOuter, DWORD dwClsCtx,
                                          LPOLESTR pwszReserved, REFIID riid,
                                          IUnknown **ppDataSource) = 0;
  virtual HRESULT WINAPI CreateDBInstanceEx(REFCLSID clsidProvider,
                                            IUnknown *pUnkOuter, DWORD dwClsCtx,
                                            LPOLESTR pwszReserved,
                                            COSERVERINFO *pServerInfo,
                                            ULONG cmq,
                                            MULTI_QI *rgmqResults) = 0;
  virtual HRESULT WINAPI LoadStringFromStorage(
      LPCOLESTR pwszFileName, LPOLESTR *ppwszInitializationString) = 0;
  virtual HRESULT WINAPI WriteStringToStorage(
      LPCOLESTR pwszFileName, LPCOLESTR pwszInitializationString,
      DWORD dwCreationDisposition) = 0;
};
#else
typedef struct IDataInitializeVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IDataInitialize *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IDataInitialize *This);
  ULONG(WINAPI *Release)(IDataInitialize *This);
  HRESULT(WINAPI *GetDataSource)(IDataInitialize *This, IUnknown *pUnkOuter,
                                 DWORD dwClsCtx,
                                 LPCOLESTR pwszInitializationString,
                                 REFIID riid, IUnknown **ppDataSource);
  HRESULT(WINAPI *GetInitializationString)(IDataInitialize *This,
                                           IUnknown *pDataSource,
                                           boolean fIncludePassword,
                                           LPOLESTR *ppwszInitString);
  HRESULT(WINAPI *CreateDBInstance)(IDataInitialize *This,
                                    REFCLSID clsidProvider, IUnknown *pUnkOuter,
                                    DWORD dwClsCtx, LPOLESTR pwszReserved,
                                    REFIID riid, IUnknown **ppDataSource);
  HRESULT(WINAPI *CreateDBInstanceEx)(IDataInitialize *This,
                                      REFCLSID clsidProvider,
                                      IUnknown *pUnkOuter, DWORD dwClsCtx,
                                      LPOLESTR pwszReserved,
                                      COSERVERINFO *pServerInfo, ULONG cmq,
                                      MULTI_QI *rgmqResults);
  HRESULT(WINAPI *LoadStringFromStorage)(IDataInitialize *This,
                                         LPCOLESTR pwszFileName,
                                         LPOLESTR *ppwszInitializationString);
  HRESULT(WINAPI *WriteStringToStorage)(IDataInitialize *This,
                                        LPCOLESTR pwszFileName,
                                        LPCOLESTR pwszInitializationString,
...
#define IDataInitialize_GetDataSource(                                         \
    This, pUnkOuter, dwClsCtx, pwszInitializationString, riid, ppDataSource)   \
  (This)->lpVtbl->GetDataSource(This, pUnkOuter, dwClsCtx,                     \
                                pwszInitializationString, riid, ppDataSource)
#define IDataInitialize_GetInitializationString(                               \
    This, pDataSource, fIncludePassword, ppwszInitString)                      \
  (This)->lpVtbl->GetInitializationString(This, pDataSource, fIncludePassword, \
                                          ppwszInitString)
#define IDataInitialize_CreateDBInstance(This, clsidProvider, pUnkOuter,       \
                                         dwClsCtx, pwszReserved, riid,         \
                                         ppDataSource)                         \
  (This)->lpVtbl->CreateDBInstance(This, clsidProvider, pUnkOuter, dwClsCtx,   \
                                   pwszReserved, riid, ppDataSource)
#define IDataInitialize_CreateDBInstanceEx(This, clsidProvider, pUnkOuter,     \
                                           dwClsCtx, pwszReserved,             \
                                           pServerInfo, cmq, rgmqResults)      \
  (This)->lpVtbl->CreateDBInstanceEx(This, clsidProvider, pUnkOuter, dwClsCtx, \
                                     pwszReserved, pServerInfo, cmq,           \
                                     rgmqResults)
#define IDataInitialize_LoadStringFromStorage(This, pwszFileName,              \
                                              ppwszInitializationString)       \
  (This)->lpVtbl->LoadStringFromStorage(This, pwszFileName,                    \
                                        ppwszInitializationString)
#define IDataInitialize_WriteStringToStorage(                                  \
    This, pwszFileName, pwszInitializationString, dwCreationDisposition)       \
  (This)->lpVtbl->WriteStringToStorage(                                        \
      This, pwszFileName, pwszInitializationString, dwCreationDisposition)
#endif
#endif
HRESULT WINAPI IDataInitialize_GetDataSource_Proxy(
    IDataInitialize *This, IUnknown *pUnkOuter, DWORD dwClsCtx,
    LPCOLESTR pwszInitializationString, REFIID riid, IUnknown **ppDataSource);
void __RPC_STUB IDataInitialize_GetDataSource_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IDataInitialize_GetInitializationString_Proxy(
    IDataInitialize *This, IUnknown *pDataSource, boolean fIncludePassword,
    LPOLESTR *ppwszInitString);
void __RPC_STUB IDataInitialize_GetInitializationString_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IDataInitialize_CreateDBInstance_Proxy(
    IDataInitialize *This, REFCLSID clsidProvider, IUnknown *pUnkOuter,
    DWORD dwClsCtx, LPOLESTR pwszReserved, REFIID riid,
    IUnknown **ppDataSource);
void __RPC_STUB IDataInitialize_CreateDBInstance_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IDataInitialize_RemoteCreateDBInstanceEx_Proxy(
    IDataInitialize *This, REFCLSID clsidProvider, IUnknown *pUnkOuter,
    DWORD dwClsCtx, LPOLESTR pwszReserved, COSERVERINFO *pServerInfo, ULONG cmq,
    const IID **rgpIID, IUnknown **rgpItf, HRESULT *rghr);
void __RPC_STUB IDataInitialize_RemoteCreateDBInstanceEx_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IDataInitialize_LoadStringFromStorage_Proxy(
    IDataInitialize *This, LPCOLESTR pwszFileName,
    LPOLESTR *ppwszInitializationString);
void __RPC_STUB IDataInitialize_LoadStringFromStorage_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IDataInitialize_WriteStringToStorage_Proxy(
    IDataInitialize *This, LPCOLESTR pwszFileName,
...
public:
  ...
  virtual HRESULT WINAPI PromptEdit(IDispatch **ppADOConnection,
                                    VARIANT_BOOL *pbSuccess) = 0;
};
#else
typedef struct IDataSourceLocatorVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IDataSourceLocator *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IDataSourceLocator *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IDataSourceLocator *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IDataSourceLocator *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *get_hWnd)(IDataSourceLocator *This,
                            COMPATIBLE_LONG *phwndParent);
  HRESULT(WINAPI *put_hWnd)(IDataSourceLocator *This,
                            COMPATIBLE_LONG hwndParent);
  HRESULT(WINAPI *PromptNew)(IDataSourceLocator *This,
                             IDispatch **ppADOConnection);
  HRESULT(WINAPI *PromptEdit)(IDataSourceLocator *This,
                              IDispatch **ppADOConnection,
...
#define IDataSourceLocator_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,  \
                                         rgDispId)                             \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IDataSourceLocator_Invoke(This, dispIdMember, riid, lcid, wFlags,      \
...
#endif
#endif
HRESULT WINAPI IDataSourceLocator_get_hWnd_Proxy(IDataSourceLocator *This,
                                                 COMPATIBLE_LONG *phwndParent);
void __RPC_STUB IDataSourceLocator_get_hWnd_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IDataSourceLocator_put_hWnd_Proxy(IDataSourceLocator *This,
                                                 COMPATIBLE_LONG hwndParent);
void __RPC_STUB IDataSourceLocator_put_hWnd_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IDataSourceLocator_PromptNew_Proxy(IDataSourceLocator *This,
                                                  IDispatch **ppADOConnection);
void __RPC_STUB IDataSourceLocator_PromptNew_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IDataSourceLocator_PromptEdit_Proxy(IDataSourceLocator *This,
                                                   IDispatch **ppADOConnection,
                                                   VARIANT_BOOL *pbSuccess);
...
#endif
#endif
HRESULT WINAPI IDataInitialize_CreateDBInstanceEx_Proxy(
    IDataInitialize *This, REFCLSID clsidProvider, IUnknown *pUnkOuter,
    DWORD dwClsCtx, LPOLESTR pwszReserved, COSERVERINFO *pServerInfo, ULONG cmq,
    MULTI_QI *rgmqResults);
HRESULT WINAPI IDataInitialize_CreateDBInstanceEx_Stub(
    IDataInitialize *This, REFCLSID clsidProvider, IUnknown *pUnkOuter,
    DWORD dwClsCtx, LPOLESTR pwszReserved, COSERVERINFO *pServerInfo, ULONG cmq,
    const IID **rgpIID, IUnknown **rgpItf, HRESULT *rghr);
#ifdef __cplusplus
