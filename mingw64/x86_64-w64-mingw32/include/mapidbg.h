...
#define TrapSz2(psz, a1, a2)                                                   \
  IFTRAP(DebugTrapFn(1, __FILE__, __LINE__, psz, a1, a2))
#define TrapSz3(psz, a1, a2, a3)                                               \
  IFTRAP(DebugTrapFn(1, __FILE__, __LINE__, psz, a1, a2, a3))
#define TrapSz4(psz, a1, a2, a3, a4)                                           \
  IFTRAP(DebugTrapFn(1, __FILE__, __LINE__, psz, a1, a2, a3, a4))
#define TrapSz5(psz, a1, a2, a3, a4, a5)                                       \
  IFTRAP(DebugTrapFn(1, __FILE__, __LINE__, psz, a1, a2, a3, a4, a5))
#define TrapSz6(psz, a1, a2, a3, a4, a5, a6)                                   \
  IFTRAP(DebugTrapFn(1, __FILE__, __LINE__, psz, a1, a2, a3, a4, a5, a6))
...
#define TrapSz8(psz, a1, a2, a3, a4, a5, a6, a7, a8)                           \
  IFTRAP(                                                                      \
      DebugTrapFn(1, __FILE__, __LINE__, psz, a1, a2, a3, a4, a5, a6, a7, a8))
#define TrapSz9(psz, a1, a2, a3, a4, a5, a6, a7, a8, a9)                       \
  IFTRAP(DebugTrapFn(1, __FILE__, __LINE__, psz, a1, a2, a3, a4, a5, a6, a7,   \
                     a8, a9))
#define Assert(t)                                                              \
  IFTRAP(                                                                      \
      ((t) ? 0 : DebugTrapFn(1, __FILE__, __LINE__, "Assertion Failure: " #t), \
       0))
#define AssertSz(t, psz)                                                       \
  IFTRAP(((t) ? 0 : DebugTrapFn(1, __FILE__, __LINE__, psz), 0))
#define AssertSz1(t, psz, a1)                                                  \
  IFTRAP(((t) ? 0 : DebugTrapFn(1, __FILE__, __LINE__, psz, a1), 0))
#define AssertSz2(t, psz, a1, a2)                                              \
  IFTRAP(((t) ? 0 : DebugTrapFn(1, __FILE__, __LINE__, psz, a1, a2), 0))
#define AssertSz3(t, psz, a1, a2, a3)                                          \
  IFTRAP(((t) ? 0 : DebugTrapFn(1, __FILE__, __LINE__, psz, a1, a2, a3), 0))
#define AssertSz4(t, psz, a1, a2, a3, a4)                                      \
  IFTRAP(((t) ? 0 : DebugTrapFn(1, __FILE__, __LINE__, psz, a1, a2, a3, a4), 0))
#define AssertSz5(t, psz, a1, a2, a3, a4, a5)                                  \
  IFTRAP(                                                                      \
      ((t) ? 0 : DebugTrapFn(1, __FILE__, __LINE__, psz, a1, a2, a3, a4, a5),  \
       0))
#define AssertSz6(t, psz, a1, a2, a3, a4, a5, a6)                              \
  IFTRAP(                                                                      \
      ((t) ? 0                                                                 \
           : DebugTrapFn(1, __FILE__, __LINE__, psz, a1, a2, a3, a4, a5, a6),  \
       0))
#define AssertSz7(t, psz, a1, a2, a3, a4, a5, a6, a7)                          \
  IFTRAP(((t) ? 0                                                              \
              : DebugTrapFn(1, __FILE__, __LINE__, psz, a1, a2, a3, a4, a5,    \
                            a6, a7),                                           \
          0))
...
#define SideAssert(t)                                                          \
  ((t) ? 0                                                                     \
       : IFTRAP(DebugTrapFn(1, __FILE__, __LINE__, "Assertion Failure: " #t)), \
   0)
#define SideAssertSz(t, psz)                                                   \
  ((t) ? 0 : IFTRAP(DebugTrapFn(1, __FILE__, __LINE__, psz)), 0)
#define SideAssertSz1(t, psz, a1)                                              \
  ((t) ? 0 : IFTRAP(DebugTrapFn(1, __FILE__, __LINE__, psz, a1)), 0)
#define SideAssertSz2(t, psz, a1, a2)                                          \
  ((t) ? 0 : IFTRAP(DebugTrapFn(1, __FILE__, __LINE__, psz, a1, a2)), 0)
#define SideAssertSz3(t, psz, a1, a2, a3)                                      \
  ((t) ? 0 : IFTRAP(DebugTrapFn(1, __FILE__, __LINE__, psz, a1, a2, a3)), 0)
...
#define NFAssert(t)                                                            \
  IFTRAP(                                                                      \
      ((t) ? 0 : DebugTrapFn(0, __FILE__, __LINE__, "Assertion Failure: " #t), \
       0))
#define NFAssertSz(t, psz)                                                     \
  IFTRAP(((t) ? 0 : DebugTrapFn(0, __FILE__, __LINE__, psz), 0))
#define NFAssertSz1(t, psz, a1)                                                \
  IFTRAP(((t) ? 0 : DebugTrapFn(0, __FILE__, __LINE__, psz, a1), 0))
#define NFAssertSz2(t, psz, a1, a2)                                            \
  IFTRAP(((t) ? 0 : DebugTrapFn(0, __FILE__, __LINE__, psz, a1, a2), 0))
#define NFAssertSz3(t, psz, a1, a2, a3)                                        \
  IFTRAP(((t) ? 0 : DebugTrapFn(0, __FILE__, __LINE__, psz, a1, a2, a3), 0))
...
#define NFAssertSz5(t, psz, a1, a2, a3, a4, a5)                                \
  IFTRAP(                                                                      \
      ((t) ? 0 : DebugTrapFn(0, __FILE__, __LINE__, psz, a1, a2, a3, a4, a5),  \
       0))
#define NFAssertSz6(t, psz, a1, a2, a3, a4, a5, a6)                            \
  IFTRAP(                                                                      \
      ((t) ? 0                                                                 \
           : DebugTrapFn(0, __FILE__, __LINE__, psz, a1, a2, a3, a4, a5, a6),  \
       0))
#define NFAssertSz7(t, psz, a1, a2, a3, a4, a5, a6, a7)                        \
  IFTRAP(((t) ? 0                                                              \
              : DebugTrapFn(0, __FILE__, __LINE__, psz, a1, a2, a3, a4, a5,    \
                            a6, a7),                                           \
          0))
...
#define NFAssertSz9(t, psz, a1, a2, a3, a4, a5, a6, a7, a8, a9)                \
  IFTRAP(((t) ? 0                                                              \
              : DebugTrapFn(0, __FILE__, __LINE__, psz, a1, a2, a3, a4, a5,    \
                            a6, a7, a8, a9),                                   \
          0))
#define NFSideAssert(t)                                                        \
  ((t) ? 0                                                                     \
       : IFTRAP(DebugTrapFn(0, __FILE__, __LINE__, "Assertion Failure: " #t)), \
   0)
#define NFSideAssertSz(t, psz)                                                 \
  ((t) ? 0 : IFTRAP(DebugTrapFn(0, __FILE__, __LINE__, psz)), 0)
#define NFSideAssertSz1(t, psz, a1)                                            \
  ((t) ? 0 : IFTRAP(DebugTrapFn(0, __FILE__, __LINE__, psz, a1)), 0)
#define NFSideAssertSz2(t, psz, a1, a2)                                        \
  ((t) ? 0 : IFTRAP(DebugTrapFn(0, __FILE__, __LINE__, psz, a1, a2)), 0)
#define NFSideAssertSz3(t, psz, a1, a2, a3)                                    \
  ((t) ? 0 : IFTRAP(DebugTrapFn(0, __FILE__, __LINE__, psz, a1, a2, a3)), 0)
...
#define NFSideAssertSz5(t, psz, a1, a2, a3, a4, a5)                            \
  ((t) ? 0                                                                     \
       : IFTRAP(DebugTrapFn(0, __FILE__, __LINE__, psz, a1, a2, a3, a4, a5)),  \
   0)
...
#define DebugTraceResult(f, hr)                                                \
  IFTRACE(((hr) ? DebugTraceFn(#f " returns 0x%08lX %s\n", GetScode(hr), (0))  \
                : 0))
#define DebugTraceSc(f, sc)                                                    \
  IFTRACE(((sc) ? DebugTraceFn(#f " returns 0x%08lX %s\n", sc, (0)) : 0))
#define DebugTraceArg(f, s) IFTRACE(DebugTraceFn(#f ": bad parameter: " s "\n"))
#define DebugTraceLine()                                                       \
  IFTRACE(DebugTraceFn("File %s, Line %i	\n", __FILE__, __LINE__))
...
#define TraceSz4(psz, a1, a2, a3, a4)                                          \
  IFTRACE(DebugTraceFn("~" psz, a1, a2, a3, a4))
#define TraceSz5(psz, a1, a2, a3, a4, a5)                                      \
  IFTRACE(DebugTraceFn("~" psz, a1, a2, a3, a4, a5))
#define TraceSz6(psz, a1, a2, a3, a4, a5, a6)                                  \
  IFTRACE(DebugTraceFn("~" psz, a1, a2, a3, a4, a5, a6))
#define TraceSz7(psz, a1, a2, a3, a4, a5, a6, a7)                              \
  IFTRACE(DebugTraceFn("~" psz, a1, a2, a3, a4, a5, a6, a7))
#define TraceSz8(psz, a1, a2, a3, a4, a5, a6, a7, a8)                          \
  IFTRACE(DebugTraceFn("~" psz, a1, a2, a3, a4, a5, a6, a7, a8))
#define TraceSz9(psz, a1, a2, a3, a4, a5, a6, a7, a8, a9)                      \
  IFTRACE(DebugTraceFn("~" psz, a1, a2, a3, a4, a5, a6, a7, a8, a9))
EXTERN_C_BEGIN
#define EXPORTDBG
int EXPORTDBG __cdecl DebugTrapFn(int fFatal, char *pszFile, int iLine,
                                  char *pszFormat, ...);
...
void *EXPORTDBG __cdecl DBGMEM_EncapsulateFn(void *pmalloc, char *pszSubsys,
                                             int fCheckOften);
