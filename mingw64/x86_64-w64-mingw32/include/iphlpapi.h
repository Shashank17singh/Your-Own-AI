...
DWORD WINAPI GetIpAddrTable(PMIB_IPADDRTABLE pIpAddrTable, PULONG pdwSize,
                            WINBOOL bOrder);
ULONG WINAPI GetIpNetTable(PMIB_IPNETTABLE IpNetTable, PULONG SizePointer,
                           WINBOOL Order);
DWORD WINAPI GetIpForwardTable(PMIB_IPFORWARDTABLE pIpForwardTable,
                               PULONG pdwSize, WINBOOL bOrder);
ULONG WINAPI GetTcpTable(PMIB_TCPTABLE TcpTable, PULONG SizePointer,
                         WINBOOL Order);
DWORD WINAPI GetExtendedTcpTable(PVOID pTcpTable, PDWORD pdwSize,
                                 WINBOOL bOrder, ULONG ulAf,
...
ULONG WINAPI GetUdpTable(PMIB_UDPTABLE UdpTable, PULONG SizePointer,
                         WINBOOL Order);
DWORD WINAPI GetExtendedUdpTable(PVOID pUdpTable, PDWORD pdwSize,
                                 WINBOOL bOrder, ULONG ulAf,
...
DWORD AllocateAndGetTcpExTableFromStack(PVOID *ppTcpTable, WINBOOL bOrder,
                                        HANDLE hHeap, DWORD dwFlags,
                                        DWORD dwFamily);
DWORD AllocateAndGetUdpExTableFromStack(PVOID *ppUdpTable, WINBOOL bOrder,
                                        HANDLE hHeap, DWORD dwFlags,
                                        DWORD dwFamily);
#else
...
#ifdef _WS2IPDEF_
#if NTDDI_VERSION >= 0x06000000
ULONG WINAPI GetTcp6Table(PMIB_TCP6TABLE TcpTable, PULONG SizePointer,
                          WINBOOL Order);
ULONG WINAPI GetTcp6Table2(PMIB_TCP6TABLE2 TcpTable, PULONG SizePointer,
                           WINBOOL Order);
ULONG WINAPI GetPerTcpConnectionEStats(PMIB_TCPROW Row,
                                       TCP_ESTATS_TYPE EstatsType, PUCHAR Rw,
                                       ULONG RwVersion, ULONG RwSize,
                                       PUCHAR Ros, ULONG RosVersion,
                                       ULONG RosSize, PUCHAR Rod,
                                       ULONG RodVersion, ULONG RodSize);
ULONG WINAPI SetPerTcpConnectionEStats(PMIB_TCPROW Row,
                                       TCP_ESTATS_TYPE EstatsType, PUCHAR Rw,
                                       ULONG RwVersion, ULONG RwSize,
                                       ULONG Offset);
ULONG WINAPI GetPerTcp6ConnectionEStats(PMIB_TCP6ROW Row,
                                        TCP_ESTATS_TYPE EstatsType, PUCHAR Rw,
                                        ULONG RwVersion, ULONG RwSize,
                                        PUCHAR Ros, ULONG RosVersion,
                                        ULONG RosSize, PUCHAR Rod,
                                        ULONG RodVersion, ULONG RodSize);
ULONG WINAPI SetPerTcp6ConnectionEStats(PMIB_TCP6ROW Row,
                                        TCP_ESTATS_TYPE EstatsType, PUCHAR Rw,
                                        ULONG RwVersion, ULONG RwSize,
                                        ULONG Offset);
ULONG WINAPI GetUdp6Table(PMIB_UDP6TABLE Udp6Table, PULONG SizePointer,
                          WINBOOL Order);
#endif
DWORD WINAPI GetOwnerModuleFromTcp6Entry(PMIB_TCP6ROW_OWNER_MODULE pTcpEntry,
                                         TCPIP_OWNER_MODULE_INFO_CLASS Class,
                                         PVOID pBuffer, PDWORD pdwSize);
DWORD WINAPI GetOwnerModuleFromUdp6Entry(PMIB_UDP6ROW_OWNER_MODULE pUdpEntry,
                                         TCPIP_OWNER_MODULE_INFO_CLASS Class,
                                         PVOID pBuffer, PDWORD pdwSize);
#endif
DWORD GetOwnerModuleFromPidAndInfo(ULONG ulPid, ULONGLONG *pInfo,
                                   TCPIP_OWNER_MODULE_INFO_CLASS Class,
                                   PVOID pBuffer, PDWORD pdwSize);
...
DWORD WINAPI NhpAllocateAndGetInterfaceInfoFromStack(
    IP_INTERFACE_NAME_INFO **ppTable, PDWORD pdwCount, WINBOOL bOrder,
    HANDLE hHeap, DWORD dwFlags);
#endif
...
DWORD WINAPI SendARP(IPAddr DestIP, IPAddr SrcIP, PVOID pMacAddr,
                     PULONG PhyAddrLen);
WINBOOL WINAPI GetRTTAndHopCount(IPAddr DestIpAddress, PULONG HopCount,
...
DWORD WINAPI ParseNetworkString(CONST WCHAR *NetworkString, DWORD Types,
...
#ifdef _WS2DEF_
ULONG WINAPI ResolveNeighbor(SOCKADDR *NetworkAddress, PVOID PhysicalAddress,
                             PULONG PhysicalAddressLength);
#endif
ULONG WINAPI CreatePersistentTcpPortReservation(USHORT StartPort,
                                                USHORT NumberOfPorts,
                                                PULONG64 Token);
ULONG WINAPI CreatePersistentUdpPortReservation(USHORT StartPort,
                                                USHORT NumberOfPorts,
                                                PULONG64 Token);
ULONG WINAPI DeletePersistentTcpPortReservation(USHORT StartPort,
                                                USHORT NumberOfPorts);
ULONG WINAPI DeletePersistentUdpPortReservation(USHORT StartPort,
                                                USHORT NumberOfPorts);
ULONG WINAPI LookupPersistentTcpPortReservation(USHORT StartPort,
                                                USHORT NumberOfPorts,
                                                PULONG64 Token);
ULONG WINAPI LookupPersistentUdpPortReservation(USHORT StartPort,
                                                USHORT NumberOfPorts,
                                                PULONG64 Token);
#endif
#if NTDDI_VERSION >= 0x06000000
#include <netioapi.h>
#endif
#endif /* WINAPI_FAMILY_PARTITION (WINAPI_PARTITION_DESKTOP) || _WIN32_WINNT   \
          >= 0x0A00 */
#ifdef __cplusplus
}
#endif
