...
typedef UINT(CALLBACK *LPFNPSPCALLBACKA)(HWND hwnd, UINT uMsg,
                                         struct _PROPSHEETPAGEA *ppsp);
typedef UINT(CALLBACK *LPFNPSPCALLBACKW)(HWND hwnd, UINT uMsg,
...
#define PROPSHEETPAGEA_V2_SIZE                                                 \
  CCSIZEOF_STRUCT(PROPSHEETPAGEA, pszHeaderSubTitle)
#define PROPSHEETPAGEW_V2_SIZE                                                 \
  CCSIZEOF_STRUCT(PROPSHEETPAGEW, pszHeaderSubTitle)
...
#define PROPSHEETHEADERA_V2_SIZE                                               \
  CCSIZEOF_STRUCT(PROPSHEETHEADERA, DUMMYUNION5_MEMBER(hbmHeader))
#define PROPSHEETHEADERW_V2_SIZE                                               \
  CCSIZEOF_STRUCT(PROPSHEETHEADERW, DUMMYUNION5_MEMBER(hbmHeader))
...
WINCOMMCTRLAPI HPROPSHEETPAGE WINAPI
CreatePropertySheetPageA(LPCPROPSHEETPAGEA constPropSheetPagePointer);
WINCOMMCTRLAPI HPROPSHEETPAGE WINAPI
CreatePropertySheetPageW(LPCPROPSHEETPAGEW constPropSheetPagePointer);
...
typedef WINBOOL(CALLBACK *LPFNADDPROPSHEETPAGES)(LPVOID, LPFNADDPROPSHEETPAGE,
                                                 LPARAM);
...
#define PropSheet_Changed(hDlg, hwnd)                                          \
  SNDMSG(hDlg, PSM_CHANGED, (WPARAM)hwnd, (LPARAM)0)
#define PSM_RESTARTWINDOWS (WM_USER + 105)
#define PropSheet_RestartWindows(hDlg)                                         \
  SNDMSG(hDlg, PSM_RESTARTWINDOWS, (WPARAM)0, (LPARAM)0)
#define PSM_REBOOTSYSTEM (WM_USER + 106)
#define PropSheet_RebootSystem(hDlg)                                           \
  SNDMSG(hDlg, PSM_REBOOTSYSTEM, (WPARAM)0, (LPARAM)0)
#define PSM_CANCELTOCLOSE (WM_USER + 107)
#define PropSheet_CancelToClose(hDlg)                                          \
  PostMessage(hDlg, PSM_CANCELTOCLOSE, (WPARAM)0, (LPARAM)0)
#define PSM_QUERYSIBLINGS (WM_USER + 108)
#define PropSheet_QuerySiblings(hDlg, wParam, lParam)                          \
  SNDMSG(hDlg, PSM_QUERYSIBLINGS, wParam, lParam)
#define PSM_UNCHANGED (WM_USER + 109)
#define PropSheet_UnChanged(hDlg, hwnd)                                        \
  SNDMSG(hDlg, PSM_UNCHANGED, (WPARAM)hwnd, (LPARAM)0)
...
#define PropSheet_SetWizButtons(hDlg, dwFlags)                                 \
  PostMessage(hDlg, PSM_SETWIZBUTTONS, (WPARAM)0, (LPARAM)dwFlags)
...
#define PropSheet_PressButton(hDlg, iButton)                                   \
  PostMessage(hDlg, PSM_PRESSBUTTON, (WPARAM)iButton, (LPARAM)0)
#define PSBTN_BACK 0
#define PSBTN_NEXT 1
...
#define PropSheet_IsDialogMessage(hDlg, pMsg)                                  \
  (WINBOOL) SNDMSG(hDlg, PSM_ISDIALOGMESSAGE, 0, (LPARAM)pMsg)
#define PSM_GETCURRENTPAGEHWND (WM_USER + 118)
#define PropSheet_GetCurrentPageHwnd(hDlg)                                     \
  (HWND) SNDMSG(hDlg, PSM_GETCURRENTPAGEHWND, (WPARAM)0, (LPARAM)0)
