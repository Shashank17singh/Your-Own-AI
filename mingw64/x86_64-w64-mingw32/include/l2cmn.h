...
#define L2_NOTIFICATION_CODE_V2_BEGIN                                          \
...
#define L2_REASON_CODE_DOT11_AC_BASE                                           \
  (L2_REASON_CODE_GEN_BASE + L2_REASON_CODE_GROUP_SIZE)
#define L2_REASON_CODE_DOT11_MSM_BASE                                          \
  (L2_REASON_CODE_DOT11_AC_BASE + L2_REASON_CODE_GROUP_SIZE)
#define L2_REASON_CODE_DOT11_SECURITY_BASE                                     \
  (L2_REASON_CODE_DOT11_MSM_BASE + L2_REASON_CODE_GROUP_SIZE)
#define L2_REASON_CODE_ONEX_BASE                                               \
  (L2_REASON_CODE_DOT11_SECURITY_BASE + L2_REASON_CODE_GROUP_SIZE)
#define L2_REASON_CODE_DOT3_AC_BASE                                            \
  (L2_REASON_CODE_ONEX_BASE + L2_REASON_CODE_GROUP_SIZE)
#define L2_REASON_CODE_DOT3_MSM_BASE                                           \
  (L2_REASON_CODE_DOT3_AC_BASE + L2_REASON_CODE_GROUP_SIZE)
#define L2_REASON_CODE_PROFILE_BASE                                            \
  (L2_REASON_CODE_DOT3_MSM_BASE + L2_REASON_CODE_GROUP_SIZE)
#define L2_REASON_CODE_IHV_BASE                                                \
  (L2_REASON_CODE_PROFILE_BASE + L2_REASON_CODE_GROUP_SIZE)
#define L2_REASON_CODE_WIMAX_BASE                                              \
  (L2_REASON_CODE_IHV_BASE + L2_REASON_CODE_GROUP_SIZE)
#define L2_REASON_CODE_RESERVED_BASE                                           \
  (L2_REASON_CODE_WIMAX_BASE + L2_REASON_CODE_GROUP_SIZE)
