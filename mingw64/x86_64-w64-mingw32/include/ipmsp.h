...
public:
  ...
  get_ParticipantTypedInfo(PARTICIPANT_TYPED_INFO InfoType, BSTR *ppInfo) = 0;
  virtual HRESULT WINAPI get_MediaTypes(__LONG32 *plMediaType) = 0;
  virtual HRESULT WINAPI put_Status(ITStream *pITStream,
                                    VARIANT_BOOL fEnable) = 0;
  virtual HRESULT WINAPI get_Status(ITStream *pITStream,
                                    VARIANT_BOOL *pStatus) = 0;
...
typedef struct ITParticipantVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITParticipant *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITParticipant *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITParticipant *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITParticipant *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *get_ParticipantTypedInfo)(ITParticipant *This,
                                            PARTICIPANT_TYPED_INFO InfoType,
                                            BSTR *ppInfo);
  HRESULT(WINAPI *get_MediaTypes)(ITParticipant *This, __LONG32 *plMediaType);
  HRESULT(WINAPI *put_Status)(ITParticipant *This, ITStream *pITStream,
                              VARIANT_BOOL fEnable);
  HRESULT(WINAPI *get_Status)(ITParticipant *This, ITStream *pITStream,
                              VARIANT_BOOL *pStatus);
  HRESULT(WINAPI *get_Streams)(ITParticipant *This, VARIANT *pVariant);
  HRESULT(WINAPI *EnumerateStreams)(ITParticipant *This,
...
#define ITParticipant_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,       \
                                    rgDispId)                                  \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITParticipant_Invoke(This, dispIdMember, riid, lcid, wFlags,           \
...
#endif
#endif
HRESULT WINAPI ITParticipant_get_ParticipantTypedInfo_Proxy(
    ITParticipant *This, PARTICIPANT_TYPED_INFO InfoType, BSTR *ppInfo);
...
HRESULT WINAPI ITParticipant_get_MediaTypes_Proxy(ITParticipant *This,
                                                  __LONG32 *plMediaType);
void __RPC_STUB ITParticipant_get_MediaTypes_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITParticipant_put_Status_Proxy(ITParticipant *This,
                                              ITStream *pITStream,
                                              VARIANT_BOOL fEnable);
void __RPC_STUB ITParticipant_put_Status_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITParticipant_get_Status_Proxy(ITParticipant *This,
                                              ITStream *pITStream,
                                              VARIANT_BOOL *pStatus);
void __RPC_STUB ITParticipant_get_Status_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITParticipant_get_Streams_Proxy(ITParticipant *This,
                                               VARIANT *pVariant);
void __RPC_STUB ITParticipant_get_Streams_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITParticipant_EnumerateStreams_Proxy(ITParticipant *This,
                                                    IEnumStream **ppEnumStream);
...
public:
  ...
  virtual HRESULT WINAPI GetStreamCaps(
      DWORD dwIndex, AM_MEDIA_TYPE **ppMediaType,
      TAPI_STREAM_CONFIG_CAPS *pStreamConfigCaps, WINBOOL *pfEnabled) = 0;
  virtual HRESULT WINAPI ReOrderCapabilities(DWORD *pdwIndices,
                                             WINBOOL *pfEnabled,
                                             WINBOOL *pfPublicize,
...
typedef struct ITFormatControlVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITFormatControl *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ITFormatControl *This);
  ULONG(WINAPI *Release)(ITFormatControl *This);
  HRESULT(WINAPI *GetCurrentFormat)(ITFormatControl *This,
                                    AM_MEDIA_TYPE **ppMediaType);
  HRESULT(WINAPI *ReleaseFormat)(ITFormatControl *This,
                                 AM_MEDIA_TYPE *pMediaType);
  HRESULT(WINAPI *GetNumberOfCapabilities)(ITFormatControl *This,
                                           DWORD *pdwCount);
  HRESULT(WINAPI *GetStreamCaps)(ITFormatControl *This, DWORD dwIndex,
                                 AM_MEDIA_TYPE **ppMediaType,
                                 TAPI_STREAM_CONFIG_CAPS *pStreamConfigCaps,
                                 WINBOOL *pfEnabled);
  HRESULT(WINAPI *ReOrderCapabilities)(ITFormatControl *This, DWORD *pdwIndices,
                                       WINBOOL *pfEnabled, WINBOOL *pfPublicize,
                                       DWORD dwNumIndices);
  END_INTERFACE
} ITFormatControlVtbl;
...
#define ITFormatControl_GetStreamCaps(This, dwIndex, ppMediaType,              \
                                      pStreamConfigCaps, pfEnabled)            \
  (This)->lpVtbl->GetStreamCaps(This, dwIndex, ppMediaType, pStreamConfigCaps, \
                                pfEnabled)
#define ITFormatControl_ReOrderCapabilities(This, pdwIndices, pfEnabled,       \
                                            pfPublicize, dwNumIndices)         \
  (This)->lpVtbl->ReOrderCapabilities(This, pdwIndices, pfEnabled,             \
                                      pfPublicize, dwNumIndices)
#endif
#endif
HRESULT
    WINAPI ITFormatControl_GetCurrentFormat_Proxy(ITFormatControl *This,
                                                  AM_MEDIA_TYPE **ppMediaType);
void __RPC_STUB ITFormatControl_GetCurrentFormat_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITFormatControl_ReleaseFormat_Proxy(ITFormatControl *This,
                                                   AM_MEDIA_TYPE *pMediaType);
void __RPC_STUB ITFormatControl_ReleaseFormat_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITFormatControl_GetNumberOfCapabilities_Proxy(
    ITFormatControl *This, DWORD *pdwCount);
void __RPC_STUB ITFormatControl_GetNumberOfCapabilities_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITFormatControl_GetStreamCaps_Proxy(
    ITFormatControl *This, DWORD dwIndex, AM_MEDIA_TYPE **ppMediaType,
    TAPI_STREAM_CONFIG_CAPS *pStreamConfigCaps, WINBOOL *pfEnabled);
void __RPC_STUB ITFormatControl_GetStreamCaps_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITFormatControl_ReOrderCapabilities_Proxy(ITFormatControl *This,
                                                         DWORD *pdwIndices,
                                                         WINBOOL *pfEnabled,
                                                         WINBOOL *pfPublicize,
                                                         DWORD dwNumIndices);
...
public:
  virtual HRESULT WINAPI GetRange(StreamQualityProperty Property,
                                  __LONG32 *plMin, __LONG32 *plMax,
                                  __LONG32 *plSteppingDelta,
                                  __LONG32 *plDefault,
                                  TAPIControlFlags *plFlags) = 0;
  virtual HRESULT WINAPI Get(StreamQualityProperty Property, __LONG32 *plValue,
                             TAPIControlFlags *plFlags) = 0;
  virtual HRESULT WINAPI Set(StreamQualityProperty Property, __LONG32 lValue,
                             TAPIControlFlags lFlags) = 0;
};
#else
typedef struct ITStreamQualityControlVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITStreamQualityControl *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ITStreamQualityControl *This);
  ULONG(WINAPI *Release)(ITStreamQualityControl *This);
  HRESULT(WINAPI *GetRange)(ITStreamQualityControl *This,
                            StreamQualityProperty Property, __LONG32 *plMin,
                            __LONG32 *plMax, __LONG32 *plSteppingDelta,
                            __LONG32 *plDefault, TAPIControlFlags *plFlags);
  HRESULT(WINAPI *Get)(ITStreamQualityControl *This,
                       StreamQualityProperty Property, __LONG32 *plValue,
                       TAPIControlFlags *plFlags);
  HRESULT(WINAPI *Set)(ITStreamQualityControl *This,
                       StreamQualityProperty Property, __LONG32 lValue,
...
#define ITStreamQualityControl_GetRange(This, Property, plMin, plMax,          \
                                        plSteppingDelta, plDefault, plFlags)   \
  (This)->lpVtbl->GetRange(This, Property, plMin, plMax, plSteppingDelta,      \
                           plDefault, plFlags)
...
HRESULT WINAPI ITStreamQualityControl_GetRange_Proxy(
    ITStreamQualityControl *This, StreamQualityProperty Property,
    __LONG32 *plMin, __LONG32 *plMax, __LONG32 *plSteppingDelta,
    __LONG32 *plDefault, TAPIControlFlags *plFlags);
void __RPC_STUB ITStreamQualityControl_GetRange_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITStreamQualityControl_Get_Proxy(ITStreamQualityControl *This,
                                                StreamQualityProperty Property,
                                                __LONG32 *plValue,
                                                TAPIControlFlags *plFlags);
void __RPC_STUB ITStreamQualityControl_Get_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITStreamQualityControl_Set_Proxy(ITStreamQualityControl *This,
                                                StreamQualityProperty Property,
                                                __LONG32 lValue,
                                                TAPIControlFlags lFlags);
...
typedef enum tagCallQualityProperty {
  ...
  CallQuality_ConfBitrate,
  CallQuality_MaxInputBitrate,
  CallQuality_CurrInputBitrate,
  CallQuality_MaxOutputBitrate,
  CallQuality_CurrOutputBitrate,
  CallQuality_MaxCPULoad,
  CallQuality_CurrCPULoad
} CallQualityProperty;
...
public:
  virtual HRESULT WINAPI GetRange(CallQualityProperty Property, __LONG32 *plMin,
                                  __LONG32 *plMax, __LONG32 *plSteppingDelta,
                                  __LONG32 *plDefault,
                                  TAPIControlFlags *plFlags) = 0;
  virtual HRESULT WINAPI Get(CallQualityProperty Property, __LONG32 *plValue,
                             TAPIControlFlags *plFlags) = 0;
  virtual HRESULT WINAPI Set(CallQualityProperty Property, __LONG32 lValue,
                             TAPIControlFlags lFlags) = 0;
};
#else
typedef struct ITCallQualityControlVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITCallQualityControl *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ITCallQualityControl *This);
  ULONG(WINAPI *Release)(ITCallQualityControl *This);
  HRESULT(WINAPI *GetRange)(ITCallQualityControl *This,
                            CallQualityProperty Property, __LONG32 *plMin,
                            __LONG32 *plMax, __LONG32 *plSteppingDelta,
                            __LONG32 *plDefault, TAPIControlFlags *plFlags);
  HRESULT(WINAPI *Get)(ITCallQualityControl *This, CallQualityProperty Property,
                       __LONG32 *plValue, TAPIControlFlags *plFlags);
  HRESULT(WINAPI *Set)(ITCallQualityControl *This, CallQualityProperty Property,
                       __LONG32 lValue, TAPIControlFlags lFlags);
  END_INTERFACE
...
#define ITCallQualityControl_GetRange(This, Property, plMin, plMax,            \
                                      plSteppingDelta, plDefault, plFlags)     \
  (This)->lpVtbl->GetRange(This, Property, plMin, plMax, plSteppingDelta,      \
                           plDefault, plFlags)
...
#endif
#endif
HRESULT WINAPI ITCallQualityControl_GetRange_Proxy(
    ITCallQualityControl *This, CallQualityProperty Property, __LONG32 *plMin,
    __LONG32 *plMax, __LONG32 *plSteppingDelta, __LONG32 *plDefault,
    TAPIControlFlags *plFlags);
void __RPC_STUB ITCallQualityControl_GetRange_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITCallQualityControl_Get_Proxy(ITCallQualityControl *This,
                                              CallQualityProperty Property,
                                              __LONG32 *plValue,
                                              TAPIControlFlags *plFlags);
void __RPC_STUB ITCallQualityControl_Get_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITCallQualityControl_Set_Proxy(ITCallQualityControl *This,
                                              CallQualityProperty Property,
                                              __LONG32 lValue,
                                              TAPIControlFlags lFlags);
...
public:
  virtual HRESULT WINAPI GetRange(AudioDeviceProperty Property, __LONG32 *plMin,
                                  __LONG32 *plMax, __LONG32 *plSteppingDelta,
                                  __LONG32 *plDefault,
                                  TAPIControlFlags *plFlags) = 0;
  virtual HRESULT WINAPI Get(AudioDeviceProperty Property, __LONG32 *plValue,
                             TAPIControlFlags *plFlags) = 0;
  virtual HRESULT WINAPI Set(AudioDeviceProperty Property, __LONG32 lValue,
                             TAPIControlFlags lFlags) = 0;
};
#else
typedef struct ITAudioDeviceControlVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITAudioDeviceControl *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ITAudioDeviceControl *This);
  ULONG(WINAPI *Release)(ITAudioDeviceControl *This);
  HRESULT(WINAPI *GetRange)(ITAudioDeviceControl *This,
                            AudioDeviceProperty Property, __LONG32 *plMin,
                            __LONG32 *plMax, __LONG32 *plSteppingDelta,
                            __LONG32 *plDefault, TAPIControlFlags *plFlags);
  HRESULT(WINAPI *Get)(ITAudioDeviceControl *This, AudioDeviceProperty Property,
                       __LONG32 *plValue, TAPIControlFlags *plFlags);
  HRESULT(WINAPI *Set)(ITAudioDeviceControl *This, AudioDeviceProperty Property,
                       __LONG32 lValue, TAPIControlFlags lFlags);
  END_INTERFACE
...
#define ITAudioDeviceControl_GetRange(This, Property, plMin, plMax,            \
                                      plSteppingDelta, plDefault, plFlags)     \
  (This)->lpVtbl->GetRange(This, Property, plMin, plMax, plSteppingDelta,      \
                           plDefault, plFlags)
...
#endif
#endif
HRESULT WINAPI ITAudioDeviceControl_GetRange_Proxy(
    ITAudioDeviceControl *This, AudioDeviceProperty Property, __LONG32 *plMin,
    __LONG32 *plMax, __LONG32 *plSteppingDelta, __LONG32 *plDefault,
    TAPIControlFlags *plFlags);
void __RPC_STUB ITAudioDeviceControl_GetRange_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAudioDeviceControl_Get_Proxy(ITAudioDeviceControl *This,
...
void __RPC_STUB ITAudioDeviceControl_Get_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAudioDeviceControl_Set_Proxy(ITAudioDeviceControl *This,
                                              AudioDeviceProperty Property,
                                              __LONG32 lValue,
                                              TAPIControlFlags lFlags);
...
public:
  virtual HRESULT WINAPI GetRange(AudioSettingsProperty Property,
                                  __LONG32 *plMin, __LONG32 *plMax,
                                  __LONG32 *plSteppingDelta,
                                  __LONG32 *plDefault,
                                  TAPIControlFlags *plFlags) = 0;
  virtual HRESULT WINAPI Get(AudioSettingsProperty Property, __LONG32 *plValue,
                             TAPIControlFlags *plFlags) = 0;
  virtual HRESULT WINAPI Set(AudioSettingsProperty Property, __LONG32 lValue,
                             TAPIControlFlags lFlags) = 0;
};
#else
typedef struct ITAudioSettingsVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITAudioSettings *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ITAudioSettings *This);
  ULONG(WINAPI *Release)(ITAudioSettings *This);
  HRESULT(WINAPI *GetRange)(ITAudioSettings *This,
                            AudioSettingsProperty Property, __LONG32 *plMin,
                            __LONG32 *plMax, __LONG32 *plSteppingDelta,
                            __LONG32 *plDefault, TAPIControlFlags *plFlags);
  HRESULT(WINAPI *Get)(ITAudioSettings *This, AudioSettingsProperty Property,
                       __LONG32 *plValue, TAPIControlFlags *plFlags);
  HRESULT(WINAPI *Set)(ITAudioSettings *This, AudioSettingsProperty Property,
                       __LONG32 lValue, TAPIControlFlags lFlags);
  END_INTERFACE
} ITAudioSettingsVtbl;
...
#define ITAudioSettings_GetRange(This, Property, plMin, plMax,                 \
                                 plSteppingDelta, plDefault, plFlags)          \
  (This)->lpVtbl->GetRange(This, Property, plMin, plMax, plSteppingDelta,      \
                           plDefault, plFlags)
...
#endif
#endif
HRESULT WINAPI ITAudioSettings_GetRange_Proxy(ITAudioSettings *This,
                                              AudioSettingsProperty Property,
                                              __LONG32 *plMin, __LONG32 *plMax,
                                              __LONG32 *plSteppingDelta,
                                              __LONG32 *plDefault,
                                              TAPIControlFlags *plFlags);
void __RPC_STUB ITAudioSettings_GetRange_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAudioSettings_Get_Proxy(ITAudioSettings *This,
                                         AudioSettingsProperty Property,
                                         __LONG32 *plValue,
                                         TAPIControlFlags *plFlags);
void __RPC_STUB ITAudioSettings_Get_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
HRESULT WINAPI ITAudioSettings_Set_Proxy(ITAudioSettings *This,
                                         AudioSettingsProperty Property,
                                         __LONG32 lValue,
                                         TAPIControlFlags lFlags);
void __RPC_STUB ITAudioSettings_Set_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
#endif
...
public:
  virtual HRESULT WINAPI SetQOSApplicationID(BSTR pApplicationID,
                                             BSTR pApplicationGUID,
                                             BSTR pSubIDs) = 0;
};
#else
typedef struct ITQOSApplicationIDVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITQOSApplicationID *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITQOSApplicationID *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITQOSApplicationID *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITQOSApplicationID *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *SetQOSApplicationID)(ITQOSApplicationID *This,
                                       BSTR pApplicationID,
                                       BSTR pApplicationGUID, BSTR pSubIDs);
  END_INTERFACE
...
#define ITQOSApplicationID_GetTypeInfo(This, iTInfo, lcid, ppTInfo)            \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITQOSApplicationID_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,  \
                                         rgDispId)                             \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITQOSApplicationID_Invoke(This, dispIdMember, riid, lcid, wFlags,      \
                                  pDispParams, pVarResult, pExcepInfo,         \
                                  puArgErr)                                    \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
#define ITQOSApplicationID_SetQOSApplicationID(This, pApplicationID,           \
                                               pApplicationGUID, pSubIDs)      \
  (This)->lpVtbl->SetQOSApplicationID(This, pApplicationID, pApplicationGUID,  \
                                      pSubIDs)
#endif
#endif
HRESULT WINAPI ITQOSApplicationID_SetQOSApplicationID_Proxy(
    ITQOSApplicationID *This, BSTR pApplicationID, BSTR pApplicationGUID,
    BSTR pSubIDs);
