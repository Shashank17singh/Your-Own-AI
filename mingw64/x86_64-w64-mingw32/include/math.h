...
#endif
double __cdecl
_cabs(struct _complex _ComplexA); /* Overridden to use our cabs.  */
...
#define isnan(x)                                                               \
  __mingw_choose_expr(                                                         \
      __mingw_types_compatible_p(__typeof__(x), double), __isnan((double)(x)), \
      __mingw_choose_expr(                                                     \
          __mingw_types_compatible_p(__typeof__(x), float),                    \
          __isnanf((float)(x)),                                                \
          __mingw_choose_expr(                                                 \
...
hypot(double, double) __MINGW_ATTRIB_DEPRECATED_MSVC2005; /* in libmoldname.a */
