...
DEFINE_GUID(IID_IEnumConnections, 0xb196b287, 0xbab4, 0x101a, 0xb6, 0x9c, 0x00,
            0xaa, 0x00, 0x34, 0x1d, 0x07);
...
IEnumConnections : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE Clone(IEnumConnections * *ppEnum) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IEnumConnections, 0xb196b287, 0xbab4, 0x101a, 0xb6, 0x9c, 0x00,
                0xaa, 0x00, 0x34, 0x1d, 0x07)
#endif
#else
typedef struct IEnumConnectionsVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IEnumConnections *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IEnumConnections *This);
  ULONG(STDMETHODCALLTYPE *Release)(IEnumConnections *This);
  /*** IEnumConnections methods ***/
  HRESULT(STDMETHODCALLTYPE *Next)(IEnumConnections *This, ULONG cConnections,
                                   LPCONNECTDATA rgcd, ULONG *pcFetched);
  HRESULT(STDMETHODCALLTYPE *Skip)(IEnumConnections *This, ULONG cConnections);
  HRESULT(STDMETHODCALLTYPE *Reset)(IEnumConnections *This);
  HRESULT(STDMETHODCALLTYPE *Clone)(IEnumConnections *This,
                                    IEnumConnections **ppEnum);
  END_INTERFACE
} IEnumConnectionsVtbl;
interface IEnumConnections { CONST_VTBL IEnumConnectionsVtbl *lpVtbl; };
#ifdef COBJMACROS
...
#else
/*** IUnknown methods ***/
static inline HRESULT IEnumConnections_QueryInterface(IEnumConnections *This,
                                                      REFIID riid,
                                                      void **ppvObject) {
...
/*** IEnumConnections methods ***/
static inline HRESULT IEnumConnections_Next(IEnumConnections *This,
                                            ULONG cConnections,
                                            LPCONNECTDATA rgcd,
                                            ULONG *pcFetched) {
  return This->lpVtbl->Next(This, cConnections, rgcd, pcFetched);
}
static inline HRESULT IEnumConnections_Skip(IEnumConnections *This,
                                            ULONG cConnections) {
...
static inline HRESULT IEnumConnections_Clone(IEnumConnections *This,
                                             IEnumConnections **ppEnum) {
...
IEnumConnections_RemoteNext_Proxy(IEnumConnections *This, ULONG cConnections,
                                  LPCONNECTDATA rgcd, ULONG *pcFetched);
...
DEFINE_GUID(IID_IConnectionPoint, 0xb196b286, 0xbab4, 0x101a, 0xb6, 0x9c, 0x00,
            0xaa, 0x00, 0x34, 0x1d, 0x07);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IConnectionPoint : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE EnumConnections(IEnumConnections *
                                                    *ppEnum) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IConnectionPoint, 0xb196b286, 0xbab4, 0x101a, 0xb6, 0x9c, 0x00,
                0xaa, 0x00, 0x34, 0x1d, 0x07)
#endif
#else
typedef struct IConnectionPointVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IConnectionPoint *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IConnectionPoint *This);
  ULONG(STDMETHODCALLTYPE *Release)(IConnectionPoint *This);
  /*** IConnectionPoint methods ***/
  HRESULT(STDMETHODCALLTYPE *GetConnectionInterface)(IConnectionPoint *This,
                                                     IID *pIID);
  HRESULT(STDMETHODCALLTYPE *GetConnectionPointContainer)(
      IConnectionPoint *This, IConnectionPointContainer **ppCPC);
  HRESULT(STDMETHODCALLTYPE *Advise)(IConnectionPoint *This, IUnknown *pUnkSink,
                                     DWORD *pdwCookie);
  HRESULT(STDMETHODCALLTYPE *Unadvise)(IConnectionPoint *This, DWORD dwCookie);
  HRESULT(STDMETHODCALLTYPE *EnumConnections)(IConnectionPoint *This,
                                              IEnumConnections **ppEnum);
  END_INTERFACE
} IConnectionPointVtbl;
interface IConnectionPoint { CONST_VTBL IConnectionPointVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IConnectionPoint_QueryInterface(IConnectionPoint *This,
                                                      REFIID riid,
                                                      void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
IConnectionPoint_GetConnectionInterface(IConnectionPoint *This, IID *pIID) {
  return This->lpVtbl->GetConnectionInterface(This, pIID);
}
static inline HRESULT IConnectionPoint_GetConnectionPointContainer(
    IConnectionPoint *This, IConnectionPointContainer **ppCPC) {
  return This->lpVtbl->GetConnectionPointContainer(This, ppCPC);
}
static inline HRESULT IConnectionPoint_Advise(IConnectionPoint *This,
                                              IUnknown *pUnkSink,
                                              DWORD *pdwCookie) {
  return This->lpVtbl->Advise(This, pUnkSink, pdwCookie);
}
static inline HRESULT IConnectionPoint_Unadvise(IConnectionPoint *This,
                                                DWORD dwCookie) {
  return This->lpVtbl->Unadvise(This, dwCookie);
}
static inline HRESULT
IConnectionPoint_EnumConnections(IConnectionPoint *This,
                                 IEnumConnections **ppEnum) {
...
DEFINE_GUID(IID_IEnumConnectionPoints, 0xb196b285, 0xbab4, 0x101a, 0xb6, 0x9c,
            0x00, 0xaa, 0x00, 0x34, 0x1d, 0x07);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("b196b285-bab4-101a-b69c-00aa00341d07")
IEnumConnectionPoints : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE Next(
      ULONG cConnections, LPCONNECTIONPOINT * ppCP, ULONG * pcFetched) = 0;
  virtual HRESULT STDMETHODCALLTYPE Skip(ULONG cConnections) = 0;
  virtual HRESULT STDMETHODCALLTYPE Reset() = 0;
  virtual HRESULT STDMETHODCALLTYPE Clone(IEnumConnectionPoints * *ppEnum) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IEnumConnectionPoints, 0xb196b285, 0xbab4, 0x101a, 0xb6, 0x9c,
                0x00, 0xaa, 0x00, 0x34, 0x1d, 0x07)
#endif
#else
typedef struct IEnumConnectionPointsVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IEnumConnectionPoints *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IEnumConnectionPoints *This);
  ULONG(STDMETHODCALLTYPE *Release)(IEnumConnectionPoints *This);
  /*** IEnumConnectionPoints methods ***/
  HRESULT(STDMETHODCALLTYPE *Next)(IEnumConnectionPoints *This,
                                   ULONG cConnections, LPCONNECTIONPOINT *ppCP,
                                   ULONG *pcFetched);
  HRESULT(STDMETHODCALLTYPE *Skip)(IEnumConnectionPoints *This,
                                   ULONG cConnections);
...
/*** IUnknown methods ***/
static inline HRESULT
IEnumConnectionPoints_QueryInterface(IEnumConnectionPoints *This, REFIID riid,
                                     void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IEnumConnectionPoints methods ***/
static inline HRESULT IEnumConnectionPoints_Next(IEnumConnectionPoints *This,
                                                 ULONG cConnections,
                                                 LPCONNECTIONPOINT *ppCP,
                                                 ULONG *pcFetched) {
  return This->lpVtbl->Next(This, cConnections, ppCP, pcFetched);
}
static inline HRESULT IEnumConnectionPoints_Skip(IEnumConnectionPoints *This,
                                                 ULONG cConnections) {
  return This->lpVtbl->Skip(This, cConnections);
}
...
static inline HRESULT
IEnumConnectionPoints_Clone(IEnumConnectionPoints *This,
                            IEnumConnectionPoints **ppEnum) {
  return This->lpVtbl->Clone(This, ppEnum);
}
#endif
...
HRESULT STDMETHODCALLTYPE IEnumConnectionPoints_RemoteNext_Proxy(
    IEnumConnectionPoints *This, ULONG cConnections, LPCONNECTIONPOINT *ppCP,
    ULONG *pcFetched);
...
DEFINE_GUID(IID_IConnectionPointContainer, 0xb196b284, 0xbab4, 0x101a, 0xb6,
...
IConnectionPointContainer : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE EnumConnectionPoints(IEnumConnectionPoints *
                                                         *ppEnum) = 0;
  virtual HRESULT STDMETHODCALLTYPE FindConnectionPoint(
      REFIID riid, IConnectionPoint * *ppCP) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IConnectionPointContainer, 0xb196b284, 0xbab4, 0x101a, 0xb6,
                0x9c, 0x00, 0xaa, 0x00, 0x34, 0x1d, 0x07)
#endif
#else
typedef struct IConnectionPointContainerVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IConnectionPointContainer *This,
                                             REFIID riid, void **ppvObject);
...
/*** IUnknown methods ***/
static inline HRESULT
IConnectionPointContainer_QueryInterface(IConnectionPointContainer *This,
                                         REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IConnectionPointContainer_AddRef(IConnectionPointContainer *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IConnectionPointContainer_Release(IConnectionPointContainer *This) {
  return This->lpVtbl->Release(This);
}
/*** IConnectionPointContainer methods ***/
static inline HRESULT
IConnectionPointContainer_EnumConnectionPoints(IConnectionPointContainer *This,
                                               IEnumConnectionPoints **ppEnum) {
  return This->lpVtbl->EnumConnectionPoints(This, ppEnum);
}
static inline HRESULT IConnectionPointContainer_FindConnectionPoint(
    IConnectionPointContainer *This, REFIID riid, IConnectionPoint **ppCP) {
...
DEFINE_GUID(IID_IClassFactory2, 0xb196b28f, 0xbab4, 0x101a, 0xb6, 0x9c, 0x00,
            0xaa, 0x00, 0x34, 0x1d, 0x07);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IClassFactory2 : public IClassFactory {
  ...
  virtual HRESULT STDMETHODCALLTYPE RequestLicKey(DWORD dwReserved,
                                                  BSTR * pBstrKey) = 0;
  virtual HRESULT STDMETHODCALLTYPE CreateInstanceLic(
      IUnknown * pUnkOuter, IUnknown * pUnkReserved, REFIID riid, BSTR bstrKey,
      PVOID * ppvObj) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IClassFactory2, 0xb196b28f, 0xbab4, 0x101a, 0xb6, 0x9c, 0x00,
                0xaa, 0x00, 0x34, 0x1d, 0x07)
#endif
#else
typedef struct IClassFactory2Vtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IClassFactory2 *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IClassFactory2 *This);
  ULONG(STDMETHODCALLTYPE *Release)(IClassFactory2 *This);
  /*** IClassFactory methods ***/
  HRESULT(STDMETHODCALLTYPE *CreateInstance)(IClassFactory2 *This,
                                             IUnknown *pUnkOuter, REFIID riid,
                                             void **ppvObject);
  HRESULT(STDMETHODCALLTYPE *LockServer)(IClassFactory2 *This, WINBOOL fLock);
  /*** IClassFactory2 methods ***/
  HRESULT(STDMETHODCALLTYPE *GetLicInfo)(IClassFactory2 *This,
                                         LICINFO *pLicInfo);
  HRESULT(STDMETHODCALLTYPE *RequestLicKey)(IClassFactory2 *This,
                                            DWORD dwReserved, BSTR *pBstrKey);
  HRESULT(STDMETHODCALLTYPE *CreateInstanceLic)(IClassFactory2 *This,
                                                IUnknown *pUnkOuter,
...
interface IClassFactory2 { CONST_VTBL IClassFactory2Vtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define IClassFactory2_CreateInstanceLic(This, pUnkOuter, pUnkReserved, riid,  \
                                         bstrKey, ppvObj)                      \
  (This)->lpVtbl->CreateInstanceLic(This, pUnkOuter, pUnkReserved, riid,       \
                                    bstrKey, ppvObj)
#else
/*** IUnknown methods ***/
static inline HRESULT IClassFactory2_QueryInterface(IClassFactory2 *This,
                                                    REFIID riid,
                                                    void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IClassFactory methods ***/
static inline HRESULT IClassFactory2_CreateInstance(IClassFactory2 *This,
                                                    IUnknown *pUnkOuter,
                                                    REFIID riid,
                                                    void **ppvObject) {
  return This->lpVtbl->CreateInstance(This, pUnkOuter, riid, ppvObject);
}
static inline HRESULT IClassFactory2_LockServer(IClassFactory2 *This,
                                                WINBOOL fLock) {
  return This->lpVtbl->LockServer(This, fLock);
}
/*** IClassFactory2 methods ***/
static inline HRESULT IClassFactory2_GetLicInfo(IClassFactory2 *This,
                                                LICINFO *pLicInfo) {
  return This->lpVtbl->GetLicInfo(This, pLicInfo);
}
static inline HRESULT IClassFactory2_RequestLicKey(IClassFactory2 *This,
                                                   DWORD dwReserved,
                                                   BSTR *pBstrKey) {
  return This->lpVtbl->RequestLicKey(This, dwReserved, pBstrKey);
}
static inline HRESULT
IClassFactory2_CreateInstanceLic(IClassFactory2 *This, IUnknown *pUnkOuter,
                                 IUnknown *pUnkReserved, REFIID riid,
                                 BSTR bstrKey, PVOID *ppvObj) {
  return This->lpVtbl->CreateInstanceLic(This, pUnkOuter, pUnkReserved, riid,
                                         bstrKey, ppvObj);
}
#endif
#endif
...
HRESULT STDMETHODCALLTYPE IClassFactory2_RemoteCreateInstanceLic_Proxy(
    IClassFactory2 *This, REFIID riid, BSTR bstrKey, IUnknown **ppvObj);
...
DEFINE_GUID(IID_IProvideClassInfo, 0xb196b283, 0xbab4, 0x101a, 0xb6, 0x9c, 0x00,
            0xaa, 0x00, 0x34, 0x1d, 0x07);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IProvideClassInfo, 0xb196b283, 0xbab4, 0x101a, 0xb6, 0x9c, 0x00,
                0xaa, 0x00, 0x34, 0x1d, 0x07)
#endif
#else
typedef struct IProvideClassInfoVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IProvideClassInfo *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IProvideClassInfo *This);
  ULONG(STDMETHODCALLTYPE *Release)(IProvideClassInfo *This);
  /*** IProvideClassInfo methods ***/
  HRESULT(STDMETHODCALLTYPE *GetClassInfo)(IProvideClassInfo *This,
                                           ITypeInfo **ppTI);
  END_INTERFACE
} IProvideClassInfoVtbl;
interface IProvideClassInfo { CONST_VTBL IProvideClassInfoVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IProvideClassInfo_QueryInterface(IProvideClassInfo *This,
                                                       REFIID riid,
                                                       void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IProvideClassInfo methods ***/
static inline HRESULT IProvideClassInfo_GetClassInfo(IProvideClassInfo *This,
                                                     ITypeInfo **ppTI) {
...
DEFINE_GUID(IID_IProvideClassInfo2, 0xa6bc3ac0, 0xdbaa, 0x11ce, 0x9d, 0xe3,
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IProvideClassInfo2, 0xa6bc3ac0, 0xdbaa, 0x11ce, 0x9d, 0xe3,
                0x00, 0xaa, 0x00, 0x4b, 0xb8, 0x51)
#endif
#else
typedef struct IProvideClassInfo2Vtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IProvideClassInfo2 *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IProvideClassInfo2 *This);
  ULONG(STDMETHODCALLTYPE *Release)(IProvideClassInfo2 *This);
  /*** IProvideClassInfo methods ***/
  HRESULT(STDMETHODCALLTYPE *GetClassInfo)(IProvideClassInfo2 *This,
                                           ITypeInfo **ppTI);
  /*** IProvideClassInfo2 methods ***/
  HRESULT(STDMETHODCALLTYPE *GetGUID)(IProvideClassInfo2 *This,
                                      DWORD dwGuidKind, GUID *pGUID);
  END_INTERFACE
} IProvideClassInfo2Vtbl;
interface IProvideClassInfo2 { CONST_VTBL IProvideClassInfo2Vtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
IProvideClassInfo2_QueryInterface(IProvideClassInfo2 *This, REFIID riid,
                                  void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IProvideClassInfo methods ***/
static inline HRESULT IProvideClassInfo2_GetClassInfo(IProvideClassInfo2 *This,
                                                      ITypeInfo **ppTI) {
  return This->lpVtbl->GetClassInfo(This, ppTI);
}
/*** IProvideClassInfo2 methods ***/
static inline HRESULT IProvideClassInfo2_GetGUID(IProvideClassInfo2 *This,
                                                 DWORD dwGuidKind,
                                                 GUID *pGUID) {
...
IProvideMultipleClassInfo : public IProvideClassInfo2 {
  ...
  virtual HRESULT STDMETHODCALLTYPE GetInfoOfIndex(
      ULONG iti, DWORD dwFlags, ITypeInfo * *pptiCoClass, DWORD * pdwTIFlags,
      ULONG * pcdispidReserved, IID * piidPrimary, IID * piidSource) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IProvideMultipleClassInfo, 0xa7aba9c1, 0x8983, 0x11cf, 0x8f,
                0x20, 0x00, 0x80, 0x5f, 0x2c, 0xd0, 0x64)
#endif
#else
typedef struct IProvideMultipleClassInfoVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IProvideMultipleClassInfo *This,
                                             REFIID riid, void **ppvObject);
  ...
  /*** IProvideClassInfo methods ***/
  HRESULT(STDMETHODCALLTYPE *GetClassInfo)(IProvideMultipleClassInfo *This,
                                           ITypeInfo **ppTI);
  /*** IProvideClassInfo2 methods ***/
  HRESULT(STDMETHODCALLTYPE *GetGUID)(IProvideMultipleClassInfo *This,
                                      DWORD dwGuidKind, GUID *pGUID);
  ...
  HRESULT(STDMETHODCALLTYPE *GetInfoOfIndex)(IProvideMultipleClassInfo *This,
                                             ULONG iti, DWORD dwFlags,
...
/*** IUnknown methods ***/
static inline HRESULT
IProvideMultipleClassInfo_QueryInterface(IProvideMultipleClassInfo *This,
                                         REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IProvideMultipleClassInfo_AddRef(IProvideMultipleClassInfo *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IProvideMultipleClassInfo_Release(IProvideMultipleClassInfo *This) {
  return This->lpVtbl->Release(This);
}
/*** IProvideClassInfo methods ***/
static inline HRESULT
IProvideMultipleClassInfo_GetClassInfo(IProvideMultipleClassInfo *This,
                                       ITypeInfo **ppTI) {
  return This->lpVtbl->GetClassInfo(This, ppTI);
}
/*** IProvideClassInfo2 methods ***/
static inline HRESULT
IProvideMultipleClassInfo_GetGUID(IProvideMultipleClassInfo *This,
                                  DWORD dwGuidKind, GUID *pGUID) {
  return This->lpVtbl->GetGUID(This, dwGuidKind, pGUID);
}
/*** IProvideMultipleClassInfo methods ***/
static inline HRESULT
IProvideMultipleClassInfo_GetMultiTypeInfoCount(IProvideMultipleClassInfo *This,
                                                ULONG *pcti) {
  return This->lpVtbl->GetMultiTypeInfoCount(This, pcti);
}
static inline HRESULT IProvideMultipleClassInfo_GetInfoOfIndex(
    IProvideMultipleClassInfo *This, ULONG iti, DWORD dwFlags,
    ITypeInfo **pptiCoClass, DWORD *pdwTIFlags, ULONG *pcdispidReserved,
    IID *piidPrimary, IID *piidSource) {
  return This->lpVtbl->GetInfoOfIndex(This, iti, dwFlags, pptiCoClass,
                                      pdwTIFlags, pcdispidReserved, piidPrimary,
                                      piidSource);
}
#endif
#endif
...
DEFINE_GUID(IID_IOleControl, 0xb196b288, 0xbab4, 0x101a, 0xb6, 0x9c, 0x00, 0xaa,
            0x00, 0x34, 0x1d, 0x07);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IOleControl : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE FreezeEvents(WINBOOL bFreeze) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IOleControl, 0xb196b288, 0xbab4, 0x101a, 0xb6, 0x9c, 0x00, 0xaa,
                0x00, 0x34, 0x1d, 0x07)
#endif
#else
typedef struct IOleControlVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IOleControl *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IOleControl *This);
  ULONG(STDMETHODCALLTYPE *Release)(IOleControl *This);
  /*** IOleControl methods ***/
  HRESULT(STDMETHODCALLTYPE *GetControlInfo)(IOleControl *This,
                                             CONTROLINFO *pCI);
  HRESULT(STDMETHODCALLTYPE *OnMnemonic)(IOleControl *This, MSG *pMsg);
  HRESULT(STDMETHODCALLTYPE *OnAmbientPropertyChange)(IOleControl *This,
                                                      DISPID dispID);
  HRESULT(STDMETHODCALLTYPE *FreezeEvents)(IOleControl *This, WINBOOL bFreeze);
  END_INTERFACE
} IOleControlVtbl;
interface IOleControl { CONST_VTBL IOleControlVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IOleControl_QueryInterface(IOleControl *This, REFIID riid,
                                                 void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IOleControl methods ***/
static inline HRESULT IOleControl_GetControlInfo(IOleControl *This,
                                                 CONTROLINFO *pCI) {
...
static inline HRESULT IOleControl_OnAmbientPropertyChange(IOleControl *This,
                                                          DISPID dispID) {
  return This->lpVtbl->OnAmbientPropertyChange(This, dispID);
}
static inline HRESULT IOleControl_FreezeEvents(IOleControl *This,
                                               WINBOOL bFreeze) {
...
DEFINE_GUID(IID_IOleControlSite, 0xb196b289, 0xbab4, 0x101a, 0xb6, 0x9c, 0x00,
            0xaa, 0x00, 0x34, 0x1d, 0x07);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("b196b289-bab4-101a-b69c-00aa00341d07")
IOleControlSite : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE OnControlInfoChanged() = 0;
  virtual HRESULT STDMETHODCALLTYPE LockInPlaceActive(WINBOOL fLock) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetExtendedControl(IDispatch * *ppDisp) = 0;
  virtual HRESULT STDMETHODCALLTYPE TransformCoords(
      POINTL * pPtlHimetric, POINTF * pPtfContainer, DWORD dwFlags) = 0;
  virtual HRESULT STDMETHODCALLTYPE TranslateAccelerator(
      MSG * pMsg, DWORD grfModifiers) = 0;
  virtual HRESULT STDMETHODCALLTYPE OnFocus(WINBOOL fGotFocus) = 0;
  virtual HRESULT STDMETHODCALLTYPE ShowPropertyFrame() = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IOleControlSite, 0xb196b289, 0xbab4, 0x101a, 0xb6, 0x9c, 0x00,
                0xaa, 0x00, 0x34, 0x1d, 0x07)
#endif
#else
typedef struct IOleControlSiteVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IOleControlSite *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *LockInPlaceActive)(IOleControlSite *This,
                                                WINBOOL fLock);
  HRESULT(STDMETHODCALLTYPE *GetExtendedControl)(IOleControlSite *This,
                                                 IDispatch **ppDisp);
  HRESULT(STDMETHODCALLTYPE *TransformCoords)(IOleControlSite *This,
                                              POINTL *pPtlHimetric,
                                              POINTF *pPtfContainer,
                                              DWORD dwFlags);
  HRESULT(STDMETHODCALLTYPE *TranslateAccelerator)(IOleControlSite *This,
                                                   MSG *pMsg,
                                                   DWORD grfModifiers);
  HRESULT(STDMETHODCALLTYPE *OnFocus)(IOleControlSite *This, WINBOOL fGotFocus);
  HRESULT(STDMETHODCALLTYPE *ShowPropertyFrame)(IOleControlSite *This);
  END_INTERFACE
} IOleControlSiteVtbl;
interface IOleControlSite { CONST_VTBL IOleControlSiteVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define IOleControlSite_TransformCoords(This, pPtlHimetric, pPtfContainer,     \
                                        dwFlags)                               \
...
#else
/*** IUnknown methods ***/
static inline HRESULT IOleControlSite_QueryInterface(IOleControlSite *This,
                                                     REFIID riid,
                                                     void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IOleControlSite methods ***/
static inline HRESULT
IOleControlSite_OnControlInfoChanged(IOleControlSite *This) {
  return This->lpVtbl->OnControlInfoChanged(This);
}
static inline HRESULT IOleControlSite_LockInPlaceActive(IOleControlSite *This,
                                                        WINBOOL fLock) {
  return This->lpVtbl->LockInPlaceActive(This, fLock);
}
static inline HRESULT IOleControlSite_GetExtendedControl(IOleControlSite *This,
                                                         IDispatch **ppDisp) {
  return This->lpVtbl->GetExtendedControl(This, ppDisp);
}
static inline HRESULT IOleControlSite_TransformCoords(IOleControlSite *This,
                                                      POINTL *pPtlHimetric,
                                                      POINTF *pPtfContainer,
                                                      DWORD dwFlags) {
  return This->lpVtbl->TransformCoords(This, pPtlHimetric, pPtfContainer,
                                       dwFlags);
}
static inline HRESULT
IOleControlSite_TranslateAccelerator(IOleControlSite *This, MSG *pMsg,
                                     DWORD grfModifiers) {
  return This->lpVtbl->TranslateAccelerator(This, pMsg, grfModifiers);
}
static inline HRESULT IOleControlSite_OnFocus(IOleControlSite *This,
                                              WINBOOL fGotFocus) {
...
DEFINE_GUID(IID_IPropertyPage, 0xb196b28d, 0xbab4, 0x101a, 0xb6, 0x9c, 0x00,
            0xaa, 0x00, 0x34, 0x1d, 0x07);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("b196b28d-bab4-101a-b69c-00aa00341d07")
IPropertyPage : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE SetPageSite(IPropertyPageSite *
                                                pPageSite) = 0;
  virtual HRESULT STDMETHODCALLTYPE Activate(HWND hWndParent, LPCRECT pRect,
                                             WINBOOL bModal) = 0;
  virtual HRESULT STDMETHODCALLTYPE Deactivate() = 0;
  virtual HRESULT STDMETHODCALLTYPE GetPageInfo(PROPPAGEINFO * pPageInfo) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetObjects(ULONG cObjects,
                                               IUnknown * *ppUnk) = 0;
  virtual HRESULT STDMETHODCALLTYPE Show(UINT nCmdShow) = 0;
  virtual HRESULT STDMETHODCALLTYPE Move(LPCRECT pRect) = 0;
  virtual HRESULT STDMETHODCALLTYPE IsPageDirty() = 0;
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IPropertyPage, 0xb196b28d, 0xbab4, 0x101a, 0xb6, 0x9c, 0x00,
                0xaa, 0x00, 0x34, 0x1d, 0x07)
#endif
#else
typedef struct IPropertyPageVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPropertyPage *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IPropertyPage *This);
  ULONG(STDMETHODCALLTYPE *Release)(IPropertyPage *This);
  /*** IPropertyPage methods ***/
  HRESULT(STDMETHODCALLTYPE *SetPageSite)(IPropertyPage *This,
                                          IPropertyPageSite *pPageSite);
  HRESULT(STDMETHODCALLTYPE *Activate)(IPropertyPage *This, HWND hWndParent,
                                       LPCRECT pRect, WINBOOL bModal);
  HRESULT(STDMETHODCALLTYPE *Deactivate)(IPropertyPage *This);
  HRESULT(STDMETHODCALLTYPE *GetPageInfo)(IPropertyPage *This,
                                          PROPPAGEINFO *pPageInfo);
  HRESULT(STDMETHODCALLTYPE *SetObjects)(IPropertyPage *This, ULONG cObjects,
                                         IUnknown **ppUnk);
  ...
  HRESULT(STDMETHODCALLTYPE *TranslateAccelerator)(IPropertyPage *This,
                                                   MSG *pMsg);
  END_INTERFACE
} IPropertyPageVtbl;
interface IPropertyPage { CONST_VTBL IPropertyPageVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IPropertyPage_QueryInterface(IPropertyPage *This,
                                                   REFIID riid,
                                                   void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IPropertyPage methods ***/
static inline HRESULT IPropertyPage_SetPageSite(IPropertyPage *This,
                                                IPropertyPageSite *pPageSite) {
  return This->lpVtbl->SetPageSite(This, pPageSite);
}
static inline HRESULT IPropertyPage_Activate(IPropertyPage *This,
                                             HWND hWndParent, LPCRECT pRect,
                                             WINBOOL bModal) {
...
static inline HRESULT IPropertyPage_GetPageInfo(IPropertyPage *This,
                                                PROPPAGEINFO *pPageInfo) {
  return This->lpVtbl->GetPageInfo(This, pPageInfo);
}
static inline HRESULT IPropertyPage_SetObjects(IPropertyPage *This,
                                               ULONG cObjects,
                                               IUnknown **ppUnk) {
...
static inline HRESULT IPropertyPage_Help(IPropertyPage *This,
                                         LPCOLESTR pszHelpDir) {
  return This->lpVtbl->Help(This, pszHelpDir);
}
static inline HRESULT IPropertyPage_TranslateAccelerator(IPropertyPage *This,
                                                         MSG *pMsg) {
...
DEFINE_GUID(IID_IPropertyPage2, 0x01e44665, 0x24ac, 0x101b, 0x84, 0xed, 0x08,
            0x00, 0x2b, 0x2e, 0xc7, 0x13);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IPropertyPage2, 0x01e44665, 0x24ac, 0x101b, 0x84, 0xed, 0x08,
                0x00, 0x2b, 0x2e, 0xc7, 0x13)
#endif
#else
typedef struct IPropertyPage2Vtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPropertyPage2 *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IPropertyPage2 *This);
  ULONG(STDMETHODCALLTYPE *Release)(IPropertyPage2 *This);
  /*** IPropertyPage methods ***/
  HRESULT(STDMETHODCALLTYPE *SetPageSite)(IPropertyPage2 *This,
                                          IPropertyPageSite *pPageSite);
  HRESULT(STDMETHODCALLTYPE *Activate)(IPropertyPage2 *This, HWND hWndParent,
                                       LPCRECT pRect, WINBOOL bModal);
  HRESULT(STDMETHODCALLTYPE *Deactivate)(IPropertyPage2 *This);
  HRESULT(STDMETHODCALLTYPE *GetPageInfo)(IPropertyPage2 *This,
                                          PROPPAGEINFO *pPageInfo);
  HRESULT(STDMETHODCALLTYPE *SetObjects)(IPropertyPage2 *This, ULONG cObjects,
                                         IUnknown **ppUnk);
  ...
  HRESULT(STDMETHODCALLTYPE *TranslateAccelerator)(IPropertyPage2 *This,
                                                   MSG *pMsg);
  /*** IPropertyPage2 methods ***/
  HRESULT(STDMETHODCALLTYPE *EditProperty)(IPropertyPage2 *This, DISPID dispID);
  END_INTERFACE
} IPropertyPage2Vtbl;
interface IPropertyPage2 { CONST_VTBL IPropertyPage2Vtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IPropertyPage2_QueryInterface(IPropertyPage2 *This,
                                                    REFIID riid,
                                                    void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IPropertyPage methods ***/
static inline HRESULT IPropertyPage2_SetPageSite(IPropertyPage2 *This,
                                                 IPropertyPageSite *pPageSite) {
  return This->lpVtbl->SetPageSite(This, pPageSite);
}
static inline HRESULT IPropertyPage2_Activate(IPropertyPage2 *This,
                                              HWND hWndParent, LPCRECT pRect,
                                              WINBOOL bModal) {
  return This->lpVtbl->Activate(This, hWndParent, pRect, bModal);
}
...
static inline HRESULT IPropertyPage2_GetPageInfo(IPropertyPage2 *This,
                                                 PROPPAGEINFO *pPageInfo) {
  return This->lpVtbl->GetPageInfo(This, pPageInfo);
}
static inline HRESULT IPropertyPage2_SetObjects(IPropertyPage2 *This,
                                                ULONG cObjects,
                                                IUnknown **ppUnk) {
  return This->lpVtbl->SetObjects(This, cObjects, ppUnk);
}
...
static inline HRESULT IPropertyPage2_Help(IPropertyPage2 *This,
                                          LPCOLESTR pszHelpDir) {
  return This->lpVtbl->Help(This, pszHelpDir);
}
static inline HRESULT IPropertyPage2_TranslateAccelerator(IPropertyPage2 *This,
                                                          MSG *pMsg) {
  return This->lpVtbl->TranslateAccelerator(This, pMsg);
}
/*** IPropertyPage2 methods ***/
static inline HRESULT IPropertyPage2_EditProperty(IPropertyPage2 *This,
                                                  DISPID dispID) {
...
DEFINE_GUID(IID_IPropertyPageSite, 0xb196b28c, 0xbab4, 0x101a, 0xb6, 0x9c, 0x00,
            0xaa, 0x00, 0x34, 0x1d, 0x07);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IPropertyPageSite, 0xb196b28c, 0xbab4, 0x101a, 0xb6, 0x9c, 0x00,
                0xaa, 0x00, 0x34, 0x1d, 0x07)
#endif
#else
typedef struct IPropertyPageSiteVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPropertyPageSite *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *OnStatusChange)(IPropertyPageSite *This,
                                             DWORD dwFlags);
  HRESULT(STDMETHODCALLTYPE *GetLocaleID)(IPropertyPageSite *This,
                                          LCID *pLocaleID);
  HRESULT(STDMETHODCALLTYPE *GetPageContainer)(IPropertyPageSite *This,
                                               IUnknown **ppUnk);
  HRESULT(STDMETHODCALLTYPE *TranslateAccelerator)(IPropertyPageSite *This,
                                                   MSG *pMsg);
  END_INTERFACE
} IPropertyPageSiteVtbl;
interface IPropertyPageSite { CONST_VTBL IPropertyPageSiteVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IPropertyPageSite_QueryInterface(IPropertyPageSite *This,
                                                       REFIID riid,
                                                       void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IPropertyPageSite methods ***/
static inline HRESULT IPropertyPageSite_OnStatusChange(IPropertyPageSite *This,
                                                       DWORD dwFlags) {
  return This->lpVtbl->OnStatusChange(This, dwFlags);
}
static inline HRESULT IPropertyPageSite_GetLocaleID(IPropertyPageSite *This,
                                                    LCID *pLocaleID) {
  return This->lpVtbl->GetLocaleID(This, pLocaleID);
}
static inline HRESULT
IPropertyPageSite_GetPageContainer(IPropertyPageSite *This, IUnknown **ppUnk) {
  return This->lpVtbl->GetPageContainer(This, ppUnk);
}
static inline HRESULT
IPropertyPageSite_TranslateAccelerator(IPropertyPageSite *This, MSG *pMsg) {
  return This->lpVtbl->TranslateAccelerator(This, pMsg);
}
#endif
#endif
...
DEFINE_GUID(IID_IPropertyNotifySink, 0x9bfbbc02, 0xeff1, 0x101a, 0x84, 0xed,
            0x00, 0xaa, 0x00, 0x34, 0x1d, 0x07);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IPropertyNotifySink, 0x9bfbbc02, 0xeff1, 0x101a, 0x84, 0xed,
                0x00, 0xaa, 0x00, 0x34, 0x1d, 0x07)
#endif
#else
typedef struct IPropertyNotifySinkVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPropertyNotifySink *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IPropertyNotifySink *This);
  ULONG(STDMETHODCALLTYPE *Release)(IPropertyNotifySink *This);
  /*** IPropertyNotifySink methods ***/
  HRESULT(STDMETHODCALLTYPE *OnChanged)(IPropertyNotifySink *This,
                                        DISPID dispID);
  HRESULT(STDMETHODCALLTYPE *OnRequestEdit)(IPropertyNotifySink *This,
                                            DISPID dispID);
  END_INTERFACE
} IPropertyNotifySinkVtbl;
interface IPropertyNotifySink { CONST_VTBL IPropertyNotifySinkVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
IPropertyNotifySink_QueryInterface(IPropertyNotifySink *This, REFIID riid,
                                   void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IPropertyNotifySink methods ***/
static inline HRESULT IPropertyNotifySink_OnChanged(IPropertyNotifySink *This,
                                                    DISPID dispID) {
  return This->lpVtbl->OnChanged(This, dispID);
}
static inline HRESULT
IPropertyNotifySink_OnRequestEdit(IPropertyNotifySink *This, DISPID dispID) {
...
DEFINE_GUID(IID_ISpecifyPropertyPages, 0xb196b28b, 0xbab4, 0x101a, 0xb6, 0x9c,
            0x00, 0xaa, 0x00, 0x34, 0x1d, 0x07);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ISpecifyPropertyPages, 0xb196b28b, 0xbab4, 0x101a, 0xb6, 0x9c,
                0x00, 0xaa, 0x00, 0x34, 0x1d, 0x07)
#endif
#else
typedef struct ISpecifyPropertyPagesVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ISpecifyPropertyPages *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(ISpecifyPropertyPages *This);
  ULONG(STDMETHODCALLTYPE *Release)(ISpecifyPropertyPages *This);
  /*** ISpecifyPropertyPages methods ***/
  HRESULT(STDMETHODCALLTYPE *GetPages)(ISpecifyPropertyPages *This,
                                       CAUUID *pPages);
  END_INTERFACE
...
/*** IUnknown methods ***/
static inline HRESULT
ISpecifyPropertyPages_QueryInterface(ISpecifyPropertyPages *This, REFIID riid,
                                     void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ISpecifyPropertyPages methods ***/
static inline HRESULT
ISpecifyPropertyPages_GetPages(ISpecifyPropertyPages *This, CAUUID *pPages) {
...
DEFINE_GUID(IID_IPersistMemory, 0xbd1ae5e0, 0xa6ae, 0x11ce, 0xbd, 0x37, 0x50,
            0x42, 0x00, 0xc1, 0x00, 0x00);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IPersistMemory : public IPersist {
  ...
  virtual HRESULT STDMETHODCALLTYPE Save(LPVOID pMem, WINBOOL fClearDirty,
                                         ULONG cbSize) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetSizeMax(ULONG * pCbSize) = 0;
  virtual HRESULT STDMETHODCALLTYPE InitNew() = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IPersistMemory, 0xbd1ae5e0, 0xa6ae, 0x11ce, 0xbd, 0x37, 0x50,
                0x42, 0x00, 0xc1, 0x00, 0x00)
#endif
#else
typedef struct IPersistMemoryVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPersistMemory *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *Load)(IPersistMemory *This, LPVOID pMem,
                                   ULONG cbSize);
  HRESULT(STDMETHODCALLTYPE *Save)(IPersistMemory *This, LPVOID pMem,
                                   WINBOOL fClearDirty, ULONG cbSize);
...
interface IPersistMemory { CONST_VTBL IPersistMemoryVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IPersistMemory_QueryInterface(IPersistMemory *This,
                                                    REFIID riid,
                                                    void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IPersist methods ***/
static inline HRESULT IPersistMemory_GetClassID(IPersistMemory *This,
                                                CLSID *pClassID) {
...
static inline HRESULT IPersistMemory_Load(IPersistMemory *This, LPVOID pMem,
                                          ULONG cbSize) {
  return This->lpVtbl->Load(This, pMem, cbSize);
}
static inline HRESULT IPersistMemory_Save(IPersistMemory *This, LPVOID pMem,
                                          WINBOOL fClearDirty, ULONG cbSize) {
  return This->lpVtbl->Save(This, pMem, fClearDirty, cbSize);
}
static inline HRESULT IPersistMemory_GetSizeMax(IPersistMemory *This,
                                                ULONG *pCbSize) {
...
#endif
#endif
HRESULT STDMETHODCALLTYPE IPersistMemory_RemoteLoad_Proxy(IPersistMemory *This,
                                                          BYTE *pMem,
                                                          ULONG cbSize);
void __RPC_STUB IPersistMemory_RemoteLoad_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage, DWORD *pdwStubPhase);
HRESULT STDMETHODCALLTYPE IPersistMemory_RemoteSave_Proxy(IPersistMemory *This,
                                                          BYTE *pMem,
                                                          WINBOOL fClearDirty,
                                                          ULONG cbSize);
void __RPC_STUB IPersistMemory_RemoteSave_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage, DWORD *pdwStubPhase);
HRESULT CALLBACK IPersistMemory_Load_Proxy(IPersistMemory *This, LPVOID pMem,
                                           ULONG cbSize);
HRESULT __RPC_STUB IPersistMemory_Load_Stub(IPersistMemory *This, BYTE *pMem,
                                            ULONG cbSize);
HRESULT CALLBACK IPersistMemory_Save_Proxy(IPersistMemory *This, LPVOID pMem,
                                           WINBOOL fClearDirty, ULONG cbSize);
HRESULT __RPC_STUB IPersistMemory_Save_Stub(IPersistMemory *This, BYTE *pMem,
                                            WINBOOL fClearDirty, ULONG cbSize);
...
DEFINE_GUID(IID_IPersistStreamInit, 0x7fd52380, 0x4e07, 0x101b, 0xae, 0x2d,
            0x08, 0x00, 0x2b, 0x2e, 0xc7, 0x13);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IPersistStreamInit : public IPersist {
  ...
  virtual HRESULT STDMETHODCALLTYPE Save(LPSTREAM pStm,
                                         WINBOOL fClearDirty) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetSizeMax(ULARGE_INTEGER * pCbSize) = 0;
  virtual HRESULT STDMETHODCALLTYPE InitNew() = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IPersistStreamInit, 0x7fd52380, 0x4e07, 0x101b, 0xae, 0x2d,
                0x08, 0x00, 0x2b, 0x2e, 0xc7, 0x13)
#endif
#else
typedef struct IPersistStreamInitVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPersistStreamInit *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IPersistStreamInit *This);
  ULONG(STDMETHODCALLTYPE *Release)(IPersistStreamInit *This);
  /*** IPersist methods ***/
  HRESULT(STDMETHODCALLTYPE *GetClassID)(IPersistStreamInit *This,
                                         CLSID *pClassID);
  ...
  HRESULT(STDMETHODCALLTYPE *Save)(IPersistStreamInit *This, LPSTREAM pStm,
                                   WINBOOL fClearDirty);
  HRESULT(STDMETHODCALLTYPE *GetSizeMax)(IPersistStreamInit *This,
                                         ULARGE_INTEGER *pCbSize);
  HRESULT(STDMETHODCALLTYPE *InitNew)(IPersistStreamInit *This);
  END_INTERFACE
} IPersistStreamInitVtbl;
interface IPersistStreamInit { CONST_VTBL IPersistStreamInitVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
IPersistStreamInit_QueryInterface(IPersistStreamInit *This, REFIID riid,
                                  void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IPersist methods ***/
static inline HRESULT IPersistStreamInit_GetClassID(IPersistStreamInit *This,
                                                    CLSID *pClassID) {
  return This->lpVtbl->GetClassID(This, pClassID);
}
/*** IPersistStreamInit methods ***/
...
static inline HRESULT IPersistStreamInit_Load(IPersistStreamInit *This,
                                              LPSTREAM pStm) {
  return This->lpVtbl->Load(This, pStm);
}
static inline HRESULT IPersistStreamInit_Save(IPersistStreamInit *This,
                                              LPSTREAM pStm,
                                              WINBOOL fClearDirty) {
  return This->lpVtbl->Save(This, pStm, fClearDirty);
}
static inline HRESULT IPersistStreamInit_GetSizeMax(IPersistStreamInit *This,
                                                    ULARGE_INTEGER *pCbSize) {
  return This->lpVtbl->GetSizeMax(This, pCbSize);
}
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IPersistPropertyBag, 0x37d84f60, 0x42cb, 0x11ce, 0x81, 0x35,
                0x00, 0xaa, 0x00, 0x4b, 0xb8, 0x51)
#endif
#else
typedef struct IPersistPropertyBagVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPersistPropertyBag *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IPersistPropertyBag *This);
  ULONG(STDMETHODCALLTYPE *Release)(IPersistPropertyBag *This);
  /*** IPersist methods ***/
  HRESULT(STDMETHODCALLTYPE *GetClassID)(IPersistPropertyBag *This,
                                         CLSID *pClassID);
  /*** IPersistPropertyBag methods ***/
  HRESULT(STDMETHODCALLTYPE *InitNew)(IPersistPropertyBag *This);
  HRESULT(STDMETHODCALLTYPE *Load)(IPersistPropertyBag *This,
                                   IPropertyBag *pPropBag,
                                   IErrorLog *pErrorLog);
  HRESULT(STDMETHODCALLTYPE *Save)(IPersistPropertyBag *This,
                                   IPropertyBag *pPropBag, WINBOOL fClearDirty,
                                   WINBOOL fSaveAllProperties);
  END_INTERFACE
} IPersistPropertyBagVtbl;
interface IPersistPropertyBag { CONST_VTBL IPersistPropertyBagVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define IPersistPropertyBag_Save(This, pPropBag, fClearDirty,                  \
                                 fSaveAllProperties)                           \
  (This)->lpVtbl->Save(This, pPropBag, fClearDirty, fSaveAllProperties)
#else
/*** IUnknown methods ***/
static inline HRESULT
IPersistPropertyBag_QueryInterface(IPersistPropertyBag *This, REFIID riid,
                                   void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IPersist methods ***/
static inline HRESULT IPersistPropertyBag_GetClassID(IPersistPropertyBag *This,
                                                     CLSID *pClassID) {
  return This->lpVtbl->GetClassID(This, pClassID);
}
/*** IPersistPropertyBag methods ***/
...
static inline HRESULT IPersistPropertyBag_Load(IPersistPropertyBag *This,
                                               IPropertyBag *pPropBag,
                                               IErrorLog *pErrorLog) {
  return This->lpVtbl->Load(This, pPropBag, pErrorLog);
}
static inline HRESULT IPersistPropertyBag_Save(IPersistPropertyBag *This,
                                               IPropertyBag *pPropBag,
                                               WINBOOL fClearDirty,
                                               WINBOOL fSaveAllProperties) {
...
DEFINE_GUID(IID_ISimpleFrameSite, 0x742b0e01, 0x14e6, 0x101b, 0x91, 0x4e, 0x00,
...
ISimpleFrameSite : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE PreMessageFilter(
      HWND hWnd, UINT msg, WPARAM wp, LPARAM lp, LRESULT * plResult,
      DWORD * pdwCookie) = 0;
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ISimpleFrameSite, 0x742b0e01, 0x14e6, 0x101b, 0x91, 0x4e, 0x00,
                0xaa, 0x00, 0x30, 0x0c, 0xab)
#endif
#else
typedef struct ISimpleFrameSiteVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ISimpleFrameSite *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *PreMessageFilter)(ISimpleFrameSite *This,
                                               HWND hWnd, UINT msg, WPARAM wp,
                                               LPARAM lp, LRESULT *plResult,
                                               DWORD *pdwCookie);
  HRESULT(STDMETHODCALLTYPE *PostMessageFilter)(ISimpleFrameSite *This,
                                                HWND hWnd, UINT msg, WPARAM wp,
                                                LPARAM lp, LRESULT *plResult,
                                                DWORD dwCookie);
  END_INTERFACE
} ISimpleFrameSiteVtbl;
interface ISimpleFrameSite { CONST_VTBL ISimpleFrameSiteVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** ISimpleFrameSite methods ***/
#define ISimpleFrameSite_PreMessageFilter(This, hWnd, msg, wp, lp, plResult,   \
                                          pdwCookie)                           \
  (This)->lpVtbl->PreMessageFilter(This, hWnd, msg, wp, lp, plResult, pdwCookie)
#define ISimpleFrameSite_PostMessageFilter(This, hWnd, msg, wp, lp, plResult,  \
                                           dwCookie)                           \
  (This)->lpVtbl->PostMessageFilter(This, hWnd, msg, wp, lp, plResult, dwCookie)
#else
/*** IUnknown methods ***/
static inline HRESULT ISimpleFrameSite_QueryInterface(ISimpleFrameSite *This,
                                                      REFIID riid,
                                                      void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ISimpleFrameSite methods ***/
static inline HRESULT ISimpleFrameSite_PreMessageFilter(ISimpleFrameSite *This,
                                                        HWND hWnd, UINT msg,
                                                        WPARAM wp, LPARAM lp,
                                                        LRESULT *plResult,
                                                        DWORD *pdwCookie) {
  return This->lpVtbl->PreMessageFilter(This, hWnd, msg, wp, lp, plResult,
                                        pdwCookie);
}
static inline HRESULT ISimpleFrameSite_PostMessageFilter(ISimpleFrameSite *This,
                                                         HWND hWnd, UINT msg,
                                                         WPARAM wp, LPARAM lp,
                                                         LRESULT *plResult,
                                                         DWORD dwCookie) {
  return This->lpVtbl->PostMessageFilter(This, hWnd, msg, wp, lp, plResult,
                                         dwCookie);
}
#endif
#endif
...
DEFINE_GUID(IID_IFont, 0xbef6e002, 0xa874, 0x101a, 0x8b, 0xba, 0x00, 0xaa, 0x00,
            0x30, 0x0c, 0xab);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IFont : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE get_Bold(WINBOOL * pBold) = 0;
  virtual HRESULT STDMETHODCALLTYPE put_Bold(WINBOOL bold) = 0;
  virtual HRESULT STDMETHODCALLTYPE get_Italic(WINBOOL * pItalic) = 0;
  virtual HRESULT STDMETHODCALLTYPE put_Italic(WINBOOL italic) = 0;
  virtual HRESULT STDMETHODCALLTYPE get_Underline(WINBOOL * pUnderline) = 0;
  virtual HRESULT STDMETHODCALLTYPE put_Underline(WINBOOL underline) = 0;
  virtual HRESULT STDMETHODCALLTYPE get_Strikethrough(WINBOOL *
                                                      pStrikethrough) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE SetRatio(LONG cyLogical,
                                             LONG cyHimetric) = 0;
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IFont, 0xbef6e002, 0xa874, 0x101a, 0x8b, 0xba, 0x00, 0xaa, 0x00,
                0x30, 0x0c, 0xab)
#endif
#else
typedef struct IFontVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IFont *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *get_Bold)(IFont *This, WINBOOL *pBold);
  HRESULT(STDMETHODCALLTYPE *put_Bold)(IFont *This, WINBOOL bold);
  HRESULT(STDMETHODCALLTYPE *get_Italic)(IFont *This, WINBOOL *pItalic);
  HRESULT(STDMETHODCALLTYPE *put_Italic)(IFont *This, WINBOOL italic);
  HRESULT(STDMETHODCALLTYPE *get_Underline)(IFont *This, WINBOOL *pUnderline);
  HRESULT(STDMETHODCALLTYPE *put_Underline)(IFont *This, WINBOOL underline);
  HRESULT(STDMETHODCALLTYPE *get_Strikethrough)(IFont *This,
                                                WINBOOL *pStrikethrough);
  HRESULT(STDMETHODCALLTYPE *put_Strikethrough)(IFont *This,
  ...
  HRESULT(STDMETHODCALLTYPE *SetRatio)(IFont *This, LONG cyLogical,
                                       LONG cyHimetric);
...
interface IFont { CONST_VTBL IFontVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IFont_QueryInterface(IFont *This, REFIID riid,
                                           void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
static inline HRESULT IFont_get_Strikethrough(IFont *This,
                                              WINBOOL *pStrikethrough) {
  return This->lpVtbl->get_Strikethrough(This, pStrikethrough);
}
static inline HRESULT IFont_put_Strikethrough(IFont *This,
                                              WINBOOL strikethrough) {
...
static inline HRESULT IFont_SetRatio(IFont *This, LONG cyLogical,
                                     LONG cyHimetric) {
...
DEFINE_GUID(IID_IPicture, 0x7bf80980, 0xbf32, 0x101a, 0x8b, 0xbb, 0x00, 0xaa,
            0x00, 0x30, 0x0c, 0xab);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IPicture : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE get_Height(OLE_YSIZE_HIMETRIC *
                                               pHeight) = 0;
  virtual HRESULT STDMETHODCALLTYPE Render(
      HDC hDC, LONG x, LONG y, LONG cx, LONG cy, OLE_XPOS_HIMETRIC xSrc,
      OLE_YPOS_HIMETRIC ySrc, OLE_XSIZE_HIMETRIC cxSrc,
      OLE_YSIZE_HIMETRIC cySrc, LPCRECT pRcWBounds) = 0;
  virtual HRESULT STDMETHODCALLTYPE set_hPal(OLE_HANDLE hPal) = 0;
  virtual HRESULT STDMETHODCALLTYPE get_CurDC(HDC * phDC) = 0;
  virtual HRESULT STDMETHODCALLTYPE SelectPicture(HDC hDCIn, HDC * phDCOut,
                                                  OLE_HANDLE * phBmpOut) = 0;
  virtual HRESULT STDMETHODCALLTYPE get_KeepOriginalFormat(WINBOOL * pKeep) = 0;
  virtual HRESULT STDMETHODCALLTYPE put_KeepOriginalFormat(WINBOOL keep) = 0;
  virtual HRESULT STDMETHODCALLTYPE PictureChanged() = 0;
  virtual HRESULT STDMETHODCALLTYPE SaveAsFile(
      LPSTREAM pStream, WINBOOL fSaveMemCopy, LONG * pCbSize) = 0;
  virtual HRESULT STDMETHODCALLTYPE get_Attributes(DWORD * pDwAttr) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IPicture, 0x7bf80980, 0xbf32, 0x101a, 0x8b, 0xbb, 0x00, 0xaa,
                0x00, 0x30, 0x0c, 0xab)
#endif
#else
typedef struct IPictureVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPicture *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *get_Width)(IPicture *This,
                                        OLE_XSIZE_HIMETRIC *pWidth);
  HRESULT(STDMETHODCALLTYPE *get_Height)(IPicture *This,
                                         OLE_YSIZE_HIMETRIC *pHeight);
  HRESULT(STDMETHODCALLTYPE *Render)(IPicture *This, HDC hDC, LONG x, LONG y,
                                     LONG cx, LONG cy, OLE_XPOS_HIMETRIC xSrc,
  ...
  HRESULT(STDMETHODCALLTYPE *SelectPicture)(IPicture *This, HDC hDCIn,
                                            HDC *phDCOut, OLE_HANDLE *phBmpOut);
  HRESULT(STDMETHODCALLTYPE *get_KeepOriginalFormat)(IPicture *This,
                                                     WINBOOL *pKeep);
  HRESULT(STDMETHODCALLTYPE *put_KeepOriginalFormat)(IPicture *This,
                                                     WINBOOL keep);
  HRESULT(STDMETHODCALLTYPE *PictureChanged)(IPicture *This);
  HRESULT(STDMETHODCALLTYPE *SaveAsFile)(IPicture *This, LPSTREAM pStream,
                                         WINBOOL fSaveMemCopy, LONG *pCbSize);
  HRESULT(STDMETHODCALLTYPE *get_Attributes)(IPicture *This, DWORD *pDwAttr);
  END_INTERFACE
} IPictureVtbl;
interface IPicture { CONST_VTBL IPictureVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define IPicture_Render(This, hDC, x, y, cx, cy, xSrc, ySrc, cxSrc, cySrc,     \
                        pRcWBounds)                                            \
  (This)->lpVtbl->Render(This, hDC, x, y, cx, cy, xSrc, ySrc, cxSrc, cySrc,    \
                         pRcWBounds)
...
#else
/*** IUnknown methods ***/
static inline HRESULT IPicture_QueryInterface(IPicture *This, REFIID riid,
                                              void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
static inline HRESULT IPicture_get_Width(IPicture *This,
                                         OLE_XSIZE_HIMETRIC *pWidth) {
  return This->lpVtbl->get_Width(This, pWidth);
}
static inline HRESULT IPicture_get_Height(IPicture *This,
                                          OLE_YSIZE_HIMETRIC *pHeight) {
  return This->lpVtbl->get_Height(This, pHeight);
}
static inline HRESULT IPicture_Render(IPicture *This, HDC hDC, LONG x, LONG y,
                                      LONG cx, LONG cy, OLE_XPOS_HIMETRIC xSrc,
                                      OLE_YPOS_HIMETRIC ySrc,
                                      OLE_XSIZE_HIMETRIC cxSrc,
                                      OLE_YSIZE_HIMETRIC cySrc,
                                      LPCRECT pRcWBounds) {
  return This->lpVtbl->Render(This, hDC, x, y, cx, cy, xSrc, ySrc, cxSrc, cySrc,
                              pRcWBounds);
}
...
static inline HRESULT IPicture_SelectPicture(IPicture *This, HDC hDCIn,
                                             HDC *phDCOut,
                                             OLE_HANDLE *phBmpOut) {
  return This->lpVtbl->SelectPicture(This, hDCIn, phDCOut, phBmpOut);
}
static inline HRESULT IPicture_get_KeepOriginalFormat(IPicture *This,
                                                      WINBOOL *pKeep) {
  return This->lpVtbl->get_KeepOriginalFormat(This, pKeep);
}
static inline HRESULT IPicture_put_KeepOriginalFormat(IPicture *This,
                                                      WINBOOL keep) {
...
static inline HRESULT IPicture_SaveAsFile(IPicture *This, LPSTREAM pStream,
                                          WINBOOL fSaveMemCopy, LONG *pCbSize) {
...
DEFINE_GUID(IID_IPicture2, 0xf5185dd8, 0x2012, 0x4b0b, 0xaa, 0xd9, 0xf0, 0x52,
            0xc6, 0xbd, 0x48, 0x2b);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("f5185dd8-2012-4b0b-aad9-f052c6bd482b")
IPicture2 : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE get_Handle(HHANDLE * pHandle) = 0;
  virtual HRESULT STDMETHODCALLTYPE get_hPal(HHANDLE * phPal) = 0;
  virtual HRESULT STDMETHODCALLTYPE get_Type(SHORT * pType) = 0;
  virtual HRESULT STDMETHODCALLTYPE get_Width(OLE_XSIZE_HIMETRIC * pWidth) = 0;
  virtual HRESULT STDMETHODCALLTYPE get_Height(OLE_YSIZE_HIMETRIC *
                                               pHeight) = 0;
  virtual HRESULT STDMETHODCALLTYPE Render(
      ...
      OLE_YPOS_HIMETRIC ySrc, OLE_XSIZE_HIMETRIC cxSrc,
      OLE_YSIZE_HIMETRIC cySrc, LPCRECT pRcWBounds) = 0;
  virtual HRESULT STDMETHODCALLTYPE set_hPal(HHANDLE hPal) = 0;
  virtual HRESULT STDMETHODCALLTYPE get_CurDC(HDC * phDC) = 0;
  virtual HRESULT STDMETHODCALLTYPE SelectPicture(HDC hDCIn, HDC * phDCOut,
                                                  HHANDLE * phBmpOut) = 0;
  virtual HRESULT STDMETHODCALLTYPE get_KeepOriginalFormat(WINBOOL * pKeep) = 0;
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IPicture2, 0xf5185dd8, 0x2012, 0x4b0b, 0xaa, 0xd9, 0xf0, 0x52,
                0xc6, 0xbd, 0x48, 0x2b)
#endif
#else
typedef struct IPicture2Vtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPicture2 *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IPicture2 *This);
  ULONG(STDMETHODCALLTYPE *Release)(IPicture2 *This);
  /*** IPicture2 methods ***/
  HRESULT(STDMETHODCALLTYPE *get_Handle)(IPicture2 *This, HHANDLE *pHandle);
  HRESULT(STDMETHODCALLTYPE *get_hPal)(IPicture2 *This, HHANDLE *phPal);
  HRESULT(STDMETHODCALLTYPE *get_Type)(IPicture2 *This, SHORT *pType);
  HRESULT(STDMETHODCALLTYPE *get_Width)(IPicture2 *This,
                                        OLE_XSIZE_HIMETRIC *pWidth);
  HRESULT(STDMETHODCALLTYPE *get_Height)(IPicture2 *This,
                                         OLE_YSIZE_HIMETRIC *pHeight);
  HRESULT(STDMETHODCALLTYPE *Render)(IPicture2 *This, HDC hDC, LONG x, LONG y,
                                     LONG cx, LONG cy, OLE_XPOS_HIMETRIC xSrc,
                                     OLE_YPOS_HIMETRIC ySrc,
                                     OLE_XSIZE_HIMETRIC cxSrc,
                                     OLE_YSIZE_HIMETRIC cySrc,
                                     LPCRECT pRcWBounds);
  HRESULT(STDMETHODCALLTYPE *set_hPal)(IPicture2 *This, HHANDLE hPal);
  HRESULT(STDMETHODCALLTYPE *get_CurDC)(IPicture2 *This, HDC *phDC);
  HRESULT(STDMETHODCALLTYPE *SelectPicture)(IPicture2 *This, HDC hDCIn,
                                            HDC *phDCOut, HHANDLE *phBmpOut);
  HRESULT(STDMETHODCALLTYPE *get_KeepOriginalFormat)(IPicture2 *This,
                                                     WINBOOL *pKeep);
  HRESULT(STDMETHODCALLTYPE *put_KeepOriginalFormat)(IPicture2 *This,
                                                     WINBOOL keep);
  HRESULT(STDMETHODCALLTYPE *PictureChanged)(IPicture2 *This);
  HRESULT(STDMETHODCALLTYPE *SaveAsFile)(IPicture2 *This, LPSTREAM pStream,
                                         WINBOOL fSaveMemCopy, LONG *pCbSize);
  HRESULT(STDMETHODCALLTYPE *get_Attributes)(IPicture2 *This, DWORD *pDwAttr);
  END_INTERFACE
} IPicture2Vtbl;
interface IPicture2 { CONST_VTBL IPicture2Vtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define IPicture2_get_Height(This, pHeight)                                    \
  (This)->lpVtbl->get_Height(This, pHeight)
#define IPicture2_Render(This, hDC, x, y, cx, cy, xSrc, ySrc, cxSrc, cySrc,    \
                         pRcWBounds)                                           \
  (This)->lpVtbl->Render(This, hDC, x, y, cx, cy, xSrc, ySrc, cxSrc, cySrc,    \
                         pRcWBounds)
...
#else
/*** IUnknown methods ***/
static inline HRESULT IPicture2_QueryInterface(IPicture2 *This, REFIID riid,
                                               void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
static inline HRESULT IPicture2_get_Width(IPicture2 *This,
                                          OLE_XSIZE_HIMETRIC *pWidth) {
  return This->lpVtbl->get_Width(This, pWidth);
}
static inline HRESULT IPicture2_get_Height(IPicture2 *This,
                                           OLE_YSIZE_HIMETRIC *pHeight) {
  return This->lpVtbl->get_Height(This, pHeight);
}
static inline HRESULT IPicture2_Render(IPicture2 *This, HDC hDC, LONG x, LONG y,
                                       LONG cx, LONG cy, OLE_XPOS_HIMETRIC xSrc,
                                       OLE_YPOS_HIMETRIC ySrc,
                                       OLE_XSIZE_HIMETRIC cxSrc,
                                       OLE_YSIZE_HIMETRIC cySrc,
...
static inline HRESULT IPicture2_SelectPicture(IPicture2 *This, HDC hDCIn,
                                              HDC *phDCOut, HHANDLE *phBmpOut) {
  return This->lpVtbl->SelectPicture(This, hDCIn, phDCOut, phBmpOut);
}
static inline HRESULT IPicture2_get_KeepOriginalFormat(IPicture2 *This,
                                                       WINBOOL *pKeep) {
  return This->lpVtbl->get_KeepOriginalFormat(This, pKeep);
}
static inline HRESULT IPicture2_put_KeepOriginalFormat(IPicture2 *This,
                                                       WINBOOL keep) {
  return This->lpVtbl->put_KeepOriginalFormat(This, keep);
}
...
static inline HRESULT IPicture2_SaveAsFile(IPicture2 *This, LPSTREAM pStream,
                                           WINBOOL fSaveMemCopy,
                                           LONG *pCbSize) {
  return This->lpVtbl->SaveAsFile(This, pStream, fSaveMemCopy, pCbSize);
}
static inline HRESULT IPicture2_get_Attributes(IPicture2 *This,
                                               DWORD *pDwAttr) {
  return This->lpVtbl->get_Attributes(This, pDwAttr);
}
#endif
...
DEFINE_GUID(IID_IFontEventsDisp, 0x4ef6100a, 0xaf88, 0x11d0, 0x98, 0x46, 0x00,
            0xc0, 0x4f, 0xc2, 0x99, 0x93);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("4ef6100a-af88-11d0-9846-00c04fc29993")
IFontEventsDisp : public IDispatch{};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IFontEventsDisp, 0x4ef6100a, 0xaf88, 0x11d0, 0x98, 0x46, 0x00,
                0xc0, 0x4f, 0xc2, 0x99, 0x93)
#endif
#else
typedef struct IFontEventsDispVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IFontEventsDisp *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IFontEventsDisp *This);
  ULONG(STDMETHODCALLTYPE *Release)(IFontEventsDisp *This);
  /*** IDispatch methods ***/
  HRESULT(STDMETHODCALLTYPE *GetTypeInfoCount)(IFontEventsDisp *This,
                                               UINT *pctinfo);
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(IFontEventsDisp *This, UINT iTInfo,
                                          LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(IFontEventsDisp *This, REFIID riid,
                                            LPOLESTR *rgszNames, UINT cNames,
                                            LCID lcid, DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(IFontEventsDisp *This, DISPID dispIdMember,
...
interface IFontEventsDisp { CONST_VTBL IFontEventsDispVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define IFontEventsDisp_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,     \
                                      rgDispId)                                \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IFontEventsDisp_Invoke(This, dispIdMember, riid, lcid, wFlags,         \
                               pDispParams, pVarResult, pExcepInfo, puArgErr)  \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
#else
/*** IUnknown methods ***/
static inline HRESULT IFontEventsDisp_QueryInterface(IFontEventsDisp *This,
                                                     REFIID riid,
                                                     void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IDispatch methods ***/
static inline HRESULT IFontEventsDisp_GetTypeInfoCount(IFontEventsDisp *This,
                                                       UINT *pctinfo) {
  return This->lpVtbl->GetTypeInfoCount(This, pctinfo);
}
static inline HRESULT IFontEventsDisp_GetTypeInfo(IFontEventsDisp *This,
                                                  UINT iTInfo, LCID lcid,
                                                  ITypeInfo **ppTInfo) {
  return This->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo);
}
static inline HRESULT IFontEventsDisp_GetIDsOfNames(IFontEventsDisp *This,
                                                    REFIID riid,
                                                    LPOLESTR *rgszNames,
...
static inline HRESULT
IFontEventsDisp_Invoke(IFontEventsDisp *This, DISPID dispIdMember, REFIID riid,
...
DEFINE_GUID(IID_IFontDisp, 0xbef6e003, 0xa874, 0x101a, 0x8b, 0xba, 0x00, 0xaa,
            0x00, 0x30, 0x0c, 0xab);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("bef6e003-a874-101a-8bba-00aa00300cab")
IFontDisp : public IDispatch{};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IFontDisp, 0xbef6e003, 0xa874, 0x101a, 0x8b, 0xba, 0x00, 0xaa,
                0x00, 0x30, 0x0c, 0xab)
#endif
#else
typedef struct IFontDispVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IFontDisp *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(IFontDisp *This, UINT iTInfo,
                                          LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(IFontDisp *This, REFIID riid,
                                            LPOLESTR *rgszNames, UINT cNames,
                                            LCID lcid, DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(IFontDisp *This, DISPID dispIdMember,
                                     REFIID riid, LCID lcid, WORD wFlags,
                                     DISPPARAMS *pDispParams,
                                     VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                                     UINT *puArgErr);
...
interface IFontDisp { CONST_VTBL IFontDispVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IFontDisp_QueryInterface(IFontDisp *This, REFIID riid,
                                               void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IDispatch methods ***/
static inline HRESULT IFontDisp_GetTypeInfoCount(IFontDisp *This,
                                                 UINT *pctinfo) {
  return This->lpVtbl->GetTypeInfoCount(This, pctinfo);
}
static inline HRESULT IFontDisp_GetTypeInfo(IFontDisp *This, UINT iTInfo,
                                            LCID lcid, ITypeInfo **ppTInfo) {
  return This->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo);
}
static inline HRESULT IFontDisp_GetIDsOfNames(IFontDisp *This, REFIID riid,
                                              LPOLESTR *rgszNames, UINT cNames,
                                              LCID lcid, DISPID *rgDispId) {
  return This->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid,
                                     rgDispId);
}
static inline HRESULT IFontDisp_Invoke(IFontDisp *This, DISPID dispIdMember,
                                       REFIID riid, LCID lcid, WORD wFlags,
                                       DISPPARAMS *pDispParams,
                                       VARIANT *pVarResult,
...
DEFINE_GUID(IID_IPictureDisp, 0x7bf80981, 0xbf32, 0x101a, 0x8b, 0xbb, 0x00,
            0xaa, 0x00, 0x30, 0x0c, 0xab);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("7bf80981-bf32-101a-8bbb-00aa00300cab")
IPictureDisp : public IDispatch{};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IPictureDisp, 0x7bf80981, 0xbf32, 0x101a, 0x8b, 0xbb, 0x00,
                0xaa, 0x00, 0x30, 0x0c, 0xab)
#endif
#else
typedef struct IPictureDispVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPictureDisp *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IPictureDisp *This);
  ULONG(STDMETHODCALLTYPE *Release)(IPictureDisp *This);
  /*** IDispatch methods ***/
  HRESULT(STDMETHODCALLTYPE *GetTypeInfoCount)(IPictureDisp *This,
                                               UINT *pctinfo);
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(IPictureDisp *This, UINT iTInfo,
                                          LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(IPictureDisp *This, REFIID riid,
                                            LPOLESTR *rgszNames, UINT cNames,
                                            LCID lcid, DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(IPictureDisp *This, DISPID dispIdMember,
                                     REFIID riid, LCID lcid, WORD wFlags,
                                     DISPPARAMS *pDispParams,
                                     VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                                     UINT *puArgErr);
...
interface IPictureDisp { CONST_VTBL IPictureDispVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define IPictureDisp_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                  \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IPictureDisp_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,        \
                                   rgDispId)                                   \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IPictureDisp_Invoke(This, dispIdMember, riid, lcid, wFlags,            \
                            pDispParams, pVarResult, pExcepInfo, puArgErr)     \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
#else
/*** IUnknown methods ***/
static inline HRESULT
IPictureDisp_QueryInterface(IPictureDisp *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IDispatch methods ***/
static inline HRESULT IPictureDisp_GetTypeInfoCount(IPictureDisp *This,
                                                    UINT *pctinfo) {
  return This->lpVtbl->GetTypeInfoCount(This, pctinfo);
}
static inline HRESULT IPictureDisp_GetTypeInfo(IPictureDisp *This, UINT iTInfo,
                                               LCID lcid, ITypeInfo **ppTInfo) {
  return This->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo);
}
static inline HRESULT
IPictureDisp_GetIDsOfNames(IPictureDisp *This, REFIID riid, LPOLESTR *rgszNames,
                           UINT cNames, LCID lcid, DISPID *rgDispId) {
  return This->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid,
                                     rgDispId);
}
static inline HRESULT
IPictureDisp_Invoke(IPictureDisp *This, DISPID dispIdMember, REFIID riid,
                    LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                    VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                    UINT *puArgErr) {
  return This->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags,
...
DEFINE_GUID(IID_IOleInPlaceObjectWindowless, 0x1c2056cc, 0x5ef4, 0x101b, 0x8b,
            0xc8, 0x00, 0xaa, 0x00, 0x3e, 0x3b, 0x29);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IOleInPlaceObjectWindowless : public IOleInPlaceObject {
  virtual HRESULT STDMETHODCALLTYPE OnWindowMessage(
      UINT msg, WPARAM wParam, LPARAM lParam, LRESULT * plResult) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetDropTarget(IDropTarget *
                                                  *ppDropTarget) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IOleInPlaceObjectWindowless, 0x1c2056cc, 0x5ef4, 0x101b, 0x8b,
                0xc8, 0x00, 0xaa, 0x00, 0x3e, 0x3b, 0x29)
#endif
#else
typedef struct IOleInPlaceObjectWindowlessVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IOleInPlaceObjectWindowless *This,
                                             REFIID riid, void **ppvObject);
  ...
  /*** IOleWindow methods ***/
  HRESULT(STDMETHODCALLTYPE *GetWindow)(IOleInPlaceObjectWindowless *This,
                                        HWND *phwnd);
  HRESULT(STDMETHODCALLTYPE *ContextSensitiveHelp)(
      IOleInPlaceObjectWindowless *This, WINBOOL fEnterMode);
  ...
  HRESULT(STDMETHODCALLTYPE *SetObjectRects)(IOleInPlaceObjectWindowless *This,
                                             LPCRECT lprcPosRect,
                                             LPCRECT lprcClipRect);
  HRESULT(STDMETHODCALLTYPE *ReactivateAndUndo)(
      IOleInPlaceObjectWindowless *This);
  /*** IOleInPlaceObjectWindowless methods ***/
  HRESULT(STDMETHODCALLTYPE *OnWindowMessage)(IOleInPlaceObjectWindowless *This,
                                              UINT msg, WPARAM wParam,
                                              LPARAM lParam, LRESULT *plResult);
  HRESULT(STDMETHODCALLTYPE *GetDropTarget)(IOleInPlaceObjectWindowless *This,
...
#define IOleInPlaceObjectWindowless_SetObjectRects(This, lprcPosRect,          \
                                                   lprcClipRect)               \
...
/*** IOleInPlaceObjectWindowless methods ***/
#define IOleInPlaceObjectWindowless_OnWindowMessage(This, msg, wParam, lParam, \
                                                    plResult)                  \
...
/*** IUnknown methods ***/
static inline HRESULT
IOleInPlaceObjectWindowless_QueryInterface(IOleInPlaceObjectWindowless *This,
                                           REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IOleInPlaceObjectWindowless_AddRef(IOleInPlaceObjectWindowless *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IOleInPlaceObjectWindowless_Release(IOleInPlaceObjectWindowless *This) {
  return This->lpVtbl->Release(This);
}
/*** IOleWindow methods ***/
static inline HRESULT
IOleInPlaceObjectWindowless_GetWindow(IOleInPlaceObjectWindowless *This,
                                      HWND *phwnd) {
  return This->lpVtbl->GetWindow(This, phwnd);
}
static inline HRESULT IOleInPlaceObjectWindowless_ContextSensitiveHelp(
    IOleInPlaceObjectWindowless *This, WINBOOL fEnterMode) {
  return This->lpVtbl->ContextSensitiveHelp(This, fEnterMode);
}
/*** IOleInPlaceObject methods ***/
static inline HRESULT IOleInPlaceObjectWindowless_InPlaceDeactivate(
    IOleInPlaceObjectWindowless *This) {
  return This->lpVtbl->InPlaceDeactivate(This);
}
static inline HRESULT
IOleInPlaceObjectWindowless_UIDeactivate(IOleInPlaceObjectWindowless *This) {
  return This->lpVtbl->UIDeactivate(This);
}
static inline HRESULT
IOleInPlaceObjectWindowless_SetObjectRects(IOleInPlaceObjectWindowless *This,
                                           LPCRECT lprcPosRect,
                                           LPCRECT lprcClipRect) {
  return This->lpVtbl->SetObjectRects(This, lprcPosRect, lprcClipRect);
}
static inline HRESULT IOleInPlaceObjectWindowless_ReactivateAndUndo(
    IOleInPlaceObjectWindowless *This) {
  return This->lpVtbl->ReactivateAndUndo(This);
}
/*** IOleInPlaceObjectWindowless methods ***/
static inline HRESULT
IOleInPlaceObjectWindowless_OnWindowMessage(IOleInPlaceObjectWindowless *This,
                                            UINT msg, WPARAM wParam,
                                            LPARAM lParam, LRESULT *plResult) {
  return This->lpVtbl->OnWindowMessage(This, msg, wParam, lParam, plResult);
}
static inline HRESULT
IOleInPlaceObjectWindowless_GetDropTarget(IOleInPlaceObjectWindowless *This,
                                          IDropTarget **ppDropTarget) {
...
typedef enum tagACTIVATEFLAGS { ACTIVATE_WINDOWLESS = 1 } ACTIVATEFLAGS;
DEFINE_GUID(IID_IOleInPlaceSiteEx, 0x9c2cad80, 0x3424, 0x11cf, 0xb6, 0x70, 0x00,
            0xaa, 0x00, 0x4c, 0xd6, 0xd8);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("9c2cad80-3424-11cf-b670-00aa004cd6d8")
IOleInPlaceSiteEx : public IOleInPlaceSite {
  virtual HRESULT STDMETHODCALLTYPE OnInPlaceActivateEx(WINBOOL * pfNoRedraw,
                                                        DWORD dwFlags) = 0;
  virtual HRESULT STDMETHODCALLTYPE OnInPlaceDeactivateEx(
      WINBOOL fNoRedraw) = 0;
  virtual HRESULT STDMETHODCALLTYPE RequestUIActivate() = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IOleInPlaceSiteEx, 0x9c2cad80, 0x3424, 0x11cf, 0xb6, 0x70, 0x00,
                0xaa, 0x00, 0x4c, 0xd6, 0xd8)
#endif
#else
typedef struct IOleInPlaceSiteExVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IOleInPlaceSiteEx *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *ContextSensitiveHelp)(IOleInPlaceSiteEx *This,
                                                   WINBOOL fEnterMode);
  ...
  HRESULT(STDMETHODCALLTYPE *GetWindowContext)(
      IOleInPlaceSiteEx *This, IOleInPlaceFrame **ppFrame,
      IOleInPlaceUIWindow **ppDoc, LPRECT lprcPosRect, LPRECT lprcClipRect,
      LPOLEINPLACEFRAMEINFO lpFrameInfo);
  HRESULT(STDMETHODCALLTYPE *Scroll)(IOleInPlaceSiteEx *This,
                                     SIZE scrollExtant);
  HRESULT(STDMETHODCALLTYPE *OnUIDeactivate)(IOleInPlaceSiteEx *This,
                                             WINBOOL fUndoable);
  ...
  HRESULT(STDMETHODCALLTYPE *OnPosRectChange)(IOleInPlaceSiteEx *This,
                                              LPCRECT lprcPosRect);
  /*** IOleInPlaceSiteEx methods ***/
  HRESULT(STDMETHODCALLTYPE *OnInPlaceActivateEx)(IOleInPlaceSiteEx *This,
                                                  WINBOOL *pfNoRedraw,
                                                  DWORD dwFlags);
  HRESULT(STDMETHODCALLTYPE *OnInPlaceDeactivateEx)(IOleInPlaceSiteEx *This,
                                                    WINBOOL fNoRedraw);
  HRESULT(STDMETHODCALLTYPE *RequestUIActivate)(IOleInPlaceSiteEx *This);
  END_INTERFACE
} IOleInPlaceSiteExVtbl;
interface IOleInPlaceSiteEx { CONST_VTBL IOleInPlaceSiteExVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define IOleInPlaceSiteEx_GetWindowContext(This, ppFrame, ppDoc, lprcPosRect,  \
                                           lprcClipRect, lpFrameInfo)          \
  (This)->lpVtbl->GetWindowContext(This, ppFrame, ppDoc, lprcPosRect,          \
                                   lprcClipRect, lpFrameInfo)
...
#else
/*** IUnknown methods ***/
static inline HRESULT IOleInPlaceSiteEx_QueryInterface(IOleInPlaceSiteEx *This,
                                                       REFIID riid,
                                                       void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IOleWindow methods ***/
static inline HRESULT IOleInPlaceSiteEx_GetWindow(IOleInPlaceSiteEx *This,
                                                  HWND *phwnd) {
  return This->lpVtbl->GetWindow(This, phwnd);
}
static inline HRESULT
IOleInPlaceSiteEx_ContextSensitiveHelp(IOleInPlaceSiteEx *This,
                                       WINBOOL fEnterMode) {
  return This->lpVtbl->ContextSensitiveHelp(This, fEnterMode);
}
/*** IOleInPlaceSite methods ***/
static inline HRESULT
IOleInPlaceSiteEx_CanInPlaceActivate(IOleInPlaceSiteEx *This) {
  return This->lpVtbl->CanInPlaceActivate(This);
}
static inline HRESULT
IOleInPlaceSiteEx_OnInPlaceActivate(IOleInPlaceSiteEx *This) {
...
static inline HRESULT IOleInPlaceSiteEx_GetWindowContext(
    IOleInPlaceSiteEx *This, IOleInPlaceFrame **ppFrame,
    IOleInPlaceUIWindow **ppDoc, LPRECT lprcPosRect, LPRECT lprcClipRect,
    LPOLEINPLACEFRAMEINFO lpFrameInfo) {
  return This->lpVtbl->GetWindowContext(This, ppFrame, ppDoc, lprcPosRect,
                                        lprcClipRect, lpFrameInfo);
}
static inline HRESULT IOleInPlaceSiteEx_Scroll(IOleInPlaceSiteEx *This,
                                               SIZE scrollExtant) {
  return This->lpVtbl->Scroll(This, scrollExtant);
}
static inline HRESULT IOleInPlaceSiteEx_OnUIDeactivate(IOleInPlaceSiteEx *This,
                                                       WINBOOL fUndoable) {
  return This->lpVtbl->OnUIDeactivate(This, fUndoable);
}
static inline HRESULT
IOleInPlaceSiteEx_OnInPlaceDeactivate(IOleInPlaceSiteEx *This) {
  return This->lpVtbl->OnInPlaceDeactivate(This);
}
static inline HRESULT
IOleInPlaceSiteEx_DiscardUndoState(IOleInPlaceSiteEx *This) {
  return This->lpVtbl->DiscardUndoState(This);
}
static inline HRESULT
IOleInPlaceSiteEx_DeactivateAndUndo(IOleInPlaceSiteEx *This) {
  return This->lpVtbl->DeactivateAndUndo(This);
}
static inline HRESULT IOleInPlaceSiteEx_OnPosRectChange(IOleInPlaceSiteEx *This,
                                                        LPCRECT lprcPosRect) {
  return This->lpVtbl->OnPosRectChange(This, lprcPosRect);
}
/*** IOleInPlaceSiteEx methods ***/
static inline HRESULT
IOleInPlaceSiteEx_OnInPlaceActivateEx(IOleInPlaceSiteEx *This,
                                      WINBOOL *pfNoRedraw, DWORD dwFlags) {
  return This->lpVtbl->OnInPlaceActivateEx(This, pfNoRedraw, dwFlags);
}
static inline HRESULT
IOleInPlaceSiteEx_OnInPlaceDeactivateEx(IOleInPlaceSiteEx *This,
                                        WINBOOL fNoRedraw) {
  return This->lpVtbl->OnInPlaceDeactivateEx(This, fNoRedraw);
}
static inline HRESULT
IOleInPlaceSiteEx_RequestUIActivate(IOleInPlaceSiteEx *This) {
...
DEFINE_GUID(IID_IOleInPlaceSiteWindowless, 0x922eada0, 0x3424, 0x11cf, 0xb6,
            0x70, 0x00, 0xaa, 0x00, 0x4c, 0xd6, 0xd8);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("922eada0-3424-11cf-b670-00aa004cd6d8")
IOleInPlaceSiteWindowless : public IOleInPlaceSiteEx {
  virtual HRESULT STDMETHODCALLTYPE CanWindowlessActivate() = 0;
  virtual HRESULT STDMETHODCALLTYPE GetCapture() = 0;
  virtual HRESULT STDMETHODCALLTYPE SetCapture(WINBOOL fCapture) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetFocus() = 0;
  virtual HRESULT STDMETHODCALLTYPE SetFocus(WINBOOL fFocus) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetDC(LPCRECT pRect, DWORD grfFlags,
                                          HDC * phDC) = 0;
  virtual HRESULT STDMETHODCALLTYPE ReleaseDC(HDC hDC) = 0;
  virtual HRESULT STDMETHODCALLTYPE InvalidateRect(LPCRECT pRect,
                                                   WINBOOL fErase) = 0;
  virtual HRESULT STDMETHODCALLTYPE InvalidateRgn(HRGN hRGN,
                                                  WINBOOL fErase) = 0;
  virtual HRESULT STDMETHODCALLTYPE ScrollRect(
      INT dx, INT dy, LPCRECT pRectScroll, LPCRECT pRectClip) = 0;
  virtual HRESULT STDMETHODCALLTYPE AdjustRect(LPRECT prc) = 0;
  virtual HRESULT STDMETHODCALLTYPE OnDefWindowMessage(
      UINT msg, WPARAM wParam, LPARAM lParam, LRESULT * plResult) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IOleInPlaceSiteWindowless, 0x922eada0, 0x3424, 0x11cf, 0xb6,
                0x70, 0x00, 0xaa, 0x00, 0x4c, 0xd6, 0xd8)
#endif
#else
typedef struct IOleInPlaceSiteWindowlessVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IOleInPlaceSiteWindowless *This,
                                             REFIID riid, void **ppvObject);
  ...
  /*** IOleWindow methods ***/
  HRESULT(STDMETHODCALLTYPE *GetWindow)(IOleInPlaceSiteWindowless *This,
                                        HWND *phwnd);
  HRESULT(STDMETHODCALLTYPE *ContextSensitiveHelp)(
      IOleInPlaceSiteWindowless *This, WINBOOL fEnterMode);
  /*** IOleInPlaceSite methods ***/
  ...
  HRESULT(STDMETHODCALLTYPE *GetWindowContext)(
      IOleInPlaceSiteWindowless *This, IOleInPlaceFrame **ppFrame,
      IOleInPlaceUIWindow **ppDoc, LPRECT lprcPosRect, LPRECT lprcClipRect,
      LPOLEINPLACEFRAMEINFO lpFrameInfo);
  HRESULT(STDMETHODCALLTYPE *Scroll)(IOleInPlaceSiteWindowless *This,
                                     SIZE scrollExtant);
  HRESULT(STDMETHODCALLTYPE *OnUIDeactivate)(IOleInPlaceSiteWindowless *This,
                                             WINBOOL fUndoable);
  ...
  HRESULT(STDMETHODCALLTYPE *OnInPlaceActivateEx)(
      IOleInPlaceSiteWindowless *This, WINBOOL *pfNoRedraw, DWORD dwFlags);
  HRESULT(STDMETHODCALLTYPE *OnInPlaceDeactivateEx)(
      IOleInPlaceSiteWindowless *This, WINBOOL fNoRedraw);
  ...
  HRESULT(STDMETHODCALLTYPE *SetFocus)(IOleInPlaceSiteWindowless *This,
                                       WINBOOL fFocus);
  HRESULT(STDMETHODCALLTYPE *GetDC)(IOleInPlaceSiteWindowless *This,
                                    LPCRECT pRect, DWORD grfFlags, HDC *phDC);
  HRESULT(STDMETHODCALLTYPE *ReleaseDC)(IOleInPlaceSiteWindowless *This,
                                        HDC hDC);
  HRESULT(STDMETHODCALLTYPE *InvalidateRect)(IOleInPlaceSiteWindowless *This,
                                             LPCRECT pRect, WINBOOL fErase);
  HRESULT(STDMETHODCALLTYPE *InvalidateRgn)(IOleInPlaceSiteWindowless *This,
                                            HRGN hRGN, WINBOOL fErase);
  HRESULT(STDMETHODCALLTYPE *ScrollRect)(IOleInPlaceSiteWindowless *This,
                                         INT dx, INT dy, LPCRECT pRectScroll,
                                         LPCRECT pRectClip);
  HRESULT(STDMETHODCALLTYPE *AdjustRect)(IOleInPlaceSiteWindowless *This,
                                         LPRECT prc);
  HRESULT(STDMETHODCALLTYPE *OnDefWindowMessage)(
      IOleInPlaceSiteWindowless *This, UINT msg, WPARAM wParam, LPARAM lParam,
      LRESULT *plResult);
  END_INTERFACE
...
#define IOleInPlaceSiteWindowless_GetWindowContext(                            \
...
#define IOleInPlaceSiteWindowless_OnPosRectChange(This, lprcPosRect)           \
  (This)->lpVtbl->OnPosRectChange(This, lprcPosRect)
/*** IOleInPlaceSiteEx methods ***/
#define IOleInPlaceSiteWindowless_OnInPlaceActivateEx(This, pfNoRedraw,        \
                                                      dwFlags)                 \
  (This)->lpVtbl->OnInPlaceActivateEx(This, pfNoRedraw, dwFlags)
...
#define IOleInPlaceSiteWindowless_ScrollRect(This, dx, dy, pRectScroll,        \
                                             pRectClip)                        \
...
#define IOleInPlaceSiteWindowless_OnDefWindowMessage(This, msg, wParam,        \
                                                     lParam, plResult)         \
  (This)->lpVtbl->OnDefWindowMessage(This, msg, wParam, lParam, plResult)
#else
/*** IUnknown methods ***/
static inline HRESULT
IOleInPlaceSiteWindowless_QueryInterface(IOleInPlaceSiteWindowless *This,
                                         REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IOleInPlaceSiteWindowless_AddRef(IOleInPlaceSiteWindowless *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IOleInPlaceSiteWindowless_Release(IOleInPlaceSiteWindowless *This) {
  return This->lpVtbl->Release(This);
}
/*** IOleWindow methods ***/
static inline HRESULT
IOleInPlaceSiteWindowless_GetWindow(IOleInPlaceSiteWindowless *This,
                                    HWND *phwnd) {
  return This->lpVtbl->GetWindow(This, phwnd);
}
static inline HRESULT
IOleInPlaceSiteWindowless_ContextSensitiveHelp(IOleInPlaceSiteWindowless *This,
                                               WINBOOL fEnterMode) {
  return This->lpVtbl->ContextSensitiveHelp(This, fEnterMode);
}
/*** IOleInPlaceSite methods ***/
static inline HRESULT
IOleInPlaceSiteWindowless_CanInPlaceActivate(IOleInPlaceSiteWindowless *This) {
  return This->lpVtbl->CanInPlaceActivate(This);
}
static inline HRESULT
IOleInPlaceSiteWindowless_OnInPlaceActivate(IOleInPlaceSiteWindowless *This) {
  return This->lpVtbl->OnInPlaceActivate(This);
}
static inline HRESULT
IOleInPlaceSiteWindowless_OnUIActivate(IOleInPlaceSiteWindowless *This) {
  return This->lpVtbl->OnUIActivate(This);
}
static inline HRESULT IOleInPlaceSiteWindowless_GetWindowContext(
    IOleInPlaceSiteWindowless *This, IOleInPlaceFrame **ppFrame,
    IOleInPlaceUIWindow **ppDoc, LPRECT lprcPosRect, LPRECT lprcClipRect,
    LPOLEINPLACEFRAMEINFO lpFrameInfo) {
  return This->lpVtbl->GetWindowContext(This, ppFrame, ppDoc, lprcPosRect,
...
static inline HRESULT
IOleInPlaceSiteWindowless_Scroll(IOleInPlaceSiteWindowless *This,
                                 SIZE scrollExtant) {
  return This->lpVtbl->Scroll(This, scrollExtant);
}
static inline HRESULT
IOleInPlaceSiteWindowless_OnUIDeactivate(IOleInPlaceSiteWindowless *This,
                                         WINBOOL fUndoable) {
  return This->lpVtbl->OnUIDeactivate(This, fUndoable);
}
static inline HRESULT
IOleInPlaceSiteWindowless_OnInPlaceDeactivate(IOleInPlaceSiteWindowless *This) {
  return This->lpVtbl->OnInPlaceDeactivate(This);
}
static inline HRESULT
IOleInPlaceSiteWindowless_DiscardUndoState(IOleInPlaceSiteWindowless *This) {
  return This->lpVtbl->DiscardUndoState(This);
}
static inline HRESULT
IOleInPlaceSiteWindowless_DeactivateAndUndo(IOleInPlaceSiteWindowless *This) {
  return This->lpVtbl->DeactivateAndUndo(This);
}
static inline HRESULT
IOleInPlaceSiteWindowless_OnPosRectChange(IOleInPlaceSiteWindowless *This,
                                          LPCRECT lprcPosRect) {
  return This->lpVtbl->OnPosRectChange(This, lprcPosRect);
}
/*** IOleInPlaceSiteEx methods ***/
static inline HRESULT IOleInPlaceSiteWindowless_OnInPlaceActivateEx(
    IOleInPlaceSiteWindowless *This, WINBOOL *pfNoRedraw, DWORD dwFlags) {
  return This->lpVtbl->OnInPlaceActivateEx(This, pfNoRedraw, dwFlags);
}
static inline HRESULT
IOleInPlaceSiteWindowless_OnInPlaceDeactivateEx(IOleInPlaceSiteWindowless *This,
                                                WINBOOL fNoRedraw) {
  return This->lpVtbl->OnInPlaceDeactivateEx(This, fNoRedraw);
}
static inline HRESULT
IOleInPlaceSiteWindowless_RequestUIActivate(IOleInPlaceSiteWindowless *This) {
  return This->lpVtbl->RequestUIActivate(This);
}
/*** IOleInPlaceSiteWindowless methods ***/
...
static inline HRESULT
IOleInPlaceSiteWindowless_GetCapture(IOleInPlaceSiteWindowless *This) {
  return This->lpVtbl->GetCapture(This);
}
static inline HRESULT
IOleInPlaceSiteWindowless_SetCapture(IOleInPlaceSiteWindowless *This,
                                     WINBOOL fCapture) {
  return This->lpVtbl->SetCapture(This, fCapture);
}
static inline HRESULT
IOleInPlaceSiteWindowless_GetFocus(IOleInPlaceSiteWindowless *This) {
  return This->lpVtbl->GetFocus(This);
}
static inline HRESULT
IOleInPlaceSiteWindowless_SetFocus(IOleInPlaceSiteWindowless *This,
                                   WINBOOL fFocus) {
  return This->lpVtbl->SetFocus(This, fFocus);
}
static inline HRESULT
IOleInPlaceSiteWindowless_GetDC(IOleInPlaceSiteWindowless *This, LPCRECT pRect,
                                DWORD grfFlags, HDC *phDC) {
  return This->lpVtbl->GetDC(This, pRect, grfFlags, phDC);
}
static inline HRESULT
IOleInPlaceSiteWindowless_ReleaseDC(IOleInPlaceSiteWindowless *This, HDC hDC) {
  return This->lpVtbl->ReleaseDC(This, hDC);
}
static inline HRESULT
IOleInPlaceSiteWindowless_InvalidateRect(IOleInPlaceSiteWindowless *This,
                                         LPCRECT pRect, WINBOOL fErase) {
  return This->lpVtbl->InvalidateRect(This, pRect, fErase);
}
static inline HRESULT
IOleInPlaceSiteWindowless_InvalidateRgn(IOleInPlaceSiteWindowless *This,
                                        HRGN hRGN, WINBOOL fErase) {
  return This->lpVtbl->InvalidateRgn(This, hRGN, fErase);
}
static inline HRESULT
IOleInPlaceSiteWindowless_ScrollRect(IOleInPlaceSiteWindowless *This, INT dx,
                                     INT dy, LPCRECT pRectScroll,
                                     LPCRECT pRectClip) {
  return This->lpVtbl->ScrollRect(This, dx, dy, pRectScroll, pRectClip);
}
static inline HRESULT
IOleInPlaceSiteWindowless_AdjustRect(IOleInPlaceSiteWindowless *This,
                                     LPRECT prc) {
  return This->lpVtbl->AdjustRect(This, prc);
}
static inline HRESULT
IOleInPlaceSiteWindowless_OnDefWindowMessage(IOleInPlaceSiteWindowless *This,
                                             UINT msg, WPARAM wParam,
                                             LPARAM lParam, LRESULT *plResult) {
...
IViewObjectEx : public IViewObject2 {
  ...
  virtual HRESULT STDMETHODCALLTYPE QueryHitPoint(
      DWORD dwAspect, LPCRECT pRectBounds, POINT ptlLoc, LONG lCloseHint,
      DWORD * pHitResult) = 0;
  virtual HRESULT STDMETHODCALLTYPE QueryHitRect(
      DWORD dwAspect, LPCRECT pRectBounds, LPCRECT pRectLoc, LONG lCloseHint,
      DWORD * pHitResult) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetNaturalExtent(
      DWORD dwAspect, LONG lindex, DVTARGETDEVICE * ptd, HDC hicTargetDev,
      DVEXTENTINFO * pExtentInfo, LPSIZEL pSizel) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IViewObjectEx, 0x3af24292, 0x0c96, 0x11ce, 0xa0, 0xcf, 0x00,
                0xaa, 0x00, 0x60, 0x0a, 0xb8)
#endif
#else
typedef struct IViewObjectExVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IViewObjectEx *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IViewObjectEx *This);
  ULONG(STDMETHODCALLTYPE *Release)(IViewObjectEx *This);
  /*** IViewObject methods ***/
  HRESULT(STDMETHODCALLTYPE *Draw)(
      IViewObjectEx *This, DWORD dwDrawAspect, LONG lindex, void *pvAspect,
  ...
  HRESULT(STDMETHODCALLTYPE *GetColorSet)(IViewObjectEx *This,
                                          DWORD dwDrawAspect, LONG lindex,
                                          void *pvAspect, DVTARGETDEVICE *ptd,
                                          HDC hicTargetDev,
                                          LOGPALETTE **ppColorSet);
  HRESULT(STDMETHODCALLTYPE *Freeze)(IViewObjectEx *This, DWORD dwDrawAspect,
                                     LONG lindex, void *pvAspect,
                                     DWORD *pdwFreeze);
  HRESULT(STDMETHODCALLTYPE *Unfreeze)(IViewObjectEx *This, DWORD dwFreeze);
  HRESULT(STDMETHODCALLTYPE *SetAdvise)(IViewObjectEx *This, DWORD aspects,
                                        DWORD advf, IAdviseSink *pAdvSink);
  HRESULT(STDMETHODCALLTYPE *GetAdvise)(IViewObjectEx *This, DWORD *pAspects,
                                        DWORD *pAdvf, IAdviseSink **ppAdvSink);
  /*** IViewObject2 methods ***/
  HRESULT(STDMETHODCALLTYPE *GetExtent)(IViewObjectEx *This, DWORD dwDrawAspect,
                                        LONG lindex, DVTARGETDEVICE *ptd,
                                        LPSIZEL lpsizel);
  /*** IViewObjectEx methods ***/
  HRESULT(STDMETHODCALLTYPE *GetRect)(IViewObjectEx *This, DWORD dwAspect,
                                      LPRECTL pRect);
  HRESULT(STDMETHODCALLTYPE *GetViewStatus)(IViewObjectEx *This,
                                            DWORD *pdwStatus);
  HRESULT(STDMETHODCALLTYPE *QueryHitPoint)(IViewObjectEx *This, DWORD dwAspect,
                                            LPCRECT pRectBounds, POINT ptlLoc,
                                            LONG lCloseHint, DWORD *pHitResult);
  HRESULT(STDMETHODCALLTYPE *QueryHitRect)(IViewObjectEx *This, DWORD dwAspect,
                                           LPCRECT pRectBounds,
                                           LPCRECT pRectLoc, LONG lCloseHint,
                                           DWORD *pHitResult);
  HRESULT(STDMETHODCALLTYPE *GetNaturalExtent)(
      IViewObjectEx *This, DWORD dwAspect, LONG lindex, DVTARGETDEVICE *ptd,
      HDC hicTargetDev, DVEXTENTINFO *pExtentInfo, LPSIZEL pSizel);
  END_INTERFACE
} IViewObjectExVtbl;
interface IViewObjectEx { CONST_VTBL IViewObjectExVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IViewObject methods ***/
#define IViewObjectEx_Draw(This, dwDrawAspect, lindex, pvAspect, ptd,          \
                           hdcTargetDev, hdcDraw, lprcBounds, lprcWBounds,     \
                           pfnContinue, dwContinue)                            \
  (This)->lpVtbl->Draw(This, dwDrawAspect, lindex, pvAspect, ptd,              \
                       hdcTargetDev, hdcDraw, lprcBounds, lprcWBounds,         \
                       pfnContinue, dwContinue)
#define IViewObjectEx_GetColorSet(This, dwDrawAspect, lindex, pvAspect, ptd,   \
                                  hicTargetDev, ppColorSet)                    \
  (This)->lpVtbl->GetColorSet(This, dwDrawAspect, lindex, pvAspect, ptd,       \
                              hicTargetDev, ppColorSet)
...
#define IViewObjectEx_QueryHitPoint(This, dwAspect, pRectBounds, ptlLoc,       \
                                    lCloseHint, pHitResult)                    \
  (This)->lpVtbl->QueryHitPoint(This, dwAspect, pRectBounds, ptlLoc,           \
                                lCloseHint, pHitResult)
#define IViewObjectEx_QueryHitRect(This, dwAspect, pRectBounds, pRectLoc,      \
                                   lCloseHint, pHitResult)                     \
  (This)->lpVtbl->QueryHitRect(This, dwAspect, pRectBounds, pRectLoc,          \
                               lCloseHint, pHitResult)
#define IViewObjectEx_GetNaturalExtent(This, dwAspect, lindex, ptd,            \
                                       hicTargetDev, pExtentInfo, pSizel)      \
  (This)->lpVtbl->GetNaturalExtent(This, dwAspect, lindex, ptd, hicTargetDev,  \
                                   pExtentInfo, pSizel)
#else
/*** IUnknown methods ***/
static inline HRESULT IViewObjectEx_QueryInterface(IViewObjectEx *This,
                                                   REFIID riid,
                                                   void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IViewObject methods ***/
static inline HRESULT IViewObjectEx_Draw(
    IViewObjectEx *This, DWORD dwDrawAspect, LONG lindex, void *pvAspect,
    DVTARGETDEVICE *ptd, HDC hdcTargetDev, HDC hdcDraw, LPCRECTL lprcBounds,
    LPCRECTL lprcWBounds,
    WINBOOL(STDMETHODCALLTYPE *pfnContinue)(ULONG_PTR dwContinue),
    ULONG_PTR dwContinue) {
  return This->lpVtbl->Draw(This, dwDrawAspect, lindex, pvAspect, ptd,
                            hdcTargetDev, hdcDraw, lprcBounds, lprcWBounds,
                            pfnContinue, dwContinue);
}
static inline HRESULT
IViewObjectEx_GetColorSet(IViewObjectEx *This, DWORD dwDrawAspect, LONG lindex,
                          void *pvAspect, DVTARGETDEVICE *ptd, HDC hicTargetDev,
                          LOGPALETTE **ppColorSet) {
  return This->lpVtbl->GetColorSet(This, dwDrawAspect, lindex, pvAspect, ptd,
                                   hicTargetDev, ppColorSet);
}
...
static inline HRESULT IViewObjectEx_Unfreeze(IViewObjectEx *This,
                                             DWORD dwFreeze) {
  return This->lpVtbl->Unfreeze(This, dwFreeze);
}
static inline HRESULT IViewObjectEx_SetAdvise(IViewObjectEx *This,
                                              DWORD aspects, DWORD advf,
                                              IAdviseSink *pAdvSink) {
  return This->lpVtbl->SetAdvise(This, aspects, advf, pAdvSink);
}
static inline HRESULT IViewObjectEx_GetAdvise(IViewObjectEx *This,
                                              DWORD *pAspects, DWORD *pAdvf,
...
/*** IViewObjectEx methods ***/
static inline HRESULT IViewObjectEx_GetRect(IViewObjectEx *This, DWORD dwAspect,
                                            LPRECTL pRect) {
  return This->lpVtbl->GetRect(This, dwAspect, pRect);
}
static inline HRESULT IViewObjectEx_GetViewStatus(IViewObjectEx *This,
                                                  DWORD *pdwStatus) {
  return This->lpVtbl->GetViewStatus(This, pdwStatus);
}
static inline HRESULT IViewObjectEx_QueryHitPoint(IViewObjectEx *This,
                                                  DWORD dwAspect,
                                                  LPCRECT pRectBounds,
                                                  POINT ptlLoc, LONG lCloseHint,
                                                  DWORD *pHitResult) {
  return This->lpVtbl->QueryHitPoint(This, dwAspect, pRectBounds, ptlLoc,
                                     lCloseHint, pHitResult);
}
static inline HRESULT
IViewObjectEx_QueryHitRect(IViewObjectEx *This, DWORD dwAspect,
                           LPCRECT pRectBounds, LPCRECT pRectLoc,
                           LONG lCloseHint, DWORD *pHitResult) {
  return This->lpVtbl->QueryHitRect(This, dwAspect, pRectBounds, pRectLoc,
                                    lCloseHint, pHitResult);
}
static inline HRESULT
IViewObjectEx_GetNaturalExtent(IViewObjectEx *This, DWORD dwAspect, LONG lindex,
...
DEFINE_GUID(IID_IOleUndoUnit, 0x894ad3b0, 0xef97, 0x11ce, 0x9b, 0xc9, 0x00,
            0xaa, 0x00, 0x60, 0x8e, 0x01);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IOleUndoUnit : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE GetUnitType(CLSID * pClsid,
                                                LONG * plID) = 0;
  virtual HRESULT STDMETHODCALLTYPE OnNextAdd() = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IOleUndoUnit, 0x894ad3b0, 0xef97, 0x11ce, 0x9b, 0xc9, 0x00,
                0xaa, 0x00, 0x60, 0x8e, 0x01)
#endif
#else
...
/*** IUnknown methods ***/
static inline HRESULT
IOleUndoUnit_QueryInterface(IOleUndoUnit *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IOleUndoUnit methods ***/
static inline HRESULT IOleUndoUnit_Do(IOleUndoUnit *This,
                                      IOleUndoManager *pUndoManager) {
  return This->lpVtbl->Do(This, pUndoManager);
}
static inline HRESULT IOleUndoUnit_GetDescription(IOleUndoUnit *This,
                                                  BSTR *pBstr) {
  return This->lpVtbl->GetDescription(This, pBstr);
}
static inline HRESULT IOleUndoUnit_GetUnitType(IOleUndoUnit *This,
                                               CLSID *pClsid, LONG *plID) {
...
DEFINE_GUID(IID_IOleParentUndoUnit, 0xa1faf330, 0xef97, 0x11ce, 0x9b, 0xc9,
            0x00, 0xaa, 0x00, 0x60, 0x8e, 0x01);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IOleParentUndoUnit : public IOleUndoUnit {
  ...
  virtual HRESULT STDMETHODCALLTYPE Close(IOleParentUndoUnit * pPUU,
                                          WINBOOL fCommit) = 0;
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IOleParentUndoUnit, 0xa1faf330, 0xef97, 0x11ce, 0x9b, 0xc9,
                0x00, 0xaa, 0x00, 0x60, 0x8e, 0x01)
#endif
#else
typedef struct IOleParentUndoUnitVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IOleParentUndoUnit *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IOleParentUndoUnit *This);
  ULONG(STDMETHODCALLTYPE *Release)(IOleParentUndoUnit *This);
  /*** IOleUndoUnit methods ***/
  HRESULT(STDMETHODCALLTYPE *Do)(IOleParentUndoUnit *This,
                                 IOleUndoManager *pUndoManager);
  HRESULT(STDMETHODCALLTYPE *GetDescription)(IOleParentUndoUnit *This,
                                             BSTR *pBstr);
  HRESULT(STDMETHODCALLTYPE *GetUnitType)(IOleParentUndoUnit *This,
                                          CLSID *pClsid, LONG *plID);
  HRESULT(STDMETHODCALLTYPE *OnNextAdd)(IOleParentUndoUnit *This);
  /*** IOleParentUndoUnit methods ***/
  HRESULT(STDMETHODCALLTYPE *Open)(IOleParentUndoUnit *This,
                                   IOleParentUndoUnit *pPUU);
  HRESULT(STDMETHODCALLTYPE *Close)(IOleParentUndoUnit *This,
                                    IOleParentUndoUnit *pPUU, WINBOOL fCommit);
  HRESULT(STDMETHODCALLTYPE *Add)(IOleParentUndoUnit *This, IOleUndoUnit *pUU);
  HRESULT(STDMETHODCALLTYPE *FindUnit)(IOleParentUndoUnit *This,
                                       IOleUndoUnit *pUU);
  HRESULT(STDMETHODCALLTYPE *GetParentState)(IOleParentUndoUnit *This,
                                             DWORD *pdwState);
  END_INTERFACE
} IOleParentUndoUnitVtbl;
interface IOleParentUndoUnit { CONST_VTBL IOleParentUndoUnitVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
IOleParentUndoUnit_QueryInterface(IOleParentUndoUnit *This, REFIID riid,
                                  void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IOleUndoUnit methods ***/
static inline HRESULT IOleParentUndoUnit_Do(IOleParentUndoUnit *This,
                                            IOleUndoManager *pUndoManager) {
  return This->lpVtbl->Do(This, pUndoManager);
}
static inline HRESULT
IOleParentUndoUnit_GetDescription(IOleParentUndoUnit *This, BSTR *pBstr) {
  return This->lpVtbl->GetDescription(This, pBstr);
}
static inline HRESULT IOleParentUndoUnit_GetUnitType(IOleParentUndoUnit *This,
                                                     CLSID *pClsid,
                                                     LONG *plID) {
  return This->lpVtbl->GetUnitType(This, pClsid, plID);
}
...
/*** IOleParentUndoUnit methods ***/
static inline HRESULT IOleParentUndoUnit_Open(IOleParentUndoUnit *This,
                                              IOleParentUndoUnit *pPUU) {
  return This->lpVtbl->Open(This, pPUU);
}
static inline HRESULT IOleParentUndoUnit_Close(IOleParentUndoUnit *This,
                                               IOleParentUndoUnit *pPUU,
                                               WINBOOL fCommit) {
  return This->lpVtbl->Close(This, pPUU, fCommit);
}
static inline HRESULT IOleParentUndoUnit_Add(IOleParentUndoUnit *This,
                                             IOleUndoUnit *pUU) {
  return This->lpVtbl->Add(This, pUU);
}
static inline HRESULT IOleParentUndoUnit_FindUnit(IOleParentUndoUnit *This,
                                                  IOleUndoUnit *pUU) {
  return This->lpVtbl->FindUnit(This, pUU);
}
static inline HRESULT
IOleParentUndoUnit_GetParentState(IOleParentUndoUnit *This, DWORD *pdwState) {
...
DEFINE_GUID(IID_IEnumOleUndoUnits, 0xb3e7c340, 0xef97, 0x11ce, 0x9b, 0xc9, 0x00,
            0xaa, 0x00, 0x60, 0x8e, 0x01);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("b3e7c340-ef97-11ce-9bc9-00aa00608e01")
IEnumOleUndoUnits : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE Next(ULONG cElt, IOleUndoUnit * *rgElt,
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IEnumOleUndoUnits, 0xb3e7c340, 0xef97, 0x11ce, 0x9b, 0xc9, 0x00,
                0xaa, 0x00, 0x60, 0x8e, 0x01)
#endif
#else
typedef struct IEnumOleUndoUnitsVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IEnumOleUndoUnits *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *Next)(IEnumOleUndoUnits *This, ULONG cElt,
  ...
  HRESULT(STDMETHODCALLTYPE *Clone)(IEnumOleUndoUnits *This,
                                    IEnumOleUndoUnits **ppEnum);
  END_INTERFACE
} IEnumOleUndoUnitsVtbl;
interface IEnumOleUndoUnits { CONST_VTBL IEnumOleUndoUnitsVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IEnumOleUndoUnits_QueryInterface(IEnumOleUndoUnits *This,
                                                       REFIID riid,
                                                       void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IEnumOleUndoUnits methods ***/
static inline HRESULT IEnumOleUndoUnits_Next(IEnumOleUndoUnits *This,
                                             ULONG cElt, IOleUndoUnit **rgElt,
                                             ULONG *pcEltFetched) {
  return This->lpVtbl->Next(This, cElt, rgElt, pcEltFetched);
}
static inline HRESULT IEnumOleUndoUnits_Skip(IEnumOleUndoUnits *This,
                                             ULONG cElt) {
...
static inline HRESULT IEnumOleUndoUnits_Clone(IEnumOleUndoUnits *This,
                                              IEnumOleUndoUnits **ppEnum) {
  return This->lpVtbl->Clone(This, ppEnum);
}
#endif
...
#endif
HRESULT STDMETHODCALLTYPE
IEnumOleUndoUnits_RemoteNext_Proxy(IEnumOleUndoUnits *This, ULONG cElt,
                                   IOleUndoUnit **rgElt, ULONG *pcEltFetched);
...
DEFINE_GUID(IID_IOleUndoManager, 0xd001f200, 0xef97, 0x11ce, 0x9b, 0xc9, 0x00,
            0xaa, 0x00, 0x60, 0x8e, 0x01);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IOleUndoManager : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE EnumUndoable(IEnumOleUndoUnits *
                                                 *ppEnum) = 0;
  virtual HRESULT STDMETHODCALLTYPE EnumRedoable(IEnumOleUndoUnits *
                                                 *ppEnum) = 0;
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IOleUndoManager, 0xd001f200, 0xef97, 0x11ce, 0x9b, 0xc9, 0x00,
                0xaa, 0x00, 0x60, 0x8e, 0x01)
#endif
#else
typedef struct IOleUndoManagerVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IOleUndoManager *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *Open)(IOleUndoManager *This,
                                   IOleParentUndoUnit *pPUU);
  HRESULT(STDMETHODCALLTYPE *Close)(IOleUndoManager *This,
                                    IOleParentUndoUnit *pPUU, WINBOOL fCommit);
  HRESULT(STDMETHODCALLTYPE *Add)(IOleUndoManager *This, IOleUndoUnit *pUU);
  HRESULT(STDMETHODCALLTYPE *GetOpenParentState)(IOleUndoManager *This,
                                                 DWORD *pdwState);
  HRESULT(STDMETHODCALLTYPE *DiscardFrom)(IOleUndoManager *This,
                                          IOleUndoUnit *pUU);
  ...
  HRESULT(STDMETHODCALLTYPE *EnumUndoable)(IOleUndoManager *This,
                                           IEnumOleUndoUnits **ppEnum);
  HRESULT(STDMETHODCALLTYPE *EnumRedoable)(IOleUndoManager *This,
                                           IEnumOleUndoUnits **ppEnum);
  HRESULT(STDMETHODCALLTYPE *GetLastUndoDescription)(IOleUndoManager *This,
                                                     BSTR *pBstr);
  HRESULT(STDMETHODCALLTYPE *GetLastRedoDescription)(IOleUndoManager *This,
                                                     BSTR *pBstr);
  HRESULT(STDMETHODCALLTYPE *Enable)(IOleUndoManager *This, WINBOOL fEnable);
  END_INTERFACE
} IOleUndoManagerVtbl;
interface IOleUndoManager { CONST_VTBL IOleUndoManagerVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IOleUndoManager_QueryInterface(IOleUndoManager *This,
                                                     REFIID riid,
                                                     void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IOleUndoManager methods ***/
static inline HRESULT IOleUndoManager_Open(IOleUndoManager *This,
                                           IOleParentUndoUnit *pPUU) {
  return This->lpVtbl->Open(This, pPUU);
}
static inline HRESULT IOleUndoManager_Close(IOleUndoManager *This,
                                            IOleParentUndoUnit *pPUU,
                                            WINBOOL fCommit) {
  return This->lpVtbl->Close(This, pPUU, fCommit);
}
static inline HRESULT IOleUndoManager_Add(IOleUndoManager *This,
                                          IOleUndoUnit *pUU) {
  return This->lpVtbl->Add(This, pUU);
}
static inline HRESULT IOleUndoManager_GetOpenParentState(IOleUndoManager *This,
                                                         DWORD *pdwState) {
  return This->lpVtbl->GetOpenParentState(This, pdwState);
}
static inline HRESULT IOleUndoManager_DiscardFrom(IOleUndoManager *This,
                                                  IOleUndoUnit *pUU) {
  return This->lpVtbl->DiscardFrom(This, pUU);
}
static inline HRESULT IOleUndoManager_UndoTo(IOleUndoManager *This,
                                             IOleUndoUnit *pUU) {
  return This->lpVtbl->UndoTo(This, pUU);
}
static inline HRESULT IOleUndoManager_RedoTo(IOleUndoManager *This,
                                             IOleUndoUnit *pUU) {
  return This->lpVtbl->RedoTo(This, pUU);
}
static inline HRESULT IOleUndoManager_EnumUndoable(IOleUndoManager *This,
                                                   IEnumOleUndoUnits **ppEnum) {
  return This->lpVtbl->EnumUndoable(This, ppEnum);
}
static inline HRESULT IOleUndoManager_EnumRedoable(IOleUndoManager *This,
                                                   IEnumOleUndoUnits **ppEnum) {
  return This->lpVtbl->EnumRedoable(This, ppEnum);
}
static inline HRESULT
IOleUndoManager_GetLastUndoDescription(IOleUndoManager *This, BSTR *pBstr) {
  return This->lpVtbl->GetLastUndoDescription(This, pBstr);
}
static inline HRESULT
IOleUndoManager_GetLastRedoDescription(IOleUndoManager *This, BSTR *pBstr) {
  return This->lpVtbl->GetLastRedoDescription(This, pBstr);
}
static inline HRESULT IOleUndoManager_Enable(IOleUndoManager *This,
                                             WINBOOL fEnable) {
...
DEFINE_GUID(IID_IPointerInactive, 0x55980ba0, 0x35aa, 0x11cf, 0xb6, 0x71, 0x00,
            0xaa, 0x00, 0x4c, 0xd6, 0xd8);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IPointerInactive : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE OnInactiveMouseMove(
      LPCRECT pRectBounds, LONG x, LONG y, DWORD grfKeyState) = 0;
  virtual HRESULT STDMETHODCALLTYPE OnInactiveSetCursor(
      LPCRECT pRectBounds, LONG x, LONG y, DWORD dwMouseMsg,
      WINBOOL fSetAlways) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IPointerInactive, 0x55980ba0, 0x35aa, 0x11cf, 0xb6, 0x71, 0x00,
                0xaa, 0x00, 0x4c, 0xd6, 0xd8)
#endif
#else
typedef struct IPointerInactiveVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPointerInactive *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetActivationPolicy)(IPointerInactive *This,
                                                  DWORD *pdwPolicy);
  HRESULT(STDMETHODCALLTYPE *OnInactiveMouseMove)(IPointerInactive *This,
                                                  LPCRECT pRectBounds, LONG x,
                                                  LONG y, DWORD grfKeyState);
  HRESULT(STDMETHODCALLTYPE *OnInactiveSetCursor)(IPointerInactive *This,
                                                  LPCRECT pRectBounds, LONG x,
                                                  LONG y, DWORD dwMouseMsg,
                                                  WINBOOL fSetAlways);
  END_INTERFACE
} IPointerInactiveVtbl;
interface IPointerInactive { CONST_VTBL IPointerInactiveVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define IPointerInactive_OnInactiveMouseMove(This, pRectBounds, x, y,          \
                                             grfKeyState)                      \
  (This)->lpVtbl->OnInactiveMouseMove(This, pRectBounds, x, y, grfKeyState)
#define IPointerInactive_OnInactiveSetCursor(This, pRectBounds, x, y,          \
                                             dwMouseMsg, fSetAlways)           \
  (This)->lpVtbl->OnInactiveSetCursor(This, pRectBounds, x, y, dwMouseMsg,     \
                                      fSetAlways)
#else
/*** IUnknown methods ***/
static inline HRESULT IPointerInactive_QueryInterface(IPointerInactive *This,
                                                      REFIID riid,
                                                      void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IPointerInactive methods ***/
static inline HRESULT
IPointerInactive_GetActivationPolicy(IPointerInactive *This, DWORD *pdwPolicy) {
  return This->lpVtbl->GetActivationPolicy(This, pdwPolicy);
}
static inline HRESULT
IPointerInactive_OnInactiveMouseMove(IPointerInactive *This,
                                     LPCRECT pRectBounds, LONG x, LONG y,
                                     DWORD grfKeyState) {
  return This->lpVtbl->OnInactiveMouseMove(This, pRectBounds, x, y,
                                           grfKeyState);
}
static inline HRESULT
IPointerInactive_OnInactiveSetCursor(IPointerInactive *This,
                                     LPCRECT pRectBounds, LONG x, LONG y,
                                     DWORD dwMouseMsg, WINBOOL fSetAlways) {
  return This->lpVtbl->OnInactiveSetCursor(This, pRectBounds, x, y, dwMouseMsg,
                                           fSetAlways);
}
#endif
#endif
...
DEFINE_GUID(IID_IObjectWithSite, 0xfc4801a3, 0x2ba9, 0x11cf, 0xa2, 0x29, 0x00,
            0xaa, 0x00, 0x3d, 0x73, 0x52);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IObjectWithSite, 0xfc4801a3, 0x2ba9, 0x11cf, 0xa2, 0x29, 0x00,
                0xaa, 0x00, 0x3d, 0x73, 0x52)
#endif
#else
typedef struct IObjectWithSiteVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IObjectWithSite *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IObjectWithSite *This);
  ULONG(STDMETHODCALLTYPE *Release)(IObjectWithSite *This);
  /*** IObjectWithSite methods ***/
  HRESULT(STDMETHODCALLTYPE *SetSite)(IObjectWithSite *This,
                                      IUnknown *pUnkSite);
  HRESULT(STDMETHODCALLTYPE *GetSite)(IObjectWithSite *This, REFIID riid,
                                      void **ppvSite);
  END_INTERFACE
} IObjectWithSiteVtbl;
interface IObjectWithSite { CONST_VTBL IObjectWithSiteVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IObjectWithSite_QueryInterface(IObjectWithSite *This,
                                                     REFIID riid,
                                                     void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IObjectWithSite methods ***/
static inline HRESULT IObjectWithSite_SetSite(IObjectWithSite *This,
                                              IUnknown *pUnkSite) {
  return This->lpVtbl->SetSite(This, pUnkSite);
}
static inline HRESULT IObjectWithSite_GetSite(IObjectWithSite *This,
                                              REFIID riid, void **ppvSite) {
...
DEFINE_GUID(IID_IPerPropertyBrowsing, 0x376bd3aa, 0x3845, 0x101b, 0x84, 0xed,
            0x08, 0x00, 0x2b, 0x2e, 0xc7, 0x13);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("376bd3aa-3845-101b-84ed-08002b2ec713")
IPerPropertyBrowsing : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetDisplayString(DISPID dispID,
                                                     BSTR * pBstr) = 0;
  virtual HRESULT STDMETHODCALLTYPE MapPropertyToPage(DISPID dispID,
                                                      CLSID * pClsid) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetPredefinedStrings(
      DISPID dispID, CALPOLESTR * pCaStringsOut, CADWORD * pCaCookiesOut) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetPredefinedValue(
      DISPID dispID, DWORD dwCookie, VARIANT * pVarOut) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IPerPropertyBrowsing, 0x376bd3aa, 0x3845, 0x101b, 0x84, 0xed,
                0x08, 0x00, 0x2b, 0x2e, 0xc7, 0x13)
#endif
#else
typedef struct IPerPropertyBrowsingVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPerPropertyBrowsing *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetDisplayString)(IPerPropertyBrowsing *This,
                                               DISPID dispID, BSTR *pBstr);
  HRESULT(STDMETHODCALLTYPE *MapPropertyToPage)(IPerPropertyBrowsing *This,
                                                DISPID dispID, CLSID *pClsid);
  HRESULT(STDMETHODCALLTYPE *GetPredefinedStrings)(IPerPropertyBrowsing *This,
                                                   DISPID dispID,
                                                   CALPOLESTR *pCaStringsOut,
                                                   CADWORD *pCaCookiesOut);
  HRESULT(STDMETHODCALLTYPE *GetPredefinedValue)(IPerPropertyBrowsing *This,
                                                 DISPID dispID, DWORD dwCookie,
                                                 VARIANT *pVarOut);
  END_INTERFACE
} IPerPropertyBrowsingVtbl;
interface IPerPropertyBrowsing { CONST_VTBL IPerPropertyBrowsingVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define IPerPropertyBrowsing_GetPredefinedStrings(This, dispID, pCaStringsOut, \
                                                  pCaCookiesOut)               \
  (This)->lpVtbl->GetPredefinedStrings(This, dispID, pCaStringsOut,            \
                                       pCaCookiesOut)
...
/*** IUnknown methods ***/
static inline HRESULT
IPerPropertyBrowsing_QueryInterface(IPerPropertyBrowsing *This, REFIID riid,
                                    void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IPerPropertyBrowsing methods ***/
static inline HRESULT
IPerPropertyBrowsing_GetDisplayString(IPerPropertyBrowsing *This, DISPID dispID,
                                      BSTR *pBstr) {
  return This->lpVtbl->GetDisplayString(This, dispID, pBstr);
}
static inline HRESULT
IPerPropertyBrowsing_MapPropertyToPage(IPerPropertyBrowsing *This,
                                       DISPID dispID, CLSID *pClsid) {
  return This->lpVtbl->MapPropertyToPage(This, dispID, pClsid);
}
static inline HRESULT IPerPropertyBrowsing_GetPredefinedStrings(
    IPerPropertyBrowsing *This, DISPID dispID, CALPOLESTR *pCaStringsOut,
    CADWORD *pCaCookiesOut) {
  return This->lpVtbl->GetPredefinedStrings(This, dispID, pCaStringsOut,
                                            pCaCookiesOut);
}
static inline HRESULT
IPerPropertyBrowsing_GetPredefinedValue(IPerPropertyBrowsing *This,
                                        DISPID dispID, DWORD dwCookie,
                                        VARIANT *pVarOut) {
...
DEFINE_GUID(IID_IPropertyBag2, 0x22f55882, 0x280b, 0x11d0, 0xa8, 0xa9, 0x00,
            0xa0, 0xc9, 0x0c, 0x20, 0x04);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("22f55882-280b-11d0-a8a9-00a0c90c2004")
IPropertyBag2 : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE Read(
      ULONG cProperties, PROPBAG2 * pPropBag, IErrorLog * pErrLog,
      VARIANT * pvarValue, HRESULT * phrError) = 0;
  virtual HRESULT STDMETHODCALLTYPE Write(
      ULONG cProperties, PROPBAG2 * pPropBag, VARIANT * pvarValue) = 0;
  virtual HRESULT STDMETHODCALLTYPE CountProperties(ULONG * pcProperties) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetPropertyInfo(
      ULONG iProperty, ULONG cProperties, PROPBAG2 * pPropBag,
      ULONG * pcProperties) = 0;
  virtual HRESULT STDMETHODCALLTYPE LoadObject(LPCOLESTR pstrName, DWORD dwHint,
                                               IUnknown * pUnkObject,
                                               IErrorLog * pErrLog) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IPropertyBag2, 0x22f55882, 0x280b, 0x11d0, 0xa8, 0xa9, 0x00,
                0xa0, 0xc9, 0x0c, 0x20, 0x04)
#endif
#else
typedef struct IPropertyBag2Vtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPropertyBag2 *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IPropertyBag2 *This);
  ULONG(STDMETHODCALLTYPE *Release)(IPropertyBag2 *This);
  /*** IPropertyBag2 methods ***/
  HRESULT(STDMETHODCALLTYPE *Read)(IPropertyBag2 *This, ULONG cProperties,
                                   PROPBAG2 *pPropBag, IErrorLog *pErrLog,
                                   VARIANT *pvarValue, HRESULT *phrError);
  HRESULT(STDMETHODCALLTYPE *Write)(IPropertyBag2 *This, ULONG cProperties,
                                    PROPBAG2 *pPropBag, VARIANT *pvarValue);
  HRESULT(STDMETHODCALLTYPE *CountProperties)(IPropertyBag2 *This,
                                              ULONG *pcProperties);
  HRESULT(STDMETHODCALLTYPE *GetPropertyInfo)(IPropertyBag2 *This,
                                              ULONG iProperty,
                                              ULONG cProperties,
                                              PROPBAG2 *pPropBag,
                                              ULONG *pcProperties);
  HRESULT(STDMETHODCALLTYPE *LoadObject)(IPropertyBag2 *This,
                                         LPCOLESTR pstrName, DWORD dwHint,
                                         IUnknown *pUnkObject,
                                         IErrorLog *pErrLog);
  END_INTERFACE
} IPropertyBag2Vtbl;
interface IPropertyBag2 { CONST_VTBL IPropertyBag2Vtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IPropertyBag2 methods ***/
#define IPropertyBag2_Read(This, cProperties, pPropBag, pErrLog, pvarValue,    \
                           phrError)                                           \
...
#define IPropertyBag2_GetPropertyInfo(This, iProperty, cProperties, pPropBag,  \
                                      pcProperties)                            \
  (This)->lpVtbl->GetPropertyInfo(This, iProperty, cProperties, pPropBag,      \
                                  pcProperties)
...
#else
/*** IUnknown methods ***/
static inline HRESULT IPropertyBag2_QueryInterface(IPropertyBag2 *This,
                                                   REFIID riid,
                                                   void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IPropertyBag2 methods ***/
static inline HRESULT IPropertyBag2_Read(IPropertyBag2 *This, ULONG cProperties,
                                         PROPBAG2 *pPropBag, IErrorLog *pErrLog,
                                         VARIANT *pvarValue,
                                         HRESULT *phrError) {
  return This->lpVtbl->Read(This, cProperties, pPropBag, pErrLog, pvarValue,
                            phrError);
}
static inline HRESULT IPropertyBag2_Write(IPropertyBag2 *This,
                                          ULONG cProperties, PROPBAG2 *pPropBag,
                                          VARIANT *pvarValue) {
  return This->lpVtbl->Write(This, cProperties, pPropBag, pvarValue);
}
static inline HRESULT IPropertyBag2_CountProperties(IPropertyBag2 *This,
                                                    ULONG *pcProperties) {
  return This->lpVtbl->CountProperties(This, pcProperties);
}
static inline HRESULT IPropertyBag2_GetPropertyInfo(IPropertyBag2 *This,
                                                    ULONG iProperty,
                                                    ULONG cProperties,
                                                    PROPBAG2 *pPropBag,
                                                    ULONG *pcProperties) {
  return This->lpVtbl->GetPropertyInfo(This, iProperty, cProperties, pPropBag,
                                       pcProperties);
}
static inline HRESULT IPropertyBag2_LoadObject(IPropertyBag2 *This,
                                               LPCOLESTR pstrName, DWORD dwHint,
                                               IUnknown *pUnkObject,
                                               IErrorLog *pErrLog) {
...
DEFINE_GUID(IID_IPersistPropertyBag2, 0x22f55881, 0x280b, 0x11d0, 0xa8, 0xa9,
            0x00, 0xa0, 0xc9, 0x0c, 0x20, 0x04);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("22f55881-280b-11d0-a8a9-00a0c90c2004")
IPersistPropertyBag2 : public IPersist {
  virtual HRESULT STDMETHODCALLTYPE InitNew() = 0;
  virtual HRESULT STDMETHODCALLTYPE Load(IPropertyBag2 * pPropBag,
                                         IErrorLog * pErrLog) = 0;
  virtual HRESULT STDMETHODCALLTYPE Save(IPropertyBag2 * pPropBag,
                                         WINBOOL fClearDirty,
                                         WINBOOL fSaveAllProperties) = 0;
  virtual HRESULT STDMETHODCALLTYPE IsDirty() = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IPersistPropertyBag2, 0x22f55881, 0x280b, 0x11d0, 0xa8, 0xa9,
                0x00, 0xa0, 0xc9, 0x0c, 0x20, 0x04)
#endif
#else
typedef struct IPersistPropertyBag2Vtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPersistPropertyBag2 *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IPersistPropertyBag2 *This);
  ULONG(STDMETHODCALLTYPE *Release)(IPersistPropertyBag2 *This);
  /*** IPersist methods ***/
  HRESULT(STDMETHODCALLTYPE *GetClassID)(IPersistPropertyBag2 *This,
                                         CLSID *pClassID);
  /*** IPersistPropertyBag2 methods ***/
  HRESULT(STDMETHODCALLTYPE *InitNew)(IPersistPropertyBag2 *This);
  HRESULT(STDMETHODCALLTYPE *Load)(IPersistPropertyBag2 *This,
                                   IPropertyBag2 *pPropBag, IErrorLog *pErrLog);
  HRESULT(STDMETHODCALLTYPE *Save)(IPersistPropertyBag2 *This,
                                   IPropertyBag2 *pPropBag, WINBOOL fClearDirty,
                                   WINBOOL fSaveAllProperties);
  HRESULT(STDMETHODCALLTYPE *IsDirty)(IPersistPropertyBag2 *This);
  END_INTERFACE
} IPersistPropertyBag2Vtbl;
interface IPersistPropertyBag2 { CONST_VTBL IPersistPropertyBag2Vtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
IPersistPropertyBag2_QueryInterface(IPersistPropertyBag2 *This, REFIID riid,
                                    void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IPersist methods ***/
static inline HRESULT
IPersistPropertyBag2_GetClassID(IPersistPropertyBag2 *This, CLSID *pClassID) {
  return This->lpVtbl->GetClassID(This, pClassID);
}
/*** IPersistPropertyBag2 methods ***/
...
static inline HRESULT IPersistPropertyBag2_Load(IPersistPropertyBag2 *This,
                                                IPropertyBag2 *pPropBag,
                                                IErrorLog *pErrLog) {
  return This->lpVtbl->Load(This, pPropBag, pErrLog);
}
static inline HRESULT IPersistPropertyBag2_Save(IPersistPropertyBag2 *This,
                                                IPropertyBag2 *pPropBag,
                                                WINBOOL fClearDirty,
                                                WINBOOL fSaveAllProperties) {
  return This->lpVtbl->Save(This, pPropBag, fClearDirty, fSaveAllProperties);
...
DEFINE_GUID(IID_IAdviseSinkEx, 0x3af24290, 0x0c96, 0x11ce, 0xa0, 0xcf, 0x00,
            0xaa, 0x00, 0x60, 0x0a, 0xb8);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IAdviseSinkEx, 0x3af24290, 0x0c96, 0x11ce, 0xa0, 0xcf, 0x00,
                0xaa, 0x00, 0x60, 0x0a, 0xb8)
#endif
#else
typedef struct IAdviseSinkExVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAdviseSinkEx *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IAdviseSinkEx *This);
  ULONG(STDMETHODCALLTYPE *Release)(IAdviseSinkEx *This);
  /*** IAdviseSink methods ***/
  void(STDMETHODCALLTYPE *OnDataChange)(IAdviseSinkEx *This,
                                        FORMATETC *pFormatetc,
                                        STGMEDIUM *pStgmed);
  void(STDMETHODCALLTYPE *OnViewChange)(IAdviseSinkEx *This, DWORD dwAspect,
                                        LONG lindex);
  ...
  void(STDMETHODCALLTYPE *OnViewStatusChange)(IAdviseSinkEx *This,
                                              DWORD dwViewStatus);
  END_INTERFACE
} IAdviseSinkExVtbl;
interface IAdviseSinkEx { CONST_VTBL IAdviseSinkExVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IAdviseSinkEx_QueryInterface(IAdviseSinkEx *This,
                                                   REFIID riid,
                                                   void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IAdviseSink methods ***/
static inline void IAdviseSinkEx_OnDataChange(IAdviseSinkEx *This,
                                              FORMATETC *pFormatetc,
                                              STGMEDIUM *pStgmed) {
  This->lpVtbl->OnDataChange(This, pFormatetc, pStgmed);
}
static inline void IAdviseSinkEx_OnViewChange(IAdviseSinkEx *This,
...
/*** IAdviseSinkEx methods ***/
static inline void IAdviseSinkEx_OnViewStatusChange(IAdviseSinkEx *This,
                                                    DWORD dwViewStatus) {
  This->lpVtbl->OnViewStatusChange(This, dwViewStatus);
}
#endif
...
DEFINE_GUID(IID_IQuickActivate, 0xcf51ed10, 0x62fe, 0x11cf, 0xbf, 0x86, 0x00,
            0xa0, 0xc9, 0x03, 0x48, 0x36);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("cf51ed10-62fe-11cf-bf86-00a0c9034836")
IQuickActivate : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE QuickActivate(QACONTAINER * pQaContainer,
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IQuickActivate, 0xcf51ed10, 0x62fe, 0x11cf, 0xbf, 0x86, 0x00,
                0xa0, 0xc9, 0x03, 0x48, 0x36)
#endif
#else
typedef struct IQuickActivateVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IQuickActivate *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *QuickActivate)(IQuickActivate *This,
                                            QACONTAINER *pQaContainer,
                                            QACONTROL *pQaControl);
  HRESULT(STDMETHODCALLTYPE *SetContentExtent)(IQuickActivate *This,
                                               LPSIZEL pSizel);
  HRESULT(STDMETHODCALLTYPE *GetContentExtent)(IQuickActivate *This,
                                               LPSIZEL pSizel);
  END_INTERFACE
} IQuickActivateVtbl;
interface IQuickActivate { CONST_VTBL IQuickActivateVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IQuickActivate_QueryInterface(IQuickActivate *This,
                                                    REFIID riid,
                                                    void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IQuickActivate methods ***/
static inline HRESULT IQuickActivate_QuickActivate(IQuickActivate *This,
                                                   QACONTAINER *pQaContainer,
                                                   QACONTROL *pQaControl) {
  return This->lpVtbl->QuickActivate(This, pQaContainer, pQaControl);
}
static inline HRESULT IQuickActivate_SetContentExtent(IQuickActivate *This,
                                                      LPSIZEL pSizel) {
  return This->lpVtbl->SetContentExtent(This, pSizel);
}
static inline HRESULT IQuickActivate_GetContentExtent(IQuickActivate *This,
                                                      LPSIZEL pSizel) {
...
HRESULT STDMETHODCALLTYPE IQuickActivate_RemoteQuickActivate_Proxy(
    IQuickActivate *This, QACONTAINER *pQaContainer, QACONTROL *pQaControl);
...
unsigned char *__RPC_USER HACCEL_UserMarshal(ULONG *, unsigned char *,
                                             HACCEL *);
unsigned char *__RPC_USER HACCEL_UserUnmarshal(ULONG *, unsigned char *,
                                               HACCEL *);
...
unsigned char *__RPC_USER HFONT_UserUnmarshal(ULONG *, unsigned char *,
                                              HFONT *);
