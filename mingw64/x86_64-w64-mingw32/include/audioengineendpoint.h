...
typedef struct _AUDIO_ENDPOINT_EXCLUSIVE_CREATE_PARAMS {
  ...
  WAVEFORMATEX wfxDeviceFormat;
    ...
    *PAUDIO_ENDPOINT_EXCLUSIVE_CREATE_PARAMS;
...
DECLARE_INTERFACE_(IAudioDeviceEndpoint, IUnknown) {
  ...
  STDMETHOD_(HRESULT, GetEventDrivenCapable)(THIS_ WINBOOL * pbIsEventCapable)
      PURE;
  STDMETHOD_(HRESULT, GetRTCaps)(THIS_ WINBOOL * pbIsRTCapable) PURE;
  STDMETHOD_(HRESULT, SetBuffer)(THIS_ HNSTIME MaxPeriod,
                                 UINT32 u32LatencyCoefficient) PURE;
  STDMETHOD_(HRESULT, WriteExclusiveModeParametersToSharedMemory)(
      THIS_ UINT_PTR hTargetProcess, HNSTIME hnsPeriod,
      HNSTIME hnsBufferDuration, UINT32 u32LatencyCoefficient,
      UINT32 * pu32SharedMemorySize, UINT_PTR * phSharedMemory) PURE;
  END_INTERFACE
};
#ifdef COBJMACROS
...
#define IAudioDeviceEndpoint_WriteExclusiveModeParametersToSharedMemory(       \
    This, hTargetProcess, hnsPeriod, hnsBufferDuration, u32LatencyCoefficient, \
    pu32SharedMemorySize, phSharedMemory)                                      \
  (This)->lpVtbl->WriteExclusiveModeParametersToSharedMemory(                  \
      This, hTargetProcess, hnsPeriod, hnsBufferDuration,                      \
      u32LatencyCoefficient, pu32SharedMemorySize, phSharedMemory)
#endif /*COBJMACROS*/
#undef INTERFACE
...
DECLARE_INTERFACE_(IAudioEndpointRT, IUnknown) {
  ...
  STDMETHOD(GetCurrentPadding)(THIS_ HNSTIME * pPadding,
                               AE_CURRENT_POSITION * pAeCurrentPosition) PURE;
...
#define IAudioEndpointRT_ProcessingComplete()                                  \
...
DECLARE_INTERFACE_(IAudioEndpointVolumeEx, IAudioEndpointVolume) {
  ...
  STDMETHOD_(HRESULT, GetChannelVolumeLevel)(THIS_ UINT nChannel,
                                             float *pfLevelDB) PURE;
  STDMETHOD_(HRESULT, GetChannelVolumeLevelScalar)(THIS_ UINT nChannel,
                                                   float *pfLevel) PURE;
  ...
  STDMETHOD_(HRESULT, GetVolumeRange)(THIS_ float *pfLevelMinDB,
                                      float *pfLevelMaxDB,
                                      float *pfVolumeIncrementDB) PURE;
  STDMETHOD_(HRESULT, GetVolumeStepInfo)(THIS_ UINT * pnStep,
                                         UINT * pnStepCount) PURE;
  STDMETHOD_(HRESULT,
             QueryHardwareSupport)(THIS_ DWORD * pdwHardwareSupportMask) PURE;
  STDMETHOD_(HRESULT, RegisterControlChangeNotify)(
      THIS_ IAudioEndpointVolumeCallback * pNotify) PURE;
  STDMETHOD_(HRESULT, SetChannelVolumeLevel)(
      THIS_ UINT nChannel, float fLevelDB, LPCGUID pguidEventContext) PURE;
  STDMETHOD_(HRESULT, SetChannelVolumeLevelScalar)(
      THIS_ UINT nChannel, float fLevel, LPCGUID pguidEventContext) PURE;
  STDMETHOD_(HRESULT, SetMasterVolumeLevel)(THIS_ float fLevelDB,
                                            LPCGUID pguidEventContext) PURE;
  STDMETHOD_(HRESULT, SetMasterVolumeLevelScalar)(
      THIS_ float fLevel, LPCGUID pguidEventContext) PURE;
  STDMETHOD_(HRESULT, SetMute)(THIS_ WINBOOL bMute, LPCGUID pguidEventContext)
      PURE;
  STDMETHOD_(HRESULT, UnregisterControlChangeNotify)(
      THIS_ IAudioEndpointVolumeCallback * pNotify) PURE;
  ...
  STDMETHOD_(HRESULT, GetVolumeRangeChannel)(
      THIS_ UINT iChannel, float *pflVolumeMinDB, float *pflVolumeMaxDB,
      float *pflVolumeIncrementDB) PURE;
  END_INTERFACE
};
#ifdef COBJMACROS
...
#define IAudioEndpointVolumeEx_GetChannelVolumeLevel(This, nChannel,           \
                                                     pfLevelDB)                \
  (This)->lpVtbl->GetChannelVolumeLevel(This, nChannel, pfLevelDB)
#define IAudioEndpointVolumeEx_GetChannelVolumeLevelScalar(This, nChannel,     \
                                                           pfLevel)            \
...
#define IAudioEndpointVolumeEx_GetVolumeRange(                                 \
    This, pfLevelMinDB, pfLevelMaxDB, pfVolumeIncrementDB)                     \
  (This)->lpVtbl->GetVolumeRange(This, pfLevelMinDB, pfLevelMaxDB,             \
                                 pfVolumeIncrementDB)
...
#define IAudioEndpointVolumeEx_QueryHardwareSupport(This,                      \
...
#define IAudioEndpointVolumeEx_SetChannelVolumeLevel(This, nChannel, fLevelDB, \
                                                     pguidEventContext)        \
  (This)->lpVtbl->SetChannelVolumeLevel(This, nChannel, fLevelDB,              \
                                        pguidEventContext)
#define IAudioEndpointVolumeEx_SetChannelVolumeLevelScalar(                    \
    This, nChannel, fLevel, pguidEventContext)                                 \
  (This)->lpVtbl->SetChannelVolumeLevelScalar(This, nChannel, fLevel,          \
                                              pguidEventContext)
#define IAudioEndpointVolumeEx_SetMasterVolumeLevel(This, fLevelDB,            \
                                                    pguidEventContext)         \
  (This)->lpVtbl->SetMasterVolumeLevel(This, fLevelDB, pguidEventContext)
#define IAudioEndpointVolumeEx_SetMasterVolumeLevelScalar(This, fLevel,        \
                                                          pguidEventContext)   \
...
#define IAudioEndpointVolumeEx_GetVolumeRangeChannel(                          \
    This, iChannel, pflVolumeMinDB, pflVolumeMaxDB, pflVolumeIncrementDB)      \
  (This)->lpVtbl->GetVolumeRangeChannel(This, iChannel, pflVolumeMinDB,        \
...
DECLARE_INTERFACE_(IAudioInputEndpointRT, IUnknown) {
  ...
  STDMETHOD(ReleaseInputDataPointer)(THIS_ UINT32 u32FrameCount,
                                     UINT_PTR pDataPointer) PURE;
  END_INTERFACE
};
#ifdef COBJMACROS
...
#define IAudioInputEndpointRT_GetInputDataPointer(This, pAeTimeStamp)          \
  (This)->lpVtbl->GetInputDataPointer(This, pAeTimeStamp)
#define IAudioInputEndpointRT_PulseEndpoint()                                  \
  (This)->lpVtbl->PulseEndpoint(This)
#define IAudioInputEndpointRT_ReleaseInputDataPointer(This, u32FrameCount,     \
                                                      pDataPointer)            \
...
DECLARE_INTERFACE_(IAudioOutputEndpointRT, IUnknown) {
  ...
  STDMETHOD_(UINT_PTR, GetOutputDataPointer)(
      THIS_ UINT32 u32FrameCount, AE_CURRENT_POSITION * pAeTimeStamp) PURE;
  STDMETHOD(PulseEndpoint)(THIS) PURE;
  STDMETHOD(ReleaseOutputDataPointer)(
      THIS_ const APO_CONNECTION_PROPERTY *pConnectionProperty) PURE;
  END_INTERFACE
};
#ifdef COBJMACROS
...
#define IAudioOutputEndpointRT_GetOutputDataPointer(This, u32FrameCount,       \
                                                    pAeTimeStamp)              \
  (This)->lpVtbl->GetOutputDataPointer(This, u32FrameCount, pAeTimeStamp)
#define IAudioOutputEndpointRT_PulseEndpoint()                                 \
  (This)->lpVtbl->PulseEndpoint(This)
#define IAudioOutputEndpointRT_ReleaseOutputDataPointer(This,                  \
                                                        pConnectionProperty)   \
