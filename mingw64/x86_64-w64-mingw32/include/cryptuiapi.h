...
#endif
#include <pshpack8.h>
WINBOOL WINAPI CryptUIDlgViewContext(DWORD dwContextType, const void *pvContext,
                                     HWND hwnd, LPCWSTR pwszTitle,
                                     DWORD dwFlags, void *pvReserved);
PCCERT_CONTEXT WINAPI CryptUIDlgSelectCertificateFromStore(
    HCERTSTORE hCertStore, HWND hwnd, LPCWSTR pwszTitle,
    LPCWSTR pwszDisplayString, DWORD dwDontUseColumn, DWORD dwFlags,
    void *pvReserved);
...
typedef WINBOOL(WINAPI *PFNCFILTERPROC)(PCCERT_CONTEXT pCertContext,
                                        WINBOOL *pfInitialSelectedCert,
                                        void *pvCallbackData);
...
typedef const CRYPTUI_WIZ_DIGITAL_SIGN_CONTEXT
    *PCCRYPTUI_WIZ_DIGITAL_SIGN_CONTEXT;
#define CRYPTUI_WIZ_NO_UI 0x0001
WINBOOL WINAPI
CryptUIWizDigitalSign(DWORD dwFlags, HWND hwndParent, LPCWSTR pwszWizardTitle,
                      PCCRYPTUI_WIZ_DIGITAL_SIGN_INFO pDigitalSignInfo,
                      PCCRYPTUI_WIZ_DIGITAL_SIGN_CONTEXT *ppSignContext);
WINBOOL WINAPI CryptUIWizFreeDigitalSignContext(
...
typedef const CRYPTUI_VIEWCERTIFICATE_STRUCTW
...
typedef const CRYPTUI_VIEWCERTIFICATE_STRUCTA
    *PCCRYPTUI_VIEWCERTIFICATE_STRUCTA;
WINBOOL WINAPI
CryptUIDlgViewCertificateW(PCCRYPTUI_VIEWCERTIFICATE_STRUCTW pCertViewInfo,
                           WINBOOL *pfPropertiesChanged);
WINBOOL WINAPI
CryptUIDlgViewCertificateA(PCCRYPTUI_VIEWCERTIFICATE_STRUCTA pCertViewInfo,
                           WINBOOL *pfPropertiesChanged);
#define CryptUIDlgViewCertificate __MINGW_NAME_AW(CryptUIDlgViewCertificate)
#define PCRYPTUI_VIEWCERTIFICATE_STRUCT                                        \
  __MINGW_NAME_AW(PCRYPTUI_VIEWCERTIFICATE_STRUCT)
#define CRYPTUI_VIEWCERTIFICATE_STRUCT                                         \
  __MINGW_NAME_AW(CRYPTUI_VIEWCERTIFICATE_STRUCT)
#define PCCRYPTUI_VIEWCERTIFICATE_STRUCT                                       \
  __MINGW_NAME_AW(PCCRYPTUI_VIEWCERTIFICATE_STRUCT)
...
WINBOOL WINAPI CryptUIWizExport(DWORD dwFlags, HWND hwndParent,
...
WINBOOL WINAPI CryptUIWizImport(DWORD dwFlags, HWND hwndParent,
                                LPCWSTR pwszWizardTitle,
