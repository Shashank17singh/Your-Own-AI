/*** Autogenerated by WIDL 11.5 from include/uiviewsettingsinterop.idl - Do not
 * edit ***/
#ifdef _WIN32
...
DEFINE_GUID(IID_IUIViewSettingsInterop, 0x3694dbf9, 0x8f68, 0x44be, 0x8f, 0xf5,
            0x19, 0x5c, 0x98, 0xed, 0xe8, 0xa6);
...
__CRT_UUID_DECL(IUIViewSettingsInterop, 0x3694dbf9, 0x8f68, 0x44be, 0x8f, 0xf5,
                0x19, 0x5c, 0x98, 0xed, 0xe8, 0xa6)
#endif
#else
typedef struct IUIViewSettingsInteropVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IUIViewSettingsInterop *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IUIViewSettingsInterop *This);
  ULONG(STDMETHODCALLTYPE *Release)(IUIViewSettingsInterop *This);
  /*** IInspectable methods ***/
  HRESULT(STDMETHODCALLTYPE *GetIids)(IUIViewSettingsInterop *This,
                                      ULONG *iidCount, IID **iids);
  HRESULT(STDMETHODCALLTYPE *GetRuntimeClassName)(IUIViewSettingsInterop *This,
                                                  HSTRING *className);
  HRESULT(STDMETHODCALLTYPE *GetTrustLevel)(IUIViewSettingsInterop *This,
                                            TrustLevel *trustLevel);
  /*** IUIViewSettingsInterop methods ***/
  HRESULT(STDMETHODCALLTYPE *GetForWindow)(IUIViewSettingsInterop *This,
...
IUIViewSettingsInterop_QueryInterface(IUIViewSettingsInterop *This, REFIID riid,
                                      void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IUIViewSettingsInterop_AddRef(IUIViewSettingsInterop *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IUIViewSettingsInterop_Release(IUIViewSettingsInterop *This) {
  return This->lpVtbl->Release(This);
}
/*** IInspectable methods ***/
static inline HRESULT
IUIViewSettingsInterop_GetIids(IUIViewSettingsInterop *This, ULONG *iidCount,
                               IID **iids) {
  return This->lpVtbl->GetIids(This, iidCount, iids);
}
static inline HRESULT
IUIViewSettingsInterop_GetRuntimeClassName(IUIViewSettingsInterop *This,
                                           HSTRING *className) {
  return This->lpVtbl->GetRuntimeClassName(This, className);
}
static inline HRESULT
IUIViewSettingsInterop_GetTrustLevel(IUIViewSettingsInterop *This,
                                     TrustLevel *trustLevel) {
  return This->lpVtbl->GetTrustLevel(This, trustLevel);
}
/*** IUIViewSettingsInterop methods ***/
static inline HRESULT
IUIViewSettingsInterop_GetForWindow(IUIViewSettingsInterop *This, HWND hwnd,
