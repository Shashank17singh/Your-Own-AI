...
WINBOOL WINAPI ICInstall(DWORD fccType, DWORD fccHandler, LPARAM lParam,
...
HIC WINAPI ICOpenFunction(DWORD fccType, DWORD fccHandler, UINT wMode,
                          FARPROC lpfnHandler);
...
#define ICAbout(hic, hwnd)                                                     \
  ICSendMessage(hic, ICM_ABOUT, (DWORD_PTR)(UINT_PTR)(hwnd), (DWORD_PTR)0)
#define ICQueryConfigure(hic)                                                  \
  (ICSendMessage(hic, ICM_CONFIGURE, (DWORD_PTR) - 1, ICMF_CONFIGURE_QUERY) == \
   ICERR_OK)
#define ICConfigure(hic, hwnd)                                                 \
  ICSendMessage(hic, ICM_CONFIGURE, (DWORD_PTR)(UINT_PTR)(hwnd), (DWORD_PTR)0)
...
#define ICGetDefaultQuality(hic)                                               \
  (ICSendMessage(hic, ICM_GETDEFAULTQUALITY, (DWORD_PTR)(LPVOID) & dwICValue,  \
                 sizeof(DWORD)),                                               \
   dwICValue)
#define ICGetDefaultKeyFrameRate(hic)                                          \
  (ICSendMessage(hic, ICM_GETDEFAULTKEYFRAMERATE,                              \
                 (DWORD_PTR)(LPVOID) & dwICValue, sizeof(DWORD)),              \
   dwICValue)
#define ICDrawWindow(hic, prc)                                                 \
  ICSendMessage(hic, ICM_DRAW_WINDOW, (DWORD_PTR)(LPVOID)(prc), sizeof(RECT))
DWORD WINAPIV ICCompress(HIC hic, DWORD dwFlags, LPBITMAPINFOHEADER lpbiOutput,
                         LPVOID lpData, LPBITMAPINFOHEADER lpbiInput,
                         LPVOID lpBits, LPDWORD lpckid, LPDWORD lpdwFlags,
                         LONG lFrameNum, DWORD dwFrameSize, DWORD dwQuality,
                         LPBITMAPINFOHEADER lpbiPrev, LPVOID lpPrev);
#define ICCompressBegin(hic, lpbiInput, lpbiOutput)                            \
  ICSendMessage(hic, ICM_COMPRESS_BEGIN, (DWORD_PTR)(LPVOID)(lpbiInput),       \
                (DWORD_PTR)(LPVOID)(lpbiOutput))
#define ICCompressQuery(hic, lpbiInput, lpbiOutput)                            \
  ICSendMessage(hic, ICM_COMPRESS_QUERY, (DWORD_PTR)(LPVOID)(lpbiInput),       \
                (DWORD_PTR)(LPVOID)(lpbiOutput))
#define ICCompressGetFormat(hic, lpbiInput, lpbiOutput)                        \
  ICSendMessage(hic, ICM_COMPRESS_GET_FORMAT, (DWORD_PTR)(LPVOID)(lpbiInput),  \
                (DWORD_PTR)(LPVOID)(lpbiOutput))
#define ICCompressGetFormatSize(hic, lpbi)                                     \
  (DWORD) ICCompressGetFormat(hic, lpbi, NULL)
#define ICCompressGetSize(hic, lpbiInput, lpbiOutput)                          \
  (DWORD) ICSendMessage(hic, ICM_COMPRESS_GET_SIZE,                            \
                        (DWORD_PTR)(LPVOID)(lpbiInput),                        \
                        (DWORD_PTR)(LPVOID)(lpbiOutput))
#define ICCompressEnd(hic)                                                     \
  ICSendMessage(hic, ICM_COMPRESS_END, (DWORD_PTR)0, (DWORD_PTR)0)
#define ICDECOMPRESS_HURRYUP __MSABI_LONG(0x80000000)
DWORD WINAPIV ICDecompress(HIC hic, DWORD dwFlags,
                           LPBITMAPINFOHEADER lpbiFormat, LPVOID lpData,
                           LPBITMAPINFOHEADER lpbi, LPVOID lpBits);
#define ICDecompressBegin(hic, lpbiInput, lpbiOutput)                          \
  ICSendMessage(hic, ICM_DECOMPRESS_BEGIN, (DWORD_PTR)(LPVOID)(lpbiInput),     \
                (DWORD_PTR)(LPVOID)(lpbiOutput))
#define ICDecompressQuery(hic, lpbiInput, lpbiOutput)                          \
  ICSendMessage(hic, ICM_DECOMPRESS_QUERY, (DWORD_PTR)(LPVOID)(lpbiInput),     \
                (DWORD_PTR)(LPVOID)(lpbiOutput))
#define ICDecompressGetFormat(hic, lpbiInput, lpbiOutput)                      \
  ((LONG)ICSendMessage(hic, ICM_DECOMPRESS_GET_FORMAT,                         \
                       (DWORD_PTR)(LPVOID)(lpbiInput),                         \
                       (DWORD_PTR)(LPVOID)(lpbiOutput)))
#define ICDecompressGetFormatSize(hic, lpbi)                                   \
  ICDecompressGetFormat(hic, lpbi, NULL)
#define ICDecompressGetPalette(hic, lpbiInput, lpbiOutput)                     \
  ICSendMessage(hic, ICM_DECOMPRESS_GET_PALETTE,                               \
                (DWORD_PTR)(LPVOID)(lpbiInput),                                \
                (DWORD_PTR)(LPVOID)(lpbiOutput))
#define ICDecompressSetPalette(hic, lpbiPalette)                               \
  ICSendMessage(hic, ICM_DECOMPRESS_SET_PALETTE,                               \
                (DWORD_PTR)(LPVOID)(lpbiPalette), (DWORD_PTR)0)
#define ICDecompressEnd(hic)                                                   \
  ICSendMessage(hic, ICM_DECOMPRESS_END, (DWORD_PTR)0, (DWORD_PTR)0)
#ifndef __CRT__NO_INLINE
__CRT_INLINE LRESULT WINAPI ICDecompressEx(
    HIC hic, DWORD dwFlags, LPBITMAPINFOHEADER lpbiSrc, LPVOID lpSrc, int xSrc,
    int ySrc, int dxSrc, int dySrc, LPBITMAPINFOHEADER lpbiDst, LPVOID lpDst,
...
__CRT_INLINE LRESULT WINAPI ICDecompressExBegin(
    HIC hic, DWORD dwFlags, LPBITMAPINFOHEADER lpbiSrc, LPVOID lpSrc, int xSrc,
    int ySrc, int dxSrc, int dySrc, LPBITMAPINFOHEADER lpbiDst, LPVOID lpDst,
    int xDst, int yDst, int dxDst, int dyDst) {
  ICDECOMPRESSEX ic;
...
__CRT_INLINE LRESULT WINAPI ICDecompressExQuery(
    HIC hic, DWORD dwFlags, LPBITMAPINFOHEADER lpbiSrc, LPVOID lpSrc, int xSrc,
    int ySrc, int dxSrc, int dySrc, LPBITMAPINFOHEADER lpbiDst, LPVOID lpDst,
    int xDst, int yDst, int dxDst, int dyDst) {
  ICDECOMPRESSEX ic;
...
#define ICDecompressExEnd(hic)                                                 \
  ICSendMessage(hic, ICM_DECOMPRESSEX_END, (DWORD_PTR)0, (DWORD_PTR)0)
#define ICDRAW_QUERY __MSABI_LONG(0x00000001)
#define ICDRAW_FULLSCREEN __MSABI_LONG(0x00000002)
#define ICDRAW_HDC __MSABI_LONG(0x00000004)
DWORD WINAPIV ICDrawBegin(HIC hic, DWORD dwFlags, HPALETTE hpal, HWND hwnd,
                          HDC hdc, int xDst, int yDst, int dxDst, int dyDst,
                          LPBITMAPINFOHEADER lpbi, int xSrc, int ySrc,
                          int dxSrc, int dySrc, DWORD dwRate, DWORD dwScale);
#define ICDRAW_HURRYUP __MSABI_LONG(0x80000000)
#define ICDRAW_UPDATE __MSABI_LONG(0x40000000)
DWORD WINAPIV ICDraw(HIC hic, DWORD dwFlags, LPVOID lpFormat, LPVOID lpData,
                     DWORD cbData, LONG lTime);
#ifndef __CRT__NO_INLINE
__CRT_INLINE LRESULT WINAPI ICDrawSuggestFormat(HIC hic,
                                                LPBITMAPINFOHEADER lpbiIn,
                                                LPBITMAPINFOHEADER lpbiOut,
                                                int dxSrc, int dySrc, int dxDst,
...
#define ICDrawQuery(hic, lpbiInput)                                            \
  ICSendMessage(hic, ICM_DRAW_QUERY, (DWORD_PTR)(LPVOID)(lpbiInput), (DWORD)0)
#define ICDrawChangePalette(hic, lpbiInput)                                    \
  ICSendMessage(hic, ICM_DRAW_CHANGEPALETTE, (DWORD_PTR)(LPVOID)(lpbiInput),   \
                (DWORD)0)
#define ICGetBuffersWanted(hic, lpdwBuffers)                                   \
  ICSendMessage(hic, ICM_GETBUFFERSWANTED, (DWORD_PTR)(LPVOID)(lpdwBuffers),   \
                (DWORD_PTR)0)
#define ICDrawEnd(hic)                                                         \
  ICSendMessage(hic, ICM_DRAW_END, (DWORD_PTR)0, (DWORD_PTR)0)
#define ICDrawStart(hic)                                                       \
  ICSendMessage(hic, ICM_DRAW_START, (DWORD_PTR)0, (DWORD_PTR)0)
...
#define ICDrawStop(hic)                                                        \
  ICSendMessage(hic, ICM_DRAW_STOP, (DWORD_PTR)0, (DWORD_PTR)0)
#define ICDrawStopPlay(hic)                                                    \
  ICSendMessage(hic, ICM_DRAW_STOP_PLAY, (DWORD_PTR)0, (DWORD_PTR)0)
#define ICDrawGetTime(hic, lplTime)                                            \
  ICSendMessage(hic, ICM_DRAW_GETTIME, (DWORD_PTR)(LPVOID)(lplTime),           \
                (DWORD_PTR)0)
#define ICDrawSetTime(hic, lTime)                                              \
  ICSendMessage(hic, ICM_DRAW_SETTIME, (DWORD_PTR)lTime, (DWORD_PTR)0)
#define ICDrawRealize(hic, hdc, fBackground)                                   \
  ICSendMessage(hic, ICM_DRAW_REALIZE, (DWORD_PTR)(UINT_PTR)(HDC)(hdc),        \
                (DWORD_PTR)(WINBOOL)(fBackground))
#define ICDrawFlush(hic)                                                       \
  ICSendMessage(hic, ICM_DRAW_FLUSH, (DWORD_PTR)0, (DWORD_PTR)0)
#define ICDrawRenderBuffer(hic)                                                \
  ICSendMessage(hic, ICM_DRAW_RENDERBUFFER, (DWORD_PTR)0, (DWORD_PTR)0)
#ifndef __CRT__NO_INLINE
__CRT_INLINE LRESULT WINAPI
...
HIC WINAPI ICLocate(DWORD fccType, DWORD fccHandler, LPBITMAPINFOHEADER lpbiIn,
                    LPBITMAPINFOHEADER lpbiOut, WORD wFlags);
HIC WINAPI ICGetDisplayFormat(HIC hic, LPBITMAPINFOHEADER lpbiIn,
                              LPBITMAPINFOHEADER lpbiOut, int BitDepth, int dx,
                              int dy);
HANDLE WINAPI ICImageCompress(HIC hic, UINT uiFlags, LPBITMAPINFO lpbiIn,
                              LPVOID lpBits, LPBITMAPINFO lpbiOut,
                              LONG lQuality, LONG *plSize);
HANDLE WINAPI ICImageDecompress(HIC hic, UINT uiFlags, LPBITMAPINFO lpbiIn,
                                LPVOID lpBits, LPBITMAPINFO lpbiOut);
typedef struct {
  LONG cbSize;
  DWORD dwFlags;
...
WINBOOL WINAPI ICCompressorChoose(HWND hwnd, UINT uiFlags, LPVOID pvIn,
...
LPVOID WINAPI ICSeqCompressFrame(PCOMPVARS pc, UINT uiFlags, LPVOID lpBits,
                                 WINBOOL *pfKey, LONG *plSize);
...
extern LPVOID WINAPI DrawDibGetBuffer(HDRAWDIB hdd, LPBITMAPINFOHEADER lpbi,
...
extern WINBOOL WINAPI DrawDibChangePalette(HDRAWDIB hdd, int iStart, int iLen,
                                           LPPALETTEENTRY lppe);
...
extern WINBOOL WINAPI DrawDibBegin(HDRAWDIB hdd, HDC hdc, int dxDst, int dyDst,
                                   LPBITMAPINFOHEADER lpbi, int dxSrc,
                                   int dySrc, UINT wFlags);
extern WINBOOL WINAPI DrawDibDraw(HDRAWDIB hdd, HDC hdc, int xDst, int yDst,
                                  int dxDst, int dyDst, LPBITMAPINFOHEADER lpbi,
...
void WINAPI StretchDIB(LPBITMAPINFOHEADER biDst, LPVOID lpDst, int DstX,
                       int DstY, int DstXE, int DstYE, LPBITMAPINFOHEADER biSrc,
                       LPVOID lpSrc, int SrcX, int SrcY, int SrcXE, int SrcYE);
#endif
#endif
#ifndef NOAVIFMT
...
DECLARE_INTERFACE_(IAVIStream, IUnknown) {
  ...
  STDMETHOD(ReadFormat)(THIS_ LONG lPos, LPVOID lpFormat, LONG * lpcbFormat)
      PURE;
  STDMETHOD(SetFormat)(THIS_ LONG lPos, LPVOID lpFormat, LONG cbFormat) PURE;
  STDMETHOD(Read)(THIS_ LONG lStart, LONG lSamples, LPVOID lpBuffer,
                  LONG cbBuffer, LONG * plBytes, LONG * plSamples) PURE;
  STDMETHOD(Write)(THIS_ LONG lStart, LONG lSamples, LPVOID lpBuffer,
...
DECLARE_INTERFACE_(IAVIEditStream, IUnknown) {
  ...
  STDMETHOD_(ULONG, AddRef)(THIS) PURE;
  STDMETHOD_(ULONG, Release)(THIS) PURE;
  STDMETHOD(Cut)(THIS_ LONG * plStart, LONG * plLength, PAVISTREAM * ppResult)
      PURE;
  STDMETHOD(Copy)(THIS_ LONG * plStart, LONG * plLength, PAVISTREAM * ppResult)
      PURE;
  STDMETHOD(Paste)(THIS_ LONG * plPos, LONG * plLength, PAVISTREAM pstream,
                   LONG lStart, LONG lEnd) PURE;
...
DECLARE_INTERFACE_(IAVIFile, IUnknown) {
  ...
  STDMETHOD(GetStream)(THIS_ PAVISTREAM * ppStream, DWORD fccType, LONG lParam)
      PURE;
  STDMETHOD(CreateStream)(THIS_ PAVISTREAM * ppStream, AVISTREAMINFOW * psi)
      PURE;
...
DECLARE_INTERFACE_(IGetFrame, IUnknown) {
  ...
  STDMETHOD(Begin)(THIS_ LONG lStart, LONG lEnd, LONG lRate) PURE;
  STDMETHOD(End)(THIS) PURE;
  STDMETHOD(SetFormat)(THIS_ LPBITMAPINFOHEADER lpbi, LPVOID lpBits, int x,
                       int y, int dx, int dy) PURE;
};
#undef PGETFRAME
...
STDAPI AVIFileOpenA(PAVIFILE *ppfile, LPCSTR szFile, UINT uMode,
                    LPCLSID lpHandler);
STDAPI AVIFileOpenW(PAVIFILE *ppfile, LPCWSTR szFile, UINT uMode,
                    LPCLSID lpHandler);
...
STDAPI AVIFileGetStream(PAVIFILE pfile, PAVISTREAM *ppavi, DWORD fccType,
                        LONG lParam);
STDAPI AVIFileCreateStreamW(PAVIFILE pfile, PAVISTREAM *ppavi,
                            AVISTREAMINFOW *psi);
STDAPI AVIFileCreateStreamA(PAVIFILE pfile, PAVISTREAM *ppavi,
                            AVISTREAMINFOA *psi);
...
STDAPI AVIStreamRead(PAVISTREAM pavi, LONG lStart, LONG lSamples,
                     LPVOID lpBuffer, LONG cbBuffer, LONG *plBytes,
                     LONG *plSamples);
...
STDAPI AVIStreamWrite(PAVISTREAM pavi, LONG lStart, LONG lSamples,
                      ...
                      LONG *plSampWritten, LONG *plBytesWritten);
...
STDAPI AVIStreamBeginStreaming(PAVISTREAM pavi, LONG lStart, LONG lEnd,
                               LONG lRate);
...
STDAPI AVIStreamOpenFromFileA(PAVISTREAM *ppavi, LPCSTR szFile, DWORD fccType,
                              LONG lParam, UINT mode, CLSID *pclsidHandler);
STDAPI AVIStreamOpenFromFileW(PAVISTREAM *ppavi, LPCWSTR szFile, DWORD fccType,
                              LONG lParam, UINT mode, CLSID *pclsidHandler);
...
#define AVIStreamSampleSize(pavi, lPos, plSize)                                \
  AVIStreamRead(pavi, lPos, 1, NULL, (LONG)0, plSize, NULL)
...
STDAPI AVIMakeCompressedStream(PAVISTREAM *ppsCompressed, PAVISTREAM ppsSource,
                               AVICOMPRESSOPTIONS *lpOptions,
                               CLSID *pclsidHandler);
EXTERN_C HRESULT CDECL AVISaveA(LPCSTR szFile, CLSID *pclsidHandler,
                                AVISAVECALLBACK lpfnCallback, int nStreams,
                                PAVISTREAM pfile,
                                LPAVICOMPRESSOPTIONS lpOptions, ...);
STDAPI AVISaveVA(LPCSTR szFile, CLSID *pclsidHandler,
                 AVISAVECALLBACK lpfnCallback, int nStreams, PAVISTREAM *ppavi,
                 LPAVICOMPRESSOPTIONS *plpOptions);
EXTERN_C HRESULT CDECL AVISaveW(LPCWSTR szFile, CLSID *pclsidHandler,
                                AVISAVECALLBACK lpfnCallback, int nStreams,
                                PAVISTREAM pfile,
                                LPAVICOMPRESSOPTIONS lpOptions, ...);
STDAPI AVISaveVW(LPCWSTR szFile, CLSID *pclsidHandler,
                 AVISAVECALLBACK lpfnCallback, int nStreams, PAVISTREAM *ppavi,
                 LPAVICOMPRESSOPTIONS *plpOptions);
STDAPI_(INT_PTR)
AVISaveOptions(HWND hwnd, UINT uiFlags, int nStreams, PAVISTREAM *ppavi,
               LPAVICOMPRESSOPTIONS *plpOptions);
...
STDAPI AVIMakeFileFromStreams(PAVIFILE *ppfile, int nStreams,
...
STDAPI EditStreamCut(PAVISTREAM pavi, LONG *plStart, LONG *plLength,
                     PAVISTREAM *ppResult);
STDAPI EditStreamCopy(PAVISTREAM pavi, LONG *plStart, LONG *plLength,
                      PAVISTREAM *ppResult);
STDAPI EditStreamPaste(PAVISTREAM pavi, LONG *plPos, LONG *plLength,
                       PAVISTREAM pstream, LONG lStart, LONG lEnd);
...
STDAPI EditStreamSetInfoW(PAVISTREAM pavi, LPAVISTREAMINFOW lpInfo,
                          LONG cbInfo);
STDAPI EditStreamSetInfoA(PAVISTREAM pavi, LPAVISTREAMINFOA lpInfo,
                          LONG cbInfo);
#ifndef AVIERR_OK
#define AVIERR_OK __MSABI_LONG(0)
#define MAKE_AVIERR(error)                                                     \
...
HWND WINAPIV MCIWndCreateA(HWND hwndParent, HINSTANCE hInstance, DWORD dwStyle,
                           LPCSTR szFile);
HWND WINAPIV MCIWndCreateW(HWND hwndParent, HINSTANCE hInstance, DWORD dwStyle,
                           LPCWSTR szFile);
...
#define MCIWndCanPlay(hwnd)                                                    \
  (WINBOOL) MCIWndSM(hwnd, MCIWNDM_CAN_PLAY, (WPARAM)0, (LPARAM)0)
#define MCIWndCanRecord(hwnd)                                                  \
  (WINBOOL) MCIWndSM(hwnd, MCIWNDM_CAN_RECORD, (WPARAM)0, (LPARAM)0)
#define MCIWndCanSave(hwnd)                                                    \
  (WINBOOL) MCIWndSM(hwnd, MCIWNDM_CAN_SAVE, (WPARAM)0, (LPARAM)0)
#define MCIWndCanWindow(hwnd)                                                  \
  (WINBOOL) MCIWndSM(hwnd, MCIWNDM_CAN_WINDOW, (WPARAM)0, (LPARAM)0)
#define MCIWndCanEject(hwnd)                                                   \
  (WINBOOL) MCIWndSM(hwnd, MCIWNDM_CAN_EJECT, (WPARAM)0, (LPARAM)0)
#define MCIWndCanConfig(hwnd)                                                  \
  (WINBOOL) MCIWndSM(hwnd, MCIWNDM_CAN_CONFIG, (WPARAM)0, (LPARAM)0)
#define MCIWndPaletteKick(hwnd)                                                \
  (WINBOOL) MCIWndSM(hwnd, MCIWNDM_PALETTEKICK, (WPARAM)0, (LPARAM)0)
#define MCIWndSave(hwnd, szFile)                                               \
  (LONG) MCIWndSM(hwnd, MCI_SAVE, (WPARAM)0, (LPARAM)(LPVOID)(szFile))
#define MCIWndSaveDialog(hwnd) MCIWndSave(hwnd, -1)
#define MCIWndNew(hwnd, lp)                                                    \
  (LONG) MCIWndSM(hwnd, MCIWNDM_NEW, (WPARAM)0, (LPARAM)(LPVOID)(lp))
#define MCIWndRecord(hwnd)                                                     \
  (LONG) MCIWndSM(hwnd, MCI_RECORD, (WPARAM)0, (LPARAM)0)
#define MCIWndOpen(hwnd, sz, f)                                                \
...
#define MCIWndResume(hwnd)                                                     \
  (LONG) MCIWndSM(hwnd, MCI_RESUME, (WPARAM)0, (LPARAM)0)
#define MCIWndSeek(hwnd, lPos)                                                 \
  (LONG) MCIWndSM(hwnd, MCI_SEEK, (WPARAM)0, (LPARAM)(LONG)(lPos))
#define MCIWndEject(hwnd)                                                      \
  (LONG) MCIWndSM(hwnd, MCIWNDM_EJECT, (WPARAM)0, (LPARAM)0)
#define MCIWndHome(hwnd) MCIWndSeek(hwnd, MCIWND_START)
#define MCIWndEnd(hwnd) MCIWndSeek(hwnd, MCIWND_END)
#define MCIWndGetSource(hwnd, prc)                                             \
  (LONG) MCIWndSM(hwnd, MCIWNDM_GET_SOURCE, (WPARAM)0, (LPARAM)(LPRECT)(prc))
#define MCIWndPutSource(hwnd, prc)                                             \
  (LONG) MCIWndSM(hwnd, MCIWNDM_PUT_SOURCE, (WPARAM)0, (LPARAM)(LPRECT)(prc))
#define MCIWndGetDest(hwnd, prc)                                               \
  (LONG) MCIWndSM(hwnd, MCIWNDM_GET_DEST, (WPARAM)0, (LPARAM)(LPRECT)(prc))
#define MCIWndPutDest(hwnd, prc)                                               \
  (LONG) MCIWndSM(hwnd, MCIWNDM_PUT_DEST, (WPARAM)0, (LPARAM)(LPRECT)(prc))
#define MCIWndPlayReverse(hwnd)                                                \
  (LONG) MCIWndSM(hwnd, MCIWNDM_PLAYREVERSE, (WPARAM)0, (LPARAM)0)
#define MCIWndPlayFrom(hwnd, lPos)                                             \
  (LONG) MCIWndSM(hwnd, MCIWNDM_PLAYFROM, (WPARAM)0, (LPARAM)(LONG)(lPos))
#define MCIWndPlayTo(hwnd, lPos)                                               \
  (LONG) MCIWndSM(hwnd, MCIWNDM_PLAYTO, (WPARAM)0, (LPARAM)(LONG)(lPos))
#define MCIWndPlayFromTo(hwnd, lStart, lEnd)                                   \
  (MCIWndSeek(hwnd, lStart), MCIWndPlayTo(hwnd, lEnd))
#define MCIWndGetDeviceID(hwnd)                                                \
  (UINT) MCIWndSM(hwnd, MCIWNDM_GETDEVICEID, (WPARAM)0, (LPARAM)0)
#define MCIWndGetAlias(hwnd)                                                   \
  (UINT) MCIWndSM(hwnd, MCIWNDM_GETALIAS, (WPARAM)0, (LPARAM)0)
#define MCIWndGetMode(hwnd, lp, len)                                           \
  (LONG) MCIWndSM(hwnd, MCIWNDM_GETMODE, (WPARAM)(UINT)(len),                  \
                  (LPARAM)(LPTSTR)(lp))
#define MCIWndGetPosition(hwnd)                                                \
  (LONG) MCIWndSM(hwnd, MCIWNDM_GETPOSITION, (WPARAM)0, (LPARAM)0)
#define MCIWndGetPositionString(hwnd, lp, len)                                 \
  (LONG) MCIWndSM(hwnd, MCIWNDM_GETPOSITION, (WPARAM)(UINT)(len),              \
                  (LPARAM)(LPTSTR)(lp))
#define MCIWndGetStart(hwnd)                                                   \
  (LONG) MCIWndSM(hwnd, MCIWNDM_GETSTART, (WPARAM)0, (LPARAM)0)
#define MCIWndGetLength(hwnd)                                                  \
  (LONG) MCIWndSM(hwnd, MCIWNDM_GETLENGTH, (WPARAM)0, (LPARAM)0)
#define MCIWndGetEnd(hwnd)                                                     \
  (LONG) MCIWndSM(hwnd, MCIWNDM_GETEND, (WPARAM)0, (LPARAM)0)
#define MCIWndStep(hwnd, n)                                                    \
  (LONG) MCIWndSM(hwnd, MCI_STEP, (WPARAM)0, (LPARAM)(__LONG32)(n))
#define MCIWndDestroy(hwnd)                                                    \
  (VOID) MCIWndSM(hwnd, WM_CLOSE, (WPARAM)0, (LPARAM)0)
#define MCIWndSetZoom(hwnd, iZoom)                                             \
  (VOID) MCIWndSM(hwnd, MCIWNDM_SETZOOM, (WPARAM)0, (LPARAM)(UINT)(iZoom))
#define MCIWndGetZoom(hwnd)                                                    \
  (UINT) MCIWndSM(hwnd, MCIWNDM_GETZOOM, (WPARAM)0, (LPARAM)0)
#define MCIWndSetVolume(hwnd, iVol)                                            \
  (LONG) MCIWndSM(hwnd, MCIWNDM_SETVOLUME, (WPARAM)0, (LPARAM)(UINT)(iVol))
#define MCIWndGetVolume(hwnd)                                                  \
  (LONG) MCIWndSM(hwnd, MCIWNDM_GETVOLUME, (WPARAM)0, (LPARAM)0)
#define MCIWndSetSpeed(hwnd, iSpeed)                                           \
  (LONG) MCIWndSM(hwnd, MCIWNDM_SETSPEED, (WPARAM)0, (LPARAM)(UINT)(iSpeed))
#define MCIWndGetSpeed(hwnd)                                                   \
  (LONG) MCIWndSM(hwnd, MCIWNDM_GETSPEED, (WPARAM)0, (LPARAM)0)
#define MCIWndSetTimeFormat(hwnd, lp)                                          \
  (LONG) MCIWndSM(hwnd, MCIWNDM_SETTIMEFORMAT, (WPARAM)0, (LPARAM)(LPTSTR)(lp))
#define MCIWndGetTimeFormat(hwnd, lp, len)                                     \
  (LONG) MCIWndSM(hwnd, MCIWNDM_GETTIMEFORMAT, (WPARAM)(UINT)(len),            \
                  (LPARAM)(LPTSTR)(lp))
#define MCIWndValidateMedia(hwnd)                                              \
  (VOID) MCIWndSM(hwnd, MCIWNDM_VALIDATEMEDIA, (WPARAM)0, (LPARAM)0)
#define MCIWndSetRepeat(hwnd, f)                                               \
  (void)MCIWndSM(hwnd, MCIWNDM_SETREPEAT, (WPARAM)0, (LPARAM)(WINBOOL)(f))
#define MCIWndGetRepeat(hwnd)                                                  \
  (WINBOOL) MCIWndSM(hwnd, MCIWNDM_GETREPEAT, (WPARAM)0, (LPARAM)0)
...
#define MCIWndSetActiveTimer(hwnd, active)                                     \
  (VOID) MCIWndSM(hwnd, MCIWNDM_SETACTIVETIMER, (WPARAM)(UINT)(active),        \
                  (LPARAM)0)
#define MCIWndSetInactiveTimer(hwnd, inactive)                                 \
  (VOID) MCIWndSM(hwnd, MCIWNDM_SETINACTIVETIMER, (WPARAM)(UINT)(inactive),    \
                  (LPARAM)0)
...
#define MCIWndGetActiveTimer(hwnd)                                             \
  (UINT) MCIWndSM(hwnd, MCIWNDM_GETACTIVETIMER, (WPARAM)0, (LPARAM)0);
#define MCIWndGetInactiveTimer(hwnd)                                           \
  (UINT) MCIWndSM(hwnd, MCIWNDM_GETINACTIVETIMER, (WPARAM)0, (LPARAM)0);
#define MCIWndRealize(hwnd, fBkgnd)                                            \
  (LONG) MCIWndSM(hwnd, MCIWNDM_REALIZE, (WPARAM)(WINBOOL)(fBkgnd), (LPARAM)0)
#define MCIWndSendString(hwnd, sz)                                             \
  (LONG) MCIWndSM(hwnd, MCIWNDM_SENDSTRING, (WPARAM)0, (LPARAM)(LPTSTR)(sz))
#define MCIWndReturnString(hwnd, lp, len)                                      \
  (LONG) MCIWndSM(hwnd, MCIWNDM_RETURNSTRING, (WPARAM)(UINT)(len),             \
                  (LPARAM)(LPVOID)(lp))
#define MCIWndGetError(hwnd, lp, len)                                          \
  (LONG) MCIWndSM(hwnd, MCIWNDM_GETERROR, (WPARAM)(UINT)(len),                 \
                  (LPARAM)(LPVOID)(lp))
#define MCIWndGetPalette(hwnd)                                                 \
  (HPALETTE) MCIWndSM(hwnd, MCIWNDM_GETPALETTE, (WPARAM)0, (LPARAM)0)
#define MCIWndSetPalette(hwnd, hpal)                                           \
  (LONG) MCIWndSM(hwnd, MCIWNDM_SETPALETTE, (WPARAM)(HPALETTE)(hpal), (LPARAM)0)
#define MCIWndGetFileName(hwnd, lp, len)                                       \
  (LONG) MCIWndSM(hwnd, MCIWNDM_GETFILENAME, (WPARAM)(UINT)(len),              \
                  (LPARAM)(LPVOID)(lp))
#define MCIWndGetDevice(hwnd, lp, len)                                         \
  (LONG) MCIWndSM(hwnd, MCIWNDM_GETDEVICE, (WPARAM)(UINT)(len),                \
                  (LPARAM)(LPVOID)(lp))
#define MCIWndGetStyles(hwnd)                                                  \
  (UINT) MCIWndSM(hwnd, MCIWNDM_GETSTYLES, (WPARAM)0, (LPARAM)0)
#define MCIWndChangeStyles(hwnd, mask, value)                                  \
  (LONG) MCIWndSM(hwnd, MCIWNDM_CHANGESTYLES, (WPARAM)(UINT)(mask),            \
                  (LPARAM)(LONG)(value))
#define MCIWndOpenInterface(hwnd, pUnk)                                        \
  (LONG) MCIWndSM(hwnd, MCIWNDM_OPENINTERFACE, (WPARAM)0,                      \
                  (LPARAM)(LPUNKNOWN)(pUnk))
#define MCIWndSetOwner(hwnd, hwndP)                                            \
  (LONG) MCIWndSM(hwnd, MCIWNDM_SETOWNER, (WPARAM)(hwndP), (LPARAM)0)
...
#define WM_CAP_FILE_SET_CAPTURE_FILE                                           \
  __MINGW_NAME_AW(WM_CAP_FILE_SET_CAPTURE_FILE)
#define WM_CAP_FILE_GET_CAPTURE_FILE                                           \
  __MINGW_NAME_AW(WM_CAP_FILE_GET_CAPTURE_FILE)
...
#define capSetCallbackOnError(hwnd, fpProc)                                    \
  ((WINBOOL)AVICapSM(hwnd, WM_CAP_SET_CALLBACK_ERROR, (WPARAM)0,               \
                     (LPARAM)(LPVOID)(fpProc)))
#define capSetCallbackOnStatus(hwnd, fpProc)                                   \
  ((WINBOOL)AVICapSM(hwnd, WM_CAP_SET_CALLBACK_STATUS, (WPARAM)0,              \
                     (LPARAM)(LPVOID)(fpProc)))
#define capSetCallbackOnYield(hwnd, fpProc)                                    \
  ((WINBOOL)AVICapSM(hwnd, WM_CAP_SET_CALLBACK_YIELD, (WPARAM)0,               \
                     (LPARAM)(LPVOID)(fpProc)))
#define capSetCallbackOnFrame(hwnd, fpProc)                                    \
  ((WINBOOL)AVICapSM(hwnd, WM_CAP_SET_CALLBACK_FRAME, (WPARAM)0,               \
                     (LPARAM)(LPVOID)(fpProc)))
#define capSetCallbackOnVideoStream(hwnd, fpProc)                              \
  ((WINBOOL)AVICapSM(hwnd, WM_CAP_SET_CALLBACK_VIDEOSTREAM, (WPARAM)0,         \
                     (LPARAM)(LPVOID)(fpProc)))
#define capSetCallbackOnWaveStream(hwnd, fpProc)                               \
  ((WINBOOL)AVICapSM(hwnd, WM_CAP_SET_CALLBACK_WAVESTREAM, (WPARAM)0,          \
                     (LPARAM)(LPVOID)(fpProc)))
#define capSetCallbackOnCapControl(hwnd, fpProc)                               \
  ((WINBOOL)AVICapSM(hwnd, WM_CAP_SET_CALLBACK_CAPCONTROL, (WPARAM)0,          \
                     (LPARAM)(LPVOID)(fpProc)))
#define capSetUserData(hwnd, lUser)                                            \
  ((WINBOOL)AVICapSM(hwnd, WM_CAP_SET_USER_DATA, (WPARAM)0, (LPARAM)lUser))
#define capGetUserData(hwnd)                                                   \
  (AVICapSM(hwnd, WM_CAP_GET_USER_DATA, (WPARAM)0, (LPARAM)0))
#define capDriverConnect(hwnd, i)                                              \
  ((WINBOOL)AVICapSM(hwnd, WM_CAP_DRIVER_CONNECT, (WPARAM)(i), (LPARAM)0))
#define capDriverDisconnect(hwnd)                                              \
  ((WINBOOL)AVICapSM(hwnd, WM_CAP_DRIVER_DISCONNECT, (WPARAM)0, (LPARAM)0))
#define capDriverGetName(hwnd, szName, wSize)                                  \
  ((WINBOOL)AVICapSM(hwnd, WM_CAP_DRIVER_GET_NAME, (WPARAM)(wSize),            \
                     (LPARAM)(LPVOID)(LPTSTR)(szName)))
#define capDriverGetVersion(hwnd, szVer, wSize)                                \
  ((WINBOOL)AVICapSM(hwnd, WM_CAP_DRIVER_GET_VERSION, (WPARAM)(wSize),         \
                     (LPARAM)(LPVOID)(LPTSTR)(szVer)))
#define capDriverGetCaps(hwnd, s, wSize)                                       \
  ((WINBOOL)AVICapSM(hwnd, WM_CAP_DRIVER_GET_CAPS, (WPARAM)(wSize),            \
                     (LPARAM)(LPVOID)(LPCAPDRIVERCAPS)(s)))
#define capFileSetCaptureFile(hwnd, szName)                                    \
  ((WINBOOL)AVICapSM(hwnd, WM_CAP_FILE_SET_CAPTURE_FILE, (WPARAM)0,            \
                     (LPARAM)(LPVOID)(LPTSTR)(szName)))
#define capFileGetCaptureFile(hwnd, szName, wSize)                             \
  ((WINBOOL)AVICapSM(hwnd, WM_CAP_FILE_GET_CAPTURE_FILE, (WPARAM)(wSize),      \
                     (LPARAM)(LPVOID)(LPTSTR)(szName)))
#define capFileAlloc(hwnd, dwSize)                                             \
  ((WINBOOL)AVICapSM(hwnd, WM_CAP_FILE_ALLOCATE, (WPARAM)0,                    \
                     (LPARAM)(DWORD)(dwSize)))
#define capFileSaveAs(hwnd, szName)                                            \
  ((WINBOOL)AVICapSM(hwnd, WM_CAP_FILE_SAVEAS, (WPARAM)0,                      \
                     (LPARAM)(LPVOID)(LPTSTR)(szName)))
#define capFileSetInfoChunk(hwnd, lpInfoChunk)                                 \
  ((WINBOOL)AVICapSM(hwnd, WM_CAP_FILE_SET_INFOCHUNK, (WPARAM)0,               \
                     (LPARAM)(LPCAPINFOCHUNK)(lpInfoChunk)))
#define capFileSaveDIB(hwnd, szName)                                           \
  ((WINBOOL)AVICapSM(hwnd, WM_CAP_FILE_SAVEDIB, (WPARAM)0,                     \
                     (LPARAM)(LPVOID)(LPTSTR)(szName)))
#define capEditCopy(hwnd)                                                      \
  ((WINBOOL)AVICapSM(hwnd, WM_CAP_EDIT_COPY, (WPARAM)0, (LPARAM)0))
#define capSetAudioFormat(hwnd, s, wSize)                                      \
  ((WINBOOL)AVICapSM(hwnd, WM_CAP_SET_AUDIOFORMAT, (WPARAM)(wSize),            \
...
#define capGetAudioFormatSize(hwnd)                                            \
  ((DWORD)AVICapSM(hwnd, WM_CAP_GET_AUDIOFORMAT, (WPARAM)0, (LPARAM)0))
#define capDlgVideoFormat(hwnd)                                                \
  ((WINBOOL)AVICapSM(hwnd, WM_CAP_DLG_VIDEOFORMAT, (WPARAM)0, (LPARAM)0))
#define capDlgVideoSource(hwnd)                                                \
  ((WINBOOL)AVICapSM(hwnd, WM_CAP_DLG_VIDEOSOURCE, (WPARAM)0, (LPARAM)0))
#define capDlgVideoDisplay(hwnd)                                               \
  ((WINBOOL)AVICapSM(hwnd, WM_CAP_DLG_VIDEODISPLAY, (WPARAM)0, (LPARAM)0))
#define capDlgVideoCompression(hwnd)                                           \
  ((WINBOOL)AVICapSM(hwnd, WM_CAP_DLG_VIDEOCOMPRESSION, (WPARAM)0, (LPARAM)0))
...
#define capGetVideoFormatSize(hwnd)                                            \
  ((DWORD)AVICapSM(hwnd, WM_CAP_GET_VIDEOFORMAT, (WPARAM)0, (LPARAM)0))
#define capSetVideoFormat(hwnd, s, wSize)                                      \
  ((WINBOOL)AVICapSM(hwnd, WM_CAP_SET_VIDEOFORMAT, (WPARAM)(wSize),            \
                     (LPARAM)(LPVOID)(s)))
#define capPreview(hwnd, f)                                                    \
  ((WINBOOL)AVICapSM(hwnd, WM_CAP_SET_PREVIEW, (WPARAM)(WINBOOL)(f), (LPARAM)0))
#define capPreviewRate(hwnd, wMS)                                              \
  ((WINBOOL)AVICapSM(hwnd, WM_CAP_SET_PREVIEWRATE, (WPARAM)(wMS), (LPARAM)0))
#define capOverlay(hwnd, f)                                                    \
  ((WINBOOL)AVICapSM(hwnd, WM_CAP_SET_OVERLAY, (WPARAM)(WINBOOL)(f), (LPARAM)0))
#define capPreviewScale(hwnd, f)                                               \
  ((WINBOOL)AVICapSM(hwnd, WM_CAP_SET_SCALE, (WPARAM)(WINBOOL)f, (LPARAM)0))
#define capGetStatus(hwnd, s, wSize)                                           \
  ((WINBOOL)AVICapSM(hwnd, WM_CAP_GET_STATUS, (WPARAM)(wSize),                 \
                     (LPARAM)(LPVOID)(LPCAPSTATUS)(s)))
#define capSetScrollPos(hwnd, lpP)                                             \
  ((WINBOOL)AVICapSM(hwnd, WM_CAP_SET_SCROLL, (WPARAM)0,                       \
                     (LPARAM)(LPPOINT)(lpP)))
#define capGrabFrame(hwnd)                                                     \
  ((WINBOOL)AVICapSM(hwnd, WM_CAP_GRAB_FRAME, (WPARAM)0, (LPARAM)0))
#define capGrabFrameNoStop(hwnd)                                               \
  ((WINBOOL)AVICapSM(hwnd, WM_CAP_GRAB_FRAME_NOSTOP, (WPARAM)0, (LPARAM)0))
#define capCaptureSequence(hwnd)                                               \
  ((WINBOOL)AVICapSM(hwnd, WM_CAP_SEQUENCE, (WPARAM)0, (LPARAM)0))
#define capCaptureSequenceNoFile(hwnd)                                         \
  ((WINBOOL)AVICapSM(hwnd, WM_CAP_SEQUENCE_NOFILE, (WPARAM)0, (LPARAM)0))
#define capCaptureStop(hwnd)                                                   \
  ((WINBOOL)AVICapSM(hwnd, WM_CAP_STOP, (WPARAM)0, (LPARAM)0))
#define capCaptureAbort(hwnd)                                                  \
  ((WINBOOL)AVICapSM(hwnd, WM_CAP_ABORT, (WPARAM)0, (LPARAM)0))
#define capCaptureSingleFrameOpen(hwnd)                                        \
  ((WINBOOL)AVICapSM(hwnd, WM_CAP_SINGLE_FRAME_OPEN, (WPARAM)0, (LPARAM)0))
#define capCaptureSingleFrameClose(hwnd)                                       \
  ((WINBOOL)AVICapSM(hwnd, WM_CAP_SINGLE_FRAME_CLOSE, (WPARAM)0, (LPARAM)0))
#define capCaptureSingleFrame(hwnd)                                            \
  ((WINBOOL)AVICapSM(hwnd, WM_CAP_SINGLE_FRAME, (WPARAM)0, (LPARAM)0))
#define capCaptureGetSetup(hwnd, s, wSize)                                     \
  ((WINBOOL)AVICapSM(hwnd, WM_CAP_GET_SEQUENCE_SETUP, (WPARAM)(wSize),         \
                     (LPARAM)(LPVOID)(LPCAPTUREPARMS)(s)))
#define capCaptureSetSetup(hwnd, s, wSize)                                     \
  ((WINBOOL)AVICapSM(hwnd, WM_CAP_SET_SEQUENCE_SETUP, (WPARAM)(wSize),         \
                     (LPARAM)(LPVOID)(LPCAPTUREPARMS)(s)))
#define capSetMCIDeviceName(hwnd, szName)                                      \
  ((WINBOOL)AVICapSM(hwnd, WM_CAP_SET_MCI_DEVICE, (WPARAM)0,                   \
                     (LPARAM)(LPVOID)(LPTSTR)(szName)))
#define capGetMCIDeviceName(hwnd, szName, wSize)                               \
  ((WINBOOL)AVICapSM(hwnd, WM_CAP_GET_MCI_DEVICE, (WPARAM)(wSize),             \
                     (LPARAM)(LPVOID)(LPTSTR)(szName)))
#define capPaletteOpen(hwnd, szName)                                           \
  ((WINBOOL)AVICapSM(hwnd, WM_CAP_PAL_OPEN, (WPARAM)0,                         \
                     (LPARAM)(LPVOID)(LPTSTR)(szName)))
#define capPaletteSave(hwnd, szName)                                           \
  ((WINBOOL)AVICapSM(hwnd, WM_CAP_PAL_SAVE, (WPARAM)0,                         \
                     (LPARAM)(LPVOID)(LPTSTR)(szName)))
#define capPalettePaste(hwnd)                                                  \
  ((WINBOOL)AVICapSM(hwnd, WM_CAP_PAL_PASTE, (WPARAM)0, (LPARAM)0))
#define capPaletteAuto(hwnd, iFrames, iColors)                                 \
  ((WINBOOL)AVICapSM(hwnd, WM_CAP_PAL_AUTOCREATE, (WPARAM)(iFrames),           \
                     (LPARAM)(DWORD)(iColors)))
#define capPaletteManual(hwnd, fGrab, iColors)                                 \
  ((WINBOOL)AVICapSM(hwnd, WM_CAP_PAL_MANUALCREATE, (WPARAM)(fGrab),           \
                     (LPARAM)(DWORD)(iColors)))
...
HWND WINAPI capCreateCaptureWindowA(LPCSTR lpszWindowName, DWORD dwStyle, int x,
                                    int y, int nWidth, int nHeight,
                                    HWND hwndParent, int nID);
WINBOOL WINAPI capGetDriverDescriptionA(UINT wDriverIndex, LPSTR lpszName,
                                        int cbName, LPSTR lpszVer, int cbVer);
HWND WINAPI capCreateCaptureWindowW(LPCWSTR lpszWindowName, DWORD dwStyle,
                                    int x, int y, int nWidth, int nHeight,
                                    HWND hwndParent, int nID);
WINBOOL WINAPI capGetDriverDescriptionW(UINT wDriverIndex, LPWSTR lpszName,
