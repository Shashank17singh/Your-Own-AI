...
public:
  ...
  virtual HRESULT WINAPI SetInputData(const DWORD dwType, const BYTE *pData,
                                      const UINT uSize) = 0;
  virtual HRESULT WINAPI GetResult(HRESULT *phr) = 0;
  virtual HRESULT WINAPI GetOutputData(const DWORD dwIndex, LPWSTR *ppszSchema,
                                       DWORD *pdwType, BYTE **ppData,
                                       ULONG *uSize) = 0;
...
typedef struct IBidiRequestVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IBidiRequest *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *SetInputData)(IBidiRequest *This, const DWORD dwType,
                                const BYTE *pData, const UINT uSize);
  HRESULT(WINAPI *GetResult)(IBidiRequest *This, HRESULT *phr);
  HRESULT(WINAPI *GetOutputData)(IBidiRequest *This, const DWORD dwIndex,
                                 LPWSTR *ppszSchema, DWORD *pdwType,
                                 BYTE **ppData, ULONG *uSize);
...
#endif
#endif
HRESULT WINAPI IBidiRequest_SetSchema_Proxy(IBidiRequest *This,
...
HRESULT WINAPI IBidiRequest_SetInputData_Proxy(IBidiRequest *This,
                                               const DWORD dwType,
                                               const BYTE *pData,
                                               const UINT uSize);
...
void __RPC_STUB IBidiRequest_GetResult_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBidiRequest_GetOutputData_Proxy(IBidiRequest *This,
                                                const DWORD dwIndex,
                                                LPWSTR *ppszSchema,
                                                DWORD *pdwType, BYTE **ppData,
                                                ULONG *uSize);
void __RPC_STUB IBidiRequest_GetOutputData_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBidiRequest_GetEnumCount_Proxy(IBidiRequest *This,
                                               DWORD *pdwTotal);
...
typedef struct IBidiRequestContainerVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IBidiRequestContainer *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IBidiRequestContainer *This);
  ULONG(WINAPI *Release)(IBidiRequestContainer *This);
  HRESULT(WINAPI *AddRequest)(IBidiRequestContainer *This,
                              IBidiRequest *pRequest);
  HRESULT(WINAPI *GetEnumObject)(IBidiRequestContainer *This,
                                 IEnumUnknown **ppenum);
...
#endif
HRESULT
    WINAPI IBidiRequestContainer_AddRequest_Proxy(IBidiRequestContainer *This,
                                                  IBidiRequest *pRequest);
void __RPC_STUB IBidiRequestContainer_AddRequest_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBidiRequestContainer_GetEnumObject_Proxy(
    IBidiRequestContainer *This, IEnumUnknown **ppenum);
void __RPC_STUB IBidiRequestContainer_GetEnumObject_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBidiRequestContainer_GetRequestCount_Proxy(
    IBidiRequestContainer *This, ULONG *puCount);
...
public:
  virtual HRESULT WINAPI BindDevice(const LPCWSTR pszDeviceName,
                                    const DWORD dwAccess) = 0;
  virtual HRESULT WINAPI UnbindDevice(void) = 0;
  virtual HRESULT WINAPI SendRecv(const LPCWSTR pszAction,
                                  IBidiRequest *pRequest) = 0;
  virtual HRESULT WINAPI MultiSendRecv(
      const LPCWSTR pszAction, IBidiRequestContainer *pRequestContainer) = 0;
};
#else
typedef struct IBidiSplVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IBidiSpl *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IBidiSpl *This);
  ULONG(WINAPI *Release)(IBidiSpl *This);
  HRESULT(WINAPI *BindDevice)(IBidiSpl *This, const LPCWSTR pszDeviceName,
                              const DWORD dwAccess);
  HRESULT(WINAPI *UnbindDevice)(IBidiSpl *This);
  HRESULT(WINAPI *SendRecv)(IBidiSpl *This, const LPCWSTR pszAction,
                            IBidiRequest *pRequest);
  HRESULT(WINAPI *MultiSendRecv)(IBidiSpl *This, const LPCWSTR pszAction,
...
#endif
#endif
HRESULT WINAPI IBidiSpl_BindDevice_Proxy(IBidiSpl *This,
                                         const LPCWSTR pszDeviceName,
                                         const DWORD dwAccess);
void __RPC_STUB IBidiSpl_BindDevice_Stub(IRpcStubBuffer *This,
...
void __RPC_STUB IBidiSpl_UnbindDevice_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBidiSpl_SendRecv_Proxy(IBidiSpl *This, const LPCWSTR pszAction,
                                       IBidiRequest *pRequest);
void __RPC_STUB IBidiSpl_SendRecv_Stub(IRpcStubBuffer *This,
                                       IRpcChannelBuffer *_pRpcChannelBuffer,
                                       PRPC_MESSAGE _pRpcMessage,
                                       DWORD *_pdwStubPhase);
HRESULT WINAPI
IBidiSpl_MultiSendRecv_Proxy(IBidiSpl *This, const LPCWSTR pszAction,
                             IBidiRequestContainer *pRequestContainer);
