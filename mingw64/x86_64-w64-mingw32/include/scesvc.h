 ...
 */
DEFINE_GUID(cNodetypeSceTemplateServices, 0x24a7f717, 0x1f0c, 0x11d1, 0xaf,
            0xfb, 0x0, 0xc0, 0x4f, 0xb9, 0x84, 0xf9);
DEFINE_GUID(cNodetypeSceAnalysisServices, 0x678050c7, 0x1ff8, 0x11d1, 0xaf,
            0xfb, 0x0, 0xc0, 0x4f, 0xb9, 0x84, 0xf9);
DEFINE_GUID(cNodetypeSceEventLog, 0x2ce06698, 0x4bf3, 0x11d1, 0x8c, 0x30, 0x0,
            0xc0, 0x4f, 0xb9, 0x84, 0xf9);
DEFINE_GUID(IID_ISceSvcAttachmentPersistInfo, 0x6d90e0d0, 0x200d, 0x11d1, 0xaf,
            0xfb, 0x0, 0xc0, 0x4f, 0xb9, 0x84, 0xf9);
DEFINE_GUID(IID_ISceSvcAttachmentData, 0x17c35fde, 0x200d, 0x11d1, 0xaf, 0xfb,
            0x0, 0xc0, 0x4f, 0xb9, 0x84, 0xf9);
#ifndef _scesvc_
#define _scesvc_
#ifdef __cplusplus
extern "C" {
...
typedef SCESTATUS(CALLBACK *PFSCE_QUERY_INFO)(
    SCE_HANDLE sceHandle, SCESVC_INFO_TYPE sceType, LPTSTR lpPrefix,
    WINBOOL bExact, PVOID *ppvInfo, PSCE_ENUMERATION_CONTEXT psceEnumHandle);
typedef SCESTATUS(CALLBACK *PFSCE_SET_INFO)(SCE_HANDLE sceHandle,
                                            SCESVC_INFO_TYPE sceType,
                                            LPTSTR lpPrefix, WINBOOL bExact,
                                            PVOID pvInfo);
...
typedef SCESTATUS(CALLBACK *PFSCE_LOG_INFO)(INT ErrLevel, DWORD Win32rc,
                                            LPTSTR pErrFmt, ...);
...
typedef SCESTATUS (*PF_UpdateService)(PSCESVC_CALLBACK_INFO pSceCbInfo,
                                      PSCESVC_CONFIGURATION_INFO ServiceInfo);
#ifdef __cplusplus
}
#endif
#endif
...
extern "C" {
#endif
#define struuidNodetypeSceTemplateServices                                     \
  "{24a7f717-1f0c-11d1-affb-00c04fb984f9}"
#define lstruuidNodetypeSceTemplateServices                                    \
  L"{24a7f717-1f0c-11d1-affb-00c04fb984f9}"
#define struuidNodetypeSceAnalysisServices                                     \
  "{678050c7-1ff8-11d1-affb-00c04fb984f9}"
#define lstruuidNodetypeSceAnalysisServices                                    \
  L"{678050c7-1ff8-11d1-affb-00c04fb984f9}"
...
public:
  virtual HRESULT WINAPI Save(LPTSTR lpTemplateName,
                              SCESVC_HANDLE *scesvcHandle, PVOID *ppvData,
                              PBOOL pbOverwriteAll) = 0;
...
typedef struct ISceSvcAttachmentPersistInfoVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ISceSvcAttachmentPersistInfo *This,
                                  REFIID riid, void **ppvObject);
  ULONG(WINAPI *AddRef)(ISceSvcAttachmentPersistInfo *This);
  ULONG(WINAPI *Release)(ISceSvcAttachmentPersistInfo *This);
  HRESULT(WINAPI *Save)(ISceSvcAttachmentPersistInfo *This,
                        LPTSTR lpTemplateName, SCESVC_HANDLE scesvcHandle,
                        PVOID *ppvData, PBOOL pbOverwriteAll);
  HRESULT(WINAPI *FreeBuffer)(ISceSvcAttachmentPersistInfo *This, PVOID pvData);
  HRESULT(WINAPI *IsDirty)(ISceSvcAttachmentPersistInfo *This,
...
#define ISceSvcAttachmentPersistInfo_Save(This, lpTemplateName, scesvcHandle,  \
...
public:
  virtual HRESULT WINAPI GetData(SCESVC_HANDLE scesvcHandle,
                                 SCESVC_INFO_TYPE sceType, PVOID *ppvData,
                                 PSCE_ENUMERATION_CONTEXT psceEnumHandle) = 0;
  virtual HRESULT WINAPI
  Initialize(LPCTSTR lpServiceName, LPCTSTR lpTemplateName,
             LPSCESVCATTACHMENTPERSISTINFO lpSceSvcPersistInfo,
             SCESVC_HANDLE *pscesvcHandle) = 0;
  virtual HRESULT WINAPI FreeBuffer(PVOID pvData) = 0;
...
typedef struct ISceSvcAttachmentDataVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ISceSvcAttachmentData *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ISceSvcAttachmentData *This);
  ULONG(WINAPI *Release)(ISceSvcAttachmentData *This);
  HRESULT(WINAPI *Initialize)(ISceSvcAttachmentData *This,
                              LPCTSTR lpServiceName, LPCTSTR lpTemplateName,
                              LPSCESVCATTACHMENTPERSISTINFO lpSceSvcPersistInfo,
                              SCESVC_HANDLE *pscesvcHandle);
  HRESULT(WINAPI *GetData)(ISceSvcAttachmentData *This,
                           SCESVC_HANDLE scesvcHandle, SCESVC_INFO_TYPE sceType,
                           PVOID *ppvData,
                           PSCE_ENUMERATION_CONTEXT psceEnumHandle);
  HRESULT(WINAPI *FreeBuffer)(ISceSvcAttachmentData *This, PVOID pvData);
  HRESULT(WINAPI *CloseHandle)(ISceSvcAttachmentData *This,
...
#define ISceSvcAttachmentData_Initialize(This, lpServiceName, lpTemplateName,  \
                                         lpSceSvcPersistInfo, pscesvcHandle)   \
  (This)->lpVtbl->Initialize(lpServiceName, lpTemplateName,                    \
                             lpSceSvcPersistInfo, pscesvcHandle)
#define ISceSvcAttachmentData_GetData(This, scesvcHandle, sceType, ppvData,    \
                                      psceEnumHandle)                          \
