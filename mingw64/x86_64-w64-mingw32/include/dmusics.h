 ...
 */
/* IIDs */
DEFINE_GUID(IID_IDirectMusicSynth, 0x09823661, 0x5c85, 0x11d2, 0xaf, 0xa6, 0x00,
...
DEFINE_GUID(IID_IDirectMusicSynthSink, 0x09823663, 0x5c85, 0x11d2, 0xaf, 0xa6,
...
DECLARE_INTERFACE_(IDirectMusicSynth, IUnknown) {
  ...
  STDMETHOD(PlayBuffer)(THIS_ REFERENCE_TIME rt, LPBYTE pbBuffer,
                        DWORD cbBuffer) PURE;
  ...
  STDMETHOD(GetFormat)(THIS_ LPWAVEFORMATEX pWaveFormatEx,
                       LPDWORD pdwWaveFormatExSiz) PURE;
...
#define IDirectMusicSynth_SetNumChannelGroups(p, a)                            \
...
#define IDirectMusicSynth_PlayBuffer(p, a, b, c)                               \
  (p)->lpVtbl->PlayBuffer(p, a, b, c)
#define IDirectMusicSynth_GetRunningStats(p, a)                                \
...
#define IDirectMusicSynth_GetLatencyClock(p, a)                                \
...
#define IDirectMusicSynth_SetChannelPriority(p, a, b, c)                       \
  (p)->lpVtbl->SetChannelPriority(p, a, b, c)
#define IDirectMusicSynth_GetChannelPriority(p, a, b, c)                       \
...
DECLARE_INTERFACE_(IDirectMusicSynth8, IDirectMusicSynth) {
  ...
  STDMETHOD(PlayVoice)(THIS_ REFERENCE_TIME rt, DWORD dwVoiceId,
                       DWORD dwChannelGroup, DWORD dwChannel, DWORD dwDLId,
                       LONG prPitch, LONG vrVolume, SAMPLE_TIME stVoiceStart,
                       SAMPLE_TIME stLoopStart, SAMPLE_TIME stLoopEnd) PURE;
  STDMETHOD(StopVoice)(THIS_ REFERENCE_TIME rt, DWORD dwVoiceId) PURE;
  STDMETHOD(GetVoiceState)(THIS_ DWORD dwVoice[], DWORD cbVoice,
                           DMUS_VOICE_STATE dwVoiceState[]) PURE;
  STDMETHOD(Refresh)(THIS_ DWORD dwDownloadID, DWORD dwFlags) PURE;
  STDMETHOD(AssignChannelToBuses)(THIS_ DWORD dwChannelGroup, DWORD dwChannel,
                                  LPDWORD pdwBuses, DWORD cBuses) PURE;
};
#undef INTERFACE
#if !defined(__cplusplus) || defined(CINTERFACE)
/*** IUnknown methods ***/
...
/*** IDirectMusicSynth8 methods ***/
#define IDirectMusicSynth8_PlayVoice(p, a, b, c, d, e, f, g, h, i, j)          \
  (p)->lpVtbl->PlayVoice(p, a, b, c, d, e, f, g, h, i, j)
#define IDirectMusicSynth8_StopVoice(p, a, b) (p)->lpVtbl->StopVoice(p, a, b)
#define IDirectMusicSynth8_GetVoiceState(p, a, b, c)                           \
  (p)->lpVtbl->GetVoiceState(p, a, b, c)
#define IDirectMusicSynth8_Refresh(p, a, b) (p)->lpVtbl->Refresh(p, a, b)
#define IDirectMusicSynth8_AssignChannelToBuses(p, a, b, c, d)                 \
...
#define IDirectMusicSynthSink_SetMasterClock(p, a)                             \
  (p)->lpVtbl->SetMasterClock(p, a)
#define IDirectMusicSynthSink_GetLatencyClock(p, a)                            \
  (p)->lpVtbl->GetLatencyClock(p, a)
#define IDirectMusicSynthSink_Activate(p, a) (p)->lpVtbl->Activate(p, a)
#define IDirectMusicSynthSink_SampleToRefTime(p, a, b)                         \
  (p)->lpVtbl->SampleToRefTime(p, a, b)
#define IDirectMusicSynthSink_RefTimeToSample(p, a, b)                         \
  (p)->lpVtbl->RefTimeToSample(p, a, b)
#define IDirectMusicSynthSink_SetDirectSound(p, a, b)                          \
  (p)->lpVtbl->SetDirectSound(p, a, b)
#define IDirectMusicSynthSink_GetDesiredBufferSize(p, a)                       \
  (p)->lpVtbl->GetDesiredBufferSize(p, a)
#endif
