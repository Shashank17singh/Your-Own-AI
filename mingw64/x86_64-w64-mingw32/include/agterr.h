...
#define AGENTPROVIDERERROR(x)                                                  \
  MAKE_SCODE(SEVERITY_ERROR, FACILITY_ITF, (x) + 0x2200)
#define AGENTVOICEERROR(x)                                                     \
  MAKE_SCODE(SEVERITY_ERROR, FACILITY_ITF, (x) + 0x2300)
#define AGENTAUDIOERROR(x)                                                     \
  MAKE_SCODE(SEVERITY_ERROR, FACILITY_ITF, (x) + 0x2400)
...
#define IS_INTERRUPT_ERROR(hRes)                                               \
  ((hRes >= AGENTREQERR_INTERRUPTEDLISTENKEY) &&                               \
