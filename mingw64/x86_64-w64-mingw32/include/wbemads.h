...
DEFINE_GUID(LIBID_WMIEXTENSIONLib, 0xe503d000, 0x5c7f, 0x11d2, 0x8b, 0x74, 0x00,
            0x10, 0x4b, 0x2a, 0xfb, 0x41);
#ifndef __IWMIExtension_FWD_DEFINED__
#define __IWMIExtension_FWD_DEFINED__
typedef interface IWMIExtension IWMIExtension;
#ifdef __cplusplus
 ...
 */
DEFINE_GUID(CLSID_WMIExtension, 0xf0975afe, 0x5c7f, 0x11d2, 0x8b, 0x74, 0x00,
            0x10, 0x4b, 0x2a, 0xfb, 0x41);
#ifdef __cplusplus
class DECLSPEC_UUID("f0975afe-5c7f-11d2-8b74-00104b2afb41") WMIExtension;
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(WMIExtension, 0xf0975afe, 0x5c7f, 0x11d2, 0x8b, 0x74, 0x00,
                0x10, 0x4b, 0x2a, 0xfb, 0x41)
#endif
#endif
...
DEFINE_GUID(IID_IWMIExtension, 0xadc1f06e, 0x5c7e, 0x11d2, 0x8b, 0x74, 0x00,
            0x10, 0x4b, 0x2a, 0xfb, 0x41);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("adc1f06e-5c7e-11d2-8b74-00104b2afb41")
IWMIExtension : public IDispatch {
  virtual HRESULT STDMETHODCALLTYPE get_WMIObjectPath(BSTR *
                                                      strWMIObjectPath) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetWMIObject(ISWbemObject *
                                                 *objWMIObject) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetWMIServices(ISWbemServices *
                                                   *objWMIServices) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IWMIExtension, 0xadc1f06e, 0x5c7e, 0x11d2, 0x8b, 0x74, 0x00,
                0x10, 0x4b, 0x2a, 0xfb, 0x41)
#endif
#else
typedef struct IWMIExtensionVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWMIExtension *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IWMIExtension *This);
  ULONG(STDMETHODCALLTYPE *Release)(IWMIExtension *This);
  /*** IDispatch methods ***/
  HRESULT(STDMETHODCALLTYPE *GetTypeInfoCount)(IWMIExtension *This,
                                               UINT *pctinfo);
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(IWMIExtension *This, UINT iTInfo,
                                          LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(IWMIExtension *This, REFIID riid,
                                            LPOLESTR *rgszNames, UINT cNames,
                                            LCID lcid, DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(IWMIExtension *This, DISPID dispIdMember,
                                     REFIID riid, LCID lcid, WORD wFlags,
                                     DISPPARAMS *pDispParams,
                                     VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                                     UINT *puArgErr);
  /*** IWMIExtension methods ***/
  HRESULT(STDMETHODCALLTYPE *get_WMIObjectPath)(IWMIExtension *This,
                                                BSTR *strWMIObjectPath);
  HRESULT(STDMETHODCALLTYPE *GetWMIObject)(IWMIExtension *This,
                                           ISWbemObject **objWMIObject);
  HRESULT(STDMETHODCALLTYPE *GetWMIServices)(IWMIExtension *This,
                                             ISWbemServices **objWMIServices);
  END_INTERFACE
} IWMIExtensionVtbl;
interface IWMIExtension { CONST_VTBL IWMIExtensionVtbl *lpVtbl; };
#ifdef COBJMACROS
...
#define IWMIExtension_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,       \
                                    rgDispId)                                  \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IWMIExtension_Invoke(This, dispIdMember, riid, lcid, wFlags,           \
...
#else
/*** IUnknown methods ***/
static inline HRESULT IWMIExtension_QueryInterface(IWMIExtension *This,
                                                   REFIID riid,
                                                   void **ppvObject) {
...
/*** IDispatch methods ***/
static inline HRESULT IWMIExtension_GetTypeInfoCount(IWMIExtension *This,
                                                     UINT *pctinfo) {
  return This->lpVtbl->GetTypeInfoCount(This, pctinfo);
}
static inline HRESULT IWMIExtension_GetTypeInfo(IWMIExtension *This,
                                                UINT iTInfo, LCID lcid,
                                                ITypeInfo **ppTInfo) {
  return This->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo);
}
static inline HRESULT IWMIExtension_GetIDsOfNames(IWMIExtension *This,
                                                  REFIID riid,
                                                  LPOLESTR *rgszNames,
...
IWMIExtension_Invoke(IWMIExtension *This, DISPID dispIdMember, REFIID riid,
...
/*** IWMIExtension methods ***/
static inline HRESULT IWMIExtension_get_WMIObjectPath(IWMIExtension *This,
                                                      BSTR *strWMIObjectPath) {
  return This->lpVtbl->get_WMIObjectPath(This, strWMIObjectPath);
}
static inline HRESULT IWMIExtension_GetWMIObject(IWMIExtension *This,
                                                 ISWbemObject **objWMIObject) {
  return This->lpVtbl->GetWMIObject(This, objWMIObject);
}
static inline HRESULT
IWMIExtension_GetWMIServices(IWMIExtension *This,
                             ISWbemServices **objWMIServices) {
