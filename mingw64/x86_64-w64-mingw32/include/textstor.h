...
#define TS_AS_ALL_SINKS                                                        \
  ((((TS_AS_TEXT_CHANGE | TS_AS_SEL_CHANGE) | TS_AS_LAYOUT_CHANGE) |           \
    TS_AS_ATTR_CHANGE) |                                                       \
   TS_AS_STATUS_CHANGE)
...
DEFINE_GUID(IID_ITextStoreACPSink, 0x22d44c94, 0xa419, 0x4542, 0xa2, 0x72, 0xae,
            0x26, 0x09, 0x3e, 0xce, 0xcf);
...
ITextStoreACPSink : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE OnTextChange(
      DWORD dwFlags, const TS_TEXTCHANGE *pChange) = 0;
  virtual HRESULT STDMETHODCALLTYPE OnSelectionChange() = 0;
  virtual HRESULT STDMETHODCALLTYPE OnLayoutChange(TsLayoutCode lcode,
  ...
  virtual HRESULT STDMETHODCALLTYPE OnAttrsChange(
      LONG acpStart, LONG acpEnd, ULONG cAttrs, const TS_ATTRID *paAttrs) = 0;
  virtual HRESULT STDMETHODCALLTYPE OnLockGranted(DWORD dwLockFlags) = 0;
  virtual HRESULT STDMETHODCALLTYPE OnStartEditTransaction() = 0;
  virtual HRESULT STDMETHODCALLTYPE OnEndEditTransaction() = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ITextStoreACPSink, 0x22d44c94, 0xa419, 0x4542, 0xa2, 0x72, 0xae,
                0x26, 0x09, 0x3e, 0xce, 0xcf)
#endif
#else
typedef struct ITextStoreACPSinkVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ITextStoreACPSink *This,
  ...
  HRESULT(STDMETHODCALLTYPE *OnTextChange)(ITextStoreACPSink *This,
                                           DWORD dwFlags,
                                           const TS_TEXTCHANGE *pChange);
  HRESULT(STDMETHODCALLTYPE *OnSelectionChange)(ITextStoreACPSink *This);
  HRESULT(STDMETHODCALLTYPE *OnLayoutChange)(ITextStoreACPSink *This,
                                             TsLayoutCode lcode,
                                             TsViewCookie vcView);
  HRESULT(STDMETHODCALLTYPE *OnStatusChange)(ITextStoreACPSink *This,
                                             DWORD dwFlags);
  HRESULT(STDMETHODCALLTYPE *OnAttrsChange)(ITextStoreACPSink *This,
                                            LONG acpStart, LONG acpEnd,
                                            ULONG cAttrs,
                                            const TS_ATTRID *paAttrs);
  HRESULT(STDMETHODCALLTYPE *OnLockGranted)(ITextStoreACPSink *This,
                                            DWORD dwLockFlags);
...
interface ITextStoreACPSink { CONST_VTBL ITextStoreACPSinkVtbl *lpVtbl; };
#ifdef COBJMACROS
...
#define ITextStoreACPSink_OnAttrsChange(This, acpStart, acpEnd, cAttrs,        \
                                        paAttrs)                               \
...
#else
/*** IUnknown methods ***/
static inline HRESULT ITextStoreACPSink_QueryInterface(ITextStoreACPSink *This,
                                                       REFIID riid,
                                                       void **ppvObject) {
...
ITextStoreACPSink_OnTextChange(ITextStoreACPSink *This, DWORD dwFlags,
                               const TS_TEXTCHANGE *pChange) {
  return This->lpVtbl->OnTextChange(This, dwFlags, pChange);
}
static inline HRESULT
ITextStoreACPSink_OnSelectionChange(ITextStoreACPSink *This) {
  return This->lpVtbl->OnSelectionChange(This);
}
static inline HRESULT ITextStoreACPSink_OnLayoutChange(ITextStoreACPSink *This,
                                                       TsLayoutCode lcode,
                                                       TsViewCookie vcView) {
  return This->lpVtbl->OnLayoutChange(This, lcode, vcView);
}
static inline HRESULT ITextStoreACPSink_OnStatusChange(ITextStoreACPSink *This,
                                                       DWORD dwFlags) {
  return This->lpVtbl->OnStatusChange(This, dwFlags);
}
static inline HRESULT
ITextStoreACPSink_OnAttrsChange(ITextStoreACPSink *This, LONG acpStart,
                                LONG acpEnd, ULONG cAttrs,
                                const TS_ATTRID *paAttrs) {
  return This->lpVtbl->OnAttrsChange(This, acpStart, acpEnd, cAttrs, paAttrs);
}
static inline HRESULT ITextStoreACPSink_OnLockGranted(ITextStoreACPSink *This,
                                                      DWORD dwLockFlags) {
  return This->lpVtbl->OnLockGranted(This, dwLockFlags);
}
static inline HRESULT
ITextStoreACPSink_OnStartEditTransaction(ITextStoreACPSink *This) {
  return This->lpVtbl->OnStartEditTransaction(This);
}
static inline HRESULT
ITextStoreACPSink_OnEndEditTransaction(ITextStoreACPSink *This) {
...
DEFINE_GUID(IID_ITextStoreACP, 0x28888fe3, 0xc2a0, 0x483a, 0xa3, 0xea, 0x8c,
            0xb1, 0xce, 0x51, 0xff, 0x3d);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
ITextStoreACP : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE AdviseSink(REFIID riid, IUnknown * punk,
                                               DWORD dwMask) = 0;
  virtual HRESULT STDMETHODCALLTYPE UnadviseSink(IUnknown * punk) = 0;
  virtual HRESULT STDMETHODCALLTYPE RequestLock(DWORD dwLockFlags,
                                                HRESULT * phrSession) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetStatus(TS_STATUS * pdcs) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetSelection(ULONG ulIndex, ULONG ulCount,
                                                 TS_SELECTION_ACP * pSelection,
                                                 ULONG * pcFetched) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetSelection(
      ULONG ulCount, const TS_SELECTION_ACP *pSelection) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetText(
      ...
      ULONG * pcRunInfoRet, LONG * pacpNext) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetText(
      DWORD dwFlags, LONG acpStart, LONG acpEnd, const WCHAR *pchText,
      ULONG cch, TS_TEXTCHANGE *pChange) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetFormattedText(
      LONG acpStart, LONG acpEnd, IDataObject * *ppDataObject) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetEmbedded(
      LONG acpPos, REFGUID rguidService, REFIID riid, IUnknown * *ppunk) = 0;
  virtual HRESULT STDMETHODCALLTYPE QueryInsertEmbedded(
      const GUID *pguidService, const FORMATETC *pFormatEtc,
  ...
  virtual HRESULT STDMETHODCALLTYPE InsertTextAtSelection(
      ...
      LONG *pacpEnd, TS_TEXTCHANGE *pChange) = 0;
  virtual HRESULT STDMETHODCALLTYPE InsertEmbeddedAtSelection(
      DWORD dwFlags, IDataObject * pDataObject, LONG * pacpStart,
      LONG * pacpEnd, TS_TEXTCHANGE * pChange) = 0;
  virtual HRESULT STDMETHODCALLTYPE RequestSupportedAttrs(
      DWORD dwFlags, ULONG cFilterAttrs, const TS_ATTRID *paFilterAttrs) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE FindNextAttrTransition(
      ...
      WINBOOL *pfFound, LONG *plFoundOffset) = 0;
  virtual HRESULT STDMETHODCALLTYPE RetrieveRequestedAttrs(
      ULONG ulCount, TS_ATTRVAL * paAttrVals, ULONG * pcFetched) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetEndACP(LONG * pacp) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetActiveView(TsViewCookie * pvcView) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetTextExt(
      ...
      WINBOOL * pfClipped) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetScreenExt(TsViewCookie vcView,
                                                 RECT * prc) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetWnd(TsViewCookie vcView,
                                           HWND * phwnd) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ITextStoreACP, 0x28888fe3, 0xc2a0, 0x483a, 0xa3, 0xea, 0x8c,
                0xb1, 0xce, 0x51, 0xff, 0x3d)
#endif
#else
typedef struct ITextStoreACPVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ITextStoreACP *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(ITextStoreACP *This);
  ULONG(STDMETHODCALLTYPE *Release)(ITextStoreACP *This);
  /*** ITextStoreACP methods ***/
  HRESULT(STDMETHODCALLTYPE *AdviseSink)(ITextStoreACP *This, REFIID riid,
                                         IUnknown *punk, DWORD dwMask);
  HRESULT(STDMETHODCALLTYPE *UnadviseSink)(ITextStoreACP *This, IUnknown *punk);
  HRESULT(STDMETHODCALLTYPE *RequestLock)(ITextStoreACP *This,
                                          DWORD dwLockFlags,
                                          HRESULT *phrSession);
  HRESULT(STDMETHODCALLTYPE *GetStatus)(ITextStoreACP *This, TS_STATUS *pdcs);
  HRESULT(STDMETHODCALLTYPE *QueryInsert)(ITextStoreACP *This,
                                          LONG acpTestStart, LONG acpTestEnd,
                                          ULONG cch, LONG *pacpResultStart,
                                          LONG *pacpResultEnd);
  HRESULT(STDMETHODCALLTYPE *GetSelection)(ITextStoreACP *This, ULONG ulIndex,
                                           ULONG ulCount,
                                           TS_SELECTION_ACP *pSelection,
                                           ULONG *pcFetched);
  HRESULT(STDMETHODCALLTYPE *SetSelection)(ITextStoreACP *This, ULONG ulCount,
                                           const TS_SELECTION_ACP *pSelection);
  HRESULT(STDMETHODCALLTYPE *GetText)(ITextStoreACP *This, LONG acpStart,
                                      LONG acpEnd, WCHAR *pchPlain,
                                      ULONG cchPlainReq, ULONG *pcchPlainRet,
                                      TS_RUNINFO *prgRunInfo, ULONG cRunInfoReq,
                                      ULONG *pcRunInfoRet, LONG *pacpNext);
  HRESULT(STDMETHODCALLTYPE *SetText)(ITextStoreACP *This, DWORD dwFlags,
                                      LONG acpStart, LONG acpEnd,
                                      const WCHAR *pchText, ULONG cch,
                                      TS_TEXTCHANGE *pChange);
  HRESULT(STDMETHODCALLTYPE *GetFormattedText)(ITextStoreACP *This,
                                               LONG acpStart, LONG acpEnd,
                                               IDataObject **ppDataObject);
  HRESULT(STDMETHODCALLTYPE *GetEmbedded)(ITextStoreACP *This, LONG acpPos,
                                          REFGUID rguidService, REFIID riid,
                                          IUnknown **ppunk);
  HRESULT(STDMETHODCALLTYPE *QueryInsertEmbedded)(ITextStoreACP *This,
                                                  const GUID *pguidService,
                                                  const FORMATETC *pFormatEtc,
                                                  WINBOOL *pfInsertable);
  HRESULT(STDMETHODCALLTYPE *InsertEmbedded)(ITextStoreACP *This, DWORD dwFlags,
                                             LONG acpStart, LONG acpEnd,
                                             IDataObject *pDataObject,
                                             TS_TEXTCHANGE *pChange);
  HRESULT(STDMETHODCALLTYPE *InsertTextAtSelection)(
      ITextStoreACP *This, DWORD dwFlags, const WCHAR *pchText, ULONG cch,
      LONG *pacpStart, LONG *pacpEnd, TS_TEXTCHANGE *pChange);
  HRESULT(STDMETHODCALLTYPE *InsertEmbeddedAtSelection)(
      ITextStoreACP *This, DWORD dwFlags, IDataObject *pDataObject,
      LONG *pacpStart, LONG *pacpEnd, TS_TEXTCHANGE *pChange);
  HRESULT(STDMETHODCALLTYPE *RequestSupportedAttrs)(
      ITextStoreACP *This, DWORD dwFlags, ULONG cFilterAttrs,
      const TS_ATTRID *paFilterAttrs);
  HRESULT(STDMETHODCALLTYPE *RequestAttrsAtPosition)(
      ITextStoreACP *This, LONG acpPos, ULONG cFilterAttrs,
  ...
  HRESULT(STDMETHODCALLTYPE *FindNextAttrTransition)(
      ITextStoreACP *This, LONG acpStart, LONG acpHalt, ULONG cFilterAttrs,
      const TS_ATTRID *paFilterAttrs, DWORD dwFlags, LONG *pacpNext,
      WINBOOL *pfFound, LONG *plFoundOffset);
  HRESULT(STDMETHODCALLTYPE *RetrieveRequestedAttrs)(ITextStoreACP *This,
                                                     ULONG ulCount,
                                                     TS_ATTRVAL *paAttrVals,
                                                     ULONG *pcFetched);
  HRESULT(STDMETHODCALLTYPE *GetEndACP)(ITextStoreACP *This, LONG *pacp);
  HRESULT(STDMETHODCALLTYPE *GetActiveView)(ITextStoreACP *This,
                                            TsViewCookie *pvcView);
  HRESULT(STDMETHODCALLTYPE *GetACPFromPoint)(ITextStoreACP *This,
                                              TsViewCookie vcView,
                                              const POINT *ptScreen,
                                              DWORD dwFlags, LONG *pacp);
  HRESULT(STDMETHODCALLTYPE *GetTextExt)(ITextStoreACP *This,
                                         TsViewCookie vcView, LONG acpStart,
                                         LONG acpEnd, RECT *prc,
                                         WINBOOL *pfClipped);
  HRESULT(STDMETHODCALLTYPE *GetScreenExt)(ITextStoreACP *This,
                                           TsViewCookie vcView, RECT *prc);
  HRESULT(STDMETHODCALLTYPE *GetWnd)(ITextStoreACP *This, TsViewCookie vcView,
                                     HWND *phwnd);
  END_INTERFACE
} ITextStoreACPVtbl;
interface ITextStoreACP { CONST_VTBL ITextStoreACPVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define ITextStoreACP_QueryInsert(This, acpTestStart, acpTestEnd, cch,         \
                                  pacpResultStart, pacpResultEnd)              \
  (This)->lpVtbl->QueryInsert(This, acpTestStart, acpTestEnd, cch,             \
                              pacpResultStart, pacpResultEnd)
#define ITextStoreACP_GetSelection(This, ulIndex, ulCount, pSelection,         \
                                   pcFetched)                                  \
...
#define ITextStoreACP_GetText(This, acpStart, acpEnd, pchPlain, cchPlainReq,   \
                              pcchPlainRet, prgRunInfo, cRunInfoReq,           \
                              pcRunInfoRet, pacpNext)                          \
  (This)->lpVtbl->GetText(This, acpStart, acpEnd, pchPlain, cchPlainReq,       \
                          pcchPlainRet, prgRunInfo, cRunInfoReq, pcRunInfoRet, \
                          pacpNext)
#define ITextStoreACP_SetText(This, dwFlags, acpStart, acpEnd, pchText, cch,   \
                              pChange)                                         \
  (This)->lpVtbl->SetText(This, dwFlags, acpStart, acpEnd, pchText, cch,       \
                          pChange)
...
#define ITextStoreACP_QueryInsertEmbedded(This, pguidService, pFormatEtc,      \
                                          pfInsertable)                        \
  (This)->lpVtbl->QueryInsertEmbedded(This, pguidService, pFormatEtc,          \
                                      pfInsertable)
#define ITextStoreACP_InsertEmbedded(This, dwFlags, acpStart, acpEnd,          \
                                     pDataObject, pChange)                     \
  (This)->lpVtbl->InsertEmbedded(This, dwFlags, acpStart, acpEnd, pDataObject, \
                                 pChange)
#define ITextStoreACP_InsertTextAtSelection(This, dwFlags, pchText, cch,       \
                                            pacpStart, pacpEnd, pChange)       \
  (This)->lpVtbl->InsertTextAtSelection(This, dwFlags, pchText, cch,           \
                                        pacpStart, pacpEnd, pChange)
#define ITextStoreACP_InsertEmbeddedAtSelection(This, dwFlags, pDataObject,    \
                                                pacpStart, pacpEnd, pChange)   \
  (This)->lpVtbl->InsertEmbeddedAtSelection(This, dwFlags, pDataObject,        \
                                            pacpStart, pacpEnd, pChange)
#define ITextStoreACP_RequestSupportedAttrs(This, dwFlags, cFilterAttrs,       \
                                            paFilterAttrs)                     \
  (This)->lpVtbl->RequestSupportedAttrs(This, dwFlags, cFilterAttrs,           \
                                        paFilterAttrs)
#define ITextStoreACP_RequestAttrsAtPosition(This, acpPos, cFilterAttrs,       \
                                             paFilterAttrs, dwFlags)           \
  (This)->lpVtbl->RequestAttrsAtPosition(This, acpPos, cFilterAttrs,           \
                                         paFilterAttrs, dwFlags)
#define ITextStoreACP_RequestAttrsTransitioningAtPosition(                     \
    This, acpPos, cFilterAttrs, paFilterAttrs, dwFlags)                        \
  (This)->lpVtbl->RequestAttrsTransitioningAtPosition(                         \
      This, acpPos, cFilterAttrs, paFilterAttrs, dwFlags)
#define ITextStoreACP_FindNextAttrTransition(                                  \
    This, acpStart, acpHalt, cFilterAttrs, paFilterAttrs, dwFlags, pacpNext,   \
    pfFound, plFoundOffset)                                                    \
  (This)->lpVtbl->FindNextAttrTransition(This, acpStart, acpHalt,              \
                                         cFilterAttrs, paFilterAttrs, dwFlags, \
                                         pacpNext, pfFound, plFoundOffset)
#define ITextStoreACP_RetrieveRequestedAttrs(This, ulCount, paAttrVals,        \
                                             pcFetched)                        \
...
#define ITextStoreACP_GetTextExt(This, vcView, acpStart, acpEnd, prc,          \
                                 pfClipped)                                    \
...
#else
/*** IUnknown methods ***/
static inline HRESULT ITextStoreACP_QueryInterface(ITextStoreACP *This,
                                                   REFIID riid,
                                                   void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ITextStoreACP methods ***/
static inline HRESULT ITextStoreACP_AdviseSink(ITextStoreACP *This, REFIID riid,
                                               IUnknown *punk, DWORD dwMask) {
  return This->lpVtbl->AdviseSink(This, riid, punk, dwMask);
}
static inline HRESULT ITextStoreACP_UnadviseSink(ITextStoreACP *This,
                                                 IUnknown *punk) {
  return This->lpVtbl->UnadviseSink(This, punk);
}
static inline HRESULT ITextStoreACP_RequestLock(ITextStoreACP *This,
                                                DWORD dwLockFlags,
                                                HRESULT *phrSession) {
  return This->lpVtbl->RequestLock(This, dwLockFlags, phrSession);
}
static inline HRESULT ITextStoreACP_GetStatus(ITextStoreACP *This,
                                              TS_STATUS *pdcs) {
  return This->lpVtbl->GetStatus(This, pdcs);
}
static inline HRESULT ITextStoreACP_QueryInsert(ITextStoreACP *This,
                                                LONG acpTestStart,
                                                LONG acpTestEnd, ULONG cch,
                                                LONG *pacpResultStart,
                                                LONG *pacpResultEnd) {
  return This->lpVtbl->QueryInsert(This, acpTestStart, acpTestEnd, cch,
                                   pacpResultStart, pacpResultEnd);
}
static inline HRESULT ITextStoreACP_GetSelection(ITextStoreACP *This,
                                                 ULONG ulIndex, ULONG ulCount,
                                                 TS_SELECTION_ACP *pSelection,
                                                 ULONG *pcFetched) {
  return This->lpVtbl->GetSelection(This, ulIndex, ulCount, pSelection,
                                    pcFetched);
}
static inline HRESULT
ITextStoreACP_SetSelection(ITextStoreACP *This, ULONG ulCount,
                           const TS_SELECTION_ACP *pSelection) {
  return This->lpVtbl->SetSelection(This, ulCount, pSelection);
}
static inline HRESULT
ITextStoreACP_GetText(ITextStoreACP *This, LONG acpStart, LONG acpEnd,
                      WCHAR *pchPlain, ULONG cchPlainReq, ULONG *pcchPlainRet,
                      TS_RUNINFO *prgRunInfo, ULONG cRunInfoReq,
                      ULONG *pcRunInfoRet, LONG *pacpNext) {
  return This->lpVtbl->GetText(This, acpStart, acpEnd, pchPlain, cchPlainReq,
                               pcchPlainRet, prgRunInfo, cRunInfoReq,
                               pcRunInfoRet, pacpNext);
}
static inline HRESULT ITextStoreACP_SetText(ITextStoreACP *This, DWORD dwFlags,
                                            LONG acpStart, LONG acpEnd,
                                            const WCHAR *pchText, ULONG cch,
                                            TS_TEXTCHANGE *pChange) {
  return This->lpVtbl->SetText(This, dwFlags, acpStart, acpEnd, pchText, cch,
                               pChange);
}
static inline HRESULT
ITextStoreACP_GetFormattedText(ITextStoreACP *This, LONG acpStart, LONG acpEnd,
                               IDataObject **ppDataObject) {
  return This->lpVtbl->GetFormattedText(This, acpStart, acpEnd, ppDataObject);
}
static inline HRESULT ITextStoreACP_GetEmbedded(ITextStoreACP *This,
                                                LONG acpPos,
...
static inline HRESULT
ITextStoreACP_QueryInsertEmbedded(ITextStoreACP *This, const GUID *pguidService,
                                  const FORMATETC *pFormatEtc,
                                  WINBOOL *pfInsertable) {
  return This->lpVtbl->QueryInsertEmbedded(This, pguidService, pFormatEtc,
                                           pfInsertable);
}
static inline HRESULT ITextStoreACP_InsertEmbedded(ITextStoreACP *This,
                                                   DWORD dwFlags, LONG acpStart,
                                                   LONG acpEnd,
                                                   IDataObject *pDataObject,
                                                   TS_TEXTCHANGE *pChange) {
  return This->lpVtbl->InsertEmbedded(This, dwFlags, acpStart, acpEnd,
                                      pDataObject, pChange);
}
static inline HRESULT ITextStoreACP_InsertTextAtSelection(
    ITextStoreACP *This, DWORD dwFlags, const WCHAR *pchText, ULONG cch,
    LONG *pacpStart, LONG *pacpEnd, TS_TEXTCHANGE *pChange) {
  return This->lpVtbl->InsertTextAtSelection(This, dwFlags, pchText, cch,
                                             pacpStart, pacpEnd, pChange);
}
static inline HRESULT ITextStoreACP_InsertEmbeddedAtSelection(
    ITextStoreACP *This, DWORD dwFlags, IDataObject *pDataObject,
    LONG *pacpStart, LONG *pacpEnd, TS_TEXTCHANGE *pChange) {
  return This->lpVtbl->InsertEmbeddedAtSelection(This, dwFlags, pDataObject,
                                                 pacpStart, pacpEnd, pChange);
}
static inline HRESULT
ITextStoreACP_RequestSupportedAttrs(ITextStoreACP *This, DWORD dwFlags,
                                    ULONG cFilterAttrs,
                                    const TS_ATTRID *paFilterAttrs) {
  return This->lpVtbl->RequestSupportedAttrs(This, dwFlags, cFilterAttrs,
                                             paFilterAttrs);
}
static inline HRESULT ITextStoreACP_RequestAttrsAtPosition(
    ITextStoreACP *This, LONG acpPos, ULONG cFilterAttrs,
    const TS_ATTRID *paFilterAttrs, DWORD dwFlags) {
  return This->lpVtbl->RequestAttrsAtPosition(This, acpPos, cFilterAttrs,
                                              paFilterAttrs, dwFlags);
}
static inline HRESULT ITextStoreACP_RequestAttrsTransitioningAtPosition(
    ITextStoreACP *This, LONG acpPos, ULONG cFilterAttrs,
    const TS_ATTRID *paFilterAttrs, DWORD dwFlags) {
  return This->lpVtbl->RequestAttrsTransitioningAtPosition(
      This, acpPos, cFilterAttrs, paFilterAttrs, dwFlags);
}
static inline HRESULT ITextStoreACP_FindNextAttrTransition(
    ITextStoreACP *This, LONG acpStart, LONG acpHalt, ULONG cFilterAttrs,
    const TS_ATTRID *paFilterAttrs, DWORD dwFlags, LONG *pacpNext,
    WINBOOL *pfFound, LONG *plFoundOffset) {
  return This->lpVtbl->FindNextAttrTransition(
      This, acpStart, acpHalt, cFilterAttrs, paFilterAttrs, dwFlags, pacpNext,
      pfFound, plFoundOffset);
}
static inline HRESULT
ITextStoreACP_RetrieveRequestedAttrs(ITextStoreACP *This, ULONG ulCount,
                                     TS_ATTRVAL *paAttrVals, ULONG *pcFetched) {
  return This->lpVtbl->RetrieveRequestedAttrs(This, ulCount, paAttrVals,
                                              pcFetched);
}
static inline HRESULT ITextStoreACP_GetEndACP(ITextStoreACP *This, LONG *pacp) {
  return This->lpVtbl->GetEndACP(This, pacp);
}
static inline HRESULT ITextStoreACP_GetActiveView(ITextStoreACP *This,
                                                  TsViewCookie *pvcView) {
  return This->lpVtbl->GetActiveView(This, pvcView);
}
static inline HRESULT ITextStoreACP_GetACPFromPoint(ITextStoreACP *This,
                                                    TsViewCookie vcView,
                                                    const POINT *ptScreen,
                                                    DWORD dwFlags, LONG *pacp) {
  return This->lpVtbl->GetACPFromPoint(This, vcView, ptScreen, dwFlags, pacp);
}
static inline HRESULT ITextStoreACP_GetTextExt(ITextStoreACP *This,
                                               TsViewCookie vcView,
                                               LONG acpStart, LONG acpEnd,
                                               RECT *prc, WINBOOL *pfClipped) {
  return This->lpVtbl->GetTextExt(This, vcView, acpStart, acpEnd, prc,
                                  pfClipped);
}
static inline HRESULT ITextStoreACP_GetScreenExt(ITextStoreACP *This,
                                                 TsViewCookie vcView,
                                                 RECT *prc) {
  return This->lpVtbl->GetScreenExt(This, vcView, prc);
}
static inline HRESULT ITextStoreACP_GetWnd(ITextStoreACP *This,
