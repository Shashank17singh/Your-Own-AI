...
#define WU_S_METADATA_IGNORED_SIGNATURE_VERIFICATION                           \
  _HRESULT_TYPEDEF_(0x00247102)
...
#define WU_E_IDLESHUTDOWN_OPCOUNT_SERVICEREGISTRATION                          \
  _HRESULT_TYPEDEF_(0x80240060)
...
#define WU_E_REDIRECTOR_ATTRPROVIDER_EXCEEDED_MAX_NAMEVALUE                    \
  _HRESULT_TYPEDEF_(0x80245008)
...
#define WU_E_SIH_POST_REBOOT_NO_CACHED_SLS_RESPONSE                            \
  _HRESULT_TYPEDEF_(0x8024510A)
...
#define WU_E_METADATA_CONFIG_INVALID_BINARY_ENCODING                           \
  _HRESULT_TYPEDEF_(0x80247101)
...
#define WU_E_METADATA_FAILURE_PROCESSING_FRAGMENTSIGNING_CONFIG                \
  _HRESULT_TYPEDEF_(0x80247108)
...
#define WU_E_METADATATRUST_CERTIFICATECHAIN_VERIFICATION                       \
  _HRESULT_TYPEDEF_(0x80247150)
#define WU_E_METADATATRUST_UNTRUSTED_CERTIFICATECHAIN                          \
  _HRESULT_TYPEDEF_(0x80247151)
#define WU_E_METADATA_TIMESTAMP_TOKEN_MISSING _HRESULT_TYPEDEF_(0x80247160)
#define WU_E_METADATA_TIMESTAMP_TOKEN_VERIFICATION_FAILED                      \
  _HRESULT_TYPEDEF_(0x80247161)
#define WU_E_METADATA_TIMESTAMP_TOKEN_UNTRUSTED _HRESULT_TYPEDEF_(0x80247162)
#define WU_E_METADATA_TIMESTAMP_TOKEN_VALIDITY_WINDOW                          \
  _HRESULT_TYPEDEF_(0x80247163)
...
#define WU_E_METADATA_TIMESTAMP_TOKEN_REFRESHONLINE                            \
  _HRESULT_TYPEDEF_(0x80247166)
...
#define WU_E_METADATA_TIMESTAMP_TOKEN_VALIDITYWINDOW_UNEXPECTED                \
  _HRESULT_TYPEDEF_(0x8024717E)
...
#define WU_E_METADATA_LEAFCERT_BAD_TRANSPORT_ENCODING                          \
  _HRESULT_TYPEDEF_(0x80247181)
#define WU_E_METADATA_INTCERT_BAD_TRANSPORT_ENCODING                           \
  _HRESULT_TYPEDEF_(0x80247182)
