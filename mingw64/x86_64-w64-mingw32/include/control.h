...
IMediaControl : public IDispatch {
  ...
  virtual HRESULT STDMETHODCALLTYPE GetState(LONG msTimeout,
                                             OAFilterState * pfs) = 0;
  virtual HRESULT STDMETHODCALLTYPE RenderFile(BSTR strFilename) = 0;
  virtual HRESULT STDMETHODCALLTYPE AddSourceFilter(BSTR strFilename,
                                                    IDispatch * *ppUnk) = 0;
  virtual HRESULT STDMETHODCALLTYPE get_FilterCollection(IDispatch *
                                                         *ppUnk) = 0;
  virtual HRESULT STDMETHODCALLTYPE get_RegFilterCollection(IDispatch *
                                                            *ppUnk) = 0;
  virtual HRESULT STDMETHODCALLTYPE StopWhenReady() = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IMediaControl, 0x56a868b1, 0x0ad4, 0x11ce, 0xb0, 0x3a, 0x00,
                0x20, 0xaf, 0x0b, 0xa7, 0x70)
#endif
#else
typedef struct IMediaControlVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IMediaControl *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTypeInfoCount)(IMediaControl *This,
                                               UINT *pctinfo);
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(IMediaControl *This, UINT iTInfo,
                                          LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(IMediaControl *This, REFIID riid,
                                            LPOLESTR *rgszNames, UINT cNames,
                                            LCID lcid, DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(IMediaControl *This, DISPID dispIdMember,
  ...
  HRESULT(STDMETHODCALLTYPE *GetState)(IMediaControl *This, LONG msTimeout,
                                       OAFilterState *pfs);
  ...
  HRESULT(STDMETHODCALLTYPE *AddSourceFilter)(IMediaControl *This,
                                              BSTR strFilename,
                                              IDispatch **ppUnk);
  HRESULT(STDMETHODCALLTYPE *get_FilterCollection)(IMediaControl *This,
                                                   IDispatch **ppUnk);
  HRESULT(STDMETHODCALLTYPE *get_RegFilterCollection)(IMediaControl *This,
                                                      IDispatch **ppUnk);
  HRESULT(STDMETHODCALLTYPE *StopWhenReady)(IMediaControl *This);
  END_INTERFACE
} IMediaControlVtbl;
interface IMediaControl { CONST_VTBL IMediaControlVtbl *lpVtbl; };
#ifdef COBJMACROS
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMediaControl_QueryInterface(IMediaControl *This,
                                                   REFIID riid,
                                                   void **ppvObject) {
...
/*** IDispatch methods ***/
static inline HRESULT IMediaControl_GetTypeInfoCount(IMediaControl *This,
                                                     UINT *pctinfo) {
  return This->lpVtbl->GetTypeInfoCount(This, pctinfo);
}
static inline HRESULT IMediaControl_GetTypeInfo(IMediaControl *This,
                                                UINT iTInfo, LCID lcid,
                                                ITypeInfo **ppTInfo) {
  return This->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo);
}
static inline HRESULT IMediaControl_GetIDsOfNames(IMediaControl *This,
                                                  REFIID riid,
                                                  LPOLESTR *rgszNames,
...
IMediaControl_Invoke(IMediaControl *This, DISPID dispIdMember, REFIID riid,
...
static inline HRESULT IMediaControl_GetState(IMediaControl *This,
                                             LONG msTimeout,
                                             OAFilterState *pfs) {
  return This->lpVtbl->GetState(This, msTimeout, pfs);
}
static inline HRESULT IMediaControl_RenderFile(IMediaControl *This,
                                               BSTR strFilename) {
  return This->lpVtbl->RenderFile(This, strFilename);
}
static inline HRESULT IMediaControl_AddSourceFilter(IMediaControl *This,
                                                    BSTR strFilename,
                                                    IDispatch **ppUnk) {
  return This->lpVtbl->AddSourceFilter(This, strFilename, ppUnk);
}
static inline HRESULT IMediaControl_get_FilterCollection(IMediaControl *This,
                                                         IDispatch **ppUnk) {
  return This->lpVtbl->get_FilterCollection(This, ppUnk);
}
static inline HRESULT IMediaControl_get_RegFilterCollection(IMediaControl *This,
                                                            IDispatch **ppUnk) {
...
typedef struct IAMCollectionVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IAMCollection *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IAMCollection *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IAMCollection *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IAMCollection *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
...
#endif
#endif
HRESULT WINAPI IAMCollection_get_Count_Proxy(IAMCollection *This,
                                             LONG *plCount);
...
HRESULT WINAPI IAMCollection_Item_Proxy(IAMCollection *This, __LONG32 lItem,
                                        IUnknown **ppUnk);
void __RPC_STUB IAMCollection_Item_Stub(IRpcStubBuffer *This,
                                        IRpcChannelBuffer *_pRpcChannelBuffer,
                                        PRPC_MESSAGE _pRpcMessage,
                                        DWORD *_pdwStubPhase);
HRESULT WINAPI IAMCollection_get__NewEnum_Proxy(IAMCollection *This,
                                                IUnknown **ppUnk);
...
public:
  ...
  virtual HRESULT WINAPI GetEvent(__LONG32 *lEventCode, LONG_PTR *lParam1,
                                  LONG_PTR *lParam2, __LONG32 msTimeout) = 0;
  virtual HRESULT WINAPI WaitForCompletion(__LONG32 msTimeout,
                                           __LONG32 *pEvCode) = 0;
  ...
  virtual HRESULT WINAPI FreeEventParams(__LONG32 lEvCode, LONG_PTR lParam1,
                                         LONG_PTR lParam2) = 0;
};
#else
typedef struct IMediaEventVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMediaEvent *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IMediaEvent *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IMediaEvent *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IMediaEvent *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *GetEventHandle)(IMediaEvent *This, OAEVENT *hEvent);
  HRESULT(WINAPI *GetEvent)(IMediaEvent *This, __LONG32 *lEventCode,
                            LONG_PTR *lParam1, LONG_PTR *lParam2,
                            __LONG32 msTimeout);
  HRESULT(WINAPI *WaitForCompletion)(IMediaEvent *This, __LONG32 msTimeout,
                                     __LONG32 *pEvCode);
  ...
  HRESULT(WINAPI *FreeEventParams)(IMediaEvent *This, __LONG32 lEvCode,
                                   LONG_PTR lParam1, LONG_PTR lParam2);
  END_INTERFACE
} IMediaEventVtbl;
struct IMediaEvent {
...
#endif
#endif
HRESULT WINAPI IMediaEvent_GetEventHandle_Proxy(IMediaEvent *This,
                                                OAEVENT *hEvent);
void __RPC_STUB IMediaEvent_GetEventHandle_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMediaEvent_GetEvent_Proxy(IMediaEvent *This,
                                          __LONG32 *lEventCode,
                                          LONG_PTR *lParam1, LONG_PTR *lParam2,
                                          __LONG32 msTimeout);
void __RPC_STUB IMediaEvent_GetEvent_Stub(IRpcStubBuffer *This,
                                          ...
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI IMediaEvent_WaitForCompletion_Proxy(IMediaEvent *This,
                                                   __LONG32 msTimeout,
                                                   __LONG32 *pEvCode);
void __RPC_STUB IMediaEvent_WaitForCompletion_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMediaEvent_CancelDefaultHandling_Proxy(IMediaEvent *This,
                                                       __LONG32 lEvCode);
void __RPC_STUB IMediaEvent_CancelDefaultHandling_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMediaEvent_RestoreDefaultHandling_Proxy(IMediaEvent *This,
                                                        __LONG32 lEvCode);
void __RPC_STUB IMediaEvent_RestoreDefaultHandling_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMediaEvent_FreeEventParams_Proxy(IMediaEvent *This,
                                                 __LONG32 lEvCode,
                                                 LONG_PTR lParam1,
                                                 LONG_PTR lParam2);
...
public:
  virtual HRESULT WINAPI SetNotifyWindow(OAHWND hwnd, __LONG32 lMsg,
...
typedef struct IMediaEventExVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMediaEventEx *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IMediaEventEx *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IMediaEventEx *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IMediaEventEx *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *GetEventHandle)(IMediaEventEx *This, OAEVENT *hEvent);
  HRESULT(WINAPI *GetEvent)(IMediaEventEx *This, __LONG32 *lEventCode,
                            LONG_PTR *lParam1, LONG_PTR *lParam2,
                            __LONG32 msTimeout);
  HRESULT(WINAPI *WaitForCompletion)(IMediaEventEx *This, __LONG32 msTimeout,
                                     __LONG32 *pEvCode);
  HRESULT(WINAPI *CancelDefaultHandling)(IMediaEventEx *This, __LONG32 lEvCode);
  HRESULT(WINAPI *RestoreDefaultHandling)(IMediaEventEx *This,
                                          __LONG32 lEvCode);
  HRESULT(WINAPI *FreeEventParams)(IMediaEventEx *This, __LONG32 lEvCode,
                                   LONG_PTR lParam1, LONG_PTR lParam2);
  HRESULT(WINAPI *SetNotifyWindow)(IMediaEventEx *This, OAHWND hwnd,
                                   __LONG32 lMsg, LONG_PTR lInstanceData);
  HRESULT(WINAPI *SetNotifyFlags)(IMediaEventEx *This, __LONG32 lNoNotifyFlags);
  HRESULT(WINAPI *GetNotifyFlags)(IMediaEventEx *This,
                                  __LONG32 *lplNoNotifyFlags);
  END_INTERFACE
} IMediaEventExVtbl;
...
#endif
#endif
HRESULT WINAPI IMediaEventEx_SetNotifyWindow_Proxy(IMediaEventEx *This,
                                                   OAHWND hwnd, __LONG32 lMsg,
                                                   LONG_PTR lInstanceData);
void __RPC_STUB IMediaEventEx_SetNotifyWindow_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMediaEventEx_SetNotifyFlags_Proxy(IMediaEventEx *This,
                                                  __LONG32 lNoNotifyFlags);
void __RPC_STUB IMediaEventEx_SetNotifyFlags_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMediaEventEx_GetNotifyFlags_Proxy(IMediaEventEx *This,
                                                  __LONG32 *lplNoNotifyFlags);
...
typedef struct IMediaPositionVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMediaPosition *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IMediaPosition *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IMediaPosition *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IMediaPosition *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
  ...
  HRESULT(WINAPI *CanSeekBackward)(IMediaPosition *This,
...
#endif
#endif
HRESULT WINAPI IMediaPosition_get_Duration_Proxy(IMediaPosition *This,
                                                 REFTIME *plength);
void __RPC_STUB IMediaPosition_get_Duration_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMediaPosition_put_CurrentPosition_Proxy(IMediaPosition *This,
                                                        REFTIME llTime);
void __RPC_STUB IMediaPosition_put_CurrentPosition_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMediaPosition_get_CurrentPosition_Proxy(IMediaPosition *This,
                                                        REFTIME *pllTime);
void __RPC_STUB IMediaPosition_get_CurrentPosition_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMediaPosition_get_StopTime_Proxy(IMediaPosition *This,
                                                 REFTIME *pllTime);
void __RPC_STUB IMediaPosition_get_StopTime_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMediaPosition_put_StopTime_Proxy(IMediaPosition *This,
                                                 REFTIME llTime);
void __RPC_STUB IMediaPosition_put_StopTime_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMediaPosition_get_PrerollTime_Proxy(IMediaPosition *This,
                                                    REFTIME *pllTime);
void __RPC_STUB IMediaPosition_get_PrerollTime_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMediaPosition_put_PrerollTime_Proxy(IMediaPosition *This,
                                                    REFTIME llTime);
void __RPC_STUB IMediaPosition_put_PrerollTime_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMediaPosition_put_Rate_Proxy(IMediaPosition *This,
                                             double dRate);
void __RPC_STUB IMediaPosition_put_Rate_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMediaPosition_get_Rate_Proxy(IMediaPosition *This,
                                             double *pdRate);
void __RPC_STUB IMediaPosition_get_Rate_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMediaPosition_CanSeekForward_Proxy(IMediaPosition *This,
                                                   LONG *pCanSeekForward);
void __RPC_STUB IMediaPosition_CanSeekForward_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMediaPosition_CanSeekBackward_Proxy(IMediaPosition *This,
                                                    LONG *pCanSeekBackward);
...
typedef struct IBasicAudioVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IBasicAudio *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IBasicAudio *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IBasicAudio *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IBasicAudio *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
...
#endif
#endif
HRESULT WINAPI IBasicAudio_put_Volume_Proxy(IBasicAudio *This,
                                            __LONG32 lVolume);
void __RPC_STUB IBasicAudio_put_Volume_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBasicAudio_get_Volume_Proxy(IBasicAudio *This,
                                            __LONG32 *plVolume);
void __RPC_STUB IBasicAudio_get_Volume_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBasicAudio_put_Balance_Proxy(IBasicAudio *This,
                                             __LONG32 lBalance);
void __RPC_STUB IBasicAudio_put_Balance_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBasicAudio_get_Balance_Proxy(IBasicAudio *This,
                                             __LONG32 *plBalance);
...
public:
  ...
  get_BackgroundPalette(__LONG32 *pBackgroundPalette) = 0;
  ...
  virtual HRESULT WINAPI NotifyOwnerMessage(OAHWND hwnd, __LONG32 uMsg,
                                            LONG_PTR wParam,
                                            LONG_PTR lParam) = 0;
  virtual HRESULT WINAPI SetWindowPosition(__LONG32 Left, __LONG32 Top,
                                           __LONG32 Width, __LONG32 Height) = 0;
  virtual HRESULT WINAPI GetWindowPosition(__LONG32 *pLeft, __LONG32 *pTop,
                                           __LONG32 *pWidth,
                                           __LONG32 *pHeight) = 0;
  virtual HRESULT WINAPI GetMinIdealImageSize(__LONG32 *pWidth,
                                              __LONG32 *pHeight) = 0;
  virtual HRESULT WINAPI GetMaxIdealImageSize(__LONG32 *pWidth,
                                              __LONG32 *pHeight) = 0;
  virtual HRESULT WINAPI GetRestorePosition(__LONG32 *pLeft, __LONG32 *pTop,
                                            __LONG32 *pWidth,
                                            __LONG32 *pHeight) = 0;
...
typedef struct IVideoWindowVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IVideoWindow *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IVideoWindow *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IVideoWindow *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IVideoWindow *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  ...
  HRESULT(WINAPI *put_WindowStyleEx)(IVideoWindow *This,
                                     __LONG32 WindowStyleEx);
  HRESULT(WINAPI *get_WindowStyleEx)(IVideoWindow *This,
                                     __LONG32 *WindowStyleEx);
  ...
  HRESULT(WINAPI *put_BackgroundPalette)(IVideoWindow *This,
                                         __LONG32 BackgroundPalette);
  HRESULT(WINAPI *get_BackgroundPalette)(IVideoWindow *This,
                                         __LONG32 *pBackgroundPalette);
  ...
  HRESULT(WINAPI *get_FullScreenMode)(IVideoWindow *This,
                                      __LONG32 *FullScreenMode);
  HRESULT(WINAPI *put_FullScreenMode)(IVideoWindow *This,
                                      __LONG32 FullScreenMode);
  HRESULT(WINAPI *SetWindowForeground)(IVideoWindow *This, __LONG32 Focus);
  HRESULT(WINAPI *NotifyOwnerMessage)(IVideoWindow *This, OAHWND hwnd,
                                      __LONG32 uMsg, LONG_PTR wParam,
                                      LONG_PTR lParam);
  HRESULT(WINAPI *SetWindowPosition)(IVideoWindow *This, __LONG32 Left,
                                     __LONG32 Top, __LONG32 Width,
                                     __LONG32 Height);
  HRESULT(WINAPI *GetWindowPosition)(IVideoWindow *This, __LONG32 *pLeft,
                                     __LONG32 *pTop, __LONG32 *pWidth,
                                     __LONG32 *pHeight);
  HRESULT(WINAPI *GetMinIdealImageSize)(IVideoWindow *This, __LONG32 *pWidth,
                                        __LONG32 *pHeight);
  HRESULT(WINAPI *GetMaxIdealImageSize)(IVideoWindow *This, __LONG32 *pWidth,
                                        __LONG32 *pHeight);
  HRESULT(WINAPI *GetRestorePosition)(IVideoWindow *This, __LONG32 *pLeft,
                                      __LONG32 *pTop, __LONG32 *pWidth,
                                      __LONG32 *pHeight);
...
#endif
#endif
HRESULT WINAPI IVideoWindow_put_Caption_Proxy(IVideoWindow *This,
                                              BSTR strCaption);
void __RPC_STUB IVideoWindow_put_Caption_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IVideoWindow_get_Caption_Proxy(IVideoWindow *This,
                                              BSTR *strCaption);
void __RPC_STUB IVideoWindow_get_Caption_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IVideoWindow_put_WindowStyle_Proxy(IVideoWindow *This,
                                                  __LONG32 WindowStyle);
void __RPC_STUB IVideoWindow_put_WindowStyle_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IVideoWindow_get_WindowStyle_Proxy(IVideoWindow *This,
                                                  __LONG32 *WindowStyle);
void __RPC_STUB IVideoWindow_get_WindowStyle_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IVideoWindow_put_WindowStyleEx_Proxy(IVideoWindow *This,
                                                    __LONG32 WindowStyleEx);
void __RPC_STUB IVideoWindow_put_WindowStyleEx_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IVideoWindow_get_WindowStyleEx_Proxy(IVideoWindow *This,
                                                    __LONG32 *WindowStyleEx);
void __RPC_STUB IVideoWindow_get_WindowStyleEx_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IVideoWindow_put_AutoShow_Proxy(IVideoWindow *This,
                                               __LONG32 AutoShow);
void __RPC_STUB IVideoWindow_put_AutoShow_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IVideoWindow_get_AutoShow_Proxy(IVideoWindow *This,
                                               __LONG32 *AutoShow);
void __RPC_STUB IVideoWindow_get_AutoShow_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IVideoWindow_put_WindowState_Proxy(IVideoWindow *This,
                                                  __LONG32 WindowState);
void __RPC_STUB IVideoWindow_put_WindowState_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IVideoWindow_get_WindowState_Proxy(IVideoWindow *This,
                                                  __LONG32 *WindowState);
void __RPC_STUB IVideoWindow_get_WindowState_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IVideoWindow_put_BackgroundPalette_Proxy(
    IVideoWindow *This, __LONG32 BackgroundPalette);
void __RPC_STUB IVideoWindow_put_BackgroundPalette_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IVideoWindow_get_BackgroundPalette_Proxy(
    IVideoWindow *This, __LONG32 *pBackgroundPalette);
void __RPC_STUB IVideoWindow_get_BackgroundPalette_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IVideoWindow_put_Visible_Proxy(IVideoWindow *This,
                                              __LONG32 Visible);
void __RPC_STUB IVideoWindow_put_Visible_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IVideoWindow_get_Visible_Proxy(IVideoWindow *This,
                                              __LONG32 *pVisible);
...
void __RPC_STUB IVideoWindow_put_Width_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IVideoWindow_get_Width_Proxy(IVideoWindow *This,
                                            __LONG32 *pWidth);
...
void __RPC_STUB IVideoWindow_get_Top_Stub(IRpcStubBuffer *This,
                                          ...
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI IVideoWindow_put_Height_Proxy(IVideoWindow *This,
                                             __LONG32 Height);
void __RPC_STUB IVideoWindow_put_Height_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IVideoWindow_get_Height_Proxy(IVideoWindow *This,
                                             __LONG32 *pHeight);
...
void __RPC_STUB IVideoWindow_get_Owner_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IVideoWindow_put_MessageDrain_Proxy(IVideoWindow *This,
                                                   OAHWND Drain);
void __RPC_STUB IVideoWindow_put_MessageDrain_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IVideoWindow_get_MessageDrain_Proxy(IVideoWindow *This,
                                                   OAHWND *Drain);
void __RPC_STUB IVideoWindow_get_MessageDrain_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IVideoWindow_get_BorderColor_Proxy(IVideoWindow *This,
                                                  __LONG32 *Color);
void __RPC_STUB IVideoWindow_get_BorderColor_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IVideoWindow_put_BorderColor_Proxy(IVideoWindow *This,
                                                  __LONG32 Color);
void __RPC_STUB IVideoWindow_put_BorderColor_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IVideoWindow_get_FullScreenMode_Proxy(IVideoWindow *This,
                                                     __LONG32 *FullScreenMode);
void __RPC_STUB IVideoWindow_get_FullScreenMode_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IVideoWindow_put_FullScreenMode_Proxy(IVideoWindow *This,
                                                     __LONG32 FullScreenMode);
void __RPC_STUB IVideoWindow_put_FullScreenMode_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IVideoWindow_SetWindowForeground_Proxy(IVideoWindow *This,
                                                      __LONG32 Focus);
void __RPC_STUB IVideoWindow_SetWindowForeground_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IVideoWindow_NotifyOwnerMessage_Proxy(IVideoWindow *This,
                                                     OAHWND hwnd, __LONG32 uMsg,
                                                     LONG_PTR wParam,
                                                     LONG_PTR lParam);
void __RPC_STUB IVideoWindow_NotifyOwnerMessage_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IVideoWindow_SetWindowPosition_Proxy(IVideoWindow *This,
                                                    __LONG32 Left, __LONG32 Top,
                                                    __LONG32 Width,
                                                    __LONG32 Height);
void __RPC_STUB IVideoWindow_SetWindowPosition_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IVideoWindow_GetWindowPosition_Proxy(IVideoWindow *This,
                                                    __LONG32 *pLeft,
                                                    __LONG32 *pTop,
                                                    __LONG32 *pWidth,
                                                    __LONG32 *pHeight);
void __RPC_STUB IVideoWindow_GetWindowPosition_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IVideoWindow_GetMinIdealImageSize_Proxy(IVideoWindow *This,
                                                       __LONG32 *pWidth,
                                                       __LONG32 *pHeight);
void __RPC_STUB IVideoWindow_GetMinIdealImageSize_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IVideoWindow_GetMaxIdealImageSize_Proxy(IVideoWindow *This,
                                                       __LONG32 *pWidth,
                                                       __LONG32 *pHeight);
void __RPC_STUB IVideoWindow_GetMaxIdealImageSize_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IVideoWindow_GetRestorePosition_Proxy(IVideoWindow *This,
                                                     __LONG32 *pLeft,
                                                     __LONG32 *pTop,
                                                     __LONG32 *pWidth,
                                                     __LONG32 *pHeight);
void __RPC_STUB IVideoWindow_GetRestorePosition_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IVideoWindow_HideCursor_Proxy(IVideoWindow *This,
                                             __LONG32 HideCursor);
void __RPC_STUB IVideoWindow_HideCursor_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IVideoWindow_IsCursorHidden_Proxy(IVideoWindow *This,
                                                 __LONG32 *CursorHidden);
...
public:
  ...
  virtual HRESULT WINAPI
  get_DestinationHeight(__LONG32 *pDestinationHeight) = 0;
  virtual HRESULT WINAPI SetSourcePosition(__LONG32 Left, __LONG32 Top,
                                           __LONG32 Width, __LONG32 Height) = 0;
  virtual HRESULT WINAPI GetSourcePosition(__LONG32 *pLeft, __LONG32 *pTop,
                                           __LONG32 *pWidth,
                                           __LONG32 *pHeight) = 0;
  virtual HRESULT WINAPI SetDefaultSourcePosition(void) = 0;
  virtual HRESULT WINAPI SetDestinationPosition(__LONG32 Left, __LONG32 Top,
                                                __LONG32 Width,
                                                __LONG32 Height) = 0;
  virtual HRESULT WINAPI GetDestinationPosition(__LONG32 *pLeft, __LONG32 *pTop,
                                                __LONG32 *pWidth,
                                                __LONG32 *pHeight) = 0;
  ...
  virtual HRESULT WINAPI GetVideoPaletteEntries(__LONG32 StartIndex,
                                                __LONG32 Entries,
                                                __LONG32 *pRetrieved,
                                                __LONG32 *pPalette) = 0;
  virtual HRESULT WINAPI GetCurrentImage(__LONG32 *pBufferSize,
                                         __LONG32 *pDIBImage) = 0;
...
typedef struct IBasicVideoVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IBasicVideo *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IBasicVideo *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IBasicVideo *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IBasicVideo *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *get_AvgTimePerFrame)(IBasicVideo *This,
  ...
  HRESULT(WINAPI *put_DestinationLeft)(IBasicVideo *This,
                                       __LONG32 DestinationLeft);
  HRESULT(WINAPI *get_DestinationLeft)(IBasicVideo *This,
                                       __LONG32 *pDestinationLeft);
  HRESULT(WINAPI *put_DestinationWidth)(IBasicVideo *This,
                                        __LONG32 DestinationWidth);
  HRESULT(WINAPI *get_DestinationWidth)(IBasicVideo *This,
                                        __LONG32 *pDestinationWidth);
  HRESULT(WINAPI *put_DestinationTop)(IBasicVideo *This,
                                      __LONG32 DestinationTop);
  HRESULT(WINAPI *get_DestinationTop)(IBasicVideo *This,
                                      __LONG32 *pDestinationTop);
  HRESULT(WINAPI *put_DestinationHeight)(IBasicVideo *This,
                                         __LONG32 DestinationHeight);
  HRESULT(WINAPI *get_DestinationHeight)(IBasicVideo *This,
                                         __LONG32 *pDestinationHeight);
  HRESULT(WINAPI *SetSourcePosition)(IBasicVideo *This, __LONG32 Left,
                                     __LONG32 Top, __LONG32 Width,
                                     __LONG32 Height);
  HRESULT(WINAPI *GetSourcePosition)(IBasicVideo *This, __LONG32 *pLeft,
                                     __LONG32 *pTop, __LONG32 *pWidth,
                                     __LONG32 *pHeight);
  HRESULT(WINAPI *SetDefaultSourcePosition)(IBasicVideo *This);
  HRESULT(WINAPI *SetDestinationPosition)(IBasicVideo *This, __LONG32 Left,
                                          __LONG32 Top, __LONG32 Width,
                                          __LONG32 Height);
  HRESULT(WINAPI *GetDestinationPosition)(IBasicVideo *This, __LONG32 *pLeft,
                                          __LONG32 *pTop, __LONG32 *pWidth,
                                          __LONG32 *pHeight);
  HRESULT(WINAPI *SetDefaultDestinationPosition)(IBasicVideo *This);
  HRESULT(WINAPI *GetVideoSize)(IBasicVideo *This, __LONG32 *pWidth,
                                __LONG32 *pHeight);
  HRESULT(WINAPI *GetVideoPaletteEntries)(IBasicVideo *This,
                                          __LONG32 StartIndex, __LONG32 Entries,
                                          __LONG32 *pRetrieved,
                                          __LONG32 *pPalette);
  HRESULT(WINAPI *GetCurrentImage)(IBasicVideo *This, __LONG32 *pBufferSize,
                                   __LONG32 *pDIBImage);
...
#endif
#endif
HRESULT WINAPI IBasicVideo_get_AvgTimePerFrame_Proxy(IBasicVideo *This,
                                                     REFTIME *pAvgTimePerFrame);
void __RPC_STUB IBasicVideo_get_AvgTimePerFrame_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBasicVideo_get_BitRate_Proxy(IBasicVideo *This,
                                             __LONG32 *pBitRate);
void __RPC_STUB IBasicVideo_get_BitRate_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBasicVideo_get_BitErrorRate_Proxy(IBasicVideo *This,
                                                  __LONG32 *pBitErrorRate);
void __RPC_STUB IBasicVideo_get_BitErrorRate_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBasicVideo_get_VideoWidth_Proxy(IBasicVideo *This,
                                                __LONG32 *pVideoWidth);
void __RPC_STUB IBasicVideo_get_VideoWidth_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBasicVideo_get_VideoHeight_Proxy(IBasicVideo *This,
                                                 __LONG32 *pVideoHeight);
void __RPC_STUB IBasicVideo_get_VideoHeight_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBasicVideo_put_SourceLeft_Proxy(IBasicVideo *This,
                                                __LONG32 SourceLeft);
void __RPC_STUB IBasicVideo_put_SourceLeft_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBasicVideo_get_SourceLeft_Proxy(IBasicVideo *This,
                                                __LONG32 *pSourceLeft);
void __RPC_STUB IBasicVideo_get_SourceLeft_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBasicVideo_put_SourceWidth_Proxy(IBasicVideo *This,
                                                 __LONG32 SourceWidth);
void __RPC_STUB IBasicVideo_put_SourceWidth_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBasicVideo_get_SourceWidth_Proxy(IBasicVideo *This,
                                                 __LONG32 *pSourceWidth);
void __RPC_STUB IBasicVideo_get_SourceWidth_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBasicVideo_put_SourceTop_Proxy(IBasicVideo *This,
                                               __LONG32 SourceTop);
void __RPC_STUB IBasicVideo_put_SourceTop_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBasicVideo_get_SourceTop_Proxy(IBasicVideo *This,
                                               __LONG32 *pSourceTop);
void __RPC_STUB IBasicVideo_get_SourceTop_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBasicVideo_put_SourceHeight_Proxy(IBasicVideo *This,
                                                  __LONG32 SourceHeight);
void __RPC_STUB IBasicVideo_put_SourceHeight_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBasicVideo_get_SourceHeight_Proxy(IBasicVideo *This,
                                                  __LONG32 *pSourceHeight);
void __RPC_STUB IBasicVideo_get_SourceHeight_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBasicVideo_put_DestinationLeft_Proxy(IBasicVideo *This,
                                                     __LONG32 DestinationLeft);
void __RPC_STUB IBasicVideo_put_DestinationLeft_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBasicVideo_get_DestinationLeft_Proxy(
    IBasicVideo *This, __LONG32 *pDestinationLeft);
void __RPC_STUB IBasicVideo_get_DestinationLeft_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBasicVideo_put_DestinationWidth_Proxy(
    IBasicVideo *This, __LONG32 DestinationWidth);
void __RPC_STUB IBasicVideo_put_DestinationWidth_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBasicVideo_get_DestinationWidth_Proxy(
    IBasicVideo *This, __LONG32 *pDestinationWidth);
void __RPC_STUB IBasicVideo_get_DestinationWidth_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBasicVideo_put_DestinationTop_Proxy(IBasicVideo *This,
                                                    __LONG32 DestinationTop);
void __RPC_STUB IBasicVideo_put_DestinationTop_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBasicVideo_get_DestinationTop_Proxy(IBasicVideo *This,
                                                    __LONG32 *pDestinationTop);
void __RPC_STUB IBasicVideo_get_DestinationTop_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBasicVideo_put_DestinationHeight_Proxy(
    IBasicVideo *This, __LONG32 DestinationHeight);
void __RPC_STUB IBasicVideo_put_DestinationHeight_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBasicVideo_get_DestinationHeight_Proxy(
    IBasicVideo *This, __LONG32 *pDestinationHeight);
void __RPC_STUB IBasicVideo_get_DestinationHeight_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBasicVideo_SetSourcePosition_Proxy(IBasicVideo *This,
                                                   __LONG32 Left, __LONG32 Top,
                                                   __LONG32 Width,
                                                   __LONG32 Height);
void __RPC_STUB IBasicVideo_SetSourcePosition_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBasicVideo_GetSourcePosition_Proxy(IBasicVideo *This,
                                                   __LONG32 *pLeft,
                                                   __LONG32 *pTop,
                                                   __LONG32 *pWidth,
                                                   __LONG32 *pHeight);
...
void __RPC_STUB IBasicVideo_SetDefaultSourcePosition_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBasicVideo_SetDestinationPosition_Proxy(IBasicVideo *This,
                                                        __LONG32 Left,
                                                        __LONG32 Top,
                                                        __LONG32 Width,
                                                        __LONG32 Height);
void __RPC_STUB IBasicVideo_SetDestinationPosition_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBasicVideo_GetDestinationPosition_Proxy(IBasicVideo *This,
                                                        __LONG32 *pLeft,
                                                        __LONG32 *pTop,
                                                        __LONG32 *pWidth,
                                                        __LONG32 *pHeight);
...
void __RPC_STUB IBasicVideo_SetDefaultDestinationPosition_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBasicVideo_GetVideoSize_Proxy(IBasicVideo *This,
                                              __LONG32 *pWidth,
                                              __LONG32 *pHeight);
void __RPC_STUB IBasicVideo_GetVideoSize_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBasicVideo_GetVideoPaletteEntries_Proxy(IBasicVideo *This,
                                                        __LONG32 StartIndex,
                                                        __LONG32 Entries,
                                                        __LONG32 *pRetrieved,
                                                        __LONG32 *pPalette);
void __RPC_STUB IBasicVideo_GetVideoPaletteEntries_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBasicVideo_GetCurrentImage_Proxy(IBasicVideo *This,
                                                 __LONG32 *pBufferSize,
                                                 __LONG32 *pDIBImage);
...
public:
  virtual HRESULT WINAPI GetPreferredAspectRatio(__LONG32 *plAspectX,
                                                 __LONG32 *plAspectY) = 0;
};
#else
typedef struct IBasicVideo2Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IBasicVideo2 *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IBasicVideo2 *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IBasicVideo2 *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IBasicVideo2 *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *get_AvgTimePerFrame)(IBasicVideo2 *This,
                                       REFTIME *pAvgTimePerFrame);
  HRESULT(WINAPI *get_BitRate)(IBasicVideo2 *This, __LONG32 *pBitRate);
  HRESULT(WINAPI *get_BitErrorRate)(IBasicVideo2 *This,
                                    __LONG32 *pBitErrorRate);
  ...
  HRESULT(WINAPI *get_SourceHeight)(IBasicVideo2 *This,
                                    __LONG32 *pSourceHeight);
  HRESULT(WINAPI *put_DestinationLeft)(IBasicVideo2 *This,
                                       __LONG32 DestinationLeft);
  HRESULT(WINAPI *get_DestinationLeft)(IBasicVideo2 *This,
                                       __LONG32 *pDestinationLeft);
  HRESULT(WINAPI *put_DestinationWidth)(IBasicVideo2 *This,
                                        __LONG32 DestinationWidth);
  HRESULT(WINAPI *get_DestinationWidth)(IBasicVideo2 *This,
                                        __LONG32 *pDestinationWidth);
  HRESULT(WINAPI *put_DestinationTop)(IBasicVideo2 *This,
                                      __LONG32 DestinationTop);
  HRESULT(WINAPI *get_DestinationTop)(IBasicVideo2 *This,
                                      __LONG32 *pDestinationTop);
  HRESULT(WINAPI *put_DestinationHeight)(IBasicVideo2 *This,
                                         __LONG32 DestinationHeight);
  HRESULT(WINAPI *get_DestinationHeight)(IBasicVideo2 *This,
                                         __LONG32 *pDestinationHeight);
  HRESULT(WINAPI *SetSourcePosition)(IBasicVideo2 *This, __LONG32 Left,
                                     __LONG32 Top, __LONG32 Width,
                                     __LONG32 Height);
  HRESULT(WINAPI *GetSourcePosition)(IBasicVideo2 *This, __LONG32 *pLeft,
                                     __LONG32 *pTop, __LONG32 *pWidth,
                                     __LONG32 *pHeight);
  HRESULT(WINAPI *SetDefaultSourcePosition)(IBasicVideo2 *This);
  HRESULT(WINAPI *SetDestinationPosition)(IBasicVideo2 *This, __LONG32 Left,
                                          __LONG32 Top, __LONG32 Width,
                                          __LONG32 Height);
  HRESULT(WINAPI *GetDestinationPosition)(IBasicVideo2 *This, __LONG32 *pLeft,
                                          __LONG32 *pTop, __LONG32 *pWidth,
                                          __LONG32 *pHeight);
  HRESULT(WINAPI *SetDefaultDestinationPosition)(IBasicVideo2 *This);
  HRESULT(WINAPI *GetVideoSize)(IBasicVideo2 *This, __LONG32 *pWidth,
                                __LONG32 *pHeight);
  HRESULT(WINAPI *GetVideoPaletteEntries)(IBasicVideo2 *This,
                                          __LONG32 StartIndex, __LONG32 Entries,
                                          __LONG32 *pRetrieved,
                                          __LONG32 *pPalette);
  HRESULT(WINAPI *GetCurrentImage)(IBasicVideo2 *This, __LONG32 *pBufferSize,
                                   __LONG32 *pDIBImage);
  HRESULT(WINAPI *IsUsingDefaultSource)(IBasicVideo2 *This);
  HRESULT(WINAPI *IsUsingDefaultDestination)(IBasicVideo2 *This);
  HRESULT(WINAPI *GetPreferredAspectRatio)(IBasicVideo2 *This,
                                           __LONG32 *plAspectX,
                                           __LONG32 *plAspectY);
  END_INTERFACE
} IBasicVideo2Vtbl;
...
#endif
#endif
HRESULT WINAPI IBasicVideo2_GetPreferredAspectRatio_Proxy(IBasicVideo2 *This,
                                                          __LONG32 *plAspectX,
                                                          __LONG32 *plAspectY);
...
typedef struct IDeferredCommandVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IDeferredCommand *This, REFIID riid,
                                  void **ppvObject);
...
void __RPC_STUB IDeferredCommand_Cancel_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IDeferredCommand_Confidence_Proxy(IDeferredCommand *This,
                                                 LONG *pConfidence);
void __RPC_STUB IDeferredCommand_Confidence_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IDeferredCommand_Postpone_Proxy(IDeferredCommand *This,
                                               REFTIME newtime);
void __RPC_STUB IDeferredCommand_Postpone_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IDeferredCommand_GetHResult_Proxy(IDeferredCommand *This,
                                                 HRESULT *phrResult);
...
public:
  virtual HRESULT WINAPI InvokeAtStreamTime(
      IDeferredCommand **pCmd, REFTIME time, GUID *iid, __LONG32 dispidMethod,
      short wFlags, __LONG32 cArgs, VARIANT *pDispParams, VARIANT *pvarResult,
      short *puArgErr) = 0;
  virtual HRESULT WINAPI InvokeAtPresentationTime(
      IDeferredCommand **pCmd, REFTIME time, GUID *iid, __LONG32 dispidMethod,
      short wFlags, __LONG32 cArgs, VARIANT *pDispParams, VARIANT *pvarResult,
      short *puArgErr) = 0;
};
...
typedef struct IQueueCommandVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IQueueCommand *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IQueueCommand *This);
  ULONG(WINAPI *Release)(IQueueCommand *This);
  HRESULT(WINAPI *InvokeAtStreamTime)(IQueueCommand *This,
                                      IDeferredCommand **pCmd, REFTIME time,
                                      GUID *iid, __LONG32 dispidMethod,
                                      short wFlags, __LONG32 cArgs,
                                      VARIANT *pDispParams, VARIANT *pvarResult,
                                      short *puArgErr);
  HRESULT(WINAPI *InvokeAtPresentationTime)(
      IQueueCommand *This, IDeferredCommand **pCmd, REFTIME time, GUID *iid,
      __LONG32 dispidMethod, short wFlags, __LONG32 cArgs, VARIANT *pDispParams,
      VARIANT *pvarResult, short *puArgErr);
  END_INTERFACE
} IQueueCommandVtbl;
...
#endif
#endif
HRESULT WINAPI IQueueCommand_InvokeAtStreamTime_Proxy(
    IQueueCommand *This, IDeferredCommand **pCmd, REFTIME time, GUID *iid,
    __LONG32 dispidMethod, short wFlags, __LONG32 cArgs, VARIANT *pDispParams,
    VARIANT *pvarResult, short *puArgErr);
void __RPC_STUB IQueueCommand_InvokeAtStreamTime_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IQueueCommand_InvokeAtPresentationTime_Proxy(
    IQueueCommand *This, IDeferredCommand **pCmd, REFTIME time, GUID *iid,
    __LONG32 dispidMethod, short wFlags, __LONG32 cArgs, VARIANT *pDispParams,
    VARIANT *pvarResult, short *puArgErr);
...
typedef struct IFilterInfoVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IFilterInfo *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IFilterInfo *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IFilterInfo *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IFilterInfo *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
...
#endif
#endif
HRESULT WINAPI IFilterInfo_FindPin_Proxy(IFilterInfo *This, BSTR strPinID,
                                         IDispatch **ppUnk);
...
void __RPC_STUB IFilterInfo_get_Name_Stub(IRpcStubBuffer *This,
                                          ...
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI IFilterInfo_get_VendorInfo_Proxy(IFilterInfo *This,
                                                BSTR *strVendorInfo);
void __RPC_STUB IFilterInfo_get_VendorInfo_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IFilterInfo_get_Filter_Proxy(IFilterInfo *This,
                                            IUnknown **ppUnk);
...
void __RPC_STUB IFilterInfo_get_Pins_Stub(IRpcStubBuffer *This,
                                          ...
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI IFilterInfo_get_IsFileSource_Proxy(IFilterInfo *This,
                                                  LONG *pbIsSource);
void __RPC_STUB IFilterInfo_get_IsFileSource_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IFilterInfo_get_Filename_Proxy(IFilterInfo *This,
                                              BSTR *pstrFilename);
void __RPC_STUB IFilterInfo_get_Filename_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IFilterInfo_put_Filename_Proxy(IFilterInfo *This,
                                              BSTR strFilename);
...
typedef struct IRegFilterInfoVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IRegFilterInfo *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IRegFilterInfo *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IRegFilterInfo *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IRegFilterInfo *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
...
#endif
#endif
HRESULT WINAPI IRegFilterInfo_get_Name_Proxy(IRegFilterInfo *This,
                                             BSTR *strName);
void __RPC_STUB IRegFilterInfo_get_Name_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IRegFilterInfo_Filter_Proxy(IRegFilterInfo *This,
                                           IDispatch **ppUnk);
...
typedef struct IMediaTypeInfoVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMediaTypeInfo *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IMediaTypeInfo *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IMediaTypeInfo *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IMediaTypeInfo *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
...
#endif
#endif
HRESULT WINAPI IMediaTypeInfo_get_Type_Proxy(IMediaTypeInfo *This,
                                             BSTR *strType);
void __RPC_STUB IMediaTypeInfo_get_Type_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMediaTypeInfo_get_Subtype_Proxy(IMediaTypeInfo *This,
                                                BSTR *strType);
...
public:
  ...
  virtual HRESULT WINAPI ConnectWithType(IUnknown *pPin,
                                         IDispatch *pMediaType) = 0;
...
typedef struct IPinInfoVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IPinInfo *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IPinInfo *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IPinInfo *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IPinInfo *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  ...
  HRESULT(WINAPI *ConnectWithType)(IPinInfo *This, IUnknown *pPin,
...
void __RPC_STUB IPinInfo_get_Pin_Stub(IRpcStubBuffer *This,
                                      ...
                                      PRPC_MESSAGE _pRpcMessage,
                                      DWORD *_pdwStubPhase);
HRESULT WINAPI IPinInfo_get_ConnectedTo_Proxy(IPinInfo *This,
                                              IDispatch **ppUnk);
void __RPC_STUB IPinInfo_get_ConnectedTo_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IPinInfo_get_ConnectionMediaType_Proxy(IPinInfo *This,
                                                      IDispatch **ppUnk);
...
void __RPC_STUB IPinInfo_ConnectDirect_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IPinInfo_ConnectWithType_Proxy(IPinInfo *This, IUnknown *pPin,
                                              IDispatch *pMediaType);
...
public:
  ...
  virtual HRESULT WINAPI get_Count(LONG *plCount) = 0;
  virtual HRESULT WINAPI GetValueByIndex(__LONG32 lIndex, BSTR *szName,
                                         __LONG32 *lCount, double *dLast,
                                         double *dAverage, double *dStdDev,
                                         double *dMin, double *dMax) = 0;
  virtual HRESULT WINAPI GetValueByName(BSTR szName, __LONG32 *lIndex,
                                        __LONG32 *lCount, double *dLast,
                                        double *dAverage, double *dStdDev,
                                        double *dMin, double *dMax) = 0;
  virtual HRESULT WINAPI GetIndex(BSTR szName, __LONG32 lCreate,
                                  __LONG32 *plIndex) = 0;
...
typedef struct IAMStatsVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IAMStats *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IAMStats *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IAMStats *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IAMStats *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *Reset)(IAMStats *This);
  HRESULT(WINAPI *get_Count)(IAMStats *This, LONG *plCount);
  HRESULT(WINAPI *GetValueByIndex)(IAMStats *This, __LONG32 lIndex,
                                   BSTR *szName, __LONG32 *lCount,
                                   double *dLast, double *dAverage,
                                   double *dStdDev, double *dMin, double *dMax);
  HRESULT(WINAPI *GetValueByName)(IAMStats *This, BSTR szName, __LONG32 *lIndex,
                                  __LONG32 *lCount, double *dLast,
                                  double *dAverage, double *dStdDev,
                                  double *dMin, double *dMax);
  HRESULT(WINAPI *GetIndex)(IAMStats *This, BSTR szName, __LONG32 lCreate,
                            __LONG32 *plIndex);
...
void __RPC_STUB IAMStats_get_Count_Stub(IRpcStubBuffer *This,
                                        ...
                                        PRPC_MESSAGE _pRpcMessage,
                                        DWORD *_pdwStubPhase);
HRESULT WINAPI IAMStats_GetValueByIndex_Proxy(IAMStats *This, __LONG32 lIndex,
                                              BSTR *szName, __LONG32 *lCount,
                                              double *dLast, double *dAverage,
                                              double *dStdDev, double *dMin,
                                              double *dMax);
void __RPC_STUB IAMStats_GetValueByIndex_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAMStats_GetValueByName_Proxy(IAMStats *This, BSTR szName,
                                             __LONG32 *lIndex, __LONG32 *lCount,
                                             double *dLast, double *dAverage,
                                             double *dStdDev, double *dMin,
                                             double *dMax);
void __RPC_STUB IAMStats_GetValueByName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAMStats_GetIndex_Proxy(IAMStats *This, BSTR szName,
                                       __LONG32 lCreate, __LONG32 *plIndex);
void __RPC_STUB IAMStats_GetIndex_Stub(IRpcStubBuffer *This,
                                       IRpcChannelBuffer *_pRpcChannelBuffer,
                                       PRPC_MESSAGE _pRpcMessage,
                                       DWORD *_pdwStubPhase);
HRESULT WINAPI IAMStats_AddValue_Proxy(IAMStats *This, __LONG32 lIndex,
                                       double dValue);
