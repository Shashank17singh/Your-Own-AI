...
public:
  virtual HRESULT WINAPI PrepareRequest(WINBOOL fRetaining, DWORD grfRM,
                                        WINBOOL fWantMoniker,
                                        WINBOOL fSinglePhase) = 0;
...
typedef struct ITransactionResourceAsyncVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITransactionResourceAsync *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ITransactionResourceAsync *This);
  ULONG(WINAPI *Release)(ITransactionResourceAsync *This);
  HRESULT(WINAPI *PrepareRequest)(ITransactionResourceAsync *This,
                                  WINBOOL fRetaining, DWORD grfRM,
                                  WINBOOL fWantMoniker, WINBOOL fSinglePhase);
  HRESULT(WINAPI *CommitRequest)(ITransactionResourceAsync *This, DWORD grfRM,
                                 XACTUOW *pNewUOW);
  HRESULT(WINAPI *AbortRequest)(ITransactionResourceAsync *This,
...
#define ITransactionResourceAsync_PrepareRequest(This, fRetaining, grfRM,      \
                                                 fWantMoniker, fSinglePhase)   \
  (This)->lpVtbl->PrepareRequest(This, fRetaining, grfRM, fWantMoniker,        \
                                 fSinglePhase)
#define ITransactionResourceAsync_CommitRequest(This, grfRM, pNewUOW)          \
  (This)->lpVtbl->CommitRequest(This, grfRM, pNewUOW)
#define ITransactionResourceAsync_AbortRequest(This, pboidReason, fRetaining,  \
                                               pNewUOW)                        \
...
#endif
#endif
HRESULT WINAPI ITransactionResourceAsync_PrepareRequest_Proxy(
    ITransactionResourceAsync *This, WINBOOL fRetaining, DWORD grfRM,
    WINBOOL fWantMoniker, WINBOOL fSinglePhase);
...
HRESULT WINAPI ITransactionResourceAsync_CommitRequest_Proxy(
    ITransactionResourceAsync *This, DWORD grfRM, XACTUOW *pNewUOW);
void __RPC_STUB ITransactionResourceAsync_CommitRequest_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITransactionResourceAsync_AbortRequest_Proxy(
    ITransactionResourceAsync *This, BOID *pboidReason, WINBOOL fRetaining,
    XACTUOW *pNewUOW);
void __RPC_STUB ITransactionResourceAsync_AbortRequest_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
ITransactionResourceAsync_TMDown_Proxy(ITransactionResourceAsync *This);
...
typedef struct ITransactionLastResourceAsyncVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITransactionLastResourceAsync *This,
                                  REFIID riid, void **ppvObject);
  ULONG(WINAPI *AddRef)(ITransactionLastResourceAsync *This);
  ULONG(WINAPI *Release)(ITransactionLastResourceAsync *This);
  HRESULT(WINAPI *DelegateCommit)(ITransactionLastResourceAsync *This,
                                  DWORD grfRM);
...
#endif
#endif
HRESULT WINAPI ITransactionLastResourceAsync_DelegateCommit_Proxy(
    ITransactionLastResourceAsync *This, DWORD grfRM);
void __RPC_STUB ITransactionLastResourceAsync_DelegateCommit_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITransactionLastResourceAsync_ForgetRequest_Proxy(
    ITransactionLastResourceAsync *This, XACTUOW *pNewUOW);
...
typedef struct ITransactionResourceVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITransactionResource *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ITransactionResource *This);
  ULONG(WINAPI *Release)(ITransactionResource *This);
  HRESULT(WINAPI *PrepareRequest)(ITransactionResource *This,
                                  WINBOOL fRetaining, DWORD grfRM,
                                  WINBOOL fWantMoniker, WINBOOL fSinglePhase);
  HRESULT(WINAPI *CommitRequest)(ITransactionResource *This, DWORD grfRM,
                                 XACTUOW *pNewUOW);
  HRESULT(WINAPI *AbortRequest)(ITransactionResource *This, BOID *pboidReason,
                                WINBOOL fRetaining, XACTUOW *pNewUOW);
...
#define ITransactionResource_PrepareRequest(This, fRetaining, grfRM,           \
                                            fWantMoniker, fSinglePhase)        \
  (This)->lpVtbl->PrepareRequest(This, fRetaining, grfRM, fWantMoniker,        \
                                 fSinglePhase)
#define ITransactionResource_CommitRequest(This, grfRM, pNewUOW)               \
  (This)->lpVtbl->CommitRequest(This, grfRM, pNewUOW)
#define ITransactionResource_AbortRequest(This, pboidReason, fRetaining,       \
                                          pNewUOW)                             \
  (This)->lpVtbl->AbortRequest(This, pboidReason, fRetaining, pNewUOW)
#define ITransactionResource_TMDown(This) (This)->lpVtbl->TMDown(This)
#endif
#endif
HRESULT WINAPI ITransactionResource_PrepareRequest_Proxy(
    ITransactionResource *This, WINBOOL fRetaining, DWORD grfRM,
    WINBOOL fWantMoniker, WINBOOL fSinglePhase);
void __RPC_STUB ITransactionResource_PrepareRequest_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITransactionResource_CommitRequest_Proxy(
    ITransactionResource *This, DWORD grfRM, XACTUOW *pNewUOW);
void __RPC_STUB ITransactionResource_CommitRequest_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITransactionResource_AbortRequest_Proxy(
    ITransactionResource *This, BOID *pboidReason, WINBOOL fRetaining,
    XACTUOW *pNewUOW);
...
public:
  virtual HRESULT WINAPI PrepareRequestDone(HRESULT hr, IMoniker *pmk,
                                            BOID *pboidReason) = 0;
...
typedef struct ITransactionEnlistmentAsyncVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITransactionEnlistmentAsync *This,
                                  REFIID riid, void **ppvObject);
  ULONG(WINAPI *AddRef)(ITransactionEnlistmentAsync *This);
  ULONG(WINAPI *Release)(ITransactionEnlistmentAsync *This);
  HRESULT(WINAPI *PrepareRequestDone)(ITransactionEnlistmentAsync *This,
                                      HRESULT hr, IMoniker *pmk,
                                      BOID *pboidReason);
  HRESULT(WINAPI *CommitRequestDone)(ITransactionEnlistmentAsync *This,
                                     HRESULT hr);
  HRESULT(WINAPI *AbortRequestDone)(ITransactionEnlistmentAsync *This,
                                    HRESULT hr);
  END_INTERFACE
...
#define ITransactionEnlistmentAsync_PrepareRequestDone(This, hr, pmk,          \
                                                       pboidReason)            \
...
HRESULT WINAPI ITransactionEnlistmentAsync_PrepareRequestDone_Proxy(
    ITransactionEnlistmentAsync *This, HRESULT hr, IMoniker *pmk,
    BOID *pboidReason);
...
void __RPC_STUB ITransactionEnlistmentAsync_CommitRequestDone_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITransactionEnlistmentAsync_AbortRequestDone_Proxy(
    ITransactionEnlistmentAsync *This, HRESULT hr);
...
public:
  virtual HRESULT WINAPI TransactionOutcome(XACTSTAT XactStat,
                                            BOID *pboidReason) = 0;
};
#else
typedef struct ITransactionLastEnlistmentAsyncVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITransactionLastEnlistmentAsync *This,
                                  REFIID riid, void **ppvObject);
  ULONG(WINAPI *AddRef)(ITransactionLastEnlistmentAsync *This);
  ULONG(WINAPI *Release)(ITransactionLastEnlistmentAsync *This);
  HRESULT(WINAPI *TransactionOutcome)(ITransactionLastEnlistmentAsync *This,
                                      XACTSTAT XactStat, BOID *pboidReason);
  END_INTERFACE
...
#ifdef COBJMACROS
define ITransactionLastEnlistmentAsync_QueryInterface(This, riid,
                                                      ppvObject)(This)
...
#define ITransactionLastEnlistmentAsync_Release(This)                          \
  (This)->lpVtbl->Release(This)
#define ITransactionLastEnlistmentAsync_TransactionOutcome(This, XactStat,     \
                                                           pboidReason)        \
  (This)->lpVtbl->TransactionOutcome(This, XactStat, pboidReason)
#endif
#endif
HRESULT WINAPI ITransactionLastEnlistmentAsync_TransactionOutcome_Proxy(
    ITransactionLastEnlistmentAsync *This, XACTSTAT XactStat,
    BOID *pboidReason);
...
public:
  ...
  virtual HRESULT WINAPI Create(ULONG cbWhereabouts, byte *rgbWhereabouts,
                                ITransactionExport **ppExport) = 0;
};
#else
typedef struct ITransactionExportFactoryVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITransactionExportFactory *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ITransactionExportFactory *This);
  ULONG(WINAPI *Release)(ITransactionExportFactory *This);
  HRESULT(WINAPI *GetRemoteClassId)(ITransactionExportFactory *This,
                                    CLSID *pclsid);
  HRESULT(WINAPI *Create)(ITransactionExportFactory *This, ULONG cbWhereabouts,
                          byte *rgbWhereabouts, ITransactionExport **ppExport);
  END_INTERFACE
...
#define ITransactionExportFactory_Create(This, cbWhereabouts, rgbWhereabouts,  \
                                         ppExport)                             \
  (This)->lpVtbl->Create(This, cbWhereabouts, rgbWhereabouts, ppExport)
#endif
#endif
HRESULT WINAPI ITransactionExportFactory_GetRemoteClassId_Proxy(
    ITransactionExportFactory *This, CLSID *pclsid);
void __RPC_STUB ITransactionExportFactory_GetRemoteClassId_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITransactionExportFactory_Create_Proxy(
    ITransactionExportFactory *This, ULONG cbWhereabouts, byte *rgbWhereabouts,
...
public:
  ...
  virtual HRESULT WINAPI GetWhereabouts(ULONG cbWhereabouts,
                                        byte *rgbWhereabouts,
                                        ULONG *pcbUsed) = 0;
};
#else
typedef struct ITransactionImportWhereaboutsVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITransactionImportWhereabouts *This,
                                  REFIID riid, void **ppvObject);
  ULONG(WINAPI *AddRef)(ITransactionImportWhereabouts *This);
  ULONG(WINAPI *Release)(ITransactionImportWhereabouts *This);
  HRESULT(WINAPI *GetWhereaboutsSize)(ITransactionImportWhereabouts *This,
                                      ULONG *pcbWhereabouts);
  HRESULT(WINAPI *GetWhereabouts)(ITransactionImportWhereabouts *This,
                                  ULONG cbWhereabouts, byte *rgbWhereabouts,
                                  ULONG *pcbUsed);
  END_INTERFACE
...
#define ITransactionImportWhereabouts_GetWhereabouts(This, cbWhereabouts,      \
                                                     rgbWhereabouts, pcbUsed)  \
  (This)->lpVtbl->GetWhereabouts(This, cbWhereabouts, rgbWhereabouts, pcbUsed)
#endif
#endif
HRESULT WINAPI ITransactionImportWhereabouts_GetWhereaboutsSize_Proxy(
    ITransactionImportWhereabouts *This, ULONG *pcbWhereabouts);
void __RPC_STUB ITransactionImportWhereabouts_GetWhereaboutsSize_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITransactionImportWhereabouts_RemoteGetWhereabouts_Proxy(
    ITransactionImportWhereabouts *This, ULONG *pcbUsed, ULONG cbWhereabouts,
    byte *rgbWhereabouts);
...
public:
  virtual HRESULT WINAPI Export(IUnknown *punkTransaction,
                                ULONG *pcbTransactionCookie) = 0;
  virtual HRESULT WINAPI GetTransactionCookie(IUnknown *punkTransaction,
...
typedef struct ITransactionExportVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITransactionExport *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ITransactionExport *This);
  ULONG(WINAPI *Release)(ITransactionExport *This);
  HRESULT(WINAPI *Export)(ITransactionExport *This, IUnknown *punkTransaction,
                          ULONG *pcbTransactionCookie);
  HRESULT(WINAPI *GetTransactionCookie)(ITransactionExport *This,
...
#define ITransactionExport_GetTransactionCookie(                               \
    This, punkTransaction, cbTransactionCookie, rgbTransactionCookie, pcbUsed) \
  (This)->lpVtbl->GetTransactionCookie(This, punkTransaction,                  \
                                       cbTransactionCookie,                    \
                                       rgbTransactionCookie, pcbUsed)
#endif
#endif
HRESULT WINAPI ITransactionExport_Export_Proxy(ITransactionExport *This,
                                               IUnknown *punkTransaction,
                                               ULONG *pcbTransactionCookie);
void __RPC_STUB ITransactionExport_Export_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITransactionExport_RemoteGetTransactionCookie_Proxy(
    ITransactionExport *This, IUnknown *punkTransaction, ULONG *pcbUsed,
    ULONG cbTransactionCookie, byte *rgbTransactionCookie);
...
public:
  virtual HRESULT WINAPI Import(ULONG cbTransactionCookie,
                                byte *rgbTransactionCookie, IID *piid,
                                void **ppvTransaction) = 0;
};
#else
typedef struct ITransactionImportVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITransactionImport *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ITransactionImport *This);
  ULONG(WINAPI *Release)(ITransactionImport *This);
  HRESULT(WINAPI *Import)(ITransactionImport *This, ULONG cbTransactionCookie,
                          byte *rgbTransactionCookie, IID *piid,
                          void **ppvTransaction);
  END_INTERFACE
...
#define ITransactionImport_Import(This, cbTransactionCookie,                   \
                                  rgbTransactionCookie, piid, ppvTransaction)  \
  (This)->lpVtbl->Import(This, cbTransactionCookie, rgbTransactionCookie,      \
                         piid, ppvTransaction)
#endif
#endif
HRESULT WINAPI ITransactionImport_Import_Proxy(ITransactionImport *This,
                                               ULONG cbTransactionCookie,
                                               byte *rgbTransactionCookie,
                                               IID *piid,
                                               void **ppvTransaction);
...
public:
  virtual HRESULT WINAPI Push(char *i_pszRemoteTmUrl,
...
typedef struct ITipTransactionVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITipTransaction *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ITipTransaction *This);
  ULONG(WINAPI *Release)(ITipTransaction *This);
  HRESULT(WINAPI *Push)(ITipTransaction *This, char *i_pszRemoteTmUrl,
                        char **o_ppszRemoteTxUrl);
  HRESULT(WINAPI *GetTransactionUrl)(ITipTransaction *This,
...
#endif
#endif
HRESULT WINAPI ITipTransaction_Push_Proxy(ITipTransaction *This,
                                          char *i_pszRemoteTmUrl,
                                          char **o_ppszRemoteTxUrl);
void __RPC_STUB ITipTransaction_Push_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI ITipTransaction_GetTransactionUrl_Proxy(ITipTransaction *This,
                                                       char **o_ppszLocalTxUrl);
...
public:
  ...
  virtual HRESULT WINAPI PullAsync(char *i_pszTxUrl,
...
typedef struct ITipHelperVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITipHelper *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *PullAsync)(ITipHelper *This, char *i_pszTxUrl,
                             ITipPullSink *i_pTipPullSink,
                             ITransaction **o_ppITransaction);
...
#define ITipHelper_PullAsync(This, i_pszTxUrl, i_pTipPullSink,                 \
                             o_ppITransaction)                                 \
...
HRESULT WINAPI ITipHelper_Pull_Proxy(ITipHelper *This, char *i_pszTxUrl,
                                     ITransaction **o_ppITransaction);
void __RPC_STUB ITipHelper_Pull_Stub(IRpcStubBuffer *This,
                                     IRpcChannelBuffer *_pRpcChannelBuffer,
                                     PRPC_MESSAGE _pRpcMessage,
                                     DWORD *_pdwStubPhase);
HRESULT WINAPI ITipHelper_PullAsync_Proxy(ITipHelper *This, char *i_pszTxUrl,
                                          ITipPullSink *i_pTipPullSink,
                                          ITransaction **o_ppITransaction);
void __RPC_STUB ITipHelper_PullAsync_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI ITipHelper_GetLocalTmUrl_Proxy(ITipHelper *This,
...
typedef struct ITipPullSinkVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITipPullSink *This, REFIID riid,
                                  void **ppvObject);
...
#endif
#endif
HRESULT WINAPI ITipPullSink_PullComplete_Proxy(ITipPullSink *This,
                                               HRESULT i_hrPull);
...
public:
  ...
  GetNetworkAdministrationAccess(WINBOOL *pbNetworkAdministrationAccess) = 0;
  virtual HRESULT WINAPI
  SetNetworkAdministrationAccess(WINBOOL bNetworkAdministrationAccess) = 0;
  virtual HRESULT WINAPI
  GetNetworkTransactionAccess(WINBOOL *pbNetworkTransactionAccess) = 0;
  virtual HRESULT WINAPI
  SetNetworkTransactionAccess(WINBOOL bNetworkTransactionAccess) = 0;
  virtual HRESULT WINAPI
  GetNetworkClientAccess(WINBOOL *pbNetworkClientAccess) = 0;
  virtual HRESULT WINAPI
  SetNetworkClientAccess(WINBOOL bNetworkClientAccess) = 0;
...
typedef struct IDtcNetworkAccessConfigVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IDtcNetworkAccessConfig *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IDtcNetworkAccessConfig *This);
  ULONG(WINAPI *Release)(IDtcNetworkAccessConfig *This);
  HRESULT(WINAPI *GetAnyNetworkAccess)(IDtcNetworkAccessConfig *This,
                                       WINBOOL *pbAnyNetworkAccess);
  HRESULT(WINAPI *SetAnyNetworkAccess)(IDtcNetworkAccessConfig *This,
                                       WINBOOL bAnyNetworkAccess);
  HRESULT(WINAPI *GetNetworkAdministrationAccess)(
      IDtcNetworkAccessConfig *This, WINBOOL *pbNetworkAdministrationAccess);
  HRESULT(WINAPI *SetNetworkAdministrationAccess)(
      IDtcNetworkAccessConfig *This, WINBOOL bNetworkAdministrationAccess);
  HRESULT(WINAPI *GetNetworkTransactionAccess)(
      IDtcNetworkAccessConfig *This, WINBOOL *pbNetworkTransactionAccess);
  HRESULT(WINAPI *SetNetworkTransactionAccess)(
      IDtcNetworkAccessConfig *This, WINBOOL bNetworkTransactionAccess);
  HRESULT(WINAPI *GetNetworkClientAccess)(IDtcNetworkAccessConfig *This,
                                          WINBOOL *pbNetworkClientAccess);
  HRESULT(WINAPI *SetNetworkClientAccess)(IDtcNetworkAccessConfig *This,
                                          WINBOOL bNetworkClientAccess);
  HRESULT(WINAPI *GetNetworkTIPAccess)(IDtcNetworkAccessConfig *This,
                                       WINBOOL *pbNetworkTIPAccess);
  HRESULT(WINAPI *SetNetworkTIPAccess)(IDtcNetworkAccessConfig *This,
                                       WINBOOL bNetworkTIPAccess);
  HRESULT(WINAPI *GetXAAccess)(IDtcNetworkAccessConfig *This,
                               WINBOOL *pbXAAccess);
  HRESULT(WINAPI *SetXAAccess)(IDtcNetworkAccessConfig *This,
                               WINBOOL bXAAccess);
...
#define IDtcNetworkAccessConfig_GetNetworkAdministrationAccess(                \
    This, pbNetworkAdministrationAccess)                                       \
  (This)->lpVtbl->GetNetworkAdministrationAccess(                              \
      This, pbNetworkAdministrationAccess)
#define IDtcNetworkAccessConfig_SetNetworkAdministrationAccess(                \
    This, bNetworkAdministrationAccess)                                        \
  (This)->lpVtbl->SetNetworkAdministrationAccess(This,                         \
                                                 bNetworkAdministrationAccess)
#define IDtcNetworkAccessConfig_GetNetworkTransactionAccess(                   \
    This, pbNetworkTransactionAccess)                                          \
  (This)->lpVtbl->GetNetworkTransactionAccess(This, pbNetworkTransactionAccess)
#define IDtcNetworkAccessConfig_SetNetworkTransactionAccess(                   \
    This, bNetworkTransactionAccess)                                           \
  (This)->lpVtbl->SetNetworkTransactionAccess(This, bNetworkTransactionAccess)
#define IDtcNetworkAccessConfig_GetNetworkClientAccess(This,                   \
                                                       pbNetworkClientAccess)  \
  (This)->lpVtbl->GetNetworkClientAccess(This, pbNetworkClientAccess)
#define IDtcNetworkAccessConfig_SetNetworkClientAccess(This,                   \
...
HRESULT WINAPI IDtcNetworkAccessConfig_GetAnyNetworkAccess_Proxy(
    IDtcNetworkAccessConfig *This, WINBOOL *pbAnyNetworkAccess);
...
HRESULT WINAPI IDtcNetworkAccessConfig_SetAnyNetworkAccess_Proxy(
    IDtcNetworkAccessConfig *This, WINBOOL bAnyNetworkAccess);
void __RPC_STUB IDtcNetworkAccessConfig_SetAnyNetworkAccess_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IDtcNetworkAccessConfig_GetNetworkAdministrationAccess_Proxy(
    IDtcNetworkAccessConfig *This, WINBOOL *pbNetworkAdministrationAccess);
void __RPC_STUB IDtcNetworkAccessConfig_GetNetworkAdministrationAccess_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IDtcNetworkAccessConfig_SetNetworkAdministrationAccess_Proxy(
    IDtcNetworkAccessConfig *This, WINBOOL bNetworkAdministrationAccess);
void __RPC_STUB IDtcNetworkAccessConfig_SetNetworkAdministrationAccess_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IDtcNetworkAccessConfig_GetNetworkTransactionAccess_Proxy(
    IDtcNetworkAccessConfig *This, WINBOOL *pbNetworkTransactionAccess);
void __RPC_STUB IDtcNetworkAccessConfig_GetNetworkTransactionAccess_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IDtcNetworkAccessConfig_SetNetworkTransactionAccess_Proxy(
    IDtcNetworkAccessConfig *This, WINBOOL bNetworkTransactionAccess);
void __RPC_STUB IDtcNetworkAccessConfig_SetNetworkTransactionAccess_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IDtcNetworkAccessConfig_GetNetworkClientAccess_Proxy(
    IDtcNetworkAccessConfig *This, WINBOOL *pbNetworkClientAccess);
void __RPC_STUB IDtcNetworkAccessConfig_GetNetworkClientAccess_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IDtcNetworkAccessConfig_SetNetworkClientAccess_Proxy(
    IDtcNetworkAccessConfig *This, WINBOOL bNetworkClientAccess);
void __RPC_STUB IDtcNetworkAccessConfig_SetNetworkClientAccess_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IDtcNetworkAccessConfig_GetNetworkTIPAccess_Proxy(
    IDtcNetworkAccessConfig *This, WINBOOL *pbNetworkTIPAccess);
void __RPC_STUB IDtcNetworkAccessConfig_GetNetworkTIPAccess_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IDtcNetworkAccessConfig_SetNetworkTIPAccess_Proxy(
    IDtcNetworkAccessConfig *This, WINBOOL bNetworkTIPAccess);
void __RPC_STUB IDtcNetworkAccessConfig_SetNetworkTIPAccess_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IDtcNetworkAccessConfig_GetXAAccess_Proxy(
    IDtcNetworkAccessConfig *This, WINBOOL *pbXAAccess);
void __RPC_STUB IDtcNetworkAccessConfig_GetXAAccess_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IDtcNetworkAccessConfig_SetXAAccess_Proxy(
    IDtcNetworkAccessConfig *This, WINBOOL bXAAccess);
void __RPC_STUB IDtcNetworkAccessConfig_SetXAAccess_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
IDtcNetworkAccessConfig_RestartDtcService_Proxy(IDtcNetworkAccessConfig *This);
...
public:
  ...
  virtual HRESULT WINAPI
  GetAuthenticationLevel(AUTHENTICATION_LEVEL *pAuthLevel) = 0;
  virtual HRESULT WINAPI
  SetAuthenticationLevel(AUTHENTICATION_LEVEL AuthLevel) = 0;
};
#else
typedef struct IDtcNetworkAccessConfig2Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IDtcNetworkAccessConfig2 *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IDtcNetworkAccessConfig2 *This);
  ULONG(WINAPI *Release)(IDtcNetworkAccessConfig2 *This);
  HRESULT(WINAPI *GetAnyNetworkAccess)(IDtcNetworkAccessConfig2 *This,
                                       WINBOOL *pbAnyNetworkAccess);
  HRESULT(WINAPI *SetAnyNetworkAccess)(IDtcNetworkAccessConfig2 *This,
                                       WINBOOL bAnyNetworkAccess);
  HRESULT(WINAPI *GetNetworkAdministrationAccess)(
      IDtcNetworkAccessConfig2 *This, WINBOOL *pbNetworkAdministrationAccess);
  HRESULT(WINAPI *SetNetworkAdministrationAccess)(
      IDtcNetworkAccessConfig2 *This, WINBOOL bNetworkAdministrationAccess);
  HRESULT(WINAPI *GetNetworkTransactionAccess)(
      IDtcNetworkAccessConfig2 *This, WINBOOL *pbNetworkTransactionAccess);
  HRESULT(WINAPI *SetNetworkTransactionAccess)(
      IDtcNetworkAccessConfig2 *This, WINBOOL bNetworkTransactionAccess);
  HRESULT(WINAPI *GetNetworkClientAccess)(IDtcNetworkAccessConfig2 *This,
                                          WINBOOL *pbNetworkClientAccess);
  HRESULT(WINAPI *SetNetworkClientAccess)(IDtcNetworkAccessConfig2 *This,
                                          WINBOOL bNetworkClientAccess);
  HRESULT(WINAPI *GetNetworkTIPAccess)(IDtcNetworkAccessConfig2 *This,
                                       WINBOOL *pbNetworkTIPAccess);
  HRESULT(WINAPI *SetNetworkTIPAccess)(IDtcNetworkAccessConfig2 *This,
                                       WINBOOL bNetworkTIPAccess);
  HRESULT(WINAPI *GetXAAccess)(IDtcNetworkAccessConfig2 *This,
                               WINBOOL *pbXAAccess);
  HRESULT(WINAPI *SetXAAccess)(IDtcNetworkAccessConfig2 *This,
                               WINBOOL bXAAccess);
  HRESULT(WINAPI *RestartDtcService)(IDtcNetworkAccessConfig2 *This);
  HRESULT(WINAPI *GetNetworkInboundAccess)(IDtcNetworkAccessConfig2 *This,
                                           WINBOOL *pbInbound);
  HRESULT(WINAPI *GetNetworkOutboundAccess)(IDtcNetworkAccessConfig2 *This,
                                            WINBOOL *pbOutbound);
  HRESULT(WINAPI *SetNetworkInboundAccess)(IDtcNetworkAccessConfig2 *This,
                                           WINBOOL bInbound);
  HRESULT(WINAPI *SetNetworkOutboundAccess)(IDtcNetworkAccessConfig2 *This,
                                            WINBOOL bOutbound);
  HRESULT(WINAPI *GetAuthenticationLevel)(IDtcNetworkAccessConfig2 *This,
                                          AUTHENTICATION_LEVEL *pAuthLevel);
  HRESULT(WINAPI *SetAuthenticationLevel)(IDtcNetworkAccessConfig2 *This,
...
#define IDtcNetworkAccessConfig2_SetAnyNetworkAccess(This, bAnyNetworkAccess)  \
  (This)->lpVtbl->SetAnyNetworkAccess(This, bAnyNetworkAccess)
#define IDtcNetworkAccessConfig2_GetNetworkAdministrationAccess(               \
    This, pbNetworkAdministrationAccess)                                       \
  (This)->lpVtbl->GetNetworkAdministrationAccess(                              \
      This, pbNetworkAdministrationAccess)
#define IDtcNetworkAccessConfig2_SetNetworkAdministrationAccess(               \
    This, bNetworkAdministrationAccess)                                        \
  (This)->lpVtbl->SetNetworkAdministrationAccess(This,                         \
                                                 bNetworkAdministrationAccess)
#define IDtcNetworkAccessConfig2_GetNetworkTransactionAccess(                  \
    This, pbNetworkTransactionAccess)                                          \
  (This)->lpVtbl->GetNetworkTransactionAccess(This, pbNetworkTransactionAccess)
#define IDtcNetworkAccessConfig2_SetNetworkTransactionAccess(                  \
    This, bNetworkTransactionAccess)                                           \
  (This)->lpVtbl->SetNetworkTransactionAccess(This, bNetworkTransactionAccess)
#define IDtcNetworkAccessConfig2_GetNetworkClientAccess(This,                  \
                                                        pbNetworkClientAccess) \
  (This)->lpVtbl->GetNetworkClientAccess(This, pbNetworkClientAccess)
#define IDtcNetworkAccessConfig2_SetNetworkClientAccess(This,                  \
                                                        bNetworkClientAccess)  \
  (This)->lpVtbl->SetNetworkClientAccess(This, bNetworkClientAccess)
...
#endif
#endif
HRESULT WINAPI IDtcNetworkAccessConfig2_GetNetworkInboundAccess_Proxy(
    IDtcNetworkAccessConfig2 *This, WINBOOL *pbInbound);
...
HRESULT WINAPI IDtcNetworkAccessConfig2_GetNetworkOutboundAccess_Proxy(
    IDtcNetworkAccessConfig2 *This, WINBOOL *pbOutbound);
void __RPC_STUB IDtcNetworkAccessConfig2_GetNetworkOutboundAccess_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IDtcNetworkAccessConfig2_SetNetworkInboundAccess_Proxy(
    IDtcNetworkAccessConfig2 *This, WINBOOL bInbound);
void __RPC_STUB IDtcNetworkAccessConfig2_SetNetworkInboundAccess_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IDtcNetworkAccessConfig2_SetNetworkOutboundAccess_Proxy(
    IDtcNetworkAccessConfig2 *This, WINBOOL bOutbound);
...
HRESULT WINAPI IDtcNetworkAccessConfig2_GetAuthenticationLevel_Proxy(
    IDtcNetworkAccessConfig2 *This, AUTHENTICATION_LEVEL *pAuthLevel);
void __RPC_STUB IDtcNetworkAccessConfig2_GetAuthenticationLevel_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IDtcNetworkAccessConfig2_SetAuthenticationLevel_Proxy(
    IDtcNetworkAccessConfig2 *This, AUTHENTICATION_LEVEL AuthLevel);
void __RPC_STUB IDtcNetworkAccessConfig2_SetAuthenticationLevel_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
#endif
DEFINE_GUID(IID_ITransactionResourceAsync, 0x69E971F0, 0x23CE, 0x11cf, 0xAD,
            0x60, 0x00, 0xAA, 0x00, 0xA7, 0x4C, 0xCD);
DEFINE_GUID(IID_ITransactionLastResourceAsync, 0xC82BD532, 0x5B30, 0x11D3, 0x8A,
            0x91, 0x00, 0xC0, 0x4F, 0x79, 0xEB, 0x6D);
DEFINE_GUID(IID_ITransactionResource, 0xEE5FF7B3, 0x4572, 0x11d0, 0x94, 0x52,
            0x00, 0xA0, 0xC9, 0x05, 0x41, 0x6E);
DEFINE_GUID(IID_ITransactionEnlistmentAsync, 0x0fb15081, 0xaf41, 0x11ce, 0xbd,
            0x2b, 0x20, 0x4c, 0x4f, 0x4f, 0x50, 0x20);
DEFINE_GUID(IID_ITransactionLastEnlistmentAsync, 0xC82BD533, 0x5B30, 0x11D3,
            0x8A, 0x91, 0x00, 0xC0, 0x4F, 0x79, 0xEB, 0x6D);
DEFINE_GUID(IID_ITransactionExportFactory, 0xE1CF9B53, 0x8745, 0x11ce, 0xA9,
            0xBA, 0x00, 0xAA, 0x00, 0x6C, 0x37, 0x06);
DEFINE_GUID(IID_ITransactionImportWhereabouts, 0x0141fda4, 0x8fc0, 0x11ce, 0xbd,
            0x18, 0x20, 0x4c, 0x4f, 0x4f, 0x50, 0x20);
DEFINE_GUID(IID_ITransactionExport, 0x0141fda5, 0x8fc0, 0x11ce, 0xbd, 0x18,
            0x20, 0x4c, 0x4f, 0x4f, 0x50, 0x20);
DEFINE_GUID(IID_ITransactionImport, 0xE1CF9B5A, 0x8745, 0x11ce, 0xA9, 0xBA,
            0x00, 0xAA, 0x00, 0x6C, 0x37, 0x06);
DEFINE_GUID(IID_ITipTransaction, 0x17cf72d0, 0xbac5, 0x11d1, 0xb1, 0xbf, 0x0,
            0xc0, 0x4f, 0xc2, 0xf3, 0xef);
DEFINE_GUID(IID_ITipHelper, 0x17cf72d1, 0xbac5, 0x11d1, 0xb1, 0xbf, 0x0, 0xc0,
            0x4f, 0xc2, 0xf3, 0xef);
DEFINE_GUID(IID_ITipPullSink, 0x17cf72d2, 0xbac5, 0x11d1, 0xb1, 0xbf, 0x0, 0xc0,
            0x4f, 0xc2, 0xf3, 0xef);
DEFINE_GUID(IID_IDtcNetworkAccessConfig, 0x9797c15d, 0xa428, 0x4291, 0x87, 0xb6,
            0x9, 0x95, 0x3, 0x1a, 0x67, 0x8d);
DEFINE_GUID(IID_IDtcNetworkAccessConfig2, 0xa7aa013b, 0xeb7d, 0x4f42, 0xb4,
            0x1c, 0xb2, 0xde, 0xc0, 0x9a, 0xe0, 0x34);
extern RPC_IF_HANDLE __MIDL_itf_txcoord_0116_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_txcoord_0116_v0_0_s_ifspec;
HRESULT WINAPI ITransactionImportWhereabouts_GetWhereabouts_Proxy(
    ITransactionImportWhereabouts *This, ULONG cbWhereabouts,
    byte *rgbWhereabouts, ULONG *pcbUsed);
HRESULT WINAPI ITransactionImportWhereabouts_GetWhereabouts_Stub(
    ITransactionImportWhereabouts *This, ULONG *pcbUsed, ULONG cbWhereabouts,
    byte *rgbWhereabouts);
HRESULT WINAPI ITransactionExport_GetTransactionCookie_Proxy(
    ITransactionExport *This, IUnknown *punkTransaction,
    ULONG cbTransactionCookie, byte *rgbTransactionCookie, ULONG *pcbUsed);
HRESULT WINAPI ITransactionExport_GetTransactionCookie_Stub(
    ITransactionExport *This, IUnknown *punkTransaction, ULONG *pcbUsed,
    ULONG cbTransactionCookie, byte *rgbTransactionCookie);
#ifdef __cplusplus
}
