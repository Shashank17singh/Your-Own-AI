...
typedef enum IdleEnum { dbFreeLocks = 1, dbRefreshCache = 8 } IdleEnum;
...
DECLARE_INTERFACE_(_DAODBEngine, _DAO) {
  ...
  STDMETHOD(CompactDatabase)(THIS_ BSTR SrcName, BSTR DstName,
                             VARIANT DstLocale, VARIANT Options,
                             VARIANT SrcLocale) PURE;
  STDMETHOD(RepairDatabase)(THIS_ BSTR Name) PURE;
  STDMETHOD(RegisterDatabase)(THIS_ BSTR Dsn, BSTR Driver, VARIANT_BOOL Silent,
                              BSTR Attributes) PURE;
  STDMETHOD(_30_CreateWorkspace)(THIS_ BSTR Name, BSTR UserName, BSTR Password,
                                 interface DAOWorkspace * *ppwrk) PURE;
  STDMETHOD(OpenDatabase)(THIS_ BSTR Name, VARIANT Options, VARIANT ReadOnly,
                          VARIANT Connect, interface DAODatabase * *ppdb) PURE;
  STDMETHOD(CreateDatabase)(THIS_ BSTR Name, BSTR Locale, VARIANT Option,
                            interface DAODatabase * *ppdb) PURE;
  ...
  STDMETHOD(ISAMStats)(THIS_ __LONG32 StatNum, VARIANT Reset, __LONG32 * pl)
      PURE;
  STDMETHOD(get_SystemDB)(THIS_ BSTR * pbstr) PURE;
  STDMETHOD(put_SystemDB)(THIS_ BSTR SystemDBPath) PURE;
  STDMETHOD(CreateWorkspace)(THIS_ BSTR Name, BSTR UserName, BSTR Password,
                             VARIANT UseType, interface DAOWorkspace * *ppwrk)
      PURE;
  STDMETHOD(OpenConnection)(THIS_ BSTR Name, VARIANT Options, VARIANT ReadOnly,
                            VARIANT Connect, interface DAOConnection * *ppconn)
      PURE;
...
DECLARE_INTERFACE_(DAOWorkspace, _DAO) {
  ...
  STDMETHOD(OpenDatabase)(THIS_ BSTR Name, VARIANT Options, VARIANT ReadOnly,
                          VARIANT Connect, interface DAODatabase * *ppdb) PURE;
  STDMETHOD(CreateDatabase)(THIS_ BSTR Name, BSTR Connect, VARIANT Option,
                            interface DAODatabase * *ppdb) PURE;
  STDMETHOD(CreateUser)(THIS_ VARIANT Name, VARIANT PID, VARIANT Password,
                        interface DAOUser * *ppusr) PURE;
  STDMETHOD(CreateGroup)(THIS_ VARIANT Name, VARIANT PID,
                         interface DAOGroup * *ppgrp) PURE;
  STDMETHOD(OpenConnection)(THIS_ BSTR Name, VARIANT Options, VARIANT ReadOnly,
                            VARIANT Connect, interface DAOConnection * *ppconn)
      PURE;
...
DECLARE_INTERFACE_(DAOConnection, IDispatch) {
  ...
  STDMETHOD(Close)(THIS) PURE;
  STDMETHOD(CreateQueryDef)(THIS_ VARIANT Name, VARIANT SQLText,
                            interface DAOQueryDef * *ppqdf) PURE;
  STDMETHOD(Execute)(THIS_ BSTR Query, VARIANT Options) PURE;
  STDMETHOD(OpenRecordset)(THIS_ BSTR Name, VARIANT Type, VARIANT Options,
                           VARIANT LockEdit, interface DAORecordset * *pprst)
      PURE;
};
#undef INTERFACE
...
DECLARE_INTERFACE_(DAODatabase, _DAO) {
  ...
  STDMETHOD(Close)(THIS) PURE;
  STDMETHOD(Execute)(THIS_ BSTR Query, VARIANT Options) PURE;
  STDMETHOD(_30_OpenRecordset)(THIS_ BSTR Name, VARIANT Type, VARIANT Options,
                               interface DAORecordset * *pprst) PURE;
  STDMETHOD(CreateProperty)(THIS_ VARIANT Name, VARIANT Type, VARIANT Value,
                            VARIANT DDL, DAOProperty * *pprp) PURE;
  STDMETHOD(CreateRelation)(THIS_ VARIANT Name, VARIANT Table,
                            VARIANT ForeignTable, VARIANT Attributes,
                            interface DAORelation * *pprel) PURE;
  STDMETHOD(CreateTableDef)(THIS_ VARIANT Name, VARIANT Attributes,
                            VARIANT SourceTablename, VARIANT Connect,
                            interface DAOTableDef * *pptdf) PURE;
  STDMETHOD(BeginTrans)(THIS) PURE;
  STDMETHOD(CommitTrans)(THIS_ __LONG32 Options) PURE;
  STDMETHOD(Rollback)(THIS) PURE;
  STDMETHOD(CreateDynaset)(THIS_ BSTR Name, VARIANT Options,
                           VARIANT Inconsistent,
                           interface DAORecordset * *pprst) PURE;
  STDMETHOD(CreateQueryDef)(THIS_ VARIANT Name, VARIANT SQLText,
                            interface DAOQueryDef * *ppqdf) PURE;
  STDMETHOD(CreateSnapshot)(THIS_ BSTR Source, VARIANT Options,
                            interface DAORecordset * *pprst) PURE;
  ...
  STDMETHOD(OpenTable)(THIS_ BSTR Name, VARIANT Options,
                       interface DAORecordset * *pprst) PURE;
  ...
  STDMETHOD(MakeReplica)(THIS_ BSTR PathName, BSTR Description, VARIANT Options)
      PURE;
...
DECLARE_INTERFACE_(_DAOTableDef, _DAO) {
  ...
  STDMETHOD(OpenRecordset)(THIS_ VARIANT Type, VARIANT Options,
                           interface DAORecordset * *pprst) PURE;
  STDMETHOD(RefreshLink)(THIS) PURE;
  STDMETHOD(CreateField)(THIS_ VARIANT Name, VARIANT Type, VARIANT Size,
                         interface DAOField * *ppfld) PURE;
...
DECLARE_INTERFACE_(_DAOQueryDef, _DAO) {
  ...
  STDMETHOD(Close)(THIS) PURE;
  STDMETHOD(_30_OpenRecordset)(THIS_ VARIANT Type, VARIANT Options,
                               interface DAORecordset * *pprst) PURE;
  STDMETHOD(_30__OpenRecordset)(THIS_ VARIANT Type, VARIANT Options,
                                interface DAORecordset * *pprst) PURE;
  ...
  STDMETHOD(CreateDynaset)(THIS_ VARIANT Options, VARIANT Inconsistent,
                           interface DAORecordset * *pprst) PURE;
  STDMETHOD(CreateSnapshot)(THIS_ VARIANT Options,
                            interface DAORecordset * *pprst) PURE;
  ...
  STDMETHOD(OpenRecordset)(THIS_ VARIANT Type, VARIANT Options,
                           VARIANT LockEdit, interface DAORecordset * *pprst)
      PURE;
  STDMETHOD(_OpenRecordset)(THIS_ VARIANT Type, VARIANT Options,
                            VARIANT LockEdit, interface DAORecordset * *pprst)
      PURE;
  STDMETHOD(Cancel)(THIS) PURE;
...
DECLARE_INTERFACE_(DAORecordset, _DAO) {
  ...
  STDMETHOD(Seek)(THIS_ BSTR Comparison, VARIANT Key1, VARIANT Key2,
                  VARIANT Key3, VARIANT Key4, VARIANT Key5, VARIANT Key6,
                  VARIANT Key7, VARIANT Key8, VARIANT Key9, VARIANT Key10,
                  VARIANT Key11, VARIANT Key12, VARIANT Key13) PURE;
...
DECLARE_INTERFACE_(_DAOField, _DAO) {
  ...
  STDMETHOD(GetChunk)(THIS_ __LONG32 Offset, __LONG32 Bytes, VARIANT * pvar)
      PURE;
