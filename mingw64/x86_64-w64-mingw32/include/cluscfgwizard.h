...
public:
  ...
  put_ServiceAccountName(BSTR bstrServiceAccountNameIn) = 0;
  virtual HRESULT WINAPI
  get_ServiceAccountName(BSTR *pbstrServiceAccountNameOut) = 0;
  virtual HRESULT WINAPI
  put_ServiceAccountDomain(BSTR bstrServiceAccountDomainIn) = 0;
  virtual HRESULT WINAPI
  get_ServiceAccountDomain(BSTR *pbstrServiceAccountDomainOut) = 0;
  ...
  virtual HRESULT WINAPI
  get_ClusterIPAddress(BSTR *pbstrClusterIPAddressOut) = 0;
  virtual HRESULT WINAPI get_ClusterIPSubnet(BSTR *pbstrClusterIPSubnetOut) = 0;
  virtual HRESULT WINAPI
  get_ClusterIPAddressNetwork(BSTR *pbstrClusterNetworkNameOut) = 0;
  virtual HRESULT WINAPI
  put_FirstNodeInCluster(BSTR bstrFirstNodeInClusterIn) = 0;
  virtual HRESULT WINAPI
  get_FirstNodeInCluster(BSTR *pbstrFirstNodeInClusterOut) = 0;
  virtual HRESULT WINAPI
  put_MinimumConfiguration(VARIANT_BOOL fMinConfigIn) = 0;
  virtual HRESULT WINAPI
  get_MinimumConfiguration(VARIANT_BOOL *pfMinConfigOut) = 0;
  virtual HRESULT WINAPI ShowWizard(__LONG32 lParentWindowHandleIn,
                                    VARIANT_BOOL *pfCompletedOut) = 0;
};
#else
typedef struct IClusCfgCreateClusterWizardVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IClusCfgCreateClusterWizard *This,
                                  REFIID riid, void **ppvObject);
  ULONG(WINAPI *AddRef)(IClusCfgCreateClusterWizard *This);
  ULONG(WINAPI *Release)(IClusCfgCreateClusterWizard *This);
  HRESULT(WINAPI *GetTypeInfoCount)(IClusCfgCreateClusterWizard *This,
                                    UINT *pctinfo);
  HRESULT(WINAPI *GetTypeInfo)(IClusCfgCreateClusterWizard *This, UINT iTInfo,
                               LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IClusCfgCreateClusterWizard *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IClusCfgCreateClusterWizard *This,
                          DISPID dispIdMember, REFIID riid, LCID lcid,
                          WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *put_ClusterName)(IClusCfgCreateClusterWizard *This,
                                   BSTR bstrClusterNameIn);
  HRESULT(WINAPI *get_ClusterName)(IClusCfgCreateClusterWizard *This,
                                   BSTR *pbstrClusterNameOut);
  HRESULT(WINAPI *put_ServiceAccountName)(IClusCfgCreateClusterWizard *This,
                                          BSTR bstrServiceAccountNameIn);
  HRESULT(WINAPI *get_ServiceAccountName)(IClusCfgCreateClusterWizard *This,
                                          BSTR *pbstrServiceAccountNameOut);
  HRESULT(WINAPI *put_ServiceAccountDomain)(IClusCfgCreateClusterWizard *This,
                                            BSTR bstrServiceAccountDomainIn);
  HRESULT(WINAPI *get_ServiceAccountDomain)(IClusCfgCreateClusterWizard *This,
                                            BSTR *pbstrServiceAccountDomainOut);
  HRESULT(WINAPI *put_ServiceAccountPassword)(IClusCfgCreateClusterWizard *This,
                                              BSTR bstrPasswordIn);
  HRESULT(WINAPI *put_ClusterIPAddress)(IClusCfgCreateClusterWizard *This,
                                        BSTR bstrClusterIPAddressIn);
  HRESULT(WINAPI *get_ClusterIPAddress)(IClusCfgCreateClusterWizard *This,
                                        BSTR *pbstrClusterIPAddressOut);
  HRESULT(WINAPI *get_ClusterIPSubnet)(IClusCfgCreateClusterWizard *This,
                                       BSTR *pbstrClusterIPSubnetOut);
  HRESULT(WINAPI *get_ClusterIPAddressNetwork)(
      IClusCfgCreateClusterWizard *This, BSTR *pbstrClusterNetworkNameOut);
  HRESULT(WINAPI *put_FirstNodeInCluster)(IClusCfgCreateClusterWizard *This,
                                          BSTR bstrFirstNodeInClusterIn);
  HRESULT(WINAPI *get_FirstNodeInCluster)(IClusCfgCreateClusterWizard *This,
                                          BSTR *pbstrFirstNodeInClusterOut);
  HRESULT(WINAPI *put_MinimumConfiguration)(IClusCfgCreateClusterWizard *This,
                                            VARIANT_BOOL fMinConfigIn);
  HRESULT(WINAPI *get_MinimumConfiguration)(IClusCfgCreateClusterWizard *This,
                                            VARIANT_BOOL *pfMinConfigOut);
  HRESULT(WINAPI *ShowWizard)(IClusCfgCreateClusterWizard *This,
                              __LONG32 lParentWindowHandleIn,
...
#define IClusCfgCreateClusterWizard_GetIDsOfNames(This, riid, rgszNames,       \
                                                  cNames, lcid, rgDispId)      \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IClusCfgCreateClusterWizard_Invoke(This, dispIdMember, riid, lcid,     \
...
#define IClusCfgCreateClusterWizard_put_ServiceAccountName(                    \
    This, bstrServiceAccountNameIn)                                            \
  (This)->lpVtbl->put_ServiceAccountName(This, bstrServiceAccountNameIn)
#define IClusCfgCreateClusterWizard_get_ServiceAccountName(                    \
    This, pbstrServiceAccountNameOut)                                          \
  (This)->lpVtbl->get_ServiceAccountName(This, pbstrServiceAccountNameOut)
#define IClusCfgCreateClusterWizard_put_ServiceAccountDomain(                  \
    This, bstrServiceAccountDomainIn)                                          \
  (This)->lpVtbl->put_ServiceAccountDomain(This, bstrServiceAccountDomainIn)
#define IClusCfgCreateClusterWizard_get_ServiceAccountDomain(                  \
    This, pbstrServiceAccountDomainOut)                                        \
  (This)->lpVtbl->get_ServiceAccountDomain(This, pbstrServiceAccountDomainOut)
#define IClusCfgCreateClusterWizard_put_ServiceAccountPassword(This,           \
                                                               bstrPasswordIn) \
  (This)->lpVtbl->put_ServiceAccountPassword(This, bstrPasswordIn)
#define IClusCfgCreateClusterWizard_put_ClusterIPAddress(                      \
    This, bstrClusterIPAddressIn)                                              \
  (This)->lpVtbl->put_ClusterIPAddress(This, bstrClusterIPAddressIn)
#define IClusCfgCreateClusterWizard_get_ClusterIPAddress(                      \
    This, pbstrClusterIPAddressOut)                                            \
  (This)->lpVtbl->get_ClusterIPAddress(This, pbstrClusterIPAddressOut)
#define IClusCfgCreateClusterWizard_get_ClusterIPSubnet(                       \
    This, pbstrClusterIPSubnetOut)                                             \
  (This)->lpVtbl->get_ClusterIPSubnet(This, pbstrClusterIPSubnetOut)
#define IClusCfgCreateClusterWizard_get_ClusterIPAddressNetwork(               \
    This, pbstrClusterNetworkNameOut)                                          \
  (This)->lpVtbl->get_ClusterIPAddressNetwork(This, pbstrClusterNetworkNameOut)
#define IClusCfgCreateClusterWizard_put_FirstNodeInCluster(                    \
    This, bstrFirstNodeInClusterIn)                                            \
  (This)->lpVtbl->put_FirstNodeInCluster(This, bstrFirstNodeInClusterIn)
#define IClusCfgCreateClusterWizard_get_FirstNodeInCluster(                    \
    This, pbstrFirstNodeInClusterOut)                                          \
  (This)->lpVtbl->get_FirstNodeInCluster(This, pbstrFirstNodeInClusterOut)
#define IClusCfgCreateClusterWizard_put_MinimumConfiguration(This,             \
                                                             fMinConfigIn)     \
  (This)->lpVtbl->put_MinimumConfiguration(This, fMinConfigIn)
#define IClusCfgCreateClusterWizard_get_MinimumConfiguration(This,             \
                                                             pfMinConfigOut)   \
  (This)->lpVtbl->get_MinimumConfiguration(This, pfMinConfigOut)
#define IClusCfgCreateClusterWizard_ShowWizard(This, lParentWindowHandleIn,    \
                                               pfCompletedOut)                 \
  (This)->lpVtbl->ShowWizard(This, lParentWindowHandleIn, pfCompletedOut)
#endif
#endif
HRESULT WINAPI IClusCfgCreateClusterWizard_put_ClusterName_Proxy(
...
HRESULT WINAPI IClusCfgCreateClusterWizard_get_ClusterName_Proxy(
    IClusCfgCreateClusterWizard *This, BSTR *pbstrClusterNameOut);
void __RPC_STUB IClusCfgCreateClusterWizard_get_ClusterName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IClusCfgCreateClusterWizard_put_ServiceAccountName_Proxy(
    IClusCfgCreateClusterWizard *This, BSTR bstrServiceAccountNameIn);
void __RPC_STUB IClusCfgCreateClusterWizard_put_ServiceAccountName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IClusCfgCreateClusterWizard_get_ServiceAccountName_Proxy(
    IClusCfgCreateClusterWizard *This, BSTR *pbstrServiceAccountNameOut);
void __RPC_STUB IClusCfgCreateClusterWizard_get_ServiceAccountName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IClusCfgCreateClusterWizard_put_ServiceAccountDomain_Proxy(
    IClusCfgCreateClusterWizard *This, BSTR bstrServiceAccountDomainIn);
void __RPC_STUB IClusCfgCreateClusterWizard_put_ServiceAccountDomain_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IClusCfgCreateClusterWizard_get_ServiceAccountDomain_Proxy(
    IClusCfgCreateClusterWizard *This, BSTR *pbstrServiceAccountDomainOut);
...
HRESULT WINAPI IClusCfgCreateClusterWizard_put_ServiceAccountPassword_Proxy(
    IClusCfgCreateClusterWizard *This, BSTR bstrPasswordIn);
void __RPC_STUB IClusCfgCreateClusterWizard_put_ServiceAccountPassword_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IClusCfgCreateClusterWizard_put_ClusterIPAddress_Proxy(
    IClusCfgCreateClusterWizard *This, BSTR bstrClusterIPAddressIn);
void __RPC_STUB IClusCfgCreateClusterWizard_put_ClusterIPAddress_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IClusCfgCreateClusterWizard_get_ClusterIPAddress_Proxy(
    IClusCfgCreateClusterWizard *This, BSTR *pbstrClusterIPAddressOut);
void __RPC_STUB IClusCfgCreateClusterWizard_get_ClusterIPAddress_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IClusCfgCreateClusterWizard_get_ClusterIPSubnet_Proxy(
    IClusCfgCreateClusterWizard *This, BSTR *pbstrClusterIPSubnetOut);
void __RPC_STUB IClusCfgCreateClusterWizard_get_ClusterIPSubnet_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IClusCfgCreateClusterWizard_get_ClusterIPAddressNetwork_Proxy(
    IClusCfgCreateClusterWizard *This, BSTR *pbstrClusterNetworkNameOut);
void __RPC_STUB IClusCfgCreateClusterWizard_get_ClusterIPAddressNetwork_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IClusCfgCreateClusterWizard_put_FirstNodeInCluster_Proxy(
    IClusCfgCreateClusterWizard *This, BSTR bstrFirstNodeInClusterIn);
void __RPC_STUB IClusCfgCreateClusterWizard_put_FirstNodeInCluster_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IClusCfgCreateClusterWizard_get_FirstNodeInCluster_Proxy(
    IClusCfgCreateClusterWizard *This, BSTR *pbstrFirstNodeInClusterOut);
...
void __RPC_STUB IClusCfgCreateClusterWizard_put_MinimumConfiguration_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IClusCfgCreateClusterWizard_get_MinimumConfiguration_Proxy(
    IClusCfgCreateClusterWizard *This, VARIANT_BOOL *pfMinConfigOut);
void __RPC_STUB IClusCfgCreateClusterWizard_get_MinimumConfiguration_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IClusCfgCreateClusterWizard_ShowWizard_Proxy(
    IClusCfgCreateClusterWizard *This, __LONG32 lParentWindowHandleIn,
    VARIANT_BOOL *pfCompletedOut);
...
typedef struct IClusCfgAddNodesWizardVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IClusCfgAddNodesWizard *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IClusCfgAddNodesWizard *This);
  ULONG(WINAPI *Release)(IClusCfgAddNodesWizard *This);
  HRESULT(WINAPI *GetTypeInfoCount)(IClusCfgAddNodesWizard *This,
                                    UINT *pctinfo);
  HRESULT(WINAPI *GetTypeInfo)(IClusCfgAddNodesWizard *This, UINT iTInfo,
                               LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IClusCfgAddNodesWizard *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IClusCfgAddNodesWizard *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *put_ClusterName)(IClusCfgAddNodesWizard *This,
                                   BSTR bstrClusterNameIn);
  HRESULT(WINAPI *get_ClusterName)(IClusCfgAddNodesWizard *This,
                                   BSTR *pbstrClusterNameOut);
  HRESULT(WINAPI *put_ServiceAccountPassword)(IClusCfgAddNodesWizard *This,
                                              BSTR bstrPasswordIn);
  HRESULT(WINAPI *put_MinimumConfiguration)(IClusCfgAddNodesWizard *This,
                                            VARIANT_BOOL fMinConfigIn);
  HRESULT(WINAPI *get_MinimumConfiguration)(IClusCfgAddNodesWizard *This,
                                            VARIANT_BOOL *pfMinConfigOut);
  HRESULT(WINAPI *AddNodeToList)(IClusCfgAddNodesWizard *This,
                                 BSTR bstrNodeNameIn);
  HRESULT(WINAPI *RemoveNodeFromList)(IClusCfgAddNodesWizard *This,
                                      BSTR bstrNodeNameIn);
  HRESULT(WINAPI *ClearNodeList)(IClusCfgAddNodesWizard *This);
  HRESULT(WINAPI *ShowWizard)(IClusCfgAddNodesWizard *This,
                              __LONG32 lParentWindowHandleIn,
                              VARIANT_BOOL *pfCompletedOut);
  END_INTERFACE
...
#define IClusCfgAddNodesWizard_GetTypeInfo(This, iTInfo, lcid, ppTInfo)        \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IClusCfgAddNodesWizard_GetIDsOfNames(This, riid, rgszNames, cNames,    \
                                             lcid, rgDispId)                   \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IClusCfgAddNodesWizard_Invoke(This, dispIdMember, riid, lcid, wFlags,  \
...
#define IClusCfgAddNodesWizard_get_ClusterName(This, pbstrClusterNameOut)      \
  (This)->lpVtbl->get_ClusterName(This, pbstrClusterNameOut)
#define IClusCfgAddNodesWizard_put_ServiceAccountPassword(This,                \
                                                          bstrPasswordIn)      \
  (This)->lpVtbl->put_ServiceAccountPassword(This, bstrPasswordIn)
...
#define IClusCfgAddNodesWizard_ShowWizard(This, lParentWindowHandleIn,         \
                                          pfCompletedOut)                      \
  (This)->lpVtbl->ShowWizard(This, lParentWindowHandleIn, pfCompletedOut)
#endif
#endif
HRESULT WINAPI IClusCfgAddNodesWizard_put_ClusterName_Proxy(
    IClusCfgAddNodesWizard *This, BSTR bstrClusterNameIn);
void __RPC_STUB IClusCfgAddNodesWizard_put_ClusterName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IClusCfgAddNodesWizard_get_ClusterName_Proxy(
    IClusCfgAddNodesWizard *This, BSTR *pbstrClusterNameOut);
...
HRESULT WINAPI IClusCfgAddNodesWizard_put_ServiceAccountPassword_Proxy(
    IClusCfgAddNodesWizard *This, BSTR bstrPasswordIn);
void __RPC_STUB IClusCfgAddNodesWizard_put_ServiceAccountPassword_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IClusCfgAddNodesWizard_put_MinimumConfiguration_Proxy(
    IClusCfgAddNodesWizard *This, VARIANT_BOOL fMinConfigIn);
...
HRESULT WINAPI IClusCfgAddNodesWizard_get_MinimumConfiguration_Proxy(
    IClusCfgAddNodesWizard *This, VARIANT_BOOL *pfMinConfigOut);
void __RPC_STUB IClusCfgAddNodesWizard_get_MinimumConfiguration_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IClusCfgAddNodesWizard_AddNodeToList_Proxy(
    IClusCfgAddNodesWizard *This, BSTR bstrNodeNameIn);
void __RPC_STUB IClusCfgAddNodesWizard_AddNodeToList_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IClusCfgAddNodesWizard_RemoveNodeFromList_Proxy(
    IClusCfgAddNodesWizard *This, BSTR bstrNodeNameIn);
void __RPC_STUB IClusCfgAddNodesWizard_RemoveNodeFromList_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
IClusCfgAddNodesWizard_ClearNodeList_Proxy(IClusCfgAddNodesWizard *This);
void __RPC_STUB IClusCfgAddNodesWizard_ClearNodeList_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IClusCfgAddNodesWizard_ShowWizard_Proxy(
    IClusCfgAddNodesWizard *This, __LONG32 lParentWindowHandleIn,
    VARIANT_BOOL *pfCompletedOut);
