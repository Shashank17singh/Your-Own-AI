...
#define FIsTransmittable(ulPropTag)                                            \
  ((PROP_ID(ulPropTag) < (ULONG)0x0E00) ||                                     \
   ...
   ((PROP_ID(ulPropTag) >= (ULONG)0x1000) &&                                   \
    (PROP_ID(ulPropTag) < (ULONG)0x6000)) ||                                   \
   ((PROP_ID(ulPropTag) >= (ULONG)0x6800) &&                                   \
    (PROP_ID(ulPropTag) < (ULONG)0x7C00)))
...
enum Gender { genderUnspecified = 0, genderFemale, genderMale };
#endif
