...
#define MDM_SET_PROTOCOLID(_dwOptions, _prot)                                  \
  (((_dwOptions) &= ~MDM_MASK_PROTOCOLID),                                     \
   ((_dwOptions) |=                                                            \
    (((_prot) << MDM_SHIFT_PROTOCOLID) & MDM_MASK_PROTOCOLID)))
...
#define MDM_SET_PROTOCOLDATA(_dwOptions, _pd)                                  \
  (((_dwOptions) &= ~MDM_MASK_PROTOCOLDATA),                                   \
   ((_dwOptions) |=                                                            \
    (((_pd) << MDM_SHIFT_PROTOCOLDATA) & MDM_MASK_PROTOCOLDATA)))
...
#define MDM_PROTOCOL_HDLCPPP_64K                                               \
  MDM_GEN_PROTOCOLINFO(MDM_PROTOCOLID_HDLCPPP,                                 \
                       MDM_GEN_HDLCPPP_PROTOCOL_DATA(MDM_HDLCPPP_SPEED_64K,    \
                                                     MDM_HDLCPPP_AUTH_DEFAULT, \
                                                     MDM_HDLCPPP_ML_DEFAULT))
#define MDM_PROTOCOL_HDLCPPP_56K                                               \
  MDM_GEN_PROTOCOLINFO(MDM_PROTOCOLID_HDLCPPP,                                 \
                       MDM_GEN_HDLCPPP_PROTOCOL_DATA(MDM_HDLCPPP_SPEED_56K,    \
                                                     MDM_HDLCPPP_AUTH_DEFAULT, \
                                                     MDM_HDLCPPP_ML_DEFAULT))
...
#define MDM_PROTOCOL_V120_64K                                                  \
  MDM_GEN_PROTOCOLINFO(                                                        \
      MDM_PROTOCOLID_V120,                                                     \
      MDM_GEN_V120_PROTOCOL_DATA(MDM_V120_SPEED_64K, MDM_V120_ML_NONE))
#define MDM_PROTOCOL_V120_56K                                                  \
  MDM_GEN_PROTOCOLINFO(                                                        \
      MDM_PROTOCOLID_V120,                                                     \
      MDM_GEN_V120_PROTOCOL_DATA(MDM_V120_SPEED_56K, MDM_V120_ML_NONE))
#define MDM_PROTOCOL_V120_112K                                                 \
  MDM_GEN_PROTOCOLINFO(                                                        \
      MDM_PROTOCOLID_V120,                                                     \
      MDM_GEN_V120_PROTOCOL_DATA(MDM_V120_SPEED_56K, MDM_V120_ML_2))
#define MDM_PROTOCOL_V120_128K                                                 \
  MDM_GEN_PROTOCOLINFO(                                                        \
      MDM_PROTOCOLID_V120,                                                     \
      MDM_GEN_V120_PROTOCOL_DATA(MDM_V120_SPEED_64K, MDM_V120_ML_2))
...
#define MDM_PROTOCOL_X75_64K                                                   \
  MDM_GEN_PROTOCOLINFO(MDM_PROTOCOLID_X75,                                     \
                       MDM_GEN_X75_PROTOCOL_DATA(MDM_X75_DATA_64K))
#define MDM_PROTOCOL_X75_128K                                                  \
  MDM_GEN_PROTOCOLINFO(MDM_PROTOCOLID_X75,                                     \
                       MDM_GEN_X75_PROTOCOL_DATA(MDM_X75_DATA_128K))
#define MDM_PROTOCOL_X75_T_70                                                  \
  MDM_GEN_PROTOCOLINFO(MDM_PROTOCOLID_X75,                                     \
                       MDM_GEN_X75_PROTOCOL_DATA(MDM_X75_DATA_T_70))
#define MDM_PROTOCOL_X75_BTX                                                   \
  MDM_GEN_PROTOCOLINFO(MDM_PROTOCOLID_X75,                                     \
                       MDM_GEN_X75_PROTOCOL_DATA(MDM_X75_DATA_BTX))
...
#define MDM_PROTOCOL_V110_1DOT2K                                               \
  MDM_GEN_PROTOCOLINFO(MDM_PROTOCOLID_V110,                                    \
                       MDM_GEN_V110_PROTOCOL_DATA(MDM_V110_SPEED_1DOT2K))
#define MDM_PROTOCOL_V110_2DOT4K                                               \
  MDM_GEN_PROTOCOLINFO(MDM_PROTOCOLID_V110,                                    \
                       MDM_GEN_V110_PROTOCOL_DATA(MDM_V110_SPEED_2DOT4K))
#define MDM_PROTOCOL_V110_4DOT8K                                               \
  MDM_GEN_PROTOCOLINFO(MDM_PROTOCOLID_V110,                                    \
                       MDM_GEN_V110_PROTOCOL_DATA(MDM_V110_SPEED_4DOT8K))
#define MDM_PROTOCOL_V110_9DOT6K                                               \
  MDM_GEN_PROTOCOLINFO(MDM_PROTOCOLID_V110,                                    \
                       MDM_GEN_V110_PROTOCOL_DATA(MDM_V110_SPEED_9DOT6K))
#define MDM_PROTOCOL_V110_12DOT0K                                              \
  MDM_GEN_PROTOCOLINFO(MDM_PROTOCOLID_V110,                                    \
                       MDM_GEN_V110_PROTOCOL_DATA(MDM_V110_SPEED_12DOT0K))
#define MDM_PROTOCOL_V110_14DOT4K                                              \
  MDM_GEN_PROTOCOLINFO(MDM_PROTOCOLID_V110,                                    \
                       MDM_GEN_V110_PROTOCOL_DATA(MDM_V110_SPEED_14DOT4K))
#define MDM_PROTOCOL_V110_19DOT2K                                              \
  MDM_GEN_PROTOCOLINFO(MDM_PROTOCOLID_V110,                                    \
                       MDM_GEN_V110_PROTOCOL_DATA(MDM_V110_SPEED_19DOT2K))
#define MDM_PROTOCOL_V110_28DOT8K                                              \
  MDM_GEN_PROTOCOLINFO(MDM_PROTOCOLID_V110,                                    \
                       MDM_GEN_V110_PROTOCOL_DATA(MDM_V110_SPEED_28DOT8K))
#define MDM_PROTOCOL_V110_38DOT4K                                              \
  MDM_GEN_PROTOCOLINFO(MDM_PROTOCOLID_V110,                                    \
                       MDM_GEN_V110_PROTOCOL_DATA(MDM_V110_SPEED_38DOT4K))
#define MDM_PROTOCOL_V110_57DOT6K                                              \
  MDM_GEN_PROTOCOLINFO(MDM_PROTOCOLID_V110,                                    \
                       MDM_GEN_V110_PROTOCOL_DATA(MDM_V110_SPEED_57DOT6K))
...
#define MDM_PROTOCOL_AUTO_1CH                                                  \
  MDM_GEN_PROTOCOLINFO(                                                        \
      MDM_PROTOCOLID_AUTO,                                                     \
      MDM_GEN_AUTO_PROTOCOL_DATA(MDM_AUTO_SPEED_DEFAULT, MDM_AUTO_ML_NONE))
#define MDM_PROTOCOL_AUTO_2CH                                                  \
  MDM_GEN_PROTOCOLINFO(                                                        \
      MDM_PROTOCOLID_AUTO,                                                     \
      MDM_GEN_AUTO_PROTOCOL_DATA(MDM_AUTO_SPEED_DEFAULT, MDM_AUTO_ML_2))
...
#define MDM_PROTOCOL_ANALOG_RLP                                                \
  MDM_GEN_PROTOCOLINFO(MDM_PROTOCOLID_ANALOG,                                  \
                       MDM_GEN_ANALOG_PROTOCOL_DATA(MDM_ANALOG_RLP_ON))
#define MDM_PROTOCOL_ANALOG_NRLP                                               \
  MDM_GEN_PROTOCOLINFO(MDM_PROTOCOLID_ANALOG,                                  \
                       MDM_GEN_ANALOG_PROTOCOL_DATA(MDM_ANALOG_RLP_OFF))
#define MDM_PROTOCOL_ANALOG_V34                                                \
  MDM_GEN_PROTOCOLINFO(MDM_PROTOCOLID_ANALOG,                                  \
                       MDM_GEN_ANALOG_PROTOCOL_DATA(MDM_ANALOG_V34))
