...
NET_API_STATUS WINAPI NetWkstaGetInfo(LMSTR servername, DWORD level,
                                      LPBYTE *bufptr);
NET_API_STATUS WINAPI NetWkstaSetInfo(LMSTR servername, DWORD level,
                                      LPBYTE buffer, LPDWORD parm_err);
NET_API_STATUS WINAPI NetWkstaUserGetInfo(LMSTR reserved, DWORD level,
                                          LPBYTE *bufptr);
NET_API_STATUS WINAPI NetWkstaUserSetInfo(LMSTR reserved, DWORD level,
                                          LPBYTE buf, LPDWORD parm_err);
NET_API_STATUS WINAPI NetWkstaUserEnum(LMSTR servername, DWORD level,
                                       LPBYTE *bufptr, DWORD prefmaxlen,
                                       LPDWORD entriesread,
                                       LPDWORD totalentries,
                                       LPDWORD resumehandle);
NET_API_STATUS WINAPI NetWkstaTransportAdd(LMSTR servername, DWORD level,
                                           LPBYTE buf, LPDWORD parm_err);
NET_API_STATUS WINAPI NetWkstaTransportDel(LMSTR servername,
                                           LMSTR transportname, DWORD ucond);
NET_API_STATUS WINAPI NetWkstaTransportEnum(LMSTR servername, DWORD level,
                                            LPBYTE *bufptr, DWORD prefmaxlen,
                                            LPDWORD entriesread,
                                            LPDWORD totalentries,
                                            LPDWORD resumehandle);
