...
#endif
DEFINE_GUID(DEVINTERFACE_AUDIO_RENDER, 0xe6327cad, 0xdcec, 0x4949, 0xae, 0x8a,
            0x99, 0x1e, 0x97, 0x6a, 0x79, 0xd2);
DEFINE_GUID(DEVINTERFACE_AUDIO_CAPTURE, 0x2eef81be, 0x33fa, 0x4800, 0x96, 0x70,
            0x1c, 0xd4, 0x74, 0x97, 0x2c, 0x3f);
...
DEFINE_PROPERTYKEY(PKEY_AudioEndpoint_Supports_EventDriven_Mode, 0x1da5d803,
                   0xd492, 0x4edd, 0x8c, 0x23, 0xe0, 0xc0, 0xff, 0xee, 0x7f,
                   0x0e, 7);
DEFINE_PROPERTYKEY(PKEY_AudioEndpoint_JackSubType, 0x1da5d803, 0xd492, 0x4edd,
                   0x8c, 0x23, 0xe0, 0xc0, 0xff, 0xee, 0x7f, 0x0e, 8);
DEFINE_PROPERTYKEY(PKEY_AudioEngine_DeviceFormat, 0xf19f064d, 0x082c, 0x4e27,
                   0xbc, 0x73, 0x68, 0x82, 0xa1, 0xbb, 0x8e, 0x4c, 0);
DEFINE_PROPERTYKEY(PKEY_AudioEngine_OEMFormat, 0xe4870e26, 0x3cc5, 0x4cd2, 0xba,
                   0x46, 0xca, 0x0a, 0x9a, 0x70, 0xed, 0x04, 3);
...
IMMNotificationClient : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE OnDefaultDeviceChanged(
      EDataFlow flow, ERole role, LPCWSTR pwstrDeviceId) = 0;
  virtual HRESULT STDMETHODCALLTYPE OnPropertyValueChanged(
      LPCWSTR pwstrDeviceId, const PROPERTYKEY key) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IMMNotificationClient, 0x7991eec9, 0x7e89, 0x4d85, 0x83, 0x90,
                0x6c, 0x70, 0x3c, 0xec, 0x60, 0xc0)
#endif
#else
typedef struct IMMNotificationClientVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IMMNotificationClient *This,
  ...
  HRESULT(STDMETHODCALLTYPE *OnDefaultDeviceChanged)(
      IMMNotificationClient *This, EDataFlow flow, ERole role,
      LPCWSTR pwstrDeviceId);
...
#define IMMNotificationClient_OnDefaultDeviceChanged(This, flow, role,         \
                                                     pwstrDeviceId)            \
  (This)->lpVtbl->OnDefaultDeviceChanged(This, flow, role, pwstrDeviceId)
...
IMMNotificationClient_QueryInterface(IMMNotificationClient *This, REFIID riid,
                                     void **ppvObject) {
...
/*** IMMNotificationClient methods ***/
static inline HRESULT IMMNotificationClient_OnDeviceStateChanged(
...
static inline HRESULT
IMMNotificationClient_OnDeviceAdded(IMMNotificationClient *This,
                                    LPCWSTR pwstrDeviceId) {
  return This->lpVtbl->OnDeviceAdded(This, pwstrDeviceId);
}
static inline HRESULT
IMMNotificationClient_OnDeviceRemoved(IMMNotificationClient *This,
                                      LPCWSTR pwstrDeviceId) {
  return This->lpVtbl->OnDeviceRemoved(This, pwstrDeviceId);
}
static inline HRESULT
IMMNotificationClient_OnDefaultDeviceChanged(IMMNotificationClient *This,
                                             EDataFlow flow, ERole role,
                                             LPCWSTR pwstrDeviceId) {
  return This->lpVtbl->OnDefaultDeviceChanged(This, flow, role, pwstrDeviceId);
}
static inline HRESULT IMMNotificationClient_OnPropertyValueChanged(
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IMMDevice, 0xd666063f, 0x1587, 0x4e43, 0x81, 0xf1, 0xb9, 0x48,
                0xe8, 0x07, 0x36, 0x3f)
#endif
#else
typedef struct IMMDeviceVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IMMDevice *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IMMDevice *This);
  ULONG(STDMETHODCALLTYPE *Release)(IMMDevice *This);
  /*** IMMDevice methods ***/
  HRESULT(STDMETHODCALLTYPE *Activate)(IMMDevice *This, REFIID iid,
                                       DWORD dwClsCtx,
                                       PROPVARIANT *pActivationParams,
                                       void **ppv);
  HRESULT(STDMETHODCALLTYPE *OpenPropertyStore)(IMMDevice *This,
                                                DWORD stgmAccess,
...
interface IMMDevice { CONST_VTBL IMMDeviceVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IMMDevice methods ***/
#define IMMDevice_Activate(This, iid, dwClsCtx, pActivationParams, ppv)        \
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMMDevice_QueryInterface(IMMDevice *This, REFIID riid,
                                               void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IMMDevice methods ***/
static inline HRESULT IMMDevice_Activate(IMMDevice *This, REFIID iid,
                                         DWORD dwClsCtx,
                                         PROPVARIANT *pActivationParams,
                                         void **ppv) {
...
static inline HRESULT
IMMDevice_OpenPropertyStore(IMMDevice *This, DWORD stgmAccess,
                            IPropertyStore **ppProperties) {
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IMMDeviceCollection, 0x0bd7a1be, 0x7a1a, 0x44db, 0x83, 0x97,
                0xcc, 0x53, 0x92, 0x38, 0x7b, 0x5e)
#endif
#else
typedef struct IMMDeviceCollectionVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IMMDeviceCollection *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetCount)(IMMDeviceCollection *This,
                                       UINT *pcDevices);
  HRESULT(STDMETHODCALLTYPE *Item)(IMMDeviceCollection *This, UINT nDevice,
                                   IMMDevice **ppdevice);
  END_INTERFACE
} IMMDeviceCollectionVtbl;
interface IMMDeviceCollection { CONST_VTBL IMMDeviceCollectionVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
IMMDeviceCollection_QueryInterface(IMMDeviceCollection *This, REFIID riid,
                                   void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IMMDeviceCollection methods ***/
static inline HRESULT IMMDeviceCollection_GetCount(IMMDeviceCollection *This,
                                                   UINT *pcDevices) {
  return This->lpVtbl->GetCount(This, pcDevices);
}
static inline HRESULT IMMDeviceCollection_Item(IMMDeviceCollection *This,
                                               UINT nDevice,
                                               IMMDevice **ppdevice) {
...
DEFINE_GUID(IID_IMMEndpoint, 0x1be09788, 0x6894, 0x4089, 0x85, 0x86, 0x9a, 0x2a,
            0x6c, 0x26, 0x5a, 0xc5);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IMMEndpoint, 0x1be09788, 0x6894, 0x4089, 0x85, 0x86, 0x9a, 0x2a,
                0x6c, 0x26, 0x5a, 0xc5)
#endif
#else
typedef struct IMMEndpointVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IMMEndpoint *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IMMEndpoint *This);
  ULONG(STDMETHODCALLTYPE *Release)(IMMEndpoint *This);
  /*** IMMEndpoint methods ***/
  HRESULT(STDMETHODCALLTYPE *GetDataFlow)(IMMEndpoint *This,
                                          EDataFlow *pDataFlow);
  END_INTERFACE
} IMMEndpointVtbl;
interface IMMEndpoint { CONST_VTBL IMMEndpointVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMMEndpoint_QueryInterface(IMMEndpoint *This, REFIID riid,
                                                 void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IMMEndpoint methods ***/
static inline HRESULT IMMEndpoint_GetDataFlow(IMMEndpoint *This,
                                              EDataFlow *pDataFlow) {
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IMMDeviceEnumerator, 0xa95664d2, 0x9614, 0x4f35, 0xa7, 0x46,
                0xde, 0x8d, 0xb6, 0x36, 0x17, 0xe6)
#endif
#else
typedef struct IMMDeviceEnumeratorVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IMMDeviceEnumerator *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *EnumAudioEndpoints)(
      IMMDeviceEnumerator *This, EDataFlow dataFlow, DWORD dwStateMask,
  ...
  HRESULT(STDMETHODCALLTYPE *GetDevice)(IMMDeviceEnumerator *This,
                                        LPCWSTR pwstrId, IMMDevice **ppDevice);
  HRESULT(STDMETHODCALLTYPE *RegisterEndpointNotificationCallback)(
      IMMDeviceEnumerator *This, IMMNotificationClient *pClient);
  HRESULT(STDMETHODCALLTYPE *UnregisterEndpointNotificationCallback)(
      IMMDeviceEnumerator *This, IMMNotificationClient *pClient);
  END_INTERFACE
} IMMDeviceEnumeratorVtbl;
interface IMMDeviceEnumerator { CONST_VTBL IMMDeviceEnumeratorVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
IMMDeviceEnumerator_QueryInterface(IMMDeviceEnumerator *This, REFIID riid,
                                   void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IMMDeviceEnumerator methods ***/
static inline HRESULT
IMMDeviceEnumerator_EnumAudioEndpoints(IMMDeviceEnumerator *This,
                                       EDataFlow dataFlow, DWORD dwStateMask,
                                       IMMDeviceCollection **ppDevices) {
  return This->lpVtbl->EnumAudioEndpoints(This, dataFlow, dwStateMask,
                                          ppDevices);
}
static inline HRESULT
IMMDeviceEnumerator_GetDefaultAudioEndpoint(IMMDeviceEnumerator *This,
                                            EDataFlow dataFlow, ERole role,
                                            IMMDevice **ppEndpoint) {
  return This->lpVtbl->GetDefaultAudioEndpoint(This, dataFlow, role,
                                               ppEndpoint);
}
static inline HRESULT IMMDeviceEnumerator_GetDevice(IMMDeviceEnumerator *This,
                                                    LPCWSTR pwstrId,
                                                    IMMDevice **ppDevice) {
  return This->lpVtbl->GetDevice(This, pwstrId, ppDevice);
}
static inline HRESULT IMMDeviceEnumerator_RegisterEndpointNotificationCallback(
    IMMDeviceEnumerator *This, IMMNotificationClient *pClient) {
...
DEFINE_GUID(IID_IMMDeviceActivator, 0x3b0d0ea4, 0xd0a9, 0x4b0e, 0x93, 0x5b,
            0x09, 0x51, 0x67, 0x46, 0xfa, 0xc0);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IMMDeviceActivator, 0x3b0d0ea4, 0xd0a9, 0x4b0e, 0x93, 0x5b,
                0x09, 0x51, 0x67, 0x46, 0xfa, 0xc0)
#endif
#else
typedef struct IMMDeviceActivatorVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IMMDeviceActivator *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *Activate)(IMMDeviceActivator *This, REFIID iid,
                                       IMMDevice *pDevice,
                                       PROPVARIANT *pActivationParams,
                                       void **ppv);
  END_INTERFACE
} IMMDeviceActivatorVtbl;
interface IMMDeviceActivator { CONST_VTBL IMMDeviceActivatorVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define IMMDeviceActivator_Activate(This, iid, pDevice, pActivationParams,     \
                                    ppv)                                       \
  (This)->lpVtbl->Activate(This, iid, pDevice, pActivationParams, ppv)
#else
/*** IUnknown methods ***/
static inline HRESULT
IMMDeviceActivator_QueryInterface(IMMDeviceActivator *This, REFIID riid,
                                  void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IMMDeviceActivator methods ***/
static inline HRESULT
IMMDeviceActivator_Activate(IMMDeviceActivator *This, REFIID iid,
                            IMMDevice *pDevice, PROPVARIANT *pActivationParams,
                            void **ppv) {
...
IActivateAudioInterfaceAsyncOperation : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetActivateResult(HRESULT * result,
                                                      IUnknown * *iface) = 0;
};
#ifdef __CRT_UUID_DECL
...
typedef struct IActivateAudioInterfaceAsyncOperationVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(
      IActivateAudioInterfaceAsyncOperation *This, REFIID riid,
      void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetActivateResult)(
      IActivateAudioInterfaceAsyncOperation *This, HRESULT *result,
      IUnknown **iface);
  END_INTERFACE
...
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
#define IActivateAudioInterfaceAsyncOperation_QueryInterface(This, riid,       \
                                                             ppvObject)        \
  (This)->lpVtbl->QueryInterface(This, riid, ppvObject)
...
/*** IActivateAudioInterfaceAsyncOperation methods ***/
#define IActivateAudioInterfaceAsyncOperation_GetActivateResult(This, result,  \
                                                                iface)         \
  (This)->lpVtbl->GetActivateResult(This, result, iface)
#else
/*** IUnknown methods ***/
static inline HRESULT IActivateAudioInterfaceAsyncOperation_QueryInterface(
    IActivateAudioInterfaceAsyncOperation *This, REFIID riid,
    void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG IActivateAudioInterfaceAsyncOperation_AddRef(
    IActivateAudioInterfaceAsyncOperation *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG IActivateAudioInterfaceAsyncOperation_Release(
    IActivateAudioInterfaceAsyncOperation *This) {
  return This->lpVtbl->Release(This);
}
/*** IActivateAudioInterfaceAsyncOperation methods ***/
static inline HRESULT IActivateAudioInterfaceAsyncOperation_GetActivateResult(
    IActivateAudioInterfaceAsyncOperation *This, HRESULT *result,
    IUnknown **iface) {
...
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
#define IActivateAudioInterfaceCompletionHandler_QueryInterface(This, riid,    \
                                                                ppvObject)     \
  (This)->lpVtbl->QueryInterface(This, riid, ppvObject)
...
#define IActivateAudioInterfaceCompletionHandler_Release(This)                 \
  (This)->lpVtbl->Release(This)
/*** IActivateAudioInterfaceCompletionHandler methods ***/
#define IActivateAudioInterfaceCompletionHandler_ActivateCompleted(This, op)   \
  (This)->lpVtbl->ActivateCompleted(This, op)
#else
/*** IUnknown methods ***/
static inline HRESULT IActivateAudioInterfaceCompletionHandler_QueryInterface(
    IActivateAudioInterfaceCompletionHandler *This, REFIID riid,
    void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG IActivateAudioInterfaceCompletionHandler_AddRef(
    IActivateAudioInterfaceCompletionHandler *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG IActivateAudioInterfaceCompletionHandler_Release(
    IActivateAudioInterfaceCompletionHandler *This) {
  return This->lpVtbl->Release(This);
}
/*** IActivateAudioInterfaceCompletionHandler methods ***/
...
DEFINE_GUID(LIBID_MMDeviceAPILib, 0x2fdaafa3, 0x7523, 0x4f66, 0x99, 0x57, 0x9d,
            0x5e, 0x7f, 0xe6, 0x98, 0xf6);
/*****************************************************************************
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(MMDeviceEnumerator, 0xbcde0395, 0xe52f, 0x467c, 0x8e, 0x3d,
                0xc4, 0x57, 0x92, 0x91, 0x69, 0x2e)
#endif
#endif
