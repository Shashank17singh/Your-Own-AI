...
#define SecPkgCredentials_SSIProvider                                          \
  __MINGW_NAME_AW(SecPkgCredentials_SSIProvider)
#define PSecPkgCredentials_SSIProvider                                         \
  __MINGW_NAME_AW(PSecPkgCredentials_SSIProvider)
...
#define SecPkgContext_NegotiationInfo                                          \
  __MINGW_NAME_AW(SecPkgContext_NegotiationInfo)
#define PSecPkgContext_NegotiationInfo                                         \
  __MINGW_NAME_AW(PSecPkgContext_NegotiationInfo)
...
#define SecPkgContext_CredentialName                                           \
  __MINGW_NAME_AW(SecPkgContext_CredentialName)
#define PSecPkgContext_CredentialName                                          \
  __MINGW_NAME_AW(PSecPkgContext_CredentialName)
...
typedef void(WINAPI *SEC_GET_KEY_FN)(void *Arg, void *Principal,
                                     unsigned __LONG32 KeyVer, void **Key,
...
#endif
    unsigned __LONG32 fCredentialUse, void *pvLogonId, void *pAuthData,
...
typedef SECURITY_STATUS(WINAPI *ACQUIRE_CREDENTIALS_HANDLE_FN_W)(
    ...
    SEC_WCHAR *, SEC_WCHAR *,
#endif
    unsigned __LONG32, void *, void *, SEC_GET_KEY_FN, void *, PCredHandle,
    PTimeStamp);
SECURITY_STATUS WINAPI AcquireCredentialsHandleA(
    ...
    SEC_GET_KEY_FN pGetKeyFn, void *pvGetKeyArgument, PCredHandle phCredential,
    PTimeStamp ptsExpiry);
typedef SECURITY_STATUS(WINAPI *ACQUIRE_CREDENTIALS_HANDLE_FN_A)(
    SEC_CHAR *, SEC_CHAR *, unsigned __LONG32, void *, void *, SEC_GET_KEY_FN,
    void *, PCredHandle, PTimeStamp);
#define AcquireCredentialsHandle __MINGW_NAME_AW(AcquireCredentialsHandle)
#define ACQUIRE_CREDENTIALS_HANDLE_FN                                          \
  __MINGW_NAME_UAW(ACQUIRE_CREDENTIALS_HANDLE_FN)
KSECDDDECLSPEC
    SECURITY_STATUS WINAPI FreeCredentialsHandle(PCredHandle phCredential);
typedef SECURITY_STATUS(WINAPI *FREE_CREDENTIALS_HANDLE_FN)(PCredHandle);
KSECDDDECLSPEC SECURITY_STATUS WINAPI AddCredentialsW(
    ...
    SEC_WCHAR *pszPrincipal, SEC_WCHAR *pszPackage,
#endif
    unsigned __LONG32 fCredentialUse, void *pAuthData, SEC_GET_KEY_FN pGetKeyFn,
    void *pvGetKeyArgument, PTimeStamp ptsExpiry);
typedef SECURITY_STATUS(WINAPI *ADD_CREDENTIALS_FN_W)(PCredHandle,
                                                      ...
                                                      SEC_WCHAR *, SEC_WCHAR *,
#endif
                                                      unsigned __LONG32, void *,
                                                      SEC_GET_KEY_FN, void *,
                                                      PTimeStamp);
SECURITY_STATUS WINAPI AddCredentialsA(
    PCredHandle hCredentials, SEC_CHAR *pszPrincipal, SEC_CHAR *pszPackage,
    unsigned __LONG32 fCredentialUse, void *pAuthData, SEC_GET_KEY_FN pGetKeyFn,
    void *pvGetKeyArgument, PTimeStamp ptsExpiry);
typedef SECURITY_STATUS(WINAPI *ADD_CREDENTIALS_FN_A)(PCredHandle, SEC_CHAR *,
                                                      SEC_CHAR *,
                                                      unsigned __LONG32, void *,
                                                      SEC_GET_KEY_FN, void *,
                                                      PTimeStamp);
...
KSECDDDECLSPEC SECURITY_STATUS WINAPI InitializeSecurityContextW(
    ...
    unsigned __LONG32 TargetDataRep, PSecBufferDesc pInput,
    unsigned __LONG32 Reserved2, PCtxtHandle phNewContext,
    PSecBufferDesc pOutput, unsigned __LONG32 *pfContextAttr,
    PTimeStamp ptsExpiry);
typedef SECURITY_STATUS(WINAPI *INITIALIZE_SECURITY_CONTEXT_FN_W)(
    PCredHandle, PCtxtHandle,
#if ISSP_MODE == 0
    PSECURITY_STRING,
#else
    SEC_WCHAR *,
#endif
    unsigned __LONG32, unsigned __LONG32, unsigned __LONG32, PSecBufferDesc,
    unsigned __LONG32, PCtxtHandle, PSecBufferDesc, unsigned __LONG32 *,
    PTimeStamp);
SECURITY_STATUS WINAPI InitializeSecurityContextA(
    ...
    PSecBufferDesc pOutput, unsigned __LONG32 *pfContextAttr,
    PTimeStamp ptsExpiry);
typedef SECURITY_STATUS(WINAPI *INITIALIZE_SECURITY_CONTEXT_FN_A)(
    PCredHandle, PCtxtHandle, SEC_CHAR *, unsigned __LONG32, unsigned __LONG32,
    unsigned __LONG32, PSecBufferDesc, unsigned __LONG32, PCtxtHandle,
    PSecBufferDesc, unsigned __LONG32 *, PTimeStamp);
#define InitializeSecurityContext __MINGW_NAME_AW(InitializeSecurityContext)
#define INITIALIZE_SECURITY_CONTEXT_FN                                         \
  __MINGW_NAME_UAW(INITIALIZE_SECURITY_CONTEXT_FN)
KSECDDDECLSPEC SECURITY_STATUS WINAPI AcceptSecurityContext(
    PCredHandle phCredential, PCtxtHandle phContext, PSecBufferDesc pInput,
    unsigned __LONG32 fContextReq, unsigned __LONG32 TargetDataRep,
    PCtxtHandle phNewContext, PSecBufferDesc pOutput,
    unsigned __LONG32 *pfContextAttr, PTimeStamp ptsExpiry);
typedef SECURITY_STATUS(WINAPI *ACCEPT_SECURITY_CONTEXT_FN)(
    PCredHandle, PCtxtHandle, PSecBufferDesc, unsigned __LONG32,
    unsigned __LONG32, PCtxtHandle, PSecBufferDesc, unsigned __LONG32 *,
    PTimeStamp);
SECURITY_STATUS WINAPI CompleteAuthToken(PCtxtHandle phContext,
                                         PSecBufferDesc pToken);
typedef SECURITY_STATUS(WINAPI *COMPLETE_AUTH_TOKEN_FN)(PCtxtHandle,
                                                        PSecBufferDesc);
KSECDDDECLSPEC SECURITY_STATUS WINAPI
...
KSECDDDECLSPEC SECURITY_STATUS WINAPI
QuerySecurityContextToken(PCtxtHandle phContext, HANDLE *Token);
typedef SECURITY_STATUS(WINAPI *QUERY_SECURITY_CONTEXT_TOKEN_FN)(PCtxtHandle,
                                                                 HANDLE *);
KSECDDDECLSPEC SECURITY_STATUS WINAPI
DeleteSecurityContext(PCtxtHandle phContext);
typedef SECURITY_STATUS(WINAPI *DELETE_SECURITY_CONTEXT_FN)(PCtxtHandle);
KSECDDDECLSPEC SECURITY_STATUS WINAPI ApplyControlToken(PCtxtHandle phContext,
                                                        PSecBufferDesc pInput);
typedef SECURITY_STATUS(WINAPI *APPLY_CONTROL_TOKEN_FN)(PCtxtHandle,
                                                        PSecBufferDesc);
KSECDDDECLSPEC SECURITY_STATUS WINAPI QueryContextAttributesW(
    PCtxtHandle phContext, unsigned __LONG32 ulAttribute, void *pBuffer);
typedef SECURITY_STATUS(WINAPI *QUERY_CONTEXT_ATTRIBUTES_FN_W)(
    PCtxtHandle, unsigned __LONG32, void *);
SECURITY_STATUS WINAPI QueryContextAttributesA(PCtxtHandle phContext,
                                               unsigned __LONG32 ulAttribute,
                                               void *pBuffer);
typedef SECURITY_STATUS(WINAPI *QUERY_CONTEXT_ATTRIBUTES_FN_A)(
    PCtxtHandle, unsigned __LONG32, void *);
#define QueryContextAttributes __MINGW_NAME_AW(QueryContextAttributes)
#define QUERY_CONTEXT_ATTRIBUTES_FN                                            \
  __MINGW_NAME_UAW(QUERY_CONTEXT_ATTRIBUTES_FN)
SECURITY_STATUS WINAPI QueryContextAttributesExW(PCtxtHandle phContext,
                                                 unsigned __LONG32 ulAttribute,
                                                 void *pBuffer,
                                                 unsigned __LONG32 cbBuffer);
typedef SECURITY_STATUS(WINAPI *QUERY_CONTEXT_ATTRIBUTES_EX_FN_W)(
    PCtxtHandle, unsigned __LONG32, void *, unsigned __LONG32);
SECURITY_STATUS WINAPI QueryContextAttributesExA(PCtxtHandle phContext,
                                                 unsigned __LONG32 ulAttribute,
                                                 void *pBuffer,
                                                 unsigned __LONG32 cbBuffer);
typedef SECURITY_STATUS(WINAPI *QUERY_CONTEXT_ATTRIBUTES_EX_FN_A)(
    PCtxtHandle, unsigned __LONG32, void *, unsigned __LONG32);
#define QueryContextAttributesEx __MINGW_NAME_AW(QueryContextAttributesEx)
#define QUERY_CONTEXT_ATTRIBUTES_EX_FN                                         \
  __MINGW_NAME_UAW(QUERY_CONTEXT_ATTRIBUTES_EX_FN)
SECURITY_STATUS WINAPI SetContextAttributesW(PCtxtHandle phContext,
                                             unsigned __LONG32 ulAttribute,
                                             void *pBuffer,
                                             unsigned __LONG32 cbBuffer);
typedef SECURITY_STATUS(WINAPI *SET_CONTEXT_ATTRIBUTES_FN_W)(PCtxtHandle,
                                                             unsigned __LONG32,
                                                             void *,
                                                             unsigned __LONG32);
SECURITY_STATUS WINAPI SetContextAttributesA(PCtxtHandle phContext,
                                             ...
                                             void *pBuffer,
                                             unsigned __LONG32 cbBuffer);
typedef SECURITY_STATUS(WINAPI *SET_CONTEXT_ATTRIBUTES_FN_A)(PCtxtHandle,
                                                             unsigned __LONG32,
                                                             void *,
                                                             unsigned __LONG32);
...
KSECDDDECLSPEC SECURITY_STATUS WINAPI QueryCredentialsAttributesW(
    PCredHandle phCredential, unsigned __LONG32 ulAttribute, void *pBuffer);
typedef SECURITY_STATUS(WINAPI *QUERY_CREDENTIALS_ATTRIBUTES_FN_W)(
    PCredHandle, unsigned __LONG32, void *);
SECURITY_STATUS WINAPI QueryCredentialsAttributesA(
    PCredHandle phCredential, unsigned __LONG32 ulAttribute, void *pBuffer);
typedef SECURITY_STATUS(WINAPI *QUERY_CREDENTIALS_ATTRIBUTES_FN_A)(
    PCredHandle, unsigned __LONG32, void *);
#define QueryCredentialsAttributes __MINGW_NAME_AW(QueryCredentialsAttributes)
#define QUERY_CREDENTIALS_ATTRIBUTES_FN                                        \
  __MINGW_NAME_UAW(QUERY_CREDENTIALS_ATTRIBUTES_FN)
SECURITY_STATUS WINAPI QueryCredentialsAttributesExW(
    PCredHandle phCredential, unsigned __LONG32 ulAttribute, void *pBuffer,
    unsigned __LONG32 cbBuffer);
typedef SECURITY_STATUS(WINAPI *QUERY_CREDENTIALS_ATTRIBUTES_EX_FN_W)(
    PCredHandle, unsigned __LONG32, void *, unsigned __LONG32);
SECURITY_STATUS WINAPI QueryCredentialsAttributesExA(
    PCredHandle phCredential, unsigned __LONG32 ulAttribute, void *pBuffer,
    unsigned __LONG32 cbBuffer);
typedef SECURITY_STATUS(WINAPI *QUERY_CREDENTIALS_ATTRIBUTES_EX_FN_A)(
    PCredHandle, unsigned __LONG32, void *, unsigned __LONG32);
#define QueryCredentialsAttributesEx                                           \
  __MINGW_NAME_AW(QueryCredentialsAttributesEx)
#define QUERY_CREDENTIALS_ATTRIBUTES_EX_FN                                     \
  __MINGW_NAME_UAW(QUERY_CREDENTIALS_ATTRIBUTES_EX_FN)
KSECDDDECLSPEC SECURITY_STATUS WINAPI SetCredentialsAttributesW(
    PCredHandle phCredential, unsigned __LONG32 ulAttribute, void *pBuffer,
    unsigned __LONG32 cbBuffer);
typedef SECURITY_STATUS(WINAPI *SET_CREDENTIALS_ATTRIBUTES_FN_W)(
    PCredHandle, unsigned __LONG32, void *, unsigned __LONG32);
SECURITY_STATUS WINAPI SetCredentialsAttributesA(PCredHandle phCredential,
                                                 unsigned __LONG32 ulAttribute,
                                                 void *pBuffer,
                                                 unsigned __LONG32 cbBuffer);
typedef SECURITY_STATUS(WINAPI *SET_CREDENTIALS_ATTRIBUTES_FN_A)(
    PCredHandle, unsigned __LONG32, void *, unsigned __LONG32);
#define SetCredentialsAttributes __MINGW_NAME_AW(SetCredentialsAttributes)
#define SET_CREDENTIALS_ATTRIBUTES_FN                                          \
  __MINGW_NAME_UAW(SET_CREDENTIALS_ATTRIBUTES_FN)
SECURITY_STATUS WINAPI FreeContextBuffer(void *pvContextBuffer);
typedef SECURITY_STATUS(WINAPI *FREE_CONTEXT_BUFFER_FN)(void *);
KSECDDDECLSPEC SECURITY_STATUS WINAPI
MakeSignature(PCtxtHandle phContext, unsigned __LONG32 fQOP,
              PSecBufferDesc pMessage, unsigned __LONG32 MessageSeqNo);
typedef SECURITY_STATUS(WINAPI *MAKE_SIGNATURE_FN)(PCtxtHandle,
                                                   unsigned __LONG32,
                                                   PSecBufferDesc,
                                                   unsigned __LONG32);
KSECDDDECLSPEC SECURITY_STATUS WINAPI
VerifySignature(PCtxtHandle phContext, PSecBufferDesc pMessage,
                unsigned __LONG32 MessageSeqNo, unsigned __LONG32 *pfQOP);
typedef SECURITY_STATUS(WINAPI *VERIFY_SIGNATURE_FN)(PCtxtHandle,
                                                     PSecBufferDesc,
                                                     unsigned __LONG32,
                                                     unsigned __LONG32 *);
...
SECURITY_STATUS WINAPI EncryptMessage(PCtxtHandle phContext,
                                      unsigned __LONG32 fQOP,
                                      PSecBufferDesc pMessage,
                                      unsigned __LONG32 MessageSeqNo);
typedef SECURITY_STATUS(WINAPI *ENCRYPT_MESSAGE_FN)(PCtxtHandle,
                                                    unsigned __LONG32,
                                                    PSecBufferDesc,
                                                    unsigned __LONG32);
SECURITY_STATUS WINAPI DecryptMessage(PCtxtHandle phContext,
                                      PSecBufferDesc pMessage,
                                      unsigned __LONG32 MessageSeqNo,
                                      unsigned __LONG32 *pfQOP);
typedef SECURITY_STATUS(WINAPI *DECRYPT_MESSAGE_FN)(PCtxtHandle, PSecBufferDesc,
                                                    unsigned __LONG32,
                                                    unsigned __LONG32 *);
KSECDDDECLSPEC SECURITY_STATUS WINAPI EnumerateSecurityPackagesW(
    unsigned __LONG32 *pcPackages, PSecPkgInfoW *ppPackageInfo);
typedef SECURITY_STATUS(WINAPI *ENUMERATE_SECURITY_PACKAGES_FN_W)(
    unsigned __LONG32 *, PSecPkgInfoW *);
SECURITY_STATUS WINAPI EnumerateSecurityPackagesA(unsigned __LONG32 *pcPackages,
                                                  PSecPkgInfoA *ppPackageInfo);
typedef SECURITY_STATUS(WINAPI *ENUMERATE_SECURITY_PACKAGES_FN_A)(
    unsigned __LONG32 *, PSecPkgInfoA *);
#define EnumerateSecurityPackages __MINGW_NAME_AW(EnumerateSecurityPackages)
#define ENUMERATE_SECURITY_PACKAGES_FN                                         \
  __MINGW_NAME_UAW(ENUMERATE_SECURITY_PACKAGES_FN)
...
SECURITY_STATUS WINAPI QuerySecurityPackageInfoA(SEC_CHAR *pszPackageName,
                                                 PSecPkgInfoA *ppPackageInfo);
typedef SECURITY_STATUS(WINAPI *QUERY_SECURITY_PACKAGE_INFO_FN_A)(
    SEC_CHAR *, PSecPkgInfoA *);
#define QuerySecurityPackageInfo __MINGW_NAME_AW(QuerySecurityPackageInfo)
#define QUERY_SECURITY_PACKAGE_INFO_FN                                         \
  __MINGW_NAME_UAW(QUERY_SECURITY_PACKAGE_INFO_FN)
...
KSECDDDECLSPEC SECURITY_STATUS WINAPI
ExportSecurityContext(PCtxtHandle phContext, ULONG fFlags,
                      PSecBuffer pPackedContext, void **pToken);
typedef SECURITY_STATUS(WINAPI *EXPORT_SECURITY_CONTEXT_FN)(PCtxtHandle, ULONG,
                                                            PSecBuffer,
                                                            void **);
...
typedef SECURITY_STATUS(WINAPI *IMPORT_SECURITY_CONTEXT_FN_A)(SEC_CHAR *,
                                                              PSecBuffer,
                                                              void *,
                                                              PCtxtHandle);
...
KSECDDDECLSPEC NTSTATUS NTAPI SecMakeSPN(
    PUNICODE_STRING ServiceClass, PUNICODE_STRING ServiceName,
    PUNICODE_STRING InstanceName, USHORT InstancePort, PUNICODE_STRING Referrer,
    PUNICODE_STRING Spn, PULONG Length, BOOLEAN Allocate);
KSECDDDECLSPEC NTSTATUS NTAPI
SecMakeSPNEx(PUNICODE_STRING ServiceClass, PUNICODE_STRING ServiceName,
             PUNICODE_STRING InstanceName, USHORT InstancePort,
             PUNICODE_STRING Referrer, PUNICODE_STRING TargetInfo,
             PUNICODE_STRING Spn, PULONG Length, BOOLEAN Allocate);
KSECDDDECLSPEC NTSTATUS NTAPI SecMakeSPNEx2(
    PUNICODE_STRING ServiceClass, PUNICODE_STRING ServiceName,
    PUNICODE_STRING InstanceName, USHORT InstancePort, PUNICODE_STRING Referrer,
    PUNICODE_STRING InTargetInfo, PUNICODE_STRING Spn, PULONG TotalSize,
    BOOLEAN Allocate, BOOLEAN IsTargetInfoMarshaled);
KSECDDDECLSPEC NTSTATUS WINAPI SecLookupAccountSid(PSID Sid, PULONG NameSize,
                                                   PUNICODE_STRING NameBuffer,
                                                   PULONG DomainSize,
                                                   PUNICODE_STRING DomainBuffer,
                                                   PSID_NAME_USE NameUse);
KSECDDDECLSPEC NTSTATUS WINAPI SecLookupAccountName(
    PUNICODE_STRING Name, PULONG SidSize, PSID Sid, PSID_NAME_USE NameUse,
    PULONG DomainSize, PUNICODE_STRING ReferencedDomain);
KSECDDDECLSPEC NTSTATUS WINAPI SecLookupWellKnownSid(
    WELL_KNOWN_SID_TYPE SidType, PSID Sid, ULONG SidBufferSize, PULONG SidSize);
#endif
...
ChangeAccountPasswordW(SEC_WCHAR *pszPackageName, SEC_WCHAR *pszDomainName,
                       SEC_WCHAR *pszAccountName, SEC_WCHAR *pszOldPassword,
                       SEC_WCHAR *pszNewPassword, BOOLEAN bImpersonating,
                       unsigned __LONG32 dwReserved, PSecBufferDesc pOutput);
typedef SECURITY_STATUS(SEC_ENTRY *CHANGE_PASSWORD_FN_W)(
    SEC_WCHAR *, SEC_WCHAR *, SEC_WCHAR *, SEC_WCHAR *, SEC_WCHAR *, BOOLEAN,
    unsigned __LONG32, PSecBufferDesc);
SECURITY_STATUS SEC_ENTRY ChangeAccountPasswordA(
    SEC_CHAR *pszPackageName, SEC_CHAR *pszDomainName, SEC_CHAR *pszAccountName,
    SEC_CHAR *pszOldPassword, SEC_CHAR *pszNewPassword, BOOLEAN bImpersonating,
    unsigned __LONG32 dwReserved, PSecBufferDesc pOutput);
typedef SECURITY_STATUS(SEC_ENTRY *CHANGE_PASSWORD_FN_A)(SEC_CHAR *, SEC_CHAR *,
                                                         SEC_CHAR *, SEC_CHAR *,
                                                         SEC_CHAR *, BOOLEAN,
                                                         unsigned __LONG32,
                                                         PSecBufferDesc);
...
#ifdef SECURITY_WIN32
SECURITY_STATUS WINAPI SaslEnumerateProfilesA(LPSTR *ProfileList,
                                              ULONG *ProfileCount);
SECURITY_STATUS WINAPI SaslEnumerateProfilesW(LPWSTR *ProfileList,
                                              ULONG *ProfileCount);
#define SaslEnumerateProfiles __MINGW_NAME_AW(SaslEnumerateProfiles)
SECURITY_STATUS WINAPI SaslGetProfilePackageA(LPSTR ProfileName,
                                              PSecPkgInfoA *PackageInfo);
SECURITY_STATUS WINAPI SaslGetProfilePackageW(LPWSTR ProfileName,
                                              PSecPkgInfoW *PackageInfo);
#define SaslGetProfilePackage __MINGW_NAME_AW(SaslGetProfilePackage)
SECURITY_STATUS WINAPI SaslIdentifyPackageA(PSecBufferDesc pInput,
                                            PSecPkgInfoA *PackageInfo);
SECURITY_STATUS WINAPI SaslIdentifyPackageW(PSecBufferDesc pInput,
                                            PSecPkgInfoW *PackageInfo);
#define SaslIdentifyPackage __MINGW_NAME_AW(SaslIdentifyPackage)
SECURITY_STATUS WINAPI SaslInitializeSecurityContextW(
    PCredHandle phCredential, PCtxtHandle phContext, LPWSTR pszTargetName,
    unsigned __LONG32 fContextReq, unsigned __LONG32 Reserved1,
    unsigned __LONG32 TargetDataRep, PSecBufferDesc pInput,
    unsigned __LONG32 Reserved2, PCtxtHandle phNewContext,
    PSecBufferDesc pOutput, unsigned __LONG32 *pfContextAttr,
...
SECURITY_STATUS WINAPI SaslInitializeSecurityContextA(
    ...
    PSecBufferDesc pOutput, unsigned __LONG32 *pfContextAttr,
    PTimeStamp ptsExpiry);
#define SaslInitializeSecurityContext                                          \
  __MINGW_NAME_AW(SaslInitializeSecurityContext)
SECURITY_STATUS WINAPI SaslAcceptSecurityContext(
    PCredHandle phCredential, PCtxtHandle phContext, PSecBufferDesc pInput,
    unsigned __LONG32 fContextReq, unsigned __LONG32 TargetDataRep,
    PCtxtHandle phNewContext, PSecBufferDesc pOutput,
    unsigned __LONG32 *pfContextAttr, PTimeStamp ptsExpiry);
...
SECURITY_STATUS WINAPI SaslSetContextOption(PCtxtHandle ContextHandle,
                                            ULONG Option, PVOID Value,
                                            ULONG Size);
SECURITY_STATUS WINAPI SaslGetContextOption(PCtxtHandle ContextHandle,
                                            ULONG Option, PVOID Value,
                                            ULONG Size, PULONG Needed);
#endif
...
unsigned __LONG32 SEC_ENTRY
SspiPromptForCredentialsW(PCWSTR pszTargetName,
#ifdef _CREDUI_INFO_DEFINED
                          PCREDUI_INFOW pUiInfo,
#else
                          PVOID pUiInfo,
#endif
                          unsigned __LONG32 dwAuthError, PCWSTR pszPackage,
                          PSEC_WINNT_AUTH_IDENTITY_OPAQUE pInputAuthIdentity,
                          PSEC_WINNT_AUTH_IDENTITY_OPAQUE *ppAuthIdentity,
                          int *pfSave, unsigned __LONG32 dwFlags);
unsigned __LONG32 SEC_ENTRY
SspiPromptForCredentialsA(PCSTR pszTargetName,
#ifdef _CREDUI_INFO_DEFINED
                          PCREDUI_INFOA pUiInfo,
#else
                          PVOID pUiInfo,
#endif
                          unsigned __LONG32 dwAuthError, PCSTR pszPackage,
                          PSEC_WINNT_AUTH_IDENTITY_OPAQUE pInputAuthIdentity,
                          PSEC_WINNT_AUTH_IDENTITY_OPAQUE *ppAuthIdentity,
                          int *pfSave, unsigned __LONG32 dwFlags);
...
SECURITY_STATUS SEC_ENTRY SspiGetCredUIContext(
    HANDLE ContextHandle, GUID *CredType, LUID *LogonId,
    PSEC_WINNT_CREDUI_CONTEXT_VECTOR *CredUIContexts, HANDLE *TokenHandle);
SECURITY_STATUS SEC_ENTRY SspiUpdateCredentials(HANDLE ContextHandle,
                                                GUID *CredType,
                                                ULONG FlatCredUIContextLength,
                                                PUCHAR FlatCredUIContext);
SECURITY_STATUS SEC_ENTRY SspiUnmarshalCredUIContext(
    PUCHAR MarshaledCredUIContext, ULONG MarshaledCredUIContextLength,
...
SECURITY_STATUS WINAPI AddSecurityPackageA(LPSTR pszPackageName,
                                           PSECURITY_PACKAGE_OPTIONS pOptions);
SECURITY_STATUS WINAPI AddSecurityPackageW(LPWSTR pszPackageName,
                                           PSECURITY_PACKAGE_OPTIONS pOptions);
...
typedef void (*SspiAsyncNotifyCallback)(SspiAsyncContext *Handle,
                                        PVOID CallbackData);
...
#if ISSP_MODE == 0
    PSECURITY_STRING pszPrincipal, PSECURITY_STRING pszPackage,
#else
    LPWSTR pszPrincipal, LPWSTR pszPackage,
#endif
    unsigned __LONG32 fCredentialUse, void *pvLogonId, void *pAuthData,
    SEC_GET_KEY_FN pGetKeyFn, void *pvGetKeyArgument, PCredHandle phCredential,
    PTimeStamp ptsExpiry);
SECURITY_STATUS SspiAcquireCredentialsHandleAsyncA(
    SspiAsyncContext *AsyncContext, LPSTR pszPrincipal, LPSTR pszPackage,
    unsigned __LONG32 fCredentialUse, void *pvLogonId, void *pAuthData,
    SEC_GET_KEY_FN pGetKeyFn, void *pvGetKeyArgument, PCredHandle phCredential,
    PTimeStamp ptsExpiry);
SECURITY_STATUS SspiInitializeSecurityContextAsyncW(
    SspiAsyncContext *AsyncContext, PCredHandle phCredential,
    PCtxtHandle phContext,
#if ISSP_MODE == 0
...
SECURITY_STATUS SspiInitializeSecurityContextAsyncA(
    SspiAsyncContext *AsyncContext, PCredHandle phCredential,
    PCtxtHandle phContext, LPSTR pszTargetName, unsigned __LONG32 fContextReq,
    unsigned __LONG32 Reserved1, unsigned __LONG32 TargetDataRep,
    PSecBufferDesc pInput, unsigned __LONG32 Reserved2,
    PCtxtHandle phNewContext, PSecBufferDesc pOutput,
    unsigned __LONG32 *pfContextAttr, PTimeStamp ptsExpiry);
SECURITY_STATUS SspiAcceptSecurityContextAsync(
    SspiAsyncContext *AsyncContext, PCredHandle phCredential,
    PCtxtHandle phContext, PSecBufferDesc pInput, unsigned __LONG32 fContextReq,
    unsigned __LONG32 TargetDataRep, PCtxtHandle phNewContext,
    PSecBufferDesc pOutput, unsigned __LONG32 *pfContextAttr,
    PTimeStamp ptsExpiry);
SECURITY_STATUS SspiFreeCredentialsHandleAsync(SspiAsyncContext *AsyncContext,
                                               PCredHandle phCredential);
SECURITY_STATUS SspiDeleteSecurityContextAsync(SspiAsyncContext *AsyncContext,
                                               PCtxtHandle phContext);
#define SspiAcquireCredentialsHandleAsync                                      \
  __MINGW_NAME_AW(SspiAcquireCredentialsHandleAsync)
#define SspiInitializeSecurityContextAsync                                     \
  __MINGW_NAME_AW(SspiInitializeSecurityContextAsync)
#endif
SECURITY_STATUS SEC_ENTRY SspiPrepareForCredRead(
    PSEC_WINNT_AUTH_IDENTITY_OPAQUE AuthIdentity, PCWSTR pszTargetName,
    PULONG pCredmanCredentialType, PCWSTR *ppszCredmanTargetName);
SECURITY_STATUS SEC_ENTRY SspiPrepareForCredWrite(
    PSEC_WINNT_AUTH_IDENTITY_OPAQUE AuthIdentity, PCWSTR pszTargetName,
    PULONG pCredmanCredentialType, PCWSTR *ppszCredmanTargetName,
    PCWSTR *ppszCredmanUserName, PUCHAR *ppCredentialBlob,
...
SECURITY_STATUS
    SEC_ENTRY SspiEncryptAuthIdentity(PSEC_WINNT_AUTH_IDENTITY_OPAQUE AuthData);
SECURITY_STATUS SEC_ENTRY SspiEncryptAuthIdentityEx(
    ULONG Options, PSEC_WINNT_AUTH_IDENTITY_OPAQUE AuthData);
SECURITY_STATUS SEC_ENTRY
...
SECURITY_STATUS SEC_ENTRY SspiDecryptAuthIdentityEx(
    ULONG Options, PSEC_WINNT_AUTH_IDENTITY_OPAQUE EncryptedAuthData);
BOOLEAN SEC_ENTRY
...
SECURITY_STATUS SEC_ENTRY SspiEncodeAuthIdentityAsStrings(
    PSEC_WINNT_AUTH_IDENTITY_OPAQUE pAuthIdentity, PCWSTR *ppszUserName,
    PCWSTR *ppszDomainName, PCWSTR *ppszPackedCredentialsString);
SECURITY_STATUS SEC_ENTRY
SspiValidateAuthIdentity(PSEC_WINNT_AUTH_IDENTITY_OPAQUE AuthData);
SECURITY_STATUS SEC_ENTRY
SspiCopyAuthIdentity(PSEC_WINNT_AUTH_IDENTITY_OPAQUE AuthData,
...
SECURITY_STATUS SEC_ENTRY SspiEncodeStringsAsAuthIdentity(
    PCWSTR pszUserName, PCWSTR pszDomainName, PCWSTR pszPackedCredentialsString,
    PSEC_WINNT_AUTH_IDENTITY_OPAQUE *ppAuthIdentity);
SECURITY_STATUS SEC_ENTRY SspiCompareAuthIdentities(
    PSEC_WINNT_AUTH_IDENTITY_OPAQUE AuthIdentity1,
    PSEC_WINNT_AUTH_IDENTITY_OPAQUE AuthIdentity2, PBOOLEAN SameSuppliedUser,
...
SECURITY_STATUS SEC_ENTRY SspiMarshalAuthIdentity(
    ...
    unsigned __LONG32 *AuthIdentityLength, char **AuthIdentityByteArray);
...
SECURITY_STATUS SEC_ENTRY SspiGetTargetHostName(PCWSTR pszTargetName,
                                                PWSTR *pszHostName);
SECURITY_STATUS SEC_ENTRY SspiExcludePackage(
    PSEC_WINNT_AUTH_IDENTITY_OPAQUE AuthIdentity, PCWSTR pszPackageName,
