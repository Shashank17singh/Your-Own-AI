...
#define INTERNET_FLAGS_MASK                                                    \
  (INTERNET_FLAG_RELOAD | INTERNET_FLAG_RAW_DATA |                             \
   INTERNET_FLAG_EXISTING_CONNECT | INTERNET_FLAG_ASYNC |                      \
   INTERNET_FLAG_PASSIVE | INTERNET_FLAG_NO_CACHE_WRITE |                      \
   INTERNET_FLAG_MAKE_PERSISTENT | INTERNET_FLAG_FROM_CACHE |                  \
   ...
   INTERNET_FLAG_RESYNCHRONIZE | INTERNET_FLAG_HYPERLINK |                     \
   INTERNET_FLAG_NO_UI | INTERNET_FLAG_PRAGMA_NOCACHE |                        \
   INTERNET_FLAG_CACHE_ASYNC | INTERNET_FLAG_FORMS_SUBMIT |                    \
   INTERNET_FLAG_NEED_FILE | INTERNET_FLAG_RESTRICTED_ZONE |                   \
...
#else
BOOLAPI InternetTimeFromSystemTime(CONST SYSTEMTIME *pst, DWORD dwRFC,
                                   LPSTR lpszTime, DWORD cbTime);
#endif
BOOLAPI InternetTimeFromSystemTimeA(CONST SYSTEMTIME *pst, DWORD dwRFC,
                                    LPSTR lpszTime, DWORD cbTime);
BOOLAPI InternetTimeFromSystemTimeW(CONST SYSTEMTIME *pst, DWORD dwRFC,
...
#else
BOOLAPI InternetTimeToSystemTime(LPCSTR lpszTime, SYSTEMTIME *pst,
                                 DWORD dwReserved);
#endif
BOOLAPI InternetTimeToSystemTimeA(LPCSTR lpszTime, SYSTEMTIME *pst,
                                  DWORD dwReserved);
BOOLAPI InternetTimeToSystemTimeW(LPCWSTR lpszTime, SYSTEMTIME *pst,
                                  DWORD dwReserved);
BOOLAPI InternetCrackUrlA(LPCSTR lpszUrl, DWORD dwUrlLength, DWORD dwFlags,
                          LPURL_COMPONENTSA lpUrlComponents);
BOOLAPI InternetCrackUrlW(LPCWSTR lpszUrl, DWORD dwUrlLength, DWORD dwFlags,
                          LPURL_COMPONENTSW lpUrlComponents);
BOOLAPI InternetCreateUrlA(LPURL_COMPONENTSA lpUrlComponents, DWORD dwFlags,
                           LPSTR lpszUrl, LPDWORD lpdwUrlLength);
BOOLAPI InternetCreateUrlW(LPURL_COMPONENTSW lpUrlComponents, DWORD dwFlags,
...
BOOLAPI InternetCanonicalizeUrlW(LPCWSTR lpszUrl, LPWSTR lpszBuffer,
                                 LPDWORD lpdwBufferLength, DWORD dwFlags);
BOOLAPI InternetCombineUrlA(LPCSTR lpszBaseUrl, LPCSTR lpszRelativeUrl,
                            LPSTR lpszBuffer, LPDWORD lpdwBufferLength,
                            DWORD dwFlags);
BOOLAPI InternetCombineUrlW(LPCWSTR lpszBaseUrl, LPCWSTR lpszRelativeUrl,
...
InternetOpenA(LPCSTR lpszAgent, DWORD dwAccessType, LPCSTR lpszProxy,
              LPCSTR lpszProxyBypass, DWORD dwFlags);
INTERNETAPI_(HINTERNET)
InternetOpenW(LPCWSTR lpszAgent, DWORD dwAccessType, LPCWSTR lpszProxy,
...
INTERNETAPI_(HINTERNET)
InternetConnectA(HINTERNET hInternet, LPCSTR lpszServerName,
                 INTERNET_PORT nServerPort, LPCSTR lpszUserName,
                 LPCSTR lpszPassword, DWORD dwService, DWORD dwFlags,
                 DWORD_PTR dwContext);
INTERNETAPI_(HINTERNET)
InternetConnectW(HINTERNET hInternet, LPCWSTR lpszServerName,
                 INTERNET_PORT nServerPort, LPCWSTR lpszUserName,
                 LPCWSTR lpszPassword, DWORD dwService, DWORD dwFlags,
                 DWORD_PTR dwContext);
...
INTERNETAPI_(HINTERNET)
InternetOpenUrlA(HINTERNET hInternet, LPCSTR lpszUrl, LPCSTR lpszHeaders,
                 DWORD dwHeadersLength, DWORD dwFlags, DWORD_PTR dwContext);
INTERNETAPI_(HINTERNET)
InternetOpenUrlW(HINTERNET hInternet, LPCWSTR lpszUrl, LPCWSTR lpszHeaders,
                 DWORD dwHeadersLength, DWORD dwFlags, DWORD_PTR dwContext);
BOOLAPI InternetReadFile(HINTERNET hFile, LPVOID lpBuffer,
                         DWORD dwNumberOfBytesToRead,
                         LPDWORD lpdwNumberOfBytesRead);
INTERNETAPI_(WINBOOL)
InternetReadFileExA(HINTERNET hFile, LPINTERNET_BUFFERSA lpBuffersOut,
                    DWORD dwFlags, DWORD_PTR dwContext);
INTERNETAPI_(WINBOOL)
InternetReadFileExW(HINTERNET hFile, LPINTERNET_BUFFERSW lpBuffersOut,
                    DWORD dwFlags, DWORD_PTR dwContext);
...
INTERNETAPI_(DWORD)
InternetSetFilePointer(HINTERNET hFile, LONG lDistanceToMove, PVOID pReserved,
...
BOOLAPI InternetQueryOptionA(HINTERNET hInternet, DWORD dwOption,
                             LPVOID lpBuffer, LPDWORD lpdwBufferLength);
BOOLAPI InternetQueryOptionW(HINTERNET hInternet, DWORD dwOption,
                             LPVOID lpBuffer, LPDWORD lpdwBufferLength);
BOOLAPI InternetSetOptionA(HINTERNET hInternet, DWORD dwOption, LPVOID lpBuffer,
                           DWORD dwBufferLength);
BOOLAPI InternetSetOptionW(HINTERNET hInternet, DWORD dwOption, LPVOID lpBuffer,
                           DWORD dwBufferLength);
BOOLAPI InternetSetOptionExA(HINTERNET hInternet, DWORD dwOption,
                             LPVOID lpBuffer, DWORD dwBufferLength,
                             DWORD dwFlags);
BOOLAPI InternetSetOptionExW(HINTERNET hInternet, DWORD dwOption,
                             LPVOID lpBuffer, DWORD dwBufferLength,
                             DWORD dwFlags);
BOOLAPI InternetLockRequestFile(HINTERNET hInternet,
...
#define SECURITY_FLAG_IGNORE_CERT_DATE_INVALID                                 \
  INTERNET_FLAG_IGNORE_CERT_DATE_INVALID
#define SECURITY_FLAG_IGNORE_REDIRECT_TO_HTTPS                                 \
  INTERNET_FLAG_IGNORE_REDIRECT_TO_HTTPS
#define SECURITY_FLAG_IGNORE_REDIRECT_TO_HTTP                                  \
  INTERNET_FLAG_IGNORE_REDIRECT_TO_HTTP
...
BOOLAPI InternetGetLastResponseInfoA(LPDWORD lpdwError, LPSTR lpszBuffer,
                                     LPDWORD lpdwBufferLength);
BOOLAPI InternetGetLastResponseInfoW(LPDWORD lpdwError, LPWSTR lpszBuffer,
                                     LPDWORD lpdwBufferLength);
...
InternetSetStatusCallback(HINTERNET hInternet,
...
#define INTERNET_INVALID_STATUS_CALLBACK                                       \
  ((INTERNET_STATUS_CALLBACK)(INT_PTR) - 1)
...
INTERNETAPI_(HINTERNET)
FtpFindFirstFileA(HINTERNET hConnect, LPCSTR lpszSearchFile,
                  LPWIN32_FIND_DATAA lpFindFileData, DWORD dwFlags,
                  DWORD_PTR dwContext);
INTERNETAPI_(HINTERNET)
FtpFindFirstFileW(HINTERNET hConnect, LPCWSTR lpszSearchFile,
                  LPWIN32_FIND_DATAW lpFindFileData, DWORD dwFlags,
                  DWORD_PTR dwContext);
BOOLAPI FtpGetFileA(HINTERNET hConnect, LPCSTR lpszRemoteFile,
                    LPCSTR lpszNewFile, WINBOOL fFailIfExists,
                    DWORD dwFlagsAndAttributes, DWORD dwFlags,
                    DWORD_PTR dwContext);
BOOLAPI FtpGetFileW(HINTERNET hConnect, LPCWSTR lpszRemoteFile,
                    LPCWSTR lpszNewFile, WINBOOL fFailIfExists,
                    DWORD dwFlagsAndAttributes, DWORD dwFlags,
                    DWORD_PTR dwContext);
BOOLAPI FtpPutFileA(HINTERNET hConnect, LPCSTR lpszLocalFile,
                    LPCSTR lpszNewRemoteFile, DWORD dwFlags,
                    DWORD_PTR dwContext);
BOOLAPI FtpPutFileW(HINTERNET hConnect, LPCWSTR lpszLocalFile,
                    LPCWSTR lpszNewRemoteFile, DWORD dwFlags,
                    DWORD_PTR dwContext);
BOOLAPI FtpGetFileEx(HINTERNET hFtpSession, LPCSTR lpszRemoteFile,
                     LPCWSTR lpszNewFile, WINBOOL fFailIfExists,
                     DWORD dwFlagsAndAttributes, DWORD dwFlags,
                     DWORD_PTR dwContext);
BOOLAPI FtpPutFileEx(HINTERNET hFtpSession, LPCWSTR lpszLocalFile,
                     LPCSTR lpszNewRemoteFile, DWORD dwFlags,
                     DWORD_PTR dwContext);
...
BOOLAPI FtpRenameFileW(HINTERNET hConnect, LPCWSTR lpszExisting,
                       LPCWSTR lpszNew);
INTERNETAPI_(HINTERNET)
FtpOpenFileA(HINTERNET hConnect, LPCSTR lpszFileName, DWORD dwAccess,
             DWORD dwFlags, DWORD_PTR dwContext);
INTERNETAPI_(HINTERNET)
FtpOpenFileW(HINTERNET hConnect, LPCWSTR lpszFileName, DWORD dwAccess,
             DWORD dwFlags, DWORD_PTR dwContext);
...
BOOLAPI FtpGetCurrentDirectoryA(HINTERNET hConnect, LPSTR lpszCurrentDirectory,
                                LPDWORD lpdwCurrentDirectory);
BOOLAPI FtpGetCurrentDirectoryW(HINTERNET hConnect, LPWSTR lpszCurrentDirectory,
                                LPDWORD lpdwCurrentDirectory);
BOOLAPI FtpCommandA(HINTERNET hConnect, WINBOOL fExpectResponse, DWORD dwFlags,
                    LPCSTR lpszCommand, DWORD_PTR dwContext,
                    HINTERNET *phFtpCommand);
BOOLAPI FtpCommandW(HINTERNET hConnect, WINBOOL fExpectResponse, DWORD dwFlags,
                    LPCWSTR lpszCommand, DWORD_PTR dwContext,
                    HINTERNET *phFtpCommand);
...
#define MAX_GOPHER_LOCATOR_LENGTH                                              \
  (1 + MAX_GOPHER_DISPLAY_TEXT + 1 + MAX_GOPHER_SELECTOR_TEXT + 1 +            \
   MAX_GOPHER_HOST_NAME + 1 + INTERNET_MAX_PORT_NUMBER_LENGTH + 1 + 1 + 2)
typedef struct {
...
#define IS_GOPHER_FILE(type)                                                   \
  (WINBOOL)(((type) & GOPHER_TYPE_FILE_MASK) ? TRUE : FALSE)
#define IS_GOPHER_DIRECTORY(type)                                              \
  (WINBOOL)(((type) & GOPHER_TYPE_DIRECTORY) ? TRUE : FALSE)
#define IS_GOPHER_PHONE_SERVER(type)                                           \
  (WINBOOL)(((type) & GOPHER_TYPE_CSO) ? TRUE : FALSE)
#define IS_GOPHER_ERROR(type)                                                  \
  (WINBOOL)(((type) & GOPHER_TYPE_ERROR) ? TRUE : FALSE)
#define IS_GOPHER_INDEX_SERVER(type)                                           \
  (WINBOOL)(((type) & GOPHER_TYPE_INDEX_SERVER) ? TRUE : FALSE)
#define IS_GOPHER_TELNET_SESSION(type)                                         \
  (WINBOOL)(((type) & GOPHER_TYPE_TELNET) ? TRUE : FALSE)
#define IS_GOPHER_BACKUP_SERVER(type)                                          \
  (WINBOOL)(((type) & GOPHER_TYPE_REDUNDANT) ? TRUE : FALSE)
#define IS_GOPHER_TN3270_SESSION(type)                                         \
  (WINBOOL)(((type) & GOPHER_TYPE_TN3270) ? TRUE : FALSE)
#define IS_GOPHER_ASK(type) (WINBOOL)(((type) & GOPHER_TYPE_ASK) ? TRUE : FALSE)
#define IS_GOPHER_PLUS(type)                                                   \
  (WINBOOL)(((type) & GOPHER_TYPE_GOPHER_PLUS) ? TRUE : FALSE)
#define IS_GOPHER_TYPE_KNOWN(type)                                             \
  (WINBOOL)(((type) & GOPHER_TYPE_UNKNOWN) ? FALSE : TRUE)
#define GOPHER_TYPE_FILE_MASK                                                  \
  (GOPHER_TYPE_TEXT_FILE | GOPHER_TYPE_MAC_BINHEX | GOPHER_TYPE_DOS_ARCHIVE |  \
   ...
   GOPHER_TYPE_IMAGE | GOPHER_TYPE_BITMAP | GOPHER_TYPE_MOVIE |                \
   GOPHER_TYPE_SOUND | GOPHER_TYPE_HTML | GOPHER_TYPE_PDF |                    \
   GOPHER_TYPE_CALENDAR | GOPHER_TYPE_INLINE)
typedef struct {
  LPCTSTR Comment;
...
BOOLAPI GopherCreateLocatorA(LPCSTR lpszHost, INTERNET_PORT nServerPort,
                             LPCSTR lpszDisplayString,
                             LPCSTR lpszSelectorString, DWORD dwGopherType,
                             LPSTR lpszLocator, LPDWORD lpdwBufferLength);
BOOLAPI GopherCreateLocatorW(LPCWSTR lpszHost, INTERNET_PORT nServerPort,
                             LPCWSTR lpszDisplayString,
                             LPCWSTR lpszSelectorString, DWORD dwGopherType,
                             LPWSTR lpszLocator, LPDWORD lpdwBufferLength);
...
INTERNETAPI_(HINTERNET)
GopherFindFirstFileA(HINTERNET hConnect, LPCSTR lpszLocator,
                     LPCSTR lpszSearchString, LPGOPHER_FIND_DATAA lpFindData,
                     DWORD dwFlags, DWORD_PTR dwContext);
INTERNETAPI_(HINTERNET)
GopherFindFirstFileW(HINTERNET hConnect, LPCWSTR lpszLocator,
                     LPCWSTR lpszSearchString, LPGOPHER_FIND_DATAW lpFindData,
                     DWORD dwFlags, DWORD_PTR dwContext);
INTERNETAPI_(HINTERNET)
GopherOpenFileA(HINTERNET hConnect, LPCSTR lpszLocator, LPCSTR lpszView,
                DWORD dwFlags, DWORD_PTR dwContext);
INTERNETAPI_(HINTERNET)
GopherOpenFileW(HINTERNET hConnect, LPCWSTR lpszLocator, LPCWSTR lpszView,
                DWORD dwFlags, DWORD_PTR dwContext);
typedef WINBOOL(CALLBACK *GOPHER_ATTRIBUTE_ENUMERATOR)(
    LPGOPHER_ATTRIBUTE_TYPE lpAttributeInfo, DWORD dwError);
BOOLAPI GopherGetAttributeA(HINTERNET hConnect, LPCSTR lpszLocator,
                            LPCSTR lpszAttributeName, LPBYTE lpBuffer,
                            DWORD dwBufferLength,
                            LPDWORD lpdwCharactersReturned,
                            GOPHER_ATTRIBUTE_ENUMERATOR lpfnEnumerator,
                            DWORD_PTR dwContext);
BOOLAPI GopherGetAttributeW(HINTERNET hConnect, LPCWSTR lpszLocator,
...
#define HTTP_QUERY_MODIFIER_FLAGS_MASK                                         \
  (HTTP_QUERY_FLAG_REQUEST_HEADERS | HTTP_QUERY_FLAG_SYSTEMTIME |              \
   HTTP_QUERY_FLAG_NUMBER | HTTP_QUERY_FLAG_COALESCE |                         \
...
INTERNETAPI_(HINTERNET)
HttpOpenRequestA(HINTERNET hConnect, LPCSTR lpszVerb, LPCSTR lpszObjectName,
                 LPCSTR lpszVersion, LPCSTR lpszReferrer,
                 LPCSTR *lplpszAcceptTypes, DWORD dwFlags, DWORD_PTR dwContext);
INTERNETAPI_(HINTERNET)
HttpOpenRequestW(HINTERNET hConnect, LPCWSTR lpszVerb, LPCWSTR lpszObjectName,
                 LPCWSTR lpszVersion, LPCWSTR lpszReferrer,
                 LPCWSTR *lplpszAcceptTypes, DWORD dwFlags,
                 DWORD_PTR dwContext);
BOOLAPI HttpAddRequestHeadersA(HINTERNET hRequest, LPCSTR lpszHeaders,
                               DWORD dwHeadersLength, DWORD dwModifiers);
BOOLAPI HttpAddRequestHeadersW(HINTERNET hRequest, LPCWSTR lpszHeaders,
                               DWORD dwHeadersLength, DWORD dwModifiers);
...
BOOLAPI HttpSendRequestA(HINTERNET hRequest, LPCSTR lpszHeaders,
                         DWORD dwHeadersLength, LPVOID lpOptional,
                         DWORD dwOptionalLength);
BOOLAPI HttpSendRequestW(HINTERNET hRequest, LPCWSTR lpszHeaders,
                         DWORD dwHeadersLength, LPVOID lpOptional,
                         DWORD dwOptionalLength);
INTERNETAPI_(WINBOOL)
HttpSendRequestExA(HINTERNET hRequest, LPINTERNET_BUFFERSA lpBuffersIn,
                   LPINTERNET_BUFFERSA lpBuffersOut, DWORD dwFlags,
                   DWORD_PTR dwContext);
INTERNETAPI_(WINBOOL)
HttpSendRequestExW(HINTERNET hRequest, LPINTERNET_BUFFERSW lpBuffersIn,
                   LPINTERNET_BUFFERSW lpBuffersOut, DWORD dwFlags,
                   DWORD_PTR dwContext);
...
INTERNETAPI_(WINBOOL)
HttpEndRequestA(HINTERNET hRequest, LPINTERNET_BUFFERSA lpBuffersOut,
                DWORD dwFlags, DWORD_PTR dwContext);
INTERNETAPI_(WINBOOL)
HttpEndRequestW(HINTERNET hRequest, LPINTERNET_BUFFERSW lpBuffersOut,
                DWORD dwFlags, DWORD_PTR dwContext);
BOOLAPI HttpQueryInfoA(HINTERNET hRequest, DWORD dwInfoLevel, LPVOID lpBuffer,
                       LPDWORD lpdwBufferLength, LPDWORD lpdwIndex);
BOOLAPI HttpQueryInfoW(HINTERNET hRequest, DWORD dwInfoLevel, LPVOID lpBuffer,
                       LPDWORD lpdwBufferLength, LPDWORD lpdwIndex);
typedef struct {
  PWSTR pwszName;
  PWSTR pwszValue;
...
BOOLAPI InternetSetCookieA(LPCSTR lpszUrl, LPCSTR lpszCookieName,
                           LPCSTR lpszCookieData);
BOOLAPI InternetSetCookieW(LPCWSTR lpszUrl, LPCWSTR lpszCookieName,
...
BOOLAPI InternetGetCookieW(LPCWSTR lpszUrl, LPCWSTR lpszCookieName,
                           LPWSTR lpszCookieData, LPDWORD lpdwSize);
INTERNETAPI_(DWORD)
InternetSetCookieExA(LPCSTR lpszUrl, LPCSTR lpszCookieName,
                     LPCSTR lpszCookieData, DWORD dwFlags,
                     DWORD_PTR dwReserved);
INTERNETAPI_(DWORD)
InternetSetCookieExW(LPCWSTR lpszUrl, LPCWSTR lpszCookieName,
                     LPCWSTR lpszCookieData, DWORD dwFlags,
                     DWORD_PTR dwReserved);
BOOLAPI InternetGetCookieExA(LPCSTR lpszUrl, LPCSTR lpszCookieName,
                             LPSTR lpszCookieData, LPDWORD lpdwSize,
                             DWORD dwFlags, LPVOID lpReserved);
BOOLAPI InternetGetCookieExW(LPCWSTR lpszUrl, LPCWSTR lpszCookieName,
                             LPWSTR lpszCookieData, LPDWORD lpdwSize,
                             DWORD dwFlags, LPVOID lpReserved);
INTERNETAPI_(DWORD) InternetAttemptConnect(DWORD dwReserved);
BOOLAPI InternetCheckConnectionA(LPCSTR lpszUrl, DWORD dwFlags,
                                 DWORD dwReserved);
BOOLAPI InternetCheckConnectionW(LPCWSTR lpszUrl, DWORD dwFlags,
                                 DWORD dwReserved);
...
DWORD InternetAuthNotifyCallback(DWORD_PTR dwContext, DWORD dwReturn,
                                 LPVOID lpReserved);
...
#else
INTERNETAPI_(DWORD)
InternetConfirmZoneCrossing(HWND hWnd, LPSTR szUrlPrev, LPSTR szUrlNew,
                            WINBOOL bPost);
#endif
INTERNETAPI_(WINBOOL)
ResumeSuspendedDownload(HINTERNET hRequest, DWORD dwResultCode);
INTERNETAPI_(DWORD)
InternetErrorDlg(HWND hWnd, HINTERNET hRequest, DWORD dwError, DWORD dwFlags,
                 LPVOID *lppvData);
INTERNETAPI_(DWORD)
InternetConfirmZoneCrossingA(HWND hWnd, LPSTR szUrlPrev, LPSTR szUrlNew,
                             WINBOOL bPost);
INTERNETAPI_(DWORD)
InternetConfirmZoneCrossingW(HWND hWnd, LPWSTR szUrlPrev, LPWSTR szUrlNew,
                             WINBOOL bPost);
...
#define ERROR_INTERNET_LOGIN_FAILURE_DISPLAY_ENTITY_BODY                       \
  (INTERNET_ERROR_BASE + 174)
...
#define URLCACHE_FIND_DEFAULT_FILTER                                           \
  NORMAL_CACHE_ENTRY | COOKIE_CACHE_ENTRY | URLHISTORY_CACHE_ENTRY |           \
      TRACK_OFFLINE_CACHE_ENTRY | TRACK_ONLINE_CACHE_ENTRY |                   \
      STICKY_CACHE_ENTRY
...
BOOLAPI CreateUrlCacheEntryA(LPCSTR lpszUrlName, DWORD dwExpectedFileSize,
                             LPCSTR lpszFileExtension, LPSTR lpszFileName,
                             DWORD dwReserved);
BOOLAPI CreateUrlCacheEntryW(LPCWSTR lpszUrlName, DWORD dwExpectedFileSize,
                             LPCWSTR lpszFileExtension, LPWSTR lpszFileName,
                             DWORD dwReserved);
#ifndef USE_FIXED_COMMIT_URL_CACHE_ENTRY
BOOLAPI CommitUrlCacheEntryA(LPCSTR lpszUrlName, LPCSTR lpszLocalFileName,
                             FILETIME ExpireTime, FILETIME LastModifiedTime,
                             DWORD CacheEntryType, LPBYTE lpHeaderInfo,
                             DWORD dwHeaderSize, LPCSTR lpszFileExtension,
                             LPCSTR lpszOriginalUrl);
BOOLAPI CommitUrlCacheEntryW(LPCWSTR lpszUrlName, LPCWSTR lpszLocalFileName,
                             FILETIME ExpireTime, FILETIME LastModifiedTime,
                             DWORD CacheEntryType, LPWSTR lpszHeaderInfo,
                             DWORD dwHeaders, LPCWSTR lpszFileExtension,
                             LPCWSTR lpszOriginalUrl);
#else
CommitUrlCacheEntryA(LPCSTR lpszUrlName, LPCSTR lpszLocalFileName,
                     FILETIME ExpireTime, FILETIME LastModifiedTime,
                     DWORD CacheEntryType, LPCSTR lpHeaderInfo,
                     DWORD dwHeaderSize, LPCSTR lpszFileExtension,
                     LPCSTR lpszOriginalUrl);
CommitUrlCacheEntryW(LPCWSTR lpszUrlName, LPCWSTR lpszLocalFileName,
                     FILETIME ExpireTime, FILETIME LastModifiedTime,
                     DWORD CacheEntryType, LPCWSTR lpHeaderInfo,
                     DWORD dwHeaderSize, LPCWSTR lpszFileExtension,
                     LPCWSTR lpszOriginalUrl);
#endif
BOOLAPI
RetrieveUrlCacheEntryFileA(LPCSTR lpszUrlName,
                           LPINTERNET_CACHE_ENTRY_INFOA lpCacheEntryInfo,
                           LPDWORD lpcbCacheEntryInfo, DWORD dwReserved);
BOOLAPI
...
RetrieveUrlCacheEntryStreamA(LPCSTR lpszUrlName,
                             LPINTERNET_CACHE_ENTRY_INFOA lpCacheEntryInfo,
                             LPDWORD lpcbCacheEntryInfo, WINBOOL fRandomRead,
                             DWORD dwReserved);
INTERNETAPI_(HANDLE)
RetrieveUrlCacheEntryStreamW(LPCWSTR lpszUrlName,
                             ...
                             LPDWORD lpcbCacheEntryInfo, WINBOOL fRandomRead,
                             DWORD dwReserved);
BOOLAPI ReadUrlCacheEntryStream(HANDLE hUrlCacheStream, DWORD dwLocation,
                                LPVOID lpBuffer, LPDWORD lpdwLen,
                                DWORD Reserved);
BOOLAPI UnlockUrlCacheEntryStream(HANDLE hUrlCacheStream, DWORD Reserved);
URLCACHEAPI_(WINBOOL)
GetUrlCacheEntryInfoA(LPCSTR lpszUrlName,
                      LPINTERNET_CACHE_ENTRY_INFOA lpCacheEntryInfo,
                      LPDWORD lpcbCacheEntryInfo);
URLCACHEAPI_(WINBOOL)
GetUrlCacheEntryInfoW(LPCWSTR lpszUrlName,
                      LPINTERNET_CACHE_ENTRY_INFOW lpCacheEntryInfo,
                      LPDWORD lpcbCacheEntryInfo);
URLCACHEAPI_(HANDLE)
FindFirstUrlCacheGroup(DWORD dwFlags, DWORD dwFilter, LPVOID lpSearchCondition,
                       DWORD dwSearchCondition, GROUPID *lpGroupId,
                       LPVOID lpReserved);
URLCACHEAPI_(WINBOOL)
FindNextUrlCacheGroup(HANDLE hFind, GROUPID *lpGroupId, LPVOID lpReserved);
URLCACHEAPI_(WINBOOL)
GetUrlCacheGroupAttributeA(GROUPID gid, DWORD dwFlags, DWORD dwAttributes,
                           LPINTERNET_CACHE_GROUP_INFOA lpGroupInfo,
                           LPDWORD lpdwGroupInfo, LPVOID lpReserved);
URLCACHEAPI_(WINBOOL)
GetUrlCacheGroupAttributeW(GROUPID gid, DWORD dwFlags, DWORD dwAttributes,
                           LPINTERNET_CACHE_GROUP_INFOW lpGroupInfo,
                           LPDWORD lpdwGroupInfo, LPVOID lpReserved);
URLCACHEAPI_(WINBOOL)
SetUrlCacheGroupAttributeA(GROUPID gid, DWORD dwFlags, DWORD dwAttributes,
                           LPINTERNET_CACHE_GROUP_INFOA lpGroupInfo,
                           LPVOID lpReserved);
URLCACHEAPI_(WINBOOL)
SetUrlCacheGroupAttributeW(GROUPID gid, DWORD dwFlags, DWORD dwAttributes,
                           LPINTERNET_CACHE_GROUP_INFOW lpGroupInfo,
                           LPVOID lpReserved);
...
BOOLAPI GetUrlCacheEntryInfoExA(LPCSTR lpszUrl,
                                LPINTERNET_CACHE_ENTRY_INFOA lpCacheEntryInfo,
                                LPDWORD lpcbCacheEntryInfo,
                                LPSTR lpszRedirectUrl, LPDWORD lpcbRedirectUrl,
                                LPVOID lpReserved, DWORD dwFlags);
BOOLAPI GetUrlCacheEntryInfoExW(LPCWSTR lpszUrl,
                                LPINTERNET_CACHE_ENTRY_INFOW lpCacheEntryInfo,
                                LPDWORD lpcbCacheEntryInfo,
                                LPWSTR lpszRedirectUrl, LPDWORD lpcbRedirectUrl,
                                LPVOID lpReserved, DWORD dwFlags);
...
#else
BOOLAPI SetUrlCacheEntryGroup(LPCSTR lpszUrlName, DWORD dwFlags,
                              GROUPID GroupId, LPBYTE pbGroupAttributes,
                              DWORD cbGroupAttributes, LPVOID lpReserved);
BOOLAPI DeleteUrlCacheEntry(LPCSTR lpszUrlName);
INTERNETAPI_(DWORD)
InternetDial(HWND hwndParent, LPSTR lpszConnectoid, DWORD dwFlags,
             LPDWORD lpdwConnection, DWORD dwReserved);
INTERNETAPI_(WINBOOL)
InternetGoOnline(LPSTR lpszURL, HWND hwndParent, DWORD dwFlags);
#endif
BOOLAPI SetUrlCacheEntryInfoA(LPCSTR lpszUrlName,
                              LPINTERNET_CACHE_ENTRY_INFOA lpCacheEntryInfo,
                              DWORD dwFieldControl);
BOOLAPI SetUrlCacheEntryInfoW(LPCWSTR lpszUrlName,
                              LPINTERNET_CACHE_ENTRY_INFOW lpCacheEntryInfo,
                              DWORD dwFieldControl);
INTERNETAPI_(GROUPID) CreateUrlCacheGroup(DWORD dwFlags, LPVOID lpReserved);
BOOLAPI DeleteUrlCacheGroup(GROUPID GroupId, DWORD dwFlags, LPVOID lpReserved);
...
BOOLAPI SetUrlCacheEntryGroupA(LPCSTR lpszUrlName, DWORD dwFlags,
                               GROUPID GroupId, LPBYTE pbGroupAttributes,
                               DWORD cbGroupAttributes, LPVOID lpReserved);
BOOLAPI SetUrlCacheEntryGroupW(LPCWSTR lpszUrlName, DWORD dwFlags,
                               GROUPID GroupId, LPBYTE pbGroupAttributes,
                               DWORD cbGroupAttributes, LPVOID lpReserved);
INTERNETAPI_(HANDLE)
FindFirstUrlCacheEntryExA(LPCSTR lpszUrlSearchPattern, DWORD dwFlags,
                          DWORD dwFilter, GROUPID GroupId,
                          LPINTERNET_CACHE_ENTRY_INFOA lpFirstCacheEntryInfo,
                          LPDWORD lpcbEntryInfo, LPVOID lpGroupAttributes,
                          LPDWORD lpcbGroupAttributes, LPVOID lpReserved);
INTERNETAPI_(HANDLE)
FindFirstUrlCacheEntryExW(LPCWSTR lpszUrlSearchPattern, DWORD dwFlags,
                          DWORD dwFilter, GROUPID GroupId,
                          LPINTERNET_CACHE_ENTRY_INFOW lpFirstCacheEntryInfo,
                          LPDWORD lpcbEntryInfo, LPVOID lpGroupAttributes,
                          LPDWORD lpcbGroupAttributes, LPVOID lpReserved);
BOOLAPI
FindNextUrlCacheEntryExA(HANDLE hEnumHandle,
                         LPINTERNET_CACHE_ENTRY_INFOA lpNextCacheEntryInfo,
                         LPDWORD lpcbEntryInfo, LPVOID lpGroupAttributes,
                         LPDWORD lpcbGroupAttributes, LPVOID lpReserved);
BOOLAPI
FindNextUrlCacheEntryExW(HANDLE hEnumHandle,
...
INTERNETAPI_(DWORD)
InternetDialA(HWND hwndParent, LPSTR lpszConnectoid, DWORD dwFlags,
              DWORD_PTR *lpdwConnection, DWORD dwReserved);
INTERNETAPI_(DWORD)
InternetDialW(HWND hwndParent, LPWSTR lpszConnectoid, DWORD dwFlags,
              DWORD_PTR *lpdwConnection, DWORD dwReserved);
...
INTERNETAPI_(WINBOOL)
InternetGoOnlineA(LPSTR lpszURL, HWND hwndParent, DWORD dwFlags);
INTERNETAPI_(WINBOOL)
InternetGoOnlineW(LPWSTR lpszURL, HWND hwndParent, DWORD dwFlags);
...
INTERNETAPI_(WINBOOL)
InternetGetConnectedStateExA(LPDWORD lpdwFlags, LPSTR lpszConnectionName,
                             DWORD dwBufLen, DWORD dwReserved);
INTERNETAPI_(WINBOOL)
InternetGetConnectedStateExW(LPDWORD lpdwFlags, LPWSTR lpszConnectionName,
                             DWORD dwBufLen, DWORD dwReserved);
...
typedef struct AutoProxyHelperVtbl {
  ...
  DWORD(WINAPI *ResolveHostName)(LPSTR lpszHostName, LPSTR lpszIPAddress,
...
typedef WINBOOL(CALLBACK *pfnInternetInitializeAutoProxyDll)(
    DWORD dwVersion, LPSTR lpszDownloadedTempFile, LPSTR lpszMime,
    AutoProxyHelperFunctions *lpAutoProxyCallbacks,
    LPAUTO_PROXY_SCRIPT_BUFFER lpAutoProxyScriptBuffer);
typedef WINBOOL(CALLBACK *pfnInternetDeInitializeAutoProxyDll)(
    LPSTR lpszMime, DWORD dwReserved);
typedef WINBOOL(CALLBACK *pfnInternetGetProxyInfo)(
    LPCSTR lpszUrl, DWORD dwUrlLength, LPSTR lpszUrlHostName,
...
#else
INTERNETAPI_(WINBOOL)
InternetGetConnectedStateEx(LPDWORD lpdwFlags, LPSTR lpszConnectionName,
                            DWORD dwNameLen, DWORD dwReserved);
#endif
INTERNETAPI_(WINBOOL) InternetInitializeAutoProxyDll(DWORD dwReserved);
INTERNETAPI_(WINBOOL)
InternetDeInitializeAutoProxyDll(LPSTR lpszMime, DWORD dwReserved);
INTERNETAPI_(WINBOOL)
InternetGetProxyInfo(LPCSTR lpszUrl, DWORD dwUrlLength, LPSTR lpszUrlHostName,
                     DWORD dwUrlHostNameLength, LPSTR *lplpszProxyHostName,
                     LPDWORD lpdwProxyHostNameLength);
INTERNETAPI_(WINBOOL)
DetectAutoProxyUrl(LPSTR lpszAutoProxyUrl, DWORD dwAutoProxyUrlLength,
                   DWORD dwDetectFlags);
INTERNETAPI_(WINBOOL)
CreateMD5SSOHash(PWSTR pszChallengeInfo, PWSTR pwszRealm, PWSTR pwszTarget,
                 PBYTE pbHexHash);
...
#define InternetSetPerSiteCookieDecision                                       \
  __MINGW_NAME_AW(InternetSetPerSiteCookieDecision)
#define InternetGetPerSiteCookieDecision                                       \
  __MINGW_NAME_AW(InternetGetPerSiteCookieDecision)
#define InternetEnumPerSiteCookieDecision                                      \
  __MINGW_NAME_AW(InternetEnumPerSiteCookieDecision)
#if defined(UNICODE)
#define InternetSetDialState InternetSetDialStateW
#else
INTERNETAPI_(WINBOOL)
InternetSetDialState(LPCSTR lpszConnectoid, DWORD dwState, DWORD dwReserved);
#endif
INTERNETAPI_(WINBOOL)
InternetSetDialStateA(LPCSTR lpszConnectoid, DWORD dwState, DWORD dwReserved);
INTERNETAPI_(WINBOOL)
InternetSetDialStateW(LPCWSTR lpszConnectoid, DWORD dwState, DWORD dwReserved);
#define INTERNET_DIALSTATE_DISCONNECTED 1
INTERNETAPI_(WINBOOL)
InternetSetPerSiteCookieDecisionA(LPCSTR pchHostName, DWORD dwDecision);
INTERNETAPI_(WINBOOL)
InternetSetPerSiteCookieDecisionW(LPCWSTR pchHostName, DWORD dwDecision);
INTERNETAPI_(WINBOOL)
InternetGetPerSiteCookieDecisionA(LPCSTR pchHostName,
                                  unsigned __LONG32 *pResult);
INTERNETAPI_(WINBOOL)
InternetGetPerSiteCookieDecisionW(LPCWSTR pchHostName,
                                  unsigned __LONG32 *pResult);
INTERNETAPI_(WINBOOL) InternetClearAllPerSiteCookieDecisions();
INTERNETAPI_(WINBOOL)
InternetEnumPerSiteCookieDecisionA(LPSTR pszSiteName,
                                   unsigned __LONG32 *pcSiteNameSize,
                                   unsigned __LONG32 *pdwDecision,
                                   unsigned __LONG32 dwIndex);
INTERNETAPI_(WINBOOL)
...
INTERNETAPI_(DWORD)
PrivacySetZonePreferenceW(DWORD dwZone, DWORD dwType, DWORD dwTemplate,
                          LPCWSTR pszPreference);
INTERNETAPI_(DWORD)
PrivacyGetZonePreferenceW(DWORD dwZone, DWORD dwType, LPDWORD pdwTemplate,
                          LPWSTR pszBuffer, LPDWORD pdwBufferLength);
#if defined(__cplusplus)
}
#endif
#include <poppack.h>
