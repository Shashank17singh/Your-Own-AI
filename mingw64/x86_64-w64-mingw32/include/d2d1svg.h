...
#endif
DEFINE_GUID(IID_ID2D1SvgAttribute, 0xc9cdb0dd, 0xf8c9, 0x4e70, 0xb7, 0xc2, 0x30,
            0x1c, 0x80, 0x29, 0x2c, 0x5e);
__CRT_UUID_DECL(ID2D1SvgAttribute, 0xc9cdb0dd, 0xf8c9, 0x4e70, 0xb7, 0xc2, 0x30,
                0x1c, 0x80, 0x29, 0x2c, 0x5e);
#ifndef D2D_USE_C_DEFINITIONS
...
/* FIXME: Add full C declaration */
#endif
DEFINE_GUID(IID_ID2D1SvgPaint, 0xd59bab0a, 0x68a2, 0x455b, 0xa5, 0xdc, 0x9e,
            0xb2, 0x85, 0x4e, 0x24, 0x90);
__CRT_UUID_DECL(ID2D1SvgPaint, 0xd59bab0a, 0x68a2, 0x455b, 0xa5, 0xdc, 0x9e,
                0xb2, 0x85, 0x4e, 0x24, 0x90);
#ifndef D2D_USE_C_DEFINITIONS
interface ID2D1SvgStrokeDashArray : public ID2D1SvgAttribute {
  STDMETHOD(RemoveDashesAtEnd)(UINT32 dashes_count) PURE;
  STDMETHOD(UpdateDashes)(const FLOAT *dashes, UINT32 dashes_count,
                          UINT32 start_index = 0) PURE;
  STDMETHOD(UpdateDashes)(const D2D1_SVG_LENGTH *dashes, UINT32 dashes_count,
                          UINT32 start_index = 0) PURE;
  STDMETHOD(GetDashes)(FLOAT * dashes, UINT32 dashes_count,
                       UINT32 start_index = 0) PURE;
  STDMETHOD(GetDashes)(D2D1_SVG_LENGTH * dashes, UINT32 dashes_count,
                       UINT32 start_index = 0) PURE;
...
/* FIXME: Add full C declaration */
#endif
DEFINE_GUID(IID_ID2D1SvgStrokeDashArray, 0xf1c0ca52, 0x92a3, 0x4f00, 0xb4, 0xce,
            0xf3, 0x56, 0x91, 0xef, 0xd9, 0xd9);
__CRT_UUID_DECL(ID2D1SvgStrokeDashArray, 0xf1c0ca52, 0x92a3, 0x4f00, 0xb4, 0xce,
                0xf3, 0x56, 0x91, 0xef, 0xd9, 0xd9);
#ifndef D2D_USE_C_DEFINITIONS
interface ID2D1SvgPointCollection : public ID2D1SvgAttribute {
  STDMETHOD(RemovePointsAtEnd)(UINT32 points_count) PURE;
  STDMETHOD(UpdatePoints)(const D2D1_POINT_2F *points, UINT32 points_count,
                          UINT32 start_index = 0) PURE;
  STDMETHOD(GetPoints)(D2D1_POINT_2F * points, UINT32 points_count,
                       UINT32 start_index = 0) PURE;
...
/* FIXME: Add full C declaration */
#endif
DEFINE_GUID(IID_ID2D1SvgPointCollection, 0x9dbe4c0d, 0x3572, 0x4dd9, 0x98, 0x25,
            0x55, 0x30, 0x81, 0x3b, 0xb7, 0x12);
__CRT_UUID_DECL(ID2D1SvgPointCollection, 0x9dbe4c0d, 0x3572, 0x4dd9, 0x98, 0x25,
                0x55, 0x30, 0x81, 0x3b, 0xb7, 0x12);
#ifndef D2D_USE_C_DEFINITIONS
interface ID2D1SvgPathData : public ID2D1SvgAttribute {
  STDMETHOD(RemoveSegmentDataAtEnd)(UINT32 data_count) PURE;
  STDMETHOD(UpdateSegmentData)(const FLOAT *data, UINT32 data_count,
                               UINT32 start_index = 0) PURE;
  STDMETHOD(GetSegmentData)(FLOAT * data, UINT32 data_count,
                            UINT32 start_index = 0) PURE;
  STDMETHOD_(UINT32, GetSegmentDataCount)() PURE;
  STDMETHOD(RemoveCommandsAtEnd)(UINT32 commands_count) PURE;
  STDMETHOD(UpdateCommands)(const D2D1_SVG_PATH_COMMAND *commands,
                            UINT32 commands_count, UINT32 start_index = 0) PURE;
  STDMETHOD(GetCommands)(D2D1_SVG_PATH_COMMAND * commands,
                         UINT32 commands_count, UINT32 start_index = 0) PURE;
  STDMETHOD_(UINT32, GetCommandsCount)() PURE;
  STDMETHOD(CreatePathGeometry)(D2D1_FILL_MODE fill_mode,
                                ID2D1PathGeometry1 * *path_geometry) PURE;
};
#else
typedef interface ID2D1SvgPathData ID2D1SvgPathData;
/* FIXME: Add full C declaration */
#endif
DEFINE_GUID(IID_ID2D1SvgPathData, 0xc095e4f4, 0xbb98, 0x43d6, 0x97, 0x45, 0x4d,
            0x1b, 0x84, 0xec, 0x98, 0x88);
__CRT_UUID_DECL(ID2D1SvgPathData, 0xc095e4f4, 0xbb98, 0x43d6, 0x97, 0x45, 0x4d,
                0x1b, 0x84, 0xec, 0x98, 0x88);
#ifndef D2D_USE_C_DEFINITIONS
interface ID2D1SvgElement : public ID2D1Resource {
  ...
  STDMETHOD(GetPreviousChild)(ID2D1SvgElement * reference_child,
                              ID2D1SvgElement * *previous_child) PURE;
  STDMETHOD(GetNextChild)(ID2D1SvgElement * reference_child,
                          ID2D1SvgElement * *next_child) PURE;
  STDMETHOD(InsertChildBefore)(ID2D1SvgElement * new_child,
                               ID2D1SvgElement *reference_child = NULL) PURE;
  STDMETHOD(AppendChild)(ID2D1SvgElement * new_child) PURE;
  STDMETHOD(ReplaceChild)(ID2D1SvgElement * new_child,
  ...
  STDMETHOD_(WINBOOL, IsAttributeSpecified)(PCWSTR name,
                                            WINBOOL *inherited = NULL) PURE;
  STDMETHOD_(UINT32, GetSpecifiedAttributeCount)() PURE;
  STDMETHOD(GetSpecifiedAttributeName)(UINT32 index, PWSTR name,
                                       UINT32 name_count,
                                       WINBOOL *inherited = NULL) PURE;
  STDMETHOD(GetSpecifiedAttributeNameLength)(UINT32 index, UINT32 * name_length,
                                             WINBOOL *inherited = NULL) PURE;
  ...
  STDMETHOD(SetAttributeValue)(PCWSTR name, D2D1_SVG_ATTRIBUTE_STRING_TYPE type,
                               PCWSTR value) PURE;
  STDMETHOD(GetAttributeValue)(PCWSTR name, D2D1_SVG_ATTRIBUTE_STRING_TYPE type,
                               PWSTR value, UINT32 value_count) PURE;
  STDMETHOD(GetAttributeValueLength)(PCWSTR name,
                                     D2D1_SVG_ATTRIBUTE_STRING_TYPE type,
                                     UINT32 * value_length) PURE;
  STDMETHOD(SetAttributeValue)(PCWSTR name, D2D1_SVG_ATTRIBUTE_POD_TYPE type,
                               const void *value, UINT32 value_size_in_bytes)
      PURE;
  STDMETHOD(GetAttributeValue)(PCWSTR name, D2D1_SVG_ATTRIBUTE_POD_TYPE type,
                               void *value, UINT32 value_size_in_bytes) PURE;
  ...
  COM_DECLSPEC_NOTHROW HRESULT SetAttributeValue(PCWSTR name, FLOAT value) {
    return SetAttributeValue(name, D2D1_SVG_ATTRIBUTE_POD_TYPE_FLOAT, &value,
                             sizeof(value));
  }
  COM_DECLSPEC_NOTHROW HRESULT GetAttributeValue(PCWSTR name, FLOAT * value) {
    return GetAttributeValue(name, D2D1_SVG_ATTRIBUTE_POD_TYPE_FLOAT, value,
                             sizeof(*value));
  }
  COM_DECLSPEC_NOTHROW HRESULT SetAttributeValue(PCWSTR name,
                                                 const D2D1_COLOR_F &value) {
    return SetAttributeValue(name, D2D1_SVG_ATTRIBUTE_POD_TYPE_COLOR, &value,
                             sizeof(value));
  }
  COM_DECLSPEC_NOTHROW HRESULT GetAttributeValue(PCWSTR name,
                                                 D2D1_COLOR_F * value) {
    return GetAttributeValue(name, D2D1_SVG_ATTRIBUTE_POD_TYPE_COLOR, value,
                             sizeof(*value));
  }
  COM_DECLSPEC_NOTHROW HRESULT SetAttributeValue(PCWSTR name,
                                                 D2D1_FILL_MODE value) {
    return SetAttributeValue(name, D2D1_SVG_ATTRIBUTE_POD_TYPE_FILL_MODE,
                             &value, sizeof(value));
  }
  COM_DECLSPEC_NOTHROW HRESULT GetAttributeValue(PCWSTR name,
                                                 D2D1_FILL_MODE * value) {
    return GetAttributeValue(name, D2D1_SVG_ATTRIBUTE_POD_TYPE_FILL_MODE, value,
                             sizeof(*value));
  }
  COM_DECLSPEC_NOTHROW HRESULT SetAttributeValue(PCWSTR name,
                                                 D2D1_SVG_DISPLAY value) {
    return SetAttributeValue(name, D2D1_SVG_ATTRIBUTE_POD_TYPE_DISPLAY, &value,
                             sizeof(value));
  }
  COM_DECLSPEC_NOTHROW HRESULT GetAttributeValue(PCWSTR name,
                                                 D2D1_SVG_DISPLAY * value) {
    return GetAttributeValue(name, D2D1_SVG_ATTRIBUTE_POD_TYPE_DISPLAY, value,
                             sizeof(*value));
  }
  COM_DECLSPEC_NOTHROW HRESULT SetAttributeValue(PCWSTR name,
                                                 D2D1_SVG_OVERFLOW value) {
    return SetAttributeValue(name, D2D1_SVG_ATTRIBUTE_POD_TYPE_OVERFLOW, &value,
                             sizeof(value));
  }
  COM_DECLSPEC_NOTHROW HRESULT GetAttributeValue(PCWSTR name,
                                                 D2D1_SVG_OVERFLOW * value) {
    return GetAttributeValue(name, D2D1_SVG_ATTRIBUTE_POD_TYPE_OVERFLOW, value,
                             sizeof(*value));
  }
  COM_DECLSPEC_NOTHROW HRESULT SetAttributeValue(PCWSTR name,
                                                 D2D1_SVG_LINE_JOIN value) {
    return SetAttributeValue(name, D2D1_SVG_ATTRIBUTE_POD_TYPE_LINE_JOIN,
                             &value, sizeof(value));
  }
  COM_DECLSPEC_NOTHROW HRESULT GetAttributeValue(PCWSTR name,
                                                 D2D1_SVG_LINE_JOIN * value) {
    return GetAttributeValue(name, D2D1_SVG_ATTRIBUTE_POD_TYPE_LINE_JOIN, value,
                             sizeof(*value));
  }
  COM_DECLSPEC_NOTHROW HRESULT SetAttributeValue(PCWSTR name,
                                                 D2D1_SVG_LINE_CAP value) {
    return SetAttributeValue(name, D2D1_SVG_ATTRIBUTE_POD_TYPE_LINE_CAP, &value,
                             sizeof(value));
  }
  COM_DECLSPEC_NOTHROW HRESULT GetAttributeValue(PCWSTR name,
                                                 D2D1_SVG_LINE_CAP * value) {
    return GetAttributeValue(name, D2D1_SVG_ATTRIBUTE_POD_TYPE_LINE_CAP, value,
                             sizeof(*value));
  }
  COM_DECLSPEC_NOTHROW HRESULT SetAttributeValue(PCWSTR name,
                                                 D2D1_SVG_VISIBILITY value) {
    return SetAttributeValue(name, D2D1_SVG_ATTRIBUTE_POD_TYPE_VISIBILITY,
                             &value, sizeof(value));
  }
  COM_DECLSPEC_NOTHROW HRESULT GetAttributeValue(PCWSTR name,
                                                 D2D1_SVG_VISIBILITY * value) {
    return GetAttributeValue(name, D2D1_SVG_ATTRIBUTE_POD_TYPE_VISIBILITY,
                             value, sizeof(*value));
  }
  COM_DECLSPEC_NOTHROW HRESULT SetAttributeValue(
      PCWSTR name, const D2D1_MATRIX_3X2_F &value) {
    return SetAttributeValue(name, D2D1_SVG_ATTRIBUTE_POD_TYPE_MATRIX, &value,
                             sizeof(value));
  }
  COM_DECLSPEC_NOTHROW HRESULT GetAttributeValue(PCWSTR name,
                                                 D2D1_MATRIX_3X2_F * value) {
    return GetAttributeValue(name, D2D1_SVG_ATTRIBUTE_POD_TYPE_MATRIX, value,
                             sizeof(*value));
  }
  COM_DECLSPEC_NOTHROW HRESULT SetAttributeValue(PCWSTR name,
                                                 D2D1_SVG_UNIT_TYPE value) {
    return SetAttributeValue(name, D2D1_SVG_ATTRIBUTE_POD_TYPE_UNIT_TYPE,
                             &value, sizeof(value));
  }
  COM_DECLSPEC_NOTHROW HRESULT GetAttributeValue(PCWSTR name,
                                                 D2D1_SVG_UNIT_TYPE * value) {
    return GetAttributeValue(name, D2D1_SVG_ATTRIBUTE_POD_TYPE_UNIT_TYPE, value,
                             sizeof(*value));
  }
  COM_DECLSPEC_NOTHROW HRESULT SetAttributeValue(PCWSTR name,
                                                 D2D1_EXTEND_MODE value) {
    return SetAttributeValue(name, D2D1_SVG_ATTRIBUTE_POD_TYPE_EXTEND_MODE,
                             &value, sizeof(value));
  }
  COM_DECLSPEC_NOTHROW HRESULT GetAttributeValue(PCWSTR name,
                                                 D2D1_EXTEND_MODE * value) {
    return GetAttributeValue(name, D2D1_SVG_ATTRIBUTE_POD_TYPE_EXTEND_MODE,
                             value, sizeof(*value));
  }
  COM_DECLSPEC_NOTHROW HRESULT SetAttributeValue(
      PCWSTR name, const D2D1_SVG_PRESERVE_ASPECT_RATIO &value) {
    return SetAttributeValue(name,
                             D2D1_SVG_ATTRIBUTE_POD_TYPE_PRESERVE_ASPECT_RATIO,
                             &value, sizeof(value));
  }
  COM_DECLSPEC_NOTHROW HRESULT GetAttributeValue(
      PCWSTR name, D2D1_SVG_PRESERVE_ASPECT_RATIO * value) {
  ...
  COM_DECLSPEC_NOTHROW HRESULT SetAttributeValue(PCWSTR name,
    ...
    return SetAttributeValue(name, D2D1_SVG_ATTRIBUTE_POD_TYPE_LENGTH, &value,
                             sizeof(value));
  }
  COM_DECLSPEC_NOTHROW HRESULT GetAttributeValue(PCWSTR name,
                                                 D2D1_SVG_LENGTH * value) {
    return GetAttributeValue(name, D2D1_SVG_ATTRIBUTE_POD_TYPE_LENGTH, value,
                             sizeof(*value));
  }
  COM_DECLSPEC_NOTHROW HRESULT GetAttributeValue(PCWSTR name,
                                                 ID2D1SvgAttribute * *value) {
    return GetAttributeValue(name, IID_ID2D1SvgAttribute,
                             reinterpret_cast<void **>(value));
  }
  COM_DECLSPEC_NOTHROW HRESULT GetAttributeValue(PCWSTR name,
                                                 ID2D1SvgPaint * *value) {
    return GetAttributeValue(name, IID_ID2D1SvgPaint,
                             reinterpret_cast<void **>(value));
  }
  COM_DECLSPEC_NOTHROW HRESULT GetAttributeValue(
      PCWSTR name, ID2D1SvgStrokeDashArray * *value) {
    return GetAttributeValue(name, IID_ID2D1SvgStrokeDashArray,
                             reinterpret_cast<void **>(value));
  }
  COM_DECLSPEC_NOTHROW HRESULT GetAttributeValue(
      PCWSTR name, ID2D1SvgPointCollection * *value) {
    return GetAttributeValue(name, IID_ID2D1SvgPointCollection,
                             reinterpret_cast<void **>(value));
  }
  COM_DECLSPEC_NOTHROW HRESULT GetAttributeValue(PCWSTR name,
                                                 ID2D1SvgPathData * *value) {
    return GetAttributeValue(name, IID_ID2D1SvgPathData,
                             reinterpret_cast<void **>(value));
  }
};
#else
...
/* FIXME: Add full C declaration */
#endif
DEFINE_GUID(IID_ID2D1SvgElement, 0xac7b67a6, 0x183e, 0x49c1, 0xa8, 0x23, 0x0e,
            0xbe, 0x40, 0xb0, 0xdb, 0x29);
__CRT_UUID_DECL(ID2D1SvgElement, 0xac7b67a6, 0x183e, 0x49c1, 0xa8, 0x23, 0x0e,
                0xbe, 0x40, 0xb0, 0xdb, 0x29);
#ifndef D2D_USE_C_DEFINITIONS
interface ID2D1SvgDocument : public ID2D1Resource {
...
#else
  virtual D2D1_SIZE_F *STDMETHODCALLTYPE GetViewportSize(D2D1_SIZE_F *)
      const = 0;
  ...
  STDMETHOD(Serialize)(IStream * output_xml_stream,
                       ID2D1SvgElement *subtree = NULL) PURE;
  STDMETHOD(Deserialize)(IStream * input_xml_stream, ID2D1SvgElement * *subtree)
      PURE;
  STDMETHOD(CreatePaint)(D2D1_SVG_PAINT_TYPE paint_type,
                         const D2D1_COLOR_F *color, PCWSTR id,
                         ID2D1SvgPaint **paint) PURE;
  STDMETHOD(CreateStrokeDashArray)(
      const D2D1_SVG_LENGTH *dashes, UINT32 dashes_count,
      ID2D1SvgStrokeDashArray **stroke_dash_array) PURE;
  STDMETHOD(CreatePointCollection)(
      const D2D1_POINT_2F *points, UINT32 points_count,
      ID2D1SvgPointCollection **point_collection) PURE;
  STDMETHOD(CreatePathData)(
      const FLOAT *segment_data, UINT32 segment_data_count,
      const D2D1_SVG_PATH_COMMAND *commands, UINT32 commands_count,
      ID2D1SvgPathData **path_data) PURE;
  COM_DECLSPEC_NOTHROW HRESULT CreatePaint(D2D1_SVG_PAINT_TYPE paint_type,
                                           const D2D1_COLOR_F &color, PCWSTR id,
                                           ID2D1SvgPaint **paint) {
...
/* FIXME: Add full C declaration */
#endif
DEFINE_GUID(IID_ID2D1SvgDocument, 0x86b88e4d, 0xafa4, 0x4d7b, 0x88, 0xe4, 0x68,
            0xa5, 0x1c, 0x4a, 0x0a, 0xec);
__CRT_UUID_DECL(ID2D1SvgDocument, 0x86b88e4d, 0xafa4, 0x4d7b, 0x88, 0xe4, 0x68,
                0xa5, 0x1c, 0x4a, 0x0a, 0xec);
