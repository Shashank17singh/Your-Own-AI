...
WINCOMMCTRLAPI
    WINBOOL WINAPI InitCommonControlsEx(const INITCOMMONCONTROLSEX *);
...
#define FORWARD_WM_NOTIFY(hwnd, idFrom, pnmhdr, fn)                            \
  (LRESULT)(fn)((hwnd), WM_NOTIFY, (WPARAM)(int)(idFrom),                      \
                (LPARAM)(NMHDR *)(pnmhdr))
...
#endif
WINCOMMCTRLAPI HIMAGELIST WINAPI ImageList_Create(int cx, int cy, UINT flags,
...
WINCOMMCTRLAPI WINBOOL WINAPI ImageList_SetImageCount(HIMAGELIST himl,
                                                      UINT uNewCount);
WINCOMMCTRLAPI int WINAPI ImageList_Add(HIMAGELIST himl, HBITMAP hbmImage,
                                        HBITMAP hbmMask);
WINCOMMCTRLAPI int WINAPI ImageList_ReplaceIcon(HIMAGELIST himl, int i,
                                                HICON hicon);
WINCOMMCTRLAPI COLORREF WINAPI ImageList_SetBkColor(HIMAGELIST himl,
                                                    COLORREF clrBk);
WINCOMMCTRLAPI COLORREF WINAPI ImageList_GetBkColor(HIMAGELIST himl);
WINCOMMCTRLAPI WINBOOL WINAPI ImageList_SetOverlayImage(HIMAGELIST himl,
                                                        int iImage,
                                                        int iOverlay);
...
#endif
WINCOMMCTRLAPI WINBOOL WINAPI ImageList_Draw(HIMAGELIST himl, int i, HDC hdcDst,
                                             int x, int y, UINT fStyle);
WINCOMMCTRLAPI WINBOOL WINAPI ImageList_Replace(HIMAGELIST himl, int i,
                                                HBITMAP hbmImage,
                                                HBITMAP hbmMask);
WINCOMMCTRLAPI int WINAPI ImageList_AddMasked(HIMAGELIST himl, HBITMAP hbmImage,
                                              COLORREF crMask);
WINCOMMCTRLAPI WINBOOL WINAPI ImageList_DrawEx(HIMAGELIST himl, int i,
                                               HDC hdcDst, int x, int y, int dx,
                                               int dy, COLORREF rgbBk,
                                               COLORREF rgbFg, UINT fStyle);
WINCOMMCTRLAPI WINBOOL WINAPI
ImageList_DrawIndirect(IMAGELISTDRAWPARAMS *pimldp);
WINCOMMCTRLAPI WINBOOL WINAPI ImageList_Remove(HIMAGELIST himl, int i);
WINCOMMCTRLAPI HICON WINAPI ImageList_GetIcon(HIMAGELIST himl, int i,
                                              UINT flags);
...
WINCOMMCTRLAPI WINBOOL WINAPI ImageList_Copy(HIMAGELIST himlDst, int iDst,
                                             HIMAGELIST himlSrc, int iSrc,
                                             UINT uFlags);
WINCOMMCTRLAPI WINBOOL WINAPI ImageList_BeginDrag(HIMAGELIST himlTrack,
                                                  int iTrack, int dxHotspot,
                                                  int dyHotspot);
...
WINCOMMCTRLAPI WINBOOL WINAPI ImageList_SetDragCursorImage(HIMAGELIST himlDrag,
                                                           int iDrag,
                                                           int dxHotspot,
                                                           int dyHotspot);
WINCOMMCTRLAPI WINBOOL WINAPI ImageList_DragShowNolock(WINBOOL fShow);
WINCOMMCTRLAPI HIMAGELIST WINAPI ImageList_GetDragImage(POINT *ppt,
                                                        POINT *pptHotspot);
...
WINCOMMCTRLAPI HRESULT WINAPI ImageList_ReadEx(DWORD dwFlags, LPSTREAM pstm,
                                               REFIID riid, PVOID *ppv);
WINCOMMCTRLAPI HRESULT WINAPI ImageList_WriteEx(HIMAGELIST himl, DWORD dwFlags,
                                                LPSTREAM pstm);
#endif
#ifndef IMAGEINFO
...
#endif
WINCOMMCTRLAPI WINBOOL WINAPI ImageList_GetIconSize(HIMAGELIST himl, int *cx,
                                                    int *cy);
WINCOMMCTRLAPI WINBOOL WINAPI ImageList_SetIconSize(HIMAGELIST himl, int cx,
                                                    int cy);
WINCOMMCTRLAPI WINBOOL WINAPI ImageList_GetImageInfo(HIMAGELIST himl, int i,
                                                     IMAGEINFO *pImageInfo);
WINCOMMCTRLAPI HIMAGELIST WINAPI ImageList_Merge(HIMAGELIST himl1, int i1,
...
#define Header_GetItemCount(hwndHD)                                            \
  (int)SNDMSG((hwndHD), HDM_GETITEMCOUNT, (WPARAM)0, (LPARAM)0)
...
#define Header_DeleteItem(hwndHD, i)                                           \
  (WINBOOL) SNDMSG((hwndHD), HDM_DELETEITEM, (WPARAM)(int)(i), (LPARAM)0)
#define HDM_GETITEMA (HDM_FIRST + 3)
#define HDM_GETITEMW (HDM_FIRST + 11)
#define HDM_GETITEM __MINGW_NAME_AW(HDM_GETITEM)
#define Header_GetItem(hwndHD, i, phdi)                                        \
  (WINBOOL) SNDMSG((hwndHD), HDM_GETITEM, (WPARAM)(int)(i),                    \
                   (LPARAM)(HD_ITEM *)(phdi))
#define HDM_SETITEMA (HDM_FIRST + 4)
#define HDM_SETITEMW (HDM_FIRST + 12)
#define HDM_SETITEM __MINGW_NAME_AW(HDM_SETITEM)
#define Header_SetItem(hwndHD, i, phdi)                                        \
  (WINBOOL) SNDMSG((hwndHD), HDM_SETITEM, (WPARAM)(int)(i),                    \
                   (LPARAM)(const HD_ITEM *)(phdi))
...
#define Header_Layout(hwndHD, playout)                                         \
  (WINBOOL) SNDMSG((hwndHD), HDM_LAYOUT, 0, (LPARAM)(HD_LAYOUT *)(playout))
...
#define Header_GetItemRect(hwnd, iItem, lprc)                                  \
  (WINBOOL) SNDMSG((hwnd), HDM_GETITEMRECT, (WPARAM)(iItem), (LPARAM)(lprc))
...
#define Header_GetOrderArray(hwnd, iCount, lpi)                                \
  (WINBOOL) SNDMSG((hwnd), HDM_GETORDERARRAY, (WPARAM)(iCount), (LPARAM)(lpi))
#define HDM_SETORDERARRAY (HDM_FIRST + 18)
#define Header_SetOrderArray(hwnd, iCount, lpi)                                \
  (WINBOOL) SNDMSG((hwnd), HDM_SETORDERARRAY, (WPARAM)(iCount), (LPARAM)(lpi))
...
#define Header_SetUnicodeFormat(hwnd, fUnicode)                                \
  (WINBOOL) SNDMSG((hwnd), HDM_SETUNICODEFORMAT, (WPARAM)(fUnicode), 0)
#define HDM_GETUNICODEFORMAT CCM_GETUNICODEFORMAT
#define Header_GetUnicodeFormat(hwnd)                                          \
  (WINBOOL) SNDMSG((hwnd), HDM_GETUNICODEFORMAT, 0, 0)
...
#define Header_GetItemDropDownRect(hwnd, iItem, lprc)                          \
  (WINBOOL)                                                                    \
      SNDMSG((hwnd), HDM_GETITEMDROPDOWNRECT, (WPARAM)(iItem), (LPARAM)(lprc))
#define HDM_GETOVERFLOWRECT (HDM_FIRST + 26)
#define Header_GetOverflowRect(hwnd, lprc)                                     \
  (WINBOOL) SNDMSG((hwnd), HDM_GETOVERFLOWRECT, 0, (LPARAM)(lprc))
...
#define Header_SetFocusedItem(hwnd, iItem)                                     \
  (WINBOOL) SNDMSG((hwnd), HDM_SETFOCUSEDITEM, (WPARAM)0, (LPARAM)(iItem))
#endif
...
WINCOMMCTRLAPI HWND WINAPI CreateToolbarEx(
...
WINCOMMCTRLAPI void WINAPI DrawStatusTextA(HDC hDC, LPCRECT lprc,
                                           LPCSTR pszText, UINT uFlags);
WINCOMMCTRLAPI void WINAPI DrawStatusTextW(HDC hDC, LPCRECT lprc,
                                           LPCWSTR pszText, UINT uFlags);
WINCOMMCTRLAPI HWND WINAPI CreateStatusWindowA(LONG style, LPCSTR lpszText,
                                               HWND hwndParent, UINT wID);
WINCOMMCTRLAPI HWND WINAPI CreateStatusWindowW(LONG style, LPCWSTR lpszText,
                                               HWND hwndParent, UINT wID);
...
#endif
#ifndef NOMENUHELP
WINCOMMCTRLAPI void WINAPI MenuHelp(UINT uMsg, WPARAM wParam, LPARAM lParam,
                                    HMENU hMainMenu, HINSTANCE hInst,
                                    HWND hwndStatus, UINT *lpwIDs);
WINCOMMCTRLAPI WINBOOL WINAPI ShowHideMenuCtl(HWND hWnd, UINT_PTR uFlags,
                                              LPINT lpInfo);
WINCOMMCTRLAPI void WINAPI GetEffectiveClientRect(HWND hWnd, LPRECT lprc,
                                                  const INT *lpInfo);
...
WINCOMMCTRLAPI HWND WINAPI CreateUpDownControl(DWORD dwStyle, int x, int y,
                                               int cx, int cy, HWND hParent,
                                               int nID, HINSTANCE hInst,
                                               HWND hBuddy, int nUpper,
                                               int nLower, int nPos);
...
#define ListView_SetUnicodeFormat(hwnd, fUnicode)                              \
  (WINBOOL) SNDMSG((hwnd), LVM_SETUNICODEFORMAT, (WPARAM)(fUnicode), 0)
#define LVM_GETUNICODEFORMAT CCM_GETUNICODEFORMAT
#define ListView_GetUnicodeFormat(hwnd)                                        \
  (WINBOOL) SNDMSG((hwnd), LVM_GETUNICODEFORMAT, 0, 0)
#define LVM_GETBKCOLOR (LVM_FIRST + 0)
#define ListView_GetBkColor(hwnd)                                              \
  (COLORREF) SNDMSG((hwnd), LVM_GETBKCOLOR, (WPARAM)0, (LPARAM)0)
#define LVM_SETBKCOLOR (LVM_FIRST + 1)
#define ListView_SetBkColor(hwnd, clrBk)                                       \
  (WINBOOL) SNDMSG((hwnd), LVM_SETBKCOLOR, 0, (LPARAM)(COLORREF)(clrBk))
#define LVM_GETIMAGELIST (LVM_FIRST + 2)
#define ListView_GetImageList(hwnd, iImageList)                                \
  (HIMAGELIST)                                                                 \
      SNDMSG((hwnd), LVM_GETIMAGELIST, (WPARAM)(INT)(iImageList), (LPARAM)0)
...
#define ListView_GetItemCount(hwnd)                                            \
  (int)SNDMSG((hwnd), LVM_GETITEMCOUNT, (WPARAM)0, (LPARAM)0)
...
#define ListView_GetItem(hwnd, pitem)                                          \
  (WINBOOL) SNDMSG((hwnd), LVM_GETITEM, 0, (LPARAM)(LV_ITEM *)(pitem))
#define LVM_SETITEMA (LVM_FIRST + 6)
#define LVM_SETITEMW (LVM_FIRST + 76)
#define LVM_SETITEM __MINGW_NAME_AW(LVM_SETITEM)
#define ListView_SetItem(hwnd, pitem)                                          \
  (WINBOOL) SNDMSG((hwnd), LVM_SETITEM, 0, (LPARAM)(const LV_ITEM *)(pitem))
...
#define ListView_DeleteItem(hwnd, i)                                           \
  (WINBOOL) SNDMSG((hwnd), LVM_DELETEITEM, (WPARAM)(int)(i), (LPARAM)0)
#define LVM_DELETEALLITEMS (LVM_FIRST + 9)
#define ListView_DeleteAllItems(hwnd)                                          \
  (WINBOOL) SNDMSG((hwnd), LVM_DELETEALLITEMS, (WPARAM)0, (LPARAM)0)
#define LVM_GETCALLBACKMASK (LVM_FIRST + 10)
#define ListView_GetCallbackMask(hwnd)                                         \
  (WINBOOL) SNDMSG((hwnd), LVM_GETCALLBACKMASK, 0, 0)
#define LVM_SETCALLBACKMASK (LVM_FIRST + 11)
#define ListView_SetCallbackMask(hwnd, mask)                                   \
  (WINBOOL) SNDMSG((hwnd), LVM_SETCALLBACKMASK, (WPARAM)(UINT)(mask), 0)
#define LVNI_ALL 0x0
#define LVNI_FOCUSED 0x1
#define LVNI_SELECTED 0x2
#define LVNI_CUT 0x4
#define LVNI_DROPHILITED 0x8
#define LVNI_STATEMASK                                                         \
  (LVNI_FOCUSED | LVNI_SELECTED | LVNI_CUT | LVNI_DROPHILITED)
...
#define LVNI_DIRECTIONMASK                                                     \
  (LVNI_ABOVE | LVNI_BELOW | LVNI_TOLEFT | LVNI_TORIGHT)
...
#define ListView_GetItemRect(hwnd, i, prc, code)                               \
  (WINBOOL)                                                                    \
      SNDMSG((hwnd), LVM_GETITEMRECT, (WPARAM)(int)(i),                        \
             ((prc) ? (((RECT *)(prc))->left = (code), (LPARAM)(RECT *)(prc))  \
                    : (LPARAM)(RECT *)NULL))
#define LVM_SETITEMPOSITION (LVM_FIRST + 15)
#define ListView_SetItemPosition(hwndLV, i, x, y)                              \
  (WINBOOL) SNDMSG((hwndLV), LVM_SETITEMPOSITION, (WPARAM)(int)(i),            \
                   MAKELPARAM((x), (y)))
#define LVM_GETITEMPOSITION (LVM_FIRST + 16)
#define ListView_GetItemPosition(hwndLV, i, ppt)                               \
  (WINBOOL) SNDMSG((hwndLV), LVM_GETITEMPOSITION, (WPARAM)(int)(i),            \
                   (LPARAM)(POINT *)(ppt))
...
#define ListView_EnsureVisible(hwndLV, i, fPartialOK)                          \
  (WINBOOL) SNDMSG((hwndLV), LVM_ENSUREVISIBLE, (WPARAM)(int)(i),              \
                   MAKELPARAM((fPartialOK), 0))
#define LVM_SCROLL (LVM_FIRST + 20)
#define ListView_Scroll(hwndLV, dx, dy)                                        \
  (WINBOOL) SNDMSG((hwndLV), LVM_SCROLL, (WPARAM)(int)(dx), (LPARAM)(int)(dy))
#define LVM_REDRAWITEMS (LVM_FIRST + 21)
#define ListView_RedrawItems(hwndLV, iFirst, iLast)                            \
  (WINBOOL) SNDMSG((hwndLV), LVM_REDRAWITEMS, (WPARAM)(int)(iFirst),           \
                   (LPARAM)(int)(iLast))
...
#define ListView_Arrange(hwndLV, code)                                         \
  (WINBOOL) SNDMSG((hwndLV), LVM_ARRANGE, (WPARAM)(UINT)(code), (LPARAM)0)
#define LVM_EDITLABELA (LVM_FIRST + 23)
#define LVM_EDITLABELW (LVM_FIRST + 118)
#define LVM_EDITLABEL __MINGW_NAME_AW(LVM_EDITLABEL)
#define ListView_EditLabel(hwndLV, i)                                          \
  (HWND) SNDMSG((hwndLV), LVM_EDITLABEL, (WPARAM)(int)(i), (LPARAM)0)
#define LVM_GETEDITCONTROL (LVM_FIRST + 24)
#define ListView_GetEditControl(hwndLV)                                        \
  (HWND) SNDMSG((hwndLV), LVM_GETEDITCONTROL, (WPARAM)0, (LPARAM)0)
...
#define ListView_SetColumnWidth(hwnd, iCol, cx)                                \
  (WINBOOL) SNDMSG((hwnd), LVM_SETCOLUMNWIDTH, (WPARAM)(int)(iCol),            \
                   MAKELPARAM((cx), 0))
#define LVM_GETHEADER (LVM_FIRST + 31)
#define ListView_GetHeader(hwnd)                                               \
  (HWND) SNDMSG((hwnd), LVM_GETHEADER, (WPARAM)0, (LPARAM)0)
...
#define ListView_GetViewRect(hwnd, prc)                                        \
  (WINBOOL) SNDMSG((hwnd), LVM_GETVIEWRECT, 0, (LPARAM)(RECT *)(prc))
#define LVM_GETTEXTCOLOR (LVM_FIRST + 35)
#define ListView_GetTextColor(hwnd)                                            \
  (COLORREF) SNDMSG((hwnd), LVM_GETTEXTCOLOR, (WPARAM)0, (LPARAM)0)
#define LVM_SETTEXTCOLOR (LVM_FIRST + 36)
#define ListView_SetTextColor(hwnd, clrText)                                   \
  (WINBOOL) SNDMSG((hwnd), LVM_SETTEXTCOLOR, 0, (LPARAM)(COLORREF)(clrText))
#define LVM_GETTEXTBKCOLOR (LVM_FIRST + 37)
#define ListView_GetTextBkColor(hwnd)                                          \
  (COLORREF) SNDMSG((hwnd), LVM_GETTEXTBKCOLOR, (WPARAM)0, (LPARAM)0)
#define LVM_SETTEXTBKCOLOR (LVM_FIRST + 38)
#define ListView_SetTextBkColor(hwnd, clrTextBk)                               \
  (WINBOOL) SNDMSG((hwnd), LVM_SETTEXTBKCOLOR, 0, (LPARAM)(COLORREF)(clrTextBk))
...
#define ListView_GetOrigin(hwndLV, ppt)                                        \
  (WINBOOL) SNDMSG((hwndLV), LVM_GETORIGIN, (WPARAM)0, (LPARAM)(POINT *)(ppt))
#define LVM_UPDATE (LVM_FIRST + 42)
#define ListView_Update(hwndLV, i)                                             \
  (WINBOOL) SNDMSG((hwndLV), LVM_UPDATE, (WPARAM)(i), (LPARAM)0)
...
#define ListView_SetItemState(hwndLV, i, data, mask)                           \
  {                                                                            \
    ...
    _ms_lvi.state = data;                                                      \
    SNDMSG((hwndLV), LVM_SETITEMSTATE, (WPARAM)(i),                            \
           (LPARAM)(LV_ITEM *)&_ms_lvi);                                       \
  }
...
#define ListView_GetItemText(hwndLV, i, iSubItem_, pszText_, cchTextMax_)      \
  {                                                                            \
    ...
    SNDMSG((hwndLV), LVM_GETITEMTEXT, (WPARAM)(i),                             \
           (LPARAM)(LV_ITEM *)&_ms_lvi);                                       \
  }
...
#define ListView_SetItemText(hwndLV, i, iSubItem_, pszText_)                   \
  {                                                                            \
    ...
    _ms_lvi.iSubItem = iSubItem_;                                              \
    _ms_lvi.pszText = pszText_;                                                \
    SNDMSG((hwndLV), LVM_SETITEMTEXT, (WPARAM)(i),                             \
           (LPARAM)(LV_ITEM *)&_ms_lvi);                                       \
  }
...
#define ListView_SortItems(hwndLV, _pfnCompare, _lPrm)                         \
  (WINBOOL) SNDMSG((hwndLV), LVM_SORTITEMS, (WPARAM)(LPARAM)(_lPrm),           \
...
#define ListView_GetSelectedCount(hwndLV)                                      \
  (UINT) SNDMSG((hwndLV), LVM_GETSELECTEDCOUNT, (WPARAM)0, (LPARAM)0)
#define LVM_GETITEMSPACING (LVM_FIRST + 51)
#define ListView_GetItemSpacing(hwndLV, fSmall)                                \
  (DWORD) SNDMSG((hwndLV), LVM_GETITEMSPACING, fSmall, (LPARAM)0)
...
#define ListView_GetISearchString(hwndLV, lpsz)                                \
  (WINBOOL) SNDMSG((hwndLV), LVM_GETISEARCHSTRING, 0, (LPARAM)(LPTSTR)(lpsz))
...
#define ListView_GetSubItemRect(hwnd, iItem, iSubItem, code, prc)              \
  (WINBOOL) SNDMSG((hwnd), LVM_GETSUBITEMRECT, (WPARAM)(int)(iItem),           \
                   ((prc) ? ((((LPRECT)(prc))->top = iSubItem),                \
                             (((LPRECT)(prc))->left = code), (LPARAM)(prc))    \
                          : (LPARAM)(LPRECT)NULL))
...
#define ListView_SubItemHitTestEx(hwnd, plvhti)                                \
  (int)SNDMSG((hwnd), LVM_SUBITEMHITTEST, (WPARAM) - 1,                        \
              (LPARAM)(LPLVHITTESTINFO)(plvhti))
#define LVM_SETCOLUMNORDERARRAY (LVM_FIRST + 58)
#define ListView_SetColumnOrderArray(hwnd, iCount, pi)                         \
  (WINBOOL) SNDMSG((hwnd), LVM_SETCOLUMNORDERARRAY, (WPARAM)(iCount),          \
                   (LPARAM)(LPINT)(pi))
#define LVM_GETCOLUMNORDERARRAY (LVM_FIRST + 59)
#define ListView_GetColumnOrderArray(hwnd, iCount, pi)                         \
  (WINBOOL) SNDMSG((hwnd), LVM_GETCOLUMNORDERARRAY, (WPARAM)(iCount),          \
                   (LPARAM)(LPINT)(pi))
...
#define ListView_SetWorkAreas(hwnd, nWorkAreas, prc)                           \
  (WINBOOL) SNDMSG((hwnd), LVM_SETWORKAREAS, (WPARAM)(int)(nWorkAreas),        \
                   (LPARAM)(RECT *)(prc))
#define LVM_GETWORKAREAS (LVM_FIRST + 70)
#define ListView_GetWorkAreas(hwnd, nWorkAreas, prc)                           \
  (WINBOOL) SNDMSG((hwnd), LVM_GETWORKAREAS, (WPARAM)(int)(nWorkAreas),        \
                   (LPARAM)(RECT *)(prc))
#define LVM_GETNUMBEROFWORKAREAS (LVM_FIRST + 73)
#define ListView_GetNumberOfWorkAreas(hwnd, pnWorkAreas)                       \
  (WINBOOL) SNDMSG((hwnd), LVM_GETNUMBEROFWORKAREAS, 0,                        \
...
#define ListView_SortItemsEx(hwndLV, _pfnCompare, _lPrm)                       \
  (WINBOOL) SNDMSG((hwndLV), LVM_SORTITEMSEX, (WPARAM)(LPARAM)(_lPrm),         \
                   (LPARAM)(PFNLVCOMPARE)(_pfnCompare))
...
#define ListView_SetGroupState(hwnd, dwGroupId, dwMask, dwState)               \
  {                                                                            \
    ...
    SNDMSG((hwnd), LVM_SETGROUPINFO, (WPARAM)(dwGroupId),                      \
           (LPARAM)(LVGROUP *)&_macro_lvg);                                    \
  }
#define LVM_GETGROUPSTATE (LVM_FIRST + 92)
#define ListView_GetGroupState(hwnd, dwGroupId, dwMask)                        \
  (UINT)                                                                       \
      SNDMSG((hwnd), LVM_GETGROUPSTATE, (WPARAM)(dwGroupId), (LPARAM)(dwMask))
...
#define ListView_SetInsertMark(hwnd, lvim)                                     \
  (WINBOOL) SNDMSG((hwnd), LVM_SETINSERTMARK, (WPARAM)0, (LPARAM)(lvim))
#define LVM_GETINSERTMARK (LVM_FIRST + 167)
#define ListView_GetInsertMark(hwnd, lvim)                                     \
  (WINBOOL) SNDMSG((hwnd), LVM_GETINSERTMARK, (WPARAM)0, (LPARAM)(lvim))
...
#define ListView_SetInfoTip(hwndLV, plvInfoTip)                                \
  (WINBOOL) SNDMSG((hwndLV), LVM_SETINFOTIP, (WPARAM)0, (LPARAM)plvInfoTip)
...
#define ListView_IsGroupViewEnabled(hwnd)                                      \
  (WINBOOL) SNDMSG((hwnd), LVM_ISGROUPVIEWENABLED, 0, 0)
...
#define ListView_SetGroupHeaderImageList(hwnd, himl)                           \
  (HIMAGELIST) SNDMSG((hwnd), LVM_SETIMAGELIST, (WPARAM)LVSIL_GROUPHEADER,     \
                      (LPARAM)(HIMAGELIST)(himl))
#define ListView_GetGroupHeaderImageList(hwnd)                                 \
  (HIMAGELIST) SNDMSG((hwnd), LVM_GETIMAGELIST, (WPARAM)LVSIL_GROUPHEADER,     \
                      __MSABI_LONG(0))
#define LVM_GETEMPTYTEXT (LVM_FIRST + 204)
#define ListView_GetEmptyText(hwnd, pszText, cchText)                          \
  (WINBOOL)                                                                    \
      SNDMSG((hwnd), LVM_GETEMPTYTEXT, (WPARAM)(cchText), (LPARAM)(pszText))
#define LVM_GETFOOTERRECT (LVM_FIRST + 205)
#define ListView_GetFooterRect(hwnd, prc)                                      \
  (WINBOOL) SNDMSG((hwnd), LVM_GETFOOTERRECT, (WPARAM)(0), (LPARAM)(prc))
...
#define ListView_GetFooterInfo(hwnd, plvfi)                                    \
  (WINBOOL) SNDMSG((hwnd), LVM_GETFOOTERINFO, (WPARAM)(0), (LPARAM)(plvfi))
#define LVM_GETFOOTERITEMRECT (LVM_FIRST + 207)
#define ListView_GetFooterItemRect(hwnd, iItem, prc)                           \
  (WINBOOL)                                                                    \
      SNDMSG((hwnd), LVM_GETFOOTERITEMRECT, (WPARAM)(iItem), (LPARAM)(prc))
...
#define ListView_GetFooterItem(hwnd, iItem, pfi)                               \
  (WINBOOL) SNDMSG((hwnd), LVM_GETFOOTERITEM, (WPARAM)(iItem), (LPARAM)(pfi))
...
#define ListView_GetItemIndexRect(hwnd, plvii, iSubItem, code, prc)            \
  (WINBOOL)                                                                    \
      SNDMSG((hwnd), LVM_GETITEMINDEXRECT, (WPARAM)(LVITEMINDEX *)(plvii),     \
             ((prc) ? ((((LPRECT)(prc))->top = (iSubItem)),                    \
                       (((LPRECT)(prc))->left = (code)), (LPARAM)(prc))        \
                    : (LPARAM)(LPRECT)NULL))
...
#define ListView_SetItemIndexState(hwndLV, plvii, data, mask)                  \
  {                                                                            \
    ...
    SNDMSG((hwndLV), LVM_SETITEMINDEXSTATE, (WPARAM)(LVITEMINDEX *)(plvii),    \
           (LPARAM)(LV_ITEM *)&_macro_lvi);                                    \
  }
#define LVM_GETNEXTITEMINDEX (LVM_FIRST + 211)
#define ListView_GetNextItemIndex(hwnd, plvii, flags)                          \
  (WINBOOL) SNDMSG((hwnd), LVM_GETNEXTITEMINDEX,                               \
                   (WPARAM)(LVITEMINDEX *)(plvii), MAKELPARAM((flags), 0))
#endif
...
#define ListView_SetBkImage(hwnd, plvbki)                                      \
  (WINBOOL) SNDMSG((hwnd), LVM_SETBKIMAGE, 0, (LPARAM)(plvbki))
#define ListView_GetBkImage(hwnd, plvbki)                                      \
  (WINBOOL) SNDMSG((hwnd), LVM_GETBKIMAGE, 0, (LPARAM)(plvbki))
...
#define TreeView_InsertItem(hwnd, lpis)                                        \
  (HTREEITEM)                                                                  \
      SNDMSG((hwnd), TVM_INSERTITEM, 0, (LPARAM)(LPTV_INSERTSTRUCT)(lpis))
#define TVM_DELETEITEM (TV_FIRST + 1)
#define TreeView_DeleteItem(hwnd, hitem)                                       \
  (WINBOOL) SNDMSG((hwnd), TVM_DELETEITEM, 0, (LPARAM)(HTREEITEM)(hitem))
#define TreeView_DeleteAllItems(hwnd)                                          \
  (WINBOOL) SNDMSG((hwnd), TVM_DELETEITEM, 0, (LPARAM)TVI_ROOT)
#define TVM_EXPAND (TV_FIRST + 2)
#define TreeView_Expand(hwnd, hitem, code)                                     \
  (WINBOOL)                                                                    \
      SNDMSG((hwnd), TVM_EXPAND, (WPARAM)(code), (LPARAM)(HTREEITEM)(hitem))
...
#define TreeView_GetItemRect(hwnd, hitem, prc, code)                           \
  (*(HTREEITEM *)prc = (hitem),                                                \
   (WINBOOL)SNDMSG((hwnd), TVM_GETITEMRECT, (WPARAM)(code),                    \
                   (LPARAM)(RECT *)(prc)))
...
#define TreeView_SetIndent(hwnd, indent)                                       \
  (WINBOOL) SNDMSG((hwnd), TVM_SETINDENT, (WPARAM)(indent), 0)
...
#define TreeView_SetImageList(hwnd, himl, iImage)                              \
  (HIMAGELIST)                                                                 \
      SNDMSG((hwnd), TVM_SETIMAGELIST, iImage, (LPARAM)(HIMAGELIST)(himl))
...
#if _WIN32_IE >= 0x0600
#define TreeView_GetNextSelected(hwnd, hitem)                                  \
  TreeView_GetNextItem(hwnd, hitem, TVGN_NEXTSELECTED)
#endif
#define TVM_SELECTITEM (TV_FIRST + 11)
#define TreeView_Select(hwnd, hitem, code)                                     \
  (WINBOOL) SNDMSG((hwnd), TVM_SELECTITEM, (WPARAM)(code),                     \
                   (LPARAM)(HTREEITEM)(hitem))
...
#define TreeView_GetItem(hwnd, pitem)                                          \
  (WINBOOL) SNDMSG((hwnd), TVM_GETITEM, 0, (LPARAM)(TV_ITEM *)(pitem))
#define TVM_SETITEMA (TV_FIRST + 13)
#define TVM_SETITEMW (TV_FIRST + 63)
#define TVM_SETITEM __MINGW_NAME_AW(TVM_SETITEM)
#define TreeView_SetItem(hwnd, pitem)                                          \
  (WINBOOL) SNDMSG((hwnd), TVM_SETITEM, 0, (LPARAM)(const TV_ITEM *)(pitem))
...
#define TreeView_CreateDragImage(hwnd, hitem)                                  \
  (HIMAGELIST)                                                                 \
      SNDMSG((hwnd), TVM_CREATEDRAGIMAGE, 0, (LPARAM)(HTREEITEM)(hitem))
#define TVM_SORTCHILDREN (TV_FIRST + 19)
#define TreeView_SortChildren(hwnd, hitem, recurse)                            \
  (WINBOOL) SNDMSG((hwnd), TVM_SORTCHILDREN, (WPARAM)(recurse),                \
                   (LPARAM)(HTREEITEM)(hitem))
#define TVM_ENSUREVISIBLE (TV_FIRST + 20)
#define TreeView_EnsureVisible(hwnd, hitem)                                    \
  (WINBOOL) SNDMSG((hwnd), TVM_ENSUREVISIBLE, 0, (LPARAM)(HTREEITEM)(hitem))
#define TVM_SORTCHILDRENCB (TV_FIRST + 21)
#define TreeView_SortChildrenCB(hwnd, psort, recurse)                          \
  (WINBOOL) SNDMSG((hwnd), TVM_SORTCHILDRENCB, (WPARAM)(recurse),              \
                   (LPARAM)(LPTV_SORTCB)(psort))
#define TVM_ENDEDITLABELNOW (TV_FIRST + 22)
#define TreeView_EndEditLabelNow(hwnd, fCancel)                                \
  (WINBOOL) SNDMSG((hwnd), TVM_ENDEDITLABELNOW, (WPARAM)(fCancel), 0)
...
#define TreeView_GetISearchString(hwndTV, lpsz)                                \
  (WINBOOL) SNDMSG((hwndTV), TVM_GETISEARCHSTRING, 0, (LPARAM)(LPTSTR)(lpsz))
#define TVM_SETINSERTMARK (TV_FIRST + 26)
#define TreeView_SetInsertMark(hwnd, hItem, fAfter)                            \
  (WINBOOL) SNDMSG((hwnd), TVM_SETINSERTMARK, (WPARAM)(fAfter), (LPARAM)(hItem))
#define TVM_SETUNICODEFORMAT CCM_SETUNICODEFORMAT
#define TreeView_SetUnicodeFormat(hwnd, fUnicode)                              \
  (WINBOOL) SNDMSG((hwnd), TVM_SETUNICODEFORMAT, (WPARAM)(fUnicode), 0)
#define TVM_GETUNICODEFORMAT CCM_GETUNICODEFORMAT
#define TreeView_GetUnicodeFormat(hwnd)                                        \
  (WINBOOL) SNDMSG((hwnd), TVM_GETUNICODEFORMAT, 0, 0)
...
#define TreeView_SetBorder(hwnd, dwFlags, xBorder, yBorder)                    \
  (int)SNDMSG((hwnd), TVM_SETBORDER, (WPARAM)(dwFlags),                        \
...
#define TreeView_SetCheckState(hwndTV, hti, fCheck)                            \
  TreeView_SetItemState(hwndTV, hti, INDEXTOSTATEIMAGEMASK((fCheck) ? 2 : 1),  \
                        TVIS_STATEIMAGEMASK)
...
#define TreeView_SetAutoScrollInfo(hwnd, uPixPerSec, uUpdateTime)              \
  SNDMSG((hwnd), TVM_SETAUTOSCROLLINFO, (WPARAM)(uPixPerSec),                  \
         (LPARAM)(uUpdateTime))
#if NTDDI_VERSION >= 0x06000000
...
typedef enum _TVITEMPART { TVGIPR_BUTTON = 0x0001 } TVITEMPART;
...
#define TabCtrl_GetImageList(hwnd)                                             \
  (HIMAGELIST) SNDMSG((hwnd), TCM_GETIMAGELIST, (WPARAM)0, (LPARAM)0)
#define TCM_SETIMAGELIST (TCM_FIRST + 3)
#define TabCtrl_SetImageList(hwnd, himl)                                       \
  (HIMAGELIST) SNDMSG((hwnd), TCM_SETIMAGELIST, 0, (LPARAM)(HIMAGELIST)(himl))
#define TCM_GETITEMCOUNT (TCM_FIRST + 4)
#define TabCtrl_GetItemCount(hwnd)                                             \
  (int)SNDMSG((hwnd), TCM_GETITEMCOUNT, (WPARAM)0, (LPARAM)0)
...
#define TabCtrl_GetItem(hwnd, iItem, pitem)                                    \
  (WINBOOL) SNDMSG((hwnd), TCM_GETITEM, (WPARAM)(int)(iItem),                  \
                   (LPARAM)(TC_ITEM *)(pitem))
#define TCM_SETITEMA (TCM_FIRST + 6)
#define TCM_SETITEMW (TCM_FIRST + 61)
#define TCM_SETITEM __MINGW_NAME_AW(TCM_SETITEM)
#define TabCtrl_SetItem(hwnd, iItem, pitem)                                    \
  (WINBOOL) SNDMSG((hwnd), TCM_SETITEM, (WPARAM)(int)(iItem),                  \
                   (LPARAM)(TC_ITEM *)(pitem))
#define TCM_INSERTITEMA (TCM_FIRST + 7)
#define TCM_INSERTITEMW (TCM_FIRST + 62)
#define TCM_INSERTITEM __MINGW_NAME_AW(TCM_INSERTITEM)
#define TabCtrl_InsertItem(hwnd, iItem, pitem)                                 \
  (int)SNDMSG((hwnd), TCM_INSERTITEM, (WPARAM)(int)(iItem),                    \
              (LPARAM)(const TC_ITEM *)(pitem))
#define TCM_DELETEITEM (TCM_FIRST + 8)
#define TabCtrl_DeleteItem(hwnd, i)                                            \
  (WINBOOL) SNDMSG((hwnd), TCM_DELETEITEM, (WPARAM)(int)(i), (LPARAM)0)
#define TCM_DELETEALLITEMS (TCM_FIRST + 9)
#define TabCtrl_DeleteAllItems(hwnd)                                           \
  (WINBOOL) SNDMSG((hwnd), TCM_DELETEALLITEMS, (WPARAM)0, (LPARAM)0)
#define TCM_GETITEMRECT (TCM_FIRST + 10)
#define TabCtrl_GetItemRect(hwnd, i, prc)                                      \
  (WINBOOL)                                                                    \
      SNDMSG((hwnd), TCM_GETITEMRECT, (WPARAM)(int)(i), (LPARAM)(RECT *)(prc))
...
#define TabCtrl_SetItemExtra(hwndTC, cb)                                       \
  (WINBOOL) SNDMSG((hwndTC), TCM_SETITEMEXTRA, (WPARAM)(cb), (LPARAM)0)
#define TCM_ADJUSTRECT (TCM_FIRST + 40)
#define TabCtrl_AdjustRect(hwnd, bLarger, prc)                                 \
  (int)SNDMSG(hwnd, TCM_ADJUSTRECT, (WPARAM)(WINBOOL)(bLarger),                \
              (LPARAM)(RECT *)prc)
...
#define TabCtrl_RemoveImage(hwnd, i)                                           \
  (void)SNDMSG((hwnd), TCM_REMOVEIMAGE, i, (LPARAM)0)
#define TCM_SETPADDING (TCM_FIRST + 43)
#define TabCtrl_SetPadding(hwnd, cx, cy)                                       \
  (void)SNDMSG((hwnd), TCM_SETPADDING, 0, MAKELPARAM(cx, cy))
#define TCM_GETROWCOUNT (TCM_FIRST + 44)
#define TabCtrl_GetRowCount(hwnd)                                              \
  (int)SNDMSG((hwnd), TCM_GETROWCOUNT, (WPARAM)0, (LPARAM)0)
#define TCM_GETTOOLTIPS (TCM_FIRST + 45)
#define TabCtrl_GetToolTips(hwnd)                                              \
  (HWND) SNDMSG((hwnd), TCM_GETTOOLTIPS, (WPARAM)0, (LPARAM)0)
#define TCM_SETTOOLTIPS (TCM_FIRST + 46)
#define TabCtrl_SetToolTips(hwnd, hwndTT)                                      \
  (void)SNDMSG((hwnd), TCM_SETTOOLTIPS, (WPARAM)(hwndTT), (LPARAM)0)
...
#define TabCtrl_HighlightItem(hwnd, i, fHighlight)                             \
  (WINBOOL) SNDMSG((hwnd), TCM_HIGHLIGHTITEM, (WPARAM)(i),                     \
...
#define TabCtrl_SetUnicodeFormat(hwnd, fUnicode)                               \
  (WINBOOL) SNDMSG((hwnd), TCM_SETUNICODEFORMAT, (WPARAM)(fUnicode), 0)
#define TCM_GETUNICODEFORMAT CCM_GETUNICODEFORMAT
#define TabCtrl_GetUnicodeFormat(hwnd)                                         \
  (WINBOOL) SNDMSG((hwnd), TCM_GETUNICODEFORMAT, 0, 0)
...
#define Animate_Create(hwndP, id, dwStyle, hInstance)                          \
  CreateWindow(ANIMATE_CLASS, NULL, dwStyle, 0, 0, 0, 0, hwndP, (HMENU)(id),   \
               hInstance, NULL)
#define Animate_Open(hwnd, szName)                                             \
  (WINBOOL) SNDMSG(hwnd, ACM_OPEN, 0, (LPARAM)(LPTSTR)(szName))
...
#define MonthCal_GetCurSel(hmc, pst)                                           \
  (WINBOOL) SNDMSG(hmc, MCM_GETCURSEL, 0, (LPARAM)(pst))
#define MCM_SETCURSEL (MCM_FIRST + 2)
#define MonthCal_SetCurSel(hmc, pst)                                           \
  (WINBOOL) SNDMSG(hmc, MCM_SETCURSEL, 0, (LPARAM)(pst))
#define MCM_GETMAXSELCOUNT (MCM_FIRST + 3)
#define MonthCal_GetMaxSelCount(hmc)                                           \
  (DWORD) SNDMSG(hmc, MCM_GETMAXSELCOUNT, (WPARAM)0, (LPARAM)0)
#define MCM_SETMAXSELCOUNT (MCM_FIRST + 4)
#define MonthCal_SetMaxSelCount(hmc, n)                                        \
  (WINBOOL) SNDMSG(hmc, MCM_SETMAXSELCOUNT, (WPARAM)(n), (LPARAM)0)
...
#define MonthCal_GetToday(hmc, pst)                                            \
  (WINBOOL) SNDMSG(hmc, MCM_GETTODAY, 0, (LPARAM)(pst))
...
#define MonthCal_SetRange(hmc, gd, rgst)                                       \
  (WINBOOL) SNDMSG(hmc, MCM_SETRANGE, (WPARAM)(gd), (LPARAM)(rgst))
...
#define MonthCal_SetUnicodeFormat(hwnd, fUnicode)                              \
  (WINBOOL) SNDMSG((hwnd), MCM_SETUNICODEFORMAT, (WPARAM)(fUnicode), 0)
...
#define MonthCal_GetCalendarGridInfo(hmc, pmcGridInfo)                         \
  (WINBOOL) SNDMSG(hmc, MCM_GETCALENDARGRIDINFO, 0,                            \
                   (LPARAM)(PMCGRIDINFO)(pmcGridInfo))
...
#define MonthCal_SetCurrentView(hmc, dwNewView)                                \
  (WINBOOL) SNDMSG(hmc, MCM_SETCURRENTVIEW, 0, (LPARAM)(dwNewView))
#endif
...
#define DateTime_SetSystemtime(hdp, gd, pst)                                   \
  (WINBOOL) SNDMSG(hdp, DTM_SETSYSTEMTIME, (WPARAM)(gd), (LPARAM)(pst))
...
#define DateTime_SetRange(hdp, gd, rgst)                                       \
  (WINBOOL) SNDMSG(hdp, DTM_SETRANGE, (WPARAM)(gd), (LPARAM)(rgst))
#define DTM_SETFORMATA (DTM_FIRST + 5)
#define DTM_SETFORMATW (DTM_FIRST + 50)
#define DTM_SETFORMAT __MINGW_NAME_AW(DTM_SETFORMAT)
#define DateTime_SetFormat(hdp, sz)                                            \
  (WINBOOL) SNDMSG(hdp, DTM_SETFORMAT, 0, (LPARAM)(sz))
...
#define DateTime_SetMonthCalStyle(hdp, dwStyle)                                \
...
#define DateTime_GetDateTimePickerInfo(hdp, pdtpi)                             \
  SNDMSG(hdp, DTM_GETDATETIMEPICKERINFO, 0, (LPARAM)(pdtpi))
#define DTM_GETIDEALSIZE (DTM_FIRST + 15)
#define DateTime_GetIdealSize(hdp, psize)                                      \
  (WINBOOL) SNDMSG((hdp), DTM_GETIDEALSIZE, 0, (LPARAM)(psize))
#endif
...
#define MAKEIPADDRESS(b1, b2, b3, b4)                                          \
  ((LPARAM)(((DWORD)(b1) << 24) + ((DWORD)(b2) << 16) + ((DWORD)(b3) << 8) +   \
            ((DWORD)(b4))))
...
#define Pager_SetScrollInfo(hwnd, cTimeOut, cLinesPer, cPixelsPerLine)         \
  (void)SNDMSG((hwnd), PGM_SETSCROLLINFO, cTimeOut,                            \
               MAKELONG(cLinesPer, cPixelsPerLine))
...
#define Button_SetSplitInfo(hwnd, pInfo)                                       \
  (WINBOOL) SNDMSG((hwnd), BCM_SETSPLITINFO, 0, (LPARAM)(pInfo))
#define BCM_GETSPLITINFO (BCM_FIRST + 0x8)
#define Button_GetSplitInfo(hwnd, pInfo)                                       \
  (WINBOOL) SNDMSG((hwnd), BCM_GETSPLITINFO, 0, (LPARAM)(pInfo))
...
#define Edit_SetCueBannerText(hwnd, lpcwText)                                  \
  (WINBOOL) SNDMSG((hwnd), EM_SETCUEBANNER, 0, (LPARAM)(lpcwText))
#define EM_GETCUEBANNER (ECM_FIRST + 2)
#define Edit_GetCueBannerText(hwnd, lpwText, cchText)                          \
  (WINBOOL)                                                                    \
      SNDMSG((hwnd), EM_GETCUEBANNER, (WPARAM)(lpwText), (LPARAM)(cchText))
...
#define Edit_HideBalloonTip(hwnd)                                              \
  (WINBOOL) SNDMSG((hwnd), EM_HIDEBALLOONTIP, 0, 0)
#if NTDDI_VERSION >= 0x06000000
#define EM_SETHILITE (ECM_FIRST + 5)
#define Edit_SetHilite(hwndCtl, ichStart, ichEnd)                              \
  ((void)SNDMSG((hwndCtl), EM_SETHILITE, (ichStart), (ichEnd)))
#define EM_GETHILITE (ECM_FIRST + 6)
#define Edit_GetHilite(hwndCtl)                                                \
  ((DWORD)SNDMSG((hwndCtl), EM_GETHILITE, (WPARAM)0, (LPARAM)0))
#endif
#define EM_NOSETFOCUS (ECM_FIRST + 7)
#define Edit_NoSetFocus(hwndCtl)                                               \
  ((DWORD)SNDMSG((hwndCtl), EM_NOSETFOCUS, (WPARAM)0, (LPARAM)0))
#define EM_TAKEFOCUS (ECM_FIRST + 8)
#define Edit_TakeFocus(hwndCtl)                                                \
  ((DWORD)SNDMSG((hwndCtl), EM_TAKEFOCUS, (WPARAM)0, (LPARAM)0))
#endif
#ifndef NOLISTBOX
...
#define ComboBox_SetCueBannerText(hwnd, lpcwText)                              \
  (WINBOOL) SNDMSG((hwnd), CB_SETCUEBANNER, 0, (LPARAM)(lpcwText))
#define ComboBox_GetCueBannerText(hwnd, lpwText, cchText)                      \
  (WINBOOL)                                                                    \
      SNDMSG((hwnd), CB_GETCUEBANNER, (WPARAM)(lpwText), (LPARAM)(cchText))
#ifndef NOSCROLLBAR
...
TaskDialogIndirect(const TASKDIALOGCONFIG *pTaskConfig, int *pnButton,
                   int *pnRadioButton, WINBOOL *pfVerificationFlagChecked);
WINCOMMCTRLAPI HRESULT WINAPI
TaskDialog(HWND hwndOwner, HINSTANCE hInstance, PCWSTR pszWindowTitle,
...
WINCOMMCTRLAPI void WINAPI DSA_DestroyCallback(HDSA hdsa,
                                               PFNDAENUMCALLBACK pfnCB,
                                               void *pData);
#ifdef __cplusplus
extern "C++" __inline void
DSA_DestroyCallback(HDSA hdsa, PFNDAENUMCALLBACKCONST pfnCB, void *pData) {
...
WINCOMMCTRLAPI void WINAPI DSA_EnumCallback(HDSA hdsa, PFNDAENUMCALLBACK pfnCB,
                                            void *pData);
#ifdef __cplusplus
extern "C++" __inline void
DSA_EnumCallback(HDSA hdsa, PFNDAENUMCALLBACKCONST pfnCB, void *pData) {
...
WINCOMMCTRLAPI WINBOOL WINAPI DSA_Sort(HDSA pdsa, PFNDACOMPARE pfnCompare,
                                       LPARAM lParam);
#ifdef __cplusplus
extern "C++" __inline WINBOOL DSA_Sort(HDSA hdsa, PFNDACOMPARECONST pfnCompare,
                                       LPARAM lParam) {
...
WINCOMMCTRLAPI void WINAPI DPA_DestroyCallback(HDPA hdpa,
                                               PFNDAENUMCALLBACK pfnCB,
                                               void *pData);
#ifdef __cplusplus
extern "C++" __inline void
DPA_DestroyCallback(HDPA hdpa, PFNDAENUMCALLBACKCONST pfnCB, void *pData) {
...
WINCOMMCTRLAPI void WINAPI DPA_EnumCallback(HDPA hdpa, PFNDAENUMCALLBACK pfnCB,
                                            void *pData);
#ifdef __cplusplus
extern "C++" __inline void
DPA_EnumCallback(HDPA hdpa, PFNDAENUMCALLBACKCONST pfnCB, void *pData) {
...
WINCOMMCTRLAPI WINBOOL WINAPI DPA_Sort(HDPA hdpa, PFNDACOMPARE pfnCompare,
                                       LPARAM lParam);
#ifdef __cplusplus
extern "C++" __inline WINBOOL DPA_Sort(HDPA hdpa, PFNDACOMPARECONST pfnCompare,
                                       LPARAM lParam) {
...
struct IStream;
typedef HRESULT(CALLBACK *PFNDPASTREAM)(DPASTREAMINFO *pinfo,
...
typedef void *(CALLBACK *PFNDPAMERGE)(UINT uMsg, void *pvDest, void *pvSrc,
                                      LPARAM lParam);
typedef const void *(CALLBACK *PFNDPAMERGECONST)(UINT uMsg, const void *pvDest,
                                                 const void *pvSrc,
                                                 LPARAM lParam);
#define DPAMM_MERGE 1
#define DPAMM_DELETE 2
#define DPAMM_INSERT 3
WINCOMMCTRLAPI WINBOOL WINAPI DPA_Merge(HDPA hdpaDest, HDPA hdpaSrc,
                                        DWORD dwFlags, PFNDACOMPARE pfnCompare,
                                        PFNDPAMERGE pfnMerge, LPARAM lParam);
#ifdef __cplusplus
extern "C++" __inline WINBOOL DPA_Merge(HDPA hdpaDest, HDPA hdpaSrc,
                                        DWORD dwFlags,
                                        PFNDACOMPARECONST pfnCompare,
                                        PFNDPAMERGECONST pfnMerge,
                                        LPARAM lParam) {
  return DPA_Merge(hdpaDest, hdpaSrc, dwFlags, (PFNDACOMPARE)pfnCompare,
                   (PFNDPAMERGE)pfnMerge, lParam);
}
#endif
...
WINCOMMCTRLAPI int WINAPI DPA_Search(HDPA hdpa, void *pFind, int iStart,
                                     PFNDACOMPARE pfnCompare, LPARAM lParam,
                                     UINT options);
#ifdef __cplusplus
extern "C++" __inline int DPA_Search(HDPA hdpa, const void *pFind, int iStart,
                                     PFNDACOMPARECONST pfnCompare,
                                     LPARAM lParam, UINT options) {
  return DPA_Search(hdpa, const_cast<void *>(pFind), iStart,
                    (PFNDACOMPARE)pfnCompare, lParam, options);
}
#endif
#define DPA_SortedInsertPtr(hdpa, pFind, iStart, pfnCompare, lParam, options,  \
                            pitem)                                             \
  DPA_InsertPtr(hdpa,                                                          \
                DPA_Search(hdpa, pFind, iStart, pfnCompare, lParam,            \
                           (DPAS_SORTED | (options))),                         \
                (pitem))
...
WINCOMMCTRLAPI WINBOOL WINAPI FlatSB_GetScrollRange(HWND, int code, LPINT,
                                                    LPINT);
WINCOMMCTRLAPI WINBOOL WINAPI FlatSB_GetScrollInfo(HWND, int code,
                                                   LPSCROLLINFO);
...
#ifdef _WIN64
WINCOMMCTRLAPI WINBOOL WINAPI FlatSB_GetScrollPropPtr(HWND, int propIndex,
                                                      PINT_PTR);
#else
#define FlatSB_GetScrollPropPtr FlatSB_GetScrollProp
#endif
WINCOMMCTRLAPI int WINAPI FlatSB_SetScrollPos(HWND, int code, int pos,
                                              WINBOOL fRedraw);
WINCOMMCTRLAPI int WINAPI FlatSB_SetScrollInfo(HWND, int code, LPSCROLLINFO,
                                               WINBOOL fRedraw);
WINCOMMCTRLAPI int WINAPI FlatSB_SetScrollRange(HWND, int code, int min,
                                                int max, WINBOOL fRedraw);
WINCOMMCTRLAPI WINBOOL WINAPI FlatSB_SetScrollProp(HWND, UINT index,
                                                   INT_PTR newValue, WINBOOL);
...
typedef LRESULT(CALLBACK *SUBCLASSPROC)(HWND hWnd, UINT uMsg, WPARAM wParam,
                                        ...
                                        DWORD_PTR dwRefData);
WINBOOL WINAPI SetWindowSubclass(HWND hWnd, SUBCLASSPROC pfnSubclass,
                                 UINT_PTR uIdSubclass, DWORD_PTR dwRefData);
WINBOOL WINAPI GetWindowSubclass(HWND hWnd, SUBCLASSPROC pfnSubclass,
                                 UINT_PTR uIdSubclass, DWORD_PTR *pdwRefData);
WINBOOL WINAPI RemoveWindowSubclass(HWND hWnd, SUBCLASSPROC pfnSubclass,
                                    UINT_PTR uIdSubclass);
LRESULT WINAPI DefSubclassProc(HWND hWnd, UINT uMsg, WPARAM wParam,
                               LPARAM lParam);
...
WINCOMMCTRLAPI HRESULT WINAPI LoadIconMetric(HINSTANCE hinst, PCWSTR pszName,
                                             int lims, HICON *phico);
WINCOMMCTRLAPI HRESULT WINAPI LoadIconWithScaleDown(HINSTANCE hinst,
                                                    PCWSTR pszName, int cx,
                                                    int cy, HICON *phico);
#endif
#ifdef __cplusplus
}
