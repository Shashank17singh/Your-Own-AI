...
_CRTIMP int __cdecl __attribute__((__nothrow__, __returns_twice__))
_setjmp3(jmp_buf _Buf, int _Count,
         ...); /* new i386 msvcrt20+ setjmp.h and setjmpex.h */
#else
#ifndef __aarch64__
_CRTIMP int __cdecl __attribute__((__nothrow__, __returns_twice__))
...
_setjmpex(jmp_buf _Buf,
          void *_Frame); /* for non-i386 setjmpex.h and aarch64 setjmp.h */
#endif
#if defined(__arm__) || defined(__aarch64__)
int __cdecl __attribute__((__nothrow__,
                           __returns_twice__)) __mingw_setjmp(jmp_buf _Buf);
...
#elif !defined(_INC_SETJMPEX) &&                                               \
    (!defined(__SEH__) || defined(__USE_MINGW_SETJMP_NON_SEH))
#if defined(__arm__) || defined(__aarch64__)
