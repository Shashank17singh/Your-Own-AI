...
DEFINE_GUID(IID_IVssEnumObject, 0xae1c7110, 0x2f60, 0x11d3, 0x8a, 0x39, 0x00,
            0xc0, 0x4f, 0x72, 0xd8, 0xe3);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("ae1c7110-2f60-11d3-8a39-00c04f72d8e3")
IVssEnumObject : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE Next(ULONG celt, VSS_OBJECT_PROP * rgelt,
                                         ULONG * pceltFetched) = 0;
  virtual HRESULT STDMETHODCALLTYPE Skip(ULONG celt) = 0;
  virtual HRESULT STDMETHODCALLTYPE Reset() = 0;
  virtual HRESULT STDMETHODCALLTYPE Clone(IVssEnumObject * *ppenum) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IVssEnumObject, 0xae1c7110, 0x2f60, 0x11d3, 0x8a, 0x39, 0x00,
                0xc0, 0x4f, 0x72, 0xd8, 0xe3)
#endif
#else
typedef struct IVssEnumObjectVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IVssEnumObject *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *Next)(IVssEnumObject *This, ULONG celt,
                                   VSS_OBJECT_PROP *rgelt, ULONG *pceltFetched);
...
interface IVssEnumObject { CONST_VTBL IVssEnumObjectVtbl *lpVtbl; };
#ifdef COBJMACROS
...
#else
/*** IUnknown methods ***/
static inline HRESULT IVssEnumObject_QueryInterface(IVssEnumObject *This,
                                                    REFIID riid,
                                                    void **ppvObject) {
...
/*** IVssEnumObject methods ***/
static inline HRESULT IVssEnumObject_Next(IVssEnumObject *This, ULONG celt,
                                          VSS_OBJECT_PROP *rgelt,
                                          ULONG *pceltFetched) {
  return This->lpVtbl->Next(This, celt, rgelt, pceltFetched);
}
static inline HRESULT IVssEnumObject_Skip(IVssEnumObject *This, ULONG celt) {
  return This->lpVtbl->Skip(This, celt);
}
static inline HRESULT IVssEnumObject_Reset(IVssEnumObject *This) {
  return This->lpVtbl->Reset(This);
}
static inline HRESULT IVssEnumObject_Clone(IVssEnumObject *This,
                                           IVssEnumObject **ppenum) {
...
DEFINE_GUID(IID_IVssAsync, 0x507c37b4, 0xcf5b, 0x4e95, 0xb0, 0xaf, 0x14, 0xeb,
            0x97, 0x67, 0x46, 0x7e);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IVssAsync : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE QueryStatus(HRESULT * pHrResult,
                                                INT * pReserved) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IVssAsync, 0x507c37b4, 0xcf5b, 0x4e95, 0xb0, 0xaf, 0x14, 0xeb,
                0x97, 0x67, 0x46, 0x7e)
#endif
#else
typedef struct IVssAsyncVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IVssAsync *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *QueryStatus)(IVssAsync *This, HRESULT *pHrResult,
                                          INT *pReserved);
  END_INTERFACE
} IVssAsyncVtbl;
interface IVssAsync { CONST_VTBL IVssAsyncVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IVssAsync_QueryInterface(IVssAsync *This, REFIID riid,
                                               void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IVssAsync methods ***/
static inline HRESULT IVssAsync_Cancel(IVssAsync *This) {
  return This->lpVtbl->Cancel(This);
}
static inline HRESULT IVssAsync_Wait(IVssAsync *This, DWORD dwMilliseconds) {
  return This->lpVtbl->Wait(This, dwMilliseconds);
}
static inline HRESULT IVssAsync_QueryStatus(IVssAsync *This, HRESULT *pHrResult,
                                            INT *pReserved) {
