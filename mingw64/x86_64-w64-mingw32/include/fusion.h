...
DEFINE_GUID(IID_IAssemblyCache, 0xe707dcde, 0xd1cd, 0x11d2, 0xba, 0xb9, 0x00,
            0xc0, 0x4f, 0x8e, 0xce, 0xae);
...
IAssemblyCache : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE UninstallAssembly(
      DWORD dwFlags, LPCWSTR pszAssemblyName,
      LPCFUSION_INSTALL_REFERENCE pRefData, ULONG * pulDisposition) = 0;
  virtual HRESULT STDMETHODCALLTYPE QueryAssemblyInfo(
      DWORD dwFlags, LPCWSTR pszAssemblyName, ASSEMBLY_INFO * pAsmInfo) = 0;
  virtual HRESULT STDMETHODCALLTYPE CreateAssemblyCacheItem(
      DWORD dwFlags, PVOID pvReserved, IAssemblyCacheItem * *ppAsmItem,
      LPCWSTR pszAssemblyName) = 0;
  virtual HRESULT STDMETHODCALLTYPE CreateAssemblyScavenger(IUnknown *
                                                            *ppUnkReserved) = 0;
  virtual HRESULT STDMETHODCALLTYPE InstallAssembly(
      DWORD dwFlags, LPCWSTR pszManifestFilePath,
      LPCFUSION_INSTALL_REFERENCE pRefData) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IAssemblyCache, 0xe707dcde, 0xd1cd, 0x11d2, 0xba, 0xb9, 0x00,
                0xc0, 0x4f, 0x8e, 0xce, 0xae)
#endif
#else
typedef struct IAssemblyCacheVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAssemblyCache *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *UninstallAssembly)(
      IAssemblyCache *This, DWORD dwFlags, LPCWSTR pszAssemblyName,
      LPCFUSION_INSTALL_REFERENCE pRefData, ULONG *pulDisposition);
  HRESULT(STDMETHODCALLTYPE *QueryAssemblyInfo)(IAssemblyCache *This,
                                                DWORD dwFlags,
                                                LPCWSTR pszAssemblyName,
                                                ASSEMBLY_INFO *pAsmInfo);
  HRESULT(STDMETHODCALLTYPE *CreateAssemblyCacheItem)(
      IAssemblyCache *This, DWORD dwFlags, PVOID pvReserved,
      IAssemblyCacheItem **ppAsmItem, LPCWSTR pszAssemblyName);
  HRESULT(STDMETHODCALLTYPE *CreateAssemblyScavenger)(IAssemblyCache *This,
                                                      IUnknown **ppUnkReserved);
  HRESULT(STDMETHODCALLTYPE *InstallAssembly)(
      IAssemblyCache *This, DWORD dwFlags, LPCWSTR pszManifestFilePath,
      LPCFUSION_INSTALL_REFERENCE pRefData);
  END_INTERFACE
} IAssemblyCacheVtbl;
interface IAssemblyCache { CONST_VTBL IAssemblyCacheVtbl *lpVtbl; };
#ifdef COBJMACROS
...
/*** IAssemblyCache methods ***/
#define IAssemblyCache_UninstallAssembly(This, dwFlags, pszAssemblyName,       \
                                         pRefData, pulDisposition)             \
  (This)->lpVtbl->UninstallAssembly(This, dwFlags, pszAssemblyName, pRefData,  \
                                    pulDisposition)
#define IAssemblyCache_QueryAssemblyInfo(This, dwFlags, pszAssemblyName,       \
                                         pAsmInfo)                             \
  (This)->lpVtbl->QueryAssemblyInfo(This, dwFlags, pszAssemblyName, pAsmInfo)
#define IAssemblyCache_CreateAssemblyCacheItem(This, dwFlags, pvReserved,      \
                                               ppAsmItem, pszAssemblyName)     \
  (This)->lpVtbl->CreateAssemblyCacheItem(This, dwFlags, pvReserved,           \
                                          ppAsmItem, pszAssemblyName)
#define IAssemblyCache_CreateAssemblyScavenger(This, ppUnkReserved)            \
  (This)->lpVtbl->CreateAssemblyScavenger(This, ppUnkReserved)
#define IAssemblyCache_InstallAssembly(This, dwFlags, pszManifestFilePath,     \
                                       pRefData)                               \
  (This)->lpVtbl->InstallAssembly(This, dwFlags, pszManifestFilePath, pRefData)
#else
/*** IUnknown methods ***/
static inline HRESULT IAssemblyCache_QueryInterface(IAssemblyCache *This,
                                                    REFIID riid,
                                                    void **ppvObject) {
...
/*** IAssemblyCache methods ***/
static inline HRESULT IAssemblyCache_UninstallAssembly(
    IAssemblyCache *This, DWORD dwFlags, LPCWSTR pszAssemblyName,
    LPCFUSION_INSTALL_REFERENCE pRefData, ULONG *pulDisposition) {
  return This->lpVtbl->UninstallAssembly(This, dwFlags, pszAssemblyName,
                                         pRefData, pulDisposition);
}
static inline HRESULT
IAssemblyCache_QueryAssemblyInfo(IAssemblyCache *This, DWORD dwFlags,
                                 LPCWSTR pszAssemblyName,
                                 ASSEMBLY_INFO *pAsmInfo) {
  return This->lpVtbl->QueryAssemblyInfo(This, dwFlags, pszAssemblyName,
                                         pAsmInfo);
}
static inline HRESULT IAssemblyCache_CreateAssemblyCacheItem(
    IAssemblyCache *This, DWORD dwFlags, PVOID pvReserved,
    IAssemblyCacheItem **ppAsmItem, LPCWSTR pszAssemblyName) {
  return This->lpVtbl->CreateAssemblyCacheItem(This, dwFlags, pvReserved,
                                               ppAsmItem, pszAssemblyName);
}
static inline HRESULT
IAssemblyCache_CreateAssemblyScavenger(IAssemblyCache *This,
                                       IUnknown **ppUnkReserved) {
  return This->lpVtbl->CreateAssemblyScavenger(This, ppUnkReserved);
}
static inline HRESULT
IAssemblyCache_InstallAssembly(IAssemblyCache *This, DWORD dwFlags,
...
DEFINE_GUID(IID_IAssemblyCacheItem, 0x9e3aaeb4, 0xd1cd, 0x11d2, 0xba, 0xb9,
            0x00, 0xc0, 0x4f, 0x8e, 0xce, 0xae);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("9e3aaeb4-d1cd-11d2-bab9-00c04f8eceae")
IAssemblyCacheItem : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE CreateStream(
      DWORD dwFlags, LPCWSTR pszStreamName, DWORD dwFormat, DWORD dwFormatFlags,
      IStream * *ppIStream, ULARGE_INTEGER * puliMaxSize) = 0;
  virtual HRESULT STDMETHODCALLTYPE Commit(DWORD dwFlags,
                                           ULONG * pulDisposition) = 0;
  virtual HRESULT STDMETHODCALLTYPE AbortItem() = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IAssemblyCacheItem, 0x9e3aaeb4, 0xd1cd, 0x11d2, 0xba, 0xb9,
                0x00, 0xc0, 0x4f, 0x8e, 0xce, 0xae)
#endif
#else
typedef struct IAssemblyCacheItemVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAssemblyCacheItem *This,
  ...
  HRESULT(STDMETHODCALLTYPE *CreateStream)(IAssemblyCacheItem *This,
                                           DWORD dwFlags, LPCWSTR pszStreamName,
                                           DWORD dwFormat, DWORD dwFormatFlags,
                                           IStream **ppIStream,
                                           ULARGE_INTEGER *puliMaxSize);
  HRESULT(STDMETHODCALLTYPE *Commit)(IAssemblyCacheItem *This, DWORD dwFlags,
                                     ULONG *pulDisposition);
  HRESULT(STDMETHODCALLTYPE *AbortItem)(IAssemblyCacheItem *This);
  END_INTERFACE
} IAssemblyCacheItemVtbl;
interface IAssemblyCacheItem { CONST_VTBL IAssemblyCacheItemVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IAssemblyCacheItem methods ***/
#define IAssemblyCacheItem_CreateStream(This, dwFlags, pszStreamName,          \
                                        dwFormat, dwFormatFlags, ppIStream,    \
                                        puliMaxSize)                           \
  (This)->lpVtbl->CreateStream(This, dwFlags, pszStreamName, dwFormat,         \
                               dwFormatFlags, ppIStream, puliMaxSize)
...
/*** IUnknown methods ***/
static inline HRESULT
IAssemblyCacheItem_QueryInterface(IAssemblyCacheItem *This, REFIID riid,
                                  void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IAssemblyCacheItem methods ***/
static inline HRESULT
IAssemblyCacheItem_CreateStream(IAssemblyCacheItem *This, DWORD dwFlags,
                                LPCWSTR pszStreamName, DWORD dwFormat,
                                DWORD dwFormatFlags, IStream **ppIStream,
                                ULARGE_INTEGER *puliMaxSize) {
  return This->lpVtbl->CreateStream(This, dwFlags, pszStreamName, dwFormat,
                                    dwFormatFlags, ppIStream, puliMaxSize);
}
static inline HRESULT IAssemblyCacheItem_Commit(IAssemblyCacheItem *This,
                                                DWORD dwFlags,
                                                ULONG *pulDisposition) {
...
typedef enum __WIDL_fusion_generated_name_00000012 {
  ...
  ASM_DISPLAYF_FULL = (((ASM_DISPLAYF_VERSION | ASM_DISPLAYF_CULTURE) |
...
typedef enum __WIDL_fusion_generated_name_00000013 {
  ...
  ASM_CMPF_VERSION = ((ASM_CMPF_MAJOR_VERSION | ASM_CMPF_MINOR_VERSION) |
  ...
  ASM_CMPF_IL_ALL =
      ...
      ASM_CMPF_CULTURE,
  ASM_CMPF_IL_NO_VERSION = (ASM_CMPF_NAME | ASM_CMPF_PUBLIC_KEY_TOKEN) |
      ASM_CMPF_CULTURE
} ASM_CMP_FLAGS;
DEFINE_GUID(IID_IAssemblyName, 0xcd193bc0, 0xb4bc, 0x11d2, 0x98, 0x33, 0x00,
            0xc0, 0x4f, 0xc3, 0x1d, 0x2e);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("cd193bc0-b4bc-11d2-9833-00c04fc31d2e")
IAssemblyName : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE SetProperty(
      DWORD PropertyId, LPVOID pvProperty, DWORD cbProperty) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetProperty(
      DWORD PropertyId, LPVOID pvProperty, LPDWORD pcbProperty) = 0;
  virtual HRESULT STDMETHODCALLTYPE Finalize() = 0;
  virtual HRESULT STDMETHODCALLTYPE GetDisplayName(
      LPOLESTR szDisplayName, LPDWORD pccDisplayName, DWORD dwDisplayFlags) = 0;
  virtual HRESULT STDMETHODCALLTYPE Reserved(
      REFIID refIID, IUnknown * pUnkReserved1, IUnknown * pUnkReserved2,
      LPCOLESTR szReserved, LONGLONG llReserved, LPVOID pvReserved,
      DWORD cbReserved, LPVOID * ppReserved) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetName(LPDWORD lpcwBuffer,
                                            WCHAR * pwzName) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetVersion(LPDWORD pdwVersionHi,
                                               LPDWORD pdwVersionLow) = 0;
  virtual HRESULT STDMETHODCALLTYPE IsEqual(IAssemblyName * pName,
                                            DWORD dwCmpFlags) = 0;
  virtual HRESULT STDMETHODCALLTYPE Clone(IAssemblyName * *pName) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IAssemblyName, 0xcd193bc0, 0xb4bc, 0x11d2, 0x98, 0x33, 0x00,
                0xc0, 0x4f, 0xc3, 0x1d, 0x2e)
#endif
#else
typedef struct IAssemblyNameVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAssemblyName *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IAssemblyName *This);
  ULONG(STDMETHODCALLTYPE *Release)(IAssemblyName *This);
  /*** IAssemblyName methods ***/
  HRESULT(STDMETHODCALLTYPE *SetProperty)(IAssemblyName *This, DWORD PropertyId,
                                          LPVOID pvProperty, DWORD cbProperty);
  HRESULT(STDMETHODCALLTYPE *GetProperty)(IAssemblyName *This, DWORD PropertyId,
                                          LPVOID pvProperty,
                                          LPDWORD pcbProperty);
  HRESULT(STDMETHODCALLTYPE *Finalize)(IAssemblyName *This);
  HRESULT(STDMETHODCALLTYPE *GetDisplayName)(IAssemblyName *This,
                                             LPOLESTR szDisplayName,
                                             LPDWORD pccDisplayName,
                                             DWORD dwDisplayFlags);
  HRESULT(STDMETHODCALLTYPE *Reserved)(IAssemblyName *This, REFIID refIID,
                                       IUnknown *pUnkReserved1,
                                       IUnknown *pUnkReserved2,
                                       LPCOLESTR szReserved,
                                       LONGLONG llReserved, LPVOID pvReserved,
                                       DWORD cbReserved, LPVOID *ppReserved);
  HRESULT(STDMETHODCALLTYPE *GetName)(IAssemblyName *This, LPDWORD lpcwBuffer,
                                      WCHAR *pwzName);
  HRESULT(STDMETHODCALLTYPE *GetVersion)(IAssemblyName *This,
                                         LPDWORD pdwVersionHi,
                                         LPDWORD pdwVersionLow);
  HRESULT(STDMETHODCALLTYPE *IsEqual)(IAssemblyName *This, IAssemblyName *pName,
                                      DWORD dwCmpFlags);
  HRESULT(STDMETHODCALLTYPE *Clone)(IAssemblyName *This, IAssemblyName **pName);
  END_INTERFACE
} IAssemblyNameVtbl;
interface IAssemblyName { CONST_VTBL IAssemblyNameVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define IAssemblyName_GetDisplayName(This, szDisplayName, pccDisplayName,      \
                                     dwDisplayFlags)                           \
  (This)->lpVtbl->GetDisplayName(This, szDisplayName, pccDisplayName,          \
                                 dwDisplayFlags)
#define IAssemblyName_Reserved(This, refIID, pUnkReserved1, pUnkReserved2,     \
                               szReserved, llReserved, pvReserved, cbReserved, \
                               ppReserved)                                     \
  (This)->lpVtbl->Reserved(This, refIID, pUnkReserved1, pUnkReserved2,         \
                           szReserved, llReserved, pvReserved, cbReserved,     \
                           ppReserved)
...
#else
/*** IUnknown methods ***/
static inline HRESULT IAssemblyName_QueryInterface(IAssemblyName *This,
                                                   REFIID riid,
                                                   void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IAssemblyName methods ***/
static inline HRESULT IAssemblyName_SetProperty(IAssemblyName *This,
                                                DWORD PropertyId,
                                                LPVOID pvProperty,
                                                DWORD cbProperty) {
  return This->lpVtbl->SetProperty(This, PropertyId, pvProperty, cbProperty);
}
static inline HRESULT IAssemblyName_GetProperty(IAssemblyName *This,
                                                DWORD PropertyId,
                                                LPVOID pvProperty,
                                                LPDWORD pcbProperty) {
...
static inline HRESULT IAssemblyName_GetDisplayName(IAssemblyName *This,
                                                   LPOLESTR szDisplayName,
                                                   LPDWORD pccDisplayName,
                                                   DWORD dwDisplayFlags) {
  return This->lpVtbl->GetDisplayName(This, szDisplayName, pccDisplayName,
                                      dwDisplayFlags);
}
static inline HRESULT IAssemblyName_Reserved(
    IAssemblyName *This, REFIID refIID, IUnknown *pUnkReserved1,
    IUnknown *pUnkReserved2, LPCOLESTR szReserved, LONGLONG llReserved,
    LPVOID pvReserved, DWORD cbReserved, LPVOID *ppReserved) {
  return This->lpVtbl->Reserved(This, refIID, pUnkReserved1, pUnkReserved2,
                                szReserved, llReserved, pvReserved, cbReserved,
                                ppReserved);
}
static inline HRESULT
IAssemblyName_GetName(IAssemblyName *This, LPDWORD lpcwBuffer, WCHAR *pwzName) {
  return This->lpVtbl->GetName(This, lpcwBuffer, pwzName);
}
static inline HRESULT IAssemblyName_GetVersion(IAssemblyName *This,
                                               LPDWORD pdwVersionHi,
                                               LPDWORD pdwVersionLow) {
  return This->lpVtbl->GetVersion(This, pdwVersionHi, pdwVersionLow);
}
static inline HRESULT IAssemblyName_IsEqual(IAssemblyName *This,
                                            IAssemblyName *pName,
                                            DWORD dwCmpFlags) {
  return This->lpVtbl->IsEqual(This, pName, dwCmpFlags);
}
static inline HRESULT IAssemblyName_Clone(IAssemblyName *This,
                                          IAssemblyName **pName) {
...
DEFINE_GUID(IID_IAssemblyEnum, 0x21b8916c, 0xf28e, 0x11d2, 0xa4, 0x73, 0x00,
            0xc0, 0x4f, 0x8e, 0xf4, 0x48);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IAssemblyEnum : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetNextAssembly(
      LPVOID pvReserved, IAssemblyName * *ppName, DWORD dwFlags) = 0;
  virtual HRESULT STDMETHODCALLTYPE Reset() = 0;
  virtual HRESULT STDMETHODCALLTYPE Clone(IAssemblyEnum * *ppEnum) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IAssemblyEnum, 0x21b8916c, 0xf28e, 0x11d2, 0xa4, 0x73, 0x00,
                0xc0, 0x4f, 0x8e, 0xf4, 0x48)
#endif
#else
typedef struct IAssemblyEnumVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAssemblyEnum *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IAssemblyEnum *This);
  ULONG(STDMETHODCALLTYPE *Release)(IAssemblyEnum *This);
  /*** IAssemblyEnum methods ***/
  HRESULT(STDMETHODCALLTYPE *GetNextAssembly)(IAssemblyEnum *This,
                                              LPVOID pvReserved,
                                              IAssemblyName **ppName,
                                              DWORD dwFlags);
  HRESULT(STDMETHODCALLTYPE *Reset)(IAssemblyEnum *This);
  HRESULT(STDMETHODCALLTYPE *Clone)(IAssemblyEnum *This,
                                    IAssemblyEnum **ppEnum);
  END_INTERFACE
} IAssemblyEnumVtbl;
interface IAssemblyEnum { CONST_VTBL IAssemblyEnumVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IAssemblyEnum_QueryInterface(IAssemblyEnum *This,
                                                   REFIID riid,
                                                   void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IAssemblyEnum methods ***/
static inline HRESULT IAssemblyEnum_GetNextAssembly(IAssemblyEnum *This,
                                                    LPVOID pvReserved,
                                                    IAssemblyName **ppName,
                                                    DWORD dwFlags) {
...
static inline HRESULT IAssemblyEnum_Clone(IAssemblyEnum *This,
                                          IAssemblyEnum **ppEnum) {
...
DEFINE_GUID(IID_IInstallReferenceItem, 0x582dac66, 0xe678, 0x449f, 0xab, 0xa6,
            0x6f, 0xaa, 0xec, 0x8a, 0x93, 0x94);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("582dac66-e678-449f-aba6-6faaec8a9394")
IInstallReferenceItem : public IUnknown{};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IInstallReferenceItem, 0x582dac66, 0xe678, 0x449f, 0xab, 0xa6,
                0x6f, 0xaa, 0xec, 0x8a, 0x93, 0x94)
#endif
#else
typedef struct IInstallReferenceItemVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IInstallReferenceItem *This,
                                             REFIID riid, void **ppvObject);
...
/*** IUnknown methods ***/
static inline HRESULT
IInstallReferenceItem_QueryInterface(IInstallReferenceItem *This, REFIID riid,
                                     void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
DEFINE_GUID(IID_IInstallReferenceEnum, 0x56b1a988, 0x7c0c, 0x4aa2, 0x86, 0x39,
            0xc3, 0xeb, 0x5a, 0x90, 0x22, 0x6f);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("56b1a988-7c0c-4aa2-8639-c3eb5a90226f")
IInstallReferenceEnum : public IUnknown{};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IInstallReferenceEnum, 0x56b1a988, 0x7c0c, 0x4aa2, 0x86, 0x39,
                0xc3, 0xeb, 0x5a, 0x90, 0x22, 0x6f)
#endif
#else
typedef struct IInstallReferenceEnumVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IInstallReferenceEnum *This,
                                             REFIID riid, void **ppvObject);
...
/*** IUnknown methods ***/
static inline HRESULT
IInstallReferenceEnum_QueryInterface(IInstallReferenceEnum *This, REFIID riid,
                                     void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
HRESULT WINAPI CompareAssemblyIdentity(LPCWSTR, WINBOOL, LPCWSTR, WINBOOL,
                                       WINBOOL *, AssemblyComparisonResult *);
HRESULT WINAPI CreateAssemblyCache(IAssemblyCache **, DWORD);
HRESULT WINAPI CreateAssemblyEnum(IAssemblyEnum **, IUnknown *, IAssemblyName *,
                                  DWORD, LPVOID);
HRESULT WINAPI CreateAssemblyNameObject(LPASSEMBLYNAME *, LPCWSTR, DWORD,
                                        LPVOID);
