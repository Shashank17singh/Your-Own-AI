...
struct _MI_FilterFT {
  MI_Result(MI_CALL *Evaluate)(const MI_Filter *self,
                               const MI_Instance *instance, MI_Boolean *result);
  MI_Result(MI_CALL *GetExpression)(const MI_Filter *self,
...
MI_INLINE MI_Result MI_INLINE_CALL MI_Filter_Evaluate(
    const MI_Filter *self, const MI_Instance *instance, MI_Boolean *result) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL
MI_Filter_GetExpression(const MI_Filter *self, const MI_Char **queryLang,
                        const MI_Char **queryExpr) {
  if (self && self->ft) {
...
struct _MI_PropertySetFT {
  MI_Result(MI_CALL *GetElementCount)(const MI_PropertySet *self,
                                      MI_Uint32 *count);
  MI_Result(MI_CALL *ContainsElement)(const MI_PropertySet *self,
                                      const MI_Char *name, MI_Boolean *flag);
  MI_Result(MI_CALL *AddElement)(MI_PropertySet *self, const MI_Char *name);
  MI_Result(MI_CALL *GetElementAt)(const MI_PropertySet *self, MI_Uint32 index,
                                   const MI_Char **name);
  ...
  MI_Result(MI_CALL *Clone)(const MI_PropertySet *self,
                            MI_PropertySet **newPropertySet);
};
...
MI_INLINE MI_Result MI_INLINE_CALL
MI_PropertySet_GetElementCount(const MI_PropertySet *self, MI_Uint32 *count) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL MI_PropertySet_ContainsElement(
    const MI_PropertySet *self, const MI_Char *name, MI_Boolean *flag) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL
MI_PropertySet_AddElement(MI_PropertySet *self, const MI_Char *name) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL MI_PropertySet_GetElementAt(
    const MI_PropertySet *self, MI_Uint32 index, const MI_Char **name) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL
MI_PropertySet_Destruct(MI_PropertySet *self) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL MI_PropertySet_Clone(
    const MI_PropertySet *self, MI_PropertySet **newPropertySet) {
  if (self && self->ft) {
...
typedef void(MI_CALL *MI_MethodDecl_Invoke)(void *self, MI_Context *context,
...
typedef void(MI_CALL *MI_ProviderFT_Load)(void **self,
...
typedef void(MI_CALL *MI_ProviderFT_GetInstance)(
    void *self, MI_Context *context, const MI_Char *nameSpace,
    const MI_Char *className, const MI_Instance *instanceName,
    const MI_PropertySet *propertySet);
typedef void(MI_CALL *MI_ProviderFT_EnumerateInstances)(
    void *self, MI_Context *context, const MI_Char *nameSpace,
    const MI_Char *className, const MI_PropertySet *propertySet,
    MI_Boolean keysOnly, const MI_Filter *filter);
typedef void(MI_CALL *MI_ProviderFT_CreateInstance)(
    void *self, MI_Context *context, const MI_Char *nameSpace,
    const MI_Char *className, const MI_Instance *newInstance);
typedef void(MI_CALL *MI_ProviderFT_ModifyInstance)(
    void *self, MI_Context *context, const MI_Char *nameSpace,
    const MI_Char *className, const MI_Instance *modifiedInstance,
    const MI_PropertySet *propertySet);
...
typedef void(MI_CALL *MI_ProviderFT_AssociatorInstances)(
    void *self, MI_Context *context, const MI_Char *nameSpace,
    const MI_Char *className, const MI_Instance *instanceName,
    const MI_Char *resultClass, const MI_Char *role, const MI_Char *resultRole,
    const MI_PropertySet *propertySet, MI_Boolean keysOnly,
    const MI_Filter *filter);
typedef void(MI_CALL *MI_ProviderFT_ReferenceInstances)(
    void *self, MI_Context *context, const MI_Char *nameSpace,
    const MI_Char *className, const MI_Instance *instanceName,
    const MI_Char *role, const MI_PropertySet *propertySet, MI_Boolean keysOnly,
    const MI_Filter *filter);
typedef void(MI_CALL *MI_ProviderFT_EnableIndications)(
    void *self, MI_Context *indicationsContext, const MI_Char *nameSpace,
    const MI_Char *className);
...
typedef void(MI_CALL *MI_ProviderFT_Subscribe)(
    void *self, MI_Context *context, const MI_Char *nameSpace,
    const MI_Char *className, const MI_Filter *filter, const MI_Char *bookmark,
    MI_Uint64 subscriptionID, void **subscriptionSelf);
typedef void(MI_CALL *MI_ProviderFT_Unsubscribe)(
    void *self, MI_Context *context, const MI_Char *nameSpace,
    const MI_Char *className, MI_Uint64 subscriptionID, void *subscriptionSelf);
typedef void(MI_CALL *MI_ProviderFT_Invoke)(void *self, MI_Context *context,
                                            const MI_Char *nameSpace,
                                            const MI_Char *className,
                                            const MI_Char *methodName,
                                            const MI_Instance *instanceName,
                                            const MI_Instance *inputParameters);
...
typedef void(MI_CALL *MI_Module_Load)(MI_Module_Self **self,
                                      MI_Context *context);
typedef void(MI_CALL *MI_Module_Unload)(MI_Module_Self *self,
                                        MI_Context *context);
...
struct _MI_InstanceFT {
  ...
  MI_Result(MI_CALL *IsA)(const MI_Instance *self,
                          const MI_ClassDecl *classDecl, MI_Boolean *flag);
  MI_Result(MI_CALL *GetClassName)(const MI_Instance *self,
                                   const MI_Char **className);
  MI_Result(MI_CALL *SetNameSpace)(MI_Instance *self, const MI_Char *nameSpace);
  MI_Result(MI_CALL *GetNameSpace)(const MI_Instance *self,
                                   const MI_Char **nameSpace);
  MI_Result(MI_CALL *GetElementCount)(const MI_Instance *self,
                                      MI_Uint32 *count);
  MI_Result(MI_CALL *AddElement)(MI_Instance *self, const MI_Char *name,
                                 const MI_Value *value, MI_Type type,
                                 MI_Uint32 flags);
  MI_Result(MI_CALL *SetElement)(MI_Instance *self, const MI_Char *name,
                                 const MI_Value *value, MI_Type type,
                                 MI_Uint32 flags);
  MI_Result(MI_CALL *SetElementAt)(MI_Instance *self, MI_Uint32 index,
                                   const MI_Value *value, MI_Type type,
                                   MI_Uint32 flags);
  MI_Result(MI_CALL *GetElement)(const MI_Instance *self, const MI_Char *name,
                                 MI_Value *value, MI_Type *type,
                                 MI_Uint32 *flags, MI_Uint32 *index);
  MI_Result(MI_CALL *GetElementAt)(const MI_Instance *self, MI_Uint32 index,
                                   const MI_Char **name, MI_Value *value,
                                   MI_Type *type, MI_Uint32 *flags);
  ...
  MI_Result(MI_CALL *GetServerName)(const MI_Instance *self,
                                    const MI_Char **name);
  MI_Result(MI_CALL *SetServerName)(MI_Instance *self, const MI_Char *name);
  MI_Result(MI_CALL *GetClass)(const MI_Instance *self,
...
MI_INLINE MI_Result MI_INLINE_CALL
MI_Instance_Clone(const MI_Instance *self, MI_Instance **newInstance) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL MI_Instance_IsA(
    const MI_Instance *self, const MI_ClassDecl *classDecl, MI_Boolean *flag) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL
MI_Instance_GetClassName(const MI_Instance *self, const MI_Char **className) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL
MI_Instance_SetNameSpace(MI_Instance *self, const MI_Char *nameSpace) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL
MI_Instance_GetNameSpace(const MI_Instance *self, const MI_Char **nameSpace) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL
MI_Instance_GetElementCount(const MI_Instance *self, MI_Uint32 *count) {
  if (self && self->ft) {
    return self->ft->GetElementCount(self, count);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
...
MI_INLINE MI_Result MI_INLINE_CALL MI_Instance_AddElement(MI_Instance *self,
                                                          const MI_Char *name,
...
MI_INLINE MI_Result MI_INLINE_CALL
MI_Instance_SetElementAt(MI_Instance *self, MI_Uint32 index,
                         const MI_Value *value, MI_Type type, MI_Uint32 flags) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL MI_Instance_SetElement(MI_Instance *self,
                                                          const MI_Char *name,
                                                          const MI_Value *value,
                                                          MI_Type type,
                                                          MI_Uint32 flags) {
...
MI_INLINE MI_Result MI_INLINE_CALL MI_Instance_GetElement(
    const MI_Instance *self, const MI_Char *name, MI_Value *value,
    MI_Type *type, MI_Uint32 *flags, MI_Uint32 *index) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL MI_Instance_GetElementAt(
    const MI_Instance *self, MI_Uint32 index, const MI_Char **name,
    MI_Value *value, MI_Type *type, MI_Uint32 *flags) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL
MI_Instance_ClearElement(MI_Instance *self, const MI_Char *name) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL MI_Instance_ClearElementAt(MI_Instance *self,
                                                              MI_Uint32 index) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL
MI_Instance_GetServerName(const MI_Instance *self, const MI_Char **name) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL
MI_Instance_SetServerName(MI_Instance *self, const MI_Char *name) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL
MI_Instance_GetClass(const MI_Instance *self, MI_Class **instanceClass) {
  if (self && self->ft) {
...
typedef void(MI_CALL *MI_CancelCallback)(MI_CancellationReason reason,
                                         void *callbackData);
...
struct _MI_ContextFT {
  ...
  MI_Result(MI_CALL *PostInstance)(MI_Context *context,
                                   const MI_Instance *instance);
  MI_Result(MI_CALL *PostIndication)(MI_Context *context,
                                     const MI_Instance *indication,
                                     MI_Uint32 subscriptionIDCount,
                                     const MI_Char *bookmark);
  MI_Result(MI_CALL *ConstructInstance)(MI_Context *context,
                                        const MI_ClassDecl *classDecl,
                                        MI_Instance *instance);
  MI_Result(MI_CALL *ConstructParameters)(MI_Context *context,
                                          const MI_MethodDecl *methodDecl,
                                          MI_Instance *instance);
  MI_Result(MI_CALL *NewInstance)(MI_Context *context,
                                  const MI_ClassDecl *classDecl,
                                  MI_Instance **instance);
  MI_Result(MI_CALL *NewDynamicInstance)(MI_Context *context,
                                         const MI_Char *className,
                                         MI_Uint32 flags,
                                         MI_Instance **instance);
  MI_Result(MI_CALL *NewParameters)(MI_Context *context,
                                    const MI_MethodDecl *methodDecl,
                                    MI_Instance **instance);
  MI_Result(MI_CALL *Canceled)(const MI_Context *context, MI_Boolean *flag);
  MI_Result(MI_CALL *GetLocale)(const MI_Context *context,
                                MI_LocaleType localeType,
                                MI_Char locale[MI_MAX_LOCALE_SIZE]);
  MI_Result(MI_CALL *RegisterCancel)(MI_Context *context,
  ...
  MI_Result(MI_CALL *GetLocalSession)(const MI_Context *context,
                                      MI_Session *session);
  MI_Result(MI_CALL *SetStringOption)(MI_Context *context, const MI_Char *name,
                                      const MI_Char *value);
  MI_Result(MI_CALL *GetStringOption)(MI_Context *context, const MI_Char *name,
                                      const MI_Char **value);
  MI_Result(MI_CALL *GetNumberOption)(MI_Context *context, const MI_Char *name,
                                      MI_Uint32 *value);
  MI_Result(MI_CALL *GetCustomOption)(MI_Context *context, const MI_Char *name,
                                      MI_Type *valueType, MI_Value *value);
  MI_Result(MI_CALL *GetCustomOptionCount)(MI_Context *context,
                                           MI_Uint32 *count);
  MI_Result(MI_CALL *GetCustomOptionAt)(MI_Context *context, MI_Uint32 index,
                                        const MI_Char **name,
                                        MI_Type *valueType, MI_Value *value);
  MI_Result(MI_CALL *WriteMessage)(MI_Context *context, MI_Uint32 channel,
                                   const MI_Char *message);
  MI_Result(MI_CALL *WriteProgress)(MI_Context *context,
                                    const MI_Char *activity,
                                    const MI_Char *currentOperation,
                                    const MI_Char *statusDescription,
                                    MI_Uint32 percentComplete,
                                    MI_Uint32 secondsRemaining);
  MI_Result(MI_CALL *WriteStreamParameter)(MI_Context *context,
                                           const MI_Char *name,
                                           const MI_Value *value, MI_Type type,
                                           MI_Uint32 flags);
  MI_Result(MI_CALL *WriteCimError)(MI_Context *context,
                                    const MI_Instance *error, MI_Boolean *flag);
  MI_Result(MI_CALL *PromptUser)(MI_Context *context, const MI_Char *message,
                                 MI_PromptType promptType, MI_Boolean *result);
  MI_Result(MI_CALL *ShouldProcess)(MI_Context *context, const MI_Char *target,
                                    const MI_Char *action, MI_Boolean *result);
  MI_Result(MI_CALL *ShouldContinue)(MI_Context *context,
                                     const MI_Char *message,
                                     MI_Boolean *result);
  MI_Result(MI_CALL *PostError)(MI_Context *context, MI_Uint32 resultCode,
                                const MI_Char *resultType,
                                const MI_Char *errorMessage);
  MI_Result(MI_CALL *PostCimError)(MI_Context *context,
                                   const MI_Instance *error);
  MI_Result(MI_CALL *WriteError)(MI_Context *context, MI_Uint32 resultCode,
                                 const MI_Char *resultType,
                                 const MI_Char *errorMessage, MI_Boolean *flag);
};
struct _MI_Context {
  const MI_ContextFT *ft;
  ptrdiff_t reserved[3];
};
MI_INLINE MI_Result MI_INLINE_CALL MI_Context_PostResult(MI_Context *context,
                                                         MI_Result result) {
...
MI_INLINE MI_Result MI_INLINE_CALL
MI_Context_PostCimError(MI_Context *context, const MI_Instance *error) {
  if (context && context->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL
MI_Context_PostError(MI_Context *context, MI_Uint32 resultCode,
                     const MI_Char *resultType, const MI_Char *errorMessage) {
  if (context && context->ft) {
    return context->ft->PostError(context, resultCode, resultType,
                                  errorMessage);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
...
MI_INLINE MI_Result MI_INLINE_CALL
MI_Context_PostInstance(MI_Context *context, const MI_Instance *instance) {
  if (context && context->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL MI_Context_PostIndication(
    MI_Context *context, const MI_Instance *indication,
    MI_Uint32 subscriptionIDCount, const MI_Char *bookmark) {
  if (context && context->ft) {
    return context->ft->PostIndication(context, indication, subscriptionIDCount,
                                       bookmark);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
...
MI_INLINE MI_Result MI_INLINE_CALL MI_Context_ConstructInstance(
    MI_Context *context, const MI_ClassDecl *classDecl, MI_Instance *instance) {
  if (context && context->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL MI_Context_ConstructParameters(
    MI_Context *context, const MI_MethodDecl *methodDecl,
    MI_Instance *instance) {
  if (context && context->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL
MI_Context_NewInstance(MI_Context *context, const MI_ClassDecl *classDecl,
                       MI_Instance **instance) {
  if (context && context->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL
MI_Context_NewDynamicInstance(MI_Context *context, const MI_Char *className,
                              MI_Uint32 flags, MI_Instance **instance) {
  if (context && context->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL
MI_Context_NewParameters(MI_Context *context, const MI_MethodDecl *methodDecl,
                         MI_Instance **instance) {
  if (context && context->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL
MI_Context_Canceled(const MI_Context *context, MI_Boolean *flag) {
  if (context && context->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL
MI_Context_GetLocale(const MI_Context *context, MI_LocaleType localeType,
                     MI_Char locale[MI_MAX_LOCALE_SIZE]) {
  if (locale) {
    locale[0] = L'\0';
  }
...
MI_INLINE MI_Result MI_INLINE_CALL MI_Context_RegisterCancel(
    MI_Context *context, MI_CancelCallback callback, void *callbackData) {
  if (context && context->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL
MI_Context_RequestUnload(MI_Context *context) {
  if (context && context->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL
MI_Context_RefuseUnload(MI_Context *context) {
  if (context && context->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL
MI_Context_GetLocalSession(const MI_Context *context, MI_Session *session) {
  if (context && context->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL MI_Context_SetStringOption(
    MI_Context *context, const MI_Char *name, const MI_Char *value) {
  if (context && context->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL MI_Context_GetNumberOption(
    MI_Context *context, const MI_Char *name, MI_Uint32 *value) {
  if (context && context->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL
MI_Context_GetCustomOption(MI_Context *context, const MI_Char *name,
                           MI_Type *valueType, MI_Value *value) {
  if (context && context->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL
MI_Context_GetCustomOptionCount(MI_Context *context, MI_Uint32 *count) {
  if (context && context->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL MI_Context_GetCustomOptionAt(
    MI_Context *context, MI_Uint32 index, const MI_Char **name,
    MI_Type *valueType, MI_Value *value) {
  if (context && context->ft) {
    return context->ft->GetCustomOptionAt(context, index, name, valueType,
                                          value);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
...
MI_INLINE MI_Result MI_INLINE_CALL
MI_Context_ShouldProcess(MI_Context *context, const MI_Char *target,
                         const MI_Char *action, MI_Boolean *flag) {
  if (context && context->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL MI_Context_ShouldContinue(
    MI_Context *context, const MI_Char *message, MI_Boolean *flag) {
  if (context && context->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL
MI_Context_PromptUser(MI_Context *context, const MI_Char *message,
                      MI_PromptType promptType, MI_Boolean *flag) {
  if (context && context->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL MI_Context_WriteError(
    MI_Context *context, MI_Uint32 resultCode, const MI_Char *resultType,
    const MI_Char *errorMessage, MI_Boolean *flag) {
  if (context && context->ft) {
    return context->ft->WriteError(context, resultCode, resultType,
                                   errorMessage, flag);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
...
MI_INLINE MI_Result MI_INLINE_CALL MI_Context_WriteCimError(
    MI_Context *context, const MI_Instance *error, MI_Boolean *flag) {
  if (context && context->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL MI_Context_WriteMessage(
    MI_Context *context, MI_Uint32 channel, const MI_Char *message) {
  if (context && context->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL MI_Context_WriteProgress(
    MI_Context *context, const MI_Char *activity,
    const MI_Char *currentOperation, const MI_Char *statusDescription,
    MI_Uint32 percentComplete, MI_Uint32 secondsRemaining) {
  if (context && context->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL MI_Context_WriteStreamParameter(
    MI_Context *self, const MI_Char *name, const MI_Value *value, MI_Type type,
    MI_Uint32 flags) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL
MI_Context_WriteWarning(MI_Context *context, const MI_Char *message) {
  if (context && context->ft) {
    return context->ft->WriteMessage(context, MI_WRITEMESSAGE_CHANNEL_WARNING,
                                     message);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
...
MI_INLINE MI_Result MI_INLINE_CALL
MI_Context_WriteVerbose(MI_Context *context, const MI_Char *message) {
  if (context && context->ft) {
    return context->ft->WriteMessage(context, MI_WRITEMESSAGE_CHANNEL_VERBOSE,
                                     message);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
...
MI_INLINE MI_Result MI_INLINE_CALL
MI_Context_WriteDebug(MI_Context *context, const MI_Char *message) {
  if (context && context->ft) {
    return context->ft->WriteMessage(context, MI_WRITEMESSAGE_CHANNEL_DEBUG,
                                     message);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
...
#error                                                                         \
    "Unsupported version of MI_CALL_VERSION. This SDK only supports version 1."
#endif
#ifdef __cplusplus
extern "C" {
#endif
...
typedef struct _MI_QualifierSetFT {
  MI_Result(MI_CALL *GetQualifierCount)(const MI_QualifierSet *self,
                                        MI_Uint32 *count);
  MI_Result(MI_CALL *GetQualifierAt)(const MI_QualifierSet *self,
                                     MI_Uint32 index, const MI_Char **name,
                                     MI_Type *qualifierType,
                                     MI_Uint32 *qualifierFlags,
                                     MI_Value *qualifierValue);
  MI_Result(MI_CALL *GetQualifier)(const MI_QualifierSet *self,
                                   const MI_Char *name, MI_Type *qualifierType,
                                   MI_Uint32 *qualifierFlags,
                                   MI_Value *qualifierValue, MI_Uint32 *index);
} MI_QualifierSetFT;
...
typedef struct _MI_ParameterSetFT {
  MI_Result(MI_CALL *GetMethodReturnType)(const MI_ParameterSet *self,
                                          MI_Type *returnType,
                                          MI_QualifierSet *qualifierSet);
  MI_Result(MI_CALL *GetParameterCount)(const MI_ParameterSet *self,
                                        MI_Uint32 *count);
  MI_Result(MI_CALL *GetParameterAt)(const MI_ParameterSet *self,
                                     MI_Uint32 index, const MI_Char **name,
                                     MI_Type *parameterType,
                                     MI_Char **referenceClass,
                                     MI_QualifierSet *qualifierSet);
  MI_Result(MI_CALL *GetParameter)(const MI_ParameterSet *self,
                                   const MI_Char *name, MI_Type *parameterType,
                                   MI_Char **referenceClass,
                                   MI_QualifierSet *qualifierSet,
                                   MI_Uint32 *index);
} MI_ParameterSetFT;
...
typedef struct _MI_ClassFT {
  MI_Result(MI_CALL *GetClassName)(const MI_Class *self,
                                   const MI_Char **className);
  MI_Result(MI_CALL *GetNameSpace)(const MI_Class *self,
                                   const MI_Char **nameSpace);
  MI_Result(MI_CALL *GetServerName)(const MI_Class *self,
                                    const MI_Char **serverName);
  MI_Result(MI_CALL *GetElementCount)(const MI_Class *self, MI_Uint32 *count);
  MI_Result(MI_CALL *GetElement)(const MI_Class *self, const MI_Char *name,
                                 MI_Value *value, MI_Boolean *valueExists,
                                 MI_Type *type, MI_Char **referenceClass,
                                 MI_QualifierSet *qualifierSet,
                                 MI_Uint32 *flags, MI_Uint32 *index);
  MI_Result(MI_CALL *GetElementAt)(const MI_Class *self, MI_Uint32 index,
                                   const MI_Char **name, MI_Value *value,
                                   MI_Boolean *valueExists, MI_Type *type,
                                   MI_Char **referenceClass,
                                   MI_QualifierSet *qualifierSet,
                                   MI_Uint32 *flags);
  MI_Result(MI_CALL *GetClassQualifierSet)(const MI_Class *self,
                                           MI_QualifierSet *qualifierSet);
  MI_Result(MI_CALL *GetMethodCount)(const MI_Class *self, MI_Uint32 *count);
  MI_Result(MI_CALL *GetMethodAt)(const MI_Class *self, MI_Uint32 index,
                                  const MI_Char **name,
                                  MI_QualifierSet *qualifierSet,
                                  MI_ParameterSet *parameterSet);
  MI_Result(MI_CALL *GetMethod)(const MI_Class *self, const MI_Char *name,
                                MI_QualifierSet *qualifierSet,
                                MI_ParameterSet *parameterSet,
                                MI_Uint32 *index);
  MI_Result(MI_CALL *GetParentClassName)(const MI_Class *self,
                                         const MI_Char **name);
  MI_Result(MI_CALL *GetParentClass)(const MI_Class *self,
...
typedef void(MI_CALL *MI_OperationCallback_PromptUser)(
    MI_Operation *operation, void *callbackContext, const MI_Char *message,
    MI_PromptType promptType,
    MI_Result(MI_CALL *promptUserResult)(
        MI_Operation *operation, MI_OperationCallback_ResponseType response));
typedef void(MI_CALL *MI_OperationCallback_WriteError)(
    MI_Operation *operation, void *callbackContext, MI_Instance *instance,
    MI_Result(MI_CALL *writeErrorResult)(
        MI_Operation *operation, MI_OperationCallback_ResponseType response));
#define MI_WRITEMESSAGE_CHANNEL_WARNING 0
#define MI_WRITEMESSAGE_CHANNEL_VERBOSE 1
#define MI_WRITEMESSAGE_CHANNEL_DEBUG 2
typedef void(MI_CALL *MI_OperationCallback_WriteMessage)(
    MI_Operation *operation, void *callbackContext, MI_Uint32 channel,
    const MI_Char *message);
typedef void(MI_CALL *MI_OperationCallback_WriteProgress)(
    MI_Operation *operation, void *callbackContext, const MI_Char *activity,
    const MI_Char *currentOperation, const MI_Char *statusDescription,
    MI_Uint32 percentageComplete, MI_Uint32 secondsRemaining);
typedef void(MI_CALL *MI_OperationCallback_Instance)(
    MI_Operation *operation, void *callbackContext, const MI_Instance *instance,
    MI_Boolean moreResults, MI_Result resultCode, const MI_Char *errorString,
...
typedef void(MI_CALL *MI_OperationCallback_StreamedParameter)(
    MI_Operation *operation, void *callbackContext,
    const MI_Char *parameterName, MI_Type resultType, const MI_Value *result,
    MI_Result(MI_CALL *resultAcknowledgement)(MI_Operation *operation));
typedef void(MI_CALL *MI_OperationCallback_Indication)(
    MI_Operation *operation, void *callbackContext, const MI_Instance *instance,
    const MI_Char *bookmark, const MI_Char *machineID, MI_Boolean moreResults,
    MI_Result resultCode, const MI_Char *errorString,
    const MI_Instance *errorDetails,
    MI_Result(MI_CALL *resultAcknowledgement)(MI_Operation *operation));
typedef void(MI_CALL *MI_OperationCallback_Class)(
    MI_Operation *operation, void *callbackContext, const MI_Class *classResult,
    MI_Boolean moreResults, MI_Result resultCode, const MI_Char *errorString,
    const MI_Instance *errorDetails,
    MI_Result(MI_CALL *resultAcknowledgement)(MI_Operation *operation));
...
typedef struct _MI_SessionCallbacks {
  void *callbackContext;
  void(MI_CALL *writeMessage)(MI_Application *application,
                              void *callbackContext, MI_Uint32 channel,
                              const MI_Char *message);
  void(MI_CALL *writeError)(MI_Application *application, void *callbackContext,
                            MI_Instance *instance);
} MI_SessionCallbacks;
...
typedef struct _MI_SubscriptionDeliveryOptionsFT {
  MI_Result(MI_CALL *SetString)(MI_SubscriptionDeliveryOptions *options,
                                const MI_Char *optionName, const MI_Char *value,
                                MI_Uint32 flags);
  MI_Result(MI_CALL *SetNumber)(MI_SubscriptionDeliveryOptions *options,
                                const MI_Char *optionName, MI_Uint32 value,
                                MI_Uint32 flags);
  MI_Result(MI_CALL *SetDateTime)(MI_SubscriptionDeliveryOptions *options,
                                  const MI_Char *optionName,
                                  const MI_Datetime *value, MI_Uint32 flags);
  MI_Result(MI_CALL *SetInterval)(MI_SubscriptionDeliveryOptions *options,
                                  const MI_Char *optionName,
                                  const MI_Interval *value, MI_Uint32 flags);
  MI_Result(MI_CALL *AddCredentials)(MI_SubscriptionDeliveryOptions *options,
                                     const MI_Char *optionName,
                                     const MI_UserCredentials *credentials,
                                     MI_Uint32 flags);
  MI_Result(MI_CALL *Delete)(MI_SubscriptionDeliveryOptions *self);
  MI_Result(MI_CALL *GetString)(MI_SubscriptionDeliveryOptions *options,
                                const MI_Char *optionName,
                                const MI_Char **value, MI_Uint32 *index,
                                MI_Uint32 *flags);
  MI_Result(MI_CALL *GetNumber)(MI_SubscriptionDeliveryOptions *options,
                                const MI_Char *optionName, MI_Uint32 *value,
                                MI_Uint32 *index, MI_Uint32 *flags);
  MI_Result(MI_CALL *GetDateTime)(MI_SubscriptionDeliveryOptions *options,
                                  const MI_Char *optionName, MI_Datetime *value,
                                  MI_Uint32 *index, MI_Uint32 *flags);
  MI_Result(MI_CALL *GetInterval)(MI_SubscriptionDeliveryOptions *options,
                                  const MI_Char *optionName, MI_Interval *value,
                                  MI_Uint32 *index, MI_Uint32 *flags);
  MI_Result(MI_CALL *GetOptionCount)(MI_SubscriptionDeliveryOptions *options,
                                     MI_Uint32 *count);
  MI_Result(MI_CALL *GetOptionAt)(MI_SubscriptionDeliveryOptions *options,
                                  MI_Uint32 index, const MI_Char **optionName,
                                  MI_Value *value, MI_Type *type,
                                  MI_Uint32 *flags);
  MI_Result(MI_CALL *GetOption)(MI_SubscriptionDeliveryOptions *options,
                                const MI_Char *optionName, MI_Value *value,
                                MI_Type *type, MI_Uint32 *index,
                                MI_Uint32 *flags);
  MI_Result(MI_CALL *GetCredentialsCount)(
      MI_SubscriptionDeliveryOptions *options, MI_Uint32 *count);
  MI_Result(MI_CALL *GetCredentialsAt)(MI_SubscriptionDeliveryOptions *options,
                                       MI_Uint32 index,
                                       const MI_Char **optionName,
                                       MI_UserCredentials *credentials,
                                       MI_Uint32 *flags);
  MI_Result(MI_CALL *GetCredentialsPasswordAt)(
      MI_SubscriptionDeliveryOptions *options, MI_Uint32 index,
      const MI_Char **optionName, MI_Char *password, MI_Uint32 bufferLength,
      MI_Uint32 *passwordLength, MI_Uint32 *flags);
  MI_Result(MI_CALL *Clone)(
      const MI_SubscriptionDeliveryOptions *self,
...
struct _MI_SerializerFT {
  ...
  MI_Result(MI_CALL *SerializeClass)(MI_Serializer *serializer, MI_Uint32 flags,
                                     const MI_Class *classObject,
                                     MI_Uint8 *clientBuffer,
                                     MI_Uint32 clientBufferLength,
                                     MI_Uint32 *clientBufferNeeded);
  MI_Result(MI_CALL *SerializeInstance)(MI_Serializer *serializer,
                                        MI_Uint32 flags,
                                        const MI_Instance *instanceObject,
                                        MI_Uint8 *clientBuffer,
                                        MI_Uint32 clientBufferLength,
                                        MI_Uint32 *clientBufferNeeded);
};
typedef MI_Result(MI_CALL *MI_Deserializer_ClassObjectNeeded)(
    void *context, const MI_Char *serverName, const MI_Char *namespaceName,
    const MI_Char *className, MI_Class **requestedClassObject);
struct _MI_DeserializerFT {
  MI_Result(MI_CALL *Close)(MI_Deserializer *deserializer);
  MI_Result(MI_CALL *DeserializeClass)(
      MI_Deserializer *deserializer, MI_Uint32 flags,
      MI_Uint8 *serializedBuffer, MI_Uint32 serializedBufferLength,
      MI_Class *parentClass, const MI_Char *serverName,
      const MI_Char *namespaceName,
      MI_Deserializer_ClassObjectNeeded classObjectNeeded,
      void *classObjectNeededContext, MI_Uint32 *serializedBufferRead,
      MI_Class **classObject, MI_Instance **cimErrorDetails);
  MI_Result(MI_CALL *Class_GetClassName)(MI_Deserializer *deserializer,
                                         MI_Uint8 *serializedBuffer,
                                         MI_Uint32 serializedBufferLength,
                                         MI_Char *className,
                                         MI_Uint32 *classNameLength,
                                         MI_Instance **cimErrorDetails);
  MI_Result(MI_CALL *Class_GetParentClassName)(MI_Deserializer *deserializer,
                                               MI_Uint8 *serializedBuffer,
                                               MI_Uint32 serializedBufferLength,
                                               MI_Char *parentClassName,
                                               MI_Uint32 *parentClassNameLength,
                                               MI_Instance **cimErrorDetails);
  MI_Result(MI_CALL *DeserializeInstance)(
      MI_Deserializer *deserializer, MI_Uint32 flags,
      MI_Uint8 *serializedBuffer, MI_Uint32 serializedBufferLength,
      MI_Class **classObjects, MI_Uint32 numberClassObjects,
      MI_Deserializer_ClassObjectNeeded classObjectNeeded,
      void *classObjectNeededContext, MI_Uint32 *serializedBufferRead,
      MI_Instance **instanceObject, MI_Instance **cimErrorDetails);
  MI_Result(MI_CALL *Instance_GetClassName)(MI_Deserializer *deserializer,
                                            MI_Uint8 *serializedBuffer,
                                            MI_Uint32 serializedBufferLength,
                                            MI_Char *className,
                                            MI_Uint32 *classNameLength,
...
typedef struct _MI_ApplicationFT {
  ...
  MI_Result(MI_CALL *NewSession)(MI_Application *application,
                                 ...
                                 MI_Session *session);
  MI_Result(MI_CALL *NewHostedProvider)(MI_Application *application,
                                        const MI_Char *namespaceName,
                                        const MI_Char *providerName,
                                        MI_MainFunction mi_Main,
                                        MI_Instance **extendedError,
                                        MI_HostedProvider *provider);
  MI_Result(MI_CALL *NewInstance)(MI_Application *application,
                                  const MI_Char *className,
                                  const MI_ClassDecl *classRTTI,
                                  MI_Instance **instance);
  MI_Result(MI_CALL *NewDestinationOptions)(MI_Application *application,
                                            MI_DestinationOptions *options);
  MI_Result(MI_CALL *NewOperationOptions)(
      MI_Application *application, MI_Boolean customOptionsMustUnderstand,
      MI_OperationOptions *options);
  MI_Result(MI_CALL *NewSubscriptionDeliveryOptions)(
      MI_Application *application, MI_SubscriptionDeliveryType deliveryType,
      MI_SubscriptionDeliveryOptions *deliveryOptions);
  MI_Result(MI_CALL *NewSerializer)(MI_Application *application,
                                    MI_Uint32 flags, MI_Char *format,
                                    MI_Serializer *serializer);
  MI_Result(MI_CALL *NewDeserializer)(MI_Application *application,
                                      MI_Uint32 flags, MI_Char *format,
                                      MI_Deserializer *deserializer);
  MI_Result(MI_CALL *NewInstanceFromClass)(MI_Application *application,
                                           const MI_Char *className,
                                           const MI_Class *classObject,
                                           MI_Instance **instance);
  MI_Result(MI_CALL *NewClass)(MI_Application *application,
                               const MI_ClassDecl *classDecl,
                               const MI_Char *namespaceName,
                               const MI_Char *serverName,
...
typedef struct _MI_HostedProviderFT {
  ...
  MI_Result(MI_CALL *GetApplication)(MI_HostedProvider *hostedProvider,
                                     MI_Application *application);
} MI_HostedProviderFT;
typedef struct _MI_SessionFT {
  MI_Result(MI_CALL *Close)(
      MI_Session *session, void *completionContext,
      void(MI_CALL *completionCallback)(void *completionContext));
  MI_Result(MI_CALL *GetApplication)(MI_Session *session,
                                     MI_Application *application);
  void(MI_CALL *GetInstance)(MI_Session *session, MI_Uint32 flags,
                             MI_OperationOptions *options,
                             const MI_Char *namespaceName,
                             const MI_Instance *inboundInstance,
                             MI_OperationCallbacks *callbacks,
                             MI_Operation *operation);
  void(MI_CALL *ModifyInstance)(MI_Session *session, MI_Uint32 flags,
                                MI_OperationOptions *options,
                                const MI_Char *namespaceName,
                                const MI_Instance *inboundInstance,
                                MI_OperationCallbacks *callbacks,
                                MI_Operation *operation);
  void(MI_CALL *CreateInstance)(MI_Session *session, MI_Uint32 flags,
                                MI_OperationOptions *options,
                                const MI_Char *namespaceName,
                                const MI_Instance *inboundInstance,
                                MI_OperationCallbacks *callbacks,
                                MI_Operation *operation);
  void(MI_CALL *DeleteInstance)(MI_Session *session, MI_Uint32 flags,
                                MI_OperationOptions *options,
                                const MI_Char *namespaceName,
                                const MI_Instance *inboundInstance,
                                MI_OperationCallbacks *callbacks,
                                MI_Operation *operation);
  void(MI_CALL *Invoke)(MI_Session *session, MI_Uint32 flags,
                        MI_OperationOptions *options,
                        const MI_Char *namespaceName, const MI_Char *className,
                        const MI_Char *methodName,
                        const MI_Instance *inboundInstance,
                        const MI_Instance *inboundProperties,
                        MI_OperationCallbacks *callbacks,
                        MI_Operation *operation);
  void(MI_CALL *EnumerateInstances)(MI_Session *session, MI_Uint32 flags,
                                    MI_OperationOptions *options,
                                    const MI_Char *namespaceName,
                                    const MI_Char *className,
                                    MI_Boolean keysOnly,
                                    MI_OperationCallbacks *callbacks,
                                    MI_Operation *operation);
  void(MI_CALL *QueryInstances)(MI_Session *session, MI_Uint32 flags,
                                MI_OperationOptions *options,
                                const MI_Char *namespaceName,
  ...
  void(MI_CALL *AssociatorInstances)(
      MI_Session *session, MI_Uint32 flags, MI_OperationOptions *options,
      const MI_Char *namespaceName, const MI_Instance *instanceKeys,
      const MI_Char *assocClass, const MI_Char *resultClass,
      const MI_Char *role, const MI_Char *resultRole, MI_Boolean keysOnly,
      MI_OperationCallbacks *callbacks, MI_Operation *operation);
  void(MI_CALL *ReferenceInstances)(
      MI_Session *session, MI_Uint32 flags, MI_OperationOptions *options,
      const MI_Char *namespaceName, const MI_Instance *instanceKeys,
      const MI_Char *resultClass, const MI_Char *role, MI_Boolean keysOnly,
      MI_OperationCallbacks *callbacks, MI_Operation *operation);
  void(MI_CALL *Subscribe)(MI_Session *session, MI_Uint32 flags,
                           MI_OperationOptions *options,
                           const MI_Char *namespaceName,
                           const MI_Char *queryDialect,
                           const MI_Char *queryExpression,
                           ...
                           MI_OperationCallbacks *callbacks,
                           MI_Operation *operation);
  void(MI_CALL *GetClass)(MI_Session *session, MI_Uint32 flags,
                          MI_OperationOptions *options,
                          const MI_Char *namespaceName,
                          const MI_Char *className,
                          MI_OperationCallbacks *callbacks,
                          MI_Operation *operation);
  void(MI_CALL *EnumerateClasses)(MI_Session *session, MI_Uint32 flags,
                                  MI_OperationOptions *options,
                                  const MI_Char *namespaceName,
                                  const MI_Char *className,
                                  ...
                                  MI_OperationCallbacks *callbacks,
                                  MI_Operation *operation);
  void(MI_CALL *TestConnection)(MI_Session *session, MI_Uint32 flags,
                                MI_OperationCallbacks *callbacks,
                                MI_Operation *operation);
} MI_SessionFT;
typedef struct _MI_OperationFT {
  MI_Result(MI_CALL *Close)(MI_Operation *operation);
  MI_Result(MI_CALL *Cancel)(MI_Operation *operation,
                             MI_CancellationReason reason);
  MI_Result(MI_CALL *GetSession)(MI_Operation *operation, MI_Session *session);
  MI_Result(MI_CALL *GetInstance)(MI_Operation *operation,
                                  const MI_Instance **instance,
                                  MI_Boolean *moreResults, MI_Result *result,
                                  const MI_Char **errorMessage,
                                  const MI_Instance **completionDetails);
  MI_Result(MI_CALL *GetIndication)(MI_Operation *operation,
                                    const MI_Instance **instance,
                                    const MI_Char **bookmark,
                                    ...
                                    const MI_Char **errorMessage,
                                    const MI_Instance **completionDetails);
  MI_Result(MI_CALL *GetClass)(MI_Operation *operation,
...
typedef struct _MI_DestinationOptionsFT {
  ...
  MI_Result(MI_CALL *SetString)(MI_DestinationOptions *options,
                                const MI_Char *optionName, const MI_Char *value,
                                MI_Uint32 flags);
  MI_Result(MI_CALL *SetNumber)(MI_DestinationOptions *options,
                                const MI_Char *optionName, MI_Uint32 value,
                                MI_Uint32 flags);
  MI_Result(MI_CALL *AddCredentials)(MI_DestinationOptions *options,
                                     const MI_Char *optionName,
                                     const MI_UserCredentials *credentials,
                                     MI_Uint32 flags);
  MI_Result(MI_CALL *GetString)(MI_DestinationOptions *options,
                                const MI_Char *optionName,
                                const MI_Char **value, MI_Uint32 *index,
                                MI_Uint32 *flags);
  MI_Result(MI_CALL *GetNumber)(MI_DestinationOptions *options,
                                const MI_Char *optionName, MI_Uint32 *value,
                                MI_Uint32 *index, MI_Uint32 *flags);
  MI_Result(MI_CALL *GetOptionCount)(MI_DestinationOptions *options,
                                     MI_Uint32 *count);
  MI_Result(MI_CALL *GetOptionAt)(MI_DestinationOptions *options,
                                  MI_Uint32 index, const MI_Char **optionName,
                                  MI_Value *value, MI_Type *type,
                                  MI_Uint32 *flags);
  MI_Result(MI_CALL *GetOption)(MI_DestinationOptions *options,
                                const MI_Char *optionName, MI_Value *value,
                                MI_Type *type, MI_Uint32 *index,
                                MI_Uint32 *flags);
  MI_Result(MI_CALL *GetCredentialsCount)(MI_DestinationOptions *options,
                                          MI_Uint32 *count);
  MI_Result(MI_CALL *GetCredentialsAt)(MI_DestinationOptions *options,
                                       MI_Uint32 index,
                                       const MI_Char **optionName,
                                       MI_UserCredentials *credentials,
                                       MI_Uint32 *flags);
  MI_Result(MI_CALL *GetCredentialsPasswordAt)(
      MI_DestinationOptions *options, MI_Uint32 index,
      const MI_Char **optionName, MI_Char *password, MI_Uint32 bufferLength,
      MI_Uint32 *passwordLength, MI_Uint32 *flags);
  MI_Result(MI_CALL *Clone)(const MI_DestinationOptions *self,
                            MI_DestinationOptions *newDestinationOptions);
  MI_Result(MI_CALL *SetInterval)(MI_DestinationOptions *options,
                                  const MI_Char *optionName,
                                  const MI_Interval *value, MI_Uint32 flags);
  MI_Result(MI_CALL *GetInterval)(MI_DestinationOptions *options,
                                  const MI_Char *optionName, MI_Interval *value,
                                  MI_Uint32 *index, MI_Uint32 *flags);
} MI_DestinationOptionsFT;
typedef struct _MI_OperationOptionsFT {
  void(MI_CALL *Delete)(MI_OperationOptions *options);
  MI_Result(MI_CALL *SetString)(MI_OperationOptions *options,
                                const MI_Char *optionName, const MI_Char *value,
                                MI_Uint32 flags);
  MI_Result(MI_CALL *SetNumber)(MI_OperationOptions *options,
                                const MI_Char *optionName, MI_Uint32 value,
                                MI_Uint32 flags);
  MI_Result(MI_CALL *SetCustomOption)(MI_OperationOptions *options,
                                      const MI_Char *optionName,
                                      MI_Type valueType, const MI_Value *value,
                                      MI_Boolean mustComply, MI_Uint32 flags);
  MI_Result(MI_CALL *GetString)(MI_OperationOptions *options,
                                const MI_Char *optionName,
                                const MI_Char **value, MI_Uint32 *index,
                                MI_Uint32 *flags);
  MI_Result(MI_CALL *GetNumber)(MI_OperationOptions *options,
                                const MI_Char *optionName, MI_Uint32 *value,
                                MI_Uint32 *index, MI_Uint32 *flags);
  MI_Result(MI_CALL *GetOptionCount)(MI_OperationOptions *options,
                                     MI_Uint32 *count);
  MI_Result(MI_CALL *GetOptionAt)(MI_OperationOptions *options, MI_Uint32 index,
                                  const MI_Char **optionName, MI_Value *value,
                                  MI_Type *type, MI_Uint32 *flags);
  MI_Result(MI_CALL *GetOption)(MI_OperationOptions *options,
                                const MI_Char *optionName, MI_Value *value,
                                MI_Type *type, MI_Uint32 *index,
                                MI_Uint32 *flags);
  MI_Result(MI_CALL *GetEnabledChannels)(MI_OperationOptions *options,
                                         const MI_Char *optionName,
                                         MI_Uint32 *channels,
                                         MI_Uint32 bufferLength,
                                         MI_Uint32 *channelCount,
                                         MI_Uint32 *flags);
  MI_Result(MI_CALL *Clone)(const MI_OperationOptions *self,
                            MI_OperationOptions *newOperationOptions);
  MI_Result(MI_CALL *SetInterval)(MI_OperationOptions *options,
                                  const MI_Char *optionName,
                                  const MI_Interval *value, MI_Uint32 flags);
  MI_Result(MI_CALL *GetInterval)(MI_OperationOptions *options,
                                  const MI_Char *optionName, MI_Interval *value,
                                  MI_Uint32 *index, MI_Uint32 *flags);
...
typedef struct _MI_UtilitiesFT {
  MI_ErrorCategory(MI_CALL *MapErrorToMiErrorCategory)(MI_Char *errorType,
                                                       MI_Uint32 error);
  MI_Result(MI_CALL *CimErrorFromErrorCode)(MI_Uint32 error,
...
#endif
MI_Result MI_MAIN_CALL MI_Application_InitializeV1(MI_Uint32 flags,
...
MI_INLINE MI_Result MI_Application_NewInstance(MI_Application *application,
                                               const MI_Char *className,
                                               const MI_ClassDecl *classRTTI,
                                               MI_Instance **instance) {
  if (application && application->ft) {
    return application->ft->NewInstance(application, className, classRTTI,
                                        instance);
  } else {
    if (instance) {
      *instance = NULL;
...
MI_INLINE MI_Result MI_Application_NewInstanceFromClass(
    MI_Application *application, const MI_Char *className,
    const MI_Class *classObject, MI_Instance **instance) {
  if (application && application->ft) {
    return application->ft->NewInstanceFromClass(application, className,
...
MI_INLINE MI_Result MI_Application_NewClass(MI_Application *application,
                                            const MI_ClassDecl *classDecl,
                                            const MI_Char *namespaceName,
                                            const MI_Char *serverName,
                                            MI_Class **classObject) {
...
MI_INLINE MI_Result MI_Application_NewParameterSet(
    MI_Application *application, const MI_ClassDecl *classRTTI,
    MI_Instance **instance) {
  if (application && application->ft) {
    return application->ft->NewInstance(application, MI_T("Parameters"),
                                        classRTTI, instance);
  } else {
    if (instance) {
      *instance = NULL;
...
MI_INLINE MI_Result MI_Application_NewDestinationOptions(
    MI_Application *application, MI_DestinationOptions *options) {
  if (application && application->ft) {
...
MI_INLINE MI_Result MI_Application_NewOperationOptions(
    MI_Application *application, MI_Boolean mustUnderstand,
    MI_OperationOptions *options) {
  if (application && application->ft) {
    return application->ft->NewOperationOptions(application, mustUnderstand,
                                                options);
  } else {
    if (options) {
...
MI_INLINE MI_Result MI_Application_NewSubscriptionDeliveryOptions(
    ...
    MI_SubscriptionDeliveryOptions *deliveryOptions) {
  if (application && application->ft) {
    return application->ft->NewSubscriptionDeliveryOptions(
        application, deliveryType, deliveryOptions);
  } else {
    if (deliveryOptions) {
...
MI_INLINE MI_Result MI_Application_NewSession(MI_Application *application,
                                              const MI_Char *protocol,
                                              const MI_Char *destination,
                                              MI_DestinationOptions *options,
                                              MI_SessionCallbacks *callbacks,
                                              ...
                                              MI_Session *session) {
  if (application && application->ft) {
    return application->ft->NewSession(application, protocol, destination,
                                       options, callbacks, extendedError,
                                       session);
  } else {
    if (session) {
...
MI_INLINE MI_Result MI_Application_NewHostedProvider(
    MI_Application *application, const MI_Char *namespaceName,
    const MI_Char *providerName, MI_MainFunction mi_Main,
    MI_Instance **extendedError, MI_HostedProvider *hostedProvider) {
  if (application && application->ft) {
    return application->ft->NewHostedProvider(application, namespaceName,
                                              providerName, mi_Main,
                                              extendedError, hostedProvider);
  } else {
    if (hostedProvider) {
...
MI_INLINE MI_Result MI_Application_NewSerializer(MI_Application *application,
                                                 MI_Uint32 flags,
                                                 MI_Char *format,
                                                 MI_Serializer *serializer) {
  if (application && application->ft) {
    return application->ft->NewSerializer(application, flags, format,
                                          serializer);
  } else {
    if (serializer) {
...
MI_INLINE MI_Result
MI_Application_NewDeserializer(MI_Application *application, MI_Uint32 flags,
                               MI_Char *format, MI_Deserializer *deserializer) {
  if (application && application->ft) {
    return application->ft->NewDeserializer(application, flags, format,
                                            deserializer);
  } else {
    if (deserializer) {
...
MI_INLINE MI_Result MI_HostedProvider_GetApplication(
    MI_HostedProvider *hostedProvider, MI_Application *application) {
  if (hostedProvider && hostedProvider->ft) {
...
MI_INLINE MI_Result
MI_Session_Close(MI_Session *session, void *completionContext,
                 void(MI_CALL *completionCallback)(void *completionContext)) {
...
MI_INLINE MI_Result MI_Session_GetApplication(MI_Session *session,
                                              MI_Application *application) {
  if (session && session->ft) {
...
MI_INLINE void MI_Session_GetInstance(MI_Session *session, MI_Uint32 flags,
                                      MI_OperationOptions *options,
                                      const MI_Char *namespaceName,
                                      const MI_Instance *inboundInstance,
                                      MI_OperationCallbacks *callbacks,
                                      MI_Operation *operation) {
  if (session && session->ft) {
    session->ft->GetInstance(session, flags, options, namespaceName,
                             inboundInstance, callbacks, operation);
  } else {
    if (operation) {
      memset(operation, 0, sizeof(*operation));
    }
    if (callbacks && callbacks->instanceResult) {
      callbacks->instanceResult(NULL, callbacks->callbackContext, NULL,
                                MI_FALSE, MI_RESULT_INVALID_PARAMETER, NULL,
                                NULL, NULL);
    }
  }
}
MI_INLINE void MI_Session_ModifyInstance(MI_Session *session, MI_Uint32 flags,
                                         MI_OperationOptions *options,
                                         const MI_Char *namespaceName,
                                         const MI_Instance *inboundInstance,
                                         MI_OperationCallbacks *callbacks,
                                         MI_Operation *operation) {
  if (session && session->ft) {
    session->ft->ModifyInstance(session, flags, options, namespaceName,
                                inboundInstance, callbacks, operation);
  } else {
    if (operation) {
      memset(operation, 0, sizeof(*operation));
...
MI_INLINE void MI_Session_CreateInstance(MI_Session *session, MI_Uint32 flags,
                                         MI_OperationOptions *options,
                                         const MI_Char *namespaceName,
                                         const MI_Instance *inboundInstance,
                                         MI_OperationCallbacks *callbacks,
                                         MI_Operation *operation) {
  if (session && session->ft) {
    session->ft->CreateInstance(session, flags, options, namespaceName,
                                inboundInstance, callbacks, operation);
  } else {
    if (operation) {
      memset(operation, 0, sizeof(*operation));
...
MI_INLINE void MI_Session_DeleteInstance(MI_Session *session, MI_Uint32 flags,
                                         MI_OperationOptions *options,
                                         const MI_Char *namespaceName,
                                         const MI_Instance *inboundInstance,
                                         MI_OperationCallbacks *callbacks,
                                         MI_Operation *operation) {
  if (session && session->ft) {
    session->ft->DeleteInstance(session, flags, options, namespaceName,
                                inboundInstance, callbacks, operation);
  } else {
    if (operation) {
      memset(operation, 0, sizeof(*operation));
...
MI_INLINE void
MI_Session_Invoke(MI_Session *session, MI_Uint32 flags,
                  MI_OperationOptions *options, const MI_Char *namespaceName,
                  const MI_Char *className, const MI_Char *methodName,
                  const MI_Instance *inboundInstance,
                  const MI_Instance *inboundProperties,
                  MI_OperationCallbacks *callbacks, MI_Operation *operation) {
  if (session && session->ft) {
    session->ft->Invoke(session, flags, options, namespaceName, className,
                        methodName, inboundInstance, inboundProperties,
                        callbacks, operation);
  } else {
    if (operation) {
      memset(operation, 0, sizeof(*operation));
...
MI_INLINE void MI_Session_EnumerateInstances(
    MI_Session *session, MI_Uint32 flags, MI_OperationOptions *options,
    const MI_Char *namespaceName, const MI_Char *className, MI_Boolean keysOnly,
    MI_OperationCallbacks *callbacks, MI_Operation *operation) {
  if (session && session->ft) {
    session->ft->EnumerateInstances(session, flags, options, namespaceName,
                                    className, keysOnly, callbacks, operation);
  } else {
    if (operation) {
      memset(operation, 0, sizeof(*operation));
    }
...
MI_INLINE void MI_Session_QueryInstances(MI_Session *session, MI_Uint32 flags,
                                         MI_OperationOptions *options,
                                         const MI_Char *namespaceName,
                                         const MI_Char *queryDialect,
                                         const MI_Char *queryExpression,
                                         ...
                                         MI_Operation *operation) {
  if (session && session->ft) {
    session->ft->QueryInstances(session, flags, options, namespaceName,
                                queryDialect, queryExpression, callbacks,
                                operation);
  } else {
    if (operation) {
      memset(operation, 0, sizeof(*operation));
...
MI_INLINE void MI_Session_AssociatorInstances(
    MI_Session *session, MI_Uint32 flags, MI_OperationOptions *options,
    const MI_Char *namespaceName, const MI_Instance *instanceKey,
    const MI_Char *assocClass, const MI_Char *resultClass, const MI_Char *role,
    const MI_Char *resultRole, MI_Boolean keysOnly,
    MI_OperationCallbacks *callbacks, MI_Operation *operation) {
  if (session && session->ft) {
    session->ft->AssociatorInstances(
        session, flags, options, namespaceName, instanceKey, assocClass,
        resultClass, role, resultRole, keysOnly, callbacks, operation);
  } else {
    if (operation) {
      memset(operation, 0, sizeof(*operation));
    }
...
MI_INLINE void MI_Session_ReferenceInstances(
    ...
    MI_OperationCallbacks *callbacks, MI_Operation *operation) {
  if (session && session->ft) {
    session->ft->ReferenceInstances(session, flags, options, namespaceName,
                                    instanceKey, resultClass, role, keysOnly,
                                    callbacks, operation);
  } else {
    if (operation) {
      memset(operation, 0, sizeof(*operation));
...
MI_INLINE void MI_Session_Subscribe(
    MI_Session *session, MI_Uint32 flags, MI_OperationOptions *options,
    const MI_Char *namespaceName, const MI_Char *queryDialect,
    const MI_Char *queryExpression,
    const MI_SubscriptionDeliveryOptions *deliverOptions,
    MI_OperationCallbacks *callbacks, MI_Operation *operation) {
  if (session && session->ft) {
    session->ft->Subscribe(session, flags, options, namespaceName, queryDialect,
                           queryExpression, deliverOptions, callbacks,
                           operation);
  } else {
    if (operation) {
      memset(operation, 0, sizeof(*operation));
    ...
    if (callbacks && callbacks->indicationResult) {
      callbacks->indicationResult(NULL, callbacks->callbackContext, NULL, NULL,
                                  NULL, MI_FALSE, MI_RESULT_INVALID_PARAMETER,
                                  NULL, NULL, NULL);
    }
  }
}
MI_INLINE void MI_Session_GetClass(MI_Session *session, MI_Uint32 flags,
                                   MI_OperationOptions *options,
                                   const MI_Char *namespaceName,
                                   const MI_Char *className,
                                   MI_OperationCallbacks *callbacks,
                                   MI_Operation *operation) {
  if (session && session->ft) {
    session->ft->GetClass(session, flags, options, namespaceName, className,
                          callbacks, operation);
  } else {
    if (operation) {
      memset(operation, 0, sizeof(*operation));
    ...
    if (callbacks && callbacks->classResult) {
      callbacks->classResult(NULL, callbacks->callbackContext, NULL, MI_FALSE,
                             MI_RESULT_INVALID_PARAMETER, NULL, NULL, NULL);
    }
  }
}
MI_INLINE void MI_Session_EnumerateClasses(MI_Session *session, MI_Uint32 flags,
                                           MI_OperationOptions *options,
                                           const MI_Char *namespaceName,
                                           const MI_Char *className,
                                           MI_Boolean classNamesOnly,
                                           ...
                                           MI_Operation *operation) {
  if (session && session->ft) {
    session->ft->EnumerateClasses(session, flags, options, namespaceName,
                                  className, classNamesOnly, callbacks,
                                  operation);
  } else {
    if (operation) {
      memset(operation, 0, sizeof(*operation));
...
MI_INLINE void MI_Session_TestConnection(MI_Session *session, MI_Uint32 flags,
                                         MI_OperationCallbacks *callbacks,
                                         MI_Operation *operation) {
  if (session && session->ft) {
...
MI_INLINE MI_Result MI_Operation_GetInstance(
    MI_Operation *operation, const MI_Instance **instance,
    MI_Boolean *moreResults, MI_Result *result, const MI_Char **errorMessage,
    const MI_Instance **completionDetails) {
  if (operation && operation->ft) {
    return operation->ft->GetInstance(operation, instance, moreResults, result,
                                      errorMessage, completionDetails);
  }
  if (result)
...
MI_INLINE MI_Result MI_Operation_GetIndication(
    MI_Operation *operation, const MI_Instance **instance,
    const MI_Char **bookmark, const MI_Char **machineID,
    MI_Boolean *moreResults, MI_Result *result, const MI_Char **errorMessage,
    const MI_Instance **completionDetails) {
  if (operation && operation->ft) {
    return operation->ft->GetIndication(operation, instance, bookmark,
                                        machineID, moreResults, result,
                                        errorMessage, completionDetails);
  }
  if (result)
    *result = MI_RESULT_INVALID_PARAMETER;
...
MI_INLINE MI_Result MI_Operation_GetClass(
    MI_Operation *operation, const MI_Class **classResult,
    MI_Boolean *moreResults, MI_Result *result, const MI_Char **errorMessage,
    const MI_Instance **completionDetails) {
  if (operation && operation->ft) {
    return operation->ft->GetClass(operation, classResult, moreResults, result,
                                   errorMessage, completionDetails);
  }
  if (result)
    *result = MI_RESULT_INVALID_PARAMETER;
...
MI_INLINE MI_Result MI_Operation_Cancel(MI_Operation *operation,
                                        MI_CancellationReason reason) {
  if (operation && operation->ft) {
...
MI_INLINE MI_Result MI_Operation_GetSession(MI_Operation *operation,
                                            MI_Session *session) {
  if (session) {
    memset(session, 0, sizeof(MI_Session));
  }
...
MI_INLINE MI_Result MI_DestinationOptions_SetTimeout(
    MI_DestinationOptions *options, const MI_Interval *timeout) {
  if (options && options->ft) {
    return options->ft->SetInterval(
        options, MI_T("__MI_DESTINATIONOPTIONS_TIMEOUT"), timeout, 0);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
}
MI_INLINE MI_Result MI_DestinationOptions_GetTimeout(
    MI_DestinationOptions *options, MI_Interval *timeout) {
  if (options && options->ft) {
    return options->ft->GetInterval(
        options, MI_T("__MI_DESTINATIONOPTIONS_TIMEOUT"), timeout, 0, 0);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
}
MI_INLINE MI_Result MI_DestinationOptions_SetCertCACheck(
    MI_DestinationOptions *options, MI_Boolean check) {
  if (options && options->ft) {
    return options->ft->SetNumber(
        options, MI_T("__MI_DESTINATIONOPTIONS_CERT_CA_CHECK"), check, 0);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
}
MI_INLINE MI_Result MI_DestinationOptions_GetCertCACheck(
  ...
  if (options && options->ft) {
    MI_Uint32 value;
    MI_Result result = options->ft->GetNumber(
        options, MI_T("__MI_DESTINATIONOPTIONS_CERT_CA_CHECK"), &value, 0, 0);
...
MI_INLINE MI_Result MI_DestinationOptions_SetCertCNCheck(
  ...
  if (options && options->ft) {
    return options->ft->SetNumber(
        options, MI_T("__MI_DESTINATIONOPTIONS_CERT_CN_CHECK"), check, 0);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
}
MI_INLINE MI_Result MI_DestinationOptions_GetCertCNCheck(
  ...
  if (options && options->ft) {
    MI_Uint32 value;
    MI_Result result = options->ft->GetNumber(
        options, MI_T("__MI_DESTINATIONOPTIONS_CERT_CN_CHECK"), &value, 0, 0);
    if (result == MI_RESULT_OK)
      *check = (MI_Boolean)value;
    return result;
  } else {
...
MI_INLINE MI_Result MI_DestinationOptions_SetCertRevocationCheck(
  ...
  if (options && options->ft) {
    return options->ft->SetNumber(
        options, MI_T("__MI_DESTINATIONOPTIONS_CERT_REVOCATION_CHECK"), check,
        0);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
...
MI_INLINE MI_Result MI_DestinationOptions_GetCertRevocationCheck(
  ...
  if (options && options->ft) {
    MI_Uint32 value;
    MI_Result result = options->ft->GetNumber(
        options, MI_T("__MI_DESTINATIONOPTIONS_CERT_REVOCATION_CHECK"), &value,
        0, 0);
    if (result == MI_RESULT_OK)
      *check = (MI_Boolean)value;
    return result;
...
MI_INLINE MI_Result MI_DestinationOptions_SetPacketPrivacy(
    MI_DestinationOptions *options, MI_Boolean privacy) {
  if (options && options->ft) {
    return options->ft->SetNumber(
        options, MI_T("__MI_DESTINATIONOPTIONS_PACKET_PRIVACY"), privacy, 0);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
}
MI_INLINE MI_Result MI_DestinationOptions_GetPacketPrivacy(
  ...
  if (options && options->ft) {
    MI_Uint32 value;
    MI_Result result = options->ft->GetNumber(
        options, MI_T("__MI_DESTINATIONOPTIONS_PACKET_PRIVACY"), &value, 0, 0);
    if (result == MI_RESULT_OK)
...
MI_INLINE MI_Result MI_DestinationOptions_SetPacketIntegrity(
    MI_DestinationOptions *options, MI_Boolean integrity) {
  if (options && options->ft) {
    return options->ft->SetNumber(
        options, MI_T("__MI_DESTINATIONOPTIONS_PACKET_INTEGRITY"), integrity,
        0);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
...
MI_INLINE MI_Result MI_DestinationOptions_GetPacketIntegrity(
  ...
  if (options && options->ft) {
    MI_Uint32 value;
    MI_Result result = options->ft->GetNumber(
        options, MI_T("__MI_DESTINATIONOPTIONS_PACKET_INTEGRITY"), &value, 0,
        0);
    if (result == MI_RESULT_OK)
...
MI_INLINE MI_Result MI_DestinationOptions_SetPacketEncoding(
    MI_DestinationOptions *options, const MI_Char *encoding) {
  if (options && options->ft) {
    return options->ft->SetString(
        options, MI_T("__MI_DESTINATIONOPTIONS_PACKET_ENCODING"), encoding, 0);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
}
...
MI_INLINE MI_Result MI_DestinationOptions_SetDataLocale(
    MI_DestinationOptions *options, const MI_Char *locale) {
  if (options && options->ft) {
    return options->ft->SetString(
        options, MI_T("__MI_DESTINATIONOPTIONS_DATA_LOCALE"), locale, 0);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
}
MI_INLINE MI_Result MI_DestinationOptions_GetDataLocale(
  ...
  if (options && options->ft) {
    return options->ft->GetString(
        options, MI_T("__MI_DESTINATIONOPTIONS_DATA_LOCALE"), locale, 0, 0);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
}
MI_INLINE MI_Result MI_DestinationOptions_SetUILocale(
  ...
  if (options && options->ft) {
    return options->ft->SetString(
        options, MI_T("__MI_DESTINATIONOPTIONS_UI_LOCALE"), locale, 0);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
}
MI_INLINE MI_Result MI_DestinationOptions_GetUILocale(
  ...
  if (options && options->ft) {
    return options->ft->GetString(
        options, MI_T("__MI_DESTINATIONOPTIONS_UI_LOCALE"), locale, 0, 0);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
}
MI_INLINE MI_Result MI_DestinationOptions_SetMaxEnvelopeSize(
    MI_DestinationOptions *options, MI_Uint32 sizeInKB) {
  if (options && options->ft) {
    return options->ft->SetNumber(
        options, MI_T("__MI_DESTINATIONOPTIONS_MAX_ENVELOPE_SIZE"), sizeInKB,
        0);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
...
MI_INLINE MI_Result MI_DestinationOptions_GetMaxEnvelopeSize(
    MI_DestinationOptions *options, MI_Uint32 *sizeInKB) {
  if (options && options->ft) {
    return options->ft->GetNumber(
        options, MI_T("__MI_DESTINATIONOPTIONS_MAX_ENVELOPE_SIZE"), sizeInKB, 0,
        0);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
...
MI_INLINE MI_Result MI_DestinationOptions_SetEncodePortInSPN(
    MI_DestinationOptions *options, MI_Boolean encodePort) {
  if (options && options->ft) {
    return options->ft->SetNumber(
        options, MI_T("__MI_DESTINATIONOPTIONS_ENCODE_PORT_IN_SPN"), encodePort,
        0);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
...
MI_INLINE MI_Result MI_DestinationOptions_GetEncodePortInSPN(
  ...
  if (options && options->ft) {
    MI_Uint32 value;
    MI_Result result = options->ft->GetNumber(
        options, MI_T("__MI_DESTINATIONOPTIONS_ENCODE_PORT_IN_SPN"), &value, 0,
        0);
    if (result == MI_RESULT_OK)
...
MI_INLINE MI_Result MI_DestinationOptions_SetHttpUrlPrefix(
    MI_DestinationOptions *options, const MI_Char *prefix) {
  if (options && options->ft) {
    return options->ft->SetString(
        options, MI_T("__MI_DESTINATIONOPTIONS_HTTP_URL_PREFIX"), prefix, 0);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
}
MI_INLINE MI_Result MI_DestinationOptions_GetHttpUrlPrefix(
  ...
  if (options && options->ft) {
    return options->ft->GetString(
        options, MI_T("__MI_DESTINATIONOPTIONS_HTTP_URL_PREFIX"), prefix, 0, 0);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
}
MI_INLINE MI_Result MI_DestinationOptions_SetDestinationPort(
    MI_DestinationOptions *options, MI_Uint32 port) {
  if (options && options->ft) {
    return options->ft->SetNumber(
        options, MI_T("__MI_DESTINATIONOPTIONS_DESTINATION_PORT"), port, 0);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
}
MI_INLINE MI_Result MI_DestinationOptions_GetDestinationPort(
  ...
  if (options && options->ft) {
    return options->ft->GetNumber(
        options, MI_T("__MI_DESTINATIONOPTIONS_DESTINATION_PORT"), port, 0, 0);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
}
...
MI_INLINE
    MI_Result MI_DestinationOptions_SetTransport(MI_DestinationOptions *options,
                                                 const MI_Char *transport) {
  if (options && options->ft) {
    return options->ft->SetString(
        options, MI_T("__MI_DESTINATIONOPTIONS_TRANSPORT"), transport, 0);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
}
MI_INLINE MI_Result MI_DestinationOptions_GetTransport(
    MI_DestinationOptions *options, const MI_Char **transport) {
  if (options && options->ft) {
    return options->ft->GetString(
        options, MI_T("__MI_DESTINATIONOPTIONS_TRANSPORT"), transport, 0, 0);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
}
...
MI_INLINE
    MI_Result MI_DestinationOptions_SetProxyType(MI_DestinationOptions *options,
                                                 const MI_Char *proxyType) {
  if (options && options->ft) {
    return options->ft->SetString(
        options, MI_T("__MI_DESTINATIONOPTIONS_PROXY_TYPE"), proxyType, 0);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
}
MI_INLINE MI_Result MI_DestinationOptions_GetProxyType(
    MI_DestinationOptions *options, const MI_Char **proxyType) {
  if (options && options->ft) {
    return options->ft->GetString(
        options, MI_T("__MI_DESTINATIONOPTIONS_PROXY_TYPE"), proxyType, 0, 0);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
}
MI_INLINE MI_Result MI_DestinationOptions_AddProxyCredentials(
    MI_DestinationOptions *options, const MI_UserCredentials *credentials) {
  if (options && options->ft) {
    return options->ft->AddCredentials(
        options, MI_T("__MI_DESTINATIONOPTIONS_PROXY_CREDENTIALS"), credentials,
        0);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
...
MI_INLINE MI_Result MI_DestinationOptions_AddDestinationCredentials(
  ...
  if (options && options->ft) {
    return options->ft->AddCredentials(
        options, MI_T("__MI_DESTINATIONOPTIONS_DESTINATION_CREDENTIALS"),
        credentials, 0);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
...
MI_INLINE MI_Result MI_DestinationOptions_SetImpersonationType(
    MI_DestinationOptions *options,
    MI_DestinationOptions_ImpersonationType impersonationType) {
  if (options && options->ft) {
    return options->ft->SetNumber(
        options, MI_T("__MI_DESTINATIONOPTIONS_IMPERSONATION_TYPE"),
        impersonationType, 0);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
...
MI_INLINE MI_Result MI_DestinationOptions_GetImpersonationType(
  ...
  if (options && options->ft) {
    MI_Uint32 value;
    MI_Result result = options->ft->GetNumber(
        options, MI_T("__MI_DESTINATIONOPTIONS_IMPERSONATION_TYPE"), &value, 0,
        0);
    if (result == MI_RESULT_OK)
...
MI_INLINE MI_Result MI_DestinationOptions_SetString(
    MI_DestinationOptions *options, const MI_Char *optionName,
...
MI_INLINE MI_Result MI_DestinationOptions_GetString(
    MI_DestinationOptions *options, const MI_Char *optionName,
    const MI_Char **optionValue, MI_Uint32 *index) {
  if (options && options->ft) {
...
MI_INLINE MI_Result MI_DestinationOptions_GetNumber(
    MI_DestinationOptions *options, const MI_Char *optionName,
    MI_Uint32 *optionValue, MI_Uint32 *index) {
  if (options && options->ft) {
...
MI_INLINE MI_Result MI_DestinationOptions_GetOptionCount(
    MI_DestinationOptions *options, MI_Uint32 *count) {
  if (options && options->ft) {
...
MI_INLINE MI_Result MI_DestinationOptions_GetOptionAt(
    MI_DestinationOptions *options, MI_Uint32 index, const MI_Char **optionName,
    MI_Value *value, MI_Type *type, MI_Uint32 *flags) {
  if (options && options->ft) {
    return options->ft->GetOptionAt(options, index, optionName, value, type,
                                    flags);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
...
MI_INLINE MI_Result MI_DestinationOptions_GetOption(
    MI_DestinationOptions *options, const MI_Char *optionName, MI_Value *value,
    MI_Type *type, MI_Uint32 *index, MI_Uint32 *flags) {
  if (options && options->ft) {
    return options->ft->GetOption(options, optionName, value, type, index,
                                  flags);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
...
MI_INLINE MI_Result MI_DestinationOptions_GetCredentialsAt(
    MI_DestinationOptions *options, MI_Uint32 index, const MI_Char **optionName,
    MI_UserCredentials *credentials, MI_Uint32 *flags) {
  if (options && options->ft) {
    return options->ft->GetCredentialsAt(options, index, optionName,
                                         credentials, flags);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
...
MI_INLINE MI_Result MI_DestinationOptions_GetCredentialsPasswordAt(
    MI_DestinationOptions *options, MI_Uint32 index, const MI_Char **optionName,
    MI_Char *password, MI_Uint32 bufferLength, MI_Uint32 *passwordLength,
    MI_Uint32 *flags) {
  if (options && options->ft) {
    return options->ft->GetCredentialsPasswordAt(options, index, optionName,
                                                 password, bufferLength,
...
MI_INLINE MI_Result MI_INLINE_CALL
MI_DestinationOptions_Clone(const MI_DestinationOptions *self,
                            MI_DestinationOptions *newDestinationOptions) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_OperationOptions_SetWriteErrorMode(
    MI_OperationOptions *options, MI_CallbackMode mode) {
  if (options && options->ft) {
    return options->ft->SetNumber(
        options, MI_T("__MI_OPERATIONOPTIONS_WRITEERRORMODE"), mode, 0);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
}
MI_INLINE MI_Result MI_OperationOptions_GetWriteErrorMode(
  ...
  if (options && options->ft) {
    MI_Uint32 value;
    MI_Result result = options->ft->GetNumber(
        options, MI_T("__MI_OPERATIONOPTIONS_WRITEERRORMODE"), &value, 0, 0);
    if (result == MI_RESULT_OK)
...
MI_INLINE MI_Result MI_OperationOptions_SetPromptUserMode(
  ...
  if (options && options->ft) {
    return options->ft->SetNumber(
        options, MI_T("__MI_OPERATIONOPTIONS_PROMPTUSERMODE"), mode, 0);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
}
MI_INLINE MI_Result MI_OperationOptions_GetPromptUserMode(
  ...
  if (options && options->ft) {
    MI_Uint32 value;
    MI_Result result = options->ft->GetNumber(
        options, MI_T("__MI_OPERATIONOPTIONS_PROMPTUSERMODE"), &value, 0, 0);
    if (result == MI_RESULT_OK)
      *mode = (MI_CallbackMode)value;
    return result;
  } else {
...
MI_INLINE MI_Result MI_OperationOptions_SetPromptUserRegularMode(
    MI_OperationOptions *options, MI_CallbackMode mode, MI_Boolean ackValue) {
  if (options && options->ft) {
    MI_Result result = options->ft->SetNumber(
        options, MI_T("__MI_OPERATIONOPTIONS_PROMPTUSERMODE"), mode, 0);
    if (result == MI_RESULT_OK)
      return options->ft->SetNumber(
          options, MI_T("__MI_OPERATIONOPTIONS_PROMPTUSERMODEREGULAR_ACKVALUE"),
          ackValue, 0);
    else
      return result;
  } else {
...
MI_INLINE MI_Result MI_OperationOptions_GetPromptUserRegularMode(
  ...
  if (options && options->ft) {
    MI_Uint32 _mode;
    MI_Result result = options->ft->GetNumber(
        options, MI_T("__MI_OPERATIONOPTIONS_PROMPTUSERMODE"), &_mode, 0, 0);
    if (result == MI_RESULT_OK) {
      MI_Uint32 _ackValue;
      result = options->ft->GetNumber(
          options, MI_T("__MI_OPERATIONOPTIONS_PROMPTUSERMODEREGULAR_ACKVALUE"),
          &_ackValue, 0, 0);
      if (result == MI_RESULT_OK) {
...
MI_INLINE MI_Result MI_OperationOptions_SetProviderArchitecture(
    MI_OperationOptions *options, MI_ProviderArchitecture architecture,
    MI_Boolean mustComply) {
  if (options && options->ft) {
    MI_Result result = options->ft->SetNumber(
        options, MI_T("__MI_OPERATIONOPTIONS_PROVIDER_ARCHITECTURE"),
        architecture, 0);
    if (result == MI_RESULT_OK)
      return options->ft->SetNumber(
          options, MI_T("__MI_OPERATIONOPTIONS_REQUIRED_ARCHITECTURE"),
          mustComply, 0);
    else
      return result;
  } else {
...
MI_INLINE MI_Result MI_OperationOptions_EnableChannel(
    MI_OperationOptions *options, MI_Uint32 channel) {
  if (options && options->ft) {
    return options->ft->SetNumber(
        options, MI_T("__MI_OPERATIONOPTIONS_CHANNEL"), channel, 0);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
}
MI_INLINE MI_Result MI_OperationOptions_DisableChannel(
  ...
  if (options && options->ft) {
    return options->ft->SetNumber(
        options, MI_T("__MI_OPERATIONOPTIONS_CHANNEL"), channel, 1);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
}
MI_INLINE MI_Result MI_OperationOptions_GetEnabledChannels(
    MI_OperationOptions *options, MI_Uint32 *channels, MI_Uint32 bufferLength,
    MI_Uint32 *channelCount, MI_Uint32 *flags) {
  if (options && options->ft) {
    return options->ft->GetEnabledChannels(
        options, MI_T("__MI_OPERATIONOPTIONS_CHANNEL"), channels, bufferLength,
        channelCount, flags);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
}
MI_INLINE MI_Result MI_OperationOptions_SetTimeout(MI_OperationOptions *options,
                                                   const MI_Interval *timeout) {
  if (options && options->ft) {
    return options->ft->SetInterval(
        options, MI_T("__MI_OPERATIONOPTIONS_TIMEOUT"), timeout, 0);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
}
MI_INLINE MI_Result MI_OperationOptions_GetTimeout(MI_OperationOptions *options,
                                                   MI_Interval *timeout) {
  if (options && options->ft) {
    return options->ft->GetInterval(
        options, MI_T("__MI_OPERATIONOPTIONS_TIMEOUT"), timeout, 0, 0);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
}
MI_INLINE MI_Result MI_OperationOptions_SetResourceUriPrefix(
    MI_OperationOptions *options, const MI_Char *ruriPrefix) {
  if (options && options->ft) {
    return options->ft->SetString(
        options, MI_T("__MI_OPERATIONOPTIONS_RESOURCE_URI_PREFIX"), ruriPrefix,
        0);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
...
MI_INLINE MI_Result MI_OperationOptions_SetResourceUri(
    MI_OperationOptions *options, const MI_Char *rUri) {
  if (options && options->ft) {
    return options->ft->SetString(
        options, MI_T("__MI_OPERATIONOPTIONS_RESOURCE_URI"), rUri, 0);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
}
MI_INLINE MI_Result MI_OperationOptions_GetResourceUri(
  ...
  if (options && options->ft) {
    return options->ft->GetString(
        options, MI_T("__MI_OPERATIONOPTIONS_RESOURCE_URI"), rUri, 0, 0);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
}
MI_INLINE MI_Result MI_OperationOptions_SetUseMachineID(
    MI_OperationOptions *options, MI_Boolean machineID) {
  if (options && options->ft) {
    return options->ft->SetNumber(
        options, MI_T("__MI_OPERATIONOPTIONS_USE_MACHINE_ID"), machineID, 0);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
}
MI_INLINE MI_Result MI_OperationOptions_GetUseMachineID(
  ...
  if (options && options->ft) {
    MI_Uint32 value;
    MI_Result result = options->ft->GetNumber(
        options, MI_T("__MI_OPERATIONOPTIONS_USE_MACHINE_ID"), &value, 0, 0);
    if (result == MI_RESULT_OK)
...
MI_INLINE MI_Result MI_OperationOptions_SetCustomOption(
    MI_OperationOptions *options, const MI_Char *optionName,
    MI_Type optionValueType, const MI_Value *optionValue,
    MI_Boolean mustComply) {
  if (options && options->ft) {
    return options->ft->SetCustomOption(options, optionName, optionValueType,
                                        optionValue, mustComply, 0);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
}
MI_INLINE MI_Result MI_OperationOptions_GetOptionCount(
    MI_OperationOptions *options, MI_Uint32 *count) {
  if (options && options->ft) {
    return options->ft->GetOptionCount(options, count);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
...
MI_INLINE MI_Result MI_OperationOptions_GetOptionAt(
    MI_OperationOptions *options, MI_Uint32 index, const MI_Char **optionName,
    MI_Value *value, MI_Type *type, MI_Uint32 *flags) {
  if (options && options->ft) {
    return options->ft->GetOptionAt(options, index, optionName, value, type,
                                    flags);
...
MI_INLINE MI_Result MI_OperationOptions_SetString(MI_OperationOptions *options,
                                                  const MI_Char *optionName,
                                                  const MI_Char *value,
                                                  MI_Uint32 flags) {
  if (options && options->ft) {
...
MI_INLINE MI_Result MI_OperationOptions_GetString(MI_OperationOptions *options,
                                                  const MI_Char *optionName,
                                                  const MI_Char **value,
                                                  MI_Uint32 *index,
                                                  MI_Uint32 *flags) {
...
MI_INLINE MI_Result MI_OperationOptions_SetNumber(MI_OperationOptions *options,
                                                  const MI_Char *optionName,
                                                  MI_Uint32 value,
                                                  MI_Uint32 flags) {
  if (options && options->ft) {
...
MI_INLINE MI_Result MI_OperationOptions_GetNumber(MI_OperationOptions *options,
                                                  const MI_Char *optionName,
                                                  MI_Uint32 *value,
                                                  MI_Uint32 *index,
                                                  MI_Uint32 *flags) {
...
MI_INLINE MI_Result MI_OperationOptions_GetOption(
    MI_OperationOptions *options, const MI_Char *optionName, MI_Value *value,
    MI_Type *type, MI_Uint32 *index, MI_Uint32 *flags) {
  if (options && options->ft) {
    return options->ft->GetOption(options, optionName, value, type, index,
                                  flags);
...
MI_INLINE MI_Result MI_Class_GetClassName(const MI_Class *self,
                                          const MI_Char **className) {
  if (self && self->ft) {
    return self->ft->GetClassName(self, className);
  } else {
...
MI_INLINE MI_Result MI_Class_GetNameSpace(const MI_Class *self,
                                          const MI_Char **nameSpace) {
  if (self && self->ft) {
    return self->ft->GetNameSpace(self, nameSpace);
  } else {
...
MI_INLINE MI_Result MI_Class_GetServerName(const MI_Class *self,
                                           const MI_Char **serverName) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_Class_GetElementCount(const MI_Class *self,
                                             MI_Uint32 *count) {
  if (self && self->ft) {
    return self->ft->GetElementCount(self, count);
  } else {
...
MI_INLINE MI_Result MI_Class_GetElement(const MI_Class *self,
                                        const MI_Char *name, MI_Value *value,
                                        MI_Boolean *valueExists, MI_Type *type,
                                        MI_Char **referenceClass,
                                        MI_QualifierSet *qualifierSet,
                                        MI_Uint32 *flags, MI_Uint32 *index) {
  if (self && self->ft) {
    return self->ft->GetElement(self, name, value, valueExists, type,
                                referenceClass, qualifierSet, flags, index);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
}
MI_INLINE MI_Result MI_Class_GetElementAt(
    const MI_Class *self, MI_Uint32 index, const MI_Char **name,
    MI_Value *value, MI_Boolean *valueExists, MI_Type *type,
    MI_Char **referenceClass, MI_QualifierSet *qualifierSet, MI_Uint32 *flags) {
  if (self && self->ft) {
    return self->ft->GetElementAt(self, index, name, value, valueExists, type,
                                  referenceClass, qualifierSet, flags);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
}
MI_INLINE MI_Result MI_Class_GetClassQualifierSet(
    const MI_Class *self, MI_QualifierSet *qualifierSet) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_Class_GetMethodCount(const MI_Class *self,
                                            MI_Uint32 *count) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_Class_GetMethodAt(const MI_Class *self, MI_Uint32 index,
                                         const MI_Char **name,
                                         MI_QualifierSet *qualifierSet,
                                         MI_ParameterSet *parameterSet) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_Class_GetMethod(const MI_Class *self,
                                       const MI_Char *name,
                                       MI_QualifierSet *qualifierSet,
                                       MI_ParameterSet *parameterSet,
                                       MI_Uint32 *index) {
...
MI_INLINE MI_Result MI_Class_GetParentClassName(const MI_Class *self,
                                                const MI_Char **name) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_Class_GetParentClass(const MI_Class *self,
                                            MI_Class **parentClass) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_INLINE_CALL MI_Class_Clone(const MI_Class *self,
                                                  MI_Class **newClass) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_ParameterSet_GetMethodReturnType(
    const MI_ParameterSet *self, MI_Type *returnType,
    MI_QualifierSet *qualifierSet) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_ParameterSet_GetParameterCount(
    const MI_ParameterSet *self, MI_Uint32 *count) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_ParameterSet_GetParameterAt(
    const MI_ParameterSet *self, MI_Uint32 index, const MI_Char **name,
    MI_Type *parameterType, MI_Char **referenceClass,
    MI_QualifierSet *qualifierSet) {
  if (self && self->ft) {
    return self->ft->GetParameterAt(self, index, name, parameterType,
                                    referenceClass, qualifierSet);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
}
MI_INLINE MI_Result MI_ParameterSet_GetParameter(
    const MI_ParameterSet *self, const MI_Char *name, MI_Type *parameterType,
    MI_Char **referenceClass, MI_QualifierSet *qualifierSet, MI_Uint32 *index) {
  if (self && self->ft) {
    return self->ft->GetParameter(self, name, parameterType, referenceClass,
                                  qualifierSet, index);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
...
MI_INLINE MI_Result MI_QualifierSet_GetQualifierCount(
    const MI_QualifierSet *self, MI_Uint32 *count) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_QualifierSet_GetQualifierAt(const MI_QualifierSet *self,
                                                   MI_Uint32 index,
                                                   const MI_Char **name,
                                                   MI_Type *qualifierType,
                                                   MI_Uint32 *qualifierFlags,
                                                   MI_Value *qualifierValue) {
  if (self && self->ft) {
    return self->ft->GetQualifierAt(self, index, name, qualifierType,
                                    qualifierFlags, qualifierValue);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
}
MI_INLINE MI_Result MI_QualifierSet_GetQualifier(
    const MI_QualifierSet *self, const MI_Char *name, MI_Type *qualifierType,
    MI_Uint32 *qualifierFlags, MI_Value *qualifierValue, MI_Uint32 *index) {
  if (self && self->ft) {
    return self->ft->GetQualifier(self, name, qualifierType, qualifierFlags,
                                  qualifierValue, index);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
}
MI_INLINE MI_Result MI_SubscriptionDeliveryOptions_SetMaximumLatency(
    MI_SubscriptionDeliveryOptions *self, MI_Interval *value) {
  if (self && self->ft) {
    return self->ft->SetInterval(
...
MI_INLINE MI_Result MI_SubscriptionDeliveryOptions_SetHeartbeatInterval(
  ...
  if (self && self->ft) {
    return self->ft->SetInterval(
        self, MI_T("__MI_SUBSCRIPTIONDELIVERYOPTIONS_SET_HEARTBEAT_INTERVAL"),
        value, 0);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
...
MI_INLINE MI_Result MI_SubscriptionDeliveryOptions_SetExpirationTime(
    MI_SubscriptionDeliveryOptions *self, MI_Datetime *value) {
  if (self && self->ft) {
    return self->ft->SetDateTime(
...
MI_INLINE MI_Result MI_SubscriptionDeliveryOptions_SetBookmark(
    MI_SubscriptionDeliveryOptions *self, const MI_Char *value) {
  if (self && self->ft) {
    return self->ft->SetString(
        self, MI_T("__MI_SUBSCRIPTIONDELIVERYOPTIONS_SET_BOOKMARK"), value, 0);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
}
...
MI_INLINE MI_Result MI_SubscriptionDeliveryOptions_SetDeliveryDestination(
  ...
  if (self && self->ft) {
    return self->ft->SetString(
        self, MI_T("__MI_SUBSCRIPTIONDELIVERYOPTIONS_SET_DELIVERY_DESTINATION"),
        value, 0);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
...
MI_INLINE MI_Result MI_SubscriptionDeliveryOptions_SetDeliveryPortNumber(
    MI_SubscriptionDeliveryOptions *self, MI_Uint32 value) {
  if (self && self->ft) {
    return self->ft->SetNumber(
        self, MI_T("__MI_SUBSCRIPTIONDELIVERYOPTIONS_SET_DELIVERY_PORT_NUMBER"),
        value, 0);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
...
MI_INLINE MI_Result MI_SubscriptionDeliveryOptions_AddDeliveryCredentials(
    MI_SubscriptionDeliveryOptions *self, const MI_UserCredentials *value) {
  if (self && self->ft) {
    return self->ft->AddCredentials(
        self, MI_T("__MI_SUBSCRIPTIONDELIVERYOPTIONS_ADD_DELIVERY_CREDENTIALS"),
        value, 0);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
...
MI_INLINE MI_Result MI_SubscriptionDeliveryOptions_SetDeliveryRetryInterval(
    MI_SubscriptionDeliveryOptions *self, const MI_Interval *value) {
  if (self && self->ft) {
    return self->ft->SetInterval(
        self,
        MI_T("__MI_SUBSCRIPTIONDELIVERYOPTIONS_SET_DELIVERY_RETRY_INTERVAL"),
        value, 0);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
...
MI_INLINE MI_Result MI_SubscriptionDeliveryOptions_SetDeliveryRetryAttempts(
  ...
  if (self && self->ft) {
    return self->ft->SetNumber(
        self,
        MI_T("__MI_SUBSCRIPTIONDELIVERYOPTIONS_SET_DELIVERY_RETRY_ATTEMPTS"),
        value, 0);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
...
MI_INLINE MI_Result
MI_SubscriptionDeliveryOptions_Delete(MI_SubscriptionDeliveryOptions *self) {
  if (self && self->ft) {
    return self->ft->Delete(self);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
...
MI_INLINE MI_Result MI_SubscriptionDeliveryOptions_SetString(
    MI_SubscriptionDeliveryOptions *self, const MI_Char *optionName,
    const MI_Char *value, MI_Uint32 flags) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_SubscriptionDeliveryOptions_SetNumber(
    MI_SubscriptionDeliveryOptions *self, const MI_Char *optionName,
    MI_Uint32 value, MI_Uint32 flags) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_SubscriptionDeliveryOptions_GetString(
    MI_SubscriptionDeliveryOptions *self, const MI_Char *optionName,
    const MI_Char **value, MI_Uint32 *index, MI_Uint32 *flags) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_SubscriptionDeliveryOptions_GetNumber(
    MI_SubscriptionDeliveryOptions *self, const MI_Char *optionName,
    MI_Uint32 *value, MI_Uint32 *index, MI_Uint32 *flags) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_SubscriptionDeliveryOptions_GetDateTime(
    MI_SubscriptionDeliveryOptions *self, const MI_Char *optionName,
    MI_Datetime *value, MI_Uint32 *index, MI_Uint32 *flags) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_SubscriptionDeliveryOptions_GetInterval(
    MI_SubscriptionDeliveryOptions *self, const MI_Char *optionName,
    MI_Interval *value, MI_Uint32 *index, MI_Uint32 *flags) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_SubscriptionDeliveryOptions_GetOptionCount(
    MI_SubscriptionDeliveryOptions *self, MI_Uint32 *count) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_SubscriptionDeliveryOptions_GetOptionAt(
    MI_SubscriptionDeliveryOptions *self, MI_Uint32 index,
    const MI_Char **optionName, MI_Value *value, MI_Type *type,
    MI_Uint32 *flags) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_SubscriptionDeliveryOptions_GetOption(
    MI_SubscriptionDeliveryOptions *self, const MI_Char *optionName,
    MI_Value *value, MI_Type *type, MI_Uint32 *index, MI_Uint32 *flags) {
  if (self && self->ft) {
...
MI_INLINE MI_Result MI_SubscriptionDeliveryOptions_GetCredentialsAt(
    MI_SubscriptionDeliveryOptions *self, MI_Uint32 index,
    const MI_Char **optionName, MI_UserCredentials *credentials,
    MI_Uint32 *flags) {
  if (self && self->ft) {
    return self->ft->GetCredentialsAt(self, index, optionName, credentials,
                                      flags);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
...
MI_INLINE MI_Result MI_SubscriptionDeliveryOptions_GetCredentialsPasswordAt(
    ...
    MI_Uint32 *passwordLength, MI_Uint32 *flags) {
  if (self && self->ft) {
    return self->ft->GetCredentialsPasswordAt(
        self, index, optionName, password, bufferLength, passwordLength, flags);
  } else {
    return MI_RESULT_INVALID_PARAMETER;
  }
}
...
MI_INLINE MI_Result MI_Serializer_SerializeClass(
    MI_Serializer *serializer, MI_Uint32 flags, const MI_Class *classObject,
    MI_Uint8 *clientBuffer, MI_Uint32 clientBufferLength,
    MI_Uint32 *clientBufferNeeded) {
  return mi_clientFT->serializerFT->SerializeClass(
      serializer, flags, classObject, clientBuffer, clientBufferLength,
      clientBufferNeeded);
}
MI_INLINE MI_Result MI_Serializer_SerializeInstance(
    MI_Serializer *serializer, MI_Uint32 flags,
    const MI_Instance *instanceObject, MI_Uint8 *clientBuffer,
    MI_Uint32 clientBufferLength, MI_Uint32 *clientBufferNeeded) {
  return mi_clientFT->serializerFT->SerializeInstance(
      serializer, flags, instanceObject, clientBuffer, clientBufferLength,
      clientBufferNeeded);
}
...
MI_INLINE MI_Result MI_Deserializer_DeserializeClass(
    MI_Deserializer *deserializer, MI_Uint32 flags, MI_Uint8 *serializedBuffer,
    MI_Uint32 serializedBufferLength, MI_Class *parentClass,
    const MI_Char *serverName, const MI_Char *namespaceName,
    MI_Deserializer_ClassObjectNeeded classObjectNeeded,
    void *classObjectNeededContext, MI_Uint32 *serializedBufferRead,
    MI_Class **classObject, MI_Instance **cimErrorDetails) {
  return mi_clientFT->deserializerFT->DeserializeClass(
      deserializer, flags, serializedBuffer, serializedBufferLength,
      parentClass, serverName, namespaceName, classObjectNeeded,
      classObjectNeededContext, serializedBufferRead, classObject,
      cimErrorDetails);
}
MI_INLINE MI_Result MI_Deserializer_Class_GetClassName(
    MI_Deserializer *deserializer, MI_Uint8 *serializedBuffer,
    MI_Uint32 serializedBufferLength, MI_Char *className,
    MI_Uint32 *classNameLength, MI_Instance **cimErrorDetails) {
  return mi_clientFT->deserializerFT->Class_GetClassName(
      deserializer, serializedBuffer, serializedBufferLength, className,
      classNameLength, cimErrorDetails);
}
MI_INLINE MI_Result MI_Deserializer_Class_GetParentClassName(
    MI_Deserializer *deserializer, MI_Uint8 *serializedBuffer,
    MI_Uint32 serializedBufferLength, MI_Char *parentClassName,
    MI_Uint32 *parentClassNameLength, MI_Instance **cimErrorDetails) {
  return mi_clientFT->deserializerFT->Class_GetParentClassName(
      deserializer, serializedBuffer, serializedBufferLength, parentClassName,
      parentClassNameLength, cimErrorDetails);
}
MI_INLINE MI_Result MI_Deserializer_DeserializeInstance(
    MI_Deserializer *deserializer, MI_Uint32 flags, MI_Uint8 *serializedBuffer,
    MI_Uint32 serializedBufferLength, MI_Class **classObjects,
    MI_Uint32 numberClassObjects,
    MI_Deserializer_ClassObjectNeeded classObjectNeeded,
    void *classObjectNeededContext, MI_Uint32 *serializedBufferRead,
    MI_Instance **instanceObject, MI_Instance **cimErrorDetails) {
  return mi_clientFT->deserializerFT->DeserializeInstance(
      deserializer, flags, serializedBuffer, serializedBufferLength,
      classObjects, numberClassObjects, classObjectNeeded,
      classObjectNeededContext, serializedBufferRead, instanceObject,
      cimErrorDetails);
}
MI_INLINE MI_Result MI_Deserializer_Instance_GetClassName(
    ...
    MI_Uint32 serializedBufferLength, MI_Char *className,
    MI_Uint32 *classNameLength, MI_Instance **cimErrorDetails) {
  return mi_clientFT->deserializerFT->Instance_GetClassName(
      deserializer, serializedBuffer, serializedBufferLength, className,
      classNameLength, cimErrorDetails);
}
MI_INLINE MI_ErrorCategory
MI_Utilities_MapErrorToMiErrorCategory(MI_Char *errorType, MI_Uint32 error) {
...
MI_INLINE MI_Result MI_Utilities_CimErrorFromErrorCode(
    MI_Uint32 error, const MI_Char *errorType, const MI_Char *errorMessage,
    MI_Instance **cimError) {
  return mi_clientFT->utilitiesFT->CimErrorFromErrorCode(
      error, errorType, errorMessage, cimError);
}
...
#define MI_SubscriptionDeliveryOptions__SetExpirationTime                      \
  MI_SubscriptionDeliveryOptions_SetExpirationTime
#define MI_SubscriptionDeliveryOptions__GetExpirationTime                      \
