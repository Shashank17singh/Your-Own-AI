...
#define MSOLEDBSQL_PRODUCT_NAME_FULL_ANSI                                      \
...
#define MSOLEDBSQL_PRODUCT_NAME_FULL_UNICODE                                   \
  L"Microsoft OLE DB Driver for SQL Server"
...
#define MSOLEDBSQL_VI_ERROR_LOOKUP_PROG_ID                                     \
  MSOLEDBSQL_VI_ERROR_LOOKUP_PROG_ID_UNICODE
#define MSOLEDBSQL_VI_ENUMERATOR_PROG_ID                                       \
  MSOLEDBSQL_VI_ENUMERATOR_PROG_ID_UNICODE
...
#define MSOLEDBSQL_VI_ERROR_LOOKUP_PROG_ID                                     \
  MSOLEDBSQL_VI_ERROR_LOOKUP_PROG_ID_ANSI
...
typedef struct IUMSInitializeVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IUMSInitialize *This, REFIID riid,
                                  void **ppvObject);
...
public:
  virtual HRESULT WINAPI GetErrorInfo(SSERRORINFO **ppErrorInfo,
                                      OLECHAR **ppStringsBuffer) = 0;
};
#else
typedef struct ISQLServerErrorInfoVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ISQLServerErrorInfo *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ISQLServerErrorInfo *This);
  ULONG(WINAPI *Release)(ISQLServerErrorInfo *This);
  HRESULT(WINAPI *GetErrorInfo)(ISQLServerErrorInfo *This,
                                SSERRORINFO **ppErrorInfo,
...
typedef struct IRowsetFastLoadVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IRowsetFastLoad *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IRowsetFastLoad *This);
  ULONG(WINAPI *Release)(IRowsetFastLoad *This);
  HRESULT(WINAPI *InsertRow)(IRowsetFastLoad *This, HACCESSOR hAccessor,
                             void *pData);
...
public:
  virtual HRESULT WINAPI GetSchemaLock(DBID *pTableID, LOCKMODE lmMode,
                                       HANDLE *phLockHandle,
                                       ULONGLONG *pTableVersion) = 0;
  virtual HRESULT WINAPI ReleaseSchemaLock(HANDLE hLockHandle) = 0;
};
#else
typedef struct ISchemaLockVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ISchemaLock *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ISchemaLock *This);
  ULONG(WINAPI *Release)(ISchemaLock *This);
  HRESULT(WINAPI *GetSchemaLock)(ISchemaLock *This, DBID *pTableID,
                                 LOCKMODE lmMode, HANDLE *phLockHandle,
                                 ULONGLONG *pTableVersion);
...
#define ISchemaLock_GetSchemaLock(This, pTableID, lmMode, phLockHandle,        \
                                  pTableVersion)                               \
  (This)->lpVtbl->GetSchemaLock(This, pTableID, lmMode, phLockHandle,          \
                                pTableVersion)
...
public:
  virtual HRESULT WINAPI BCPColFmt(DBORDINAL idxUserDataCol, int eUserDataType,
                                   int cbIndicator, int cbUserData,
                                   BYTE *pbUserDataTerm, int cbUserDataTerm,
                                   DBORDINAL idxServerCol) = 0;
  ...
  virtual HRESULT WINAPI BCPInit(const wchar_t *pwszTable,
...
typedef struct IBCPSessionVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IBCPSession *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IBCPSession *This);
  ULONG(WINAPI *Release)(IBCPSession *This);
  HRESULT(WINAPI *BCPColFmt)(IBCPSession *This, DBORDINAL idxUserDataCol,
                             int eUserDataType, int cbIndicator, int cbUserData,
                             BYTE *pbUserDataTerm, int cbUserDataTerm,
  ...
  HRESULT(WINAPI *BCPInit)(IBCPSession *This, const wchar_t *pwszTable,
                           const wchar_t *pwszDataFile,
                           const wchar_t *pwszErrorFile, int eDirection);
  HRESULT(WINAPI *BCPReadFmt)(IBCPSession *This, const wchar_t *pwszFormatFile);
  HRESULT(WINAPI *BCPWriteFmt)(IBCPSession *This,
...
#define IBCPSession_BCPColFmt(This, idxUserDataCol, eUserDataType,             \
                              cbIndicator, cbUserData, pbUserDataTerm,         \
                              cbUserDataTerm, idxServerCol)                    \
  (This)->lpVtbl->BCPColFmt(This, idxUserDataCol, eUserDataType, cbIndicator,  \
                            cbUserData, pbUserDataTerm, cbUserDataTerm,        \
                            idxServerCol)
...
#define IBCPSession_BCPInit(This, pwszTable, pwszDataFile, pwszErrorFile,      \
                            eDirection)                                        \
  (This)->lpVtbl->BCPInit(This, pwszTable, pwszDataFile, pwszErrorFile,        \
                          eDirection)
...
public:
  virtual HRESULT WINAPI BCPSetBulkMode(int property, void *pField, int cbField,
                                        void *pRow, int cbRow) = 0;
};
#else
typedef struct IBCPSession2Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IBCPSession2 *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IBCPSession2 *This);
  ULONG(WINAPI *Release)(IBCPSession2 *This);
  HRESULT(WINAPI *BCPColFmt)(IBCPSession2 *This, DBORDINAL idxUserDataCol,
                             int eUserDataType, int cbIndicator, int cbUserData,
                             BYTE *pbUserDataTerm, int cbUserDataTerm,
                             DBORDINAL idxServerCol);
  ...
  HRESULT(WINAPI *BCPInit)(IBCPSession2 *This, const wchar_t *pwszTable,
                           const wchar_t *pwszDataFile,
                           const wchar_t *pwszErrorFile, int eDirection);
  HRESULT(WINAPI *BCPReadFmt)(IBCPSession2 *This,
                              const wchar_t *pwszFormatFile);
  HRESULT(WINAPI *BCPWriteFmt)(IBCPSession2 *This,
                               const wchar_t *pwszFormatFile);
  HRESULT(WINAPI *BCPSetBulkMode)(IBCPSession2 *This, int property,
                                  void *pField, int cbField, void *pRow,
                                  int cbRow);
  END_INTERFACE
} IBCPSession2Vtbl;
struct IBCPSession2 {
...
#define IBCPSession2_BCPColFmt(This, idxUserDataCol, eUserDataType,            \
                               cbIndicator, cbUserData, pbUserDataTerm,        \
                               cbUserDataTerm, idxServerCol)                   \
  (This)->lpVtbl->BCPColFmt(This, idxUserDataCol, eUserDataType, cbIndicator,  \
                            cbUserData, pbUserDataTerm, cbUserDataTerm,        \
...
#define IBCPSession2_BCPExec(This, pRowsCopied)                                \
  (This)->lpVtbl->BCPExec(This, pRowsCopied)
#define IBCPSession2_BCPInit(This, pwszTable, pwszDataFile, pwszErrorFile,     \
                             eDirection)                                       \
  (This)->lpVtbl->BCPInit(This, pwszTable, pwszDataFile, pwszErrorFile,        \
                          eDirection)
...
#define IBCPSession2_BCPWriteFmt(This, pwszFormatFile)                         \
  (This)->lpVtbl->BCPWriteFmt(This, pwszFormatFile)
#define IBCPSession2_BCPSetBulkMode(This, property, pField, cbField, pRow,     \
                                    cbRow)                                     \
  (This, property, pField, cbField, pRow, cbRow)
#endif
#endif
#endif
...
typedef struct ISSAbortVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ISSAbort *This, REFIID riid,
                                  void **ppvObject);
...
public:
  virtual HRESULT WINAPI GetParameterProperties(
      DB_UPARAMS *pcParams, SSPARAMPROPS **prgParamProperties) = 0;
  virtual HRESULT WINAPI SetParameterProperties(
      DB_UPARAMS cParams, SSPARAMPROPS rgParamProperties[]) = 0;
};
#else
typedef struct ISSCommandWithParametersVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ISSCommandWithParameters *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ISSCommandWithParameters *This);
  ULONG(WINAPI *Release)(ISSCommandWithParameters *This);
  HRESULT(WINAPI *GetParameterInfo)(ISSCommandWithParameters *This,
                                    DB_UPARAMS *pcParams,
                                    DBPARAMINFO **prgParamInfo,
                                    OLECHAR **ppNamesBuffer);
  HRESULT(WINAPI *MapParameterNames)(ISSCommandWithParameters *This,
                                     DB_UPARAMS cParamNames,
                                     const OLECHAR *rgParamNames[],
                                     DB_LPARAMS rgParamOrdinals[]);
  HRESULT(WINAPI *SetParameterInfo)(ISSCommandWithParameters *This,
                                    DB_UPARAMS cParams,
                                    const DB_UPARAMS rgParamOrdinals[],
                                    const DBPARAMBINDINFO rgParamBindInfo[]);
  HRESULT(WINAPI *GetParameterProperties)(ISSCommandWithParameters *This,
                                          DB_UPARAMS *pcParams,
                                          SSPARAMPROPS **prgParamProperties);
  HRESULT(WINAPI *SetParameterProperties)(ISSCommandWithParameters *This,
                                          DB_UPARAMS cParams,
...
#define ISSCommandWithParameters_GetParameterInfo(This, pcParams,              \
                                                  prgParamInfo, ppNamesBuffer) \
...
#define ISSCommandWithParameters_MapParameterNames(                            \
  ...
  (This)->lpVtbl->MapParameterNames(This, cParamNames, rgParamNames,           \
                                    rgParamOrdinals)
#define ISSCommandWithParameters_SetParameterInfo(                             \
    This, cParams, rgParamOrdinals, rgParamBindInfo)                           \
  (This)->lpVtbl->SetParameterInfo(This, cParams, rgParamOrdinals,             \
                                   rgParamBindInfo)
#define ISSCommandWithParameters_GetParameterProperties(This, pcParams,        \
                                                        prgParamProperties)    \
  (This)->lpVtbl->GetParameterProperties(This, pcParams, prgParamProperties)
#define ISSCommandWithParameters_SetParameterProperties(This, cParams,         \
                                                        rgParamProperties)     \
...
typedef struct ISSAsynchStatusVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ISSAsynchStatus *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ISSAsynchStatus *This);
  ULONG(WINAPI *Release)(ISSAsynchStatus *This);
  HRESULT(WINAPI *Abort)(ISSAsynchStatus *This, HCHAPTER hChapter,
                         DBASYNCHOP eOperation);
  HRESULT(WINAPI *GetStatus)(ISSAsynchStatus *This, HCHAPTER hChapter,
                             DBASYNCHOP eOperation, DBCOUNTITEM *pulProgress,
                             DBCOUNTITEM *pulProgressMax,
                             DBASYNCHPHASE *peAsynchPhase,
                             LPOLESTR *ppwszStatusText);
  HRESULT(WINAPI *WaitForAsynchCompletion)(ISSAsynchStatus *This,
...
#define ISSAsynchStatus_Abort(This, hChapter, eOperation)                      \
  (This)->lpVtbl->Abort(This, hChapter, eOperation)
#define ISSAsynchStatus_GetStatus(This, hChapter, eOperation, pulProgress,     \
                                  pulProgressMax, peAsynchPhase,               \
                                  ppwszStatusText)                             \
  (This)->lpVtbl->GetStatus(This, hChapter, eOperation, pulProgress,           \
                            pulProgressMax, peAsynchPhase, ppwszStatusText)
...
extern const GUID CLSID_MSOLEDBSQL = {
    ...
    0x1d7b,
    0x4a16,
    {0x8d, 0xed, 0xb2, 0x9c, 0x9, 0xcb, 0x64, 0x8d}};
extern const GUID CLSID_MSOLEDBSQL_ERROR = {
    0xecab1ccbL,
    0x116a,
    0x4541,
    {0xad, 0xba, 0x69, 0xc, 0xeb, 0x9c, 0xc8, 0x43}};
extern const GUID CLSID_MSOLEDBSQL_ENUMERATOR = {
    0x720818d5L,
    0x1465,
    0x4812,
    {0x83, 0x9f, 0x9f, 0x15, 0xc3, 0x8a, 0x52, 0xcb}};
#else
extern const GUID CLSID_MSOLEDBSQL;
extern const GUID CLSID_MSOLEDBSQL_ERROR;
extern const GUID CLSID_MSOLEDBSQL_ENUMERATOR;
...
extern const GUID CLSID_ROWSET_TVP = {
    ...
    0x7bee,
    0x443f,
    {0x86, 0xda, 0xe3, 0x98, 0x4f, 0xcd, 0x4d, 0xf9}};
#else
extern const GUID CLSID_ROWSET_TVP;
#endif
#ifndef _SQLOLEDB_H_
...
extern const GUID IID_ISQLServerErrorInfo = {
    ...
    0xef21,
    0x11d0,
    {0x97, 0xe7, 0x0, 0xc0, 0x4f, 0xc2, 0xad, 0x98}};
...
extern const GUID IID_ISchemaLock = {
    ...
    0x2511,
    0x11d4,
    {0xb2, 0x58, 0x0, 0xc0, 0x4f, 0x79, 0x71, 0xce}};
extern const GUID IID_ISQLXMLHelper = {
    0xd22a7678L,
    0xf860,
    0x40cd,
    {0xa5, 0x67, 0x15, 0x63, 0xde, 0xb4, 0x6d, 0x49}};
#else
extern const GUID IID_ISQLServerErrorInfo;
extern const GUID IID_IRowsetFastLoad;
extern const GUID IID_IUMSInitialize;
...
extern const GUID IID_IBCPSession = {
    ...
    0x42D1,
    0x42f0,
    {0xA1, 0x70, 0xAB, 0x0F, 0x8B, 0x45, 0xB9, 0x39}};
extern const GUID IID_IBCPSession2 = {
    0xad79d3b6,
    0x59dd,
    0x46a3,
    {0xbf, 0xc6, 0xe6, 0x2a, 0x65, 0xff, 0x35, 0x23}};
extern const GUID IID_ISSCommandWithParameters = {
    0xeec30162,
    0x6087,
    0x467c,
    {0xb9, 0x95, 0x7c, 0x52, 0x3c, 0xe9, 0x65, 0x61}};
extern const GUID IID_ISSAsynchStatus = {
    0x1FF1F743,
    0x8BB0,
    0x4c00,
    {0xAC, 0xC4, 0xC1, 0x0E, 0x43, 0xB0, 0x8F, 0xC1}};
#else
extern const GUID IID_ISSAbort;
extern const GUID IID_IBCPSession;
extern const GUID IID_IBCPSession2;
...
extern const GUID OLEDBDECLSPEC DBPROPSET_SQLSERVERDATASOURCEINFO = {
    ...
    0x35f6,
    0x11d2,
    {0x9c, 0x54, 0x0, 0xc0, 0x4f, 0x79, 0x71, 0xd3}};
...
FnLocalDBCreateInstance(PCWSTR wszVersion, PCWSTR pInstanceName, DWORD dwFlags);
typedef FnLocalDBCreateInstance *PFnLocalDBCreateInstance;
typedef HRESULT __cdecl FnLocalDBStartInstance(PCWSTR pInstanceName,
                                               DWORD dwFlags,
                                               LPWSTR wszSqlConnection,
                                               LPDWORD lpcchSqlConnection);
typedef FnLocalDBStartInstance *PFnLocalDBStartInstance;
#define LOCALDB_TRUNCATE_ERR_MESSAGE 0x0001L
typedef HRESULT __cdecl FnLocalDBFormatMessage(HRESULT hrLocalDB, DWORD dwFlags,
                                               DWORD dwLanguageId,
                                               LPWSTR wszMessage,
...
typedef HRESULT __cdecl FnLocalDBStopInstance(PCWSTR pInstanceName,
...
typedef HRESULT __cdecl FnLocalDBDeleteInstance(PCWSTR pInstanceName,
                                                DWORD dwFlags);
...
typedef HRESULT __cdecl
FnLocalDBGetInstances(PTLocalDBInstanceName pInstanceNames,
...
typedef HRESULT __cdecl FnLocalDBGetInstanceInfo(PCWSTR wszInstanceName,
                                                 PLocalDBInstanceInfo pInfo,
                                                 DWORD cbInfo);
...
typedef HRESULT __cdecl FnLocalDBGetVersions(PTLocalDBVersion pVersions,
...
typedef HRESULT __cdecl
FnLocalDBGetVersionInfo(PCWSTR wszVersion, PLocalDBVersionInfo pVersionInfo,
                        DWORD cbVersionInfo);
...
typedef HRESULT __cdecl
FnLocalDBShareInstance(PSID pOwnerSID, PCWSTR wszPrivateLocalDBInstanceName,
                       PCWSTR wszSharedName, DWORD dwFlags);
typedef FnLocalDBShareInstance *PFnLocalDBShareInstance;
FnLocalDBShareInstance LocalDBShareInstance;
typedef HRESULT __cdecl FnLocalDBUnshareInstance(PCWSTR pInstanceName,
                                                 DWORD dwFlags);
...
static HRESULT LocalDBGetPFn(LPCSTR szLocalDBFn, FARPROC *pfnLocalDBFn) {
  ...
  if (!hLocalDBDll) {
    ...
    if (ERROR_SUCCESS !=
        (ec = RegOpenKeyExW(HKEY_LOCAL_MACHINE,
                            L"SOFTWARE\\Microsoft\\Microsoft SQL Server Local "
                            L"DB\\Installed Versions",
                            0, KEY_READ, &hkeyVersions)))
      goto Cleanup;
    for (int i = 0;; i++) {
      cchKeyName = 256;
      if (ERROR_SUCCESS !=
          (ec = RegEnumKeyExW(hkeyVersions, i, verCurrent.wszKeyName,
                              &cchKeyName, 0, NULL, NULL, NULL))) {
    ...
    if (ERROR_SUCCESS != (ec = RegOpenKeyExW(hkeyVersions, verHigh.wszKeyName,
                                             0, KEY_READ, &hkeyVersion)))
      goto Cleanup;
    if (ERROR_SUCCESS !=
        (ec = RegQueryValueExW(hkeyVersion, L"InstanceAPIPath", NULL,
                               &dwValueType, (PBYTE)wszLocalDBDll,
                               &cbLocalDBDll)))
      goto Cleanup;
    ...
    if (NULL == InterlockedCompareExchangePointer(
                    (volatile PVOID *)&hLocalDBDll, hLocalDBDllTemp, NULL))
...
HRESULT __cdecl LocalDBCreateInstance(PCWSTR wszVersion, PCWSTR pInstanceName,
                                      DWORD dwFlags) {
  LOCALDB_PROXY(LocalDBCreateInstance)(wszVersion, pInstanceName, dwFlags);
}
HRESULT __cdecl LocalDBStartInstance(PCWSTR pInstanceName, DWORD dwFlags,
                                     LPWSTR wszSqlConnection,
                                     LPDWORD lpcchSqlConnection) {
  LOCALDB_PROXY(LocalDBStartInstance)(pInstanceName, dwFlags, wszSqlConnection,
                                      lpcchSqlConnection);
}
HRESULT __cdecl LocalDBStopInstance(PCWSTR pInstanceName, DWORD dwFlags,
                                    ULONG ulTimeout) {
...
HRESULT __cdecl LocalDBFormatMessage(HRESULT hrLocalDB, DWORD dwFlags,
                                     DWORD dwLanguageId, LPWSTR wszMessage,
                                     LPDWORD lpcchMessage) {
  LOCALDB_PROXY(LocalDBFormatMessage)(hrLocalDB, dwFlags, dwLanguageId,
                                      wszMessage, lpcchMessage);
}
HRESULT __cdecl LocalDBGetInstances(PTLocalDBInstanceName pInstanceNames,
                                    LPDWORD lpdwNumberOfInstances) {
  LOCALDB_PROXY(LocalDBGetInstances)(pInstanceNames, lpdwNumberOfInstances);
}
HRESULT __cdecl LocalDBGetInstanceInfo(PCWSTR wszInstanceName,
                                       PLocalDBInstanceInfo pInfo,
                                       DWORD cbInfo) {
  LOCALDB_PROXY(LocalDBGetInstanceInfo)(wszInstanceName, pInfo, cbInfo);
}
HRESULT __cdecl LocalDBStartTracing() { LOCALDB_PROXY(LocalDBStartTracing)(); }
HRESULT __cdecl LocalDBStopTracing() { LOCALDB_PROXY(LocalDBStopTracing)(); }
HRESULT __cdecl LocalDBShareInstance(PSID pOwnerSID,
                                     PCWSTR wszLocalDBInstancePrivateName,
                                     PCWSTR wszSharedName, DWORD dwFlags) {
  LOCALDB_PROXY(LocalDBShareInstance)(pOwnerSID, wszLocalDBInstancePrivateName,
                                      wszSharedName, dwFlags);
}
HRESULT __cdecl LocalDBGetVersions(PTLocalDBVersion pVersions,
                                   LPDWORD lpdwNumberOfVersions) {
...
HRESULT __cdecl LocalDBGetVersionInfo(PCWSTR wszVersion,
