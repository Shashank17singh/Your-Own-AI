...
DEFINE_GUID(IID_IMpeg2TableFilter, 0xbdcdd913, 0x9ecd, 0x4fb2, 0x81, 0xae, 0xad,
            0xf7, 0x47, 0xea, 0x75, 0xa5);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("bdcdd913-9ecd-4fb2-81ae-adf747ea75a5")
IMpeg2TableFilter : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE AddPID(PID p) = 0;
  virtual HRESULT STDMETHODCALLTYPE AddTable(PID p, TID t) = 0;
  virtual HRESULT STDMETHODCALLTYPE AddExtension(PID p, TID t, TEID e) = 0;
  virtual HRESULT STDMETHODCALLTYPE RemovePID(PID p) = 0;
  virtual HRESULT STDMETHODCALLTYPE RemoveTable(PID p, TID t) = 0;
  virtual HRESULT STDMETHODCALLTYPE RemoveExtension(PID p, TID t, TEID e) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IMpeg2TableFilter, 0xbdcdd913, 0x9ecd, 0x4fb2, 0x81, 0xae, 0xad,
                0xf7, 0x47, 0xea, 0x75, 0xa5)
#endif
#else
typedef struct IMpeg2TableFilterVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IMpeg2TableFilter *This,
  ...
  HRESULT(STDMETHODCALLTYPE *AddExtension)(IMpeg2TableFilter *This, PID p,
                                           TID t, TEID e);
  HRESULT(STDMETHODCALLTYPE *RemovePID)(IMpeg2TableFilter *This, PID p);
  HRESULT(STDMETHODCALLTYPE *RemoveTable)(IMpeg2TableFilter *This, PID p,
                                          TID t);
  HRESULT(STDMETHODCALLTYPE *RemoveExtension)(IMpeg2TableFilter *This, PID p,
                                              TID t, TEID e);
  END_INTERFACE
} IMpeg2TableFilterVtbl;
interface IMpeg2TableFilter { CONST_VTBL IMpeg2TableFilterVtbl *lpVtbl; };
#ifdef COBJMACROS
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMpeg2TableFilter_QueryInterface(IMpeg2TableFilter *This,
                                                       REFIID riid,
                                                       void **ppvObject) {
...
static inline HRESULT IMpeg2TableFilter_AddTable(IMpeg2TableFilter *This, PID p,
                                                 TID t) {
  return This->lpVtbl->AddTable(This, p, t);
}
static inline HRESULT IMpeg2TableFilter_AddExtension(IMpeg2TableFilter *This,
                                                     PID p, TID t, TEID e) {
  return This->lpVtbl->AddExtension(This, p, t, e);
}
static inline HRESULT IMpeg2TableFilter_RemovePID(IMpeg2TableFilter *This,
                                                  PID p) {
  return This->lpVtbl->RemovePID(This, p);
}
static inline HRESULT IMpeg2TableFilter_RemoveTable(IMpeg2TableFilter *This,
                                                    PID p, TID t) {
  return This->lpVtbl->RemoveTable(This, p, t);
}
static inline HRESULT IMpeg2TableFilter_RemoveExtension(IMpeg2TableFilter *This,
                                                        PID p, TID t, TEID e) {
 ...
 */
DEFINE_GUID(CLSID_Mpeg2TableFilter, 0x752845f1, 0x758f, 0x4c83, 0xa0, 0x43,
            0x42, 0x70, 0xc5, 0x93, 0x30, 0x8e);
#ifdef __cplusplus
class DECLSPEC_UUID("752845f1-758f-4c83-a043-4270c593308e") Mpeg2TableFilter;
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(Mpeg2TableFilter, 0x752845f1, 0x758f, 0x4c83, 0xa0, 0x43, 0x42,
                0x70, 0xc5, 0x93, 0x30, 0x8e)
#endif
#endif
...
DEFINE_GUID(LIBID_Mpeg2DataLib, 0xdbaf6c1b, 0xb6a4, 0x4898, 0xae, 0x65, 0x20,
            0x4f, 0x0d, 0x95, 0x09, 0xa1);
/*****************************************************************************
 * IMpeg2Data interface
 */
#ifndef __IMpeg2Data_INTERFACE_DEFINED__
#define __IMpeg2Data_INTERFACE_DEFINED__
DEFINE_GUID(IID_IMpeg2Data, 0x9b396d40, 0xf380, 0x4e3c, 0xa5, 0x14, 0x1a, 0x82,
            0xbf, 0x6e, 0xbf, 0xe6);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IMpeg2Data : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetSection(
      PID pid, TID tid, PMPEG2_FILTER filter, DWORD timeout,
  ...
  virtual HRESULT STDMETHODCALLTYPE GetStreamOfSections(
      PID pid, TID tid, PMPEG2_FILTER filter, HANDLE data_ready_event,
      IMpeg2Stream * *mpeg_stream) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IMpeg2Data, 0x9b396d40, 0xf380, 0x4e3c, 0xa5, 0x14, 0x1a, 0x82,
                0xbf, 0x6e, 0xbf, 0xe6)
#endif
#else
typedef struct IMpeg2DataVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IMpeg2Data *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IMpeg2Data *This);
  ULONG(STDMETHODCALLTYPE *Release)(IMpeg2Data *This);
  /*** IMpeg2Data methods ***/
  HRESULT(STDMETHODCALLTYPE *GetSection)(IMpeg2Data *This, PID pid, TID tid,
                                         PMPEG2_FILTER filter, DWORD timeout,
                                         ISectionList **section_list);
  HRESULT(STDMETHODCALLTYPE *GetTable)(IMpeg2Data *This, PID pid, TID tid,
                                       PMPEG2_FILTER filter, DWORD timeout,
                                       ISectionList **section_list);
  HRESULT(STDMETHODCALLTYPE *GetStreamOfSections)(IMpeg2Data *This, PID pid,
                                                  TID tid, PMPEG2_FILTER filter,
                                                  HANDLE data_ready_event,
                                                  IMpeg2Stream **mpeg_stream);
  END_INTERFACE
} IMpeg2DataVtbl;
interface IMpeg2Data { CONST_VTBL IMpeg2DataVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IMpeg2Data methods ***/
#define IMpeg2Data_GetSection(This, pid, tid, filter, timeout, section_list)   \
  (This)->lpVtbl->GetSection(This, pid, tid, filter, timeout, section_list)
#define IMpeg2Data_GetTable(This, pid, tid, filter, timeout, section_list)     \
  (This)->lpVtbl->GetTable(This, pid, tid, filter, timeout, section_list)
#define IMpeg2Data_GetStreamOfSections(This, pid, tid, filter,                 \
                                       data_ready_event, mpeg_stream)          \
  (This)->lpVtbl->GetStreamOfSections(This, pid, tid, filter,                  \
                                      data_ready_event, mpeg_stream)
#else
/*** IUnknown methods ***/
static inline HRESULT IMpeg2Data_QueryInterface(IMpeg2Data *This, REFIID riid,
                                                void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IMpeg2Data methods ***/
static inline HRESULT IMpeg2Data_GetSection(IMpeg2Data *This, PID pid, TID tid,
                                            PMPEG2_FILTER filter, DWORD timeout,
                                            ISectionList **section_list) {
  return This->lpVtbl->GetSection(This, pid, tid, filter, timeout,
                                  section_list);
}
static inline HRESULT IMpeg2Data_GetTable(IMpeg2Data *This, PID pid, TID tid,
                                          PMPEG2_FILTER filter, DWORD timeout,
                                          ISectionList **section_list) {
  return This->lpVtbl->GetTable(This, pid, tid, filter, timeout, section_list);
}
static inline HRESULT
IMpeg2Data_GetStreamOfSections(IMpeg2Data *This, PID pid, TID tid,
                               PMPEG2_FILTER filter, HANDLE data_ready_event,
                               IMpeg2Stream **mpeg_stream) {
  return This->lpVtbl->GetStreamOfSections(This, pid, tid, filter,
                                           data_ready_event, mpeg_stream);
}
#endif
#endif
...
DEFINE_GUID(IID_ISectionList, 0xafec1eb5, 0x2a64, 0x46c6, 0xbf, 0x4b, 0xae,
            0x3c, 0xcb, 0x6a, 0xfd, 0xb0);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("afec1eb5-2a64-46c6-bf4b-ae3ccb6afdb0")
ISectionList : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE Initialize(
      MPEG_REQUEST_TYPE request_type, IMpeg2Data * mpeg2_data,
      PMPEG_CONTEXT context, PID pid, TID tid, PMPEG2_FILTER filter,
      DWORD timeout, HANDLE done_event) = 0;
  virtual HRESULT STDMETHODCALLTYPE InitializeWithRawSections(
      PMPEG_PACKET_LIST mpl_sections) = 0;
  virtual HRESULT STDMETHODCALLTYPE CancelPendingRequest() = 0;
  virtual HRESULT STDMETHODCALLTYPE GetNumberOfSections(WORD * count) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetSectionData(
      WORD section_number, DWORD * raw_packet_length, PSECTION * section) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetProgramIdentifier(PID * pid) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetTableIdentifier(TID * tid) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ISectionList, 0xafec1eb5, 0x2a64, 0x46c6, 0xbf, 0x4b, 0xae,
                0x3c, 0xcb, 0x6a, 0xfd, 0xb0)
#endif
#else
typedef struct ISectionListVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ISectionList *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(ISectionList *This);
  ULONG(STDMETHODCALLTYPE *Release)(ISectionList *This);
  /*** ISectionList methods ***/
  HRESULT(STDMETHODCALLTYPE *Initialize)(ISectionList *This,
                                         MPEG_REQUEST_TYPE request_type,
                                         IMpeg2Data *mpeg2_data,
                                         PMPEG_CONTEXT context, PID pid,
                                         TID tid, PMPEG2_FILTER filter,
                                         DWORD timeout, HANDLE done_event);
  HRESULT(STDMETHODCALLTYPE *InitializeWithRawSections)(
      ISectionList *This, PMPEG_PACKET_LIST mpl_sections);
  HRESULT(STDMETHODCALLTYPE *CancelPendingRequest)(ISectionList *This);
  HRESULT(STDMETHODCALLTYPE *GetNumberOfSections)(ISectionList *This,
                                                  WORD *count);
  HRESULT(STDMETHODCALLTYPE *GetSectionData)(ISectionList *This,
                                             WORD section_number,
                                             DWORD *raw_packet_length,
                                             PSECTION *section);
  HRESULT(STDMETHODCALLTYPE *GetProgramIdentifier)(ISectionList *This,
                                                   PID *pid);
  HRESULT(STDMETHODCALLTYPE *GetTableIdentifier)(ISectionList *This, TID *tid);
  END_INTERFACE
} ISectionListVtbl;
interface ISectionList { CONST_VTBL ISectionListVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** ISectionList methods ***/
#define ISectionList_Initialize(This, request_type, mpeg2_data, context, pid,  \
                                tid, filter, timeout, done_event)              \
  (This)->lpVtbl->Initialize(This, request_type, mpeg2_data, context, pid,     \
                             tid, filter, timeout, done_event)
#define ISectionList_InitializeWithRawSections(This, mpl_sections)             \
  (This)->lpVtbl->InitializeWithRawSections(This, mpl_sections)
#define ISectionList_CancelPendingRequest(This)                                \
  (This)->lpVtbl->CancelPendingRequest(This)
#define ISectionList_GetNumberOfSections(This, count)                          \
  (This)->lpVtbl->GetNumberOfSections(This, count)
#define ISectionList_GetSectionData(This, section_number, raw_packet_length,   \
                                    section)                                   \
  (This)->lpVtbl->GetSectionData(This, section_number, raw_packet_length,      \
                                 section)
#define ISectionList_GetProgramIdentifier(This, pid)                           \
  (This)->lpVtbl->GetProgramIdentifier(This, pid)
#define ISectionList_GetTableIdentifier(This, tid)                             \
  (This)->lpVtbl->GetTableIdentifier(This, tid)
#else
/*** IUnknown methods ***/
static inline HRESULT
ISectionList_QueryInterface(ISectionList *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ISectionList methods ***/
static inline HRESULT
ISectionList_Initialize(ISectionList *This, MPEG_REQUEST_TYPE request_type,
                        IMpeg2Data *mpeg2_data, PMPEG_CONTEXT context, PID pid,
                        TID tid, PMPEG2_FILTER filter, DWORD timeout,
                        HANDLE done_event) {
  return This->lpVtbl->Initialize(This, request_type, mpeg2_data, context, pid,
                                  tid, filter, timeout, done_event);
}
static inline HRESULT
ISectionList_InitializeWithRawSections(ISectionList *This,
...
static inline HRESULT ISectionList_GetNumberOfSections(ISectionList *This,
                                                       WORD *count) {
  return This->lpVtbl->GetNumberOfSections(This, count);
}
static inline HRESULT ISectionList_GetSectionData(ISectionList *This,
                                                  WORD section_number,
                                                  DWORD *raw_packet_length,
                                                  PSECTION *section) {
  return This->lpVtbl->GetSectionData(This, section_number, raw_packet_length,
                                      section);
}
static inline HRESULT ISectionList_GetProgramIdentifier(ISectionList *This,
                                                        PID *pid) {
  return This->lpVtbl->GetProgramIdentifier(This, pid);
}
static inline HRESULT ISectionList_GetTableIdentifier(ISectionList *This,
                                                      TID *tid) {
...
DEFINE_GUID(IID_IMpeg2Stream, 0x400cc286, 0x32a0, 0x4ce4, 0x90, 0x41, 0x39,
            0x57, 0x11, 0x25, 0xa6, 0x35);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IMpeg2Stream, 0x400cc286, 0x32a0, 0x4ce4, 0x90, 0x41, 0x39,
                0x57, 0x11, 0x25, 0xa6, 0x35)
#endif
#else
typedef struct IMpeg2StreamVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IMpeg2Stream *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IMpeg2Stream *This);
  ULONG(STDMETHODCALLTYPE *Release)(IMpeg2Stream *This);
  /*** IMpeg2Stream methods ***/
  HRESULT(STDMETHODCALLTYPE *Initialize)(IMpeg2Stream *This,
                                         MPEG_REQUEST_TYPE request_type,
                                         IMpeg2Data *mpeg2_data,
                                         PMPEG_CONTEXT context, PID pid,
                                         TID tid, PMPEG2_FILTER filter,
  ...
  HRESULT(STDMETHODCALLTYPE *SupplyDataBuffer)(
      IMpeg2Stream *This, PMPEG_STREAM_BUFFER stream_buffer);
  END_INTERFACE
} IMpeg2StreamVtbl;
interface IMpeg2Stream { CONST_VTBL IMpeg2StreamVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IMpeg2Stream methods ***/
#define IMpeg2Stream_Initialize(This, request_type, mpeg2_data, context, pid,  \
                                tid, filter, data_ready_event)                 \
  (This)->lpVtbl->Initialize(This, request_type, mpeg2_data, context, pid,     \
                             tid, filter, data_ready_event)
#define IMpeg2Stream_SupplyDataBuffer(This, stream_buffer)                     \
  (This)->lpVtbl->SupplyDataBuffer(This, stream_buffer)
#else
/*** IUnknown methods ***/
static inline HRESULT
IMpeg2Stream_QueryInterface(IMpeg2Stream *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IMpeg2Stream methods ***/
static inline HRESULT IMpeg2Stream_Initialize(IMpeg2Stream *This,
                                              MPEG_REQUEST_TYPE request_type,
                                              IMpeg2Data *mpeg2_data,
                                              PMPEG_CONTEXT context, PID pid,
                                              TID tid, PMPEG2_FILTER filter,
...
static inline HRESULT
IMpeg2Stream_SupplyDataBuffer(IMpeg2Stream *This,
 ...
 * SectionList coclass
 */
DEFINE_GUID(CLSID_SectionList, 0x73da5d04, 0x4347, 0x45d3, 0xa9, 0xdc, 0xfa,
            0xe9, 0xdd, 0xbe, 0x55, 0x8d);
#ifdef __cplusplus
class DECLSPEC_UUID("73da5d04-4347-45d3-a9dc-fae9ddbe558d") SectionList;
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(SectionList, 0x73da5d04, 0x4347, 0x45d3, 0xa9, 0xdc, 0xfa, 0xe9,
                0xdd, 0xbe, 0x55, 0x8d)
#endif
#endif
/*****************************************************************************
 * Mpeg2Stream coclass
 */
DEFINE_GUID(CLSID_Mpeg2Stream, 0xf91d96c7, 0x8509, 0x4d0b, 0xab, 0x26, 0xa0,
            0xdd, 0x10, 0x90, 0x4b, 0xb7);
#ifdef __cplusplus
class DECLSPEC_UUID("f91d96c7-8509-4d0b-ab26-a0dd10904bb7") Mpeg2Stream;
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(Mpeg2Stream, 0xf91d96c7, 0x8509, 0x4d0b, 0xab, 0x26, 0xa0, 0xdd,
                0x10, 0x90, 0x4b, 0xb7)
#endif
#endif
/*****************************************************************************
 * Mpeg2Data coclass
 */
DEFINE_GUID(CLSID_Mpeg2Data, 0xc666e115, 0xbb62, 0x4027, 0xa1, 0x13, 0x82, 0xd6,
            0x43, 0xfe, 0x2d, 0x99);
#ifdef __cplusplus
class DECLSPEC_UUID("c666e115-bb62-4027-a113-82d643fe2d99") Mpeg2Data;
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(Mpeg2Data, 0xc666e115, 0xbb62, 0x4027, 0xa1, 0x13, 0x82, 0xd6,
                0x43, 0xfe, 0x2d, 0x99)
#endif
#endif
