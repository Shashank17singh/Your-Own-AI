...
#define SQL_ODBC_KEYWORDS                                                      \
  ...
  "YEAR,ZONE"
SQLRETURN SQL_API SQLBrowseConnect(SQLHDBC hdbc, SQLCHAR *szConnStrIn,
...
SQLRETURN SQL_API SQLPrimaryKeys(SQLHSTMT hstmt, SQLCHAR *szCatalogName,
...
SQLRETURN SQL_API SQLProcedures(SQLHSTMT hstmt, SQLCHAR *szCatalogName,
                                SQLSMALLINT cbCatalogName,
...
SQLRETURN SQL_API SQLTablePrivileges(SQLHSTMT hstmt, SQLCHAR *szCatalogName,
                                     SQLSMALLINT cbCatalogName,
                                     SQLCHAR *szSchemaName,
...
#if (ODBCVER >= 0x0300)
#ifndef RC_INVOKED
SQLRETURN SQL_API SQLAllocHandleStd(SQLSMALLINT fHandleType, SQLHANDLE hInput,
                                    SQLHANDLE *phOutput);
#endif
#endif
