...
#endif
typedef VOID(CALLBACK *TCI_NOTIFY_HANDLER)(HANDLE ClRegCtx, HANDLE ClIfcCtx,
                                           ULONG Event, HANDLE SubCode,
                                           ULONG BufSize, PVOID Buffer);
typedef VOID(CALLBACK *TCI_ADD_FLOW_COMPLETE_HANDLER)(HANDLE ClFlowCtx,
                                                      ULONG Status);
typedef VOID(CALLBACK *TCI_MOD_FLOW_COMPLETE_HANDLER)(HANDLE ClFlowCtx,
                                                      ULONG Status);
typedef VOID(CALLBACK *TCI_DEL_FLOW_COMPLETE_HANDLER)(HANDLE ClFlowCtx,
                                                      ULONG Status);
...
ULONG WINAPI TcEnumerateInterfaces(HANDLE ClientHandle, PULONG pBufferSize,
                                   PTC_IFC_DESCRIPTOR InterfaceBuffer);
ULONG WINAPI TcOpenInterfaceA(LPSTR pInterfaceName, HANDLE ClientHandle,
                              HANDLE ClIfcCtx, PHANDLE pIfcHandle);
ULONG WINAPI TcOpenInterfaceW(LPWSTR pInterfaceName, HANDLE ClientHandle,
                              HANDLE ClIfcCtx, PHANDLE pIfcHandle);
ULONG WINAPI TcCloseInterface(HANDLE IfcHandle);
ULONG WINAPI TcQueryInterface(HANDLE IfcHandle, LPGUID pGuidParam,
                              BOOLEAN NotifyChange, PULONG pBufferSize,
                              PVOID Buffer);
ULONG WINAPI TcSetInterface(HANDLE IfcHandle, LPGUID pGuidParam,
                            ULONG BufferSize, PVOID Buffer);
ULONG WINAPI TcQueryFlowA(LPSTR pFlowName, LPGUID pGuidParam,
                          PULONG pBufferSize, PVOID Buffer);
ULONG WINAPI TcQueryFlowW(LPWSTR pFlowName, LPGUID pGuidParam,
                          PULONG pBufferSize, PVOID Buffer);
ULONG WINAPI TcSetFlowA(LPSTR pFlowName, LPGUID pGuidParam, ULONG BufferSize,
                        PVOID Buffer);
ULONG WINAPI TcSetFlowW(LPWSTR pFlowName, LPGUID pGuidParam, ULONG BufferSize,
                        PVOID Buffer);
ULONG WINAPI TcAddFlow(HANDLE IfcHandle, HANDLE ClFlowCtx, ULONG Flags,
...
ULONG WINAPI TcAddFilter(HANDLE FlowHandle, PTC_GEN_FILTER pGenericFilter,
...
ULONG WINAPI TcEnumerateFlows(HANDLE IfcHandle, PHANDLE pEnumHandle,
                              PULONG pFlowCount, PULONG pBufSize,
