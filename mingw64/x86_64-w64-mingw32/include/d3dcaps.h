...
typedef HRESULT(CALLBACK *LPD3DENUMDEVICESCALLBACK)(
    GUID *guid, char *description, char *name, D3DDEVICEDESC *hal_desc,
    D3DDEVICEDESC *hel_desc, void *ctx);
typedef HRESULT(CALLBACK *LPD3DENUMDEVICESCALLBACK7)(char *description,
                                                     char *name,
                                                     D3DDEVICEDESC7 *desc,
                                                     void *ctx);
...
#define D3DDEBCAPS_MEM                                                         \
  (D3DDEBCAPS_SYSTEMMEMORY | D3DDEBCAPS_VIDEOMEMORY) /* = 0x3 */
