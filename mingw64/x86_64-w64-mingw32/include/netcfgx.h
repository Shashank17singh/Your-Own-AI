...
#define NETCFG_E_ALREADY_INITIALIZED                                           \
  MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, 0xa020)
#define NETCFG_E_NOT_INITIALIZED                                               \
  MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, 0xa021)
...
#define NETCFG_E_ACTIVE_RAS_CONNECTIONS                                        \
  MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, 0xa026)
#define NETCFG_E_ADAPTER_NOT_FOUND                                             \
  MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, 0xa027)
#define NETCFG_E_COMPONENT_REMOVED_PENDING_REBOOT                              \
  MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, 0xa028)
#define NETCFG_E_MAX_FILTER_LIMIT                                              \
  MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, 0xa029)
#define NETCFG_E_VMSWITCH_ACTIVE_OVER_ADAPTER                                  \
  MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, 0xa02a)
#define NETCFG_E_DUPLICATE_INSTANCEID                                          \
  MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, 0xa02b)
#define NETCFG_S_REBOOT MAKE_HRESULT(SEVERITY_SUCCESS, FACILITY_ITF, 0xa020)
#define NETCFG_S_DISABLE_QUERY                                                 \
  MAKE_HRESULT(SEVERITY_SUCCESS, FACILITY_ITF, 0xa022)
#define NETCFG_S_STILL_REFERENCED                                              \
  MAKE_HRESULT(SEVERITY_SUCCESS, FACILITY_ITF, 0xa023)
#define NETCFG_S_CAUSED_SETUP_CHANGE                                           \
  MAKE_HRESULT(SEVERITY_SUCCESS, FACILITY_ITF, 0xa024)
...
DEFINE_GUID(IID_IEnumNetCfgBindingInterface, 0xc0e8ae90, 0x306e, 0x11d1, 0xaa,
            0xcf, 0x00, 0x80, 0x5f, 0xc1, 0x27, 0x0e);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("c0e8ae90-306e-11d1-aacf-00805fc1270e")
IEnumNetCfgBindingInterface : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE Next(
      ULONG celt, INetCfgBindingInterface * *rgelt, ULONG * pceltFetched) = 0;
  virtual HRESULT STDMETHODCALLTYPE Skip(ULONG celt) = 0;
  virtual HRESULT STDMETHODCALLTYPE Reset() = 0;
  virtual HRESULT STDMETHODCALLTYPE Clone(IEnumNetCfgBindingInterface *
                                          *ppenum) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IEnumNetCfgBindingInterface, 0xc0e8ae90, 0x306e, 0x11d1, 0xaa,
                0xcf, 0x00, 0x80, 0x5f, 0xc1, 0x27, 0x0e)
#endif
#else
typedef struct IEnumNetCfgBindingInterfaceVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IEnumNetCfgBindingInterface *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IEnumNetCfgBindingInterface *This);
  ULONG(STDMETHODCALLTYPE *Release)(IEnumNetCfgBindingInterface *This);
  /*** IEnumNetCfgBindingInterface methods ***/
  HRESULT(STDMETHODCALLTYPE *Next)(IEnumNetCfgBindingInterface *This,
                                   ULONG celt, INetCfgBindingInterface **rgelt,
                                   ULONG *pceltFetched);
  HRESULT(STDMETHODCALLTYPE *Skip)(IEnumNetCfgBindingInterface *This,
                                   ULONG celt);
  HRESULT(STDMETHODCALLTYPE *Reset)(IEnumNetCfgBindingInterface *This);
  HRESULT(STDMETHODCALLTYPE *Clone)(IEnumNetCfgBindingInterface *This,
...
IEnumNetCfgBindingInterface_QueryInterface(IEnumNetCfgBindingInterface *This,
                                           REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IEnumNetCfgBindingInterface_AddRef(IEnumNetCfgBindingInterface *This) {
...
/*** IEnumNetCfgBindingInterface methods ***/
static inline HRESULT
IEnumNetCfgBindingInterface_Next(IEnumNetCfgBindingInterface *This, ULONG celt,
                                 INetCfgBindingInterface **rgelt,
                                 ULONG *pceltFetched) {
  return This->lpVtbl->Next(This, celt, rgelt, pceltFetched);
}
static inline HRESULT
IEnumNetCfgBindingInterface_Skip(IEnumNetCfgBindingInterface *This,
                                 ULONG celt) {
  return This->lpVtbl->Skip(This, celt);
}
static inline HRESULT
IEnumNetCfgBindingInterface_Reset(IEnumNetCfgBindingInterface *This) {
  return This->lpVtbl->Reset(This);
}
static inline HRESULT
IEnumNetCfgBindingInterface_Clone(IEnumNetCfgBindingInterface *This,
                                  IEnumNetCfgBindingInterface **ppenum) {
...
DEFINE_GUID(IID_IEnumNetCfgBindingPath, 0xc0e8ae91, 0x306e, 0x11d1, 0xaa, 0xcf,
            0x00, 0x80, 0x5f, 0xc1, 0x27, 0x0e);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("c0e8ae91-306e-11d1-aacf-00805fc1270e")
IEnumNetCfgBindingPath : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE Next(
      ULONG celt, INetCfgBindingPath * *rgelt, ULONG * pceltFetched) = 0;
  virtual HRESULT STDMETHODCALLTYPE Skip(ULONG celt) = 0;
  virtual HRESULT STDMETHODCALLTYPE Reset() = 0;
  virtual HRESULT STDMETHODCALLTYPE Clone(IEnumNetCfgBindingPath * *ppenum) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IEnumNetCfgBindingPath, 0xc0e8ae91, 0x306e, 0x11d1, 0xaa, 0xcf,
                0x00, 0x80, 0x5f, 0xc1, 0x27, 0x0e)
#endif
#else
typedef struct IEnumNetCfgBindingPathVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IEnumNetCfgBindingPath *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IEnumNetCfgBindingPath *This);
  ULONG(STDMETHODCALLTYPE *Release)(IEnumNetCfgBindingPath *This);
  /*** IEnumNetCfgBindingPath methods ***/
  HRESULT(STDMETHODCALLTYPE *Next)(IEnumNetCfgBindingPath *This, ULONG celt,
                                   INetCfgBindingPath **rgelt,
                                   ULONG *pceltFetched);
  HRESULT(STDMETHODCALLTYPE *Skip)(IEnumNetCfgBindingPath *This, ULONG celt);
  HRESULT(STDMETHODCALLTYPE *Reset)(IEnumNetCfgBindingPath *This);
...
/*** IUnknown methods ***/
static inline HRESULT
IEnumNetCfgBindingPath_QueryInterface(IEnumNetCfgBindingPath *This, REFIID riid,
                                      void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IEnumNetCfgBindingPath_AddRef(IEnumNetCfgBindingPath *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
...
/*** IEnumNetCfgBindingPath methods ***/
static inline HRESULT IEnumNetCfgBindingPath_Next(IEnumNetCfgBindingPath *This,
                                                  ULONG celt,
                                                  INetCfgBindingPath **rgelt,
                                                  ULONG *pceltFetched) {
  return This->lpVtbl->Next(This, celt, rgelt, pceltFetched);
}
static inline HRESULT IEnumNetCfgBindingPath_Skip(IEnumNetCfgBindingPath *This,
                                                  ULONG celt) {
  return This->lpVtbl->Skip(This, celt);
}
static inline HRESULT
IEnumNetCfgBindingPath_Reset(IEnumNetCfgBindingPath *This) {
  return This->lpVtbl->Reset(This);
}
static inline HRESULT
IEnumNetCfgBindingPath_Clone(IEnumNetCfgBindingPath *This,
                             IEnumNetCfgBindingPath **ppenum) {
  return This->lpVtbl->Clone(This, ppenum);
}
#endif
...
DEFINE_GUID(IID_IEnumNetCfgComponent, 0xc0e8ae92, 0x306e, 0x11d1, 0xaa, 0xcf,
            0x00, 0x80, 0x5f, 0xc1, 0x27, 0x0e);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("c0e8ae92-306e-11d1-aacf-00805fc1270e")
IEnumNetCfgComponent : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE Next(ULONG celt, INetCfgComponent * *rgelt,
                                         ULONG * pceltFetched) = 0;
  virtual HRESULT STDMETHODCALLTYPE Skip(ULONG celt) = 0;
  virtual HRESULT STDMETHODCALLTYPE Reset() = 0;
  virtual HRESULT STDMETHODCALLTYPE Clone(IEnumNetCfgComponent * *ppenum) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IEnumNetCfgComponent, 0xc0e8ae92, 0x306e, 0x11d1, 0xaa, 0xcf,
                0x00, 0x80, 0x5f, 0xc1, 0x27, 0x0e)
#endif
#else
typedef struct IEnumNetCfgComponentVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IEnumNetCfgComponent *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IEnumNetCfgComponent *This);
  ULONG(STDMETHODCALLTYPE *Release)(IEnumNetCfgComponent *This);
  /*** IEnumNetCfgComponent methods ***/
  HRESULT(STDMETHODCALLTYPE *Next)(IEnumNetCfgComponent *This, ULONG celt,
                                   INetCfgComponent **rgelt,
                                   ULONG *pceltFetched);
  HRESULT(STDMETHODCALLTYPE *Skip)(IEnumNetCfgComponent *This, ULONG celt);
  HRESULT(STDMETHODCALLTYPE *Reset)(IEnumNetCfgComponent *This);
  HRESULT(STDMETHODCALLTYPE *Clone)(IEnumNetCfgComponent *This,
                                    IEnumNetCfgComponent **ppenum);
  END_INTERFACE
} IEnumNetCfgComponentVtbl;
interface IEnumNetCfgComponent { CONST_VTBL IEnumNetCfgComponentVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
IEnumNetCfgComponent_QueryInterface(IEnumNetCfgComponent *This, REFIID riid,
                                    void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IEnumNetCfgComponent methods ***/
static inline HRESULT IEnumNetCfgComponent_Next(IEnumNetCfgComponent *This,
                                                ULONG celt,
                                                INetCfgComponent **rgelt,
                                                ULONG *pceltFetched) {
  return This->lpVtbl->Next(This, celt, rgelt, pceltFetched);
}
static inline HRESULT IEnumNetCfgComponent_Skip(IEnumNetCfgComponent *This,
                                                ULONG celt) {
  return This->lpVtbl->Skip(This, celt);
}
...
static inline HRESULT
IEnumNetCfgComponent_Clone(IEnumNetCfgComponent *This,
                           IEnumNetCfgComponent **ppenum) {
  return This->lpVtbl->Clone(This, ppenum);
}
#endif
...
DEFINE_GUID(IID_INetCfg, 0xc0e8ae93, 0x306e, 0x11d1, 0xaa, 0xcf, 0x00, 0x80,
            0x5f, 0xc1, 0x27, 0x0e);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("c0e8ae93-306e-11d1-aacf-00805fc1270e")
INetCfg : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE Initialize(PVOID pvReserved) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE EnumComponents(
      const GUID *pguidClass, IEnumNetCfgComponent **ppenumComponent) = 0;
  virtual HRESULT STDMETHODCALLTYPE FindComponent(
      LPCWSTR pszwInfId, INetCfgComponent * *pComponent) = 0;
  virtual HRESULT STDMETHODCALLTYPE QueryNetCfgClass(
      const GUID *pguidClass, REFIID riid, void **ppvObject) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(INetCfg, 0xc0e8ae93, 0x306e, 0x11d1, 0xaa, 0xcf, 0x00, 0x80,
                0x5f, 0xc1, 0x27, 0x0e)
#endif
#else
typedef struct INetCfgVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INetCfg *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *EnumComponents)(
      INetCfg *This, const GUID *pguidClass,
      IEnumNetCfgComponent **ppenumComponent);
  HRESULT(STDMETHODCALLTYPE *FindComponent)(INetCfg *This, LPCWSTR pszwInfId,
                                            INetCfgComponent **pComponent);
  HRESULT(STDMETHODCALLTYPE *QueryNetCfgClass)(INetCfg *This,
                                               const GUID *pguidClass,
                                               REFIID riid, void **ppvObject);
  END_INTERFACE
} INetCfgVtbl;
interface INetCfg { CONST_VTBL INetCfgVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT INetCfg_QueryInterface(INetCfg *This, REFIID riid,
                                             void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
static inline HRESULT
INetCfg_EnumComponents(INetCfg *This, const GUID *pguidClass,
                       IEnumNetCfgComponent **ppenumComponent) {
  return This->lpVtbl->EnumComponents(This, pguidClass, ppenumComponent);
}
static inline HRESULT INetCfg_FindComponent(INetCfg *This, LPCWSTR pszwInfId,
                                            INetCfgComponent **pComponent) {
  return This->lpVtbl->FindComponent(This, pszwInfId, pComponent);
}
static inline HRESULT INetCfg_QueryNetCfgClass(INetCfg *This,
                                               const GUID *pguidClass,
                                               REFIID riid, void **ppvObject) {
 ...
 * CNetCfg coclass
 */
DEFINE_GUID(CLSID_CNetCfg, 0x5b035261, 0x40f9, 0x11d1, 0xaa, 0xec, 0x00, 0x80,
            0x5f, 0xc1, 0x27, 0x0e);
#ifdef __cplusplus
class DECLSPEC_UUID("5b035261-40f9-11d1-aaec-00805fc1270e") CNetCfg;
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(CNetCfg, 0x5b035261, 0x40f9, 0x11d1, 0xaa, 0xec, 0x00, 0x80,
                0x5f, 0xc1, 0x27, 0x0e)
#endif
#endif
/*****************************************************************************
...
DEFINE_GUID(IID_INetCfgLock, 0xc0e8ae9f, 0x306e, 0x11d1, 0xaa, 0xcf, 0x00, 0x80,
            0x5f, 0xc1, 0x27, 0x0e);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
INetCfgLock : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE AcquireWriteLock(
      DWORD cmsTimeout, LPCWSTR pszwClientDescription,
      LPWSTR * ppszwClientDescription) = 0;
  virtual HRESULT STDMETHODCALLTYPE ReleaseWriteLock() = 0;
  virtual HRESULT STDMETHODCALLTYPE IsWriteLocked(LPWSTR *
                                                  ppszwClientDescription) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(INetCfgLock, 0xc0e8ae9f, 0x306e, 0x11d1, 0xaa, 0xcf, 0x00, 0x80,
                0x5f, 0xc1, 0x27, 0x0e)
#endif
#else
typedef struct INetCfgLockVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INetCfgLock *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(INetCfgLock *This);
  ULONG(STDMETHODCALLTYPE *Release)(INetCfgLock *This);
  /*** INetCfgLock methods ***/
  HRESULT(STDMETHODCALLTYPE *AcquireWriteLock)(INetCfgLock *This,
                                               DWORD cmsTimeout,
                                               LPCWSTR pszwClientDescription,
                                               LPWSTR *ppszwClientDescription);
  HRESULT(STDMETHODCALLTYPE *ReleaseWriteLock)(INetCfgLock *This);
  HRESULT(STDMETHODCALLTYPE *IsWriteLocked)(INetCfgLock *This,
                                            LPWSTR *ppszwClientDescription);
  END_INTERFACE
} INetCfgLockVtbl;
interface INetCfgLock { CONST_VTBL INetCfgLockVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** INetCfgLock methods ***/
#define INetCfgLock_AcquireWriteLock(This, cmsTimeout, pszwClientDescription,  \
                                     ppszwClientDescription)                   \
  (This)->lpVtbl->AcquireWriteLock(This, cmsTimeout, pszwClientDescription,    \
                                   ppszwClientDescription)
...
#else
/*** IUnknown methods ***/
static inline HRESULT INetCfgLock_QueryInterface(INetCfgLock *This, REFIID riid,
                                                 void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** INetCfgLock methods ***/
static inline HRESULT
INetCfgLock_AcquireWriteLock(INetCfgLock *This, DWORD cmsTimeout,
                             LPCWSTR pszwClientDescription,
                             LPWSTR *ppszwClientDescription) {
  return This->lpVtbl->AcquireWriteLock(This, cmsTimeout, pszwClientDescription,
                                        ppszwClientDescription);
}
...
static inline HRESULT
INetCfgLock_IsWriteLocked(INetCfgLock *This, LPWSTR *ppszwClientDescription) {
...
DEFINE_GUID(IID_INetCfgBindingInterface, 0xc0e8ae94, 0x306e, 0x11d1, 0xaa, 0xcf,
            0x00, 0x80, 0x5f, 0xc1, 0x27, 0x0e);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("c0e8ae94-306e-11d1-aacf-00805fc1270e")
INetCfgBindingInterface : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetName(LPWSTR * ppszwInterfaceName) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetUpperComponent(INetCfgComponent *
                                                      *ppnccItem) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetLowerComponent(INetCfgComponent *
                                                      *ppnccItem) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(INetCfgBindingInterface, 0xc0e8ae94, 0x306e, 0x11d1, 0xaa, 0xcf,
                0x00, 0x80, 0x5f, 0xc1, 0x27, 0x0e)
#endif
#else
typedef struct INetCfgBindingInterfaceVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INetCfgBindingInterface *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(INetCfgBindingInterface *This);
  ULONG(STDMETHODCALLTYPE *Release)(INetCfgBindingInterface *This);
  /*** INetCfgBindingInterface methods ***/
  HRESULT(STDMETHODCALLTYPE *GetName)(INetCfgBindingInterface *This,
                                      LPWSTR *ppszwInterfaceName);
  HRESULT(STDMETHODCALLTYPE *GetUpperComponent)(INetCfgBindingInterface *This,
                                                INetCfgComponent **ppnccItem);
  HRESULT(STDMETHODCALLTYPE *GetLowerComponent)(INetCfgBindingInterface *This,
                                                INetCfgComponent **ppnccItem);
  END_INTERFACE
...
/*** IUnknown methods ***/
static inline HRESULT
INetCfgBindingInterface_QueryInterface(INetCfgBindingInterface *This,
                                       REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
INetCfgBindingInterface_AddRef(INetCfgBindingInterface *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
...
/*** INetCfgBindingInterface methods ***/
static inline HRESULT
INetCfgBindingInterface_GetName(INetCfgBindingInterface *This,
                                LPWSTR *ppszwInterfaceName) {
  return This->lpVtbl->GetName(This, ppszwInterfaceName);
}
static inline HRESULT
INetCfgBindingInterface_GetUpperComponent(INetCfgBindingInterface *This,
                                          INetCfgComponent **ppnccItem) {
  return This->lpVtbl->GetUpperComponent(This, ppnccItem);
}
static inline HRESULT
INetCfgBindingInterface_GetLowerComponent(INetCfgBindingInterface *This,
                                          INetCfgComponent **ppnccItem) {
...
DEFINE_GUID(IID_INetCfgBindingPath, 0xc0e8ae96, 0x306e, 0x11d1, 0xaa, 0xcf,
            0x00, 0x80, 0x5f, 0xc1, 0x27, 0x0e);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("c0e8ae96-306e-11d1-aacf-00805fc1270e")
INetCfgBindingPath : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE IsSamePathAs(INetCfgBindingPath *
                                                 pPath) = 0;
  virtual HRESULT STDMETHODCALLTYPE IsSubPathOf(INetCfgBindingPath * pPath) = 0;
  virtual HRESULT STDMETHODCALLTYPE IsEnabled() = 0;
  virtual HRESULT STDMETHODCALLTYPE Enable(WINBOOL fEnable) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetPathToken(LPWSTR * ppszwPathToken) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetOwner(INetCfgComponent *
                                             *ppComponent) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetDepth(ULONG * pcInterfaces) = 0;
  virtual HRESULT STDMETHODCALLTYPE EnumBindingInterfaces(
      IEnumNetCfgBindingInterface * *ppenumInterface) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(INetCfgBindingPath, 0xc0e8ae96, 0x306e, 0x11d1, 0xaa, 0xcf,
                0x00, 0x80, 0x5f, 0xc1, 0x27, 0x0e)
#endif
#else
typedef struct INetCfgBindingPathVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INetCfgBindingPath *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(INetCfgBindingPath *This);
  ULONG(STDMETHODCALLTYPE *Release)(INetCfgBindingPath *This);
  /*** INetCfgBindingPath methods ***/
  HRESULT(STDMETHODCALLTYPE *IsSamePathAs)(INetCfgBindingPath *This,
                                           INetCfgBindingPath *pPath);
  HRESULT(STDMETHODCALLTYPE *IsSubPathOf)(INetCfgBindingPath *This,
                                          INetCfgBindingPath *pPath);
  HRESULT(STDMETHODCALLTYPE *IsEnabled)(INetCfgBindingPath *This);
  HRESULT(STDMETHODCALLTYPE *Enable)(INetCfgBindingPath *This, WINBOOL fEnable);
  HRESULT(STDMETHODCALLTYPE *GetPathToken)(INetCfgBindingPath *This,
                                           LPWSTR *ppszwPathToken);
  HRESULT(STDMETHODCALLTYPE *GetOwner)(INetCfgBindingPath *This,
                                       INetCfgComponent **ppComponent);
  HRESULT(STDMETHODCALLTYPE *GetDepth)(INetCfgBindingPath *This,
                                       ULONG *pcInterfaces);
...
interface INetCfgBindingPath { CONST_VTBL INetCfgBindingPathVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
INetCfgBindingPath_QueryInterface(INetCfgBindingPath *This, REFIID riid,
                                  void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** INetCfgBindingPath methods ***/
static inline HRESULT
INetCfgBindingPath_IsSamePathAs(INetCfgBindingPath *This,
                                INetCfgBindingPath *pPath) {
  return This->lpVtbl->IsSamePathAs(This, pPath);
}
static inline HRESULT
INetCfgBindingPath_IsSubPathOf(INetCfgBindingPath *This,
                               INetCfgBindingPath *pPath) {
...
static inline HRESULT INetCfgBindingPath_Enable(INetCfgBindingPath *This,
                                                WINBOOL fEnable) {
  return This->lpVtbl->Enable(This, fEnable);
}
static inline HRESULT INetCfgBindingPath_GetPathToken(INetCfgBindingPath *This,
                                                      LPWSTR *ppszwPathToken) {
  return This->lpVtbl->GetPathToken(This, ppszwPathToken);
}
static inline HRESULT
INetCfgBindingPath_GetOwner(INetCfgBindingPath *This,
                            INetCfgComponent **ppComponent) {
  return This->lpVtbl->GetOwner(This, ppComponent);
}
static inline HRESULT INetCfgBindingPath_GetDepth(INetCfgBindingPath *This,
                                                  ULONG *pcInterfaces) {
  return This->lpVtbl->GetDepth(This, pcInterfaces);
}
static inline HRESULT INetCfgBindingPath_EnumBindingInterfaces(
    INetCfgBindingPath *This, IEnumNetCfgBindingInterface **ppenumInterface) {
...
DEFINE_GUID(IID_INetCfgClass, 0xc0e8ae97, 0x306e, 0x11d1, 0xaa, 0xcf, 0x00,
            0x80, 0x5f, 0xc1, 0x27, 0x0e);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("c0e8ae97-306e-11d1-aacf-00805fc1270e")
INetCfgClass : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE FindComponent(
      LPCWSTR pszwInfId, INetCfgComponent * *ppnccItem) = 0;
  virtual HRESULT STDMETHODCALLTYPE EnumComponents(IEnumNetCfgComponent *
                                                   *ppenumComponent) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(INetCfgClass, 0xc0e8ae97, 0x306e, 0x11d1, 0xaa, 0xcf, 0x00,
                0x80, 0x5f, 0xc1, 0x27, 0x0e)
#endif
#else
typedef struct INetCfgClassVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INetCfgClass *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(INetCfgClass *This);
  ULONG(STDMETHODCALLTYPE *Release)(INetCfgClass *This);
  /*** INetCfgClass methods ***/
  HRESULT(STDMETHODCALLTYPE *FindComponent)(INetCfgClass *This,
                                            LPCWSTR pszwInfId,
                                            INetCfgComponent **ppnccItem);
  HRESULT(STDMETHODCALLTYPE *EnumComponents)(
      INetCfgClass *This, IEnumNetCfgComponent **ppenumComponent);
  END_INTERFACE
} INetCfgClassVtbl;
interface INetCfgClass { CONST_VTBL INetCfgClassVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
INetCfgClass_QueryInterface(INetCfgClass *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** INetCfgClass methods ***/
static inline HRESULT INetCfgClass_FindComponent(INetCfgClass *This,
                                                 LPCWSTR pszwInfId,
                                                 INetCfgComponent **ppnccItem) {
  return This->lpVtbl->FindComponent(This, pszwInfId, ppnccItem);
}
static inline HRESULT
INetCfgClass_EnumComponents(INetCfgClass *This,
                            IEnumNetCfgComponent **ppenumComponent) {
...
DEFINE_GUID(IID_INetCfgClassSetup, 0xc0e8ae9d, 0x306e, 0x11d1, 0xaa, 0xcf, 0x00,
            0x80, 0x5f, 0xc1, 0x27, 0x0e);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
INetCfgClassSetup : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE SelectAndInstall(
      HWND hwndParent, OBO_TOKEN * pOboToken,
      INetCfgComponent * *ppnccItem) = 0;
  virtual HRESULT STDMETHODCALLTYPE Install(
      LPCWSTR pszwInfId, OBO_TOKEN * pOboToken, DWORD dwSetupFlags,
      DWORD dwUpgradeFromBuildNo, LPCWSTR pszwAnswerFile,
      LPCWSTR pszwAnswerSections, INetCfgComponent * *ppnccItem) = 0;
  virtual HRESULT STDMETHODCALLTYPE DeInstall(INetCfgComponent * pComponent,
                                              OBO_TOKEN * pOboToken,
                                              LPWSTR * pmszwRefs) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(INetCfgClassSetup, 0xc0e8ae9d, 0x306e, 0x11d1, 0xaa, 0xcf, 0x00,
                0x80, 0x5f, 0xc1, 0x27, 0x0e)
#endif
#else
typedef struct INetCfgClassSetupVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INetCfgClassSetup *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(INetCfgClassSetup *This);
  ULONG(STDMETHODCALLTYPE *Release)(INetCfgClassSetup *This);
  /*** INetCfgClassSetup methods ***/
  HRESULT(STDMETHODCALLTYPE *SelectAndInstall)(INetCfgClassSetup *This,
                                               HWND hwndParent,
                                               OBO_TOKEN *pOboToken,
                                               INetCfgComponent **ppnccItem);
  HRESULT(STDMETHODCALLTYPE *Install)(
      INetCfgClassSetup *This, LPCWSTR pszwInfId, OBO_TOKEN *pOboToken,
      DWORD dwSetupFlags, DWORD dwUpgradeFromBuildNo, LPCWSTR pszwAnswerFile,
      LPCWSTR pszwAnswerSections, INetCfgComponent **ppnccItem);
  HRESULT(STDMETHODCALLTYPE *DeInstall)(INetCfgClassSetup *This,
                                        INetCfgComponent *pComponent,
                                        OBO_TOKEN *pOboToken,
                                        LPWSTR *pmszwRefs);
  END_INTERFACE
} INetCfgClassSetupVtbl;
interface INetCfgClassSetup { CONST_VTBL INetCfgClassSetupVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** INetCfgClassSetup methods ***/
#define INetCfgClassSetup_SelectAndInstall(This, hwndParent, pOboToken,        \
                                           ppnccItem)                          \
  (This)->lpVtbl->SelectAndInstall(This, hwndParent, pOboToken, ppnccItem)
#define INetCfgClassSetup_Install(This, pszwInfId, pOboToken, dwSetupFlags,    \
                                  dwUpgradeFromBuildNo, pszwAnswerFile,        \
                                  pszwAnswerSections, ppnccItem)               \
  (This)->lpVtbl->Install(This, pszwInfId, pOboToken, dwSetupFlags,            \
                          dwUpgradeFromBuildNo, pszwAnswerFile,                \
                          pszwAnswerSections, ppnccItem)
...
#else
/*** IUnknown methods ***/
static inline HRESULT INetCfgClassSetup_QueryInterface(INetCfgClassSetup *This,
                                                       REFIID riid,
                                                       void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** INetCfgClassSetup methods ***/
static inline HRESULT
INetCfgClassSetup_SelectAndInstall(INetCfgClassSetup *This, HWND hwndParent,
                                   OBO_TOKEN *pOboToken,
                                   INetCfgComponent **ppnccItem) {
  return This->lpVtbl->SelectAndInstall(This, hwndParent, pOboToken, ppnccItem);
}
static inline HRESULT INetCfgClassSetup_Install(
    INetCfgClassSetup *This, LPCWSTR pszwInfId, OBO_TOKEN *pOboToken,
    DWORD dwSetupFlags, DWORD dwUpgradeFromBuildNo, LPCWSTR pszwAnswerFile,
    LPCWSTR pszwAnswerSections, INetCfgComponent **ppnccItem) {
  return This->lpVtbl->Install(This, pszwInfId, pOboToken, dwSetupFlags,
                               dwUpgradeFromBuildNo, pszwAnswerFile,
                               pszwAnswerSections, ppnccItem);
}
static inline HRESULT INetCfgClassSetup_DeInstall(INetCfgClassSetup *This,
                                                  INetCfgComponent *pComponent,
                                                  OBO_TOKEN *pOboToken,
                                                  LPWSTR *pmszwRefs) {
...
DEFINE_GUID(IID_INetCfgClassSetup2, 0xc0e8aea0, 0x306e, 0x11d1, 0xaa, 0xcf,
            0x00, 0x80, 0x5f, 0xc1, 0x27, 0x0e);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
INetCfgClassSetup2 : public INetCfgClassSetup {
  virtual HRESULT STDMETHODCALLTYPE UpdateNonEnumeratedComponent(
      INetCfgComponent * pIComp, DWORD dwSetupFlags,
      DWORD dwUpgradeFromBuildNo) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(INetCfgClassSetup2, 0xc0e8aea0, 0x306e, 0x11d1, 0xaa, 0xcf,
                0x00, 0x80, 0x5f, 0xc1, 0x27, 0x0e)
#endif
#else
typedef struct INetCfgClassSetup2Vtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INetCfgClassSetup2 *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(INetCfgClassSetup2 *This);
  ULONG(STDMETHODCALLTYPE *Release)(INetCfgClassSetup2 *This);
  /*** INetCfgClassSetup methods ***/
  HRESULT(STDMETHODCALLTYPE *SelectAndInstall)(INetCfgClassSetup2 *This,
                                               HWND hwndParent,
                                               OBO_TOKEN *pOboToken,
                                               INetCfgComponent **ppnccItem);
  HRESULT(STDMETHODCALLTYPE *Install)(
      INetCfgClassSetup2 *This, LPCWSTR pszwInfId, OBO_TOKEN *pOboToken,
      DWORD dwSetupFlags, DWORD dwUpgradeFromBuildNo, LPCWSTR pszwAnswerFile,
      LPCWSTR pszwAnswerSections, INetCfgComponent **ppnccItem);
  HRESULT(STDMETHODCALLTYPE *DeInstall)(INetCfgClassSetup2 *This,
                                        INetCfgComponent *pComponent,
                                        OBO_TOKEN *pOboToken,
                                        LPWSTR *pmszwRefs);
  /*** INetCfgClassSetup2 methods ***/
  HRESULT(STDMETHODCALLTYPE *UpdateNonEnumeratedComponent)(
      INetCfgClassSetup2 *This, INetCfgComponent *pIComp, DWORD dwSetupFlags,
      DWORD dwUpgradeFromBuildNo);
  END_INTERFACE
} INetCfgClassSetup2Vtbl;
interface INetCfgClassSetup2 { CONST_VTBL INetCfgClassSetup2Vtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** INetCfgClassSetup methods ***/
#define INetCfgClassSetup2_SelectAndInstall(This, hwndParent, pOboToken,       \
                                            ppnccItem)                         \
  (This)->lpVtbl->SelectAndInstall(This, hwndParent, pOboToken, ppnccItem)
#define INetCfgClassSetup2_Install(This, pszwInfId, pOboToken, dwSetupFlags,   \
                                   dwUpgradeFromBuildNo, pszwAnswerFile,       \
                                   pszwAnswerSections, ppnccItem)              \
  (This)->lpVtbl->Install(This, pszwInfId, pOboToken, dwSetupFlags,            \
                          dwUpgradeFromBuildNo, pszwAnswerFile,                \
...
#define INetCfgClassSetup2_DeInstall(This, pComponent, pOboToken, pmszwRefs)   \
  (This)->lpVtbl->DeInstall(This, pComponent, pOboToken, pmszwRefs)
/*** INetCfgClassSetup2 methods ***/
#define INetCfgClassSetup2_UpdateNonEnumeratedComponent(                       \
    This, pIComp, dwSetupFlags, dwUpgradeFromBuildNo)                          \
  (This)->lpVtbl->UpdateNonEnumeratedComponent(This, pIComp, dwSetupFlags,     \
                                               dwUpgradeFromBuildNo)
#else
/*** IUnknown methods ***/
static inline HRESULT
INetCfgClassSetup2_QueryInterface(INetCfgClassSetup2 *This, REFIID riid,
                                  void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** INetCfgClassSetup methods ***/
static inline HRESULT
INetCfgClassSetup2_SelectAndInstall(INetCfgClassSetup2 *This, HWND hwndParent,
                                    OBO_TOKEN *pOboToken,
                                    INetCfgComponent **ppnccItem) {
  return This->lpVtbl->SelectAndInstall(This, hwndParent, pOboToken, ppnccItem);
}
static inline HRESULT INetCfgClassSetup2_Install(
    INetCfgClassSetup2 *This, LPCWSTR pszwInfId, OBO_TOKEN *pOboToken,
    DWORD dwSetupFlags, DWORD dwUpgradeFromBuildNo, LPCWSTR pszwAnswerFile,
    LPCWSTR pszwAnswerSections, INetCfgComponent **ppnccItem) {
  return This->lpVtbl->Install(This, pszwInfId, pOboToken, dwSetupFlags,
...
static inline HRESULT INetCfgClassSetup2_DeInstall(INetCfgClassSetup2 *This,
                                                   INetCfgComponent *pComponent,
                                                   OBO_TOKEN *pOboToken,
                                                   LPWSTR *pmszwRefs) {
  return This->lpVtbl->DeInstall(This, pComponent, pOboToken, pmszwRefs);
...
/*** INetCfgClassSetup2 methods ***/
static inline HRESULT INetCfgClassSetup2_UpdateNonEnumeratedComponent(
    INetCfgClassSetup2 *This, INetCfgComponent *pIComp, DWORD dwSetupFlags,
    DWORD dwUpgradeFromBuildNo) {
  return This->lpVtbl->UpdateNonEnumeratedComponent(This, pIComp, dwSetupFlags,
                                                    dwUpgradeFromBuildNo);
}
#endif
#endif
...
DEFINE_GUID(IID_INetCfgComponent, 0xc0e8ae99, 0x306e, 0x11d1, 0xaa, 0xcf, 0x00,
            0x80, 0x5f, 0xc1, 0x27, 0x0e);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("c0e8ae99-306e-11d1-aacf-00805fc1270e")
INetCfgComponent : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetDisplayName(LPWSTR *
                                                   ppszwDisplayName) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetDisplayName(LPCWSTR pszwDisplayName) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetHelpText(LPWSTR * pszwHelpText) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetId(LPWSTR * ppszwId) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetCharacteristics(
      LPDWORD pdwCharacteristics) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetInstanceGuid(GUID * pGuid) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetPnpDevNodeId(LPWSTR *
                                                    ppszwDevNodeId) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetClassGuid(GUID * pGuid) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetBindName(LPWSTR * ppszwBindName) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetDeviceStatus(ULONG * pulStatus) = 0;
  virtual HRESULT STDMETHODCALLTYPE OpenParamKey(HKEY * phkey) = 0;
  virtual HRESULT STDMETHODCALLTYPE RaisePropertyUi(
      HWND hwndParent, DWORD dwFlags, IUnknown * punkContext) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(INetCfgComponent, 0xc0e8ae99, 0x306e, 0x11d1, 0xaa, 0xcf, 0x00,
                0x80, 0x5f, 0xc1, 0x27, 0x0e)
#endif
#else
typedef struct INetCfgComponentVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INetCfgComponent *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(INetCfgComponent *This);
  ULONG(STDMETHODCALLTYPE *Release)(INetCfgComponent *This);
  /*** INetCfgComponent methods ***/
  HRESULT(STDMETHODCALLTYPE *GetDisplayName)(INetCfgComponent *This,
                                             LPWSTR *ppszwDisplayName);
  HRESULT(STDMETHODCALLTYPE *SetDisplayName)(INetCfgComponent *This,
                                             LPCWSTR pszwDisplayName);
  HRESULT(STDMETHODCALLTYPE *GetHelpText)(INetCfgComponent *This,
                                          LPWSTR *pszwHelpText);
  HRESULT(STDMETHODCALLTYPE *GetId)(INetCfgComponent *This, LPWSTR *ppszwId);
  HRESULT(STDMETHODCALLTYPE *GetCharacteristics)(INetCfgComponent *This,
                                                 LPDWORD pdwCharacteristics);
  HRESULT(STDMETHODCALLTYPE *GetInstanceGuid)(INetCfgComponent *This,
                                              GUID *pGuid);
  HRESULT(STDMETHODCALLTYPE *GetPnpDevNodeId)(INetCfgComponent *This,
                                              LPWSTR *ppszwDevNodeId);
  HRESULT(STDMETHODCALLTYPE *GetClassGuid)(INetCfgComponent *This, GUID *pGuid);
  HRESULT(STDMETHODCALLTYPE *GetBindName)(INetCfgComponent *This,
                                          LPWSTR *ppszwBindName);
  HRESULT(STDMETHODCALLTYPE *GetDeviceStatus)(INetCfgComponent *This,
                                              ULONG *pulStatus);
  HRESULT(STDMETHODCALLTYPE *OpenParamKey)(INetCfgComponent *This, HKEY *phkey);
  HRESULT(STDMETHODCALLTYPE *RaisePropertyUi)(INetCfgComponent *This,
                                              HWND hwndParent, DWORD dwFlags,
                                              IUnknown *punkContext);
  END_INTERFACE
} INetCfgComponentVtbl;
interface INetCfgComponent { CONST_VTBL INetCfgComponentVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define INetCfgComponent_RaisePropertyUi(This, hwndParent, dwFlags,            \
                                         punkContext)                          \
  (This)->lpVtbl->RaisePropertyUi(This, hwndParent, dwFlags, punkContext)
#else
/*** IUnknown methods ***/
static inline HRESULT INetCfgComponent_QueryInterface(INetCfgComponent *This,
                                                      REFIID riid,
                                                      void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** INetCfgComponent methods ***/
static inline HRESULT
INetCfgComponent_GetDisplayName(INetCfgComponent *This,
                                LPWSTR *ppszwDisplayName) {
  return This->lpVtbl->GetDisplayName(This, ppszwDisplayName);
}
static inline HRESULT INetCfgComponent_SetDisplayName(INetCfgComponent *This,
                                                      LPCWSTR pszwDisplayName) {
  return This->lpVtbl->SetDisplayName(This, pszwDisplayName);
}
static inline HRESULT INetCfgComponent_GetHelpText(INetCfgComponent *This,
                                                   LPWSTR *pszwHelpText) {
  return This->lpVtbl->GetHelpText(This, pszwHelpText);
}
static inline HRESULT INetCfgComponent_GetId(INetCfgComponent *This,
                                             LPWSTR *ppszwId) {
  return This->lpVtbl->GetId(This, ppszwId);
}
static inline HRESULT
INetCfgComponent_GetCharacteristics(INetCfgComponent *This,
                                    LPDWORD pdwCharacteristics) {
  return This->lpVtbl->GetCharacteristics(This, pdwCharacteristics);
}
static inline HRESULT INetCfgComponent_GetInstanceGuid(INetCfgComponent *This,
                                                       GUID *pGuid) {
  return This->lpVtbl->GetInstanceGuid(This, pGuid);
}
static inline HRESULT INetCfgComponent_GetPnpDevNodeId(INetCfgComponent *This,
                                                       LPWSTR *ppszwDevNodeId) {
  return This->lpVtbl->GetPnpDevNodeId(This, ppszwDevNodeId);
}
static inline HRESULT INetCfgComponent_GetClassGuid(INetCfgComponent *This,
                                                    GUID *pGuid) {
  return This->lpVtbl->GetClassGuid(This, pGuid);
}
static inline HRESULT INetCfgComponent_GetBindName(INetCfgComponent *This,
                                                   LPWSTR *ppszwBindName) {
  return This->lpVtbl->GetBindName(This, ppszwBindName);
}
static inline HRESULT INetCfgComponent_GetDeviceStatus(INetCfgComponent *This,
                                                       ULONG *pulStatus) {
  return This->lpVtbl->GetDeviceStatus(This, pulStatus);
}
static inline HRESULT INetCfgComponent_OpenParamKey(INetCfgComponent *This,
                                                    HKEY *phkey) {
  return This->lpVtbl->OpenParamKey(This, phkey);
}
static inline HRESULT INetCfgComponent_RaisePropertyUi(INetCfgComponent *This,
                                                       HWND hwndParent,
                                                       DWORD dwFlags,
                                                       IUnknown *punkContext) {
...
DEFINE_GUID(IID_INetCfgComponentBindings, 0xc0e8ae9e, 0x306e, 0x11d1, 0xaa,
            0xcf, 0x00, 0x80, 0x5f, 0xc1, 0x27, 0x0e);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("c0e8ae9e-306e-11d1-aacf-00805fc1270e")
INetCfgComponentBindings : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE BindTo(INetCfgComponent * pnccItem) = 0;
  virtual HRESULT STDMETHODCALLTYPE UnbindFrom(INetCfgComponent * pnccItem) = 0;
  virtual HRESULT STDMETHODCALLTYPE SupportsBindingInterface(
      DWORD dwFlags, LPCWSTR pszwInterfaceName) = 0;
  virtual HRESULT STDMETHODCALLTYPE IsBoundTo(INetCfgComponent * pnccItem) = 0;
  virtual HRESULT STDMETHODCALLTYPE IsBindableTo(INetCfgComponent *
                                                 pnccItem) = 0;
  virtual HRESULT STDMETHODCALLTYPE EnumBindingPaths(
      DWORD dwFlags, IEnumNetCfgBindingPath * *ppIEnum) = 0;
  virtual HRESULT STDMETHODCALLTYPE MoveBefore(
      INetCfgBindingPath * pncbItemSrc, INetCfgBindingPath * pncbItemDest) = 0;
  virtual HRESULT STDMETHODCALLTYPE MoveAfter(
      INetCfgBindingPath * pncbItemSrc, INetCfgBindingPath * pncbItemDest) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(INetCfgComponentBindings, 0xc0e8ae9e, 0x306e, 0x11d1, 0xaa,
                0xcf, 0x00, 0x80, 0x5f, 0xc1, 0x27, 0x0e)
#endif
#else
typedef struct INetCfgComponentBindingsVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INetCfgComponentBindings *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(INetCfgComponentBindings *This);
  ULONG(STDMETHODCALLTYPE *Release)(INetCfgComponentBindings *This);
  /*** INetCfgComponentBindings methods ***/
  HRESULT(STDMETHODCALLTYPE *BindTo)(INetCfgComponentBindings *This,
                                     INetCfgComponent *pnccItem);
  HRESULT(STDMETHODCALLTYPE *UnbindFrom)(INetCfgComponentBindings *This,
                                         INetCfgComponent *pnccItem);
  HRESULT(STDMETHODCALLTYPE *SupportsBindingInterface)(
      INetCfgComponentBindings *This, DWORD dwFlags, LPCWSTR pszwInterfaceName);
  HRESULT(STDMETHODCALLTYPE *IsBoundTo)(INetCfgComponentBindings *This,
                                        INetCfgComponent *pnccItem);
  HRESULT(STDMETHODCALLTYPE *IsBindableTo)(INetCfgComponentBindings *This,
                                           INetCfgComponent *pnccItem);
  HRESULT(STDMETHODCALLTYPE *EnumBindingPaths)(
      INetCfgComponentBindings *This, DWORD dwFlags,
      IEnumNetCfgBindingPath **ppIEnum);
  HRESULT(STDMETHODCALLTYPE *MoveBefore)(INetCfgComponentBindings *This,
                                         INetCfgBindingPath *pncbItemSrc,
                                         INetCfgBindingPath *pncbItemDest);
  HRESULT(STDMETHODCALLTYPE *MoveAfter)(INetCfgComponentBindings *This,
                                        INetCfgBindingPath *pncbItemSrc,
                                        INetCfgBindingPath *pncbItemDest);
  END_INTERFACE
...
#define INetCfgComponentBindings_SupportsBindingInterface(This, dwFlags,       \
                                                          pszwInterfaceName)   \
...
/*** IUnknown methods ***/
static inline HRESULT
INetCfgComponentBindings_QueryInterface(INetCfgComponentBindings *This,
                                        REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
INetCfgComponentBindings_AddRef(INetCfgComponentBindings *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
INetCfgComponentBindings_Release(INetCfgComponentBindings *This) {
  return This->lpVtbl->Release(This);
}
/*** INetCfgComponentBindings methods ***/
static inline HRESULT
INetCfgComponentBindings_BindTo(INetCfgComponentBindings *This,
                                INetCfgComponent *pnccItem) {
  return This->lpVtbl->BindTo(This, pnccItem);
}
static inline HRESULT
INetCfgComponentBindings_UnbindFrom(INetCfgComponentBindings *This,
                                    INetCfgComponent *pnccItem) {
  return This->lpVtbl->UnbindFrom(This, pnccItem);
}
static inline HRESULT INetCfgComponentBindings_SupportsBindingInterface(
    INetCfgComponentBindings *This, DWORD dwFlags, LPCWSTR pszwInterfaceName) {
  return This->lpVtbl->SupportsBindingInterface(This, dwFlags,
                                                pszwInterfaceName);
}
static inline HRESULT
INetCfgComponentBindings_IsBoundTo(INetCfgComponentBindings *This,
                                   INetCfgComponent *pnccItem) {
  return This->lpVtbl->IsBoundTo(This, pnccItem);
}
static inline HRESULT
INetCfgComponentBindings_IsBindableTo(INetCfgComponentBindings *This,
                                      INetCfgComponent *pnccItem) {
  return This->lpVtbl->IsBindableTo(This, pnccItem);
}
static inline HRESULT
INetCfgComponentBindings_EnumBindingPaths(INetCfgComponentBindings *This,
                                          DWORD dwFlags,
                                          IEnumNetCfgBindingPath **ppIEnum) {
  return This->lpVtbl->EnumBindingPaths(This, dwFlags, ppIEnum);
}
static inline HRESULT
INetCfgComponentBindings_MoveBefore(INetCfgComponentBindings *This,
                                    INetCfgBindingPath *pncbItemSrc,
                                    INetCfgBindingPath *pncbItemDest) {
  return This->lpVtbl->MoveBefore(This, pncbItemSrc, pncbItemDest);
}
static inline HRESULT
INetCfgComponentBindings_MoveAfter(INetCfgComponentBindings *This,
                                   INetCfgBindingPath *pncbItemSrc,
                                   INetCfgBindingPath *pncbItemDest) {
...
DEFINE_GUID(IID_INetCfgSysPrep, 0xc0e8ae98, 0x306e, 0x11d1, 0xaa, 0xcf, 0x00,
            0x80, 0x5f, 0xc1, 0x27, 0x0e);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
INetCfgSysPrep : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE HrSetupSetFirstDword(
      LPCWSTR pwszSection, LPCWSTR pwszKey, DWORD dwValue) = 0;
  virtual HRESULT STDMETHODCALLTYPE HrSetupSetFirstString(
      LPCWSTR pwszSection, LPCWSTR pwszKey, LPCWSTR pwszValue) = 0;
  virtual HRESULT STDMETHODCALLTYPE HrSetupSetFirstStringAsBool(
      LPCWSTR pwszSection, LPCWSTR pwszKey, WINBOOL fValue) = 0;
  virtual HRESULT STDMETHODCALLTYPE HrSetupSetFirstMultiSzField(
      LPCWSTR pwszSection, LPCWSTR pwszKey, LPCWSTR pmszValue) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(INetCfgSysPrep, 0xc0e8ae98, 0x306e, 0x11d1, 0xaa, 0xcf, 0x00,
                0x80, 0x5f, 0xc1, 0x27, 0x0e)
#endif
#else
typedef struct INetCfgSysPrepVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INetCfgSysPrep *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(INetCfgSysPrep *This);
  ULONG(STDMETHODCALLTYPE *Release)(INetCfgSysPrep *This);
  /*** INetCfgSysPrep methods ***/
  HRESULT(STDMETHODCALLTYPE *HrSetupSetFirstDword)(INetCfgSysPrep *This,
                                                   LPCWSTR pwszSection,
                                                   LPCWSTR pwszKey,
                                                   DWORD dwValue);
  HRESULT(STDMETHODCALLTYPE *HrSetupSetFirstString)(INetCfgSysPrep *This,
                                                    LPCWSTR pwszSection,
                                                    LPCWSTR pwszKey,
                                                    LPCWSTR pwszValue);
  HRESULT(STDMETHODCALLTYPE *HrSetupSetFirstStringAsBool)(INetCfgSysPrep *This,
                                                          LPCWSTR pwszSection,
                                                          LPCWSTR pwszKey,
                                                          WINBOOL fValue);
  HRESULT(STDMETHODCALLTYPE *HrSetupSetFirstMultiSzField)(INetCfgSysPrep *This,
                                                          LPCWSTR pwszSection,
                                                          LPCWSTR pwszKey,
                                                          LPCWSTR pmszValue);
  END_INTERFACE
} INetCfgSysPrepVtbl;
interface INetCfgSysPrep { CONST_VTBL INetCfgSysPrepVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** INetCfgSysPrep methods ***/
#define INetCfgSysPrep_HrSetupSetFirstDword(This, pwszSection, pwszKey,        \
                                            dwValue)                           \
  (This)->lpVtbl->HrSetupSetFirstDword(This, pwszSection, pwszKey, dwValue)
#define INetCfgSysPrep_HrSetupSetFirstString(This, pwszSection, pwszKey,       \
                                             pwszValue)                        \
  (This)->lpVtbl->HrSetupSetFirstString(This, pwszSection, pwszKey, pwszValue)
#define INetCfgSysPrep_HrSetupSetFirstStringAsBool(This, pwszSection, pwszKey, \
                                                   fValue)                     \
  (This)->lpVtbl->HrSetupSetFirstStringAsBool(This, pwszSection, pwszKey,      \
                                              fValue)
#define INetCfgSysPrep_HrSetupSetFirstMultiSzField(This, pwszSection, pwszKey, \
                                                   pmszValue)                  \
  (This)->lpVtbl->HrSetupSetFirstMultiSzField(This, pwszSection, pwszKey,      \
                                              pmszValue)
#else
/*** IUnknown methods ***/
static inline HRESULT INetCfgSysPrep_QueryInterface(INetCfgSysPrep *This,
                                                    REFIID riid,
                                                    void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** INetCfgSysPrep methods ***/
static inline HRESULT INetCfgSysPrep_HrSetupSetFirstDword(INetCfgSysPrep *This,
                                                          LPCWSTR pwszSection,
                                                          LPCWSTR pwszKey,
                                                          DWORD dwValue) {
  return This->lpVtbl->HrSetupSetFirstDword(This, pwszSection, pwszKey,
                                            dwValue);
}
static inline HRESULT INetCfgSysPrep_HrSetupSetFirstString(INetCfgSysPrep *This,
                                                           LPCWSTR pwszSection,
                                                           LPCWSTR pwszKey,
                                                           LPCWSTR pwszValue) {
  return This->lpVtbl->HrSetupSetFirstString(This, pwszSection, pwszKey,
                                             pwszValue);
}
static inline HRESULT
INetCfgSysPrep_HrSetupSetFirstStringAsBool(INetCfgSysPrep *This,
                                           LPCWSTR pwszSection, LPCWSTR pwszKey,
                                           WINBOOL fValue) {
  return This->lpVtbl->HrSetupSetFirstStringAsBool(This, pwszSection, pwszKey,
                                                   fValue);
}
static inline HRESULT
INetCfgSysPrep_HrSetupSetFirstMultiSzField(INetCfgSysPrep *This,
                                           LPCWSTR pwszSection, LPCWSTR pwszKey,
                                           LPCWSTR pmszValue) {
  return This->lpVtbl->HrSetupSetFirstMultiSzField(This, pwszSection, pwszKey,
                                                   pmszValue);
}
#endif
#endif
