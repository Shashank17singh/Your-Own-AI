...
DWORD WINAPI PowerReadACValue(HKEY RootPowerKey, CONST GUID *SchemeGuid,
                              CONST GUID *SubGroupOfPowerSettingsGuid,
                              CONST GUID *PowerSettingGuid, PULONG Type,
                              LPBYTE Buffer, LPDWORD BufferSize);
DWORD WINAPI PowerReadDCValue(HKEY RootPowerKey, CONST GUID *SchemeGuid,
                              CONST GUID *SubGroupOfPowerSettingsGuid,
                              CONST GUID *PowerSettingGuid, PULONG Type,
...
DWORD WINAPI PowerWriteDCValueIndex(HKEY RootPowerKey, CONST GUID *SchemeGuid,
                                    ...
                                    CONST GUID *PowerSettingGuid,
                                    DWORD DcValueIndex);
DWORD WINAPI PowerGetActiveScheme(HKEY UserRootPowerKey,
...
typedef VOID WINAPI EFFECTIVE_POWER_MODE_CALLBACK(EFFECTIVE_POWER_MODE Mode,
                                                  VOID *Context);
HRESULT WINAPI PowerRegisterForEffectivePowerModeNotifications(
    ULONG Version, EFFECTIVE_POWER_MODE_CALLBACK *Callback, VOID *Context,
    VOID **RegistrationHandle);
HRESULT WINAPI
PowerUnregisterFromEffectivePowerModeNotifications(VOID *RegistrationHandle);
#endif
