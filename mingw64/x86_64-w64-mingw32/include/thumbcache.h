...
#define WTS_E_FAILEDEXTRACTION                                                 \
  MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, 0xb200)
#define WTS_E_EXTRACTIONTIMEDOUT                                               \
  MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, 0xb201)
#define WTS_E_SURROGATEUNAVAILABLE                                             \
  MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, 0xb202)
#define WTS_E_FASTEXTRACTIONNOTSUPPORTED                                       \
  MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, 0xb203)
#define WTS_E_DATAFILEUNAVAILABLE                                              \
  MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, 0xb204)
#define WTS_E_EXTRACTIONPENDING                                                \
  MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, 0xb205)
#define WTS_E_EXTRACTIONBLOCKED                                                \
  MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, 0xb206)
/*****************************************************************************
 * ISharedBitmap interface
 */
#ifndef __ISharedBitmap_INTERFACE_DEFINED__
#define __ISharedBitmap_INTERFACE_DEFINED__
DEFINE_GUID(IID_ISharedBitmap, 0x091162a4, 0xbc96, 0x411f, 0xaa, 0xe8, 0xc5,
            0x12, 0x2c, 0xd0, 0x33, 0x63);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("091162a4-bc96-411f-aae8-c5122cd03363")
ISharedBitmap : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetSharedBitmap(HBITMAP * phbm) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetSize(SIZE * pSize) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetFormat(WTS_ALPHATYPE * pat) = 0;
  virtual HRESULT STDMETHODCALLTYPE InitializeBitmap(HBITMAP hbm,
                                                     WTS_ALPHATYPE wtsAT) = 0;
  virtual HRESULT STDMETHODCALLTYPE Detach(HBITMAP * phbm) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ISharedBitmap, 0x091162a4, 0xbc96, 0x411f, 0xaa, 0xe8, 0xc5,
                0x12, 0x2c, 0xd0, 0x33, 0x63)
#endif
#else
typedef struct ISharedBitmapVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ISharedBitmap *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(ISharedBitmap *This);
  ULONG(STDMETHODCALLTYPE *Release)(ISharedBitmap *This);
  /*** ISharedBitmap methods ***/
  HRESULT(STDMETHODCALLTYPE *GetSharedBitmap)(ISharedBitmap *This,
                                              HBITMAP *phbm);
  HRESULT(STDMETHODCALLTYPE *GetSize)(ISharedBitmap *This, SIZE *pSize);
  HRESULT(STDMETHODCALLTYPE *GetFormat)(ISharedBitmap *This,
                                        WTS_ALPHATYPE *pat);
  HRESULT(STDMETHODCALLTYPE *InitializeBitmap)(ISharedBitmap *This, HBITMAP hbm,
                                               WTS_ALPHATYPE wtsAT);
  HRESULT(STDMETHODCALLTYPE *Detach)(ISharedBitmap *This, HBITMAP *phbm);
  END_INTERFACE
} ISharedBitmapVtbl;
interface ISharedBitmap { CONST_VTBL ISharedBitmapVtbl *lpVtbl; };
#ifdef COBJMACROS
...
#else
/*** IUnknown methods ***/
static inline HRESULT ISharedBitmap_QueryInterface(ISharedBitmap *This,
                                                   REFIID riid,
                                                   void **ppvObject) {
...
/*** ISharedBitmap methods ***/
static inline HRESULT ISharedBitmap_GetSharedBitmap(ISharedBitmap *This,
                                                    HBITMAP *phbm) {
...
static inline HRESULT ISharedBitmap_GetFormat(ISharedBitmap *This,
                                              WTS_ALPHATYPE *pat) {
  return This->lpVtbl->GetFormat(This, pat);
}
static inline HRESULT ISharedBitmap_InitializeBitmap(ISharedBitmap *This,
                                                     HBITMAP hbm,
                                                     WTS_ALPHATYPE wtsAT) {
...
DEFINE_GUID(IID_IThumbnailCache, 0xf676c15d, 0x596a, 0x4ce2, 0x82, 0x34, 0x33,
            0x99, 0x6f, 0x44, 0x5d, 0xb1);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IThumbnailCache : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetThumbnail(
      IShellItem * pShellItem, UINT cxyRequestedThumbSize, WTS_FLAGS flags,
      ISharedBitmap * *ppvThumb, WTS_CACHEFLAGS * pOutFlags,
      WTS_THUMBNAILID * pThumbnailID) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetThumbnailByID(
      WTS_THUMBNAILID thumbnailID, UINT cxyRequestedThumbSize,
      ISharedBitmap * *ppvThumb, WTS_CACHEFLAGS * pOutFlags) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IThumbnailCache, 0xf676c15d, 0x596a, 0x4ce2, 0x82, 0x34, 0x33,
                0x99, 0x6f, 0x44, 0x5d, 0xb1)
#endif
#else
typedef struct IThumbnailCacheVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IThumbnailCache *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetThumbnail)(
      IThumbnailCache *This, IShellItem *pShellItem, UINT cxyRequestedThumbSize,
      WTS_FLAGS flags, ISharedBitmap **ppvThumb, WTS_CACHEFLAGS *pOutFlags,
      WTS_THUMBNAILID *pThumbnailID);
  HRESULT(STDMETHODCALLTYPE *GetThumbnailByID)(IThumbnailCache *This,
...
interface IThumbnailCache { CONST_VTBL IThumbnailCacheVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IThumbnailCache methods ***/
#define IThumbnailCache_GetThumbnail(This, pShellItem, cxyRequestedThumbSize,  \
                                     flags, ppvThumb, pOutFlags, pThumbnailID) \
  (This)->lpVtbl->GetThumbnail(This, pShellItem, cxyRequestedThumbSize, flags, \
                               ppvThumb, pOutFlags, pThumbnailID)
#define IThumbnailCache_GetThumbnailByID(                                      \
    This, thumbnailID, cxyRequestedThumbSize, ppvThumb, pOutFlags)             \
  (This)->lpVtbl->GetThumbnailByID(This, thumbnailID, cxyRequestedThumbSize,   \
                                   ppvThumb, pOutFlags)
#else
/*** IUnknown methods ***/
static inline HRESULT IThumbnailCache_QueryInterface(IThumbnailCache *This,
                                                     REFIID riid,
                                                     void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IThumbnailCache methods ***/
static inline HRESULT IThumbnailCache_GetThumbnail(
    IThumbnailCache *This, IShellItem *pShellItem, UINT cxyRequestedThumbSize,
    WTS_FLAGS flags, ISharedBitmap **ppvThumb, WTS_CACHEFLAGS *pOutFlags,
    WTS_THUMBNAILID *pThumbnailID) {
  return This->lpVtbl->GetThumbnail(This, pShellItem, cxyRequestedThumbSize,
                                    flags, ppvThumb, pOutFlags, pThumbnailID);
}
static inline HRESULT IThumbnailCache_GetThumbnailByID(
    IThumbnailCache *This, WTS_THUMBNAILID thumbnailID,
    UINT cxyRequestedThumbSize, ISharedBitmap **ppvThumb,
    WTS_CACHEFLAGS *pOutFlags) {
  return This->lpVtbl->GetThumbnailByID(
      This, thumbnailID, cxyRequestedThumbSize, ppvThumb, pOutFlags);
}
#endif
#endif
...
DEFINE_GUID(IID_IThumbnailProvider, 0xe357fccd, 0xa995, 0x4576, 0xb0, 0x1f,
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IThumbnailProvider, 0xe357fccd, 0xa995, 0x4576, 0xb0, 0x1f,
                0x23, 0x46, 0x30, 0x15, 0x4e, 0x96)
#endif
#else
typedef struct IThumbnailProviderVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IThumbnailProvider *This,
  ...
  HRESULT(STDMETHODCALLTYPE *GetThumbnail)(IThumbnailProvider *This, UINT cx,
                                           HBITMAP *phbmp,
                                           WTS_ALPHATYPE *pdwAlpha);
  END_INTERFACE
} IThumbnailProviderVtbl;
interface IThumbnailProvider { CONST_VTBL IThumbnailProviderVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
IThumbnailProvider_QueryInterface(IThumbnailProvider *This, REFIID riid,
                                  void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IThumbnailProvider methods ***/
static inline HRESULT IThumbnailProvider_GetThumbnail(IThumbnailProvider *This,
...
DEFINE_GUID(IID_IThumbnailSettings, 0xf4376f00, 0xbef5, 0x4d45, 0x80, 0xf3,
            0x1e, 0x02, 0x3b, 0xbf, 0x12, 0x09);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("f4376f00-bef5-4d45-80f3-1e023bbf1209")
IThumbnailSettings : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE SetContext(WTS_CONTEXTFLAGS dwContext) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IThumbnailSettings, 0xf4376f00, 0xbef5, 0x4d45, 0x80, 0xf3,
                0x1e, 0x02, 0x3b, 0xbf, 0x12, 0x09)
#endif
#else
typedef struct IThumbnailSettingsVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IThumbnailSettings *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IThumbnailSettings *This);
  ULONG(STDMETHODCALLTYPE *Release)(IThumbnailSettings *This);
  /*** IThumbnailSettings methods ***/
  HRESULT(STDMETHODCALLTYPE *SetContext)(IThumbnailSettings *This,
                                         WTS_CONTEXTFLAGS dwContext);
  END_INTERFACE
} IThumbnailSettingsVtbl;
interface IThumbnailSettings { CONST_VTBL IThumbnailSettingsVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
IThumbnailSettings_QueryInterface(IThumbnailSettings *This, REFIID riid,
                                  void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IThumbnailSettings methods ***/
static inline HRESULT
IThumbnailSettings_SetContext(IThumbnailSettings *This,
                              WTS_CONTEXTFLAGS dwContext) {
...
DEFINE_GUID(IID_IThumbnailCachePrimer, 0x0f03f8fe, 0x2b26, 0x46f0, 0x96, 0x5a,
            0x21, 0x2a, 0xa8, 0xd6, 0x6b, 0x76);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IThumbnailCachePrimer : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE PageInThumbnail(
      IShellItem * psi, WTS_FLAGS wtsFlags, UINT cxyRequestedThumbSize) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IThumbnailCachePrimer, 0x0f03f8fe, 0x2b26, 0x46f0, 0x96, 0x5a,
                0x21, 0x2a, 0xa8, 0xd6, 0x6b, 0x76)
#endif
#else
typedef struct IThumbnailCachePrimerVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IThumbnailCachePrimer *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IThumbnailCachePrimer *This);
  ULONG(STDMETHODCALLTYPE *Release)(IThumbnailCachePrimer *This);
  /*** IThumbnailCachePrimer methods ***/
  HRESULT(STDMETHODCALLTYPE *PageInThumbnail)(IThumbnailCachePrimer *This,
                                              IShellItem *psi,
                                              WTS_FLAGS wtsFlags,
                                              UINT cxyRequestedThumbSize);
  END_INTERFACE
...
/*** IThumbnailCachePrimer methods ***/
#define IThumbnailCachePrimer_PageInThumbnail(This, psi, wtsFlags,             \
                                              cxyRequestedThumbSize)           \
  (This)->lpVtbl->PageInThumbnail(This, psi, wtsFlags, cxyRequestedThumbSize)
#else
/*** IUnknown methods ***/
static inline HRESULT
IThumbnailCachePrimer_QueryInterface(IThumbnailCachePrimer *This, REFIID riid,
                                     void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IThumbnailCachePrimer methods ***/
static inline HRESULT
IThumbnailCachePrimer_PageInThumbnail(IThumbnailCachePrimer *This,
                                      IShellItem *psi, WTS_FLAGS wtsFlags,
                                      UINT cxyRequestedThumbSize) {
  return This->lpVtbl->PageInThumbnail(This, psi, wtsFlags,
                                       cxyRequestedThumbSize);
}
#endif
#endif
...
DEFINE_GUID(LIBID_ThumbCacheLib, 0x4c857096, 0x0514, 0x4d4d, 0xab, 0xd5, 0xdf,
            0xaa, 0xa3, 0xc3, 0x26, 0xd2);
/*****************************************************************************
 * LocalThumbnailCache coclass
 */
DEFINE_GUID(CLSID_LocalThumbnailCache, 0x50ef4544, 0xac9f, 0x4a8e, 0xb2, 0x1b,
            0x8a, 0x26, 0x18, 0x0d, 0xb1, 0x3f);
#ifdef __cplusplus
class DECLSPEC_UUID("50ef4544-ac9f-4a8e-b21b-8a26180db13f") LocalThumbnailCache;
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(LocalThumbnailCache, 0x50ef4544, 0xac9f, 0x4a8e, 0xb2, 0x1b,
                0x8a, 0x26, 0x18, 0x0d, 0xb1, 0x3f)
#endif
#endif
/*****************************************************************************
 ...
 */
DEFINE_GUID(CLSID_SharedBitmap, 0x4db26476, 0x6787, 0x4046, 0xb8, 0x36, 0xe8,
            0x41, 0x2a, 0x9e, 0x8a, 0x27);
#ifdef __cplusplus
class DECLSPEC_UUID("4db26476-6787-4046-b836-e8412a9e8a27") SharedBitmap;
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(SharedBitmap, 0x4db26476, 0x6787, 0x4046, 0xb8, 0x36, 0xe8,
                0x41, 0x2a, 0x9e, 0x8a, 0x27)
#endif
#endif
