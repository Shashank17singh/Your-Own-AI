...
typedef struct ITransactionPhase0EnlistmentAsync
...
typedef struct IDtcLuRecoveryInitiatedByDtcTransWork
...
typedef struct IDtcLuRecoveryInitiatedByDtcStatusWork
...
typedef struct xa_switch_t {
  ...
  __LONG32 flags;
  __LONG32 version;
  int(__cdecl *xa_open_entry)(char *__MIDL_0004, int __MIDL_0005,
                              __LONG32 __MIDL_0006);
  int(__cdecl *xa_close_entry)(char *__MIDL_0008, int __MIDL_0009,
                               __LONG32 __MIDL_0010);
  int(__cdecl *xa_start_entry)(XID *__MIDL_0012, int __MIDL_0013,
                               __LONG32 __MIDL_0014);
  int(__cdecl *xa_end_entry)(XID *__MIDL_0016, int __MIDL_0017,
                             __LONG32 __MIDL_0018);
  int(__cdecl *xa_rollback_entry)(XID *__MIDL_0020, int __MIDL_0021,
                                  __LONG32 __MIDL_0022);
  int(__cdecl *xa_prepare_entry)(XID *__MIDL_0024, int __MIDL_0025,
                                 __LONG32 __MIDL_0026);
  int(__cdecl *xa_commit_entry)(XID *__MIDL_0028, int __MIDL_0029,
                                __LONG32 __MIDL_0030);
  int(__cdecl *xa_recover_entry)(XID *__MIDL_0032, __LONG32 __MIDL_0033,
                                 int __MIDL_0034, __LONG32 __MIDL_0035);
  int(__cdecl *xa_forget_entry)(XID *__MIDL_0037, int __MIDL_0038,
                                __LONG32 __MIDL_0039);
  int(__cdecl *xa_complete_entry)(int *__MIDL_0041, int *__MIDL_0042,
                                  int __MIDL_0043, __LONG32 __MIDL_0044);
} xa_switch_t;
#endif
...
typedef struct IXATransLookupVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IXATransLookup *This, REFIID riid,
                                  void **ppvObject);
...
typedef struct IXATransLookup2Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IXATransLookup2 *This, REFIID riid,
                                  void **ppvObject);
...
typedef struct IResourceManagerSinkVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IResourceManagerSink *This, REFIID riid,
                                  void **ppvObject);
...
public:
  virtual HRESULT WINAPI Enlist(ITransaction *pTransaction,
                                ITransactionResourceAsync *pRes, XACTUOW *pUOW,
                                LONG *pisoLevel,
                                ITransactionEnlistmentAsync **ppEnlist) = 0;
  virtual HRESULT WINAPI Reenlist(byte *pPrepInfo, ULONG cbPrepInfo,
                                  DWORD lTimeout, XACTSTAT *pXactStat) = 0;
  virtual HRESULT WINAPI ReenlistmentComplete(void) = 0;
  virtual HRESULT WINAPI GetDistributedTransactionManager(REFIID iid,
                                                          void **ppvObject) = 0;
};
#else
typedef struct IResourceManagerVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IResourceManager *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IResourceManager *This);
  ULONG(WINAPI *Release)(IResourceManager *This);
  HRESULT(WINAPI *Enlist)(IResourceManager *This, ITransaction *pTransaction,
                          ITransactionResourceAsync *pRes, XACTUOW *pUOW,
                          LONG *pisoLevel,
                          ITransactionEnlistmentAsync **ppEnlist);
  HRESULT(WINAPI *Reenlist)(IResourceManager *This, byte *pPrepInfo,
                            ULONG cbPrepInfo, DWORD lTimeout,
                            XACTSTAT *pXactStat);
  HRESULT(WINAPI *ReenlistmentComplete)(IResourceManager *This);
  HRESULT(WINAPI *GetDistributedTransactionManager)(IResourceManager *This,
                                                    REFIID iid,
                                                    void **ppvObject);
  END_INTERFACE
...
#define IResourceManager_Enlist(This, pTransaction, pRes, pUOW, pisoLevel,     \
                                ppEnlist)                                      \
  (This)->lpVtbl->Enlist(This, pTransaction, pRes, pUOW, pisoLevel, ppEnlist)
#define IResourceManager_Reenlist(This, pPrepInfo, cbPrepInfo, lTimeout,       \
                                  pXactStat)                                   \
...
#define IResourceManager_GetDistributedTransactionManager(This, iid,           \
                                                          ppvObject)           \
  (This)->lpVtbl->GetDistributedTransactionManager(This, iid, ppvObject)
#endif
#endif
HRESULT WINAPI IResourceManager_Enlist_Proxy(
    IResourceManager *This, ITransaction *pTransaction,
    ITransactionResourceAsync *pRes, XACTUOW *pUOW, LONG *pisoLevel,
    ITransactionEnlistmentAsync **ppEnlist);
void __RPC_STUB IResourceManager_Enlist_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IResourceManager_Reenlist_Proxy(IResourceManager *This,
                                               byte *pPrepInfo,
                                               ULONG cbPrepInfo, DWORD lTimeout,
                                               XACTSTAT *pXactStat);
void __RPC_STUB IResourceManager_Reenlist_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
IResourceManager_ReenlistmentComplete_Proxy(IResourceManager *This);
...
HRESULT WINAPI IResourceManager_GetDistributedTransactionManager_Proxy(
    IResourceManager *This, REFIID iid, void **ppvObject);
...
public:
  virtual HRESULT WINAPI TransactionCommitted(byte *pPrepInfo,
                                              ULONG cbPrepInfo) = 0;
...
typedef struct ILastResourceManagerVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ILastResourceManager *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ILastResourceManager *This);
  ULONG(WINAPI *Release)(ILastResourceManager *This);
  HRESULT(WINAPI *TransactionCommitted)(ILastResourceManager *This,
                                        byte *pPrepInfo, ULONG cbPrepInfo);
...
#endif
#endif
HRESULT WINAPI ILastResourceManager_TransactionCommitted_Proxy(
    ILastResourceManager *This, byte *pPrepInfo, ULONG cbPrepInfo);
void __RPC_STUB ILastResourceManager_TransactionCommitted_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
ILastResourceManager_RecoveryDone_Proxy(ILastResourceManager *This);
...
public:
  virtual HRESULT WINAPI Enlist2(ITransaction *pTransaction,
                                 ITransactionResourceAsync *pResAsync,
                                 XACTUOW *pUOW, LONG *pisoLevel, XID *pXid,
                                 ITransactionEnlistmentAsync **ppEnlist) = 0;
  virtual HRESULT WINAPI Reenlist2(XID *pXid, DWORD dwTimeout,
                                   XACTSTAT *pXactStat) = 0;
};
#else
typedef struct IResourceManager2Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IResourceManager2 *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IResourceManager2 *This);
  ULONG(WINAPI *Release)(IResourceManager2 *This);
  HRESULT(WINAPI *Enlist)(IResourceManager2 *This, ITransaction *pTransaction,
                          ITransactionResourceAsync *pRes, XACTUOW *pUOW,
                          LONG *pisoLevel,
                          ITransactionEnlistmentAsync **ppEnlist);
  HRESULT(WINAPI *Reenlist)(IResourceManager2 *This, byte *pPrepInfo,
                            ULONG cbPrepInfo, DWORD lTimeout,
                            XACTSTAT *pXactStat);
  HRESULT(WINAPI *ReenlistmentComplete)(IResourceManager2 *This);
  HRESULT(WINAPI *GetDistributedTransactionManager)(IResourceManager2 *This,
                                                    REFIID iid,
                                                    void **ppvObject);
  HRESULT(WINAPI *Enlist2)(IResourceManager2 *This, ITransaction *pTransaction,
                           ITransactionResourceAsync *pResAsync, XACTUOW *pUOW,
                           LONG *pisoLevel, XID *pXid,
                           ITransactionEnlistmentAsync **ppEnlist);
  HRESULT(WINAPI *Reenlist2)(IResourceManager2 *This, XID *pXid,
                             DWORD dwTimeout, XACTSTAT *pXactStat);
  END_INTERFACE
...
#define IResourceManager2_Enlist(This, pTransaction, pRes, pUOW, pisoLevel,    \
                                 ppEnlist)                                     \
  (This)->lpVtbl->Enlist(This, pTransaction, pRes, pUOW, pisoLevel, ppEnlist)
#define IResourceManager2_Reenlist(This, pPrepInfo, cbPrepInfo, lTimeout,      \
                                   pXactStat)                                  \
  (This)->lpVtbl->Reenlist(This, pPrepInfo, cbPrepInfo, lTimeout, pXactStat)
#define IResourceManager2_ReenlistmentComplete(This)                           \
  (This)->lpVtbl->ReenlistmentComplete(This)
#define IResourceManager2_GetDistributedTransactionManager(This, iid,          \
                                                           ppvObject)          \
  (This)->lpVtbl->GetDistributedTransactionManager(This, iid, ppvObject)
#define IResourceManager2_Enlist2(This, pTransaction, pResAsync, pUOW,         \
                                  pisoLevel, pXid, ppEnlist)                   \
  (This)->lpVtbl->Enlist2(This, pTransaction, pResAsync, pUOW, pisoLevel,      \
                          pXid, ppEnlist)
#define IResourceManager2_Reenlist2(This, pXid, dwTimeout, pXactStat)          \
  (This)->lpVtbl->Reenlist2(This, pXid, dwTimeout, pXactStat)
#endif
#endif
HRESULT WINAPI IResourceManager2_Enlist2_Proxy(
    IResourceManager2 *This, ITransaction *pTransaction,
    ITransactionResourceAsync *pResAsync, XACTUOW *pUOW, LONG *pisoLevel,
    XID *pXid, ITransactionEnlistmentAsync **ppEnlist);
void __RPC_STUB IResourceManager2_Enlist2_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IResourceManager2_Reenlist2_Proxy(IResourceManager2 *This,
                                                 XID *pXid, DWORD dwTimeout,
                                                 XACTSTAT *pXactStat);
...
typedef struct IXAConfigVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IXAConfig *This, REFIID riid,
                                  void **ppvObject);
...
void __RPC_STUB IXAConfig_Initialize_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI IXAConfig_Terminate_Proxy(IXAConfig *This);
void __RPC_STUB IXAConfig_Terminate_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
#endif
...
public:
  ...
  virtual HRESULT WINAPI RMInfo(xa_switch_t *pXa_Switch,
                                WINBOOL fCDeclCallingConv, char *pszOpenString,
                                char *pszCloseString, GUID guidRMRecovery) = 0;
};
#else
typedef struct IRMHelperVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IRMHelper *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *RMInfo)(IRMHelper *This, xa_switch_t *pXa_Switch,
                          WINBOOL fCDeclCallingConv, char *pszOpenString,
                          char *pszCloseString, GUID guidRMRecovery);
  END_INTERFACE
} IRMHelperVtbl;
struct IRMHelper {
...
#define IRMHelper_RMInfo(This, pXa_Switch, fCDeclCallingConv, pszOpenString,   \
                         pszCloseString, guidRMRecovery)                       \
  (This)->lpVtbl->RMInfo(This, pXa_Switch, fCDeclCallingConv, pszOpenString,   \
                         pszCloseString, guidRMRecovery)
#endif
#endif
HRESULT WINAPI IRMHelper_RMCount_Proxy(IRMHelper *This,
                                       DWORD dwcTotalNumberOfRMs);
void __RPC_STUB IRMHelper_RMCount_Stub(IRpcStubBuffer *This,
                                       IRpcChannelBuffer *_pRpcChannelBuffer,
                                       PRPC_MESSAGE _pRpcMessage,
                                       DWORD *_pdwStubPhase);
HRESULT WINAPI IRMHelper_RMInfo_Proxy(IRMHelper *This, xa_switch_t *pXa_Switch,
                                      WINBOOL fCDeclCallingConv,
                                      char *pszOpenString, char *pszCloseString,
                                      GUID guidRMRecovery);
void __RPC_STUB IRMHelper_RMInfo_Stub(IRpcStubBuffer *This,
                                      IRpcChannelBuffer *_pRpcChannelBuffer,
                                      PRPC_MESSAGE _pRpcMessage,
                                      DWORD *_pdwStubPhase);
#endif
...
typedef struct IXAObtainRMInfoVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IXAObtainRMInfo *This, REFIID riid,
                                  void **ppvObject);
...
#endif
#endif
HRESULT WINAPI IXAObtainRMInfo_ObtainRMInfo_Proxy(IXAObtainRMInfo *This,
                                                  IRMHelper *pIRMHelper);
...
public:
  virtual HRESULT WINAPI Create(GUID *pguidRM, CHAR *pszRMName,
...
typedef struct IResourceManagerFactoryVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IResourceManagerFactory *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IResourceManagerFactory *This);
  ULONG(WINAPI *Release)(IResourceManagerFactory *This);
  HRESULT(WINAPI *Create)(IResourceManagerFactory *This, GUID *pguidRM,
                          CHAR *pszRMName, IResourceManagerSink *pIResMgrSink,
...
#define IResourceManagerFactory_Create(This, pguidRM, pszRMName, pIResMgrSink, \
                                       ppResMgr)                               \
  (This)->lpVtbl->Create(This, pguidRM, pszRMName, pIResMgrSink, ppResMgr)
#endif
#endif
HRESULT WINAPI IResourceManagerFactory_Create_Proxy(
    IResourceManagerFactory *This, GUID *pguidRM, CHAR *pszRMName,
    IResourceManagerSink *pIResMgrSink, IResourceManager **ppResMgr);
...
public:
  virtual HRESULT WINAPI CreateEx(GUID *pguidRM, CHAR *pszRMName,
                                  IResourceManagerSink *pIResMgrSink,
                                  REFIID riidRequested, void **ppvResMgr) = 0;
};
#else
typedef struct IResourceManagerFactory2Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IResourceManagerFactory2 *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IResourceManagerFactory2 *This);
  ULONG(WINAPI *Release)(IResourceManagerFactory2 *This);
  HRESULT(WINAPI *Create)(IResourceManagerFactory2 *This, GUID *pguidRM,
                          CHAR *pszRMName, IResourceManagerSink *pIResMgrSink,
                          IResourceManager **ppResMgr);
  HRESULT(WINAPI *CreateEx)(IResourceManagerFactory2 *This, GUID *pguidRM,
                            CHAR *pszRMName, IResourceManagerSink *pIResMgrSink,
                            REFIID riidRequested, void **ppvResMgr);
  END_INTERFACE
...
#define IResourceManagerFactory2_Create(This, pguidRM, pszRMName,              \
                                        pIResMgrSink, ppResMgr)                \
  (This)->lpVtbl->Create(This, pguidRM, pszRMName, pIResMgrSink, ppResMgr)
#define IResourceManagerFactory2_CreateEx(                                     \
    This, pguidRM, pszRMName, pIResMgrSink, riidRequested, ppvResMgr)          \
  (This)->lpVtbl->CreateEx(This, pguidRM, pszRMName, pIResMgrSink,             \
                           riidRequested, ppvResMgr)
#endif
#endif
HRESULT WINAPI IResourceManagerFactory2_CreateEx_Proxy(
    IResourceManagerFactory2 *This, GUID *pguidRM, CHAR *pszRMName,
    IResourceManagerSink *pIResMgrSink, REFIID riidRequested, void **ppvResMgr);
...
typedef struct IPrepareInfoVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IPrepareInfo *This, REFIID riid,
                                  void **ppvObject);
...
#endif
#endif
HRESULT WINAPI IPrepareInfo_GetPrepareInfoSize_Proxy(IPrepareInfo *This,
                                                     ULONG *pcbPrepInfo);
void __RPC_STUB IPrepareInfo_GetPrepareInfoSize_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IPrepareInfo_GetPrepareInfo_Proxy(IPrepareInfo *This,
                                                 byte *pPrepInfo);
...
public:
  virtual HRESULT WINAPI GetPrepareInfoSize(ULONG *pcbPrepInfo) = 0;
  virtual HRESULT WINAPI GetPrepareInfo(ULONG cbPrepareInfo,
                                        byte *pPrepInfo) = 0;
};
#else
typedef struct IPrepareInfo2Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IPrepareInfo2 *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetPrepareInfo)(IPrepareInfo2 *This, ULONG cbPrepareInfo,
                                  byte *pPrepInfo);
  END_INTERFACE
} IPrepareInfo2Vtbl;
...
#endif
#endif
HRESULT WINAPI IPrepareInfo2_GetPrepareInfoSize_Proxy(IPrepareInfo2 *This,
                                                      ULONG *pcbPrepInfo);
void __RPC_STUB IPrepareInfo2_GetPrepareInfoSize_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IPrepareInfo2_GetPrepareInfo_Proxy(IPrepareInfo2 *This,
                                                  ULONG cbPrepareInfo,
                                                  byte *pPrepInfo);
...
typedef struct IGetDispenserVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IGetDispenser *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IGetDispenser *This);
  ULONG(WINAPI *Release)(IGetDispenser *This);
  HRESULT(WINAPI *GetDispenser)(IGetDispenser *This, REFIID iid,
                                void **ppvObject);
  END_INTERFACE
} IGetDispenserVtbl;
...
#endif
#endif
HRESULT WINAPI IGetDispenser_GetDispenser_Proxy(IGetDispenser *This, REFIID iid,
                                                void **ppvObject);
...
typedef struct ITransactionVoterBallotAsync2Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITransactionVoterBallotAsync2 *This,
                                  REFIID riid, void **ppvObject);
  ULONG(WINAPI *AddRef)(ITransactionVoterBallotAsync2 *This);
  ULONG(WINAPI *Release)(ITransactionVoterBallotAsync2 *This);
  HRESULT(WINAPI *VoteRequestDone)(ITransactionVoterBallotAsync2 *This,
                                   HRESULT hr, BOID *pboidReason);
  END_INTERFACE
...
#endif
#endif
HRESULT WINAPI ITransactionVoterBallotAsync2_VoteRequestDone_Proxy(
    ITransactionVoterBallotAsync2 *This, HRESULT hr, BOID *pboidReason);
...
typedef struct ITransactionVoterNotifyAsync2Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITransactionVoterNotifyAsync2 *This,
                                  REFIID riid, void **ppvObject);
  ULONG(WINAPI *AddRef)(ITransactionVoterNotifyAsync2 *This);
  ULONG(WINAPI *Release)(ITransactionVoterNotifyAsync2 *This);
  HRESULT(WINAPI *Committed)(ITransactionVoterNotifyAsync2 *This,
                             WINBOOL fRetaining, XACTUOW *pNewUOW, HRESULT hr);
  HRESULT(WINAPI *Aborted)(ITransactionVoterNotifyAsync2 *This,
                           BOID *pboidReason, WINBOOL fRetaining,
                           XACTUOW *pNewUOW, HRESULT hr);
  HRESULT(WINAPI *HeuristicDecision)(ITransactionVoterNotifyAsync2 *This,
                                     DWORD dwDecision, BOID *pboidReason,
                                     HRESULT hr);
...
#define ITransactionVoterNotifyAsync2_Aborted(This, pboidReason, fRetaining,   \
                                              pNewUOW, hr)                     \
  (This)->lpVtbl->Aborted(This, pboidReason, fRetaining, pNewUOW, hr)
#define ITransactionVoterNotifyAsync2_HeuristicDecision(This, dwDecision,      \
                                                        pboidReason, hr)       \
...
#endif
#endif
HRESULT WINAPI ITransactionVoterNotifyAsync2_VoteRequest_Proxy(
...
public:
  virtual HRESULT WINAPI Create(
      ITransaction *pTransaction, ITransactionVoterNotifyAsync2 *pVoterNotify,
      ITransactionVoterBallotAsync2 **ppVoterBallot) = 0;
};
#else
typedef struct ITransactionVoterFactory2Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITransactionVoterFactory2 *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ITransactionVoterFactory2 *This);
  ULONG(WINAPI *Release)(ITransactionVoterFactory2 *This);
  HRESULT(WINAPI *Create)(ITransactionVoterFactory2 *This,
...
#define ITransactionVoterFactory2_Create(This, pTransaction, pVoterNotify,     \
                                         ppVoterBallot)                        \
  (This)->lpVtbl->Create(This, pTransaction, pVoterNotify, ppVoterBallot)
#endif
#endif
HRESULT WINAPI ITransactionVoterFactory2_Create_Proxy(
    ITransactionVoterFactory2 *This, ITransaction *pTransaction,
    ITransactionVoterNotifyAsync2 *pVoterNotify,
    ITransactionVoterBallotAsync2 **ppVoterBallot);
...
typedef struct ITransactionPhase0EnlistmentAsyncVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITransactionPhase0EnlistmentAsync *This,
                                  REFIID riid, void **ppvObject);
  ...
  HRESULT(WINAPI *GetTransaction)(ITransactionPhase0EnlistmentAsync *This,
...
#ifdef COBJMACROS
#define ITransactionPhase0EnlistmentAsync_QueryInterface(This, riid,           \
                                                         ppvObject)            \
  (This)->lpVtbl->QueryInterface(This, riid, ppvObject)
...
#endif
#endif
HRESULT WINAPI ITransactionPhase0EnlistmentAsync_Enable_Proxy(
    ITransactionPhase0EnlistmentAsync *This);
void __RPC_STUB ITransactionPhase0EnlistmentAsync_Enable_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITransactionPhase0EnlistmentAsync_WaitForEnlistment_Proxy(
    ITransactionPhase0EnlistmentAsync *This);
void __RPC_STUB ITransactionPhase0EnlistmentAsync_WaitForEnlistment_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITransactionPhase0EnlistmentAsync_Phase0Done_Proxy(
    ITransactionPhase0EnlistmentAsync *This);
void __RPC_STUB ITransactionPhase0EnlistmentAsync_Phase0Done_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITransactionPhase0EnlistmentAsync_Unenlist_Proxy(
    ITransactionPhase0EnlistmentAsync *This);
void __RPC_STUB ITransactionPhase0EnlistmentAsync_Unenlist_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITransactionPhase0EnlistmentAsync_GetTransaction_Proxy(
    ITransactionPhase0EnlistmentAsync *This, ITransaction **ppITransaction);
...
typedef struct ITransactionPhase0NotifyAsyncVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITransactionPhase0NotifyAsync *This,
                                  REFIID riid, void **ppvObject);
  ULONG(WINAPI *AddRef)(ITransactionPhase0NotifyAsync *This);
  ULONG(WINAPI *Release)(ITransactionPhase0NotifyAsync *This);
  HRESULT(WINAPI *Phase0Request)(ITransactionPhase0NotifyAsync *This,
                                 WINBOOL fAbortingHint);
  HRESULT(WINAPI *EnlistCompleted)(ITransactionPhase0NotifyAsync *This,
                                   HRESULT status);
  END_INTERFACE
...
#endif
#endif
HRESULT WINAPI ITransactionPhase0NotifyAsync_Phase0Request_Proxy(
    ITransactionPhase0NotifyAsync *This, WINBOOL fAbortingHint);
void __RPC_STUB ITransactionPhase0NotifyAsync_Phase0Request_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITransactionPhase0NotifyAsync_EnlistCompleted_Proxy(
    ITransactionPhase0NotifyAsync *This, HRESULT status);
...
#define ITransactionPhase0Factory_Create(This, pPhase0Notify,                  \
                                         ppPhase0Enlistment)                   \
  (This)->lpVtbl->Create(This, pPhase0Notify, ppPhase0Enlistment)
#endif
#endif
HRESULT WINAPI ITransactionPhase0Factory_Create_Proxy(
    ITransactionPhase0Factory *This,
    ITransactionPhase0NotifyAsync *pPhase0Notify,
    ITransactionPhase0EnlistmentAsync **ppPhase0Enlistment);
...
public:
  ...
  virtual HRESULT WINAPI MarshalPropagationToken(ULONG cbToken, byte *rgbToken,
                                                 ULONG *pcbUsed) = 0;
  virtual HRESULT WINAPI UnmarshalReturnToken(ULONG cbReturnToken,
...
typedef struct ITransactionTransmitterVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITransactionTransmitter *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ITransactionTransmitter *This);
  ULONG(WINAPI *Release)(ITransactionTransmitter *This);
  HRESULT(WINAPI *Set)(ITransactionTransmitter *This,
                       ITransaction *pTransaction);
  HRESULT(WINAPI *GetPropagationTokenSize)(ITransactionTransmitter *This,
                                           ULONG *pcbToken);
  HRESULT(WINAPI *MarshalPropagationToken)(ITransactionTransmitter *This,
                                           ULONG cbToken, byte *rgbToken,
                                           ULONG *pcbUsed);
  HRESULT(WINAPI *UnmarshalReturnToken)(ITransactionTransmitter *This,
                                        ULONG cbReturnToken,
                                        byte *rgbReturnToken);
...
#define ITransactionTransmitter_MarshalPropagationToken(This, cbToken,         \
                                                        rgbToken, pcbUsed)     \
  (This)->lpVtbl->MarshalPropagationToken(This, cbToken, rgbToken, pcbUsed)
#define ITransactionTransmitter_UnmarshalReturnToken(This, cbReturnToken,      \
                                                     rgbReturnToken)           \
...
#endif
#endif
HRESULT WINAPI ITransactionTransmitter_Set_Proxy(ITransactionTransmitter *This,
                                                 ITransaction *pTransaction);
void __RPC_STUB ITransactionTransmitter_Set_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITransactionTransmitter_GetPropagationTokenSize_Proxy(
    ITransactionTransmitter *This, ULONG *pcbToken);
void __RPC_STUB ITransactionTransmitter_GetPropagationTokenSize_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITransactionTransmitter_MarshalPropagationToken_Proxy(
    ITransactionTransmitter *This, ULONG cbToken, byte *rgbToken,
    ULONG *pcbUsed);
void __RPC_STUB ITransactionTransmitter_MarshalPropagationToken_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITransactionTransmitter_UnmarshalReturnToken_Proxy(
    ITransactionTransmitter *This, ULONG cbReturnToken, byte *rgbReturnToken);
void __RPC_STUB ITransactionTransmitter_UnmarshalReturnToken_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
ITransactionTransmitter_Reset_Proxy(ITransactionTransmitter *This);
...
typedef struct ITransactionTransmitterFactoryVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITransactionTransmitterFactory *This,
                                  REFIID riid, void **ppvObject);
  ULONG(WINAPI *AddRef)(ITransactionTransmitterFactory *This);
  ULONG(WINAPI *Release)(ITransactionTransmitterFactory *This);
  HRESULT(WINAPI *Create)(ITransactionTransmitterFactory *This,
...
#endif
#endif
HRESULT WINAPI ITransactionTransmitterFactory_Create_Proxy(
...
public:
  virtual HRESULT WINAPI UnmarshalPropagationToken(
      ULONG cbToken, byte *rgbToken, ITransaction **ppTransaction) = 0;
  virtual HRESULT WINAPI GetReturnTokenSize(ULONG *pcbReturnToken) = 0;
  virtual HRESULT WINAPI MarshalReturnToken(ULONG cbReturnToken,
                                            byte *rgbReturnToken,
                                            ULONG *pcbUsed) = 0;
  virtual HRESULT WINAPI Reset(void) = 0;
};
...
typedef struct ITransactionReceiverVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITransactionReceiver *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ITransactionReceiver *This);
  ULONG(WINAPI *Release)(ITransactionReceiver *This);
  HRESULT(WINAPI *UnmarshalPropagationToken)(ITransactionReceiver *This,
                                             ULONG cbToken, byte *rgbToken,
                                             ITransaction **ppTransaction);
  HRESULT(WINAPI *GetReturnTokenSize)(ITransactionReceiver *This,
                                      ULONG *pcbReturnToken);
  HRESULT(WINAPI *MarshalReturnToken)(ITransactionReceiver *This,
                                      ULONG cbReturnToken, byte *rgbReturnToken,
                                      ULONG *pcbUsed);
...
#define ITransactionReceiver_UnmarshalPropagationToken(                        \
    This, cbToken, rgbToken, ppTransaction)                                    \
  (This)->lpVtbl->UnmarshalPropagationToken(This, cbToken, rgbToken,           \
                                            ppTransaction)
#define ITransactionReceiver_GetReturnTokenSize(This, pcbReturnToken)          \
  (This)->lpVtbl->GetReturnTokenSize(This, pcbReturnToken)
#define ITransactionReceiver_MarshalReturnToken(This, cbReturnToken,           \
                                                rgbReturnToken, pcbUsed)       \
  (This)->lpVtbl->MarshalReturnToken(This, cbReturnToken, rgbReturnToken,      \
                                     pcbUsed)
#define ITransactionReceiver_Reset(This) (This)->lpVtbl->Reset(This)
#endif
#endif
HRESULT WINAPI ITransactionReceiver_UnmarshalPropagationToken_Proxy(
    ITransactionReceiver *This, ULONG cbToken, byte *rgbToken,
    ITransaction **ppTransaction);
void __RPC_STUB ITransactionReceiver_UnmarshalPropagationToken_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITransactionReceiver_GetReturnTokenSize_Proxy(
    ITransactionReceiver *This, ULONG *pcbReturnToken);
void __RPC_STUB ITransactionReceiver_GetReturnTokenSize_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITransactionReceiver_MarshalReturnToken_Proxy(
    ITransactionReceiver *This, ULONG cbReturnToken, byte *rgbReturnToken,
    ULONG *pcbUsed);
...
typedef struct ITransactionReceiverFactoryVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITransactionReceiverFactory *This,
                                  REFIID riid, void **ppvObject);
  ULONG(WINAPI *AddRef)(ITransactionReceiverFactory *This);
  ULONG(WINAPI *Release)(ITransactionReceiverFactory *This);
  HRESULT(WINAPI *Create)(ITransactionReceiverFactory *This,
...
#endif
#endif
HRESULT WINAPI ITransactionReceiverFactory_Create_Proxy(
    ITransactionReceiverFactory *This, ITransactionReceiver **ppReceiver);
...
typedef struct IDtcLuConfigureVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IDtcLuConfigure *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *Delete)(IDtcLuConfigure *This, byte *pucLuPair,
                          DWORD cbLuPair);
  END_INTERFACE
} IDtcLuConfigureVtbl;
...
#endif
#endif
HRESULT WINAPI IDtcLuConfigure_Add_Proxy(IDtcLuConfigure *This, byte *pucLuPair,
                                         DWORD cbLuPair);
void __RPC_STUB IDtcLuConfigure_Add_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
HRESULT WINAPI IDtcLuConfigure_Delete_Proxy(IDtcLuConfigure *This,
                                            byte *pucLuPair, DWORD cbLuPair);
...
typedef struct IDtcLuRecoveryVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IDtcLuRecovery *This, REFIID riid,
                                  void **ppvObject);
...
public:
  virtual HRESULT WINAPI Create(byte *pucLuPair, DWORD cbLuPair,
                                IDtcLuRecovery **ppRecovery) = 0;
};
#else
typedef struct IDtcLuRecoveryFactoryVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IDtcLuRecoveryFactory *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IDtcLuRecoveryFactory *This);
  ULONG(WINAPI *Release)(IDtcLuRecoveryFactory *This);
  HRESULT(WINAPI *Create)(IDtcLuRecoveryFactory *This, byte *pucLuPair,
                          DWORD cbLuPair, IDtcLuRecovery **ppRecovery);
  END_INTERFACE
...
#endif
#endif
HRESULT WINAPI IDtcLuRecoveryFactory_Create_Proxy(IDtcLuRecoveryFactory *This,
                                                  byte *pucLuPair,
                                                  DWORD cbLuPair,
...
typedef enum _DtcLu_Xln { DTCLUXLN_COLD = 1, DTCLUXLN_WARM } DTCLUXLN;
...
public:
  virtual HRESULT WINAPI GetLogNameSizes(DWORD *pcbOurLogName,
                                         DWORD *pcbRemoteLogName) = 0;
  virtual HRESULT WINAPI GetOurXln(DTCLUXLN *pXln, unsigned char *pOurLogName,
                                   unsigned char *pRemoteLogName,
                                   DWORD *pdwProtocol) = 0;
  virtual HRESULT WINAPI
  HandleConfirmationFromOurXln(DTCLUXLNCONFIRMATION Confirmation) = 0;
  virtual HRESULT WINAPI HandleTheirXlnResponse(
      DTCLUXLN Xln, unsigned char *pRemoteLogName, DWORD cbRemoteLogName,
      DWORD dwProtocol, DTCLUXLNCONFIRMATION *pConfirmation) = 0;
  ...
  virtual HRESULT WINAPI GetOurCompareStates(
      unsigned char *pOurTransId, DTCLUCOMPARESTATE *pCompareState) = 0;
  virtual HRESULT WINAPI HandleTheirCompareStatesResponse(
      DTCLUCOMPARESTATE CompareState,
      DTCLUCOMPARESTATESCONFIRMATION *pConfirmation) = 0;
  virtual HRESULT WINAPI
  HandleErrorFromOurCompareStates(DTCLUCOMPARESTATESERROR Error) = 0;
...
typedef struct IDtcLuRecoveryInitiatedByDtcTransWorkVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IDtcLuRecoveryInitiatedByDtcTransWork *This,
                                  REFIID riid, void **ppvObject);
  ...
  HRESULT(WINAPI *GetLogNameSizes)(IDtcLuRecoveryInitiatedByDtcTransWork *This,
                                   DWORD *pcbOurLogName,
                                   DWORD *pcbRemoteLogName);
  HRESULT(WINAPI *GetOurXln)(IDtcLuRecoveryInitiatedByDtcTransWork *This,
                             DTCLUXLN *pXln, unsigned char *pOurLogName,
                             unsigned char *pRemoteLogName, DWORD *pdwProtocol);
  HRESULT(WINAPI *HandleConfirmationFromOurXln)(
      IDtcLuRecoveryInitiatedByDtcTransWork *This,
      DTCLUXLNCONFIRMATION Confirmation);
  HRESULT(WINAPI *HandleTheirXlnResponse)(
      IDtcLuRecoveryInitiatedByDtcTransWork *This, DTCLUXLN Xln,
      unsigned char *pRemoteLogName, DWORD cbRemoteLogName, DWORD dwProtocol,
      DTCLUXLNCONFIRMATION *pConfirmation);
  HRESULT(WINAPI *HandleErrorFromOurXln)(
      IDtcLuRecoveryInitiatedByDtcTransWork *This, DTCLUXLNERROR Error);
  HRESULT(WINAPI *CheckForCompareStates)(
      IDtcLuRecoveryInitiatedByDtcTransWork *This, WINBOOL *fCompareStates);
  HRESULT(WINAPI *GetOurTransIdSize)(
      IDtcLuRecoveryInitiatedByDtcTransWork *This, DWORD *pcbOurTransId);
  HRESULT(WINAPI *GetOurCompareStates)(
      IDtcLuRecoveryInitiatedByDtcTransWork *This, unsigned char *pOurTransId,
      DTCLUCOMPARESTATE *pCompareState);
  HRESULT(WINAPI *HandleTheirCompareStatesResponse)(
      IDtcLuRecoveryInitiatedByDtcTransWork *This,
      DTCLUCOMPARESTATE CompareState,
      DTCLUCOMPARESTATESCONFIRMATION *pConfirmation);
  HRESULT(WINAPI *HandleErrorFromOurCompareStates)(
      IDtcLuRecoveryInitiatedByDtcTransWork *This,
      DTCLUCOMPARESTATESERROR Error);
  HRESULT(WINAPI *ConversationLost)(
      IDtcLuRecoveryInitiatedByDtcTransWork *This);
  HRESULT(WINAPI *GetRecoverySeqNum)(
      IDtcLuRecoveryInitiatedByDtcTransWork *This, LONG *plRecoverySeqNum);
  HRESULT(WINAPI *ObsoleteRecoverySeqNum)(
      IDtcLuRecoveryInitiatedByDtcTransWork *This, LONG lNewRecoverySeqNum);
  END_INTERFACE
...
#ifdef COBJMACROS
#define IDtcLuRecoveryInitiatedByDtcTransWork_QueryInterface(This, riid,       \
                                                             ppvObject)        \
  (This)->lpVtbl->QueryInterface(This, riid, ppvObject)
...
#define IDtcLuRecoveryInitiatedByDtcTransWork_Release(This)                    \
  (This)->lpVtbl->Release(This)
#define IDtcLuRecoveryInitiatedByDtcTransWork_GetLogNameSizes(                 \
    This, pcbOurLogName, pcbRemoteLogName)                                     \
  (This)->lpVtbl->GetLogNameSizes(This, pcbOurLogName, pcbRemoteLogName)
#define IDtcLuRecoveryInitiatedByDtcTransWork_GetOurXln(                       \
    This, pXln, pOurLogName, pRemoteLogName, pdwProtocol)                      \
  (This)->lpVtbl->GetOurXln(This, pXln, pOurLogName, pRemoteLogName,           \
                            pdwProtocol)
#define IDtcLuRecoveryInitiatedByDtcTransWork_HandleConfirmationFromOurXln(    \
    This, Confirmation)                                                        \
  (This)->lpVtbl->HandleConfirmationFromOurXln(This, Confirmation)
#define IDtcLuRecoveryInitiatedByDtcTransWork_HandleTheirXlnResponse(          \
    This, Xln, pRemoteLogName, cbRemoteLogName, dwProtocol, pConfirmation)     \
  (This)->lpVtbl->HandleTheirXlnResponse(                                      \
      This, Xln, pRemoteLogName, cbRemoteLogName, dwProtocol, pConfirmation)
#define IDtcLuRecoveryInitiatedByDtcTransWork_HandleErrorFromOurXln(This,      \
                                                                    Error)     \
  (This)->lpVtbl->HandleErrorFromOurXln(This, Error)
#define IDtcLuRecoveryInitiatedByDtcTransWork_CheckForCompareStates(           \
    This, fCompareStates)                                                      \
  (This)->lpVtbl->CheckForCompareStates(This, fCompareStates)
#define IDtcLuRecoveryInitiatedByDtcTransWork_GetOurTransIdSize(This,          \
                                                                pcbOurTransId) \
  (This)->lpVtbl->GetOurTransIdSize(This, pcbOurTransId)
#define IDtcLuRecoveryInitiatedByDtcTransWork_GetOurCompareStates(             \
    This, pOurTransId, pCompareState)                                          \
  (This)->lpVtbl->GetOurCompareStates(This, pOurTransId, pCompareState)
#define IDtcLuRecoveryInitiatedByDtcTransWork_HandleTheirCompareStatesResponse( \
    This, CompareState, pConfirmation)                                          \
  (This)->lpVtbl->HandleTheirCompareStatesResponse(This, CompareState,          \
                                                   pConfirmation)
#define IDtcLuRecoveryInitiatedByDtcTransWork_HandleErrorFromOurCompareStates( \
    This, Error)                                                               \
...
#define IDtcLuRecoveryInitiatedByDtcTransWork_GetRecoverySeqNum(               \
    This, plRecoverySeqNum)                                                    \
  (This)->lpVtbl->GetRecoverySeqNum(This, plRecoverySeqNum)
#define IDtcLuRecoveryInitiatedByDtcTransWork_ObsoleteRecoverySeqNum(          \
    This, lNewRecoverySeqNum)                                                  \
  (This)->lpVtbl->ObsoleteRecoverySeqNum(This, lNewRecoverySeqNum)
#endif
#endif
HRESULT WINAPI IDtcLuRecoveryInitiatedByDtcTransWork_GetLogNameSizes_Proxy(
    IDtcLuRecoveryInitiatedByDtcTransWork *This, DWORD *pcbOurLogName,
    DWORD *pcbRemoteLogName);
void __RPC_STUB IDtcLuRecoveryInitiatedByDtcTransWork_GetLogNameSizes_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IDtcLuRecoveryInitiatedByDtcTransWork_GetOurXln_Proxy(
    IDtcLuRecoveryInitiatedByDtcTransWork *This, DTCLUXLN *pXln,
    unsigned char *pOurLogName, unsigned char *pRemoteLogName,
    DWORD *pdwProtocol);
void __RPC_STUB IDtcLuRecoveryInitiatedByDtcTransWork_GetOurXln_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
IDtcLuRecoveryInitiatedByDtcTransWork_HandleConfirmationFromOurXln_Proxy(
    IDtcLuRecoveryInitiatedByDtcTransWork *This,
    DTCLUXLNCONFIRMATION Confirmation);
void __RPC_STUB
IDtcLuRecoveryInitiatedByDtcTransWork_HandleConfirmationFromOurXln_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
IDtcLuRecoveryInitiatedByDtcTransWork_HandleTheirXlnResponse_Proxy(
    ...
    DTCLUXLNCONFIRMATION *pConfirmation);
void __RPC_STUB
IDtcLuRecoveryInitiatedByDtcTransWork_HandleTheirXlnResponse_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
IDtcLuRecoveryInitiatedByDtcTransWork_HandleErrorFromOurXln_Proxy(
    IDtcLuRecoveryInitiatedByDtcTransWork *This, DTCLUXLNERROR Error);
void __RPC_STUB
IDtcLuRecoveryInitiatedByDtcTransWork_HandleErrorFromOurXln_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
IDtcLuRecoveryInitiatedByDtcTransWork_CheckForCompareStates_Proxy(
    IDtcLuRecoveryInitiatedByDtcTransWork *This, WINBOOL *fCompareStates);
void __RPC_STUB
IDtcLuRecoveryInitiatedByDtcTransWork_CheckForCompareStates_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IDtcLuRecoveryInitiatedByDtcTransWork_GetOurTransIdSize_Proxy(
    IDtcLuRecoveryInitiatedByDtcTransWork *This, DWORD *pcbOurTransId);
void __RPC_STUB IDtcLuRecoveryInitiatedByDtcTransWork_GetOurTransIdSize_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IDtcLuRecoveryInitiatedByDtcTransWork_GetOurCompareStates_Proxy(
    IDtcLuRecoveryInitiatedByDtcTransWork *This, unsigned char *pOurTransId,
    DTCLUCOMPARESTATE *pCompareState);
void __RPC_STUB IDtcLuRecoveryInitiatedByDtcTransWork_GetOurCompareStates_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
IDtcLuRecoveryInitiatedByDtcTransWork_HandleTheirCompareStatesResponse_Proxy(
    IDtcLuRecoveryInitiatedByDtcTransWork *This, DTCLUCOMPARESTATE CompareState,
    DTCLUCOMPARESTATESCONFIRMATION *pConfirmation);
void __RPC_STUB
IDtcLuRecoveryInitiatedByDtcTransWork_HandleTheirCompareStatesResponse_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
IDtcLuRecoveryInitiatedByDtcTransWork_HandleErrorFromOurCompareStates_Proxy(
    IDtcLuRecoveryInitiatedByDtcTransWork *This, DTCLUCOMPARESTATESERROR Error);
void __RPC_STUB
IDtcLuRecoveryInitiatedByDtcTransWork_HandleErrorFromOurCompareStates_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IDtcLuRecoveryInitiatedByDtcTransWork_ConversationLost_Proxy(
    IDtcLuRecoveryInitiatedByDtcTransWork *This);
void __RPC_STUB IDtcLuRecoveryInitiatedByDtcTransWork_ConversationLost_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IDtcLuRecoveryInitiatedByDtcTransWork_GetRecoverySeqNum_Proxy(
    IDtcLuRecoveryInitiatedByDtcTransWork *This, LONG *plRecoverySeqNum);
void __RPC_STUB IDtcLuRecoveryInitiatedByDtcTransWork_GetRecoverySeqNum_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
IDtcLuRecoveryInitiatedByDtcTransWork_ObsoleteRecoverySeqNum_Proxy(
    IDtcLuRecoveryInitiatedByDtcTransWork *This, LONG lNewRecoverySeqNum);
void __RPC_STUB
IDtcLuRecoveryInitiatedByDtcTransWork_ObsoleteRecoverySeqNum_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
#endif
...
typedef struct IDtcLuRecoveryInitiatedByDtcStatusWorkVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IDtcLuRecoveryInitiatedByDtcStatusWork *This,
                                  REFIID riid, void **ppvObject);
  ...
  HRESULT(WINAPI *HandleCheckLuStatus)(
      IDtcLuRecoveryInitiatedByDtcStatusWork *This, LONG lRecoverySeqNum);
  END_INTERFACE
...
#ifdef COBJMACROS
#define IDtcLuRecoveryInitiatedByDtcStatusWork_QueryInterface(This, riid,      \
                                                              ppvObject)       \
  (This)->lpVtbl->QueryInterface(This, riid, ppvObject)
...
#define IDtcLuRecoveryInitiatedByDtcStatusWork_Release(This)                   \
  (This)->lpVtbl->Release(This)
#define IDtcLuRecoveryInitiatedByDtcStatusWork_HandleCheckLuStatus(            \
    This, lRecoverySeqNum)                                                     \
  (This)->lpVtbl->HandleCheckLuStatus(This, lRecoverySeqNum)
#endif
#endif
HRESULT WINAPI IDtcLuRecoveryInitiatedByDtcStatusWork_HandleCheckLuStatus_Proxy(
    IDtcLuRecoveryInitiatedByDtcStatusWork *This, LONG lRecoverySeqNum);
...
public:
  virtual HRESULT WINAPI GetWork(DTCINITIATEDRECOVERYWORK *pWork,
                                 void **ppv) = 0;
};
#else
typedef struct IDtcLuRecoveryInitiatedByDtcVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IDtcLuRecoveryInitiatedByDtc *This,
                                  REFIID riid, void **ppvObject);
  ULONG(WINAPI *AddRef)(IDtcLuRecoveryInitiatedByDtc *This);
  ULONG(WINAPI *Release)(IDtcLuRecoveryInitiatedByDtc *This);
  HRESULT(WINAPI *GetWork)(IDtcLuRecoveryInitiatedByDtc *This,
                           DTCINITIATEDRECOVERYWORK *pWork, void **ppv);
  END_INTERFACE
...
#endif
#endif
HRESULT WINAPI IDtcLuRecoveryInitiatedByDtc_GetWork_Proxy(
    IDtcLuRecoveryInitiatedByDtc *This, DTCINITIATEDRECOVERYWORK *pWork,
    void **ppv);
...
public:
  virtual HRESULT WINAPI HandleTheirXln(LONG lRecoverySeqNum, DTCLUXLN Xln,
                                        unsigned char *pRemoteLogName,
                                        DWORD cbRemoteLogName,
                                        unsigned char *pOurLogName,
                                        DWORD cbOurLogName, DWORD dwProtocol,
                                        DTCLUXLNRESPONSE *pResponse) = 0;
  virtual HRESULT WINAPI GetOurLogNameSize(DWORD *pcbOurLogName) = 0;
  virtual HRESULT WINAPI GetOurXln(DTCLUXLN *pXln, unsigned char *pOurLogName,
                                   DWORD *pdwProtocol) = 0;
  virtual HRESULT WINAPI
  HandleConfirmationOfOurXln(DTCLUXLNCONFIRMATION Confirmation) = 0;
  virtual HRESULT WINAPI HandleTheirCompareStates(
      unsigned char *pRemoteTransId, DWORD cbRemoteTransId,
      DTCLUCOMPARESTATE CompareState, DTCLUCOMPARESTATESRESPONSE *pResponse,
      DTCLUCOMPARESTATE *pCompareState) = 0;
  virtual HRESULT WINAPI HandleConfirmationOfOurCompareStates(
...
typedef struct IDtcLuRecoveryInitiatedByLuWorkVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IDtcLuRecoveryInitiatedByLuWork *This,
                                  REFIID riid, void **ppvObject);
  ULONG(WINAPI *AddRef)(IDtcLuRecoveryInitiatedByLuWork *This);
  ULONG(WINAPI *Release)(IDtcLuRecoveryInitiatedByLuWork *This);
  HRESULT(WINAPI *HandleTheirXln)(IDtcLuRecoveryInitiatedByLuWork *This,
                                  LONG lRecoverySeqNum, DTCLUXLN Xln,
                                  unsigned char *pRemoteLogName,
                                  DWORD cbRemoteLogName,
                                  unsigned char *pOurLogName,
                                  DWORD cbOurLogName, DWORD dwProtocol,
                                  DTCLUXLNRESPONSE *pResponse);
  HRESULT(WINAPI *GetOurLogNameSize)(IDtcLuRecoveryInitiatedByLuWork *This,
                                     DWORD *pcbOurLogName);
  HRESULT(WINAPI *GetOurXln)(IDtcLuRecoveryInitiatedByLuWork *This,
                             DTCLUXLN *pXln, unsigned char *pOurLogName,
                             DWORD *pdwProtocol);
  HRESULT(WINAPI *HandleConfirmationOfOurXln)(
      IDtcLuRecoveryInitiatedByLuWork *This, DTCLUXLNCONFIRMATION Confirmation);
  HRESULT(WINAPI *HandleTheirCompareStates)(
      IDtcLuRecoveryInitiatedByLuWork *This, unsigned char *pRemoteTransId,
      DWORD cbRemoteTransId, DTCLUCOMPARESTATE CompareState,
      DTCLUCOMPARESTATESRESPONSE *pResponse, DTCLUCOMPARESTATE *pCompareState);
  HRESULT(WINAPI *HandleConfirmationOfOurCompareStates)(
      IDtcLuRecoveryInitiatedByLuWork *This,
      DTCLUCOMPARESTATESCONFIRMATION Confirmation);
  HRESULT(WINAPI *HandleErrorFromOurCompareStates)(
      IDtcLuRecoveryInitiatedByLuWork *This, DTCLUCOMPARESTATESERROR Error);
...
#define IDtcLuRecoveryInitiatedByLuWork_Release(This)                          \
  (This)->lpVtbl->Release(This)
#define IDtcLuRecoveryInitiatedByLuWork_HandleTheirXln(                        \
    This, lRecoverySeqNum, Xln, pRemoteLogName, cbRemoteLogName, pOurLogName,  \
    cbOurLogName, dwProtocol, pResponse)                                       \
  (This)->lpVtbl->HandleTheirXln(This, lRecoverySeqNum, Xln, pRemoteLogName,   \
                                 cbRemoteLogName, pOurLogName, cbOurLogName,   \
                                 dwProtocol, pResponse)
...
#define IDtcLuRecoveryInitiatedByLuWork_GetOurXln(This, pXln, pOurLogName,     \
                                                  pdwProtocol)                 \
  (This)->lpVtbl->GetOurXln(This, pXln, pOurLogName, pdwProtocol)
#define IDtcLuRecoveryInitiatedByLuWork_HandleConfirmationOfOurXln(            \
    This, Confirmation)                                                        \
  (This)->lpVtbl->HandleConfirmationOfOurXln(This, Confirmation)
#define IDtcLuRecoveryInitiatedByLuWork_HandleTheirCompareStates(              \
    This, pRemoteTransId, cbRemoteTransId, CompareState, pResponse,            \
    pCompareState)                                                             \
  (This)->lpVtbl->HandleTheirCompareStates(This, pRemoteTransId,               \
                                           cbRemoteTransId, CompareState,      \
                                           pResponse, pCompareState)
#define IDtcLuRecoveryInitiatedByLuWork_HandleConfirmationOfOurCompareStates(  \
    This, Confirmation)                                                        \
  (This)->lpVtbl->HandleConfirmationOfOurCompareStates(This, Confirmation)
#define IDtcLuRecoveryInitiatedByLuWork_HandleErrorFromOurCompareStates(This,  \
                                                                        Error) \
  (This)->lpVtbl->HandleErrorFromOurCompareStates(This, Error)
...
#endif
#endif
HRESULT WINAPI IDtcLuRecoveryInitiatedByLuWork_HandleTheirXln_Proxy(
    IDtcLuRecoveryInitiatedByLuWork *This, LONG lRecoverySeqNum, DTCLUXLN Xln,
    unsigned char *pRemoteLogName, DWORD cbRemoteLogName,
    unsigned char *pOurLogName, DWORD cbOurLogName, DWORD dwProtocol,
    DTCLUXLNRESPONSE *pResponse);
void __RPC_STUB IDtcLuRecoveryInitiatedByLuWork_HandleTheirXln_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IDtcLuRecoveryInitiatedByLuWork_GetOurLogNameSize_Proxy(
    IDtcLuRecoveryInitiatedByLuWork *This, DWORD *pcbOurLogName);
void __RPC_STUB IDtcLuRecoveryInitiatedByLuWork_GetOurLogNameSize_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IDtcLuRecoveryInitiatedByLuWork_GetOurXln_Proxy(
    IDtcLuRecoveryInitiatedByLuWork *This, DTCLUXLN *pXln,
    unsigned char *pOurLogName, DWORD *pdwProtocol);
void __RPC_STUB IDtcLuRecoveryInitiatedByLuWork_GetOurXln_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IDtcLuRecoveryInitiatedByLuWork_HandleConfirmationOfOurXln_Proxy(
    IDtcLuRecoveryInitiatedByLuWork *This, DTCLUXLNCONFIRMATION Confirmation);
...
void __RPC_STUB IDtcLuRecoveryInitiatedByLuWork_HandleTheirCompareStates_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
IDtcLuRecoveryInitiatedByLuWork_HandleConfirmationOfOurCompareStates_Proxy(
    IDtcLuRecoveryInitiatedByLuWork *This,
    DTCLUCOMPARESTATESCONFIRMATION Confirmation);
void __RPC_STUB
IDtcLuRecoveryInitiatedByLuWork_HandleConfirmationOfOurCompareStates_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
IDtcLuRecoveryInitiatedByLuWork_HandleErrorFromOurCompareStates_Proxy(
    IDtcLuRecoveryInitiatedByLuWork *This, DTCLUCOMPARESTATESERROR Error);
void __RPC_STUB
IDtcLuRecoveryInitiatedByLuWork_HandleErrorFromOurCompareStates_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IDtcLuRecoveryInitiatedByLuWork_ConversationLost_Proxy(
    IDtcLuRecoveryInitiatedByLuWork *This);
...
public:
  virtual HRESULT WINAPI
  GetObjectToHandleWorkFromLu(IDtcLuRecoveryInitiatedByLuWork **ppWork) = 0;
};
#else
typedef struct IDtcLuRecoveryInitiatedByLuVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IDtcLuRecoveryInitiatedByLu *This,
                                  REFIID riid, void **ppvObject);
  ULONG(WINAPI *AddRef)(IDtcLuRecoveryInitiatedByLu *This);
  ULONG(WINAPI *Release)(IDtcLuRecoveryInitiatedByLu *This);
  HRESULT(WINAPI *GetObjectToHandleWorkFromLu)(
...
#endif
#endif
HRESULT WINAPI IDtcLuRecoveryInitiatedByLu_GetObjectToHandleWorkFromLu_Proxy(
    IDtcLuRecoveryInitiatedByLu *This,
    IDtcLuRecoveryInitiatedByLuWork **ppWork);
...
typedef struct IDtcLuRmEnlistmentVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IDtcLuRmEnlistment *This, REFIID riid,
                                  void **ppvObject);
...
#endif
#endif
HRESULT WINAPI IDtcLuRmEnlistment_Unplug_Proxy(IDtcLuRmEnlistment *This,
                                               WINBOOL fConversationLost);
...
typedef struct IDtcLuRmEnlistmentSinkVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IDtcLuRmEnlistmentSink *This, REFIID riid,
                                  void **ppvObject);
...
#endif
HRESULT
    WINAPI IDtcLuRmEnlistmentSink_AckUnplug_Proxy(IDtcLuRmEnlistmentSink *This);
void __RPC_STUB IDtcLuRmEnlistmentSink_AckUnplug_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
IDtcLuRmEnlistmentSink_TmDown_Proxy(IDtcLuRmEnlistmentSink *This);
void __RPC_STUB IDtcLuRmEnlistmentSink_TmDown_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
IDtcLuRmEnlistmentSink_SessionLost_Proxy(IDtcLuRmEnlistmentSink *This);
void __RPC_STUB IDtcLuRmEnlistmentSink_SessionLost_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
IDtcLuRmEnlistmentSink_BackedOut_Proxy(IDtcLuRmEnlistmentSink *This);
void __RPC_STUB IDtcLuRmEnlistmentSink_BackedOut_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
IDtcLuRmEnlistmentSink_BackOut_Proxy(IDtcLuRmEnlistmentSink *This);
void __RPC_STUB IDtcLuRmEnlistmentSink_BackOut_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
IDtcLuRmEnlistmentSink_Committed_Proxy(IDtcLuRmEnlistmentSink *This);
void __RPC_STUB IDtcLuRmEnlistmentSink_Committed_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
IDtcLuRmEnlistmentSink_Forget_Proxy(IDtcLuRmEnlistmentSink *This);
void __RPC_STUB IDtcLuRmEnlistmentSink_Forget_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
IDtcLuRmEnlistmentSink_Prepare_Proxy(IDtcLuRmEnlistmentSink *This);
void __RPC_STUB IDtcLuRmEnlistmentSink_Prepare_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
IDtcLuRmEnlistmentSink_RequestCommit_Proxy(IDtcLuRmEnlistmentSink *This);
...
public:
  virtual HRESULT WINAPI Create(unsigned char *pucLuPair, DWORD cbLuPair,
                                ...
                                unsigned char *pTransId, DWORD cbTransId,
...
typedef struct IDtcLuRmEnlistmentFactoryVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IDtcLuRmEnlistmentFactory *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IDtcLuRmEnlistmentFactory *This);
  ULONG(WINAPI *Release)(IDtcLuRmEnlistmentFactory *This);
  HRESULT(WINAPI *Create)(IDtcLuRmEnlistmentFactory *This,
                          unsigned char *pucLuPair, DWORD cbLuPair,
                          ITransaction *pITransaction, unsigned char *pTransId,
                          DWORD cbTransId,
                          IDtcLuRmEnlistmentSink *pRmEnlistmentSink,
...
#define IDtcLuRmEnlistmentFactory_Create(This, pucLuPair, cbLuPair,            \
                                         pITransaction, pTransId, cbTransId,   \
                                         pRmEnlistmentSink, ppRmEnlistment)    \
  (This)->lpVtbl->Create(This, pucLuPair, cbLuPair, pITransaction, pTransId,   \
                         cbTransId, pRmEnlistmentSink, ppRmEnlistment)
#endif
#endif
HRESULT WINAPI IDtcLuRmEnlistmentFactory_Create_Proxy(
    IDtcLuRmEnlistmentFactory *This, unsigned char *pucLuPair, DWORD cbLuPair,
    ITransaction *pITransaction, unsigned char *pTransId, DWORD cbTransId,
    IDtcLuRmEnlistmentSink *pRmEnlistmentSink,
    IDtcLuRmEnlistment **ppRmEnlistment);
...
typedef struct IDtcLuSubordinateDtcVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IDtcLuSubordinateDtc *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IDtcLuSubordinateDtc *This);
  ULONG(WINAPI *Release)(IDtcLuSubordinateDtc *This);
  HRESULT(WINAPI *Unplug)(IDtcLuSubordinateDtc *This,
                          WINBOOL fConversationLost);
...
#endif
#endif
HRESULT WINAPI IDtcLuSubordinateDtc_Unplug_Proxy(IDtcLuSubordinateDtc *This,
                                                 WINBOOL fConversationLost);
...
void __RPC_STUB IDtcLuSubordinateDtc_Prepare_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
IDtcLuSubordinateDtc_RequestCommit_Proxy(IDtcLuSubordinateDtc *This);
...
typedef struct IDtcLuSubordinateDtcSinkVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IDtcLuSubordinateDtcSink *This, REFIID riid,
                                  void **ppvObject);
...
#endif
HRESULT WINAPI
IDtcLuSubordinateDtcSink_AckUnplug_Proxy(IDtcLuSubordinateDtcSink *This);
void __RPC_STUB IDtcLuSubordinateDtcSink_AckUnplug_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
IDtcLuSubordinateDtcSink_TmDown_Proxy(IDtcLuSubordinateDtcSink *This);
void __RPC_STUB IDtcLuSubordinateDtcSink_TmDown_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
IDtcLuSubordinateDtcSink_SessionLost_Proxy(IDtcLuSubordinateDtcSink *This);
void __RPC_STUB IDtcLuSubordinateDtcSink_SessionLost_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
IDtcLuSubordinateDtcSink_BackedOut_Proxy(IDtcLuSubordinateDtcSink *This);
void __RPC_STUB IDtcLuSubordinateDtcSink_BackedOut_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
IDtcLuSubordinateDtcSink_BackOut_Proxy(IDtcLuSubordinateDtcSink *This);
void __RPC_STUB IDtcLuSubordinateDtcSink_BackOut_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
IDtcLuSubordinateDtcSink_Committed_Proxy(IDtcLuSubordinateDtcSink *This);
void __RPC_STUB IDtcLuSubordinateDtcSink_Committed_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
IDtcLuSubordinateDtcSink_Forget_Proxy(IDtcLuSubordinateDtcSink *This);
void __RPC_STUB IDtcLuSubordinateDtcSink_Forget_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
IDtcLuSubordinateDtcSink_RequestCommit_Proxy(IDtcLuSubordinateDtcSink *This);
...
typedef struct IDtcLuSubordinateDtcFactoryVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IDtcLuSubordinateDtcFactory *This,
                                  REFIID riid, void **ppvObject);
  ULONG(WINAPI *AddRef)(IDtcLuSubordinateDtcFactory *This);
  ULONG(WINAPI *Release)(IDtcLuSubordinateDtcFactory *This);
  HRESULT(WINAPI *Create)(IDtcLuSubordinateDtcFactory *This,
                          unsigned char *pucLuPair, DWORD cbLuPair,
                          IUnknown *punkTransactionOuter, ISOLEVEL isoLevel,
                          ULONG isoFlags, ITransactionOptions *pOptions,
                          ITransaction **ppTransaction, unsigned char *pTransId,
                          DWORD cbTransId,
                          IDtcLuSubordinateDtcSink *pSubordinateDtcSink,
...
#define IDtcLuSubordinateDtcFactory_Create(                                    \
    This, pucLuPair, cbLuPair, punkTransactionOuter, isoLevel, isoFlags,       \
    pOptions, ppTransaction, pTransId, cbTransId, pSubordinateDtcSink,         \
    ppSubordinateDtc)                                                          \
  (This)->lpVtbl->Create(This, pucLuPair, cbLuPair, punkTransactionOuter,      \
                         isoLevel, isoFlags, pOptions, ppTransaction,          \
                         pTransId, cbTransId, pSubordinateDtcSink,             \
                         ppSubordinateDtc)
#endif
#endif
HRESULT WINAPI IDtcLuSubordinateDtcFactory_Create_Proxy(
    IDtcLuSubordinateDtcFactory *This, unsigned char *pucLuPair, DWORD cbLuPair,
    IUnknown *punkTransactionOuter, ISOLEVEL isoLevel, ULONG isoFlags,
    ITransactionOptions *pOptions, ITransaction **ppTransaction,
    unsigned char *pTransId, DWORD cbTransId,
    IDtcLuSubordinateDtcSink *pSubordinateDtcSink,
    IDtcLuSubordinateDtc **ppSubordinateDtc);
void __RPC_STUB IDtcLuSubordinateDtcFactory_Create_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
#endif
DEFINE_GUID(IID_IXATransLookup, 0xF3B1F131, 0xEEDA, 0x11ce, 0xAE, 0xD4, 0x00,
            0xAA, 0x00, 0x51, 0xE2, 0xC4);
DEFINE_GUID(IID_IXATransLookup2, 0xbf193c85, 0xd1a, 0x4290, 0xb8, 0x8f, 0xd2,
            0xcb, 0x88, 0x73, 0xd1, 0xe7);
DEFINE_GUID(IID_IResourceManagerSink, 0x0D563181, 0xDEFB, 0x11ce, 0xAE, 0xD1,
            0x00, 0xAA, 0x00, 0x51, 0xE2, 0xC4);
DEFINE_GUID(IID_IResourceManager, 0x3741d21, 0x87eb, 0x11ce, 0x80, 0x81, 0x00,
            0x80, 0xc7, 0x58, 0x52, 0x7e);
DEFINE_GUID(IID_IResourceManager2, 0xd136c69a, 0xf749, 0x11d1, 0x8f, 0x47, 0x0,
            0xc0, 0x4f, 0x8e, 0xe5, 0x7d);
DEFINE_GUID(IID_ILastResourceManager, 0x4d964ad4, 0x5b33, 0x11d3, 0x8a, 0x91,
            0x00, 0xc0, 0x4f, 0x79, 0xeb, 0x6d);
DEFINE_GUID(IID_IXAConfig, 0xC8A6E3A1, 0x9A8C, 0x11cf, 0xA3, 0x08, 0x00, 0xA0,
            0xC9, 0x05, 0x41, 0x6E);
DEFINE_GUID(IID_IRMHelper, 0xE793F6D1, 0xF53D, 0x11cf, 0xA6, 0x0D, 0x00, 0xA0,
            0xC9, 0x05, 0x41, 0x6E);
DEFINE_GUID(IID_IXAObtainRMInfo, 0xE793F6D2, 0xF53D, 0x11cf, 0xA6, 0x0D, 0x00,
            0xA0, 0xC9, 0x05, 0x41, 0x6E);
DEFINE_GUID(IID_IXAResourceManager, 0x4131E751, 0x1AEA, 0x11d0, 0x94, 0x4B,
            0x00, 0xA0, 0xC9, 0x05, 0x41, 0x6E);
DEFINE_GUID(IID_IXAResourceManagerFactory, 0x4131E750, 0x1AEA, 0x11d0, 0x94,
            0x4B, 0x00, 0xA0, 0xC9, 0x05, 0x41, 0x6E);
DEFINE_GUID(IID_IXATransaction, 0x4131E752, 0x1AEA, 0x11d0, 0x94, 0x4B, 0x00,
            0xA0, 0xC9, 0x05, 0x41, 0x6E);
DEFINE_GUID(IID_IResourceManagerFactory, 0x13741d20, 0x87eb, 0x11ce, 0x80, 0x81,
            0x00, 0x80, 0xc7, 0x58, 0x52, 0x7e);
DEFINE_GUID(IID_IResourceManagerFactory2, 0x6b369c21, 0xfbd2, 0x11d1, 0x8f,
            0x47, 0x0, 0xc0, 0x4f, 0x8e, 0xe5, 0x7d);
DEFINE_GUID(IID_IPrepareInfo, 0x80c7bfd0, 0x87ee, 0x11ce, 0x80, 0x81, 0x00,
            0x80, 0xc7, 0x58, 0x52, 0x7e);
DEFINE_GUID(IID_IPrepareInfo2, 0x5FAB2547, 0x9779, 0x11d1, 0xB8, 0x86, 0x00,
            0xC0, 0x4F, 0xB9, 0x61, 0x8A);
DEFINE_GUID(IID_IGetDispenser, 0xc23cc370, 0x87ef, 0x11ce, 0x80, 0x81, 0x00,
            0x80, 0xc7, 0x58, 0x52, 0x7e);
DEFINE_GUID(IID_ITransactionVoterNotifyAsync2, 0x5433376b, 0x414d, 0x11d3, 0xb2,
            0x6, 0x0, 0xc0, 0x4f, 0xc2, 0xf3, 0xef);
DEFINE_GUID(IID_ITransactionVoterBallotAsync2, 0x5433376c, 0x414d, 0x11d3, 0xb2,
            0x6, 0x0, 0xc0, 0x4f, 0xc2, 0xf3, 0xef);
DEFINE_GUID(IID_ITransactionVoterFactory2, 0x5433376a, 0x414d, 0x11d3, 0xb2,
            0x6, 0x0, 0xc0, 0x4f, 0xc2, 0xf3, 0xef);
DEFINE_GUID(IID_ITransactionPhase0EnlistmentAsync, 0x82DC88E1, 0xA954, 0x11d1,
            0x8F, 0x88, 0x00, 0x60, 0x08, 0x95, 0xE7, 0xD5);
DEFINE_GUID(IID_ITransactionPhase0NotifyAsync, 0xEF081809, 0x0C76, 0x11d2, 0x87,
            0xA6, 0x00, 0xC0, 0x4F, 0x99, 0x0F, 0x34);
DEFINE_GUID(IID_ITransactionPhase0Factory, 0x82DC88E0, 0xA954, 0x11d1, 0x8F,
            0x88, 0x00, 0x60, 0x08, 0x95, 0xE7, 0xD5);
DEFINE_GUID(IID_ITransactionTransmitter, 0x59313E01, 0xB36C, 0x11cf, 0xA5, 0x39,
            0x00, 0xAA, 0x00, 0x68, 0x87, 0xC3);
DEFINE_GUID(IID_ITransactionTransmitterFactory, 0x59313E00, 0xB36C, 0x11cf,
            0xA5, 0x39, 0x00, 0xAA, 0x00, 0x68, 0x87, 0xC3);
DEFINE_GUID(IID_ITransactionReceiver, 0x59313E03, 0xB36C, 0x11cf, 0xA5, 0x39,
            0x00, 0xAA, 0x00, 0x68, 0x87, 0xC3);
DEFINE_GUID(IID_ITransactionReceiverFactory, 0x59313E02, 0xB36C, 0x11cf, 0xA5,
            0x39, 0x00, 0xAA, 0x00, 0x68, 0x87, 0xC3);
DEFINE_GUID(IID_IDtcLuConfigure, 0x4131E760, 0x1AEA, 0x11d0, 0x94, 0x4B, 0x00,
            0xA0, 0xC9, 0x05, 0x41, 0x6E);
DEFINE_GUID(IID_IDtcLuRecovery, 0xac2b8ad2, 0xd6f0, 0x11d0, 0xb3, 0x86, 0x0,
            0xa0, 0xc9, 0x8, 0x33, 0x65);
DEFINE_GUID(IID_IDtcLuRecoveryFactory, 0x4131E762, 0x1AEA, 0x11d0, 0x94, 0x4B,
            0x00, 0xA0, 0xC9, 0x05, 0x41, 0x6E);
DEFINE_GUID(IID_IDtcLuRecoveryInitiatedByDtcTransWork, 0x4131E765, 0x1AEA,
            0x11d0, 0x94, 0x4B, 0x00, 0xA0, 0xC9, 0x05, 0x41, 0x6E);
DEFINE_GUID(IID_IDtcLuRecoveryInitiatedByDtcStatusWork, 0x4131E766, 0x1AEA,
            0x11d0, 0x94, 0x4B, 0x00, 0xA0, 0xC9, 0x05, 0x41, 0x6E);
DEFINE_GUID(IID_IDtcLuRecoveryInitiatedByDtc, 0x4131E764, 0x1AEA, 0x11d0, 0x94,
            0x4B, 0x00, 0xA0, 0xC9, 0x05, 0x41, 0x6E);
DEFINE_GUID(IID_IDtcLuRecoveryInitiatedByLuWork, 0xac2b8ad1, 0xd6f0, 0x11d0,
            0xb3, 0x86, 0x0, 0xa0, 0xc9, 0x8, 0x33, 0x65);
DEFINE_GUID(IID_IDtcLuRecoveryInitiatedByLu, 0x4131E768, 0x1AEA, 0x11d0, 0x94,
            0x4B, 0x00, 0xA0, 0xC9, 0x05, 0x41, 0x6E);
DEFINE_GUID(IID_IDtcLuRmEnlistment, 0x4131E769, 0x1AEA, 0x11d0, 0x94, 0x4B,
            0x00, 0xA0, 0xC9, 0x05, 0x41, 0x6E);
DEFINE_GUID(IID_IDtcLuRmEnlistmentSink, 0x4131E770, 0x1AEA, 0x11d0, 0x94, 0x4B,
            0x00, 0xA0, 0xC9, 0x05, 0x41, 0x6E);
DEFINE_GUID(IID_IDtcLuRmEnlistmentFactory, 0x4131E771, 0x1AEA, 0x11d0, 0x94,
            0x4B, 0x00, 0xA0, 0xC9, 0x05, 0x41, 0x6E);
DEFINE_GUID(IID_IDtcLuSubordinateDtc, 0x4131E773, 0x1AEA, 0x11d0, 0x94, 0x4B,
            0x00, 0xA0, 0xC9, 0x05, 0x41, 0x6E);
DEFINE_GUID(IID_IDtcLuSubordinateDtcSink, 0x4131E774, 0x1AEA, 0x11d0, 0x94,
            0x4B, 0x00, 0xA0, 0xC9, 0x05, 0x41, 0x6E);
DEFINE_GUID(IID_IDtcLuSubordinateDtcFactory, 0x4131E775, 0x1AEA, 0x11d0, 0x94,
            0x4B, 0x00, 0xA0, 0xC9, 0x05, 0x41, 0x6E);
