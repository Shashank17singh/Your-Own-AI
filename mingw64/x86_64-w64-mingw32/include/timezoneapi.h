...
WINBASEAPI WINBOOL WINAPI SystemTimeToTzSpecificLocalTime(
    CONST TIME_ZONE_INFORMATION *lpTimeZoneInformation,
    CONST SYSTEMTIME *lpUniversalTime, LPSYSTEMTIME lpLocalTime);
WINBASEAPI WINBOOL WINAPI TzSpecificLocalTimeToSystemTime(
    CONST TIME_ZONE_INFORMATION *lpTimeZoneInformation,
...
WINBOOL
    WINAPI GetTimeZoneInformationForYear(USHORT wYear,
...
WINBASEAPI WINBOOL WINAPI SystemTimeToTzSpecificLocalTimeEx(
