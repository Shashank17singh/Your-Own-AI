...
public:
  ...
  get_HideDLMembership(VARIANT_BOOL *pHideDLMembership) = 0;
  virtual HRESULT WINAPI
  put_HideDLMembership(VARIANT_BOOL varHideDLMembership) = 0;
};
#else
typedef struct IDistributionListVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IDistributionList *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IDistributionList *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IDistributionList *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IDistributionList *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *get_HideDLMembership)(IDistributionList *This,
                                        VARIANT_BOOL *pHideDLMembership);
  HRESULT(WINAPI *put_HideDLMembership)(IDistributionList *This,
                                        VARIANT_BOOL varHideDLMembership);
  END_INTERFACE
...
#define IDistributionList_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,   \
                                        rgDispId)                              \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IDistributionList_Invoke(This, dispIdMember, riid, lcid, wFlags,       \
...
#endif
#endif
HRESULT WINAPI IDistributionList_get_HideDLMembership_Proxy(
    IDistributionList *This, VARIANT_BOOL *pHideDLMembership);
...
HRESULT WINAPI IDistributionList_put_HideDLMembership_Proxy(
    IDistributionList *This, VARIANT_BOOL varHideDLMembership);
...
public:
  ...
  virtual HRESULT WINAPI
  get_RestrictedAddressList(VARIANT *pRestrictedAddressList) = 0;
  virtual HRESULT WINAPI
  put_RestrictedAddressList(VARIANT varRestrictedAddressList) = 0;
  virtual HRESULT WINAPI get_RestrictedAddresses(
      CDOEXMRestrictedAddressType *pRestrictedAddresses) = 0;
  virtual HRESULT WINAPI put_RestrictedAddresses(
      CDOEXMRestrictedAddressType varRestrictedAddresses) = 0;
  virtual HRESULT WINAPI get_ForwardTo(BSTR *pForwardTo) = 0;
  virtual HRESULT WINAPI put_ForwardTo(BSTR varForwardTo) = 0;
  virtual HRESULT WINAPI
  get_ForwardingStyle(CDOEXMDeliverAndRedirect *pForwardingStyle) = 0;
  virtual HRESULT WINAPI
  put_ForwardingStyle(CDOEXMDeliverAndRedirect varForwardingStyle) = 0;
  virtual HRESULT WINAPI
  get_HideFromAddressBook(VARIANT_BOOL *pHideFromAddressBook) = 0;
  virtual HRESULT WINAPI
  put_HideFromAddressBook(VARIANT_BOOL varHideFromAddressBook) = 0;
  ...
  virtual HRESULT WINAPI
  get_AutoGenerateEmailAddresses(VARIANT_BOOL *pAutoGenerateEmailAddresses) = 0;
  virtual HRESULT WINAPI put_AutoGenerateEmailAddresses(
      VARIANT_BOOL varAutoGenerateEmailAddresses) = 0;
...
typedef struct IMailRecipientVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMailRecipient *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IMailRecipient *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IMailRecipient *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IMailRecipient *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *get_IncomingLimit)(IMailRecipient *This,
                                     __LONG32 *pIncomingLimit);
  HRESULT(WINAPI *put_IncomingLimit)(IMailRecipient *This,
                                     __LONG32 varIncomingLimit);
  HRESULT(WINAPI *get_OutgoingLimit)(IMailRecipient *This,
                                     __LONG32 *pOutgoingLimit);
  HRESULT(WINAPI *put_OutgoingLimit)(IMailRecipient *This,
                                     __LONG32 varOutgoingLimit);
  HRESULT(WINAPI *get_RestrictedAddressList)(IMailRecipient *This,
                                             VARIANT *pRestrictedAddressList);
  HRESULT(WINAPI *put_RestrictedAddressList)(IMailRecipient *This,
                                             VARIANT varRestrictedAddressList);
  HRESULT(WINAPI *get_RestrictedAddresses)(
      IMailRecipient *This, CDOEXMRestrictedAddressType *pRestrictedAddresses);
  HRESULT(WINAPI *put_RestrictedAddresses)(
      IMailRecipient *This, CDOEXMRestrictedAddressType varRestrictedAddresses);
  ...
  HRESULT(WINAPI *get_ForwardingStyle)(
      IMailRecipient *This, CDOEXMDeliverAndRedirect *pForwardingStyle);
  HRESULT(WINAPI *put_ForwardingStyle)(
      IMailRecipient *This, CDOEXMDeliverAndRedirect varForwardingStyle);
  HRESULT(WINAPI *get_HideFromAddressBook)(IMailRecipient *This,
                                           VARIANT_BOOL *pHideFromAddressBook);
  HRESULT(WINAPI *put_HideFromAddressBook)(IMailRecipient *This,
                                           VARIANT_BOOL varHideFromAddressBook);
  ...
  HRESULT(WINAPI *get_ProxyAddresses)(IMailRecipient *This,
                                      VARIANT *pProxyAddresses);
  HRESULT(WINAPI *put_ProxyAddresses)(IMailRecipient *This,
                                      VARIANT varProxyAddresses);
  HRESULT(WINAPI *get_AutoGenerateEmailAddresses)(
      IMailRecipient *This, VARIANT_BOOL *pAutoGenerateEmailAddresses);
  HRESULT(WINAPI *put_AutoGenerateEmailAddresses)(
      IMailRecipient *This, VARIANT_BOOL varAutoGenerateEmailAddresses);
  HRESULT(WINAPI *get_Alias)(IMailRecipient *This, BSTR *pAlias);
  HRESULT(WINAPI *put_Alias)(IMailRecipient *This, BSTR varAlias);
  HRESULT(WINAPI *get_TargetAddress)(IMailRecipient *This,
                                     BSTR *varTargetAddress);
...
#define IMailRecipient_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IMailRecipient_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,      \
                                     rgDispId)                                 \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IMailRecipient_Invoke(This, dispIdMember, riid, lcid, wFlags,          \
...
#define IMailRecipient_put_RestrictedAddressList(This,                         \
                                                 varRestrictedAddressList)     \
...
#define IMailRecipient_get_AutoGenerateEmailAddresses(                         \
    This, pAutoGenerateEmailAddresses)                                         \
  (This)->lpVtbl->get_AutoGenerateEmailAddresses(This,                         \
                                                 pAutoGenerateEmailAddresses)
#define IMailRecipient_put_AutoGenerateEmailAddresses(                         \
    This, varAutoGenerateEmailAddresses)                                       \
  (This)->lpVtbl->put_AutoGenerateEmailAddresses(                              \
      This, varAutoGenerateEmailAddresses)
...
#endif
#endif
HRESULT WINAPI IMailRecipient_get_IncomingLimit_Proxy(IMailRecipient *This,
                                                      __LONG32 *pIncomingLimit);
void __RPC_STUB IMailRecipient_get_IncomingLimit_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailRecipient_put_IncomingLimit_Proxy(
    IMailRecipient *This, __LONG32 varIncomingLimit);
void __RPC_STUB IMailRecipient_put_IncomingLimit_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailRecipient_get_OutgoingLimit_Proxy(IMailRecipient *This,
                                                      __LONG32 *pOutgoingLimit);
void __RPC_STUB IMailRecipient_get_OutgoingLimit_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailRecipient_put_OutgoingLimit_Proxy(
    IMailRecipient *This, __LONG32 varOutgoingLimit);
void __RPC_STUB IMailRecipient_put_OutgoingLimit_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailRecipient_get_RestrictedAddressList_Proxy(
    IMailRecipient *This, VARIANT *pRestrictedAddressList);
void __RPC_STUB IMailRecipient_get_RestrictedAddressList_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailRecipient_put_RestrictedAddressList_Proxy(
    IMailRecipient *This, VARIANT varRestrictedAddressList);
void __RPC_STUB IMailRecipient_put_RestrictedAddressList_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailRecipient_get_RestrictedAddresses_Proxy(
    IMailRecipient *This, CDOEXMRestrictedAddressType *pRestrictedAddresses);
...
void __RPC_STUB IMailRecipient_put_RestrictedAddresses_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailRecipient_get_ForwardTo_Proxy(IMailRecipient *This,
                                                  BSTR *pForwardTo);
void __RPC_STUB IMailRecipient_get_ForwardTo_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailRecipient_put_ForwardTo_Proxy(IMailRecipient *This,
                                                  BSTR varForwardTo);
void __RPC_STUB IMailRecipient_put_ForwardTo_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailRecipient_get_ForwardingStyle_Proxy(
    IMailRecipient *This, CDOEXMDeliverAndRedirect *pForwardingStyle);
void __RPC_STUB IMailRecipient_get_ForwardingStyle_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailRecipient_put_ForwardingStyle_Proxy(
    IMailRecipient *This, CDOEXMDeliverAndRedirect varForwardingStyle);
void __RPC_STUB IMailRecipient_put_ForwardingStyle_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailRecipient_get_HideFromAddressBook_Proxy(
    IMailRecipient *This, VARIANT_BOOL *pHideFromAddressBook);
void __RPC_STUB IMailRecipient_get_HideFromAddressBook_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailRecipient_put_HideFromAddressBook_Proxy(
    IMailRecipient *This, VARIANT_BOOL varHideFromAddressBook);
void __RPC_STUB IMailRecipient_put_HideFromAddressBook_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailRecipient_get_X400Email_Proxy(IMailRecipient *This,
                                                  BSTR *pX400Email);
void __RPC_STUB IMailRecipient_get_X400Email_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailRecipient_put_X400Email_Proxy(IMailRecipient *This,
                                                  BSTR varX400Email);
void __RPC_STUB IMailRecipient_put_X400Email_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailRecipient_get_SMTPEmail_Proxy(IMailRecipient *This,
                                                  BSTR *pSMTPEmail);
void __RPC_STUB IMailRecipient_get_SMTPEmail_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailRecipient_put_SMTPEmail_Proxy(IMailRecipient *This,
                                                  BSTR varSMTPEmail);
void __RPC_STUB IMailRecipient_put_SMTPEmail_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailRecipient_get_ProxyAddresses_Proxy(
    IMailRecipient *This, VARIANT *pProxyAddresses);
void __RPC_STUB IMailRecipient_get_ProxyAddresses_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailRecipient_put_ProxyAddresses_Proxy(
    IMailRecipient *This, VARIANT varProxyAddresses);
void __RPC_STUB IMailRecipient_put_ProxyAddresses_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailRecipient_get_AutoGenerateEmailAddresses_Proxy(
    IMailRecipient *This, VARIANT_BOOL *pAutoGenerateEmailAddresses);
void __RPC_STUB IMailRecipient_get_AutoGenerateEmailAddresses_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailRecipient_put_AutoGenerateEmailAddresses_Proxy(
    IMailRecipient *This, VARIANT_BOOL varAutoGenerateEmailAddresses);
void __RPC_STUB IMailRecipient_put_AutoGenerateEmailAddresses_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailRecipient_get_Alias_Proxy(IMailRecipient *This,
                                              BSTR *pAlias);
void __RPC_STUB IMailRecipient_get_Alias_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailRecipient_put_Alias_Proxy(IMailRecipient *This,
                                              BSTR varAlias);
void __RPC_STUB IMailRecipient_put_Alias_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailRecipient_get_TargetAddress_Proxy(IMailRecipient *This,
                                                      BSTR *varTargetAddress);
void __RPC_STUB IMailRecipient_get_TargetAddress_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailRecipient_MailEnable_Proxy(IMailRecipient *This,
                                               BSTR TargetMailAddress);
...
public:
  virtual HRESULT WINAPI
  get_EnableStoreDefaults(VARIANT *pEnableStoreDefaults) = 0;
  virtual HRESULT WINAPI
  put_EnableStoreDefaults(VARIANT varEnableStoreDefaults) = 0;
  ...
  virtual HRESULT WINAPI get_OverrideStoreGarbageCollection(
      VARIANT_BOOL *pOverrideStoreGarbageCollection) = 0;
  virtual HRESULT WINAPI put_OverrideStoreGarbageCollection(
...
typedef struct IMailboxStoreVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMailboxStore *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IMailboxStore *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IMailboxStore *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IMailboxStore *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *get_EnableStoreDefaults)(IMailboxStore *This,
                                           VARIANT *pEnableStoreDefaults);
  HRESULT(WINAPI *put_EnableStoreDefaults)(IMailboxStore *This,
                                           VARIANT varEnableStoreDefaults);
  ...
  HRESULT(WINAPI *get_OverQuotaLimit)(IMailboxStore *This,
                                      __LONG32 *pOverQuotaLimit);
  HRESULT(WINAPI *put_OverQuotaLimit)(IMailboxStore *This,
  ...
  HRESULT(WINAPI *get_OverrideStoreGarbageCollection)(
      IMailboxStore *This, VARIANT_BOOL *pOverrideStoreGarbageCollection);
  HRESULT(WINAPI *put_OverrideStoreGarbageCollection)(
      IMailboxStore *This, VARIANT_BOOL varOverrideStoreGarbageCollection);
  HRESULT(WINAPI *get_DaysBeforeGarbageCollection)(
      IMailboxStore *This, __LONG32 *pDaysBeforeGarbageCollection);
  ...
  HRESULT(WINAPI *get_GarbageCollectOnlyAfterBackup)(
      IMailboxStore *This, VARIANT_BOOL *pGarbageCollectOnlyAfterBackup);
  HRESULT(WINAPI *put_GarbageCollectOnlyAfterBackup)(
      IMailboxStore *This, VARIANT_BOOL varGarbageCollectOnlyAfterBackup);
  ...
  HRESULT(WINAPI *get_RecipientLimit)(IMailboxStore *This,
                                      __LONG32 *pRecipientLimit);
  HRESULT(WINAPI *put_RecipientLimit)(IMailboxStore *This,
                                      __LONG32 varRecipientLimit);
...
#define IMailboxStore_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                 \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IMailboxStore_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,       \
                                    rgDispId)                                  \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IMailboxStore_Invoke(This, dispIdMember, riid, lcid, wFlags,           \
                             pDispParams, pVarResult, pExcepInfo, puArgErr)    \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#define IMailboxStore_get_OverrideStoreGarbageCollection(                      \
    This, pOverrideStoreGarbageCollection)                                     \
  (This)->lpVtbl->get_OverrideStoreGarbageCollection(                          \
      This, pOverrideStoreGarbageCollection)
#define IMailboxStore_put_OverrideStoreGarbageCollection(                      \
    This, varOverrideStoreGarbageCollection)                                   \
  (This)->lpVtbl->put_OverrideStoreGarbageCollection(                          \
      This, varOverrideStoreGarbageCollection)
#define IMailboxStore_get_DaysBeforeGarbageCollection(                         \
    This, pDaysBeforeGarbageCollection)                                        \
  (This)->lpVtbl->get_DaysBeforeGarbageCollection(                             \
      This, pDaysBeforeGarbageCollection)
#define IMailboxStore_put_DaysBeforeGarbageCollection(                         \
    This, varDaysBeforeGarbageCollection)                                      \
  (This)->lpVtbl->put_DaysBeforeGarbageCollection(                             \
      This, varDaysBeforeGarbageCollection)
#define IMailboxStore_get_GarbageCollectOnlyAfterBackup(                       \
    This, pGarbageCollectOnlyAfterBackup)                                      \
  (This)->lpVtbl->get_GarbageCollectOnlyAfterBackup(                           \
      This, pGarbageCollectOnlyAfterBackup)
#define IMailboxStore_put_GarbageCollectOnlyAfterBackup(                       \
...
#endif
#endif
HRESULT WINAPI IMailboxStore_get_EnableStoreDefaults_Proxy(
    IMailboxStore *This, VARIANT *pEnableStoreDefaults);
void __RPC_STUB IMailboxStore_get_EnableStoreDefaults_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailboxStore_put_EnableStoreDefaults_Proxy(
    IMailboxStore *This, VARIANT varEnableStoreDefaults);
void __RPC_STUB IMailboxStore_put_EnableStoreDefaults_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailboxStore_get_StoreQuota_Proxy(IMailboxStore *This,
                                                  __LONG32 *pStoreQuota);
void __RPC_STUB IMailboxStore_get_StoreQuota_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailboxStore_put_StoreQuota_Proxy(IMailboxStore *This,
                                                  __LONG32 varStoreQuota);
void __RPC_STUB IMailboxStore_put_StoreQuota_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailboxStore_get_OverQuotaLimit_Proxy(
    IMailboxStore *This, __LONG32 *pOverQuotaLimit);
void __RPC_STUB IMailboxStore_get_OverQuotaLimit_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailboxStore_put_OverQuotaLimit_Proxy(
    IMailboxStore *This, __LONG32 varOverQuotaLimit);
void __RPC_STUB IMailboxStore_put_OverQuotaLimit_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailboxStore_get_HardLimit_Proxy(IMailboxStore *This,
                                                 __LONG32 *pHardLimit);
void __RPC_STUB IMailboxStore_get_HardLimit_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailboxStore_put_HardLimit_Proxy(IMailboxStore *This,
...
void __RPC_STUB IMailboxStore_get_OverrideStoreGarbageCollection_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailboxStore_put_OverrideStoreGarbageCollection_Proxy(
    IMailboxStore *This, VARIANT_BOOL varOverrideStoreGarbageCollection);
void __RPC_STUB IMailboxStore_put_OverrideStoreGarbageCollection_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailboxStore_get_DaysBeforeGarbageCollection_Proxy(
    IMailboxStore *This, __LONG32 *pDaysBeforeGarbageCollection);
...
void __RPC_STUB IMailboxStore_put_DaysBeforeGarbageCollection_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailboxStore_get_GarbageCollectOnlyAfterBackup_Proxy(
    IMailboxStore *This, VARIANT_BOOL *pGarbageCollectOnlyAfterBackup);
void __RPC_STUB IMailboxStore_get_GarbageCollectOnlyAfterBackup_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailboxStore_put_GarbageCollectOnlyAfterBackup_Proxy(
    IMailboxStore *This, VARIANT_BOOL varGarbageCollectOnlyAfterBackup);
void __RPC_STUB IMailboxStore_put_GarbageCollectOnlyAfterBackup_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailboxStore_get_Delegates_Proxy(IMailboxStore *This,
                                                 VARIANT *pDelegates);
void __RPC_STUB IMailboxStore_get_Delegates_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailboxStore_put_Delegates_Proxy(IMailboxStore *This,
                                                 VARIANT varDelegates);
void __RPC_STUB IMailboxStore_put_Delegates_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailboxStore_get_HomeMDB_Proxy(IMailboxStore *This,
                                               BSTR *varHomeMDB);
void __RPC_STUB IMailboxStore_get_HomeMDB_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailboxStore_get_RecipientLimit_Proxy(
    IMailboxStore *This, __LONG32 *pRecipientLimit);
void __RPC_STUB IMailboxStore_get_RecipientLimit_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailboxStore_put_RecipientLimit_Proxy(
    IMailboxStore *This, __LONG32 varRecipientLimit);
void __RPC_STUB IMailboxStore_put_RecipientLimit_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailboxStore_CreateMailbox_Proxy(IMailboxStore *This,
                                                 BSTR HomeMDBURL);
...
void __RPC_STUB IMailboxStore_DeleteMailbox_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailboxStore_MoveMailbox_Proxy(IMailboxStore *This,
                                               BSTR HomeMDBURL);
