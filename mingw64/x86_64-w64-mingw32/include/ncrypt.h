...
#define NCRYPT_ASYMMETRIC_ENCRYPTION_INTERFACE                                 \
...
#define NCRYPT_ASYMMETRIC_ENCRYPTION_OPERATION                                 \
...
SECURITY_STATUS WINAPI NCryptOpenStorageProvider(NCRYPT_PROV_HANDLE *phProvider,
                                                 LPCWSTR pszProviderName,
                                                 DWORD dwFlags);
SECURITY_STATUS WINAPI NCryptEnumAlgorithms(NCRYPT_PROV_HANDLE hProvider,
                                            DWORD dwAlgOperations,
                                            DWORD *pdwAlgCount,
                                            NCryptAlgorithmName **ppAlgList,
                                            DWORD dwFlags);
SECURITY_STATUS WINAPI NCryptIsAlgSupported(NCRYPT_PROV_HANDLE hProvider,
                                            LPCWSTR pszAlgId, DWORD dwFlags);
SECURITY_STATUS WINAPI NCryptEnumKeys(NCRYPT_PROV_HANDLE hProvider,
                                      LPCWSTR pszScope,
                                      NCryptKeyName **ppKeyName,
                                      PVOID *ppEnumState, DWORD dwFlags);
...
SECURITY_STATUS WINAPI NCryptCreatePersistedKey(
    NCRYPT_PROV_HANDLE hProvider, NCRYPT_KEY_HANDLE *phKey, LPCWSTR pszAlgId,
...
#define NCRYPT_PCP_PLATFORM_BINDING_PCRMASK_PROPERTY                           \
  L"PCP_PLATFORM_BINDING_PCRMASK"
#define NCRYPT_PCP_PLATFORM_BINDING_PCRDIGESTLIST_PROPERTY                     \
  L"PCP_PLATFORM_BINDING_PCRDIGESTLIST"
#define NCRYPT_PCP_PLATFORM_BINDING_PCRDIGEST_PROPERTY                         \
  L"PCP_PLATFORM_BINDING_PCRDIGEST"
...
#define NCRYPT_PCP_ALTERNATE_KEY_STORAGE_LOCATION_PROPERTY                     \
  L"PCP_ALTERNATE_KEY_STORAGE_LOCATION"
#define NCRYPT_TPM12_PROVIDER (0x00010000)
#define NCRYPT_PCP_SIGNATURE_KEY (0x1)
#define NCRYPT_PCP_ENCRYPTION_KEY (0x2)
#define NCRYPT_PCP_GENERIC_KEY                                                 \
...
SECURITY_STATUS WINAPI NCryptGetProperty(NCRYPT_HANDLE hObject,
                                         ...
                                         DWORD dwFlags);
SECURITY_STATUS WINAPI NCryptSetProperty(NCRYPT_HANDLE hObject,
                                         LPCWSTR pszProperty, PBYTE pbInput,
                                         DWORD cbInput, DWORD dwFlags);
SECURITY_STATUS WINAPI NCryptFinalizeKey(NCRYPT_KEY_HANDLE hKey, DWORD dwFlags);
SECURITY_STATUS WINAPI NCryptEncrypt(NCRYPT_KEY_HANDLE hKey, PBYTE pbInput,
...
#define NCRYPT_KEY_STORAGE_INTERFACE_VERSION_2                                 \
  BCRYPT_MAKE_INTERFACE_VERSION(2, 0)
SECURITY_STATUS WINAPI NCryptImportKey(NCRYPT_PROV_HANDLE hProvider,
                                       NCRYPT_KEY_HANDLE hImportKey,
                                       LPCWSTR pszBlobType,
                                       NCryptBufferDesc *pParameterList,
                                       NCRYPT_KEY_HANDLE *phKey, PBYTE pbData,
                                       DWORD cbData, DWORD dwFlags);
SECURITY_STATUS WINAPI NCryptExportKey(NCRYPT_KEY_HANDLE hKey,
...
SECURITY_STATUS WINAPI NCryptVerifySignature(
    ...
    DWORD cbHashValue, PBYTE pbSignature, DWORD cbSignature, DWORD dwFlags);
...
SECURITY_STATUS WINAPI NCryptTranslateHandle(NCRYPT_PROV_HANDLE *phProvider,
                                             ...
                                             DWORD dwLegacyKeySpec,
                                             DWORD dwFlags);
SECURITY_STATUS WINAPI NCryptNotifyChangeKey(NCRYPT_PROV_HANDLE hProvider,
                                             HANDLE *phEvent, DWORD dwFlags);
SECURITY_STATUS WINAPI
...
SECURITY_STATUS WINAPI NCryptDeriveKey(NCRYPT_SECRET_HANDLE hSharedSecret,
                                       LPCWSTR pwszKDF,
                                       NCryptBufferDesc *pParameterList,
                                       PBYTE pbDerivedKey, DWORD cbDerivedKey,
                                       DWORD *pcbResult, ULONG dwFlags);
#if NTDDI_VERSION >= 0x06020000
SECURITY_STATUS WINAPI NCryptKeyDerivation(NCRYPT_KEY_HANDLE hKey,
                                           NCryptBufferDesc *pParameterList,
                                           PUCHAR pbDerivedKey,
                                           DWORD cbDerivedKey, DWORD *pcbResult,
                                           ULONG dwFlags);
#endif
#if NTDDI_VERSION >= NTDDI_WINTHRESHOLD
SECURITY_STATUS WINAPI NCryptCreateClaim(NCRYPT_KEY_HANDLE hSubjectKey,
                                         NCRYPT_KEY_HANDLE hAuthorityKey,
                                         DWORD dwClaimType,
                                         NCryptBufferDesc *pParameterList,
                                         PBYTE pbClaimBlob, DWORD cbClaimBlob,
                                         DWORD *pcbResult, DWORD dwFlags);
SECURITY_STATUS WINAPI NCryptVerifyClaim(
    NCRYPT_KEY_HANDLE hSubjectKey, NCRYPT_KEY_HANDLE hAuthorityKey,
    DWORD dwClaimType, NCryptBufferDesc *pParameterList, PBYTE pbClaimBlob,
    DWORD cbClaimBlob, NCryptBufferDesc *pOutput, DWORD dwFlags);
#endif
#endif
#ifdef __cplusplus
}
