...
typedef struct _SUPPORT_FUNCTIONS {
  ...
  DWORD(WINAPI *SetInterfaceReceiveType)(DWORD ProtocolId, DWORD InterfaceIndex,
                                         DWORD InterfaceReceiveType,
                                         WINBOOL bActivate);
  DWORD(WINAPI *ValidateRoute)(DWORD ProtocolId, PVOID RouteInfo,
                               PVOID DestAddress);
  DWORD(WINAPI *MIBEntryCreate)(DWORD dwRoutingPid, DWORD dwEntrySize,
                                LPVOID lpEntry);
  DWORD(WINAPI *MIBEntryDelete)(DWORD dwRoutingPid, DWORD dwEntrySize,
                                LPVOID lpEntry);
  DWORD(WINAPI *MIBEntrySet)(DWORD dwRoutingPid, DWORD dwEntrySize,
                             LPVOID lpEntry);
  DWORD(WINAPI *MIBEntryGet)(DWORD dwRoutingPid, DWORD dwInEntrySize,
                             LPVOID lpInEntry, LPDWORD lpOutEntrySize,
                             LPVOID lpOutEntry);
  DWORD(WINAPI *MIBEntryGetFirst)(DWORD dwRoutingPid, DWORD dwInEntrySize,
                                  LPVOID lpInEntry, LPDWORD lpOutEntrySize,
                                  LPVOID lpOutEntry);
  DWORD(WINAPI *MIBEntryGetNext)(DWORD dwRoutingPid, DWORD dwInEntrySize,
                                 LPVOID lpInEntry, LPDWORD lpOutEntrySize,
                                 LPVOID lpOutEntry);
...
typedef DWORD(WINAPI *PSTART_PROTOCOL)(HANDLE NotificationEvent,
...
typedef DWORD(WINAPI *PADD_INTERFACE)(
    LPWSTR InterfaceName, ULONG InterfaceIndex,
    NET_INTERFACE_TYPE InterfaceType, DWORD MediaType, WORD AccessType,
    WORD ConnectionType, PVOID InterfaceInfo, ULONG StructureVersion,
    ULONG StructureSize, ULONG StructureCount);
typedef DWORD(WINAPI *PDELETE_INTERFACE)(ULONG InterfaceIndex);
typedef DWORD(WINAPI *PGET_EVENT_MESSAGE)(ROUTING_PROTOCOL_EVENTS *Event,
                                          MESSAGE *Result);
typedef DWORD(WINAPI *PGET_INTERFACE_INFO)(
    ULONG InterfaceIndex, PVOID InterfaceInfo, PULONG BufferSize,
    PULONG StructureVersion, PULONG StructureSize, PULONG StructureCount);
typedef DWORD(WINAPI *PSET_INTERFACE_INFO)(ULONG InterfaceIndex,
                                           PVOID InterfaceInfo,
                                           ULONG StructureVersion,
                                           ULONG StructureSize,
                                           ULONG StructureCount);
typedef DWORD(WINAPI *PINTERFACE_STATUS)(ULONG InterfaceIndex,
                                         WINBOOL InterfaceActive,
                                         DWORD StatusType, PVOID StatusInfo);
typedef DWORD(WINAPI *PQUERY_POWER)(DWORD PowerType);
typedef DWORD(WINAPI *PSET_POWER)(DWORD PowerType);
typedef DWORD(WINAPI *PGET_GLOBAL_INFO)(PVOID GlobalInfo, PULONG BufferSize,
                                        PULONG StructureVersion,
                                        PULONG StructureSize,
                                        PULONG StructureCount);
typedef DWORD(WINAPI *PSET_GLOBAL_INFO)(PVOID GlobalInfo,
                                        ULONG StructureVersion,
                                        ULONG StructureSize,
                                        ULONG StructureCount);
...
typedef DWORD(WINAPI *PMIB_GET)(ULONG InputDataSize, PVOID InputData,
                                PULONG OutputDataSize, PVOID OutputData);
typedef DWORD(WINAPI *PMIB_SET)(ULONG InputDataSize, PVOID InputData);
typedef DWORD(WINAPI *PMIB_GET_FIRST)(ULONG InputDataSize, PVOID InputData,
                                      PULONG OutputDataSize, PVOID OutputData);
typedef DWORD(WINAPI *PMIB_GET_NEXT)(ULONG InputDataSize, PVOID InputData,
                                     PULONG OutputDataSize, PVOID OutputData);
typedef DWORD(WINAPI *PMIB_SET_TRAP_INFO)(HANDLE Event, ULONG InputDataSize,
                                          PVOID InputData,
                                          PULONG OutputDataSize,
                                          PVOID OutputData);
typedef DWORD(WINAPI *PMIB_GET_TRAP_INFO)(ULONG InputDataSize, PVOID InputData,
                                          PULONG OutputDataSize,
                                          PVOID OutputData);
typedef DWORD(WINAPI *PCONNECT_CLIENT)(ULONG InterfaceIndex,
                                       PVOID ClientAddress);
typedef DWORD(WINAPI *PDISCONNECT_CLIENT)(ULONG InterfaceIndex,
                                          PVOID ClientAddress);
...
typedef DWORD(WINAPI *PGET_NEIGHBORS)(DWORD InterfaceIndex, PDWORD NeighborList,
...
typedef DWORD(WINAPI *PGET_MFE_STATUS)(DWORD InterfaceIndex, DWORD GroupAddress,
                                       DWORD SourceAddress, PBYTE StatusCode);
