 ...
 * include/windows.system.profile.systemmanufacturers.idl - Do not edit ***/
#ifdef _WIN32
...
typedef interface __x_ABI_CWindows_CSystem_CProfile_CSystemManufacturers_CISmbiosInformationStatics
    __x_ABI_CWindows_CSystem_CProfile_CSystemManufacturers_CISmbiosInformationStatics;
#ifdef __cplusplus
#define __x_ABI_CWindows_CSystem_CProfile_CSystemManufacturers_CISmbiosInformationStatics \
...
#endif /* defined                                                                                   \
          ____x_ABI_CWindows_CSystem_CProfile_CSystemManufacturers_CSmbiosInformation_FWD_DEFINED__ \
        */
...
#endif
#if !defined(                                                                  \
    WINDOWS_SYSTEM_PROFILE_SYSTEMMANUFACTURERS_SYSTEMMANUFACTURERSCONTRACT_VERSION)
...
ISmbiosInformationStatics : public IInspectable {
  virtual HRESULT STDMETHODCALLTYPE get_SerialNumber(HSTRING * value) = 0;
};
} // namespace SystemManufacturers
} // namespace Profile
} // namespace System
...
interface __x_ABI_CWindows_CSystem_CProfile_CSystemManufacturers_CISmbiosInformationStatics {
  CONST_VTBL __x_ABI_CWindows_CSystem_CProfile_CSystemManufacturers_CISmbiosInformationStaticsVtbl
      *lpVtbl;
};
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
#define __x_ABI_CWindows_CSystem_CProfile_CSystemManufacturers_CISmbiosInformationStatics_QueryInterface( \
    This, riid, ppvObject)                                                                                \
  (This)->lpVtbl->QueryInterface(This, riid, ppvObject)
#define __x_ABI_CWindows_CSystem_CProfile_CSystemManufacturers_CISmbiosInformationStatics_AddRef( \
    This)                                                                                         \
  (This)->lpVtbl->AddRef(This)
#define __x_ABI_CWindows_CSystem_CProfile_CSystemManufacturers_CISmbiosInformationStatics_Release( \
    This)                                                                                          \
  (This)->lpVtbl->Release(This)
/*** IInspectable methods ***/
#define __x_ABI_CWindows_CSystem_CProfile_CSystemManufacturers_CISmbiosInformationStatics_GetIids( \
    This, iidCount, iids)                                                                          \
  (This)->lpVtbl->GetIids(This, iidCount, iids)
#define __x_ABI_CWindows_CSystem_CProfile_CSystemManufacturers_CISmbiosInformationStatics_GetRuntimeClassName( \
    This, className)                                                                                           \
  (This)->lpVtbl->GetRuntimeClassName(This, className)
#define __x_ABI_CWindows_CSystem_CProfile_CSystemManufacturers_CISmbiosInformationStatics_GetTrustLevel( \
    This, trustLevel)                                                                                    \
  (This)->lpVtbl->GetTrustLevel(This, trustLevel)
/*** ISmbiosInformationStatics methods ***/
#define __x_ABI_CWindows_CSystem_CProfile_CSystemManufacturers_CISmbiosInformationStatics_get_SerialNumber( \
    This, value)                                                                                            \
  (This)->lpVtbl->get_SerialNumber(This, value)
#else
/*** IUnknown methods ***/
static inline HRESULT
__x_ABI_CWindows_CSystem_CProfile_CSystemManufacturers_CISmbiosInformationStatics_QueryInterface(
    __x_ABI_CWindows_CSystem_CProfile_CSystemManufacturers_CISmbiosInformationStatics
        *This,
    REFIID riid, void **ppvObject) {
...
static inline ULONG
__x_ABI_CWindows_CSystem_CProfile_CSystemManufacturers_CISmbiosInformationStatics_AddRef(
    __x_ABI_CWindows_CSystem_CProfile_CSystemManufacturers_CISmbiosInformationStatics
        *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
__x_ABI_CWindows_CSystem_CProfile_CSystemManufacturers_CISmbiosInformationStatics_Release(
    __x_ABI_CWindows_CSystem_CProfile_CSystemManufacturers_CISmbiosInformationStatics
        *This) {
...
/*** IInspectable methods ***/
static inline HRESULT
__x_ABI_CWindows_CSystem_CProfile_CSystemManufacturers_CISmbiosInformationStatics_GetIids(
    __x_ABI_CWindows_CSystem_CProfile_CSystemManufacturers_CISmbiosInformationStatics
        *This,
    ULONG *iidCount, IID **iids) {
...
static inline HRESULT
__x_ABI_CWindows_CSystem_CProfile_CSystemManufacturers_CISmbiosInformationStatics_GetRuntimeClassName(
    __x_ABI_CWindows_CSystem_CProfile_CSystemManufacturers_CISmbiosInformationStatics
        *This,
    HSTRING *className) {
...
static inline HRESULT
__x_ABI_CWindows_CSystem_CProfile_CSystemManufacturers_CISmbiosInformationStatics_GetTrustLevel(
    __x_ABI_CWindows_CSystem_CProfile_CSystemManufacturers_CISmbiosInformationStatics
        *This,
    TrustLevel *trustLevel) {
...
/*** ISmbiosInformationStatics methods ***/
static inline HRESULT
__x_ABI_CWindows_CSystem_CProfile_CSystemManufacturers_CISmbiosInformationStatics_get_SerialNumber(
    __x_ABI_CWindows_CSystem_CProfile_CSystemManufacturers_CISmbiosInformationStatics
        *This,
    HSTRING *value) {
...
#define IID_ISmbiosInformationStatics                                          \
  IID___x_ABI_CWindows_CSystem_CProfile_CSystemManufacturers_CISmbiosInformationStatics
#define ISmbiosInformationStaticsVtbl                                          \
  __x_ABI_CWindows_CSystem_CProfile_CSystemManufacturers_CISmbiosInformationStaticsVtbl
#define ISmbiosInformationStatics                                              \
  __x_ABI_CWindows_CSystem_CProfile_CSystemManufacturers_CISmbiosInformationStatics
#define ISmbiosInformationStatics_QueryInterface                               \
  __x_ABI_CWindows_CSystem_CProfile_CSystemManufacturers_CISmbiosInformationStatics_QueryInterface
#define ISmbiosInformationStatics_AddRef                                       \
  __x_ABI_CWindows_CSystem_CProfile_CSystemManufacturers_CISmbiosInformationStatics_AddRef
#define ISmbiosInformationStatics_Release                                      \
  __x_ABI_CWindows_CSystem_CProfile_CSystemManufacturers_CISmbiosInformationStatics_Release
#define ISmbiosInformationStatics_GetIids                                      \
  __x_ABI_CWindows_CSystem_CProfile_CSystemManufacturers_CISmbiosInformationStatics_GetIids
#define ISmbiosInformationStatics_GetRuntimeClassName                          \
  __x_ABI_CWindows_CSystem_CProfile_CSystemManufacturers_CISmbiosInformationStatics_GetRuntimeClassName
#define ISmbiosInformationStatics_GetTrustLevel                                \
  __x_ABI_CWindows_CSystem_CProfile_CSystemManufacturers_CISmbiosInformationStatics_GetTrustLevel
#define ISmbiosInformationStatics_get_SerialNumber                             \
  __x_ABI_CWindows_CSystem_CProfile_CSystemManufacturers_CISmbiosInformationStatics_get_SerialNumber
...
static const WCHAR
    RuntimeClass_Windows_System_Profile_SystemManufacturers_SmbiosInformation
        [] = {'W', 'i', 'n', 'd', 'o', 'w', 's', '.', 'S', 'y', 's', 't', 'e',
              'm', '.', 'P', 'r', 'o', 'f', 'i', 'l', 'e', '.', 'S', 'y', 's',
              't', 'e', 'm', 'M', 'a', 'n', 'u', 'f', 'a', 'c', 't', 'u', 'r',
              'e', 'r', 's', '.', 'S', 'm', 'b', 'i', 'o', 's', 'I', 'n', 'f',
              'o', 'r', 'm', 'a', 't', 'i', 'o', 'n', 0};
