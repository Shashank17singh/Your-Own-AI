...
DEFINE_GUID(IID_IOptionArray, 0x22b6d492, 0x0f88, 0x11d1, 0xba, 0x19, 0x00,
            0xc0, 0x4f, 0xd9, 0x12, 0xd0);
...
IOptionArray : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE QueryOption(DWORD dwOption, LPVOID pBuffer,
                                                ULONG * pcbBuf) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetOption(DWORD dwOption, LPVOID pBuffer,
                                              ULONG cbBuf) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IOptionArray, 0x22b6d492, 0x0f88, 0x11d1, 0xba, 0x19, 0x00,
                0xc0, 0x4f, 0xd9, 0x12, 0xd0)
#endif
#else
typedef struct IOptionArrayVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IOptionArray *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IOptionArray *This);
  ULONG(STDMETHODCALLTYPE *Release)(IOptionArray *This);
  /*** IOptionArray methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryOption)(IOptionArray *This, DWORD dwOption,
                                          LPVOID pBuffer, ULONG *pcbBuf);
  HRESULT(STDMETHODCALLTYPE *SetOption)(IOptionArray *This, DWORD dwOption,
                                        LPVOID pBuffer, ULONG cbBuf);
  END_INTERFACE
} IOptionArrayVtbl;
interface IOptionArray { CONST_VTBL IOptionArrayVtbl *lpVtbl; };
#ifdef COBJMACROS
...
IOptionArray_QueryInterface(IOptionArray *This, REFIID riid, void **ppvObject) {
...
/*** IOptionArray methods ***/
static inline HRESULT IOptionArray_QueryOption(IOptionArray *This,
                                               DWORD dwOption, LPVOID pBuffer,
                                               ULONG *pcbBuf) {
  return This->lpVtbl->QueryOption(This, dwOption, pBuffer, pcbBuf);
}
static inline HRESULT IOptionArray_SetOption(IOptionArray *This, DWORD dwOption,
                                             LPVOID pBuffer, ULONG cbBuf) {
...
DEFINE_GUID(IID_IHtmlLoadOptions, 0xa71a0808, 0x0f88, 0x11d1, 0xba, 0x19, 0x00,
            0xc0, 0x4f, 0xd9, 0x12, 0xd0);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("a71a0808-0f88-11d1-ba19-00c04fd912d0")
IHtmlLoadOptions : public IOptionArray{};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IHtmlLoadOptions, 0xa71a0808, 0x0f88, 0x11d1, 0xba, 0x19, 0x00,
                0xc0, 0x4f, 0xd9, 0x12, 0xd0)
#endif
#else
typedef struct IHtmlLoadOptionsVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IHtmlLoadOptions *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IHtmlLoadOptions *This);
  ULONG(STDMETHODCALLTYPE *Release)(IHtmlLoadOptions *This);
  /*** IOptionArray methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryOption)(IHtmlLoadOptions *This,
                                          DWORD dwOption, LPVOID pBuffer,
                                          ULONG *pcbBuf);
  HRESULT(STDMETHODCALLTYPE *SetOption)(IHtmlLoadOptions *This, DWORD dwOption,
                                        LPVOID pBuffer, ULONG cbBuf);
  END_INTERFACE
} IHtmlLoadOptionsVtbl;
interface IHtmlLoadOptions { CONST_VTBL IHtmlLoadOptionsVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IHtmlLoadOptions_QueryInterface(IHtmlLoadOptions *This,
                                                      REFIID riid,
                                                      void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IOptionArray methods ***/
static inline HRESULT IHtmlLoadOptions_QueryOption(IHtmlLoadOptions *This,
                                                   DWORD dwOption,
                                                   LPVOID pBuffer,
                                                   ULONG *pcbBuf) {
  return This->lpVtbl->QueryOption(This, dwOption, pBuffer, pcbBuf);
}
static inline HRESULT IHtmlLoadOptions_SetOption(IHtmlLoadOptions *This,
                                                 DWORD dwOption, LPVOID pBuffer,
                                                 ULONG cbBuf) {
  return This->lpVtbl->SetOption(This, dwOption, pBuffer, cbBuf);
}
...
DEFINE_GUID(CLSID_HTMLLoadOptions, 0x18845040, 0x0FA5, 0x11D1, 0xBA, 0x19, 0x00,
            0xC0, 0x4F, 0xD9, 0x12, 0xD0);
