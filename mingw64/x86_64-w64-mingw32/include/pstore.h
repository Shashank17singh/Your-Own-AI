...
public:
  virtual HRESULT WINAPI Next(DWORD celt, LPWSTR *rgelt,
...
typedef struct IEnumPStoreItemsVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IEnumPStoreItems *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IEnumPStoreItems *This);
  ULONG(WINAPI *Release)(IEnumPStoreItems *This);
  HRESULT(WINAPI *Next)(IEnumPStoreItems *This, DWORD celt, LPWSTR *rgelt,
                        DWORD *pceltFetched);
...
#endif
#endif
HRESULT WINAPI IEnumPStoreItems_Next_Proxy(IEnumPStoreItems *This, DWORD celt,
                                           LPWSTR *rgelt, DWORD *pceltFetched);
...
void __RPC_STUB IEnumPStoreItems_Reset_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumPStoreItems_Clone_Proxy(IEnumPStoreItems *This,
...
typedef struct IEnumPStoreTypesVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IEnumPStoreTypes *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IEnumPStoreTypes *This);
  ULONG(WINAPI *Release)(IEnumPStoreTypes *This);
  HRESULT(WINAPI *Next)(IEnumPStoreTypes *This, DWORD celt, GUID *rgelt,
                        DWORD *pceltFetched);
...
#endif
#endif
HRESULT WINAPI IEnumPStoreTypes_Next_Proxy(IEnumPStoreTypes *This, DWORD celt,
                                           GUID *rgelt, DWORD *pceltFetched);
...
void __RPC_STUB IEnumPStoreTypes_Reset_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumPStoreTypes_Clone_Proxy(IEnumPStoreTypes *This,
...
public:
  ...
  virtual HRESULT WINAPI GetProvParam(DWORD dwParam, DWORD *pcbData,
                                      BYTE **ppbData, DWORD dwFlags) = 0;
  virtual HRESULT WINAPI SetProvParam(DWORD dwParam, DWORD cbData, BYTE *pbData,
                                      DWORD dwFlags) = 0;
  virtual HRESULT WINAPI CreateType(PST_KEY Key, const GUID *pType,
                                    PPST_TYPEINFO pInfo, DWORD dwFlags) = 0;
  virtual HRESULT WINAPI GetTypeInfo(PST_KEY Key, const GUID *pType,
                                     PPST_TYPEINFO *ppInfo, DWORD dwFlags) = 0;
  virtual HRESULT WINAPI DeleteType(PST_KEY Key, const GUID *pType,
                                    DWORD dwFlags) = 0;
  virtual HRESULT WINAPI CreateSubtype(PST_KEY Key, const GUID *pType,
                                       const GUID *pSubtype,
                                       PPST_TYPEINFO pInfo,
                                       PPST_ACCESSRULESET pRules,
                                       DWORD dwFlags) = 0;
  virtual HRESULT WINAPI GetSubtypeInfo(PST_KEY Key, const GUID *pType,
                                        const GUID *pSubtype,
                                        PPST_TYPEINFO *ppInfo,
                                        DWORD dwFlags) = 0;
  virtual HRESULT WINAPI DeleteSubtype(PST_KEY Key, const GUID *pType,
                                       const GUID *pSubtype, DWORD dwFlags) = 0;
  virtual HRESULT WINAPI ReadAccessRuleset(PST_KEY Key, const GUID *pType,
                                           const GUID *pSubtype,
                                           PPST_ACCESSRULESET *ppRules,
                                           DWORD dwFlags) = 0;
  virtual HRESULT WINAPI WriteAccessRuleset(PST_KEY Key, const GUID *pType,
                                            const GUID *pSubtype,
                                            PPST_ACCESSRULESET pRules,
                                            DWORD dwFlags) = 0;
  virtual HRESULT WINAPI EnumTypes(PST_KEY Key, DWORD dwFlags,
                                   IEnumPStoreTypes **ppenum) = 0;
  virtual HRESULT WINAPI EnumSubtypes(PST_KEY Key, const GUID *pType,
                                      DWORD dwFlags,
                                      IEnumPStoreTypes **ppenum) = 0;
  virtual HRESULT WINAPI DeleteItem(PST_KEY Key, const GUID *pItemType,
                                    const GUID *pItemSubtype,
                                    LPCWSTR szItemName,
                                    PPST_PROMPTINFO pPromptInfo,
                                    DWORD dwFlags) = 0;
  virtual HRESULT WINAPI ReadItem(PST_KEY Key, const GUID *pItemType,
                                  const GUID *pItemSubtype, LPCWSTR szItemName,
                                  DWORD *pcbData, BYTE **ppbData,
                                  PPST_PROMPTINFO pPromptInfo,
                                  DWORD dwFlags) = 0;
  virtual HRESULT WINAPI WriteItem(PST_KEY Key, const GUID *pItemType,
                                   const GUID *pItemSubtype, LPCWSTR szItemName,
                                   DWORD cbData, BYTE *pbData,
                                   PPST_PROMPTINFO pPromptInfo,
                                   DWORD dwDefaultConfirmationStyle,
                                   DWORD dwFlags) = 0;
  virtual HRESULT WINAPI OpenItem(PST_KEY Key, const GUID *pItemType,
                                  const GUID *pItemSubtype, LPCWSTR szItemName,
                                  PST_ACCESSMODE ModeFlags,
                                  PPST_PROMPTINFO pPromptInfo,
                                  DWORD dwFlags) = 0;
  virtual HRESULT WINAPI CloseItem(PST_KEY Key, const GUID *pItemType,
                                   const GUID *pItemSubtype, LPCWSTR szItemName,
                                   DWORD dwFlags) = 0;
  virtual HRESULT WINAPI EnumItems(PST_KEY Key, const GUID *pItemType,
...
typedef struct IPStoreVtbl {
  ...
  HRESULT(WINAPI *GetProvParam)(IPStore *This, DWORD dwParam, DWORD *pcbData,
                                BYTE **ppbData, DWORD dwFlags);
  HRESULT(WINAPI *SetProvParam)(IPStore *This, DWORD dwParam, DWORD cbData,
                                BYTE *pbData, DWORD dwFlags);
  HRESULT(WINAPI *CreateType)(IPStore *This, PST_KEY Key, const GUID *pType,
                              PPST_TYPEINFO pInfo, DWORD dwFlags);
  HRESULT(WINAPI *GetTypeInfo)(IPStore *This, PST_KEY Key, const GUID *pType,
                               PPST_TYPEINFO *ppInfo, DWORD dwFlags);
  HRESULT(WINAPI *DeleteType)(IPStore *This, PST_KEY Key, const GUID *pType,
                              DWORD dwFlags);
  HRESULT(WINAPI *CreateSubtype)(IPStore *This, PST_KEY Key, const GUID *pType,
                                 const GUID *pSubtype, PPST_TYPEINFO pInfo,
                                 PPST_ACCESSRULESET pRules, DWORD dwFlags);
  HRESULT(WINAPI *GetSubtypeInfo)(IPStore *This, PST_KEY Key, const GUID *pType,
                                  const GUID *pSubtype, PPST_TYPEINFO *ppInfo,
                                  DWORD dwFlags);
  HRESULT(WINAPI *DeleteSubtype)(IPStore *This, PST_KEY Key, const GUID *pType,
                                 const GUID *pSubtype, DWORD dwFlags);
  HRESULT(WINAPI *ReadAccessRuleset)(IPStore *This, PST_KEY Key,
                                     const GUID *pType, const GUID *pSubtype,
                                     PPST_ACCESSRULESET *ppRules,
                                     DWORD dwFlags);
  HRESULT(WINAPI *WriteAccessRuleset)(IPStore *This, PST_KEY Key,
                                      const GUID *pType, const GUID *pSubtype,
                                      PPST_ACCESSRULESET pRules, DWORD dwFlags);
  HRESULT(WINAPI *EnumTypes)(IPStore *This, PST_KEY Key, DWORD dwFlags,
                             IEnumPStoreTypes **ppenum);
  HRESULT(WINAPI *EnumSubtypes)(IPStore *This, PST_KEY Key, const GUID *pType,
                                DWORD dwFlags, IEnumPStoreTypes **ppenum);
  HRESULT(WINAPI *DeleteItem)(IPStore *This, PST_KEY Key, const GUID *pItemType,
                              const GUID *pItemSubtype, LPCWSTR szItemName,
                              PPST_PROMPTINFO pPromptInfo, DWORD dwFlags);
  HRESULT(WINAPI *ReadItem)(IPStore *This, PST_KEY Key, const GUID *pItemType,
                            const GUID *pItemSubtype, LPCWSTR szItemName,
                            DWORD *pcbData, BYTE **ppbData,
                            PPST_PROMPTINFO pPromptInfo, DWORD dwFlags);
  HRESULT(WINAPI *WriteItem)(IPStore *This, PST_KEY Key, const GUID *pItemType,
                             const GUID *pItemSubtype, LPCWSTR szItemName,
                             DWORD cbData, BYTE *pbData,
                             PPST_PROMPTINFO pPromptInfo,
                             DWORD dwDefaultConfirmationStyle, DWORD dwFlags);
  HRESULT(WINAPI *OpenItem)(IPStore *This, PST_KEY Key, const GUID *pItemType,
                            const GUID *pItemSubtype, LPCWSTR szItemName,
                            PST_ACCESSMODE ModeFlags,
                            PPST_PROMPTINFO pPromptInfo, DWORD dwFlags);
  HRESULT(WINAPI *CloseItem)(IPStore *This, PST_KEY Key, const GUID *pItemType,
                             const GUID *pItemSubtype, LPCWSTR szItemName,
                             DWORD dwFlags);
  HRESULT(WINAPI *EnumItems)(IPStore *This, PST_KEY Key, const GUID *pItemType,
                             const GUID *pItemSubtype, DWORD dwFlags,
                             IEnumPStoreItems **ppenum);
  END_INTERFACE
} IPStoreVtbl;
...
#define IPStore_CreateSubtype(This, Key, pType, pSubtype, pInfo, pRules,       \
                              dwFlags)                                         \
  (This)->lpVtbl->CreateSubtype(This, Key, pType, pSubtype, pInfo, pRules,     \
                                dwFlags)
...
#define IPStore_ReadAccessRuleset(This, Key, pType, pSubtype, ppRules,         \
                                  dwFlags)                                     \
  (This)->lpVtbl->ReadAccessRuleset(This, Key, pType, pSubtype, ppRules,       \
                                    dwFlags)
#define IPStore_WriteAccessRuleset(This, Key, pType, pSubtype, pRules,         \
                                   dwFlags)                                    \
  (This)->lpVtbl->WriteAccessRuleset(This, Key, pType, pSubtype, pRules,       \
                                     dwFlags)
...
#define IPStore_DeleteItem(This, Key, pItemType, pItemSubtype, szItemName,     \
                           pPromptInfo, dwFlags)                               \
  (This)->lpVtbl->DeleteItem(This, Key, pItemType, pItemSubtype, szItemName,   \
                             pPromptInfo, dwFlags)
#define IPStore_ReadItem(This, Key, pItemType, pItemSubtype, szItemName,       \
                         pcbData, ppbData, pPromptInfo, dwFlags)               \
  (This)->lpVtbl->ReadItem(This, Key, pItemType, pItemSubtype, szItemName,     \
                           pcbData, ppbData, pPromptInfo, dwFlags)
#define IPStore_WriteItem(This, Key, pItemType, pItemSubtype, szItemName,      \
                          cbData, pbData, pPromptInfo,                         \
                          dwDefaultConfirmationStyle, dwFlags)                 \
  (This)->lpVtbl->WriteItem(This, Key, pItemType, pItemSubtype, szItemName,    \
                            cbData, pbData, pPromptInfo,                       \
                            dwDefaultConfirmationStyle, dwFlags)
#define IPStore_OpenItem(This, Key, pItemType, pItemSubtype, szItemName,       \
                         ModeFlags, pPromptInfo, dwFlags)                      \
  (This)->lpVtbl->OpenItem(This, Key, pItemType, pItemSubtype, szItemName,     \
                           ModeFlags, pPromptInfo, dwFlags)
#define IPStore_CloseItem(This, Key, pItemType, pItemSubtype, szItemName,      \
                          dwFlags)                                             \
  (This)->lpVtbl->CloseItem(This, Key, pItemType, pItemSubtype, szItemName,    \
                            dwFlags)
...
#endif
#endif
HRESULT WINAPI IPStore_GetInfo_Proxy(IPStore *This,
                                     PPST_PROVIDERINFO *ppProperties);
void __RPC_STUB IPStore_GetInfo_Stub(IRpcStubBuffer *This,
                                     IRpcChannelBuffer *_pRpcChannelBuffer,
                                     PRPC_MESSAGE _pRpcMessage,
                                     DWORD *_pdwStubPhase);
HRESULT WINAPI IPStore_GetProvParam_Proxy(IPStore *This, DWORD dwParam,
                                          DWORD *pcbData, BYTE **ppbData,
                                          DWORD dwFlags);
void __RPC_STUB IPStore_GetProvParam_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI IPStore_SetProvParam_Proxy(IPStore *This, DWORD dwParam,
                                          DWORD cbData, BYTE *pbData,
                                          DWORD dwFlags);
void __RPC_STUB IPStore_SetProvParam_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI IPStore_CreateType_Proxy(IPStore *This, PST_KEY Key,
                                        const GUID *pType, PPST_TYPEINFO pInfo,
                                        DWORD dwFlags);
void __RPC_STUB IPStore_CreateType_Stub(IRpcStubBuffer *This,
                                        IRpcChannelBuffer *_pRpcChannelBuffer,
                                        PRPC_MESSAGE _pRpcMessage,
                                        DWORD *_pdwStubPhase);
HRESULT WINAPI IPStore_GetTypeInfo_Proxy(IPStore *This, PST_KEY Key,
                                         const GUID *pType,
                                         PPST_TYPEINFO *ppInfo, DWORD dwFlags);
void __RPC_STUB IPStore_GetTypeInfo_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
HRESULT WINAPI IPStore_DeleteType_Proxy(IPStore *This, PST_KEY Key,
                                        const GUID *pType, DWORD dwFlags);
void __RPC_STUB IPStore_DeleteType_Stub(IRpcStubBuffer *This,
                                        IRpcChannelBuffer *_pRpcChannelBuffer,
                                        PRPC_MESSAGE _pRpcMessage,
                                        DWORD *_pdwStubPhase);
HRESULT WINAPI IPStore_CreateSubtype_Proxy(
    IPStore *This, PST_KEY Key, const GUID *pType, const GUID *pSubtype,
    PPST_TYPEINFO pInfo, PPST_ACCESSRULESET pRules, DWORD dwFlags);
void __RPC_STUB IPStore_CreateSubtype_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IPStore_GetSubtypeInfo_Proxy(IPStore *This, PST_KEY Key,
                                            const GUID *pType,
                                            const GUID *pSubtype,
                                            PPST_TYPEINFO *ppInfo,
                                            DWORD dwFlags);
void __RPC_STUB IPStore_GetSubtypeInfo_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IPStore_DeleteSubtype_Proxy(IPStore *This, PST_KEY Key,
                                           const GUID *pType,
                                           const GUID *pSubtype, DWORD dwFlags);
void __RPC_STUB IPStore_DeleteSubtype_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IPStore_ReadAccessRuleset_Proxy(IPStore *This, PST_KEY Key,
                                               const GUID *pType,
                                               const GUID *pSubtype,
                                               PPST_ACCESSRULESET *ppRules,
                                               DWORD dwFlags);
void __RPC_STUB IPStore_ReadAccessRuleset_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IPStore_WriteAccessRuleset_Proxy(IPStore *This, PST_KEY Key,
                                                const GUID *pType,
                                                const GUID *pSubtype,
                                                PPST_ACCESSRULESET pRules,
                                                DWORD dwFlags);
void __RPC_STUB IPStore_WriteAccessRuleset_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IPStore_EnumTypes_Proxy(IPStore *This, PST_KEY Key,
                                       DWORD dwFlags,
                                       IEnumPStoreTypes **ppenum);
void __RPC_STUB IPStore_EnumTypes_Stub(IRpcStubBuffer *This,
                                       IRpcChannelBuffer *_pRpcChannelBuffer,
                                       PRPC_MESSAGE _pRpcMessage,
                                       DWORD *_pdwStubPhase);
HRESULT WINAPI IPStore_EnumSubtypes_Proxy(IPStore *This, PST_KEY Key,
                                          const GUID *pType, DWORD dwFlags,
                                          IEnumPStoreTypes **ppenum);
void __RPC_STUB IPStore_EnumSubtypes_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI IPStore_DeleteItem_Proxy(
    IPStore *This, PST_KEY Key, const GUID *pItemType, const GUID *pItemSubtype,
    LPCWSTR szItemName, PPST_PROMPTINFO pPromptInfo, DWORD dwFlags);
void __RPC_STUB IPStore_DeleteItem_Stub(IRpcStubBuffer *This,
                                        IRpcChannelBuffer *_pRpcChannelBuffer,
                                        PRPC_MESSAGE _pRpcMessage,
                                        DWORD *_pdwStubPhase);
HRESULT WINAPI IPStore_ReadItem_Proxy(
    IPStore *This, PST_KEY Key, const GUID *pItemType, const GUID *pItemSubtype,
    LPCWSTR szItemName, DWORD *pcbData, BYTE **ppbData,
    PPST_PROMPTINFO pPromptInfo, DWORD dwFlags);
void __RPC_STUB IPStore_ReadItem_Stub(IRpcStubBuffer *This,
                                      IRpcChannelBuffer *_pRpcChannelBuffer,
                                      PRPC_MESSAGE _pRpcMessage,
                                      DWORD *_pdwStubPhase);
HRESULT WINAPI IPStore_WriteItem_Proxy(
    IPStore *This, PST_KEY Key, const GUID *pItemType, const GUID *pItemSubtype,
    LPCWSTR szItemName, DWORD cbData, BYTE *pbData, PPST_PROMPTINFO pPromptInfo,
    DWORD dwDefaultConfirmationStyle, DWORD dwFlags);
void __RPC_STUB IPStore_WriteItem_Stub(IRpcStubBuffer *This,
                                       IRpcChannelBuffer *_pRpcChannelBuffer,
                                       PRPC_MESSAGE _pRpcMessage,
                                       DWORD *_pdwStubPhase);
HRESULT WINAPI IPStore_OpenItem_Proxy(
    IPStore *This, PST_KEY Key, const GUID *pItemType, const GUID *pItemSubtype,
    LPCWSTR szItemName, PST_ACCESSMODE ModeFlags, PPST_PROMPTINFO pPromptInfo,
    DWORD dwFlags);
void __RPC_STUB IPStore_OpenItem_Stub(IRpcStubBuffer *This,
                                      IRpcChannelBuffer *_pRpcChannelBuffer,
                                      PRPC_MESSAGE _pRpcMessage,
                                      DWORD *_pdwStubPhase);
HRESULT WINAPI IPStore_CloseItem_Proxy(IPStore *This, PST_KEY Key,
                                       const GUID *pItemType,
                                       const GUID *pItemSubtype,
                                       LPCWSTR szItemName, DWORD dwFlags);
void __RPC_STUB IPStore_CloseItem_Stub(IRpcStubBuffer *This,
                                       IRpcChannelBuffer *_pRpcChannelBuffer,
                                       PRPC_MESSAGE _pRpcMessage,
                                       DWORD *_pdwStubPhase);
HRESULT WINAPI IPStore_EnumItems_Proxy(IPStore *This, PST_KEY Key,
                                       const GUID *pItemType,
                                       const GUID *pItemSubtype, DWORD dwFlags,
                                       IEnumPStoreItems **ppenum);
void __RPC_STUB IPStore_EnumItems_Stub(IRpcStubBuffer *This,
                                       IRpcChannelBuffer *_pRpcChannelBuffer,
                                       PRPC_MESSAGE _pRpcMessage,
                                       DWORD *_pdwStubPhase);
#endif
...
public:
  virtual HRESULT WINAPI Next(DWORD celt, PST_PROVIDERINFO **rgelt,
                              DWORD *pceltFetched) = 0;
  virtual HRESULT WINAPI Skip(DWORD celt) = 0;
  virtual HRESULT WINAPI Reset(void) = 0;
...
typedef struct IEnumPStoreProvidersVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IEnumPStoreProviders *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IEnumPStoreProviders *This);
  ULONG(WINAPI *Release)(IEnumPStoreProviders *This);
  HRESULT(WINAPI *Next)(IEnumPStoreProviders *This, DWORD celt,
                        PST_PROVIDERINFO **rgelt, DWORD *pceltFetched);
  HRESULT(WINAPI *Skip)(IEnumPStoreProviders *This, DWORD celt);
  HRESULT(WINAPI *Reset)(IEnumPStoreProviders *This);
  HRESULT(WINAPI *Clone)(IEnumPStoreProviders *This,
...
#endif
#endif
HRESULT WINAPI IEnumPStoreProviders_Next_Proxy(IEnumPStoreProviders *This,
                                               DWORD celt,
                                               PST_PROVIDERINFO **rgelt,
                                               DWORD *pceltFetched);
void __RPC_STUB IEnumPStoreProviders_Next_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumPStoreProviders_Skip_Proxy(IEnumPStoreProviders *This,
                                               DWORD celt);
...
void __RPC_STUB IEnumPStoreProviders_Reset_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumPStoreProviders_Clone_Proxy(IEnumPStoreProviders *This,
                                                IEnumPStoreProviders **ppenum);
...
HRESULT WINAPI PStoreEnumProviders(DWORD dwFlags,
                                   IEnumPStoreProviders **ppenum);
