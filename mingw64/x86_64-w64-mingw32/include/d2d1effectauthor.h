...
#include <d2d1_1.h>
typedef HRESULT(CALLBACK *PD2D1_PROPERTY_SET_FUNCTION)(IUnknown *, const BYTE *,
                                                       UINT32);
typedef HRESULT(CALLBACK *PD2D1_PROPERTY_GET_FUNCTION)(const IUnknown *, BYTE *,
                                                       UINT32 dataSize,
                                                       UINT32 *);
...
#endif
DEFINE_GUID(IID_ID2D1VertexBuffer, 0x9b8b1336, 0x00a5, 0x4668, 0x92, 0xb7, 0xce,
            0xd5, 0xd8, 0xbf, 0x9b, 0x7b);
__CRT_UUID_DECL(ID2D1VertexBuffer, 0x9b8b1336, 0x00a5, 0x4668, 0x92, 0xb7, 0xce,
                0xd5, 0xd8, 0xbf, 0x9b, 0x7b);
#ifndef D2D_USE_C_DEFINITIONS
interface ID2D1ResourceTexture : public IUnknown {
  STDMETHOD(Update)(CONST UINT32 * minimumExtents,
                    CONST UINT32 * maximimumExtents, CONST UINT32 * strides,
                    UINT32 dimensions, CONST BYTE * data, UINT32 dataCount)
      PURE;
};
#else
...
/* FIXME: Add full C declaration */
#endif
DEFINE_GUID(IID_ID2D1ResourceTexture, 0x688d15c3, 0x02b0, 0x438d, 0xb1, 0x3a,
            0xd1, 0xb4, 0x4c, 0x32, 0xc3, 0x9a);
__CRT_UUID_DECL(ID2D1ResourceTexture, 0x688d15c3, 0x02b0, 0x438d, 0xb1, 0x3a,
                0xd1, 0xb4, 0x4c, 0x32, 0xc3, 0x9a);
#ifndef D2D_USE_C_DEFINITIONS
interface ID2D1RenderInfo : public IUnknown {
  STDMETHOD(SetInputDescription)(UINT32 inputIndex,
                                 D2D1_INPUT_DESCRIPTION inputDescription) PURE;
  STDMETHOD(SetOutputBuffer)(D2D1_BUFFER_PRECISION bufferPrecision,
                             D2D1_CHANNEL_DEPTH channelDepth) PURE;
...
/* FIXME: Add full C declaration */
#endif
DEFINE_GUID(IID_ID2D1RenderInfo, 0x519ae1bd, 0xd19a, 0x420d, 0xb8, 0x49, 0x36,
            0x4f, 0x59, 0x47, 0x76, 0xb7);
__CRT_UUID_DECL(ID2D1RenderInfo, 0x519ae1bd, 0xd19a, 0x420d, 0xb8, 0x49, 0x36,
                0x4f, 0x59, 0x47, 0x76, 0xb7);
#ifndef D2D_USE_C_DEFINITIONS
interface ID2D1DrawInfo : public ID2D1RenderInfo {
  STDMETHOD(SetPixelShaderConstantBuffer)(CONST BYTE * buffer,
                                          UINT32 bufferCount) PURE;
  STDMETHOD(SetResourceTexture)(UINT32 textureIndex,
                                ID2D1ResourceTexture * resourceTexture) PURE;
  STDMETHOD(SetVertexShaderConstantBuffer)(CONST BYTE * buffer,
                                           UINT32 bufferCount) PURE;
  STDMETHOD(SetPixelShader)(REFGUID shaderId, D2D1_PIXEL_OPTIONS pixelOptions =
                                                  D2D1_PIXEL_OPTIONS_NONE) PURE;
  STDMETHOD(SetVertexProcessing)(
      ID2D1VertexBuffer * vertexBuffer, D2D1_VERTEX_OPTIONS vertexOptions,
...
/* FIXME: Add full C declaration */
#endif
DEFINE_GUID(IID_ID2D1DrawInfo, 0x693ce632, 0x7f2f, 0x45de, 0x93, 0xfe, 0x18,
            0xd8, 0x8b, 0x37, 0xaa, 0x21);
__CRT_UUID_DECL(ID2D1DrawInfo, 0x693ce632, 0x7f2f, 0x45de, 0x93, 0xfe, 0x18,
                0xd8, 0x8b, 0x37, 0xaa, 0x21);
#ifndef D2D_USE_C_DEFINITIONS
...
/* FIXME: Add full C declaration */
#endif
DEFINE_GUID(IID_ID2D1TransformNode, 0xb2efe1e7, 0x729f, 0x4102, 0x94, 0x9f,
            0x50, 0x5f, 0xa2, 0x1b, 0xf6, 0x66);
__CRT_UUID_DECL(ID2D1TransformNode, 0xb2efe1e7, 0x729f, 0x4102, 0x94, 0x9f,
                0x50, 0x5f, 0xa2, 0x1b, 0xf6, 0x66);
#ifndef D2D_USE_C_DEFINITIONS
interface ID2D1Transform : public ID2D1TransformNode {
  STDMETHOD(MapOutputRectToInputRects)(CONST D2D1_RECT_L * outputRect,
  ...
  STDMETHOD(MapInputRectsToOutputRect)(
      ...
      D2D1_RECT_L * outputOpaqueSubRect) PURE;
  STDMETHOD(MapInvalidRect)(UINT32 inputIndex, D2D1_RECT_L invalidInputRect,
                            D2D1_RECT_L * invalidOutputRect) CONST PURE;
};
#else
typedef interface ID2D1Transform ID2D1Transform;
/* FIXME: Add full C declaration */
#endif
DEFINE_GUID(IID_ID2D1Transform, 0xef1a287d, 0x342a, 0x4f76, 0x8f, 0xdb, 0xda,
            0x0d, 0x6e, 0xa9, 0xf9, 0x2b);
__CRT_UUID_DECL(ID2D1Transform, 0xef1a287d, 0x342a, 0x4f76, 0x8f, 0xdb, 0xda,
                0x0d, 0x6e, 0xa9, 0xf9, 0x2b);
#ifndef D2D_USE_C_DEFINITIONS
...
/* FIXME: Add full C declaration */
#endif
DEFINE_GUID(IID_ID2D1DrawTransform, 0x36bfdcb6, 0x9739, 0x435d, 0xa3, 0x0d,
            0xa6, 0x53, 0xbe, 0xff, 0x6a, 0x6f);
__CRT_UUID_DECL(ID2D1DrawTransform, 0x36bfdcb6, 0x9739, 0x435d, 0xa3, 0x0d,
                0xa6, 0x53, 0xbe, 0xff, 0x6a, 0x6f);
#ifndef D2D_USE_C_DEFINITIONS
interface ID2D1TransformGraph : public IUnknown {
  ...
  STDMETHOD(ConnectNode)(ID2D1TransformNode * fromNode,
                         ID2D1TransformNode * toNode, UINT32 toNodeInputIndex)
      PURE;
  STDMETHOD(ConnectToEffectInput)(UINT32 toEffectInputIndex,
                                  ID2D1TransformNode * node,
                                  UINT32 toNodeInputIndex) PURE;
...
/* FIXME: Add full C declaration */
#endif
DEFINE_GUID(IID_ID2D1TransformGraph, 0x13d29038, 0xc3e6, 0x4034, 0x90, 0x81,
            0x13, 0xb5, 0x3a, 0x41, 0x79, 0x92);
__CRT_UUID_DECL(ID2D1TransformGraph, 0x13d29038, 0xc3e6, 0x4034, 0x90, 0x81,
                0x13, 0xb5, 0x3a, 0x41, 0x79, 0x92);
#ifndef D2D_USE_C_DEFINITIONS
...
/* FIXME: Add full C declaration */
#endif
DEFINE_GUID(IID_ID2D1ConcreteTransform, 0x1a799d8a, 0x69f7, 0x4e4c, 0x9f, 0xed,
            0x43, 0x7c, 0xcc, 0x66, 0x84, 0xcc);
__CRT_UUID_DECL(ID2D1ConcreteTransform, 0x1a799d8a, 0x69f7, 0x4e4c, 0x9f, 0xed,
                0x43, 0x7c, 0xcc, 0x66, 0x84, 0xcc);
#ifndef D2D_USE_C_DEFINITIONS
interface ID2D1BlendTransform : public ID2D1ConcreteTransform {
  STDMETHOD_(void, SetDescription)(CONST D2D1_BLEND_DESCRIPTION * description)
      PURE;
  STDMETHOD_(void, GetDescription)(D2D1_BLEND_DESCRIPTION * description)
      CONST PURE;
};
#else
...
/* FIXME: Add full C declaration */
#endif
DEFINE_GUID(IID_ID2D1BlendTransform, 0x63ac0b32, 0xba44, 0x450f, 0x88, 0x06,
            0x7f, 0x4c, 0xa1, 0xff, 0x2f, 0x1b);
__CRT_UUID_DECL(ID2D1BlendTransform, 0x63ac0b32, 0xba44, 0x450f, 0x88, 0x06,
                0x7f, 0x4c, 0xa1, 0xff, 0x2f, 0x1b);
#ifndef D2D_USE_C_DEFINITIONS
...
/* FIXME: Add full C declaration */
#endif
DEFINE_GUID(IID_ID2D1BorderTransform, 0x4998735c, 0x3a19, 0x473c, 0x97, 0x81,
            0x65, 0x68, 0x47, 0xe3, 0xa3, 0x47);
__CRT_UUID_DECL(ID2D1BorderTransform, 0x4998735c, 0x3a19, 0x473c, 0x97, 0x81,
                0x65, 0x68, 0x47, 0xe3, 0xa3, 0x47);
#ifndef D2D_USE_C_DEFINITIONS
...
/* FIXME: Add full C declaration */
#endif
DEFINE_GUID(IID_ID2D1OffsetTransform, 0x3fe6adea, 0x7643, 0x4f53, 0xbd, 0x14,
            0xa0, 0xce, 0x63, 0xf2, 0x40, 0x42);
__CRT_UUID_DECL(ID2D1OffsetTransform, 0x3fe6adea, 0x7643, 0x4f53, 0xbd, 0x14,
                0xa0, 0xce, 0x63, 0xf2, 0x40, 0x42);
#ifndef D2D_USE_C_DEFINITIONS
...
/* FIXME: Add full C declaration */
#endif
DEFINE_GUID(IID_ID2D1BoundsAdjustmentTransform, 0x90f732e2, 0x5092, 0x4606,
            0xa8, 0x19, 0x86, 0x51, 0x97, 0x0b, 0xac, 0xcd);
__CRT_UUID_DECL(ID2D1BoundsAdjustmentTransform, 0x90f732e2, 0x5092, 0x4606,
                0xa8, 0x19, 0x86, 0x51, 0x97, 0x0b, 0xac, 0xcd);
#ifndef D2D_USE_C_DEFINITIONS
interface ID2D1EffectContext : public IUnknown {
  ...
  STDMETHOD(GetMaximumSupportedFeatureLevel)(
      CONST D3D_FEATURE_LEVEL * featureLevels, UINT32 featureLevelsCount,
      D3D_FEATURE_LEVEL * maximumSupportedFeatureLevel) CONST PURE;
  STDMETHOD(CreateTransformNodeFromEffect)(
      ID2D1Effect * effect, ID2D1TransformNode * *transformNode) PURE;
  STDMETHOD(CreateBlendTransform)(
      UINT32 numInputs, CONST D2D1_BLEND_DESCRIPTION * blendDescription,
      ID2D1BlendTransform * *transform) PURE;
  STDMETHOD(CreateBorderTransform)(D2D1_EXTEND_MODE extendModeX,
                                   D2D1_EXTEND_MODE extendModeY,
                                   ID2D1BorderTransform * *transform) PURE;
  STDMETHOD(CreateOffsetTransform)(D2D1_POINT_2L offset,
                                   ID2D1OffsetTransform * *transform) PURE;
  STDMETHOD(CreateBoundsAdjustmentTransform)(
      CONST D2D1_RECT_L * outputRectangle,
      ID2D1BoundsAdjustmentTransform * *transform) PURE;
  STDMETHOD(LoadPixelShader)(REFGUID shaderId, CONST BYTE * shaderBuffer,
                             UINT32 shaderBufferCount) PURE;
  STDMETHOD(LoadVertexShader)(REFGUID resourceId, CONST BYTE * shaderBuffer,
                              UINT32 shaderBufferCount) PURE;
  STDMETHOD(LoadComputeShader)(REFGUID resourceId, CONST BYTE * shaderBuffer,
                               UINT32 shaderBufferCount) PURE;
  ...
  STDMETHOD(CreateResourceTexture)(
      ...
      CONST BYTE * data, CONST UINT32 * strides, UINT32 dataSize,
      ID2D1ResourceTexture * *resourceTexture) PURE;
  STDMETHOD(FindResourceTexture)(CONST GUID * resourceId,
                                 ID2D1ResourceTexture * *resourceTexture) PURE;
  STDMETHOD(CreateVertexBuffer)(
      ...
      ID2D1VertexBuffer * *buffer) PURE;
  STDMETHOD(FindVertexBuffer)(CONST GUID * resourceId,
                              ID2D1VertexBuffer * *buffer) PURE;
  ...
  STDMETHOD(CreateColorContextFromWicColorContext)(
      ...
      PURE;
  STDMETHOD(CheckFeatureSupport)(D2D1_FEATURE feature, void *featureSupportData,
                                 UINT32 featureSupportDataSize) CONST PURE;
...
/* FIXME: Add full C declaration */
#endif
DEFINE_GUID(IID_ID2D1EffectContext, 0x3d9f916b, 0x27dc, 0x4ad7, 0xb4, 0xf1,
            0x64, 0x94, 0x53, 0x40, 0xf5, 0x63);
__CRT_UUID_DECL(ID2D1EffectContext, 0x3d9f916b, 0x27dc, 0x4ad7, 0xb4, 0xf1,
                0x64, 0x94, 0x53, 0x40, 0xf5, 0x63);
#ifndef D2D_USE_C_DEFINITIONS
interface ID2D1EffectImpl : public IUnknown {
  STDMETHOD(Initialize)(ID2D1EffectContext * effectContext,
                        ID2D1TransformGraph * transformGraph) PURE;
...
typedef struct ID2D1EffectImplVtbl {
  IUnknownVtbl Base;
  STDMETHOD(Initialize)(ID2D1EffectImpl *, ID2D1EffectContext *,
                        ID2D1TransformGraph *) PURE;
...
#endif
DEFINE_GUID(IID_ID2D1EffectImpl, 0xa248fd3f, 0x3e6c, 0x4e63, 0x9f, 0x03, 0x7f,
            0x68, 0xec, 0xc9, 0x1d, 0xb9);
__CRT_UUID_DECL(ID2D1EffectImpl, 0xa248fd3f, 0x3e6c, 0x4e63, 0x9f, 0x03, 0x7f,
                0x68, 0xec, 0xc9, 0x1d, 0xb9);
