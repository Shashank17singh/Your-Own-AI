...
WINBOOL WINAPI GetUrlCacheConfigInfoA(LPINTERNET_CACHE_CONFIG_INFOA, LPDWORD,
                                      DWORD);
WINBOOL WINAPI GetUrlCacheConfigInfoW(LPINTERNET_CACHE_CONFIG_INFOW, LPDWORD,
                                      DWORD);
...
DWORD WINAPI ParseX509EncodedCertificateForListBoxEntry(LPBYTE, DWORD, LPSTR,
                                                        LPDWORD);
...
WINBOOL WINAPI InternetGetSecurityInfoByURLA(LPSTR, PCCERT_CHAIN_CONTEXT *,
                                             DWORD *);
WINBOOL WINAPI InternetGetSecurityInfoByURLW(LPCWSTR, PCCERT_CHAIN_CONTEXT *,
                                             DWORD *);
#define InternetGetSecurityInfoByURL                                           \
  __MINGW_NAME_AW(InternetGetSecurityInfoByURL)
#ifdef __cplusplus
}
#endif
