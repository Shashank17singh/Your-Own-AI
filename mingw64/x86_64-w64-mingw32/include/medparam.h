...
DEFINE_GUID(IID_IMediaParams, 0x6d6cbb61, 0xa223, 0x44aa, 0x84, 0x2f, 0xa2,
            0xf0, 0x67, 0x50, 0xbe, 0x6e);
...
IMediaParams : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE AddEnvelope(
      DWORD dwParamIndex, DWORD cPoints, MP_ENVELOPE_SEGMENT * pEnvelope) = 0;
  virtual HRESULT STDMETHODCALLTYPE FlushEnvelope(
      DWORD dwParamIndex, REFERENCE_TIME refTimeStart,
      REFERENCE_TIME refTimeEnd) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetParam(DWORD dwParamIndex,
                                             MP_DATA * pValue) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetParam(DWORD dwParamIndex,
                                             MP_DATA value) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetTimeFormat(GUID guidTimeFormat,
                                                  MP_TIMEDATA mpTimeData) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IMediaParams, 0x6d6cbb61, 0xa223, 0x44aa, 0x84, 0x2f, 0xa2,
                0xf0, 0x67, 0x50, 0xbe, 0x6e)
#endif
#else
typedef struct IMediaParamsVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IMediaParams *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *AddEnvelope)(IMediaParams *This,
                                          DWORD dwParamIndex, DWORD cPoints,
                                          MP_ENVELOPE_SEGMENT *pEnvelope);
  HRESULT(STDMETHODCALLTYPE *FlushEnvelope)(IMediaParams *This,
                                            DWORD dwParamIndex,
                                            REFERENCE_TIME refTimeStart,
                                            REFERENCE_TIME refTimeEnd);
  HRESULT(STDMETHODCALLTYPE *GetParam)(IMediaParams *This, DWORD dwParamIndex,
                                       MP_DATA *pValue);
  HRESULT(STDMETHODCALLTYPE *SetParam)(IMediaParams *This, DWORD dwParamIndex,
                                       MP_DATA value);
...
interface IMediaParams { CONST_VTBL IMediaParamsVtbl *lpVtbl; };
#ifdef COBJMACROS
...
/*** IMediaParams methods ***/
#define IMediaParams_AddEnvelope(This, dwParamIndex, cPoints, pEnvelope)       \
  (This)->lpVtbl->AddEnvelope(This, dwParamIndex, cPoints, pEnvelope)
...
IMediaParams_QueryInterface(IMediaParams *This, REFIID riid, void **ppvObject) {
...
/*** IMediaParams methods ***/
static inline HRESULT IMediaParams_AddEnvelope(IMediaParams *This,
                                               DWORD dwParamIndex,
                                               DWORD cPoints,
                                               MP_ENVELOPE_SEGMENT *pEnvelope) {
  return This->lpVtbl->AddEnvelope(This, dwParamIndex, cPoints, pEnvelope);
}
static inline HRESULT IMediaParams_FlushEnvelope(IMediaParams *This,
                                                 DWORD dwParamIndex,
                                                 REFERENCE_TIME refTimeStart,
                                                 REFERENCE_TIME refTimeEnd) {
  return This->lpVtbl->FlushEnvelope(This, dwParamIndex, refTimeStart,
                                     refTimeEnd);
}
static inline HRESULT
IMediaParams_GetParam(IMediaParams *This, DWORD dwParamIndex, MP_DATA *pValue) {
  return This->lpVtbl->GetParam(This, dwParamIndex, pValue);
}
static inline HRESULT IMediaParams_SetParam(IMediaParams *This,
                                            DWORD dwParamIndex, MP_DATA value) {
  return This->lpVtbl->SetParam(This, dwParamIndex, value);
}
static inline HRESULT IMediaParams_SetTimeFormat(IMediaParams *This,
                                                 GUID guidTimeFormat,
                                                 MP_TIMEDATA mpTimeData) {
...
DEFINE_GUID(IID_IMediaParamInfo, 0x6d6cbb60, 0xa223, 0x44aa, 0x84, 0x2f, 0xa2,
            0xf0, 0x67, 0x50, 0xbe, 0x6d);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("6d6cbb60-a223-44aa-842f-a2f06750be6d")
IMediaParamInfo : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetParamCount(DWORD * pdwParams) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetParamInfo(DWORD dwParamIndex,
                                                 MP_PARAMINFO * pInfo) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetParamText(DWORD dwParamIndex,
                                                 WCHAR * *ppwchText) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetNumTimeFormats(DWORD *
                                                      pdwNumTimeFormats) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetSupportedTimeFormat(
      DWORD dwFormatIndex, GUID * pguidTimeFormat) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetCurrentTimeFormat(
      GUID * pguidTimeFormat, MP_TIMEDATA * pTimeData) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IMediaParamInfo, 0x6d6cbb60, 0xa223, 0x44aa, 0x84, 0x2f, 0xa2,
                0xf0, 0x67, 0x50, 0xbe, 0x6d)
#endif
#else
typedef struct IMediaParamInfoVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IMediaParamInfo *This, REFIID riid,
                                             void **ppvObject);
...
interface IMediaParamInfo { CONST_VTBL IMediaParamInfoVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMediaParamInfo_QueryInterface(IMediaParamInfo *This,
                                                     REFIID riid,
                                                     void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IMediaParamInfo methods ***/
static inline HRESULT IMediaParamInfo_GetParamCount(IMediaParamInfo *This,
                                                    DWORD *pdwParams) {
  return This->lpVtbl->GetParamCount(This, pdwParams);
}
static inline HRESULT IMediaParamInfo_GetParamInfo(IMediaParamInfo *This,
                                                   DWORD dwParamIndex,
                                                   MP_PARAMINFO *pInfo) {
  return This->lpVtbl->GetParamInfo(This, dwParamIndex, pInfo);
}
static inline HRESULT IMediaParamInfo_GetParamText(IMediaParamInfo *This,
                                                   DWORD dwParamIndex,
                                                   WCHAR **ppwchText) {
  return This->lpVtbl->GetParamText(This, dwParamIndex, ppwchText);
}
static inline HRESULT
IMediaParamInfo_GetNumTimeFormats(IMediaParamInfo *This,
                                  DWORD *pdwNumTimeFormats) {
  return This->lpVtbl->GetNumTimeFormats(This, pdwNumTimeFormats);
}
static inline HRESULT IMediaParamInfo_GetSupportedTimeFormat(
    IMediaParamInfo *This, DWORD dwFormatIndex, GUID *pguidTimeFormat) {
  return This->lpVtbl->GetSupportedTimeFormat(This, dwFormatIndex,
                                              pguidTimeFormat);
}
static inline HRESULT IMediaParamInfo_GetCurrentTimeFormat(
    IMediaParamInfo *This, GUID *pguidTimeFormat, MP_TIMEDATA *pTimeData) {
