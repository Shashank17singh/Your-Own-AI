...
#define STATIC_KSDATAFORMAT_SUBTYPE_WAVEFORMATEX                               \
  __MSABI_LONG(0x00000000), 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00,      \
      0x38, 0x9b, 0x71
...
typedef struct dvi_adpcmwaveformat_tag {
  WAVEFORMATEX wfx;
  WORD wSamplesPerBlock;
} DVIADPCMWAVEFORMAT, *PDVIADPCMWAVEFORMAT, *NPDVIADPCMWAVEFORMAT,
...
typedef struct ima_adpcmwaveformat_tag {
  WAVEFORMATEX wfx;
  WORD wSamplesPerBlock;
} IMAADPCMWAVEFORMAT, *PIMAADPCMWAVEFORMAT, *NPIMAADPCMWAVEFORMAT,
...
typedef struct sierra_adpcmwaveformat_tag {
  WAVEFORMATEX wfx;
  WORD wRevision;
} SIERRAADPCMWAVEFORMAT, *PSIERRAADPCMWAVEFORMAT, *NPSIERRAADPCMWAVEFORMAT,
    *LPSIERRAADPCMWAVEFORMAT;
typedef struct g723_adpcmwaveformat_tag {
  WAVEFORMATEX wfx;
  WORD cbExtraSize;
  WORD nAuxBlockSize;
} G723_ADPCMWAVEFORMAT, *PG723_ADPCMWAVEFORMAT, *NPG723_ADPCMWAVEFORMAT,
    *LPG723_ADPCMWAVEFORMAT;
typedef struct digistdwaveformat_tag {
  WAVEFORMATEX wfx;
} DIGISTDWAVEFORMAT, *PDIGISTDWAVEFORMAT, *NPDIGISTDWAVEFORMAT,
    *LPDIGISTDWAVEFORMAT;
typedef struct digifixwaveformat_tag {
  WAVEFORMATEX wfx;
} DIGIFIXWAVEFORMAT, *PDIGIFIXWAVEFORMAT, *NPDIGIFIXWAVEFORMAT,
    *LPDIGIFIXWAVEFORMAT;
...
typedef struct yamaha_adpmcwaveformat_tag {
  WAVEFORMATEX wfx;
} YAMAHA_ADPCMWAVEFORMAT, *PYAMAHA_ADPCMWAVEFORMAT, *NPYAMAHA_ADPCMWAVEFORMAT,
    *LPYAMAHA_ADPCMWAVEFORMAT;
typedef struct sonarcwaveformat_tag {
  WAVEFORMATEX wfx;
  WORD wCompType;
} SONARCWAVEFORMAT, *PSONARCWAVEFORMAT, *NPSONARCWAVEFORMAT,
    *LPSONARCWAVEFORMAT;
...
typedef struct echosc1waveformat_tag {
  WAVEFORMATEX wfx;
} ECHOSC1WAVEFORMAT, *PECHOSC1WAVEFORMAT, *NPECHOSC1WAVEFORMAT,
    *LPECHOSC1WAVEFORMAT;
...
typedef struct gsm610waveformat_tag {
  WAVEFORMATEX wfx;
  WORD wSamplesPerBlock;
} GSM610WAVEFORMAT, *PGSM610WAVEFORMAT, *NPGSM610WAVEFORMAT,
    *LPGSM610WAVEFORMAT;
#endif
#if WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_DESKTOP)
typedef struct adpcmewaveformat_tag {
  WAVEFORMATEX wfx;
  WORD wSamplesPerBlock;
} ADPCMEWAVEFORMAT, *PADPCMEWAVEFORMAT, *NPADPCMEWAVEFORMAT,
    *LPADPCMEWAVEFORMAT;
typedef struct contres_vqlpcwaveformat_tag {
  WAVEFORMATEX wfx;
  WORD wSamplesPerBlock;
} CONTRESVQLPCWAVEFORMAT, *PCONTRESVQLPCWAVEFORMAT, *NPCONTRESVQLPCWAVEFORMAT,
    *LPCONTRESVQLPCWAVEFORMAT;
typedef struct digirealwaveformat_tag {
  WAVEFORMATEX wfx;
  WORD wSamplesPerBlock;
} DIGIREALWAVEFORMAT, *PDIGIREALWAVEFORMAT, *NPDIGIREALWAVEFORMAT,
    *LPDIGIREALWAVEFORMAT;
typedef struct digiadpcmmwaveformat_tag {
  WAVEFORMATEX wfx;
  WORD wSamplesPerBlock;
} DIGIADPCMWAVEFORMAT, *PDIGIADPCMWAVEFORMAT, *NPDIGIADPCMWAVEFORMAT,
    *LPDIGIADPCMWAVEFORMAT;
typedef struct contres_cr10waveformat_tag {
  WAVEFORMATEX wfx;
  WORD wSamplesPerBlock;
} CONTRESCR10WAVEFORMAT, *PCONTRESCR10WAVEFORMAT, *NPCONTRESCR10WAVEFORMAT,
    *LPCONTRESCR10WAVEFORMAT;
typedef struct nms_vbxadpcmmwaveformat_tag {
  WAVEFORMATEX wfx;
  WORD wSamplesPerBlock;
} NMS_VBXADPCMWAVEFORMAT, *PNMS_VBXADPCMWAVEFORMAT, *NPNMS_VBXADPCMWAVEFORMAT,
...
typedef struct mpeglayer3waveformat_tag {
  ...
  WORD nCodecDelay;
} MPEGLAYER3WAVEFORMAT, *PMPEGLAYER3WAVEFORMAT, *NPMPEGLAYER3WAVEFORMAT,
...
#define MSAUDIO1_WFX_EXTRA_BYTES                                               \
...
#define WMAUDIO2_WFX_EXTRA_BYTES                                               \
  (sizeof(WMAUDIO2WAVEFORMAT) - sizeof(WAVEFORMATEX))
...
#define WMAUDIO3_WFX_EXTRA_BYTES                                               \
  (sizeof(WMAUDIO3WAVEFORMAT) - sizeof(WAVEFORMATEX))
#endif
#if WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_DESKTOP)
...
typedef struct fmtowns_snd_waveformat_tag {
  WAVEFORMATEX wfx;
  WORD wRevision;
} FMTOWNS_SND_WAVEFORMAT, *PFMTOWNS_SND_WAVEFORMAT, *NPFMTOWNS_SND_WAVEFORMAT,
    *LPFMTOWNS_SND_WAVEFORMAT;
typedef struct oligsmwaveformat_tag {
  WAVEFORMATEX wfx;
} OLIGSMWAVEFORMAT, *POLIGSMWAVEFORMAT, *NPOLIGSMWAVEFORMAT,
    *LPOLIGSMWAVEFORMAT;
typedef struct oliadpcmwaveformat_tag {
  WAVEFORMATEX wfx;
} OLIADPCMWAVEFORMAT, *POLIADPCMWAVEFORMAT, *NPOLIADPCMWAVEFORMAT,
    *LPOLIADPCMWAVEFORMAT;
typedef struct olicelpwaveformat_tag {
  WAVEFORMATEX wfx;
} OLICELPWAVEFORMAT, *POLICELPWAVEFORMAT, *NPOLICELPWAVEFORMAT,
    *LPOLICELPWAVEFORMAT;
typedef struct olisbcwaveformat_tag {
  WAVEFORMATEX wfx;
} OLISBCWAVEFORMAT, *POLISBCWAVEFORMAT, *NPOLISBCWAVEFORMAT,
    *LPOLISBCWAVEFORMAT;
typedef struct olioprwaveformat_tag {
  WAVEFORMATEX wfx;
} OLIOPRWAVEFORMAT, *POLIOPRWAVEFORMAT, *NPOLIOPRWAVEFORMAT,
    *LPOLIOPRWAVEFORMAT;
typedef struct csimaadpcmwaveformat_tag {
  WAVEFORMATEX wfx;
} CSIMAADPCMWAVEFORMAT, *PCSIMAADPCMWAVEFORMAT, *NPCSIMAADPCMWAVEFORMAT,
...
typedef struct wavefilter_volume_tag {
  WAVEFILTER wfltr;
  DWORD dwVolume;
} VOLUMEWAVEFILTER, *PVOLUMEWAVEFILTER, *NPVOLUMEWAVEFILTER,
    *LPVOLUMEWAVEFILTER;
#endif
