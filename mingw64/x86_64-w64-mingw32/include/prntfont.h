...
#define GET_UNIDRVINFO(pUFM)                                                   \
  ((PUNIDRVINFO)((ULONG_PTR)(pUFM) + (pUFM)->loUnidrvInfo))
#define GET_IFIMETRICS(pUFM)                                                   \
  ((IFIMETRICS *)((ULONG_PTR)(pUFM) + (pUFM)->loIFIMetrics))
#define GET_EXTTEXTMETRIC(pUFM)                                                \
  ((EXTTEXTMETRIC *)((ULONG_PTR)(pUFM) + (pUFM)->loExtTextMetric))
#define GET_WIDTHTABLE(pUFM)                                                   \
  ((PWIDTHTABLE)((ULONG_PTR)(pUFM) + (pUFM)->loWidthTable))
...
#define GET_CODEPAGEINFO(pGTT)                                                 \
  ((PUNI_CODEPAGEINFO)((ULONG_PTR)(pGTT) +                                     \
                       ((PUNI_GLYPHSETDATA)pGTT)->loCodePageOffset))
