...
typedef struct GdiplusStartupInput {
  ...
  GdiplusStartupInput(DebugEventProc debugEventCallback = NULL,
      ...
      : GdiplusVersion(1), DebugEventCallback(debugEventCallback),
...
#ifdef __cplusplus
  GdiplusStartupOutput() : NotificationHook(NULL), NotificationUnhook(NULL) {}
#endif /* __cplusplus */
} GdiplusStartupOutput;
#ifdef __cplusplus
extern "C" {
#endif
GpStatus WINGDIPAPI GdiplusStartup(ULONG_PTR *, GDIPCONST GdiplusStartupInput *,
                                   GdiplusStartupOutput *);
