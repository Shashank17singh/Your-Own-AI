...
public:
  static UINT
  EmfToWmfBits(HENHMETAFILE hEmf, UINT cbData16, LPBYTE pData16,
  ...
  Metafile(HMETAFILE hWmf, const WmfPlaceableFileHeader *wmfPlaceableFileHeader,
    ...
    lastStatus = DllExports::GdipCreateMetafileFromWmf(
        hWmf, deleteWmf, wmfPlaceableFileHeader, &nativeMetafile);
    nativeImage = nativeMetafile;
  }
  Metafile(HENHMETAFILE hEmf, BOOL deleteEmf = FALSE) : Image(NULL, Ok) {
    GpMetafile *nativeMetafile = NULL;
    lastStatus =
        DllExports::GdipCreateMetafileFromEmf(hEmf, deleteEmf, &nativeMetafile);
    nativeImage = nativeMetafile;
  }
  Metafile(const WCHAR *filename) : Image(NULL, Ok) {
    GpMetafile *nativeMetafile = NULL;
    lastStatus =
        DllExports::GdipCreateMetafileFromFile(filename, &nativeMetafile);
    nativeImage = nativeMetafile;
  }
  Metafile(const WCHAR *filename,
    ...
    lastStatus = DllExports::GdipCreateMetafileFromWmfFile(
        filename, wmfPlaceableFileHeader, &nativeMetafile);
    nativeImage = nativeMetafile;
  }
  Metafile(IStream *stream) : Image(NULL, Ok) {
    GpMetafile *nativeMetafile = NULL;
    lastStatus =
        DllExports::GdipCreateMetafileFromStream(stream, &nativeMetafile);
    nativeImage = nativeMetafile;
  }
  Metafile(HDC referenceHdc, EmfType type = EmfTypeEmfPlusDual,
      ...
      : Image(NULL, Ok) {
    GpMetafile *nativeMetafile = NULL;
    lastStatus = DllExports::GdipRecordMetafile(referenceHdc, type, NULL,
  ...
  Metafile(HDC referenceHdc, const RectF &frameRect,
    ...
    GpMetafile *nativeMetafile = NULL;
    lastStatus =
        DllExports::GdipRecordMetafile(referenceHdc, type, &frameRect,
  ...
  HENHMETAFILE GetHENHMETAFILE() {
    ...
    updateStatus(DllExports::GdipGetHemfFromMetafile((GpMetafile *)nativeImage,
                                                     &result));
    return result;
  }
  ...
  Status PlayRecord(EmfPlusRecordType recordType, UINT flags, UINT dataSize,
