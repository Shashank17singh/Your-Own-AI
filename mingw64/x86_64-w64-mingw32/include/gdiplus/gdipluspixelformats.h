...
#define PixelFormat1bppIndexed                                                 \
  ((INT)(1 | (1 << 8) | PixelFormatIndexed | PixelFormatGDI))
#define PixelFormat4bppIndexed                                                 \
  ((INT)(2 | (4 << 8) | PixelFormatIndexed | PixelFormatGDI))
#define PixelFormat8bppIndexed                                                 \
  ((INT)(3 | (8 << 8) | PixelFormatIndexed | PixelFormatGDI))
...
#define PixelFormat16bppARGB1555                                               \
  ((INT)(7 | (16 << 8) | PixelFormatAlpha | PixelFormatGDI))
...
#define PixelFormat32bppARGB                                                   \
  ((INT)(10 | (32 << 8) | PixelFormatAlpha | PixelFormatGDI |                  \
         PixelFormatCanonical))
#define PixelFormat32bppPARGB                                                  \
  ((INT)(11 | (32 << 8) | PixelFormatAlpha | PixelFormatPAlpha |               \
         PixelFormatGDI))
#define PixelFormat48bppRGB ((INT)(12 | (48 << 8) | PixelFormatExtended))
#define PixelFormat64bppARGB                                                   \
  ((INT)(13 | (64 << 8) | PixelFormatAlpha | PixelFormatCanonical |            \
         PixelFormatExtended))
#define PixelFormat64bppPARGB                                                  \
  ((INT)(14 | (64 << 8) | PixelFormatAlpha | PixelFormatPAlpha |               \
         PixelFormatExtended))
