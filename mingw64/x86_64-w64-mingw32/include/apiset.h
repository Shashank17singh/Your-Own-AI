...
typedef NTSTATUS(NTAPI *PAPI_SET_LOAD_SCHEMA_RTN)(PCSTR,
                                                  PCAPI_SET_NAMESPACE_ARRAY *,
                                                  PVOID *);
typedef NTSTATUS(NTAPI *PAPI_SET_LOOKUP_HELPER_RTN)(PCAPI_SET_NAMESPACE_ARRAY,
                                                    PCSTR, PCSTR, PBOOLEAN,
                                                    PSTR, ULONG);
typedef NTSTATUS(NTAPI *PAPI_SET_RELEASE_SCHEMA_RTN)(PVOID);
NTSTATUS NTAPI ApiSetResolveToHost(PCAPI_SET_NAMESPACE_ARRAY ApiSetSchema,
                                   PCUNICODE_STRING FileNameIn,
                                   PCUNICODE_STRING ParentName,
                                   PBOOLEAN Resolved,
                                   PUNICODE_STRING HostBinary);
#endif
#ifdef __cplusplus
}
#endif
