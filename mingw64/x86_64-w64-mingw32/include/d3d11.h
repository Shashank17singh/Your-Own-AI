...
#define D3D11_COMMONSHADER_CONSTANT_BUFFER_PARTIAL_UPDATE_EXTENTS_BYTE_ALIGNMENT \
  (16)
...
struct CD3D11_QUERY_DESC : public D3D11_QUERY_DESC {
  CD3D11_QUERY_DESC() {}
  ~CD3D11_QUERY_DESC() {}
  explicit CD3D11_QUERY_DESC(const D3D11_QUERY_DESC &other)
...
struct CD3D11_RASTERIZER_DESC : public D3D11_RASTERIZER_DESC {
  ...
  explicit CD3D11_RASTERIZER_DESC(
      ...
      WINBOOL frontCounterClockwise, INT depthBias, FLOAT depthBiasClamp,
      FLOAT slopeScaledDepthBias, BOOL depthClipEnable, WINBOOL scissorEnable,
      WINBOOL multisampleEnable, WINBOOL antialiasedLineEnable) {
    FillMode = fillMode;
    CullMode = cullMode;
...
struct CD3D11_DEPTH_STENCIL_DESC : public D3D11_DEPTH_STENCIL_DESC {
  ...
  explicit CD3D11_DEPTH_STENCIL_DESC(const D3D11_DEPTH_STENCIL_DESC &other)
      : D3D11_DEPTH_STENCIL_DESC(other) {}
  ...
  explicit CD3D11_DEPTH_STENCIL_DESC(
      WINBOOL depth_enable, D3D11_DEPTH_WRITE_MASK depth_write_mask,
      D3D11_COMPARISON_FUNC depth_func, WINBOOL stencil_enable,
      UINT8 stencil_read_mask, UINT8 stencil_write_mask,
...
struct CD3D11_RENDER_TARGET_VIEW_DESC : public D3D11_RENDER_TARGET_VIEW_DESC {
  ...
  explicit CD3D11_RENDER_TARGET_VIEW_DESC(
      D3D11_RTV_DIMENSION dim, DXGI_FORMAT format = DXGI_FORMAT_UNKNOWN,
  ...
  explicit CD3D11_RENDER_TARGET_VIEW_DESC(ID3D11Buffer *, DXGI_FORMAT format,
                                          UINT first_elem, UINT elem_cnt) {
    Format = format;
  ...
  explicit CD3D11_RENDER_TARGET_VIEW_DESC(
      ID3D11Texture1D *texture, D3D11_RTV_DIMENSION dim,
      DXGI_FORMAT format = DXGI_FORMAT_UNKNOWN, UINT mip_slice = 0,
      UINT first_slice = 0, UINT array_size = -1);
  explicit CD3D11_RENDER_TARGET_VIEW_DESC(
      ID3D11Texture2D *texture, D3D11_RTV_DIMENSION dim,
      DXGI_FORMAT format = DXGI_FORMAT_UNKNOWN, UINT mip_slice = 0,
      UINT first_slice = 0, UINT array_size = -1);
  explicit CD3D11_RENDER_TARGET_VIEW_DESC(
      ID3D11Texture3D *texture, DXGI_FORMAT format = DXGI_FORMAT_UNKNOWN,
      UINT mip_slice = 0, UINT first_w_slice = 0, UINT w_slice = -1);
  ~CD3D11_RENDER_TARGET_VIEW_DESC() {}
  explicit CD3D11_RENDER_TARGET_VIEW_DESC(
      const D3D11_RENDER_TARGET_VIEW_DESC &other)
...
struct CD3D11_SAMPLER_DESC : public D3D11_SAMPLER_DESC {
  ...
  explicit CD3D11_SAMPLER_DESC(D3D11_FILTER filter,
                               ...
                               D3D11_COMPARISON_FUNC comparisonFunc,
                               const FLOAT *borderColor, FLOAT minLOD,
                               FLOAT maxLOD) {
    Filter = filter;
    AddressU = addressU;
    AddressV = addressV;
...
struct CD3D11_SHADER_RESOURCE_VIEW_DESC
  ...
  explicit CD3D11_SHADER_RESOURCE_VIEW_DESC(
      D3D11_SRV_DIMENSION dim, DXGI_FORMAT format = DXGI_FORMAT_UNKNOWN,
      UINT most_detailed_mip = 0, UINT mip_levels = -1, UINT first_slice = 0,
      UINT array_size = -1, UINT flags = 0) {
    Format = format;
    ViewDimension = dim;
  ...
  explicit CD3D11_SHADER_RESOURCE_VIEW_DESC(ID3D11Buffer *, DXGI_FORMAT format,
                                            UINT first_elem, UINT elem_cnt,
                                            UINT flags = 0);
  explicit CD3D11_SHADER_RESOURCE_VIEW_DESC(
      ID3D11Texture1D *texture, D3D11_SRV_DIMENSION dim,
      DXGI_FORMAT format = DXGI_FORMAT_UNKNOWN, UINT most_detailed_mip = 0,
      UINT mip_levels = -1, UINT first_slice = 0, UINT array_size = -1);
  explicit CD3D11_SHADER_RESOURCE_VIEW_DESC(
      ID3D11Texture2D *texture, D3D11_SRV_DIMENSION dim,
      DXGI_FORMAT format = DXGI_FORMAT_UNKNOWN, UINT most_detailed_mip = 0,
      UINT mip_levels = -1, UINT first_slice = 0, UINT array_size = -1);
  explicit CD3D11_SHADER_RESOURCE_VIEW_DESC(
      ID3D11Texture3D *texture, DXGI_FORMAT format = DXGI_FORMAT_UNKNOWN,
  ...
  ~CD3D11_SHADER_RESOURCE_VIEW_DESC() {}
  explicit CD3D11_SHADER_RESOURCE_VIEW_DESC(
      const D3D11_SHADER_RESOURCE_VIEW_DESC &other)
...
DEFINE_GUID(D3D11_DECODER_PROFILE_MPEG2_IDCT, 0xbf22ad00, 0x03ea, 0x4690, 0x80,
            0x77, 0x47, 0x33, 0x46, 0x20, 0x9b, 0x7e);
DEFINE_GUID(D3D11_DECODER_PROFILE_MPEG2_VLD, 0xee27417f, 0x5e28, 0x4e65, 0xbe,
            0xea, 0x1d, 0x26, 0xb5, 0x08, 0xad, 0xc9);
DEFINE_GUID(D3D11_DECODER_PROFILE_MPEG1_VLD, 0x6f3ec719, 0x3735, 0x42cc, 0x80,
            0x63, 0x65, 0xcc, 0x3c, 0xb3, 0x66, 0x16);
DEFINE_GUID(D3D11_DECODER_PROFILE_MPEG2and1_VLD, 0x86695f12, 0x340e, 0x4f04,
            0x9f, 0xd3, 0x92, 0x53, 0xdd, 0x32, 0x74, 0x60);
DEFINE_GUID(D3D11_DECODER_PROFILE_H264_MOCOMP_NOFGT, 0x1b81be64, 0xa0c7, 0x11d3,
            0xb9, 0x84, 0x00, 0xc0, 0x4f, 0x2e, 0x73, 0xc5);
DEFINE_GUID(D3D11_DECODER_PROFILE_H264_MOCOMP_FGT, 0x1b81be65, 0xa0c7, 0x11d3,
            0xb9, 0x84, 0x00, 0xc0, 0x4f, 0x2e, 0x73, 0xc5);
DEFINE_GUID(D3D11_DECODER_PROFILE_H264_IDCT_NOFGT, 0x1b81be66, 0xa0c7, 0x11d3,
            0xb9, 0x84, 0x00, 0xc0, 0x4f, 0x2e, 0x73, 0xc5);
DEFINE_GUID(D3D11_DECODER_PROFILE_H264_IDCT_FGT, 0x1b81be67, 0xa0c7, 0x11d3,
            0xb9, 0x84, 0x00, 0xc0, 0x4f, 0x2e, 0x73, 0xc5);
DEFINE_GUID(D3D11_DECODER_PROFILE_H264_VLD_NOFGT, 0x1b81be68, 0xa0c7, 0x11d3,
            0xb9, 0x84, 0x00, 0xc0, 0x4f, 0x2e, 0x73, 0xc5);
DEFINE_GUID(D3D11_DECODER_PROFILE_H264_VLD_FGT, 0x1b81be69, 0xa0c7, 0x11d3,
            0xb9, 0x84, 0x00, 0xc0, 0x4f, 0x2e, 0x73, 0xc5);
...
DEFINE_GUID(D3D11_DECODER_PROFILE_H264_VLD_STEREO_NOFGT, 0xf9aaccbb, 0xc2b6,
            0x4cfc, 0x87, 0x79, 0x57, 0x07, 0xb1, 0x76, 0x05, 0x52);
DEFINE_GUID(D3D11_DECODER_PROFILE_H264_VLD_MULTIVIEW_NOFGT, 0x705b9d82, 0x76cf,
            0x49d6, 0xb7, 0xe6, 0xac, 0x88, 0x72, 0xdb, 0x01, 0x3c);
DEFINE_GUID(D3D11_DECODER_PROFILE_WMV8_POSTPROC, 0x1b81be80, 0xa0c7, 0x11d3,
            0xb9, 0x84, 0x00, 0xc0, 0x4f, 0x2e, 0x73, 0xc5);
DEFINE_GUID(D3D11_DECODER_PROFILE_WMV8_MOCOMP, 0x1b81be81, 0xa0c7, 0x11d3, 0xb9,
            0x84, 0x00, 0xc0, 0x4f, 0x2e, 0x73, 0xc5);
DEFINE_GUID(D3D11_DECODER_PROFILE_WMV9_POSTPROC, 0x1b81be90, 0xa0c7, 0x11d3,
            0xb9, 0x84, 0x00, 0xc0, 0x4f, 0x2e, 0x73, 0xc5);
DEFINE_GUID(D3D11_DECODER_PROFILE_WMV9_MOCOMP, 0x1b81be91, 0xa0c7, 0x11d3, 0xb9,
            0x84, 0x00, 0xc0, 0x4f, 0x2e, 0x73, 0xc5);
DEFINE_GUID(D3D11_DECODER_PROFILE_WMV9_IDCT, 0x1b81be94, 0xa0c7, 0x11d3, 0xb9,
            0x84, 0x00, 0xc0, 0x4f, 0x2e, 0x73, 0xc5);
DEFINE_GUID(D3D11_DECODER_PROFILE_VC1_POSTPROC, 0x1b81beA0, 0xa0c7, 0x11d3,
            0xb9, 0x84, 0x00, 0xc0, 0x4f, 0x2e, 0x73, 0xc5);
DEFINE_GUID(D3D11_DECODER_PROFILE_VC1_MOCOMP, 0x1b81beA1, 0xa0c7, 0x11d3, 0xb9,
            0x84, 0x00, 0xc0, 0x4f, 0x2e, 0x73, 0xc5);
DEFINE_GUID(D3D11_DECODER_PROFILE_VC1_IDCT, 0x1b81beA2, 0xa0c7, 0x11d3, 0xb9,
            0x84, 0x00, 0xc0, 0x4f, 0x2e, 0x73, 0xc5);
DEFINE_GUID(D3D11_DECODER_PROFILE_VC1_VLD, 0x1b81beA3, 0xa0c7, 0x11d3, 0xb9,
            0x84, 0x00, 0xc0, 0x4f, 0x2e, 0x73, 0xc5);
DEFINE_GUID(D3D11_DECODER_PROFILE_VC1_D2010, 0x1b81beA4, 0xa0c7, 0x11d3, 0xb9,
            0x84, 0x00, 0xc0, 0x4f, 0x2e, 0x73, 0xc5);
DEFINE_GUID(D3D11_DECODER_PROFILE_MPEG4PT2_VLD_SIMPLE, 0xefd64d74, 0xc9e8,
            0x41d7, 0xa5, 0xe9, 0xe9, 0xb0, 0xe3, 0x9f, 0xa3, 0x19);
...
DEFINE_GUID(D3D11_DECODER_PROFILE_HEVC_VLD_MAIN, 0x5b11d51b, 0x2f4c, 0x4452,
            0xbc, 0xc3, 0x09, 0xf2, 0xa1, 0x16, 0x0c, 0xc0);
DEFINE_GUID(D3D11_DECODER_PROFILE_HEVC_VLD_MAIN10, 0x107af0e0, 0xef1a, 0x4d19,
...
DEFINE_GUID(D3D11_DECODER_PROFILE_VP9_VLD_10BIT_PROFILE2, 0xa4c749ef, 0x6ecf,
            0x48aa, 0x84, 0x48, 0x50, 0xa7, 0xa1, 0x16, 0x5f, 0xf7);
DEFINE_GUID(D3D11_DECODER_PROFILE_VP8_VLD, 0x90b899ea, 0x3a62, 0x4705, 0x88,
            0xb3, 0x8d, 0xf0, 0x4b, 0x27, 0x44, 0xe7);
...
ID3D11DeviceChild : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE GetPrivateData(
      REFGUID guid, UINT * pDataSize, void *pData) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetPrivateData(REFGUID guid, UINT DataSize,
                                                   const void *pData) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetPrivateDataInterface(
      REFGUID guid, const IUnknown *pData) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D11DeviceChild, 0x1841e5c8, 0x16b0, 0x489b, 0xbc, 0xc8, 0x44,
                0xcf, 0xb0, 0xd5, 0xde, 0xae)
#endif
#else
typedef struct ID3D11DeviceChildVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11DeviceChild *This,
  ...
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(ID3D11DeviceChild *This,
                                             REFGUID guid, UINT *pDataSize,
                                             void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D11DeviceChild *This,
                                             REFGUID guid, UINT DataSize,
                                             const void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateDataInterface)(ID3D11DeviceChild *This,
                                                      REFGUID guid,
                                                      const IUnknown *pData);
  END_INTERFACE
} ID3D11DeviceChildVtbl;
interface ID3D11DeviceChild { CONST_VTBL ID3D11DeviceChildVtbl *lpVtbl; };
#ifdef COBJMACROS
...
#else
/*** IUnknown methods ***/
static inline HRESULT ID3D11DeviceChild_QueryInterface(ID3D11DeviceChild *This,
                                                       REFIID riid,
                                                       void **ppvObject) {
...
/*** ID3D11DeviceChild methods ***/
static inline void ID3D11DeviceChild_GetDevice(ID3D11DeviceChild *This,
                                               ID3D11Device **ppDevice) {
  This->lpVtbl->GetDevice(This, ppDevice);
}
static inline HRESULT ID3D11DeviceChild_GetPrivateData(ID3D11DeviceChild *This,
                                                       REFGUID guid,
                                                       UINT *pDataSize,
                                                       void *pData) {
  return This->lpVtbl->GetPrivateData(This, guid, pDataSize, pData);
}
static inline HRESULT ID3D11DeviceChild_SetPrivateData(ID3D11DeviceChild *This,
                                                       REFGUID guid,
                                                       UINT DataSize,
                                                       const void *pData) {
...
ID3D11DeviceChild_SetPrivateDataInterface(ID3D11DeviceChild *This, REFGUID guid,
                                          const IUnknown *pData) {
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D11Asynchronous, 0x4b35d0cd, 0x1e15, 0x4258, 0x9c, 0x98,
                0x1b, 0x13, 0x33, 0xf6, 0xdd, 0x3b)
#endif
#else
typedef struct ID3D11AsynchronousVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11Asynchronous *This,
                                             REFIID riid, void **ppvObject);
  ...
  void(STDMETHODCALLTYPE *GetDevice)(ID3D11Asynchronous *This,
                                     ID3D11Device **ppDevice);
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(ID3D11Asynchronous *This,
                                             REFGUID guid, UINT *pDataSize,
                                             void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D11Asynchronous *This,
                                             REFGUID guid, UINT DataSize,
                                             const void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateDataInterface)(ID3D11Asynchronous *This,
                                                      REFGUID guid,
                                                      const IUnknown *pData);
...
interface ID3D11Asynchronous { CONST_VTBL ID3D11AsynchronousVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
ID3D11Asynchronous_QueryInterface(ID3D11Asynchronous *This, REFIID riid,
                                  void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ID3D11DeviceChild methods ***/
static inline void ID3D11Asynchronous_GetDevice(ID3D11Asynchronous *This,
                                                ID3D11Device **ppDevice) {
  This->lpVtbl->GetDevice(This, ppDevice);
}
static inline HRESULT
ID3D11Asynchronous_GetPrivateData(ID3D11Asynchronous *This, REFGUID guid,
                                  UINT *pDataSize, void *pData) {
  return This->lpVtbl->GetPrivateData(This, guid, pDataSize, pData);
}
static inline HRESULT
ID3D11Asynchronous_SetPrivateData(ID3D11Asynchronous *This, REFGUID guid,
                                  UINT DataSize, const void *pData) {
  return This->lpVtbl->SetPrivateData(This, guid, DataSize, pData);
}
static inline HRESULT ID3D11Asynchronous_SetPrivateDataInterface(
    ID3D11Asynchronous *This, REFGUID guid, const IUnknown *pData) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, pData);
}
/*** ID3D11Asynchronous methods ***/
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D11Query, 0xd6c00747, 0x87b7, 0x425e, 0xb8, 0x4d, 0x44, 0xd1,
                0x08, 0x56, 0x0a, 0xfd)
#endif
#else
typedef struct ID3D11QueryVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11Query *This, REFIID riid,
                                             void **ppvObject);
  ...
  void(STDMETHODCALLTYPE *GetDevice)(ID3D11Query *This,
                                     ID3D11Device **ppDevice);
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(ID3D11Query *This, REFGUID guid,
                                             UINT *pDataSize, void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D11Query *This, REFGUID guid,
                                             UINT DataSize, const void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateDataInterface)(ID3D11Query *This,
                                                      REFGUID guid,
                                                      const IUnknown *pData);
  /*** ID3D11Asynchronous methods ***/
...
interface ID3D11Query { CONST_VTBL ID3D11QueryVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT ID3D11Query_QueryInterface(ID3D11Query *This, REFIID riid,
                                                 void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ID3D11DeviceChild methods ***/
static inline void ID3D11Query_GetDevice(ID3D11Query *This,
                                         ID3D11Device **ppDevice) {
  This->lpVtbl->GetDevice(This, ppDevice);
}
static inline HRESULT ID3D11Query_GetPrivateData(ID3D11Query *This,
                                                 REFGUID guid, UINT *pDataSize,
                                                 void *pData) {
  return This->lpVtbl->GetPrivateData(This, guid, pDataSize, pData);
}
static inline HRESULT ID3D11Query_SetPrivateData(ID3D11Query *This,
                                                 REFGUID guid, UINT DataSize,
                                                 const void *pData) {
  return This->lpVtbl->SetPrivateData(This, guid, DataSize, pData);
}
static inline HRESULT
ID3D11Query_SetPrivateDataInterface(ID3D11Query *This, REFGUID guid,
                                    const IUnknown *pData) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, pData);
}
/*** ID3D11Asynchronous methods ***/
...
/*** ID3D11Query methods ***/
static inline void ID3D11Query_GetDesc(ID3D11Query *This,
...
ID3D11Resource : public ID3D11DeviceChild {
  virtual void STDMETHODCALLTYPE GetType(D3D11_RESOURCE_DIMENSION *
                                         pResourceDimension) = 0;
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D11Resource, 0xdc8e63f3, 0xd12b, 0x4952, 0xb4, 0x7b, 0x5e,
                0x45, 0x02, 0x6a, 0x86, 0x2d)
#endif
#else
typedef struct ID3D11ResourceVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11Resource *This, REFIID riid,
                                             void **ppvObject);
  ...
  void(STDMETHODCALLTYPE *GetDevice)(ID3D11Resource *This,
                                     ID3D11Device **ppDevice);
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(ID3D11Resource *This, REFGUID guid,
                                             UINT *pDataSize, void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D11Resource *This, REFGUID guid,
                                             UINT DataSize, const void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateDataInterface)(ID3D11Resource *This,
                                                      REFGUID guid,
                                                      const IUnknown *pData);
  /*** ID3D11Resource methods ***/
  void(STDMETHODCALLTYPE *GetType)(
      ID3D11Resource *This, D3D11_RESOURCE_DIMENSION *pResourceDimension);
...
interface ID3D11Resource { CONST_VTBL ID3D11ResourceVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT ID3D11Resource_QueryInterface(ID3D11Resource *This,
                                                    REFIID riid,
                                                    void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ID3D11DeviceChild methods ***/
static inline void ID3D11Resource_GetDevice(ID3D11Resource *This,
                                            ID3D11Device **ppDevice) {
  This->lpVtbl->GetDevice(This, ppDevice);
}
static inline HRESULT ID3D11Resource_GetPrivateData(ID3D11Resource *This,
                                                    REFGUID guid,
                                                    UINT *pDataSize,
                                                    void *pData) {
  return This->lpVtbl->GetPrivateData(This, guid, pDataSize, pData);
}
static inline HRESULT ID3D11Resource_SetPrivateData(ID3D11Resource *This,
                                                    REFGUID guid, UINT DataSize,
                                                    const void *pData) {
  return This->lpVtbl->SetPrivateData(This, guid, DataSize, pData);
}
static inline HRESULT
ID3D11Resource_SetPrivateDataInterface(ID3D11Resource *This, REFGUID guid,
                                       const IUnknown *pData) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, pData);
}
/*** ID3D11Resource methods ***/
static inline void
ID3D11Resource_GetType(ID3D11Resource *This,
                       D3D11_RESOURCE_DIMENSION *pResourceDimension) {
  This->lpVtbl->GetType(This, pResourceDimension);
}
static inline void ID3D11Resource_SetEvictionPriority(ID3D11Resource *This,
                                                      UINT EvictionPriority) {
  This->lpVtbl->SetEvictionPriority(This, EvictionPriority);
}
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D11View, 0x839d1216, 0xbb2e, 0x412b, 0xb7, 0xf4, 0xa9, 0xdb,
                0xeb, 0xe0, 0x8e, 0xd1)
#endif
#else
typedef struct ID3D11ViewVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11View *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(ID3D11View *This, REFGUID guid,
                                             UINT *pDataSize, void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D11View *This, REFGUID guid,
                                             UINT DataSize, const void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateDataInterface)(ID3D11View *This,
                                                      REFGUID guid,
                                                      const IUnknown *pData);
  /*** ID3D11View methods ***/
...
interface ID3D11View { CONST_VTBL ID3D11ViewVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT ID3D11View_QueryInterface(ID3D11View *This, REFIID riid,
                                                void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ID3D11DeviceChild methods ***/
static inline void ID3D11View_GetDevice(ID3D11View *This,
                                        ID3D11Device **ppDevice) {
  This->lpVtbl->GetDevice(This, ppDevice);
}
static inline HRESULT ID3D11View_GetPrivateData(ID3D11View *This, REFGUID guid,
                                                UINT *pDataSize, void *pData) {
  return This->lpVtbl->GetPrivateData(This, guid, pDataSize, pData);
}
static inline HRESULT ID3D11View_SetPrivateData(ID3D11View *This, REFGUID guid,
                                                UINT DataSize,
                                                const void *pData) {
  return This->lpVtbl->SetPrivateData(This, guid, DataSize, pData);
}
static inline HRESULT
ID3D11View_SetPrivateDataInterface(ID3D11View *This, REFGUID guid,
                                   const IUnknown *pData) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, pData);
}
/*** ID3D11View methods ***/
static inline void ID3D11View_GetResource(ID3D11View *This,
                                          ID3D11Resource **ppResource) {
  This->lpVtbl->GetResource(This, ppResource);
}
#endif
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D11BlendState, 0x75b68faa, 0x347d, 0x4159, 0x8f, 0x45, 0xa0,
                0x64, 0x0f, 0x01, 0xcd, 0x9a)
#endif
#else
typedef struct ID3D11BlendStateVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11BlendState *This,
                                             REFIID riid, void **ppvObject);
  ...
  void(STDMETHODCALLTYPE *GetDevice)(ID3D11BlendState *This,
                                     ID3D11Device **ppDevice);
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(ID3D11BlendState *This,
                                             REFGUID guid, UINT *pDataSize,
                                             void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D11BlendState *This,
                                             REFGUID guid, UINT DataSize,
                                             const void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateDataInterface)(ID3D11BlendState *This,
                                                      REFGUID guid,
                                                      const IUnknown *pData);
...
interface ID3D11BlendState { CONST_VTBL ID3D11BlendStateVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT ID3D11BlendState_QueryInterface(ID3D11BlendState *This,
                                                      REFIID riid,
                                                      void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ID3D11DeviceChild methods ***/
static inline void ID3D11BlendState_GetDevice(ID3D11BlendState *This,
                                              ID3D11Device **ppDevice) {
  This->lpVtbl->GetDevice(This, ppDevice);
}
static inline HRESULT ID3D11BlendState_GetPrivateData(ID3D11BlendState *This,
                                                      REFGUID guid,
                                                      UINT *pDataSize,
                                                      void *pData) {
  return This->lpVtbl->GetPrivateData(This, guid, pDataSize, pData);
}
static inline HRESULT ID3D11BlendState_SetPrivateData(ID3D11BlendState *This,
                                                      REFGUID guid,
                                                      UINT DataSize,
                                                      const void *pData) {
  return This->lpVtbl->SetPrivateData(This, guid, DataSize, pData);
...
static inline HRESULT
ID3D11BlendState_SetPrivateDataInterface(ID3D11BlendState *This, REFGUID guid,
                                         const IUnknown *pData) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, pData);
}
/*** ID3D11BlendState methods ***/
static inline void ID3D11BlendState_GetDesc(ID3D11BlendState *This,
                                            D3D11_BLEND_DESC *pDesc) {
  This->lpVtbl->GetDesc(This, pDesc);
}
#endif
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D11Buffer, 0x48570b85, 0xd1ee, 0x4fcd, 0xa2, 0x50, 0xeb,
                0x35, 0x07, 0x22, 0xb0, 0x37)
#endif
#else
typedef struct ID3D11BufferVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11Buffer *This, REFIID riid,
                                             void **ppvObject);
  ...
  void(STDMETHODCALLTYPE *GetDevice)(ID3D11Buffer *This,
                                     ID3D11Device **ppDevice);
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(ID3D11Buffer *This, REFGUID guid,
                                             UINT *pDataSize, void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D11Buffer *This, REFGUID guid,
                                             UINT DataSize, const void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateDataInterface)(ID3D11Buffer *This,
                                                      REFGUID guid,
                                                      const IUnknown *pData);
  /*** ID3D11Resource methods ***/
  void(STDMETHODCALLTYPE *GetType)(
      ID3D11Buffer *This, D3D11_RESOURCE_DIMENSION *pResourceDimension);
...
interface ID3D11Buffer { CONST_VTBL ID3D11BufferVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
ID3D11Buffer_QueryInterface(ID3D11Buffer *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ID3D11DeviceChild methods ***/
static inline void ID3D11Buffer_GetDevice(ID3D11Buffer *This,
                                          ID3D11Device **ppDevice) {
  This->lpVtbl->GetDevice(This, ppDevice);
}
static inline HRESULT ID3D11Buffer_GetPrivateData(ID3D11Buffer *This,
                                                  REFGUID guid, UINT *pDataSize,
                                                  void *pData) {
  return This->lpVtbl->GetPrivateData(This, guid, pDataSize, pData);
}
static inline HRESULT ID3D11Buffer_SetPrivateData(ID3D11Buffer *This,
                                                  REFGUID guid, UINT DataSize,
                                                  const void *pData) {
  return This->lpVtbl->SetPrivateData(This, guid, DataSize, pData);
}
static inline HRESULT
ID3D11Buffer_SetPrivateDataInterface(ID3D11Buffer *This, REFGUID guid,
                                     const IUnknown *pData) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, pData);
}
/*** ID3D11Resource methods ***/
static inline void
ID3D11Buffer_GetType(ID3D11Buffer *This,
                     D3D11_RESOURCE_DIMENSION *pResourceDimension) {
  This->lpVtbl->GetType(This, pResourceDimension);
}
static inline void ID3D11Buffer_SetEvictionPriority(ID3D11Buffer *This,
                                                    UINT EvictionPriority) {
  This->lpVtbl->SetEvictionPriority(This, EvictionPriority);
}
...
/*** ID3D11Buffer methods ***/
static inline void ID3D11Buffer_GetDesc(ID3D11Buffer *This,
                                        D3D11_BUFFER_DESC *pDesc) {
  This->lpVtbl->GetDesc(This, pDesc);
}
#endif
...
ID3D11ClassInstance : public ID3D11DeviceChild {
  virtual void STDMETHODCALLTYPE GetClassLinkage(ID3D11ClassLinkage *
                                                 *ppLinkage) = 0;
  virtual void STDMETHODCALLTYPE GetDesc(D3D11_CLASS_INSTANCE_DESC * pDesc) = 0;
  virtual void STDMETHODCALLTYPE GetInstanceName(LPSTR pInstanceName,
                                                 SIZE_T * pBufferLength) = 0;
  virtual void STDMETHODCALLTYPE GetTypeName(LPSTR pTypeName,
                                             SIZE_T * pBufferLength) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D11ClassInstance, 0xa6cd7faa, 0xb0b7, 0x4a2f, 0x94, 0x36,
                0x86, 0x62, 0xa6, 0x57, 0x97, 0xcb)
#endif
#else
typedef struct ID3D11ClassInstanceVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11ClassInstance *This,
                                             REFIID riid, void **ppvObject);
  ...
  void(STDMETHODCALLTYPE *GetDevice)(ID3D11ClassInstance *This,
                                     ID3D11Device **ppDevice);
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(ID3D11ClassInstance *This,
                                             REFGUID guid, UINT *pDataSize,
                                             void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D11ClassInstance *This,
                                             REFGUID guid, UINT DataSize,
                                             const void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateDataInterface)(ID3D11ClassInstance *This,
                                                      REFGUID guid,
                                                      const IUnknown *pData);
  ...
  void(STDMETHODCALLTYPE *GetTypeName)(ID3D11ClassInstance *This,
                                       LPSTR pTypeName, SIZE_T *pBufferLength);
  END_INTERFACE
} ID3D11ClassInstanceVtbl;
interface ID3D11ClassInstance { CONST_VTBL ID3D11ClassInstanceVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
ID3D11ClassInstance_QueryInterface(ID3D11ClassInstance *This, REFIID riid,
                                   void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ID3D11DeviceChild methods ***/
static inline void ID3D11ClassInstance_GetDevice(ID3D11ClassInstance *This,
                                                 ID3D11Device **ppDevice) {
  This->lpVtbl->GetDevice(This, ppDevice);
}
static inline HRESULT
ID3D11ClassInstance_GetPrivateData(ID3D11ClassInstance *This, REFGUID guid,
                                   UINT *pDataSize, void *pData) {
  return This->lpVtbl->GetPrivateData(This, guid, pDataSize, pData);
}
static inline HRESULT
ID3D11ClassInstance_SetPrivateData(ID3D11ClassInstance *This, REFGUID guid,
                                   UINT DataSize, const void *pData) {
  return This->lpVtbl->SetPrivateData(This, guid, DataSize, pData);
}
static inline HRESULT ID3D11ClassInstance_SetPrivateDataInterface(
    ID3D11ClassInstance *This, REFGUID guid, const IUnknown *pData) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, pData);
}
/*** ID3D11ClassInstance methods ***/
static inline void
ID3D11ClassInstance_GetClassLinkage(ID3D11ClassInstance *This,
                                    ID3D11ClassLinkage **ppLinkage) {
  This->lpVtbl->GetClassLinkage(This, ppLinkage);
}
static inline void
ID3D11ClassInstance_GetDesc(ID3D11ClassInstance *This,
                            D3D11_CLASS_INSTANCE_DESC *pDesc) {
  This->lpVtbl->GetDesc(This, pDesc);
}
static inline void ID3D11ClassInstance_GetInstanceName(
    ID3D11ClassInstance *This, LPSTR pInstanceName, SIZE_T *pBufferLength) {
  This->lpVtbl->GetInstanceName(This, pInstanceName, pBufferLength);
}
static inline void ID3D11ClassInstance_GetTypeName(ID3D11ClassInstance *This,
                                                   LPSTR pTypeName,
                                                   SIZE_T *pBufferLength) {
  This->lpVtbl->GetTypeName(This, pTypeName, pBufferLength);
}
...
ID3D11ClassLinkage : public ID3D11DeviceChild {
  ...
  virtual HRESULT STDMETHODCALLTYPE CreateClassInstance(
      LPCSTR pClassTypeName, UINT ConstantBufferOffset,
      UINT ConstantVectorOffset, UINT TextureOffset, UINT SamplerOffset,
      ID3D11ClassInstance * *ppInstance) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D11ClassLinkage, 0xddf57cba, 0x9543, 0x46e4, 0xa1, 0x2b,
                0xf2, 0x07, 0xa0, 0xfe, 0x7f, 0xed)
#endif
#else
typedef struct ID3D11ClassLinkageVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11ClassLinkage *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetClassInstance)(
      ID3D11ClassLinkage *This, LPCSTR pClassInstanceName, UINT InstanceIndex,
      ID3D11ClassInstance **ppInstance);
  HRESULT(STDMETHODCALLTYPE *CreateClassInstance)(
      ID3D11ClassLinkage *This, LPCSTR pClassTypeName,
...
interface ID3D11ClassLinkage { CONST_VTBL ID3D11ClassLinkageVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
ID3D11ClassLinkage_QueryInterface(ID3D11ClassLinkage *This, REFIID riid,
                                  void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ID3D11DeviceChild methods ***/
static inline void ID3D11ClassLinkage_GetDevice(ID3D11ClassLinkage *This,
                                                ID3D11Device **ppDevice) {
  This->lpVtbl->GetDevice(This, ppDevice);
}
static inline HRESULT
ID3D11ClassLinkage_GetPrivateData(ID3D11ClassLinkage *This, REFGUID guid,
                                  UINT *pDataSize, void *pData) {
  return This->lpVtbl->GetPrivateData(This, guid, pDataSize, pData);
}
static inline HRESULT
ID3D11ClassLinkage_SetPrivateData(ID3D11ClassLinkage *This, REFGUID guid,
                                  UINT DataSize, const void *pData) {
  return This->lpVtbl->SetPrivateData(This, guid, DataSize, pData);
}
static inline HRESULT ID3D11ClassLinkage_SetPrivateDataInterface(
    ID3D11ClassLinkage *This, REFGUID guid, const IUnknown *pData) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, pData);
}
/*** ID3D11ClassLinkage methods ***/
static inline HRESULT ID3D11ClassLinkage_GetClassInstance(
    ID3D11ClassLinkage *This, LPCSTR pClassInstanceName, UINT InstanceIndex,
    ID3D11ClassInstance **ppInstance) {
  return This->lpVtbl->GetClassInstance(This, pClassInstanceName, InstanceIndex,
                                        ppInstance);
}
static inline HRESULT ID3D11ClassLinkage_CreateClassInstance(
    ID3D11ClassLinkage *This, LPCSTR pClassTypeName, UINT ConstantBufferOffset,
    UINT ConstantVectorOffset, UINT TextureOffset, UINT SamplerOffset,
    ID3D11ClassInstance **ppInstance) {
  return This->lpVtbl->CreateClassInstance(
      This, pClassTypeName, ConstantBufferOffset, ConstantVectorOffset,
      TextureOffset, SamplerOffset, ppInstance);
}
#endif
...
ID3D11CommandList : public ID3D11DeviceChild {
  virtual UINT STDMETHODCALLTYPE GetContextFlags() = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D11CommandList, 0xa24bc4d1, 0x769e, 0x43f7, 0x80, 0x13, 0x98,
                0xff, 0x56, 0x6c, 0x18, 0xe2)
#endif
#else
typedef struct ID3D11CommandListVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11CommandList *This,
                                             REFIID riid, void **ppvObject);
  ...
  void(STDMETHODCALLTYPE *GetDevice)(ID3D11CommandList *This,
                                     ID3D11Device **ppDevice);
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(ID3D11CommandList *This,
                                             REFGUID guid, UINT *pDataSize,
                                             void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D11CommandList *This,
                                             REFGUID guid, UINT DataSize,
                                             const void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateDataInterface)(ID3D11CommandList *This,
                                                      REFGUID guid,
                                                      const IUnknown *pData);
...
interface ID3D11CommandList { CONST_VTBL ID3D11CommandListVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT ID3D11CommandList_QueryInterface(ID3D11CommandList *This,
                                                       REFIID riid,
                                                       void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ID3D11DeviceChild methods ***/
static inline void ID3D11CommandList_GetDevice(ID3D11CommandList *This,
                                               ID3D11Device **ppDevice) {
  This->lpVtbl->GetDevice(This, ppDevice);
}
static inline HRESULT ID3D11CommandList_GetPrivateData(ID3D11CommandList *This,
                                                       REFGUID guid,
                                                       UINT *pDataSize,
                                                       void *pData) {
  return This->lpVtbl->GetPrivateData(This, guid, pDataSize, pData);
}
static inline HRESULT ID3D11CommandList_SetPrivateData(ID3D11CommandList *This,
                                                       REFGUID guid,
                                                       UINT DataSize,
                                                       const void *pData) {
  return This->lpVtbl->SetPrivateData(This, guid, DataSize, pData);
...
static inline HRESULT
ID3D11CommandList_SetPrivateDataInterface(ID3D11CommandList *This, REFGUID guid,
                                          const IUnknown *pData) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, pData);
}
/*** ID3D11CommandList methods ***/
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D11ComputeShader, 0x4f5b196e, 0xc2bd, 0x495e, 0xbd, 0x01,
                0x1f, 0xde, 0xd3, 0x8e, 0x49, 0x69)
#endif
#else
typedef struct ID3D11ComputeShaderVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11ComputeShader *This,
                                             REFIID riid, void **ppvObject);
  ...
  void(STDMETHODCALLTYPE *GetDevice)(ID3D11ComputeShader *This,
                                     ID3D11Device **ppDevice);
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(ID3D11ComputeShader *This,
                                             REFGUID guid, UINT *pDataSize,
                                             void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D11ComputeShader *This,
                                             REFGUID guid, UINT DataSize,
                                             const void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateDataInterface)(ID3D11ComputeShader *This,
                                                      REFGUID guid,
                                                      const IUnknown *pData);
  END_INTERFACE
} ID3D11ComputeShaderVtbl;
interface ID3D11ComputeShader { CONST_VTBL ID3D11ComputeShaderVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
ID3D11ComputeShader_QueryInterface(ID3D11ComputeShader *This, REFIID riid,
                                   void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ID3D11DeviceChild methods ***/
static inline void ID3D11ComputeShader_GetDevice(ID3D11ComputeShader *This,
                                                 ID3D11Device **ppDevice) {
  This->lpVtbl->GetDevice(This, ppDevice);
}
static inline HRESULT
ID3D11ComputeShader_GetPrivateData(ID3D11ComputeShader *This, REFGUID guid,
                                   UINT *pDataSize, void *pData) {
  return This->lpVtbl->GetPrivateData(This, guid, pDataSize, pData);
}
static inline HRESULT
ID3D11ComputeShader_SetPrivateData(ID3D11ComputeShader *This, REFGUID guid,
                                   UINT DataSize, const void *pData) {
  return This->lpVtbl->SetPrivateData(This, guid, DataSize, pData);
}
static inline HRESULT ID3D11ComputeShader_SetPrivateDataInterface(
    ID3D11ComputeShader *This, REFGUID guid, const IUnknown *pData) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, pData);
}
#endif
#endif
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D11Counter, 0x6e8c49fb, 0xa371, 0x4770, 0xb4, 0x40, 0x29,
                0x08, 0x60, 0x22, 0xb7, 0x41)
#endif
#else
typedef struct ID3D11CounterVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11Counter *This, REFIID riid,
                                             void **ppvObject);
  ...
  void(STDMETHODCALLTYPE *GetDevice)(ID3D11Counter *This,
                                     ID3D11Device **ppDevice);
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(ID3D11Counter *This, REFGUID guid,
                                             UINT *pDataSize, void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D11Counter *This, REFGUID guid,
                                             UINT DataSize, const void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateDataInterface)(ID3D11Counter *This,
                                                      REFGUID guid,
                                                      const IUnknown *pData);
  /*** ID3D11Asynchronous methods ***/
...
interface ID3D11Counter { CONST_VTBL ID3D11CounterVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT ID3D11Counter_QueryInterface(ID3D11Counter *This,
                                                   REFIID riid,
                                                   void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ID3D11DeviceChild methods ***/
static inline void ID3D11Counter_GetDevice(ID3D11Counter *This,
                                           ID3D11Device **ppDevice) {
  This->lpVtbl->GetDevice(This, ppDevice);
}
static inline HRESULT ID3D11Counter_GetPrivateData(ID3D11Counter *This,
                                                   REFGUID guid,
                                                   UINT *pDataSize,
                                                   void *pData) {
  return This->lpVtbl->GetPrivateData(This, guid, pDataSize, pData);
}
static inline HRESULT ID3D11Counter_SetPrivateData(ID3D11Counter *This,
                                                   REFGUID guid, UINT DataSize,
                                                   const void *pData) {
  return This->lpVtbl->SetPrivateData(This, guid, DataSize, pData);
}
static inline HRESULT
ID3D11Counter_SetPrivateDataInterface(ID3D11Counter *This, REFGUID guid,
                                      const IUnknown *pData) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, pData);
}
/*** ID3D11Asynchronous methods ***/
...
/*** ID3D11Counter methods ***/
static inline void ID3D11Counter_GetDesc(ID3D11Counter *This,
                                         D3D11_COUNTER_DESC *pDesc) {
  This->lpVtbl->GetDesc(This, pDesc);
}
#endif
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D11DepthStencilState, 0x03823efb, 0x8d8f, 0x4e1c, 0x9a, 0xa2,
                0xf6, 0x4b, 0xb2, 0xcb, 0xfd, 0xf1)
#endif
#else
typedef struct ID3D11DepthStencilStateVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11DepthStencilState *This,
                                             REFIID riid, void **ppvObject);
  ...
  void(STDMETHODCALLTYPE *GetDevice)(ID3D11DepthStencilState *This,
                                     ID3D11Device **ppDevice);
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(ID3D11DepthStencilState *This,
                                             REFGUID guid, UINT *pDataSize,
                                             void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D11DepthStencilState *This,
                                             REFGUID guid, UINT DataSize,
                                             const void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateDataInterface)(
      ID3D11DepthStencilState *This, REFGUID guid, const IUnknown *pData);
...
/*** IUnknown methods ***/
static inline HRESULT
ID3D11DepthStencilState_QueryInterface(ID3D11DepthStencilState *This,
                                       REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
ID3D11DepthStencilState_AddRef(ID3D11DepthStencilState *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
ID3D11DepthStencilState_Release(ID3D11DepthStencilState *This) {
  return This->lpVtbl->Release(This);
}
/*** ID3D11DeviceChild methods ***/
static inline void
ID3D11DepthStencilState_GetDevice(ID3D11DepthStencilState *This,
                                  ID3D11Device **ppDevice) {
  This->lpVtbl->GetDevice(This, ppDevice);
}
static inline HRESULT ID3D11DepthStencilState_GetPrivateData(
    ID3D11DepthStencilState *This, REFGUID guid, UINT *pDataSize, void *pData) {
  return This->lpVtbl->GetPrivateData(This, guid, pDataSize, pData);
}
static inline HRESULT
ID3D11DepthStencilState_SetPrivateData(ID3D11DepthStencilState *This,
                                       REFGUID guid, UINT DataSize,
                                       const void *pData) {
  return This->lpVtbl->SetPrivateData(This, guid, DataSize, pData);
}
static inline HRESULT ID3D11DepthStencilState_SetPrivateDataInterface(
    ID3D11DepthStencilState *This, REFGUID guid, const IUnknown *pData) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, pData);
}
/*** ID3D11DepthStencilState methods ***/
static inline void
ID3D11DepthStencilState_GetDesc(ID3D11DepthStencilState *This,
                                D3D11_DEPTH_STENCIL_DESC *pDesc) {
  This->lpVtbl->GetDesc(This, pDesc);
}
#endif
...
ID3D11DepthStencilView : public ID3D11View {
  virtual void STDMETHODCALLTYPE GetDesc(D3D11_DEPTH_STENCIL_VIEW_DESC *
                                         pDesc) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D11DepthStencilView, 0x9fdac92a, 0x1876, 0x48c3, 0xaf, 0xad,
                0x25, 0xb9, 0x4f, 0x84, 0xa9, 0xb6)
#endif
#else
typedef struct ID3D11DepthStencilViewVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11DepthStencilView *This,
                                             REFIID riid, void **ppvObject);
  ...
  void(STDMETHODCALLTYPE *GetDevice)(ID3D11DepthStencilView *This,
                                     ID3D11Device **ppDevice);
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(ID3D11DepthStencilView *This,
                                             REFGUID guid, UINT *pDataSize,
                                             void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D11DepthStencilView *This,
                                             REFGUID guid, UINT DataSize,
                                             const void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateDataInterface)(
      ID3D11DepthStencilView *This, REFGUID guid, const IUnknown *pData);
  /*** ID3D11View methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
ID3D11DepthStencilView_QueryInterface(ID3D11DepthStencilView *This, REFIID riid,
                                      void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
ID3D11DepthStencilView_AddRef(ID3D11DepthStencilView *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
ID3D11DepthStencilView_Release(ID3D11DepthStencilView *This) {
  return This->lpVtbl->Release(This);
}
/*** ID3D11DeviceChild methods ***/
static inline void
ID3D11DepthStencilView_GetDevice(ID3D11DepthStencilView *This,
                                 ID3D11Device **ppDevice) {
  This->lpVtbl->GetDevice(This, ppDevice);
}
static inline HRESULT ID3D11DepthStencilView_GetPrivateData(
    ID3D11DepthStencilView *This, REFGUID guid, UINT *pDataSize, void *pData) {
  return This->lpVtbl->GetPrivateData(This, guid, pDataSize, pData);
}
static inline HRESULT
ID3D11DepthStencilView_SetPrivateData(ID3D11DepthStencilView *This,
                                      REFGUID guid, UINT DataSize,
                                      const void *pData) {
  return This->lpVtbl->SetPrivateData(This, guid, DataSize, pData);
}
static inline HRESULT ID3D11DepthStencilView_SetPrivateDataInterface(
    ID3D11DepthStencilView *This, REFGUID guid, const IUnknown *pData) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, pData);
}
/*** ID3D11View methods ***/
static inline void
ID3D11DepthStencilView_GetResource(ID3D11DepthStencilView *This,
                                   ID3D11Resource **ppResource) {
  This->lpVtbl->GetResource(This, ppResource);
}
/*** ID3D11DepthStencilView methods ***/
static inline void
ID3D11DepthStencilView_GetDesc(ID3D11DepthStencilView *This,
                               D3D11_DEPTH_STENCIL_VIEW_DESC *pDesc) {
  This->lpVtbl->GetDesc(This, pDesc);
}
#endif
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D11DomainShader, 0xf582c508, 0x0f36, 0x490c, 0x99, 0x77,
                0x31, 0xee, 0xce, 0x26, 0x8c, 0xfa)
#endif
#else
typedef struct ID3D11DomainShaderVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11DomainShader *This,
                                             REFIID riid, void **ppvObject);
  ...
  void(STDMETHODCALLTYPE *GetDevice)(ID3D11DomainShader *This,
                                     ID3D11Device **ppDevice);
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(ID3D11DomainShader *This,
                                             REFGUID guid, UINT *pDataSize,
                                             void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D11DomainShader *This,
                                             REFGUID guid, UINT DataSize,
                                             const void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateDataInterface)(ID3D11DomainShader *This,
                                                      REFGUID guid,
                                                      const IUnknown *pData);
  END_INTERFACE
...
/*** IUnknown methods ***/
static inline HRESULT
ID3D11DomainShader_QueryInterface(ID3D11DomainShader *This, REFIID riid,
                                  void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ID3D11DeviceChild methods ***/
static inline void ID3D11DomainShader_GetDevice(ID3D11DomainShader *This,
                                                ID3D11Device **ppDevice) {
  This->lpVtbl->GetDevice(This, ppDevice);
}
static inline HRESULT
ID3D11DomainShader_GetPrivateData(ID3D11DomainShader *This, REFGUID guid,
                                  UINT *pDataSize, void *pData) {
  return This->lpVtbl->GetPrivateData(This, guid, pDataSize, pData);
}
static inline HRESULT
ID3D11DomainShader_SetPrivateData(ID3D11DomainShader *This, REFGUID guid,
                                  UINT DataSize, const void *pData) {
  return This->lpVtbl->SetPrivateData(This, guid, DataSize, pData);
}
static inline HRESULT ID3D11DomainShader_SetPrivateDataInterface(
    ID3D11DomainShader *This, REFGUID guid, const IUnknown *pData) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, pData);
}
#endif
#endif
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D11GeometryShader, 0x38325b96, 0xeffb, 0x4022, 0xba, 0x02,
                0x2e, 0x79, 0x5b, 0x70, 0x27, 0x5c)
#endif
#else
typedef struct ID3D11GeometryShaderVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11GeometryShader *This,
                                             REFIID riid, void **ppvObject);
  ...
  void(STDMETHODCALLTYPE *GetDevice)(ID3D11GeometryShader *This,
                                     ID3D11Device **ppDevice);
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(ID3D11GeometryShader *This,
                                             REFGUID guid, UINT *pDataSize,
                                             void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D11GeometryShader *This,
                                             REFGUID guid, UINT DataSize,
                                             const void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateDataInterface)(
      ID3D11GeometryShader *This, REFGUID guid, const IUnknown *pData);
  END_INTERFACE
} ID3D11GeometryShaderVtbl;
interface ID3D11GeometryShader { CONST_VTBL ID3D11GeometryShaderVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
ID3D11GeometryShader_QueryInterface(ID3D11GeometryShader *This, REFIID riid,
                                    void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ID3D11DeviceChild methods ***/
static inline void ID3D11GeometryShader_GetDevice(ID3D11GeometryShader *This,
                                                  ID3D11Device **ppDevice) {
  This->lpVtbl->GetDevice(This, ppDevice);
}
static inline HRESULT
ID3D11GeometryShader_GetPrivateData(ID3D11GeometryShader *This, REFGUID guid,
                                    UINT *pDataSize, void *pData) {
  return This->lpVtbl->GetPrivateData(This, guid, pDataSize, pData);
}
static inline HRESULT
ID3D11GeometryShader_SetPrivateData(ID3D11GeometryShader *This, REFGUID guid,
                                    UINT DataSize, const void *pData) {
  return This->lpVtbl->SetPrivateData(This, guid, DataSize, pData);
}
static inline HRESULT ID3D11GeometryShader_SetPrivateDataInterface(
    ID3D11GeometryShader *This, REFGUID guid, const IUnknown *pData) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, pData);
}
#endif
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D11HullShader, 0x8e5c6061, 0x628a, 0x4c8e, 0x82, 0x64, 0xbb,
                0xe4, 0x5c, 0xb3, 0xd5, 0xdd)
#endif
#else
typedef struct ID3D11HullShaderVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11HullShader *This,
                                             REFIID riid, void **ppvObject);
  ...
  void(STDMETHODCALLTYPE *GetDevice)(ID3D11HullShader *This,
                                     ID3D11Device **ppDevice);
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(ID3D11HullShader *This,
                                             REFGUID guid, UINT *pDataSize,
                                             void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D11HullShader *This,
                                             REFGUID guid, UINT DataSize,
                                             const void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateDataInterface)(ID3D11HullShader *This,
                                                      REFGUID guid,
                                                      const IUnknown *pData);
  END_INTERFACE
} ID3D11HullShaderVtbl;
interface ID3D11HullShader { CONST_VTBL ID3D11HullShaderVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT ID3D11HullShader_QueryInterface(ID3D11HullShader *This,
                                                      REFIID riid,
                                                      void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ID3D11DeviceChild methods ***/
static inline void ID3D11HullShader_GetDevice(ID3D11HullShader *This,
                                              ID3D11Device **ppDevice) {
  This->lpVtbl->GetDevice(This, ppDevice);
}
static inline HRESULT ID3D11HullShader_GetPrivateData(ID3D11HullShader *This,
                                                      REFGUID guid,
                                                      UINT *pDataSize,
                                                      void *pData) {
  return This->lpVtbl->GetPrivateData(This, guid, pDataSize, pData);
}
static inline HRESULT ID3D11HullShader_SetPrivateData(ID3D11HullShader *This,
                                                      REFGUID guid,
                                                      UINT DataSize,
                                                      const void *pData) {
  return This->lpVtbl->SetPrivateData(This, guid, DataSize, pData);
...
static inline HRESULT
ID3D11HullShader_SetPrivateDataInterface(ID3D11HullShader *This, REFGUID guid,
                                         const IUnknown *pData) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, pData);
}
#endif
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D11InputLayout, 0xe4819ddc, 0x4cf0, 0x4025, 0xbd, 0x26, 0x5d,
                0xe8, 0x2a, 0x3e, 0x07, 0xb7)
#endif
#else
typedef struct ID3D11InputLayoutVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11InputLayout *This,
                                             REFIID riid, void **ppvObject);
  ...
  void(STDMETHODCALLTYPE *GetDevice)(ID3D11InputLayout *This,
                                     ID3D11Device **ppDevice);
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(ID3D11InputLayout *This,
                                             REFGUID guid, UINT *pDataSize,
                                             void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D11InputLayout *This,
                                             REFGUID guid, UINT DataSize,
                                             const void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateDataInterface)(ID3D11InputLayout *This,
                                                      REFGUID guid,
                                                      const IUnknown *pData);
  END_INTERFACE
} ID3D11InputLayoutVtbl;
interface ID3D11InputLayout { CONST_VTBL ID3D11InputLayoutVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT ID3D11InputLayout_QueryInterface(ID3D11InputLayout *This,
                                                       REFIID riid,
                                                       void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ID3D11DeviceChild methods ***/
static inline void ID3D11InputLayout_GetDevice(ID3D11InputLayout *This,
                                               ID3D11Device **ppDevice) {
  This->lpVtbl->GetDevice(This, ppDevice);
}
static inline HRESULT ID3D11InputLayout_GetPrivateData(ID3D11InputLayout *This,
                                                       REFGUID guid,
                                                       UINT *pDataSize,
                                                       void *pData) {
  return This->lpVtbl->GetPrivateData(This, guid, pDataSize, pData);
}
static inline HRESULT ID3D11InputLayout_SetPrivateData(ID3D11InputLayout *This,
                                                       REFGUID guid,
                                                       UINT DataSize,
                                                       const void *pData) {
  return This->lpVtbl->SetPrivateData(This, guid, DataSize, pData);
...
static inline HRESULT
ID3D11InputLayout_SetPrivateDataInterface(ID3D11InputLayout *This, REFGUID guid,
                                          const IUnknown *pData) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, pData);
}
#endif
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D11PixelShader, 0xea82e40d, 0x51dc, 0x4f33, 0x93, 0xd4, 0xdb,
                0x7c, 0x91, 0x25, 0xae, 0x8c)
#endif
#else
typedef struct ID3D11PixelShaderVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11PixelShader *This,
                                             REFIID riid, void **ppvObject);
  ...
  void(STDMETHODCALLTYPE *GetDevice)(ID3D11PixelShader *This,
                                     ID3D11Device **ppDevice);
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(ID3D11PixelShader *This,
                                             REFGUID guid, UINT *pDataSize,
                                             void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D11PixelShader *This,
                                             REFGUID guid, UINT DataSize,
                                             const void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateDataInterface)(ID3D11PixelShader *This,
                                                      REFGUID guid,
                                                      const IUnknown *pData);
  END_INTERFACE
} ID3D11PixelShaderVtbl;
interface ID3D11PixelShader { CONST_VTBL ID3D11PixelShaderVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT ID3D11PixelShader_QueryInterface(ID3D11PixelShader *This,
                                                       REFIID riid,
                                                       void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ID3D11DeviceChild methods ***/
static inline void ID3D11PixelShader_GetDevice(ID3D11PixelShader *This,
                                               ID3D11Device **ppDevice) {
  This->lpVtbl->GetDevice(This, ppDevice);
}
static inline HRESULT ID3D11PixelShader_GetPrivateData(ID3D11PixelShader *This,
                                                       REFGUID guid,
                                                       UINT *pDataSize,
                                                       void *pData) {
  return This->lpVtbl->GetPrivateData(This, guid, pDataSize, pData);
}
static inline HRESULT ID3D11PixelShader_SetPrivateData(ID3D11PixelShader *This,
                                                       REFGUID guid,
                                                       UINT DataSize,
                                                       const void *pData) {
  return This->lpVtbl->SetPrivateData(This, guid, DataSize, pData);
...
static inline HRESULT
ID3D11PixelShader_SetPrivateDataInterface(ID3D11PixelShader *This, REFGUID guid,
                                          const IUnknown *pData) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, pData);
}
#endif
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D11Predicate, 0x9eb576dd, 0x9f77, 0x4d86, 0x81, 0xaa, 0x8b,
                0xab, 0x5f, 0xe4, 0x90, 0xe2)
#endif
#else
typedef struct ID3D11PredicateVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11Predicate *This, REFIID riid,
                                             void **ppvObject);
  ...
  void(STDMETHODCALLTYPE *GetDevice)(ID3D11Predicate *This,
                                     ID3D11Device **ppDevice);
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(ID3D11Predicate *This,
                                             REFGUID guid, UINT *pDataSize,
                                             void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D11Predicate *This,
                                             REFGUID guid, UINT DataSize,
                                             const void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateDataInterface)(ID3D11Predicate *This,
                                                      REFGUID guid,
                                                      const IUnknown *pData);
  /*** ID3D11Asynchronous methods ***/
...
interface ID3D11Predicate { CONST_VTBL ID3D11PredicateVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT ID3D11Predicate_QueryInterface(ID3D11Predicate *This,
                                                     REFIID riid,
                                                     void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ID3D11DeviceChild methods ***/
static inline void ID3D11Predicate_GetDevice(ID3D11Predicate *This,
                                             ID3D11Device **ppDevice) {
  This->lpVtbl->GetDevice(This, ppDevice);
}
static inline HRESULT ID3D11Predicate_GetPrivateData(ID3D11Predicate *This,
                                                     REFGUID guid,
                                                     UINT *pDataSize,
                                                     void *pData) {
  return This->lpVtbl->GetPrivateData(This, guid, pDataSize, pData);
}
static inline HRESULT ID3D11Predicate_SetPrivateData(ID3D11Predicate *This,
                                                     REFGUID guid,
                                                     UINT DataSize,
                                                     const void *pData) {
  return This->lpVtbl->SetPrivateData(This, guid, DataSize, pData);
...
static inline HRESULT
ID3D11Predicate_SetPrivateDataInterface(ID3D11Predicate *This, REFGUID guid,
                                        const IUnknown *pData) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, pData);
}
/*** ID3D11Asynchronous methods ***/
...
/*** ID3D11Query methods ***/
static inline void ID3D11Predicate_GetDesc(ID3D11Predicate *This,
                                           D3D11_QUERY_DESC *pDesc) {
  This->lpVtbl->GetDesc(This, pDesc);
}
#endif
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D11RasterizerState, 0x9bb4ab81, 0xab1a, 0x4d8f, 0xb5, 0x06,
                0xfc, 0x04, 0x20, 0x0b, 0x6e, 0xe7)
#endif
#else
typedef struct ID3D11RasterizerStateVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11RasterizerState *This,
                                             REFIID riid, void **ppvObject);
  ...
  void(STDMETHODCALLTYPE *GetDevice)(ID3D11RasterizerState *This,
                                     ID3D11Device **ppDevice);
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(ID3D11RasterizerState *This,
                                             REFGUID guid, UINT *pDataSize,
                                             void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D11RasterizerState *This,
                                             REFGUID guid, UINT DataSize,
                                             const void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateDataInterface)(
      ID3D11RasterizerState *This, REFGUID guid, const IUnknown *pData);
...
/*** IUnknown methods ***/
static inline HRESULT
ID3D11RasterizerState_QueryInterface(ID3D11RasterizerState *This, REFIID riid,
                                     void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ID3D11DeviceChild methods ***/
static inline void ID3D11RasterizerState_GetDevice(ID3D11RasterizerState *This,
                                                   ID3D11Device **ppDevice) {
  This->lpVtbl->GetDevice(This, ppDevice);
}
static inline HRESULT
ID3D11RasterizerState_GetPrivateData(ID3D11RasterizerState *This, REFGUID guid,
                                     UINT *pDataSize, void *pData) {
  return This->lpVtbl->GetPrivateData(This, guid, pDataSize, pData);
}
static inline HRESULT
ID3D11RasterizerState_SetPrivateData(ID3D11RasterizerState *This, REFGUID guid,
                                     UINT DataSize, const void *pData) {
  return This->lpVtbl->SetPrivateData(This, guid, DataSize, pData);
}
static inline HRESULT ID3D11RasterizerState_SetPrivateDataInterface(
    ID3D11RasterizerState *This, REFGUID guid, const IUnknown *pData) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, pData);
}
/*** ID3D11RasterizerState methods ***/
static inline void ID3D11RasterizerState_GetDesc(ID3D11RasterizerState *This,
                                                 D3D11_RASTERIZER_DESC *pDesc) {
  This->lpVtbl->GetDesc(This, pDesc);
}
#endif
...
ID3D11RenderTargetView : public ID3D11View {
  virtual void STDMETHODCALLTYPE GetDesc(D3D11_RENDER_TARGET_VIEW_DESC *
                                         pDesc) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D11RenderTargetView, 0xdfdba067, 0x0b8d, 0x4865, 0x87, 0x5b,
                0xd7, 0xb4, 0x51, 0x6c, 0xc1, 0x64)
#endif
#else
typedef struct ID3D11RenderTargetViewVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11RenderTargetView *This,
                                             REFIID riid, void **ppvObject);
  ...
  void(STDMETHODCALLTYPE *GetDevice)(ID3D11RenderTargetView *This,
                                     ID3D11Device **ppDevice);
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(ID3D11RenderTargetView *This,
                                             REFGUID guid, UINT *pDataSize,
                                             void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D11RenderTargetView *This,
                                             REFGUID guid, UINT DataSize,
                                             const void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateDataInterface)(
      ID3D11RenderTargetView *This, REFGUID guid, const IUnknown *pData);
  /*** ID3D11View methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
ID3D11RenderTargetView_QueryInterface(ID3D11RenderTargetView *This, REFIID riid,
                                      void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
ID3D11RenderTargetView_AddRef(ID3D11RenderTargetView *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
ID3D11RenderTargetView_Release(ID3D11RenderTargetView *This) {
  return This->lpVtbl->Release(This);
}
/*** ID3D11DeviceChild methods ***/
static inline void
ID3D11RenderTargetView_GetDevice(ID3D11RenderTargetView *This,
                                 ID3D11Device **ppDevice) {
  This->lpVtbl->GetDevice(This, ppDevice);
}
static inline HRESULT ID3D11RenderTargetView_GetPrivateData(
    ID3D11RenderTargetView *This, REFGUID guid, UINT *pDataSize, void *pData) {
  return This->lpVtbl->GetPrivateData(This, guid, pDataSize, pData);
}
static inline HRESULT
ID3D11RenderTargetView_SetPrivateData(ID3D11RenderTargetView *This,
                                      REFGUID guid, UINT DataSize,
                                      const void *pData) {
  return This->lpVtbl->SetPrivateData(This, guid, DataSize, pData);
}
...
/*** ID3D11View methods ***/
static inline void
ID3D11RenderTargetView_GetResource(ID3D11RenderTargetView *This,
                                   ID3D11Resource **ppResource) {
  This->lpVtbl->GetResource(This, ppResource);
}
/*** ID3D11RenderTargetView methods ***/
static inline void
ID3D11RenderTargetView_GetDesc(ID3D11RenderTargetView *This,
                               D3D11_RENDER_TARGET_VIEW_DESC *pDesc) {
  This->lpVtbl->GetDesc(This, pDesc);
}
#endif
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D11SamplerState, 0xda6fea51, 0x564c, 0x4487, 0x98, 0x10,
                0xf0, 0xd0, 0xf9, 0xb4, 0xe3, 0xa5)
#endif
#else
typedef struct ID3D11SamplerStateVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11SamplerState *This,
                                             REFIID riid, void **ppvObject);
  ...
  void(STDMETHODCALLTYPE *GetDevice)(ID3D11SamplerState *This,
                                     ID3D11Device **ppDevice);
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(ID3D11SamplerState *This,
                                             REFGUID guid, UINT *pDataSize,
                                             void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D11SamplerState *This,
                                             REFGUID guid, UINT DataSize,
                                             const void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateDataInterface)(ID3D11SamplerState *This,
                                                      REFGUID guid,
                                                      const IUnknown *pData);
...
interface ID3D11SamplerState { CONST_VTBL ID3D11SamplerStateVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
ID3D11SamplerState_QueryInterface(ID3D11SamplerState *This, REFIID riid,
                                  void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ID3D11DeviceChild methods ***/
static inline void ID3D11SamplerState_GetDevice(ID3D11SamplerState *This,
                                                ID3D11Device **ppDevice) {
  This->lpVtbl->GetDevice(This, ppDevice);
}
static inline HRESULT
ID3D11SamplerState_GetPrivateData(ID3D11SamplerState *This, REFGUID guid,
                                  UINT *pDataSize, void *pData) {
  return This->lpVtbl->GetPrivateData(This, guid, pDataSize, pData);
}
static inline HRESULT
ID3D11SamplerState_SetPrivateData(ID3D11SamplerState *This, REFGUID guid,
                                  UINT DataSize, const void *pData) {
  return This->lpVtbl->SetPrivateData(This, guid, DataSize, pData);
}
static inline HRESULT ID3D11SamplerState_SetPrivateDataInterface(
    ID3D11SamplerState *This, REFGUID guid, const IUnknown *pData) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, pData);
}
/*** ID3D11SamplerState methods ***/
static inline void ID3D11SamplerState_GetDesc(ID3D11SamplerState *This,
                                              D3D11_SAMPLER_DESC *pDesc) {
  This->lpVtbl->GetDesc(This, pDesc);
}
#endif
...
ID3D11ShaderResourceView : public ID3D11View {
  virtual void STDMETHODCALLTYPE GetDesc(D3D11_SHADER_RESOURCE_VIEW_DESC *
                                         pDesc) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D11ShaderResourceView, 0xb0e06fe0, 0x8192, 0x4e1a, 0xb1,
                0xca, 0x36, 0xd7, 0x41, 0x47, 0x10, 0xb2)
#endif
#else
typedef struct ID3D11ShaderResourceViewVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11ShaderResourceView *This,
                                             REFIID riid, void **ppvObject);
  ...
  void(STDMETHODCALLTYPE *GetDevice)(ID3D11ShaderResourceView *This,
                                     ID3D11Device **ppDevice);
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(ID3D11ShaderResourceView *This,
                                             REFGUID guid, UINT *pDataSize,
                                             void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D11ShaderResourceView *This,
                                             REFGUID guid, UINT DataSize,
                                             const void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateDataInterface)(
      ID3D11ShaderResourceView *This, REFGUID guid, const IUnknown *pData);
  /*** ID3D11View methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
ID3D11ShaderResourceView_QueryInterface(ID3D11ShaderResourceView *This,
                                        REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
ID3D11ShaderResourceView_AddRef(ID3D11ShaderResourceView *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
ID3D11ShaderResourceView_Release(ID3D11ShaderResourceView *This) {
  return This->lpVtbl->Release(This);
}
/*** ID3D11DeviceChild methods ***/
static inline void
ID3D11ShaderResourceView_GetDevice(ID3D11ShaderResourceView *This,
                                   ID3D11Device **ppDevice) {
  This->lpVtbl->GetDevice(This, ppDevice);
}
static inline HRESULT
ID3D11ShaderResourceView_GetPrivateData(ID3D11ShaderResourceView *This,
                                        REFGUID guid, UINT *pDataSize,
                                        void *pData) {
  return This->lpVtbl->GetPrivateData(This, guid, pDataSize, pData);
}
static inline HRESULT
ID3D11ShaderResourceView_SetPrivateData(ID3D11ShaderResourceView *This,
                                        REFGUID guid, UINT DataSize,
                                        const void *pData) {
  return This->lpVtbl->SetPrivateData(This, guid, DataSize, pData);
}
static inline HRESULT ID3D11ShaderResourceView_SetPrivateDataInterface(
    ID3D11ShaderResourceView *This, REFGUID guid, const IUnknown *pData) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, pData);
}
/*** ID3D11View methods ***/
static inline void
ID3D11ShaderResourceView_GetResource(ID3D11ShaderResourceView *This,
                                     ID3D11Resource **ppResource) {
  This->lpVtbl->GetResource(This, ppResource);
}
/*** ID3D11ShaderResourceView methods ***/
static inline void
ID3D11ShaderResourceView_GetDesc(ID3D11ShaderResourceView *This,
                                 D3D11_SHADER_RESOURCE_VIEW_DESC *pDesc) {
  This->lpVtbl->GetDesc(This, pDesc);
}
#endif
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D11Texture1D, 0xf8fb5c27, 0xc6b3, 0x4f75, 0xa4, 0xc8, 0x43,
                0x9a, 0xf2, 0xef, 0x56, 0x4c)
#endif
#else
typedef struct ID3D11Texture1DVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11Texture1D *This, REFIID riid,
                                             void **ppvObject);
  ...
  void(STDMETHODCALLTYPE *GetDevice)(ID3D11Texture1D *This,
                                     ID3D11Device **ppDevice);
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(ID3D11Texture1D *This,
                                             REFGUID guid, UINT *pDataSize,
                                             void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D11Texture1D *This,
                                             REFGUID guid, UINT DataSize,
                                             const void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateDataInterface)(ID3D11Texture1D *This,
                                                      REFGUID guid,
                                                      const IUnknown *pData);
  /*** ID3D11Resource methods ***/
  void(STDMETHODCALLTYPE *GetType)(
      ID3D11Texture1D *This, D3D11_RESOURCE_DIMENSION *pResourceDimension);
...
interface ID3D11Texture1D { CONST_VTBL ID3D11Texture1DVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT ID3D11Texture1D_QueryInterface(ID3D11Texture1D *This,
                                                     REFIID riid,
                                                     void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ID3D11DeviceChild methods ***/
static inline void ID3D11Texture1D_GetDevice(ID3D11Texture1D *This,
                                             ID3D11Device **ppDevice) {
  This->lpVtbl->GetDevice(This, ppDevice);
}
static inline HRESULT ID3D11Texture1D_GetPrivateData(ID3D11Texture1D *This,
                                                     REFGUID guid,
                                                     UINT *pDataSize,
                                                     void *pData) {
  return This->lpVtbl->GetPrivateData(This, guid, pDataSize, pData);
}
static inline HRESULT ID3D11Texture1D_SetPrivateData(ID3D11Texture1D *This,
                                                     REFGUID guid,
                                                     UINT DataSize,
                                                     const void *pData) {
  return This->lpVtbl->SetPrivateData(This, guid, DataSize, pData);
...
static inline HRESULT
ID3D11Texture1D_SetPrivateDataInterface(ID3D11Texture1D *This, REFGUID guid,
                                        const IUnknown *pData) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, pData);
}
/*** ID3D11Resource methods ***/
static inline void
ID3D11Texture1D_GetType(ID3D11Texture1D *This,
                        D3D11_RESOURCE_DIMENSION *pResourceDimension) {
  This->lpVtbl->GetType(This, pResourceDimension);
}
static inline void ID3D11Texture1D_SetEvictionPriority(ID3D11Texture1D *This,
                                                       UINT EvictionPriority) {
  This->lpVtbl->SetEvictionPriority(This, EvictionPriority);
}
...
/*** ID3D11Texture1D methods ***/
static inline void ID3D11Texture1D_GetDesc(ID3D11Texture1D *This,
                                           D3D11_TEXTURE1D_DESC *pDesc) {
  This->lpVtbl->GetDesc(This, pDesc);
}
#endif
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D11Texture2D, 0x6f15aaf2, 0xd208, 0x4e89, 0x9a, 0xb4, 0x48,
                0x95, 0x35, 0xd3, 0x4f, 0x9c)
#endif
#else
typedef struct ID3D11Texture2DVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11Texture2D *This, REFIID riid,
                                             void **ppvObject);
  ...
  void(STDMETHODCALLTYPE *GetDevice)(ID3D11Texture2D *This,
                                     ID3D11Device **ppDevice);
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(ID3D11Texture2D *This,
                                             REFGUID guid, UINT *pDataSize,
                                             void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D11Texture2D *This,
                                             REFGUID guid, UINT DataSize,
                                             const void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateDataInterface)(ID3D11Texture2D *This,
                                                      REFGUID guid,
                                                      const IUnknown *pData);
  /*** ID3D11Resource methods ***/
  void(STDMETHODCALLTYPE *GetType)(
      ID3D11Texture2D *This, D3D11_RESOURCE_DIMENSION *pResourceDimension);
...
interface ID3D11Texture2D { CONST_VTBL ID3D11Texture2DVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT ID3D11Texture2D_QueryInterface(ID3D11Texture2D *This,
                                                     REFIID riid,
                                                     void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ID3D11DeviceChild methods ***/
static inline void ID3D11Texture2D_GetDevice(ID3D11Texture2D *This,
                                             ID3D11Device **ppDevice) {
  This->lpVtbl->GetDevice(This, ppDevice);
}
static inline HRESULT ID3D11Texture2D_GetPrivateData(ID3D11Texture2D *This,
                                                     REFGUID guid,
                                                     UINT *pDataSize,
                                                     void *pData) {
  return This->lpVtbl->GetPrivateData(This, guid, pDataSize, pData);
}
static inline HRESULT ID3D11Texture2D_SetPrivateData(ID3D11Texture2D *This,
                                                     REFGUID guid,
                                                     UINT DataSize,
                                                     const void *pData) {
  return This->lpVtbl->SetPrivateData(This, guid, DataSize, pData);
...
static inline HRESULT
ID3D11Texture2D_SetPrivateDataInterface(ID3D11Texture2D *This, REFGUID guid,
                                        const IUnknown *pData) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, pData);
}
/*** ID3D11Resource methods ***/
static inline void
ID3D11Texture2D_GetType(ID3D11Texture2D *This,
                        D3D11_RESOURCE_DIMENSION *pResourceDimension) {
  This->lpVtbl->GetType(This, pResourceDimension);
}
static inline void ID3D11Texture2D_SetEvictionPriority(ID3D11Texture2D *This,
                                                       UINT EvictionPriority) {
  This->lpVtbl->SetEvictionPriority(This, EvictionPriority);
}
...
/*** ID3D11Texture2D methods ***/
static inline void ID3D11Texture2D_GetDesc(ID3D11Texture2D *This,
                                           D3D11_TEXTURE2D_DESC *pDesc) {
  This->lpVtbl->GetDesc(This, pDesc);
}
#endif
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D11Texture3D, 0x037e866e, 0xf56d, 0x4357, 0xa8, 0xaf, 0x9d,
                0xab, 0xbe, 0x6e, 0x25, 0x0e)
#endif
#else
typedef struct ID3D11Texture3DVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11Texture3D *This, REFIID riid,
                                             void **ppvObject);
  ...
  void(STDMETHODCALLTYPE *GetDevice)(ID3D11Texture3D *This,
                                     ID3D11Device **ppDevice);
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(ID3D11Texture3D *This,
                                             REFGUID guid, UINT *pDataSize,
                                             void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D11Texture3D *This,
                                             REFGUID guid, UINT DataSize,
                                             const void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateDataInterface)(ID3D11Texture3D *This,
                                                      REFGUID guid,
                                                      const IUnknown *pData);
  /*** ID3D11Resource methods ***/
  void(STDMETHODCALLTYPE *GetType)(
      ID3D11Texture3D *This, D3D11_RESOURCE_DIMENSION *pResourceDimension);
...
interface ID3D11Texture3D { CONST_VTBL ID3D11Texture3DVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT ID3D11Texture3D_QueryInterface(ID3D11Texture3D *This,
                                                     REFIID riid,
                                                     void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ID3D11DeviceChild methods ***/
static inline void ID3D11Texture3D_GetDevice(ID3D11Texture3D *This,
                                             ID3D11Device **ppDevice) {
  This->lpVtbl->GetDevice(This, ppDevice);
}
static inline HRESULT ID3D11Texture3D_GetPrivateData(ID3D11Texture3D *This,
                                                     REFGUID guid,
                                                     UINT *pDataSize,
                                                     void *pData) {
  return This->lpVtbl->GetPrivateData(This, guid, pDataSize, pData);
}
static inline HRESULT ID3D11Texture3D_SetPrivateData(ID3D11Texture3D *This,
                                                     REFGUID guid,
                                                     UINT DataSize,
                                                     const void *pData) {
  return This->lpVtbl->SetPrivateData(This, guid, DataSize, pData);
...
static inline HRESULT
ID3D11Texture3D_SetPrivateDataInterface(ID3D11Texture3D *This, REFGUID guid,
                                        const IUnknown *pData) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, pData);
}
/*** ID3D11Resource methods ***/
static inline void
ID3D11Texture3D_GetType(ID3D11Texture3D *This,
                        D3D11_RESOURCE_DIMENSION *pResourceDimension) {
  This->lpVtbl->GetType(This, pResourceDimension);
}
static inline void ID3D11Texture3D_SetEvictionPriority(ID3D11Texture3D *This,
                                                       UINT EvictionPriority) {
  This->lpVtbl->SetEvictionPriority(This, EvictionPriority);
}
...
/*** ID3D11Texture3D methods ***/
static inline void ID3D11Texture3D_GetDesc(ID3D11Texture3D *This,
                                           D3D11_TEXTURE3D_DESC *pDesc) {
  This->lpVtbl->GetDesc(This, pDesc);
}
#endif
...
ID3D11UnorderedAccessView : public ID3D11View {
  virtual void STDMETHODCALLTYPE GetDesc(D3D11_UNORDERED_ACCESS_VIEW_DESC *
                                         pDesc) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D11UnorderedAccessView, 0x28acf509, 0x7f5c, 0x48f6, 0x86,
                0x11, 0xf3, 0x16, 0x01, 0x0a, 0x63, 0x80)
#endif
#else
typedef struct ID3D11UnorderedAccessViewVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11UnorderedAccessView *This,
                                             REFIID riid, void **ppvObject);
  ...
  void(STDMETHODCALLTYPE *GetDevice)(ID3D11UnorderedAccessView *This,
                                     ID3D11Device **ppDevice);
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(ID3D11UnorderedAccessView *This,
                                             REFGUID guid, UINT *pDataSize,
                                             void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D11UnorderedAccessView *This,
                                             REFGUID guid, UINT DataSize,
                                             const void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateDataInterface)(
      ID3D11UnorderedAccessView *This, REFGUID guid, const IUnknown *pData);
  /*** ID3D11View methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
ID3D11UnorderedAccessView_QueryInterface(ID3D11UnorderedAccessView *This,
                                         REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
ID3D11UnorderedAccessView_AddRef(ID3D11UnorderedAccessView *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
ID3D11UnorderedAccessView_Release(ID3D11UnorderedAccessView *This) {
  return This->lpVtbl->Release(This);
}
/*** ID3D11DeviceChild methods ***/
static inline void
ID3D11UnorderedAccessView_GetDevice(ID3D11UnorderedAccessView *This,
                                    ID3D11Device **ppDevice) {
  This->lpVtbl->GetDevice(This, ppDevice);
}
static inline HRESULT
ID3D11UnorderedAccessView_GetPrivateData(ID3D11UnorderedAccessView *This,
                                         REFGUID guid, UINT *pDataSize,
                                         void *pData) {
  return This->lpVtbl->GetPrivateData(This, guid, pDataSize, pData);
}
static inline HRESULT
ID3D11UnorderedAccessView_SetPrivateData(ID3D11UnorderedAccessView *This,
                                         REFGUID guid, UINT DataSize,
                                         const void *pData) {
  return This->lpVtbl->SetPrivateData(This, guid, DataSize, pData);
}
static inline HRESULT ID3D11UnorderedAccessView_SetPrivateDataInterface(
    ID3D11UnorderedAccessView *This, REFGUID guid, const IUnknown *pData) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, pData);
}
/*** ID3D11View methods ***/
static inline void
ID3D11UnorderedAccessView_GetResource(ID3D11UnorderedAccessView *This,
                                      ID3D11Resource **ppResource) {
  This->lpVtbl->GetResource(This, ppResource);
}
/*** ID3D11UnorderedAccessView methods ***/
static inline void
ID3D11UnorderedAccessView_GetDesc(ID3D11UnorderedAccessView *This,
                                  D3D11_UNORDERED_ACCESS_VIEW_DESC *pDesc) {
  This->lpVtbl->GetDesc(This, pDesc);
}
#endif
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D11VertexShader, 0x3b301d64, 0xd678, 0x4289, 0x88, 0x97,
                0x22, 0xf8, 0x92, 0x8b, 0x72, 0xf3)
#endif
#else
typedef struct ID3D11VertexShaderVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11VertexShader *This,
                                             REFIID riid, void **ppvObject);
  ...
  void(STDMETHODCALLTYPE *GetDevice)(ID3D11VertexShader *This,
                                     ID3D11Device **ppDevice);
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(ID3D11VertexShader *This,
                                             REFGUID guid, UINT *pDataSize,
                                             void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D11VertexShader *This,
                                             REFGUID guid, UINT DataSize,
                                             const void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateDataInterface)(ID3D11VertexShader *This,
                                                      REFGUID guid,
                                                      const IUnknown *pData);
  END_INTERFACE
} ID3D11VertexShaderVtbl;
interface ID3D11VertexShader { CONST_VTBL ID3D11VertexShaderVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
ID3D11VertexShader_QueryInterface(ID3D11VertexShader *This, REFIID riid,
                                  void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ID3D11DeviceChild methods ***/
static inline void ID3D11VertexShader_GetDevice(ID3D11VertexShader *This,
                                                ID3D11Device **ppDevice) {
  This->lpVtbl->GetDevice(This, ppDevice);
}
static inline HRESULT
ID3D11VertexShader_GetPrivateData(ID3D11VertexShader *This, REFGUID guid,
                                  UINT *pDataSize, void *pData) {
  return This->lpVtbl->GetPrivateData(This, guid, pDataSize, pData);
}
static inline HRESULT
ID3D11VertexShader_SetPrivateData(ID3D11VertexShader *This, REFGUID guid,
                                  UINT DataSize, const void *pData) {
  return This->lpVtbl->SetPrivateData(This, guid, DataSize, pData);
}
static inline HRESULT ID3D11VertexShader_SetPrivateDataInterface(
    ID3D11VertexShader *This, REFGUID guid, const IUnknown *pData) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, pData);
}
#endif
#endif
...
ID3D11DeviceContext : public ID3D11DeviceChild {
  ...
  virtual void STDMETHODCALLTYPE PSSetShader(
      ...
      ID3D11ClassInstance *const *ppClassInstances, UINT NumClassInstances) = 0;
  ...
  virtual void STDMETHODCALLTYPE DrawIndexed(
      UINT IndexCount, UINT StartIndexLocation, INT BaseVertexLocation) = 0;
  virtual void STDMETHODCALLTYPE Draw(UINT VertexCount,
                                      UINT StartVertexLocation) = 0;
  virtual HRESULT STDMETHODCALLTYPE Map(
      ID3D11Resource * pResource, UINT Subresource, D3D11_MAP MapType,
      UINT MapFlags, D3D11_MAPPED_SUBRESOURCE * pMappedResource) = 0;
  virtual void STDMETHODCALLTYPE Unmap(ID3D11Resource * pResource,
                                       UINT Subresource) = 0;
  virtual void STDMETHODCALLTYPE PSSetConstantBuffers(
      UINT StartSlot, UINT NumBuffers,
      ID3D11Buffer *const *ppConstantBuffers) = 0;
  virtual void STDMETHODCALLTYPE IASetInputLayout(ID3D11InputLayout *
                                                  pInputLayout) = 0;
  virtual void STDMETHODCALLTYPE IASetVertexBuffers(
      UINT StartSlot, UINT NumBuffers, ID3D11Buffer *const *ppVertexBuffers,
      const UINT *pStrides, const UINT *pOffsets) = 0;
  virtual void STDMETHODCALLTYPE IASetIndexBuffer(
      ID3D11Buffer * pIndexBuffer, DXGI_FORMAT Format, UINT Offset) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetData(ID3D11Asynchronous * pAsync,
                                            void *pData, UINT DataSize,
                                            UINT GetDataFlags) = 0;
  virtual void STDMETHODCALLTYPE SetPredication(ID3D11Predicate * pPredicate,
  ...
  virtual void STDMETHODCALLTYPE OMSetBlendState(ID3D11BlendState * pBlendState,
                                                 const FLOAT BlendFactor[4],
                                                 UINT SampleMask) = 0;
  virtual void STDMETHODCALLTYPE OMSetDepthStencilState(
      ID3D11DepthStencilState * pDepthStencilState, UINT StencilRef) = 0;
  virtual void STDMETHODCALLTYPE SOSetTargets(UINT NumBuffers,
                                              ID3D11Buffer *const *ppSOTargets,
                                              const UINT *pOffsets) = 0;
  virtual void STDMETHODCALLTYPE DrawAuto() = 0;
  virtual void STDMETHODCALLTYPE DrawIndexedInstancedIndirect(
      ID3D11Buffer * pBufferForArgs, UINT AlignedByteOffsetForArgs) = 0;
  virtual void STDMETHODCALLTYPE DrawInstancedIndirect(
      ID3D11Buffer * pBufferForArgs, UINT AlignedByteOffsetForArgs) = 0;
  virtual void STDMETHODCALLTYPE Dispatch(UINT ThreadGroupCountX,
                                          UINT ThreadGroupCountY,
                                          UINT ThreadGroupCountZ) = 0;
  virtual void STDMETHODCALLTYPE DispatchIndirect(
      ID3D11Buffer * pBufferForArgs, UINT AlignedByteOffsetForArgs) = 0;
  virtual void STDMETHODCALLTYPE RSSetState(ID3D11RasterizerState *
                                            pRasterizerState) = 0;
  virtual void STDMETHODCALLTYPE RSSetViewports(
      UINT NumViewports, const D3D11_VIEWPORT *pViewports) = 0;
  virtual void STDMETHODCALLTYPE RSSetScissorRects(
      UINT NumRects, const D3D11_RECT *pRects) = 0;
  ...
  virtual void STDMETHODCALLTYPE CopyResource(
      ID3D11Resource * pDstResource, ID3D11Resource * pSrcResource) = 0;
  ...
  virtual void STDMETHODCALLTYPE ClearRenderTargetView(
      ID3D11RenderTargetView * pRenderTargetView, const FLOAT ColorRGBA[4]) = 0;
  ...
  virtual void STDMETHODCALLTYPE ClearDepthStencilView(
      ...
      UINT8 Stencil) = 0;
  virtual void STDMETHODCALLTYPE GenerateMips(ID3D11ShaderResourceView *
                                              pShaderResourceView) = 0;
  virtual void STDMETHODCALLTYPE SetResourceMinLOD(ID3D11Resource * pResource,
                                                   FLOAT MinLOD) = 0;
  virtual FLOAT STDMETHODCALLTYPE GetResourceMinLOD(ID3D11Resource *
                                                    pResource) = 0;
  ...
  virtual void STDMETHODCALLTYPE ExecuteCommandList(
      ID3D11CommandList * pCommandList, WINBOOL RestoreContextState) = 0;
  ...
  virtual void STDMETHODCALLTYPE VSGetConstantBuffers(
      UINT StartSlot, UINT NumBuffers, ID3D11Buffer * *ppConstantBuffers) = 0;
  ...
  virtual void STDMETHODCALLTYPE PSGetSamplers(
      UINT StartSlot, UINT NumSamplers, ID3D11SamplerState * *ppSamplers) = 0;
  virtual void STDMETHODCALLTYPE VSGetShader(
      ID3D11VertexShader * *ppVertexShader,
      ID3D11ClassInstance * *ppClassInstances, UINT * pNumClassInstances) = 0;
  virtual void STDMETHODCALLTYPE PSGetConstantBuffers(
      UINT StartSlot, UINT NumBuffers, ID3D11Buffer * *ppConstantBuffers) = 0;
  virtual void STDMETHODCALLTYPE IAGetInputLayout(ID3D11InputLayout *
                                                  *ppInputLayout) = 0;
  ...
  virtual void STDMETHODCALLTYPE VSGetSamplers(
      UINT StartSlot, UINT NumSamplers, ID3D11SamplerState * *ppSamplers) = 0;
  virtual void STDMETHODCALLTYPE GetPredication(ID3D11Predicate * *ppPredicate,
  ...
  virtual void STDMETHODCALLTYPE OMGetRenderTargetsAndUnorderedAccessViews(
      ...
      UINT NumUAVs, ID3D11UnorderedAccessView * *ppUnorderedAccessViews) = 0;
  virtual void STDMETHODCALLTYPE OMGetBlendState(
      ID3D11BlendState * *ppBlendState, FLOAT BlendFactor[4],
      UINT * pSampleMask) = 0;
  virtual void STDMETHODCALLTYPE OMGetDepthStencilState(
      ID3D11DepthStencilState * *ppDepthStencilState, UINT * pStencilRef) = 0;
  virtual void STDMETHODCALLTYPE SOGetTargets(UINT NumBuffers,
                                              ID3D11Buffer * *ppSOTargets) = 0;
  virtual void STDMETHODCALLTYPE RSGetState(ID3D11RasterizerState *
                                            *ppRasterizerState) = 0;
  virtual void STDMETHODCALLTYPE RSGetViewports(
      UINT * pNumViewports, D3D11_VIEWPORT * pViewports) = 0;
  virtual void STDMETHODCALLTYPE RSGetScissorRects(UINT * pNumRects,
                                                   D3D11_RECT * pRects) = 0;
  ...
  virtual D3D11_DEVICE_CONTEXT_TYPE STDMETHODCALLTYPE GetType() = 0;
  virtual UINT STDMETHODCALLTYPE GetContextFlags() = 0;
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D11DeviceContext, 0xc0bfa96c, 0xe089, 0x44fb, 0x8e, 0xaf,
                0x26, 0xf8, 0x79, 0x61, 0x90, 0xda)
#endif
#else
typedef struct ID3D11DeviceContextVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11DeviceContext *This,
                                             REFIID riid, void **ppvObject);
  ...
  void(STDMETHODCALLTYPE *VSSetConstantBuffers)(
      ID3D11DeviceContext *This, UINT StartSlot, UINT NumBuffers,
      ID3D11Buffer *const *ppConstantBuffers);
  void(STDMETHODCALLTYPE *PSSetShaderResources)(
      ID3D11DeviceContext *This, UINT StartSlot, UINT NumViews,
      ID3D11ShaderResourceView *const *ppShaderResourceViews);
  void(STDMETHODCALLTYPE *PSSetShader)(
      ID3D11DeviceContext *This, ID3D11PixelShader *pPixelShader,
  ...
  void(STDMETHODCALLTYPE *VSSetShader)(
      ID3D11DeviceContext *This, ID3D11VertexShader *pVertexShader,
      ID3D11ClassInstance *const *ppClassInstances, UINT NumClassInstances);
  void(STDMETHODCALLTYPE *DrawIndexed)(ID3D11DeviceContext *This,
                                       UINT IndexCount, UINT StartIndexLocation,
                                       INT BaseVertexLocation);
  void(STDMETHODCALLTYPE *Draw)(ID3D11DeviceContext *This, UINT VertexCount,
                                UINT StartVertexLocation);
  ...
  void(STDMETHODCALLTYPE *GSSetShader)(
      ID3D11DeviceContext *This, ID3D11GeometryShader *pShader,
      ID3D11ClassInstance *const *ppClassInstances, UINT NumClassInstances);
  void(STDMETHODCALLTYPE *IASetPrimitiveTopology)(
      ID3D11DeviceContext *This, D3D11_PRIMITIVE_TOPOLOGY Topology);
  ...
  HRESULT(STDMETHODCALLTYPE *GetData)(ID3D11DeviceContext *This,
                                      ID3D11Asynchronous *pAsync, void *pData,
  ...
  void(STDMETHODCALLTYPE *OMSetRenderTargetsAndUnorderedAccessViews)(
      ID3D11DeviceContext *This, UINT NumRTVs,
      ID3D11RenderTargetView *const *ppRenderTargetViews,
      ID3D11DepthStencilView *pDepthStencilView, UINT UAVStartSlot,
      UINT NumUAVs, ID3D11UnorderedAccessView *const *ppUnorderedAccessViews,
  ...
  void(STDMETHODCALLTYPE *OMSetDepthStencilState)(
      ID3D11DeviceContext *This, ID3D11DepthStencilState *pDepthStencilState,
      UINT StencilRef);
  ...
  void(STDMETHODCALLTYPE *DrawIndexedInstancedIndirect)(
      ID3D11DeviceContext *This, ID3D11Buffer *pBufferForArgs,
  ...
  void(STDMETHODCALLTYPE *CopyStructureCount)(
      ID3D11DeviceContext *This, ID3D11Buffer *pDstBuffer,
      UINT DstAlignedByteOffset, ID3D11UnorderedAccessView *pSrcView);
  void(STDMETHODCALLTYPE *ClearRenderTargetView)(
      ID3D11DeviceContext *This, ID3D11RenderTargetView *pRenderTargetView,
  ...
  void(STDMETHODCALLTYPE *ClearDepthStencilView)(
      ID3D11DeviceContext *This, ID3D11DepthStencilView *pDepthStencilView,
      UINT ClearFlags, FLOAT Depth, UINT8 Stencil);
  void(STDMETHODCALLTYPE *GenerateMips)(
      ID3D11DeviceContext *This, ID3D11ShaderResourceView *pShaderResourceView);
  ...
  void(STDMETHODCALLTYPE *HSSetShader)(
      ID3D11DeviceContext *This, ID3D11HullShader *pHullShader,
      ID3D11ClassInstance *const *ppClassInstances, UINT NumClassInstances);
  ...
  void(STDMETHODCALLTYPE *CSSetUnorderedAccessViews)(
      ID3D11DeviceContext *This, UINT StartSlot, UINT NumUAVs,
      ID3D11UnorderedAccessView *const *ppUnorderedAccessViews,
      const UINT *pUAVInitialCounts);
  void(STDMETHODCALLTYPE *CSSetShader)(
      ID3D11DeviceContext *This, ID3D11ComputeShader *pComputeShader,
      ID3D11ClassInstance *const *ppClassInstances, UINT NumClassInstances);
  ...
  void(STDMETHODCALLTYPE *IAGetPrimitiveTopology)(
      ID3D11DeviceContext *This, D3D11_PRIMITIVE_TOPOLOGY *pTopology);
  ...
  void(STDMETHODCALLTYPE *OMGetDepthStencilState)(
      ID3D11DeviceContext *This, ID3D11DepthStencilState **ppDepthStencilState,
      UINT *pStencilRef);
  void(STDMETHODCALLTYPE *SOGetTargets)(ID3D11DeviceContext *This,
                                        UINT NumBuffers,
                                        ID3D11Buffer **ppSOTargets);
  void(STDMETHODCALLTYPE *RSGetState)(
      ID3D11DeviceContext *This, ID3D11RasterizerState **ppRasterizerState);
  ...
  HRESULT(STDMETHODCALLTYPE *FinishCommandList)(
      ID3D11DeviceContext *This, WINBOOL RestoreDeferredContextState,
      ID3D11CommandList **ppCommandList);
  END_INTERFACE
} ID3D11DeviceContextVtbl;
interface ID3D11DeviceContext { CONST_VTBL ID3D11DeviceContextVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
ID3D11DeviceContext_QueryInterface(ID3D11DeviceContext *This, REFIID riid,
                                   void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ID3D11DeviceChild methods ***/
static inline void ID3D11DeviceContext_GetDevice(ID3D11DeviceContext *This,
                                                 ID3D11Device **ppDevice) {
  This->lpVtbl->GetDevice(This, ppDevice);
}
static inline HRESULT
ID3D11DeviceContext_GetPrivateData(ID3D11DeviceContext *This, REFGUID guid,
                                   UINT *pDataSize, void *pData) {
  return This->lpVtbl->GetPrivateData(This, guid, pDataSize, pData);
}
static inline HRESULT
ID3D11DeviceContext_SetPrivateData(ID3D11DeviceContext *This, REFGUID guid,
                                   UINT DataSize, const void *pData) {
  return This->lpVtbl->SetPrivateData(This, guid, DataSize, pData);
}
static inline HRESULT ID3D11DeviceContext_SetPrivateDataInterface(
    ID3D11DeviceContext *This, REFGUID guid, const IUnknown *pData) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, pData);
}
/*** ID3D11DeviceContext methods ***/
static inline void ID3D11DeviceContext_VSSetConstantBuffers(
    ID3D11DeviceContext *This, UINT StartSlot, UINT NumBuffers,
    ID3D11Buffer *const *ppConstantBuffers) {
  This->lpVtbl->VSSetConstantBuffers(This, StartSlot, NumBuffers,
                                     ppConstantBuffers);
}
static inline void ID3D11DeviceContext_PSSetShaderResources(
    ID3D11DeviceContext *This, UINT StartSlot, UINT NumViews,
    ID3D11ShaderResourceView *const *ppShaderResourceViews) {
  This->lpVtbl->PSSetShaderResources(This, StartSlot, NumViews,
                                     ppShaderResourceViews);
}
static inline void ID3D11DeviceContext_PSSetShader(
    ID3D11DeviceContext *This, ID3D11PixelShader *pPixelShader,
    ID3D11ClassInstance *const *ppClassInstances, UINT NumClassInstances) {
  This->lpVtbl->PSSetShader(This, pPixelShader, ppClassInstances,
                            NumClassInstances);
...
static inline void
ID3D11DeviceContext_PSSetSamplers(ID3D11DeviceContext *This, UINT StartSlot,
                                  UINT NumSamplers,
                                  ID3D11SamplerState *const *ppSamplers) {
  This->lpVtbl->PSSetSamplers(This, StartSlot, NumSamplers, ppSamplers);
}
static inline void ID3D11DeviceContext_VSSetShader(
    ID3D11DeviceContext *This, ID3D11VertexShader *pVertexShader,
    ID3D11ClassInstance *const *ppClassInstances, UINT NumClassInstances) {
  This->lpVtbl->VSSetShader(This, pVertexShader, ppClassInstances,
                            NumClassInstances);
}
static inline void ID3D11DeviceContext_DrawIndexed(ID3D11DeviceContext *This,
                                                   UINT IndexCount,
                                                   UINT StartIndexLocation,
                                                   INT BaseVertexLocation) {
  This->lpVtbl->DrawIndexed(This, IndexCount, StartIndexLocation,
...
static inline void ID3D11DeviceContext_Draw(ID3D11DeviceContext *This,
                                            UINT VertexCount,
                                            UINT StartVertexLocation) {
  This->lpVtbl->Draw(This, VertexCount, StartVertexLocation);
}
static inline HRESULT
ID3D11DeviceContext_Map(ID3D11DeviceContext *This, ID3D11Resource *pResource,
                        UINT Subresource, D3D11_MAP MapType, UINT MapFlags,
                        D3D11_MAPPED_SUBRESOURCE *pMappedResource) {
  return This->lpVtbl->Map(This, pResource, Subresource, MapType, MapFlags,
                           pMappedResource);
}
static inline void ID3D11DeviceContext_Unmap(ID3D11DeviceContext *This,
                                             ID3D11Resource *pResource,
                                             UINT Subresource) {
  This->lpVtbl->Unmap(This, pResource, Subresource);
}
static inline void ID3D11DeviceContext_PSSetConstantBuffers(
    ID3D11DeviceContext *This, UINT StartSlot, UINT NumBuffers,
    ID3D11Buffer *const *ppConstantBuffers) {
  This->lpVtbl->PSSetConstantBuffers(This, StartSlot, NumBuffers,
                                     ppConstantBuffers);
...
static inline void
ID3D11DeviceContext_IASetInputLayout(ID3D11DeviceContext *This,
                                     ID3D11InputLayout *pInputLayout) {
  This->lpVtbl->IASetInputLayout(This, pInputLayout);
}
static inline void ID3D11DeviceContext_IASetVertexBuffers(
    ...
    ID3D11Buffer *const *ppVertexBuffers, const UINT *pStrides,
    const UINT *pOffsets) {
  This->lpVtbl->IASetVertexBuffers(This, StartSlot, NumBuffers, ppVertexBuffers,
                                   pStrides, pOffsets);
}
static inline void
ID3D11DeviceContext_IASetIndexBuffer(ID3D11DeviceContext *This,
                                     ID3D11Buffer *pIndexBuffer,
                                     DXGI_FORMAT Format, UINT Offset) {
  This->lpVtbl->IASetIndexBuffer(This, pIndexBuffer, Format, Offset);
}
static inline void ID3D11DeviceContext_DrawIndexedInstanced(
    ID3D11DeviceContext *This, UINT IndexCountPerInstance, UINT InstanceCount,
    UINT StartIndexLocation, INT BaseVertexLocation,
    UINT StartInstanceLocation) {
  This->lpVtbl->DrawIndexedInstanced(This, IndexCountPerInstance, InstanceCount,
                                     StartIndexLocation, BaseVertexLocation,
                                     StartInstanceLocation);
}
static inline void ID3D11DeviceContext_DrawInstanced(
    ID3D11DeviceContext *This, UINT VertexCountPerInstance, UINT InstanceCount,
    UINT StartVertexLocation, UINT StartInstanceLocation) {
  This->lpVtbl->DrawInstanced(This, VertexCountPerInstance, InstanceCount,
                              StartVertexLocation, StartInstanceLocation);
}
static inline void ID3D11DeviceContext_GSSetConstantBuffers(
    ID3D11DeviceContext *This, UINT StartSlot, UINT NumBuffers,
    ID3D11Buffer *const *ppConstantBuffers) {
  This->lpVtbl->GSSetConstantBuffers(This, StartSlot, NumBuffers,
                                     ppConstantBuffers);
}
static inline void ID3D11DeviceContext_GSSetShader(
    ID3D11DeviceContext *This, ID3D11GeometryShader *pShader,
    ID3D11ClassInstance *const *ppClassInstances, UINT NumClassInstances) {
  This->lpVtbl->GSSetShader(This, pShader, ppClassInstances, NumClassInstances);
}
static inline void
ID3D11DeviceContext_IASetPrimitiveTopology(ID3D11DeviceContext *This,
                                           D3D11_PRIMITIVE_TOPOLOGY Topology) {
  This->lpVtbl->IASetPrimitiveTopology(This, Topology);
}
static inline void ID3D11DeviceContext_VSSetShaderResources(
    ID3D11DeviceContext *This, UINT StartSlot, UINT NumViews,
    ID3D11ShaderResourceView *const *ppShaderResourceViews) {
  This->lpVtbl->VSSetShaderResources(This, StartSlot, NumViews,
                                     ppShaderResourceViews);
...
static inline void
ID3D11DeviceContext_VSSetSamplers(ID3D11DeviceContext *This, UINT StartSlot,
                                  UINT NumSamplers,
                                  ID3D11SamplerState *const *ppSamplers) {
  This->lpVtbl->VSSetSamplers(This, StartSlot, NumSamplers, ppSamplers);
}
static inline void ID3D11DeviceContext_Begin(ID3D11DeviceContext *This,
                                             ID3D11Asynchronous *pAsync) {
  This->lpVtbl->Begin(This, pAsync);
}
static inline void ID3D11DeviceContext_End(ID3D11DeviceContext *This,
                                           ID3D11Asynchronous *pAsync) {
  This->lpVtbl->End(This, pAsync);
}
static inline HRESULT ID3D11DeviceContext_GetData(ID3D11DeviceContext *This,
                                                  ID3D11Asynchronous *pAsync,
                                                  void *pData, UINT DataSize,
                                                  UINT GetDataFlags) {
...
static inline void
ID3D11DeviceContext_SetPredication(ID3D11DeviceContext *This,
                                   ID3D11Predicate *pPredicate,
                                   WINBOOL PredicateValue) {
  This->lpVtbl->SetPredication(This, pPredicate, PredicateValue);
}
static inline void ID3D11DeviceContext_GSSetShaderResources(
    ID3D11DeviceContext *This, UINT StartSlot, UINT NumViews,
    ID3D11ShaderResourceView *const *ppShaderResourceViews) {
  This->lpVtbl->GSSetShaderResources(This, StartSlot, NumViews,
                                     ppShaderResourceViews);
...
static inline void
ID3D11DeviceContext_GSSetSamplers(ID3D11DeviceContext *This, UINT StartSlot,
                                  UINT NumSamplers,
                                  ID3D11SamplerState *const *ppSamplers) {
  This->lpVtbl->GSSetSamplers(This, StartSlot, NumSamplers, ppSamplers);
}
static inline void ID3D11DeviceContext_OMSetRenderTargets(
    ID3D11DeviceContext *This, UINT NumViews,
    ID3D11RenderTargetView *const *ppRenderTargetViews,
    ID3D11DepthStencilView *pDepthStencilView) {
  This->lpVtbl->OMSetRenderTargets(This, NumViews, ppRenderTargetViews,
...
static inline void ID3D11DeviceContext_OMSetBlendState(
    ID3D11DeviceContext *This, ID3D11BlendState *pBlendState,
    const FLOAT BlendFactor[4], UINT SampleMask) {
  This->lpVtbl->OMSetBlendState(This, pBlendState, BlendFactor, SampleMask);
}
static inline void ID3D11DeviceContext_OMSetDepthStencilState(
    ID3D11DeviceContext *This, ID3D11DepthStencilState *pDepthStencilState,
    UINT StencilRef) {
  This->lpVtbl->OMSetDepthStencilState(This, pDepthStencilState, StencilRef);
}
static inline void
ID3D11DeviceContext_SOSetTargets(ID3D11DeviceContext *This, UINT NumBuffers,
                                 ID3D11Buffer *const *ppSOTargets,
                                 const UINT *pOffsets) {
  This->lpVtbl->SOSetTargets(This, NumBuffers, ppSOTargets, pOffsets);
}
...
static inline void ID3D11DeviceContext_DrawIndexedInstancedIndirect(
    ID3D11DeviceContext *This, ID3D11Buffer *pBufferForArgs,
    UINT AlignedByteOffsetForArgs) {
  This->lpVtbl->DrawIndexedInstancedIndirect(This, pBufferForArgs,
                                             AlignedByteOffsetForArgs);
...
static inline void
ID3D11DeviceContext_DrawInstancedIndirect(ID3D11DeviceContext *This,
                                          ID3D11Buffer *pBufferForArgs,
                                          UINT AlignedByteOffsetForArgs) {
  This->lpVtbl->DrawInstancedIndirect(This, pBufferForArgs,
                                      AlignedByteOffsetForArgs);
}
static inline void ID3D11DeviceContext_Dispatch(ID3D11DeviceContext *This,
                                                UINT ThreadGroupCountX,
                                                UINT ThreadGroupCountY,
                                                UINT ThreadGroupCountZ) {
  This->lpVtbl->Dispatch(This, ThreadGroupCountX, ThreadGroupCountY,
...
static inline void
ID3D11DeviceContext_DispatchIndirect(ID3D11DeviceContext *This,
                                     ID3D11Buffer *pBufferForArgs,
                                     UINT AlignedByteOffsetForArgs) {
  This->lpVtbl->DispatchIndirect(This, pBufferForArgs,
                                 AlignedByteOffsetForArgs);
...
static inline void
ID3D11DeviceContext_RSSetState(ID3D11DeviceContext *This,
                               ID3D11RasterizerState *pRasterizerState) {
  This->lpVtbl->RSSetState(This, pRasterizerState);
}
static inline void
ID3D11DeviceContext_RSSetViewports(ID3D11DeviceContext *This, UINT NumViewports,
                                   const D3D11_VIEWPORT *pViewports) {
  This->lpVtbl->RSSetViewports(This, NumViewports, pViewports);
}
static inline void
ID3D11DeviceContext_RSSetScissorRects(ID3D11DeviceContext *This, UINT NumRects,
                                      const D3D11_RECT *pRects) {
  This->lpVtbl->RSSetScissorRects(This, NumRects, pRects);
}
static inline void ID3D11DeviceContext_CopySubresourceRegion(
    ID3D11DeviceContext *This, ID3D11Resource *pDstResource,
    UINT DstSubresource, UINT DstX, UINT DstY, UINT DstZ,
    ID3D11Resource *pSrcResource, UINT SrcSubresource,
    const D3D11_BOX *pSrcBox) {
  This->lpVtbl->CopySubresourceRegion(This, pDstResource, DstSubresource, DstX,
                                      DstY, DstZ, pSrcResource, SrcSubresource,
                                      pSrcBox);
}
static inline void
ID3D11DeviceContext_CopyResource(ID3D11DeviceContext *This,
                                 ID3D11Resource *pDstResource,
                                 ID3D11Resource *pSrcResource) {
  This->lpVtbl->CopyResource(This, pDstResource, pSrcResource);
}
static inline void ID3D11DeviceContext_UpdateSubresource(
    ID3D11DeviceContext *This, ID3D11Resource *pDstResource,
    UINT DstSubresource, const D3D11_BOX *pDstBox, const void *pSrcData,
    UINT SrcRowPitch, UINT SrcDepthPitch) {
  This->lpVtbl->UpdateSubresource(This, pDstResource, DstSubresource, pDstBox,
                                  pSrcData, SrcRowPitch, SrcDepthPitch);
}
static inline void ID3D11DeviceContext_CopyStructureCount(
    ID3D11DeviceContext *This, ID3D11Buffer *pDstBuffer,
    UINT DstAlignedByteOffset, ID3D11UnorderedAccessView *pSrcView) {
  This->lpVtbl->CopyStructureCount(This, pDstBuffer, DstAlignedByteOffset,
                                   pSrcView);
}
static inline void ID3D11DeviceContext_ClearRenderTargetView(
    ID3D11DeviceContext *This, ID3D11RenderTargetView *pRenderTargetView,
    const FLOAT ColorRGBA[4]) {
  This->lpVtbl->ClearRenderTargetView(This, pRenderTargetView, ColorRGBA);
}
static inline void ID3D11DeviceContext_ClearUnorderedAccessViewUint(
    ID3D11DeviceContext *This, ID3D11UnorderedAccessView *pUnorderedAccessView,
    const UINT Values[4]) {
  This->lpVtbl->ClearUnorderedAccessViewUint(This, pUnorderedAccessView,
                                             Values);
}
static inline void ID3D11DeviceContext_ClearUnorderedAccessViewFloat(
    ID3D11DeviceContext *This, ID3D11UnorderedAccessView *pUnorderedAccessView,
    const FLOAT Values[4]) {
  This->lpVtbl->ClearUnorderedAccessViewFloat(This, pUnorderedAccessView,
                                              Values);
}
static inline void ID3D11DeviceContext_ClearDepthStencilView(
    ID3D11DeviceContext *This, ID3D11DepthStencilView *pDepthStencilView,
    UINT ClearFlags, FLOAT Depth, UINT8 Stencil) {
  This->lpVtbl->ClearDepthStencilView(This, pDepthStencilView, ClearFlags,
                                      Depth, Stencil);
}
static inline void ID3D11DeviceContext_GenerateMips(
    ID3D11DeviceContext *This, ID3D11ShaderResourceView *pShaderResourceView) {
  This->lpVtbl->GenerateMips(This, pShaderResourceView);
}
static inline void
ID3D11DeviceContext_SetResourceMinLOD(ID3D11DeviceContext *This,
                                      ID3D11Resource *pResource, FLOAT MinLOD) {
  This->lpVtbl->SetResourceMinLOD(This, pResource, MinLOD);
}
static inline FLOAT
ID3D11DeviceContext_GetResourceMinLOD(ID3D11DeviceContext *This,
                                      ID3D11Resource *pResource) {
  return This->lpVtbl->GetResourceMinLOD(This, pResource);
}
static inline void ID3D11DeviceContext_ResolveSubresource(
    ID3D11DeviceContext *This, ID3D11Resource *pDstResource,
...
static inline void
ID3D11DeviceContext_ExecuteCommandList(ID3D11DeviceContext *This,
                                       ID3D11CommandList *pCommandList,
                                       WINBOOL RestoreContextState) {
  This->lpVtbl->ExecuteCommandList(This, pCommandList, RestoreContextState);
}
static inline void ID3D11DeviceContext_HSSetShaderResources(
    ID3D11DeviceContext *This, UINT StartSlot, UINT NumViews,
    ID3D11ShaderResourceView *const *ppShaderResourceViews) {
  This->lpVtbl->HSSetShaderResources(This, StartSlot, NumViews,
                                     ppShaderResourceViews);
}
static inline void ID3D11DeviceContext_HSSetShader(
    ID3D11DeviceContext *This, ID3D11HullShader *pHullShader,
    ID3D11ClassInstance *const *ppClassInstances, UINT NumClassInstances) {
  This->lpVtbl->HSSetShader(This, pHullShader, ppClassInstances,
                            NumClassInstances);
...
static inline void
ID3D11DeviceContext_HSSetSamplers(ID3D11DeviceContext *This, UINT StartSlot,
                                  UINT NumSamplers,
                                  ID3D11SamplerState *const *ppSamplers) {
  This->lpVtbl->HSSetSamplers(This, StartSlot, NumSamplers, ppSamplers);
}
static inline void ID3D11DeviceContext_HSSetConstantBuffers(
    ID3D11DeviceContext *This, UINT StartSlot, UINT NumBuffers,
    ID3D11Buffer *const *ppConstantBuffers) {
  This->lpVtbl->HSSetConstantBuffers(This, StartSlot, NumBuffers,
                                     ppConstantBuffers);
}
static inline void ID3D11DeviceContext_DSSetShaderResources(
    ID3D11DeviceContext *This, UINT StartSlot, UINT NumViews,
    ID3D11ShaderResourceView *const *ppShaderResourceViews) {
  This->lpVtbl->DSSetShaderResources(This, StartSlot, NumViews,
                                     ppShaderResourceViews);
}
static inline void ID3D11DeviceContext_DSSetShader(
    ID3D11DeviceContext *This, ID3D11DomainShader *pDomainShader,
    ID3D11ClassInstance *const *ppClassInstances, UINT NumClassInstances) {
  This->lpVtbl->DSSetShader(This, pDomainShader, ppClassInstances,
                            NumClassInstances);
...
static inline void
ID3D11DeviceContext_DSSetSamplers(ID3D11DeviceContext *This, UINT StartSlot,
                                  UINT NumSamplers,
                                  ID3D11SamplerState *const *ppSamplers) {
  This->lpVtbl->DSSetSamplers(This, StartSlot, NumSamplers, ppSamplers);
}
static inline void ID3D11DeviceContext_DSSetConstantBuffers(
    ID3D11DeviceContext *This, UINT StartSlot, UINT NumBuffers,
    ID3D11Buffer *const *ppConstantBuffers) {
  This->lpVtbl->DSSetConstantBuffers(This, StartSlot, NumBuffers,
                                     ppConstantBuffers);
}
static inline void ID3D11DeviceContext_CSSetShaderResources(
    ID3D11DeviceContext *This, UINT StartSlot, UINT NumViews,
    ID3D11ShaderResourceView *const *ppShaderResourceViews) {
  This->lpVtbl->CSSetShaderResources(This, StartSlot, NumViews,
                                     ppShaderResourceViews);
}
static inline void ID3D11DeviceContext_CSSetUnorderedAccessViews(
    ID3D11DeviceContext *This, UINT StartSlot, UINT NumUAVs,
    ID3D11UnorderedAccessView *const *ppUnorderedAccessViews,
    const UINT *pUAVInitialCounts) {
  This->lpVtbl->CSSetUnorderedAccessViews(
...
static inline void ID3D11DeviceContext_CSSetShader(
    ID3D11DeviceContext *This, ID3D11ComputeShader *pComputeShader,
    ID3D11ClassInstance *const *ppClassInstances, UINT NumClassInstances) {
  This->lpVtbl->CSSetShader(This, pComputeShader, ppClassInstances,
                            NumClassInstances);
...
static inline void
ID3D11DeviceContext_CSSetSamplers(ID3D11DeviceContext *This, UINT StartSlot,
                                  UINT NumSamplers,
                                  ID3D11SamplerState *const *ppSamplers) {
  This->lpVtbl->CSSetSamplers(This, StartSlot, NumSamplers, ppSamplers);
}
static inline void ID3D11DeviceContext_CSSetConstantBuffers(
    ID3D11DeviceContext *This, UINT StartSlot, UINT NumBuffers,
    ID3D11Buffer *const *ppConstantBuffers) {
  This->lpVtbl->CSSetConstantBuffers(This, StartSlot, NumBuffers,
                                     ppConstantBuffers);
...
static inline void
ID3D11DeviceContext_VSGetConstantBuffers(ID3D11DeviceContext *This,
                                         UINT StartSlot, UINT NumBuffers,
                                         ID3D11Buffer **ppConstantBuffers) {
  This->lpVtbl->VSGetConstantBuffers(This, StartSlot, NumBuffers,
                                     ppConstantBuffers);
}
static inline void ID3D11DeviceContext_PSGetShaderResources(
    ID3D11DeviceContext *This, UINT StartSlot, UINT NumViews,
    ID3D11ShaderResourceView **ppShaderResourceViews) {
  This->lpVtbl->PSGetShaderResources(This, StartSlot, NumViews,
                                     ppShaderResourceViews);
}
static inline void ID3D11DeviceContext_PSGetShader(
    ID3D11DeviceContext *This, ID3D11PixelShader **ppPixelShader,
    ID3D11ClassInstance **ppClassInstances, UINT *pNumClassInstances) {
  This->lpVtbl->PSGetShader(This, ppPixelShader, ppClassInstances,
                            pNumClassInstances);
}
static inline void
ID3D11DeviceContext_PSGetSamplers(ID3D11DeviceContext *This, UINT StartSlot,
                                  UINT NumSamplers,
                                  ID3D11SamplerState **ppSamplers) {
  This->lpVtbl->PSGetSamplers(This, StartSlot, NumSamplers, ppSamplers);
}
static inline void ID3D11DeviceContext_VSGetShader(
    ID3D11DeviceContext *This, ID3D11VertexShader **ppVertexShader,
    ID3D11ClassInstance **ppClassInstances, UINT *pNumClassInstances) {
  This->lpVtbl->VSGetShader(This, ppVertexShader, ppClassInstances,
                            pNumClassInstances);
}
static inline void
ID3D11DeviceContext_PSGetConstantBuffers(ID3D11DeviceContext *This,
                                         UINT StartSlot, UINT NumBuffers,
                                         ID3D11Buffer **ppConstantBuffers) {
  This->lpVtbl->PSGetConstantBuffers(This, StartSlot, NumBuffers,
                                     ppConstantBuffers);
...
static inline void
ID3D11DeviceContext_IAGetInputLayout(ID3D11DeviceContext *This,
                                     ID3D11InputLayout **ppInputLayout) {
  This->lpVtbl->IAGetInputLayout(This, ppInputLayout);
}
static inline void ID3D11DeviceContext_IAGetVertexBuffers(
    ID3D11DeviceContext *This, UINT StartSlot, UINT NumBuffers,
    ID3D11Buffer **ppVertexBuffers, UINT *pStrides, UINT *pOffsets) {
  This->lpVtbl->IAGetVertexBuffers(This, StartSlot, NumBuffers, ppVertexBuffers,
                                   pStrides, pOffsets);
}
static inline void
ID3D11DeviceContext_IAGetIndexBuffer(ID3D11DeviceContext *This,
                                     ID3D11Buffer **pIndexBuffer,
                                     DXGI_FORMAT *Format, UINT *Offset) {
  This->lpVtbl->IAGetIndexBuffer(This, pIndexBuffer, Format, Offset);
}
static inline void
ID3D11DeviceContext_GSGetConstantBuffers(ID3D11DeviceContext *This,
                                         UINT StartSlot, UINT NumBuffers,
                                         ID3D11Buffer **ppConstantBuffers) {
  This->lpVtbl->GSGetConstantBuffers(This, StartSlot, NumBuffers,
                                     ppConstantBuffers);
}
static inline void ID3D11DeviceContext_GSGetShader(
    ID3D11DeviceContext *This, ID3D11GeometryShader **ppGeometryShader,
    ID3D11ClassInstance **ppClassInstances, UINT *pNumClassInstances) {
  This->lpVtbl->GSGetShader(This, ppGeometryShader, ppClassInstances,
                            pNumClassInstances);
}
static inline void ID3D11DeviceContext_IAGetPrimitiveTopology(
    ID3D11DeviceContext *This, D3D11_PRIMITIVE_TOPOLOGY *pTopology) {
  This->lpVtbl->IAGetPrimitiveTopology(This, pTopology);
}
static inline void ID3D11DeviceContext_VSGetShaderResources(
    ID3D11DeviceContext *This, UINT StartSlot, UINT NumViews,
    ID3D11ShaderResourceView **ppShaderResourceViews) {
  This->lpVtbl->VSGetShaderResources(This, StartSlot, NumViews,
                                     ppShaderResourceViews);
...
static inline void
ID3D11DeviceContext_VSGetSamplers(ID3D11DeviceContext *This, UINT StartSlot,
                                  UINT NumSamplers,
                                  ID3D11SamplerState **ppSamplers) {
  This->lpVtbl->VSGetSamplers(This, StartSlot, NumSamplers, ppSamplers);
}
static inline void
ID3D11DeviceContext_GetPredication(ID3D11DeviceContext *This,
                                   ID3D11Predicate **ppPredicate,
                                   WINBOOL *pPredicateValue) {
  This->lpVtbl->GetPredication(This, ppPredicate, pPredicateValue);
}
static inline void ID3D11DeviceContext_GSGetShaderResources(
    ID3D11DeviceContext *This, UINT StartSlot, UINT NumViews,
    ID3D11ShaderResourceView **ppShaderResourceViews) {
  This->lpVtbl->GSGetShaderResources(This, StartSlot, NumViews,
                                     ppShaderResourceViews);
...
static inline void
ID3D11DeviceContext_GSGetSamplers(ID3D11DeviceContext *This, UINT StartSlot,
                                  UINT NumSamplers,
                                  ID3D11SamplerState **ppSamplers) {
  This->lpVtbl->GSGetSamplers(This, StartSlot, NumSamplers, ppSamplers);
}
static inline void ID3D11DeviceContext_OMGetRenderTargets(
    ID3D11DeviceContext *This, UINT NumViews,
    ID3D11RenderTargetView **ppRenderTargetViews,
    ID3D11DepthStencilView **ppDepthStencilView) {
  This->lpVtbl->OMGetRenderTargets(This, NumViews, ppRenderTargetViews,
...
static inline void
ID3D11DeviceContext_OMGetBlendState(ID3D11DeviceContext *This,
                                    ID3D11BlendState **ppBlendState,
...
static inline void
ID3D11DeviceContext_SOGetTargets(ID3D11DeviceContext *This, UINT NumBuffers,
                                 ID3D11Buffer **ppSOTargets) {
  This->lpVtbl->SOGetTargets(This, NumBuffers, ppSOTargets);
}
static inline void
ID3D11DeviceContext_RSGetState(ID3D11DeviceContext *This,
                               ID3D11RasterizerState **ppRasterizerState) {
  This->lpVtbl->RSGetState(This, ppRasterizerState);
}
static inline void
ID3D11DeviceContext_RSGetViewports(ID3D11DeviceContext *This,
                                   UINT *pNumViewports,
                                   D3D11_VIEWPORT *pViewports) {
  This->lpVtbl->RSGetViewports(This, pNumViewports, pViewports);
}
static inline void
ID3D11DeviceContext_RSGetScissorRects(ID3D11DeviceContext *This,
                                      UINT *pNumRects, D3D11_RECT *pRects) {
  This->lpVtbl->RSGetScissorRects(This, pNumRects, pRects);
}
static inline void ID3D11DeviceContext_HSGetShaderResources(
    ID3D11DeviceContext *This, UINT StartSlot, UINT NumViews,
    ID3D11ShaderResourceView **ppShaderResourceViews) {
  This->lpVtbl->HSGetShaderResources(This, StartSlot, NumViews,
                                     ppShaderResourceViews);
}
static inline void ID3D11DeviceContext_HSGetShader(
    ID3D11DeviceContext *This, ID3D11HullShader **ppHullShader,
    ID3D11ClassInstance **ppClassInstances, UINT *pNumClassInstances) {
  This->lpVtbl->HSGetShader(This, ppHullShader, ppClassInstances,
                            pNumClassInstances);
}
static inline void
ID3D11DeviceContext_HSGetSamplers(ID3D11DeviceContext *This, UINT StartSlot,
                                  UINT NumSamplers,
                                  ID3D11SamplerState **ppSamplers) {
  This->lpVtbl->HSGetSamplers(This, StartSlot, NumSamplers, ppSamplers);
}
static inline void
ID3D11DeviceContext_HSGetConstantBuffers(ID3D11DeviceContext *This,
                                         UINT StartSlot, UINT NumBuffers,
                                         ID3D11Buffer **ppConstantBuffers) {
  This->lpVtbl->HSGetConstantBuffers(This, StartSlot, NumBuffers,
                                     ppConstantBuffers);
}
static inline void ID3D11DeviceContext_DSGetShaderResources(
    ID3D11DeviceContext *This, UINT StartSlot, UINT NumViews,
    ID3D11ShaderResourceView **ppShaderResourceViews) {
  This->lpVtbl->DSGetShaderResources(This, StartSlot, NumViews,
                                     ppShaderResourceViews);
}
static inline void ID3D11DeviceContext_DSGetShader(
    ID3D11DeviceContext *This, ID3D11DomainShader **ppDomainShader,
    ID3D11ClassInstance **ppClassInstances, UINT *pNumClassInstances) {
  This->lpVtbl->DSGetShader(This, ppDomainShader, ppClassInstances,
                            pNumClassInstances);
}
static inline void
ID3D11DeviceContext_DSGetSamplers(ID3D11DeviceContext *This, UINT StartSlot,
                                  UINT NumSamplers,
                                  ID3D11SamplerState **ppSamplers) {
  This->lpVtbl->DSGetSamplers(This, StartSlot, NumSamplers, ppSamplers);
}
static inline void
ID3D11DeviceContext_DSGetConstantBuffers(ID3D11DeviceContext *This,
                                         UINT StartSlot, UINT NumBuffers,
                                         ID3D11Buffer **ppConstantBuffers) {
  This->lpVtbl->DSGetConstantBuffers(This, StartSlot, NumBuffers,
                                     ppConstantBuffers);
}
static inline void ID3D11DeviceContext_CSGetShaderResources(
    ID3D11DeviceContext *This, UINT StartSlot, UINT NumViews,
    ID3D11ShaderResourceView **ppShaderResourceViews) {
  This->lpVtbl->CSGetShaderResources(This, StartSlot, NumViews,
                                     ppShaderResourceViews);
...
static inline void ID3D11DeviceContext_CSGetShader(
    ID3D11DeviceContext *This, ID3D11ComputeShader **ppComputeShader,
    ID3D11ClassInstance **ppClassInstances, UINT *pNumClassInstances) {
  This->lpVtbl->CSGetShader(This, ppComputeShader, ppClassInstances,
                            pNumClassInstances);
}
static inline void
ID3D11DeviceContext_CSGetSamplers(ID3D11DeviceContext *This, UINT StartSlot,
                                  UINT NumSamplers,
                                  ID3D11SamplerState **ppSamplers) {
  This->lpVtbl->CSGetSamplers(This, StartSlot, NumSamplers, ppSamplers);
}
static inline void
ID3D11DeviceContext_CSGetConstantBuffers(ID3D11DeviceContext *This,
                                         UINT StartSlot, UINT NumBuffers,
                                         ID3D11Buffer **ppConstantBuffers) {
  This->lpVtbl->CSGetConstantBuffers(This, StartSlot, NumBuffers,
                                     ppConstantBuffers);
...
ID3D11DeviceContext_GetType(ID3D11DeviceContext *This) {
  return This->lpVtbl->GetType(This);
}
static inline UINT
ID3D11DeviceContext_GetContextFlags(ID3D11DeviceContext *This) {
  return This->lpVtbl->GetContextFlags(This);
}
static inline HRESULT
ID3D11DeviceContext_FinishCommandList(ID3D11DeviceContext *This,
                                      WINBOOL RestoreDeferredContextState,
                                      ID3D11CommandList **ppCommandList) {
  return This->lpVtbl->FinishCommandList(This, RestoreDeferredContextState,
                                         ppCommandList);
}
#endif
#endif
...
DEFINE_GUID(IID_ID3D11AuthenticatedChannel, 0x3015a308, 0xdcbd, 0x47aa, 0xa7,
            0x47, 0x19, 0x24, 0x86, 0xd1, 0x4d, 0x4a);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("3015a308-dcbd-47aa-a747-192486d14d4a")
ID3D11AuthenticatedChannel : public ID3D11DeviceChild {
  virtual HRESULT STDMETHODCALLTYPE GetCertificateSize(UINT *
                                                       pCertificateSize) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetCertificate(UINT CertificateSize,
                                                   BYTE * pCertificate) = 0;
  virtual void STDMETHODCALLTYPE GetChannelHandle(HANDLE * pChannelHandle) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D11AuthenticatedChannel, 0x3015a308, 0xdcbd, 0x47aa, 0xa7,
                0x47, 0x19, 0x24, 0x86, 0xd1, 0x4d, 0x4a)
#endif
#else
typedef struct ID3D11AuthenticatedChannelVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11AuthenticatedChannel *This,
                                             REFIID riid, void **ppvObject);
  ...
  void(STDMETHODCALLTYPE *GetDevice)(ID3D11AuthenticatedChannel *This,
                                     ID3D11Device **ppDevice);
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(ID3D11AuthenticatedChannel *This,
                                             REFGUID guid, UINT *pDataSize,
                                             void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D11AuthenticatedChannel *This,
                                             REFGUID guid, UINT DataSize,
                                             const void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateDataInterface)(
      ID3D11AuthenticatedChannel *This, REFGUID guid, const IUnknown *pData);
  /*** ID3D11AuthenticatedChannel methods ***/
  HRESULT(STDMETHODCALLTYPE *GetCertificateSize)(
      ID3D11AuthenticatedChannel *This, UINT *pCertificateSize);
  HRESULT(STDMETHODCALLTYPE *GetCertificate)(ID3D11AuthenticatedChannel *This,
...
#define ID3D11AuthenticatedChannel_GetDevice(This, ppDevice)                   \
  (This)->lpVtbl->GetDevice(This, ppDevice)
#define ID3D11AuthenticatedChannel_GetPrivateData(This, guid, pDataSize,       \
                                                  pData)                       \
  (This)->lpVtbl->GetPrivateData(This, guid, pDataSize, pData)
...
#define ID3D11AuthenticatedChannel_GetCertificate(This, CertificateSize,       \
                                                  pCertificate)                \
...
/*** IUnknown methods ***/
static inline HRESULT
ID3D11AuthenticatedChannel_QueryInterface(ID3D11AuthenticatedChannel *This,
                                          REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
ID3D11AuthenticatedChannel_AddRef(ID3D11AuthenticatedChannel *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
ID3D11AuthenticatedChannel_Release(ID3D11AuthenticatedChannel *This) {
  return This->lpVtbl->Release(This);
}
/*** ID3D11DeviceChild methods ***/
static inline void
ID3D11AuthenticatedChannel_GetDevice(ID3D11AuthenticatedChannel *This,
                                     ID3D11Device **ppDevice) {
  This->lpVtbl->GetDevice(This, ppDevice);
}
static inline HRESULT
ID3D11AuthenticatedChannel_GetPrivateData(ID3D11AuthenticatedChannel *This,
                                          REFGUID guid, UINT *pDataSize,
                                          void *pData) {
  return This->lpVtbl->GetPrivateData(This, guid, pDataSize, pData);
}
static inline HRESULT
ID3D11AuthenticatedChannel_SetPrivateData(ID3D11AuthenticatedChannel *This,
                                          REFGUID guid, UINT DataSize,
                                          const void *pData) {
  return This->lpVtbl->SetPrivateData(This, guid, DataSize, pData);
}
static inline HRESULT ID3D11AuthenticatedChannel_SetPrivateDataInterface(
    ID3D11AuthenticatedChannel *This, REFGUID guid, const IUnknown *pData) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, pData);
}
/*** ID3D11AuthenticatedChannel methods ***/
static inline HRESULT
ID3D11AuthenticatedChannel_GetCertificateSize(ID3D11AuthenticatedChannel *This,
                                              UINT *pCertificateSize) {
  return This->lpVtbl->GetCertificateSize(This, pCertificateSize);
}
static inline HRESULT
ID3D11AuthenticatedChannel_GetCertificate(ID3D11AuthenticatedChannel *This,
                                          UINT CertificateSize,
                                          BYTE *pCertificate) {
  return This->lpVtbl->GetCertificate(This, CertificateSize, pCertificate);
}
static inline void
ID3D11AuthenticatedChannel_GetChannelHandle(ID3D11AuthenticatedChannel *This,
                                            HANDLE *pChannelHandle) {
  This->lpVtbl->GetChannelHandle(This, pChannelHandle);
}
#endif
...
DEFINE_GUID(IID_ID3D11CryptoSession, 0x9b32f9ad, 0xbdcc, 0x40a6, 0xa3, 0x9d,
            0xd5, 0xc8, 0x65, 0x84, 0x57, 0x20);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("9b32f9ad-bdcc-40a6-a39d-d5c865845720")
ID3D11CryptoSession : public ID3D11DeviceChild {
  virtual void STDMETHODCALLTYPE GetCryptoType(GUID * pCryptoType) = 0;
  virtual void STDMETHODCALLTYPE GetDecoderProfile(GUID * pDecoderProfile) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetCertificateSize(UINT *
                                                       pCertificateSize) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetCertificate(UINT CertificateSize,
                                                   BYTE * pCertificate) = 0;
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D11CryptoSession, 0x9b32f9ad, 0xbdcc, 0x40a6, 0xa3, 0x9d,
                0xd5, 0xc8, 0x65, 0x84, 0x57, 0x20)
#endif
#else
typedef struct ID3D11CryptoSessionVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11CryptoSession *This,
                                             REFIID riid, void **ppvObject);
  ...
  void(STDMETHODCALLTYPE *GetDevice)(ID3D11CryptoSession *This,
                                     ID3D11Device **ppDevice);
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(ID3D11CryptoSession *This,
                                             REFGUID guid, UINT *pDataSize,
                                             void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D11CryptoSession *This,
                                             REFGUID guid, UINT DataSize,
                                             const void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateDataInterface)(ID3D11CryptoSession *This,
                                                      REFGUID guid,
                                                      const IUnknown *pData);
  ...
  HRESULT(STDMETHODCALLTYPE *GetCertificateSize)(ID3D11CryptoSession *This,
                                                 UINT *pCertificateSize);
  HRESULT(STDMETHODCALLTYPE *GetCertificate)(ID3D11CryptoSession *This,
                                             UINT CertificateSize,
                                             BYTE *pCertificate);
...
interface ID3D11CryptoSession { CONST_VTBL ID3D11CryptoSessionVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define ID3D11CryptoSession_GetCertificateSize(This, pCertificateSize)         \
  (This)->lpVtbl->GetCertificateSize(This, pCertificateSize)
#define ID3D11CryptoSession_GetCertificate(This, CertificateSize,              \
                                           pCertificate)                       \
  (This)->lpVtbl->GetCertificate(This, CertificateSize, pCertificate)
...
/*** IUnknown methods ***/
static inline HRESULT
ID3D11CryptoSession_QueryInterface(ID3D11CryptoSession *This, REFIID riid,
                                   void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ID3D11DeviceChild methods ***/
static inline void ID3D11CryptoSession_GetDevice(ID3D11CryptoSession *This,
                                                 ID3D11Device **ppDevice) {
  This->lpVtbl->GetDevice(This, ppDevice);
}
static inline HRESULT
ID3D11CryptoSession_GetPrivateData(ID3D11CryptoSession *This, REFGUID guid,
                                   UINT *pDataSize, void *pData) {
  return This->lpVtbl->GetPrivateData(This, guid, pDataSize, pData);
}
static inline HRESULT
ID3D11CryptoSession_SetPrivateData(ID3D11CryptoSession *This, REFGUID guid,
                                   UINT DataSize, const void *pData) {
  return This->lpVtbl->SetPrivateData(This, guid, DataSize, pData);
}
static inline HRESULT ID3D11CryptoSession_SetPrivateDataInterface(
    ID3D11CryptoSession *This, REFGUID guid, const IUnknown *pData) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, pData);
}
/*** ID3D11CryptoSession methods ***/
static inline void ID3D11CryptoSession_GetCryptoType(ID3D11CryptoSession *This,
                                                     GUID *pCryptoType) {
  This->lpVtbl->GetCryptoType(This, pCryptoType);
}
static inline void
ID3D11CryptoSession_GetDecoderProfile(ID3D11CryptoSession *This,
                                      GUID *pDecoderProfile) {
  This->lpVtbl->GetDecoderProfile(This, pDecoderProfile);
}
static inline HRESULT
ID3D11CryptoSession_GetCertificateSize(ID3D11CryptoSession *This,
                                       UINT *pCertificateSize) {
  return This->lpVtbl->GetCertificateSize(This, pCertificateSize);
}
static inline HRESULT
ID3D11CryptoSession_GetCertificate(ID3D11CryptoSession *This,
                                   UINT CertificateSize, BYTE *pCertificate) {
  return This->lpVtbl->GetCertificate(This, CertificateSize, pCertificate);
}
static inline void
ID3D11CryptoSession_GetCryptoSessionHandle(ID3D11CryptoSession *This,
                                           HANDLE *pCryptoSessionHandle) {
  This->lpVtbl->GetCryptoSessionHandle(This, pCryptoSessionHandle);
}
#endif
...
ID3D11VideoDecoder : public ID3D11DeviceChild {
  ...
  virtual HRESULT STDMETHODCALLTYPE GetDriverHandle(HANDLE * pDriverHandle) = 0;
};
#ifdef __CRT_UUID_DECL
...
typedef struct ID3D11VideoDecoderVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11VideoDecoder *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetCreationParameters)(
      ID3D11VideoDecoder *This, D3D11_VIDEO_DECODER_DESC *pVideoDesc,
      D3D11_VIDEO_DECODER_CONFIG *pConfig);
  HRESULT(STDMETHODCALLTYPE *GetDriverHandle)(ID3D11VideoDecoder *This,
                                              HANDLE *pDriverHandle);
  END_INTERFACE
} ID3D11VideoDecoderVtbl;
interface ID3D11VideoDecoder { CONST_VTBL ID3D11VideoDecoderVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
ID3D11VideoDecoder_QueryInterface(ID3D11VideoDecoder *This, REFIID riid,
                                  void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ID3D11DeviceChild methods ***/
static inline void ID3D11VideoDecoder_GetDevice(ID3D11VideoDecoder *This,
                                                ID3D11Device **ppDevice) {
  This->lpVtbl->GetDevice(This, ppDevice);
}
static inline HRESULT
ID3D11VideoDecoder_GetPrivateData(ID3D11VideoDecoder *This, REFGUID guid,
                                  UINT *pDataSize, void *pData) {
  return This->lpVtbl->GetPrivateData(This, guid, pDataSize, pData);
}
static inline HRESULT
ID3D11VideoDecoder_SetPrivateData(ID3D11VideoDecoder *This, REFGUID guid,
                                  UINT DataSize, const void *pData) {
  return This->lpVtbl->SetPrivateData(This, guid, DataSize, pData);
}
static inline HRESULT ID3D11VideoDecoder_SetPrivateDataInterface(
    ID3D11VideoDecoder *This, REFGUID guid, const IUnknown *pData) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, pData);
}
/*** ID3D11VideoDecoder methods ***/
static inline HRESULT
ID3D11VideoDecoder_GetCreationParameters(ID3D11VideoDecoder *This,
                                         D3D11_VIDEO_DECODER_DESC *pVideoDesc,
                                         D3D11_VIDEO_DECODER_CONFIG *pConfig) {
  return This->lpVtbl->GetCreationParameters(This, pVideoDesc, pConfig);
}
static inline HRESULT
ID3D11VideoDecoder_GetDriverHandle(ID3D11VideoDecoder *This,
                                   HANDLE *pDriverHandle) {
...
DEFINE_GUID(IID_ID3D11VideoProcessorEnumerator, 0x31627037, 0x53ab, 0x4200,
...
ID3D11VideoProcessorEnumerator : public ID3D11DeviceChild {
  ...
  virtual HRESULT STDMETHODCALLTYPE CheckVideoProcessorFormat(
      DXGI_FORMAT Format, UINT * pFlags) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetVideoProcessorRateConversionCaps(
      UINT TypeIndex, D3D11_VIDEO_PROCESSOR_RATE_CONVERSION_CAPS * pCaps) = 0;
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D11VideoProcessorEnumerator, 0x31627037, 0x53ab, 0x4200,
                0x90, 0x61, 0x05, 0xfa, 0xa9, 0xab, 0x45, 0xf9)
#endif
#else
typedef struct ID3D11VideoProcessorEnumeratorVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(
      ID3D11VideoProcessorEnumerator *This, REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(
      ID3D11VideoProcessorEnumerator *This, REFGUID guid, UINT *pDataSize,
      void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(
      ID3D11VideoProcessorEnumerator *This, REFGUID guid, UINT DataSize,
      const void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateDataInterface)(
      ID3D11VideoProcessorEnumerator *This, REFGUID guid,
      const IUnknown *pData);
  ...
  HRESULT(STDMETHODCALLTYPE *CheckVideoProcessorFormat)(
      ID3D11VideoProcessorEnumerator *This, DXGI_FORMAT Format, UINT *pFlags);
  HRESULT(STDMETHODCALLTYPE *GetVideoProcessorCaps)(
      ID3D11VideoProcessorEnumerator *This, D3D11_VIDEO_PROCESSOR_CAPS *pCaps);
  HRESULT(STDMETHODCALLTYPE *GetVideoProcessorRateConversionCaps)(
      ID3D11VideoProcessorEnumerator *This, UINT TypeIndex,
      D3D11_VIDEO_PROCESSOR_RATE_CONVERSION_CAPS *pCaps);
  HRESULT(STDMETHODCALLTYPE *GetVideoProcessorCustomRate)(
      ID3D11VideoProcessorEnumerator *This, UINT TypeIndex,
      UINT CustomRateIndex, D3D11_VIDEO_PROCESSOR_CUSTOM_RATE *pRate);
  HRESULT(STDMETHODCALLTYPE *GetVideoProcessorFilterRange)(
      ID3D11VideoProcessorEnumerator *This, D3D11_VIDEO_PROCESSOR_FILTER Filter,
...
#define ID3D11VideoProcessorEnumerator_GetDevice(This, ppDevice)               \
  (This)->lpVtbl->GetDevice(This, ppDevice)
#define ID3D11VideoProcessorEnumerator_GetPrivateData(This, guid, pDataSize,   \
                                                      pData)                   \
  (This)->lpVtbl->GetPrivateData(This, guid, pDataSize, pData)
#define ID3D11VideoProcessorEnumerator_SetPrivateData(This, guid, DataSize,    \
                                                      pData)                   \
  (This)->lpVtbl->SetPrivateData(This, guid, DataSize, pData)
#define ID3D11VideoProcessorEnumerator_SetPrivateDataInterface(This, guid,     \
                                                               pData)          \
  (This)->lpVtbl->SetPrivateDataInterface(This, guid, pData)
/*** ID3D11VideoProcessorEnumerator methods ***/
#define ID3D11VideoProcessorEnumerator_GetVideoProcessorContentDesc(           \
    This, pContentDesc)                                                        \
  (This)->lpVtbl->GetVideoProcessorContentDesc(This, pContentDesc)
#define ID3D11VideoProcessorEnumerator_CheckVideoProcessorFormat(This, Format, \
                                                                 pFlags)       \
...
#define ID3D11VideoProcessorEnumerator_GetVideoProcessorRateConversionCaps(    \
    This, TypeIndex, pCaps)                                                    \
  (This)->lpVtbl->GetVideoProcessorRateConversionCaps(This, TypeIndex, pCaps)
#define ID3D11VideoProcessorEnumerator_GetVideoProcessorCustomRate(            \
    This, TypeIndex, CustomRateIndex, pRate)                                   \
  (This)->lpVtbl->GetVideoProcessorCustomRate(This, TypeIndex,                 \
                                              CustomRateIndex, pRate)
#define ID3D11VideoProcessorEnumerator_GetVideoProcessorFilterRange(           \
    This, Filter, pRange)                                                      \
  (This)->lpVtbl->GetVideoProcessorFilterRange(This, Filter, pRange)
#else
/*** IUnknown methods ***/
static inline HRESULT ID3D11VideoProcessorEnumerator_QueryInterface(
    ID3D11VideoProcessorEnumerator *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
ID3D11VideoProcessorEnumerator_AddRef(ID3D11VideoProcessorEnumerator *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
ID3D11VideoProcessorEnumerator_Release(ID3D11VideoProcessorEnumerator *This) {
  return This->lpVtbl->Release(This);
}
/*** ID3D11DeviceChild methods ***/
static inline void
ID3D11VideoProcessorEnumerator_GetDevice(ID3D11VideoProcessorEnumerator *This,
                                         ID3D11Device **ppDevice) {
  This->lpVtbl->GetDevice(This, ppDevice);
}
static inline HRESULT ID3D11VideoProcessorEnumerator_GetPrivateData(
    ID3D11VideoProcessorEnumerator *This, REFGUID guid, UINT *pDataSize,
    void *pData) {
  return This->lpVtbl->GetPrivateData(This, guid, pDataSize, pData);
}
static inline HRESULT ID3D11VideoProcessorEnumerator_SetPrivateData(
    ID3D11VideoProcessorEnumerator *This, REFGUID guid, UINT DataSize,
    const void *pData) {
  return This->lpVtbl->SetPrivateData(This, guid, DataSize, pData);
}
static inline HRESULT ID3D11VideoProcessorEnumerator_SetPrivateDataInterface(
    ID3D11VideoProcessorEnumerator *This, REFGUID guid, const IUnknown *pData) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, pData);
}
/*** ID3D11VideoProcessorEnumerator methods ***/
static inline HRESULT
...
static inline HRESULT ID3D11VideoProcessorEnumerator_CheckVideoProcessorFormat(
    ID3D11VideoProcessorEnumerator *This, DXGI_FORMAT Format, UINT *pFlags) {
  return This->lpVtbl->CheckVideoProcessorFormat(This, Format, pFlags);
}
static inline HRESULT ID3D11VideoProcessorEnumerator_GetVideoProcessorCaps(
    ID3D11VideoProcessorEnumerator *This, D3D11_VIDEO_PROCESSOR_CAPS *pCaps) {
...
ID3D11VideoProcessorEnumerator_GetVideoProcessorRateConversionCaps(
    ID3D11VideoProcessorEnumerator *This, UINT TypeIndex,
    D3D11_VIDEO_PROCESSOR_RATE_CONVERSION_CAPS *pCaps) {
  return This->lpVtbl->GetVideoProcessorRateConversionCaps(This, TypeIndex,
                                                           pCaps);
}
static inline HRESULT
ID3D11VideoProcessorEnumerator_GetVideoProcessorCustomRate(
    ID3D11VideoProcessorEnumerator *This, UINT TypeIndex, UINT CustomRateIndex,
    D3D11_VIDEO_PROCESSOR_CUSTOM_RATE *pRate) {
  return This->lpVtbl->GetVideoProcessorCustomRate(This, TypeIndex,
                                                   CustomRateIndex, pRate);
}
static inline HRESULT
...
DEFINE_GUID(IID_ID3D11VideoProcessor, 0x1d7b0652, 0x185f, 0x41c6, 0x85, 0xce,
            0x0c, 0x5b, 0xe3, 0xd4, 0xae, 0x6c);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D11VideoProcessor, 0x1d7b0652, 0x185f, 0x41c6, 0x85, 0xce,
                0x0c, 0x5b, 0xe3, 0xd4, 0xae, 0x6c)
#endif
#else
typedef struct ID3D11VideoProcessorVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11VideoProcessor *This,
                                             REFIID riid, void **ppvObject);
  ...
  void(STDMETHODCALLTYPE *GetDevice)(ID3D11VideoProcessor *This,
                                     ID3D11Device **ppDevice);
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(ID3D11VideoProcessor *This,
                                             REFGUID guid, UINT *pDataSize,
                                             void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D11VideoProcessor *This,
                                             REFGUID guid, UINT DataSize,
                                             const void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateDataInterface)(
      ID3D11VideoProcessor *This, REFGUID guid, const IUnknown *pData);
  /*** ID3D11VideoProcessor methods ***/
  void(STDMETHODCALLTYPE *GetContentDesc)(
      ID3D11VideoProcessor *This, D3D11_VIDEO_PROCESSOR_CONTENT_DESC *pDesc);
  void(STDMETHODCALLTYPE *GetRateConversionCaps)(
      ID3D11VideoProcessor *This,
      D3D11_VIDEO_PROCESSOR_RATE_CONVERSION_CAPS *pCaps);
  END_INTERFACE
} ID3D11VideoProcessorVtbl;
interface ID3D11VideoProcessor { CONST_VTBL ID3D11VideoProcessorVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
ID3D11VideoProcessor_QueryInterface(ID3D11VideoProcessor *This, REFIID riid,
                                    void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ID3D11DeviceChild methods ***/
static inline void ID3D11VideoProcessor_GetDevice(ID3D11VideoProcessor *This,
                                                  ID3D11Device **ppDevice) {
  This->lpVtbl->GetDevice(This, ppDevice);
}
static inline HRESULT
ID3D11VideoProcessor_GetPrivateData(ID3D11VideoProcessor *This, REFGUID guid,
                                    UINT *pDataSize, void *pData) {
  return This->lpVtbl->GetPrivateData(This, guid, pDataSize, pData);
}
static inline HRESULT
ID3D11VideoProcessor_SetPrivateData(ID3D11VideoProcessor *This, REFGUID guid,
                                    UINT DataSize, const void *pData) {
  return This->lpVtbl->SetPrivateData(This, guid, DataSize, pData);
}
...
/*** ID3D11VideoProcessor methods ***/
static inline void
ID3D11VideoProcessor_GetContentDesc(ID3D11VideoProcessor *This,
                                    D3D11_VIDEO_PROCESSOR_CONTENT_DESC *pDesc) {
  This->lpVtbl->GetContentDesc(This, pDesc);
}
static inline void ID3D11VideoProcessor_GetRateConversionCaps(
    ID3D11VideoProcessor *This,
    D3D11_VIDEO_PROCESSOR_RATE_CONVERSION_CAPS *pCaps) {
  This->lpVtbl->GetRateConversionCaps(This, pCaps);
}
...
DEFINE_GUID(IID_ID3D11VideoDecoderOutputView, 0xc2931aea, 0x2a85, 0x4f20, 0x86,
            0x0f, 0xfb, 0xa1, 0xfd, 0x25, 0x6e, 0x18);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("c2931aea-2a85-4f20-860f-fba1fd256e18")
ID3D11VideoDecoderOutputView : public ID3D11View {
  virtual void STDMETHODCALLTYPE GetDesc(D3D11_VIDEO_DECODER_OUTPUT_VIEW_DESC *
                                         pDesc) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D11VideoDecoderOutputView, 0xc2931aea, 0x2a85, 0x4f20, 0x86,
                0x0f, 0xfb, 0xa1, 0xfd, 0x25, 0x6e, 0x18)
#endif
#else
typedef struct ID3D11VideoDecoderOutputViewVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11VideoDecoderOutputView *This,
                                             REFIID riid, void **ppvObject);
  ...
  void(STDMETHODCALLTYPE *GetDevice)(ID3D11VideoDecoderOutputView *This,
                                     ID3D11Device **ppDevice);
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(ID3D11VideoDecoderOutputView *This,
                                             REFGUID guid, UINT *pDataSize,
                                             void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D11VideoDecoderOutputView *This,
                                             REFGUID guid, UINT DataSize,
                                             const void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateDataInterface)(
      ID3D11VideoDecoderOutputView *This, REFGUID guid, const IUnknown *pData);
  /*** ID3D11View methods ***/
...
#define ID3D11VideoDecoderOutputView_GetDevice(This, ppDevice)                 \
  (This)->lpVtbl->GetDevice(This, ppDevice)
#define ID3D11VideoDecoderOutputView_GetPrivateData(This, guid, pDataSize,     \
                                                    pData)                     \
  (This)->lpVtbl->GetPrivateData(This, guid, pDataSize, pData)
#define ID3D11VideoDecoderOutputView_SetPrivateData(This, guid, DataSize,      \
                                                    pData)                     \
  (This)->lpVtbl->SetPrivateData(This, guid, DataSize, pData)
#define ID3D11VideoDecoderOutputView_SetPrivateDataInterface(This, guid,       \
                                                             pData)            \
  (This)->lpVtbl->SetPrivateDataInterface(This, guid, pData)
/*** ID3D11View methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
ID3D11VideoDecoderOutputView_QueryInterface(ID3D11VideoDecoderOutputView *This,
                                            REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
...
/*** ID3D11DeviceChild methods ***/
static inline void
ID3D11VideoDecoderOutputView_GetDevice(ID3D11VideoDecoderOutputView *This,
                                       ID3D11Device **ppDevice) {
  This->lpVtbl->GetDevice(This, ppDevice);
}
static inline HRESULT
ID3D11VideoDecoderOutputView_GetPrivateData(ID3D11VideoDecoderOutputView *This,
                                            REFGUID guid, UINT *pDataSize,
                                            void *pData) {
  return This->lpVtbl->GetPrivateData(This, guid, pDataSize, pData);
}
static inline HRESULT
ID3D11VideoDecoderOutputView_SetPrivateData(ID3D11VideoDecoderOutputView *This,
                                            REFGUID guid, UINT DataSize,
                                            const void *pData) {
  return This->lpVtbl->SetPrivateData(This, guid, DataSize, pData);
}
static inline HRESULT ID3D11VideoDecoderOutputView_SetPrivateDataInterface(
    ID3D11VideoDecoderOutputView *This, REFGUID guid, const IUnknown *pData) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, pData);
}
/*** ID3D11View methods ***/
static inline void
ID3D11VideoDecoderOutputView_GetResource(ID3D11VideoDecoderOutputView *This,
                                         ID3D11Resource **ppResource) {
  This->lpVtbl->GetResource(This, ppResource);
}
/*** ID3D11VideoDecoderOutputView methods ***/
static inline void ID3D11VideoDecoderOutputView_GetDesc(
...
DEFINE_GUID(IID_ID3D11VideoProcessorInputView, 0x11ec5a5f, 0x51dc, 0x4945, 0xab,
            0x34, 0x6e, 0x8c, 0x21, 0x30, 0x0e, 0xa5);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("11ec5a5f-51dc-4945-ab34-6e8c21300ea5")
ID3D11VideoProcessorInputView : public ID3D11View {
  virtual void STDMETHODCALLTYPE GetDesc(D3D11_VIDEO_PROCESSOR_INPUT_VIEW_DESC *
                                         pDesc) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D11VideoProcessorInputView, 0x11ec5a5f, 0x51dc, 0x4945, 0xab,
                0x34, 0x6e, 0x8c, 0x21, 0x30, 0x0e, 0xa5)
#endif
#else
typedef struct ID3D11VideoProcessorInputViewVtbl {
  ...
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(
      ID3D11VideoProcessorInputView *This, REFIID riid, void **ppvObject);
  ...
  void(STDMETHODCALLTYPE *GetDevice)(ID3D11VideoProcessorInputView *This,
                                     ID3D11Device **ppDevice);
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(
      ID3D11VideoProcessorInputView *This, REFGUID guid, UINT *pDataSize,
      void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(
      ID3D11VideoProcessorInputView *This, REFGUID guid, UINT DataSize,
      const void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateDataInterface)(
      ID3D11VideoProcessorInputView *This, REFGUID guid, const IUnknown *pData);
  /*** ID3D11View methods ***/
...
#define ID3D11VideoProcessorInputView_GetDevice(This, ppDevice)                \
  (This)->lpVtbl->GetDevice(This, ppDevice)
#define ID3D11VideoProcessorInputView_GetPrivateData(This, guid, pDataSize,    \
                                                     pData)                    \
  (This)->lpVtbl->GetPrivateData(This, guid, pDataSize, pData)
#define ID3D11VideoProcessorInputView_SetPrivateData(This, guid, DataSize,     \
                                                     pData)                    \
  (This)->lpVtbl->SetPrivateData(This, guid, DataSize, pData)
#define ID3D11VideoProcessorInputView_SetPrivateDataInterface(This, guid,      \
                                                              pData)           \
  (This)->lpVtbl->SetPrivateDataInterface(This, guid, pData)
/*** ID3D11View methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT ID3D11VideoProcessorInputView_QueryInterface(
    ID3D11VideoProcessorInputView *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
ID3D11VideoProcessorInputView_AddRef(ID3D11VideoProcessorInputView *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
ID3D11VideoProcessorInputView_Release(ID3D11VideoProcessorInputView *This) {
  return This->lpVtbl->Release(This);
}
/*** ID3D11DeviceChild methods ***/
static inline void
ID3D11VideoProcessorInputView_GetDevice(ID3D11VideoProcessorInputView *This,
                                        ID3D11Device **ppDevice) {
  This->lpVtbl->GetDevice(This, ppDevice);
}
static inline HRESULT ID3D11VideoProcessorInputView_GetPrivateData(
    ID3D11VideoProcessorInputView *This, REFGUID guid, UINT *pDataSize,
    void *pData) {
  return This->lpVtbl->GetPrivateData(This, guid, pDataSize, pData);
}
static inline HRESULT ID3D11VideoProcessorInputView_SetPrivateData(
    ID3D11VideoProcessorInputView *This, REFGUID guid, UINT DataSize,
    const void *pData) {
  return This->lpVtbl->SetPrivateData(This, guid, DataSize, pData);
}
static inline HRESULT ID3D11VideoProcessorInputView_SetPrivateDataInterface(
    ID3D11VideoProcessorInputView *This, REFGUID guid, const IUnknown *pData) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, pData);
}
/*** ID3D11View methods ***/
static inline void
ID3D11VideoProcessorInputView_GetResource(ID3D11VideoProcessorInputView *This,
                                          ID3D11Resource **ppResource) {
  This->lpVtbl->GetResource(This, ppResource);
}
/*** ID3D11VideoProcessorInputView methods ***/
static inline void ID3D11VideoProcessorInputView_GetDesc(
    ID3D11VideoProcessorInputView *This,
    D3D11_VIDEO_PROCESSOR_INPUT_VIEW_DESC *pDesc) {
  This->lpVtbl->GetDesc(This, pDesc);
}
...
DEFINE_GUID(IID_ID3D11VideoProcessorOutputView, 0xa048285e, 0x25a9, 0x4527,
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D11VideoProcessorOutputView, 0xa048285e, 0x25a9, 0x4527,
                0xbd, 0x93, 0xd6, 0x8b, 0x68, 0xc4, 0x42, 0x54)
#endif
#else
typedef struct ID3D11VideoProcessorOutputViewVtbl {
  ...
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(
      ID3D11VideoProcessorOutputView *This, REFIID riid, void **ppvObject);
  ...
  void(STDMETHODCALLTYPE *GetDevice)(ID3D11VideoProcessorOutputView *This,
                                     ID3D11Device **ppDevice);
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(
      ID3D11VideoProcessorOutputView *This, REFGUID guid, UINT *pDataSize,
      void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(
      ID3D11VideoProcessorOutputView *This, REFGUID guid, UINT DataSize,
      const void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateDataInterface)(
      ID3D11VideoProcessorOutputView *This, REFGUID guid,
      const IUnknown *pData);
  /*** ID3D11View methods ***/
...
#define ID3D11VideoProcessorOutputView_GetDevice(This, ppDevice)               \
  (This)->lpVtbl->GetDevice(This, ppDevice)
#define ID3D11VideoProcessorOutputView_GetPrivateData(This, guid, pDataSize,   \
                                                      pData)                   \
  (This)->lpVtbl->GetPrivateData(This, guid, pDataSize, pData)
#define ID3D11VideoProcessorOutputView_SetPrivateData(This, guid, DataSize,    \
                                                      pData)                   \
  (This)->lpVtbl->SetPrivateData(This, guid, DataSize, pData)
#define ID3D11VideoProcessorOutputView_SetPrivateDataInterface(This, guid,     \
                                                               pData)          \
  (This)->lpVtbl->SetPrivateDataInterface(This, guid, pData)
/*** ID3D11View methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT ID3D11VideoProcessorOutputView_QueryInterface(
    ID3D11VideoProcessorOutputView *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
ID3D11VideoProcessorOutputView_AddRef(ID3D11VideoProcessorOutputView *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
ID3D11VideoProcessorOutputView_Release(ID3D11VideoProcessorOutputView *This) {
  return This->lpVtbl->Release(This);
}
/*** ID3D11DeviceChild methods ***/
static inline void
ID3D11VideoProcessorOutputView_GetDevice(ID3D11VideoProcessorOutputView *This,
                                         ID3D11Device **ppDevice) {
  This->lpVtbl->GetDevice(This, ppDevice);
}
static inline HRESULT ID3D11VideoProcessorOutputView_GetPrivateData(
    ID3D11VideoProcessorOutputView *This, REFGUID guid, UINT *pDataSize,
    void *pData) {
  return This->lpVtbl->GetPrivateData(This, guid, pDataSize, pData);
}
static inline HRESULT ID3D11VideoProcessorOutputView_SetPrivateData(
    ID3D11VideoProcessorOutputView *This, REFGUID guid, UINT DataSize,
    const void *pData) {
  return This->lpVtbl->SetPrivateData(This, guid, DataSize, pData);
}
static inline HRESULT ID3D11VideoProcessorOutputView_SetPrivateDataInterface(
    ID3D11VideoProcessorOutputView *This, REFGUID guid, const IUnknown *pData) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, pData);
}
/*** ID3D11View methods ***/
static inline void
ID3D11VideoProcessorOutputView_GetResource(ID3D11VideoProcessorOutputView *This,
                                           ID3D11Resource **ppResource) {
  This->lpVtbl->GetResource(This, ppResource);
}
/*** ID3D11VideoProcessorOutputView methods ***/
static inline void ID3D11VideoProcessorOutputView_GetDesc(
    ID3D11VideoProcessorOutputView *This,
    D3D11_VIDEO_PROCESSOR_OUTPUT_VIEW_DESC *pDesc) {
  This->lpVtbl->GetDesc(This, pDesc);
}
...
DEFINE_GUID(IID_ID3D11VideoDevice, 0x10ec4d5b, 0x975a, 0x4689, 0xb9, 0xe4, 0xd0,
            0xaa, 0xc3, 0x0f, 0xe3, 0x33);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
ID3D11VideoDevice : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE CreateVideoProcessor(
      ID3D11VideoProcessorEnumerator * pEnum, UINT RateConversionIndex,
  ...
  virtual HRESULT STDMETHODCALLTYPE CreateCryptoSession(
      const GUID *pCryptoType, const GUID *pDecoderProfile,
      const GUID *pKeyExchangeType, ID3D11CryptoSession **ppCryptoSession) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE CreateVideoProcessorInputView(
      ID3D11Resource * pResource, ID3D11VideoProcessorEnumerator * pEnum,
  ...
  virtual UINT STDMETHODCALLTYPE GetVideoDecoderProfileCount() = 0;
  virtual HRESULT STDMETHODCALLTYPE GetVideoDecoderProfile(
      UINT Index, GUID * pDecoderProfile) = 0;
  virtual HRESULT STDMETHODCALLTYPE CheckVideoDecoderFormat(
      const GUID *pDecoderProfile, DXGI_FORMAT Format, WINBOOL *pSupported) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetVideoDecoderConfigCount(
      const D3D11_VIDEO_DECODER_DESC *pDesc, UINT *pCount) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetVideoDecoderConfig(
      const D3D11_VIDEO_DECODER_DESC *pDesc, UINT Index,
      D3D11_VIDEO_DECODER_CONFIG *pConfig) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE CheckCryptoKeyExchange(
      const GUID *pCryptoType, const GUID *pDecoderProfile, UINT Index,
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D11VideoDevice, 0x10ec4d5b, 0x975a, 0x4689, 0xb9, 0xe4, 0xd0,
                0xaa, 0xc3, 0x0f, 0xe3, 0x33)
#endif
#else
typedef struct ID3D11VideoDeviceVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11VideoDevice *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *CreateVideoDecoder)(
      ID3D11VideoDevice *This, const D3D11_VIDEO_DECODER_DESC *pVideoDesc,
      const D3D11_VIDEO_DECODER_CONFIG *pConfig,
      ID3D11VideoDecoder **ppDecoder);
  HRESULT(STDMETHODCALLTYPE *CreateVideoProcessor)(
      ID3D11VideoDevice *This, ID3D11VideoProcessorEnumerator *pEnum,
      UINT RateConversionIndex, ID3D11VideoProcessor **ppVideoProcessor);
  HRESULT(STDMETHODCALLTYPE *CreateAuthenticatedChannel)(
      ID3D11VideoDevice *This, D3D11_AUTHENTICATED_CHANNEL_TYPE ChannelType,
      ID3D11AuthenticatedChannel **ppAuthenticatedChannel);
  HRESULT(STDMETHODCALLTYPE *CreateCryptoSession)(
      ID3D11VideoDevice *This, const GUID *pCryptoType,
      const GUID *pDecoderProfile, const GUID *pKeyExchangeType,
      ID3D11CryptoSession **ppCryptoSession);
  HRESULT(STDMETHODCALLTYPE *CreateVideoDecoderOutputView)(
      ID3D11VideoDevice *This, ID3D11Resource *pResource,
      const D3D11_VIDEO_DECODER_OUTPUT_VIEW_DESC *pDesc,
  ...
  HRESULT(STDMETHODCALLTYPE *CreateVideoProcessorEnumerator)(
      ID3D11VideoDevice *This, const D3D11_VIDEO_PROCESSOR_CONTENT_DESC *pDesc,
  ...
  HRESULT(STDMETHODCALLTYPE *CheckVideoDecoderFormat)(
      ID3D11VideoDevice *This, const GUID *pDecoderProfile, DXGI_FORMAT Format,
      WINBOOL *pSupported);
  HRESULT(STDMETHODCALLTYPE *GetVideoDecoderConfigCount)(
      ID3D11VideoDevice *This, const D3D11_VIDEO_DECODER_DESC *pDesc,
      UINT *pCount);
  HRESULT(STDMETHODCALLTYPE *GetVideoDecoderConfig)(
      ID3D11VideoDevice *This, const D3D11_VIDEO_DECODER_DESC *pDesc,
      UINT Index, D3D11_VIDEO_DECODER_CONFIG *pConfig);
  HRESULT(STDMETHODCALLTYPE *GetContentProtectionCaps)(
      ID3D11VideoDevice *This, const GUID *pCryptoType,
      const GUID *pDecoderProfile, D3D11_VIDEO_CONTENT_PROTECTION_CAPS *pCaps);
  HRESULT(STDMETHODCALLTYPE *CheckCryptoKeyExchange)(
      ID3D11VideoDevice *This, const GUID *pCryptoType,
      const GUID *pDecoderProfile, UINT Index, GUID *pKeyExchangeType);
...
interface ID3D11VideoDevice { CONST_VTBL ID3D11VideoDeviceVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define ID3D11VideoDevice_CreateVideoProcessor(                                \
    This, pEnum, RateConversionIndex, ppVideoProcessor)                        \
  (This)->lpVtbl->CreateVideoProcessor(This, pEnum, RateConversionIndex,       \
                                       ppVideoProcessor)
#define ID3D11VideoDevice_CreateAuthenticatedChannel(This, ChannelType,        \
                                                     ppAuthenticatedChannel)   \
  (This)->lpVtbl->CreateAuthenticatedChannel(This, ChannelType,                \
                                             ppAuthenticatedChannel)
#define ID3D11VideoDevice_CreateCryptoSession(                                 \
    This, pCryptoType, pDecoderProfile, pKeyExchangeType, ppCryptoSession)     \
  (This)->lpVtbl->CreateCryptoSession(This, pCryptoType, pDecoderProfile,      \
                                      pKeyExchangeType, ppCryptoSession)
#define ID3D11VideoDevice_CreateVideoDecoderOutputView(This, pResource, pDesc, \
                                                       ppVDOVView)             \
  (This)->lpVtbl->CreateVideoDecoderOutputView(This, pResource, pDesc,         \
                                               ppVDOVView)
#define ID3D11VideoDevice_CreateVideoProcessorInputView(                       \
  ...
  (This)->lpVtbl->CreateVideoProcessorInputView(This, pResource, pEnum, pDesc, \
                                                ppVPIView)
#define ID3D11VideoDevice_CreateVideoProcessorOutputView(                      \
    This, pResource, pEnum, pDesc, ppVPOView)                                  \
  (This)->lpVtbl->CreateVideoProcessorOutputView(This, pResource, pEnum,       \
                                                 pDesc, ppVPOView)
...
#define ID3D11VideoDevice_CheckVideoDecoderFormat(This, pDecoderProfile,       \
                                                  Format, pSupported)          \
  (This)->lpVtbl->CheckVideoDecoderFormat(This, pDecoderProfile, Format,       \
                                          pSupported)
...
#define ID3D11VideoDevice_GetContentProtectionCaps(This, pCryptoType,          \
                                                   pDecoderProfile, pCaps)     \
  (This)->lpVtbl->GetContentProtectionCaps(This, pCryptoType, pDecoderProfile, \
                                           pCaps)
#define ID3D11VideoDevice_CheckCryptoKeyExchange(                              \
...
#else
/*** IUnknown methods ***/
static inline HRESULT ID3D11VideoDevice_QueryInterface(ID3D11VideoDevice *This,
                                                       REFIID riid,
                                                       void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ID3D11VideoDevice methods ***/
static inline HRESULT ID3D11VideoDevice_CreateVideoDecoder(
    ID3D11VideoDevice *This, const D3D11_VIDEO_DECODER_DESC *pVideoDesc,
...
static inline HRESULT ID3D11VideoDevice_CreateVideoProcessor(
    ID3D11VideoDevice *This, ID3D11VideoProcessorEnumerator *pEnum,
    UINT RateConversionIndex, ID3D11VideoProcessor **ppVideoProcessor) {
  return This->lpVtbl->CreateVideoProcessor(This, pEnum, RateConversionIndex,
                                            ppVideoProcessor);
}
static inline HRESULT ID3D11VideoDevice_CreateAuthenticatedChannel(
    ID3D11VideoDevice *This, D3D11_AUTHENTICATED_CHANNEL_TYPE ChannelType,
    ID3D11AuthenticatedChannel **ppAuthenticatedChannel) {
  return This->lpVtbl->CreateAuthenticatedChannel(This, ChannelType,
                                                  ppAuthenticatedChannel);
}
static inline HRESULT ID3D11VideoDevice_CreateCryptoSession(
    ID3D11VideoDevice *This, const GUID *pCryptoType,
    const GUID *pDecoderProfile, const GUID *pKeyExchangeType,
    ID3D11CryptoSession **ppCryptoSession) {
  return This->lpVtbl->CreateCryptoSession(This, pCryptoType, pDecoderProfile,
                                           pKeyExchangeType, ppCryptoSession);
}
static inline HRESULT ID3D11VideoDevice_CreateVideoDecoderOutputView(
    ID3D11VideoDevice *This, ID3D11Resource *pResource,
    const D3D11_VIDEO_DECODER_OUTPUT_VIEW_DESC *pDesc,
    ID3D11VideoDecoderOutputView **ppVDOVView) {
  return This->lpVtbl->CreateVideoDecoderOutputView(This, pResource, pDesc,
                                                    ppVDOVView);
}
static inline HRESULT ID3D11VideoDevice_CreateVideoProcessorInputView(
    ID3D11VideoDevice *This, ID3D11Resource *pResource,
    ID3D11VideoProcessorEnumerator *pEnum,
    const D3D11_VIDEO_PROCESSOR_INPUT_VIEW_DESC *pDesc,
    ID3D11VideoProcessorInputView **ppVPIView) {
  return This->lpVtbl->CreateVideoProcessorInputView(This, pResource, pEnum,
                                                     pDesc, ppVPIView);
}
static inline HRESULT ID3D11VideoDevice_CreateVideoProcessorOutputView(
    ID3D11VideoDevice *This, ID3D11Resource *pResource,
    ID3D11VideoProcessorEnumerator *pEnum,
    const D3D11_VIDEO_PROCESSOR_OUTPUT_VIEW_DESC *pDesc,
    ID3D11VideoProcessorOutputView **ppVPOView) {
  return This->lpVtbl->CreateVideoProcessorOutputView(This, pResource, pEnum,
                                                      pDesc, ppVPOView);
}
static inline HRESULT ID3D11VideoDevice_CreateVideoProcessorEnumerator(
    ID3D11VideoDevice *This, const D3D11_VIDEO_PROCESSOR_CONTENT_DESC *pDesc,
    ID3D11VideoProcessorEnumerator **ppEnum) {
...
static inline HRESULT
ID3D11VideoDevice_GetVideoDecoderProfile(ID3D11VideoDevice *This, UINT Index,
                                         GUID *pDecoderProfile) {
  return This->lpVtbl->GetVideoDecoderProfile(This, Index, pDecoderProfile);
}
static inline HRESULT ID3D11VideoDevice_CheckVideoDecoderFormat(
    ID3D11VideoDevice *This, const GUID *pDecoderProfile, DXGI_FORMAT Format,
    WINBOOL *pSupported) {
  return This->lpVtbl->CheckVideoDecoderFormat(This, pDecoderProfile, Format,
                                               pSupported);
}
static inline HRESULT ID3D11VideoDevice_GetVideoDecoderConfigCount(
    ID3D11VideoDevice *This, const D3D11_VIDEO_DECODER_DESC *pDesc,
    UINT *pCount) {
  return This->lpVtbl->GetVideoDecoderConfigCount(This, pDesc, pCount);
}
static inline HRESULT ID3D11VideoDevice_GetVideoDecoderConfig(
    ID3D11VideoDevice *This, const D3D11_VIDEO_DECODER_DESC *pDesc, UINT Index,
    D3D11_VIDEO_DECODER_CONFIG *pConfig) {
  return This->lpVtbl->GetVideoDecoderConfig(This, pDesc, Index, pConfig);
}
static inline HRESULT ID3D11VideoDevice_GetContentProtectionCaps(
    ID3D11VideoDevice *This, const GUID *pCryptoType,
    const GUID *pDecoderProfile, D3D11_VIDEO_CONTENT_PROTECTION_CAPS *pCaps) {
  return This->lpVtbl->GetContentProtectionCaps(This, pCryptoType,
                                                pDecoderProfile, pCaps);
}
static inline HRESULT ID3D11VideoDevice_CheckCryptoKeyExchange(
    ID3D11VideoDevice *This, const GUID *pCryptoType,
    const GUID *pDecoderProfile, UINT Index, GUID *pKeyExchangeType) {
  return This->lpVtbl->CheckCryptoKeyExchange(
      This, pCryptoType, pDecoderProfile, Index, pKeyExchangeType);
}
static inline HRESULT ID3D11VideoDevice_SetPrivateData(ID3D11VideoDevice *This,
                                                       REFGUID guid,
                                                       UINT DataSize,
                                                       const void *pData) {
  return This->lpVtbl->SetPrivateData(This, guid, DataSize, pData);
...
static inline HRESULT
ID3D11VideoDevice_SetPrivateDataInterface(ID3D11VideoDevice *This, REFGUID guid,
                                          const IUnknown *pData) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, pData);
}
#endif
...
ID3D11VideoContext : public ID3D11DeviceChild {
  virtual HRESULT STDMETHODCALLTYPE GetDecoderBuffer(
      ...
      UINT * buffer_size, void **buffer) = 0;
  virtual HRESULT STDMETHODCALLTYPE ReleaseDecoderBuffer(
      ID3D11VideoDecoder * decoder, D3D11_VIDEO_DECODER_BUFFER_TYPE type) = 0;
  virtual HRESULT STDMETHODCALLTYPE DecoderBeginFrame(
      ID3D11VideoDecoder * decoder, ID3D11VideoDecoderOutputView * view,
      UINT key_size, const void *key) = 0;
  virtual HRESULT STDMETHODCALLTYPE DecoderEndFrame(ID3D11VideoDecoder *
                                                    decoder) = 0;
  virtual HRESULT STDMETHODCALLTYPE SubmitDecoderBuffers(
      ID3D11VideoDecoder * decoder, UINT buffers_count,
  ...
  virtual void STDMETHODCALLTYPE VideoProcessorSetOutputTargetRect(
      ID3D11VideoProcessor * processor, WINBOOL enable, const RECT *rect) = 0;
  virtual void STDMETHODCALLTYPE VideoProcessorSetOutputBackgroundColor(
      ID3D11VideoProcessor * processor, WINBOOL y_cb_cr,
  ...
  virtual void STDMETHODCALLTYPE VideoProcessorSetOutputConstriction(
      ID3D11VideoProcessor * processor, WINBOOL enable, SIZE size) = 0;
  virtual void STDMETHODCALLTYPE VideoProcessorSetOutputStereoMode(
      ID3D11VideoProcessor * processor, WINBOOL enable) = 0;
  virtual HRESULT STDMETHODCALLTYPE VideoProcessorSetOutputExtension(
      ID3D11VideoProcessor * processor, const GUID *guid, UINT data_size,
      void *data) = 0;
  virtual void STDMETHODCALLTYPE VideoProcessorGetOutputTargetRect(
      ID3D11VideoProcessor * processor, WINBOOL * enabled, RECT * rect) = 0;
  ...
  virtual void STDMETHODCALLTYPE VideoProcessorGetOutputConstriction(
      ID3D11VideoProcessor * processor, WINBOOL * enabled, SIZE * size) = 0;
  virtual void STDMETHODCALLTYPE VideoProcessorGetOutputStereoMode(
      ID3D11VideoProcessor * processor, WINBOOL * enabled) = 0;
  ...
  virtual void STDMETHODCALLTYPE VideoProcessorSetStreamFrameFormat(
      ID3D11VideoProcessor * processor, UINT stream_idx,
  ...
  virtual void STDMETHODCALLTYPE VideoProcessorSetStreamOutputRate(
      ID3D11VideoProcessor * processor, UINT stream_idx,
      D3D11_VIDEO_PROCESSOR_OUTPUT_RATE rate, WINBOOL repeat,
      const DXGI_RATIONAL *custom_rate) = 0;
  virtual void STDMETHODCALLTYPE VideoProcessorSetStreamSourceRect(
      ID3D11VideoProcessor * processor, UINT stream_idx, WINBOOL enable,
      const RECT *rect) = 0;
  ...
  virtual void STDMETHODCALLTYPE VideoProcessorSetStreamPalette(
      ID3D11VideoProcessor * processor, UINT stream_idx, UINT entry_count,
  ...
  virtual void STDMETHODCALLTYPE VideoProcessorSetStreamStereoFormat(
      ID3D11VideoProcessor * processor, UINT stream_idx, WINBOOL enable,
      D3D11_VIDEO_PROCESSOR_STEREO_FORMAT format, WINBOOL left_view_frame0,
      WINBOOL base_view_frame0,
      D3D11_VIDEO_PROCESSOR_STEREO_FLIP_MODE flip_mode, int mono_offset) = 0;
  virtual void STDMETHODCALLTYPE VideoProcessorSetStreamAutoProcessingMode(
      ID3D11VideoProcessor * processor, UINT stream_idx, WINBOOL enable) = 0;
  virtual void STDMETHODCALLTYPE VideoProcessorSetStreamFilter(
      ID3D11VideoProcessor * processor, UINT stream_idx,
      D3D11_VIDEO_PROCESSOR_FILTER filter, WINBOOL enable, int level) = 0;
  virtual HRESULT STDMETHODCALLTYPE VideoProcessorSetStreamExtension(
      ID3D11VideoProcessor * processor, UINT stream_idx, const GUID *guid,
      UINT data_size, void *data) = 0;
  ...
  virtual void STDMETHODCALLTYPE VideoProcessorGetStreamSourceRect(
      ID3D11VideoProcessor * processor, UINT stream_idx, WINBOOL * enabled,
      RECT * rect) = 0;
  ...
  virtual void STDMETHODCALLTYPE VideoProcessorGetStreamPixelAspectRatio(
      ID3D11VideoProcessor * processor, UINT stream_idx, WINBOOL * enabled,
      DXGI_RATIONAL * src_aspect_ratio, DXGI_RATIONAL * dst_aspect_ratio) = 0;
  ...
  virtual void STDMETHODCALLTYPE VideoProcessorGetStreamAutoProcessingMode(
      ID3D11VideoProcessor * processor, UINT stream_idx, WINBOOL * enabled) = 0;
  virtual void STDMETHODCALLTYPE VideoProcessorGetStreamFilter(
      ID3D11VideoProcessor * processor, UINT stream_idx,
      D3D11_VIDEO_PROCESSOR_FILTER filter, WINBOOL * enabled, int *level) = 0;
  virtual HRESULT STDMETHODCALLTYPE VideoProcessorGetStreamExtension(
      ID3D11VideoProcessor * processor, UINT stream_idx, const GUID *guid,
      UINT data_size, void *data) = 0;
  virtual HRESULT STDMETHODCALLTYPE VideoProcessorBlt(
      ID3D11VideoProcessor * processor, ID3D11VideoProcessorOutputView * view,
      UINT frame_idx, UINT stream_count,
      const D3D11_VIDEO_PROCESSOR_STREAM *streams) = 0;
  virtual HRESULT STDMETHODCALLTYPE NegotiateCryptoSessionKeyExchange(
      ID3D11CryptoSession * session, UINT data_size, void *data) = 0;
  virtual void STDMETHODCALLTYPE EncryptionBlt(
      ID3D11CryptoSession * session, ID3D11Texture2D * src_surface,
      ID3D11Texture2D * dst_surface, UINT iv_size, void *iv) = 0;
  virtual void STDMETHODCALLTYPE DecryptionBlt(
      ID3D11CryptoSession * session, ID3D11Texture2D * src_surface,
      ID3D11Texture2D * dst_surface, D3D11_ENCRYPTED_BLOCK_INFO * block_info,
      UINT key_size, const void *key, UINT iv_size, void *iv) = 0;
  virtual void STDMETHODCALLTYPE StartSessionKeyRefresh(
      ID3D11CryptoSession * session, UINT random_number_size,
      void *random_number) = 0;
  virtual void STDMETHODCALLTYPE FinishSessionKeyRefresh(ID3D11CryptoSession *
                                                         session) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetEncryptionBltKey(
      ID3D11CryptoSession * session, UINT key_size, void *key) = 0;
  virtual HRESULT STDMETHODCALLTYPE NegotiateAuthenticatedChannelKeyExchange(
      ID3D11AuthenticatedChannel * channel, UINT data_size, void *data) = 0;
  virtual HRESULT STDMETHODCALLTYPE QueryAuthenticatedChannel(
      ID3D11AuthenticatedChannel * channel, UINT input_size, const void *input,
      UINT output_size, void *output) = 0;
...
typedef struct ID3D11VideoContextVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11VideoContext *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetDecoderBuffer)(
      ID3D11VideoContext *This, ID3D11VideoDecoder *decoder,
      D3D11_VIDEO_DECODER_BUFFER_TYPE type, UINT *buffer_size, void **buffer);
  HRESULT(STDMETHODCALLTYPE *ReleaseDecoderBuffer)(
      ID3D11VideoContext *This, ID3D11VideoDecoder *decoder,
      D3D11_VIDEO_DECODER_BUFFER_TYPE type);
  HRESULT(STDMETHODCALLTYPE *DecoderBeginFrame)(
      ID3D11VideoContext *This, ID3D11VideoDecoder *decoder,
      ID3D11VideoDecoderOutputView *view, UINT key_size, const void *key);
  HRESULT(STDMETHODCALLTYPE *DecoderEndFrame)(ID3D11VideoContext *This,
                                              ID3D11VideoDecoder *decoder);
  HRESULT(STDMETHODCALLTYPE *SubmitDecoderBuffers)(
      ID3D11VideoContext *This, ID3D11VideoDecoder *decoder, UINT buffers_count,
  ...
  void(STDMETHODCALLTYPE *VideoProcessorSetOutputTargetRect)(
      ID3D11VideoContext *This, ID3D11VideoProcessor *processor, WINBOOL enable,
      const RECT *rect);
  void(STDMETHODCALLTYPE *VideoProcessorSetOutputBackgroundColor)(
      ID3D11VideoContext *This, ID3D11VideoProcessor *processor,
      WINBOOL y_cb_cr, const D3D11_VIDEO_COLOR *color);
  ...
  void(STDMETHODCALLTYPE *VideoProcessorSetOutputAlphaFillMode)(
      ID3D11VideoContext *This, ID3D11VideoProcessor *processor,
      D3D11_VIDEO_PROCESSOR_ALPHA_FILL_MODE alpha_fill_mode, UINT stream_idx);
  ...
  void(STDMETHODCALLTYPE *VideoProcessorGetStreamFilter)(
      ID3D11VideoContext *This, ID3D11VideoProcessor *processor,
      UINT stream_idx, D3D11_VIDEO_PROCESSOR_FILTER filter, WINBOOL *enabled,
      int *level);
  ...
  HRESULT(STDMETHODCALLTYPE *VideoProcessorBlt)(
      ID3D11VideoContext *This, ID3D11VideoProcessor *processor,
      ID3D11VideoProcessorOutputView *view, UINT frame_idx, UINT stream_count,
      const D3D11_VIDEO_PROCESSOR_STREAM *streams);
  HRESULT(STDMETHODCALLTYPE *NegotiateCryptoSessionKeyExchange)(
      ID3D11VideoContext *This, ID3D11CryptoSession *session, UINT data_size,
      void *data);
...
interface ID3D11VideoContext { CONST_VTBL ID3D11VideoContextVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define ID3D11VideoContext_SetPrivateDataInterface(This, guid, pData)          \
  (This)->lpVtbl->SetPrivateDataInterface(This, guid, pData)
/*** ID3D11VideoContext methods ***/
#define ID3D11VideoContext_GetDecoderBuffer(This, decoder, type, buffer_size,  \
                                            buffer)                            \
  (This)->lpVtbl->GetDecoderBuffer(This, decoder, type, buffer_size, buffer)
#define ID3D11VideoContext_ReleaseDecoderBuffer(This, decoder, type)           \
  (This)->lpVtbl->ReleaseDecoderBuffer(This, decoder, type)
#define ID3D11VideoContext_DecoderBeginFrame(This, decoder, view, key_size,    \
                                             key)                              \
  (This)->lpVtbl->DecoderBeginFrame(This, decoder, view, key_size, key)
#define ID3D11VideoContext_DecoderEndFrame(This, decoder)                      \
  (This)->lpVtbl->DecoderEndFrame(This, decoder)
#define ID3D11VideoContext_SubmitDecoderBuffers(This, decoder, buffers_count,  \
                                                buffer_desc)                   \
  (This)->lpVtbl->SubmitDecoderBuffers(This, decoder, buffers_count,           \
                                       buffer_desc)
#define ID3D11VideoContext_DecoderExtension(This, decoder, extension)          \
  (This)->lpVtbl->DecoderExtension(This, decoder, extension)
#define ID3D11VideoContext_VideoProcessorSetOutputTargetRect(This, processor,  \
                                                             enable, rect)     \
  (This)->lpVtbl->VideoProcessorSetOutputTargetRect(This, processor, enable,   \
                                                    rect)
#define ID3D11VideoContext_VideoProcessorSetOutputBackgroundColor(             \
    This, processor, y_cb_cr, color)                                           \
  (This)->lpVtbl->VideoProcessorSetOutputBackgroundColor(This, processor,      \
                                                         y_cb_cr, color)
#define ID3D11VideoContext_VideoProcessorSetOutputColorSpace(This, processor,  \
                                                             color_space)      \
  (This)->lpVtbl->VideoProcessorSetOutputColorSpace(This, processor,           \
                                                    color_space)
#define ID3D11VideoContext_VideoProcessorSetOutputAlphaFillMode(               \
    This, processor, alpha_fill_mode, stream_idx)                              \
  (This)->lpVtbl->VideoProcessorSetOutputAlphaFillMode(                        \
      This, processor, alpha_fill_mode, stream_idx)
#define ID3D11VideoContext_VideoProcessorSetOutputConstriction(                \
    This, processor, enable, size)                                             \
  (This)->lpVtbl->VideoProcessorSetOutputConstriction(This, processor, enable, \
                                                      size)
#define ID3D11VideoContext_VideoProcessorSetOutputStereoMode(This, processor,  \
                                                             enable)           \
  (This)->lpVtbl->VideoProcessorSetOutputStereoMode(This, processor, enable)
#define ID3D11VideoContext_VideoProcessorSetOutputExtension(                   \
    This, processor, guid, data_size, data)                                    \
  (This)->lpVtbl->VideoProcessorSetOutputExtension(This, processor, guid,      \
                                                   data_size, data)
#define ID3D11VideoContext_VideoProcessorGetOutputTargetRect(This, processor,  \
                                                             enabled, rect)    \
  (This)->lpVtbl->VideoProcessorGetOutputTargetRect(This, processor, enabled,  \
                                                    rect)
#define ID3D11VideoContext_VideoProcessorGetOutputBackgroundColor(             \
    This, processor, y_cb_cr, color)                                           \
  (This)->lpVtbl->VideoProcessorGetOutputBackgroundColor(This, processor,      \
                                                         y_cb_cr, color)
#define ID3D11VideoContext_VideoProcessorGetOutputColorSpace(This, processor,  \
                                                             color_space)      \
  (This)->lpVtbl->VideoProcessorGetOutputColorSpace(This, processor,           \
                                                    color_space)
#define ID3D11VideoContext_VideoProcessorGetOutputAlphaFillMode(               \
    This, processor, alpha_fill_mode, stream_idx)                              \
  (This)->lpVtbl->VideoProcessorGetOutputAlphaFillMode(                        \
      This, processor, alpha_fill_mode, stream_idx)
#define ID3D11VideoContext_VideoProcessorGetOutputConstriction(                \
    This, processor, enabled, size)                                            \
  (This)->lpVtbl->VideoProcessorGetOutputConstriction(This, processor,         \
                                                      enabled, size)
#define ID3D11VideoContext_VideoProcessorGetOutputStereoMode(This, processor,  \
                                                             enabled)          \
  (This)->lpVtbl->VideoProcessorGetOutputStereoMode(This, processor, enabled)
#define ID3D11VideoContext_VideoProcessorGetOutputExtension(                   \
    This, processor, guid, data_size, data)                                    \
  (This)->lpVtbl->VideoProcessorGetOutputExtension(This, processor, guid,      \
                                                   data_size, data)
#define ID3D11VideoContext_VideoProcessorSetStreamFrameFormat(                 \
    This, processor, stream_idx, format)                                       \
  (This)->lpVtbl->VideoProcessorSetStreamFrameFormat(This, processor,          \
                                                     stream_idx, format)
#define ID3D11VideoContext_VideoProcessorSetStreamColorSpace(                  \
    This, processor, stream_idx, color_space)                                  \
  (This)->lpVtbl->VideoProcessorSetStreamColorSpace(This, processor,           \
                                                    stream_idx, color_space)
#define ID3D11VideoContext_VideoProcessorSetStreamOutputRate(                  \
    This, processor, stream_idx, rate, repeat, custom_rate)                    \
  (This)->lpVtbl->VideoProcessorSetStreamOutputRate(                           \
      This, processor, stream_idx, rate, repeat, custom_rate)
#define ID3D11VideoContext_VideoProcessorSetStreamSourceRect(                  \
    This, processor, stream_idx, enable, rect)                                 \
  (This)->lpVtbl->VideoProcessorSetStreamSourceRect(This, processor,           \
                                                    stream_idx, enable, rect)
#define ID3D11VideoContext_VideoProcessorSetStreamDestRect(                    \
    This, processor, stream_idx, enable, rect)                                 \
  (This)->lpVtbl->VideoProcessorSetStreamDestRect(This, processor, stream_idx, \
                                                  enable, rect)
#define ID3D11VideoContext_VideoProcessorSetStreamAlpha(                       \
    This, processor, stream_idx, enable, alpha)                                \
  (This)->lpVtbl->VideoProcessorSetStreamAlpha(This, processor, stream_idx,    \
                                               enable, alpha)
#define ID3D11VideoContext_VideoProcessorSetStreamPalette(                     \
    This, processor, stream_idx, entry_count, entries)                         \
  (This)->lpVtbl->VideoProcessorSetStreamPalette(This, processor, stream_idx,  \
                                                 entry_count, entries)
#define ID3D11VideoContext_VideoProcessorSetStreamPixelAspectRatio(            \
    This, processor, stream_idx, enable, src_aspect_ratio, dst_aspect_ratio)   \
  (This)->lpVtbl->VideoProcessorSetStreamPixelAspectRatio(                     \
      This, processor, stream_idx, enable, src_aspect_ratio, dst_aspect_ratio)
#define ID3D11VideoContext_VideoProcessorSetStreamLumaKey(                     \
    This, processor, stream_idx, enable, lower, upper)                         \
  (This)->lpVtbl->VideoProcessorSetStreamLumaKey(This, processor, stream_idx,  \
                                                 enable, lower, upper)
#define ID3D11VideoContext_VideoProcessorSetStreamStereoFormat(                \
    This, processor, stream_idx, enable, format, left_view_frame0,             \
    base_view_frame0, flip_mode, mono_offset)                                  \
  (This)->lpVtbl->VideoProcessorSetStreamStereoFormat(                         \
      This, processor, stream_idx, enable, format, left_view_frame0,           \
      base_view_frame0, flip_mode, mono_offset)
#define ID3D11VideoContext_VideoProcessorSetStreamAutoProcessingMode(          \
    This, processor, stream_idx, enable)                                       \
  (This)->lpVtbl->VideoProcessorSetStreamAutoProcessingMode(                   \
      This, processor, stream_idx, enable)
#define ID3D11VideoContext_VideoProcessorSetStreamFilter(                      \
    This, processor, stream_idx, filter, enable, level)                        \
  (This)->lpVtbl->VideoProcessorSetStreamFilter(This, processor, stream_idx,   \
                                                filter, enable, level)
#define ID3D11VideoContext_VideoProcessorSetStreamExtension(                   \
    This, processor, stream_idx, guid, data_size, data)                        \
  (This)->lpVtbl->VideoProcessorSetStreamExtension(                            \
      This, processor, stream_idx, guid, data_size, data)
#define ID3D11VideoContext_VideoProcessorGetStreamFrameFormat(                 \
    This, processor, stream_idx, format)                                       \
  (This)->lpVtbl->VideoProcessorGetStreamFrameFormat(This, processor,          \
                                                     stream_idx, format)
#define ID3D11VideoContext_VideoProcessorGetStreamColorSpace(                  \
    This, processor, stream_idx, color_space)                                  \
  (This)->lpVtbl->VideoProcessorGetStreamColorSpace(This, processor,           \
                                                    stream_idx, color_space)
#define ID3D11VideoContext_VideoProcessorGetStreamOutputRate(                  \
    This, processor, stream_idx, rate, repeat, custom_rate)                    \
  (This)->lpVtbl->VideoProcessorGetStreamOutputRate(                           \
      This, processor, stream_idx, rate, repeat, custom_rate)
#define ID3D11VideoContext_VideoProcessorGetStreamSourceRect(                  \
    This, processor, stream_idx, enabled, rect)                                \
  (This)->lpVtbl->VideoProcessorGetStreamSourceRect(This, processor,           \
                                                    stream_idx, enabled, rect)
#define ID3D11VideoContext_VideoProcessorGetStreamDestRect(                    \
    This, processor, stream_idx, enabled, rect)                                \
  (This)->lpVtbl->VideoProcessorGetStreamDestRect(This, processor, stream_idx, \
                                                  enabled, rect)
#define ID3D11VideoContext_VideoProcessorGetStreamAlpha(                       \
    This, processor, stream_idx, enabled, alpha)                               \
  (This)->lpVtbl->VideoProcessorGetStreamAlpha(This, processor, stream_idx,    \
                                               enabled, alpha)
#define ID3D11VideoContext_VideoProcessorGetStreamPalette(                     \
    This, processor, stream_idx, entry_count, entries)                         \
  (This)->lpVtbl->VideoProcessorGetStreamPalette(This, processor, stream_idx,  \
                                                 entry_count, entries)
#define ID3D11VideoContext_VideoProcessorGetStreamPixelAspectRatio(            \
    This, processor, stream_idx, enabled, src_aspect_ratio, dst_aspect_ratio)  \
  (This)->lpVtbl->VideoProcessorGetStreamPixelAspectRatio(                     \
      This, processor, stream_idx, enabled, src_aspect_ratio,                  \
      dst_aspect_ratio)
#define ID3D11VideoContext_VideoProcessorGetStreamLumaKey(                     \
    This, processor, stream_idx, enabled, lower, upper)                        \
  (This)->lpVtbl->VideoProcessorGetStreamLumaKey(This, processor, stream_idx,  \
                                                 enabled, lower, upper)
#define ID3D11VideoContext_VideoProcessorGetStreamStereoFormat(                \
    This, processor, stream_idx, enabled, format, left_view_frame0,            \
    base_view_frame0, flip_mode, mono_offset)                                  \
  (This)->lpVtbl->VideoProcessorGetStreamStereoFormat(                         \
      This, processor, stream_idx, enabled, format, left_view_frame0,          \
      base_view_frame0, flip_mode, mono_offset)
#define ID3D11VideoContext_VideoProcessorGetStreamAutoProcessingMode(          \
    This, processor, stream_idx, enabled)                                      \
  (This)->lpVtbl->VideoProcessorGetStreamAutoProcessingMode(                   \
      This, processor, stream_idx, enabled)
#define ID3D11VideoContext_VideoProcessorGetStreamFilter(                      \
    This, processor, stream_idx, filter, enabled, level)                       \
  (This)->lpVtbl->VideoProcessorGetStreamFilter(This, processor, stream_idx,   \
                                                filter, enabled, level)
#define ID3D11VideoContext_VideoProcessorGetStreamExtension(                   \
    This, processor, stream_idx, guid, data_size, data)                        \
  (This)->lpVtbl->VideoProcessorGetStreamExtension(                            \
      This, processor, stream_idx, guid, data_size, data)
#define ID3D11VideoContext_VideoProcessorBlt(This, processor, view, frame_idx, \
                                             stream_count, streams)            \
  (This)->lpVtbl->VideoProcessorBlt(This, processor, view, frame_idx,          \
                                    stream_count, streams)
#define ID3D11VideoContext_NegotiateCryptoSessionKeyExchange(This, session,    \
                                                             data_size, data)  \
  (This)->lpVtbl->NegotiateCryptoSessionKeyExchange(This, session, data_size,  \
                                                    data)
#define ID3D11VideoContext_EncryptionBlt(This, session, src_surface,           \
                                         dst_surface, iv_size, iv)             \
  (This)->lpVtbl->EncryptionBlt(This, session, src_surface, dst_surface,       \
                                iv_size, iv)
#define ID3D11VideoContext_DecryptionBlt(This, session, src_surface,           \
                                         dst_surface, block_info, key_size,    \
                                         key, iv_size, iv)                     \
  (This)->lpVtbl->DecryptionBlt(This, session, src_surface, dst_surface,       \
                                block_info, key_size, key, iv_size, iv)
#define ID3D11VideoContext_StartSessionKeyRefresh(                             \
    This, session, random_number_size, random_number)                          \
  (This)->lpVtbl->StartSessionKeyRefresh(This, session, random_number_size,    \
                                         random_number)
#define ID3D11VideoContext_FinishSessionKeyRefresh(This, session)              \
  (This)->lpVtbl->FinishSessionKeyRefresh(This, session)
#define ID3D11VideoContext_GetEncryptionBltKey(This, session, key_size, key)   \
  (This)->lpVtbl->GetEncryptionBltKey(This, session, key_size, key)
#define ID3D11VideoContext_NegotiateAuthenticatedChannelKeyExchange(           \
    This, channel, data_size, data)                                            \
  (This)->lpVtbl->NegotiateAuthenticatedChannelKeyExchange(This, channel,      \
                                                           data_size, data)
#define ID3D11VideoContext_QueryAuthenticatedChannel(                          \
    This, channel, input_size, input, output_size, output)                     \
  (This)->lpVtbl->QueryAuthenticatedChannel(This, channel, input_size, input,  \
                                            output_size, output)
#define ID3D11VideoContext_ConfigureAuthenticatedChannel(                      \
    This, channel, input_size, input, output)                                  \
  (This)->lpVtbl->ConfigureAuthenticatedChannel(This, channel, input_size,     \
                                                input, output)
#define ID3D11VideoContext_VideoProcessorSetStreamRotation(                    \
    This, processor, stream_idx, enable, rotation)                             \
  (This)->lpVtbl->VideoProcessorSetStreamRotation(This, processor, stream_idx, \
                                                  enable, rotation)
#define ID3D11VideoContext_VideoProcessorGetStreamRotation(                    \
    This, processor, stream_idx, enable, rotation)                             \
  (This)->lpVtbl->VideoProcessorGetStreamRotation(This, processor, stream_idx, \
                                                  enable, rotation)
#else
/*** IUnknown methods ***/
static inline HRESULT
ID3D11VideoContext_QueryInterface(ID3D11VideoContext *This, REFIID riid,
                                  void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ID3D11DeviceChild methods ***/
static inline void ID3D11VideoContext_GetDevice(ID3D11VideoContext *This,
                                                ID3D11Device **ppDevice) {
  This->lpVtbl->GetDevice(This, ppDevice);
}
static inline HRESULT
ID3D11VideoContext_GetPrivateData(ID3D11VideoContext *This, REFGUID guid,
                                  UINT *pDataSize, void *pData) {
  return This->lpVtbl->GetPrivateData(This, guid, pDataSize, pData);
}
static inline HRESULT
ID3D11VideoContext_SetPrivateData(ID3D11VideoContext *This, REFGUID guid,
                                  UINT DataSize, const void *pData) {
  return This->lpVtbl->SetPrivateData(This, guid, DataSize, pData);
}
static inline HRESULT ID3D11VideoContext_SetPrivateDataInterface(
    ID3D11VideoContext *This, REFGUID guid, const IUnknown *pData) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, pData);
}
/*** ID3D11VideoContext methods ***/
static inline HRESULT ID3D11VideoContext_GetDecoderBuffer(
    ID3D11VideoContext *This, ID3D11VideoDecoder *decoder,
    D3D11_VIDEO_DECODER_BUFFER_TYPE type, UINT *buffer_size, void **buffer) {
  return This->lpVtbl->GetDecoderBuffer(This, decoder, type, buffer_size,
                                        buffer);
}
static inline HRESULT
ID3D11VideoContext_ReleaseDecoderBuffer(ID3D11VideoContext *This,
                                        ID3D11VideoDecoder *decoder,
                                        D3D11_VIDEO_DECODER_BUFFER_TYPE type) {
  return This->lpVtbl->ReleaseDecoderBuffer(This, decoder, type);
}
static inline HRESULT ID3D11VideoContext_DecoderBeginFrame(
    ID3D11VideoContext *This, ID3D11VideoDecoder *decoder,
    ID3D11VideoDecoderOutputView *view, UINT key_size, const void *key) {
  return This->lpVtbl->DecoderBeginFrame(This, decoder, view, key_size, key);
}
static inline HRESULT
ID3D11VideoContext_DecoderEndFrame(ID3D11VideoContext *This,
                                   ID3D11VideoDecoder *decoder) {
...
static inline HRESULT ID3D11VideoContext_SubmitDecoderBuffers(
    ID3D11VideoContext *This, ID3D11VideoDecoder *decoder, UINT buffers_count,
    const D3D11_VIDEO_DECODER_BUFFER_DESC *buffer_desc) {
  return This->lpVtbl->SubmitDecoderBuffers(This, decoder, buffers_count,
                                            buffer_desc);
}
static inline HRESULT ID3D11VideoContext_DecoderExtension(
    ID3D11VideoContext *This, ID3D11VideoDecoder *decoder,
    const D3D11_VIDEO_DECODER_EXTENSION *extension) {
  return This->lpVtbl->DecoderExtension(This, decoder, extension);
}
static inline void ID3D11VideoContext_VideoProcessorSetOutputTargetRect(
    ID3D11VideoContext *This, ID3D11VideoProcessor *processor, WINBOOL enable,
    const RECT *rect) {
  This->lpVtbl->VideoProcessorSetOutputTargetRect(This, processor, enable,
                                                  rect);
}
static inline void ID3D11VideoContext_VideoProcessorSetOutputBackgroundColor(
    ID3D11VideoContext *This, ID3D11VideoProcessor *processor, WINBOOL y_cb_cr,
    const D3D11_VIDEO_COLOR *color) {
  This->lpVtbl->VideoProcessorSetOutputBackgroundColor(This, processor, y_cb_cr,
                                                       color);
}
static inline void ID3D11VideoContext_VideoProcessorSetOutputColorSpace(
    ID3D11VideoContext *This, ID3D11VideoProcessor *processor,
    const D3D11_VIDEO_PROCESSOR_COLOR_SPACE *color_space) {
  This->lpVtbl->VideoProcessorSetOutputColorSpace(This, processor, color_space);
}
static inline void ID3D11VideoContext_VideoProcessorSetOutputAlphaFillMode(
    ID3D11VideoContext *This, ID3D11VideoProcessor *processor,
    D3D11_VIDEO_PROCESSOR_ALPHA_FILL_MODE alpha_fill_mode, UINT stream_idx) {
  This->lpVtbl->VideoProcessorSetOutputAlphaFillMode(
      This, processor, alpha_fill_mode, stream_idx);
}
static inline void ID3D11VideoContext_VideoProcessorSetOutputConstriction(
    ID3D11VideoContext *This, ID3D11VideoProcessor *processor, WINBOOL enable,
    SIZE size) {
  This->lpVtbl->VideoProcessorSetOutputConstriction(This, processor, enable,
                                                    size);
}
static inline void ID3D11VideoContext_VideoProcessorSetOutputStereoMode(
    ID3D11VideoContext *This, ID3D11VideoProcessor *processor, WINBOOL enable) {
  This->lpVtbl->VideoProcessorSetOutputStereoMode(This, processor, enable);
}
static inline HRESULT ID3D11VideoContext_VideoProcessorSetOutputExtension(
    ID3D11VideoContext *This, ID3D11VideoProcessor *processor, const GUID *guid,
    UINT data_size, void *data) {
  return This->lpVtbl->VideoProcessorSetOutputExtension(This, processor, guid,
                                                        data_size, data);
}
static inline void ID3D11VideoContext_VideoProcessorGetOutputTargetRect(
    ID3D11VideoContext *This, ID3D11VideoProcessor *processor, WINBOOL *enabled,
    RECT *rect) {
  This->lpVtbl->VideoProcessorGetOutputTargetRect(This, processor, enabled,
                                                  rect);
}
static inline void ID3D11VideoContext_VideoProcessorGetOutputBackgroundColor(
    ID3D11VideoContext *This, ID3D11VideoProcessor *processor, WINBOOL *y_cb_cr,
    D3D11_VIDEO_COLOR *color) {
  This->lpVtbl->VideoProcessorGetOutputBackgroundColor(This, processor, y_cb_cr,
                                                       color);
}
static inline void ID3D11VideoContext_VideoProcessorGetOutputColorSpace(
    ID3D11VideoContext *This, ID3D11VideoProcessor *processor,
    D3D11_VIDEO_PROCESSOR_COLOR_SPACE *color_space) {
  This->lpVtbl->VideoProcessorGetOutputColorSpace(This, processor, color_space);
}
static inline void ID3D11VideoContext_VideoProcessorGetOutputAlphaFillMode(
    ID3D11VideoContext *This, ID3D11VideoProcessor *processor,
    D3D11_VIDEO_PROCESSOR_ALPHA_FILL_MODE *alpha_fill_mode, UINT *stream_idx) {
  This->lpVtbl->VideoProcessorGetOutputAlphaFillMode(
      This, processor, alpha_fill_mode, stream_idx);
}
static inline void ID3D11VideoContext_VideoProcessorGetOutputConstriction(
    ID3D11VideoContext *This, ID3D11VideoProcessor *processor, WINBOOL *enabled,
    SIZE *size) {
  This->lpVtbl->VideoProcessorGetOutputConstriction(This, processor, enabled,
                                                    size);
}
static inline void ID3D11VideoContext_VideoProcessorGetOutputStereoMode(
    ID3D11VideoContext *This, ID3D11VideoProcessor *processor,
    WINBOOL *enabled) {
  This->lpVtbl->VideoProcessorGetOutputStereoMode(This, processor, enabled);
}
static inline HRESULT ID3D11VideoContext_VideoProcessorGetOutputExtension(
    ID3D11VideoContext *This, ID3D11VideoProcessor *processor, const GUID *guid,
    UINT data_size, void *data) {
  return This->lpVtbl->VideoProcessorGetOutputExtension(This, processor, guid,
                                                        data_size, data);
}
static inline void ID3D11VideoContext_VideoProcessorSetStreamFrameFormat(
    ID3D11VideoContext *This, ID3D11VideoProcessor *processor, UINT stream_idx,
    D3D11_VIDEO_FRAME_FORMAT format) {
  This->lpVtbl->VideoProcessorSetStreamFrameFormat(This, processor, stream_idx,
                                                   format);
}
static inline void ID3D11VideoContext_VideoProcessorSetStreamColorSpace(
    ID3D11VideoContext *This, ID3D11VideoProcessor *processor, UINT stream_idx,
    const D3D11_VIDEO_PROCESSOR_COLOR_SPACE *color_space) {
  This->lpVtbl->VideoProcessorSetStreamColorSpace(This, processor, stream_idx,
                                                  color_space);
}
static inline void ID3D11VideoContext_VideoProcessorSetStreamOutputRate(
    ID3D11VideoContext *This, ID3D11VideoProcessor *processor, UINT stream_idx,
    D3D11_VIDEO_PROCESSOR_OUTPUT_RATE rate, WINBOOL repeat,
    const DXGI_RATIONAL *custom_rate) {
  This->lpVtbl->VideoProcessorSetStreamOutputRate(This, processor, stream_idx,
                                                  rate, repeat, custom_rate);
}
static inline void ID3D11VideoContext_VideoProcessorSetStreamSourceRect(
    ID3D11VideoContext *This, ID3D11VideoProcessor *processor, UINT stream_idx,
    WINBOOL enable, const RECT *rect) {
  This->lpVtbl->VideoProcessorSetStreamSourceRect(This, processor, stream_idx,
                                                  enable, rect);
}
static inline void ID3D11VideoContext_VideoProcessorSetStreamDestRect(
    ID3D11VideoContext *This, ID3D11VideoProcessor *processor, UINT stream_idx,
    WINBOOL enable, const RECT *rect) {
  This->lpVtbl->VideoProcessorSetStreamDestRect(This, processor, stream_idx,
                                                enable, rect);
}
static inline void ID3D11VideoContext_VideoProcessorSetStreamAlpha(
    ID3D11VideoContext *This, ID3D11VideoProcessor *processor, UINT stream_idx,
    WINBOOL enable, float alpha) {
  This->lpVtbl->VideoProcessorSetStreamAlpha(This, processor, stream_idx,
                                             enable, alpha);
}
static inline void ID3D11VideoContext_VideoProcessorSetStreamPalette(
    ID3D11VideoContext *This, ID3D11VideoProcessor *processor, UINT stream_idx,
    UINT entry_count, const UINT *entries) {
  This->lpVtbl->VideoProcessorSetStreamPalette(This, processor, stream_idx,
                                               entry_count, entries);
}
static inline void ID3D11VideoContext_VideoProcessorSetStreamPixelAspectRatio(
    ID3D11VideoContext *This, ID3D11VideoProcessor *processor, UINT stream_idx,
    WINBOOL enable, const DXGI_RATIONAL *src_aspect_ratio,
    const DXGI_RATIONAL *dst_aspect_ratio) {
  This->lpVtbl->VideoProcessorSetStreamPixelAspectRatio(
      This, processor, stream_idx, enable, src_aspect_ratio, dst_aspect_ratio);
}
static inline void ID3D11VideoContext_VideoProcessorSetStreamLumaKey(
    ID3D11VideoContext *This, ID3D11VideoProcessor *processor, UINT stream_idx,
    WINBOOL enable, float lower, float upper) {
  This->lpVtbl->VideoProcessorSetStreamLumaKey(This, processor, stream_idx,
                                               enable, lower, upper);
}
static inline void ID3D11VideoContext_VideoProcessorSetStreamStereoFormat(
    ID3D11VideoContext *This, ID3D11VideoProcessor *processor, UINT stream_idx,
    WINBOOL enable, D3D11_VIDEO_PROCESSOR_STEREO_FORMAT format,
    WINBOOL left_view_frame0, WINBOOL base_view_frame0,
    D3D11_VIDEO_PROCESSOR_STEREO_FLIP_MODE flip_mode, int mono_offset) {
  This->lpVtbl->VideoProcessorSetStreamStereoFormat(
      This, processor, stream_idx, enable, format, left_view_frame0,
      base_view_frame0, flip_mode, mono_offset);
}
static inline void ID3D11VideoContext_VideoProcessorSetStreamAutoProcessingMode(
    ID3D11VideoContext *This, ID3D11VideoProcessor *processor, UINT stream_idx,
    WINBOOL enable) {
  This->lpVtbl->VideoProcessorSetStreamAutoProcessingMode(This, processor,
                                                          stream_idx, enable);
}
static inline void ID3D11VideoContext_VideoProcessorSetStreamFilter(
    ID3D11VideoContext *This, ID3D11VideoProcessor *processor, UINT stream_idx,
    D3D11_VIDEO_PROCESSOR_FILTER filter, WINBOOL enable, int level) {
  This->lpVtbl->VideoProcessorSetStreamFilter(This, processor, stream_idx,
                                              filter, enable, level);
}
static inline HRESULT ID3D11VideoContext_VideoProcessorSetStreamExtension(
    ID3D11VideoContext *This, ID3D11VideoProcessor *processor, UINT stream_idx,
    const GUID *guid, UINT data_size, void *data) {
  return This->lpVtbl->VideoProcessorSetStreamExtension(
      This, processor, stream_idx, guid, data_size, data);
}
static inline void ID3D11VideoContext_VideoProcessorGetStreamFrameFormat(
    ID3D11VideoContext *This, ID3D11VideoProcessor *processor, UINT stream_idx,
    D3D11_VIDEO_FRAME_FORMAT *format) {
  This->lpVtbl->VideoProcessorGetStreamFrameFormat(This, processor, stream_idx,
                                                   format);
}
static inline void ID3D11VideoContext_VideoProcessorGetStreamColorSpace(
    ID3D11VideoContext *This, ID3D11VideoProcessor *processor, UINT stream_idx,
    D3D11_VIDEO_PROCESSOR_COLOR_SPACE *color_space) {
  This->lpVtbl->VideoProcessorGetStreamColorSpace(This, processor, stream_idx,
                                                  color_space);
}
static inline void ID3D11VideoContext_VideoProcessorGetStreamOutputRate(
    ID3D11VideoContext *This, ID3D11VideoProcessor *processor, UINT stream_idx,
    D3D11_VIDEO_PROCESSOR_OUTPUT_RATE *rate, WINBOOL *repeat,
    DXGI_RATIONAL *custom_rate) {
  This->lpVtbl->VideoProcessorGetStreamOutputRate(This, processor, stream_idx,
                                                  rate, repeat, custom_rate);
}
static inline void ID3D11VideoContext_VideoProcessorGetStreamSourceRect(
    ID3D11VideoContext *This, ID3D11VideoProcessor *processor, UINT stream_idx,
    WINBOOL *enabled, RECT *rect) {
  This->lpVtbl->VideoProcessorGetStreamSourceRect(This, processor, stream_idx,
                                                  enabled, rect);
}
static inline void ID3D11VideoContext_VideoProcessorGetStreamDestRect(
    ID3D11VideoContext *This, ID3D11VideoProcessor *processor, UINT stream_idx,
    WINBOOL *enabled, RECT *rect) {
  This->lpVtbl->VideoProcessorGetStreamDestRect(This, processor, stream_idx,
                                                enabled, rect);
}
static inline void ID3D11VideoContext_VideoProcessorGetStreamAlpha(
    ID3D11VideoContext *This, ID3D11VideoProcessor *processor, UINT stream_idx,
    WINBOOL *enabled, float *alpha) {
  This->lpVtbl->VideoProcessorGetStreamAlpha(This, processor, stream_idx,
                                             enabled, alpha);
}
static inline void ID3D11VideoContext_VideoProcessorGetStreamPalette(
    ID3D11VideoContext *This, ID3D11VideoProcessor *processor, UINT stream_idx,
    UINT entry_count, UINT *entries) {
  This->lpVtbl->VideoProcessorGetStreamPalette(This, processor, stream_idx,
                                               entry_count, entries);
}
static inline void ID3D11VideoContext_VideoProcessorGetStreamPixelAspectRatio(
    ID3D11VideoContext *This, ID3D11VideoProcessor *processor, UINT stream_idx,
    WINBOOL *enabled, DXGI_RATIONAL *src_aspect_ratio,
    DXGI_RATIONAL *dst_aspect_ratio) {
  This->lpVtbl->VideoProcessorGetStreamPixelAspectRatio(
      This, processor, stream_idx, enabled, src_aspect_ratio, dst_aspect_ratio);
}
static inline void ID3D11VideoContext_VideoProcessorGetStreamLumaKey(
    ID3D11VideoContext *This, ID3D11VideoProcessor *processor, UINT stream_idx,
    WINBOOL *enabled, float *lower, float *upper) {
  This->lpVtbl->VideoProcessorGetStreamLumaKey(This, processor, stream_idx,
                                               enabled, lower, upper);
}
static inline void ID3D11VideoContext_VideoProcessorGetStreamStereoFormat(
    ID3D11VideoContext *This, ID3D11VideoProcessor *processor, UINT stream_idx,
    WINBOOL *enabled, D3D11_VIDEO_PROCESSOR_STEREO_FORMAT *format,
    WINBOOL *left_view_frame0, WINBOOL *base_view_frame0,
    D3D11_VIDEO_PROCESSOR_STEREO_FLIP_MODE *flip_mode, int *mono_offset) {
  This->lpVtbl->VideoProcessorGetStreamStereoFormat(
      This, processor, stream_idx, enabled, format, left_view_frame0,
...
static inline void ID3D11VideoContext_VideoProcessorGetStreamAutoProcessingMode(
    ID3D11VideoContext *This, ID3D11VideoProcessor *processor, UINT stream_idx,
    WINBOOL *enabled) {
  This->lpVtbl->VideoProcessorGetStreamAutoProcessingMode(This, processor,
                                                          stream_idx, enabled);
}
static inline void ID3D11VideoContext_VideoProcessorGetStreamFilter(
    ID3D11VideoContext *This, ID3D11VideoProcessor *processor, UINT stream_idx,
    D3D11_VIDEO_PROCESSOR_FILTER filter, WINBOOL *enabled, int *level) {
  This->lpVtbl->VideoProcessorGetStreamFilter(This, processor, stream_idx,
                                              filter, enabled, level);
}
static inline HRESULT ID3D11VideoContext_VideoProcessorGetStreamExtension(
    ID3D11VideoContext *This, ID3D11VideoProcessor *processor, UINT stream_idx,
    const GUID *guid, UINT data_size, void *data) {
  return This->lpVtbl->VideoProcessorGetStreamExtension(
      This, processor, stream_idx, guid, data_size, data);
}
static inline HRESULT ID3D11VideoContext_VideoProcessorBlt(
    ID3D11VideoContext *This, ID3D11VideoProcessor *processor,
    ID3D11VideoProcessorOutputView *view, UINT frame_idx, UINT stream_count,
    const D3D11_VIDEO_PROCESSOR_STREAM *streams) {
  return This->lpVtbl->VideoProcessorBlt(This, processor, view, frame_idx,
                                         stream_count, streams);
}
static inline HRESULT ID3D11VideoContext_NegotiateCryptoSessionKeyExchange(
    ID3D11VideoContext *This, ID3D11CryptoSession *session, UINT data_size,
    void *data) {
  return This->lpVtbl->NegotiateCryptoSessionKeyExchange(This, session,
                                                         data_size, data);
}
static inline void ID3D11VideoContext_EncryptionBlt(
    ID3D11VideoContext *This, ID3D11CryptoSession *session,
    ID3D11Texture2D *src_surface, ID3D11Texture2D *dst_surface, UINT iv_size,
    void *iv) {
  This->lpVtbl->EncryptionBlt(This, session, src_surface, dst_surface, iv_size,
                              iv);
}
static inline void ID3D11VideoContext_DecryptionBlt(
    ID3D11VideoContext *This, ID3D11CryptoSession *session,
    ID3D11Texture2D *src_surface, ID3D11Texture2D *dst_surface,
    D3D11_ENCRYPTED_BLOCK_INFO *block_info, UINT key_size, const void *key,
    UINT iv_size, void *iv) {
  This->lpVtbl->DecryptionBlt(This, session, src_surface, dst_surface,
                              block_info, key_size, key, iv_size, iv);
}
static inline void ID3D11VideoContext_StartSessionKeyRefresh(
    ID3D11VideoContext *This, ID3D11CryptoSession *session,
    UINT random_number_size, void *random_number) {
  This->lpVtbl->StartSessionKeyRefresh(This, session, random_number_size,
                                       random_number);
}
static inline void
ID3D11VideoContext_FinishSessionKeyRefresh(ID3D11VideoContext *This,
                                           ID3D11CryptoSession *session) {
  This->lpVtbl->FinishSessionKeyRefresh(This, session);
}
static inline HRESULT
ID3D11VideoContext_GetEncryptionBltKey(ID3D11VideoContext *This,
                                       ID3D11CryptoSession *session,
                                       UINT key_size, void *key) {
...
ID3D11VideoContext_NegotiateAuthenticatedChannelKeyExchange(
    ID3D11VideoContext *This, ID3D11AuthenticatedChannel *channel,
    UINT data_size, void *data) {
  return This->lpVtbl->NegotiateAuthenticatedChannelKeyExchange(
      This, channel, data_size, data);
}
static inline HRESULT ID3D11VideoContext_QueryAuthenticatedChannel(
    ID3D11VideoContext *This, ID3D11AuthenticatedChannel *channel,
    UINT input_size, const void *input, UINT output_size, void *output) {
  return This->lpVtbl->QueryAuthenticatedChannel(This, channel, input_size,
                                                 input, output_size, output);
}
static inline HRESULT ID3D11VideoContext_ConfigureAuthenticatedChannel(
    ID3D11VideoContext *This, ID3D11AuthenticatedChannel *channel,
    UINT input_size, const void *input,
    D3D11_AUTHENTICATED_CONFIGURE_OUTPUT *output) {
  return This->lpVtbl->ConfigureAuthenticatedChannel(This, channel, input_size,
                                                     input, output);
}
static inline void ID3D11VideoContext_VideoProcessorSetStreamRotation(
    ID3D11VideoContext *This, ID3D11VideoProcessor *processor, UINT stream_idx,
    WINBOOL enable, D3D11_VIDEO_PROCESSOR_ROTATION rotation) {
  This->lpVtbl->VideoProcessorSetStreamRotation(This, processor, stream_idx,
                                                enable, rotation);
}
...
ID3D11Device : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE CreateBuffer(
      ...
      const D3D11_SUBRESOURCE_DATA *pInitialData, ID3D11Buffer **ppBuffer) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE CreatePixelShader(
      const void *pShaderBytecode, SIZE_T BytecodeLength,
      ID3D11ClassLinkage *pClassLinkage, ID3D11PixelShader **ppPixelShader) = 0;
  virtual HRESULT STDMETHODCALLTYPE CreateHullShader(
      const void *pShaderBytecode, SIZE_T BytecodeLength,
      ID3D11ClassLinkage *pClassLinkage, ID3D11HullShader **ppHullShader) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE CreateClassLinkage(ID3D11ClassLinkage *
                                                       *ppLinkage) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE CreateQuery(
      const D3D11_QUERY_DESC *pQueryDesc, ID3D11Query **ppQuery) = 0;
  virtual HRESULT STDMETHODCALLTYPE CreatePredicate(
      const D3D11_QUERY_DESC *pPredicateDesc,
      ID3D11Predicate **ppPredicate) = 0;
  virtual HRESULT STDMETHODCALLTYPE CreateCounter(
      const D3D11_COUNTER_DESC *pCounterDesc, ID3D11Counter **ppCounter) = 0;
  virtual HRESULT STDMETHODCALLTYPE CreateDeferredContext(
      UINT ContextFlags, ID3D11DeviceContext * *ppDeferredContext) = 0;
  virtual HRESULT STDMETHODCALLTYPE OpenSharedResource(
      HANDLE hResource, REFIID ReturnedInterface, void **ppResource) = 0;
  virtual HRESULT STDMETHODCALLTYPE CheckFormatSupport(
      DXGI_FORMAT Format, UINT * pFormatSupport) = 0;
  virtual HRESULT STDMETHODCALLTYPE CheckMultisampleQualityLevels(
      DXGI_FORMAT Format, UINT SampleCount, UINT * pNumQualityLevels) = 0;
  virtual void STDMETHODCALLTYPE CheckCounterInfo(D3D11_COUNTER_INFO *
                                                  pCounterInfo) = 0;
  virtual HRESULT STDMETHODCALLTYPE CheckCounter(
      ...
      UINT *pUnitsLength, LPSTR szDescription, UINT *pDescriptionLength) = 0;
  ...
  virtual void STDMETHODCALLTYPE GetImmediateContext(ID3D11DeviceContext *
...
typedef struct ID3D11DeviceVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *CreateTexture3D)(
      ID3D11Device *This, const D3D11_TEXTURE3D_DESC *pDesc,
      const D3D11_SUBRESOURCE_DATA *pInitialData,
  ...
  HRESULT(STDMETHODCALLTYPE *CreateInputLayout)(
      ID3D11Device *This, const D3D11_INPUT_ELEMENT_DESC *pInputElementDescs,
      UINT NumElements, const void *pShaderBytecodeWithInputSignature,
      SIZE_T BytecodeLength, ID3D11InputLayout **ppInputLayout);
  HRESULT(STDMETHODCALLTYPE *CreateVertexShader)(
      ID3D11Device *This, const void *pShaderBytecode, SIZE_T BytecodeLength,
  ...
  HRESULT(STDMETHODCALLTYPE *CreateClassLinkage)(
      ID3D11Device *This, ID3D11ClassLinkage **ppLinkage);
  HRESULT(STDMETHODCALLTYPE *CreateBlendState)(
      ID3D11Device *This, const D3D11_BLEND_DESC *pBlendStateDesc,
      ID3D11BlendState **ppBlendState);
  HRESULT(STDMETHODCALLTYPE *CreateDepthStencilState)(
      ID3D11Device *This, const D3D11_DEPTH_STENCIL_DESC *pDepthStencilDesc,
      ID3D11DepthStencilState **ppDepthStencilState);
  HRESULT(STDMETHODCALLTYPE *CreateRasterizerState)(
      ID3D11Device *This, const D3D11_RASTERIZER_DESC *pRasterizerDesc,
      ID3D11RasterizerState **ppRasterizerState);
  HRESULT(STDMETHODCALLTYPE *CreateSamplerState)(
      ID3D11Device *This, const D3D11_SAMPLER_DESC *pSamplerDesc,
      ID3D11SamplerState **ppSamplerState);
  HRESULT(STDMETHODCALLTYPE *CreateQuery)(ID3D11Device *This,
                                          const D3D11_QUERY_DESC *pQueryDesc,
                                          ID3D11Query **ppQuery);
  HRESULT(STDMETHODCALLTYPE *CreatePredicate)(
      ID3D11Device *This, const D3D11_QUERY_DESC *pPredicateDesc,
      ID3D11Predicate **ppPredicate);
  HRESULT(STDMETHODCALLTYPE *CreateCounter)(
      ID3D11Device *This, const D3D11_COUNTER_DESC *pCounterDesc,
  ...
  HRESULT(STDMETHODCALLTYPE *CheckMultisampleQualityLevels)(
      ID3D11Device *This, DXGI_FORMAT Format, UINT SampleCount,
      UINT *pNumQualityLevels);
  void(STDMETHODCALLTYPE *CheckCounterInfo)(ID3D11Device *This,
                                            D3D11_COUNTER_INFO *pCounterInfo);
  HRESULT(STDMETHODCALLTYPE *CheckCounter)(
      ID3D11Device *This, const D3D11_COUNTER_DESC *pDesc,
      D3D11_COUNTER_TYPE *pType, UINT *pActiveCounters, LPSTR szName,
      UINT *pNameLength, LPSTR szUnits, UINT *pUnitsLength, LPSTR szDescription,
      UINT *pDescriptionLength);
  HRESULT(STDMETHODCALLTYPE *CheckFeatureSupport)(ID3D11Device *This,
                                                  D3D11_FEATURE Feature,
                                                  void *pFeatureSupportData,
                                                  UINT FeatureSupportDataSize);
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(ID3D11Device *This, REFGUID guid,
                                             UINT *pDataSize, void *pData);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D11Device *This, REFGUID guid,
                                             UINT DataSize, const void *pData);
...
/*** IUnknown methods ***/
static inline HRESULT
ID3D11Device_QueryInterface(ID3D11Device *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ID3D11Device methods ***/
static inline HRESULT
ID3D11Device_CreateBuffer(ID3D11Device *This, const D3D11_BUFFER_DESC *pDesc,
                          const D3D11_SUBRESOURCE_DATA *pInitialData,
                          ID3D11Buffer **ppBuffer) {
  return This->lpVtbl->CreateBuffer(This, pDesc, pInitialData, ppBuffer);
}
static inline HRESULT ID3D11Device_CreateTexture1D(
    ID3D11Device *This, const D3D11_TEXTURE1D_DESC *pDesc,
...
static inline HRESULT ID3D11Device_CreateTexture2D(
    ID3D11Device *This, const D3D11_TEXTURE2D_DESC *pDesc,
...
static inline HRESULT ID3D11Device_CreateTexture3D(
    ID3D11Device *This, const D3D11_TEXTURE3D_DESC *pDesc,
...
static inline HRESULT ID3D11Device_CreateShaderResourceView(
    ID3D11Device *This, ID3D11Resource *pResource,
    const D3D11_SHADER_RESOURCE_VIEW_DESC *pDesc,
    ID3D11ShaderResourceView **ppSRView) {
  return This->lpVtbl->CreateShaderResourceView(This, pResource, pDesc,
                                                ppSRView);
}
static inline HRESULT ID3D11Device_CreateUnorderedAccessView(
    ID3D11Device *This, ID3D11Resource *pResource,
    const D3D11_UNORDERED_ACCESS_VIEW_DESC *pDesc,
    ID3D11UnorderedAccessView **ppUAView) {
  return This->lpVtbl->CreateUnorderedAccessView(This, pResource, pDesc,
                                                 ppUAView);
}
static inline HRESULT
ID3D11Device_CreateRenderTargetView(ID3D11Device *This,
                                    ID3D11Resource *pResource,
                                    const D3D11_RENDER_TARGET_VIEW_DESC *pDesc,
                                    ID3D11RenderTargetView **ppRTView) {
  return This->lpVtbl->CreateRenderTargetView(This, pResource, pDesc, ppRTView);
}
static inline HRESULT ID3D11Device_CreateDepthStencilView(
    ID3D11Device *This, ID3D11Resource *pResource,
    const D3D11_DEPTH_STENCIL_VIEW_DESC *pDesc,
    ID3D11DepthStencilView **ppDepthStencilView) {
  return This->lpVtbl->CreateDepthStencilView(This, pResource, pDesc,
                                              ppDepthStencilView);
}
static inline HRESULT ID3D11Device_CreateInputLayout(
    ...
    UINT NumElements, const void *pShaderBytecodeWithInputSignature,
    SIZE_T BytecodeLength, ID3D11InputLayout **ppInputLayout) {
  return This->lpVtbl->CreateInputLayout(This, pInputElementDescs, NumElements,
                                         pShaderBytecodeWithInputSignature,
                                         BytecodeLength, ppInputLayout);
}
static inline HRESULT ID3D11Device_CreateVertexShader(
    ID3D11Device *This, const void *pShaderBytecode, SIZE_T BytecodeLength,
    ID3D11ClassLinkage *pClassLinkage, ID3D11VertexShader **ppVertexShader) {
  return This->lpVtbl->CreateVertexShader(This, pShaderBytecode, BytecodeLength,
                                          pClassLinkage, ppVertexShader);
}
static inline HRESULT ID3D11Device_CreateGeometryShader(
    ID3D11Device *This, const void *pShaderBytecode, SIZE_T BytecodeLength,
    ID3D11ClassLinkage *pClassLinkage,
    ID3D11GeometryShader **ppGeometryShader) {
  return This->lpVtbl->CreateGeometryShader(
      This, pShaderBytecode, BytecodeLength, pClassLinkage, ppGeometryShader);
}
static inline HRESULT ID3D11Device_CreateGeometryShaderWithStreamOutput(
    ...
    ID3D11ClassLinkage *pClassLinkage,
    ID3D11GeometryShader **ppGeometryShader) {
  return This->lpVtbl->CreateGeometryShaderWithStreamOutput(
      This, pShaderBytecode, BytecodeLength, pSODeclaration, NumEntries,
      pBufferStrides, NumStrides, RasterizedStream, pClassLinkage,
      ppGeometryShader);
}
static inline HRESULT ID3D11Device_CreatePixelShader(
    ID3D11Device *This, const void *pShaderBytecode, SIZE_T BytecodeLength,
    ID3D11ClassLinkage *pClassLinkage, ID3D11PixelShader **ppPixelShader) {
  return This->lpVtbl->CreatePixelShader(This, pShaderBytecode, BytecodeLength,
                                         pClassLinkage, ppPixelShader);
}
static inline HRESULT ID3D11Device_CreateHullShader(
    ID3D11Device *This, const void *pShaderBytecode, SIZE_T BytecodeLength,
    ID3D11ClassLinkage *pClassLinkage, ID3D11HullShader **ppHullShader) {
  return This->lpVtbl->CreateHullShader(This, pShaderBytecode, BytecodeLength,
                                        pClassLinkage, ppHullShader);
}
static inline HRESULT ID3D11Device_CreateDomainShader(
    ID3D11Device *This, const void *pShaderBytecode, SIZE_T BytecodeLength,
    ID3D11ClassLinkage *pClassLinkage, ID3D11DomainShader **ppDomainShader) {
  return This->lpVtbl->CreateDomainShader(This, pShaderBytecode, BytecodeLength,
                                          pClassLinkage, ppDomainShader);
}
static inline HRESULT ID3D11Device_CreateComputeShader(
    ID3D11Device *This, const void *pShaderBytecode, SIZE_T BytecodeLength,
    ID3D11ClassLinkage *pClassLinkage, ID3D11ComputeShader **ppComputeShader) {
  return This->lpVtbl->CreateComputeShader(
      This, pShaderBytecode, BytecodeLength, pClassLinkage, ppComputeShader);
}
static inline HRESULT
ID3D11Device_CreateClassLinkage(ID3D11Device *This,
                                ID3D11ClassLinkage **ppLinkage) {
  return This->lpVtbl->CreateClassLinkage(This, ppLinkage);
}
static inline HRESULT
ID3D11Device_CreateBlendState(ID3D11Device *This,
                              const D3D11_BLEND_DESC *pBlendStateDesc,
                              ID3D11BlendState **ppBlendState) {
  return This->lpVtbl->CreateBlendState(This, pBlendStateDesc, ppBlendState);
}
static inline HRESULT ID3D11Device_CreateDepthStencilState(
    ID3D11Device *This, const D3D11_DEPTH_STENCIL_DESC *pDepthStencilDesc,
    ID3D11DepthStencilState **ppDepthStencilState) {
  return This->lpVtbl->CreateDepthStencilState(This, pDepthStencilDesc,
                                               ppDepthStencilState);
}
static inline HRESULT
ID3D11Device_CreateRasterizerState(ID3D11Device *This,
                                   const D3D11_RASTERIZER_DESC *pRasterizerDesc,
                                   ID3D11RasterizerState **ppRasterizerState) {
  return This->lpVtbl->CreateRasterizerState(This, pRasterizerDesc,
                                             ppRasterizerState);
}
static inline HRESULT
ID3D11Device_CreateSamplerState(ID3D11Device *This,
                                const D3D11_SAMPLER_DESC *pSamplerDesc,
                                ID3D11SamplerState **ppSamplerState) {
  return This->lpVtbl->CreateSamplerState(This, pSamplerDesc, ppSamplerState);
}
static inline HRESULT
ID3D11Device_CreateQuery(ID3D11Device *This, const D3D11_QUERY_DESC *pQueryDesc,
                         ID3D11Query **ppQuery) {
  return This->lpVtbl->CreateQuery(This, pQueryDesc, ppQuery);
}
static inline HRESULT
ID3D11Device_CreatePredicate(ID3D11Device *This,
                             const D3D11_QUERY_DESC *pPredicateDesc,
                             ID3D11Predicate **ppPredicate) {
  return This->lpVtbl->CreatePredicate(This, pPredicateDesc, ppPredicate);
}
static inline HRESULT
ID3D11Device_CreateCounter(ID3D11Device *This,
                           const D3D11_COUNTER_DESC *pCounterDesc,
                           ID3D11Counter **ppCounter) {
  return This->lpVtbl->CreateCounter(This, pCounterDesc, ppCounter);
}
static inline HRESULT
ID3D11Device_CreateDeferredContext(ID3D11Device *This, UINT ContextFlags,
                                   ID3D11DeviceContext **ppDeferredContext) {
  return This->lpVtbl->CreateDeferredContext(This, ContextFlags,
                                             ppDeferredContext);
}
static inline HRESULT ID3D11Device_OpenSharedResource(ID3D11Device *This,
                                                      HANDLE hResource,
                                                      REFIID ReturnedInterface,
                                                      void **ppResource) {
  return This->lpVtbl->OpenSharedResource(This, hResource, ReturnedInterface,
                                          ppResource);
}
static inline HRESULT ID3D11Device_CheckFormatSupport(ID3D11Device *This,
                                                      DXGI_FORMAT Format,
                                                      UINT *pFormatSupport) {
  return This->lpVtbl->CheckFormatSupport(This, Format, pFormatSupport);
}
static inline HRESULT
ID3D11Device_CheckMultisampleQualityLevels(ID3D11Device *This,
                                           DXGI_FORMAT Format, UINT SampleCount,
                                           UINT *pNumQualityLevels) {
  return This->lpVtbl->CheckMultisampleQualityLevels(This, Format, SampleCount,
                                                     pNumQualityLevels);
}
static inline void
ID3D11Device_CheckCounterInfo(ID3D11Device *This,
                              D3D11_COUNTER_INFO *pCounterInfo) {
  This->lpVtbl->CheckCounterInfo(This, pCounterInfo);
}
static inline HRESULT
ID3D11Device_CheckCounter(ID3D11Device *This, const D3D11_COUNTER_DESC *pDesc,
                          ...
                          UINT *pDescriptionLength) {
  return This->lpVtbl->CheckCounter(This, pDesc, pType, pActiveCounters, szName,
                                    pNameLength, szUnits, pUnitsLength,
                                    szDescription, pDescriptionLength);
}
static inline HRESULT
ID3D11Device_CheckFeatureSupport(ID3D11Device *This, D3D11_FEATURE Feature,
                                 void *pFeatureSupportData,
                                 UINT FeatureSupportDataSize) {
  return This->lpVtbl->CheckFeatureSupport(This, Feature, pFeatureSupportData,
                                           FeatureSupportDataSize);
}
static inline HRESULT ID3D11Device_GetPrivateData(ID3D11Device *This,
                                                  REFGUID guid, UINT *pDataSize,
                                                  void *pData) {
  return This->lpVtbl->GetPrivateData(This, guid, pDataSize, pData);
}
static inline HRESULT ID3D11Device_SetPrivateData(ID3D11Device *This,
                                                  REFGUID guid, UINT DataSize,
                                                  const void *pData) {
  return This->lpVtbl->SetPrivateData(This, guid, DataSize, pData);
}
static inline HRESULT
ID3D11Device_SetPrivateDataInterface(ID3D11Device *This, REFGUID guid,
                                     const IUnknown *pData) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, pData);
}
static inline D3D_FEATURE_LEVEL
ID3D11Device_GetFeatureLevel(ID3D11Device *This) {
...
static inline void
ID3D11Device_GetImmediateContext(ID3D11Device *This,
                                 ID3D11DeviceContext **ppImmediateContext) {
  This->lpVtbl->GetImmediateContext(This, ppImmediateContext);
}
static inline HRESULT ID3D11Device_SetExceptionMode(ID3D11Device *This,
                                                    UINT RaiseFlags) {
...
HRESULT __stdcall D3D11CreateDeviceAndSwapChain(
    IDXGIAdapter *adapter, D3D_DRIVER_TYPE driver_type, HMODULE swrast,
    UINT flags, const D3D_FEATURE_LEVEL *feature_levels, UINT levels,
    UINT sdk_version, const DXGI_SWAP_CHAIN_DESC *swapchain_desc,
