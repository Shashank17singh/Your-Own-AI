...
public:
  ...
  virtual HRESULT WINAPI GetAllAccessRights(
      LPWSTR lpProperty, PACTRL_ACCESSW_ALLOCATE_ALL_NODES *ppAccessList,
      PTRUSTEEW *ppOwner, PTRUSTEEW *ppGroup) = 0;
  virtual HRESULT WINAPI IsAccessAllowed(PTRUSTEEW pTrustee, LPWSTR lpProperty,
                                         ACCESS_RIGHTS AccessRights,
                                         WINBOOL *pfAccessAllowed) = 0;
};
#else
typedef struct IAccessControlVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IAccessControl *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IAccessControl *This);
  ULONG(WINAPI *Release)(IAccessControl *This);
  HRESULT(WINAPI *GrantAccessRights)(IAccessControl *This,
                                     PACTRL_ACCESSW pAccessList);
  HRESULT(WINAPI *SetAccessRights)(IAccessControl *This,
                                   PACTRL_ACCESSW pAccessList);
  HRESULT(WINAPI *SetOwner)(IAccessControl *This, PTRUSTEEW pOwner,
                            PTRUSTEEW pGroup);
  HRESULT(WINAPI *RevokeAccessRights)(IAccessControl *This, LPWSTR lpProperty,
                                      ULONG cTrustees, TRUSTEEW prgTrustees[]);
  HRESULT(WINAPI *GetAllAccessRights)(
      IAccessControl *This, LPWSTR lpProperty,
      PACTRL_ACCESSW_ALLOCATE_ALL_NODES *ppAccessList, PTRUSTEEW *ppOwner,
      PTRUSTEEW *ppGroup);
  HRESULT(WINAPI *IsAccessAllowed)(IAccessControl *This, PTRUSTEEW pTrustee,
                                   LPWSTR lpProperty,
                                   ACCESS_RIGHTS AccessRights,
                                   WINBOOL *pfAccessAllowed);
  END_INTERFACE
} IAccessControlVtbl;
...
#define IAccessControl_RevokeAccessRights(This, lpProperty, cTrustees,         \
                                          prgTrustees)                         \
  (This)->lpVtbl->RevokeAccessRights(This, lpProperty, cTrustees, prgTrustees)
#define IAccessControl_GetAllAccessRights(This, lpProperty, ppAccessList,      \
                                          ppOwner, ppGroup)                    \
  (This)->lpVtbl->GetAllAccessRights(This, lpProperty, ppAccessList, ppOwner,  \
                                     ppGroup)
#define IAccessControl_IsAccessAllowed(This, pTrustee, lpProperty,             \
                                       AccessRights, pfAccessAllowed)          \
  (This)->lpVtbl->IsAccessAllowed(This, pTrustee, lpProperty, AccessRights,    \
                                  pfAccessAllowed)
#endif
#endif
HRESULT
    WINAPI IAccessControl_GrantAccessRights_Proxy(IAccessControl *This,
                                                  PACTRL_ACCESSW pAccessList);
...
HRESULT WINAPI IAccessControl_SetAccessRights_Proxy(IAccessControl *This,
                                                    PACTRL_ACCESSW pAccessList);
void __RPC_STUB IAccessControl_SetAccessRights_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAccessControl_SetOwner_Proxy(IAccessControl *This,
                                             PTRUSTEEW pOwner,
                                             PTRUSTEEW pGroup);
void __RPC_STUB IAccessControl_SetOwner_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAccessControl_RevokeAccessRights_Proxy(IAccessControl *This,
                                                       LPWSTR lpProperty,
                                                       ULONG cTrustees,
...
void __RPC_STUB IAccessControl_RevokeAccessRights_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAccessControl_GetAllAccessRights_Proxy(
    IAccessControl *This, LPWSTR lpProperty,
    PACTRL_ACCESSW_ALLOCATE_ALL_NODES *ppAccessList, PTRUSTEEW *ppOwner,
    PTRUSTEEW *ppGroup);
void __RPC_STUB IAccessControl_GetAllAccessRights_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAccessControl_IsAccessAllowed_Proxy(IAccessControl *This,
                                                    PTRUSTEEW pTrustee,
                                                    LPWSTR lpProperty,
                                                    ACCESS_RIGHTS AccessRights,
                                                    WINBOOL *pfAccessAllowed);
...
public:
  ...
  virtual HRESULT WINAPI RevokeAuditRights(LPWSTR lpProperty, ULONG cTrustees,
                                           TRUSTEEW prgTrustees[]) = 0;
  virtual HRESULT WINAPI GetAllAuditRights(LPWSTR lpProperty,
                                           PACTRL_AUDITW *ppAuditList) = 0;
  virtual HRESULT WINAPI IsAccessAudited(PTRUSTEEW pTrustee,
                                         ACCESS_RIGHTS AuditRights,
                                         WINBOOL *pfAccessAudited) = 0;
};
#else
typedef struct IAuditControlVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IAuditControl *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IAuditControl *This);
  ULONG(WINAPI *Release)(IAuditControl *This);
  HRESULT(WINAPI *GrantAuditRights)(IAuditControl *This,
                                    PACTRL_AUDITW pAuditList);
  HRESULT(WINAPI *SetAuditRights)(IAuditControl *This,
                                  PACTRL_AUDITW pAuditList);
  HRESULT(WINAPI *RevokeAuditRights)(IAuditControl *This, LPWSTR lpProperty,
                                     ULONG cTrustees, TRUSTEEW prgTrustees[]);
  HRESULT(WINAPI *GetAllAuditRights)(IAuditControl *This, LPWSTR lpProperty,
                                     PACTRL_AUDITW *ppAuditList);
  HRESULT(WINAPI *IsAccessAudited)(IAuditControl *This, PTRUSTEEW pTrustee,
                                   ACCESS_RIGHTS AuditRights,
                                   WINBOOL *pfAccessAudited);
  END_INTERFACE
} IAuditControlVtbl;
...
#define IAuditControl_RevokeAuditRights(This, lpProperty, cTrustees,           \
                                        prgTrustees)                           \
...
#define IAuditControl_IsAccessAudited(This, pTrustee, AuditRights,             \
                                      pfAccessAudited)                         \
  (This)->lpVtbl->IsAccessAudited(This, pTrustee, AuditRights, pfAccessAudited)
#endif
#endif
HRESULT WINAPI IAuditControl_GrantAuditRights_Proxy(IAuditControl *This,
                                                    PACTRL_AUDITW pAuditList);
void __RPC_STUB IAuditControl_GrantAuditRights_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAuditControl_SetAuditRights_Proxy(IAuditControl *This,
                                                  PACTRL_AUDITW pAuditList);
void __RPC_STUB IAuditControl_SetAuditRights_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAuditControl_RevokeAuditRights_Proxy(IAuditControl *This,
                                                     LPWSTR lpProperty,
                                                     ULONG cTrustees,
                                                     TRUSTEEW prgTrustees[]);
void __RPC_STUB IAuditControl_RevokeAuditRights_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAuditControl_GetAllAuditRights_Proxy(
    IAuditControl *This, LPWSTR lpProperty, PACTRL_AUDITW *ppAuditList);
void __RPC_STUB IAuditControl_GetAllAuditRights_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAuditControl_IsAccessAudited_Proxy(IAuditControl *This,
                                                   PTRUSTEEW pTrustee,
                                                   ACCESS_RIGHTS AuditRights,
                                                   WINBOOL *pfAccessAudited);
