...
#include <lmcons.h>
#include <lmuseflg.h>
NET_API_STATUS WINAPI NetUseAdd(LMSTR UncServerName, DWORD Level, LPBYTE Buf,
                                LPDWORD ParmError);
NET_API_STATUS WINAPI NetUseDel(LMSTR UncServerName, LMSTR UseName,
                                DWORD ForceCond);
NET_API_STATUS WINAPI NetUseEnum(LMSTR UncServerName, DWORD Level,
                                 LPBYTE *BufPtr, DWORD PreferedMaximumSize,
                                 LPDWORD EntriesRead, LPDWORD TotalEntries,
                                 LPDWORD ResumeHandle);
NET_API_STATUS WINAPI NetUseGetInfo(LMSTR UncServerName, LMSTR UseName,
