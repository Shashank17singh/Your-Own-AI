...
int __cdecl srv_describe(SRV_PROC *, int, char *, int, __LONG32, __LONG32,
                         __LONG32, __LONG32, void *);
...
int __cdecl srv_senddone(SRV_PROC *srvproc, USHORT status, USHORT curcmd,
                         __LONG32 count);
int __cdecl srv_rpcparams(SRV_PROC *);
int __cdecl srv_paraminfo(SRV_PROC *, int, BYTE *, ULONG *, ULONG *, BYTE *,
                          WINBOOL *);
...
int __cdecl srv_convert(SRV_PROC *, int, void *, __LONG32, int, void *,
                        __LONG32);
...
__LONG32 __cdecl srv_langcpy(SRV_PROC *srvproc, __LONG32 start, __LONG32 nbytes,
                             char *buffer);
__LONG32 __cdecl srv_langlen(SRV_PROC *srvproc);
void *__cdecl srv_langptr(SRV_PROC *srvproc);
int __cdecl srv_log(SRV_SERVER *server, WINBOOL datestamp, char *msg,
                    int msglen);
...
int __cdecl srv_returnval(SRV_PROC *srvproc, char *valuename, int len,
                          BYTE status, __LONG32 type, __LONG32 maxlen,
                          __LONG32 datalen, void *value);
...
int __cdecl srv_wsendmsg(SRV_PROC *srvproc, __LONG32 msgnum, BYTE msgclass,
                         WCHAR *message, int msglen);
int __cdecl srv_sendmsg(SRV_PROC *srvproc, int msgtype, __LONG32 msgnum,
                        BYTE msgclass, BYTE state, char *rpcname,
                        int rpcnamelen, USHORT linenum, char *message,
                        int msglen);
...
int __cdecl srv_message_handler(SRV_PROC *srvproc, int errornum, BYTE severity,
                                BYTE state, int oserrnum, char *errtext,
                                int errtextlen, char *oserrtext,
                                int oserrtextlen);
int __cdecl srv_pre_handle(SRV_SERVER *server, SRV_PROC *srvproc,
                           __LONG32 event, EventHandler handler,
                           WINBOOL remove);
int __cdecl srv_post_handle(SRV_SERVER *server, SRV_PROC *srvproc,
                            __LONG32 event, EventHandler handler,
                            WINBOOL remove);
