...
public:                                                                        \
  ...
  const ADO_BINDING_ENTRY *WINAPI GetADOBindingEntries() {                     \
...
#define ADO_FIXED_LENGTH_ENTRY2(Ordinal, DataType, Buffer, Modify)             \
  {Ordinal, DataType, 0,                                                       \
   0,       0,        offsetof(ADORowClass, Buffer),                           \
   0,       0,        classoffset(CADORecordBinding, ADORowClass),             \
   Modify},
#define ADO_NUMERIC_ENTRY(Ordinal, DataType, Buffer, Precision, Scale, Status, \
                          Modify)                                              \
  {Ordinal,                                                                    \
   DataType,                                                                   \
   Precision,                                                                  \
...
#define ADO_NUMERIC_ENTRY2(Ordinal, DataType, Buffer, Precision, Scale,        \
                           Modify)                                             \
  {Ordinal, DataType, Precision,                                               \
   Scale,   0,        offsetof(ADORowClass, Buffer),                           \
   0,       0,        classoffset(CADORecordBinding, ADORowClass),             \
   Modify},
...
#define ADO_VARIABLE_LENGTH_ENTRY2(Ordinal, DataType, Buffer, Size, Status,    \
  ...
  {Ordinal,                                                                    \
   ...
   classoffset(CADORecordBinding, ADORowClass),                                \
   Modify},
#define ADO_VARIABLE_LENGTH_ENTRY3(Ordinal, DataType, Buffer, Size, Length,    \
                                   Modify)                                     \
  {Ordinal,                                                                    \
   DataType,                                                                   \
   0,                                                                          \
...
#define ADO_VARIABLE_LENGTH_ENTRY4(Ordinal, DataType, Buffer, Size, Modify)    \
  {Ordinal, DataType, 0,                                                       \
   0,       Size,     offsetof(ADORowClass, Buffer),                           \
   0,       0,        classoffset(CADORecordBinding, ADORowClass),             \
   Modify},
...
struct __declspec(uuid(
    "00000544-0000-0010-8000-00aa006d2ea4")) IADORecordBinding;
