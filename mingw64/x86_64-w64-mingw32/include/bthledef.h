...
DEFINE_GUID(GUID_BLUETOOTHLE_DEVICE_INTERFACE, 0x781aee18, 0x7733, 0x4ce4, 0xad,
            0xd0, 0x91, 0xf4, 0x1c, 0x67, 0xb5, 0x92);
DEFINE_GUID(GUID_BLUETOOTH_GATT_SERVICE_DEVICE_INTERFACE, 0x6e3bb679, 0x4372,
            0x40c8, 0x9e, 0xaa, 0x45, 0x09, 0xdf, 0x26, 0x0c, 0xd8);
DEFINE_GUID(BTH_LE_ATT_BLUETOOTH_BASE_GUID, 0x00000000, 0x0000, 0x1000, 0x80,
...
#define BTH_LE_GAP_APPEARANCE_GET_CATEGORY(a)                                  \
  ((a >> BTH_LE_GAP_APPEARANCE_CATEGORY_OFFSET) &                              \
...
#define BLUETOOTH_GATT_FLAG_VALID_MASK                                         \
  (BLUETOOTH_GATT_FLAG_NONE | BLUETOOTH_GATT_FLAG_CONNECTION_ENCRYPTED |       \
...
#define IS_BLUETOOTH_GATT_FLAG_VALID(f)                                        \
  (0 == (f & ~BLUETOOTH_GATT_FLAG_VALID_MASK))
...
#endif
            struct { BOOLEAN IsBroadcast; } ServerCharacteristicConfiguration;
#ifdef __WIDL__
...
FORCEINLINE BOOLEAN IsBthLEUuidMatch(BTH_LE_UUID uuid1, BTH_LE_UUID uuid2) {
  ...
  if (uuid1.IsShortUuid && uuid2.IsShortUuid) {
    ...
    return (0 ==
            memcmp(&uuid1.Value.LongUuid, &uuid2.Value.LongUuid, sizeof(GUID)));
    ...
    return (0 == memcmp(&uuid1.Value.LongUuid, &tempLongUuid.Value.LongUuid,
                        sizeof(GUID)));
  }
  return FALSE;
}
