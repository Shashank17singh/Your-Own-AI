...
class CBaseTerminal : virtual public CComObjectRootEx<CComMultiThreadModelNoCS>,
                      public IDispatchImpl<ITTerminalVtblBase<CBaseTerminal>,
                                           &IID_ITTerminal, &LIBID_TAPI3Lib>,
...
public:
  virtual HRESULT Initialize(IID iidTerminalClass, DWORD dwMediaType,
                             TERMINAL_DIRECTION Direction,
                             MSP_HANDLE htAddress);

public:
  STDMETHOD(get_AddressHandle)(MSP_HANDLE *phtAddress);
  STDMETHOD(ConnectTerminal)(IGraphBuilder *pGraph, DWORD dwTerminalDirection,
...
public:
  ...
  virtual HRESULT GetNumExposedPins(IGraphBuilder *pGraph,
                                    DWORD *pdwNumPins) = 0;
