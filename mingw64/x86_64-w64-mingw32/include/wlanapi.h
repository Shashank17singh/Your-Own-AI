...
#define WLAN_REASON_CODE_MSM_CONNECT_BASE                                      \
  (WLAN_REASON_CODE_MSM_BASE + WLAN_REASON_CODE_RANGE_SIZE / 2)
#define WLAN_REASON_CODE_MSM_END                                               \
...
#define WLAN_REASON_CODE_MSMSEC_CONNECT_BASE                                   \
  (WLAN_REASON_CODE_MSMSEC_BASE + WLAN_REASON_CODE_RANGE_SIZE / 2)
#define WLAN_REASON_CODE_MSMSEC_END                                            \
...
#define WLAN_REASON_CODE_RESERVED_END                                          \
  (WLAN_REASON_CODE_RESERVED_BASE + WLAN_REASON_CODE_RANGE_SIZE - 1)
...
#define WLAN_REASON_CODE_NO_AUTO_CONNECTION                                    \
...
#define WLAN_REASON_CODE_SSID_LIST_TOO_LONG                                    \
  (WLAN_REASON_CODE_AC_CONNECT_BASE + 8)
#define WLAN_REASON_CODE_CONNECT_CALL_FAIL                                     \
...
#define WLAN_REASON_CODE_USER_NOT_RESPOND                                      \
...
#define WLAN_REASON_CODE_INVALID_PROFILE_SCHEMA                                \
  (WLAN_REASON_CODE_PROFILE_BASE + 1)
#define WLAN_REASON_CODE_PROFILE_MISSING (WLAN_REASON_CODE_PROFILE_BASE + 2)
#define WLAN_REASON_CODE_INVALID_PROFILE_NAME                                  \
  (WLAN_REASON_CODE_PROFILE_BASE + 3)
#define WLAN_REASON_CODE_INVALID_PROFILE_TYPE                                  \
...
#define WLAN_REASON_CODE_IHV_SETTINGS_MISSING                                  \
...
#define WLAN_REASON_CODE_PROFILE_SSID_INVALID                                  \
...
#define WLAN_REASON_CODE_SECURITY_FAILURE                                      \
  (WLAN_REASON_CODE_MSM_CONNECT_BASE + 6)
#define WLAN_REASON_CODE_SECURITY_TIMEOUT                                      \
...
#define WLAN_EXECUTE_ACCESS                                                    \
  (WLAN_READ_ACCESS | STANDARD_RIGHTS_EXECUTE | FILE_EXECUTE)
#define WLAN_WRITE_ACCESS                                                      \
  (WLAN_READ_ACCESS | WLAN_EXECUTE_ACCESS | STANDARD_RIGHTS_WRITE |            \
...
/* Assuming stdcall */
typedef VOID(CALLBACK *WLAN_NOTIFICATION_CALLBACK)(PWLAN_NOTIFICATION_DATA,
                                                   PVOID);
...
DWORD WINAPI
WlanConnect2(HANDLE hClientHandle, const GUID *pInterfaceGuid,
...
DWORD WINAPI WlanDeviceServiceCommand(HANDLE hClientHandle,
                                      const GUID *pInterfaceGuid,
                                      LPGUID pDeviceServiceGuid, DWORD dwOpCode,
                                      DWORD dwInBufferSize, PVOID pInBuffer,
                                      DWORD dwOutBufferSize, PVOID pOutBuffer,
                                      PDWORD pdwBytesReturned);
DWORD WINAPI WlanDisconnect(HANDLE hClientHandle, const GUID *pInterfaceGuid,
                            PVOID pReserved);
...
DWORD WINAPI WlanGetAvailableNetworkList2(
    HANDLE hClientHandle, const GUID *pInterfaceGuid, DWORD dwFlags,
    PVOID pReserved, PWLAN_AVAILABLE_NETWORK_LIST_V2 *ppAvailableNetworkList);
...
DWORD WINAPI WlanGetProfileList(HANDLE hClientHandle,
...
DWORD WINAPI WlanQueryInterface(HANDLE hClientHandle,
                                const GUID *pInterfaceGuid,
...
DWORD WINAPI WlanSetProfile(HANDLE hClientHandle, const GUID *pInterfaceGuid,
                            ...
                            WINBOOL bOverwrite, PVOID pReserved,
                            DWORD *pdwReasonCode);
DWORD WINAPI WlanSetProfileEapXmlUserData(HANDLE hClientHandle,
                                          const GUID *pInterfaceGuid,
                                          LPCWSTR strProfileName, DWORD dwFlags,
                                          LPCWSTR strEapXmlUserData,
                                          PVOID pReserved);
DWORD WINAPI WlanSetProfileList(HANDLE hClientHandle,
                                const GUID *pInterfaceGuid, DWORD dwItems,
                                LPCWSTR *strProfileNames, PVOID pReserved);
DWORD WINAPI WlanSetProfilePosition(HANDLE hClientHandle,
                                    const GUID *pInterfaceGuid,
                                    LPCWSTR strProfileName, DWORD dwPosition,
                                    PVOID pReserved);
...
DWORD WINAPI WlanExtractPsdIEDataList(HANDLE hClientHandle, DWORD dwIeDataSize,
                                      const PBYTE pRawIeData, LPCWSTR strFormat,
                                      PVOID pReserved,
                                      PWLAN_RAW_DATA_LIST *ppPsdIEDataList);
DWORD WINAPI WlanGetFilterList(HANDLE hClientHandle,
...
DWORD WINAPI WlanGetNetworkBssList(HANDLE hClientHandle,
                                   const GUID *pInterfaceGuid,
                                   const PDOT11_SSID pDot11Ssid,
                                   DOT11_BSS_TYPE dot11BssType,
                                   WINBOOL bSecurityEnabled, PVOID pReserved,
                                   PWLAN_BSS_LIST *ppWlanBssList);
DWORD WINAPI WlanGetProfileCustomUserData(HANDLE hClientHandle,
                                          const GUID *pInterfaceGuid,
                                          LPCWSTR strProfileName,
                                          PVOID pReserved, DWORD *pdwDataSize,
                                          PBYTE *ppData);
DWORD WINAPI WlanGetSecuritySettings(HANDLE hClientHandle,
...
DWORD WINAPI WlanIhvControl(HANDLE hClientHandle, const GUID *pInterfaceGuid,
                            WLAN_IHV_CONTROL_TYPE Type, DWORD dwInBufferSize,
                            PVOID pInBuffer, DWORD dwOutBufferSize,
                            PVOID pOutBuffer, PDWORD pdwBytesReturned);
DWORD WINAPI
WlanQueryAutoConfigParameter(HANDLE hClientHandle, WLAN_AUTOCONF_OPCODE OpCode,
                             PVOID pReserved, PDWORD pdwDataSize, PVOID *ppData,
                             PWLAN_OPCODE_VALUE_TYPE pWlanOpcodeValueType);
DWORD WINAPI WlanRegisterDeviceServiceNotification(
    HANDLE hClientHandle, const PWLAN_DEVICE_SERVICE_GUID_LIST pDevSvcGuidList);
DWORD WINAPI WlanRenameProfile(HANDLE hClientHandle, const GUID *pInterfaceGuid,
...
DWORD WINAPI WlanSaveTemporaryProfile(HANDLE hClientHandle,
                                      const GUID *pInterfaceGuid,
                                      LPCWSTR strProfileName,
                                      LPCWSTR strAllUserProfileSecurity,
                                      DWORD dwFlags, WINBOOL bOverWrite,
                                      PVOID pReserved);
DWORD WINAPI WlanScan(HANDLE hClientHandle, const GUID *pInterfaceGuid,
                      const PDOT11_SSID pDot11Ssid,
                      const PWLAN_RAW_DATA pIeData, PVOID pReserved);
DWORD WINAPI WlanSetAutoConfigParameter(HANDLE hClientHandle,
                                        WLAN_AUTOCONF_OPCODE OpCode,
                                        DWORD dwDataSize, const PVOID pData,
                                        PVOID pReserved);
DWORD WINAPI WlanSetFilterList(HANDLE hClientHandle,
                               WLAN_FILTER_LIST_TYPE wlanFilterListType,
                               const PDOT11_NETWORK_LIST pNetworkList,
                               PVOID pReserved);
DWORD WINAPI WlanSetProfileCustomUserData(HANDLE hClientHandle,
                                          const GUID *pInterfaceGuid,
                                          LPCWSTR strProfileName,
                                          DWORD dwDataSize, const PBYTE pData,
                                          PVOID pReserved);
DWORD WlanSetProfileEapUserData(HANDLE hClientHandle,
                                const GUID *pInterfaceGuid,
                                LPCWSTR strProfileName, EAP_METHOD_TYPE eapType,
                                DWORD dwFlags, DWORD dwEapUserDataSize,
                                const LPBYTE pbEapUserData, PVOID pReserved);
DWORD WINAPI WlanSetPsdIEDataList(HANDLE hClientHandle, LPCWSTR strFormat,
                                  const PWLAN_RAW_DATA_LIST pPsdIEDataList,
                                  PVOID pReserved);
DWORD WINAPI WlanSetSecuritySettings(HANDLE hClientHandle,
                                     WLAN_SECURABLE_OBJECT SecurableObject,
                                     LPCWSTR strModifiedSDDL);
DWORD WINAPI WlanUIEditProfile(DWORD dwClientVersion, LPCWSTR wstrProfileName,
                               GUID *pInterfaceGuid, HWND hWnd,
                               WL_DISPLAY_PAGES wlStartPage, PVOID pReserved,
