...
typedef void(CALLBACK *INTERACTION_CONTEXT_OUTPUT_CALLBACK2)(
    void *clientData, const INTERACTION_CONTEXT_OUTPUT2 *output);
#endif
...
HRESULT
    WINAPI CreateInteractionContext(HINTERACTIONCONTEXT *interactionContext);
HRESULT WINAPI
DestroyInteractionContext(HINTERACTIONCONTEXT interactionContext);
HRESULT WINAPI RegisterOutputCallbackInteractionContext(
    HINTERACTIONCONTEXT interactionContext,
    INTERACTION_CONTEXT_OUTPUT_CALLBACK outputCallback, void *clientData);
#if (NTDDI_VERSION >= NTDDI_WIN10_VB)
HRESULT WINAPI RegisterOutputCallbackInteractionContext2(
    HINTERACTIONCONTEXT interactionContext,
    INTERACTION_CONTEXT_OUTPUT_CALLBACK2 outputCallback, void *clientData);
#endif
HRESULT WINAPI SetInteractionConfigurationInteractionContext(
    HINTERACTIONCONTEXT interactionContext, UINT32 configurationCount,
    const INTERACTION_CONTEXT_CONFIGURATION *configuration);
HRESULT WINAPI GetInteractionConfigurationInteractionContext(
    HINTERACTIONCONTEXT interactionContext, UINT32 configurationCount,
    INTERACTION_CONTEXT_CONFIGURATION *configuration);
HRESULT WINAPI SetPropertyInteractionContext(
    HINTERACTIONCONTEXT interactionContext,
    INTERACTION_CONTEXT_PROPERTY contextProperty, UINT32 value);
HRESULT WINAPI GetPropertyInteractionContext(
    HINTERACTIONCONTEXT interactionContext,
    INTERACTION_CONTEXT_PROPERTY contextProperty, UINT32 *value);
HRESULT WINAPI SetInertiaParameterInteractionContext(
    HINTERACTIONCONTEXT interactionContext, INERTIA_PARAMETER inertiaParameter,
    float value);
HRESULT WINAPI GetInertiaParameterInteractionContext(
    HINTERACTIONCONTEXT interactionContext, INERTIA_PARAMETER inertiaParameter,
    float *value);
HRESULT WINAPI SetCrossSlideParametersInteractionContext(
    HINTERACTIONCONTEXT interactionContext, UINT32 parameterCount,
    CROSS_SLIDE_PARAMETER *crossSlideParameters);
HRESULT WINAPI GetCrossSlideParameterInteractionContext(
    HINTERACTIONCONTEXT interactionContext, CROSS_SLIDE_THRESHOLD threshold,
    float *distance);
#if (NTDDI_VERSION >= NTDDI_WIN10_VB)
HRESULT WINAPI
SetTapParameterInteractionContext(HINTERACTIONCONTEXT interactionContext,
                                  TAP_PARAMETER parameter, float value);
HRESULT WINAPI
GetTapParameterInteractionContext(HINTERACTIONCONTEXT interactionContext,
                                  TAP_PARAMETER parameter, float *value);
HRESULT WINAPI
SetHoldParameterInteractionContext(HINTERACTIONCONTEXT interactionContext,
                                   HOLD_PARAMETER parameter, float value);
HRESULT WINAPI
GetHoldParameterInteractionContext(HINTERACTIONCONTEXT interactionContext,
                                   HOLD_PARAMETER parameter, float *value);
HRESULT WINAPI SetTranslationParameterInteractionContext(
    HINTERACTIONCONTEXT interactionContext, TRANSLATION_PARAMETER parameter,
    float value);
HRESULT WINAPI GetTranslationParameterInteractionContext(
    HINTERACTIONCONTEXT interactionContext, TRANSLATION_PARAMETER parameter,
    float *value);
#endif
HRESULT WINAPI SetMouseWheelParameterInteractionContext(
    HINTERACTIONCONTEXT interactionContext, MOUSE_WHEEL_PARAMETER parameter,
    float value);
HRESULT WINAPI GetMouseWheelParameterInteractionContext(
    HINTERACTIONCONTEXT interactionContext, MOUSE_WHEEL_PARAMETER parameter,
    float *value);
HRESULT WINAPI ResetInteractionContext(HINTERACTIONCONTEXT interactionContext);
HRESULT WINAPI GetStateInteractionContext(
    HINTERACTIONCONTEXT interactionContext, const POINTER_INFO *pointerInfo,
    INTERACTION_STATE *state);
HRESULT WINAPI AddPointerInteractionContext(
    HINTERACTIONCONTEXT interactionContext, UINT32 pointerId);
HRESULT WINAPI RemovePointerInteractionContext(
    HINTERACTIONCONTEXT interactionContext, UINT32 pointerId);
HRESULT WINAPI ProcessPointerFramesInteractionContext(
    HINTERACTIONCONTEXT interactionContext, UINT32 entriesCount,
    UINT32 pointerCount, const POINTER_INFO *pointerInfo);
HRESULT WINAPI BufferPointerPacketsInteractionContext(
    HINTERACTIONCONTEXT interactionContext, UINT32 entriesCount,
    const POINTER_INFO *pointerInfo);
HRESULT WINAPI ProcessBufferedPacketsInteractionContext(
    HINTERACTIONCONTEXT interactionContext);
HRESULT WINAPI
ProcessInertiaInteractionContext(HINTERACTIONCONTEXT interactionContext);
HRESULT WINAPI StopInteractionContext(HINTERACTIONCONTEXT interactionContext);
HRESULT WINAPI SetPivotInteractionContext(
    HINTERACTIONCONTEXT interactionContext, float x, float y, float radius);
