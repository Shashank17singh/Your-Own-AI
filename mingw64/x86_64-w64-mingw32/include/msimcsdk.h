...
public:
  virtual HRESULT WINAPI CreateContext(VARIANT Profile, VARIANT Flags,
                                       IDispatch **ppInterface) = 0;
  virtual HRESULT WINAPI ShowOptions(void) = 0;
  virtual HRESULT WINAPI get_Profiles(IDispatch **pProfile) = 0;
  virtual HRESULT WINAPI HostWindow(BSTR bstrControl, __LONG32 lStyle,
                                    VARIANT_BOOL fShowOnTaskbar,
                                    IDispatch **ppMSIMWnd) = 0;
  virtual HRESULT WINAPI CreateProfile(BSTR bstrProfile,
                                       IDispatch **ppProfile) = 0;
  virtual HRESULT WINAPI PopupMessage(BSTR bstrMessage, __LONG32 nTimeout,
                                      VARIANT_BOOL fClick,
                                      __LONG32 *plCookie) = 0;
  virtual HRESULT WINAPI HostWindowEx(BSTR bstrControl, __LONG32 lStyle,
                                      __LONG32 lExStyle, IStream *pStream,
                                      IMSIMWindow **ppMSIMWindow,
...
typedef struct IMSIMHostVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMSIMHost *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IMSIMHost *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IMSIMHost *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IMSIMHost *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *CreateContext)(IMSIMHost *This, VARIANT Profile,
                                 VARIANT Flags, IDispatch **ppInterface);
  HRESULT(WINAPI *ShowOptions)(IMSIMHost *This);
  HRESULT(WINAPI *get_Profiles)(IMSIMHost *This, IDispatch **pProfile);
  HRESULT(WINAPI *HostWindow)(IMSIMHost *This, BSTR bstrControl,
                              __LONG32 lStyle, VARIANT_BOOL fShowOnTaskbar,
                              IDispatch **ppMSIMWnd);
  HRESULT(WINAPI *CreateProfile)(IMSIMHost *This, BSTR bstrProfile,
                                 IDispatch **ppProfile);
  HRESULT(WINAPI *PopupMessage)(IMSIMHost *This, BSTR bstrMessage,
                                __LONG32 nTimeout, VARIANT_BOOL fClick,
                                __LONG32 *plCookie);
  HRESULT(WINAPI *HostWindowEx)(IMSIMHost *This, BSTR bstrControl,
                                __LONG32 lStyle, __LONG32 lExStyle,
                                IStream *pStream, IMSIMWindow **ppMSIMWindow,
                                IUnknown **ppUnk, REFIID iidAdvise,
                                IUnknown *punkSink);
  END_INTERFACE
} IMSIMHostVtbl;
...
#define IMSIMHost_Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
...
#define IMSIMHost_HostWindow(This, bstrControl, lStyle, fShowOnTaskbar,        \
                             ppMSIMWnd)                                        \
  (This)->lpVtbl->HostWindow(This, bstrControl, lStyle, fShowOnTaskbar,        \
                             ppMSIMWnd)
...
#define IMSIMHost_HostWindowEx(This, bstrControl, lStyle, lExStyle, pStream,   \
                               ppMSIMWindow, ppUnk, iidAdvise, punkSink)       \
  (This)->lpVtbl->HostWindowEx(This, bstrControl, lStyle, lExStyle, pStream,   \
                               ppMSIMWindow, ppUnk, iidAdvise, punkSink)
#endif
#endif
HRESULT WINAPI IMSIMHost_CreateContext_Proxy(IMSIMHost *This, VARIANT Profile,
                                             VARIANT Flags,
...
void __RPC_STUB IMSIMHost_ShowOptions_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSIMHost_get_Profiles_Proxy(IMSIMHost *This,
                                            IDispatch **pProfile);
void __RPC_STUB IMSIMHost_get_Profiles_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSIMHost_HostWindow_Proxy(IMSIMHost *This, BSTR bstrControl,
                                          __LONG32 lStyle,
                                          VARIANT_BOOL fShowOnTaskbar,
                                          IDispatch **ppMSIMWnd);
void __RPC_STUB IMSIMHost_HostWindow_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI IMSIMHost_CreateProfile_Proxy(IMSIMHost *This, BSTR bstrProfile,
                                             IDispatch **ppProfile);
void __RPC_STUB IMSIMHost_CreateProfile_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSIMHost_PopupMessage_Proxy(IMSIMHost *This, BSTR bstrMessage,
                                            __LONG32 nTimeout,
                                            VARIANT_BOOL fClick,
                                            __LONG32 *plCookie);
void __RPC_STUB IMSIMHost_PopupMessage_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSIMHost_HostWindowEx_Proxy(IMSIMHost *This, BSTR bstrControl,
                                            __LONG32 lStyle, __LONG32 lExStyle,
                                            IStream *pStream,
                                            IMSIMWindow **ppMSIMWindow,
                                            IUnknown **ppUnk, REFIID iidAdvise,
...
typedef struct DMSIMHostEventsVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(DMSIMHostEvents *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(DMSIMHostEvents *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(DMSIMHostEvents *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(DMSIMHostEvents *This, DISPID dispIdMember,
...
#define DMSIMHostEvents_GetTypeInfo(This, iTInfo, lcid, ppTInfo)               \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define DMSIMHostEvents_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,     \
                                      rgDispId)                                \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define DMSIMHostEvents_Invoke(This, dispIdMember, riid, lcid, wFlags,         \
...
public:
  ...
  virtual HRESULT WINAPI Move(__LONG32 nX, __LONG32 nY, __LONG32 nWidth,
                              __LONG32 nHeight) = 0;
  ...
  virtual HRESULT WINAPI GetPosition(VARIANT *pvarX, VARIANT *pvarY,
                                     VARIANT *pvarWidth,
                                     VARIANT *pvarHeight) = 0;
...
typedef struct IMSIMWindowVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMSIMWindow *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IMSIMWindow *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IMSIMWindow *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IMSIMWindow *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *get_Object)(IMSIMWindow *This, IDispatch **ppDisp);
  HRESULT(WINAPI *Move)(IMSIMWindow *This, __LONG32 nX, __LONG32 nY,
                        __LONG32 nWidth, __LONG32 nHeight);
  ...
  HRESULT(WINAPI *GetPosition)(IMSIMWindow *This, VARIANT *pvarX,
                               VARIANT *pvarY, VARIANT *pvarWidth,
                               VARIANT *pvarHeight);
...
#define IMSIMWindow_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                   \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IMSIMWindow_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,         \
                                  rgDispId)                                    \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IMSIMWindow_Invoke(This, dispIdMember, riid, lcid, wFlags,             \
                           pDispParams, pVarResult, pExcepInfo, puArgErr)      \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI IMSIMWindow_get_Object_Proxy(IMSIMWindow *This,
                                            IDispatch **ppDisp);
void __RPC_STUB IMSIMWindow_get_Object_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSIMWindow_Move_Proxy(IMSIMWindow *This, __LONG32 nX,
                                      __LONG32 nY, __LONG32 nWidth,
                                      __LONG32 nHeight);
void __RPC_STUB IMSIMWindow_Move_Stub(IRpcStubBuffer *This,
                                      IRpcChannelBuffer *_pRpcChannelBuffer,
                                      PRPC_MESSAGE _pRpcMessage,
                                      DWORD *_pdwStubPhase);
HRESULT WINAPI IMSIMWindow_Focus_Proxy(IMSIMWindow *This);
void __RPC_STUB IMSIMWindow_Focus_Stub(IRpcStubBuffer *This,
                                       IRpcChannelBuffer *_pRpcChannelBuffer,
                                       PRPC_MESSAGE _pRpcMessage,
                                       DWORD *_pdwStubPhase);
HRESULT WINAPI IMSIMWindow_Show_Proxy(IMSIMWindow *This);
void __RPC_STUB IMSIMWindow_Show_Stub(IRpcStubBuffer *This,
                                      IRpcChannelBuffer *_pRpcChannelBuffer,
                                      PRPC_MESSAGE _pRpcMessage,
                                      DWORD *_pdwStubPhase);
HRESULT WINAPI IMSIMWindow_Hide_Proxy(IMSIMWindow *This);
void __RPC_STUB IMSIMWindow_Hide_Stub(IRpcStubBuffer *This,
                                      IRpcChannelBuffer *_pRpcChannelBuffer,
                                      PRPC_MESSAGE _pRpcMessage,
                                      DWORD *_pdwStubPhase);
...
void __RPC_STUB IMSIMWindow_Close_Stub(IRpcStubBuffer *This,
                                       IRpcChannelBuffer *_pRpcChannelBuffer,
                                       PRPC_MESSAGE _pRpcMessage,
                                       DWORD *_pdwStubPhase);
HRESULT WINAPI IMSIMWindow_get_HasFocus_Proxy(IMSIMWindow *This,
                                              VARIANT_BOOL *pVal);
void __RPC_STUB IMSIMWindow_get_HasFocus_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSIMWindow_get_IsVisible_Proxy(IMSIMWindow *This,
                                               VARIANT_BOOL *pVal);
void __RPC_STUB IMSIMWindow_get_IsVisible_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSIMWindow_GetPosition_Proxy(IMSIMWindow *This, VARIANT *pvarX,
                                             VARIANT *pvarY, VARIANT *pvarWidth,
                                             VARIANT *pvarHeight);
void __RPC_STUB IMSIMWindow_GetPosition_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSIMWindow_get_TopMost_Proxy(IMSIMWindow *This,
                                             VARIANT_BOOL *pVal);
void __RPC_STUB IMSIMWindow_get_TopMost_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSIMWindow_put_TopMost_Proxy(IMSIMWindow *This,
                                             VARIANT_BOOL newVal);
...
typedef struct DMSIMWindowEventsVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(DMSIMWindowEvents *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(DMSIMWindowEvents *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(DMSIMWindowEvents *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(DMSIMWindowEvents *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  END_INTERFACE
...
#define DMSIMWindowEvents_GetTypeInfo(This, iTInfo, lcid, ppTInfo)             \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define DMSIMWindowEvents_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,   \
                                        rgDispId)                              \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define DMSIMWindowEvents_Invoke(This, dispIdMember, riid, lcid, wFlags,       \
...
public:
  ...
  virtual HRESULT WINAPI FindContact(BSTR bstrFirstName, BSTR bstrLastName,
                                     BSTR bstrAlias, BSTR bstrCity,
                                     BSTR bstrState, BSTR bstrCountry,
                                     LONG *plCookie) = 0;
  virtual HRESULT WINAPI Logon(VARIANT varParameter) = 0;
  virtual HRESULT WINAPI CreateContact(BSTR bstrAlias,
                                       IDispatch **ppContact) = 0;
  virtual HRESULT WINAPI SetLocalState(__LONG32 lState, BSTR bstrDescription,
                                       VARIANT varData) = 0;
  virtual HRESULT WINAPI GetLocalState(VARIANT *pvarState,
                                       VARIANT *pvarDescription,
                                       VARIANT *pvarData) = 0;
  virtual HRESULT WINAPI CreateIMSession(VARIANT varIMContact,
                                         IDispatch **ppIMSession) = 0;
  virtual HRESULT WINAPI get_IMSessions(IDispatch **ppIMSessions) = 0;
  virtual HRESULT WINAPI NewList(BSTR bstrListName, __LONG32 bfProperties,
                                 IDispatch **ppList) = 0;
  virtual HRESULT WINAPI List(BSTR bstrListName, IDispatch **ppList) = 0;
  virtual HRESULT WINAPI RemoveList(BSTR bstrListName) = 0;
  virtual HRESULT WINAPI SendNetMeetingInvite(VARIANT varContact,
                                              __LONG32 lInviteCookie,
                                              __LONG32 *plSendCookie) = 0;
  virtual HRESULT WINAPI SendNetMeetingAccept(VARIANT varContact,
                                              __LONG32 lInviteCookie,
                                              __LONG32 lInviteType,
                                              __LONG32 *plSendCookie) = 0;
  virtual HRESULT WINAPI SendNetMeetingCancel(VARIANT varContact,
                                              __LONG32 lInviteCookie,
                                              __LONG32 hrReason,
                                              __LONG32 *plSendCookie) = 0;
...
typedef struct IIMServiceVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IIMService *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IIMService *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IIMService *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IIMService *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  ...
  HRESULT(WINAPI *FindContact)(IIMService *This, BSTR bstrFirstName,
                               BSTR bstrLastName, BSTR bstrAlias, BSTR bstrCity,
                               BSTR bstrState, BSTR bstrCountry,
                               LONG *plCookie);
  HRESULT(WINAPI *Logon)(IIMService *This, VARIANT varParameter);
  HRESULT(WINAPI *CreateContact)(IIMService *This, BSTR bstrAlias,
                                 IDispatch **ppContact);
  HRESULT(WINAPI *SetLocalState)(IIMService *This, __LONG32 lState,
                                 BSTR bstrDescription, VARIANT varData);
  HRESULT(WINAPI *GetLocalState)(IIMService *This, VARIANT *pvarState,
                                 VARIANT *pvarDescription, VARIANT *pvarData);
  HRESULT(WINAPI *CreateIMSession)(IIMService *This, VARIANT varIMContact,
                                   IDispatch **ppIMSession);
  HRESULT(WINAPI *get_IMSessions)(IIMService *This, IDispatch **ppIMSessions);
  HRESULT(WINAPI *NewList)(IIMService *This, BSTR bstrListName,
                           __LONG32 bfProperties, IDispatch **ppList);
  HRESULT(WINAPI *List)(IIMService *This, BSTR bstrListName,
                        IDispatch **ppList);
  HRESULT(WINAPI *RemoveList)(IIMService *This, BSTR bstrListName);
  HRESULT(WINAPI *SendNetMeetingInvite)(IIMService *This, VARIANT varContact,
                                        __LONG32 lInviteCookie,
                                        __LONG32 *plSendCookie);
  HRESULT(WINAPI *SendNetMeetingAccept)(IIMService *This, VARIANT varContact,
                                        __LONG32 lInviteCookie,
                                        __LONG32 lInviteType,
                                        __LONG32 *plSendCookie);
  HRESULT(WINAPI *SendNetMeetingCancel)(IIMService *This, VARIANT varContact,
                                        __LONG32 lInviteCookie,
                                        __LONG32 hrReason,
                                        __LONG32 *plSendCookie);
...
#define IIMService_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                    \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IIMService_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,          \
                                 rgDispId)                                     \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IIMService_Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr)                    \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#define IIMService_FindContact(This, bstrFirstName, bstrLastName, bstrAlias,   \
                               bstrCity, bstrState, bstrCountry, plCookie)     \
  (This)->lpVtbl->FindContact(This, bstrFirstName, bstrLastName, bstrAlias,    \
                              bstrCity, bstrState, bstrCountry, plCookie)
...
#define IIMService_SendNetMeetingInvite(This, varContact, lInviteCookie,       \
                                        plSendCookie)                          \
  (This)->lpVtbl->SendNetMeetingInvite(This, varContact, lInviteCookie,        \
                                       plSendCookie)
#define IIMService_SendNetMeetingAccept(This, varContact, lInviteCookie,       \
                                        lInviteType, plSendCookie)             \
  (This)->lpVtbl->SendNetMeetingAccept(This, varContact, lInviteCookie,        \
                                       lInviteType, plSendCookie)
#define IIMService_SendNetMeetingCancel(This, varContact, lInviteCookie,       \
                                        hrReason, plSendCookie)                \
  (This)->lpVtbl->SendNetMeetingCancel(This, varContact, lInviteCookie,        \
                                       hrReason, plSendCookie)
...
void __RPC_STUB IIMService_get_Server_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IIMService_get_IMAddress_Proxy(IIMService *This,
                                              BSTR *pbstrName);
...
void __RPC_STUB IIMService_put_FriendlyName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IIMService_get_FriendlyName_Proxy(IIMService *This,
                                                 BSTR *pbstrName);
void __RPC_STUB IIMService_get_FriendlyName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IIMService_Logoff_Proxy(IIMService *This);
void __RPC_STUB IIMService_Logoff_Stub(IRpcStubBuffer *This,
                                       IRpcChannelBuffer *_pRpcChannelBuffer,
                                       PRPC_MESSAGE _pRpcMessage,
                                       DWORD *_pdwStubPhase);
HRESULT WINAPI IIMService_FindContact_Proxy(IIMService *This,
                                            BSTR bstrFirstName,
                                            BSTR bstrLastName, BSTR bstrAlias,
                                            BSTR bstrCity, BSTR bstrState,
                                            BSTR bstrCountry, LONG *plCookie);
void __RPC_STUB IIMService_FindContact_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IIMService_Logon_Proxy(IIMService *This, VARIANT varParameter);
void __RPC_STUB IIMService_Logon_Stub(IRpcStubBuffer *This,
                                      IRpcChannelBuffer *_pRpcChannelBuffer,
                                      PRPC_MESSAGE _pRpcMessage,
                                      DWORD *_pdwStubPhase);
HRESULT WINAPI IIMService_CreateContact_Proxy(IIMService *This, BSTR bstrAlias,
                                              IDispatch **ppContact);
void __RPC_STUB IIMService_CreateContact_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IIMService_SetLocalState_Proxy(IIMService *This, __LONG32 lState,
                                              BSTR bstrDescription,
                                              VARIANT varData);
void __RPC_STUB IIMService_SetLocalState_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IIMService_GetLocalState_Proxy(IIMService *This,
                                              VARIANT *pvarState,
                                              VARIANT *pvarDescription,
                                              VARIANT *pvarData);
void __RPC_STUB IIMService_GetLocalState_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IIMService_CreateIMSession_Proxy(IIMService *This,
                                                VARIANT varIMContact,
                                                IDispatch **ppIMSession);
void __RPC_STUB IIMService_CreateIMSession_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IIMService_get_IMSessions_Proxy(IIMService *This,
                                               IDispatch **ppIMSessions);
void __RPC_STUB IIMService_get_IMSessions_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IIMService_NewList_Proxy(IIMService *This, BSTR bstrListName,
                                        __LONG32 bfProperties,
                                        IDispatch **ppList);
void __RPC_STUB IIMService_NewList_Stub(IRpcStubBuffer *This,
                                        IRpcChannelBuffer *_pRpcChannelBuffer,
                                        PRPC_MESSAGE _pRpcMessage,
                                        DWORD *_pdwStubPhase);
HRESULT WINAPI IIMService_List_Proxy(IIMService *This, BSTR bstrListName,
                                     IDispatch **ppList);
void __RPC_STUB IIMService_List_Stub(IRpcStubBuffer *This,
                                     IRpcChannelBuffer *_pRpcChannelBuffer,
                                     PRPC_MESSAGE _pRpcMessage,
                                     DWORD *_pdwStubPhase);
...
void __RPC_STUB IIMService_RemoveList_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IIMService_SendNetMeetingInvite_Proxy(IIMService *This,
                                                     VARIANT varContact,
                                                     __LONG32 lInviteCookie,
                                                     __LONG32 *plSendCookie);
...
void __RPC_STUB IIMService_SendNetMeetingAccept_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IIMService_SendNetMeetingCancel_Proxy(IIMService *This,
                                                     VARIANT varContact,
                                                     __LONG32 lInviteCookie,
                                                     __LONG32 hrReason,
                                                     __LONG32 *plSendCookie);
void __RPC_STUB IIMService_SendNetMeetingCancel_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IIMService_get_BlockByDefault_Proxy(IIMService *This,
                                                   VARIANT_BOOL *pVal);
...
typedef struct DIMServiceEventsVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(DIMServiceEvents *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(DIMServiceEvents *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(DIMServiceEvents *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(DIMServiceEvents *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  END_INTERFACE
...
#define DIMServiceEvents_GetTypeInfo(This, iTInfo, lcid, ppTInfo)              \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define DIMServiceEvents_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,    \
                                       rgDispId)                               \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define DIMServiceEvents_Invoke(This, dispIdMember, riid, lcid, wFlags,        \
                                pDispParams, pVarResult, pExcepInfo, puArgErr) \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
#endif
...
public:
  ...
  virtual HRESULT WINAPI SendText(BSTR bstrMsgHeader, BSTR bstrMsgText,
                                  IM_MSG_TYPE MsgType, LONG *plCookie) = 0;
  virtual HRESULT WINAPI get_Service(IDispatch **ppService) = 0;
};
#else
typedef struct IIMContactVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IIMContact *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IIMContact *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IIMContact *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IIMContact *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  ...
  HRESULT(WINAPI *SendText)(IIMContact *This, BSTR bstrMsgHeader,
                            BSTR bstrMsgText, IM_MSG_TYPE MsgType,
                            LONG *plCookie);
...
#define IIMContact_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                    \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IIMContact_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,          \
                                 rgDispId)                                     \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IIMContact_Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr)                    \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#define IIMContact_SendText(This, bstrMsgHeader, bstrMsgText, MsgType,         \
                            plCookie)                                          \
...
#endif
#endif
HRESULT WINAPI IIMContact_put_FriendlyName_Proxy(IIMContact *This,
                                                 BSTR bstrFriendlyName);
void __RPC_STUB IIMContact_put_FriendlyName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IIMContact_get_FriendlyName_Proxy(IIMContact *This,
                                                 BSTR *pbstrFriendlyName);
void __RPC_STUB IIMContact_get_FriendlyName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IIMContact_get_EmailAddress_Proxy(IIMContact *This,
...
void __RPC_STUB IIMContact_get_State_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI IIMContact_get_LogonName_Proxy(IIMContact *This,
                                              BSTR *pbstrLogonName);
void __RPC_STUB IIMContact_get_LogonName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IIMContact_SendText_Proxy(IIMContact *This, BSTR bstrMsgHeader,
                                         BSTR bstrMsgText, IM_MSG_TYPE MsgType,
                                         LONG *plCookie);
void __RPC_STUB IIMContact_SendText_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
HRESULT WINAPI IIMContact_get_Service_Proxy(IIMContact *This,
                                            IDispatch **ppService);
...
typedef struct IIMContactsVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IIMContacts *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IIMContacts *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IIMContacts *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IIMContacts *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *Item)(IIMContacts *This, VARIANT varItem,
                        IDispatch **ppContact);
...
#define IIMContacts_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                   \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IIMContacts_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,         \
                                  rgDispId)                                    \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IIMContacts_Invoke(This, dispIdMember, riid, lcid, wFlags,             \
                           pDispParams, pVarResult, pExcepInfo, puArgErr)      \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI IIMContacts_Item_Proxy(IIMContacts *This, VARIANT varItem,
                                      IDispatch **ppContact);
void __RPC_STUB IIMContacts_Item_Stub(IRpcStubBuffer *This,
                                      IRpcChannelBuffer *_pRpcChannelBuffer,
                                      PRPC_MESSAGE _pRpcMessage,
                                      DWORD *_pdwStubPhase);
...
void __RPC_STUB IIMContacts_Add_Stub(IRpcStubBuffer *This,
                                     IRpcChannelBuffer *_pRpcChannelBuffer,
                                     PRPC_MESSAGE _pRpcMessage,
                                     DWORD *_pdwStubPhase);
HRESULT WINAPI IIMContacts_Remove_Proxy(IIMContacts *This, IDispatch *pContact);
void __RPC_STUB IIMContacts_Remove_Stub(IRpcStubBuffer *This,
                                        IRpcChannelBuffer *_pRpcChannelBuffer,
                                        PRPC_MESSAGE _pRpcMessage,
                                        DWORD *_pdwStubPhase);
HRESULT WINAPI IIMContacts_get_Name_Proxy(IIMContacts *This, BSTR *pVal);
void __RPC_STUB IIMContacts_get_Name_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI IIMContacts_put_Name_Proxy(IIMContacts *This, BSTR newVal);
void __RPC_STUB IIMContacts_put_Name_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI IIMContacts_get_Properties_Proxy(IIMContacts *This,
                                                __LONG32 *pVal);
...
void __RPC_STUB IIMContacts_get_Cookie_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IIMContacts_get__NewEnum_Proxy(IIMContacts *This,
                                              IUnknown **ppVal);
...
typedef struct IIMSessionVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IIMSession *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IIMSession *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IIMSession *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IIMSession *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  ...
  HRESULT(WINAPI *SendText)(IIMSession *This, BSTR bstrMsgHeader,
                            BSTR bstrMsgText, IM_MSG_TYPE MsgType,
                            LONG *plCookie);
  END_INTERFACE
} IIMSessionVtbl;
...
#define IIMSession_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                    \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IIMSession_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,          \
                                 rgDispId)                                     \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IIMSession_Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr)                    \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#define IIMSession_SendText(This, bstrMsgHeader, bstrMsgText, MsgType,         \
                            plCookie)                                          \
  (This)->lpVtbl->SendText(This, bstrMsgHeader, bstrMsgText, MsgType, plCookie)
#endif
#endif
HRESULT WINAPI IIMSession_get_Members_Proxy(IIMSession *This,
                                            IDispatch **ppMembers);
void __RPC_STUB IIMSession_get_Members_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IIMSession_get_State_Proxy(IIMSession *This, IM_SSTATE *psState);
void __RPC_STUB IIMSession_get_State_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI IIMSession_get_Service_Proxy(IIMSession *This,
                                            IDispatch **ppService);
void __RPC_STUB IIMSession_get_Service_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IIMSession_get_Invitees_Proxy(IIMSession *This,
                                             IDispatch **ppInvitees);
...
void __RPC_STUB IIMSession_LeaveSession_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IIMSession_InviteContact_Proxy(IIMSession *This,
                                              VARIANT vContact);
void __RPC_STUB IIMSession_InviteContact_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IIMSession_SendText_Proxy(IIMSession *This, BSTR bstrMsgHeader,
                                         BSTR bstrMsgText, IM_MSG_TYPE MsgType,
                                         LONG *plCookie);
void __RPC_STUB IIMSession_SendText_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
#endif
...
typedef struct IIMSessionsVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IIMSessions *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IIMSessions *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IIMSessions *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IIMSessions *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *get_Count)(IIMSessions *This, __LONG32 *pcSessions);
  HRESULT(WINAPI *Item)(IIMSessions *This, __LONG32 Index,
                        IDispatch **ppIMSession);
...
#define IIMSessions_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                   \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IIMSessions_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,         \
                                  rgDispId)                                    \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IIMSessions_Invoke(This, dispIdMember, riid, lcid, wFlags,             \
                           pDispParams, pVarResult, pExcepInfo, puArgErr)      \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI IIMSessions_get_Count_Proxy(IIMSessions *This,
                                           __LONG32 *pcSessions);
void __RPC_STUB IIMSessions_get_Count_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IIMSessions_Item_Proxy(IIMSessions *This, __LONG32 Index,
                                      IDispatch **ppIMSession);
void __RPC_STUB IIMSessions_Item_Stub(IRpcStubBuffer *This,
                                      IRpcChannelBuffer *_pRpcChannelBuffer,
                                      PRPC_MESSAGE _pRpcMessage,
                                      DWORD *_pdwStubPhase);
HRESULT WINAPI IIMSessions_get__NewEnum_Proxy(IIMSessions *This,
                                              IUnknown **ppUnknown);
