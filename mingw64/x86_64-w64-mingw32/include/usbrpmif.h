...
NTSTATUS
NTAPI
RPMRegisterAlternateDriver(PDRIVER_OBJECT DriverObject, LPCWSTR CompatibleId,
                           PHANDLE RegisteredDriver);
USBRPMAPI
NTSTATUS
NTAPI
RPMUnregisterAlternateDriver(HANDLE RegisteredDriver);
USBRPMAPI
NTSTATUS
RPMGetAvailableDevices(HANDLE RegisteredDriver, USHORT Locale,
                       PUSBRPM_DEVICE_LIST *DeviceList);
USBRPMAPI
NTSTATUS
NTAPI
RPMLoadAlternateDriverForDevice(HANDLE RegisteredDriver, ULONG64 HubID,
                                ULONG ConnectionIndex, REFGUID OwnerGuid);
USBRPMAPI
NTSTATUS
NTAPI
RPMUnloadAlternateDriverForDevice(HANDLE RegisteredDriver, ULONG64 HubID,
                                  ULONG ConnectionIndex);
