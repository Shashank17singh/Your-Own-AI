...
DECLARE_INTERFACE_(IPAT, IUnknown) {
  ...
  STDMETHOD_(HRESULT, FindRecordProgramMapPid)(THIS_ WORD wProgramNumber,
                                               WORD * pwVal) PURE;
  STDMETHOD_(HRESULT, GetCountOfRecords)(THIS_ DWORD * pdwVal) PURE;
  STDMETHOD_(HRESULT, GetNextTable)(THIS_ IPAT * *ppPAT) PURE;
  STDMETHOD_(HRESULT, GetRecordProgramMapPid)(THIS_ DWORD dwIndex, WORD * pwVal)
      PURE;
  STDMETHOD_(HRESULT, GetRecordProgramNumber)(THIS_ DWORD dwIndex, WORD * pwVal)
      PURE;
...
DECLARE_INTERFACE_(IPSITables, IUnknown) {
  ...
  STDMETHOD_(ULONG, Release)(THIS) PURE;
  /* IPSITables methods */
  STDMETHOD_(HRESULT, GetTable)(THIS_ DWORD dwTSID, DWORD dwTID_PID,
                                DWORD dwHashedVer, DWORD dwPara4,
                                IUnknown * *ppIUnknown) PURE;
  END_INTERFACE
};
#ifdef COBJMACROS
...
#define IPSITables_GetTable(This, dwTSID, dwTID_PID, dwHashedVer, dwPara4,     \
                            ppIUnknown)                                        \
  (This)->lpVtbl->GetTable(This, dwTSID, dwTID_PID, dwHashedVer, dwPara4,      \
                           ppIUnknown)
#endif /*COBJMACROS*/
#undef INTERFACE
...
DECLARE_INTERFACE_(IPMT, IUnknown) {
  ...
  STDMETHOD_(HRESULT, GetRecordDescriptorByIndex)(
      THIS_ DWORD dwRecordIndex, DWORD dwDescIndex,
  ...
  STDMETHOD_(HRESULT, GetRecordDescriptorByTag)(
      ...
      IGenericDescriptor * *ppDescriptor) PURE;
  STDMETHOD_(HRESULT, GetRecordElementaryPid)(THIS_ DWORD dwRecordIndex,
                                              PID * pPidVal) PURE;
  STDMETHOD_(HRESULT, GetRecordStreamType)(THIS_ DWORD dwRecordIndex,
                                           BYTE * pbVal) PURE;
  ...
  STDMETHOD_(HRESULT, Initialize)(THIS_ ISectionList * pSectionList,
                                  IMpeg2Data * pMPEGData) PURE;
  STDMETHOD_(HRESULT, QueryMPEInfo)(THIS_ MPE_ELEMENT * *ppMPEList,
                                    UINT * puiCount) PURE;
  STDMETHOD_(HRESULT, QueryServiceGatewayInfo)(
      THIS_ DSMCC_ELEMENT * *ppDSMCCList, UINT * puiCount) PURE;
  STDMETHOD_(HRESULT, RegisterForNextTable)(THIS_ HANDLE hNextTableAvailable)
      PURE;
  STDMETHOD_(HRESULT, RegisterForWhenCurrent)(THIS_ HANDLE hNextTableIsCurrent)
      PURE;
...
#define IPMT_GetRecordDescriptorByIndex(This, dwRecordIndex, dwDescIndex,      \
                                        ppDescriptor)                          \
  (This)->lpVtbl->GetRecordDescriptorByIndex(This, dwRecordIndex, dwDescIndex, \
                                             ppDescriptor)
#define IPMT_GetRecordDescriptorByTag(This, dwRecordIndex, bTag, pdwCookie,    \
                                      ppDescriptor)                            \
