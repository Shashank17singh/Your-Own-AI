...
public:
  ...
  virtual HRESULT WINAPI GetItemID(__LONG32 dwItemIndex,
                                   __LONG32 *pdwCommandID) = 0;
  virtual HRESULT WINAPI GetItemConfidence(__LONG32 dwItemIndex,
                                           __LONG32 *plConfidence) = 0;
  virtual HRESULT WINAPI GetItemText(__LONG32 dwItemIndex, BSTR *pbszText) = 0;
  virtual HRESULT WINAPI GetAllItemData(VARIANT *pdwItemIndices,
...
typedef struct IAgentUserInputVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IAgentUserInput *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IAgentUserInput *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IAgentUserInput *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IAgentUserInput *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *GetCount)(IAgentUserInput *This, __LONG32 *pdwCount);
  HRESULT(WINAPI *GetItemID)(IAgentUserInput *This, __LONG32 dwItemIndex,
                             __LONG32 *pdwCommandID);
  HRESULT(WINAPI *GetItemConfidence)(IAgentUserInput *This,
                                     __LONG32 dwItemIndex,
                                     __LONG32 *plConfidence);
  HRESULT(WINAPI *GetItemText)(IAgentUserInput *This, __LONG32 dwItemIndex,
                               BSTR *pbszText);
  HRESULT(WINAPI *GetAllItemData)(IAgentUserInput *This,
                                  VARIANT *pdwItemIndices,
                                  VARIANT *plConfidences, VARIANT *pbszText);
  END_INTERFACE
} IAgentUserInputVtbl;
...
#define IAgentUserInput_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,     \
                                      rgDispId)                                \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IAgentUserInput_Invoke(This, dispIdMember, riid, lcid, wFlags,         \
...
#define IAgentUserInput_GetAllItemData(This, pdwItemIndices, plConfidences,    \
                                       pbszText)                               \
  (This)->lpVtbl->GetAllItemData(This, pdwItemIndices, plConfidences, pbszText)
#endif
#endif
HRESULT WINAPI IAgentUserInput_GetCount_Proxy(IAgentUserInput *This,
                                              __LONG32 *pdwCount);
...
HRESULT WINAPI IAgentUserInput_GetItemID_Proxy(IAgentUserInput *This,
                                               __LONG32 dwItemIndex,
                                               __LONG32 *pdwCommandID);
void __RPC_STUB IAgentUserInput_GetItemID_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentUserInput_GetItemConfidence_Proxy(IAgentUserInput *This,
                                                       __LONG32 dwItemIndex,
                                                       __LONG32 *plConfidence);
void __RPC_STUB IAgentUserInput_GetItemConfidence_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentUserInput_GetItemText_Proxy(IAgentUserInput *This,
                                                 __LONG32 dwItemIndex,
                                                 BSTR *pbszText);
void __RPC_STUB IAgentUserInput_GetItemText_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentUserInput_GetAllItemData_Proxy(IAgentUserInput *This,
                                                    VARIANT *pdwItemIndices,
                                                    VARIANT *plConfidences,
                                                    VARIANT *pbszText);
...
typedef struct IAgentCommandVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IAgentCommand *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IAgentCommand *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IAgentCommand *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IAgentCommand *This, DISPID dispIdMember, REFIID riid,
  ...
  HRESULT(WINAPI *SetConfidenceThreshold)(IAgentCommand *This,
                                          __LONG32 lThreshold);
  HRESULT(WINAPI *GetConfidenceThreshold)(IAgentCommand *This,
                                          __LONG32 *plThreshold);
...
#define IAgentCommand_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                 \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IAgentCommand_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,       \
                                    rgDispId)                                  \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IAgentCommand_Invoke(This, dispIdMember, riid, lcid, wFlags,           \
                             pDispParams, pVarResult, pExcepInfo, puArgErr)    \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI IAgentCommand_SetCaption_Proxy(IAgentCommand *This,
                                              BSTR bszCaption);
void __RPC_STUB IAgentCommand_SetCaption_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCommand_GetCaption_Proxy(IAgentCommand *This,
                                              BSTR *pbszCaption);
...
void __RPC_STUB IAgentCommand_SetVoice_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCommand_GetVoice_Proxy(IAgentCommand *This,
                                            BSTR *pbszVoice);
void __RPC_STUB IAgentCommand_GetVoice_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCommand_SetEnabled_Proxy(IAgentCommand *This,
                                              __LONG32 bEnabled);
void __RPC_STUB IAgentCommand_SetEnabled_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCommand_GetEnabled_Proxy(IAgentCommand *This,
                                              __LONG32 *pbEnabled);
void __RPC_STUB IAgentCommand_GetEnabled_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCommand_SetVisible_Proxy(IAgentCommand *This,
                                              __LONG32 bVisible);
void __RPC_STUB IAgentCommand_SetVisible_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCommand_GetVisible_Proxy(IAgentCommand *This,
                                              __LONG32 *pbVisible);
void __RPC_STUB IAgentCommand_GetVisible_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCommand_SetConfidenceThreshold_Proxy(IAgentCommand *This,
                                                          __LONG32 lThreshold);
void __RPC_STUB IAgentCommand_SetConfidenceThreshold_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCommand_GetConfidenceThreshold_Proxy(
    IAgentCommand *This, __LONG32 *plThreshold);
void __RPC_STUB IAgentCommand_GetConfidenceThreshold_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCommand_SetConfidenceText_Proxy(IAgentCommand *This,
                                                     BSTR bszTipText);
void __RPC_STUB IAgentCommand_SetConfidenceText_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCommand_GetConfidenceText_Proxy(IAgentCommand *This,
                                                     BSTR *pbszTipText);
...
void __RPC_STUB IAgentCommand_GetID_Stub(IRpcStubBuffer *This,
...
typedef struct IAgentCommandExVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IAgentCommandEx *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IAgentCommandEx *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IAgentCommandEx *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IAgentCommandEx *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  ...
  HRESULT(WINAPI *SetConfidenceThreshold)(IAgentCommandEx *This,
                                          __LONG32 lThreshold);
  HRESULT(WINAPI *GetConfidenceThreshold)(IAgentCommandEx *This,
                                          __LONG32 *plThreshold);
  ...
  HRESULT(WINAPI *GetVoiceCaption)(IAgentCommandEx *This,
...
#define IAgentCommandEx_GetTypeInfo(This, iTInfo, lcid, ppTInfo)               \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IAgentCommandEx_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,     \
                                      rgDispId)                                \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IAgentCommandEx_Invoke(This, dispIdMember, riid, lcid, wFlags,         \
                               pDispParams, pVarResult, pExcepInfo, puArgErr)  \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI IAgentCommandEx_SetHelpContextID_Proxy(IAgentCommandEx *This,
                                                      __LONG32 ulID);
void __RPC_STUB IAgentCommandEx_SetHelpContextID_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCommandEx_GetHelpContextID_Proxy(IAgentCommandEx *This,
                                                      __LONG32 *pulID);
void __RPC_STUB IAgentCommandEx_GetHelpContextID_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCommandEx_SetVoiceCaption_Proxy(IAgentCommandEx *This,
                                                     BSTR bszVoiceCaption);
void __RPC_STUB IAgentCommandEx_SetVoiceCaption_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCommandEx_GetVoiceCaption_Proxy(IAgentCommandEx *This,
                                                     BSTR *pbszVoiceCaption);
...
public:
  virtual HRESULT WINAPI GetCommand(__LONG32 dwCommandID,
  ...
  virtual HRESULT WINAPI SetVisible(__LONG32 bVisible) = 0;
  virtual HRESULT WINAPI GetVisible(__LONG32 *pbVisible) = 0;
  virtual HRESULT WINAPI Add(BSTR bszCaption, BSTR bszVoice, __LONG32 bEnabled,
                             __LONG32 bVisible, __LONG32 *pdwID) = 0;
  virtual HRESULT WINAPI Insert(BSTR bszCaption, BSTR bszVoice,
                                __LONG32 bEnabled, __LONG32 bVisible,
                                __LONG32 dwRefID, __LONG32 bBefore,
                                __LONG32 *pdwID) = 0;
...
typedef struct IAgentCommandsVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IAgentCommands *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IAgentCommands *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IAgentCommands *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IAgentCommands *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *GetCommand)(IAgentCommands *This, __LONG32 dwCommandID,
  ...
  HRESULT(WINAPI *Add)(IAgentCommands *This, BSTR bszCaption, BSTR bszVoice,
                       __LONG32 bEnabled, __LONG32 bVisible, __LONG32 *pdwID);
  HRESULT(WINAPI *Insert)(IAgentCommands *This, BSTR bszCaption, BSTR bszVoice,
                          __LONG32 bEnabled, __LONG32 bVisible,
                          __LONG32 dwRefID, __LONG32 bBefore, __LONG32 *pdwID);
...
#define IAgentCommands_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IAgentCommands_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,      \
                                     rgDispId)                                 \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IAgentCommands_Invoke(This, dispIdMember, riid, lcid, wFlags,          \
                              pDispParams, pVarResult, pExcepInfo, puArgErr)   \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#define IAgentCommands_GetVisible(This, pbVisible)                             \
  (This)->lpVtbl->GetVisible(This, pbVisible)
#define IAgentCommands_Add(This, bszCaption, bszVoice, bEnabled, bVisible,     \
                           pdwID)                                              \
  (This)->lpVtbl->Add(This, bszCaption, bszVoice, bEnabled, bVisible, pdwID)
#define IAgentCommands_Insert(This, bszCaption, bszVoice, bEnabled, bVisible,  \
                              dwRefID, bBefore, pdwID)                         \
  (This)->lpVtbl->Insert(This, bszCaption, bszVoice, bEnabled, bVisible,       \
                         dwRefID, bBefore, pdwID)
...
#endif
#endif
HRESULT WINAPI IAgentCommands_GetCommand_Proxy(IAgentCommands *This,
                                               __LONG32 dwCommandID,
                                               IUnknown **ppunkCommand);
void __RPC_STUB IAgentCommands_GetCommand_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCommands_GetCount_Proxy(IAgentCommands *This,
                                             __LONG32 *pdwCount);
void __RPC_STUB IAgentCommands_GetCount_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCommands_SetCaption_Proxy(IAgentCommands *This,
                                               BSTR bszCaption);
void __RPC_STUB IAgentCommands_SetCaption_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCommands_GetCaption_Proxy(IAgentCommands *This,
                                               BSTR *pbszCaption);
void __RPC_STUB IAgentCommands_GetCaption_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCommands_SetVoice_Proxy(IAgentCommands *This,
                                             BSTR bszVoice);
void __RPC_STUB IAgentCommands_SetVoice_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCommands_GetVoice_Proxy(IAgentCommands *This,
                                             BSTR *pbszVoice);
void __RPC_STUB IAgentCommands_GetVoice_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCommands_SetVisible_Proxy(IAgentCommands *This,
                                               __LONG32 bVisible);
void __RPC_STUB IAgentCommands_SetVisible_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCommands_GetVisible_Proxy(IAgentCommands *This,
                                               __LONG32 *pbVisible);
void __RPC_STUB IAgentCommands_GetVisible_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCommands_Add_Proxy(IAgentCommands *This, BSTR bszCaption,
                                        BSTR bszVoice, __LONG32 bEnabled,
                                        __LONG32 bVisible, __LONG32 *pdwID);
void __RPC_STUB IAgentCommands_Add_Stub(IRpcStubBuffer *This,
                                        IRpcChannelBuffer *_pRpcChannelBuffer,
                                        PRPC_MESSAGE _pRpcMessage,
                                        DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCommands_Insert_Proxy(IAgentCommands *This,
                                           BSTR bszCaption, BSTR bszVoice,
                                           __LONG32 bEnabled, __LONG32 bVisible,
                                           __LONG32 dwRefID, __LONG32 bBefore,
                                           __LONG32 *pdwID);
...
public:
  virtual HRESULT WINAPI GetCommandEx(__LONG32 dwCommandID,
                                      IAgentCommandEx **ppCommandEx) = 0;
  ...
  virtual HRESULT WINAPI AddEx(BSTR bszCaption, BSTR bszVoice,
                               BSTR bszVoiceCaption, __LONG32 bEnabled,
                               __LONG32 bVisible, __LONG32 ulHelpId,
                               __LONG32 *pdwID) = 0;
  virtual HRESULT WINAPI InsertEx(BSTR bszCaption, BSTR bszVoice,
                                  BSTR bszVoiceCaption, __LONG32 bEnabled,
                                  __LONG32 bVisible, __LONG32 ulHelpId,
                                  __LONG32 dwRefID, __LONG32 bBefore,
                                  __LONG32 *pdwID) = 0;
...
typedef struct IAgentCommandsExVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IAgentCommandsEx *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IAgentCommandsEx *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IAgentCommandsEx *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IAgentCommandsEx *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *GetCommand)(IAgentCommandsEx *This, __LONG32 dwCommandID,
                              IUnknown **ppunkCommand);
  ...
  HRESULT(WINAPI *Add)(IAgentCommandsEx *This, BSTR bszCaption, BSTR bszVoice,
                       __LONG32 bEnabled, __LONG32 bVisible, __LONG32 *pdwID);
  HRESULT(WINAPI *Insert)(IAgentCommandsEx *This, BSTR bszCaption,
                          BSTR bszVoice, __LONG32 bEnabled, __LONG32 bVisible,
                          __LONG32 dwRefID, __LONG32 bBefore, __LONG32 *pdwID);
  HRESULT(WINAPI *Remove)(IAgentCommandsEx *This, __LONG32 dwID);
  HRESULT(WINAPI *RemoveAll)(IAgentCommandsEx *This);
  HRESULT(WINAPI *GetCommandEx)(IAgentCommandsEx *This, __LONG32 dwCommandID,
                                IAgentCommandEx **ppCommandEx);
  ...
  HRESULT(WINAPI *GetHelpContextID)(IAgentCommandsEx *This,
                                    __LONG32 *pulHelpID);
  ...
  HRESULT(WINAPI *SetVoiceCaption)(IAgentCommandsEx *This,
                                   BSTR bszVoiceCaption);
  HRESULT(WINAPI *GetVoiceCaption)(IAgentCommandsEx *This,
                                   BSTR *bszVoiceCaption);
  HRESULT(WINAPI *AddEx)(IAgentCommandsEx *This, BSTR bszCaption, BSTR bszVoice,
                         BSTR bszVoiceCaption, __LONG32 bEnabled,
                         __LONG32 bVisible, __LONG32 ulHelpId, __LONG32 *pdwID);
  HRESULT(WINAPI *InsertEx)(IAgentCommandsEx *This, BSTR bszCaption,
                            BSTR bszVoice, BSTR bszVoiceCaption,
                            __LONG32 bEnabled, __LONG32 bVisible,
                            __LONG32 ulHelpId, __LONG32 dwRefID,
                            __LONG32 bBefore, __LONG32 *pdwID);
  HRESULT(WINAPI *SetGlobalVoiceCommandsEnabled)(IAgentCommandsEx *This,
                                                 __LONG32 bEnable);
  HRESULT(WINAPI *GetGlobalVoiceCommandsEnabled)(IAgentCommandsEx *This,
                                                 __LONG32 *pbEnabled);
  END_INTERFACE
...
#define IAgentCommandsEx_GetTypeInfo(This, iTInfo, lcid, ppTInfo)              \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IAgentCommandsEx_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,    \
                                       rgDispId)                               \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IAgentCommandsEx_Invoke(This, dispIdMember, riid, lcid, wFlags,        \
                                pDispParams, pVarResult, pExcepInfo, puArgErr) \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#define IAgentCommandsEx_GetVisible(This, pbVisible)                           \
  (This)->lpVtbl->GetVisible(This, pbVisible)
#define IAgentCommandsEx_Add(This, bszCaption, bszVoice, bEnabled, bVisible,   \
                             pdwID)                                            \
  (This)->lpVtbl->Add(This, bszCaption, bszVoice, bEnabled, bVisible, pdwID)
#define IAgentCommandsEx_Insert(This, bszCaption, bszVoice, bEnabled,          \
                                bVisible, dwRefID, bBefore, pdwID)             \
  (This)->lpVtbl->Insert(This, bszCaption, bszVoice, bEnabled, bVisible,       \
                         dwRefID, bBefore, pdwID)
...
#define IAgentCommandsEx_AddEx(This, bszCaption, bszVoice, bszVoiceCaption,    \
                               bEnabled, bVisible, ulHelpId, pdwID)            \
  (This)->lpVtbl->AddEx(This, bszCaption, bszVoice, bszVoiceCaption, bEnabled, \
                        bVisible, ulHelpId, pdwID)
#define IAgentCommandsEx_InsertEx(This, bszCaption, bszVoice, bszVoiceCaption, \
                                  bEnabled, bVisible, ulHelpId, dwRefID,       \
                                  bBefore, pdwID)                              \
  (This)->lpVtbl->InsertEx(This, bszCaption, bszVoice, bszVoiceCaption,        \
                           bEnabled, bVisible, ulHelpId, dwRefID, bBefore,     \
                           pdwID)
...
#endif
HRESULT
    WINAPI IAgentCommandsEx_GetCommandEx_Proxy(IAgentCommandsEx *This,
                                               __LONG32 dwCommandID,
                                               IAgentCommandEx **ppCommandEx);
void __RPC_STUB IAgentCommandsEx_GetCommandEx_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCommandsEx_SetDefaultID_Proxy(IAgentCommandsEx *This,
                                                   __LONG32 dwID);
void __RPC_STUB IAgentCommandsEx_SetDefaultID_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCommandsEx_GetDefaultID_Proxy(IAgentCommandsEx *This,
                                                   __LONG32 *pdwID);
void __RPC_STUB IAgentCommandsEx_GetDefaultID_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCommandsEx_SetHelpContextID_Proxy(IAgentCommandsEx *This,
                                                       __LONG32 ulHelpID);
void __RPC_STUB IAgentCommandsEx_SetHelpContextID_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCommandsEx_GetHelpContextID_Proxy(IAgentCommandsEx *This,
                                                       __LONG32 *pulHelpID);
void __RPC_STUB IAgentCommandsEx_GetHelpContextID_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCommandsEx_SetFontName_Proxy(IAgentCommandsEx *This,
                                                  BSTR bszFontName);
void __RPC_STUB IAgentCommandsEx_SetFontName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCommandsEx_GetFontName_Proxy(IAgentCommandsEx *This,
                                                  BSTR *pbszFontName);
void __RPC_STUB IAgentCommandsEx_GetFontName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCommandsEx_SetFontSize_Proxy(IAgentCommandsEx *This,
                                                  __LONG32 lFontSize);
void __RPC_STUB IAgentCommandsEx_SetFontSize_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCommandsEx_GetFontSize_Proxy(IAgentCommandsEx *This,
                                                  __LONG32 *lFontSize);
void __RPC_STUB IAgentCommandsEx_GetFontSize_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCommandsEx_SetVoiceCaption_Proxy(IAgentCommandsEx *This,
                                                      BSTR bszVoiceCaption);
void __RPC_STUB IAgentCommandsEx_SetVoiceCaption_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCommandsEx_GetVoiceCaption_Proxy(IAgentCommandsEx *This,
                                                      BSTR *bszVoiceCaption);
void __RPC_STUB IAgentCommandsEx_GetVoiceCaption_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCommandsEx_AddEx_Proxy(IAgentCommandsEx *This,
                                            BSTR bszCaption, BSTR bszVoice,
                                            BSTR bszVoiceCaption,
                                            __LONG32 bEnabled,
                                            __LONG32 bVisible,
                                            __LONG32 ulHelpId, __LONG32 *pdwID);
void __RPC_STUB IAgentCommandsEx_AddEx_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCommandsEx_InsertEx_Proxy(
    IAgentCommandsEx *This, BSTR bszCaption, BSTR bszVoice,
    BSTR bszVoiceCaption, __LONG32 bEnabled, __LONG32 bVisible,
    __LONG32 ulHelpId, __LONG32 dwRefID, __LONG32 bBefore, __LONG32 *pdwID);
void __RPC_STUB IAgentCommandsEx_InsertEx_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCommandsEx_SetGlobalVoiceCommandsEnabled_Proxy(
    IAgentCommandsEx *This, __LONG32 bEnable);
void __RPC_STUB IAgentCommandsEx_SetGlobalVoiceCommandsEnabled_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCommandsEx_GetGlobalVoiceCommandsEnabled_Proxy(
    IAgentCommandsEx *This, __LONG32 *pbEnabled);
...
typedef struct IAgentCommandWindowVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IAgentCommandWindow *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IAgentCommandWindow *This, UINT iTInfo,
                               LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IAgentCommandWindow *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IAgentCommandWindow *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  ...
  HRESULT(WINAPI *GetPosition)(IAgentCommandWindow *This, __LONG32 *plLeft,
                               __LONG32 *plTop);
  HRESULT(WINAPI *GetSize)(IAgentCommandWindow *This, __LONG32 *plWidth,
                           __LONG32 *plHeight);
  END_INTERFACE
...
#define IAgentCommandWindow_GetTypeInfo(This, iTInfo, lcid, ppTInfo)           \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IAgentCommandWindow_GetIDsOfNames(This, riid, rgszNames, cNames, lcid, \
                                          rgDispId)                            \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IAgentCommandWindow_Invoke(This, dispIdMember, riid, lcid, wFlags,     \
...
#endif
#endif
HRESULT WINAPI IAgentCommandWindow_SetVisible_Proxy(IAgentCommandWindow *This,
                                                    __LONG32 bVisible);
void __RPC_STUB IAgentCommandWindow_SetVisible_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCommandWindow_GetVisible_Proxy(IAgentCommandWindow *This,
                                                    __LONG32 *pbVisible);
void __RPC_STUB IAgentCommandWindow_GetVisible_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCommandWindow_GetPosition_Proxy(IAgentCommandWindow *This,
                                                     __LONG32 *plLeft,
                                                     __LONG32 *plTop);
void __RPC_STUB IAgentCommandWindow_GetPosition_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCommandWindow_GetSize_Proxy(IAgentCommandWindow *This,
                                                 __LONG32 *plWidth,
                                                 __LONG32 *plHeight);
...
typedef struct IAgentSpeechInputPropertiesVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IAgentSpeechInputProperties *This,
                                  REFIID riid, void **ppvObject);
  ULONG(WINAPI *AddRef)(IAgentSpeechInputProperties *This);
  ULONG(WINAPI *Release)(IAgentSpeechInputProperties *This);
  HRESULT(WINAPI *GetTypeInfoCount)(IAgentSpeechInputProperties *This,
                                    UINT *pctinfo);
  HRESULT(WINAPI *GetTypeInfo)(IAgentSpeechInputProperties *This, UINT iTInfo,
                               LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IAgentSpeechInputProperties *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IAgentSpeechInputProperties *This,
                          DISPID dispIdMember, REFIID riid, LCID lcid,
                          WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *GetInstalled)(IAgentSpeechInputProperties *This,
                                __LONG32 *pbInstalled);
  HRESULT(WINAPI *GetEnabled)(IAgentSpeechInputProperties *This,
                              __LONG32 *pbEnabled);
  HRESULT(WINAPI *GetHotKey)(IAgentSpeechInputProperties *This,
                             BSTR *pbszHotCharKey);
  HRESULT(WINAPI *GetLCID)(IAgentSpeechInputProperties *This,
                           LCID *plcidCurrent);
  HRESULT(WINAPI *GetEngine)(IAgentSpeechInputProperties *This,
                             BSTR *pbszEngine);
  HRESULT(WINAPI *SetEngine)(IAgentSpeechInputProperties *This, BSTR bszEngine);
  HRESULT(WINAPI *GetListeningTip)(IAgentSpeechInputProperties *This,
                                   __LONG32 *pbListeningTip);
  END_INTERFACE
...
#define IAgentSpeechInputProperties_GetTypeInfo(This, iTInfo, lcid, ppTInfo)   \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IAgentSpeechInputProperties_GetIDsOfNames(This, riid, rgszNames,       \
                                                  cNames, lcid, rgDispId)      \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IAgentSpeechInputProperties_Invoke(This, dispIdMember, riid, lcid,     \
...
#endif
#endif
HRESULT WINAPI IAgentSpeechInputProperties_GetInstalled_Proxy(
    IAgentSpeechInputProperties *This, __LONG32 *pbInstalled);
void __RPC_STUB IAgentSpeechInputProperties_GetInstalled_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentSpeechInputProperties_GetEnabled_Proxy(
    IAgentSpeechInputProperties *This, __LONG32 *pbEnabled);
void __RPC_STUB IAgentSpeechInputProperties_GetEnabled_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentSpeechInputProperties_GetHotKey_Proxy(
    IAgentSpeechInputProperties *This, BSTR *pbszHotCharKey);
void __RPC_STUB IAgentSpeechInputProperties_GetHotKey_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentSpeechInputProperties_GetLCID_Proxy(
    IAgentSpeechInputProperties *This, LCID *plcidCurrent);
void __RPC_STUB IAgentSpeechInputProperties_GetLCID_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentSpeechInputProperties_GetEngine_Proxy(
    IAgentSpeechInputProperties *This, BSTR *pbszEngine);
void __RPC_STUB IAgentSpeechInputProperties_GetEngine_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentSpeechInputProperties_SetEngine_Proxy(
    IAgentSpeechInputProperties *This, BSTR bszEngine);
void __RPC_STUB IAgentSpeechInputProperties_SetEngine_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentSpeechInputProperties_GetListeningTip_Proxy(
    IAgentSpeechInputProperties *This, __LONG32 *pbListeningTip);
...
public:
  ...
  GetUsingSoundEffects(__LONG32 *pbUsingSoundEffects) = 0;
};
#else
typedef struct IAgentAudioOutputPropertiesVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IAgentAudioOutputProperties *This,
                                  REFIID riid, void **ppvObject);
  ULONG(WINAPI *AddRef)(IAgentAudioOutputProperties *This);
  ULONG(WINAPI *Release)(IAgentAudioOutputProperties *This);
  HRESULT(WINAPI *GetTypeInfoCount)(IAgentAudioOutputProperties *This,
                                    UINT *pctinfo);
  HRESULT(WINAPI *GetTypeInfo)(IAgentAudioOutputProperties *This, UINT iTInfo,
                               LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IAgentAudioOutputProperties *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IAgentAudioOutputProperties *This,
                          DISPID dispIdMember, REFIID riid, LCID lcid,
                          WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *GetEnabled)(IAgentAudioOutputProperties *This,
                              __LONG32 *pbEnabled);
  HRESULT(WINAPI *GetUsingSoundEffects)(IAgentAudioOutputProperties *This,
                                        __LONG32 *pbUsingSoundEffects);
  END_INTERFACE
...
#define IAgentAudioOutputProperties_GetTypeInfo(This, iTInfo, lcid, ppTInfo)   \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IAgentAudioOutputProperties_GetIDsOfNames(This, riid, rgszNames,       \
                                                  cNames, lcid, rgDispId)      \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IAgentAudioOutputProperties_Invoke(This, dispIdMember, riid, lcid,     \
                                           wFlags, pDispParams, pVarResult,    \
                                           pExcepInfo, puArgErr)               \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
#define IAgentAudioOutputProperties_GetEnabled(This, pbEnabled)                \
  (This)->lpVtbl->GetEnabled(This, pbEnabled)
#define IAgentAudioOutputProperties_GetUsingSoundEffects(This,                 \
                                                         pbUsingSoundEffects)  \
  (This)->lpVtbl->GetUsingSoundEffects(This, pbUsingSoundEffects)
#endif
#endif
HRESULT WINAPI IAgentAudioOutputProperties_GetEnabled_Proxy(
    IAgentAudioOutputProperties *This, __LONG32 *pbEnabled);
void __RPC_STUB IAgentAudioOutputProperties_GetEnabled_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentAudioOutputProperties_GetUsingSoundEffects_Proxy(
    IAgentAudioOutputProperties *This, __LONG32 *pbUsingSoundEffects);
...
typedef struct IAgentAudioOutputPropertiesExVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IAgentAudioOutputPropertiesEx *This,
                                  REFIID riid, void **ppvObject);
  ULONG(WINAPI *AddRef)(IAgentAudioOutputPropertiesEx *This);
  ULONG(WINAPI *Release)(IAgentAudioOutputPropertiesEx *This);
  HRESULT(WINAPI *GetTypeInfoCount)(IAgentAudioOutputPropertiesEx *This,
                                    UINT *pctinfo);
  HRESULT(WINAPI *GetTypeInfo)(IAgentAudioOutputPropertiesEx *This, UINT iTInfo,
                               LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IAgentAudioOutputPropertiesEx *This,
                                 REFIID riid, LPOLESTR *rgszNames, UINT cNames,
                                 LCID lcid, DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IAgentAudioOutputPropertiesEx *This,
                          DISPID dispIdMember, REFIID riid, LCID lcid,
                          WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *GetEnabled)(IAgentAudioOutputPropertiesEx *This,
                              __LONG32 *pbEnabled);
  HRESULT(WINAPI *GetUsingSoundEffects)(IAgentAudioOutputPropertiesEx *This,
                                        __LONG32 *pbUsingSoundEffects);
  HRESULT(WINAPI *GetStatus)(IAgentAudioOutputPropertiesEx *This,
                             __LONG32 *plStatus);
  END_INTERFACE
...
#define IAgentAudioOutputPropertiesEx_GetTypeInfo(This, iTInfo, lcid, ppTInfo) \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IAgentAudioOutputPropertiesEx_GetIDsOfNames(This, riid, rgszNames,     \
                                                    cNames, lcid, rgDispId)    \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IAgentAudioOutputPropertiesEx_Invoke(This, dispIdMember, riid, lcid,   \
                                             wFlags, pDispParams, pVarResult,  \
                                             pExcepInfo, puArgErr)             \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
#define IAgentAudioOutputPropertiesEx_GetEnabled(This, pbEnabled)              \
  (This)->lpVtbl->GetEnabled(This, pbEnabled)
#define IAgentAudioOutputPropertiesEx_GetUsingSoundEffects(                    \
    This, pbUsingSoundEffects)                                                 \
  (This)->lpVtbl->GetUsingSoundEffects(This, pbUsingSoundEffects)
#define IAgentAudioOutputPropertiesEx_GetStatus(This, plStatus)                \
  (This)->lpVtbl->GetStatus(This, plStatus)
#endif
#endif
HRESULT WINAPI IAgentAudioOutputPropertiesEx_GetStatus_Proxy(
    IAgentAudioOutputPropertiesEx *This, __LONG32 *plStatus);
...
typedef struct IAgentPropertySheetVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IAgentPropertySheet *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IAgentPropertySheet *This, UINT iTInfo,
                               LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IAgentPropertySheet *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IAgentPropertySheet *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  ...
  HRESULT(WINAPI *GetPosition)(IAgentPropertySheet *This, __LONG32 *plLeft,
                               __LONG32 *plTop);
  HRESULT(WINAPI *GetSize)(IAgentPropertySheet *This, __LONG32 *plWidth,
                           __LONG32 *plHeight);
...
#define IAgentPropertySheet_GetTypeInfo(This, iTInfo, lcid, ppTInfo)           \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IAgentPropertySheet_GetIDsOfNames(This, riid, rgszNames, cNames, lcid, \
                                          rgDispId)                            \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IAgentPropertySheet_Invoke(This, dispIdMember, riid, lcid, wFlags,     \
                                   pDispParams, pVarResult, pExcepInfo,        \
                                   puArgErr)                                   \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI IAgentPropertySheet_GetVisible_Proxy(IAgentPropertySheet *This,
                                                    __LONG32 *pbVisible);
void __RPC_STUB IAgentPropertySheet_GetVisible_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentPropertySheet_SetVisible_Proxy(IAgentPropertySheet *This,
                                                    __LONG32 bVisible);
void __RPC_STUB IAgentPropertySheet_SetVisible_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentPropertySheet_GetPosition_Proxy(IAgentPropertySheet *This,
                                                     __LONG32 *plLeft,
                                                     __LONG32 *plTop);
void __RPC_STUB IAgentPropertySheet_GetPosition_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentPropertySheet_GetSize_Proxy(IAgentPropertySheet *This,
                                                 __LONG32 *plWidth,
                                                 __LONG32 *plHeight);
void __RPC_STUB IAgentPropertySheet_GetSize_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentPropertySheet_GetPage_Proxy(IAgentPropertySheet *This,
                                                 BSTR *pbszPage);
void __RPC_STUB IAgentPropertySheet_GetPage_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentPropertySheet_SetPage_Proxy(IAgentPropertySheet *This,
                                                 BSTR bszPage);
...
typedef struct IAgentBalloonVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IAgentBalloon *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IAgentBalloon *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IAgentBalloon *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IAgentBalloon *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  ...
  HRESULT(WINAPI *GetNumCharsPerLine)(IAgentBalloon *This,
                                      __LONG32 *plCharsPerLine);
  ...
  HRESULT(WINAPI *GetFontStrikethru)(IAgentBalloon *This,
                                     __LONG32 *pbFontStrikethru);
  HRESULT(WINAPI *GetFontUnderline)(IAgentBalloon *This,
                                    __LONG32 *pbFontUnderline);
...
#define IAgentBalloon_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                 \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IAgentBalloon_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,       \
                                    rgDispId)                                  \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IAgentBalloon_Invoke(This, dispIdMember, riid, lcid, wFlags,           \
                             pDispParams, pVarResult, pExcepInfo, puArgErr)    \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI IAgentBalloon_GetEnabled_Proxy(IAgentBalloon *This,
                                              __LONG32 *pbEnabled);
void __RPC_STUB IAgentBalloon_GetEnabled_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentBalloon_GetNumLines_Proxy(IAgentBalloon *This,
                                               __LONG32 *plLines);
void __RPC_STUB IAgentBalloon_GetNumLines_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentBalloon_GetNumCharsPerLine_Proxy(IAgentBalloon *This,
                                                      __LONG32 *plCharsPerLine);
void __RPC_STUB IAgentBalloon_GetNumCharsPerLine_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentBalloon_GetFontName_Proxy(IAgentBalloon *This,
                                               BSTR *pbszFontName);
void __RPC_STUB IAgentBalloon_GetFontName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentBalloon_GetFontSize_Proxy(IAgentBalloon *This,
                                               __LONG32 *plFontSize);
void __RPC_STUB IAgentBalloon_GetFontSize_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentBalloon_GetFontBold_Proxy(IAgentBalloon *This,
                                               __LONG32 *pbFontBold);
void __RPC_STUB IAgentBalloon_GetFontBold_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentBalloon_GetFontItalic_Proxy(IAgentBalloon *This,
                                                 __LONG32 *pbFontItalic);
void __RPC_STUB IAgentBalloon_GetFontItalic_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentBalloon_GetFontStrikethru_Proxy(
    IAgentBalloon *This, __LONG32 *pbFontStrikethru);
void __RPC_STUB IAgentBalloon_GetFontStrikethru_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentBalloon_GetFontUnderline_Proxy(IAgentBalloon *This,
                                                    __LONG32 *pbFontUnderline);
void __RPC_STUB IAgentBalloon_GetFontUnderline_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentBalloon_GetForeColor_Proxy(IAgentBalloon *This,
                                                __LONG32 *plFGColor);
void __RPC_STUB IAgentBalloon_GetForeColor_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentBalloon_GetBackColor_Proxy(IAgentBalloon *This,
                                                __LONG32 *plBGColor);
void __RPC_STUB IAgentBalloon_GetBackColor_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentBalloon_GetBorderColor_Proxy(IAgentBalloon *This,
                                                  __LONG32 *plBorderColor);
void __RPC_STUB IAgentBalloon_GetBorderColor_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentBalloon_SetVisible_Proxy(IAgentBalloon *This,
                                              __LONG32 bVisible);
void __RPC_STUB IAgentBalloon_SetVisible_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentBalloon_GetVisible_Proxy(IAgentBalloon *This,
                                              __LONG32 *pbVisible);
void __RPC_STUB IAgentBalloon_GetVisible_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentBalloon_SetFontName_Proxy(IAgentBalloon *This,
                                               BSTR bszFontName);
void __RPC_STUB IAgentBalloon_SetFontName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentBalloon_SetFontSize_Proxy(IAgentBalloon *This,
                                               __LONG32 lFontSize);
void __RPC_STUB IAgentBalloon_SetFontSize_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentBalloon_SetFontCharSet_Proxy(IAgentBalloon *This,
                                                  short sFontCharSet);
void __RPC_STUB IAgentBalloon_SetFontCharSet_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentBalloon_GetFontCharSet_Proxy(IAgentBalloon *This,
                                                  short *psFontCharSet);
...
typedef struct IAgentBalloonExVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IAgentBalloonEx *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IAgentBalloonEx *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IAgentBalloonEx *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IAgentBalloonEx *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  ...
  HRESULT(WINAPI *GetNumCharsPerLine)(IAgentBalloonEx *This,
                                      __LONG32 *plCharsPerLine);
  ...
  HRESULT(WINAPI *GetFontStrikethru)(IAgentBalloonEx *This,
                                     __LONG32 *pbFontStrikethru);
  HRESULT(WINAPI *GetFontUnderline)(IAgentBalloonEx *This,
                                    __LONG32 *pbFontUnderline);
  ...
  HRESULT(WINAPI *GetBorderColor)(IAgentBalloonEx *This,
                                  __LONG32 *plBorderColor);
  ...
  HRESULT(WINAPI *SetNumCharsPerLine)(IAgentBalloonEx *This,
                                      __LONG32 lCharsPerLine);
  END_INTERFACE
} IAgentBalloonExVtbl;
...
#define IAgentBalloonEx_GetTypeInfo(This, iTInfo, lcid, ppTInfo)               \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IAgentBalloonEx_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,     \
                                      rgDispId)                                \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IAgentBalloonEx_Invoke(This, dispIdMember, riid, lcid, wFlags,         \
                               pDispParams, pVarResult, pExcepInfo, puArgErr)  \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI IAgentBalloonEx_SetStyle_Proxy(IAgentBalloonEx *This,
                                              __LONG32 lStyle);
void __RPC_STUB IAgentBalloonEx_SetStyle_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentBalloonEx_GetStyle_Proxy(IAgentBalloonEx *This,
                                              __LONG32 *plStyle);
void __RPC_STUB IAgentBalloonEx_GetStyle_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentBalloonEx_SetNumLines_Proxy(IAgentBalloonEx *This,
                                                 __LONG32 lLines);
void __RPC_STUB IAgentBalloonEx_SetNumLines_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentBalloonEx_SetNumCharsPerLine_Proxy(IAgentBalloonEx *This,
                                                        __LONG32 lCharsPerLine);
...
public:
  ...
  virtual HRESULT WINAPI Prepare(__LONG32 dwType, BSTR bszName, __LONG32 bQueue,
                                 __LONG32 *pdwReqID) = 0;
  ...
  virtual HRESULT WINAPI Speak(BSTR bszText, BSTR bszUrl,
                               __LONG32 *pdwReqID) = 0;
  virtual HRESULT WINAPI MoveTo(short x, short y, __LONG32 lSpeed,
                                __LONG32 *pdwReqID) = 0;
...
typedef struct IAgentCharacterVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IAgentCharacter *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IAgentCharacter *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IAgentCharacter *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IAgentCharacter *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *GetVisible)(IAgentCharacter *This, __LONG32 *pbVisible);
  HRESULT(WINAPI *SetPosition)(IAgentCharacter *This, __LONG32 lLeft,
                               __LONG32 lTop);
  HRESULT(WINAPI *GetPosition)(IAgentCharacter *This, __LONG32 *plLeft,
                               __LONG32 *plTop);
  HRESULT(WINAPI *SetSize)(IAgentCharacter *This, __LONG32 lWidth,
                           __LONG32 lHeight);
  HRESULT(WINAPI *GetSize)(IAgentCharacter *This, __LONG32 *plWidth,
                           __LONG32 *plHeight);
  ...
  HRESULT(WINAPI *Prepare)(IAgentCharacter *This, __LONG32 dwType, BSTR bszName,
                           __LONG32 bQueue, __LONG32 *pdwReqID);
  HRESULT(WINAPI *Play)(IAgentCharacter *This, BSTR bszAnimation,
                        __LONG32 *pdwReqID);
  HRESULT(WINAPI *Stop)(IAgentCharacter *This, __LONG32 dwReqID);
  HRESULT(WINAPI *StopAll)(IAgentCharacter *This, __LONG32 lTypes);
  HRESULT(WINAPI *Wait)(IAgentCharacter *This, __LONG32 dwReqID,
                        __LONG32 *pdwReqID);
  HRESULT(WINAPI *Interrupt)(IAgentCharacter *This, __LONG32 dwReqID,
                             __LONG32 *pdwReqID);
  HRESULT(WINAPI *Show)(IAgentCharacter *This, __LONG32 bFast,
                        __LONG32 *pdwReqID);
  HRESULT(WINAPI *Hide)(IAgentCharacter *This, __LONG32 bFast,
                        __LONG32 *pdwReqID);
  HRESULT(WINAPI *Speak)(IAgentCharacter *This, BSTR bszText, BSTR bszUrl,
                         __LONG32 *pdwReqID);
  HRESULT(WINAPI *MoveTo)(IAgentCharacter *This, short x, short y,
                          __LONG32 lSpeed, __LONG32 *pdwReqID);
  HRESULT(WINAPI *GestureAt)(IAgentCharacter *This, short x, short y,
                             __LONG32 *pdwReqID);
  HRESULT(WINAPI *GetMoveCause)(IAgentCharacter *This, __LONG32 *pdwCause);
  HRESULT(WINAPI *GetVisibilityCause)(IAgentCharacter *This,
                                      __LONG32 *pdwCause);
  HRESULT(WINAPI *HasOtherClients)(IAgentCharacter *This,
                                   __LONG32 *plNumOtherClients);
...
#define IAgentCharacter_GetTypeInfo(This, iTInfo, lcid, ppTInfo)               \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IAgentCharacter_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,     \
                                      rgDispId)                                \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IAgentCharacter_Invoke(This, dispIdMember, riid, lcid, wFlags,         \
                               pDispParams, pVarResult, pExcepInfo, puArgErr)  \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI IAgentCharacter_GetVisible_Proxy(IAgentCharacter *This,
                                                __LONG32 *pbVisible);
void __RPC_STUB IAgentCharacter_GetVisible_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacter_SetPosition_Proxy(IAgentCharacter *This,
                                                 __LONG32 lLeft, __LONG32 lTop);
void __RPC_STUB IAgentCharacter_SetPosition_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacter_GetPosition_Proxy(IAgentCharacter *This,
                                                 __LONG32 *plLeft,
                                                 __LONG32 *plTop);
void __RPC_STUB IAgentCharacter_GetPosition_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacter_SetSize_Proxy(IAgentCharacter *This,
                                             __LONG32 lWidth, __LONG32 lHeight);
void __RPC_STUB IAgentCharacter_SetSize_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacter_GetSize_Proxy(IAgentCharacter *This,
                                             __LONG32 *plWidth,
                                             __LONG32 *plHeight);
void __RPC_STUB IAgentCharacter_GetSize_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacter_GetName_Proxy(IAgentCharacter *This,
                                             BSTR *pbszName);
void __RPC_STUB IAgentCharacter_GetName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacter_GetDescription_Proxy(IAgentCharacter *This,
                                                    BSTR *pbszDescription);
void __RPC_STUB IAgentCharacter_GetDescription_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacter_GetTTSSpeed_Proxy(IAgentCharacter *This,
                                                 __LONG32 *pdwSpeed);
void __RPC_STUB IAgentCharacter_GetTTSSpeed_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacter_GetTTSPitch_Proxy(IAgentCharacter *This,
                                                 short *pwPitch);
void __RPC_STUB IAgentCharacter_GetTTSPitch_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacter_Activate_Proxy(IAgentCharacter *This,
                                              short sState);
void __RPC_STUB IAgentCharacter_Activate_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacter_SetIdleOn_Proxy(IAgentCharacter *This,
                                               __LONG32 bOn);
void __RPC_STUB IAgentCharacter_SetIdleOn_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacter_GetIdleOn_Proxy(IAgentCharacter *This,
                                               __LONG32 *pbOn);
void __RPC_STUB IAgentCharacter_GetIdleOn_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacter_Prepare_Proxy(IAgentCharacter *This,
                                             __LONG32 dwType, BSTR bszName,
                                             __LONG32 bQueue,
                                             __LONG32 *pdwReqID);
void __RPC_STUB IAgentCharacter_Prepare_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacter_Play_Proxy(IAgentCharacter *This,
                                          BSTR bszAnimation,
                                          __LONG32 *pdwReqID);
void __RPC_STUB IAgentCharacter_Play_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacter_Stop_Proxy(IAgentCharacter *This,
                                          __LONG32 dwReqID);
void __RPC_STUB IAgentCharacter_Stop_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacter_StopAll_Proxy(IAgentCharacter *This,
                                             __LONG32 lTypes);
void __RPC_STUB IAgentCharacter_StopAll_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacter_Wait_Proxy(IAgentCharacter *This,
                                          __LONG32 dwReqID, __LONG32 *pdwReqID);
void __RPC_STUB IAgentCharacter_Wait_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacter_Interrupt_Proxy(IAgentCharacter *This,
                                               __LONG32 dwReqID,
                                               __LONG32 *pdwReqID);
void __RPC_STUB IAgentCharacter_Interrupt_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacter_Show_Proxy(IAgentCharacter *This, __LONG32 bFast,
                                          __LONG32 *pdwReqID);
void __RPC_STUB IAgentCharacter_Show_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacter_Hide_Proxy(IAgentCharacter *This, __LONG32 bFast,
                                          __LONG32 *pdwReqID);
void __RPC_STUB IAgentCharacter_Hide_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacter_Speak_Proxy(IAgentCharacter *This, BSTR bszText,
                                           BSTR bszUrl, __LONG32 *pdwReqID);
void __RPC_STUB IAgentCharacter_Speak_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacter_MoveTo_Proxy(IAgentCharacter *This, short x,
                                            short y, __LONG32 lSpeed,
                                            __LONG32 *pdwReqID);
void __RPC_STUB IAgentCharacter_MoveTo_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacter_GestureAt_Proxy(IAgentCharacter *This, short x,
                                               short y, __LONG32 *pdwReqID);
void __RPC_STUB IAgentCharacter_GestureAt_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacter_GetMoveCause_Proxy(IAgentCharacter *This,
                                                  __LONG32 *pdwCause);
void __RPC_STUB IAgentCharacter_GetMoveCause_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacter_GetVisibilityCause_Proxy(IAgentCharacter *This,
                                                        __LONG32 *pdwCause);
void __RPC_STUB IAgentCharacter_GetVisibilityCause_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacter_HasOtherClients_Proxy(
    IAgentCharacter *This, __LONG32 *plNumOtherClients);
void __RPC_STUB IAgentCharacter_HasOtherClients_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacter_SetSoundEffectsOn_Proxy(IAgentCharacter *This,
                                                       __LONG32 bOn);
void __RPC_STUB IAgentCharacter_SetSoundEffectsOn_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacter_GetSoundEffectsOn_Proxy(IAgentCharacter *This,
                                                       __LONG32 *pbOn);
void __RPC_STUB IAgentCharacter_GetSoundEffectsOn_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacter_SetName_Proxy(IAgentCharacter *This,
                                             BSTR bszName);
void __RPC_STUB IAgentCharacter_SetName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacter_SetDescription_Proxy(IAgentCharacter *This,
                                                    BSTR bszDescription);
void __RPC_STUB IAgentCharacter_SetDescription_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacter_GetExtraData_Proxy(IAgentCharacter *This,
                                                  BSTR *pbszExtraData);
...
public:
  ...
  virtual HRESULT WINAPI GetOriginalSize(__LONG32 *plWidth,
                                         __LONG32 *plHeight) = 0;
...
typedef struct IAgentCharacterExVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IAgentCharacterEx *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IAgentCharacterEx *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IAgentCharacterEx *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IAgentCharacterEx *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *GetVisible)(IAgentCharacterEx *This, __LONG32 *pbVisible);
  HRESULT(WINAPI *SetPosition)(IAgentCharacterEx *This, __LONG32 lLeft,
                               __LONG32 lTop);
  HRESULT(WINAPI *GetPosition)(IAgentCharacterEx *This, __LONG32 *plLeft,
                               __LONG32 *plTop);
  HRESULT(WINAPI *SetSize)(IAgentCharacterEx *This, __LONG32 lWidth,
                           __LONG32 lHeight);
  HRESULT(WINAPI *GetSize)(IAgentCharacterEx *This, __LONG32 *plWidth,
                           __LONG32 *plHeight);
  HRESULT(WINAPI *GetName)(IAgentCharacterEx *This, BSTR *pbszName);
  HRESULT(WINAPI *GetDescription)(IAgentCharacterEx *This,
                                  BSTR *pbszDescription);
  ...
  HRESULT(WINAPI *Prepare)(IAgentCharacterEx *This, __LONG32 dwType,
                           BSTR bszName, __LONG32 bQueue, __LONG32 *pdwReqID);
  HRESULT(WINAPI *Play)(IAgentCharacterEx *This, BSTR bszAnimation,
                        __LONG32 *pdwReqID);
  HRESULT(WINAPI *Stop)(IAgentCharacterEx *This, __LONG32 dwReqID);
  HRESULT(WINAPI *StopAll)(IAgentCharacterEx *This, __LONG32 lTypes);
  HRESULT(WINAPI *Wait)(IAgentCharacterEx *This, __LONG32 dwReqID,
                        __LONG32 *pdwReqID);
  HRESULT(WINAPI *Interrupt)(IAgentCharacterEx *This, __LONG32 dwReqID,
                             __LONG32 *pdwReqID);
  HRESULT(WINAPI *Show)(IAgentCharacterEx *This, __LONG32 bFast,
                        __LONG32 *pdwReqID);
  HRESULT(WINAPI *Hide)(IAgentCharacterEx *This, __LONG32 bFast,
                        __LONG32 *pdwReqID);
  HRESULT(WINAPI *Speak)(IAgentCharacterEx *This, BSTR bszText, BSTR bszUrl,
                         __LONG32 *pdwReqID);
  HRESULT(WINAPI *MoveTo)(IAgentCharacterEx *This, short x, short y,
                          __LONG32 lSpeed, __LONG32 *pdwReqID);
  HRESULT(WINAPI *GestureAt)(IAgentCharacterEx *This, short x, short y,
                             __LONG32 *pdwReqID);
  HRESULT(WINAPI *GetMoveCause)(IAgentCharacterEx *This, __LONG32 *pdwCause);
  HRESULT(WINAPI *GetVisibilityCause)(IAgentCharacterEx *This,
                                      __LONG32 *pdwCause);
  HRESULT(WINAPI *HasOtherClients)(IAgentCharacterEx *This,
                                   __LONG32 *plNumOtherClients);
  ...
  HRESULT(WINAPI *SetAutoPopupMenu)(IAgentCharacterEx *This,
                                    __LONG32 bAutoPopupMenu);
  HRESULT(WINAPI *GetAutoPopupMenu)(IAgentCharacterEx *This,
                                    __LONG32 *pbAutoPopupMenu);
  ...
  HRESULT(WINAPI *GetHelpModeOn)(IAgentCharacterEx *This,
                                 __LONG32 *pbHelpModeOn);
  ...
  HRESULT(WINAPI *GetOriginalSize)(IAgentCharacterEx *This, __LONG32 *plWidth,
                                   __LONG32 *plHeight);
  HRESULT(WINAPI *Think)(IAgentCharacterEx *This, BSTR bszText,
                         __LONG32 *pdwReqID);
  HRESULT(WINAPI *GetVersion)(IAgentCharacterEx *This, short *psMajor,
                              short *psMinor);
  HRESULT(WINAPI *GetAnimationNames)(IAgentCharacterEx *This,
                                     IUnknown **punkEnum);
...
#define IAgentCharacterEx_GetTypeInfo(This, iTInfo, lcid, ppTInfo)             \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IAgentCharacterEx_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,   \
                                        rgDispId)                              \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IAgentCharacterEx_Invoke(This, dispIdMember, riid, lcid, wFlags,       \
                                 pDispParams, pVarResult, pExcepInfo,          \
                                 puArgErr)                                     \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI IAgentCharacterEx_ShowPopupMenu_Proxy(IAgentCharacterEx *This,
                                                     short x, short y);
void __RPC_STUB IAgentCharacterEx_ShowPopupMenu_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacterEx_SetAutoPopupMenu_Proxy(
    IAgentCharacterEx *This, __LONG32 bAutoPopupMenu);
void __RPC_STUB IAgentCharacterEx_SetAutoPopupMenu_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacterEx_GetAutoPopupMenu_Proxy(
    IAgentCharacterEx *This, __LONG32 *pbAutoPopupMenu);
void __RPC_STUB IAgentCharacterEx_GetAutoPopupMenu_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacterEx_GetHelpFileName_Proxy(IAgentCharacterEx *This,
                                                       BSTR *pbszName);
void __RPC_STUB IAgentCharacterEx_GetHelpFileName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacterEx_SetHelpFileName_Proxy(IAgentCharacterEx *This,
                                                       BSTR bszName);
void __RPC_STUB IAgentCharacterEx_SetHelpFileName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacterEx_SetHelpModeOn_Proxy(IAgentCharacterEx *This,
                                                     __LONG32 bHelpModeOn);
void __RPC_STUB IAgentCharacterEx_SetHelpModeOn_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacterEx_GetHelpModeOn_Proxy(IAgentCharacterEx *This,
                                                     __LONG32 *pbHelpModeOn);
void __RPC_STUB IAgentCharacterEx_GetHelpModeOn_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacterEx_SetHelpContextID_Proxy(IAgentCharacterEx *This,
                                                        __LONG32 ulID);
void __RPC_STUB IAgentCharacterEx_SetHelpContextID_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacterEx_GetHelpContextID_Proxy(IAgentCharacterEx *This,
                                                        __LONG32 *pulID);
void __RPC_STUB IAgentCharacterEx_GetHelpContextID_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacterEx_GetActive_Proxy(IAgentCharacterEx *This,
                                                 short *psState);
void __RPC_STUB IAgentCharacterEx_GetActive_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacterEx_Listen_Proxy(IAgentCharacterEx *This,
                                              __LONG32 bListen);
void __RPC_STUB IAgentCharacterEx_Listen_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacterEx_SetLanguageID_Proxy(IAgentCharacterEx *This,
                                                     __LONG32 langid);
void __RPC_STUB IAgentCharacterEx_SetLanguageID_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacterEx_GetLanguageID_Proxy(IAgentCharacterEx *This,
                                                     __LONG32 *plangid);
void __RPC_STUB IAgentCharacterEx_GetLanguageID_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacterEx_GetTTSModeID_Proxy(IAgentCharacterEx *This,
                                                    BSTR *pbszModeID);
void __RPC_STUB IAgentCharacterEx_GetTTSModeID_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacterEx_SetTTSModeID_Proxy(IAgentCharacterEx *This,
                                                    BSTR bszModeID);
void __RPC_STUB IAgentCharacterEx_SetTTSModeID_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacterEx_GetSRModeID_Proxy(IAgentCharacterEx *This,
                                                   BSTR *pbszModeID);
void __RPC_STUB IAgentCharacterEx_GetSRModeID_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacterEx_SetSRModeID_Proxy(IAgentCharacterEx *This,
                                                   BSTR bszModeID);
void __RPC_STUB IAgentCharacterEx_SetSRModeID_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacterEx_GetGUID_Proxy(IAgentCharacterEx *This,
                                               BSTR *pbszID);
void __RPC_STUB IAgentCharacterEx_GetGUID_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacterEx_GetOriginalSize_Proxy(IAgentCharacterEx *This,
                                                       __LONG32 *plWidth,
                                                       __LONG32 *plHeight);
void __RPC_STUB IAgentCharacterEx_GetOriginalSize_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacterEx_Think_Proxy(IAgentCharacterEx *This,
                                             BSTR bszText, __LONG32 *pdwReqID);
void __RPC_STUB IAgentCharacterEx_Think_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacterEx_GetVersion_Proxy(IAgentCharacterEx *This,
                                                  short *psMajor,
                                                  short *psMinor);
void __RPC_STUB IAgentCharacterEx_GetVersion_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacterEx_GetAnimationNames_Proxy(
    IAgentCharacterEx *This, IUnknown **punkEnum);
void __RPC_STUB IAgentCharacterEx_GetAnimationNames_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentCharacterEx_GetSRStatus_Proxy(IAgentCharacterEx *This,
                                                   __LONG32 *plStatus);
...
public:
  virtual HRESULT WINAPI Load(VARIANT vLoadKey, __LONG32 *pdwCharID,
                              __LONG32 *pdwReqID) = 0;
  virtual HRESULT WINAPI Unload(__LONG32 dwCharID) = 0;
  virtual HRESULT WINAPI Register(IUnknown *punkNotifySink,
                                  __LONG32 *pdwSinkID) = 0;
  virtual HRESULT WINAPI Unregister(__LONG32 dwSinkID) = 0;
  virtual HRESULT WINAPI GetCharacter(__LONG32 dwCharID,
...
typedef struct IAgentVtbl {
  ...
  HRESULT(WINAPI *GetTypeInfo)(IAgent *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IAgent *This, REFIID riid, LPOLESTR *rgszNames,
                                 UINT cNames, LCID lcid, DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IAgent *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *Load)(IAgent *This, VARIANT vLoadKey, __LONG32 *pdwCharID,
                        __LONG32 *pdwReqID);
  ...
  HRESULT(WINAPI *GetCharacter)(IAgent *This, __LONG32 dwCharID,
...
#define IAgent_GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)    \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IAgent_Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,     \
                      pVarResult, pExcepInfo, puArgErr)                        \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI IAgent_Load_Proxy(IAgent *This, VARIANT vLoadKey,
                                 __LONG32 *pdwCharID, __LONG32 *pdwReqID);
void __RPC_STUB IAgent_Load_Stub(IRpcStubBuffer *This,
                                 IRpcChannelBuffer *_pRpcChannelBuffer,
                                 PRPC_MESSAGE _pRpcMessage,
                                 DWORD *_pdwStubPhase);
HRESULT WINAPI IAgent_Unload_Proxy(IAgent *This, __LONG32 dwCharID);
void __RPC_STUB IAgent_Unload_Stub(IRpcStubBuffer *This,
                                   IRpcChannelBuffer *_pRpcChannelBuffer,
                                   PRPC_MESSAGE _pRpcMessage,
                                   DWORD *_pdwStubPhase);
HRESULT WINAPI IAgent_Register_Proxy(IAgent *This, IUnknown *punkNotifySink,
                                     __LONG32 *pdwSinkID);
void __RPC_STUB IAgent_Register_Stub(IRpcStubBuffer *This,
                                     IRpcChannelBuffer *_pRpcChannelBuffer,
                                     PRPC_MESSAGE _pRpcMessage,
                                     DWORD *_pdwStubPhase);
HRESULT WINAPI IAgent_Unregister_Proxy(IAgent *This, __LONG32 dwSinkID);
void __RPC_STUB IAgent_Unregister_Stub(IRpcStubBuffer *This,
                                       IRpcChannelBuffer *_pRpcChannelBuffer,
                                       PRPC_MESSAGE _pRpcMessage,
                                       DWORD *_pdwStubPhase);
HRESULT WINAPI IAgent_GetCharacter_Proxy(IAgent *This, __LONG32 dwCharID,
                                         IDispatch **ppunkCharacter);
void __RPC_STUB IAgent_GetCharacter_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
HRESULT WINAPI IAgent_GetSuspended_Proxy(IAgent *This, __LONG32 *pbSuspended);
void __RPC_STUB IAgent_GetSuspended_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
#endif
...
public:
  virtual HRESULT WINAPI GetCharacterEx(__LONG32 dwCharID,
                                        IAgentCharacterEx **ppCharacterEx) = 0;
  virtual HRESULT WINAPI GetVersion(short *psMajor, short *psMinor) = 0;
  virtual HRESULT WINAPI ShowDefaultCharacterProperties(
      short x, short y, __LONG32 bUseDefaultPosition) = 0;
};
#else
typedef struct IAgentExVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IAgentEx *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IAgentEx *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IAgentEx *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IAgentEx *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *Load)(IAgentEx *This, VARIANT vLoadKey, __LONG32 *pdwCharID,
                        __LONG32 *pdwReqID);
  HRESULT(WINAPI *Unload)(IAgentEx *This, __LONG32 dwCharID);
  HRESULT(WINAPI *Register)(IAgentEx *This, IUnknown *punkNotifySink,
                            __LONG32 *pdwSinkID);
  HRESULT(WINAPI *Unregister)(IAgentEx *This, __LONG32 dwSinkID);
  HRESULT(WINAPI *GetCharacter)(IAgentEx *This, __LONG32 dwCharID,
                                IDispatch **ppunkCharacter);
  HRESULT(WINAPI *GetSuspended)(IAgentEx *This, __LONG32 *pbSuspended);
  HRESULT(WINAPI *GetCharacterEx)(IAgentEx *This, __LONG32 dwCharID,
                                  IAgentCharacterEx **ppCharacterEx);
  HRESULT(WINAPI *GetVersion)(IAgentEx *This, short *psMajor, short *psMinor);
  HRESULT(WINAPI *ShowDefaultCharacterProperties)(IAgentEx *This, short x,
                                                  short y,
                                                  __LONG32 bUseDefaultPosition);
  END_INTERFACE
} IAgentExVtbl;
struct IAgentEx {
...
#define IAgentEx_GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)  \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IAgentEx_Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,   \
                        pVarResult, pExcepInfo, puArgErr)                      \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#define IAgentEx_GetVersion(This, psMajor, psMinor)                            \
  (This)->lpVtbl->GetVersion(This, psMajor, psMinor)
#define IAgentEx_ShowDefaultCharacterProperties(This, x, y,                    \
                                                bUseDefaultPosition)           \
  (This)->lpVtbl->ShowDefaultCharacterProperties(This, x, y,                   \
                                                 bUseDefaultPosition)
#endif
#endif
HRESULT WINAPI IAgentEx_GetCharacterEx_Proxy(IAgentEx *This, __LONG32 dwCharID,
                                             IAgentCharacterEx **ppCharacterEx);
void __RPC_STUB IAgentEx_GetCharacterEx_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentEx_GetVersion_Proxy(IAgentEx *This, short *psMajor,
                                         short *psMinor);
void __RPC_STUB IAgentEx_GetVersion_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentEx_ShowDefaultCharacterProperties_Proxy(
    IAgentEx *This, short x, short y, __LONG32 bUseDefaultPosition);
...
public:
  virtual HRESULT WINAPI Command(__LONG32 dwCommandID,
                                 IUnknown *punkUserInput) = 0;
  virtual HRESULT WINAPI ActivateInputState(__LONG32 dwCharID,
                                            __LONG32 bActivated) = 0;
  virtual HRESULT WINAPI Restart(void) = 0;
  virtual HRESULT WINAPI Shutdown(void) = 0;
  virtual HRESULT WINAPI VisibleState(__LONG32 dwCharID, __LONG32 bVisible,
                                      __LONG32 dwCause) = 0;
  virtual HRESULT WINAPI Click(__LONG32 dwCharID, short fwKeys, __LONG32 x,
                               __LONG32 y) = 0;
  virtual HRESULT WINAPI DblClick(__LONG32 dwCharID, short fwKeys, __LONG32 x,
                                  __LONG32 y) = 0;
  virtual HRESULT WINAPI DragStart(__LONG32 dwCharID, short fwKeys, __LONG32 x,
                                   __LONG32 y) = 0;
  virtual HRESULT WINAPI DragComplete(__LONG32 dwCharID, short fwKeys,
                                      __LONG32 x, __LONG32 y) = 0;
  virtual HRESULT WINAPI RequestStart(__LONG32 dwRequestID) = 0;
  virtual HRESULT WINAPI RequestComplete(__LONG32 dwRequestID,
                                         __LONG32 hrStatus) = 0;
  virtual HRESULT WINAPI BookMark(__LONG32 dwBookMarkID) = 0;
  virtual HRESULT WINAPI Idle(__LONG32 dwCharID, __LONG32 bStart) = 0;
  virtual HRESULT WINAPI Move(__LONG32 dwCharID, __LONG32 x, __LONG32 y,
                              __LONG32 dwCause) = 0;
  virtual HRESULT WINAPI Size(__LONG32 dwCharID, __LONG32 lWidth,
                              __LONG32 lHeight) = 0;
  virtual HRESULT WINAPI BalloonVisibleState(__LONG32 dwCharID,
                                             __LONG32 bVisible) = 0;
};
#else
typedef struct IAgentNotifySinkVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IAgentNotifySink *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IAgentNotifySink *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IAgentNotifySink *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IAgentNotifySink *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *Command)(IAgentNotifySink *This, __LONG32 dwCommandID,
                           IUnknown *punkUserInput);
  HRESULT(WINAPI *ActivateInputState)(IAgentNotifySink *This, __LONG32 dwCharID,
                                      __LONG32 bActivated);
  HRESULT(WINAPI *Restart)(IAgentNotifySink *This);
  HRESULT(WINAPI *Shutdown)(IAgentNotifySink *This);
  HRESULT(WINAPI *VisibleState)(IAgentNotifySink *This, __LONG32 dwCharID,
                                __LONG32 bVisible, __LONG32 dwCause);
  HRESULT(WINAPI *Click)(IAgentNotifySink *This, __LONG32 dwCharID,
                         short fwKeys, __LONG32 x, __LONG32 y);
  HRESULT(WINAPI *DblClick)(IAgentNotifySink *This, __LONG32 dwCharID,
                            short fwKeys, __LONG32 x, __LONG32 y);
  HRESULT(WINAPI *DragStart)(IAgentNotifySink *This, __LONG32 dwCharID,
                             short fwKeys, __LONG32 x, __LONG32 y);
  HRESULT(WINAPI *DragComplete)(IAgentNotifySink *This, __LONG32 dwCharID,
                                short fwKeys, __LONG32 x, __LONG32 y);
  HRESULT(WINAPI *RequestStart)(IAgentNotifySink *This, __LONG32 dwRequestID);
  HRESULT(WINAPI *RequestComplete)(IAgentNotifySink *This, __LONG32 dwRequestID,
                                   __LONG32 hrStatus);
  HRESULT(WINAPI *BookMark)(IAgentNotifySink *This, __LONG32 dwBookMarkID);
  HRESULT(WINAPI *Idle)(IAgentNotifySink *This, __LONG32 dwCharID,
                        __LONG32 bStart);
  HRESULT(WINAPI *Move)(IAgentNotifySink *This, __LONG32 dwCharID, __LONG32 x,
                        __LONG32 y, __LONG32 dwCause);
  HRESULT(WINAPI *Size)(IAgentNotifySink *This, __LONG32 dwCharID,
                        __LONG32 lWidth, __LONG32 lHeight);
  HRESULT(WINAPI *BalloonVisibleState)(IAgentNotifySink *This,
                                       __LONG32 dwCharID, __LONG32 bVisible);
  END_INTERFACE
...
#define IAgentNotifySink_GetTypeInfo(This, iTInfo, lcid, ppTInfo)              \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IAgentNotifySink_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,    \
                                       rgDispId)                               \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IAgentNotifySink_Invoke(This, dispIdMember, riid, lcid, wFlags,        \
                                pDispParams, pVarResult, pExcepInfo, puArgErr) \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI IAgentNotifySink_Command_Proxy(IAgentNotifySink *This,
                                              __LONG32 dwCommandID,
                                              IUnknown *punkUserInput);
void __RPC_STUB IAgentNotifySink_Command_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentNotifySink_ActivateInputState_Proxy(IAgentNotifySink *This,
                                                         __LONG32 dwCharID,
                                                         __LONG32 bActivated);
...
void __RPC_STUB IAgentNotifySink_Shutdown_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentNotifySink_VisibleState_Proxy(IAgentNotifySink *This,
                                                   __LONG32 dwCharID,
                                                   __LONG32 bVisible,
                                                   __LONG32 dwCause);
void __RPC_STUB IAgentNotifySink_VisibleState_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentNotifySink_Click_Proxy(IAgentNotifySink *This,
                                            __LONG32 dwCharID, short fwKeys,
                                            __LONG32 x, __LONG32 y);
void __RPC_STUB IAgentNotifySink_Click_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentNotifySink_DblClick_Proxy(IAgentNotifySink *This,
                                               __LONG32 dwCharID, short fwKeys,
                                               __LONG32 x, __LONG32 y);
void __RPC_STUB IAgentNotifySink_DblClick_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentNotifySink_DragStart_Proxy(IAgentNotifySink *This,
                                                __LONG32 dwCharID, short fwKeys,
                                                __LONG32 x, __LONG32 y);
void __RPC_STUB IAgentNotifySink_DragStart_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentNotifySink_DragComplete_Proxy(IAgentNotifySink *This,
                                                   __LONG32 dwCharID,
                                                   short fwKeys, __LONG32 x,
                                                   __LONG32 y);
void __RPC_STUB IAgentNotifySink_DragComplete_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentNotifySink_RequestStart_Proxy(IAgentNotifySink *This,
                                                   __LONG32 dwRequestID);
void __RPC_STUB IAgentNotifySink_RequestStart_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentNotifySink_RequestComplete_Proxy(IAgentNotifySink *This,
                                                      __LONG32 dwRequestID,
                                                      __LONG32 hrStatus);
void __RPC_STUB IAgentNotifySink_RequestComplete_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentNotifySink_BookMark_Proxy(IAgentNotifySink *This,
                                               __LONG32 dwBookMarkID);
void __RPC_STUB IAgentNotifySink_BookMark_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentNotifySink_Idle_Proxy(IAgentNotifySink *This,
                                           __LONG32 dwCharID, __LONG32 bStart);
void __RPC_STUB IAgentNotifySink_Idle_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentNotifySink_Move_Proxy(IAgentNotifySink *This,
                                           __LONG32 dwCharID, __LONG32 x,
                                           __LONG32 y, __LONG32 dwCause);
void __RPC_STUB IAgentNotifySink_Move_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentNotifySink_Size_Proxy(IAgentNotifySink *This,
                                           __LONG32 dwCharID, __LONG32 lWidth,
                                           __LONG32 lHeight);
void __RPC_STUB IAgentNotifySink_Size_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentNotifySink_BalloonVisibleState_Proxy(
    IAgentNotifySink *This, __LONG32 dwCharID, __LONG32 bVisible);
...
public:
  virtual HRESULT WINAPI HelpComplete(__LONG32 dwCharID, __LONG32 dwCommandID,
                                      __LONG32 dwCause) = 0;
  virtual HRESULT WINAPI ListeningState(__LONG32 dwCharID, __LONG32 bListening,
                                        __LONG32 dwCause) = 0;
  virtual HRESULT WINAPI DefaultCharacterChange(BSTR bszGUID) = 0;
  virtual HRESULT WINAPI AgentPropertyChange(void) = 0;
  virtual HRESULT WINAPI ActiveClientChange(__LONG32 dwCharID,
                                            __LONG32 lStatus) = 0;
};
#else
typedef struct IAgentNotifySinkExVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IAgentNotifySinkEx *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IAgentNotifySinkEx *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IAgentNotifySinkEx *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IAgentNotifySinkEx *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *Command)(IAgentNotifySinkEx *This, __LONG32 dwCommandID,
                           IUnknown *punkUserInput);
  HRESULT(WINAPI *ActivateInputState)(IAgentNotifySinkEx *This,
                                      __LONG32 dwCharID, __LONG32 bActivated);
  HRESULT(WINAPI *Restart)(IAgentNotifySinkEx *This);
  HRESULT(WINAPI *Shutdown)(IAgentNotifySinkEx *This);
  HRESULT(WINAPI *VisibleState)(IAgentNotifySinkEx *This, __LONG32 dwCharID,
                                __LONG32 bVisible, __LONG32 dwCause);
  HRESULT(WINAPI *Click)(IAgentNotifySinkEx *This, __LONG32 dwCharID,
                         short fwKeys, __LONG32 x, __LONG32 y);
  HRESULT(WINAPI *DblClick)(IAgentNotifySinkEx *This, __LONG32 dwCharID,
                            short fwKeys, __LONG32 x, __LONG32 y);
  HRESULT(WINAPI *DragStart)(IAgentNotifySinkEx *This, __LONG32 dwCharID,
                             short fwKeys, __LONG32 x, __LONG32 y);
  HRESULT(WINAPI *DragComplete)(IAgentNotifySinkEx *This, __LONG32 dwCharID,
                                short fwKeys, __LONG32 x, __LONG32 y);
  HRESULT(WINAPI *RequestStart)(IAgentNotifySinkEx *This, __LONG32 dwRequestID);
  HRESULT(WINAPI *RequestComplete)(IAgentNotifySinkEx *This,
                                   __LONG32 dwRequestID, __LONG32 hrStatus);
  HRESULT(WINAPI *BookMark)(IAgentNotifySinkEx *This, __LONG32 dwBookMarkID);
  HRESULT(WINAPI *Idle)(IAgentNotifySinkEx *This, __LONG32 dwCharID,
                        __LONG32 bStart);
  HRESULT(WINAPI *Move)(IAgentNotifySinkEx *This, __LONG32 dwCharID, __LONG32 x,
                        __LONG32 y, __LONG32 dwCause);
  HRESULT(WINAPI *Size)(IAgentNotifySinkEx *This, __LONG32 dwCharID,
                        __LONG32 lWidth, __LONG32 lHeight);
  HRESULT(WINAPI *BalloonVisibleState)(IAgentNotifySinkEx *This,
                                       __LONG32 dwCharID, __LONG32 bVisible);
  HRESULT(WINAPI *HelpComplete)(IAgentNotifySinkEx *This, __LONG32 dwCharID,
                                __LONG32 dwCommandID, __LONG32 dwCause);
  HRESULT(WINAPI *ListeningState)(IAgentNotifySinkEx *This, __LONG32 dwCharID,
                                  __LONG32 bListening, __LONG32 dwCause);
  HRESULT(WINAPI *DefaultCharacterChange)(IAgentNotifySinkEx *This,
                                          BSTR bszGUID);
  HRESULT(WINAPI *AgentPropertyChange)(IAgentNotifySinkEx *This);
  HRESULT(WINAPI *ActiveClientChange)(IAgentNotifySinkEx *This,
                                      __LONG32 dwCharID, __LONG32 lStatus);
  END_INTERFACE
...
#define IAgentNotifySinkEx_GetTypeInfo(This, iTInfo, lcid, ppTInfo)            \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IAgentNotifySinkEx_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,  \
                                         rgDispId)                             \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IAgentNotifySinkEx_Invoke(This, dispIdMember, riid, lcid, wFlags,      \
                                  pDispParams, pVarResult, pExcepInfo,         \
                                  puArgErr)                                    \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI IAgentNotifySinkEx_HelpComplete_Proxy(IAgentNotifySinkEx *This,
                                                     __LONG32 dwCharID,
                                                     __LONG32 dwCommandID,
                                                     __LONG32 dwCause);
void __RPC_STUB IAgentNotifySinkEx_HelpComplete_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentNotifySinkEx_ListeningState_Proxy(IAgentNotifySinkEx *This,
                                                       __LONG32 dwCharID,
                                                       __LONG32 bListening,
                                                       __LONG32 dwCause);
void __RPC_STUB IAgentNotifySinkEx_ListeningState_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentNotifySinkEx_DefaultCharacterChange_Proxy(
    IAgentNotifySinkEx *This, BSTR bszGUID);
void __RPC_STUB IAgentNotifySinkEx_DefaultCharacterChange_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
IAgentNotifySinkEx_AgentPropertyChange_Proxy(IAgentNotifySinkEx *This);
void __RPC_STUB IAgentNotifySinkEx_AgentPropertyChange_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentNotifySinkEx_ActiveClientChange_Proxy(
    IAgentNotifySinkEx *This, __LONG32 dwCharID, __LONG32 lStatus);
...
typedef struct IAgentPrivateNotifySinkVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IAgentPrivateNotifySink *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetClientID)(IAgentPrivateNotifySink *This,
                               DWORD *pdwClientID);
  END_INTERFACE
...
#endif
HRESULT WINAPI
IAgentPrivateNotifySink_ReleaseAll_Proxy(IAgentPrivateNotifySink *This);
void __RPC_STUB IAgentPrivateNotifySink_ReleaseAll_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentPrivateNotifySink_ReleaseOne_Proxy(
    IAgentPrivateNotifySink *This, void *pnNotify);
void __RPC_STUB IAgentPrivateNotifySink_ReleaseOne_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IAgentPrivateNotifySink_GetClientID_Proxy(
    IAgentPrivateNotifySink *This, DWORD *pdwClientID);
...
public:
  virtual HRESULT WINAPI Create(IUnknown *pSink, REFIID riidSink,
                                IUnknown **pMarshaledSink) = 0;
};
#else
typedef struct IAgentCustomMarshalMakerVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IAgentCustomMarshalMaker *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IAgentCustomMarshalMaker *This);
  ULONG(WINAPI *Release)(IAgentCustomMarshalMaker *This);
  HRESULT(WINAPI *Create)(IAgentCustomMarshalMaker *This, IUnknown *pSink,
                          REFIID riidSink, IUnknown **pMarshaledSink);
  END_INTERFACE
...
#endif
#endif
HRESULT WINAPI IAgentCustomMarshalMaker_Create_Proxy(
    IAgentCustomMarshalMaker *This, IUnknown *pSink, REFIID riidSink,
    IUnknown **pMarshaledSink);
...
typedef struct IAgentClientStatusVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IAgentClientStatus *This, REFIID riid,
                                  void **ppvObject);
