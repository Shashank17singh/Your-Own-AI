...
#endif
#include <lmcons.h>
NET_API_STATUS WINAPI NetUserAdd(LPCWSTR servername, DWORD level, LPBYTE buf,
                                 LPDWORD parm_err);
NET_API_STATUS WINAPI NetUserEnum(LPCWSTR servername, DWORD level, DWORD filter,
...
#define UF_ACCOUNT_TYPE_MASK                                                   \
  (UF_TEMP_DUPLICATE_ACCOUNT | UF_NORMAL_ACCOUNT |                             \
   UF_INTERDOMAIN_TRUST_ACCOUNT | UF_WORKSTATION_TRUST_ACCOUNT |               \
   UF_SERVER_TRUST_ACCOUNT)
...
#define UF_SETTABLE_BITS                                                       \
  (UF_SCRIPT | UF_ACCOUNTDISABLE | UF_LOCKOUT | UF_HOMEDIR_REQUIRED |          \
   ...
   UF_DONT_EXPIRE_PASSWD | UF_MNS_LOGON_ACCOUNT |                              \
   UF_ENCRYPTED_TEXT_PASSWORD_ALLOWED | UF_SMARTCARD_REQUIRED |                \
...
#define AF_SETTABLE_BITS                                                       \
  (AF_OP_PRINT | AF_OP_COMM | AF_OP_SERVER | AF_OP_ACCOUNTS)
...
#ifndef _LMGROUP_
#define _LMGROUP_
NET_API_STATUS WINAPI NetGroupAdd(LPCWSTR servername, DWORD level, LPBYTE buf,
                                  LPDWORD parm_err);
NET_API_STATUS WINAPI NetGroupAddUser(LPCWSTR servername, LPCWSTR GroupName,
                                      LPCWSTR username);
NET_API_STATUS WINAPI NetGroupEnum(LPCWSTR servername, DWORD level,
                                   LPBYTE *bufptr, DWORD prefmaxlen,
                                   LPDWORD entriesread, LPDWORD totalentries,
                                   PDWORD_PTR resume_handle);
NET_API_STATUS WINAPI NetGroupGetInfo(LPCWSTR servername, LPCWSTR groupname,
                                      DWORD level, LPBYTE *bufptr);
NET_API_STATUS WINAPI NetGroupSetInfo(LPCWSTR servername, LPCWSTR groupname,
                                      DWORD level, LPBYTE buf,
                                      LPDWORD parm_err);
NET_API_STATUS WINAPI NetGroupDel(LPCWSTR servername, LPCWSTR groupname);
NET_API_STATUS WINAPI NetGroupDelUser(LPCWSTR servername, LPCWSTR GroupName,
                                      LPCWSTR Username);
NET_API_STATUS WINAPI NetGroupGetUsers(LPCWSTR servername, LPCWSTR groupname,
                                       DWORD level, LPBYTE *bufptr,
                                       DWORD prefmaxlen, LPDWORD entriesread,
                                       LPDWORD totalentries,
                                       PDWORD_PTR ResumeHandle);
NET_API_STATUS WINAPI NetGroupSetUsers(LPCWSTR servername, LPCWSTR groupname,
                                       DWORD level, LPBYTE buf,
                                       DWORD totalentries);
...
NET_API_STATUS WINAPI NetLocalGroupAddMember(LPCWSTR servername,
                                             LPCWSTR groupname, PSID membersid);
...
NetLocalGroupGetMembers(LPCWSTR servername, LPCWSTR localgroupname, DWORD level,
...
NET_API_STATUS WINAPI NetQueryDisplayInformation(LPCWSTR ServerName,
                                                 DWORD Level, DWORD Index,
                                                 DWORD EntriesRequested,
                                                 DWORD PreferredMaximumLength,
                                                 LPDWORD ReturnedEntryCount,
                                                 PVOID *SortedBuffer);
NET_API_STATUS WINAPI NetGetDisplayInformationIndex(LPCWSTR ServerName,
                                                    DWORD Level, LPCWSTR Prefix,
                                                    LPDWORD Index);
...
NET_API_STATUS WINAPI NetAccessAdd(LPCWSTR servername, DWORD level, LPBYTE buf,
                                   LPDWORD parm_err);
NET_API_STATUS WINAPI NetAccessEnum(LPCWSTR servername, LPCWSTR BasePath,
                                    DWORD Recursive, DWORD level,
                                    LPBYTE *bufptr, DWORD prefmaxlen,
                                    LPDWORD entriesread, LPDWORD totalentries,
                                    LPDWORD resume_handle);
NET_API_STATUS WINAPI NetAccessGetInfo(LPCWSTR servername, LPCWSTR resource,
                                       DWORD level, LPBYTE *bufptr);
NET_API_STATUS WINAPI NetAccessSetInfo(LPCWSTR servername, LPCWSTR resource,
                                       DWORD level, LPBYTE buf,
                                       LPDWORD parm_err);
NET_API_STATUS WINAPI NetAccessDel(LPCWSTR servername, LPCWSTR resource);
NET_API_STATUS WINAPI NetAccessGetUserPerms(LPCWSTR servername, LPCWSTR UGname,
                                            LPCWSTR resource, LPDWORD Perms);
...
NET_API_STATUS WINAPI
NetValidatePasswordPolicy(LPCWSTR ServerName, LPVOID Qualifier,
                          NET_VALIDATE_PASSWORD_TYPE ValidationType,
                          LPVOID InputArg, LPVOID *OutputArg);
NET_API_STATUS WINAPI NetValidatePasswordPolicyFree(LPVOID *OutputArg);
#endif
#ifndef _LMDOMAIN_
#define _LMDOMAIN_
NET_API_STATUS WINAPI NetGetDCName(LPCWSTR servername, LPCWSTR domainname,
                                   LPBYTE *bufptr);
NET_API_STATUS WINAPI NetGetAnyDCName(LPCWSTR servername, LPCWSTR domainname,
                                      LPBYTE *bufptr);
NET_API_STATUS WINAPI I_NetLogonControl(LPCWSTR ServerName, DWORD FunctionCode,
                                        DWORD QueryLevel, LPBYTE *Buffer);
NET_API_STATUS WINAPI I_NetLogonControl2(LPCWSTR ServerName, DWORD FunctionCode,
                                         DWORD QueryLevel, LPBYTE Data,
                                         LPBYTE *Buffer);
#if !defined(_NTDEF_) && !defined(_NTSTATUS_PSDK)
#define _NTSTATUS_PSDK
typedef LONG NTSTATUS, *PNTSTATUS;
#endif
NTSTATUS WINAPI NetEnumerateTrustedDomains(LPWSTR ServerName,
                                           LPWSTR *DomainNames);
...
NTSTATUS WINAPI NetAddServiceAccount(LPWSTR ServerName, LPWSTR AccountName,
                                     LPWSTR Reserved, DWORD Flags);
NTSTATUS WINAPI NetRemoveServiceAccount(LPWSTR ServerName, LPWSTR AccountName,
                                        DWORD Flags);
NTSTATUS WINAPI NetIsServiceAccount(LPWSTR ServerName, LPWSTR AccountName,
                                    BOOL *IsService);
NTSTATUS WINAPI NetEnumerateServiceAccounts(LPWSTR ServerName, DWORD Flags,
                                            DWORD *AccountsCount,
                                            PZPWSTR *Accounts);
