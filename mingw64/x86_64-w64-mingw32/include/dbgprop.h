...
typedef interface IDebugPropertyEnumType_Arguments
...
typedef interface IDebugPropertyEnumType_LocalsPlusArgs
...
typedef interface IDebugPropertyEnumType_Registers
...
#define DBGPROP_INFO_STANDARD                                                  \
  (((DBGPROP_INFO_NAME | DBGPROP_INFO_TYPE) | DBGPROP_INFO_VALUE) |            \
   DBGPROP_INFO_ATTRIBUTES)
#define DBGPROP_INFO_ALL                                                       \
  (((((DBGPROP_INFO_NAME | DBGPROP_INFO_TYPE) | DBGPROP_INFO_VALUE) |          \
...
#define PROP_INFO_STANDARD                                                     \
  (((PROP_INFO_NAME | PROP_INFO_TYPE) | PROP_INFO_VALUE) | PROP_INFO_ATTRIBUTES)
#define PROP_INFO_ALL                                                          \
  (((((PROP_INFO_NAME | PROP_INFO_TYPE) | PROP_INFO_VALUE) |                   \
     PROP_INFO_FULLNAME) |                                                     \
...
DEFINE_GUID(IID_IDebugProperty, 0x51973c50, 0xcb0c, 0x11d0, 0xb5, 0xc9, 0x00,
...
IDebugProperty : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetPropertyInfo(
      DWORD dwFieldSpec, UINT nRadix, DebugPropertyInfo * pPropertyInfo) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetExtendedInfo(
      ULONG cInfos, GUID * rgguidExtendedInfo, VARIANT * rgvar) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetValueAsString(LPCOLESTR pszValue,
                                                     UINT nRadix) = 0;
  virtual HRESULT STDMETHODCALLTYPE EnumMembers(
      DWORD dwFieldSpec, UINT nRadix, REFIID refiid,
      IEnumDebugPropertyInfo * *ppepi) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetParent(IDebugProperty *
                                              *ppDebugProp) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDebugProperty, 0x51973c50, 0xcb0c, 0x11d0, 0xb5, 0xc9, 0x00,
                0xa0, 0x24, 0x4a, 0x0e, 0x7a)
#endif
#else
typedef struct IDebugPropertyVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDebugProperty *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetPropertyInfo)(IDebugProperty *This,
                                              DWORD dwFieldSpec, UINT nRadix,
                                              DebugPropertyInfo *pPropertyInfo);
  HRESULT(STDMETHODCALLTYPE *GetExtendedInfo)(IDebugProperty *This,
                                              ULONG cInfos,
                                              GUID *rgguidExtendedInfo,
                                              VARIANT *rgvar);
  HRESULT(STDMETHODCALLTYPE *SetValueAsString)(IDebugProperty *This,
                                               LPCOLESTR pszValue, UINT nRadix);
  HRESULT(STDMETHODCALLTYPE *EnumMembers)(IDebugProperty *This,
                                          DWORD dwFieldSpec, UINT nRadix,
                                          REFIID refiid,
                                          IEnumDebugPropertyInfo **ppepi);
  HRESULT(STDMETHODCALLTYPE *GetParent)(IDebugProperty *This,
                                        IDebugProperty **ppDebugProp);
  END_INTERFACE
} IDebugPropertyVtbl;
interface IDebugProperty { CONST_VTBL IDebugPropertyVtbl *lpVtbl; };
#ifdef COBJMACROS
...
/*** IDebugProperty methods ***/
#define IDebugProperty_GetPropertyInfo(This, dwFieldSpec, nRadix,              \
                                       pPropertyInfo)                          \
  (This)->lpVtbl->GetPropertyInfo(This, dwFieldSpec, nRadix, pPropertyInfo)
#define IDebugProperty_GetExtendedInfo(This, cInfos, rgguidExtendedInfo,       \
                                       rgvar)                                  \
...
#else
/*** IUnknown methods ***/
static inline HRESULT IDebugProperty_QueryInterface(IDebugProperty *This,
                                                    REFIID riid,
                                                    void **ppvObject) {
...
IDebugProperty_GetPropertyInfo(IDebugProperty *This, DWORD dwFieldSpec,
                               UINT nRadix, DebugPropertyInfo *pPropertyInfo) {
  return This->lpVtbl->GetPropertyInfo(This, dwFieldSpec, nRadix,
                                       pPropertyInfo);
}
static inline HRESULT IDebugProperty_GetExtendedInfo(IDebugProperty *This,
                                                     ULONG cInfos,
                                                     GUID *rgguidExtendedInfo,
                                                     VARIANT *rgvar) {
  return This->lpVtbl->GetExtendedInfo(This, cInfos, rgguidExtendedInfo, rgvar);
}
static inline HRESULT IDebugProperty_SetValueAsString(IDebugProperty *This,
                                                      LPCOLESTR pszValue,
                                                      UINT nRadix) {
  return This->lpVtbl->SetValueAsString(This, pszValue, nRadix);
}
static inline HRESULT
IDebugProperty_EnumMembers(IDebugProperty *This, DWORD dwFieldSpec, UINT nRadix,
                           REFIID refiid, IEnumDebugPropertyInfo **ppepi) {
  return This->lpVtbl->EnumMembers(This, dwFieldSpec, nRadix, refiid, ppepi);
}
static inline HRESULT IDebugProperty_GetParent(IDebugProperty *This,
                                               IDebugProperty **ppDebugProp) {
...
HRESULT STDMETHODCALLTYPE IDebugProperty_RemoteGetPropertyInfo_Proxy(
    IDebugProperty *This, DWORD dwFieldSpec, UINT nRadix, DWORD *dwValidFields,
    BSTR *pbstrName, BSTR *pbstrType, BSTR *pbstrValue, BSTR *pbstrFullName,
    DWORD *pdwAttrib, IDebugProperty **ppDebugProperty);
...
HRESULT CALLBACK IDebugProperty_GetPropertyInfo_Proxy(
    IDebugProperty *This, DWORD dwFieldSpec, UINT nRadix,
    DebugPropertyInfo *pPropertyInfo);
...
DEFINE_GUID(IID_IEnumDebugPropertyInfo, 0x51973c51, 0xcb0c, 0x11d0, 0xb5, 0xc9,
            0x00, 0xa0, 0x24, 0x4a, 0x0e, 0x7a);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("51973c51-cb0c-11d0-b5c9-00a0244a0e7a")
IEnumDebugPropertyInfo : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE Next(ULONG celt, DebugPropertyInfo * pi,
                                         ULONG * pcEltsfetched) = 0;
  virtual HRESULT STDMETHODCALLTYPE Skip(ULONG celt) = 0;
  virtual HRESULT STDMETHODCALLTYPE Reset() = 0;
  virtual HRESULT STDMETHODCALLTYPE Clone(IEnumDebugPropertyInfo * *ppepi) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetCount(ULONG * pcelt) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IEnumDebugPropertyInfo, 0x51973c51, 0xcb0c, 0x11d0, 0xb5, 0xc9,
                0x00, 0xa0, 0x24, 0x4a, 0x0e, 0x7a)
#endif
#else
typedef struct IEnumDebugPropertyInfoVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IEnumDebugPropertyInfo *This,
  ...
  HRESULT(STDMETHODCALLTYPE *Next)(IEnumDebugPropertyInfo *This, ULONG celt,
                                   DebugPropertyInfo *pi, ULONG *pcEltsfetched);
  ...
  HRESULT(STDMETHODCALLTYPE *Clone)(IEnumDebugPropertyInfo *This,
                                    IEnumDebugPropertyInfo **ppepi);
  HRESULT(STDMETHODCALLTYPE *GetCount)(IEnumDebugPropertyInfo *This,
                                       ULONG *pcelt);
  END_INTERFACE
...
/*** IUnknown methods ***/
static inline HRESULT
IEnumDebugPropertyInfo_QueryInterface(IEnumDebugPropertyInfo *This, REFIID riid,
                                      void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IEnumDebugPropertyInfo_AddRef(IEnumDebugPropertyInfo *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IEnumDebugPropertyInfo_Release(IEnumDebugPropertyInfo *This) {
  return This->lpVtbl->Release(This);
}
/*** IEnumDebugPropertyInfo methods ***/
static inline HRESULT IEnumDebugPropertyInfo_Next(IEnumDebugPropertyInfo *This,
                                                  ULONG celt,
                                                  DebugPropertyInfo *pi,
                                                  ULONG *pcEltsfetched) {
  return This->lpVtbl->Next(This, celt, pi, pcEltsfetched);
}
static inline HRESULT IEnumDebugPropertyInfo_Skip(IEnumDebugPropertyInfo *This,
                                                  ULONG celt) {
  return This->lpVtbl->Skip(This, celt);
}
static inline HRESULT
IEnumDebugPropertyInfo_Reset(IEnumDebugPropertyInfo *This) {
  return This->lpVtbl->Reset(This);
}
static inline HRESULT
IEnumDebugPropertyInfo_Clone(IEnumDebugPropertyInfo *This,
                             IEnumDebugPropertyInfo **ppepi) {
  return This->lpVtbl->Clone(This, ppepi);
}
static inline HRESULT
IEnumDebugPropertyInfo_GetCount(IEnumDebugPropertyInfo *This, ULONG *pcelt) {
...
#endif
HRESULT __stdcall
IEnumDebugPropertyInfo_RemoteNext_Proxy(IEnumDebugPropertyInfo *This,
                                        ULONG celt, DebugPropertyInfo *pinfo,
                                        ULONG *pcEltsfetched);
void __RPC_STUB IEnumDebugPropertyInfo_RemoteNext_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage, DWORD *pdwStubPhase);
HRESULT CALLBACK IEnumDebugPropertyInfo_Next_Proxy(IEnumDebugPropertyInfo *This,
                                                   ULONG celt,
                                                   DebugPropertyInfo *pi,
                                                   ULONG *pcEltsfetched);
HRESULT __RPC_STUB IEnumDebugPropertyInfo_Next_Stub(
    IEnumDebugPropertyInfo *This, ULONG celt, DebugPropertyInfo *pinfo,
    ULONG *pcEltsfetched);
...
DEFINE_GUID(IID_IDebugExtendedProperty, 0x51973c52, 0xcb0c, 0x11d0, 0xb5, 0xc9,
            0x00, 0xa0, 0x24, 0x4a, 0x0e, 0x7a);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDebugExtendedProperty, 0x51973c52, 0xcb0c, 0x11d0, 0xb5, 0xc9,
                0x00, 0xa0, 0x24, 0x4a, 0x0e, 0x7a)
#endif
#else
typedef struct IDebugExtendedPropertyVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDebugExtendedProperty *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IDebugExtendedProperty *This);
  ULONG(STDMETHODCALLTYPE *Release)(IDebugExtendedProperty *This);
  /*** IDebugProperty methods ***/
  HRESULT(STDMETHODCALLTYPE *GetPropertyInfo)(IDebugExtendedProperty *This,
                                              DWORD dwFieldSpec, UINT nRadix,
                                              DebugPropertyInfo *pPropertyInfo);
  HRESULT(STDMETHODCALLTYPE *GetExtendedInfo)(IDebugExtendedProperty *This,
                                              ULONG cInfos,
                                              GUID *rgguidExtendedInfo,
                                              VARIANT *rgvar);
  HRESULT(STDMETHODCALLTYPE *SetValueAsString)(IDebugExtendedProperty *This,
                                               LPCOLESTR pszValue, UINT nRadix);
  HRESULT(STDMETHODCALLTYPE *EnumMembers)(IDebugExtendedProperty *This,
                                          DWORD dwFieldSpec, UINT nRadix,
                                          REFIID refiid,
                                          IEnumDebugPropertyInfo **ppepi);
  HRESULT(STDMETHODCALLTYPE *GetParent)(IDebugExtendedProperty *This,
                                        IDebugProperty **ppDebugProp);
  /*** IDebugExtendedProperty methods ***/
  HRESULT(STDMETHODCALLTYPE *GetExtendedPropertyInfo)(
      IDebugExtendedProperty *This, DWORD dwFieldSpec, UINT nRadix,
...
/*** IDebugProperty methods ***/
#define IDebugExtendedProperty_GetPropertyInfo(This, dwFieldSpec, nRadix,      \
                                               pPropertyInfo)                  \
  (This)->lpVtbl->GetPropertyInfo(This, dwFieldSpec, nRadix, pPropertyInfo)
#define IDebugExtendedProperty_GetExtendedInfo(This, cInfos,                   \
                                               rgguidExtendedInfo, rgvar)      \
  (This)->lpVtbl->GetExtendedInfo(This, cInfos, rgguidExtendedInfo, rgvar)
#define IDebugExtendedProperty_SetValueAsString(This, pszValue, nRadix)        \
  (This)->lpVtbl->SetValueAsString(This, pszValue, nRadix)
#define IDebugExtendedProperty_EnumMembers(This, dwFieldSpec, nRadix, refiid,  \
                                           ppepi)                              \
  (This)->lpVtbl->EnumMembers(This, dwFieldSpec, nRadix, refiid, ppepi)
...
#define IDebugExtendedProperty_GetExtendedPropertyInfo(                        \
    This, dwFieldSpec, nRadix, pExtendedPropertyInfo)                          \
  (This)->lpVtbl->GetExtendedPropertyInfo(This, dwFieldSpec, nRadix,           \
                                          pExtendedPropertyInfo)
#define IDebugExtendedProperty_EnumExtendedMembers(This, dwFieldSpec, nRadix,  \
                                                   ppeepi)                     \
  (This)->lpVtbl->EnumExtendedMembers(This, dwFieldSpec, nRadix, ppeepi)
#else
/*** IUnknown methods ***/
static inline HRESULT
IDebugExtendedProperty_QueryInterface(IDebugExtendedProperty *This, REFIID riid,
                                      void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IDebugExtendedProperty_AddRef(IDebugExtendedProperty *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IDebugExtendedProperty_Release(IDebugExtendedProperty *This) {
  return This->lpVtbl->Release(This);
}
/*** IDebugProperty methods ***/
static inline HRESULT
IDebugExtendedProperty_GetPropertyInfo(IDebugExtendedProperty *This,
                                       DWORD dwFieldSpec, UINT nRadix,
                                       DebugPropertyInfo *pPropertyInfo) {
  return This->lpVtbl->GetPropertyInfo(This, dwFieldSpec, nRadix,
                                       pPropertyInfo);
...
static inline HRESULT
IDebugExtendedProperty_GetExtendedInfo(IDebugExtendedProperty *This,
                                       ULONG cInfos, GUID *rgguidExtendedInfo,
                                       VARIANT *rgvar) {
  return This->lpVtbl->GetExtendedInfo(This, cInfos, rgguidExtendedInfo, rgvar);
}
static inline HRESULT
IDebugExtendedProperty_SetValueAsString(IDebugExtendedProperty *This,
                                        LPCOLESTR pszValue, UINT nRadix) {
  return This->lpVtbl->SetValueAsString(This, pszValue, nRadix);
}
static inline HRESULT IDebugExtendedProperty_EnumMembers(
    IDebugExtendedProperty *This, DWORD dwFieldSpec, UINT nRadix, REFIID refiid,
    IEnumDebugPropertyInfo **ppepi) {
  return This->lpVtbl->EnumMembers(This, dwFieldSpec, nRadix, refiid, ppepi);
}
static inline HRESULT
IDebugExtendedProperty_GetParent(IDebugExtendedProperty *This,
                                 IDebugProperty **ppDebugProp) {
  return This->lpVtbl->GetParent(This, ppDebugProp);
}
/*** IDebugExtendedProperty methods ***/
static inline HRESULT IDebugExtendedProperty_GetExtendedPropertyInfo(
    IDebugExtendedProperty *This, DWORD dwFieldSpec, UINT nRadix,
    ExtendedDebugPropertyInfo *pExtendedPropertyInfo) {
  return This->lpVtbl->GetExtendedPropertyInfo(This, dwFieldSpec, nRadix,
                                               pExtendedPropertyInfo);
}
static inline HRESULT IDebugExtendedProperty_EnumExtendedMembers(
    IDebugExtendedProperty *This, DWORD dwFieldSpec, UINT nRadix,
    IEnumDebugExtendedPropertyInfo **ppeepi) {
...
DEFINE_GUID(IID_IEnumDebugExtendedPropertyInfo, 0x51973c53, 0xcb0c, 0x11d0,
...
IEnumDebugExtendedPropertyInfo : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE Next(
      ULONG celt, ExtendedDebugPropertyInfo * rgExtendedPropertyInfo,
      ULONG * pceltFetched) = 0;
  virtual HRESULT STDMETHODCALLTYPE Skip(ULONG celt) = 0;
  virtual HRESULT STDMETHODCALLTYPE Reset() = 0;
  virtual HRESULT STDMETHODCALLTYPE Clone(IEnumDebugExtendedPropertyInfo *
                                          *pedpe) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetCount(ULONG * pcelt) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IEnumDebugExtendedPropertyInfo, 0x51973c53, 0xcb0c, 0x11d0,
                0xb5, 0xc9, 0x00, 0xa0, 0x24, 0x4a, 0x0e, 0x7a)
#endif
#else
typedef struct IEnumDebugExtendedPropertyInfoVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(
      IEnumDebugExtendedPropertyInfo *This, REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *Next)(
      IEnumDebugExtendedPropertyInfo *This, ULONG celt,
      ExtendedDebugPropertyInfo *rgExtendedPropertyInfo, ULONG *pceltFetched);
  HRESULT(STDMETHODCALLTYPE *Skip)(IEnumDebugExtendedPropertyInfo *This,
                                   ULONG celt);
  HRESULT(STDMETHODCALLTYPE *Reset)(IEnumDebugExtendedPropertyInfo *This);
  HRESULT(STDMETHODCALLTYPE *Clone)(IEnumDebugExtendedPropertyInfo *This,
                                    IEnumDebugExtendedPropertyInfo **pedpe);
  HRESULT(STDMETHODCALLTYPE *GetCount)(IEnumDebugExtendedPropertyInfo *This,
                                       ULONG *pcelt);
  END_INTERFACE
...
/*** IEnumDebugExtendedPropertyInfo methods ***/
#define IEnumDebugExtendedPropertyInfo_Next(                                   \
    This, celt, rgExtendedPropertyInfo, pceltFetched)                          \
...
#else
/*** IUnknown methods ***/
static inline HRESULT IEnumDebugExtendedPropertyInfo_QueryInterface(
    IEnumDebugExtendedPropertyInfo *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IEnumDebugExtendedPropertyInfo_AddRef(IEnumDebugExtendedPropertyInfo *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IEnumDebugExtendedPropertyInfo_Release(IEnumDebugExtendedPropertyInfo *This) {
  return This->lpVtbl->Release(This);
}
/*** IEnumDebugExtendedPropertyInfo methods ***/
static inline HRESULT IEnumDebugExtendedPropertyInfo_Next(
    IEnumDebugExtendedPropertyInfo *This, ULONG celt,
    ExtendedDebugPropertyInfo *rgExtendedPropertyInfo, ULONG *pceltFetched) {
  return This->lpVtbl->Next(This, celt, rgExtendedPropertyInfo, pceltFetched);
}
static inline HRESULT
IEnumDebugExtendedPropertyInfo_Skip(IEnumDebugExtendedPropertyInfo *This,
                                    ULONG celt) {
  return This->lpVtbl->Skip(This, celt);
}
static inline HRESULT
IEnumDebugExtendedPropertyInfo_Reset(IEnumDebugExtendedPropertyInfo *This) {
  return This->lpVtbl->Reset(This);
}
static inline HRESULT
IEnumDebugExtendedPropertyInfo_Clone(IEnumDebugExtendedPropertyInfo *This,
                                     IEnumDebugExtendedPropertyInfo **pedpe) {
  return This->lpVtbl->Clone(This, pedpe);
}
static inline HRESULT
IEnumDebugExtendedPropertyInfo_GetCount(IEnumDebugExtendedPropertyInfo *This,
                                        ULONG *pcelt) {
  return This->lpVtbl->GetCount(This, pcelt);
}
#endif
...
DEFINE_GUID(IID_IPerPropertyBrowsing2, 0x51973c54, 0xcb0c, 0x11d0, 0xb5, 0xc9,
            0x00, 0xa0, 0x24, 0x4a, 0x0e, 0x7a);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IPerPropertyBrowsing2 : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE MapPropertyToPage(
      DISPID dispid, CLSID * pClsidPropPage) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetPredefinedStrings(
      DISPID dispid, CALPOLESTR * pCaStrings, CADWORD * pCaCookies) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetPredefinedValue(DISPID dispid,
                                                       DWORD dwCookie) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IPerPropertyBrowsing2, 0x51973c54, 0xcb0c, 0x11d0, 0xb5, 0xc9,
                0x00, 0xa0, 0x24, 0x4a, 0x0e, 0x7a)
#endif
#else
typedef struct IPerPropertyBrowsing2Vtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPerPropertyBrowsing2 *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetDisplayString)(IPerPropertyBrowsing2 *This,
                                               DISPID dispid, BSTR *pBstr);
  HRESULT(STDMETHODCALLTYPE *MapPropertyToPage)(IPerPropertyBrowsing2 *This,
                                                DISPID dispid,
                                                CLSID *pClsidPropPage);
  HRESULT(STDMETHODCALLTYPE *GetPredefinedStrings)(IPerPropertyBrowsing2 *This,
                                                   DISPID dispid,
                                                   CALPOLESTR *pCaStrings,
                                                   CADWORD *pCaCookies);
  HRESULT(STDMETHODCALLTYPE *SetPredefinedValue)(IPerPropertyBrowsing2 *This,
...
#define IPerPropertyBrowsing2_GetPredefinedStrings(This, dispid, pCaStrings,   \
                                                   pCaCookies)                 \
...
/*** IUnknown methods ***/
static inline HRESULT
IPerPropertyBrowsing2_QueryInterface(IPerPropertyBrowsing2 *This, REFIID riid,
                                     void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IPerPropertyBrowsing2 methods ***/
static inline HRESULT
IPerPropertyBrowsing2_GetDisplayString(IPerPropertyBrowsing2 *This,
                                       DISPID dispid, BSTR *pBstr) {
  return This->lpVtbl->GetDisplayString(This, dispid, pBstr);
}
static inline HRESULT
IPerPropertyBrowsing2_MapPropertyToPage(IPerPropertyBrowsing2 *This,
                                        DISPID dispid, CLSID *pClsidPropPage) {
  return This->lpVtbl->MapPropertyToPage(This, dispid, pClsidPropPage);
}
static inline HRESULT IPerPropertyBrowsing2_GetPredefinedStrings(
    IPerPropertyBrowsing2 *This, DISPID dispid, CALPOLESTR *pCaStrings,
    CADWORD *pCaCookies) {
  return This->lpVtbl->GetPredefinedStrings(This, dispid, pCaStrings,
                                            pCaCookies);
}
static inline HRESULT
IPerPropertyBrowsing2_SetPredefinedValue(IPerPropertyBrowsing2 *This,
                                         DISPID dispid, DWORD dwCookie) {
...
DEFINE_GUID(IID_IDebugPropertyEnumType_All, 0x51973c55, 0xcb0c, 0x11d0, 0xb5,
...
IDebugPropertyEnumType_All : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetName(BSTR * a) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDebugPropertyEnumType_All, 0x51973c55, 0xcb0c, 0x11d0, 0xb5,
                0xc9, 0x00, 0xa0, 0x24, 0x4a, 0x0e, 0x7a)
#endif
#else
typedef struct IDebugPropertyEnumType_AllVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDebugPropertyEnumType_All *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetName)(IDebugPropertyEnumType_All *This,
                                      BSTR *a);
  END_INTERFACE
...
/*** IDebugPropertyEnumType_All methods ***/
#define IDebugPropertyEnumType_All_GetName(This, a)                            \
  (This)->lpVtbl->GetName(This, a)
#else
/*** IUnknown methods ***/
static inline HRESULT
IDebugPropertyEnumType_All_QueryInterface(IDebugPropertyEnumType_All *This,
                                          REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IDebugPropertyEnumType_All_AddRef(IDebugPropertyEnumType_All *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IDebugPropertyEnumType_All_Release(IDebugPropertyEnumType_All *This) {
  return This->lpVtbl->Release(This);
}
/*** IDebugPropertyEnumType_All methods ***/
static inline HRESULT
IDebugPropertyEnumType_All_GetName(IDebugPropertyEnumType_All *This, BSTR *a) {
...
DEFINE_GUID(IID_IDebugPropertyEnumType_Locals, 0x51973c56, 0xcb0c, 0x11d0, 0xb5,
            0xc9, 0x00, 0xa0, 0x24, 0x4a, 0x0e, 0x7a);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("51973c56-cb0c-11d0-b5c9-00a0244a0e7a")
IDebugPropertyEnumType_Locals : public IDebugPropertyEnumType_All{};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDebugPropertyEnumType_Locals, 0x51973c56, 0xcb0c, 0x11d0, 0xb5,
                0xc9, 0x00, 0xa0, 0x24, 0x4a, 0x0e, 0x7a)
#endif
#else
typedef struct IDebugPropertyEnumType_LocalsVtbl {
  ...
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(
      IDebugPropertyEnumType_Locals *This, REFIID riid, void **ppvObject);
  ...
  /*** IDebugPropertyEnumType_All methods ***/
  HRESULT(STDMETHODCALLTYPE *GetName)(IDebugPropertyEnumType_Locals *This,
                                      BSTR *a);
  END_INTERFACE
...
#define IDebugPropertyEnumType_Locals_Release(This)                            \
  (This)->lpVtbl->Release(This)
/*** IDebugPropertyEnumType_All methods ***/
#define IDebugPropertyEnumType_Locals_GetName(This, a)                         \
  (This)->lpVtbl->GetName(This, a)
#else
/*** IUnknown methods ***/
static inline HRESULT IDebugPropertyEnumType_Locals_QueryInterface(
    IDebugPropertyEnumType_Locals *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IDebugPropertyEnumType_Locals_AddRef(IDebugPropertyEnumType_Locals *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IDebugPropertyEnumType_Locals_Release(IDebugPropertyEnumType_Locals *This) {
  return This->lpVtbl->Release(This);
}
/*** IDebugPropertyEnumType_All methods ***/
static inline HRESULT
IDebugPropertyEnumType_Locals_GetName(IDebugPropertyEnumType_Locals *This,
                                      BSTR *a) {
  return This->lpVtbl->GetName(This, a);
}
#endif
...
DEFINE_GUID(IID_IDebugPropertyEnumType_Arguments, 0x51973c57, 0xcb0c, 0x11d0,
            0xb5, 0xc9, 0x00, 0xa0, 0x24, 0x4a, 0x0e, 0x7a);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("51973c57-cb0c-11d0-b5c9-00a0244a0e7a")
IDebugPropertyEnumType_Arguments : public IDebugPropertyEnumType_All{};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDebugPropertyEnumType_Arguments, 0x51973c57, 0xcb0c, 0x11d0,
                0xb5, 0xc9, 0x00, 0xa0, 0x24, 0x4a, 0x0e, 0x7a)
#endif
#else
typedef struct IDebugPropertyEnumType_ArgumentsVtbl {
  ...
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(
      IDebugPropertyEnumType_Arguments *This, REFIID riid, void **ppvObject);
  ...
  /*** IDebugPropertyEnumType_All methods ***/
  HRESULT(STDMETHODCALLTYPE *GetName)(IDebugPropertyEnumType_Arguments *This,
                                      BSTR *a);
  END_INTERFACE
...
#define IDebugPropertyEnumType_Arguments_Release(This)                         \
  (This)->lpVtbl->Release(This)
/*** IDebugPropertyEnumType_All methods ***/
#define IDebugPropertyEnumType_Arguments_GetName(This, a)                      \
  (This)->lpVtbl->GetName(This, a)
#else
/*** IUnknown methods ***/
static inline HRESULT IDebugPropertyEnumType_Arguments_QueryInterface(
    IDebugPropertyEnumType_Arguments *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG IDebugPropertyEnumType_Arguments_AddRef(
    IDebugPropertyEnumType_Arguments *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG IDebugPropertyEnumType_Arguments_Release(
    IDebugPropertyEnumType_Arguments *This) {
  return This->lpVtbl->Release(This);
}
/*** IDebugPropertyEnumType_All methods ***/
static inline HRESULT
IDebugPropertyEnumType_Arguments_GetName(IDebugPropertyEnumType_Arguments *This,
                                         BSTR *a) {
  return This->lpVtbl->GetName(This, a);
}
#endif
...
DEFINE_GUID(IID_IDebugPropertyEnumType_LocalsPlusArgs, 0x51973c58, 0xcb0c,
            0x11d0, 0xb5, 0xc9, 0x00, 0xa0, 0x24, 0x4a, 0x0e, 0x7a);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDebugPropertyEnumType_LocalsPlusArgs, 0x51973c58, 0xcb0c,
                0x11d0, 0xb5, 0xc9, 0x00, 0xa0, 0x24, 0x4a, 0x0e, 0x7a)
#endif
#else
typedef struct IDebugPropertyEnumType_LocalsPlusArgsVtbl {
  ...
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(
      IDebugPropertyEnumType_LocalsPlusArgs *This, REFIID riid,
      void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetName)(
      IDebugPropertyEnumType_LocalsPlusArgs *This, BSTR *a);
  END_INTERFACE
...
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
#define IDebugPropertyEnumType_LocalsPlusArgs_QueryInterface(This, riid,       \
                                                             ppvObject)        \
  (This)->lpVtbl->QueryInterface(This, riid, ppvObject)
...
#define IDebugPropertyEnumType_LocalsPlusArgs_Release(This)                    \
  (This)->lpVtbl->Release(This)
/*** IDebugPropertyEnumType_All methods ***/
#define IDebugPropertyEnumType_LocalsPlusArgs_GetName(This, a)                 \
  (This)->lpVtbl->GetName(This, a)
#else
/*** IUnknown methods ***/
static inline HRESULT IDebugPropertyEnumType_LocalsPlusArgs_QueryInterface(
    IDebugPropertyEnumType_LocalsPlusArgs *This, REFIID riid,
    void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG IDebugPropertyEnumType_LocalsPlusArgs_AddRef(
    IDebugPropertyEnumType_LocalsPlusArgs *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG IDebugPropertyEnumType_LocalsPlusArgs_Release(
    IDebugPropertyEnumType_LocalsPlusArgs *This) {
  return This->lpVtbl->Release(This);
}
/*** IDebugPropertyEnumType_All methods ***/
static inline HRESULT IDebugPropertyEnumType_LocalsPlusArgs_GetName(
    IDebugPropertyEnumType_LocalsPlusArgs *This, BSTR *a) {
  return This->lpVtbl->GetName(This, a);
}
#endif
...
DEFINE_GUID(IID_IDebugPropertyEnumType_Registers, 0x51973c59, 0xcb0c, 0x11d0,
            0xb5, 0xc9, 0x00, 0xa0, 0x24, 0x4a, 0x0e, 0x7a);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("51973c59-cb0c-11d0-b5c9-00a0244a0e7a")
IDebugPropertyEnumType_Registers : public IDebugPropertyEnumType_All{};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDebugPropertyEnumType_Registers, 0x51973c59, 0xcb0c, 0x11d0,
                0xb5, 0xc9, 0x00, 0xa0, 0x24, 0x4a, 0x0e, 0x7a)
#endif
#else
typedef struct IDebugPropertyEnumType_RegistersVtbl {
  ...
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(
      IDebugPropertyEnumType_Registers *This, REFIID riid, void **ppvObject);
  ...
  /*** IDebugPropertyEnumType_All methods ***/
  HRESULT(STDMETHODCALLTYPE *GetName)(IDebugPropertyEnumType_Registers *This,
                                      BSTR *a);
  END_INTERFACE
...
#define IDebugPropertyEnumType_Registers_Release(This)                         \
  (This)->lpVtbl->Release(This)
/*** IDebugPropertyEnumType_All methods ***/
#define IDebugPropertyEnumType_Registers_GetName(This, a)                      \
  (This)->lpVtbl->GetName(This, a)
#else
/*** IUnknown methods ***/
static inline HRESULT IDebugPropertyEnumType_Registers_QueryInterface(
    IDebugPropertyEnumType_Registers *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG IDebugPropertyEnumType_Registers_AddRef(
    IDebugPropertyEnumType_Registers *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG IDebugPropertyEnumType_Registers_Release(
    IDebugPropertyEnumType_Registers *This) {
  return This->lpVtbl->Release(This);
}
/*** IDebugPropertyEnumType_All methods ***/
static inline HRESULT
IDebugPropertyEnumType_Registers_GetName(IDebugPropertyEnumType_Registers *This,
                                         BSTR *a) {
  return This->lpVtbl->GetName(This, a);
}
#endif
