...
DEFINE_GUID(Audit_ObjectAccess_CbacStaging, 0x0cce9246, 0x69ae, 0x11d9, 0xbe,
            0xd3, 0x50, 0x50, 0x54, 0x50, 0x30, 0x30);
#ifdef INITGUID
...
DEFINE_GUID(Audit_Logon_Claims, 0x0cce9247, 0x69ae, 0x11d9, 0xbe, 0xd3, 0x50,
            0x50, 0x54, 0x50, 0x30, 0x30);
#ifdef INITGUID
...
DEFINE_GUID(Audit_DetailedTracking_PnpActivity, 0x0cce9248, 0x69ae, 0x11d9,
            0xbe, 0xd3, 0x50, 0x50, 0x54, 0x50, 0x30, 0x30);
#ifdef INITGUID
...
DEFINE_GUID(Audit_Logon_Groups, 0x0cce9249, 0x69ae, 0x11d9, 0xbe, 0xd3, 0x50,
            0x50, 0x54, 0x50, 0x30, 0x30);
#ifdef INITGUID
...
#endif
#if !defined(INITGUID) ||                                                      \
    !defined(Audit_DetailedTracking_TokenRightAdjusted_defined)
DEFINE_GUID(Audit_DetailedTracking_TokenRightAdjusted, 0x0cce924a, 0x69ae,
            0x11d9, 0xbe, 0xd3, 0x50, 0x50, 0x54, 0x50, 0x30, 0x30);
#ifdef INITGUID
...
#ifndef _NTLSA_IFS_
NTSTATUS NTAPI LsaRegisterLogonProcess(PLSA_STRING LogonProcessName,
                                       PHANDLE LsaHandle,
                                       PLSA_OPERATIONAL_MODE SecurityMode);
NTSTATUS NTAPI LsaLogonUser(
    HANDLE LsaHandle, PLSA_STRING OriginName, SECURITY_LOGON_TYPE LogonType,
    ULONG AuthenticationPackage, PVOID AuthenticationInformation,
    ULONG AuthenticationInformationLength, PTOKEN_GROUPS LocalGroups,
    PTOKEN_SOURCE SourceContext, PVOID *ProfileBuffer,
    PULONG ProfileBufferLength, PLUID LogonId, PHANDLE Token,
    PQUOTA_LIMITS Quotas, PNTSTATUS SubStatus);
NTSTATUS NTAPI LsaLookupAuthenticationPackage(HANDLE LsaHandle,
...
NTSTATUS NTAPI LsaInsertProtectedProcessAddress(PVOID BufferAddress,
                                                ULONG BufferSize);
NTSTATUS NTAPI LsaRemoveProtectedProcessAddress(PVOID BufferAddress,
                                                ULONG BufferSize);
#endif
...
#define LSA_SCANNER_INFO_DISABLE_AUTH_TARGET_VALIDATION                        \
  (__MSABI_LONG(0x00000001))
#define LSA_SCANNER_INFO_ADMIN_ALL_FLAGS                                       \
...
typedef struct _LSA_FOREST_TRUST_RECORD2 {
  ...
  [switch_type(LSA_FOREST_TRUST_RECORD_TYPE), switch_is(ForestTrustType)]
      ...
      union {
        ...
        [case (
            ForestTrustScannerInfo)] LSA_FOREST_TRUST_SCANNER_INFO ScannerInfo;
#else
    LSA_UNICODE_STRING TopLevelName;
    LSA_FOREST_TRUST_DOMAIN_INFO DomainInfo;
...
NTSTATUS NTAPI LsaOpenPolicy(PLSA_UNICODE_STRING SystemName,
                             PLSA_OBJECT_ATTRIBUTES ObjectAttributes,
                             ACCESS_MASK DesiredAccess,
                             PLSA_HANDLE PolicyHandle);
NTSTATUS NTAPI LsaQueryInformationPolicy(
    LSA_HANDLE PolicyHandle, POLICY_INFORMATION_CLASS InformationClass,
    PVOID *Buffer);
NTSTATUS NTAPI LsaSetInformationPolicy(
    LSA_HANDLE PolicyHandle, POLICY_INFORMATION_CLASS InformationClass,
    PVOID Buffer);
NTSTATUS NTAPI LsaQueryDomainInformationPolicy(
    LSA_HANDLE PolicyHandle, POLICY_DOMAIN_INFORMATION_CLASS InformationClass,
    PVOID *Buffer);
...
NTSTATUS NTAPI LsaLookupNames(LSA_HANDLE PolicyHandle, ULONG Count,
                              PLSA_UNICODE_STRING Names,
                              PLSA_REFERENCED_DOMAIN_LIST *ReferencedDomains,
                              PLSA_TRANSLATED_SID *Sids);
NTSTATUS NTAPI LsaLookupNames2(LSA_HANDLE PolicyHandle, ULONG Flags,
                               ULONG Count, PLSA_UNICODE_STRING Names,
                               PLSA_REFERENCED_DOMAIN_LIST *ReferencedDomains,
                               PLSA_TRANSLATED_SID2 *Sids);
NTSTATUS NTAPI LsaLookupSids(LSA_HANDLE PolicyHandle, ULONG Count, PSID *Sids,
                             PLSA_REFERENCED_DOMAIN_LIST *ReferencedDomains,
                             PLSA_TRANSLATED_NAME *Names);
NTSTATUS NTAPI LsaLookupSids2(LSA_HANDLE PolicyHandle, ULONG LookupOptions,
                              ULONG Count, PSID *Sids,
                              PLSA_REFERENCED_DOMAIN_LIST *ReferencedDomains,
                              PLSA_TRANSLATED_NAME *Names);
NTSTATUS NTAPI LsaSetCAPs(PLSA_UNICODE_STRING CAPDNs, ULONG CAPDNCount,
                          ULONG Flags);
NTSTATUS NTAPI LsaGetAppliedCAPIDs(PLSA_UNICODE_STRING SystemName,
                                   PSID **CAPIDs, PULONG CAPIDCount);
...
NTSTATUS NTAPI LsaQueryCAPs(PSID *CAPIDs, ULONG CAPIDCount,
                            PCENTRAL_ACCESS_POLICY *CAPs, PULONG CAPCount);
...
NTSTATUS NTAPI LsaEnumerateAccountsWithUserRight(LSA_HANDLE PolicyHandle,
                                                 PLSA_UNICODE_STRING UserRight,
                                                 PVOID *Buffer,
                                                 PULONG CountReturned);
NTSTATUS NTAPI LsaEnumerateAccountRights(LSA_HANDLE PolicyHandle,
                                         PSID AccountSid,
                                         PLSA_UNICODE_STRING *UserRights,
                                         PULONG CountOfRights);
NTSTATUS NTAPI LsaAddAccountRights(LSA_HANDLE PolicyHandle, PSID AccountSid,
                                   PLSA_UNICODE_STRING UserRights,
                                   ULONG CountOfRights);
NTSTATUS NTAPI LsaRemoveAccountRights(LSA_HANDLE PolicyHandle, PSID AccountSid,
                                      BOOLEAN AllRights,
                                      PLSA_UNICODE_STRING UserRights,
                                      ULONG CountOfRights);
NTSTATUS NTAPI LsaOpenTrustedDomainByName(LSA_HANDLE PolicyHandle,
...
NTSTATUS NTAPI LsaSetTrustedDomainInformation(
    LSA_HANDLE PolicyHandle, PSID TrustedDomainSid,
    TRUSTED_INFORMATION_CLASS InformationClass, PVOID Buffer);
NTSTATUS NTAPI LsaDeleteTrustedDomain(LSA_HANDLE PolicyHandle,
                                      PSID TrustedDomainSid);
NTSTATUS NTAPI LsaQueryTrustedDomainInfoByName(
    LSA_HANDLE PolicyHandle, PLSA_UNICODE_STRING TrustedDomainName,
    TRUSTED_INFORMATION_CLASS InformationClass, PVOID *Buffer);
...
NTSTATUS NTAPI LsaSetForestTrustInformation(
    LSA_HANDLE PolicyHandle, PLSA_UNICODE_STRING TrustedDomainName,
    PLSA_FOREST_TRUST_INFORMATION ForestTrustInfo, BOOLEAN CheckOnly,
    PLSA_FOREST_TRUST_COLLISION_INFORMATION *CollisionInfo);
#ifdef TESTING_MATCHING_ROUTINE
NTSTATUS NTAPI LsaForestTrustFindMatch(LSA_HANDLE PolicyHandle, ULONG Type,
                                       PLSA_UNICODE_STRING Name,
                                       PLSA_UNICODE_STRING *Match);
#endif
NTSTATUS NTAPI LsaStorePrivateData(LSA_HANDLE PolicyHandle,
                                   PLSA_UNICODE_STRING KeyName,
                                   PLSA_UNICODE_STRING PrivateData);
NTSTATUS NTAPI LsaRetrievePrivateData(LSA_HANDLE PolicyHandle,
                                      PLSA_UNICODE_STRING KeyName,
                                      PLSA_UNICODE_STRING *PrivateData);
...
NTSTATUS NTAPI LsaSetForestTrustInformation2(
    LSA_HANDLE PolicyHandle, PLSA_UNICODE_STRING TrustedDomainName,
    LSA_FOREST_TRUST_RECORD_TYPE HighestRecordType,
    PLSA_FOREST_TRUST_INFORMATION2 ForestTrustInfo, BOOLEAN CheckOnly,
    PLSA_FOREST_TRUST_COLLISION_INFORMATION *CollisionInfo);
#ifndef _NTLSA_IFS_
#define _NTLSA_IFS_
#endif
...
typedef BOOLEAN (*PSAM_PASSWORD_FILTER_ROUTINE)(PUNICODE_STRING AccountName,
...
#define MSV1_0_IUM_SUPPLEMENTAL_CREDENTIAL_SIZE(Creds)                         \
  (FIELD_OFFSET(MSV1_0_IUM_SUPPLEMENTAL_CREDENTIAL, EncryptedCreds) +          \
   (Creds)->EncryptedCredsSize)
...
NTSTATUS WINAPI RtlEncryptMemory(PVOID Memory, ULONG MemorySize,
                                 ULONG OptionFlags);
NTSTATUS WINAPI RtlDecryptMemory(PVOID Memory, ULONG MemorySize,
                                 ULONG OptionFlags);
...
#define AUTH_REQ_PER_USER_FLAGS                                                \
  (AUTH_REQ_ALLOW_FORWARDABLE | AUTH_REQ_ALLOW_PROXIABLE |                     \
   AUTH_REQ_ALLOW_POSTDATE | AUTH_REQ_ALLOW_RENEWABLE |                        \
...
#define KERB_IS_MS_PRINCIPAL(_x_)                                              \
...
typedef const PAUDIT_POLICY_INFORMATION PCAUDIT_POLICY_INFORMATION,
    LPCAUDIT_POLICY_INFORMATION;
...
#define AUDIT_GENERIC_ALL                                                      \
  (STANDARD_RIGHTS_REQUIRED | AUDIT_SET_SYSTEM_POLICY |                        \
   AUDIT_QUERY_SYSTEM_POLICY | AUDIT_SET_USER_POLICY |                         \
   AUDIT_QUERY_USER_POLICY | AUDIT_ENUMERATE_USERS | AUDIT_SET_MISC_POLICY |   \
   AUDIT_QUERY_MISC_POLICY)
#define AUDIT_GENERIC_READ                                                     \
  (STANDARD_RIGHTS_READ | AUDIT_QUERY_SYSTEM_POLICY |                          \
...
VOID WINAPI AuditFree(PVOID Buffer);
BOOLEAN WINAPI AuditSetSystemPolicy(PCAUDIT_POLICY_INFORMATION pAuditPolicy,
                                    ULONG PolicyCount);
BOOLEAN WINAPI AuditQuerySystemPolicy(const GUID *pSubCategoryGuids,
                                      ULONG PolicyCount,
                                      PAUDIT_POLICY_INFORMATION *ppAuditPolicy);
BOOLEAN WINAPI AuditSetPerUserPolicy(const PSID pSid,
...
BOOLEAN WINAPI AuditComputeEffectivePolicyByToken(
    ...
    PAUDIT_POLICY_INFORMATION *ppAuditPolicy);
BOOLEAN WINAPI AuditEnumerateCategories(GUID **ppAuditCategoriesArray,
                                        PULONG pCountReturned);
BOOLEAN WINAPI
AuditEnumeratePerUserPolicy(PPOLICY_AUDIT_SID_ARRAY *ppAuditSidArray);
BOOLEAN WINAPI AuditEnumerateSubCategories(const GUID *pAuditCategoryGuid,
                                           BOOLEAN bRetrieveAllSubCategories,
                                           GUID **ppAuditSubCategoriesArray,
                                           PULONG pCountReturned);
BOOLEAN WINAPI AuditLookupCategoryGuidFromCategoryId(
    POLICY_AUDIT_EVENT_TYPE AuditCategoryId, GUID *pAuditCategoryGuid);
BOOLEAN WINAPI AuditQuerySecurity(SECURITY_INFORMATION SecurityInformation,
...
BOOLEAN WINAPI AuditLookupSubCategoryNameA(const GUID *pAuditSubCategoryGuid,
                                           LPSTR *ppszSubCategoryName);
BOOLEAN WINAPI AuditLookupSubCategoryNameW(const GUID *pAuditSubCategoryGuid,
                                           LPWSTR *ppszSubCategoryName);
BOOLEAN WINAPI AuditLookupCategoryNameA(const GUID *pAuditCategoryGuid,
                                        LPSTR *ppszCategoryName);
BOOLEAN WINAPI AuditLookupCategoryNameW(const GUID *pAuditCategoryGuid,
                                        LPWSTR *ppszCategoryName);
BOOLEAN WINAPI AuditLookupCategoryIdFromCategoryGuid(
    const GUID *pAuditCategoryGuid, PPOLICY_AUDIT_EVENT_TYPE pAuditCategoryId);
BOOLEAN WINAPI AuditSetSecurity(SECURITY_INFORMATION SecurityInformation,
                                PSECURITY_DESCRIPTOR pSecurityDescriptor);
BOOLEAN NTAPI AuditSetGlobalSaclW(PCWSTR ObjectTypeName, PACL Acl);
BOOLEAN NTAPI AuditSetGlobalSaclA(PCSTR ObjectTypeName, PACL Acl);
#define AuditSetGlobalSacl __MINGW_NAME_AW(AuditSetGlobalSacl)
BOOLEAN NTAPI AuditQueryGlobalSaclW(PCWSTR ObjectTypeName, PACL *Acl);
BOOLEAN NTAPI AuditQueryGlobalSaclA(PCSTR ObjectTypeName, PACL *Acl);
