...
public:
  ...
  get_SubjectLoggingEnabled(VARIANT_BOOL *pSubjectLoggingEnabled) = 0;
  virtual HRESULT WINAPI
  put_SubjectLoggingEnabled(VARIANT_BOOL varSubjectLoggingEnabled) = 0;
  virtual HRESULT WINAPI
  get_MessageTrackingEnabled(VARIANT_BOOL *pMessageTrackingEnabled) = 0;
  virtual HRESULT WINAPI
  put_MessageTrackingEnabled(VARIANT_BOOL varMessageTrackingEnabled) = 0;
  virtual HRESULT WINAPI
  get_DaysBeforeLogFileRemoval(__LONG32 *pDaysBeforeLogFileRemoval) = 0;
  virtual HRESULT WINAPI
  put_DaysBeforeLogFileRemoval(__LONG32 varDaysBeforeLogFileRemoval) = 0;
...
typedef struct IExchangeServerVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IExchangeServer *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IExchangeServer *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IExchangeServer *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IExchangeServer *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *get_DataSource)(IExchangeServer *This,
                                  IDataSource2 **varDataSource);
  HRESULT(WINAPI *get_Fields)(IExchangeServer *This, Fields **varFields);
  HRESULT(WINAPI *get_Name)(IExchangeServer *This, BSTR *varName);
  HRESULT(WINAPI *get_ExchangeVersion)(IExchangeServer *This,
                                       BSTR *varExchangeVersion);
  HRESULT(WINAPI *get_StorageGroups)(IExchangeServer *This,
                                     VARIANT *varStorageGroups);
  HRESULT(WINAPI *get_SubjectLoggingEnabled)(
      IExchangeServer *This, VARIANT_BOOL *pSubjectLoggingEnabled);
  HRESULT(WINAPI *put_SubjectLoggingEnabled)(
      IExchangeServer *This, VARIANT_BOOL varSubjectLoggingEnabled);
  HRESULT(WINAPI *get_MessageTrackingEnabled)(
      IExchangeServer *This, VARIANT_BOOL *pMessageTrackingEnabled);
  HRESULT(WINAPI *put_MessageTrackingEnabled)(
      IExchangeServer *This, VARIANT_BOOL varMessageTrackingEnabled);
  HRESULT(WINAPI *get_DaysBeforeLogFileRemoval)(
      IExchangeServer *This, __LONG32 *pDaysBeforeLogFileRemoval);
  HRESULT(WINAPI *put_DaysBeforeLogFileRemoval)(
      IExchangeServer *This, __LONG32 varDaysBeforeLogFileRemoval);
  HRESULT(WINAPI *get_ServerType)(IExchangeServer *This,
                                  CDOEXMServerType *pServerType);
  HRESULT(WINAPI *put_ServerType)(IExchangeServer *This,
                                  CDOEXMServerType varServerType);
  HRESULT(WINAPI *get_DirectoryServer)(IExchangeServer *This,
                                       BSTR *varDirectoryServer);
  HRESULT(WINAPI *GetInterface)(IExchangeServer *This, BSTR Interface,
                                IDispatch **ppUnknown);
  END_INTERFACE
} IExchangeServerVtbl;
...
#define IExchangeServer_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,     \
                                      rgDispId)                                \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IExchangeServer_Invoke(This, dispIdMember, riid, lcid, wFlags,         \
...
#define IExchangeServer_get_SubjectLoggingEnabled(This,                        \
                                                  pSubjectLoggingEnabled)      \
  (This)->lpVtbl->get_SubjectLoggingEnabled(This, pSubjectLoggingEnabled)
#define IExchangeServer_put_SubjectLoggingEnabled(This,                        \
                                                  varSubjectLoggingEnabled)    \
  (This)->lpVtbl->put_SubjectLoggingEnabled(This, varSubjectLoggingEnabled)
#define IExchangeServer_get_MessageTrackingEnabled(This,                       \
                                                   pMessageTrackingEnabled)    \
  (This)->lpVtbl->get_MessageTrackingEnabled(This, pMessageTrackingEnabled)
#define IExchangeServer_put_MessageTrackingEnabled(This,                       \
                                                   varMessageTrackingEnabled)  \
  (This)->lpVtbl->put_MessageTrackingEnabled(This, varMessageTrackingEnabled)
#define IExchangeServer_get_DaysBeforeLogFileRemoval(                          \
    This, pDaysBeforeLogFileRemoval)                                           \
  (This)->lpVtbl->get_DaysBeforeLogFileRemoval(This, pDaysBeforeLogFileRemoval)
#define IExchangeServer_put_DaysBeforeLogFileRemoval(                          \
    This, varDaysBeforeLogFileRemoval)                                         \
  (This)->lpVtbl->put_DaysBeforeLogFileRemoval(This,                           \
                                               varDaysBeforeLogFileRemoval)
...
#endif
HRESULT
    WINAPI IExchangeServer_get_DataSource_Proxy(IExchangeServer *This,
                                                IDataSource2 **varDataSource);
...
HRESULT WINAPI IExchangeServer_get_Fields_Proxy(IExchangeServer *This,
                                                Fields **varFields);
void __RPC_STUB IExchangeServer_get_Fields_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IExchangeServer_get_Name_Proxy(IExchangeServer *This,
                                              BSTR *varName);
void __RPC_STUB IExchangeServer_get_Name_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IExchangeServer_get_ExchangeVersion_Proxy(
    IExchangeServer *This, BSTR *varExchangeVersion);
void __RPC_STUB IExchangeServer_get_ExchangeVersion_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IExchangeServer_get_StorageGroups_Proxy(
    IExchangeServer *This, VARIANT *varStorageGroups);
...
void __RPC_STUB IExchangeServer_put_SubjectLoggingEnabled_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IExchangeServer_get_MessageTrackingEnabled_Proxy(
    IExchangeServer *This, VARIANT_BOOL *pMessageTrackingEnabled);
...
void __RPC_STUB IExchangeServer_get_DaysBeforeLogFileRemoval_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IExchangeServer_put_DaysBeforeLogFileRemoval_Proxy(
    IExchangeServer *This, __LONG32 varDaysBeforeLogFileRemoval);
void __RPC_STUB IExchangeServer_put_DaysBeforeLogFileRemoval_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IExchangeServer_get_ServerType_Proxy(
    IExchangeServer *This, CDOEXMServerType *pServerType);
void __RPC_STUB IExchangeServer_get_ServerType_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IExchangeServer_put_ServerType_Proxy(
    IExchangeServer *This, CDOEXMServerType varServerType);
void __RPC_STUB IExchangeServer_put_ServerType_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IExchangeServer_get_DirectoryServer_Proxy(
    IExchangeServer *This, BSTR *varDirectoryServer);
void __RPC_STUB IExchangeServer_get_DirectoryServer_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IExchangeServer_GetInterface_Proxy(IExchangeServer *This,
                                                  BSTR Interface,
                                                  IDispatch **ppUnknown);
...
public:
  ...
  virtual HRESULT WINAPI
  get_CircularLogging(VARIANT_BOOL *pCircularLogging) = 0;
  virtual HRESULT WINAPI
  put_CircularLogging(VARIANT_BOOL varCircularLogging) = 0;
  ...
  virtual HRESULT WINAPI MoveSystemFiles(BSTR SystemFilePath,
                                         __LONG32 Flags) = 0;
};
#else
typedef struct IStorageGroupVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IStorageGroup *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IStorageGroup *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IStorageGroup *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IStorageGroup *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *get_DataSource)(IStorageGroup *This,
                                  IDataSource2 **varDataSource);
  ...
  HRESULT(WINAPI *get_PublicStoreDBs)(IStorageGroup *This,
                                      VARIANT *varPublicStoreDBs);
  HRESULT(WINAPI *get_MailboxStoreDBs)(IStorageGroup *This,
                                       VARIANT *varMailboxStoreDBs);
  HRESULT(WINAPI *get_LogFilePath)(IStorageGroup *This, BSTR *varLogFilePath);
  HRESULT(WINAPI *get_SystemFilePath)(IStorageGroup *This,
                                      BSTR *varSystemFilePath);
  HRESULT(WINAPI *get_CircularLogging)(IStorageGroup *This,
                                       VARIANT_BOOL *pCircularLogging);
  HRESULT(WINAPI *put_CircularLogging)(IStorageGroup *This,
                                       VARIANT_BOOL varCircularLogging);
  HRESULT(WINAPI *get_ZeroDatabase)(IStorageGroup *This,
                                    VARIANT_BOOL *pZeroDatabase);
  HRESULT(WINAPI *put_ZeroDatabase)(IStorageGroup *This,
                                    VARIANT_BOOL varZeroDatabase);
  HRESULT(WINAPI *GetInterface)(IStorageGroup *This, BSTR Interface,
                                IDispatch **ppUnknown);
  HRESULT(WINAPI *MoveLogFiles)(IStorageGroup *This, BSTR LogFilePath,
                                __LONG32 Flags);
  HRESULT(WINAPI *MoveSystemFiles)(IStorageGroup *This, BSTR SystemFilePath,
                                   __LONG32 Flags);
  END_INTERFACE
} IStorageGroupVtbl;
...
#define IStorageGroup_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                 \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IStorageGroup_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,       \
                                    rgDispId)                                  \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IStorageGroup_Invoke(This, dispIdMember, riid, lcid, wFlags,           \
                             pDispParams, pVarResult, pExcepInfo, puArgErr)    \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI IStorageGroup_get_DataSource_Proxy(IStorageGroup *This,
                                                  IDataSource2 **varDataSource);
void __RPC_STUB IStorageGroup_get_DataSource_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IStorageGroup_get_Fields_Proxy(IStorageGroup *This,
                                              Fields **varFields);
...
void __RPC_STUB IStorageGroup_put_Name_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IStorageGroup_get_PublicStoreDBs_Proxy(
    IStorageGroup *This, VARIANT *varPublicStoreDBs);
void __RPC_STUB IStorageGroup_get_PublicStoreDBs_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IStorageGroup_get_MailboxStoreDBs_Proxy(
    IStorageGroup *This, VARIANT *varMailboxStoreDBs);
void __RPC_STUB IStorageGroup_get_MailboxStoreDBs_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IStorageGroup_get_LogFilePath_Proxy(IStorageGroup *This,
                                                   BSTR *varLogFilePath);
void __RPC_STUB IStorageGroup_get_LogFilePath_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IStorageGroup_get_SystemFilePath_Proxy(IStorageGroup *This,
                                                      BSTR *varSystemFilePath);
void __RPC_STUB IStorageGroup_get_SystemFilePath_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IStorageGroup_get_CircularLogging_Proxy(
    IStorageGroup *This, VARIANT_BOOL *pCircularLogging);
void __RPC_STUB IStorageGroup_get_CircularLogging_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IStorageGroup_put_CircularLogging_Proxy(
    IStorageGroup *This, VARIANT_BOOL varCircularLogging);
void __RPC_STUB IStorageGroup_put_CircularLogging_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IStorageGroup_get_ZeroDatabase_Proxy(
    IStorageGroup *This, VARIANT_BOOL *pZeroDatabase);
void __RPC_STUB IStorageGroup_get_ZeroDatabase_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IStorageGroup_put_ZeroDatabase_Proxy(
    IStorageGroup *This, VARIANT_BOOL varZeroDatabase);
void __RPC_STUB IStorageGroup_put_ZeroDatabase_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IStorageGroup_GetInterface_Proxy(IStorageGroup *This,
                                                BSTR Interface,
                                                IDispatch **ppUnknown);
void __RPC_STUB IStorageGroup_GetInterface_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IStorageGroup_MoveLogFiles_Proxy(IStorageGroup *This,
                                                BSTR LogFilePath,
                                                __LONG32 Flags);
void __RPC_STUB IStorageGroup_MoveLogFiles_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IStorageGroup_MoveSystemFiles_Proxy(IStorageGroup *This,
                                                   BSTR SystemFilePath,
                                                   __LONG32 Flags);
...
public:
  ...
  virtual HRESULT WINAPI
  get_DaysBeforeItemExpiration(__LONG32 *pDaysBeforeItemExpiration) = 0;
  virtual HRESULT WINAPI
  put_DaysBeforeItemExpiration(__LONG32 varDaysBeforeItemExpiration) = 0;
  virtual HRESULT WINAPI
  get_DaysBeforeGarbageCollection(__LONG32 *pDaysBeforeGarbageCollection) = 0;
  virtual HRESULT WINAPI
  put_DaysBeforeGarbageCollection(__LONG32 varDaysBeforeGarbageCollection) = 0;
  virtual HRESULT WINAPI get_GarbageCollectOnlyAfterBackup(
      VARIANT_BOOL *pGarbageCollectOnlyAfterBackup) = 0;
  virtual HRESULT WINAPI put_GarbageCollectOnlyAfterBackup(
      VARIANT_BOOL varGarbageCollectOnlyAfterBackup) = 0;
  virtual HRESULT WINAPI GetInterface(BSTR Interface,
                                      IDispatch **ppUnknown) = 0;
  virtual HRESULT WINAPI MoveDataFiles(BSTR DBPath, BSTR SLVPath,
                                       __LONG32 Flags) = 0;
...
typedef struct IPublicStoreDBVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IPublicStoreDB *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IPublicStoreDB *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IPublicStoreDB *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IPublicStoreDB *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *get_DataSource)(IPublicStoreDB *This,
                                  IDataSource2 **varDataSource);
  ...
  HRESULT(WINAPI *get_Status)(IPublicStoreDB *This,
                              CDOEXMStoreDBStatus *varStatus);
  ...
  HRESULT(WINAPI *get_ItemSizeLimit)(IPublicStoreDB *This,
                                     __LONG32 *pItemSizeLimit);
  HRESULT(WINAPI *put_ItemSizeLimit)(IPublicStoreDB *This,
                                     __LONG32 varItemSizeLimit);
  HRESULT(WINAPI *get_DaysBeforeItemExpiration)(
      IPublicStoreDB *This, __LONG32 *pDaysBeforeItemExpiration);
  HRESULT(WINAPI *put_DaysBeforeItemExpiration)(
      IPublicStoreDB *This, __LONG32 varDaysBeforeItemExpiration);
  HRESULT(WINAPI *get_DaysBeforeGarbageCollection)(
      IPublicStoreDB *This, __LONG32 *pDaysBeforeGarbageCollection);
  HRESULT(WINAPI *put_DaysBeforeGarbageCollection)(
      IPublicStoreDB *This, __LONG32 varDaysBeforeGarbageCollection);
  HRESULT(WINAPI *get_GarbageCollectOnlyAfterBackup)(
      IPublicStoreDB *This, VARIANT_BOOL *pGarbageCollectOnlyAfterBackup);
  HRESULT(WINAPI *put_GarbageCollectOnlyAfterBackup)(
      IPublicStoreDB *This, VARIANT_BOOL varGarbageCollectOnlyAfterBackup);
  HRESULT(WINAPI *GetInterface)(IPublicStoreDB *This, BSTR Interface,
                                IDispatch **ppUnknown);
  HRESULT(WINAPI *MoveDataFiles)(IPublicStoreDB *This, BSTR DBPath,
                                 BSTR SLVPath, __LONG32 Flags);
...
#define IPublicStoreDB_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IPublicStoreDB_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,      \
                                     rgDispId)                                 \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IPublicStoreDB_Invoke(This, dispIdMember, riid, lcid, wFlags,          \
                              pDispParams, pVarResult, pExcepInfo, puArgErr)   \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#define IPublicStoreDB_get_DaysBeforeItemExpiration(This,                      \
                                                    pDaysBeforeItemExpiration) \
  (This)->lpVtbl->get_DaysBeforeItemExpiration(This, pDaysBeforeItemExpiration)
#define IPublicStoreDB_put_DaysBeforeItemExpiration(                           \
    This, varDaysBeforeItemExpiration)                                         \
  (This)->lpVtbl->put_DaysBeforeItemExpiration(This,                           \
                                               varDaysBeforeItemExpiration)
#define IPublicStoreDB_get_DaysBeforeGarbageCollection(                        \
    This, pDaysBeforeGarbageCollection)                                        \
  (This)->lpVtbl->get_DaysBeforeGarbageCollection(                             \
      This, pDaysBeforeGarbageCollection)
#define IPublicStoreDB_put_DaysBeforeGarbageCollection(                        \
    This, varDaysBeforeGarbageCollection)                                      \
  (This)->lpVtbl->put_DaysBeforeGarbageCollection(                             \
      This, varDaysBeforeGarbageCollection)
#define IPublicStoreDB_get_GarbageCollectOnlyAfterBackup(                      \
    This, pGarbageCollectOnlyAfterBackup)                                      \
  (This)->lpVtbl->get_GarbageCollectOnlyAfterBackup(                           \
      This, pGarbageCollectOnlyAfterBackup)
#define IPublicStoreDB_put_GarbageCollectOnlyAfterBackup(                      \
    This, varGarbageCollectOnlyAfterBackup)                                    \
  (This)->lpVtbl->put_GarbageCollectOnlyAfterBackup(                           \
      This, varGarbageCollectOnlyAfterBackup)
...
#endif
HRESULT
    WINAPI IPublicStoreDB_get_DataSource_Proxy(IPublicStoreDB *This,
                                               IDataSource2 **varDataSource);
void __RPC_STUB IPublicStoreDB_get_DataSource_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IPublicStoreDB_get_Fields_Proxy(IPublicStoreDB *This,
                                               Fields **varFields);
...
void __RPC_STUB IPublicStoreDB_get_Name_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IPublicStoreDB_put_Name_Proxy(IPublicStoreDB *This,
                                             BSTR varName);
void __RPC_STUB IPublicStoreDB_put_Name_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IPublicStoreDB_get_FolderTree_Proxy(IPublicStoreDB *This,
                                                   BSTR *pFolderTree);
void __RPC_STUB IPublicStoreDB_get_FolderTree_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IPublicStoreDB_put_FolderTree_Proxy(IPublicStoreDB *This,
                                                   BSTR varFolderTree);
void __RPC_STUB IPublicStoreDB_put_FolderTree_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IPublicStoreDB_get_DBPath_Proxy(IPublicStoreDB *This,
                                               BSTR *varDBPath);
void __RPC_STUB IPublicStoreDB_get_DBPath_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IPublicStoreDB_get_SLVPath_Proxy(IPublicStoreDB *This,
                                                BSTR *varSLVPath);
void __RPC_STUB IPublicStoreDB_get_SLVPath_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IPublicStoreDB_get_Status_Proxy(IPublicStoreDB *This,
                                               CDOEXMStoreDBStatus *varStatus);
void __RPC_STUB IPublicStoreDB_get_Status_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IPublicStoreDB_get_Enabled_Proxy(IPublicStoreDB *This,
                                                VARIANT_BOOL *pEnabled);
void __RPC_STUB IPublicStoreDB_get_Enabled_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IPublicStoreDB_put_Enabled_Proxy(IPublicStoreDB *This,
                                                VARIANT_BOOL varEnabled);
void __RPC_STUB IPublicStoreDB_put_Enabled_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IPublicStoreDB_get_StoreQuota_Proxy(IPublicStoreDB *This,
                                                   __LONG32 *pStoreQuota);
void __RPC_STUB IPublicStoreDB_get_StoreQuota_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IPublicStoreDB_put_StoreQuota_Proxy(IPublicStoreDB *This,
                                                   __LONG32 varStoreQuota);
void __RPC_STUB IPublicStoreDB_put_StoreQuota_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IPublicStoreDB_get_HardLimit_Proxy(IPublicStoreDB *This,
                                                  __LONG32 *pHardLimit);
void __RPC_STUB IPublicStoreDB_get_HardLimit_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IPublicStoreDB_put_HardLimit_Proxy(IPublicStoreDB *This,
                                                  __LONG32 varHardLimit);
void __RPC_STUB IPublicStoreDB_put_HardLimit_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IPublicStoreDB_get_ItemSizeLimit_Proxy(IPublicStoreDB *This,
                                                      __LONG32 *pItemSizeLimit);
void __RPC_STUB IPublicStoreDB_get_ItemSizeLimit_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IPublicStoreDB_put_ItemSizeLimit_Proxy(
    IPublicStoreDB *This, __LONG32 varItemSizeLimit);
void __RPC_STUB IPublicStoreDB_put_ItemSizeLimit_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IPublicStoreDB_get_DaysBeforeItemExpiration_Proxy(
    IPublicStoreDB *This, __LONG32 *pDaysBeforeItemExpiration);
void __RPC_STUB IPublicStoreDB_get_DaysBeforeItemExpiration_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IPublicStoreDB_put_DaysBeforeItemExpiration_Proxy(
    IPublicStoreDB *This, __LONG32 varDaysBeforeItemExpiration);
void __RPC_STUB IPublicStoreDB_put_DaysBeforeItemExpiration_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IPublicStoreDB_get_DaysBeforeGarbageCollection_Proxy(
    IPublicStoreDB *This, __LONG32 *pDaysBeforeGarbageCollection);
...
void __RPC_STUB IPublicStoreDB_put_DaysBeforeGarbageCollection_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IPublicStoreDB_get_GarbageCollectOnlyAfterBackup_Proxy(
    IPublicStoreDB *This, VARIANT_BOOL *pGarbageCollectOnlyAfterBackup);
void __RPC_STUB IPublicStoreDB_get_GarbageCollectOnlyAfterBackup_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IPublicStoreDB_put_GarbageCollectOnlyAfterBackup_Proxy(
    IPublicStoreDB *This, VARIANT_BOOL varGarbageCollectOnlyAfterBackup);
void __RPC_STUB IPublicStoreDB_put_GarbageCollectOnlyAfterBackup_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IPublicStoreDB_GetInterface_Proxy(IPublicStoreDB *This,
                                                 BSTR Interface,
                                                 IDispatch **ppUnknown);
void __RPC_STUB IPublicStoreDB_GetInterface_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IPublicStoreDB_MoveDataFiles_Proxy(IPublicStoreDB *This,
                                                  BSTR DBPath, BSTR SLVPath,
                                                  __LONG32 Flags);
void __RPC_STUB IPublicStoreDB_MoveDataFiles_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IPublicStoreDB_Mount_Proxy(IPublicStoreDB *This,
                                          __LONG32 Timeout);
void __RPC_STUB IPublicStoreDB_Mount_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI IPublicStoreDB_Dismount_Proxy(IPublicStoreDB *This,
                                             __LONG32 Timeout);
...
public:
  ...
  virtual HRESULT WINAPI
  put_DaysBeforeGarbageCollection(__LONG32 varDaysBeforeGarbageCollection) = 0;
  virtual HRESULT WINAPI get_DaysBeforeDeletedMailboxCleanup(
      __LONG32 *pDaysBeforeDeletedMailboxCleanup) = 0;
  virtual HRESULT WINAPI put_DaysBeforeDeletedMailboxCleanup(
      __LONG32 varDaysBeforeDeletedMailboxCleanup) = 0;
  virtual HRESULT WINAPI get_GarbageCollectOnlyAfterBackup(
      VARIANT_BOOL *pGarbageCollectOnlyAfterBackup) = 0;
  virtual HRESULT WINAPI put_GarbageCollectOnlyAfterBackup(
      VARIANT_BOOL varGarbageCollectOnlyAfterBackup) = 0;
...
typedef struct IMailboxStoreDBVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMailboxStoreDB *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IMailboxStoreDB *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IMailboxStoreDB *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IMailboxStoreDB *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *get_DataSource)(IMailboxStoreDB *This,
                                  IDataSource2 **varDataSource);
  ...
  HRESULT(WINAPI *get_PublicStoreDB)(IMailboxStoreDB *This,
                                     BSTR *pPublicStoreDB);
  HRESULT(WINAPI *put_PublicStoreDB)(IMailboxStoreDB *This,
                                     BSTR varPublicStoreDB);
  HRESULT(WINAPI *get_OfflineAddressList)(IMailboxStoreDB *This,
                                          BSTR *pOfflineAddressList);
  HRESULT(WINAPI *put_OfflineAddressList)(IMailboxStoreDB *This,
                                          BSTR varOfflineAddressList);
  ...
  HRESULT(WINAPI *get_Status)(IMailboxStoreDB *This,
                              CDOEXMStoreDBStatus *varStatus);
  ...
  HRESULT(WINAPI *put_StoreQuota)(IMailboxStoreDB *This,
                                  __LONG32 varStoreQuota);
  HRESULT(WINAPI *get_OverQuotaLimit)(IMailboxStoreDB *This,
                                      __LONG32 *pOverQuotaLimit);
  HRESULT(WINAPI *put_OverQuotaLimit)(IMailboxStoreDB *This,
                                      __LONG32 varOverQuotaLimit);
  ...
  HRESULT(WINAPI *get_DaysBeforeGarbageCollection)(
      IMailboxStoreDB *This, __LONG32 *pDaysBeforeGarbageCollection);
  HRESULT(WINAPI *put_DaysBeforeGarbageCollection)(
      IMailboxStoreDB *This, __LONG32 varDaysBeforeGarbageCollection);
  HRESULT(WINAPI *get_DaysBeforeDeletedMailboxCleanup)(
      IMailboxStoreDB *This, __LONG32 *pDaysBeforeDeletedMailboxCleanup);
  HRESULT(WINAPI *put_DaysBeforeDeletedMailboxCleanup)(
      IMailboxStoreDB *This, __LONG32 varDaysBeforeDeletedMailboxCleanup);
  HRESULT(WINAPI *get_GarbageCollectOnlyAfterBackup)(
      IMailboxStoreDB *This, VARIANT_BOOL *pGarbageCollectOnlyAfterBackup);
  HRESULT(WINAPI *put_GarbageCollectOnlyAfterBackup)(
      IMailboxStoreDB *This, VARIANT_BOOL varGarbageCollectOnlyAfterBackup);
  HRESULT(WINAPI *GetInterface)(IMailboxStoreDB *This, BSTR Interface,
                                IDispatch **ppUnknown);
  HRESULT(WINAPI *MoveDataFiles)(IMailboxStoreDB *This, BSTR DBPath,
                                 BSTR SLVPath, __LONG32 Flags);
...
#define IMailboxStoreDB_GetTypeInfo(This, iTInfo, lcid, ppTInfo)               \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IMailboxStoreDB_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,     \
                                      rgDispId)                                \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IMailboxStoreDB_Invoke(This, dispIdMember, riid, lcid, wFlags,         \
                               pDispParams, pVarResult, pExcepInfo, puArgErr)  \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#define IMailboxStoreDB_put_HardLimit(This, varHardLimit)                      \
  (This)->lpVtbl->put_HardLimit(This, varHardLimit)
#define IMailboxStoreDB_get_DaysBeforeGarbageCollection(                       \
    This, pDaysBeforeGarbageCollection)                                        \
  (This)->lpVtbl->get_DaysBeforeGarbageCollection(                             \
      This, pDaysBeforeGarbageCollection)
#define IMailboxStoreDB_put_DaysBeforeGarbageCollection(                       \
    This, varDaysBeforeGarbageCollection)                                      \
  (This)->lpVtbl->put_DaysBeforeGarbageCollection(                             \
      This, varDaysBeforeGarbageCollection)
#define IMailboxStoreDB_get_DaysBeforeDeletedMailboxCleanup(                   \
    This, pDaysBeforeDeletedMailboxCleanup)                                    \
  (This)->lpVtbl->get_DaysBeforeDeletedMailboxCleanup(                         \
      This, pDaysBeforeDeletedMailboxCleanup)
#define IMailboxStoreDB_put_DaysBeforeDeletedMailboxCleanup(                   \
    This, varDaysBeforeDeletedMailboxCleanup)                                  \
  (This)->lpVtbl->put_DaysBeforeDeletedMailboxCleanup(                         \
      This, varDaysBeforeDeletedMailboxCleanup)
#define IMailboxStoreDB_get_GarbageCollectOnlyAfterBackup(                     \
    This, pGarbageCollectOnlyAfterBackup)                                      \
  (This)->lpVtbl->get_GarbageCollectOnlyAfterBackup(                           \
      This, pGarbageCollectOnlyAfterBackup)
#define IMailboxStoreDB_put_GarbageCollectOnlyAfterBackup(                     \
    This, varGarbageCollectOnlyAfterBackup)                                    \
  (This)->lpVtbl->put_GarbageCollectOnlyAfterBackup(                           \
      This, varGarbageCollectOnlyAfterBackup)
...
#endif
HRESULT
    WINAPI IMailboxStoreDB_get_DataSource_Proxy(IMailboxStoreDB *This,
                                                IDataSource2 **varDataSource);
void __RPC_STUB IMailboxStoreDB_get_DataSource_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailboxStoreDB_get_Fields_Proxy(IMailboxStoreDB *This,
                                                Fields **varFields);
void __RPC_STUB IMailboxStoreDB_get_Fields_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailboxStoreDB_get_Name_Proxy(IMailboxStoreDB *This,
                                              BSTR *pName);
void __RPC_STUB IMailboxStoreDB_get_Name_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailboxStoreDB_put_Name_Proxy(IMailboxStoreDB *This,
                                              BSTR varName);
void __RPC_STUB IMailboxStoreDB_put_Name_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailboxStoreDB_get_PublicStoreDB_Proxy(IMailboxStoreDB *This,
                                                       BSTR *pPublicStoreDB);
void __RPC_STUB IMailboxStoreDB_get_PublicStoreDB_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailboxStoreDB_put_PublicStoreDB_Proxy(IMailboxStoreDB *This,
                                                       BSTR varPublicStoreDB);
void __RPC_STUB IMailboxStoreDB_put_PublicStoreDB_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailboxStoreDB_get_OfflineAddressList_Proxy(
    IMailboxStoreDB *This, BSTR *pOfflineAddressList);
void __RPC_STUB IMailboxStoreDB_get_OfflineAddressList_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailboxStoreDB_put_OfflineAddressList_Proxy(
    IMailboxStoreDB *This, BSTR varOfflineAddressList);
void __RPC_STUB IMailboxStoreDB_put_OfflineAddressList_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailboxStoreDB_get_DBPath_Proxy(IMailboxStoreDB *This,
                                                BSTR *varDBPath);
void __RPC_STUB IMailboxStoreDB_get_DBPath_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailboxStoreDB_get_SLVPath_Proxy(IMailboxStoreDB *This,
                                                 BSTR *varSLVPath);
void __RPC_STUB IMailboxStoreDB_get_SLVPath_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailboxStoreDB_get_Status_Proxy(IMailboxStoreDB *This,
                                                CDOEXMStoreDBStatus *varStatus);
void __RPC_STUB IMailboxStoreDB_get_Status_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailboxStoreDB_get_Enabled_Proxy(IMailboxStoreDB *This,
                                                 VARIANT_BOOL *pEnabled);
void __RPC_STUB IMailboxStoreDB_get_Enabled_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailboxStoreDB_put_Enabled_Proxy(IMailboxStoreDB *This,
                                                 VARIANT_BOOL varEnabled);
void __RPC_STUB IMailboxStoreDB_put_Enabled_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailboxStoreDB_get_StoreQuota_Proxy(IMailboxStoreDB *This,
                                                    __LONG32 *pStoreQuota);
void __RPC_STUB IMailboxStoreDB_get_StoreQuota_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailboxStoreDB_put_StoreQuota_Proxy(IMailboxStoreDB *This,
                                                    __LONG32 varStoreQuota);
void __RPC_STUB IMailboxStoreDB_put_StoreQuota_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailboxStoreDB_get_OverQuotaLimit_Proxy(
    IMailboxStoreDB *This, __LONG32 *pOverQuotaLimit);
void __RPC_STUB IMailboxStoreDB_get_OverQuotaLimit_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailboxStoreDB_put_OverQuotaLimit_Proxy(
    IMailboxStoreDB *This, __LONG32 varOverQuotaLimit);
void __RPC_STUB IMailboxStoreDB_put_OverQuotaLimit_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailboxStoreDB_get_HardLimit_Proxy(IMailboxStoreDB *This,
                                                   __LONG32 *pHardLimit);
void __RPC_STUB IMailboxStoreDB_get_HardLimit_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailboxStoreDB_put_HardLimit_Proxy(IMailboxStoreDB *This,
                                                   __LONG32 varHardLimit);
void __RPC_STUB IMailboxStoreDB_put_HardLimit_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailboxStoreDB_get_DaysBeforeGarbageCollection_Proxy(
    IMailboxStoreDB *This, __LONG32 *pDaysBeforeGarbageCollection);
...
void __RPC_STUB IMailboxStoreDB_get_DaysBeforeDeletedMailboxCleanup_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailboxStoreDB_put_DaysBeforeDeletedMailboxCleanup_Proxy(
    IMailboxStoreDB *This, __LONG32 varDaysBeforeDeletedMailboxCleanup);
void __RPC_STUB IMailboxStoreDB_put_DaysBeforeDeletedMailboxCleanup_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailboxStoreDB_get_GarbageCollectOnlyAfterBackup_Proxy(
    IMailboxStoreDB *This, VARIANT_BOOL *pGarbageCollectOnlyAfterBackup);
void __RPC_STUB IMailboxStoreDB_get_GarbageCollectOnlyAfterBackup_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailboxStoreDB_put_GarbageCollectOnlyAfterBackup_Proxy(
    IMailboxStoreDB *This, VARIANT_BOOL varGarbageCollectOnlyAfterBackup);
void __RPC_STUB IMailboxStoreDB_put_GarbageCollectOnlyAfterBackup_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailboxStoreDB_GetInterface_Proxy(IMailboxStoreDB *This,
                                                  BSTR Interface,
                                                  IDispatch **ppUnknown);
void __RPC_STUB IMailboxStoreDB_GetInterface_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailboxStoreDB_MoveDataFiles_Proxy(IMailboxStoreDB *This,
                                                   BSTR DBPath, BSTR SLVPath,
                                                   __LONG32 Flags);
void __RPC_STUB IMailboxStoreDB_MoveDataFiles_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailboxStoreDB_Mount_Proxy(IMailboxStoreDB *This,
                                           __LONG32 Timeout);
void __RPC_STUB IMailboxStoreDB_Mount_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMailboxStoreDB_Dismount_Proxy(IMailboxStoreDB *This,
                                              __LONG32 Timeout);
...
typedef struct IFolderTreeVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IFolderTree *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IFolderTree *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IFolderTree *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IFolderTree *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *get_DataSource)(IFolderTree *This,
                                  IDataSource2 **varDataSource);
  ...
  HRESULT(WINAPI *get_TreeType)(IFolderTree *This,
                                CDOEXMFolderTreeType *varTreeType);
  HRESULT(WINAPI *get_RootFolderURL)(IFolderTree *This, BSTR *varRootFolderURL);
  HRESULT(WINAPI *GetInterface)(IFolderTree *This, BSTR Interface,
                                IDispatch **ppUnknown);
  END_INTERFACE
} IFolderTreeVtbl;
struct IFolderTree {
...
#define IFolderTree_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                   \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IFolderTree_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,         \
                                  rgDispId)                                    \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IFolderTree_Invoke(This, dispIdMember, riid, lcid, wFlags,             \
                           pDispParams, pVarResult, pExcepInfo, puArgErr)      \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI IFolderTree_get_DataSource_Proxy(IFolderTree *This,
                                                IDataSource2 **varDataSource);
void __RPC_STUB IFolderTree_get_DataSource_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IFolderTree_get_Fields_Proxy(IFolderTree *This,
                                            Fields **varFields);
void __RPC_STUB IFolderTree_get_Fields_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IFolderTree_get_Name_Proxy(IFolderTree *This, BSTR *pName);
void __RPC_STUB IFolderTree_get_Name_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI IFolderTree_put_Name_Proxy(IFolderTree *This, BSTR varName);
void __RPC_STUB IFolderTree_put_Name_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI IFolderTree_get_StoreDBs_Proxy(IFolderTree *This,
                                              VARIANT *varStoreDBs);
void __RPC_STUB IFolderTree_get_StoreDBs_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IFolderTree_get_TreeType_Proxy(
    IFolderTree *This, CDOEXMFolderTreeType *varTreeType);
void __RPC_STUB IFolderTree_get_TreeType_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IFolderTree_get_RootFolderURL_Proxy(IFolderTree *This,
                                                   BSTR *varRootFolderURL);
void __RPC_STUB IFolderTree_get_RootFolderURL_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IFolderTree_GetInterface_Proxy(IFolderTree *This, BSTR Interface,
                                              IDispatch **ppUnknown);
...
typedef struct IDataSource2Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IDataSource2 *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IDataSource2 *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IDataSource2 *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IDataSource2 *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  ...
  HRESULT(WINAPI *get_ActiveConnection)(IDataSource2 *This,
                                        _Connection **varActiveConnection);
  HRESULT(WINAPI *SaveToObject)(IDataSource2 *This, IUnknown *Source,
                                BSTR InterfaceName);
  HRESULT(WINAPI *OpenObject)(IDataSource2 *This, IUnknown *Source,
                              BSTR InterfaceName);
  HRESULT(WINAPI *SaveTo)(IDataSource2 *This, BSTR SourceURL,
                          ...
                          BSTR Password);
  HRESULT(WINAPI *Open)(IDataSource2 *This, BSTR SourceURL,
                        IDispatch *ActiveConnection, ConnectModeEnum Mode,
                        RecordCreateOptionsEnum CreateOptions,
                        RecordOpenOptionsEnum Options, BSTR UserName,
                        BSTR Password);
  HRESULT(WINAPI *Save)(IDataSource2 *This);
  HRESULT(WINAPI *SaveToContainer)(IDataSource2 *This, BSTR ContainerURL,
...
#define IDataSource2_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                  \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IDataSource2_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,        \
                                   rgDispId)                                   \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IDataSource2_Invoke(This, dispIdMember, riid, lcid, wFlags,            \
                            pDispParams, pVarResult, pExcepInfo, puArgErr)     \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#define IDataSource2_SaveTo(This, SourceURL, ActiveConnection, Mode,           \
                            CreateOptions, Options, UserName, Password)        \
  (This)->lpVtbl->SaveTo(This, SourceURL, ActiveConnection, Mode,              \
                         CreateOptions, Options, UserName, Password)
#define IDataSource2_Open(This, SourceURL, ActiveConnection, Mode,             \
                          CreateOptions, Options, UserName, Password)          \
...
#define IDataSource2_SaveToContainer(This, ContainerURL, ActiveConnection,     \
...
void __RPC_STUB IDataSource2_Delete_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
HRESULT WINAPI IDataSource2_MoveToContainer_Proxy(IDataSource2 *This,
                                                  BSTR ContainerURL);
