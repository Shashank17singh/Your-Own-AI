...
HRESULT __cdecl GetXaSwitch(XA_SWITCH_FLAGS XaSwitchFlags,
...
public:
  virtual HRESULT WINAPI RequestNewResourceManager(char *pszDSN,
                                                   char *pszClientDllName,
                                                   DWORD *pdwRMCookie) = 0;
  virtual HRESULT WINAPI TranslateTridToXid(DWORD *pdwITransaction,
                                            DWORD dwRMCookie, XID *pXid) = 0;
  virtual HRESULT WINAPI EnlistResourceManager(DWORD dwRMCookie,
                                               DWORD *pdwITransaction) = 0;
  virtual HRESULT WINAPI ReleaseResourceManager(DWORD dwRMCookie) = 0;
};
#else
typedef struct IDtcToXaMapperVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IDtcToXaMapper *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IDtcToXaMapper *This);
  ULONG(WINAPI *Release)(IDtcToXaMapper *This);
  HRESULT(WINAPI *RequestNewResourceManager)(IDtcToXaMapper *This, char *pszDSN,
                                             char *pszClientDllName,
                                             DWORD *pdwRMCookie);
  HRESULT(WINAPI *TranslateTridToXid)(IDtcToXaMapper *This,
                                      DWORD *pdwITransaction, DWORD dwRMCookie,
                                      XID *pXid);
  HRESULT(WINAPI *EnlistResourceManager)(IDtcToXaMapper *This, DWORD dwRMCookie,
                                         DWORD *pdwITransaction);
  HRESULT(WINAPI *ReleaseResourceManager)(IDtcToXaMapper *This,
                                          DWORD dwRMCookie);
  END_INTERFACE
} IDtcToXaMapperVtbl;
...
#define IDtcToXaMapper_RequestNewResourceManager(                              \
    This, pszDSN, pszClientDllName, pdwRMCookie)                               \
  (This)->lpVtbl->RequestNewResourceManager(This, pszDSN, pszClientDllName,    \
                                            pdwRMCookie)
#define IDtcToXaMapper_TranslateTridToXid(This, pdwITransaction, dwRMCookie,   \
                                          pXid)                                \
  (This)->lpVtbl->TranslateTridToXid(This, pdwITransaction, dwRMCookie, pXid)
#define IDtcToXaMapper_EnlistResourceManager(This, dwRMCookie,                 \
                                             pdwITransaction)                  \
...
#endif
#endif
HRESULT WINAPI IDtcToXaMapper_RequestNewResourceManager_Proxy(
    IDtcToXaMapper *This, char *pszDSN, char *pszClientDllName,
    DWORD *pdwRMCookie);
...
HRESULT WINAPI IDtcToXaMapper_TranslateTridToXid_Proxy(IDtcToXaMapper *This,
                                                       DWORD *pdwITransaction,
                                                       DWORD dwRMCookie,
                                                       XID *pXid);
void __RPC_STUB IDtcToXaMapper_TranslateTridToXid_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IDtcToXaMapper_EnlistResourceManager_Proxy(
    IDtcToXaMapper *This, DWORD dwRMCookie, DWORD *pdwITransaction);
void __RPC_STUB IDtcToXaMapper_EnlistResourceManager_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IDtcToXaMapper_ReleaseResourceManager_Proxy(IDtcToXaMapper *This,
                                                           DWORD dwRMCookie);
...
public:
  virtual HRESULT WINAPI Create(char *pszDSN, char *pszClientDllName,
                                GUID *pguidRm, IDtcToXaHelper **ppXaHelper) = 0;
};
#else
typedef struct IDtcToXaHelperFactoryVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IDtcToXaHelperFactory *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IDtcToXaHelperFactory *This);
  ULONG(WINAPI *Release)(IDtcToXaHelperFactory *This);
  HRESULT(WINAPI *Create)(IDtcToXaHelperFactory *This, char *pszDSN,
                          char *pszClientDllName, GUID *pguidRm,
                          IDtcToXaHelper **ppXaHelper);
  END_INTERFACE
...
#define IDtcToXaHelperFactory_Create(This, pszDSN, pszClientDllName, pguidRm,  \
                                     ppXaHelper)                               \
  (This)->lpVtbl->Create(This, pszDSN, pszClientDllName, pguidRm, ppXaHelper)
#endif
#endif
HRESULT WINAPI IDtcToXaHelperFactory_Create_Proxy(IDtcToXaHelperFactory *This,
                                                  char *pszDSN,
                                                  char *pszClientDllName,
                                                  GUID *pguidRm,
                                                  IDtcToXaHelper **ppXaHelper);
...
public:
  ...
  virtual HRESULT WINAPI TranslateTridToXid(ITransaction *pITransaction,
                                            GUID *pguidBqual, XID *pXid) = 0;
};
#else
typedef struct IDtcToXaHelperVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IDtcToXaHelper *This, REFIID riid,
                                  void **ppvObject);
...
#define IDtcToXaHelper_TranslateTridToXid(This, pITransaction, pguidBqual,     \
                                          pXid)                                \
  (This)->lpVtbl->TranslateTridToXid(This, pITransaction, pguidBqual, pXid)
#endif
#endif
HRESULT WINAPI IDtcToXaHelper_Close_Proxy(IDtcToXaHelper *This,
                                          WINBOOL i_fDoRecovery);
void __RPC_STUB IDtcToXaHelper_Close_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI IDtcToXaHelper_TranslateTridToXid_Proxy(
    IDtcToXaHelper *This, ITransaction *pITransaction, GUID *pguidBqual,
    XID *pXid);
...
public:
  virtual HRESULT WINAPI XARMCreate(char *pszDSN, char *pszClientDll,
                                    DWORD *pdwRMCookie) = 0;
  virtual HRESULT WINAPI ConvertTridToXID(DWORD *pdwITrans, DWORD dwRMCookie,
                                          XID *pxid) = 0;
  virtual HRESULT WINAPI
  EnlistWithRM(DWORD dwRMCookie, ITransaction *i_pITransaction,
               ITransactionResourceAsync *i_pITransRes,
               ITransactionEnlistmentAsync **o_ppITransEnslitment) = 0;
  virtual void WINAPI ReleaseRMCookie(DWORD i_dwRMCookie,
                                      WINBOOL i_fNormal) = 0;
};
#else
typedef struct IDtcToXaHelperSinglePipeVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IDtcToXaHelperSinglePipe *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IDtcToXaHelperSinglePipe *This);
  ULONG(WINAPI *Release)(IDtcToXaHelperSinglePipe *This);
  HRESULT(WINAPI *XARMCreate)(IDtcToXaHelperSinglePipe *This, char *pszDSN,
                              char *pszClientDll, DWORD *pdwRMCookie);
  HRESULT(WINAPI *ConvertTridToXID)(IDtcToXaHelperSinglePipe *This,
                                    DWORD *pdwITrans, DWORD dwRMCookie,
                                    XID *pxid);
  HRESULT(WINAPI *EnlistWithRM)(
      IDtcToXaHelperSinglePipe *This, DWORD dwRMCookie,
      ITransaction *i_pITransaction, ITransactionResourceAsync *i_pITransRes,
      ITransactionEnlistmentAsync **o_ppITransEnslitment);
  void(WINAPI *ReleaseRMCookie)(IDtcToXaHelperSinglePipe *This,
                                DWORD i_dwRMCookie, WINBOOL i_fNormal);
  END_INTERFACE
...
#define IDtcToXaHelperSinglePipe_XARMCreate(This, pszDSN, pszClientDll,        \
                                            pdwRMCookie)                       \
  (This)->lpVtbl->XARMCreate(This, pszDSN, pszClientDll, pdwRMCookie)
#define IDtcToXaHelperSinglePipe_ConvertTridToXID(This, pdwITrans, dwRMCookie, \
                                                  pxid)                        \
  (This)->lpVtbl->ConvertTridToXID(This, pdwITrans, dwRMCookie, pxid)
#define IDtcToXaHelperSinglePipe_EnlistWithRM(                                 \
    This, dwRMCookie, i_pITransaction, i_pITransRes, o_ppITransEnslitment)     \
  (This)->lpVtbl->EnlistWithRM(This, dwRMCookie, i_pITransaction,              \
                               i_pITransRes, o_ppITransEnslitment)
#define IDtcToXaHelperSinglePipe_ReleaseRMCookie(This, i_dwRMCookie,           \
                                                 i_fNormal)                    \
  (This)->lpVtbl->ReleaseRMCookie(This, i_dwRMCookie, i_fNormal)
#endif
#endif
HRESULT WINAPI IDtcToXaHelperSinglePipe_XARMCreate_Proxy(
    IDtcToXaHelperSinglePipe *This, char *pszDSN, char *pszClientDll,
    DWORD *pdwRMCookie);
void __RPC_STUB IDtcToXaHelperSinglePipe_XARMCreate_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IDtcToXaHelperSinglePipe_ConvertTridToXID_Proxy(
    IDtcToXaHelperSinglePipe *This, DWORD *pdwITrans, DWORD dwRMCookie,
    XID *pxid);
void __RPC_STUB IDtcToXaHelperSinglePipe_ConvertTridToXID_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IDtcToXaHelperSinglePipe_EnlistWithRM_Proxy(
    IDtcToXaHelperSinglePipe *This, DWORD dwRMCookie,
    ITransaction *i_pITransaction, ITransactionResourceAsync *i_pITransRes,
    ITransactionEnlistmentAsync **o_ppITransEnslitment);
void __RPC_STUB IDtcToXaHelperSinglePipe_EnlistWithRM_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
void WINAPI IDtcToXaHelperSinglePipe_ReleaseRMCookie_Proxy(
    IDtcToXaHelperSinglePipe *This, DWORD i_dwRMCookie, WINBOOL i_fNormal);
void __RPC_STUB IDtcToXaHelperSinglePipe_ReleaseRMCookie_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
#endif
DEFINE_GUID(IID_IDtcToXaMapper, 0x64FFABE0, 0x7CE9, 0x11d0, 0x8C, 0xE6, 0x00,
            0xC0, 0x4F, 0xDC, 0x87, 0x7E);
DEFINE_GUID(IID_IDtcToXaHelperFactory, 0xadefc46a, 0xcb1d, 0x11d0, 0xb1, 0x35,
            0x00, 0xc0, 0x4f, 0xc2, 0xf3, 0xef);
DEFINE_GUID(IID_IDtcToXaHelper, 0xadefc46b, 0xcb1d, 0x11d0, 0xb1, 0x35, 0x00,
            0xc0, 0x4f, 0xc2, 0xf3, 0xef);
DEFINE_GUID(IID_IDtcToXaHelperSinglePipe, 0x47ED4971, 0x53B3, 0x11d1, 0xBB,
            0xB9, 0x00, 0xC0, 0x4F, 0xD6, 0x58, 0xF6);
