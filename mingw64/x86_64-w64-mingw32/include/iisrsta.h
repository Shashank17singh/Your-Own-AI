...
#endif
DEFINE_GUID(IID_IIisServiceControl, 0xE8FB8620, 0x588F, 0x11d2, 0x9d, 0x61, 0x0,
            0xc0, 0x4f, 0x79, 0xc5, 0xfe);
DEFINE_GUID(CLSID_IisServiceControl, 0xE8FB8621, 0x588F, 0x11d2, 0x9d, 0x61,
            0x0, 0xc0, 0x4f, 0x79, 0xc5, 0xfe);
DEFINE_GUID(LIBID_IISRSTALib, 0xE8FB8614, 0x588F, 0x11d2, 0x9d, 0x61, 0x0, 0xc0,
            0x4f, 0x79, 0xc5, 0xfe);
...
public:
  ...
  virtual HRESULT WINAPI Reboot(DWORD dwTimeouMsecs,
                                DWORD dwForceAppsClosed) = 0;
  virtual HRESULT WINAPI Status(DWORD dwBufferSize, unsigned char *pbBuffer,
                                DWORD *pdwMDRequiredBufferSize,
                                DWORD *pdwNumServices) = 0;
  virtual HRESULT WINAPI Kill(void) = 0;
};
#else
typedef struct IIisServiceControlVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IIisServiceControl *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IIisServiceControl *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IIisServiceControl *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IIisServiceControl *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *Stop)(IIisServiceControl *This, DWORD dwTimeoutMsecs,
                        DWORD dwForce);
  HRESULT(WINAPI *Start)(IIisServiceControl *This, DWORD dwTimeoutMsecs);
  HRESULT(WINAPI *Reboot)(IIisServiceControl *This, DWORD dwTimeouMsecs,
                          DWORD dwForceAppsClosed);
  HRESULT(WINAPI *Status)(IIisServiceControl *This, DWORD dwBufferSize,
...
#define IIisServiceControl_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,  \
                                         rgDispId)                             \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IIisServiceControl_Invoke(This, dispIdMember, riid, lcid, wFlags,      \
...
#define IIisServiceControl_Status(This, dwBufferSize, pbBuffer,                \
                                  pdwMDRequiredBufferSize, pdwNumServices)     \
  (This)->lpVtbl->Status(This, dwBufferSize, pbBuffer,                         \
                         pdwMDRequiredBufferSize, pdwNumServices)
#define IIisServiceControl_Kill(This) (This)->lpVtbl->Kill(This)
#endif
#endif
HRESULT WINAPI IIisServiceControl_Stop_Proxy(IIisServiceControl *This,
...
HRESULT WINAPI IIisServiceControl_Start_Proxy(IIisServiceControl *This,
                                              DWORD dwTimeoutMsecs);
void __RPC_STUB IIisServiceControl_Start_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IIisServiceControl_Reboot_Proxy(IIisServiceControl *This,
                                               DWORD dwTimeouMsecs,
                                               DWORD dwForceAppsClosed);
void __RPC_STUB IIisServiceControl_Reboot_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IIisServiceControl_Status_Proxy(IIisServiceControl *This,
                                               DWORD dwBufferSize,
                                               unsigned char *pbBuffer,
                                               DWORD *pdwMDRequiredBufferSize,
                                               DWORD *pdwNumServices);
