...
DECLARE_INTERFACE_(IDirectPlay8LobbiedApplication, IUnknown) {
  ...
  STDMETHOD(Initialize)(THIS_ PVOID pvUserContext, PFNDPNMESSAGEHANDLER pfn,
                        DPNHANDLE * pdpnhConnection, DWORD dwFlags) PURE;
  STDMETHOD(RegisterProgram)(THIS_ PDPL_PROGRAM_DESC pdplProgramDesc,
                             DWORD dwFlags) PURE;
  STDMETHOD(UnRegisterProgram)(THIS_ GUID * pguidApplication, DWORD dwFlags)
      PURE;
  STDMETHOD(Send)(THIS_ DPNHANDLE hConnection, BYTE * pBuffer,
                  DWORD pBufferSize, DWORD dwFlags) PURE;
  STDMETHOD(SetAppAvailable)(THIS_ WINBOOL fAvailable, DWORD dwFlags) PURE;
  STDMETHOD(UpdateStatus)(THIS_ DPNHANDLE hConnection, DWORD dwStatus,
                          DWORD dwFlags) PURE;
  STDMETHOD(Close)(THIS_ DWORD dwFlags) PURE;
  STDMETHOD(GetConnectionSettings)(THIS_ DPNHANDLE hConnection,
                                   DPL_CONNECTION_SETTINGS * pdplSessionInfo,
                                   DWORD * pdwInfoSize, DWORD dwFlags) PURE;
  STDMETHOD(SetConnectionSettings)(
      THIS_ DPNHANDLE hConnection,
      const DPL_CONNECTION_SETTINGS *pdplSessionInfo, DWORD dwFlags) PURE;
};
#undef INTERFACE
...
DECLARE_INTERFACE_(IDirectPlay8LobbyClient, IUnknown) {
  ...
  STDMETHOD(Initialize)(THIS_ PVOID pvUserContext, PFNDPNMESSAGEHANDLER pfn,
                        DWORD dwFlags) PURE;
  STDMETHOD(EnumLocalPrograms)(THIS_ GUID * pGuidApplication, BYTE * pEnumData,
                               DWORD * pdwEnumData, DWORD * pdwItems,
                               DWORD dwFlags) PURE;
  STDMETHOD(ConnectApplication)(
      THIS_ DPL_CONNECT_INFO * pdplConnectionInfo, PVOID pvConnectionContext,
      DPNHANDLE * hApplication, DWORD dwTimeOut, DWORD dwFlags) PURE;
  STDMETHOD(Send)(THIS_ DPNHANDLE hConnection, BYTE * pBuffer,
                  DWORD pBufferSize, DWORD dwFlags) PURE;
  STDMETHOD(ReleaseApplication)(THIS_ DPNHANDLE hConnection, DWORD dwFlags)
      PURE;
  STDMETHOD(Close)(THIS_ DWORD dwFlags) PURE;
  STDMETHOD(GetConnectionSettings)(THIS_ DPNHANDLE hConnection,
                                   DPL_CONNECTION_SETTINGS * pdplSessionInfo,
...
#endif
/* Export functions */
HRESULT WINAPI DirectPlay8LobbyCreate(const GUID *pcIID, LPVOID *ppvInterface,
                                      IUnknown *pUnknown);
#ifdef __cplusplus
}
#endif
