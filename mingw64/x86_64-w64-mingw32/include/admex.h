...
#ifndef _ADMEX_IADM_
#define _ADMEX_IADM_
DEFINE_GUID(IID_IMSAdminReplication, 0xc804d980, 0xebec, 0x11d0, 0xa6, 0xa0,
            0x0, 0xa0, 0xc9, 0x22, 0xe7, 0x52);
DEFINE_GUID(IID_IMSAdminCryptoCapabilities, 0x78b64540, 0xf26d, 0x11d0, 0xa6,
            0xa3, 0x0, 0xa0, 0xc9, 0x22, 0xe7, 0x52);
DEFINE_GUID(CLSID_MSCryptoAdmEx, 0x9f0bd3a0, 0xec01, 0x11d0, 0xa6, 0xa0, 0x0,
            0xa0, 0xc9, 0x22, 0xe7, 0x52);
...
public:
  virtual HRESULT WINAPI GetSignature(DWORD dwBufferSize,
                                      unsigned char *pbBuffer,
                                      DWORD *pdwMDRequiredBufferSize) = 0;
  virtual HRESULT WINAPI Propagate(DWORD dwBufferSize,
                                   unsigned char *pszBuffer) = 0;
  virtual HRESULT WINAPI Propagate2(DWORD dwBufferSize,
                                    unsigned char *pszBuffer,
                                    DWORD dwSignatureMismatch) = 0;
  virtual HRESULT WINAPI Serialize(DWORD dwBufferSize, unsigned char *pbBuffer,
                                   DWORD *pdwMDRequiredBufferSize) = 0;
  virtual HRESULT WINAPI DeSerialize(DWORD dwBufferSize,
                                     unsigned char *pbBuffer) = 0;
};
#else
typedef struct IMSAdminReplicationVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMSAdminReplication *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IMSAdminReplication *This);
  ULONG(WINAPI *Release)(IMSAdminReplication *This);
  HRESULT(WINAPI *GetSignature)(IMSAdminReplication *This, DWORD dwBufferSize,
                                unsigned char *pbBuffer,
                                DWORD *pdwMDRequiredBufferSize);
  HRESULT(WINAPI *Propagate)(IMSAdminReplication *This, DWORD dwBufferSize,
                             unsigned char *pszBuffer);
  HRESULT(WINAPI *Propagate2)(IMSAdminReplication *This, DWORD dwBufferSize,
                              unsigned char *pszBuffer,
                              DWORD dwSignatureMismatch);
  HRESULT(WINAPI *Serialize)(IMSAdminReplication *This, DWORD dwBufferSize,
                             unsigned char *pbBuffer,
                             DWORD *pdwMDRequiredBufferSize);
  HRESULT(WINAPI *DeSerialize)(IMSAdminReplication *This, DWORD dwBufferSize,
                               unsigned char *pbBuffer);
  END_INTERFACE
...
#define IMSAdminReplication_GetSignature(This, dwBufferSize, pbBuffer,         \
                                         pdwMDRequiredBufferSize)              \
  (This)->lpVtbl->GetSignature(This, dwBufferSize, pbBuffer,                   \
                               pdwMDRequiredBufferSize)
#define IMSAdminReplication_Propagate(This, dwBufferSize, pszBuffer)           \
  (This)->lpVtbl->Propagate(This, dwBufferSize, pszBuffer)
#define IMSAdminReplication_Propagate2(This, dwBufferSize, pszBuffer,          \
                                       dwSignatureMismatch)                    \
  (This)->lpVtbl->Propagate2(This, dwBufferSize, pszBuffer, dwSignatureMismatch)
#define IMSAdminReplication_Serialize(This, dwBufferSize, pbBuffer,            \
                                      pdwMDRequiredBufferSize)                 \
  (This)->lpVtbl->Serialize(This, dwBufferSize, pbBuffer,                      \
                            pdwMDRequiredBufferSize)
...
HRESULT WINAPI IMSAdminReplication_Propagate_Proxy(IMSAdminReplication *This,
                                                   DWORD dwBufferSize,
                                                   unsigned char *pszBuffer);
void __RPC_STUB IMSAdminReplication_Propagate_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSAdminReplication_Propagate2_Proxy(IMSAdminReplication *This,
                                                    DWORD dwBufferSize,
                                                    unsigned char *pszBuffer,
                                                    DWORD dwSignatureMismatch);
void __RPC_STUB IMSAdminReplication_Propagate2_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSAdminReplication_Serialize_Proxy(
    IMSAdminReplication *This, DWORD dwBufferSize, unsigned char *pbBuffer,
    DWORD *pdwMDRequiredBufferSize);
void __RPC_STUB IMSAdminReplication_Serialize_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSAdminReplication_DeSerialize_Proxy(IMSAdminReplication *This,
                                                     DWORD dwBufferSize,
                                                     unsigned char *pbBuffer);
...
public:
  virtual HRESULT WINAPI GetProtocols(DWORD dwBufferSize,
                                      unsigned char *pbBuffer,
                                      DWORD *pdwMDRequiredBufferSize) = 0;
  virtual HRESULT WINAPI
  GetMaximumCipherStrength(LPDWORD pdwMaximumCipherStrength) = 0;
  virtual HRESULT WINAPI
  GetRootCertificates(DWORD dwBufferSize, unsigned char *pbBuffer,
                      DWORD *pdwMDRequiredBufferSize) = 0;
  virtual HRESULT WINAPI GetSupportedAlgs(DWORD dwBufferSize, DWORD *pbBuffer,
                                          DWORD *pdwMDRequiredBufferSize) = 0;
  virtual HRESULT WINAPI SetCAList(DWORD dwBufferSize,
                                   unsigned char *pbBuffer) = 0;
};
#else
typedef struct IMSAdminCryptoCapabilitiesVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMSAdminCryptoCapabilities *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IMSAdminCryptoCapabilities *This);
  ULONG(WINAPI *Release)(IMSAdminCryptoCapabilities *This);
  HRESULT(WINAPI *GetProtocols)(IMSAdminCryptoCapabilities *This,
                                DWORD dwBufferSize, unsigned char *pbBuffer,
                                DWORD *pdwMDRequiredBufferSize);
  HRESULT(WINAPI *GetMaximumCipherStrength)(IMSAdminCryptoCapabilities *This,
                                            LPDWORD pdwMaximumCipherStrength);
  HRESULT(WINAPI *GetRootCertificates)(IMSAdminCryptoCapabilities *This,
                                       DWORD dwBufferSize,
                                       unsigned char *pbBuffer,
                                       DWORD *pdwMDRequiredBufferSize);
  HRESULT(WINAPI *GetSupportedAlgs)(IMSAdminCryptoCapabilities *This,
                                    DWORD dwBufferSize, DWORD *pbBuffer,
                                    DWORD *pdwMDRequiredBufferSize);
  HRESULT(WINAPI *SetCAList)(IMSAdminCryptoCapabilities *This,
                             DWORD dwBufferSize, unsigned char *pbBuffer);
  END_INTERFACE
...
#define IMSAdminCryptoCapabilities_GetProtocols(This, dwBufferSize, pbBuffer,  \
                                                pdwMDRequiredBufferSize)       \
  (This)->lpVtbl->GetProtocols(This, dwBufferSize, pbBuffer,                   \
                               pdwMDRequiredBufferSize)
#define IMSAdminCryptoCapabilities_GetMaximumCipherStrength(                   \
    This, pdwMaximumCipherStrength)                                            \
  (This)->lpVtbl->GetMaximumCipherStrength(This, pdwMaximumCipherStrength)
#define IMSAdminCryptoCapabilities_GetRootCertificates(                        \
    This, dwBufferSize, pbBuffer, pdwMDRequiredBufferSize)                     \
  (This)->lpVtbl->GetRootCertificates(This, dwBufferSize, pbBuffer,            \
                                      pdwMDRequiredBufferSize)
#define IMSAdminCryptoCapabilities_GetSupportedAlgs(                           \
    This, dwBufferSize, pbBuffer, pdwMDRequiredBufferSize)                     \
  (This)->lpVtbl->GetSupportedAlgs(This, dwBufferSize, pbBuffer,               \
                                   pdwMDRequiredBufferSize)
#define IMSAdminCryptoCapabilities_SetCAList(This, dwBufferSize, pbBuffer)     \
  (This)->lpVtbl->SetCAList(This, dwBufferSize, pbBuffer)
#endif
#endif
HRESULT WINAPI IMSAdminCryptoCapabilities_GetProtocols_Proxy(
    IMSAdminCryptoCapabilities *This, DWORD dwBufferSize,
    unsigned char *pbBuffer, DWORD *pdwMDRequiredBufferSize);
void __RPC_STUB IMSAdminCryptoCapabilities_GetProtocols_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSAdminCryptoCapabilities_GetMaximumCipherStrength_Proxy(
    IMSAdminCryptoCapabilities *This, LPDWORD pdwMaximumCipherStrength);
...
void __RPC_STUB IMSAdminCryptoCapabilities_GetRootCertificates_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSAdminCryptoCapabilities_GetSupportedAlgs_Proxy(
...
void __RPC_STUB IMSAdminCryptoCapabilities_GetSupportedAlgs_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSAdminCryptoCapabilities_SetCAList_Proxy(
    IMSAdminCryptoCapabilities *This, DWORD dwBufferSize,
    unsigned char *pbBuffer);
