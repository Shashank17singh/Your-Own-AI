...
typedef void __RPC_API RPC_OBJECT_INQ_FN(UUID *ObjectUuid, UUID *TypeUuid,
                                         RPC_STATUS *Status);
typedef RPC_STATUS RPC_ENTRY RPC_IF_CALLBACK_FN(RPC_IF_HANDLE InterfaceUuid,
                                                void *Context);
...
#define RpcServerInqDefaultPrincName                                           \
  __MINGW_NAME_AW(RpcServerInqDefaultPrincName)
...
RPCRTAPI RPC_STATUS RPC_ENTRY RpcBindingSetOption(RPC_BINDING_HANDLE hBinding,
                                                  unsigned __LONG32 option,
                                                  ULONG_PTR optionValue);
RPCRTAPI RPC_STATUS RPC_ENTRY RpcBindingInqOption(RPC_BINDING_HANDLE hBinding,
                                                  unsigned __LONG32 option,
                                                  ULONG_PTR *pOptionValue);
RPCRTAPI RPC_STATUS RPC_ENTRY RpcBindingFromStringBindingA(
    RPC_CSTR StringBinding, RPC_BINDING_HANDLE *Binding);
RPCRTAPI RPC_STATUS RPC_ENTRY RpcBindingFromStringBindingW(
    RPC_WSTR StringBinding, RPC_BINDING_HANDLE *Binding);
RPCRTAPI RPC_STATUS RPC_ENTRY
RpcSsGetContextBinding(void *ContextHandle, RPC_BINDING_HANDLE *Binding);
...
RPCRTAPI RPC_STATUS RPC_ENTRY RpcMgmtInqDefaultProtectLevel(
    unsigned __LONG32 AuthnSvc, unsigned __LONG32 *AuthnLevel);
RPCRTAPI RPC_STATUS RPC_ENTRY
...
RPCRTAPI RPC_STATUS RPC_ENTRY RpcIfInqId(RPC_IF_HANDLE RpcIfHandle,
                                         RPC_IF_ID *RpcIfId);
...
RPCRTAPI RPC_STATUS RPC_ENTRY RpcMgmtInqComTimeout(RPC_BINDING_HANDLE Binding,
...
RPCRTAPI RPC_STATUS RPC_ENTRY RpcServerInqIf(RPC_IF_HANDLE IfSpec,
                                             UUID *MgrTypeUuid,
                                             RPC_MGR_EPV **MgrEpv);
...
RPCRTAPI RPC_STATUS RPC_ENTRY
RpcServerUnregisterIf(RPC_IF_HANDLE IfSpec, UUID *MgrTypeUuid,
                      unsigned int WaitForCallsToComplete);
RPCRTAPI RPC_STATUS RPC_ENTRY RpcServerUnregisterIfEx(
    RPC_IF_HANDLE IfSpec, UUID *MgrTypeUuid, int RundownContextHandles);
RPCRTAPI RPC_STATUS RPC_ENTRY RpcServerUseAllProtseqs(unsigned int MaxCalls,
...
RPCRTAPI RPC_STATUS RPC_ENTRY
RpcServerUseAllProtseqsIfEx(unsigned int MaxCalls, RPC_IF_HANDLE IfSpec,
                            void *SecurityDescriptor, PRPC_POLICY Policy);
RPCRTAPI RPC_STATUS RPC_ENTRY RpcServerUseProtseqA(RPC_CSTR Protseq,
                                                   unsigned int MaxCalls,
                                                   void *SecurityDescriptor);
RPCRTAPI RPC_STATUS RPC_ENTRY RpcServerUseProtseqExA(RPC_CSTR Protseq,
                                                     unsigned int MaxCalls,
                                                     void *SecurityDescriptor,
                                                     PRPC_POLICY Policy);
RPCRTAPI RPC_STATUS RPC_ENTRY RpcServerUseProtseqW(RPC_WSTR Protseq,
                                                   unsigned int MaxCalls,
                                                   void *SecurityDescriptor);
RPCRTAPI RPC_STATUS RPC_ENTRY RpcServerUseProtseqExW(RPC_WSTR Protseq,
                                                     unsigned int MaxCalls,
                                                     void *SecurityDescriptor,
                                                     PRPC_POLICY Policy);
...
RPCRTAPI RPC_STATUS RPC_ENTRY RpcServerUseProtseqEpExW(RPC_WSTR Protseq,
                                                       ...
                                                       void *SecurityDescriptor,
                                                       PRPC_POLICY Policy);
RPCRTAPI RPC_STATUS RPC_ENTRY RpcServerUseProtseqIfA(RPC_CSTR Protseq,
                                                     unsigned int MaxCalls,
                                                     RPC_IF_HANDLE IfSpec,
                                                     void *SecurityDescriptor);
RPCRTAPI RPC_STATUS RPC_ENTRY RpcServerUseProtseqIfExA(RPC_CSTR Protseq,
                                                       unsigned int MaxCalls,
                                                       RPC_IF_HANDLE IfSpec,
                                                       void *SecurityDescriptor,
                                                       PRPC_POLICY Policy);
RPCRTAPI RPC_STATUS RPC_ENTRY RpcServerUseProtseqIfW(RPC_WSTR Protseq,
                                                     unsigned int MaxCalls,
                                                     RPC_IF_HANDLE IfSpec,
                                                     void *SecurityDescriptor);
RPCRTAPI RPC_STATUS RPC_ENTRY RpcServerUseProtseqIfExW(RPC_WSTR Protseq,
                                                       unsigned int MaxCalls,
                                                       RPC_IF_HANDLE IfSpec,
                                                       void *SecurityDescriptor,
                                                       PRPC_POLICY Policy);
...
RPCRTAPI RPC_STATUS RPC_ENTRY
RpcMgmtSetServerStackSize(unsigned __LONG32 ThreadStackSize);
...
RPCRTAPI RPC_STATUS RPC_ENTRY RpcMgmtInqServerPrincNameA(
    RPC_BINDING_HANDLE Binding, unsigned __LONG32 AuthnSvc,
    RPC_CSTR *ServerPrincName);
RPCRTAPI RPC_STATUS RPC_ENTRY RpcMgmtInqServerPrincNameW(
    RPC_BINDING_HANDLE Binding, unsigned __LONG32 AuthnSvc,
    RPC_WSTR *ServerPrincName);
RPCRTAPI RPC_STATUS RPC_ENTRY
RpcServerInqDefaultPrincNameA(unsigned __LONG32 AuthnSvc, RPC_CSTR *PrincName);
RPCRTAPI RPC_STATUS RPC_ENTRY
RpcServerInqDefaultPrincNameW(unsigned __LONG32 AuthnSvc, RPC_WSTR *PrincName);
...
RPCRTAPI RPC_STATUS RPC_ENTRY RpcNsBindingInqEntryNameA(
    RPC_BINDING_HANDLE Binding, unsigned __LONG32 EntryNameSyntax,
    RPC_CSTR *EntryName);
...
#define RPC_HTTP_TRANSPORT_CREDENTIALS                                         \
  __MINGW_NAME_UAW(RPC_HTTP_TRANSPORT_CREDENTIALS)
#define PRPC_HTTP_TRANSPORT_CREDENTIALS                                        \
  __MINGW_NAME_UAW(PRPC_HTTP_TRANSPORT_CREDENTIALS)
#define _RPC_HTTP_TRANSPORT_CREDENTIALS                                        \
  __MINGW_NAME_UAW(_RPC_HTTP_TRANSPORT_CREDENTIALS)
...
typedef RPC_STATUS(__RPC_API *RPC_NEW_HTTP_PROXY_CHANNEL)(
    ...
    void *SessionId, void *Interface, void *Reserved, unsigned __LONG32 Flags,
...
RPCRTAPI RPC_STATUS RPC_ENTRY RpcBindingInqAuthClientA(
    RPC_BINDING_HANDLE ClientBinding, RPC_AUTHZ_HANDLE *Privs,
    RPC_CSTR *ServerPrincName, unsigned __LONG32 *AuthnLevel,
    unsigned __LONG32 *AuthnSvc, unsigned __LONG32 *AuthzSvc);
RPCRTAPI RPC_STATUS RPC_ENTRY RpcBindingInqAuthClientW(
    RPC_BINDING_HANDLE ClientBinding, RPC_AUTHZ_HANDLE *Privs,
    RPC_WSTR *ServerPrincName, unsigned __LONG32 *AuthnLevel,
    unsigned __LONG32 *AuthnSvc, unsigned __LONG32 *AuthzSvc);
...
RPCRTAPI RPC_STATUS RPC_ENTRY RpcBindingInqAuthInfoA(
    RPC_BINDING_HANDLE Binding, RPC_CSTR *ServerPrincName,
    unsigned __LONG32 *AuthnLevel, unsigned __LONG32 *AuthnSvc,
    RPC_AUTH_IDENTITY_HANDLE *AuthIdentity, unsigned __LONG32 *AuthzSvc);
RPCRTAPI RPC_STATUS RPC_ENTRY RpcBindingInqAuthInfoW(
    RPC_BINDING_HANDLE Binding, RPC_WSTR *ServerPrincName,
    unsigned __LONG32 *AuthnLevel, unsigned __LONG32 *AuthnSvc,
    RPC_AUTH_IDENTITY_HANDLE *AuthIdentity, unsigned __LONG32 *AuthzSvc);
...
RPCRTAPI RPC_STATUS RPC_ENTRY RpcBindingInqAuthInfoExA(
    ...
    unsigned __LONG32 *AuthnLevel, unsigned __LONG32 *AuthnSvc,
    RPC_AUTH_IDENTITY_HANDLE *AuthIdentity, unsigned __LONG32 *AuthzSvc,
    unsigned __LONG32 RpcQosVersion, RPC_SECURITY_QOS *SecurityQOS);
RPCRTAPI RPC_STATUS RPC_ENTRY RpcBindingInqAuthInfoExW(
    RPC_BINDING_HANDLE Binding, RPC_WSTR *ServerPrincName,
    unsigned __LONG32 *AuthnLevel, unsigned __LONG32 *AuthnSvc,
    RPC_AUTH_IDENTITY_HANDLE *AuthIdentity, unsigned __LONG32 *AuthzSvc,
    unsigned __LONG32 RpcQosVersion, RPC_SECURITY_QOS *SecurityQOS);
typedef void(__RPC_API *RPC_AUTH_KEY_RETRIEVAL_FN)(
    void *Arg, unsigned short *ServerPrincName, unsigned __LONG32 KeyVer,
    void **Key, RPC_STATUS *Status);
RPCRTAPI RPC_STATUS RPC_ENTRY
RpcServerRegisterAuthInfoA(RPC_CSTR ServerPrincName, unsigned __LONG32 AuthnSvc,
                           RPC_AUTH_KEY_RETRIEVAL_FN GetKeyFn, void *Arg);
RPCRTAPI RPC_STATUS RPC_ENTRY
RpcServerRegisterAuthInfoW(RPC_WSTR ServerPrincName, unsigned __LONG32 AuthnSvc,
                           RPC_AUTH_KEY_RETRIEVAL_FN GetKeyFn, void *Arg);
...
RPCRTAPI RPC_STATUS RPC_ENTRY RpcBindingServerFromClient(
    RPC_BINDING_HANDLE ClientBinding, RPC_BINDING_HANDLE *ServerBinding);
...
RPCRTAPI RPC_STATUS RPC_ENTRY
RpcServerTestCancel(RPC_BINDING_HANDLE BindingHandle);
...
RPCRTAPI RPC_STATUS RPC_ENTRY UuidToStringA(const UUID *Uuid,
                                            RPC_CSTR *StringUuid);
RPCRTAPI RPC_STATUS RPC_ENTRY UuidFromStringA(RPC_CSTR StringUuid, UUID *Uuid);
RPCRTAPI RPC_STATUS RPC_ENTRY UuidToStringW(const UUID *Uuid,
                                            RPC_WSTR *StringUuid);
RPCRTAPI RPC_STATUS RPC_ENTRY UuidFromStringW(RPC_WSTR StringUuid, UUID *Uuid);
RPCRTAPI signed int RPC_ENTRY UuidCompare(UUID *Uuid1, UUID *Uuid2,
                                          RPC_STATUS *Status);
...
RPCRTAPI RPC_STATUS RPC_ENTRY RpcEpUnregister(RPC_IF_HANDLE IfSpec,
                                              RPC_BINDING_VECTOR *BindingVector,
                                              UUID_VECTOR *UuidVector);
RPCRTAPI RPC_STATUS RPC_ENTRY DceErrorInqTextA(RPC_STATUS RpcStatus,
                                               RPC_CSTR ErrorText);
RPCRTAPI RPC_STATUS RPC_ENTRY DceErrorInqTextW(RPC_STATUS RpcStatus,
                                               RPC_WSTR ErrorText);
...
RPCRTAPI RPC_STATUS RPC_ENTRY RpcMgmtEpEltInqBegin(
    RPC_BINDING_HANDLE EpBinding, unsigned __LONG32 InquiryType,
    RPC_IF_ID *IfId, unsigned __LONG32 VersOption, UUID *ObjectUuid,
...
RPCRTAPI RPC_STATUS RPC_ENTRY RpcMgmtEpUnregister(RPC_BINDING_HANDLE EpBinding,
                                                  RPC_IF_ID *IfId,
                                                  RPC_BINDING_HANDLE Binding,
                                                  UUID *ObjectUuid);
typedef int(__RPC_API *RPC_MGMT_AUTHORIZATION_FN)(
    RPC_BINDING_HANDLE ClientBinding, unsigned __LONG32 RequestedMgmtOperation,
    RPC_STATUS *Status);
...
RPC_STATUS RPC_ENTRY RpcBindingCreateA(RPC_BINDING_HANDLE_TEMPLATE *Template,
                                       RPC_BINDING_HANDLE_SECURITY *Security,
                                       RPC_BINDING_HANDLE_OPTIONS *Options,
                                       RPC_BINDING_HANDLE *Binding);
RPC_STATUS RPC_ENTRY RpcBindingCreateW(RPC_BINDING_HANDLE_TEMPLATE *Template,
                                       RPC_BINDING_HANDLE_SECURITY *Security,
                                       RPC_BINDING_HANDLE_OPTIONS *Options,
                                       RPC_BINDING_HANDLE *Binding);
