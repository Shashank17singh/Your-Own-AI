...
int ftw(const char *, int (*)(const char *, const struct stat *, int), int)
    __MINGW_ASM_CALL(ftw32i64);
int nftw(const char *,
         int (*)(const char *, const struct stat *, int, struct FTW *), int,
         int) __MINGW_ASM_CALL(nftw32i64);
#else
int ftw(const char *, int (*)(const char *, const struct stat *, int), int)
    __MINGW_ASM_CALL(ftw64);
int nftw(const char *,
         int (*)(const char *, const struct stat *, int, struct FTW *), int,
         int) __MINGW_ASM_CALL(nftw64);
#endif
#else
#ifdef _USE_32BIT_TIME_T
int ftw(const char *, int (*)(const char *, const struct stat *, int), int)
    __MINGW_ASM_CALL(ftw32);
int nftw(const char *,
         int (*)(const char *, const struct stat *, int, struct FTW *), int,
         int) __MINGW_ASM_CALL(nftw32);
#else
int ftw(const char *, int (*)(const char *, const struct stat *, int), int)
    __MINGW_ASM_CALL(ftw64i32);
int nftw(const char *,
         int (*)(const char *, const struct stat *, int, struct FTW *), int,
         int) __MINGW_ASM_CALL(nftw64i32);
#endif
#endif
#endif
