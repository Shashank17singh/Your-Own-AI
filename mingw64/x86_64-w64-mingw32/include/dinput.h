...
typedef WINBOOL(CALLBACK *LPDIENUMDEVICESCALLBACKA)(LPCDIDEVICEINSTANCEA,
                                                    LPVOID);
typedef WINBOOL(CALLBACK *LPDIENUMDEVICESCALLBACKW)(LPCDIDEVICEINSTANCEW,
                                                    LPVOID);
...
#if DIRECTINPUT_VERSION >= 0x0800
typedef WINBOOL(CALLBACK *LPDIENUMDEVICESBYSEMANTICSCBA)(LPCDIDEVICEINSTANCEA,
                                                         LPDIRECTINPUTDEVICE8A,
                                                         DWORD, DWORD, LPVOID);
typedef WINBOOL(CALLBACK *LPDIENUMDEVICESBYSEMANTICSCBW)(LPCDIDEVICEINSTANCEW,
...
typedef WINBOOL(CALLBACK *LPDIENUMDEVICEOBJECTSCALLBACKA)(
    LPCDIDEVICEOBJECTINSTANCEA, LPVOID);
typedef WINBOOL(CALLBACK *LPDIENUMDEVICEOBJECTSCALLBACKW)(
    LPCDIDEVICEOBJECTINSTANCEW, LPVOID);
DECL_WINELIB_TYPE_AW(LPDIENUMDEVICEOBJECTSCALLBACK)
#if DIRECTINPUT_VERSION >= 0x0500
typedef WINBOOL(CALLBACK *LPDIENUMCREATEDEFFECTOBJECTSCALLBACK)(
