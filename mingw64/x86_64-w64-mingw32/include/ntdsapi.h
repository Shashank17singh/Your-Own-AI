...
#define DS_DEFAULT_LOCALE_COMPARE_FLAGS                                        \
  (NORM_IGNORECASE | NORM_IGNOREKANATYPE | NORM_IGNORENONSPACE |               \
...
#define DS_GENERIC_READ                                                        \
  ((STANDARD_RIGHTS_READ) | (ACTRL_DS_LIST) | (ACTRL_DS_READ_PROP) |           \
...
#define DS_GENERIC_ALL                                                         \
  ((STANDARD_RIGHTS_REQUIRED) | (ACTRL_DS_CREATE_CHILD) |                      \
   (ACTRL_DS_DELETE_CHILD) | (ACTRL_DS_DELETE_TREE) | (ACTRL_DS_READ_PROP) |   \
   (ACTRL_DS_WRITE_PROP) | (ACTRL_DS_LIST) | (ACTRL_DS_LIST_OBJECT) |          \
...
#define DsClientMakeSpnForTargetServer                                         \
  __MINGW_NAME_AW(DsClientMakeSpnForTargetServer)
...
NTDSAPI DWORD WINAPI DsBindW(LPCWSTR DomainControllerName,
                             LPCWSTR DnsDomainName, HANDLE *phDS);
NTDSAPI DWORD WINAPI DsBindA(LPCSTR DomainControllerName, LPCSTR DnsDomainName,
                             HANDLE *phDS);
NTDSAPI DWORD WINAPI DsBindWithCredW(LPCWSTR DomainControllerName,
                                     LPCWSTR DnsDomainName,
                                     RPC_AUTH_IDENTITY_HANDLE AuthIdentity,
                                     HANDLE *phDS);
NTDSAPI DWORD WINAPI DsBindWithCredA(LPCSTR DomainControllerName,
                                     LPCSTR DnsDomainName,
                                     RPC_AUTH_IDENTITY_HANDLE AuthIdentity,
                                     HANDLE *phDS);
NTDSAPI DWORD WINAPI DsBindWithSpnW(LPCWSTR DomainControllerName,
                                    LPCWSTR DnsDomainName,
                                    RPC_AUTH_IDENTITY_HANDLE AuthIdentity,
                                    LPCWSTR ServicePrincipalName, HANDLE *phDS);
NTDSAPI DWORD WINAPI DsBindWithSpnA(LPCSTR DomainControllerName,
                                    LPCSTR DnsDomainName,
                                    RPC_AUTH_IDENTITY_HANDLE AuthIdentity,
                                    LPCSTR ServicePrincipalName, HANDLE *phDS);
NTDSAPI_POSTXP DWORD WINAPI
DsBindWithSpnExW(LPCWSTR DomainControllerName, LPCWSTR DnsDomainName,
                 RPC_AUTH_IDENTITY_HANDLE AuthIdentity,
                 LPCWSTR ServicePrincipalName, DWORD BindFlags, HANDLE *phDS);
NTDSAPI_POSTXP DWORD WINAPI
DsBindWithSpnExA(LPCSTR DomainControllerName, LPCSTR DnsDomainName,
                 RPC_AUTH_IDENTITY_HANDLE AuthIdentity,
                 LPCSTR ServicePrincipalName, DWORD BindFlags, HANDLE *phDS);
...
NTDSAPI DWORD WINAPI
DsMakePasswordCredentialsW(LPCWSTR User, LPCWSTR Domain, LPCWSTR Password,
                           RPC_AUTH_IDENTITY_HANDLE *pAuthIdentity);
NTDSAPI DWORD WINAPI
DsMakePasswordCredentialsA(LPCSTR User, LPCSTR Domain, LPCSTR Password,
                           RPC_AUTH_IDENTITY_HANDLE *pAuthIdentity);
NTDSAPI VOID WINAPI
DsFreePasswordCredentials(RPC_AUTH_IDENTITY_HANDLE AuthIdentity);
NTDSAPI DWORD WINAPI DsCrackNamesW(HANDLE hDS, DS_NAME_FLAGS flags,
                                   DS_NAME_FORMAT formatOffered,
                                   DS_NAME_FORMAT formatDesired, DWORD cNames,
                                   const LPCWSTR *rpNames,
                                   PDS_NAME_RESULTW *ppResult);
NTDSAPI DWORD WINAPI DsCrackNamesA(HANDLE hDS, DS_NAME_FLAGS flags,
                                   DS_NAME_FORMAT formatOffered,
                                   DS_NAME_FORMAT formatDesired, DWORD cNames,
...
NTDSAPI DWORD WINAPI DsMakeSpnW(LPCWSTR ServiceClass, LPCWSTR ServiceName,
                                LPCWSTR InstanceName, USHORT InstancePort,
                                LPCWSTR Referrer, DWORD *pcSpnLength,
                                LPWSTR pszSpn);
NTDSAPI DWORD WINAPI DsMakeSpnA(LPCSTR ServiceClass, LPCSTR ServiceName,
                                LPCSTR InstanceName, USHORT InstancePort,
                                LPCSTR Referrer, DWORD *pcSpnLength,
                                LPSTR pszSpn);
NTDSAPI DWORD WINAPI DsGetSpnA(DS_SPN_NAME_TYPE ServiceType,
                               LPCSTR ServiceClass, LPCSTR ServiceName,
                               USHORT InstancePort, USHORT cInstanceNames,
                               LPCSTR *pInstanceNames,
                               const USHORT *pInstancePorts, DWORD *pcSpn,
                               LPSTR **prpszSpn);
NTDSAPI DWORD WINAPI DsGetSpnW(DS_SPN_NAME_TYPE ServiceType,
                               LPCWSTR ServiceClass, LPCWSTR ServiceName,
                               USHORT InstancePort, USHORT cInstanceNames,
...
NTDSAPI DWORD WINAPI DsCrackSpnA(LPCSTR pszSpn, LPDWORD pcServiceClass,
                                 LPSTR ServiceClass, LPDWORD pcServiceName,
                                 LPSTR ServiceName, LPDWORD pcInstanceName,
                                 LPSTR InstanceName, USHORT *pInstancePort);
NTDSAPI DWORD WINAPI DsCrackSpnW(LPCWSTR pszSpn, DWORD *pcServiceClass,
                                 LPWSTR ServiceClass, DWORD *pcServiceName,
                                 LPWSTR ServiceName, DWORD *pcInstanceName,
                                 LPWSTR InstanceName, USHORT *pInstancePort);
NTDSAPI DWORD WINAPI DsWriteAccountSpnA(HANDLE hDS, DS_SPN_WRITE_OP Operation,
                                        LPCSTR pszAccount, DWORD cSpn,
                                        LPCSTR *rpszSpn);
NTDSAPI DWORD WINAPI DsWriteAccountSpnW(HANDLE hDS, DS_SPN_WRITE_OP Operation,
                                        LPCWSTR pszAccount, DWORD cSpn,
                                        LPCWSTR *rpszSpn);
NTDSAPI DWORD WINAPI DsClientMakeSpnForTargetServerW(LPCWSTR ServiceClass,
                                                     LPCWSTR ServiceName,
                                                     DWORD *pcSpnLength,
                                                     LPWSTR pszSpn);
NTDSAPI DWORD WINAPI DsClientMakeSpnForTargetServerA(LPCSTR ServiceClass,
                                                     LPCSTR ServiceName,
                                                     DWORD *pcSpnLength,
                                                     LPSTR pszSpn);
NTDSAPI DWORD WINAPI DsServerRegisterSpnA(DS_SPN_WRITE_OP Operation,
                                          LPCSTR ServiceClass,
                                          LPCSTR UserObjectDN);
NTDSAPI DWORD WINAPI DsServerRegisterSpnW(DS_SPN_WRITE_OP Operation,
                                          LPCWSTR ServiceClass,
                                          LPCWSTR UserObjectDN);
NTDSAPI DWORD WINAPI DsReplicaSyncA(HANDLE hDS, LPCSTR NameContext,
                                    const UUID *pUuidDsaSrc, ULONG Options);
NTDSAPI DWORD WINAPI DsReplicaSyncW(HANDLE hDS, LPCWSTR NameContext,
                                    const UUID *pUuidDsaSrc, ULONG Options);
NTDSAPI DWORD WINAPI DsReplicaAddA(HANDLE hDS, LPCSTR NameContext,
                                   LPCSTR SourceDsaDn, LPCSTR TransportDn,
                                   LPCSTR SourceDsaAddress,
                                   const PSCHEDULE pSchedule, DWORD Options);
NTDSAPI DWORD WINAPI DsReplicaAddW(HANDLE hDS, LPCWSTR NameContext,
                                   LPCWSTR SourceDsaDn, LPCWSTR TransportDn,
                                   LPCWSTR SourceDsaAddress,
                                   const PSCHEDULE pSchedule, DWORD Options);
NTDSAPI DWORD WINAPI DsReplicaDelA(HANDLE hDS, LPCSTR NameContext,
                                   LPCSTR DsaSrc, ULONG Options);
NTDSAPI DWORD WINAPI DsReplicaDelW(HANDLE hDS, LPCWSTR NameContext,
                                   LPCWSTR DsaSrc, ULONG Options);
NTDSAPI DWORD WINAPI DsReplicaModifyA(
    HANDLE hDS, LPCSTR NameContext, const UUID *pUuidSourceDsa,
    LPCSTR TransportDn, LPCSTR SourceDsaAddress, const PSCHEDULE pSchedule,
    DWORD ReplicaFlags, DWORD ModifyFields, DWORD Options);
NTDSAPI DWORD WINAPI DsReplicaModifyW(
    HANDLE hDS, LPCWSTR NameContext, const UUID *pUuidSourceDsa,
    LPCWSTR TransportDn, LPCWSTR SourceDsaAddress, const PSCHEDULE pSchedule,
    DWORD ReplicaFlags, DWORD ModifyFields, DWORD Options);
NTDSAPI DWORD WINAPI DsReplicaUpdateRefsA(HANDLE hDS, LPCSTR NameContext,
                                          LPCSTR DsaDest,
...
#define DsListServersForDomainInSite                                           \
  __MINGW_NAME_AW(DsListServersForDomainInSite)
...
DsReplicaSyncAllA(HANDLE hDS, LPCSTR pszNameContext, ULONG ulFlags,
                  WINBOOL(WINAPI *pFnCallBack)(LPVOID, PDS_REPSYNCALL_UPDATEA),
                  LPVOID pCallbackData, PDS_REPSYNCALL_ERRINFOA **pErrors);
NTDSAPI DWORD WINAPI
DsReplicaSyncAllW(HANDLE hDS, LPCWSTR pszNameContext, ULONG ulFlags,
                  WINBOOL(WINAPI *pFnCallBack)(LPVOID, PDS_REPSYNCALL_UPDATEW),
                  LPVOID pCallbackData, PDS_REPSYNCALL_ERRINFOW **pErrors);
NTDSAPI DWORD WINAPI DsRemoveDsServerW(HANDLE hDs, LPWSTR ServerDN,
                                       LPWSTR DomainDN,
                                       WINBOOL *fLastDcInDomain,
                                       WINBOOL fCommit);
NTDSAPI DWORD WINAPI DsRemoveDsServerA(HANDLE hDs, LPSTR ServerDN,
                                       LPSTR DomainDN, WINBOOL *fLastDcInDomain,
                                       WINBOOL fCommit);
...
NTDSAPI DWORD WINAPI DsListServersInSiteA(HANDLE hDs, LPCSTR site,
                                          PDS_NAME_RESULTA *ppServers);
NTDSAPI DWORD WINAPI DsListServersInSiteW(HANDLE hDs, LPCWSTR site,
                                          PDS_NAME_RESULTW *ppServers);
NTDSAPI DWORD WINAPI DsListDomainsInSiteA(HANDLE hDs, LPCSTR site,
                                          PDS_NAME_RESULTA *ppDomains);
NTDSAPI DWORD WINAPI DsListDomainsInSiteW(HANDLE hDs, LPCWSTR site,
                                          PDS_NAME_RESULTW *ppDomains);
NTDSAPI DWORD WINAPI DsListServersForDomainInSiteA(HANDLE hDs, LPCSTR domain,
                                                   LPCSTR site,
                                                   PDS_NAME_RESULTA *ppServers);
NTDSAPI DWORD WINAPI DsListServersForDomainInSiteW(HANDLE hDs, LPCWSTR domain,
                                                   LPCWSTR site,
                                                   PDS_NAME_RESULTW *ppServers);
NTDSAPI DWORD WINAPI DsListInfoForServerA(HANDLE hDs, LPCSTR server,
                                          PDS_NAME_RESULTA *ppInfo);
NTDSAPI DWORD WINAPI DsListInfoForServerW(HANDLE hDs, LPCWSTR server,
...
NTDSAPI_POSTXP DWORD WINAPI DsQuerySitesByCostW(
    HANDLE hDS, LPWSTR pwszFromSite, LPWSTR *rgwszToSites, DWORD cToSites,
    DWORD dwFlags, PDS_SITE_COST_INFO *prgSiteInfo);
NTDSAPI_POSTXP DWORD WINAPI DsQuerySitesByCostA(
    HANDLE hDS, LPSTR pwszFromSite, LPSTR *rgwszToSites, DWORD cToSites,
    DWORD dwFlags, PDS_SITE_COST_INFO *prgSiteInfo);
...
NTDSAPI DWORD WINAPI DsMapSchemaGuidsA(HANDLE hDs, DWORD cGuids, GUID *rGuids,
                                       DS_SCHEMA_GUID_MAPA **ppGuidMap);
NTDSAPI VOID WINAPI DsFreeSchemaGuidMapA(PDS_SCHEMA_GUID_MAPA pGuidMap);
NTDSAPI DWORD WINAPI DsMapSchemaGuidsW(HANDLE hDs, DWORD cGuids, GUID *rGuids,
...
NTDSAPI DWORD WINAPI DsGetDomainControllerInfoA(HANDLE hDs, LPCSTR DomainName,
                                                DWORD InfoLevel, DWORD *pcOut,
                                                VOID **ppInfo);
NTDSAPI DWORD WINAPI DsGetDomainControllerInfoW(HANDLE hDs, LPCWSTR DomainName,
                                                DWORD InfoLevel, DWORD *pcOut,
                                                VOID **ppInfo);
NTDSAPI VOID WINAPI DsFreeDomainControllerInfoA(DWORD InfoLevel, DWORD cInfo,
                                                VOID *pInfo);
NTDSAPI VOID WINAPI DsFreeDomainControllerInfoW(DWORD InfoLevel, DWORD cInfo,
                                                VOID *pInfo);
...
#define PDS_DOMAIN_CONTROLLER_INFO_1                                           \
  __MINGW_NAME_AW(PDS_DOMAIN_CONTROLLER_INFO_1)
#define PDS_DOMAIN_CONTROLLER_INFO_2                                           \
  __MINGW_NAME_AW(PDS_DOMAIN_CONTROLLER_INFO_2)
...
typedef enum { DS_KCC_TASKID_UPDATE_TOPOLOGY = 0 } DS_KCC_TASKID;
...
NTDSAPI DWORD WINAPI DsReplicaConsistencyCheck(HANDLE hDS, DS_KCC_TASKID TaskID,
                                               DWORD dwFlags);
NTDSAPI DWORD WINAPI DsReplicaVerifyObjectsW(HANDLE hDS, LPCWSTR NameContext,
                                             const UUID *pUuidDsaSrc,
                                             ULONG ulOptions);
NTDSAPI DWORD WINAPI DsReplicaVerifyObjectsA(HANDLE hDS, LPCSTR NameContext,
                                             const UUID *pUuidDsaSrc,
                                             ULONG ulOptions);
...
NTDSAPI DWORD WINAPI DsReplicaGetInfoW(HANDLE hDS, DS_REPL_INFO_TYPE InfoType,
                                       LPCWSTR pszObject,
                                       UUID *puuidForSourceDsaObjGuid,
                                       VOID **ppInfo);
NTDSAPI DWORD WINAPI DsReplicaGetInfo2W(
    HANDLE hDS, DS_REPL_INFO_TYPE InfoType, LPCWSTR pszObject,
    UUID *puuidForSourceDsaObjGuid, LPCWSTR pszAttributeName, LPCWSTR pszValue,
    DWORD dwFlags, DWORD dwEnumerationContext, VOID **ppInfo);
...
NTDSAPI DWORD WINAPI DsAddSidHistoryW(HANDLE hDS, DWORD Flags,
                                      LPCWSTR SrcDomain, LPCWSTR SrcPrincipal,
                                      LPCWSTR SrcDomainController,
                                      RPC_AUTH_IDENTITY_HANDLE SrcDomainCreds,
                                      LPCWSTR DstDomain, LPCWSTR DstPrincipal);
NTDSAPI DWORD WINAPI DsAddSidHistoryA(HANDLE hDS, DWORD Flags, LPCSTR SrcDomain,
                                      LPCSTR SrcPrincipal,
                                      LPCSTR SrcDomainController,
                                      RPC_AUTH_IDENTITY_HANDLE SrcDomainCreds,
                                      LPCSTR DstDomain, LPCSTR DstPrincipal);
NTDSAPI DWORD WINAPI DsInheritSecurityIdentityW(HANDLE hDS, DWORD Flags,
                                                LPCWSTR SrcPrincipal,
                                                LPCWSTR DstPrincipal);
NTDSAPI DWORD WINAPI DsInheritSecurityIdentityA(HANDLE hDS, DWORD Flags,
                                                LPCSTR SrcPrincipal,
                                                LPCSTR DstPrincipal);
...
NTDSAPI DWORD WINAPI DsQuoteRdnValueW(DWORD cUnquotedRdnValueLength,
                                      LPCWCH psUnquotedRdnValue,
                                      DWORD *pcQuotedRdnValueLength,
                                      LPWCH psQuotedRdnValue);
NTDSAPI DWORD WINAPI DsQuoteRdnValueA(DWORD cUnquotedRdnValueLength,
                                      LPCCH psUnquotedRdnValue,
                                      DWORD *pcQuotedRdnValueLength,
                                      LPCH psQuotedRdnValue);
NTDSAPI DWORD WINAPI DsUnquoteRdnValueW(DWORD cQuotedRdnValueLength,
                                        LPCWCH psQuotedRdnValue,
                                        DWORD *pcUnquotedRdnValueLength,
                                        LPWCH psUnquotedRdnValue);
NTDSAPI DWORD WINAPI DsUnquoteRdnValueA(DWORD cQuotedRdnValueLength,
                                        LPCCH psQuotedRdnValue,
                                        DWORD *pcUnquotedRdnValueLength,
                                        LPCH psUnquotedRdnValue);
NTDSAPI DWORD WINAPI DsGetRdnW(LPCWCH *ppDN, DWORD *pcDN, LPCWCH *ppKey,
                               DWORD *pcKey, LPCWCH *ppVal, DWORD *pcVal);
NTDSAPI WINBOOL WINAPI DsCrackUnquotedMangledRdnW(LPCWSTR pszRDN, DWORD cchRDN,
                                                  GUID *pGuid,
                                                  DS_MANGLE_FOR *peDsMangleFor);
NTDSAPI WINBOOL WINAPI DsCrackUnquotedMangledRdnA(LPCSTR pszRDN, DWORD cchRDN,
                                                  GUID *pGuid,
                                                  DS_MANGLE_FOR *peDsMangleFor);
NTDSAPI WINBOOL WINAPI DsIsMangledRdnValueW(LPCWSTR pszRdn, DWORD cRdn,
                                            DS_MANGLE_FOR eDsMangleForDesired);
NTDSAPI WINBOOL WINAPI DsIsMangledRdnValueA(LPCSTR pszRdn, DWORD cRdn,
                                            DS_MANGLE_FOR eDsMangleForDesired);
NTDSAPI WINBOOL WINAPI DsIsMangledDnA(LPCSTR pszDn, DS_MANGLE_FOR eDsMangleFor);
NTDSAPI WINBOOL WINAPI DsIsMangledDnW(LPCWSTR pszDn,
