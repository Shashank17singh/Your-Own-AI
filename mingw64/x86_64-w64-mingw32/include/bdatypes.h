...
{ MEDIA_TRANSPORT_PACKET,
  ...
  MEDIA_MPEG2_PSI,
  MEDIA_TRANSPORT_PAYLOAD } MEDIA_SAMPLE_CONTENT;
...
{ DVB_Cable,
  ...
  DVB_Satellite,
  ISDB_Terrestrial,
  ISDB_Satellite } DVBSystemType;
typedef enum BDA_Channel { BDA_UNDEFINED_CHANNEL = -1 } BDA_Channel;
#ifdef __WIDL__
...
{ CategoryNotSet = -1,
  ...
  CategorySuperimpose,
  CategoryData,
  CATEGORY_COUNT } ComponentCategory;
#ifdef __WIDL__
...
{ StatusActive,
  StatusInactive,
  StatusUnavailable } ComponentStatus;
#ifdef __WIDL__
...
{ BDA_UNITIALIZED_MPEG2STREAMTYPE = -1,
  ...
  DOLBY_DIGITAL_PLUS_AUDIO_ATSC = 0x87 } MPEG2StreamType;
typedef enum ATSCComponentTypeFlags { ATSCCT_AC3 = 0x1 } ATSCComponentTypeFlags;
#ifdef __WIDL__
...
{ BDA_SCAN_MOD_16QAM = 0x00000001,
  ...
  BDA_SCAN_MOD_32APSK = 0x20000000 } ScanModulationTypes;
#ifdef __WIDL__
...
{ BDA_SPECTRAL_INVERSION_NOT_SET = -1,
  ...
  BDA_SPECTRAL_INVERSION_MAX } SpectralInversion;
#ifdef __WIDL__
...
{ BDA_POLARISATION_NOT_SET = -1,
  ...
  BDA_POLARISATION_MAX } Polarisation;
#ifdef __WIDL__
...
{ BDA_XMIT_MODE_NOT_SET = -1,
  ...
  BDA_XMIT_MODE_16K,
  BDA_XMIT_MODE_32K,
  BDA_XMIT_MODE_MAX } TransmissionMode;
#ifdef __WIDL__
