...
DECLARE_INTERFACE_(IOPMVideoOutput, IUnknown) {
  ...
  STDMETHOD_(HRESULT, StartInitialization)(
      THIS_ OPM_RANDOM_NUMBER * prnRandomNumber, BYTE * *ppbCertificate,
      ULONG * pulCertificateLength) PURE;
  STDMETHOD_(HRESULT, FinishInitialization)(
      THIS_ const OPM_ENCRYPTED_INITIALIZATION_PARAMETERS *pParameters) PURE;
  STDMETHOD_(HRESULT, GetInformation)(
      THIS_ const OPM_GET_INFO_PARAMETERS *pParameters,
      OPM_REQUESTED_INFORMATION *pRequestedInformation) PURE;
  STDMETHOD_(HRESULT, COPPCompatibleGetInformation)(
      THIS_ const OPM_COPP_COMPATIBLE_GET_INFO_PARAMETERS *pParameters,
      OPM_REQUESTED_INFORMATION *pRequestedInformation) PURE;
  STDMETHOD_(HRESULT,
             Configure)(THIS_ const OPM_CONFIGURE_PARAMETERS *pParameters,
                        ULONG ulAdditionalParametersSize,
                        const BYTE *pbAdditionalParameters) PURE;
  END_INTERFACE
};
#ifdef COBJMACROS
...
#define IOPMVideoOutput_Configure(                                             \
    This, pParameters, ulAdditionalParametersSize, pbAdditionalParameters)     \
  (This)->lpVtbl->Configure(This, pParameters, ulAdditionalParametersSize,     \
                            pbAdditionalParameters)
#define IOPMVideoOutput_COPPCompatibleGetInformation(This, pParameters,        \
                                                     pRequestedInformation)    \
  (This)->lpVtbl->COPPCompatibleGetInformation(This, pParameters,              \
                                               pRequestedInformation)
#define IOPMVideoOutput_FinishInitialization(This, pParameters)                \
  (This)->lpVtbl->FinishInitialization(This, pParameters)
#define IOPMVideoOutput_GetInformation(This, pParameters,                      \
                                       pRequestedInformation)                  \
  (This)->lpVtbl->GetInformation(This, pParameters, pRequestedInformation)
#define IOPMVideoOutput_StartInitialization(                                   \
    This, prnRandomNumber, ppbCertificate, pulCertificateLength)               \
  (This)->lpVtbl->StartInitialization(This, prnRandomNumber, ppbCertificate,   \
...
HRESULT WINAPI OPMGetVideoOutputsFromHMONITOR(
    HMONITOR hMonitor, OPM_VIDEO_OUTPUT_SEMANTICS vos,
    ULONG *pulNumVideoOutputs, IOPMVideoOutput ***pppOPMVideoOutputArray);
HRESULT WINAPI OPMGetVideoOutputsFromIDirect3DDevice9Object(
    IDirect3DDevice9 *pDirect3DDevice9, OPM_VIDEO_OUTPUT_SEMANTICS vos,
    ULONG *pulNumVideoOutputs, IOPMVideoOutput ***pppOPMVideoOutputArray);
