/*** Autogenerated by WIDL 11.5 from include/structuredquerycondition.idl - Do
 * not edit ***/
#ifdef _WIN32
...
DEFINE_GUID(IID_IRichChunk, 0x4fdef69c, 0xdbc9, 0x454e, 0x99, 0x10, 0xb3, 0x4f,
            0x3c, 0x64, 0xb5, 0x10);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("4fdef69c-dbc9-454e-9910-b34f3c64b510")
IRichChunk : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetData(ULONG * pFirstPos, ULONG * pLength,
                                            LPWSTR * ppsz,
                                            PROPVARIANT * pValue) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IRichChunk, 0x4fdef69c, 0xdbc9, 0x454e, 0x99, 0x10, 0xb3, 0x4f,
                0x3c, 0x64, 0xb5, 0x10)
#endif
#else
typedef struct IRichChunkVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IRichChunk *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IRichChunk *This);
  ULONG(STDMETHODCALLTYPE *Release)(IRichChunk *This);
  /*** IRichChunk methods ***/
  HRESULT(STDMETHODCALLTYPE *GetData)(IRichChunk *This, ULONG *pFirstPos,
                                      ULONG *pLength, LPWSTR *ppsz,
                                      PROPVARIANT *pValue);
  END_INTERFACE
} IRichChunkVtbl;
interface IRichChunk { CONST_VTBL IRichChunkVtbl *lpVtbl; };
#ifdef COBJMACROS
...
#else
/*** IUnknown methods ***/
static inline HRESULT IRichChunk_QueryInterface(IRichChunk *This, REFIID riid,
                                                void **ppvObject) {
...
/*** IRichChunk methods ***/
static inline HRESULT IRichChunk_GetData(IRichChunk *This, ULONG *pFirstPos,
                                         ULONG *pLength, LPWSTR *ppsz,
                                         PROPVARIANT *pValue) {
...
#endif
#endif
HRESULT STDMETHODCALLTYPE IRichChunk_RemoteGetData_Proxy(IRichChunk *This,
                                                         ULONG *pFirstPos,
                                                         ULONG *pLength,
                                                         LPWSTR *ppsz,
                                                         PROPVARIANT *pValue);
...
HRESULT CALLBACK IRichChunk_GetData_Proxy(IRichChunk *This, ULONG *pFirstPos,
                                          ULONG *pLength, LPWSTR *ppsz,
                                          PROPVARIANT *pValue);
HRESULT __RPC_STUB IRichChunk_GetData_Stub(IRichChunk *This, ULONG *pFirstPos,
                                           ULONG *pLength, LPWSTR *ppsz,
                                           PROPVARIANT *pValue);
...
DEFINE_GUID(IID_ICondition, 0x0fc988d4, 0xc935, 0x4b97, 0xa9, 0x73, 0x46, 0x28,
            0x2e, 0xa1, 0x75, 0xc8);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("0fc988d4-c935-4b97-a973-46282ea175c8")
ICondition : public IPersistStream {
  virtual HRESULT STDMETHODCALLTYPE GetConditionType(CONDITION_TYPE *
                                                     pNodeType) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetSubConditions(REFIID riid,
                                                     void **ppv) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetComparisonInfo(
      LPWSTR * ppszPropertyName, CONDITION_OPERATION * pcop,
      PROPVARIANT * ppropvar) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetValueType(LPWSTR *
                                                 ppszValueTypeName) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetInputTerms(
      IRichChunk * *ppPropertyTerm, IRichChunk * *ppOperationTerm,
      IRichChunk * *ppValueTerm) = 0;
  virtual HRESULT STDMETHODCALLTYPE Clone(ICondition * *ppc) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ICondition, 0x0fc988d4, 0xc935, 0x4b97, 0xa9, 0x73, 0x46, 0x28,
                0x2e, 0xa1, 0x75, 0xc8)
#endif
#else
typedef struct IConditionVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ICondition *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *Save)(ICondition *This, IStream *pStm,
                                   WINBOOL fClearDirty);
  ...
  HRESULT(STDMETHODCALLTYPE *GetSubConditions)(ICondition *This, REFIID riid,
                                               void **ppv);
...
interface ICondition { CONST_VTBL IConditionVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT ICondition_QueryInterface(ICondition *This, REFIID riid,
                                                void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
static inline HRESULT ICondition_Save(ICondition *This, IStream *pStm,
                                      WINBOOL fClearDirty) {
  return This->lpVtbl->Save(This, pStm, fClearDirty);
}
static inline HRESULT ICondition_GetSizeMax(ICondition *This,
                                            ULARGE_INTEGER *pcbSize) {
  return This->lpVtbl->GetSizeMax(This, pcbSize);
}
/*** ICondition methods ***/
static inline HRESULT ICondition_GetConditionType(ICondition *This,
                                                  CONDITION_TYPE *pNodeType) {
  return This->lpVtbl->GetConditionType(This, pNodeType);
}
static inline HRESULT ICondition_GetSubConditions(ICondition *This, REFIID riid,
                                                  void **ppv) {
  return This->lpVtbl->GetSubConditions(This, riid, ppv);
}
static inline HRESULT ICondition_GetComparisonInfo(ICondition *This,
                                                   LPWSTR *ppszPropertyName,
                                                   CONDITION_OPERATION *pcop,
                                                   PROPVARIANT *ppropvar) {
  return This->lpVtbl->GetComparisonInfo(This, ppszPropertyName, pcop,
                                         ppropvar);
}
static inline HRESULT ICondition_GetValueType(ICondition *This,
                                              LPWSTR *ppszValueTypeName) {
  return This->lpVtbl->GetValueType(This, ppszValueTypeName);
}
static inline HRESULT
ICondition_GetValueNormalization(ICondition *This, LPWSTR *ppszNormalization) {
  return This->lpVtbl->GetValueNormalization(This, ppszNormalization);
}
static inline HRESULT ICondition_GetInputTerms(ICondition *This,
                                               IRichChunk **ppPropertyTerm,
                                               IRichChunk **ppOperationTerm,
                                               IRichChunk **ppValueTerm) {
  return This->lpVtbl->GetInputTerms(This, ppPropertyTerm, ppOperationTerm,
                                     ppValueTerm);
}
...
HRESULT STDMETHODCALLTYPE ICondition_RemoteGetComparisonInfo_Proxy(
    ICondition *This, LPWSTR *ppszPropertyName, CONDITION_OPERATION *pcop,
    PROPVARIANT *ppropvar);
void __RPC_STUB ICondition_RemoteGetComparisonInfo_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage, DWORD *pdwStubPhase);
HRESULT STDMETHODCALLTYPE ICondition_RemoteGetInputTerms_Proxy(
    ICondition *This, IRichChunk **ppPropertyTerm, IRichChunk **ppOperationTerm,
    IRichChunk **ppValueTerm);
void __RPC_STUB ICondition_RemoteGetInputTerms_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *pRpcChannelBuffer,
    PRPC_MESSAGE pRpcMessage, DWORD *pdwStubPhase);
HRESULT CALLBACK ICondition_GetComparisonInfo_Proxy(ICondition *This,
                                                    LPWSTR *ppszPropertyName,
                                                    CONDITION_OPERATION *pcop,
                                                    PROPVARIANT *ppropvar);
HRESULT __RPC_STUB ICondition_GetComparisonInfo_Stub(ICondition *This,
                                                     LPWSTR *ppszPropertyName,
                                                     CONDITION_OPERATION *pcop,
                                                     PROPVARIANT *ppropvar);
HRESULT CALLBACK ICondition_GetInputTerms_Proxy(ICondition *This,
                                                IRichChunk **ppPropertyTerm,
                                                IRichChunk **ppOperationTerm,
                                                IRichChunk **ppValueTerm);
HRESULT __RPC_STUB ICondition_GetInputTerms_Stub(ICondition *This,
                                                 IRichChunk **ppPropertyTerm,
                                                 IRichChunk **ppOperationTerm,
                                                 IRichChunk **ppValueTerm);
...
DEFINE_GUID(IID_ICondition2, 0x0db8851d, 0x2e5b, 0x47eb, 0x92, 0x08, 0xd2, 0x8c,
            0x32, 0x5a, 0x01, 0xd7);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("0db8851d-2e5b-47eb-9208-d28c325a01d7")
ICondition2 : public ICondition {
  virtual HRESULT STDMETHODCALLTYPE GetLocale(LPWSTR * ppszLocaleName) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetLeafConditionInfo(
      PROPERTYKEY * ppropkey, CONDITION_OPERATION * pcop,
      PROPVARIANT * ppropvar) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ICondition2, 0x0db8851d, 0x2e5b, 0x47eb, 0x92, 0x08, 0xd2, 0x8c,
                0x32, 0x5a, 0x01, 0xd7)
#endif
#else
typedef struct ICondition2Vtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ICondition2 *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *Save)(ICondition2 *This, IStream *pStm,
                                   WINBOOL fClearDirty);
  HRESULT(STDMETHODCALLTYPE *GetSizeMax)(ICondition2 *This,
                                         ULARGE_INTEGER *pcbSize);
  /*** ICondition methods ***/
  HRESULT(STDMETHODCALLTYPE *GetConditionType)(ICondition2 *This,
                                               CONDITION_TYPE *pNodeType);
  HRESULT(STDMETHODCALLTYPE *GetSubConditions)(ICondition2 *This, REFIID riid,
                                               void **ppv);
  HRESULT(STDMETHODCALLTYPE *GetComparisonInfo)(ICondition2 *This,
                                                LPWSTR *ppszPropertyName,
                                                CONDITION_OPERATION *pcop,
                                                PROPVARIANT *ppropvar);
  HRESULT(STDMETHODCALLTYPE *GetValueType)(ICondition2 *This,
                                           LPWSTR *ppszValueTypeName);
  HRESULT(STDMETHODCALLTYPE *GetValueNormalization)(ICondition2 *This,
                                                    LPWSTR *ppszNormalization);
  HRESULT(STDMETHODCALLTYPE *GetInputTerms)(ICondition2 *This,
                                            IRichChunk **ppPropertyTerm,
                                            IRichChunk **ppOperationTerm,
                                            IRichChunk **ppValueTerm);
  HRESULT(STDMETHODCALLTYPE *Clone)(ICondition2 *This, ICondition **ppc);
  /*** ICondition2 methods ***/
  HRESULT(STDMETHODCALLTYPE *GetLocale)(ICondition2 *This,
                                        LPWSTR *ppszLocaleName);
  HRESULT(STDMETHODCALLTYPE *GetLeafConditionInfo)(ICondition2 *This,
                                                   PROPERTYKEY *ppropkey,
                                                   CONDITION_OPERATION *pcop,
                                                   PROPVARIANT *ppropvar);
  END_INTERFACE
} ICondition2Vtbl;
interface ICondition2 { CONST_VTBL ICondition2Vtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define ICondition2_GetValueNormalization(This, ppszNormalization)             \
  (This)->lpVtbl->GetValueNormalization(This, ppszNormalization)
#define ICondition2_GetInputTerms(This, ppPropertyTerm, ppOperationTerm,       \
                                  ppValueTerm)                                 \
  (This)->lpVtbl->GetInputTerms(This, ppPropertyTerm, ppOperationTerm,         \
                                ppValueTerm)
...
#else
/*** IUnknown methods ***/
static inline HRESULT ICondition2_QueryInterface(ICondition2 *This, REFIID riid,
                                                 void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IPersist methods ***/
static inline HRESULT ICondition2_GetClassID(ICondition2 *This,
                                             CLSID *pClassID) {
  return This->lpVtbl->GetClassID(This, pClassID);
}
/*** IPersistStream methods ***/
...
static inline HRESULT ICondition2_Save(ICondition2 *This, IStream *pStm,
                                       WINBOOL fClearDirty) {
  return This->lpVtbl->Save(This, pStm, fClearDirty);
}
static inline HRESULT ICondition2_GetSizeMax(ICondition2 *This,
                                             ULARGE_INTEGER *pcbSize) {
  return This->lpVtbl->GetSizeMax(This, pcbSize);
}
/*** ICondition methods ***/
static inline HRESULT ICondition2_GetConditionType(ICondition2 *This,
                                                   CONDITION_TYPE *pNodeType) {
  return This->lpVtbl->GetConditionType(This, pNodeType);
}
static inline HRESULT ICondition2_GetSubConditions(ICondition2 *This,
                                                   REFIID riid, void **ppv) {
  return This->lpVtbl->GetSubConditions(This, riid, ppv);
}
static inline HRESULT ICondition2_GetComparisonInfo(ICondition2 *This,
                                                    LPWSTR *ppszPropertyName,
                                                    CONDITION_OPERATION *pcop,
                                                    PROPVARIANT *ppropvar) {
  return This->lpVtbl->GetComparisonInfo(This, ppszPropertyName, pcop,
...
static inline HRESULT ICondition2_GetValueType(ICondition2 *This,
                                               LPWSTR *ppszValueTypeName) {
  return This->lpVtbl->GetValueType(This, ppszValueTypeName);
}
static inline HRESULT
ICondition2_GetValueNormalization(ICondition2 *This,
                                  LPWSTR *ppszNormalization) {
  return This->lpVtbl->GetValueNormalization(This, ppszNormalization);
}
static inline HRESULT ICondition2_GetInputTerms(ICondition2 *This,
                                                IRichChunk **ppPropertyTerm,
                                                IRichChunk **ppOperationTerm,
                                                IRichChunk **ppValueTerm) {
  return This->lpVtbl->GetInputTerms(This, ppPropertyTerm, ppOperationTerm,
...
/*** ICondition2 methods ***/
static inline HRESULT ICondition2_GetLocale(ICondition2 *This,
                                            LPWSTR *ppszLocaleName) {
  return This->lpVtbl->GetLocale(This, ppszLocaleName);
}
static inline HRESULT
ICondition2_GetLeafConditionInfo(ICondition2 *This, PROPERTYKEY *ppropkey,
                                 CONDITION_OPERATION *pcop,
                                 PROPVARIANT *ppropvar) {
...
HRESULT STDMETHODCALLTYPE ICondition2_RemoteGetLeafConditionInfo_Proxy(
    ICondition2 *This, PROPERTYKEY *ppropkey, CONDITION_OPERATION *pcop,
    PROPVARIANT *ppropvar);
