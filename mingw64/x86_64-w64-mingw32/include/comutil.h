...
inline char *WINAPI ConvertBSTRToString(BSTR pSrc) {
  ...
  if (::WideCharToMultiByte(CP_ACP, 0, pSrc, -1, str, mbSize, NULL, NULL) ==
      0) {
    DWORD err = ::GetLastError();
    delete[] str;
    _com_issue_error(HRESULT_FROM_WIN32(err));
...
inline BSTR _bstr_t::copy(bool fCopy) const {
  return (m_Data != NULL) ? (fCopy ? m_Data->Copy() : m_Data->GetWString())
                          : NULL;
}
...
inline _bstr_t::Data_t::Data_t(const _bstr_t &s1, const _bstr_t &s2)
  ...
  if (wstr1 != NULL) {
    _COM_MEMCPY_S(m_wstr, (l1 + l2 + 1) * sizeof(wchar_t), wstr1,
                  (l1 + 1) * sizeof(wchar_t));
  }
  const wchar_t *wstr2 = static_cast<const wchar_t *>(s2);
  if (wstr2 != NULL) {
    _COM_MEMCPY_S(m_wstr + l1, (l2 + 1) * sizeof(wchar_t), wstr2,
                  (l2 + 1) * sizeof(wchar_t));
  }
}
...
inline unsigned __LONG32 _bstr_t::Data_t::Release() throw() {
  unsigned __LONG32 cRef =
      InterlockedDecrement(reinterpret_cast<LONG *>(&m_RefCount));
  if (cRef == 0)
    delete this;
  return cRef;
}
inline unsigned __LONG32 _bstr_t::Data_t::RefCount() const throw() {
  return m_RefCount;
}
...
inline _variant_t::_variant_t(const _variant_t &varSrc) {
  ::VariantInit(this);
  _com_util::CheckError(::VariantCopy(
...
__MINGW_EXTENSION inline _variant_t::_variant_t(
    unsigned __int64 ui8Src) throw() {
  V_VT(this) = VT_UI8;
  V_UI8(this) = ui8Src;
}
...
inline _variant_t &_variant_t::operator=(const _bstr_t &bstrSrc) {
  _COM_ASSERT(V_VT(this) != VT_BSTR || !((BSTR)bstrSrc) ||
              V_BSTR(this) != (BSTR)bstrSrc);
  Clear();
  V_VT(this) = VT_BSTR;
  if (!bstrSrc) {
    V_BSTR(this) = NULL;
...
inline _variant_t &_variant_t::operator=(const char *pSrc) {
  _COM_ASSERT(V_VT(this) != (VT_I1 | VT_BYREF) || !pSrc ||
              V_I1REF(this) != pSrc);
  Clear();
  V_VT(this) = VT_BSTR;
  V_BSTR(this) = _com_util::ConvertStringToBSTR(pSrc);
...
inline _variant_t &_variant_t::operator=(IDispatch *pSrc) {
  _COM_ASSERT(V_VT(this) != VT_DISPATCH || pSrc == 0 ||
              V_DISPATCH(this) != pSrc);
  Clear();
  V_VT(this) = VT_DISPATCH;
  V_DISPATCH(this) = pSrc;
...
__MINGW_EXTENSION inline _variant_t &
...
inline bool _variant_t::operator==(const VARIANT *pSrc) const throw() {
  ...
  case VT_BSTR:
    return (::SysStringByteLen(V_BSTR(this)) ==
            ::SysStringByteLen(V_BSTR(pSrc))) &&
           (memcmp(V_BSTR(this), V_BSTR(pSrc),
...
inline void _variant_t::Clear() { _com_util::CheckError(::VariantClear(this)); }
...
inline VARIANT &_variant_t::GetVARIANT() throw() { return *(VARIANT *)this; }
...
inline void _variant_t::ChangeType(VARTYPE vartype, const _variant_t *pSrc) {
  ...
  if ((this != pSrc) || (vartype != V_VT(this))) {
    _com_util::CheckError(::VariantChangeType(
        static_cast<VARIANT *>(this),
        const_cast<VARIANT *>(static_cast<const VARIANT *>(pSrc)), 0, vartype));
  }
}
...
/* We use _com_issue_error here, but we only provide its inline version in
 * comdef.h, so we need to make sure that it's included as well. */
#include <comdef.h>
#endif /* __cplusplus */
#endif
