...
WINOLEAUTAPI SafeArrayAllocDescriptorEx(VARTYPE vt, UINT cDims,
                                        SAFEARRAY **ppsaOut);
...
WINOLEAUTAPI_(SAFEARRAY *)
SafeArrayCreateEx(VARTYPE vt, UINT cDims, SAFEARRAYBOUND *rgsabound,
                  PVOID pvExtra);
...
WINOLEAUTAPI SafeArrayPtrOfIndex(SAFEARRAY *psa, LONG *rgIndices,
                                 void **ppvData);
...
WINOLEAUTAPI_(SAFEARRAY *)
SafeArrayCreateVectorEx(VARTYPE vt, LONG lLbound, ULONG cElements,
                        PVOID pvExtra);
...
WINOLEAUTAPI VariantChangeType(VARIANTARG *pvargDest, VARIANTARG *pvarSrc,
                               USHORT wFlags, VARTYPE vt);
WINOLEAUTAPI VariantChangeTypeEx(VARIANTARG *pvargDest, VARIANTARG *pvarSrc,
...
WINOLEAUTAPI VarUI1FromStr(LPCOLESTR strIn, LCID lcid, ULONG dwFlags,
                           BYTE *pbOut);
...
WINOLEAUTAPI VarI2FromStr(LPCOLESTR strIn, LCID lcid, ULONG dwFlags,
                          SHORT *psOut);
...
WINOLEAUTAPI VarI4FromStr(LPCOLESTR strIn, LCID lcid, ULONG dwFlags,
                          LONG *plOut);
...
WINOLEAUTAPI VarI8FromStr(LPCOLESTR strIn, LCID lcid, unsigned __LONG32 dwFlags,
                          LONG64 *pi64Out);
...
WINOLEAUTAPI VarR4FromStr(LPCOLESTR strIn, LCID lcid, ULONG dwFlags,
                          FLOAT *pfltOut);
...
WINOLEAUTAPI VarR8FromStr(LPCOLESTR strIn, LCID lcid, ULONG dwFlags,
                          DOUBLE *pdblOut);
...
WINOLEAUTAPI VarDateFromStr(LPCOLESTR strIn, LCID lcid, ULONG dwFlags,
                            DATE *pdateOut);
...
WINOLEAUTAPI VarCyFromStr(LPCOLESTR strIn, LCID lcid, ULONG dwFlags,
                          CY *pcyOut);
...
WINOLEAUTAPI VarBstrFromUI1(BYTE bVal, LCID lcid, ULONG dwFlags,
                            BSTR *pbstrOut);
WINOLEAUTAPI VarBstrFromI2(SHORT iVal, LCID lcid, ULONG dwFlags,
                           BSTR *pbstrOut);
WINOLEAUTAPI VarBstrFromI4(LONG lIn, LCID lcid, ULONG dwFlags, BSTR *pbstrOut);
WINOLEAUTAPI VarBstrFromI8(LONG64 i64In, LCID lcid, unsigned __LONG32 dwFlags,
                           BSTR *pbstrOut);
WINOLEAUTAPI VarBstrFromR4(FLOAT fltIn, LCID lcid, ULONG dwFlags,
                           BSTR *pbstrOut);
WINOLEAUTAPI VarBstrFromR8(DOUBLE dblIn, LCID lcid, ULONG dwFlags,
                           BSTR *pbstrOut);
WINOLEAUTAPI VarBstrFromCy(CY cyIn, LCID lcid, ULONG dwFlags, BSTR *pbstrOut);
WINOLEAUTAPI VarBstrFromDate(DATE dateIn, LCID lcid, ULONG dwFlags,
                             BSTR *pbstrOut);
WINOLEAUTAPI VarBstrFromDisp(IDispatch *pdispIn, LCID lcid, ULONG dwFlags,
                             BSTR *pbstrOut);
WINOLEAUTAPI VarBstrFromBool(VARIANT_BOOL boolIn, LCID lcid, ULONG dwFlags,
                             BSTR *pbstrOut);
WINOLEAUTAPI VarBstrFromI1(CHAR cIn, LCID lcid, ULONG dwFlags, BSTR *pbstrOut);
WINOLEAUTAPI VarBstrFromUI2(USHORT uiIn, LCID lcid, ULONG dwFlags,
                            BSTR *pbstrOut);
WINOLEAUTAPI VarBstrFromUI4(ULONG ulIn, LCID lcid, ULONG dwFlags,
                            BSTR *pbstrOut);
WINOLEAUTAPI VarBstrFromUI8(ULONG64 ui64In, LCID lcid,
                            unsigned __LONG32 dwFlags, BSTR *pbstrOut);
WINOLEAUTAPI VarBstrFromDec(DECIMAL *pdecIn, LCID lcid, ULONG dwFlags,
                            BSTR *pbstrOut);
...
WINOLEAUTAPI VarBoolFromStr(LPCOLESTR strIn, LCID lcid, ULONG dwFlags,
                            VARIANT_BOOL *pboolOut);
WINOLEAUTAPI VarBoolFromDisp(IDispatch *pdispIn, LCID lcid,
                             VARIANT_BOOL *pboolOut);
...
WINOLEAUTAPI VarI1FromStr(LPCOLESTR strIn, LCID lcid, ULONG dwFlags,
                          CHAR *pcOut);
...
WINOLEAUTAPI VarUI2FromStr(LPCOLESTR strIn, LCID lcid, ULONG dwFlags,
                           USHORT *puiOut);
...
WINOLEAUTAPI VarUI4FromStr(LPCOLESTR strIn, LCID lcid, ULONG dwFlags,
                           ULONG *pulOut);
...
WINOLEAUTAPI VarUI8FromStr(LPCOLESTR strIn, LCID lcid,
                           unsigned __LONG32 dwFlags, ULONG64 *pi64Out);
...
WINOLEAUTAPI VarDecFromStr(LPCOLESTR strIn, LCID lcid, ULONG dwFlags,
                           DECIMAL *pdecOut);
...
WINOLEAUTAPI VarParseNumFromStr(LPCOLESTR strIn, LCID lcid, ULONG dwFlags,
                                NUMPARSE *pnumprs, BYTE *rgbDig);
WINOLEAUTAPI VarNumFromParseNum(NUMPARSE *pnumprs, BYTE *rgbDig, ULONG dwVtBits,
                                VARIANT *pvar);
...
#ifdef __cplusplus
extern "C++" {
static __inline HRESULT WINAPI VarCmp(LPVARIANT pvarLeft, LPVARIANT pvarRight,
                                      LCID lcid) {
...
WINOLEAUTAPI VarDateFromUdateEx(UDATE *pudateIn, LCID lcid, ULONG dwFlags,
                                DATE *pdateOut);
...
WINOLEAUTAPI VarFormat(LPVARIANT pvarIn, LPOLESTR pstrFormat, int iFirstDay,
                       int iFirstWeek, ULONG dwFlags, BSTR *pbstrOut);
WINOLEAUTAPI VarFormatDateTime(LPVARIANT pvarIn, int iNamedFormat,
                               ULONG dwFlags, BSTR *pbstrOut);
WINOLEAUTAPI VarFormatNumber(LPVARIANT pvarIn, int iNumDig, int iIncLead,
                             int iUseParens, int iGroup, ULONG dwFlags,
                             BSTR *pbstrOut);
WINOLEAUTAPI VarFormatPercent(LPVARIANT pvarIn, int iNumDig, int iIncLead,
                              int iUseParens, int iGroup, ULONG dwFlags,
                              BSTR *pbstrOut);
WINOLEAUTAPI VarFormatCurrency(LPVARIANT pvarIn, int iNumDig, int iIncLead,
                               int iUseParens, int iGroup, ULONG dwFlags,
                               BSTR *pbstrOut);
WINOLEAUTAPI VarWeekdayName(int iWeekday, int fAbbrev, int iFirstDay,
                            ULONG dwFlags, BSTR *pbstrOut);
WINOLEAUTAPI VarMonthName(int iMonth, int fAbbrev, ULONG dwFlags,
                          BSTR *pbstrOut);
WINOLEAUTAPI VarFormatFromTokens(LPVARIANT pvarIn, LPOLESTR pstrFormat,
                                 LPBYTE pbTokCur, ULONG dwFlags, BSTR *pbstrOut,
                                 LCID lcid);
WINOLEAUTAPI VarTokenizeFormatString(LPOLESTR pstrFormat, LPBYTE rgbTok,
...
#endif
WINOLEAUTAPI_(ULONG)
LHashValOfNameSysA(SYSKIND syskind, LCID lcid, LPCSTR szName);
WINOLEAUTAPI_(ULONG)
...
#define IsHashValCompatible(lhashval1, lhashval2)                              \
  ((WINBOOL)((0x00ff0000 & (lhashval1)) == (0x00ff0000 & (lhashval2))))
...
WINOLEAUTAPI RegisterTypeLib(ITypeLib *ptlib, LPCOLESTR szFullPath,
                             LPCOLESTR szHelpDir);
WINOLEAUTAPI UnRegisterTypeLib(REFGUID libID, WORD wVerMajor, WORD wVerMinor,
...
WINOLEAUTAPI GetRecordInfoFromGuids(REFGUID rGuidTypeLib, ULONG uVerMajor,
                                    ULONG uVerMinor, LCID lcid,
