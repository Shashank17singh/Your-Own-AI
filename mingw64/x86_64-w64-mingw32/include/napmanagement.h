...
DEFINE_GUID(IID_INapClientManagement, 0x432a1da5, 0x3888, 0x4b9a, 0xa7, 0x34,
            0xcf, 0xf1, 0xe4, 0x48, 0xc5, 0xb9);
...
INapClientManagement : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetNapClientInfo(
      WINBOOL * isNapEnabled, CountedString * *clientName,
      CountedString * *clientDescription, CountedString * *protocolVersion) = 0;
...
__CRT_UUID_DECL(INapClientManagement, 0x432a1da5, 0x3888, 0x4b9a, 0xa7, 0x34,
                0xcf, 0xf1, 0xe4, 0x48, 0xc5, 0xb9)
#endif
#else
typedef struct INapClientManagementVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INapClientManagement *This,
  ...
  HRESULT(STDMETHODCALLTYPE *GetNapClientInfo)(
      INapClientManagement *This, WINBOOL *isNapEnabled,
      CountedString **clientName, CountedString **clientDescription,
  ...
  HRESULT(STDMETHODCALLTYPE *RegisterSystemHealthAgent)(
      INapClientManagement *This, const NapComponentRegistrationInfo *agent);
  HRESULT(STDMETHODCALLTYPE *UnregisterSystemHealthAgent)(
      INapClientManagement *This, SystemHealthEntityId id);
  HRESULT(STDMETHODCALLTYPE *RegisterEnforcementClient)(
      INapClientManagement *This, const NapComponentRegistrationInfo *enforcer);
  HRESULT(STDMETHODCALLTYPE *UnregisterEnforcementClient)(
      INapClientManagement *This, EnforcementEntityId id);
  HRESULT(STDMETHODCALLTYPE *GetRegisteredSystemHealthAgents)(
      INapClientManagement *This, SystemHealthEntityCount *count,
      NapComponentRegistrationInfo **agents);
  HRESULT(STDMETHODCALLTYPE *GetRegisteredEnforcementClients)(
      INapClientManagement *This, EnforcementEntityCount *count,
      NapComponentRegistrationInfo **enforcers);
  END_INTERFACE
} INapClientManagementVtbl;
interface INapClientManagement { CONST_VTBL INapClientManagementVtbl *lpVtbl; };
#ifdef COBJMACROS
...
/*** INapClientManagement methods ***/
#define INapClientManagement_GetNapClientInfo(                                 \
    This, isNapEnabled, clientName, clientDescription, protocolVersion)        \
  (This)->lpVtbl->GetNapClientInfo(This, isNapEnabled, clientName,             \
                                   clientDescription, protocolVersion)
#define INapClientManagement_GetSystemIsolationInfo(This, isolationInfo,       \
                                                    unknownConnections)        \
...
#define INapClientManagement_GetRegisteredSystemHealthAgents(This, count,      \
                                                             agents)           \
  (This)->lpVtbl->GetRegisteredSystemHealthAgents(This, count, agents)
#define INapClientManagement_GetRegisteredEnforcementClients(This, count,      \
                                                             enforcers)        \
  (This)->lpVtbl->GetRegisteredEnforcementClients(This, count, enforcers)
#else
/*** IUnknown methods ***/
static inline HRESULT
INapClientManagement_QueryInterface(INapClientManagement *This, REFIID riid,
                                    void **ppvObject) {
...
/*** INapClientManagement methods ***/
static inline HRESULT INapClientManagement_GetNapClientInfo(
    INapClientManagement *This, WINBOOL *isNapEnabled,
    CountedString **clientName, CountedString **clientDescription,
    CountedString **protocolVersion) {
  return This->lpVtbl->GetNapClientInfo(This, isNapEnabled, clientName,
                                        clientDescription, protocolVersion);
}
static inline HRESULT
INapClientManagement_GetSystemIsolationInfo(INapClientManagement *This,
                                            IsolationInfo **isolationInfo,
                                            WINBOOL *unknownConnections) {
  return This->lpVtbl->GetSystemIsolationInfo(This, isolationInfo,
                                              unknownConnections);
}
static inline HRESULT INapClientManagement_RegisterSystemHealthAgent(
    INapClientManagement *This, const NapComponentRegistrationInfo *agent) {
  return This->lpVtbl->RegisterSystemHealthAgent(This, agent);
}
static inline HRESULT
INapClientManagement_UnregisterSystemHealthAgent(INapClientManagement *This,
                                                 SystemHealthEntityId id) {
  return This->lpVtbl->UnregisterSystemHealthAgent(This, id);
}
static inline HRESULT INapClientManagement_RegisterEnforcementClient(
    INapClientManagement *This, const NapComponentRegistrationInfo *enforcer) {
  return This->lpVtbl->RegisterEnforcementClient(This, enforcer);
}
static inline HRESULT
INapClientManagement_UnregisterEnforcementClient(INapClientManagement *This,
                                                 EnforcementEntityId id) {
  return This->lpVtbl->UnregisterEnforcementClient(This, id);
}
static inline HRESULT INapClientManagement_GetRegisteredSystemHealthAgents(
    INapClientManagement *This, SystemHealthEntityCount *count,
    NapComponentRegistrationInfo **agents) {
  return This->lpVtbl->GetRegisteredSystemHealthAgents(This, count, agents);
}
static inline HRESULT INapClientManagement_GetRegisteredEnforcementClients(
    INapClientManagement *This, EnforcementEntityCount *count,
    NapComponentRegistrationInfo **enforcers) {
...
DEFINE_GUID(IID_INapClientManagement2, 0x07a1127b, 0x18cc, 0x422a, 0xb9, 0x88,
            0xe8, 0x92, 0x60, 0x0f, 0xcc, 0x74);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(INapClientManagement2, 0x07a1127b, 0x18cc, 0x422a, 0xb9, 0x88,
                0xe8, 0x92, 0x60, 0x0f, 0xcc, 0x74)
#endif
#else
typedef struct INapClientManagement2Vtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *GetSystemIsolationInfo)(
      ...
      WINBOOL *unknownConnections);
  HRESULT(STDMETHODCALLTYPE *RegisterSystemHealthAgent)(
      INapClientManagement2 *This, const NapComponentRegistrationInfo *agent);
  HRESULT(STDMETHODCALLTYPE *UnregisterSystemHealthAgent)(
  ...
  HRESULT(STDMETHODCALLTYPE *UnregisterEnforcementClient)(
      INapClientManagement2 *This, EnforcementEntityId id);
  HRESULT(STDMETHODCALLTYPE *GetRegisteredSystemHealthAgents)(
      INapClientManagement2 *This, SystemHealthEntityCount *count,
      NapComponentRegistrationInfo **agents);
  HRESULT(STDMETHODCALLTYPE *GetRegisteredEnforcementClients)(
      INapClientManagement2 *This, EnforcementEntityCount *count,
      NapComponentRegistrationInfo **enforcers);
  /*** INapClientManagement2 methods ***/
  HRESULT(STDMETHODCALLTYPE *GetSystemIsolationInfoEx)(
      INapClientManagement2 *This, IsolationInfoEx **isolationInfo,
      WINBOOL *unknownConnections);
  END_INTERFACE
...
/*** INapClientManagement methods ***/
#define INapClientManagement2_GetNapClientInfo(                                \
    This, isNapEnabled, clientName, clientDescription, protocolVersion)        \
  (This)->lpVtbl->GetNapClientInfo(This, isNapEnabled, clientName,             \
                                   clientDescription, protocolVersion)
#define INapClientManagement2_GetSystemIsolationInfo(This, isolationInfo,      \
                                                     unknownConnections)       \
  (This)->lpVtbl->GetSystemIsolationInfo(This, isolationInfo,                  \
                                         unknownConnections)
...
#define INapClientManagement2_UnregisterEnforcementClient(This, id)            \
  (This)->lpVtbl->UnregisterEnforcementClient(This, id)
#define INapClientManagement2_GetRegisteredSystemHealthAgents(This, count,     \
                                                              agents)          \
  (This)->lpVtbl->GetRegisteredSystemHealthAgents(This, count, agents)
#define INapClientManagement2_GetRegisteredEnforcementClients(This, count,     \
                                                              enforcers)       \
  (This)->lpVtbl->GetRegisteredEnforcementClients(This, count, enforcers)
/*** INapClientManagement2 methods ***/
#define INapClientManagement2_GetSystemIsolationInfoEx(This, isolationInfo,    \
                                                       unknownConnections)     \
...
/*** IUnknown methods ***/
static inline HRESULT
INapClientManagement2_QueryInterface(INapClientManagement2 *This, REFIID riid,
                                     void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** INapClientManagement methods ***/
static inline HRESULT INapClientManagement2_GetNapClientInfo(
    INapClientManagement2 *This, WINBOOL *isNapEnabled,
    CountedString **clientName, CountedString **clientDescription,
    CountedString **protocolVersion) {
  return This->lpVtbl->GetNapClientInfo(This, isNapEnabled, clientName,
...
static inline HRESULT
INapClientManagement2_GetSystemIsolationInfo(INapClientManagement2 *This,
                                             IsolationInfo **isolationInfo,
                                             WINBOOL *unknownConnections) {
  return This->lpVtbl->GetSystemIsolationInfo(This, isolationInfo,
                                              unknownConnections);
}
static inline HRESULT INapClientManagement2_RegisterSystemHealthAgent(
    INapClientManagement2 *This, const NapComponentRegistrationInfo *agent) {
  return This->lpVtbl->RegisterSystemHealthAgent(This, agent);
}
static inline HRESULT
INapClientManagement2_UnregisterSystemHealthAgent(INapClientManagement2 *This,
                                                  SystemHealthEntityId id) {
  return This->lpVtbl->UnregisterSystemHealthAgent(This, id);
}
static inline HRESULT INapClientManagement2_RegisterEnforcementClient(
    INapClientManagement2 *This, const NapComponentRegistrationInfo *enforcer) {
  return This->lpVtbl->RegisterEnforcementClient(This, enforcer);
}
static inline HRESULT
INapClientManagement2_UnregisterEnforcementClient(INapClientManagement2 *This,
                                                  EnforcementEntityId id) {
  return This->lpVtbl->UnregisterEnforcementClient(This, id);
}
...
static inline HRESULT INapClientManagement2_GetRegisteredEnforcementClients(
    INapClientManagement2 *This, EnforcementEntityCount *count,
    NapComponentRegistrationInfo **enforcers) {
  return This->lpVtbl->GetRegisteredEnforcementClients(This, count, enforcers);
}
/*** INapClientManagement2 methods ***/
static inline HRESULT
INapClientManagement2_GetSystemIsolationInfoEx(INapClientManagement2 *This,
