...
STDAPI HlinkCreateFromMoniker(IMoniker *pimkTrgt, LPCWSTR pwzLocation,
                              LPCWSTR pwzFriendlyName, IHlinkSite *pihlsite,
                              DWORD dwSiteData, IUnknown *piunkOuter,
                              REFIID riid, void **ppvObj);
STDAPI HlinkCreateFromString(LPCWSTR pwzTarget, LPCWSTR pwzLocation,
                             LPCWSTR pwzFriendlyName, IHlinkSite *pihlsite,
                             DWORD dwSiteData, IUnknown *piunkOuter,
                             REFIID riid, void **ppvObj);
STDAPI HlinkCreateFromData(IDataObject *piDataObj, IHlinkSite *pihlsite,
                           DWORD dwSiteData, IUnknown *piunkOuter, REFIID riid,
                           void **ppvObj);
STDAPI HlinkQueryCreateFromData(IDataObject *piDataObj);
STDAPI HlinkClone(IHlink *pihl, REFIID riid, IHlinkSite *pihlsiteForClone,
                  DWORD dwSiteData, void **ppvObj);
STDAPI HlinkCreateBrowseContext(IUnknown *piunkOuter, REFIID riid,
                                void **ppvObj);
STDAPI HlinkNavigateToStringReference(LPCWSTR pwzTarget, LPCWSTR pwzLocation,
                                      IHlinkSite *pihlsite, DWORD dwSiteData,
                                      IHlinkFrame *pihlframe, DWORD grfHLNF,
                                      LPBC pibc, IBindStatusCallback *pibsc,
                                      IHlinkBrowseContext *pihlbc);
STDAPI HlinkNavigate(IHlink *pihl, IHlinkFrame *pihlframe, DWORD grfHLNF,
                     LPBC pbc, IBindStatusCallback *pibsc,
                     IHlinkBrowseContext *pihlbc);
STDAPI HlinkOnNavigate(IHlinkFrame *pihlframe, IHlinkBrowseContext *pihlbc,
                       DWORD grfHLNF, IMoniker *pimkTarget, LPCWSTR pwzLocation,
                       LPCWSTR pwzFriendlyName, ULONG *puHLID);
STDAPI HlinkUpdateStackItem(IHlinkFrame *pihlframe, IHlinkBrowseContext *pihlbc,
                            ULONG uHLID, IMoniker *pimkTrgt,
                            LPCWSTR pwzLocation, LPCWSTR pwzFriendlyName);
STDAPI HlinkOnRenameDocument(DWORD dwReserved, IHlinkBrowseContext *pihlbc,
                             IMoniker *pimkOld, IMoniker *pimkNew);
STDAPI HlinkResolveMonikerForData(LPMONIKER pimkReference, DWORD reserved,
                                  LPBC pibc, ULONG cFmtetc, FORMATETC *rgFmtetc,
                                  IBindStatusCallback *pibsc,
                                  LPMONIKER pimkBase);
STDAPI HlinkResolveStringForData(LPCWSTR pwzReference, DWORD reserved,
                                 LPBC pibc, ULONG cFmtetc, FORMATETC *rgFmtetc,
                                 IBindStatusCallback *pibsc,
                                 LPMONIKER pimkBase);
STDAPI HlinkParseDisplayName(LPBC pibc, LPCWSTR pwzDisplayName,
                             WINBOOL fNoForceAbs, ULONG *pcchEaten,
                             IMoniker **ppimk);
STDAPI HlinkCreateExtensionServices(LPCWSTR pwzAdditionalHeaders, HWND phwnd,
                                    LPCWSTR pszUsername, LPCWSTR pszPassword,
                                    IUnknown *piunkOuter, REFIID riid,
                                    void **ppvObj);
...
STDAPI HlinkCreateShortcut(DWORD grfHLSHORTCUTF, IHlink *pihl, LPCWSTR pwzDir,
                           LPCWSTR pwzFileName, LPWSTR *ppwzShortcutFile,
                           DWORD dwReserved);
STDAPI HlinkCreateShortcutFromMoniker(DWORD grfHLSHORTCUTF,
                                      IMoniker *pimkTarget, LPCWSTR pwzLocation,
                                      LPCWSTR pwzDir, LPCWSTR pwzFileName,
                                      LPWSTR *ppwzShortcutFile,
                                      DWORD dwReserved);
STDAPI HlinkCreateShortcutFromString(DWORD grfHLSHORTCUTF, LPCWSTR pwzTarget,
                                     LPCWSTR pwzLocation, LPCWSTR pwzDir,
                                     LPCWSTR pwzFileName,
                                     LPWSTR *ppwzShortcutFile,
                                     DWORD dwReserved);
STDAPI HlinkResolveShortcut(LPCWSTR pwzShortcutFileName, IHlinkSite *pihlsite,
                            DWORD dwSiteData, IUnknown *piunkOuter, REFIID riid,
                            void **ppvObj);
STDAPI HlinkResolveShortcutToMoniker(LPCWSTR pwzShortcutFileName,
                                     IMoniker **ppimkTarget,
                                     LPWSTR *ppwzLocation);
STDAPI HlinkResolveShortcutToString(LPCWSTR pwzShortcutFileName,
                                    LPWSTR *ppwzTarget, LPWSTR *ppwzLocation);
STDAPI HlinkIsShortcut(LPCWSTR pwzFileName);
STDAPI HlinkGetValueFromParams(LPCWSTR pwzParams, LPCWSTR pwzName,
                               LPWSTR *ppwzValue);
typedef enum _HLTRANSLATEF_NOREDEF10 {
  HLTRANSLATEF_DEFAULT = 0,
  HLTRANSLATEF_DONTAPPLYDEFAULTPREFIX = 0x1
} HLTRANSLATEF;
STDAPI HlinkTranslateURL(LPCWSTR pwzURL, DWORD grfFlags,
...
typedef enum __MIDL_IHlink_0004 { HLINKMISC_RELATIVE = 0x1 } HLINKMISC;
...
public:
  virtual HRESULT WINAPI SetHlinkSite(IHlinkSite *pihlSite,
                                      DWORD dwSiteData) = 0;
  virtual HRESULT WINAPI GetHlinkSite(IHlinkSite **ppihlSite,
                                      DWORD *pdwSiteData) = 0;
  virtual HRESULT WINAPI SetMonikerReference(DWORD grfHLSETF,
                                             IMoniker *pimkTarget,
                                             LPCWSTR pwzLocation) = 0;
  virtual HRESULT WINAPI GetMonikerReference(DWORD dwWhichRef,
                                             IMoniker **ppimkTarget,
                                             LPWSTR *ppwzLocation) = 0;
  virtual HRESULT WINAPI SetStringReference(DWORD grfHLSETF, LPCWSTR pwzTarget,
                                            LPCWSTR pwzLocation) = 0;
  virtual HRESULT WINAPI GetStringReference(DWORD dwWhichRef,
                                            LPWSTR *ppwzTarget,
                                            LPWSTR *ppwzLocation) = 0;
  virtual HRESULT WINAPI SetFriendlyName(LPCWSTR pwzFriendlyName) = 0;
  virtual HRESULT WINAPI GetFriendlyName(DWORD grfHLFNAMEF,
  ...
  virtual HRESULT WINAPI Navigate(DWORD grfHLNF, LPBC pibc,
                                  IBindStatusCallback *pibsc,
...
typedef struct IHlinkVtbl {
  ...
  HRESULT(WINAPI *SetHlinkSite)(IHlink *This, IHlinkSite *pihlSite,
                                DWORD dwSiteData);
  HRESULT(WINAPI *GetHlinkSite)(IHlink *This, IHlinkSite **ppihlSite,
                                DWORD *pdwSiteData);
  HRESULT(WINAPI *SetMonikerReference)(IHlink *This, DWORD grfHLSETF,
                                       IMoniker *pimkTarget,
                                       LPCWSTR pwzLocation);
  HRESULT(WINAPI *GetMonikerReference)(IHlink *This, DWORD dwWhichRef,
                                       IMoniker **ppimkTarget,
                                       LPWSTR *ppwzLocation);
  HRESULT(WINAPI *SetStringReference)(IHlink *This, DWORD grfHLSETF,
                                      LPCWSTR pwzTarget, LPCWSTR pwzLocation);
  HRESULT(WINAPI *GetStringReference)(IHlink *This, DWORD dwWhichRef,
                                      LPWSTR *ppwzTarget, LPWSTR *ppwzLocation);
  HRESULT(WINAPI *SetFriendlyName)(IHlink *This, LPCWSTR pwzFriendlyName);
  HRESULT(WINAPI *GetFriendlyName)(IHlink *This, DWORD grfHLFNAMEF,
                                   LPWSTR *ppwzFriendlyName);
  HRESULT(WINAPI *SetTargetFrameName)(IHlink *This, LPCWSTR pwzTargetFrameName);
  HRESULT(WINAPI *GetTargetFrameName)(IHlink *This,
                                      LPWSTR *ppwzTargetFrameName);
  HRESULT(WINAPI *GetMiscStatus)(IHlink *This, DWORD *pdwStatus);
  HRESULT(WINAPI *Navigate)(IHlink *This, DWORD grfHLNF, LPBC pibc,
                            IBindStatusCallback *pibsc,
                            IHlinkBrowseContext *pihlbc);
  HRESULT(WINAPI *SetAdditionalParams)(IHlink *This,
                                       LPCWSTR pwzAdditionalParams);
  HRESULT(WINAPI *GetAdditionalParams)(IHlink *This,
...
#define IHlink_GetMonikerReference(This, dwWhichRef, ppimkTarget,              \
                                   ppwzLocation)                               \
  (This)->lpVtbl->GetMonikerReference(This, dwWhichRef, ppimkTarget,           \
                                      ppwzLocation)
...
#endif
#endif
HRESULT WINAPI IHlink_SetHlinkSite_Proxy(IHlink *This, IHlinkSite *pihlSite,
                                         DWORD dwSiteData);
void __RPC_STUB IHlink_SetHlinkSite_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
HRESULT WINAPI IHlink_GetHlinkSite_Proxy(IHlink *This, IHlinkSite **ppihlSite,
                                         DWORD *pdwSiteData);
void __RPC_STUB IHlink_GetHlinkSite_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
HRESULT WINAPI IHlink_SetMonikerReference_Proxy(IHlink *This, DWORD grfHLSETF,
                                                IMoniker *pimkTarget,
                                                LPCWSTR pwzLocation);
...
HRESULT WINAPI IHlink_GetMonikerReference_Proxy(IHlink *This, DWORD dwWhichRef,
                                                IMoniker **ppimkTarget,
                                                LPWSTR *ppwzLocation);
void __RPC_STUB IHlink_GetMonikerReference_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IHlink_SetStringReference_Proxy(IHlink *This, DWORD grfHLSETF,
                                               LPCWSTR pwzTarget,
                                               LPCWSTR pwzLocation);
void __RPC_STUB IHlink_SetStringReference_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IHlink_GetStringReference_Proxy(IHlink *This, DWORD dwWhichRef,
                                               LPWSTR *ppwzTarget,
                                               LPWSTR *ppwzLocation);
void __RPC_STUB IHlink_GetStringReference_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IHlink_SetFriendlyName_Proxy(IHlink *This,
                                            LPCWSTR pwzFriendlyName);
void __RPC_STUB IHlink_SetFriendlyName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IHlink_GetFriendlyName_Proxy(IHlink *This, DWORD grfHLFNAMEF,
                                            LPWSTR *ppwzFriendlyName);
void __RPC_STUB IHlink_GetFriendlyName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IHlink_SetTargetFrameName_Proxy(IHlink *This,
                                               LPCWSTR pwzTargetFrameName);
void __RPC_STUB IHlink_SetTargetFrameName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IHlink_GetTargetFrameName_Proxy(IHlink *This,
                                               LPWSTR *ppwzTargetFrameName);
void __RPC_STUB IHlink_GetTargetFrameName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IHlink_GetMiscStatus_Proxy(IHlink *This, DWORD *pdwStatus);
void __RPC_STUB IHlink_GetMiscStatus_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI IHlink_Navigate_Proxy(IHlink *This, DWORD grfHLNF, LPBC pibc,
                                     IBindStatusCallback *pibsc,
                                     IHlinkBrowseContext *pihlbc);
void __RPC_STUB IHlink_Navigate_Stub(IRpcStubBuffer *This,
                                     IRpcChannelBuffer *_pRpcChannelBuffer,
                                     PRPC_MESSAGE _pRpcMessage,
                                     DWORD *_pdwStubPhase);
HRESULT WINAPI IHlink_SetAdditionalParams_Proxy(IHlink *This,
                                                LPCWSTR pwzAdditionalParams);
void __RPC_STUB IHlink_SetAdditionalParams_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IHlink_GetAdditionalParams_Proxy(IHlink *This,
                                                LPWSTR *ppwzAdditionalParams);
...
public:
  virtual HRESULT WINAPI QueryService(DWORD dwSiteData, REFGUID guidService,
                                      REFIID riid, IUnknown **ppiunk) = 0;
  virtual HRESULT WINAPI GetMoniker(DWORD dwSiteData, DWORD dwAssign,
                                    DWORD dwWhich, IMoniker **ppimk) = 0;
  virtual HRESULT WINAPI ReadyToNavigate(DWORD dwSiteData,
                                         DWORD dwReserved) = 0;
  virtual HRESULT WINAPI OnNavigationComplete(DWORD dwSiteData,
                                              DWORD dwreserved, HRESULT hrError,
                                              LPCWSTR pwzError) = 0;
};
#else
typedef struct IHlinkSiteVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IHlinkSite *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IHlinkSite *This);
  ULONG(WINAPI *Release)(IHlinkSite *This);
  HRESULT(WINAPI *QueryService)(IHlinkSite *This, DWORD dwSiteData,
                                REFGUID guidService, REFIID riid,
                                IUnknown **ppiunk);
  HRESULT(WINAPI *GetMoniker)(IHlinkSite *This, DWORD dwSiteData,
                              DWORD dwAssign, DWORD dwWhich, IMoniker **ppimk);
  HRESULT(WINAPI *ReadyToNavigate)(IHlinkSite *This, DWORD dwSiteData,
                                   DWORD dwReserved);
  HRESULT(WINAPI *OnNavigationComplete)(IHlinkSite *This, DWORD dwSiteData,
                                        DWORD dwreserved, HRESULT hrError,
                                        LPCWSTR pwzError);
  END_INTERFACE
} IHlinkSiteVtbl;
...
#define IHlinkSite_OnNavigationComplete(This, dwSiteData, dwreserved, hrError, \
                                        pwzError)                              \
  (This)->lpVtbl->OnNavigationComplete(This, dwSiteData, dwreserved, hrError,  \
                                       pwzError)
#endif
#endif
HRESULT WINAPI IHlinkSite_QueryService_Proxy(IHlinkSite *This, DWORD dwSiteData,
                                             REFGUID guidService, REFIID riid,
                                             IUnknown **ppiunk);
void __RPC_STUB IHlinkSite_QueryService_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IHlinkSite_GetMoniker_Proxy(IHlinkSite *This, DWORD dwSiteData,
                                           DWORD dwAssign, DWORD dwWhich,
                                           IMoniker **ppimk);
void __RPC_STUB IHlinkSite_GetMoniker_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IHlinkSite_ReadyToNavigate_Proxy(IHlinkSite *This,
                                                DWORD dwSiteData,
                                                DWORD dwReserved);
void __RPC_STUB IHlinkSite_ReadyToNavigate_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IHlinkSite_OnNavigationComplete_Proxy(IHlinkSite *This,
                                                     DWORD dwSiteData,
                                                     DWORD dwreserved,
                                                     HRESULT hrError,
                                                     LPCWSTR pwzError);
...
public:
  ...
  virtual HRESULT WINAPI GetMoniker(LPCWSTR pwzLocation, DWORD dwAssign,
                                    IMoniker **ppimkLocation) = 0;
  virtual HRESULT WINAPI GetFriendlyName(LPCWSTR pwzLocation,
                                         LPWSTR *ppwzFriendlyName) = 0;
};
#else
typedef struct IHlinkTargetVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IHlinkTarget *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IHlinkTarget *This);
  ULONG(WINAPI *Release)(IHlinkTarget *This);
  HRESULT(WINAPI *SetBrowseContext)(IHlinkTarget *This,
                                    IHlinkBrowseContext *pihlbc);
  HRESULT(WINAPI *GetBrowseContext)(IHlinkTarget *This,
                                    IHlinkBrowseContext **ppihlbc);
  HRESULT(WINAPI *Navigate)(IHlinkTarget *This, DWORD grfHLNF,
                            LPCWSTR pwzJumpLocation);
  HRESULT(WINAPI *GetMoniker)(IHlinkTarget *This, LPCWSTR pwzLocation,
                              DWORD dwAssign, IMoniker **ppimkLocation);
  HRESULT(WINAPI *GetFriendlyName)(IHlinkTarget *This, LPCWSTR pwzLocation,
                                   LPWSTR *ppwzFriendlyName);
  END_INTERFACE
} IHlinkTargetVtbl;
struct IHlinkTarget {
...
#endif
#endif
HRESULT WINAPI IHlinkTarget_SetBrowseContext_Proxy(IHlinkTarget *This,
                                                   IHlinkBrowseContext *pihlbc);
void __RPC_STUB IHlinkTarget_SetBrowseContext_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IHlinkTarget_GetBrowseContext_Proxy(
    IHlinkTarget *This, IHlinkBrowseContext **ppihlbc);
void __RPC_STUB IHlinkTarget_GetBrowseContext_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IHlinkTarget_Navigate_Proxy(IHlinkTarget *This, DWORD grfHLNF,
                                           LPCWSTR pwzJumpLocation);
void __RPC_STUB IHlinkTarget_Navigate_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IHlinkTarget_GetMoniker_Proxy(IHlinkTarget *This,
                                             LPCWSTR pwzLocation,
                                             DWORD dwAssign,
...
void __RPC_STUB IHlinkTarget_GetMoniker_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IHlinkTarget_GetFriendlyName_Proxy(IHlinkTarget *This,
                                                  LPCWSTR pwzLocation,
                                                  LPWSTR *ppwzFriendlyName);
...
public:
  virtual HRESULT WINAPI SetBrowseContext(IHlinkBrowseContext *pihlbc) = 0;
  virtual HRESULT WINAPI GetBrowseContext(IHlinkBrowseContext **ppihlbc) = 0;
  virtual HRESULT WINAPI Navigate(DWORD grfHLNF, LPBC pbc,
                                  IBindStatusCallback *pibsc,
                                  IHlink *pihlNavigate) = 0;
  virtual HRESULT WINAPI OnNavigate(DWORD grfHLNF, IMoniker *pimkTarget,
                                    LPCWSTR pwzLocation,
                                    LPCWSTR pwzFriendlyName,
                                    DWORD dwreserved) = 0;
  virtual HRESULT WINAPI UpdateHlink(ULONG uHLID, IMoniker *pimkTarget,
                                     LPCWSTR pwzLocation,
...
typedef struct IHlinkFrameVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IHlinkFrame *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IHlinkFrame *This);
  ULONG(WINAPI *Release)(IHlinkFrame *This);
  HRESULT(WINAPI *SetBrowseContext)(IHlinkFrame *This,
                                    IHlinkBrowseContext *pihlbc);
  HRESULT(WINAPI *GetBrowseContext)(IHlinkFrame *This,
                                    IHlinkBrowseContext **ppihlbc);
  HRESULT(WINAPI *Navigate)(IHlinkFrame *This, DWORD grfHLNF, LPBC pbc,
                            IBindStatusCallback *pibsc, IHlink *pihlNavigate);
  HRESULT(WINAPI *OnNavigate)(IHlinkFrame *This, DWORD grfHLNF,
                              IMoniker *pimkTarget, LPCWSTR pwzLocation,
                              LPCWSTR pwzFriendlyName, DWORD dwreserved);
  HRESULT(WINAPI *UpdateHlink)(IHlinkFrame *This, ULONG uHLID,
                               IMoniker *pimkTarget, LPCWSTR pwzLocation,
                               LPCWSTR pwzFriendlyName);
  END_INTERFACE
} IHlinkFrameVtbl;
...
#define IHlinkFrame_OnNavigate(This, grfHLNF, pimkTarget, pwzLocation,         \
                               pwzFriendlyName, dwreserved)                    \
  (This)->lpVtbl->OnNavigate(This, grfHLNF, pimkTarget, pwzLocation,           \
                             pwzFriendlyName, dwreserved)
#define IHlinkFrame_UpdateHlink(This, uHLID, pimkTarget, pwzLocation,          \
                                pwzFriendlyName)                               \
  (This)->lpVtbl->UpdateHlink(This, uHLID, pimkTarget, pwzLocation,            \
                              pwzFriendlyName)
#endif
#endif
HRESULT WINAPI IHlinkFrame_SetBrowseContext_Proxy(IHlinkFrame *This,
                                                  IHlinkBrowseContext *pihlbc);
void __RPC_STUB IHlinkFrame_SetBrowseContext_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IHlinkFrame_GetBrowseContext_Proxy(
    IHlinkFrame *This, IHlinkBrowseContext **ppihlbc);
void __RPC_STUB IHlinkFrame_GetBrowseContext_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IHlinkFrame_Navigate_Proxy(IHlinkFrame *This, DWORD grfHLNF,
                                          LPBC pbc, IBindStatusCallback *pibsc,
                                          IHlink *pihlNavigate);
void __RPC_STUB IHlinkFrame_Navigate_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI IHlinkFrame_OnNavigate_Proxy(IHlinkFrame *This, DWORD grfHLNF,
                                            IMoniker *pimkTarget,
                                            LPCWSTR pwzLocation,
                                            LPCWSTR pwzFriendlyName,
                                            DWORD dwreserved);
void __RPC_STUB IHlinkFrame_OnNavigate_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IHlinkFrame_UpdateHlink_Proxy(IHlinkFrame *This, ULONG uHLID,
                                             IMoniker *pimkTarget,
                                             LPCWSTR pwzLocation,
                                             LPCWSTR pwzFriendlyName);
...
public:
  virtual HRESULT WINAPI Next(ULONG celt, HLITEM *rgelt,
...
typedef struct IEnumHLITEMVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IEnumHLITEM *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IEnumHLITEM *This);
  ULONG(WINAPI *Release)(IEnumHLITEM *This);
  HRESULT(WINAPI *Next)(IEnumHLITEM *This, ULONG celt, HLITEM *rgelt,
                        ULONG *pceltFetched);
...
#endif
#endif
HRESULT WINAPI IEnumHLITEM_Next_Proxy(IEnumHLITEM *This, ULONG celt,
                                      HLITEM *rgelt, ULONG *pceltFetched);
void __RPC_STUB IEnumHLITEM_Next_Stub(IRpcStubBuffer *This,
                                      IRpcChannelBuffer *_pRpcChannelBuffer,
                                      PRPC_MESSAGE _pRpcMessage,
                                      DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumHLITEM_Skip_Proxy(IEnumHLITEM *This, ULONG celt);
void __RPC_STUB IEnumHLITEM_Skip_Stub(IRpcStubBuffer *This,
                                      IRpcChannelBuffer *_pRpcChannelBuffer,
                                      PRPC_MESSAGE _pRpcMessage,
                                      DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumHLITEM_Reset_Proxy(IEnumHLITEM *This);
void __RPC_STUB IEnumHLITEM_Reset_Stub(IRpcStubBuffer *This,
                                       IRpcChannelBuffer *_pRpcChannelBuffer,
                                       PRPC_MESSAGE _pRpcMessage,
                                       DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumHLITEM_Clone_Proxy(IEnumHLITEM *This,
                                       IEnumHLITEM **ppienumhlitem);
void __RPC_STUB IEnumHLITEM_Clone_Stub(IRpcStubBuffer *This,
                                       IRpcChannelBuffer *_pRpcChannelBuffer,
                                       PRPC_MESSAGE _pRpcMessage,
                                       DWORD *_pdwStubPhase);
#endif
...
public:
  virtual HRESULT WINAPI Register(DWORD reserved, IUnknown *piunk,
                                  IMoniker *pimk, DWORD *pdwRegister) = 0;
  virtual HRESULT WINAPI GetObject(IMoniker *pimk,
                                   WINBOOL fBindIfRootRegistered,
                                   IUnknown **ppiunk) = 0;
  ...
  virtual HRESULT WINAPI SetInitialHlink(IMoniker *pimkTarget,
                                         LPCWSTR pwzLocation,
                                         LPCWSTR pwzFriendlyName) = 0;
  virtual HRESULT WINAPI OnNavigateHlink(DWORD grfHLNF, IMoniker *pimkTarget,
                                         LPCWSTR pwzLocation,
                                         LPCWSTR pwzFriendlyName,
                                         ULONG *puHLID) = 0;
  virtual HRESULT WINAPI UpdateHlink(ULONG uHLID, IMoniker *pimkTarget,
                                     LPCWSTR pwzLocation,
                                     LPCWSTR pwzFriendlyName) = 0;
  virtual HRESULT WINAPI EnumNavigationStack(DWORD dwReserved,
                                             DWORD grfHLFNAMEF,
  ...
  virtual HRESULT WINAPI Clone(IUnknown *piunkOuter, REFIID riid,
...
typedef struct IHlinkBrowseContextVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IHlinkBrowseContext *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IHlinkBrowseContext *This);
  ULONG(WINAPI *Release)(IHlinkBrowseContext *This);
  HRESULT(WINAPI *Register)(IHlinkBrowseContext *This, DWORD reserved,
                            IUnknown *piunk, IMoniker *pimk,
                            DWORD *pdwRegister);
  HRESULT(WINAPI *GetObject)(IHlinkBrowseContext *This, IMoniker *pimk,
                             WINBOOL fBindIfRootRegistered, IUnknown **ppiunk);
  HRESULT(WINAPI *Revoke)(IHlinkBrowseContext *This, DWORD dwRegister);
  HRESULT(WINAPI *SetBrowseWindowInfo)(IHlinkBrowseContext *This,
                                       HLBWINFO *phlbwi);
  HRESULT(WINAPI *GetBrowseWindowInfo)(IHlinkBrowseContext *This,
                                       HLBWINFO *phlbwi);
  HRESULT(WINAPI *SetInitialHlink)(IHlinkBrowseContext *This,
                                   IMoniker *pimkTarget, LPCWSTR pwzLocation,
                                   LPCWSTR pwzFriendlyName);
  HRESULT(WINAPI *OnNavigateHlink)(IHlinkBrowseContext *This, DWORD grfHLNF,
                                   IMoniker *pimkTarget, LPCWSTR pwzLocation,
                                   LPCWSTR pwzFriendlyName, ULONG *puHLID);
  HRESULT(WINAPI *UpdateHlink)(IHlinkBrowseContext *This, ULONG uHLID,
                               IMoniker *pimkTarget, LPCWSTR pwzLocation,
                               LPCWSTR pwzFriendlyName);
  HRESULT(WINAPI *EnumNavigationStack)(IHlinkBrowseContext *This,
                                       DWORD dwReserved, DWORD grfHLFNAMEF,
                                       IEnumHLITEM **ppienumhlitem);
  HRESULT(WINAPI *QueryHlink)(IHlinkBrowseContext *This, DWORD grfHLQF,
                              ULONG uHLID);
  HRESULT(WINAPI *GetHlink)(IHlinkBrowseContext *This, ULONG uHLID,
                            IHlink **ppihl);
  HRESULT(WINAPI *SetCurrentHlink)(IHlinkBrowseContext *This, ULONG uHLID);
  HRESULT(WINAPI *Clone)(IHlinkBrowseContext *This, IUnknown *piunkOuter,
                         REFIID riid, IUnknown **ppiunkObj);
...
#define IHlinkBrowseContext_GetObject(This, pimk, fBindIfRootRegistered,       \
                                      ppiunk)                                  \
...
#define IHlinkBrowseContext_SetInitialHlink(This, pimkTarget, pwzLocation,     \
                                            pwzFriendlyName)                   \
  (This)->lpVtbl->SetInitialHlink(This, pimkTarget, pwzLocation,               \
                                  pwzFriendlyName)
#define IHlinkBrowseContext_OnNavigateHlink(                                   \
    This, grfHLNF, pimkTarget, pwzLocation, pwzFriendlyName, puHLID)           \
  (This)->lpVtbl->OnNavigateHlink(This, grfHLNF, pimkTarget, pwzLocation,      \
                                  pwzFriendlyName, puHLID)
#define IHlinkBrowseContext_UpdateHlink(This, uHLID, pimkTarget, pwzLocation,  \
                                        pwzFriendlyName)                       \
  (This)->lpVtbl->UpdateHlink(This, uHLID, pimkTarget, pwzLocation,            \
                              pwzFriendlyName)
#define IHlinkBrowseContext_EnumNavigationStack(This, dwReserved, grfHLFNAMEF, \
                                                ppienumhlitem)                 \
  (This)->lpVtbl->EnumNavigationStack(This, dwReserved, grfHLFNAMEF,           \
                                      ppienumhlitem)
...
#endif
#endif
HRESULT WINAPI IHlinkBrowseContext_Register_Proxy(IHlinkBrowseContext *This,
                                                  DWORD reserved,
                                                  IUnknown *piunk,
                                                  IMoniker *pimk,
                                                  DWORD *pdwRegister);
void __RPC_STUB IHlinkBrowseContext_Register_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IHlinkBrowseContext_GetObject_Proxy(
    IHlinkBrowseContext *This, IMoniker *pimk, WINBOOL fBindIfRootRegistered,
    IUnknown **ppiunk);
void __RPC_STUB IHlinkBrowseContext_GetObject_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IHlinkBrowseContext_Revoke_Proxy(IHlinkBrowseContext *This,
                                                DWORD dwRegister);
void __RPC_STUB IHlinkBrowseContext_Revoke_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IHlinkBrowseContext_SetBrowseWindowInfo_Proxy(
    IHlinkBrowseContext *This, HLBWINFO *phlbwi);
void __RPC_STUB IHlinkBrowseContext_SetBrowseWindowInfo_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IHlinkBrowseContext_GetBrowseWindowInfo_Proxy(
    IHlinkBrowseContext *This, HLBWINFO *phlbwi);
void __RPC_STUB IHlinkBrowseContext_GetBrowseWindowInfo_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IHlinkBrowseContext_SetInitialHlink_Proxy(
    IHlinkBrowseContext *This, IMoniker *pimkTarget, LPCWSTR pwzLocation,
    LPCWSTR pwzFriendlyName);
void __RPC_STUB IHlinkBrowseContext_SetInitialHlink_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IHlinkBrowseContext_OnNavigateHlink_Proxy(
    IHlinkBrowseContext *This, DWORD grfHLNF, IMoniker *pimkTarget,
    LPCWSTR pwzLocation, LPCWSTR pwzFriendlyName, ULONG *puHLID);
void __RPC_STUB IHlinkBrowseContext_OnNavigateHlink_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IHlinkBrowseContext_UpdateHlink_Proxy(IHlinkBrowseContext *This,
                                                     ULONG uHLID,
                                                     IMoniker *pimkTarget,
                                                     LPCWSTR pwzLocation,
                                                     LPCWSTR pwzFriendlyName);
void __RPC_STUB IHlinkBrowseContext_UpdateHlink_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IHlinkBrowseContext_EnumNavigationStack_Proxy(
    IHlinkBrowseContext *This, DWORD dwReserved, DWORD grfHLFNAMEF,
    IEnumHLITEM **ppienumhlitem);
void __RPC_STUB IHlinkBrowseContext_EnumNavigationStack_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IHlinkBrowseContext_QueryHlink_Proxy(IHlinkBrowseContext *This,
                                                    DWORD grfHLQF, ULONG uHLID);
void __RPC_STUB IHlinkBrowseContext_QueryHlink_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IHlinkBrowseContext_GetHlink_Proxy(IHlinkBrowseContext *This,
                                                  ULONG uHLID, IHlink **ppihl);
void __RPC_STUB IHlinkBrowseContext_GetHlink_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IHlinkBrowseContext_SetCurrentHlink_Proxy(
    IHlinkBrowseContext *This, ULONG uHLID);
void __RPC_STUB IHlinkBrowseContext_SetCurrentHlink_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IHlinkBrowseContext_Clone_Proxy(IHlinkBrowseContext *This,
                                               IUnknown *piunkOuter,
                                               REFIID riid,
                                               IUnknown **ppiunkObj);
void __RPC_STUB IHlinkBrowseContext_Clone_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IHlinkBrowseContext_Close_Proxy(IHlinkBrowseContext *This,
                                               DWORD reserved);
...
public:
  ...
  virtual HRESULT WINAPI SetAuthenticateData(HWND phwnd, LPCWSTR pwzUsername,
                                             LPCWSTR pwzPassword) = 0;
};
#else
typedef struct IExtensionServicesVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IExtensionServices *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IExtensionServices *This);
  ULONG(WINAPI *Release)(IExtensionServices *This);
  HRESULT(WINAPI *SetAdditionalHeaders)(IExtensionServices *This,
                                        LPCWSTR pwzAdditionalHeaders);
  HRESULT(WINAPI *SetAuthenticateData)(IExtensionServices *This, HWND phwnd,
                                       LPCWSTR pwzUsername,
                                       LPCWSTR pwzPassword);
  END_INTERFACE
...
#define IExtensionServices_SetAuthenticateData(This, phwnd, pwzUsername,       \
                                               pwzPassword)                    \
  (This)->lpVtbl->SetAuthenticateData(This, phwnd, pwzUsername, pwzPassword)
#endif
#endif
HRESULT WINAPI IExtensionServices_SetAdditionalHeaders_Proxy(
    IExtensionServices *This, LPCWSTR pwzAdditionalHeaders);
void __RPC_STUB IExtensionServices_SetAdditionalHeaders_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IExtensionServices_SetAuthenticateData_Proxy(
    IExtensionServices *This, HWND phwnd, LPCWSTR pwzUsername,
    LPCWSTR pwzPassword);
