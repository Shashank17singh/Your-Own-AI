...
WINBOOL WINAPI TxfLogCreateFileReadContext(LPCWSTR LogPath,
                                           CLFS_LSN BeginningLsn,
                                           CLFS_LSN EndingLSN,
                                           PTXF_ID TxfFileId,
                                           PVOID *TxfLogContext);
WINBOOL WINAPI TxfLogDestroyReadContext(PVOID TxfLogContext);
WINBOOL WINAPI TxfLogReadRecords(PVOID TxfLogContext, ULONG BufferLength,
                                 PVOID Buffer, PULONG BytesUsed,
                                 PULONG RecordCount);
#ifdef __cplusplus
}
#endif
