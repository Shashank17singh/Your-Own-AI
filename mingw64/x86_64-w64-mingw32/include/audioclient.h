...
typedef enum AMBISONICS_TYPE { AMBISONICS_TYPE_FULL3D = 0x0 } AMBISONICS_TYPE;
...
IAudioClient : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE Initialize(
      AUDCLNT_SHAREMODE ShareMode, DWORD StreamFlags,
      REFERENCE_TIME hnsBufferDuration, REFERENCE_TIME hnsPeriodicity,
      const WAVEFORMATEX *pFormat, LPCGUID AudioSessionGuid) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetBufferSize(UINT32 *
                                                  pNumBufferFrames) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetStreamLatency(REFERENCE_TIME *
                                                     phnsLatency) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetCurrentPadding(UINT32 *
                                                      pNumPaddingFrames) = 0;
  virtual HRESULT STDMETHODCALLTYPE IsFormatSupported(
      AUDCLNT_SHAREMODE ShareMode, const WAVEFORMATEX *pFormat,
      WAVEFORMATEX **ppClosestMatch) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetMixFormat(WAVEFORMATEX *
                                                 *ppDeviceFormat) = 0;
...
__CRT_UUID_DECL(IAudioClient, 0x1cb9ad4c, 0xdbfa, 0x4c32, 0xb1, 0x78, 0xc2,
                0xf5, 0x68, 0xa7, 0x03, 0xb2)
#endif
#else
typedef struct IAudioClientVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAudioClient *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *SetEventHandle)(IAudioClient *This,
                                             HANDLE eventHandle);
  HRESULT(STDMETHODCALLTYPE *GetService)(IAudioClient *This, REFIID riid,
                                         void **ppv);
  END_INTERFACE
} IAudioClientVtbl;
interface IAudioClient { CONST_VTBL IAudioClientVtbl *lpVtbl; };
#ifdef COBJMACROS
...
IAudioClient_QueryInterface(IAudioClient *This, REFIID riid, void **ppvObject) {
...
/*** IAudioClient methods ***/
static inline HRESULT
IAudioClient_Initialize(IAudioClient *This, AUDCLNT_SHAREMODE ShareMode,
                        DWORD StreamFlags, REFERENCE_TIME hnsBufferDuration,
                        REFERENCE_TIME hnsPeriodicity,
                        const WAVEFORMATEX *pFormat, LPCGUID AudioSessionGuid) {
  return This->lpVtbl->Initialize(This, ShareMode, StreamFlags,
                                  hnsBufferDuration, hnsPeriodicity, pFormat,
                                  AudioSessionGuid);
}
static inline HRESULT IAudioClient_GetBufferSize(IAudioClient *This,
                                                 UINT32 *pNumBufferFrames) {
  return This->lpVtbl->GetBufferSize(This, pNumBufferFrames);
}
static inline HRESULT
IAudioClient_GetStreamLatency(IAudioClient *This, REFERENCE_TIME *phnsLatency) {
  return This->lpVtbl->GetStreamLatency(This, phnsLatency);
}
static inline HRESULT
IAudioClient_GetCurrentPadding(IAudioClient *This, UINT32 *pNumPaddingFrames) {
  return This->lpVtbl->GetCurrentPadding(This, pNumPaddingFrames);
}
static inline HRESULT
IAudioClient_IsFormatSupported(IAudioClient *This, AUDCLNT_SHAREMODE ShareMode,
                               const WAVEFORMATEX *pFormat,
                               WAVEFORMATEX **ppClosestMatch) {
  return This->lpVtbl->IsFormatSupported(This, ShareMode, pFormat,
                                         ppClosestMatch);
}
static inline HRESULT IAudioClient_GetMixFormat(IAudioClient *This,
                                                WAVEFORMATEX **ppDeviceFormat) {
  return This->lpVtbl->GetMixFormat(This, ppDeviceFormat);
}
static inline HRESULT
IAudioClient_GetDevicePeriod(IAudioClient *This,
                             REFERENCE_TIME *phnsDefaultDevicePeriod,
                             REFERENCE_TIME *phnsMinimumDevicePeriod) {
  return This->lpVtbl->GetDevicePeriod(This, phnsDefaultDevicePeriod,
                                       phnsMinimumDevicePeriod);
}
...
static inline HRESULT IAudioClient_SetEventHandle(IAudioClient *This,
                                                  HANDLE eventHandle) {
  return This->lpVtbl->SetEventHandle(This, eventHandle);
}
static inline HRESULT IAudioClient_GetService(IAudioClient *This, REFIID riid,
                                              void **ppv) {
...
DEFINE_GUID(IID_IAudioClient2, 0x726778cd, 0xf60a, 0x4eda, 0x82, 0xde, 0xe4,
            0x76, 0x10, 0xcd, 0x78, 0xaa);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IAudioClient2 : public IAudioClient {
  virtual HRESULT STDMETHODCALLTYPE IsOffloadCapable(
      AUDIO_STREAM_CATEGORY Category, WINBOOL * pbOffloadCapable) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetBufferSizeLimits(
      const WAVEFORMATEX *pFormat, WINBOOL bEventDriven,
      REFERENCE_TIME *phnsMinBufferDuration,
      REFERENCE_TIME *phnsMaxBufferDuration) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IAudioClient2, 0x726778cd, 0xf60a, 0x4eda, 0x82, 0xde, 0xe4,
                0x76, 0x10, 0xcd, 0x78, 0xaa)
#endif
#else
typedef struct IAudioClient2Vtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAudioClient2 *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IAudioClient2 *This);
  ULONG(STDMETHODCALLTYPE *Release)(IAudioClient2 *This);
  /*** IAudioClient methods ***/
  HRESULT(STDMETHODCALLTYPE *Initialize)(
      IAudioClient2 *This, AUDCLNT_SHAREMODE ShareMode, DWORD StreamFlags,
      REFERENCE_TIME hnsBufferDuration, REFERENCE_TIME hnsPeriodicity,
      const WAVEFORMATEX *pFormat, LPCGUID AudioSessionGuid);
  HRESULT(STDMETHODCALLTYPE *GetBufferSize)(IAudioClient2 *This,
                                            UINT32 *pNumBufferFrames);
  HRESULT(STDMETHODCALLTYPE *GetStreamLatency)(IAudioClient2 *This,
                                               REFERENCE_TIME *phnsLatency);
  HRESULT(STDMETHODCALLTYPE *GetCurrentPadding)(IAudioClient2 *This,
                                                UINT32 *pNumPaddingFrames);
  HRESULT(STDMETHODCALLTYPE *IsFormatSupported)(IAudioClient2 *This,
                                                AUDCLNT_SHAREMODE ShareMode,
                                                const WAVEFORMATEX *pFormat,
                                                WAVEFORMATEX **ppClosestMatch);
  HRESULT(STDMETHODCALLTYPE *GetMixFormat)(IAudioClient2 *This,
                                           WAVEFORMATEX **ppDeviceFormat);
  HRESULT(STDMETHODCALLTYPE *GetDevicePeriod)(
      IAudioClient2 *This, REFERENCE_TIME *phnsDefaultDevicePeriod,
      REFERENCE_TIME *phnsMinimumDevicePeriod);
  HRESULT(STDMETHODCALLTYPE *Start)(IAudioClient2 *This);
  HRESULT(STDMETHODCALLTYPE *Stop)(IAudioClient2 *This);
  HRESULT(STDMETHODCALLTYPE *Reset)(IAudioClient2 *This);
  HRESULT(STDMETHODCALLTYPE *SetEventHandle)(IAudioClient2 *This,
                                             HANDLE eventHandle);
  HRESULT(STDMETHODCALLTYPE *GetService)(IAudioClient2 *This, REFIID riid,
                                         void **ppv);
  /*** IAudioClient2 methods ***/
  HRESULT(STDMETHODCALLTYPE *IsOffloadCapable)(IAudioClient2 *This,
                                               AUDIO_STREAM_CATEGORY Category,
                                               WINBOOL *pbOffloadCapable);
  HRESULT(STDMETHODCALLTYPE *SetClientProperties)(
      IAudioClient2 *This, const AudioClientProperties *pProperties);
  HRESULT(STDMETHODCALLTYPE *GetBufferSizeLimits)(
      IAudioClient2 *This, const WAVEFORMATEX *pFormat, WINBOOL bEventDriven,
      REFERENCE_TIME *phnsMinBufferDuration,
      REFERENCE_TIME *phnsMaxBufferDuration);
  END_INTERFACE
} IAudioClient2Vtbl;
interface IAudioClient2 { CONST_VTBL IAudioClient2Vtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IAudioClient methods ***/
#define IAudioClient2_Initialize(This, ShareMode, StreamFlags,                 \
                                 hnsBufferDuration, hnsPeriodicity, pFormat,   \
                                 AudioSessionGuid)                             \
  (This)->lpVtbl->Initialize(This, ShareMode, StreamFlags, hnsBufferDuration,  \
                             hnsPeriodicity, pFormat, AudioSessionGuid)
...
#define IAudioClient2_GetCurrentPadding(This, pNumPaddingFrames)               \
  (This)->lpVtbl->GetCurrentPadding(This, pNumPaddingFrames)
#define IAudioClient2_IsFormatSupported(This, ShareMode, pFormat,              \
                                        ppClosestMatch)                        \
  (This)->lpVtbl->IsFormatSupported(This, ShareMode, pFormat, ppClosestMatch)
#define IAudioClient2_GetMixFormat(This, ppDeviceFormat)                       \
  (This)->lpVtbl->GetMixFormat(This, ppDeviceFormat)
#define IAudioClient2_GetDevicePeriod(This, phnsDefaultDevicePeriod,           \
                                      phnsMinimumDevicePeriod)                 \
  (This)->lpVtbl->GetDevicePeriod(This, phnsDefaultDevicePeriod,               \
                                  phnsMinimumDevicePeriod)
...
#define IAudioClient2_GetBufferSizeLimits(                                     \
    This, pFormat, bEventDriven, phnsMinBufferDuration, phnsMaxBufferDuration) \
  (This)->lpVtbl->GetBufferSizeLimits(This, pFormat, bEventDriven,             \
                                      phnsMinBufferDuration,                   \
                                      phnsMaxBufferDuration)
#else
/*** IUnknown methods ***/
static inline HRESULT IAudioClient2_QueryInterface(IAudioClient2 *This,
                                                   REFIID riid,
                                                   void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IAudioClient methods ***/
static inline HRESULT IAudioClient2_Initialize(
    IAudioClient2 *This, AUDCLNT_SHAREMODE ShareMode, DWORD StreamFlags,
    REFERENCE_TIME hnsBufferDuration, REFERENCE_TIME hnsPeriodicity,
    const WAVEFORMATEX *pFormat, LPCGUID AudioSessionGuid) {
  return This->lpVtbl->Initialize(This, ShareMode, StreamFlags,
...
static inline HRESULT IAudioClient2_GetBufferSize(IAudioClient2 *This,
                                                  UINT32 *pNumBufferFrames) {
  return This->lpVtbl->GetBufferSize(This, pNumBufferFrames);
}
static inline HRESULT
IAudioClient2_GetStreamLatency(IAudioClient2 *This,
                               REFERENCE_TIME *phnsLatency) {
  return This->lpVtbl->GetStreamLatency(This, phnsLatency);
}
static inline HRESULT
IAudioClient2_GetCurrentPadding(IAudioClient2 *This,
                                UINT32 *pNumPaddingFrames) {
  return This->lpVtbl->GetCurrentPadding(This, pNumPaddingFrames);
}
static inline HRESULT IAudioClient2_IsFormatSupported(
    IAudioClient2 *This, AUDCLNT_SHAREMODE ShareMode,
    const WAVEFORMATEX *pFormat, WAVEFORMATEX **ppClosestMatch) {
  return This->lpVtbl->IsFormatSupported(This, ShareMode, pFormat,
                                         ppClosestMatch);
}
static inline HRESULT
IAudioClient2_GetMixFormat(IAudioClient2 *This, WAVEFORMATEX **ppDeviceFormat) {
  return This->lpVtbl->GetMixFormat(This, ppDeviceFormat);
}
static inline HRESULT
IAudioClient2_GetDevicePeriod(IAudioClient2 *This,
                              REFERENCE_TIME *phnsDefaultDevicePeriod,
                              REFERENCE_TIME *phnsMinimumDevicePeriod) {
  return This->lpVtbl->GetDevicePeriod(This, phnsDefaultDevicePeriod,
                                       phnsMinimumDevicePeriod);
...
static inline HRESULT IAudioClient2_SetEventHandle(IAudioClient2 *This,
                                                   HANDLE eventHandle) {
  return This->lpVtbl->SetEventHandle(This, eventHandle);
}
static inline HRESULT IAudioClient2_GetService(IAudioClient2 *This, REFIID riid,
                                               void **ppv) {
  return This->lpVtbl->GetService(This, riid, ppv);
}
/*** IAudioClient2 methods ***/
static inline HRESULT
IAudioClient2_IsOffloadCapable(IAudioClient2 *This,
                               AUDIO_STREAM_CATEGORY Category,
                               WINBOOL *pbOffloadCapable) {
  return This->lpVtbl->IsOffloadCapable(This, Category, pbOffloadCapable);
}
static inline HRESULT
IAudioClient2_SetClientProperties(IAudioClient2 *This,
...
static inline HRESULT IAudioClient2_GetBufferSizeLimits(
    ...
    REFERENCE_TIME *phnsMinBufferDuration,
    REFERENCE_TIME *phnsMaxBufferDuration) {
  return This->lpVtbl->GetBufferSizeLimits(This, pFormat, bEventDriven,
                                           phnsMinBufferDuration,
                                           phnsMaxBufferDuration);
}
#endif
...
IAudioClient3 : public IAudioClient2 {
  virtual HRESULT STDMETHODCALLTYPE GetSharedModeEnginePeriod(
      const WAVEFORMATEX *pFormat, UINT32 *pDefaultPeriodInFrames,
  ...
  virtual HRESULT STDMETHODCALLTYPE GetCurrentSharedModeEnginePeriod(
      WAVEFORMATEX * *ppFormat, UINT32 * pCurrentPeriodInFrames) = 0;
  virtual HRESULT STDMETHODCALLTYPE InitializeSharedAudioStream(
      DWORD StreamFlags, UINT32 PeriodInFrames, const WAVEFORMATEX *pFormat,
...
typedef struct IAudioClient3Vtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAudioClient3 *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IAudioClient3 *This);
  ULONG(STDMETHODCALLTYPE *Release)(IAudioClient3 *This);
  /*** IAudioClient methods ***/
  HRESULT(STDMETHODCALLTYPE *Initialize)(
      IAudioClient3 *This, AUDCLNT_SHAREMODE ShareMode, DWORD StreamFlags,
      REFERENCE_TIME hnsBufferDuration, REFERENCE_TIME hnsPeriodicity,
      const WAVEFORMATEX *pFormat, LPCGUID AudioSessionGuid);
  HRESULT(STDMETHODCALLTYPE *GetBufferSize)(IAudioClient3 *This,
                                            UINT32 *pNumBufferFrames);
  HRESULT(STDMETHODCALLTYPE *GetStreamLatency)(IAudioClient3 *This,
                                               REFERENCE_TIME *phnsLatency);
  HRESULT(STDMETHODCALLTYPE *GetCurrentPadding)(IAudioClient3 *This,
                                                UINT32 *pNumPaddingFrames);
  HRESULT(STDMETHODCALLTYPE *IsFormatSupported)(IAudioClient3 *This,
                                                AUDCLNT_SHAREMODE ShareMode,
                                                const WAVEFORMATEX *pFormat,
                                                WAVEFORMATEX **ppClosestMatch);
  HRESULT(STDMETHODCALLTYPE *GetMixFormat)(IAudioClient3 *This,
                                           WAVEFORMATEX **ppDeviceFormat);
  HRESULT(STDMETHODCALLTYPE *GetDevicePeriod)(
      IAudioClient3 *This, REFERENCE_TIME *phnsDefaultDevicePeriod,
      REFERENCE_TIME *phnsMinimumDevicePeriod);
  HRESULT(STDMETHODCALLTYPE *Start)(IAudioClient3 *This);
  HRESULT(STDMETHODCALLTYPE *Stop)(IAudioClient3 *This);
  HRESULT(STDMETHODCALLTYPE *Reset)(IAudioClient3 *This);
  HRESULT(STDMETHODCALLTYPE *SetEventHandle)(IAudioClient3 *This,
                                             HANDLE eventHandle);
  HRESULT(STDMETHODCALLTYPE *GetService)(IAudioClient3 *This, REFIID riid,
                                         void **ppv);
  /*** IAudioClient2 methods ***/
  HRESULT(STDMETHODCALLTYPE *IsOffloadCapable)(IAudioClient3 *This,
                                               AUDIO_STREAM_CATEGORY Category,
                                               WINBOOL *pbOffloadCapable);
  HRESULT(STDMETHODCALLTYPE *SetClientProperties)(
      IAudioClient3 *This, const AudioClientProperties *pProperties);
  HRESULT(STDMETHODCALLTYPE *GetBufferSizeLimits)(
      IAudioClient3 *This, const WAVEFORMATEX *pFormat, WINBOOL bEventDriven,
      REFERENCE_TIME *phnsMinBufferDuration,
      REFERENCE_TIME *phnsMaxBufferDuration);
  /*** IAudioClient3 methods ***/
  HRESULT(STDMETHODCALLTYPE *GetSharedModeEnginePeriod)(
      IAudioClient3 *This, const WAVEFORMATEX *pFormat,
      UINT32 *pDefaultPeriodInFrames, UINT32 *pFundamentalPeriodInFrames,
      UINT32 *pMinPeriodInFrames, UINT32 *pMaxPeriodInFrames);
  HRESULT(STDMETHODCALLTYPE *GetCurrentSharedModeEnginePeriod)(
      IAudioClient3 *This, WAVEFORMATEX **ppFormat,
...
interface IAudioClient3 { CONST_VTBL IAudioClient3Vtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IAudioClient methods ***/
#define IAudioClient3_Initialize(This, ShareMode, StreamFlags,                 \
                                 hnsBufferDuration, hnsPeriodicity, pFormat,   \
                                 AudioSessionGuid)                             \
  (This)->lpVtbl->Initialize(This, ShareMode, StreamFlags, hnsBufferDuration,  \
                             hnsPeriodicity, pFormat, AudioSessionGuid)
...
#define IAudioClient3_GetCurrentPadding(This, pNumPaddingFrames)               \
  (This)->lpVtbl->GetCurrentPadding(This, pNumPaddingFrames)
#define IAudioClient3_IsFormatSupported(This, ShareMode, pFormat,              \
                                        ppClosestMatch)                        \
  (This)->lpVtbl->IsFormatSupported(This, ShareMode, pFormat, ppClosestMatch)
#define IAudioClient3_GetMixFormat(This, ppDeviceFormat)                       \
  (This)->lpVtbl->GetMixFormat(This, ppDeviceFormat)
#define IAudioClient3_GetDevicePeriod(This, phnsDefaultDevicePeriod,           \
                                      phnsMinimumDevicePeriod)                 \
  (This)->lpVtbl->GetDevicePeriod(This, phnsDefaultDevicePeriod,               \
                                  phnsMinimumDevicePeriod)
...
#define IAudioClient3_SetClientProperties(This, pProperties)                   \
  (This)->lpVtbl->SetClientProperties(This, pProperties)
#define IAudioClient3_GetBufferSizeLimits(                                     \
    This, pFormat, bEventDriven, phnsMinBufferDuration, phnsMaxBufferDuration) \
  (This)->lpVtbl->GetBufferSizeLimits(This, pFormat, bEventDriven,             \
                                      phnsMinBufferDuration,                   \
                                      phnsMaxBufferDuration)
/*** IAudioClient3 methods ***/
#define IAudioClient3_GetSharedModeEnginePeriod(                               \
    This, pFormat, pDefaultPeriodInFrames, pFundamentalPeriodInFrames,         \
    pMinPeriodInFrames, pMaxPeriodInFrames)                                    \
  (This)->lpVtbl->GetSharedModeEnginePeriod(                                   \
      This, pFormat, pDefaultPeriodInFrames, pFundamentalPeriodInFrames,       \
      pMinPeriodInFrames, pMaxPeriodInFrames)
#define IAudioClient3_GetCurrentSharedModeEnginePeriod(This, ppFormat,         \
                                                       pCurrentPeriodInFrames) \
  (This)->lpVtbl->GetCurrentSharedModeEnginePeriod(This, ppFormat,             \
                                                   pCurrentPeriodInFrames)
#define IAudioClient3_InitializeSharedAudioStream(                             \
    This, StreamFlags, PeriodInFrames, pFormat, AudioSessionGuid)              \
  (This)->lpVtbl->InitializeSharedAudioStream(                                 \
      This, StreamFlags, PeriodInFrames, pFormat, AudioSessionGuid)
#else
/*** IUnknown methods ***/
static inline HRESULT IAudioClient3_QueryInterface(IAudioClient3 *This,
                                                   REFIID riid,
                                                   void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IAudioClient methods ***/
static inline HRESULT IAudioClient3_Initialize(
    IAudioClient3 *This, AUDCLNT_SHAREMODE ShareMode, DWORD StreamFlags,
    REFERENCE_TIME hnsBufferDuration, REFERENCE_TIME hnsPeriodicity,
    const WAVEFORMATEX *pFormat, LPCGUID AudioSessionGuid) {
  return This->lpVtbl->Initialize(This, ShareMode, StreamFlags,
...
static inline HRESULT IAudioClient3_GetBufferSize(IAudioClient3 *This,
                                                  UINT32 *pNumBufferFrames) {
  return This->lpVtbl->GetBufferSize(This, pNumBufferFrames);
}
static inline HRESULT
IAudioClient3_GetStreamLatency(IAudioClient3 *This,
                               REFERENCE_TIME *phnsLatency) {
  return This->lpVtbl->GetStreamLatency(This, phnsLatency);
}
static inline HRESULT
IAudioClient3_GetCurrentPadding(IAudioClient3 *This,
                                UINT32 *pNumPaddingFrames) {
  return This->lpVtbl->GetCurrentPadding(This, pNumPaddingFrames);
}
static inline HRESULT IAudioClient3_IsFormatSupported(
    IAudioClient3 *This, AUDCLNT_SHAREMODE ShareMode,
    const WAVEFORMATEX *pFormat, WAVEFORMATEX **ppClosestMatch) {
  return This->lpVtbl->IsFormatSupported(This, ShareMode, pFormat,
                                         ppClosestMatch);
}
static inline HRESULT
IAudioClient3_GetMixFormat(IAudioClient3 *This, WAVEFORMATEX **ppDeviceFormat) {
  return This->lpVtbl->GetMixFormat(This, ppDeviceFormat);
}
static inline HRESULT
IAudioClient3_GetDevicePeriod(IAudioClient3 *This,
                              REFERENCE_TIME *phnsDefaultDevicePeriod,
                              REFERENCE_TIME *phnsMinimumDevicePeriod) {
  return This->lpVtbl->GetDevicePeriod(This, phnsDefaultDevicePeriod,
                                       phnsMinimumDevicePeriod);
...
static inline HRESULT IAudioClient3_SetEventHandle(IAudioClient3 *This,
                                                   HANDLE eventHandle) {
  return This->lpVtbl->SetEventHandle(This, eventHandle);
}
static inline HRESULT IAudioClient3_GetService(IAudioClient3 *This, REFIID riid,
                                               void **ppv) {
  return This->lpVtbl->GetService(This, riid, ppv);
}
/*** IAudioClient2 methods ***/
static inline HRESULT
IAudioClient3_IsOffloadCapable(IAudioClient3 *This,
                               AUDIO_STREAM_CATEGORY Category,
                               WINBOOL *pbOffloadCapable) {
  return This->lpVtbl->IsOffloadCapable(This, Category, pbOffloadCapable);
}
static inline HRESULT
IAudioClient3_SetClientProperties(IAudioClient3 *This,
                                  const AudioClientProperties *pProperties) {
  return This->lpVtbl->SetClientProperties(This, pProperties);
}
...
static inline HRESULT IAudioClient3_GetSharedModeEnginePeriod(
    ...
    UINT32 *pDefaultPeriodInFrames, UINT32 *pFundamentalPeriodInFrames,
    UINT32 *pMinPeriodInFrames, UINT32 *pMaxPeriodInFrames) {
  return This->lpVtbl->GetSharedModeEnginePeriod(
      This, pFormat, pDefaultPeriodInFrames, pFundamentalPeriodInFrames,
      pMinPeriodInFrames, pMaxPeriodInFrames);
}
static inline HRESULT
IAudioClient3_GetCurrentSharedModeEnginePeriod(IAudioClient3 *This,
                                               WAVEFORMATEX **ppFormat,
                                               UINT32 *pCurrentPeriodInFrames) {
  return This->lpVtbl->GetCurrentSharedModeEnginePeriod(This, ppFormat,
                                                        pCurrentPeriodInFrames);
}
static inline HRESULT IAudioClient3_InitializeSharedAudioStream(
    IAudioClient3 *This, DWORD StreamFlags, UINT32 PeriodInFrames,
    const WAVEFORMATEX *pFormat, LPCGUID AudioSessionGuid) {
  return This->lpVtbl->InitializeSharedAudioStream(
      This, StreamFlags, PeriodInFrames, pFormat, AudioSessionGuid);
}
#endif
#endif
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IAudioRenderClient, 0xf294acfc, 0x3146, 0x4483, 0xa7, 0xbf,
                0xad, 0xdc, 0xa7, 0xc2, 0x60, 0xe2)
#endif
#else
typedef struct IAudioRenderClientVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAudioRenderClient *This,
  ...
  HRESULT(STDMETHODCALLTYPE *GetBuffer)(IAudioRenderClient *This,
                                        UINT32 NumFramesRequested,
                                        BYTE **ppData);
  HRESULT(STDMETHODCALLTYPE *ReleaseBuffer)(IAudioRenderClient *This,
                                            UINT32 NumFramesWritten,
                                            DWORD dwFlags);
  END_INTERFACE
} IAudioRenderClientVtbl;
interface IAudioRenderClient { CONST_VTBL IAudioRenderClientVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
IAudioRenderClient_QueryInterface(IAudioRenderClient *This, REFIID riid,
                                  void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IAudioRenderClient methods ***/
static inline HRESULT IAudioRenderClient_GetBuffer(IAudioRenderClient *This,
                                                   UINT32 NumFramesRequested,
                                                   BYTE **ppData) {
  return This->lpVtbl->GetBuffer(This, NumFramesRequested, ppData);
}
static inline HRESULT IAudioRenderClient_ReleaseBuffer(IAudioRenderClient *This,
                                                       UINT32 NumFramesWritten,
                                                       DWORD dwFlags) {
...
IAudioCaptureClient : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetBuffer(
      ...
      UINT64 * pu64DevicePosition, UINT64 * pu64QPCPosition) = 0;
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IAudioCaptureClient, 0xc8adbd64, 0xe71e, 0x48a0, 0xa4, 0xde,
                0x18, 0x5c, 0x39, 0x5c, 0xd3, 0x17)
#endif
#else
typedef struct IAudioCaptureClientVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAudioCaptureClient *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetBuffer)(IAudioCaptureClient *This,
                                        BYTE **ppData, UINT32 *pNumFramesToRead,
                                        DWORD *pdwFlags,
                                        UINT64 *pu64DevicePosition,
                                        UINT64 *pu64QPCPosition);
  HRESULT(STDMETHODCALLTYPE *ReleaseBuffer)(IAudioCaptureClient *This,
                                            UINT32 NumFramesRead);
  HRESULT(STDMETHODCALLTYPE *GetNextPacketSize)(IAudioCaptureClient *This,
                                                UINT32 *pNumFramesInNextPacket);
  END_INTERFACE
} IAudioCaptureClientVtbl;
interface IAudioCaptureClient { CONST_VTBL IAudioCaptureClientVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
IAudioCaptureClient_QueryInterface(IAudioCaptureClient *This, REFIID riid,
                                   void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IAudioCaptureClient methods ***/
static inline HRESULT IAudioCaptureClient_GetBuffer(
    IAudioCaptureClient *This, BYTE **ppData, UINT32 *pNumFramesToRead,
    DWORD *pdwFlags, UINT64 *pu64DevicePosition, UINT64 *pu64QPCPosition) {
  return This->lpVtbl->GetBuffer(This, ppData, pNumFramesToRead, pdwFlags,
                                 pu64DevicePosition, pu64QPCPosition);
}
static inline HRESULT
IAudioCaptureClient_ReleaseBuffer(IAudioCaptureClient *This,
                                  UINT32 NumFramesRead) {
  return This->lpVtbl->ReleaseBuffer(This, NumFramesRead);
}
static inline HRESULT
IAudioCaptureClient_GetNextPacketSize(IAudioCaptureClient *This,
                                      UINT32 *pNumFramesInNextPacket) {
...
DEFINE_GUID(IID_IAudioClock, 0xcd63314f, 0x3fba, 0x4a1b, 0x81, 0x2c, 0xef, 0x96,
            0x35, 0x87, 0x28, 0xe7);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IAudioClock, 0xcd63314f, 0x3fba, 0x4a1b, 0x81, 0x2c, 0xef, 0x96,
                0x35, 0x87, 0x28, 0xe7)
#endif
#else
typedef struct IAudioClockVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAudioClock *This, REFIID riid,
                                             void **ppvObject);
...
interface IAudioClock { CONST_VTBL IAudioClockVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IAudioClock_QueryInterface(IAudioClock *This, REFIID riid,
                                                 void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IAudioClock methods ***/
static inline HRESULT IAudioClock_GetFrequency(IAudioClock *This,
                                               UINT64 *pu64Frequency) {
  return This->lpVtbl->GetFrequency(This, pu64Frequency);
}
static inline HRESULT IAudioClock_GetPosition(IAudioClock *This,
                                              UINT64 *pu64Position,
                                              UINT64 *pu64QPCPosition) {
  return This->lpVtbl->GetPosition(This, pu64Position, pu64QPCPosition);
}
static inline HRESULT
IAudioClock_GetCharacteristics(IAudioClock *This, DWORD *pdwCharacteristics) {
...
DEFINE_GUID(IID_IAudioClock2, 0x6f49ff73, 0x6727, 0x49ac, 0xa0, 0x08, 0xd9,
            0x8c, 0xf5, 0xe7, 0x00, 0x48);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IAudioClock2, 0x6f49ff73, 0x6727, 0x49ac, 0xa0, 0x08, 0xd9,
                0x8c, 0xf5, 0xe7, 0x00, 0x48)
#endif
#else
typedef struct IAudioClock2Vtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAudioClock2 *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IAudioClock2 *This);
  ULONG(STDMETHODCALLTYPE *Release)(IAudioClock2 *This);
  /*** IAudioClock2 methods ***/
  HRESULT(STDMETHODCALLTYPE *GetDevicePosition)(IAudioClock2 *This,
                                                UINT64 *DevicePosition,
                                                UINT64 *QPCPosition);
  END_INTERFACE
} IAudioClock2Vtbl;
interface IAudioClock2 { CONST_VTBL IAudioClock2Vtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
IAudioClock2_QueryInterface(IAudioClock2 *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IAudioClock2 methods ***/
static inline HRESULT IAudioClock2_GetDevicePosition(IAudioClock2 *This,
                                                     UINT64 *DevicePosition,
                                                     UINT64 *QPCPosition) {
...
DEFINE_GUID(IID_IAudioClockAdjustment, 0xf6e4c0a0, 0x46d9, 0x4fb8, 0xbe, 0x21,
            0x57, 0xa3, 0xef, 0x2b, 0x62, 0x6c);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IAudioClockAdjustment, 0xf6e4c0a0, 0x46d9, 0x4fb8, 0xbe, 0x21,
                0x57, 0xa3, 0xef, 0x2b, 0x62, 0x6c)
#endif
#else
typedef struct IAudioClockAdjustmentVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAudioClockAdjustment *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *SetSampleRate)(IAudioClockAdjustment *This,
                                            float flSampleRate);
  END_INTERFACE
...
/*** IUnknown methods ***/
static inline HRESULT
IAudioClockAdjustment_QueryInterface(IAudioClockAdjustment *This, REFIID riid,
                                     void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IAudioClockAdjustment methods ***/
static inline HRESULT
IAudioClockAdjustment_SetSampleRate(IAudioClockAdjustment *This,
                                    float flSampleRate) {
...
DEFINE_GUID(IID_ISimpleAudioVolume, 0x87ce5498, 0x68d6, 0x44e5, 0x92, 0x15,
...
ISimpleAudioVolume : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE SetMute(const WINBOOL bMute,
                                            LPCGUID EventContext) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetMute(WINBOOL * pbMute) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ISimpleAudioVolume, 0x87ce5498, 0x68d6, 0x44e5, 0x92, 0x15,
                0x6d, 0xa4, 0x7e, 0xf8, 0x83, 0xd8)
#endif
#else
typedef struct ISimpleAudioVolumeVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ISimpleAudioVolume *This,
                                             REFIID riid, void **ppvObject);
...
interface ISimpleAudioVolume { CONST_VTBL ISimpleAudioVolumeVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
ISimpleAudioVolume_QueryInterface(ISimpleAudioVolume *This, REFIID riid,
                                  void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ISimpleAudioVolume methods ***/
static inline HRESULT
ISimpleAudioVolume_SetMasterVolume(ISimpleAudioVolume *This, float fLevel,
                                   LPCGUID EventContext) {
  return This->lpVtbl->SetMasterVolume(This, fLevel, EventContext);
}
static inline HRESULT
ISimpleAudioVolume_GetMasterVolume(ISimpleAudioVolume *This, float *pfLevel) {
  return This->lpVtbl->GetMasterVolume(This, pfLevel);
}
static inline HRESULT ISimpleAudioVolume_SetMute(ISimpleAudioVolume *This,
                                                 const WINBOOL bMute,
                                                 LPCGUID EventContext) {
  return This->lpVtbl->SetMute(This, bMute, EventContext);
}
static inline HRESULT ISimpleAudioVolume_GetMute(ISimpleAudioVolume *This,
                                                 WINBOOL *pbMute) {
...
DEFINE_GUID(IID_IAudioStreamVolume, 0x93014887, 0x242d, 0x4068, 0x8a, 0x15,
            0xcf, 0x5e, 0x93, 0xb9, 0x0f, 0xe3);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IAudioStreamVolume, 0x93014887, 0x242d, 0x4068, 0x8a, 0x15,
                0xcf, 0x5e, 0x93, 0xb9, 0x0f, 0xe3)
#endif
#else
typedef struct IAudioStreamVolumeVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAudioStreamVolume *This,
                                             REFIID riid, void **ppvObject);
...
interface IAudioStreamVolume { CONST_VTBL IAudioStreamVolumeVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
IAudioStreamVolume_QueryInterface(IAudioStreamVolume *This, REFIID riid,
                                  void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IAudioStreamVolume methods ***/
static inline HRESULT
IAudioStreamVolume_GetChannelCount(IAudioStreamVolume *This, UINT32 *pdwCount) {
  return This->lpVtbl->GetChannelCount(This, pdwCount);
}
static inline HRESULT
IAudioStreamVolume_SetChannelVolume(IAudioStreamVolume *This, UINT32 dwIndex,
                                    const float fLevel) {
  return This->lpVtbl->SetChannelVolume(This, dwIndex, fLevel);
}
static inline HRESULT
IAudioStreamVolume_GetChannelVolume(IAudioStreamVolume *This, UINT32 dwIndex,
                                    float *pfLevel) {
  return This->lpVtbl->GetChannelVolume(This, dwIndex, pfLevel);
}
static inline HRESULT IAudioStreamVolume_SetAllVolumes(IAudioStreamVolume *This,
                                                       UINT32 dwCount,
                                                       const float *pfVolumes) {
  return This->lpVtbl->SetAllVolumes(This, dwCount, pfVolumes);
}
static inline HRESULT IAudioStreamVolume_GetAllVolumes(IAudioStreamVolume *This,
                                                       UINT32 dwCount,
                                                       float *pfVolumes) {
...
DEFINE_GUID(IID_IAudioAmbisonicsControl, 0x28724c91, 0xdf35, 0x4856, 0x9f, 0x76,
            0xd6, 0xa2, 0x64, 0x13, 0xf3, 0xdf);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IAudioAmbisonicsControl : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE GetHeadTracking(WINBOOL *
                                                    pbEnableHeadTracking) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetRotation(float X, float Y, float Z,
                                                float W) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IAudioAmbisonicsControl, 0x28724c91, 0xdf35, 0x4856, 0x9f, 0x76,
                0xd6, 0xa2, 0x64, 0x13, 0xf3, 0xdf)
#endif
#else
typedef struct IAudioAmbisonicsControlVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAudioAmbisonicsControl *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IAudioAmbisonicsControl *This);
  ULONG(STDMETHODCALLTYPE *Release)(IAudioAmbisonicsControl *This);
  /*** IAudioAmbisonicsControl methods ***/
  HRESULT(STDMETHODCALLTYPE *SetData)(
      IAudioAmbisonicsControl *This, const AMBISONICS_PARAMS *pAmbisonicsParams,
      UINT32 cbAmbisonicsParams);
  HRESULT(STDMETHODCALLTYPE *SetHeadTracking)(IAudioAmbisonicsControl *This,
                                              WINBOOL bEnableHeadTracking);
  HRESULT(STDMETHODCALLTYPE *GetHeadTracking)(IAudioAmbisonicsControl *This,
                                              WINBOOL *pbEnableHeadTracking);
  HRESULT(STDMETHODCALLTYPE *SetRotation)(IAudioAmbisonicsControl *This,
...
/*** IAudioAmbisonicsControl methods ***/
#define IAudioAmbisonicsControl_SetData(This, pAmbisonicsParams,               \
                                        cbAmbisonicsParams)                    \
...
/*** IUnknown methods ***/
static inline HRESULT
IAudioAmbisonicsControl_QueryInterface(IAudioAmbisonicsControl *This,
                                       REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IAudioAmbisonicsControl_AddRef(IAudioAmbisonicsControl *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IAudioAmbisonicsControl_Release(IAudioAmbisonicsControl *This) {
  return This->lpVtbl->Release(This);
}
/*** IAudioAmbisonicsControl methods ***/
static inline HRESULT
IAudioAmbisonicsControl_SetData(IAudioAmbisonicsControl *This,
                                const AMBISONICS_PARAMS *pAmbisonicsParams,
                                UINT32 cbAmbisonicsParams) {
  return This->lpVtbl->SetData(This, pAmbisonicsParams, cbAmbisonicsParams);
}
static inline HRESULT
IAudioAmbisonicsControl_SetHeadTracking(IAudioAmbisonicsControl *This,
                                        WINBOOL bEnableHeadTracking) {
  return This->lpVtbl->SetHeadTracking(This, bEnableHeadTracking);
}
static inline HRESULT
IAudioAmbisonicsControl_GetHeadTracking(IAudioAmbisonicsControl *This,
                                        WINBOOL *pbEnableHeadTracking) {
  return This->lpVtbl->GetHeadTracking(This, pbEnableHeadTracking);
}
static inline HRESULT
IAudioAmbisonicsControl_SetRotation(IAudioAmbisonicsControl *This, float X,
...
DEFINE_GUID(IID_IChannelAudioVolume, 0x1c158861, 0xb533, 0x4b30, 0xb1, 0xcf,
            0xe8, 0x53, 0xe5, 0x1c, 0x59, 0xb8);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IChannelAudioVolume : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE SetChannelVolume(
      UINT32 dwIndex, const float fLevel, LPCGUID EventContext) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetChannelVolume(UINT32 dwIndex,
                                                     float *pfLevel) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetAllVolumes(
      UINT32 dwCount, const float *pfVolumes, LPCGUID EventContext) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetAllVolumes(UINT32 dwCount,
                                                  float *pfVolumes) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IChannelAudioVolume, 0x1c158861, 0xb533, 0x4b30, 0xb1, 0xcf,
                0xe8, 0x53, 0xe5, 0x1c, 0x59, 0xb8)
#endif
#else
typedef struct IChannelAudioVolumeVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IChannelAudioVolume *This,
                                             REFIID riid, void **ppvObject);
...
interface IChannelAudioVolume { CONST_VTBL IChannelAudioVolumeVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
IChannelAudioVolume_QueryInterface(IChannelAudioVolume *This, REFIID riid,
                                   void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IChannelAudioVolume methods ***/
static inline HRESULT
IChannelAudioVolume_GetChannelCount(IChannelAudioVolume *This,
                                    UINT32 *pdwCount) {
  return This->lpVtbl->GetChannelCount(This, pdwCount);
}
static inline HRESULT
IChannelAudioVolume_SetChannelVolume(IChannelAudioVolume *This, UINT32 dwIndex,
                                     const float fLevel, LPCGUID EventContext) {
  return This->lpVtbl->SetChannelVolume(This, dwIndex, fLevel, EventContext);
}
static inline HRESULT
IChannelAudioVolume_GetChannelVolume(IChannelAudioVolume *This, UINT32 dwIndex,
                                     float *pfLevel) {
  return This->lpVtbl->GetChannelVolume(This, dwIndex, pfLevel);
}
static inline HRESULT
IChannelAudioVolume_SetAllVolumes(IChannelAudioVolume *This, UINT32 dwCount,
                                  const float *pfVolumes,
                                  LPCGUID EventContext) {
  return This->lpVtbl->SetAllVolumes(This, dwCount, pfVolumes, EventContext);
}
static inline HRESULT
IChannelAudioVolume_GetAllVolumes(IChannelAudioVolume *This, UINT32 dwCount,
                                  float *pfVolumes) {
  return This->lpVtbl->GetAllVolumes(This, dwCount, pfVolumes);
}
#endif
