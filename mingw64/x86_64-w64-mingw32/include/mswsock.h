...
#endif /* __MSWSOCK_WS1_SHARED */
typedef WINBOOL(WINAPI *LPFN_TRANSMITFILE)(
...
typedef WINBOOL(WINAPI *LPFN_ACCEPTEX)(
...
typedef WINBOOL(WINAPI *LPFN_TRANSMITPACKETS)(
    SOCKET hSocket, LPTRANSMIT_PACKETS_ELEMENT lpPacketArray,
    DWORD nElementCount, DWORD nSendSize, LPOVERLAPPED lpOverlapped,
    DWORD dwFlags);
#define WSAID_TRANSMITPACKETS                                                  \
  {0xd9689da0, 0x1f90, 0x11d3, {0x99, 0x71, 0x00, 0xc0, 0x4f, 0x68, 0xc8, 0x76}}
typedef WINBOOL(WINAPI *LPFN_CONNECTEX)(SOCKET s, const struct sockaddr *name,
...
typedef WINBOOL(WINAPI *LPFN_DISCONNECTEX)(SOCKET s, LPOVERLAPPED lpOverlapped,
