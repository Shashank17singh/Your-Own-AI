...
DEFINE_GUIDSTRUCT("E5323777-F976-4F5B-9B55-B94699C46E44",
...
DEFINE_GUIDSTRUCT("0A3D1C5D-5243-4819-9ED0-AEE8044CEE2B",
                  KSPROPSETID_MemoryTransport);
#define KSPROPSETID_MemoryTransport                                            \
  DEFINE_GUIDNAMED(KSPROPSETID_MemoryTransport)
enum { KSPROPERTY_MEMORY_TRANSPORT = 1 };
#define DEFINE_KSPROPERTY_ITEM_MEMORY_TRANSPORT(SetHandler)                    \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_MEMORY_TRANSPORT, NULL,                    \
                         sizeof(KSPROPERTY), sizeof(WINBOOL), (SetHandler),    \
                         NULL, 0, NULL, NULL, 0)
...
__forceinline void KsGateAddOnInputToAnd(PKSGATE AndGate) { (VOID) AndGate; }
...
__forceinline void KsGateAddOffInputToOr(PKSGATE OrGate) { (VOID) OrGate; }
__forceinline void KsGateRemoveOnInputFromOr(PKSGATE OrGate) {
  KsGateTurnInputOff(OrGate);
}
__forceinline void KsGateRemoveOffInputFromOr(PKSGATE OrGate) { (VOID) OrGate; }
...
#define DEFINE_ABSTRACT_UNKNOWN()                                              \
  STDMETHOD_(NTSTATUS, QueryInterface)(THIS_ REFIID InterfaceId,               \
...
DECLARE_INTERFACE_(IKsControl, IUnknown) {
  ...
  STDMETHOD_(NTSTATUS, KsMethod)(THIS_ PKSMETHOD Method, ULONG MethodLength,
                                 PVOID MethodData, ULONG DataLength,
                                 ULONG * BytesReturned) PURE;
  STDMETHOD_(NTSTATUS, KsEvent)(THIS_ PKSEVENT Event, ULONG EventLength,
                                PVOID EventData, ULONG DataLength,
                                ULONG * BytesReturned) PURE;
};
...
DECLARE_INTERFACE_(IKsReferenceClock, IUnknown) {
  ...
  STDMETHOD_(LONGLONG, GetCorrelatedPhysicalTime)(THIS_ PLONGLONG SystemTime)
      PURE;
...
DECLARE_INTERFACE_(IKsDeviceFunctions, IUnknown) {
  ...
  STDMETHOD_(NTSTATUS, RegisterAdapterObjectEx)(
      THIS_ PADAPTER_OBJECT AdapterObject,
      PDEVICE_DESCRIPTION DeviceDescription, ULONG NumberOfMapRegisters,
      ULONG MaxMappingsByteCount, ULONG MappingTableStride) PURE;
};
#undef INTERFACE
...
__forceinline void KsFilterAddEvent(PKSFILTER Filter,
                                    PKSEVENT_ENTRY EventEntry) {
...
__forceinline void KsFilterGenerateEvents(PKSFILTER Filter,
...
__forceinline void KsPinGenerateEvents(PKSPIN Pin, const GUID *EventSet,
...
__forceinline PKSDEVICE
KsFilterFactoryGetParentDevice(PKSFILTERFACTORY FilterFactory) {
  return (PKSDEVICE)KsGetParent((PVOID)FilterFactory);
}
__forceinline PKSFILTERFACTORY
KsFilterGetParentFilterFactory(PKSFILTER Filter) {
...
__forceinline PKSFILTERFACTORY
KsDeviceGetFirstChildFilterFactory(PKSDEVICE Device) {
  return (PKSFILTERFACTORY)KsGetFirstChild((PVOID)Device);
}
__forceinline PKSFILTER
KsFilterFactoryGetFirstChildFilter(PKSFILTERFACTORY FilterFactory) {
...
__forceinline PKSFILTERFACTORY
KsFilterFactoryGetNextSiblingFilterFactory(PKSFILTERFACTORY FilterFactory) {
...
__forceinline PKSDEVICE
KsFilterFactoryGetDevice(PKSFILTERFACTORY FilterFactory) {
...
__forceinline PUNKNOWN
KsDeviceRegisterAggregatedClientUnknown(PKSDEVICE Device,
...
__forceinline PUNKNOWN
KsFilterFactoryRegisterAggregatedClientUnknown(PKSFILTERFACTORY FilterFactory,
                                               PUNKNOWN ClientUnknown) {
  return KsRegisterAggregatedClientUnknown((PVOID)FilterFactory, ClientUnknown);
}
__forceinline PUNKNOWN
KsFilterFactoryGetOuterUnknown(PKSFILTERFACTORY FilterFactory) {
  return KsGetOuterUnknown((PVOID)FilterFactory);
}
__forceinline PUNKNOWN
KsFilterRegisterAggregatedClientUnknown(PKSFILTER Filter,
                                        PUNKNOWN ClientUnknown) {
...
__forceinline PUNKNOWN
KsPinRegisterAggregatedClientUnknown(PKSPIN Pin, PUNKNOWN ClientUnknown) {
