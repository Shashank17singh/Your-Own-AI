...
DECLARE_INTERFACE_(INetDiagHelperInfo, IUnknown) {
  ...
  STDMETHOD_(HRESULT, GetAttributeInfo)(
      THIS_ ULONG * pcelt, HelperAttributeInfo * *pprgAttributeInfos) PURE;
  END_INTERFACE
};
#ifdef COBJMACROS
...
DECLARE_INTERFACE_(INetDiagHelper, IUnknown) {
  ...
  STDMETHOD_(HRESULT, GetAttributes)(THIS_ ULONG * pcelt,
                                     HELPER_ATTRIBUTE * *pprgAttributes) PURE;
  STDMETHOD_(HRESULT, GetCacheTime)(THIS_ FILETIME * pCacheTime) PURE;
  STDMETHOD_(HRESULT,
             GetDiagnosticsInfo)(THIS_ RETVAL DiagnosticsInfo * *ppInfo) PURE;
  STDMETHOD_(HRESULT, GetDownStreamHypotheses)(
      THIS_ ULONG * pcelt, HYPOTHESIS * *pprgHypotheses) PURE;
  STDMETHOD_(HRESULT, GetHigherHypotheses)(THIS_ ULONG * pcelt,
                                           HYPOTHESIS * *pprgHypotheses) PURE;
  STDMETHOD_(HRESULT, GetKeyAttributes)(
      THIS_ ULONG * pcelt, HELPER_ATTRIBUTE * *pprgAttributes) PURE;
  STDMETHOD_(HRESULT, GetLifeTime)(THIS_ LIFE_TIME * pLifeTime) PURE;
  STDMETHOD_(HRESULT, GetLowerHypotheses)(THIS_ ULONG * pcelt,
                                          HYPOTHESIS * *pprgHypotheses) PURE;
  STDMETHOD_(HRESULT, GetRepairInfo)(THIS_ PROBLEM_TYPE problem, ULONG pcelt,
                                     RepairInfo * *ppInfo) PURE;
  STDMETHOD_(HRESULT, GetUpStreamHypotheses)(THIS_ ULONG * pcelt,
                                             HYPOTHESIS * *pprgHypotheses) PURE;
  STDMETHOD_(HRESULT, HighUtilization)(
      THIS_ STRING LPWSTR pwszInstanceDescription,
      STRING LPWSTR * ppwszDescription, LONG * pDeferredTime,
      DIAGNOSTICS_STATUS * pStatus) PURE;
  STDMETHOD_(HRESULT, Initialize)(THIS_ ULONG celt,
                                  HELPER_ATTRIBUTE rgAttributes) PURE;
  STDMETHOD_(HRESULT, LowHealth)(THIS_ STRING LPWSTR pwszInstanceDescription,
                                 STRING LPWSTR * ppwszDescription,
                                 LONG * pDeferredTime,
                                 DIAGNOSTICS_STATUS * pStatus) PURE;
  STDMETHOD_(HRESULT, Repair)(THIS_ REPAIRINFO * pInfo, LONG * pDeferredTime,
                              REPAIR_STATUS * pStatus) PURE;
  STDMETHOD_(HRESULT, SetLifeTime)(THIS_ LIFE_TIME lifeTime) PURE;
  STDMETHOD_(HRESULT, Validate)(THIS_ PROBLEM_TYPE problem,
                                ULONG * pDeferredTime, REPAIR_STATUS * pStatus)
      PURE;
  END_INTERFACE
};
#ifdef COBJMACROS
...
#define INetDiagHelper_HighUtilization(                                        \
    This, pwszInstanceDescription, ppwszDescription, pDeferredTime, pStatus)   \
  (This)->lpVtbl->HighUtilization(This, pwszInstanceDescription,               \
                                  ppwszDescription, pDeferredTime, pStatus)
#define INetDiagHelper_Initialize(This, celt, rgAttributes)                    \
  (This)->lpVtbl->Initialize(This, celt, rgAttributes)
#define INetDiagHelper_LowHealth(This, pwszInstanceDescription,                \
                                 ppwszDescription, pDeferredTime, pStatus)     \
  (This)->lpVtbl->LowHealth(This, pwszInstanceDescription, ppwszDescription,   \
                            pDeferredTime, pStatus)
...
DECLARE_INTERFACE_(INetDiagHelperEx, IUnknown) {
  ...
  STDMETHOD_(HRESULT,
             ReconfirmLowHealth)(THIS_ ULONG celt, HypothesisResult * pResults,
                                 string LPWSTR * ppwszUpdatedDescription,
                                 DIAGNOSIS_STATUS * pUpdatedStatus) PURE;
...
#define INetDiagHelperEx_ReconfirmLowHealth(                                   \
    This, celt, pResults, ppwszUpdatedDescription, pUpdatedStatus)             \
  (This)->lpVtbl->ReconfirmLowHealth(This, celt, pResults,                     \
                                     ppwszUpdatedDescription, pUpdatedStatus)
#define INetDiagHelperEx_ReproduceFailure()                                    \
