...
DECLARE_INTERFACE_IID_(ID3DXFile, IUnknown,
  ...
  STDMETHOD(CreateSaveObject)(
      THIS_ const void *data, D3DXF_FILESAVEOPTIONS flags,
...
DECLARE_INTERFACE_IID_(ID3DXFileSaveObject, IUnknown,
  ...
  STDMETHOD(AddDataObject)(THIS_ REFGUID template_guid, const char *name,
                           const GUID *guid, SIZE_T data_size, const void *data,
                           struct ID3DXFileSaveData **obj) PURE;
  STDMETHOD(Save)(THIS) PURE;
};
#undef INTERFACE
#define INTERFACE ID3DXFileSaveData
DECLARE_INTERFACE_IID_(ID3DXFileSaveData, IUnknown,
...
DECLARE_INTERFACE_IID_(ID3DXFileEnumObject, IUnknown,
  ...
  STDMETHOD(GetDataObjectById)(THIS_ REFGUID guid, struct ID3DXFileData * *obj)
      PURE;
  STDMETHOD(GetDataObjectByName)(THIS_ const char *name,
                                 struct ID3DXFileData **obj) PURE;
};
#undef INTERFACE
#define INTERFACE ID3DXFileData
DECLARE_INTERFACE_IID_(ID3DXFileData, IUnknown,
