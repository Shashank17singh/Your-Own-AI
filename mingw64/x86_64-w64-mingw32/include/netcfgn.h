...
DEFINE_GUID(IID_INetCfgPnpReconfigCallback, 0x8d84bd35, 0xe227, 0x11d2, 0xb7,
            0x00, 0x00, 0xa0, 0xc9, 0x8a, 0x6a, 0x85);
...
INetCfgPnpReconfigCallback : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE SendPnpReconfig(
      NCPNP_RECONFIG_LAYER Layer, LPCWSTR pszwUpper, LPCWSTR pszwLower,
      PVOID pvData, DWORD dwSizeOfData) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(INetCfgPnpReconfigCallback, 0x8d84bd35, 0xe227, 0x11d2, 0xb7,
                0x00, 0x00, 0xa0, 0xc9, 0x8a, 0x6a, 0x85)
#endif
#else
typedef struct INetCfgPnpReconfigCallbackVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INetCfgPnpReconfigCallback *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(INetCfgPnpReconfigCallback *This);
  ULONG(STDMETHODCALLTYPE *Release)(INetCfgPnpReconfigCallback *This);
  /*** INetCfgPnpReconfigCallback methods ***/
  HRESULT(STDMETHODCALLTYPE *SendPnpReconfig)(INetCfgPnpReconfigCallback *This,
                                              NCPNP_RECONFIG_LAYER Layer,
                                              LPCWSTR pszwUpper,
                                              LPCWSTR pszwLower, PVOID pvData,
                                              DWORD dwSizeOfData);
  END_INTERFACE
...
/*** INetCfgPnpReconfigCallback methods ***/
#define INetCfgPnpReconfigCallback_SendPnpReconfig(                            \
    This, Layer, pszwUpper, pszwLower, pvData, dwSizeOfData)                   \
  (This)->lpVtbl->SendPnpReconfig(This, Layer, pszwUpper, pszwLower, pvData,   \
                                  dwSizeOfData)
#else
/*** IUnknown methods ***/
static inline HRESULT
INetCfgPnpReconfigCallback_QueryInterface(INetCfgPnpReconfigCallback *This,
                                          REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
INetCfgPnpReconfigCallback_AddRef(INetCfgPnpReconfigCallback *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
INetCfgPnpReconfigCallback_Release(INetCfgPnpReconfigCallback *This) {
  return This->lpVtbl->Release(This);
}
/*** INetCfgPnpReconfigCallback methods ***/
static inline HRESULT INetCfgPnpReconfigCallback_SendPnpReconfig(
    INetCfgPnpReconfigCallback *This, NCPNP_RECONFIG_LAYER Layer,
    LPCWSTR pszwUpper, LPCWSTR pszwLower, PVOID pvData, DWORD dwSizeOfData) {
  return This->lpVtbl->SendPnpReconfig(This, Layer, pszwUpper, pszwLower,
                                       pvData, dwSizeOfData);
}
#endif
#endif
...
DEFINE_GUID(IID_INetCfgComponentControl, 0x932238df, 0xbea1, 0x11d0, 0x92, 0x98,
            0x00, 0xc0, 0x4f, 0xc9, 0x9d, 0xcf);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("932238df-bea1-11d0-9298-00c04fc99dcf")
INetCfgComponentControl : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE Initialize(
      INetCfgComponent * pIComp, INetCfg * pINetCfg, WINBOOL fInstalling) = 0;
  virtual HRESULT STDMETHODCALLTYPE ApplyRegistryChanges() = 0;
  virtual HRESULT STDMETHODCALLTYPE ApplyPnpChanges(INetCfgPnpReconfigCallback *
                                                    pICallback) = 0;
  virtual HRESULT STDMETHODCALLTYPE CancelChanges() = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(INetCfgComponentControl, 0x932238df, 0xbea1, 0x11d0, 0x92, 0x98,
                0x00, 0xc0, 0x4f, 0xc9, 0x9d, 0xcf)
#endif
#else
typedef struct INetCfgComponentControlVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INetCfgComponentControl *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(INetCfgComponentControl *This);
  ULONG(STDMETHODCALLTYPE *Release)(INetCfgComponentControl *This);
  /*** INetCfgComponentControl methods ***/
  HRESULT(STDMETHODCALLTYPE *Initialize)(INetCfgComponentControl *This,
  ...
  HRESULT(STDMETHODCALLTYPE *ApplyPnpChanges)(
      INetCfgComponentControl *This, INetCfgPnpReconfigCallback *pICallback);
  HRESULT(STDMETHODCALLTYPE *CancelChanges)(INetCfgComponentControl *This);
  END_INTERFACE
...
/*** INetCfgComponentControl methods ***/
#define INetCfgComponentControl_Initialize(This, pIComp, pINetCfg,             \
                                           fInstalling)                        \
...
/*** IUnknown methods ***/
static inline HRESULT
INetCfgComponentControl_QueryInterface(INetCfgComponentControl *This,
                                       REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
INetCfgComponentControl_AddRef(INetCfgComponentControl *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
...
/*** INetCfgComponentControl methods ***/
static inline HRESULT
INetCfgComponentControl_Initialize(INetCfgComponentControl *This,
                                   INetCfgComponent *pIComp, INetCfg *pINetCfg,
                                   WINBOOL fInstalling) {
  return This->lpVtbl->Initialize(This, pIComp, pINetCfg, fInstalling);
}
static inline HRESULT
INetCfgComponentControl_ApplyRegistryChanges(INetCfgComponentControl *This) {
  return This->lpVtbl->ApplyRegistryChanges(This);
}
static inline HRESULT INetCfgComponentControl_ApplyPnpChanges(
    INetCfgComponentControl *This, INetCfgPnpReconfigCallback *pICallback) {
  return This->lpVtbl->ApplyPnpChanges(This, pICallback);
}
static inline HRESULT
INetCfgComponentControl_CancelChanges(INetCfgComponentControl *This) {
...
DEFINE_GUID(IID_INetCfgComponentSetup, 0x932238e3, 0xbea1, 0x11d0, 0x92, 0x98,
            0x00, 0xc0, 0x4f, 0xc9, 0x9d, 0xcf);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("932238e3-bea1-11d0-9298-00c04fc99dcf")
INetCfgComponentSetup : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE Install(DWORD dwSetupFlags) = 0;
  virtual HRESULT STDMETHODCALLTYPE Upgrade(DWORD dwSetupFlags,
                                            DWORD dwUpgradeFomBuildNo) = 0;
  virtual HRESULT STDMETHODCALLTYPE ReadAnswerFile(
      LPCWSTR pszwAnswerFile, LPCWSTR pszwAnswerSections) = 0;
  virtual HRESULT STDMETHODCALLTYPE Removing() = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(INetCfgComponentSetup, 0x932238e3, 0xbea1, 0x11d0, 0x92, 0x98,
                0x00, 0xc0, 0x4f, 0xc9, 0x9d, 0xcf)
#endif
#else
typedef struct INetCfgComponentSetupVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INetCfgComponentSetup *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(INetCfgComponentSetup *This);
  ULONG(STDMETHODCALLTYPE *Release)(INetCfgComponentSetup *This);
  /*** INetCfgComponentSetup methods ***/
  HRESULT(STDMETHODCALLTYPE *Install)(INetCfgComponentSetup *This,
                                      DWORD dwSetupFlags);
  HRESULT(STDMETHODCALLTYPE *Upgrade)(INetCfgComponentSetup *This,
                                      DWORD dwSetupFlags,
                                      DWORD dwUpgradeFomBuildNo);
  HRESULT(STDMETHODCALLTYPE *ReadAnswerFile)(INetCfgComponentSetup *This,
                                             LPCWSTR pszwAnswerFile,
                                             LPCWSTR pszwAnswerSections);
  HRESULT(STDMETHODCALLTYPE *Removing)(INetCfgComponentSetup *This);
  END_INTERFACE
...
#define INetCfgComponentSetup_ReadAnswerFile(This, pszwAnswerFile,             \
                                             pszwAnswerSections)               \
...
/*** IUnknown methods ***/
static inline HRESULT
INetCfgComponentSetup_QueryInterface(INetCfgComponentSetup *This, REFIID riid,
                                     void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** INetCfgComponentSetup methods ***/
static inline HRESULT INetCfgComponentSetup_Install(INetCfgComponentSetup *This,
                                                    DWORD dwSetupFlags) {
  return This->lpVtbl->Install(This, dwSetupFlags);
}
static inline HRESULT INetCfgComponentSetup_Upgrade(INetCfgComponentSetup *This,
                                                    DWORD dwSetupFlags,
                                                    DWORD dwUpgradeFomBuildNo) {
  return This->lpVtbl->Upgrade(This, dwSetupFlags, dwUpgradeFomBuildNo);
}
static inline HRESULT
INetCfgComponentSetup_ReadAnswerFile(INetCfgComponentSetup *This,
                                     LPCWSTR pszwAnswerFile,
                                     LPCWSTR pszwAnswerSections) {
  return This->lpVtbl->ReadAnswerFile(This, pszwAnswerFile, pszwAnswerSections);
}
static inline HRESULT
INetCfgComponentSetup_Removing(INetCfgComponentSetup *This) {
...
typedef enum tagDEFAULT_PAGES { DPP_ADVANCED = 1 } DEFAULT_PAGES;
DEFINE_GUID(IID_INetCfgComponentPropertyUi, 0x932238e0, 0xbea1, 0x11d0, 0x92,
            0x98, 0x00, 0xc0, 0x4f, 0xc9, 0x9d, 0xcf);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("932238e0-bea1-11d0-9298-00c04fc99dcf")
INetCfgComponentPropertyUi : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE QueryPropertyUi(IUnknown *
                                                    pUnkReserved) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetContext(IUnknown * pUnkReserved) = 0;
  virtual HRESULT STDMETHODCALLTYPE MergePropPages(
      DWORD * pdwDefPages, BYTE * *pahpspPrivate, UINT * pcPages,
      HWND hwndParent, LPCWSTR * pszStartPage) = 0;
  virtual HRESULT STDMETHODCALLTYPE ValidateProperties(HWND hwndSheet) = 0;
  virtual HRESULT STDMETHODCALLTYPE ApplyProperties() = 0;
  virtual HRESULT STDMETHODCALLTYPE CancelProperties() = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(INetCfgComponentPropertyUi, 0x932238e0, 0xbea1, 0x11d0, 0x92,
                0x98, 0x00, 0xc0, 0x4f, 0xc9, 0x9d, 0xcf)
#endif
#else
typedef struct INetCfgComponentPropertyUiVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INetCfgComponentPropertyUi *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(INetCfgComponentPropertyUi *This);
  ...
  HRESULT(STDMETHODCALLTYPE *MergePropPages)(INetCfgComponentPropertyUi *This,
                                             DWORD *pdwDefPages,
                                             BYTE **pahpspPrivate,
                                             UINT *pcPages, HWND hwndParent,
                                             LPCWSTR *pszStartPage);
  HRESULT(STDMETHODCALLTYPE *ValidateProperties)(
      INetCfgComponentPropertyUi *This, HWND hwndSheet);
  HRESULT(STDMETHODCALLTYPE *ApplyProperties)(INetCfgComponentPropertyUi *This);
...
#define INetCfgComponentPropertyUi_MergePropPages(                             \
    This, pdwDefPages, pahpspPrivate, pcPages, hwndParent, pszStartPage)       \
  (This)->lpVtbl->MergePropPages(This, pdwDefPages, pahpspPrivate, pcPages,    \
                                 hwndParent, pszStartPage)
...
/*** IUnknown methods ***/
static inline HRESULT
INetCfgComponentPropertyUi_QueryInterface(INetCfgComponentPropertyUi *This,
                                          REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
INetCfgComponentPropertyUi_AddRef(INetCfgComponentPropertyUi *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
...
/*** INetCfgComponentPropertyUi methods ***/
static inline HRESULT
INetCfgComponentPropertyUi_QueryPropertyUi(INetCfgComponentPropertyUi *This,
                                           IUnknown *pUnkReserved) {
  return This->lpVtbl->QueryPropertyUi(This, pUnkReserved);
}
static inline HRESULT
INetCfgComponentPropertyUi_SetContext(INetCfgComponentPropertyUi *This,
                                      IUnknown *pUnkReserved) {
  return This->lpVtbl->SetContext(This, pUnkReserved);
}
static inline HRESULT INetCfgComponentPropertyUi_MergePropPages(
    INetCfgComponentPropertyUi *This, DWORD *pdwDefPages, BYTE **pahpspPrivate,
    UINT *pcPages, HWND hwndParent, LPCWSTR *pszStartPage) {
  return This->lpVtbl->MergePropPages(This, pdwDefPages, pahpspPrivate, pcPages,
                                      hwndParent, pszStartPage);
}
static inline HRESULT
INetCfgComponentPropertyUi_ValidateProperties(INetCfgComponentPropertyUi *This,
                                              HWND hwndSheet) {
  return This->lpVtbl->ValidateProperties(This, hwndSheet);
}
static inline HRESULT
INetCfgComponentPropertyUi_ApplyProperties(INetCfgComponentPropertyUi *This) {
  return This->lpVtbl->ApplyProperties(This);
}
static inline HRESULT
INetCfgComponentPropertyUi_CancelProperties(INetCfgComponentPropertyUi *This) {
...
DEFINE_GUID(IID_INetCfgComponentNotifyBinding, 0x932238e1, 0xbea1, 0x11d0, 0x92,
            0x98, 0x00, 0xc0, 0x4f, 0xc9, 0x9d, 0xcf);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
INetCfgComponentNotifyBinding : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE QueryBindingPath(
      DWORD dwChangeFlag, INetCfgBindingPath * pIPath) = 0;
  virtual HRESULT STDMETHODCALLTYPE NotifyBindingPath(
      DWORD dwChangeFlag, INetCfgBindingPath * pIPath) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(INetCfgComponentNotifyBinding, 0x932238e1, 0xbea1, 0x11d0, 0x92,
                0x98, 0x00, 0xc0, 0x4f, 0xc9, 0x9d, 0xcf)
#endif
#else
typedef struct INetCfgComponentNotifyBindingVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(
      INetCfgComponentNotifyBinding *This, REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(INetCfgComponentNotifyBinding *This);
  ULONG(STDMETHODCALLTYPE *Release)(INetCfgComponentNotifyBinding *This);
  /*** INetCfgComponentNotifyBinding methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryBindingPath)(
      INetCfgComponentNotifyBinding *This, DWORD dwChangeFlag,
...
/*** INetCfgComponentNotifyBinding methods ***/
#define INetCfgComponentNotifyBinding_QueryBindingPath(This, dwChangeFlag,     \
                                                       pIPath)                 \
  (This)->lpVtbl->QueryBindingPath(This, dwChangeFlag, pIPath)
#define INetCfgComponentNotifyBinding_NotifyBindingPath(This, dwChangeFlag,    \
                                                        pIPath)                \
  (This)->lpVtbl->NotifyBindingPath(This, dwChangeFlag, pIPath)
#else
/*** IUnknown methods ***/
static inline HRESULT INetCfgComponentNotifyBinding_QueryInterface(
    INetCfgComponentNotifyBinding *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
INetCfgComponentNotifyBinding_AddRef(INetCfgComponentNotifyBinding *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
INetCfgComponentNotifyBinding_Release(INetCfgComponentNotifyBinding *This) {
  return This->lpVtbl->Release(This);
}
/*** INetCfgComponentNotifyBinding methods ***/
static inline HRESULT INetCfgComponentNotifyBinding_QueryBindingPath(
    INetCfgComponentNotifyBinding *This, DWORD dwChangeFlag,
    INetCfgBindingPath *pIPath) {
  return This->lpVtbl->QueryBindingPath(This, dwChangeFlag, pIPath);
}
static inline HRESULT INetCfgComponentNotifyBinding_NotifyBindingPath(
    INetCfgComponentNotifyBinding *This, DWORD dwChangeFlag,
    INetCfgBindingPath *pIPath) {
...
DEFINE_GUID(IID_INetCfgComponentNotifyGlobal, 0x932238e2, 0xbea1, 0x11d0, 0x92,
            0x98, 0x00, 0xc0, 0x4f, 0xc9, 0x9d, 0xcf);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
INetCfgComponentNotifyGlobal : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE SysNotifyComponent(
      DWORD dwChangeFlag, INetCfgComponent * pIComp) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(INetCfgComponentNotifyGlobal, 0x932238e2, 0xbea1, 0x11d0, 0x92,
                0x98, 0x00, 0xc0, 0x4f, 0xc9, 0x9d, 0xcf)
#endif
#else
typedef struct INetCfgComponentNotifyGlobalVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INetCfgComponentNotifyGlobal *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(INetCfgComponentNotifyGlobal *This);
  ULONG(STDMETHODCALLTYPE *Release)(INetCfgComponentNotifyGlobal *This);
  /*** INetCfgComponentNotifyGlobal methods ***/
  HRESULT(STDMETHODCALLTYPE *GetSupportedNotifications)(
      INetCfgComponentNotifyGlobal *This, DWORD *dwNotifications);
  HRESULT(STDMETHODCALLTYPE *SysQueryBindingPath)(
      INetCfgComponentNotifyGlobal *This, DWORD dwChangeFlag,
      INetCfgBindingPath *pIPath);
...
/*** INetCfgComponentNotifyGlobal methods ***/
#define INetCfgComponentNotifyGlobal_GetSupportedNotifications(                \
    This, dwNotifications)                                                     \
  (This)->lpVtbl->GetSupportedNotifications(This, dwNotifications)
#define INetCfgComponentNotifyGlobal_SysQueryBindingPath(This, dwChangeFlag,   \
                                                         pIPath)               \
  (This)->lpVtbl->SysQueryBindingPath(This, dwChangeFlag, pIPath)
#define INetCfgComponentNotifyGlobal_SysNotifyBindingPath(This, dwChangeFlag,  \
                                                          pIPath)              \
  (This)->lpVtbl->SysNotifyBindingPath(This, dwChangeFlag, pIPath)
#define INetCfgComponentNotifyGlobal_SysNotifyComponent(This, dwChangeFlag,    \
                                                        pIComp)                \
  (This)->lpVtbl->SysNotifyComponent(This, dwChangeFlag, pIComp)
#else
/*** IUnknown methods ***/
static inline HRESULT
INetCfgComponentNotifyGlobal_QueryInterface(INetCfgComponentNotifyGlobal *This,
                                            REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
INetCfgComponentNotifyGlobal_AddRef(INetCfgComponentNotifyGlobal *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
INetCfgComponentNotifyGlobal_Release(INetCfgComponentNotifyGlobal *This) {
  return This->lpVtbl->Release(This);
}
/*** INetCfgComponentNotifyGlobal methods ***/
static inline HRESULT INetCfgComponentNotifyGlobal_GetSupportedNotifications(
    INetCfgComponentNotifyGlobal *This, DWORD *dwNotifications) {
  return This->lpVtbl->GetSupportedNotifications(This, dwNotifications);
}
static inline HRESULT INetCfgComponentNotifyGlobal_SysQueryBindingPath(
    INetCfgComponentNotifyGlobal *This, DWORD dwChangeFlag,
    INetCfgBindingPath *pIPath) {
  return This->lpVtbl->SysQueryBindingPath(This, dwChangeFlag, pIPath);
}
static inline HRESULT INetCfgComponentNotifyGlobal_SysNotifyBindingPath(
    INetCfgComponentNotifyGlobal *This, DWORD dwChangeFlag,
    INetCfgBindingPath *pIPath) {
  return This->lpVtbl->SysNotifyBindingPath(This, dwChangeFlag, pIPath);
}
static inline HRESULT INetCfgComponentNotifyGlobal_SysNotifyComponent(
    INetCfgComponentNotifyGlobal *This, DWORD dwChangeFlag,
    INetCfgComponent *pIComp) {
...
DEFINE_GUID(IID_INetCfgComponentUpperEdge, 0x932238e4, 0xbea1, 0x11d0, 0x92,
            0x98, 0x00, 0xc0, 0x4f, 0xc9, 0x9d, 0xcf);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
INetCfgComponentUpperEdge : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetInterfaceIdsForAdapter(
      INetCfgComponent * pAdapter, DWORD * pdwNumInterfaces,
      GUID * *ppguidInterfaceIds) = 0;
  virtual HRESULT STDMETHODCALLTYPE AddInterfacesToAdapter(
      INetCfgComponent * pAdapter, DWORD dwNumInterfaces) = 0;
  virtual HRESULT STDMETHODCALLTYPE RemoveInterfacesFromAdapter(
      INetCfgComponent * pAdapter, DWORD dwNumInterfaces,
      const GUID *pguidInterfaceIds) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(INetCfgComponentUpperEdge, 0x932238e4, 0xbea1, 0x11d0, 0x92,
                0x98, 0x00, 0xc0, 0x4f, 0xc9, 0x9d, 0xcf)
#endif
#else
typedef struct INetCfgComponentUpperEdgeVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INetCfgComponentUpperEdge *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(INetCfgComponentUpperEdge *This);
  ULONG(STDMETHODCALLTYPE *Release)(INetCfgComponentUpperEdge *This);
  /*** INetCfgComponentUpperEdge methods ***/
  HRESULT(STDMETHODCALLTYPE *GetInterfaceIdsForAdapter)(
      INetCfgComponentUpperEdge *This, INetCfgComponent *pAdapter,
      DWORD *pdwNumInterfaces, GUID **ppguidInterfaceIds);
  HRESULT(STDMETHODCALLTYPE *AddInterfacesToAdapter)(
      INetCfgComponentUpperEdge *This, INetCfgComponent *pAdapter,
      DWORD dwNumInterfaces);
  HRESULT(STDMETHODCALLTYPE *RemoveInterfacesFromAdapter)(
      INetCfgComponentUpperEdge *This, INetCfgComponent *pAdapter,
      DWORD dwNumInterfaces, const GUID *pguidInterfaceIds);
  END_INTERFACE
...
/*** INetCfgComponentUpperEdge methods ***/
#define INetCfgComponentUpperEdge_GetInterfaceIdsForAdapter(                   \
    This, pAdapter, pdwNumInterfaces, ppguidInterfaceIds)                      \
  (This)->lpVtbl->GetInterfaceIdsForAdapter(This, pAdapter, pdwNumInterfaces,  \
                                            ppguidInterfaceIds)
#define INetCfgComponentUpperEdge_AddInterfacesToAdapter(This, pAdapter,       \
                                                         dwNumInterfaces)      \
  (This)->lpVtbl->AddInterfacesToAdapter(This, pAdapter, dwNumInterfaces)
#define INetCfgComponentUpperEdge_RemoveInterfacesFromAdapter(                 \
    This, pAdapter, dwNumInterfaces, pguidInterfaceIds)                        \
  (This)->lpVtbl->RemoveInterfacesFromAdapter(This, pAdapter, dwNumInterfaces, \
                                              pguidInterfaceIds)
#else
/*** IUnknown methods ***/
static inline HRESULT
INetCfgComponentUpperEdge_QueryInterface(INetCfgComponentUpperEdge *This,
                                         REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
INetCfgComponentUpperEdge_AddRef(INetCfgComponentUpperEdge *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
INetCfgComponentUpperEdge_Release(INetCfgComponentUpperEdge *This) {
  return This->lpVtbl->Release(This);
}
/*** INetCfgComponentUpperEdge methods ***/
static inline HRESULT INetCfgComponentUpperEdge_GetInterfaceIdsForAdapter(
    INetCfgComponentUpperEdge *This, INetCfgComponent *pAdapter,
    DWORD *pdwNumInterfaces, GUID **ppguidInterfaceIds) {
  return This->lpVtbl->GetInterfaceIdsForAdapter(
      This, pAdapter, pdwNumInterfaces, ppguidInterfaceIds);
}
static inline HRESULT INetCfgComponentUpperEdge_AddInterfacesToAdapter(
    INetCfgComponentUpperEdge *This, INetCfgComponent *pAdapter,
    DWORD dwNumInterfaces) {
  return This->lpVtbl->AddInterfacesToAdapter(This, pAdapter, dwNumInterfaces);
}
static inline HRESULT INetCfgComponentUpperEdge_RemoveInterfacesFromAdapter(
    INetCfgComponentUpperEdge *This, INetCfgComponent *pAdapter,
    DWORD dwNumInterfaces, const GUID *pguidInterfaceIds) {
  return This->lpVtbl->RemoveInterfacesFromAdapter(
      This, pAdapter, dwNumInterfaces, pguidInterfaceIds);
}
#endif
#endif
...
DEFINE_GUID(IID_INetLanConnectionUiInfo, 0xc08956a6, 0x1cd3, 0x11d1, 0xb1, 0xc5,
            0x00, 0x80, 0x5f, 0xc1, 0x27, 0x0e);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("c08956a6-1cd3-11d1-b1c5-00805fc1270e")
INetLanConnectionUiInfo : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetDeviceGuid(GUID * pguid) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(INetLanConnectionUiInfo, 0xc08956a6, 0x1cd3, 0x11d1, 0xb1, 0xc5,
                0x00, 0x80, 0x5f, 0xc1, 0x27, 0x0e)
#endif
#else
typedef struct INetLanConnectionUiInfoVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INetLanConnectionUiInfo *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(INetLanConnectionUiInfo *This);
  ULONG(STDMETHODCALLTYPE *Release)(INetLanConnectionUiInfo *This);
  /*** INetLanConnectionUiInfo methods ***/
  HRESULT(STDMETHODCALLTYPE *GetDeviceGuid)(INetLanConnectionUiInfo *This,
                                            GUID *pguid);
  END_INTERFACE
...
/*** IUnknown methods ***/
static inline HRESULT
INetLanConnectionUiInfo_QueryInterface(INetLanConnectionUiInfo *This,
                                       REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
INetLanConnectionUiInfo_AddRef(INetLanConnectionUiInfo *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
INetLanConnectionUiInfo_Release(INetLanConnectionUiInfo *This) {
  return This->lpVtbl->Release(This);
}
/*** INetLanConnectionUiInfo methods ***/
static inline HRESULT
INetLanConnectionUiInfo_GetDeviceGuid(INetLanConnectionUiInfo *This,
                                      GUID *pguid) {
...
DEFINE_GUID(IID_INetRasConnectionIpUiInfo, 0xfaedcf58, 0x31fe, 0x11d1, 0xaa,
...
INetRasConnectionIpUiInfo : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetUiInfo(RASCON_IPUI * pInfo) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(INetRasConnectionIpUiInfo, 0xfaedcf58, 0x31fe, 0x11d1, 0xaa,
                0xd2, 0x00, 0x80, 0x5f, 0xc1, 0x27, 0x0e)
#endif
#else
typedef struct INetRasConnectionIpUiInfoVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INetRasConnectionIpUiInfo *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(INetRasConnectionIpUiInfo *This);
  ULONG(STDMETHODCALLTYPE *Release)(INetRasConnectionIpUiInfo *This);
  /*** INetRasConnectionIpUiInfo methods ***/
  HRESULT(STDMETHODCALLTYPE *GetUiInfo)(INetRasConnectionIpUiInfo *This,
                                        RASCON_IPUI *pInfo);
  END_INTERFACE
...
/*** IUnknown methods ***/
static inline HRESULT
INetRasConnectionIpUiInfo_QueryInterface(INetRasConnectionIpUiInfo *This,
                                         REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
INetRasConnectionIpUiInfo_AddRef(INetRasConnectionIpUiInfo *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
INetRasConnectionIpUiInfo_Release(INetRasConnectionIpUiInfo *This) {
  return This->lpVtbl->Release(This);
}
/*** INetRasConnectionIpUiInfo methods ***/
static inline HRESULT
INetRasConnectionIpUiInfo_GetUiInfo(INetRasConnectionIpUiInfo *This,
                                    RASCON_IPUI *pInfo) {
...
DEFINE_GUID(IID_INetCfgComponentSysPrep, 0xc0e8ae9a, 0x306e, 0x11d1, 0xaa, 0xcf,
            0x00, 0x80, 0x5f, 0xc1, 0x27, 0x0e);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
INetCfgComponentSysPrep : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE SaveAdapterParameters(
      INetCfgSysPrep * pncsp, LPCWSTR pszwAnswerSections,
      GUID * pAdapterInstanceGuid) = 0;
  virtual HRESULT STDMETHODCALLTYPE RestoreAdapterParameters(
      LPCWSTR pszwAnswerFile, LPCWSTR pszwAnswerSection,
      GUID * pAdapterInstanceGuid) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(INetCfgComponentSysPrep, 0xc0e8ae9a, 0x306e, 0x11d1, 0xaa, 0xcf,
                0x00, 0x80, 0x5f, 0xc1, 0x27, 0x0e)
#endif
#else
typedef struct INetCfgComponentSysPrepVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INetCfgComponentSysPrep *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(INetCfgComponentSysPrep *This);
  ULONG(STDMETHODCALLTYPE *Release)(INetCfgComponentSysPrep *This);
  /*** INetCfgComponentSysPrep methods ***/
  HRESULT(STDMETHODCALLTYPE *SaveAdapterParameters)(
      INetCfgComponentSysPrep *This, INetCfgSysPrep *pncsp,
      LPCWSTR pszwAnswerSections, GUID *pAdapterInstanceGuid);
  HRESULT(STDMETHODCALLTYPE *RestoreAdapterParameters)(
      INetCfgComponentSysPrep *This, LPCWSTR pszwAnswerFile,
      LPCWSTR pszwAnswerSection, GUID *pAdapterInstanceGuid);
  END_INTERFACE
...
/*** INetCfgComponentSysPrep methods ***/
#define INetCfgComponentSysPrep_SaveAdapterParameters(                         \
    This, pncsp, pszwAnswerSections, pAdapterInstanceGuid)                     \
  (This)->lpVtbl->SaveAdapterParameters(This, pncsp, pszwAnswerSections,       \
                                        pAdapterInstanceGuid)
#define INetCfgComponentSysPrep_RestoreAdapterParameters(                      \
    This, pszwAnswerFile, pszwAnswerSection, pAdapterInstanceGuid)             \
  (This)->lpVtbl->RestoreAdapterParameters(                                    \
      This, pszwAnswerFile, pszwAnswerSection, pAdapterInstanceGuid)
#else
/*** IUnknown methods ***/
static inline HRESULT
INetCfgComponentSysPrep_QueryInterface(INetCfgComponentSysPrep *This,
                                       REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
INetCfgComponentSysPrep_AddRef(INetCfgComponentSysPrep *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
INetCfgComponentSysPrep_Release(INetCfgComponentSysPrep *This) {
  return This->lpVtbl->Release(This);
}
/*** INetCfgComponentSysPrep methods ***/
static inline HRESULT INetCfgComponentSysPrep_SaveAdapterParameters(
    INetCfgComponentSysPrep *This, INetCfgSysPrep *pncsp,
    LPCWSTR pszwAnswerSections, GUID *pAdapterInstanceGuid) {
  return This->lpVtbl->SaveAdapterParameters(This, pncsp, pszwAnswerSections,
                                             pAdapterInstanceGuid);
}
static inline HRESULT INetCfgComponentSysPrep_RestoreAdapterParameters(
    INetCfgComponentSysPrep *This, LPCWSTR pszwAnswerFile,
    LPCWSTR pszwAnswerSection, GUID *pAdapterInstanceGuid) {
  return This->lpVtbl->RestoreAdapterParameters(
      This, pszwAnswerFile, pszwAnswerSection, pAdapterInstanceGuid);
}
#endif
#endif
