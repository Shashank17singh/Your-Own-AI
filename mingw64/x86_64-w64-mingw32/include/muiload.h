...
HINSTANCE WINAPI LoadMUILibrary(LPCTSTR pszFullModuleName,
                                DWORD dwLangConvention, LANGID LangID);
WINBOOL WINAPI GetUILanguageFallbackList(PWSTR pFallbackList,
