...
public:
  virtual HRESULT WINAPI get_LocalParticipantTypedInfo(
      PARTICIPANT_TYPED_INFO InfoType, BSTR *ppInfo) = 0;
  virtual HRESULT WINAPI put_LocalParticipantTypedInfo(
      PARTICIPANT_TYPED_INFO InfoType, BSTR pInfo) = 0;
};
#else
typedef struct ITLocalParticipantVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITLocalParticipant *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITLocalParticipant *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITLocalParticipant *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITLocalParticipant *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *get_LocalParticipantTypedInfo)(
      ITLocalParticipant *This, PARTICIPANT_TYPED_INFO InfoType, BSTR *ppInfo);
  HRESULT(WINAPI *put_LocalParticipantTypedInfo)(
      ITLocalParticipant *This, PARTICIPANT_TYPED_INFO InfoType, BSTR pInfo);
  END_INTERFACE
...
#define ITLocalParticipant_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,  \
                                         rgDispId)                             \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITLocalParticipant_Invoke(This, dispIdMember, riid, lcid, wFlags,      \
                                  pDispParams, pVarResult, pExcepInfo,         \
                                  puArgErr)                                    \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
#define ITLocalParticipant_get_LocalParticipantTypedInfo(This, InfoType,       \
                                                         ppInfo)               \
  (This)->lpVtbl->get_LocalParticipantTypedInfo(This, InfoType, ppInfo)
#define ITLocalParticipant_put_LocalParticipantTypedInfo(This, InfoType,       \
                                                         pInfo)                \
  (This)->lpVtbl->put_LocalParticipantTypedInfo(This, InfoType, pInfo)
#endif
#endif
HRESULT WINAPI ITLocalParticipant_get_LocalParticipantTypedInfo_Proxy(
    ITLocalParticipant *This, PARTICIPANT_TYPED_INFO InfoType, BSTR *ppInfo);
...
HRESULT WINAPI ITLocalParticipant_put_LocalParticipantTypedInfo_Proxy(
    ITLocalParticipant *This, PARTICIPANT_TYPED_INFO InfoType, BSTR pInfo);
...
public:
  virtual HRESULT WINAPI Next(ULONG celt, ITParticipant **ppElements,
...
typedef struct IEnumParticipantVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IEnumParticipant *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IEnumParticipant *This);
  ULONG(WINAPI *Release)(IEnumParticipant *This);
  HRESULT(WINAPI *Next)(IEnumParticipant *This, ULONG celt,
                        ITParticipant **ppElements, ULONG *pceltFetched);
...
#endif
#endif
HRESULT WINAPI IEnumParticipant_Next_Proxy(IEnumParticipant *This, ULONG celt,
                                           ITParticipant **ppElements,
                                           ULONG *pceltFetched);
...
void __RPC_STUB IEnumParticipant_Skip_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumParticipant_Clone_Proxy(IEnumParticipant *This,
                                            IEnumParticipant **ppEnum);
...
public:
  ...
  EnumerateParticipants(IEnumParticipant **ppEnumParticipants) = 0;
  virtual HRESULT WINAPI get_Participants(VARIANT *pVariant) = 0;
};
#else
typedef struct ITParticipantControlVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITParticipantControl *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITParticipantControl *This, UINT iTInfo,
                               LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITParticipantControl *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITParticipantControl *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *EnumerateParticipants)(ITParticipantControl *This,
                                         IEnumParticipant **ppEnumParticipants);
  HRESULT(WINAPI *get_Participants)(ITParticipantControl *This,
                                    VARIANT *pVariant);
  END_INTERFACE
...
#define ITParticipantControl_GetTypeInfo(This, iTInfo, lcid, ppTInfo)          \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITParticipantControl_GetIDsOfNames(This, riid, rgszNames, cNames,      \
                                           lcid, rgDispId)                     \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITParticipantControl_Invoke(This, dispIdMember, riid, lcid, wFlags,    \
                                    pDispParams, pVarResult, pExcepInfo,       \
                                    puArgErr)                                  \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI ITParticipantControl_EnumerateParticipants_Proxy(
    ITParticipantControl *This, IEnumParticipant **ppEnumParticipants);
void __RPC_STUB ITParticipantControl_EnumerateParticipants_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITParticipantControl_get_Participants_Proxy(
    ITParticipantControl *This, VARIANT *pVariant);
...
public:
  virtual HRESULT WINAPI get_SubStreamFromParticipant(
      ITParticipant *pParticipant, ITSubStream **ppITSubStream) = 0;
  virtual HRESULT WINAPI get_ParticipantFromSubStream(
      ITSubStream *pITSubStream, ITParticipant **ppParticipant) = 0;
  virtual HRESULT WINAPI SwitchTerminalToSubStream(
      ITTerminal *pITTerminal, ITSubStream *pITSubStream) = 0;
};
#else
typedef struct ITParticipantSubStreamControlVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITParticipantSubStreamControl *This,
                                  REFIID riid, void **ppvObject);
  ULONG(WINAPI *AddRef)(ITParticipantSubStreamControl *This);
  ULONG(WINAPI *Release)(ITParticipantSubStreamControl *This);
  HRESULT(WINAPI *GetTypeInfoCount)(ITParticipantSubStreamControl *This,
                                    UINT *pctinfo);
  HRESULT(WINAPI *GetTypeInfo)(ITParticipantSubStreamControl *This, UINT iTInfo,
                               LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITParticipantSubStreamControl *This,
                                 REFIID riid, LPOLESTR *rgszNames, UINT cNames,
                                 LCID lcid, DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITParticipantSubStreamControl *This,
                          DISPID dispIdMember, REFIID riid, LCID lcid,
                          WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *get_SubStreamFromParticipant)(
      ITParticipantSubStreamControl *This, ITParticipant *pParticipant,
      ITSubStream **ppITSubStream);
  HRESULT(WINAPI *get_ParticipantFromSubStream)(
      ITParticipantSubStreamControl *This, ITSubStream *pITSubStream,
      ITParticipant **ppParticipant);
  HRESULT(WINAPI *SwitchTerminalToSubStream)(
      ITParticipantSubStreamControl *This, ITTerminal *pITTerminal,
...
#define ITParticipantSubStreamControl_GetTypeInfo(This, iTInfo, lcid, ppTInfo) \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITParticipantSubStreamControl_GetIDsOfNames(This, riid, rgszNames,     \
                                                    cNames, lcid, rgDispId)    \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITParticipantSubStreamControl_Invoke(This, dispIdMember, riid, lcid,   \
                                             wFlags, pDispParams, pVarResult,  \
                                             pExcepInfo, puArgErr)             \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
#define ITParticipantSubStreamControl_get_SubStreamFromParticipant(            \
    This, pParticipant, ppITSubStream)                                         \
  (This)->lpVtbl->get_SubStreamFromParticipant(This, pParticipant,             \
                                               ppITSubStream)
#define ITParticipantSubStreamControl_get_ParticipantFromSubStream(            \
    This, pITSubStream, ppParticipant)                                         \
  (This)->lpVtbl->get_ParticipantFromSubStream(This, pITSubStream,             \
                                               ppParticipant)
#define ITParticipantSubStreamControl_SwitchTerminalToSubStream(               \
    This, pITTerminal, pITSubStream)                                           \
...
void __RPC_STUB ITParticipantSubStreamControl_get_ParticipantFromSubStream_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITParticipantSubStreamControl_SwitchTerminalToSubStream_Proxy(
    ITParticipantSubStreamControl *This, ITTerminal *pITTerminal,
    ITSubStream *pITSubStream);
...
typedef struct ITParticipantEventVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITParticipantEvent *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITParticipantEvent *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITParticipantEvent *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITParticipantEvent *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *get_Event)(ITParticipantEvent *This,
                             PARTICIPANT_EVENT *pParticipantEvent);
  HRESULT(WINAPI *get_Participant)(ITParticipantEvent *This,
                                   ITParticipant **ppParticipant);
  HRESULT(WINAPI *get_SubStream)(ITParticipantEvent *This,
...
#define ITParticipantEvent_GetTypeInfo(This, iTInfo, lcid, ppTInfo)            \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITParticipantEvent_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,  \
                                         rgDispId)                             \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITParticipantEvent_Invoke(This, dispIdMember, riid, lcid, wFlags,      \
                                  pDispParams, pVarResult, pExcepInfo,         \
                                  puArgErr)                                    \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI ITParticipantEvent_get_Event_Proxy(
    ITParticipantEvent *This, PARTICIPANT_EVENT *pParticipantEvent);
void __RPC_STUB ITParticipantEvent_get_Event_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITParticipantEvent_get_Participant_Proxy(
    ITParticipantEvent *This, ITParticipant **ppParticipant);
void __RPC_STUB ITParticipantEvent_get_Participant_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITParticipantEvent_get_SubStream_Proxy(
    ITParticipantEvent *This, ITSubStream **ppSubStream);
...
typedef struct IMulticastControlVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMulticastControl *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IMulticastControl *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IMulticastControl *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IMulticastControl *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *get_LoopbackMode)(IMulticastControl *This,
                                    MULTICAST_LOOPBACK_MODE *pMode);
  HRESULT(WINAPI *put_LoopbackMode)(IMulticastControl *This,
                                    MULTICAST_LOOPBACK_MODE mode);
  END_INTERFACE
...
#define IMulticastControl_GetTypeInfo(This, iTInfo, lcid, ppTInfo)             \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IMulticastControl_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,   \
                                        rgDispId)                              \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IMulticastControl_Invoke(This, dispIdMember, riid, lcid, wFlags,       \
                                 pDispParams, pVarResult, pExcepInfo,          \
                                 puArgErr)                                     \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI IMulticastControl_get_LoopbackMode_Proxy(
    IMulticastControl *This, MULTICAST_LOOPBACK_MODE *pMode);
void __RPC_STUB IMulticastControl_get_LoopbackMode_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMulticastControl_put_LoopbackMode_Proxy(
    IMulticastControl *This, MULTICAST_LOOPBACK_MODE mode);
