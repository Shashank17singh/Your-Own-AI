...
IActivationFactory : public IInspectable {
  virtual HRESULT STDMETHODCALLTYPE ActivateInstance(IInspectable *
                                                     *instance) = 0;
};
...
typedef struct IActivationFactoryVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IActivationFactory *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IActivationFactory *This);
  ULONG(STDMETHODCALLTYPE *Release)(IActivationFactory *This);
  /*** IInspectable methods ***/
  HRESULT(STDMETHODCALLTYPE *GetIids)(IActivationFactory *This, ULONG *iidCount,
                                      IID **iids);
  HRESULT(STDMETHODCALLTYPE *GetRuntimeClassName)(IActivationFactory *This,
                                                  HSTRING *className);
  HRESULT(STDMETHODCALLTYPE *GetTrustLevel)(IActivationFactory *This,
                                            TrustLevel *trustLevel);
  /*** IActivationFactory methods ***/
  HRESULT(STDMETHODCALLTYPE *ActivateInstance)(IActivationFactory *This,
                                               IInspectable **instance);
  END_INTERFACE
} IActivationFactoryVtbl;
interface IActivationFactory { CONST_VTBL IActivationFactoryVtbl *lpVtbl; };
#ifdef COBJMACROS
...
IActivationFactory_QueryInterface(IActivationFactory *This, REFIID riid,
                                  void **ppvObject) {
...
/*** IInspectable methods ***/
static inline HRESULT IActivationFactory_GetIids(IActivationFactory *This,
                                                 ULONG *iidCount, IID **iids) {
  return This->lpVtbl->GetIids(This, iidCount, iids);
}
static inline HRESULT
IActivationFactory_GetRuntimeClassName(IActivationFactory *This,
                                       HSTRING *className) {
  return This->lpVtbl->GetRuntimeClassName(This, className);
}
static inline HRESULT IActivationFactory_GetTrustLevel(IActivationFactory *This,
                                                       TrustLevel *trustLevel) {
  return This->lpVtbl->GetTrustLevel(This, trustLevel);
}
/*** IActivationFactory methods ***/
static inline HRESULT
IActivationFactory_ActivateInstance(IActivationFactory *This,
                                    IInspectable **instance) {
