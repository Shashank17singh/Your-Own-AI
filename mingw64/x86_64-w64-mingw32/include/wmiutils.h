...
public:
  ...
  virtual HRESULT WINAPI SetKey(LPCWSTR wszName, ULONG uFlags, ULONG uCimType,
                                LPVOID pKeyVal) = 0;
  virtual HRESULT WINAPI SetKey2(LPCWSTR wszName, ULONG uFlags, ULONG uCimType,
                                 VARIANT *pKeyVal) = 0;
  virtual HRESULT WINAPI GetKey(ULONG uKeyIx, ULONG uFlags,
                                ULONG *puNameBufSize, LPWSTR pszKeyName,
                                ULONG *puKeyValBufSize, LPVOID pKeyVal,
                                ULONG *puApparentCimType) = 0;
  virtual HRESULT WINAPI GetKey2(ULONG uKeyIx, ULONG uFlags,
                                 ULONG *puNameBufSize, LPWSTR pszKeyName,
                                 VARIANT *pKeyValue,
                                 ULONG *puApparentCimType) = 0;
  ...
  virtual HRESULT WINAPI GetInfo(ULONG uRequestedInfo,
                                 ULONGLONG *puResponse) = 0;
  virtual HRESULT WINAPI GetText(__LONG32 lFlags, ULONG *puBuffLength,
                                 LPWSTR pszText) = 0;
};
#else
typedef struct IWbemPathKeyListVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IWbemPathKeyList *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *SetKey)(IWbemPathKeyList *This, LPCWSTR wszName, ULONG uFlags,
                          ULONG uCimType, LPVOID pKeyVal);
  HRESULT(WINAPI *SetKey2)(IWbemPathKeyList *This, LPCWSTR wszName,
                           ULONG uFlags, ULONG uCimType, VARIANT *pKeyVal);
  HRESULT(WINAPI *GetKey)(IWbemPathKeyList *This, ULONG uKeyIx, ULONG uFlags,
                          ULONG *puNameBufSize, LPWSTR pszKeyName,
                          ULONG *puKeyValBufSize, LPVOID pKeyVal,
                          ULONG *puApparentCimType);
  HRESULT(WINAPI *GetKey2)(IWbemPathKeyList *This, ULONG uKeyIx, ULONG uFlags,
                           ULONG *puNameBufSize, LPWSTR pszKeyName,
                           VARIANT *pKeyValue, ULONG *puApparentCimType);
  HRESULT(WINAPI *RemoveKey)(IWbemPathKeyList *This, LPCWSTR wszName,
                             ULONG uFlags);
  ...
  HRESULT(WINAPI *GetInfo)(IWbemPathKeyList *This, ULONG uRequestedInfo,
                           ULONGLONG *puResponse);
  HRESULT(WINAPI *GetText)(IWbemPathKeyList *This, __LONG32 lFlags,
                           ULONG *puBuffLength, LPWSTR pszText);
  END_INTERFACE
...
#define IWbemPathKeyList_GetKey(This, uKeyIx, uFlags, puNameBufSize,           \
                                pszKeyName, puKeyValBufSize, pKeyVal,          \
                                puApparentCimType)                             \
  (This)->lpVtbl->GetKey(This, uKeyIx, uFlags, puNameBufSize, pszKeyName,      \
                         puKeyValBufSize, pKeyVal, puApparentCimType)
#define IWbemPathKeyList_GetKey2(This, uKeyIx, uFlags, puNameBufSize,          \
                                 pszKeyName, pKeyValue, puApparentCimType)     \
  (This)->lpVtbl->GetKey2(This, uKeyIx, uFlags, puNameBufSize, pszKeyName,     \
...
#endif
#endif
HRESULT WINAPI IWbemPathKeyList_GetCount_Proxy(IWbemPathKeyList *This,
                                               ULONG *puKeyCount);
...
HRESULT WINAPI IWbemPathKeyList_SetKey_Proxy(IWbemPathKeyList *This,
                                             LPCWSTR wszName, ULONG uFlags,
                                             ULONG uCimType, LPVOID pKeyVal);
void __RPC_STUB IWbemPathKeyList_SetKey_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IWbemPathKeyList_SetKey2_Proxy(IWbemPathKeyList *This,
                                              LPCWSTR wszName, ULONG uFlags,
                                              ULONG uCimType, VARIANT *pKeyVal);
void __RPC_STUB IWbemPathKeyList_SetKey2_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IWbemPathKeyList_GetKey_Proxy(
    IWbemPathKeyList *This, ULONG uKeyIx, ULONG uFlags, ULONG *puNameBufSize,
    LPWSTR pszKeyName, ULONG *puKeyValBufSize, LPVOID pKeyVal,
    ULONG *puApparentCimType);
void __RPC_STUB IWbemPathKeyList_GetKey_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IWbemPathKeyList_GetKey2_Proxy(
    IWbemPathKeyList *This, ULONG uKeyIx, ULONG uFlags, ULONG *puNameBufSize,
    LPWSTR pszKeyName, VARIANT *pKeyValue, ULONG *puApparentCimType);
void __RPC_STUB IWbemPathKeyList_GetKey2_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IWbemPathKeyList_RemoveKey_Proxy(IWbemPathKeyList *This,
                                                LPCWSTR wszName, ULONG uFlags);
void __RPC_STUB IWbemPathKeyList_RemoveKey_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IWbemPathKeyList_RemoveAllKeys_Proxy(IWbemPathKeyList *This,
                                                    ULONG uFlags);
void __RPC_STUB IWbemPathKeyList_RemoveAllKeys_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IWbemPathKeyList_MakeSingleton_Proxy(IWbemPathKeyList *This,
                                                    boolean bSet);
void __RPC_STUB IWbemPathKeyList_MakeSingleton_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IWbemPathKeyList_GetInfo_Proxy(IWbemPathKeyList *This,
                                              ULONG uRequestedInfo,
                                              ULONGLONG *puResponse);
void __RPC_STUB IWbemPathKeyList_GetInfo_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IWbemPathKeyList_GetText_Proxy(IWbemPathKeyList *This,
                                              __LONG32 lFlags,
                                              ULONG *puBuffLength,
                                              LPWSTR pszText);
...
public:
  ...
  virtual HRESULT WINAPI GetNamespaceAt(ULONG uIndex, ULONG *puNameBufLength,
                                        LPWSTR pName) = 0;
  ...
  virtual HRESULT WINAPI GetScope(ULONG uIndex, ULONG *puClassNameBufSize,
                                  LPWSTR pszClass,
                                  IWbemPathKeyList **pKeyList) = 0;
  virtual HRESULT WINAPI GetScopeAsText(ULONG uIndex, ULONG *puTextBufSize,
                                        LPWSTR pszText) = 0;
  ...
  virtual WINBOOL WINAPI IsRelativeOrChild(LPWSTR wszMachine,
                                           LPWSTR wszNamespace,
                                           __LONG32 lFlags) = 0;
...
typedef struct IWbemPathVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IWbemPath *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetText)(IWbemPath *This, __LONG32 lFlags,
                           ULONG *puBuffLength, LPWSTR pszText);
  HRESULT(WINAPI *GetInfo)(IWbemPath *This, ULONG uRequestedInfo,
                           ULONGLONG *puResponse);
  HRESULT(WINAPI *SetServer)(IWbemPath *This, LPCWSTR Name);
  HRESULT(WINAPI *GetServer)(IWbemPath *This, ULONG *puNameBufLength,
                             LPWSTR pName);
  HRESULT(WINAPI *GetNamespaceCount)(IWbemPath *This, ULONG *puCount);
  HRESULT(WINAPI *SetNamespaceAt)(IWbemPath *This, ULONG uIndex,
                                  LPCWSTR pszName);
  HRESULT(WINAPI *GetNamespaceAt)(IWbemPath *This, ULONG uIndex,
                                  ULONG *puNameBufLength, LPWSTR pName);
  ...
  HRESULT(WINAPI *SetScopeFromText)(IWbemPath *This, ULONG uIndex,
                                    LPWSTR pszText);
  HRESULT(WINAPI *GetScope)(IWbemPath *This, ULONG uIndex,
                            ULONG *puClassNameBufSize, LPWSTR pszClass,
                            IWbemPathKeyList **pKeyList);
  HRESULT(WINAPI *GetScopeAsText)(IWbemPath *This, ULONG uIndex,
                                  ULONG *puTextBufSize, LPWSTR pszText);
  ...
  HRESULT(WINAPI *GetClassName)(IWbemPath *This, ULONG *puBuffLength,
                                LPWSTR pszName);
  HRESULT(WINAPI *GetKeyList)(IWbemPath *This, IWbemPathKeyList **pOut);
  HRESULT(WINAPI *CreateClassPart)(IWbemPath *This, __LONG32 lFlags,
                                   LPCWSTR Name);
  HRESULT(WINAPI *DeleteClassPart)(IWbemPath *This, __LONG32 lFlags);
  WINBOOL(WINAPI *IsRelative)(IWbemPath *This, LPWSTR wszMachine,
                              LPWSTR wszNamespace);
  WINBOOL(WINAPI *IsRelativeOrChild)(IWbemPath *This, LPWSTR wszMachine,
                                     LPWSTR wszNamespace, __LONG32 lFlags);
...
#endif
#endif
HRESULT WINAPI IWbemPath_SetText_Proxy(IWbemPath *This, ULONG uMode,
                                       LPCWSTR pszPath);
void __RPC_STUB IWbemPath_SetText_Stub(IRpcStubBuffer *This,
                                       IRpcChannelBuffer *_pRpcChannelBuffer,
                                       PRPC_MESSAGE _pRpcMessage,
                                       DWORD *_pdwStubPhase);
HRESULT WINAPI IWbemPath_GetText_Proxy(IWbemPath *This, __LONG32 lFlags,
                                       ULONG *puBuffLength, LPWSTR pszText);
void __RPC_STUB IWbemPath_GetText_Stub(IRpcStubBuffer *This,
                                       IRpcChannelBuffer *_pRpcChannelBuffer,
                                       PRPC_MESSAGE _pRpcMessage,
                                       DWORD *_pdwStubPhase);
HRESULT WINAPI IWbemPath_GetInfo_Proxy(IWbemPath *This, ULONG uRequestedInfo,
                                       ULONGLONG *puResponse);
void __RPC_STUB IWbemPath_GetInfo_Stub(IRpcStubBuffer *This,
                                       IRpcChannelBuffer *_pRpcChannelBuffer,
                                       PRPC_MESSAGE _pRpcMessage,
                                       DWORD *_pdwStubPhase);
HRESULT WINAPI IWbemPath_SetServer_Proxy(IWbemPath *This, LPCWSTR Name);
void __RPC_STUB IWbemPath_SetServer_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
HRESULT WINAPI IWbemPath_GetServer_Proxy(IWbemPath *This,
                                         ULONG *puNameBufLength, LPWSTR pName);
void __RPC_STUB IWbemPath_GetServer_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
HRESULT WINAPI IWbemPath_GetNamespaceCount_Proxy(IWbemPath *This,
                                                 ULONG *puCount);
void __RPC_STUB IWbemPath_GetNamespaceCount_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IWbemPath_SetNamespaceAt_Proxy(IWbemPath *This, ULONG uIndex,
                                              LPCWSTR pszName);
void __RPC_STUB IWbemPath_SetNamespaceAt_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IWbemPath_GetNamespaceAt_Proxy(IWbemPath *This, ULONG uIndex,
...
void __RPC_STUB IWbemPath_GetScopeCount_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IWbemPath_SetScope_Proxy(IWbemPath *This, ULONG uIndex,
                                        LPWSTR pszClass);
void __RPC_STUB IWbemPath_SetScope_Stub(IRpcStubBuffer *This,
                                        IRpcChannelBuffer *_pRpcChannelBuffer,
                                        PRPC_MESSAGE _pRpcMessage,
                                        DWORD *_pdwStubPhase);
HRESULT WINAPI IWbemPath_SetScopeFromText_Proxy(IWbemPath *This, ULONG uIndex,
                                                LPWSTR pszText);
void __RPC_STUB IWbemPath_SetScopeFromText_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IWbemPath_GetScope_Proxy(IWbemPath *This, ULONG uIndex,
                                        ULONG *puClassNameBufSize,
                                        LPWSTR pszClass,
                                        IWbemPathKeyList **pKeyList);
void __RPC_STUB IWbemPath_GetScope_Stub(IRpcStubBuffer *This,
                                        IRpcChannelBuffer *_pRpcChannelBuffer,
                                        PRPC_MESSAGE _pRpcMessage,
                                        DWORD *_pdwStubPhase);
HRESULT WINAPI IWbemPath_GetScopeAsText_Proxy(IWbemPath *This, ULONG uIndex,
                                              ULONG *puTextBufSize,
                                              LPWSTR pszText);
...
void __RPC_STUB IWbemPath_SetClassName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IWbemPath_GetClassName_Proxy(IWbemPath *This,
                                            ULONG *puBuffLength,
                                            LPWSTR pszName);
void __RPC_STUB IWbemPath_GetClassName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IWbemPath_GetKeyList_Proxy(IWbemPath *This,
                                          IWbemPathKeyList **pOut);
void __RPC_STUB IWbemPath_GetKeyList_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI IWbemPath_CreateClassPart_Proxy(IWbemPath *This, __LONG32 lFlags,
                                               LPCWSTR Name);
void __RPC_STUB IWbemPath_CreateClassPart_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IWbemPath_DeleteClassPart_Proxy(IWbemPath *This,
                                               __LONG32 lFlags);
void __RPC_STUB IWbemPath_DeleteClassPart_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
WINBOOL WINAPI IWbemPath_IsRelative_Proxy(IWbemPath *This, LPWSTR wszMachine,
                                          LPWSTR wszNamespace);
void __RPC_STUB IWbemPath_IsRelative_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
WINBOOL WINAPI IWbemPath_IsRelativeOrChild_Proxy(IWbemPath *This,
                                                 LPWSTR wszMachine,
                                                 LPWSTR wszNamespace,
                                                 __LONG32 lFlags);
...
void __RPC_STUB IWbemPath_IsLocal_Stub(IRpcStubBuffer *This,
                                       IRpcChannelBuffer *_pRpcChannelBuffer,
                                       PRPC_MESSAGE _pRpcMessage,
                                       DWORD *_pdwStubPhase);
WINBOOL WINAPI IWbemPath_IsSameClassName_Proxy(IWbemPath *This,
                                               LPCWSTR wszClass);
...
public:
  ...
  virtual HRESULT WINAPI SetLanguageFeatures(ULONG uFlags, ULONG uArraySize,
                                             ULONG *puFeatures) = 0;
  virtual HRESULT WINAPI TestLanguageFeatures(ULONG uFlags, ULONG *uArraySize,
                                              ULONG *puFeatures) = 0;
  virtual HRESULT WINAPI Parse(LPCWSTR pszLang, LPCWSTR pszQuery,
                               ULONG uFlags) = 0;
  virtual HRESULT WINAPI GetAnalysis(ULONG uAnalysisType, ULONG uFlags,
                                     LPVOID *pAnalysis) = 0;
  virtual HRESULT WINAPI FreeMemory(LPVOID pMem) = 0;
  virtual HRESULT WINAPI GetQueryInfo(ULONG uAnalysisType, ULONG uInfoId,
                                      ULONG uBufSize, LPVOID pDestBuf) = 0;
};
#else
typedef struct IWbemQueryVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IWbemQuery *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IWbemQuery *This);
  ULONG(WINAPI *Release)(IWbemQuery *This);
  HRESULT(WINAPI *Empty)(IWbemQuery *This);
  HRESULT(WINAPI *SetLanguageFeatures)(IWbemQuery *This, ULONG uFlags,
                                       ULONG uArraySize, ULONG *puFeatures);
  HRESULT(WINAPI *TestLanguageFeatures)(IWbemQuery *This, ULONG uFlags,
                                        ULONG *uArraySize, ULONG *puFeatures);
  HRESULT(WINAPI *Parse)(IWbemQuery *This, LPCWSTR pszLang, LPCWSTR pszQuery,
                         ULONG uFlags);
  HRESULT(WINAPI *GetAnalysis)(IWbemQuery *This, ULONG uAnalysisType,
                               ULONG uFlags, LPVOID *pAnalysis);
  HRESULT(WINAPI *FreeMemory)(IWbemQuery *This, LPVOID pMem);
  HRESULT(WINAPI *GetQueryInfo)(IWbemQuery *This, ULONG uAnalysisType,
                                ULONG uInfoId, ULONG uBufSize, LPVOID pDestBuf);
  END_INTERFACE
} IWbemQueryVtbl;
struct IWbemQuery {
...
#define IWbemQuery_GetQueryInfo(This, uAnalysisType, uInfoId, uBufSize,        \
                                pDestBuf)                                      \
...
void __RPC_STUB IWbemQuery_Empty_Stub(IRpcStubBuffer *This,
                                      IRpcChannelBuffer *_pRpcChannelBuffer,
                                      PRPC_MESSAGE _pRpcMessage,
                                      DWORD *_pdwStubPhase);
HRESULT WINAPI IWbemQuery_SetLanguageFeatures_Proxy(IWbemQuery *This,
                                                    ULONG uFlags,
                                                    ULONG uArraySize,
                                                    ULONG *puFeatures);
void __RPC_STUB IWbemQuery_SetLanguageFeatures_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IWbemQuery_TestLanguageFeatures_Proxy(IWbemQuery *This,
                                                     ULONG uFlags,
                                                     ULONG *uArraySize,
                                                     ULONG *puFeatures);
void __RPC_STUB IWbemQuery_TestLanguageFeatures_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IWbemQuery_Parse_Proxy(IWbemQuery *This, LPCWSTR pszLang,
                                      LPCWSTR pszQuery, ULONG uFlags);
void __RPC_STUB IWbemQuery_Parse_Stub(IRpcStubBuffer *This,
                                      IRpcChannelBuffer *_pRpcChannelBuffer,
                                      PRPC_MESSAGE _pRpcMessage,
                                      DWORD *_pdwStubPhase);
HRESULT WINAPI IWbemQuery_GetAnalysis_Proxy(IWbemQuery *This,
                                            ULONG uAnalysisType, ULONG uFlags,
                                            LPVOID *pAnalysis);
...
void __RPC_STUB IWbemQuery_FreeMemory_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IWbemQuery_GetQueryInfo_Proxy(IWbemQuery *This,
                                             ULONG uAnalysisType, ULONG uInfoId,
                                             ULONG uBufSize, LPVOID pDestBuf);
