...
#include <olectl.h>
#endif
DEFINE_GUID(IID_IProvideMultipleClassInfo, 0xa7aba9c1, 0x8983, 0x11cf, 0x8f,
...
public:
  ...
  virtual HRESULT WINAPI GetInfoOfIndex(ULONG iti, DWORD dwFlags,
                                        ITypeInfo **pptiCoClass,
                                        DWORD *pdwTIFlags,
                                        ULONG *pcdispidReserved,
                                        IID *piidPrimary, IID *piidSource) = 0;
};
#else
typedef struct IProvideMultipleClassInfoVtbl {
  HRESULT(WINAPI *QueryInterface)(IProvideMultipleClassInfo *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IProvideMultipleClassInfo *This);
  ULONG(WINAPI *Release)(IProvideMultipleClassInfo *This);
  HRESULT(WINAPI *GetClassInfo)(IProvideMultipleClassInfo *This,
                                LPTYPEINFO *ppTI);
  HRESULT(WINAPI *GetGUID)(IProvideMultipleClassInfo *This, DWORD dwGuidKind,
                           GUID *pGUID);
  HRESULT(WINAPI *GetMultiTypeInfoCount)(IProvideMultipleClassInfo *This,
                                         ULONG *pcti);
  HRESULT(WINAPI *GetInfoOfIndex)(IProvideMultipleClassInfo *This, ULONG iti,
                                  DWORD dwFlags, ITypeInfo **pptiCoClass,
                                  DWORD *pdwTIFlags, ULONG *pcdispidReserved,
...
#define IProvideMultipleClassInfo_GetInfoOfIndex(                              \
    This, iti, dwFlags, pptiCoClass, pdwTIFlags, pcdispidReserved,             \
    piidPrimary, piidSource)                                                   \
  (This)->lpVtbl->GetInfoOfIndex(This, iti, dwFlags, pptiCoClass, pdwTIFlags,  \
                                 pcdispidReserved, piidPrimary, piidSource)
#endif
#endif
HRESULT WINAPI IProvideMultipleClassInfo_GetMultiTypeInfoCount_Proxy(
    IProvideMultipleClassInfo *This, ULONG *pcti);
...
HRESULT WINAPI IProvideMultipleClassInfo_GetInfoOfIndex_Proxy(
    IProvideMultipleClassInfo *This, ULONG iti, DWORD dwFlags,
