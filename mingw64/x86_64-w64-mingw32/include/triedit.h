...
public:
  virtual HRESULT WINAPI FilterIn(IUnknown *pStmOld, IUnknown **ppStmNew,
                                  DWORD dwFlags, BSTR bstrBaseURL) = 0;
  virtual HRESULT WINAPI FilterOut(IUnknown *pStmOld, IUnknown **ppStmNew,
                                   DWORD dwFlags, BSTR bstrBaseURL) = 0;
};
#else
typedef struct ITriEditDocumentVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITriEditDocument *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITriEditDocument *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITriEditDocument *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITriEditDocument *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *FilterIn)(ITriEditDocument *This, IUnknown *pStmOld,
                            IUnknown **ppStmNew, DWORD dwFlags,
                            BSTR bstrBaseURL);
  HRESULT(WINAPI *FilterOut)(ITriEditDocument *This, IUnknown *pStmOld,
                             IUnknown **ppStmNew, DWORD dwFlags,
                             BSTR bstrBaseURL);
  END_INTERFACE
...
#define ITriEditDocument_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,    \
                                       rgDispId)                               \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITriEditDocument_Invoke(This, dispIdMember, riid, lcid, wFlags,        \
                                pDispParams, pVarResult, pExcepInfo, puArgErr) \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
#define ITriEditDocument_FilterIn(This, pStmOld, ppStmNew, dwFlags,            \
                                  bstrBaseURL)                                 \
  (This)->lpVtbl->FilterIn(This, pStmOld, ppStmNew, dwFlags, bstrBaseURL)
#define ITriEditDocument_FilterOut(This, pStmOld, ppStmNew, dwFlags,           \
                                   bstrBaseURL)                                \
  (This)->lpVtbl->FilterOut(This, pStmOld, ppStmNew, dwFlags, bstrBaseURL)
#endif
#endif
HRESULT WINAPI ITriEditDocument_FilterIn_Proxy(ITriEditDocument *This,
                                               IUnknown *pStmOld,
                                               IUnknown **ppStmNew,
...
HRESULT WINAPI ITriEditDocument_FilterOut_Proxy(ITriEditDocument *This,
                                                IUnknown *pStmOld,
                                                IUnknown **ppStmNew,
                                                DWORD dwFlags,
                                                BSTR bstrBaseURL);
...
typedef struct IDocHostDragDropHandlerVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IDocHostDragDropHandler *This, REFIID riid,
                                  void **ppvObject);
...
#endif
#endif
HRESULT WINAPI IDocHostDragDropHandler_DrawDragFeedback_Proxy(
    IDocHostDragDropHandler *This, RECT *pRect);
