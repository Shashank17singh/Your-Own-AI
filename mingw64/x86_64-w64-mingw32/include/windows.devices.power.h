/*** Autogenerated by WIDL 11.5 from include/windows.devices.power.idl - Do not
 * edit ***/
#ifdef _WIN32
...
typedef interface __x_ABI_CWindows_CDevices_CPower_CIBatteryReport
    __x_ABI_CWindows_CDevices_CPower_CIBatteryReport;
#ifdef __cplusplus
#define __x_ABI_CWindows_CDevices_CPower_CIBatteryReport                       \
  ABI::Windows::Devices::Power::IBatteryReport
namespace ABI {
namespace Windows {
namespace Devices {
namespace Power {
...
#else
typedef struct __x_ABI_CWindows_CDevices_CPower_CBatteryReport
    __x_ABI_CWindows_CDevices_CPower_CBatteryReport;
#endif /* defined __cplusplus */
#endif /* defined                                                              \
          ____x_ABI_CWindows_CDevices_CPower_CBatteryReport_FWD_DEFINED__ */
...
DEFINE_GUID(IID___x_ABI_CWindows_CDevices_CPower_CIBatteryReport, 0xc9858c3a,
            0x4e13, 0x420a, 0xa8, 0xd0, 0x24, 0xf1, 0x8f, 0x39, 0x54, 0x01);
...
__CRT_UUID_DECL(__x_ABI_CWindows_CDevices_CPower_CIBatteryReport, 0xc9858c3a,
                0x4e13, 0x420a, 0xa8, 0xd0, 0x24, 0xf1, 0x8f, 0x39, 0x54, 0x01)
#endif
#else
typedef struct __x_ABI_CWindows_CDevices_CPower_CIBatteryReportVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(
      __x_ABI_CWindows_CDevices_CPower_CIBatteryReport *This, REFIID riid,
      void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetIids)(
      __x_ABI_CWindows_CDevices_CPower_CIBatteryReport *This, ULONG *iidCount,
      IID **iids);
...
/*** IUnknown methods ***/
#define __x_ABI_CWindows_CDevices_CPower_CIBatteryReport_QueryInterface(       \
    This, riid, ppvObject)                                                     \
...
/*** IInspectable methods ***/
#define __x_ABI_CWindows_CDevices_CPower_CIBatteryReport_GetIids(              \
    This, iidCount, iids)                                                      \
  (This)->lpVtbl->GetIids(This, iidCount, iids)
#define __x_ABI_CWindows_CDevices_CPower_CIBatteryReport_GetRuntimeClassName(  \
    This, className)                                                           \
  (This)->lpVtbl->GetRuntimeClassName(This, className)
#define __x_ABI_CWindows_CDevices_CPower_CIBatteryReport_GetTrustLevel(        \
    This, trustLevel)                                                          \
  (This)->lpVtbl->GetTrustLevel(This, trustLevel)
/*** IBatteryReport methods ***/
#define __x_ABI_CWindows_CDevices_CPower_CIBatteryReport_get_ChargeRateInMilliwatts( \
    This, value)                                                                     \
  (This)->lpVtbl->get_ChargeRateInMilliwatts(This, value)
#define __x_ABI_CWindows_CDevices_CPower_CIBatteryReport_get_DesignCapacityInMilliwattHours( \
    This, value)                                                                             \
  (This)->lpVtbl->get_DesignCapacityInMilliwattHours(This, value)
#define __x_ABI_CWindows_CDevices_CPower_CIBatteryReport_get_FullChargeCapacityInMilliwattHours( \
    This, value)                                                                                 \
  (This)->lpVtbl->get_FullChargeCapacityInMilliwattHours(This, value)
#define __x_ABI_CWindows_CDevices_CPower_CIBatteryReport_get_RemainingCapacityInMilliwattHours( \
    This, value)                                                                                \
  (This)->lpVtbl->get_RemainingCapacityInMilliwattHours(This, value)
#define __x_ABI_CWindows_CDevices_CPower_CIBatteryReport_get_Status(This,      \
                                                                    value)     \
...
static inline ULONG __x_ABI_CWindows_CDevices_CPower_CIBatteryReport_AddRef(
    __x_ABI_CWindows_CDevices_CPower_CIBatteryReport *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG __x_ABI_CWindows_CDevices_CPower_CIBatteryReport_Release(
    __x_ABI_CWindows_CDevices_CPower_CIBatteryReport *This) {
  return This->lpVtbl->Release(This);
}
/*** IInspectable methods ***/
static inline HRESULT __x_ABI_CWindows_CDevices_CPower_CIBatteryReport_GetIids(
    __x_ABI_CWindows_CDevices_CPower_CIBatteryReport *This, ULONG *iidCount,
    IID **iids) {
  return This->lpVtbl->GetIids(This, iidCount, iids);
}
static inline HRESULT
__x_ABI_CWindows_CDevices_CPower_CIBatteryReport_GetRuntimeClassName(
    __x_ABI_CWindows_CDevices_CPower_CIBatteryReport *This,
    HSTRING *className) {
  return This->lpVtbl->GetRuntimeClassName(This, className);
}
static inline HRESULT
__x_ABI_CWindows_CDevices_CPower_CIBatteryReport_GetTrustLevel(
    __x_ABI_CWindows_CDevices_CPower_CIBatteryReport *This,
    TrustLevel *trustLevel) {
...
/*** IBatteryReport methods ***/
static inline HRESULT
__x_ABI_CWindows_CDevices_CPower_CIBatteryReport_get_ChargeRateInMilliwatts(
    __x_ABI_CWindows_CDevices_CPower_CIBatteryReport *This,
    __FIReference_1_INT32 **value) {
  return This->lpVtbl->get_ChargeRateInMilliwatts(This, value);
}
static inline HRESULT
__x_ABI_CWindows_CDevices_CPower_CIBatteryReport_get_DesignCapacityInMilliwattHours(
    __x_ABI_CWindows_CDevices_CPower_CIBatteryReport *This,
    __FIReference_1_INT32 **value) {
  return This->lpVtbl->get_DesignCapacityInMilliwattHours(This, value);
}
static inline HRESULT
__x_ABI_CWindows_CDevices_CPower_CIBatteryReport_get_FullChargeCapacityInMilliwattHours(
    __x_ABI_CWindows_CDevices_CPower_CIBatteryReport *This,
    __FIReference_1_INT32 **value) {
  return This->lpVtbl->get_FullChargeCapacityInMilliwattHours(This, value);
}
static inline HRESULT
__x_ABI_CWindows_CDevices_CPower_CIBatteryReport_get_RemainingCapacityInMilliwattHours(
    __x_ABI_CWindows_CDevices_CPower_CIBatteryReport *This,
    __FIReference_1_INT32 **value) {
  return This->lpVtbl->get_RemainingCapacityInMilliwattHours(This, value);
}
static inline HRESULT
__x_ABI_CWindows_CDevices_CPower_CIBatteryReport_get_Status(
    __x_ABI_CWindows_CDevices_CPower_CIBatteryReport *This,
    __x_ABI_CWindows_CSystem_CPower_CBatteryStatus *value) {
...
#define IBatteryReport_QueryInterface                                          \
  __x_ABI_CWindows_CDevices_CPower_CIBatteryReport_QueryInterface
#define IBatteryReport_AddRef                                                  \
  __x_ABI_CWindows_CDevices_CPower_CIBatteryReport_AddRef
#define IBatteryReport_Release                                                 \
  __x_ABI_CWindows_CDevices_CPower_CIBatteryReport_Release
#define IBatteryReport_GetIids                                                 \
  __x_ABI_CWindows_CDevices_CPower_CIBatteryReport_GetIids
#define IBatteryReport_GetRuntimeClassName                                     \
  __x_ABI_CWindows_CDevices_CPower_CIBatteryReport_GetRuntimeClassName
#define IBatteryReport_GetTrustLevel                                           \
  __x_ABI_CWindows_CDevices_CPower_CIBatteryReport_GetTrustLevel
#define IBatteryReport_get_ChargeRateInMilliwatts                              \
  __x_ABI_CWindows_CDevices_CPower_CIBatteryReport_get_ChargeRateInMilliwatts
#define IBatteryReport_get_DesignCapacityInMilliwattHours                      \
  __x_ABI_CWindows_CDevices_CPower_CIBatteryReport_get_DesignCapacityInMilliwattHours
#define IBatteryReport_get_FullChargeCapacityInMilliwattHours                  \
  __x_ABI_CWindows_CDevices_CPower_CIBatteryReport_get_FullChargeCapacityInMilliwattHours
#define IBatteryReport_get_RemainingCapacityInMilliwattHours                   \
  __x_ABI_CWindows_CDevices_CPower_CIBatteryReport_get_RemainingCapacityInMilliwattHours
#define IBatteryReport_get_Status                                              \
  __x_ABI_CWindows_CDevices_CPower_CIBatteryReport_get_Status
...
static const WCHAR RuntimeClass_Windows_Devices_Power_BatteryReport[] = {
    'W', 'i', 'n', 'd', 'o', 'w', 's', '.', 'D', 'e', 'v', 'i',
    'c', 'e', 's', '.', 'P', 'o', 'w', 'e', 'r', '.', 'B', 'a',
    't', 't', 'e', 'r', 'y', 'R', 'e', 'p', 'o', 'r', 't', 0};
#elif defined(__GNUC__) && !defined(__cplusplus)
const DECLSPEC_SELECTANY WCHAR
    RuntimeClass_Windows_Devices_Power_BatteryReport[] =
