...
public:
  virtual HRESULT WINAPI Next(ULONG celt, ITEMPROP *rgelt,
...
#endif
#endif
HRESULT WINAPI IEnumItemProperties_Next_Proxy(IEnumItemProperties *This,
                                              ULONG celt, ITEMPROP *rgelt,
                                              ULONG *pceltFetched);
...
HRESULT WINAPI IEnumItemProperties_Skip_Proxy(IEnumItemProperties *This,
                                              ULONG celt);
...
void __RPC_STUB IEnumItemProperties_Reset_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumItemProperties_Clone_Proxy(IEnumItemProperties *This,
                                               IEnumItemProperties **ppenum);
void __RPC_STUB IEnumItemProperties_Clone_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumItemProperties_GetCount_Proxy(IEnumItemProperties *This,
                                                  ULONG *pnCount);
...
public:
  ...
  GetSubscriptionItemInfo(SUBSCRIPTIONITEMINFO *pSubscriptionItemInfo) = 0;
  virtual HRESULT WINAPI SetSubscriptionItemInfo(
      const SUBSCRIPTIONITEMINFO *pSubscriptionItemInfo) = 0;
  virtual HRESULT WINAPI ReadProperties(ULONG nCount, const LPCWSTR rgwszName[],
                                        VARIANT rgValue[]) = 0;
  virtual HRESULT WINAPI WriteProperties(ULONG nCount,
                                         const LPCWSTR rgwszName[],
                                         const VARIANT rgValue[]) = 0;
  virtual HRESULT WINAPI
  EnumProperties(IEnumItemProperties **ppEnumItemProperties) = 0;
  virtual HRESULT WINAPI NotifyChanged(void) = 0;
};
#else
typedef struct ISubscriptionItemVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ISubscriptionItem *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ISubscriptionItem *This);
  ULONG(WINAPI *Release)(ISubscriptionItem *This);
  HRESULT(WINAPI *GetCookie)(ISubscriptionItem *This,
                             SUBSCRIPTIONCOOKIE *pCookie);
  HRESULT(WINAPI *GetSubscriptionItemInfo)(
      ISubscriptionItem *This, SUBSCRIPTIONITEMINFO *pSubscriptionItemInfo);
  HRESULT(WINAPI *SetSubscriptionItemInfo)(
      ISubscriptionItem *This,
      const SUBSCRIPTIONITEMINFO *pSubscriptionItemInfo);
  HRESULT(WINAPI *ReadProperties)(ISubscriptionItem *This, ULONG nCount,
                                  const LPCWSTR rgwszName[], VARIANT rgValue[]);
  HRESULT(WINAPI *WriteProperties)(ISubscriptionItem *This, ULONG nCount,
                                   const LPCWSTR rgwszName[],
                                   const VARIANT rgValue[]);
  HRESULT(WINAPI *EnumProperties)(ISubscriptionItem *This,
...
#endif
#endif
HRESULT WINAPI ISubscriptionItem_GetCookie_Proxy(ISubscriptionItem *This,
                                                 SUBSCRIPTIONCOOKIE *pCookie);
void __RPC_STUB ISubscriptionItem_GetCookie_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISubscriptionItem_GetSubscriptionItemInfo_Proxy(
    ISubscriptionItem *This, SUBSCRIPTIONITEMINFO *pSubscriptionItemInfo);
void __RPC_STUB ISubscriptionItem_GetSubscriptionItemInfo_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISubscriptionItem_SetSubscriptionItemInfo_Proxy(
    ISubscriptionItem *This, const SUBSCRIPTIONITEMINFO *pSubscriptionItemInfo);
void __RPC_STUB ISubscriptionItem_SetSubscriptionItemInfo_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISubscriptionItem_ReadProperties_Proxy(ISubscriptionItem *This,
                                                      ULONG nCount,
                                                      const LPCWSTR rgwszName[],
                                                      VARIANT rgValue[]);
void __RPC_STUB ISubscriptionItem_ReadProperties_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISubscriptionItem_WriteProperties_Proxy(
    ISubscriptionItem *This, ULONG nCount, const LPCWSTR rgwszName[],
    const VARIANT rgValue[]);
void __RPC_STUB ISubscriptionItem_WriteProperties_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISubscriptionItem_EnumProperties_Proxy(
    ISubscriptionItem *This, IEnumItemProperties **ppEnumItemProperties);
...
public:
  virtual HRESULT WINAPI Next(ULONG celt, SUBSCRIPTIONCOOKIE *rgelt,
                              ULONG *pceltFetched) = 0;
  virtual HRESULT WINAPI Skip(ULONG celt) = 0;
  virtual HRESULT WINAPI Reset(void) = 0;
...
typedef struct IEnumSubscriptionVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IEnumSubscription *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IEnumSubscription *This);
  ULONG(WINAPI *Release)(IEnumSubscription *This);
  HRESULT(WINAPI *Next)(IEnumSubscription *This, ULONG celt,
                        SUBSCRIPTIONCOOKIE *rgelt, ULONG *pceltFetched);
...
#endif
#endif
HRESULT WINAPI IEnumSubscription_Next_Proxy(IEnumSubscription *This, ULONG celt,
                                            SUBSCRIPTIONCOOKIE *rgelt,
                                            ULONG *pceltFetched);
void __RPC_STUB IEnumSubscription_Next_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumSubscription_Skip_Proxy(IEnumSubscription *This,
                                            ULONG celt);
...
void __RPC_STUB IEnumSubscription_Reset_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumSubscription_Clone_Proxy(IEnumSubscription *This,
                                             IEnumSubscription **ppenum);
void __RPC_STUB IEnumSubscription_Clone_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumSubscription_GetCount_Proxy(IEnumSubscription *This,
                                                ULONG *pnCount);
...
public:
  ...
  virtual HRESULT WINAPI IsSubscribed(LPCWSTR pwszURL,
                                      WINBOOL *pfSubscribed) = 0;
  virtual HRESULT WINAPI GetSubscriptionInfo(LPCWSTR pwszURL,
                                             SUBSCRIPTIONINFO *pInfo) = 0;
  virtual HRESULT WINAPI GetDefaultInfo(SUBSCRIPTIONTYPE subType,
                                        SUBSCRIPTIONINFO *pInfo) = 0;
  virtual HRESULT WINAPI ShowSubscriptionProperties(LPCWSTR pwszURL,
                                                    HWND hwnd) = 0;
  virtual HRESULT WINAPI CreateSubscription(HWND hwnd, LPCWSTR pwszURL,
...
typedef struct ISubscriptionMgrVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ISubscriptionMgr *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ISubscriptionMgr *This);
  ULONG(WINAPI *Release)(ISubscriptionMgr *This);
  HRESULT(WINAPI *DeleteSubscription)(ISubscriptionMgr *This, LPCWSTR pwszURL,
                                      HWND hwnd);
  HRESULT(WINAPI *UpdateSubscription)(ISubscriptionMgr *This, LPCWSTR pwszURL);
  HRESULT(WINAPI *UpdateAll)(ISubscriptionMgr *This);
  HRESULT(WINAPI *IsSubscribed)(ISubscriptionMgr *This, LPCWSTR pwszURL,
                                WINBOOL *pfSubscribed);
  HRESULT(WINAPI *GetSubscriptionInfo)(ISubscriptionMgr *This, LPCWSTR pwszURL,
                                       SUBSCRIPTIONINFO *pInfo);
  HRESULT(WINAPI *GetDefaultInfo)(ISubscriptionMgr *This,
                                  SUBSCRIPTIONTYPE subType,
                                  SUBSCRIPTIONINFO *pInfo);
  HRESULT(WINAPI *ShowSubscriptionProperties)(ISubscriptionMgr *This,
                                              LPCWSTR pwszURL, HWND hwnd);
  HRESULT(WINAPI *CreateSubscription)(ISubscriptionMgr *This, HWND hwnd,
                                      LPCWSTR pwszURL, LPCWSTR pwszFriendlyName,
                                      DWORD dwFlags, SUBSCRIPTIONTYPE subsType,
                                      SUBSCRIPTIONINFO *pInfo);
  END_INTERFACE
...
#define ISubscriptionMgr_CreateSubscription(                                   \
    This, hwnd, pwszURL, pwszFriendlyName, dwFlags, subsType, pInfo)           \
  (This)->lpVtbl->CreateSubscription(This, hwnd, pwszURL, pwszFriendlyName,    \
                                     dwFlags, subsType, pInfo)
#endif
#endif
HRESULT WINAPI ISubscriptionMgr_DeleteSubscription_Proxy(ISubscriptionMgr *This,
                                                         LPCWSTR pwszURL,
                                                         HWND hwnd);
void __RPC_STUB ISubscriptionMgr_DeleteSubscription_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISubscriptionMgr_UpdateSubscription_Proxy(ISubscriptionMgr *This,
                                                         LPCWSTR pwszURL);
...
void __RPC_STUB ISubscriptionMgr_UpdateAll_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISubscriptionMgr_IsSubscribed_Proxy(ISubscriptionMgr *This,
                                                   LPCWSTR pwszURL,
                                                   WINBOOL *pfSubscribed);
void __RPC_STUB ISubscriptionMgr_IsSubscribed_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISubscriptionMgr_GetSubscriptionInfo_Proxy(
    ISubscriptionMgr *This, LPCWSTR pwszURL, SUBSCRIPTIONINFO *pInfo);
void __RPC_STUB ISubscriptionMgr_GetSubscriptionInfo_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISubscriptionMgr_GetDefaultInfo_Proxy(ISubscriptionMgr *This,
                                                     SUBSCRIPTIONTYPE subType,
                                                     SUBSCRIPTIONINFO *pInfo);
void __RPC_STUB ISubscriptionMgr_GetDefaultInfo_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISubscriptionMgr_ShowSubscriptionProperties_Proxy(
    ISubscriptionMgr *This, LPCWSTR pwszURL, HWND hwnd);
void __RPC_STUB ISubscriptionMgr_ShowSubscriptionProperties_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISubscriptionMgr_CreateSubscription_Proxy(
    ISubscriptionMgr *This, HWND hwnd, LPCWSTR pwszURL,
    LPCWSTR pwszFriendlyName, DWORD dwFlags, SUBSCRIPTIONTYPE subsType,
    SUBSCRIPTIONINFO *pInfo);
...
public:
  virtual HRESULT WINAPI
  GetItemFromURL(LPCWSTR pwszURL, ISubscriptionItem **ppSubscriptionItem) = 0;
  virtual HRESULT WINAPI
  GetItemFromCookie(const SUBSCRIPTIONCOOKIE *pSubscriptionCookie,
                    ISubscriptionItem **ppSubscriptionItem) = 0;
  virtual HRESULT WINAPI GetSubscriptionRunState(
      DWORD dwNumCookies, const SUBSCRIPTIONCOOKIE *pCookies,
      DWORD *pdwRunState) = 0;
  virtual HRESULT WINAPI
  EnumSubscriptions(DWORD dwFlags, IEnumSubscription **ppEnumSubscriptions) = 0;
  virtual HRESULT WINAPI UpdateItems(DWORD dwFlags, DWORD dwNumCookies,
                                     const SUBSCRIPTIONCOOKIE *pCookies) = 0;
  virtual HRESULT WINAPI AbortItems(DWORD dwNumCookies,
                                    const SUBSCRIPTIONCOOKIE *pCookies) = 0;
...
typedef struct ISubscriptionMgr2Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ISubscriptionMgr2 *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ISubscriptionMgr2 *This);
  ULONG(WINAPI *Release)(ISubscriptionMgr2 *This);
  HRESULT(WINAPI *DeleteSubscription)(ISubscriptionMgr2 *This, LPCWSTR pwszURL,
                                      HWND hwnd);
  HRESULT(WINAPI *UpdateSubscription)(ISubscriptionMgr2 *This, LPCWSTR pwszURL);
  HRESULT(WINAPI *UpdateAll)(ISubscriptionMgr2 *This);
  HRESULT(WINAPI *IsSubscribed)(ISubscriptionMgr2 *This, LPCWSTR pwszURL,
                                WINBOOL *pfSubscribed);
  HRESULT(WINAPI *GetSubscriptionInfo)(ISubscriptionMgr2 *This, LPCWSTR pwszURL,
                                       SUBSCRIPTIONINFO *pInfo);
  HRESULT(WINAPI *GetDefaultInfo)(ISubscriptionMgr2 *This,
                                  SUBSCRIPTIONTYPE subType,
                                  SUBSCRIPTIONINFO *pInfo);
  HRESULT(WINAPI *ShowSubscriptionProperties)(ISubscriptionMgr2 *This,
                                              LPCWSTR pwszURL, HWND hwnd);
  HRESULT(WINAPI *CreateSubscription)(ISubscriptionMgr2 *This, HWND hwnd,
                                      LPCWSTR pwszURL, LPCWSTR pwszFriendlyName,
                                      DWORD dwFlags, SUBSCRIPTIONTYPE subsType,
                                      SUBSCRIPTIONINFO *pInfo);
  HRESULT(WINAPI *GetItemFromURL)(ISubscriptionMgr2 *This, LPCWSTR pwszURL,
                                  ISubscriptionItem **ppSubscriptionItem);
  HRESULT(WINAPI *GetItemFromCookie)(
      ISubscriptionMgr2 *This, const SUBSCRIPTIONCOOKIE *pSubscriptionCookie,
      ISubscriptionItem **ppSubscriptionItem);
  HRESULT(WINAPI *GetSubscriptionRunState)(ISubscriptionMgr2 *This,
                                           DWORD dwNumCookies,
                                           const SUBSCRIPTIONCOOKIE *pCookies,
                                           DWORD *pdwRunState);
  HRESULT(WINAPI *EnumSubscriptions)(ISubscriptionMgr2 *This, DWORD dwFlags,
                                     IEnumSubscription **ppEnumSubscriptions);
  HRESULT(WINAPI *UpdateItems)(ISubscriptionMgr2 *This, DWORD dwFlags,
                               DWORD dwNumCookies,
                               const SUBSCRIPTIONCOOKIE *pCookies);
  HRESULT(WINAPI *AbortItems)(ISubscriptionMgr2 *This, DWORD dwNumCookies,
                              const SUBSCRIPTIONCOOKIE *pCookies);
...
#define ISubscriptionMgr2_ShowSubscriptionProperties(This, pwszURL, hwnd)      \
  (This)->lpVtbl->ShowSubscriptionProperties(This, pwszURL, hwnd)
#define ISubscriptionMgr2_CreateSubscription(                                  \
    This, hwnd, pwszURL, pwszFriendlyName, dwFlags, subsType, pInfo)           \
  (This)->lpVtbl->CreateSubscription(This, hwnd, pwszURL, pwszFriendlyName,    \
                                     dwFlags, subsType, pInfo)
...
#define ISubscriptionMgr2_GetItemFromCookie(This, pSubscriptionCookie,         \
                                            ppSubscriptionItem)                \
  (This)->lpVtbl->GetItemFromCookie(This, pSubscriptionCookie,                 \
                                    ppSubscriptionItem)
#define ISubscriptionMgr2_GetSubscriptionRunState(This, dwNumCookies,          \
                                                  pCookies, pdwRunState)       \
  (This)->lpVtbl->GetSubscriptionRunState(This, dwNumCookies, pCookies,        \
                                          pdwRunState)
#define ISubscriptionMgr2_EnumSubscriptions(This, dwFlags,                     \
                                            ppEnumSubscriptions)               \
...
#endif
HRESULT WINAPI
ISubscriptionMgr2_GetItemFromURL_Proxy(ISubscriptionMgr2 *This, LPCWSTR pwszURL,
                                       ISubscriptionItem **ppSubscriptionItem);
void __RPC_STUB ISubscriptionMgr2_GetItemFromURL_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISubscriptionMgr2_GetItemFromCookie_Proxy(
    ISubscriptionMgr2 *This, const SUBSCRIPTIONCOOKIE *pSubscriptionCookie,
    ISubscriptionItem **ppSubscriptionItem);
void __RPC_STUB ISubscriptionMgr2_GetItemFromCookie_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISubscriptionMgr2_GetSubscriptionRunState_Proxy(
    ISubscriptionMgr2 *This, DWORD dwNumCookies,
    const SUBSCRIPTIONCOOKIE *pCookies, DWORD *pdwRunState);
void __RPC_STUB ISubscriptionMgr2_GetSubscriptionRunState_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISubscriptionMgr2_EnumSubscriptions_Proxy(
    ISubscriptionMgr2 *This, DWORD dwFlags,
    IEnumSubscription **ppEnumSubscriptions);
void __RPC_STUB ISubscriptionMgr2_EnumSubscriptions_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISubscriptionMgr2_UpdateItems_Proxy(
    ISubscriptionMgr2 *This, DWORD dwFlags, DWORD dwNumCookies,
    const SUBSCRIPTIONCOOKIE *pCookies);
void __RPC_STUB ISubscriptionMgr2_UpdateItems_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
ISubscriptionMgr2_AbortItems_Proxy(ISubscriptionMgr2 *This, DWORD dwNumCookies,
                                   const SUBSCRIPTIONCOOKIE *pCookies);
