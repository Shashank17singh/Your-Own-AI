...
enum SF_PROPERTY_IIS { SF_PROPERTY_SSL_CTXT, SF_PROPERTY_INSTANCE_NUM_ID };
enum SF_STATUS_TYPE {
...
typedef struct _HTTP_FILTER_CONTEXT {
  ...
  WINBOOL(WINAPI *GetServerVariable)(struct _HTTP_FILTER_CONTEXT *pfc,
                                     LPSTR lpszVariableName, LPVOID lpvBuffer,
                                     LPDWORD lpdwSize);
  WINBOOL(WINAPI *AddResponseHeaders)(struct _HTTP_FILTER_CONTEXT *pfc,
                                      LPSTR lpszHeaders, DWORD dwReserved);
  WINBOOL(WINAPI *WriteClient)(struct _HTTP_FILTER_CONTEXT *pfc, LPVOID Buffer,
                               LPDWORD lpdwBytes, DWORD dwReserved);
  VOID *(WINAPI *AllocMem)(struct _HTTP_FILTER_CONTEXT *pfc, DWORD cbSize,
                           DWORD dwReserved);
  WINBOOL(WINAPI *ServerSupportFunction)(struct _HTTP_FILTER_CONTEXT *pfc,
...
typedef struct _HTTP_FILTER_PREPROC_HEADERS {
  WINBOOL(WINAPI *GetHeader)(struct _HTTP_FILTER_CONTEXT *pfc, LPSTR lpszName,
                             LPVOID lpvBuffer, LPDWORD lpdwSize);
  WINBOOL(WINAPI *SetHeader)(struct _HTTP_FILTER_CONTEXT *pfc, LPSTR lpszName,
                             LPSTR lpszValue);
  WINBOOL(WINAPI *AddHeader)(struct _HTTP_FILTER_CONTEXT *pfc, LPSTR lpszName,
                             LPSTR lpszValue);
  DWORD HttpStatus;
  DWORD dwReserved;
...
typedef struct _HTTP_FILTER_AUTH_COMPLETE_INFO {
  ...
  WINBOOL(WINAPI *AddHeader)(struct _HTTP_FILTER_CONTEXT *pfc, LPSTR lpszName,
                             LPSTR lpszValue);
  WINBOOL(WINAPI *GetUserToken)(struct _HTTP_FILTER_CONTEXT *pfc,
                                HANDLE *phToken);
  DWORD HttpStatus;
  WINBOOL fResetAuth;
  DWORD dwReserved;
