...
DEFINE_GUID(IID_ID3D10Blob, 0x8ba5fb08, 0x5195, 0x40e2, 0xac, 0x58, 0x0d, 0x98,
            0x9c, 0x3a, 0x01, 0x02);
...
__CRT_UUID_DECL(ID3D10Blob, 0x8ba5fb08, 0x5195, 0x40e2, 0xac, 0x58, 0x0d, 0x98,
                0x9c, 0x3a, 0x01, 0x02)
#endif
#else
typedef struct ID3D10BlobVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D10Blob *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(ID3D10Blob *This);
  ULONG(STDMETHODCALLTYPE *Release)(ID3D10Blob *This);
  /*** ID3D10Blob methods ***/
  void *(STDMETHODCALLTYPE *GetBufferPointer)(ID3D10Blob *This);
  SIZE_T(STDMETHODCALLTYPE *GetBufferSize)(ID3D10Blob *This);
  END_INTERFACE
} ID3D10BlobVtbl;
interface ID3D10Blob { CONST_VTBL ID3D10BlobVtbl *lpVtbl; };
#ifdef COBJMACROS
...
#else
/*** IUnknown methods ***/
static inline HRESULT ID3D10Blob_QueryInterface(ID3D10Blob *This, REFIID riid,
                                                void **ppvObject) {
...
DEFINE_GUID(IID_ID3DDestructionNotifier, 0xa06eb39a, 0x50da, 0x425b, 0x8c, 0x31,
            0x4e, 0xec, 0xd6, 0xc2, 0x70, 0xf3);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
ID3DDestructionNotifier : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE RegisterDestructionCallback(
      PFN_DESTRUCTION_CALLBACK callback_func, void *data,
      UINT *callback_id) = 0;
  virtual HRESULT STDMETHODCALLTYPE UnregisterDestructionCallback(
      UINT callback_id) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3DDestructionNotifier, 0xa06eb39a, 0x50da, 0x425b, 0x8c, 0x31,
                0x4e, 0xec, 0xd6, 0xc2, 0x70, 0xf3)
#endif
#else
typedef struct ID3DDestructionNotifierVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3DDestructionNotifier *This,
  ...
  HRESULT(STDMETHODCALLTYPE *RegisterDestructionCallback)(
      ID3DDestructionNotifier *This, PFN_DESTRUCTION_CALLBACK callback_func,
      void *data, UINT *callback_id);
  HRESULT(STDMETHODCALLTYPE *UnregisterDestructionCallback)(
      ID3DDestructionNotifier *This, UINT callback_id);
  END_INTERFACE
...
/*** ID3DDestructionNotifier methods ***/
#define ID3DDestructionNotifier_RegisterDestructionCallback(                   \
    This, callback_func, data, callback_id)                                    \
  (This)->lpVtbl->RegisterDestructionCallback(This, callback_func, data,       \
                                              callback_id)
#define ID3DDestructionNotifier_UnregisterDestructionCallback(This,            \
                                                              callback_id)     \
  (This)->lpVtbl->UnregisterDestructionCallback(This, callback_id)
#else
/*** IUnknown methods ***/
static inline HRESULT
ID3DDestructionNotifier_QueryInterface(ID3DDestructionNotifier *This,
                                       REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
ID3DDestructionNotifier_AddRef(ID3DDestructionNotifier *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
ID3DDestructionNotifier_Release(ID3DDestructionNotifier *This) {
  return This->lpVtbl->Release(This);
}
/*** ID3DDestructionNotifier methods ***/
static inline HRESULT ID3DDestructionNotifier_RegisterDestructionCallback(
    ID3DDestructionNotifier *This, PFN_DESTRUCTION_CALLBACK callback_func,
    void *data, UINT *callback_id) {
  return This->lpVtbl->RegisterDestructionCallback(This, callback_func, data,
                                                   callback_id);
}
static inline HRESULT ID3DDestructionNotifier_UnregisterDestructionCallback(
    ID3DDestructionNotifier *This, UINT callback_id) {
...
interface ID3DInclude {
  ...
  virtual HRESULT STDMETHODCALLTYPE Open(
      D3D_INCLUDE_TYPE include_type, const char *filename,
      const void *parent_data, const void **data, UINT *bytes) = 0;
  virtual HRESULT STDMETHODCALLTYPE Close(const void *data) = 0;
  END_INTERFACE
};
#else
typedef struct ID3DIncludeVtbl {
  BEGIN_INTERFACE
  /*** ID3DInclude methods ***/
  HRESULT(STDMETHODCALLTYPE *Open)(ID3DInclude *This,
                                   D3D_INCLUDE_TYPE include_type,
                                   const char *filename,
                                   const void *parent_data, const void **data,
                                   UINT *bytes);
  HRESULT(STDMETHODCALLTYPE *Close)(ID3DInclude *This, const void *data);
  END_INTERFACE
} ID3DIncludeVtbl;
interface ID3DInclude { CONST_VTBL ID3DIncludeVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** ID3DInclude methods ***/
#define ID3DInclude_Open(This, include_type, filename, parent_data, data,      \
                         bytes)                                                \
  (This)->lpVtbl->Open(This, include_type, filename, parent_data, data, bytes)
#define ID3DInclude_Close(This, data) (This)->lpVtbl->Close(This, data)
#else
/*** ID3DInclude methods ***/
static inline HRESULT ID3DInclude_Open(ID3DInclude *This,
                                       D3D_INCLUDE_TYPE include_type,
                                       const char *filename,
                                       const void *parent_data,
                                       const void **data, UINT *bytes) {
  return This->lpVtbl->Open(This, include_type, filename, parent_data, data,
                            bytes);
}
