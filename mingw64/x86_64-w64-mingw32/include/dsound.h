...
DEFINE_GUID(CLSID_DirectSoundCapture, 0xb0210780, 0x89cd, 0x11d0, 0xaf, 0x08,
...
DEFINE_GUID(IID_IDirectSoundCapture, 0xB0210781, 0x89CD, 0x11D0, 0xAF, 0x08,
            0x00, 0xA0, 0xC9, 0x25, 0xCD, 0x16);
...
DEFINE_GUID(IID_IDirectSoundCaptureBuffer8, 0x00990DF4, 0x0DBB, 0x4872, 0x83,
            0x3E, 0x6D, 0x30, 0x3E, 0x80, 0xAE, 0xB6);
...
DEFINE_GUID(DS3DALG_NO_VIRTUALIZATION, 0xc241333f, 0x1c1b, 0x11d2, 0x94, 0xf5,
            0x00, 0xc0, 0x4f, 0xc2, 0x8a, 0xca);
DEFINE_GUID(DS3DALG_HRTF_FULL, 0xc2413340, 0x1c1b, 0x11d2, 0x94, 0xf5, 0x00,
            0xc0, 0x4f, 0xc2, 0x8a, 0xca);
DEFINE_GUID(DS3DALG_HRTF_LIGHT, 0xc2413342, 0x1c1b, 0x11d2, 0x94, 0xf5, 0x00,
            0xc0, 0x4f, 0xc2, 0x8a, 0xca);
...
DEFINE_GUID(GUID_DSCFX_CLASS_AEC, 0xBF963D80, 0xC559, 0x11D0, 0x8A, 0x2B, 0x00,
...
extern HRESULT WINAPI DirectSoundCreate(LPCGUID lpGUID, LPDIRECTSOUND *ppDS,
                                        LPUNKNOWN pUnkOuter);
...
extern HRESULT WINAPI DirectSoundCreate8(LPCGUID lpGUID, LPDIRECTSOUND8 *ppDS8,
                                         LPUNKNOWN pUnkOuter);
...
DECLARE_INTERFACE_(IDirectSound, IUnknown) {
  ...
  STDMETHOD(CreateSoundBuffer)(THIS_ LPCDSBUFFERDESC lpcDSBufferDesc,
                               LPLPDIRECTSOUNDBUFFER lplpDirectSoundBuffer,
                               IUnknown * pUnkOuter) PURE;
  STDMETHOD(GetCaps)(THIS_ LPDSCAPS lpDSCaps) PURE;
  STDMETHOD(DuplicateSoundBuffer)(THIS_ LPDIRECTSOUNDBUFFER lpDsbOriginal,
                                  LPLPDIRECTSOUNDBUFFER lplpDsbDuplicate) PURE;
...
DECLARE_INTERFACE_(IDirectSoundBuffer, IUnknown) {
  ...
  STDMETHOD(GetCurrentPosition)(THIS_ LPDWORD lpdwCurrentPlayCursor,
                                LPDWORD lpdwCurrentWriteCursor) PURE;
  STDMETHOD(GetFormat)(THIS_ LPWAVEFORMATEX lpwfxFormat, DWORD dwSizeAllocated,
                       LPDWORD lpdwSizeWritten) PURE;
  ...
  STDMETHOD(Initialize)(THIS_ LPDIRECTSOUND lpDirectSound,
                        LPCDSBUFFERDESC lpcDSBufferDesc) PURE;
  STDMETHOD(Lock)(THIS_ DWORD dwOffset, DWORD dwBytes, LPVOID * ppvAudioPtr1,
                  LPDWORD pdwAudioBytes1, LPVOID * ppvAudioPtr2,
                  LPDWORD pdwAudioBytes2, DWORD dwFlags) PURE;
  STDMETHOD(Play)(THIS_ DWORD dwReserved1, DWORD dwReserved2, DWORD dwFlags)
      PURE;
  ...
  STDMETHOD(Unlock)(THIS_ LPVOID pvAudioPtr1, DWORD dwAudioBytes1,
                    LPVOID pvAudioPtr2, DWORD dwAudioPtr2) PURE;
...
DECLARE_INTERFACE_(IDirectSoundBuffer8, IUnknown) {
  ...
  STDMETHOD(Unlock)(THIS_ LPVOID pvAudioPtr1, DWORD dwAudioBytes1,
                    LPVOID pvAudioPtr2, DWORD dwAudioPtr2) PURE;
  STDMETHOD(Restore)(THIS) PURE;
  STDMETHOD(SetFX)(THIS_ DWORD dwEffectsCount, LPDSEFFECTDESC pDSFXDesc,
                   LPDWORD pdwResultCodes) PURE;
  STDMETHOD(AcquireResources)(THIS_ DWORD dwFlags, DWORD dwEffectsCount,
                              LPDWORD pdwResultCodes) PURE;
  STDMETHOD(GetObjectInPath)(THIS_ REFGUID rguidObject, DWORD dwIndex,
                             REFGUID rguidInterface, LPVOID * ppObject) PURE;
};
#undef INTERFACE
...
DECLARE_INTERFACE_(IDirectSoundCapture, IUnknown) {
  ...
  STDMETHOD(CreateCaptureBuffer)(
      THIS_ LPCDSCBUFFERDESC lpcDSCBufferDesc,
      LPDIRECTSOUNDCAPTUREBUFFER * lplpDSCaptureBuffer, LPUNKNOWN pUnk) PURE;
...
DECLARE_INTERFACE_(IDirectSoundCaptureBuffer, IUnknown) {
  ...
  STDMETHOD(GetCurrentPosition)(THIS_ LPDWORD lpdwCapturePosition,
                                LPDWORD lpdwReadPosition) PURE;
  STDMETHOD(GetFormat)(THIS_ LPWAVEFORMATEX lpwfxFormat, DWORD dwSizeAllocated,
                       LPDWORD lpdwSizeWritten) PURE;
  STDMETHOD(GetStatus)(THIS_ LPDWORD lpdwStatus) PURE;
  STDMETHOD(Initialize)(THIS_ LPDIRECTSOUNDCAPTURE lpDSC,
                        LPCDSCBUFFERDESC lpcDSCBDesc) PURE;
  STDMETHOD(Lock)(THIS_ DWORD dwReadCusor, DWORD dwReadBytes,
                  LPVOID * lplpvAudioPtr1, LPDWORD lpdwAudioBytes1,
                  LPVOID * lplpvAudioPtr2, LPDWORD lpdwAudioBytes2,
                  DWORD dwFlags) PURE;
  STDMETHOD(Start)(THIS_ DWORD dwFlags) PURE;
  STDMETHOD(Stop)(THIS) PURE;
  STDMETHOD(Unlock)(THIS_ LPVOID lpvAudioPtr1, DWORD dwAudioBytes1,
                    LPVOID lpvAudioPtr2, DWORD dwAudioBytes2) PURE;
};
#undef INTERFACE
#if !defined(__cplusplus) || defined(CINTERFACE)
/*** IUnknown methods ***/
...
DECLARE_INTERFACE_(IDirectSoundNotify, IUnknown) {
  ...
  STDMETHOD(SetNotificationPositions)(THIS_ DWORD cPositionNotifies,
...
DECLARE_INTERFACE_(IDirectSound3DListener, IUnknown) {
  ...
  STDMETHOD(GetOrientation)(THIS_ LPD3DVECTOR lpvOrientFront,
                            LPD3DVECTOR lpvOrientTop) PURE;
  ...
  STDMETHOD(SetAllParameters)(THIS_ LPCDS3DLISTENER lpcListener, DWORD dwApply)
      PURE;
  ...
  STDMETHOD(SetDopplerFactor)(THIS_ D3DVALUE flDopplerFactor, DWORD dwApply)
      PURE;
  STDMETHOD(SetOrientation)(THIS_ D3DVALUE xFront, D3DVALUE yFront,
                            D3DVALUE zFront, D3DVALUE xTop, D3DVALUE yTop,
                            D3DVALUE zTop, DWORD dwApply) PURE;
  STDMETHOD(SetPosition)(THIS_ D3DVALUE x, D3DVALUE y, D3DVALUE z,
                         DWORD dwApply) PURE;
  STDMETHOD(SetRolloffFactor)(THIS_ D3DVALUE flRolloffFactor, DWORD dwApply)
      PURE;
  STDMETHOD(SetVelocity)(THIS_ D3DVALUE x, D3DVALUE y, D3DVALUE z,
                         DWORD dwApply) PURE;
...
DECLARE_INTERFACE_(IDirectSound3DBuffer, IUnknown) {
  ...
  STDMETHOD(GetConeAngles)(THIS_ LPDWORD lpdwInsideConeAngle,
                           LPDWORD lpdwOutsideConeAngle) PURE;
  ...
  STDMETHOD(GetPosition)(THIS_ LPD3DVECTOR lpvPosition) PURE;
  STDMETHOD(GetVelocity)(THIS_ LPD3DVECTOR lpvVelocity) PURE;
  STDMETHOD(SetAllParameters)(THIS_ LPCDS3DBUFFER lpcDs3dBuffer, DWORD dwApply)
      PURE;
  STDMETHOD(SetConeAngles)(THIS_ DWORD dwInsideConeAngle,
                           DWORD dwOutsideConeAngle, DWORD dwApply) PURE;
  STDMETHOD(SetConeOrientation)(THIS_ D3DVALUE x, D3DVALUE y, D3DVALUE z,
                                DWORD dwApply) PURE;
...
DECLARE_INTERFACE_(IKsPropertySet, IUnknown) {
  ...
  STDMETHOD(Get)(THIS_ REFGUID rgid, ULONG x1, LPVOID p1, ULONG x2, LPVOID p2,
                 ULONG x3, ULONG * px4) PURE;
  STDMETHOD(Set)(THIS_ REFGUID rgid, ULONG x1, LPVOID p1, ULONG x2, LPVOID p2,
                 ULONG x3) PURE;
...
DECLARE_INTERFACE_(IDirectSoundFullDuplex, IUnknown) {
  ...
  STDMETHOD(Initialize)(
      THIS_ LPCGUID pCaptureGuid, LPCGUID pRendererGuid,
...
#define I3DL2_ENVIRONMENT_PRESET_CITY                                          \
  -1000, -800, 0.0f, 1.49f, 0.67f, -2273, 0.007f, 2217, 0.011f, 50.0f, 100.0f, \
      5000.0f
...
#define I3DL2_ENVIRONMENT_PRESET_SEWERPIPE                                     \
  -1000, -1000, 0.0f, 2.81f, 0.14f, 429, 0.014f, 648, 0.011f, 80.0f, 60.0f,    \
      5000.0f
