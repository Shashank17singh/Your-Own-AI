...
typedef DECLSPEC_UUID(
    "000002AE-0000-0010-8000-00AA006D2EA4") enum MemberTypeEnum {
  adMemberUnknown = 0,
  adMemberRegular = 0x1,
  adMemberAll = 0x2,
  adMemberMeasure = 0x3,
...
typedef DECLSPEC_UUID(
    "C23BBD43-E494-4d00-B4D1-6C9A2CE17CE3") enum SchemaObjectTypeEnum {
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE get_ActiveConnection(IDispatch *
                                                         *ppConn) = 0;
...
typedef struct ICatalogVtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ICatalog *This, REFIID riid,
  ...
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(ICatalog *This, UINT iTInfo,
                                          LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(ICatalog *This, REFIID riid,
                                            LPOLESTR *rgszNames, UINT cNames,
                                            LCID lcid, DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(ICatalog *This, DISPID dispIdMember,
                                     REFIID riid, LCID lcid, WORD wFlags,
                                     DISPPARAMS *pDispParams,
                                     VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                                     UINT *puArgErr);
  HRESULT(STDMETHODCALLTYPE *get_Name)(ICatalog *This, BSTR *pbstr);
  HRESULT(STDMETHODCALLTYPE *putref_ActiveConnection)(ICatalog *This,
                                                      IDispatch *pconn);
  HRESULT(STDMETHODCALLTYPE *put_ActiveConnection)(ICatalog *This,
                                                   BSTR bstrConn);
  HRESULT(STDMETHODCALLTYPE *get_ActiveConnection)(ICatalog *This,
                                                   IDispatch **ppConn);
  HRESULT(STDMETHODCALLTYPE *get_CubeDefs)(ICatalog *This,
                                           CubeDefs **ppvObject);
  END_INTERFACE
} ICatalogVtbl;
interface ICatalog { CONST_VTBL struct ICatalogVtbl *lpVtbl; };
#ifdef COBJMACROS
...
public:
  virtual HRESULT STDMETHODCALLTYPE get_Item(SAFEARRAY * *idx,
                                             Cell * *ppvObject) = 0;
  virtual HRESULT STDMETHODCALLTYPE Open(VARIANT DataSource,
                                         VARIANT ActiveConnection) = 0;
...
typedef struct ICellsetVtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ICellset *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(ICellset *This, UINT iTInfo,
                                          LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(ICellset *This, REFIID riid,
                                            LPOLESTR *rgszNames, UINT cNames,
                                            LCID lcid, DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(ICellset *This, DISPID dispIdMember,
                                     REFIID riid, LCID lcid, WORD wFlags,
                                     DISPPARAMS *pDispParams,
                                     VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                                     UINT *puArgErr);
  HRESULT(STDMETHODCALLTYPE *get_Item)(ICellset *This, SAFEARRAY **idx,
                                       Cell **ppvObject);
  HRESULT(STDMETHODCALLTYPE *Open)(ICellset *This, VARIANT DataSource,
  ...
  HRESULT(STDMETHODCALLTYPE *putref_ActiveConnection)(ICellset *This,
                                                      IDispatch *pconn);
  HRESULT(STDMETHODCALLTYPE *put_ActiveConnection)(ICellset *This,
                                                   BSTR bstrConn);
  HRESULT(STDMETHODCALLTYPE *get_ActiveConnection)(ICellset *This,
                                                   IDispatch **ppConn);
  ...
  HRESULT(STDMETHODCALLTYPE *get_Properties)(ICellset *This,
                                             Properties **ppvObject);
  END_INTERFACE
} ICellsetVtbl;
interface ICellset { CONST_VTBL struct ICellsetVtbl *lpVtbl; };
#ifdef COBJMACROS
...
typedef struct CellVtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(Cell *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(Cell *This, UINT iTInfo, LCID lcid,
                                          ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(Cell *This, REFIID riid,
                                            LPOLESTR *rgszNames, UINT cNames,
                                            LCID lcid, DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(Cell *This, DISPID dispIdMember,
                                     REFIID riid, LCID lcid, WORD wFlags,
                                     DISPPARAMS *pDispParams,
                                     VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                                     UINT *puArgErr);
  ...
  HRESULT(STDMETHODCALLTYPE *get_Properties)(Cell *This,
                                             Properties **ppvObject);
...
interface Cell { CONST_VTBL struct CellVtbl *lpVtbl; };
#ifdef COBJMACROS
...
typedef struct AxisVtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(Axis *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(Axis *This, UINT iTInfo, LCID lcid,
                                          ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(Axis *This, REFIID riid,
                                            LPOLESTR *rgszNames, UINT cNames,
                                            LCID lcid, DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(Axis *This, DISPID dispIdMember,
                                     REFIID riid, LCID lcid, WORD wFlags,
                                     DISPPARAMS *pDispParams,
                                     VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                                     UINT *puArgErr);
  ...
  HRESULT(STDMETHODCALLTYPE *get_Properties)(Axis *This,
                                             Properties **ppvObject);
  END_INTERFACE
} AxisVtbl;
interface Axis { CONST_VTBL struct AxisVtbl *lpVtbl; };
#ifdef COBJMACROS
...
#define Axis_GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)      \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))
#define Axis_Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,       \
                    pVarResult, pExcepInfo, puArgErr)                          \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))
...
typedef struct PositionVtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(Position *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(Position *This, UINT iTInfo,
                                          LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(Position *This, REFIID riid,
                                            LPOLESTR *rgszNames, UINT cNames,
                                            LCID lcid, DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(Position *This, DISPID dispIdMember,
                                     REFIID riid, LCID lcid, WORD wFlags,
                                     DISPPARAMS *pDispParams,
                                     VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                                     UINT *puArgErr);
...
interface Position { CONST_VTBL struct PositionVtbl *lpVtbl; };
#ifdef COBJMACROS
...
typedef struct MemberVtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(Member *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(Member *This, UINT iTInfo, LCID lcid,
                                          ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(Member *This, REFIID riid,
                                            LPOLESTR *rgszNames, UINT cNames,
                                            LCID lcid, DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(Member *This, DISPID dispIdMember,
                                     REFIID riid, LCID lcid, WORD wFlags,
                                     DISPPARAMS *pDispParams,
                                     VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                                     UINT *puArgErr);
  ...
  HRESULT(STDMETHODCALLTYPE *get_Properties)(Member *This,
                                             Properties **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *get_ParentSameAsPrev)(Member *This,
                                                   VARIANT_BOOL *pf);
  HRESULT(STDMETHODCALLTYPE *get_Children)(Member *This, Members **ppvObject);
  END_INTERFACE
} MemberVtbl;
interface Member { CONST_VTBL struct MemberVtbl *lpVtbl; };
#ifdef COBJMACROS
...
typedef struct LevelVtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(Level *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(Level *This, UINT iTInfo, LCID lcid,
                                          ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(Level *This, REFIID riid,
                                            LPOLESTR *rgszNames, UINT cNames,
                                            LCID lcid, DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(Level *This, DISPID dispIdMember,
                                     REFIID riid, LCID lcid, WORD wFlags,
                                     DISPPARAMS *pDispParams,
                                     VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                                     UINT *puArgErr);
  ...
  HRESULT(STDMETHODCALLTYPE *get_Properties)(Level *This,
                                             Properties **ppvObject);
  HRESULT(STDMETHODCALLTYPE *get_Members)(Level *This, Members **ppvObject);
  END_INTERFACE
} LevelVtbl;
interface Level { CONST_VTBL struct LevelVtbl *lpVtbl; };
#ifdef COBJMACROS
...
typedef struct CubeDef25Vtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(CubeDef25 *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(CubeDef25 *This, UINT iTInfo,
                                          LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(CubeDef25 *This, REFIID riid,
                                            LPOLESTR *rgszNames, UINT cNames,
                                            LCID lcid, DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(CubeDef25 *This, DISPID dispIdMember,
                                     REFIID riid, LCID lcid, WORD wFlags,
                                     DISPPARAMS *pDispParams,
                                     VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                                     UINT *puArgErr);
  ...
  HRESULT(STDMETHODCALLTYPE *get_Properties)(CubeDef25 *This,
                                             Properties **ppvObject);
  HRESULT(STDMETHODCALLTYPE *get_Dimensions)(CubeDef25 *This,
                                             Dimensions **ppvObject);
  END_INTERFACE
} CubeDef25Vtbl;
interface CubeDef25 { CONST_VTBL struct CubeDef25Vtbl *lpVtbl; };
#ifdef COBJMACROS
...
public:
  virtual HRESULT STDMETHODCALLTYPE GetSchemaObject(
      SchemaObjectTypeEnum eObjType, BSTR bsUniqueName, IDispatch * *ppObj) = 0;
};
#else
typedef struct CubeDefVtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(CubeDef *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(CubeDef *This, UINT iTInfo, LCID lcid,
                                          ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(CubeDef *This, REFIID riid,
                                            LPOLESTR *rgszNames, UINT cNames,
                                            LCID lcid, DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(CubeDef *This, DISPID dispIdMember,
                                     REFIID riid, LCID lcid, WORD wFlags,
                                     DISPPARAMS *pDispParams,
                                     VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                                     UINT *puArgErr);
  ...
  HRESULT(STDMETHODCALLTYPE *get_Properties)(CubeDef *This,
                                             Properties **ppvObject);
  HRESULT(STDMETHODCALLTYPE *get_Dimensions)(CubeDef *This,
                                             Dimensions **ppvObject);
  HRESULT(STDMETHODCALLTYPE *GetSchemaObject)(CubeDef *This,
                                              SchemaObjectTypeEnum eObjType,
                                              BSTR bsUniqueName,
                                              IDispatch **ppObj);
  END_INTERFACE
} CubeDefVtbl;
interface CubeDef { CONST_VTBL struct CubeDefVtbl *lpVtbl; };
#ifdef COBJMACROS
...
#define CubeDef_GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)   \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))
#define CubeDef_Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,    \
                       pVarResult, pExcepInfo, puArgErr)                       \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE get_Description(BSTR * pbstr) = 0;
  virtual HRESULT STDMETHODCALLTYPE get_Properties(Properties * *ppvObject) = 0;
  virtual HRESULT STDMETHODCALLTYPE get_Hierarchies(Hierarchies *
                                                    *ppvObject) = 0;
};
#else
typedef struct DimensionVtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(Dimension *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(Dimension *This, UINT iTInfo,
                                          LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(Dimension *This, REFIID riid,
                                            LPOLESTR *rgszNames, UINT cNames,
                                            LCID lcid, DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(Dimension *This, DISPID dispIdMember,
                                     REFIID riid, LCID lcid, WORD wFlags,
                                     DISPPARAMS *pDispParams,
                                     VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                                     UINT *puArgErr);
  ...
  HRESULT(STDMETHODCALLTYPE *get_Properties)(Dimension *This,
                                             Properties **ppvObject);
  HRESULT(STDMETHODCALLTYPE *get_Hierarchies)(Dimension *This,
                                              Hierarchies **ppvObject);
  END_INTERFACE
} DimensionVtbl;
interface Dimension { CONST_VTBL struct DimensionVtbl *lpVtbl; };
#ifdef COBJMACROS
...
typedef struct HierarchyVtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(Hierarchy *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(Hierarchy *This, UINT iTInfo,
                                          LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(Hierarchy *This, REFIID riid,
                                            LPOLESTR *rgszNames, UINT cNames,
                                            LCID lcid, DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(Hierarchy *This, DISPID dispIdMember,
                                     REFIID riid, LCID lcid, WORD wFlags,
                                     DISPPARAMS *pDispParams,
                                     VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                                     UINT *puArgErr);
  ...
  HRESULT(STDMETHODCALLTYPE *get_Properties)(Hierarchy *This,
                                             Properties **ppvObject);
  HRESULT(STDMETHODCALLTYPE *get_Levels)(Hierarchy *This, Levels **ppvObject);
  END_INTERFACE
} HierarchyVtbl;
interface Hierarchy { CONST_VTBL struct HierarchyVtbl *lpVtbl; };
#ifdef COBJMACROS
...
typedef struct MD_CollectionVtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(MD_Collection *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(MD_Collection *This);
  ULONG(STDMETHODCALLTYPE *Release)(MD_Collection *This);
  HRESULT(STDMETHODCALLTYPE *GetTypeInfoCount)(MD_Collection *This,
                                               UINT *pctinfo);
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(MD_Collection *This, UINT iTInfo,
                                          LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(MD_Collection *This, REFIID riid,
                                            LPOLESTR *rgszNames, UINT cNames,
                                            LCID lcid, DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(MD_Collection *This, DISPID dispIdMember,
                                     REFIID riid, LCID lcid, WORD wFlags,
                                     DISPPARAMS *pDispParams,
                                     VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                                     UINT *puArgErr);
  HRESULT(STDMETHODCALLTYPE *Refresh)(MD_Collection *This);
  HRESULT(STDMETHODCALLTYPE *_NewEnum)(MD_Collection *This,
                                       IUnknown **ppvObject);
  HRESULT(STDMETHODCALLTYPE *get_Count)(MD_Collection *This, long *c);
  END_INTERFACE
} MD_CollectionVtbl;
interface MD_Collection { CONST_VTBL struct MD_CollectionVtbl *lpVtbl; };
#ifdef COBJMACROS
...
#define MD_Collection_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                 \
  ((This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo))
#define MD_Collection_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,       \
                                    rgDispId)                                  \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))
#define MD_Collection_Invoke(This, dispIdMember, riid, lcid, wFlags,           \
...
typedef struct MembersVtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(Members *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(Members *This, UINT iTInfo, LCID lcid,
                                          ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(Members *This, REFIID riid,
                                            LPOLESTR *rgszNames, UINT cNames,
                                            LCID lcid, DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(Members *This, DISPID dispIdMember,
                                     REFIID riid, LCID lcid, WORD wFlags,
                                     DISPPARAMS *pDispParams,
                                     VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                                     UINT *puArgErr);
  ...
  HRESULT(STDMETHODCALLTYPE *get_Item)(Members *This, VARIANT Index,
                                       Member **ppvObject);
  END_INTERFACE
} MembersVtbl;
interface Members { CONST_VTBL struct MembersVtbl *lpVtbl; };
#ifdef COBJMACROS
...
typedef struct LevelsVtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(Levels *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(Levels *This, UINT iTInfo, LCID lcid,
                                          ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(Levels *This, REFIID riid,
                                            LPOLESTR *rgszNames, UINT cNames,
                                            LCID lcid, DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(Levels *This, DISPID dispIdMember,
                                     REFIID riid, LCID lcid, WORD wFlags,
                                     DISPPARAMS *pDispParams,
                                     VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                                     UINT *puArgErr);
  ...
  HRESULT(STDMETHODCALLTYPE *get_Item)(Levels *This, VARIANT Index,
                                       Level **ppvObject);
  END_INTERFACE
} LevelsVtbl;
interface Levels { CONST_VTBL struct LevelsVtbl *lpVtbl; };
#ifdef COBJMACROS
...
typedef struct AxesVtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(Axes *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(Axes *This, UINT iTInfo, LCID lcid,
                                          ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(Axes *This, REFIID riid,
                                            LPOLESTR *rgszNames, UINT cNames,
                                            LCID lcid, DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(Axes *This, DISPID dispIdMember,
                                     REFIID riid, LCID lcid, WORD wFlags,
                                     DISPPARAMS *pDispParams,
                                     VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                                     UINT *puArgErr);
  ...
  HRESULT(STDMETHODCALLTYPE *get_Item)(Axes *This, VARIANT Index,
                                       Axis **ppvObject);
  END_INTERFACE
} AxesVtbl;
interface Axes { CONST_VTBL struct AxesVtbl *lpVtbl; };
#ifdef COBJMACROS
...
public:
  virtual HRESULT STDMETHODCALLTYPE get_Item(VARIANT Index,
                                             Position * *ppvObject) = 0;
};
#else
typedef struct PositionsVtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(Positions *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(Positions *This, UINT iTInfo,
                                          LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(Positions *This, REFIID riid,
                                            LPOLESTR *rgszNames, UINT cNames,
                                            LCID lcid, DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(Positions *This, DISPID dispIdMember,
                                     REFIID riid, LCID lcid, WORD wFlags,
                                     DISPPARAMS *pDispParams,
                                     VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                                     UINT *puArgErr);
  ...
  HRESULT(STDMETHODCALLTYPE *get_Item)(Positions *This, VARIANT Index,
                                       Position **ppvObject);
  END_INTERFACE
} PositionsVtbl;
interface Positions { CONST_VTBL struct PositionsVtbl *lpVtbl; };
#ifdef COBJMACROS
...
public:
  virtual HRESULT STDMETHODCALLTYPE get_Item(VARIANT Index,
                                             Hierarchy * *ppvObject) = 0;
};
#else
typedef struct HierarchiesVtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(Hierarchies *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(Hierarchies *This);
  ULONG(STDMETHODCALLTYPE *Release)(Hierarchies *This);
  HRESULT(STDMETHODCALLTYPE *GetTypeInfoCount)(Hierarchies *This,
                                               UINT *pctinfo);
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(Hierarchies *This, UINT iTInfo,
                                          LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(Hierarchies *This, REFIID riid,
                                            LPOLESTR *rgszNames, UINT cNames,
                                            LCID lcid, DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(Hierarchies *This, DISPID dispIdMember,
                                     REFIID riid, LCID lcid, WORD wFlags,
                                     DISPPARAMS *pDispParams,
                                     VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                                     UINT *puArgErr);
  ...
  HRESULT(STDMETHODCALLTYPE *get_Item)(Hierarchies *This, VARIANT Index,
                                       Hierarchy **ppvObject);
  END_INTERFACE
} HierarchiesVtbl;
interface Hierarchies { CONST_VTBL struct HierarchiesVtbl *lpVtbl; };
#ifdef COBJMACROS
...
#define Hierarchies_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                   \
  ((This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo))
#define Hierarchies_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,         \
                                  rgDispId)                                    \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))
#define Hierarchies_Invoke(This, dispIdMember, riid, lcid, wFlags,             \
                           pDispParams, pVarResult, pExcepInfo, puArgErr)      \
  ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
                          pVarResult, pExcepInfo, puArgErr))
...
public:
  virtual HRESULT STDMETHODCALLTYPE get_Item(VARIANT Index,
                                             Dimension * *ppvObject) = 0;
};
#else
typedef struct DimensionsVtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(Dimensions *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(Dimensions *This, UINT iTInfo,
                                          LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(Dimensions *This, REFIID riid,
                                            LPOLESTR *rgszNames, UINT cNames,
                                            LCID lcid, DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(Dimensions *This, DISPID dispIdMember,
                                     REFIID riid, LCID lcid, WORD wFlags,
                                     DISPPARAMS *pDispParams,
                                     VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                                     UINT *puArgErr);
  ...
  HRESULT(STDMETHODCALLTYPE *get_Item)(Dimensions *This, VARIANT Index,
                                       Dimension **ppvObject);
  END_INTERFACE
} DimensionsVtbl;
interface Dimensions { CONST_VTBL struct DimensionsVtbl *lpVtbl; };
#ifdef COBJMACROS
...
#define Dimensions_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                    \
  ((This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo))
#define Dimensions_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,          \
                                 rgDispId)                                     \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))
...
typedef struct CubeDefsVtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(CubeDefs *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(CubeDefs *This, UINT iTInfo,
                                          LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(CubeDefs *This, REFIID riid,
                                            LPOLESTR *rgszNames, UINT cNames,
                                            LCID lcid, DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(CubeDefs *This, DISPID dispIdMember,
                                     REFIID riid, LCID lcid, WORD wFlags,
                                     DISPPARAMS *pDispParams,
                                     VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                                     UINT *puArgErr);
  ...
  HRESULT(STDMETHODCALLTYPE *get_Item)(CubeDefs *This, VARIANT Index,
                                       CubeDef **ppvObject);
  END_INTERFACE
} CubeDefsVtbl;
interface CubeDefs { CONST_VTBL struct CubeDefsVtbl *lpVtbl; };
#ifdef COBJMACROS
...
#ifdef __cplusplus
class DECLSPEC_UUID("228136B0-8BD3-11D0-B4EF-00A0C9138CA4") Catalog;
#endif
EXTERN_C const CLSID CLSID_Cellset;
#ifdef __cplusplus
class DECLSPEC_UUID("228136B8-8BD3-11D0-B4EF-00A0C9138CA4") Cellset;
#endif
#endif
#ifdef __cplusplus
}
