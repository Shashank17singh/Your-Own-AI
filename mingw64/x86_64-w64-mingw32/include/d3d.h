...
DEFINE_GUID(IID_IDirect3D3, 0xbb223240, 0xe72b, 0x11d0, 0xa9, 0xb4, 0x00, 0xaa,
            0x00, 0xc0, 0x99, 0x3e);
DEFINE_GUID(IID_IDirect3D7, 0xf5049e77, 0x4861, 0x11d2, 0xa4, 0x07, 0x00, 0xa0,
            0xc9, 0x06, 0x29, 0xa8);
...
DEFINE_GUID(IID_IDirect3DRefDevice, 0x50936643, 0x13e9, 0x11d1, 0x89, 0xaa,
            0x00, 0xa0, 0xc9, 0x05, 0x41, 0x29);
DEFINE_GUID(IID_IDirect3DTnLHalDevice, 0xf5049e78, 0x4861, 0x11d2, 0xa4, 0x07,
...
DEFINE_GUID(IID_IDirect3DDevice2, 0x93281501, 0x8CF8, 0x11D0, 0x89, 0xAB, 0x00,
            0xA0, 0xC9, 0x05, 0x41, 0x29);
DEFINE_GUID(IID_IDirect3DDevice3, 0xb0ab3b60, 0x33d7, 0x11d1, 0xa9, 0x81, 0x00,
            0xc0, 0x4f, 0xd7, 0xb1, 0x74);
DEFINE_GUID(IID_IDirect3DDevice7, 0xf5049e79, 0x4861, 0x11d2, 0xa4, 0x07, 0x00,
            0xa0, 0xc9, 0x06, 0x29, 0xa8);
DEFINE_GUID(IID_IDirect3DTexture, 0x2CDCD9E0, 0x25A0, 0x11CF, 0xA3, 0x1A, 0x00,
            0xAA, 0x00, 0xB9, 0x33, 0x56);
DEFINE_GUID(IID_IDirect3DTexture2, 0x93281502, 0x8CF8, 0x11D0, 0x89, 0xAB, 0x00,
            0xA0, 0xC9, 0x05, 0x41, 0x29);
...
DEFINE_GUID(IID_IDirect3DMaterial, 0x4417C144, 0x33AD, 0x11CF, 0x81, 0x6F, 0x00,
            0x00, 0xC0, 0x20, 0x15, 0x6E);
DEFINE_GUID(IID_IDirect3DMaterial2, 0x93281503, 0x8CF8, 0x11D0, 0x89, 0xAB,
            0x00, 0xA0, 0xC9, 0x05, 0x41, 0x29);
DEFINE_GUID(IID_IDirect3DMaterial3, 0xca9c46f4, 0xd3c5, 0x11d1, 0xb7, 0x5a,
            0x00, 0x60, 0x08, 0x52, 0xb3, 0x12);
...
DEFINE_GUID(IID_IDirect3DViewport, 0x4417C146, 0x33AD, 0x11CF, 0x81, 0x6F, 0x00,
            0x00, 0xC0, 0x20, 0x15, 0x6E);
DEFINE_GUID(IID_IDirect3DViewport2, 0x93281500, 0x8CF8, 0x11D0, 0x89, 0xAB,
            0x00, 0xA0, 0xC9, 0x05, 0x41, 0x29);
DEFINE_GUID(IID_IDirect3DViewport3, 0xb0ab3b61, 0x33d7, 0x11d1, 0xa9, 0x81,
            0x00, 0xc0, 0x4f, 0xd7, 0xb1, 0x74);
DEFINE_GUID(IID_IDirect3DVertexBuffer, 0x7a503555, 0x4a83, 0x11d1, 0xa5, 0xdb,
            0x00, 0xa0, 0xc9, 0x03, 0x67, 0xf8);
DEFINE_GUID(IID_IDirect3DVertexBuffer7, 0xf5049e7d, 0x4861, 0x11d2, 0xa4, 0x07,
            0x00, 0xa0, 0xc9, 0x06, 0x29, 0xa8);
...
DECLARE_INTERFACE_(IDirect3D, IUnknown) {
  ...
  STDMETHOD(CreateLight)(THIS_ struct IDirect3DLight * *light, IUnknown * outer)
      PURE;
  STDMETHOD(CreateMaterial)(THIS_ struct IDirect3DMaterial * *material,
                            IUnknown * outer) PURE;
  STDMETHOD(CreateViewport)(THIS_ struct IDirect3DViewport * *viewport,
                            IUnknown * outer) PURE;
  STDMETHOD(FindDevice)(THIS_ D3DFINDDEVICESEARCH * search,
                        D3DFINDDEVICERESULT * result) PURE;
};
#undef INTERFACE
...
DECLARE_INTERFACE_(IDirect3D2, IUnknown) {
  ...
  STDMETHOD(CreateLight)(THIS_ struct IDirect3DLight * *light, IUnknown * outer)
      PURE;
  STDMETHOD(CreateMaterial)(THIS_ struct IDirect3DMaterial2 * *material,
                            IUnknown * outer) PURE;
  STDMETHOD(CreateViewport)(THIS_ struct IDirect3DViewport2 * *viewport,
                            IUnknown * outer) PURE;
  STDMETHOD(FindDevice)(THIS_ D3DFINDDEVICESEARCH * search,
                        D3DFINDDEVICERESULT * result) PURE;
...
DECLARE_INTERFACE_(IDirect3D3, IUnknown) {
  ...
  STDMETHOD(CreateLight)(THIS_ struct IDirect3DLight * *light, IUnknown * outer)
      PURE;
  STDMETHOD(CreateMaterial)(THIS_ struct IDirect3DMaterial3 * *material,
                            IUnknown * outer) PURE;
  STDMETHOD(CreateViewport)(THIS_ struct IDirect3DViewport3 * *viewport,
                            IUnknown * outer) PURE;
  STDMETHOD(FindDevice)(THIS_ D3DFINDDEVICESEARCH * search,
                        D3DFINDDEVICERESULT * result) PURE;
  ...
  STDMETHOD(CreateVertexBuffer)(THIS_ D3DVERTEXBUFFERDESC * desc,
                                struct IDirect3DVertexBuffer * *buffer,
                                DWORD flags, IUnknown * outer) PURE;
  STDMETHOD(EnumZBufferFormats)(THIS_ REFCLSID device_iid,
...
DECLARE_INTERFACE_(IDirect3D7, IUnknown) {
  ...
  STDMETHOD(CreateVertexBuffer)(THIS_ D3DVERTEXBUFFERDESC * desc,
                                struct IDirect3DVertexBuffer7 * *buffer,
                                DWORD flags) PURE;
  STDMETHOD(EnumZBufferFormats)(THIS_ REFCLSID device_iid,
                                LPD3DENUMPIXELFORMATSCALLBACK cb, void *ctx)
      PURE;
...
DECLARE_INTERFACE_(IDirect3DMaterial, IUnknown) {
  ...
  STDMETHOD(GetHandle)(THIS_ struct IDirect3DDevice * device,
                       D3DMATERIALHANDLE * handle) PURE;
...
DECLARE_INTERFACE_(IDirect3DMaterial2, IUnknown) {
  ...
  STDMETHOD(SetMaterial)(THIS_ D3DMATERIAL * data) PURE;
  STDMETHOD(GetMaterial)(THIS_ D3DMATERIAL * data) PURE;
  STDMETHOD(GetHandle)(THIS_ struct IDirect3DDevice2 * device,
                       D3DMATERIALHANDLE * handle) PURE;
};
#undef INTERFACE
#if !defined(__cplusplus) || defined(CINTERFACE)
...
DECLARE_INTERFACE_(IDirect3DMaterial3, IUnknown) {
  ...
  STDMETHOD(SetMaterial)(THIS_ D3DMATERIAL * data) PURE;
  STDMETHOD(GetMaterial)(THIS_ D3DMATERIAL * data) PURE;
  STDMETHOD(GetHandle)(THIS_ struct IDirect3DDevice3 * device,
                       D3DMATERIALHANDLE * handle) PURE;
};
#undef INTERFACE
#if !defined(__cplusplus) || defined(CINTERFACE)
...
DECLARE_INTERFACE_(IDirect3DTexture, IUnknown) {
  ...
  STDMETHOD(Initialize)(THIS_ struct IDirect3DDevice * device,
                        IDirectDrawSurface * surface) PURE;
  STDMETHOD(GetHandle)(THIS_ struct IDirect3DDevice * device,
                       D3DTEXTUREHANDLE * handle) PURE;
...
DECLARE_INTERFACE_(IDirect3DViewport, IUnknown) {
  ...
  STDMETHOD(TransformVertices)(THIS_ DWORD vertex_count,
                               D3DTRANSFORMDATA * data, DWORD flags,
                               DWORD * offscreen) PURE;
  ...
  STDMETHOD(GetBackground)(THIS_ D3DMATERIALHANDLE * material, WINBOOL * valid)
      PURE;
  STDMETHOD(SetBackgroundDepth)(THIS_ IDirectDrawSurface * surface) PURE;
  STDMETHOD(GetBackgroundDepth)(THIS_ IDirectDrawSurface * *surface,
                                WINBOOL * valid) PURE;
  ...
  STDMETHOD(NextLight)(THIS_ IDirect3DLight * ref, IDirect3DLight * *light,
                       DWORD flags) PURE;
};
#undef INTERFACE
#if !defined(__cplusplus) || defined(CINTERFACE)
...
DECLARE_INTERFACE_(IDirect3DViewport3, IDirect3DViewport2) {
  ...
  STDMETHOD(GetBackgroundDepth2)(THIS_ IDirectDrawSurface4 * *surface,
                                 WINBOOL * valid) PURE;
  STDMETHOD(Clear2)(THIS_ DWORD count, D3DRECT * rects, DWORD flags,
                    DWORD color, D3DVALUE z, DWORD stencil) PURE;
};
#undef INTERFACE
#if !defined(__cplusplus) || defined(CINTERFACE)
/*** IUnknown methods ***/
...
DECLARE_INTERFACE_(IDirect3DExecuteBuffer, IUnknown) {
  ...
  STDMETHOD(Initialize)(THIS_ struct IDirect3DDevice * device,
                        D3DEXECUTEBUFFERDESC * desc) PURE;
  ...
  STDMETHOD(Validate)(THIS_ DWORD * offset, LPD3DVALIDATECALLBACK cb, void *ctx,
                      DWORD reserved) PURE;
...
DECLARE_INTERFACE_(IDirect3DDevice, IUnknown) {
  ...
  STDMETHOD(Initialize)(THIS_ IDirect3D * d3d, GUID * guid,
                        D3DDEVICEDESC * desc) PURE;
  STDMETHOD(GetCaps)(THIS_ D3DDEVICEDESC * hal_desc, D3DDEVICEDESC * hel_desc)
      PURE;
  STDMETHOD(SwapTextureHandles)(THIS_ IDirect3DTexture * tex1,
                                IDirect3DTexture * tex2) PURE;
  ...
  STDMETHOD(Execute)(THIS_ IDirect3DExecuteBuffer * buffer,
...
DECLARE_INTERFACE_(IDirect3DDevice2, IUnknown) {
  ...
  STDMETHOD(GetCaps)(THIS_ D3DDEVICEDESC * hal_desc, D3DDEVICEDESC * hel_desc)
      PURE;
  STDMETHOD(SwapTextureHandles)(THIS_ IDirect3DTexture2 * tex1,
                                IDirect3DTexture2 * tex2) PURE;
  STDMETHOD(GetStats)(THIS_ D3DSTATS * stats) PURE;
  ...
  STDMETHOD(SetRenderTarget)(THIS_ IDirectDrawSurface * surface, DWORD flags)
      PURE;
  STDMETHOD(GetRenderTarget)(THIS_ IDirectDrawSurface * *surface) PURE;
  STDMETHOD(Begin)(THIS_ D3DPRIMITIVETYPE d3dpt, D3DVERTEXTYPE dwVertexTypeDesc,
                   DWORD dwFlags) PURE;
  STDMETHOD(BeginIndexed)(THIS_ D3DPRIMITIVETYPE primitive_type,
                          D3DVERTEXTYPE vertex_type, void *vertices,
                          DWORD vertex_count, DWORD flags) PURE;
  ...
  STDMETHOD(GetRenderState)(THIS_ D3DRENDERSTATETYPE dwRenderStateType,
                            LPDWORD lpdwRenderState) PURE;
  STDMETHOD(SetRenderState)(THIS_ D3DRENDERSTATETYPE dwRenderStateType,
                            DWORD dwRenderState) PURE;
  STDMETHOD(GetLightState)(THIS_ D3DLIGHTSTATETYPE dwLightStateType,
                           LPDWORD lpdwLightState) PURE;
  STDMETHOD(SetLightState)(THIS_ D3DLIGHTSTATETYPE dwLightStateType,
                           DWORD dwLightState) PURE;
  STDMETHOD(SetTransform)(THIS_ D3DTRANSFORMSTATETYPE state, D3DMATRIX * matrix)
      PURE;
  ...
  STDMETHOD(DrawIndexedPrimitive)(THIS_ D3DPRIMITIVETYPE primitive_type,
                                  ...
                                  DWORD index_count, DWORD flags) PURE;
...
DECLARE_INTERFACE_(IDirect3DDevice3, IUnknown) {
  ...
  STDMETHOD(EnumTextureFormats)(THIS_ LPD3DENUMPIXELFORMATSCALLBACK cb,
                                void *ctx) PURE;
  STDMETHOD(BeginScene)(THIS) PURE;
  STDMETHOD(EndScene)(THIS) PURE;
  ...
  STDMETHOD(SetRenderTarget)(THIS_ IDirectDrawSurface4 * surface, DWORD flags)
      PURE;
  STDMETHOD(GetRenderTarget)(THIS_ IDirectDrawSurface4 * *surface) PURE;
  STDMETHOD(Begin)(THIS_ D3DPRIMITIVETYPE d3dptPrimitiveType,
  ...
  STDMETHOD(DrawIndexedPrimitive)(
      THIS_ D3DPRIMITIVETYPE primitive_type, DWORD fvf, void *vertices,
      DWORD vertex_count, WORD *indices, DWORD index_count, DWORD flags) PURE;
  STDMETHOD(SetClipStatus)(THIS_ D3DCLIPSTATUS * clip_status) PURE;
  STDMETHOD(GetClipStatus)(THIS_ D3DCLIPSTATUS * clip_status) PURE;
  STDMETHOD(DrawPrimitiveStrided)(THIS_ D3DPRIMITIVETYPE primitive_type,
                                  DWORD fvf,
  ...
  STDMETHOD(DrawIndexedPrimitiveStrided)(
      ...
      D3DDRAWPRIMITIVESTRIDEDDATA * strided_data, DWORD vertex_count,
  ...
  STDMETHOD(DrawIndexedPrimitiveVB)(
      THIS_ D3DPRIMITIVETYPE primitive_type, struct IDirect3DVertexBuffer * vb,
      WORD * indices, DWORD index_count, DWORD flags) PURE;
  STDMETHOD(ComputeSphereVisibility)(THIS_ D3DVECTOR * centers,
                                     D3DVALUE * radii, DWORD sphere_count,
  ...
  STDMETHOD(GetTextureStageState)(THIS_ DWORD dwStage,
                                  D3DTEXTURESTAGESTATETYPE d3dTexStageStateType,
                                  LPDWORD lpdwState) PURE;
  STDMETHOD(SetTextureStageState)(THIS_ DWORD dwStage,
                                  D3DTEXTURESTAGESTATETYPE d3dTexStageStateType,
                                  DWORD dwState) PURE;
...
DECLARE_INTERFACE_(IDirect3DDevice7, IUnknown) {
  ...
  STDMETHOD(SetRenderTarget)(THIS_ IDirectDrawSurface7 * surface, DWORD flags)
      PURE;
  STDMETHOD(GetRenderTarget)(THIS_ IDirectDrawSurface7 * *surface) PURE;
  STDMETHOD(Clear)(THIS_ DWORD count, D3DRECT * rects, DWORD flags,
                   D3DCOLOR color, D3DVALUE z, DWORD stencil) PURE;
  STDMETHOD(SetTransform)(THIS_ D3DTRANSFORMSTATETYPE state, D3DMATRIX * matrix)
      PURE;
  STDMETHOD(GetTransform)(THIS_ D3DTRANSFORMSTATETYPE state, D3DMATRIX * matrix)
      PURE;
  ...
  STDMETHOD(DrawIndexedPrimitiveVB)(
      THIS_ D3DPRIMITIVETYPE primitive_type, struct IDirect3DVertexBuffer7 * vb,
      DWORD start_vertex, DWORD vertex_count, WORD * indices, DWORD index_count,
      DWORD flags) PURE;
  STDMETHOD(ComputeSphereVisibility)(THIS_ D3DVECTOR * centers,
                                     D3DVALUE * radii, DWORD sphere_count,
                                     DWORD flags, DWORD * ret) PURE;
  ...
  STDMETHOD(CreateStateBlock)(THIS_ D3DSTATEBLOCKTYPE d3dsbType,
                              LPDWORD lpdwBlockHandle) PURE;
  STDMETHOD(Load)(THIS_ IDirectDrawSurface7 * dst_surface, POINT * dst_point,
                  IDirectDrawSurface7 * src_surface, RECT * src_rect,
                  DWORD flags) PURE;
...
DECLARE_INTERFACE_(IDirect3DVertexBuffer7, IUnknown) {
  ...
  STDMETHOD(ProcessVerticesStrided)(
      ...
      D3DDRAWPRIMITIVESTRIDEDDATA * data, DWORD fvf, IDirect3DDevice7 * device,
      DWORD flags) PURE;
};
#undef INTERFACE
#if !defined(__cplusplus) || defined(CINTERFACE)
