...
public:
  virtual HRESULT WINAPI GetMimeCLSIDMapping(UINT *pcTypes, LPCSTR **ppszTypes,
                                             CLSID **ppclsID) = 0;
};
#else
typedef struct IMimeInfoVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMimeInfo *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IMimeInfo *This);
  ULONG(WINAPI *Release)(IMimeInfo *This);
  HRESULT(WINAPI *GetMimeCLSIDMapping)(IMimeInfo *This, UINT *pcTypes,
                                       LPCSTR **ppszTypes, CLSID **ppclsID);
  END_INTERFACE
} IMimeInfoVtbl;
struct IMimeInfo {
...
#endif
#endif
HRESULT WINAPI IMimeInfo_GetMimeCLSIDMapping_Proxy(IMimeInfo *This,
                                                   UINT *pcTypes,
                                                   LPCSTR **ppszTypes,
                                                   CLSID **ppclsID);
