...
LPSNMP_MGR_SESSION SNMP_FUNC_TYPE SnmpMgrOpen(LPSTR lpAgentAddress,
                                              LPSTR lpAgentCommunity,
                                              INT nTimeOut, INT nRetries);
WINBOOL SNMP_FUNC_TYPE SnmpMgrCtl(LPSNMP_MGR_SESSION session, DWORD dwCtlCode,
                                  LPVOID lpvInBuffer, DWORD cbInBuffer,
                                  LPVOID lpvOUTBuffer, DWORD cbOUTBuffer,
                                  LPDWORD lpcbBytesReturned);
WINBOOL SNMP_FUNC_TYPE SnmpMgrClose(LPSNMP_MGR_SESSION session);
SNMPAPI SNMP_FUNC_TYPE SnmpMgrRequest(LPSNMP_MGR_SESSION session,
                                      BYTE requestType,
...
WINBOOL SNMP_FUNC_TYPE SnmpMgrGetTrap(AsnObjectIdentifier *enterprise,
                                      AsnNetworkAddress *IPAddress,
                                      AsnInteger *genericTrap,
                                      AsnInteger *specificTrap,
                                      AsnTimeticks *timeStamp,
                                      RFC1157VarBindList *variableBindings);
WINBOOL SNMP_FUNC_TYPE SnmpMgrGetTrapEx(
    AsnObjectIdentifier *enterprise, AsnNetworkAddress *agentAddress,
    AsnNetworkAddress *sourceAddress, AsnInteger *genericTrap,
