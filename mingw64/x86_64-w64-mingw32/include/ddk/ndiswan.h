...
#define NdisMWanInitializeWrapper(NdisWrapperHandle, SystemSpecific1,          \
                                  SystemSpecific2, SystemSpecific3)            \
  {                                                                            \
    NdisMInitializeWrapper(NdisWrapperHandle, SystemSpecific1,                 \
                           SystemSpecific2, SystemSpecific3);                  \
  }
