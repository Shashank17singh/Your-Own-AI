...
typedef NTSTATUS(NTAPI *PPARALLEL_SET_CHIP_MODE)(IN PVOID SetChipContext,
                                                 IN UCHAR ChipMode);
typedef NTSTATUS(NTAPI *PPARALLEL_CLEAR_CHIP_MODE)(IN PVOID ClearChipContext,
                                                   IN UCHAR ChipMode);
typedef NTSTATUS(NTAPI *PPARCHIP_CLEAR_CHIP_MODE)(IN PVOID ClearChipContext,
                                                  IN UCHAR ChipMode);
typedef NTSTATUS(NTAPI *PPARALLEL_TRY_SELECT_ROUTINE)(
    IN PVOID TrySelectContext, IN PVOID TrySelectCommand);
typedef NTSTATUS(NTAPI *PPARALLEL_DESELECT_ROUTINE)(IN PVOID DeselectContext,
...
typedef BOOLEAN(NTAPI *PPARALLEL_TRY_ALLOCATE_ROUTINE)(
    IN PVOID TryAllocateContext);
typedef VOID(NTAPI *PPARALLEL_FREE_ROUTINE)(IN PVOID FreeContext);
typedef ULONG(NTAPI *PPARALLEL_QUERY_WAITERS_ROUTINE)(
...
typedef enum _PARALLEL_SAFETY { SAFE_MODE, UNSAFE_MODE } PARALLEL_SAFETY;
typedef NTSTATUS(NTAPI *PNEGOTIATE_IEEE_MODE)(IN PVOID Context,
...
typedef NTSTATUS(NTAPI *PPARALLEL_READ)(IN PVOID Context, OUT PVOID Buffer,
                                        IN ULONG NumBytesToRead,
                                        OUT PULONG NumBytesRead,
                                        IN UCHAR Channel);
typedef NTSTATUS(NTAPI *PPARALLEL_WRITE)(IN PVOID Context, OUT PVOID Buffer,
                                         IN ULONG NumBytesToWrite,
                                         OUT PULONG NumBytesWritten,
                                         IN UCHAR Channel);
typedef NTSTATUS(NTAPI *PPARALLEL_TRYSELECT_DEVICE)(
    IN PVOID Context, IN PARALLEL_1284_COMMAND Command);
typedef NTSTATUS(NTAPI *PPARALLEL_DESELECT_DEVICE)(
    IN PVOID Context, IN PARALLEL_1284_COMMAND Command);
