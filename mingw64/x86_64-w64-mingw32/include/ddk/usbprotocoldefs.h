...
#define USB_UNCONNECTED_ADDRESS(address)                                       \
  (USB_UnConnected_Device_Address == (address))
#define USB_CONNECTED_ADDRESS(address)                                         \
  (USB_UnConnected_Device_Address != (address))
#define PID_OUT 1
#define PID_IN 9
#define PID_SOF 5
...
#define USB_MAKE_REQUEST_TYPE(direction, type, recipient)                      \
  (BYTE)(((BYTE)direction << 7) | ((BYTE)type << 5) | ((BYTE)recipient & 0x07))
#endif
#define GET_STATUS 0
