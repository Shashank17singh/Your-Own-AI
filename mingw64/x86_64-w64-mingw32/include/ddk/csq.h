 ...
 *
 */
typedef VOID(NTAPI IO_CSQ_INSERT_IRP)(IN struct _IO_CSQ *Csq, IN PIRP Irp);
 ...
 *
 */
typedef VOID(NTAPI IO_CSQ_REMOVE_IRP)(IN struct _IO_CSQ *Csq, IN PIRP Irp);
 ...
 *
 ...
 Tail.Overlay.ListEntry); if(IsListEmpty(&IrpQueue)) return NULL; return
 CONTAINING_RECORD(IrpQueue.Flink, IRP, Tail.Overlay.ListEntry);
  }
 *
 */
typedef PIRP(NTAPI IO_CSQ_PEEK_NEXT_IRP)(IN struct _IO_CSQ *Csq, IN PIRP Irp,
 ...
 *
 */
typedef VOID(NTAPI IO_CSQ_ACQUIRE_LOCK)(IN struct _IO_CSQ *Csq,
                                        OUT PKIRQL Irql);
 ...
 *
 */
typedef VOID(NTAPI IO_CSQ_RELEASE_LOCK)(IN struct _IO_CSQ *Csq, IN KIRQL Irql);
 ...
 *
 */
typedef VOID(NTAPI IO_CSQ_COMPLETE_CANCELED_IRP)(IN struct _IO_CSQ *Csq,
                                                 IN PIRP Irp);
 ...
 */
NTKERNELAPI
NTSTATUS NTAPI IoCsqInitialize(
    PIO_CSQ Csq, PIO_CSQ_INSERT_IRP CsqInsertIrp,
    PIO_CSQ_REMOVE_IRP CsqRemoveIrp, PIO_CSQ_PEEK_NEXT_IRP CsqPeekNextIrp,
    PIO_CSQ_ACQUIRE_LOCK CsqAcquireLock, PIO_CSQ_RELEASE_LOCK CsqReleaseLock,
    PIO_CSQ_COMPLETE_CANCELED_IRP CsqCompleteCanceledIrp);
/*
 ...
 */
NTKERNELAPI
NTSTATUS NTAPI IoCsqInitializeEx(
    PIO_CSQ Csq, PIO_CSQ_INSERT_IRP_EX CsqInsertIrpEx,
    PIO_CSQ_REMOVE_IRP CsqRemoveIrp, PIO_CSQ_PEEK_NEXT_IRP CsqPeekNextIrp,
    PIO_CSQ_ACQUIRE_LOCK CsqAcquireLock, PIO_CSQ_RELEASE_LOCK CsqReleaseLock,
    PIO_CSQ_COMPLETE_CANCELED_IRP CsqCompleteCanceledIrp);
/*
 ...
 */
NTKERNELAPI
VOID NTAPI IoCsqInsertIrp(PIO_CSQ Csq, PIRP Irp, PIO_CSQ_IRP_CONTEXT Context);
/*
 * Insert an IRP into the queue, with special context maintained that
 * makes it easy to find IRPs in the queue
 */
NTKERNELAPI
NTSTATUS NTAPI IoCsqInsertIrpEx(PIO_CSQ Csq, PIRP Irp,
 ...
 */
NTKERNELAPI
PIRP NTAPI IoCsqRemoveIrp(PIO_CSQ Csq, PIO_CSQ_IRP_CONTEXT Context);
/*
 * Remove the next IRP from the queue
 */
NTKERNELAPI
PIRP NTAPI IoCsqRemoveNextIrp(PIO_CSQ Csq, PVOID PeekContext);
#ifdef __cplusplus
}
#endif
