...
#define IOCTL_TDI_QUERY_DIRECT_SEND_HANDLER                                    \
  _TDI_CONTROL_CODE(0x80, METHOD_NEITHER)
#define IOCTL_TDI_QUERY_DIRECT_SENDDG_HANDLER                                  \
  _TDI_CONTROL_CODE(0x81, METHOD_NEITHER)
/* TdiAssociateAddress */
...
typedef NTSTATUS(NTAPI *PTDI_IND_CONNECT)(
    IN PVOID TdiEventContext, IN LONG RemoteAddressLength,
    IN PVOID RemoteAddress, IN LONG UserDataLength, IN PVOID UserData,
    IN LONG OptionsLength, IN PVOID Options,
    OUT CONNECTION_CONTEXT *ConnectionContext, OUT PIRP *AcceptIrp);
TDIKRNLAPI
NTSTATUS
NTAPI
TdiDefaultConnectHandler(IN PVOID TdiEventContext, IN LONG RemoteAddressLength,
                         IN PVOID RemoteAddress, IN LONG UserDataLength,
                         IN PVOID UserData, IN LONG OptionsLength,
                         IN PVOID Options,
                         OUT CONNECTION_CONTEXT *ConnectionContext,
                         OUT PIRP *AcceptIrp);
typedef NTSTATUS(NTAPI *PTDI_IND_DISCONNECT)(
    IN PVOID TdiEventContext, IN CONNECTION_CONTEXT ConnectionContext,
    IN LONG DisconnectDataLength, IN PVOID DisconnectData,
...
typedef NTSTATUS(NTAPI *PTDI_IND_ERROR_EX)(IN PVOID TdiEventContext,
                                           IN NTSTATUS Status, IN PVOID Buffer);
TDIKRNLAPI
NTSTATUS
NTAPI
TdiDefaultErrorHandler(IN PVOID TdiEventContext, IN NTSTATUS Status);
...
TdiDefaultReceiveHandler(IN PVOID TdiEventContext,
                         IN CONNECTION_CONTEXT ConnectionContext,
                         IN ULONG ReceiveFlags, IN ULONG BytesIndicated,
                         IN ULONG BytesAvailable, OUT ULONG *BytesTaken,
                         IN PVOID Tsdu, OUT PIRP *IoRequestPacket);
typedef NTSTATUS(NTAPI *PTDI_IND_RECEIVE_DATAGRAM)(
    IN PVOID TdiEventContext, IN LONG SourceAddressLength,
    IN PVOID SourceAddress, IN LONG OptionsLength, IN PVOID Options,
    IN ULONG ReceiveDatagramFlags, IN ULONG BytesIndicated,
    IN ULONG BytesAvailable, OUT ULONG *BytesTaken, IN PVOID Tsdu,
    OUT PIRP *IoRequestPacket);
TDIKRNLAPI
NTSTATUS NTAPI TdiDefaultRcvDatagramHandler(
    IN PVOID TdiEventContext, IN LONG SourceAddressLength,
    IN PVOID SourceAddress, IN LONG OptionsLength, IN PVOID Options,
    IN ULONG ReceiveDatagramFlags, IN ULONG BytesIndicated,
    IN ULONG BytesAvailable, OUT ULONG *BytesTaken, IN PVOID Tsdu,
    OUT PIRP *IoRequestPacket);
typedef NTSTATUS(NTAPI *PTDI_IND_RECEIVE_EXPEDITED)(
    IN PVOID TdiEventContext, IN CONNECTION_CONTEXT ConnectionContext,
    IN ULONG ReceiveFlags, IN ULONG BytesIndicated, IN ULONG BytesAvailable,
    OUT ULONG *BytesTaken, IN PVOID Tsdu, OUT PIRP *IoRequestPacket);
TDIKRNLAPI
NTSTATUS
NTAPI
TdiDefaultRcvExpeditedHandler(IN PVOID TdiEventContext,
                              IN CONNECTION_CONTEXT ConnectionContext,
                              IN ULONG ReceiveFlags, IN ULONG BytesIndicated,
                              IN ULONG BytesAvailable, OUT ULONG *BytesTaken,
                              IN PVOID Tsdu, OUT PIRP *IoRequestPacket);
typedef NTSTATUS(NTAPI *PTDI_IND_CHAINED_RECEIVE)(
    IN PVOID TdiEventContext, IN CONNECTION_CONTEXT ConnectionContext,
...
TdiDefaultChainedReceiveHandler(IN PVOID TdiEventContext,
                                IN CONNECTION_CONTEXT ConnectionContext,
                                IN ULONG ReceiveFlags, IN ULONG ReceiveLength,
                                IN ULONG StartingOffset, IN PMDL Tsdu,
                                IN PVOID TsduDescriptor);
typedef NTSTATUS(NTAPI *PTDI_IND_CHAINED_RECEIVE_DATAGRAM)(
    IN PVOID TdiEventContext, IN LONG SourceAddressLength,
    IN PVOID SourceAddress, IN LONG OptionsLength, IN PVOID Options,
    IN ULONG ReceiveDatagramFlags, IN ULONG ReceiveDatagramLength,
...
TdiDefaultChainedRcvDatagramHandler(
    ...
    IN ULONG ReceiveDatagramFlags, IN ULONG ReceiveDatagramLength,
    IN ULONG StartingOffset, IN PMDL Tsdu, IN PVOID TsduDescriptor);
typedef NTSTATUS(NTAPI *PTDI_IND_CHAINED_RECEIVE_EXPEDITED)(
    IN PVOID TdiEventContext, IN CONNECTION_CONTEXT ConnectionContext,
    IN ULONG ReceiveFlags, IN ULONG ReceiveLength, IN ULONG StartingOffset,
    IN PMDL Tsdu, IN PVOID TsduDescriptor);
TDIKRNLAPI
NTSTATUS
NTAPI
TdiDefaultChainedRcvExpeditedHandler(IN PVOID TdiEventContext,
                                     IN CONNECTION_CONTEXT ConnectionContext,
                                     IN ULONG ReceiveFlags,
                                     IN ULONG ReceiveLength,
                                     IN ULONG StartingOffset, IN PMDL Tsdu,
                                     IN PVOID TsduDescriptor);
typedef NTSTATUS(NTAPI *PTDI_IND_SEND_POSSIBLE)(IN PVOID TdiEventContext,
...
#define TdiBuildBaseIrp(bIrp, bDevObj, bFileObj, bCompRoutine, bContxt,        \
                        bIrpSp, bMinor)                                        \
  {                                                                            \
 ...
 */
#define TdiBuildAccept(Irp, DevObj, FileObj, CompRoutine, Contxt,              \
  ...
  {                                                                            \
    ...
    _IrpSp = IoGetNextIrpStackLocation(Irp);                                   \
                                                                               \
    TdiBuildBaseIrp(Irp, DevObj, FileObj, CompRoutine, Contxt, _IrpSp,         \
                    TDI_ACCEPT);                                               \
                                                                               \
 ...
 */
#define TdiBuildAssociateAddress(Irp, DevObj, FileObj, CompRoutine, Contxt,    \
                                 AddrHandle)                                   \
  {                                                                            \
 ...
 *   OUT PTDI_CONNECTION_INFORMATION  ReturnConnectionInfo);
 */
#define TdiBuildDisconnect(Irp, DevObj, FileObj, CompRoutine, Contxt, Time,    \
...
#define TdiBuildInternalDeviceControlIrp(IrpSubFunction, DeviceObject,         \
  ...
  IoBuildDeviceIoControlRequest(IrpSubFunction, DeviceObject, NULL, 0, NULL,   \
                                0, TRUE, Event, IoStatusBlock)
/*
 * VOID
 * TdiBuildListen(
 *   IN PIRP  Irp,
 ...
 *   OUT PTDI_CONNECTION_INFORMATION  ReturnConnectionInfo);
 */
#define TdiBuildListen(Irp, DevObj, FileObj, CompRoutine, Contxt, Flags,       \
                       RequestConnectionInfo, ReturnConnectionInfo)            \
  {                                                                            \
    PTDI_REQUEST_KERNEL _Request;                                              \
    PIO_STACK_LOCATION _IrpSp;                                                 \
...
TDIKRNLAPI
VOID NTAPI TdiBuildNetbiosAddress(IN PUCHAR NetbiosName, IN BOOLEAN IsGroupName,
 ...
 *   IN PMDL  MdlAddr);
 */
#define TdiBuildQueryInformation(Irp, DevObj, FileObj, CompRoutine, Contxt,    \
                                 QType, MdlAddr)                               \
  {                                                                            \
 ...
 *   IN ULONG  ReceiveLen);
 */
#define TdiBuildReceive(Irp, DevObj, FileObj, CompRoutine, Contxt, MdlAddr,    \
                        InFlags, ReceiveLen)                                   \
  {                                                                            \
 ...
 *   ULONG InFlags);
 */
#define TdiBuildReceiveDatagram(Irp, DevObj, FileObj, CompRoutine, Contxt,     \
                                MdlAddr, ReceiveLen, ReceiveDatagramInfo,      \
                                ReturnInfo, InFlags)                           \
  {                                                                            \
 ...
 *   IN ULONG  SendLen);
 */
#define TdiBuildSend(Irp, DevObj, FileObj, CompRoutine, Contxt, MdlAddr,       \
                     InFlags, SendLen)                                         \
  {                                                                            \
 ...
 */
#define TdiBuildSendDatagram(Irp, DevObj, FileObj, CompRoutine, Contxt,        \
 ...
 */
#define TdiBuildSetEventHandler(Irp, DevObj, FileObj, CompRoutine, Contxt,     \
 ...
 *   IN PMDL  MdlAddr);
 */
#define TdiBuildSetInformation(Irp, DevObj, FileObj, CompRoutine, Contxt,      \
                               SType, MdlAddr)                                 \
  {                                                                            \
...
typedef VOID(NTAPI *TDI_ADD_ADDRESS_HANDLER_V2)(IN PTA_ADDRESS Address,
                                                IN PUNICODE_STRING DeviceName,
                                                IN PTDI_PNP_CONTEXT Context);
typedef VOID(NTAPI *TDI_BINDING_HANDLER)(IN TDI_PNP_OPCODE PnPOpcode,
                                         IN PUNICODE_STRING DeviceName,
...
typedef VOID(NTAPI *TDI_DEL_ADDRESS_HANDLER_V2)(IN PTA_ADDRESS Address,
                                                IN PUNICODE_STRING DeviceName,
                                                IN PTDI_PNP_CONTEXT Context);
typedef NTSTATUS(NTAPI *TDI_PNP_POWER_HANDLER)(IN PUNICODE_STRING DeviceName,
                                               IN PNET_PNP_EVENT PowerEvent,
                                               IN PTDI_PNP_CONTEXT Context1,
                                               IN PTDI_PNP_CONTEXT Context2);
typedef VOID(NTAPI *TDI_UNBIND_HANDLER)(IN PUNICODE_STRING DeviceName);
typedef VOID(NTAPI *ProviderPnPPowerComplete)(IN PNET_PNP_EVENT NetEvent,
...
NTSTATUS
NTAPI
TdiCopyBufferToMdl(IN PVOID SourceBuffer, IN ULONG SourceOffset,
                   IN ULONG SourceBytesToCopy, IN PMDL DestinationMdlChain,
                   IN ULONG DestinationOffset, IN PULONG BytesCopied);
/*
 * VOID
...
NTSTATUS
NTAPI
TdiCopyMdlChainToMdlChain(IN PMDL SourceMdlChain, IN ULONG SourceOffset,
                          IN PMDL DestinationMdlChain,
                          IN ULONG DestinationOffset, OUT PULONG BytesCopied);
TDIKRNLAPI
NTSTATUS
NTAPI
TdiCopyMdlToBuffer(IN PMDL SourceMdlChain, IN ULONG SourceOffset,
                   IN PVOID DestinationBuffer, IN ULONG DestinationOffset,
                   IN ULONG DestinationBufferSize, OUT PULONG BytesCopied);
TDIKRNLAPI
NTSTATUS
NTAPI
...
NTSTATUS
NTAPI
TdiDeregisterNetAddress(IN HANDLE AddrRegistrationHandle);
TDIKRNLAPI
NTSTATUS
NTAPI
TdiDeregisterPnPHandlers(IN HANDLE BindingHandle);
TDIKRNLAPI
NTSTATUS
NTAPI
TdiDeregisterProvider(IN HANDLE ProviderHandle);
TDIKRNLAPI
NTSTATUS
NTAPI
TdiEnumerateAddresses(IN HANDLE BindingHandle);
TDIKRNLAPI
VOID NTAPI TdiInitialize(VOID);
TDIKRNLAPI
VOID NTAPI TdiMapBuffer(IN PMDL MdlChain);
TDIKRNLAPI
NTSTATUS
NTAPI
TdiMapUserRequest(IN PDEVICE_OBJECT DeviceObject, IN PIRP Irp,
                  IN PIO_STACK_LOCATION IrpSp);
TDIKRNLAPI
BOOLEAN
NTAPI
TdiMatchPdoWithChainedReceiveContext(IN PVOID TsduDescriptor, IN PVOID PDO);
TDIKRNLAPI
VOID NTAPI TdiPnPPowerComplete(IN HANDLE BindingHandle,
                               IN PNET_PNP_EVENT PowerEvent,
                               IN NTSTATUS Status);
TDIKRNLAPI
NTSTATUS
NTAPI
TdiPnPPowerRequest(IN PUNICODE_STRING DeviceName, IN PNET_PNP_EVENT PowerEvent,
                   IN PTDI_PNP_CONTEXT Context1, IN PTDI_PNP_CONTEXT Context2,
                   IN ProviderPnPPowerComplete ProtocolCompletionHandler);
TDIKRNLAPI
NTSTATUS
NTAPI
TdiProviderReady(IN HANDLE ProviderHandle);
TDIKRNLAPI
NTSTATUS
NTAPI
...
NTSTATUS
NTAPI
TdiRegisterNetAddress(IN PTA_ADDRESS Address, IN PUNICODE_STRING DeviceName,
                      IN PTDI_PNP_CONTEXT Context,
...
NTSTATUS
NTAPI
TdiRegisterPnPHandlers(IN PTDI_CLIENT_INTERFACE_INFO ClientInterfaceInfo,
                       IN ULONG InterfaceInfoSize, OUT HANDLE *BindingHandle);
TDIKRNLAPI
NTSTATUS
NTAPI
TdiRegisterProvider(IN PUNICODE_STRING ProviderName,
                    OUT HANDLE *ProviderHandle);
TDIKRNLAPI
VOID NTAPI TdiReturnChainedReceives(IN PVOID *TsduDescriptors,
                                    IN ULONG NumberOfTsdus);
TDIKRNLAPI
VOID NTAPI TdiUnmapBuffer(IN PMDL MdlChain);
#ifdef __cplusplus
}
#endif
#endif /* __TDIKRNL_H */
