...
#define SIZE_ENUM_PDO_RESULTS_HEADER                                           \
  (sizeof(ENUM_PDO_RESULTS) - sizeof(ENUM_PDO_ENTRY))
#define IOCTL_EHSTOR_DEVICE_SET_AUTHZ_STATE                                    \
  CTL_CODE(IOCTL_STORAGE_BASE, 0x501, METHOD_BUFFERED, FILE_ANY_ACCESS)
...
DEFINE_GUID(GUID_USBSTOR_EHSTOR_SILO_INTERFACE, 0x7c2bcf57, 0x2bea, 0x46da,
            0xad, 0x26, 0x78, 0xfd, 0xc8, 0x3c, 0xee, 0x46);
DEFINE_GUID(GUID_USBSTOR_EHSTOR_CONTROL_INTERFACE, 0x4f40006f, 0xb933, 0x4550,
            0xb5, 0x32, 0x2b, 0x58, 0xce, 0xe6, 0x14, 0xd3);
