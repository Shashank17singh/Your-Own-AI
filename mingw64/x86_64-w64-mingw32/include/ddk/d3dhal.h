...
typedef DWORD(PASCAL *LPD3DHAL_CONTEXTDESTROYALLCB)(
...
typedef DWORD(PASCAL *LPD3DHAL_DRAWONEINDEXEDPRIMITIVECB)(
    LPD3DHAL_DRAWONEINDEXEDPRIMITIVEDATA);
...
typedef DWORD(PASCAL *LPD3DHAL_VALIDATETEXTURESTAGESTATECB)(
    LPD3DHAL_VALIDATETEXTURESTAGESTATEDATA);
...
#define D3DGDI2_TYPE_DXVERSION                                                 \
  0x00000004 /* Make driver aware of currently used DirectX version */
...
#define D3DGDI2_TYPE_GETDDIVERSION                                             \
  0x00000023 /* Returns DX9_DDI_VERSION, used to check which DDK version the   \
                driver is compiled against */
