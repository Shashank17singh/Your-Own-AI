...
typedef BOOLEAN(FASTCALL *PPROCESSOR_IDLE_HANDLER)(
...
typedef NTSTATUS(NTAPI *PENTER_STATE_HANDLER)(
    IN PVOID Context, IN PENTER_STATE_SYSTEM_HANDLER SystemHandler OPTIONAL,
    IN PVOID SystemContext, IN LONG NumberProcessors, IN LONG volatile *Number);
...
NTSTATUS
NTAPI
NtPowerInformation(IN POWER_INFORMATION_LEVEL InformationLevel,
