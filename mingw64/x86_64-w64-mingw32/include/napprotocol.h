...
DEFINE_GUID(IID_INapSoHConstructor, 0x35298344, 0x96a6, 0x45e7, 0x9b, 0x6b,
            0x62, 0xec, 0xc6, 0xe0, 0x99, 0x20);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("35298344-96a6-45e7-9b6b-62ecc6e09920")
INapSoHConstructor : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE Initialize(SystemHealthEntityId id,
                                               WINBOOL isRequest) = 0;
  virtual HRESULT STDMETHODCALLTYPE AppendAttribute(
      SoHAttributeType type, const SoHAttributeValue *value) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetSoH(SoH * *soh) = 0;
  virtual HRESULT STDMETHODCALLTYPE Validate(const SoH *soh,
                                             WINBOOL isRequest) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(INapSoHConstructor, 0x35298344, 0x96a6, 0x45e7, 0x9b, 0x6b,
                0x62, 0xec, 0xc6, 0xe0, 0x99, 0x20)
#endif
#else
typedef struct INapSoHConstructorVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INapSoHConstructor *This,
  ...
  HRESULT(STDMETHODCALLTYPE *Initialize)(INapSoHConstructor *This,
                                         SystemHealthEntityId id,
                                         WINBOOL isRequest);
  HRESULT(STDMETHODCALLTYPE *AppendAttribute)(INapSoHConstructor *This,
                                              SoHAttributeType type,
                                              const SoHAttributeValue *value);
  HRESULT(STDMETHODCALLTYPE *GetSoH)(INapSoHConstructor *This, SoH **soh);
  HRESULT(STDMETHODCALLTYPE *Validate)(INapSoHConstructor *This, const SoH *soh,
                                       WINBOOL isRequest);
  END_INTERFACE
} INapSoHConstructorVtbl;
interface INapSoHConstructor { CONST_VTBL INapSoHConstructorVtbl *lpVtbl; };
#ifdef COBJMACROS
...
INapSoHConstructor_QueryInterface(INapSoHConstructor *This, REFIID riid,
                                  void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG INapSoHConstructor_AddRef(INapSoHConstructor *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG INapSoHConstructor_Release(INapSoHConstructor *This) {
  return This->lpVtbl->Release(This);
}
/*** INapSoHConstructor methods ***/
static inline HRESULT INapSoHConstructor_Initialize(INapSoHConstructor *This,
                                                    SystemHealthEntityId id,
                                                    WINBOOL isRequest) {
  return This->lpVtbl->Initialize(This, id, isRequest);
}
static inline HRESULT
INapSoHConstructor_AppendAttribute(INapSoHConstructor *This,
                                   SoHAttributeType type,
                                   const SoHAttributeValue *value) {
  return This->lpVtbl->AppendAttribute(This, type, value);
}
static inline HRESULT INapSoHConstructor_GetSoH(INapSoHConstructor *This,
                                                SoH **soh) {
  return This->lpVtbl->GetSoH(This, soh);
}
static inline HRESULT INapSoHConstructor_Validate(INapSoHConstructor *This,
                                                  const SoH *soh,
                                                  WINBOOL isRequest) {
...
DEFINE_GUID(IID_INapSoHProcessor, 0xfb2fa8b0, 0x2cd5, 0x457d, 0xab, 0xa8, 0x43,
            0x76, 0xf6, 0x3e, 0xa1, 0xc0);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("fb2fa8b0-2cd5-457d-aba8-4376f63ea1c0")
INapSoHProcessor : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE Initialize(
      const SoH *soh, WINBOOL isRequest, SystemHealthEntityId *id) = 0;
  virtual HRESULT STDMETHODCALLTYPE FindNextAttribute(
      UINT16 fromLocation, SoHAttributeType type,
      UINT16 * attributeLocation) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetAttribute(
      UINT16 attributeLocation, SoHAttributeType * type,
      SoHAttributeValue * *value) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetNumberOfAttributes(UINT16 *
                                                          attributeCount) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(INapSoHProcessor, 0xfb2fa8b0, 0x2cd5, 0x457d, 0xab, 0xa8, 0x43,
                0x76, 0xf6, 0x3e, 0xa1, 0xc0)
#endif
#else
typedef struct INapSoHProcessorVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INapSoHProcessor *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *Initialize)(INapSoHProcessor *This, const SoH *soh,
                                         WINBOOL isRequest,
                                         SystemHealthEntityId *id);
  HRESULT(STDMETHODCALLTYPE *FindNextAttribute)(INapSoHProcessor *This,
                                                UINT16 fromLocation,
                                                SoHAttributeType type,
                                                UINT16 *attributeLocation);
  HRESULT(STDMETHODCALLTYPE *GetAttribute)(INapSoHProcessor *This,
                                           UINT16 attributeLocation,
                                           SoHAttributeType *type,
                                           SoHAttributeValue **value);
  HRESULT(STDMETHODCALLTYPE *GetNumberOfAttributes)(INapSoHProcessor *This,
                                                    UINT16 *attributeCount);
  END_INTERFACE
} INapSoHProcessorVtbl;
interface INapSoHProcessor { CONST_VTBL INapSoHProcessorVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define INapSoHProcessor_FindNextAttribute(This, fromLocation, type,           \
                                           attributeLocation)                  \
...
#else
/*** IUnknown methods ***/
static inline HRESULT INapSoHProcessor_QueryInterface(INapSoHProcessor *This,
                                                      REFIID riid,
                                                      void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG INapSoHProcessor_AddRef(INapSoHProcessor *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG INapSoHProcessor_Release(INapSoHProcessor *This) {
  return This->lpVtbl->Release(This);
}
/*** INapSoHProcessor methods ***/
static inline HRESULT INapSoHProcessor_Initialize(INapSoHProcessor *This,
                                                  const SoH *soh,
                                                  WINBOOL isRequest,
                                                  SystemHealthEntityId *id) {
...
static inline HRESULT
INapSoHProcessor_FindNextAttribute(INapSoHProcessor *This, UINT16 fromLocation,
                                   SoHAttributeType type,
                                   UINT16 *attributeLocation) {
  return This->lpVtbl->FindNextAttribute(This, fromLocation, type,
                                         attributeLocation);
}
static inline HRESULT INapSoHProcessor_GetAttribute(INapSoHProcessor *This,
                                                    UINT16 attributeLocation,
                                                    SoHAttributeType *type,
                                                    SoHAttributeValue **value) {
...
static inline HRESULT
INapSoHProcessor_GetNumberOfAttributes(INapSoHProcessor *This,
                                       UINT16 *attributeCount) {
