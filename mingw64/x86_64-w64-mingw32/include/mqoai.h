...
typedef struct IMSMQCoordinatedTransactionDispenser
...
typedef struct IMSMQCoordinatedTransactionDispenser2
...
typedef struct IMSMQCoordinatedTransactionDispenser3
...
#ifdef __cplusplus
typedef class MSMQCoordinatedTransactionDispenser
    MSMQCoordinatedTransactionDispenser;
#else
typedef struct MSMQCoordinatedTransactionDispenser
    MSMQCoordinatedTransactionDispenser;
#endif
#endif
...
enum RELOPS { REL_NOP = 0, REL_EQ, REL_NEQ, REL_LT, REL_GT, REL_LE, REL_GE };
enum MQCERT_REGISTER {
  MQCERT_REGISTER_ALWAYS = 1,
  MQCERT_REGISTER_IF_NOT_EXIST = 2
};
enum MQMSGCURSOR { MQMSG_FIRST = 0, MQMSG_CURRENT = 1, MQMSG_NEXT = 2 };
enum MQMSGCLASS {
  ...
  MQMSG_CLASS_NACK_PURGED = 0x8000 + 0x1,
  MQMSG_CLASS_NACK_REACH_QUEUE_TIMEOUT = 0x8000 + 0x2,
  MQMSG_CLASS_NACK_Q_EXCEED_QUOTA = 0x8000 + 0x3,
  MQMSG_CLASS_NACK_ACCESS_DENIED = 0x8000 + 0x4,
  MQMSG_CLASS_NACK_HOP_COUNT_EXCEEDED = 0x8000 + 0x5,
  MQMSG_CLASS_NACK_BAD_SIGNATURE = 0x8000 + 0x6,
  MQMSG_CLASS_NACK_BAD_ENCRYPTION = 0x8000 + 0x7,
  MQMSG_CLASS_NACK_COULD_NOT_ENCRYPT = 0x8000 + 0x8,
  MQMSG_CLASS_NACK_NOT_TRANSACTIONAL_Q = 0x8000 + 0x9,
  MQMSG_CLASS_NACK_NOT_TRANSACTIONAL_MSG = 0x8000 + 0xa,
  MQMSG_CLASS_NACK_UNSUPPORTED_CRYPTO_PROVIDER = 0x8000 + 0xb,
  MQMSG_CLASS_NACK_SOURCE_COMPUTER_GUID_CHANGED = 0x8000 + 0xc,
  MQMSG_CLASS_NACK_Q_DELETED = 0x8000 + 0x4000,
...
enum MQMSGTRACE { MQMSG_TRACE_NONE = 0, MQMSG_SEND_ROUTE_TO_REPORT_QUEUE = 1 };
...
enum MQSHARE { MQ_DENY_NONE = 0, MQ_DENY_RECEIVE_SHARE = 1 };
enum MQACCESS {
  MQ_RECEIVE_ACCESS = 1,
  MQ_SEND_ACCESS = 2,
  MQ_PEEK_ACCESS = 0x20,
...
enum MQJOURNAL { MQ_JOURNAL_NONE = 0, MQ_JOURNAL = 1 };
enum MQTRANSACTIONAL { MQ_TRANSACTIONAL_NONE = 0, MQ_TRANSACTIONAL = 1 };
enum MQAUTHENTICATE { MQ_AUTHENTICATE_NONE = 0, MQ_AUTHENTICATE = 1 };
enum MQPRIVLEVEL {
  MQ_PRIV_LEVEL_NONE = 0,
  MQ_PRIV_LEVEL_OPTIONAL = 1,
  MQ_PRIV_LEVEL_BODY = 2
};
enum MQPRIORITY { MQ_MIN_PRIORITY = 0, MQ_MAX_PRIORITY = 7 };
enum MQMAX { MQ_MAX_Q_NAME_LEN = 124, MQ_MAX_Q_LABEL_LEN = 124 };
enum QUEUE_TYPE {
  MQ_TYPE_PUBLIC = 0,
  MQ_TYPE_PRIVATE,
  MQ_TYPE_MACHINE,
...
enum MQERROR {
  ...
  MQ_ERROR_ILLEGAL_OPERATIO = 0xc00e0064,
...
public:
  virtual HRESULT WINAPI LookupQueue(VARIANT *QueueGuid,
                                     VARIANT *ServiceTypeGuid, VARIANT *Label,
                                     VARIANT *CreateTime, VARIANT *ModifyTime,
                                     VARIANT *RelServiceType, VARIANT *RelLabel,
                                     VARIANT *RelCreateTime,
                                     VARIANT *RelModifyTime,
                                     IMSMQQueueInfos **ppqinfos) = 0;
};
#else
typedef struct IMSMQQueryVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMSMQQuery *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IMSMQQuery *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IMSMQQuery *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IMSMQQuery *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *LookupQueue)(IMSMQQuery *This, VARIANT *QueueGuid,
                               VARIANT *ServiceTypeGuid, VARIANT *Label,
                               VARIANT *CreateTime, VARIANT *ModifyTime,
                               VARIANT *RelServiceType, VARIANT *RelLabel,
                               VARIANT *RelCreateTime, VARIANT *RelModifyTime,
...
#define IMSMQQuery_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,          \
                                 rgDispId)                                     \
...
#define IMSMQQuery_Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams, \
  ...
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
#define IMSMQQuery_LookupQueue(                                                \
    This, QueueGuid, ServiceTypeGuid, Label, CreateTime, ModifyTime,           \
    RelServiceType, RelLabel, RelCreateTime, RelModifyTime, ppqinfos)          \
  (This)->lpVtbl->LookupQueue(                                                 \
      This, QueueGuid, ServiceTypeGuid, Label, CreateTime, ModifyTime,         \
      RelServiceType, RelLabel, RelCreateTime, RelModifyTime, ppqinfos)
#endif
#endif
HRESULT WINAPI IMSMQQuery_LookupQueue_Proxy(
    IMSMQQuery *This, VARIANT *QueueGuid, VARIANT *ServiceTypeGuid,
    VARIANT *Label, VARIANT *CreateTime, VARIANT *ModifyTime,
    VARIANT *RelServiceType, VARIANT *RelLabel, VARIANT *RelCreateTime,
...
public:
  ...
  virtual HRESULT WINAPI Create(VARIANT *IsTransactional,
                                VARIANT *IsWorldReadable) = 0;
  virtual HRESULT WINAPI Delete(void) = 0;
  virtual HRESULT WINAPI Open(__LONG32 Access, __LONG32 ShareMode,
                              IMSMQQueue **ppq) = 0;
...
typedef struct IMSMQQueueInfoVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMSMQQueueInfo *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IMSMQQueueInfo *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IMSMQQueueInfo *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IMSMQQueueInfo *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *get_QueueGuid)(IMSMQQueueInfo *This, BSTR *pbstrGuidQueue);
  HRESULT(WINAPI *get_ServiceTypeGuid)(IMSMQQueueInfo *This,
                                       BSTR *pbstrGuidServiceType);
  HRESULT(WINAPI *put_ServiceTypeGuid)(IMSMQQueueInfo *This,
  ...
  HRESULT(WINAPI *get_IsTransactional)(IMSMQQueueInfo *This,
  ...
  HRESULT(WINAPI *get_BasePriority)(IMSMQQueueInfo *This,
                                    __LONG32 *plBasePriority);
  HRESULT(WINAPI *put_BasePriority)(IMSMQQueueInfo *This,
                                    __LONG32 lBasePriority);
  HRESULT(WINAPI *get_CreateTime)(IMSMQQueueInfo *This,
                                  VARIANT *pvarCreateTime);
  HRESULT(WINAPI *get_ModifyTime)(IMSMQQueueInfo *This,
                                  VARIANT *pvarModifyTime);
  HRESULT(WINAPI *get_Authenticate)(IMSMQQueueInfo *This,
                                    __LONG32 *plAuthenticate);
  HRESULT(WINAPI *put_Authenticate)(IMSMQQueueInfo *This,
                                    __LONG32 lAuthenticate);
  HRESULT(WINAPI *get_JournalQuota)(IMSMQQueueInfo *This,
                                    __LONG32 *plJournalQuota);
  HRESULT(WINAPI *put_JournalQuota)(IMSMQQueueInfo *This,
                                    __LONG32 lJournalQuota);
  HRESULT(WINAPI *get_IsWorldReadable)(IMSMQQueueInfo *This,
                                       Boolean *pisWorldReadable);
  HRESULT(WINAPI *Create)(IMSMQQueueInfo *This, VARIANT *IsTransactional,
                          VARIANT *IsWorldReadable);
  HRESULT(WINAPI *Delete)(IMSMQQueueInfo *This);
  HRESULT(WINAPI *Open)(IMSMQQueueInfo *This, __LONG32 Access,
                        __LONG32 ShareMode, IMSMQQueue **ppq);
...
#define IMSMQQueueInfo_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IMSMQQueueInfo_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,      \
                                     rgDispId)                                 \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IMSMQQueueInfo_Invoke(This, dispIdMember, riid, lcid, wFlags,          \
...
#endif
#endif
HRESULT WINAPI IMSMQQueueInfo_get_QueueGuid_Proxy(IMSMQQueueInfo *This,
                                                  BSTR *pbstrGuidQueue);
void __RPC_STUB IMSMQQueueInfo_get_QueueGuid_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo_get_ServiceTypeGuid_Proxy(
    IMSMQQueueInfo *This, BSTR *pbstrGuidServiceType);
void __RPC_STUB IMSMQQueueInfo_get_ServiceTypeGuid_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo_put_ServiceTypeGuid_Proxy(
    IMSMQQueueInfo *This, BSTR bstrGuidServiceType);
void __RPC_STUB IMSMQQueueInfo_put_ServiceTypeGuid_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo_get_Label_Proxy(IMSMQQueueInfo *This,
                                              BSTR *pbstrLabel);
void __RPC_STUB IMSMQQueueInfo_get_Label_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo_put_Label_Proxy(IMSMQQueueInfo *This,
                                              BSTR bstrLabel);
void __RPC_STUB IMSMQQueueInfo_put_Label_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo_get_PathName_Proxy(IMSMQQueueInfo *This,
                                                 BSTR *pbstrPathName);
void __RPC_STUB IMSMQQueueInfo_get_PathName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo_put_PathName_Proxy(IMSMQQueueInfo *This,
                                                 BSTR bstrPathName);
void __RPC_STUB IMSMQQueueInfo_put_PathName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo_get_FormatName_Proxy(IMSMQQueueInfo *This,
                                                   BSTR *pbstrFormatName);
void __RPC_STUB IMSMQQueueInfo_get_FormatName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo_put_FormatName_Proxy(IMSMQQueueInfo *This,
                                                   BSTR bstrFormatName);
void __RPC_STUB IMSMQQueueInfo_put_FormatName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo_get_IsTransactional_Proxy(
    IMSMQQueueInfo *This, Boolean *pisTransactional);
void __RPC_STUB IMSMQQueueInfo_get_IsTransactional_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo_get_PrivLevel_Proxy(IMSMQQueueInfo *This,
                                                  __LONG32 *plPrivLevel);
void __RPC_STUB IMSMQQueueInfo_get_PrivLevel_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo_put_PrivLevel_Proxy(IMSMQQueueInfo *This,
                                                  __LONG32 lPrivLevel);
void __RPC_STUB IMSMQQueueInfo_put_PrivLevel_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo_get_Journal_Proxy(IMSMQQueueInfo *This,
                                                __LONG32 *plJournal);
void __RPC_STUB IMSMQQueueInfo_get_Journal_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo_put_Journal_Proxy(IMSMQQueueInfo *This,
                                                __LONG32 lJournal);
void __RPC_STUB IMSMQQueueInfo_put_Journal_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo_get_Quota_Proxy(IMSMQQueueInfo *This,
                                              __LONG32 *plQuota);
void __RPC_STUB IMSMQQueueInfo_get_Quota_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo_put_Quota_Proxy(IMSMQQueueInfo *This,
                                              __LONG32 lQuota);
void __RPC_STUB IMSMQQueueInfo_put_Quota_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo_get_BasePriority_Proxy(IMSMQQueueInfo *This,
                                                     __LONG32 *plBasePriority);
void __RPC_STUB IMSMQQueueInfo_get_BasePriority_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo_put_BasePriority_Proxy(IMSMQQueueInfo *This,
                                                     __LONG32 lBasePriority);
void __RPC_STUB IMSMQQueueInfo_put_BasePriority_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo_get_CreateTime_Proxy(IMSMQQueueInfo *This,
                                                   VARIANT *pvarCreateTime);
void __RPC_STUB IMSMQQueueInfo_get_CreateTime_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo_get_ModifyTime_Proxy(IMSMQQueueInfo *This,
                                                   VARIANT *pvarModifyTime);
void __RPC_STUB IMSMQQueueInfo_get_ModifyTime_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo_get_Authenticate_Proxy(IMSMQQueueInfo *This,
                                                     __LONG32 *plAuthenticate);
void __RPC_STUB IMSMQQueueInfo_get_Authenticate_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo_put_Authenticate_Proxy(IMSMQQueueInfo *This,
                                                     __LONG32 lAuthenticate);
void __RPC_STUB IMSMQQueueInfo_put_Authenticate_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo_get_JournalQuota_Proxy(IMSMQQueueInfo *This,
                                                     __LONG32 *plJournalQuota);
void __RPC_STUB IMSMQQueueInfo_get_JournalQuota_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo_put_JournalQuota_Proxy(IMSMQQueueInfo *This,
                                                     __LONG32 lJournalQuota);
void __RPC_STUB IMSMQQueueInfo_put_JournalQuota_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo_get_IsWorldReadable_Proxy(
    IMSMQQueueInfo *This, Boolean *pisWorldReadable);
void __RPC_STUB IMSMQQueueInfo_get_IsWorldReadable_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo_Create_Proxy(IMSMQQueueInfo *This,
...
void __RPC_STUB IMSMQQueueInfo_Delete_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo_Open_Proxy(IMSMQQueueInfo *This, __LONG32 Access,
                                         __LONG32 ShareMode, IMSMQQueue **ppq);
void __RPC_STUB IMSMQQueueInfo_Open_Stub(IRpcStubBuffer *This,
...
typedef struct IMSMQQueueInfo2Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMSMQQueueInfo2 *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IMSMQQueueInfo2 *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IMSMQQueueInfo2 *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IMSMQQueueInfo2 *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *get_QueueGuid)(IMSMQQueueInfo2 *This, BSTR *pbstrGuidQueue);
  HRESULT(WINAPI *get_ServiceTypeGuid)(IMSMQQueueInfo2 *This,
                                       BSTR *pbstrGuidServiceType);
  HRESULT(WINAPI *put_ServiceTypeGuid)(IMSMQQueueInfo2 *This,
                                       BSTR bstrGuidServiceType);
  ...
  HRESULT(WINAPI *get_IsTransactional)(IMSMQQueueInfo2 *This,
                                       Boolean *pisTransactional);
  ...
  HRESULT(WINAPI *get_BasePriority)(IMSMQQueueInfo2 *This,
                                    __LONG32 *plBasePriority);
  HRESULT(WINAPI *put_BasePriority)(IMSMQQueueInfo2 *This,
                                    __LONG32 lBasePriority);
  HRESULT(WINAPI *get_CreateTime)(IMSMQQueueInfo2 *This,
                                  VARIANT *pvarCreateTime);
  HRESULT(WINAPI *get_ModifyTime)(IMSMQQueueInfo2 *This,
                                  VARIANT *pvarModifyTime);
  HRESULT(WINAPI *get_Authenticate)(IMSMQQueueInfo2 *This,
                                    __LONG32 *plAuthenticate);
  HRESULT(WINAPI *put_Authenticate)(IMSMQQueueInfo2 *This,
                                    __LONG32 lAuthenticate);
  HRESULT(WINAPI *get_JournalQuota)(IMSMQQueueInfo2 *This,
                                    __LONG32 *plJournalQuota);
  HRESULT(WINAPI *put_JournalQuota)(IMSMQQueueInfo2 *This,
                                    __LONG32 lJournalQuota);
  HRESULT(WINAPI *get_IsWorldReadable)(IMSMQQueueInfo2 *This,
                                       Boolean *pisWorldReadable);
  HRESULT(WINAPI *Create)(IMSMQQueueInfo2 *This, VARIANT *IsTransactional,
                          VARIANT *IsWorldReadable);
  HRESULT(WINAPI *Delete)(IMSMQQueueInfo2 *This);
  HRESULT(WINAPI *Open)(IMSMQQueueInfo2 *This, __LONG32 Access,
                        __LONG32 ShareMode, IMSMQQueue2 **ppq);
  HRESULT(WINAPI *Refresh)(IMSMQQueueInfo2 *This);
  HRESULT(WINAPI *Update)(IMSMQQueueInfo2 *This);
  HRESULT(WINAPI *get_PathNameDNS)(IMSMQQueueInfo2 *This,
                                   BSTR *pbstrPathNameDNS);
  HRESULT(WINAPI *get_Properties)(IMSMQQueueInfo2 *This,
...
#define IMSMQQueueInfo2_GetTypeInfo(This, iTInfo, lcid, ppTInfo)               \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IMSMQQueueInfo2_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,     \
                                      rgDispId)                                \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IMSMQQueueInfo2_Invoke(This, dispIdMember, riid, lcid, wFlags,         \
                               pDispParams, pVarResult, pExcepInfo, puArgErr)  \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI IMSMQQueueInfo2_get_QueueGuid_Proxy(IMSMQQueueInfo2 *This,
                                                   BSTR *pbstrGuidQueue);
void __RPC_STUB IMSMQQueueInfo2_get_QueueGuid_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo2_get_ServiceTypeGuid_Proxy(
    IMSMQQueueInfo2 *This, BSTR *pbstrGuidServiceType);
void __RPC_STUB IMSMQQueueInfo2_get_ServiceTypeGuid_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo2_put_ServiceTypeGuid_Proxy(
    IMSMQQueueInfo2 *This, BSTR bstrGuidServiceType);
void __RPC_STUB IMSMQQueueInfo2_put_ServiceTypeGuid_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo2_get_Label_Proxy(IMSMQQueueInfo2 *This,
                                               BSTR *pbstrLabel);
void __RPC_STUB IMSMQQueueInfo2_get_Label_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo2_put_Label_Proxy(IMSMQQueueInfo2 *This,
                                               BSTR bstrLabel);
void __RPC_STUB IMSMQQueueInfo2_put_Label_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo2_get_PathName_Proxy(IMSMQQueueInfo2 *This,
                                                  BSTR *pbstrPathName);
void __RPC_STUB IMSMQQueueInfo2_get_PathName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo2_put_PathName_Proxy(IMSMQQueueInfo2 *This,
                                                  BSTR bstrPathName);
void __RPC_STUB IMSMQQueueInfo2_put_PathName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo2_get_FormatName_Proxy(IMSMQQueueInfo2 *This,
                                                    BSTR *pbstrFormatName);
void __RPC_STUB IMSMQQueueInfo2_get_FormatName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo2_put_FormatName_Proxy(IMSMQQueueInfo2 *This,
                                                    BSTR bstrFormatName);
void __RPC_STUB IMSMQQueueInfo2_put_FormatName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo2_get_IsTransactional_Proxy(
    IMSMQQueueInfo2 *This, Boolean *pisTransactional);
void __RPC_STUB IMSMQQueueInfo2_get_IsTransactional_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo2_get_PrivLevel_Proxy(IMSMQQueueInfo2 *This,
                                                   __LONG32 *plPrivLevel);
void __RPC_STUB IMSMQQueueInfo2_get_PrivLevel_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo2_put_PrivLevel_Proxy(IMSMQQueueInfo2 *This,
                                                   __LONG32 lPrivLevel);
void __RPC_STUB IMSMQQueueInfo2_put_PrivLevel_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo2_get_Journal_Proxy(IMSMQQueueInfo2 *This,
                                                 __LONG32 *plJournal);
void __RPC_STUB IMSMQQueueInfo2_get_Journal_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo2_put_Journal_Proxy(IMSMQQueueInfo2 *This,
                                                 __LONG32 lJournal);
void __RPC_STUB IMSMQQueueInfo2_put_Journal_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo2_get_Quota_Proxy(IMSMQQueueInfo2 *This,
                                               __LONG32 *plQuota);
void __RPC_STUB IMSMQQueueInfo2_get_Quota_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo2_put_Quota_Proxy(IMSMQQueueInfo2 *This,
                                               __LONG32 lQuota);
void __RPC_STUB IMSMQQueueInfo2_put_Quota_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo2_get_BasePriority_Proxy(IMSMQQueueInfo2 *This,
                                                      __LONG32 *plBasePriority);
void __RPC_STUB IMSMQQueueInfo2_get_BasePriority_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo2_put_BasePriority_Proxy(IMSMQQueueInfo2 *This,
                                                      __LONG32 lBasePriority);
void __RPC_STUB IMSMQQueueInfo2_put_BasePriority_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo2_get_CreateTime_Proxy(IMSMQQueueInfo2 *This,
                                                    VARIANT *pvarCreateTime);
void __RPC_STUB IMSMQQueueInfo2_get_CreateTime_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo2_get_ModifyTime_Proxy(IMSMQQueueInfo2 *This,
                                                    VARIANT *pvarModifyTime);
void __RPC_STUB IMSMQQueueInfo2_get_ModifyTime_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo2_get_Authenticate_Proxy(IMSMQQueueInfo2 *This,
                                                      __LONG32 *plAuthenticate);
void __RPC_STUB IMSMQQueueInfo2_get_Authenticate_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo2_put_Authenticate_Proxy(IMSMQQueueInfo2 *This,
                                                      __LONG32 lAuthenticate);
void __RPC_STUB IMSMQQueueInfo2_put_Authenticate_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo2_get_JournalQuota_Proxy(IMSMQQueueInfo2 *This,
                                                      __LONG32 *plJournalQuota);
void __RPC_STUB IMSMQQueueInfo2_get_JournalQuota_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo2_put_JournalQuota_Proxy(IMSMQQueueInfo2 *This,
                                                      __LONG32 lJournalQuota);
void __RPC_STUB IMSMQQueueInfo2_put_JournalQuota_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo2_get_IsWorldReadable_Proxy(
    IMSMQQueueInfo2 *This, Boolean *pisWorldReadable);
void __RPC_STUB IMSMQQueueInfo2_get_IsWorldReadable_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo2_Create_Proxy(IMSMQQueueInfo2 *This,
                                            VARIANT *IsTransactional,
                                            VARIANT *IsWorldReadable);
...
void __RPC_STUB IMSMQQueueInfo2_Delete_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo2_Open_Proxy(IMSMQQueueInfo2 *This,
                                          __LONG32 Access, __LONG32 ShareMode,
                                          IMSMQQueue2 **ppq);
void __RPC_STUB IMSMQQueueInfo2_Open_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
...
void __RPC_STUB IMSMQQueueInfo2_Update_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo2_get_PathNameDNS_Proxy(IMSMQQueueInfo2 *This,
                                                     BSTR *pbstrPathNameDNS);
void __RPC_STUB IMSMQQueueInfo2_get_PathNameDNS_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo2_get_Properties_Proxy(
    IMSMQQueueInfo2 *This, IDispatch **ppcolProperties);
void __RPC_STUB IMSMQQueueInfo2_get_Properties_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo2_get_Security_Proxy(IMSMQQueueInfo2 *This,
                                                  VARIANT *pvarSecurity);
void __RPC_STUB IMSMQQueueInfo2_get_Security_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo2_put_Security_Proxy(IMSMQQueueInfo2 *This,
                                                  VARIANT varSecurity);
...
public:
  ...
  get_IsTransactional2(VARIANT_BOOL *pisTransactional) = 0;
  virtual HRESULT WINAPI
  get_IsWorldReadable2(VARIANT_BOOL *pisWorldReadable) = 0;
...
typedef struct IMSMQQueueInfo3Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMSMQQueueInfo3 *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IMSMQQueueInfo3 *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IMSMQQueueInfo3 *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IMSMQQueueInfo3 *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *get_QueueGuid)(IMSMQQueueInfo3 *This, BSTR *pbstrGuidQueue);
  HRESULT(WINAPI *get_ServiceTypeGuid)(IMSMQQueueInfo3 *This,
                                       BSTR *pbstrGuidServiceType);
  HRESULT(WINAPI *put_ServiceTypeGuid)(IMSMQQueueInfo3 *This,
                                       BSTR bstrGuidServiceType);
  ...
  HRESULT(WINAPI *get_IsTransactional)(IMSMQQueueInfo3 *This,
                                       Boolean *pisTransactional);
  ...
  HRESULT(WINAPI *get_BasePriority)(IMSMQQueueInfo3 *This,
                                    __LONG32 *plBasePriority);
  HRESULT(WINAPI *put_BasePriority)(IMSMQQueueInfo3 *This,
                                    __LONG32 lBasePriority);
  HRESULT(WINAPI *get_CreateTime)(IMSMQQueueInfo3 *This,
                                  VARIANT *pvarCreateTime);
  HRESULT(WINAPI *get_ModifyTime)(IMSMQQueueInfo3 *This,
                                  VARIANT *pvarModifyTime);
  HRESULT(WINAPI *get_Authenticate)(IMSMQQueueInfo3 *This,
                                    __LONG32 *plAuthenticate);
  HRESULT(WINAPI *put_Authenticate)(IMSMQQueueInfo3 *This,
                                    __LONG32 lAuthenticate);
  HRESULT(WINAPI *get_JournalQuota)(IMSMQQueueInfo3 *This,
                                    __LONG32 *plJournalQuota);
  HRESULT(WINAPI *put_JournalQuota)(IMSMQQueueInfo3 *This,
                                    __LONG32 lJournalQuota);
  HRESULT(WINAPI *get_IsWorldReadable)(IMSMQQueueInfo3 *This,
                                       Boolean *pisWorldReadable);
  HRESULT(WINAPI *Create)(IMSMQQueueInfo3 *This, VARIANT *IsTransactional,
                          VARIANT *IsWorldReadable);
  HRESULT(WINAPI *Delete)(IMSMQQueueInfo3 *This);
  HRESULT(WINAPI *Open)(IMSMQQueueInfo3 *This, __LONG32 Access,
                        __LONG32 ShareMode, IMSMQQueue3 **ppq);
  HRESULT(WINAPI *Refresh)(IMSMQQueueInfo3 *This);
  HRESULT(WINAPI *Update)(IMSMQQueueInfo3 *This);
  HRESULT(WINAPI *get_PathNameDNS)(IMSMQQueueInfo3 *This,
                                   BSTR *pbstrPathNameDNS);
  HRESULT(WINAPI *get_Properties)(IMSMQQueueInfo3 *This,
                                  IDispatch **ppcolProperties);
  ...
  HRESULT(WINAPI *get_IsTransactional2)(IMSMQQueueInfo3 *This,
                                        VARIANT_BOOL *pisTransactional);
  HRESULT(WINAPI *get_IsWorldReadable2)(IMSMQQueueInfo3 *This,
                                        VARIANT_BOOL *pisWorldReadable);
  HRESULT(WINAPI *get_MulticastAddress)(IMSMQQueueInfo3 *This,
                                        BSTR *pbstrMulticastAddress);
  HRESULT(WINAPI *put_MulticastAddress)(IMSMQQueueInfo3 *This,
                                        BSTR bstrMulticastAddress);
...
#define IMSMQQueueInfo3_GetTypeInfo(This, iTInfo, lcid, ppTInfo)               \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IMSMQQueueInfo3_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,     \
                                      rgDispId)                                \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IMSMQQueueInfo3_Invoke(This, dispIdMember, riid, lcid, wFlags,         \
                               pDispParams, pVarResult, pExcepInfo, puArgErr)  \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI IMSMQQueueInfo3_get_QueueGuid_Proxy(IMSMQQueueInfo3 *This,
                                                   BSTR *pbstrGuidQueue);
void __RPC_STUB IMSMQQueueInfo3_get_QueueGuid_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo3_get_ServiceTypeGuid_Proxy(
    IMSMQQueueInfo3 *This, BSTR *pbstrGuidServiceType);
void __RPC_STUB IMSMQQueueInfo3_get_ServiceTypeGuid_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo3_put_ServiceTypeGuid_Proxy(
    IMSMQQueueInfo3 *This, BSTR bstrGuidServiceType);
void __RPC_STUB IMSMQQueueInfo3_put_ServiceTypeGuid_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo3_get_Label_Proxy(IMSMQQueueInfo3 *This,
                                               BSTR *pbstrLabel);
void __RPC_STUB IMSMQQueueInfo3_get_Label_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo3_put_Label_Proxy(IMSMQQueueInfo3 *This,
                                               BSTR bstrLabel);
void __RPC_STUB IMSMQQueueInfo3_put_Label_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo3_get_PathName_Proxy(IMSMQQueueInfo3 *This,
                                                  BSTR *pbstrPathName);
void __RPC_STUB IMSMQQueueInfo3_get_PathName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo3_put_PathName_Proxy(IMSMQQueueInfo3 *This,
                                                  BSTR bstrPathName);
void __RPC_STUB IMSMQQueueInfo3_put_PathName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo3_get_FormatName_Proxy(IMSMQQueueInfo3 *This,
                                                    BSTR *pbstrFormatName);
void __RPC_STUB IMSMQQueueInfo3_get_FormatName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo3_put_FormatName_Proxy(IMSMQQueueInfo3 *This,
                                                    BSTR bstrFormatName);
void __RPC_STUB IMSMQQueueInfo3_put_FormatName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo3_get_IsTransactional_Proxy(
    IMSMQQueueInfo3 *This, Boolean *pisTransactional);
void __RPC_STUB IMSMQQueueInfo3_get_IsTransactional_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo3_get_PrivLevel_Proxy(IMSMQQueueInfo3 *This,
                                                   __LONG32 *plPrivLevel);
void __RPC_STUB IMSMQQueueInfo3_get_PrivLevel_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo3_put_PrivLevel_Proxy(IMSMQQueueInfo3 *This,
                                                   __LONG32 lPrivLevel);
void __RPC_STUB IMSMQQueueInfo3_put_PrivLevel_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo3_get_Journal_Proxy(IMSMQQueueInfo3 *This,
                                                 __LONG32 *plJournal);
void __RPC_STUB IMSMQQueueInfo3_get_Journal_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo3_put_Journal_Proxy(IMSMQQueueInfo3 *This,
                                                 __LONG32 lJournal);
void __RPC_STUB IMSMQQueueInfo3_put_Journal_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo3_get_Quota_Proxy(IMSMQQueueInfo3 *This,
                                               __LONG32 *plQuota);
void __RPC_STUB IMSMQQueueInfo3_get_Quota_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo3_put_Quota_Proxy(IMSMQQueueInfo3 *This,
                                               __LONG32 lQuota);
void __RPC_STUB IMSMQQueueInfo3_put_Quota_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo3_get_BasePriority_Proxy(IMSMQQueueInfo3 *This,
                                                      __LONG32 *plBasePriority);
void __RPC_STUB IMSMQQueueInfo3_get_BasePriority_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo3_put_BasePriority_Proxy(IMSMQQueueInfo3 *This,
                                                      __LONG32 lBasePriority);
void __RPC_STUB IMSMQQueueInfo3_put_BasePriority_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo3_get_CreateTime_Proxy(IMSMQQueueInfo3 *This,
                                                    VARIANT *pvarCreateTime);
void __RPC_STUB IMSMQQueueInfo3_get_CreateTime_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo3_get_ModifyTime_Proxy(IMSMQQueueInfo3 *This,
                                                    VARIANT *pvarModifyTime);
void __RPC_STUB IMSMQQueueInfo3_get_ModifyTime_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo3_get_Authenticate_Proxy(IMSMQQueueInfo3 *This,
                                                      __LONG32 *plAuthenticate);
void __RPC_STUB IMSMQQueueInfo3_get_Authenticate_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo3_put_Authenticate_Proxy(IMSMQQueueInfo3 *This,
                                                      __LONG32 lAuthenticate);
void __RPC_STUB IMSMQQueueInfo3_put_Authenticate_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo3_get_JournalQuota_Proxy(IMSMQQueueInfo3 *This,
                                                      __LONG32 *plJournalQuota);
void __RPC_STUB IMSMQQueueInfo3_get_JournalQuota_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo3_put_JournalQuota_Proxy(IMSMQQueueInfo3 *This,
                                                      __LONG32 lJournalQuota);
void __RPC_STUB IMSMQQueueInfo3_put_JournalQuota_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo3_get_IsWorldReadable_Proxy(
    IMSMQQueueInfo3 *This, Boolean *pisWorldReadable);
void __RPC_STUB IMSMQQueueInfo3_get_IsWorldReadable_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo3_Create_Proxy(IMSMQQueueInfo3 *This,
                                            VARIANT *IsTransactional,
                                            VARIANT *IsWorldReadable);
...
void __RPC_STUB IMSMQQueueInfo3_Delete_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo3_Open_Proxy(IMSMQQueueInfo3 *This,
                                          __LONG32 Access, __LONG32 ShareMode,
                                          IMSMQQueue3 **ppq);
void __RPC_STUB IMSMQQueueInfo3_Open_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
...
void __RPC_STUB IMSMQQueueInfo3_Update_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo3_get_PathNameDNS_Proxy(IMSMQQueueInfo3 *This,
                                                     BSTR *pbstrPathNameDNS);
void __RPC_STUB IMSMQQueueInfo3_get_PathNameDNS_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo3_get_Properties_Proxy(
    IMSMQQueueInfo3 *This, IDispatch **ppcolProperties);
void __RPC_STUB IMSMQQueueInfo3_get_Properties_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo3_get_Security_Proxy(IMSMQQueueInfo3 *This,
                                                  VARIANT *pvarSecurity);
void __RPC_STUB IMSMQQueueInfo3_get_Security_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo3_put_Security_Proxy(IMSMQQueueInfo3 *This,
                                                  VARIANT varSecurity);
void __RPC_STUB IMSMQQueueInfo3_put_Security_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo3_get_IsTransactional2_Proxy(
    IMSMQQueueInfo3 *This, VARIANT_BOOL *pisTransactional);
void __RPC_STUB IMSMQQueueInfo3_get_IsTransactional2_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo3_get_IsWorldReadable2_Proxy(
    IMSMQQueueInfo3 *This, VARIANT_BOOL *pisWorldReadable);
void __RPC_STUB IMSMQQueueInfo3_get_IsWorldReadable2_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo3_get_MulticastAddress_Proxy(
    IMSMQQueueInfo3 *This, BSTR *pbstrMulticastAddress);
void __RPC_STUB IMSMQQueueInfo3_get_MulticastAddress_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo3_put_MulticastAddress_Proxy(
    IMSMQQueueInfo3 *This, BSTR bstrMulticastAddress);
void __RPC_STUB IMSMQQueueInfo3_put_MulticastAddress_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfo3_get_ADsPath_Proxy(IMSMQQueueInfo3 *This,
                                                 BSTR *pbstrADsPath);
...
public:
  ...
  virtual HRESULT WINAPI Receive(VARIANT *Transaction,
                                 VARIANT *WantDestinationQueue,
                                 VARIANT *WantBody, VARIANT *ReceiveTimeout,
                                 IMSMQMessage **ppmsg) = 0;
  virtual HRESULT WINAPI Peek(VARIANT *WantDestinationQueue, VARIANT *WantBody,
                              VARIANT *ReceiveTimeout,
                              IMSMQMessage **ppmsg) = 0;
  virtual HRESULT WINAPI EnableNotification(IMSMQEvent *Event, VARIANT *Cursor,
                                            VARIANT *ReceiveTimeout) = 0;
  virtual HRESULT WINAPI Reset(void) = 0;
  virtual HRESULT WINAPI ReceiveCurrent(VARIANT *Transaction,
                                        VARIANT *WantDestinationQueue,
                                        VARIANT *WantBody,
                                        VARIANT *ReceiveTimeout,
                                        IMSMQMessage **ppmsg) = 0;
  virtual HRESULT WINAPI PeekNext(VARIANT *WantDestinationQueue,
                                  VARIANT *WantBody, VARIANT *ReceiveTimeout,
                                  IMSMQMessage **ppmsg) = 0;
  virtual HRESULT WINAPI PeekCurrent(VARIANT *WantDestinationQueue,
                                     VARIANT *WantBody, VARIANT *ReceiveTimeout,
                                     IMSMQMessage **ppmsg) = 0;
};
#else
typedef struct IMSMQQueueVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMSMQQueue *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IMSMQQueue *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IMSMQQueue *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IMSMQQueue *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  ...
  HRESULT(WINAPI *Receive)(IMSMQQueue *This, VARIANT *Transaction,
                           VARIANT *WantDestinationQueue, VARIANT *WantBody,
                           VARIANT *ReceiveTimeout, IMSMQMessage **ppmsg);
  HRESULT(WINAPI *Peek)(IMSMQQueue *This, VARIANT *WantDestinationQueue,
                        VARIANT *WantBody, VARIANT *ReceiveTimeout,
                        IMSMQMessage **ppmsg);
  HRESULT(WINAPI *EnableNotification)(IMSMQQueue *This, IMSMQEvent *Event,
                                      VARIANT *Cursor, VARIANT *ReceiveTimeout);
  HRESULT(WINAPI *Reset)(IMSMQQueue *This);
  HRESULT(WINAPI *ReceiveCurrent)(IMSMQQueue *This, VARIANT *Transaction,
                                  VARIANT *WantDestinationQueue,
                                  VARIANT *WantBody, VARIANT *ReceiveTimeout,
                                  IMSMQMessage **ppmsg);
  HRESULT(WINAPI *PeekNext)(IMSMQQueue *This, VARIANT *WantDestinationQueue,
                            VARIANT *WantBody, VARIANT *ReceiveTimeout,
                            IMSMQMessage **ppmsg);
  HRESULT(WINAPI *PeekCurrent)(IMSMQQueue *This, VARIANT *WantDestinationQueue,
                               VARIANT *WantBody, VARIANT *ReceiveTimeout,
                               IMSMQMessage **ppmsg);
  END_INTERFACE
} IMSMQQueueVtbl;
...
#define IMSMQQueue_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                    \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IMSMQQueue_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,          \
                                 rgDispId)                                     \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
...
#define IMSMQQueue_Receive(This, Transaction, WantDestinationQueue, WantBody,  \
                           ReceiveTimeout, ppmsg)                              \
  (This)->lpVtbl->Receive(This, Transaction, WantDestinationQueue, WantBody,   \
                          ReceiveTimeout, ppmsg)
#define IMSMQQueue_Peek(This, WantDestinationQueue, WantBody, ReceiveTimeout,  \
                        ppmsg)                                                 \
  (This)->lpVtbl->Peek(This, WantDestinationQueue, WantBody, ReceiveTimeout,   \
                       ppmsg)
...
#define IMSMQQueue_ReceiveCurrent(This, Transaction, WantDestinationQueue,     \
                                  WantBody, ReceiveTimeout, ppmsg)             \
  (This)->lpVtbl->ReceiveCurrent(This, Transaction, WantDestinationQueue,      \
                                 WantBody, ReceiveTimeout, ppmsg)
#define IMSMQQueue_PeekNext(This, WantDestinationQueue, WantBody,              \
                            ReceiveTimeout, ppmsg)                             \
  (This)->lpVtbl->PeekNext(This, WantDestinationQueue, WantBody,               \
                           ReceiveTimeout, ppmsg)
#define IMSMQQueue_PeekCurrent(This, WantDestinationQueue, WantBody,           \
                               ReceiveTimeout, ppmsg)                          \
  (This)->lpVtbl->PeekCurrent(This, WantDestinationQueue, WantBody,            \
                              ReceiveTimeout, ppmsg)
#endif
#endif
HRESULT WINAPI IMSMQQueue_get_Access_Proxy(IMSMQQueue *This,
                                           __LONG32 *plAccess);
void __RPC_STUB IMSMQQueue_get_Access_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue_get_ShareMode_Proxy(IMSMQQueue *This,
                                              __LONG32 *plShareMode);
void __RPC_STUB IMSMQQueue_get_ShareMode_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue_get_QueueInfo_Proxy(IMSMQQueue *This,
                                              IMSMQQueueInfo **ppqinfo);
void __RPC_STUB IMSMQQueue_get_QueueInfo_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue_get_Handle_Proxy(IMSMQQueue *This,
                                           __LONG32 *plHandle);
...
void __RPC_STUB IMSMQQueue_Close_Stub(IRpcStubBuffer *This,
                                      IRpcChannelBuffer *_pRpcChannelBuffer,
                                      PRPC_MESSAGE _pRpcMessage,
                                      DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue_Receive_Proxy(IMSMQQueue *This, VARIANT *Transaction,
                                        VARIANT *WantDestinationQueue,
                                        VARIANT *WantBody,
                                        VARIANT *ReceiveTimeout,
                                        IMSMQMessage **ppmsg);
void __RPC_STUB IMSMQQueue_Receive_Stub(IRpcStubBuffer *This,
                                        IRpcChannelBuffer *_pRpcChannelBuffer,
                                        PRPC_MESSAGE _pRpcMessage,
                                        DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue_Peek_Proxy(IMSMQQueue *This,
                                     VARIANT *WantDestinationQueue,
                                     VARIANT *WantBody, VARIANT *ReceiveTimeout,
                                     IMSMQMessage **ppmsg);
void __RPC_STUB IMSMQQueue_Peek_Stub(IRpcStubBuffer *This,
                                     IRpcChannelBuffer *_pRpcChannelBuffer,
                                     PRPC_MESSAGE _pRpcMessage,
                                     DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue_EnableNotification_Proxy(IMSMQQueue *This,
                                                   IMSMQEvent *Event,
                                                   VARIANT *Cursor,
                                                   VARIANT *ReceiveTimeout);
...
void __RPC_STUB IMSMQQueue_Reset_Stub(IRpcStubBuffer *This,
                                      IRpcChannelBuffer *_pRpcChannelBuffer,
                                      PRPC_MESSAGE _pRpcMessage,
                                      DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue_ReceiveCurrent_Proxy(
    IMSMQQueue *This, VARIANT *Transaction, VARIANT *WantDestinationQueue,
    VARIANT *WantBody, VARIANT *ReceiveTimeout, IMSMQMessage **ppmsg);
void __RPC_STUB IMSMQQueue_ReceiveCurrent_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue_PeekNext_Proxy(IMSMQQueue *This,
                                         VARIANT *WantDestinationQueue,
                                         VARIANT *WantBody,
                                         VARIANT *ReceiveTimeout,
                                         IMSMQMessage **ppmsg);
void __RPC_STUB IMSMQQueue_PeekNext_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue_PeekCurrent_Proxy(IMSMQQueue *This,
                                            VARIANT *WantDestinationQueue,
                                            VARIANT *WantBody,
                                            VARIANT *ReceiveTimeout,
                                            IMSMQMessage **ppmsg);
...
public:
  ...
  virtual HRESULT WINAPI get_IsOpen(Boolean *pisOpen) = 0;
  virtual HRESULT WINAPI Close(void) = 0;
  virtual HRESULT WINAPI Receive_v1(VARIANT *Transaction,
                                    VARIANT *WantDestinationQueue,
                                    VARIANT *WantBody, VARIANT *ReceiveTimeout,
                                    IMSMQMessage **ppmsg) = 0;
  virtual HRESULT WINAPI Peek_v1(VARIANT *WantDestinationQueue,
                                 VARIANT *WantBody, VARIANT *ReceiveTimeout,
                                 IMSMQMessage **ppmsg) = 0;
  virtual HRESULT WINAPI EnableNotification(IMSMQEvent2 *Event, VARIANT *Cursor,
                                            VARIANT *ReceiveTimeout) = 0;
  virtual HRESULT WINAPI Reset(void) = 0;
  virtual HRESULT WINAPI ReceiveCurrent_v1(VARIANT *Transaction,
                                           VARIANT *WantDestinationQueue,
                                           VARIANT *WantBody,
                                           VARIANT *ReceiveTimeout,
                                           IMSMQMessage **ppmsg) = 0;
  virtual HRESULT WINAPI PeekNext_v1(VARIANT *WantDestinationQueue,
                                     VARIANT *WantBody, VARIANT *ReceiveTimeout,
                                     IMSMQMessage **ppmsg) = 0;
  virtual HRESULT WINAPI PeekCurrent_v1(VARIANT *WantDestinationQueue,
                                        VARIANT *WantBody,
                                        VARIANT *ReceiveTimeout,
                                        IMSMQMessage **ppmsg) = 0;
  virtual HRESULT WINAPI Receive(VARIANT *Transaction,
...
typedef struct IMSMQQueue2Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMSMQQueue2 *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IMSMQQueue2 *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IMSMQQueue2 *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IMSMQQueue2 *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  ...
  HRESULT(WINAPI *Receive_v1)(IMSMQQueue2 *This, VARIANT *Transaction,
                              VARIANT *WantDestinationQueue, VARIANT *WantBody,
                              VARIANT *ReceiveTimeout, IMSMQMessage **ppmsg);
  HRESULT(WINAPI *Peek_v1)(IMSMQQueue2 *This, VARIANT *WantDestinationQueue,
                           VARIANT *WantBody, VARIANT *ReceiveTimeout,
                           IMSMQMessage **ppmsg);
  HRESULT(WINAPI *EnableNotification)(IMSMQQueue2 *This, IMSMQEvent2 *Event,
                                      VARIANT *Cursor, VARIANT *ReceiveTimeout);
  HRESULT(WINAPI *Reset)(IMSMQQueue2 *This);
  HRESULT(WINAPI *ReceiveCurrent_v1)(IMSMQQueue2 *This, VARIANT *Transaction,
                                     VARIANT *WantDestinationQueue,
                                     VARIANT *WantBody, VARIANT *ReceiveTimeout,
                                     IMSMQMessage **ppmsg);
  HRESULT(WINAPI *PeekNext_v1)(IMSMQQueue2 *This, VARIANT *WantDestinationQueue,
                               VARIANT *WantBody, VARIANT *ReceiveTimeout,
                               IMSMQMessage **ppmsg);
  HRESULT(WINAPI *PeekCurrent_v1)(IMSMQQueue2 *This,
                                  VARIANT *WantDestinationQueue,
                                  VARIANT *WantBody, VARIANT *ReceiveTimeout,
                                  IMSMQMessage **ppmsg);
  HRESULT(WINAPI *Receive)(IMSMQQueue2 *This, VARIANT *Transaction,
                           VARIANT *WantDestinationQueue, VARIANT *WantBody,
                           VARIANT *ReceiveTimeout, VARIANT *WantConnectorType,
                           IMSMQMessage2 **ppmsg);
  HRESULT(WINAPI *Peek)(IMSMQQueue2 *This, VARIANT *WantDestinationQueue,
                        VARIANT *WantBody, VARIANT *ReceiveTimeout,
                        VARIANT *WantConnectorType, IMSMQMessage2 **ppmsg);
  HRESULT(WINAPI *ReceiveCurrent)(IMSMQQueue2 *This, VARIANT *Transaction,
                                  VARIANT *WantDestinationQueue,
                                  VARIANT *WantBody, VARIANT *ReceiveTimeout,
                                  VARIANT *WantConnectorType,
                                  IMSMQMessage2 **ppmsg);
  HRESULT(WINAPI *PeekNext)(IMSMQQueue2 *This, VARIANT *WantDestinationQueue,
                            VARIANT *WantBody, VARIANT *ReceiveTimeout,
                            VARIANT *WantConnectorType, IMSMQMessage2 **ppmsg);
  HRESULT(WINAPI *PeekCurrent)(IMSMQQueue2 *This, VARIANT *WantDestinationQueue,
                               VARIANT *WantBody, VARIANT *ReceiveTimeout,
                               VARIANT *WantConnectorType,
                               IMSMQMessage2 **ppmsg);
  HRESULT(WINAPI *get_Properties)(IMSMQQueue2 *This,
                                  IDispatch **ppcolProperties);
  END_INTERFACE
} IMSMQQueue2Vtbl;
struct IMSMQQueue2 {
...
#define IMSMQQueue2_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                   \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IMSMQQueue2_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,         \
                                  rgDispId)                                    \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IMSMQQueue2_Invoke(This, dispIdMember, riid, lcid, wFlags,             \
                           pDispParams, pVarResult, pExcepInfo, puArgErr)      \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#define IMSMQQueue2_Receive_v1(This, Transaction, WantDestinationQueue,        \
                               WantBody, ReceiveTimeout, ppmsg)                \
  (This)->lpVtbl->Receive_v1(This, Transaction, WantDestinationQueue,          \
                             WantBody, ReceiveTimeout, ppmsg)
#define IMSMQQueue2_Peek_v1(This, WantDestinationQueue, WantBody,              \
                            ReceiveTimeout, ppmsg)                             \
  (This)->lpVtbl->Peek_v1(This, WantDestinationQueue, WantBody,                \
                          ReceiveTimeout, ppmsg)
...
#define IMSMQQueue2_ReceiveCurrent_v1(This, Transaction, WantDestinationQueue, \
                                      WantBody, ReceiveTimeout, ppmsg)         \
  (This)->lpVtbl->ReceiveCurrent_v1(This, Transaction, WantDestinationQueue,   \
                                    WantBody, ReceiveTimeout, ppmsg)
#define IMSMQQueue2_PeekNext_v1(This, WantDestinationQueue, WantBody,          \
                                ReceiveTimeout, ppmsg)                         \
  (This)->lpVtbl->PeekNext_v1(This, WantDestinationQueue, WantBody,            \
                              ReceiveTimeout, ppmsg)
#define IMSMQQueue2_PeekCurrent_v1(This, WantDestinationQueue, WantBody,       \
                                   ReceiveTimeout, ppmsg)                      \
  (This)->lpVtbl->PeekCurrent_v1(This, WantDestinationQueue, WantBody,         \
                                 ReceiveTimeout, ppmsg)
#define IMSMQQueue2_Receive(This, Transaction, WantDestinationQueue, WantBody, \
                            ReceiveTimeout, WantConnectorType, ppmsg)          \
  (This)->lpVtbl->Receive(This, Transaction, WantDestinationQueue, WantBody,   \
                          ReceiveTimeout, WantConnectorType, ppmsg)
#define IMSMQQueue2_Peek(This, WantDestinationQueue, WantBody, ReceiveTimeout, \
                         WantConnectorType, ppmsg)                             \
  (This)->lpVtbl->Peek(This, WantDestinationQueue, WantBody, ReceiveTimeout,   \
                       WantConnectorType, ppmsg)
#define IMSMQQueue2_ReceiveCurrent(This, Transaction, WantDestinationQueue,    \
                                   WantBody, ReceiveTimeout,                   \
                                   WantConnectorType, ppmsg)                   \
  (This)->lpVtbl->ReceiveCurrent(This, Transaction, WantDestinationQueue,      \
                                 WantBody, ReceiveTimeout, WantConnectorType,  \
                                 ppmsg)
#define IMSMQQueue2_PeekNext(This, WantDestinationQueue, WantBody,             \
                             ReceiveTimeout, WantConnectorType, ppmsg)         \
  (This)->lpVtbl->PeekNext(This, WantDestinationQueue, WantBody,               \
                           ReceiveTimeout, WantConnectorType, ppmsg)
#define IMSMQQueue2_PeekCurrent(This, WantDestinationQueue, WantBody,          \
                                ReceiveTimeout, WantConnectorType, ppmsg)      \
  (This)->lpVtbl->PeekCurrent(This, WantDestinationQueue, WantBody,            \
                              ReceiveTimeout, WantConnectorType, ppmsg)
...
#endif
#endif
HRESULT WINAPI IMSMQQueue2_get_Access_Proxy(IMSMQQueue2 *This,
                                            __LONG32 *plAccess);
void __RPC_STUB IMSMQQueue2_get_Access_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue2_get_ShareMode_Proxy(IMSMQQueue2 *This,
                                               __LONG32 *plShareMode);
void __RPC_STUB IMSMQQueue2_get_ShareMode_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue2_get_QueueInfo_Proxy(IMSMQQueue2 *This,
                                               IMSMQQueueInfo2 **ppqinfo);
void __RPC_STUB IMSMQQueue2_get_QueueInfo_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue2_get_Handle_Proxy(IMSMQQueue2 *This,
                                            __LONG32 *plHandle);
void __RPC_STUB IMSMQQueue2_get_Handle_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue2_get_IsOpen_Proxy(IMSMQQueue2 *This,
                                            Boolean *pisOpen);
void __RPC_STUB IMSMQQueue2_get_IsOpen_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue2_Close_Proxy(IMSMQQueue2 *This);
void __RPC_STUB IMSMQQueue2_Close_Stub(IRpcStubBuffer *This,
                                       IRpcChannelBuffer *_pRpcChannelBuffer,
                                       PRPC_MESSAGE _pRpcMessage,
                                       DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue2_Receive_v1_Proxy(
    IMSMQQueue2 *This, VARIANT *Transaction, VARIANT *WantDestinationQueue,
    VARIANT *WantBody, VARIANT *ReceiveTimeout, IMSMQMessage **ppmsg);
void __RPC_STUB IMSMQQueue2_Receive_v1_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue2_Peek_v1_Proxy(IMSMQQueue2 *This,
                                         VARIANT *WantDestinationQueue,
                                         VARIANT *WantBody,
                                         VARIANT *ReceiveTimeout,
                                         IMSMQMessage **ppmsg);
void __RPC_STUB IMSMQQueue2_Peek_v1_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue2_EnableNotification_Proxy(IMSMQQueue2 *This,
                                                    IMSMQEvent2 *Event,
                                                    VARIANT *Cursor,
                                                    VARIANT *ReceiveTimeout);
...
void __RPC_STUB IMSMQQueue2_Reset_Stub(IRpcStubBuffer *This,
                                       IRpcChannelBuffer *_pRpcChannelBuffer,
                                       PRPC_MESSAGE _pRpcMessage,
                                       DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue2_ReceiveCurrent_v1_Proxy(
    IMSMQQueue2 *This, VARIANT *Transaction, VARIANT *WantDestinationQueue,
    VARIANT *WantBody, VARIANT *ReceiveTimeout, IMSMQMessage **ppmsg);
void __RPC_STUB IMSMQQueue2_ReceiveCurrent_v1_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue2_PeekNext_v1_Proxy(IMSMQQueue2 *This,
                                             VARIANT *WantDestinationQueue,
                                             VARIANT *WantBody,
                                             VARIANT *ReceiveTimeout,
                                             IMSMQMessage **ppmsg);
void __RPC_STUB IMSMQQueue2_PeekNext_v1_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue2_PeekCurrent_v1_Proxy(IMSMQQueue2 *This,
                                                VARIANT *WantDestinationQueue,
                                                VARIANT *WantBody,
                                                VARIANT *ReceiveTimeout,
                                                IMSMQMessage **ppmsg);
void __RPC_STUB IMSMQQueue2_PeekCurrent_v1_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue2_Receive_Proxy(
    IMSMQQueue2 *This, VARIANT *Transaction, VARIANT *WantDestinationQueue,
    VARIANT *WantBody, VARIANT *ReceiveTimeout, VARIANT *WantConnectorType,
    IMSMQMessage2 **ppmsg);
void __RPC_STUB IMSMQQueue2_Receive_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue2_Peek_Proxy(
    IMSMQQueue2 *This, VARIANT *WantDestinationQueue, VARIANT *WantBody,
    VARIANT *ReceiveTimeout, VARIANT *WantConnectorType, IMSMQMessage2 **ppmsg);
void __RPC_STUB IMSMQQueue2_Peek_Stub(IRpcStubBuffer *This,
                                      IRpcChannelBuffer *_pRpcChannelBuffer,
                                      PRPC_MESSAGE _pRpcMessage,
                                      DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue2_ReceiveCurrent_Proxy(
    IMSMQQueue2 *This, VARIANT *Transaction, VARIANT *WantDestinationQueue,
    VARIANT *WantBody, VARIANT *ReceiveTimeout, VARIANT *WantConnectorType,
    IMSMQMessage2 **ppmsg);
void __RPC_STUB IMSMQQueue2_ReceiveCurrent_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue2_PeekNext_Proxy(
    IMSMQQueue2 *This, VARIANT *WantDestinationQueue, VARIANT *WantBody,
    VARIANT *ReceiveTimeout, VARIANT *WantConnectorType, IMSMQMessage2 **ppmsg);
void __RPC_STUB IMSMQQueue2_PeekNext_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue2_PeekCurrent_Proxy(
    IMSMQQueue2 *This, VARIANT *WantDestinationQueue, VARIANT *WantBody,
    VARIANT *ReceiveTimeout, VARIANT *WantConnectorType, IMSMQMessage2 **ppmsg);
void __RPC_STUB IMSMQQueue2_PeekCurrent_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue2_get_Properties_Proxy(IMSMQQueue2 *This,
                                                IDispatch **ppcolProperties);
...
public:
  ...
  virtual HRESULT WINAPI put_Journal(__LONG32 lJournal) = 0;
  virtual HRESULT WINAPI
  get_ResponseQueueInfo(IMSMQQueueInfo **ppqinfoResponse) = 0;
  virtual HRESULT WINAPI
  putref_ResponseQueueInfo(IMSMQQueueInfo *pqinfoResponse) = 0;
  ...
  virtual HRESULT WINAPI put_Label(BSTR bstrLabel) = 0;
  virtual HRESULT WINAPI
  get_MaxTimeToReachQueue(__LONG32 *plMaxTimeToReachQueue) = 0;
  virtual HRESULT WINAPI
  put_MaxTimeToReachQueue(__LONG32 lMaxTimeToReachQueue) = 0;
  ...
  virtual HRESULT WINAPI
  get_DestinationQueueInfo(IMSMQQueueInfo **ppqinfoDest) = 0;
  ...
  virtual HRESULT WINAPI Send(IMSMQQueue *DestinationQueue,
                              VARIANT *Transaction) = 0;
  virtual HRESULT WINAPI AttachCurrentSecurityContext(void) = 0;
};
#else
typedef struct IMSMQMessageVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMSMQMessage *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IMSMQMessage *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IMSMQMessage *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IMSMQMessage *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  ...
  HRESULT(WINAPI *get_IsAuthenticated)(IMSMQMessage *This,
  ...
  HRESULT(WINAPI *get_ResponseQueueInfo)(IMSMQMessage *This,
                                         IMSMQQueueInfo **ppqinfoResponse);
  HRESULT(WINAPI *putref_ResponseQueueInfo)(IMSMQMessage *This,
  ...
  HRESULT(WINAPI *get_SourceMachineGuid)(IMSMQMessage *This,
  ...
  HRESULT(WINAPI *get_AdminQueueInfo)(IMSMQMessage *This,
                                      IMSMQQueueInfo **ppqinfoAdmin);
  HRESULT(WINAPI *putref_AdminQueueInfo)(IMSMQMessage *This,
                                         IMSMQQueueInfo *pqinfoAdmin);
  ...
  HRESULT(WINAPI *get_MaxTimeToReachQueue)(IMSMQMessage *This,
                                           __LONG32 *plMaxTimeToReachQueue);
  HRESULT(WINAPI *put_MaxTimeToReachQueue)(IMSMQMessage *This,
                                           __LONG32 lMaxTimeToReachQueue);
  HRESULT(WINAPI *get_MaxTimeToReceive)(IMSMQMessage *This,
                                        __LONG32 *plMaxTimeToReceive);
  HRESULT(WINAPI *put_MaxTimeToReceive)(IMSMQMessage *This,
                                        __LONG32 lMaxTimeToReceive);
  ...
  HRESULT(WINAPI *get_EncryptAlgorithm)(IMSMQMessage *This,
                                        __LONG32 *plEncryptAlg);
  HRESULT(WINAPI *put_EncryptAlgorithm)(IMSMQMessage *This,
                                        __LONG32 lEncryptAlg);
  ...
  HRESULT(WINAPI *get_DestinationQueueInfo)(IMSMQMessage *This,
                                            IMSMQQueueInfo **ppqinfoDest);
  HRESULT(WINAPI *get_SenderCertificate)(IMSMQMessage *This,
                                         VARIANT *pvarSenderCert);
  HRESULT(WINAPI *put_SenderCertificate)(IMSMQMessage *This,
                                         VARIANT varSenderCert);
  HRESULT(WINAPI *get_SenderId)(IMSMQMessage *This, VARIANT *pvarSenderId);
  HRESULT(WINAPI *get_SenderIdType)(IMSMQMessage *This,
                                    __LONG32 *plSenderIdType);
  HRESULT(WINAPI *put_SenderIdType)(IMSMQMessage *This, __LONG32 lSenderIdType);
  HRESULT(WINAPI *Send)(IMSMQMessage *This, IMSMQQueue *DestinationQueue,
                        VARIANT *Transaction);
...
#define IMSMQMessage_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                  \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IMSMQMessage_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,        \
                                   rgDispId)                                   \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IMSMQMessage_Invoke(This, dispIdMember, riid, lcid, wFlags,            \
                            pDispParams, pVarResult, pExcepInfo, puArgErr)     \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI IMSMQMessage_get_Class_Proxy(IMSMQMessage *This,
                                            __LONG32 *plClass);
void __RPC_STUB IMSMQMessage_get_Class_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage_get_PrivLevel_Proxy(IMSMQMessage *This,
                                                __LONG32 *plPrivLevel);
void __RPC_STUB IMSMQMessage_get_PrivLevel_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage_put_PrivLevel_Proxy(IMSMQMessage *This,
                                                __LONG32 lPrivLevel);
void __RPC_STUB IMSMQMessage_put_PrivLevel_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage_get_AuthLevel_Proxy(IMSMQMessage *This,
                                                __LONG32 *plAuthLevel);
void __RPC_STUB IMSMQMessage_get_AuthLevel_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage_put_AuthLevel_Proxy(IMSMQMessage *This,
                                                __LONG32 lAuthLevel);
void __RPC_STUB IMSMQMessage_put_AuthLevel_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage_get_IsAuthenticated_Proxy(
    IMSMQMessage *This, Boolean *pisAuthenticated);
void __RPC_STUB IMSMQMessage_get_IsAuthenticated_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage_get_Delivery_Proxy(IMSMQMessage *This,
                                               __LONG32 *plDelivery);
void __RPC_STUB IMSMQMessage_get_Delivery_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage_put_Delivery_Proxy(IMSMQMessage *This,
                                               __LONG32 lDelivery);
void __RPC_STUB IMSMQMessage_put_Delivery_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage_get_Trace_Proxy(IMSMQMessage *This,
                                            __LONG32 *plTrace);
void __RPC_STUB IMSMQMessage_get_Trace_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage_put_Trace_Proxy(IMSMQMessage *This,
                                            __LONG32 lTrace);
void __RPC_STUB IMSMQMessage_put_Trace_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage_get_Priority_Proxy(IMSMQMessage *This,
                                               __LONG32 *plPriority);
void __RPC_STUB IMSMQMessage_get_Priority_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage_put_Priority_Proxy(IMSMQMessage *This,
                                               __LONG32 lPriority);
void __RPC_STUB IMSMQMessage_put_Priority_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage_get_Journal_Proxy(IMSMQMessage *This,
                                              __LONG32 *plJournal);
void __RPC_STUB IMSMQMessage_get_Journal_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage_put_Journal_Proxy(IMSMQMessage *This,
                                              __LONG32 lJournal);
...
void __RPC_STUB IMSMQMessage_get_ResponseQueueInfo_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage_putref_ResponseQueueInfo_Proxy(
    IMSMQMessage *This, IMSMQQueueInfo *pqinfoResponse);
void __RPC_STUB IMSMQMessage_putref_ResponseQueueInfo_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage_get_AppSpecific_Proxy(IMSMQMessage *This,
                                                  __LONG32 *plAppSpecific);
void __RPC_STUB IMSMQMessage_get_AppSpecific_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage_put_AppSpecific_Proxy(IMSMQMessage *This,
                                                  __LONG32 lAppSpecific);
void __RPC_STUB IMSMQMessage_put_AppSpecific_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage_get_SourceMachineGuid_Proxy(
    IMSMQMessage *This, BSTR *pbstrGuidSrcMachine);
void __RPC_STUB IMSMQMessage_get_SourceMachineGuid_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage_get_BodyLength_Proxy(IMSMQMessage *This,
                                                 __LONG32 *pcbBody);
void __RPC_STUB IMSMQMessage_get_BodyLength_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage_get_Body_Proxy(IMSMQMessage *This,
                                           VARIANT *pvarBody);
...
void __RPC_STUB IMSMQMessage_put_Body_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage_get_AdminQueueInfo_Proxy(
    IMSMQMessage *This, IMSMQQueueInfo **ppqinfoAdmin);
void __RPC_STUB IMSMQMessage_get_AdminQueueInfo_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage_putref_AdminQueueInfo_Proxy(
    IMSMQMessage *This, IMSMQQueueInfo *pqinfoAdmin);
void __RPC_STUB IMSMQMessage_putref_AdminQueueInfo_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage_get_Id_Proxy(IMSMQMessage *This,
                                         VARIANT *pvarMsgId);
void __RPC_STUB IMSMQMessage_get_Id_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage_get_CorrelationId_Proxy(IMSMQMessage *This,
                                                    VARIANT *pvarMsgId);
void __RPC_STUB IMSMQMessage_get_CorrelationId_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage_put_CorrelationId_Proxy(IMSMQMessage *This,
                                                    VARIANT varMsgId);
...
void __RPC_STUB IMSMQMessage_get_Ack_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage_put_Ack_Proxy(IMSMQMessage *This, __LONG32 lAck);
void __RPC_STUB IMSMQMessage_put_Ack_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage_get_Label_Proxy(IMSMQMessage *This,
                                            BSTR *pbstrLabel);
...
void __RPC_STUB IMSMQMessage_put_Label_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage_get_MaxTimeToReachQueue_Proxy(
    IMSMQMessage *This, __LONG32 *plMaxTimeToReachQueue);
void __RPC_STUB IMSMQMessage_get_MaxTimeToReachQueue_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage_put_MaxTimeToReachQueue_Proxy(
    IMSMQMessage *This, __LONG32 lMaxTimeToReachQueue);
void __RPC_STUB IMSMQMessage_put_MaxTimeToReachQueue_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage_get_MaxTimeToReceive_Proxy(
    IMSMQMessage *This, __LONG32 *plMaxTimeToReceive);
void __RPC_STUB IMSMQMessage_get_MaxTimeToReceive_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage_put_MaxTimeToReceive_Proxy(
    IMSMQMessage *This, __LONG32 lMaxTimeToReceive);
void __RPC_STUB IMSMQMessage_put_MaxTimeToReceive_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage_get_HashAlgorithm_Proxy(IMSMQMessage *This,
                                                    __LONG32 *plHashAlg);
void __RPC_STUB IMSMQMessage_get_HashAlgorithm_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage_put_HashAlgorithm_Proxy(IMSMQMessage *This,
                                                    __LONG32 lHashAlg);
void __RPC_STUB IMSMQMessage_put_HashAlgorithm_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage_get_EncryptAlgorithm_Proxy(IMSMQMessage *This,
                                                       __LONG32 *plEncryptAlg);
void __RPC_STUB IMSMQMessage_get_EncryptAlgorithm_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage_put_EncryptAlgorithm_Proxy(IMSMQMessage *This,
                                                       __LONG32 lEncryptAlg);
void __RPC_STUB IMSMQMessage_put_EncryptAlgorithm_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage_get_SentTime_Proxy(IMSMQMessage *This,
                                               VARIANT *pvarSentTime);
void __RPC_STUB IMSMQMessage_get_SentTime_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage_get_ArrivedTime_Proxy(IMSMQMessage *This,
                                                  VARIANT *plArrivedTime);
void __RPC_STUB IMSMQMessage_get_ArrivedTime_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage_get_DestinationQueueInfo_Proxy(
    IMSMQMessage *This, IMSMQQueueInfo **ppqinfoDest);
void __RPC_STUB IMSMQMessage_get_DestinationQueueInfo_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage_get_SenderCertificate_Proxy(
    IMSMQMessage *This, VARIANT *pvarSenderCert);
void __RPC_STUB IMSMQMessage_get_SenderCertificate_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage_put_SenderCertificate_Proxy(IMSMQMessage *This,
                                                        VARIANT varSenderCert);
void __RPC_STUB IMSMQMessage_put_SenderCertificate_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage_get_SenderId_Proxy(IMSMQMessage *This,
                                               VARIANT *pvarSenderId);
void __RPC_STUB IMSMQMessage_get_SenderId_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage_get_SenderIdType_Proxy(IMSMQMessage *This,
                                                   __LONG32 *plSenderIdType);
void __RPC_STUB IMSMQMessage_get_SenderIdType_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage_put_SenderIdType_Proxy(IMSMQMessage *This,
                                                   __LONG32 lSenderIdType);
void __RPC_STUB IMSMQMessage_put_SenderIdType_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage_Send_Proxy(IMSMQMessage *This,
                                       IMSMQQueue *DestinationQueue,
                                       VARIANT *Transaction);
void __RPC_STUB IMSMQMessage_Send_Stub(IRpcStubBuffer *This,
                                       IRpcChannelBuffer *_pRpcChannelBuffer,
                                       PRPC_MESSAGE _pRpcMessage,
                                       DWORD *_pdwStubPhase);
HRESULT WINAPI
IMSMQMessage_AttachCurrentSecurityContext_Proxy(IMSMQMessage *This);
...
typedef struct IMSMQQueueInfosVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMSMQQueueInfos *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IMSMQQueueInfos *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IMSMQQueueInfos *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IMSMQQueueInfos *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
...
#define IMSMQQueueInfos_GetTypeInfo(This, iTInfo, lcid, ppTInfo)               \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IMSMQQueueInfos_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,     \
                                      rgDispId)                                \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IMSMQQueueInfos_Invoke(This, dispIdMember, riid, lcid, wFlags,         \
                               pDispParams, pVarResult, pExcepInfo, puArgErr)  \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
void __RPC_STUB IMSMQQueueInfos_Reset_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfos_Next_Proxy(IMSMQQueueInfos *This,
                                          IMSMQQueueInfo **ppqinfoNext);
void __RPC_STUB IMSMQQueueInfos_Next_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
#endif
...
typedef struct IMSMQQueueInfos2Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMSMQQueueInfos2 *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IMSMQQueueInfos2 *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IMSMQQueueInfos2 *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IMSMQQueueInfos2 *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *Reset)(IMSMQQueueInfos2 *This);
  HRESULT(WINAPI *Next)(IMSMQQueueInfos2 *This, IMSMQQueueInfo2 **ppqinfoNext);
  HRESULT(WINAPI *get_Properties)(IMSMQQueueInfos2 *This,
                                  IDispatch **ppcolProperties);
  END_INTERFACE
...
#define IMSMQQueueInfos2_GetTypeInfo(This, iTInfo, lcid, ppTInfo)              \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IMSMQQueueInfos2_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,    \
                                       rgDispId)                               \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IMSMQQueueInfos2_Invoke(This, dispIdMember, riid, lcid, wFlags,        \
                                pDispParams, pVarResult, pExcepInfo, puArgErr) \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
void __RPC_STUB IMSMQQueueInfos2_Reset_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfos2_Next_Proxy(IMSMQQueueInfos2 *This,
                                           IMSMQQueueInfo2 **ppqinfoNext);
void __RPC_STUB IMSMQQueueInfos2_Next_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfos2_get_Properties_Proxy(
    IMSMQQueueInfos2 *This, IDispatch **ppcolProperties);
...
typedef struct IMSMQQueueInfos3Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMSMQQueueInfos3 *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IMSMQQueueInfos3 *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IMSMQQueueInfos3 *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IMSMQQueueInfos3 *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *Reset)(IMSMQQueueInfos3 *This);
  HRESULT(WINAPI *Next)(IMSMQQueueInfos3 *This, IMSMQQueueInfo3 **ppqinfoNext);
  HRESULT(WINAPI *get_Properties)(IMSMQQueueInfos3 *This,
                                  IDispatch **ppcolProperties);
  END_INTERFACE
...
#define IMSMQQueueInfos3_GetTypeInfo(This, iTInfo, lcid, ppTInfo)              \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IMSMQQueueInfos3_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,    \
                                       rgDispId)                               \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IMSMQQueueInfos3_Invoke(This, dispIdMember, riid, lcid, wFlags,        \
                                pDispParams, pVarResult, pExcepInfo, puArgErr) \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
void __RPC_STUB IMSMQQueueInfos3_Reset_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfos3_Next_Proxy(IMSMQQueueInfos3 *This,
                                           IMSMQQueueInfo3 **ppqinfoNext);
void __RPC_STUB IMSMQQueueInfos3_Next_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueInfos3_get_Properties_Proxy(
    IMSMQQueueInfos3 *This, IDispatch **ppcolProperties);
...
typedef struct IMSMQEventVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMSMQEvent *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IMSMQEvent *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IMSMQEvent *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IMSMQEvent *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  END_INTERFACE
...
#define IMSMQEvent_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                    \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IMSMQEvent_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,          \
                                 rgDispId)                                     \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
...
typedef struct IMSMQEvent2Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMSMQEvent2 *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IMSMQEvent2 *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IMSMQEvent2 *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IMSMQEvent2 *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *get_Properties)(IMSMQEvent2 *This,
                                  IDispatch **ppcolProperties);
  END_INTERFACE
} IMSMQEvent2Vtbl;
struct IMSMQEvent2 {
...
#define IMSMQEvent2_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                   \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IMSMQEvent2_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,         \
                                  rgDispId)                                    \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IMSMQEvent2_Invoke(This, dispIdMember, riid, lcid, wFlags,             \
                           pDispParams, pVarResult, pExcepInfo, puArgErr)      \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI IMSMQEvent2_get_Properties_Proxy(IMSMQEvent2 *This,
                                                IDispatch **ppcolProperties);
...
typedef struct IMSMQEvent3Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMSMQEvent3 *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IMSMQEvent3 *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IMSMQEvent3 *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IMSMQEvent3 *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *get_Properties)(IMSMQEvent3 *This,
                                  IDispatch **ppcolProperties);
  END_INTERFACE
} IMSMQEvent3Vtbl;
struct IMSMQEvent3 {
...
#define IMSMQEvent3_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                   \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IMSMQEvent3_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,         \
                                  rgDispId)                                    \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IMSMQEvent3_Invoke(This, dispIdMember, riid, lcid, wFlags,             \
                           pDispParams, pVarResult, pExcepInfo, puArgErr)      \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
public:
  ...
  virtual HRESULT WINAPI Commit(VARIANT *fRetaining, VARIANT *grfTC,
                                VARIANT *grfRM) = 0;
...
typedef struct IMSMQTransactionVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMSMQTransaction *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IMSMQTransaction *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IMSMQTransaction *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IMSMQTransaction *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *get_Transaction)(IMSMQTransaction *This,
                                   __LONG32 *plTransaction);
  HRESULT(WINAPI *Commit)(IMSMQTransaction *This, VARIANT *fRetaining,
                          VARIANT *grfTC, VARIANT *grfRM);
  HRESULT(WINAPI *Abort)(IMSMQTransaction *This, VARIANT *fRetaining,
                         VARIANT *fAsync);
  END_INTERFACE
...
#define IMSMQTransaction_GetTypeInfo(This, iTInfo, lcid, ppTInfo)              \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IMSMQTransaction_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,    \
                                       rgDispId)                               \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IMSMQTransaction_Invoke(This, dispIdMember, riid, lcid, wFlags,        \
                                pDispParams, pVarResult, pExcepInfo, puArgErr) \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI IMSMQTransaction_get_Transaction_Proxy(IMSMQTransaction *This,
                                                      __LONG32 *plTransaction);
void __RPC_STUB IMSMQTransaction_get_Transaction_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQTransaction_Commit_Proxy(IMSMQTransaction *This,
                                             VARIANT *fRetaining,
                                             VARIANT *grfTC, VARIANT *grfRM);
void __RPC_STUB IMSMQTransaction_Commit_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQTransaction_Abort_Proxy(IMSMQTransaction *This,
                                            VARIANT *fRetaining,
                                            VARIANT *fAsync);
...
typedef struct IMSMQCoordinatedTransactionDispenserVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMSMQCoordinatedTransactionDispenser *This,
  ...
  HRESULT(WINAPI *GetTypeInfoCount)(IMSMQCoordinatedTransactionDispenser *This,
                                    UINT *pctinfo);
  HRESULT(WINAPI *GetTypeInfo)(IMSMQCoordinatedTransactionDispenser *This,
                               UINT iTInfo, LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IMSMQCoordinatedTransactionDispenser *This,
                                 REFIID riid, LPOLESTR *rgszNames, UINT cNames,
                                 LCID lcid, DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IMSMQCoordinatedTransactionDispenser *This,
                          DISPID dispIdMember, REFIID riid, LCID lcid,
                          WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *BeginTransaction)(IMSMQCoordinatedTransactionDispenser *This,
                                    IMSMQTransaction **ptransaction);
  END_INTERFACE
...
#ifdef COBJMACROS
#define IMSMQCoordinatedTransactionDispenser_QueryInterface(This, riid,        \
                                                            ppvObject)         \
  (This)->lpVtbl->QueryInterface(This, riid, ppvObject)
...
#define IMSMQCoordinatedTransactionDispenser_GetTypeInfoCount(This, pctinfo)   \
  (This)->lpVtbl->GetTypeInfoCount(This, pctinfo)
#define IMSMQCoordinatedTransactionDispenser_GetTypeInfo(This, iTInfo, lcid,   \
                                                         ppTInfo)              \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IMSMQCoordinatedTransactionDispenser_GetIDsOfNames(                    \
...
#define IMSMQCoordinatedTransactionDispenser_Invoke(                           \
  ...
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
#define IMSMQCoordinatedTransactionDispenser_BeginTransaction(This,            \
                                                              ptransaction)    \
...
typedef struct IMSMQTransactionDispenserVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMSMQTransactionDispenser *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IMSMQTransactionDispenser *This);
  ULONG(WINAPI *Release)(IMSMQTransactionDispenser *This);
  HRESULT(WINAPI *GetTypeInfoCount)(IMSMQTransactionDispenser *This,
                                    UINT *pctinfo);
  HRESULT(WINAPI *GetTypeInfo)(IMSMQTransactionDispenser *This, UINT iTInfo,
                               LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IMSMQTransactionDispenser *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IMSMQTransactionDispenser *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *BeginTransaction)(IMSMQTransactionDispenser *This,
                                    IMSMQTransaction **ptransaction);
  END_INTERFACE
...
#define IMSMQTransactionDispenser_GetTypeInfo(This, iTInfo, lcid, ppTInfo)     \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IMSMQTransactionDispenser_GetIDsOfNames(This, riid, rgszNames, cNames, \
                                                lcid, rgDispId)                \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IMSMQTransactionDispenser_Invoke(This, dispIdMember, riid, lcid,       \
...
#endif
#endif
HRESULT WINAPI IMSMQTransactionDispenser_BeginTransaction_Proxy(
    IMSMQTransactionDispenser *This, IMSMQTransaction **ptransaction);
...
public:
  virtual HRESULT WINAPI LookupQueue(VARIANT *QueueGuid,
                                     ...
                                     VARIANT *RelCreateTime,
                                     VARIANT *RelModifyTime,
                                     IMSMQQueueInfos2 **ppqinfos) = 0;
  virtual HRESULT WINAPI get_Properties(IDispatch **ppcolProperties) = 0;
};
#else
typedef struct IMSMQQuery2Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMSMQQuery2 *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IMSMQQuery2 *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IMSMQQuery2 *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IMSMQQuery2 *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *LookupQueue)(IMSMQQuery2 *This, VARIANT *QueueGuid,
                               VARIANT *ServiceTypeGuid, VARIANT *Label,
                               VARIANT *CreateTime, VARIANT *ModifyTime,
                               VARIANT *RelServiceType, VARIANT *RelLabel,
                               VARIANT *RelCreateTime, VARIANT *RelModifyTime,
                               IMSMQQueueInfos2 **ppqinfos);
  HRESULT(WINAPI *get_Properties)(IMSMQQuery2 *This,
                                  IDispatch **ppcolProperties);
  END_INTERFACE
} IMSMQQuery2Vtbl;
struct IMSMQQuery2 {
...
#define IMSMQQuery2_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                   \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IMSMQQuery2_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,         \
                                  rgDispId)                                    \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IMSMQQuery2_Invoke(This, dispIdMember, riid, lcid, wFlags,             \
                           pDispParams, pVarResult, pExcepInfo, puArgErr)      \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
#define IMSMQQuery2_LookupQueue(                                               \
    This, QueueGuid, ServiceTypeGuid, Label, CreateTime, ModifyTime,           \
    RelServiceType, RelLabel, RelCreateTime, RelModifyTime, ppqinfos)          \
  (This)->lpVtbl->LookupQueue(                                                 \
      This, QueueGuid, ServiceTypeGuid, Label, CreateTime, ModifyTime,         \
...
#endif
#endif
HRESULT WINAPI IMSMQQuery2_LookupQueue_Proxy(
    IMSMQQuery2 *This, VARIANT *QueueGuid, VARIANT *ServiceTypeGuid,
    VARIANT *Label, VARIANT *CreateTime, VARIANT *ModifyTime,
    VARIANT *RelServiceType, VARIANT *RelLabel, VARIANT *RelCreateTime,
...
void __RPC_STUB IMSMQQuery2_LookupQueue_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQuery2_get_Properties_Proxy(IMSMQQuery2 *This,
                                                IDispatch **ppcolProperties);
...
public:
  virtual HRESULT WINAPI LookupQueue_v2(
      VARIANT *QueueGuid, VARIANT *ServiceTypeGuid, VARIANT *Label,
      VARIANT *CreateTime, VARIANT *ModifyTime, VARIANT *RelServiceType,
      VARIANT *RelLabel, VARIANT *RelCreateTime, VARIANT *RelModifyTime,
      IMSMQQueueInfos3 **ppqinfos) = 0;
  virtual HRESULT WINAPI get_Properties(IDispatch **ppcolProperties) = 0;
  virtual HRESULT WINAPI
  LookupQueue(VARIANT *QueueGuid, VARIANT *ServiceTypeGuid, VARIANT *Label,
              VARIANT *CreateTime, VARIANT *ModifyTime, VARIANT *RelServiceType,
              VARIANT *RelLabel, VARIANT *RelCreateTime, VARIANT *RelModifyTime,
              VARIANT *MulticastAddress, VARIANT *RelMulticastAddress,
              IMSMQQueueInfos3 **ppqinfos) = 0;
};
#else
typedef struct IMSMQQuery3Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMSMQQuery3 *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IMSMQQuery3 *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IMSMQQuery3 *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IMSMQQuery3 *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *LookupQueue_v2)(IMSMQQuery3 *This, VARIANT *QueueGuid,
                                  VARIANT *ServiceTypeGuid, VARIANT *Label,
                                  VARIANT *CreateTime, VARIANT *ModifyTime,
                                  VARIANT *RelServiceType, VARIANT *RelLabel,
                                  VARIANT *RelCreateTime,
  ...
  HRESULT(WINAPI *get_Properties)(IMSMQQuery3 *This,
                                  IDispatch **ppcolProperties);
  HRESULT(WINAPI *LookupQueue)(IMSMQQuery3 *This, VARIANT *QueueGuid,
                               VARIANT *ServiceTypeGuid, VARIANT *Label,
                               VARIANT *CreateTime, VARIANT *ModifyTime,
                               VARIANT *RelServiceType, VARIANT *RelLabel,
                               VARIANT *RelCreateTime, VARIANT *RelModifyTime,
...
#define IMSMQQuery3_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                   \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IMSMQQuery3_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,         \
                                  rgDispId)                                    \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IMSMQQuery3_Invoke(This, dispIdMember, riid, lcid, wFlags,             \
                           pDispParams, pVarResult, pExcepInfo, puArgErr)      \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
#define IMSMQQuery3_LookupQueue_v2(                                            \
    This, QueueGuid, ServiceTypeGuid, Label, CreateTime, ModifyTime,           \
    RelServiceType, RelLabel, RelCreateTime, RelModifyTime, ppqinfos)          \
  (This)->lpVtbl->LookupQueue_v2(                                              \
      This, QueueGuid, ServiceTypeGuid, Label, CreateTime, ModifyTime,         \
      RelServiceType, RelLabel, RelCreateTime, RelModifyTime, ppqinfos)
#define IMSMQQuery3_get_Properties(This, ppcolProperties)                      \
  (This)->lpVtbl->get_Properties(This, ppcolProperties)
#define IMSMQQuery3_LookupQueue(                                               \
    This, QueueGuid, ServiceTypeGuid, Label, CreateTime, ModifyTime,           \
    RelServiceType, RelLabel, RelCreateTime, RelModifyTime, MulticastAddress,  \
    RelMulticastAddress, ppqinfos)                                             \
  (This)->lpVtbl->LookupQueue(This, QueueGuid, ServiceTypeGuid, Label,         \
                              CreateTime, ModifyTime, RelServiceType,          \
                              RelLabel, RelCreateTime, RelModifyTime,          \
                              MulticastAddress, RelMulticastAddress, ppqinfos)
#endif
#endif
HRESULT WINAPI IMSMQQuery3_LookupQueue_v2_Proxy(
    IMSMQQuery3 *This, VARIANT *QueueGuid, VARIANT *ServiceTypeGuid,
    VARIANT *Label, VARIANT *CreateTime, VARIANT *ModifyTime,
    VARIANT *RelServiceType, VARIANT *RelLabel, VARIANT *RelCreateTime,
...
void __RPC_STUB IMSMQQuery3_LookupQueue_v2_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQuery3_get_Properties_Proxy(IMSMQQuery3 *This,
                                                IDispatch **ppcolProperties);
void __RPC_STUB IMSMQQuery3_get_Properties_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQuery3_LookupQueue_Proxy(
    IMSMQQuery3 *This, VARIANT *QueueGuid, VARIANT *ServiceTypeGuid,
    VARIANT *Label, VARIANT *CreateTime, VARIANT *ModifyTime,
    VARIANT *RelServiceType, VARIANT *RelLabel, VARIANT *RelCreateTime,
    VARIANT *RelModifyTime, VARIANT *MulticastAddress,
    VARIANT *RelMulticastAddress, IMSMQQueueInfos3 **ppqinfos);
...
public:
  ...
  virtual HRESULT WINAPI put_Journal(__LONG32 lJournal) = 0;
  virtual HRESULT WINAPI
  get_ResponseQueueInfo_v1(IMSMQQueueInfo **ppqinfoResponse) = 0;
  virtual HRESULT WINAPI
  putref_ResponseQueueInfo_v1(IMSMQQueueInfo *pqinfoResponse) = 0;
  virtual HRESULT WINAPI get_AppSpecific(__LONG32 *plAppSpecific) = 0;
  virtual HRESULT WINAPI put_AppSpecific(__LONG32 lAppSpecific) = 0;
  virtual HRESULT WINAPI get_SourceMachineGuid(BSTR *pbstrGuidSrcMachine) = 0;
  virtual HRESULT WINAPI get_BodyLength(__LONG32 *pcbBody) = 0;
  ...
  virtual HRESULT WINAPI put_Body(VARIANT varBody) = 0;
  virtual HRESULT WINAPI
  get_AdminQueueInfo_v1(IMSMQQueueInfo **ppqinfoAdmin) = 0;
  virtual HRESULT WINAPI
  putref_AdminQueueInfo_v1(IMSMQQueueInfo *pqinfoAdmin) = 0;
  virtual HRESULT WINAPI get_Id(VARIANT *pvarMsgId) = 0;
  virtual HRESULT WINAPI get_CorrelationId(VARIANT *pvarMsgId) = 0;
  virtual HRESULT WINAPI put_CorrelationId(VARIANT varMsgId) = 0;
  virtual HRESULT WINAPI get_Ack(__LONG32 *plAck) = 0;
  ...
  virtual HRESULT WINAPI get_ArrivedTime(VARIANT *plArrivedTime) = 0;
  virtual HRESULT WINAPI
  get_DestinationQueueInfo(IMSMQQueueInfo2 **ppqinfoDest) = 0;
  virtual HRESULT WINAPI get_SenderCertificate(VARIANT *pvarSenderCert) = 0;
  virtual HRESULT WINAPI put_SenderCertificate(VARIANT varSenderCert) = 0;
  virtual HRESULT WINAPI get_SenderId(VARIANT *pvarSenderId) = 0;
  virtual HRESULT WINAPI get_SenderIdType(__LONG32 *plSenderIdType) = 0;
  virtual HRESULT WINAPI put_SenderIdType(__LONG32 lSenderIdType) = 0;
  virtual HRESULT WINAPI Send(IMSMQQueue2 *DestinationQueue,
                              VARIANT *Transaction) = 0;
  virtual HRESULT WINAPI AttachCurrentSecurityContext(void) = 0;
  ...
  virtual HRESULT WINAPI
  get_ConnectorTypeGuid(BSTR *pbstrGuidConnectorType) = 0;
  virtual HRESULT WINAPI put_ConnectorTypeGuid(BSTR bstrGuidConnectorType) = 0;
  virtual HRESULT WINAPI
  get_TransactionStatusQueueInfo(IMSMQQueueInfo2 **ppqinfoXactStatus) = 0;
  virtual HRESULT WINAPI
  get_DestinationSymmetricKey(VARIANT *pvarDestSymmKey) = 0;
  virtual HRESULT WINAPI
  put_DestinationSymmetricKey(VARIANT varDestSymmKey) = 0;
  virtual HRESULT WINAPI get_Signature(VARIANT *pvarSignature) = 0;
  virtual HRESULT WINAPI put_Signature(VARIANT varSignature) = 0;
  virtual HRESULT WINAPI
  get_AuthenticationProviderType(__LONG32 *plAuthProvType) = 0;
  virtual HRESULT WINAPI
  put_AuthenticationProviderType(__LONG32 lAuthProvType) = 0;
  virtual HRESULT WINAPI
  get_AuthenticationProviderName(BSTR *pbstrAuthProvName) = 0;
  virtual HRESULT WINAPI
  put_AuthenticationProviderName(BSTR bstrAuthProvName) = 0;
  ...
  virtual HRESULT WINAPI
  get_ResponseQueueInfo(IMSMQQueueInfo2 **ppqinfoResponse) = 0;
  virtual HRESULT WINAPI
  putref_ResponseQueueInfo(IMSMQQueueInfo2 *pqinfoResponse) = 0;
  virtual HRESULT WINAPI get_AdminQueueInfo(IMSMQQueueInfo2 **ppqinfoAdmin) = 0;
  virtual HRESULT WINAPI
  putref_AdminQueueInfo(IMSMQQueueInfo2 *pqinfoAdmin) = 0;
  virtual HRESULT WINAPI
  get_ReceivedAuthenticationLevel(short *psReceivedAuthenticationLevel) = 0;
};
#else
typedef struct IMSMQMessage2Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMSMQMessage2 *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IMSMQMessage2 *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IMSMQMessage2 *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IMSMQMessage2 *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  ...
  HRESULT(WINAPI *get_IsAuthenticated)(IMSMQMessage2 *This,
                                       Boolean *pisAuthenticated);
  ...
  HRESULT(WINAPI *get_ResponseQueueInfo_v1)(IMSMQMessage2 *This,
                                            IMSMQQueueInfo **ppqinfoResponse);
  HRESULT(WINAPI *putref_ResponseQueueInfo_v1)(IMSMQMessage2 *This,
                                               IMSMQQueueInfo *pqinfoResponse);
  HRESULT(WINAPI *get_AppSpecific)(IMSMQMessage2 *This,
                                   __LONG32 *plAppSpecific);
  HRESULT(WINAPI *put_AppSpecific)(IMSMQMessage2 *This, __LONG32 lAppSpecific);
  HRESULT(WINAPI *get_SourceMachineGuid)(IMSMQMessage2 *This,
                                         BSTR *pbstrGuidSrcMachine);
  ...
  HRESULT(WINAPI *get_AdminQueueInfo_v1)(IMSMQMessage2 *This,
                                         IMSMQQueueInfo **ppqinfoAdmin);
  HRESULT(WINAPI *putref_AdminQueueInfo_v1)(IMSMQMessage2 *This,
                                            IMSMQQueueInfo *pqinfoAdmin);
  ...
  HRESULT(WINAPI *get_MaxTimeToReachQueue)(IMSMQMessage2 *This,
                                           __LONG32 *plMaxTimeToReachQueue);
  HRESULT(WINAPI *put_MaxTimeToReachQueue)(IMSMQMessage2 *This,
                                           __LONG32 lMaxTimeToReachQueue);
  HRESULT(WINAPI *get_MaxTimeToReceive)(IMSMQMessage2 *This,
                                        __LONG32 *plMaxTimeToReceive);
  HRESULT(WINAPI *put_MaxTimeToReceive)(IMSMQMessage2 *This,
                                        __LONG32 lMaxTimeToReceive);
  ...
  HRESULT(WINAPI *get_EncryptAlgorithm)(IMSMQMessage2 *This,
                                        __LONG32 *plEncryptAlg);
  HRESULT(WINAPI *put_EncryptAlgorithm)(IMSMQMessage2 *This,
                                        __LONG32 lEncryptAlg);
  ...
  HRESULT(WINAPI *get_DestinationQueueInfo)(IMSMQMessage2 *This,
                                            IMSMQQueueInfo2 **ppqinfoDest);
  HRESULT(WINAPI *get_SenderCertificate)(IMSMQMessage2 *This,
                                         VARIANT *pvarSenderCert);
  HRESULT(WINAPI *put_SenderCertificate)(IMSMQMessage2 *This,
                                         VARIANT varSenderCert);
  HRESULT(WINAPI *get_SenderId)(IMSMQMessage2 *This, VARIANT *pvarSenderId);
  HRESULT(WINAPI *get_SenderIdType)(IMSMQMessage2 *This,
                                    __LONG32 *plSenderIdType);
  HRESULT(WINAPI *put_SenderIdType)(IMSMQMessage2 *This,
                                    __LONG32 lSenderIdType);
  HRESULT(WINAPI *Send)(IMSMQMessage2 *This, IMSMQQueue2 *DestinationQueue,
                        VARIANT *Transaction);
  HRESULT(WINAPI *AttachCurrentSecurityContext)(IMSMQMessage2 *This);
  HRESULT(WINAPI *get_SenderVersion)(IMSMQMessage2 *This,
                                     __LONG32 *plSenderVersion);
  ...
  HRESULT(WINAPI *get_ConnectorTypeGuid)(IMSMQMessage2 *This,
                                         BSTR *pbstrGuidConnectorType);
  HRESULT(WINAPI *put_ConnectorTypeGuid)(IMSMQMessage2 *This,
                                         BSTR bstrGuidConnectorType);
  HRESULT(WINAPI *get_TransactionStatusQueueInfo)(
      IMSMQMessage2 *This, IMSMQQueueInfo2 **ppqinfoXactStatus);
  HRESULT(WINAPI *get_DestinationSymmetricKey)(IMSMQMessage2 *This,
                                               VARIANT *pvarDestSymmKey);
  HRESULT(WINAPI *put_DestinationSymmetricKey)(IMSMQMessage2 *This,
  ...
  HRESULT(WINAPI *get_AuthenticationProviderType)(IMSMQMessage2 *This,
                                                  __LONG32 *plAuthProvType);
  HRESULT(WINAPI *put_AuthenticationProviderType)(IMSMQMessage2 *This,
                                                  __LONG32 lAuthProvType);
  HRESULT(WINAPI *get_AuthenticationProviderName)(IMSMQMessage2 *This,
                                                  BSTR *pbstrAuthProvName);
  HRESULT(WINAPI *put_AuthenticationProviderName)(IMSMQMessage2 *This,
  ...
  HRESULT(WINAPI *get_Properties)(IMSMQMessage2 *This,
                                  IDispatch **ppcolProperties);
  HRESULT(WINAPI *get_TransactionId)(IMSMQMessage2 *This, VARIANT *pvarXactId);
  HRESULT(WINAPI *get_IsFirstInTransaction)(IMSMQMessage2 *This,
                                            Boolean *pisFirstInXact);
  HRESULT(WINAPI *get_IsLastInTransaction)(IMSMQMessage2 *This,
                                           Boolean *pisLastInXact);
  HRESULT(WINAPI *get_ResponseQueueInfo)(IMSMQMessage2 *This,
                                         IMSMQQueueInfo2 **ppqinfoResponse);
  HRESULT(WINAPI *putref_ResponseQueueInfo)(IMSMQMessage2 *This,
                                            IMSMQQueueInfo2 *pqinfoResponse);
  HRESULT(WINAPI *get_AdminQueueInfo)(IMSMQMessage2 *This,
                                      IMSMQQueueInfo2 **ppqinfoAdmin);
  HRESULT(WINAPI *putref_AdminQueueInfo)(IMSMQMessage2 *This,
                                         IMSMQQueueInfo2 *pqinfoAdmin);
  HRESULT(WINAPI *get_ReceivedAuthenticationLevel)(
      IMSMQMessage2 *This, short *psReceivedAuthenticationLevel);
  END_INTERFACE
} IMSMQMessage2Vtbl;
...
#define IMSMQMessage2_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                 \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IMSMQMessage2_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,       \
                                    rgDispId)                                  \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IMSMQMessage2_Invoke(This, dispIdMember, riid, lcid, wFlags,           \
                             pDispParams, pVarResult, pExcepInfo, puArgErr)    \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#define IMSMQMessage2_putref_AdminQueueInfo(This, pqinfoAdmin)                 \
  (This)->lpVtbl->putref_AdminQueueInfo(This, pqinfoAdmin)
#define IMSMQMessage2_get_ReceivedAuthenticationLevel(                         \
    This, psReceivedAuthenticationLevel)                                       \
  (This)->lpVtbl->get_ReceivedAuthenticationLevel(                             \
      This, psReceivedAuthenticationLevel)
#endif
#endif
HRESULT WINAPI IMSMQMessage2_get_Class_Proxy(IMSMQMessage2 *This,
                                             __LONG32 *plClass);
void __RPC_STUB IMSMQMessage2_get_Class_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_get_PrivLevel_Proxy(IMSMQMessage2 *This,
                                                 __LONG32 *plPrivLevel);
void __RPC_STUB IMSMQMessage2_get_PrivLevel_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_put_PrivLevel_Proxy(IMSMQMessage2 *This,
                                                 __LONG32 lPrivLevel);
void __RPC_STUB IMSMQMessage2_put_PrivLevel_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_get_AuthLevel_Proxy(IMSMQMessage2 *This,
                                                 __LONG32 *plAuthLevel);
void __RPC_STUB IMSMQMessage2_get_AuthLevel_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_put_AuthLevel_Proxy(IMSMQMessage2 *This,
                                                 __LONG32 lAuthLevel);
void __RPC_STUB IMSMQMessage2_put_AuthLevel_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_get_IsAuthenticated_Proxy(
    IMSMQMessage2 *This, Boolean *pisAuthenticated);
void __RPC_STUB IMSMQMessage2_get_IsAuthenticated_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_get_Delivery_Proxy(IMSMQMessage2 *This,
                                                __LONG32 *plDelivery);
void __RPC_STUB IMSMQMessage2_get_Delivery_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_put_Delivery_Proxy(IMSMQMessage2 *This,
                                                __LONG32 lDelivery);
void __RPC_STUB IMSMQMessage2_put_Delivery_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_get_Trace_Proxy(IMSMQMessage2 *This,
                                             __LONG32 *plTrace);
void __RPC_STUB IMSMQMessage2_get_Trace_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_put_Trace_Proxy(IMSMQMessage2 *This,
                                             __LONG32 lTrace);
void __RPC_STUB IMSMQMessage2_put_Trace_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_get_Priority_Proxy(IMSMQMessage2 *This,
                                                __LONG32 *plPriority);
void __RPC_STUB IMSMQMessage2_get_Priority_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_put_Priority_Proxy(IMSMQMessage2 *This,
                                                __LONG32 lPriority);
void __RPC_STUB IMSMQMessage2_put_Priority_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_get_Journal_Proxy(IMSMQMessage2 *This,
                                               __LONG32 *plJournal);
void __RPC_STUB IMSMQMessage2_get_Journal_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_put_Journal_Proxy(IMSMQMessage2 *This,
                                               __LONG32 lJournal);
...
HRESULT WINAPI IMSMQMessage2_putref_ResponseQueueInfo_v1_Proxy(
    IMSMQMessage2 *This, IMSMQQueueInfo *pqinfoResponse);
void __RPC_STUB IMSMQMessage2_putref_ResponseQueueInfo_v1_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_get_AppSpecific_Proxy(IMSMQMessage2 *This,
                                                   __LONG32 *plAppSpecific);
void __RPC_STUB IMSMQMessage2_get_AppSpecific_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_put_AppSpecific_Proxy(IMSMQMessage2 *This,
                                                   __LONG32 lAppSpecific);
void __RPC_STUB IMSMQMessage2_put_AppSpecific_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_get_SourceMachineGuid_Proxy(
    IMSMQMessage2 *This, BSTR *pbstrGuidSrcMachine);
void __RPC_STUB IMSMQMessage2_get_SourceMachineGuid_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_get_BodyLength_Proxy(IMSMQMessage2 *This,
                                                  __LONG32 *pcbBody);
void __RPC_STUB IMSMQMessage2_get_BodyLength_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_get_Body_Proxy(IMSMQMessage2 *This,
                                            VARIANT *pvarBody);
void __RPC_STUB IMSMQMessage2_get_Body_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_put_Body_Proxy(IMSMQMessage2 *This,
                                            VARIANT varBody);
void __RPC_STUB IMSMQMessage2_put_Body_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_get_AdminQueueInfo_v1_Proxy(
    IMSMQMessage2 *This, IMSMQQueueInfo **ppqinfoAdmin);
void __RPC_STUB IMSMQMessage2_get_AdminQueueInfo_v1_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_putref_AdminQueueInfo_v1_Proxy(
    IMSMQMessage2 *This, IMSMQQueueInfo *pqinfoAdmin);
void __RPC_STUB IMSMQMessage2_putref_AdminQueueInfo_v1_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_get_Id_Proxy(IMSMQMessage2 *This,
                                          VARIANT *pvarMsgId);
void __RPC_STUB IMSMQMessage2_get_Id_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_get_CorrelationId_Proxy(IMSMQMessage2 *This,
                                                     VARIANT *pvarMsgId);
void __RPC_STUB IMSMQMessage2_get_CorrelationId_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_put_CorrelationId_Proxy(IMSMQMessage2 *This,
                                                     VARIANT varMsgId);
void __RPC_STUB IMSMQMessage2_put_CorrelationId_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_get_Ack_Proxy(IMSMQMessage2 *This,
                                           __LONG32 *plAck);
...
void __RPC_STUB IMSMQMessage2_put_Ack_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_get_Label_Proxy(IMSMQMessage2 *This,
                                             BSTR *pbstrLabel);
void __RPC_STUB IMSMQMessage2_get_Label_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_put_Label_Proxy(IMSMQMessage2 *This,
                                             BSTR bstrLabel);
void __RPC_STUB IMSMQMessage2_put_Label_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_get_MaxTimeToReachQueue_Proxy(
    IMSMQMessage2 *This, __LONG32 *plMaxTimeToReachQueue);
void __RPC_STUB IMSMQMessage2_get_MaxTimeToReachQueue_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_put_MaxTimeToReachQueue_Proxy(
    IMSMQMessage2 *This, __LONG32 lMaxTimeToReachQueue);
void __RPC_STUB IMSMQMessage2_put_MaxTimeToReachQueue_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_get_MaxTimeToReceive_Proxy(
    IMSMQMessage2 *This, __LONG32 *plMaxTimeToReceive);
void __RPC_STUB IMSMQMessage2_get_MaxTimeToReceive_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_put_MaxTimeToReceive_Proxy(
    IMSMQMessage2 *This, __LONG32 lMaxTimeToReceive);
void __RPC_STUB IMSMQMessage2_put_MaxTimeToReceive_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_get_HashAlgorithm_Proxy(IMSMQMessage2 *This,
                                                     __LONG32 *plHashAlg);
void __RPC_STUB IMSMQMessage2_get_HashAlgorithm_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_put_HashAlgorithm_Proxy(IMSMQMessage2 *This,
                                                     __LONG32 lHashAlg);
void __RPC_STUB IMSMQMessage2_put_HashAlgorithm_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_get_EncryptAlgorithm_Proxy(IMSMQMessage2 *This,
                                                        __LONG32 *plEncryptAlg);
void __RPC_STUB IMSMQMessage2_get_EncryptAlgorithm_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_put_EncryptAlgorithm_Proxy(IMSMQMessage2 *This,
                                                        __LONG32 lEncryptAlg);
void __RPC_STUB IMSMQMessage2_put_EncryptAlgorithm_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_get_SentTime_Proxy(IMSMQMessage2 *This,
                                                VARIANT *pvarSentTime);
void __RPC_STUB IMSMQMessage2_get_SentTime_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_get_ArrivedTime_Proxy(IMSMQMessage2 *This,
                                                   VARIANT *plArrivedTime);
void __RPC_STUB IMSMQMessage2_get_ArrivedTime_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_get_DestinationQueueInfo_Proxy(
    IMSMQMessage2 *This, IMSMQQueueInfo2 **ppqinfoDest);
void __RPC_STUB IMSMQMessage2_get_DestinationQueueInfo_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_get_SenderCertificate_Proxy(
    IMSMQMessage2 *This, VARIANT *pvarSenderCert);
void __RPC_STUB IMSMQMessage2_get_SenderCertificate_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_put_SenderCertificate_Proxy(IMSMQMessage2 *This,
                                                         VARIANT varSenderCert);
void __RPC_STUB IMSMQMessage2_put_SenderCertificate_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_get_SenderId_Proxy(IMSMQMessage2 *This,
                                                VARIANT *pvarSenderId);
void __RPC_STUB IMSMQMessage2_get_SenderId_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_get_SenderIdType_Proxy(IMSMQMessage2 *This,
                                                    __LONG32 *plSenderIdType);
void __RPC_STUB IMSMQMessage2_get_SenderIdType_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_put_SenderIdType_Proxy(IMSMQMessage2 *This,
                                                    __LONG32 lSenderIdType);
void __RPC_STUB IMSMQMessage2_put_SenderIdType_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_Send_Proxy(IMSMQMessage2 *This,
                                        IMSMQQueue2 *DestinationQueue,
                                        VARIANT *Transaction);
void __RPC_STUB IMSMQMessage2_Send_Stub(IRpcStubBuffer *This,
                                        IRpcChannelBuffer *_pRpcChannelBuffer,
                                        PRPC_MESSAGE _pRpcMessage,
                                        DWORD *_pdwStubPhase);
HRESULT WINAPI
IMSMQMessage2_AttachCurrentSecurityContext_Proxy(IMSMQMessage2 *This);
void __RPC_STUB IMSMQMessage2_AttachCurrentSecurityContext_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_get_SenderVersion_Proxy(IMSMQMessage2 *This,
                                                     __LONG32 *plSenderVersion);
void __RPC_STUB IMSMQMessage2_get_SenderVersion_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_get_Extension_Proxy(IMSMQMessage2 *This,
                                                 VARIANT *pvarExtension);
void __RPC_STUB IMSMQMessage2_get_Extension_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_put_Extension_Proxy(IMSMQMessage2 *This,
                                                 VARIANT varExtension);
void __RPC_STUB IMSMQMessage2_put_Extension_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_get_ConnectorTypeGuid_Proxy(
    IMSMQMessage2 *This, BSTR *pbstrGuidConnectorType);
void __RPC_STUB IMSMQMessage2_get_ConnectorTypeGuid_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_put_ConnectorTypeGuid_Proxy(
    IMSMQMessage2 *This, BSTR bstrGuidConnectorType);
void __RPC_STUB IMSMQMessage2_put_ConnectorTypeGuid_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_get_TransactionStatusQueueInfo_Proxy(
    IMSMQMessage2 *This, IMSMQQueueInfo2 **ppqinfoXactStatus);
void __RPC_STUB IMSMQMessage2_get_TransactionStatusQueueInfo_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_get_DestinationSymmetricKey_Proxy(
    IMSMQMessage2 *This, VARIANT *pvarDestSymmKey);
void __RPC_STUB IMSMQMessage2_get_DestinationSymmetricKey_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_put_DestinationSymmetricKey_Proxy(
    IMSMQMessage2 *This, VARIANT varDestSymmKey);
void __RPC_STUB IMSMQMessage2_put_DestinationSymmetricKey_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_get_Signature_Proxy(IMSMQMessage2 *This,
                                                 VARIANT *pvarSignature);
void __RPC_STUB IMSMQMessage2_get_Signature_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_put_Signature_Proxy(IMSMQMessage2 *This,
                                                 VARIANT varSignature);
void __RPC_STUB IMSMQMessage2_put_Signature_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_get_AuthenticationProviderType_Proxy(
    IMSMQMessage2 *This, __LONG32 *plAuthProvType);
void __RPC_STUB IMSMQMessage2_get_AuthenticationProviderType_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_put_AuthenticationProviderType_Proxy(
    IMSMQMessage2 *This, __LONG32 lAuthProvType);
void __RPC_STUB IMSMQMessage2_put_AuthenticationProviderType_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_get_AuthenticationProviderName_Proxy(
    IMSMQMessage2 *This, BSTR *pbstrAuthProvName);
void __RPC_STUB IMSMQMessage2_get_AuthenticationProviderName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_put_AuthenticationProviderName_Proxy(
    IMSMQMessage2 *This, BSTR bstrAuthProvName);
void __RPC_STUB IMSMQMessage2_put_AuthenticationProviderName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_put_SenderId_Proxy(IMSMQMessage2 *This,
                                                VARIANT varSenderId);
void __RPC_STUB IMSMQMessage2_put_SenderId_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_get_MsgClass_Proxy(IMSMQMessage2 *This,
                                                __LONG32 *plMsgClass);
void __RPC_STUB IMSMQMessage2_get_MsgClass_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_put_MsgClass_Proxy(IMSMQMessage2 *This,
                                                __LONG32 lMsgClass);
void __RPC_STUB IMSMQMessage2_put_MsgClass_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_get_Properties_Proxy(IMSMQMessage2 *This,
                                                  IDispatch **ppcolProperties);
void __RPC_STUB IMSMQMessage2_get_Properties_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_get_TransactionId_Proxy(IMSMQMessage2 *This,
                                                     VARIANT *pvarXactId);
void __RPC_STUB IMSMQMessage2_get_TransactionId_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_get_IsFirstInTransaction_Proxy(
    IMSMQMessage2 *This, Boolean *pisFirstInXact);
void __RPC_STUB IMSMQMessage2_get_IsFirstInTransaction_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_get_IsLastInTransaction_Proxy(
    IMSMQMessage2 *This, Boolean *pisLastInXact);
void __RPC_STUB IMSMQMessage2_get_IsLastInTransaction_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_get_ResponseQueueInfo_Proxy(
    IMSMQMessage2 *This, IMSMQQueueInfo2 **ppqinfoResponse);
void __RPC_STUB IMSMQMessage2_get_ResponseQueueInfo_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_putref_ResponseQueueInfo_Proxy(
    IMSMQMessage2 *This, IMSMQQueueInfo2 *pqinfoResponse);
void __RPC_STUB IMSMQMessage2_putref_ResponseQueueInfo_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_get_AdminQueueInfo_Proxy(
    IMSMQMessage2 *This, IMSMQQueueInfo2 **ppqinfoAdmin);
void __RPC_STUB IMSMQMessage2_get_AdminQueueInfo_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage2_putref_AdminQueueInfo_Proxy(
    IMSMQMessage2 *This, IMSMQQueueInfo2 *pqinfoAdmin);
...
public:
  ...
  virtual HRESULT WINAPI get_ArrivedTime(VARIANT *plArrivedTime) = 0;
  virtual HRESULT WINAPI
  get_DestinationQueueInfo(IMSMQQueueInfo3 **ppqinfoDest) = 0;
  virtual HRESULT WINAPI get_SenderCertificate(VARIANT *pvarSenderCert) = 0;
  virtual HRESULT WINAPI put_SenderCertificate(VARIANT varSenderCert) = 0;
  virtual HRESULT WINAPI get_SenderId(VARIANT *pvarSenderId) = 0;
  virtual HRESULT WINAPI get_SenderIdType(__LONG32 *plSenderIdType) = 0;
  virtual HRESULT WINAPI put_SenderIdType(__LONG32 lSenderIdType) = 0;
  virtual HRESULT WINAPI Send(IDispatch *DestinationQueue,
                              VARIANT *Transaction) = 0;
  virtual HRESULT WINAPI AttachCurrentSecurityContext(void) = 0;
  virtual HRESULT WINAPI get_SenderVersion(__LONG32 *plSenderVersion) = 0;
  virtual HRESULT WINAPI get_Extension(VARIANT *pvarExtension) = 0;
  ...
  virtual HRESULT WINAPI put_ConnectorTypeGuid(BSTR bstrGuidConnectorType) = 0;
  virtual HRESULT WINAPI
  get_TransactionStatusQueueInfo(IMSMQQueueInfo3 **ppqinfoXactStatus) = 0;
  virtual HRESULT WINAPI
  get_DestinationSymmetricKey(VARIANT *pvarDestSymmKey) = 0;
  virtual HRESULT WINAPI
  put_DestinationSymmetricKey(VARIANT varDestSymmKey) = 0;
  ...
  virtual HRESULT WINAPI get_IsLastInTransaction(Boolean *pisLastInXact) = 0;
  virtual HRESULT WINAPI
  get_ResponseQueueInfo_v2(IMSMQQueueInfo2 **ppqinfoResponse) = 0;
  virtual HRESULT WINAPI
  putref_ResponseQueueInfo_v2(IMSMQQueueInfo2 *pqinfoResponse) = 0;
  virtual HRESULT WINAPI
  get_AdminQueueInfo_v2(IMSMQQueueInfo2 **ppqinfoAdmin) = 0;
  virtual HRESULT WINAPI
  putref_AdminQueueInfo_v2(IMSMQQueueInfo2 *pqinfoAdmin) = 0;
  virtual HRESULT WINAPI
  get_ReceivedAuthenticationLevel(short *psReceivedAuthenticationLevel) = 0;
  virtual HRESULT WINAPI
  get_ResponseQueueInfo(IMSMQQueueInfo3 **ppqinfoResponse) = 0;
  virtual HRESULT WINAPI
  putref_ResponseQueueInfo(IMSMQQueueInfo3 *pqinfoResponse) = 0;
  virtual HRESULT WINAPI get_AdminQueueInfo(IMSMQQueueInfo3 **ppqinfoAdmin) = 0;
  virtual HRESULT WINAPI
  putref_AdminQueueInfo(IMSMQQueueInfo3 *pqinfoAdmin) = 0;
  virtual HRESULT WINAPI
  get_ResponseDestination(IDispatch **ppdestResponse) = 0;
  virtual HRESULT WINAPI
  putref_ResponseDestination(IDispatch *pdestResponse) = 0;
  ...
  virtual HRESULT WINAPI
  get_IsAuthenticated2(VARIANT_BOOL *pisAuthenticated) = 0;
  virtual HRESULT WINAPI
  get_IsFirstInTransaction2(VARIANT_BOOL *pisFirstInXact) = 0;
  virtual HRESULT WINAPI
  get_IsLastInTransaction2(VARIANT_BOOL *pisLastInXact) = 0;
...
typedef struct IMSMQMessage3Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMSMQMessage3 *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IMSMQMessage3 *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IMSMQMessage3 *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IMSMQMessage3 *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  ...
  HRESULT(WINAPI *get_IsAuthenticated)(IMSMQMessage3 *This,
                                       Boolean *pisAuthenticated);
  ...
  HRESULT(WINAPI *get_ResponseQueueInfo_v1)(IMSMQMessage3 *This,
                                            IMSMQQueueInfo **ppqinfoResponse);
  HRESULT(WINAPI *putref_ResponseQueueInfo_v1)(IMSMQMessage3 *This,
                                               IMSMQQueueInfo *pqinfoResponse);
  HRESULT(WINAPI *get_AppSpecific)(IMSMQMessage3 *This,
                                   __LONG32 *plAppSpecific);
  HRESULT(WINAPI *put_AppSpecific)(IMSMQMessage3 *This, __LONG32 lAppSpecific);
  HRESULT(WINAPI *get_SourceMachineGuid)(IMSMQMessage3 *This,
                                         BSTR *pbstrGuidSrcMachine);
  ...
  HRESULT(WINAPI *get_AdminQueueInfo_v1)(IMSMQMessage3 *This,
                                         IMSMQQueueInfo **ppqinfoAdmin);
  HRESULT(WINAPI *putref_AdminQueueInfo_v1)(IMSMQMessage3 *This,
                                            IMSMQQueueInfo *pqinfoAdmin);
  ...
  HRESULT(WINAPI *get_MaxTimeToReachQueue)(IMSMQMessage3 *This,
                                           __LONG32 *plMaxTimeToReachQueue);
  HRESULT(WINAPI *put_MaxTimeToReachQueue)(IMSMQMessage3 *This,
                                           __LONG32 lMaxTimeToReachQueue);
  HRESULT(WINAPI *get_MaxTimeToReceive)(IMSMQMessage3 *This,
                                        __LONG32 *plMaxTimeToReceive);
  HRESULT(WINAPI *put_MaxTimeToReceive)(IMSMQMessage3 *This,
                                        __LONG32 lMaxTimeToReceive);
  ...
  HRESULT(WINAPI *get_EncryptAlgorithm)(IMSMQMessage3 *This,
                                        __LONG32 *plEncryptAlg);
  HRESULT(WINAPI *put_EncryptAlgorithm)(IMSMQMessage3 *This,
                                        __LONG32 lEncryptAlg);
  ...
  HRESULT(WINAPI *get_DestinationQueueInfo)(IMSMQMessage3 *This,
                                            IMSMQQueueInfo3 **ppqinfoDest);
  HRESULT(WINAPI *get_SenderCertificate)(IMSMQMessage3 *This,
                                         VARIANT *pvarSenderCert);
  HRESULT(WINAPI *put_SenderCertificate)(IMSMQMessage3 *This,
                                         VARIANT varSenderCert);
  HRESULT(WINAPI *get_SenderId)(IMSMQMessage3 *This, VARIANT *pvarSenderId);
  HRESULT(WINAPI *get_SenderIdType)(IMSMQMessage3 *This,
                                    __LONG32 *plSenderIdType);
  HRESULT(WINAPI *put_SenderIdType)(IMSMQMessage3 *This,
                                    __LONG32 lSenderIdType);
  HRESULT(WINAPI *Send)(IMSMQMessage3 *This, IDispatch *DestinationQueue,
                        VARIANT *Transaction);
  HRESULT(WINAPI *AttachCurrentSecurityContext)(IMSMQMessage3 *This);
  HRESULT(WINAPI *get_SenderVersion)(IMSMQMessage3 *This,
                                     __LONG32 *plSenderVersion);
  ...
  HRESULT(WINAPI *get_ConnectorTypeGuid)(IMSMQMessage3 *This,
                                         BSTR *pbstrGuidConnectorType);
  HRESULT(WINAPI *put_ConnectorTypeGuid)(IMSMQMessage3 *This,
                                         BSTR bstrGuidConnectorType);
  HRESULT(WINAPI *get_TransactionStatusQueueInfo)(
      IMSMQMessage3 *This, IMSMQQueueInfo3 **ppqinfoXactStatus);
  HRESULT(WINAPI *get_DestinationSymmetricKey)(IMSMQMessage3 *This,
                                               VARIANT *pvarDestSymmKey);
  HRESULT(WINAPI *put_DestinationSymmetricKey)(IMSMQMessage3 *This,
                                               VARIANT varDestSymmKey);
  ...
  HRESULT(WINAPI *get_AuthenticationProviderType)(IMSMQMessage3 *This,
                                                  __LONG32 *plAuthProvType);
  HRESULT(WINAPI *put_AuthenticationProviderType)(IMSMQMessage3 *This,
                                                  __LONG32 lAuthProvType);
  HRESULT(WINAPI *get_AuthenticationProviderName)(IMSMQMessage3 *This,
                                                  BSTR *pbstrAuthProvName);
  HRESULT(WINAPI *put_AuthenticationProviderName)(IMSMQMessage3 *This,
                                                  BSTR bstrAuthProvName);
  ...
  HRESULT(WINAPI *get_Properties)(IMSMQMessage3 *This,
                                  IDispatch **ppcolProperties);
  HRESULT(WINAPI *get_TransactionId)(IMSMQMessage3 *This, VARIANT *pvarXactId);
  HRESULT(WINAPI *get_IsFirstInTransaction)(IMSMQMessage3 *This,
                                            Boolean *pisFirstInXact);
  HRESULT(WINAPI *get_IsLastInTransaction)(IMSMQMessage3 *This,
                                           Boolean *pisLastInXact);
  HRESULT(WINAPI *get_ResponseQueueInfo_v2)(IMSMQMessage3 *This,
                                            IMSMQQueueInfo2 **ppqinfoResponse);
  HRESULT(WINAPI *putref_ResponseQueueInfo_v2)(IMSMQMessage3 *This,
                                               IMSMQQueueInfo2 *pqinfoResponse);
  HRESULT(WINAPI *get_AdminQueueInfo_v2)(IMSMQMessage3 *This,
                                         IMSMQQueueInfo2 **ppqinfoAdmin);
  HRESULT(WINAPI *putref_AdminQueueInfo_v2)(IMSMQMessage3 *This,
                                            IMSMQQueueInfo2 *pqinfoAdmin);
  HRESULT(WINAPI *get_ReceivedAuthenticationLevel)(
      IMSMQMessage3 *This, short *psReceivedAuthenticationLevel);
  HRESULT(WINAPI *get_ResponseQueueInfo)(IMSMQMessage3 *This,
                                         IMSMQQueueInfo3 **ppqinfoResponse);
  HRESULT(WINAPI *putref_ResponseQueueInfo)(IMSMQMessage3 *This,
                                            IMSMQQueueInfo3 *pqinfoResponse);
  HRESULT(WINAPI *get_AdminQueueInfo)(IMSMQMessage3 *This,
                                      IMSMQQueueInfo3 **ppqinfoAdmin);
  HRESULT(WINAPI *putref_AdminQueueInfo)(IMSMQMessage3 *This,
                                         IMSMQQueueInfo3 *pqinfoAdmin);
  HRESULT(WINAPI *get_ResponseDestination)(IMSMQMessage3 *This,
                                           IDispatch **ppdestResponse);
  HRESULT(WINAPI *putref_ResponseDestination)(IMSMQMessage3 *This,
                                              IDispatch *pdestResponse);
  HRESULT(WINAPI *get_Destination)(IMSMQMessage3 *This,
                                   IDispatch **ppdestDestination);
  HRESULT(WINAPI *get_LookupId)(IMSMQMessage3 *This, VARIANT *pvarLookupId);
  HRESULT(WINAPI *get_IsAuthenticated2)(IMSMQMessage3 *This,
                                        VARIANT_BOOL *pisAuthenticated);
  HRESULT(WINAPI *get_IsFirstInTransaction2)(IMSMQMessage3 *This,
                                             VARIANT_BOOL *pisFirstInXact);
  HRESULT(WINAPI *get_IsLastInTransaction2)(IMSMQMessage3 *This,
                                            VARIANT_BOOL *pisLastInXact);
  HRESULT(WINAPI *AttachCurrentSecurityContext2)(IMSMQMessage3 *This);
  HRESULT(WINAPI *get_SoapEnvelope)(IMSMQMessage3 *This,
                                    BSTR *pbstrSoapEnvelope);
  HRESULT(WINAPI *get_CompoundMessage)(IMSMQMessage3 *This,
                                       VARIANT *pvarCompoundMessage);
...
#define IMSMQMessage3_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                 \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IMSMQMessage3_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,       \
                                    rgDispId)                                  \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IMSMQMessage3_Invoke(This, dispIdMember, riid, lcid, wFlags,           \
                             pDispParams, pVarResult, pExcepInfo, puArgErr)    \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#define IMSMQMessage3_get_ReceivedAuthenticationLevel(                         \
    This, psReceivedAuthenticationLevel)                                       \
  (This)->lpVtbl->get_ReceivedAuthenticationLevel(                             \
      This, psReceivedAuthenticationLevel)
...
#endif
#endif
HRESULT WINAPI IMSMQMessage3_get_Class_Proxy(IMSMQMessage3 *This,
                                             __LONG32 *plClass);
void __RPC_STUB IMSMQMessage3_get_Class_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_PrivLevel_Proxy(IMSMQMessage3 *This,
                                                 __LONG32 *plPrivLevel);
void __RPC_STUB IMSMQMessage3_get_PrivLevel_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_put_PrivLevel_Proxy(IMSMQMessage3 *This,
                                                 __LONG32 lPrivLevel);
void __RPC_STUB IMSMQMessage3_put_PrivLevel_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_AuthLevel_Proxy(IMSMQMessage3 *This,
                                                 __LONG32 *plAuthLevel);
void __RPC_STUB IMSMQMessage3_get_AuthLevel_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_put_AuthLevel_Proxy(IMSMQMessage3 *This,
                                                 __LONG32 lAuthLevel);
void __RPC_STUB IMSMQMessage3_put_AuthLevel_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_IsAuthenticated_Proxy(
    IMSMQMessage3 *This, Boolean *pisAuthenticated);
void __RPC_STUB IMSMQMessage3_get_IsAuthenticated_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_Delivery_Proxy(IMSMQMessage3 *This,
                                                __LONG32 *plDelivery);
void __RPC_STUB IMSMQMessage3_get_Delivery_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_put_Delivery_Proxy(IMSMQMessage3 *This,
                                                __LONG32 lDelivery);
void __RPC_STUB IMSMQMessage3_put_Delivery_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_Trace_Proxy(IMSMQMessage3 *This,
                                             __LONG32 *plTrace);
void __RPC_STUB IMSMQMessage3_get_Trace_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_put_Trace_Proxy(IMSMQMessage3 *This,
                                             __LONG32 lTrace);
void __RPC_STUB IMSMQMessage3_put_Trace_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_Priority_Proxy(IMSMQMessage3 *This,
                                                __LONG32 *plPriority);
void __RPC_STUB IMSMQMessage3_get_Priority_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_put_Priority_Proxy(IMSMQMessage3 *This,
                                                __LONG32 lPriority);
void __RPC_STUB IMSMQMessage3_put_Priority_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_Journal_Proxy(IMSMQMessage3 *This,
                                               __LONG32 *plJournal);
void __RPC_STUB IMSMQMessage3_get_Journal_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_put_Journal_Proxy(IMSMQMessage3 *This,
                                               __LONG32 lJournal);
void __RPC_STUB IMSMQMessage3_put_Journal_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_ResponseQueueInfo_v1_Proxy(
    IMSMQMessage3 *This, IMSMQQueueInfo **ppqinfoResponse);
void __RPC_STUB IMSMQMessage3_get_ResponseQueueInfo_v1_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_putref_ResponseQueueInfo_v1_Proxy(
    IMSMQMessage3 *This, IMSMQQueueInfo *pqinfoResponse);
void __RPC_STUB IMSMQMessage3_putref_ResponseQueueInfo_v1_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_AppSpecific_Proxy(IMSMQMessage3 *This,
                                                   __LONG32 *plAppSpecific);
void __RPC_STUB IMSMQMessage3_get_AppSpecific_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_put_AppSpecific_Proxy(IMSMQMessage3 *This,
                                                   __LONG32 lAppSpecific);
void __RPC_STUB IMSMQMessage3_put_AppSpecific_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_SourceMachineGuid_Proxy(
    IMSMQMessage3 *This, BSTR *pbstrGuidSrcMachine);
void __RPC_STUB IMSMQMessage3_get_SourceMachineGuid_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_BodyLength_Proxy(IMSMQMessage3 *This,
                                                  __LONG32 *pcbBody);
void __RPC_STUB IMSMQMessage3_get_BodyLength_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_Body_Proxy(IMSMQMessage3 *This,
                                            VARIANT *pvarBody);
void __RPC_STUB IMSMQMessage3_get_Body_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_put_Body_Proxy(IMSMQMessage3 *This,
                                            VARIANT varBody);
void __RPC_STUB IMSMQMessage3_put_Body_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_AdminQueueInfo_v1_Proxy(
    IMSMQMessage3 *This, IMSMQQueueInfo **ppqinfoAdmin);
void __RPC_STUB IMSMQMessage3_get_AdminQueueInfo_v1_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_putref_AdminQueueInfo_v1_Proxy(
    IMSMQMessage3 *This, IMSMQQueueInfo *pqinfoAdmin);
void __RPC_STUB IMSMQMessage3_putref_AdminQueueInfo_v1_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_Id_Proxy(IMSMQMessage3 *This,
                                          VARIANT *pvarMsgId);
void __RPC_STUB IMSMQMessage3_get_Id_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_CorrelationId_Proxy(IMSMQMessage3 *This,
                                                     VARIANT *pvarMsgId);
void __RPC_STUB IMSMQMessage3_get_CorrelationId_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_put_CorrelationId_Proxy(IMSMQMessage3 *This,
                                                     VARIANT varMsgId);
void __RPC_STUB IMSMQMessage3_put_CorrelationId_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_Ack_Proxy(IMSMQMessage3 *This,
                                           __LONG32 *plAck);
...
void __RPC_STUB IMSMQMessage3_put_Ack_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_Label_Proxy(IMSMQMessage3 *This,
                                             BSTR *pbstrLabel);
void __RPC_STUB IMSMQMessage3_get_Label_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_put_Label_Proxy(IMSMQMessage3 *This,
                                             BSTR bstrLabel);
void __RPC_STUB IMSMQMessage3_put_Label_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_MaxTimeToReachQueue_Proxy(
    IMSMQMessage3 *This, __LONG32 *plMaxTimeToReachQueue);
void __RPC_STUB IMSMQMessage3_get_MaxTimeToReachQueue_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_put_MaxTimeToReachQueue_Proxy(
    IMSMQMessage3 *This, __LONG32 lMaxTimeToReachQueue);
void __RPC_STUB IMSMQMessage3_put_MaxTimeToReachQueue_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_MaxTimeToReceive_Proxy(
    IMSMQMessage3 *This, __LONG32 *plMaxTimeToReceive);
void __RPC_STUB IMSMQMessage3_get_MaxTimeToReceive_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_put_MaxTimeToReceive_Proxy(
    IMSMQMessage3 *This, __LONG32 lMaxTimeToReceive);
void __RPC_STUB IMSMQMessage3_put_MaxTimeToReceive_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_HashAlgorithm_Proxy(IMSMQMessage3 *This,
                                                     __LONG32 *plHashAlg);
void __RPC_STUB IMSMQMessage3_get_HashAlgorithm_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_put_HashAlgorithm_Proxy(IMSMQMessage3 *This,
                                                     __LONG32 lHashAlg);
void __RPC_STUB IMSMQMessage3_put_HashAlgorithm_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_EncryptAlgorithm_Proxy(IMSMQMessage3 *This,
                                                        __LONG32 *plEncryptAlg);
void __RPC_STUB IMSMQMessage3_get_EncryptAlgorithm_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_put_EncryptAlgorithm_Proxy(IMSMQMessage3 *This,
                                                        __LONG32 lEncryptAlg);
void __RPC_STUB IMSMQMessage3_put_EncryptAlgorithm_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_SentTime_Proxy(IMSMQMessage3 *This,
                                                VARIANT *pvarSentTime);
void __RPC_STUB IMSMQMessage3_get_SentTime_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_ArrivedTime_Proxy(IMSMQMessage3 *This,
                                                   VARIANT *plArrivedTime);
void __RPC_STUB IMSMQMessage3_get_ArrivedTime_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_DestinationQueueInfo_Proxy(
    IMSMQMessage3 *This, IMSMQQueueInfo3 **ppqinfoDest);
void __RPC_STUB IMSMQMessage3_get_DestinationQueueInfo_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_SenderCertificate_Proxy(
    IMSMQMessage3 *This, VARIANT *pvarSenderCert);
void __RPC_STUB IMSMQMessage3_get_SenderCertificate_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_put_SenderCertificate_Proxy(IMSMQMessage3 *This,
                                                         VARIANT varSenderCert);
void __RPC_STUB IMSMQMessage3_put_SenderCertificate_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_SenderId_Proxy(IMSMQMessage3 *This,
                                                VARIANT *pvarSenderId);
void __RPC_STUB IMSMQMessage3_get_SenderId_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_SenderIdType_Proxy(IMSMQMessage3 *This,
                                                    __LONG32 *plSenderIdType);
void __RPC_STUB IMSMQMessage3_get_SenderIdType_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_put_SenderIdType_Proxy(IMSMQMessage3 *This,
                                                    __LONG32 lSenderIdType);
void __RPC_STUB IMSMQMessage3_put_SenderIdType_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_Send_Proxy(IMSMQMessage3 *This,
                                        IDispatch *DestinationQueue,
                                        VARIANT *Transaction);
void __RPC_STUB IMSMQMessage3_Send_Stub(IRpcStubBuffer *This,
                                        IRpcChannelBuffer *_pRpcChannelBuffer,
                                        PRPC_MESSAGE _pRpcMessage,
                                        DWORD *_pdwStubPhase);
HRESULT WINAPI
IMSMQMessage3_AttachCurrentSecurityContext_Proxy(IMSMQMessage3 *This);
void __RPC_STUB IMSMQMessage3_AttachCurrentSecurityContext_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_SenderVersion_Proxy(IMSMQMessage3 *This,
                                                     __LONG32 *plSenderVersion);
void __RPC_STUB IMSMQMessage3_get_SenderVersion_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_Extension_Proxy(IMSMQMessage3 *This,
                                                 VARIANT *pvarExtension);
void __RPC_STUB IMSMQMessage3_get_Extension_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_put_Extension_Proxy(IMSMQMessage3 *This,
                                                 VARIANT varExtension);
void __RPC_STUB IMSMQMessage3_put_Extension_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_ConnectorTypeGuid_Proxy(
    IMSMQMessage3 *This, BSTR *pbstrGuidConnectorType);
void __RPC_STUB IMSMQMessage3_get_ConnectorTypeGuid_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_put_ConnectorTypeGuid_Proxy(
    IMSMQMessage3 *This, BSTR bstrGuidConnectorType);
void __RPC_STUB IMSMQMessage3_put_ConnectorTypeGuid_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_TransactionStatusQueueInfo_Proxy(
    IMSMQMessage3 *This, IMSMQQueueInfo3 **ppqinfoXactStatus);
void __RPC_STUB IMSMQMessage3_get_TransactionStatusQueueInfo_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_DestinationSymmetricKey_Proxy(
    IMSMQMessage3 *This, VARIANT *pvarDestSymmKey);
void __RPC_STUB IMSMQMessage3_get_DestinationSymmetricKey_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_put_DestinationSymmetricKey_Proxy(
    IMSMQMessage3 *This, VARIANT varDestSymmKey);
void __RPC_STUB IMSMQMessage3_put_DestinationSymmetricKey_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_Signature_Proxy(IMSMQMessage3 *This,
                                                 VARIANT *pvarSignature);
void __RPC_STUB IMSMQMessage3_get_Signature_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_put_Signature_Proxy(IMSMQMessage3 *This,
                                                 VARIANT varSignature);
void __RPC_STUB IMSMQMessage3_put_Signature_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_AuthenticationProviderType_Proxy(
    IMSMQMessage3 *This, __LONG32 *plAuthProvType);
void __RPC_STUB IMSMQMessage3_get_AuthenticationProviderType_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_put_AuthenticationProviderType_Proxy(
    IMSMQMessage3 *This, __LONG32 lAuthProvType);
void __RPC_STUB IMSMQMessage3_put_AuthenticationProviderType_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_AuthenticationProviderName_Proxy(
    IMSMQMessage3 *This, BSTR *pbstrAuthProvName);
void __RPC_STUB IMSMQMessage3_get_AuthenticationProviderName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_put_AuthenticationProviderName_Proxy(
    IMSMQMessage3 *This, BSTR bstrAuthProvName);
void __RPC_STUB IMSMQMessage3_put_AuthenticationProviderName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_put_SenderId_Proxy(IMSMQMessage3 *This,
                                                VARIANT varSenderId);
void __RPC_STUB IMSMQMessage3_put_SenderId_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_MsgClass_Proxy(IMSMQMessage3 *This,
                                                __LONG32 *plMsgClass);
void __RPC_STUB IMSMQMessage3_get_MsgClass_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_put_MsgClass_Proxy(IMSMQMessage3 *This,
                                                __LONG32 lMsgClass);
void __RPC_STUB IMSMQMessage3_put_MsgClass_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_Properties_Proxy(IMSMQMessage3 *This,
                                                  IDispatch **ppcolProperties);
void __RPC_STUB IMSMQMessage3_get_Properties_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_TransactionId_Proxy(IMSMQMessage3 *This,
                                                     VARIANT *pvarXactId);
void __RPC_STUB IMSMQMessage3_get_TransactionId_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_IsFirstInTransaction_Proxy(
    IMSMQMessage3 *This, Boolean *pisFirstInXact);
void __RPC_STUB IMSMQMessage3_get_IsFirstInTransaction_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_IsLastInTransaction_Proxy(
    IMSMQMessage3 *This, Boolean *pisLastInXact);
void __RPC_STUB IMSMQMessage3_get_IsLastInTransaction_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_ResponseQueueInfo_v2_Proxy(
    IMSMQMessage3 *This, IMSMQQueueInfo2 **ppqinfoResponse);
void __RPC_STUB IMSMQMessage3_get_ResponseQueueInfo_v2_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_putref_ResponseQueueInfo_v2_Proxy(
    IMSMQMessage3 *This, IMSMQQueueInfo2 *pqinfoResponse);
void __RPC_STUB IMSMQMessage3_putref_ResponseQueueInfo_v2_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_AdminQueueInfo_v2_Proxy(
    IMSMQMessage3 *This, IMSMQQueueInfo2 **ppqinfoAdmin);
void __RPC_STUB IMSMQMessage3_get_AdminQueueInfo_v2_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_putref_AdminQueueInfo_v2_Proxy(
    IMSMQMessage3 *This, IMSMQQueueInfo2 *pqinfoAdmin);
void __RPC_STUB IMSMQMessage3_putref_AdminQueueInfo_v2_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_ReceivedAuthenticationLevel_Proxy(
    IMSMQMessage3 *This, short *psReceivedAuthenticationLevel);
void __RPC_STUB IMSMQMessage3_get_ReceivedAuthenticationLevel_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_ResponseQueueInfo_Proxy(
    IMSMQMessage3 *This, IMSMQQueueInfo3 **ppqinfoResponse);
void __RPC_STUB IMSMQMessage3_get_ResponseQueueInfo_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_putref_ResponseQueueInfo_Proxy(
    IMSMQMessage3 *This, IMSMQQueueInfo3 *pqinfoResponse);
void __RPC_STUB IMSMQMessage3_putref_ResponseQueueInfo_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_AdminQueueInfo_Proxy(
    IMSMQMessage3 *This, IMSMQQueueInfo3 **ppqinfoAdmin);
void __RPC_STUB IMSMQMessage3_get_AdminQueueInfo_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_putref_AdminQueueInfo_Proxy(
    IMSMQMessage3 *This, IMSMQQueueInfo3 *pqinfoAdmin);
void __RPC_STUB IMSMQMessage3_putref_AdminQueueInfo_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_ResponseDestination_Proxy(
    IMSMQMessage3 *This, IDispatch **ppdestResponse);
void __RPC_STUB IMSMQMessage3_get_ResponseDestination_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_putref_ResponseDestination_Proxy(
    IMSMQMessage3 *This, IDispatch *pdestResponse);
void __RPC_STUB IMSMQMessage3_putref_ResponseDestination_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_Destination_Proxy(
    IMSMQMessage3 *This, IDispatch **ppdestDestination);
void __RPC_STUB IMSMQMessage3_get_Destination_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_LookupId_Proxy(IMSMQMessage3 *This,
                                                VARIANT *pvarLookupId);
void __RPC_STUB IMSMQMessage3_get_LookupId_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_IsAuthenticated2_Proxy(
    IMSMQMessage3 *This, VARIANT_BOOL *pisAuthenticated);
void __RPC_STUB IMSMQMessage3_get_IsAuthenticated2_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_IsFirstInTransaction2_Proxy(
    IMSMQMessage3 *This, VARIANT_BOOL *pisFirstInXact);
void __RPC_STUB IMSMQMessage3_get_IsFirstInTransaction2_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_IsLastInTransaction2_Proxy(
    IMSMQMessage3 *This, VARIANT_BOOL *pisLastInXact);
void __RPC_STUB IMSMQMessage3_get_IsLastInTransaction2_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
IMSMQMessage3_AttachCurrentSecurityContext2_Proxy(IMSMQMessage3 *This);
void __RPC_STUB IMSMQMessage3_AttachCurrentSecurityContext2_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_SoapEnvelope_Proxy(IMSMQMessage3 *This,
                                                    BSTR *pbstrSoapEnvelope);
void __RPC_STUB IMSMQMessage3_get_SoapEnvelope_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_get_CompoundMessage_Proxy(
    IMSMQMessage3 *This, VARIANT *pvarCompoundMessage);
void __RPC_STUB IMSMQMessage3_get_CompoundMessage_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_put_SoapHeader_Proxy(IMSMQMessage3 *This,
                                                  BSTR bstrSoapHeader);
void __RPC_STUB IMSMQMessage3_put_SoapHeader_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQMessage3_put_SoapBody_Proxy(IMSMQMessage3 *This,
                                                BSTR bstrSoapBody);
...
public:
  ...
  virtual HRESULT WINAPI Peek_v1(VARIANT *WantDestinationQueue,
                                 VARIANT *WantBody, VARIANT *ReceiveTimeout,
                                 IMSMQMessage **ppmsg) = 0;
  virtual HRESULT WINAPI EnableNotification(IMSMQEvent3 *Event, VARIANT *Cursor,
                                            VARIANT *ReceiveTimeout) = 0;
  virtual HRESULT WINAPI Reset(void) = 0;
  virtual HRESULT WINAPI ReceiveCurrent_v1(VARIANT *Transaction,
                                           VARIANT *WantDestinationQueue,
  ...
  virtual HRESULT WINAPI ReceiveByLookupId(
      VARIANT LookupId, VARIANT *Transaction, VARIANT *WantDestinationQueue,
      VARIANT *WantBody, VARIANT *WantConnectorType, IMSMQMessage3 **ppmsg) = 0;
  virtual HRESULT WINAPI ReceiveNextByLookupId(
      VARIANT LookupId, VARIANT *Transaction, VARIANT *WantDestinationQueue,
      VARIANT *WantBody, VARIANT *WantConnectorType, IMSMQMessage3 **ppmsg) = 0;
  virtual HRESULT WINAPI ReceivePreviousByLookupId(
      VARIANT LookupId, VARIANT *Transaction, VARIANT *WantDestinationQueue,
      VARIANT *WantBody, VARIANT *WantConnectorType, IMSMQMessage3 **ppmsg) = 0;
  virtual HRESULT WINAPI ReceiveFirstByLookupId(VARIANT *Transaction,
                                                VARIANT *WantDestinationQueue,
                                                VARIANT *WantBody,
                                                VARIANT *WantConnectorType,
                                                IMSMQMessage3 **ppmsg) = 0;
  virtual HRESULT WINAPI ReceiveLastByLookupId(VARIANT *Transaction,
                                               VARIANT *WantDestinationQueue,
                                               VARIANT *WantBody,
                                               VARIANT *WantConnectorType,
                                               IMSMQMessage3 **ppmsg) = 0;
  virtual HRESULT WINAPI PeekByLookupId(VARIANT LookupId,
                                        VARIANT *WantDestinationQueue,
                                        VARIANT *WantBody,
                                        VARIANT *WantConnectorType,
                                        IMSMQMessage3 **ppmsg) = 0;
  virtual HRESULT WINAPI PeekNextByLookupId(VARIANT LookupId,
                                            VARIANT *WantDestinationQueue,
                                            VARIANT *WantBody,
                                            VARIANT *WantConnectorType,
                                            IMSMQMessage3 **ppmsg) = 0;
  virtual HRESULT WINAPI PeekPreviousByLookupId(VARIANT LookupId,
                                                VARIANT *WantDestinationQueue,
                                                VARIANT *WantBody,
                                                VARIANT *WantConnectorType,
                                                IMSMQMessage3 **ppmsg) = 0;
  virtual HRESULT WINAPI PeekFirstByLookupId(VARIANT *WantDestinationQueue,
                                             VARIANT *WantBody,
                                             VARIANT *WantConnectorType,
                                             IMSMQMessage3 **ppmsg) = 0;
  virtual HRESULT WINAPI PeekLastByLookupId(VARIANT *WantDestinationQueue,
                                            VARIANT *WantBody,
                                            VARIANT *WantConnectorType,
                                            IMSMQMessage3 **ppmsg) = 0;
...
typedef struct IMSMQQueue3Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMSMQQueue3 *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IMSMQQueue3 *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IMSMQQueue3 *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IMSMQQueue3 *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  ...
  HRESULT(WINAPI *Receive_v1)(IMSMQQueue3 *This, VARIANT *Transaction,
                              VARIANT *WantDestinationQueue, VARIANT *WantBody,
                              VARIANT *ReceiveTimeout, IMSMQMessage **ppmsg);
  HRESULT(WINAPI *Peek_v1)(IMSMQQueue3 *This, VARIANT *WantDestinationQueue,
                           VARIANT *WantBody, VARIANT *ReceiveTimeout,
                           IMSMQMessage **ppmsg);
  HRESULT(WINAPI *EnableNotification)(IMSMQQueue3 *This, IMSMQEvent3 *Event,
                                      VARIANT *Cursor, VARIANT *ReceiveTimeout);
  HRESULT(WINAPI *Reset)(IMSMQQueue3 *This);
  HRESULT(WINAPI *ReceiveCurrent_v1)(IMSMQQueue3 *This, VARIANT *Transaction,
                                     VARIANT *WantDestinationQueue,
                                     VARIANT *WantBody, VARIANT *ReceiveTimeout,
                                     IMSMQMessage **ppmsg);
  HRESULT(WINAPI *PeekNext_v1)(IMSMQQueue3 *This, VARIANT *WantDestinationQueue,
                               VARIANT *WantBody, VARIANT *ReceiveTimeout,
                               IMSMQMessage **ppmsg);
  HRESULT(WINAPI *PeekCurrent_v1)(IMSMQQueue3 *This,
                                  VARIANT *WantDestinationQueue,
                                  VARIANT *WantBody, VARIANT *ReceiveTimeout,
                                  IMSMQMessage **ppmsg);
  HRESULT(WINAPI *Receive)(IMSMQQueue3 *This, VARIANT *Transaction,
                           VARIANT *WantDestinationQueue, VARIANT *WantBody,
                           VARIANT *ReceiveTimeout, VARIANT *WantConnectorType,
                           IMSMQMessage3 **ppmsg);
  HRESULT(WINAPI *Peek)(IMSMQQueue3 *This, VARIANT *WantDestinationQueue,
                        VARIANT *WantBody, VARIANT *ReceiveTimeout,
                        VARIANT *WantConnectorType, IMSMQMessage3 **ppmsg);
  HRESULT(WINAPI *ReceiveCurrent)(IMSMQQueue3 *This, VARIANT *Transaction,
                                  VARIANT *WantDestinationQueue,
                                  VARIANT *WantBody, VARIANT *ReceiveTimeout,
                                  VARIANT *WantConnectorType,
                                  IMSMQMessage3 **ppmsg);
  HRESULT(WINAPI *PeekNext)(IMSMQQueue3 *This, VARIANT *WantDestinationQueue,
                            VARIANT *WantBody, VARIANT *ReceiveTimeout,
                            VARIANT *WantConnectorType, IMSMQMessage3 **ppmsg);
  HRESULT(WINAPI *PeekCurrent)(IMSMQQueue3 *This, VARIANT *WantDestinationQueue,
                               VARIANT *WantBody, VARIANT *ReceiveTimeout,
                               VARIANT *WantConnectorType,
                               IMSMQMessage3 **ppmsg);
  HRESULT(WINAPI *get_Properties)(IMSMQQueue3 *This,
                                  IDispatch **ppcolProperties);
  HRESULT(WINAPI *get_Handle2)(IMSMQQueue3 *This, VARIANT *pvarHandle);
  HRESULT(WINAPI *ReceiveByLookupId)(IMSMQQueue3 *This, VARIANT LookupId,
                                     VARIANT *Transaction,
                                     VARIANT *WantDestinationQueue,
                                     VARIANT *WantBody,
                                     VARIANT *WantConnectorType,
                                     IMSMQMessage3 **ppmsg);
  HRESULT(WINAPI *ReceiveNextByLookupId)(IMSMQQueue3 *This, VARIANT LookupId,
                                         VARIANT *Transaction,
                                         VARIANT *WantDestinationQueue,
                                         VARIANT *WantBody,
                                         VARIANT *WantConnectorType,
                                         IMSMQMessage3 **ppmsg);
  HRESULT(WINAPI *ReceivePreviousByLookupId)(
      IMSMQQueue3 *This, VARIANT LookupId, VARIANT *Transaction,
      VARIANT *WantDestinationQueue, VARIANT *WantBody,
      VARIANT *WantConnectorType, IMSMQMessage3 **ppmsg);
  HRESULT(WINAPI *ReceiveFirstByLookupId)(
      IMSMQQueue3 *This, VARIANT *Transaction, VARIANT *WantDestinationQueue,
      VARIANT *WantBody, VARIANT *WantConnectorType, IMSMQMessage3 **ppmsg);
  HRESULT(WINAPI *ReceiveLastByLookupId)(
      IMSMQQueue3 *This, VARIANT *Transaction, VARIANT *WantDestinationQueue,
      VARIANT *WantBody, VARIANT *WantConnectorType, IMSMQMessage3 **ppmsg);
  HRESULT(WINAPI *PeekByLookupId)(IMSMQQueue3 *This, VARIANT LookupId,
                                  VARIANT *WantDestinationQueue,
                                  VARIANT *WantBody, VARIANT *WantConnectorType,
                                  IMSMQMessage3 **ppmsg);
  HRESULT(WINAPI *PeekNextByLookupId)(IMSMQQueue3 *This, VARIANT LookupId,
                                      VARIANT *WantDestinationQueue,
                                      VARIANT *WantBody,
                                      VARIANT *WantConnectorType,
                                      IMSMQMessage3 **ppmsg);
  HRESULT(WINAPI *PeekPreviousByLookupId)(IMSMQQueue3 *This, VARIANT LookupId,
                                          VARIANT *WantDestinationQueue,
                                          VARIANT *WantBody,
                                          VARIANT *WantConnectorType,
                                          IMSMQMessage3 **ppmsg);
  HRESULT(WINAPI *PeekFirstByLookupId)(IMSMQQueue3 *This,
                                       VARIANT *WantDestinationQueue,
                                       VARIANT *WantBody,
                                       VARIANT *WantConnectorType,
                                       IMSMQMessage3 **ppmsg);
  HRESULT(WINAPI *PeekLastByLookupId)(IMSMQQueue3 *This,
                                      VARIANT *WantDestinationQueue,
                                      VARIANT *WantBody,
                                      VARIANT *WantConnectorType,
                                      IMSMQMessage3 **ppmsg);
...
#define IMSMQQueue3_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                   \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IMSMQQueue3_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,         \
                                  rgDispId)                                    \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IMSMQQueue3_Invoke(This, dispIdMember, riid, lcid, wFlags,             \
                           pDispParams, pVarResult, pExcepInfo, puArgErr)      \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#define IMSMQQueue3_Receive_v1(This, Transaction, WantDestinationQueue,        \
                               WantBody, ReceiveTimeout, ppmsg)                \
  (This)->lpVtbl->Receive_v1(This, Transaction, WantDestinationQueue,          \
                             WantBody, ReceiveTimeout, ppmsg)
#define IMSMQQueue3_Peek_v1(This, WantDestinationQueue, WantBody,              \
                            ReceiveTimeout, ppmsg)                             \
  (This)->lpVtbl->Peek_v1(This, WantDestinationQueue, WantBody,                \
                          ReceiveTimeout, ppmsg)
...
#define IMSMQQueue3_ReceiveCurrent_v1(This, Transaction, WantDestinationQueue, \
                                      WantBody, ReceiveTimeout, ppmsg)         \
  (This)->lpVtbl->ReceiveCurrent_v1(This, Transaction, WantDestinationQueue,   \
                                    WantBody, ReceiveTimeout, ppmsg)
#define IMSMQQueue3_PeekNext_v1(This, WantDestinationQueue, WantBody,          \
                                ReceiveTimeout, ppmsg)                         \
  (This)->lpVtbl->PeekNext_v1(This, WantDestinationQueue, WantBody,            \
                              ReceiveTimeout, ppmsg)
#define IMSMQQueue3_PeekCurrent_v1(This, WantDestinationQueue, WantBody,       \
                                   ReceiveTimeout, ppmsg)                      \
  (This)->lpVtbl->PeekCurrent_v1(This, WantDestinationQueue, WantBody,         \
                                 ReceiveTimeout, ppmsg)
#define IMSMQQueue3_Receive(This, Transaction, WantDestinationQueue, WantBody, \
                            ReceiveTimeout, WantConnectorType, ppmsg)          \
  (This)->lpVtbl->Receive(This, Transaction, WantDestinationQueue, WantBody,   \
                          ReceiveTimeout, WantConnectorType, ppmsg)
#define IMSMQQueue3_Peek(This, WantDestinationQueue, WantBody, ReceiveTimeout, \
                         WantConnectorType, ppmsg)                             \
  (This)->lpVtbl->Peek(This, WantDestinationQueue, WantBody, ReceiveTimeout,   \
                       WantConnectorType, ppmsg)
#define IMSMQQueue3_ReceiveCurrent(This, Transaction, WantDestinationQueue,    \
                                   WantBody, ReceiveTimeout,                   \
                                   WantConnectorType, ppmsg)                   \
  (This)->lpVtbl->ReceiveCurrent(This, Transaction, WantDestinationQueue,      \
                                 WantBody, ReceiveTimeout, WantConnectorType,  \
                                 ppmsg)
#define IMSMQQueue3_PeekNext(This, WantDestinationQueue, WantBody,             \
                             ReceiveTimeout, WantConnectorType, ppmsg)         \
  (This)->lpVtbl->PeekNext(This, WantDestinationQueue, WantBody,               \
                           ReceiveTimeout, WantConnectorType, ppmsg)
#define IMSMQQueue3_PeekCurrent(This, WantDestinationQueue, WantBody,          \
                                ReceiveTimeout, WantConnectorType, ppmsg)      \
  (This)->lpVtbl->PeekCurrent(This, WantDestinationQueue, WantBody,            \
                              ReceiveTimeout, WantConnectorType, ppmsg)
...
#define IMSMQQueue3_ReceiveByLookupId(This, LookupId, Transaction,             \
                                      WantDestinationQueue, WantBody,          \
                                      WantConnectorType, ppmsg)                \
  (This)->lpVtbl->ReceiveByLookupId(This, LookupId, Transaction,               \
                                    WantDestinationQueue, WantBody,            \
                                    WantConnectorType, ppmsg)
#define IMSMQQueue3_ReceiveNextByLookupId(This, LookupId, Transaction,         \
                                          WantDestinationQueue, WantBody,      \
                                          WantConnectorType, ppmsg)            \
  (This)->lpVtbl->ReceiveNextByLookupId(This, LookupId, Transaction,           \
                                        WantDestinationQueue, WantBody,        \
                                        WantConnectorType, ppmsg)
#define IMSMQQueue3_ReceivePreviousByLookupId(This, LookupId, Transaction,     \
                                              WantDestinationQueue, WantBody,  \
                                              WantConnectorType, ppmsg)        \
  (This)->lpVtbl->ReceivePreviousByLookupId(This, LookupId, Transaction,       \
                                            WantDestinationQueue, WantBody,    \
                                            WantConnectorType, ppmsg)
#define IMSMQQueue3_ReceiveFirstByLookupId(This, Transaction,                  \
                                           WantDestinationQueue, WantBody,     \
                                           WantConnectorType, ppmsg)           \
  (This)->lpVtbl->ReceiveFirstByLookupId(This, Transaction,                    \
                                         WantDestinationQueue, WantBody,       \
                                         WantConnectorType, ppmsg)
#define IMSMQQueue3_ReceiveLastByLookupId(This, Transaction,                   \
                                          WantDestinationQueue, WantBody,      \
                                          WantConnectorType, ppmsg)            \
  (This)->lpVtbl->ReceiveLastByLookupId(This, Transaction,                     \
                                        WantDestinationQueue, WantBody,        \
                                        WantConnectorType, ppmsg)
#define IMSMQQueue3_PeekByLookupId(This, LookupId, WantDestinationQueue,       \
                                   WantBody, WantConnectorType, ppmsg)         \
  (This)->lpVtbl->PeekByLookupId(This, LookupId, WantDestinationQueue,         \
                                 WantBody, WantConnectorType, ppmsg)
#define IMSMQQueue3_PeekNextByLookupId(This, LookupId, WantDestinationQueue,   \
                                       WantBody, WantConnectorType, ppmsg)     \
  (This)->lpVtbl->PeekNextByLookupId(This, LookupId, WantDestinationQueue,     \
                                     WantBody, WantConnectorType, ppmsg)
#define IMSMQQueue3_PeekPreviousByLookupId(                                    \
    This, LookupId, WantDestinationQueue, WantBody, WantConnectorType, ppmsg)  \
  (This)->lpVtbl->PeekPreviousByLookupId(This, LookupId, WantDestinationQueue, \
                                         WantBody, WantConnectorType, ppmsg)
#define IMSMQQueue3_PeekFirstByLookupId(This, WantDestinationQueue, WantBody,  \
                                        WantConnectorType, ppmsg)              \
  (This)->lpVtbl->PeekFirstByLookupId(This, WantDestinationQueue, WantBody,    \
                                      WantConnectorType, ppmsg)
#define IMSMQQueue3_PeekLastByLookupId(This, WantDestinationQueue, WantBody,   \
                                       WantConnectorType, ppmsg)               \
  (This)->lpVtbl->PeekLastByLookupId(This, WantDestinationQueue, WantBody,     \
                                     WantConnectorType, ppmsg)
...
#endif
#endif
HRESULT WINAPI IMSMQQueue3_get_Access_Proxy(IMSMQQueue3 *This,
                                            __LONG32 *plAccess);
void __RPC_STUB IMSMQQueue3_get_Access_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue3_get_ShareMode_Proxy(IMSMQQueue3 *This,
                                               __LONG32 *plShareMode);
void __RPC_STUB IMSMQQueue3_get_ShareMode_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue3_get_QueueInfo_Proxy(IMSMQQueue3 *This,
                                               IMSMQQueueInfo3 **ppqinfo);
void __RPC_STUB IMSMQQueue3_get_QueueInfo_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue3_get_Handle_Proxy(IMSMQQueue3 *This,
                                            __LONG32 *plHandle);
void __RPC_STUB IMSMQQueue3_get_Handle_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue3_get_IsOpen_Proxy(IMSMQQueue3 *This,
                                            Boolean *pisOpen);
void __RPC_STUB IMSMQQueue3_get_IsOpen_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue3_Close_Proxy(IMSMQQueue3 *This);
void __RPC_STUB IMSMQQueue3_Close_Stub(IRpcStubBuffer *This,
                                       IRpcChannelBuffer *_pRpcChannelBuffer,
                                       PRPC_MESSAGE _pRpcMessage,
                                       DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue3_Receive_v1_Proxy(
    IMSMQQueue3 *This, VARIANT *Transaction, VARIANT *WantDestinationQueue,
    VARIANT *WantBody, VARIANT *ReceiveTimeout, IMSMQMessage **ppmsg);
void __RPC_STUB IMSMQQueue3_Receive_v1_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue3_Peek_v1_Proxy(IMSMQQueue3 *This,
                                         VARIANT *WantDestinationQueue,
                                         VARIANT *WantBody,
                                         VARIANT *ReceiveTimeout,
                                         IMSMQMessage **ppmsg);
void __RPC_STUB IMSMQQueue3_Peek_v1_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue3_EnableNotification_Proxy(IMSMQQueue3 *This,
                                                    IMSMQEvent3 *Event,
                                                    VARIANT *Cursor,
                                                    VARIANT *ReceiveTimeout);
...
void __RPC_STUB IMSMQQueue3_Reset_Stub(IRpcStubBuffer *This,
                                       IRpcChannelBuffer *_pRpcChannelBuffer,
                                       PRPC_MESSAGE _pRpcMessage,
                                       DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue3_ReceiveCurrent_v1_Proxy(
    IMSMQQueue3 *This, VARIANT *Transaction, VARIANT *WantDestinationQueue,
    VARIANT *WantBody, VARIANT *ReceiveTimeout, IMSMQMessage **ppmsg);
void __RPC_STUB IMSMQQueue3_ReceiveCurrent_v1_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue3_PeekNext_v1_Proxy(IMSMQQueue3 *This,
                                             VARIANT *WantDestinationQueue,
                                             VARIANT *WantBody,
                                             VARIANT *ReceiveTimeout,
                                             IMSMQMessage **ppmsg);
void __RPC_STUB IMSMQQueue3_PeekNext_v1_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue3_PeekCurrent_v1_Proxy(IMSMQQueue3 *This,
                                                VARIANT *WantDestinationQueue,
                                                VARIANT *WantBody,
                                                VARIANT *ReceiveTimeout,
                                                IMSMQMessage **ppmsg);
void __RPC_STUB IMSMQQueue3_PeekCurrent_v1_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue3_Receive_Proxy(
    IMSMQQueue3 *This, VARIANT *Transaction, VARIANT *WantDestinationQueue,
    VARIANT *WantBody, VARIANT *ReceiveTimeout, VARIANT *WantConnectorType,
    IMSMQMessage3 **ppmsg);
void __RPC_STUB IMSMQQueue3_Receive_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue3_Peek_Proxy(
    IMSMQQueue3 *This, VARIANT *WantDestinationQueue, VARIANT *WantBody,
    VARIANT *ReceiveTimeout, VARIANT *WantConnectorType, IMSMQMessage3 **ppmsg);
void __RPC_STUB IMSMQQueue3_Peek_Stub(IRpcStubBuffer *This,
                                      IRpcChannelBuffer *_pRpcChannelBuffer,
                                      PRPC_MESSAGE _pRpcMessage,
                                      DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue3_ReceiveCurrent_Proxy(
    IMSMQQueue3 *This, VARIANT *Transaction, VARIANT *WantDestinationQueue,
    VARIANT *WantBody, VARIANT *ReceiveTimeout, VARIANT *WantConnectorType,
    IMSMQMessage3 **ppmsg);
void __RPC_STUB IMSMQQueue3_ReceiveCurrent_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue3_PeekNext_Proxy(
    IMSMQQueue3 *This, VARIANT *WantDestinationQueue, VARIANT *WantBody,
    VARIANT *ReceiveTimeout, VARIANT *WantConnectorType, IMSMQMessage3 **ppmsg);
void __RPC_STUB IMSMQQueue3_PeekNext_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
...
void __RPC_STUB IMSMQQueue3_PeekCurrent_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue3_get_Properties_Proxy(IMSMQQueue3 *This,
                                                IDispatch **ppcolProperties);
void __RPC_STUB IMSMQQueue3_get_Properties_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue3_get_Handle2_Proxy(IMSMQQueue3 *This,
                                             VARIANT *pvarHandle);
void __RPC_STUB IMSMQQueue3_get_Handle2_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue3_ReceiveByLookupId_Proxy(
    IMSMQQueue3 *This, VARIANT LookupId, VARIANT *Transaction,
    VARIANT *WantDestinationQueue, VARIANT *WantBody,
    VARIANT *WantConnectorType, IMSMQMessage3 **ppmsg);
void __RPC_STUB IMSMQQueue3_ReceiveByLookupId_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue3_ReceiveNextByLookupId_Proxy(
    IMSMQQueue3 *This, VARIANT LookupId, VARIANT *Transaction,
    VARIANT *WantDestinationQueue, VARIANT *WantBody,
    VARIANT *WantConnectorType, IMSMQMessage3 **ppmsg);
void __RPC_STUB IMSMQQueue3_ReceiveNextByLookupId_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue3_ReceivePreviousByLookupId_Proxy(
    IMSMQQueue3 *This, VARIANT LookupId, VARIANT *Transaction,
    VARIANT *WantDestinationQueue, VARIANT *WantBody,
    VARIANT *WantConnectorType, IMSMQMessage3 **ppmsg);
void __RPC_STUB IMSMQQueue3_ReceivePreviousByLookupId_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue3_ReceiveFirstByLookupId_Proxy(
    IMSMQQueue3 *This, VARIANT *Transaction, VARIANT *WantDestinationQueue,
    VARIANT *WantBody, VARIANT *WantConnectorType, IMSMQMessage3 **ppmsg);
void __RPC_STUB IMSMQQueue3_ReceiveFirstByLookupId_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue3_ReceiveLastByLookupId_Proxy(
    IMSMQQueue3 *This, VARIANT *Transaction, VARIANT *WantDestinationQueue,
    VARIANT *WantBody, VARIANT *WantConnectorType, IMSMQMessage3 **ppmsg);
void __RPC_STUB IMSMQQueue3_ReceiveLastByLookupId_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue3_PeekByLookupId_Proxy(
    IMSMQQueue3 *This, VARIANT LookupId, VARIANT *WantDestinationQueue,
    VARIANT *WantBody, VARIANT *WantConnectorType, IMSMQMessage3 **ppmsg);
void __RPC_STUB IMSMQQueue3_PeekByLookupId_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue3_PeekNextByLookupId_Proxy(
    IMSMQQueue3 *This, VARIANT LookupId, VARIANT *WantDestinationQueue,
    VARIANT *WantBody, VARIANT *WantConnectorType, IMSMQMessage3 **ppmsg);
void __RPC_STUB IMSMQQueue3_PeekNextByLookupId_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue3_PeekPreviousByLookupId_Proxy(
    IMSMQQueue3 *This, VARIANT LookupId, VARIANT *WantDestinationQueue,
    VARIANT *WantBody, VARIANT *WantConnectorType, IMSMQMessage3 **ppmsg);
...
void __RPC_STUB IMSMQQueue3_PeekFirstByLookupId_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue3_PeekLastByLookupId_Proxy(
    IMSMQQueue3 *This, VARIANT *WantDestinationQueue, VARIANT *WantBody,
    VARIANT *WantConnectorType, IMSMQMessage3 **ppmsg);
...
void __RPC_STUB IMSMQQueue3_Purge_Stub(IRpcStubBuffer *This,
                                       IRpcChannelBuffer *_pRpcChannelBuffer,
                                       PRPC_MESSAGE _pRpcMessage,
                                       DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueue3_get_IsOpen2_Proxy(IMSMQQueue3 *This,
                                             VARIANT_BOOL *pisOpen);
...
public:
  ...
  virtual HRESULT WINAPI FireArrivedEvent(IMSMQQueue *pq,
                                          __LONG32 msgcursor) = 0;
  virtual HRESULT WINAPI FireArrivedErrorEvent(IMSMQQueue *pq, HRESULT hrStatus,
                                               __LONG32 msgcursor) = 0;
};
#else
typedef struct IMSMQPrivateEventVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMSMQPrivateEvent *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IMSMQPrivateEvent *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IMSMQPrivateEvent *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IMSMQPrivateEvent *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *get_Hwnd)(IMSMQPrivateEvent *This, __LONG32 *phwnd);
  HRESULT(WINAPI *FireArrivedEvent)(IMSMQPrivateEvent *This, IMSMQQueue *pq,
                                    __LONG32 msgcursor);
  HRESULT(WINAPI *FireArrivedErrorEvent)(IMSMQPrivateEvent *This,
                                         IMSMQQueue *pq, HRESULT hrStatus,
                                         __LONG32 msgcursor);
  END_INTERFACE
...
#define IMSMQPrivateEvent_GetTypeInfo(This, iTInfo, lcid, ppTInfo)             \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IMSMQPrivateEvent_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,   \
                                        rgDispId)                              \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IMSMQPrivateEvent_Invoke(This, dispIdMember, riid, lcid, wFlags,       \
...
#endif
#endif
HRESULT WINAPI IMSMQPrivateEvent_get_Hwnd_Proxy(IMSMQPrivateEvent *This,
                                                __LONG32 *phwnd);
void __RPC_STUB IMSMQPrivateEvent_get_Hwnd_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQPrivateEvent_FireArrivedEvent_Proxy(IMSMQPrivateEvent *This,
                                                        IMSMQQueue *pq,
                                                        __LONG32 msgcursor);
void __RPC_STUB IMSMQPrivateEvent_FireArrivedEvent_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQPrivateEvent_FireArrivedErrorEvent_Proxy(
    IMSMQPrivateEvent *This, IMSMQQueue *pq, HRESULT hrStatus,
    __LONG32 msgcursor);
...
typedef struct _DMSMQEventEventsVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(_DMSMQEventEvents *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(_DMSMQEventEvents *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(_DMSMQEventEvents *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(_DMSMQEventEvents *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  END_INTERFACE
...
#define _DMSMQEventEvents_GetTypeInfo(This, iTInfo, lcid, ppTInfo)             \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define _DMSMQEventEvents_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,   \
                                        rgDispId)                              \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define _DMSMQEventEvents_Invoke(This, dispIdMember, riid, lcid, wFlags,       \
                                 pDispParams, pVarResult, pExcepInfo,          \
                                 puArgErr)                                     \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
typedef struct IMSMQTransaction2Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMSMQTransaction2 *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IMSMQTransaction2 *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IMSMQTransaction2 *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IMSMQTransaction2 *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *get_Transaction)(IMSMQTransaction2 *This,
                                   __LONG32 *plTransaction);
  HRESULT(WINAPI *Commit)(IMSMQTransaction2 *This, VARIANT *fRetaining,
                          VARIANT *grfTC, VARIANT *grfRM);
  HRESULT(WINAPI *Abort)(IMSMQTransaction2 *This, VARIANT *fRetaining,
                         VARIANT *fAsync);
  HRESULT(WINAPI *InitNew)(IMSMQTransaction2 *This, VARIANT varTransaction);
  HRESULT(WINAPI *get_Properties)(IMSMQTransaction2 *This,
                                  IDispatch **ppcolProperties);
  END_INTERFACE
...
#define IMSMQTransaction2_GetTypeInfo(This, iTInfo, lcid, ppTInfo)             \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IMSMQTransaction2_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,   \
                                        rgDispId)                              \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IMSMQTransaction2_Invoke(This, dispIdMember, riid, lcid, wFlags,       \
                                 pDispParams, pVarResult, pExcepInfo,          \
                                 puArgErr)                                     \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI IMSMQTransaction2_InitNew_Proxy(IMSMQTransaction2 *This,
                                               VARIANT varTransaction);
void __RPC_STUB IMSMQTransaction2_InitNew_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQTransaction2_get_Properties_Proxy(
    IMSMQTransaction2 *This, IDispatch **ppcolProperties);
...
typedef struct IMSMQTransaction3Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMSMQTransaction3 *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IMSMQTransaction3 *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IMSMQTransaction3 *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IMSMQTransaction3 *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *get_Transaction)(IMSMQTransaction3 *This,
                                   __LONG32 *plTransaction);
  HRESULT(WINAPI *Commit)(IMSMQTransaction3 *This, VARIANT *fRetaining,
                          VARIANT *grfTC, VARIANT *grfRM);
  HRESULT(WINAPI *Abort)(IMSMQTransaction3 *This, VARIANT *fRetaining,
                         VARIANT *fAsync);
  HRESULT(WINAPI *InitNew)(IMSMQTransaction3 *This, VARIANT varTransaction);
  HRESULT(WINAPI *get_Properties)(IMSMQTransaction3 *This,
                                  IDispatch **ppcolProperties);
  HRESULT(WINAPI *get_ITransaction)(IMSMQTransaction3 *This,
                                    VARIANT *pvarITransaction);
  END_INTERFACE
...
#define IMSMQTransaction3_GetTypeInfo(This, iTInfo, lcid, ppTInfo)             \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IMSMQTransaction3_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,   \
                                        rgDispId)                              \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IMSMQTransaction3_Invoke(This, dispIdMember, riid, lcid, wFlags,       \
                                 pDispParams, pVarResult, pExcepInfo,          \
                                 puArgErr)                                     \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
HRESULT
    WINAPI IMSMQTransaction3_get_ITransaction_Proxy(IMSMQTransaction3 *This,
                                                    VARIANT *pvarITransaction);
...
typedef struct IMSMQCoordinatedTransactionDispenser2Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMSMQCoordinatedTransactionDispenser2 *This,
                                  REFIID riid, void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfoCount)(IMSMQCoordinatedTransactionDispenser2 *This,
                                    UINT *pctinfo);
  HRESULT(WINAPI *GetTypeInfo)(IMSMQCoordinatedTransactionDispenser2 *This,
                               UINT iTInfo, LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IMSMQCoordinatedTransactionDispenser2 *This,
                                 REFIID riid, LPOLESTR *rgszNames, UINT cNames,
                                 LCID lcid, DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IMSMQCoordinatedTransactionDispenser2 *This,
                          DISPID dispIdMember, REFIID riid, LCID lcid,
                          WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *BeginTransaction)(IMSMQCoordinatedTransactionDispenser2 *This,
                                    IMSMQTransaction2 **ptransaction);
  HRESULT(WINAPI *get_Properties)(IMSMQCoordinatedTransactionDispenser2 *This,
                                  IDispatch **ppcolProperties);
  END_INTERFACE
...
#ifdef COBJMACROS
#define IMSMQCoordinatedTransactionDispenser2_QueryInterface(This, riid,       \
                                                             ppvObject)        \
  (This)->lpVtbl->QueryInterface(This, riid, ppvObject)
...
#define IMSMQCoordinatedTransactionDispenser2_GetTypeInfoCount(This, pctinfo)  \
  (This)->lpVtbl->GetTypeInfoCount(This, pctinfo)
#define IMSMQCoordinatedTransactionDispenser2_GetTypeInfo(This, iTInfo, lcid,  \
                                                          ppTInfo)             \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IMSMQCoordinatedTransactionDispenser2_GetIDsOfNames(                   \
    This, riid, rgszNames, cNames, lcid, rgDispId)                             \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IMSMQCoordinatedTransactionDispenser2_Invoke(                          \
  ...
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
#define IMSMQCoordinatedTransactionDispenser2_BeginTransaction(This,           \
                                                               ptransaction)   \
  (This)->lpVtbl->BeginTransaction(This, ptransaction)
#define IMSMQCoordinatedTransactionDispenser2_get_Properties(This,             \
                                                             ppcolProperties)  \
  (This)->lpVtbl->get_Properties(This, ppcolProperties)
#endif
#endif
HRESULT WINAPI IMSMQCoordinatedTransactionDispenser2_BeginTransaction_Proxy(
    IMSMQCoordinatedTransactionDispenser2 *This,
    IMSMQTransaction2 **ptransaction);
void __RPC_STUB IMSMQCoordinatedTransactionDispenser2_BeginTransaction_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQCoordinatedTransactionDispenser2_get_Properties_Proxy(
    IMSMQCoordinatedTransactionDispenser2 *This, IDispatch **ppcolProperties);
...
typedef struct IMSMQCoordinatedTransactionDispenser3Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMSMQCoordinatedTransactionDispenser3 *This,
                                  REFIID riid, void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfoCount)(IMSMQCoordinatedTransactionDispenser3 *This,
                                    UINT *pctinfo);
  HRESULT(WINAPI *GetTypeInfo)(IMSMQCoordinatedTransactionDispenser3 *This,
                               UINT iTInfo, LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IMSMQCoordinatedTransactionDispenser3 *This,
                                 REFIID riid, LPOLESTR *rgszNames, UINT cNames,
                                 LCID lcid, DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IMSMQCoordinatedTransactionDispenser3 *This,
                          DISPID dispIdMember, REFIID riid, LCID lcid,
                          WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *BeginTransaction)(IMSMQCoordinatedTransactionDispenser3 *This,
                                    IMSMQTransaction3 **ptransaction);
  HRESULT(WINAPI *get_Properties)(IMSMQCoordinatedTransactionDispenser3 *This,
                                  IDispatch **ppcolProperties);
  END_INTERFACE
...
#ifdef COBJMACROS
#define IMSMQCoordinatedTransactionDispenser3_QueryInterface(This, riid,       \
                                                             ppvObject)        \
  (This)->lpVtbl->QueryInterface(This, riid, ppvObject)
...
#define IMSMQCoordinatedTransactionDispenser3_GetTypeInfoCount(This, pctinfo)  \
  (This)->lpVtbl->GetTypeInfoCount(This, pctinfo)
#define IMSMQCoordinatedTransactionDispenser3_GetTypeInfo(This, iTInfo, lcid,  \
                                                          ppTInfo)             \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IMSMQCoordinatedTransactionDispenser3_GetIDsOfNames(                   \
    This, riid, rgszNames, cNames, lcid, rgDispId)                             \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IMSMQCoordinatedTransactionDispenser3_Invoke(                          \
  ...
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
#define IMSMQCoordinatedTransactionDispenser3_BeginTransaction(This,           \
                                                               ptransaction)   \
  (This)->lpVtbl->BeginTransaction(This, ptransaction)
#define IMSMQCoordinatedTransactionDispenser3_get_Properties(This,             \
                                                             ppcolProperties)  \
  (This)->lpVtbl->get_Properties(This, ppcolProperties)
#endif
#endif
HRESULT WINAPI IMSMQCoordinatedTransactionDispenser3_BeginTransaction_Proxy(
    IMSMQCoordinatedTransactionDispenser3 *This,
    IMSMQTransaction3 **ptransaction);
void __RPC_STUB IMSMQCoordinatedTransactionDispenser3_BeginTransaction_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQCoordinatedTransactionDispenser3_get_Properties_Proxy(
    IMSMQCoordinatedTransactionDispenser3 *This, IDispatch **ppcolProperties);
...
typedef struct IMSMQTransactionDispenser2Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMSMQTransactionDispenser2 *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IMSMQTransactionDispenser2 *This);
  ULONG(WINAPI *Release)(IMSMQTransactionDispenser2 *This);
  HRESULT(WINAPI *GetTypeInfoCount)(IMSMQTransactionDispenser2 *This,
                                    UINT *pctinfo);
  HRESULT(WINAPI *GetTypeInfo)(IMSMQTransactionDispenser2 *This, UINT iTInfo,
                               LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IMSMQTransactionDispenser2 *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IMSMQTransactionDispenser2 *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *BeginTransaction)(IMSMQTransactionDispenser2 *This,
                                    IMSMQTransaction2 **ptransaction);
  HRESULT(WINAPI *get_Properties)(IMSMQTransactionDispenser2 *This,
                                  IDispatch **ppcolProperties);
  END_INTERFACE
...
#define IMSMQTransactionDispenser2_GetTypeInfo(This, iTInfo, lcid, ppTInfo)    \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IMSMQTransactionDispenser2_GetIDsOfNames(This, riid, rgszNames,        \
                                                 cNames, lcid, rgDispId)       \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IMSMQTransactionDispenser2_Invoke(This, dispIdMember, riid, lcid,      \
                                          wFlags, pDispParams, pVarResult,     \
                                          pExcepInfo, puArgErr)                \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI IMSMQTransactionDispenser2_BeginTransaction_Proxy(
    IMSMQTransactionDispenser2 *This, IMSMQTransaction2 **ptransaction);
void __RPC_STUB IMSMQTransactionDispenser2_BeginTransaction_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQTransactionDispenser2_get_Properties_Proxy(
    IMSMQTransactionDispenser2 *This, IDispatch **ppcolProperties);
...
typedef struct IMSMQTransactionDispenser3Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMSMQTransactionDispenser3 *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IMSMQTransactionDispenser3 *This);
  ULONG(WINAPI *Release)(IMSMQTransactionDispenser3 *This);
  HRESULT(WINAPI *GetTypeInfoCount)(IMSMQTransactionDispenser3 *This,
                                    UINT *pctinfo);
  HRESULT(WINAPI *GetTypeInfo)(IMSMQTransactionDispenser3 *This, UINT iTInfo,
                               LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IMSMQTransactionDispenser3 *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IMSMQTransactionDispenser3 *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *BeginTransaction)(IMSMQTransactionDispenser3 *This,
                                    IMSMQTransaction3 **ptransaction);
  HRESULT(WINAPI *get_Properties)(IMSMQTransactionDispenser3 *This,
                                  IDispatch **ppcolProperties);
  END_INTERFACE
...
#define IMSMQTransactionDispenser3_GetTypeInfo(This, iTInfo, lcid, ppTInfo)    \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IMSMQTransactionDispenser3_GetIDsOfNames(This, riid, rgszNames,        \
                                                 cNames, lcid, rgDispId)       \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IMSMQTransactionDispenser3_Invoke(This, dispIdMember, riid, lcid,      \
                                          wFlags, pDispParams, pVarResult,     \
                                          pExcepInfo, puArgErr)                \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI IMSMQTransactionDispenser3_BeginTransaction_Proxy(
    IMSMQTransactionDispenser3 *This, IMSMQTransaction3 **ptransaction);
void __RPC_STUB IMSMQTransactionDispenser3_BeginTransaction_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQTransactionDispenser3_get_Properties_Proxy(
    IMSMQTransactionDispenser3 *This, IDispatch **ppcolProperties);
...
public:
  virtual HRESULT WINAPI MachineIdOfMachineName(BSTR MachineName,
                                                BSTR *pbstrGuid) = 0;
};
#else
typedef struct IMSMQApplicationVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMSMQApplication *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IMSMQApplication *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IMSMQApplication *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IMSMQApplication *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *MachineIdOfMachineName)(IMSMQApplication *This,
                                          BSTR MachineName, BSTR *pbstrGuid);
  END_INTERFACE
...
#define IMSMQApplication_GetTypeInfo(This, iTInfo, lcid, ppTInfo)              \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IMSMQApplication_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,    \
                                       rgDispId)                               \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IMSMQApplication_Invoke(This, dispIdMember, riid, lcid, wFlags,        \
                                pDispParams, pVarResult, pExcepInfo, puArgErr) \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI IMSMQApplication_MachineIdOfMachineName_Proxy(
    IMSMQApplication *This, BSTR MachineName, BSTR *pbstrGuid);
...
public:
  virtual HRESULT WINAPI RegisterCertificate(VARIANT *Flags,
                                             VARIANT *ExternalCertificate) = 0;
  virtual HRESULT WINAPI MachineNameOfMachineId(BSTR bstrGuid,
...
typedef struct IMSMQApplication2Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMSMQApplication2 *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IMSMQApplication2 *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IMSMQApplication2 *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IMSMQApplication2 *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *MachineIdOfMachineName)(IMSMQApplication2 *This,
                                          BSTR MachineName, BSTR *pbstrGuid);
  HRESULT(WINAPI *RegisterCertificate)(IMSMQApplication2 *This, VARIANT *Flags,
                                       VARIANT *ExternalCertificate);
  HRESULT(WINAPI *MachineNameOfMachineId)(IMSMQApplication2 *This,
                                          BSTR bstrGuid,
                                          BSTR *pbstrMachineName);
  HRESULT(WINAPI *get_MSMQVersionMajor)(IMSMQApplication2 *This,
                                        short *psMSMQVersionMajor);
  HRESULT(WINAPI *get_MSMQVersionMinor)(IMSMQApplication2 *This,
                                        short *psMSMQVersionMinor);
  HRESULT(WINAPI *get_MSMQVersionBuild)(IMSMQApplication2 *This,
                                        short *psMSMQVersionBuild);
  HRESULT(WINAPI *get_IsDsEnabled)(IMSMQApplication2 *This,
                                   VARIANT_BOOL *pfIsDsEnabled);
  HRESULT(WINAPI *get_Properties)(IMSMQApplication2 *This,
                                  IDispatch **ppcolProperties);
  END_INTERFACE
...
#define IMSMQApplication2_GetTypeInfo(This, iTInfo, lcid, ppTInfo)             \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IMSMQApplication2_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,   \
                                        rgDispId)                              \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IMSMQApplication2_Invoke(This, dispIdMember, riid, lcid, wFlags,       \
                                 pDispParams, pVarResult, pExcepInfo,          \
                                 puArgErr)                                     \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
#define IMSMQApplication2_MachineIdOfMachineName(This, MachineName, pbstrGuid) \
  (This)->lpVtbl->MachineIdOfMachineName(This, MachineName, pbstrGuid)
#define IMSMQApplication2_RegisterCertificate(This, Flags,                     \
                                              ExternalCertificate)             \
  (This)->lpVtbl->RegisterCertificate(This, Flags, ExternalCertificate)
#define IMSMQApplication2_MachineNameOfMachineId(This, bstrGuid,               \
                                                 pbstrMachineName)             \
...
#endif
#endif
HRESULT WINAPI IMSMQApplication2_RegisterCertificate_Proxy(
    IMSMQApplication2 *This, VARIANT *Flags, VARIANT *ExternalCertificate);
void __RPC_STUB IMSMQApplication2_RegisterCertificate_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQApplication2_MachineNameOfMachineId_Proxy(
    IMSMQApplication2 *This, BSTR bstrGuid, BSTR *pbstrMachineName);
void __RPC_STUB IMSMQApplication2_MachineNameOfMachineId_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQApplication2_get_MSMQVersionMajor_Proxy(
    IMSMQApplication2 *This, short *psMSMQVersionMajor);
void __RPC_STUB IMSMQApplication2_get_MSMQVersionMajor_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQApplication2_get_MSMQVersionMinor_Proxy(
    IMSMQApplication2 *This, short *psMSMQVersionMinor);
void __RPC_STUB IMSMQApplication2_get_MSMQVersionMinor_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQApplication2_get_MSMQVersionBuild_Proxy(
    IMSMQApplication2 *This, short *psMSMQVersionBuild);
void __RPC_STUB IMSMQApplication2_get_MSMQVersionBuild_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQApplication2_get_IsDsEnabled_Proxy(
    IMSMQApplication2 *This, VARIANT_BOOL *pfIsDsEnabled);
void __RPC_STUB IMSMQApplication2_get_IsDsEnabled_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQApplication2_get_Properties_Proxy(
    IMSMQApplication2 *This, IDispatch **ppcolProperties);
...
public:
  ...
  virtual HRESULT WINAPI
  get_DirectoryServiceServer(BSTR *pbstrDirectoryServiceServer) = 0;
...
typedef struct IMSMQApplication3Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMSMQApplication3 *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IMSMQApplication3 *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IMSMQApplication3 *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IMSMQApplication3 *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *MachineIdOfMachineName)(IMSMQApplication3 *This,
                                          BSTR MachineName, BSTR *pbstrGuid);
  HRESULT(WINAPI *RegisterCertificate)(IMSMQApplication3 *This, VARIANT *Flags,
                                       VARIANT *ExternalCertificate);
  HRESULT(WINAPI *MachineNameOfMachineId)(IMSMQApplication3 *This,
                                          BSTR bstrGuid,
                                          BSTR *pbstrMachineName);
  HRESULT(WINAPI *get_MSMQVersionMajor)(IMSMQApplication3 *This,
                                        short *psMSMQVersionMajor);
  HRESULT(WINAPI *get_MSMQVersionMinor)(IMSMQApplication3 *This,
                                        short *psMSMQVersionMinor);
  HRESULT(WINAPI *get_MSMQVersionBuild)(IMSMQApplication3 *This,
                                        short *psMSMQVersionBuild);
  HRESULT(WINAPI *get_IsDsEnabled)(IMSMQApplication3 *This,
                                   VARIANT_BOOL *pfIsDsEnabled);
  HRESULT(WINAPI *get_Properties)(IMSMQApplication3 *This,
                                  IDispatch **ppcolProperties);
  HRESULT(WINAPI *get_ActiveQueues)(IMSMQApplication3 *This,
                                    VARIANT *pvActiveQueues);
  HRESULT(WINAPI *get_PrivateQueues)(IMSMQApplication3 *This,
                                     VARIANT *pvPrivateQueues);
  HRESULT(WINAPI *get_DirectoryServiceServer)(
      IMSMQApplication3 *This, BSTR *pbstrDirectoryServiceServer);
  HRESULT(WINAPI *get_IsConnected)(IMSMQApplication3 *This,
                                   VARIANT_BOOL *pfIsConnected);
  HRESULT(WINAPI *get_BytesInAllQueues)(IMSMQApplication3 *This,
                                        VARIANT *pvBytesInAllQueues);
...
#define IMSMQApplication3_GetTypeInfo(This, iTInfo, lcid, ppTInfo)             \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IMSMQApplication3_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,   \
                                        rgDispId)                              \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IMSMQApplication3_Invoke(This, dispIdMember, riid, lcid, wFlags,       \
                                 pDispParams, pVarResult, pExcepInfo,          \
                                 puArgErr)                                     \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
#define IMSMQApplication3_MachineIdOfMachineName(This, MachineName, pbstrGuid) \
  (This)->lpVtbl->MachineIdOfMachineName(This, MachineName, pbstrGuid)
#define IMSMQApplication3_RegisterCertificate(This, Flags,                     \
                                              ExternalCertificate)             \
  (This)->lpVtbl->RegisterCertificate(This, Flags, ExternalCertificate)
#define IMSMQApplication3_MachineNameOfMachineId(This, bstrGuid,               \
                                                 pbstrMachineName)             \
  (This)->lpVtbl->MachineNameOfMachineId(This, bstrGuid, pbstrMachineName)
...
#define IMSMQApplication3_get_DirectoryServiceServer(                          \
    This, pbstrDirectoryServiceServer)                                         \
...
#endif
HRESULT
    WINAPI IMSMQApplication3_get_ActiveQueues_Proxy(IMSMQApplication3 *This,
                                                    VARIANT *pvActiveQueues);
void __RPC_STUB IMSMQApplication3_get_ActiveQueues_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQApplication3_get_PrivateQueues_Proxy(
    IMSMQApplication3 *This, VARIANT *pvPrivateQueues);
void __RPC_STUB IMSMQApplication3_get_PrivateQueues_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQApplication3_get_DirectoryServiceServer_Proxy(
    IMSMQApplication3 *This, BSTR *pbstrDirectoryServiceServer);
void __RPC_STUB IMSMQApplication3_get_DirectoryServiceServer_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQApplication3_get_IsConnected_Proxy(
    IMSMQApplication3 *This, VARIANT_BOOL *pfIsConnected);
void __RPC_STUB IMSMQApplication3_get_IsConnected_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQApplication3_get_BytesInAllQueues_Proxy(
    IMSMQApplication3 *This, VARIANT *pvBytesInAllQueues);
void __RPC_STUB IMSMQApplication3_get_BytesInAllQueues_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQApplication3_put_Machine_Proxy(IMSMQApplication3 *This,
                                                   BSTR bstrMachine);
void __RPC_STUB IMSMQApplication3_put_Machine_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQApplication3_get_Machine_Proxy(IMSMQApplication3 *This,
                                                   BSTR *pbstrMachine);
...
typedef struct IMSMQDestinationVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMSMQDestination *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IMSMQDestination *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IMSMQDestination *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IMSMQDestination *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  ...
  HRESULT(WINAPI *get_FormatName)(IMSMQDestination *This,
                                  BSTR *pbstrFormatName);
  HRESULT(WINAPI *put_FormatName)(IMSMQDestination *This, BSTR bstrFormatName);
  HRESULT(WINAPI *get_Destinations)(IMSMQDestination *This,
                                    IDispatch **ppDestinations);
  HRESULT(WINAPI *putref_Destinations)(IMSMQDestination *This,
                                       IDispatch *pDestinations);
  HRESULT(WINAPI *get_Properties)(IMSMQDestination *This,
                                  IDispatch **ppcolProperties);
  END_INTERFACE
...
#define IMSMQDestination_GetTypeInfo(This, iTInfo, lcid, ppTInfo)              \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IMSMQDestination_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,    \
                                       rgDispId)                               \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IMSMQDestination_Invoke(This, dispIdMember, riid, lcid, wFlags,        \
                                pDispParams, pVarResult, pExcepInfo, puArgErr) \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
void __RPC_STUB IMSMQDestination_Close_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQDestination_get_IsOpen_Proxy(IMSMQDestination *This,
                                                 VARIANT_BOOL *pfIsOpen);
void __RPC_STUB IMSMQDestination_get_IsOpen_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQDestination_get_IADs_Proxy(IMSMQDestination *This,
                                               IDispatch **ppIADs);
void __RPC_STUB IMSMQDestination_get_IADs_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQDestination_putref_IADs_Proxy(IMSMQDestination *This,
                                                  IDispatch *pIADs);
void __RPC_STUB IMSMQDestination_putref_IADs_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQDestination_get_ADsPath_Proxy(IMSMQDestination *This,
                                                  BSTR *pbstrADsPath);
void __RPC_STUB IMSMQDestination_get_ADsPath_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQDestination_put_ADsPath_Proxy(IMSMQDestination *This,
                                                  BSTR bstrADsPath);
void __RPC_STUB IMSMQDestination_put_ADsPath_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQDestination_get_PathName_Proxy(IMSMQDestination *This,
                                                   BSTR *pbstrPathName);
void __RPC_STUB IMSMQDestination_get_PathName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQDestination_put_PathName_Proxy(IMSMQDestination *This,
                                                   BSTR bstrPathName);
void __RPC_STUB IMSMQDestination_put_PathName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQDestination_get_FormatName_Proxy(IMSMQDestination *This,
                                                     BSTR *pbstrFormatName);
void __RPC_STUB IMSMQDestination_get_FormatName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQDestination_put_FormatName_Proxy(IMSMQDestination *This,
                                                     BSTR bstrFormatName);
void __RPC_STUB IMSMQDestination_put_FormatName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQDestination_get_Destinations_Proxy(
    IMSMQDestination *This, IDispatch **ppDestinations);
void __RPC_STUB IMSMQDestination_get_Destinations_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQDestination_putref_Destinations_Proxy(
    IMSMQDestination *This, IDispatch *pDestinations);
void __RPC_STUB IMSMQDestination_putref_Destinations_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQDestination_get_Properties_Proxy(
    IMSMQDestination *This, IDispatch **ppcolProperties);
...
typedef struct IMSMQPrivateDestinationVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMSMQPrivateDestination *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IMSMQPrivateDestination *This);
  ULONG(WINAPI *Release)(IMSMQPrivateDestination *This);
  HRESULT(WINAPI *GetTypeInfoCount)(IMSMQPrivateDestination *This,
                                    UINT *pctinfo);
  HRESULT(WINAPI *GetTypeInfo)(IMSMQPrivateDestination *This, UINT iTInfo,
                               LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IMSMQPrivateDestination *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IMSMQPrivateDestination *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *get_Handle)(IMSMQPrivateDestination *This,
                              VARIANT *pvarHandle);
...
#define IMSMQPrivateDestination_GetTypeInfo(This, iTInfo, lcid, ppTInfo)       \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IMSMQPrivateDestination_GetIDsOfNames(This, riid, rgszNames, cNames,   \
                                              lcid, rgDispId)                  \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IMSMQPrivateDestination_Invoke(This, dispIdMember, riid, lcid, wFlags, \
                                       pDispParams, pVarResult, pExcepInfo,    \
                                       puArgErr)                               \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI IMSMQPrivateDestination_get_Handle_Proxy(
    IMSMQPrivateDestination *This, VARIANT *pvarHandle);
void __RPC_STUB IMSMQPrivateDestination_get_Handle_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQPrivateDestination_put_Handle_Proxy(
    IMSMQPrivateDestination *This, VARIANT varHandle);
...
typedef struct IMSMQCollectionVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMSMQCollection *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IMSMQCollection *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IMSMQCollection *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IMSMQCollection *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *Item)(IMSMQCollection *This, VARIANT *Index,
                        VARIANT *pvarRet);
...
#define IMSMQCollection_GetTypeInfo(This, iTInfo, lcid, ppTInfo)               \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IMSMQCollection_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,     \
                                      rgDispId)                                \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IMSMQCollection_Invoke(This, dispIdMember, riid, lcid, wFlags,         \
                               pDispParams, pVarResult, pExcepInfo, puArgErr)  \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI IMSMQCollection_Item_Proxy(IMSMQCollection *This, VARIANT *Index,
                                          VARIANT *pvarRet);
void __RPC_STUB IMSMQCollection_Item_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQCollection_get_Count_Proxy(IMSMQCollection *This,
                                               __LONG32 *pCount);
void __RPC_STUB IMSMQCollection_get_Count_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQCollection__NewEnum_Proxy(IMSMQCollection *This,
                                              IUnknown **ppunk);
...
public:
  virtual HRESULT WINAPI Init(VARIANT *Machine, VARIANT *Pathname,
                              VARIANT *FormatName) = 0;
  virtual HRESULT WINAPI get_FormatName(BSTR *pbstrFormatName) = 0;
  virtual HRESULT WINAPI get_Machine(BSTR *pbstrMachine) = 0;
  ...
  virtual HRESULT WINAPI
  get_TransactionalStatus(__LONG32 *plTransactionalStatus) = 0;
  virtual HRESULT WINAPI get_BytesInQueue(VARIANT *pvBytesInQueue) = 0;
};
#else
typedef struct IMSMQManagementVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMSMQManagement *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IMSMQManagement *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IMSMQManagement *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IMSMQManagement *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *Init)(IMSMQManagement *This, VARIANT *Machine,
                        VARIANT *Pathname, VARIANT *FormatName);
  ...
  HRESULT(WINAPI *get_MessageCount)(IMSMQManagement *This,
                                    __LONG32 *plMessageCount);
  HRESULT(WINAPI *get_ForeignStatus)(IMSMQManagement *This,
                                     __LONG32 *plForeignStatus);
  ...
  HRESULT(WINAPI *get_TransactionalStatus)(IMSMQManagement *This,
                                           __LONG32 *plTransactionalStatus);
  HRESULT(WINAPI *get_BytesInQueue)(IMSMQManagement *This,
                                    VARIANT *pvBytesInQueue);
  END_INTERFACE
} IMSMQManagementVtbl;
...
#define IMSMQManagement_GetTypeInfo(This, iTInfo, lcid, ppTInfo)               \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IMSMQManagement_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,     \
                                      rgDispId)                                \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IMSMQManagement_Invoke(This, dispIdMember, riid, lcid, wFlags,         \
                               pDispParams, pVarResult, pExcepInfo, puArgErr)  \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI IMSMQManagement_Init_Proxy(IMSMQManagement *This,
                                          VARIANT *Machine, VARIANT *Pathname,
                                          VARIANT *FormatName);
void __RPC_STUB IMSMQManagement_Init_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQManagement_get_FormatName_Proxy(IMSMQManagement *This,
                                                    BSTR *pbstrFormatName);
void __RPC_STUB IMSMQManagement_get_FormatName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQManagement_get_Machine_Proxy(IMSMQManagement *This,
                                                 BSTR *pbstrMachine);
void __RPC_STUB IMSMQManagement_get_Machine_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQManagement_get_MessageCount_Proxy(IMSMQManagement *This,
                                                      __LONG32 *plMessageCount);
void __RPC_STUB IMSMQManagement_get_MessageCount_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQManagement_get_ForeignStatus_Proxy(
    IMSMQManagement *This, __LONG32 *plForeignStatus);
void __RPC_STUB IMSMQManagement_get_ForeignStatus_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQManagement_get_QueueType_Proxy(IMSMQManagement *This,
                                                   __LONG32 *plQueueType);
void __RPC_STUB IMSMQManagement_get_QueueType_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQManagement_get_IsLocal_Proxy(IMSMQManagement *This,
                                                 VARIANT_BOOL *pfIsLocal);
void __RPC_STUB IMSMQManagement_get_IsLocal_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQManagement_get_TransactionalStatus_Proxy(
    IMSMQManagement *This, __LONG32 *plTransactionalStatus);
void __RPC_STUB IMSMQManagement_get_TransactionalStatus_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQManagement_get_BytesInQueue_Proxy(IMSMQManagement *This,
                                                      VARIANT *pvBytesInQueue);
...
typedef struct IMSMQOutgoingQueueManagementVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMSMQOutgoingQueueManagement *This,
                                  REFIID riid, void **ppvObject);
  ULONG(WINAPI *AddRef)(IMSMQOutgoingQueueManagement *This);
  ULONG(WINAPI *Release)(IMSMQOutgoingQueueManagement *This);
  HRESULT(WINAPI *GetTypeInfoCount)(IMSMQOutgoingQueueManagement *This,
                                    UINT *pctinfo);
  HRESULT(WINAPI *GetTypeInfo)(IMSMQOutgoingQueueManagement *This, UINT iTInfo,
                               LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IMSMQOutgoingQueueManagement *This,
                                 REFIID riid, LPOLESTR *rgszNames, UINT cNames,
                                 LCID lcid, DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IMSMQOutgoingQueueManagement *This,
                          DISPID dispIdMember, REFIID riid, LCID lcid,
                          WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *Init)(IMSMQOutgoingQueueManagement *This, VARIANT *Machine,
                        VARIANT *Pathname, VARIANT *FormatName);
  HRESULT(WINAPI *get_FormatName)(IMSMQOutgoingQueueManagement *This,
                                  BSTR *pbstrFormatName);
  HRESULT(WINAPI *get_Machine)(IMSMQOutgoingQueueManagement *This,
                               BSTR *pbstrMachine);
  HRESULT(WINAPI *get_MessageCount)(IMSMQOutgoingQueueManagement *This,
                                    __LONG32 *plMessageCount);
  HRESULT(WINAPI *get_ForeignStatus)(IMSMQOutgoingQueueManagement *This,
                                     __LONG32 *plForeignStatus);
  HRESULT(WINAPI *get_QueueType)(IMSMQOutgoingQueueManagement *This,
                                 __LONG32 *plQueueType);
  HRESULT(WINAPI *get_IsLocal)(IMSMQOutgoingQueueManagement *This,
                               VARIANT_BOOL *pfIsLocal);
  HRESULT(WINAPI *get_TransactionalStatus)(IMSMQOutgoingQueueManagement *This,
                                           __LONG32 *plTransactionalStatus);
  HRESULT(WINAPI *get_BytesInQueue)(IMSMQOutgoingQueueManagement *This,
                                    VARIANT *pvBytesInQueue);
  HRESULT(WINAPI *get_State)(IMSMQOutgoingQueueManagement *This,
                             __LONG32 *plState);
  HRESULT(WINAPI *get_NextHops)(IMSMQOutgoingQueueManagement *This,
                                VARIANT *pvNextHops);
  HRESULT(WINAPI *EodGetSendInfo)(IMSMQOutgoingQueueManagement *This,
                                  IMSMQCollection **ppCollection);
...
#define IMSMQOutgoingQueueManagement_GetTypeInfo(This, iTInfo, lcid, ppTInfo)  \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IMSMQOutgoingQueueManagement_GetIDsOfNames(This, riid, rgszNames,      \
                                                   cNames, lcid, rgDispId)     \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IMSMQOutgoingQueueManagement_Invoke(This, dispIdMember, riid, lcid,    \
                                            wFlags, pDispParams, pVarResult,   \
                                            pExcepInfo, puArgErr)              \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#define IMSMQOutgoingQueueManagement_get_IsLocal(This, pfIsLocal)              \
  (This)->lpVtbl->get_IsLocal(This, pfIsLocal)
#define IMSMQOutgoingQueueManagement_get_TransactionalStatus(                  \
    This, plTransactionalStatus)                                               \
  (This)->lpVtbl->get_TransactionalStatus(This, plTransactionalStatus)
...
#endif
#endif
HRESULT WINAPI IMSMQOutgoingQueueManagement_get_State_Proxy(
    IMSMQOutgoingQueueManagement *This, __LONG32 *plState);
void __RPC_STUB IMSMQOutgoingQueueManagement_get_State_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQOutgoingQueueManagement_get_NextHops_Proxy(
    IMSMQOutgoingQueueManagement *This, VARIANT *pvNextHops);
void __RPC_STUB IMSMQOutgoingQueueManagement_get_NextHops_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQOutgoingQueueManagement_EodGetSendInfo_Proxy(
    IMSMQOutgoingQueueManagement *This, IMSMQCollection **ppCollection);
void __RPC_STUB IMSMQOutgoingQueueManagement_EodGetSendInfo_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
IMSMQOutgoingQueueManagement_Resume_Proxy(IMSMQOutgoingQueueManagement *This);
void __RPC_STUB IMSMQOutgoingQueueManagement_Resume_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
IMSMQOutgoingQueueManagement_Pause_Proxy(IMSMQOutgoingQueueManagement *This);
void __RPC_STUB IMSMQOutgoingQueueManagement_Pause_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQOutgoingQueueManagement_EodResend_Proxy(
...
public:
  virtual HRESULT WINAPI
  get_JournalMessageCount(__LONG32 *plJournalMessageCount) = 0;
...
typedef struct IMSMQQueueManagementVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMSMQQueueManagement *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IMSMQQueueManagement *This, UINT iTInfo,
                               LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IMSMQQueueManagement *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IMSMQQueueManagement *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *Init)(IMSMQQueueManagement *This, VARIANT *Machine,
                        VARIANT *Pathname, VARIANT *FormatName);
  HRESULT(WINAPI *get_FormatName)(IMSMQQueueManagement *This,
                                  BSTR *pbstrFormatName);
  HRESULT(WINAPI *get_Machine)(IMSMQQueueManagement *This, BSTR *pbstrMachine);
  HRESULT(WINAPI *get_MessageCount)(IMSMQQueueManagement *This,
                                    __LONG32 *plMessageCount);
  HRESULT(WINAPI *get_ForeignStatus)(IMSMQQueueManagement *This,
                                     __LONG32 *plForeignStatus);
  HRESULT(WINAPI *get_QueueType)(IMSMQQueueManagement *This,
                                 __LONG32 *plQueueType);
  HRESULT(WINAPI *get_IsLocal)(IMSMQQueueManagement *This,
                               VARIANT_BOOL *pfIsLocal);
  HRESULT(WINAPI *get_TransactionalStatus)(IMSMQQueueManagement *This,
                                           __LONG32 *plTransactionalStatus);
  HRESULT(WINAPI *get_BytesInQueue)(IMSMQQueueManagement *This,
                                    VARIANT *pvBytesInQueue);
  HRESULT(WINAPI *get_JournalMessageCount)(IMSMQQueueManagement *This,
                                           __LONG32 *plJournalMessageCount);
  HRESULT(WINAPI *get_BytesInJournal)(IMSMQQueueManagement *This,
                                      VARIANT *pvBytesInJournal);
  HRESULT(WINAPI *EodGetReceiveInfo)(IMSMQQueueManagement *This,
                                     VARIANT *pvCollection);
  END_INTERFACE
...
#define IMSMQQueueManagement_GetTypeInfo(This, iTInfo, lcid, ppTInfo)          \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IMSMQQueueManagement_GetIDsOfNames(This, riid, rgszNames, cNames,      \
                                           lcid, rgDispId)                     \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IMSMQQueueManagement_Invoke(This, dispIdMember, riid, lcid, wFlags,    \
                                    pDispParams, pVarResult, pExcepInfo,       \
                                    puArgErr)                                  \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#define IMSMQQueueManagement_get_IsLocal(This, pfIsLocal)                      \
  (This)->lpVtbl->get_IsLocal(This, pfIsLocal)
#define IMSMQQueueManagement_get_TransactionalStatus(This,                     \
                                                     plTransactionalStatus)    \
  (This)->lpVtbl->get_TransactionalStatus(This, plTransactionalStatus)
#define IMSMQQueueManagement_get_BytesInQueue(This, pvBytesInQueue)            \
  (This)->lpVtbl->get_BytesInQueue(This, pvBytesInQueue)
#define IMSMQQueueManagement_get_JournalMessageCount(This,                     \
                                                     plJournalMessageCount)    \
...
#endif
#endif
HRESULT WINAPI IMSMQQueueManagement_get_JournalMessageCount_Proxy(
    IMSMQQueueManagement *This, __LONG32 *plJournalMessageCount);
void __RPC_STUB IMSMQQueueManagement_get_JournalMessageCount_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueManagement_get_BytesInJournal_Proxy(
    IMSMQQueueManagement *This, VARIANT *pvBytesInJournal);
void __RPC_STUB IMSMQQueueManagement_get_BytesInJournal_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMSMQQueueManagement_EodGetReceiveInfo_Proxy(
    IMSMQQueueManagement *This, VARIANT *pvCollection);
