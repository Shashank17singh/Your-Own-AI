...
#define SP_PROT_TLS1_1PLUS_SERVER                                              \
...
#define SP_PROT_TLS1_1PLUS                                                     \
  (SP_PROT_TLS1_1PLUS_SERVER | SP_PROT_TLS1_1PLUS_CLIENT)
#define SP_PROT_TLS1_3PLUS_SERVER SP_PROT_TLS1_3_SERVER
#define SP_PROT_TLS1_3PLUS_CLIENT SP_PROT_TLS1_3_CLIENT
#define SP_PROT_TLS1_3PLUS                                                     \
  (SP_PROT_TLS1_3PLUS_SERVER | SP_PROT_TLS1_3PLUS_CLIENT)
...
WINBOOL SslGenerateKeyPair(PSSL_CREDENTIAL_CERTIFICATE pCerts, PSTR pszDN,
                           PSTR pszPassword, DWORD Bits);
VOID SslGenerateRandomBits(PUCHAR pRandomData, LONG cRandomData);
WINBOOL SslCrackCertificate(PUCHAR pbCertificate, DWORD cbCertificate,
                            DWORD dwFlags, PX509Certificate *ppCertificate);
...
typedef WINBOOL(WINAPI *SSL_CRACK_CERTIFICATE_FN)(
    PUCHAR pbCertificate, DWORD cbCertificate, WINBOOL VerifySignature,
...
typedef SECURITY_STATUS(WINAPI *SslGetServerIdentityFn)(
    PBYTE ClientHello, DWORD ClientHelloSize, PBYTE *ServerIdentity,
    PDWORD ServerIdentitySize, DWORD Flags);
SECURITY_STATUS WINAPI SslGetServerIdentity(PBYTE ClientHello,
...
typedef SECURITY_STATUS(WINAPI *SslGetExtensionsFn)(
    const BYTE *clientHello, DWORD clientHelloByteSize,
    SCH_EXTENSION_DATA *genericExtensions, BYTE genericExtensionsCount,
    DWORD *bytesToRead, SchGetExtensionsOptions flags);
SECURITY_STATUS WINAPI SslGetExtensions(const BYTE *clientHello,
