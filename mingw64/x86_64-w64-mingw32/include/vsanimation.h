...
enum EXPANDSTATES { TA_EXPAND_AFFECTED = 1, TA_EXPAND_REVEALED = 2 };
enum COLLAPSESTATES { TA_COLLAPSE_HIDDEN = 1, TA_COLLAPSE_AFFECTED = 2 };
enum REPOSITIONSTATES { TA_REPOSITION_TARGET = 1 };
enum FADEINSTATES { TA_FADEIN_SHOWN = 1 };
enum FADEOUTSTATES { TA_FADEOUT_HIDDEN = 1 };
...
enum ADDTOLISTSTATES { TA_ADDTOLIST_ADDED = 1, TA_ADDTOLIST_AFFECTED = 2 };
...
enum SHOWEDGEUISTATES { TA_SHOWEDGEUI_TARGET = 1 };
enum HIDEEDGEUISTATES { TA_HIDEEDGEUI_TARGET = 1 };
enum SHOWPANELSTATES { TA_SHOWPANEL_TARGET = 1 };
enum HIDEPANELSTATES { TA_HIDEPANEL_TARGET = 1 };
enum SHOWPOPUPSTATES { TA_SHOWPOPUP_TARGET = 1 };
enum HIDEPOPUPSTATES { TA_HIDEPOPUP_TARGET = 1 };
enum POINTERDOWNSTATES { TA_POINTERDOWN_TARGET = 1 };
enum POINTERUPSTATES { TA_POINTERUP_TARGET = 1 };
...
enum DRAGBETWEENENTERSTATES { TA_DRAGBETWEENENTER_AFFECTED = 1 };
enum DRAGBETWEENLEAVESTATES { TA_DRAGBETWEENLEAVE_AFFECTED = 1 };
...
enum SWIPEREVEALSTATES { TA_SWIPEREVEAL_TARGET = 1 };
enum ENTERPAGESTATES { TA_ENTERPAGE_TARGET = 1 };
enum TRANSITIONPAGESTATES {
  TA_TRANSITIONPAGE_INCOMING = 1,
  TA_TRANSITIONPAGE_OUTGOING = 2
};
enum CROSSFADESTATES { TA_CROSSFADE_INCOMING = 1, TA_CROSSFADE_OUTGOING = 2 };
enum PEEKSTATES { TA_PEEK_TARGET = 1 };
