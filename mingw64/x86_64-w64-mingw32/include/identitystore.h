...
DEFINE_GUID(IID_IAssociatedIdentityProvider, 0x2AF066B3, 0x4CBB, 0x4CBA, 0xA7,
            0x98, 0x20, 0x4B, 0x6A, 0xF6, 0x8C, 0xC0);
...
DECLARE_INTERFACE_(IAssociatedIdentityProvider, IUnknown) {
  ...
  STDMETHOD_(HRESULT, AssociateIdentity)(
      THIS_ HWND hwndParent, IPropertyStore * *ppPropertyStore) PURE;
  STDMETHOD_(HRESULT, ChangeCredential)(THIS_ HWND hwndParent,
                                        LPCWSTR lpszUniqueID) PURE;
  STDMETHOD_(HRESULT, DisassociateIdentity)(THIS_ HWND hwndParent,
                                            LPCWSTR lpszUniqueID) PURE;
  END_INTERFACE
};
#ifdef COBJMACROS
...
#define IAssociatedIdentityProvider_AssociateIdentity(This, hwndParent,        \
                                                      ppPropertyStore)         \
  (This)->lpVtbl->AssociateIdentity(This, hwndParent, ppPropertyStore)
#define IAssociatedIdentityProvider_ChangeCredential(This, hwndParent,         \
                                                     lpszUniqueID)             \
  (This)->lpVtbl->ChangeCredential(This, hwndParent, lpszUniqueID)
#define IAssociatedIdentityProvider_DisassociateIdentity(This, hwndParent,     \
                                                         lpszUniqueID)         \
