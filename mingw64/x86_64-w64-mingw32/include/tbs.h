...
TBS_RESULT WINAPI Tbsip_Submit_Command(TBS_HCONTEXT hContext,
                                       ...
                                       PCBYTE pabCommand, UINT32 cbCommand,
                                       PBYTE pabResult, PUINT32 pcbResult);
TBS_RESULT WINAPI Tbsip_Cancel_Commands(TBS_HCONTEXT hContext);
TBS_RESULT WINAPI Tbsi_Physical_Presence_Command(TBS_HCONTEXT hContext,
                                                 PCBYTE pabInput,
                                                 UINT32 cbInput,
                                                 PBYTE pabOutput,
                                                 PUINT32 pcbOutput);
...
TBS_RESULT WINAPI Tbsi_Get_OwnerAuth(TBS_HCONTEXT hContext,
                                     TBS_OWNERAUTH_TYPE ownerauthType,
                                     PBYTE pOutputBuf, PUINT32 pOutputBufLen);
TBS_RESULT WINAPI Tbsi_Revoke_Attestation(void);
#endif /* (NTDDI_VERSION >= NTDDI_WIN8) */
#if (NTDDI_VERSION >= NTDDI_WINBLUE)
#ifndef _NTDDK_
HRESULT GetDeviceID(PBYTE pbWindowsAIK, UINT32 cbWindowsAIK, PUINT32 pcbResult,
                    WINBOOL *pfProtectedByTPM);
HRESULT GetDeviceIDString(PWSTR pszWindowsAIK, UINT32 cchWindowsAIK,
                          PUINT32 pcchResult, WINBOOL *pfProtectedByTPM);
...
TBS_RESULT WINAPI Tbsi_Get_TCG_Log_Ex(UINT32 logType, PBYTE pbOutput,
                                      PUINT32 pcbOutput);
