...
DECLARE_INTERFACE_IID_(IDCompositionSurface, IUnknown,
...
DECLARE_INTERFACE_IID_(IDCompositionVirtualSurface, IDCompositionSurface,
...
DECLARE_INTERFACE_IID_(IDCompositionTransform3D, IDCompositionEffect,
                       "71185722-246b-41f2-aad1-0443f7f4bfc2"){};
#undef INTERFACE
#define INTERFACE IDCompositionTransform
DECLARE_INTERFACE_IID_(IDCompositionTransform, IDCompositionTransform3D,
                       "fd55faa7-37e0-4c20-95d2-9be45bc33f55"){};
#undef INTERFACE
#define INTERFACE IDCompositionTranslateTransform
DECLARE_INTERFACE_IID_(IDCompositionTranslateTransform, IDCompositionTransform,
...
DECLARE_INTERFACE_IID_(IDCompositionScaleTransform, IDCompositionTransform,
...
DECLARE_INTERFACE_IID_(IDCompositionRotateTransform, IDCompositionTransform,
...
DECLARE_INTERFACE_IID_(IDCompositionSkewTransform, IDCompositionTransform,
...
DECLARE_INTERFACE_IID_(IDCompositionMatrixTransform, IDCompositionTransform,
...
DECLARE_INTERFACE_IID_(IDCompositionTranslateTransform3D,
...
DECLARE_INTERFACE_IID_(IDCompositionScaleTransform3D, IDCompositionTransform3D,
...
DECLARE_INTERFACE_IID_(IDCompositionRotateTransform3D, IDCompositionTransform3D,
...
DECLARE_INTERFACE_IID_(IDCompositionMatrixTransform3D, IDCompositionTransform3D,
...
DECLARE_INTERFACE_IID_(IDCompositionEffectGroup, IDCompositionEffect,
...
DECLARE_INTERFACE_IID_(IDCompositionClip, IUnknown,
                       "64ac3703-9d3f-45ec-a109-7cac0e7a13a7"){};
#undef INTERFACE
#define INTERFACE IDCompositionRectangleClip
DECLARE_INTERFACE_IID_(IDCompositionRectangleClip, IDCompositionClip,
...
DECLARE_INTERFACE_IID_(IDCompositionVisual, IUnknown,
  ...
  STDMETHOD(SetBitmapInterpolationMode)(
      THIS_ DCOMPOSITION_BITMAP_INTERPOLATION_MODE) PURE;
...
DECLARE_INTERFACE_IID_(IDCompositionDevice, IUnknown,
  ...
  STDMETHOD(CreateTranslateTransform3D)(
      THIS_ IDCompositionTranslateTransform3D **) PURE;
...
__CRT_UUID_DECL(IDCompositionDevice, 0xc37ea93a, 0xe7aa, 0x450d, 0xb1, 0x6f,
                0x97, 0x46, 0xcb, 0x04, 0x07, 0xf3);
#endif
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDCompositionVisual2, 0xe8de1639, 0x4331, 0x4b26, 0xbc, 0x5f,
                0x6a, 0x32, 0x1d, 0x34, 0x7a, 0x85);
#endif
#undef INTERFACE
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDCompositionSurfaceFactory, 0xe334bc12, 0x3937, 0x4e02, 0x85,
                0xeb, 0xfc, 0xf4, 0xeb, 0x30, 0xd2, 0xc8);
#endif
#undef INTERFACE
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDCompositionDevice2, 0x75f6468d, 0x1b8e, 0x447c, 0x9b, 0xc6,
                0x75, 0xfe, 0xa8, 0x0b, 0x5b, 0x25);
#endif
#undef INTERFACE
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDCompositionDesktopDevice, 0x5f4633fe, 0x1e08, 0x4cb8, 0x8c,
                0x75, 0xce, 0x24, 0x33, 0x3f, 0x56, 0x02);
#endif
#undef INTERFACE
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDCompositionDeviceDebug, 0xa1a3c64a, 0x224f, 0x4a81, 0x97,
                0x73, 0x4f, 0x03, 0xa8, 0x9d, 0x3c, 0x6c);
#endif
#undef INTERFACE
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDCompositionVisualDebug, 0xfed2b808, 0x5eb4, 0x43a0, 0xae,
                0xa3, 0x35, 0xf6, 0x52, 0x80, 0xf9, 0x1b);
#endif
#undef INTERFACE
#define INTERFACE IDCompositionFilterEffect
DECLARE_INTERFACE_IID_(IDCompositionFilterEffect, IDCompositionEffect,
                       "30C421D5-8CB2-4E9F-B133-37BE270D4AC2") {
  STDMETHOD(SetInput)(THIS_ UINT index, IUnknown * input, UINT flags) PURE;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDCompositionFilterEffect, 0x30c421d5, 0x8cb2, 0x4e9f, 0xb1,
                0x33, 0x37, 0xbe, 0x27, 0x0d, 0x4a, 0xc2);
#endif
#undef INTERFACE
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDCompositionSaturationEffect, 0xa08debda, 0x3258, 0x4fa4, 0x9f,
                0x16, 0x91, 0x74, 0xd3, 0xfe, 0x93, 0xb1);
#endif
#undef INTERFACE
#define INTERFACE IDCompositionTableTransferEffect
DECLARE_INTERFACE_IID_(IDCompositionTableTransferEffect,
  ...
  STDMETHOD(SetRedTableValue)(THIS_ UINT index,
  ...
  STDMETHOD(SetGreenTableValue)(THIS_ UINT index,
                                IDCompositionAnimation * animation) PURE;
#else
  STDMETHOD(SetGreenTableValue)(THIS_ UINT index,
                                IDCompositionAnimation * animation) PURE;
  ...
  STDMETHOD(SetBlueTableValue)(THIS_ UINT index,
                               IDCompositionAnimation * animation) PURE;
#else
  STDMETHOD(SetBlueTableValue)(THIS_ UINT index,
                               IDCompositionAnimation * animation) PURE;
  ...
  STDMETHOD(SetAlphaTableValue)(THIS_ UINT index,
                                IDCompositionAnimation * animation) PURE;
#else
  STDMETHOD(SetAlphaTableValue)(THIS_ UINT index,
                                IDCompositionAnimation * animation) PURE;
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDCompositionTableTransferEffect, 0x9b7e82e2, 0x69c5, 0x4eb4,
                0xa5, 0xf5, 0xa7, 0x03, 0x3f, 0x51, 0x32, 0xcd);
#endif
#undef INTERFACE
#define INTERFACE IDCompositionGaussianBlurEffect
DECLARE_INTERFACE_IID_(IDCompositionGaussianBlurEffect,
                       IDCompositionFilterEffect,
                       "45D4D0B7-1BD4-454E-8894-2BFA68443033") {
#if defined(_MSC_VER) && defined(__cplusplus)
  STDMETHOD(SetStandardDeviation)(THIS_ float amount) PURE;
  STDMETHOD(SetStandardDeviation)(THIS_ IDCompositionAnimation * animation)
      PURE;
#else
  STDMETHOD(SetStandardDeviation)(THIS_ IDCompositionAnimation * animation)
      PURE;
...
__CRT_UUID_DECL(IDCompositionGaussianBlurEffect, 0x45d4d0b7, 0x1bd4, 0x454e,
                0x88, 0x94, 0x2b, 0xfa, 0x68, 0x44, 0x30, 0x33);
#endif
#undef INTERFACE
#define INTERFACE IDCompositionColorMatrixEffect
DECLARE_INTERFACE_IID_(IDCompositionColorMatrixEffect,
                       IDCompositionFilterEffect,
  ...
  STDMETHOD(SetMatrixElement)(THIS_ int row, int column,
                              IDCompositionAnimation *animation) PURE;
#else
  STDMETHOD(SetMatrixElement)(THIS_ int row, int column,
                              IDCompositionAnimation *animation) PURE;
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDCompositionColorMatrixEffect, 0xc1170a22, 0x3ce2, 0x4966,
                0x90, 0xd4, 0x55, 0x40, 0x8b, 0xfc, 0x84, 0xc4);
#endif
/* WARNING: some of the arguments are replaced with void*, only what's used has
 * been kept */
#undef INTERFACE
...
DECLARE_INTERFACE_IID_(IDCompositionDevice3, IDCompositionDevice2,
  ...
  STDMETHOD(CreateBrightnessEffect)(
      THIS_ /* TODO IDCompositionBrightnessEffect */ void **brightnessEffect)
      PURE;
  STDMETHOD(CreateColorMatrixEffect)(THIS_ IDCompositionColorMatrixEffect *
                                     *colorMatrixEffect) PURE;
  STDMETHOD(CreateShadowEffect)(
      THIS_ /* TODO IDCompositionShadowEffect */ void **shadowEffect) PURE;
  STDMETHOD(CreateHueRotationEffect)(
      THIS_ /* IDCompositionHueRotationEffect */ void **hueRotationEffect) PURE;
  STDMETHOD(CreateSaturationEffect)(THIS_ IDCompositionSaturationEffect *
                                    *saturationEffect) PURE;
  STDMETHOD(CreateTurbulenceEffect)(
      THIS_ /* IDCompositionTurbulenceEffect */ void **turbulenceEffect) PURE;
  STDMETHOD(CreateLinearTransferEffect)(
      THIS_ /* IDCompositionLinearTransferEffect */ void **linearTransferEffect)
      PURE;
  STDMETHOD(CreateTableTransferEffect)(THIS_ IDCompositionTableTransferEffect *
                                       *tableTransferEffect) PURE;
  STDMETHOD(CreateCompositeEffect)(
      THIS_ /* IDCompositionCompositeEffect */ void **compositeEffect) PURE;
  STDMETHOD(CreateBlendEffect)(
      THIS_ /* TODO IDCompositionBlendEffect */ void **blendEffect) PURE;
  STDMETHOD(CreateArithmeticCompositeEffect)(
      THIS_ /* IDCompositionArithmeticCompositeEffect */ void *
          *arithmeticCompositeEffect) PURE;
  STDMETHOD(CreateAffineTransform2DEffect)(
      THIS_ /* IDCompositionAffineTransform2DEffect */ void *
          *affineTransform2dEffect) PURE;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDCompositionDevice3, 0x0987cb06, 0xf916, 0x48bf, 0x8d, 0x35,
                0xce, 0x76, 0x41, 0x78, 0x1b, 0xd9);
#endif
#if (NTDDI_VERSION >= NTDDI_WIN10_NI)
#undef INTERFACE
#define INTERFACE IDCompositionTexture
DECLARE_INTERFACE_IID_(IDCompositionTexture, IUnknown,
  ...
  STDMETHOD(GetAvailableFence)(THIS_ UINT64 * fenceValue, REFIID iid,
                               void **availableFence) PURE;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDCompositionTexture, 0x929bb1aa, 0x725f, 0x433b, 0xab, 0xd7,
                0x27, 0x30, 0x75, 0xa8, 0x35, 0xf2);
#endif
#undef INTERFACE
#define INTERFACE IDCompositionDevice4
DECLARE_INTERFACE_IID_(IDCompositionDevice4, IDCompositionDevice3,
                       "85FC5CCA-2DA6-494C-86B6-4A775C049B8A") {
  STDMETHOD(CheckCompositionTextureSupport)(
      THIS_ IUnknown * renderingDevice, WINBOOL * supportsCompositionTextures)
      PURE;
  STDMETHOD(CreateCompositionTexture)(
      THIS_ IUnknown * d3dTexture, IDCompositionTexture * *compositionTexture)
      PURE;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDCompositionDevice4, 0x85fc5cca, 0x2da6, 0x494c, 0x86, 0xb6,
                0x4a, 0x77, 0x5c, 0x04, 0x9b, 0x8a);
#endif
#endif /* (NTDDI_VERSION >= NTDDI_WIN10_NI) */
#if (NTDDI_VERSION >= NTDDI_WIN11_GE)
#undef INTERFACE
#define INTERFACE IDCompositionDynamicTexture
DECLARE_INTERFACE_IID_(IDCompositionDynamicTexture, IUnknown,
                       "A1DE1D3F-6405-447F-8E95-1383A34B0277") {
#if defined(_MSC_VER) && defined(__cplusplus)
  STDMETHOD(SetTexture)(THIS_ IDCompositionTexture * pTexture) PURE;
  STDMETHOD(SetTexture)(THIS_ IDCompositionTexture * pTexture,
                        const D2D_RECT_L *pRects, size_t rectCount) PURE;
#else
  STDMETHOD(SetTexture)(THIS_ IDCompositionTexture * pTexture,
                        const D2D_RECT_L *pRects, size_t rectCount) PURE;
  STDMETHOD(SetTexture)(THIS_ IDCompositionTexture * pTexture) PURE;
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDCompositionDynamicTexture, 0xa1de1d3f, 0x6405, 0x447f, 0x8e,
                0x95, 0x13, 0x83, 0xa3, 0x4b, 0x02, 0x77);
#endif
#undef INTERFACE
#define INTERFACE IDCompositionDevice5
DECLARE_INTERFACE_IID_(IDCompositionDevice5, IDCompositionDevice4,
                       "2C6BEBFE-A603-472F-AF34-D2443356E61B") {
  STDMETHOD(CreateDynamicTexture)(THIS_ IDCompositionDynamicTexture *
                                  *compositionDynamicTexture) PURE;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDCompositionDevice5, 0x2c6bebfe, 0xa603, 0x472f, 0xaf, 0x34,
                0xd2, 0x44, 0x33, 0x56, 0xe6, 0x1b);
#endif
#endif /* (NTDDI_VERSION >= NTDDI_WIN11_GE) */
#endif /* WINAPI_PARTITION_DESKTOP */
#if (_WIN32_WINNT >= 0x0A00)
STDAPI DCompositionCreateDevice3(IUnknown *renderingDevice, REFIID iid,
                                 void **dcompositionDevice);
#endif
STDAPI DCompositionCreateSurfaceHandle(DWORD desiredAccess,
                                       SECURITY_ATTRIBUTES *securityAttributes,
                                       HANDLE *surfaceHandle);
STDAPI DCompositionAttachMouseWheelToHwnd(IDCompositionVisual *visual,
                                          HWND hwnd, BOOL enable);
STDAPI DCompositionAttachMouseDragToHwnd(IDCompositionVisual *visual, HWND hwnd,
                                         BOOL enable);
#endif
#endif /* _DCOMP_H_ */
