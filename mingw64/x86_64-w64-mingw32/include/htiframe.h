...
public:
  virtual HRESULT WINAPI OnCreate(IUnknown *pUnkDestination,
                                  ULONG cbCookie) = 0;
...
typedef struct ITargetNotifyVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITargetNotify *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ITargetNotify *This);
  ULONG(WINAPI *Release)(ITargetNotify *This);
  HRESULT(WINAPI *OnCreate)(ITargetNotify *This, IUnknown *pUnkDestination,
                            ULONG cbCookie);
...
#endif
#endif
HRESULT WINAPI ITargetNotify_OnCreate_Proxy(ITargetNotify *This,
...
HRESULT WINAPI ITargetNotify_OnReuse_Proxy(ITargetNotify *This,
                                           IUnknown *pUnkDestination);
...
typedef struct ITargetNotify2Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITargetNotify2 *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ITargetNotify2 *This);
  ULONG(WINAPI *Release)(ITargetNotify2 *This);
  HRESULT(WINAPI *OnCreate)(ITargetNotify2 *This, IUnknown *pUnkDestination,
                            ULONG cbCookie);
...
#endif
#endif
HRESULT WINAPI ITargetNotify2_GetOptionString_Proxy(ITargetNotify2 *This,
                                                    BSTR *pbstrOptions);
...
public:
  ...
  virtual HRESULT WINAPI FindFrame(LPCWSTR pszTargetName, DWORD dwFlags,
                                   IUnknown **ppunkTargetFrame) = 0;
  virtual HRESULT WINAPI GetTargetAlias(LPCWSTR pszTargetName,
                                        LPWSTR *ppszTargetAlias) = 0;
};
#else
typedef struct ITargetFrame2Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITargetFrame2 *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *SetFrameMargins)(ITargetFrame2 *This, DWORD dwWidth,
                                   DWORD dwHeight);
  HRESULT(WINAPI *GetFrameMargins)(ITargetFrame2 *This, DWORD *pdwWidth,
                                   DWORD *pdwHeight);
  HRESULT(WINAPI *FindFrame)(ITargetFrame2 *This, LPCWSTR pszTargetName,
                             DWORD dwFlags, IUnknown **ppunkTargetFrame);
  HRESULT(WINAPI *GetTargetAlias)(ITargetFrame2 *This, LPCWSTR pszTargetName,
...
#define ITargetFrame2_FindFrame(This, pszTargetName, dwFlags,                  \
                                ppunkTargetFrame)                              \
...
#endif
#endif
HRESULT WINAPI ITargetFrame2_SetFrameName_Proxy(ITargetFrame2 *This,
                                                LPCWSTR pszFrameName);
void __RPC_STUB ITargetFrame2_SetFrameName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITargetFrame2_GetFrameName_Proxy(ITargetFrame2 *This,
                                                LPWSTR *ppszFrameName);
void __RPC_STUB ITargetFrame2_GetFrameName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITargetFrame2_GetParentFrame_Proxy(ITargetFrame2 *This,
                                                  IUnknown **ppunkParent);
void __RPC_STUB ITargetFrame2_GetParentFrame_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITargetFrame2_SetFrameSrc_Proxy(ITargetFrame2 *This,
                                               LPCWSTR pszFrameSrc);
void __RPC_STUB ITargetFrame2_SetFrameSrc_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITargetFrame2_GetFrameSrc_Proxy(ITargetFrame2 *This,
                                               LPWSTR *ppszFrameSrc);
void __RPC_STUB ITargetFrame2_GetFrameSrc_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITargetFrame2_GetFramesContainer_Proxy(
    ITargetFrame2 *This, IOleContainer **ppContainer);
void __RPC_STUB ITargetFrame2_GetFramesContainer_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITargetFrame2_SetFrameOptions_Proxy(ITargetFrame2 *This,
                                                   DWORD dwFlags);
void __RPC_STUB ITargetFrame2_SetFrameOptions_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITargetFrame2_GetFrameOptions_Proxy(ITargetFrame2 *This,
                                                   DWORD *pdwFlags);
void __RPC_STUB ITargetFrame2_GetFrameOptions_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITargetFrame2_SetFrameMargins_Proxy(ITargetFrame2 *This,
                                                   DWORD dwWidth,
                                                   DWORD dwHeight);
void __RPC_STUB ITargetFrame2_SetFrameMargins_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITargetFrame2_GetFrameMargins_Proxy(ITargetFrame2 *This,
                                                   DWORD *pdwWidth,
                                                   DWORD *pdwHeight);
void __RPC_STUB ITargetFrame2_GetFrameMargins_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITargetFrame2_FindFrame_Proxy(ITargetFrame2 *This,
...
void __RPC_STUB ITargetFrame2_FindFrame_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITargetFrame2_GetTargetAlias_Proxy(ITargetFrame2 *This,
                                                  LPCWSTR pszTargetName,
                                                  LPWSTR *ppszTargetAlias);
...
typedef struct ITargetContainerVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITargetContainer *This, REFIID riid,
                                  void **ppvObject);
...
#endif
#endif
HRESULT WINAPI ITargetContainer_GetFrameUrl_Proxy(ITargetContainer *This,
                                                  LPWSTR *ppszFrameSrc);
void __RPC_STUB ITargetContainer_GetFrameUrl_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITargetContainer_GetFramesContainer_Proxy(
    ITargetContainer *This, IOleContainer **ppContainer);
