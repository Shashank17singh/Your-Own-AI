...
#include "ocidl.h"
#include "unknwn.h"
DEFINE_GUID(IID_IADMEXT, 0x51dfe970, 0xf6f2, 0x11d0, 0xb9, 0xbd, 0x0, 0xa0,
            0xc9, 0x22, 0xe7, 0x50);
...
#define IISADMIN_EXTENSIONS_REG_KEY                                            \
  TEXT("SOFTWARE\\Microsoft\\InetStp\\Extensions")
...
#define IISADMIN_EXTENSIONS_CLSID_MD_KEY                                       \
  TEXT("LM/IISADMIN/EXTENSIONS/DCOMCLSIDS")
...
public:
  ...
  virtual HRESULT WINAPI EnumDcomCLSIDs(CLSID *pclsidDcom,
                                        DWORD dwEnumIndex) = 0;
