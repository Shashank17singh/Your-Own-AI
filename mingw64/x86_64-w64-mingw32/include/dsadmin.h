 ...
 */
DEFINE_GUID(CLSID_DsAdminCreateObj, 0xe301a009, 0xf901, 0x11d2, 0x82, 0xb9, 0x0,
            0xc0, 0x4f, 0x68, 0x92, 0x8b);
DEFINE_GUID(IID_IDsAdminCreateObj, 0x53554a38, 0xf902, 0x11d2, 0x82, 0xb9, 0x0,
            0xc0, 0x4f, 0x68, 0x92, 0x8b);
DEFINE_GUID(IID_IDsAdminNewObj, 0xf2573587, 0xe6fc, 0x11d2, 0x82, 0xaf, 0x0,
            0xc0, 0x4f, 0x68, 0x92, 0x8b);
DEFINE_GUID(IID_IDsAdminNewObjPrimarySite, 0xbe2b487e, 0xf904, 0x11d2, 0x82,
            0xb9, 0x0, 0xc0, 0x4f, 0x68, 0x92, 0x8b);
DEFINE_GUID(IID_IDsAdminNewObjExt, 0x6088eae2, 0xe7bf, 0x11d2, 0x82, 0xaf, 0x0,
            0xc0, 0x4f, 0x68, 0x92, 0x8b);
DEFINE_GUID(IID_IDsAdminNotifyHandler, 0xe4a2b8b3, 0x5a18, 0x11d2, 0x97, 0xc1,
            0x0, 0xa0, 0xc9, 0xa0, 0x6d, 0x2d);
#ifndef _DSADMIN_H
#define _DSADMIN_H
#undef INTERFACE
...
DECLARE_INTERFACE_(IDsAdminCreateObj, IUnknown) {
  ...
  STDMETHOD(Initialize)(THIS_ IADsContainer * pADsContainerObj,
                        IADs * pADsCopySource, LPCWSTR lpszClassName) PURE;
...
DECLARE_INTERFACE_(IDsAdminNewObjExt, IUnknown) {
  ...
  STDMETHOD_(ULONG, Release)(THIS) PURE;
  STDMETHOD(Initialize)(THIS_ IADsContainer * pADsContainerObj,
                        IADs * pADsCopySource, LPCWSTR lpszClassName,
...
DECLARE_INTERFACE_(IDsAdminNotifyHandler, IUnknown) {
  ...
  STDMETHOD_(ULONG, AddRef)(THIS) PURE;
  STDMETHOD_(ULONG, Release)(THIS) PURE;
  STDMETHOD(Initialize)(THIS_ IDataObject * pExtraInfo, ULONG * puEventFlags)
      PURE;
  STDMETHOD(Begin)(THIS_ ULONG uEvent, IDataObject * pArg1, IDataObject * pArg2,
                   ULONG * puFlags, BSTR * pBstr) PURE;
