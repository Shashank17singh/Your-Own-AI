...
typedef struct IObjectWithSiteVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IObjectWithSite *This, REFIID riid,
                                  void **ppvObject);
...
#endif
#endif
HRESULT WINAPI IObjectWithSite_SetSite_Proxy(IObjectWithSite *This,
                                             IUnknown *pUnkSite);
...
HRESULT WINAPI IObjectWithSite_GetSite_Proxy(IObjectWithSite *This, REFIID riid,
                                             void **ppvSite);
...
public:
  virtual HRESULT WINAPI BrowseType(REFGUID rguidPathType,
                                    LPOLESTR pszDefaultPath, ULONG cchPath,
                                    LPOLESTR pszPath, HWND hWnd) = 0;
};
#else
typedef struct IDataPathBrowserVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IDataPathBrowser *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IDataPathBrowser *This);
  ULONG(WINAPI *Release)(IDataPathBrowser *This);
  HRESULT(WINAPI *BrowseType)(IDataPathBrowser *This, REFGUID rguidPathType,
                              LPOLESTR pszDefaultPath, ULONG cchPath,
                              LPOLESTR pszPath, HWND hWnd);
  END_INTERFACE
...
#define IDataPathBrowser_BrowseType(This, rguidPathType, pszDefaultPath,       \
                                    cchPath, pszPath, hWnd)                    \
  (This)->lpVtbl->BrowseType(This, rguidPathType, pszDefaultPath, cchPath,     \
                             pszPath, hWnd)
#endif
#endif
HRESULT WINAPI IDataPathBrowser_BrowseType_Proxy(IDataPathBrowser *This,
                                                 REFGUID rguidPathType,
                                                 LPOLESTR pszDefaultPath,
                                                 ULONG cchPath,
                                                 LPOLESTR pszPath, HWND hWnd);
...
public:
  virtual HRESULT WINAPI GetGUIDDwordArrays(REFGUID rguidArray, CAUUID *pcaUUID,
                                            CADWORD *pcadw) = 0;
  virtual HRESULT WINAPI GetClassInfoLocale(ITypeInfo **ppITypeInfo,
                                            LCID lcid) = 0;
...
typedef struct IProvideClassInfo3Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IProvideClassInfo3 *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetGUID)(IProvideClassInfo3 *This, DWORD dwGuidKind,
                           GUID *pGUID);
  HRESULT(WINAPI *GetGUIDDwordArrays)(IProvideClassInfo3 *This,
                                      REFGUID rguidArray, CAUUID *pcaUUID,
                                      CADWORD *pcadw);
  HRESULT(WINAPI *GetClassInfoLocale)(IProvideClassInfo3 *This,
                                      ITypeInfo **ppITypeInfo, LCID lcid);
  HRESULT(WINAPI *GetFlags)(IProvideClassInfo3 *This, REFGUID guidGroup,
                            DWORD *pdwFlags);
  END_INTERFACE
...
#define IProvideClassInfo3_GetGUIDDwordArrays(This, rguidArray, pcaUUID,       \
                                              pcadw)                           \
...
#endif
#endif
HRESULT WINAPI IProvideClassInfo3_GetGUIDDwordArrays_Proxy(
    IProvideClassInfo3 *This, REFGUID rguidArray, CAUUID *pcaUUID,
    CADWORD *pcadw);
void __RPC_STUB IProvideClassInfo3_GetGUIDDwordArrays_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IProvideClassInfo3_GetClassInfoLocale_Proxy(
    IProvideClassInfo3 *This, ITypeInfo **ppITypeInfo, LCID lcid);
void __RPC_STUB IProvideClassInfo3_GetClassInfoLocale_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IProvideClassInfo3_GetFlags_Proxy(IProvideClassInfo3 *This,
                                                 REFGUID guidGroup,
                                                 DWORD *pdwFlags);
