...
#define CORDBG_E_FUNC_EVAL_CANNOT_UPDATE_REGISTER_IN_NONLEAF_FRAME             \
  EMAKEHR(0x1329)
...
#define CORDBG_E_CURRENT_EXCEPTION_IS_OUTSIDE_CURRENT_EXECUTION_SCOPE          \
  EMAKEHR(0x1c33)
...
#define CORPROF_E_INCONSISTENT_FLAGS_WITH_HOST_PROTECTION_SETTING              \
  EMAKEHR(0x1377)
