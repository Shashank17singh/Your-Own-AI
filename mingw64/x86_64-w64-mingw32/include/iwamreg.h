...
DEFINE_GUID(IID_IWamAdmin, 0x29822AB7, 0xF302, 0x11D0, 0x99, 0x53, 0x00, 0xC0,
            0x4F, 0xD9, 0x19, 0xC1);
DEFINE_GUID(IID_IWamAdmin2, 0x29822AB8, 0xF302, 0x11D0, 0x99, 0x53, 0x00, 0xC0,
            0x4F, 0xD9, 0x19, 0xC1);
DEFINE_GUID(IID_IIISApplicationAdmin, 0x7C4E1804, 0xE342, 0x483D, 0xA4, 0x3E,
            0xA8, 0x50, 0xCF, 0xCC, 0x8D, 0x18);
DEFINE_GUID(LIBID_WAMREGLib, 0x29822AA8, 0xF302, 0x11D0, 0x99, 0x53, 0x00, 0xC0,
            0x4F, 0xD9, 0x19, 0xC1);
DEFINE_GUID(CLSID_WamAdmin, 0x61738644, 0xF196, 0x11D0, 0x99, 0x53, 0x00, 0xC0,
            0x4F, 0xD9, 0x19, 0xC1);
#endif
...
public:
  ...
  virtual HRESULT WINAPI AppGetStatus(LPCWSTR szMDPath,
                                      DWORD *pdwAppStatus) = 0;
  virtual HRESULT WINAPI AppDeleteRecoverable(LPCWSTR szMDPath,
                                              WINBOOL fRecursive) = 0;
  virtual HRESULT WINAPI AppRecover(LPCWSTR szMDPath, WINBOOL fRecursive) = 0;
};
#else
typedef struct IWamAdminVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IWamAdmin *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IWamAdmin *This);
  ULONG(WINAPI *Release)(IWamAdmin *This);
  HRESULT(WINAPI *AppCreate)(IWamAdmin *This, LPCWSTR szMDPath,
                             WINBOOL fInProc);
  HRESULT(WINAPI *AppDelete)(IWamAdmin *This, LPCWSTR szMDPath,
                             WINBOOL fRecursive);
  HRESULT(WINAPI *AppUnLoad)(IWamAdmin *This, LPCWSTR szMDPath,
                             WINBOOL fRecursive);
  HRESULT(WINAPI *AppGetStatus)(IWamAdmin *This, LPCWSTR szMDPath,
                                DWORD *pdwAppStatus);
  HRESULT(WINAPI *AppDeleteRecoverable)(IWamAdmin *This, LPCWSTR szMDPath,
                                        WINBOOL fRecursive);
  HRESULT(WINAPI *AppRecover)(IWamAdmin *This, LPCWSTR szMDPath,
                              WINBOOL fRecursive);
  END_INTERFACE
} IWamAdminVtbl;
struct IWamAdmin {
...
#endif
#endif
HRESULT WINAPI IWamAdmin_AppCreate_Proxy(IWamAdmin *This, LPCWSTR szMDPath,
                                         WINBOOL fInProc);
void __RPC_STUB IWamAdmin_AppCreate_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
HRESULT WINAPI IWamAdmin_AppDelete_Proxy(IWamAdmin *This, LPCWSTR szMDPath,
                                         WINBOOL fRecursive);
void __RPC_STUB IWamAdmin_AppDelete_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
HRESULT WINAPI IWamAdmin_AppUnLoad_Proxy(IWamAdmin *This, LPCWSTR szMDPath,
                                         WINBOOL fRecursive);
void __RPC_STUB IWamAdmin_AppUnLoad_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
HRESULT WINAPI IWamAdmin_AppGetStatus_Proxy(IWamAdmin *This, LPCWSTR szMDPath,
                                            DWORD *pdwAppStatus);
...
HRESULT WINAPI IWamAdmin_AppDeleteRecoverable_Proxy(IWamAdmin *This,
                                                    LPCWSTR szMDPath,
                                                    WINBOOL fRecursive);
void __RPC_STUB IWamAdmin_AppDeleteRecoverable_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IWamAdmin_AppRecover_Proxy(IWamAdmin *This, LPCWSTR szMDPath,
                                          WINBOOL fRecursive);
void __RPC_STUB IWamAdmin_AppRecover_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
#endif
...
typedef struct IWamAdmin2Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IWamAdmin2 *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IWamAdmin2 *This);
  ULONG(WINAPI *Release)(IWamAdmin2 *This);
  HRESULT(WINAPI *AppCreate)(IWamAdmin2 *This, LPCWSTR szMDPath,
                             WINBOOL fInProc);
  HRESULT(WINAPI *AppDelete)(IWamAdmin2 *This, LPCWSTR szMDPath,
                             WINBOOL fRecursive);
  HRESULT(WINAPI *AppUnLoad)(IWamAdmin2 *This, LPCWSTR szMDPath,
                             WINBOOL fRecursive);
  HRESULT(WINAPI *AppGetStatus)(IWamAdmin2 *This, LPCWSTR szMDPath,
                                DWORD *pdwAppStatus);
  HRESULT(WINAPI *AppDeleteRecoverable)(IWamAdmin2 *This, LPCWSTR szMDPath,
                                        WINBOOL fRecursive);
  HRESULT(WINAPI *AppRecover)(IWamAdmin2 *This, LPCWSTR szMDPath,
                              WINBOOL fRecursive);
  HRESULT(WINAPI *AppCreate2)(IWamAdmin2 *This, LPCWSTR szMDPath,
                              DWORD dwAppMode);
  END_INTERFACE
} IWamAdmin2Vtbl;
struct IWamAdmin2 {
...
#endif
#endif
HRESULT WINAPI IWamAdmin2_AppCreate2_Proxy(IWamAdmin2 *This, LPCWSTR szMDPath,
                                           DWORD dwAppMode);
...
public:
  virtual HRESULT WINAPI CreateApplication(LPCWSTR szMDPath, DWORD dwAppMode,
                                           LPCWSTR szAppPoolId,
                                           WINBOOL fCreatePool) = 0;
  virtual HRESULT WINAPI DeleteApplication(LPCWSTR szMDPath,
                                           WINBOOL fRecursive) = 0;
  ...
  virtual HRESULT WINAPI EnumerateApplicationsInPool(LPCWSTR szPool,
                                                     BSTR *bstrBuffer) = 0;
...
typedef struct IIISApplicationAdminVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IIISApplicationAdmin *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IIISApplicationAdmin *This);
  ULONG(WINAPI *Release)(IIISApplicationAdmin *This);
  HRESULT(WINAPI *CreateApplication)(IIISApplicationAdmin *This,
                                     LPCWSTR szMDPath, DWORD dwAppMode,
                                     LPCWSTR szAppPoolId, WINBOOL fCreatePool);
  HRESULT(WINAPI *DeleteApplication)(IIISApplicationAdmin *This,
                                     LPCWSTR szMDPath, WINBOOL fRecursive);
  HRESULT(WINAPI *CreateApplicationPool)(IIISApplicationAdmin *This,
                                         LPCWSTR szPool);
  HRESULT(WINAPI *DeleteApplicationPool)(IIISApplicationAdmin *This,
                                         LPCWSTR szPool);
  HRESULT(WINAPI *EnumerateApplicationsInPool)(IIISApplicationAdmin *This,
                                               LPCWSTR szPool,
                                               BSTR *bstrBuffer);
  HRESULT(WINAPI *RecycleApplicationPool)(IIISApplicationAdmin *This,
                                          LPCWSTR szPool);
...
#define IIISApplicationAdmin_CreateApplication(This, szMDPath, dwAppMode,      \
                                               szAppPoolId, fCreatePool)       \
  (This)->lpVtbl->CreateApplication(This, szMDPath, dwAppMode, szAppPoolId,    \
                                    fCreatePool)
...
#define IIISApplicationAdmin_EnumerateApplicationsInPool(This, szPool,         \
                                                         bstrBuffer)           \
...
#endif
#endif
HRESULT WINAPI IIISApplicationAdmin_CreateApplication_Proxy(
    IIISApplicationAdmin *This, LPCWSTR szMDPath, DWORD dwAppMode,
    LPCWSTR szAppPoolId, WINBOOL fCreatePool);
void __RPC_STUB IIISApplicationAdmin_CreateApplication_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IIISApplicationAdmin_DeleteApplication_Proxy(
    IIISApplicationAdmin *This, LPCWSTR szMDPath, WINBOOL fRecursive);
void __RPC_STUB IIISApplicationAdmin_DeleteApplication_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IIISApplicationAdmin_CreateApplicationPool_Proxy(
    IIISApplicationAdmin *This, LPCWSTR szPool);
...
void __RPC_STUB IIISApplicationAdmin_DeleteApplicationPool_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IIISApplicationAdmin_EnumerateApplicationsInPool_Proxy(
    IIISApplicationAdmin *This, LPCWSTR szPool, BSTR *bstrBuffer);
void __RPC_STUB IIISApplicationAdmin_EnumerateApplicationsInPool_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IIISApplicationAdmin_RecycleApplicationPool_Proxy(
    IIISApplicationAdmin *This, LPCWSTR szPool);
void __RPC_STUB IIISApplicationAdmin_RecycleApplicationPool_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IIISApplicationAdmin_GetProcessMode_Proxy(
    IIISApplicationAdmin *This, DWORD *pdwMode);
