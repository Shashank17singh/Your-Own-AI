...
#endif
typedef SCODE(WINAPI WABALLOCATEBUFFER)(LPWABOBJECT lpWABObject, ULONG cbSize,
                                        LPVOID *lppBuffer);
typedef SCODE(WINAPI WABALLOCATEMORE)(LPWABOBJECT lpWABObject, ULONG cbSize,
                                      LPVOID lpObject, LPVOID *lppBuffer);
