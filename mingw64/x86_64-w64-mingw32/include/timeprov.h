...
extern "C" {
#endif
#define wszW32TimeRegKeyTimeProviders                                          \
  L"System\\CurrentControlSet\\Services\\W32Time\\TimeProviders"
#define wszW32TimeRegKeyPolicyTimeProviders                                    \
  L"Software\\Policies\\Microsoft\\W32Time\\TimeProviders"
...
typedef enum TimeProvState { TPS_Running, TPS_Error } TimeProvState;
struct SetProviderStatusInfo;
typedef void(WINAPI SetProviderStatusInfoFreeFunc)(
    struct SetProviderStatusInfo *pspsi);
...
typedef HRESULT(WINAPI LogTimeProvEventFunc)(WORD wType, WCHAR *wszProvName,
                                             WCHAR *wszMessage);
...
HRESULT WINAPI TimeProvOpen(WCHAR *wszName, TimeProvSysCallbacks *pSysCallbacks,
                            TimeProvHandle *phTimeProv);
HRESULT WINAPI TimeProvCommand(TimeProvHandle hTimeProv, TimeProvCmd eCmd,
                               TimeProvArgs pvArgs);
