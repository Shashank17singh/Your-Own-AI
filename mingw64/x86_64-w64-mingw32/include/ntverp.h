...
#define VER_PRODUCTVERSION_STRING                                              \
  VER_PRODUCTVERSION_MAJORMINOR1(VER_PRODUCTMAJORVERSION,                      \
...
#define LVER_PRODUCTVERSION_STRING                                             \
  LVER_PRODUCTVERSION_MAJORMINOR1(VER_PRODUCTMAJORVERSION,                     \
                                  VER_PRODUCTMINORVERSION)
#define VER_PRODUCTVERSION                                                     \
  VER_PRODUCTMAJORVERSION, VER_PRODUCTMINORVERSION, 3790, VER_PRODUCTBUILD_QFE
...
#define VER_PRODUCTVERSION_STR                                                 \
  VER_PRODUCTVERSION_STR1(3790, VER_PRODUCTBUILD_QFE)
...
#define LVER_PRODUCTVERSION_STR                                                \
  LVER_PRODUCTVERSION_STR1(3790, VER_PRODUCTBUILD_QFE)
#define VER_DEBUG 0
