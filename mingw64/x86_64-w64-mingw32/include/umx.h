...
#define SZ_UME_GETEXTENDEDERRORSTRING                                          \
  __MINGW_NAME_AW(SZ_UME_GETEXTENDEDERRORSTRING)
...
typedef VOID(WINAPI *PUMX_RENAMEW)(HWND hwndParent, PUMS_GETSELW pumsSelection,
                                   LPWSTR pchNewName);
typedef VOID(WINAPI *PUMX_RENAMEA)(HWND hwndParent, PUMS_GETSELA pumsSelection,
                                   LPSTR pchNewName);
...
VOID WINAPI UMERenameA(HWND hwndParent, PUMS_GETSELA pumsSelection,
                       LPSTR pchNewName);
VOID WINAPI UMERenameW(HWND hwndParent, PUMS_GETSELW pumsSelection,
                       LPWSTR pchNewName);
#endif
