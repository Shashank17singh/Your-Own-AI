...
public:
  ...
  virtual HRESULT WINAPI VerifyRequest(const BSTR strConfig, LONG Context,
...
typedef struct ICertPolicyVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ICertPolicy *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ICertPolicy *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ICertPolicy *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ICertPolicy *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *Initialize)(ICertPolicy *This, const BSTR strConfig);
  HRESULT(WINAPI *VerifyRequest)(ICertPolicy *This, const BSTR strConfig,
                                 LONG Context, LONG bNewRequest, LONG Flags,
                                 LONG *pDisposition);
...
#define ICertPolicy_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,         \
                                  rgDispId)                                    \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ICertPolicy_Invoke(This, dispIdMember, riid, lcid, wFlags,             \
...
#define ICertPolicy_VerifyRequest(This, strConfig, Context, bNewRequest,       \
                                  Flags, pDisposition)                         \
  (This)->lpVtbl->VerifyRequest(This, strConfig, Context, bNewRequest, Flags,  \
                                pDisposition)
...
#endif
#endif
HRESULT WINAPI ICertPolicy_Initialize_Proxy(ICertPolicy *This,
...
HRESULT WINAPI ICertPolicy_VerifyRequest_Proxy(ICertPolicy *This,
                                               const BSTR strConfig,
                                               LONG Context, LONG bNewRequest,
                                               LONG Flags, LONG *pDisposition);
void __RPC_STUB ICertPolicy_VerifyRequest_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICertPolicy_GetDescription_Proxy(ICertPolicy *This,
...
void __RPC_STUB ICertPolicy_ShutDown_Stub(IRpcStubBuffer *This,
...
public:
  ...
  GetManageModule(ICertManageModule **ppManageModule) = 0;
};
#else
typedef struct ICertPolicy2Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ICertPolicy2 *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ICertPolicy2 *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ICertPolicy2 *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ICertPolicy2 *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *Initialize)(ICertPolicy2 *This, const BSTR strConfig);
  HRESULT(WINAPI *VerifyRequest)(ICertPolicy2 *This, const BSTR strConfig,
                                 LONG Context, LONG bNewRequest, LONG Flags,
                                 LONG *pDisposition);
  HRESULT(WINAPI *GetDescription)(ICertPolicy2 *This, BSTR *pstrDescription);
  HRESULT(WINAPI *ShutDown)(ICertPolicy2 *This);
  HRESULT(WINAPI *GetManageModule)(ICertPolicy2 *This,
...
#define ICertPolicy2_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                  \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ICertPolicy2_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,        \
                                   rgDispId)                                   \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ICertPolicy2_Invoke(This, dispIdMember, riid, lcid, wFlags,            \
                            pDispParams, pVarResult, pExcepInfo, puArgErr)     \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
#define ICertPolicy2_Initialize(This, strConfig)                               \
  (This)->lpVtbl->Initialize(This, strConfig)
#define ICertPolicy2_VerifyRequest(This, strConfig, Context, bNewRequest,      \
                                   Flags, pDisposition)                        \
  (This)->lpVtbl->VerifyRequest(This, strConfig, Context, bNewRequest, Flags,  \
                                pDisposition)
...
#endif
#endif
HRESULT WINAPI ICertPolicy2_GetManageModule_Proxy(
    ICertPolicy2 *This, ICertManageModule **ppManageModule);
