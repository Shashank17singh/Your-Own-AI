...
/*** IUnknown methods ***/
#define IDirectXFile_QueryInterface(p, a, b)                                   \
...
#define IDirectXFile_CreateSaveObject(p, a, b, c)                              \
...
#if !defined(__cplusplus) || defined(CINTERFACE)
/*** IUnknown methods ***/
#define IDirectXFileEnumObject_QueryInterface(p, a, b)                         \
  (p)->lpVtbl->QueryInterface(p, a, b)
...
#define IDirectXFileEnumObject_GetDataObjectById(p, a, b)                      \
  (p)->lpVtbl->GetDataObjectById(p, a, b)
#define IDirectXFileEnumObject_GetDataObjectByName(p, a, b)                    \
...
DECLARE_INTERFACE_(IDirectXFileSaveObject, IUnknown) {
  ...
  STDMETHOD(CreateDataObject)(THIS_ REFGUID, LPCSTR, const GUID *, DWORD,
                              LPVOID, LPDIRECTXFILEDATA *) PURE;
  STDMETHOD(SaveData)(THIS_ LPDIRECTXFILEDATA) PURE;
};
#undef INTERFACE
#if !defined(__cplusplus) || defined(CINTERFACE)
/*** IUnknown methods ***/
#define IDirectXFileSaveObject_QueryInterface(p, a, b)                         \
  (p)->lpVtbl->QueryInterface(p, a, b)
#define IDirectXFileSaveObject_AddRef(p) (p)->lpVtbl->AddRef(p)
#define IDirectXFileSaveObject_Release(p) (p)->lpVtbl->Release(p)
/*** IDirectXFileSaveObject methods ***/
#define IDirectXFileSaveObject_SaveTemplates(p, a, b)                          \
  (p)->lpVtbl->SaveTemplates(p, a, b)
#define IDirectXFileSaveObject_CreateDataObject(p, a, b, c, d, e, f)           \
...
DECLARE_INTERFACE_(IDirectXFileData, IDirectXFileObject) {
  ...
  STDMETHOD(AddBinaryObject)(THIS_ LPCSTR, const GUID *, LPCSTR, LPVOID, DWORD)
      PURE;
};
#undef INTERFACE
#if !defined(__cplusplus) || defined(CINTERFACE)
/*** IUnknown methods ***/
#define IDirectXFileData_QueryInterface(p, a, b)                               \
  (p)->lpVtbl->QueryInterface(p, a, b)
...
#define IDirectXFileData_AddDataReference(p, a, b)                             \
  (p)->lpVtbl->AddDataReference(p, a, b)
#define IDirectXFileData_AddBinaryObject(p, a, b, c, d, e)                     \
...
#if !defined(__cplusplus) || defined(CINTERFACE)
/*** IUnknown methods ***/
#define IDirectXFileDataReference_QueryInterface(p, a, b)                      \
  (p)->lpVtbl->QueryInterface(p, a, b)
...
#if !defined(__cplusplus) || defined(CINTERFACE)
/*** IUnknown methods ***/
#define IDirectXFileBinary_QueryInterface(p, a, b)                             \
  (p)->lpVtbl->QueryInterface(p, a, b)
...
DEFINE_GUID(IID_IDirectXFile, 0x3d82ab40, 0x62da, 0x11cf, 0xab, 0x39, 0x00,
...
DEFINE_GUID(IID_IDirectXFileObject, 0x3d82ab43, 0x62da, 0x11cf, 0xab, 0x39,
            0x00, 0x20, 0xaf, 0x71, 0xe4, 0x33);
DEFINE_GUID(IID_IDirectXFileData, 0x3d82ab44, 0x62da, 0x11cf, 0xab, 0x39, 0x00,
            0x20, 0xaf, 0x71, 0xe4, 0x33);
DEFINE_GUID(IID_IDirectXFileDataReference, 0x3d82ab45, 0x62da, 0x11cf, 0xab,
            0x39, 0x00, 0x20, 0xaf, 0x71, 0xe4, 0x33);
DEFINE_GUID(IID_IDirectXFileBinary, 0x3d82ab46, 0x62da, 0x11cf, 0xab, 0x39,
            0x00, 0x20, 0xaf, 0x71, 0xe4, 0x33);
/* DirectX File Header template's GUID */
DEFINE_GUID(TID_DXFILEHeader, 0x3d82ab43, 0x62da, 0x11cf, 0xab, 0x39, 0x00,
            0x20, 0xaf, 0x71, 0xe4, 0x33);
/* DirectX File errors */
#define _FACDD 0x876
