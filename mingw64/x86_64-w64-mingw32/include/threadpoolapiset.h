...
typedef VOID(WINAPI *PTP_WIN32_IO_CALLBACK)(PTP_CALLBACK_INSTANCE Instance,
...
WINBASEAPI VOID WINAPI SetThreadpoolThreadMaximum(PTP_POOL ptpp,
                                                  DWORD cthrdMost);
WINBASEAPI WINBOOL WINAPI SetThreadpoolThreadMinimum(PTP_POOL ptpp,
                                                     DWORD cthrdMic);
WINBASEAPI WINBOOL WINAPI
SetThreadpoolStackInformation(PTP_POOL ptpp, PTP_POOL_STACK_INFORMATION ptpsi);
WINBASEAPI WINBOOL WINAPI QueryThreadpoolStackInformation(
    PTP_POOL ptpp, PTP_POOL_STACK_INFORMATION ptpsi);
...
WINBASEAPI VOID WINAPI CloseThreadpoolCleanupGroupMembers(
    PTP_CLEANUP_GROUP ptpcg, WINBOOL fCancelPendingCallbacks,
    PVOID pvCleanupContext);
WINBASEAPI VOID WINAPI CloseThreadpoolCleanupGroup(PTP_CLEANUP_GROUP ptpcg);
WINBASEAPI VOID WINAPI SetEventWhenCallbackReturns(PTP_CALLBACK_INSTANCE pci,
                                                   HANDLE evt);
WINBASEAPI VOID WINAPI ReleaseSemaphoreWhenCallbackReturns(
    PTP_CALLBACK_INSTANCE pci, HANDLE sem, DWORD crel);
...
WINBASEAPI VOID WINAPI FreeLibraryWhenCallbackReturns(PTP_CALLBACK_INSTANCE pci,
                                                      HMODULE mod);
...
WINBASEAPI PTP_WORK WINAPI CreateThreadpoolWork(PTP_WORK_CALLBACK pfnwk,
                                                PVOID pv,
                                                PTP_CALLBACK_ENVIRON pcbe);
WINBASEAPI VOID WINAPI SubmitThreadpoolWork(PTP_WORK pwk);
WINBASEAPI VOID WINAPI
WaitForThreadpoolWorkCallbacks(PTP_WORK pwk, WINBOOL fCancelPendingCallbacks);
WINBASEAPI VOID WINAPI CloseThreadpoolWork(PTP_WORK pwk);
WINBASEAPI PTP_TIMER WINAPI CreateThreadpoolTimer(PTP_TIMER_CALLBACK pfnti,
                                                  PVOID pv,
                                                  PTP_CALLBACK_ENVIRON pcbe);
WINBASEAPI VOID WINAPI SetThreadpoolTimer(PTP_TIMER pti, PFILETIME pftDueTime,
                                          DWORD msPeriod, DWORD msWindowLength);
WINBASEAPI WINBOOL WINAPI IsThreadpoolTimerSet(PTP_TIMER pti);
WINBASEAPI VOID WINAPI
WaitForThreadpoolTimerCallbacks(PTP_TIMER pti, WINBOOL fCancelPendingCallbacks);
WINBASEAPI VOID WINAPI CloseThreadpoolTimer(PTP_TIMER pti);
WINBASEAPI PTP_WAIT WINAPI CreateThreadpoolWait(PTP_WAIT_CALLBACK pfnwa,
                                                PVOID pv,
                                                PTP_CALLBACK_ENVIRON pcbe);
WINBASEAPI VOID WINAPI SetThreadpoolWait(PTP_WAIT pwa, HANDLE h,
                                         PFILETIME pftTimeout);
WINBASEAPI VOID WINAPI
WaitForThreadpoolWaitCallbacks(PTP_WAIT pwa, WINBOOL fCancelPendingCallbacks);
WINBASEAPI VOID WINAPI CloseThreadpoolWait(PTP_WAIT pwa);
WINBASEAPI PTP_IO WINAPI CreateThreadpoolIo(HANDLE fl,
...
WINBASEAPI VOID WINAPI
WaitForThreadpoolIoCallbacks(PTP_IO pio, WINBOOL fCancelPendingCallbacks);
WINBASEAPI VOID WINAPI CloseThreadpoolIo(PTP_IO pio);
WINBASEAPI WINBOOL WINAPI SetThreadpoolTimerEx(PTP_TIMER pti,
                                               PFILETIME pftDueTime,
                                               DWORD msPeriod,
                                               DWORD msWindowLength);
WINBASEAPI WINBOOL WINAPI SetThreadpoolWaitEx(PTP_WAIT pwa, HANDLE h,
                                              PFILETIME pftTimeout,
                                              PVOID Reserved);
#endif
#endif
