...
extern const MSDASQLDECLSPEC GUID IID_ISQLRequestDiagFields = {
    ...
    0xb5ff,
    0x11d0,
    {0x8a, 0x80, 0x0, 0xc0, 0x4f, 0xd6, 0x11, 0xcd}};
...
public:
  virtual HRESULT WINAPI GetOriginalRow(HCHAPTER hReserved, HROW hRow,
                                        HROW *phRowOriginal) = 0;
  virtual HRESULT WINAPI GetPendingColumns(
      HCHAPTER hReserved, HROW hRow, ULONG cColumnOrdinals,
      const ULONG rgiOrdinals[], DBPENDINGSTATUS rgColumnStatus[]) = 0;
};
#else
typedef struct IRowsetChangeExtInfoVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IRowsetChangeExtInfo *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IRowsetChangeExtInfo *This);
  ULONG(WINAPI *Release)(IRowsetChangeExtInfo *This);
  HRESULT(WINAPI *GetOriginalRow)(IRowsetChangeExtInfo *This,
                                  HCHAPTER hReserved, HROW hRow,
                                  HROW *phRowOriginal);
  HRESULT(WINAPI *GetPendingColumns)(IRowsetChangeExtInfo *This,
                                     HCHAPTER hReserved, HROW hRow,
...
#define IRowsetChangeExtInfo_GetOriginalRow(This, hReserved, hRow,             \
                                            phRowOriginal)                     \
  (This)->lpVtbl->GetOriginalRow(This, hReserved, hRow, phRowOriginal)
#define IRowsetChangeExtInfo_GetPendingColumns(                                \
    This, hReserved, hRow, cColumnOrdinals, rgiOrdinals, rgColumnStatus)       \
  (This)->lpVtbl->GetPendingColumns(This, hReserved, hRow, cColumnOrdinals,    \
                                    rgiOrdinals, rgColumnStatus)
#endif
#endif
HRESULT WINAPI IRowsetChangeExtInfo_GetOriginalRow_Proxy(
    IRowsetChangeExtInfo *This, HCHAPTER hReserved, HROW hRow,
    HROW *phRowOriginal);
...
HRESULT WINAPI IRowsetChangeExtInfo_GetPendingColumns_Proxy(
    IRowsetChangeExtInfo *This, HCHAPTER hReserved, HROW hRow,
    ULONG cColumnOrdinals, const ULONG rgiOrdinals[],
    DBPENDINGSTATUS rgColumnStatus[]);
...
public:
  virtual HRESULT WINAPI RequestDiagFields(ULONG cDiagFields,
                                           KAGREQDIAG rgDiagFields[]) = 0;
};
#else
typedef struct ISQLRequestDiagFieldsVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ISQLRequestDiagFields *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ISQLRequestDiagFields *This);
  ULONG(WINAPI *Release)(ISQLRequestDiagFields *This);
  HRESULT(WINAPI *RequestDiagFields)(ISQLRequestDiagFields *This,
                                     ULONG cDiagFields,
                                     KAGREQDIAG rgDiagFields[]);
  END_INTERFACE
...
#define ISQLRequestDiagFields_RequestDiagFields(This, cDiagFields,             \
                                                rgDiagFields)                  \
  (This)->lpVtbl->RequestDiagFields(This, cDiagFields, rgDiagFields)
#endif
#endif
HRESULT WINAPI ISQLRequestDiagFields_RequestDiagFields_Proxy(
    ISQLRequestDiagFields *This, ULONG cDiagFields, KAGREQDIAG rgDiagFields[]);
...
typedef struct ISQLGetDiagFieldVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ISQLGetDiagField *This, REFIID riid,
                                  void **ppvObject);
...
#endif
#endif
HRESULT WINAPI ISQLGetDiagField_GetDiagField_Proxy(ISQLGetDiagField *This,
                                                   KAGGETDIAG *pDiagInfo);
