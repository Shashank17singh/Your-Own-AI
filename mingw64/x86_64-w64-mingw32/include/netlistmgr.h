...
DEFINE_GUID(IID_INetworkCostManager, 0xdcb00008, 0x570f, 0x4a9b, 0x8d, 0x69,
...
INetworkCostManager : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetCost(DWORD * pCost,
                                            NLM_SOCKADDR * pDestIPAddr) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetDataPlanStatus(
      NLM_DATAPLAN_STATUS * pDataPlanStatus, NLM_SOCKADDR * pDestIPAddr) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetDestinationAddresses(
      UINT32 length, NLM_SOCKADDR * pDestIPAddrList, VARIANT_BOOL bAppend) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(INetworkCostManager, 0xdcb00008, 0x570f, 0x4a9b, 0x8d, 0x69,
                0x19, 0x9f, 0xdb, 0xa5, 0x72, 0x3b)
#endif
#else
typedef struct INetworkCostManagerVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INetworkCostManager *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(INetworkCostManager *This);
  ULONG(STDMETHODCALLTYPE *Release)(INetworkCostManager *This);
  /*** INetworkCostManager methods ***/
  HRESULT(STDMETHODCALLTYPE *GetCost)(INetworkCostManager *This, DWORD *pCost,
                                      NLM_SOCKADDR *pDestIPAddr);
  HRESULT(STDMETHODCALLTYPE *GetDataPlanStatus)(
      INetworkCostManager *This, NLM_DATAPLAN_STATUS *pDataPlanStatus,
      NLM_SOCKADDR *pDestIPAddr);
  HRESULT(STDMETHODCALLTYPE *SetDestinationAddresses)(
      INetworkCostManager *This, UINT32 length, NLM_SOCKADDR *pDestIPAddrList,
      VARIANT_BOOL bAppend);
  END_INTERFACE
} INetworkCostManagerVtbl;
interface INetworkCostManager { CONST_VTBL INetworkCostManagerVtbl *lpVtbl; };
#ifdef COBJMACROS
...
#define INetworkCostManager_GetDataPlanStatus(This, pDataPlanStatus,           \
                                              pDestIPAddr)                     \
  (This)->lpVtbl->GetDataPlanStatus(This, pDataPlanStatus, pDestIPAddr)
#define INetworkCostManager_SetDestinationAddresses(This, length,              \
                                                    pDestIPAddrList, bAppend)  \
  (This)->lpVtbl->SetDestinationAddresses(This, length, pDestIPAddrList,       \
                                          bAppend)
#else
/*** IUnknown methods ***/
static inline HRESULT
INetworkCostManager_QueryInterface(INetworkCostManager *This, REFIID riid,
                                   void **ppvObject) {
...
/*** INetworkCostManager methods ***/
static inline HRESULT INetworkCostManager_GetCost(INetworkCostManager *This,
                                                  DWORD *pCost,
                                                  NLM_SOCKADDR *pDestIPAddr) {
  return This->lpVtbl->GetCost(This, pCost, pDestIPAddr);
}
static inline HRESULT
INetworkCostManager_GetDataPlanStatus(INetworkCostManager *This,
                                      NLM_DATAPLAN_STATUS *pDataPlanStatus,
                                      NLM_SOCKADDR *pDestIPAddr) {
  return This->lpVtbl->GetDataPlanStatus(This, pDataPlanStatus, pDestIPAddr);
}
static inline HRESULT INetworkCostManager_SetDestinationAddresses(
    INetworkCostManager *This, UINT32 length, NLM_SOCKADDR *pDestIPAddrList,
    VARIANT_BOOL bAppend) {
  return This->lpVtbl->SetDestinationAddresses(This, length, pDestIPAddrList,
                                               bAppend);
}
#endif
#endif
...
DEFINE_GUID(IID_INetworkConnectionCost, 0xdcb0000a, 0x570f, 0x4a9b, 0x8d, 0x69,
            0x19, 0x9f, 0xdb, 0xa5, 0x72, 0x3b);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
INetworkConnectionCost : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE GetDataPlanStatus(NLM_DATAPLAN_STATUS *
                                                      pDataPlanStatus) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(INetworkConnectionCost, 0xdcb0000a, 0x570f, 0x4a9b, 0x8d, 0x69,
                0x19, 0x9f, 0xdb, 0xa5, 0x72, 0x3b)
#endif
#else
typedef struct INetworkConnectionCostVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INetworkConnectionCost *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(INetworkConnectionCost *This);
  ULONG(STDMETHODCALLTYPE *Release)(INetworkConnectionCost *This);
  /*** INetworkConnectionCost methods ***/
  HRESULT(STDMETHODCALLTYPE *GetCost)(INetworkConnectionCost *This,
                                      DWORD *pCost);
  HRESULT(STDMETHODCALLTYPE *GetDataPlanStatus)(
      INetworkConnectionCost *This, NLM_DATAPLAN_STATUS *pDataPlanStatus);
  END_INTERFACE
...
/*** IUnknown methods ***/
static inline HRESULT
INetworkConnectionCost_QueryInterface(INetworkConnectionCost *This, REFIID riid,
                                      void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
INetworkConnectionCost_AddRef(INetworkConnectionCost *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
INetworkConnectionCost_Release(INetworkConnectionCost *This) {
  return This->lpVtbl->Release(This);
}
/*** INetworkConnectionCost methods ***/
static inline HRESULT
INetworkConnectionCost_GetCost(INetworkConnectionCost *This, DWORD *pCost) {
  return This->lpVtbl->GetCost(This, pCost);
}
static inline HRESULT
INetworkConnectionCost_GetDataPlanStatus(INetworkConnectionCost *This,
                                         NLM_DATAPLAN_STATUS *pDataPlanStatus) {
...
DEFINE_GUID(IID_INetworkCostManagerEvents, 0xdcb00009, 0x570f, 0x4a9b, 0x8d,
            0x69, 0x19, 0x9f, 0xdb, 0xa5, 0x72, 0x3b);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("dcb00009-570f-4a9b-8d69-199fdba5723b")
INetworkCostManagerEvents : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE CostChanged(DWORD newCost,
                                                NLM_SOCKADDR * pDestAddr) = 0;
  virtual HRESULT STDMETHODCALLTYPE DataPlanStatusChanged(NLM_SOCKADDR *
                                                          pDestAddr) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(INetworkCostManagerEvents, 0xdcb00009, 0x570f, 0x4a9b, 0x8d,
                0x69, 0x19, 0x9f, 0xdb, 0xa5, 0x72, 0x3b)
#endif
#else
typedef struct INetworkCostManagerEventsVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INetworkCostManagerEvents *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(INetworkCostManagerEvents *This);
  ULONG(STDMETHODCALLTYPE *Release)(INetworkCostManagerEvents *This);
  /*** INetworkCostManagerEvents methods ***/
  HRESULT(STDMETHODCALLTYPE *CostChanged)(INetworkCostManagerEvents *This,
                                          DWORD newCost,
                                          NLM_SOCKADDR *pDestAddr);
  HRESULT(STDMETHODCALLTYPE *DataPlanStatusChanged)(
      INetworkCostManagerEvents *This, NLM_SOCKADDR *pDestAddr);
  END_INTERFACE
...
/*** IUnknown methods ***/
static inline HRESULT
INetworkCostManagerEvents_QueryInterface(INetworkCostManagerEvents *This,
                                         REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
INetworkCostManagerEvents_AddRef(INetworkCostManagerEvents *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
INetworkCostManagerEvents_Release(INetworkCostManagerEvents *This) {
  return This->lpVtbl->Release(This);
}
/*** INetworkCostManagerEvents methods ***/
static inline HRESULT
INetworkCostManagerEvents_CostChanged(INetworkCostManagerEvents *This,
                                      DWORD newCost, NLM_SOCKADDR *pDestAddr) {
  return This->lpVtbl->CostChanged(This, newCost, pDestAddr);
}
static inline HRESULT
INetworkCostManagerEvents_DataPlanStatusChanged(INetworkCostManagerEvents *This,
                                                NLM_SOCKADDR *pDestAddr) {
...
DEFINE_GUID(IID_IEnumNetworks, 0xdcb00003, 0x570f, 0x4a9b, 0x8d, 0x69, 0x19,
            0x9f, 0xdb, 0xa5, 0x72, 0x3b);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IEnumNetworks, 0xdcb00003, 0x570f, 0x4a9b, 0x8d, 0x69, 0x19,
                0x9f, 0xdb, 0xa5, 0x72, 0x3b)
#endif
#else
typedef struct IEnumNetworksVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IEnumNetworks *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IEnumNetworks *This);
  ULONG(STDMETHODCALLTYPE *Release)(IEnumNetworks *This);
  /*** IDispatch methods ***/
  HRESULT(STDMETHODCALLTYPE *GetTypeInfoCount)(IEnumNetworks *This,
                                               UINT *pctinfo);
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(IEnumNetworks *This, UINT iTInfo,
                                          LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(IEnumNetworks *This, REFIID riid,
                                            LPOLESTR *rgszNames, UINT cNames,
                                            LCID lcid, DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(IEnumNetworks *This, DISPID dispIdMember,
                                     REFIID riid, LCID lcid, WORD wFlags,
                                     DISPPARAMS *pDispParams,
                                     VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                                     UINT *puArgErr);
  /*** IEnumNetworks methods ***/
  HRESULT(STDMETHODCALLTYPE *get__NewEnum)(IEnumNetworks *This,
                                           IEnumVARIANT **ppEnumVar);
  HRESULT(STDMETHODCALLTYPE *Next)(IEnumNetworks *This, ULONG celt,
                                   INetwork **rgelt, ULONG *pceltFetched);
  HRESULT(STDMETHODCALLTYPE *Skip)(IEnumNetworks *This, ULONG celt);
  HRESULT(STDMETHODCALLTYPE *Reset)(IEnumNetworks *This);
  HRESULT(STDMETHODCALLTYPE *Clone)(IEnumNetworks *This,
                                    IEnumNetworks **ppEnumNetwork);
  END_INTERFACE
} IEnumNetworksVtbl;
interface IEnumNetworks { CONST_VTBL IEnumNetworksVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define IEnumNetworks_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,       \
                                    rgDispId)                                  \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IEnumNetworks_Invoke(This, dispIdMember, riid, lcid, wFlags,           \
...
#else
/*** IUnknown methods ***/
static inline HRESULT IEnumNetworks_QueryInterface(IEnumNetworks *This,
                                                   REFIID riid,
                                                   void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IDispatch methods ***/
static inline HRESULT IEnumNetworks_GetTypeInfoCount(IEnumNetworks *This,
                                                     UINT *pctinfo) {
  return This->lpVtbl->GetTypeInfoCount(This, pctinfo);
}
static inline HRESULT IEnumNetworks_GetTypeInfo(IEnumNetworks *This,
                                                UINT iTInfo, LCID lcid,
                                                ITypeInfo **ppTInfo) {
  return This->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo);
}
static inline HRESULT IEnumNetworks_GetIDsOfNames(IEnumNetworks *This,
                                                  REFIID riid,
                                                  LPOLESTR *rgszNames,
...
static inline HRESULT
IEnumNetworks_Invoke(IEnumNetworks *This, DISPID dispIdMember, REFIID riid,
...
/*** IEnumNetworks methods ***/
static inline HRESULT IEnumNetworks_get__NewEnum(IEnumNetworks *This,
                                                 IEnumVARIANT **ppEnumVar) {
  return This->lpVtbl->get__NewEnum(This, ppEnumVar);
}
static inline HRESULT IEnumNetworks_Next(IEnumNetworks *This, ULONG celt,
                                         INetwork **rgelt,
                                         ULONG *pceltFetched) {
...
static inline HRESULT IEnumNetworks_Clone(IEnumNetworks *This,
                                          IEnumNetworks **ppEnumNetwork) {
...
DEFINE_GUID(IID_IEnumNetworkConnections, 0xdcb00006, 0x570f, 0x4a9b, 0x8d, 0x69,
            0x19, 0x9f, 0xdb, 0xa5, 0x72, 0x3b);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IEnumNetworkConnections : public IDispatch {
  ...
  virtual HRESULT STDMETHODCALLTYPE Next(
      ULONG celt, INetworkConnection * *rgelt, ULONG * pceltFetched) = 0;
  virtual HRESULT STDMETHODCALLTYPE Skip(ULONG celt) = 0;
  virtual HRESULT STDMETHODCALLTYPE Reset() = 0;
  virtual HRESULT STDMETHODCALLTYPE Clone(IEnumNetworkConnections *
                                          *ppEnumNetwork) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IEnumNetworkConnections, 0xdcb00006, 0x570f, 0x4a9b, 0x8d, 0x69,
                0x19, 0x9f, 0xdb, 0xa5, 0x72, 0x3b)
#endif
#else
typedef struct IEnumNetworkConnectionsVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IEnumNetworkConnections *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IEnumNetworkConnections *This);
  ULONG(STDMETHODCALLTYPE *Release)(IEnumNetworkConnections *This);
  /*** IDispatch methods ***/
  HRESULT(STDMETHODCALLTYPE *GetTypeInfoCount)(IEnumNetworkConnections *This,
                                               UINT *pctinfo);
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(IEnumNetworkConnections *This,
                                          UINT iTInfo, LCID lcid,
                                          ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(IEnumNetworkConnections *This,
                                            REFIID riid, LPOLESTR *rgszNames,
                                            UINT cNames, LCID lcid,
                                            DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(IEnumNetworkConnections *This,
  ...
  HRESULT(STDMETHODCALLTYPE *get__NewEnum)(IEnumNetworkConnections *This,
                                           IEnumVARIANT **ppEnumVar);
  HRESULT(STDMETHODCALLTYPE *Next)(IEnumNetworkConnections *This, ULONG celt,
  ...
  HRESULT(STDMETHODCALLTYPE *Clone)(IEnumNetworkConnections *This,
...
#define IEnumNetworkConnections_GetTypeInfo(This, iTInfo, lcid, ppTInfo)       \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IEnumNetworkConnections_GetIDsOfNames(This, riid, rgszNames, cNames,   \
                                              lcid, rgDispId)                  \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IEnumNetworkConnections_Invoke(This, dispIdMember, riid, lcid, wFlags, \
...
/*** IUnknown methods ***/
static inline HRESULT
IEnumNetworkConnections_QueryInterface(IEnumNetworkConnections *This,
                                       REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IEnumNetworkConnections_AddRef(IEnumNetworkConnections *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IEnumNetworkConnections_Release(IEnumNetworkConnections *This) {
  return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static inline HRESULT
IEnumNetworkConnections_GetTypeInfoCount(IEnumNetworkConnections *This,
                                         UINT *pctinfo) {
  return This->lpVtbl->GetTypeInfoCount(This, pctinfo);
}
static inline HRESULT
IEnumNetworkConnections_GetTypeInfo(IEnumNetworkConnections *This, UINT iTInfo,
                                    LCID lcid, ITypeInfo **ppTInfo) {
  return This->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo);
}
static inline HRESULT IEnumNetworkConnections_GetIDsOfNames(
    IEnumNetworkConnections *This, REFIID riid, LPOLESTR *rgszNames,
    UINT cNames, LCID lcid, DISPID *rgDispId) {
  return This->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid,
                                     rgDispId);
}
static inline HRESULT IEnumNetworkConnections_Invoke(
    IEnumNetworkConnections *This, DISPID dispIdMember, REFIID riid, LCID lcid,
...
/*** IEnumNetworkConnections methods ***/
static inline HRESULT
IEnumNetworkConnections_get__NewEnum(IEnumNetworkConnections *This,
                                     IEnumVARIANT **ppEnumVar) {
  return This->lpVtbl->get__NewEnum(This, ppEnumVar);
}
static inline HRESULT
IEnumNetworkConnections_Next(IEnumNetworkConnections *This, ULONG celt,
                             INetworkConnection **rgelt, ULONG *pceltFetched) {
  return This->lpVtbl->Next(This, celt, rgelt, pceltFetched);
}
static inline HRESULT
IEnumNetworkConnections_Skip(IEnumNetworkConnections *This, ULONG celt) {
  return This->lpVtbl->Skip(This, celt);
}
static inline HRESULT
IEnumNetworkConnections_Reset(IEnumNetworkConnections *This) {
  return This->lpVtbl->Reset(This);
}
static inline HRESULT
IEnumNetworkConnections_Clone(IEnumNetworkConnections *This,
                              IEnumNetworkConnections **ppEnumNetwork) {
  return This->lpVtbl->Clone(This, ppEnumNetwork);
}
#endif
...
INetworkListManager : public IDispatch {
  virtual HRESULT STDMETHODCALLTYPE GetNetworks(
      NLM_ENUM_NETWORK Flags, IEnumNetworks * *ppEnumNetwork) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE IsConnectedToInternet(VARIANT_BOOL *
                                                          pbIsConnected) = 0;
  virtual HRESULT STDMETHODCALLTYPE IsConnected(VARIANT_BOOL *
                                                pbIsConnected) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetConnectivity(NLM_CONNECTIVITY *
                                                    pConnectivity) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(INetworkListManager, 0xdcb00000, 0x570f, 0x4a9b, 0x8d, 0x69,
                0x19, 0x9f, 0xdb, 0xa5, 0x72, 0x3b)
#endif
#else
typedef struct INetworkListManagerVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INetworkListManager *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(INetworkListManager *This);
  ULONG(STDMETHODCALLTYPE *Release)(INetworkListManager *This);
  /*** IDispatch methods ***/
  HRESULT(STDMETHODCALLTYPE *GetTypeInfoCount)(INetworkListManager *This,
                                               UINT *pctinfo);
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(INetworkListManager *This,
                                          UINT iTInfo, LCID lcid,
                                          ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(INetworkListManager *This,
                                            REFIID riid, LPOLESTR *rgszNames,
                                            UINT cNames, LCID lcid,
                                            DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(INetworkListManager *This,
                                     DISPID dispIdMember, REFIID riid,
                                     LCID lcid, WORD wFlags,
                                     DISPPARAMS *pDispParams,
                                     VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
  ...
  HRESULT(STDMETHODCALLTYPE *GetNetworks)(INetworkListManager *This,
                                          NLM_ENUM_NETWORK Flags,
                                          IEnumNetworks **ppEnumNetwork);
  HRESULT(STDMETHODCALLTYPE *GetNetwork)(INetworkListManager *This,
                                         GUID gdNetworkId,
                                         INetwork **ppNetwork);
  HRESULT(STDMETHODCALLTYPE *GetNetworkConnections)(
      INetworkListManager *This, IEnumNetworkConnections **ppEnum);
  HRESULT(STDMETHODCALLTYPE *GetNetworkConnection)(
      INetworkListManager *This, GUID gdNetworkConnectionId,
      INetworkConnection **ppNetworkConnection);
  HRESULT(STDMETHODCALLTYPE *IsConnectedToInternet)(
      INetworkListManager *This, VARIANT_BOOL *pbIsConnected);
  HRESULT(STDMETHODCALLTYPE *IsConnected)(INetworkListManager *This,
                                          VARIANT_BOOL *pbIsConnected);
  HRESULT(STDMETHODCALLTYPE *GetConnectivity)(INetworkListManager *This,
                                              NLM_CONNECTIVITY *pConnectivity);
  END_INTERFACE
} INetworkListManagerVtbl;
interface INetworkListManager { CONST_VTBL INetworkListManagerVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define INetworkListManager_GetTypeInfo(This, iTInfo, lcid, ppTInfo)           \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define INetworkListManager_GetIDsOfNames(This, riid, rgszNames, cNames, lcid, \
                                          rgDispId)                            \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define INetworkListManager_Invoke(This, dispIdMember, riid, lcid, wFlags,     \
                                   pDispParams, pVarResult, pExcepInfo,        \
                                   puArgErr)                                   \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#define INetworkListManager_GetNetworkConnection(This, gdNetworkConnectionId,  \
                                                 ppNetworkConnection)          \
  (This)->lpVtbl->GetNetworkConnection(This, gdNetworkConnectionId,            \
                                       ppNetworkConnection)
#define INetworkListManager_IsConnectedToInternet(This, pbIsConnected)         \
  (This)->lpVtbl->IsConnectedToInternet(This, pbIsConnected)
#define INetworkListManager_IsConnected(This, pbIsConnected)                   \
  (This)->lpVtbl->IsConnected(This, pbIsConnected)
#define INetworkListManager_GetConnectivity(This, pConnectivity)               \
  (This)->lpVtbl->GetConnectivity(This, pConnectivity)
#else
/*** IUnknown methods ***/
static inline HRESULT
INetworkListManager_QueryInterface(INetworkListManager *This, REFIID riid,
                                   void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IDispatch methods ***/
static inline HRESULT
INetworkListManager_GetTypeInfoCount(INetworkListManager *This, UINT *pctinfo) {
  return This->lpVtbl->GetTypeInfoCount(This, pctinfo);
}
static inline HRESULT INetworkListManager_GetTypeInfo(INetworkListManager *This,
                                                      UINT iTInfo, LCID lcid,
                                                      ITypeInfo **ppTInfo) {
  return This->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo);
}
static inline HRESULT
INetworkListManager_GetIDsOfNames(INetworkListManager *This, REFIID riid,
...
static inline HRESULT
INetworkListManager_Invoke(INetworkListManager *This, DISPID dispIdMember,
                           REFIID riid, LCID lcid, WORD wFlags,
...
/*** INetworkListManager methods ***/
static inline HRESULT
INetworkListManager_GetNetworks(INetworkListManager *This,
                                NLM_ENUM_NETWORK Flags,
                                IEnumNetworks **ppEnumNetwork) {
  return This->lpVtbl->GetNetworks(This, Flags, ppEnumNetwork);
}
static inline HRESULT INetworkListManager_GetNetwork(INetworkListManager *This,
                                                     GUID gdNetworkId,
                                                     INetwork **ppNetwork) {
  return This->lpVtbl->GetNetwork(This, gdNetworkId, ppNetwork);
}
static inline HRESULT
INetworkListManager_GetNetworkConnections(INetworkListManager *This,
                                          IEnumNetworkConnections **ppEnum) {
  return This->lpVtbl->GetNetworkConnections(This, ppEnum);
}
static inline HRESULT INetworkListManager_GetNetworkConnection(
    INetworkListManager *This, GUID gdNetworkConnectionId,
    INetworkConnection **ppNetworkConnection) {
  return This->lpVtbl->GetNetworkConnection(This, gdNetworkConnectionId,
                                            ppNetworkConnection);
}
static inline HRESULT
INetworkListManager_IsConnectedToInternet(INetworkListManager *This,
                                          VARIANT_BOOL *pbIsConnected) {
  return This->lpVtbl->IsConnectedToInternet(This, pbIsConnected);
}
static inline HRESULT
INetworkListManager_IsConnected(INetworkListManager *This,
                                VARIANT_BOOL *pbIsConnected) {
  return This->lpVtbl->IsConnected(This, pbIsConnected);
}
static inline HRESULT
INetworkListManager_GetConnectivity(INetworkListManager *This,
                                    NLM_CONNECTIVITY *pConnectivity) {
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(NetworkListManager, 0xdcb00c01, 0x570f, 0x4a9b, 0x8d, 0x69,
                0x19, 0x9f, 0xdb, 0xa5, 0x72, 0x3b)
#endif
#endif
/*****************************************************************************
...
DEFINE_GUID(IID_INetworkListManagerEvents, 0xdcb00001, 0x570f, 0x4a9b, 0x8d,
            0x69, 0x19, 0x9f, 0xdb, 0xa5, 0x72, 0x3b);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(INetworkListManagerEvents, 0xdcb00001, 0x570f, 0x4a9b, 0x8d,
                0x69, 0x19, 0x9f, 0xdb, 0xa5, 0x72, 0x3b)
#endif
#else
typedef struct INetworkListManagerEventsVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INetworkListManagerEvents *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *ConnectivityChanged)(
      INetworkListManagerEvents *This, NLM_CONNECTIVITY newConnectivity);
  END_INTERFACE
...
/*** IUnknown methods ***/
static inline HRESULT
INetworkListManagerEvents_QueryInterface(INetworkListManagerEvents *This,
                                         REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
INetworkListManagerEvents_AddRef(INetworkListManagerEvents *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
INetworkListManagerEvents_Release(INetworkListManagerEvents *This) {
  return This->lpVtbl->Release(This);
}
/*** INetworkListManagerEvents methods ***/
static inline HRESULT INetworkListManagerEvents_ConnectivityChanged(
    INetworkListManagerEvents *This, NLM_CONNECTIVITY newConnectivity) {
...
DEFINE_GUID(IID_INetworkConnectionEvents, 0xdcb00007, 0x570f, 0x4a9b, 0x8d,
            0x69, 0x19, 0x9f, 0xdb, 0xa5, 0x72, 0x3b);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
INetworkConnectionEvents : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE NetworkConnectionConnectivityChanged(
      GUID connectionId, NLM_CONNECTIVITY newConnectivity) = 0;
  virtual HRESULT STDMETHODCALLTYPE NetworkConnectionPropertyChanged(
      GUID connectionId, NLM_CONNECTION_PROPERTY_CHANGE flags) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(INetworkConnectionEvents, 0xdcb00007, 0x570f, 0x4a9b, 0x8d,
                0x69, 0x19, 0x9f, 0xdb, 0xa5, 0x72, 0x3b)
#endif
#else
typedef struct INetworkConnectionEventsVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INetworkConnectionEvents *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *NetworkConnectionConnectivityChanged)(
      INetworkConnectionEvents *This, GUID connectionId,
...
/*** INetworkConnectionEvents methods ***/
#define INetworkConnectionEvents_NetworkConnectionConnectivityChanged(         \
    This, connectionId, newConnectivity)                                       \
  (This)->lpVtbl->NetworkConnectionConnectivityChanged(This, connectionId,     \
                                                       newConnectivity)
#define INetworkConnectionEvents_NetworkConnectionPropertyChanged(             \
    This, connectionId, flags)                                                 \
  (This)->lpVtbl->NetworkConnectionPropertyChanged(This, connectionId, flags)
#else
/*** IUnknown methods ***/
static inline HRESULT
INetworkConnectionEvents_QueryInterface(INetworkConnectionEvents *This,
                                        REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
INetworkConnectionEvents_AddRef(INetworkConnectionEvents *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
INetworkConnectionEvents_Release(INetworkConnectionEvents *This) {
  return This->lpVtbl->Release(This);
}
/*** INetworkConnectionEvents methods ***/
static inline HRESULT
INetworkConnectionEvents_NetworkConnectionConnectivityChanged(
    INetworkConnectionEvents *This, GUID connectionId,
    NLM_CONNECTIVITY newConnectivity) {
  return This->lpVtbl->NetworkConnectionConnectivityChanged(This, connectionId,
                                                            newConnectivity);
}
static inline HRESULT INetworkConnectionEvents_NetworkConnectionPropertyChanged(
    INetworkConnectionEvents *This, GUID connectionId,
    NLM_CONNECTION_PROPERTY_CHANGE flags) {
  return This->lpVtbl->NetworkConnectionPropertyChanged(This, connectionId,
                                                        flags);
}
#endif
#endif
...
DEFINE_GUID(IID_INetworkConnection, 0xdcb00005, 0x570f, 0x4a9b, 0x8d, 0x69,
            0x19, 0x9f, 0xdb, 0xa5, 0x72, 0x3b);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
INetworkConnection : public IDispatch {
  ...
  virtual HRESULT STDMETHODCALLTYPE get_IsConnected(VARIANT_BOOL *
                                                    pbIsConnected) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetConnectivity(NLM_CONNECTIVITY *
                                                    pConnectivity) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetDomainType(NLM_DOMAIN_TYPE *
                                                  pDomainType) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(INetworkConnection, 0xdcb00005, 0x570f, 0x4a9b, 0x8d, 0x69,
                0x19, 0x9f, 0xdb, 0xa5, 0x72, 0x3b)
#endif
#else
typedef struct INetworkConnectionVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INetworkConnection *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(INetworkConnection *This);
  ULONG(STDMETHODCALLTYPE *Release)(INetworkConnection *This);
  /*** IDispatch methods ***/
  HRESULT(STDMETHODCALLTYPE *GetTypeInfoCount)(INetworkConnection *This,
                                               UINT *pctinfo);
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(INetworkConnection *This, UINT iTInfo,
                                          LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(INetworkConnection *This,
                                            REFIID riid, LPOLESTR *rgszNames,
                                            UINT cNames, LCID lcid,
                                            DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(INetworkConnection *This,
                                     DISPID dispIdMember, REFIID riid,
                                     LCID lcid, WORD wFlags,
                                     DISPPARAMS *pDispParams,
                                     VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
  ...
  HRESULT(STDMETHODCALLTYPE *GetNetwork)(INetworkConnection *This,
                                         INetwork **ppNetwork);
  HRESULT(STDMETHODCALLTYPE *get_IsConnectedToInternet)(
      INetworkConnection *This, VARIANT_BOOL *pbIsConnected);
  HRESULT(STDMETHODCALLTYPE *get_IsConnected)(INetworkConnection *This,
                                              VARIANT_BOOL *pbIsConnected);
  HRESULT(STDMETHODCALLTYPE *GetConnectivity)(INetworkConnection *This,
                                              NLM_CONNECTIVITY *pConnectivity);
  HRESULT(STDMETHODCALLTYPE *GetConnectionId)(INetworkConnection *This,
                                              GUID *pgdConnectionId);
  HRESULT(STDMETHODCALLTYPE *GetAdapterId)(INetworkConnection *This,
                                           GUID *pgdAdapterId);
  HRESULT(STDMETHODCALLTYPE *GetDomainType)(INetworkConnection *This,
                                            NLM_DOMAIN_TYPE *pDomainType);
  END_INTERFACE
} INetworkConnectionVtbl;
interface INetworkConnection { CONST_VTBL INetworkConnectionVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define INetworkConnection_GetTypeInfo(This, iTInfo, lcid, ppTInfo)            \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define INetworkConnection_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,  \
                                         rgDispId)                             \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define INetworkConnection_Invoke(This, dispIdMember, riid, lcid, wFlags,      \
                                  pDispParams, pVarResult, pExcepInfo,         \
                                  puArgErr)                                    \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
/*** IUnknown methods ***/
static inline HRESULT
INetworkConnection_QueryInterface(INetworkConnection *This, REFIID riid,
                                  void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IDispatch methods ***/
static inline HRESULT
INetworkConnection_GetTypeInfoCount(INetworkConnection *This, UINT *pctinfo) {
  return This->lpVtbl->GetTypeInfoCount(This, pctinfo);
}
static inline HRESULT INetworkConnection_GetTypeInfo(INetworkConnection *This,
                                                     UINT iTInfo, LCID lcid,
                                                     ITypeInfo **ppTInfo) {
  return This->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo);
}
static inline HRESULT INetworkConnection_GetIDsOfNames(INetworkConnection *This,
                                                       REFIID riid,
                                                       LPOLESTR *rgszNames,
                                                       UINT cNames, LCID lcid,
                                                       DISPID *rgDispId) {
...
static inline HRESULT
INetworkConnection_Invoke(INetworkConnection *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr) {
  return This->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags,
...
/*** INetworkConnection methods ***/
static inline HRESULT INetworkConnection_GetNetwork(INetworkConnection *This,
                                                    INetwork **ppNetwork) {
  return This->lpVtbl->GetNetwork(This, ppNetwork);
}
static inline HRESULT
INetworkConnection_get_IsConnectedToInternet(INetworkConnection *This,
                                             VARIANT_BOOL *pbIsConnected) {
  return This->lpVtbl->get_IsConnectedToInternet(This, pbIsConnected);
}
static inline HRESULT
INetworkConnection_get_IsConnected(INetworkConnection *This,
                                   VARIANT_BOOL *pbIsConnected) {
  return This->lpVtbl->get_IsConnected(This, pbIsConnected);
}
static inline HRESULT
INetworkConnection_GetConnectivity(INetworkConnection *This,
                                   NLM_CONNECTIVITY *pConnectivity) {
  return This->lpVtbl->GetConnectivity(This, pConnectivity);
}
static inline HRESULT
INetworkConnection_GetConnectionId(INetworkConnection *This,
                                   GUID *pgdConnectionId) {
  return This->lpVtbl->GetConnectionId(This, pgdConnectionId);
}
static inline HRESULT INetworkConnection_GetAdapterId(INetworkConnection *This,
                                                      GUID *pgdAdapterId) {
  return This->lpVtbl->GetAdapterId(This, pgdAdapterId);
}
static inline HRESULT
INetworkConnection_GetDomainType(INetworkConnection *This,
                                 NLM_DOMAIN_TYPE *pDomainType) {
...
DEFINE_GUID(IID_INetwork, 0xdcb00002, 0x570f, 0x4a9b, 0x8d, 0x69, 0x19, 0x9f,
            0xdb, 0xa5, 0x72, 0x3b);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
INetwork : public IDispatch {
  ...
  virtual HRESULT STDMETHODCALLTYPE GetTimeCreatedAndConnected(
      DWORD * pdwLowDateTimeCreated, DWORD * pdwHighDateTimeCreated,
      DWORD * pdwLowDateTimeConnected, DWORD * pdwHighDateTimeConnected) = 0;
  virtual HRESULT STDMETHODCALLTYPE get_IsConnectedToInternet(
      VARIANT_BOOL * pbIsConnected) = 0;
  virtual HRESULT STDMETHODCALLTYPE get_IsConnected(VARIANT_BOOL *
                                                    pbIsConnected) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetConnectivity(NLM_CONNECTIVITY *
                                                    pConnectivity) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetCategory(NLM_NETWORK_CATEGORY *
                                                pCategory) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetCategory(
      NLM_NETWORK_CATEGORY NewCategory) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(INetwork, 0xdcb00002, 0x570f, 0x4a9b, 0x8d, 0x69, 0x19, 0x9f,
                0xdb, 0xa5, 0x72, 0x3b)
#endif
#else
typedef struct INetworkVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INetwork *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(INetwork *This, UINT iTInfo,
                                          LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(INetwork *This, REFIID riid,
                                            LPOLESTR *rgszNames, UINT cNames,
                                            LCID lcid, DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(INetwork *This, DISPID dispIdMember,
                                     REFIID riid, LCID lcid, WORD wFlags,
                                     DISPPARAMS *pDispParams,
                                     VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                                     UINT *puArgErr);
  ...
  HRESULT(STDMETHODCALLTYPE *GetDescription)(INetwork *This,
                                             BSTR *pszDescription);
  HRESULT(STDMETHODCALLTYPE *SetDescription)(INetwork *This,
                                             BSTR szDescription);
  HRESULT(STDMETHODCALLTYPE *GetNetworkId)(INetwork *This,
                                           GUID *pgdGuidNetworkId);
  HRESULT(STDMETHODCALLTYPE *GetDomainType)(INetwork *This,
                                            NLM_DOMAIN_TYPE *pNetworkType);
  HRESULT(STDMETHODCALLTYPE *GetNetworkConnections)(
      INetwork *This, IEnumNetworkConnections **ppEnumNetworkConnection);
  HRESULT(STDMETHODCALLTYPE *GetTimeCreatedAndConnected)(
      INetwork *This, DWORD *pdwLowDateTimeCreated,
      DWORD *pdwHighDateTimeCreated, DWORD *pdwLowDateTimeConnected,
      DWORD *pdwHighDateTimeConnected);
  HRESULT(STDMETHODCALLTYPE *get_IsConnectedToInternet)(
      INetwork *This, VARIANT_BOOL *pbIsConnected);
  HRESULT(STDMETHODCALLTYPE *get_IsConnected)(INetwork *This,
                                              VARIANT_BOOL *pbIsConnected);
  HRESULT(STDMETHODCALLTYPE *GetConnectivity)(INetwork *This,
                                              NLM_CONNECTIVITY *pConnectivity);
  HRESULT(STDMETHODCALLTYPE *GetCategory)(INetwork *This,
                                          NLM_NETWORK_CATEGORY *pCategory);
  HRESULT(STDMETHODCALLTYPE *SetCategory)(INetwork *This,
                                          NLM_NETWORK_CATEGORY NewCategory);
  END_INTERFACE
} INetworkVtbl;
interface INetwork { CONST_VTBL INetworkVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define INetwork_GetTimeCreatedAndConnected(                                   \
    This, pdwLowDateTimeCreated, pdwHighDateTimeCreated,                       \
    pdwLowDateTimeConnected, pdwHighDateTimeConnected)                         \
  (This)->lpVtbl->GetTimeCreatedAndConnected(                                  \
      This, pdwLowDateTimeCreated, pdwHighDateTimeCreated,                     \
      pdwLowDateTimeConnected, pdwHighDateTimeConnected)
...
#else
/*** IUnknown methods ***/
static inline HRESULT INetwork_QueryInterface(INetwork *This, REFIID riid,
                                              void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
static inline HRESULT INetwork_GetTypeInfo(INetwork *This, UINT iTInfo,
                                           LCID lcid, ITypeInfo **ppTInfo) {
  return This->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo);
}
static inline HRESULT INetwork_GetIDsOfNames(INetwork *This, REFIID riid,
                                             LPOLESTR *rgszNames, UINT cNames,
                                             LCID lcid, DISPID *rgDispId) {
  return This->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid,
                                     rgDispId);
}
static inline HRESULT INetwork_Invoke(INetwork *This, DISPID dispIdMember,
                                      REFIID riid, LCID lcid, WORD wFlags,
                                      DISPPARAMS *pDispParams,
                                      VARIANT *pVarResult,
                                      EXCEPINFO *pExcepInfo, UINT *puArgErr) {
...
static inline HRESULT INetwork_GetDescription(INetwork *This,
                                              BSTR *pszDescription) {
  return This->lpVtbl->GetDescription(This, pszDescription);
}
static inline HRESULT INetwork_SetDescription(INetwork *This,
                                              BSTR szDescription) {
  return This->lpVtbl->SetDescription(This, szDescription);
}
static inline HRESULT INetwork_GetNetworkId(INetwork *This,
                                            GUID *pgdGuidNetworkId) {
  return This->lpVtbl->GetNetworkId(This, pgdGuidNetworkId);
}
static inline HRESULT INetwork_GetDomainType(INetwork *This,
                                             NLM_DOMAIN_TYPE *pNetworkType) {
  return This->lpVtbl->GetDomainType(This, pNetworkType);
}
static inline HRESULT INetwork_GetNetworkConnections(
    INetwork *This, IEnumNetworkConnections **ppEnumNetworkConnection) {
  return This->lpVtbl->GetNetworkConnections(This, ppEnumNetworkConnection);
}
static inline HRESULT INetwork_GetTimeCreatedAndConnected(
    INetwork *This, DWORD *pdwLowDateTimeCreated, DWORD *pdwHighDateTimeCreated,
    DWORD *pdwLowDateTimeConnected, DWORD *pdwHighDateTimeConnected) {
  return This->lpVtbl->GetTimeCreatedAndConnected(
      This, pdwLowDateTimeCreated, pdwHighDateTimeCreated,
      pdwLowDateTimeConnected, pdwHighDateTimeConnected);
}
static inline HRESULT
INetwork_get_IsConnectedToInternet(INetwork *This,
                                   VARIANT_BOOL *pbIsConnected) {
  return This->lpVtbl->get_IsConnectedToInternet(This, pbIsConnected);
}
static inline HRESULT INetwork_get_IsConnected(INetwork *This,
                                               VARIANT_BOOL *pbIsConnected) {
  return This->lpVtbl->get_IsConnected(This, pbIsConnected);
}
static inline HRESULT
INetwork_GetConnectivity(INetwork *This, NLM_CONNECTIVITY *pConnectivity) {
  return This->lpVtbl->GetConnectivity(This, pConnectivity);
}
static inline HRESULT INetwork_GetCategory(INetwork *This,
                                           NLM_NETWORK_CATEGORY *pCategory) {
  return This->lpVtbl->GetCategory(This, pCategory);
}
static inline HRESULT INetwork_SetCategory(INetwork *This,
                                           NLM_NETWORK_CATEGORY NewCategory) {
...
DEFINE_GUID(IID_INetworkEvents, 0xdcb00004, 0x570f, 0x4a9b, 0x8d, 0x69, 0x19,
            0x9f, 0xdb, 0xa5, 0x72, 0x3b);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
INetworkEvents : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE NetworkConnectivityChanged(
      GUID networkId, NLM_CONNECTIVITY newConnectivity) = 0;
  virtual HRESULT STDMETHODCALLTYPE NetworkPropertyChanged(
      GUID networkId, NLM_NETWORK_PROPERTY_CHANGE flags) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(INetworkEvents, 0xdcb00004, 0x570f, 0x4a9b, 0x8d, 0x69, 0x19,
                0x9f, 0xdb, 0xa5, 0x72, 0x3b)
#endif
#else
typedef struct INetworkEventsVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INetworkEvents *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *NetworkAdded)(INetworkEvents *This,
                                           GUID networkId);
  HRESULT(STDMETHODCALLTYPE *NetworkDeleted)(INetworkEvents *This,
                                             GUID networkId);
  HRESULT(STDMETHODCALLTYPE *NetworkConnectivityChanged)(
      INetworkEvents *This, GUID networkId, NLM_CONNECTIVITY newConnectivity);
  HRESULT(STDMETHODCALLTYPE *NetworkPropertyChanged)(
      INetworkEvents *This, GUID networkId, NLM_NETWORK_PROPERTY_CHANGE flags);
  END_INTERFACE
} INetworkEventsVtbl;
interface INetworkEvents { CONST_VTBL INetworkEventsVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define INetworkEvents_NetworkConnectivityChanged(This, networkId,             \
                                                  newConnectivity)             \
...
#else
/*** IUnknown methods ***/
static inline HRESULT INetworkEvents_QueryInterface(INetworkEvents *This,
                                                    REFIID riid,
                                                    void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** INetworkEvents methods ***/
static inline HRESULT INetworkEvents_NetworkAdded(INetworkEvents *This,
                                                  GUID networkId) {
  return This->lpVtbl->NetworkAdded(This, networkId);
}
static inline HRESULT INetworkEvents_NetworkDeleted(INetworkEvents *This,
                                                    GUID networkId) {
  return This->lpVtbl->NetworkDeleted(This, networkId);
}
static inline HRESULT
INetworkEvents_NetworkConnectivityChanged(INetworkEvents *This, GUID networkId,
                                          NLM_CONNECTIVITY newConnectivity) {
  return This->lpVtbl->NetworkConnectivityChanged(This, networkId,
                                                  newConnectivity);
}
static inline HRESULT
INetworkEvents_NetworkPropertyChanged(INetworkEvents *This, GUID networkId,
