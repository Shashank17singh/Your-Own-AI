...
NET_API_STATUS WINAPI NetServerEnumEx(LMCSTR ServerName, DWORD Level,
                                      LPBYTE *Bufptr, DWORD PrefMaxlen,
                                      LPDWORD EntriesRead, LPDWORD totalentries,
                                      DWORD servertype, LMCSTR domain,
                                      LMCSTR FirstNameToReturn);
NET_API_STATUS WINAPI NetServerGetInfo(LMSTR servername, DWORD level,
                                       LPBYTE *bufptr);
NET_API_STATUS WINAPI NetServerSetInfo(LMSTR servername, DWORD level,
                                       LPBYTE buf, LPDWORD ParmError);
NET_API_STATUS NetServerSetInfoCommandLine(WORD argc, LMSTR argv[]);
NET_API_STATUS WINAPI NetServerDiskEnum(LMSTR servername, DWORD level,
                                        LPBYTE *bufptr, DWORD prefmaxlen,
                                        LPDWORD entriesread,
                                        LPDWORD totalentries,
                                        LPDWORD resume_handle);
NET_API_STATUS WINAPI NetServerComputerNameAdd(LMSTR ServerName,
                                               LMSTR EmulatedDomainName,
                                               LMSTR EmulatedServerName);
NET_API_STATUS WINAPI NetServerComputerNameDel(LMSTR ServerName,
                                               LMSTR EmulatedServerName);
NET_API_STATUS WINAPI NetServerTransportAdd(LMSTR servername, DWORD level,
                                            LPBYTE bufptr);
NET_API_STATUS WINAPI NetServerTransportAddEx(LMSTR servername, DWORD level,
                                              LPBYTE bufptr);
NET_API_STATUS WINAPI NetServerTransportDel(LMSTR servername, DWORD level,
                                            LPBYTE bufptr);
NET_API_STATUS WINAPI NetServerTransportEnum(LMSTR servername, DWORD level,
                                             LPBYTE *bufptr, DWORD prefmaxlen,
                                             LPDWORD entriesread,
                                             LPDWORD totalentries,
                                             LPDWORD resumehandle);
WINBOOL WINAPI SetServiceBits(SERVICE_STATUS_HANDLE hServiceStatus,
                              DWORD dwServiceBits, WINBOOL bSetBitsOn,
