...
#endif
#include <lmcons.h>
NET_API_STATUS WINAPI NetShareAdd(LMSTR servername, DWORD level, LPBYTE buf,
                                  LPDWORD parm_err);
...
NET_API_STATUS WINAPI NetShareEnumSticky(LMSTR servername, DWORD level,
                                         LPBYTE *bufptr, DWORD prefmaxlen,
                                         LPDWORD entriesread,
...
NET_API_STATUS WINAPI NetShareSetInfo(LMSTR servername, LMSTR netname,
                                      DWORD level, LPBYTE buf,
                                      LPDWORD parm_err);
NET_API_STATUS WINAPI NetShareDel(LMSTR servername, LMSTR netname,
                                  DWORD reserved);
NET_API_STATUS WINAPI NetShareDelSticky(LMSTR servername, LMSTR netname,
                                        DWORD reserved);
NET_API_STATUS WINAPI NetShareCheck(LMSTR servername, LMSTR device,
                                    LPDWORD type);
...
NET_API_STATUS WINAPI NetSessionEnum(LMSTR servername, LMSTR UncClientName,
                                     LMSTR username, DWORD level,
                                     LPBYTE *bufptr, DWORD prefmaxlen,
                                     LPDWORD entriesread, LPDWORD totalentries,
                                     LPDWORD resume_handle);
NET_API_STATUS WINAPI NetSessionDel(LMSTR servername, LMSTR UncClientName,
                                    LMSTR username);
NET_API_STATUS WINAPI NetSessionGetInfo(LMSTR servername, LMSTR UncClientName,
                                        LMSTR username, DWORD level,
                                        LPBYTE *bufptr);
...
NET_API_STATUS WINAPI NetConnectionEnum(LMSTR servername, LMSTR qualifier,
                                        DWORD level, LPBYTE *bufptr,
...
NET_API_STATUS WINAPI NetFileEnum(LMSTR servername, LMSTR basepath,
                                  LMSTR username, DWORD level, LPBYTE *bufptr,
                                  DWORD prefmaxlen, LPDWORD entriesread,
                                  LPDWORD totalentries,
                                  PDWORD_PTR resume_handle);
NET_API_STATUS WINAPI NetFileGetInfo(LMSTR servername, DWORD fileid,
                                     DWORD level, LPBYTE *bufptr);
