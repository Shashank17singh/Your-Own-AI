...
public:
  virtual HRESULT WINAPI Init(BSTR pName, BLOB_CHARACTER_SET CharacterSet,
                              BSTR pBlob) = 0;
  virtual HRESULT WINAPI
  get_CharacterSet(BLOB_CHARACTER_SET *pCharacterSet) = 0;
  virtual HRESULT WINAPI get_ConferenceBlob(BSTR *ppBlob) = 0;
  virtual HRESULT WINAPI SetConferenceBlob(BLOB_CHARACTER_SET CharacterSet,
                                           BSTR pBlob) = 0;
};
#else
typedef struct ITConferenceBlobVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITConferenceBlob *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITConferenceBlob *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITConferenceBlob *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITConferenceBlob *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *Init)(ITConferenceBlob *This, BSTR pName,
                        BLOB_CHARACTER_SET CharacterSet, BSTR pBlob);
  HRESULT(WINAPI *get_CharacterSet)(ITConferenceBlob *This,
                                    BLOB_CHARACTER_SET *pCharacterSet);
  HRESULT(WINAPI *get_ConferenceBlob)(ITConferenceBlob *This, BSTR *ppBlob);
  HRESULT(WINAPI *SetConferenceBlob)(ITConferenceBlob *This,
...
#define ITConferenceBlob_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,    \
                                       rgDispId)                               \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITConferenceBlob_Invoke(This, dispIdMember, riid, lcid, wFlags,        \
...
#endif
#endif
HRESULT WINAPI ITConferenceBlob_Init_Proxy(ITConferenceBlob *This, BSTR pName,
                                           BLOB_CHARACTER_SET CharacterSet,
                                           BSTR pBlob);
...
HRESULT WINAPI ITConferenceBlob_get_CharacterSet_Proxy(
    ITConferenceBlob *This, BLOB_CHARACTER_SET *pCharacterSet);
void __RPC_STUB ITConferenceBlob_get_CharacterSet_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITConferenceBlob_get_ConferenceBlob_Proxy(ITConferenceBlob *This,
                                                         BSTR *ppBlob);
void __RPC_STUB ITConferenceBlob_get_ConferenceBlob_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITConferenceBlob_SetConferenceBlob_Proxy(
    ITConferenceBlob *This, BLOB_CHARACTER_SET CharacterSet, BSTR pBlob);
...
typedef struct ITMediaVtbl {
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITMedia *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITMedia *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITMedia *This, DISPID dispIdMember, REFIID riid,
...
void __RPC_STUB ITMedia_get_NumPorts_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI ITMedia_get_TransportProtocol_Proxy(ITMedia *This,
                                                   BSTR *ppProtocol);
void __RPC_STUB ITMedia_get_TransportProtocol_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITMedia_put_TransportProtocol_Proxy(ITMedia *This,
                                                   BSTR pProtocol);
...
void __RPC_STUB ITMedia_put_MediaTitle_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITMedia_SetPortInfo_Proxy(ITMedia *This, LONG StartPort,
                                         LONG NumPorts);
void __RPC_STUB ITMedia_SetPortInfo_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
#endif
...
public:
  virtual HRESULT WINAPI Next(ULONG celt, ITMedia **pVal,
...
typedef struct IEnumMediaVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IEnumMedia *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IEnumMedia *This);
  ULONG(WINAPI *Release)(IEnumMedia *This);
  HRESULT(WINAPI *Next)(IEnumMedia *This, ULONG celt, ITMedia **pVal,
                        ULONG *pceltFetched);
...
#endif
#endif
HRESULT WINAPI IEnumMedia_Next_Proxy(IEnumMedia *This, ULONG celt,
                                     ITMedia **pVal, ULONG *pceltFetched);
void __RPC_STUB IEnumMedia_Next_Stub(IRpcStubBuffer *This,
                                     IRpcChannelBuffer *_pRpcChannelBuffer,
                                     PRPC_MESSAGE _pRpcMessage,
                                     DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumMedia_Reset_Proxy(IEnumMedia *This);
void __RPC_STUB IEnumMedia_Reset_Stub(IRpcStubBuffer *This,
                                      IRpcChannelBuffer *_pRpcChannelBuffer,
                                      PRPC_MESSAGE _pRpcMessage,
                                      DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumMedia_Skip_Proxy(IEnumMedia *This, ULONG celt);
void __RPC_STUB IEnumMedia_Skip_Stub(IRpcStubBuffer *This,
                                     IRpcChannelBuffer *_pRpcChannelBuffer,
                                     PRPC_MESSAGE _pRpcMessage,
                                     DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumMedia_Clone_Proxy(IEnumMedia *This, IEnumMedia **ppEnum);
void __RPC_STUB IEnumMedia_Clone_Stub(IRpcStubBuffer *This,
                                      IRpcChannelBuffer *_pRpcChannelBuffer,
                                      PRPC_MESSAGE _pRpcMessage,
                                      DWORD *_pdwStubPhase);
#endif
...
typedef struct ITMediaCollectionVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITMediaCollection *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITMediaCollection *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITMediaCollection *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITMediaCollection *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *get_Count)(ITMediaCollection *This, LONG *pVal);
  HRESULT(WINAPI *get_Item)(ITMediaCollection *This, LONG Index,
                            ITMedia **pVal);
  HRESULT(WINAPI *get__NewEnum)(ITMediaCollection *This, IUnknown **pVal);
  HRESULT(WINAPI *get_EnumerationIf)(ITMediaCollection *This,
                                     IEnumMedia **pVal);
  HRESULT(WINAPI *Create)(ITMediaCollection *This, LONG Index,
                          ITMedia **ppMedia);
...
#define ITMediaCollection_GetTypeInfo(This, iTInfo, lcid, ppTInfo)             \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITMediaCollection_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,   \
                                        rgDispId)                              \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITMediaCollection_Invoke(This, dispIdMember, riid, lcid, wFlags,       \
...
#endif
#endif
HRESULT WINAPI ITMediaCollection_get_Count_Proxy(ITMediaCollection *This,
                                                 LONG *pVal);
void __RPC_STUB ITMediaCollection_get_Count_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITMediaCollection_get_Item_Proxy(ITMediaCollection *This,
                                                LONG Index, ITMedia **pVal);
void __RPC_STUB ITMediaCollection_get_Item_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITMediaCollection_get__NewEnum_Proxy(ITMediaCollection *This,
                                                    IUnknown **pVal);
void __RPC_STUB ITMediaCollection_get__NewEnum_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITMediaCollection_get_EnumerationIf_Proxy(
    ITMediaCollection *This, IEnumMedia **pVal);
void __RPC_STUB ITMediaCollection_get_EnumerationIf_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITMediaCollection_Create_Proxy(ITMediaCollection *This,
                                              LONG Index, ITMedia **ppMedia);
void __RPC_STUB ITMediaCollection_Create_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITMediaCollection_Delete_Proxy(ITMediaCollection *This,
                                              LONG Index);
...
typedef struct ITTimeVtbl {
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITTime *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITTime *This, REFIID riid, LPOLESTR *rgszNames,
                                 UINT cNames, LCID lcid, DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITTime *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
...
void __RPC_STUB ITTime_get_StartTime_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI ITTime_put_StartTime_Proxy(ITTime *This, DOUBLE Time);
void __RPC_STUB ITTime_put_StartTime_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI ITTime_get_StopTime_Proxy(ITTime *This, DOUBLE *pTime);
void __RPC_STUB ITTime_get_StopTime_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
HRESULT WINAPI ITTime_put_StopTime_Proxy(ITTime *This, DOUBLE Time);
void __RPC_STUB ITTime_put_StopTime_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
#endif
...
public:
  virtual HRESULT WINAPI Next(ULONG celt, ITTime **pVal,
                              ULONG *pceltFetched) = 0;
  virtual HRESULT WINAPI Reset(void) = 0;
  virtual HRESULT WINAPI Skip(ULONG celt) = 0;
...
typedef struct IEnumTimeVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IEnumTime *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IEnumTime *This);
  ULONG(WINAPI *Release)(IEnumTime *This);
  HRESULT(WINAPI *Next)(IEnumTime *This, ULONG celt, ITTime **pVal,
                        ULONG *pceltFetched);
...
#endif
#endif
HRESULT WINAPI IEnumTime_Next_Proxy(IEnumTime *This, ULONG celt, ITTime **pVal,
                                    ULONG *pceltFetched);
void __RPC_STUB IEnumTime_Next_Stub(IRpcStubBuffer *This,
                                    IRpcChannelBuffer *_pRpcChannelBuffer,
                                    PRPC_MESSAGE _pRpcMessage,
                                    DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumTime_Reset_Proxy(IEnumTime *This);
void __RPC_STUB IEnumTime_Reset_Stub(IRpcStubBuffer *This,
                                     IRpcChannelBuffer *_pRpcChannelBuffer,
                                     PRPC_MESSAGE _pRpcMessage,
                                     DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumTime_Skip_Proxy(IEnumTime *This, ULONG celt);
void __RPC_STUB IEnumTime_Skip_Stub(IRpcStubBuffer *This,
                                    IRpcChannelBuffer *_pRpcChannelBuffer,
                                    PRPC_MESSAGE _pRpcMessage,
                                    DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumTime_Clone_Proxy(IEnumTime *This, IEnumTime **ppEnum);
void __RPC_STUB IEnumTime_Clone_Stub(IRpcStubBuffer *This,
                                     IRpcChannelBuffer *_pRpcChannelBuffer,
                                     PRPC_MESSAGE _pRpcMessage,
                                     DWORD *_pdwStubPhase);
#endif
...
typedef struct ITTimeCollectionVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITTimeCollection *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITTimeCollection *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITTimeCollection *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITTimeCollection *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
...
#define ITTimeCollection_GetTypeInfo(This, iTInfo, lcid, ppTInfo)              \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITTimeCollection_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,    \
                                       rgDispId)                               \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITTimeCollection_Invoke(This, dispIdMember, riid, lcid, wFlags,        \
                                pDispParams, pVarResult, pExcepInfo, puArgErr) \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI ITTimeCollection_get_Count_Proxy(ITTimeCollection *This,
                                                LONG *pVal);
void __RPC_STUB ITTimeCollection_get_Count_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITTimeCollection_get_Item_Proxy(ITTimeCollection *This,
                                               LONG Index, ITTime **pVal);
void __RPC_STUB ITTimeCollection_get_Item_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITTimeCollection_get__NewEnum_Proxy(ITTimeCollection *This,
                                                   IUnknown **pVal);
void __RPC_STUB ITTimeCollection_get__NewEnum_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITTimeCollection_get_EnumerationIf_Proxy(ITTimeCollection *This,
                                                        IEnumTime **pVal);
void __RPC_STUB ITTimeCollection_get_EnumerationIf_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITTimeCollection_Create_Proxy(ITTimeCollection *This, LONG Index,
                                             ITTime **ppTime);
void __RPC_STUB ITTimeCollection_Create_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITTimeCollection_Delete_Proxy(ITTimeCollection *This,
                                             LONG Index);
...
public:
  ...
  virtual HRESULT WINAPI
  get_ProtocolVersion(unsigned char *pProtocolVersion) = 0;
  ...
  virtual HRESULT WINAPI GetEmailNames(VARIANT *pAddresses,
                                       VARIANT *pNames) = 0;
  virtual HRESULT WINAPI SetEmailNames(VARIANT Addresses, VARIANT Names) = 0;
  virtual HRESULT WINAPI GetPhoneNumbers(VARIANT *pNumbers,
                                         VARIANT *pNames) = 0;
  ...
  virtual HRESULT WINAPI
  get_MediaCollection(ITMediaCollection **ppMediaCollection) = 0;
  virtual HRESULT WINAPI
  get_TimeCollection(ITTimeCollection **ppTimeCollection) = 0;
};
#else
typedef struct ITSdpVtbl {
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITSdp *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITSdp *This, REFIID riid, LPOLESTR *rgszNames,
                                 UINT cNames, LCID lcid, DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITSdp *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *get_IsValid)(ITSdp *This, VARIANT_BOOL *pfIsValid);
  HRESULT(WINAPI *get_ProtocolVersion)(ITSdp *This,
                                       unsigned char *pProtocolVersion);
  ...
  HRESULT(WINAPI *GetEmailNames)(ITSdp *This, VARIANT *pAddresses,
                                 VARIANT *pNames);
  HRESULT(WINAPI *SetEmailNames)(ITSdp *This, VARIANT Addresses, VARIANT Names);
  HRESULT(WINAPI *GetPhoneNumbers)(ITSdp *This, VARIANT *pNumbers,
                                   VARIANT *pNames);
  ...
  HRESULT(WINAPI *get_MediaCollection)(ITSdp *This,
                                       ITMediaCollection **ppMediaCollection);
  HRESULT(WINAPI *get_TimeCollection)(ITSdp *This,
...
void __RPC_STUB ITSdp_get_IsValid_Stub(IRpcStubBuffer *This,
                                       IRpcChannelBuffer *_pRpcChannelBuffer,
                                       PRPC_MESSAGE _pRpcMessage,
                                       DWORD *_pdwStubPhase);
HRESULT WINAPI ITSdp_get_ProtocolVersion_Proxy(ITSdp *This,
                                               unsigned char *pProtocolVersion);
void __RPC_STUB ITSdp_get_ProtocolVersion_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITSdp_get_SessionId_Proxy(ITSdp *This, DOUBLE *pSessionId);
void __RPC_STUB ITSdp_get_SessionId_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
HRESULT WINAPI ITSdp_get_SessionVersion_Proxy(ITSdp *This,
                                              DOUBLE *pSessionVersion);
void __RPC_STUB ITSdp_get_SessionVersion_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITSdp_put_SessionVersion_Proxy(ITSdp *This,
                                              DOUBLE SessionVersion);
void __RPC_STUB ITSdp_put_SessionVersion_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITSdp_get_MachineAddress_Proxy(ITSdp *This,
                                              BSTR *ppMachineAddress);
void __RPC_STUB ITSdp_get_MachineAddress_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITSdp_put_MachineAddress_Proxy(ITSdp *This,
                                              BSTR pMachineAddress);
void __RPC_STUB ITSdp_put_MachineAddress_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITSdp_get_Name_Proxy(ITSdp *This, BSTR *ppName);
void __RPC_STUB ITSdp_get_Name_Stub(IRpcStubBuffer *This,
                                    IRpcChannelBuffer *_pRpcChannelBuffer,
                                    PRPC_MESSAGE _pRpcMessage,
                                    DWORD *_pdwStubPhase);
HRESULT WINAPI ITSdp_put_Name_Proxy(ITSdp *This, BSTR pName);
void __RPC_STUB ITSdp_put_Name_Stub(IRpcStubBuffer *This,
                                    IRpcChannelBuffer *_pRpcChannelBuffer,
                                    PRPC_MESSAGE _pRpcMessage,
                                    DWORD *_pdwStubPhase);
...
void __RPC_STUB ITSdp_get_Url_Stub(IRpcStubBuffer *This,
                                   IRpcChannelBuffer *_pRpcChannelBuffer,
                                   PRPC_MESSAGE _pRpcMessage,
                                   DWORD *_pdwStubPhase);
HRESULT WINAPI ITSdp_put_Url_Proxy(ITSdp *This, BSTR pUrl);
void __RPC_STUB ITSdp_put_Url_Stub(IRpcStubBuffer *This,
                                   IRpcChannelBuffer *_pRpcChannelBuffer,
                                   PRPC_MESSAGE _pRpcMessage,
                                   DWORD *_pdwStubPhase);
HRESULT WINAPI ITSdp_GetEmailNames_Proxy(ITSdp *This, VARIANT *pAddresses,
                                         VARIANT *pNames);
void __RPC_STUB ITSdp_GetEmailNames_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
HRESULT WINAPI ITSdp_SetEmailNames_Proxy(ITSdp *This, VARIANT Addresses,
                                         VARIANT Names);
void __RPC_STUB ITSdp_SetEmailNames_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
HRESULT WINAPI ITSdp_GetPhoneNumbers_Proxy(ITSdp *This, VARIANT *pNumbers,
                                           VARIANT *pNames);
void __RPC_STUB ITSdp_GetPhoneNumbers_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITSdp_SetPhoneNumbers_Proxy(ITSdp *This, VARIANT Numbers,
                                           VARIANT Names);
void __RPC_STUB ITSdp_SetPhoneNumbers_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITSdp_get_Originator_Proxy(ITSdp *This, BSTR *ppOriginator);
void __RPC_STUB ITSdp_get_Originator_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI ITSdp_put_Originator_Proxy(ITSdp *This, BSTR pOriginator);
void __RPC_STUB ITSdp_put_Originator_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI ITSdp_get_MediaCollection_Proxy(
    ITSdp *This, ITMediaCollection **ppMediaCollection);
void __RPC_STUB ITSdp_get_MediaCollection_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITSdp_get_TimeCollection_Proxy(
...
public:
  ...
  virtual HRESULT WINAPI SetAddressInfo(BSTR pStartAddress, LONG NumAddresses,
                                        unsigned char Ttl) = 0;
  ...
  virtual HRESULT WINAPI GetEncryptionKey(BSTR *ppKeyType,
...
typedef struct ITConnectionVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITConnection *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITConnection *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITConnection *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITConnection *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  ...
  HRESULT(WINAPI *SetAddressInfo)(ITConnection *This, BSTR pStartAddress,
                                  LONG NumAddresses, unsigned char Ttl);
  HRESULT(WINAPI *SetBandwidthInfo)(ITConnection *This, BSTR pModifier,
                                    DOUBLE Bandwidth);
  HRESULT(WINAPI *SetEncryptionKey)(ITConnection *This, BSTR pKeyType,
                                    BSTR *ppKeyData);
  HRESULT(WINAPI *GetEncryptionKey)(ITConnection *This, BSTR *ppKeyType,
                                    VARIANT_BOOL *pfValidKeyData,
                                    BSTR *ppKeyData);
  END_INTERFACE
} ITConnectionVtbl;
...
#define ITConnection_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                  \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITConnection_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,        \
                                   rgDispId)                                   \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITConnection_Invoke(This, dispIdMember, riid, lcid, wFlags,            \
                            pDispParams, pVarResult, pExcepInfo, puArgErr)     \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#define ITConnection_GetEncryptionKey(This, ppKeyType, pfValidKeyData,         \
                                      ppKeyData)                               \
  (This)->lpVtbl->GetEncryptionKey(This, ppKeyType, pfValidKeyData, ppKeyData)
#endif
#endif
HRESULT WINAPI ITConnection_get_NetworkType_Proxy(ITConnection *This,
                                                  BSTR *ppNetworkType);
void __RPC_STUB ITConnection_get_NetworkType_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITConnection_put_NetworkType_Proxy(ITConnection *This,
                                                  BSTR pNetworkType);
void __RPC_STUB ITConnection_put_NetworkType_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITConnection_get_AddressType_Proxy(ITConnection *This,
                                                  BSTR *ppAddressType);
void __RPC_STUB ITConnection_get_AddressType_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITConnection_put_AddressType_Proxy(ITConnection *This,
                                                  BSTR pAddressType);
void __RPC_STUB ITConnection_put_AddressType_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITConnection_get_StartAddress_Proxy(ITConnection *This,
                                                   BSTR *ppStartAddress);
void __RPC_STUB ITConnection_get_StartAddress_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITConnection_get_NumAddresses_Proxy(ITConnection *This,
                                                   LONG *pNumAddresses);
void __RPC_STUB ITConnection_get_NumAddresses_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITConnection_get_Ttl_Proxy(ITConnection *This,
                                          unsigned char *pTtl);
void __RPC_STUB ITConnection_get_Ttl_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI ITConnection_get_BandwidthModifier_Proxy(ITConnection *This,
                                                        BSTR *ppModifier);
void __RPC_STUB ITConnection_get_BandwidthModifier_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITConnection_get_Bandwidth_Proxy(ITConnection *This,
                                                DOUBLE *pBandwidth);
void __RPC_STUB ITConnection_get_Bandwidth_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITConnection_SetAddressInfo_Proxy(ITConnection *This,
                                                 BSTR pStartAddress,
                                                 LONG NumAddresses,
                                                 unsigned char Ttl);
void __RPC_STUB ITConnection_SetAddressInfo_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITConnection_SetBandwidthInfo_Proxy(ITConnection *This,
                                                   BSTR pModifier,
                                                   DOUBLE Bandwidth);
void __RPC_STUB ITConnection_SetBandwidthInfo_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITConnection_SetEncryptionKey_Proxy(ITConnection *This,
                                                   BSTR pKeyType,
                                                   BSTR *ppKeyData);
void __RPC_STUB ITConnection_SetEncryptionKey_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITConnection_GetEncryptionKey_Proxy(ITConnection *This,
                                                   BSTR *ppKeyType,
                                                   VARIANT_BOOL *pfValidKeyData,
                                                   BSTR *ppKeyData);
...
typedef struct ITAttributeListVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITAttributeList *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITAttributeList *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITAttributeList *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITAttributeList *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
...
#define ITAttributeList_GetTypeInfo(This, iTInfo, lcid, ppTInfo)               \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITAttributeList_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,     \
                                      rgDispId)                                \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITAttributeList_Invoke(This, dispIdMember, riid, lcid, wFlags,         \
                               pDispParams, pVarResult, pExcepInfo, puArgErr)  \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI ITAttributeList_get_Count_Proxy(ITAttributeList *This,
                                               LONG *pVal);
void __RPC_STUB ITAttributeList_get_Count_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAttributeList_get_Item_Proxy(ITAttributeList *This, LONG Index,
                                              BSTR *pVal);
void __RPC_STUB ITAttributeList_get_Item_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAttributeList_Add_Proxy(ITAttributeList *This, LONG Index,
                                         BSTR pAttribute);
void __RPC_STUB ITAttributeList_Add_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
...
void __RPC_STUB ITAttributeList_Delete_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAttributeList_get_AttributeList_Proxy(ITAttributeList *This,
                                                       VARIANT *pVal);
void __RPC_STUB ITAttributeList_get_AttributeList_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAttributeList_put_AttributeList_Proxy(ITAttributeList *This,
                                                       VARIANT newVal);
