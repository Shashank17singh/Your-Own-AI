...
} DHCPV6CAPI_PARAMS_ARRAY, *PDHCPV6CAPI_PARAMS_ARRAY,
    *LPDHCPV6CAPI_PARAMS_ARRAY;
typedef struct _DHCPV6PrefixLeaseInformation {
  ...
  LPBYTE ServerId;
  DWORD ServerIdLen;
} DHCPV6PrefixLeaseInformation, *PDHCPV6PrefixLeaseInformation,
    *LPDHCPV6PrefixLeaseInformation, *LPDHCPV6CAPIPrefixLeaseInformation;
VOID APIENTRY Dhcpv6CApiCleanup(void);
VOID APIENTRY Dhcpv6CApiInitialize(LPDWORD Version);
DWORD APIENTRY Dhcpv6RequestParams(WINBOOL forceNewInform, LPVOID reserved,
                                   LPWSTR adapterName,
                                   LPDHCPV6CAPI_CLASSID classId,
                                   DHCPV6CAPI_PARAMS_ARRAY recdParams,
                                   LPBYTE buffer, LPDWORD pSize);
DWORD APIENTRY
Dhcpv6ReleasePrefix(LPWSTR adapterName, LPDHCPV6CAPI_CLASSID classId,
                    LPDHCPV6CAPIPrefixLeaseInformation prefixleaseInfo);
DWORD APIENTRY Dhcpv6RenewPrefix(LPWSTR adapterName,
                                 LPDHCPV6CAPI_CLASSID classId,
                                 LPDHCPV6PrefixLeaseInformation prefixleaseInfo,
                                 DWORD *pdwTimeToWait, DWORD bValidatePrefix);
DWORD APIENTRY Dhcpv6RequestPrefix(
    LPWSTR adapterName, LPDHCPV6CAPI_CLASSID classId,
    LPDHCPV6PrefixLeaseInformation prefixleaseInfo, DWORD *pdwTimeToWait);
