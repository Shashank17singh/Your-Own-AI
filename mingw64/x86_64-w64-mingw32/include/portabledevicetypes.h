/*** Autogenerated by WIDL 11.5 from include/portabledevicetypes.idl - Do not
 * edit ***/
#ifdef _WIN32
...
typedef interface IPortableDevicePropVariantCollection
...
typedef interface IPortableDeviceValuesCollection
...
#ifdef __cplusplus
typedef class PortableDevicePropVariantCollection
    PortableDevicePropVariantCollection;
#else
typedef struct PortableDevicePropVariantCollection
    PortableDevicePropVariantCollection;
#endif /* defined __cplusplus */
...
DEFINE_GUID(IID_IWpdSerializer, 0xb32f4002, 0xbb27, 0x45ff, 0xaf, 0x4f, 0x06,
            0x63, 0x1c, 0x1e, 0x8d, 0xad);
...
IWpdSerializer : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetIPortableDeviceValuesFromBuffer(
      BYTE * buffer, DWORD input_buffer_length,
      IPortableDeviceValues * *params) = 0;
  virtual HRESULT STDMETHODCALLTYPE WriteIPortableDeviceValuesToBuffer(
      DWORD output_buffer_length, IPortableDeviceValues * results,
      BYTE * buffer, DWORD * bytes_written) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetBufferFromIPortableDeviceValues(
      IPortableDeviceValues * source, BYTE * *buffer, DWORD * buffer_size) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetSerializedSize(
      IPortableDeviceValues * source, DWORD * size) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IWpdSerializer, 0xb32f4002, 0xbb27, 0x45ff, 0xaf, 0x4f, 0x06,
                0x63, 0x1c, 0x1e, 0x8d, 0xad)
#endif
#else
typedef struct IWpdSerializerVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWpdSerializer *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetIPortableDeviceValuesFromBuffer)(
      IWpdSerializer *This, BYTE *buffer, DWORD input_buffer_length,
      IPortableDeviceValues **params);
  HRESULT(STDMETHODCALLTYPE *WriteIPortableDeviceValuesToBuffer)(
      IWpdSerializer *This, DWORD output_buffer_length,
      IPortableDeviceValues *results, BYTE *buffer, DWORD *bytes_written);
  HRESULT(STDMETHODCALLTYPE *GetBufferFromIPortableDeviceValues)(
      IWpdSerializer *This, IPortableDeviceValues *source, BYTE **buffer,
      DWORD *buffer_size);
  HRESULT(STDMETHODCALLTYPE *GetSerializedSize)(IWpdSerializer *This,
                                                IPortableDeviceValues *source,
                                                DWORD *size);
  END_INTERFACE
} IWpdSerializerVtbl;
interface IWpdSerializer { CONST_VTBL IWpdSerializerVtbl *lpVtbl; };
#ifdef COBJMACROS
...
/*** IWpdSerializer methods ***/
#define IWpdSerializer_GetIPortableDeviceValuesFromBuffer(                     \
    This, buffer, input_buffer_length, params)                                 \
  (This)->lpVtbl->GetIPortableDeviceValuesFromBuffer(                          \
      This, buffer, input_buffer_length, params)
#define IWpdSerializer_WriteIPortableDeviceValuesToBuffer(                     \
    This, output_buffer_length, results, buffer, bytes_written)                \
  (This)->lpVtbl->WriteIPortableDeviceValuesToBuffer(                          \
      This, output_buffer_length, results, buffer, bytes_written)
#define IWpdSerializer_GetBufferFromIPortableDeviceValues(This, source,        \
                                                          buffer, buffer_size) \
  (This)->lpVtbl->GetBufferFromIPortableDeviceValues(This, source, buffer,     \
                                                     buffer_size)
#define IWpdSerializer_GetSerializedSize(This, source, size)                   \
  (This)->lpVtbl->GetSerializedSize(This, source, size)
#else
/*** IUnknown methods ***/
static inline HRESULT IWpdSerializer_QueryInterface(IWpdSerializer *This,
                                                    REFIID riid,
                                                    void **ppvObject) {
...
/*** IWpdSerializer methods ***/
static inline HRESULT IWpdSerializer_GetIPortableDeviceValuesFromBuffer(
    IWpdSerializer *This, BYTE *buffer, DWORD input_buffer_length,
    IPortableDeviceValues **params) {
  return This->lpVtbl->GetIPortableDeviceValuesFromBuffer(
      This, buffer, input_buffer_length, params);
}
static inline HRESULT IWpdSerializer_WriteIPortableDeviceValuesToBuffer(
    IWpdSerializer *This, DWORD output_buffer_length,
    IPortableDeviceValues *results, BYTE *buffer, DWORD *bytes_written) {
  return This->lpVtbl->WriteIPortableDeviceValuesToBuffer(
      This, output_buffer_length, results, buffer, bytes_written);
}
static inline HRESULT IWpdSerializer_GetBufferFromIPortableDeviceValues(
    IWpdSerializer *This, IPortableDeviceValues *source, BYTE **buffer,
    DWORD *buffer_size) {
  return This->lpVtbl->GetBufferFromIPortableDeviceValues(This, source, buffer,
                                                          buffer_size);
}
static inline HRESULT
IWpdSerializer_GetSerializedSize(IWpdSerializer *This,
                                 IPortableDeviceValues *source, DWORD *size) {
...
DEFINE_GUID(IID_IPortableDeviceValues, 0x6848f6f2, 0x3155, 0x4f86, 0xb6, 0xf5,
            0x26, 0x3e, 0xee, 0xab, 0x31, 0x43);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IPortableDeviceValues : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE GetAt(const DWORD index, PROPERTYKEY *pKey,
  ...
  virtual HRESULT STDMETHODCALLTYPE GetValue(REFPROPERTYKEY key,
                                             PROPVARIANT * pValue) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetStringValue(REFPROPERTYKEY key,
                                                   LPCWSTR Value) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE SetUnsignedIntegerValue(
      REFPROPERTYKEY key, const ULONG Value) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetUnsignedIntegerValue(REFPROPERTYKEY key,
                                                            ULONG * pValue) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetSignedIntegerValue(REFPROPERTYKEY key,
                                                          const LONG Value) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetSignedIntegerValue(REFPROPERTYKEY key,
                                                          LONG * pValue) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetUnsignedLargeIntegerValue(
      REFPROPERTYKEY key, const ULONGLONG Value) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetUnsignedLargeIntegerValue(
      REFPROPERTYKEY key, ULONGLONG * pValue) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetSignedLargeIntegerValue(
      REFPROPERTYKEY key, const LONGLONG Value) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetSignedLargeIntegerValue(
      REFPROPERTYKEY key, LONGLONG * pValue) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetFloatValue(REFPROPERTYKEY key,
                                                  const FLOAT Value) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetFloatValue(REFPROPERTYKEY key,
                                                  FLOAT * pValue) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetErrorValue(REFPROPERTYKEY key,
                                                  const HRESULT Value) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetErrorValue(REFPROPERTYKEY key,
                                                  HRESULT * pValue) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetKeyValue(REFPROPERTYKEY key,
                                                REFPROPERTYKEY Value) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetKeyValue(REFPROPERTYKEY key,
                                                PROPERTYKEY * pValue) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetBoolValue(REFPROPERTYKEY key,
                                                 const WINBOOL Value) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetBoolValue(REFPROPERTYKEY key,
                                                 WINBOOL * pValue) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetIUnknownValue(REFPROPERTYKEY key,
                                                     IUnknown * pValue) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetIUnknownValue(REFPROPERTYKEY key,
                                                     IUnknown * *ppValue) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetGuidValue(REFPROPERTYKEY key,
                                                 REFGUID Value) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetGuidValue(REFPROPERTYKEY key,
                                                 GUID * pValue) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetBufferValue(
      REFPROPERTYKEY key, BYTE * pValue, DWORD cbValue) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetBufferValue(
      REFPROPERTYKEY key, BYTE * *ppValue, DWORD * pcbValue) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetIPortableDeviceValuesValue(
      REFPROPERTYKEY key, IPortableDeviceValues * pValue) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetIPortableDeviceValuesValue(
      REFPROPERTYKEY key, IPortableDeviceValues * *ppValue) = 0;
  virtual HRESULT STDMETHODCALLTYPE
  SetIPortableDevicePropVariantCollectionValue(
      REFPROPERTYKEY key, IPortableDevicePropVariantCollection * pValue) = 0;
  virtual HRESULT STDMETHODCALLTYPE
  GetIPortableDevicePropVariantCollectionValue(
      REFPROPERTYKEY key, IPortableDevicePropVariantCollection * *ppValue) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetIPortableDeviceKeyCollectionValue(
      REFPROPERTYKEY key, IPortableDeviceKeyCollection * pValue) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetIPortableDeviceKeyCollectionValue(
      REFPROPERTYKEY key, IPortableDeviceKeyCollection * *ppValue) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetIPortableDeviceValuesCollectionValue(
      REFPROPERTYKEY key, IPortableDeviceValuesCollection * pValue) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetIPortableDeviceValuesCollectionValue(
      REFPROPERTYKEY key, IPortableDeviceValuesCollection * *ppValue) = 0;
  virtual HRESULT STDMETHODCALLTYPE RemoveValue(REFPROPERTYKEY key) = 0;
  virtual HRESULT STDMETHODCALLTYPE CopyValuesFromPropertyStore(IPropertyStore *
                                                                pStore) = 0;
  virtual HRESULT STDMETHODCALLTYPE CopyValuesToPropertyStore(IPropertyStore *
                                                              pStore) = 0;
  virtual HRESULT STDMETHODCALLTYPE Clear() = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IPortableDeviceValues, 0x6848f6f2, 0x3155, 0x4f86, 0xb6, 0xf5,
                0x26, 0x3e, 0xee, 0xab, 0x31, 0x43)
#endif
#else
typedef struct IPortableDeviceValuesVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPortableDeviceValues *This,
  ...
  HRESULT(STDMETHODCALLTYPE *GetCount)(IPortableDeviceValues *This,
                                       DWORD *pcelt);
  HRESULT(STDMETHODCALLTYPE *GetAt)(IPortableDeviceValues *This,
                                    const DWORD index, PROPERTYKEY *pKey,
                                    PROPVARIANT *pValue);
  HRESULT(STDMETHODCALLTYPE *SetValue)(IPortableDeviceValues *This,
                                       REFPROPERTYKEY key,
                                       const PROPVARIANT *pValue);
  HRESULT(STDMETHODCALLTYPE *GetValue)(IPortableDeviceValues *This,
                                       REFPROPERTYKEY key, PROPVARIANT *pValue);
  HRESULT(STDMETHODCALLTYPE *SetStringValue)(IPortableDeviceValues *This,
                                             REFPROPERTYKEY key, LPCWSTR Value);
  HRESULT(STDMETHODCALLTYPE *GetStringValue)(IPortableDeviceValues *This,
                                             REFPROPERTYKEY key,
                                             LPWSTR *pValue);
  ...
  HRESULT(STDMETHODCALLTYPE *GetUnsignedIntegerValue)(
      IPortableDeviceValues *This, REFPROPERTYKEY key, ULONG *pValue);
  HRESULT(STDMETHODCALLTYPE *SetSignedIntegerValue)(IPortableDeviceValues *This,
                                                    REFPROPERTYKEY key,
                                                    const LONG Value);
  HRESULT(STDMETHODCALLTYPE *GetSignedIntegerValue)(IPortableDeviceValues *This,
                                                    REFPROPERTYKEY key,
                                                    LONG *pValue);
  HRESULT(STDMETHODCALLTYPE *SetUnsignedLargeIntegerValue)(
      IPortableDeviceValues *This, REFPROPERTYKEY key, const ULONGLONG Value);
  ...
  HRESULT(STDMETHODCALLTYPE *SetSignedLargeIntegerValue)(
      IPortableDeviceValues *This, REFPROPERTYKEY key, const LONGLONG Value);
  HRESULT(STDMETHODCALLTYPE *GetSignedLargeIntegerValue)(
      IPortableDeviceValues *This, REFPROPERTYKEY key, LONGLONG *pValue);
  HRESULT(STDMETHODCALLTYPE *SetFloatValue)(IPortableDeviceValues *This,
                                            REFPROPERTYKEY key,
                                            const FLOAT Value);
  HRESULT(STDMETHODCALLTYPE *GetFloatValue)(IPortableDeviceValues *This,
                                            REFPROPERTYKEY key, FLOAT *pValue);
  HRESULT(STDMETHODCALLTYPE *SetErrorValue)(IPortableDeviceValues *This,
                                            REFPROPERTYKEY key,
                                            const HRESULT Value);
  HRESULT(STDMETHODCALLTYPE *GetErrorValue)(IPortableDeviceValues *This,
                                            REFPROPERTYKEY key,
                                            HRESULT *pValue);
  HRESULT(STDMETHODCALLTYPE *SetKeyValue)(IPortableDeviceValues *This,
                                          REFPROPERTYKEY key,
                                          REFPROPERTYKEY Value);
  HRESULT(STDMETHODCALLTYPE *GetKeyValue)(IPortableDeviceValues *This,
                                          REFPROPERTYKEY key,
                                          PROPERTYKEY *pValue);
  HRESULT(STDMETHODCALLTYPE *SetBoolValue)(IPortableDeviceValues *This,
                                           REFPROPERTYKEY key,
                                           const WINBOOL Value);
  HRESULT(STDMETHODCALLTYPE *GetBoolValue)(IPortableDeviceValues *This,
                                           REFPROPERTYKEY key, WINBOOL *pValue);
  HRESULT(STDMETHODCALLTYPE *SetIUnknownValue)(IPortableDeviceValues *This,
                                               REFPROPERTYKEY key,
                                               IUnknown *pValue);
  HRESULT(STDMETHODCALLTYPE *GetIUnknownValue)(IPortableDeviceValues *This,
                                               REFPROPERTYKEY key,
                                               IUnknown **ppValue);
  HRESULT(STDMETHODCALLTYPE *SetGuidValue)(IPortableDeviceValues *This,
                                           REFPROPERTYKEY key, REFGUID Value);
  HRESULT(STDMETHODCALLTYPE *GetGuidValue)(IPortableDeviceValues *This,
                                           REFPROPERTYKEY key, GUID *pValue);
  HRESULT(STDMETHODCALLTYPE *SetBufferValue)(IPortableDeviceValues *This,
                                             REFPROPERTYKEY key, BYTE *pValue,
                                             DWORD cbValue);
  HRESULT(STDMETHODCALLTYPE *GetBufferValue)(IPortableDeviceValues *This,
                                             REFPROPERTYKEY key, BYTE **ppValue,
                                             DWORD *pcbValue);
  HRESULT(STDMETHODCALLTYPE *SetIPortableDeviceValuesValue)(
      IPortableDeviceValues *This, REFPROPERTYKEY key,
  ...
  HRESULT(STDMETHODCALLTYPE *RemoveValue)(IPortableDeviceValues *This,
                                          REFPROPERTYKEY key);
  HRESULT(STDMETHODCALLTYPE *CopyValuesFromPropertyStore)(
      IPortableDeviceValues *This, IPropertyStore *pStore);
...
#define IPortableDeviceValues_GetIPortableDeviceValuesValue(This, key,         \
                                                            ppValue)           \
  (This)->lpVtbl->GetIPortableDeviceValuesValue(This, key, ppValue)
#define IPortableDeviceValues_SetIPortableDevicePropVariantCollectionValue(    \
    This, key, pValue)                                                         \
  (This)->lpVtbl->SetIPortableDevicePropVariantCollectionValue(This, key,      \
                                                               pValue)
#define IPortableDeviceValues_GetIPortableDevicePropVariantCollectionValue(    \
    This, key, ppValue)                                                        \
  (This)->lpVtbl->GetIPortableDevicePropVariantCollectionValue(This, key,      \
                                                               ppValue)
#define IPortableDeviceValues_SetIPortableDeviceKeyCollectionValue(This, key,  \
                                                                   pValue)     \
  (This)->lpVtbl->SetIPortableDeviceKeyCollectionValue(This, key, pValue)
#define IPortableDeviceValues_GetIPortableDeviceKeyCollectionValue(This, key,  \
                                                                   ppValue)    \
  (This)->lpVtbl->GetIPortableDeviceKeyCollectionValue(This, key, ppValue)
#define IPortableDeviceValues_SetIPortableDeviceValuesCollectionValue(         \
    This, key, pValue)                                                         \
  (This)->lpVtbl->SetIPortableDeviceValuesCollectionValue(This, key, pValue)
#define IPortableDeviceValues_GetIPortableDeviceValuesCollectionValue(         \
    This, key, ppValue)                                                        \
...
/*** IUnknown methods ***/
static inline HRESULT
IPortableDeviceValues_QueryInterface(IPortableDeviceValues *This, REFIID riid,
                                     void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IPortableDeviceValues methods ***/
static inline HRESULT
IPortableDeviceValues_GetCount(IPortableDeviceValues *This, DWORD *pcelt) {
  return This->lpVtbl->GetCount(This, pcelt);
}
static inline HRESULT IPortableDeviceValues_GetAt(IPortableDeviceValues *This,
                                                  const DWORD index,
                                                  PROPERTYKEY *pKey,
                                                  PROPVARIANT *pValue) {
...
static inline HRESULT
IPortableDeviceValues_SetValue(IPortableDeviceValues *This, REFPROPERTYKEY key,
                               const PROPVARIANT *pValue) {
  return This->lpVtbl->SetValue(This, key, pValue);
}
static inline HRESULT
IPortableDeviceValues_GetValue(IPortableDeviceValues *This, REFPROPERTYKEY key,
                               PROPVARIANT *pValue) {
  return This->lpVtbl->GetValue(This, key, pValue);
}
static inline HRESULT
IPortableDeviceValues_SetStringValue(IPortableDeviceValues *This,
                                     REFPROPERTYKEY key, LPCWSTR Value) {
  return This->lpVtbl->SetStringValue(This, key, Value);
}
static inline HRESULT
IPortableDeviceValues_GetStringValue(IPortableDeviceValues *This,
                                     REFPROPERTYKEY key, LPWSTR *pValue) {
...
static inline HRESULT IPortableDeviceValues_GetUnsignedIntegerValue(
    IPortableDeviceValues *This, REFPROPERTYKEY key, ULONG *pValue) {
  return This->lpVtbl->GetUnsignedIntegerValue(This, key, pValue);
}
static inline HRESULT IPortableDeviceValues_SetSignedIntegerValue(
    IPortableDeviceValues *This, REFPROPERTYKEY key, const LONG Value) {
  return This->lpVtbl->SetSignedIntegerValue(This, key, Value);
}
static inline HRESULT
IPortableDeviceValues_GetSignedIntegerValue(IPortableDeviceValues *This,
                                            REFPROPERTYKEY key, LONG *pValue) {
  return This->lpVtbl->GetSignedIntegerValue(This, key, pValue);
}
static inline HRESULT IPortableDeviceValues_SetUnsignedLargeIntegerValue(
    IPortableDeviceValues *This, REFPROPERTYKEY key, const ULONGLONG Value) {
...
static inline HRESULT IPortableDeviceValues_SetSignedLargeIntegerValue(
    IPortableDeviceValues *This, REFPROPERTYKEY key, const LONGLONG Value) {
  return This->lpVtbl->SetSignedLargeIntegerValue(This, key, Value);
}
static inline HRESULT IPortableDeviceValues_GetSignedLargeIntegerValue(
    IPortableDeviceValues *This, REFPROPERTYKEY key, LONGLONG *pValue) {
  return This->lpVtbl->GetSignedLargeIntegerValue(This, key, pValue);
}
static inline HRESULT
IPortableDeviceValues_SetFloatValue(IPortableDeviceValues *This,
                                    REFPROPERTYKEY key, const FLOAT Value) {
  return This->lpVtbl->SetFloatValue(This, key, Value);
}
static inline HRESULT
IPortableDeviceValues_GetFloatValue(IPortableDeviceValues *This,
                                    REFPROPERTYKEY key, FLOAT *pValue) {
  return This->lpVtbl->GetFloatValue(This, key, pValue);
}
static inline HRESULT
IPortableDeviceValues_SetErrorValue(IPortableDeviceValues *This,
                                    REFPROPERTYKEY key, const HRESULT Value) {
  return This->lpVtbl->SetErrorValue(This, key, Value);
}
static inline HRESULT
IPortableDeviceValues_GetErrorValue(IPortableDeviceValues *This,
                                    REFPROPERTYKEY key, HRESULT *pValue) {
  return This->lpVtbl->GetErrorValue(This, key, pValue);
}
static inline HRESULT
IPortableDeviceValues_SetKeyValue(IPortableDeviceValues *This,
                                  REFPROPERTYKEY key, REFPROPERTYKEY Value) {
  return This->lpVtbl->SetKeyValue(This, key, Value);
}
static inline HRESULT
IPortableDeviceValues_GetKeyValue(IPortableDeviceValues *This,
                                  REFPROPERTYKEY key, PROPERTYKEY *pValue) {
  return This->lpVtbl->GetKeyValue(This, key, pValue);
}
static inline HRESULT
IPortableDeviceValues_SetBoolValue(IPortableDeviceValues *This,
                                   REFPROPERTYKEY key, const WINBOOL Value) {
  return This->lpVtbl->SetBoolValue(This, key, Value);
}
static inline HRESULT
IPortableDeviceValues_GetBoolValue(IPortableDeviceValues *This,
                                   REFPROPERTYKEY key, WINBOOL *pValue) {
  return This->lpVtbl->GetBoolValue(This, key, pValue);
}
static inline HRESULT
IPortableDeviceValues_SetIUnknownValue(IPortableDeviceValues *This,
                                       REFPROPERTYKEY key, IUnknown *pValue) {
  return This->lpVtbl->SetIUnknownValue(This, key, pValue);
}
static inline HRESULT
IPortableDeviceValues_GetIUnknownValue(IPortableDeviceValues *This,
                                       REFPROPERTYKEY key, IUnknown **ppValue) {
  return This->lpVtbl->GetIUnknownValue(This, key, ppValue);
}
static inline HRESULT
IPortableDeviceValues_SetGuidValue(IPortableDeviceValues *This,
                                   REFPROPERTYKEY key, REFGUID Value) {
  return This->lpVtbl->SetGuidValue(This, key, Value);
}
static inline HRESULT
IPortableDeviceValues_GetGuidValue(IPortableDeviceValues *This,
                                   REFPROPERTYKEY key, GUID *pValue) {
  return This->lpVtbl->GetGuidValue(This, key, pValue);
}
static inline HRESULT
IPortableDeviceValues_SetBufferValue(IPortableDeviceValues *This,
                                     REFPROPERTYKEY key, BYTE *pValue,
                                     DWORD cbValue) {
  return This->lpVtbl->SetBufferValue(This, key, pValue, cbValue);
}
static inline HRESULT
IPortableDeviceValues_GetBufferValue(IPortableDeviceValues *This,
                                     REFPROPERTYKEY key, BYTE **ppValue,
                                     DWORD *pcbValue) {
  return This->lpVtbl->GetBufferValue(This, key, ppValue, pcbValue);
}
static inline HRESULT IPortableDeviceValues_SetIPortableDeviceValuesValue(
    IPortableDeviceValues *This, REFPROPERTYKEY key,
    IPortableDeviceValues *pValue) {
  return This->lpVtbl->SetIPortableDeviceValuesValue(This, key, pValue);
}
static inline HRESULT IPortableDeviceValues_GetIPortableDeviceValuesValue(
    IPortableDeviceValues *This, REFPROPERTYKEY key,
    IPortableDeviceValues **ppValue) {
  return This->lpVtbl->GetIPortableDeviceValuesValue(This, key, ppValue);
}
static inline HRESULT
IPortableDeviceValues_SetIPortableDevicePropVariantCollectionValue(
    IPortableDeviceValues *This, REFPROPERTYKEY key,
    IPortableDevicePropVariantCollection *pValue) {
  return This->lpVtbl->SetIPortableDevicePropVariantCollectionValue(This, key,
                                                                    pValue);
}
static inline HRESULT
IPortableDeviceValues_GetIPortableDevicePropVariantCollectionValue(
    IPortableDeviceValues *This, REFPROPERTYKEY key,
    IPortableDevicePropVariantCollection **ppValue) {
  return This->lpVtbl->GetIPortableDevicePropVariantCollectionValue(This, key,
                                                                    ppValue);
}
static inline HRESULT
IPortableDeviceValues_SetIPortableDeviceKeyCollectionValue(
    IPortableDeviceValues *This, REFPROPERTYKEY key,
    IPortableDeviceKeyCollection *pValue) {
  return This->lpVtbl->SetIPortableDeviceKeyCollectionValue(This, key, pValue);
}
static inline HRESULT
IPortableDeviceValues_GetIPortableDeviceKeyCollectionValue(
    IPortableDeviceValues *This, REFPROPERTYKEY key,
    IPortableDeviceKeyCollection **ppValue) {
  return This->lpVtbl->GetIPortableDeviceKeyCollectionValue(This, key, ppValue);
}
static inline HRESULT
IPortableDeviceValues_SetIPortableDeviceValuesCollectionValue(
    IPortableDeviceValues *This, REFPROPERTYKEY key,
    IPortableDeviceValuesCollection *pValue) {
  return This->lpVtbl->SetIPortableDeviceValuesCollectionValue(This, key,
                                                               pValue);
}
static inline HRESULT
IPortableDeviceValues_GetIPortableDeviceValuesCollectionValue(
    IPortableDeviceValues *This, REFPROPERTYKEY key,
    IPortableDeviceValuesCollection **ppValue) {
  return This->lpVtbl->GetIPortableDeviceValuesCollectionValue(This, key,
                                                               ppValue);
}
static inline HRESULT
IPortableDeviceValues_RemoveValue(IPortableDeviceValues *This,
                                  REFPROPERTYKEY key) {
  return This->lpVtbl->RemoveValue(This, key);
}
static inline HRESULT
IPortableDeviceValues_CopyValuesFromPropertyStore(IPortableDeviceValues *This,
                                                  IPropertyStore *pStore) {
  return This->lpVtbl->CopyValuesFromPropertyStore(This, pStore);
}
static inline HRESULT
IPortableDeviceValues_CopyValuesToPropertyStore(IPortableDeviceValues *This,
                                                IPropertyStore *pStore) {
...
DEFINE_GUID(IID_IPortableDeviceKeyCollection, 0xdada2357, 0xe0ad, 0x492e, 0x98,
            0xdb, 0xdd, 0x61, 0xc5, 0x3b, 0xa3, 0x53);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IPortableDeviceKeyCollection : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE GetAt(const DWORD dwIndex,
                                          PROPERTYKEY *pKey) = 0;
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IPortableDeviceKeyCollection, 0xdada2357, 0xe0ad, 0x492e, 0x98,
                0xdb, 0xdd, 0x61, 0xc5, 0x3b, 0xa3, 0x53)
#endif
#else
typedef struct IPortableDeviceKeyCollectionVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPortableDeviceKeyCollection *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetCount)(IPortableDeviceKeyCollection *This,
                                       DWORD *pcElems);
  HRESULT(STDMETHODCALLTYPE *GetAt)(IPortableDeviceKeyCollection *This,
                                    const DWORD dwIndex, PROPERTYKEY *pKey);
  HRESULT(STDMETHODCALLTYPE *Add)(IPortableDeviceKeyCollection *This,
                                  REFPROPERTYKEY Key);
...
/*** IUnknown methods ***/
static inline HRESULT
IPortableDeviceKeyCollection_QueryInterface(IPortableDeviceKeyCollection *This,
                                            REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IPortableDeviceKeyCollection_AddRef(IPortableDeviceKeyCollection *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IPortableDeviceKeyCollection_Release(IPortableDeviceKeyCollection *This) {
  return This->lpVtbl->Release(This);
}
/*** IPortableDeviceKeyCollection methods ***/
static inline HRESULT
IPortableDeviceKeyCollection_GetCount(IPortableDeviceKeyCollection *This,
                                      DWORD *pcElems) {
  return This->lpVtbl->GetCount(This, pcElems);
}
static inline HRESULT
IPortableDeviceKeyCollection_GetAt(IPortableDeviceKeyCollection *This,
                                   const DWORD dwIndex, PROPERTYKEY *pKey) {
  return This->lpVtbl->GetAt(This, dwIndex, pKey);
}
static inline HRESULT
IPortableDeviceKeyCollection_Add(IPortableDeviceKeyCollection *This,
                                 REFPROPERTYKEY Key) {
  return This->lpVtbl->Add(This, Key);
}
static inline HRESULT
IPortableDeviceKeyCollection_Clear(IPortableDeviceKeyCollection *This) {
  return This->lpVtbl->Clear(This);
}
static inline HRESULT
IPortableDeviceKeyCollection_RemoveAt(IPortableDeviceKeyCollection *This,
                                      const DWORD dwIndex) {
...
DEFINE_GUID(IID_IPortableDevicePropVariantCollection, 0x89b2e422, 0x4f1b,
            0x4316, 0xbc, 0xef, 0xa4, 0x4a, 0xfe, 0xa8, 0x3e, 0xb3);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IPortableDevicePropVariantCollection, 0x89b2e422, 0x4f1b,
                0x4316, 0xbc, 0xef, 0xa4, 0x4a, 0xfe, 0xa8, 0x3e, 0xb3)
#endif
#else
typedef struct IPortableDevicePropVariantCollectionVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(
      IPortableDevicePropVariantCollection *This, REFIID riid,
      void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetCount)(
      IPortableDevicePropVariantCollection *This, DWORD *pcElems);
  HRESULT(STDMETHODCALLTYPE *GetAt)(IPortableDevicePropVariantCollection *This,
                                    const DWORD dwIndex, PROPVARIANT *pValue);
  HRESULT(STDMETHODCALLTYPE *Add)(IPortableDevicePropVariantCollection *This,
                                  const PROPVARIANT *pValue);
  HRESULT(STDMETHODCALLTYPE *GetType)(
      IPortableDevicePropVariantCollection *This, VARTYPE *pvt);
  HRESULT(STDMETHODCALLTYPE *ChangeType)(
      IPortableDevicePropVariantCollection *This, const VARTYPE vt);
  HRESULT(STDMETHODCALLTYPE *Clear)(IPortableDevicePropVariantCollection *This);
  HRESULT(STDMETHODCALLTYPE *RemoveAt)(
      IPortableDevicePropVariantCollection *This, const DWORD dwIndex);
  END_INTERFACE
...
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
#define IPortableDevicePropVariantCollection_QueryInterface(This, riid,        \
                                                            ppvObject)         \
  (This)->lpVtbl->QueryInterface(This, riid, ppvObject)
...
#else
/*** IUnknown methods ***/
static inline HRESULT IPortableDevicePropVariantCollection_QueryInterface(
    IPortableDevicePropVariantCollection *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG IPortableDevicePropVariantCollection_AddRef(
    IPortableDevicePropVariantCollection *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG IPortableDevicePropVariantCollection_Release(
    IPortableDevicePropVariantCollection *This) {
  return This->lpVtbl->Release(This);
}
/*** IPortableDevicePropVariantCollection methods ***/
static inline HRESULT IPortableDevicePropVariantCollection_GetCount(
    IPortableDevicePropVariantCollection *This, DWORD *pcElems) {
  return This->lpVtbl->GetCount(This, pcElems);
}
static inline HRESULT IPortableDevicePropVariantCollection_GetAt(
    IPortableDevicePropVariantCollection *This, const DWORD dwIndex,
    PROPVARIANT *pValue) {
  return This->lpVtbl->GetAt(This, dwIndex, pValue);
}
static inline HRESULT IPortableDevicePropVariantCollection_Add(
    IPortableDevicePropVariantCollection *This, const PROPVARIANT *pValue) {
  return This->lpVtbl->Add(This, pValue);
}
static inline HRESULT IPortableDevicePropVariantCollection_GetType(
    IPortableDevicePropVariantCollection *This, VARTYPE *pvt) {
  return This->lpVtbl->GetType(This, pvt);
}
static inline HRESULT IPortableDevicePropVariantCollection_ChangeType(
    IPortableDevicePropVariantCollection *This, const VARTYPE vt) {
  return This->lpVtbl->ChangeType(This, vt);
}
static inline HRESULT IPortableDevicePropVariantCollection_Clear(
    IPortableDevicePropVariantCollection *This) {
  return This->lpVtbl->Clear(This);
}
static inline HRESULT IPortableDevicePropVariantCollection_RemoveAt(
    IPortableDevicePropVariantCollection *This, const DWORD dwIndex) {
  return This->lpVtbl->RemoveAt(This, dwIndex);
}
#endif
...
DEFINE_GUID(IID_IPortableDeviceValuesCollection, 0x6e3f2d79, 0x4e07, 0x48c4,
            0x82, 0x08, 0xd8, 0xc2, 0xe5, 0xaf, 0x4a, 0x99);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("6e3f2d79-4e07-48c4-8208-d8c2e5af4a99")
IPortableDeviceValuesCollection : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetCount(DWORD * pcElems) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetAt(DWORD dwIndex, IPortableDeviceValues *
                                                             *ppValues) = 0;
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IPortableDeviceValuesCollection, 0x6e3f2d79, 0x4e07, 0x48c4,
                0x82, 0x08, 0xd8, 0xc2, 0xe5, 0xaf, 0x4a, 0x99)
#endif
#else
typedef struct IPortableDeviceValuesCollectionVtbl {
  ...
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(
      IPortableDeviceValuesCollection *This, REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetCount)(IPortableDeviceValuesCollection *This,
                                       DWORD *pcElems);
  HRESULT(STDMETHODCALLTYPE *GetAt)(IPortableDeviceValuesCollection *This,
                                    DWORD dwIndex,
                                    IPortableDeviceValues **ppValues);
  HRESULT(STDMETHODCALLTYPE *Add)(IPortableDeviceValuesCollection *This,
                                  IPortableDeviceValues *pValues);
  HRESULT(STDMETHODCALLTYPE *Clear)(IPortableDeviceValuesCollection *This);
  HRESULT(STDMETHODCALLTYPE *RemoveAt)(IPortableDeviceValuesCollection *This,
                                       const DWORD dwIndex);
  END_INTERFACE
...
#else
/*** IUnknown methods ***/
static inline HRESULT IPortableDeviceValuesCollection_QueryInterface(
    IPortableDeviceValuesCollection *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IPortableDeviceValuesCollection_AddRef(IPortableDeviceValuesCollection *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IPortableDeviceValuesCollection_Release(IPortableDeviceValuesCollection *This) {
  return This->lpVtbl->Release(This);
}
/*** IPortableDeviceValuesCollection methods ***/
static inline HRESULT
IPortableDeviceValuesCollection_GetCount(IPortableDeviceValuesCollection *This,
                                         DWORD *pcElems) {
  return This->lpVtbl->GetCount(This, pcElems);
}
static inline HRESULT
IPortableDeviceValuesCollection_GetAt(IPortableDeviceValuesCollection *This,
                                      DWORD dwIndex,
                                      IPortableDeviceValues **ppValues) {
  return This->lpVtbl->GetAt(This, dwIndex, ppValues);
}
static inline HRESULT
IPortableDeviceValuesCollection_Add(IPortableDeviceValuesCollection *This,
                                    IPortableDeviceValues *pValues) {
  return This->lpVtbl->Add(This, pValues);
}
static inline HRESULT
IPortableDeviceValuesCollection_Clear(IPortableDeviceValuesCollection *This) {
  return This->lpVtbl->Clear(This);
}
static inline HRESULT
IPortableDeviceValuesCollection_RemoveAt(IPortableDeviceValuesCollection *This,
                                         const DWORD dwIndex) {
  return This->lpVtbl->RemoveAt(This, dwIndex);
}
#endif
...
DEFINE_GUID(LIBID_PortableDeviceTypesLib, 0x2b00ba2f, 0xe750, 0x4beb, 0x92,
            0x35, 0x97, 0x14, 0x2e, 0xde, 0x1d, 0x3e);
/*****************************************************************************
 * WpdSerializer coclass
 */
DEFINE_GUID(CLSID_WpdSerializer, 0x0b91a74b, 0xad7c, 0x4a9d, 0xb5, 0x63, 0x29,
            0xee, 0xf9, 0x16, 0x71, 0x72);
#ifdef __cplusplus
class DECLSPEC_UUID("0b91a74b-ad7c-4a9d-b563-29eef9167172") WpdSerializer;
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(WpdSerializer, 0x0b91a74b, 0xad7c, 0x4a9d, 0xb5, 0x63, 0x29,
                0xee, 0xf9, 0x16, 0x71, 0x72)
#endif
#endif
/*****************************************************************************
 ...
 */
DEFINE_GUID(CLSID_PortableDeviceValues, 0x0c15d503, 0xd017, 0x47ce, 0x90, 0x16,
            0x7b, 0x3f, 0x97, 0x87, 0x21, 0xcc);
#ifdef __cplusplus
class DECLSPEC_UUID("0c15d503-d017-47ce-9016-7b3f978721cc")
    PortableDeviceValues;
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(PortableDeviceValues, 0x0c15d503, 0xd017, 0x47ce, 0x90, 0x16,
                0x7b, 0x3f, 0x97, 0x87, 0x21, 0xcc)
#endif
#endif
/*****************************************************************************
 ...
 */
DEFINE_GUID(CLSID_PortableDeviceKeyCollection, 0xde2d022d, 0x2480, 0x43be, 0x97,
            0xf0, 0xd1, 0xfa, 0x2c, 0xf9, 0x8f, 0x4f);
#ifdef __cplusplus
class DECLSPEC_UUID("de2d022d-2480-43be-97f0-d1fa2cf98f4f")
    PortableDeviceKeyCollection;
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(PortableDeviceKeyCollection, 0xde2d022d, 0x2480, 0x43be, 0x97,
                0xf0, 0xd1, 0xfa, 0x2c, 0xf9, 0x8f, 0x4f)
#endif
#endif
/*****************************************************************************
 ...
 */
DEFINE_GUID(CLSID_PortableDevicePropVariantCollection, 0x08a99e2f, 0x6d6d,
            0x4b80, 0xaf, 0x5a, 0xba, 0xf2, 0xbc, 0xbe, 0x4c, 0xb9);
#ifdef __cplusplus
class DECLSPEC_UUID("08a99e2f-6d6d-4b80-af5a-baf2bcbe4cb9")
    PortableDevicePropVariantCollection;
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(PortableDevicePropVariantCollection, 0x08a99e2f, 0x6d6d, 0x4b80,
                0xaf, 0x5a, 0xba, 0xf2, 0xbc, 0xbe, 0x4c, 0xb9)
#endif
#endif
/*****************************************************************************
 * PortableDeviceValuesCollection coclass
 */
DEFINE_GUID(CLSID_PortableDeviceValuesCollection, 0x3882134d, 0x14cf, 0x4220,
            0x9c, 0xb4, 0x43, 0x5f, 0x86, 0xd8, 0x3f, 0x60);
#ifdef __cplusplus
class DECLSPEC_UUID("3882134d-14cf-4220-9cb4-435f86d83f60")
    PortableDeviceValuesCollection;
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(PortableDeviceValuesCollection, 0x3882134d, 0x14cf, 0x4220,
                0x9c, 0xb4, 0x43, 0x5f, 0x86, 0xd8, 0x3f, 0x60)
#endif
#endif
