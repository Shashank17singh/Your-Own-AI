/*** Autogenerated by WIDL 11.5 from include/napenforcementclient.idl - Do not
 * edit ***/
#ifdef _WIN32
...
typedef interface INapEnforcementClientConnection
...
typedef interface INapEnforcementClientConnection2
...
DEFINE_GUID(IID_INapEnforcementClientBinding, 0x92b93223, 0x7487, 0x42d9, 0x9a,
            0x91, 0x5b, 0x85, 0x07, 0x72, 0x03, 0x84);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("92b93223-7487-42d9-9a91-5b8507720384")
INapEnforcementClientBinding : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE Initialize(
      EnforcementEntityId id, INapEnforcementClientCallback * callback) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE NotifySoHChangeFailure() = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(INapEnforcementClientBinding, 0x92b93223, 0x7487, 0x42d9, 0x9a,
                0x91, 0x5b, 0x85, 0x07, 0x72, 0x03, 0x84)
#endif
#else
typedef struct INapEnforcementClientBindingVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INapEnforcementClientBinding *This,
  ...
  HRESULT(STDMETHODCALLTYPE *Initialize)(
      INapEnforcementClientBinding *This, EnforcementEntityId id,
  ...
  HRESULT(STDMETHODCALLTYPE *GetSoHRequest)(
      INapEnforcementClientBinding *This,
      INapEnforcementClientConnection *connection, WINBOOL *retriggerHint);
...
#define INapEnforcementClientBinding_GetSoHRequest(This, connection,           \
                                                   retriggerHint)              \
...
INapEnforcementClientBinding_QueryInterface(INapEnforcementClientBinding *This,
                                            REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
INapEnforcementClientBinding_AddRef(INapEnforcementClientBinding *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
INapEnforcementClientBinding_Release(INapEnforcementClientBinding *This) {
  return This->lpVtbl->Release(This);
}
/*** INapEnforcementClientBinding methods ***/
static inline HRESULT INapEnforcementClientBinding_Initialize(
    INapEnforcementClientBinding *This, EnforcementEntityId id,
    INapEnforcementClientCallback *callback) {
  return This->lpVtbl->Initialize(This, id, callback);
}
static inline HRESULT
INapEnforcementClientBinding_Uninitialize(INapEnforcementClientBinding *This) {
  return This->lpVtbl->Uninitialize(This);
}
static inline HRESULT INapEnforcementClientBinding_CreateConnection(
    INapEnforcementClientBinding *This,
    INapEnforcementClientConnection **connection) {
  return This->lpVtbl->CreateConnection(This, connection);
}
static inline HRESULT INapEnforcementClientBinding_GetSoHRequest(
    INapEnforcementClientBinding *This,
    INapEnforcementClientConnection *connection, WINBOOL *retriggerHint) {
  return This->lpVtbl->GetSoHRequest(This, connection, retriggerHint);
}
static inline HRESULT INapEnforcementClientBinding_ProcessSoHResponse(
    INapEnforcementClientBinding *This,
    INapEnforcementClientConnection *connection) {
  return This->lpVtbl->ProcessSoHResponse(This, connection);
}
static inline HRESULT INapEnforcementClientBinding_NotifyConnectionStateDown(
    INapEnforcementClientBinding *This,
    INapEnforcementClientConnection *downCxn) {
  return This->lpVtbl->NotifyConnectionStateDown(This, downCxn);
}
static inline HRESULT INapEnforcementClientBinding_NotifySoHChangeFailure(
    INapEnforcementClientBinding *This) {
...
DEFINE_GUID(IID_INapEnforcementClientCallback, 0xf5a0b90a, 0x83a1, 0x4f76, 0xba,
            0x3f, 0x02, 0x54, 0x18, 0x68, 0x28, 0x14);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("f5a0b90a-83a1-4f76-ba3f-025418682814")
INapEnforcementClientCallback : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE NotifySoHChange() = 0;
  virtual HRESULT STDMETHODCALLTYPE GetConnections(Connections *
                                                   *connections) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(INapEnforcementClientCallback, 0xf5a0b90a, 0x83a1, 0x4f76, 0xba,
                0x3f, 0x02, 0x54, 0x18, 0x68, 0x28, 0x14)
#endif
#else
typedef struct INapEnforcementClientCallbackVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(
      INapEnforcementClientCallback *This, REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetConnections)(
      INapEnforcementClientCallback *This, Connections **connections);
  END_INTERFACE
...
#else
/*** IUnknown methods ***/
static inline HRESULT INapEnforcementClientCallback_QueryInterface(
    INapEnforcementClientCallback *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
INapEnforcementClientCallback_AddRef(INapEnforcementClientCallback *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
INapEnforcementClientCallback_Release(INapEnforcementClientCallback *This) {
  return This->lpVtbl->Release(This);
}
/*** INapEnforcementClientCallback methods ***/
static inline HRESULT INapEnforcementClientCallback_NotifySoHChange(
    INapEnforcementClientCallback *This) {
  return This->lpVtbl->NotifySoHChange(This);
}
static inline HRESULT INapEnforcementClientCallback_GetConnections(
    INapEnforcementClientCallback *This, Connections **connections) {
...
DEFINE_GUID(IID_INapEnforcementClientConnection, 0xfb3a3505, 0xddb1, 0x468a,
            0xb3, 0x07, 0xf3, 0x28, 0xa5, 0x74, 0x19, 0xd8);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("fb3a3505-ddb1-468a-b307-f328a57419d8")
INapEnforcementClientConnection : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE Initialize(EnforcementEntityId id) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetMaxSize(ProtocolMaxSize maxSize) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetMaxSize(ProtocolMaxSize * maxSize) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetFlags(UINT8 flags) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetFlags(UINT8 * flags) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetConnectionId(
      const ConnectionId *connectionId) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetConnectionId(ConnectionId *
                                                    *connectionId) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetCorrelationId(CorrelationId *
                                                     correlationId) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetStringCorrelationId(StringCorrelationId *
                                                           *correlationId) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetSoHRequest(NetworkSoHRequest *
                                                  *sohRequest) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetSoHResponse(
      const NetworkSoHResponse *sohResponse) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetSoHResponse(NetworkSoHResponse *
                                                   *sohResponse) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetIsolationInfo(
      const IsolationInfo *isolationInfo) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetIsolationInfo(IsolationInfo *
                                                     *isolationInfo) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetPrivateData(
      const PrivateData *privateData) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetPrivateData(PrivateData *
                                                   *privateData) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetEnforcerPrivateData(
      const PrivateData *privateData) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetEnforcerPrivateData(PrivateData *
                                                           *privateData) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(INapEnforcementClientConnection, 0xfb3a3505, 0xddb1, 0x468a,
                0xb3, 0x07, 0xf3, 0x28, 0xa5, 0x74, 0x19, 0xd8)
#endif
#else
typedef struct INapEnforcementClientConnectionVtbl {
  ...
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(
      INapEnforcementClientConnection *This, REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *Initialize)(INapEnforcementClientConnection *This,
                                         EnforcementEntityId id);
  HRESULT(STDMETHODCALLTYPE *SetMaxSize)(INapEnforcementClientConnection *This,
                                         ProtocolMaxSize maxSize);
  HRESULT(STDMETHODCALLTYPE *GetMaxSize)(INapEnforcementClientConnection *This,
                                         ProtocolMaxSize *maxSize);
  HRESULT(STDMETHODCALLTYPE *SetFlags)(INapEnforcementClientConnection *This,
                                       UINT8 flags);
  HRESULT(STDMETHODCALLTYPE *GetFlags)(INapEnforcementClientConnection *This,
                                       UINT8 *flags);
  HRESULT(STDMETHODCALLTYPE *SetConnectionId)(
      INapEnforcementClientConnection *This, const ConnectionId *connectionId);
  HRESULT(STDMETHODCALLTYPE *GetConnectionId)(
      INapEnforcementClientConnection *This, ConnectionId **connectionId);
  HRESULT(STDMETHODCALLTYPE *GetCorrelationId)(
      INapEnforcementClientConnection *This, CorrelationId *correlationId);
  ...
  HRESULT(STDMETHODCALLTYPE *GetSoHRequest)(
      INapEnforcementClientConnection *This, NetworkSoHRequest **sohRequest);
  HRESULT(STDMETHODCALLTYPE *SetSoHResponse)(
      INapEnforcementClientConnection *This,
      const NetworkSoHResponse *sohResponse);
  HRESULT(STDMETHODCALLTYPE *GetSoHResponse)(
      INapEnforcementClientConnection *This, NetworkSoHResponse **sohResponse);
  ...
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(
      INapEnforcementClientConnection *This, const PrivateData *privateData);
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(
      INapEnforcementClientConnection *This, PrivateData **privateData);
...
#define INapEnforcementClientConnection_GetStringCorrelationId(This,           \
                                                               correlationId)  \
...
#define INapEnforcementClientConnection_SetEnforcerPrivateData(This,           \
                                                               privateData)    \
  (This)->lpVtbl->SetEnforcerPrivateData(This, privateData)
#define INapEnforcementClientConnection_GetEnforcerPrivateData(This,           \
                                                               privateData)    \
  (This)->lpVtbl->GetEnforcerPrivateData(This, privateData)
#else
/*** IUnknown methods ***/
static inline HRESULT INapEnforcementClientConnection_QueryInterface(
    INapEnforcementClientConnection *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
INapEnforcementClientConnection_AddRef(INapEnforcementClientConnection *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
INapEnforcementClientConnection_Release(INapEnforcementClientConnection *This) {
  return This->lpVtbl->Release(This);
}
/*** INapEnforcementClientConnection methods ***/
static inline HRESULT INapEnforcementClientConnection_Initialize(
    INapEnforcementClientConnection *This, EnforcementEntityId id) {
  return This->lpVtbl->Initialize(This, id);
}
static inline HRESULT INapEnforcementClientConnection_SetMaxSize(
    INapEnforcementClientConnection *This, ProtocolMaxSize maxSize) {
  return This->lpVtbl->SetMaxSize(This, maxSize);
}
static inline HRESULT INapEnforcementClientConnection_GetMaxSize(
    INapEnforcementClientConnection *This, ProtocolMaxSize *maxSize) {
  return This->lpVtbl->GetMaxSize(This, maxSize);
}
static inline HRESULT
INapEnforcementClientConnection_SetFlags(INapEnforcementClientConnection *This,
                                         UINT8 flags) {
  return This->lpVtbl->SetFlags(This, flags);
}
static inline HRESULT
INapEnforcementClientConnection_GetFlags(INapEnforcementClientConnection *This,
                                         UINT8 *flags) {
  return This->lpVtbl->GetFlags(This, flags);
}
static inline HRESULT INapEnforcementClientConnection_SetConnectionId(
    INapEnforcementClientConnection *This, const ConnectionId *connectionId) {
  return This->lpVtbl->SetConnectionId(This, connectionId);
}
static inline HRESULT INapEnforcementClientConnection_GetConnectionId(
    INapEnforcementClientConnection *This, ConnectionId **connectionId) {
  return This->lpVtbl->GetConnectionId(This, connectionId);
}
static inline HRESULT INapEnforcementClientConnection_GetCorrelationId(
    INapEnforcementClientConnection *This, CorrelationId *correlationId) {
  return This->lpVtbl->GetCorrelationId(This, correlationId);
}
static inline HRESULT INapEnforcementClientConnection_GetStringCorrelationId(
    INapEnforcementClientConnection *This,
    StringCorrelationId **correlationId) {
  return This->lpVtbl->GetStringCorrelationId(This, correlationId);
}
static inline HRESULT INapEnforcementClientConnection_SetCorrelationId(
    INapEnforcementClientConnection *This, CorrelationId correlationId) {
  return This->lpVtbl->SetCorrelationId(This, correlationId);
}
static inline HRESULT INapEnforcementClientConnection_SetSoHRequest(
    INapEnforcementClientConnection *This,
    const NetworkSoHRequest *sohRequest) {
  return This->lpVtbl->SetSoHRequest(This, sohRequest);
}
static inline HRESULT INapEnforcementClientConnection_GetSoHRequest(
    INapEnforcementClientConnection *This, NetworkSoHRequest **sohRequest) {
  return This->lpVtbl->GetSoHRequest(This, sohRequest);
}
static inline HRESULT INapEnforcementClientConnection_SetSoHResponse(
    INapEnforcementClientConnection *This,
    const NetworkSoHResponse *sohResponse) {
  return This->lpVtbl->SetSoHResponse(This, sohResponse);
}
static inline HRESULT INapEnforcementClientConnection_GetSoHResponse(
    INapEnforcementClientConnection *This, NetworkSoHResponse **sohResponse) {
...
static inline HRESULT INapEnforcementClientConnection_SetPrivateData(
    INapEnforcementClientConnection *This, const PrivateData *privateData) {
  return This->lpVtbl->SetPrivateData(This, privateData);
}
static inline HRESULT INapEnforcementClientConnection_GetPrivateData(
    INapEnforcementClientConnection *This, PrivateData **privateData) {
  return This->lpVtbl->GetPrivateData(This, privateData);
}
static inline HRESULT INapEnforcementClientConnection_SetEnforcerPrivateData(
    INapEnforcementClientConnection *This, const PrivateData *privateData) {
  return This->lpVtbl->SetEnforcerPrivateData(This, privateData);
}
static inline HRESULT INapEnforcementClientConnection_GetEnforcerPrivateData(
    INapEnforcementClientConnection *This, PrivateData **privateData) {
...
DEFINE_GUID(IID_INapEnforcementClientConnection2, 0xbd244906, 0x70dd, 0x4690,
            0xbe, 0xea, 0x64, 0x86, 0x53, 0x39, 0x35, 0x00);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
INapEnforcementClientConnection2 : public INapEnforcementClientConnection {
  ...
  virtual HRESULT STDMETHODCALLTYPE GetIsolationInfoEx(IsolationInfoEx *
                                                       *isolationInfo) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetInstalledShvs(
      SystemHealthEntityCount * count, SystemHealthEntityId * *ids) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetInstalledShvs(
      SystemHealthEntityCount count, SystemHealthEntityId * ids) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(INapEnforcementClientConnection2, 0xbd244906, 0x70dd, 0x4690,
                0xbe, 0xea, 0x64, 0x86, 0x53, 0x39, 0x35, 0x00)
#endif
#else
typedef struct INapEnforcementClientConnection2Vtbl {
  ...
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(
      INapEnforcementClientConnection2 *This, REFIID riid, void **ppvObject);
  ...
  /*** INapEnforcementClientConnection methods ***/
  HRESULT(STDMETHODCALLTYPE *Initialize)(INapEnforcementClientConnection2 *This,
                                         EnforcementEntityId id);
  HRESULT(STDMETHODCALLTYPE *SetMaxSize)(INapEnforcementClientConnection2 *This,
                                         ProtocolMaxSize maxSize);
  HRESULT(STDMETHODCALLTYPE *GetMaxSize)(INapEnforcementClientConnection2 *This,
                                         ProtocolMaxSize *maxSize);
  HRESULT(STDMETHODCALLTYPE *SetFlags)(INapEnforcementClientConnection2 *This,
                                       UINT8 flags);
  HRESULT(STDMETHODCALLTYPE *GetFlags)(INapEnforcementClientConnection2 *This,
                                       UINT8 *flags);
  HRESULT(STDMETHODCALLTYPE *SetConnectionId)(
      INapEnforcementClientConnection2 *This, const ConnectionId *connectionId);
  HRESULT(STDMETHODCALLTYPE *GetConnectionId)(
      INapEnforcementClientConnection2 *This, ConnectionId **connectionId);
  HRESULT(STDMETHODCALLTYPE *GetCorrelationId)(
      INapEnforcementClientConnection2 *This, CorrelationId *correlationId);
  HRESULT(STDMETHODCALLTYPE *GetStringCorrelationId)(
  ...
  HRESULT(STDMETHODCALLTYPE *SetSoHRequest)(
      ...
      const NetworkSoHRequest *sohRequest);
  HRESULT(STDMETHODCALLTYPE *GetSoHRequest)(
      INapEnforcementClientConnection2 *This, NetworkSoHRequest **sohRequest);
  HRESULT(STDMETHODCALLTYPE *SetSoHResponse)(
      INapEnforcementClientConnection2 *This,
      const NetworkSoHResponse *sohResponse);
  HRESULT(STDMETHODCALLTYPE *GetSoHResponse)(
      INapEnforcementClientConnection2 *This, NetworkSoHResponse **sohResponse);
  HRESULT(STDMETHODCALLTYPE *SetIsolationInfo)(
      INapEnforcementClientConnection2 *This,
      const IsolationInfo *isolationInfo);
  HRESULT(STDMETHODCALLTYPE *GetIsolationInfo)(
  ...
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(
      INapEnforcementClientConnection2 *This, const PrivateData *privateData);
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(
      INapEnforcementClientConnection2 *This, PrivateData **privateData);
  HRESULT(STDMETHODCALLTYPE *SetEnforcerPrivateData)(
      INapEnforcementClientConnection2 *This, const PrivateData *privateData);
  HRESULT(STDMETHODCALLTYPE *GetEnforcerPrivateData)(
      INapEnforcementClientConnection2 *This, PrivateData **privateData);
  ...
  HRESULT(STDMETHODCALLTYPE *GetIsolationInfoEx)(
      INapEnforcementClientConnection2 *This, IsolationInfoEx **isolationInfo);
  HRESULT(STDMETHODCALLTYPE *GetInstalledShvs)(
      INapEnforcementClientConnection2 *This, SystemHealthEntityCount *count,
...
#define INapEnforcementClientConnection2_GetCorrelationId(This, correlationId) \
  (This)->lpVtbl->GetCorrelationId(This, correlationId)
#define INapEnforcementClientConnection2_GetStringCorrelationId(This,          \
                                                                correlationId) \
  (This)->lpVtbl->GetStringCorrelationId(This, correlationId)
...
#define INapEnforcementClientConnection2_GetPrivateData(This, privateData)     \
  (This)->lpVtbl->GetPrivateData(This, privateData)
#define INapEnforcementClientConnection2_SetEnforcerPrivateData(This,          \
                                                                privateData)   \
  (This)->lpVtbl->SetEnforcerPrivateData(This, privateData)
#define INapEnforcementClientConnection2_GetEnforcerPrivateData(This,          \
                                                                privateData)   \
  (This)->lpVtbl->GetEnforcerPrivateData(This, privateData)
/*** INapEnforcementClientConnection2 methods ***/
#define INapEnforcementClientConnection2_SetIsolationInfoEx(This,              \
                                                            isolationInfo)     \
  (This)->lpVtbl->SetIsolationInfoEx(This, isolationInfo)
#define INapEnforcementClientConnection2_GetIsolationInfoEx(This,              \
                                                            isolationInfo)     \
...
#else
/*** IUnknown methods ***/
static inline HRESULT INapEnforcementClientConnection2_QueryInterface(
    INapEnforcementClientConnection2 *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG INapEnforcementClientConnection2_AddRef(
    INapEnforcementClientConnection2 *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG INapEnforcementClientConnection2_Release(
    INapEnforcementClientConnection2 *This) {
  return This->lpVtbl->Release(This);
}
/*** INapEnforcementClientConnection methods ***/
static inline HRESULT INapEnforcementClientConnection2_Initialize(
    INapEnforcementClientConnection2 *This, EnforcementEntityId id) {
  return This->lpVtbl->Initialize(This, id);
}
static inline HRESULT INapEnforcementClientConnection2_SetMaxSize(
    INapEnforcementClientConnection2 *This, ProtocolMaxSize maxSize) {
  return This->lpVtbl->SetMaxSize(This, maxSize);
}
static inline HRESULT INapEnforcementClientConnection2_GetMaxSize(
    INapEnforcementClientConnection2 *This, ProtocolMaxSize *maxSize) {
  return This->lpVtbl->GetMaxSize(This, maxSize);
}
static inline HRESULT INapEnforcementClientConnection2_SetFlags(
    INapEnforcementClientConnection2 *This, UINT8 flags) {
  return This->lpVtbl->SetFlags(This, flags);
}
static inline HRESULT INapEnforcementClientConnection2_GetFlags(
    INapEnforcementClientConnection2 *This, UINT8 *flags) {
  return This->lpVtbl->GetFlags(This, flags);
}
static inline HRESULT INapEnforcementClientConnection2_SetConnectionId(
    INapEnforcementClientConnection2 *This, const ConnectionId *connectionId) {
  return This->lpVtbl->SetConnectionId(This, connectionId);
}
static inline HRESULT INapEnforcementClientConnection2_GetConnectionId(
    INapEnforcementClientConnection2 *This, ConnectionId **connectionId) {
  return This->lpVtbl->GetConnectionId(This, connectionId);
}
static inline HRESULT INapEnforcementClientConnection2_GetCorrelationId(
    INapEnforcementClientConnection2 *This, CorrelationId *correlationId) {
  return This->lpVtbl->GetCorrelationId(This, correlationId);
}
static inline HRESULT INapEnforcementClientConnection2_GetStringCorrelationId(
    INapEnforcementClientConnection2 *This,
    StringCorrelationId **correlationId) {
  return This->lpVtbl->GetStringCorrelationId(This, correlationId);
}
static inline HRESULT INapEnforcementClientConnection2_SetCorrelationId(
    INapEnforcementClientConnection2 *This, CorrelationId correlationId) {
  return This->lpVtbl->SetCorrelationId(This, correlationId);
}
static inline HRESULT INapEnforcementClientConnection2_SetSoHRequest(
    INapEnforcementClientConnection2 *This,
    const NetworkSoHRequest *sohRequest) {
  return This->lpVtbl->SetSoHRequest(This, sohRequest);
}
static inline HRESULT INapEnforcementClientConnection2_GetSoHRequest(
    INapEnforcementClientConnection2 *This, NetworkSoHRequest **sohRequest) {
  return This->lpVtbl->GetSoHRequest(This, sohRequest);
}
static inline HRESULT INapEnforcementClientConnection2_SetSoHResponse(
    INapEnforcementClientConnection2 *This,
    const NetworkSoHResponse *sohResponse) {
  return This->lpVtbl->SetSoHResponse(This, sohResponse);
}
static inline HRESULT INapEnforcementClientConnection2_GetSoHResponse(
    INapEnforcementClientConnection2 *This, NetworkSoHResponse **sohResponse) {
  return This->lpVtbl->GetSoHResponse(This, sohResponse);
}
static inline HRESULT INapEnforcementClientConnection2_SetIsolationInfo(
    INapEnforcementClientConnection2 *This,
    const IsolationInfo *isolationInfo) {
  return This->lpVtbl->SetIsolationInfo(This, isolationInfo);
}
...
static inline HRESULT INapEnforcementClientConnection2_SetPrivateData(
    INapEnforcementClientConnection2 *This, const PrivateData *privateData) {
  return This->lpVtbl->SetPrivateData(This, privateData);
}
static inline HRESULT INapEnforcementClientConnection2_GetPrivateData(
    INapEnforcementClientConnection2 *This, PrivateData **privateData) {
  return This->lpVtbl->GetPrivateData(This, privateData);
}
static inline HRESULT INapEnforcementClientConnection2_SetEnforcerPrivateData(
    INapEnforcementClientConnection2 *This, const PrivateData *privateData) {
  return This->lpVtbl->SetEnforcerPrivateData(This, privateData);
}
static inline HRESULT INapEnforcementClientConnection2_GetEnforcerPrivateData(
    INapEnforcementClientConnection2 *This, PrivateData **privateData) {
  return This->lpVtbl->GetEnforcerPrivateData(This, privateData);
}
/*** INapEnforcementClientConnection2 methods ***/
static inline HRESULT INapEnforcementClientConnection2_SetIsolationInfoEx(
    INapEnforcementClientConnection2 *This,
    const IsolationInfoEx *isolationInfo) {
  return This->lpVtbl->SetIsolationInfoEx(This, isolationInfo);
}
static inline HRESULT INapEnforcementClientConnection2_GetIsolationInfoEx(
    INapEnforcementClientConnection2 *This, IsolationInfoEx **isolationInfo) {
  return This->lpVtbl->GetIsolationInfoEx(This, isolationInfo);
}
static inline HRESULT INapEnforcementClientConnection2_GetInstalledShvs(
    INapEnforcementClientConnection2 *This, SystemHealthEntityCount *count,
    SystemHealthEntityId **ids) {
  return This->lpVtbl->GetInstalledShvs(This, count, ids);
}
static inline HRESULT INapEnforcementClientConnection2_SetInstalledShvs(
    INapEnforcementClientConnection2 *This, SystemHealthEntityCount count,
    SystemHealthEntityId *ids) {
