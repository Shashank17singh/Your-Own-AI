...
typedef struct {
  ...
  UCHAR VS[256];
    ...
    *PNVME_IDENTIFY_SPECIFIC_NAMESPACE_IO_COMMAND_SET;
typedef struct {
  UCHAR VSL;
  UCHAR WZSL;
  UCHAR WUSL;
  ...
  UCHAR Reserved[4080];
    ...
    *PNVME_IDENTIFY_NVM_SPECIFIC_CONTROLLER_IO_COMMAND_SET;
typedef struct {
  UCHAR ZASL;
  UCHAR Reserved[4095];
} NVME_IDENTIFY_ZNS_SPECIFIC_CONTROLLER_IO_COMMAND_SET,
    *PNVME_IDENTIFY_ZNS_SPECIFIC_CONTROLLER_IO_COMMAND_SET;
typedef struct {
...
DEFINE_GUID(GUID_WCS_DEVICE_SMART_ATTRIBUTES, 0x2810AFC5, 0xBFEA, 0xA4F2, 0x9C,
            0x4F, 0x6F, 0x7C, 0xC9, 0x14, 0xD5, 0xAF);
#define GUID_WCS_DEVICE_ERROR_RECOVERYGuid                                     \
  {0x2131D944, 0x30FE, 0xAE34, {0xAB, 0x4D, 0xFD, 0x3D, 0xBA, 0x83, 0x19, 0x5A}}
DEFINE_GUID(GUID_WCS_DEVICE_ERROR_RECOVERY, 0x2131D944, 0x30FE, 0xAE34, 0xAB,
            0x4D, 0xFD, 0x3D, 0xBA, 0x83, 0x19, 0x5A);
typedef enum {
...
typedef struct _NVME_WCS_DEVICE_SMART_ATTRIBUTES_LOG_V2 {
  ...
  GUID LogPageGUID;
    ...
    *PNVME_WCS_DEVICE_SMART_ATTRIBUTES_LOG_V2;
C_ASSERT(sizeof(NVME_WCS_DEVICE_SMART_ATTRIBUTES_LOG_V2) ==
         sizeof(NVME_WCS_DEVICE_SMART_ATTRIBUTES_LOG));
...
typedef union {
  ...
  ULONG AsUlong;
    ...
    *PNVME_CDW11_FEATURE_IO_COMMAND_SET_PROFILE;
typedef union {
  __C89_NAMELESS struct {
    ULONG GDHM : 1;
    ULONG Reserved : 31;
...
typedef struct {
  ...
  UCHAR EVAL[ANYSIZE_ARRAY];
    ...
    *PNVME_HOST_METADATA_ELEMENT_DESCRIPTOR;
typedef struct {
...
typedef NVME_CDW11_FEATURE_ERROR_INJECTION NVME_CDW0_FEATURE_ERROR_INJECTION,
...
typedef union {
  ...
  ULONG AsUlong;
    ...
    *PNVME_CDW11_FEATURE_READONLY_WRITETHROUGH_MODE;
typedef union {
  __C89_NAMELESS struct {
    ULONG EOLBehavior : 3;
    ULONG Reserved0 : 29;
...
typedef union {
  ...
  ULONG AsUlong;
    ...
    *PNVME_CDW11_FEATURE_CLEAR_PCIE_CORRECTABLE_ERROR_COUNTERS;
typedef union {
  __C89_NAMELESS struct {
    ULONG Reserved0 : 31;
    ULONG Enable : 1;
  ...
  ULONG AsUlong;
    ...
    *PNVME_CDW11_FEATURE_ENABLE_IEEE1667_SILO;
typedef union {
  __C89_NAMELESS struct {
    ULONG Enabled : 3;
    ULONG Reserved0 : 29;
  ...
  ULONG AsUlong;
    ...
    *PNVME_CDW0_FEATURE_ENABLE_IEEE1667_SILO;
...
typedef struct {
  ...
  ULONG Reserved : 31;
    ...
    *PNVME_CDW11_FEATURE_RESERVATION_PERSISTENCE;
typedef struct {
  ULONG Reserved : 1;
  ULONG REGPRE : 1;
  ULONG RESREL : 1;
  ...
  ULONG Reserved1 : 28;
    ...
    *PNVME_CDW11_FEATURE_RESERVATION_NOTIFICATION_MASK;
typedef union {
...
typedef struct _NVME_TELEMETRY_CONTROLLER_INITIATED_LOG {
  ...
  UCHAR ReasonIdentifier[128];
    ...
    *PNVME_TELEMETRY_CONTROLLER_INITIATED_LOG;
typedef struct {
  struct {
    UCHAR ActiveSlot : 3;
    UCHAR Reserved0 : 1;
...
typedef struct {
  ...
  USHORT EventLength;
    ...
    *PNVME_PERSISTENT_EVENT_LOG_EVENT_HEADER;
typedef enum {
...
typedef struct {
  ...
  ULONGLONG PRKEY;
    ...
    *PNVME_RESERVATION_ACQUIRE_DATA_STRUCTURE;
typedef enum {
...
typedef struct {
  ...
  ULONGLONG NRKEY;
    ...
    *PNVME_RESERVATION_REGISTER_DATA_STRUCTURE;
typedef enum {
...
typedef struct {
  ULONGLONG CRKEY;
    ...
    *PNVME_RESERVATION_RELEASE_DATA_STRUCTURE;
typedef union {
  __C89_NAMELESS struct {
    ULONG NUMD;
  };
...
typedef struct {
  ...
  UCHAR Reserved1[14];
    ...
    *PNVME_RESERVATION_REPORT_STATUS_HEADER;
#pragma pack(pop)
...
typedef struct {
  ...
  NVME_REGISTERED_CONTROLLER_DATA RegisteredControllersData[ANYSIZE_ARRAY];
    ...
    *PNVME_RESERVATION_REPORT_STATUS_DATA_STRUCTURE;
typedef struct {
  USHORT CNTLID;
  struct {
    UCHAR HoldReservation : 1;
  ...
  UCHAR Reserved1[32];
    ...
    *PNVME_REGISTERED_CONTROLLER_EXTENDED_DATA;
C_ASSERT(sizeof(NVME_REGISTERED_CONTROLLER_EXTENDED_DATA) == 64);
typedef struct {
  NVME_RESERVATION_REPORT_STATUS_HEADER Header;
  UCHAR Reserved1[40];
  NVME_REGISTERED_CONTROLLER_EXTENDED_DATA
      RegisteredControllersExtendedData[ANYSIZE_ARRAY];
} NVME_RESERVATION_REPORT_STATUS_EXTENDED_DATA_STRUCTURE,
    *PNVME_RESERVATION_REPORT_STATUS_EXTENDED_DATA_STRUCTURE;
typedef enum {
