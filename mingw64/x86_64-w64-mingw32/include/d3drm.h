...
DECLARE_INTERFACE_(IDirect3DRM, IUnknown) {
  ...
  /*** IDirect3DRM methods ***/
  STDMETHOD(CreateObject)(THIS_ REFCLSID clsid, IUnknown * outer, REFIID iid,
                          void **out) PURE;
  STDMETHOD(CreateFrame)(THIS_ IDirect3DRMFrame * parent,
                         IDirect3DRMFrame * *frame) PURE;
  STDMETHOD(CreateMesh)(THIS_ IDirect3DRMMesh * *mesh) PURE;
  STDMETHOD(CreateMeshBuilder)(THIS_ IDirect3DRMMeshBuilder * *mesh_builder)
      PURE;
  ...
  STDMETHOD(CreateTexture)(THIS_ D3DRMIMAGE * image,
                           IDirect3DRMTexture * *texture) PURE;
  STDMETHOD(CreateLight)(THIS_ D3DRMLIGHTTYPE type, D3DCOLOR color,
                         IDirect3DRMLight * *light) PURE;
  STDMETHOD(CreateLightRGB)(THIS_ D3DRMLIGHTTYPE type, D3DVALUE r, D3DVALUE g,
                            D3DVALUE b, IDirect3DRMLight * *light) PURE;
  STDMETHOD(CreateMaterial)(THIS_ D3DVALUE power,
                            IDirect3DRMMaterial * *material) PURE;
  STDMETHOD(CreateDevice)(THIS_ DWORD width, DWORD height,
                          IDirect3DRMDevice * *device) PURE;
  STDMETHOD(CreateDeviceFromSurface)(THIS_ GUID * guid, IDirectDraw * ddraw,
                                     IDirectDrawSurface * surface,
                                     IDirect3DRMDevice * *device) PURE;
  STDMETHOD(CreateDeviceFromD3D)(THIS_ IDirect3D * d3d,
                                 IDirect3DDevice * d3d_device,
                                 IDirect3DRMDevice * *device) PURE;
  STDMETHOD(CreateDeviceFromClipper)(THIS_ IDirectDrawClipper * clipper,
                                     GUID * guid, int width, int height,
                                     IDirect3DRMDevice **device) PURE;
  STDMETHOD(CreateTextureFromSurface)(THIS_ IDirectDrawSurface * surface,
                                      IDirect3DRMTexture * *texture) PURE;
  STDMETHOD(CreateShadow)(THIS_ IDirect3DRMVisual * visual,
                          IDirect3DRMLight * light, D3DVALUE px, D3DVALUE py,
                          D3DVALUE pz, D3DVALUE nx, D3DVALUE ny, D3DVALUE nz,
                          IDirect3DRMVisual * *shadow) PURE;
  STDMETHOD(CreateViewport)(
      THIS_ IDirect3DRMDevice * device, IDirect3DRMFrame * camera, DWORD x,
      DWORD y, DWORD width, DWORD height, IDirect3DRMViewport * *viewport) PURE;
  STDMETHOD(CreateWrap)(THIS_ D3DRMWRAPTYPE type, IDirect3DRMFrame * reference,
                        ...
                        D3DVALUE sv, IDirect3DRMWrap * *wrap) PURE;
  STDMETHOD(CreateUserVisual)(THIS_ D3DRMUSERVISUALCALLBACK cb, void *ctx,
                              IDirect3DRMUserVisual **visual) PURE;
  STDMETHOD(LoadTexture)(THIS_ const char *filename,
                         IDirect3DRMTexture **texture) PURE;
  STDMETHOD(LoadTextureFromResource)(THIS_ HRSRC resource,
                                     IDirect3DRMTexture * *texture) PURE;
  ...
  STDMETHOD(GetNamedObject)(THIS_ const char *name, IDirect3DRMObject **object)
      PURE;
  STDMETHOD(EnumerateObjects)(THIS_ D3DRMOBJECTCALLBACK cb, void *ctx) PURE;
  STDMETHOD(Load)(THIS_ void *source, void *object_id, IID **iids,
                  DWORD iid_count, D3DRMLOADOPTIONS flags,
                  D3DRMLOADCALLBACK load_cb, void *load_ctx,
                  D3DRMLOADTEXTURECALLBACK load_tex_cb, void *load_tex_ctx,
...
#define IDirect3DRM_CreateShadow(p, a, b, c, d, e, f, g, h, i)                 \
...
#define IDirect3DRM_CreateWrap(p, a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, \
                               q)                                              \
  (p)->lpVtbl->CreateWrap(p, a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, q)
#define IDirect3DRM_CreateUserVisual(p, a, b, c)                               \
  (p)->lpVtbl->CreateUserVisual(p, a, b, c)
#define IDirect3DRM_LoadTexture(p, a, b) (p)->lpVtbl->LoadTexture(p, a, b)
#define IDirect3DRM_LoadTextureFromResource(p, a, b)                           \
...
#define IDirect3DRM_SetDefaultTextureColors(p, a)                              \
  (p)->lpVtbl->SetDefaultTextureColors(p, a)
#define IDirect3DRM_SetDefaultTextureShades(p, a)                              \
...
#define IDirect3DRM_EnumerateObjects(p, a, b)                                  \
...
#define IDirect3DRM_CreateShadow(p, a, b, c, d, e, f, g, h, i)                 \
  (p)->CreateShadow(a, b, c, d, e, f, g, h, i)
#define IDirect3DRM_CreateViewport(p, a, b, c, d, e, f, g)                     \
  (p)->CreateViewport(a, b, c, d, e, f, g)
#define IDirect3DRM_CreateWrap(p, a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, \
                               q)                                              \
  (p)->CreateWrap(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, q)
...
#define IDirect3DRM_SetDefaultTextureColors(p, a)                              \
  (p)->SetDefaultTextureColors(a)
#define IDirect3DRM_SetDefaultTextureShades(p, a)                              \
  (p)->SetDefaultTextureShades(a)
...
DECLARE_INTERFACE_(IDirect3DRM2, IUnknown) {
  ...
  STDMETHOD(CreateObject)(THIS_ REFCLSID clsid, IUnknown * outer, REFIID iid,
                          void **out) PURE;
  STDMETHOD(CreateFrame)(THIS_ IDirect3DRMFrame * parent,
                         IDirect3DRMFrame2 * *frame) PURE;
  STDMETHOD(CreateMesh)(THIS_ IDirect3DRMMesh * *mesh) PURE;
  STDMETHOD(CreateMeshBuilder)(THIS_ IDirect3DRMMeshBuilder2 * *mesh_builder)
      PURE;
  STDMETHOD(CreateFace)(THIS_ IDirect3DRMFace * *face) PURE;
  STDMETHOD(CreateAnimation)(THIS_ IDirect3DRMAnimation * *animation) PURE;
  STDMETHOD(CreateAnimationSet)(THIS_ IDirect3DRMAnimationSet * *set) PURE;
  ...
  STDMETHOD(CreateDeviceFromSurface)(THIS_ GUID * guid, IDirectDraw * ddraw,
                                     IDirectDrawSurface * surface,
                                     IDirect3DRMDevice2 * *device) PURE;
  STDMETHOD(CreateDeviceFromD3D)(THIS_ IDirect3D2 * d3d,
  ...
  STDMETHOD(LoadTextureFromResource)(
      THIS_ HMODULE module, const char *resource_name,
  ...
  STDMETHOD(Load)(THIS_ void *source, void *object_id, IID **iids,
                  ...
                  IDirect3DRMFrame *parent_frame) PURE;
  STDMETHOD(Tick)(THIS_ D3DVALUE) PURE;
  STDMETHOD(CreateProgressiveMesh)(THIS_ IDirect3DRMProgressiveMesh * *mesh)
      PURE;
};
#undef INTERFACE
#if !defined(__cplusplus) || defined(CINTERFACE)
/*** IUnknown methods ***/
#define IDirect3DRM2_QueryInterface(p, a, b)                                   \
...
#define IDirect3DRM2_CreateAnimationSet(p, a)                                  \
  (p)->lpVtbl->CreateAnimationSet(p, a)
#define IDirect3DRM2_CreateTexture(p, a, b) (p)->lpVtbl->CreateTexture(p, a, b)
#define IDirect3DRM2_CreateLight(p, a, b, c)                                   \
  (p)->lpVtbl->CreateLight(p, a, b, c)
#define IDirect3DRM2_CreateLightRGB(p, a, b, c, d, e)                          \
  (p)->lpVtbl->CreateLightRGB(p, a, b, c, d, e)
#define IDirect3DRM2_CreateMaterial(p, a, b)                                   \
...
#define IDirect3DRM2_CreateTextureFromSurface(p, a, b)                         \
  (p)->lpVtbl->CreateTextureFromSurface(p, a, b)
#define IDirect3DRM2_CreateShadow(p, a, b, c, d, e, f, g, h, i)                \
  (p)->lpVtbl->CreateShadow(p, a, b, c, d, e, f, g, h, i)
#define IDirect3DRM2_CreateViewport(p, a, b, c, d, e, f, g)                    \
  (p)->lpVtbl->CreateViewport(p, a, b, c, d, e, f, g)
#define IDirect3DRM2_CreateWrap(p, a, b, c, d, e, f, g, h, i, j, k, l, m, n,   \
                                o, q)                                          \
  (p)->lpVtbl->CreateWrap(p, a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, q)
#define IDirect3DRM2_CreateUserVisual(p, a, b, c)                              \
  (p)->lpVtbl->CreateUserVisual(p, a, b, c)
#define IDirect3DRM2_LoadTexture(p, a, b) (p)->lpVtbl->LoadTexture(p, a, b)
#define IDirect3DRM2_LoadTextureFromResource(p, a, b, c, d)                    \
...
#define IDirect3DRM2_SetDefaultTextureColors(p, a)                             \
  (p)->lpVtbl->SetDefaultTextureColors(p, a)
#define IDirect3DRM2_SetDefaultTextureShades(p, a)                             \
  (p)->lpVtbl->SetDefaultTextureShades(p, a)
#define IDirect3DRM2_GetDevices(p, a) (p)->lpVtbl->GetDevices(p, a)
#define IDirect3DRM2_GetNamedObject(p, a, b)                                   \
  (p)->lpVtbl->GetNamedObject(p, a, b)
#define IDirect3DRM2_EnumerateObjects(p, a, b)                                 \
  (p)->lpVtbl->EnumerateObjects(p, a, b)
#define IDirect3DRM2_Load(p, a, b, c, d, e, f, g, h, i, j)                     \
  (p)->lpVtbl->Load(p, a, b, c, d, e, f, g, h, i, j)
#define IDirect3DRM2_Tick(p, a) (p)->lpVtbl->Tick(p, a)
#define IDirect3DRM2_CreateProgressiveMesh(p, a)                               \
...
DECLARE_INTERFACE_(IDirect3DRM3, IUnknown) {
  ...
  STDMETHOD(CreateObject)(THIS_ REFCLSID clsid, IUnknown * outer, REFIID iid,
                          void **out) PURE;
  STDMETHOD(CreateFrame)(THIS_ IDirect3DRMFrame3 * parent,
                         IDirect3DRMFrame3 * *frame) PURE;
  STDMETHOD(CreateMesh)(THIS_ IDirect3DRMMesh * *mesh) PURE;
  STDMETHOD(CreateMeshBuilder)(THIS_ IDirect3DRMMeshBuilder3 * *mesh_builder)
      PURE;
  ...
  STDMETHOD(CreateLightRGB)(THIS_ D3DRMLIGHTTYPE type, D3DVALUE r, D3DVALUE g,
                            D3DVALUE b, IDirect3DRMLight * *light) PURE;
  STDMETHOD(CreateMaterial)(THIS_ D3DVALUE, IDirect3DRMMaterial2 * *material)
      PURE;
  STDMETHOD(CreateDevice)(THIS_ DWORD width, DWORD height,
  ...
  STDMETHOD(CreateTextureFromSurface)(THIS_ IDirectDrawSurface * surface,
                                      IDirect3DRMTexture3 * *texture) PURE;
  STDMETHOD(CreateShadow)(THIS_ IUnknown * object, IDirect3DRMLight * light,
                          D3DVALUE px, D3DVALUE py, D3DVALUE pz, D3DVALUE nx,
                          D3DVALUE ny, D3DVALUE nz,
                          IDirect3DRMShadow2 * *shadow) PURE;
  STDMETHOD(CreateViewport)(THIS_ IDirect3DRMDevice3 * device,
                            IDirect3DRMFrame3 * camera, DWORD x, DWORD y,
                            DWORD width, DWORD height,
                            IDirect3DRMViewport2 * *viewport) PURE;
  ...
  STDMETHOD(CreateClippedVisual)(THIS_ IDirect3DRMVisual * visual,
...
#if !defined(__cplusplus) || defined(CINTERFACE)
/*** IUnknown methods ***/
#define IDirect3DRM3_QueryInterface(p, a, b)                                   \
  (p)->lpVtbl->QueryInterface(p, a, b)
...
#define IDirect3DRM3_CreateAnimationSet(p, a)                                  \
  (p)->lpVtbl->CreateAnimationSet(p, a)
...
#define IDirect3DRM3_CreateTextureFromSurface(p, a, b)                         \
  (p)->lpVtbl->CreateTextureFromSurface(p, a, b)
#define IDirect3DRM3_CreateShadow(p, a, b, c, d, e, f, g, h, i)                \
  (p)->lpVtbl->CreateShadow(p, a, b, c, d, e, f, g, h, i)
#define IDirect3DRM3_CreateViewport(p, a, b, c, d, e, f, g)                    \
  (p)->lpVtbl->CreateViewport(p, a, b, c, d, e, f, g)
#define IDirect3DRM3_CreateWrap(p, a, b, c, d, e, f, g, h, i, j, k, l, m, n,   \
                                o, q)                                          \
  (p)->lpVtbl->CreateWrap(p, a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, q)
#define IDirect3DRM3_CreateUserVisual(p, a, b, c)                              \
  (p)->lpVtbl->CreateUserVisual(p, a, b, c)
#define IDirect3DRM3_LoadTexture(p, a, b) (p)->lpVtbl->LoadTexture(p, a, b)
#define IDirect3DRM3_LoadTextureFromResource(p, a, b, c, d)                    \
  (p)->lpVtbl->LoadTextureFromResource(p, a, b, c, d)
...
#define IDirect3DRM3_SetDefaultTextureColors(p, a)                             \
  (p)->lpVtbl->SetDefaultTextureColors(p, a)
#define IDirect3DRM3_SetDefaultTextureShades(p, a)                             \
  (p)->lpVtbl->SetDefaultTextureShades(p, a)
#define IDirect3DRM3_GetDevices(p, a) (p)->lpVtbl->GetDevices(p, a)
#define IDirect3DRM3_GetNamedObject(p, a, b)                                   \
  (p)->lpVtbl->GetNamedObject(p, a, b)
#define IDirect3DRM3_EnumerateObjects(p, a, b)                                 \
  (p)->lpVtbl->EnumerateObjects(p, a, b)
#define IDirect3DRM3_Load(p, a, b, c, d, e, f, g, h, i, j)                     \
  (p)->lpVtbl->Load(p, a, b, c, d, e, f, g, h, i, j)
#define IDirect3DRM3_Tick(p, a) (p)->lpVtbl->Tick(p, a)
#define IDirect3DRM3_CreateProgressiveMesh(p, a)                               \
  (p)->lpVtbl->CreateProgressiveMesh(p, a)
#define IDirect3DRM3_RegisterClient(p, a, b)                                   \
  (p)->lpVtbl->RegisterClient(p, a, b)
#define IDirect3DRM3_UnregisterClient(p, a) (p)->lpVtbl->UnregisterClient(p, a)
#define IDirect3DRM3_CreateClippedVisual(p, a, b)                              \
