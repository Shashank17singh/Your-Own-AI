...
NET_API_STATUS WINAPI NetScheduleJobAdd(LPCWSTR Servername, LPBYTE Buffer,
                                        LPDWORD JobId);
NET_API_STATUS WINAPI NetScheduleJobDel(LPCWSTR Servername, DWORD MinJobId,
                                        DWORD MaxJobId);
NET_API_STATUS WINAPI NetScheduleJobEnum(
...
NET_API_STATUS WINAPI NetScheduleJobGetInfo(LPCWSTR Servername, DWORD JobId,
