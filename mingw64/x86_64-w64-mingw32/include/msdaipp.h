...
const GUID DBPROPSET_MSDAIPP_INIT = {
    0x8f1033e3, 0xb2cd, 0x11d1, {0x9c, 0x74, 0x0, 0x0, 0xf8, 0x75, 0xac, 0x61}};
...
enum MFO { MFO_DONTCHANGE = 0, MFO_MARK = 1, MFO_UNMARK = 2 };
...
extern const DBID DBROWCOL_ISMARKEDFOROFFLINE = {
    DBGUID_RESOURCE_ISMARKEDFOROFFLINE, DBKIND_GUID, 0};
#else
extern const DBID DBROWCOL_ISMARKEDFOROFFLINE;
#endif
...
const GUID GUID_IPPCOMMAND = {
    0xd395c253, 0x6511, 0x11d1, {0x9c, 0x9, 0x0, 0x0, 0xf8, 0x75, 0xac, 0x61}};
const GUID GUID_DAV_PROVIDER = {0x9FECD570, 0xB9D4, 0x11d1, 0x9C, 0x78, 0x00,
                                0x00,       0xF8,   0x75,   0xAC, 0x61};
const GUID GUID_WEC_PROVIDER = {0x9FECD571, 0xB9D4, 0x11d1, 0x9C, 0x78, 0x00,
                                0x00,       0xF8,   0x75,   0xAC, 0x61};
const GUID GUID_HTTP_PROVIDER = {0x9FECD572, 0xB9D4, 0x11d1, 0x9C, 0x78, 0x00,
                                 0x00,       0xF8,   0x75,   0xAC, 0x61};
...
typedef struct ISynchronizeRowVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ISynchronizeRow *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ISynchronizeRow *This);
  ULONG(WINAPI *Release)(ISynchronizeRow *This);
  HRESULT(WINAPI *Synchronize)(ISynchronizeRow *This,
                               MSDAIPP_SYNC_FLAGS dwFlags);
  END_INTERFACE
} ISynchronizeRowVtbl;
...
#endif
#endif
HRESULT WINAPI ISynchronizeRow_Synchronize_Proxy(ISynchronizeRow *This,
                                                 MSDAIPP_SYNC_FLAGS dwFlags);
