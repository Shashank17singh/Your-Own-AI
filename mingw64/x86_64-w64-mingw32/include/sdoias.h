...
typedef enum _NAMESPROPERTIES { PROPERTY_NAMES_REALMS = 0x402 } NAMESPROPERTIES;
...
public:
  ...
  virtual HRESULT WINAPI GetServiceSDO(IASDATASTORE eDataStore,
                                       BSTR bstrServiceName,
                                       IUnknown **ppServiceSDO) = 0;
  virtual HRESULT WINAPI GetUserSDO(IASDATASTORE eDataStore, BSTR bstrUserName,
                                    IUnknown **ppUserSDO) = 0;
  virtual HRESULT WINAPI GetOSType(IASOSTYPE *eOSType) = 0;
  virtual HRESULT WINAPI GetDomainType(IASDOMAINTYPE *eDomainType) = 0;
  virtual HRESULT WINAPI
  IsDirectoryAvailable(VARIANT_BOOL *boolDirectoryAvailable) = 0;
...
typedef struct ISdoMachineVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ISdoMachine *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ISdoMachine *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ISdoMachine *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ISdoMachine *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *Attach)(ISdoMachine *This, BSTR bstrComputerName);
  HRESULT(WINAPI *GetDictionarySDO)(ISdoMachine *This,
                                    IUnknown **ppDictionarySDO);
  HRESULT(WINAPI *GetServiceSDO)(ISdoMachine *This, IASDATASTORE eDataStore,
                                 BSTR bstrServiceName, IUnknown **ppServiceSDO);
  HRESULT(WINAPI *GetUserSDO)(ISdoMachine *This, IASDATASTORE eDataStore,
                              BSTR bstrUserName, IUnknown **ppUserSDO);
  ...
  HRESULT(WINAPI *IsDirectoryAvailable)(ISdoMachine *This,
                                        VARIANT_BOOL *boolDirectoryAvailable);
  HRESULT(WINAPI *GetAttachedComputer)(ISdoMachine *This,
...
#define ISdoMachine_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,         \
                                  rgDispId)                                    \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ISdoMachine_Invoke(This, dispIdMember, riid, lcid, wFlags,             \
...
#define ISdoMachine_GetServiceSDO(This, eDataStore, bstrServiceName,           \
                                  ppServiceSDO)                                \
...
#endif
#endif
HRESULT WINAPI ISdoMachine_Attach_Proxy(ISdoMachine *This,
                                        BSTR bstrComputerName);
void __RPC_STUB ISdoMachine_Attach_Stub(IRpcStubBuffer *This,
                                        IRpcChannelBuffer *_pRpcChannelBuffer,
                                        PRPC_MESSAGE _pRpcMessage,
                                        DWORD *_pdwStubPhase);
HRESULT WINAPI ISdoMachine_GetDictionarySDO_Proxy(ISdoMachine *This,
                                                  IUnknown **ppDictionarySDO);
...
HRESULT WINAPI ISdoMachine_GetServiceSDO_Proxy(ISdoMachine *This,
                                               IASDATASTORE eDataStore,
                                               BSTR bstrServiceName,
                                               IUnknown **ppServiceSDO);
void __RPC_STUB ISdoMachine_GetServiceSDO_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISdoMachine_GetUserSDO_Proxy(ISdoMachine *This,
                                            IASDATASTORE eDataStore,
                                            BSTR bstrUserName,
                                            IUnknown **ppUserSDO);
void __RPC_STUB ISdoMachine_GetUserSDO_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISdoMachine_GetOSType_Proxy(ISdoMachine *This,
                                           IASOSTYPE *eOSType);
void __RPC_STUB ISdoMachine_GetOSType_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISdoMachine_GetDomainType_Proxy(ISdoMachine *This,
                                               IASDOMAINTYPE *eDomainType);
void __RPC_STUB ISdoMachine_GetDomainType_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISdoMachine_IsDirectoryAvailable_Proxy(
    ISdoMachine *This, VARIANT_BOOL *boolDirectoryAvailable);
void __RPC_STUB ISdoMachine_IsDirectoryAvailable_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISdoMachine_GetAttachedComputer_Proxy(ISdoMachine *This,
                                                     BSTR *bstrComputerName);
void __RPC_STUB ISdoMachine_GetAttachedComputer_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISdoMachine_GetSDOSchema_Proxy(ISdoMachine *This,
                                              IUnknown **ppSDOSchema);
...
typedef struct ISdoServiceControlVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ISdoServiceControl *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ISdoServiceControl *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ISdoServiceControl *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ISdoServiceControl *This, DISPID dispIdMember,
...
#define ISdoServiceControl_GetTypeInfo(This, iTInfo, lcid, ppTInfo)            \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ISdoServiceControl_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,  \
                                         rgDispId)                             \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ISdoServiceControl_Invoke(This, dispIdMember, riid, lcid, wFlags,      \
...
HRESULT WINAPI ISdoServiceControl_GetServiceStatus_Proxy(
    ISdoServiceControl *This, LONG *status);
...
public:
  virtual HRESULT WINAPI GetPropertyInfo(LONG Id,
                                         IUnknown **ppPropertyInfo) = 0;
...
typedef struct ISdoVtbl {
  ...
  HRESULT(WINAPI *GetTypeInfo)(ISdo *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ISdo *This, REFIID riid, LPOLESTR *rgszNames,
                                 UINT cNames, LCID lcid, DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ISdo *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *GetPropertyInfo)(ISdo *This, LONG Id,
                                   IUnknown **ppPropertyInfo);
...
#define ISdo_GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)      \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ISdo_Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,       \
                    pVarResult, pExcepInfo, puArgErr)                          \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI ISdo_GetPropertyInfo_Proxy(ISdo *This, LONG Id,
                                          IUnknown **ppPropertyInfo);
void __RPC_STUB ISdo_GetPropertyInfo_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI ISdo_GetProperty_Proxy(ISdo *This, LONG Id, VARIANT *pValue);
void __RPC_STUB ISdo_GetProperty_Stub(IRpcStubBuffer *This,
                                      IRpcChannelBuffer *_pRpcChannelBuffer,
                                      PRPC_MESSAGE _pRpcMessage,
                                      DWORD *_pdwStubPhase);
HRESULT WINAPI ISdo_PutProperty_Proxy(ISdo *This, LONG Id, VARIANT *pValue);
void __RPC_STUB ISdo_PutProperty_Stub(IRpcStubBuffer *This,
                                      IRpcChannelBuffer *_pRpcChannelBuffer,
                                      PRPC_MESSAGE _pRpcMessage,
                                      DWORD *_pdwStubPhase);
HRESULT WINAPI ISdo_ResetProperty_Proxy(ISdo *This, LONG Id);
void __RPC_STUB ISdo_ResetProperty_Stub(IRpcStubBuffer *This,
                                        IRpcChannelBuffer *_pRpcChannelBuffer,
                                        PRPC_MESSAGE _pRpcMessage,
                                        DWORD *_pdwStubPhase);
HRESULT WINAPI ISdo_Apply_Proxy(ISdo *This);
void __RPC_STUB ISdo_Apply_Stub(IRpcStubBuffer *This,
                                IRpcChannelBuffer *_pRpcChannelBuffer,
                                PRPC_MESSAGE _pRpcMessage,
                                DWORD *_pdwStubPhase);
HRESULT WINAPI ISdo_Restore_Proxy(ISdo *This);
void __RPC_STUB ISdo_Restore_Stub(IRpcStubBuffer *This,
                                  IRpcChannelBuffer *_pRpcChannelBuffer,
                                  PRPC_MESSAGE _pRpcMessage,
                                  DWORD *_pdwStubPhase);
HRESULT WINAPI ISdo_get__NewEnum_Proxy(ISdo *This, IUnknown **ppEnumVARIANT);
void __RPC_STUB ISdo_get__NewEnum_Stub(IRpcStubBuffer *This,
                                       IRpcChannelBuffer *_pRpcChannelBuffer,
                                       PRPC_MESSAGE _pRpcMessage,
                                       DWORD *_pdwStubPhase);
#endif
...
typedef struct ISdoCollectionVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ISdoCollection *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ISdoCollection *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ISdoCollection *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ISdoCollection *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  ...
  HRESULT(WINAPI *IsNameUnique)(ISdoCollection *This, BSTR bstrName,
                                VARIANT_BOOL *pBool);
...
#define ISdoCollection_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ISdoCollection_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,      \
                                     rgDispId)                                 \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ISdoCollection_Invoke(This, dispIdMember, riid, lcid, wFlags,          \
                              pDispParams, pVarResult, pExcepInfo, puArgErr)   \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI ISdoCollection_get_Count_Proxy(ISdoCollection *This,
                                              __LONG32 *pCount);
void __RPC_STUB ISdoCollection_get_Count_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISdoCollection_Add_Proxy(ISdoCollection *This, BSTR bstrName,
                                        IDispatch **ppItem);
void __RPC_STUB ISdoCollection_Add_Stub(IRpcStubBuffer *This,
                                        IRpcChannelBuffer *_pRpcChannelBuffer,
                                        PRPC_MESSAGE _pRpcMessage,
                                        DWORD *_pdwStubPhase);
HRESULT WINAPI ISdoCollection_Remove_Proxy(ISdoCollection *This,
                                           IDispatch *pItem);
...
void __RPC_STUB ISdoCollection_Reload_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISdoCollection_IsNameUnique_Proxy(ISdoCollection *This,
                                                 BSTR bstrName,
                                                 VARIANT_BOOL *pBool);
void __RPC_STUB ISdoCollection_IsNameUnique_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISdoCollection_Item_Proxy(ISdoCollection *This, VARIANT *Name,
                                         IDispatch **pItem);
void __RPC_STUB ISdoCollection_Item_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
HRESULT WINAPI ISdoCollection_get__NewEnum_Proxy(ISdoCollection *This,
...
public:
  ...
  virtual HRESULT WINAPI GetAttributeInfo(ATTRIBUTEID Id, VARIANT *pInfoIDs,
                                          VARIANT *pInfoValues) = 0;
  virtual HRESULT WINAPI EnumAttributeValues(ATTRIBUTEID Id, VARIANT *pValueIds,
                                             VARIANT *pValuesDesc) = 0;
  virtual HRESULT WINAPI CreateAttribute(ATTRIBUTEID Id,
                                         IDispatch **ppAttributeObject) = 0;
  virtual HRESULT WINAPI GetAttributeID(BSTR bstrAttributeName,
                                        ATTRIBUTEID *pId) = 0;
};
#else
typedef struct ISdoDictionaryOldVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ISdoDictionaryOld *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ISdoDictionaryOld *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ISdoDictionaryOld *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ISdoDictionaryOld *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *EnumAttributes)(ISdoDictionaryOld *This, VARIANT *Id,
                                  VARIANT *pValues);
  HRESULT(WINAPI *GetAttributeInfo)(ISdoDictionaryOld *This, ATTRIBUTEID Id,
                                    VARIANT *pInfoIDs, VARIANT *pInfoValues);
  HRESULT(WINAPI *EnumAttributeValues)(ISdoDictionaryOld *This, ATTRIBUTEID Id,
                                       VARIANT *pValueIds,
                                       VARIANT *pValuesDesc);
  HRESULT(WINAPI *CreateAttribute)(ISdoDictionaryOld *This, ATTRIBUTEID Id,
                                   IDispatch **ppAttributeObject);
  HRESULT(WINAPI *GetAttributeID)(ISdoDictionaryOld *This,
                                  BSTR bstrAttributeName, ATTRIBUTEID *pId);
  END_INTERFACE
...
#define ISdoDictionaryOld_GetTypeInfo(This, iTInfo, lcid, ppTInfo)             \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ISdoDictionaryOld_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,   \
                                        rgDispId)                              \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ISdoDictionaryOld_Invoke(This, dispIdMember, riid, lcid, wFlags,       \
                                 pDispParams, pVarResult, pExcepInfo,          \
                                 puArgErr)                                     \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#define ISdoDictionaryOld_EnumAttributeValues(This, Id, pValueIds,             \
                                              pValuesDesc)                     \
...
#endif
#endif
HRESULT WINAPI ISdoDictionaryOld_EnumAttributes_Proxy(ISdoDictionaryOld *This,
                                                      VARIANT *Id,
                                                      VARIANT *pValues);
void __RPC_STUB ISdoDictionaryOld_EnumAttributes_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISdoDictionaryOld_GetAttributeInfo_Proxy(ISdoDictionaryOld *This,
                                                        ATTRIBUTEID Id,
                                                        VARIANT *pInfoIDs,
                                                        VARIANT *pInfoValues);
void __RPC_STUB ISdoDictionaryOld_GetAttributeInfo_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISdoDictionaryOld_EnumAttributeValues_Proxy(
    ISdoDictionaryOld *This, ATTRIBUTEID Id, VARIANT *pValueIds,
    VARIANT *pValuesDesc);
void __RPC_STUB ISdoDictionaryOld_EnumAttributeValues_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISdoDictionaryOld_CreateAttribute_Proxy(
    ISdoDictionaryOld *This, ATTRIBUTEID Id, IDispatch **ppAttributeObject);
void __RPC_STUB ISdoDictionaryOld_CreateAttribute_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISdoDictionaryOld_GetAttributeID_Proxy(ISdoDictionaryOld *This,
...
typedef enum _IDENTITY_TYPE { IAS_IDENTITY_NO_DEFAULT = 1 } IDENTITY_TYPE;
