...
extern "C" {
#endif
HRESULT WINAPI RoActivateInstance(HSTRING activatableClassId,
...
HRESULT WINAPI RoRegisterForApartmentShutdown(
    IApartmentShutdown *callbackObj, UINT64 *apartmentId,
...
__inline void Uninitialize() { RoUninitialize(); }
template <class T>
__inline HRESULT GetActivationFactory(HSTRING classid, T **factory) {
