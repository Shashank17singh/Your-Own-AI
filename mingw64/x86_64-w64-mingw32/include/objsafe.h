...
public:
  virtual HRESULT WINAPI GetInterfaceSafetyOptions(
      REFIID riid, DWORD *pdwSupportedOptions, DWORD *pdwEnabledOptions) = 0;
  virtual HRESULT WINAPI SetInterfaceSafetyOptions(REFIID riid,
...
typedef struct IObjectSafetyVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IObjectSafety *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IObjectSafety *This);
  ULONG(WINAPI *Release)(IObjectSafety *This);
  HRESULT(WINAPI *GetInterfaceSafetyOptions)(IObjectSafety *This, REFIID riid,
                                             DWORD *pdwSupportedOptions,
                                             DWORD *pdwEnabledOptions);
  HRESULT(WINAPI *SetInterfaceSafetyOptions)(IObjectSafety *This, REFIID riid,
                                             DWORD dwOptionSetMask,
...
#define IObjectSafety_GetInterfaceSafetyOptions(                               \
    This, riid, pdwSupportedOptions, pdwEnabledOptions)                        \
  (This)->lpVtbl->GetInterfaceSafetyOptions(This, riid, pdwSupportedOptions,   \
                                            pdwEnabledOptions)
#define IObjectSafety_SetInterfaceSafetyOptions(This, riid, dwOptionSetMask,   \
                                                dwEnabledOptions)              \
  (This)->lpVtbl->SetInterfaceSafetyOptions(This, riid, dwOptionSetMask,       \
                                            dwEnabledOptions)
#endif
#endif
HRESULT WINAPI IObjectSafety_GetInterfaceSafetyOptions_Proxy(
    IObjectSafety *This, REFIID riid, DWORD *pdwSupportedOptions,
    DWORD *pdwEnabledOptions);
...
HRESULT WINAPI IObjectSafety_SetInterfaceSafetyOptions_Proxy(
    IObjectSafety *This, REFIID riid, DWORD dwOptionSetMask,
    DWORD dwEnabledOptions);
