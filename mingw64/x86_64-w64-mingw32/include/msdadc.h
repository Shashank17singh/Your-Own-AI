...
public:
  virtual HRESULT WINAPI DataConvert(DBTYPE wSrcType, DBTYPE wDstType,
                                     DBLENGTH cbSrcLength,
                                     DBLENGTH *pcbDstLength, void *pSrc,
                                     void *pDst, DBLENGTH cbDstMaxLength,
                                     DBSTATUS dbsSrcStatus,
                                     DBSTATUS *pdbsStatus, BYTE bPrecision,
                                     BYTE bScale, DBDATACONVERT dwFlags) = 0;
  virtual HRESULT WINAPI CanConvert(DBTYPE wSrcType, DBTYPE wDstType) = 0;
  virtual HRESULT WINAPI GetConversionSize(DBTYPE wSrcType, DBTYPE wDstType,
...
typedef struct IDataConvertVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IDataConvert *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IDataConvert *This);
  ULONG(WINAPI *Release)(IDataConvert *This);
  HRESULT(WINAPI *DataConvert)(IDataConvert *This, DBTYPE wSrcType,
                               DBTYPE wDstType, DBLENGTH cbSrcLength,
                               DBLENGTH *pcbDstLength, void *pSrc, void *pDst,
                               DBLENGTH cbDstMaxLength, DBSTATUS dbsSrcStatus,
                               DBSTATUS *pdbsStatus, BYTE bPrecision,
                               BYTE bScale, DBDATACONVERT dwFlags);
  HRESULT(WINAPI *CanConvert)(IDataConvert *This, DBTYPE wSrcType,
                              DBTYPE wDstType);
  HRESULT(WINAPI *GetConversionSize)(IDataConvert *This, DBTYPE wSrcType,
                                     DBTYPE wDstType, DBLENGTH *pcbSrcLength,
                                     DBLENGTH *pcbDstLength, void *pSrc);
  END_INTERFACE
} IDataConvertVtbl;
struct IDataConvert {
...
#define IDataConvert_DataConvert(                                              \
    This, wSrcType, wDstType, cbSrcLength, pcbDstLength, pSrc, pDst,           \
    cbDstMaxLength, dbsSrcStatus, pdbsStatus, bPrecision, bScale, dwFlags)     \
  (This)->lpVtbl->DataConvert(                                                 \
      This, wSrcType, wDstType, cbSrcLength, pcbDstLength, pSrc, pDst,         \
      cbDstMaxLength, dbsSrcStatus, pdbsStatus, bPrecision, bScale, dwFlags)
#define IDataConvert_CanConvert(This, wSrcType, wDstType)                      \
  (This)->lpVtbl->CanConvert(This, wSrcType, wDstType)
#define IDataConvert_GetConversionSize(This, wSrcType, wDstType, pcbSrcLength, \
                                       pcbDstLength, pSrc)                     \
  (This)->lpVtbl->GetConversionSize(This, wSrcType, wDstType, pcbSrcLength,    \
                                    pcbDstLength, pSrc)
#endif
#endif
HRESULT WINAPI IDataConvert_DataConvert_Proxy(
    IDataConvert *This, DBTYPE wSrcType, DBTYPE wDstType, DBLENGTH cbSrcLength,
    DBLENGTH *pcbDstLength, void *pSrc, void *pDst, DBLENGTH cbDstMaxLength,
    DBSTATUS dbsSrcStatus, DBSTATUS *pdbsStatus, BYTE bPrecision, BYTE bScale,
...
HRESULT WINAPI IDataConvert_CanConvert_Proxy(IDataConvert *This,
...
HRESULT WINAPI IDataConvert_GetConversionSize_Proxy(
    ...
    DBLENGTH *pcbSrcLength, DBLENGTH *pcbDstLength, void *pSrc);
...
public:
  virtual HRESULT WINAPI GetInfo(ULONG cInfo, DCINFOTYPE rgeInfoType[],
                                 DCINFO **prgInfo) = 0;
...
typedef struct IDCInfoVtbl {
  ...
  HRESULT(WINAPI *GetInfo)(IDCInfo *This, ULONG cInfo, DCINFOTYPE rgeInfoType[],
                           DCINFO **prgInfo);
...
#endif
#endif
HRESULT WINAPI IDCInfo_GetInfo_Proxy(IDCInfo *This, ULONG cInfo,
                                     DCINFOTYPE rgeInfoType[],
                                     DCINFO **prgInfo);
void __RPC_STUB IDCInfo_GetInfo_Stub(IRpcStubBuffer *This,
                                     IRpcChannelBuffer *_pRpcChannelBuffer,
                                     PRPC_MESSAGE _pRpcMessage,
                                     DWORD *_pdwStubPhase);
HRESULT WINAPI IDCInfo_SetInfo_Proxy(IDCInfo *This, ULONG cInfo,
                                     DCINFO rgInfo[]);
void __RPC_STUB IDCInfo_SetInfo_Stub(IRpcStubBuffer *This,
                                     IRpcChannelBuffer *_pRpcChannelBuffer,
                                     PRPC_MESSAGE _pRpcMessage,
                                     DWORD *_pdwStubPhase);
#endif
extern const GUID OLEDBDECLSPEC IID_IDataConvert = {
    0x0c733a8d,
    0x2a1c,
    0x11ce,
    {0xad, 0xe5, 0x00, 0xaa, 0x00, 0x44, 0x77, 0x3d}};
extern const GUID OLEDBDECLSPEC IID_IDCInfo = {
    0x0c733a9c,
    0x2a1c,
    0x11ce,
    {0xad, 0xe5, 0x00, 0xaa, 0x00, 0x44, 0x77, 0x3d}};
