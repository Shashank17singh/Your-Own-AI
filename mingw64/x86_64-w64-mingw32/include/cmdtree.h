...
public:
  virtual HRESULT WINAPI FindErrorNodes(const DBCOMMANDTREE *pRoot,
                                        ULONG *pcErrorNodes,
                                        DBCOMMANDTREE ***prgErrorNodes) = 0;
  ...
  virtual HRESULT WINAPI SetCommandTree(DBCOMMANDTREE **ppRoot,
...
typedef struct ICommandTreeVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ICommandTree *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ICommandTree *This);
  ULONG(WINAPI *Release)(ICommandTree *This);
  HRESULT(WINAPI *FindErrorNodes)(ICommandTree *This,
  ...
  HRESULT(WINAPI *SetCommandTree)(ICommandTree *This, DBCOMMANDTREE **ppRoot,
                                  DBCOMMANDREUSE dwCommandReuse, WINBOOL fCopy);
  END_INTERFACE
} ICommandTreeVtbl;
struct ICommandTree {
...
#endif
#endif
HRESULT WINAPI ICommandTree_FindErrorNodes_Proxy(
    ICommandTree *This, const DBCOMMANDTREE *pRoot, ULONG *pcErrorNodes,
    DBCOMMANDTREE ***prgErrorNodes);
...
HRESULT WINAPI ICommandTree_FreeCommandTree_Proxy(ICommandTree *This,
                                                  DBCOMMANDTREE **ppRoot);
void __RPC_STUB ICommandTree_FreeCommandTree_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICommandTree_GetCommandTree_Proxy(ICommandTree *This,
                                                 DBCOMMANDTREE **ppRoot);
void __RPC_STUB ICommandTree_GetCommandTree_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICommandTree_SetCommandTree_Proxy(ICommandTree *This,
                                                 DBCOMMANDTREE **ppRoot,
                                                 DBCOMMANDREUSE dwCommandReuse,
                                                 WINBOOL fCopy);
...
public:
  virtual HRESULT WINAPI AddPostProcessing(DBCOMMANDTREE **ppRoot,
                                           WINBOOL fCopy) = 0;
...
typedef struct IQueryVtbl {
  ...
  HRESULT(WINAPI *FindErrorNodes)(IQuery *This, const DBCOMMANDTREE *pRoot,
                                  ULONG *pcErrorNodes,
                                  DBCOMMANDTREE ***prgErrorNodes);
  ...
  HRESULT(WINAPI *SetCommandTree)(IQuery *This, DBCOMMANDTREE **ppRoot,
                                  DBCOMMANDREUSE dwCommandReuse, WINBOOL fCopy);
  HRESULT(WINAPI *AddPostProcessing)(IQuery *This, DBCOMMANDTREE **ppRoot,
                                     WINBOOL fCopy);
  HRESULT(WINAPI *GetCardinalityEstimate)(IQuery *This,
...
#endif
#endif
HRESULT WINAPI IQuery_AddPostProcessing_Proxy(IQuery *This,
                                              DBCOMMANDTREE **ppRoot,
                                              WINBOOL fCopy);
void __RPC_STUB IQuery_AddPostProcessing_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IQuery_GetCardinalityEstimate_Proxy(IQuery *This,
                                                   DBORDINAL *pulCardinality);
