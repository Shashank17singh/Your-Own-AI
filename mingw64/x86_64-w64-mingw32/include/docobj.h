...
DEFINE_GUID(IID_IOleDocument, 0xb722bcc5, 0x4e68, 0x101b, 0xa2, 0xbc, 0x00,
            0xaa, 0x00, 0x40, 0x47, 0x70);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("b722bcc5-4e68-101b-a2bc-00aa00404770")
IOleDocument : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE CreateView(IOleInPlaceSite * pIPSite,
                                               IStream * pstm, DWORD dwReserved,
                                               IOleDocumentView * *ppView) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetDocMiscStatus(DWORD * pdwStatus) = 0;
  virtual HRESULT STDMETHODCALLTYPE EnumViews(IEnumOleDocumentViews * *ppEnum,
                                              IOleDocumentView * *ppView) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IOleDocument, 0xb722bcc5, 0x4e68, 0x101b, 0xa2, 0xbc, 0x00,
                0xaa, 0x00, 0x40, 0x47, 0x70)
#endif
#else
typedef struct IOleDocumentVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IOleDocument *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IOleDocument *This);
  ULONG(STDMETHODCALLTYPE *Release)(IOleDocument *This);
  /*** IOleDocument methods ***/
  HRESULT(STDMETHODCALLTYPE *CreateView)(IOleDocument *This,
                                         IOleInPlaceSite *pIPSite,
                                         IStream *pstm, DWORD dwReserved,
                                         IOleDocumentView **ppView);
  HRESULT(STDMETHODCALLTYPE *GetDocMiscStatus)(IOleDocument *This,
                                               DWORD *pdwStatus);
  HRESULT(STDMETHODCALLTYPE *EnumViews)(IOleDocument *This,
                                        IEnumOleDocumentViews **ppEnum,
                                        IOleDocumentView **ppView);
  END_INTERFACE
} IOleDocumentVtbl;
interface IOleDocument { CONST_VTBL IOleDocumentVtbl *lpVtbl; };
#ifdef COBJMACROS
...
IOleDocument_QueryInterface(IOleDocument *This, REFIID riid, void **ppvObject) {
...
/*** IOleDocument methods ***/
static inline HRESULT IOleDocument_CreateView(IOleDocument *This,
                                              IOleInPlaceSite *pIPSite,
                                              IStream *pstm, DWORD dwReserved,
                                              IOleDocumentView **ppView) {
  return This->lpVtbl->CreateView(This, pIPSite, pstm, dwReserved, ppView);
}
static inline HRESULT IOleDocument_GetDocMiscStatus(IOleDocument *This,
                                                    DWORD *pdwStatus) {
  return This->lpVtbl->GetDocMiscStatus(This, pdwStatus);
}
static inline HRESULT IOleDocument_EnumViews(IOleDocument *This,
                                             IEnumOleDocumentViews **ppEnum,
                                             IOleDocumentView **ppView) {
...
DEFINE_GUID(IID_IOleDocumentSite, 0xb722bcc7, 0x4e68, 0x101b, 0xa2, 0xbc, 0x00,
            0xaa, 0x00, 0x40, 0x47, 0x70);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("b722bcc7-4e68-101b-a2bc-00aa00404770")
IOleDocumentSite : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE ActivateMe(IOleDocumentView *
                                               pViewToActivate) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IOleDocumentSite, 0xb722bcc7, 0x4e68, 0x101b, 0xa2, 0xbc, 0x00,
                0xaa, 0x00, 0x40, 0x47, 0x70)
#endif
#else
typedef struct IOleDocumentSiteVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IOleDocumentSite *This,
  ...
  HRESULT(STDMETHODCALLTYPE *ActivateMe)(IOleDocumentSite *This,
                                         IOleDocumentView *pViewToActivate);
  END_INTERFACE
} IOleDocumentSiteVtbl;
interface IOleDocumentSite { CONST_VTBL IOleDocumentSiteVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IOleDocumentSite_QueryInterface(IOleDocumentSite *This,
                                                      REFIID riid,
                                                      void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IOleDocumentSite methods ***/
static inline HRESULT
IOleDocumentSite_ActivateMe(IOleDocumentSite *This,
                            IOleDocumentView *pViewToActivate) {
...
DEFINE_GUID(IID_IOleDocumentView, 0xb722bcc6, 0x4e68, 0x101b, 0xa2, 0xbc, 0x00,
            0xaa, 0x00, 0x40, 0x47, 0x70);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("b722bcc6-4e68-101b-a2bc-00aa00404770")
IOleDocumentView : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE SetInPlaceSite(IOleInPlaceSite *
                                                   pIPSite) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetInPlaceSite(IOleInPlaceSite *
                                                   *ppIPSite) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE SetRectComplex(
      LPRECT prcView, LPRECT prcHScroll, LPRECT prcVScroll,
      LPRECT prcSizeBox) = 0;
  virtual HRESULT STDMETHODCALLTYPE Show(WINBOOL fShow) = 0;
  virtual HRESULT STDMETHODCALLTYPE UIActivate(WINBOOL fUIActivate) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE Clone(IOleInPlaceSite * pIPSiteNew,
                                          IOleDocumentView * *ppViewNew) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IOleDocumentView, 0xb722bcc6, 0x4e68, 0x101b, 0xa2, 0xbc, 0x00,
                0xaa, 0x00, 0x40, 0x47, 0x70)
#endif
#else
typedef struct IOleDocumentViewVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IOleDocumentView *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *SetInPlaceSite)(IOleDocumentView *This,
                                             IOleInPlaceSite *pIPSite);
  HRESULT(STDMETHODCALLTYPE *GetInPlaceSite)(IOleDocumentView *This,
                                             IOleInPlaceSite **ppIPSite);
  HRESULT(STDMETHODCALLTYPE *GetDocument)(IOleDocumentView *This,
                                          IUnknown **ppunk);
  ...
  HRESULT(STDMETHODCALLTYPE *SetRectComplex)(IOleDocumentView *This,
                                             LPRECT prcView, LPRECT prcHScroll,
                                             LPRECT prcVScroll,
                                             LPRECT prcSizeBox);
  HRESULT(STDMETHODCALLTYPE *Show)(IOleDocumentView *This, WINBOOL fShow);
  HRESULT(STDMETHODCALLTYPE *UIActivate)(IOleDocumentView *This,
                                         WINBOOL fUIActivate);
  HRESULT(STDMETHODCALLTYPE *Open)(IOleDocumentView *This);
  HRESULT(STDMETHODCALLTYPE *CloseView)(IOleDocumentView *This,
                                        DWORD dwReserved);
  HRESULT(STDMETHODCALLTYPE *SaveViewState)(IOleDocumentView *This,
                                            LPSTREAM pstm);
  HRESULT(STDMETHODCALLTYPE *ApplyViewState)(IOleDocumentView *This,
                                             LPSTREAM pstm);
  HRESULT(STDMETHODCALLTYPE *Clone)(IOleDocumentView *This,
                                    IOleInPlaceSite *pIPSiteNew,
                                    IOleDocumentView **ppViewNew);
  END_INTERFACE
} IOleDocumentViewVtbl;
interface IOleDocumentView { CONST_VTBL IOleDocumentViewVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define IOleDocumentView_SetRectComplex(This, prcView, prcHScroll, prcVScroll, \
                                        prcSizeBox)                            \
  (This)->lpVtbl->SetRectComplex(This, prcView, prcHScroll, prcVScroll,        \
                                 prcSizeBox)
...
#else
/*** IUnknown methods ***/
static inline HRESULT IOleDocumentView_QueryInterface(IOleDocumentView *This,
                                                      REFIID riid,
                                                      void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IOleDocumentView methods ***/
static inline HRESULT
IOleDocumentView_SetInPlaceSite(IOleDocumentView *This,
                                IOleInPlaceSite *pIPSite) {
  return This->lpVtbl->SetInPlaceSite(This, pIPSite);
}
static inline HRESULT
IOleDocumentView_GetInPlaceSite(IOleDocumentView *This,
                                IOleInPlaceSite **ppIPSite) {
  return This->lpVtbl->GetInPlaceSite(This, ppIPSite);
}
static inline HRESULT IOleDocumentView_GetDocument(IOleDocumentView *This,
                                                   IUnknown **ppunk) {
  return This->lpVtbl->GetDocument(This, ppunk);
}
static inline HRESULT IOleDocumentView_SetRect(IOleDocumentView *This,
                                               LPRECT prcView) {
  return This->lpVtbl->SetRect(This, prcView);
}
static inline HRESULT IOleDocumentView_GetRect(IOleDocumentView *This,
                                               LPRECT prcView) {
  return This->lpVtbl->GetRect(This, prcView);
}
static inline HRESULT IOleDocumentView_SetRectComplex(IOleDocumentView *This,
                                                      LPRECT prcView,
                                                      LPRECT prcHScroll,
                                                      LPRECT prcVScroll,
                                                      LPRECT prcSizeBox) {
  return This->lpVtbl->SetRectComplex(This, prcView, prcHScroll, prcVScroll,
                                      prcSizeBox);
}
static inline HRESULT IOleDocumentView_Show(IOleDocumentView *This,
                                            WINBOOL fShow) {
  return This->lpVtbl->Show(This, fShow);
}
static inline HRESULT IOleDocumentView_UIActivate(IOleDocumentView *This,
                                                  WINBOOL fUIActivate) {
...
static inline HRESULT IOleDocumentView_CloseView(IOleDocumentView *This,
                                                 DWORD dwReserved) {
  return This->lpVtbl->CloseView(This, dwReserved);
}
static inline HRESULT IOleDocumentView_SaveViewState(IOleDocumentView *This,
                                                     LPSTREAM pstm) {
  return This->lpVtbl->SaveViewState(This, pstm);
}
static inline HRESULT IOleDocumentView_ApplyViewState(IOleDocumentView *This,
                                                      LPSTREAM pstm) {
  return This->lpVtbl->ApplyViewState(This, pstm);
}
static inline HRESULT IOleDocumentView_Clone(IOleDocumentView *This,
                                             IOleInPlaceSite *pIPSiteNew,
                                             IOleDocumentView **ppViewNew) {
...
DEFINE_GUID(IID_IEnumOleDocumentViews, 0xb722bcc8, 0x4e68, 0x101b, 0xa2, 0xbc,
            0x00, 0xaa, 0x00, 0x40, 0x47, 0x70);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("b722bcc8-4e68-101b-a2bc-00aa00404770")
IEnumOleDocumentViews : public IUnknown {
  virtual HRESULT __stdcall Next(ULONG cViews, IOleDocumentView * *rgpView,
                                 ULONG * pcFetched) = 0;
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IEnumOleDocumentViews, 0xb722bcc8, 0x4e68, 0x101b, 0xa2, 0xbc,
                0x00, 0xaa, 0x00, 0x40, 0x47, 0x70)
#endif
#else
typedef struct IEnumOleDocumentViewsVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IEnumOleDocumentViews *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(__stdcall *Next)(IEnumOleDocumentViews *This, ULONG cViews,
  ...
  HRESULT(STDMETHODCALLTYPE *Clone)(IEnumOleDocumentViews *This,
                                    IEnumOleDocumentViews **ppEnum);
  END_INTERFACE
...
/*** IUnknown methods ***/
static inline HRESULT
IEnumOleDocumentViews_QueryInterface(IEnumOleDocumentViews *This, REFIID riid,
                                     void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IEnumOleDocumentViews methods ***/
static inline HRESULT IEnumOleDocumentViews_Next(IEnumOleDocumentViews *This,
                                                 ULONG cViews,
                                                 IOleDocumentView **rgpView,
                                                 ULONG *pcFetched) {
  return This->lpVtbl->Next(This, cViews, rgpView, pcFetched);
}
static inline HRESULT IEnumOleDocumentViews_Skip(IEnumOleDocumentViews *This,
                                                 ULONG cViews) {
...
static inline HRESULT
IEnumOleDocumentViews_Clone(IEnumOleDocumentViews *This,
                            IEnumOleDocumentViews **ppEnum) {
...
#endif
HRESULT __stdcall
IEnumOleDocumentViews_RemoteNext_Proxy(IEnumOleDocumentViews *This,
                                       ULONG cViews, IOleDocumentView **rgpView,
                                       ULONG *pcFetched);
...
DEFINE_GUID(IID_IContinueCallback, 0xb722bcca, 0x4e68, 0x101b, 0xa2, 0xbc, 0x00,
            0xaa, 0x00, 0x40, 0x47, 0x70);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IContinueCallback : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE FContinuePrinting(
      LONG nCntPrinted, LONG nCurPage, wchar_t * pwszPrintStatus) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IContinueCallback, 0xb722bcca, 0x4e68, 0x101b, 0xa2, 0xbc, 0x00,
                0xaa, 0x00, 0x40, 0x47, 0x70)
#endif
#else
typedef struct IContinueCallbackVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IContinueCallback *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *FContinuePrinting)(IContinueCallback *This,
                                                LONG nCntPrinted, LONG nCurPage,
                                                wchar_t *pwszPrintStatus);
  END_INTERFACE
} IContinueCallbackVtbl;
interface IContinueCallback { CONST_VTBL IContinueCallbackVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define IContinueCallback_FContinuePrinting(This, nCntPrinted, nCurPage,       \
                                            pwszPrintStatus)                   \
  (This)->lpVtbl->FContinuePrinting(This, nCntPrinted, nCurPage,               \
                                    pwszPrintStatus)
#else
/*** IUnknown methods ***/
static inline HRESULT IContinueCallback_QueryInterface(IContinueCallback *This,
                                                       REFIID riid,
                                                       void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
static inline HRESULT
IContinueCallback_FContinuePrinting(IContinueCallback *This, LONG nCntPrinted,
                                    LONG nCurPage, wchar_t *pwszPrintStatus) {
  return This->lpVtbl->FContinuePrinting(This, nCntPrinted, nCurPage,
                                         pwszPrintStatus);
}
#endif
#endif
...
DEFINE_GUID(IID_IPrint, 0xb722bcc9, 0x4e68, 0x101b, 0xa2, 0xbc, 0x00, 0xaa,
            0x00, 0x40, 0x47, 0x70);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IPrint : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE GetPageInfo(LONG * pnFirstPage,
                                                LONG * pcPages) = 0;
  virtual HRESULT __stdcall Print(
      ...
      LONG * pcPagesPrinted, LONG * pnLastPage) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IPrint, 0xb722bcc9, 0x4e68, 0x101b, 0xa2, 0xbc, 0x00, 0xaa,
                0x00, 0x40, 0x47, 0x70)
#endif
#else
typedef struct IPrintVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPrint *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetPageInfo)(IPrint *This, LONG *pnFirstPage,
                                          LONG *pcPages);
  HRESULT(__stdcall *Print)(IPrint *This, DWORD grfFlags, DVTARGETDEVICE **pptd,
                            PAGESET **ppPageSet, STGMEDIUM *pstgmOptions,
                            IContinueCallback *pcallback, LONG nFirstPage,
                            LONG *pcPagesPrinted, LONG *pnLastPage);
  END_INTERFACE
} IPrintVtbl;
interface IPrint { CONST_VTBL IPrintVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define IPrint_Print(This, grfFlags, pptd, ppPageSet, pstgmOptions, pcallback, \
                     nFirstPage, pcPagesPrinted, pnLastPage)                   \
  (This)->lpVtbl->Print(This, grfFlags, pptd, ppPageSet, pstgmOptions,         \
                        pcallback, nFirstPage, pcPagesPrinted, pnLastPage)
#else
/*** IUnknown methods ***/
static inline HRESULT IPrint_QueryInterface(IPrint *This, REFIID riid,
                                            void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
static inline HRESULT IPrint_GetPageInfo(IPrint *This, LONG *pnFirstPage,
                                         LONG *pcPages) {
  return This->lpVtbl->GetPageInfo(This, pnFirstPage, pcPages);
}
static inline HRESULT IPrint_Print(IPrint *This, DWORD grfFlags,
                                   DVTARGETDEVICE **pptd, PAGESET **ppPageSet,
                                   STGMEDIUM *pstgmOptions,
                                   IContinueCallback *pcallback,
                                   LONG nFirstPage, LONG *pcPagesPrinted,
                                   LONG *pnLastPage) {
  return This->lpVtbl->Print(This, grfFlags, pptd, ppPageSet, pstgmOptions,
                             pcallback, nFirstPage, pcPagesPrinted, pnLastPage);
}
#endif
#endif
#endif
HRESULT __stdcall
IPrint_RemotePrint_Proxy(IPrint *This, DWORD grfFlags, DVTARGETDEVICE **pptd,
                         PAGESET **pppageset, RemSTGMEDIUM *pstgmOptions,
                         IContinueCallback *pcallback, LONG nFirstPage,
                         LONG *pcPagesPrinted, LONG *pnLastPage);
void __RPC_STUB IPrint_RemotePrint_Stub(IRpcStubBuffer *This,
                                        IRpcChannelBuffer *pRpcChannelBuffer,
                                        PRPC_MESSAGE pRpcMessage,
                                        DWORD *pdwStubPhase);
HRESULT CALLBACK IPrint_Print_Proxy(IPrint *This, DWORD grfFlags,
                                    DVTARGETDEVICE **pptd, PAGESET **ppPageSet,
                                    STGMEDIUM *pstgmOptions,
                                    IContinueCallback *pcallback,
                                    LONG nFirstPage, LONG *pcPagesPrinted,
                                    LONG *pnLastPage);
HRESULT __RPC_STUB IPrint_Print_Stub(IPrint *This, DWORD grfFlags,
                                     DVTARGETDEVICE **pptd, PAGESET **pppageset,
...
#endif
DEFINE_GUID(IID_IOleCommandTarget, 0xb722bccb, 0x4e68, 0x101b, 0xa2, 0xbc, 0x00,
            0xaa, 0x00, 0x40, 0x47, 0x70);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IOleCommandTarget : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE Exec(const GUID *pguidCmdGroup,
                                         ...
                                         VARIANT *pvaIn, VARIANT *pvaOut) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IOleCommandTarget, 0xb722bccb, 0x4e68, 0x101b, 0xa2, 0xbc, 0x00,
                0xaa, 0x00, 0x40, 0x47, 0x70)
#endif
#else
typedef struct IOleCommandTargetVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IOleCommandTarget *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IOleCommandTarget *This);
  ULONG(STDMETHODCALLTYPE *Release)(IOleCommandTarget *This);
  /*** IOleCommandTarget methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryStatus)(IOleCommandTarget *This,
                                          const GUID *pguidCmdGroup,
                                          ULONG cCmds, OLECMD prgCmds[],
                                          OLECMDTEXT *pCmdText);
  HRESULT(STDMETHODCALLTYPE *Exec)(IOleCommandTarget *This,
                                   const GUID *pguidCmdGroup, DWORD nCmdID,
                                   DWORD nCmdexecopt, VARIANT *pvaIn,
                                   VARIANT *pvaOut);
  END_INTERFACE
} IOleCommandTargetVtbl;
interface IOleCommandTarget { CONST_VTBL IOleCommandTargetVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IOleCommandTarget methods ***/
#define IOleCommandTarget_QueryStatus(This, pguidCmdGroup, cCmds, prgCmds,     \
                                      pCmdText)                                \
...
#else
/*** IUnknown methods ***/
static inline HRESULT IOleCommandTarget_QueryInterface(IOleCommandTarget *This,
                                                       REFIID riid,
                                                       void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IOleCommandTarget methods ***/
static inline HRESULT IOleCommandTarget_QueryStatus(IOleCommandTarget *This,
                                                    const GUID *pguidCmdGroup,
                                                    ULONG cCmds,
                                                    OLECMD prgCmds[],
                                                    OLECMDTEXT *pCmdText) {
  return This->lpVtbl->QueryStatus(This, pguidCmdGroup, cCmds, prgCmds,
                                   pCmdText);
}
static inline HRESULT IOleCommandTarget_Exec(IOleCommandTarget *This,
                                             const GUID *pguidCmdGroup,
                                             DWORD nCmdID, DWORD nCmdexecopt,
                                             VARIANT *pvaIn, VARIANT *pvaOut) {
  return This->lpVtbl->Exec(This, pguidCmdGroup, nCmdID, nCmdexecopt, pvaIn,
                            pvaOut);
}
#endif
#endif
...
DEFINE_GUID(IID_IZoomEvents, 0x41b68150, 0x904c, 0x4e17, 0xa0, 0xba, 0xa4, 0x38,
            0x18, 0x2e, 0x35, 0x9d);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IZoomEvents, 0x41b68150, 0x904c, 0x4e17, 0xa0, 0xba, 0xa4, 0x38,
                0x18, 0x2e, 0x35, 0x9d)
#endif
#else
typedef struct IZoomEventsVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IZoomEvents *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IZoomEvents *This);
  ULONG(STDMETHODCALLTYPE *Release)(IZoomEvents *This);
  /*** IZoomEvents methods ***/
  HRESULT(STDMETHODCALLTYPE *OnZoomPercentChanged)(IZoomEvents *This,
                                                   ULONG ulZoomPercent);
  END_INTERFACE
} IZoomEventsVtbl;
interface IZoomEvents { CONST_VTBL IZoomEventsVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IZoomEvents_QueryInterface(IZoomEvents *This, REFIID riid,
                                                 void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IZoomEvents methods ***/
static inline HRESULT IZoomEvents_OnZoomPercentChanged(IZoomEvents *This,
                                                       ULONG ulZoomPercent) {
...
DEFINE_GUID(IID_IProtectFocus, 0xd81f90a3, 0x8156, 0x44f7, 0xad, 0x28, 0x5a,
            0xbb, 0x87, 0x00, 0x32, 0x74);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("d81f90a3-8156-44f7-ad28-5abb87003274")
IProtectFocus : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE AllowFocusChange(WINBOOL * pfAllow) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IProtectFocus, 0xd81f90a3, 0x8156, 0x44f7, 0xad, 0x28, 0x5a,
                0xbb, 0x87, 0x00, 0x32, 0x74)
#endif
#else
typedef struct IProtectFocusVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IProtectFocus *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IProtectFocus *This);
  ULONG(STDMETHODCALLTYPE *Release)(IProtectFocus *This);
  /*** IProtectFocus methods ***/
  HRESULT(STDMETHODCALLTYPE *AllowFocusChange)(IProtectFocus *This,
                                               WINBOOL *pfAllow);
  END_INTERFACE
} IProtectFocusVtbl;
interface IProtectFocus { CONST_VTBL IProtectFocusVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IProtectFocus_QueryInterface(IProtectFocus *This,
                                                   REFIID riid,
                                                   void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IProtectFocus methods ***/
static inline HRESULT IProtectFocus_AllowFocusChange(IProtectFocus *This,
                                                     WINBOOL *pfAllow) {
...
DEFINE_GUID(IID_IProtectedModeMenuServices, 0x73c105ee, 0x9dff, 0x4a07, 0xb8,
            0x3c, 0x7e, 0xff, 0x29, 0x0c, 0x26, 0x6e);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("73c105ee-9dff-4a07-b83c-7eff290c266e")
IProtectedModeMenuServices : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE CreateMenu(HMENU * phMenu) = 0;
  virtual HRESULT STDMETHODCALLTYPE LoadMenu(
      LPCWSTR pszModuleName, LPCWSTR pszMenuName, HMENU * phMenu) = 0;
  virtual HRESULT STDMETHODCALLTYPE LoadMenuID(
      LPCWSTR pszModuleName, WORD wResourceID, HMENU * phMenu) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IProtectedModeMenuServices, 0x73c105ee, 0x9dff, 0x4a07, 0xb8,
                0x3c, 0x7e, 0xff, 0x29, 0x0c, 0x26, 0x6e)
#endif
#else
typedef struct IProtectedModeMenuServicesVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IProtectedModeMenuServices *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *CreateMenu)(IProtectedModeMenuServices *This,
                                         HMENU *phMenu);
  HRESULT(STDMETHODCALLTYPE *LoadMenu)(IProtectedModeMenuServices *This,
                                       LPCWSTR pszModuleName,
                                       LPCWSTR pszMenuName, HMENU *phMenu);
  HRESULT(STDMETHODCALLTYPE *LoadMenuID)(IProtectedModeMenuServices *This,
                                         LPCWSTR pszModuleName,
                                         WORD wResourceID, HMENU *phMenu);
  END_INTERFACE
...
#define IProtectedModeMenuServices_LoadMenu(This, pszModuleName, pszMenuName,  \
                                            phMenu)                            \
  (This)->lpVtbl->LoadMenu(This, pszModuleName, pszMenuName, phMenu)
#define IProtectedModeMenuServices_LoadMenuID(This, pszModuleName,             \
                                              wResourceID, phMenu)             \
  (This)->lpVtbl->LoadMenuID(This, pszModuleName, wResourceID, phMenu)
#else
/*** IUnknown methods ***/
static inline HRESULT
IProtectedModeMenuServices_QueryInterface(IProtectedModeMenuServices *This,
                                          REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IProtectedModeMenuServices_AddRef(IProtectedModeMenuServices *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IProtectedModeMenuServices_Release(IProtectedModeMenuServices *This) {
  return This->lpVtbl->Release(This);
}
/*** IProtectedModeMenuServices methods ***/
static inline HRESULT
IProtectedModeMenuServices_CreateMenu(IProtectedModeMenuServices *This,
                                      HMENU *phMenu) {
  return This->lpVtbl->CreateMenu(This, phMenu);
}
static inline HRESULT
IProtectedModeMenuServices_LoadMenu(IProtectedModeMenuServices *This,
                                    LPCWSTR pszModuleName, LPCWSTR pszMenuName,
                                    HMENU *phMenu) {
  return This->lpVtbl->LoadMenu(This, pszModuleName, pszMenuName, phMenu);
}
static inline HRESULT
IProtectedModeMenuServices_LoadMenuID(IProtectedModeMenuServices *This,
                                      LPCWSTR pszModuleName, WORD wResourceID,
                                      HMENU *phMenu) {
