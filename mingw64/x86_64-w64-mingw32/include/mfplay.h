...
STDAPI MFPCreateMediaPlayer(LPCWSTR pwszURL, BOOL fStartPlayback,
                            MFP_CREATION_OPTIONS creationOptions,
                            IMFPMediaPlayerCallback *pCallback, HWND hWnd,
...
DEFINE_GUID(IID_IMFPMediaPlayer, 0xa714590a, 0x58af, 0x430a, 0x85, 0xbf, 0x44,
            0xf5, 0xec, 0x83, 0x8d, 0x85);
...
IMFPMediaPlayer : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE FrameStep() = 0;
  virtual HRESULT STDMETHODCALLTYPE SetPosition(
      REFGUID guidPositionType, const PROPVARIANT *pvPositionValue) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetPosition(
      REFGUID guidPositionType, PROPVARIANT * pvPositionValue) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetDuration(
      REFGUID guidPositionType, PROPVARIANT * pvDurationValue) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetSupportedRates(
      WINBOOL fForwardDirection, float *pflSlowestRate,
      float *pflFastestRate) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetState(MFP_MEDIAPLAYER_STATE *
                                             peState) = 0;
  virtual HRESULT STDMETHODCALLTYPE CreateMediaItemFromURL(
      LPCWSTR pwszURL, WINBOOL fSync, DWORD_PTR dwUserData,
      IMFPMediaItem * *ppMediaItem) = 0;
  virtual HRESULT STDMETHODCALLTYPE CreateMediaItemFromObject(
      IUnknown * pIUnknownObj, WINBOOL fSync, DWORD_PTR dwUserData,
      IMFPMediaItem * *ppMediaItem) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetMediaItem(IMFPMediaItem *
                                                 pIMFPMediaItem) = 0;
  virtual HRESULT STDMETHODCALLTYPE ClearMediaItem() = 0;
  virtual HRESULT STDMETHODCALLTYPE GetMediaItem(IMFPMediaItem *
                                                 *ppIMFPMediaItem) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetMute(WINBOOL * pfMute) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetMute(WINBOOL fMute) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetVideoSourceRect(MFVideoNormalizedRect *
                                                       pnrcSource) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE UpdateVideo() = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE InsertEffect(IUnknown * pEffect,
                                                 WINBOOL fOptional) = 0;
...
__CRT_UUID_DECL(IMFPMediaPlayer, 0xa714590a, 0x58af, 0x430a, 0x85, 0xbf, 0x44,
                0xf5, 0xec, 0x83, 0x8d, 0x85)
#endif
#else
typedef struct IMFPMediaPlayerVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IMFPMediaPlayer *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *SetPosition)(IMFPMediaPlayer *This,
                                          REFGUID guidPositionType,
                                          const PROPVARIANT *pvPositionValue);
  HRESULT(STDMETHODCALLTYPE *GetPosition)(IMFPMediaPlayer *This,
                                          REFGUID guidPositionType,
                                          PROPVARIANT *pvPositionValue);
  HRESULT(STDMETHODCALLTYPE *GetDuration)(IMFPMediaPlayer *This,
                                          REFGUID guidPositionType,
  ...
  HRESULT(STDMETHODCALLTYPE *GetSupportedRates)(IMFPMediaPlayer *This,
                                                WINBOOL fForwardDirection,
                                                float *pflSlowestRate,
                                                float *pflFastestRate);
  HRESULT(STDMETHODCALLTYPE *GetState)(IMFPMediaPlayer *This,
                                       MFP_MEDIAPLAYER_STATE *peState);
  HRESULT(STDMETHODCALLTYPE *CreateMediaItemFromURL)(
      IMFPMediaPlayer *This, LPCWSTR pwszURL, WINBOOL fSync,
      DWORD_PTR dwUserData, IMFPMediaItem **ppMediaItem);
  HRESULT(STDMETHODCALLTYPE *CreateMediaItemFromObject)(
      IMFPMediaPlayer *This, IUnknown *pIUnknownObj, WINBOOL fSync,
      DWORD_PTR dwUserData, IMFPMediaItem **ppMediaItem);
  HRESULT(STDMETHODCALLTYPE *SetMediaItem)(IMFPMediaPlayer *This,
                                           IMFPMediaItem *pIMFPMediaItem);
  HRESULT(STDMETHODCALLTYPE *ClearMediaItem)(IMFPMediaPlayer *This);
  HRESULT(STDMETHODCALLTYPE *GetMediaItem)(IMFPMediaPlayer *This,
                                           IMFPMediaItem **ppIMFPMediaItem);
  HRESULT(STDMETHODCALLTYPE *GetVolume)(IMFPMediaPlayer *This,
                                        float *pflVolume);
  HRESULT(STDMETHODCALLTYPE *SetVolume)(IMFPMediaPlayer *This, float flVolume);
  HRESULT(STDMETHODCALLTYPE *GetBalance)(IMFPMediaPlayer *This,
                                         float *pflBalance);
  HRESULT(STDMETHODCALLTYPE *SetBalance)(IMFPMediaPlayer *This,
                                         float flBalance);
  HRESULT(STDMETHODCALLTYPE *GetMute)(IMFPMediaPlayer *This, WINBOOL *pfMute);
  HRESULT(STDMETHODCALLTYPE *SetMute)(IMFPMediaPlayer *This, WINBOOL fMute);
  HRESULT(STDMETHODCALLTYPE *GetNativeVideoSize)(IMFPMediaPlayer *This,
                                                 SIZE *pszVideo,
                                                 SIZE *pszARVideo);
  HRESULT(STDMETHODCALLTYPE *GetIdealVideoSize)(IMFPMediaPlayer *This,
                                                SIZE *pszMin, SIZE *pszMax);
  HRESULT(STDMETHODCALLTYPE *SetVideoSourceRect)(
      IMFPMediaPlayer *This, const MFVideoNormalizedRect *pnrcSource);
  HRESULT(STDMETHODCALLTYPE *GetVideoSourceRect)(
      IMFPMediaPlayer *This, MFVideoNormalizedRect *pnrcSource);
  HRESULT(STDMETHODCALLTYPE *SetAspectRatioMode)(IMFPMediaPlayer *This,
                                                 DWORD dwAspectRatioMode);
  HRESULT(STDMETHODCALLTYPE *GetAspectRatioMode)(IMFPMediaPlayer *This,
                                                 DWORD *pdwAspectRatioMode);
  HRESULT(STDMETHODCALLTYPE *GetVideoWindow)(IMFPMediaPlayer *This,
                                             HWND *phwndVideo);
  HRESULT(STDMETHODCALLTYPE *UpdateVideo)(IMFPMediaPlayer *This);
  HRESULT(STDMETHODCALLTYPE *SetBorderColor)(IMFPMediaPlayer *This,
                                             COLORREF Clr);
  HRESULT(STDMETHODCALLTYPE *GetBorderColor)(IMFPMediaPlayer *This,
                                             COLORREF *pClr);
  HRESULT(STDMETHODCALLTYPE *InsertEffect)(IMFPMediaPlayer *This,
                                           IUnknown *pEffect,
                                           WINBOOL fOptional);
  HRESULT(STDMETHODCALLTYPE *RemoveEffect)(IMFPMediaPlayer *This,
                                           IUnknown *pEffect);
  HRESULT(STDMETHODCALLTYPE *RemoveAllEffects)(IMFPMediaPlayer *This);
  HRESULT(STDMETHODCALLTYPE *Shutdown)(IMFPMediaPlayer *This);
  END_INTERFACE
} IMFPMediaPlayerVtbl;
interface IMFPMediaPlayer { CONST_VTBL IMFPMediaPlayerVtbl *lpVtbl; };
#ifdef COBJMACROS
...
#define IMFPMediaPlayer_GetSupportedRates(This, fForwardDirection,             \
                                          pflSlowestRate, pflFastestRate)      \
  (This)->lpVtbl->GetSupportedRates(This, fForwardDirection, pflSlowestRate,   \
                                    pflFastestRate)
#define IMFPMediaPlayer_GetState(This, peState)                                \
  (This)->lpVtbl->GetState(This, peState)
#define IMFPMediaPlayer_CreateMediaItemFromURL(This, pwszURL, fSync,           \
                                               dwUserData, ppMediaItem)        \
  (This)->lpVtbl->CreateMediaItemFromURL(This, pwszURL, fSync, dwUserData,     \
                                         ppMediaItem)
#define IMFPMediaPlayer_CreateMediaItemFromObject(This, pIUnknownObj, fSync,   \
                                                  dwUserData, ppMediaItem)     \
  (This)->lpVtbl->CreateMediaItemFromObject(This, pIUnknownObj, fSync,         \
                                            dwUserData, ppMediaItem)
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMFPMediaPlayer_QueryInterface(IMFPMediaPlayer *This,
                                                     REFIID riid,
                                                     void **ppvObject) {
...
IMFPMediaPlayer_SetPosition(IMFPMediaPlayer *This, REFGUID guidPositionType,
                            const PROPVARIANT *pvPositionValue) {
  return This->lpVtbl->SetPosition(This, guidPositionType, pvPositionValue);
}
static inline HRESULT
IMFPMediaPlayer_GetPosition(IMFPMediaPlayer *This, REFGUID guidPositionType,
                            PROPVARIANT *pvPositionValue) {
  return This->lpVtbl->GetPosition(This, guidPositionType, pvPositionValue);
}
static inline HRESULT
IMFPMediaPlayer_GetDuration(IMFPMediaPlayer *This, REFGUID guidPositionType,
                            PROPVARIANT *pvDurationValue) {
  return This->lpVtbl->GetDuration(This, guidPositionType, pvDurationValue);
}
static inline HRESULT IMFPMediaPlayer_SetRate(IMFPMediaPlayer *This,
                                              float flRate) {
  return This->lpVtbl->SetRate(This, flRate);
}
static inline HRESULT IMFPMediaPlayer_GetRate(IMFPMediaPlayer *This,
                                              float *pflRate) {
  return This->lpVtbl->GetRate(This, pflRate);
}
static inline HRESULT IMFPMediaPlayer_GetSupportedRates(
    IMFPMediaPlayer *This, WINBOOL fForwardDirection, float *pflSlowestRate,
    float *pflFastestRate) {
  return This->lpVtbl->GetSupportedRates(This, fForwardDirection,
                                         pflSlowestRate, pflFastestRate);
}
static inline HRESULT IMFPMediaPlayer_GetState(IMFPMediaPlayer *This,
                                               MFP_MEDIAPLAYER_STATE *peState) {
  return This->lpVtbl->GetState(This, peState);
}
static inline HRESULT
IMFPMediaPlayer_CreateMediaItemFromURL(IMFPMediaPlayer *This, LPCWSTR pwszURL,
                                       WINBOOL fSync, DWORD_PTR dwUserData,
                                       IMFPMediaItem **ppMediaItem) {
  return This->lpVtbl->CreateMediaItemFromURL(This, pwszURL, fSync, dwUserData,
                                              ppMediaItem);
}
static inline HRESULT IMFPMediaPlayer_CreateMediaItemFromObject(
    IMFPMediaPlayer *This, IUnknown *pIUnknownObj, WINBOOL fSync,
    DWORD_PTR dwUserData, IMFPMediaItem **ppMediaItem) {
  return This->lpVtbl->CreateMediaItemFromObject(This, pIUnknownObj, fSync,
                                                 dwUserData, ppMediaItem);
}
static inline HRESULT
IMFPMediaPlayer_SetMediaItem(IMFPMediaPlayer *This,
                             IMFPMediaItem *pIMFPMediaItem) {
...
static inline HRESULT
IMFPMediaPlayer_GetMediaItem(IMFPMediaPlayer *This,
                             IMFPMediaItem **ppIMFPMediaItem) {
  return This->lpVtbl->GetMediaItem(This, ppIMFPMediaItem);
}
static inline HRESULT IMFPMediaPlayer_GetVolume(IMFPMediaPlayer *This,
                                                float *pflVolume) {
  return This->lpVtbl->GetVolume(This, pflVolume);
}
static inline HRESULT IMFPMediaPlayer_SetVolume(IMFPMediaPlayer *This,
                                                float flVolume) {
  return This->lpVtbl->SetVolume(This, flVolume);
}
static inline HRESULT IMFPMediaPlayer_GetBalance(IMFPMediaPlayer *This,
                                                 float *pflBalance) {
  return This->lpVtbl->GetBalance(This, pflBalance);
}
static inline HRESULT IMFPMediaPlayer_SetBalance(IMFPMediaPlayer *This,
                                                 float flBalance) {
  return This->lpVtbl->SetBalance(This, flBalance);
}
static inline HRESULT IMFPMediaPlayer_GetMute(IMFPMediaPlayer *This,
                                              WINBOOL *pfMute) {
  return This->lpVtbl->GetMute(This, pfMute);
}
static inline HRESULT IMFPMediaPlayer_SetMute(IMFPMediaPlayer *This,
                                              WINBOOL fMute) {
  return This->lpVtbl->SetMute(This, fMute);
}
static inline HRESULT IMFPMediaPlayer_GetNativeVideoSize(IMFPMediaPlayer *This,
                                                         SIZE *pszVideo,
                                                         SIZE *pszARVideo) {
  return This->lpVtbl->GetNativeVideoSize(This, pszVideo, pszARVideo);
}
static inline HRESULT IMFPMediaPlayer_GetIdealVideoSize(IMFPMediaPlayer *This,
                                                        SIZE *pszMin,
                                                        SIZE *pszMax) {
  return This->lpVtbl->GetIdealVideoSize(This, pszMin, pszMax);
}
static inline HRESULT
IMFPMediaPlayer_SetVideoSourceRect(IMFPMediaPlayer *This,
                                   const MFVideoNormalizedRect *pnrcSource) {
  return This->lpVtbl->SetVideoSourceRect(This, pnrcSource);
}
static inline HRESULT
IMFPMediaPlayer_GetVideoSourceRect(IMFPMediaPlayer *This,
                                   MFVideoNormalizedRect *pnrcSource) {
  return This->lpVtbl->GetVideoSourceRect(This, pnrcSource);
}
static inline HRESULT
IMFPMediaPlayer_SetAspectRatioMode(IMFPMediaPlayer *This,
                                   DWORD dwAspectRatioMode) {
  return This->lpVtbl->SetAspectRatioMode(This, dwAspectRatioMode);
}
static inline HRESULT
IMFPMediaPlayer_GetAspectRatioMode(IMFPMediaPlayer *This,
                                   DWORD *pdwAspectRatioMode) {
  return This->lpVtbl->GetAspectRatioMode(This, pdwAspectRatioMode);
}
static inline HRESULT IMFPMediaPlayer_GetVideoWindow(IMFPMediaPlayer *This,
                                                     HWND *phwndVideo) {
...
static inline HRESULT IMFPMediaPlayer_SetBorderColor(IMFPMediaPlayer *This,
                                                     COLORREF Clr) {
  return This->lpVtbl->SetBorderColor(This, Clr);
}
static inline HRESULT IMFPMediaPlayer_GetBorderColor(IMFPMediaPlayer *This,
                                                     COLORREF *pClr) {
  return This->lpVtbl->GetBorderColor(This, pClr);
}
static inline HRESULT IMFPMediaPlayer_InsertEffect(IMFPMediaPlayer *This,
                                                   IUnknown *pEffect,
                                                   WINBOOL fOptional) {
  return This->lpVtbl->InsertEffect(This, pEffect, fOptional);
}
static inline HRESULT IMFPMediaPlayer_RemoveEffect(IMFPMediaPlayer *This,
                                                   IUnknown *pEffect) {
...
EXTERN_GUID(MFP_POSITIONTYPE_100NS, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
            0x0, 0x0);
/*****************************************************************************
...
DEFINE_GUID(IID_IMFPMediaItem, 0x90eb3e6b, 0xecbf, 0x45cc, 0xb1, 0xda, 0xc6,
            0xfe, 0x3e, 0xa7, 0x0d, 0x57);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("90eb3e6b-ecbf-45cc-b1da-c6fe3ea70d57")
IMFPMediaItem : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetMediaPlayer(IMFPMediaPlayer *
                                                   *ppMediaPlayer) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetStartStopPosition(
      GUID * pguidStartPositionType, PROPVARIANT * pvStartValue,
      GUID * pguidStopPositionType, PROPVARIANT * pvStopValue) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetStartStopPosition(
      const GUID *pguidStartPositionType, const PROPVARIANT *pvStartValue,
      const GUID *pguidStopPositionType, const PROPVARIANT *pvStopValue) = 0;
  virtual HRESULT STDMETHODCALLTYPE HasVideo(WINBOOL * pfHasVideo,
                                             WINBOOL * pfSelected) = 0;
  virtual HRESULT STDMETHODCALLTYPE HasAudio(WINBOOL * pfHasAudio,
                                             WINBOOL * pfSelected) = 0;
  virtual HRESULT STDMETHODCALLTYPE IsProtected(WINBOOL * pfProtected) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetDuration(
      REFGUID guidPositionType, PROPVARIANT * pvDurationValue) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetNumberOfStreams(DWORD *
                                                       pdwStreamCount) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetStreamSelection(DWORD dwStreamIndex,
                                                       WINBOOL * pfEnabled) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetStreamSelection(DWORD dwStreamIndex,
                                                       WINBOOL fEnabled) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetStreamAttribute(
      DWORD dwStreamIndex, REFGUID guidMFAttribute, PROPVARIANT * pvValue) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetPresentationAttribute(
      REFGUID guidMFAttribute, PROPVARIANT * pvValue) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetCharacteristics(
      MFP_MEDIAITEM_CHARACTERISTICS * pCharacteristics) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetStreamSink(DWORD dwStreamIndex,
                                                  IUnknown * pMediaSink) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetMetadata(IPropertyStore *
                                                *ppMetadataStore) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IMFPMediaItem, 0x90eb3e6b, 0xecbf, 0x45cc, 0xb1, 0xda, 0xc6,
                0xfe, 0x3e, 0xa7, 0x0d, 0x57)
#endif
#else
typedef struct IMFPMediaItemVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IMFPMediaItem *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IMFPMediaItem *This);
  ULONG(STDMETHODCALLTYPE *Release)(IMFPMediaItem *This);
  /*** IMFPMediaItem methods ***/
  HRESULT(STDMETHODCALLTYPE *GetMediaPlayer)(IMFPMediaItem *This,
                                             IMFPMediaPlayer **ppMediaPlayer);
  HRESULT(STDMETHODCALLTYPE *GetURL)(IMFPMediaItem *This, LPWSTR *ppwszURL);
  HRESULT(STDMETHODCALLTYPE *GetObject)(IMFPMediaItem *This,
                                        IUnknown **ppIUnknown);
  HRESULT(STDMETHODCALLTYPE *GetUserData)(IMFPMediaItem *This,
                                          DWORD_PTR *pdwUserData);
  HRESULT(STDMETHODCALLTYPE *SetUserData)(IMFPMediaItem *This,
                                          DWORD_PTR dwUserData);
  HRESULT(STDMETHODCALLTYPE *GetStartStopPosition)(IMFPMediaItem *This,
  ...
  HRESULT(STDMETHODCALLTYPE *SetStartStopPosition)(
      IMFPMediaItem *This, const GUID *pguidStartPositionType,
      const PROPVARIANT *pvStartValue, const GUID *pguidStopPositionType,
      const PROPVARIANT *pvStopValue);
  HRESULT(STDMETHODCALLTYPE *HasVideo)(IMFPMediaItem *This, WINBOOL *pfHasVideo,
                                       WINBOOL *pfSelected);
  HRESULT(STDMETHODCALLTYPE *HasAudio)(IMFPMediaItem *This, WINBOOL *pfHasAudio,
                                       WINBOOL *pfSelected);
  HRESULT(STDMETHODCALLTYPE *IsProtected)(IMFPMediaItem *This,
                                          WINBOOL *pfProtected);
  HRESULT(STDMETHODCALLTYPE *GetDuration)(IMFPMediaItem *This,
                                          REFGUID guidPositionType,
                                          PROPVARIANT *pvDurationValue);
  HRESULT(STDMETHODCALLTYPE *GetNumberOfStreams)(IMFPMediaItem *This,
                                                 DWORD *pdwStreamCount);
  HRESULT(STDMETHODCALLTYPE *GetStreamSelection)(IMFPMediaItem *This,
                                                 DWORD dwStreamIndex,
                                                 WINBOOL *pfEnabled);
  HRESULT(STDMETHODCALLTYPE *SetStreamSelection)(IMFPMediaItem *This,
                                                 DWORD dwStreamIndex,
                                                 WINBOOL fEnabled);
  HRESULT(STDMETHODCALLTYPE *GetStreamAttribute)(IMFPMediaItem *This,
                                                 DWORD dwStreamIndex,
                                                 REFGUID guidMFAttribute,
                                                 PROPVARIANT *pvValue);
  HRESULT(STDMETHODCALLTYPE *GetPresentationAttribute)(IMFPMediaItem *This,
                                                       REFGUID guidMFAttribute,
                                                       PROPVARIANT *pvValue);
  HRESULT(STDMETHODCALLTYPE *GetCharacteristics)(
      IMFPMediaItem *This, MFP_MEDIAITEM_CHARACTERISTICS *pCharacteristics);
  HRESULT(STDMETHODCALLTYPE *SetStreamSink)(IMFPMediaItem *This,
                                            DWORD dwStreamIndex,
                                            IUnknown *pMediaSink);
  HRESULT(STDMETHODCALLTYPE *GetMetadata)(IMFPMediaItem *This,
                                          IPropertyStore **ppMetadataStore);
  END_INTERFACE
} IMFPMediaItemVtbl;
interface IMFPMediaItem { CONST_VTBL IMFPMediaItemVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define IMFPMediaItem_GetStartStopPosition(This, pguidStartPositionType,       \
                                           pvStartValue,                       \
                                           pguidStopPositionType, pvStopValue) \
  (This)->lpVtbl->GetStartStopPosition(This, pguidStartPositionType,           \
                                       pvStartValue, pguidStopPositionType,    \
                                       pvStopValue)
#define IMFPMediaItem_SetStartStopPosition(This, pguidStartPositionType,       \
                                           pvStartValue,                       \
                                           pguidStopPositionType, pvStopValue) \
  (This)->lpVtbl->SetStartStopPosition(This, pguidStartPositionType,           \
                                       pvStartValue, pguidStopPositionType,    \
                                       pvStopValue)
...
#define IMFPMediaItem_GetStreamAttribute(This, dwStreamIndex, guidMFAttribute, \
                                         pvValue)                              \
  (This)->lpVtbl->GetStreamAttribute(This, dwStreamIndex, guidMFAttribute,     \
                                     pvValue)
...
#else
/*** IUnknown methods ***/
static inline HRESULT IMFPMediaItem_QueryInterface(IMFPMediaItem *This,
                                                   REFIID riid,
                                                   void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IMFPMediaItem methods ***/
static inline HRESULT
IMFPMediaItem_GetMediaPlayer(IMFPMediaItem *This,
                             IMFPMediaPlayer **ppMediaPlayer) {
  return This->lpVtbl->GetMediaPlayer(This, ppMediaPlayer);
}
static inline HRESULT IMFPMediaItem_GetURL(IMFPMediaItem *This,
                                           LPWSTR *ppwszURL) {
  return This->lpVtbl->GetURL(This, ppwszURL);
}
static inline HRESULT IMFPMediaItem_GetObject(IMFPMediaItem *This,
                                              IUnknown **ppIUnknown) {
  return This->lpVtbl->GetObject(This, ppIUnknown);
}
static inline HRESULT IMFPMediaItem_GetUserData(IMFPMediaItem *This,
                                                DWORD_PTR *pdwUserData) {
  return This->lpVtbl->GetUserData(This, pdwUserData);
}
static inline HRESULT IMFPMediaItem_SetUserData(IMFPMediaItem *This,
                                                DWORD_PTR dwUserData) {
  return This->lpVtbl->SetUserData(This, dwUserData);
}
static inline HRESULT IMFPMediaItem_GetStartStopPosition(
    IMFPMediaItem *This, GUID *pguidStartPositionType,
    PROPVARIANT *pvStartValue, GUID *pguidStopPositionType,
    PROPVARIANT *pvStopValue) {
  return This->lpVtbl->GetStartStopPosition(This, pguidStartPositionType,
                                            pvStartValue, pguidStopPositionType,
                                            pvStopValue);
}
static inline HRESULT IMFPMediaItem_SetStartStopPosition(
    IMFPMediaItem *This, const GUID *pguidStartPositionType,
    const PROPVARIANT *pvStartValue, const GUID *pguidStopPositionType,
    const PROPVARIANT *pvStopValue) {
  return This->lpVtbl->SetStartStopPosition(This, pguidStartPositionType,
                                            pvStartValue, pguidStopPositionType,
                                            pvStopValue);
}
static inline HRESULT IMFPMediaItem_HasVideo(IMFPMediaItem *This,
                                             WINBOOL *pfHasVideo,
                                             WINBOOL *pfSelected) {
  return This->lpVtbl->HasVideo(This, pfHasVideo, pfSelected);
}
static inline HRESULT IMFPMediaItem_HasAudio(IMFPMediaItem *This,
                                             WINBOOL *pfHasAudio,
                                             WINBOOL *pfSelected) {
  return This->lpVtbl->HasAudio(This, pfHasAudio, pfSelected);
}
static inline HRESULT IMFPMediaItem_IsProtected(IMFPMediaItem *This,
                                                WINBOOL *pfProtected) {
  return This->lpVtbl->IsProtected(This, pfProtected);
}
static inline HRESULT IMFPMediaItem_GetDuration(IMFPMediaItem *This,
                                                REFGUID guidPositionType,
                                                PROPVARIANT *pvDurationValue) {
  return This->lpVtbl->GetDuration(This, guidPositionType, pvDurationValue);
}
static inline HRESULT IMFPMediaItem_GetNumberOfStreams(IMFPMediaItem *This,
                                                       DWORD *pdwStreamCount) {
  return This->lpVtbl->GetNumberOfStreams(This, pdwStreamCount);
}
static inline HRESULT IMFPMediaItem_GetStreamSelection(IMFPMediaItem *This,
                                                       DWORD dwStreamIndex,
                                                       WINBOOL *pfEnabled) {
  return This->lpVtbl->GetStreamSelection(This, dwStreamIndex, pfEnabled);
}
static inline HRESULT IMFPMediaItem_SetStreamSelection(IMFPMediaItem *This,
                                                       DWORD dwStreamIndex,
                                                       WINBOOL fEnabled) {
  return This->lpVtbl->SetStreamSelection(This, dwStreamIndex, fEnabled);
}
static inline HRESULT IMFPMediaItem_GetStreamAttribute(IMFPMediaItem *This,
                                                       DWORD dwStreamIndex,
                                                       REFGUID guidMFAttribute,
                                                       PROPVARIANT *pvValue) {
  return This->lpVtbl->GetStreamAttribute(This, dwStreamIndex, guidMFAttribute,
                                          pvValue);
}
static inline HRESULT IMFPMediaItem_GetPresentationAttribute(
    IMFPMediaItem *This, REFGUID guidMFAttribute, PROPVARIANT *pvValue) {
  return This->lpVtbl->GetPresentationAttribute(This, guidMFAttribute, pvValue);
}
static inline HRESULT IMFPMediaItem_GetCharacteristics(
    IMFPMediaItem *This, MFP_MEDIAITEM_CHARACTERISTICS *pCharacteristics) {
  return This->lpVtbl->GetCharacteristics(This, pCharacteristics);
}
static inline HRESULT IMFPMediaItem_SetStreamSink(IMFPMediaItem *This,
                                                  DWORD dwStreamIndex,
                                                  IUnknown *pMediaSink) {
  return This->lpVtbl->SetStreamSink(This, dwStreamIndex, pMediaSink);
}
static inline HRESULT
IMFPMediaItem_GetMetadata(IMFPMediaItem *This,
                          IPropertyStore **ppMetadataStore) {
...
EXTERN_C const DECLSPEC_SELECTANY PROPERTYKEY MFP_PKEY_StreamIndex = {
    {0xa7cf9740,
     0xe8d9,
     0x4a87,
     {0xbd, 0x8e, 0x29, 0x67, 0x0, 0x1f, 0xd3, 0xad}},
    0x00};
EXTERN_C const DECLSPEC_SELECTANY PROPERTYKEY MFP_PKEY_StreamRenderingResults =
    {{0xa7cf9740,
      0xe8d9,
      0x4a87,
      {0xbd, 0x8e, 0x29, 0x67, 0x0, 0x1f, 0xd3, 0xad}},
     0x01};
#define __MFP_CAST_EVENT(pHdr, Tag)                                            \
  (((pHdr)->eEventType == MFP_EVENT_TYPE_##Tag) ? (MFP_##Tag##_EVENT *)(pHdr)  \
                                                : NULL)
...
#define MFP_GET_MEDIAITEM_CREATED_EVENT(pHdr)                                  \
  __MFP_CAST_EVENT(pHdr, MEDIAITEM_CREATED)
...
#define MFP_GET_MEDIAITEM_CLEARED_EVENT(pHdr)                                  \
  __MFP_CAST_EVENT(pHdr, MEDIAITEM_CLEARED)
#define MFP_GET_MF_EVENT(pHdr) __MFP_CAST_EVENT(pHdr, MF)
#define MFP_GET_ERROR_EVENT(pHdr) __MFP_CAST_EVENT(pHdr, ERROR)
#define MFP_GET_PLAYBACK_ENDED_EVENT(pHdr)                                     \
  __MFP_CAST_EVENT(pHdr, PLAYBACK_ENDED)
#define MFP_GET_ACQUIRE_USER_CREDENTIAL_EVENT(pHdr)                            \
  __MFP_CAST_EVENT(pHdr, ACQUIRE_USER_CREDENTIAL)
/*****************************************************************************
...
DEFINE_GUID(IID_IMFPMediaPlayerCallback, 0x766c8ffb, 0x5fdb, 0x4fea, 0xa2, 0x8d,
            0xb9, 0x12, 0x99, 0x6f, 0x51, 0xbd);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("766c8ffb-5fdb-4fea-a28d-b912996f51bd")
IMFPMediaPlayerCallback : public IUnknown {
  virtual void STDMETHODCALLTYPE OnMediaPlayerEvent(MFP_EVENT_HEADER *
                                                    pEventHeader) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IMFPMediaPlayerCallback, 0x766c8ffb, 0x5fdb, 0x4fea, 0xa2, 0x8d,
                0xb9, 0x12, 0x99, 0x6f, 0x51, 0xbd)
#endif
#else
typedef struct IMFPMediaPlayerCallbackVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IMFPMediaPlayerCallback *This,
  ...
  void(STDMETHODCALLTYPE *OnMediaPlayerEvent)(IMFPMediaPlayerCallback *This,
...
/*** IUnknown methods ***/
static inline HRESULT
IMFPMediaPlayerCallback_QueryInterface(IMFPMediaPlayerCallback *This,
                                       REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IMFPMediaPlayerCallback_AddRef(IMFPMediaPlayerCallback *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IMFPMediaPlayerCallback_Release(IMFPMediaPlayerCallback *This) {
  return This->lpVtbl->Release(This);
}
/*** IMFPMediaPlayerCallback methods ***/
static inline void
IMFPMediaPlayerCallback_OnMediaPlayerEvent(IMFPMediaPlayerCallback *This,
                                           MFP_EVENT_HEADER *pEventHeader) {
  This->lpVtbl->OnMediaPlayerEvent(This, pEventHeader);
}
#endif
