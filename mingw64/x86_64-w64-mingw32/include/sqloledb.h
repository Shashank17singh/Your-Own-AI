...
extern const GUID CLSID_SQLOLEDB = {
    0xc7ff16c, 0x38e3, 0x11d0, {0x97, 0xab, 0x0, 0xc0, 0x4f, 0xc2, 0xad, 0x98}};
...
extern const GUID CLSID_SQLOLEDB_ENUMERATOR = {
    ...
    0xe68d,
    0x11d0,
    {0x97, 0xe4, 0x0, 0xc0, 0x4f, 0xc2, 0xad, 0x98}};
#else
extern const GUID CLSID_SQLOLEDB;
extern const GUID CLSID_SQLOLEDB_ERROR;
extern const GUID CLSID_SQLOLEDB_ENUMERATOR;
...
extern const GUID DBGUID_MSSQLXML = {
    ...
    0xe6ed,
    0x11d2,
    {0xb2, 0x52, 0x00, 0xc0, 0x4f, 0x68, 0x1b, 0x71}};
extern const GUID DBGUID_XPATH = {
    0xec2a4293,
    0xe898,
    0x11d2,
    {0xb1, 0xb7, 0x00, 0xc0, 0x4f, 0x68, 0x0c, 0x56}};
...
extern const DBID DBCOLUMN_SS_COMPFLAGS = {
    {0x627bd890,
     0xed54,
     0x11d2,
     {0xb9, 0x94, 0x0, 0xc0, 0x4f, 0x8c, 0xa8, 0x2c}},
    DBKIND_GUID_PROPID,
    (LPOLESTR)100};
...
#endif
HRESULT
    WINAPI ISQLServerErrorInfo_GetErrorInfo_Proxy(ISQLServerErrorInfo *This,
                                                  SSERRORINFO **ppErrorInfo,
                                                  OLECHAR **ppStringsBuffer);
...
#endif
#endif
HRESULT WINAPI IRowsetFastLoad_InsertRow_Proxy(IRowsetFastLoad *This,
                                               HACCESSOR hAccessor,
                                               void *pData);
void __RPC_STUB IRowsetFastLoad_InsertRow_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IRowsetFastLoad_Commit_Proxy(IRowsetFastLoad *This,
                                            WINBOOL fDone);
...
enum LOCKMODEENUM { LOCKMODE_INVALID = 0, LOCKMODE_EXCLUSIVE, LOCKMODE_SHARED };
...
#endif
#endif
HRESULT WINAPI ISchemaLock_GetSchemaLock_Proxy(ISchemaLock *This,
                                               DBID *pTableID, LOCKMODE lmMode,
                                               HANDLE *phLockHandle,
                                               ULONGLONG *pTableVersion);
void __RPC_STUB ISchemaLock_GetSchemaLock_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISchemaLock_ReleaseSchemaLock_Proxy(ISchemaLock *This,
                                                   HANDLE hLockHandle);
