...
#define IsRouteNonUnicast(pRoute)                                              \
  (((DWORD)((pRoute)->RR_Network.N_NetNumber & 0x000000FF)) >=                 \
   ((DWORD)0x000000E0))
...
#define ROUTE_HEADER                                                           \
  DWORD_ALIGN(FILETIME, RR_TimeStamp);                                         \
  DWORD RR_RoutingProtocol;                                                    \
  DWORD RR_InterfaceID;                                                        \
  DWORD_ALIGN(PROTOCOL_SPECIFIC_DATA, RR_ProtocolSpecificData)
...
HANDLE WINAPI RtmRegisterClient(DWORD ProtocolFamily, DWORD RoutingProtocol,
                                HANDLE ChangeEvent, DWORD Flags);
DWORD WINAPI RtmDeregisterClient(HANDLE ClientHandle);
DWORD WINAPI RtmDequeueRouteChangeMessage(HANDLE ClientHandle, DWORD *Flags,
                                          PVOID CurBestRoute,
                                          PVOID PrevBestRoute);
DWORD WINAPI RtmAddRoute(HANDLE ClientHandle, PVOID Route, DWORD TimeToLive,
                         DWORD *Flags, PVOID CurBestRoute, PVOID PrevBestRoute);
DWORD WINAPI RtmDeleteRoute(HANDLE ClientHandle, PVOID Route, DWORD *Flags,
                            PVOID CurBestRoute);
...
HANDLE WINAPI RtmCreateEnumerationHandle(DWORD ProtocolFamily,
                                         DWORD EnumerationFlags,
                                         PVOID CriteriaRoute);
...
DWORD WINAPI RtmBlockDeleteRoutes(HANDLE ClientHandle, DWORD EnumerationFlags,
                                  PVOID CriteriaRoute);
DWORD WINAPI RtmGetFirstRoute(DWORD ProtocolFamily, DWORD EnumerationFlags,
                              PVOID Route);
#define RtmGetSpecificRoute(ProtocolFamily, Route)                             \
  RtmGetFirstRoute(ProtocolFamily,                                             \
                   RTM_ONLY_THIS_NETWORK | RTM_ONLY_THIS_PROTOCOL |            \
                       RTM_ONLY_THIS_INTERFACE,                                \
                   Route)
DWORD WINAPI RtmGetNextRoute(DWORD ProtocolFamily, DWORD EnumerationFlags,
                             PVOID Route);
