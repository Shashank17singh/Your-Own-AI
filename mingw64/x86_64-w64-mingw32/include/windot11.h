...
#define NDIS_PACKET_TYPE_802_11_ALL_MULTICAST_DATA                             \
...
#define NDIS_PACKET_TYPE_ALL_802_11_FILTERS                                    \
  (NDIS_PACKET_TYPE_DIRECTED | NDIS_PACKET_TYPE_MULTICAST |                    \
   ...
   NDIS_PACKET_TYPE_802_11_RAW_MGMT | NDIS_PACKET_TYPE_802_11_DIRECTED_CTRL |  \
...
#define DOT11_PACKET_TYPE_RESERVED                                             \
  (~(DOT11_PACKET_TYPE_DIRECTED_CTRL | DOT11_PACKET_TYPE_DIRECTED_MGMT |       \
     DOT11_PACKET_TYPE_DIRECTED_DATA | DOT11_PACKET_TYPE_MULTICAST_CTRL |      \
     DOT11_PACKET_TYPE_MULTICAST_MGMT | DOT11_PACKET_TYPE_MULTICAST_DATA |     \
     DOT11_PACKET_TYPE_BROADCAST_CTRL | DOT11_PACKET_TYPE_BROADCAST_MGMT |     \
     DOT11_PACKET_TYPE_BROADCAST_DATA | DOT11_PACKET_TYPE_PROMISCUOUS_CTRL |   \
     DOT11_PACKET_TYPE_PROMISCUOUS_MGMT | DOT11_PACKET_TYPE_PROMISCUOUS_DATA | \
     DOT11_PACKET_TYPE_ALL_MULTICAST_CTRL |                                    \
     DOT11_PACKET_TYPE_ALL_MULTICAST_MGMT |                                    \
     DOT11_PACKET_TYPE_ALL_MULTICAST_DATA | 0))
...
typedef DOT11_SUPPORTED_DATA_RATES_VALUE_V2 DOT11_SUPPORTED_DATA_RATES_VALUE_V1,
    *PDOT11_SUPPORTED_DATA_RATES_VALUE_V1;
...
#define OID_DOT11_EHCC_NUMBER_OF_CHANNELS_FAMILY_INDEX                         \
  (OID_DOT11_NDIS_START + 79)
...
#define OID_DOT11_PMKID_LIST                                                   \
  NWF_DEFINE_OID(128, NWF_OPERATIONAL_OID, NWF_OPTIONAL_OID)
...
#ifdef __WIDL__
  [
    unique, size_is(uTotalNumOfEntries)
...
typedef struct _DOT11_DATA_RATE_MAPPING_TABLE {
  ...
  DOT11_DATA_RATE_MAPPING_ENTRY
      DataRateMappingEntries[DOT11_RATE_SET_MAX_LENGTH];
...
#define OID_DOT11_QOS_PARAMS                                                   \
  NWF_DEFINE_OID(156, NWF_OPERATIONAL_OID, NWF_OPTIONAL_OID)
...
typedef struct DOT11_PHY_ATTRIBUTES DOT11_PHY_ATTRIBUTES,
...
#define DOT11_SEND_CONTEXT_SIZE                                                \
  ((sizeof(DOT11_SEND_CONTEXT) + MEMORY_ALLOCATION_ALIGNMENT - 1) &            \
...
#define DOT11_RECV_CONTEXT_SIZE                                                \
  ((sizeof(DOT11_RECV_CONTEXT) + MEMORY_ALLOCATION_ALIGNMENT - 1) &            \
   ~(MEMORY_ALLOCATION_ALIGNMENT - 1))
#else
...
#define DOT11_DISASSOC_REASON_PEER_DEAUTHENTICATED                             \
  DOT11_ASSOC_STATUS_PEER_DEAUTHENTICATED
#define DOT11_DISASSOC_REASON_PEER_DISASSOCIATED                               \
  DOT11_ASSOC_STATUS_PEER_DISASSOCIATED
...
typedef struct DOT11_CONNECTION_COMPLETION_PARAMETERS {
  ...
  DOT11_ASSOC_STATUS uStatus;
    ...
    *PDOT11_CONNECTION_COMPLETION_PARAMETERS;
...
typedef struct DOT11_PMKID_CANDIDATE_LIST_PARAMETERS {
  ...
  ULONG uCandidateListOffset;
    ...
    *PDOT11_PMKID_CANDIDATE_LIST_PARAMETERS;
...
#define DEFINE_NWF_GUID(NAME, ORD)                                             \
  DEFINE_GUID(NAME, 0x6cb9a43e + (ORD), 0xc45f, 0x4039, 0x9f, 0xe6, 0xd0,      \
              0x8c, 0xb0, 0x57, 0x18, 0x4c)
...
#endif
#define NDIS_SIZEOF_DOT11_EXTAP_ATTRIBUTES_REVISION_1                          \
  sizeof(DOT11_EXTAP_ATTRIBUTES)
#define DOT11_SIZEOF_INCOMING_ASSOC_DECISION_REVISION_1                        \
...
#define DOT11_SIZEOF_VWIFI_COMBINATION_REVISION_1                              \
...
#define DOT11_SIZEOF_VWIFI_COMBINATION_REVISION_2                              \
...
#define DOT11_SIZEOF_VWIFI_COMBINATION_REVISION_3                              \
  sizeof(DOT11_VWIFI_COMBINATION_V3)
...
#ifdef __WIDL__
  [ unique,
    size_is(uTotalNumOfEntries) ] DOT11_VWIFI_COMBINATION Combinations[*];
#else
...
#define WFD_STATUS_SUCCEEDED(status)                                           \
  (((DOT11_WFD_STATUS_CODE)(status)) == DOT11_WFD_STATUS_SUCCESS ||            \
   ((DOT11_WFD_STATUS_CODE)(status)) ==                                        \
       DOT11_WFD_STATUS_SUCCESS_ACCEPTED_BY_USER)
#define WFD_STATUS_FAILED(status)                                              \
  (((DOT11_WFD_STATUS_CODE)(status)) != DOT11_WFD_STATUS_SUCCESS &&            \
   ((DOT11_WFD_STATUS_CODE)(status)) !=                                        \
       DOT11_WFD_STATUS_SUCCESS_ACCEPTED_BY_USER)
#define DOT11_WFD_MINOR_REASON_SUCCESS 0
#define DOT11_WFD_MINOR_REASON_DISASSOCIATED_FROM_WLAN_CROSS_CONNECTION_POLICY 1
#define DOT11_WFD_MINOR_REASON_DISASSOCIATED_NOT_MANAGED_INFRASTRUCTURE_CAPABLE \
  2
...
#define DOT11_SIZEOF_WFD_DISCOVER_COMPLETE_PARAMETERS_REVISION_1               \
...
#define DOT11_SIZEOF_RECEIVED_GO_NEGOTIATION_REQUEST_PARAMETERS_REVISION_1     \
  sizeof(DOT11_RECEIVED_GO_NEGOTIATION_REQUEST_PARAMETERS)
#define DOT11_SIZEOF_GO_NEGOTIATION_RESPONSE_SEND_COMPLETE_PARAMETERS_REVISION_1 \
  sizeof(DOT11_GO_NEGOTIATION_RESPONSE_SEND_COMPLETE_PARAMETERS)
#define DOT11_SIZEOF_RECEIVED_GO_NEGOTIATION_RESPONSE_PARAMETERS_REVISION_1    \
  sizeof(DOT11_RECEIVED_GO_NEGOTIATION_RESPONSE_PARAMETERS)
#define DOT11_SIZEOF_GO_NEGOTIATION_CONFIRMATION_SEND_COMPLETE_PARAMETERS_REVISION_1 \
...
#define DOT11_SIZEOF_RECEIVED_GO_NEGOTIATION_CONFIRMATION_PARAMETERS_REVISION_1 \
...
#define DOT11_SIZEOF_INVITATION_REQUEST_SEND_COMPLETE_PARAMETERS_REVISION_1    \
...
#define DOT11_SIZEOF_RECEIVED_INVITATION_REQUEST_PARAMETERS_REVISION_1         \
...
#define DOT11_SIZEOF_INVITATION_RESPONSE_SEND_COMPLETE_PARAMETERS_REVISION_1   \
...
#define DOT11_SIZEOF_RECEIVED_INVITATION_RESPONSE_PARAMETERS_REVISION_1        \
...
#define DOT11_SIZEOF_PROVISION_DISCOVERY_REQUEST_SEND_COMPLETE_PARAMETERS_REVISION_1 \
...
#define DOT11_SIZEOF_WFD_DEVICE_CAPABILITY_CONFIG_1                            \
  sizeof(DOT11_WFD_DEVICE_CAPABILITY_CONFIG)
#define DOT11_SIZEOF_WFD_GROUP_CAPABILITY_CONFIG_1                             \
  sizeof(DOT11_WFD_GROUP_OWNER_CAPABILITY_CONFIG)
#define DOT11_SIZEOF_WFD_DEVICE_INFO_REVISION_1 sizeof(DOT11_WFD_DEVICE_INFO)
#define DOT11_SIZEOF_WFD_SECONDARY_DEVICE_TYPE_LIST_REVISION_1                 \
  FIELD_OFFSET(DOT11_WFD_SECONDARY_DEVICE_TYPE_LIST, SecondaryDeviceTypes)
#define DOT11_SIZEOF_WFD_DISCOVER_REQUEST_REVISION_1                           \
  sizeof(DOT11_WFD_DISCOVER_REQUEST)
#define OID_DOT11_WFD_DEVICE_CAPABILITY                                        \
  NWF_DEFINE_OID(0x01, NWF_WFD_DEVICE_OID, NWF_MANDATORY_OID)
#define OID_DOT11_WFD_GROUP_OWNER_CAPABILITY                                   \
  NWF_DEFINE_OID(0x02, NWF_WFD_DEVICE_OID, NWF_MANDATORY_OID)
#define OID_DOT11_WFD_DEVICE_INFO                                              \
  NWF_DEFINE_OID(0x03, NWF_WFD_DEVICE_OID, NWF_MANDATORY_OID)
#define OID_DOT11_WFD_SECONDARY_DEVICE_TYPE_LIST                               \
  NWF_DEFINE_OID(0x04, NWF_WFD_DEVICE_OID, NWF_MANDATORY_OID)
#define OID_DOT11_WFD_DISCOVER_REQUEST                                         \
  NWF_DEFINE_OID(0x05, NWF_WFD_DEVICE_OID, NWF_MANDATORY_OID)
#define OID_DOT11_WFD_ENUM_DEVICE_LIST                                         \
  NWF_DEFINE_OID(0x06, NWF_WFD_DEVICE_OID, NWF_MANDATORY_OID)
#define OID_DOT11_WFD_LISTEN_STATE_DISCOVERABILITY                             \
  NWF_DEFINE_OID(0x07, NWF_WFD_DEVICE_OID, NWF_MANDATORY_OID)
#define OID_DOT11_WFD_ADDITIONAL_IE                                            \
  NWF_DEFINE_OID(0x08, NWF_WFD_DEVICE_OID, NWF_MANDATORY_OID)
#define DOT11_WFD_DEVICE_ENTRY_GET_DEVICE_SIZE(DEV)                            \
  (sizeof(DOT11_WFD_DEVICE_ENTRY) + (DEV)->uBeaconIEsLength +                  \
   (DEV)->uProbeResponseIEsLength)
...
#define DOT11_SIZEOF_WFD_ADDITIONAL_IE_REVISION_1                              \
  sizeof(DOT11_WFD_ADDITIONAL_IE)
#define DOT11_WFD_ADDITIONAL_IE_GET_HEADER_SIZE(ADDIE)                         \
  (sizeof(DOT11_WFD_ADDITIONAL_IE))
#define DOT11_WFD_ADDITIONAL_IE_GET_HEADER_END(ADDIE)                          \
  (((PCHAR)(ADDIE)) + sizeof(DOT11_WFD_ADDITIONAL_IE))
#define DOT11_WFD_ADDITIONAL_IE_GET_BEACON_IE(ADDIE)                           \
  (((PCHAR)(ADDIE)) + (ADDIE)->uBeaconIEsOffset)
#define DOT11_WFD_ADDITIONAL_IE_SET_BEACON_IE(ADDIE, B)                        \
  (ADDIE)->uBeaconIEsOffset = (DWORD)(((SIZE_T)(B)) - ((SIZE_T)(ADDIE)))
#define DOT11_WFD_ADDITIONAL_IE_GET_BEACON_IE_SIZE(ADDIE)                      \
  ((ADDIE)->uBeaconIEsLength)
#define DOT11_WFD_ADDITIONAL_IE_SET_BEACON_IE_SIZE(ADDIE, SZ)                  \
  (ADDIE)->uBeaconIEsLength = (DWORD)(SZ)
#define DOT11_WFD_ADDITIONAL_IE_GET_BEACON_IE_END(ADDIE)                       \
  (((PCHAR)(ADDIE)) + (ADDIE)->uBeaconIEsOffset +                              \
   DOT11_WFD_ADDITIONAL_IE_GET_BEACON_IE_SIZE(ADDIE))
#define DOT11_WFD_ADDITIONAL_IE_GET_PROBE_RESPONSE_IE(ADDIE)                   \
  (((PCHAR)(ADDIE)) + (ADDIE)->uProbeResponseIEsOffset)
#define DOT11_WFD_ADDITIONAL_IE_SET_PROBE_RESPONSE_IE(ADDIE, _response_)       \
  (ADDIE)->uProbeResponseIEsOffset =                                           \
      (DWORD)(((SIZE_T)(_response_)) - ((SIZE_T)(ADDIE)))
#define DOT11_WFD_ADDITIONAL_IE_GET_PROBE_RESPONSE_IE_SIZE(ADDIE)              \
  ((ADDIE)->uProbeResponseIEsLength)
#define DOT11_WFD_ADDITIONAL_IE_SET_PROBE_RESPONSE_IE_SIZE(ADDIE, SZ)          \
  (ADDIE)->uProbeResponseIEsLength = (DWORD)(SZ)
#define DOT11_WFD_ADDITIONAL_IE_GET_PROBE_RESPONSE_IE_END(ADDIE)               \
  (((PCHAR)(ADDIE)) + (ADDIE)->uProbeResponseIEsOffset +                       \
   DOT11_WFD_ADDITIONAL_IE_GET_PROBE_RESPONSE_IE_SIZE(ADDIE))
#define DOT11_WFD_ADDITIONAL_IE_GET_PROBE_REQUEST_IE(ADDIE)                    \
  (((PCHAR)(ADDIE)) + (ADDIE)->uDefaultRequestIEsOffset)
#define DOT11_WFD_ADDITIONAL_IE_SET_PROBE_REQUEST_IE(ADDIE, REQ)               \
  (ADDIE)->uDefaultRequestIEsOffset =                                          \
      (DWORD)(((SIZE_T)(REQ)) - ((SIZE_T)(ADDIE)))
#define DOT11_WFD_ADDITIONAL_IE_GET_PROBE_REQUEST_IE_SIZE(ADDIE)               \
  ((ADDIE)->uDefaultRequestIEsLength)
#define DOT11_WFD_ADDITIONAL_IE_SET_PROBE_REQUEST_IE_SIZE(ADDIE, SZ)           \
  (ADDIE)->uDefaultRequestIEsLength = (DWORD)(SZ)
#define DOT11_WFD_ADDITIONAL_IE_GET_ALL_IE_SIZE(ADDIE)                         \
  ((ADDIE)->uBeaconIEsLength + (ADDIE)->uProbeResponseIEsLength +              \
   (ADDIE)->uDefaultRequestIEsLength)
#define DOT11_WFD_ADDITIONAL_IE_GET_TOTAL_SIZE(ADDIE)                          \
  (DOT11_WFD_ADDITIONAL_IE_GET_HEADER_SIZE(ADDIE) +                            \
   DOT11_WFD_ADDITIONAL_IE_GET_ALL_IE_SIZE(ADDIE))
#define OID_DOT11_WFD_FLUSH_DEVICE_LIST                                        \
  NWF_DEFINE_OID(0x09, NWF_WFD_DEVICE_OID, NWF_MANDATORY_OID)
#define OID_DOT11_WFD_SEND_GO_NEGOTIATION_REQUEST                              \
...
typedef struct _DOT11_SEND_GO_NEGOTIATION_REQUEST_PARAMETERS {
  ...
  ULONG uIEsLength;
    ...
    *PDOT11_SEND_GO_NEGOTIATION_REQUEST_PARAMETERS;
#define DOT11_SIZEOF_SEND_GO_NEGOTIATION_REQUEST_PARAMETERS_REVISION_1         \
  sizeof(DOT11_SEND_GO_NEGOTIATION_REQUEST_PARAMETERS)
#define OID_DOT11_WFD_SEND_GO_NEGOTIATION_RESPONSE                             \
...
#define DOT11_SIZEOF_SEND_GO_NEGOTIATION_RESPONSE_PARAMETERS_REVISION_1        \
  sizeof(DOT11_SEND_GO_NEGOTIATION_RESPONSE_PARAMETERS)
#define OID_DOT11_WFD_SEND_GO_NEGOTIATION_CONFIRMATION                         \
...
#define DOT11_SIZEOF_SEND_GO_NEGOTIATION_CONFIRMATION_PARAMETERS_REVISION_1    \
  sizeof(DOT11_SEND_GO_NEGOTIATION_CONFIRMATION_PARAMETERS)
#define OID_DOT11_WFD_SEND_INVITATION_REQUEST                                  \
...
#define DOT11_SIZEOF_SEND_INVITATION_REQUEST_PARAMETERS_REVISION_1             \
  sizeof(DOT11_SEND_INVITATION_REQUEST_PARAMETERS)
#define DOT11_SIZEOF_SEND_INVITATION_RESPONSE_PARAMETERS_REVISION_1            \
  sizeof(DOT11_SEND_INVITATION_RESPONSE_PARAMETERS)
#define OID_DOT11_WFD_SEND_INVITATION_RESPONSE                                 \
  NWF_DEFINE_OID(0x0e, NWF_WFD_DEVICE_OID, NWF_MANDATORY_OID)
#define OID_DOT11_WFD_SEND_PROVISION_DISCOVERY_REQUEST                         \
...
#define OID_DOT11_WFD_SEND_PROVISION_DISCOVERY_RESPONSE                        \
  NWF_DEFINE_OID(0x10, NWF_WFD_DEVICE_OID, NWF_MANDATORY_OID)
#define OID_DOT11_WFD_GET_DIALOG_TOKEN                                         \
  NWF_DEFINE_OID(0x11, NWF_WFD_DEVICE_OID, NWF_MANDATORY_OID)
#define OID_DOT11_WFD_STOP_DISCOVERY                                           \
  NWF_DEFINE_OID(0x12, NWF_WFD_DEVICE_OID, NWF_MANDATORY_OID)
#define OID_DOT11_WFD_DEVICE_LISTEN_CHANNEL                                    \
  NWF_DEFINE_OID(0x13, NWF_WFD_DEVICE_OID, NWF_MANDATORY_OID)
#define OID_DOT11_WFD_DESIRED_GROUP_ID                                         \
  NWF_DEFINE_OID(0x01, NWF_WFD_ROLE_OID, NWF_MANDATORY_OID)
#define OID_DOT11_WFD_START_GO_REQUEST                                         \
...
#define OID_DOT11_WFD_CONNECT_TO_GROUP_REQUEST                                 \
...
#define OID_DOT11_WFD_GROUP_JOIN_PARAMETERS                                    \
...
#define DOT11_SIZEOF_SEND_PROVISION_DISCOVERY_REQUEST_PARAMETERS_REVISION_1    \
  sizeof(DOT11_SEND_PROVISION_DISCOVERY_REQUEST_PARAMETERS)
#define DOT11_SIZEOF_WFD_DEVICE_LISTEN_CHANNEL_REVISION_1                      \
  sizeof(DOT11_WFD_DEVICE_LISTEN_CHANNEL)
#define DOT11_SIZEOF_WFD_GROUP_START_PARAMETERS_REVISION_1                     \
  sizeof(DOT11_WFD_GROUP_START_PARAMETERS)
#define DOT11_SIZEOF_WFD_GROUP_JOIN_PARAMETERS_REVISION_1                      \
  sizeof(DOT11_WFD_GROUP_JOIN_PARAMETERS)
#define DOT11_SIZEOF_SEND_PROVISION_DISCOVERY_RESPONSE_PARAMETERS_REVISION_1   \
  sizeof(DOT11_SEND_PROVISION_DISCOVERY_RESPONSE_PARAMETERS)
#endif
#ifdef NWF_POWER_SAVE_SUPPORTED
#define NWF_POWER_SAVE_OID (0x07U)
#define OID_DOT11_POWER_MGMT_MODE_AUTO_ENABLED                                 \
  NWF_DEFINE_OID(0x01, NWF_POWER_SAVE_OID, NWF_MANDATORY_OID)
#define OID_DOT11_POWER_MGMT_MODE_STATUS                                       \
  NWF_DEFINE_OID(0x02, NWF_POWER_SAVE_OID, NWF_MANDATORY_OID)
#define OID_DOT11_OFFLOAD_NETWORK_LIST                                         \
...
#define DOT11_SIZEOF_OFFLOAD_NETWORK_LIST_INFO_REVISION_1(UNOE)                \
  (FIELD_OFFSET(DOT11_OFFLOAD_NETWORK_LIST_INFO, offloadNetworkList) +         \
   sizeof(DOT11_OFFLOAD_NETWORK) * (UNOE))
...
#define DOT11_SIZEOF_POWER_MGMT_MODE_STATUS_INFO_REVISION_1                    \
  sizeof(DOT11_POWER_MGMT_MODE_STATUS_INFO)
...
#define DOT11_SIZEOF_OFFLOAD_NETWORK_STATUS_PARAMETERS_REVISION_1              \
...
#define OID_DOT11_MANUFACTURING_TEST                                           \
...
typedef enum _DOT11_MANUFACTURING_TEST_TYPE {
  ...
  dot11_manufacturing_test_IHV_end = 0xffffffff
    ...
    *PDOT11_MANUFACTURING_TEST_TYPE;
...
typedef enum DOT11_MANUFACTURING_SELF_TEST_TYPE {
  ...
  DOT11_MANUFACTURING_SELF_TEST_TYPE_BT_COEXISTENCE
    ...
    *PDOT11_MANUFACTURING_SELF_TEST_TYPE;
...
typedef struct _DOT11_MANUFACTURING_SELF_TEST_QUERY_RESULTS {
  ...
  UCHAR ucBufferOut[1];
    ...
    *PDOT11_MANUFACTURING_SELF_TEST_QUERY_RESULTS;
...
typedef struct _DOT11_MANUFACTURING_FUNCTIONAL_TEST_RX {
  ...
  LONG PowerLevel;
    ...
    *PDOT11_MANUFACTURING_FUNCTIONAL_TEST_RX;
typedef struct _DOT11_MANUFACTURING_FUNCTIONAL_TEST_TX {
  ...
  LONG ADCPowerLevel;
    ...
    *PDOT11_MANUFACTURING_FUNCTIONAL_TEST_TX;
...
typedef enum _DOT11_MANUFACTURING_CALLBACK_TYPE {
  ...
  dot11_manufacturing_callback_IHV_end = 0xffffffff
    ...
    *PDOT11_MANUFACTURING_CALLBACK_TYPE;
