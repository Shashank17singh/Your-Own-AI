...
DEFINE_GUID(IID_IContextCallback, 0x000001da, 0x0000, 0x0000, 0xc0, 0x00, 0x00,
...
IContextCallback : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE ContextCallback(
      PFNCONTEXTCALL pCallback, ComCallData * pParam, REFIID riid, int iMethod,
      IUnknown *pUnk) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IContextCallback, 0x000001da, 0x0000, 0x0000, 0xc0, 0x00, 0x00,
                0x00, 0x00, 0x00, 0x00, 0x46)
#endif
#else
typedef struct IContextCallbackVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IContextCallback *This,
  ...
  HRESULT(STDMETHODCALLTYPE *ContextCallback)(IContextCallback *This,
                                              PFNCONTEXTCALL pCallback,
                                              ComCallData *pParam, REFIID riid,
                                              int iMethod, IUnknown *pUnk);
  END_INTERFACE
} IContextCallbackVtbl;
interface IContextCallback { CONST_VTBL IContextCallbackVtbl *lpVtbl; };
#ifdef COBJMACROS
...
/*** IContextCallback methods ***/
#define IContextCallback_ContextCallback(This, pCallback, pParam, riid,        \
                                         iMethod, pUnk)                        \
  (This)->lpVtbl->ContextCallback(This, pCallback, pParam, riid, iMethod, pUnk)
#else
/*** IUnknown methods ***/
static inline HRESULT IContextCallback_QueryInterface(IContextCallback *This,
                                                      REFIID riid,
                                                      void **ppvObject) {
...
/*** IContextCallback methods ***/
static inline HRESULT IContextCallback_ContextCallback(IContextCallback *This,
                                                       PFNCONTEXTCALL pCallback,
                                                       ComCallData *pParam,
                                                       REFIID riid, int iMethod,
                                                       IUnknown *pUnk) {
  return This->lpVtbl->ContextCallback(This, pCallback, pParam, riid, iMethod,
                                       pUnk);
}
#endif
#endif
