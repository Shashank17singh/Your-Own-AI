...
DEFINE_GUID(IID_IWeakReference, 0x00000037, 0x0000, 0x0000, 0xc0, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x46);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("00000037-0000-0000-c000-000000000046")
IWeakReference : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE Resolve(REFIID iid,
                                            IInspectable * *ref) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IWeakReference, 0x00000037, 0x0000, 0x0000, 0xc0, 0x00, 0x00,
                0x00, 0x00, 0x00, 0x00, 0x46)
#endif
#else
typedef struct IWeakReferenceVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWeakReference *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IWeakReference *This);
  ULONG(STDMETHODCALLTYPE *Release)(IWeakReference *This);
  /*** IWeakReference methods ***/
  HRESULT(STDMETHODCALLTYPE *Resolve)(IWeakReference *This, REFIID iid,
                                      IInspectable **ref);
  END_INTERFACE
} IWeakReferenceVtbl;
interface IWeakReference { CONST_VTBL IWeakReferenceVtbl *lpVtbl; };
#ifdef COBJMACROS
...
/*** IWeakReference methods ***/
#define IWeakReference_Resolve(This, iid, ref)                                 \
  (This)->lpVtbl->Resolve(This, iid, ref)
#else
/*** IUnknown methods ***/
static inline HRESULT IWeakReference_QueryInterface(IWeakReference *This,
                                                    REFIID riid,
                                                    void **ppvObject) {
...
/*** IWeakReference methods ***/
static inline HRESULT IWeakReference_Resolve(IWeakReference *This, REFIID iid,
                                             IInspectable **ref) {
...
DEFINE_GUID(IID_IWeakReferenceSource, 0x00000038, 0x0000, 0x0000, 0xc0, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x46);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("00000038-0000-0000-c000-000000000046")
IWeakReferenceSource : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetWeakReference(IWeakReference * *ref) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IWeakReferenceSource, 0x00000038, 0x0000, 0x0000, 0xc0, 0x00,
                0x00, 0x00, 0x00, 0x00, 0x00, 0x46)
#endif
#else
typedef struct IWeakReferenceSourceVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWeakReferenceSource *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IWeakReferenceSource *This);
  ULONG(STDMETHODCALLTYPE *Release)(IWeakReferenceSource *This);
  /*** IWeakReferenceSource methods ***/
  HRESULT(STDMETHODCALLTYPE *GetWeakReference)(IWeakReferenceSource *This,
                                               IWeakReference **ref);
  END_INTERFACE
} IWeakReferenceSourceVtbl;
interface IWeakReferenceSource { CONST_VTBL IWeakReferenceSourceVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IWeakReferenceSource methods ***/
#define IWeakReferenceSource_GetWeakReference(This, ref)                       \
  (This)->lpVtbl->GetWeakReference(This, ref)
#else
/*** IUnknown methods ***/
static inline HRESULT
IWeakReferenceSource_QueryInterface(IWeakReferenceSource *This, REFIID riid,
                                    void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IWeakReferenceSource methods ***/
static inline HRESULT
IWeakReferenceSource_GetWeakReference(IWeakReferenceSource *This,
                                      IWeakReference **ref) {
