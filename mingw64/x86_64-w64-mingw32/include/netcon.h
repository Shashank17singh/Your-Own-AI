...
typedef struct IEnumNetSharingPrivateConnection
...
typedef struct INetSharingPortMappingCollection
...
typedef struct INetSharingEveryConnectionCollection
...
typedef struct INetSharingPublicConnectionCollection
...
typedef struct INetSharingPrivateConnectionCollection
...
#define NETCON_HKEYCURRENTUSERPATH                                             \
  TEXT("Software\\Microsoft\\Windows NT\\CurrentVersion\\Network\\Network "    \
       "Connections")
...
public:
  virtual HRESULT WINAPI Next(ULONG celt, INetConnection **rgelt,
...
typedef struct IEnumNetConnectionVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IEnumNetConnection *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IEnumNetConnection *This);
  ULONG(WINAPI *Release)(IEnumNetConnection *This);
  HRESULT(WINAPI *Next)(IEnumNetConnection *This, ULONG celt,
                        INetConnection **rgelt, ULONG *pceltFetched);
...
#endif
#endif
HRESULT WINAPI IEnumNetConnection_Next_Proxy(IEnumNetConnection *This,
                                             ULONG celt, INetConnection **rgelt,
                                             ULONG *pceltFetched);
...
HRESULT WINAPI IEnumNetConnection_Skip_Proxy(IEnumNetConnection *This,
                                             ULONG celt);
...
void __RPC_STUB IEnumNetConnection_Reset_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumNetConnection_Clone_Proxy(IEnumNetConnection *This,
...
public:
  ...
  virtual HRESULT WINAPI Duplicate(LPCWSTR pszwDuplicateName,
...
typedef struct INetConnectionVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(INetConnection *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *Duplicate)(INetConnection *This, LPCWSTR pszwDuplicateName,
                             INetConnection **ppCon);
  HRESULT(WINAPI *GetProperties)(INetConnection *This,
...
void __RPC_STUB INetConnection_Delete_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI INetConnection_Duplicate_Proxy(INetConnection *This,
                                              LPCWSTR pszwDuplicateName,
                                              INetConnection **ppCon);
void __RPC_STUB INetConnection_Duplicate_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI INetConnection_GetProperties_Proxy(INetConnection *This,
                                                  NETCON_PROPERTIES **ppProps);
void __RPC_STUB INetConnection_GetProperties_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI INetConnection_GetUiObjectClassId_Proxy(INetConnection *This,
                                                       CLSID *pclsid);
void __RPC_STUB INetConnection_GetUiObjectClassId_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI INetConnection_Rename_Proxy(INetConnection *This,
                                           LPCWSTR pszwNewName);
...
typedef struct INetConnectionManagerVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(INetConnectionManager *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(INetConnectionManager *This);
  ULONG(WINAPI *Release)(INetConnectionManager *This);
  HRESULT(WINAPI *EnumConnections)(INetConnectionManager *This,
...
#endif
#endif
HRESULT WINAPI INetConnectionManager_EnumConnections_Proxy(
    INetConnectionManager *This, NETCONMGR_ENUM_FLAGS Flags,
    IEnumNetConnection **ppEnum);
...
typedef struct INetConnectionManagerEventsVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(INetConnectionManagerEvents *This,
  ...
  HRESULT(WINAPI *Disable)(INetConnectionManagerEvents *This,
...
#endif
#endif
HRESULT WINAPI INetConnectionManagerEvents_RefreshConnections_Proxy(
    INetConnectionManagerEvents *This);
void __RPC_STUB INetConnectionManagerEvents_RefreshConnections_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
INetConnectionManagerEvents_Enable_Proxy(INetConnectionManagerEvents *This);
void __RPC_STUB INetConnectionManagerEvents_Enable_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI INetConnectionManagerEvents_Disable_Proxy(
    INetConnectionManagerEvents *This, ULONG ulDisableTimeout);
...
typedef struct INetConnectionConnectUiVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(INetConnectionConnectUi *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(INetConnectionConnectUi *This);
  ULONG(WINAPI *Release)(INetConnectionConnectUi *This);
  HRESULT(WINAPI *SetConnection)(INetConnectionConnectUi *This,
                                 INetConnection *pCon);
  HRESULT(WINAPI *Connect)(INetConnectionConnectUi *This, HWND hwndParent,
                           DWORD dwFlags);
  HRESULT(WINAPI *Disconnect)(INetConnectionConnectUi *This, HWND hwndParent,
                              DWORD dwFlags);
  END_INTERFACE
...
#endif
#endif
HRESULT WINAPI INetConnectionConnectUi_SetConnection_Proxy(
    INetConnectionConnectUi *This, INetConnection *pCon);
void __RPC_STUB INetConnectionConnectUi_SetConnection_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI INetConnectionConnectUi_Connect_Proxy(
    INetConnectionConnectUi *This, HWND hwndParent, DWORD dwFlags);
void __RPC_STUB INetConnectionConnectUi_Connect_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI INetConnectionConnectUi_Disconnect_Proxy(
    INetConnectionConnectUi *This, HWND hwndParent, DWORD dwFlags);
...
public:
  virtual HRESULT WINAPI SetConnection(INetConnection *pCon) = 0;
  virtual HRESULT WINAPI AddPages(HWND hwndParent,
...
typedef struct INetConnectionPropertyUiVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(INetConnectionPropertyUi *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(INetConnectionPropertyUi *This);
  ULONG(WINAPI *Release)(INetConnectionPropertyUi *This);
  HRESULT(WINAPI *SetConnection)(INetConnectionPropertyUi *This,
                                 INetConnection *pCon);
  HRESULT(WINAPI *AddPages)(INetConnectionPropertyUi *This, HWND hwndParent,
...
#define INetConnectionPropertyUi_SetConnection(This, pCon)                     \
  (This)->lpVtbl->SetConnection(This, pCon)
#define INetConnectionPropertyUi_AddPages(This, hwndParent, pfnAddPage,        \
                                          lParam)                              \
  (This)->lpVtbl->AddPages(This, hwndParent, pfnAddPage, lParam)
#endif
#endif
HRESULT WINAPI INetConnectionPropertyUi_SetConnection_Proxy(
    INetConnectionPropertyUi *This, INetConnection *pCon);
void __RPC_STUB INetConnectionPropertyUi_SetConnection_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI INetConnectionPropertyUi_AddPages_Proxy(
    INetConnectionPropertyUi *This, HWND hwndParent,
    LPFNADDPROPSHEETPAGE pfnAddPage, LPARAM lParam);
...
typedef struct INetConnectionPropertyUi2Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(INetConnectionPropertyUi2 *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(INetConnectionPropertyUi2 *This);
  ULONG(WINAPI *Release)(INetConnectionPropertyUi2 *This);
  HRESULT(WINAPI *SetConnection)(INetConnectionPropertyUi2 *This,
                                 INetConnection *pCon);
  HRESULT(WINAPI *AddPages)(INetConnectionPropertyUi2 *This, HWND hwndParent,
                            LPFNADDPROPSHEETPAGE pfnAddPage, LPARAM lParam);
  HRESULT(WINAPI *GetIcon)(INetConnectionPropertyUi2 *This, DWORD dwSize,
                           HICON *phIcon);
  END_INTERFACE
...
#define INetConnectionPropertyUi2_SetConnection(This, pCon)                    \
  (This)->lpVtbl->SetConnection(This, pCon)
#define INetConnectionPropertyUi2_AddPages(This, hwndParent, pfnAddPage,       \
                                           lParam)                             \
  (This)->lpVtbl->AddPages(This, hwndParent, pfnAddPage, lParam)
...
#endif
#endif
HRESULT WINAPI INetConnectionPropertyUi2_GetIcon_Proxy(
    INetConnectionPropertyUi2 *This, DWORD dwSize, HICON *phIcon);
...
public:
  virtual HRESULT WINAPI ChooseConnection(NETCON_CHOOSECONN *pChooseConn,
                                          INetConnection **ppCon) = 0;
  virtual HRESULT WINAPI ShowConnectionProperties(HWND hwndParent,
                                                  INetConnection *pCon) = 0;
  virtual HRESULT WINAPI StartNewConnectionWizard(HWND hwndParent,
                                                  INetConnection **ppCon) = 0;
};
#else
typedef struct INetConnectionCommonUiVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(INetConnectionCommonUi *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(INetConnectionCommonUi *This);
  ULONG(WINAPI *Release)(INetConnectionCommonUi *This);
  HRESULT(WINAPI *ChooseConnection)(INetConnectionCommonUi *This,
                                    NETCON_CHOOSECONN *pChooseConn,
                                    INetConnection **ppCon);
  HRESULT(WINAPI *ShowConnectionProperties)(INetConnectionCommonUi *This,
                                            HWND hwndParent,
                                            INetConnection *pCon);
  HRESULT(WINAPI *StartNewConnectionWizard)(INetConnectionCommonUi *This,
                                            HWND hwndParent,
                                            INetConnection **ppCon);
  END_INTERFACE
...
#define INetConnectionCommonUi_ShowConnectionProperties(This, hwndParent,      \
                                                        pCon)                  \
  (This)->lpVtbl->ShowConnectionProperties(This, hwndParent, pCon)
#define INetConnectionCommonUi_StartNewConnectionWizard(This, hwndParent,      \
                                                        ppCon)                 \
  (This)->lpVtbl->StartNewConnectionWizard(This, hwndParent, ppCon)
#endif
#endif
HRESULT WINAPI INetConnectionCommonUi_ChooseConnection_Proxy(
    INetConnectionCommonUi *This, NETCON_CHOOSECONN *pChooseConn,
    INetConnection **ppCon);
void __RPC_STUB INetConnectionCommonUi_ChooseConnection_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI INetConnectionCommonUi_ShowConnectionProperties_Proxy(
    INetConnectionCommonUi *This, HWND hwndParent, INetConnection *pCon);
void __RPC_STUB INetConnectionCommonUi_ShowConnectionProperties_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI INetConnectionCommonUi_StartNewConnectionWizard_Proxy(
    INetConnectionCommonUi *This, HWND hwndParent, INetConnection **ppCon);
...
public:
  virtual HRESULT WINAPI Next(ULONG celt, VARIANT *rgVar,
                              ULONG *pceltFetched) = 0;
  virtual HRESULT WINAPI Skip(ULONG celt) = 0;
  virtual HRESULT WINAPI Reset(void) = 0;
...
typedef struct IEnumNetSharingPortMappingVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IEnumNetSharingPortMapping *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IEnumNetSharingPortMapping *This);
  ULONG(WINAPI *Release)(IEnumNetSharingPortMapping *This);
  HRESULT(WINAPI *Next)(IEnumNetSharingPortMapping *This, ULONG celt,
  ...
  HRESULT(WINAPI *Clone)(IEnumNetSharingPortMapping *This,
                         IEnumNetSharingPortMapping **ppenum);
  END_INTERFACE
...
#endif
#endif
HRESULT WINAPI IEnumNetSharingPortMapping_Next_Proxy(
    IEnumNetSharingPortMapping *This, ULONG celt, VARIANT *rgVar,
    ULONG *pceltFetched);
void __RPC_STUB IEnumNetSharingPortMapping_Next_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumNetSharingPortMapping_Skip_Proxy(
    IEnumNetSharingPortMapping *This, ULONG celt);
void __RPC_STUB IEnumNetSharingPortMapping_Skip_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
IEnumNetSharingPortMapping_Reset_Proxy(IEnumNetSharingPortMapping *This);
void __RPC_STUB IEnumNetSharingPortMapping_Reset_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumNetSharingPortMapping_Clone_Proxy(
    IEnumNetSharingPortMapping *This, IEnumNetSharingPortMapping **ppenum);
...
typedef struct INetSharingPortMappingPropsVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(INetSharingPortMappingProps *This,
                                  REFIID riid, void **ppvObject);
  ULONG(WINAPI *AddRef)(INetSharingPortMappingProps *This);
  ULONG(WINAPI *Release)(INetSharingPortMappingProps *This);
  HRESULT(WINAPI *GetTypeInfoCount)(INetSharingPortMappingProps *This,
                                    UINT *pctinfo);
  HRESULT(WINAPI *GetTypeInfo)(INetSharingPortMappingProps *This, UINT iTInfo,
                               LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(INetSharingPortMappingProps *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(INetSharingPortMappingProps *This,
                          DISPID dispIdMember, REFIID riid, LCID lcid,
                          WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *get_Name)(INetSharingPortMappingProps *This, BSTR *pbstrName);
  HRESULT(WINAPI *get_IPProtocol)(INetSharingPortMappingProps *This,
                                  UCHAR *pucIPProt);
  HRESULT(WINAPI *get_ExternalPort)(INetSharingPortMappingProps *This,
                                    __LONG32 *pusPort);
  HRESULT(WINAPI *get_InternalPort)(INetSharingPortMappingProps *This,
                                    __LONG32 *pusPort);
  HRESULT(WINAPI *get_Options)(INetSharingPortMappingProps *This,
                               __LONG32 *pdwOptions);
  HRESULT(WINAPI *get_TargetName)(INetSharingPortMappingProps *This,
                                  BSTR *pbstrTargetName);
  HRESULT(WINAPI *get_TargetIPAddress)(INetSharingPortMappingProps *This,
                                       BSTR *pbstrTargetIPAddress);
  HRESULT(WINAPI *get_Enabled)(INetSharingPortMappingProps *This,
                               VARIANT_BOOL *pbool);
  END_INTERFACE
...
#define INetSharingPortMappingProps_GetIDsOfNames(This, riid, rgszNames,       \
                                                  cNames, lcid, rgDispId)      \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define INetSharingPortMappingProps_Invoke(This, dispIdMember, riid, lcid,     \
...
#define INetSharingPortMappingProps_get_TargetIPAddress(This,                  \
...
#endif
#endif
HRESULT WINAPI INetSharingPortMappingProps_get_Name_Proxy(
    INetSharingPortMappingProps *This, BSTR *pbstrName);
void __RPC_STUB INetSharingPortMappingProps_get_Name_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI INetSharingPortMappingProps_get_IPProtocol_Proxy(
    INetSharingPortMappingProps *This, UCHAR *pucIPProt);
void __RPC_STUB INetSharingPortMappingProps_get_IPProtocol_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI INetSharingPortMappingProps_get_ExternalPort_Proxy(
    INetSharingPortMappingProps *This, __LONG32 *pusPort);
void __RPC_STUB INetSharingPortMappingProps_get_ExternalPort_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI INetSharingPortMappingProps_get_InternalPort_Proxy(
    INetSharingPortMappingProps *This, __LONG32 *pusPort);
void __RPC_STUB INetSharingPortMappingProps_get_InternalPort_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI INetSharingPortMappingProps_get_Options_Proxy(
    INetSharingPortMappingProps *This, __LONG32 *pdwOptions);
void __RPC_STUB INetSharingPortMappingProps_get_Options_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI INetSharingPortMappingProps_get_TargetName_Proxy(
    INetSharingPortMappingProps *This, BSTR *pbstrTargetName);
void __RPC_STUB INetSharingPortMappingProps_get_TargetName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI INetSharingPortMappingProps_get_TargetIPAddress_Proxy(
    INetSharingPortMappingProps *This, BSTR *pbstrTargetIPAddress);
...
HRESULT WINAPI INetSharingPortMappingProps_get_Enabled_Proxy(
    INetSharingPortMappingProps *This, VARIANT_BOOL *pbool);
...
public:
  ...
  get_Properties(INetSharingPortMappingProps **ppNSPMP) = 0;
  virtual HRESULT WINAPI Delete(void) = 0;
};
#else
typedef struct INetSharingPortMappingVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(INetSharingPortMapping *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(INetSharingPortMapping *This);
  ULONG(WINAPI *Release)(INetSharingPortMapping *This);
  HRESULT(WINAPI *GetTypeInfoCount)(INetSharingPortMapping *This,
                                    UINT *pctinfo);
  HRESULT(WINAPI *GetTypeInfo)(INetSharingPortMapping *This, UINT iTInfo,
                               LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(INetSharingPortMapping *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(INetSharingPortMapping *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *Disable)(INetSharingPortMapping *This);
  HRESULT(WINAPI *Enable)(INetSharingPortMapping *This);
  HRESULT(WINAPI *get_Properties)(INetSharingPortMapping *This,
...
#define INetSharingPortMapping_GetTypeInfo(This, iTInfo, lcid, ppTInfo)        \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define INetSharingPortMapping_GetIDsOfNames(This, riid, rgszNames, cNames,    \
                                             lcid, rgDispId)                   \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define INetSharingPortMapping_Invoke(This, dispIdMember, riid, lcid, wFlags,  \
...
#endif
HRESULT
    WINAPI INetSharingPortMapping_Disable_Proxy(INetSharingPortMapping *This);
void __RPC_STUB INetSharingPortMapping_Disable_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
INetSharingPortMapping_Enable_Proxy(INetSharingPortMapping *This);
void __RPC_STUB INetSharingPortMapping_Enable_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI INetSharingPortMapping_get_Properties_Proxy(
    INetSharingPortMapping *This, INetSharingPortMappingProps **ppNSPMP);
void __RPC_STUB INetSharingPortMapping_get_Properties_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
INetSharingPortMapping_Delete_Proxy(INetSharingPortMapping *This);
...
typedef struct IEnumNetSharingEveryConnectionVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IEnumNetSharingEveryConnection *This,
                                  REFIID riid, void **ppvObject);
  ULONG(WINAPI *AddRef)(IEnumNetSharingEveryConnection *This);
  ULONG(WINAPI *Release)(IEnumNetSharingEveryConnection *This);
  HRESULT(WINAPI *Next)(IEnumNetSharingEveryConnection *This, ULONG celt,
                        VARIANT *rgVar, ULONG *pceltFetched);
  ...
  HRESULT(WINAPI *Clone)(IEnumNetSharingEveryConnection *This,
                         IEnumNetSharingEveryConnection **ppenum);
  END_INTERFACE
...
#endif
#endif
HRESULT WINAPI IEnumNetSharingEveryConnection_Next_Proxy(
    IEnumNetSharingEveryConnection *This, ULONG celt, VARIANT *rgVar,
    ULONG *pceltFetched);
void __RPC_STUB IEnumNetSharingEveryConnection_Next_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumNetSharingEveryConnection_Skip_Proxy(
    IEnumNetSharingEveryConnection *This, ULONG celt);
...
void __RPC_STUB IEnumNetSharingEveryConnection_Reset_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumNetSharingEveryConnection_Clone_Proxy(
    IEnumNetSharingEveryConnection *This,
    IEnumNetSharingEveryConnection **ppenum);
...
typedef struct IEnumNetSharingPublicConnectionVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IEnumNetSharingPublicConnection *This,
                                  REFIID riid, void **ppvObject);
  ULONG(WINAPI *AddRef)(IEnumNetSharingPublicConnection *This);
  ULONG(WINAPI *Release)(IEnumNetSharingPublicConnection *This);
  HRESULT(WINAPI *Next)(IEnumNetSharingPublicConnection *This, ULONG celt,
                        VARIANT *rgVar, ULONG *pceltFetched);
  ...
  HRESULT(WINAPI *Clone)(IEnumNetSharingPublicConnection *This,
...
#endif
#endif
HRESULT WINAPI IEnumNetSharingPublicConnection_Next_Proxy(
    IEnumNetSharingPublicConnection *This, ULONG celt, VARIANT *rgVar,
    ULONG *pceltFetched);
void __RPC_STUB IEnumNetSharingPublicConnection_Next_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumNetSharingPublicConnection_Skip_Proxy(
    IEnumNetSharingPublicConnection *This, ULONG celt);
...
void __RPC_STUB IEnumNetSharingPublicConnection_Reset_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumNetSharingPublicConnection_Clone_Proxy(
    IEnumNetSharingPublicConnection *This,
    IEnumNetSharingPublicConnection **ppenum);
...
typedef struct IEnumNetSharingPrivateConnectionVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IEnumNetSharingPrivateConnection *This,
                                  REFIID riid, void **ppvObject);
  ULONG(WINAPI *AddRef)(IEnumNetSharingPrivateConnection *This);
  ULONG(WINAPI *Release)(IEnumNetSharingPrivateConnection *This);
  HRESULT(WINAPI *Next)(IEnumNetSharingPrivateConnection *This, ULONG celt,
                        VARIANT *rgVar, ULONG *pCeltFetched);
  ...
  HRESULT(WINAPI *Clone)(IEnumNetSharingPrivateConnection *This,
...
#endif
#endif
HRESULT WINAPI IEnumNetSharingPrivateConnection_Next_Proxy(
    IEnumNetSharingPrivateConnection *This, ULONG celt, VARIANT *rgVar,
    ULONG *pCeltFetched);
void __RPC_STUB IEnumNetSharingPrivateConnection_Next_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumNetSharingPrivateConnection_Skip_Proxy(
    IEnumNetSharingPrivateConnection *This, ULONG celt);
void __RPC_STUB IEnumNetSharingPrivateConnection_Skip_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumNetSharingPrivateConnection_Reset_Proxy(
...
typedef struct INetSharingPortMappingCollectionVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(INetSharingPortMappingCollection *This,
                                  REFIID riid, void **ppvObject);
  ULONG(WINAPI *AddRef)(INetSharingPortMappingCollection *This);
  ULONG(WINAPI *Release)(INetSharingPortMappingCollection *This);
  HRESULT(WINAPI *GetTypeInfoCount)(INetSharingPortMappingCollection *This,
                                    UINT *pctinfo);
  HRESULT(WINAPI *GetTypeInfo)(INetSharingPortMappingCollection *This,
                               UINT iTInfo, LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(INetSharingPortMappingCollection *This,
                                 REFIID riid, LPOLESTR *rgszNames, UINT cNames,
                                 LCID lcid, DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(INetSharingPortMappingCollection *This,
                          DISPID dispIdMember, REFIID riid, LCID lcid,
                          WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *get__NewEnum)(INetSharingPortMappingCollection *This,
                                IUnknown **pVal);
  HRESULT(WINAPI *get_Count)(INetSharingPortMappingCollection *This,
                             __LONG32 *pVal);
  END_INTERFACE
...
#define INetSharingPortMappingCollection_GetTypeInfoCount(This, pctinfo)       \
  (This)->lpVtbl->GetTypeInfoCount(This, pctinfo)
#define INetSharingPortMappingCollection_GetTypeInfo(This, iTInfo, lcid,       \
                                                     ppTInfo)                  \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define INetSharingPortMappingCollection_GetIDsOfNames(This, riid, rgszNames,  \
                                                       cNames, lcid, rgDispId) \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define INetSharingPortMappingCollection_Invoke(                               \
...
#endif
#endif
HRESULT WINAPI INetSharingPortMappingCollection_get__NewEnum_Proxy(
    INetSharingPortMappingCollection *This, IUnknown **pVal);
void __RPC_STUB INetSharingPortMappingCollection_get__NewEnum_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI INetSharingPortMappingCollection_get_Count_Proxy(
    INetSharingPortMappingCollection *This, __LONG32 *pVal);
...
typedef struct INetConnectionPropsVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(INetConnectionProps *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(INetConnectionProps *This, UINT iTInfo,
                               LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(INetConnectionProps *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(INetConnectionProps *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  ...
  HRESULT(WINAPI *get_DeviceName)(INetConnectionProps *This,
                                  BSTR *pbstrDeviceName);
  HRESULT(WINAPI *get_Status)(INetConnectionProps *This,
                              NETCON_STATUS *pStatus);
  HRESULT(WINAPI *get_MediaType)(INetConnectionProps *This,
                                 NETCON_MEDIATYPE *pMediaType);
  HRESULT(WINAPI *get_Characteristics)(INetConnectionProps *This,
                                       DWORD *pdwFlags);
  END_INTERFACE
...
#define INetConnectionProps_GetTypeInfo(This, iTInfo, lcid, ppTInfo)           \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define INetConnectionProps_GetIDsOfNames(This, riid, rgszNames, cNames, lcid, \
                                          rgDispId)                            \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define INetConnectionProps_Invoke(This, dispIdMember, riid, lcid, wFlags,     \
                                   pDispParams, pVarResult, pExcepInfo,        \
                                   puArgErr)                                   \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI INetConnectionProps_get_Guid_Proxy(INetConnectionProps *This,
                                                  BSTR *pbstrGuid);
void __RPC_STUB INetConnectionProps_get_Guid_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI INetConnectionProps_get_Name_Proxy(INetConnectionProps *This,
                                                  BSTR *pbstrName);
void __RPC_STUB INetConnectionProps_get_Name_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI INetConnectionProps_get_DeviceName_Proxy(
    INetConnectionProps *This, BSTR *pbstrDeviceName);
void __RPC_STUB INetConnectionProps_get_DeviceName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI INetConnectionProps_get_Status_Proxy(INetConnectionProps *This,
                                                    NETCON_STATUS *pStatus);
void __RPC_STUB INetConnectionProps_get_Status_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI INetConnectionProps_get_MediaType_Proxy(
    INetConnectionProps *This, NETCON_MEDIATYPE *pMediaType);
void __RPC_STUB INetConnectionProps_get_MediaType_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI INetConnectionProps_get_Characteristics_Proxy(
    INetConnectionProps *This, DWORD *pdwFlags);
...
public:
  ...
  virtual HRESULT WINAPI
  get_SharingConnectionType(SHARINGCONNECTIONTYPE *pType) = 0;
  virtual HRESULT WINAPI DisableSharing(void) = 0;
  virtual HRESULT WINAPI EnableSharing(SHARINGCONNECTIONTYPE Type) = 0;
  virtual HRESULT WINAPI
  get_InternetFirewallEnabled(VARIANT_BOOL *pbEnabled) = 0;
  virtual HRESULT WINAPI DisableInternetFirewall(void) = 0;
  virtual HRESULT WINAPI EnableInternetFirewall(void) = 0;
  virtual HRESULT WINAPI
  get_EnumPortMappings(SHARINGCONNECTION_ENUM_FLAGS Flags,
                       INetSharingPortMappingCollection **ppColl) = 0;
  virtual HRESULT WINAPI AddPortMapping(BSTR bstrName, UCHAR ucIPProtocol,
                                        USHORT usExternalPort,
                                        USHORT usInternalPort, DWORD dwOptions,
                                        BSTR bstrTargetNameOrIPAddress,
                                        ICS_TARGETTYPE eTargetType,
                                        INetSharingPortMapping **ppMapping) = 0;
  virtual HRESULT WINAPI
  RemovePortMapping(INetSharingPortMapping *pMapping) = 0;
};
#else
typedef struct INetSharingConfigurationVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(INetSharingConfiguration *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(INetSharingConfiguration *This);
  ULONG(WINAPI *Release)(INetSharingConfiguration *This);
  HRESULT(WINAPI *GetTypeInfoCount)(INetSharingConfiguration *This,
                                    UINT *pctinfo);
  HRESULT(WINAPI *GetTypeInfo)(INetSharingConfiguration *This, UINT iTInfo,
                               LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(INetSharingConfiguration *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(INetSharingConfiguration *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *get_SharingEnabled)(INetSharingConfiguration *This,
                                      VARIANT_BOOL *pbEnabled);
  HRESULT(WINAPI *get_SharingConnectionType)(INetSharingConfiguration *This,
                                             SHARINGCONNECTIONTYPE *pType);
  HRESULT(WINAPI *DisableSharing)(INetSharingConfiguration *This);
  HRESULT(WINAPI *EnableSharing)(INetSharingConfiguration *This,
                                 SHARINGCONNECTIONTYPE Type);
  HRESULT(WINAPI *get_InternetFirewallEnabled)(INetSharingConfiguration *This,
                                               VARIANT_BOOL *pbEnabled);
  ...
  HRESULT(WINAPI *get_EnumPortMappings)(
      INetSharingConfiguration *This, SHARINGCONNECTION_ENUM_FLAGS Flags,
      INetSharingPortMappingCollection **ppColl);
  HRESULT(WINAPI *AddPortMapping)(INetSharingConfiguration *This, BSTR bstrName,
                                  UCHAR ucIPProtocol, USHORT usExternalPort,
                                  USHORT usInternalPort, DWORD dwOptions,
                                  BSTR bstrTargetNameOrIPAddress,
                                  ICS_TARGETTYPE eTargetType,
                                  INetSharingPortMapping **ppMapping);
  HRESULT(WINAPI *RemovePortMapping)(INetSharingConfiguration *This,
...
#define INetSharingConfiguration_GetTypeInfo(This, iTInfo, lcid, ppTInfo)      \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define INetSharingConfiguration_GetIDsOfNames(This, riid, rgszNames, cNames,  \
                                               lcid, rgDispId)                 \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define INetSharingConfiguration_Invoke(This, dispIdMember, riid, lcid,        \
                                        wFlags, pDispParams, pVarResult,       \
                                        pExcepInfo, puArgErr)                  \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#define INetSharingConfiguration_AddPortMapping(                               \
    This, bstrName, ucIPProtocol, usExternalPort, usInternalPort, dwOptions,   \
    bstrTargetNameOrIPAddress, eTargetType, ppMapping)                         \
  (This)->lpVtbl->AddPortMapping(                                              \
      This, bstrName, ucIPProtocol, usExternalPort, usInternalPort, dwOptions, \
      bstrTargetNameOrIPAddress, eTargetType, ppMapping)
...
HRESULT WINAPI INetSharingConfiguration_get_SharingEnabled_Proxy(
    INetSharingConfiguration *This, VARIANT_BOOL *pbEnabled);
void __RPC_STUB INetSharingConfiguration_get_SharingEnabled_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI INetSharingConfiguration_get_SharingConnectionType_Proxy(
    INetSharingConfiguration *This, SHARINGCONNECTIONTYPE *pType);
void __RPC_STUB INetSharingConfiguration_get_SharingConnectionType_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
INetSharingConfiguration_DisableSharing_Proxy(INetSharingConfiguration *This);
void __RPC_STUB INetSharingConfiguration_DisableSharing_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI INetSharingConfiguration_EnableSharing_Proxy(
    INetSharingConfiguration *This, SHARINGCONNECTIONTYPE Type);
void __RPC_STUB INetSharingConfiguration_EnableSharing_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI INetSharingConfiguration_get_InternetFirewallEnabled_Proxy(
    INetSharingConfiguration *This, VARIANT_BOOL *pbEnabled);
...
void __RPC_STUB INetSharingConfiguration_DisableInternetFirewall_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI INetSharingConfiguration_EnableInternetFirewall_Proxy(
    INetSharingConfiguration *This);
void __RPC_STUB INetSharingConfiguration_EnableInternetFirewall_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI INetSharingConfiguration_get_EnumPortMappings_Proxy(
    INetSharingConfiguration *This, SHARINGCONNECTION_ENUM_FLAGS Flags,
    INetSharingPortMappingCollection **ppColl);
void __RPC_STUB INetSharingConfiguration_get_EnumPortMappings_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI INetSharingConfiguration_AddPortMapping_Proxy(
    INetSharingConfiguration *This, BSTR bstrName, UCHAR ucIPProtocol,
    USHORT usExternalPort, USHORT usInternalPort, DWORD dwOptions,
    BSTR bstrTargetNameOrIPAddress, ICS_TARGETTYPE eTargetType,
    INetSharingPortMapping **ppMapping);
void __RPC_STUB INetSharingConfiguration_AddPortMapping_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI INetSharingConfiguration_RemovePortMapping_Proxy(
    INetSharingConfiguration *This, INetSharingPortMapping *pMapping);
...
typedef struct INetSharingEveryConnectionCollectionVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(INetSharingEveryConnectionCollection *This,
                                  REFIID riid, void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfoCount)(INetSharingEveryConnectionCollection *This,
                                    UINT *pctinfo);
  HRESULT(WINAPI *GetTypeInfo)(INetSharingEveryConnectionCollection *This,
                               UINT iTInfo, LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(INetSharingEveryConnectionCollection *This,
                                 REFIID riid, LPOLESTR *rgszNames, UINT cNames,
                                 LCID lcid, DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(INetSharingEveryConnectionCollection *This,
                          DISPID dispIdMember, REFIID riid, LCID lcid,
                          WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *get__NewEnum)(INetSharingEveryConnectionCollection *This,
                                IUnknown **pVal);
  HRESULT(WINAPI *get_Count)(INetSharingEveryConnectionCollection *This,
                             __LONG32 *pVal);
  END_INTERFACE
...
#ifdef COBJMACROS
#define INetSharingEveryConnectionCollection_QueryInterface(This, riid,        \
                                                            ppvObject)         \
  (This)->lpVtbl->QueryInterface(This, riid, ppvObject)
...
#define INetSharingEveryConnectionCollection_GetTypeInfoCount(This, pctinfo)   \
  (This)->lpVtbl->GetTypeInfoCount(This, pctinfo)
#define INetSharingEveryConnectionCollection_GetTypeInfo(This, iTInfo, lcid,   \
                                                         ppTInfo)              \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define INetSharingEveryConnectionCollection_GetIDsOfNames(                    \
    This, riid, rgszNames, cNames, lcid, rgDispId)                             \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define INetSharingEveryConnectionCollection_Invoke(                           \
    This, dispIdMember, riid, lcid, wFlags, pDispParams, pVarResult,           \
    pExcepInfo, puArgErr)                                                      \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI INetSharingEveryConnectionCollection_get__NewEnum_Proxy(
    INetSharingEveryConnectionCollection *This, IUnknown **pVal);
void __RPC_STUB INetSharingEveryConnectionCollection_get__NewEnum_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI INetSharingEveryConnectionCollection_get_Count_Proxy(
    INetSharingEveryConnectionCollection *This, __LONG32 *pVal);
...
typedef struct INetSharingPublicConnectionCollectionVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(INetSharingPublicConnectionCollection *This,
                                  REFIID riid, void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfoCount)(INetSharingPublicConnectionCollection *This,
                                    UINT *pctinfo);
  HRESULT(WINAPI *GetTypeInfo)(INetSharingPublicConnectionCollection *This,
                               UINT iTInfo, LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(INetSharingPublicConnectionCollection *This,
                                 REFIID riid, LPOLESTR *rgszNames, UINT cNames,
                                 LCID lcid, DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(INetSharingPublicConnectionCollection *This,
                          DISPID dispIdMember, REFIID riid, LCID lcid,
                          WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *get__NewEnum)(INetSharingPublicConnectionCollection *This,
                                IUnknown **pVal);
...
#ifdef COBJMACROS
#define INetSharingPublicConnectionCollection_QueryInterface(This, riid,       \
                                                             ppvObject)        \
  (This)->lpVtbl->QueryInterface(This, riid, ppvObject)
...
#define INetSharingPublicConnectionCollection_GetTypeInfoCount(This, pctinfo)  \
  (This)->lpVtbl->GetTypeInfoCount(This, pctinfo)
#define INetSharingPublicConnectionCollection_GetTypeInfo(This, iTInfo, lcid,  \
                                                          ppTInfo)             \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define INetSharingPublicConnectionCollection_GetIDsOfNames(                   \
    This, riid, rgszNames, cNames, lcid, rgDispId)                             \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define INetSharingPublicConnectionCollection_Invoke(                          \
    This, dispIdMember, riid, lcid, wFlags, pDispParams, pVarResult,           \
    pExcepInfo, puArgErr)                                                      \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI INetSharingPublicConnectionCollection_get__NewEnum_Proxy(
    INetSharingPublicConnectionCollection *This, IUnknown **pVal);
void __RPC_STUB INetSharingPublicConnectionCollection_get__NewEnum_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI INetSharingPublicConnectionCollection_get_Count_Proxy(
    INetSharingPublicConnectionCollection *This, __LONG32 *pVal);
...
typedef struct INetSharingPrivateConnectionCollectionVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(INetSharingPrivateConnectionCollection *This,
                                  REFIID riid, void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfoCount)(
      INetSharingPrivateConnectionCollection *This, UINT *pctinfo);
  HRESULT(WINAPI *GetTypeInfo)(INetSharingPrivateConnectionCollection *This,
                               UINT iTInfo, LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(INetSharingPrivateConnectionCollection *This,
                                 REFIID riid, LPOLESTR *rgszNames, UINT cNames,
                                 LCID lcid, DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(INetSharingPrivateConnectionCollection *This,
                          DISPID dispIdMember, REFIID riid, LCID lcid,
                          WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *get__NewEnum)(INetSharingPrivateConnectionCollection *This,
                                IUnknown **pVal);
  HRESULT(WINAPI *get_Count)(INetSharingPrivateConnectionCollection *This,
                             __LONG32 *pVal);
  END_INTERFACE
...
#ifdef COBJMACROS
#define INetSharingPrivateConnectionCollection_QueryInterface(This, riid,      \
                                                              ppvObject)       \
  (This)->lpVtbl->QueryInterface(This, riid, ppvObject)
...
#define INetSharingPrivateConnectionCollection_GetTypeInfoCount(This, pctinfo) \
  (This)->lpVtbl->GetTypeInfoCount(This, pctinfo)
#define INetSharingPrivateConnectionCollection_GetTypeInfo(This, iTInfo, lcid, \
                                                           ppTInfo)            \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define INetSharingPrivateConnectionCollection_GetIDsOfNames(                  \
    This, riid, rgszNames, cNames, lcid, rgDispId)                             \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
...
#endif
#endif
HRESULT WINAPI INetSharingPrivateConnectionCollection_get__NewEnum_Proxy(
    INetSharingPrivateConnectionCollection *This, IUnknown **pVal);
void __RPC_STUB INetSharingPrivateConnectionCollection_get__NewEnum_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI INetSharingPrivateConnectionCollection_get_Count_Proxy(
    INetSharingPrivateConnectionCollection *This, __LONG32 *pVal);
...
public:
  ...
  virtual HRESULT WINAPI
  get_EnumPublicConnections(SHARINGCONNECTION_ENUM_FLAGS Flags,
                            INetSharingPublicConnectionCollection **ppColl) = 0;
  virtual HRESULT WINAPI get_EnumPrivateConnections(
      SHARINGCONNECTION_ENUM_FLAGS Flags,
      INetSharingPrivateConnectionCollection **ppColl) = 0;
  virtual HRESULT WINAPI get_INetSharingConfigurationForINetConnection(
      INetConnection *pNetConnection,
      INetSharingConfiguration **ppNetSharingConfiguration) = 0;
  virtual HRESULT WINAPI
  get_EnumEveryConnection(INetSharingEveryConnectionCollection **ppColl) = 0;
  virtual HRESULT WINAPI get_NetConnectionProps(
      INetConnection *pNetConnection, INetConnectionProps **ppProps) = 0;
};
#else
typedef struct INetSharingManagerVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(INetSharingManager *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(INetSharingManager *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(INetSharingManager *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(INetSharingManager *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *get_SharingInstalled)(INetSharingManager *This,
                                        VARIANT_BOOL *pbInstalled);
  HRESULT(WINAPI *get_EnumPublicConnections)(
      INetSharingManager *This, SHARINGCONNECTION_ENUM_FLAGS Flags,
      INetSharingPublicConnectionCollection **ppColl);
  HRESULT(WINAPI *get_EnumPrivateConnections)(
      INetSharingManager *This, SHARINGCONNECTION_ENUM_FLAGS Flags,
      INetSharingPrivateConnectionCollection **ppColl);
  HRESULT(WINAPI *get_INetSharingConfigurationForINetConnection)(
      INetSharingManager *This, INetConnection *pNetConnection,
      INetSharingConfiguration **ppNetSharingConfiguration);
  HRESULT(WINAPI *get_EnumEveryConnection)(
      INetSharingManager *This, INetSharingEveryConnectionCollection **ppColl);
  HRESULT(WINAPI *get_NetConnectionProps)(INetSharingManager *This,
                                          INetConnection *pNetConnection,
...
#define INetSharingManager_GetTypeInfo(This, iTInfo, lcid, ppTInfo)            \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define INetSharingManager_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,  \
                                         rgDispId)                             \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define INetSharingManager_Invoke(This, dispIdMember, riid, lcid, wFlags,      \
                                  pDispParams, pVarResult, pExcepInfo,         \
                                  puArgErr)                                    \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#define INetSharingManager_get_INetSharingConfigurationForINetConnection(      \
    This, pNetConnection, ppNetSharingConfiguration)                           \
  (This)->lpVtbl->get_INetSharingConfigurationForINetConnection(               \
      This, pNetConnection, ppNetSharingConfiguration)
#define INetSharingManager_get_EnumEveryConnection(This, ppColl)               \
  (This)->lpVtbl->get_EnumEveryConnection(This, ppColl)
#define INetSharingManager_get_NetConnectionProps(This, pNetConnection,        \
                                                  ppProps)                     \
  (This)->lpVtbl->get_NetConnectionProps(This, pNetConnection, ppProps)
#endif
#endif
HRESULT WINAPI INetSharingManager_get_SharingInstalled_Proxy(
    INetSharingManager *This, VARIANT_BOOL *pbInstalled);
void __RPC_STUB INetSharingManager_get_SharingInstalled_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI INetSharingManager_get_EnumPublicConnections_Proxy(
    INetSharingManager *This, SHARINGCONNECTION_ENUM_FLAGS Flags,
    INetSharingPublicConnectionCollection **ppColl);
...
void __RPC_STUB INetSharingManager_get_EnumPrivateConnections_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
INetSharingManager_get_INetSharingConfigurationForINetConnection_Proxy(
    INetSharingManager *This, INetConnection *pNetConnection,
    INetSharingConfiguration **ppNetSharingConfiguration);
void __RPC_STUB
INetSharingManager_get_INetSharingConfigurationForINetConnection_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI INetSharingManager_get_EnumEveryConnection_Proxy(
    INetSharingManager *This, INetSharingEveryConnectionCollection **ppColl);
void __RPC_STUB INetSharingManager_get_EnumEveryConnection_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI INetSharingManager_get_NetConnectionProps_Proxy(
    INetSharingManager *This, INetConnection *pNetConnection,
    INetConnectionProps **ppProps);
