...
typedef struct IBITSExtensionSetupVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IBITSExtensionSetup *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(IBITSExtensionSetup *This, UINT iTInfo,
                               LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IBITSExtensionSetup *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IBITSExtensionSetup *This, DISPID dispIdMember,
  ...
  HRESULT(WINAPI *GetCleanupTaskName)(IBITSExtensionSetup *This,
                                      BSTR *pTaskName);
  HRESULT(WINAPI *GetCleanupTask)(IBITSExtensionSetup *This, REFIID riid,
                                  IUnknown **ppUnk);
  END_INTERFACE
...
#define IBITSExtensionSetup_GetIDsOfNames(This, riid, rgszNames, cNames, lcid, \
                                          rgDispId)                            \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IBITSExtensionSetup_Invoke(This, dispIdMember, riid, lcid, wFlags,     \
...
#endif
HRESULT WINAPI
IBITSExtensionSetup_EnableBITSUploads_Proxy(IBITSExtensionSetup *This);
...
HRESULT WINAPI
IBITSExtensionSetup_DisableBITSUploads_Proxy(IBITSExtensionSetup *This);
void __RPC_STUB IBITSExtensionSetup_DisableBITSUploads_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBITSExtensionSetup_GetCleanupTaskName_Proxy(
    IBITSExtensionSetup *This, BSTR *pTaskName);
void __RPC_STUB IBITSExtensionSetup_GetCleanupTaskName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IBITSExtensionSetup_GetCleanupTask_Proxy(
    IBITSExtensionSetup *This, REFIID riid, IUnknown **ppUnk);
...
public:
  virtual HRESULT WINAPI GetObject(BSTR Path,
                                   IBITSExtensionSetup **ppExtensionSetup) = 0;
};
#else
typedef struct IBITSExtensionSetupFactoryVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IBITSExtensionSetupFactory *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IBITSExtensionSetupFactory *This);
  ULONG(WINAPI *Release)(IBITSExtensionSetupFactory *This);
  HRESULT(WINAPI *GetTypeInfoCount)(IBITSExtensionSetupFactory *This,
                                    UINT *pctinfo);
  HRESULT(WINAPI *GetTypeInfo)(IBITSExtensionSetupFactory *This, UINT iTInfo,
                               LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(IBITSExtensionSetupFactory *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(IBITSExtensionSetupFactory *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *GetObject)(IBITSExtensionSetupFactory *This, BSTR Path,
...
#define IBITSExtensionSetupFactory_GetTypeInfo(This, iTInfo, lcid, ppTInfo)    \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define IBITSExtensionSetupFactory_GetIDsOfNames(This, riid, rgszNames,        \
                                                 cNames, lcid, rgDispId)       \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define IBITSExtensionSetupFactory_Invoke(This, dispIdMember, riid, lcid,      \
...
#endif
#endif
HRESULT WINAPI IBITSExtensionSetupFactory_GetObject_Proxy(
    IBITSExtensionSetupFactory *This, BSTR Path,
    IBITSExtensionSetup **ppExtensionSetup);
