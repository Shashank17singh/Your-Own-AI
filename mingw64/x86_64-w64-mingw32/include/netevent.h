...
#define EVENT_BOWSER_MAILSLOT_DATAGRAM_THRESHOLD_EXCEEDED                      \
  __MSABI_LONG(0x40001F5E)
...
#define EVENT_DNSAPI_DEREGISTRATION_FAILED_NOTSUPP_PRIMARY_DN                  \
  __MSABI_LONG(0x80002BBA)
#define EVENT_DNSAPI_DEREGISTRATION_FAILED_OTHER __MSABI_LONG(0x80002BB1)
#define EVENT_DNSAPI_DEREGISTRATION_FAILED_OTHER_PRIMARY_DN                    \
  __MSABI_LONG(0x80002BBD)
#define EVENT_DNSAPI_DEREGISTRATION_FAILED_REFUSED __MSABI_LONG(0x80002BAF)
#define EVENT_DNSAPI_DEREGISTRATION_FAILED_REFUSED_PRIMARY_DN                  \
  __MSABI_LONG(0x80002BBB)
#define EVENT_DNSAPI_DEREGISTRATION_FAILED_SECURITY __MSABI_LONG(0x80002BB0)
#define EVENT_DNSAPI_DEREGISTRATION_FAILED_SECURITY_PRIMARY_DN                 \
  __MSABI_LONG(0x80002BBC)
#define EVENT_DNSAPI_DEREGISTRATION_FAILED_SERVERFAIL __MSABI_LONG(0x80002BAD)
#define EVENT_DNSAPI_DEREGISTRATION_FAILED_SERVERFAIL_PRIMARY_DN               \
  __MSABI_LONG(0x80002BB9)
#define EVENT_DNSAPI_DEREGISTRATION_FAILED_TIMEOUT __MSABI_LONG(0x80002BAC)
#define EVENT_DNSAPI_DEREGISTRATION_FAILED_TIMEOUT_PRIMARY_DN                  \
  __MSABI_LONG(0x80002BB8)
...
#define EVENT_DNSAPI_PTR_DEREGISTRATION_FAILED_SERVERFAIL                      \
  __MSABI_LONG(0x80002BB3)
...
#define EVENT_DNSAPI_REGISTRATION_FAILED_NOTSUPP_PRIMARY_DN                    \
  __MSABI_LONG(0x80002B9C)
#define EVENT_DNSAPI_REGISTRATION_FAILED_OTHER __MSABI_LONG(0x80002B93)
#define EVENT_DNSAPI_REGISTRATION_FAILED_OTHER_PRIMARY_DN                      \
  __MSABI_LONG(0x80002B9F)
#define EVENT_DNSAPI_REGISTRATION_FAILED_REFUSED __MSABI_LONG(0x80002B91)
#define EVENT_DNSAPI_REGISTRATION_FAILED_REFUSED_PRIMARY_DN                    \
  __MSABI_LONG(0x80002B9D)
...
#define EVENT_DNSAPI_REGISTRATION_FAILED_SECURITY_PRIMARY_DN                   \
  __MSABI_LONG(0x80002B9E)
#define EVENT_DNSAPI_REGISTRATION_FAILED_SERVERFAIL __MSABI_LONG(0x80002B8F)
#define EVENT_DNSAPI_REGISTRATION_FAILED_SERVERFAIL_PRIMARY_DN                 \
  __MSABI_LONG(0x80002B9B)
#define EVENT_DNSAPI_REGISTRATION_FAILED_TIMEOUT __MSABI_LONG(0x80002B8E)
#define EVENT_DNSAPI_REGISTRATION_FAILED_TIMEOUT_PRIMARY_DN                    \
  __MSABI_LONG(0x80002B9A)
...
#define EVENT_DNS_CACHE_START_FAILURE_NO_SHUTDOWN_NOTIFY                       \
  __MSABI_LONG(0xC0002AFD)
...
#define EVENT_EQOS_ERROR_MACHINE_POLICY_KEYNAME_SIZE_ZERO                      \
  __MSABI_LONG(0xC0004142)
#define EVENT_EQOS_ERROR_MACHINE_POLICY_KEYNAME_TOO_LONG                       \
  __MSABI_LONG(0xC0004140)
#define EVENT_EQOS_ERROR_MACHINE_POLICY_REFERESH __MSABI_LONG(0xC000413C)
#define EVENT_EQOS_ERROR_OPENING_MACHINE_POLICY_ROOT_KEY                       \
  __MSABI_LONG(0xC000413E)
...
#define EVENT_EQOS_ERROR_PROCESSING_MACHINE_POLICY_FIELD                       \
  __MSABI_LONG(0xC0004146)
...
#define EVENT_EQOS_INFO_MACHINE_POLICY_REFRESH_NO_CHANGE                       \
  __MSABI_LONG(0x40004074)
#define EVENT_EQOS_INFO_MACHINE_POLICY_REFRESH_WITH_CHANGE                     \
  __MSABI_LONG(0x40004075)
#define EVENT_EQOS_INFO_TCP_AUTOTUNING_HIGHLY_RESTRICTED                       \
  __MSABI_LONG(0x4000407A)
...
#define EVENT_EQOS_WARNING_MACHINE_POLICY_NO_FULLPATH_APPNAME                  \
  __MSABI_LONG(0x800040E2)
#define EVENT_EQOS_WARNING_MACHINE_POLICY_PROFILE_NOT_SPECIFIED                \
  __MSABI_LONG(0x800040DC)
#define EVENT_EQOS_WARNING_MACHINE_POLICY_QUOTA_EXCEEDED                       \
  __MSABI_LONG(0x800040DE)
...
#define EVENT_EQOS_WARNING_USER_POLICY_NO_FULLPATH_APPNAME                     \
  __MSABI_LONG(0x800040E3)
#define EVENT_EQOS_WARNING_USER_POLICY_PROFILE_NOT_SPECIFIED                   \
  __MSABI_LONG(0x800040DD)
...
#define EVENT_FRS_CANNOT_START_BACKUP_RESTORE_IN_PROGRESS                      \
  __MSABI_LONG(0xC00034D1)
