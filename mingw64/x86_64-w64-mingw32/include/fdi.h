...
typedef enum { fdidtNEW_CABINET, fdidtNEW_FOLDER, fdidtDECRYPT } FDIDECRYPTTYPE;
typedef struct {
...
#define FNSEEK(fn)                                                             \
  __LONG32 DIAMONDAPI fn(INT_PTR hf, __LONG32 dist, int seektype)
...
typedef INT_PTR(DIAMONDAPI *PFNFDINOTIFY)(FDINOTIFICATIONTYPE fdint,
...
#define cpu80286 (0)
#define cpu80386 (1)
HFDI DIAMONDAPI FDICreate(PFNALLOC pfnalloc, PFNFREE pfnfree, PFNOPEN pfnopen,
                          PFNREAD pfnread, PFNWRITE pfnwrite, PFNCLOSE pfnclose,
                          PFNSEEK pfnseek, int cpuType, PERF perf);
WINBOOL DIAMONDAPI FDIIsCabinet(HFDI hfdi, INT_PTR hf, PFDICABINETINFO pfdici);
WINBOOL DIAMONDAPI FDICopy(HFDI hfdi, char *pszCabinet, char *pszCabPath,
                           int flags, PFNFDINOTIFY pfnfdin,
                           PFNFDIDECRYPT pfnfdid, void *pvUser);
WINBOOL DIAMONDAPI FDIDestroy(HFDI hfdi);
WINBOOL DIAMONDAPI FDITruncateCabinet(HFDI hfdi, char *pszCabinetName,
