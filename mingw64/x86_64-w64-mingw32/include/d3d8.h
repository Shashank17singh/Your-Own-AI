...
DEFINE_GUID(IID_IDirect3DResource8, 0x1B36BB7B, 0x09B7, 0x410A, 0xB4, 0x45,
            0x7D, 0x14, 0x30, 0xD7, 0xB3, 0x3F);
...
DECLARE_INTERFACE_IID_(IDirect3D8, IUnknown,
  ...
  STDMETHOD(GetAdapterDisplayMode)(THIS_ UINT Adapter, D3DDISPLAYMODE * pMode)
      PURE;
  STDMETHOD(CheckDeviceType)(THIS_ UINT Adapter, D3DDEVTYPE CheckType,
                             D3DFORMAT DisplayFormat,
                             D3DFORMAT BackBufferFormat, WINBOOL Windowed) PURE;
  ...
  STDMETHOD(CheckDeviceMultiSampleType)(
      ...
      WINBOOL Windowed, D3DMULTISAMPLE_TYPE MultiSampleType) PURE;
  ...
  STDMETHOD(CreateDevice)(
      ...
      struct IDirect3DDevice8 * *ppReturnedDeviceInterface) PURE;
};
#undef INTERFACE
...
DECLARE_INTERFACE_IID_(IDirect3DVolume8, IUnknown,
  ...
  STDMETHOD(SetPrivateData)(THIS_ REFGUID refguid, const void *data,
...
DECLARE_INTERFACE_IID_(IDirect3DSwapChain8, IUnknown,
  ...
  STDMETHOD(GetBackBuffer)(THIS_ UINT BackBuffer, D3DBACKBUFFER_TYPE Type,
                           struct IDirect3DSurface8 * *ppBackBuffer) PURE;
};
#undef INTERFACE
#if !defined(__cplusplus) || defined(CINTERFACE)
/*** IUnknown methods ***/
...
DECLARE_INTERFACE_IID_(IDirect3DSurface8, IUnknown,
...
DECLARE_INTERFACE_IID_(IDirect3DIndexBuffer8, IDirect3DResource8,
...
DECLARE_INTERFACE_IID_(IDirect3DBaseTexture8, IDirect3DResource8,
...
DECLARE_INTERFACE_IID_(IDirect3DCubeTexture8, IDirect3DBaseTexture8,
...
DECLARE_INTERFACE_IID_(IDirect3DTexture8, IDirect3DBaseTexture8,
  ...
  STDMETHOD(GetSurfaceLevel)(THIS_ UINT Level,
                             IDirect3DSurface8 * *ppSurfaceLevel) PURE;
...
DECLARE_INTERFACE_IID_(IDirect3DVolumeTexture8, IDirect3DBaseTexture8,
...
DECLARE_INTERFACE_IID_(IDirect3DDevice8, IUnknown,
  ...
  STDMETHOD_(void, SetCursorPosition)(THIS_ UINT XScreenSpace,
                                      UINT YScreenSpace, DWORD Flags) PURE;
  ...
  STDMETHOD_(void, SetGammaRamp)(THIS_ DWORD flags, const D3DGAMMARAMP *ramp)
      PURE;
  ...
  STDMETHOD(CreateTexture)(THIS_ UINT Width, UINT Height, UINT Levels,
                           ...
                           IDirect3DTexture8 * *ppTexture) PURE;
  ...
  STDMETHOD(CreateVertexBuffer)(THIS_ UINT Length, DWORD Usage, DWORD FVF,
                                D3DPOOL Pool,
                                IDirect3DVertexBuffer8 * *ppVertexBuffer) PURE;
  STDMETHOD(CreateIndexBuffer)(THIS_ UINT Length, DWORD Usage, D3DFORMAT Format,
                               D3DPOOL Pool,
  ...
  STDMETHOD(CreateImageSurface)(THIS_ UINT Width, UINT Height, D3DFORMAT Format,
                                IDirect3DSurface8 * *ppSurface) PURE;
  STDMETHOD(CopyRects)(THIS_ IDirect3DSurface8 * src_surface,
  ...
  STDMETHOD(GetDepthStencilSurface)(THIS_ IDirect3DSurface8 *
  ...
  STDMETHOD(GetInfo)(THIS_ DWORD DevInfoID, void *pDevInfoStruct,
                     DWORD DevInfoStructSize) PURE;
  ...
  STDMETHOD(DrawIndexedPrimitive)(THIS_ D3DPRIMITIVETYPE PrimitiveType,
  ...
  STDMETHOD(CreateVertexShader)(THIS_ const DWORD *declaration,
  ...
  STDMETHOD(SetVertexShaderConstant)(THIS_ DWORD reg_idx, const void *data,
                                     DWORD count) PURE;
  STDMETHOD(GetVertexShaderConstant)(THIS_ DWORD Register, void *pConstantData,
                                     DWORD ConstantCount) PURE;
  STDMETHOD(GetVertexShaderDeclaration)(THIS_ DWORD Handle, void *pData,
                                        DWORD *pSizeOfData) PURE;
  STDMETHOD(GetVertexShaderFunction)(THIS_ DWORD Handle, void *pData,
                                     DWORD *pSizeOfData) PURE;
  ...
  STDMETHOD(SetIndices)(THIS_ IDirect3DIndexBuffer8 * pIndexData,
                        UINT BaseVertexIndex) PURE;
  STDMETHOD(GetIndices)(THIS_ IDirect3DIndexBuffer8 * *ppIndexData,
                        UINT * pBaseVertexIndex) PURE;
  STDMETHOD(CreatePixelShader)(THIS_ const DWORD *byte_code, DWORD *shader)
      PURE;
  ...
  STDMETHOD(SetPixelShaderConstant)(THIS_ DWORD reg_idx, const void *data,
                                    DWORD count) PURE;
  STDMETHOD(GetPixelShaderConstant)(THIS_ DWORD Register, void *pConstantData,
                                    DWORD ConstantCount) PURE;
  STDMETHOD(GetPixelShaderFunction)(THIS_ DWORD Handle, void *pData,
                                    DWORD *pSizeOfData) PURE;
