...
PSSTDAPI InitPropVariantFromBuffer(const VOID *pv, UINT cb,
...
PSSTDAPI_(INT)
PropVariantCompareEx(REFPROPVARIANT propvar1, REFPROPVARIANT propvar2,
                     PROPVAR_COMPARE_UNIT uint, PROPVAR_COMPARE_FLAGS flags);
PSSTDAPI InitPropVariantFromFileTime(const FILETIME *pftIn,
                                     PROPVARIANT *ppropvar);
PSSTDAPI InitPropVariantFromStringVector(PCWSTR *strs, ULONG count,
                                         PROPVARIANT *ppropvar);
PSSTDAPI PropVariantToDouble(REFPROPVARIANT propvarIn, double *ret);
PSSTDAPI PropVariantToFileTime(REFPROPVARIANT propvar, PSTIME_FLAGS flags,
                               FILETIME *out);
...
PSSTDAPI PropVariantToUInt32Vector(REFPROPVARIANT propvar, ULONG *buffer,
...
PSSTDAPI_(PCWSTR)
PropVariantToStringWithDefault(REFPROPVARIANT propvarIn, LPCWSTR pszDefault);
PSSTDAPI_(PCWSTR)
VariantToStringWithDefault(const VARIANT *pvar, LPCWSTR pszDefault);
...
PSSTDAPI PropVariantGetStringElem(const PROPVARIANT *propvar, ULONG idx,
                                  WCHAR **ret);
#ifdef __cplusplus
...
inline HRESULT InitPropVariantFromUInt64(ULONGLONG ullVal,
                                         PROPVARIANT *ppropvar) {
  ppropvar->vt = VT_UI8;
...
inline HRESULT InitPropVariantFromGUIDAsBuffer(REFGUID guid,
                                               PROPVARIANT *ppropvar) {
#ifdef __cplusplus
...
PSSTDAPI StgSerializePropVariant(const PROPVARIANT *ppropvar,
                                 SERIALIZEDPROPERTYVALUE **ppprop, ULONG *pcb);
PSSTDAPI StgDeserializePropVariant(const SERIALIZEDPROPERTYVALUE *pprop,
                                   ULONG cbmax, PROPVARIANT *ppropvar);
#ifdef __cplusplus
}
#endif
