...
#define CM_NOTIFY_FILTER_VALID_FLAGS                                           \
...
typedef DWORD(CALLBACK *PCM_NOTIFY_CALLBACK)(HCMNOTIFICATION hNotify,
                                             PVOID Context,
...
#define CM_Get_Device_ID_List_Size_Ex                                          \
  __MINGW_NAME_AW(CM_Get_Device_ID_List_Size_Ex)
#define CM_Get_DevInst_Registry_Property                                       \
  __MINGW_NAME_AW(CM_Get_DevNode_Registry_Property)
#define CM_Get_DevInst_Registry_Property_Ex                                    \
  __MINGW_NAME_AW(CM_Get_DevNode_Registry_Property_Ex)
#define CM_Get_DevNode_Registry_Property                                       \
  __MINGW_NAME_AW(CM_Get_DevNode_Registry_Property)
#define CM_Get_DevNode_Registry_Property_Ex                                    \
  __MINGW_NAME_AW(CM_Get_DevNode_Registry_Property_Ex)
#define CM_Get_DevInst_Custom_Property                                         \
  __MINGW_NAME_AW(CM_Get_DevNode_Custom_Property)
#define CM_Get_DevInst_Custom_Property_Ex                                      \
  __MINGW_NAME_AW(CM_Get_DevNode_Custom_Property_Ex)
#define CM_Get_DevNode_Custom_Property                                         \
  __MINGW_NAME_AW(CM_Get_DevNode_Custom_Property)
#define CM_Get_DevNode_Custom_Property_Ex                                      \
  __MINGW_NAME_AW(CM_Get_DevNode_Custom_Property_Ex)
#define CM_Get_Hardware_Profile_Info                                           \
  __MINGW_NAME_AW(CM_Get_Hardware_Profile_Info)
#define CM_Get_Hardware_Profile_Info_Ex                                        \
  __MINGW_NAME_AW(CM_Get_Hardware_Profile_Info_Ex)
...
#define CM_Get_Device_Interface_Alias                                          \
  __MINGW_NAME_AW(CM_Get_Device_Interface_Alias)
#define CM_Get_Device_Interface_Alias_Ex                                       \
  __MINGW_NAME_AW(CM_Get_Device_Interface_Alias_Ex)
#define CM_Get_Device_Interface_List_Ex                                        \
  __MINGW_NAME_AW(CM_Get_Device_Interface_List_Ex)
#define CM_Get_Device_Interface_List_Size_Ex                                   \
  __MINGW_NAME_AW(CM_Get_Device_Interface_List_Size_Ex)
...
#define CM_Query_And_Remove_SubTree_Ex                                         \
  __MINGW_NAME_AW(CM_Query_And_Remove_SubTree_Ex)
...
#define CM_Register_Device_Interface                                           \
  __MINGW_NAME_AW(CM_Register_Device_Interface)
#define CM_Register_Device_Interface_Ex                                        \
  __MINGW_NAME_AW(CM_Register_Device_Interface_Ex)
#define CM_Unregister_Device_Interface                                         \
  __MINGW_NAME_AW(CM_Unregister_Device_Interface)
#define CM_Unregister_Device_Interface_Ex                                      \
  __MINGW_NAME_AW(CM_Unregister_Device_Interface_Ex)
#define CM_Set_DevInst_Registry_Property                                       \
  __MINGW_NAME_AW(CM_Set_DevNode_Registry_Property)
#define CM_Set_DevInst_Registry_Property_Ex                                    \
  __MINGW_NAME_AW(CM_Set_DevNode_Registry_Property_Ex)
...
#define CM_Get_Resource_Conflict_Details                                       \
  __MINGW_NAME_AW(CM_Get_Resource_Conflict_Details)
#define CM_Get_Class_Registry_Property                                         \
  __MINGW_NAME_AW(CM_Get_Class_Registry_Property)
#define CM_Set_Class_Registry_Property                                         \
  __MINGW_NAME_AW(CM_Set_Class_Registry_Property)
CMAPI CONFIGRET WINAPI CM_Add_Empty_Log_Conf(PLOG_CONF plcLogConf,
                                             DEVINST dnDevInst,
                                             PRIORITY Priority, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Add_Empty_Log_Conf_Ex(PLOG_CONF plcLogConf,
                                                DEVINST dnDevInst,
                                                PRIORITY Priority,
                                                ULONG ulFlags,
                                                HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Add_IDA(DEVINST dnDevInst, PSTR pszID, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Add_IDW(DEVINST dnDevInst, PWSTR pszID,
                                  ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Add_ID_ExA(DEVINST dnDevInst, PSTR pszID,
                                     ULONG ulFlags, HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Add_ID_ExW(DEVINST dnDevInst, PWSTR pszID,
                                     ULONG ulFlags, HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Add_Range(DWORDLONG ullStartValue,
                                    DWORDLONG ullEndValue, RANGE_LIST rlh,
                                    ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Add_Res_Des(PRES_DES prdResDes, LOG_CONF lcLogConf,
                                      RESOURCEID ResourceID,
                                      PCVOID ResourceData, ULONG ResourceLen,
                                      ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Add_Res_Des_Ex(PRES_DES prdResDes, LOG_CONF lcLogConf,
                                         RESOURCEID ResourceID,
                                         PCVOID ResourceData, ULONG ResourceLen,
                                         ULONG ulFlags, HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Connect_MachineA(PCSTR UNCServerName,
                                           PHMACHINE phMachine);
CMAPI CONFIGRET WINAPI CM_Connect_MachineW(PCWSTR UNCServerName,
                                           PHMACHINE phMachine);
CMAPI CONFIGRET WINAPI CM_Create_DevNodeA(PDEVINST pdnDevInst,
                                          DEVINSTID_A pDeviceID,
                                          DEVINST dnParent, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Create_DevNodeW(PDEVINST pdnDevInst,
...
CMAPI CONFIGRET WINAPI CM_Create_DevNode_ExA(PDEVINST pdnDevInst,
                                             ...
                                             DEVINST dnParent, ULONG ulFlags,
                                             HANDLE hMachine);
CMAPI CONFIGRET WINAPI CM_Create_DevNode_ExW(PDEVINST pdnDevInst,
                                             DEVINSTID_W pDeviceID,
                                             DEVINST dnParent, ULONG ulFlags,
                                             HANDLE hMachine);
...
CMAPI CONFIGRET WINAPI CM_Delete_Class_Key_Ex(LPGUID ClassGuid, ULONG ulFlags,
                                              HANDLE hMachine);
CMAPI CONFIGRET WINAPI CM_Delete_DevNode_Key(DEVNODE dnDevNode,
                                             ULONG ulHardwareProfile,
                                             ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Delete_DevNode_Key_Ex(DEVNODE dnDevNode,
                                                ULONG ulHardwareProfile,
...
CMAPI CONFIGRET WINAPI CM_Delete_Range(DWORDLONG ullStartValue,
                                       DWORDLONG ullEndValue, RANGE_LIST rlh,
                                       ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Detect_Resource_Conflict(
    DEVINST dnDevInst, RESOURCEID ResourceID, PCVOID ResourceData,
...
CMAPI CONFIGRET WINAPI CM_Disable_DevNode_Ex(DEVINST dnDevInst, ULONG ulFlags,
                                             HMACHINE hMachine);
...
CMAPI CONFIGRET WINAPI CM_Dup_Range_List(RANGE_LIST rlhOld, RANGE_LIST rlhNew,
                                         ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Enable_DevNode(DEVINST dnDevInst, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Enable_DevNode_Ex(DEVINST dnDevInst, ULONG ulFlags,
                                            HMACHINE hMachine);
#define CM_Enable_DevInst CM_Enable_DevNode
#define CM_Enable_DevInst_Ex CM_Enable_DevNode_Ex
CMAPI CONFIGRET WINAPI CM_Enumerate_Classes(ULONG ulClassIndex,
                                            LPGUID ClassGuid, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Enumerate_Classes_Ex(ULONG ulClassIndex,
                                               LPGUID ClassGuid, ULONG ulFlags,
                                               HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Enumerate_EnumeratorsA(ULONG ulEnumIndex,
                                                 PCHAR Buffer, PULONG pulLength,
                                                 ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Enumerate_EnumeratorsW(ULONG ulEnumIndex,
                                                 PWCHAR Buffer,
                                                 PULONG pulLength,
                                                 ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Enumerate_Enumerators_ExA(ULONG ulEnumIndex,
                                                    PCHAR Buffer,
                                                    PULONG pulLength,
                                                    ULONG ulFlags,
                                                    HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Enumerate_Enumerators_ExW(ULONG ulEnumIndex,
                                                    PWCHAR Buffer,
                                                    PULONG pulLength,
                                                    ULONG ulFlags,
                                                    HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Find_Range(PDWORDLONG pullStart, DWORDLONG ullStart,
                                     ULONG ulLength, DWORDLONG ullAlignment,
                                     DWORDLONG ullEnd, RANGE_LIST rlh,
                                     ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_First_Range(RANGE_LIST rlh, PDWORDLONG pullStart,
                                      PDWORDLONG pullEnd,
                                      PRANGE_ELEMENT preElement, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Free_Log_Conf(LOG_CONF lcLogConfToBeFreed,
                                        ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Free_Log_Conf_Ex(LOG_CONF lcLogConfToBeFreed,
                                           ULONG ulFlags, HMACHINE hMachine);
...
CMAPI CONFIGRET WINAPI CM_Free_Res_Des(PRES_DES prdResDes, RES_DES rdResDes,
                                       ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Free_Res_Des_Ex(PRES_DES prdResDes, RES_DES rdResDes,
                                          ULONG ulFlags, HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Free_Res_Des_Handle(RES_DES rdResDes);
CMAPI CONFIGRET WINAPI CM_Get_Child(PDEVINST pdnDevInst, DEVINST dnDevInst,
                                    ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Get_Child_Ex(PDEVINST pdnDevInst, DEVINST dnDevInst,
                                       ULONG ulFlags, HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Get_Class_NameA(LPGUID ClassGuid, PCHAR Buffer,
                                          PULONG pulLength, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Get_Class_NameW(LPGUID ClassGuid, PWCHAR Buffer,
                                          PULONG pulLength, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Get_Class_Name_ExA(LPGUID ClassGuid, PCHAR Buffer,
                                             PULONG pulLength, ULONG ulFlags,
                                             HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Get_Class_Name_ExW(LPGUID ClassGuid, PWCHAR Buffer,
                                             PULONG pulLength, ULONG ulFlags,
                                             HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Get_Class_Key_NameA(LPGUID ClassGuid,
                                              LPSTR pszKeyName,
                                              PULONG pulLength, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Get_Class_Key_NameW(LPGUID ClassGuid,
                                              LPWSTR pszKeyName,
                                              PULONG pulLength, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Get_Class_Key_Name_ExA(LPGUID ClassGuid,
                                                 LPSTR pszKeyName,
                                                 PULONG pulLength,
                                                 ULONG ulFlags,
                                                 HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Get_Class_Key_Name_ExW(LPGUID ClassGuid,
                                                 LPWSTR pszKeyName,
                                                 PULONG pulLength,
                                                 ULONG ulFlags,
                                                 HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Get_Depth(PULONG pulDepth, DEVINST dnDevInst,
                                    ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Get_Depth_Ex(PULONG pulDepth, DEVINST dnDevInst,
                                       ULONG ulFlags, HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Get_Device_IDA(DEVINST dnDevInst, PCHAR Buffer,
                                         ULONG BufferLen, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Get_Device_IDW(DEVINST dnDevInst, PWCHAR Buffer,
                                         ULONG BufferLen, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Get_Device_ID_ExA(DEVINST dnDevInst, PCHAR Buffer,
                                            ULONG BufferLen, ULONG ulFlags,
                                            HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Get_Device_ID_ExW(DEVINST dnDevInst, PWCHAR Buffer,
                                            ULONG BufferLen, ULONG ulFlags,
                                            HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Get_Device_ID_ListA(PCSTR pszFilter, PCHAR Buffer,
                                              ULONG BufferLen, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Get_Device_ID_ListW(PCWSTR pszFilter, PWCHAR Buffer,
                                              ULONG BufferLen, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Get_Device_ID_List_ExA(PCSTR pszFilter, PCHAR Buffer,
                                                 ULONG BufferLen, ULONG ulFlags,
                                                 HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Get_Device_ID_List_ExW(PCWSTR pszFilter,
                                                 PWCHAR Buffer, ULONG BufferLen,
                                                 ULONG ulFlags,
                                                 HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Get_Device_ID_List_SizeA(PULONG pulLen,
                                                   PCSTR pszFilter,
                                                   ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Get_Device_ID_List_SizeW(PULONG pulLen,
                                                   PCWSTR pszFilter,
                                                   ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Get_Device_ID_List_Size_ExA(PULONG pulLen,
                                                      PCSTR pszFilter,
                                                      ULONG ulFlags,
                                                      HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Get_Device_ID_List_Size_ExW(PULONG pulLen,
                                                      PCWSTR pszFilter,
                                                      ULONG ulFlags,
                                                      HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Get_Device_ID_Size(PULONG pulLen, DEVINST dnDevInst,
                                             ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Get_Device_ID_Size_Ex(PULONG pulLen,
                                                DEVINST dnDevInst,
                                                ULONG ulFlags,
                                                HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Get_DevNode_Registry_PropertyA(
    DEVINST dnDevInst, ULONG ulProperty, PULONG pulRegDataType, PVOID Buffer,
    PULONG pulLength, ULONG ulFlags);
...
CM_Get_DevNode_Property_Keys(DEVINST dnDevInst, DEVPROPKEY *PropertyKeyArray,
                             PULONG PropertyKeyCount, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Get_DevNode_Property_Keys_Ex(
    DEVINST dnDevInst, DEVPROPKEY *PropertyKeyArray, PULONG PropertyKeyCount,
    ULONG ulFlags, HMACHINE hMachine);
#endif /* (WINVER >= _WIN32_WINNT_LONGHORN) */
CMAPI CONFIGRET WINAPI CM_Get_DevNode_Status(PULONG pulStatus,
...
CMAPI CONFIGRET WINAPI CM_Get_First_Log_Conf(PLOG_CONF plcLogConf,
                                             DEVINST dnDevInst, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Get_First_Log_Conf_Ex(PLOG_CONF plcLogConf,
                                                DEVINST dnDevInst,
                                                ULONG ulFlags,
                                                HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Get_Global_State(PULONG pulState, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Get_Global_State_Ex(PULONG pulState, ULONG ulFlags,
                                              HMACHINE hMachine);
...
CMAPI CONFIGRET WINAPI
CM_Get_Hardware_Profile_Info_ExA(ULONG ulIndex, PHWPROFILEINFO_A pHWProfileInfo,
                                 ULONG ulFlags, HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Get_Hardware_Profile_InfoW(
    ULONG ulIndex, PHWPROFILEINFO_W pHWProfileInfo, ULONG ulFlags);
CMAPI CONFIGRET WINAPI
CM_Get_Hardware_Profile_Info_ExW(ULONG ulIndex, PHWPROFILEINFO_W pHWProfileInfo,
                                 ULONG ulFlags, HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Get_HW_Prof_FlagsA(DEVINSTID_A szDevInstName,
                                             ULONG ulHardwareProfile,
                                             PULONG pulValue, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Get_HW_Prof_FlagsW(DEVINSTID_W szDevInstName,
                                             ULONG ulHardwareProfile,
                                             PULONG pulValue, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Get_HW_Prof_Flags_ExA(DEVINSTID_A szDevInstName,
                                                ULONG ulHardwareProfile,
                                                PULONG pulValue, ULONG ulFlags,
                                                HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Get_HW_Prof_Flags_ExW(DEVINSTID_W szDevInstName,
                                                ULONG ulHardwareProfile,
                                                PULONG pulValue, ULONG ulFlags,
                                                HMACHINE hMachine);
...
CMAPI CONFIGRET WINAPI CM_Get_Device_Interface_Property_KeysW(
    LPCWSTR pszDeviceInterface, DEVPROPKEY *PropertyKeyArray,
    PULONG PropertyKeyCount, ULONG ulFlags);
#ifdef UNICODE
#define CM_Get_Device_Interface_Property_Keys                                  \
  CM_Get_Device_Interface_Property_KeysW
#endif
CMAPI CONFIGRET WINAPI CM_Get_Device_Interface_Property_Keys_ExW(
    LPCWSTR pszDeviceInterface, DEVPROPKEY *PropertyKeyArray,
    PULONG PropertyKeyCount, ULONG ulFlags, HMACHINE hMachine);
#ifdef UNICODE
#define CM_Get_Device_Interface_Property_Keys_Ex                               \
  CM_Get_Device_Interface_Property_Keys_ExW
#endif
#endif /* (WINVER >= _WIN32_WINNT_LONGHORN) */
CMAPI CONFIGRET WINAPI CM_Get_Log_Conf_Priority(LOG_CONF lcLogConf,
                                                PPRIORITY pPriority,
                                                ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Get_Log_Conf_Priority_Ex(LOG_CONF lcLogConf,
                                                   PPRIORITY pPriority,
                                                   ULONG ulFlags,
                                                   HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Get_Next_Log_Conf(PLOG_CONF plcLogConf,
                                            LOG_CONF lcLogConf, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Get_Next_Log_Conf_Ex(PLOG_CONF plcLogConf,
                                               LOG_CONF lcLogConf,
                                               ULONG ulFlags,
                                               HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Get_Parent(PDEVINST pdnDevInst, DEVINST dnDevInst,
                                     ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Get_Parent_Ex(PDEVINST pdnDevInst, DEVINST dnDevInst,
                                        ULONG ulFlags, HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Get_Res_Des_Data(RES_DES rdResDes, PVOID Buffer,
                                           ULONG BufferLen, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Get_Res_Des_Data_Ex(RES_DES rdResDes, PVOID Buffer,
                                              ULONG BufferLen, ULONG ulFlags,
                                              HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Get_Res_Des_Data_Size(PULONG pulSize,
                                                RES_DES rdResDes,
                                                ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Get_Res_Des_Data_Size_Ex(PULONG pulSize,
                                                   RES_DES rdResDes,
                                                   ULONG ulFlags,
                                                   HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Get_Sibling(PDEVINST pdnDevInst, DEVINST DevInst,
                                      ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Get_Sibling_Ex(PDEVINST pdnDevInst, DEVINST DevInst,
                                         ULONG ulFlags, HMACHINE hMachine);
...
CMAPI WINBOOL WINAPI CM_Is_Version_Available_Ex(WORD wVersion,
                                                HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Intersect_Range_List(RANGE_LIST rlhOld1,
                                               RANGE_LIST rlhOld2,
                                               RANGE_LIST rlhNew,
                                               ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Invert_Range_List(RANGE_LIST rlhOld,
                                            RANGE_LIST rlhNew,
                                            DWORDLONG ullMaxValue,
                                            ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Locate_DevNodeA(PDEVINST pdnDevInst,
                                          DEVINSTID_A pDeviceID, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Locate_DevNodeW(PDEVINST pdnDevInst,
                                          DEVINSTID_W pDeviceID, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Locate_DevNode_ExA(PDEVINST pdnDevInst,
                                             DEVINSTID_A pDeviceID,
                                             ULONG ulFlags, HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Locate_DevNode_ExW(PDEVINST pdnDevInst,
                                             DEVINSTID_W pDeviceID,
                                             ULONG ulFlags, HMACHINE hMachine);
...
CMAPI CONFIGRET WINAPI CM_Merge_Range_List(RANGE_LIST rlhOld1,
                                           RANGE_LIST rlhOld2,
                                           RANGE_LIST rlhNew, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Modify_Res_Des(PRES_DES prdResDes, RES_DES rdResDes,
                                         RESOURCEID ResourceID,
                                         PCVOID ResourceData, ULONG ResourceLen,
                                         ULONG ulFlags);
...
CMAPI CONFIGRET WINAPI CM_Move_DevNode(DEVINST dnFromDevInst,
                                       DEVINST dnToDevInst, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Move_DevNode_Ex(DEVINST dnFromDevInst,
                                          DEVINST dnToDevInst, ULONG ulFlags,
                                          HMACHINE hMachine);
#define CM_Move_DevInst CM_Move_DevNode
#define CM_Move_DevInst_Ex CM_Move_DevNode_Ex
CMAPI CONFIGRET WINAPI CM_Next_Range(PRANGE_ELEMENT preElement,
                                     PDWORDLONG pullStart, PDWORDLONG pullEnd,
                                     ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Get_Next_Res_Des(PRES_DES prdResDes, RES_DES rdResDes,
                                           RESOURCEID ForResource,
                                           PRESOURCEID pResourceID,
                                           ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Get_Next_Res_Des_Ex(PRES_DES prdResDes,
                                              RES_DES rdResDes,
                                              RESOURCEID ForResource,
                                              PRESOURCEID pResourceID,
                                              ULONG ulFlags, HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Open_Class_KeyA(LPGUID ClassGuid, LPCSTR pszClassName,
                                          REGSAM samDesired,
                                          REGDISPOSITION Disposition,
                                          PHKEY phkClass, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Open_Class_KeyW(LPGUID ClassGuid,
                                          LPCWSTR pszClassName,
                                          REGSAM samDesired,
                                          REGDISPOSITION Disposition,
                                          PHKEY phkClass, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Open_Class_Key_ExA(LPGUID pszClassGuid,
                                             LPCSTR pszClassName,
                                             REGSAM samDesired,
                                             REGDISPOSITION Disposition,
                                             PHKEY phkClass, ULONG ulFlags,
                                             HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Open_Class_Key_ExW(LPGUID pszClassGuid,
                                             LPCWSTR pszClassName,
                                             REGSAM samDesired,
                                             REGDISPOSITION Disposition,
                                             PHKEY phkClass, ULONG ulFlags,
                                             HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Open_DevNode_Key(DEVINST dnDevNode, REGSAM samDesired,
                                           ULONG ulHardwareProfile,
                                           REGDISPOSITION Disposition,
                                           PHKEY phkDevice, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Open_DevNode_Key_Ex(DEVINST dnDevNode,
                                              REGSAM samDesired,
                                              ULONG ulHardwareProfile,
                                              REGDISPOSITION Disposition,
                                              PHKEY phkDevice, ULONG ulFlags,
...
#if (WINVER >= _WIN32_WINNT_LONGHORN)
CMAPI CONFIGRET WINAPI CM_Open_Device_Interface_KeyA(LPCSTR pszDeviceInterface,
                                                     REGSAM samDesired,
                                                     REGDISPOSITION Disposition,
                                                     PHKEY phkDeviceInterface,
                                                     ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Open_Device_Interface_KeyW(LPCWSTR pszDeviceInterface,
                                                     REGSAM samDesired,
                                                     REGDISPOSITION Disposition,
                                                     PHKEY phkDeviceInterface,
                                                     ULONG ulFlags);
#define CM_Open_Device_Interface_Key                                           \
  __MINGW_NAME_AW(CM_Open_Device_Interface_Key)
CMAPI CONFIGRET WINAPI CM_Open_Device_Interface_Key_ExA(
    LPCSTR pszDeviceInterface, REGSAM samDesired, REGDISPOSITION Disposition,
    PHKEY phkDeviceInterface, ULONG ulFlags, HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Open_Device_Interface_Key_ExW(
    LPCWSTR pszDeviceInterface, REGSAM samDesired, REGDISPOSITION Disposition,
    PHKEY phkDeviceInterface, ULONG ulFlags, HMACHINE hMachine);
#define CM_Open_Device_Interface_Key_Ex                                        \
  __MINGW_NAME_AW(CM_Open_Device_Interface_Key_Ex)
CMAPI CONFIGRET WINAPI
...
#define CM_Delete_Device_Interface_Key                                         \
...
#define CM_Delete_Device_Interface_Key_Ex                                      \
  __MINGW_NAME_AW(CM_Delete_Device_Interface_Key_Ex)
#endif /* (WINVER >= _WIN32_WINNT_LONGHORN) */
CMAPI CONFIGRET WINAPI CM_Query_Arbitrator_Free_Data(PVOID pData, ULONG DataLen,
                                                     DEVINST dnDevInst,
                                                     RESOURCEID ResourceID,
                                                     ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Query_Arbitrator_Free_Data_Ex(
    ...
    ULONG ulFlags, HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Query_Arbitrator_Free_Size(PULONG pulSize,
                                                     DEVINST dnDevInst,
                                                     RESOURCEID ResourceID,
                                                     ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Query_Arbitrator_Free_Size_Ex(PULONG pulSize,
                                                        DEVINST dnDevInst,
                                                        RESOURCEID ResourceID,
                                                        ULONG ulFlags,
                                                        HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Query_Remove_SubTree(DEVINST dnAncestor,
                                               ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Query_Remove_SubTree_Ex(DEVINST dnAncestor,
                                                  ULONG ulFlags,
                                                  HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Query_And_Remove_SubTreeA(DEVINST dnAncestor,
...
CMAPI CONFIGRET WINAPI CM_Query_And_Remove_SubTreeW(DEVINST dnAncestor,
                                                    PPNP_VETO_TYPE pVetoType,
                                                    LPWSTR pszVetoName,
                                                    ULONG ulNameLength,
                                                    ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Query_And_Remove_SubTree_ExW(
    ...
    ULONG ulNameLength, ULONG ulFlags, HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Request_Device_EjectA(DEVINST dnDevInst,
                                                PPNP_VETO_TYPE pVetoType,
                                                LPSTR pszVetoName,
                                                ULONG ulNameLength,
                                                ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Request_Device_Eject_ExA(
    ...
    ULONG ulNameLength, ULONG ulFlags, HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Request_Device_EjectW(DEVINST dnDevInst,
                                                PPNP_VETO_TYPE pVetoType,
                                                LPWSTR pszVetoName,
                                                ULONG ulNameLength,
                                                ULONG ulFlags);
...
CMAPI CONFIGRET WINAPI CM_Reenumerate_DevNode_Ex(DEVINST dnDevInst,
                                                 ULONG ulFlags,
                                                 HMACHINE hMachine);
...
CMAPI CONFIGRET WINAPI CM_Register_Device_Interface_ExW(
    ...
    LPWSTR pszDeviceInterface, PULONG pulLength, ULONG ulFlags,
    HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Set_DevNode_Problem_Ex(DEVINST dnDevInst,
                                                 ULONG ulProblem, ULONG ulFlags,
                                                 HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Set_DevNode_Problem(DEVINST dnDevInst,
                                              ULONG ulProblem, ULONG ulFlags);
...
CMAPI CONFIGRET WINAPI CM_Unregister_Device_Interface_ExW(
    LPCWSTR pszDeviceInterface, ULONG ulFlags, HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Register_Device_Driver(DEVINST dnDevInst,
                                                 ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Register_Device_Driver_Ex(DEVINST dnDevInst,
                                                    ULONG ulFlags,
                                                    HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Remove_SubTree(DEVINST dnAncestor, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Remove_SubTree_Ex(DEVINST dnAncestor, ULONG ulFlags,
                                            HMACHINE hMachine);
#if (WINVER >= _WIN32_WINNT_LONGHORN)
CMAPI CONFIGRET WINAPI CM_Set_DevNode_PropertyW(
    DEVINST dnDevInst, const DEVPROPKEY *PropertyKey, DEVPROPTYPE PropertyType,
    const PBYTE PropertyBuffer, ULONG PropertyBufferSize, ULONG ulFlags);
#ifdef UNICODE
...
#endif
#endif /* (WINVER >= _WIN32_WINNT_LONGHORN) */
CMAPI CONFIGRET WINAPI CM_Set_DevNode_Registry_PropertyA(DEVINST dnDevInst,
                                                         ULONG ulProperty,
                                                         PCVOID Buffer,
                                                         ULONG ulLength,
                                                         ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Set_DevNode_Registry_PropertyW(DEVINST dnDevInst,
                                                         ULONG ulProperty,
                                                         PCVOID Buffer,
                                                         ULONG ulLength,
                                                         ULONG ulFlags);
...
CMAPI CONFIGRET WINAPI CM_Set_Device_Interface_PropertyW(
    LPCWSTR pszDeviceInterface, const DEVPROPKEY *PropertyKey,
    DEVPROPTYPE PropertyType, const PBYTE PropertyBuffer,
...
CMAPI CONFIGRET WINAPI CM_Set_Device_Interface_Property_ExW(
    LPCWSTR pszDeviceInterface, const DEVPROPKEY *PropertyKey,
    DEVPROPTYPE PropertyType, const PBYTE PropertyBuffer,
    ULONG PropertyBufferSize, ULONG ulFlags, HMACHINE hMachine);
#ifdef UNICODE
...
CMAPI CONFIGRET WINAPI CM_Set_HW_Prof_FlagsA(DEVINSTID_A szDevInstName,
                                             ULONG ulConfig, ULONG ulValue,
                                             ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Set_HW_Prof_FlagsW(DEVINSTID_W szDevInstName,
                                             ULONG ulConfig, ULONG ulValue,
                                             ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Set_HW_Prof_Flags_ExA(DEVINSTID_A szDevInstName,
                                                ULONG ulConfig, ULONG ulValue,
                                                ULONG ulFlags,
                                                HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Set_HW_Prof_Flags_ExW(DEVINSTID_W szDevInstName,
                                                ULONG ulConfig, ULONG ulValue,
                                                ULONG ulFlags,
                                                HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Setup_DevNode(DEVINST dnDevInst, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Setup_DevNode_Ex(DEVINST dnDevInst, ULONG ulFlags,
                                           HMACHINE hMachine);
#define CM_Setup_DevInst CM_Setup_DevNode
#define CM_Setup_DevInst_Ex CM_Setup_DevNode_Ex
CMAPI CONFIGRET WINAPI CM_Test_Range_Available(DWORDLONG ullStartValue,
                                               DWORDLONG ullEndValue,
                                               RANGE_LIST rlh, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Uninstall_DevNode(DEVNODE dnPhantom, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Uninstall_DevNode_Ex(DEVNODE dnPhantom, ULONG ulFlags,
                                               HANDLE hMachine);
...
CONFIGRET CM_Write_UserPowerKey(const GUID *SchemeGuid,
                                const GUID *SubGroupOfPowerSettingsGuid,
                                const GUID *PowerSettingGuid, ULONG AccessFlags,
                                ULONG Type, UCHAR *Buffer, DWORD BufferSize,
                                PDWORD Error);
...
CONFIGRET CM_Duplicate_PowerScheme(const GUID *SourceSchemeGuid,
                                   GUID **DestinationSchemeGuid, PDWORD Error);
CONFIGRET CM_Delete_PowerScheme(const GUID *SchemeGuid, PDWORD Error);
CONFIGRET CM_Import_PowerScheme(LPCWSTR ImportFileNamePath,
                                GUID **DestinationSchemeGuid, PDWORD Error);
#endif /* (WINVER >= _WIN32_WINNT_LONGHORN) */
CMAPI CONFIGRET WINAPI CM_Set_HW_Prof(ULONG ulHardwareProfile, ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Set_HW_Prof_Ex(ULONG ulHardwareProfile, ULONG ulFlags,
                                         HMACHINE hMachine);
CMAPI CONFIGRET WINAPI CM_Query_Resource_Conflict_List(
    PCONFLICT_LIST pclConflictList, DEVINST dnDevInst, RESOURCEID ResourceID,
    PCVOID ResourceData, ULONG ResourceLen, ULONG ulFlags, HMACHINE hMachine);
CMAPI CONFIGRET WINAPI
...
CMAPI CONFIGRET WINAPI
CM_Get_Resource_Conflict_DetailsA(CONFLICT_LIST clConflictList, ULONG ulIndex,
                                  PCONFLICT_DETAILS_A pConflictDetails);
CMAPI CONFIGRET WINAPI
CM_Get_Resource_Conflict_DetailsW(CONFLICT_LIST clConflictList, ULONG ulIndex,
                                  PCONFLICT_DETAILS_W pConflictDetails);
#if (WINVER >= _WIN32_WINNT_LONGHORN)
CMAPI CONFIGRET WINAPI CM_Get_Class_PropertyW(
    LPCGUID ClassGUID, const DEVPROPKEY *PropertyKey, DEVPROPTYPE *PropertyType,
    PBYTE PropertyBuffer, PULONG PropertyBufferSize, ULONG ulFlags);
#ifdef UNICODE
...
#endif
CMAPI CONFIGRET WINAPI CM_Get_Class_Property_Keys(LPCGUID ClassGUID,
                                                  DEVPROPKEY *PropertyKeyArray,
                                                  PULONG PropertyKeyCount,
                                                  ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Get_Class_Property_Keys_Ex(
    LPCGUID ClassGUID, DEVPROPKEY *PropertyKeyArray, PULONG PropertyKeyCount,
    ULONG ulFlags, HMACHINE hMachine);
...
CMAPI CONFIGRET WINAPI CM_Get_Class_Registry_PropertyW(
    LPGUID ClassGUID, ULONG ulProperty, PULONG pulRegDataType, PVOID Buffer,
    PULONG pulLength, ULONG ulFlags, HMACHINE hMachine);
...
#define CM_Get_Device_Interface_List                                           \
  __MINGW_NAME_AW(CM_Get_Device_Interface_List)
#define CM_Get_Device_Interface_List_Size                                      \
  __MINGW_NAME_AW(CM_Get_Device_Interface_List_Size)
CMAPI CONFIGRET WINAPI CM_Get_Device_Interface_ListA(LPGUID InterfaceClassGuid,
                                                     DEVINSTID_A pDeviceID,
                                                     PCHAR Buffer,
                                                     ULONG BufferLen,
                                                     ULONG ulFlags);
CMAPI CONFIGRET WINAPI CM_Get_Device_Interface_ListW(LPGUID InterfaceClassGuid,
                                                     DEVINSTID_W pDeviceID,
                                                     PWCHAR Buffer,
                                                     ULONG BufferLen,
                                                     ULONG ulFlags);
CMAPI CONFIGRET WINAPI
CM_Get_Device_Interface_List_SizeA(PULONG pulLen, LPGUID InterfaceClassGuid,
                                   DEVINSTID_A pDeviceID, ULONG ulFlags);
CMAPI CONFIGRET WINAPI
CM_Get_Device_Interface_List_SizeW(PULONG pulLen, LPGUID InterfaceClassGuid,
                                   DEVINSTID_W pDeviceID, ULONG ulFlags);
#endif
#ifdef __cplusplus
}
