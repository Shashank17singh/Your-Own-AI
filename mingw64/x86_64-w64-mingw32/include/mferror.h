...
#define MF_E_SOURCERESOLVER_MUTUALLY_EXCLUSIVE_FLAGS                           \
...
#define MF_E_OPERATION_UNSUPPORTED_AT_D3D_FEATURE_LEVEL                        \
  _HRESULT_TYPEDEF_(0xc00d3708)
#define MF_E_UNSUPPORTED_MEDIATYPE_AT_D3D_FEATURE_LEVEL                        \
  _HRESULT_TYPEDEF_(0xc00d3709)
...
#define MF_E_TRANSFORM_PROPERTY_ARRAY_VALUE_WRONG_NUM_DIM                      \
...
#define MF_E_TRANSFORM_NOT_POSSIBLE_FOR_CURRENT_OUTPUT_MEDIATYPE               \
  _HRESULT_TYPEDEF_(0xc00d6d6d)
#define MF_E_TRANSFORM_NOT_POSSIBLE_FOR_CURRENT_INPUT_MEDIATYPE                \
  _HRESULT_TYPEDEF_(0xc00d6d6e)
#define MF_E_TRANSFORM_NOT_POSSIBLE_FOR_CURRENT_MEDIATYPE_COMBINATION          \
  _HRESULT_TYPEDEF_(0xc00d6d6f)
#define MF_E_TRANSFORM_CONFLICTS_WITH_OTHER_CURRENTLY_ENABLED_FEATURES         \
...
#define MF_E_TRANSFORM_CANNOT_CHANGE_MEDIATYPE_WHILE_PROCESSING                \
...
#define MF_E_LICENSE_RESTORE_NEEDS_INDIVIDUALIZATION                           \
...
#define MF_E_WMDRMOTA_DRM_ENCRYPTION_SCHEME_NOT_SUPPORTED                      \
...
#define MF_S_VIDEO_DISABLED_WITH_UNKNOWN_SOFTWARE_OUTPUT                       \
...
#define MF_E_HIGH_SECURITY_LEVEL_CONTENT_NOT_ALLOWED                           \
...
#define MF_E_ITA_UNRECOGNIZED_ANALOG_VIDEO_PROTECTION_GUID                     \
...
#define MF_E_RESOLUTION_REQUIRES_PMP_CREATION_CALLBACK                         \
...
#define MF_E_CLOCK_AUDIO_DEVICE_POSITION_UNEXPECTED                            \
  _HRESULT_TYPEDEF_(0x000d9c45)
#define MF_E_CLOCK_AUDIO_RENDER_POSITION_UNEXPECTED                            \
  _HRESULT_TYPEDEF_(0x000d9c46)
...
#define MF_E_CAPTURE_SOURCE_NO_INDEPENDENT_PHOTO_STREAM_PRESENT                \
  _HRESULT_TYPEDEF_(0xc00dabe6)
#define MF_E_CAPTURE_SOURCE_NO_VIDEO_STREAM_PRESENT                            \
  _HRESULT_TYPEDEF_(0xc00dabe7)
#define MF_E_CAPTURE_SOURCE_NO_AUDIO_STREAM_PRESENT                            \
  _HRESULT_TYPEDEF_(0xc00dabe8)
#define MF_E_CAPTURE_SOURCE_DEVICE_EXTENDEDPROP_OP_IN_PROGRESS                 \
...
#define MF_E_HW_ACCELERATED_THUMBNAIL_NOT_SUPPORTED                            \
  _HRESULT_TYPEDEF_(0xc00dabec)
#define MF_E_UNSUPPORTED_CAPTURE_DEVICE_PRESENT _HRESULT_TYPEDEF_(0xc00dabed)
#define MF_E_TIMELINECONTROLLER_UNSUPPORTED_SOURCE_TYPE                        \
...
#define MF_E_MEDIA_EXTENSION_APPSERVICE_CONNECTION_FAILED                      \
  _HRESULT_TYPEDEF_(0xc00db3b0)
#define MF_E_MEDIA_EXTENSION_APPSERVICE_REQUEST_FAILED                         \
  _HRESULT_TYPEDEF_(0xc00db3b1)
#define MF_E_MEDIA_EXTENSION_PACKAGE_INTEGRITY_CHECK_FAILED                    \
  _HRESULT_TYPEDEF_(0xc00db3b2)
#define MF_E_MEDIA_EXTENSION_PACKAGE_LICENSE_INVALID                           \
