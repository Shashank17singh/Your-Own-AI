...
typedef struct _ADOCollectionVtbl {
  BEGIN_INTERFACE HRESULT(STDMETHODCALLTYPE *QueryInterface)(
      _ADOADOCollection *This, REFIID riid, _COM_Outptr_ void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(_ADOADOCollection *This);
  ULONG(STDMETHODCALLTYPE *Release)(_ADOADOCollection *This);
  HRESULT(STDMETHODCALLTYPE *GetTypeInfoCount)(_ADOADOCollection *This,
                                               UINT *pctinfo);
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(_ADOADOCollection *This, UINT iTInfo,
                                          LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(_ADOADOCollection *This,
                                            REFIID riid, LPOLESTR *rgszNames,
                                            UINT cNames, LCID lcid,
                                            DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(_ADOADOCollection *This,
  ...
  HRESULT(STDMETHODCALLTYPE *_NewEnum)(_ADOADOCollection *This,
                                       IUnknown **ppvObject);
...
typedef struct _ADODynaCollectionVtbl {
  BEGIN_INTERFACE HRESULT(STDMETHODCALLTYPE *QueryInterface)(
      _ADODynaADOCollection *This, REFIID riid, _COM_Outptr_ void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(_ADODynaADOCollection *This);
  ULONG(STDMETHODCALLTYPE *Release)(_ADODynaADOCollection *This);
  HRESULT(STDMETHODCALLTYPE *GetTypeInfoCount)(_ADODynaADOCollection *This,
                                               UINT *pctinfo);
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(_ADODynaADOCollection *This,
                                          UINT iTInfo, LCID lcid,
                                          ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(_ADODynaADOCollection *This,
                                            REFIID riid, LPOLESTR *rgszNames,
                                            UINT cNames, LCID lcid,
                                            DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(_ADODynaADOCollection *This,
                                     DISPID dispIdMember, REFIID riid,
                                     LCID lcid, WORD wFlags,
                                     DISPPARAMS *pDispParams,
                                     VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
  ...
  HRESULT(STDMETHODCALLTYPE *_NewEnum)(_ADODynaADOCollection *This,
                                       IUnknown **ppvObject);
  HRESULT(STDMETHODCALLTYPE *Refresh)(_ADODynaADOCollection *This);
  HRESULT(STDMETHODCALLTYPE *Append)(_ADODynaADOCollection *This,
                                     IDispatch *Object);
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE putref_ActiveConnection(IDispatch *
                                                            pCon) = 0;
  virtual HRESULT STDMETHODCALLTYPE get_Procedures(ADOProcedures *
                                                   *ppvObject) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE Create(BSTR ConnectString,
                                           VARIANT * Connection) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetObjectOwner(
      BSTR ObjectName, ObjectTypeEnum ObjectType, VARIANT ObjectTypeId,
      BSTR * OwnerName) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetObjectOwner(
      BSTR ObjectName, ObjectTypeEnum ObjectType, BSTR UserName,
      VARIANT ObjectTypeId) = 0;
};
#else
typedef struct _CatalogVtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(_ADOCatalog *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(_ADOCatalog *This);
  ULONG(STDMETHODCALLTYPE *Release)(_ADOCatalog *This);
  HRESULT(STDMETHODCALLTYPE *GetTypeInfoCount)(_ADOCatalog *This,
                                               UINT *pctinfo);
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(_ADOCatalog *This, UINT iTInfo,
                                          LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(_ADOCatalog *This, REFIID riid,
                                            LPOLESTR *rgszNames, UINT cNames,
                                            LCID lcid, DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(_ADOCatalog *This, DISPID dispIdMember,
                                     REFIID riid, LCID lcid, WORD wFlags,
                                     DISPPARAMS *pDispParams,
                                     VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                                     UINT *puArgErr);
  HRESULT(STDMETHODCALLTYPE *get_Tables)(_ADOCatalog *This,
                                         ADOTables **ppvObject);
  HRESULT(STDMETHODCALLTYPE *get_ActiveConnection)(_ADOCatalog *This,
                                                   VARIANT *pVal);
  HRESULT(STDMETHODCALLTYPE *put_ActiveConnection)(_ADOCatalog *This,
                                                   VARIANT newVal);
  HRESULT(STDMETHODCALLTYPE *putref_ActiveConnection)(_ADOCatalog *This,
                                                      IDispatch *pCon);
  HRESULT(STDMETHODCALLTYPE *get_Procedures)(_ADOCatalog *This,
                                             ADOProcedures **ppvObject);
  HRESULT(STDMETHODCALLTYPE *get_Views)(_ADOCatalog *This,
                                        ADOViews **ppvObject);
  HRESULT(STDMETHODCALLTYPE *get_Groups)(_ADOCatalog *This,
                                         ADOGroups **ppvObject);
  HRESULT(STDMETHODCALLTYPE *get_Users)(_ADOCatalog *This,
                                        ADOUsers **ppvObject);
  HRESULT(STDMETHODCALLTYPE *Create)(_ADOCatalog *This, BSTR ConnectString,
                                     VARIANT *Connection);
  HRESULT(STDMETHODCALLTYPE *GetObjectOwner)(_ADOCatalog *This, BSTR ObjectName,
                                             ObjectTypeEnum ObjectType,
                                             VARIANT ObjectTypeId,
                                             BSTR *OwnerName);
  HRESULT(STDMETHODCALLTYPE *SetObjectOwner)(_ADOCatalog *This, BSTR ObjectName,
                                             ObjectTypeEnum ObjectType,
                                             BSTR UserName,
                                             VARIANT ObjectTypeId);
  END_INTERFACE
} _CatalogVtbl;
interface _Catalog { CONST_VTBL struct _CatalogVtbl *lpVtbl; };
#ifdef COBJMACROS
...
#define _Catalog_GetObjectOwner(This, ObjectName, ObjectType, ObjectTypeId,    \
                                OwnerName)                                     \
  ((This)->lpVtbl->GetObjectOwner(This, ObjectName, ObjectType, ObjectTypeId,  \
                                  OwnerName))
#define _Catalog_SetObjectOwner(This, ObjectName, ObjectType, UserName,        \
                                ObjectTypeId)                                  \
  ((This)->lpVtbl->SetObjectOwner(This, ObjectName, ObjectType, UserName,      \
                                  ObjectTypeId))
#endif
#endif
#endif
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE get_ParentCatalog(_ADOCatalog *
                                                      *ppvObject) = 0;
  virtual HRESULT STDMETHODCALLTYPE put_ParentCatalog(_ADOCatalog *
                                                      ppvObject) = 0;
  virtual HRESULT STDMETHODCALLTYPE putref_ParentCatalog(_ADOCatalog *
                                                         ppvObject) = 0;
};
#else
typedef struct _TableVtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(_ADOTable *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(_ADOTable *This, UINT iTInfo,
                                          LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(_ADOTable *This, REFIID riid,
                                            LPOLESTR *rgszNames, UINT cNames,
                                            LCID lcid, DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(_ADOTable *This, DISPID dispIdMember,
                                     REFIID riid, LCID lcid, WORD wFlags,
                                     DISPPARAMS *pDispParams,
                                     VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                                     UINT *puArgErr);
  HRESULT(STDMETHODCALLTYPE *get_Columns)(_ADOTable *This,
  ...
  HRESULT(STDMETHODCALLTYPE *get_Indexes)(_ADOTable *This,
                                          ADOIndexes **ppvObject);
  HRESULT(STDMETHODCALLTYPE *get_Keys)(_ADOTable *This, ADOKeys **ppvObject);
  HRESULT(STDMETHODCALLTYPE *get_Properties)(_ADOTable *This,
  ...
  HRESULT(STDMETHODCALLTYPE *get_ParentCatalog)(_ADOTable *This,
                                                _ADOCatalog **ppvObject);
  HRESULT(STDMETHODCALLTYPE *put_ParentCatalog)(_ADOTable *This,
                                                _ADOCatalog *ppvObject);
  HRESULT(STDMETHODCALLTYPE *putref_ParentADOCatalog)(_ADOTable *This,
                                                      _ADOCatalog *ppvObject);
  END_INTERFACE
} _TableVtbl;
interface _Table { CONST_VTBL struct _TableVtbl *lpVtbl; };
#ifdef COBJMACROS
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetPermissions(
      VARIANT Name, ObjectTypeEnum ObjectType, VARIANT ObjectTypeId,
      RightsEnum * Rights) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetPermissions(
      VARIANT Name, ObjectTypeEnum ObjectType, ActionEnum Action,
      RightsEnum Rights, InheritTypeEnum Inherit, VARIANT ObjectTypeId) = 0;
  virtual HRESULT STDMETHODCALLTYPE get_Users(ADOUsers * *ppvObject) = 0;
};
#else
typedef struct _Group25Vtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(_Group25 *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(_Group25 *This, UINT iTInfo,
                                          LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(_Group25 *This, REFIID riid,
                                            LPOLESTR *rgszNames, UINT cNames,
                                            LCID lcid, DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(_Group25 *This, DISPID dispIdMember,
                                     REFIID riid, LCID lcid, WORD wFlags,
                                     DISPPARAMS *pDispParams,
                                     VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                                     UINT *puArgErr);
  ...
  HRESULT(STDMETHODCALLTYPE *GetPermissions)(_Group25 *This, VARIANT Name,
                                             ObjectTypeEnum ObjectType,
                                             VARIANT ObjectTypeId,
                                             RightsEnum *Rights);
  HRESULT(STDMETHODCALLTYPE *SetPermissions)(_Group25 *This, VARIANT Name,
                                             ObjectTypeEnum ObjectType,
                                             ActionEnum Action,
                                             RightsEnum Rights,
...
interface _Group25 { CONST_VTBL struct _Group25Vtbl *lpVtbl; };
#ifdef COBJMACROS
...
#define _Group25_SetPermissions(This, Name, ObjectType, Action, Rights,        \
                                Inherit, ObjectTypeId)                         \
  ((This)->lpVtbl->SetPermissions(This, Name, ObjectType, Action, Rights,      \
                                  Inherit, ObjectTypeId))
...
typedef struct _GroupVtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(_ADOGroup *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(_ADOGroup *This, UINT iTInfo,
                                          LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(_ADOGroup *This, REFIID riid,
                                            LPOLESTR *rgszNames, UINT cNames,
                                            LCID lcid, DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(_ADOGroup *This, DISPID dispIdMember,
                                     REFIID riid, LCID lcid, WORD wFlags,
                                     DISPPARAMS *pDispParams,
                                     VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                                     UINT *puArgErr);
  ...
  HRESULT(STDMETHODCALLTYPE *GetPermissions)(_ADOGroup *This, VARIANT Name,
                                             ObjectTypeEnum ObjectType,
                                             VARIANT ObjectTypeId,
                                             RightsEnum *Rights);
  HRESULT(STDMETHODCALLTYPE *SetPermissions)(_ADOGroup *This, VARIANT Name,
                                             ObjectTypeEnum ObjectType,
                                             ActionEnum Action,
                                             RightsEnum Rights,
                                             InheritTypeEnum Inherit,
  ...
  HRESULT(STDMETHODCALLTYPE *get_Properties)(_ADOGroup *This,
                                             ADOProperties **ppvObject);
  HRESULT(STDMETHODCALLTYPE *get_ParentCatalog)(_ADOGroup *This,
                                                _ADOCatalog **ppvObject);
  HRESULT(STDMETHODCALLTYPE *put_ParentCatalog)(_ADOGroup *This,
                                                _ADOCatalog *ppvObject);
  HRESULT(STDMETHODCALLTYPE *putref_ParentADOCatalog)(_ADOGroup *This,
                                                      _ADOCatalog *ppvObject);
  END_INTERFACE
} _GroupVtbl;
interface _Group { CONST_VTBL struct _GroupVtbl *lpVtbl; };
#ifdef COBJMACROS
...
#define _Group_GetPermissions(This, Name, ObjectType, ObjectTypeId, Rights)    \
  ((This)->lpVtbl->GetPermissions(This, Name, ObjectType, ObjectTypeId, Rights))
#define _Group_SetPermissions(This, Name, ObjectType, Action, Rights, Inherit, \
                              ObjectTypeId)                                    \
  ((This)->lpVtbl->SetPermissions(This, Name, ObjectType, Action, Rights,      \
                                  Inherit, ObjectTypeId))
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE SetPermissions(
      VARIANT Name, ObjectTypeEnum ObjectType, ActionEnum Action,
      RightsEnum Rights, InheritTypeEnum Inherit, VARIANT ObjectTypeId) = 0;
  virtual HRESULT STDMETHODCALLTYPE ChangePassword(BSTR OldPassword,
                                                   BSTR NewPassword) = 0;
  virtual HRESULT STDMETHODCALLTYPE get_Groups(ADOGroups * *ppvObject) = 0;
};
#else
typedef struct _User25Vtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(_User25 *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(_User25 *This, UINT iTInfo, LCID lcid,
                                          ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(_User25 *This, REFIID riid,
                                            LPOLESTR *rgszNames, UINT cNames,
                                            LCID lcid, DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(_User25 *This, DISPID dispIdMember,
                                     REFIID riid, LCID lcid, WORD wFlags,
                                     DISPPARAMS *pDispParams,
                                     VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                                     UINT *puArgErr);
  ...
  HRESULT(STDMETHODCALLTYPE *GetPermissions)(_User25 *This, VARIANT Name,
                                             ObjectTypeEnum ObjectType,
                                             VARIANT ObjectTypeId,
                                             RightsEnum *Rights);
  HRESULT(STDMETHODCALLTYPE *SetPermissions)(
      _User25 *This, VARIANT Name, ObjectTypeEnum ObjectType, ActionEnum Action,
      RightsEnum Rights, InheritTypeEnum Inherit, VARIANT ObjectTypeId);
  HRESULT(STDMETHODCALLTYPE *ChangePassword)(_User25 *This, BSTR OldPassword,
                                             BSTR NewPassword);
  HRESULT(STDMETHODCALLTYPE *get_Groups)(_User25 *This, ADOGroups **ppvObject);
  END_INTERFACE
} _User25Vtbl;
interface _User25 { CONST_VTBL struct _User25Vtbl *lpVtbl; };
#ifdef COBJMACROS
...
#define _User25_GetPermissions(This, Name, ObjectType, ObjectTypeId, Rights)   \
  ((This)->lpVtbl->GetPermissions(This, Name, ObjectType, ObjectTypeId, Rights))
#define _User25_SetPermissions(This, Name, ObjectType, Action, Rights,         \
                               Inherit, ObjectTypeId)                          \
  ((This)->lpVtbl->SetPermissions(This, Name, ObjectType, Action, Rights,      \
                                  Inherit, ObjectTypeId))
...
typedef struct _UserVtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(_ADOUser *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(_ADOUser *This, UINT iTInfo,
                                          LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(_ADOUser *This, REFIID riid,
                                            LPOLESTR *rgszNames, UINT cNames,
                                            LCID lcid, DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(_ADOUser *This, DISPID dispIdMember,
                                     REFIID riid, LCID lcid, WORD wFlags,
                                     DISPPARAMS *pDispParams,
                                     VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                                     UINT *puArgErr);
  ...
  HRESULT(STDMETHODCALLTYPE *GetPermissions)(_ADOUser *This, VARIANT Name,
                                             ObjectTypeEnum ObjectType,
                                             VARIANT ObjectTypeId,
                                             RightsEnum *Rights);
  HRESULT(STDMETHODCALLTYPE *SetPermissions)(_ADOUser *This, VARIANT Name,
                                             ObjectTypeEnum ObjectType,
                                             ActionEnum Action,
                                             RightsEnum Rights,
                                             InheritTypeEnum Inherit,
                                             VARIANT ObjectTypeId);
  HRESULT(STDMETHODCALLTYPE *ChangePassword)(_ADOUser *This, BSTR OldPassword,
                                             BSTR NewPassword);
  HRESULT(STDMETHODCALLTYPE *get_Groups)(_ADOUser *This, ADOGroups **ppvObject);
  HRESULT(STDMETHODCALLTYPE *get_Properties)(_ADOUser *This,
                                             ADOProperties **ppvObject);
  HRESULT(STDMETHODCALLTYPE *get_ParentCatalog)(_ADOUser *This,
                                                _ADOCatalog **ppvObject);
  HRESULT(STDMETHODCALLTYPE *put_ParentCatalog)(_ADOUser *This,
                                                _ADOCatalog *ppvObject);
  HRESULT(STDMETHODCALLTYPE *putref_ParentADOCatalog)(_ADOUser *This,
                                                      _ADOCatalog *ppvObject);
  END_INTERFACE
} _UserVtbl;
interface _User { CONST_VTBL struct _UserVtbl *lpVtbl; };
#ifdef COBJMACROS
...
#define _User_GetPermissions(This, Name, ObjectType, ObjectTypeId, Rights)     \
  ((This)->lpVtbl->GetPermissions(This, Name, ObjectType, ObjectTypeId, Rights))
#define _User_SetPermissions(This, Name, ObjectType, Action, Rights, Inherit,  \
                             ObjectTypeId)                                     \
  ((This)->lpVtbl->SetPermissions(This, Name, ObjectType, Action, Rights,      \
                                  Inherit, ObjectTypeId))
...
public:
  virtual HRESULT STDMETHODCALLTYPE get_Name(BSTR * pVal) = 0;
  virtual HRESULT STDMETHODCALLTYPE put_Name(BSTR newVal) = 0;
  virtual HRESULT STDMETHODCALLTYPE get_Attributes(ColumnAttributesEnum *
                                                   pVal) = 0;
  virtual HRESULT STDMETHODCALLTYPE put_Attributes(
      ColumnAttributesEnum newVal) = 0;
...
typedef struct _ColumnVtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(_ADOColumn *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(_ADOColumn *This, UINT iTInfo,
                                          LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(_ADOColumn *This, REFIID riid,
                                            LPOLESTR *rgszNames, UINT cNames,
                                            LCID lcid, DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(_ADOColumn *This, DISPID dispIdMember,
                                     REFIID riid, LCID lcid, WORD wFlags,
                                     DISPPARAMS *pDispParams,
                                     VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                                     UINT *puArgErr);
  ...
  HRESULT(STDMETHODCALLTYPE *get_Attributes)(_ADOColumn *This,
                                             ColumnAttributesEnum *pVal);
  HRESULT(STDMETHODCALLTYPE *put_Attributes)(_ADOColumn *This,
                                             ColumnAttributesEnum newVal);
  HRESULT(STDMETHODCALLTYPE *get_DefinedSize)(_ADOColumn *This, long *pVal);
  HRESULT(STDMETHODCALLTYPE *put_DefinedSize)(_ADOColumn *This,
                                              long DefinedSize);
  ...
  HRESULT(STDMETHODCALLTYPE *get_SortOrder)(_ADOColumn *This,
                                            SortOrderEnum *pVal);
  HRESULT(STDMETHODCALLTYPE *put_SortOrder)(_ADOColumn *This,
  ...
  HRESULT(STDMETHODCALLTYPE *get_Properties)(_ADOColumn *This,
                                             ADOProperties **ppvObject);
  HRESULT(STDMETHODCALLTYPE *get_ParentCatalog)(_ADOColumn *This,
                                                _ADOCatalog **ppvObject);
  HRESULT(STDMETHODCALLTYPE *put_ParentCatalog)(_ADOColumn *This,
                                                _ADOCatalog *ppvObject);
  HRESULT(STDMETHODCALLTYPE *putref_ParentADOCatalog)(_ADOColumn *This,
                                                      _ADOCatalog *ppvObject);
  END_INTERFACE
} _ColumnVtbl;
interface _Column { CONST_VTBL struct _ColumnVtbl *lpVtbl; };
#ifdef COBJMACROS
...
typedef struct _IndexVtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(_ADOIndex *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(_ADOIndex *This, UINT iTInfo,
                                          LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(_ADOIndex *This, REFIID riid,
                                            LPOLESTR *rgszNames, UINT cNames,
                                            LCID lcid, DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(_ADOIndex *This, DISPID dispIdMember,
                                     REFIID riid, LCID lcid, WORD wFlags,
                                     DISPPARAMS *pDispParams,
                                     VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                                     UINT *puArgErr);
  ...
  HRESULT(STDMETHODCALLTYPE *get_Clustered)(_ADOIndex *This,
                                            VARIANT_BOOL *pVal);
  HRESULT(STDMETHODCALLTYPE *put_Clustered)(_ADOIndex *This,
                                            VARIANT_BOOL newVal);
  HRESULT(STDMETHODCALLTYPE *get_IndexNulls)(_ADOIndex *This,
                                             AllowNullsEnum *pVal);
  HRESULT(STDMETHODCALLTYPE *put_IndexNulls)(_ADOIndex *This,
                                             AllowNullsEnum newVal);
  HRESULT(STDMETHODCALLTYPE *get_PrimaryKey)(_ADOIndex *This,
                                             VARIANT_BOOL *pVal);
  HRESULT(STDMETHODCALLTYPE *put_PrimaryKey)(_ADOIndex *This,
                                             VARIANT_BOOL newVal);
  ...
  HRESULT(STDMETHODCALLTYPE *get_Columns)(_ADOIndex *This,
                                          ADOColumns **ppvObject);
  HRESULT(STDMETHODCALLTYPE *get_Properties)(_ADOIndex *This,
                                             ADOProperties **ppvObject);
  END_INTERFACE
} _IndexVtbl;
interface _Index { CONST_VTBL struct _IndexVtbl *lpVtbl; };
#ifdef COBJMACROS
...
typedef struct _KeyVtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(_ADOKey *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(_ADOKey *This, UINT iTInfo, LCID lcid,
                                          ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(_ADOKey *This, REFIID riid,
                                            LPOLESTR *rgszNames, UINT cNames,
                                            LCID lcid, DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(_ADOKey *This, DISPID dispIdMember,
                                     REFIID riid, LCID lcid, WORD wFlags,
                                     DISPPARAMS *pDispParams,
                                     VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                                     UINT *puArgErr);
  ...
  HRESULT(STDMETHODCALLTYPE *get_Columns)(_ADOKey *This,
                                          ADOColumns **ppvObject);
  END_INTERFACE
} _KeyVtbl;
interface _Key { CONST_VTBL struct _KeyVtbl *lpVtbl; };
#ifdef COBJMACROS
...
typedef struct ViewVtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ADOView *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(ADOView *This, UINT iTInfo, LCID lcid,
                                          ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(ADOView *This, REFIID riid,
                                            LPOLESTR *rgszNames, UINT cNames,
                                            LCID lcid, DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(ADOView *This, DISPID dispIdMember,
                                     REFIID riid, LCID lcid, WORD wFlags,
                                     DISPPARAMS *pDispParams,
                                     VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                                     UINT *puArgErr);
...
interface View { CONST_VTBL struct ViewVtbl *lpVtbl; };
#ifdef COBJMACROS
...
typedef struct ProcedureVtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ADOProcedure *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(ADOProcedure *This);
  ULONG(STDMETHODCALLTYPE *Release)(ADOProcedure *This);
  HRESULT(STDMETHODCALLTYPE *GetTypeInfoCount)(ADOProcedure *This,
                                               UINT *pctinfo);
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(ADOProcedure *This, UINT iTInfo,
                                          LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(ADOProcedure *This, REFIID riid,
                                            LPOLESTR *rgszNames, UINT cNames,
                                            LCID lcid, DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(ADOProcedure *This, DISPID dispIdMember,
                                     REFIID riid, LCID lcid, WORD wFlags,
                                     DISPPARAMS *pDispParams,
                                     VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                                     UINT *puArgErr);
  ...
  HRESULT(STDMETHODCALLTYPE *putref_Command)(ADOProcedure *This,
                                             IDispatch *pComm);
  HRESULT(STDMETHODCALLTYPE *get_Name)(ADOProcedure *This, BSTR *pVal);
  HRESULT(STDMETHODCALLTYPE *get_DateCreated)(ADOProcedure *This,
                                              VARIANT *pVal);
  HRESULT(STDMETHODCALLTYPE *get_DateModified)(ADOProcedure *This,
                                               VARIANT *pVal);
  END_INTERFACE
} ProcedureVtbl;
interface Procedure { CONST_VTBL struct ProcedureVtbl *lpVtbl; };
#ifdef COBJMACROS
...
public:
  virtual HRESULT STDMETHODCALLTYPE get_Item(VARIANT Item,
                                             Table * *ppvObject) = 0;
...
typedef struct TablesVtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ADOTables *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(ADOTables *This, UINT iTInfo,
                                          LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(ADOTables *This, REFIID riid,
                                            LPOLESTR *rgszNames, UINT cNames,
                                            LCID lcid, DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(ADOTables *This, DISPID dispIdMember,
                                     REFIID riid, LCID lcid, WORD wFlags,
                                     DISPPARAMS *pDispParams,
                                     VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                                     UINT *puArgErr);
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE Append(
      VARIANT Item, DataTypeEnum Type = adVarWChar, long DefinedSize = 0) = 0;
  virtual HRESULT STDMETHODCALLTYPE Delete(VARIANT Item) = 0;
};
#else
typedef struct ColumnsVtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ADOColumns *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(ADOColumns *This, UINT iTInfo,
                                          LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(ADOColumns *This, REFIID riid,
                                            LPOLESTR *rgszNames, UINT cNames,
                                            LCID lcid, DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(ADOColumns *This, DISPID dispIdMember,
                                     REFIID riid, LCID lcid, WORD wFlags,
                                     DISPPARAMS *pDispParams,
                                     VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                                     UINT *puArgErr);
  ...
  HRESULT(STDMETHODCALLTYPE *get_Item)(ADOColumns *This, VARIANT Item,
                                       Column **ppvObject);
  HRESULT(STDMETHODCALLTYPE *Append)(ADOColumns *This, VARIANT Item,
                                     DataTypeEnum Type, long DefinedSize);
  HRESULT(STDMETHODCALLTYPE *Delete)(ADOColumns *This, VARIANT Item);
  END_INTERFACE
} ColumnsVtbl;
interface Columns { CONST_VTBL struct ColumnsVtbl *lpVtbl; };
#ifdef COBJMACROS
...
typedef struct ProceduresVtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ADOProcedures *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(ADOProcedures *This);
  ULONG(STDMETHODCALLTYPE *Release)(ADOProcedures *This);
  HRESULT(STDMETHODCALLTYPE *GetTypeInfoCount)(ADOProcedures *This,
                                               UINT *pctinfo);
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(ADOProcedures *This, UINT iTInfo,
                                          LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(ADOProcedures *This, REFIID riid,
                                            LPOLESTR *rgszNames, UINT cNames,
                                            LCID lcid, DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(ADOProcedures *This, DISPID dispIdMember,
                                     REFIID riid, LCID lcid, WORD wFlags,
                                     DISPPARAMS *pDispParams,
                                     VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                                     UINT *puArgErr);
  HRESULT(STDMETHODCALLTYPE *get_Count)(ADOProcedures *This, long *c);
  HRESULT(STDMETHODCALLTYPE *_NewEnum)(ADOProcedures *This,
                                       IUnknown **ppvObject);
  HRESULT(STDMETHODCALLTYPE *Refresh)(ADOProcedures *This);
  HRESULT(STDMETHODCALLTYPE *get_Item)(ADOProcedures *This, VARIANT Item,
                                       ADOProcedure **ppvObject);
  HRESULT(STDMETHODCALLTYPE *Append)(ADOProcedures *This, BSTR Name,
                                     IDispatch *Command);
  HRESULT(STDMETHODCALLTYPE *Delete)(ADOProcedures *This, VARIANT Item);
  END_INTERFACE
} ProceduresVtbl;
interface Procedures { CONST_VTBL struct ProceduresVtbl *lpVtbl; };
#ifdef COBJMACROS
...
#define Procedures_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                    \
  ((This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo))
#define Procedures_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,          \
                                 rgDispId)                                     \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))
...
typedef struct ViewsVtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ADOViews *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(ADOViews *This, UINT iTInfo,
                                          LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(ADOViews *This, REFIID riid,
                                            LPOLESTR *rgszNames, UINT cNames,
                                            LCID lcid, DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(ADOViews *This, DISPID dispIdMember,
                                     REFIID riid, LCID lcid, WORD wFlags,
                                     DISPPARAMS *pDispParams,
                                     VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                                     UINT *puArgErr);
  ...
  HRESULT(STDMETHODCALLTYPE *get_Item)(ADOViews *This, VARIANT Item,
                                       ADOView **ppvObject);
  HRESULT(STDMETHODCALLTYPE *Append)(ADOViews *This, BSTR Name,
                                     IDispatch *Command);
  HRESULT(STDMETHODCALLTYPE *Delete)(ADOViews *This, VARIANT Item);
  END_INTERFACE
} ViewsVtbl;
interface Views { CONST_VTBL struct ViewsVtbl *lpVtbl; };
#ifdef COBJMACROS
...
typedef struct IndexesVtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ADOIndexes *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(ADOIndexes *This, UINT iTInfo,
                                          LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(ADOIndexes *This, REFIID riid,
                                            LPOLESTR *rgszNames, UINT cNames,
                                            LCID lcid, DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(ADOIndexes *This, DISPID dispIdMember,
                                     REFIID riid, LCID lcid, WORD wFlags,
                                     DISPPARAMS *pDispParams,
                                     VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                                     UINT *puArgErr);
  ...
  HRESULT(STDMETHODCALLTYPE *get_Item)(ADOIndexes *This, VARIANT Item,
                                       Index **ppvObject);
  HRESULT(STDMETHODCALLTYPE *Append)(ADOIndexes *This, VARIANT Item,
                                     VARIANT columns);
  HRESULT(STDMETHODCALLTYPE *Delete)(ADOIndexes *This, VARIANT Item);
  END_INTERFACE
} IndexesVtbl;
interface Indexes { CONST_VTBL struct IndexesVtbl *lpVtbl; };
#ifdef COBJMACROS
...
public:
  virtual HRESULT STDMETHODCALLTYPE get_Item(VARIANT Item,
                                             Key * *ppvObject) = 0;
  virtual HRESULT STDMETHODCALLTYPE Append(
      VARIANT Item, KeyTypeEnum Type, VARIANT Column,
      BSTR RelatedADOTable = L"", BSTR RelatedADOColumn = L"") = 0;
  virtual HRESULT STDMETHODCALLTYPE Delete(VARIANT Item) = 0;
};
#else
typedef struct KeysVtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ADOKeys *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(ADOKeys *This, UINT iTInfo, LCID lcid,
                                          ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(ADOKeys *This, REFIID riid,
                                            LPOLESTR *rgszNames, UINT cNames,
                                            LCID lcid, DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(ADOKeys *This, DISPID dispIdMember,
                                     REFIID riid, LCID lcid, WORD wFlags,
                                     DISPPARAMS *pDispParams,
                                     VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                                     UINT *puArgErr);
  ...
  HRESULT(STDMETHODCALLTYPE *get_Item)(ADOKeys *This, VARIANT Item,
                                       Key **ppvObject);
  HRESULT(STDMETHODCALLTYPE *Append)(ADOKeys *This, VARIANT Item,
                                     KeyTypeEnum Type, VARIANT Column,
                                     BSTR RelatedTable, BSTR RelatedColumn);
  HRESULT(STDMETHODCALLTYPE *Delete)(ADOKeys *This, VARIANT Item);
  END_INTERFACE
} KeysVtbl;
interface Keys { CONST_VTBL struct KeysVtbl *lpVtbl; };
#ifdef COBJMACROS
...
#define Keys_Append(This, Item, Type, Column, RelatedTable, RelatedColumn)     \
  ((This)->lpVtbl->Append(This, Item, Type, Column, RelatedTable,              \
                          RelatedColumn))
...
public:
  virtual HRESULT STDMETHODCALLTYPE get_Item(VARIANT Item,
                                             User * *ppvObject) = 0;
  virtual HRESULT STDMETHODCALLTYPE Append(VARIANT Item,
                                           BSTR Password = L"") = 0;
  virtual HRESULT STDMETHODCALLTYPE Delete(VARIANT Item) = 0;
};
#else
typedef struct UsersVtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ADOUsers *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(ADOUsers *This, UINT iTInfo,
                                          LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(ADOUsers *This, REFIID riid,
                                            LPOLESTR *rgszNames, UINT cNames,
                                            LCID lcid, DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(ADOUsers *This, DISPID dispIdMember,
                                     REFIID riid, LCID lcid, WORD wFlags,
                                     DISPPARAMS *pDispParams,
                                     VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                                     UINT *puArgErr);
  ...
  HRESULT(STDMETHODCALLTYPE *get_Item)(ADOUsers *This, VARIANT Item,
                                       User **ppvObject);
  HRESULT(STDMETHODCALLTYPE *Append)(ADOUsers *This, VARIANT Item,
                                     BSTR Password);
  HRESULT(STDMETHODCALLTYPE *Delete)(ADOUsers *This, VARIANT Item);
  END_INTERFACE
} UsersVtbl;
interface Users { CONST_VTBL struct UsersVtbl *lpVtbl; };
#ifdef COBJMACROS
...
typedef struct GroupsVtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ADOGroups *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(ADOGroups *This, UINT iTInfo,
                                          LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(ADOGroups *This, REFIID riid,
                                            LPOLESTR *rgszNames, UINT cNames,
                                            LCID lcid, DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(ADOGroups *This, DISPID dispIdMember,
                                     REFIID riid, LCID lcid, WORD wFlags,
                                     DISPPARAMS *pDispParams,
                                     VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                                     UINT *puArgErr);
...
typedef struct PropertiesVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *get_Item)(ADOProperties *This, VARIANT Item,
