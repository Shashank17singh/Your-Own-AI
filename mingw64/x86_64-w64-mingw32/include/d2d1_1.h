...
interface ID2D1Properties : public IUnknown {
  ...
  STDMETHOD(GetPropertyName)(UINT32 index, PWSTR name, UINT32 nameCount)
      CONST PURE;
  ...
  STDMETHOD(SetValueByName)(PCWSTR name, D2D1_PROPERTY_TYPE type,
                            CONST BYTE * data, UINT32 dataSize) PURE;
  STDMETHOD(SetValue)(UINT32 index, D2D1_PROPERTY_TYPE type, CONST BYTE * data,
                      UINT32 dataSize) PURE;
  STDMETHOD(GetValueByName)(PCWSTR name, D2D1_PROPERTY_TYPE type, BYTE * data,
                            UINT32 dataSize) CONST PURE;
  STDMETHOD(GetValue)(UINT32 index, D2D1_PROPERTY_TYPE type, BYTE * data,
                      UINT32 dataSize) CONST PURE;
  STDMETHOD_(UINT32, GetValueSize)(UINT32 index) CONST PURE;
  STDMETHOD(GetSubProperties)(UINT32 index, ID2D1Properties * *subProperties)
      CONST PURE;
  ...
  HRESULT GetValueByName(PCWSTR propertyName, T * value) const {
    return GetValueByName(propertyName, reinterpret_cast<BYTE *>(value),
                          sizeof(*value));
  }
  template <typename T> T GetValueByName(PCWSTR propertyName) const {
    T ret;
  ...
  HRESULT SetValueByName(PCWSTR propertyName, const T &value) {
    return SetValueByName(propertyName, reinterpret_cast<const BYTE *>(&value),
                          sizeof(value));
  }
  template <typename T>
  ...
  template <typename T, typename U> HRESULT GetValue(U index, T * value) const {
    return GetValue(static_cast<UINT32>(index), reinterpret_cast<BYTE *>(value),
                    sizeof(*value));
  }
  template <typename T, typename U> T GetValue(U index) const {
    T ret;
    GetValue(static_cast<UINT32>(index), reinterpret_cast<BYTE *>(&ret),
             sizeof(ret));
    return ret;
  }
  template <typename T>
  ...
  template <typename T, typename U> HRESULT SetValue(U index, const T &value) {
    return SetValue(static_cast<UINT32>(index),
  ...
  template <typename T> UINT32 GetPropertyNameLength(T index) CONST {
    return GetPropertyNameLength(static_cast<UINT32>(index));
  }
  template <typename T> D2D1_PROPERTY_TYPE GetType(T index) CONST {
    return GetType(static_cast<UINT32>(index));
  }
  template <typename T> UINT32 GetValueSize(T index) CONST {
...
#endif
DEFINE_GUID(IID_ID2D1Properties, 0x483473d7, 0xcd46, 0x4f9d, 0x9d, 0x3a, 0x31,
            0x12, 0xaa, 0x80, 0x15, 0x9d);
__CRT_UUID_DECL(ID2D1Properties, 0x483473d7, 0xcd46, 0x4f9d, 0x9d, 0x3a, 0x31,
                0x12, 0xaa, 0x80, 0x15, 0x9d);
#ifndef D2D_USE_C_DEFINITIONS
interface ID2D1GdiMetafileSink : public IUnknown {
  STDMETHOD(ProcessRecord)(DWORD recordType, CONST void *recordData,
                           DWORD recordDataSize) PURE;
};
#else
typedef interface ID2D1GdiMetafileSink ID2D1GdiMetafileSink;
/* FIXME: Add full C declaration */
#endif
DEFINE_GUID(IID_ID2D1GdiMetafileSink, 0x82237326, 0x8111, 0x4f7c, 0xbc, 0xf4,
            0xb5, 0xc1, 0x17, 0x55, 0x64, 0xfe);
__CRT_UUID_DECL(ID2D1GdiMetafileSink, 0x82237326, 0x8111, 0x4f7c, 0xbc, 0xf4,
                0xb5, 0xc1, 0x17, 0x55, 0x64, 0xfe);
#ifndef D2D_USE_C_DEFINITIONS
...
/* FIXME: Add full C declaration */
#endif
DEFINE_GUID(IID_ID2D1GdiMetafile, 0x2f543dc3, 0xcfc1, 0x4211, 0x86, 0x4f, 0xcf,
            0xd9, 0x1c, 0x6f, 0x33, 0x95);
__CRT_UUID_DECL(ID2D1GdiMetafile, 0x2f543dc3, 0xcfc1, 0x4211, 0x86, 0x4f, 0xcf,
                0xd9, 0x1c, 0x6f, 0x33, 0x95);
#ifndef D2D_USE_C_DEFINITIONS
...
/* FIXME: Add full C declaration */
#endif
DEFINE_GUID(IID_ID2D1StrokeStyle1, 0x10a72a66, 0xe91c, 0x43f4, 0x99, 0x3f, 0xdd,
            0xf4, 0xb8, 0x2b, 0x0b, 0x4a);
__CRT_UUID_DECL(ID2D1StrokeStyle1, 0x10a72a66, 0xe91c, 0x43f4, 0x99, 0x3f, 0xdd,
                0xf4, 0xb8, 0x2b, 0x0b, 0x4a);
#ifndef D2D_USE_C_DEFINITIONS
interface ID2D1CommandSink : public IUnknown {
  ...
  STDMETHOD(SetTextAntialiasMode)(D2D1_TEXT_ANTIALIAS_MODE textAntialiasMode)
      PURE;
  STDMETHOD(SetTextRenderingParams)(IDWriteRenderingParams *
                                    textRenderingParams) PURE;
  ...
  STDMETHOD(DrawLine)(D2D1_POINT_2F point0, D2D1_POINT_2F point1,
                      ID2D1Brush * brush, FLOAT strokeWidth,
                      ID2D1StrokeStyle * strokeStyle) PURE;
  STDMETHOD(DrawGeometry)(ID2D1Geometry * geometry, ID2D1Brush * brush,
                          FLOAT strokeWidth, ID2D1StrokeStyle * strokeStyle)
      PURE;
  STDMETHOD(DrawRectangle)(CONST D2D1_RECT_F * rect, ID2D1Brush * brush,
                           FLOAT strokeWidth, ID2D1StrokeStyle * strokeStyle)
      PURE;
  STDMETHOD(DrawBitmap)(ID2D1Bitmap * bitmap,
                        CONST D2D1_RECT_F * destinationRectangle, FLOAT opacity,
                        D2D1_INTERPOLATION_MODE interpolationMode,
                        CONST D2D1_RECT_F * sourceRectangle,
                        CONST D2D1_MATRIX_4X4_F * perspectiveTransform) PURE;
  STDMETHOD(DrawImage)(ID2D1Image * image, CONST D2D1_POINT_2F * targetOffset,
                       CONST D2D1_RECT_F * imageRectangle,
                       D2D1_INTERPOLATION_MODE interpolationMode,
                       D2D1_COMPOSITE_MODE compositeMode) PURE;
  STDMETHOD(DrawGdiMetafile)(ID2D1GdiMetafile * gdiMetafile,
                             CONST D2D1_POINT_2F * targetOffset) PURE;
  STDMETHOD(FillMesh)(ID2D1Mesh * mesh, ID2D1Brush * brush) PURE;
  STDMETHOD(FillOpacityMask)(ID2D1Bitmap * opacityMask, ID2D1Brush * brush,
                             CONST D2D1_RECT_F * destinationRectangle,
                             CONST D2D1_RECT_F * sourceRectangle) PURE;
  STDMETHOD(FillGeometry)(ID2D1Geometry * geometry, ID2D1Brush * brush,
                          ID2D1Brush * opacityBrush) PURE;
  STDMETHOD(FillRectangle)(CONST D2D1_RECT_F * rect, ID2D1Brush * brush) PURE;
  STDMETHOD(PushAxisAlignedClip)(CONST D2D1_RECT_F * clipRect,
                                 D2D1_ANTIALIAS_MODE antialiasMode) PURE;
  STDMETHOD(PushLayer)(CONST D2D1_LAYER_PARAMETERS1 * layerParameters1,
...
#endif
DEFINE_GUID(IID_ID2D1CommandSink, 0x54d7898a, 0xa061, 0x40a7, 0xbe, 0xc7, 0xe4,
            0x65, 0xbc, 0xba, 0x2c, 0x4f);
__CRT_UUID_DECL(ID2D1CommandSink, 0x54d7898a, 0xa061, 0x40a7, 0xbe, 0xc7, 0xe4,
                0x65, 0xbc, 0xba, 0x2c, 0x4f);
#ifndef D2D_USE_C_DEFINITIONS
...
#endif
DEFINE_GUID(IID_ID2D1CommandList, 0xb4f34a19, 0x2383, 0x4d76, 0x94, 0xf6, 0xec,
            0x34, 0x36, 0x57, 0xc3, 0xdc);
__CRT_UUID_DECL(ID2D1CommandList, 0xb4f34a19, 0x2383, 0x4d76, 0x94, 0xf6, 0xec,
                0x34, 0x36, 0x57, 0xc3, 0xdc);
#ifndef D2D_USE_C_DEFINITIONS
interface ID2D1PrintControl : public IUnknown {
  STDMETHOD(AddPage)(ID2D1CommandList * commandList, D2D_SIZE_F pageSize,
                     IStream * pagePrintTicketStream, D2D1_TAG *tag1 = NULL,
                     D2D1_TAG *tag2 = NULL) PURE;
  STDMETHOD(Close)() PURE;
};
#else
typedef interface ID2D1PrintControl ID2D1PrintControl;
#endif
DEFINE_GUID(IID_ID2D1PrintControl, 0x2c1d867d, 0xc290, 0x41c8, 0xae, 0x7e, 0x34,
            0xa9, 0x87, 0x02, 0xe9, 0xa5);
__CRT_UUID_DECL(ID2D1PrintControl, 0x2c1d867d, 0xc290, 0x41c8, 0xae, 0x7e, 0x34,
                0xa9, 0x87, 0x02, 0xe9, 0xa5);
#ifndef D2D_USE_C_DEFINITIONS
interface ID2D1Effect : public ID2D1Properties {
  STDMETHOD_(void, SetInput)(UINT32 index, ID2D1Image * input,
                             BOOL invalidate = TRUE) PURE;
  ...
  void SetInputEffect(UINT32 index, ID2D1Effect * inputEffect,
...
/* FIXME: Add full C declaration */
#endif
DEFINE_GUID(IID_ID2D1Effect, 0x28211a43, 0x7d89, 0x476f, 0x81, 0x81, 0x2d, 0x61,
            0x59, 0xb2, 0x20, 0xad);
__CRT_UUID_DECL(ID2D1Effect, 0x28211a43, 0x7d89, 0x476f, 0x81, 0x81, 0x2d, 0x61,
                0x59, 0xb2, 0x20, 0xad);
#endif
#ifndef D2D_USE_C_DEFINITIONS
interface ID2D1Bitmap1 : public ID2D1Bitmap {
  STDMETHOD_(void, GetColorContext)(ID2D1ColorContext * *colorContext)
      CONST PURE;
...
typedef struct ID2D1Bitmap1Vtbl {
  ...
  STDMETHOD(Map)(ID2D1Bitmap1 *This, D2D1_MAP_OPTIONS options,
                 D2D1_MAPPED_RECT *mappedRect) PURE;
  STDMETHOD(Unmap)(ID2D1Bitmap1 *This) PURE;
} ID2D1Bitmap1Vtbl;
interface ID2D1Bitmap1 { const ID2D1Bitmap1Vtbl *lpVtbl; };
/*** IUnknown methods ***/
#define ID2D1Bitmap1_QueryInterface(This, riid, ppvObject)                     \
...
#define ID2D1Bitmap1_GetSize(This)                                             \
  ID2D1Bitmap1_GetSize_define_WIDL_C_INLINE_WRAPPERS_for_aggregate_return_support
#define ID2D1Bitmap1_GetPixelSize(This)                                        \
  ID2D1Bitmap1_GetPixelSize_define_WIDL_C_INLINE_WRAPPERS_for_aggregate_return_support
#define ID2D1Bitmap1_GetPixelFormat(This)                                      \
  ID2D1Bitmap1_GetPixelFormat_define_WIDL_C_INLINE_WRAPPERS_for_aggregate_return_support
#define ID2D1Bitmap1_GetDpi(This, dpi_x, dpi_y)                                \
  (This)->lpVtbl->GetDpi(This, dpi_x, dpi_y)
#define ID2D1Bitmap1_CopyFromBitmap(This, dst_point, bitmap, src_rect)         \
  (This)->lpVtbl->CopyFromBitmap(This, dst_point, bitmap, src_rect)
#define ID2D1Bitmap1_CopyFromRenderTarget(This, dst_point, render_target,      \
                                          src_rect)                            \
  (This)->lpVtbl->CopyFromRenderTarget(This, dst_point, render_target, src_rect)
#define ID2D1Bitmap1_CopyFromMemory(This, dst_rect, src_data, pitch)           \
  (This)->lpVtbl->CopyFromMemory(This, dst_rect, src_data, pitch)
/*** ID2D1Bitmap1 methods ***/
#define ID2D1Bitmap1_GetColorContext(This, context)                            \
  (This)->lpVtbl->GetColorContext(This, context)
#define ID2D1Bitmap1_GetOptions(This) (This)->lpVtbl->GetOptions(This)
#define ID2D1Bitmap1_GetSurface(This, surface)                                 \
  (This)->lpVtbl->GetSurface(This, surface)
#define ID2D1Bitmap1_Map(This, options, mapped_rect)                           \
  (This)->lpVtbl->Map(This, options, mapped_rect)
...
DEFINE_GUID(IID_ID2D1Bitmap1, 0xa898a84c, 0x3873, 0x4588, 0xb0, 0x8b, 0xeb,
            0xbf, 0x97, 0x8d, 0xf0, 0x41);
__CRT_UUID_DECL(ID2D1Bitmap1, 0xa898a84c, 0x3873, 0x4588, 0xb0, 0x8b, 0xeb,
                0xbf, 0x97, 0x8d, 0xf0, 0x41);
#ifndef D2D_USE_C_DEFINITIONS
interface ID2D1ImageBrush : public ID2D1Brush {
  ...
  STDMETHOD_(void, SetInterpolationMode)(
      D2D1_INTERPOLATION_MODE interpolationMode) PURE;
  STDMETHOD_(void, SetSourceRectangle)(CONST D2D1_RECT_F * sourceRectangle)
      PURE;
  ...
  STDMETHOD_(void, GetSourceRectangle)(D2D1_RECT_F * sourceRectangle)
      CONST PURE;
};
#else
...
/* FIXME: Add full C declaration */
#endif
DEFINE_GUID(IID_ID2D1ImageBrush, 0xfe9e984d, 0x3f95, 0x407c, 0xb5, 0xdb, 0xcb,
            0x94, 0xd4, 0xe8, 0xf8, 0x7c);
__CRT_UUID_DECL(ID2D1ImageBrush, 0xfe9e984d, 0x3f95, 0x407c, 0xb5, 0xdb, 0xcb,
                0x94, 0xd4, 0xe8, 0xf8, 0x7c);
#ifndef D2D_USE_C_DEFINITIONS
...
/* FIXME: Add full C declaration */
#endif
DEFINE_GUID(IID_ID2D1BitmapBrush1, 0x41343a53, 0xe41a, 0x49a2, 0x91, 0xcd, 0x21,
            0x79, 0x3b, 0xbb, 0x62, 0xe5);
__CRT_UUID_DECL(ID2D1BitmapBrush1, 0x41343a53, 0xe41a, 0x49a2, 0x91, 0xcd, 0x21,
                0x79, 0x3b, 0xbb, 0x62, 0xe5);
#ifndef D2D_USE_C_DEFINITIONS
interface ID2D1GradientStopCollection1 : public ID2D1GradientStopCollection {
  STDMETHOD_(void, GetGradientStops1)(D2D1_GRADIENT_STOP * gradientStops,
...
/* FIXME: Add full C declaration */
#endif
DEFINE_GUID(IID_ID2D1GradientStopCollection1, 0xae1572f4, 0x5dd0, 0x4777, 0x99,
            0x8b, 0x92, 0x79, 0x47, 0x2a, 0xe6, 0x3b);
__CRT_UUID_DECL(ID2D1GradientStopCollection1, 0xae1572f4, 0x5dd0, 0x4777, 0x99,
                0x8b, 0x92, 0x79, 0x47, 0x2a, 0xe6, 0x3b);
#ifndef D2D_USE_C_DEFINITIONS
...
typedef interface ID2D1ColorContext ID2D1ColorContext;
#endif
DEFINE_GUID(IID_ID2D1ColorContext, 0x1c4820bb, 0x5771, 0x4518, 0xa5, 0x81, 0x2f,
            0xe4, 0xdd, 0x0e, 0xc6, 0x57);
__CRT_UUID_DECL(ID2D1ColorContext, 0x1c4820bb, 0x5771, 0x4518, 0xa5, 0x81, 0x2f,
                0xe4, 0xdd, 0x0e, 0xc6, 0x57);
#ifndef D2D_USE_C_DEFINITIONS
interface ID2D1DeviceContext : public ID2D1RenderTarget {
  STDMETHOD(CreateBitmap)(D2D1_SIZE_U size, CONST void *sourceData,
                          UINT32 pitch,
  ...
  STDMETHOD(CreateColorContext)(D2D1_COLOR_SPACE space, CONST BYTE * profile,
                                UINT32 profileSize,
                                ID2D1ColorContext * *colorContext) PURE;
  ...
  STDMETHOD(CreateColorContextFromWicColorContext)(
      IWICColorContext * wicColorContext, ID2D1ColorContext * *colorContext)
      PURE;
  ...
  STDMETHOD(CreateImageBrush)(ID2D1Image * image,
                              CONST D2D1_IMAGE_BRUSH_PROPERTIES *
                                  imageBrushProperties,
                              CONST D2D1_BRUSH_PROPERTIES * brushProperties,
                              ID2D1ImageBrush * *imageBrush) PURE;
  STDMETHOD(CreateBitmapBrush)(ID2D1Bitmap * bitmap,
  ...
  STDMETHOD_(BOOL, IsBufferPrecisionSupported)(
      D2D1_BUFFER_PRECISION bufferPrecision) CONST PURE;
  STDMETHOD(GetImageLocalBounds)(ID2D1Image * image, D2D1_RECT_F * localBounds)
      CONST PURE;
  STDMETHOD(GetImageWorldBounds)(ID2D1Image * image, D2D1_RECT_F * worldBounds)
      CONST PURE;
  ...
  STDMETHOD_(void, SetRenderingControls)(CONST D2D1_RENDERING_CONTROLS *
                                         renderingControls) PURE;
  STDMETHOD_(void, GetRenderingControls)(D2D1_RENDERING_CONTROLS *
                                         renderingControls) CONST PURE;
  ...
  STDMETHOD_(void, DrawImage)(
      ID2D1Image * image, CONST D2D1_POINT_2F *targetOffset = NULL,
      CONST D2D1_RECT_F *imageRectangle = NULL,
      D2D1_INTERPOLATION_MODE interpolationMode =
          D2D1_INTERPOLATION_MODE_LINEAR,
      D2D1_COMPOSITE_MODE compositeMode = D2D1_COMPOSITE_MODE_SOURCE_OVER) PURE;
  STDMETHOD_(void, DrawGdiMetafile)(ID2D1GdiMetafile * gdiMetafile,
  ...
  STDMETHOD_(void, PushLayer)(CONST D2D1_LAYER_PARAMETERS1 * layerParameters,
                              ID2D1Layer * layer) PURE;
  using ID2D1RenderTarget::PushLayer;
  STDMETHOD(InvalidateEffectInputRectangle)(ID2D1Effect * effect, UINT32 input,
                                            CONST D2D1_RECT_F * inputRectangle)
      PURE;
  STDMETHOD(GetEffectInvalidRectangleCount)(ID2D1Effect * effect,
                                            UINT32 * rectangleCount) PURE;
  STDMETHOD(GetEffectInvalidRectangles)(ID2D1Effect * effect,
  ...
  HRESULT CreateBitmap(D2D1_SIZE_U size, CONST void *sourceData, UINT32 pitch,
                       CONST D2D1_BITMAP_PROPERTIES1 &bitmapProperties,
                       ID2D1Bitmap1 **bitmap) {
  ...
  HRESULT CreateImageBrush(ID2D1Image * image,
                           CONST D2D1_IMAGE_BRUSH_PROPERTIES &
                               imageBrushProperties,
                           CONST D2D1_BRUSH_PROPERTIES & brushProperties,
  ...
  void DrawImage(ID2D1Effect * effect, CONST D2D1_POINT_2F *targetOffset = NULL,
                 CONST D2D1_RECT_F *imageRectangle = NULL,
                 D2D1_INTERPOLATION_MODE interpolationMode =
                     D2D1_INTERPOLATION_MODE_LINEAR,
    ...
    DrawImage(output, targetOffset, imageRectangle, interpolationMode,
              compositeMode);
    output->Release();
  }
  ...
  void DrawImage(
      ID2D1Effect * effect, D2D1_INTERPOLATION_MODE interpolationMode,
  ...
  void DrawImage(ID2D1Image * image, D2D1_POINT_2F targetOffset,
                 ...
                 D2D1_COMPOSITE_MODE compositeMode =
                     D2D1_COMPOSITE_MODE_SOURCE_OVER) {
    DrawImage(image, &targetOffset, &imageRectangle, interpolationMode,
              compositeMode);
  }
  void DrawImage(ID2D1Effect * effect, D2D1_POINT_2F targetOffset,
                 CONST D2D1_RECT_F & imageRectangle,
                 ...
                 D2D1_COMPOSITE_MODE compositeMode =
                     D2D1_COMPOSITE_MODE_SOURCE_OVER) {
    DrawImage(effect, &targetOffset, &imageRectangle, interpolationMode,
              compositeMode);
  }
  ...
  void FillOpacityMask(ID2D1Bitmap * opacityMask, ID2D1Brush * brush,
                       CONST D2D1_RECT_F & destinationRectangle,
                       CONST D2D1_RECT_F & sourceRectangle) {
    FillOpacityMask(opacityMask, brush, &destinationRectangle,
                    &sourceRectangle);
  }
...
typedef struct ID2D1DeviceContextVtbl {
  ...
  STDMETHOD(CreateBitmapFromWicBitmap)(
      ID2D1DeviceContext *This, IWICBitmapSource *wicBitmapSource,
      CONST D2D1_BITMAP_PROPERTIES1 *bitmapProperties,
      ID2D1Bitmap1 **bitmap) PURE;
  STDMETHOD(CreateColorContext)(ID2D1DeviceContext *This,
                                D2D1_COLOR_SPACE space, CONST BYTE *profile,
                                UINT32 profileSize,
                                ID2D1ColorContext **colorContext) PURE;
  STDMETHOD(CreateColorContextFromFilename)(
      ID2D1DeviceContext *This, PCWSTR filename,
      ID2D1ColorContext **colorContext) PURE;
  STDMETHOD(CreateColorContextFromWicColorContext)(
      ID2D1DeviceContext *This, IWICColorContext *wicColorContext,
      ID2D1ColorContext **colorContext) PURE;
  STDMETHOD(CreateBitmapFromDxgiSurface)(
      ID2D1DeviceContext *This, IDXGISurface *surface,
      CONST D2D1_BITMAP_PROPERTIES1 *bitmapProperties,
      ID2D1Bitmap1 **bitmap) PURE;
  ...
  STDMETHOD(CreateImageBrush)(
      ID2D1DeviceContext *This, struct ID2D1Image *image,
      CONST D2D1_IMAGE_BRUSH_PROPERTIES *imageBrushProperties,
      CONST D2D1_BRUSH_PROPERTIES *brushProperties,
      ID2D1ImageBrush **imageBrush) PURE;
  STDMETHOD(CreateBitmapBrush)(
      ID2D1DeviceContext *This, ID2D1Bitmap *bitmap,
  ...
  STDMETHOD_(D2D1_PRIMITIVE_BLEND,
             GetPrimitiveBlend)(ID2D1DeviceContext *This) PURE;
  ...
  STDMETHOD_(void, DrawGlyphRun)(
      ID2D1DeviceContext *This, D2D1_POINT_2F baselineOrigin,
      CONST DWRITE_GLYPH_RUN *glyphRun,
      CONST DWRITE_GLYPH_RUN_DESCRIPTION *glyphRunDescription,
      ID2D1Brush *foregroundBrush, DWRITE_MEASURING_MODE measuringMode) PURE;
  ...
  STDMETHOD_(void, DrawGdiMetafile)(ID2D1DeviceContext *This,
                                    ...
                                    CONST D2D1_POINT_2F *targetOffset) PURE;
  STDMETHOD_(void,
             DrawBitmap)(ID2D1DeviceContext *This, ID2D1Bitmap *bitmap,
                         CONST D2D1_RECT_F *destinationRectangle, FLOAT opacity,
                         D2D1_INTERPOLATION_MODE interpolationMode,
                         CONST D2D1_RECT_F *sourceRectangle,
                         CONST D2D1_MATRIX_4X4_F *perspectiveTransform) PURE;
  ...
  STDMETHOD(InvalidateEffectInputRectangle)(
      ID2D1DeviceContext *This, ID2D1Effect *effect, UINT32 input,
  ...
  STDMETHOD(GetEffectInvalidRectangles)(ID2D1DeviceContext *This,
                                        ...
                                        UINT32 rectanglesCount) PURE;
  STDMETHOD(GetEffectRequiredInputRectangles)(
      ID2D1DeviceContext *This, ID2D1Effect *renderEffect,
...
interface ID2D1DeviceContext { const ID2D1DeviceContextVtbl *lpVtbl; };
/*** IUnknown methods ***/
#define ID2D1DeviceContext_QueryInterface(This, riid, ppvObject)               \
  (This)->lpVtbl->QueryInterface(This, riid, ppvObject)
...
#define ID2D1DeviceContext_CreateSharedBitmap(This, iid, data, desc, bitmap)   \
  (This)->lpVtbl->CreateSharedBitmap(This, iid, data, desc, bitmap)
#define ID2D1DeviceContext_CreateSolidColorBrush(This, color, desc, brush)     \
  (This)->lpVtbl->CreateSolidColorBrush(This, color, desc, brush)
#define ID2D1DeviceContext_CreateLinearGradientBrush(                          \
    This, gradient_brush_desc, brush_desc, gradient, brush)                    \
  (This)->lpVtbl->CreateLinearGradientBrush(This, gradient_brush_desc,         \
                                            brush_desc, gradient, brush)
#define ID2D1DeviceContext_CreateRadialGradientBrush(                          \
    This, gradient_brush_desc, brush_desc, gradient, brush)                    \
  (This)->lpVtbl->CreateRadialGradientBrush(This, gradient_brush_desc,         \
                                            brush_desc, gradient, brush)
#define ID2D1DeviceContext_CreateCompatibleRenderTarget(                       \
    This, size, pixel_size, format, options, render_target)                    \
  (This)->lpVtbl->CreateCompatibleRenderTarget(This, size, pixel_size, format, \
...
#define ID2D1DeviceContext_DrawLine(This, p0, p1, brush, stroke_width,         \
                                    stroke_style)                              \
  (This)->lpVtbl->DrawLine(This, p0, p1, brush, stroke_width, stroke_style)
#define ID2D1DeviceContext_DrawRectangle(This, rect, brush, stroke_width,      \
                                         stroke_style)                         \
...
#define ID2D1DeviceContext_DrawRoundedRectangle(This, rect, brush,             \
                                                stroke_width, stroke_style)    \
  (This)->lpVtbl->DrawRoundedRectangle(This, rect, brush, stroke_width,        \
                                       stroke_style)
#define ID2D1DeviceContext_FillRoundedRectangle(This, rect, brush)             \
  (This)->lpVtbl->FillRoundedRectangle(This, rect, brush)
#define ID2D1DeviceContext_DrawEllipse(This, ellipse, brush, stroke_width,     \
                                       stroke_style)                           \
...
#define ID2D1DeviceContext_DrawGeometry(This, geometry, brush, stroke_width,   \
                                        stroke_style)                          \
  (This)->lpVtbl->DrawGeometry(This, geometry, brush, stroke_width,            \
                               stroke_style)
#define ID2D1DeviceContext_FillGeometry(This, geometry, brush, opacity_brush)  \
...
#define ID2D1DeviceContext_DrawText(This, string, string_len, text_format,     \
                                    layout_rect, brush, options,               \
                                    measuring_mode)                            \
  (This)->lpVtbl->DrawText(This, string, string_len, text_format, layout_rect, \
                           brush, options, measuring_mode)
#define ID2D1DeviceContext_DrawTextLayout(This, origin, layout, brush,         \
                                          options)                             \
...
#define ID2D1DeviceContext_SetAntialiasMode(This, antialias_mode)              \
...
#define ID2D1DeviceContext_SetTextAntialiasMode(This, antialias_mode)          \
...
#define ID2D1DeviceContext_SetTextRenderingParams(This, text_rendering_params) \
  (This)->lpVtbl->SetTextRenderingParams(This, text_rendering_params)
#define ID2D1DeviceContext_GetTextRenderingParams(This, text_rendering_params) \
...
#define ID2D1DeviceContext_SaveDrawingState(This, state_block)                 \
  (This)->lpVtbl->SaveDrawingState(This, state_block)
#define ID2D1DeviceContext_RestoreDrawingState(This, state_block)              \
  (This)->lpVtbl->RestoreDrawingState(This, state_block)
#define ID2D1DeviceContext_PushAxisAlignedClip(This, clip_rect,                \
                                               antialias_mode)                 \
...
#define ID2D1DeviceContext_GetPixelFormat(This)                                \
  ID2D1DeviceContext_GetPixelFormat_define_WIDL_C_INLINE_WRAPPERS_for_aggregate_return_support
#define ID2D1DeviceContext_SetDpi(This, dpi_x, dpi_y)                          \
  (This)->lpVtbl->SetDpi(This, dpi_x, dpi_y)
#define ID2D1DeviceContext_GetDpi(This, dpi_x, dpi_y)                          \
  (This)->lpVtbl->GetDpi(This, dpi_x, dpi_y)
#define ID2D1DeviceContext_GetSize(This)                                       \
  ID2D1DeviceContext_GetSize_define_WIDL_C_INLINE_WRAPPERS_for_aggregate_return_support
#define ID2D1DeviceContext_GetPixelSize(This)                                  \
  ID2D1DeviceContext_GetPixelSize_define_WIDL_C_INLINE_WRAPPERS_for_aggregate_return_support
#define ID2D1DeviceContext_GetMaximumBitmapSize(This)                          \
  (This)->lpVtbl->GetMaximumBitmapSize(This)
#define ID2D1DeviceContext_IsSupported(This, desc)                             \
  (This)->lpVtbl->IsSupported(This, desc)
/*** ID2D1DeviceContext methods ***/
#define ID2D1DeviceContext_CreateBitmap(This, size, src_data, pitch, desc,     \
                                        bitmap)                                \
  (This)->lpVtbl->ID2D1DeviceContext_CreateBitmap(This, size, src_data, pitch, \
                                                  desc, bitmap)
#define ID2D1DeviceContext_CreateBitmapFromWicBitmap(This, bitmap_source,      \
                                                     desc, bitmap)             \
  (This)->lpVtbl->ID2D1DeviceContext_CreateBitmapFromWicBitmap(                \
      This, bitmap_source, desc, bitmap)
#define ID2D1DeviceContext_CreateColorContext(This, space, profile,            \
                                              profile_size, color_context)     \
  (This)->lpVtbl->CreateColorContext(This, space, profile, profile_size,       \
                                     color_context)
#define ID2D1DeviceContext_CreateColorContextFromFilename(This, filename,      \
                                                          color_context)       \
...
#define ID2D1DeviceContext_CreateColorContextFromWicColorContext(              \
    This, wic_color_context, color_context)                                    \
  (This)->lpVtbl->CreateColorContextFromWicColorContext(                       \
      This, wic_color_context, color_context)
#define ID2D1DeviceContext_CreateBitmapFromDxgiSurface(This, surface, desc,    \
                                                       bitmap)                 \
  (This)->lpVtbl->CreateBitmapFromDxgiSurface(This, surface, desc, bitmap)
#define ID2D1DeviceContext_CreateEffect(This, effect_id, effect)               \
  (This)->lpVtbl->CreateEffect(This, effect_id, effect)
#define ID2D1DeviceContext_CreateGradientStopCollection(                       \
  ...
  (This)->lpVtbl->ID2D1DeviceContext_CreateGradientStopCollection(             \
      This, stops, stop_count, preinterpolation_space,                         \
      postinterpolation_space, buffer_precision, extend_mode,                  \
      color_interpolation_mode, gradient)
#define ID2D1DeviceContext_CreateImageBrush(This, image, image_brush_desc,     \
                                            brush_desc, brush)                 \
  (This)->lpVtbl->CreateImageBrush(This, image, image_brush_desc, brush_desc,  \
                                   brush)
#define ID2D1DeviceContext_CreateBitmapBrush(This, bitmap, bitmap_brush_desc,  \
                                             brush_desc, bitmap_brush)         \
  (This)->lpVtbl->ID2D1DeviceContext_CreateBitmapBrush(                        \
      This, bitmap, bitmap_brush_desc, brush_desc, bitmap_brush)
#define ID2D1DeviceContext_CreateCommandList(This, command_list)               \
  (This)->lpVtbl->CreateCommandList(This, command_list)
#define ID2D1DeviceContext_IsDxgiFormatSupported(This, format)                 \
  (This)->lpVtbl->IsDxgiFormatSupported(This, format)
#define ID2D1DeviceContext_IsBufferPrecisionSupported(This, buffer_precision)  \
  (This)->lpVtbl->IsBufferPrecisionSupported(This, buffer_precision)
#define ID2D1DeviceContext_GetImageLocalBounds(This, image, local_bounds)      \
  (This)->lpVtbl->GetImageLocalBounds(This, image, local_bounds)
#define ID2D1DeviceContext_GetImageWorldBounds(This, image, world_bounds)      \
  (This)->lpVtbl->GetImageWorldBounds(This, image, world_bounds)
#define ID2D1DeviceContext_GetGlyphRunWorldBounds(                             \
    This, baseline_origin, glyph_run, measuring_mode, bounds)                  \
  (This)->lpVtbl->GetGlyphRunWorldBounds(This, baseline_origin, glyph_run,     \
                                         measuring_mode, bounds)
...
#define ID2D1DeviceContext_GetTarget(This, target)                             \
  (This)->lpVtbl->GetTarget(This, target)
#define ID2D1DeviceContext_SetRenderingControls(This, rendering_controls)      \
  (This)->lpVtbl->SetRenderingControls(This, rendering_controls)
#define ID2D1DeviceContext_GetRenderingControls(This, rendering_controls)      \
  (This)->lpVtbl->GetRenderingControls(This, rendering_controls)
#define ID2D1DeviceContext_SetPrimitiveBlend(This, primitive_blend)            \
...
#define ID2D1DeviceContext_SetUnitMode(This, unit_mode)                        \
  (This)->lpVtbl->SetUnitMode(This, unit_mode)
#define ID2D1DeviceContext_GetUnitMode(This) (This)->lpVtbl->GetUnitMode(This)
#define ID2D1DeviceContext_DrawGlyphRun(This, baseline_origin, glyph_run,      \
                                        glyph_run_desc, brush, measuring_mode) \
  (This)->lpVtbl->ID2D1DeviceContext_DrawGlyphRun(                             \
      This, baseline_origin, glyph_run, glyph_run_desc, brush, measuring_mode)
#define ID2D1DeviceContext_DrawImage(This, image, target_offset, image_rect,   \
                                     interpolation_mode, composite_mode)       \
  (This)->lpVtbl->DrawImage(This, image, target_offset, image_rect,            \
                            interpolation_mode, composite_mode)
#define ID2D1DeviceContext_DrawGdiMetafile(This, metafile, target_offset)      \
  (This)->lpVtbl->DrawGdiMetafile(This, metafile, target_offset)
#define ID2D1DeviceContext_DrawBitmap(This, bitmap, dst_rect, opacity,         \
                                      interpolation_mode, src_rect,            \
                                      perspective_transform)                   \
  (This)->lpVtbl->ID2D1DeviceContext_DrawBitmap(                               \
      This, bitmap, dst_rect, opacity, interpolation_mode, src_rect,           \
      perspective_transform)
#define ID2D1DeviceContext_PushLayer(This, layer_parameters, layer)            \
  (This)->lpVtbl->ID2D1DeviceContext_PushLayer(This, layer_parameters, layer)
#define ID2D1DeviceContext_InvalidateEffectInputRectangle(This, effect, input, \
                                                          input_rect)          \
  (This)->lpVtbl->InvalidateEffectInputRectangle(This, effect, input,          \
                                                 input_rect)
#define ID2D1DeviceContext_GetEffectInvalidRectangleCount(This, effect,        \
                                                          rect_count)          \
  (This)->lpVtbl->GetEffectInvalidRectangleCount(This, effect, rect_count)
#define ID2D1DeviceContext_GetEffectInvalidRectangles(This, effect,            \
                                                      rectangles, rect_count)  \
  (This)->lpVtbl->GetEffectInvalidRectangles(This, effect, rectangles,         \
                                             rect_count)
#define ID2D1DeviceContext_GetEffectRequiredInputRectangles(                   \
    This, effect, image_rect, desc, input_rect, input_count)                   \
  (This)->lpVtbl->GetEffectRequiredInputRectangles(                            \
      This, effect, image_rect, desc, input_rect, input_count)
#define ID2D1DeviceContext_FillOpacityMask(This, mask, brush, dst_rect,        \
                                           src_rect)                           \
  (This)->lpVtbl->ID2D1DeviceContext_FillOpacityMask(This, mask, brush,        \
                                                     dst_rect, src_rect)
#endif
DEFINE_GUID(IID_ID2D1DeviceContext, 0xe8f7fe7a, 0x191c, 0x466d, 0xad, 0x95,
            0x97, 0x56, 0x78, 0xbd, 0xa9, 0x98);
__CRT_UUID_DECL(ID2D1DeviceContext, 0xe8f7fe7a, 0x191c, 0x466d, 0xad, 0x95,
                0x97, 0x56, 0x78, 0xbd, 0xa9, 0x98);
#ifndef D2D_USE_C_DEFINITIONS
interface ID2D1Device : public ID2D1Resource {
  STDMETHOD(CreateDeviceContext)(D2D1_DEVICE_CONTEXT_OPTIONS options,
                                 ID2D1DeviceContext * *deviceContext) PURE;
  STDMETHOD(CreatePrintControl)(IWICImagingFactory * wicFactory,
  ...
  HRESULT CreatePrintControl(IWICImagingFactory * wicFactory,
                             IPrintDocumentPackageTarget * documentTarget,
                             CONST D2D1_PRINT_CONTROL_PROPERTIES &
                                 printControlProperties,
                             ID2D1PrintControl * *printControl) {
    return CreatePrintControl(wicFactory, documentTarget,
                              &printControlProperties, printControl);
  }
};
#else
typedef interface ID2D1Device ID2D1Device;
typedef struct ID2D1DeviceVtbl {
  ...
  STDMETHOD(CreatePrintControl)(
      ID2D1Device *This, IWICImagingFactory *wicFactory,
      IPrintDocumentPackageTarget *documentTarget,
...
interface ID2D1Device { const ID2D1DeviceVtbl *lpVtbl; };
/*** IUnknown methods ***/
#define ID2D1Device_QueryInterface(This, riid, ppvObject)                      \
  (This)->lpVtbl->QueryInterface(This, riid, ppvObject)
...
#define ID2D1Device_GetFactory(This, factory)                                  \
  (This)->lpVtbl->GetFactory(This, factory)
/*** ID2D1Device methods ***/
#define ID2D1Device_CreateDeviceContext(This, options, context)                \
  (This)->lpVtbl->CreateDeviceContext(This, options, context)
#define ID2D1Device_CreatePrintControl(This, wic_factory, document_target,     \
                                       desc, print_control)                    \
  (This)->lpVtbl->CreatePrintControl(This, wic_factory, document_target, desc, \
                                     print_control)
#define ID2D1Device_SetMaximumTextureMemory(This, max_texture_memory)          \
...
#define ID2D1Device_ClearResources(This, msec_since_use)                       \
  (This)->lpVtbl->ClearResources(This, msec_since_use)
#endif
DEFINE_GUID(IID_ID2D1Device, 0x47dd575d, 0xac05, 0x4cdd, 0x80, 0x49, 0x9b, 0x02,
            0xcd, 0x16, 0xf4, 0x4c);
__CRT_UUID_DECL(ID2D1Device, 0x47dd575d, 0xac05, 0x4cdd, 0x80, 0x49, 0x9b, 0x02,
                0xcd, 0x16, 0xf4, 0x4c);
#ifndef D2D_USE_C_DEFINITIONS
interface ID2D1DrawingStateBlock1 : public ID2D1DrawingStateBlock {
  STDMETHOD_(void, GetDescription)(D2D1_DRAWING_STATE_DESCRIPTION1 *
                                   stateDescription) CONST PURE;
  using ID2D1DrawingStateBlock::GetDescription;
  STDMETHOD_(void, SetDescription)(CONST D2D1_DRAWING_STATE_DESCRIPTION1 *
                                   stateDescription) PURE;
...
/* FIXME: Add full C declaration */
#endif
DEFINE_GUID(IID_ID2D1DrawingStateBlock1, 0x689f1f85, 0xc72e, 0x4e33, 0x8f, 0x19,
            0x85, 0x75, 0x4e, 0xfd, 0x5a, 0xce);
__CRT_UUID_DECL(ID2D1DrawingStateBlock1, 0x689f1f85, 0xc72e, 0x4e33, 0x8f, 0x19,
                0x85, 0x75, 0x4e, 0xfd, 0x5a, 0xce);
#ifndef D2D_USE_C_DEFINITIONS
interface ID2D1PathGeometry1 : public ID2D1PathGeometry {
  STDMETHOD(ComputePointAndSegmentAtLength)(
      FLOAT length, UINT32 startSegment,
      CONST D2D1_MATRIX_3X2_F * worldTransform, FLOAT flatteningTolerance,
      D2D1_POINT_DESCRIPTION * pointDescription) CONST PURE;
  HRESULT ComputePointAndSegmentAtLength(
      FLOAT length, UINT32 startSegment,
      CONST D2D1_MATRIX_3X2_F & worldTransform, FLOAT flatteningTolerance,
      D2D1_POINT_DESCRIPTION * pointDescription) CONST {
    return ComputePointAndSegmentAtLength(length, startSegment, &worldTransform,
                                          flatteningTolerance,
                                          pointDescription);
  }
  HRESULT ComputePointAndSegmentAtLength(
...
/* FIXME: Add full C declaration */
#endif
DEFINE_GUID(IID_ID2D1PathGeometry1, 0x62baa2d2, 0xab54, 0x41b7, 0xb8, 0x72,
            0x78, 0x7e, 0x01, 0x06, 0xa4, 0x21);
__CRT_UUID_DECL(ID2D1PathGeometry1, 0x62baa2d2, 0xab54, 0x41b7, 0xb8, 0x72,
                0x78, 0x7e, 0x01, 0x06, 0xa4, 0x21);
#ifndef D2D_USE_C_DEFINITIONS
interface ID2D1Factory1 : public ID2D1Factory {
  STDMETHOD(CreateDevice)(IDXGIDevice * dxgiDevice, ID2D1Device * *d2dDevice)
      PURE;
  STDMETHOD(CreateStrokeStyle)(CONST D2D1_STROKE_STYLE_PROPERTIES1 *
  ...
  STDMETHOD(CreateGdiMetafile)(IStream * metafileStream,
                               ID2D1GdiMetafile * *metafile) PURE;
  STDMETHOD(RegisterEffectFromStream)(
      REFCLSID classId, IStream * propertyXml,
  ...
  STDMETHOD(GetRegisteredEffects)(CLSID * effects, UINT32 effectsCount,
                                  UINT32 * effectsReturned,
                                  UINT32 * effectsRegistered) CONST PURE;
  STDMETHOD(GetEffectProperties)(REFCLSID effectId,
                                 ID2D1Properties * *properties) CONST PURE;
  HRESULT CreateStrokeStyle(CONST D2D1_STROKE_STYLE_PROPERTIES1 &
                                strokeStyleProperties,
                            CONST FLOAT * dashes, UINT32 dashesCount,
  ...
  HRESULT CreateDrawingStateBlock(ID2D1DrawingStateBlock1 *
                                  *drawingStateBlock) {
...
typedef struct ID2D1Factory1Vtbl {
  ...
  STDMETHOD(CreateGdiMetafile)(ID2D1Factory1 *This, IStream *metafileStream,
                               ID2D1GdiMetafile **metafile) PURE;
  STDMETHOD(RegisterEffectFromStream)(
      ID2D1Factory1 *This, REFCLSID classId, IStream *propertyXml,
      CONST D2D1_PROPERTY_BINDING *bindings, UINT32 bindingsCount,
      CONST PD2D1_EFFECT_FACTORY effectFactory) PURE;
  STDMETHOD(RegisterEffectFromString)(
      ID2D1Factory1 *This, REFCLSID classId, PCWSTR propertyXml,
      CONST D2D1_PROPERTY_BINDING *bindings, UINT32 bindingsCount,
      CONST PD2D1_EFFECT_FACTORY effectFactory) PURE;
...
interface ID2D1Factory1 { const ID2D1Factory1Vtbl *lpVtbl; };
...
#define ID2D1Factory1_CreateDevice(this, A, B)                                 \
  (this)->lpVtbl->CreateDevice(this, A, B)
#define ID2D1Factory1_CreateStrokeStyle(this, A, B, C, D)                      \
  (this)->lpVtbl->CreateStrokeStyle(this, A, B, C, D)
#define ID2D1Factory1_CreatePathGeometry(this, A)                              \
  (this)->lpVbtl->CreatePathGeometry(this, A)
#define ID2D1Factory1_CreateDrawingStateBlock(this, A, B, C)                   \
  (this)->lpVtbl->CreateDrawingStateBlock(this, A, B, C)
#define ID2D1Factory1_CreateGdiMetafile(this, A, B)                            \
  (this)->lpVtbl->CreateGdiMetafile(this, A, B)
#define ID2D1Factory1_RegisterEffectFromStream(this, A, B, C, D, E)            \
  (this)->lpVtbl->RegisterEffectFromStream(this, A, B, C, D, E)
#define ID2D1Factory1_RegisterEffectFromString(this, A, B, C, D, E)            \
  (this)->lpVtbl->RegisterEffectFromString(this, A, B, C, D, E)
#define ID2D1Factory1_UnregisterEffect(this, A)                                \
  (this)->lpVtbl->UnregisterEffect(this, A)
#define ID2D1Factory1_GetRegisteredEffects(this, A, B, C, D)                   \
  (this)->lpVtbl->GetRegisteredEffects(this, A, B, C, D)
#define ID2D1Factory1_GetEffectProperties(this, A, B)                          \
  (this)->lpVtbl->GetEffectProperties(this, A, B)
#endif
DEFINE_GUID(IID_ID2D1Factory1, 0xbb12d362, 0xdaee, 0x4b9a, 0xaa, 0x1d, 0x14,
            0xba, 0x40, 0x1c, 0xfa, 0x1f);
__CRT_UUID_DECL(ID2D1Factory1, 0xbb12d362, 0xdaee, 0x4b9a, 0xaa, 0x1d, 0x14,
                0xba, 0x40, 0x1c, 0xfa, 0x1f);
#ifndef D2D_USE_C_DEFINITIONS
...
interface ID2D1Multithread { ID2D1MultithreadVtbl *lpVtbl; };
#define ID2D1Multithread_QueryInterface(this, A, B)                            \
...
#define ID2D1Mutlithread_GetMultithreadProtected(this)                         \
  (this)->lpVtbl->GetMultihreadProtected(this)
#define ID2D1Multithread_Enter(this) (this)->lpVtbl->Enter(this)
#define ID2D1Multithread_Leave(this) (this)->lpVtbl->Leave(this)
#endif
DEFINE_GUID(IID_ID2D1Multithread, 0x31e6e7bc, 0xe0ff, 0x4d46, 0x8c, 0x64, 0xa0,
            0xa8, 0xc4, 0x1c, 0x15, 0xd3);
__CRT_UUID_DECL(ID2D1Multithread, 0x31e6e7bc, 0xe0ff, 0x4d46, 0x8c, 0x64, 0xa0,
                0xa8, 0xc4, 0x1c, 0x15, 0xd3);
