...
DECLARE_INTERFACE_(IDxDiagContainer, IUnknown) {
  ...
  STDMETHOD(EnumChildContainerNames)(THIS_ DWORD dwIndex, LPWSTR pwszContainer,
                                     DWORD cchContainer) PURE;
  STDMETHOD(GetChildContainer)(THIS_ LPCWSTR pwszContainer,
                               IDxDiagContainer * *ppInstance) PURE;
  STDMETHOD(GetNumberOfProps)(THIS_ DWORD * pdwCount) PURE;
  STDMETHOD(EnumPropNames)(THIS_ DWORD dwIndex, LPWSTR pwszPropName,
                           DWORD cchPropName) PURE;
...
/*** IDxDiagContainer methods ***/
#define IDxDiagContainer_GetNumberOfChildContainers(p, a)                      \
  (p)->GetNumberOfChildContainers(a)
#define IDxDiagContainer_EnumChildContainerNames(p, a, b, c)                   \
