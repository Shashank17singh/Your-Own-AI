...
#endif
DEFINE_GUID(CLSID_DebugAutoAttach, 0x70f65411, 0xfe8c, 0x4248, 0xbc, 0xff, 0x70,
            0x1c, 0x8b, 0x2f, 0x45, 0x29);
...
public:
  virtual HRESULT WINAPI AutoAttach(REFGUID guidPort, DWORD dwPid,
                                    AUTOATTACH_PROGRAM_TYPE dwProgramType,
                                    DWORD dwProgramId,
                                    LPCWSTR pszSessionId) = 0;
};
#else
typedef struct IDebugAutoAttachVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IDebugAutoAttach *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IDebugAutoAttach *This);
  ULONG(WINAPI *Release)(IDebugAutoAttach *This);
  HRESULT(WINAPI *AutoAttach)(IDebugAutoAttach *This, REFGUID guidPort,
                              DWORD dwPid,
                              AUTOATTACH_PROGRAM_TYPE dwProgramType,
                              DWORD dwProgramId, LPCWSTR pszSessionId);
  END_INTERFACE
...
#define IDebugAutoAttach_AutoAttach(This, guidPort, dwPid, dwProgramType,      \
                                    dwProgramId, pszSessionId)                 \
  (This)->lpVtbl->AutoAttach(This, guidPort, dwPid, dwProgramType,             \
                             dwProgramId, pszSessionId)
#endif
#endif
HRESULT WINAPI IDebugAutoAttach_AutoAttach_Proxy(
    IDebugAutoAttach *This, REFGUID guidPort, DWORD dwPid,
    AUTOATTACH_PROGRAM_TYPE dwProgramType, DWORD dwProgramId,
