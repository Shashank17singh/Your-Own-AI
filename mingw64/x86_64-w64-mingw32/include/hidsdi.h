...
BOOLEAN NTAPI HidD_GetInputReport(HANDLE HidDeviceObject, PVOID ReportBuffer,
                                  ULONG ReportBufferLength);
BOOLEAN NTAPI HidD_GetIndexedString(HANDLE HidDeviceObject, ULONG StringIndex,
                                    PVOID Buffer, ULONG BufferLength);
BOOLEAN NTAPI HidD_GetManufacturerString(HANDLE HidDeviceObject, PVOID Buffer,
                                         ULONG BufferLength);
BOOLEAN NTAPI HidD_GetMsGenreDescriptor(HANDLE HidDeviceObject, PVOID Buffer,
                                        ULONG BufferLength);
BOOLEAN NTAPI HidD_GetNumInputBuffers(HANDLE HidDeviceObject,
                                      PULONG NumberBuffers);
BOOLEAN NTAPI HidD_GetPhysicalDescriptor(HANDLE HidDeviceObject, PVOID Buffer,
                                         ULONG BufferLength);
...
BOOLEAN NTAPI HidD_GetProductString(HANDLE HidDeviceObject, PVOID Buffer,
                                    ULONG BufferLength);
BOOLEAN NTAPI HidD_GetSerialNumberString(HANDLE HidDeviceObject, PVOID Buffer,
                                         ULONG BufferLength);
...
BOOLEAN NTAPI HidD_SetFeature(HANDLE HidDeviceObject, PVOID ReportBuffer,
                              ULONG ReportBufferLength);
BOOLEAN NTAPI HidD_SetNumInputBuffers(HANDLE HidDeviceObject,
                                      ULONG NumberBuffers);
BOOLEAN NTAPI HidD_SetOutputReport(HANDLE HidDeviceObject, PVOID ReportBuffer,
                                   ULONG ReportBufferLength);
#include <poppack.h>
#endif
#ifdef __cplusplus
