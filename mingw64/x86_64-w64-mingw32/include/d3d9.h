...
DECLARE_INTERFACE_IID_(IDirect3D9, IUnknown,
  ...
  STDMETHOD(GetAdapterIdentifier)(THIS_ UINT Adapter, DWORD Flags,
                                  D3DADAPTER_IDENTIFIER9 * pIdentifier) PURE;
  STDMETHOD_(UINT, GetAdapterModeCount)(THIS_ UINT Adapter, D3DFORMAT Format)
      PURE;
  STDMETHOD(EnumAdapterModes)(THIS_ UINT Adapter, D3DFORMAT Format, UINT Mode,
  ...
  STDMETHOD(CheckDeviceType)(
      THIS_ UINT iAdapter, D3DDEVTYPE DevType, D3DFORMAT DisplayFormat,
  ...
  STDMETHOD(GetDeviceCaps)(THIS_ UINT Adapter, D3DDEVTYPE DeviceType,
                           D3DCAPS9 * pCaps) PURE;
...
__CRT_UUID_DECL(IDirect3D9, 0x81BDCBCA, 0x64D4, 0x426D, 0xAE, 0x8D, 0xAD, 0x1,
                0x47, 0xF4, 0x27, 0x5C);
#endif
...
DECLARE_INTERFACE_IID_(IDirect3DVolume9, IUnknown,
  ...
  STDMETHOD(SetPrivateData)(THIS_ REFGUID guid, const void *data,
                            DWORD data_size, DWORD flags) PURE;
  STDMETHOD(GetPrivateData)(THIS_ REFGUID refguid, void *pData,
                            DWORD *pSizeOfData) PURE;
  STDMETHOD(FreePrivateData)(THIS_ REFGUID refguid) PURE;
  STDMETHOD(GetContainer)(THIS_ REFIID riid, void **ppContainer) PURE;
  STDMETHOD(GetDesc)(THIS_ D3DVOLUME_DESC * pDesc) PURE;
  STDMETHOD(LockBox)(THIS_ D3DLOCKED_BOX * locked_box, const D3DBOX *box,
                     DWORD flags) PURE;
  STDMETHOD(UnlockBox)(THIS) PURE;
};
#undef INTERFACE
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDirect3DVolume9, 0x24f416e6, 0x1f67, 0x4aa7, 0xb8, 0x8e, 0xd3,
                0x3f, 0x6f, 0x31, 0x28, 0xa1);
#endif
#if !defined(__cplusplus) || defined(CINTERFACE)
/*** IUnknown methods ***/
...
DECLARE_INTERFACE_IID_(IDirect3DSwapChain9, IUnknown,
  ...
  STDMETHOD(Present)(THIS_ const RECT *src_rect, const RECT *dst_rect,
                     ...
                     DWORD flags) PURE;
  STDMETHOD(GetFrontBufferData)(THIS_ struct IDirect3DSurface9 * pDestSurface)
      PURE;
...
#undef INTERFACE
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDirect3DSwapChain9, 0x794950f2, 0xadfc, 0x458a, 0x90, 0x5e,
                0x10, 0xa1, 0xb, 0xb, 0x50, 0x3b);
#endif
#if !defined(__cplusplus) || defined(CINTERFACE)
/*** IUnknown methods ***/
...
DECLARE_INTERFACE_IID_(IDirect3DResource9, IUnknown,
...
#undef INTERFACE
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDirect3DResource9, 0x5eec05d, 0x8f7d, 0x4362, 0xb9, 0x99, 0xd1,
                0xba, 0xf3, 0x57, 0xc7, 0x4);
#endif
#if !defined(__cplusplus) || defined(CINTERFACE)
/*** IUnknown methods ***/
...
DECLARE_INTERFACE_IID_(IDirect3DSurface9, IDirect3DResource9,
  ...
  STDMETHOD(LockRect)(THIS_ D3DLOCKED_RECT * locked_rect, const RECT *rect,
                      DWORD flags) PURE;
...
#undef INTERFACE
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDirect3DSurface9, 0xcfbaf3a, 0x9ff6, 0x429a, 0x99, 0xb3, 0xa2,
                0x79, 0x6a, 0xf8, 0xb8, 0x9b);
#endif
#if !defined(__cplusplus) || defined(CINTERFACE)
/*** IUnknown methods ***/
...
DECLARE_INTERFACE_IID_(IDirect3DVertexBuffer9, IDirect3DResource9,
  ...
  STDMETHOD(Lock)(THIS_ UINT OffsetToLock, UINT SizeToLock, void **ppbData,
                  DWORD Flags) PURE;
...
#undef INTERFACE
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDirect3DVertexBuffer9, 0xb64bb1b5, 0xfd70, 0x4df6, 0xbf, 0x91,
                0x19, 0xd0, 0xa1, 0x24, 0x55, 0xe3);
#endif
#if !defined(__cplusplus) || defined(CINTERFACE)
/*** IUnknown methods ***/
...
DECLARE_INTERFACE_IID_(IDirect3DIndexBuffer9, IDirect3DResource9,
...
#undef INTERFACE
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDirect3DIndexBuffer9, 0x7c9dd65e, 0xd3f7, 0x4529, 0xac, 0xee,
                0x78, 0x58, 0x30, 0xac, 0xde, 0x35);
#endif
#if !defined(__cplusplus) || defined(CINTERFACE)
/*** IUnknown methods ***/
...
DECLARE_INTERFACE_IID_(IDirect3DBaseTexture9, IDirect3DResource9,
...
#undef INTERFACE
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDirect3DBaseTexture9, 0x580ca87e, 0x1d3c, 0x4d54, 0x99, 0x1d,
                0xb7, 0xd3, 0xe3, 0xc2, 0x98, 0xce);
#endif
#if !defined(__cplusplus) || defined(CINTERFACE)
/*** IUnknown methods ***/
...
DECLARE_INTERFACE_IID_(IDirect3DCubeTexture9, IDirect3DBaseTexture9,
  ...
  STDMETHOD(LockRect)(THIS_ D3DCUBEMAP_FACES face, UINT level,
                      D3DLOCKED_RECT * locked_rect, const RECT *rect,
                      DWORD flags) PURE;
  STDMETHOD(UnlockRect)(THIS_ D3DCUBEMAP_FACES FaceType, UINT Level) PURE;
  STDMETHOD(AddDirtyRect)(THIS_ D3DCUBEMAP_FACES face, const RECT *dirty_rect)
      PURE;
};
#undef INTERFACE
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDirect3DCubeTexture9, 0xfff32f81, 0xd953, 0x473a, 0x92, 0x23,
                0x93, 0xd6, 0x52, 0xab, 0xa9, 0x3f);
#endif
#if !defined(__cplusplus) || defined(CINTERFACE)
/*** IUnknown methods ***/
...
DECLARE_INTERFACE_IID_(IDirect3DTexture9, IDirect3DBaseTexture9,
  ...
  STDMETHOD(GetLevelDesc)(THIS_ UINT Level, D3DSURFACE_DESC * pDesc) PURE;
  STDMETHOD(GetSurfaceLevel)(THIS_ UINT Level,
                             IDirect3DSurface9 * *ppSurfaceLevel) PURE;
  STDMETHOD(LockRect)(THIS_ UINT level, D3DLOCKED_RECT * locked_rect,
...
#undef INTERFACE
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDirect3DTexture9, 0x85c31227, 0x3de5, 0x4f00, 0x9b, 0x3a, 0xf1,
                0x1a, 0xc3, 0x8c, 0x18, 0xb5);
#endif
#if !defined(__cplusplus) || defined(CINTERFACE)
/*** IUnknown methods ***/
...
DECLARE_INTERFACE_IID_(IDirect3DVolumeTexture9, IDirect3DBaseTexture9,
  ...
  STDMETHOD(GetVolumeLevel)(THIS_ UINT Level, IDirect3DVolume9 * *ppVolumeLevel)
      PURE;
  STDMETHOD(LockBox)(THIS_ UINT level, D3DLOCKED_BOX * locked_box,
                     const D3DBOX *box, DWORD flags) PURE;
  STDMETHOD(UnlockBox)(THIS_ UINT Level) PURE;
  STDMETHOD(AddDirtyBox)(THIS_ const D3DBOX *dirty_box) PURE;
};
#undef INTERFACE
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDirect3DVolumeTexture9, 0x2518526c, 0xe789, 0x4111, 0xa7, 0xb9,
                0x47, 0xef, 0x32, 0x8d, 0x13, 0xe6);
#endif
#if !defined(__cplusplus) || defined(CINTERFACE)
/*** IUnknown methods ***/
...
DECLARE_INTERFACE_IID_(IDirect3DVertexDeclaration9, IUnknown,
  ...
  STDMETHOD(GetDevice)(THIS_ struct IDirect3DDevice9 * *ppDevice) PURE;
  STDMETHOD(GetDeclaration)(THIS_ D3DVERTEXELEMENT9 *, UINT * pNumElements)
      PURE;
};
#undef INTERFACE
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDirect3DVertexDeclaration9, 0xdd13c59c, 0x36fa, 0x4098, 0xa8,
                0xfb, 0xc7, 0xed, 0x39, 0xdc, 0x85, 0x46);
#endif
#if !defined(__cplusplus) || defined(CINTERFACE)
/*** IUnknown methods ***/
...
DECLARE_INTERFACE_IID_(IDirect3DVertexShader9, IUnknown,
...
#undef INTERFACE
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDirect3DVertexShader9, 0xefc5557e, 0x6265, 0x4613, 0x8a, 0x94,
                0x43, 0x85, 0x78, 0x89, 0xeb, 0x36);
#endif
#if !defined(__cplusplus) || defined(CINTERFACE)
/*** IUnknown methods ***/
...
DECLARE_INTERFACE_IID_(IDirect3DPixelShader9, IUnknown,
...
#undef INTERFACE
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDirect3DPixelShader9, 0x6d3bdbdc, 0x5b02, 0x4415, 0xb8, 0x52,
                0xce, 0x5e, 0x8b, 0xcc, 0xb2, 0x89);
#endif
#if !defined(__cplusplus) || defined(CINTERFACE)
/*** IUnknown methods ***/
...
DECLARE_INTERFACE_IID_(IDirect3DStateBlock9, IUnknown,
...
#undef INTERFACE
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDirect3DStateBlock9, 0xb07c4fe5, 0x310d, 0x4ba8, 0xa2, 0x3c,
                0x4f, 0xf, 0x20, 0x6f, 0x21, 0x8b);
#endif
#if !defined(__cplusplus) || defined(CINTERFACE)
/*** IUnknown methods ***/
...
#undef INTERFACE
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDirect3DQuery9, 0xd9771460, 0xa695, 0x4f26, 0xbb, 0xd3, 0x27,
                0xb8, 0x40, 0xb5, 0x41, 0xcc);
#endif
#if !defined(__cplusplus) || defined(CINTERFACE)
/*** IUnknown methods ***/
...
DECLARE_INTERFACE_IID_(IDirect3DDevice9, IUnknown,
  ...
  STDMETHOD(GetCreationParameters)(THIS_ D3DDEVICE_CREATION_PARAMETERS *
                                   pParameters) PURE;
  STDMETHOD(SetCursorProperties)(THIS_ UINT XHotSpot, UINT YHotSpot,
                                 IDirect3DSurface9 * pCursorBitmap) PURE;
  ...
  STDMETHOD(GetSwapChain)(THIS_ UINT iSwapChain,
                          IDirect3DSwapChain9 * *pSwapChain) PURE;
  ...
  STDMETHOD(Present)(THIS_ const RECT *src_rect, const RECT *dst_rect,
                     HWND dst_window_override, const RGNDATA *dirty_region)
      PURE;
  STDMETHOD(GetBackBuffer)(THIS_ UINT iSwapChain, UINT iBackBuffer,
                           D3DBACKBUFFER_TYPE Type,
                           IDirect3DSurface9 * *ppBackBuffer) PURE;
  STDMETHOD(GetRasterStatus)(THIS_ UINT iSwapChain,
                             D3DRASTER_STATUS * pRasterStatus) PURE;
  STDMETHOD(SetDialogBoxMode)(THIS_ WINBOOL bEnableDialogs) PURE;
  STDMETHOD_(void, SetGammaRamp)(THIS_ UINT swapchain_idx, DWORD flags,
                                 const D3DGAMMARAMP *ramp) PURE;
  ...
  STDMETHOD(CreateVolumeTexture)(
      ...
      IDirect3DVolumeTexture9 * *ppVolumeTexture, HANDLE * pSharedHandle) PURE;
  ...
  STDMETHOD(CreateRenderTarget)(THIS_ UINT Width, UINT Height, D3DFORMAT Format,
                                ...
                                DWORD MultisampleQuality, WINBOOL Lockable,
  ...
  STDMETHOD(CreateDepthStencilSurface)(
      ...
      PURE;
  STDMETHOD(UpdateSurface)(THIS_ IDirect3DSurface9 * src_surface,
                           const RECT *src_rect, IDirect3DSurface9 *dst_surface,
                           const POINT *dst_point) PURE;
  STDMETHOD(UpdateTexture)(THIS_ IDirect3DBaseTexture9 * pSourceTexture,
                           IDirect3DBaseTexture9 * pDestinationTexture) PURE;
  STDMETHOD(GetRenderTargetData)(THIS_ IDirect3DSurface9 * pRenderTarget,
                                 IDirect3DSurface9 * pDestSurface) PURE;
  STDMETHOD(GetFrontBufferData)(THIS_ UINT iSwapChain,
                                IDirect3DSurface9 * pDestSurface) PURE;
  STDMETHOD(StretchRect)(THIS_ IDirect3DSurface9 * src_surface,
                         const RECT *src_rect, IDirect3DSurface9 *dst_surface,
                         const RECT *dst_rect, D3DTEXTUREFILTERTYPE filter)
      PURE;
  STDMETHOD(ColorFill)(THIS_ IDirect3DSurface9 * surface, const RECT *rect,
                       D3DCOLOR color) PURE;
  ...
  STDMETHOD(SetRenderTarget)(THIS_ DWORD RenderTargetIndex,
                             IDirect3DSurface9 * pRenderTarget) PURE;
  STDMETHOD(GetRenderTarget)(THIS_ DWORD RenderTargetIndex,
                             IDirect3DSurface9 * *ppRenderTarget) PURE;
  STDMETHOD(SetDepthStencilSurface)(THIS_ IDirect3DSurface9 * pNewZStencil)
      PURE;
  STDMETHOD(GetDepthStencilSurface)(THIS_ IDirect3DSurface9 *
                                    *ppZStencilSurface) PURE;
  ...
  STDMETHOD(SetTransform)(THIS_ D3DTRANSFORMSTATETYPE state,
                          const D3DMATRIX *matrix) PURE;
  STDMETHOD(GetTransform)(THIS_ D3DTRANSFORMSTATETYPE State,
                          D3DMATRIX * pMatrix) PURE;
  STDMETHOD(MultiplyTransform)(THIS_ D3DTRANSFORMSTATETYPE state,
                               const D3DMATRIX *matrix) PURE;
  ...
  STDMETHOD(GetRenderState)(THIS_ D3DRENDERSTATETYPE State, DWORD * pValue)
      PURE;
  STDMETHOD(CreateStateBlock)(THIS_ D3DSTATEBLOCKTYPE Type,
                              IDirect3DStateBlock9 * *ppSB) PURE;
  ...
  STDMETHOD(GetSamplerState)(THIS_ DWORD Sampler, D3DSAMPLERSTATETYPE Type,
                             DWORD * pValue) PURE;
  STDMETHOD(SetSamplerState)(THIS_ DWORD Sampler, D3DSAMPLERSTATETYPE Type,
                             DWORD Value) PURE;
  STDMETHOD(ValidateDevice)(THIS_ DWORD * pNumPasses) PURE;
  STDMETHOD(SetPaletteEntries)(THIS_ UINT palette_idx,
                               const PALETTEENTRY *entries) PURE;
  STDMETHOD(GetPaletteEntries)(THIS_ UINT PaletteNumber,
                               PALETTEENTRY * pEntries) PURE;
  ...
  STDMETHOD(DrawPrimitive)(THIS_ D3DPRIMITIVETYPE PrimitiveType,
                           UINT StartVertex, UINT PrimitiveCount) PURE;
  STDMETHOD(DrawIndexedPrimitive)(THIS_ D3DPRIMITIVETYPE, INT BaseVertexIndex,
                                  UINT MinVertexIndex, UINT NumVertices,
                                  UINT startIndex, UINT primCount) PURE;
  STDMETHOD(DrawPrimitiveUP)(THIS_ D3DPRIMITIVETYPE primitive_type,
                             UINT primitive_count, const void *data,
                             UINT stride) PURE;
  STDMETHOD(DrawIndexedPrimitiveUP)(
      THIS_ D3DPRIMITIVETYPE primitive_type, UINT min_vertex_idx,
      UINT vertex_count, UINT primitive_count, const void *index_data,
      D3DFORMAT index_format, const void *data, UINT stride) PURE;
  ...
  STDMETHOD(CreateVertexShader)(THIS_ const DWORD *byte_code,
                                IDirect3DVertexShader9 **shader) PURE;
  STDMETHOD(SetVertexShader)(THIS_ IDirect3DVertexShader9 * pShader) PURE;
  STDMETHOD(GetVertexShader)(THIS_ IDirect3DVertexShader9 * *ppShader) PURE;
  STDMETHOD(SetVertexShaderConstantF)(THIS_ UINT reg_idx, const float *data,
                                      UINT count) PURE;
  STDMETHOD(GetVertexShaderConstantF)(
      THIS_ UINT StartRegister, float *pConstantData, UINT Vector4fCount) PURE;
  STDMETHOD(SetVertexShaderConstantI)(THIS_ UINT reg_idx, const int *data,
                                      UINT count) PURE;
  STDMETHOD(GetVertexShaderConstantI)(
      THIS_ UINT StartRegister, int *pConstantData, UINT Vector4iCount) PURE;
  STDMETHOD(SetVertexShaderConstantB)(THIS_ UINT reg_idx, const WINBOOL *data,
                                      UINT count) PURE;
  STDMETHOD(GetVertexShaderConstantB)(
      THIS_ UINT StartRegister, WINBOOL * pConstantData, UINT BoolCount) PURE;
  STDMETHOD(SetStreamSource)(THIS_ UINT StreamNumber,
                             IDirect3DVertexBuffer9 * pStreamData,
                             UINT OffsetInBytes, UINT Stride) PURE;
  STDMETHOD(GetStreamSource)(THIS_ UINT StreamNumber,
  ...
  STDMETHOD(CreatePixelShader)(THIS_ const DWORD *byte_code,
                               IDirect3DPixelShader9 **shader) PURE;
  STDMETHOD(SetPixelShader)(THIS_ IDirect3DPixelShader9 * pShader) PURE;
  STDMETHOD(GetPixelShader)(THIS_ IDirect3DPixelShader9 * *ppShader) PURE;
  STDMETHOD(SetPixelShaderConstantF)(THIS_ UINT reg_idx, const float *data,
                                     UINT count) PURE;
  STDMETHOD(GetPixelShaderConstantF)(
      THIS_ UINT StartRegister, float *pConstantData, UINT Vector4fCount) PURE;
  STDMETHOD(SetPixelShaderConstantI)(THIS_ UINT reg_idx, const int *data,
                                     UINT count) PURE;
  STDMETHOD(GetPixelShaderConstantI)(
      THIS_ UINT StartRegister, int *pConstantData, UINT Vector4iCount) PURE;
  STDMETHOD(SetPixelShaderConstantB)(THIS_ UINT reg_idx, const WINBOOL *data,
                                     UINT count) PURE;
...
#undef INTERFACE
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDirect3DDevice9, 0xd0223b96, 0xbf7a, 0x43fd, 0x92, 0xbd, 0xa4,
                0x3b, 0xd, 0x82, 0xb9, 0xeb);
#endif
#if !defined(__cplusplus) || defined(CINTERFACE)
/*** IUnknown methods ***/
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDirect3D9Ex, 0x02177241, 0x69fc, 0x400c, 0x8f, 0xf1, 0x93,
...
DECLARE_INTERFACE_IID_(IDirect3D9Ex, IDirect3D9,
  ...
  STDMETHOD_(UINT, GetAdapterCount)(THIS) PURE;
  STDMETHOD(GetAdapterIdentifier)(THIS_ UINT adapter_idx, DWORD flags,
                                  D3DADAPTER_IDENTIFIER9 * identifier) PURE;
  STDMETHOD_(UINT, GetAdapterModeCount)(THIS_ UINT adapter_idx,
                                        D3DFORMAT format) PURE;
  STDMETHOD(EnumAdapterModes)(THIS_ UINT adapter_idx, D3DFORMAT format,
                              UINT mode_idx, D3DDISPLAYMODE * mode) PURE;
  STDMETHOD(GetAdapterDisplayMode)(THIS_ UINT adapter_idx,
                                   D3DDISPLAYMODE * mode) PURE;
  STDMETHOD(CheckDeviceType)(
      THIS_ UINT adapter_idx, D3DDEVTYPE device_type, D3DFORMAT display_format,
      D3DFORMAT backbuffer_format, WINBOOL windowed) PURE;
  STDMETHOD(CheckDeviceFormat)(
      THIS_ UINT adapter_idx, D3DDEVTYPE device_type, D3DFORMAT adapter_format,
      DWORD usage, D3DRESOURCETYPE resource_type, D3DFORMAT format) PURE;
  STDMETHOD(CheckDeviceMultiSampleType)(
      THIS_ UINT adapter_idx, D3DDEVTYPE device_type, D3DFORMAT surface_format,
  ...
  STDMETHOD(CheckDeviceFormatConversion)(
      THIS_ UINT adapter_idx, D3DDEVTYPE device_type, D3DFORMAT src_format,
      D3DFORMAT dst_format) PURE;
  STDMETHOD(GetDeviceCaps)(THIS_ UINT adapter_idx, D3DDEVTYPE device_type,
                           D3DCAPS9 * caps) PURE;
  STDMETHOD_(HMONITOR, GetAdapterMonitor)(THIS_ UINT adapter_idx) PURE;
  STDMETHOD(CreateDevice)(THIS_ UINT adapter_idx, D3DDEVTYPE device_type,
                          HWND focus_window, DWORD flags,
                          D3DPRESENT_PARAMETERS * parameters,
                          struct IDirect3DDevice9 * *device) PURE;
  /* IDirect3D9Ex */
  STDMETHOD_(UINT, GetAdapterModeCountEx)(
      THIS_ UINT adapter_idx, const D3DDISPLAYMODEFILTER *filter) PURE;
  STDMETHOD(EnumAdapterModesEx)(THIS_ UINT adapter_idx,
  ...
  STDMETHOD(CreateDeviceEx)(
      THIS_ UINT adapter_idx, D3DDEVTYPE device_type, HWND focus_window,
      DWORD flags, D3DPRESENT_PARAMETERS * parameters, D3DDISPLAYMODEEX * mode,
...
/* IDirect3D9 */
#define IDirect3D9Ex_RegisterSoftwareDevice(p, a)                              \
  (p)->lpVtbl->RegisterSoftwareDevice(p, a)
...
#endif
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDirect3DSwapChain9Ex, 0x91886caf, 0x1c3d, 0x4d2e, 0xa0, 0xab,
...
DECLARE_INTERFACE_IID_(IDirect3DSwapChain9Ex, IDirect3DSwapChain9,
  ...
  STDMETHOD(Present)(THIS_ const RECT *src_rect, const RECT *dst_rect,
                     HWND dst_window_override, const RGNDATA *dirty_region,
                     DWORD flags) PURE;
  STDMETHOD(GetFrontBufferData)(THIS_ struct IDirect3DSurface9 * dst_surface)
      PURE;
  STDMETHOD(GetBackBuffer)(THIS_ UINT backbuffer_idx,
  ...
  STDMETHOD(GetPresentParameters)(THIS_ D3DPRESENT_PARAMETERS * parameters)
      PURE;
  ...
  STDMETHOD(GetDisplayModeEx)(THIS_ D3DDISPLAYMODEEX * mode,
                              D3DDISPLAYROTATION * rotation) PURE;
};
#undef INTERFACE
#if !defined(__cplusplus) || defined(CINTERFACE)
...
#endif
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDirect3DDevice9Ex, 0xb18b10ce, 0x2649, 0x405a, 0x87, 0xf, 0x95,
...
DECLARE_INTERFACE_IID_(IDirect3DDevice9Ex, IDirect3DDevice9,
  ...
  STDMETHOD(GetDisplayMode)(THIS_ UINT swapchain_idx, D3DDISPLAYMODE * mode)
      PURE;
  STDMETHOD(GetCreationParameters)(THIS_ D3DDEVICE_CREATION_PARAMETERS *
                                   parameters) PURE;
  STDMETHOD(SetCursorProperties)(THIS_ UINT hotspot_x, UINT hotspot_y,
                                 IDirect3DSurface9 * bitmap) PURE;
  STDMETHOD_(void, SetCursorPosition)(THIS_ int x, int y, DWORD flags) PURE;
  ...
  STDMETHOD(GetSwapChain)(THIS_ UINT swapchain_idx,
                          IDirect3DSwapChain9 * *swapchain) PURE;
  STDMETHOD_(UINT, GetNumberOfSwapChains)(THIS) PURE;
  ...
  STDMETHOD(GetRasterStatus)(THIS_ UINT swapchain_idx,
                             D3DRASTER_STATUS * raster_status) PURE;
  STDMETHOD(SetDialogBoxMode)(THIS_ WINBOOL enable) PURE;
  STDMETHOD_(void, SetGammaRamp)(THIS_ UINT swapchain_idx, DWORD flags,
                                 const D3DGAMMARAMP *ramp) PURE;
  STDMETHOD_(void, GetGammaRamp)(THIS_ UINT swapchain_idx, D3DGAMMARAMP * ramp)
      PURE;
  ...
  STDMETHOD(CreateCubeTexture)(THIS_ UINT edge_length, UINT levels, DWORD usage,
                               ...
                               HANDLE * shared_handle) PURE;
  STDMETHOD(CreateVertexBuffer)(THIS_ UINT size, DWORD usage, DWORD fvf,
                                D3DPOOL pool, IDirect3DVertexBuffer9 * *buffer,
                                HANDLE * shared_handle) PURE;
  STDMETHOD(CreateIndexBuffer)(THIS_ UINT size, DWORD usage, D3DFORMAT format,
                               D3DPOOL pool, IDirect3DIndexBuffer9 * *buffer,
                               HANDLE * shared_handle) PURE;
  STDMETHOD(CreateRenderTarget)(THIS_ UINT width, UINT height, D3DFORMAT format,
  ...
  STDMETHOD(UpdateSurface)(THIS_ IDirect3DSurface9 * src_surface,
                           const RECT *src_rect, IDirect3DSurface9 *dst_surface,
                           const POINT *dst_point) PURE;
  STDMETHOD(UpdateTexture)(THIS_ IDirect3DBaseTexture9 * src_texture,
                           IDirect3DBaseTexture9 * dst_texture) PURE;
  STDMETHOD(GetRenderTargetData)(THIS_ IDirect3DSurface9 * render_target,
                                 IDirect3DSurface9 * dst_surface) PURE;
  STDMETHOD(GetFrontBufferData)(THIS_ UINT swapchain_idx,
                                IDirect3DSurface9 * dst_surface) PURE;
  STDMETHOD(StretchRect)(THIS_ IDirect3DSurface9 * src_surface,
                         const RECT *src_rect, IDirect3DSurface9 *dst_surface,
                         const RECT *dst_rect, D3DTEXTUREFILTERTYPE filter)
  ...
  STDMETHOD(GetRenderTarget)(THIS_ DWORD idx, IDirect3DSurface9 * *surface)
      PURE;
  STDMETHOD(SetDepthStencilSurface)(THIS_ IDirect3DSurface9 * depth_stencil)
      PURE;
  STDMETHOD(GetDepthStencilSurface)(THIS_ IDirect3DSurface9 * *depth_stencil)
      PURE;
  STDMETHOD(BeginScene)(THIS) PURE;
  STDMETHOD(EndScene)(THIS) PURE;
  STDMETHOD(Clear)(THIS_ DWORD rect_count, const D3DRECT *rects, DWORD flags,
  ...
  STDMETHOD(SetTransform)(THIS_ D3DTRANSFORMSTATETYPE state,
                          const D3DMATRIX *matrix) PURE;
  STDMETHOD(GetTransform)(THIS_ D3DTRANSFORMSTATETYPE State, D3DMATRIX * matrix)
      PURE;
  STDMETHOD(MultiplyTransform)(THIS_ D3DTRANSFORMSTATETYPE state,
                               const D3DMATRIX *matrix) PURE;
  STDMETHOD(SetViewport)(THIS_ const D3DVIEWPORT9 *viewport) PURE;
  ...
  STDMETHOD(CreateStateBlock)(THIS_ D3DSTATEBLOCKTYPE type,
                              IDirect3DStateBlock9 * *stateblock) PURE;
  STDMETHOD(BeginStateBlock)(THIS) PURE;
  ...
  STDMETHOD(GetTexture)(THIS_ DWORD stage, IDirect3DBaseTexture9 * *texture)
      PURE;
  STDMETHOD(SetTexture)(THIS_ DWORD stage, IDirect3DBaseTexture9 * texture)
      PURE;
  STDMETHOD(GetTextureStageState)(
      THIS_ DWORD stage, D3DTEXTURESTAGESTATETYPE state, DWORD * value) PURE;
  STDMETHOD(SetTextureStageState)(
      THIS_ DWORD stage, D3DTEXTURESTAGESTATETYPE state, DWORD value) PURE;
  STDMETHOD(GetSamplerState)(THIS_ DWORD sampler_idx, D3DSAMPLERSTATETYPE state,
                             DWORD * value) PURE;
  STDMETHOD(SetSamplerState)(THIS_ DWORD sampler_idx, D3DSAMPLERSTATETYPE state,
                             DWORD value) PURE;
  STDMETHOD(ValidateDevice)(THIS_ DWORD * pass_count) PURE;
  STDMETHOD(SetPaletteEntries)(THIS_ UINT palette_idx,
                               const PALETTEENTRY *entries) PURE;
  STDMETHOD(GetPaletteEntries)(THIS_ UINT palette_idx, PALETTEENTRY * entries)
      PURE;
  ...
  STDMETHOD_(float, GetNPatchMode)(THIS) PURE;
  STDMETHOD(DrawPrimitive)(THIS_ D3DPRIMITIVETYPE primitive_type,
                           UINT start_vertex, UINT primitive_count) PURE;
  STDMETHOD(DrawIndexedPrimitive)(THIS_ D3DPRIMITIVETYPE primitive_type,
                                  INT base_vertex_idx, UINT min_vertex_idx,
                                  UINT vertex_count, UINT start_idx,
                                  UINT primitive_count) PURE;
  STDMETHOD(DrawPrimitiveUP)(THIS_ D3DPRIMITIVETYPE primitive_type,
                             UINT primitive_count, const void *data,
                             UINT stride) PURE;
  STDMETHOD(DrawIndexedPrimitiveUP)(
      ...
      D3DFORMAT index_format, const void *data, UINT stride) PURE;
  STDMETHOD(ProcessVertices)(
      THIS_ UINT src_start_idx, UINT dst_idx, UINT vertex_count,
      IDirect3DVertexBuffer9 * dst_buffer,
      IDirect3DVertexDeclaration9 * declaration, DWORD flags) PURE;
  STDMETHOD(CreateVertexDeclaration)(THIS_ const D3DVERTEXELEMENT9 *elements,
                                     IDirect3DVertexDeclaration9 **declaration)
      PURE;
  STDMETHOD(SetVertexDeclaration)(THIS_ IDirect3DVertexDeclaration9 *
                                  declaration) PURE;
  STDMETHOD(GetVertexDeclaration)(THIS_ IDirect3DVertexDeclaration9 *
                                  *declaration) PURE;
  STDMETHOD(SetFVF)(THIS_ DWORD fvf) PURE;
  ...
  STDMETHOD(SetVertexShaderConstantF)(THIS_ UINT reg_idx, const float *data,
                                      UINT count) PURE;
  STDMETHOD(GetVertexShaderConstantF)(THIS_ UINT reg_idx, float *data,
                                      UINT count) PURE;
  STDMETHOD(SetVertexShaderConstantI)(THIS_ UINT reg_idx, const int *data,
                                      UINT count) PURE;
  STDMETHOD(GetVertexShaderConstantI)(THIS_ UINT reg_idx, int *data, UINT count)
      PURE;
  STDMETHOD(SetVertexShaderConstantB)(THIS_ UINT reg_idx, const WINBOOL *data,
                                      UINT count) PURE;
  STDMETHOD(GetVertexShaderConstantB)(THIS_ UINT reg_idx, WINBOOL * data,
                                      UINT count) PURE;
  STDMETHOD(SetStreamSource)(THIS_ UINT stream_idx,
                             IDirect3DVertexBuffer9 * buffer, UINT offset,
                             UINT stride) PURE;
  STDMETHOD(GetStreamSource)(THIS_ UINT stream_idx,
                             IDirect3DVertexBuffer9 * *buffer, UINT * offset,
                             UINT * stride) PURE;
  ...
  STDMETHOD(SetPixelShaderConstantF)(THIS_ UINT reg_idx, const float *data,
                                     UINT count) PURE;
  STDMETHOD(GetPixelShaderConstantF)(THIS_ UINT reg_idx, float *data,
                                     UINT count) PURE;
  STDMETHOD(SetPixelShaderConstantI)(THIS_ UINT reg_idx, const int *data,
                                     UINT count) PURE;
  STDMETHOD(GetPixelShaderConstantI)(THIS_ UINT reg_idx, int *data, UINT count)
      PURE;
  STDMETHOD(SetPixelShaderConstantB)(THIS_ UINT reg_idx, const WINBOOL *data,
                                     UINT count) PURE;
  STDMETHOD(GetPixelShaderConstantB)(THIS_ UINT reg_idx, WINBOOL * data,
                                     UINT count) PURE;
  STDMETHOD(DrawRectPatch)(THIS_ UINT handle, const float *segment_count,
                           const D3DRECTPATCH_INFO *patch_info) PURE;
  STDMETHOD(DrawTriPatch)(THIS_ UINT handle, const float *segment_count,
                          const D3DTRIPATCH_INFO *patch_info) PURE;
  STDMETHOD(DeletePatch)(THIS_ UINT handle) PURE;
  STDMETHOD(CreateQuery)(THIS_ D3DQUERYTYPE type, IDirect3DQuery9 * *query)
      PURE;
  /* IDirect3DDevice9Ex */
  STDMETHOD(SetConvolutionMonoKernel)(THIS_ UINT width, UINT height,
                                      float *rows, float *columns) PURE;
  STDMETHOD(ComposeRects)(
      THIS_ IDirect3DSurface9 * src_surface, IDirect3DSurface9 * dst_surface,
      IDirect3DVertexBuffer9 * src_descs, UINT rect_count,
      IDirect3DVertexBuffer9 * dst_descs, D3DCOMPOSERECTSOP operation,
      INT offset_x, INT offset_y) PURE;
  ...
  STDMETHOD(CheckResourceResidency)(THIS_ IDirect3DResource9 * *resources,
                                    UINT32 resource_count) PURE;
  ...
  STDMETHOD(CreateDepthStencilSurfaceEx)(
      ...
      WINBOOL discard, IDirect3DSurface9 * *surface, HANDLE * shared_handle,
      DWORD usage) PURE;
  STDMETHOD(ResetEx)(THIS_ D3DPRESENT_PARAMETERS * parameters,
                     D3DDISPLAYMODEEX * mode) PURE;
  STDMETHOD(GetDisplayModeEx)(THIS_ UINT swapchain_idx, D3DDISPLAYMODEEX * mode,
                              D3DDISPLAYROTATION * rotation) PURE;
};
#undef INTERFACE
#if !defined(__cplusplus) || defined(CINTERFACE)
