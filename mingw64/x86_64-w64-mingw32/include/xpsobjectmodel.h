...
typedef interface IXpsOMRemoteDictionaryResourceCollection
...
typedef interface IXpsOMDocumentStructureResource
...
#define XPS_E_UNEXPECTED_RESTRICTED_FONT_RELATIONSHIP                          \
  MAKE_HRESULT(1, FACILITY_XPS, 0x11)
...
#define XPS_E_MISSING_DOCUMENTSEQUENCE_RELATIONSHIP                            \
  MAKE_HRESULT(1, FACILITY_XPS, 0x108)
...
#define XPS_E_MISSING_RESTRICTED_FONT_RELATIONSHIP                             \
  MAKE_HRESULT(1, FACILITY_XPS, 0x111)
...
#define XPS_E_MULTIPLE_DOCUMENTSEQUENCE_RELATIONSHIPS                          \
  MAKE_HRESULT(1, FACILITY_XPS, 0x202)
#define XPS_E_MULTIPLE_THUMBNAILS_ON_PAGE MAKE_HRESULT(1, FACILITY_XPS, 0x203)
#define XPS_E_MULTIPLE_THUMBNAILS_ON_PACKAGE                                   \
  MAKE_HRESULT(1, FACILITY_XPS, 0x204)
#define XPS_E_MULTIPLE_PRINTTICKETS_ON_PAGE MAKE_HRESULT(1, FACILITY_XPS, 0x205)
#define XPS_E_MULTIPLE_PRINTTICKETS_ON_DOCUMENT                                \
  MAKE_HRESULT(1, FACILITY_XPS, 0x206)
#define XPS_E_MULTIPLE_PRINTTICKETS_ON_DOCUMENTSEQUENCE                        \
  MAKE_HRESULT(1, FACILITY_XPS, 0x207)
...
#define XPS_E_RESTRICTED_FONT_NOT_OBFUSCATED                                   \
  MAKE_HRESULT(1, FACILITY_XPS, 0x309)
#define XPS_E_NEGATIVE_FLOAT MAKE_HRESULT(1, FACILITY_XPS, 0x30a)
#define XPS_E_XKEY_ATTR_PRESENT_OUTSIDE_RES_DICT                               \
  MAKE_HRESULT(1, FACILITY_XPS, 0x400)
...
#define XPS_E_BOTH_PATHFIGURE_AND_ABBR_SYNTAX_PRESENT                          \
  MAKE_HRESULT(1, FACILITY_XPS, 0x507)
#define XPS_E_BOTH_RESOURCE_AND_SOURCEATTR_PRESENT                             \
  MAKE_HRESULT(1, FACILITY_XPS, 0x508)
#define XPS_E_BLEED_BOX_PAGE_DIMENSIONS_NOT_IN_SYNC                            \
  MAKE_HRESULT(1, FACILITY_XPS, 0x509)
...
DEFINE_GUID(IID_IXpsOMShareable, 0x7137398f, 0x2fc1, 0x454d, 0x8c, 0x6a, 0x2c,
            0x31, 0x15, 0xa1, 0x6e, 0xce);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("7137398f-2fc1-454d-8c6a-2c3115a16ece")
IXpsOMShareable : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetOwner(IUnknown * *owner) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetType(XPS_OBJECT_TYPE * type) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMShareable, 0x7137398f, 0x2fc1, 0x454d, 0x8c, 0x6a, 0x2c,
                0x31, 0x15, 0xa1, 0x6e, 0xce)
#endif
#else
typedef struct IXpsOMShareableVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsOMShareable *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetType)(IXpsOMShareable *This,
                                      XPS_OBJECT_TYPE *type);
  END_INTERFACE
} IXpsOMShareableVtbl;
interface IXpsOMShareable { CONST_VTBL IXpsOMShareableVtbl *lpVtbl; };
#ifdef COBJMACROS
...
#else
/*** IUnknown methods ***/
static inline HRESULT IXpsOMShareable_QueryInterface(IXpsOMShareable *This,
                                                     REFIID riid,
                                                     void **ppvObject) {
...
/*** IXpsOMShareable methods ***/
static inline HRESULT IXpsOMShareable_GetOwner(IXpsOMShareable *This,
                                               IUnknown **owner) {
  return This->lpVtbl->GetOwner(This, owner);
}
static inline HRESULT IXpsOMShareable_GetType(IXpsOMShareable *This,
                                              XPS_OBJECT_TYPE *type) {
...
DEFINE_GUID(IID_IXpsOMPart, 0x74eb2f0b, 0xa91e, 0x4486, 0xaf, 0xac, 0x0f, 0xab,
            0xec, 0xa3, 0xdf, 0xc6);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("74eb2f0b-a91e-4486-afac-0fabeca3dfc6")
IXpsOMPart : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetPartName(IOpcPartUri * *partUri) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetPartName(IOpcPartUri * partUri) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMPart, 0x74eb2f0b, 0xa91e, 0x4486, 0xaf, 0xac, 0x0f, 0xab,
                0xec, 0xa3, 0xdf, 0xc6)
#endif
#else
typedef struct IXpsOMPartVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsOMPart *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IXpsOMPart *This);
  ULONG(STDMETHODCALLTYPE *Release)(IXpsOMPart *This);
  /*** IXpsOMPart methods ***/
  HRESULT(STDMETHODCALLTYPE *GetPartName)(IXpsOMPart *This,
                                          IOpcPartUri **partUri);
  HRESULT(STDMETHODCALLTYPE *SetPartName)(IXpsOMPart *This,
                                          IOpcPartUri *partUri);
  END_INTERFACE
} IXpsOMPartVtbl;
interface IXpsOMPart { CONST_VTBL IXpsOMPartVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IXpsOMPart_QueryInterface(IXpsOMPart *This, REFIID riid,
                                                void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IXpsOMPart methods ***/
static inline HRESULT IXpsOMPart_GetPartName(IXpsOMPart *This,
                                             IOpcPartUri **partUri) {
  return This->lpVtbl->GetPartName(This, partUri);
}
static inline HRESULT IXpsOMPart_SetPartName(IXpsOMPart *This,
                                             IOpcPartUri *partUri) {
...
DEFINE_GUID(IID_IXpsOMGlyphsEditor, 0xa5ab8616, 0x5b16, 0x4b9f, 0x96, 0x29,
            0x89, 0xb3, 0x23, 0xed, 0x79, 0x09);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("a5ab8616-5b16-4b9f-9629-89b323ed7909")
IXpsOMGlyphsEditor : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE ApplyEdits() = 0;
  virtual HRESULT STDMETHODCALLTYPE GetUnicodeString(LPWSTR *
                                                     unicodeString) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetUnicodeString(LPCWSTR unicodeString) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetGlyphIndexCount(UINT32 * indexCount) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetGlyphIndices(
      UINT32 * indexCount, XPS_GLYPH_INDEX * glyphIndices) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetGlyphIndices(
      UINT32 indexCount, const XPS_GLYPH_INDEX *glyphIndices) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetGlyphMappingCount(UINT32 *
                                                         glyphMappingCount) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetGlyphMappings(
      UINT32 * glyphMappingCount, XPS_GLYPH_MAPPING * glyphMappings) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetGlyphMappings(
      UINT32 glyphMappingCount, const XPS_GLYPH_MAPPING *glyphMappings) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetProhibitedCaretStops(
      UINT32 * count, UINT32 * prohibitedCaretStops) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetProhibitedCaretStops(
      UINT32 count, const UINT32 *prohibitedCaretStops) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetBidiLevel(UINT32 * bidiLevel) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetBidiLevel(UINT32 bidiLevel) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetIsSideways(WINBOOL * isSideways) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetIsSideways(WINBOOL isSideways) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetDeviceFontName(LPWSTR *
                                                      deviceFontName) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetDeviceFontName(
      LPCWSTR deviceFontName) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMGlyphsEditor, 0xa5ab8616, 0x5b16, 0x4b9f, 0x96, 0x29,
                0x89, 0xb3, 0x23, 0xed, 0x79, 0x09)
#endif
#else
typedef struct IXpsOMGlyphsEditorVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsOMGlyphsEditor *This,
  ...
  HRESULT(STDMETHODCALLTYPE *GetUnicodeString)(IXpsOMGlyphsEditor *This,
                                               LPWSTR *unicodeString);
  HRESULT(STDMETHODCALLTYPE *SetUnicodeString)(IXpsOMGlyphsEditor *This,
                                               LPCWSTR unicodeString);
  HRESULT(STDMETHODCALLTYPE *GetGlyphIndexCount)(IXpsOMGlyphsEditor *This,
                                                 UINT32 *indexCount);
  HRESULT(STDMETHODCALLTYPE *GetGlyphIndices)(IXpsOMGlyphsEditor *This,
                                              UINT32 *indexCount,
                                              XPS_GLYPH_INDEX *glyphIndices);
  HRESULT(STDMETHODCALLTYPE *SetGlyphIndices)(
      IXpsOMGlyphsEditor *This, UINT32 indexCount,
      const XPS_GLYPH_INDEX *glyphIndices);
  HRESULT(STDMETHODCALLTYPE *GetGlyphMappingCount)(IXpsOMGlyphsEditor *This,
                                                   UINT32 *glyphMappingCount);
  HRESULT(STDMETHODCALLTYPE *GetGlyphMappings)(
      IXpsOMGlyphsEditor *This, UINT32 *glyphMappingCount,
  ...
  HRESULT(STDMETHODCALLTYPE *GetProhibitedCaretStops)(
      IXpsOMGlyphsEditor *This, UINT32 *count, UINT32 *prohibitedCaretStops);
  HRESULT(STDMETHODCALLTYPE *SetProhibitedCaretStops)(
      IXpsOMGlyphsEditor *This, UINT32 count,
      const UINT32 *prohibitedCaretStops);
  HRESULT(STDMETHODCALLTYPE *GetBidiLevel)(IXpsOMGlyphsEditor *This,
                                           UINT32 *bidiLevel);
  HRESULT(STDMETHODCALLTYPE *SetBidiLevel)(IXpsOMGlyphsEditor *This,
                                           UINT32 bidiLevel);
  HRESULT(STDMETHODCALLTYPE *GetIsSideways)(IXpsOMGlyphsEditor *This,
                                            WINBOOL *isSideways);
  HRESULT(STDMETHODCALLTYPE *SetIsSideways)(IXpsOMGlyphsEditor *This,
                                            WINBOOL isSideways);
  HRESULT(STDMETHODCALLTYPE *GetDeviceFontName)(IXpsOMGlyphsEditor *This,
                                                LPWSTR *deviceFontName);
  HRESULT(STDMETHODCALLTYPE *SetDeviceFontName)(IXpsOMGlyphsEditor *This,
                                                LPCWSTR deviceFontName);
  END_INTERFACE
} IXpsOMGlyphsEditorVtbl;
interface IXpsOMGlyphsEditor { CONST_VTBL IXpsOMGlyphsEditorVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define IXpsOMGlyphsEditor_GetGlyphMappings(This, glyphMappingCount,           \
                                            glyphMappings)                     \
  (This)->lpVtbl->GetGlyphMappings(This, glyphMappingCount, glyphMappings)
#define IXpsOMGlyphsEditor_SetGlyphMappings(This, glyphMappingCount,           \
                                            glyphMappings)                     \
  (This)->lpVtbl->SetGlyphMappings(This, glyphMappingCount, glyphMappings)
#define IXpsOMGlyphsEditor_GetProhibitedCaretStopCount(                        \
    This, prohibitedCaretStopCount)                                            \
  (This)->lpVtbl->GetProhibitedCaretStopCount(This, prohibitedCaretStopCount)
#define IXpsOMGlyphsEditor_GetProhibitedCaretStops(This, count,                \
                                                   prohibitedCaretStops)       \
  (This)->lpVtbl->GetProhibitedCaretStops(This, count, prohibitedCaretStops)
#define IXpsOMGlyphsEditor_SetProhibitedCaretStops(This, count,                \
                                                   prohibitedCaretStops)       \
...
IXpsOMGlyphsEditor_QueryInterface(IXpsOMGlyphsEditor *This, REFIID riid,
                                  void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
static inline HRESULT
IXpsOMGlyphsEditor_GetUnicodeString(IXpsOMGlyphsEditor *This,
                                    LPWSTR *unicodeString) {
  return This->lpVtbl->GetUnicodeString(This, unicodeString);
}
static inline HRESULT
IXpsOMGlyphsEditor_SetUnicodeString(IXpsOMGlyphsEditor *This,
                                    LPCWSTR unicodeString) {
  return This->lpVtbl->SetUnicodeString(This, unicodeString);
}
static inline HRESULT
IXpsOMGlyphsEditor_GetGlyphIndexCount(IXpsOMGlyphsEditor *This,
                                      UINT32 *indexCount) {
  return This->lpVtbl->GetGlyphIndexCount(This, indexCount);
}
static inline HRESULT
IXpsOMGlyphsEditor_GetGlyphIndices(IXpsOMGlyphsEditor *This, UINT32 *indexCount,
                                   XPS_GLYPH_INDEX *glyphIndices) {
  return This->lpVtbl->GetGlyphIndices(This, indexCount, glyphIndices);
}
static inline HRESULT
IXpsOMGlyphsEditor_SetGlyphIndices(IXpsOMGlyphsEditor *This, UINT32 indexCount,
                                   const XPS_GLYPH_INDEX *glyphIndices) {
  return This->lpVtbl->SetGlyphIndices(This, indexCount, glyphIndices);
}
static inline HRESULT
IXpsOMGlyphsEditor_GetGlyphMappingCount(IXpsOMGlyphsEditor *This,
                                        UINT32 *glyphMappingCount) {
  return This->lpVtbl->GetGlyphMappingCount(This, glyphMappingCount);
}
static inline HRESULT
IXpsOMGlyphsEditor_GetGlyphMappings(IXpsOMGlyphsEditor *This,
                                    UINT32 *glyphMappingCount,
                                    XPS_GLYPH_MAPPING *glyphMappings) {
  return This->lpVtbl->GetGlyphMappings(This, glyphMappingCount, glyphMappings);
}
static inline HRESULT
IXpsOMGlyphsEditor_SetGlyphMappings(IXpsOMGlyphsEditor *This,
                                    UINT32 glyphMappingCount,
                                    const XPS_GLYPH_MAPPING *glyphMappings) {
  return This->lpVtbl->SetGlyphMappings(This, glyphMappingCount, glyphMappings);
}
static inline HRESULT IXpsOMGlyphsEditor_GetProhibitedCaretStopCount(
    IXpsOMGlyphsEditor *This, UINT32 *prohibitedCaretStopCount) {
  return This->lpVtbl->GetProhibitedCaretStopCount(This,
                                                   prohibitedCaretStopCount);
}
static inline HRESULT IXpsOMGlyphsEditor_GetProhibitedCaretStops(
    IXpsOMGlyphsEditor *This, UINT32 *count, UINT32 *prohibitedCaretStops) {
  return This->lpVtbl->GetProhibitedCaretStops(This, count,
                                               prohibitedCaretStops);
}
static inline HRESULT
IXpsOMGlyphsEditor_SetProhibitedCaretStops(IXpsOMGlyphsEditor *This,
                                           UINT32 count,
                                           const UINT32 *prohibitedCaretStops) {
  return This->lpVtbl->SetProhibitedCaretStops(This, count,
                                               prohibitedCaretStops);
}
static inline HRESULT IXpsOMGlyphsEditor_GetBidiLevel(IXpsOMGlyphsEditor *This,
                                                      UINT32 *bidiLevel) {
  return This->lpVtbl->GetBidiLevel(This, bidiLevel);
}
static inline HRESULT IXpsOMGlyphsEditor_SetBidiLevel(IXpsOMGlyphsEditor *This,
                                                      UINT32 bidiLevel) {
  return This->lpVtbl->SetBidiLevel(This, bidiLevel);
}
static inline HRESULT IXpsOMGlyphsEditor_GetIsSideways(IXpsOMGlyphsEditor *This,
                                                       WINBOOL *isSideways) {
  return This->lpVtbl->GetIsSideways(This, isSideways);
}
static inline HRESULT IXpsOMGlyphsEditor_SetIsSideways(IXpsOMGlyphsEditor *This,
                                                       WINBOOL isSideways) {
  return This->lpVtbl->SetIsSideways(This, isSideways);
}
static inline HRESULT
IXpsOMGlyphsEditor_GetDeviceFontName(IXpsOMGlyphsEditor *This,
                                     LPWSTR *deviceFontName) {
  return This->lpVtbl->GetDeviceFontName(This, deviceFontName);
}
static inline HRESULT
IXpsOMGlyphsEditor_SetDeviceFontName(IXpsOMGlyphsEditor *This,
                                     LPCWSTR deviceFontName) {
...
DEFINE_GUID(IID_IXpsOMDashCollection, 0x081613f4, 0x74eb, 0x48f2, 0x83, 0xb3,
            0x37, 0xa9, 0xce, 0x2d, 0x7d, 0xc6);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IXpsOMDashCollection : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE GetAt(UINT32 index, XPS_DASH * dash) = 0;
  virtual HRESULT STDMETHODCALLTYPE InsertAt(UINT32 index,
                                             const XPS_DASH *dash) = 0;
  virtual HRESULT STDMETHODCALLTYPE RemoveAt(UINT32 index) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetAt(UINT32 index,
                                          const XPS_DASH *dash) = 0;
  virtual HRESULT STDMETHODCALLTYPE Append(const XPS_DASH *dash) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMDashCollection, 0x081613f4, 0x74eb, 0x48f2, 0x83, 0xb3,
                0x37, 0xa9, 0xce, 0x2d, 0x7d, 0xc6)
#endif
#else
typedef struct IXpsOMDashCollectionVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsOMDashCollection *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetCount)(IXpsOMDashCollection *This,
                                       UINT32 *count);
  HRESULT(STDMETHODCALLTYPE *GetAt)(IXpsOMDashCollection *This, UINT32 index,
                                    XPS_DASH *dash);
  HRESULT(STDMETHODCALLTYPE *InsertAt)(IXpsOMDashCollection *This, UINT32 index,
                                       const XPS_DASH *dash);
  HRESULT(STDMETHODCALLTYPE *RemoveAt)(IXpsOMDashCollection *This,
                                       UINT32 index);
  HRESULT(STDMETHODCALLTYPE *SetAt)(IXpsOMDashCollection *This, UINT32 index,
                                    const XPS_DASH *dash);
  HRESULT(STDMETHODCALLTYPE *Append)(IXpsOMDashCollection *This,
                                     const XPS_DASH *dash);
  END_INTERFACE
} IXpsOMDashCollectionVtbl;
interface IXpsOMDashCollection { CONST_VTBL IXpsOMDashCollectionVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
IXpsOMDashCollection_QueryInterface(IXpsOMDashCollection *This, REFIID riid,
                                    void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IXpsOMDashCollection methods ***/
static inline HRESULT IXpsOMDashCollection_GetCount(IXpsOMDashCollection *This,
                                                    UINT32 *count) {
  return This->lpVtbl->GetCount(This, count);
}
static inline HRESULT IXpsOMDashCollection_GetAt(IXpsOMDashCollection *This,
                                                 UINT32 index, XPS_DASH *dash) {
  return This->lpVtbl->GetAt(This, index, dash);
}
static inline HRESULT IXpsOMDashCollection_InsertAt(IXpsOMDashCollection *This,
                                                    UINT32 index,
                                                    const XPS_DASH *dash) {
  return This->lpVtbl->InsertAt(This, index, dash);
}
static inline HRESULT IXpsOMDashCollection_RemoveAt(IXpsOMDashCollection *This,
                                                    UINT32 index) {
  return This->lpVtbl->RemoveAt(This, index);
}
static inline HRESULT IXpsOMDashCollection_SetAt(IXpsOMDashCollection *This,
                                                 UINT32 index,
                                                 const XPS_DASH *dash) {
  return This->lpVtbl->SetAt(This, index, dash);
}
static inline HRESULT IXpsOMDashCollection_Append(IXpsOMDashCollection *This,
                                                  const XPS_DASH *dash) {
...
DEFINE_GUID(IID_IXpsOMGeometryFigure, 0xd410dc83, 0x908c, 0x443e, 0x89, 0x47,
            0xb1, 0x79, 0x5d, 0x3c, 0x16, 0x5a);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("d410dc83-908c-443e-8947-b1795d3c165a")
IXpsOMGeometryFigure : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetOwner(IXpsOMGeometry * *owner) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetSegmentData(UINT32 * dataCount,
                                                   FLOAT * segmentData) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetSegmentTypes(
      UINT32 * segmentCount, XPS_SEGMENT_TYPE * segmentTypes) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetSegmentStrokes(
      UINT32 * segmentCount, WINBOOL * segmentStrokes) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetSegments(
      UINT32 segmentCount, UINT32 segmentDataCount,
      const XPS_SEGMENT_TYPE *segmentTypes, const FLOAT *segmentData,
      const WINBOOL *segmentStrokes) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetStartPoint(XPS_POINT * startPoint) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetStartPoint(
      const XPS_POINT *startPoint) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetIsClosed(WINBOOL * isClosed) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetIsClosed(WINBOOL isClosed) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetIsFilled(WINBOOL * isFilled) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetIsFilled(WINBOOL isFilled) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetSegmentCount(UINT32 * segmentCount) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetSegmentDataCount(UINT32 *
                                                        segmentDataCount) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetSegmentStrokePattern(
      XPS_SEGMENT_STROKE_PATTERN * segmentStrokePattern) = 0;
  virtual HRESULT STDMETHODCALLTYPE Clone(IXpsOMGeometryFigure *
                                          *geometryFigure) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMGeometryFigure, 0xd410dc83, 0x908c, 0x443e, 0x89, 0x47,
                0xb1, 0x79, 0x5d, 0x3c, 0x16, 0x5a)
#endif
#else
typedef struct IXpsOMGeometryFigureVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsOMGeometryFigure *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetOwner)(IXpsOMGeometryFigure *This,
                                       IXpsOMGeometry **owner);
  HRESULT(STDMETHODCALLTYPE *GetSegmentData)(IXpsOMGeometryFigure *This,
                                             UINT32 *dataCount,
                                             FLOAT *segmentData);
  HRESULT(STDMETHODCALLTYPE *GetSegmentTypes)(IXpsOMGeometryFigure *This,
                                              UINT32 *segmentCount,
                                              XPS_SEGMENT_TYPE *segmentTypes);
  HRESULT(STDMETHODCALLTYPE *GetSegmentStrokes)(IXpsOMGeometryFigure *This,
                                                UINT32 *segmentCount,
                                                WINBOOL *segmentStrokes);
  HRESULT(STDMETHODCALLTYPE *SetSegments)(IXpsOMGeometryFigure *This,
                                          UINT32 segmentCount,
                                          UINT32 segmentDataCount,
                                          const XPS_SEGMENT_TYPE *segmentTypes,
                                          const FLOAT *segmentData,
                                          const WINBOOL *segmentStrokes);
  HRESULT(STDMETHODCALLTYPE *GetStartPoint)(IXpsOMGeometryFigure *This,
                                            XPS_POINT *startPoint);
  HRESULT(STDMETHODCALLTYPE *SetStartPoint)(IXpsOMGeometryFigure *This,
                                            const XPS_POINT *startPoint);
  HRESULT(STDMETHODCALLTYPE *GetIsClosed)(IXpsOMGeometryFigure *This,
                                          WINBOOL *isClosed);
  HRESULT(STDMETHODCALLTYPE *SetIsClosed)(IXpsOMGeometryFigure *This,
                                          WINBOOL isClosed);
  HRESULT(STDMETHODCALLTYPE *GetIsFilled)(IXpsOMGeometryFigure *This,
                                          WINBOOL *isFilled);
  HRESULT(STDMETHODCALLTYPE *SetIsFilled)(IXpsOMGeometryFigure *This,
                                          WINBOOL isFilled);
  HRESULT(STDMETHODCALLTYPE *GetSegmentCount)(IXpsOMGeometryFigure *This,
                                              UINT32 *segmentCount);
  HRESULT(STDMETHODCALLTYPE *GetSegmentDataCount)(IXpsOMGeometryFigure *This,
                                                  UINT32 *segmentDataCount);
  ...
  HRESULT(STDMETHODCALLTYPE *Clone)(IXpsOMGeometryFigure *This,
                                    IXpsOMGeometryFigure **geometryFigure);
  END_INTERFACE
} IXpsOMGeometryFigureVtbl;
interface IXpsOMGeometryFigure { CONST_VTBL IXpsOMGeometryFigureVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define IXpsOMGeometryFigure_GetSegmentStrokes(This, segmentCount,             \
                                               segmentStrokes)                 \
  (This)->lpVtbl->GetSegmentStrokes(This, segmentCount, segmentStrokes)
#define IXpsOMGeometryFigure_SetSegments(This, segmentCount, segmentDataCount, \
                                         segmentTypes, segmentData,            \
                                         segmentStrokes)                       \
  (This)->lpVtbl->SetSegments(This, segmentCount, segmentDataCount,            \
...
#define IXpsOMGeometryFigure_GetSegmentStrokePattern(This,                     \
...
/*** IUnknown methods ***/
static inline HRESULT
IXpsOMGeometryFigure_QueryInterface(IXpsOMGeometryFigure *This, REFIID riid,
                                    void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IXpsOMGeometryFigure methods ***/
static inline HRESULT IXpsOMGeometryFigure_GetOwner(IXpsOMGeometryFigure *This,
                                                    IXpsOMGeometry **owner) {
  return This->lpVtbl->GetOwner(This, owner);
}
static inline HRESULT
IXpsOMGeometryFigure_GetSegmentData(IXpsOMGeometryFigure *This,
                                    UINT32 *dataCount, FLOAT *segmentData) {
  return This->lpVtbl->GetSegmentData(This, dataCount, segmentData);
}
static inline HRESULT
IXpsOMGeometryFigure_GetSegmentTypes(IXpsOMGeometryFigure *This,
                                     UINT32 *segmentCount,
                                     XPS_SEGMENT_TYPE *segmentTypes) {
  return This->lpVtbl->GetSegmentTypes(This, segmentCount, segmentTypes);
}
static inline HRESULT IXpsOMGeometryFigure_GetSegmentStrokes(
    IXpsOMGeometryFigure *This, UINT32 *segmentCount, WINBOOL *segmentStrokes) {
  return This->lpVtbl->GetSegmentStrokes(This, segmentCount, segmentStrokes);
}
static inline HRESULT IXpsOMGeometryFigure_SetSegments(
    IXpsOMGeometryFigure *This, UINT32 segmentCount, UINT32 segmentDataCount,
    const XPS_SEGMENT_TYPE *segmentTypes, const FLOAT *segmentData,
    const WINBOOL *segmentStrokes) {
  return This->lpVtbl->SetSegments(This, segmentCount, segmentDataCount,
                                   segmentTypes, segmentData, segmentStrokes);
}
static inline HRESULT
IXpsOMGeometryFigure_GetStartPoint(IXpsOMGeometryFigure *This,
                                   XPS_POINT *startPoint) {
  return This->lpVtbl->GetStartPoint(This, startPoint);
}
static inline HRESULT
IXpsOMGeometryFigure_SetStartPoint(IXpsOMGeometryFigure *This,
                                   const XPS_POINT *startPoint) {
  return This->lpVtbl->SetStartPoint(This, startPoint);
}
static inline HRESULT
IXpsOMGeometryFigure_GetIsClosed(IXpsOMGeometryFigure *This,
                                 WINBOOL *isClosed) {
  return This->lpVtbl->GetIsClosed(This, isClosed);
}
static inline HRESULT
IXpsOMGeometryFigure_SetIsClosed(IXpsOMGeometryFigure *This, WINBOOL isClosed) {
  return This->lpVtbl->SetIsClosed(This, isClosed);
}
static inline HRESULT
IXpsOMGeometryFigure_GetIsFilled(IXpsOMGeometryFigure *This,
                                 WINBOOL *isFilled) {
  return This->lpVtbl->GetIsFilled(This, isFilled);
}
static inline HRESULT
IXpsOMGeometryFigure_SetIsFilled(IXpsOMGeometryFigure *This, WINBOOL isFilled) {
  return This->lpVtbl->SetIsFilled(This, isFilled);
}
static inline HRESULT
IXpsOMGeometryFigure_GetSegmentCount(IXpsOMGeometryFigure *This,
                                     UINT32 *segmentCount) {
  return This->lpVtbl->GetSegmentCount(This, segmentCount);
}
static inline HRESULT
IXpsOMGeometryFigure_GetSegmentDataCount(IXpsOMGeometryFigure *This,
                                         UINT32 *segmentDataCount) {
  return This->lpVtbl->GetSegmentDataCount(This, segmentDataCount);
}
static inline HRESULT IXpsOMGeometryFigure_GetSegmentStrokePattern(
    IXpsOMGeometryFigure *This,
    XPS_SEGMENT_STROKE_PATTERN *segmentStrokePattern) {
  return This->lpVtbl->GetSegmentStrokePattern(This, segmentStrokePattern);
}
static inline HRESULT
IXpsOMGeometryFigure_Clone(IXpsOMGeometryFigure *This,
                           IXpsOMGeometryFigure **geometryFigure) {
...
DEFINE_GUID(IID_IXpsOMGeometryFigureCollection, 0xfd48c3f3, 0xa58e, 0x4b5a,
            0x88, 0x26, 0x1d, 0xe5, 0x4a, 0xbe, 0x72, 0xb2);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("fd48c3f3-a58e-4b5a-8826-1de54abe72b2")
IXpsOMGeometryFigureCollection : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetCount(UINT32 * count) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetAt(
      UINT32 index, IXpsOMGeometryFigure * *geometryFigure) = 0;
  virtual HRESULT STDMETHODCALLTYPE InsertAt(
      UINT32 index, IXpsOMGeometryFigure * geometryFigure) = 0;
  virtual HRESULT STDMETHODCALLTYPE RemoveAt(UINT32 index) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetAt(UINT32 index, IXpsOMGeometryFigure *
                                                            geometryFigure) = 0;
  virtual HRESULT STDMETHODCALLTYPE Append(IXpsOMGeometryFigure *
                                           geometryFigure) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMGeometryFigureCollection, 0xfd48c3f3, 0xa58e, 0x4b5a,
                0x88, 0x26, 0x1d, 0xe5, 0x4a, 0xbe, 0x72, 0xb2)
#endif
#else
typedef struct IXpsOMGeometryFigureCollectionVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(
      IXpsOMGeometryFigureCollection *This, REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetCount)(IXpsOMGeometryFigureCollection *This,
                                       UINT32 *count);
  HRESULT(STDMETHODCALLTYPE *GetAt)(IXpsOMGeometryFigureCollection *This,
                                    UINT32 index,
                                    IXpsOMGeometryFigure **geometryFigure);
  HRESULT(STDMETHODCALLTYPE *InsertAt)(IXpsOMGeometryFigureCollection *This,
                                       UINT32 index,
                                       IXpsOMGeometryFigure *geometryFigure);
  HRESULT(STDMETHODCALLTYPE *RemoveAt)(IXpsOMGeometryFigureCollection *This,
                                       UINT32 index);
  HRESULT(STDMETHODCALLTYPE *SetAt)(IXpsOMGeometryFigureCollection *This,
                                    UINT32 index,
                                    IXpsOMGeometryFigure *geometryFigure);
  HRESULT(STDMETHODCALLTYPE *Append)(IXpsOMGeometryFigureCollection *This,
                                     IXpsOMGeometryFigure *geometryFigure);
  END_INTERFACE
...
#else
/*** IUnknown methods ***/
static inline HRESULT IXpsOMGeometryFigureCollection_QueryInterface(
    IXpsOMGeometryFigureCollection *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IXpsOMGeometryFigureCollection_AddRef(IXpsOMGeometryFigureCollection *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IXpsOMGeometryFigureCollection_Release(IXpsOMGeometryFigureCollection *This) {
  return This->lpVtbl->Release(This);
}
/*** IXpsOMGeometryFigureCollection methods ***/
static inline HRESULT
IXpsOMGeometryFigureCollection_GetCount(IXpsOMGeometryFigureCollection *This,
                                        UINT32 *count) {
  return This->lpVtbl->GetCount(This, count);
}
static inline HRESULT
IXpsOMGeometryFigureCollection_GetAt(IXpsOMGeometryFigureCollection *This,
                                     UINT32 index,
                                     IXpsOMGeometryFigure **geometryFigure) {
  return This->lpVtbl->GetAt(This, index, geometryFigure);
}
static inline HRESULT
IXpsOMGeometryFigureCollection_InsertAt(IXpsOMGeometryFigureCollection *This,
                                        UINT32 index,
                                        IXpsOMGeometryFigure *geometryFigure) {
  return This->lpVtbl->InsertAt(This, index, geometryFigure);
}
static inline HRESULT
IXpsOMGeometryFigureCollection_RemoveAt(IXpsOMGeometryFigureCollection *This,
                                        UINT32 index) {
  return This->lpVtbl->RemoveAt(This, index);
}
static inline HRESULT
IXpsOMGeometryFigureCollection_SetAt(IXpsOMGeometryFigureCollection *This,
                                     UINT32 index,
                                     IXpsOMGeometryFigure *geometryFigure) {
  return This->lpVtbl->SetAt(This, index, geometryFigure);
}
static inline HRESULT
IXpsOMGeometryFigureCollection_Append(IXpsOMGeometryFigureCollection *This,
                                      IXpsOMGeometryFigure *geometryFigure) {
...
DEFINE_GUID(IID_IXpsOMGradientStopCollection, 0xc9174c3a, 0x3cd3, 0x4319, 0xbd,
            0xa4, 0x11, 0xa3, 0x93, 0x92, 0xce, 0xef);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("c9174c3a-3cd3-4319-bda4-11a39392ceef")
IXpsOMGradientStopCollection : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetCount(UINT32 * count) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetAt(UINT32 index,
  ...
  virtual HRESULT STDMETHODCALLTYPE SetAt(UINT32 index,
                                          IXpsOMGradientStop * stop) = 0;
  virtual HRESULT STDMETHODCALLTYPE Append(IXpsOMGradientStop * stop) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMGradientStopCollection, 0xc9174c3a, 0x3cd3, 0x4319, 0xbd,
                0xa4, 0x11, 0xa3, 0x93, 0x92, 0xce, 0xef)
#endif
#else
typedef struct IXpsOMGradientStopCollectionVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsOMGradientStopCollection *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetCount)(IXpsOMGradientStopCollection *This,
                                       UINT32 *count);
  HRESULT(STDMETHODCALLTYPE *GetAt)(IXpsOMGradientStopCollection *This,
                                    UINT32 index, IXpsOMGradientStop **stop);
  HRESULT(STDMETHODCALLTYPE *InsertAt)(IXpsOMGradientStopCollection *This,
                                       UINT32 index, IXpsOMGradientStop *stop);
  HRESULT(STDMETHODCALLTYPE *RemoveAt)(IXpsOMGradientStopCollection *This,
                                       UINT32 index);
  HRESULT(STDMETHODCALLTYPE *SetAt)(IXpsOMGradientStopCollection *This,
                                    UINT32 index, IXpsOMGradientStop *stop);
  HRESULT(STDMETHODCALLTYPE *Append)(IXpsOMGradientStopCollection *This,
...
/*** IUnknown methods ***/
static inline HRESULT
IXpsOMGradientStopCollection_QueryInterface(IXpsOMGradientStopCollection *This,
                                            REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IXpsOMGradientStopCollection_AddRef(IXpsOMGradientStopCollection *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IXpsOMGradientStopCollection_Release(IXpsOMGradientStopCollection *This) {
  return This->lpVtbl->Release(This);
}
/*** IXpsOMGradientStopCollection methods ***/
static inline HRESULT
IXpsOMGradientStopCollection_GetCount(IXpsOMGradientStopCollection *This,
                                      UINT32 *count) {
  return This->lpVtbl->GetCount(This, count);
}
static inline HRESULT
IXpsOMGradientStopCollection_GetAt(IXpsOMGradientStopCollection *This,
                                   UINT32 index, IXpsOMGradientStop **stop) {
  return This->lpVtbl->GetAt(This, index, stop);
}
static inline HRESULT
IXpsOMGradientStopCollection_InsertAt(IXpsOMGradientStopCollection *This,
                                      UINT32 index, IXpsOMGradientStop *stop) {
  return This->lpVtbl->InsertAt(This, index, stop);
}
static inline HRESULT
IXpsOMGradientStopCollection_RemoveAt(IXpsOMGradientStopCollection *This,
                                      UINT32 index) {
  return This->lpVtbl->RemoveAt(This, index);
}
static inline HRESULT
IXpsOMGradientStopCollection_SetAt(IXpsOMGradientStopCollection *This,
                                   UINT32 index, IXpsOMGradientStop *stop) {
  return This->lpVtbl->SetAt(This, index, stop);
}
static inline HRESULT
IXpsOMGradientStopCollection_Append(IXpsOMGradientStopCollection *This,
                                    IXpsOMGradientStop *stop) {
...
DEFINE_GUID(IID_IXpsOMGradientStop, 0x5cf4f5cc, 0x3969, 0x49b5, 0xa7, 0x0a,
            0x55, 0x50, 0xb6, 0x18, 0xfe, 0x49);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("5cf4f5cc-3969-49b5-a70a-5550b618fe49")
IXpsOMGradientStop : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetOwner(IXpsOMGradientBrush * *owner) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetOffset(FLOAT * offset) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetOffset(FLOAT offset) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetColor(
      XPS_COLOR * color, IXpsOMColorProfileResource * *colorProfile) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetColor(
      const XPS_COLOR *color, IXpsOMColorProfileResource *colorProfile) = 0;
  virtual HRESULT STDMETHODCALLTYPE Clone(IXpsOMGradientStop *
                                          *gradientStop) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMGradientStop, 0x5cf4f5cc, 0x3969, 0x49b5, 0xa7, 0x0a,
                0x55, 0x50, 0xb6, 0x18, 0xfe, 0x49)
#endif
#else
typedef struct IXpsOMGradientStopVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsOMGradientStop *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetOwner)(IXpsOMGradientStop *This,
                                       IXpsOMGradientBrush **owner);
  HRESULT(STDMETHODCALLTYPE *GetOffset)(IXpsOMGradientStop *This,
                                        FLOAT *offset);
  HRESULT(STDMETHODCALLTYPE *SetOffset)(IXpsOMGradientStop *This, FLOAT offset);
  HRESULT(STDMETHODCALLTYPE *GetColor)(
      IXpsOMGradientStop *This, XPS_COLOR *color,
      IXpsOMColorProfileResource **colorProfile);
  HRESULT(STDMETHODCALLTYPE *SetColor)(
      IXpsOMGradientStop *This, const XPS_COLOR *color,
      IXpsOMColorProfileResource *colorProfile);
  HRESULT(STDMETHODCALLTYPE *Clone)(IXpsOMGradientStop *This,
                                    IXpsOMGradientStop **gradientStop);
  END_INTERFACE
} IXpsOMGradientStopVtbl;
interface IXpsOMGradientStop { CONST_VTBL IXpsOMGradientStopVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
IXpsOMGradientStop_QueryInterface(IXpsOMGradientStop *This, REFIID riid,
                                  void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
static inline HRESULT IXpsOMGradientStop_GetOffset(IXpsOMGradientStop *This,
                                                   FLOAT *offset) {
  return This->lpVtbl->GetOffset(This, offset);
}
static inline HRESULT IXpsOMGradientStop_SetOffset(IXpsOMGradientStop *This,
                                                   FLOAT offset) {
  return This->lpVtbl->SetOffset(This, offset);
}
static inline HRESULT
IXpsOMGradientStop_GetColor(IXpsOMGradientStop *This, XPS_COLOR *color,
                            IXpsOMColorProfileResource **colorProfile) {
  return This->lpVtbl->GetColor(This, color, colorProfile);
}
static inline HRESULT
IXpsOMGradientStop_SetColor(IXpsOMGradientStop *This, const XPS_COLOR *color,
                            IXpsOMColorProfileResource *colorProfile) {
  return This->lpVtbl->SetColor(This, color, colorProfile);
}
static inline HRESULT
IXpsOMGradientStop_Clone(IXpsOMGradientStop *This,
                         IXpsOMGradientStop **gradientStop) {
...
DEFINE_GUID(IID_IXpsOMPartResources, 0xf4cf7729, 0x4864, 0x4275, 0x99, 0xb3,
            0xa8, 0x71, 0x71, 0x63, 0xec, 0xaf);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMPartResources, 0xf4cf7729, 0x4864, 0x4275, 0x99, 0xb3,
                0xa8, 0x71, 0x71, 0x63, 0xec, 0xaf)
#endif
#else
typedef struct IXpsOMPartResourcesVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsOMPartResources *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetFontResources)(
      IXpsOMPartResources *This, IXpsOMFontResourceCollection **fontResources);
...
interface IXpsOMPartResources { CONST_VTBL IXpsOMPartResourcesVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define IXpsOMPartResources_GetColorProfileResources(This,                     \
                                                     colorProfileResources)    \
  (This)->lpVtbl->GetColorProfileResources(This, colorProfileResources)
#define IXpsOMPartResources_GetRemoteDictionaryResources(This,                 \
                                                         dictionaryResources)  \
  (This)->lpVtbl->GetRemoteDictionaryResources(This, dictionaryResources)
#else
/*** IUnknown methods ***/
static inline HRESULT
IXpsOMPartResources_QueryInterface(IXpsOMPartResources *This, REFIID riid,
                                   void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IXpsOMPartResources methods ***/
static inline HRESULT IXpsOMPartResources_GetFontResources(
    IXpsOMPartResources *This, IXpsOMFontResourceCollection **fontResources) {
  return This->lpVtbl->GetFontResources(This, fontResources);
}
static inline HRESULT IXpsOMPartResources_GetImageResources(
    IXpsOMPartResources *This, IXpsOMImageResourceCollection **imageResources) {
  return This->lpVtbl->GetImageResources(This, imageResources);
}
static inline HRESULT IXpsOMPartResources_GetColorProfileResources(
    IXpsOMPartResources *This,
    IXpsOMColorProfileResourceCollection **colorProfileResources) {
  return This->lpVtbl->GetColorProfileResources(This, colorProfileResources);
}
static inline HRESULT IXpsOMPartResources_GetRemoteDictionaryResources(
    IXpsOMPartResources *This,
    IXpsOMRemoteDictionaryResourceCollection **dictionaryResources) {
...
DEFINE_GUID(IID_IXpsOMFontResourceCollection, 0x70b4a6bb, 0x88d4, 0x4fa8, 0xaa,
            0xf9, 0x6d, 0x9c, 0x59, 0x6f, 0xdb, 0xad);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IXpsOMFontResourceCollection : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE InsertAt(UINT32 index,
                                             IXpsOMFontResource * value) = 0;
  virtual HRESULT STDMETHODCALLTYPE Append(IXpsOMFontResource * value) = 0;
  virtual HRESULT STDMETHODCALLTYPE RemoveAt(UINT32 index) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetByPartName(
      IOpcPartUri * partName, IXpsOMFontResource * *part) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMFontResourceCollection, 0x70b4a6bb, 0x88d4, 0x4fa8, 0xaa,
                0xf9, 0x6d, 0x9c, 0x59, 0x6f, 0xdb, 0xad)
#endif
#else
typedef struct IXpsOMFontResourceCollectionVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsOMFontResourceCollection *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetCount)(IXpsOMFontResourceCollection *This,
                                       UINT32 *count);
  HRESULT(STDMETHODCALLTYPE *GetAt)(IXpsOMFontResourceCollection *This,
                                    UINT32 index, IXpsOMFontResource **value);
  HRESULT(STDMETHODCALLTYPE *SetAt)(IXpsOMFontResourceCollection *This,
                                    UINT32 index, IXpsOMFontResource *value);
  HRESULT(STDMETHODCALLTYPE *InsertAt)(IXpsOMFontResourceCollection *This,
                                       UINT32 index, IXpsOMFontResource *value);
  HRESULT(STDMETHODCALLTYPE *Append)(IXpsOMFontResourceCollection *This,
                                     IXpsOMFontResource *value);
  HRESULT(STDMETHODCALLTYPE *RemoveAt)(IXpsOMFontResourceCollection *This,
                                       UINT32 index);
  HRESULT(STDMETHODCALLTYPE *GetByPartName)(IXpsOMFontResourceCollection *This,
...
/*** IUnknown methods ***/
static inline HRESULT
IXpsOMFontResourceCollection_QueryInterface(IXpsOMFontResourceCollection *This,
                                            REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IXpsOMFontResourceCollection_AddRef(IXpsOMFontResourceCollection *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IXpsOMFontResourceCollection_Release(IXpsOMFontResourceCollection *This) {
  return This->lpVtbl->Release(This);
}
/*** IXpsOMFontResourceCollection methods ***/
static inline HRESULT
IXpsOMFontResourceCollection_GetCount(IXpsOMFontResourceCollection *This,
                                      UINT32 *count) {
  return This->lpVtbl->GetCount(This, count);
}
static inline HRESULT
IXpsOMFontResourceCollection_GetAt(IXpsOMFontResourceCollection *This,
                                   UINT32 index, IXpsOMFontResource **value) {
  return This->lpVtbl->GetAt(This, index, value);
}
static inline HRESULT
IXpsOMFontResourceCollection_SetAt(IXpsOMFontResourceCollection *This,
                                   UINT32 index, IXpsOMFontResource *value) {
  return This->lpVtbl->SetAt(This, index, value);
}
static inline HRESULT
IXpsOMFontResourceCollection_InsertAt(IXpsOMFontResourceCollection *This,
                                      UINT32 index, IXpsOMFontResource *value) {
  return This->lpVtbl->InsertAt(This, index, value);
}
static inline HRESULT
IXpsOMFontResourceCollection_Append(IXpsOMFontResourceCollection *This,
                                    IXpsOMFontResource *value) {
  return This->lpVtbl->Append(This, value);
}
static inline HRESULT
IXpsOMFontResourceCollection_RemoveAt(IXpsOMFontResourceCollection *This,
                                      UINT32 index) {
  return This->lpVtbl->RemoveAt(This, index);
}
static inline HRESULT
IXpsOMFontResourceCollection_GetByPartName(IXpsOMFontResourceCollection *This,
                                           IOpcPartUri *partName,
                                           IXpsOMFontResource **part) {
...
DEFINE_GUID(IID_IXpsOMImageResourceCollection, 0x7a4a1a71, 0x9cde, 0x4b71, 0xb3,
            0x3f, 0x62, 0xde, 0x84, 0x3e, 0xab, 0xfe);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IXpsOMImageResourceCollection : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE SetAt(UINT32 index,
                                          IXpsOMImageResource * object) = 0;
  virtual HRESULT STDMETHODCALLTYPE Append(IXpsOMImageResource * object) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetByPartName(
      IOpcPartUri * partName, IXpsOMImageResource * *part) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMImageResourceCollection, 0x7a4a1a71, 0x9cde, 0x4b71, 0xb3,
                0x3f, 0x62, 0xde, 0x84, 0x3e, 0xab, 0xfe)
#endif
#else
typedef struct IXpsOMImageResourceCollectionVtbl {
  ...
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(
      IXpsOMImageResourceCollection *This, REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetCount)(IXpsOMImageResourceCollection *This,
                                       UINT32 *count);
  HRESULT(STDMETHODCALLTYPE *GetAt)(IXpsOMImageResourceCollection *This,
                                    UINT32 index, IXpsOMImageResource **object);
  HRESULT(STDMETHODCALLTYPE *InsertAt)(IXpsOMImageResourceCollection *This,
                                       UINT32 index,
                                       IXpsOMImageResource *object);
  HRESULT(STDMETHODCALLTYPE *RemoveAt)(IXpsOMImageResourceCollection *This,
                                       UINT32 index);
  HRESULT(STDMETHODCALLTYPE *SetAt)(IXpsOMImageResourceCollection *This,
                                    UINT32 index, IXpsOMImageResource *object);
  HRESULT(STDMETHODCALLTYPE *Append)(IXpsOMImageResourceCollection *This,
                                     IXpsOMImageResource *object);
  HRESULT(STDMETHODCALLTYPE *GetByPartName)(IXpsOMImageResourceCollection *This,
                                            IOpcPartUri *partName,
...
#else
/*** IUnknown methods ***/
static inline HRESULT IXpsOMImageResourceCollection_QueryInterface(
    IXpsOMImageResourceCollection *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IXpsOMImageResourceCollection_AddRef(IXpsOMImageResourceCollection *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IXpsOMImageResourceCollection_Release(IXpsOMImageResourceCollection *This) {
  return This->lpVtbl->Release(This);
}
/*** IXpsOMImageResourceCollection methods ***/
static inline HRESULT
IXpsOMImageResourceCollection_GetCount(IXpsOMImageResourceCollection *This,
                                       UINT32 *count) {
  return This->lpVtbl->GetCount(This, count);
}
static inline HRESULT
IXpsOMImageResourceCollection_GetAt(IXpsOMImageResourceCollection *This,
                                    UINT32 index,
                                    IXpsOMImageResource **object) {
  return This->lpVtbl->GetAt(This, index, object);
}
static inline HRESULT
IXpsOMImageResourceCollection_InsertAt(IXpsOMImageResourceCollection *This,
                                       UINT32 index,
                                       IXpsOMImageResource *object) {
  return This->lpVtbl->InsertAt(This, index, object);
}
static inline HRESULT
IXpsOMImageResourceCollection_RemoveAt(IXpsOMImageResourceCollection *This,
                                       UINT32 index) {
  return This->lpVtbl->RemoveAt(This, index);
}
static inline HRESULT
IXpsOMImageResourceCollection_SetAt(IXpsOMImageResourceCollection *This,
                                    UINT32 index, IXpsOMImageResource *object) {
  return This->lpVtbl->SetAt(This, index, object);
}
static inline HRESULT
IXpsOMImageResourceCollection_Append(IXpsOMImageResourceCollection *This,
                                     IXpsOMImageResource *object) {
  return This->lpVtbl->Append(This, object);
}
static inline HRESULT
IXpsOMImageResourceCollection_GetByPartName(IXpsOMImageResourceCollection *This,
                                            IOpcPartUri *partName,
                                            IXpsOMImageResource **part) {
  return This->lpVtbl->GetByPartName(This, partName, part);
}
...
DEFINE_GUID(IID_IXpsOMColorProfileResourceCollection, 0x12759630, 0x5fba,
            0x4283, 0x8f, 0x7d, 0xcc, 0xa8, 0x49, 0x80, 0x9e, 0xdb);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("12759630-5fba-4283-8f7d-cca849809edb")
IXpsOMColorProfileResourceCollection : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetCount(UINT32 * count) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetAt(
      UINT32 index, IXpsOMColorProfileResource * *object) = 0;
  virtual HRESULT STDMETHODCALLTYPE InsertAt(
      UINT32 index, IXpsOMColorProfileResource * object) = 0;
  virtual HRESULT STDMETHODCALLTYPE RemoveAt(UINT32 index) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetAt(
      UINT32 index, IXpsOMColorProfileResource * object) = 0;
  virtual HRESULT STDMETHODCALLTYPE Append(IXpsOMColorProfileResource *
                                           object) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetByPartName(
      IOpcPartUri * partName, IXpsOMColorProfileResource * *part) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMColorProfileResourceCollection, 0x12759630, 0x5fba,
                0x4283, 0x8f, 0x7d, 0xcc, 0xa8, 0x49, 0x80, 0x9e, 0xdb)
#endif
#else
typedef struct IXpsOMColorProfileResourceCollectionVtbl {
  ...
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(
      IXpsOMColorProfileResourceCollection *This, REFIID riid,
      void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetCount)(
      IXpsOMColorProfileResourceCollection *This, UINT32 *count);
  HRESULT(STDMETHODCALLTYPE *GetAt)(IXpsOMColorProfileResourceCollection *This,
                                    UINT32 index,
                                    IXpsOMColorProfileResource **object);
  HRESULT(STDMETHODCALLTYPE *InsertAt)(
      IXpsOMColorProfileResourceCollection *This, UINT32 index,
      IXpsOMColorProfileResource *object);
  HRESULT(STDMETHODCALLTYPE *RemoveAt)(
      IXpsOMColorProfileResourceCollection *This, UINT32 index);
  HRESULT(STDMETHODCALLTYPE *SetAt)(IXpsOMColorProfileResourceCollection *This,
                                    UINT32 index,
                                    IXpsOMColorProfileResource *object);
  HRESULT(STDMETHODCALLTYPE *Append)(IXpsOMColorProfileResourceCollection *This,
                                     IXpsOMColorProfileResource *object);
  HRESULT(STDMETHODCALLTYPE *GetByPartName)(
      IXpsOMColorProfileResourceCollection *This, IOpcPartUri *partName,
...
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
#define IXpsOMColorProfileResourceCollection_QueryInterface(This, riid,        \
                                                            ppvObject)         \
  (This)->lpVtbl->QueryInterface(This, riid, ppvObject)
...
#define IXpsOMColorProfileResourceCollection_Append(This, object)              \
  (This)->lpVtbl->Append(This, object)
#define IXpsOMColorProfileResourceCollection_GetByPartName(This, partName,     \
                                                           part)               \
  (This)->lpVtbl->GetByPartName(This, partName, part)
#else
/*** IUnknown methods ***/
static inline HRESULT IXpsOMColorProfileResourceCollection_QueryInterface(
    IXpsOMColorProfileResourceCollection *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG IXpsOMColorProfileResourceCollection_AddRef(
    IXpsOMColorProfileResourceCollection *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG IXpsOMColorProfileResourceCollection_Release(
    IXpsOMColorProfileResourceCollection *This) {
  return This->lpVtbl->Release(This);
}
/*** IXpsOMColorProfileResourceCollection methods ***/
static inline HRESULT IXpsOMColorProfileResourceCollection_GetCount(
    IXpsOMColorProfileResourceCollection *This, UINT32 *count) {
  return This->lpVtbl->GetCount(This, count);
}
static inline HRESULT IXpsOMColorProfileResourceCollection_GetAt(
    IXpsOMColorProfileResourceCollection *This, UINT32 index,
    IXpsOMColorProfileResource **object) {
  return This->lpVtbl->GetAt(This, index, object);
}
static inline HRESULT IXpsOMColorProfileResourceCollection_InsertAt(
    IXpsOMColorProfileResourceCollection *This, UINT32 index,
    IXpsOMColorProfileResource *object) {
  return This->lpVtbl->InsertAt(This, index, object);
}
static inline HRESULT IXpsOMColorProfileResourceCollection_RemoveAt(
    IXpsOMColorProfileResourceCollection *This, UINT32 index) {
  return This->lpVtbl->RemoveAt(This, index);
}
static inline HRESULT IXpsOMColorProfileResourceCollection_SetAt(
    IXpsOMColorProfileResourceCollection *This, UINT32 index,
    IXpsOMColorProfileResource *object) {
  return This->lpVtbl->SetAt(This, index, object);
}
static inline HRESULT IXpsOMColorProfileResourceCollection_Append(
    IXpsOMColorProfileResourceCollection *This,
    IXpsOMColorProfileResource *object) {
  return This->lpVtbl->Append(This, object);
}
static inline HRESULT IXpsOMColorProfileResourceCollection_GetByPartName(
    IXpsOMColorProfileResourceCollection *This, IOpcPartUri *partName,
    IXpsOMColorProfileResource **part) {
  return This->lpVtbl->GetByPartName(This, partName, part);
}
...
DEFINE_GUID(IID_IXpsOMRemoteDictionaryResourceCollection, 0x5c38db61, 0x7fec,
            0x464a, 0x87, 0xbd, 0x41, 0xe3, 0xbe, 0xf0, 0x18, 0xbe);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("5c38db61-7fec-464a-87bd-41e3bef018be")
IXpsOMRemoteDictionaryResourceCollection : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetCount(UINT32 * count) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetAt(
      UINT32 index, IXpsOMRemoteDictionaryResource * *object) = 0;
  virtual HRESULT STDMETHODCALLTYPE InsertAt(
      UINT32 index, IXpsOMRemoteDictionaryResource * object) = 0;
  virtual HRESULT STDMETHODCALLTYPE RemoveAt(UINT32 index) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetAt(
      UINT32 index, IXpsOMRemoteDictionaryResource * object) = 0;
  virtual HRESULT STDMETHODCALLTYPE Append(IXpsOMRemoteDictionaryResource *
                                           object) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetByPartName(
      IOpcPartUri * partName,
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMRemoteDictionaryResourceCollection, 0x5c38db61, 0x7fec,
                0x464a, 0x87, 0xbd, 0x41, 0xe3, 0xbe, 0xf0, 0x18, 0xbe)
#endif
#else
typedef struct IXpsOMRemoteDictionaryResourceCollectionVtbl {
  ...
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(
      IXpsOMRemoteDictionaryResourceCollection *This, REFIID riid,
      void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetCount)(
      IXpsOMRemoteDictionaryResourceCollection *This, UINT32 *count);
  HRESULT(STDMETHODCALLTYPE *GetAt)(
      IXpsOMRemoteDictionaryResourceCollection *This, UINT32 index,
  ...
  HRESULT(STDMETHODCALLTYPE *Append)(
      ...
      IXpsOMRemoteDictionaryResource *object);
  HRESULT(STDMETHODCALLTYPE *GetByPartName)(
      IXpsOMRemoteDictionaryResourceCollection *This, IOpcPartUri *partName,
...
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
#define IXpsOMRemoteDictionaryResourceCollection_QueryInterface(This, riid,    \
                                                                ppvObject)     \
  (This)->lpVtbl->QueryInterface(This, riid, ppvObject)
...
#define IXpsOMRemoteDictionaryResourceCollection_Append(This, object)          \
  (This)->lpVtbl->Append(This, object)
#define IXpsOMRemoteDictionaryResourceCollection_GetByPartName(                \
    This, partName, remoteDictionaryResource)                                  \
  (This)->lpVtbl->GetByPartName(This, partName, remoteDictionaryResource)
#else
/*** IUnknown methods ***/
static inline HRESULT IXpsOMRemoteDictionaryResourceCollection_QueryInterface(
    IXpsOMRemoteDictionaryResourceCollection *This, REFIID riid,
    void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG IXpsOMRemoteDictionaryResourceCollection_AddRef(
    IXpsOMRemoteDictionaryResourceCollection *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG IXpsOMRemoteDictionaryResourceCollection_Release(
    IXpsOMRemoteDictionaryResourceCollection *This) {
  return This->lpVtbl->Release(This);
}
/*** IXpsOMRemoteDictionaryResourceCollection methods ***/
static inline HRESULT IXpsOMRemoteDictionaryResourceCollection_GetCount(
    IXpsOMRemoteDictionaryResourceCollection *This, UINT32 *count) {
  return This->lpVtbl->GetCount(This, count);
}
static inline HRESULT IXpsOMRemoteDictionaryResourceCollection_GetAt(
    IXpsOMRemoteDictionaryResourceCollection *This, UINT32 index,
    IXpsOMRemoteDictionaryResource **object) {
  return This->lpVtbl->GetAt(This, index, object);
}
static inline HRESULT IXpsOMRemoteDictionaryResourceCollection_InsertAt(
    IXpsOMRemoteDictionaryResourceCollection *This, UINT32 index,
    IXpsOMRemoteDictionaryResource *object) {
  return This->lpVtbl->InsertAt(This, index, object);
}
static inline HRESULT IXpsOMRemoteDictionaryResourceCollection_RemoveAt(
    IXpsOMRemoteDictionaryResourceCollection *This, UINT32 index) {
  return This->lpVtbl->RemoveAt(This, index);
}
static inline HRESULT IXpsOMRemoteDictionaryResourceCollection_SetAt(
    IXpsOMRemoteDictionaryResourceCollection *This, UINT32 index,
    IXpsOMRemoteDictionaryResource *object) {
  return This->lpVtbl->SetAt(This, index, object);
}
static inline HRESULT IXpsOMRemoteDictionaryResourceCollection_Append(
    IXpsOMRemoteDictionaryResourceCollection *This,
    IXpsOMRemoteDictionaryResource *object) {
  return This->lpVtbl->Append(This, object);
}
static inline HRESULT IXpsOMRemoteDictionaryResourceCollection_GetByPartName(
    IXpsOMRemoteDictionaryResourceCollection *This, IOpcPartUri *partName,
    IXpsOMRemoteDictionaryResource **remoteDictionaryResource) {
...
DEFINE_GUID(IID_IXpsOMSignatureBlockResourceCollection, 0xab8f5d8e, 0x351b,
            0x4d33, 0xaa, 0xed, 0xfa, 0x56, 0xf0, 0x02, 0x29, 0x31);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("ab8f5d8e-351b-4d33-aaed-fa56f0022931")
IXpsOMSignatureBlockResourceCollection : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetCount(UINT32 * count) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetAt(
      UINT32 index, IXpsOMSignatureBlockResource * *signatureBlockResource) = 0;
  virtual HRESULT STDMETHODCALLTYPE InsertAt(
      UINT32 index, IXpsOMSignatureBlockResource * signatureBlockResource) = 0;
  virtual HRESULT STDMETHODCALLTYPE RemoveAt(UINT32 index) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetAt(
      UINT32 index, IXpsOMSignatureBlockResource * signatureBlockResource) = 0;
  virtual HRESULT STDMETHODCALLTYPE Append(IXpsOMSignatureBlockResource *
                                           signatureBlockResource) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetByPartName(
      IOpcPartUri * partName,
      IXpsOMSignatureBlockResource * *signatureBlockResource) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMSignatureBlockResourceCollection, 0xab8f5d8e, 0x351b,
                0x4d33, 0xaa, 0xed, 0xfa, 0x56, 0xf0, 0x02, 0x29, 0x31)
#endif
#else
typedef struct IXpsOMSignatureBlockResourceCollectionVtbl {
  ...
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(
      IXpsOMSignatureBlockResourceCollection *This, REFIID riid,
      void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(
  ...
  HRESULT(STDMETHODCALLTYPE *GetCount)(
      IXpsOMSignatureBlockResourceCollection *This, UINT32 *count);
  HRESULT(STDMETHODCALLTYPE *GetAt)(
      IXpsOMSignatureBlockResourceCollection *This, UINT32 index,
...
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
#define IXpsOMSignatureBlockResourceCollection_QueryInterface(This, riid,      \
                                                              ppvObject)       \
  (This)->lpVtbl->QueryInterface(This, riid, ppvObject)
...
#define IXpsOMSignatureBlockResourceCollection_GetCount(This, count)           \
  (This)->lpVtbl->GetCount(This, count)
#define IXpsOMSignatureBlockResourceCollection_GetAt(This, index,              \
                                                     signatureBlockResource)   \
  (This)->lpVtbl->GetAt(This, index, signatureBlockResource)
#define IXpsOMSignatureBlockResourceCollection_InsertAt(                       \
    This, index, signatureBlockResource)                                       \
...
#define IXpsOMSignatureBlockResourceCollection_Append(This,                    \
                                                      signatureBlockResource)  \
  (This)->lpVtbl->Append(This, signatureBlockResource)
#define IXpsOMSignatureBlockResourceCollection_GetByPartName(                  \
    This, partName, signatureBlockResource)                                    \
  (This)->lpVtbl->GetByPartName(This, partName, signatureBlockResource)
#else
/*** IUnknown methods ***/
static inline HRESULT IXpsOMSignatureBlockResourceCollection_QueryInterface(
    IXpsOMSignatureBlockResourceCollection *This, REFIID riid,
    void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG IXpsOMSignatureBlockResourceCollection_AddRef(
    IXpsOMSignatureBlockResourceCollection *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG IXpsOMSignatureBlockResourceCollection_Release(
    IXpsOMSignatureBlockResourceCollection *This) {
  return This->lpVtbl->Release(This);
}
/*** IXpsOMSignatureBlockResourceCollection methods ***/
static inline HRESULT IXpsOMSignatureBlockResourceCollection_GetCount(
    IXpsOMSignatureBlockResourceCollection *This, UINT32 *count) {
  return This->lpVtbl->GetCount(This, count);
}
static inline HRESULT IXpsOMSignatureBlockResourceCollection_GetAt(
    IXpsOMSignatureBlockResourceCollection *This, UINT32 index,
    IXpsOMSignatureBlockResource **signatureBlockResource) {
...
static inline HRESULT IXpsOMSignatureBlockResourceCollection_RemoveAt(
    IXpsOMSignatureBlockResourceCollection *This, UINT32 index) {
  return This->lpVtbl->RemoveAt(This, index);
}
static inline HRESULT IXpsOMSignatureBlockResourceCollection_SetAt(
    IXpsOMSignatureBlockResourceCollection *This, UINT32 index,
    IXpsOMSignatureBlockResource *signatureBlockResource) {
  return This->lpVtbl->SetAt(This, index, signatureBlockResource);
}
static inline HRESULT IXpsOMSignatureBlockResourceCollection_Append(
    IXpsOMSignatureBlockResourceCollection *This,
    IXpsOMSignatureBlockResource *signatureBlockResource) {
...
DEFINE_GUID(IID_IXpsOMVisualCollection, 0x94d8abde, 0xab91, 0x46a8, 0x82, 0xb7,
            0xf5, 0xb0, 0x5e, 0xf0, 0x1a, 0x96);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IXpsOMVisualCollection : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE SetAt(UINT32 index,
                                          IXpsOMVisual * object) = 0;
  virtual HRESULT STDMETHODCALLTYPE Append(IXpsOMVisual * object) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMVisualCollection, 0x94d8abde, 0xab91, 0x46a8, 0x82, 0xb7,
                0xf5, 0xb0, 0x5e, 0xf0, 0x1a, 0x96)
#endif
#else
typedef struct IXpsOMVisualCollectionVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsOMVisualCollection *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetCount)(IXpsOMVisualCollection *This,
                                       UINT32 *count);
  HRESULT(STDMETHODCALLTYPE *GetAt)(IXpsOMVisualCollection *This, UINT32 index,
                                    IXpsOMVisual **object);
  HRESULT(STDMETHODCALLTYPE *InsertAt)(IXpsOMVisualCollection *This,
                                       UINT32 index, IXpsOMVisual *object);
  HRESULT(STDMETHODCALLTYPE *RemoveAt)(IXpsOMVisualCollection *This,
                                       UINT32 index);
  HRESULT(STDMETHODCALLTYPE *SetAt)(IXpsOMVisualCollection *This, UINT32 index,
                                    IXpsOMVisual *object);
  HRESULT(STDMETHODCALLTYPE *Append)(IXpsOMVisualCollection *This,
                                     IXpsOMVisual *object);
  END_INTERFACE
...
/*** IUnknown methods ***/
static inline HRESULT
IXpsOMVisualCollection_QueryInterface(IXpsOMVisualCollection *This, REFIID riid,
                                      void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IXpsOMVisualCollection_AddRef(IXpsOMVisualCollection *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IXpsOMVisualCollection_Release(IXpsOMVisualCollection *This) {
  return This->lpVtbl->Release(This);
}
/*** IXpsOMVisualCollection methods ***/
static inline HRESULT
IXpsOMVisualCollection_GetCount(IXpsOMVisualCollection *This, UINT32 *count) {
  return This->lpVtbl->GetCount(This, count);
}
static inline HRESULT IXpsOMVisualCollection_GetAt(IXpsOMVisualCollection *This,
                                                   UINT32 index,
                                                   IXpsOMVisual **object) {
  return This->lpVtbl->GetAt(This, index, object);
}
static inline HRESULT
IXpsOMVisualCollection_InsertAt(IXpsOMVisualCollection *This, UINT32 index,
                                IXpsOMVisual *object) {
  return This->lpVtbl->InsertAt(This, index, object);
}
static inline HRESULT
IXpsOMVisualCollection_RemoveAt(IXpsOMVisualCollection *This, UINT32 index) {
  return This->lpVtbl->RemoveAt(This, index);
}
static inline HRESULT IXpsOMVisualCollection_SetAt(IXpsOMVisualCollection *This,
                                                   UINT32 index,
                                                   IXpsOMVisual *object) {
  return This->lpVtbl->SetAt(This, index, object);
}
static inline HRESULT
IXpsOMVisualCollection_Append(IXpsOMVisualCollection *This,
                              IXpsOMVisual *object) {
  return This->lpVtbl->Append(This, object);
}
#endif
...
DEFINE_GUID(IID_IXpsOMDictionary, 0x897c86b8, 0x8eaf, 0x4ae3, 0xbd, 0xde, 0x56,
            0x41, 0x9f, 0xcf, 0x42, 0x36);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("897c86b8-8eaf-4ae3-bdde-56419fcf4236")
IXpsOMDictionary : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetOwner(IUnknown * *owner) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetCount(UINT32 * count) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetAt(UINT32 index, LPWSTR * key,
                                          IXpsOMShareable * *entry) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetByKey(
      LPCWSTR key, IXpsOMShareable * beforeEntry, IXpsOMShareable * *entry) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetIndex(IXpsOMShareable * entry,
                                             UINT32 * index) = 0;
  virtual HRESULT STDMETHODCALLTYPE Append(LPCWSTR key,
                                           IXpsOMShareable * entry) = 0;
  virtual HRESULT STDMETHODCALLTYPE InsertAt(UINT32 index, LPCWSTR key,
                                             IXpsOMShareable * entry) = 0;
  virtual HRESULT STDMETHODCALLTYPE RemoveAt(UINT32 index) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetAt(UINT32 index, LPCWSTR key,
                                          IXpsOMShareable * entry) = 0;
  virtual HRESULT STDMETHODCALLTYPE Clone(IXpsOMDictionary * *dictionary) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMDictionary, 0x897c86b8, 0x8eaf, 0x4ae3, 0xbd, 0xde, 0x56,
                0x41, 0x9f, 0xcf, 0x42, 0x36)
#endif
#else
typedef struct IXpsOMDictionaryVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsOMDictionary *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetOwner)(IXpsOMDictionary *This,
                                       IUnknown **owner);
  HRESULT(STDMETHODCALLTYPE *GetCount)(IXpsOMDictionary *This, UINT32 *count);
  HRESULT(STDMETHODCALLTYPE *GetAt)(IXpsOMDictionary *This, UINT32 index,
                                    LPWSTR *key, IXpsOMShareable **entry);
  HRESULT(STDMETHODCALLTYPE *GetByKey)(IXpsOMDictionary *This, LPCWSTR key,
                                       IXpsOMShareable *beforeEntry,
                                       IXpsOMShareable **entry);
  HRESULT(STDMETHODCALLTYPE *GetIndex)(IXpsOMDictionary *This,
                                       IXpsOMShareable *entry, UINT32 *index);
  HRESULT(STDMETHODCALLTYPE *Append)(IXpsOMDictionary *This, LPCWSTR key,
                                     IXpsOMShareable *entry);
  HRESULT(STDMETHODCALLTYPE *InsertAt)(IXpsOMDictionary *This, UINT32 index,
                                       LPCWSTR key, IXpsOMShareable *entry);
  HRESULT(STDMETHODCALLTYPE *RemoveAt)(IXpsOMDictionary *This, UINT32 index);
  HRESULT(STDMETHODCALLTYPE *SetAt)(IXpsOMDictionary *This, UINT32 index,
                                    LPCWSTR key, IXpsOMShareable *entry);
  HRESULT(STDMETHODCALLTYPE *Clone)(IXpsOMDictionary *This,
                                    IXpsOMDictionary **dictionary);
  END_INTERFACE
} IXpsOMDictionaryVtbl;
interface IXpsOMDictionary { CONST_VTBL IXpsOMDictionaryVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IXpsOMDictionary_QueryInterface(IXpsOMDictionary *This,
                                                      REFIID riid,
                                                      void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IXpsOMDictionary methods ***/
static inline HRESULT IXpsOMDictionary_GetOwner(IXpsOMDictionary *This,
                                                IUnknown **owner) {
  return This->lpVtbl->GetOwner(This, owner);
}
static inline HRESULT IXpsOMDictionary_GetCount(IXpsOMDictionary *This,
                                                UINT32 *count) {
  return This->lpVtbl->GetCount(This, count);
}
static inline HRESULT IXpsOMDictionary_GetAt(IXpsOMDictionary *This,
                                             UINT32 index, LPWSTR *key,
                                             IXpsOMShareable **entry) {
  return This->lpVtbl->GetAt(This, index, key, entry);
}
static inline HRESULT IXpsOMDictionary_GetByKey(IXpsOMDictionary *This,
                                                LPCWSTR key,
                                                IXpsOMShareable *beforeEntry,
                                                IXpsOMShareable **entry) {
  return This->lpVtbl->GetByKey(This, key, beforeEntry, entry);
}
static inline HRESULT IXpsOMDictionary_GetIndex(IXpsOMDictionary *This,
                                                IXpsOMShareable *entry,
                                                UINT32 *index) {
  return This->lpVtbl->GetIndex(This, entry, index);
}
static inline HRESULT IXpsOMDictionary_Append(IXpsOMDictionary *This,
                                              LPCWSTR key,
                                              IXpsOMShareable *entry) {
  return This->lpVtbl->Append(This, key, entry);
}
static inline HRESULT IXpsOMDictionary_InsertAt(IXpsOMDictionary *This,
                                                UINT32 index, LPCWSTR key,
                                                IXpsOMShareable *entry) {
  return This->lpVtbl->InsertAt(This, index, key, entry);
}
static inline HRESULT IXpsOMDictionary_RemoveAt(IXpsOMDictionary *This,
                                                UINT32 index) {
  return This->lpVtbl->RemoveAt(This, index);
}
static inline HRESULT IXpsOMDictionary_SetAt(IXpsOMDictionary *This,
                                             UINT32 index, LPCWSTR key,
                                             IXpsOMShareable *entry) {
  return This->lpVtbl->SetAt(This, index, key, entry);
}
static inline HRESULT IXpsOMDictionary_Clone(IXpsOMDictionary *This,
                                             IXpsOMDictionary **dictionary) {
...
DEFINE_GUID(IID_IXpsOMPageReference, 0xed360180, 0x6f92, 0x4998, 0x89, 0x0d,
            0x2f, 0x20, 0x85, 0x31, 0xa0, 0xa0);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("ed360180-6f92-4998-890d-2f208531a0a0")
IXpsOMPageReference : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetOwner(IXpsOMDocument * *document) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetPage(IXpsOMPage * *page) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetPage(IXpsOMPage * page) = 0;
  virtual HRESULT STDMETHODCALLTYPE DiscardPage() = 0;
  virtual HRESULT STDMETHODCALLTYPE IsPageLoaded(WINBOOL * isPageLoaded) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE SetPrintTicketResource(
      IXpsOMPrintTicketResource * printTicketResource) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetThumbnailResource(IXpsOMImageResource *
                                                         *imageResource) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetThumbnailResource(IXpsOMImageResource *
                                                         imageResource) = 0;
  virtual HRESULT STDMETHODCALLTYPE CollectLinkTargets(IXpsOMNameCollection *
                                                       *linkTargets) = 0;
  virtual HRESULT STDMETHODCALLTYPE CollectPartResources(IXpsOMPartResources *
                                                         *partResources) = 0;
  virtual HRESULT STDMETHODCALLTYPE HasRestrictedFonts(WINBOOL *
                                                       restrictedFonts) = 0;
  virtual HRESULT STDMETHODCALLTYPE Clone(IXpsOMPageReference *
                                          *pageReference) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMPageReference, 0xed360180, 0x6f92, 0x4998, 0x89, 0x0d,
                0x2f, 0x20, 0x85, 0x31, 0xa0, 0xa0)
#endif
#else
typedef struct IXpsOMPageReferenceVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsOMPageReference *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetOwner)(IXpsOMPageReference *This,
                                       IXpsOMDocument **document);
  HRESULT(STDMETHODCALLTYPE *GetPage)(IXpsOMPageReference *This,
                                      IXpsOMPage **page);
  HRESULT(STDMETHODCALLTYPE *SetPage)(IXpsOMPageReference *This,
                                      IXpsOMPage *page);
  HRESULT(STDMETHODCALLTYPE *DiscardPage)(IXpsOMPageReference *This);
  HRESULT(STDMETHODCALLTYPE *IsPageLoaded)(IXpsOMPageReference *This,
                                           WINBOOL *isPageLoaded);
  HRESULT(STDMETHODCALLTYPE *GetAdvisoryPageDimensions)(
      IXpsOMPageReference *This, XPS_SIZE *pageDimensions);
  HRESULT(STDMETHODCALLTYPE *SetAdvisoryPageDimensions)(
      IXpsOMPageReference *This, const XPS_SIZE *pageDimensions);
  ...
  HRESULT(STDMETHODCALLTYPE *GetThumbnailResource)(
      IXpsOMPageReference *This, IXpsOMImageResource **imageResource);
  HRESULT(STDMETHODCALLTYPE *SetThumbnailResource)(
      IXpsOMPageReference *This, IXpsOMImageResource *imageResource);
  HRESULT(STDMETHODCALLTYPE *CollectLinkTargets)(
      IXpsOMPageReference *This, IXpsOMNameCollection **linkTargets);
  HRESULT(STDMETHODCALLTYPE *CollectPartResources)(
      IXpsOMPageReference *This, IXpsOMPartResources **partResources);
  HRESULT(STDMETHODCALLTYPE *HasRestrictedFonts)(IXpsOMPageReference *This,
                                                 WINBOOL *restrictedFonts);
  HRESULT(STDMETHODCALLTYPE *Clone)(IXpsOMPageReference *This,
                                    IXpsOMPageReference **pageReference);
  END_INTERFACE
} IXpsOMPageReferenceVtbl;
interface IXpsOMPageReference { CONST_VTBL IXpsOMPageReferenceVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define IXpsOMPageReference_GetStoryFragmentsResource(This,                    \
                                                      storyFragmentsResource)  \
  (This)->lpVtbl->GetStoryFragmentsResource(This, storyFragmentsResource)
#define IXpsOMPageReference_SetStoryFragmentsResource(This,                    \
                                                      storyFragmentsResource)  \
...
/*** IUnknown methods ***/
static inline HRESULT
IXpsOMPageReference_QueryInterface(IXpsOMPageReference *This, REFIID riid,
                                   void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IXpsOMPageReference methods ***/
static inline HRESULT IXpsOMPageReference_GetOwner(IXpsOMPageReference *This,
                                                   IXpsOMDocument **document) {
  return This->lpVtbl->GetOwner(This, document);
}
static inline HRESULT IXpsOMPageReference_GetPage(IXpsOMPageReference *This,
                                                  IXpsOMPage **page) {
  return This->lpVtbl->GetPage(This, page);
}
static inline HRESULT IXpsOMPageReference_SetPage(IXpsOMPageReference *This,
                                                  IXpsOMPage *page) {
  return This->lpVtbl->SetPage(This, page);
}
static inline HRESULT
IXpsOMPageReference_DiscardPage(IXpsOMPageReference *This) {
  return This->lpVtbl->DiscardPage(This);
}
static inline HRESULT
IXpsOMPageReference_IsPageLoaded(IXpsOMPageReference *This,
                                 WINBOOL *isPageLoaded) {
  return This->lpVtbl->IsPageLoaded(This, isPageLoaded);
}
static inline HRESULT
IXpsOMPageReference_GetAdvisoryPageDimensions(IXpsOMPageReference *This,
                                              XPS_SIZE *pageDimensions) {
  return This->lpVtbl->GetAdvisoryPageDimensions(This, pageDimensions);
}
static inline HRESULT
IXpsOMPageReference_SetAdvisoryPageDimensions(IXpsOMPageReference *This,
                                              const XPS_SIZE *pageDimensions) {
  return This->lpVtbl->SetAdvisoryPageDimensions(This, pageDimensions);
}
static inline HRESULT IXpsOMPageReference_GetStoryFragmentsResource(
    IXpsOMPageReference *This,
    IXpsOMStoryFragmentsResource **storyFragmentsResource) {
  return This->lpVtbl->GetStoryFragmentsResource(This, storyFragmentsResource);
}
static inline HRESULT IXpsOMPageReference_SetStoryFragmentsResource(
    IXpsOMPageReference *This,
    IXpsOMStoryFragmentsResource *storyFragmentsResource) {
  return This->lpVtbl->SetStoryFragmentsResource(This, storyFragmentsResource);
}
static inline HRESULT IXpsOMPageReference_GetPrintTicketResource(
    IXpsOMPageReference *This,
    IXpsOMPrintTicketResource **printTicketResource) {
  return This->lpVtbl->GetPrintTicketResource(This, printTicketResource);
}
static inline HRESULT IXpsOMPageReference_SetPrintTicketResource(
    IXpsOMPageReference *This, IXpsOMPrintTicketResource *printTicketResource) {
  return This->lpVtbl->SetPrintTicketResource(This, printTicketResource);
}
static inline HRESULT
IXpsOMPageReference_GetThumbnailResource(IXpsOMPageReference *This,
                                         IXpsOMImageResource **imageResource) {
  return This->lpVtbl->GetThumbnailResource(This, imageResource);
}
static inline HRESULT
IXpsOMPageReference_SetThumbnailResource(IXpsOMPageReference *This,
                                         IXpsOMImageResource *imageResource) {
  return This->lpVtbl->SetThumbnailResource(This, imageResource);
}
static inline HRESULT
IXpsOMPageReference_CollectLinkTargets(IXpsOMPageReference *This,
                                       IXpsOMNameCollection **linkTargets) {
  return This->lpVtbl->CollectLinkTargets(This, linkTargets);
}
static inline HRESULT
IXpsOMPageReference_CollectPartResources(IXpsOMPageReference *This,
                                         IXpsOMPartResources **partResources) {
  return This->lpVtbl->CollectPartResources(This, partResources);
}
static inline HRESULT
IXpsOMPageReference_HasRestrictedFonts(IXpsOMPageReference *This,
                                       WINBOOL *restrictedFonts) {
  return This->lpVtbl->HasRestrictedFonts(This, restrictedFonts);
}
static inline HRESULT
IXpsOMPageReference_Clone(IXpsOMPageReference *This,
                          IXpsOMPageReference **pageReference) {
...
DEFINE_GUID(IID_IXpsOMPageReferenceCollection, 0xca16ba4d, 0xe7b9, 0x45c5, 0x95,
            0x8b, 0xf9, 0x80, 0x22, 0x47, 0x37, 0x45);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("ca16ba4d-e7b9-45c5-958b-f98022473745")
IXpsOMPageReferenceCollection : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetCount(UINT32 * count) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetAt(UINT32 index, IXpsOMPageReference *
                                                            *pageReference) = 0;
  virtual HRESULT STDMETHODCALLTYPE InsertAt(
      UINT32 index, IXpsOMPageReference * pageReference) = 0;
  virtual HRESULT STDMETHODCALLTYPE RemoveAt(UINT32 index) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetAt(UINT32 index, IXpsOMPageReference *
                                                            pageReference) = 0;
  virtual HRESULT STDMETHODCALLTYPE Append(IXpsOMPageReference *
                                           pageReference) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMPageReferenceCollection, 0xca16ba4d, 0xe7b9, 0x45c5, 0x95,
                0x8b, 0xf9, 0x80, 0x22, 0x47, 0x37, 0x45)
#endif
#else
typedef struct IXpsOMPageReferenceCollectionVtbl {
  ...
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(
      IXpsOMPageReferenceCollection *This, REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetCount)(IXpsOMPageReferenceCollection *This,
                                       UINT32 *count);
  HRESULT(STDMETHODCALLTYPE *GetAt)(IXpsOMPageReferenceCollection *This,
                                    UINT32 index,
                                    IXpsOMPageReference **pageReference);
  HRESULT(STDMETHODCALLTYPE *InsertAt)(IXpsOMPageReferenceCollection *This,
                                       UINT32 index,
                                       IXpsOMPageReference *pageReference);
  HRESULT(STDMETHODCALLTYPE *RemoveAt)(IXpsOMPageReferenceCollection *This,
                                       UINT32 index);
  HRESULT(STDMETHODCALLTYPE *SetAt)(IXpsOMPageReferenceCollection *This,
                                    UINT32 index,
                                    IXpsOMPageReference *pageReference);
  HRESULT(STDMETHODCALLTYPE *Append)(IXpsOMPageReferenceCollection *This,
                                     IXpsOMPageReference *pageReference);
  END_INTERFACE
...
#else
/*** IUnknown methods ***/
static inline HRESULT IXpsOMPageReferenceCollection_QueryInterface(
    IXpsOMPageReferenceCollection *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IXpsOMPageReferenceCollection_AddRef(IXpsOMPageReferenceCollection *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IXpsOMPageReferenceCollection_Release(IXpsOMPageReferenceCollection *This) {
  return This->lpVtbl->Release(This);
}
/*** IXpsOMPageReferenceCollection methods ***/
static inline HRESULT
IXpsOMPageReferenceCollection_GetCount(IXpsOMPageReferenceCollection *This,
                                       UINT32 *count) {
  return This->lpVtbl->GetCount(This, count);
}
static inline HRESULT
IXpsOMPageReferenceCollection_GetAt(IXpsOMPageReferenceCollection *This,
                                    UINT32 index,
                                    IXpsOMPageReference **pageReference) {
  return This->lpVtbl->GetAt(This, index, pageReference);
}
static inline HRESULT
IXpsOMPageReferenceCollection_InsertAt(IXpsOMPageReferenceCollection *This,
                                       UINT32 index,
                                       IXpsOMPageReference *pageReference) {
  return This->lpVtbl->InsertAt(This, index, pageReference);
}
static inline HRESULT
IXpsOMPageReferenceCollection_RemoveAt(IXpsOMPageReferenceCollection *This,
                                       UINT32 index) {
  return This->lpVtbl->RemoveAt(This, index);
}
static inline HRESULT
IXpsOMPageReferenceCollection_SetAt(IXpsOMPageReferenceCollection *This,
                                    UINT32 index,
                                    IXpsOMPageReference *pageReference) {
  return This->lpVtbl->SetAt(This, index, pageReference);
}
static inline HRESULT
IXpsOMPageReferenceCollection_Append(IXpsOMPageReferenceCollection *This,
                                     IXpsOMPageReference *pageReference) {
...
DEFINE_GUID(IID_IXpsOMDocumentCollection, 0xd1c87f0d, 0xe947, 0x4754, 0x8a,
            0x25, 0x97, 0x14, 0x78, 0xf7, 0xe8, 0x3e);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IXpsOMDocumentCollection : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE SetAt(UINT32 index,
                                          IXpsOMDocument * document) = 0;
  virtual HRESULT STDMETHODCALLTYPE Append(IXpsOMDocument * document) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMDocumentCollection, 0xd1c87f0d, 0xe947, 0x4754, 0x8a,
                0x25, 0x97, 0x14, 0x78, 0xf7, 0xe8, 0x3e)
#endif
#else
typedef struct IXpsOMDocumentCollectionVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsOMDocumentCollection *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetCount)(IXpsOMDocumentCollection *This,
                                       UINT32 *count);
  HRESULT(STDMETHODCALLTYPE *GetAt)(IXpsOMDocumentCollection *This,
                                    UINT32 index, IXpsOMDocument **document);
  HRESULT(STDMETHODCALLTYPE *InsertAt)(IXpsOMDocumentCollection *This,
                                       UINT32 index, IXpsOMDocument *document);
  HRESULT(STDMETHODCALLTYPE *RemoveAt)(IXpsOMDocumentCollection *This,
                                       UINT32 index);
  HRESULT(STDMETHODCALLTYPE *SetAt)(IXpsOMDocumentCollection *This,
                                    UINT32 index, IXpsOMDocument *document);
  HRESULT(STDMETHODCALLTYPE *Append)(IXpsOMDocumentCollection *This,
                                     IXpsOMDocument *document);
  END_INTERFACE
...
/*** IUnknown methods ***/
static inline HRESULT
IXpsOMDocumentCollection_QueryInterface(IXpsOMDocumentCollection *This,
                                        REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IXpsOMDocumentCollection_AddRef(IXpsOMDocumentCollection *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IXpsOMDocumentCollection_Release(IXpsOMDocumentCollection *This) {
  return This->lpVtbl->Release(This);
}
/*** IXpsOMDocumentCollection methods ***/
static inline HRESULT
IXpsOMDocumentCollection_GetCount(IXpsOMDocumentCollection *This,
                                  UINT32 *count) {
  return This->lpVtbl->GetCount(This, count);
}
static inline HRESULT
IXpsOMDocumentCollection_GetAt(IXpsOMDocumentCollection *This, UINT32 index,
                               IXpsOMDocument **document) {
  return This->lpVtbl->GetAt(This, index, document);
}
static inline HRESULT
IXpsOMDocumentCollection_InsertAt(IXpsOMDocumentCollection *This, UINT32 index,
                                  IXpsOMDocument *document) {
  return This->lpVtbl->InsertAt(This, index, document);
}
static inline HRESULT
IXpsOMDocumentCollection_RemoveAt(IXpsOMDocumentCollection *This,
                                  UINT32 index) {
  return This->lpVtbl->RemoveAt(This, index);
}
static inline HRESULT
IXpsOMDocumentCollection_SetAt(IXpsOMDocumentCollection *This, UINT32 index,
                               IXpsOMDocument *document) {
  return This->lpVtbl->SetAt(This, index, document);
}
static inline HRESULT
IXpsOMDocumentCollection_Append(IXpsOMDocumentCollection *This,
                                IXpsOMDocument *document) {
...
DEFINE_GUID(IID_IXpsOMPackage, 0x18c3df65, 0x81e1, 0x4674, 0x91, 0xdc, 0xfc,
            0x45, 0x2f, 0x5a, 0x41, 0x6f);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("18c3df65-81e1-4674-91dc-fc452f5a416f")
IXpsOMPackage : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetDocumentSequence(IXpsOMDocumentSequence *
                                                        *documentSequence) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetDocumentSequence(IXpsOMDocumentSequence *
                                                        documentSequence) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetCoreProperties(IXpsOMCoreProperties *
                                                      *coreProperties) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetCoreProperties(IXpsOMCoreProperties *
                                                      coreProperties) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE WriteToFile(
      LPCWSTR fileName, LPSECURITY_ATTRIBUTES securityAttributes,
      DWORD flagsAndAttributes, WINBOOL optimizeMarkupSize) = 0;
  virtual HRESULT STDMETHODCALLTYPE WriteToStream(
      ISequentialStream * stream, WINBOOL optimizeMarkupSize) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMPackage, 0x18c3df65, 0x81e1, 0x4674, 0x91, 0xdc, 0xfc,
                0x45, 0x2f, 0x5a, 0x41, 0x6f)
#endif
#else
typedef struct IXpsOMPackageVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsOMPackage *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetDocumentSequence)(
      IXpsOMPackage *This, IXpsOMDocumentSequence **documentSequence);
  HRESULT(STDMETHODCALLTYPE *SetDocumentSequence)(
      IXpsOMPackage *This, IXpsOMDocumentSequence *documentSequence);
  HRESULT(STDMETHODCALLTYPE *GetCoreProperties)(
      IXpsOMPackage *This, IXpsOMCoreProperties **coreProperties);
  HRESULT(STDMETHODCALLTYPE *SetCoreProperties)(
      IXpsOMPackage *This, IXpsOMCoreProperties *coreProperties);
  HRESULT(STDMETHODCALLTYPE *GetDiscardControlPartName)(
      IXpsOMPackage *This, IOpcPartUri **discardControlPartUri);
  HRESULT(STDMETHODCALLTYPE *SetDiscardControlPartName)(
      IXpsOMPackage *This, IOpcPartUri *discardControlPartUri);
  HRESULT(STDMETHODCALLTYPE *GetThumbnailResource)(
      IXpsOMPackage *This, IXpsOMImageResource **imageResource);
  HRESULT(STDMETHODCALLTYPE *SetThumbnailResource)(
      IXpsOMPackage *This, IXpsOMImageResource *imageResource);
  HRESULT(STDMETHODCALLTYPE *WriteToFile)(
      IXpsOMPackage *This, LPCWSTR fileName,
      LPSECURITY_ATTRIBUTES securityAttributes, DWORD flagsAndAttributes,
      WINBOOL optimizeMarkupSize);
  HRESULT(STDMETHODCALLTYPE *WriteToStream)(IXpsOMPackage *This,
                                            ISequentialStream *stream,
                                            WINBOOL optimizeMarkupSize);
  END_INTERFACE
} IXpsOMPackageVtbl;
interface IXpsOMPackage { CONST_VTBL IXpsOMPackageVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define IXpsOMPackage_SetThumbnailResource(This, imageResource)                \
  (This)->lpVtbl->SetThumbnailResource(This, imageResource)
#define IXpsOMPackage_WriteToFile(This, fileName, securityAttributes,          \
                                  flagsAndAttributes, optimizeMarkupSize)      \
  (This)->lpVtbl->WriteToFile(This, fileName, securityAttributes,              \
                              flagsAndAttributes, optimizeMarkupSize)
...
#else
/*** IUnknown methods ***/
static inline HRESULT IXpsOMPackage_QueryInterface(IXpsOMPackage *This,
                                                   REFIID riid,
                                                   void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IXpsOMPackage methods ***/
static inline HRESULT
IXpsOMPackage_GetDocumentSequence(IXpsOMPackage *This,
                                  IXpsOMDocumentSequence **documentSequence) {
  return This->lpVtbl->GetDocumentSequence(This, documentSequence);
}
static inline HRESULT
IXpsOMPackage_SetDocumentSequence(IXpsOMPackage *This,
                                  IXpsOMDocumentSequence *documentSequence) {
  return This->lpVtbl->SetDocumentSequence(This, documentSequence);
}
static inline HRESULT
IXpsOMPackage_GetCoreProperties(IXpsOMPackage *This,
                                IXpsOMCoreProperties **coreProperties) {
  return This->lpVtbl->GetCoreProperties(This, coreProperties);
}
static inline HRESULT
IXpsOMPackage_SetCoreProperties(IXpsOMPackage *This,
                                IXpsOMCoreProperties *coreProperties) {
  return This->lpVtbl->SetCoreProperties(This, coreProperties);
}
static inline HRESULT
IXpsOMPackage_GetDiscardControlPartName(IXpsOMPackage *This,
                                        IOpcPartUri **discardControlPartUri) {
  return This->lpVtbl->GetDiscardControlPartName(This, discardControlPartUri);
}
static inline HRESULT
IXpsOMPackage_SetDiscardControlPartName(IXpsOMPackage *This,
                                        IOpcPartUri *discardControlPartUri) {
  return This->lpVtbl->SetDiscardControlPartName(This, discardControlPartUri);
}
static inline HRESULT
IXpsOMPackage_GetThumbnailResource(IXpsOMPackage *This,
                                   IXpsOMImageResource **imageResource) {
  return This->lpVtbl->GetThumbnailResource(This, imageResource);
}
static inline HRESULT
IXpsOMPackage_SetThumbnailResource(IXpsOMPackage *This,
                                   IXpsOMImageResource *imageResource) {
  return This->lpVtbl->SetThumbnailResource(This, imageResource);
}
static inline HRESULT
IXpsOMPackage_WriteToFile(IXpsOMPackage *This, LPCWSTR fileName,
                          LPSECURITY_ATTRIBUTES securityAttributes,
                          DWORD flagsAndAttributes,
                          WINBOOL optimizeMarkupSize) {
  return This->lpVtbl->WriteToFile(This, fileName, securityAttributes,
                                   flagsAndAttributes, optimizeMarkupSize);
}
static inline HRESULT IXpsOMPackage_WriteToStream(IXpsOMPackage *This,
                                                  ISequentialStream *stream,
                                                  WINBOOL optimizeMarkupSize) {
...
DEFINE_GUID(IID_IXpsOMObjectFactory, 0xf9b2a685, 0xa50d, 0x4fc2, 0xb7, 0x64,
            0xb5, 0x6e, 0x09, 0x3e, 0xa0, 0xca);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("f9b2a685-a50d-4fc2-b764-b56e093ea0ca")
IXpsOMObjectFactory : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE CreatePackage(IXpsOMPackage * *package) = 0;
  virtual HRESULT STDMETHODCALLTYPE CreatePackageFromFile(
      LPCWSTR filename, WINBOOL reuseObjects, IXpsOMPackage * *package) = 0;
  virtual HRESULT STDMETHODCALLTYPE CreatePackageFromStream(
      IStream * stream, WINBOOL reuseObjects, IXpsOMPackage * *package) = 0;
  virtual HRESULT STDMETHODCALLTYPE CreateStoryFragmentsResource(
      IStream * acquiredStream, IOpcPartUri * partUri,
      IXpsOMStoryFragmentsResource * *storyFragmentsResource) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE CreateRemoteDictionaryResource(
      IXpsOMDictionary * dictionary, IOpcPartUri * partUri,
      IXpsOMRemoteDictionaryResource * *remoteDictionaryResource) = 0;
  virtual HRESULT STDMETHODCALLTYPE CreateRemoteDictionaryResourceFromStream(
      IStream * dictionaryMarkupStream, IOpcPartUri * dictionaryPartUri,
      IXpsOMPartResources * resources,
      IXpsOMRemoteDictionaryResource * *dictionaryResource) = 0;
  virtual HRESULT STDMETHODCALLTYPE CreatePartResources(IXpsOMPartResources *
                                                        *partResources) = 0;
  virtual HRESULT STDMETHODCALLTYPE CreateDocumentSequence(
      IOpcPartUri * partUri, IXpsOMDocumentSequence * *documentSequence) = 0;
  virtual HRESULT STDMETHODCALLTYPE CreateDocument(
      IOpcPartUri * partUri, IXpsOMDocument * *document) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE CreatePage(
      const XPS_SIZE *pageDimensions, LPCWSTR language, IOpcPartUri *partUri,
      IXpsOMPage **page) = 0;
  virtual HRESULT STDMETHODCALLTYPE CreatePageFromStream(
      IStream * pageMarkupStream, IOpcPartUri * partUri,
      IXpsOMPartResources * resources, WINBOOL reuseObjects,
      IXpsOMPage * *page) = 0;
  virtual HRESULT STDMETHODCALLTYPE CreateCanvas(IXpsOMCanvas * *canvas) = 0;
  virtual HRESULT STDMETHODCALLTYPE CreateGlyphs(
      IXpsOMFontResource * fontResource, IXpsOMGlyphs * *glyphs) = 0;
  virtual HRESULT STDMETHODCALLTYPE CreatePath(IXpsOMPath * *path) = 0;
  virtual HRESULT STDMETHODCALLTYPE CreateGeometry(IXpsOMGeometry *
                                                   *geometry) = 0;
  virtual HRESULT STDMETHODCALLTYPE CreateGeometryFigure(
      const XPS_POINT *startPoint, IXpsOMGeometryFigure **figure) = 0;
  virtual HRESULT STDMETHODCALLTYPE CreateMatrixTransform(
      const XPS_MATRIX *matrix, IXpsOMMatrixTransform **transform) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE CreateImageBrush(
      IXpsOMImageResource * image, const XPS_RECT *viewBox,
      const XPS_RECT *viewPort, IXpsOMImageBrush **imageBrush) = 0;
  virtual HRESULT STDMETHODCALLTYPE CreateVisualBrush(
      const XPS_RECT *viewBox, const XPS_RECT *viewPort,
      IXpsOMVisualBrush **visualBrush) = 0;
  virtual HRESULT STDMETHODCALLTYPE CreateImageResource(
      IStream * acquiredStream, XPS_IMAGE_TYPE contentType,
      IOpcPartUri * partUri, IXpsOMImageResource * *imageResource) = 0;
  virtual HRESULT STDMETHODCALLTYPE CreatePrintTicketResource(
      IStream * acquiredStream, IOpcPartUri * partUri,
      IXpsOMPrintTicketResource * *printTicketResource) = 0;
  virtual HRESULT STDMETHODCALLTYPE CreateFontResource(
      IStream * acquiredStream, XPS_FONT_EMBEDDING fontEmbedding,
      IOpcPartUri * partUri, WINBOOL isObfSourceStream,
      IXpsOMFontResource * *fontResource) = 0;
  virtual HRESULT STDMETHODCALLTYPE CreateGradientStop(
      const XPS_COLOR *color, IXpsOMColorProfileResource *colorProfile,
      FLOAT offset, IXpsOMGradientStop **gradientStop) = 0;
  virtual HRESULT STDMETHODCALLTYPE CreateLinearGradientBrush(
      IXpsOMGradientStop * gradStop1, IXpsOMGradientStop * gradStop2,
  ...
  virtual HRESULT STDMETHODCALLTYPE CreateCoreProperties(
      IOpcPartUri * partUri, IXpsOMCoreProperties * *coreProperties) = 0;
  virtual HRESULT STDMETHODCALLTYPE CreateDictionary(IXpsOMDictionary *
                                                     *dictionary) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE CreatePackageWriterOnFile(
      LPCWSTR fileName, LPSECURITY_ATTRIBUTES securityAttributes,
      DWORD flagsAndAttributes, WINBOOL optimizeMarkupSize,
  ...
  virtual HRESULT STDMETHODCALLTYPE CreatePackageWriterOnStream(
      ISequentialStream * outputStream, WINBOOL optimizeMarkupSize,
      XPS_INTERLEAVING interleaving, IOpcPartUri * documentSequencePartName,
      IXpsOMCoreProperties * coreProperties,
      IXpsOMImageResource * packageThumbnail,
      IXpsOMPrintTicketResource * documentSequencePrintTicket,
      IOpcPartUri * discardControlPartName,
      IXpsOMPackageWriter * *packageWriter) = 0;
  virtual HRESULT STDMETHODCALLTYPE CreatePartUri(LPCWSTR uri,
                                                  IOpcPartUri * *partUri) = 0;
  virtual HRESULT STDMETHODCALLTYPE CreateReadOnlyStreamOnFile(
      LPCWSTR filename, IStream * *stream) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMObjectFactory, 0xf9b2a685, 0xa50d, 0x4fc2, 0xb7, 0x64,
                0xb5, 0x6e, 0x09, 0x3e, 0xa0, 0xca)
#endif
#else
typedef struct IXpsOMObjectFactoryVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsOMObjectFactory *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *CreatePackage)(IXpsOMObjectFactory *This,
                                            IXpsOMPackage **package);
  HRESULT(STDMETHODCALLTYPE *CreatePackageFromFile)(IXpsOMObjectFactory *This,
                                                    LPCWSTR filename,
                                                    WINBOOL reuseObjects,
                                                    IXpsOMPackage **package);
  HRESULT(STDMETHODCALLTYPE *CreatePackageFromStream)(IXpsOMObjectFactory *This,
                                                      IStream *stream,
                                                      WINBOOL reuseObjects,
                                                      IXpsOMPackage **package);
  HRESULT(STDMETHODCALLTYPE *CreateStoryFragmentsResource)(
      IXpsOMObjectFactory *This, IStream *acquiredStream, IOpcPartUri *partUri,
      IXpsOMStoryFragmentsResource **storyFragmentsResource);
  ...
  HRESULT(STDMETHODCALLTYPE *CreateRemoteDictionaryResource)(
      IXpsOMObjectFactory *This, IXpsOMDictionary *dictionary,
      IOpcPartUri *partUri,
      IXpsOMRemoteDictionaryResource **remoteDictionaryResource);
  HRESULT(STDMETHODCALLTYPE *CreateRemoteDictionaryResourceFromStream)(
      ...
      IOpcPartUri *dictionaryPartUri, IXpsOMPartResources *resources,
  ...
  HRESULT(STDMETHODCALLTYPE *CreateDocumentSequence)(
      IXpsOMObjectFactory *This, IOpcPartUri *partUri,
      IXpsOMDocumentSequence **documentSequence);
  HRESULT(STDMETHODCALLTYPE *CreateDocument)(IXpsOMObjectFactory *This,
                                             IOpcPartUri *partUri,
                                             IXpsOMDocument **document);
  HRESULT(STDMETHODCALLTYPE *CreatePageReference)(
      IXpsOMObjectFactory *This, const XPS_SIZE *advisoryPageDimensions,
      IXpsOMPageReference **pageReference);
  HRESULT(STDMETHODCALLTYPE *CreatePage)(IXpsOMObjectFactory *This,
                                         const XPS_SIZE *pageDimensions,
                                         LPCWSTR language, IOpcPartUri *partUri,
                                         IXpsOMPage **page);
  HRESULT(STDMETHODCALLTYPE *CreatePageFromStream)(
      IXpsOMObjectFactory *This, IStream *pageMarkupStream,
      IOpcPartUri *partUri, IXpsOMPartResources *resources,
      WINBOOL reuseObjects, IXpsOMPage **page);
  HRESULT(STDMETHODCALLTYPE *CreateCanvas)(IXpsOMObjectFactory *This,
                                           IXpsOMCanvas **canvas);
  HRESULT(STDMETHODCALLTYPE *CreateGlyphs)(IXpsOMObjectFactory *This,
                                           IXpsOMFontResource *fontResource,
                                           IXpsOMGlyphs **glyphs);
  HRESULT(STDMETHODCALLTYPE *CreatePath)(IXpsOMObjectFactory *This,
                                         IXpsOMPath **path);
  HRESULT(STDMETHODCALLTYPE *CreateGeometry)(IXpsOMObjectFactory *This,
                                             IXpsOMGeometry **geometry);
  HRESULT(STDMETHODCALLTYPE *CreateGeometryFigure)(
      IXpsOMObjectFactory *This, const XPS_POINT *startPoint,
      IXpsOMGeometryFigure **figure);
  HRESULT(STDMETHODCALLTYPE *CreateMatrixTransform)(
      IXpsOMObjectFactory *This, const XPS_MATRIX *matrix,
      IXpsOMMatrixTransform **transform);
  HRESULT(STDMETHODCALLTYPE *CreateSolidColorBrush)(
      IXpsOMObjectFactory *This, const XPS_COLOR *color,
      IXpsOMColorProfileResource *colorProfile,
  ...
  HRESULT(STDMETHODCALLTYPE *CreateImageBrush)(IXpsOMObjectFactory *This,
                                               IXpsOMImageResource *image,
                                               const XPS_RECT *viewBox,
                                               const XPS_RECT *viewPort,
                                               IXpsOMImageBrush **imageBrush);
  HRESULT(STDMETHODCALLTYPE *CreateVisualBrush)(
      IXpsOMObjectFactory *This, const XPS_RECT *viewBox,
      const XPS_RECT *viewPort, IXpsOMVisualBrush **visualBrush);
  HRESULT(STDMETHODCALLTYPE *CreateImageResource)(
      IXpsOMObjectFactory *This, IStream *acquiredStream,
      XPS_IMAGE_TYPE contentType, IOpcPartUri *partUri,
      IXpsOMImageResource **imageResource);
  ...
  HRESULT(STDMETHODCALLTYPE *CreateFontResource)(
      IXpsOMObjectFactory *This, IStream *acquiredStream,
      XPS_FONT_EMBEDDING fontEmbedding, IOpcPartUri *partUri,
      WINBOOL isObfSourceStream, IXpsOMFontResource **fontResource);
  HRESULT(STDMETHODCALLTYPE *CreateGradientStop)(
      IXpsOMObjectFactory *This, const XPS_COLOR *color,
      IXpsOMColorProfileResource *colorProfile, FLOAT offset,
      IXpsOMGradientStop **gradientStop);
  HRESULT(STDMETHODCALLTYPE *CreateLinearGradientBrush)(
      IXpsOMObjectFactory *This, IXpsOMGradientStop *gradStop1,
      IXpsOMGradientStop *gradStop2, const XPS_POINT *startPoint,
      const XPS_POINT *endPoint,
      IXpsOMLinearGradientBrush **linearGradientBrush);
  HRESULT(STDMETHODCALLTYPE *CreateRadialGradientBrush)(
      IXpsOMObjectFactory *This, IXpsOMGradientStop *gradStop1,
      IXpsOMGradientStop *gradStop2, const XPS_POINT *centerPoint,
      const XPS_POINT *gradientOrigin, const XPS_SIZE *radiiSizes,
      IXpsOMRadialGradientBrush **radialGradientBrush);
  HRESULT(STDMETHODCALLTYPE *CreateCoreProperties)(
      IXpsOMObjectFactory *This, IOpcPartUri *partUri,
      IXpsOMCoreProperties **coreProperties);
  HRESULT(STDMETHODCALLTYPE *CreateDictionary)(IXpsOMObjectFactory *This,
                                               IXpsOMDictionary **dictionary);
  HRESULT(STDMETHODCALLTYPE *CreatePartUriCollection)(
      IXpsOMObjectFactory *This, IXpsOMPartUriCollection **partUriCollection);
  HRESULT(STDMETHODCALLTYPE *CreatePackageWriterOnFile)(
      IXpsOMObjectFactory *This, LPCWSTR fileName,
      LPSECURITY_ATTRIBUTES securityAttributes, DWORD flagsAndAttributes,
      WINBOOL optimizeMarkupSize, XPS_INTERLEAVING interleaving,
  ...
  HRESULT(STDMETHODCALLTYPE *CreatePackageWriterOnStream)(
      IXpsOMObjectFactory *This, ISequentialStream *outputStream,
      WINBOOL optimizeMarkupSize, XPS_INTERLEAVING interleaving,
      IOpcPartUri *documentSequencePartName,
      IXpsOMCoreProperties *coreProperties,
      IXpsOMImageResource *packageThumbnail,
      IXpsOMPrintTicketResource *documentSequencePrintTicket,
      IOpcPartUri *discardControlPartName, IXpsOMPackageWriter **packageWriter);
  HRESULT(STDMETHODCALLTYPE *CreatePartUri)(IXpsOMObjectFactory *This,
                                            LPCWSTR uri, IOpcPartUri **partUri);
  HRESULT(STDMETHODCALLTYPE *CreateReadOnlyStreamOnFile)(
      IXpsOMObjectFactory *This, LPCWSTR filename, IStream **stream);
  END_INTERFACE
} IXpsOMObjectFactoryVtbl;
interface IXpsOMObjectFactory { CONST_VTBL IXpsOMObjectFactoryVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define IXpsOMObjectFactory_CreatePackageFromFile(This, filename,              \
                                                  reuseObjects, package)       \
  (This)->lpVtbl->CreatePackageFromFile(This, filename, reuseObjects, package)
#define IXpsOMObjectFactory_CreatePackageFromStream(This, stream,              \
                                                    reuseObjects, package)     \
  (This)->lpVtbl->CreatePackageFromStream(This, stream, reuseObjects, package)
#define IXpsOMObjectFactory_CreateStoryFragmentsResource(                      \
    This, acquiredStream, partUri, storyFragmentsResource)                     \
  (This)->lpVtbl->CreateStoryFragmentsResource(This, acquiredStream, partUri,  \
                                               storyFragmentsResource)
#define IXpsOMObjectFactory_CreateDocumentStructureResource(                   \
    This, acquiredStream, partUri, documentStructureResource)                  \
  (This)->lpVtbl->CreateDocumentStructureResource(                             \
      This, acquiredStream, partUri, documentStructureResource)
#define IXpsOMObjectFactory_CreateSignatureBlockResource(                      \
    This, acquiredStream, partUri, signatureBlockResource)                     \
  (This)->lpVtbl->CreateSignatureBlockResource(This, acquiredStream, partUri,  \
                                               signatureBlockResource)
#define IXpsOMObjectFactory_CreateRemoteDictionaryResource(                    \
    This, dictionary, partUri, remoteDictionaryResource)                       \
  (This)->lpVtbl->CreateRemoteDictionaryResource(This, dictionary, partUri,    \
                                                 remoteDictionaryResource)
#define IXpsOMObjectFactory_CreateRemoteDictionaryResourceFromStream(          \
    This, dictionaryMarkupStream, dictionaryPartUri, resources,                \
    dictionaryResource)                                                        \
...
#define IXpsOMObjectFactory_CreateDocumentSequence(This, partUri,              \
                                                   documentSequence)           \
...
#define IXpsOMObjectFactory_CreatePageReference(This, advisoryPageDimensions,  \
                                                pageReference)                 \
  (This)->lpVtbl->CreatePageReference(This, advisoryPageDimensions,            \
                                      pageReference)
#define IXpsOMObjectFactory_CreatePage(This, pageDimensions, language,         \
                                       partUri, page)                          \
  (This)->lpVtbl->CreatePage(This, pageDimensions, language, partUri, page)
#define IXpsOMObjectFactory_CreatePageFromStream(                              \
    This, pageMarkupStream, partUri, resources, reuseObjects, page)            \
  (This)->lpVtbl->CreatePageFromStream(This, pageMarkupStream, partUri,        \
                                       resources, reuseObjects, page)
...
#define IXpsOMObjectFactory_CreateSolidColorBrush(This, color, colorProfile,   \
                                                  solidColorBrush)             \
  (This)->lpVtbl->CreateSolidColorBrush(This, color, colorProfile,             \
                                        solidColorBrush)
#define IXpsOMObjectFactory_CreateColorProfileResource(                        \
    This, acquiredStream, partUri, colorProfileResource)                       \
  (This)->lpVtbl->CreateColorProfileResource(This, acquiredStream, partUri,    \
                                             colorProfileResource)
#define IXpsOMObjectFactory_CreateImageBrush(This, image, viewBox, viewPort,   \
                                             imageBrush)                       \
  (This)->lpVtbl->CreateImageBrush(This, image, viewBox, viewPort, imageBrush)
#define IXpsOMObjectFactory_CreateVisualBrush(This, viewBox, viewPort,         \
                                              visualBrush)                     \
  (This)->lpVtbl->CreateVisualBrush(This, viewBox, viewPort, visualBrush)
#define IXpsOMObjectFactory_CreateImageResource(                               \
    This, acquiredStream, contentType, partUri, imageResource)                 \
  (This)->lpVtbl->CreateImageResource(This, acquiredStream, contentType,       \
                                      partUri, imageResource)
#define IXpsOMObjectFactory_CreatePrintTicketResource(                         \
    This, acquiredStream, partUri, printTicketResource)                        \
  (This)->lpVtbl->CreatePrintTicketResource(This, acquiredStream, partUri,     \
                                            printTicketResource)
#define IXpsOMObjectFactory_CreateFontResource(                                \
    This, acquiredStream, fontEmbedding, partUri, isObfSourceStream,           \
    fontResource)                                                              \
  (This)->lpVtbl->CreateFontResource(This, acquiredStream, fontEmbedding,      \
                                     partUri, isObfSourceStream, fontResource)
#define IXpsOMObjectFactory_CreateGradientStop(This, color, colorProfile,      \
                                               offset, gradientStop)           \
  (This)->lpVtbl->CreateGradientStop(This, color, colorProfile, offset,        \
                                     gradientStop)
#define IXpsOMObjectFactory_CreateLinearGradientBrush(                         \
    This, gradStop1, gradStop2, startPoint, endPoint, linearGradientBrush)     \
  (This)->lpVtbl->CreateLinearGradientBrush(                                   \
      This, gradStop1, gradStop2, startPoint, endPoint, linearGradientBrush)
#define IXpsOMObjectFactory_CreateRadialGradientBrush(                         \
    This, gradStop1, gradStop2, centerPoint, gradientOrigin, radiiSizes,       \
    radialGradientBrush)                                                       \
  (This)->lpVtbl->CreateRadialGradientBrush(This, gradStop1, gradStop2,        \
                                            centerPoint, gradientOrigin,       \
                                            radiiSizes, radialGradientBrush)
#define IXpsOMObjectFactory_CreateCoreProperties(This, partUri,                \
                                                 coreProperties)               \
...
#define IXpsOMObjectFactory_CreatePackageWriterOnFile(                         \
  ...
  (This)->lpVtbl->CreatePackageWriterOnFile(                                   \
      This, fileName, securityAttributes, flagsAndAttributes,                  \
      optimizeMarkupSize, interleaving, documentSequencePartName,              \
      coreProperties, packageThumbnail, documentSequencePrintTicket,           \
      discardControlPartName, packageWriter)
#define IXpsOMObjectFactory_CreatePackageWriterOnStream(                       \
    This, outputStream, optimizeMarkupSize, interleaving,                      \
    documentSequencePartName, coreProperties, packageThumbnail,                \
    documentSequencePrintTicket, discardControlPartName, packageWriter)        \
  (This)->lpVtbl->CreatePackageWriterOnStream(                                 \
      This, outputStream, optimizeMarkupSize, interleaving,                    \
      documentSequencePartName, coreProperties, packageThumbnail,              \
      documentSequencePrintTicket, discardControlPartName, packageWriter)
...
/*** IUnknown methods ***/
static inline HRESULT
IXpsOMObjectFactory_QueryInterface(IXpsOMObjectFactory *This, REFIID riid,
                                   void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IXpsOMObjectFactory methods ***/
static inline HRESULT
IXpsOMObjectFactory_CreatePackage(IXpsOMObjectFactory *This,
                                  IXpsOMPackage **package) {
  return This->lpVtbl->CreatePackage(This, package);
}
static inline HRESULT IXpsOMObjectFactory_CreatePackageFromFile(
    IXpsOMObjectFactory *This, LPCWSTR filename, WINBOOL reuseObjects,
    IXpsOMPackage **package) {
  return This->lpVtbl->CreatePackageFromFile(This, filename, reuseObjects,
                                             package);
}
static inline HRESULT IXpsOMObjectFactory_CreatePackageFromStream(
    IXpsOMObjectFactory *This, IStream *stream, WINBOOL reuseObjects,
    IXpsOMPackage **package) {
  return This->lpVtbl->CreatePackageFromStream(This, stream, reuseObjects,
                                               package);
}
static inline HRESULT IXpsOMObjectFactory_CreateStoryFragmentsResource(
    IXpsOMObjectFactory *This, IStream *acquiredStream, IOpcPartUri *partUri,
    IXpsOMStoryFragmentsResource **storyFragmentsResource) {
  return This->lpVtbl->CreateStoryFragmentsResource(
      This, acquiredStream, partUri, storyFragmentsResource);
}
static inline HRESULT IXpsOMObjectFactory_CreateDocumentStructureResource(
    IXpsOMObjectFactory *This, IStream *acquiredStream, IOpcPartUri *partUri,
    IXpsOMDocumentStructureResource **documentStructureResource) {
  return This->lpVtbl->CreateDocumentStructureResource(
      This, acquiredStream, partUri, documentStructureResource);
}
static inline HRESULT IXpsOMObjectFactory_CreateSignatureBlockResource(
    IXpsOMObjectFactory *This, IStream *acquiredStream, IOpcPartUri *partUri,
    IXpsOMSignatureBlockResource **signatureBlockResource) {
  return This->lpVtbl->CreateSignatureBlockResource(
      This, acquiredStream, partUri, signatureBlockResource);
}
static inline HRESULT IXpsOMObjectFactory_CreateRemoteDictionaryResource(
    ...
    IOpcPartUri *partUri,
    IXpsOMRemoteDictionaryResource **remoteDictionaryResource) {
  return This->lpVtbl->CreateRemoteDictionaryResource(This, dictionary, partUri,
                                                      remoteDictionaryResource);
}
static inline HRESULT
IXpsOMObjectFactory_CreateRemoteDictionaryResourceFromStream(
    IXpsOMObjectFactory *This, IStream *dictionaryMarkupStream,
    IOpcPartUri *dictionaryPartUri, IXpsOMPartResources *resources,
    IXpsOMRemoteDictionaryResource **dictionaryResource) {
  return This->lpVtbl->CreateRemoteDictionaryResourceFromStream(
      This, dictionaryMarkupStream, dictionaryPartUri, resources,
      dictionaryResource);
}
static inline HRESULT
IXpsOMObjectFactory_CreatePartResources(IXpsOMObjectFactory *This,
                                        IXpsOMPartResources **partResources) {
  return This->lpVtbl->CreatePartResources(This, partResources);
}
static inline HRESULT IXpsOMObjectFactory_CreateDocumentSequence(
    IXpsOMObjectFactory *This, IOpcPartUri *partUri,
    IXpsOMDocumentSequence **documentSequence) {
  return This->lpVtbl->CreateDocumentSequence(This, partUri, documentSequence);
}
static inline HRESULT
IXpsOMObjectFactory_CreateDocument(IXpsOMObjectFactory *This,
                                   IOpcPartUri *partUri,
                                   IXpsOMDocument **document) {
  return This->lpVtbl->CreateDocument(This, partUri, document);
}
static inline HRESULT
IXpsOMObjectFactory_CreatePageReference(IXpsOMObjectFactory *This,
                                        const XPS_SIZE *advisoryPageDimensions,
                                        IXpsOMPageReference **pageReference) {
  return This->lpVtbl->CreatePageReference(This, advisoryPageDimensions,
                                           pageReference);
}
static inline HRESULT
IXpsOMObjectFactory_CreatePage(IXpsOMObjectFactory *This,
                               const XPS_SIZE *pageDimensions, LPCWSTR language,
                               IOpcPartUri *partUri, IXpsOMPage **page) {
  return This->lpVtbl->CreatePage(This, pageDimensions, language, partUri,
                                  page);
}
static inline HRESULT IXpsOMObjectFactory_CreatePageFromStream(
    IXpsOMObjectFactory *This, IStream *pageMarkupStream, IOpcPartUri *partUri,
    IXpsOMPartResources *resources, WINBOOL reuseObjects, IXpsOMPage **page) {
  return This->lpVtbl->CreatePageFromStream(This, pageMarkupStream, partUri,
                                            resources, reuseObjects, page);
}
static inline HRESULT
IXpsOMObjectFactory_CreateCanvas(IXpsOMObjectFactory *This,
                                 IXpsOMCanvas **canvas) {
  return This->lpVtbl->CreateCanvas(This, canvas);
}
static inline HRESULT
IXpsOMObjectFactory_CreateGlyphs(IXpsOMObjectFactory *This,
                                 IXpsOMFontResource *fontResource,
                                 IXpsOMGlyphs **glyphs) {
  return This->lpVtbl->CreateGlyphs(This, fontResource, glyphs);
}
static inline HRESULT IXpsOMObjectFactory_CreatePath(IXpsOMObjectFactory *This,
                                                     IXpsOMPath **path) {
  return This->lpVtbl->CreatePath(This, path);
}
static inline HRESULT
IXpsOMObjectFactory_CreateGeometry(IXpsOMObjectFactory *This,
                                   IXpsOMGeometry **geometry) {
  return This->lpVtbl->CreateGeometry(This, geometry);
}
static inline HRESULT
IXpsOMObjectFactory_CreateGeometryFigure(IXpsOMObjectFactory *This,
                                         const XPS_POINT *startPoint,
                                         IXpsOMGeometryFigure **figure) {
  return This->lpVtbl->CreateGeometryFigure(This, startPoint, figure);
}
static inline HRESULT
IXpsOMObjectFactory_CreateMatrixTransform(IXpsOMObjectFactory *This,
                                          const XPS_MATRIX *matrix,
                                          IXpsOMMatrixTransform **transform) {
  return This->lpVtbl->CreateMatrixTransform(This, matrix, transform);
}
static inline HRESULT IXpsOMObjectFactory_CreateSolidColorBrush(
    IXpsOMObjectFactory *This, const XPS_COLOR *color,
    IXpsOMColorProfileResource *colorProfile,
    IXpsOMSolidColorBrush **solidColorBrush) {
  return This->lpVtbl->CreateSolidColorBrush(This, color, colorProfile,
                                             solidColorBrush);
}
static inline HRESULT IXpsOMObjectFactory_CreateColorProfileResource(
    IXpsOMObjectFactory *This, IStream *acquiredStream, IOpcPartUri *partUri,
    IXpsOMColorProfileResource **colorProfileResource) {
  return This->lpVtbl->CreateColorProfileResource(This, acquiredStream, partUri,
                                                  colorProfileResource);
}
static inline HRESULT IXpsOMObjectFactory_CreateImageBrush(
    IXpsOMObjectFactory *This, IXpsOMImageResource *image,
    const XPS_RECT *viewBox, const XPS_RECT *viewPort,
    IXpsOMImageBrush **imageBrush) {
  return This->lpVtbl->CreateImageBrush(This, image, viewBox, viewPort,
                                        imageBrush);
}
static inline HRESULT IXpsOMObjectFactory_CreateVisualBrush(
    IXpsOMObjectFactory *This, const XPS_RECT *viewBox,
    const XPS_RECT *viewPort, IXpsOMVisualBrush **visualBrush) {
  return This->lpVtbl->CreateVisualBrush(This, viewBox, viewPort, visualBrush);
}
static inline HRESULT IXpsOMObjectFactory_CreateImageResource(
    IXpsOMObjectFactory *This, IStream *acquiredStream,
    XPS_IMAGE_TYPE contentType, IOpcPartUri *partUri,
    IXpsOMImageResource **imageResource) {
  return This->lpVtbl->CreateImageResource(This, acquiredStream, contentType,
                                           partUri, imageResource);
}
static inline HRESULT IXpsOMObjectFactory_CreatePrintTicketResource(
    IXpsOMObjectFactory *This, IStream *acquiredStream, IOpcPartUri *partUri,
    IXpsOMPrintTicketResource **printTicketResource) {
  return This->lpVtbl->CreatePrintTicketResource(This, acquiredStream, partUri,
                                                 printTicketResource);
}
static inline HRESULT IXpsOMObjectFactory_CreateFontResource(
    IXpsOMObjectFactory *This, IStream *acquiredStream,
    XPS_FONT_EMBEDDING fontEmbedding, IOpcPartUri *partUri,
    WINBOOL isObfSourceStream, IXpsOMFontResource **fontResource) {
  return This->lpVtbl->CreateFontResource(This, acquiredStream, fontEmbedding,
                                          partUri, isObfSourceStream,
                                          fontResource);
}
static inline HRESULT IXpsOMObjectFactory_CreateGradientStop(
    IXpsOMObjectFactory *This, const XPS_COLOR *color,
    IXpsOMColorProfileResource *colorProfile, FLOAT offset,
    IXpsOMGradientStop **gradientStop) {
  return This->lpVtbl->CreateGradientStop(This, color, colorProfile, offset,
                                          gradientStop);
}
static inline HRESULT IXpsOMObjectFactory_CreateLinearGradientBrush(
    IXpsOMObjectFactory *This, IXpsOMGradientStop *gradStop1,
    IXpsOMGradientStop *gradStop2, const XPS_POINT *startPoint,
    const XPS_POINT *endPoint,
    IXpsOMLinearGradientBrush **linearGradientBrush) {
  return This->lpVtbl->CreateLinearGradientBrush(
      This, gradStop1, gradStop2, startPoint, endPoint, linearGradientBrush);
}
...
static inline HRESULT IXpsOMObjectFactory_CreateCoreProperties(
    IXpsOMObjectFactory *This, IOpcPartUri *partUri,
    IXpsOMCoreProperties **coreProperties) {
  return This->lpVtbl->CreateCoreProperties(This, partUri, coreProperties);
}
static inline HRESULT
IXpsOMObjectFactory_CreateDictionary(IXpsOMObjectFactory *This,
                                     IXpsOMDictionary **dictionary) {
  return This->lpVtbl->CreateDictionary(This, dictionary);
}
static inline HRESULT IXpsOMObjectFactory_CreatePartUriCollection(
    IXpsOMObjectFactory *This, IXpsOMPartUriCollection **partUriCollection) {
...
static inline HRESULT IXpsOMObjectFactory_CreatePackageWriterOnFile(
    ...
    LPSECURITY_ATTRIBUTES securityAttributes, DWORD flagsAndAttributes,
    WINBOOL optimizeMarkupSize, XPS_INTERLEAVING interleaving,
    IOpcPartUri *documentSequencePartName, IXpsOMCoreProperties *coreProperties,
    IXpsOMImageResource *packageThumbnail,
    IXpsOMPrintTicketResource *documentSequencePrintTicket,
    IOpcPartUri *discardControlPartName, IXpsOMPackageWriter **packageWriter) {
  return This->lpVtbl->CreatePackageWriterOnFile(
      This, fileName, securityAttributes, flagsAndAttributes,
      optimizeMarkupSize, interleaving, documentSequencePartName,
      coreProperties, packageThumbnail, documentSequencePrintTicket,
      discardControlPartName, packageWriter);
...
static inline HRESULT IXpsOMObjectFactory_CreatePackageWriterOnStream(
    ...
    IXpsOMPrintTicketResource *documentSequencePrintTicket,
    IOpcPartUri *discardControlPartName, IXpsOMPackageWriter **packageWriter) {
  return This->lpVtbl->CreatePackageWriterOnStream(
      This, outputStream, optimizeMarkupSize, interleaving,
      documentSequencePartName, coreProperties, packageThumbnail,
      documentSequencePrintTicket, discardControlPartName, packageWriter);
}
static inline HRESULT
IXpsOMObjectFactory_CreatePartUri(IXpsOMObjectFactory *This, LPCWSTR uri,
                                  IOpcPartUri **partUri) {
  return This->lpVtbl->CreatePartUri(This, uri, partUri);
}
static inline HRESULT IXpsOMObjectFactory_CreateReadOnlyStreamOnFile(
    IXpsOMObjectFactory *This, LPCWSTR filename, IStream **stream) {
...
DEFINE_GUID(IID_IXpsOMNameCollection, 0x4bddf8ec, 0xc915, 0x421b, 0xa1, 0x66,
            0xd1, 0x73, 0xd2, 0x56, 0x53, 0xd2);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("4bddf8ec-c915-421b-a166-d173d25653d2")
IXpsOMNameCollection : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetCount(UINT32 * count) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetAt(UINT32 index, LPWSTR * name) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMNameCollection, 0x4bddf8ec, 0xc915, 0x421b, 0xa1, 0x66,
                0xd1, 0x73, 0xd2, 0x56, 0x53, 0xd2)
#endif
#else
typedef struct IXpsOMNameCollectionVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsOMNameCollection *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetCount)(IXpsOMNameCollection *This,
                                       UINT32 *count);
  HRESULT(STDMETHODCALLTYPE *GetAt)(IXpsOMNameCollection *This, UINT32 index,
                                    LPWSTR *name);
  END_INTERFACE
} IXpsOMNameCollectionVtbl;
interface IXpsOMNameCollection { CONST_VTBL IXpsOMNameCollectionVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
IXpsOMNameCollection_QueryInterface(IXpsOMNameCollection *This, REFIID riid,
                                    void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IXpsOMNameCollection methods ***/
static inline HRESULT IXpsOMNameCollection_GetCount(IXpsOMNameCollection *This,
                                                    UINT32 *count) {
  return This->lpVtbl->GetCount(This, count);
}
static inline HRESULT IXpsOMNameCollection_GetAt(IXpsOMNameCollection *This,
...
DEFINE_GUID(IID_IXpsOMPartUriCollection, 0x57c650d4, 0x067c, 0x4893, 0x8c, 0x33,
            0xf6, 0x2a, 0x06, 0x33, 0x73, 0x0f);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IXpsOMPartUriCollection : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE SetAt(UINT32 index,
                                          IOpcPartUri * partUri) = 0;
  virtual HRESULT STDMETHODCALLTYPE Append(IOpcPartUri * partUri) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMPartUriCollection, 0x57c650d4, 0x067c, 0x4893, 0x8c, 0x33,
                0xf6, 0x2a, 0x06, 0x33, 0x73, 0x0f)
#endif
#else
typedef struct IXpsOMPartUriCollectionVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsOMPartUriCollection *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetCount)(IXpsOMPartUriCollection *This,
                                       UINT32 *count);
  HRESULT(STDMETHODCALLTYPE *GetAt)(IXpsOMPartUriCollection *This, UINT32 index,
                                    IOpcPartUri **partUri);
  HRESULT(STDMETHODCALLTYPE *InsertAt)(IXpsOMPartUriCollection *This,
                                       UINT32 index, IOpcPartUri *partUri);
  HRESULT(STDMETHODCALLTYPE *RemoveAt)(IXpsOMPartUriCollection *This,
                                       UINT32 index);
  HRESULT(STDMETHODCALLTYPE *SetAt)(IXpsOMPartUriCollection *This, UINT32 index,
                                    IOpcPartUri *partUri);
  HRESULT(STDMETHODCALLTYPE *Append)(IXpsOMPartUriCollection *This,
                                     IOpcPartUri *partUri);
  END_INTERFACE
...
/*** IUnknown methods ***/
static inline HRESULT
IXpsOMPartUriCollection_QueryInterface(IXpsOMPartUriCollection *This,
                                       REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IXpsOMPartUriCollection_AddRef(IXpsOMPartUriCollection *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IXpsOMPartUriCollection_Release(IXpsOMPartUriCollection *This) {
  return This->lpVtbl->Release(This);
}
/*** IXpsOMPartUriCollection methods ***/
static inline HRESULT
IXpsOMPartUriCollection_GetCount(IXpsOMPartUriCollection *This, UINT32 *count) {
  return This->lpVtbl->GetCount(This, count);
}
static inline HRESULT
IXpsOMPartUriCollection_GetAt(IXpsOMPartUriCollection *This, UINT32 index,
                              IOpcPartUri **partUri) {
  return This->lpVtbl->GetAt(This, index, partUri);
}
static inline HRESULT
IXpsOMPartUriCollection_InsertAt(IXpsOMPartUriCollection *This, UINT32 index,
                                 IOpcPartUri *partUri) {
  return This->lpVtbl->InsertAt(This, index, partUri);
}
static inline HRESULT
IXpsOMPartUriCollection_RemoveAt(IXpsOMPartUriCollection *This, UINT32 index) {
  return This->lpVtbl->RemoveAt(This, index);
}
static inline HRESULT
IXpsOMPartUriCollection_SetAt(IXpsOMPartUriCollection *This, UINT32 index,
                              IOpcPartUri *partUri) {
  return This->lpVtbl->SetAt(This, index, partUri);
}
static inline HRESULT
IXpsOMPartUriCollection_Append(IXpsOMPartUriCollection *This,
                               IOpcPartUri *partUri) {
...
DEFINE_GUID(IID_IXpsOMPackageWriter, 0x4e2aa182, 0xa443, 0x42c6, 0xb4, 0x1b,
            0x4f, 0x8e, 0x9d, 0xe7, 0x3f, 0xf9);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IXpsOMPackageWriter : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE AddPage(
      IXpsOMPage * page, const XPS_SIZE *advisoryPageDimensions,
  ...
  virtual HRESULT STDMETHODCALLTYPE AddResource(IXpsOMResource * resource) = 0;
  virtual HRESULT STDMETHODCALLTYPE Close() = 0;
  virtual HRESULT STDMETHODCALLTYPE IsClosed(WINBOOL * isClosed) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMPackageWriter, 0x4e2aa182, 0xa443, 0x42c6, 0xb4, 0x1b,
                0x4f, 0x8e, 0x9d, 0xe7, 0x3f, 0xf9)
#endif
#else
typedef struct IXpsOMPackageWriterVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsOMPackageWriter *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *StartNewDocument)(
      IXpsOMPackageWriter *This, IOpcPartUri *documentPartName,
      IXpsOMPrintTicketResource *documentPrintTicket,
      IXpsOMDocumentStructureResource *documentStructure,
      IXpsOMSignatureBlockResourceCollection *signatureBlockResources,
      IXpsOMPartUriCollection *restrictedFonts);
  HRESULT(STDMETHODCALLTYPE *AddPage)(
      IXpsOMPackageWriter *This, IXpsOMPage *page,
      const XPS_SIZE *advisoryPageDimensions,
      IXpsOMPartUriCollection *discardableResourceParts,
      IXpsOMStoryFragmentsResource *storyFragments,
      IXpsOMPrintTicketResource *pagePrintTicket,
      IXpsOMImageResource *pageThumbnail);
  HRESULT(STDMETHODCALLTYPE *AddResource)(IXpsOMPackageWriter *This,
                                          IXpsOMResource *resource);
  HRESULT(STDMETHODCALLTYPE *Close)(IXpsOMPackageWriter *This);
  HRESULT(STDMETHODCALLTYPE *IsClosed)(IXpsOMPackageWriter *This,
                                       WINBOOL *isClosed);
  END_INTERFACE
} IXpsOMPackageWriterVtbl;
interface IXpsOMPackageWriter { CONST_VTBL IXpsOMPackageWriterVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IXpsOMPackageWriter methods ***/
#define IXpsOMPackageWriter_StartNewDocument(                                  \
    This, documentPartName, documentPrintTicket, documentStructure,            \
    signatureBlockResources, restrictedFonts)                                  \
  (This)->lpVtbl->StartNewDocument(This, documentPartName,                     \
                                   documentPrintTicket, documentStructure,     \
                                   signatureBlockResources, restrictedFonts)
#define IXpsOMPackageWriter_AddPage(This, page, advisoryPageDimensions,        \
                                    discardableResourceParts, storyFragments,  \
                                    pagePrintTicket, pageThumbnail)            \
  (This)->lpVtbl->AddPage(This, page, advisoryPageDimensions,                  \
                          discardableResourceParts, storyFragments,            \
                          pagePrintTicket, pageThumbnail)
...
/*** IUnknown methods ***/
static inline HRESULT
IXpsOMPackageWriter_QueryInterface(IXpsOMPackageWriter *This, REFIID riid,
                                   void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IXpsOMPackageWriter methods ***/
static inline HRESULT IXpsOMPackageWriter_StartNewDocument(
    IXpsOMPackageWriter *This, IOpcPartUri *documentPartName,
    IXpsOMPrintTicketResource *documentPrintTicket,
    IXpsOMDocumentStructureResource *documentStructure,
    IXpsOMSignatureBlockResourceCollection *signatureBlockResources,
    IXpsOMPartUriCollection *restrictedFonts) {
  return This->lpVtbl->StartNewDocument(
      This, documentPartName, documentPrintTicket, documentStructure,
      signatureBlockResources, restrictedFonts);
}
static inline HRESULT
IXpsOMPackageWriter_AddPage(IXpsOMPackageWriter *This, IXpsOMPage *page,
                            const XPS_SIZE *advisoryPageDimensions,
                            IXpsOMPartUriCollection *discardableResourceParts,
                            IXpsOMStoryFragmentsResource *storyFragments,
                            IXpsOMPrintTicketResource *pagePrintTicket,
                            IXpsOMImageResource *pageThumbnail) {
  return This->lpVtbl->AddPage(This, page, advisoryPageDimensions,
                               discardableResourceParts, storyFragments,
                               pagePrintTicket, pageThumbnail);
}
static inline HRESULT
IXpsOMPackageWriter_AddResource(IXpsOMPackageWriter *This,
                                IXpsOMResource *resource) {
...
static inline HRESULT IXpsOMPackageWriter_IsClosed(IXpsOMPackageWriter *This,
                                                   WINBOOL *isClosed) {
...
DEFINE_GUID(IID_IXpsOMPackageTarget, 0x219a9db0, 0x4959, 0x47d0, 0x80, 0x34,
            0xb1, 0xce, 0x84, 0xf4, 0x1a, 0x4d);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMPackageTarget, 0x219a9db0, 0x4959, 0x47d0, 0x80, 0x34,
                0xb1, 0xce, 0x84, 0xf4, 0x1a, 0x4d)
#endif
#else
typedef struct IXpsOMPackageTargetVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsOMPackageTarget *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IXpsOMPackageTarget *This);
  ULONG(STDMETHODCALLTYPE *Release)(IXpsOMPackageTarget *This);
  /*** IXpsOMPackageTarget methods ***/
  HRESULT(STDMETHODCALLTYPE *CreateXpsOMPackageWriter)(
      IXpsOMPackageTarget *This, IOpcPartUri *documentSequencePartName,
      IXpsOMPrintTicketResource *documentSequencePrintTicket,
      IOpcPartUri *discardControlPartName, IXpsOMPackageWriter **packageWriter);
  END_INTERFACE
} IXpsOMPackageTargetVtbl;
interface IXpsOMPackageTarget { CONST_VTBL IXpsOMPackageTargetVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IXpsOMPackageTarget methods ***/
#define IXpsOMPackageTarget_CreateXpsOMPackageWriter(                          \
    This, documentSequencePartName, documentSequencePrintTicket,               \
    discardControlPartName, packageWriter)                                     \
  (This)->lpVtbl->CreateXpsOMPackageWriter(                                    \
      This, documentSequencePartName, documentSequencePrintTicket,             \
      discardControlPartName, packageWriter)
#else
/*** IUnknown methods ***/
static inline HRESULT
IXpsOMPackageTarget_QueryInterface(IXpsOMPackageTarget *This, REFIID riid,
                                   void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IXpsOMPackageTarget methods ***/
static inline HRESULT IXpsOMPackageTarget_CreateXpsOMPackageWriter(
    IXpsOMPackageTarget *This, IOpcPartUri *documentSequencePartName,
    IXpsOMPrintTicketResource *documentSequencePrintTicket,
    IOpcPartUri *discardControlPartName, IXpsOMPackageWriter **packageWriter) {
  return This->lpVtbl->CreateXpsOMPackageWriter(
      This, documentSequencePartName, documentSequencePrintTicket,
      discardControlPartName, packageWriter);
}
#endif
...
DEFINE_GUID(IID_IXpsOMVisual, 0xbc3e7333, 0xfb0b, 0x4af3, 0xa8, 0x19, 0x0b,
            0x4e, 0xaa, 0xd0, 0xd2, 0xfd);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("bc3e7333-fb0b-4af3-a819-0b4eaad0d2fd")
IXpsOMVisual : public IXpsOMShareable {
  virtual HRESULT STDMETHODCALLTYPE GetTransform(IXpsOMMatrixTransform *
                                                 *matrixTransform) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetTransformLocal(IXpsOMMatrixTransform *
                                                      *matrixTransform) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetTransformLocal(IXpsOMMatrixTransform *
                                                      matrixTransform) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetTransformLookup(LPWSTR * key) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetTransformLookup(LPCWSTR key) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetClipGeometry(IXpsOMGeometry *
                                                    *clipGeometry) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetClipGeometryLocal(IXpsOMGeometry *
                                                         *clipGeometry) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetClipGeometryLocal(IXpsOMGeometry *
                                                         clipGeometry) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetClipGeometryLookup(LPWSTR * key) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetClipGeometryLookup(LPCWSTR key) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetOpacity(FLOAT * opacity) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetOpacity(FLOAT opacity) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetOpacityMaskBrush(IXpsOMBrush *
                                                        *opacityMaskBrush) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE SetOpacityMaskBrushLocal(
      IXpsOMBrush * opacityMaskBrush) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetOpacityMaskBrushLookup(LPWSTR * key) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetOpacityMaskBrushLookup(LPCWSTR key) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetName(LPWSTR * name) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetName(LPCWSTR name) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetIsHyperlinkTarget(WINBOOL *
                                                         isHyperlink) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetIsHyperlinkTarget(
      WINBOOL isHyperlink) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetHyperlinkNavigateUri(IUri *
                                                            *hyperlinkUri) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetHyperlinkNavigateUri(IUri *
                                                            hyperlinkUri) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetLanguage(LPWSTR * language) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetLanguage(LPCWSTR language) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMVisual, 0xbc3e7333, 0xfb0b, 0x4af3, 0xa8, 0x19, 0x0b,
                0x4e, 0xaa, 0xd0, 0xd2, 0xfd)
#endif
#else
typedef struct IXpsOMVisualVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsOMVisual *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetType)(IXpsOMVisual *This,
                                      XPS_OBJECT_TYPE *type);
  ...
  HRESULT(STDMETHODCALLTYPE *SetTransformLocal)(
      IXpsOMVisual *This, IXpsOMMatrixTransform *matrixTransform);
  HRESULT(STDMETHODCALLTYPE *GetTransformLookup)(IXpsOMVisual *This,
                                                 LPWSTR *key);
  HRESULT(STDMETHODCALLTYPE *SetTransformLookup)(IXpsOMVisual *This,
                                                 LPCWSTR key);
  HRESULT(STDMETHODCALLTYPE *GetClipGeometry)(IXpsOMVisual *This,
                                              IXpsOMGeometry **clipGeometry);
  HRESULT(STDMETHODCALLTYPE *GetClipGeometryLocal)(
      IXpsOMVisual *This, IXpsOMGeometry **clipGeometry);
  HRESULT(STDMETHODCALLTYPE *SetClipGeometryLocal)(
      IXpsOMVisual *This, IXpsOMGeometry *clipGeometry);
  HRESULT(STDMETHODCALLTYPE *GetClipGeometryLookup)(IXpsOMVisual *This,
                                                    LPWSTR *key);
  HRESULT(STDMETHODCALLTYPE *SetClipGeometryLookup)(IXpsOMVisual *This,
                                                    LPCWSTR key);
  ...
  HRESULT(STDMETHODCALLTYPE *GetOpacityMaskBrush)(
      IXpsOMVisual *This, IXpsOMBrush **opacityMaskBrush);
  HRESULT(STDMETHODCALLTYPE *GetOpacityMaskBrushLocal)(
      IXpsOMVisual *This, IXpsOMBrush **opacityMaskBrush);
  HRESULT(STDMETHODCALLTYPE *SetOpacityMaskBrushLocal)(
      IXpsOMVisual *This, IXpsOMBrush *opacityMaskBrush);
  HRESULT(STDMETHODCALLTYPE *GetOpacityMaskBrushLookup)(IXpsOMVisual *This,
                                                        LPWSTR *key);
  HRESULT(STDMETHODCALLTYPE *SetOpacityMaskBrushLookup)(IXpsOMVisual *This,
                                                        LPCWSTR key);
  ...
  HRESULT(STDMETHODCALLTYPE *GetIsHyperlinkTarget)(IXpsOMVisual *This,
                                                   WINBOOL *isHyperlink);
  HRESULT(STDMETHODCALLTYPE *SetIsHyperlinkTarget)(IXpsOMVisual *This,
                                                   WINBOOL isHyperlink);
  HRESULT(STDMETHODCALLTYPE *GetHyperlinkNavigateUri)(IXpsOMVisual *This,
                                                      IUri **hyperlinkUri);
  HRESULT(STDMETHODCALLTYPE *SetHyperlinkNavigateUri)(IXpsOMVisual *This,
                                                      IUri *hyperlinkUri);
...
/*** IUnknown methods ***/
static inline HRESULT
IXpsOMVisual_QueryInterface(IXpsOMVisual *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IXpsOMShareable methods ***/
static inline HRESULT IXpsOMVisual_GetOwner(IXpsOMVisual *This,
                                            IUnknown **owner) {
  return This->lpVtbl->GetOwner(This, owner);
}
static inline HRESULT IXpsOMVisual_GetType(IXpsOMVisual *This,
                                           XPS_OBJECT_TYPE *type) {
  return This->lpVtbl->GetType(This, type);
}
/*** IXpsOMVisual methods ***/
static inline HRESULT
IXpsOMVisual_GetTransform(IXpsOMVisual *This,
                          IXpsOMMatrixTransform **matrixTransform) {
  return This->lpVtbl->GetTransform(This, matrixTransform);
}
static inline HRESULT
IXpsOMVisual_GetTransformLocal(IXpsOMVisual *This,
                               IXpsOMMatrixTransform **matrixTransform) {
  return This->lpVtbl->GetTransformLocal(This, matrixTransform);
}
static inline HRESULT
IXpsOMVisual_SetTransformLocal(IXpsOMVisual *This,
                               IXpsOMMatrixTransform *matrixTransform) {
  return This->lpVtbl->SetTransformLocal(This, matrixTransform);
}
static inline HRESULT IXpsOMVisual_GetTransformLookup(IXpsOMVisual *This,
                                                      LPWSTR *key) {
  return This->lpVtbl->GetTransformLookup(This, key);
}
static inline HRESULT IXpsOMVisual_SetTransformLookup(IXpsOMVisual *This,
                                                      LPCWSTR key) {
  return This->lpVtbl->SetTransformLookup(This, key);
}
static inline HRESULT
IXpsOMVisual_GetClipGeometry(IXpsOMVisual *This,
                             IXpsOMGeometry **clipGeometry) {
  return This->lpVtbl->GetClipGeometry(This, clipGeometry);
}
static inline HRESULT
IXpsOMVisual_GetClipGeometryLocal(IXpsOMVisual *This,
                                  IXpsOMGeometry **clipGeometry) {
  return This->lpVtbl->GetClipGeometryLocal(This, clipGeometry);
}
static inline HRESULT
IXpsOMVisual_SetClipGeometryLocal(IXpsOMVisual *This,
                                  IXpsOMGeometry *clipGeometry) {
  return This->lpVtbl->SetClipGeometryLocal(This, clipGeometry);
}
static inline HRESULT IXpsOMVisual_GetClipGeometryLookup(IXpsOMVisual *This,
                                                         LPWSTR *key) {
  return This->lpVtbl->GetClipGeometryLookup(This, key);
}
static inline HRESULT IXpsOMVisual_SetClipGeometryLookup(IXpsOMVisual *This,
                                                         LPCWSTR key) {
  return This->lpVtbl->SetClipGeometryLookup(This, key);
}
static inline HRESULT IXpsOMVisual_GetOpacity(IXpsOMVisual *This,
                                              FLOAT *opacity) {
  return This->lpVtbl->GetOpacity(This, opacity);
}
static inline HRESULT IXpsOMVisual_SetOpacity(IXpsOMVisual *This,
                                              FLOAT opacity) {
  return This->lpVtbl->SetOpacity(This, opacity);
}
static inline HRESULT
IXpsOMVisual_GetOpacityMaskBrush(IXpsOMVisual *This,
                                 IXpsOMBrush **opacityMaskBrush) {
  return This->lpVtbl->GetOpacityMaskBrush(This, opacityMaskBrush);
}
static inline HRESULT
IXpsOMVisual_GetOpacityMaskBrushLocal(IXpsOMVisual *This,
                                      IXpsOMBrush **opacityMaskBrush) {
  return This->lpVtbl->GetOpacityMaskBrushLocal(This, opacityMaskBrush);
}
static inline HRESULT
IXpsOMVisual_SetOpacityMaskBrushLocal(IXpsOMVisual *This,
                                      IXpsOMBrush *opacityMaskBrush) {
  return This->lpVtbl->SetOpacityMaskBrushLocal(This, opacityMaskBrush);
}
static inline HRESULT IXpsOMVisual_GetOpacityMaskBrushLookup(IXpsOMVisual *This,
                                                             LPWSTR *key) {
  return This->lpVtbl->GetOpacityMaskBrushLookup(This, key);
}
static inline HRESULT IXpsOMVisual_SetOpacityMaskBrushLookup(IXpsOMVisual *This,
                                                             LPCWSTR key) {
...
static inline HRESULT IXpsOMVisual_GetIsHyperlinkTarget(IXpsOMVisual *This,
                                                        WINBOOL *isHyperlink) {
  return This->lpVtbl->GetIsHyperlinkTarget(This, isHyperlink);
}
static inline HRESULT IXpsOMVisual_SetIsHyperlinkTarget(IXpsOMVisual *This,
                                                        WINBOOL isHyperlink) {
  return This->lpVtbl->SetIsHyperlinkTarget(This, isHyperlink);
}
static inline HRESULT
IXpsOMVisual_GetHyperlinkNavigateUri(IXpsOMVisual *This, IUri **hyperlinkUri) {
  return This->lpVtbl->GetHyperlinkNavigateUri(This, hyperlinkUri);
}
static inline HRESULT IXpsOMVisual_SetHyperlinkNavigateUri(IXpsOMVisual *This,
                                                           IUri *hyperlinkUri) {
  return This->lpVtbl->SetHyperlinkNavigateUri(This, hyperlinkUri);
}
static inline HRESULT IXpsOMVisual_GetLanguage(IXpsOMVisual *This,
                                               LPWSTR *language) {
  return This->lpVtbl->GetLanguage(This, language);
}
static inline HRESULT IXpsOMVisual_SetLanguage(IXpsOMVisual *This,
                                               LPCWSTR language) {
...
DEFINE_GUID(IID_IXpsOMBrush, 0x56a3f80c, 0xea4c, 0x4187, 0xa5, 0x7b, 0xa2, 0xa4,
            0x73, 0xb2, 0xb4, 0x2b);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMBrush, 0x56a3f80c, 0xea4c, 0x4187, 0xa5, 0x7b, 0xa2, 0xa4,
                0x73, 0xb2, 0xb4, 0x2b)
#endif
#else
typedef struct IXpsOMBrushVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsOMBrush *This, REFIID riid,
                                             void **ppvObject);
...
interface IXpsOMBrush { CONST_VTBL IXpsOMBrushVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IXpsOMBrush_QueryInterface(IXpsOMBrush *This, REFIID riid,
                                                 void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IXpsOMShareable methods ***/
static inline HRESULT IXpsOMBrush_GetOwner(IXpsOMBrush *This,
                                           IUnknown **owner) {
  return This->lpVtbl->GetOwner(This, owner);
}
static inline HRESULT IXpsOMBrush_GetType(IXpsOMBrush *This,
                                          XPS_OBJECT_TYPE *type) {
  return This->lpVtbl->GetType(This, type);
}
/*** IXpsOMBrush methods ***/
static inline HRESULT IXpsOMBrush_GetOpacity(IXpsOMBrush *This,
                                             FLOAT *opacity) {
  return This->lpVtbl->GetOpacity(This, opacity);
}
...
DEFINE_GUID(IID_IXpsOMMatrixTransform, 0xb77330ff, 0xbb37, 0x4501, 0xa9, 0x3e,
            0xf1, 0xb1, 0xe5, 0x0b, 0xfc, 0x46);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("b77330ff-bb37-4501-a93e-f1b1e50bfc46")
IXpsOMMatrixTransform : public IXpsOMShareable {
  virtual HRESULT STDMETHODCALLTYPE GetMatrix(XPS_MATRIX * matrix) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetMatrix(const XPS_MATRIX *matrix) = 0;
  virtual HRESULT STDMETHODCALLTYPE Clone(IXpsOMMatrixTransform *
                                          *matrixTransform) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMMatrixTransform, 0xb77330ff, 0xbb37, 0x4501, 0xa9, 0x3e,
                0xf1, 0xb1, 0xe5, 0x0b, 0xfc, 0x46)
#endif
#else
typedef struct IXpsOMMatrixTransformVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsOMMatrixTransform *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IXpsOMMatrixTransform *This);
  ULONG(STDMETHODCALLTYPE *Release)(IXpsOMMatrixTransform *This);
  /*** IXpsOMShareable methods ***/
  HRESULT(STDMETHODCALLTYPE *GetOwner)(IXpsOMMatrixTransform *This,
                                       IUnknown **owner);
  HRESULT(STDMETHODCALLTYPE *GetType)(IXpsOMMatrixTransform *This,
                                      XPS_OBJECT_TYPE *type);
  /*** IXpsOMMatrixTransform methods ***/
  HRESULT(STDMETHODCALLTYPE *GetMatrix)(IXpsOMMatrixTransform *This,
                                        XPS_MATRIX *matrix);
  HRESULT(STDMETHODCALLTYPE *SetMatrix)(IXpsOMMatrixTransform *This,
                                        const XPS_MATRIX *matrix);
  HRESULT(STDMETHODCALLTYPE *Clone)(IXpsOMMatrixTransform *This,
                                    IXpsOMMatrixTransform **matrixTransform);
  END_INTERFACE
...
/*** IUnknown methods ***/
static inline HRESULT
IXpsOMMatrixTransform_QueryInterface(IXpsOMMatrixTransform *This, REFIID riid,
                                     void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IXpsOMShareable methods ***/
static inline HRESULT
IXpsOMMatrixTransform_GetOwner(IXpsOMMatrixTransform *This, IUnknown **owner) {
  return This->lpVtbl->GetOwner(This, owner);
}
static inline HRESULT IXpsOMMatrixTransform_GetType(IXpsOMMatrixTransform *This,
                                                    XPS_OBJECT_TYPE *type) {
  return This->lpVtbl->GetType(This, type);
}
/*** IXpsOMMatrixTransform methods ***/
static inline HRESULT
IXpsOMMatrixTransform_GetMatrix(IXpsOMMatrixTransform *This,
                                XPS_MATRIX *matrix) {
  return This->lpVtbl->GetMatrix(This, matrix);
}
static inline HRESULT
IXpsOMMatrixTransform_SetMatrix(IXpsOMMatrixTransform *This,
                                const XPS_MATRIX *matrix) {
  return This->lpVtbl->SetMatrix(This, matrix);
}
static inline HRESULT
IXpsOMMatrixTransform_Clone(IXpsOMMatrixTransform *This,
                            IXpsOMMatrixTransform **matrixTransform) {
...
DEFINE_GUID(IID_IXpsOMGeometry, 0x64fcf3d7, 0x4d58, 0x44ba, 0xad, 0x73, 0xa1,
            0x3a, 0xf6, 0x49, 0x20, 0x72);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IXpsOMGeometry : public IXpsOMShareable {
  virtual HRESULT STDMETHODCALLTYPE GetFigures(IXpsOMGeometryFigureCollection *
                                               *figures) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetFillRule(XPS_FILL_RULE * fillRule) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetFillRule(XPS_FILL_RULE fillRule) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetTransform(IXpsOMMatrixTransform *
                                                 *transform) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetTransformLocal(IXpsOMMatrixTransform *
                                                      *transform) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetTransformLocal(IXpsOMMatrixTransform *
                                                      transform) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetTransformLookup(LPWSTR * lookup) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetTransformLookup(LPCWSTR lookup) = 0;
  virtual HRESULT STDMETHODCALLTYPE Clone(IXpsOMGeometry * *geometry) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMGeometry, 0x64fcf3d7, 0x4d58, 0x44ba, 0xad, 0x73, 0xa1,
                0x3a, 0xf6, 0x49, 0x20, 0x72)
#endif
#else
typedef struct IXpsOMGeometryVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsOMGeometry *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetType)(IXpsOMGeometry *This,
                                      XPS_OBJECT_TYPE *type);
  /*** IXpsOMGeometry methods ***/
  HRESULT(STDMETHODCALLTYPE *GetFigures)(
      IXpsOMGeometry *This, IXpsOMGeometryFigureCollection **figures);
  HRESULT(STDMETHODCALLTYPE *GetFillRule)(IXpsOMGeometry *This,
                                          XPS_FILL_RULE *fillRule);
  HRESULT(STDMETHODCALLTYPE *SetFillRule)(IXpsOMGeometry *This,
                                          XPS_FILL_RULE fillRule);
  HRESULT(STDMETHODCALLTYPE *GetTransform)(IXpsOMGeometry *This,
                                           IXpsOMMatrixTransform **transform);
  HRESULT(STDMETHODCALLTYPE *GetTransformLocal)(
      IXpsOMGeometry *This, IXpsOMMatrixTransform **transform);
  HRESULT(STDMETHODCALLTYPE *SetTransformLocal)(
      IXpsOMGeometry *This, IXpsOMMatrixTransform *transform);
  HRESULT(STDMETHODCALLTYPE *GetTransformLookup)(IXpsOMGeometry *This,
                                                 LPWSTR *lookup);
  HRESULT(STDMETHODCALLTYPE *SetTransformLookup)(IXpsOMGeometry *This,
                                                 LPCWSTR lookup);
  HRESULT(STDMETHODCALLTYPE *Clone)(IXpsOMGeometry *This,
                                    IXpsOMGeometry **geometry);
  END_INTERFACE
} IXpsOMGeometryVtbl;
interface IXpsOMGeometry { CONST_VTBL IXpsOMGeometryVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IXpsOMGeometry_QueryInterface(IXpsOMGeometry *This,
                                                    REFIID riid,
                                                    void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IXpsOMShareable methods ***/
static inline HRESULT IXpsOMGeometry_GetOwner(IXpsOMGeometry *This,
                                              IUnknown **owner) {
  return This->lpVtbl->GetOwner(This, owner);
}
static inline HRESULT IXpsOMGeometry_GetType(IXpsOMGeometry *This,
                                             XPS_OBJECT_TYPE *type) {
  return This->lpVtbl->GetType(This, type);
}
/*** IXpsOMGeometry methods ***/
static inline HRESULT
IXpsOMGeometry_GetFigures(IXpsOMGeometry *This,
                          IXpsOMGeometryFigureCollection **figures) {
  return This->lpVtbl->GetFigures(This, figures);
}
static inline HRESULT IXpsOMGeometry_GetFillRule(IXpsOMGeometry *This,
                                                 XPS_FILL_RULE *fillRule) {
  return This->lpVtbl->GetFillRule(This, fillRule);
}
static inline HRESULT IXpsOMGeometry_SetFillRule(IXpsOMGeometry *This,
                                                 XPS_FILL_RULE fillRule) {
  return This->lpVtbl->SetFillRule(This, fillRule);
}
static inline HRESULT
IXpsOMGeometry_GetTransform(IXpsOMGeometry *This,
                            IXpsOMMatrixTransform **transform) {
  return This->lpVtbl->GetTransform(This, transform);
}
static inline HRESULT
IXpsOMGeometry_GetTransformLocal(IXpsOMGeometry *This,
                                 IXpsOMMatrixTransform **transform) {
  return This->lpVtbl->GetTransformLocal(This, transform);
}
static inline HRESULT
IXpsOMGeometry_SetTransformLocal(IXpsOMGeometry *This,
                                 IXpsOMMatrixTransform *transform) {
  return This->lpVtbl->SetTransformLocal(This, transform);
}
static inline HRESULT IXpsOMGeometry_GetTransformLookup(IXpsOMGeometry *This,
                                                        LPWSTR *lookup) {
  return This->lpVtbl->GetTransformLookup(This, lookup);
}
static inline HRESULT IXpsOMGeometry_SetTransformLookup(IXpsOMGeometry *This,
                                                        LPCWSTR lookup) {
  return This->lpVtbl->SetTransformLookup(This, lookup);
}
static inline HRESULT IXpsOMGeometry_Clone(IXpsOMGeometry *This,
                                           IXpsOMGeometry **geometry) {
...
IXpsOMGlyphs : public IXpsOMVisual {
  ...
  virtual HRESULT STDMETHODCALLTYPE GetProhibitedCaretStopCount(
      UINT32 * prohibitedCaretStopCount) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetProhibitedCaretStops(
      UINT32 * prohibitedCaretStopCount, UINT32 * prohibitedCaretStops) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetBidiLevel(UINT32 * bidiLevel) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetIsSideways(WINBOOL * isSideways) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetDeviceFontName(LPWSTR *
                                                      deviceFontName) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetStyleSimulations(XPS_STYLE_SIMULATION *
                                                        styleSimulations) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetStyleSimulations(
      XPS_STYLE_SIMULATION styleSimulations) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetOrigin(XPS_POINT * origin) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetOrigin(const XPS_POINT *origin) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE SetFontRenderingEmSize(
      FLOAT fontRenderingEmSize) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetFontResource(IXpsOMFontResource *
                                                    *fontResource) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetFontResource(IXpsOMFontResource *
                                                    fontResource) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetFontFaceIndex(SHORT * fontFaceIndex) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetFontFaceIndex(SHORT fontFaceIndex) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetFillBrush(IXpsOMBrush * *fillBrush) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetFillBrushLocal(IXpsOMBrush *
                                                      *fillBrush) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetFillBrushLocal(IXpsOMBrush *
                                                      fillBrush) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetFillBrushLookup(LPWSTR * key) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetFillBrushLookup(LPCWSTR key) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetGlyphsEditor(IXpsOMGlyphsEditor *
                                                    *editor) = 0;
  virtual HRESULT STDMETHODCALLTYPE Clone(IXpsOMGlyphs * *glyphs) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMGlyphs, 0x819b3199, 0x0a5a, 0x4b64, 0xbe, 0xc7, 0xa9,
                0xe1, 0x7e, 0x78, 0x0d, 0xe2)
#endif
#else
typedef struct IXpsOMGlyphsVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsOMGlyphs *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetType)(IXpsOMGlyphs *This,
                                      XPS_OBJECT_TYPE *type);
  /*** IXpsOMVisual methods ***/
  HRESULT(STDMETHODCALLTYPE *GetTransform)(
  ...
  HRESULT(STDMETHODCALLTYPE *SetTransformLocal)(
      IXpsOMGlyphs *This, IXpsOMMatrixTransform *matrixTransform);
  HRESULT(STDMETHODCALLTYPE *GetTransformLookup)(IXpsOMGlyphs *This,
                                                 LPWSTR *key);
  HRESULT(STDMETHODCALLTYPE *SetTransformLookup)(IXpsOMGlyphs *This,
                                                 LPCWSTR key);
  HRESULT(STDMETHODCALLTYPE *GetClipGeometry)(IXpsOMGlyphs *This,
                                              IXpsOMGeometry **clipGeometry);
  HRESULT(STDMETHODCALLTYPE *GetClipGeometryLocal)(
      IXpsOMGlyphs *This, IXpsOMGeometry **clipGeometry);
  HRESULT(STDMETHODCALLTYPE *SetClipGeometryLocal)(
      IXpsOMGlyphs *This, IXpsOMGeometry *clipGeometry);
  HRESULT(STDMETHODCALLTYPE *GetClipGeometryLookup)(IXpsOMGlyphs *This,
                                                    LPWSTR *key);
  HRESULT(STDMETHODCALLTYPE *SetClipGeometryLookup)(IXpsOMGlyphs *This,
                                                    LPCWSTR key);
  ...
  HRESULT(STDMETHODCALLTYPE *GetOpacityMaskBrush)(
      IXpsOMGlyphs *This, IXpsOMBrush **opacityMaskBrush);
  HRESULT(STDMETHODCALLTYPE *GetOpacityMaskBrushLocal)(
      IXpsOMGlyphs *This, IXpsOMBrush **opacityMaskBrush);
  HRESULT(STDMETHODCALLTYPE *SetOpacityMaskBrushLocal)(
      IXpsOMGlyphs *This, IXpsOMBrush *opacityMaskBrush);
  HRESULT(STDMETHODCALLTYPE *GetOpacityMaskBrushLookup)(IXpsOMGlyphs *This,
                                                        LPWSTR *key);
  HRESULT(STDMETHODCALLTYPE *SetOpacityMaskBrushLookup)(IXpsOMGlyphs *This,
                                                        LPCWSTR key);
  ...
  HRESULT(STDMETHODCALLTYPE *GetIsHyperlinkTarget)(IXpsOMGlyphs *This,
                                                   WINBOOL *isHyperlink);
  HRESULT(STDMETHODCALLTYPE *SetIsHyperlinkTarget)(IXpsOMGlyphs *This,
                                                   WINBOOL isHyperlink);
  HRESULT(STDMETHODCALLTYPE *GetHyperlinkNavigateUri)(IXpsOMGlyphs *This,
                                                      IUri **hyperlinkUri);
  HRESULT(STDMETHODCALLTYPE *SetHyperlinkNavigateUri)(IXpsOMGlyphs *This,
                                                      IUri *hyperlinkUri);
  ...
  HRESULT(STDMETHODCALLTYPE *GetUnicodeString)(IXpsOMGlyphs *This,
                                               LPWSTR *unicodeString);
  HRESULT(STDMETHODCALLTYPE *GetGlyphIndexCount)(IXpsOMGlyphs *This,
                                                 UINT32 *indexCount);
  HRESULT(STDMETHODCALLTYPE *GetGlyphIndices)(IXpsOMGlyphs *This,
                                              UINT32 *indexCount,
                                              XPS_GLYPH_INDEX *glyphIndices);
  HRESULT(STDMETHODCALLTYPE *GetGlyphMappingCount)(IXpsOMGlyphs *This,
                                                   UINT32 *glyphMappingCount);
  HRESULT(STDMETHODCALLTYPE *GetGlyphMappings)(
      IXpsOMGlyphs *This, UINT32 *glyphMappingCount,
      XPS_GLYPH_MAPPING *glyphMappings);
  HRESULT(STDMETHODCALLTYPE *GetProhibitedCaretStopCount)(
  ...
  HRESULT(STDMETHODCALLTYPE *GetBidiLevel)(IXpsOMGlyphs *This,
                                           UINT32 *bidiLevel);
  HRESULT(STDMETHODCALLTYPE *GetIsSideways)(IXpsOMGlyphs *This,
                                            WINBOOL *isSideways);
  HRESULT(STDMETHODCALLTYPE *GetDeviceFontName)(IXpsOMGlyphs *This,
                                                LPWSTR *deviceFontName);
  HRESULT(STDMETHODCALLTYPE *GetStyleSimulations)(
      IXpsOMGlyphs *This, XPS_STYLE_SIMULATION *styleSimulations);
  HRESULT(STDMETHODCALLTYPE *SetStyleSimulations)(
      IXpsOMGlyphs *This, XPS_STYLE_SIMULATION styleSimulations);
  HRESULT(STDMETHODCALLTYPE *GetOrigin)(IXpsOMGlyphs *This, XPS_POINT *origin);
  HRESULT(STDMETHODCALLTYPE *SetOrigin)(IXpsOMGlyphs *This,
                                        const XPS_POINT *origin);
  HRESULT(STDMETHODCALLTYPE *GetFontRenderingEmSize)(
      IXpsOMGlyphs *This, FLOAT *fontRenderingEmSize);
  HRESULT(STDMETHODCALLTYPE *SetFontRenderingEmSize)(IXpsOMGlyphs *This,
                                                     FLOAT fontRenderingEmSize);
  HRESULT(STDMETHODCALLTYPE *GetFontResource)(
      IXpsOMGlyphs *This, IXpsOMFontResource **fontResource);
  HRESULT(STDMETHODCALLTYPE *SetFontResource)(IXpsOMGlyphs *This,
                                              IXpsOMFontResource *fontResource);
  HRESULT(STDMETHODCALLTYPE *GetFontFaceIndex)(IXpsOMGlyphs *This,
                                               SHORT *fontFaceIndex);
  HRESULT(STDMETHODCALLTYPE *SetFontFaceIndex)(IXpsOMGlyphs *This,
                                               SHORT fontFaceIndex);
  HRESULT(STDMETHODCALLTYPE *GetFillBrush)(IXpsOMGlyphs *This,
                                           IXpsOMBrush **fillBrush);
  HRESULT(STDMETHODCALLTYPE *GetFillBrushLocal)(IXpsOMGlyphs *This,
                                                IXpsOMBrush **fillBrush);
  HRESULT(STDMETHODCALLTYPE *SetFillBrushLocal)(IXpsOMGlyphs *This,
                                                IXpsOMBrush *fillBrush);
  HRESULT(STDMETHODCALLTYPE *GetFillBrushLookup)(IXpsOMGlyphs *This,
                                                 LPWSTR *key);
  HRESULT(STDMETHODCALLTYPE *SetFillBrushLookup)(IXpsOMGlyphs *This,
                                                 LPCWSTR key);
  HRESULT(STDMETHODCALLTYPE *GetGlyphsEditor)(IXpsOMGlyphs *This,
                                              IXpsOMGlyphsEditor **editor);
  HRESULT(STDMETHODCALLTYPE *Clone)(IXpsOMGlyphs *This, IXpsOMGlyphs **glyphs);
  END_INTERFACE
} IXpsOMGlyphsVtbl;
interface IXpsOMGlyphs { CONST_VTBL IXpsOMGlyphsVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define IXpsOMGlyphs_GetGlyphMappings(This, glyphMappingCount, glyphMappings)  \
  (This)->lpVtbl->GetGlyphMappings(This, glyphMappingCount, glyphMappings)
#define IXpsOMGlyphs_GetProhibitedCaretStopCount(This,                         \
                                                 prohibitedCaretStopCount)     \
  (This)->lpVtbl->GetProhibitedCaretStopCount(This, prohibitedCaretStopCount)
...
/*** IUnknown methods ***/
static inline HRESULT
IXpsOMGlyphs_QueryInterface(IXpsOMGlyphs *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IXpsOMShareable methods ***/
static inline HRESULT IXpsOMGlyphs_GetOwner(IXpsOMGlyphs *This,
                                            IUnknown **owner) {
  return This->lpVtbl->GetOwner(This, owner);
}
static inline HRESULT IXpsOMGlyphs_GetType(IXpsOMGlyphs *This,
                                           XPS_OBJECT_TYPE *type) {
  return This->lpVtbl->GetType(This, type);
}
/*** IXpsOMVisual methods ***/
static inline HRESULT
IXpsOMGlyphs_GetTransform(IXpsOMGlyphs *This,
                          IXpsOMMatrixTransform **matrixTransform) {
  return This->lpVtbl->GetTransform(This, matrixTransform);
}
static inline HRESULT
IXpsOMGlyphs_GetTransformLocal(IXpsOMGlyphs *This,
                               IXpsOMMatrixTransform **matrixTransform) {
  return This->lpVtbl->GetTransformLocal(This, matrixTransform);
}
static inline HRESULT
IXpsOMGlyphs_SetTransformLocal(IXpsOMGlyphs *This,
                               IXpsOMMatrixTransform *matrixTransform) {
  return This->lpVtbl->SetTransformLocal(This, matrixTransform);
}
static inline HRESULT IXpsOMGlyphs_GetTransformLookup(IXpsOMGlyphs *This,
                                                      LPWSTR *key) {
  return This->lpVtbl->GetTransformLookup(This, key);
}
static inline HRESULT IXpsOMGlyphs_SetTransformLookup(IXpsOMGlyphs *This,
                                                      LPCWSTR key) {
  return This->lpVtbl->SetTransformLookup(This, key);
}
static inline HRESULT
IXpsOMGlyphs_GetClipGeometry(IXpsOMGlyphs *This,
                             IXpsOMGeometry **clipGeometry) {
  return This->lpVtbl->GetClipGeometry(This, clipGeometry);
}
static inline HRESULT
IXpsOMGlyphs_GetClipGeometryLocal(IXpsOMGlyphs *This,
                                  IXpsOMGeometry **clipGeometry) {
  return This->lpVtbl->GetClipGeometryLocal(This, clipGeometry);
}
static inline HRESULT
IXpsOMGlyphs_SetClipGeometryLocal(IXpsOMGlyphs *This,
                                  IXpsOMGeometry *clipGeometry) {
  return This->lpVtbl->SetClipGeometryLocal(This, clipGeometry);
}
static inline HRESULT IXpsOMGlyphs_GetClipGeometryLookup(IXpsOMGlyphs *This,
                                                         LPWSTR *key) {
  return This->lpVtbl->GetClipGeometryLookup(This, key);
}
static inline HRESULT IXpsOMGlyphs_SetClipGeometryLookup(IXpsOMGlyphs *This,
                                                         LPCWSTR key) {
  return This->lpVtbl->SetClipGeometryLookup(This, key);
}
static inline HRESULT IXpsOMGlyphs_GetOpacity(IXpsOMGlyphs *This,
                                              FLOAT *opacity) {
  return This->lpVtbl->GetOpacity(This, opacity);
}
static inline HRESULT IXpsOMGlyphs_SetOpacity(IXpsOMGlyphs *This,
                                              FLOAT opacity) {
  return This->lpVtbl->SetOpacity(This, opacity);
}
static inline HRESULT
IXpsOMGlyphs_GetOpacityMaskBrush(IXpsOMGlyphs *This,
                                 IXpsOMBrush **opacityMaskBrush) {
  return This->lpVtbl->GetOpacityMaskBrush(This, opacityMaskBrush);
}
static inline HRESULT
IXpsOMGlyphs_GetOpacityMaskBrushLocal(IXpsOMGlyphs *This,
                                      IXpsOMBrush **opacityMaskBrush) {
  return This->lpVtbl->GetOpacityMaskBrushLocal(This, opacityMaskBrush);
}
static inline HRESULT
IXpsOMGlyphs_SetOpacityMaskBrushLocal(IXpsOMGlyphs *This,
                                      IXpsOMBrush *opacityMaskBrush) {
  return This->lpVtbl->SetOpacityMaskBrushLocal(This, opacityMaskBrush);
}
static inline HRESULT IXpsOMGlyphs_GetOpacityMaskBrushLookup(IXpsOMGlyphs *This,
                                                             LPWSTR *key) {
  return This->lpVtbl->GetOpacityMaskBrushLookup(This, key);
}
static inline HRESULT IXpsOMGlyphs_SetOpacityMaskBrushLookup(IXpsOMGlyphs *This,
                                                             LPCWSTR key) {
  return This->lpVtbl->SetOpacityMaskBrushLookup(This, key);
}
...
static inline HRESULT IXpsOMGlyphs_GetIsHyperlinkTarget(IXpsOMGlyphs *This,
                                                        WINBOOL *isHyperlink) {
  return This->lpVtbl->GetIsHyperlinkTarget(This, isHyperlink);
}
static inline HRESULT IXpsOMGlyphs_SetIsHyperlinkTarget(IXpsOMGlyphs *This,
                                                        WINBOOL isHyperlink) {
  return This->lpVtbl->SetIsHyperlinkTarget(This, isHyperlink);
}
static inline HRESULT
IXpsOMGlyphs_GetHyperlinkNavigateUri(IXpsOMGlyphs *This, IUri **hyperlinkUri) {
  return This->lpVtbl->GetHyperlinkNavigateUri(This, hyperlinkUri);
}
static inline HRESULT IXpsOMGlyphs_SetHyperlinkNavigateUri(IXpsOMGlyphs *This,
                                                           IUri *hyperlinkUri) {
  return This->lpVtbl->SetHyperlinkNavigateUri(This, hyperlinkUri);
}
static inline HRESULT IXpsOMGlyphs_GetLanguage(IXpsOMGlyphs *This,
                                               LPWSTR *language) {
  return This->lpVtbl->GetLanguage(This, language);
}
static inline HRESULT IXpsOMGlyphs_SetLanguage(IXpsOMGlyphs *This,
                                               LPCWSTR language) {
  return This->lpVtbl->SetLanguage(This, language);
}
/*** IXpsOMGlyphs methods ***/
static inline HRESULT IXpsOMGlyphs_GetUnicodeString(IXpsOMGlyphs *This,
                                                    LPWSTR *unicodeString) {
  return This->lpVtbl->GetUnicodeString(This, unicodeString);
}
static inline HRESULT IXpsOMGlyphs_GetGlyphIndexCount(IXpsOMGlyphs *This,
                                                      UINT32 *indexCount) {
  return This->lpVtbl->GetGlyphIndexCount(This, indexCount);
}
static inline HRESULT
IXpsOMGlyphs_GetGlyphIndices(IXpsOMGlyphs *This, UINT32 *indexCount,
                             XPS_GLYPH_INDEX *glyphIndices) {
  return This->lpVtbl->GetGlyphIndices(This, indexCount, glyphIndices);
}
static inline HRESULT
IXpsOMGlyphs_GetGlyphMappingCount(IXpsOMGlyphs *This,
                                  UINT32 *glyphMappingCount) {
  return This->lpVtbl->GetGlyphMappingCount(This, glyphMappingCount);
}
static inline HRESULT
IXpsOMGlyphs_GetGlyphMappings(IXpsOMGlyphs *This, UINT32 *glyphMappingCount,
                              XPS_GLYPH_MAPPING *glyphMappings) {
  return This->lpVtbl->GetGlyphMappings(This, glyphMappingCount, glyphMappings);
}
static inline HRESULT
IXpsOMGlyphs_GetProhibitedCaretStopCount(IXpsOMGlyphs *This,
                                         UINT32 *prohibitedCaretStopCount) {
  return This->lpVtbl->GetProhibitedCaretStopCount(This,
                                                   prohibitedCaretStopCount);
}
static inline HRESULT
IXpsOMGlyphs_GetProhibitedCaretStops(IXpsOMGlyphs *This,
                                     UINT32 *prohibitedCaretStopCount,
                                     UINT32 *prohibitedCaretStops) {
  return This->lpVtbl->GetProhibitedCaretStops(This, prohibitedCaretStopCount,
                                               prohibitedCaretStops);
}
static inline HRESULT IXpsOMGlyphs_GetBidiLevel(IXpsOMGlyphs *This,
                                                UINT32 *bidiLevel) {
  return This->lpVtbl->GetBidiLevel(This, bidiLevel);
}
static inline HRESULT IXpsOMGlyphs_GetIsSideways(IXpsOMGlyphs *This,
                                                 WINBOOL *isSideways) {
  return This->lpVtbl->GetIsSideways(This, isSideways);
}
static inline HRESULT IXpsOMGlyphs_GetDeviceFontName(IXpsOMGlyphs *This,
                                                     LPWSTR *deviceFontName) {
  return This->lpVtbl->GetDeviceFontName(This, deviceFontName);
}
static inline HRESULT
IXpsOMGlyphs_GetStyleSimulations(IXpsOMGlyphs *This,
                                 XPS_STYLE_SIMULATION *styleSimulations) {
  return This->lpVtbl->GetStyleSimulations(This, styleSimulations);
}
static inline HRESULT
IXpsOMGlyphs_SetStyleSimulations(IXpsOMGlyphs *This,
                                 XPS_STYLE_SIMULATION styleSimulations) {
  return This->lpVtbl->SetStyleSimulations(This, styleSimulations);
}
static inline HRESULT IXpsOMGlyphs_GetOrigin(IXpsOMGlyphs *This,
                                             XPS_POINT *origin) {
  return This->lpVtbl->GetOrigin(This, origin);
}
static inline HRESULT IXpsOMGlyphs_SetOrigin(IXpsOMGlyphs *This,
                                             const XPS_POINT *origin) {
  return This->lpVtbl->SetOrigin(This, origin);
}
static inline HRESULT
IXpsOMGlyphs_GetFontRenderingEmSize(IXpsOMGlyphs *This,
                                    FLOAT *fontRenderingEmSize) {
  return This->lpVtbl->GetFontRenderingEmSize(This, fontRenderingEmSize);
}
static inline HRESULT
IXpsOMGlyphs_SetFontRenderingEmSize(IXpsOMGlyphs *This,
                                    FLOAT fontRenderingEmSize) {
  return This->lpVtbl->SetFontRenderingEmSize(This, fontRenderingEmSize);
}
static inline HRESULT
IXpsOMGlyphs_GetFontResource(IXpsOMGlyphs *This,
                             IXpsOMFontResource **fontResource) {
  return This->lpVtbl->GetFontResource(This, fontResource);
}
static inline HRESULT
IXpsOMGlyphs_SetFontResource(IXpsOMGlyphs *This,
                             IXpsOMFontResource *fontResource) {
  return This->lpVtbl->SetFontResource(This, fontResource);
}
static inline HRESULT IXpsOMGlyphs_GetFontFaceIndex(IXpsOMGlyphs *This,
                                                    SHORT *fontFaceIndex) {
  return This->lpVtbl->GetFontFaceIndex(This, fontFaceIndex);
}
static inline HRESULT IXpsOMGlyphs_SetFontFaceIndex(IXpsOMGlyphs *This,
                                                    SHORT fontFaceIndex) {
  return This->lpVtbl->SetFontFaceIndex(This, fontFaceIndex);
}
static inline HRESULT IXpsOMGlyphs_GetFillBrush(IXpsOMGlyphs *This,
                                                IXpsOMBrush **fillBrush) {
  return This->lpVtbl->GetFillBrush(This, fillBrush);
}
static inline HRESULT IXpsOMGlyphs_GetFillBrushLocal(IXpsOMGlyphs *This,
                                                     IXpsOMBrush **fillBrush) {
  return This->lpVtbl->GetFillBrushLocal(This, fillBrush);
}
static inline HRESULT IXpsOMGlyphs_SetFillBrushLocal(IXpsOMGlyphs *This,
                                                     IXpsOMBrush *fillBrush) {
  return This->lpVtbl->SetFillBrushLocal(This, fillBrush);
}
static inline HRESULT IXpsOMGlyphs_GetFillBrushLookup(IXpsOMGlyphs *This,
                                                      LPWSTR *key) {
  return This->lpVtbl->GetFillBrushLookup(This, key);
}
static inline HRESULT IXpsOMGlyphs_SetFillBrushLookup(IXpsOMGlyphs *This,
                                                      LPCWSTR key) {
  return This->lpVtbl->SetFillBrushLookup(This, key);
}
static inline HRESULT
IXpsOMGlyphs_GetGlyphsEditor(IXpsOMGlyphs *This, IXpsOMGlyphsEditor **editor) {
  return This->lpVtbl->GetGlyphsEditor(This, editor);
}
static inline HRESULT IXpsOMGlyphs_Clone(IXpsOMGlyphs *This,
                                         IXpsOMGlyphs **glyphs) {
...
DEFINE_GUID(IID_IXpsOMPath, 0x37d38bb6, 0x3ee9, 0x4110, 0x93, 0x12, 0x14, 0xb1,
            0x94, 0x16, 0x33, 0x37);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("37d38bb6-3ee9-4110-9312-14b194163337")
IXpsOMPath : public IXpsOMVisual {
  virtual HRESULT STDMETHODCALLTYPE GetGeometry(IXpsOMGeometry * *geometry) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetGeometryLocal(IXpsOMGeometry *
                                                     *geometry) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetGeometryLocal(IXpsOMGeometry *
                                                     geometry) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetGeometryLookup(LPWSTR * lookup) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetGeometryLookup(LPCWSTR lookup) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetSnapsToPixels(WINBOOL *
                                                     snapsToPixels) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetSnapsToPixels(WINBOOL snapsToPixels) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetStrokeBrush(IXpsOMBrush * *brush) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetStrokeBrushLocal(IXpsOMBrush *
                                                        *brush) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetStrokeBrushLocal(IXpsOMBrush *
                                                        brush) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetStrokeBrushLookup(LPWSTR * lookup) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetStrokeBrushLookup(LPCWSTR lookup) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetStrokeDashes(IXpsOMDashCollection *
                                                    *strokeDashes) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetStrokeDashCap(XPS_DASH_CAP *
                                                     strokeDashCap) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetStrokeDashCap(
      XPS_DASH_CAP strokeDashCap) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetStrokeDashOffset(FLOAT *
                                                        strokeDashOffset) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE SetStrokeStartLineCap(
      XPS_LINE_CAP strokeStartLineCap) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetStrokeEndLineCap(XPS_LINE_CAP *
                                                        strokeEndLineCap) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetStrokeEndLineCap(
      XPS_LINE_CAP strokeEndLineCap) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetStrokeLineJoin(XPS_LINE_JOIN *
                                                      strokeLineJoin) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetStrokeLineJoin(
      XPS_LINE_JOIN strokeLineJoin) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetStrokeMiterLimit(FLOAT *
                                                        strokeMiterLimit) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetStrokeMiterLimit(
      FLOAT strokeMiterLimit) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetStrokeThickness(FLOAT *
                                                       strokeThickness) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetStrokeThickness(
      FLOAT strokeThickness) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetFillBrush(IXpsOMBrush * *brush) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetFillBrushLocal(IXpsOMBrush * *brush) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetFillBrushLocal(IXpsOMBrush * brush) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetFillBrushLookup(LPWSTR * lookup) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetFillBrushLookup(LPCWSTR lookup) = 0;
  virtual HRESULT STDMETHODCALLTYPE Clone(IXpsOMPath * *path) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMPath, 0x37d38bb6, 0x3ee9, 0x4110, 0x93, 0x12, 0x14, 0xb1,
                0x94, 0x16, 0x33, 0x37)
#endif
#else
typedef struct IXpsOMPathVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsOMPath *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetClipGeometry)(IXpsOMPath *This,
                                              IXpsOMGeometry **clipGeometry);
  HRESULT(STDMETHODCALLTYPE *GetClipGeometryLocal)(
      IXpsOMPath *This, IXpsOMGeometry **clipGeometry);
  HRESULT(STDMETHODCALLTYPE *SetClipGeometryLocal)(
      IXpsOMPath *This, IXpsOMGeometry *clipGeometry);
  HRESULT(STDMETHODCALLTYPE *GetClipGeometryLookup)(IXpsOMPath *This,
                                                    LPWSTR *key);
  HRESULT(STDMETHODCALLTYPE *SetClipGeometryLookup)(IXpsOMPath *This,
                                                    LPCWSTR key);
  ...
  HRESULT(STDMETHODCALLTYPE *GetOpacityMaskBrush)(
      IXpsOMPath *This, IXpsOMBrush **opacityMaskBrush);
  HRESULT(STDMETHODCALLTYPE *GetOpacityMaskBrushLocal)(
      IXpsOMPath *This, IXpsOMBrush **opacityMaskBrush);
  HRESULT(STDMETHODCALLTYPE *SetOpacityMaskBrushLocal)(
      IXpsOMPath *This, IXpsOMBrush *opacityMaskBrush);
  HRESULT(STDMETHODCALLTYPE *GetOpacityMaskBrushLookup)(IXpsOMPath *This,
                                                        LPWSTR *key);
  HRESULT(STDMETHODCALLTYPE *SetOpacityMaskBrushLookup)(IXpsOMPath *This,
                                                        LPCWSTR key);
  ...
  HRESULT(STDMETHODCALLTYPE *GetIsHyperlinkTarget)(IXpsOMPath *This,
                                                   WINBOOL *isHyperlink);
  HRESULT(STDMETHODCALLTYPE *SetIsHyperlinkTarget)(IXpsOMPath *This,
                                                   WINBOOL isHyperlink);
  HRESULT(STDMETHODCALLTYPE *GetHyperlinkNavigateUri)(IXpsOMPath *This,
                                                      IUri **hyperlinkUri);
  HRESULT(STDMETHODCALLTYPE *SetHyperlinkNavigateUri)(IXpsOMPath *This,
                                                      IUri *hyperlinkUri);
  ...
  /*** IXpsOMPath methods ***/
  HRESULT(STDMETHODCALLTYPE *GetGeometry)(IXpsOMPath *This,
                                          IXpsOMGeometry **geometry);
  HRESULT(STDMETHODCALLTYPE *GetGeometryLocal)(IXpsOMPath *This,
                                               IXpsOMGeometry **geometry);
  HRESULT(STDMETHODCALLTYPE *SetGeometryLocal)(IXpsOMPath *This,
                                               IXpsOMGeometry *geometry);
  HRESULT(STDMETHODCALLTYPE *GetGeometryLookup)(IXpsOMPath *This,
                                                LPWSTR *lookup);
  HRESULT(STDMETHODCALLTYPE *SetGeometryLookup)(IXpsOMPath *This,
                                                LPCWSTR lookup);
  HRESULT(STDMETHODCALLTYPE *GetAccessibilityShortDescription)(
      IXpsOMPath *This, LPWSTR *shortDescription);
  HRESULT(STDMETHODCALLTYPE *SetAccessibilityShortDescription)(
      IXpsOMPath *This, LPCWSTR shortDescription);
  HRESULT(STDMETHODCALLTYPE *GetAccessibilityLongDescription)(
      IXpsOMPath *This, LPWSTR *longDescription);
  HRESULT(STDMETHODCALLTYPE *SetAccessibilityLongDescription)(
      IXpsOMPath *This, LPCWSTR longDescription);
  HRESULT(STDMETHODCALLTYPE *GetSnapsToPixels)(IXpsOMPath *This,
                                               WINBOOL *snapsToPixels);
  HRESULT(STDMETHODCALLTYPE *SetSnapsToPixels)(IXpsOMPath *This,
                                               WINBOOL snapsToPixels);
  HRESULT(STDMETHODCALLTYPE *GetStrokeBrush)(IXpsOMPath *This,
                                             IXpsOMBrush **brush);
  HRESULT(STDMETHODCALLTYPE *GetStrokeBrushLocal)(IXpsOMPath *This,
                                                  IXpsOMBrush **brush);
  HRESULT(STDMETHODCALLTYPE *SetStrokeBrushLocal)(IXpsOMPath *This,
                                                  IXpsOMBrush *brush);
  HRESULT(STDMETHODCALLTYPE *GetStrokeBrushLookup)(IXpsOMPath *This,
                                                   LPWSTR *lookup);
  HRESULT(STDMETHODCALLTYPE *SetStrokeBrushLookup)(IXpsOMPath *This,
                                                   LPCWSTR lookup);
  HRESULT(STDMETHODCALLTYPE *GetStrokeDashes)(
      IXpsOMPath *This, IXpsOMDashCollection **strokeDashes);
  HRESULT(STDMETHODCALLTYPE *GetStrokeDashCap)(IXpsOMPath *This,
                                               XPS_DASH_CAP *strokeDashCap);
  HRESULT(STDMETHODCALLTYPE *SetStrokeDashCap)(IXpsOMPath *This,
                                               XPS_DASH_CAP strokeDashCap);
  HRESULT(STDMETHODCALLTYPE *GetStrokeDashOffset)(IXpsOMPath *This,
                                                  FLOAT *strokeDashOffset);
  HRESULT(STDMETHODCALLTYPE *SetStrokeDashOffset)(IXpsOMPath *This,
                                                  FLOAT strokeDashOffset);
  HRESULT(STDMETHODCALLTYPE *GetStrokeStartLineCap)(
      IXpsOMPath *This, XPS_LINE_CAP *strokeStartLineCap);
  HRESULT(STDMETHODCALLTYPE *SetStrokeStartLineCap)(
      IXpsOMPath *This, XPS_LINE_CAP strokeStartLineCap);
  HRESULT(STDMETHODCALLTYPE *GetStrokeEndLineCap)(
      IXpsOMPath *This, XPS_LINE_CAP *strokeEndLineCap);
  HRESULT(STDMETHODCALLTYPE *SetStrokeEndLineCap)(
      IXpsOMPath *This, XPS_LINE_CAP strokeEndLineCap);
  HRESULT(STDMETHODCALLTYPE *GetStrokeLineJoin)(IXpsOMPath *This,
                                                XPS_LINE_JOIN *strokeLineJoin);
  HRESULT(STDMETHODCALLTYPE *SetStrokeLineJoin)(IXpsOMPath *This,
                                                XPS_LINE_JOIN strokeLineJoin);
  HRESULT(STDMETHODCALLTYPE *GetStrokeMiterLimit)(IXpsOMPath *This,
                                                  FLOAT *strokeMiterLimit);
  HRESULT(STDMETHODCALLTYPE *SetStrokeMiterLimit)(IXpsOMPath *This,
                                                  FLOAT strokeMiterLimit);
  HRESULT(STDMETHODCALLTYPE *GetStrokeThickness)(IXpsOMPath *This,
                                                 FLOAT *strokeThickness);
  HRESULT(STDMETHODCALLTYPE *SetStrokeThickness)(IXpsOMPath *This,
                                                 FLOAT strokeThickness);
  HRESULT(STDMETHODCALLTYPE *GetFillBrush)(IXpsOMPath *This,
                                           IXpsOMBrush **brush);
  HRESULT(STDMETHODCALLTYPE *GetFillBrushLocal)(IXpsOMPath *This,
                                                IXpsOMBrush **brush);
  HRESULT(STDMETHODCALLTYPE *SetFillBrushLocal)(IXpsOMPath *This,
                                                IXpsOMBrush *brush);
  HRESULT(STDMETHODCALLTYPE *GetFillBrushLookup)(IXpsOMPath *This,
                                                 LPWSTR *lookup);
  HRESULT(STDMETHODCALLTYPE *SetFillBrushLookup)(IXpsOMPath *This,
                                                 LPCWSTR lookup);
  HRESULT(STDMETHODCALLTYPE *Clone)(IXpsOMPath *This, IXpsOMPath **path);
  END_INTERFACE
} IXpsOMPathVtbl;
interface IXpsOMPath { CONST_VTBL IXpsOMPathVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IXpsOMPath_QueryInterface(IXpsOMPath *This, REFIID riid,
                                                void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
static inline HRESULT IXpsOMPath_GetType(IXpsOMPath *This,
                                         XPS_OBJECT_TYPE *type) {
  return This->lpVtbl->GetType(This, type);
}
/*** IXpsOMVisual methods ***/
static inline HRESULT
IXpsOMPath_GetTransform(IXpsOMPath *This,
                        IXpsOMMatrixTransform **matrixTransform) {
  return This->lpVtbl->GetTransform(This, matrixTransform);
}
static inline HRESULT
IXpsOMPath_GetTransformLocal(IXpsOMPath *This,
                             IXpsOMMatrixTransform **matrixTransform) {
  return This->lpVtbl->GetTransformLocal(This, matrixTransform);
}
static inline HRESULT
IXpsOMPath_SetTransformLocal(IXpsOMPath *This,
                             IXpsOMMatrixTransform *matrixTransform) {
  return This->lpVtbl->SetTransformLocal(This, matrixTransform);
}
static inline HRESULT IXpsOMPath_GetTransformLookup(IXpsOMPath *This,
                                                    LPWSTR *key) {
  return This->lpVtbl->GetTransformLookup(This, key);
}
static inline HRESULT IXpsOMPath_SetTransformLookup(IXpsOMPath *This,
                                                    LPCWSTR key) {
  return This->lpVtbl->SetTransformLookup(This, key);
}
static inline HRESULT
IXpsOMPath_GetClipGeometry(IXpsOMPath *This, IXpsOMGeometry **clipGeometry) {
  return This->lpVtbl->GetClipGeometry(This, clipGeometry);
}
static inline HRESULT
IXpsOMPath_GetClipGeometryLocal(IXpsOMPath *This,
                                IXpsOMGeometry **clipGeometry) {
  return This->lpVtbl->GetClipGeometryLocal(This, clipGeometry);
}
static inline HRESULT
IXpsOMPath_SetClipGeometryLocal(IXpsOMPath *This,
                                IXpsOMGeometry *clipGeometry) {
  return This->lpVtbl->SetClipGeometryLocal(This, clipGeometry);
}
static inline HRESULT IXpsOMPath_GetClipGeometryLookup(IXpsOMPath *This,
                                                       LPWSTR *key) {
  return This->lpVtbl->GetClipGeometryLookup(This, key);
}
static inline HRESULT IXpsOMPath_SetClipGeometryLookup(IXpsOMPath *This,
                                                       LPCWSTR key) {
  return This->lpVtbl->SetClipGeometryLookup(This, key);
}
...
static inline HRESULT
IXpsOMPath_GetOpacityMaskBrush(IXpsOMPath *This,
                               IXpsOMBrush **opacityMaskBrush) {
  return This->lpVtbl->GetOpacityMaskBrush(This, opacityMaskBrush);
}
static inline HRESULT
IXpsOMPath_GetOpacityMaskBrushLocal(IXpsOMPath *This,
                                    IXpsOMBrush **opacityMaskBrush) {
  return This->lpVtbl->GetOpacityMaskBrushLocal(This, opacityMaskBrush);
}
static inline HRESULT
IXpsOMPath_SetOpacityMaskBrushLocal(IXpsOMPath *This,
                                    IXpsOMBrush *opacityMaskBrush) {
  return This->lpVtbl->SetOpacityMaskBrushLocal(This, opacityMaskBrush);
}
static inline HRESULT IXpsOMPath_GetOpacityMaskBrushLookup(IXpsOMPath *This,
                                                           LPWSTR *key) {
  return This->lpVtbl->GetOpacityMaskBrushLookup(This, key);
}
static inline HRESULT IXpsOMPath_SetOpacityMaskBrushLookup(IXpsOMPath *This,
                                                           LPCWSTR key) {
  return This->lpVtbl->SetOpacityMaskBrushLookup(This, key);
}
...
static inline HRESULT IXpsOMPath_GetIsHyperlinkTarget(IXpsOMPath *This,
                                                      WINBOOL *isHyperlink) {
  return This->lpVtbl->GetIsHyperlinkTarget(This, isHyperlink);
}
static inline HRESULT IXpsOMPath_SetIsHyperlinkTarget(IXpsOMPath *This,
                                                      WINBOOL isHyperlink) {
  return This->lpVtbl->SetIsHyperlinkTarget(This, isHyperlink);
}
static inline HRESULT IXpsOMPath_GetHyperlinkNavigateUri(IXpsOMPath *This,
                                                         IUri **hyperlinkUri) {
  return This->lpVtbl->GetHyperlinkNavigateUri(This, hyperlinkUri);
}
static inline HRESULT IXpsOMPath_SetHyperlinkNavigateUri(IXpsOMPath *This,
                                                         IUri *hyperlinkUri) {
  return This->lpVtbl->SetHyperlinkNavigateUri(This, hyperlinkUri);
}
static inline HRESULT IXpsOMPath_GetLanguage(IXpsOMPath *This,
                                             LPWSTR *language) {
  return This->lpVtbl->GetLanguage(This, language);
}
static inline HRESULT IXpsOMPath_SetLanguage(IXpsOMPath *This,
                                             LPCWSTR language) {
  return This->lpVtbl->SetLanguage(This, language);
}
/*** IXpsOMPath methods ***/
static inline HRESULT IXpsOMPath_GetGeometry(IXpsOMPath *This,
                                             IXpsOMGeometry **geometry) {
  return This->lpVtbl->GetGeometry(This, geometry);
}
static inline HRESULT IXpsOMPath_GetGeometryLocal(IXpsOMPath *This,
                                                  IXpsOMGeometry **geometry) {
  return This->lpVtbl->GetGeometryLocal(This, geometry);
}
static inline HRESULT IXpsOMPath_SetGeometryLocal(IXpsOMPath *This,
                                                  IXpsOMGeometry *geometry) {
  return This->lpVtbl->SetGeometryLocal(This, geometry);
}
static inline HRESULT IXpsOMPath_GetGeometryLookup(IXpsOMPath *This,
                                                   LPWSTR *lookup) {
  return This->lpVtbl->GetGeometryLookup(This, lookup);
}
static inline HRESULT IXpsOMPath_SetGeometryLookup(IXpsOMPath *This,
                                                   LPCWSTR lookup) {
  return This->lpVtbl->SetGeometryLookup(This, lookup);
}
static inline HRESULT
IXpsOMPath_GetAccessibilityShortDescription(IXpsOMPath *This,
                                            LPWSTR *shortDescription) {
  return This->lpVtbl->GetAccessibilityShortDescription(This, shortDescription);
}
static inline HRESULT
IXpsOMPath_SetAccessibilityShortDescription(IXpsOMPath *This,
                                            LPCWSTR shortDescription) {
  return This->lpVtbl->SetAccessibilityShortDescription(This, shortDescription);
}
static inline HRESULT
IXpsOMPath_GetAccessibilityLongDescription(IXpsOMPath *This,
                                           LPWSTR *longDescription) {
  return This->lpVtbl->GetAccessibilityLongDescription(This, longDescription);
}
static inline HRESULT
IXpsOMPath_SetAccessibilityLongDescription(IXpsOMPath *This,
                                           LPCWSTR longDescription) {
  return This->lpVtbl->SetAccessibilityLongDescription(This, longDescription);
}
static inline HRESULT IXpsOMPath_GetSnapsToPixels(IXpsOMPath *This,
                                                  WINBOOL *snapsToPixels) {
  return This->lpVtbl->GetSnapsToPixels(This, snapsToPixels);
}
static inline HRESULT IXpsOMPath_SetSnapsToPixels(IXpsOMPath *This,
                                                  WINBOOL snapsToPixels) {
  return This->lpVtbl->SetSnapsToPixels(This, snapsToPixels);
}
static inline HRESULT IXpsOMPath_GetStrokeBrush(IXpsOMPath *This,
                                                IXpsOMBrush **brush) {
  return This->lpVtbl->GetStrokeBrush(This, brush);
}
static inline HRESULT IXpsOMPath_GetStrokeBrushLocal(IXpsOMPath *This,
                                                     IXpsOMBrush **brush) {
  return This->lpVtbl->GetStrokeBrushLocal(This, brush);
}
static inline HRESULT IXpsOMPath_SetStrokeBrushLocal(IXpsOMPath *This,
                                                     IXpsOMBrush *brush) {
  return This->lpVtbl->SetStrokeBrushLocal(This, brush);
}
static inline HRESULT IXpsOMPath_GetStrokeBrushLookup(IXpsOMPath *This,
                                                      LPWSTR *lookup) {
  return This->lpVtbl->GetStrokeBrushLookup(This, lookup);
}
static inline HRESULT IXpsOMPath_SetStrokeBrushLookup(IXpsOMPath *This,
                                                      LPCWSTR lookup) {
  return This->lpVtbl->SetStrokeBrushLookup(This, lookup);
}
static inline HRESULT
IXpsOMPath_GetStrokeDashes(IXpsOMPath *This,
                           IXpsOMDashCollection **strokeDashes) {
  return This->lpVtbl->GetStrokeDashes(This, strokeDashes);
}
static inline HRESULT IXpsOMPath_GetStrokeDashCap(IXpsOMPath *This,
                                                  XPS_DASH_CAP *strokeDashCap) {
  return This->lpVtbl->GetStrokeDashCap(This, strokeDashCap);
}
static inline HRESULT IXpsOMPath_SetStrokeDashCap(IXpsOMPath *This,
                                                  XPS_DASH_CAP strokeDashCap) {
  return This->lpVtbl->SetStrokeDashCap(This, strokeDashCap);
}
static inline HRESULT IXpsOMPath_GetStrokeDashOffset(IXpsOMPath *This,
                                                     FLOAT *strokeDashOffset) {
  return This->lpVtbl->GetStrokeDashOffset(This, strokeDashOffset);
}
static inline HRESULT IXpsOMPath_SetStrokeDashOffset(IXpsOMPath *This,
                                                     FLOAT strokeDashOffset) {
  return This->lpVtbl->SetStrokeDashOffset(This, strokeDashOffset);
}
static inline HRESULT
IXpsOMPath_GetStrokeStartLineCap(IXpsOMPath *This,
                                 XPS_LINE_CAP *strokeStartLineCap) {
  return This->lpVtbl->GetStrokeStartLineCap(This, strokeStartLineCap);
}
static inline HRESULT
IXpsOMPath_SetStrokeStartLineCap(IXpsOMPath *This,
                                 XPS_LINE_CAP strokeStartLineCap) {
  return This->lpVtbl->SetStrokeStartLineCap(This, strokeStartLineCap);
}
static inline HRESULT
IXpsOMPath_GetStrokeEndLineCap(IXpsOMPath *This,
                               XPS_LINE_CAP *strokeEndLineCap) {
  return This->lpVtbl->GetStrokeEndLineCap(This, strokeEndLineCap);
}
static inline HRESULT
IXpsOMPath_SetStrokeEndLineCap(IXpsOMPath *This,
                               XPS_LINE_CAP strokeEndLineCap) {
  return This->lpVtbl->SetStrokeEndLineCap(This, strokeEndLineCap);
}
static inline HRESULT
IXpsOMPath_GetStrokeLineJoin(IXpsOMPath *This, XPS_LINE_JOIN *strokeLineJoin) {
  return This->lpVtbl->GetStrokeLineJoin(This, strokeLineJoin);
}
static inline HRESULT
IXpsOMPath_SetStrokeLineJoin(IXpsOMPath *This, XPS_LINE_JOIN strokeLineJoin) {
  return This->lpVtbl->SetStrokeLineJoin(This, strokeLineJoin);
}
static inline HRESULT IXpsOMPath_GetStrokeMiterLimit(IXpsOMPath *This,
                                                     FLOAT *strokeMiterLimit) {
  return This->lpVtbl->GetStrokeMiterLimit(This, strokeMiterLimit);
}
static inline HRESULT IXpsOMPath_SetStrokeMiterLimit(IXpsOMPath *This,
                                                     FLOAT strokeMiterLimit) {
  return This->lpVtbl->SetStrokeMiterLimit(This, strokeMiterLimit);
}
static inline HRESULT IXpsOMPath_GetStrokeThickness(IXpsOMPath *This,
                                                    FLOAT *strokeThickness) {
  return This->lpVtbl->GetStrokeThickness(This, strokeThickness);
}
static inline HRESULT IXpsOMPath_SetStrokeThickness(IXpsOMPath *This,
                                                    FLOAT strokeThickness) {
  return This->lpVtbl->SetStrokeThickness(This, strokeThickness);
}
static inline HRESULT IXpsOMPath_GetFillBrush(IXpsOMPath *This,
                                              IXpsOMBrush **brush) {
  return This->lpVtbl->GetFillBrush(This, brush);
}
static inline HRESULT IXpsOMPath_GetFillBrushLocal(IXpsOMPath *This,
                                                   IXpsOMBrush **brush) {
  return This->lpVtbl->GetFillBrushLocal(This, brush);
}
static inline HRESULT IXpsOMPath_SetFillBrushLocal(IXpsOMPath *This,
                                                   IXpsOMBrush *brush) {
  return This->lpVtbl->SetFillBrushLocal(This, brush);
}
static inline HRESULT IXpsOMPath_GetFillBrushLookup(IXpsOMPath *This,
                                                    LPWSTR *lookup) {
  return This->lpVtbl->GetFillBrushLookup(This, lookup);
}
static inline HRESULT IXpsOMPath_SetFillBrushLookup(IXpsOMPath *This,
                                                    LPCWSTR lookup) {
...
DEFINE_GUID(IID_IXpsOMSolidColorBrush, 0xa06f9f05, 0x3be9, 0x4763, 0x98, 0xa8,
            0x09, 0x4f, 0xc6, 0x72, 0xe4, 0x88);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IXpsOMSolidColorBrush : public IXpsOMBrush {
  ...
  virtual HRESULT STDMETHODCALLTYPE SetColor(
      const XPS_COLOR *color, IXpsOMColorProfileResource *colorProfile) = 0;
  virtual HRESULT STDMETHODCALLTYPE Clone(IXpsOMSolidColorBrush *
                                          *solidColorBrush) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMSolidColorBrush, 0xa06f9f05, 0x3be9, 0x4763, 0x98, 0xa8,
                0x09, 0x4f, 0xc6, 0x72, 0xe4, 0x88)
#endif
#else
typedef struct IXpsOMSolidColorBrushVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsOMSolidColorBrush *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IXpsOMSolidColorBrush *This);
  ULONG(STDMETHODCALLTYPE *Release)(IXpsOMSolidColorBrush *This);
  /*** IXpsOMShareable methods ***/
  HRESULT(STDMETHODCALLTYPE *GetOwner)(IXpsOMSolidColorBrush *This,
                                       IUnknown **owner);
  HRESULT(STDMETHODCALLTYPE *GetType)(IXpsOMSolidColorBrush *This,
                                      XPS_OBJECT_TYPE *type);
  /*** IXpsOMBrush methods ***/
  HRESULT(STDMETHODCALLTYPE *GetOpacity)(IXpsOMSolidColorBrush *This,
                                         FLOAT *opacity);
  HRESULT(STDMETHODCALLTYPE *SetOpacity)(IXpsOMSolidColorBrush *This,
                                         FLOAT opacity);
  /*** IXpsOMSolidColorBrush methods ***/
  HRESULT(STDMETHODCALLTYPE *GetColor)(
      IXpsOMSolidColorBrush *This, XPS_COLOR *color,
      IXpsOMColorProfileResource **colorProfile);
  HRESULT(STDMETHODCALLTYPE *SetColor)(
      IXpsOMSolidColorBrush *This, const XPS_COLOR *color,
      IXpsOMColorProfileResource *colorProfile);
  HRESULT(STDMETHODCALLTYPE *Clone)(IXpsOMSolidColorBrush *This,
                                    IXpsOMSolidColorBrush **solidColorBrush);
  END_INTERFACE
...
/*** IUnknown methods ***/
static inline HRESULT
IXpsOMSolidColorBrush_QueryInterface(IXpsOMSolidColorBrush *This, REFIID riid,
                                     void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IXpsOMShareable methods ***/
static inline HRESULT
IXpsOMSolidColorBrush_GetOwner(IXpsOMSolidColorBrush *This, IUnknown **owner) {
  return This->lpVtbl->GetOwner(This, owner);
}
static inline HRESULT IXpsOMSolidColorBrush_GetType(IXpsOMSolidColorBrush *This,
                                                    XPS_OBJECT_TYPE *type) {
  return This->lpVtbl->GetType(This, type);
}
/*** IXpsOMBrush methods ***/
static inline HRESULT
IXpsOMSolidColorBrush_GetOpacity(IXpsOMSolidColorBrush *This, FLOAT *opacity) {
  return This->lpVtbl->GetOpacity(This, opacity);
}
static inline HRESULT
IXpsOMSolidColorBrush_SetOpacity(IXpsOMSolidColorBrush *This, FLOAT opacity) {
  return This->lpVtbl->SetOpacity(This, opacity);
}
/*** IXpsOMSolidColorBrush methods ***/
static inline HRESULT
IXpsOMSolidColorBrush_GetColor(IXpsOMSolidColorBrush *This, XPS_COLOR *color,
                               IXpsOMColorProfileResource **colorProfile) {
  return This->lpVtbl->GetColor(This, color, colorProfile);
}
static inline HRESULT
IXpsOMSolidColorBrush_SetColor(IXpsOMSolidColorBrush *This,
                               const XPS_COLOR *color,
                               IXpsOMColorProfileResource *colorProfile) {
  return This->lpVtbl->SetColor(This, color, colorProfile);
}
static inline HRESULT
IXpsOMSolidColorBrush_Clone(IXpsOMSolidColorBrush *This,
                            IXpsOMSolidColorBrush **solidColorBrush) {
...
DEFINE_GUID(IID_IXpsOMTileBrush, 0x0fc2328d, 0xd722, 0x4a54, 0xb2, 0xec, 0xbe,
            0x90, 0x21, 0x8a, 0x78, 0x9e);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IXpsOMTileBrush : public IXpsOMBrush {
  ...
  virtual HRESULT STDMETHODCALLTYPE GetTransformLookup(LPWSTR * key) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetTransformLookup(LPCWSTR key) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetViewbox(XPS_RECT * viewbox) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetViewbox(const XPS_RECT *viewbox) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetViewport(XPS_RECT * viewport) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetViewport(const XPS_RECT *viewport) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetTileMode(XPS_TILE_MODE * tileMode) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetTileMode(XPS_TILE_MODE tileMode) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMTileBrush, 0x0fc2328d, 0xd722, 0x4a54, 0xb2, 0xec, 0xbe,
                0x90, 0x21, 0x8a, 0x78, 0x9e)
#endif
#else
typedef struct IXpsOMTileBrushVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsOMTileBrush *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetType)(IXpsOMTileBrush *This,
                                      XPS_OBJECT_TYPE *type);
  /*** IXpsOMBrush methods ***/
  ...
  HRESULT(STDMETHODCALLTYPE *GetTransform)(IXpsOMTileBrush *This,
                                           IXpsOMMatrixTransform **transform);
  HRESULT(STDMETHODCALLTYPE *GetTransformLocal)(
      IXpsOMTileBrush *This, IXpsOMMatrixTransform **transform);
  HRESULT(STDMETHODCALLTYPE *SetTransformLocal)(
      IXpsOMTileBrush *This, IXpsOMMatrixTransform *transform);
  HRESULT(STDMETHODCALLTYPE *GetTransformLookup)(IXpsOMTileBrush *This,
                                                 LPWSTR *key);
  HRESULT(STDMETHODCALLTYPE *SetTransformLookup)(IXpsOMTileBrush *This,
                                                 LPCWSTR key);
  HRESULT(STDMETHODCALLTYPE *GetViewbox)(IXpsOMTileBrush *This,
                                         XPS_RECT *viewbox);
  HRESULT(STDMETHODCALLTYPE *SetViewbox)(IXpsOMTileBrush *This,
                                         const XPS_RECT *viewbox);
  HRESULT(STDMETHODCALLTYPE *GetViewport)(IXpsOMTileBrush *This,
                                          XPS_RECT *viewport);
  HRESULT(STDMETHODCALLTYPE *SetViewport)(IXpsOMTileBrush *This,
                                          const XPS_RECT *viewport);
  HRESULT(STDMETHODCALLTYPE *GetTileMode)(IXpsOMTileBrush *This,
                                          XPS_TILE_MODE *tileMode);
  HRESULT(STDMETHODCALLTYPE *SetTileMode)(IXpsOMTileBrush *This,
                                          XPS_TILE_MODE tileMode);
  END_INTERFACE
} IXpsOMTileBrushVtbl;
interface IXpsOMTileBrush { CONST_VTBL IXpsOMTileBrushVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IXpsOMTileBrush_QueryInterface(IXpsOMTileBrush *This,
                                                     REFIID riid,
                                                     void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IXpsOMShareable methods ***/
static inline HRESULT IXpsOMTileBrush_GetOwner(IXpsOMTileBrush *This,
                                               IUnknown **owner) {
  return This->lpVtbl->GetOwner(This, owner);
}
static inline HRESULT IXpsOMTileBrush_GetType(IXpsOMTileBrush *This,
                                              XPS_OBJECT_TYPE *type) {
  return This->lpVtbl->GetType(This, type);
}
/*** IXpsOMBrush methods ***/
static inline HRESULT IXpsOMTileBrush_GetOpacity(IXpsOMTileBrush *This,
                                                 FLOAT *opacity) {
  return This->lpVtbl->GetOpacity(This, opacity);
}
static inline HRESULT IXpsOMTileBrush_SetOpacity(IXpsOMTileBrush *This,
                                                 FLOAT opacity) {
  return This->lpVtbl->SetOpacity(This, opacity);
}
/*** IXpsOMTileBrush methods ***/
static inline HRESULT
IXpsOMTileBrush_GetTransform(IXpsOMTileBrush *This,
                             IXpsOMMatrixTransform **transform) {
  return This->lpVtbl->GetTransform(This, transform);
}
static inline HRESULT
IXpsOMTileBrush_GetTransformLocal(IXpsOMTileBrush *This,
                                  IXpsOMMatrixTransform **transform) {
  return This->lpVtbl->GetTransformLocal(This, transform);
}
static inline HRESULT
IXpsOMTileBrush_SetTransformLocal(IXpsOMTileBrush *This,
                                  IXpsOMMatrixTransform *transform) {
  return This->lpVtbl->SetTransformLocal(This, transform);
}
static inline HRESULT IXpsOMTileBrush_GetTransformLookup(IXpsOMTileBrush *This,
                                                         LPWSTR *key) {
  return This->lpVtbl->GetTransformLookup(This, key);
}
static inline HRESULT IXpsOMTileBrush_SetTransformLookup(IXpsOMTileBrush *This,
                                                         LPCWSTR key) {
  return This->lpVtbl->SetTransformLookup(This, key);
}
static inline HRESULT IXpsOMTileBrush_GetViewbox(IXpsOMTileBrush *This,
                                                 XPS_RECT *viewbox) {
  return This->lpVtbl->GetViewbox(This, viewbox);
}
static inline HRESULT IXpsOMTileBrush_SetViewbox(IXpsOMTileBrush *This,
                                                 const XPS_RECT *viewbox) {
  return This->lpVtbl->SetViewbox(This, viewbox);
}
static inline HRESULT IXpsOMTileBrush_GetViewport(IXpsOMTileBrush *This,
                                                  XPS_RECT *viewport) {
  return This->lpVtbl->GetViewport(This, viewport);
}
static inline HRESULT IXpsOMTileBrush_SetViewport(IXpsOMTileBrush *This,
                                                  const XPS_RECT *viewport) {
  return This->lpVtbl->SetViewport(This, viewport);
}
static inline HRESULT IXpsOMTileBrush_GetTileMode(IXpsOMTileBrush *This,
                                                  XPS_TILE_MODE *tileMode) {
  return This->lpVtbl->GetTileMode(This, tileMode);
}
static inline HRESULT IXpsOMTileBrush_SetTileMode(IXpsOMTileBrush *This,
                                                  XPS_TILE_MODE tileMode) {
...
DEFINE_GUID(IID_IXpsOMGradientBrush, 0xedb59622, 0x61a2, 0x42c3, 0xba, 0xce,
            0xac, 0xf2, 0x28, 0x6c, 0x06, 0xbf);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IXpsOMGradientBrush : public IXpsOMBrush {
  ...
  virtual HRESULT STDMETHODCALLTYPE GetTransformLookup(LPWSTR * key) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetTransformLookup(LPCWSTR key) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetSpreadMethod(XPS_SPREAD_METHOD *
                                                    spreadMethod) = 0;
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMGradientBrush, 0xedb59622, 0x61a2, 0x42c3, 0xba, 0xce,
                0xac, 0xf2, 0x28, 0x6c, 0x06, 0xbf)
#endif
#else
typedef struct IXpsOMGradientBrushVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsOMGradientBrush *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IXpsOMGradientBrush *This);
  ULONG(STDMETHODCALLTYPE *Release)(IXpsOMGradientBrush *This);
  /*** IXpsOMShareable methods ***/
  HRESULT(STDMETHODCALLTYPE *GetOwner)(IXpsOMGradientBrush *This,
                                       IUnknown **owner);
  HRESULT(STDMETHODCALLTYPE *GetType)(IXpsOMGradientBrush *This,
                                      XPS_OBJECT_TYPE *type);
  /*** IXpsOMBrush methods ***/
  HRESULT(STDMETHODCALLTYPE *GetOpacity)(IXpsOMGradientBrush *This,
                                         FLOAT *opacity);
  HRESULT(STDMETHODCALLTYPE *SetOpacity)(IXpsOMGradientBrush *This,
                                         FLOAT opacity);
  /*** IXpsOMGradientBrush methods ***/
  HRESULT(STDMETHODCALLTYPE *GetGradientStops)(
      IXpsOMGradientBrush *This, IXpsOMGradientStopCollection **gradientStops);
  HRESULT(STDMETHODCALLTYPE *GetTransform)(IXpsOMGradientBrush *This,
                                           IXpsOMMatrixTransform **transform);
  HRESULT(STDMETHODCALLTYPE *GetTransformLocal)(
      IXpsOMGradientBrush *This, IXpsOMMatrixTransform **transform);
  HRESULT(STDMETHODCALLTYPE *SetTransformLocal)(
      IXpsOMGradientBrush *This, IXpsOMMatrixTransform *transform);
  HRESULT(STDMETHODCALLTYPE *GetTransformLookup)(IXpsOMGradientBrush *This,
                                                 LPWSTR *key);
  HRESULT(STDMETHODCALLTYPE *SetTransformLookup)(IXpsOMGradientBrush *This,
                                                 LPCWSTR key);
  HRESULT(STDMETHODCALLTYPE *GetSpreadMethod)(IXpsOMGradientBrush *This,
                                              XPS_SPREAD_METHOD *spreadMethod);
  HRESULT(STDMETHODCALLTYPE *SetSpreadMethod)(IXpsOMGradientBrush *This,
                                              XPS_SPREAD_METHOD spreadMethod);
...
interface IXpsOMGradientBrush { CONST_VTBL IXpsOMGradientBrushVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define IXpsOMGradientBrush_GetColorInterpolationMode(This,                    \
                                                      colorInterpolationMode)  \
  (This)->lpVtbl->GetColorInterpolationMode(This, colorInterpolationMode)
#define IXpsOMGradientBrush_SetColorInterpolationMode(This,                    \
                                                      colorInterpolationMode)  \
  (This)->lpVtbl->SetColorInterpolationMode(This, colorInterpolationMode)
#else
/*** IUnknown methods ***/
static inline HRESULT
IXpsOMGradientBrush_QueryInterface(IXpsOMGradientBrush *This, REFIID riid,
                                   void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IXpsOMShareable methods ***/
static inline HRESULT IXpsOMGradientBrush_GetOwner(IXpsOMGradientBrush *This,
                                                   IUnknown **owner) {
  return This->lpVtbl->GetOwner(This, owner);
}
static inline HRESULT IXpsOMGradientBrush_GetType(IXpsOMGradientBrush *This,
                                                  XPS_OBJECT_TYPE *type) {
  return This->lpVtbl->GetType(This, type);
}
/*** IXpsOMBrush methods ***/
static inline HRESULT IXpsOMGradientBrush_GetOpacity(IXpsOMGradientBrush *This,
                                                     FLOAT *opacity) {
  return This->lpVtbl->GetOpacity(This, opacity);
}
static inline HRESULT IXpsOMGradientBrush_SetOpacity(IXpsOMGradientBrush *This,
                                                     FLOAT opacity) {
  return This->lpVtbl->SetOpacity(This, opacity);
}
/*** IXpsOMGradientBrush methods ***/
static inline HRESULT IXpsOMGradientBrush_GetGradientStops(
    IXpsOMGradientBrush *This, IXpsOMGradientStopCollection **gradientStops) {
  return This->lpVtbl->GetGradientStops(This, gradientStops);
}
static inline HRESULT
IXpsOMGradientBrush_GetTransform(IXpsOMGradientBrush *This,
                                 IXpsOMMatrixTransform **transform) {
  return This->lpVtbl->GetTransform(This, transform);
}
static inline HRESULT
IXpsOMGradientBrush_GetTransformLocal(IXpsOMGradientBrush *This,
                                      IXpsOMMatrixTransform **transform) {
  return This->lpVtbl->GetTransformLocal(This, transform);
}
static inline HRESULT
IXpsOMGradientBrush_SetTransformLocal(IXpsOMGradientBrush *This,
                                      IXpsOMMatrixTransform *transform) {
  return This->lpVtbl->SetTransformLocal(This, transform);
}
static inline HRESULT
IXpsOMGradientBrush_GetTransformLookup(IXpsOMGradientBrush *This, LPWSTR *key) {
  return This->lpVtbl->GetTransformLookup(This, key);
}
static inline HRESULT
IXpsOMGradientBrush_SetTransformLookup(IXpsOMGradientBrush *This, LPCWSTR key) {
  return This->lpVtbl->SetTransformLookup(This, key);
}
static inline HRESULT
IXpsOMGradientBrush_GetSpreadMethod(IXpsOMGradientBrush *This,
                                    XPS_SPREAD_METHOD *spreadMethod) {
  return This->lpVtbl->GetSpreadMethod(This, spreadMethod);
}
static inline HRESULT
IXpsOMGradientBrush_SetSpreadMethod(IXpsOMGradientBrush *This,
                                    XPS_SPREAD_METHOD spreadMethod) {
  return This->lpVtbl->SetSpreadMethod(This, spreadMethod);
}
static inline HRESULT IXpsOMGradientBrush_GetColorInterpolationMode(
    IXpsOMGradientBrush *This,
    XPS_COLOR_INTERPOLATION *colorInterpolationMode) {
  return This->lpVtbl->GetColorInterpolationMode(This, colorInterpolationMode);
}
static inline HRESULT IXpsOMGradientBrush_SetColorInterpolationMode(
    IXpsOMGradientBrush *This, XPS_COLOR_INTERPOLATION colorInterpolationMode) {
...
DEFINE_GUID(IID_IXpsOMVisualBrush, 0x97e294af, 0x5b37, 0x46b4, 0x80, 0x57, 0x87,
            0x4d, 0x2f, 0x64, 0x11, 0x9b);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("97e294af-5b37-46b4-8057-874d2f64119b")
IXpsOMVisualBrush : public IXpsOMTileBrush {
  virtual HRESULT STDMETHODCALLTYPE GetVisual(IXpsOMVisual * *visual) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetVisualLocal(IXpsOMVisual * *visual) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetVisualLocal(IXpsOMVisual * visual) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetVisualLookup(LPWSTR * lookup) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetVisualLookup(LPCWSTR lookup) = 0;
  virtual HRESULT STDMETHODCALLTYPE Clone(IXpsOMVisualBrush * *visualBrush) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMVisualBrush, 0x97e294af, 0x5b37, 0x46b4, 0x80, 0x57, 0x87,
                0x4d, 0x2f, 0x64, 0x11, 0x9b)
#endif
#else
typedef struct IXpsOMVisualBrushVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsOMVisualBrush *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IXpsOMVisualBrush *This);
  ULONG(STDMETHODCALLTYPE *Release)(IXpsOMVisualBrush *This);
  /*** IXpsOMShareable methods ***/
  HRESULT(STDMETHODCALLTYPE *GetOwner)(IXpsOMVisualBrush *This,
                                       IUnknown **owner);
  HRESULT(STDMETHODCALLTYPE *GetType)(IXpsOMVisualBrush *This,
                                      XPS_OBJECT_TYPE *type);
  /*** IXpsOMBrush methods ***/
  HRESULT(STDMETHODCALLTYPE *GetOpacity)(IXpsOMVisualBrush *This,
                                         FLOAT *opacity);
  HRESULT(STDMETHODCALLTYPE *SetOpacity)(IXpsOMVisualBrush *This,
                                         FLOAT opacity);
  /*** IXpsOMTileBrush methods ***/
  HRESULT(STDMETHODCALLTYPE *GetTransform)(IXpsOMVisualBrush *This,
                                           IXpsOMMatrixTransform **transform);
  HRESULT(STDMETHODCALLTYPE *GetTransformLocal)(
      IXpsOMVisualBrush *This, IXpsOMMatrixTransform **transform);
  HRESULT(STDMETHODCALLTYPE *SetTransformLocal)(
      IXpsOMVisualBrush *This, IXpsOMMatrixTransform *transform);
  HRESULT(STDMETHODCALLTYPE *GetTransformLookup)(IXpsOMVisualBrush *This,
                                                 LPWSTR *key);
  HRESULT(STDMETHODCALLTYPE *SetTransformLookup)(IXpsOMVisualBrush *This,
                                                 LPCWSTR key);
  HRESULT(STDMETHODCALLTYPE *GetViewbox)(IXpsOMVisualBrush *This,
                                         XPS_RECT *viewbox);
  HRESULT(STDMETHODCALLTYPE *SetViewbox)(IXpsOMVisualBrush *This,
                                         const XPS_RECT *viewbox);
  HRESULT(STDMETHODCALLTYPE *GetViewport)(IXpsOMVisualBrush *This,
                                          XPS_RECT *viewport);
  HRESULT(STDMETHODCALLTYPE *SetViewport)(IXpsOMVisualBrush *This,
                                          const XPS_RECT *viewport);
  HRESULT(STDMETHODCALLTYPE *GetTileMode)(IXpsOMVisualBrush *This,
                                          XPS_TILE_MODE *tileMode);
  HRESULT(STDMETHODCALLTYPE *SetTileMode)(IXpsOMVisualBrush *This,
                                          XPS_TILE_MODE tileMode);
  /*** IXpsOMVisualBrush methods ***/
  HRESULT(STDMETHODCALLTYPE *GetVisual)(IXpsOMVisualBrush *This,
                                        IXpsOMVisual **visual);
  HRESULT(STDMETHODCALLTYPE *GetVisualLocal)(IXpsOMVisualBrush *This,
                                             IXpsOMVisual **visual);
  HRESULT(STDMETHODCALLTYPE *SetVisualLocal)(IXpsOMVisualBrush *This,
                                             IXpsOMVisual *visual);
  HRESULT(STDMETHODCALLTYPE *GetVisualLookup)(IXpsOMVisualBrush *This,
                                              LPWSTR *lookup);
  HRESULT(STDMETHODCALLTYPE *SetVisualLookup)(IXpsOMVisualBrush *This,
                                              LPCWSTR lookup);
  HRESULT(STDMETHODCALLTYPE *Clone)(IXpsOMVisualBrush *This,
                                    IXpsOMVisualBrush **visualBrush);
  END_INTERFACE
} IXpsOMVisualBrushVtbl;
interface IXpsOMVisualBrush { CONST_VTBL IXpsOMVisualBrushVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IXpsOMVisualBrush_QueryInterface(IXpsOMVisualBrush *This,
                                                       REFIID riid,
                                                       void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IXpsOMShareable methods ***/
static inline HRESULT IXpsOMVisualBrush_GetOwner(IXpsOMVisualBrush *This,
                                                 IUnknown **owner) {
  return This->lpVtbl->GetOwner(This, owner);
}
static inline HRESULT IXpsOMVisualBrush_GetType(IXpsOMVisualBrush *This,
                                                XPS_OBJECT_TYPE *type) {
  return This->lpVtbl->GetType(This, type);
}
/*** IXpsOMBrush methods ***/
static inline HRESULT IXpsOMVisualBrush_GetOpacity(IXpsOMVisualBrush *This,
                                                   FLOAT *opacity) {
  return This->lpVtbl->GetOpacity(This, opacity);
}
static inline HRESULT IXpsOMVisualBrush_SetOpacity(IXpsOMVisualBrush *This,
                                                   FLOAT opacity) {
  return This->lpVtbl->SetOpacity(This, opacity);
}
/*** IXpsOMTileBrush methods ***/
static inline HRESULT
IXpsOMVisualBrush_GetTransform(IXpsOMVisualBrush *This,
                               IXpsOMMatrixTransform **transform) {
  return This->lpVtbl->GetTransform(This, transform);
}
static inline HRESULT
IXpsOMVisualBrush_GetTransformLocal(IXpsOMVisualBrush *This,
                                    IXpsOMMatrixTransform **transform) {
  return This->lpVtbl->GetTransformLocal(This, transform);
}
static inline HRESULT
IXpsOMVisualBrush_SetTransformLocal(IXpsOMVisualBrush *This,
                                    IXpsOMMatrixTransform *transform) {
  return This->lpVtbl->SetTransformLocal(This, transform);
}
static inline HRESULT
IXpsOMVisualBrush_GetTransformLookup(IXpsOMVisualBrush *This, LPWSTR *key) {
  return This->lpVtbl->GetTransformLookup(This, key);
}
static inline HRESULT
IXpsOMVisualBrush_SetTransformLookup(IXpsOMVisualBrush *This, LPCWSTR key) {
  return This->lpVtbl->SetTransformLookup(This, key);
}
static inline HRESULT IXpsOMVisualBrush_GetViewbox(IXpsOMVisualBrush *This,
                                                   XPS_RECT *viewbox) {
  return This->lpVtbl->GetViewbox(This, viewbox);
}
static inline HRESULT IXpsOMVisualBrush_SetViewbox(IXpsOMVisualBrush *This,
                                                   const XPS_RECT *viewbox) {
  return This->lpVtbl->SetViewbox(This, viewbox);
}
static inline HRESULT IXpsOMVisualBrush_GetViewport(IXpsOMVisualBrush *This,
                                                    XPS_RECT *viewport) {
  return This->lpVtbl->GetViewport(This, viewport);
}
static inline HRESULT IXpsOMVisualBrush_SetViewport(IXpsOMVisualBrush *This,
                                                    const XPS_RECT *viewport) {
  return This->lpVtbl->SetViewport(This, viewport);
}
static inline HRESULT IXpsOMVisualBrush_GetTileMode(IXpsOMVisualBrush *This,
                                                    XPS_TILE_MODE *tileMode) {
  return This->lpVtbl->GetTileMode(This, tileMode);
}
static inline HRESULT IXpsOMVisualBrush_SetTileMode(IXpsOMVisualBrush *This,
                                                    XPS_TILE_MODE tileMode) {
  return This->lpVtbl->SetTileMode(This, tileMode);
}
/*** IXpsOMVisualBrush methods ***/
static inline HRESULT IXpsOMVisualBrush_GetVisual(IXpsOMVisualBrush *This,
                                                  IXpsOMVisual **visual) {
  return This->lpVtbl->GetVisual(This, visual);
}
static inline HRESULT IXpsOMVisualBrush_GetVisualLocal(IXpsOMVisualBrush *This,
                                                       IXpsOMVisual **visual) {
  return This->lpVtbl->GetVisualLocal(This, visual);
}
static inline HRESULT IXpsOMVisualBrush_SetVisualLocal(IXpsOMVisualBrush *This,
                                                       IXpsOMVisual *visual) {
  return This->lpVtbl->SetVisualLocal(This, visual);
}
static inline HRESULT IXpsOMVisualBrush_GetVisualLookup(IXpsOMVisualBrush *This,
                                                        LPWSTR *lookup) {
  return This->lpVtbl->GetVisualLookup(This, lookup);
}
static inline HRESULT IXpsOMVisualBrush_SetVisualLookup(IXpsOMVisualBrush *This,
                                                        LPCWSTR lookup) {
  return This->lpVtbl->SetVisualLookup(This, lookup);
}
static inline HRESULT IXpsOMVisualBrush_Clone(IXpsOMVisualBrush *This,
                                              IXpsOMVisualBrush **visualBrush) {
...
DEFINE_GUID(IID_IXpsOMImageBrush, 0x3df0b466, 0xd382, 0x49ef, 0x85, 0x50, 0xdd,
            0x94, 0xc8, 0x02, 0x42, 0xe4);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("3df0b466-d382-49ef-8550-dd94c80242e4")
IXpsOMImageBrush : public IXpsOMTileBrush {
  virtual HRESULT STDMETHODCALLTYPE GetImageResource(IXpsOMImageResource *
                                                     *imageResource) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetImageResource(IXpsOMImageResource *
                                                     imageResource) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetColorProfileResource(
      IXpsOMColorProfileResource * *colorProfileResource) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetColorProfileResource(
      IXpsOMColorProfileResource * colorProfileResource) = 0;
  virtual HRESULT STDMETHODCALLTYPE Clone(IXpsOMImageBrush * *imageBrush) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMImageBrush, 0x3df0b466, 0xd382, 0x49ef, 0x85, 0x50, 0xdd,
                0x94, 0xc8, 0x02, 0x42, 0xe4)
#endif
#else
typedef struct IXpsOMImageBrushVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsOMImageBrush *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IXpsOMImageBrush *This);
  ULONG(STDMETHODCALLTYPE *Release)(IXpsOMImageBrush *This);
  /*** IXpsOMShareable methods ***/
  HRESULT(STDMETHODCALLTYPE *GetOwner)(IXpsOMImageBrush *This,
                                       IUnknown **owner);
  HRESULT(STDMETHODCALLTYPE *GetType)(IXpsOMImageBrush *This,
                                      XPS_OBJECT_TYPE *type);
  /*** IXpsOMBrush methods ***/
  HRESULT(STDMETHODCALLTYPE *GetOpacity)(IXpsOMImageBrush *This,
                                         FLOAT *opacity);
  HRESULT(STDMETHODCALLTYPE *SetOpacity)(IXpsOMImageBrush *This, FLOAT opacity);
  /*** IXpsOMTileBrush methods ***/
  HRESULT(STDMETHODCALLTYPE *GetTransform)(IXpsOMImageBrush *This,
                                           IXpsOMMatrixTransform **transform);
  HRESULT(STDMETHODCALLTYPE *GetTransformLocal)(
      IXpsOMImageBrush *This, IXpsOMMatrixTransform **transform);
  HRESULT(STDMETHODCALLTYPE *SetTransformLocal)(
      IXpsOMImageBrush *This, IXpsOMMatrixTransform *transform);
  HRESULT(STDMETHODCALLTYPE *GetTransformLookup)(IXpsOMImageBrush *This,
                                                 LPWSTR *key);
  HRESULT(STDMETHODCALLTYPE *SetTransformLookup)(IXpsOMImageBrush *This,
                                                 LPCWSTR key);
  HRESULT(STDMETHODCALLTYPE *GetViewbox)(IXpsOMImageBrush *This,
                                         XPS_RECT *viewbox);
  HRESULT(STDMETHODCALLTYPE *SetViewbox)(IXpsOMImageBrush *This,
                                         const XPS_RECT *viewbox);
  HRESULT(STDMETHODCALLTYPE *GetViewport)(IXpsOMImageBrush *This,
                                          XPS_RECT *viewport);
  HRESULT(STDMETHODCALLTYPE *SetViewport)(IXpsOMImageBrush *This,
                                          const XPS_RECT *viewport);
  HRESULT(STDMETHODCALLTYPE *GetTileMode)(IXpsOMImageBrush *This,
                                          XPS_TILE_MODE *tileMode);
  HRESULT(STDMETHODCALLTYPE *SetTileMode)(IXpsOMImageBrush *This,
                                          XPS_TILE_MODE tileMode);
  /*** IXpsOMImageBrush methods ***/
  HRESULT(STDMETHODCALLTYPE *GetImageResource)(
      IXpsOMImageBrush *This, IXpsOMImageResource **imageResource);
  ...
  HRESULT(STDMETHODCALLTYPE *SetColorProfileResource)(
      IXpsOMImageBrush *This, IXpsOMColorProfileResource *colorProfileResource);
  HRESULT(STDMETHODCALLTYPE *Clone)(IXpsOMImageBrush *This,
                                    IXpsOMImageBrush **imageBrush);
  END_INTERFACE
} IXpsOMImageBrushVtbl;
interface IXpsOMImageBrush { CONST_VTBL IXpsOMImageBrushVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IXpsOMImageBrush_QueryInterface(IXpsOMImageBrush *This,
                                                      REFIID riid,
                                                      void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IXpsOMShareable methods ***/
static inline HRESULT IXpsOMImageBrush_GetOwner(IXpsOMImageBrush *This,
                                                IUnknown **owner) {
  return This->lpVtbl->GetOwner(This, owner);
}
static inline HRESULT IXpsOMImageBrush_GetType(IXpsOMImageBrush *This,
                                               XPS_OBJECT_TYPE *type) {
  return This->lpVtbl->GetType(This, type);
}
/*** IXpsOMBrush methods ***/
static inline HRESULT IXpsOMImageBrush_GetOpacity(IXpsOMImageBrush *This,
                                                  FLOAT *opacity) {
  return This->lpVtbl->GetOpacity(This, opacity);
}
static inline HRESULT IXpsOMImageBrush_SetOpacity(IXpsOMImageBrush *This,
                                                  FLOAT opacity) {
  return This->lpVtbl->SetOpacity(This, opacity);
}
/*** IXpsOMTileBrush methods ***/
static inline HRESULT
IXpsOMImageBrush_GetTransform(IXpsOMImageBrush *This,
                              IXpsOMMatrixTransform **transform) {
  return This->lpVtbl->GetTransform(This, transform);
}
static inline HRESULT
IXpsOMImageBrush_GetTransformLocal(IXpsOMImageBrush *This,
                                   IXpsOMMatrixTransform **transform) {
  return This->lpVtbl->GetTransformLocal(This, transform);
}
static inline HRESULT
IXpsOMImageBrush_SetTransformLocal(IXpsOMImageBrush *This,
                                   IXpsOMMatrixTransform *transform) {
  return This->lpVtbl->SetTransformLocal(This, transform);
}
static inline HRESULT
IXpsOMImageBrush_GetTransformLookup(IXpsOMImageBrush *This, LPWSTR *key) {
  return This->lpVtbl->GetTransformLookup(This, key);
}
static inline HRESULT
IXpsOMImageBrush_SetTransformLookup(IXpsOMImageBrush *This, LPCWSTR key) {
  return This->lpVtbl->SetTransformLookup(This, key);
}
static inline HRESULT IXpsOMImageBrush_GetViewbox(IXpsOMImageBrush *This,
                                                  XPS_RECT *viewbox) {
  return This->lpVtbl->GetViewbox(This, viewbox);
}
static inline HRESULT IXpsOMImageBrush_SetViewbox(IXpsOMImageBrush *This,
                                                  const XPS_RECT *viewbox) {
  return This->lpVtbl->SetViewbox(This, viewbox);
}
static inline HRESULT IXpsOMImageBrush_GetViewport(IXpsOMImageBrush *This,
                                                   XPS_RECT *viewport) {
  return This->lpVtbl->GetViewport(This, viewport);
}
static inline HRESULT IXpsOMImageBrush_SetViewport(IXpsOMImageBrush *This,
                                                   const XPS_RECT *viewport) {
  return This->lpVtbl->SetViewport(This, viewport);
}
static inline HRESULT IXpsOMImageBrush_GetTileMode(IXpsOMImageBrush *This,
                                                   XPS_TILE_MODE *tileMode) {
  return This->lpVtbl->GetTileMode(This, tileMode);
}
static inline HRESULT IXpsOMImageBrush_SetTileMode(IXpsOMImageBrush *This,
                                                   XPS_TILE_MODE tileMode) {
  return This->lpVtbl->SetTileMode(This, tileMode);
}
/*** IXpsOMImageBrush methods ***/
static inline HRESULT
IXpsOMImageBrush_GetImageResource(IXpsOMImageBrush *This,
                                  IXpsOMImageResource **imageResource) {
  return This->lpVtbl->GetImageResource(This, imageResource);
}
static inline HRESULT
IXpsOMImageBrush_SetImageResource(IXpsOMImageBrush *This,
                                  IXpsOMImageResource *imageResource) {
  return This->lpVtbl->SetImageResource(This, imageResource);
}
static inline HRESULT IXpsOMImageBrush_GetColorProfileResource(
    IXpsOMImageBrush *This, IXpsOMColorProfileResource **colorProfileResource) {
  return This->lpVtbl->GetColorProfileResource(This, colorProfileResource);
}
static inline HRESULT IXpsOMImageBrush_SetColorProfileResource(
    IXpsOMImageBrush *This, IXpsOMColorProfileResource *colorProfileResource) {
  return This->lpVtbl->SetColorProfileResource(This, colorProfileResource);
}
static inline HRESULT IXpsOMImageBrush_Clone(IXpsOMImageBrush *This,
                                             IXpsOMImageBrush **imageBrush) {
...
DEFINE_GUID(IID_IXpsOMLinearGradientBrush, 0x005e279f, 0xc30d, 0x40ff, 0x93,
            0xec, 0x19, 0x50, 0xd3, 0xc5, 0x28, 0xdb);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IXpsOMLinearGradientBrush : public IXpsOMGradientBrush {
  ...
  virtual HRESULT STDMETHODCALLTYPE SetStartPoint(
      const XPS_POINT *startPoint) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetEndPoint(XPS_POINT * endPoint) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetEndPoint(const XPS_POINT *endPoint) = 0;
  virtual HRESULT STDMETHODCALLTYPE Clone(IXpsOMLinearGradientBrush *
                                          *linearGradientBrush) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMLinearGradientBrush, 0x005e279f, 0xc30d, 0x40ff, 0x93,
                0xec, 0x19, 0x50, 0xd3, 0xc5, 0x28, 0xdb)
#endif
#else
typedef struct IXpsOMLinearGradientBrushVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsOMLinearGradientBrush *This,
                                             REFIID riid, void **ppvObject);
  ...
  /*** IXpsOMShareable methods ***/
  HRESULT(STDMETHODCALLTYPE *GetOwner)(IXpsOMLinearGradientBrush *This,
                                       IUnknown **owner);
  HRESULT(STDMETHODCALLTYPE *GetType)(IXpsOMLinearGradientBrush *This,
                                      XPS_OBJECT_TYPE *type);
  /*** IXpsOMBrush methods ***/
  HRESULT(STDMETHODCALLTYPE *GetOpacity)(IXpsOMLinearGradientBrush *This,
                                         FLOAT *opacity);
  HRESULT(STDMETHODCALLTYPE *SetOpacity)(IXpsOMLinearGradientBrush *This,
                                         FLOAT opacity);
  /*** IXpsOMGradientBrush methods ***/
  HRESULT(STDMETHODCALLTYPE *GetGradientStops)(
      IXpsOMLinearGradientBrush *This,
      IXpsOMGradientStopCollection **gradientStops);
  HRESULT(STDMETHODCALLTYPE *GetTransform)(IXpsOMLinearGradientBrush *This,
                                           IXpsOMMatrixTransform **transform);
  HRESULT(STDMETHODCALLTYPE *GetTransformLocal)(
      IXpsOMLinearGradientBrush *This, IXpsOMMatrixTransform **transform);
  HRESULT(STDMETHODCALLTYPE *SetTransformLocal)(
      IXpsOMLinearGradientBrush *This, IXpsOMMatrixTransform *transform);
  HRESULT(STDMETHODCALLTYPE *GetTransformLookup)(
      IXpsOMLinearGradientBrush *This, LPWSTR *key);
  HRESULT(STDMETHODCALLTYPE *SetTransformLookup)(
      IXpsOMLinearGradientBrush *This, LPCWSTR key);
  HRESULT(STDMETHODCALLTYPE *GetSpreadMethod)(IXpsOMLinearGradientBrush *This,
                                              XPS_SPREAD_METHOD *spreadMethod);
  HRESULT(STDMETHODCALLTYPE *SetSpreadMethod)(IXpsOMLinearGradientBrush *This,
                                              XPS_SPREAD_METHOD spreadMethod);
  HRESULT(STDMETHODCALLTYPE *GetColorInterpolationMode)(
      IXpsOMLinearGradientBrush *This,
      XPS_COLOR_INTERPOLATION *colorInterpolationMode);
  ...
  HRESULT(STDMETHODCALLTYPE *GetStartPoint)(IXpsOMLinearGradientBrush *This,
                                            XPS_POINT *startPoint);
  HRESULT(STDMETHODCALLTYPE *SetStartPoint)(IXpsOMLinearGradientBrush *This,
                                            const XPS_POINT *startPoint);
  HRESULT(STDMETHODCALLTYPE *GetEndPoint)(IXpsOMLinearGradientBrush *This,
                                          XPS_POINT *endPoint);
  HRESULT(STDMETHODCALLTYPE *SetEndPoint)(IXpsOMLinearGradientBrush *This,
                                          const XPS_POINT *endPoint);
...
#define IXpsOMLinearGradientBrush_SetSpreadMethod(This, spreadMethod)          \
  (This)->lpVtbl->SetSpreadMethod(This, spreadMethod)
#define IXpsOMLinearGradientBrush_GetColorInterpolationMode(                   \
    This, colorInterpolationMode)                                              \
  (This)->lpVtbl->GetColorInterpolationMode(This, colorInterpolationMode)
...
/*** IUnknown methods ***/
static inline HRESULT
IXpsOMLinearGradientBrush_QueryInterface(IXpsOMLinearGradientBrush *This,
                                         REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IXpsOMLinearGradientBrush_AddRef(IXpsOMLinearGradientBrush *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IXpsOMLinearGradientBrush_Release(IXpsOMLinearGradientBrush *This) {
  return This->lpVtbl->Release(This);
}
/*** IXpsOMShareable methods ***/
static inline HRESULT
IXpsOMLinearGradientBrush_GetOwner(IXpsOMLinearGradientBrush *This,
                                   IUnknown **owner) {
  return This->lpVtbl->GetOwner(This, owner);
}
static inline HRESULT
IXpsOMLinearGradientBrush_GetType(IXpsOMLinearGradientBrush *This,
                                  XPS_OBJECT_TYPE *type) {
  return This->lpVtbl->GetType(This, type);
}
/*** IXpsOMBrush methods ***/
static inline HRESULT
IXpsOMLinearGradientBrush_GetOpacity(IXpsOMLinearGradientBrush *This,
                                     FLOAT *opacity) {
  return This->lpVtbl->GetOpacity(This, opacity);
}
static inline HRESULT
IXpsOMLinearGradientBrush_SetOpacity(IXpsOMLinearGradientBrush *This,
                                     FLOAT opacity) {
  return This->lpVtbl->SetOpacity(This, opacity);
}
/*** IXpsOMGradientBrush methods ***/
static inline HRESULT IXpsOMLinearGradientBrush_GetGradientStops(
    IXpsOMLinearGradientBrush *This,
    IXpsOMGradientStopCollection **gradientStops) {
  return This->lpVtbl->GetGradientStops(This, gradientStops);
}
static inline HRESULT
IXpsOMLinearGradientBrush_GetTransform(IXpsOMLinearGradientBrush *This,
                                       IXpsOMMatrixTransform **transform) {
  return This->lpVtbl->GetTransform(This, transform);
}
static inline HRESULT
IXpsOMLinearGradientBrush_GetTransformLocal(IXpsOMLinearGradientBrush *This,
                                            IXpsOMMatrixTransform **transform) {
  return This->lpVtbl->GetTransformLocal(This, transform);
}
static inline HRESULT
IXpsOMLinearGradientBrush_SetTransformLocal(IXpsOMLinearGradientBrush *This,
                                            IXpsOMMatrixTransform *transform) {
  return This->lpVtbl->SetTransformLocal(This, transform);
}
static inline HRESULT
IXpsOMLinearGradientBrush_GetTransformLookup(IXpsOMLinearGradientBrush *This,
                                             LPWSTR *key) {
  return This->lpVtbl->GetTransformLookup(This, key);
}
static inline HRESULT
IXpsOMLinearGradientBrush_SetTransformLookup(IXpsOMLinearGradientBrush *This,
                                             LPCWSTR key) {
  return This->lpVtbl->SetTransformLookup(This, key);
}
static inline HRESULT
IXpsOMLinearGradientBrush_GetSpreadMethod(IXpsOMLinearGradientBrush *This,
                                          XPS_SPREAD_METHOD *spreadMethod) {
  return This->lpVtbl->GetSpreadMethod(This, spreadMethod);
}
static inline HRESULT
IXpsOMLinearGradientBrush_SetSpreadMethod(IXpsOMLinearGradientBrush *This,
                                          XPS_SPREAD_METHOD spreadMethod) {
  return This->lpVtbl->SetSpreadMethod(This, spreadMethod);
}
static inline HRESULT IXpsOMLinearGradientBrush_GetColorInterpolationMode(
    IXpsOMLinearGradientBrush *This,
    XPS_COLOR_INTERPOLATION *colorInterpolationMode) {
  return This->lpVtbl->GetColorInterpolationMode(This, colorInterpolationMode);
}
static inline HRESULT IXpsOMLinearGradientBrush_SetColorInterpolationMode(
    IXpsOMLinearGradientBrush *This,
    XPS_COLOR_INTERPOLATION colorInterpolationMode) {
  return This->lpVtbl->SetColorInterpolationMode(This, colorInterpolationMode);
}
/*** IXpsOMLinearGradientBrush methods ***/
static inline HRESULT
IXpsOMLinearGradientBrush_GetStartPoint(IXpsOMLinearGradientBrush *This,
                                        XPS_POINT *startPoint) {
  return This->lpVtbl->GetStartPoint(This, startPoint);
}
static inline HRESULT
IXpsOMLinearGradientBrush_SetStartPoint(IXpsOMLinearGradientBrush *This,
                                        const XPS_POINT *startPoint) {
  return This->lpVtbl->SetStartPoint(This, startPoint);
}
static inline HRESULT
IXpsOMLinearGradientBrush_GetEndPoint(IXpsOMLinearGradientBrush *This,
                                      XPS_POINT *endPoint) {
  return This->lpVtbl->GetEndPoint(This, endPoint);
}
static inline HRESULT
IXpsOMLinearGradientBrush_SetEndPoint(IXpsOMLinearGradientBrush *This,
                                      const XPS_POINT *endPoint) {
  return This->lpVtbl->SetEndPoint(This, endPoint);
}
static inline HRESULT IXpsOMLinearGradientBrush_Clone(
    IXpsOMLinearGradientBrush *This,
    IXpsOMLinearGradientBrush **linearGradientBrush) {
...
DEFINE_GUID(IID_IXpsOMRadialGradientBrush, 0x75f207e5, 0x08bf, 0x413c, 0x96,
            0xb1, 0xb8, 0x2b, 0x40, 0x64, 0x17, 0x6b);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("75f207e5-08bf-413c-96b1-b82b4064176b")
IXpsOMRadialGradientBrush : public IXpsOMGradientBrush {
  virtual HRESULT STDMETHODCALLTYPE GetCenter(XPS_POINT * center) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetCenter(const XPS_POINT *center) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetRadiiSizes(XPS_SIZE * radiiSizes) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetRadiiSizes(
      const XPS_SIZE *radiiSizes) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetGradientOrigin(XPS_POINT * origin) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetGradientOrigin(
      const XPS_POINT *origin) = 0;
  virtual HRESULT STDMETHODCALLTYPE Clone(IXpsOMRadialGradientBrush *
                                          *radialGradientBrush) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMRadialGradientBrush, 0x75f207e5, 0x08bf, 0x413c, 0x96,
                0xb1, 0xb8, 0x2b, 0x40, 0x64, 0x17, 0x6b)
#endif
#else
typedef struct IXpsOMRadialGradientBrushVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsOMRadialGradientBrush *This,
                                             REFIID riid, void **ppvObject);
  ...
  /*** IXpsOMShareable methods ***/
  HRESULT(STDMETHODCALLTYPE *GetOwner)(IXpsOMRadialGradientBrush *This,
                                       IUnknown **owner);
  HRESULT(STDMETHODCALLTYPE *GetType)(IXpsOMRadialGradientBrush *This,
                                      XPS_OBJECT_TYPE *type);
  /*** IXpsOMBrush methods ***/
  HRESULT(STDMETHODCALLTYPE *GetOpacity)(IXpsOMRadialGradientBrush *This,
                                         FLOAT *opacity);
  HRESULT(STDMETHODCALLTYPE *SetOpacity)(IXpsOMRadialGradientBrush *This,
                                         FLOAT opacity);
  /*** IXpsOMGradientBrush methods ***/
  HRESULT(STDMETHODCALLTYPE *GetGradientStops)(
      IXpsOMRadialGradientBrush *This,
      IXpsOMGradientStopCollection **gradientStops);
  HRESULT(STDMETHODCALLTYPE *GetTransform)(IXpsOMRadialGradientBrush *This,
                                           IXpsOMMatrixTransform **transform);
  HRESULT(STDMETHODCALLTYPE *GetTransformLocal)(
      IXpsOMRadialGradientBrush *This, IXpsOMMatrixTransform **transform);
  HRESULT(STDMETHODCALLTYPE *SetTransformLocal)(
      IXpsOMRadialGradientBrush *This, IXpsOMMatrixTransform *transform);
  HRESULT(STDMETHODCALLTYPE *GetTransformLookup)(
      IXpsOMRadialGradientBrush *This, LPWSTR *key);
  HRESULT(STDMETHODCALLTYPE *SetTransformLookup)(
      IXpsOMRadialGradientBrush *This, LPCWSTR key);
  HRESULT(STDMETHODCALLTYPE *GetSpreadMethod)(IXpsOMRadialGradientBrush *This,
                                              XPS_SPREAD_METHOD *spreadMethod);
  HRESULT(STDMETHODCALLTYPE *SetSpreadMethod)(IXpsOMRadialGradientBrush *This,
                                              XPS_SPREAD_METHOD spreadMethod);
  HRESULT(STDMETHODCALLTYPE *GetColorInterpolationMode)(
      IXpsOMRadialGradientBrush *This,
      XPS_COLOR_INTERPOLATION *colorInterpolationMode);
  ...
  HRESULT(STDMETHODCALLTYPE *GetCenter)(IXpsOMRadialGradientBrush *This,
                                        XPS_POINT *center);
  HRESULT(STDMETHODCALLTYPE *SetCenter)(IXpsOMRadialGradientBrush *This,
                                        const XPS_POINT *center);
  HRESULT(STDMETHODCALLTYPE *GetRadiiSizes)(IXpsOMRadialGradientBrush *This,
                                            XPS_SIZE *radiiSizes);
  HRESULT(STDMETHODCALLTYPE *SetRadiiSizes)(IXpsOMRadialGradientBrush *This,
                                            const XPS_SIZE *radiiSizes);
  HRESULT(STDMETHODCALLTYPE *GetGradientOrigin)(IXpsOMRadialGradientBrush *This,
                                                XPS_POINT *origin);
  HRESULT(STDMETHODCALLTYPE *SetGradientOrigin)(IXpsOMRadialGradientBrush *This,
                                                const XPS_POINT *origin);
  HRESULT(STDMETHODCALLTYPE *Clone)(
      IXpsOMRadialGradientBrush *This,
      IXpsOMRadialGradientBrush **radialGradientBrush);
...
#define IXpsOMRadialGradientBrush_SetSpreadMethod(This, spreadMethod)          \
  (This)->lpVtbl->SetSpreadMethod(This, spreadMethod)
#define IXpsOMRadialGradientBrush_GetColorInterpolationMode(                   \
    This, colorInterpolationMode)                                              \
  (This)->lpVtbl->GetColorInterpolationMode(This, colorInterpolationMode)
#define IXpsOMRadialGradientBrush_SetColorInterpolationMode(                   \
    This, colorInterpolationMode)                                              \
  (This)->lpVtbl->SetColorInterpolationMode(This, colorInterpolationMode)
/*** IXpsOMRadialGradientBrush methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
IXpsOMRadialGradientBrush_QueryInterface(IXpsOMRadialGradientBrush *This,
                                         REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IXpsOMRadialGradientBrush_AddRef(IXpsOMRadialGradientBrush *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IXpsOMRadialGradientBrush_Release(IXpsOMRadialGradientBrush *This) {
  return This->lpVtbl->Release(This);
}
/*** IXpsOMShareable methods ***/
static inline HRESULT
IXpsOMRadialGradientBrush_GetOwner(IXpsOMRadialGradientBrush *This,
                                   IUnknown **owner) {
  return This->lpVtbl->GetOwner(This, owner);
}
static inline HRESULT
IXpsOMRadialGradientBrush_GetType(IXpsOMRadialGradientBrush *This,
                                  XPS_OBJECT_TYPE *type) {
  return This->lpVtbl->GetType(This, type);
}
/*** IXpsOMBrush methods ***/
static inline HRESULT
IXpsOMRadialGradientBrush_GetOpacity(IXpsOMRadialGradientBrush *This,
                                     FLOAT *opacity) {
  return This->lpVtbl->GetOpacity(This, opacity);
}
static inline HRESULT
IXpsOMRadialGradientBrush_SetOpacity(IXpsOMRadialGradientBrush *This,
                                     FLOAT opacity) {
  return This->lpVtbl->SetOpacity(This, opacity);
}
/*** IXpsOMGradientBrush methods ***/
static inline HRESULT IXpsOMRadialGradientBrush_GetGradientStops(
    IXpsOMRadialGradientBrush *This,
    IXpsOMGradientStopCollection **gradientStops) {
  return This->lpVtbl->GetGradientStops(This, gradientStops);
}
static inline HRESULT
IXpsOMRadialGradientBrush_GetTransform(IXpsOMRadialGradientBrush *This,
                                       IXpsOMMatrixTransform **transform) {
  return This->lpVtbl->GetTransform(This, transform);
}
static inline HRESULT
IXpsOMRadialGradientBrush_GetTransformLocal(IXpsOMRadialGradientBrush *This,
                                            IXpsOMMatrixTransform **transform) {
  return This->lpVtbl->GetTransformLocal(This, transform);
}
static inline HRESULT
IXpsOMRadialGradientBrush_SetTransformLocal(IXpsOMRadialGradientBrush *This,
                                            IXpsOMMatrixTransform *transform) {
  return This->lpVtbl->SetTransformLocal(This, transform);
}
static inline HRESULT
IXpsOMRadialGradientBrush_GetTransformLookup(IXpsOMRadialGradientBrush *This,
                                             LPWSTR *key) {
  return This->lpVtbl->GetTransformLookup(This, key);
}
static inline HRESULT
IXpsOMRadialGradientBrush_SetTransformLookup(IXpsOMRadialGradientBrush *This,
                                             LPCWSTR key) {
  return This->lpVtbl->SetTransformLookup(This, key);
}
static inline HRESULT
IXpsOMRadialGradientBrush_GetSpreadMethod(IXpsOMRadialGradientBrush *This,
                                          XPS_SPREAD_METHOD *spreadMethod) {
  return This->lpVtbl->GetSpreadMethod(This, spreadMethod);
}
static inline HRESULT
IXpsOMRadialGradientBrush_SetSpreadMethod(IXpsOMRadialGradientBrush *This,
                                          XPS_SPREAD_METHOD spreadMethod) {
  return This->lpVtbl->SetSpreadMethod(This, spreadMethod);
}
static inline HRESULT IXpsOMRadialGradientBrush_GetColorInterpolationMode(
    IXpsOMRadialGradientBrush *This,
    XPS_COLOR_INTERPOLATION *colorInterpolationMode) {
  return This->lpVtbl->GetColorInterpolationMode(This, colorInterpolationMode);
}
static inline HRESULT IXpsOMRadialGradientBrush_SetColorInterpolationMode(
    IXpsOMRadialGradientBrush *This,
    XPS_COLOR_INTERPOLATION colorInterpolationMode) {
  return This->lpVtbl->SetColorInterpolationMode(This, colorInterpolationMode);
}
/*** IXpsOMRadialGradientBrush methods ***/
static inline HRESULT
IXpsOMRadialGradientBrush_GetCenter(IXpsOMRadialGradientBrush *This,
                                    XPS_POINT *center) {
  return This->lpVtbl->GetCenter(This, center);
}
static inline HRESULT
IXpsOMRadialGradientBrush_SetCenter(IXpsOMRadialGradientBrush *This,
                                    const XPS_POINT *center) {
  return This->lpVtbl->SetCenter(This, center);
}
static inline HRESULT
IXpsOMRadialGradientBrush_GetRadiiSizes(IXpsOMRadialGradientBrush *This,
                                        XPS_SIZE *radiiSizes) {
  return This->lpVtbl->GetRadiiSizes(This, radiiSizes);
}
static inline HRESULT
IXpsOMRadialGradientBrush_SetRadiiSizes(IXpsOMRadialGradientBrush *This,
                                        const XPS_SIZE *radiiSizes) {
  return This->lpVtbl->SetRadiiSizes(This, radiiSizes);
}
static inline HRESULT
IXpsOMRadialGradientBrush_GetGradientOrigin(IXpsOMRadialGradientBrush *This,
                                            XPS_POINT *origin) {
  return This->lpVtbl->GetGradientOrigin(This, origin);
}
static inline HRESULT
IXpsOMRadialGradientBrush_SetGradientOrigin(IXpsOMRadialGradientBrush *This,
                                            const XPS_POINT *origin) {
  return This->lpVtbl->SetGradientOrigin(This, origin);
}
static inline HRESULT IXpsOMRadialGradientBrush_Clone(
    IXpsOMRadialGradientBrush *This,
    IXpsOMRadialGradientBrush **radialGradientBrush) {
...
DEFINE_GUID(IID_IXpsOMResource, 0xda2ac0a2, 0x73a2, 0x4975, 0xad, 0x14, 0x74,
            0x09, 0x7c, 0x3f, 0xf3, 0xa5);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("da2ac0a2-73a2-4975-ad14-74097c3ff3a5")
IXpsOMResource : public IXpsOMPart{};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMResource, 0xda2ac0a2, 0x73a2, 0x4975, 0xad, 0x14, 0x74,
                0x09, 0x7c, 0x3f, 0xf3, 0xa5)
#endif
#else
typedef struct IXpsOMResourceVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsOMResource *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IXpsOMResource *This);
  ULONG(STDMETHODCALLTYPE *Release)(IXpsOMResource *This);
  /*** IXpsOMPart methods ***/
  HRESULT(STDMETHODCALLTYPE *GetPartName)(IXpsOMResource *This,
                                          IOpcPartUri **partUri);
  HRESULT(STDMETHODCALLTYPE *SetPartName)(IXpsOMResource *This,
                                          IOpcPartUri *partUri);
  END_INTERFACE
} IXpsOMResourceVtbl;
interface IXpsOMResource { CONST_VTBL IXpsOMResourceVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IXpsOMResource_QueryInterface(IXpsOMResource *This,
                                                    REFIID riid,
                                                    void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IXpsOMPart methods ***/
static inline HRESULT IXpsOMResource_GetPartName(IXpsOMResource *This,
                                                 IOpcPartUri **partUri) {
  return This->lpVtbl->GetPartName(This, partUri);
}
static inline HRESULT IXpsOMResource_SetPartName(IXpsOMResource *This,
                                                 IOpcPartUri *partUri) {
  return This->lpVtbl->SetPartName(This, partUri);
}
#endif
...
DEFINE_GUID(IID_IXpsOMFontResource, 0xa8c45708, 0x47d9, 0x4af4, 0x8d, 0x20,
            0x33, 0xb4, 0x8c, 0x9b, 0x84, 0x85);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("a8c45708-47d9-4af4-8d20-33b48c9b8485")
IXpsOMFontResource : public IXpsOMResource {
  virtual HRESULT STDMETHODCALLTYPE GetStream(IStream * *readerStream) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetContent(
      IStream * sourceStream, XPS_FONT_EMBEDDING embeddingOption,
      IOpcPartUri * partName) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetEmbeddingOption(XPS_FONT_EMBEDDING *
                                                       embeddingOption) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMFontResource, 0xa8c45708, 0x47d9, 0x4af4, 0x8d, 0x20,
                0x33, 0xb4, 0x8c, 0x9b, 0x84, 0x85)
#endif
#else
typedef struct IXpsOMFontResourceVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsOMFontResource *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IXpsOMFontResource *This);
  ULONG(STDMETHODCALLTYPE *Release)(IXpsOMFontResource *This);
  /*** IXpsOMPart methods ***/
  HRESULT(STDMETHODCALLTYPE *GetPartName)(IXpsOMFontResource *This,
                                          IOpcPartUri **partUri);
  HRESULT(STDMETHODCALLTYPE *SetPartName)(IXpsOMFontResource *This,
                                          IOpcPartUri *partUri);
  /*** IXpsOMFontResource methods ***/
  HRESULT(STDMETHODCALLTYPE *GetStream)(IXpsOMFontResource *This,
                                        IStream **readerStream);
  HRESULT(STDMETHODCALLTYPE *SetContent)(IXpsOMFontResource *This,
                                         IStream *sourceStream,
                                         XPS_FONT_EMBEDDING embeddingOption,
                                         IOpcPartUri *partName);
  HRESULT(STDMETHODCALLTYPE *GetEmbeddingOption)(
      IXpsOMFontResource *This, XPS_FONT_EMBEDDING *embeddingOption);
  END_INTERFACE
} IXpsOMFontResourceVtbl;
interface IXpsOMFontResource { CONST_VTBL IXpsOMFontResourceVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define IXpsOMFontResource_SetContent(This, sourceStream, embeddingOption,     \
                                      partName)                                \
...
/*** IUnknown methods ***/
static inline HRESULT
IXpsOMFontResource_QueryInterface(IXpsOMFontResource *This, REFIID riid,
                                  void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IXpsOMPart methods ***/
static inline HRESULT IXpsOMFontResource_GetPartName(IXpsOMFontResource *This,
                                                     IOpcPartUri **partUri) {
  return This->lpVtbl->GetPartName(This, partUri);
}
static inline HRESULT IXpsOMFontResource_SetPartName(IXpsOMFontResource *This,
                                                     IOpcPartUri *partUri) {
  return This->lpVtbl->SetPartName(This, partUri);
}
/*** IXpsOMFontResource methods ***/
static inline HRESULT IXpsOMFontResource_GetStream(IXpsOMFontResource *This,
                                                   IStream **readerStream) {
  return This->lpVtbl->GetStream(This, readerStream);
}
static inline HRESULT
IXpsOMFontResource_SetContent(IXpsOMFontResource *This, IStream *sourceStream,
                              XPS_FONT_EMBEDDING embeddingOption,
                              IOpcPartUri *partName) {
  return This->lpVtbl->SetContent(This, sourceStream, embeddingOption,
                                  partName);
}
static inline HRESULT
IXpsOMFontResource_GetEmbeddingOption(IXpsOMFontResource *This,
                                      XPS_FONT_EMBEDDING *embeddingOption) {
...
DEFINE_GUID(IID_IXpsOMImageResource, 0x3db8417d, 0xae50, 0x485e, 0x9a, 0x44,
            0xd7, 0x75, 0x8f, 0x78, 0xa2, 0x3f);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("3db8417d-ae50-485e-9a44-d7758f78a23f")
IXpsOMImageResource : public IXpsOMResource {
  virtual HRESULT STDMETHODCALLTYPE GetStream(IStream * *readerStream) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetContent(IStream * sourceStream,
                                               XPS_IMAGE_TYPE imageType,
                                               IOpcPartUri * partName) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetImageType(XPS_IMAGE_TYPE *
                                                 imageType) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMImageResource, 0x3db8417d, 0xae50, 0x485e, 0x9a, 0x44,
                0xd7, 0x75, 0x8f, 0x78, 0xa2, 0x3f)
#endif
#else
typedef struct IXpsOMImageResourceVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsOMImageResource *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IXpsOMImageResource *This);
  ULONG(STDMETHODCALLTYPE *Release)(IXpsOMImageResource *This);
  /*** IXpsOMPart methods ***/
  HRESULT(STDMETHODCALLTYPE *GetPartName)(IXpsOMImageResource *This,
                                          IOpcPartUri **partUri);
  HRESULT(STDMETHODCALLTYPE *SetPartName)(IXpsOMImageResource *This,
                                          IOpcPartUri *partUri);
  /*** IXpsOMImageResource methods ***/
  HRESULT(STDMETHODCALLTYPE *GetStream)(IXpsOMImageResource *This,
                                        IStream **readerStream);
  HRESULT(STDMETHODCALLTYPE *SetContent)(IXpsOMImageResource *This,
                                         IStream *sourceStream,
                                         XPS_IMAGE_TYPE imageType,
                                         IOpcPartUri *partName);
  HRESULT(STDMETHODCALLTYPE *GetImageType)(IXpsOMImageResource *This,
                                           XPS_IMAGE_TYPE *imageType);
  END_INTERFACE
} IXpsOMImageResourceVtbl;
interface IXpsOMImageResource { CONST_VTBL IXpsOMImageResourceVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define IXpsOMImageResource_GetStream(This, readerStream)                      \
  (This)->lpVtbl->GetStream(This, readerStream)
#define IXpsOMImageResource_SetContent(This, sourceStream, imageType,          \
                                       partName)                               \
...
/*** IUnknown methods ***/
static inline HRESULT
IXpsOMImageResource_QueryInterface(IXpsOMImageResource *This, REFIID riid,
                                   void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IXpsOMPart methods ***/
static inline HRESULT IXpsOMImageResource_GetPartName(IXpsOMImageResource *This,
                                                      IOpcPartUri **partUri) {
  return This->lpVtbl->GetPartName(This, partUri);
}
static inline HRESULT IXpsOMImageResource_SetPartName(IXpsOMImageResource *This,
                                                      IOpcPartUri *partUri) {
  return This->lpVtbl->SetPartName(This, partUri);
}
/*** IXpsOMImageResource methods ***/
static inline HRESULT IXpsOMImageResource_GetStream(IXpsOMImageResource *This,
                                                    IStream **readerStream) {
  return This->lpVtbl->GetStream(This, readerStream);
}
static inline HRESULT IXpsOMImageResource_SetContent(IXpsOMImageResource *This,
                                                     IStream *sourceStream,
                                                     XPS_IMAGE_TYPE imageType,
                                                     IOpcPartUri *partName) {
...
static inline HRESULT
IXpsOMImageResource_GetImageType(IXpsOMImageResource *This,
                                 XPS_IMAGE_TYPE *imageType) {
...
DEFINE_GUID(IID_IXpsOMColorProfileResource, 0x67bd7d69, 0x1eef, 0x4bb1, 0xb5,
            0xe7, 0x6f, 0x4f, 0x87, 0xbe, 0x8a, 0xbe);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMColorProfileResource, 0x67bd7d69, 0x1eef, 0x4bb1, 0xb5,
                0xe7, 0x6f, 0x4f, 0x87, 0xbe, 0x8a, 0xbe)
#endif
#else
typedef struct IXpsOMColorProfileResourceVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsOMColorProfileResource *This,
                                             REFIID riid, void **ppvObject);
  ...
  /*** IXpsOMPart methods ***/
  HRESULT(STDMETHODCALLTYPE *GetPartName)(IXpsOMColorProfileResource *This,
                                          IOpcPartUri **partUri);
  HRESULT(STDMETHODCALLTYPE *SetPartName)(IXpsOMColorProfileResource *This,
                                          IOpcPartUri *partUri);
  /*** IXpsOMColorProfileResource methods ***/
  HRESULT(STDMETHODCALLTYPE *GetStream)(IXpsOMColorProfileResource *This,
                                        IStream **stream);
  HRESULT(STDMETHODCALLTYPE *SetContent)(IXpsOMColorProfileResource *This,
                                         IStream *sourceStream,
                                         IOpcPartUri *partName);
  END_INTERFACE
...
/*** IUnknown methods ***/
static inline HRESULT
IXpsOMColorProfileResource_QueryInterface(IXpsOMColorProfileResource *This,
                                          REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IXpsOMColorProfileResource_AddRef(IXpsOMColorProfileResource *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IXpsOMColorProfileResource_Release(IXpsOMColorProfileResource *This) {
  return This->lpVtbl->Release(This);
}
/*** IXpsOMPart methods ***/
static inline HRESULT
IXpsOMColorProfileResource_GetPartName(IXpsOMColorProfileResource *This,
                                       IOpcPartUri **partUri) {
  return This->lpVtbl->GetPartName(This, partUri);
}
static inline HRESULT
IXpsOMColorProfileResource_SetPartName(IXpsOMColorProfileResource *This,
                                       IOpcPartUri *partUri) {
  return This->lpVtbl->SetPartName(This, partUri);
}
/*** IXpsOMColorProfileResource methods ***/
static inline HRESULT
IXpsOMColorProfileResource_GetStream(IXpsOMColorProfileResource *This,
                                     IStream **stream) {
  return This->lpVtbl->GetStream(This, stream);
}
static inline HRESULT
IXpsOMColorProfileResource_SetContent(IXpsOMColorProfileResource *This,
                                      IStream *sourceStream,
                                      IOpcPartUri *partName) {
...
DEFINE_GUID(IID_IXpsOMPrintTicketResource, 0xe7ff32d2, 0x34aa, 0x499b, 0xbb,
            0xe9, 0x9c, 0xd4, 0xee, 0x6c, 0x59, 0xf7);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMPrintTicketResource, 0xe7ff32d2, 0x34aa, 0x499b, 0xbb,
                0xe9, 0x9c, 0xd4, 0xee, 0x6c, 0x59, 0xf7)
#endif
#else
typedef struct IXpsOMPrintTicketResourceVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsOMPrintTicketResource *This,
                                             REFIID riid, void **ppvObject);
  ...
  /*** IXpsOMPart methods ***/
  HRESULT(STDMETHODCALLTYPE *GetPartName)(IXpsOMPrintTicketResource *This,
                                          IOpcPartUri **partUri);
  HRESULT(STDMETHODCALLTYPE *SetPartName)(IXpsOMPrintTicketResource *This,
                                          IOpcPartUri *partUri);
  /*** IXpsOMPrintTicketResource methods ***/
  HRESULT(STDMETHODCALLTYPE *GetStream)(IXpsOMPrintTicketResource *This,
                                        IStream **stream);
  HRESULT(STDMETHODCALLTYPE *SetContent)(IXpsOMPrintTicketResource *This,
                                         IStream *sourceStream,
                                         IOpcPartUri *partName);
  END_INTERFACE
...
/*** IUnknown methods ***/
static inline HRESULT
IXpsOMPrintTicketResource_QueryInterface(IXpsOMPrintTicketResource *This,
                                         REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IXpsOMPrintTicketResource_AddRef(IXpsOMPrintTicketResource *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IXpsOMPrintTicketResource_Release(IXpsOMPrintTicketResource *This) {
  return This->lpVtbl->Release(This);
}
/*** IXpsOMPart methods ***/
static inline HRESULT
IXpsOMPrintTicketResource_GetPartName(IXpsOMPrintTicketResource *This,
                                      IOpcPartUri **partUri) {
  return This->lpVtbl->GetPartName(This, partUri);
}
static inline HRESULT
IXpsOMPrintTicketResource_SetPartName(IXpsOMPrintTicketResource *This,
                                      IOpcPartUri *partUri) {
  return This->lpVtbl->SetPartName(This, partUri);
}
/*** IXpsOMPrintTicketResource methods ***/
static inline HRESULT
IXpsOMPrintTicketResource_GetStream(IXpsOMPrintTicketResource *This,
                                    IStream **stream) {
  return This->lpVtbl->GetStream(This, stream);
}
static inline HRESULT
IXpsOMPrintTicketResource_SetContent(IXpsOMPrintTicketResource *This,
                                     IStream *sourceStream,
                                     IOpcPartUri *partName) {
  return This->lpVtbl->SetContent(This, sourceStream, partName);
}
...
DEFINE_GUID(IID_IXpsOMRemoteDictionaryResource, 0xc9bd7cd4, 0xe16a, 0x4bf8,
            0x8c, 0x84, 0xc9, 0x50, 0xaf, 0x7a, 0x30, 0x61);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("c9bd7cd4-e16a-4bf8-8c84-c950af7a3061")
IXpsOMRemoteDictionaryResource : public IXpsOMResource {
  virtual HRESULT STDMETHODCALLTYPE GetDictionary(IXpsOMDictionary *
                                                  *dictionary) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetDictionary(IXpsOMDictionary *
                                                  dictionary) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMRemoteDictionaryResource, 0xc9bd7cd4, 0xe16a, 0x4bf8,
                0x8c, 0x84, 0xc9, 0x50, 0xaf, 0x7a, 0x30, 0x61)
#endif
#else
typedef struct IXpsOMRemoteDictionaryResourceVtbl {
  ...
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(
      IXpsOMRemoteDictionaryResource *This, REFIID riid, void **ppvObject);
  ...
  /*** IXpsOMPart methods ***/
  HRESULT(STDMETHODCALLTYPE *GetPartName)(IXpsOMRemoteDictionaryResource *This,
                                          IOpcPartUri **partUri);
  HRESULT(STDMETHODCALLTYPE *SetPartName)(IXpsOMRemoteDictionaryResource *This,
                                          IOpcPartUri *partUri);
  /*** IXpsOMRemoteDictionaryResource methods ***/
  HRESULT(STDMETHODCALLTYPE *GetDictionary)(
      IXpsOMRemoteDictionaryResource *This, IXpsOMDictionary **dictionary);
...
#else
/*** IUnknown methods ***/
static inline HRESULT IXpsOMRemoteDictionaryResource_QueryInterface(
    IXpsOMRemoteDictionaryResource *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IXpsOMRemoteDictionaryResource_AddRef(IXpsOMRemoteDictionaryResource *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IXpsOMRemoteDictionaryResource_Release(IXpsOMRemoteDictionaryResource *This) {
  return This->lpVtbl->Release(This);
}
/*** IXpsOMPart methods ***/
static inline HRESULT
IXpsOMRemoteDictionaryResource_GetPartName(IXpsOMRemoteDictionaryResource *This,
                                           IOpcPartUri **partUri) {
  return This->lpVtbl->GetPartName(This, partUri);
}
static inline HRESULT
IXpsOMRemoteDictionaryResource_SetPartName(IXpsOMRemoteDictionaryResource *This,
                                           IOpcPartUri *partUri) {
  return This->lpVtbl->SetPartName(This, partUri);
}
/*** IXpsOMRemoteDictionaryResource methods ***/
static inline HRESULT IXpsOMRemoteDictionaryResource_GetDictionary(
    IXpsOMRemoteDictionaryResource *This, IXpsOMDictionary **dictionary) {
  return This->lpVtbl->GetDictionary(This, dictionary);
}
static inline HRESULT IXpsOMRemoteDictionaryResource_SetDictionary(
    IXpsOMRemoteDictionaryResource *This, IXpsOMDictionary *dictionary) {
...
DEFINE_GUID(IID_IXpsOMDocumentStructureResource, 0x85febc8a, 0x6b63, 0x48a9,
            0xaf, 0x07, 0x70, 0x64, 0xe4, 0xec, 0xff, 0x30);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("85febc8a-6b63-48a9-af07-7064e4ecff30")
IXpsOMDocumentStructureResource : public IXpsOMResource {
  virtual HRESULT STDMETHODCALLTYPE GetOwner(IXpsOMDocument * *owner) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetStream(IStream * *stream) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetContent(IStream * sourceStream,
                                               IOpcPartUri * partName) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMDocumentStructureResource, 0x85febc8a, 0x6b63, 0x48a9,
                0xaf, 0x07, 0x70, 0x64, 0xe4, 0xec, 0xff, 0x30)
#endif
#else
typedef struct IXpsOMDocumentStructureResourceVtbl {
  ...
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(
      IXpsOMDocumentStructureResource *This, REFIID riid, void **ppvObject);
  ...
  /*** IXpsOMPart methods ***/
  HRESULT(STDMETHODCALLTYPE *GetPartName)(IXpsOMDocumentStructureResource *This,
                                          IOpcPartUri **partUri);
  HRESULT(STDMETHODCALLTYPE *SetPartName)(IXpsOMDocumentStructureResource *This,
                                          IOpcPartUri *partUri);
  /*** IXpsOMDocumentStructureResource methods ***/
  HRESULT(STDMETHODCALLTYPE *GetOwner)(IXpsOMDocumentStructureResource *This,
                                       IXpsOMDocument **owner);
  HRESULT(STDMETHODCALLTYPE *GetStream)(IXpsOMDocumentStructureResource *This,
                                        IStream **stream);
  HRESULT(STDMETHODCALLTYPE *SetContent)(IXpsOMDocumentStructureResource *This,
                                         IStream *sourceStream,
                                         IOpcPartUri *partName);
  END_INTERFACE
...
#define IXpsOMDocumentStructureResource_GetStream(This, stream)                \
  (This)->lpVtbl->GetStream(This, stream)
#define IXpsOMDocumentStructureResource_SetContent(This, sourceStream,         \
                                                   partName)                   \
  (This)->lpVtbl->SetContent(This, sourceStream, partName)
#else
/*** IUnknown methods ***/
static inline HRESULT IXpsOMDocumentStructureResource_QueryInterface(
    IXpsOMDocumentStructureResource *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IXpsOMDocumentStructureResource_AddRef(IXpsOMDocumentStructureResource *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IXpsOMDocumentStructureResource_Release(IXpsOMDocumentStructureResource *This) {
  return This->lpVtbl->Release(This);
}
/*** IXpsOMPart methods ***/
static inline HRESULT IXpsOMDocumentStructureResource_GetPartName(
    IXpsOMDocumentStructureResource *This, IOpcPartUri **partUri) {
  return This->lpVtbl->GetPartName(This, partUri);
}
static inline HRESULT IXpsOMDocumentStructureResource_SetPartName(
    IXpsOMDocumentStructureResource *This, IOpcPartUri *partUri) {
  return This->lpVtbl->SetPartName(This, partUri);
}
/*** IXpsOMDocumentStructureResource methods ***/
static inline HRESULT
IXpsOMDocumentStructureResource_GetOwner(IXpsOMDocumentStructureResource *This,
                                         IXpsOMDocument **owner) {
  return This->lpVtbl->GetOwner(This, owner);
}
static inline HRESULT
IXpsOMDocumentStructureResource_GetStream(IXpsOMDocumentStructureResource *This,
                                          IStream **stream) {
  return This->lpVtbl->GetStream(This, stream);
}
static inline HRESULT IXpsOMDocumentStructureResource_SetContent(
    IXpsOMDocumentStructureResource *This, IStream *sourceStream,
    IOpcPartUri *partName) {
  return This->lpVtbl->SetContent(This, sourceStream, partName);
}
#endif
...
DEFINE_GUID(IID_IXpsOMStoryFragmentsResource, 0xc2b3ca09, 0x0473, 0x4282, 0x87,
            0xae, 0x17, 0x80, 0x86, 0x32, 0x23, 0xf0);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("c2b3ca09-0473-4282-87ae-1780863223f0")
IXpsOMStoryFragmentsResource : public IXpsOMResource {
  virtual HRESULT STDMETHODCALLTYPE GetOwner(IXpsOMPageReference * *owner) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetStream(IStream * *stream) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetContent(IStream * sourceStream,
                                               IOpcPartUri * partName) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMStoryFragmentsResource, 0xc2b3ca09, 0x0473, 0x4282, 0x87,
                0xae, 0x17, 0x80, 0x86, 0x32, 0x23, 0xf0)
#endif
#else
typedef struct IXpsOMStoryFragmentsResourceVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsOMStoryFragmentsResource *This,
                                             REFIID riid, void **ppvObject);
  ...
  /*** IXpsOMPart methods ***/
  HRESULT(STDMETHODCALLTYPE *GetPartName)(IXpsOMStoryFragmentsResource *This,
                                          IOpcPartUri **partUri);
  HRESULT(STDMETHODCALLTYPE *SetPartName)(IXpsOMStoryFragmentsResource *This,
                                          IOpcPartUri *partUri);
  /*** IXpsOMStoryFragmentsResource methods ***/
  HRESULT(STDMETHODCALLTYPE *GetOwner)(IXpsOMStoryFragmentsResource *This,
                                       IXpsOMPageReference **owner);
  HRESULT(STDMETHODCALLTYPE *GetStream)(IXpsOMStoryFragmentsResource *This,
                                        IStream **stream);
  HRESULT(STDMETHODCALLTYPE *SetContent)(IXpsOMStoryFragmentsResource *This,
                                         IStream *sourceStream,
                                         IOpcPartUri *partName);
  END_INTERFACE
...
/*** IUnknown methods ***/
static inline HRESULT
IXpsOMStoryFragmentsResource_QueryInterface(IXpsOMStoryFragmentsResource *This,
                                            REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IXpsOMStoryFragmentsResource_AddRef(IXpsOMStoryFragmentsResource *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IXpsOMStoryFragmentsResource_Release(IXpsOMStoryFragmentsResource *This) {
  return This->lpVtbl->Release(This);
}
/*** IXpsOMPart methods ***/
static inline HRESULT
IXpsOMStoryFragmentsResource_GetPartName(IXpsOMStoryFragmentsResource *This,
                                         IOpcPartUri **partUri) {
  return This->lpVtbl->GetPartName(This, partUri);
}
static inline HRESULT
IXpsOMStoryFragmentsResource_SetPartName(IXpsOMStoryFragmentsResource *This,
                                         IOpcPartUri *partUri) {
  return This->lpVtbl->SetPartName(This, partUri);
}
/*** IXpsOMStoryFragmentsResource methods ***/
static inline HRESULT
IXpsOMStoryFragmentsResource_GetOwner(IXpsOMStoryFragmentsResource *This,
                                      IXpsOMPageReference **owner) {
  return This->lpVtbl->GetOwner(This, owner);
}
static inline HRESULT
IXpsOMStoryFragmentsResource_GetStream(IXpsOMStoryFragmentsResource *This,
                                       IStream **stream) {
  return This->lpVtbl->GetStream(This, stream);
}
static inline HRESULT
IXpsOMStoryFragmentsResource_SetContent(IXpsOMStoryFragmentsResource *This,
                                        IStream *sourceStream,
                                        IOpcPartUri *partName) {
  return This->lpVtbl->SetContent(This, sourceStream, partName);
}
...
DEFINE_GUID(IID_IXpsOMSignatureBlockResource, 0x4776ad35, 0x2e04, 0x4357, 0x87,
            0x43, 0xeb, 0xf6, 0xc1, 0x71, 0xa9, 0x05);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMSignatureBlockResource, 0x4776ad35, 0x2e04, 0x4357, 0x87,
                0x43, 0xeb, 0xf6, 0xc1, 0x71, 0xa9, 0x05)
#endif
#else
typedef struct IXpsOMSignatureBlockResourceVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsOMSignatureBlockResource *This,
                                             REFIID riid, void **ppvObject);
  ...
  /*** IXpsOMPart methods ***/
  HRESULT(STDMETHODCALLTYPE *GetPartName)(IXpsOMSignatureBlockResource *This,
                                          IOpcPartUri **partUri);
  HRESULT(STDMETHODCALLTYPE *SetPartName)(IXpsOMSignatureBlockResource *This,
                                          IOpcPartUri *partUri);
  /*** IXpsOMSignatureBlockResource methods ***/
  HRESULT(STDMETHODCALLTYPE *GetOwner)(IXpsOMSignatureBlockResource *This,
                                       IXpsOMDocument **owner);
  HRESULT(STDMETHODCALLTYPE *GetStream)(IXpsOMSignatureBlockResource *This,
                                        IStream **stream);
  HRESULT(STDMETHODCALLTYPE *SetContent)(IXpsOMSignatureBlockResource *This,
                                         IStream *sourceStream,
                                         IOpcPartUri *partName);
  END_INTERFACE
...
/*** IUnknown methods ***/
static inline HRESULT
IXpsOMSignatureBlockResource_QueryInterface(IXpsOMSignatureBlockResource *This,
                                            REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IXpsOMSignatureBlockResource_AddRef(IXpsOMSignatureBlockResource *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IXpsOMSignatureBlockResource_Release(IXpsOMSignatureBlockResource *This) {
  return This->lpVtbl->Release(This);
}
/*** IXpsOMPart methods ***/
static inline HRESULT
IXpsOMSignatureBlockResource_GetPartName(IXpsOMSignatureBlockResource *This,
                                         IOpcPartUri **partUri) {
  return This->lpVtbl->GetPartName(This, partUri);
}
static inline HRESULT
IXpsOMSignatureBlockResource_SetPartName(IXpsOMSignatureBlockResource *This,
                                         IOpcPartUri *partUri) {
  return This->lpVtbl->SetPartName(This, partUri);
}
/*** IXpsOMSignatureBlockResource methods ***/
static inline HRESULT
IXpsOMSignatureBlockResource_GetOwner(IXpsOMSignatureBlockResource *This,
                                      IXpsOMDocument **owner) {
  return This->lpVtbl->GetOwner(This, owner);
}
static inline HRESULT
IXpsOMSignatureBlockResource_GetStream(IXpsOMSignatureBlockResource *This,
                                       IStream **stream) {
  return This->lpVtbl->GetStream(This, stream);
}
static inline HRESULT
IXpsOMSignatureBlockResource_SetContent(IXpsOMSignatureBlockResource *This,
                                        IStream *sourceStream,
                                        IOpcPartUri *partName) {
  return This->lpVtbl->SetContent(This, sourceStream, partName);
}
...
DEFINE_GUID(IID_IXpsOMCanvas, 0x221d1452, 0x331e, 0x47c6, 0x87, 0xe9, 0x6c,
            0xce, 0xfb, 0x9b, 0x5b, 0xa3);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("221d1452-331e-47c6-87e9-6ccefb9b5ba3")
IXpsOMCanvas : public IXpsOMVisual {
  virtual HRESULT STDMETHODCALLTYPE GetVisuals(IXpsOMVisualCollection *
                                               *visuals) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetDictionaryLocal(IXpsOMDictionary *
                                                       *resourceDictionary) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetDictionaryLocal(IXpsOMDictionary *
                                                       resourceDictionary) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetDictionaryResource(
      IXpsOMRemoteDictionaryResource * *remoteDictionaryResource) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetDictionaryResource(
      IXpsOMRemoteDictionaryResource * remoteDictionaryResource) = 0;
  virtual HRESULT STDMETHODCALLTYPE Clone(IXpsOMCanvas * *canvas) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMCanvas, 0x221d1452, 0x331e, 0x47c6, 0x87, 0xe9, 0x6c,
                0xce, 0xfb, 0x9b, 0x5b, 0xa3)
#endif
#else
typedef struct IXpsOMCanvasVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsOMCanvas *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetType)(IXpsOMCanvas *This,
                                      XPS_OBJECT_TYPE *type);
  /*** IXpsOMVisual methods ***/
  HRESULT(STDMETHODCALLTYPE *GetTransform)(
  ...
  HRESULT(STDMETHODCALLTYPE *SetTransformLocal)(
      IXpsOMCanvas *This, IXpsOMMatrixTransform *matrixTransform);
  HRESULT(STDMETHODCALLTYPE *GetTransformLookup)(IXpsOMCanvas *This,
                                                 LPWSTR *key);
  HRESULT(STDMETHODCALLTYPE *SetTransformLookup)(IXpsOMCanvas *This,
                                                 LPCWSTR key);
  HRESULT(STDMETHODCALLTYPE *GetClipGeometry)(IXpsOMCanvas *This,
                                              IXpsOMGeometry **clipGeometry);
  HRESULT(STDMETHODCALLTYPE *GetClipGeometryLocal)(
      IXpsOMCanvas *This, IXpsOMGeometry **clipGeometry);
  HRESULT(STDMETHODCALLTYPE *SetClipGeometryLocal)(
      IXpsOMCanvas *This, IXpsOMGeometry *clipGeometry);
  HRESULT(STDMETHODCALLTYPE *GetClipGeometryLookup)(IXpsOMCanvas *This,
                                                    LPWSTR *key);
  HRESULT(STDMETHODCALLTYPE *SetClipGeometryLookup)(IXpsOMCanvas *This,
                                                    LPCWSTR key);
  ...
  HRESULT(STDMETHODCALLTYPE *GetOpacityMaskBrush)(
      IXpsOMCanvas *This, IXpsOMBrush **opacityMaskBrush);
  HRESULT(STDMETHODCALLTYPE *GetOpacityMaskBrushLocal)(
      IXpsOMCanvas *This, IXpsOMBrush **opacityMaskBrush);
  HRESULT(STDMETHODCALLTYPE *SetOpacityMaskBrushLocal)(
      IXpsOMCanvas *This, IXpsOMBrush *opacityMaskBrush);
  HRESULT(STDMETHODCALLTYPE *GetOpacityMaskBrushLookup)(IXpsOMCanvas *This,
                                                        LPWSTR *key);
  HRESULT(STDMETHODCALLTYPE *SetOpacityMaskBrushLookup)(IXpsOMCanvas *This,
                                                        LPCWSTR key);
  ...
  HRESULT(STDMETHODCALLTYPE *GetIsHyperlinkTarget)(IXpsOMCanvas *This,
                                                   WINBOOL *isHyperlink);
  HRESULT(STDMETHODCALLTYPE *SetIsHyperlinkTarget)(IXpsOMCanvas *This,
                                                   WINBOOL isHyperlink);
  HRESULT(STDMETHODCALLTYPE *GetHyperlinkNavigateUri)(IXpsOMCanvas *This,
                                                      IUri **hyperlinkUri);
  HRESULT(STDMETHODCALLTYPE *SetHyperlinkNavigateUri)(IXpsOMCanvas *This,
                                                      IUri *hyperlinkUri);
  ...
  HRESULT(STDMETHODCALLTYPE *GetVisuals)(IXpsOMCanvas *This,
                                         IXpsOMVisualCollection **visuals);
  HRESULT(STDMETHODCALLTYPE *GetUseAliasedEdgeMode)(
      IXpsOMCanvas *This, WINBOOL *useAliasedEdgeMode);
  HRESULT(STDMETHODCALLTYPE *SetUseAliasedEdgeMode)(IXpsOMCanvas *This,
                                                    WINBOOL useAliasedEdgeMode);
  HRESULT(STDMETHODCALLTYPE *GetAccessibilityShortDescription)(
      IXpsOMCanvas *This, LPWSTR *shortDescription);
  HRESULT(STDMETHODCALLTYPE *SetAccessibilityShortDescription)(
      IXpsOMCanvas *This, LPCWSTR shortDescription);
  HRESULT(STDMETHODCALLTYPE *GetAccessibilityLongDescription)(
      IXpsOMCanvas *This, LPWSTR *longDescription);
  HRESULT(STDMETHODCALLTYPE *SetAccessibilityLongDescription)(
      IXpsOMCanvas *This, LPCWSTR longDescription);
  HRESULT(STDMETHODCALLTYPE *GetDictionary)(
      IXpsOMCanvas *This, IXpsOMDictionary **resourceDictionary);
...
interface IXpsOMCanvas { CONST_VTBL IXpsOMCanvasVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
IXpsOMCanvas_QueryInterface(IXpsOMCanvas *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IXpsOMShareable methods ***/
static inline HRESULT IXpsOMCanvas_GetOwner(IXpsOMCanvas *This,
                                            IUnknown **owner) {
  return This->lpVtbl->GetOwner(This, owner);
}
static inline HRESULT IXpsOMCanvas_GetType(IXpsOMCanvas *This,
                                           XPS_OBJECT_TYPE *type) {
  return This->lpVtbl->GetType(This, type);
}
/*** IXpsOMVisual methods ***/
static inline HRESULT
IXpsOMCanvas_GetTransform(IXpsOMCanvas *This,
                          IXpsOMMatrixTransform **matrixTransform) {
  return This->lpVtbl->GetTransform(This, matrixTransform);
}
static inline HRESULT
IXpsOMCanvas_GetTransformLocal(IXpsOMCanvas *This,
                               IXpsOMMatrixTransform **matrixTransform) {
  return This->lpVtbl->GetTransformLocal(This, matrixTransform);
}
static inline HRESULT
IXpsOMCanvas_SetTransformLocal(IXpsOMCanvas *This,
                               IXpsOMMatrixTransform *matrixTransform) {
  return This->lpVtbl->SetTransformLocal(This, matrixTransform);
}
static inline HRESULT IXpsOMCanvas_GetTransformLookup(IXpsOMCanvas *This,
                                                      LPWSTR *key) {
  return This->lpVtbl->GetTransformLookup(This, key);
}
static inline HRESULT IXpsOMCanvas_SetTransformLookup(IXpsOMCanvas *This,
                                                      LPCWSTR key) {
  return This->lpVtbl->SetTransformLookup(This, key);
}
static inline HRESULT
IXpsOMCanvas_GetClipGeometry(IXpsOMCanvas *This,
                             IXpsOMGeometry **clipGeometry) {
  return This->lpVtbl->GetClipGeometry(This, clipGeometry);
}
static inline HRESULT
IXpsOMCanvas_GetClipGeometryLocal(IXpsOMCanvas *This,
                                  IXpsOMGeometry **clipGeometry) {
  return This->lpVtbl->GetClipGeometryLocal(This, clipGeometry);
}
static inline HRESULT
IXpsOMCanvas_SetClipGeometryLocal(IXpsOMCanvas *This,
                                  IXpsOMGeometry *clipGeometry) {
  return This->lpVtbl->SetClipGeometryLocal(This, clipGeometry);
}
static inline HRESULT IXpsOMCanvas_GetClipGeometryLookup(IXpsOMCanvas *This,
                                                         LPWSTR *key) {
  return This->lpVtbl->GetClipGeometryLookup(This, key);
}
static inline HRESULT IXpsOMCanvas_SetClipGeometryLookup(IXpsOMCanvas *This,
                                                         LPCWSTR key) {
  return This->lpVtbl->SetClipGeometryLookup(This, key);
}
static inline HRESULT IXpsOMCanvas_GetOpacity(IXpsOMCanvas *This,
                                              FLOAT *opacity) {
  return This->lpVtbl->GetOpacity(This, opacity);
}
static inline HRESULT IXpsOMCanvas_SetOpacity(IXpsOMCanvas *This,
                                              FLOAT opacity) {
  return This->lpVtbl->SetOpacity(This, opacity);
}
static inline HRESULT
IXpsOMCanvas_GetOpacityMaskBrush(IXpsOMCanvas *This,
                                 IXpsOMBrush **opacityMaskBrush) {
  return This->lpVtbl->GetOpacityMaskBrush(This, opacityMaskBrush);
}
static inline HRESULT
IXpsOMCanvas_GetOpacityMaskBrushLocal(IXpsOMCanvas *This,
                                      IXpsOMBrush **opacityMaskBrush) {
  return This->lpVtbl->GetOpacityMaskBrushLocal(This, opacityMaskBrush);
}
static inline HRESULT
IXpsOMCanvas_SetOpacityMaskBrushLocal(IXpsOMCanvas *This,
                                      IXpsOMBrush *opacityMaskBrush) {
  return This->lpVtbl->SetOpacityMaskBrushLocal(This, opacityMaskBrush);
}
static inline HRESULT IXpsOMCanvas_GetOpacityMaskBrushLookup(IXpsOMCanvas *This,
                                                             LPWSTR *key) {
  return This->lpVtbl->GetOpacityMaskBrushLookup(This, key);
}
static inline HRESULT IXpsOMCanvas_SetOpacityMaskBrushLookup(IXpsOMCanvas *This,
                                                             LPCWSTR key) {
  return This->lpVtbl->SetOpacityMaskBrushLookup(This, key);
}
...
static inline HRESULT IXpsOMCanvas_GetIsHyperlinkTarget(IXpsOMCanvas *This,
                                                        WINBOOL *isHyperlink) {
  return This->lpVtbl->GetIsHyperlinkTarget(This, isHyperlink);
}
static inline HRESULT IXpsOMCanvas_SetIsHyperlinkTarget(IXpsOMCanvas *This,
                                                        WINBOOL isHyperlink) {
  return This->lpVtbl->SetIsHyperlinkTarget(This, isHyperlink);
}
static inline HRESULT
IXpsOMCanvas_GetHyperlinkNavigateUri(IXpsOMCanvas *This, IUri **hyperlinkUri) {
  return This->lpVtbl->GetHyperlinkNavigateUri(This, hyperlinkUri);
}
static inline HRESULT IXpsOMCanvas_SetHyperlinkNavigateUri(IXpsOMCanvas *This,
                                                           IUri *hyperlinkUri) {
  return This->lpVtbl->SetHyperlinkNavigateUri(This, hyperlinkUri);
}
static inline HRESULT IXpsOMCanvas_GetLanguage(IXpsOMCanvas *This,
                                               LPWSTR *language) {
  return This->lpVtbl->GetLanguage(This, language);
}
static inline HRESULT IXpsOMCanvas_SetLanguage(IXpsOMCanvas *This,
                                               LPCWSTR language) {
  return This->lpVtbl->SetLanguage(This, language);
}
/*** IXpsOMCanvas methods ***/
static inline HRESULT
IXpsOMCanvas_GetVisuals(IXpsOMCanvas *This, IXpsOMVisualCollection **visuals) {
  return This->lpVtbl->GetVisuals(This, visuals);
}
static inline HRESULT
IXpsOMCanvas_GetUseAliasedEdgeMode(IXpsOMCanvas *This,
                                   WINBOOL *useAliasedEdgeMode) {
  return This->lpVtbl->GetUseAliasedEdgeMode(This, useAliasedEdgeMode);
}
static inline HRESULT
IXpsOMCanvas_SetUseAliasedEdgeMode(IXpsOMCanvas *This,
                                   WINBOOL useAliasedEdgeMode) {
  return This->lpVtbl->SetUseAliasedEdgeMode(This, useAliasedEdgeMode);
}
static inline HRESULT
IXpsOMCanvas_GetAccessibilityShortDescription(IXpsOMCanvas *This,
                                              LPWSTR *shortDescription) {
  return This->lpVtbl->GetAccessibilityShortDescription(This, shortDescription);
}
static inline HRESULT
IXpsOMCanvas_SetAccessibilityShortDescription(IXpsOMCanvas *This,
                                              LPCWSTR shortDescription) {
  return This->lpVtbl->SetAccessibilityShortDescription(This, shortDescription);
}
static inline HRESULT
IXpsOMCanvas_GetAccessibilityLongDescription(IXpsOMCanvas *This,
                                             LPWSTR *longDescription) {
  return This->lpVtbl->GetAccessibilityLongDescription(This, longDescription);
}
static inline HRESULT
IXpsOMCanvas_SetAccessibilityLongDescription(IXpsOMCanvas *This,
                                             LPCWSTR longDescription) {
  return This->lpVtbl->SetAccessibilityLongDescription(This, longDescription);
}
static inline HRESULT
IXpsOMCanvas_GetDictionary(IXpsOMCanvas *This,
                           IXpsOMDictionary **resourceDictionary) {
  return This->lpVtbl->GetDictionary(This, resourceDictionary);
}
static inline HRESULT
IXpsOMCanvas_GetDictionaryLocal(IXpsOMCanvas *This,
                                IXpsOMDictionary **resourceDictionary) {
  return This->lpVtbl->GetDictionaryLocal(This, resourceDictionary);
}
static inline HRESULT
IXpsOMCanvas_SetDictionaryLocal(IXpsOMCanvas *This,
                                IXpsOMDictionary *resourceDictionary) {
  return This->lpVtbl->SetDictionaryLocal(This, resourceDictionary);
}
static inline HRESULT IXpsOMCanvas_GetDictionaryResource(
    IXpsOMCanvas *This,
    IXpsOMRemoteDictionaryResource **remoteDictionaryResource) {
  return This->lpVtbl->GetDictionaryResource(This, remoteDictionaryResource);
}
static inline HRESULT IXpsOMCanvas_SetDictionaryResource(
    IXpsOMCanvas *This,
    IXpsOMRemoteDictionaryResource *remoteDictionaryResource) {
  return This->lpVtbl->SetDictionaryResource(This, remoteDictionaryResource);
}
static inline HRESULT IXpsOMCanvas_Clone(IXpsOMCanvas *This,
                                         IXpsOMCanvas **canvas) {
...
DEFINE_GUID(IID_IXpsOMPage, 0xd3e18888, 0xf120, 0x4fee, 0x8c, 0x68, 0x35, 0x29,
            0x6e, 0xae, 0x91, 0xd4);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("d3e18888-f120-4fee-8c68-35296eae91d4")
IXpsOMPage : public IXpsOMPart {
  virtual HRESULT STDMETHODCALLTYPE GetOwner(IXpsOMPageReference *
                                             *pageReference) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetVisuals(IXpsOMVisualCollection *
                                               *visuals) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetPageDimensions(XPS_SIZE *
                                                      pageDimensions) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetPageDimensions(
      const XPS_SIZE *pageDimensions) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetContentBox(XPS_RECT * contentBox) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetContentBox(
      const XPS_RECT *contentBox) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetBleedBox(XPS_RECT * bleedBox) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetBleedBox(const XPS_RECT *bleedBox) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetLanguage(LPWSTR * language) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetLanguage(LPCWSTR language) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetName(LPWSTR * name) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetName(LPCWSTR name) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE SetDictionaryResource(
      IXpsOMRemoteDictionaryResource * remoteDictionaryResource) = 0;
  virtual HRESULT STDMETHODCALLTYPE Write(ISequentialStream * stream,
                                          WINBOOL optimizeMarkupSize) = 0;
  virtual HRESULT STDMETHODCALLTYPE GenerateUnusedLookupKey(
      XPS_OBJECT_TYPE type, LPWSTR * key) = 0;
  virtual HRESULT STDMETHODCALLTYPE Clone(IXpsOMPage * *page) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMPage, 0xd3e18888, 0xf120, 0x4fee, 0x8c, 0x68, 0x35, 0x29,
                0x6e, 0xae, 0x91, 0xd4)
#endif
#else
typedef struct IXpsOMPageVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsOMPage *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IXpsOMPage *This);
  ULONG(STDMETHODCALLTYPE *Release)(IXpsOMPage *This);
  /*** IXpsOMPart methods ***/
  HRESULT(STDMETHODCALLTYPE *GetPartName)(IXpsOMPage *This,
                                          IOpcPartUri **partUri);
  HRESULT(STDMETHODCALLTYPE *SetPartName)(IXpsOMPage *This,
                                          IOpcPartUri *partUri);
  /*** IXpsOMPage methods ***/
  HRESULT(STDMETHODCALLTYPE *GetOwner)(IXpsOMPage *This,
                                       IXpsOMPageReference **pageReference);
  HRESULT(STDMETHODCALLTYPE *GetVisuals)(IXpsOMPage *This,
                                         IXpsOMVisualCollection **visuals);
  HRESULT(STDMETHODCALLTYPE *GetPageDimensions)(IXpsOMPage *This,
                                                XPS_SIZE *pageDimensions);
  HRESULT(STDMETHODCALLTYPE *SetPageDimensions)(IXpsOMPage *This,
                                                const XPS_SIZE *pageDimensions);
  HRESULT(STDMETHODCALLTYPE *GetContentBox)(IXpsOMPage *This,
                                            XPS_RECT *contentBox);
  HRESULT(STDMETHODCALLTYPE *SetContentBox)(IXpsOMPage *This,
                                            const XPS_RECT *contentBox);
  HRESULT(STDMETHODCALLTYPE *GetBleedBox)(IXpsOMPage *This, XPS_RECT *bleedBox);
  HRESULT(STDMETHODCALLTYPE *SetBleedBox)(IXpsOMPage *This,
  ...
  HRESULT(STDMETHODCALLTYPE *GetIsHyperlinkTarget)(IXpsOMPage *This,
                                                   WINBOOL *isHyperlinkTarget);
  HRESULT(STDMETHODCALLTYPE *SetIsHyperlinkTarget)(IXpsOMPage *This,
                                                   WINBOOL isHyperlinkTarget);
  HRESULT(STDMETHODCALLTYPE *GetDictionary)(
      IXpsOMPage *This, IXpsOMDictionary **resourceDictionary);
  HRESULT(STDMETHODCALLTYPE *GetDictionaryLocal)(
      IXpsOMPage *This, IXpsOMDictionary **resourceDictionary);
  HRESULT(STDMETHODCALLTYPE *SetDictionaryLocal)(
      IXpsOMPage *This, IXpsOMDictionary *resourceDictionary);
  ...
  HRESULT(STDMETHODCALLTYPE *SetDictionaryResource)(
      IXpsOMPage *This,
      IXpsOMRemoteDictionaryResource *remoteDictionaryResource);
  HRESULT(STDMETHODCALLTYPE *Write)(IXpsOMPage *This, ISequentialStream *stream,
                                    WINBOOL optimizeMarkupSize);
  HRESULT(STDMETHODCALLTYPE *GenerateUnusedLookupKey)(IXpsOMPage *This,
                                                      XPS_OBJECT_TYPE type,
                                                      LPWSTR *key);
  HRESULT(STDMETHODCALLTYPE *Clone)(IXpsOMPage *This, IXpsOMPage **page);
  END_INTERFACE
} IXpsOMPageVtbl;
interface IXpsOMPage { CONST_VTBL IXpsOMPageVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IXpsOMPage_QueryInterface(IXpsOMPage *This, REFIID riid,
                                                void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IXpsOMPart methods ***/
static inline HRESULT IXpsOMPage_GetPartName(IXpsOMPage *This,
                                             IOpcPartUri **partUri) {
  return This->lpVtbl->GetPartName(This, partUri);
}
static inline HRESULT IXpsOMPage_SetPartName(IXpsOMPage *This,
                                             IOpcPartUri *partUri) {
  return This->lpVtbl->SetPartName(This, partUri);
}
/*** IXpsOMPage methods ***/
static inline HRESULT IXpsOMPage_GetOwner(IXpsOMPage *This,
                                          IXpsOMPageReference **pageReference) {
  return This->lpVtbl->GetOwner(This, pageReference);
}
static inline HRESULT IXpsOMPage_GetVisuals(IXpsOMPage *This,
                                            IXpsOMVisualCollection **visuals) {
  return This->lpVtbl->GetVisuals(This, visuals);
}
static inline HRESULT IXpsOMPage_GetPageDimensions(IXpsOMPage *This,
                                                   XPS_SIZE *pageDimensions) {
  return This->lpVtbl->GetPageDimensions(This, pageDimensions);
}
static inline HRESULT
IXpsOMPage_SetPageDimensions(IXpsOMPage *This, const XPS_SIZE *pageDimensions) {
  return This->lpVtbl->SetPageDimensions(This, pageDimensions);
}
static inline HRESULT IXpsOMPage_GetContentBox(IXpsOMPage *This,
                                               XPS_RECT *contentBox) {
  return This->lpVtbl->GetContentBox(This, contentBox);
}
static inline HRESULT IXpsOMPage_SetContentBox(IXpsOMPage *This,
                                               const XPS_RECT *contentBox) {
  return This->lpVtbl->SetContentBox(This, contentBox);
}
static inline HRESULT IXpsOMPage_GetBleedBox(IXpsOMPage *This,
                                             XPS_RECT *bleedBox) {
  return This->lpVtbl->GetBleedBox(This, bleedBox);
}
static inline HRESULT IXpsOMPage_SetBleedBox(IXpsOMPage *This,
                                             const XPS_RECT *bleedBox) {
  return This->lpVtbl->SetBleedBox(This, bleedBox);
}
static inline HRESULT IXpsOMPage_GetLanguage(IXpsOMPage *This,
                                             LPWSTR *language) {
  return This->lpVtbl->GetLanguage(This, language);
}
static inline HRESULT IXpsOMPage_SetLanguage(IXpsOMPage *This,
                                             LPCWSTR language) {
  return This->lpVtbl->SetLanguage(This, language);
}
...
static inline HRESULT
IXpsOMPage_GetIsHyperlinkTarget(IXpsOMPage *This, WINBOOL *isHyperlinkTarget) {
  return This->lpVtbl->GetIsHyperlinkTarget(This, isHyperlinkTarget);
}
static inline HRESULT
IXpsOMPage_SetIsHyperlinkTarget(IXpsOMPage *This, WINBOOL isHyperlinkTarget) {
  return This->lpVtbl->SetIsHyperlinkTarget(This, isHyperlinkTarget);
}
static inline HRESULT
IXpsOMPage_GetDictionary(IXpsOMPage *This,
                         IXpsOMDictionary **resourceDictionary) {
  return This->lpVtbl->GetDictionary(This, resourceDictionary);
}
static inline HRESULT
IXpsOMPage_GetDictionaryLocal(IXpsOMPage *This,
                              IXpsOMDictionary **resourceDictionary) {
  return This->lpVtbl->GetDictionaryLocal(This, resourceDictionary);
}
static inline HRESULT
IXpsOMPage_SetDictionaryLocal(IXpsOMPage *This,
                              IXpsOMDictionary *resourceDictionary) {
  return This->lpVtbl->SetDictionaryLocal(This, resourceDictionary);
}
static inline HRESULT IXpsOMPage_GetDictionaryResource(
    IXpsOMPage *This,
    IXpsOMRemoteDictionaryResource **remoteDictionaryResource) {
  return This->lpVtbl->GetDictionaryResource(This, remoteDictionaryResource);
}
static inline HRESULT IXpsOMPage_SetDictionaryResource(
    IXpsOMPage *This,
    IXpsOMRemoteDictionaryResource *remoteDictionaryResource) {
  return This->lpVtbl->SetDictionaryResource(This, remoteDictionaryResource);
}
static inline HRESULT IXpsOMPage_Write(IXpsOMPage *This,
                                       ISequentialStream *stream,
                                       WINBOOL optimizeMarkupSize) {
  return This->lpVtbl->Write(This, stream, optimizeMarkupSize);
}
static inline HRESULT IXpsOMPage_GenerateUnusedLookupKey(IXpsOMPage *This,
                                                         XPS_OBJECT_TYPE type,
                                                         LPWSTR *key) {
...
DEFINE_GUID(IID_IXpsOMDocument, 0x2c2c94cb, 0xac5f, 0x4254, 0x8e, 0xe9, 0x23,
            0x94, 0x83, 0x09, 0xd9, 0xf0);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("2c2c94cb-ac5f-4254-8ee9-23948309d9f0")
IXpsOMDocument : public IXpsOMPart {
  virtual HRESULT STDMETHODCALLTYPE GetOwner(IXpsOMDocumentSequence *
                                             *documentSequence) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE Clone(IXpsOMDocument * *document) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMDocument, 0x2c2c94cb, 0xac5f, 0x4254, 0x8e, 0xe9, 0x23,
                0x94, 0x83, 0x09, 0xd9, 0xf0)
#endif
#else
typedef struct IXpsOMDocumentVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsOMDocument *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IXpsOMDocument *This);
  ULONG(STDMETHODCALLTYPE *Release)(IXpsOMDocument *This);
  /*** IXpsOMPart methods ***/
  HRESULT(STDMETHODCALLTYPE *GetPartName)(IXpsOMDocument *This,
                                          IOpcPartUri **partUri);
  HRESULT(STDMETHODCALLTYPE *SetPartName)(IXpsOMDocument *This,
                                          IOpcPartUri *partUri);
  /*** IXpsOMDocument methods ***/
  HRESULT(STDMETHODCALLTYPE *GetOwner)(
      IXpsOMDocument *This, IXpsOMDocumentSequence **documentSequence);
  HRESULT(STDMETHODCALLTYPE *GetPageReferences)(
      IXpsOMDocument *This, IXpsOMPageReferenceCollection **pageReferences);
  HRESULT(STDMETHODCALLTYPE *GetPrintTicketResource)(
      IXpsOMDocument *This, IXpsOMPrintTicketResource **printTicketResource);
  HRESULT(STDMETHODCALLTYPE *SetPrintTicketResource)(
      IXpsOMDocument *This, IXpsOMPrintTicketResource *printTicketResource);
  ...
  HRESULT(STDMETHODCALLTYPE *GetSignatureBlockResources)(
      IXpsOMDocument *This,
      IXpsOMSignatureBlockResourceCollection **signatureBlockResources);
  HRESULT(STDMETHODCALLTYPE *Clone)(IXpsOMDocument *This,
                                    IXpsOMDocument **document);
  END_INTERFACE
} IXpsOMDocumentVtbl;
interface IXpsOMDocument { CONST_VTBL IXpsOMDocumentVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IXpsOMDocument_QueryInterface(IXpsOMDocument *This,
                                                    REFIID riid,
                                                    void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IXpsOMPart methods ***/
static inline HRESULT IXpsOMDocument_GetPartName(IXpsOMDocument *This,
                                                 IOpcPartUri **partUri) {
  return This->lpVtbl->GetPartName(This, partUri);
}
static inline HRESULT IXpsOMDocument_SetPartName(IXpsOMDocument *This,
                                                 IOpcPartUri *partUri) {
  return This->lpVtbl->SetPartName(This, partUri);
}
/*** IXpsOMDocument methods ***/
static inline HRESULT
IXpsOMDocument_GetOwner(IXpsOMDocument *This,
                        IXpsOMDocumentSequence **documentSequence) {
  return This->lpVtbl->GetOwner(This, documentSequence);
}
static inline HRESULT IXpsOMDocument_GetPageReferences(
    IXpsOMDocument *This, IXpsOMPageReferenceCollection **pageReferences) {
  return This->lpVtbl->GetPageReferences(This, pageReferences);
}
static inline HRESULT IXpsOMDocument_GetPrintTicketResource(
    IXpsOMDocument *This, IXpsOMPrintTicketResource **printTicketResource) {
  return This->lpVtbl->GetPrintTicketResource(This, printTicketResource);
}
static inline HRESULT IXpsOMDocument_SetPrintTicketResource(
    IXpsOMDocument *This, IXpsOMPrintTicketResource *printTicketResource) {
  return This->lpVtbl->SetPrintTicketResource(This, printTicketResource);
}
static inline HRESULT IXpsOMDocument_GetDocumentStructureResource(
    IXpsOMDocument *This,
    IXpsOMDocumentStructureResource **documentStructureResource) {
  return This->lpVtbl->GetDocumentStructureResource(This,
                                                    documentStructureResource);
}
static inline HRESULT IXpsOMDocument_SetDocumentStructureResource(
    IXpsOMDocument *This,
    IXpsOMDocumentStructureResource *documentStructureResource) {
  return This->lpVtbl->SetDocumentStructureResource(This,
                                                    documentStructureResource);
}
static inline HRESULT IXpsOMDocument_GetSignatureBlockResources(
    IXpsOMDocument *This,
    IXpsOMSignatureBlockResourceCollection **signatureBlockResources) {
  return This->lpVtbl->GetSignatureBlockResources(This,
                                                  signatureBlockResources);
}
static inline HRESULT IXpsOMDocument_Clone(IXpsOMDocument *This,
                                           IXpsOMDocument **document) {
...
DEFINE_GUID(IID_IXpsOMDocumentSequence, 0x56492eb4, 0xd8d5, 0x425e, 0x82, 0x56,
            0x4c, 0x2b, 0x64, 0xad, 0x02, 0x64);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("56492eb4-d8d5-425e-8256-4c2b64ad0264")
IXpsOMDocumentSequence : public IXpsOMPart {
  virtual HRESULT STDMETHODCALLTYPE GetOwner(IXpsOMPackage * *package) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetDocuments(IXpsOMDocumentCollection *
                                                 *documents) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetPrintTicketResource(
      IXpsOMPrintTicketResource * *printTicketResource) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetPrintTicketResource(
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMDocumentSequence, 0x56492eb4, 0xd8d5, 0x425e, 0x82, 0x56,
                0x4c, 0x2b, 0x64, 0xad, 0x02, 0x64)
#endif
#else
typedef struct IXpsOMDocumentSequenceVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsOMDocumentSequence *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IXpsOMDocumentSequence *This);
  ULONG(STDMETHODCALLTYPE *Release)(IXpsOMDocumentSequence *This);
  /*** IXpsOMPart methods ***/
  HRESULT(STDMETHODCALLTYPE *GetPartName)(IXpsOMDocumentSequence *This,
                                          IOpcPartUri **partUri);
  HRESULT(STDMETHODCALLTYPE *SetPartName)(IXpsOMDocumentSequence *This,
                                          IOpcPartUri *partUri);
  /*** IXpsOMDocumentSequence methods ***/
  HRESULT(STDMETHODCALLTYPE *GetOwner)(IXpsOMDocumentSequence *This,
                                       IXpsOMPackage **package);
  HRESULT(STDMETHODCALLTYPE *GetDocuments)(
      IXpsOMDocumentSequence *This, IXpsOMDocumentCollection **documents);
  HRESULT(STDMETHODCALLTYPE *GetPrintTicketResource)(
...
#define IXpsOMDocumentSequence_GetPrintTicketResource(This,                    \
                                                      printTicketResource)     \
  (This)->lpVtbl->GetPrintTicketResource(This, printTicketResource)
#define IXpsOMDocumentSequence_SetPrintTicketResource(This,                    \
                                                      printTicketResource)     \
  (This)->lpVtbl->SetPrintTicketResource(This, printTicketResource)
#else
/*** IUnknown methods ***/
static inline HRESULT
IXpsOMDocumentSequence_QueryInterface(IXpsOMDocumentSequence *This, REFIID riid,
                                      void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IXpsOMDocumentSequence_AddRef(IXpsOMDocumentSequence *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IXpsOMDocumentSequence_Release(IXpsOMDocumentSequence *This) {
  return This->lpVtbl->Release(This);
}
/*** IXpsOMPart methods ***/
static inline HRESULT
IXpsOMDocumentSequence_GetPartName(IXpsOMDocumentSequence *This,
                                   IOpcPartUri **partUri) {
  return This->lpVtbl->GetPartName(This, partUri);
}
static inline HRESULT
IXpsOMDocumentSequence_SetPartName(IXpsOMDocumentSequence *This,
                                   IOpcPartUri *partUri) {
  return This->lpVtbl->SetPartName(This, partUri);
}
/*** IXpsOMDocumentSequence methods ***/
static inline HRESULT
IXpsOMDocumentSequence_GetOwner(IXpsOMDocumentSequence *This,
                                IXpsOMPackage **package) {
  return This->lpVtbl->GetOwner(This, package);
}
static inline HRESULT
IXpsOMDocumentSequence_GetDocuments(IXpsOMDocumentSequence *This,
                                    IXpsOMDocumentCollection **documents) {
  return This->lpVtbl->GetDocuments(This, documents);
}
static inline HRESULT IXpsOMDocumentSequence_GetPrintTicketResource(
    IXpsOMDocumentSequence *This,
    IXpsOMPrintTicketResource **printTicketResource) {
  return This->lpVtbl->GetPrintTicketResource(This, printTicketResource);
}
static inline HRESULT IXpsOMDocumentSequence_SetPrintTicketResource(
    IXpsOMDocumentSequence *This,
    IXpsOMPrintTicketResource *printTicketResource) {
  return This->lpVtbl->SetPrintTicketResource(This, printTicketResource);
}
...
DEFINE_GUID(IID_IXpsOMCoreProperties, 0x3340fe8f, 0x4027, 0x4aa1, 0x8f, 0x5f,
            0xd3, 0x5a, 0xe4, 0x5f, 0xe5, 0x97);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("3340fe8f-4027-4aa1-8f5f-d35ae45fe597")
IXpsOMCoreProperties : public IXpsOMPart {
  virtual HRESULT STDMETHODCALLTYPE GetOwner(IXpsOMPackage * *package) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetCategory(LPWSTR * category) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetCategory(LPCWSTR category) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetContentStatus(LPWSTR *
                                                     contentStatus) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetContentStatus(LPCWSTR contentStatus) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetContentType(LPWSTR * contentType) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetContentType(LPCWSTR contentType) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetCreated(SYSTEMTIME * created) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetCreated(const SYSTEMTIME *created) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetCreator(LPWSTR * creator) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetCreator(LPCWSTR creator) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetDescription(LPWSTR * description) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetDescription(LPCWSTR description) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetIdentifier(LPWSTR * identifier) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetIdentifier(LPCWSTR identifier) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetKeywords(LPWSTR * keywords) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetKeywords(LPCWSTR keywords) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetLanguage(LPWSTR * language) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetLanguage(LPCWSTR language) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetLastModifiedBy(LPWSTR *
                                                      lastModifiedBy) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetLastModifiedBy(
      LPCWSTR lastModifiedBy) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetLastPrinted(SYSTEMTIME *
                                                   lastPrinted) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetLastPrinted(
      const SYSTEMTIME *lastPrinted) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetModified(SYSTEMTIME * modified) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetModified(const SYSTEMTIME *modified) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetRevision(LPWSTR * revision) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetRevision(LPCWSTR revision) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetSubject(LPWSTR * subject) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetSubject(LPCWSTR subject) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetTitle(LPWSTR * title) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetTitle(LPCWSTR title) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetVersion(LPWSTR * version) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetVersion(LPCWSTR version) = 0;
  virtual HRESULT STDMETHODCALLTYPE Clone(IXpsOMCoreProperties *
                                          *coreProperties) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMCoreProperties, 0x3340fe8f, 0x4027, 0x4aa1, 0x8f, 0x5f,
                0xd3, 0x5a, 0xe4, 0x5f, 0xe5, 0x97)
#endif
#else
typedef struct IXpsOMCorePropertiesVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsOMCoreProperties *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IXpsOMCoreProperties *This);
  ULONG(STDMETHODCALLTYPE *Release)(IXpsOMCoreProperties *This);
  /*** IXpsOMPart methods ***/
  HRESULT(STDMETHODCALLTYPE *GetPartName)(IXpsOMCoreProperties *This,
                                          IOpcPartUri **partUri);
  HRESULT(STDMETHODCALLTYPE *SetPartName)(IXpsOMCoreProperties *This,
                                          IOpcPartUri *partUri);
  /*** IXpsOMCoreProperties methods ***/
  HRESULT(STDMETHODCALLTYPE *GetOwner)(IXpsOMCoreProperties *This,
                                       IXpsOMPackage **package);
  HRESULT(STDMETHODCALLTYPE *GetCategory)(IXpsOMCoreProperties *This,
                                          LPWSTR *category);
  HRESULT(STDMETHODCALLTYPE *SetCategory)(IXpsOMCoreProperties *This,
                                          LPCWSTR category);
  HRESULT(STDMETHODCALLTYPE *GetContentStatus)(IXpsOMCoreProperties *This,
                                               LPWSTR *contentStatus);
  HRESULT(STDMETHODCALLTYPE *SetContentStatus)(IXpsOMCoreProperties *This,
                                               LPCWSTR contentStatus);
  HRESULT(STDMETHODCALLTYPE *GetContentType)(IXpsOMCoreProperties *This,
                                             LPWSTR *contentType);
  HRESULT(STDMETHODCALLTYPE *SetContentType)(IXpsOMCoreProperties *This,
                                             LPCWSTR contentType);
  HRESULT(STDMETHODCALLTYPE *GetCreated)(IXpsOMCoreProperties *This,
                                         SYSTEMTIME *created);
  HRESULT(STDMETHODCALLTYPE *SetCreated)(IXpsOMCoreProperties *This,
                                         const SYSTEMTIME *created);
  HRESULT(STDMETHODCALLTYPE *GetCreator)(IXpsOMCoreProperties *This,
                                         LPWSTR *creator);
  HRESULT(STDMETHODCALLTYPE *SetCreator)(IXpsOMCoreProperties *This,
                                         LPCWSTR creator);
  HRESULT(STDMETHODCALLTYPE *GetDescription)(IXpsOMCoreProperties *This,
                                             LPWSTR *description);
  HRESULT(STDMETHODCALLTYPE *SetDescription)(IXpsOMCoreProperties *This,
                                             LPCWSTR description);
  HRESULT(STDMETHODCALLTYPE *GetIdentifier)(IXpsOMCoreProperties *This,
                                            LPWSTR *identifier);
  HRESULT(STDMETHODCALLTYPE *SetIdentifier)(IXpsOMCoreProperties *This,
                                            LPCWSTR identifier);
  HRESULT(STDMETHODCALLTYPE *GetKeywords)(IXpsOMCoreProperties *This,
                                          LPWSTR *keywords);
  HRESULT(STDMETHODCALLTYPE *SetKeywords)(IXpsOMCoreProperties *This,
                                          LPCWSTR keywords);
  HRESULT(STDMETHODCALLTYPE *GetLanguage)(IXpsOMCoreProperties *This,
                                          LPWSTR *language);
  HRESULT(STDMETHODCALLTYPE *SetLanguage)(IXpsOMCoreProperties *This,
                                          LPCWSTR language);
  HRESULT(STDMETHODCALLTYPE *GetLastModifiedBy)(IXpsOMCoreProperties *This,
                                                LPWSTR *lastModifiedBy);
  HRESULT(STDMETHODCALLTYPE *SetLastModifiedBy)(IXpsOMCoreProperties *This,
                                                LPCWSTR lastModifiedBy);
  HRESULT(STDMETHODCALLTYPE *GetLastPrinted)(IXpsOMCoreProperties *This,
                                             SYSTEMTIME *lastPrinted);
  HRESULT(STDMETHODCALLTYPE *SetLastPrinted)(IXpsOMCoreProperties *This,
                                             const SYSTEMTIME *lastPrinted);
  HRESULT(STDMETHODCALLTYPE *GetModified)(IXpsOMCoreProperties *This,
                                          SYSTEMTIME *modified);
  HRESULT(STDMETHODCALLTYPE *SetModified)(IXpsOMCoreProperties *This,
                                          const SYSTEMTIME *modified);
  HRESULT(STDMETHODCALLTYPE *GetRevision)(IXpsOMCoreProperties *This,
                                          LPWSTR *revision);
  HRESULT(STDMETHODCALLTYPE *SetRevision)(IXpsOMCoreProperties *This,
                                          LPCWSTR revision);
  HRESULT(STDMETHODCALLTYPE *GetSubject)(IXpsOMCoreProperties *This,
                                         LPWSTR *subject);
  HRESULT(STDMETHODCALLTYPE *SetSubject)(IXpsOMCoreProperties *This,
                                         LPCWSTR subject);
  HRESULT(STDMETHODCALLTYPE *GetTitle)(IXpsOMCoreProperties *This,
                                       LPWSTR *title);
  HRESULT(STDMETHODCALLTYPE *SetTitle)(IXpsOMCoreProperties *This,
                                       LPCWSTR title);
  HRESULT(STDMETHODCALLTYPE *GetVersion)(IXpsOMCoreProperties *This,
                                         LPWSTR *version);
  HRESULT(STDMETHODCALLTYPE *SetVersion)(IXpsOMCoreProperties *This,
                                         LPCWSTR version);
  HRESULT(STDMETHODCALLTYPE *Clone)(IXpsOMCoreProperties *This,
                                    IXpsOMCoreProperties **coreProperties);
  END_INTERFACE
} IXpsOMCorePropertiesVtbl;
interface IXpsOMCoreProperties { CONST_VTBL IXpsOMCorePropertiesVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
IXpsOMCoreProperties_QueryInterface(IXpsOMCoreProperties *This, REFIID riid,
                                    void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IXpsOMPart methods ***/
static inline HRESULT
IXpsOMCoreProperties_GetPartName(IXpsOMCoreProperties *This,
                                 IOpcPartUri **partUri) {
  return This->lpVtbl->GetPartName(This, partUri);
}
static inline HRESULT
IXpsOMCoreProperties_SetPartName(IXpsOMCoreProperties *This,
                                 IOpcPartUri *partUri) {
  return This->lpVtbl->SetPartName(This, partUri);
}
/*** IXpsOMCoreProperties methods ***/
static inline HRESULT IXpsOMCoreProperties_GetOwner(IXpsOMCoreProperties *This,
                                                    IXpsOMPackage **package) {
  return This->lpVtbl->GetOwner(This, package);
}
static inline HRESULT
IXpsOMCoreProperties_GetCategory(IXpsOMCoreProperties *This, LPWSTR *category) {
  return This->lpVtbl->GetCategory(This, category);
}
static inline HRESULT
IXpsOMCoreProperties_SetCategory(IXpsOMCoreProperties *This, LPCWSTR category) {
  return This->lpVtbl->SetCategory(This, category);
}
static inline HRESULT
IXpsOMCoreProperties_GetContentStatus(IXpsOMCoreProperties *This,
                                      LPWSTR *contentStatus) {
  return This->lpVtbl->GetContentStatus(This, contentStatus);
}
static inline HRESULT
IXpsOMCoreProperties_SetContentStatus(IXpsOMCoreProperties *This,
                                      LPCWSTR contentStatus) {
  return This->lpVtbl->SetContentStatus(This, contentStatus);
}
static inline HRESULT
IXpsOMCoreProperties_GetContentType(IXpsOMCoreProperties *This,
                                    LPWSTR *contentType) {
  return This->lpVtbl->GetContentType(This, contentType);
}
static inline HRESULT
IXpsOMCoreProperties_SetContentType(IXpsOMCoreProperties *This,
                                    LPCWSTR contentType) {
  return This->lpVtbl->SetContentType(This, contentType);
}
static inline HRESULT
IXpsOMCoreProperties_GetCreated(IXpsOMCoreProperties *This,
                                SYSTEMTIME *created) {
  return This->lpVtbl->GetCreated(This, created);
}
static inline HRESULT
IXpsOMCoreProperties_SetCreated(IXpsOMCoreProperties *This,
                                const SYSTEMTIME *created) {
  return This->lpVtbl->SetCreated(This, created);
}
static inline HRESULT
IXpsOMCoreProperties_GetCreator(IXpsOMCoreProperties *This, LPWSTR *creator) {
  return This->lpVtbl->GetCreator(This, creator);
}
static inline HRESULT
IXpsOMCoreProperties_SetCreator(IXpsOMCoreProperties *This, LPCWSTR creator) {
  return This->lpVtbl->SetCreator(This, creator);
}
static inline HRESULT
IXpsOMCoreProperties_GetDescription(IXpsOMCoreProperties *This,
                                    LPWSTR *description) {
  return This->lpVtbl->GetDescription(This, description);
}
static inline HRESULT
IXpsOMCoreProperties_SetDescription(IXpsOMCoreProperties *This,
                                    LPCWSTR description) {
  return This->lpVtbl->SetDescription(This, description);
}
static inline HRESULT
IXpsOMCoreProperties_GetIdentifier(IXpsOMCoreProperties *This,
                                   LPWSTR *identifier) {
  return This->lpVtbl->GetIdentifier(This, identifier);
}
static inline HRESULT
IXpsOMCoreProperties_SetIdentifier(IXpsOMCoreProperties *This,
                                   LPCWSTR identifier) {
  return This->lpVtbl->SetIdentifier(This, identifier);
}
static inline HRESULT
IXpsOMCoreProperties_GetKeywords(IXpsOMCoreProperties *This, LPWSTR *keywords) {
  return This->lpVtbl->GetKeywords(This, keywords);
}
static inline HRESULT
IXpsOMCoreProperties_SetKeywords(IXpsOMCoreProperties *This, LPCWSTR keywords) {
  return This->lpVtbl->SetKeywords(This, keywords);
}
static inline HRESULT
IXpsOMCoreProperties_GetLanguage(IXpsOMCoreProperties *This, LPWSTR *language) {
  return This->lpVtbl->GetLanguage(This, language);
}
static inline HRESULT
IXpsOMCoreProperties_SetLanguage(IXpsOMCoreProperties *This, LPCWSTR language) {
  return This->lpVtbl->SetLanguage(This, language);
}
static inline HRESULT
IXpsOMCoreProperties_GetLastModifiedBy(IXpsOMCoreProperties *This,
                                       LPWSTR *lastModifiedBy) {
  return This->lpVtbl->GetLastModifiedBy(This, lastModifiedBy);
}
static inline HRESULT
IXpsOMCoreProperties_SetLastModifiedBy(IXpsOMCoreProperties *This,
                                       LPCWSTR lastModifiedBy) {
  return This->lpVtbl->SetLastModifiedBy(This, lastModifiedBy);
}
static inline HRESULT
IXpsOMCoreProperties_GetLastPrinted(IXpsOMCoreProperties *This,
                                    SYSTEMTIME *lastPrinted) {
  return This->lpVtbl->GetLastPrinted(This, lastPrinted);
}
static inline HRESULT
IXpsOMCoreProperties_SetLastPrinted(IXpsOMCoreProperties *This,
                                    const SYSTEMTIME *lastPrinted) {
  return This->lpVtbl->SetLastPrinted(This, lastPrinted);
}
static inline HRESULT
IXpsOMCoreProperties_GetModified(IXpsOMCoreProperties *This,
                                 SYSTEMTIME *modified) {
  return This->lpVtbl->GetModified(This, modified);
}
static inline HRESULT
IXpsOMCoreProperties_SetModified(IXpsOMCoreProperties *This,
                                 const SYSTEMTIME *modified) {
  return This->lpVtbl->SetModified(This, modified);
}
static inline HRESULT
IXpsOMCoreProperties_GetRevision(IXpsOMCoreProperties *This, LPWSTR *revision) {
  return This->lpVtbl->GetRevision(This, revision);
}
static inline HRESULT
IXpsOMCoreProperties_SetRevision(IXpsOMCoreProperties *This, LPCWSTR revision) {
  return This->lpVtbl->SetRevision(This, revision);
}
static inline HRESULT
IXpsOMCoreProperties_GetSubject(IXpsOMCoreProperties *This, LPWSTR *subject) {
  return This->lpVtbl->GetSubject(This, subject);
}
static inline HRESULT
IXpsOMCoreProperties_SetSubject(IXpsOMCoreProperties *This, LPCWSTR subject) {
  return This->lpVtbl->SetSubject(This, subject);
}
static inline HRESULT IXpsOMCoreProperties_GetTitle(IXpsOMCoreProperties *This,
                                                    LPWSTR *title) {
  return This->lpVtbl->GetTitle(This, title);
}
static inline HRESULT IXpsOMCoreProperties_SetTitle(IXpsOMCoreProperties *This,
                                                    LPCWSTR title) {
  return This->lpVtbl->SetTitle(This, title);
}
static inline HRESULT
IXpsOMCoreProperties_GetVersion(IXpsOMCoreProperties *This, LPWSTR *version) {
  return This->lpVtbl->GetVersion(This, version);
}
static inline HRESULT
IXpsOMCoreProperties_SetVersion(IXpsOMCoreProperties *This, LPCWSTR version) {
  return This->lpVtbl->SetVersion(This, version);
}
static inline HRESULT
IXpsOMCoreProperties_Clone(IXpsOMCoreProperties *This,
                           IXpsOMCoreProperties **coreProperties) {
...
DEFINE_GUID(IID_IXpsOMThumbnailGenerator, 0x15b873d5, 0x1971, 0x41e8, 0x83,
            0xa3, 0x65, 0x78, 0x40, 0x30, 0x64, 0xc7);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IXpsOMThumbnailGenerator : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GenerateThumbnail(
      IXpsOMPage * page, XPS_IMAGE_TYPE thumbnailType,
      XPS_THUMBNAIL_SIZE thumbnailSize, IOpcPartUri * imageResourcePartName,
      IXpsOMImageResource * *imageResource) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsOMThumbnailGenerator, 0x15b873d5, 0x1971, 0x41e8, 0x83,
                0xa3, 0x65, 0x78, 0x40, 0x30, 0x64, 0xc7)
#endif
#else
typedef struct IXpsOMThumbnailGeneratorVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsOMThumbnailGenerator *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GenerateThumbnail)(
      IXpsOMThumbnailGenerator *This, IXpsOMPage *page,
      XPS_IMAGE_TYPE thumbnailType, XPS_THUMBNAIL_SIZE thumbnailSize,
...
/*** IXpsOMThumbnailGenerator methods ***/
#define IXpsOMThumbnailGenerator_GenerateThumbnail(                            \
    This, page, thumbnailType, thumbnailSize, imageResourcePartName,           \
    imageResource)                                                             \
  (This)->lpVtbl->GenerateThumbnail(This, page, thumbnailType, thumbnailSize,  \
                                    imageResourcePartName, imageResource)
#else
/*** IUnknown methods ***/
static inline HRESULT
IXpsOMThumbnailGenerator_QueryInterface(IXpsOMThumbnailGenerator *This,
                                        REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IXpsOMThumbnailGenerator_AddRef(IXpsOMThumbnailGenerator *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IXpsOMThumbnailGenerator_Release(IXpsOMThumbnailGenerator *This) {
  return This->lpVtbl->Release(This);
}
/*** IXpsOMThumbnailGenerator methods ***/
static inline HRESULT IXpsOMThumbnailGenerator_GenerateThumbnail(
    IXpsOMThumbnailGenerator *This, IXpsOMPage *page,
    XPS_IMAGE_TYPE thumbnailType, XPS_THUMBNAIL_SIZE thumbnailSize,
    IOpcPartUri *imageResourcePartName, IXpsOMImageResource **imageResource) {
  return This->lpVtbl->GenerateThumbnail(This, page, thumbnailType,
                                         thumbnailSize, imageResourcePartName,
                                         imageResource);
}
#endif
#endif
...
DEFINE_GUID(LIBID_MSXPS, 0xb47491a0, 0xcf33, 0x4fe4, 0x9a, 0x48, 0xb0, 0xac,
            0xda, 0xe2, 0x07, 0xe8);
#if WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_APP)
/*****************************************************************************
 * XpsOMObjectFactory coclass
 */
DEFINE_GUID(CLSID_XpsOMObjectFactory, 0xe974d26d, 0x3d9b, 0x4d47, 0x88, 0xcc,
            0x38, 0x72, 0xf2, 0xdc, 0x35, 0x85);
#ifdef __cplusplus
class DECLSPEC_UUID("e974d26d-3d9b-4d47-88cc-3872f2dc3585") XpsOMObjectFactory;
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(XpsOMObjectFactory, 0xe974d26d, 0x3d9b, 0x4d47, 0x88, 0xcc,
                0x38, 0x72, 0xf2, 0xdc, 0x35, 0x85)
#endif
#endif
#endif
 ...
 */
DEFINE_GUID(CLSID_XpsOMThumbnailGenerator, 0x7e4a23e2, 0xb969, 0x4761, 0xbe,
            0x35, 0x1a, 0x8c, 0xed, 0x58, 0xe3, 0x23);
#ifdef __cplusplus
class DECLSPEC_UUID("7e4a23e2-b969-4761-be35-1a8ced58e323")
    XpsOMThumbnailGenerator;
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(XpsOMThumbnailGenerator, 0x7e4a23e2, 0xb969, 0x4761, 0xbe, 0x35,
                0x1a, 0x8c, 0xed, 0x58, 0xe3, 0x23)
#endif
#endif
#endif
