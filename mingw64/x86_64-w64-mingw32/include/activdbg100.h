...
typedef interface IWebAppDiagnosticsObjectInitialization
...
typedef interface IDebugApplicationThreadEvents110
...
typedef interface IRemoteDebugCriticalErrorEvent110
...
DEFINE_GUID(IID_IDebugApplicationNode100, 0x90a7734e, 0x841b, 0x4f77, 0x93,
            0x84, 0xa2, 0x89, 0x1e, 0x76, 0xe7, 0xe2);
...
IDebugApplicationNode100 : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE SetFilterForEventSink(
      DWORD dwCookie, APPLICATION_NODE_EVENT_FILTER filter) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE QueryIsChildNode(IDebugDocument *
                                                     pSearchKey) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDebugApplicationNode100, 0x90a7734e, 0x841b, 0x4f77, 0x93,
                0x84, 0xa2, 0x89, 0x1e, 0x76, 0xe7, 0xe2)
#endif
#else
typedef struct IDebugApplicationNode100Vtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDebugApplicationNode100 *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IDebugApplicationNode100 *This);
  ULONG(STDMETHODCALLTYPE *Release)(IDebugApplicationNode100 *This);
  /*** IDebugApplicationNode100 methods ***/
  HRESULT(STDMETHODCALLTYPE *SetFilterForEventSink)(
      IDebugApplicationNode100 *This, DWORD dwCookie,
      APPLICATION_NODE_EVENT_FILTER filter);
  HRESULT(STDMETHODCALLTYPE *GetExcludedDocuments)(
      IDebugApplicationNode100 *This, APPLICATION_NODE_EVENT_FILTER filter,
      TEXT_DOCUMENT_ARRAY *pDocuments);
  HRESULT(STDMETHODCALLTYPE *QueryIsChildNode)(IDebugApplicationNode100 *This,
...
#define IDebugApplicationNode100_GetExcludedDocuments(This, filter,            \
                                                      pDocuments)              \
...
IDebugApplicationNode100_QueryInterface(IDebugApplicationNode100 *This,
                                        REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IDebugApplicationNode100_AddRef(IDebugApplicationNode100 *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IDebugApplicationNode100_Release(IDebugApplicationNode100 *This) {
  return This->lpVtbl->Release(This);
}
/*** IDebugApplicationNode100 methods ***/
static inline HRESULT IDebugApplicationNode100_SetFilterForEventSink(
    IDebugApplicationNode100 *This, DWORD dwCookie,
    APPLICATION_NODE_EVENT_FILTER filter) {
  return This->lpVtbl->SetFilterForEventSink(This, dwCookie, filter);
}
static inline HRESULT IDebugApplicationNode100_GetExcludedDocuments(
    IDebugApplicationNode100 *This, APPLICATION_NODE_EVENT_FILTER filter,
    TEXT_DOCUMENT_ARRAY *pDocuments) {
  return This->lpVtbl->GetExcludedDocuments(This, filter, pDocuments);
}
static inline HRESULT
IDebugApplicationNode100_QueryIsChildNode(IDebugApplicationNode100 *This,
                                          IDebugDocument *pSearchKey) {
...
DEFINE_GUID(IID_IWebAppDiagnosticsSetup, 0x379bfbe1, 0xc6c9, 0x432a, 0x93, 0xe1,
            0x6d, 0x17, 0x65, 0x6c, 0x53, 0x8c);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("379bfbe1-c6c9-432a-93e1-6d17656c538c")
IWebAppDiagnosticsSetup : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE DiagnosticsSupported(VARIANT_BOOL *
                                                         pRetVal) = 0;
  virtual HRESULT STDMETHODCALLTYPE CreateObjectWithSiteAtWebApp(
      REFCLSID rclsid, DWORD dwClsContext, REFIID riid,
      DWORD_PTR hPassToObject) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IWebAppDiagnosticsSetup, 0x379bfbe1, 0xc6c9, 0x432a, 0x93, 0xe1,
                0x6d, 0x17, 0x65, 0x6c, 0x53, 0x8c)
#endif
#else
typedef struct IWebAppDiagnosticsSetupVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWebAppDiagnosticsSetup *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IWebAppDiagnosticsSetup *This);
  ULONG(STDMETHODCALLTYPE *Release)(IWebAppDiagnosticsSetup *This);
  ...
  HRESULT(STDMETHODCALLTYPE *CreateObjectWithSiteAtWebApp)(
      IWebAppDiagnosticsSetup *This, REFCLSID rclsid, DWORD dwClsContext,
      REFIID riid, DWORD_PTR hPassToObject);
  END_INTERFACE
...
#define IWebAppDiagnosticsSetup_CreateObjectWithSiteAtWebApp(                  \
    This, rclsid, dwClsContext, riid, hPassToObject)                           \
  (This)->lpVtbl->CreateObjectWithSiteAtWebApp(This, rclsid, dwClsContext,     \
                                               riid, hPassToObject)
#else
/*** IUnknown methods ***/
static inline HRESULT
IWebAppDiagnosticsSetup_QueryInterface(IWebAppDiagnosticsSetup *This,
                                       REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IWebAppDiagnosticsSetup_AddRef(IWebAppDiagnosticsSetup *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IWebAppDiagnosticsSetup_Release(IWebAppDiagnosticsSetup *This) {
  return This->lpVtbl->Release(This);
}
/*** IWebAppDiagnosticsSetup methods ***/
static inline HRESULT
IWebAppDiagnosticsSetup_DiagnosticsSupported(IWebAppDiagnosticsSetup *This,
                                             VARIANT_BOOL *pRetVal) {
  return This->lpVtbl->DiagnosticsSupported(This, pRetVal);
}
static inline HRESULT IWebAppDiagnosticsSetup_CreateObjectWithSiteAtWebApp(
    IWebAppDiagnosticsSetup *This, REFCLSID rclsid, DWORD dwClsContext,
    REFIID riid, DWORD_PTR hPassToObject) {
  return This->lpVtbl->CreateObjectWithSiteAtWebApp(This, rclsid, dwClsContext,
                                                    riid, hPassToObject);
}
#endif
#endif
...
DEFINE_GUID(IID_IRemoteDebugApplication110, 0xd5fe005b, 0x2836, 0x485e, 0xb1,
            0xf9, 0x89, 0xd9, 0x1a, 0xa2, 0x4f, 0xd4);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IRemoteDebugApplication110, 0xd5fe005b, 0x2836, 0x485e, 0xb1,
                0xf9, 0x89, 0xd9, 0x1a, 0xa2, 0x4f, 0xd4)
#endif
#else
typedef struct IRemoteDebugApplication110Vtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IRemoteDebugApplication110 *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IRemoteDebugApplication110 *This);
  ULONG(STDMETHODCALLTYPE *Release)(IRemoteDebugApplication110 *This);
  /*** IRemoteDebugApplication110 methods ***/
  HRESULT(STDMETHODCALLTYPE *SetDebuggerOptions)(
      IRemoteDebugApplication110 *This, enum SCRIPT_DEBUGGER_OPTIONS mask,
...
#define IRemoteDebugApplication110_GetCurrentDebuggerOptions(This,             \
                                                             pCurrentOptions)  \
...
/*** IUnknown methods ***/
static inline HRESULT
IRemoteDebugApplication110_QueryInterface(IRemoteDebugApplication110 *This,
                                          REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IRemoteDebugApplication110_AddRef(IRemoteDebugApplication110 *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IRemoteDebugApplication110_Release(IRemoteDebugApplication110 *This) {
  return This->lpVtbl->Release(This);
}
/*** IRemoteDebugApplication110 methods ***/
static inline HRESULT IRemoteDebugApplication110_SetDebuggerOptions(
    IRemoteDebugApplication110 *This, enum SCRIPT_DEBUGGER_OPTIONS mask,
    enum SCRIPT_DEBUGGER_OPTIONS value) {
  return This->lpVtbl->SetDebuggerOptions(This, mask, value);
}
static inline HRESULT IRemoteDebugApplication110_GetCurrentDebuggerOptions(
    IRemoteDebugApplication110 *This,
    enum SCRIPT_DEBUGGER_OPTIONS *pCurrentOptions) {
  return This->lpVtbl->GetCurrentDebuggerOptions(This, pCurrentOptions);
}
static inline HRESULT IRemoteDebugApplication110_GetMainThread(
    IRemoteDebugApplication110 *This,
    IRemoteDebugApplicationThread **ppThread) {
...
DEFINE_GUID(IID_IDebugApplication11032, 0xbdb3b5de, 0x89f2, 0x4e11, 0x84, 0xa5,
            0x97, 0x44, 0x5f, 0x94, 0x1c, 0x7d);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IDebugApplication11032 : public IRemoteDebugApplication110 {
  virtual HRESULT STDMETHODCALLTYPE SynchronousCallInMainThread(
      IDebugThreadCall32 * pptc, DWORD_PTR dwParam1, DWORD_PTR dwParam2,
  ...
  virtual HRESULT STDMETHODCALLTYPE CallableWaitForHandles(
      DWORD handleCount, const HANDLE *pHandles, DWORD *pIndex) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDebugApplication11032, 0xbdb3b5de, 0x89f2, 0x4e11, 0x84, 0xa5,
                0x97, 0x44, 0x5f, 0x94, 0x1c, 0x7d)
#endif
#else
typedef struct IDebugApplication11032Vtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDebugApplication11032 *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IDebugApplication11032 *This);
  ULONG(STDMETHODCALLTYPE *Release)(IDebugApplication11032 *This);
  /*** IRemoteDebugApplication110 methods ***/
  HRESULT(STDMETHODCALLTYPE *SetDebuggerOptions)(
      IDebugApplication11032 *This, enum SCRIPT_DEBUGGER_OPTIONS mask,
      enum SCRIPT_DEBUGGER_OPTIONS value);
  HRESULT(STDMETHODCALLTYPE *GetCurrentDebuggerOptions)(
      IDebugApplication11032 *This,
      enum SCRIPT_DEBUGGER_OPTIONS *pCurrentOptions);
  HRESULT(STDMETHODCALLTYPE *GetMainThread)(
      IDebugApplication11032 *This, IRemoteDebugApplicationThread **ppThread);
  /*** IDebugApplication11032 methods ***/
  HRESULT(STDMETHODCALLTYPE *SynchronousCallInMainThread)(
      IDebugApplication11032 *This, IDebugThreadCall32 *pptc,
  ...
  HRESULT(STDMETHODCALLTYPE *CallableWaitForHandles)(
      IDebugApplication11032 *This, DWORD handleCount, const HANDLE *pHandles,
      DWORD *pIndex);
  END_INTERFACE
...
#define IDebugApplication11032_SetDebuggerOptions(This, mask, value)           \
  (This)->lpVtbl->SetDebuggerOptions(This, mask, value)
#define IDebugApplication11032_GetCurrentDebuggerOptions(This,                 \
                                                         pCurrentOptions)      \
  (This)->lpVtbl->GetCurrentDebuggerOptions(This, pCurrentOptions)
#define IDebugApplication11032_GetMainThread(This, ppThread)                   \
  (This)->lpVtbl->GetMainThread(This, ppThread)
/*** IDebugApplication11032 methods ***/
#define IDebugApplication11032_SynchronousCallInMainThread(                    \
    This, pptc, dwParam1, dwParam2, dwParam3)                                  \
  (This)->lpVtbl->SynchronousCallInMainThread(This, pptc, dwParam1, dwParam2,  \
                                              dwParam3)
#define IDebugApplication11032_AsynchronousCallInMainThread(                   \
    This, pptc, dwParam1, dwParam2, dwParam3)                                  \
  (This)->lpVtbl->AsynchronousCallInMainThread(This, pptc, dwParam1, dwParam2, \
                                               dwParam3)
#define IDebugApplication11032_CallableWaitForHandles(This, handleCount,       \
                                                      pHandles, pIndex)        \
  (This)->lpVtbl->CallableWaitForHandles(This, handleCount, pHandles, pIndex)
#else
/*** IUnknown methods ***/
static inline HRESULT
IDebugApplication11032_QueryInterface(IDebugApplication11032 *This, REFIID riid,
                                      void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IDebugApplication11032_AddRef(IDebugApplication11032 *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IDebugApplication11032_Release(IDebugApplication11032 *This) {
  return This->lpVtbl->Release(This);
}
/*** IRemoteDebugApplication110 methods ***/
static inline HRESULT
IDebugApplication11032_SetDebuggerOptions(IDebugApplication11032 *This,
                                          enum SCRIPT_DEBUGGER_OPTIONS mask,
                                          enum SCRIPT_DEBUGGER_OPTIONS value) {
  return This->lpVtbl->SetDebuggerOptions(This, mask, value);
}
static inline HRESULT IDebugApplication11032_GetCurrentDebuggerOptions(
    IDebugApplication11032 *This,
    enum SCRIPT_DEBUGGER_OPTIONS *pCurrentOptions) {
  return This->lpVtbl->GetCurrentDebuggerOptions(This, pCurrentOptions);
}
static inline HRESULT
IDebugApplication11032_GetMainThread(IDebugApplication11032 *This,
                                     IRemoteDebugApplicationThread **ppThread) {
  return This->lpVtbl->GetMainThread(This, ppThread);
}
/*** IDebugApplication11032 methods ***/
static inline HRESULT IDebugApplication11032_SynchronousCallInMainThread(
    IDebugApplication11032 *This, IDebugThreadCall32 *pptc, DWORD_PTR dwParam1,
    DWORD_PTR dwParam2, DWORD_PTR dwParam3) {
  return This->lpVtbl->SynchronousCallInMainThread(This, pptc, dwParam1,
                                                   dwParam2, dwParam3);
}
static inline HRESULT IDebugApplication11032_AsynchronousCallInMainThread(
    IDebugApplication11032 *This, IDebugThreadCall32 *pptc, DWORD_PTR dwParam1,
    DWORD_PTR dwParam2, DWORD_PTR dwParam3) {
  return This->lpVtbl->AsynchronousCallInMainThread(This, pptc, dwParam1,
                                                    dwParam2, dwParam3);
}
static inline HRESULT IDebugApplication11032_CallableWaitForHandles(
    IDebugApplication11032 *This, DWORD handleCount, const HANDLE *pHandles,
    DWORD *pIndex) {
  return This->lpVtbl->CallableWaitForHandles(This, handleCount, pHandles,
                                              pIndex);
}
#endif
#endif
...
DEFINE_GUID(IID_IDebugApplication11064, 0x2039d958, 0x4eeb, 0x496a, 0x87, 0xbb,
            0x2e, 0x52, 0x01, 0xea, 0xde, 0xef);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("2039d958-4eeb-496a-87bb-2e5201eadeef")
IDebugApplication11064 : public IRemoteDebugApplication110 {
  virtual HRESULT STDMETHODCALLTYPE SynchronousCallInMainThread(
      IDebugThreadCall64 * pptc, DWORD_PTR dwParam1, DWORD_PTR dwParam2,
      DWORD_PTR dwParam3) = 0;
  virtual HRESULT STDMETHODCALLTYPE AsynchronousCallInMainThread(
      IDebugThreadCall64 * pptc, DWORD_PTR dwParam1, DWORD_PTR dwParam2,
      DWORD_PTR dwParam3) = 0;
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDebugApplication11064, 0x2039d958, 0x4eeb, 0x496a, 0x87, 0xbb,
                0x2e, 0x52, 0x01, 0xea, 0xde, 0xef)
#endif
#else
typedef struct IDebugApplication11064Vtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDebugApplication11064 *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IDebugApplication11064 *This);
  ULONG(STDMETHODCALLTYPE *Release)(IDebugApplication11064 *This);
  /*** IRemoteDebugApplication110 methods ***/
  HRESULT(STDMETHODCALLTYPE *SetDebuggerOptions)(
      IDebugApplication11064 *This, enum SCRIPT_DEBUGGER_OPTIONS mask,
      enum SCRIPT_DEBUGGER_OPTIONS value);
  HRESULT(STDMETHODCALLTYPE *GetCurrentDebuggerOptions)(
      IDebugApplication11064 *This,
      enum SCRIPT_DEBUGGER_OPTIONS *pCurrentOptions);
  HRESULT(STDMETHODCALLTYPE *GetMainThread)(
      IDebugApplication11064 *This, IRemoteDebugApplicationThread **ppThread);
  /*** IDebugApplication11064 methods ***/
  HRESULT(STDMETHODCALLTYPE *SynchronousCallInMainThread)(
      IDebugApplication11064 *This, IDebugThreadCall64 *pptc,
      DWORD_PTR dwParam1, DWORD_PTR dwParam2, DWORD_PTR dwParam3);
  HRESULT(STDMETHODCALLTYPE *AsynchronousCallInMainThread)(
      IDebugApplication11064 *This, IDebugThreadCall64 *pptc,
      DWORD_PTR dwParam1, DWORD_PTR dwParam2, DWORD_PTR dwParam3);
  HRESULT(STDMETHODCALLTYPE *CallableWaitForHandles)(
      IDebugApplication11064 *This, DWORD handleCount, const HANDLE *pHandles,
      DWORD *pIndex);
  END_INTERFACE
...
#define IDebugApplication11064_SetDebuggerOptions(This, mask, value)           \
  (This)->lpVtbl->SetDebuggerOptions(This, mask, value)
#define IDebugApplication11064_GetCurrentDebuggerOptions(This,                 \
                                                         pCurrentOptions)      \
  (This)->lpVtbl->GetCurrentDebuggerOptions(This, pCurrentOptions)
#define IDebugApplication11064_GetMainThread(This, ppThread)                   \
  (This)->lpVtbl->GetMainThread(This, ppThread)
/*** IDebugApplication11064 methods ***/
#define IDebugApplication11064_SynchronousCallInMainThread(                    \
    This, pptc, dwParam1, dwParam2, dwParam3)                                  \
  (This)->lpVtbl->SynchronousCallInMainThread(This, pptc, dwParam1, dwParam2,  \
                                              dwParam3)
#define IDebugApplication11064_AsynchronousCallInMainThread(                   \
    This, pptc, dwParam1, dwParam2, dwParam3)                                  \
  (This)->lpVtbl->AsynchronousCallInMainThread(This, pptc, dwParam1, dwParam2, \
                                               dwParam3)
#define IDebugApplication11064_CallableWaitForHandles(This, handleCount,       \
                                                      pHandles, pIndex)        \
  (This)->lpVtbl->CallableWaitForHandles(This, handleCount, pHandles, pIndex)
#else
/*** IUnknown methods ***/
static inline HRESULT
IDebugApplication11064_QueryInterface(IDebugApplication11064 *This, REFIID riid,
                                      void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IDebugApplication11064_AddRef(IDebugApplication11064 *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IDebugApplication11064_Release(IDebugApplication11064 *This) {
  return This->lpVtbl->Release(This);
}
/*** IRemoteDebugApplication110 methods ***/
static inline HRESULT
IDebugApplication11064_SetDebuggerOptions(IDebugApplication11064 *This,
                                          enum SCRIPT_DEBUGGER_OPTIONS mask,
                                          enum SCRIPT_DEBUGGER_OPTIONS value) {
  return This->lpVtbl->SetDebuggerOptions(This, mask, value);
}
static inline HRESULT IDebugApplication11064_GetCurrentDebuggerOptions(
    IDebugApplication11064 *This,
    enum SCRIPT_DEBUGGER_OPTIONS *pCurrentOptions) {
  return This->lpVtbl->GetCurrentDebuggerOptions(This, pCurrentOptions);
}
static inline HRESULT
IDebugApplication11064_GetMainThread(IDebugApplication11064 *This,
                                     IRemoteDebugApplicationThread **ppThread) {
  return This->lpVtbl->GetMainThread(This, ppThread);
}
/*** IDebugApplication11064 methods ***/
static inline HRESULT IDebugApplication11064_SynchronousCallInMainThread(
    IDebugApplication11064 *This, IDebugThreadCall64 *pptc, DWORD_PTR dwParam1,
    DWORD_PTR dwParam2, DWORD_PTR dwParam3) {
  return This->lpVtbl->SynchronousCallInMainThread(This, pptc, dwParam1,
                                                   dwParam2, dwParam3);
}
static inline HRESULT IDebugApplication11064_AsynchronousCallInMainThread(
    IDebugApplication11064 *This, IDebugThreadCall64 *pptc, DWORD_PTR dwParam1,
    DWORD_PTR dwParam2, DWORD_PTR dwParam3) {
  return This->lpVtbl->AsynchronousCallInMainThread(This, pptc, dwParam1,
                                                    dwParam2, dwParam3);
}
static inline HRESULT IDebugApplication11064_CallableWaitForHandles(
    IDebugApplication11064 *This, DWORD handleCount, const HANDLE *pHandles,
    DWORD *pIndex) {
  return This->lpVtbl->CallableWaitForHandles(This, handleCount, pHandles,
                                              pIndex);
...
DEFINE_GUID(IID_IWebAppDiagnosticsObjectInitialization, 0x16ff3a42, 0xa5f5,
            0x432b, 0xb6, 0x25, 0x8e, 0x8e, 0x16, 0xf5, 0x7e, 0x15);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("16ff3a42-a5f5-432b-b625-8e8e16f57e15")
IWebAppDiagnosticsObjectInitialization : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE Initialize(
      HANDLE_PTR hPassedHandle, IUnknown * pDebugApplication) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IWebAppDiagnosticsObjectInitialization, 0x16ff3a42, 0xa5f5,
                0x432b, 0xb6, 0x25, 0x8e, 0x8e, 0x16, 0xf5, 0x7e, 0x15)
#endif
#else
typedef struct IWebAppDiagnosticsObjectInitializationVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(
      IWebAppDiagnosticsObjectInitialization *This, REFIID riid,
      void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *Initialize)(
      IWebAppDiagnosticsObjectInitialization *This, HANDLE_PTR hPassedHandle,
...
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
#define IWebAppDiagnosticsObjectInitialization_QueryInterface(This, riid,      \
                                                              ppvObject)       \
  (This)->lpVtbl->QueryInterface(This, riid, ppvObject)
...
/*** IWebAppDiagnosticsObjectInitialization methods ***/
#define IWebAppDiagnosticsObjectInitialization_Initialize(This, hPassedHandle, \
                                                          pDebugApplication)   \
  (This)->lpVtbl->Initialize(This, hPassedHandle, pDebugApplication)
#else
/*** IUnknown methods ***/
static inline HRESULT IWebAppDiagnosticsObjectInitialization_QueryInterface(
    IWebAppDiagnosticsObjectInitialization *This, REFIID riid,
    void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG IWebAppDiagnosticsObjectInitialization_AddRef(
    IWebAppDiagnosticsObjectInitialization *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG IWebAppDiagnosticsObjectInitialization_Release(
    IWebAppDiagnosticsObjectInitialization *This) {
  return This->lpVtbl->Release(This);
}
/*** IWebAppDiagnosticsObjectInitialization methods ***/
static inline HRESULT IWebAppDiagnosticsObjectInitialization_Initialize(
    IWebAppDiagnosticsObjectInitialization *This, HANDLE_PTR hPassedHandle,
    IUnknown *pDebugApplication) {
...
DEFINE_GUID(IID_IActiveScriptWinRTErrorDebug, 0x73a3f82a, 0x0fe9, 0x4b33, 0xba,
            0x3b, 0xfe, 0x09, 0x5f, 0x69, 0x7e, 0x0a);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("73a3f82a-0fe9-4b33-ba3b-fe095f697e0a")
IActiveScriptWinRTErrorDebug : public IActiveScriptError {
  virtual HRESULT STDMETHODCALLTYPE GetRestrictedErrorString(BSTR *
                                                             errorString) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetRestrictedErrorReference(
      BSTR * referenceString) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetCapabilitySid(BSTR * capabilitySid) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IActiveScriptWinRTErrorDebug, 0x73a3f82a, 0x0fe9, 0x4b33, 0xba,
                0x3b, 0xfe, 0x09, 0x5f, 0x69, 0x7e, 0x0a)
#endif
#else
typedef struct IActiveScriptWinRTErrorDebugVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IActiveScriptWinRTErrorDebug *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IActiveScriptWinRTErrorDebug *This);
  ULONG(STDMETHODCALLTYPE *Release)(IActiveScriptWinRTErrorDebug *This);
  /*** IActiveScriptError methods ***/
  HRESULT(STDMETHODCALLTYPE *GetExceptionInfo)(
      IActiveScriptWinRTErrorDebug *This, EXCEPINFO *pexcepinfo);
  HRESULT(STDMETHODCALLTYPE *GetSourcePosition)(
      IActiveScriptWinRTErrorDebug *This, DWORD *pdwSourceContext,
      ULONG *pulLineNumber, LONG *plCharacterPosition);
  HRESULT(STDMETHODCALLTYPE *GetSourceLineText)(
      IActiveScriptWinRTErrorDebug *This, BSTR *pbstrSourceLine);
  /*** IActiveScriptWinRTErrorDebug methods ***/
  HRESULT(STDMETHODCALLTYPE *GetRestrictedErrorString)(
      IActiveScriptWinRTErrorDebug *This, BSTR *errorString);
  HRESULT(STDMETHODCALLTYPE *GetRestrictedErrorReference)(
      IActiveScriptWinRTErrorDebug *This, BSTR *referenceString);
  HRESULT(STDMETHODCALLTYPE *GetCapabilitySid)(
      IActiveScriptWinRTErrorDebug *This, BSTR *capabilitySid);
  END_INTERFACE
...
#define IActiveScriptWinRTErrorDebug_GetSourcePosition(                        \
...
/*** IActiveScriptWinRTErrorDebug methods ***/
#define IActiveScriptWinRTErrorDebug_GetRestrictedErrorString(This,            \
                                                              errorString)     \
  (This)->lpVtbl->GetRestrictedErrorString(This, errorString)
#define IActiveScriptWinRTErrorDebug_GetRestrictedErrorReference(              \
...
/*** IUnknown methods ***/
static inline HRESULT
IActiveScriptWinRTErrorDebug_QueryInterface(IActiveScriptWinRTErrorDebug *This,
                                            REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IActiveScriptWinRTErrorDebug_AddRef(IActiveScriptWinRTErrorDebug *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IActiveScriptWinRTErrorDebug_Release(IActiveScriptWinRTErrorDebug *This) {
  return This->lpVtbl->Release(This);
}
/*** IActiveScriptError methods ***/
static inline HRESULT IActiveScriptWinRTErrorDebug_GetExceptionInfo(
    IActiveScriptWinRTErrorDebug *This, EXCEPINFO *pexcepinfo) {
  return This->lpVtbl->GetExceptionInfo(This, pexcepinfo);
}
static inline HRESULT IActiveScriptWinRTErrorDebug_GetSourcePosition(
    IActiveScriptWinRTErrorDebug *This, DWORD *pdwSourceContext,
    ULONG *pulLineNumber, LONG *plCharacterPosition) {
  return This->lpVtbl->GetSourcePosition(This, pdwSourceContext, pulLineNumber,
                                         plCharacterPosition);
}
static inline HRESULT IActiveScriptWinRTErrorDebug_GetSourceLineText(
    IActiveScriptWinRTErrorDebug *This, BSTR *pbstrSourceLine) {
  return This->lpVtbl->GetSourceLineText(This, pbstrSourceLine);
}
/*** IActiveScriptWinRTErrorDebug methods ***/
static inline HRESULT IActiveScriptWinRTErrorDebug_GetRestrictedErrorString(
    IActiveScriptWinRTErrorDebug *This, BSTR *errorString) {
  return This->lpVtbl->GetRestrictedErrorString(This, errorString);
}
static inline HRESULT IActiveScriptWinRTErrorDebug_GetRestrictedErrorReference(
    IActiveScriptWinRTErrorDebug *This, BSTR *referenceString) {
  return This->lpVtbl->GetRestrictedErrorReference(This, referenceString);
}
static inline HRESULT IActiveScriptWinRTErrorDebug_GetCapabilitySid(
    IActiveScriptWinRTErrorDebug *This, BSTR *capabilitySid) {
...
DEFINE_GUID(IID_IActiveScriptErrorDebug110, 0x516e42b6, 0x89a8, 0x4530, 0x93,
            0x7b, 0x5f, 0x07, 0x08, 0x43, 0x14, 0x42);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IActiveScriptErrorDebug110, 0x516e42b6, 0x89a8, 0x4530, 0x93,
                0x7b, 0x5f, 0x07, 0x08, 0x43, 0x14, 0x42)
#endif
#else
typedef struct IActiveScriptErrorDebug110Vtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IActiveScriptErrorDebug110 *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IActiveScriptErrorDebug110 *This);
  ULONG(STDMETHODCALLTYPE *Release)(IActiveScriptErrorDebug110 *This);
...
/*** IActiveScriptErrorDebug110 methods ***/
#define IActiveScriptErrorDebug110_GetExceptionThrownKind(This,                \
                                                          pExceptionKind)      \
  (This)->lpVtbl->GetExceptionThrownKind(This, pExceptionKind)
#else
/*** IUnknown methods ***/
static inline HRESULT
IActiveScriptErrorDebug110_QueryInterface(IActiveScriptErrorDebug110 *This,
                                          REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IActiveScriptErrorDebug110_AddRef(IActiveScriptErrorDebug110 *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IActiveScriptErrorDebug110_Release(IActiveScriptErrorDebug110 *This) {
  return This->lpVtbl->Release(This);
}
/*** IActiveScriptErrorDebug110 methods ***/
static inline HRESULT IActiveScriptErrorDebug110_GetExceptionThrownKind(
    IActiveScriptErrorDebug110 *This,
    SCRIPT_ERROR_DEBUG_EXCEPTION_THROWN_KIND *pExceptionKind) {
...
DEFINE_GUID(IID_IDebugApplicationThreadEvents110, 0x84e5e468, 0xd5da, 0x48a8,
            0x83, 0xf4, 0x40, 0x36, 0x64, 0x29, 0x00, 0x7b);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("84e5e468-d5da-48a8-83f4-40366429007b")
IDebugApplicationThreadEvents110 : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE OnSuspendForBreakPoint() = 0;
  virtual HRESULT STDMETHODCALLTYPE OnResumeFromBreakPoint() = 0;
  virtual HRESULT STDMETHODCALLTYPE OnThreadRequestComplete() = 0;
  virtual HRESULT STDMETHODCALLTYPE OnBeginThreadRequest() = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDebugApplicationThreadEvents110, 0x84e5e468, 0xd5da, 0x48a8,
                0x83, 0xf4, 0x40, 0x36, 0x64, 0x29, 0x00, 0x7b)
#endif
#else
typedef struct IDebugApplicationThreadEvents110Vtbl {
  ...
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(
      IDebugApplicationThreadEvents110 *This, REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IDebugApplicationThreadEvents110 *This);
  ULONG(STDMETHODCALLTYPE *Release)(IDebugApplicationThreadEvents110 *This);
...
#else
/*** IUnknown methods ***/
static inline HRESULT IDebugApplicationThreadEvents110_QueryInterface(
    IDebugApplicationThreadEvents110 *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG IDebugApplicationThreadEvents110_AddRef(
    IDebugApplicationThreadEvents110 *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG IDebugApplicationThreadEvents110_Release(
    IDebugApplicationThreadEvents110 *This) {
  return This->lpVtbl->Release(This);
}
/*** IDebugApplicationThreadEvents110 methods ***/
static inline HRESULT IDebugApplicationThreadEvents110_OnSuspendForBreakPoint(
    IDebugApplicationThreadEvents110 *This) {
  return This->lpVtbl->OnSuspendForBreakPoint(This);
}
static inline HRESULT IDebugApplicationThreadEvents110_OnResumeFromBreakPoint(
    IDebugApplicationThreadEvents110 *This) {
  return This->lpVtbl->OnResumeFromBreakPoint(This);
}
static inline HRESULT IDebugApplicationThreadEvents110_OnThreadRequestComplete(
    IDebugApplicationThreadEvents110 *This) {
  return This->lpVtbl->OnThreadRequestComplete(This);
}
static inline HRESULT IDebugApplicationThreadEvents110_OnBeginThreadRequest(
    IDebugApplicationThreadEvents110 *This) {
...
DEFINE_GUID(IID_IDebugApplicationThread11032, 0x2194ac5c, 0x6561, 0x404a, 0xa2,
            0xe9, 0xf5, 0x7d, 0x72, 0xde, 0x37, 0x02);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IDebugApplicationThread11032 : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE IsSuspendedForBreakPoint(WINBOOL *
                                                             pfIsSuspended) = 0;
  virtual HRESULT STDMETHODCALLTYPE IsThreadCallable(WINBOOL *
                                                     pfIsCallable) = 0;
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDebugApplicationThread11032, 0x2194ac5c, 0x6561, 0x404a, 0xa2,
                0xe9, 0xf5, 0x7d, 0x72, 0xde, 0x37, 0x02)
#endif
#else
typedef struct IDebugApplicationThread11032Vtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDebugApplicationThread11032 *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IDebugApplicationThread11032 *This);
  ULONG(STDMETHODCALLTYPE *Release)(IDebugApplicationThread11032 *This);
  /*** IDebugApplicationThread11032 methods ***/
  HRESULT(STDMETHODCALLTYPE *GetActiveThreadRequestCount)(
      IDebugApplicationThread11032 *This, UINT *puiThreadRequests);
  HRESULT(STDMETHODCALLTYPE *IsSuspendedForBreakPoint)(
      IDebugApplicationThread11032 *This, WINBOOL *pfIsSuspended);
  HRESULT(STDMETHODCALLTYPE *IsThreadCallable)(
      IDebugApplicationThread11032 *This, WINBOOL *pfIsCallable);
  HRESULT(STDMETHODCALLTYPE *AsynchronousCallIntoThread)(
      IDebugApplicationThread11032 *This, IDebugThreadCall32 *pptc,
      DWORD_PTR dwParam1, DWORD_PTR dwParam2, DWORD_PTR dwParam3);
  END_INTERFACE
...
/*** IDebugApplicationThread11032 methods ***/
#define IDebugApplicationThread11032_GetActiveThreadRequestCount(              \
    This, puiThreadRequests)                                                   \
  (This)->lpVtbl->GetActiveThreadRequestCount(This, puiThreadRequests)
#define IDebugApplicationThread11032_IsSuspendedForBreakPoint(This,            \
                                                              pfIsSuspended)   \
...
#define IDebugApplicationThread11032_AsynchronousCallIntoThread(               \
    This, pptc, dwParam1, dwParam2, dwParam3)                                  \
  (This)->lpVtbl->AsynchronousCallIntoThread(This, pptc, dwParam1, dwParam2,   \
                                             dwParam3)
#else
/*** IUnknown methods ***/
static inline HRESULT
IDebugApplicationThread11032_QueryInterface(IDebugApplicationThread11032 *This,
                                            REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IDebugApplicationThread11032_AddRef(IDebugApplicationThread11032 *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IDebugApplicationThread11032_Release(IDebugApplicationThread11032 *This) {
  return This->lpVtbl->Release(This);
}
/*** IDebugApplicationThread11032 methods ***/
static inline HRESULT IDebugApplicationThread11032_GetActiveThreadRequestCount(
    IDebugApplicationThread11032 *This, UINT *puiThreadRequests) {
  return This->lpVtbl->GetActiveThreadRequestCount(This, puiThreadRequests);
}
static inline HRESULT IDebugApplicationThread11032_IsSuspendedForBreakPoint(
    IDebugApplicationThread11032 *This, WINBOOL *pfIsSuspended) {
  return This->lpVtbl->IsSuspendedForBreakPoint(This, pfIsSuspended);
}
static inline HRESULT IDebugApplicationThread11032_IsThreadCallable(
    IDebugApplicationThread11032 *This, WINBOOL *pfIsCallable) {
  return This->lpVtbl->IsThreadCallable(This, pfIsCallable);
}
static inline HRESULT IDebugApplicationThread11032_AsynchronousCallIntoThread(
    IDebugApplicationThread11032 *This, IDebugThreadCall32 *pptc,
    DWORD_PTR dwParam1, DWORD_PTR dwParam2, DWORD_PTR dwParam3) {
  return This->lpVtbl->AsynchronousCallIntoThread(This, pptc, dwParam1,
                                                  dwParam2, dwParam3);
}
#endif
#endif
...
DEFINE_GUID(IID_IDebugApplicationThread11064, 0x420aa4cc, 0xefd8, 0x4dac, 0x98,
            0x3b, 0x47, 0x12, 0x78, 0x26, 0x91, 0x7d);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDebugApplicationThread11064, 0x420aa4cc, 0xefd8, 0x4dac, 0x98,
                0x3b, 0x47, 0x12, 0x78, 0x26, 0x91, 0x7d)
#endif
#else
typedef struct IDebugApplicationThread11064Vtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDebugApplicationThread11064 *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IDebugApplicationThread11064 *This);
  ULONG(STDMETHODCALLTYPE *Release)(IDebugApplicationThread11064 *This);
  /*** IDebugApplicationThread11064 methods ***/
  HRESULT(STDMETHODCALLTYPE *GetActiveThreadRequestCount)(
      IDebugApplicationThread11064 *This, UINT *puiThreadRequests);
  HRESULT(STDMETHODCALLTYPE *IsSuspendedForBreakPoint)(
      IDebugApplicationThread11064 *This, WINBOOL *pfIsSuspended);
  HRESULT(STDMETHODCALLTYPE *IsThreadCallable)(
      IDebugApplicationThread11064 *This, WINBOOL *pfIsCallable);
  HRESULT(STDMETHODCALLTYPE *AsynchronousCallIntoThread)(
      IDebugApplicationThread11064 *This, IDebugThreadCall64 *pptc,
      DWORD_PTR dwParam1, DWORD_PTR dwParam2, DWORD_PTR dwParam3);
  END_INTERFACE
...
/*** IDebugApplicationThread11064 methods ***/
#define IDebugApplicationThread11064_GetActiveThreadRequestCount(              \
    This, puiThreadRequests)                                                   \
  (This)->lpVtbl->GetActiveThreadRequestCount(This, puiThreadRequests)
#define IDebugApplicationThread11064_IsSuspendedForBreakPoint(This,            \
                                                              pfIsSuspended)   \
  (This)->lpVtbl->IsSuspendedForBreakPoint(This, pfIsSuspended)
#define IDebugApplicationThread11064_IsThreadCallable(This, pfIsCallable)      \
  (This)->lpVtbl->IsThreadCallable(This, pfIsCallable)
#define IDebugApplicationThread11064_AsynchronousCallIntoThread(               \
    This, pptc, dwParam1, dwParam2, dwParam3)                                  \
  (This)->lpVtbl->AsynchronousCallIntoThread(This, pptc, dwParam1, dwParam2,   \
                                             dwParam3)
#else
/*** IUnknown methods ***/
static inline HRESULT
IDebugApplicationThread11064_QueryInterface(IDebugApplicationThread11064 *This,
                                            REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IDebugApplicationThread11064_AddRef(IDebugApplicationThread11064 *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IDebugApplicationThread11064_Release(IDebugApplicationThread11064 *This) {
  return This->lpVtbl->Release(This);
}
/*** IDebugApplicationThread11064 methods ***/
static inline HRESULT IDebugApplicationThread11064_GetActiveThreadRequestCount(
    IDebugApplicationThread11064 *This, UINT *puiThreadRequests) {
  return This->lpVtbl->GetActiveThreadRequestCount(This, puiThreadRequests);
}
static inline HRESULT IDebugApplicationThread11064_IsSuspendedForBreakPoint(
    IDebugApplicationThread11064 *This, WINBOOL *pfIsSuspended) {
  return This->lpVtbl->IsSuspendedForBreakPoint(This, pfIsSuspended);
}
static inline HRESULT IDebugApplicationThread11064_IsThreadCallable(
    IDebugApplicationThread11064 *This, WINBOOL *pfIsCallable) {
  return This->lpVtbl->IsThreadCallable(This, pfIsCallable);
}
static inline HRESULT IDebugApplicationThread11064_AsynchronousCallIntoThread(
    IDebugApplicationThread11064 *This, IDebugThreadCall64 *pptc,
    DWORD_PTR dwParam1, DWORD_PTR dwParam2, DWORD_PTR dwParam3) {
  return This->lpVtbl->AsynchronousCallIntoThread(This, pptc, dwParam1,
                                                  dwParam2, dwParam3);
...
DEFINE_GUID(IID_IRemoteDebugCriticalErrorEvent110, 0x2f69c611, 0x6b14, 0x47e8,
            0x92, 0x60, 0x4b, 0xb7, 0xc5, 0x2f, 0x50, 0x4b);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("2f69c611-6b14-47e8-9260-4bb7c52f504b")
IRemoteDebugCriticalErrorEvent110 : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetErrorInfo(
      BSTR * pbstrSource, int *pMessageId, BSTR *pbstrMessage,
      IDebugDocumentContext **ppLocation) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IRemoteDebugCriticalErrorEvent110, 0x2f69c611, 0x6b14, 0x47e8,
                0x92, 0x60, 0x4b, 0xb7, 0xc5, 0x2f, 0x50, 0x4b)
#endif
#else
typedef struct IRemoteDebugCriticalErrorEvent110Vtbl {
  ...
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(
      IRemoteDebugCriticalErrorEvent110 *This, REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IRemoteDebugCriticalErrorEvent110 *This);
  ULONG(STDMETHODCALLTYPE *Release)(IRemoteDebugCriticalErrorEvent110 *This);
  /*** IRemoteDebugCriticalErrorEvent110 methods ***/
  HRESULT(STDMETHODCALLTYPE *GetErrorInfo)(
      IRemoteDebugCriticalErrorEvent110 *This, BSTR *pbstrSource,
      int *pMessageId, BSTR *pbstrMessage, IDebugDocumentContext **ppLocation);
  END_INTERFACE
...
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
#define IRemoteDebugCriticalErrorEvent110_QueryInterface(This, riid,           \
                                                         ppvObject)            \
  (This)->lpVtbl->QueryInterface(This, riid, ppvObject)
...
#define IRemoteDebugCriticalErrorEvent110_Release(This)                        \
  (This)->lpVtbl->Release(This)
/*** IRemoteDebugCriticalErrorEvent110 methods ***/
#define IRemoteDebugCriticalErrorEvent110_GetErrorInfo(                        \
    This, pbstrSource, pMessageId, pbstrMessage, ppLocation)                   \
  (This)->lpVtbl->GetErrorInfo(This, pbstrSource, pMessageId, pbstrMessage,    \
                               ppLocation)
#else
/*** IUnknown methods ***/
static inline HRESULT IRemoteDebugCriticalErrorEvent110_QueryInterface(
    IRemoteDebugCriticalErrorEvent110 *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG IRemoteDebugCriticalErrorEvent110_AddRef(
    IRemoteDebugCriticalErrorEvent110 *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG IRemoteDebugCriticalErrorEvent110_Release(
    IRemoteDebugCriticalErrorEvent110 *This) {
  return This->lpVtbl->Release(This);
}
/*** IRemoteDebugCriticalErrorEvent110 methods ***/
static inline HRESULT IRemoteDebugCriticalErrorEvent110_GetErrorInfo(
    IRemoteDebugCriticalErrorEvent110 *This, BSTR *pbstrSource, int *pMessageId,
    BSTR *pbstrMessage, IDebugDocumentContext **ppLocation) {
  return This->lpVtbl->GetErrorInfo(This, pbstrSource, pMessageId, pbstrMessage,
                                    ppLocation);
}
#endif
#endif
