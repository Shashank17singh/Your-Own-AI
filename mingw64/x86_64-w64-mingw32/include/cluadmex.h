...
typedef struct IGetClusterUIInfoVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IGetClusterUIInfo *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IGetClusterUIInfo *This);
  ULONG(WINAPI *Release)(IGetClusterUIInfo *This);
  HRESULT(WINAPI *GetClusterName)(IGetClusterUIInfo *This, BSTR lpszName,
                                  LONG *pcchName);
...
#endif
#endif
HRESULT WINAPI IGetClusterUIInfo_GetClusterName_Proxy(IGetClusterUIInfo *This,
                                                      BSTR lpszName,
                                                      LONG *pcchName);
...
typedef struct IGetClusterDataInfoVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IGetClusterDataInfo *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IGetClusterDataInfo *This);
  ULONG(WINAPI *Release)(IGetClusterDataInfo *This);
  HRESULT(WINAPI *GetClusterName)(IGetClusterDataInfo *This, BSTR lpszName,
                                  LONG *pcchName);
...
#endif
#endif
HRESULT WINAPI IGetClusterDataInfo_GetClusterName_Proxy(
    IGetClusterDataInfo *This, BSTR lpszName, LONG *pcchName);
void __RPC_STUB IGetClusterDataInfo_GetClusterName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HCLUSTER WINAPI
IGetClusterDataInfo_GetClusterHandle_Proxy(IGetClusterDataInfo *This);
...
public:
  virtual HRESULT WINAPI GetObjectName(LONG lObjIndex, BSTR lpszName,
                                       LONG *pcchName) = 0;
...
typedef struct IGetClusterObjectInfoVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IGetClusterObjectInfo *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IGetClusterObjectInfo *This);
  ULONG(WINAPI *Release)(IGetClusterObjectInfo *This);
  HRESULT(WINAPI *GetObjectName)(IGetClusterObjectInfo *This, LONG lObjIndex,
                                 BSTR lpszName, LONG *pcchName);
  CLUADMEX_OBJECT_TYPE(WINAPI *GetObjectType)(IGetClusterObjectInfo *This,
                                              LONG lObjIndex);
  END_INTERFACE
...
#define IGetClusterObjectInfo_GetObjectName(This, lObjIndex, lpszName,         \
                                            pcchName)                          \
...
#endif
#endif
HRESULT WINAPI IGetClusterObjectInfo_GetObjectName_Proxy(
    IGetClusterObjectInfo *This, LONG lObjIndex, BSTR lpszName, LONG *pcchName);
void __RPC_STUB IGetClusterObjectInfo_GetObjectName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
CLUADMEX_OBJECT_TYPE WINAPI IGetClusterObjectInfo_GetObjectType_Proxy(
    IGetClusterObjectInfo *This, LONG lObjIndex);
...
typedef struct IGetClusterNodeInfoVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IGetClusterNodeInfo *This, REFIID riid,
                                  void **ppvObject);
...
#endif
#endif
HNODE WINAPI IGetClusterNodeInfo_GetNodeHandle_Proxy(IGetClusterNodeInfo *This,
                                                     LONG lObjIndex);
...
typedef struct IGetClusterGroupInfoVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IGetClusterGroupInfo *This, REFIID riid,
                                  void **ppvObject);
...
#endif
HGROUP
    WINAPI IGetClusterGroupInfo_GetGroupHandle_Proxy(IGetClusterGroupInfo *This,
                                                     LONG lObjIndex);
...
public:
  ...
  virtual HRESULT WINAPI GetResourceTypeName(LONG lObjIndex,
                                             BSTR lpszResTypeName,
                                             LONG *pcchResTypeName) = 0;
  virtual WINBOOL WINAPI GetResourceNetworkName(LONG lObjIndex,
                                                BSTR lpszNetName,
                                                ULONG *pcchNetName) = 0;
};
#else
typedef struct IGetClusterResourceInfoVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IGetClusterResourceInfo *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IGetClusterResourceInfo *This);
  ULONG(WINAPI *Release)(IGetClusterResourceInfo *This);
  HRESOURCE(WINAPI *GetResourceHandle)(IGetClusterResourceInfo *This,
                                       LONG lObjIndex);
  HRESULT(WINAPI *GetResourceTypeName)(IGetClusterResourceInfo *This,
                                       LONG lObjIndex, BSTR lpszResTypeName,
                                       LONG *pcchResTypeName);
  WINBOOL(WINAPI *GetResourceNetworkName)(IGetClusterResourceInfo *This,
                                          LONG lObjIndex, BSTR lpszNetName,
                                          ULONG *pcchNetName);
  END_INTERFACE
...
#define IGetClusterResourceInfo_GetResourceTypeName(                           \
    This, lObjIndex, lpszResTypeName, pcchResTypeName)                         \
  (This)->lpVtbl->GetResourceTypeName(This, lObjIndex, lpszResTypeName,        \
                                      pcchResTypeName)
#define IGetClusterResourceInfo_GetResourceNetworkName(                        \
    This, lObjIndex, lpszNetName, pcchNetName)                                 \
  (This)->lpVtbl->GetResourceNetworkName(This, lObjIndex, lpszNetName,         \
                                         pcchNetName)
#endif
#endif
HRESOURCE WINAPI IGetClusterResourceInfo_GetResourceHandle_Proxy(
    IGetClusterResourceInfo *This, LONG lObjIndex);
void __RPC_STUB IGetClusterResourceInfo_GetResourceHandle_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IGetClusterResourceInfo_GetResourceTypeName_Proxy(
    IGetClusterResourceInfo *This, LONG lObjIndex, BSTR lpszResTypeName,
    LONG *pcchResTypeName);
...
WINBOOL WINAPI IGetClusterResourceInfo_GetResourceNetworkName_Proxy(
    IGetClusterResourceInfo *This, LONG lObjIndex, BSTR lpszNetName,
    ULONG *pcchNetName);
...
typedef struct IGetClusterNetworkInfoVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IGetClusterNetworkInfo *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IGetClusterNetworkInfo *This);
  ULONG(WINAPI *Release)(IGetClusterNetworkInfo *This);
  HNETWORK(WINAPI *GetNetworkHandle)(IGetClusterNetworkInfo *This,
                                     LONG lObjIndex);
  END_INTERFACE
...
#endif
#endif
HNETWORK WINAPI IGetClusterNetworkInfo_GetNetworkHandle_Proxy(
    IGetClusterNetworkInfo *This, LONG lObjIndex);
...
typedef struct IGetClusterNetInterfaceInfoVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IGetClusterNetInterfaceInfo *This,
  ...
  HNETINTERFACE(WINAPI *GetNetInterfaceHandle)(
      IGetClusterNetInterfaceInfo *This, LONG lObjIndex);
  END_INTERFACE
...
typedef struct IWCPropertySheetCallbackVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IWCPropertySheetCallback *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IWCPropertySheetCallback *This);
  ULONG(WINAPI *Release)(IWCPropertySheetCallback *This);
  HRESULT(WINAPI *AddPropertySheetPage)(IWCPropertySheetCallback *This,
                                        LONG *hpage);
  END_INTERFACE
...
#endif
#endif
HRESULT WINAPI IWCPropertySheetCallback_AddPropertySheetPage_Proxy(
    IWCPropertySheetCallback *This, LONG *hpage);
...
public:
  virtual HRESULT WINAPI CreatePropertySheetPages(
      IUnknown *piData, IWCPropertySheetCallback *piCallback) = 0;
};
#else
typedef struct IWEExtendPropertySheetVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IWEExtendPropertySheet *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IWEExtendPropertySheet *This);
  ULONG(WINAPI *Release)(IWEExtendPropertySheet *This);
  HRESULT(WINAPI *CreatePropertySheetPages)(
      IWEExtendPropertySheet *This, IUnknown *piData,
...
#define IWEExtendPropertySheet_CreatePropertySheetPages(This, piData,          \
                                                        piCallback)            \
  (This)->lpVtbl->CreatePropertySheetPages(This, piData, piCallback)
#endif
#endif
HRESULT WINAPI IWEExtendPropertySheet_CreatePropertySheetPages_Proxy(
    IWEExtendPropertySheet *This, IUnknown *piData,
    IWCPropertySheetCallback *piCallback);
...
typedef struct IWCWizardCallbackVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IWCWizardCallback *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *EnableNext)(IWCWizardCallback *This, LONG *hpage,
                              WINBOOL bEnable);
  END_INTERFACE
...
#endif
#endif
HRESULT WINAPI IWCWizardCallback_AddWizardPage_Proxy(IWCWizardCallback *This,
                                                     LONG *hpage);
void __RPC_STUB IWCWizardCallback_AddWizardPage_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IWCWizardCallback_EnableNext_Proxy(IWCWizardCallback *This,
                                                  LONG *hpage, WINBOOL bEnable);
...
public:
  virtual HRESULT WINAPI CreateWizardPages(IUnknown *piData,
                                           IWCWizardCallback *piCallback) = 0;
};
#else
typedef struct IWEExtendWizardVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IWEExtendWizard *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IWEExtendWizard *This);
  ULONG(WINAPI *Release)(IWEExtendWizard *This);
  HRESULT(WINAPI *CreateWizardPages)(IWEExtendWizard *This, IUnknown *piData,
...
HRESULT WINAPI IWEExtendWizard_CreateWizardPages_Proxy(
    IWEExtendWizard *This, IUnknown *piData, IWCWizardCallback *piCallback);
...
public:
  virtual HRESULT WINAPI AddExtensionMenuItem(BSTR lpszName,
...
typedef struct IWCContextMenuCallbackVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IWCContextMenuCallback *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IWCContextMenuCallback *This);
  ULONG(WINAPI *Release)(IWCContextMenuCallback *This);
  HRESULT(WINAPI *AddExtensionMenuItem)(IWCContextMenuCallback *This,
                                        BSTR lpszName, BSTR lpszStatusBarText,
                                        ULONG nCommandID,
                                        ULONG nSubmenuCommandID, ULONG uFlags);
  END_INTERFACE
...
#define IWCContextMenuCallback_AddExtensionMenuItem(                           \
    This, lpszName, lpszStatusBarText, nCommandID, nSubmenuCommandID, uFlags)  \
  (This)->lpVtbl->AddExtensionMenuItem(This, lpszName, lpszStatusBarText,      \
                                       nCommandID, nSubmenuCommandID, uFlags)
#endif
#endif
HRESULT WINAPI IWCContextMenuCallback_AddExtensionMenuItem_Proxy(
    IWCContextMenuCallback *This, BSTR lpszName, BSTR lpszStatusBarText,
    ULONG nCommandID, ULONG nSubmenuCommandID, ULONG uFlags);
...
public:
  ...
  AddContextMenuItems(IUnknown *piData, IWCContextMenuCallback *piCallback) = 0;
};
#else
typedef struct IWEExtendContextMenuVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IWEExtendContextMenu *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IWEExtendContextMenu *This);
  ULONG(WINAPI *Release)(IWEExtendContextMenu *This);
  HRESULT(WINAPI *AddContextMenuItems)(IWEExtendContextMenu *This,
                                       IUnknown *piData,
...
#endif
#endif
HRESULT WINAPI IWEExtendContextMenu_AddContextMenuItems_Proxy(
    IWEExtendContextMenu *This, IUnknown *piData,
    IWCContextMenuCallback *piCallback);
...
typedef struct IWEInvokeCommandVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IWEInvokeCommand *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IWEInvokeCommand *This);
  ULONG(WINAPI *Release)(IWEInvokeCommand *This);
  HRESULT(WINAPI *InvokeCommand)(IWEInvokeCommand *This, ULONG nCommandID,
                                 IUnknown *piData);
  END_INTERFACE
...
#endif
#endif
HRESULT WINAPI IWEInvokeCommand_InvokeCommand_Proxy(IWEInvokeCommand *This,
                                                    ULONG nCommandID,
                                                    IUnknown *piData);
...
typedef struct IWCWizard97CallbackVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IWCWizard97Callback *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *EnableNext)(IWCWizard97Callback *This, LONG *hpage,
                              WINBOOL bEnable);
  END_INTERFACE
...
#endif
HRESULT
    WINAPI IWCWizard97Callback_AddWizard97Page_Proxy(IWCWizard97Callback *This,
                                                     LONG *hpage);
void __RPC_STUB IWCWizard97Callback_AddWizard97Page_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IWCWizard97Callback_EnableNext_Proxy(IWCWizard97Callback *This,
                                                    LONG *hpage,
                                                    WINBOOL bEnable);
...
public:
  virtual HRESULT WINAPI
  CreateWizard97Pages(IUnknown *piData, IWCWizard97Callback *piCallback) = 0;
};
#else
typedef struct IWEExtendWizard97Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IWEExtendWizard97 *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IWEExtendWizard97 *This);
  ULONG(WINAPI *Release)(IWEExtendWizard97 *This);
  HRESULT(WINAPI *CreateWizard97Pages)(IWEExtendWizard97 *This,
                                       IUnknown *piData,
...
#endif
#endif
HRESULT WINAPI IWEExtendWizard97_CreateWizard97Pages_Proxy(
    IWEExtendWizard97 *This, IUnknown *piData, IWCWizard97Callback *piCallback);
