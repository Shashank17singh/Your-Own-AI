...
DEFINE_GUID(IID_IEnumDMO, 0x2c3cd98a, 0x2bfa, 0x4a53, 0x9c, 0x27, 0x52, 0x49,
            0xba, 0x64, 0xba, 0x0f);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("2c3cd98a-2bfa-4a53-9c27-5249ba64ba0f")
IEnumDMO : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE Next(DWORD cItemsToFetch, CLSID * pCLSID,
                                         WCHAR * *Names,
...
__CRT_UUID_DECL(IEnumDMO, 0x2c3cd98a, 0x2bfa, 0x4a53, 0x9c, 0x27, 0x52, 0x49,
                0xba, 0x64, 0xba, 0x0f)
#endif
#else
typedef struct IEnumDMOVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IEnumDMO *This, REFIID riid,
                                             void **ppvObject);
...
interface IEnumDMO { CONST_VTBL IEnumDMOVtbl *lpVtbl; };
#ifdef COBJMACROS
...
#else
/*** IUnknown methods ***/
static inline HRESULT IEnumDMO_QueryInterface(IEnumDMO *This, REFIID riid,
                                              void **ppvObject) {
...
/*** IEnumDMO methods ***/
static inline HRESULT IEnumDMO_Next(IEnumDMO *This, DWORD cItemsToFetch,
                                    CLSID *pCLSID, WCHAR **Names,
                                    DWORD *pcItemsFetched) {
...
DEFINE_GUID(IID_IMediaBuffer, 0x59eff8b9, 0x938c, 0x4a26, 0x82, 0xf2, 0x95,
            0xcb, 0x84, 0xcd, 0xc8, 0x37);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IMediaBuffer : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE GetBufferAndLength(BYTE * *ppBuffer,
                                                       DWORD * pcbLength) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IMediaBuffer, 0x59eff8b9, 0x938c, 0x4a26, 0x82, 0xf2, 0x95,
                0xcb, 0x84, 0xcd, 0xc8, 0x37)
#endif
#else
typedef struct IMediaBufferVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IMediaBuffer *This, REFIID riid,
                                             void **ppvObject);
...
interface IMediaBuffer { CONST_VTBL IMediaBufferVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
IMediaBuffer_QueryInterface(IMediaBuffer *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IMediaBuffer methods ***/
static inline HRESULT IMediaBuffer_SetLength(IMediaBuffer *This,
                                             DWORD cbLength) {
  return This->lpVtbl->SetLength(This, cbLength);
}
static inline HRESULT IMediaBuffer_GetMaxLength(IMediaBuffer *This,
                                                DWORD *pcbMaxLength) {
  return This->lpVtbl->GetMaxLength(This, pcbMaxLength);
}
static inline HRESULT IMediaBuffer_GetBufferAndLength(IMediaBuffer *This,
                                                      BYTE **ppBuffer,
                                                      DWORD *pcbLength) {
...
DEFINE_GUID(IID_IMediaObject, 0xd8ad0f58, 0x5494, 0x4102, 0x97, 0xc5, 0xec,
            0x79, 0x8e, 0x59, 0xbc, 0xf4);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IMediaObject : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE GetOutputStreamInfo(
      DWORD dwOutputStreamIndex, DWORD * pdwFlags) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetInputType(
      DWORD dwInputStreamIndex, DWORD dwTypeIndex, DMO_MEDIA_TYPE * pmt) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetOutputType(
      DWORD dwOutputStreamIndex, DWORD dwTypeIndex, DMO_MEDIA_TYPE * pmt) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetInputType(
      DWORD dwInputStreamIndex, const DMO_MEDIA_TYPE *pmt, DWORD dwFlags) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetOutputType(
      DWORD dwOutputStreamIndex, const DMO_MEDIA_TYPE *pmt, DWORD dwFlags) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetInputCurrentType(
      DWORD dwInputStreamIndex, DMO_MEDIA_TYPE * pmt) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetOutputCurrentType(
      DWORD dwOutputStreamIndex, DMO_MEDIA_TYPE * pmt) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetInputSizeInfo(
      DWORD dwInputStreamIndex, DWORD * pcbSize, DWORD * pcbMaxLookahead,
      DWORD * pcbAlignment) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetOutputSizeInfo(
      DWORD dwOutputStreamIndex, DWORD * pcbSize, DWORD * pcbAlignment) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetInputMaxLatency(
      DWORD dwInputStreamIndex, REFERENCE_TIME * prtMaxLatency) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE AllocateStreamingResources() = 0;
  virtual HRESULT STDMETHODCALLTYPE FreeStreamingResources() = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE ProcessOutput(
      ...
      DMO_OUTPUT_DATA_BUFFER * pOutputBuffers, DWORD * pdwStatus) = 0;
  virtual HRESULT STDMETHODCALLTYPE Lock(LONG bLock) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IMediaObject, 0xd8ad0f58, 0x5494, 0x4102, 0x97, 0xc5, 0xec,
                0x79, 0x8e, 0x59, 0xbc, 0xf4)
#endif
#else
typedef struct IMediaObjectVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IMediaObject *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetInputStreamInfo)(IMediaObject *This,
                                                 DWORD dwInputStreamIndex,
                                                 DWORD *pdwFlags);
  HRESULT(STDMETHODCALLTYPE *GetOutputStreamInfo)(IMediaObject *This,
                                                  DWORD dwOutputStreamIndex,
                                                  DWORD *pdwFlags);
  HRESULT(STDMETHODCALLTYPE *GetInputType)(IMediaObject *This,
                                           DWORD dwInputStreamIndex,
                                           DWORD dwTypeIndex,
                                           DMO_MEDIA_TYPE *pmt);
  HRESULT(STDMETHODCALLTYPE *GetOutputType)(IMediaObject *This,
                                            DWORD dwOutputStreamIndex,
                                            DWORD dwTypeIndex,
                                            DMO_MEDIA_TYPE *pmt);
  HRESULT(STDMETHODCALLTYPE *SetInputType)(IMediaObject *This,
                                           DWORD dwInputStreamIndex,
                                           const DMO_MEDIA_TYPE *pmt,
                                           DWORD dwFlags);
  HRESULT(STDMETHODCALLTYPE *SetOutputType)(IMediaObject *This,
                                            DWORD dwOutputStreamIndex,
                                            const DMO_MEDIA_TYPE *pmt,
                                            DWORD dwFlags);
  HRESULT(STDMETHODCALLTYPE *GetInputCurrentType)(IMediaObject *This,
                                                  DWORD dwInputStreamIndex,
                                                  DMO_MEDIA_TYPE *pmt);
  HRESULT(STDMETHODCALLTYPE *GetOutputCurrentType)(IMediaObject *This,
                                                   DWORD dwOutputStreamIndex,
                                                   DMO_MEDIA_TYPE *pmt);
  HRESULT(STDMETHODCALLTYPE *GetInputSizeInfo)(IMediaObject *This,
                                               DWORD dwInputStreamIndex,
                                               DWORD *pcbSize,
                                               DWORD *pcbMaxLookahead,
                                               DWORD *pcbAlignment);
  HRESULT(STDMETHODCALLTYPE *GetOutputSizeInfo)(IMediaObject *This,
                                                DWORD dwOutputStreamIndex,
                                                DWORD *pcbSize,
                                                DWORD *pcbAlignment);
  HRESULT(STDMETHODCALLTYPE *GetInputMaxLatency)(IMediaObject *This,
                                                 DWORD dwInputStreamIndex,
                                                 REFERENCE_TIME *prtMaxLatency);
  HRESULT(STDMETHODCALLTYPE *SetInputMaxLatency)(IMediaObject *This,
                                                 DWORD dwInputStreamIndex,
                                                 REFERENCE_TIME rtMaxLatency);
  HRESULT(STDMETHODCALLTYPE *Flush)(IMediaObject *This);
  HRESULT(STDMETHODCALLTYPE *Discontinuity)(IMediaObject *This,
                                            DWORD dwInputStreamIndex);
  ...
  HRESULT(STDMETHODCALLTYPE *GetInputStatus)(IMediaObject *This,
                                             DWORD dwInputStreamIndex,
                                             DWORD *dwFlags);
  HRESULT(STDMETHODCALLTYPE *ProcessInput)(IMediaObject *This,
                                           DWORD dwInputStreamIndex,
...
interface IMediaObject { CONST_VTBL IMediaObjectVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
IMediaObject_QueryInterface(IMediaObject *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IMediaObject methods ***/
static inline HRESULT IMediaObject_GetStreamCount(IMediaObject *This,
                                                  DWORD *pcInputStreams,
                                                  DWORD *pcOutputStreams) {
  return This->lpVtbl->GetStreamCount(This, pcInputStreams, pcOutputStreams);
}
static inline HRESULT IMediaObject_GetInputStreamInfo(IMediaObject *This,
                                                      DWORD dwInputStreamIndex,
                                                      DWORD *pdwFlags) {
  return This->lpVtbl->GetInputStreamInfo(This, dwInputStreamIndex, pdwFlags);
}
static inline HRESULT
IMediaObject_GetOutputStreamInfo(IMediaObject *This, DWORD dwOutputStreamIndex,
                                 DWORD *pdwFlags) {
  return This->lpVtbl->GetOutputStreamInfo(This, dwOutputStreamIndex, pdwFlags);
}
static inline HRESULT IMediaObject_GetInputType(IMediaObject *This,
                                                DWORD dwInputStreamIndex,
                                                DWORD dwTypeIndex,
                                                DMO_MEDIA_TYPE *pmt) {
  return This->lpVtbl->GetInputType(This, dwInputStreamIndex, dwTypeIndex, pmt);
}
static inline HRESULT IMediaObject_GetOutputType(IMediaObject *This,
                                                 DWORD dwOutputStreamIndex,
                                                 DWORD dwTypeIndex,
                                                 DMO_MEDIA_TYPE *pmt) {
  return This->lpVtbl->GetOutputType(This, dwOutputStreamIndex, dwTypeIndex,
                                     pmt);
}
static inline HRESULT IMediaObject_SetInputType(IMediaObject *This,
                                                DWORD dwInputStreamIndex,
                                                const DMO_MEDIA_TYPE *pmt,
                                                DWORD dwFlags) {
  return This->lpVtbl->SetInputType(This, dwInputStreamIndex, pmt, dwFlags);
}
static inline HRESULT IMediaObject_SetOutputType(IMediaObject *This,
                                                 DWORD dwOutputStreamIndex,
                                                 const DMO_MEDIA_TYPE *pmt,
                                                 DWORD dwFlags) {
  return This->lpVtbl->SetOutputType(This, dwOutputStreamIndex, pmt, dwFlags);
}
static inline HRESULT IMediaObject_GetInputCurrentType(IMediaObject *This,
                                                       DWORD dwInputStreamIndex,
                                                       DMO_MEDIA_TYPE *pmt) {
  return This->lpVtbl->GetInputCurrentType(This, dwInputStreamIndex, pmt);
}
static inline HRESULT
IMediaObject_GetOutputCurrentType(IMediaObject *This, DWORD dwOutputStreamIndex,
                                  DMO_MEDIA_TYPE *pmt) {
  return This->lpVtbl->GetOutputCurrentType(This, dwOutputStreamIndex, pmt);
}
static inline HRESULT IMediaObject_GetInputSizeInfo(IMediaObject *This,
                                                    DWORD dwInputStreamIndex,
                                                    DWORD *pcbSize,
                                                    DWORD *pcbMaxLookahead,
                                                    DWORD *pcbAlignment) {
  return This->lpVtbl->GetInputSizeInfo(This, dwInputStreamIndex, pcbSize,
                                        pcbMaxLookahead, pcbAlignment);
}
static inline HRESULT IMediaObject_GetOutputSizeInfo(IMediaObject *This,
                                                     DWORD dwOutputStreamIndex,
                                                     DWORD *pcbSize,
                                                     DWORD *pcbAlignment) {
  return This->lpVtbl->GetOutputSizeInfo(This, dwOutputStreamIndex, pcbSize,
                                         pcbAlignment);
}
static inline HRESULT
IMediaObject_GetInputMaxLatency(IMediaObject *This, DWORD dwInputStreamIndex,
                                REFERENCE_TIME *prtMaxLatency) {
  return This->lpVtbl->GetInputMaxLatency(This, dwInputStreamIndex,
                                          prtMaxLatency);
}
static inline HRESULT
IMediaObject_SetInputMaxLatency(IMediaObject *This, DWORD dwInputStreamIndex,
                                REFERENCE_TIME rtMaxLatency) {
  return This->lpVtbl->SetInputMaxLatency(This, dwInputStreamIndex,
                                          rtMaxLatency);
}
static inline HRESULT IMediaObject_Flush(IMediaObject *This) {
  return This->lpVtbl->Flush(This);
}
static inline HRESULT IMediaObject_Discontinuity(IMediaObject *This,
                                                 DWORD dwInputStreamIndex) {
  return This->lpVtbl->Discontinuity(This, dwInputStreamIndex);
}
static inline HRESULT
IMediaObject_AllocateStreamingResources(IMediaObject *This) {
...
static inline HRESULT IMediaObject_GetInputStatus(IMediaObject *This,
                                                  DWORD dwInputStreamIndex,
                                                  DWORD *dwFlags) {
  return This->lpVtbl->GetInputStatus(This, dwInputStreamIndex, dwFlags);
}
static inline HRESULT IMediaObject_ProcessInput(
  ...
  return This->lpVtbl->ProcessInput(This, dwInputStreamIndex, pBuffer, dwFlags,
                                    rtTimestamp, rtTimelength);
}
static inline HRESULT IMediaObject_ProcessOutput(
    IMediaObject *This, DWORD dwFlags, DWORD cOutputBufferCount,
    DMO_OUTPUT_DATA_BUFFER *pOutputBuffers, DWORD *pdwStatus) {
  return This->lpVtbl->ProcessOutput(This, dwFlags, cOutputBufferCount,
                                     pOutputBuffers, pdwStatus);
}
...
DEFINE_GUID(IID_IMediaObjectInPlace, 0x651b9ad0, 0x0fc7, 0x4aa9, 0x95, 0x38,
            0xd8, 0x99, 0x31, 0x01, 0x07, 0x41);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("651b9ad0-0fc7-4aa9-9538-d89931010741")
IMediaObjectInPlace : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE Process(ULONG ulSize, BYTE * pData,
                                            REFERENCE_TIME refTimeStart,
                                            DWORD dwFlags) = 0;
  virtual HRESULT STDMETHODCALLTYPE Clone(IMediaObjectInPlace *
                                          *ppMediaObject) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetLatency(REFERENCE_TIME *
                                               pLatencyTime) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IMediaObjectInPlace, 0x651b9ad0, 0x0fc7, 0x4aa9, 0x95, 0x38,
                0xd8, 0x99, 0x31, 0x01, 0x07, 0x41)
#endif
#else
typedef struct IMediaObjectInPlaceVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *Process)(IMediaObjectInPlace *This, ULONG ulSize,
                                      BYTE *pData, REFERENCE_TIME refTimeStart,
                                      DWORD dwFlags);
...
interface IMediaObjectInPlace { CONST_VTBL IMediaObjectInPlaceVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
IMediaObjectInPlace_QueryInterface(IMediaObjectInPlace *This, REFIID riid,
                                   void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IMediaObjectInPlace methods ***/
static inline HRESULT IMediaObjectInPlace_Process(IMediaObjectInPlace *This,
                                                  ULONG ulSize, BYTE *pData,
                                                  REFERENCE_TIME refTimeStart,
                                                  DWORD dwFlags) {
  return This->lpVtbl->Process(This, ulSize, pData, refTimeStart, dwFlags);
}
static inline HRESULT
IMediaObjectInPlace_Clone(IMediaObjectInPlace *This,
                          IMediaObjectInPlace **ppMediaObject) {
  return This->lpVtbl->Clone(This, ppMediaObject);
}
static inline HRESULT
IMediaObjectInPlace_GetLatency(IMediaObjectInPlace *This,
                               REFERENCE_TIME *pLatencyTime) {
...
DEFINE_GUID(IID_IDMOQualityControl, 0x65abea96, 0xcf36, 0x453f, 0xaf, 0x8a,
            0x70, 0x5e, 0x98, 0xf1, 0x62, 0x60);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("65abea96-cf36-453f-af8a-705e98f16260")
IDMOQualityControl : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE SetNow(REFERENCE_TIME now) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetStatus(DWORD flags) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetStatus(DWORD * flags) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDMOQualityControl, 0x65abea96, 0xcf36, 0x453f, 0xaf, 0x8a,
                0x70, 0x5e, 0x98, 0xf1, 0x62, 0x60)
#endif
#else
typedef struct IDMOQualityControlVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *SetNow)(IDMOQualityControl *This,
                                     REFERENCE_TIME now);
  HRESULT(STDMETHODCALLTYPE *SetStatus)(IDMOQualityControl *This, DWORD flags);
  HRESULT(STDMETHODCALLTYPE *GetStatus)(IDMOQualityControl *This, DWORD *flags);
  END_INTERFACE
} IDMOQualityControlVtbl;
interface IDMOQualityControl { CONST_VTBL IDMOQualityControlVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define IDMOQualityControl_SetStatus(This, flags)                              \
  (This)->lpVtbl->SetStatus(This, flags)
#define IDMOQualityControl_GetStatus(This, flags)                              \
  (This)->lpVtbl->GetStatus(This, flags)
#else
/*** IUnknown methods ***/
static inline HRESULT
IDMOQualityControl_QueryInterface(IDMOQualityControl *This, REFIID riid,
                                  void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IDMOQualityControl methods ***/
static inline HRESULT IDMOQualityControl_SetNow(IDMOQualityControl *This,
                                                REFERENCE_TIME now) {
  return This->lpVtbl->SetNow(This, now);
}
static inline HRESULT IDMOQualityControl_SetStatus(IDMOQualityControl *This,
                                                   DWORD flags) {
  return This->lpVtbl->SetStatus(This, flags);
}
static inline HRESULT IDMOQualityControl_GetStatus(IDMOQualityControl *This,
                                                   DWORD *flags) {
...
DEFINE_GUID(IID_IDMOVideoOutputOptimizations, 0xbe8f4f4e, 0x5b16, 0x4d29, 0xb3,
            0x50, 0x7f, 0x6b, 0x5d, 0x92, 0x98, 0xac);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IDMOVideoOutputOptimizations : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE QueryOperationModePreferences(
      ULONG index, DWORD * flags) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetOperationMode(ULONG index,
                                                     DWORD flags) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetCurrentOperationMode(ULONG index,
                                                            DWORD * flags) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetCurrentSampleRequirements(
      ULONG index, DWORD * flags) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDMOVideoOutputOptimizations, 0xbe8f4f4e, 0x5b16, 0x4d29, 0xb3,
                0x50, 0x7f, 0x6b, 0x5d, 0x92, 0x98, 0xac)
#endif
#else
typedef struct IDMOVideoOutputOptimizationsVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryOperationModePreferences)(
      IDMOVideoOutputOptimizations *This, ULONG index, DWORD *flags);
...
#define IDMOVideoOutputOptimizations_QueryOperationModePreferences(            \
    This, index, flags)                                                        \
  (This)->lpVtbl->QueryOperationModePreferences(This, index, flags)
#define IDMOVideoOutputOptimizations_SetOperationMode(This, index, flags)      \
  (This)->lpVtbl->SetOperationMode(This, index, flags)
#define IDMOVideoOutputOptimizations_GetCurrentOperationMode(This, index,      \
                                                             flags)            \
  (This)->lpVtbl->GetCurrentOperationMode(This, index, flags)
#define IDMOVideoOutputOptimizations_GetCurrentSampleRequirements(This, index, \
                                                                  flags)       \
  (This)->lpVtbl->GetCurrentSampleRequirements(This, index, flags)
#else
/*** IUnknown methods ***/
static inline HRESULT
IDMOVideoOutputOptimizations_QueryInterface(IDMOVideoOutputOptimizations *This,
                                            REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IDMOVideoOutputOptimizations_AddRef(IDMOVideoOutputOptimizations *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IDMOVideoOutputOptimizations_Release(IDMOVideoOutputOptimizations *This) {
  return This->lpVtbl->Release(This);
}
/*** IDMOVideoOutputOptimizations methods ***/
static inline HRESULT
IDMOVideoOutputOptimizations_QueryOperationModePreferences(
    IDMOVideoOutputOptimizations *This, ULONG index, DWORD *flags) {
  return This->lpVtbl->QueryOperationModePreferences(This, index, flags);
}
static inline HRESULT IDMOVideoOutputOptimizations_SetOperationMode(
    IDMOVideoOutputOptimizations *This, ULONG index, DWORD flags) {
  return This->lpVtbl->SetOperationMode(This, index, flags);
}
static inline HRESULT IDMOVideoOutputOptimizations_GetCurrentOperationMode(
    IDMOVideoOutputOptimizations *This, ULONG index, DWORD *flags) {
  return This->lpVtbl->GetCurrentOperationMode(This, index, flags);
}
static inline HRESULT IDMOVideoOutputOptimizations_GetCurrentSampleRequirements(
    IDMOVideoOutputOptimizations *This, ULONG index, DWORD *flags) {
