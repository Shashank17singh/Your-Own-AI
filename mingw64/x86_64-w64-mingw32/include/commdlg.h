...
#ifdef DEFINE_GUID
DEFINE_GUID(IID_IPrintDialogCallback, 0x5852a2c3, 0x6530, 0x11d1, 0xb6, 0xa3,
            0x0, 0x0, 0xf8, 0x75, 0x7b, 0xf9);
DEFINE_GUID(IID_IPrintDialogServices, 0x509aaeda, 0x5639, 0x11d1, 0xb6, 0xa1,
            0x0, 0x0, 0xf8, 0x75, 0x7b, 0xf9);
#endif
...
#define OPENFILENAME_SIZE_VERSION_400                                          \
  __MINGW_NAME_AW(OPENFILENAME_SIZE_VERSION_400)
...
#define CommDlg_OpenSave_GetFolderPath                                         \
  __MINGW_NAME_AW(CommDlg_OpenSave_GetFolderPath)
...
DECLARE_INTERFACE_(IPrintDialogCallback, IUnknown) {
  ...
  STDMETHOD(HandleMessage)(THIS_ HWND hDlg, UINT uMsg, WPARAM wParam,
                           LPARAM lParam, LRESULT * pResult) PURE;
};
#undef INTERFACE
