...
STDAPI_(DWORD)
PssCaptureSnapshot(HANDLE ProcessHandle, PSS_CAPTURE_FLAGS CaptureFlags,
                   DWORD ThreadContextFlags, HPSS *SnapshotHandle);
STDAPI_(DWORD) PssFreeSnapshot(HANDLE ProcessHandle, HPSS SnapshotHandle);
STDAPI_(DWORD)
PssQuerySnapshot(HPSS SnapshotHandle,
                 PSS_QUERY_INFORMATION_CLASS InformationClass, void *Buffer,
                 DWORD BufferLength);
STDAPI_(DWORD)
PssWalkSnapshot(HPSS SnapshotHandle,
                PSS_WALK_INFORMATION_CLASS InformationClass,
                HPSSWALK WalkMarkerHandle, void *Buffer, DWORD BufferLength);
STDAPI_(DWORD)
PssDuplicateSnapshot(HANDLE SourceProcessHandle, HPSS SnapshotHandle,
                     HANDLE TargetProcessHandle, HPSS *TargetSnapshotHandle,
...
STDAPI_(DWORD)
PssWalkMarkerGetPosition(HPSSWALK WalkMarkerHandle, ULONG_PTR *Position);
STDAPI_(DWORD)
PssWalkMarkerSetPosition(HPSSWALK WalkMarkerHandle, ULONG_PTR Position);
