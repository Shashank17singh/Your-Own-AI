...
WINBOOL WINAPI CryptCATAdminAcquireContext2(HCATADMIN *, const GUID *,
                                            const WCHAR *,
                                            const CERT_STRONG_SIGN_PARA *,
                                            DWORD);
HCATINFO WINAPI CryptCATAdminAddCatalog(HCATADMIN, PWSTR, PWSTR, DWORD);
WINBOOL WINAPI CryptCATAdminCalcHashFromFileHandle(HANDLE, DWORD *, BYTE *,
                                                   DWORD);
WINBOOL WINAPI CryptCATAdminCalcHashFromFileHandle2(HCATADMIN, HANDLE, DWORD *,
                                                    BYTE *, DWORD);
HCATINFO WINAPI CryptCATAdminEnumCatalogFromHash(HCATADMIN, BYTE *, DWORD,
                                                 DWORD, HCATINFO *);
...
WINBOOL WINAPI CryptCATAdminResolveCatalogPath(HCATADMIN, WCHAR *,
                                               CATALOG_INFO *, DWORD);
WINBOOL WINAPI CryptCATCatalogInfoFromContext(HCATINFO, CATALOG_INFO *, DWORD);
WINBOOL WINAPI CryptCATCDFClose(CRYPTCATCDF *);
CRYPTCATATTRIBUTE *WINAPI CryptCATCDFEnumCatAttributes(
    CRYPTCATCDF *, CRYPTCATATTRIBUTE *, PFN_CDF_PARSE_ERROR_CALLBACK);
LPWSTR WINAPI CryptCATCDFEnumMembersByCDFTagEx(CRYPTCATCDF *, LPWSTR,
                                               PFN_CDF_PARSE_ERROR_CALLBACK,
                                               CRYPTCATMEMBER **, WINBOOL,
                                               LPVOID);
...
CRYPTCATATTRIBUTE *WINAPI CryptCATPutAttrInfo(HANDLE catalog,
                                              ...
                                              WCHAR *name, DWORD flags,
                                              DWORD size, BYTE *data);
CRYPTCATATTRIBUTE *WINAPI CryptCATPutCatAttrInfo(HANDLE catalog, WCHAR *name,
                                                 DWORD flags, DWORD size,
                                                 BYTE *data);
CRYPTCATMEMBER *WINAPI CryptCATPutMemberInfo(HANDLE catalog, WCHAR *filename,
                                             WCHAR *member, GUID *subject,
