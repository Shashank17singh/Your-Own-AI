...
DEFINE_GUID(IID_ISimpleDataConverter, 0x78667670, 0x3C3D, 0x11d2, 0x91, 0xF9,
            0x00, 0x60, 0x97, 0xC9, 0x7F, 0x9B);
#if defined(__cplusplus) && !defined(CINTERFACE)
struct ISimpleDataConverter : public IUnknown {
public:
  virtual HRESULT WINAPI ConvertData(VARIANT varSrc, __LONG32 vtDest,
...
typedef struct ISimpleDataConverterVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ISimpleDataConverter *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ISimpleDataConverter *This);
  ULONG(WINAPI *Release)(ISimpleDataConverter *This);
  HRESULT(WINAPI *ConvertData)(ISimpleDataConverter *This, VARIANT varSrc,
                               __LONG32 vtDest, IUnknown *pUnknownElement,
                               VARIANT *pvarDest);
  HRESULT(WINAPI *CanConvertData)(ISimpleDataConverter *This, __LONG32 vt1,
                                  __LONG32 vt2);
  END_INTERFACE
...
#define ISimpleDataConverter_ConvertData(This, varSrc, vtDest,                 \
                                         pUnknownElement, pvarDest)            \
...
#endif
#endif
HRESULT WINAPI ISimpleDataConverter_ConvertData_Proxy(
    ISimpleDataConverter *This, VARIANT varSrc, __LONG32 vtDest,
    IUnknown *pUnknownElement, VARIANT *pvarDest);
...
HRESULT WINAPI ISimpleDataConverter_CanConvertData_Proxy(
