...
WINPATHCCHAPI HRESULT APIENTRY PathAllocCombine(PCWSTR pszPathIn,
                                                PCWSTR pszMore,
...
WINPATHCCHAPI HRESULT APIENTRY PathAllocCanonicalize(PCWSTR pszPathIn,
                                                     unsigned long dwFlags,
                                                     PWSTR *ppszPathOut);
WINPATHCCHAPI HRESULT APIENTRY PathCchAddBackslash(PWSTR pszPath,
                                                   size_t cchPath);
WINPATHCCHAPI HRESULT APIENTRY PathCchAddBackslashEx(PWSTR pszPath,
                                                     size_t cchPath,
                                                     PWSTR *ppszEnd,
                                                     size_t *pcchRemaining);
WINPATHCCHAPI HRESULT APIENTRY PathCchAddExtension(PWSTR pszPath,
                                                   size_t cchPath,
                                                   PCWSTR pszExt);
WINPATHCCHAPI HRESULT APIENTRY PathCchAppend(PWSTR pszPath, size_t cchPath,
                                             PCWSTR pszMore);
WINPATHCCHAPI HRESULT APIENTRY PathCchAppendEx(PWSTR pszPath, size_t cchPath,
                                               PCWSTR pszMore,
                                               unsigned long dwFlags);
WINPATHCCHAPI HRESULT APIENTRY PathCchCanonicalize(PWSTR pszPathOut,
                                                   size_t cchPathOut,
                                                   PCWSTR pszPathIn);
WINPATHCCHAPI HRESULT APIENTRY PathCchCanonicalizeEx(PWSTR pszPathOut,
                                                     size_t cchPathOut,
                                                     PCWSTR pszPathIn,
                                                     unsigned long dwFlags);
WINPATHCCHAPI HRESULT APIENTRY PathCchCombine(PWSTR pszPathOut,
                                              size_t cchPathOut,
                                              PCWSTR pszPathIn, PCWSTR pszMore);
WINPATHCCHAPI HRESULT APIENTRY PathCchCombineEx(PWSTR pszPathOut,
                                                size_t cchPathOut,
                                                PCWSTR pszPathIn,
                                                PCWSTR pszMore,
                                                unsigned long dwFlags);
WINPATHCCHAPI HRESULT APIENTRY PathCchFindExtension(PCWSTR pszPath,
                                                    size_t cchPath,
                                                    PCWSTR *ppszExt);
WINPATHCCHAPI WINBOOL APIENTRY PathCchIsRoot(PCWSTR pszPath);
WINPATHCCHAPI HRESULT APIENTRY PathCchRemoveBackslashEx(PWSTR pszPath,
                                                        size_t cchPath,
                                                        PWSTR *ppszEnd,
                                                        size_t *pcchRemaining);
WINPATHCCHAPI HRESULT APIENTRY PathCchRemoveBackslash(PWSTR pszPath,
                                                      size_t cchPath);
WINPATHCCHAPI HRESULT APIENTRY PathCchRemoveExtension(PWSTR pszPath,
                                                      size_t cchPath);
WINPATHCCHAPI HRESULT APIENTRY PathCchRemoveFileSpec(PWSTR pszPath,
                                                     size_t cchPath);
WINPATHCCHAPI HRESULT APIENTRY PathCchRenameExtension(PWSTR pszPath,
                                                      size_t cchPath,
                                                      PCWSTR pszExt);
WINPATHCCHAPI HRESULT APIENTRY PathCchSkipRoot(PCWSTR pszPath,
                                               PCWSTR *ppszRootEnd);
WINPATHCCHAPI HRESULT APIENTRY PathCchStripPrefix(PWSTR pszPath,
                                                  size_t cchPath);
WINPATHCCHAPI HRESULT APIENTRY PathCchStripToRoot(PWSTR pszPath,
                                                  size_t cchPath);
...
#define FindPreviousBackslashWorker                                            \
  FindPreviousBackslashWorker_is_internal_to_pathcch;
...
#define PathRenameExtension                                                    \
  PathRenameExtension_instead_use_PathCchRenameExtension;
...
__CRT_INLINE HRESULT PathCchSkipRoot(PWSTR path, PWSTR *prootend) {
  return PathCchSkipRoot(const_cast<PCWSTR>(path),
                         const_cast<PCWSTR *>(prootend));
}
__CRT_INLINE HRESULT PathCchFindExtension(PWSTR path, size_t n, PWSTR *pext) {
  return PathCchFindExtension(const_cast<PCWSTR>(path), n,
                              const_cast<PCWSTR *>(pext));
}
#endif
#endif
#endif
