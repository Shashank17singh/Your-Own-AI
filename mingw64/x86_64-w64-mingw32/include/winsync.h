...
typedef enum _FILTERING_TYPE { FT_CURRENT_ITEMS_ONLY = 0 } FILTERING_TYPE;
...
DECLARE_INTERFACE_(IAsynchronousDataRetriever, IUnknown) {
  ...
  STDMETHOD_(HRESULT, GetIdParameters)(THIS_ ID_PARAMETERS * pIdParameters)
      PURE;
  STDMETHOD_(HRESULT, LoadChangeData)(THIS_ ILoadChangeContext *
                                      pLoadChangeContext) PURE;
  STDMETHOD_(HRESULT, RegisterCallback)(THIS_ IDataRetrieverCallback *
                                        pDataRetrieverCallback) PURE;
  STDMETHOD_(HRESULT, RevokeCallback)(THIS_ IDataRetrieverCallback *
                                      pDataRetrieverCallback) PURE;
  END_INTERFACE
};
#ifdef COBJMACROS
...
#define IAsynchronousDataRetriever_RegisterCallback(This,                      \
                                                    pDataRetrieverCallback)    \
  (This)->lpVtbl->RegisterCallback(This, pDataRetrieverCallback)
#define IAsynchronousDataRetriever_RevokeCallback(This,                        \
                                                  pDataRetrieverCallback)      \
...
DECLARE_INTERFACE_(IChangeConflict, IUnknown) {
  ...
  STDMETHOD_(HRESULT, GetDestinationProviderConflictingChange)(
      THIS_ ISyncChange * *ppConflictingChange) PURE;
  STDMETHOD_(HRESULT, GetDestinationProviderConflictingData)(
      THIS_ IUnknown * *ppConflictingData) PURE;
  STDMETHOD_(HRESULT, GetResolveActionForChange)(THIS_ SYNC_RESOLVE_ACTION *
                                                 pResolveAction) PURE;
  STDMETHOD_(HRESULT, GetResolveActionForChangeUnit)(
      THIS_ ISyncChangeUnit * pChangeUnit, SYNC_RESOLVE_ACTION * pResolveAction)
      PURE;
  STDMETHOD_(HRESULT, GetSourceProviderConflictingChange)(THIS_ ISyncChange *
                                                          *ppSyncChange) PURE;
  STDMETHOD_(HRESULT, GetSourceProviderConflictingData)(
      THIS_ IUnknown * *ppConflictingData) PURE;
  STDMETHOD_(HRESULT, SetResolveActionForChange)(
      THIS_ SYNC_RESOLVE_ACTION resolveAction) PURE;
  STDMETHOD_(HRESULT, SetResolveActionForChangeUnit)(
      THIS_ ISyncChangeUnit * pChangeUnit, SYNC_RESOLVE_ACTION resolveAction)
      PURE;
  END_INTERFACE
};
#ifdef COBJMACROS
...
#define IChangeConflict_GetDestinationProviderConflictingChange(               \
    This, ppConflictingChange)                                                 \
  (This)->lpVtbl->GetDestinationProviderConflictingChange(This,                \
                                                          ppConflictingChange)
#define IChangeConflict_GetDestinationProviderConflictingData(                 \
    This, ppConflictingData)                                                   \
...
#define IChangeConflict_GetResolveActionForChangeUnit(This, pChangeUnit,       \
                                                      pResolveAction)          \
  (This)->lpVtbl->GetResolveActionForChangeUnit(This, pChangeUnit,             \
                                                pResolveAction)
#define IChangeConflict_GetSourceProviderConflictingChange(This, ppSyncChange) \
  (This)->lpVtbl->GetSourceProviderConflictingChange(This, ppSyncChange)
#define IChangeConflict_GetSourceProviderConflictingData(This,                 \
                                                         ppConflictingData)    \
...
#define IChangeConflict_SetResolveActionForChangeUnit(This, pChangeUnit,       \
                                                      resolveAction)           \
  (This)->lpVtbl->SetResolveActionForChangeUnit(This, pChangeUnit,             \
                                                resolveAction)
#endif /*COBJMACROS*/
#undef INTERFACE
...
#define IChangeUnitException_GetChangeUnitId(This, pcbIdSize)                  \
...
#define IChangeUnitException_GetItemId(This, pcbIdSize)                        \
...
#define ISyncFilterInfo_Serialize(This, pcbBuffer)                             \
  (This)->lpVtbl->Serialize(This, pcbBuffer)
#endif /*COBJMACROS*/
#undef INTERFACE
...
DECLARE_INTERFACE_(IChangeUnitListFilterInfo, ISyncFilterInfo) {
  ...
  STDMETHOD_(HRESULT, GetChangeUnitId)(THIS_ DWORD dwChangeUnitIdIndex,
                                       DWORD * pcbIdSize) PURE;
  STDMETHOD_(HRESULT, GetChangeUnitIdCount)(THIS_ DWORD * pdwChangeUnitIdCount)
      PURE;
  STDMETHOD_(HRESULT, Initialize)(THIS_ const BYTE *const *ppbChangeUnitIds,
                                  DWORD dwChangeUnitCount) PURE;
  END_INTERFACE
};
#ifdef COBJMACROS
...
#define IChangeUnitListFilterInfo_Serialize(This, pcbBuffer)                   \
  (This)->lpVtbl->Serialize(This, pcbBuffer)
#define IChangeUnitListFilterInfo_GetChangeUnitId(This, dwChangeUnitIdIndex,   \
                                                  pcbIdSize)                   \
  (This)->lpVtbl->GetChangeUnitId(This, dwChangeUnitIdIndex, pcbIdSize)
#define IChangeUnitListFilterInfo_GetChangeUnitIdCount(This,                   \
                                                       pdwChangeUnitIdCount)   \
  (This)->lpVtbl->GetChangeUnitIdCount(This, pdwChangeUnitIdCount)
#define IChangeUnitListFilterInfo_Initialize(This, ppbChangeUnitIds,           \
                                             dwChangeUnitCount)                \
...
DECLARE_INTERFACE_(IClockVector, IUnknown) {
  ...
  STDMETHOD_(HRESULT, GetClockVectorElements)(THIS_ REFIID riid,
                                              void **ppiEnumClockVector) PURE;
  END_INTERFACE
};
#ifdef COBJMACROS
...
DECLARE_INTERFACE_(IConstructReplicaKeyMap, IUnknown) {
  ...
  STDMETHOD_(HRESULT, FindOrAddReplica)(THIS_ BYTE * pbReplicaId,
                                        DWORD * pdwReplicaKey) PURE;
  END_INTERFACE
};
#ifdef COBJMACROS
...
#define IConstructReplicaKeyMap_FindOrAddReplica(This, pbReplicaId,            \
                                                 pdwReplicaKey)                \
...
DECLARE_INTERFACE_(ICoreFragment, IUnknown) {
  ...
  STDMETHOD_(HRESULT, NextRange)(THIS_ DWORD * pItemIdSize,
                                 IClockVector * *piClockVector) PURE;
...
#define ICoreFragment_NextColumn(This, pChangeUnitIdSize)                      \
  (This)->lpVtbl->NextColumn(This, pChangeUnitIdSize)
#define ICoreFragment_NextRange(This, pItemIdSize, piClockVector)              \
  (This)->lpVtbl->NextRange(This, pItemIdSize, piClockVector)
...
DECLARE_INTERFACE_(ILoadChangeContext, IUnknown) {
  ...
  STDMETHOD_(HRESULT, SetRecoverableErrorOnChange)(
      THIS_ HRESULT hrError, IRecoverableErrorData * pErrorData) PURE;
  STDMETHOD_(HRESULT, SetRecoverableErrorOnChangeUnit)(
      THIS_ HRESULT hrError, ISyncChangeUnit * pChangeUnit,
      IRecoverableErrorData * pErrorData) PURE;
  END_INTERFACE
};
#ifdef COBJMACROS
...
#define ILoadChangeContext_SetRecoverableErrorOnChange(This, hrError,          \
                                                       pErrorData)             \
  (This)->lpVtbl->SetRecoverableErrorOnChange(This, hrError, pErrorData)
#define ILoadChangeContext_SetRecoverableErrorOnChangeUnit(                    \
    This, hrError, pChangeUnit, pErrorData)                                    \
  (This)->lpVtbl->SetRecoverableErrorOnChangeUnit(This, hrError, pChangeUnit,  \
                                                  pErrorData)
#endif /*COBJMACROS*/
#undef INTERFACE
...
DECLARE_INTERFACE_(ISyncChange, IUnknown) {
  ...
  STDMETHOD_(ULONG, Release)(THIS) PURE;
  /* ISyncChange methods */
  STDMETHOD_(HRESULT, GetChangeUnits)(THIS_ IEnumSyncChangeUnits * *ppEnum)
      PURE;
  STDMETHOD_(HRESULT, GetChangeVersion)(THIS_ const BYTE *pbCurrentReplicaId,
                                        SYNC_VERSION *pVersion) PURE;
  STDMETHOD_(HRESULT, GetCreationVersion)(THIS_ const BYTE *pbCurrentReplicaId,
                                          SYNC_VERSION *pVersion) PURE;
  STDMETHOD_(HRESULT, GetFlags)(THIS_ DWORD * pdwFlags) PURE;
  STDMETHOD_(HRESULT, GetLearnedKnowledge)(THIS_ ISyncKnowledge *
                                           *ppMadeWithKnowledge) PURE;
  STDMETHOD_(HRESULT, GetMadeWithKnowledge)(THIS_ ISyncKnowledge *
                                            *ppMadeWithKnowledge) PURE;
...
#define ISyncChange_GetLearnedKnowledge(This, ppMadeWithKnowledge)             \
  (This)->lpVtbl->GetLearnedKnowledge(This, ppMadeWithKnowledge)
...
#define ISyncChange_GetOwnerReplicaId(This, pcbIdSize)                         \
  (This)->lpVtbl->GetOwnerReplicaId(This, pcbIdSize)
#define ISyncChange_GetRootItemId(This, pcbIdSize)                             \
...
DECLARE_INTERFACE_(ISyncChangeUnit, IUnknown) {
  ...
  STDMETHOD_(HRESULT, GetChangeUnitId)(THIS_ DWORD * pcbIdSize) PURE;
  STDMETHOD_(HRESULT, GetChangeUnitVersion)(
      THIS_ const BYTE *pbCurrentReplicaId, SYNC_VERSION *pVersion) PURE;
...
#define ISyncChangeUnit_GetChangeUnitId(This, pcbIdSize)                       \
  (This)->lpVtbl->GetChangeUnitId(This, pcbIdSize)
#define ISyncChangeUnit_GetChangeUnitVersion(This, pbCurrentReplicaId,         \
                                             pVersion)                         \
...
DECLARE_INTERFACE_(IRecoverableErrorData, IUnknown) {
  ...
  STDMETHOD_(HRESULT, GetErrorDescription)(THIS_ DWORD * pcchErrorDescription)
      PURE;
  STDMETHOD_(HRESULT, GetItemDisplayName)(THIS_ DWORD * pcchItemDisplayName)
      PURE;
  STDMETHOD_(HRESULT, Initialize)(THIS_ LPCWSTR pcszItemDisplayName,
                                  LPCWSTR pcszErrorDescription) PURE;
  END_INTERFACE
};
#ifdef COBJMACROS
...
#define IRecoverableErrorData_GetErrorDescription(This, pcchErrorDescription)  \
  (This)->lpVtbl->GetErrorDescription(This, pcchErrorDescription)
#define IRecoverableErrorData_GetItemDisplayName(This, pcchItemDisplayName)    \
  (This)->lpVtbl->GetItemDisplayName(This, pcchItemDisplayName)
#define IRecoverableErrorData_Initialize(This, pcszItemDisplayName,            \
...
DECLARE_INTERFACE_(IEnumSyncChangeUnits, IUnknown) {
  ...
  STDMETHOD_(HRESULT, Next)(THIS_ ULONG cChanges,
                            ISyncChangeUnit * *ppChangeUnit, ULONG * pcFetched)
      PURE;
  STDMETHOD_(HRESULT, Reset)(THIS) PURE;
