...
#define IS_DMPUB_HIDDEN(dw, DMPub)                                             \
  (WINBOOL)((DWORD)(dw) & MAKE_DMPUB_HIDEBIT(DMPub))
...
typedef LONG_PTR(CALLBACK *PFNCOMPROPSHEET)(HANDLE hComPropSheet, UINT Function,
...
typedef LONG(FAR *PFNPROPSHEETUI)(PPROPSHEETUI_INFO pPSUIInfo, LPARAM lParam);
...
/* FUNCTIONS */
LONG APIENTRY CommonPropertySheetUIA(HWND hWndOwner,
                                     PFNPROPSHEETUI pfnPropSheetUI,
                                     LPARAM lParam, LPDWORD pResult);
LONG APIENTRY CommonPropertySheetUIW(HWND hWndOwner,
                                     PFNPROPSHEETUI pfnPropSheetUI,
                                     LPARAM lParam, LPDWORD pResult);
#ifdef UNICODE
...
WINBOOL
APIENTRY
SetCPSUIUserData(HWND hDlg, ULONG_PTR CPSUIUserData);
