...
#define _AMD64_
    ...
    !(defined(_X86_) || defined(__x86_64) || defined(_AMD64_) ||               \
      defined(__ia64__) || defined(__aarch64__))
#if !defined(_ARM_)
#define _ARM_
#endif
#endif /* _ARM_ */
...
#define UInt32x32To64(a, b)                                                    \
  (((ULONGLONG)((unsigned int)(a))) * ((ULONGLONG)((unsigned int)(b))))
...
#undef _rotl64
#undef _rotr64
__MINGW_EXTENSION unsigned __int64 __cdecl _rotl64(unsigned __int64 Value,
                                                   int Shift);
...
#define DEFINE_ENUM_FLAG_OPERATORS(ENUMTYPE)                                   \
  extern "C++" {                                                               \
  __MINGW_CXX11_CONSTEXPR inline ENUMTYPE operator~(ENUMTYPE a) {              \
    return ENUMTYPE(~((int)a));                                                \
  }                                                                            \
  __MINGW_CXX11_CONSTEXPR inline ENUMTYPE operator|(ENUMTYPE a, ENUMTYPE b) {  \
  ...
  __MINGW_CXX14_CONSTEXPR inline ENUMTYPE &operator|=(ENUMTYPE &a,             \
                                                      ENUMTYPE b) {            \
    return a = a | b;                                                          \
  }                                                                            \
  __MINGW_CXX14_CONSTEXPR inline ENUMTYPE &operator&=(ENUMTYPE &a,             \
...
#define SUBLANG_HAUSA_NIGERIA                                                  \
  SUBLANG_HAUSA_NIGERIA_LATIN /* SUBLANG_HAUSA_NIGERIA_LATIN is what MS        \
                                 defines */
...
#define SUBLANG_LAO_LAO_PDR                                                    \
  SUBLANG_LAO_LAO /* SUBLANG_LAO_LAO is what MS defines */
...
#define SUBLANG_SYRIAC_SYRIA                                                   \
  SUBLANG_SYRIAC /* SUBLANG_SYRIAC_SYRIA is what MSDN mentions */
...
/* SHORT InterlockedIncrement16(SHORT volatile *Addend); moved to
 * psdk_inc/intrin-impl.h */
/* SHORT InterlockedDecrement16(SHORT volatile *Addend); moved to
 * psdk_inc/intrin-impl.h */
/* SHORT InterlockedCompareExchange16(SHORT volatile *Destination,SHORT
 * ExChange,SHORT Comperand); moved to psdk_inc/intrin-impl.h */
/* LONG InterlockedIncrement(LONG volatile *Addend); moved to
 * psdk_inc/intrin-impl.h */
/* LONG InterlockedDecrement(LONG volatile *Addend); moved to
 * psdk_inc/intrin-impl.h */
/* LONG InterlockedExchange(LONG volatile *Target,LONG Value); moved to
 * psdk_inc/intrin-impl.h */
/* LONG InterlockedExchangeAdd(LONG volatile *Addend,LONG Value); moved to
 * psdk_inc/intrin-impl.h */
/* LONG InterlockedCompareExchange(LONG volatile *Destination,LONG ExChange,LONG
 * Comperand); moved to psdk_inc/intrin-impl.h */
/* LONG InterlockedAdd(LONG volatile *Addend,LONG Value); moved to
 * psdk_inc/intrin-impl.h */
/* LONG64 InterlockedIncrement64(LONG64 volatile *Addend); moved to
 * psdk_inc/intrin-impl.h */
/* LONG64 InterlockedDecrement64(LONG64 volatile *Addend); moved to
 * psdk_inc/intrin-impl.h */
/* LONG64 InterlockedExchange64(LONG64 volatile *Target,LONG64 Value); moved to
 * psdk_inc/intrin-impl.h */
/* LONG64 InterlockedExchangeAdd64(LONG64 volatile *Addend,LONG64 Value); moved
 * to psdk_inc/intrin-impl.h */
/* LONG64 InterlockedAdd64(LONG64 volatile *Addend,LONG64 Value); moved to
 * psdk_inc/intrin-impl.h */
/* LONG64 InterlockedCompareExchange64(LONG64 volatile *Destination,LONG64
 * ExChange,LONG64 Comperand); moved to psdk_inc/intrin-impl.h */
/* PVOID InterlockedCompareExchangePointer(PVOID volatile *Destination,PVOID
 * ExChange,PVOID Comperand); moved to psdk_inc/intrin-impl.h */
/* PVOID InterlockedExchangePointer(PVOID volatile *Target,PVOID Value); moved
 * to psdk_inc/intrin-impl.h */
...
/* VOID __movsb(PBYTE Destination,BYTE const *Source,SIZE_T Count); moved to
 * psdk_inc/intrin-impl.h */
/* VOID __movsw(PWORD Destination,WORD const *Source,SIZE_T Count); moved to
 * psdk_inc/intrin-impl.h */
/* VOID __movsd(PDWORD Destination,DWORD const *Source,SIZE_T Count); moved to
 * psdk_inc/intrin-impl.h */
/* VOID __movsq(PDWORD64 Destination,DWORD64 const *Source,SIZE_T Count); moved
 * to psdk_inc/intrin-impl.h */
...
DWORD64 UnsignedMultiply128(DWORD64 Multiplier, DWORD64 Multiplicand,
                            DWORD64 *HighProduct);
LONG64 MultiplyExtract128(LONG64 Multiplier, LONG64 Multiplicand, BYTE Shift);
DWORD64 UnsignedMultiplyExtract128(DWORD64 Multiplier, DWORD64 Multiplicand,
                                   BYTE Shift);
#ifndef __CRT__NO_INLINE
__CRT_INLINE LONG64 MultiplyExtract128(LONG64 Multiplier, LONG64 Multiplicand,
                                       BYTE Shift) {
...
/* void __writegsbyte(unsigned __LONG32 Offset,unsigned char Data); moved to
 * psdk_inc/intrin-impl.h */
/* void __writegsword(unsigned __LONG32 Offset,unsigned short Data); moved to
 * psdk_inc/intrin-impl.h */
/* void __writegsdword(unsigned __LONG32 Offset,unsigned __LONG32 Data); moved
 * to psdk_inc/intrin-impl.h */
#ifdef __cplusplus
}
#endif
...
typedef DWORD (*POUT_OF_PROCESS_FUNCTION_TABLE_CALLBACK)(
    HANDLE Process, PVOID TableAddress, PDWORD Entries,
...
typedef struct _IMAGE_ARM_RUNTIME_FUNCTION_ENTRY RUNTIME_FUNCTION,
    *PRUNTIME_FUNCTION;
typedef PRUNTIME_FUNCTION (*PGET_RUNTIME_FUNCTION_CALLBACK)(DWORD ControlPc,
                                                            PVOID Context);
#define UNW_FLAG_NHANDLER 0x0
#define UNW_FLAG_EHANDLER 0x1
#define UNW_FLAG_UHANDLER 0x2
...
#define CONTEXT_ARM64_FULL                                                     \
  (CONTEXT_ARM64_CONTROL | CONTEXT_ARM64_INTEGER | CONTEXT_ARM64_FLOATING_POINT)
#define CONTEXT_ARM64_ALL                                                      \
  (CONTEXT_ARM64_CONTROL | CONTEXT_ARM64_INTEGER |                             \
   CONTEXT_ARM64_FLOATING_POINT | CONTEXT_ARM64_DEBUG_REGISTERS |              \
   CONTEXT_ARM64_X18)
...
FORCEINLINE VOID MemoryBarrier(VOID) __buildmemorybarrier()
...
#endif /* end of _X86_ */
/* LONG WINAPI InterlockedIncrement(LONG volatile *); moved to
 * psdk_inc/intrin-impl.h */
/* LONG WINAPI InterlockedDecrement(LONG volatile *); moved to
 * psdk_inc/intrin-impl.h */
/* LONG WINAPI InterlockedExchange(LONG volatile *, LONG); moved to
 * psdk_inc/intrin-impl.h */
...
#define OUT_OF_PROCESS_FUNCTION_TABLE_CALLBACK_EXPORT_NAME                     \
  "OutOfProcessFunctionTableCallback"
VOID __jump_unwind(ULONGLONG TargetMsFrame, ULONGLONG TargetBsFrame,
                   ULONGLONG TargetPc);
#endif /* end of _IA64_ */
...
#ifdef __ia64__
NTSYSAPI VOID NTAPI RtlUnwind2(FRAME_POINTERS TargetFrame, PVOID TargetIp,
                               PEXCEPTION_RECORD ExceptionRecord,
...
#define SECURITY_EDGE_CLOUD_INFRASTRUCTURE_SERVICE_ID_BASE_RID                 \
  (__MSABI_LONG(0x00000062))
...
#define SE_APP_SILO_VOLUME_ROOT_MINIMAL_CAPABILITY                             \
  L"isolatedWin32-volumeRootMinimal"
#define SE_APP_SILO_PROFILES_ROOT_MINIMAL_CAPABILITY                           \
...
#define TOKEN_TRUST_CONSTRAINT_MASK                                            \
...
#define TOKEN_INTEGRITY_LEVEL_MAX_SIZE                                         \
  ((((DWORD)(sizeof(TOKEN_MANDATORY_LABEL)) + sizeof(PVOID) - 1) &             \
    ~(sizeof(PVOID) - 1)) +                                                    \
...
#ifndef __WIDL__
#define TOKEN_APPCONTAINER_SID_MAX_SIZE                                        \
  (sizeof(TOKEN_APPCONTAINER_INFORMATION) + SECURITY_MAX_SID_SIZE)
#endif
...
#define CLAIM_SECURITY_ATTRIBUTE_VALID_FLAGS                                   \
  (CLAIM_SECURITY_ATTRIBUTE_NON_INHERITABLE |                                  \
   ...
   CLAIM_SECURITY_ATTRIBUTE_DISABLED | CLAIM_SECURITY_ATTRIBUTE_MANDATORY)
...
#define JOB_OBJECT_VALID_COMPLETION_FILTER                                     \
  (((__MSABI_LONG(1U) << (JOB_OBJECT_MSG_MAXIMUM + 1)) - 1) -                  \
   ((__MSABI_LONG(1U) << JOB_OBJECT_MSG_MINIMUM) - 1))
...
#define XSTATE_MASK_LEGACY_FLOATING_POINT                                      \
  (1ULL << (XSTATE_LEGACY_FLOATING_POINT))
...
#define XSTATE_MASK_MPX                                                        \
  ((1LLU << (XSTATE_MPX_BNDREGS)) | (1LLU << (XSTATE_MPX_BNDCSR)))
#define XSTATE_MASK_AVX512                                                     \
  ((1LLU << (XSTATE_AVX512_KMASK)) | (1LLU << (XSTATE_AVX512_ZMM_H)) |         \
   (1LLU << (XSTATE_AVX512_ZMM)))
...
#define XSTATE_MASK_ALLOWED                                                    \
  (XSTATE_MASK_LEGACY | XSTATE_MASK_AVX | XSTATE_MASK_MPX |                    \
   XSTATE_MASK_AVX512 | XSTATE_MASK_IPT | XSTATE_MASK_PASID |                  \
   XSTATE_MASK_CET_U | XSTATE_MASK_AMX_TILE_CONFIG |                           \
   XSTATE_MASK_AMX_TILE_DATA | XSTATE_MASK_LWP)
#elif defined(_X86_) || defined(__i386__)
#define XSTATE_MASK_ALLOWED                                                    \
  (XSTATE_MASK_LEGACY | XSTATE_MASK_AVX | XSTATE_MASK_MPX |                    \
   XSTATE_MASK_AVX512 | XSTATE_MASK_IPT | XSTATE_MASK_CET_U | XSTATE_MASK_LWP)
#endif
...
DEFINE_GUID(GUID_IDLE_RESILIENCY_SUBGROUP, 0x2e601130, 0x5351, 0x4d9d, 0x8e,
            0x4, 0x25, 0x29, 0x66, 0xba, 0xd0, 0x54);
...
DEFINE_GUID(GUID_EXECUTION_REQUIRED_REQUEST_TIMEOUT, 0x3166bc41, 0x7e98, 0x4e03,
            0xb3, 0x4e, 0xec, 0xf, 0x5f, 0x2b, 0x21, 0x8e);
...
DEFINE_GUID(GUID_DEVICE_POWER_POLICY_VIDEO_BRIGHTNESS, __MSABI_LONG(0xaded5e82),
...
DEFINE_GUID(GUID_VIDEO_CONSOLE_LOCK_TIMEOUT, 0x8ec4b3a5, 0x6868, 0x48c2, 0xbe,
            0x75, 0x4f, 0x30, 0x44, 0xbe, 0x88, 0xa7);
DEFINE_GUID(GUID_ADAPTIVE_POWER_BEHAVIOR_SUBGROUP, 0x8619b916, 0xe004, 0x4dd8,
            0x9b, 0x66, 0xda, 0xe8, 0x6f, 0x80, 0x66, 0x98);
DEFINE_GUID(GUID_NON_ADAPTIVE_INPUT_TIMEOUT, 0x5adbbfbc, 0x74e, 0x4da1, 0xba,
            0x38, 0xdb, 0x8b, 0x36, 0xb2, 0xc8, 0xf3);
...
DEFINE_GUID(GUID_PROCESSOR_PERF_BOOST_MODE, 0xbe337238, 0xd82, 0x4146, 0xa9,
            0x60, 0x4f, 0x37, 0x49, 0xd4, 0x70, 0xc7);
...
DEFINE_GUID(GUID_PROCESSOR_IDLE_STATE_MAXIMUM, 0x9943e905, 0x9a30, 0x4ec1, 0x9b,
            0x99, 0x44, 0xdd, 0x3b, 0x76, 0xf7, 0xa2);
...
DEFINE_GUID(GUID_PROCESSOR_PARKING_CONCURRENCY_THRESHOLD, 0x2430ab6f, 0xa520,
            0x44a2, 0x96, 0x01, 0xf7, 0xf2, 0x3b, 0x51, 0x34, 0xb1);
DEFINE_GUID(GUID_PROCESSOR_PARKING_HEADROOM_THRESHOLD, 0xf735a673, 0x2066,
            0x4f80, 0xa0, 0xc5, 0xdd, 0xee, 0x0c, 0xf1, 0xbf, 0x5d);
...
DEFINE_GUID(GUID_GLOBAL_USER_PRESENCE, 0x786e8a1d, 0xb427, 0x4344, 0x92, 0x7,
            0x9, 0xe7, 0xb, 0xdc, 0xbe, 0xa9);
DEFINE_GUID(GUID_SESSION_DISPLAY_STATUS, 0x2b84c20e, 0xad23, 0x4ddf, 0x93, 0xdb,
            0x5, 0xff, 0xbd, 0x7e, 0xfc, 0xa5);
DEFINE_GUID(GUID_SESSION_USER_PRESENCE, 0x3c0f4548, 0xc03f, 0x4c4d, 0xb9, 0xf2,
            0x23, 0x7e, 0xde, 0x68, 0x63, 0x76);
...
DEFINE_GUID(PPM_PERFSTATE_CHANGE_GUID, 0xa5b32ddd, 0x7f39, 0x4abc, 0xb8, 0x92,
            0x90, 0xe, 0x43, 0xb5, 0x9e, 0xbb);
DEFINE_GUID(PPM_PERFSTATE_DOMAIN_CHANGE_GUID, 0x995e6b7f, 0xd653, 0x497a, 0xb9,
            0x78, 0x36, 0xa3, 0xc, 0x29, 0xbf, 0x1);
DEFINE_GUID(PPM_IDLESTATE_CHANGE_GUID, 0x4838fe4f, 0xf71c, 0x4e51, 0x9e, 0xcc,
            0x84, 0x30, 0xa7, 0xac, 0x4c, 0x6c);
DEFINE_GUID(PPM_PERFSTATES_DATA_GUID, 0x5708cc20, 0x7d40, 0x4bf4, 0xb4, 0xaa,
            0x2b, 0x01, 0x33, 0x8d, 0x01, 0x26);
DEFINE_GUID(PPM_IDLESTATES_DATA_GUID, 0xba138e10, 0xe250, 0x4ad7, 0x86, 0x16,
            0xcf, 0x1a, 0x7a, 0xd4, 0x10, 0xe7);
DEFINE_GUID(PPM_IDLE_ACCOUNTING_GUID, 0xe2a26f78, 0xae07, 0x4ee0, 0xa3, 0x0f,
            0xce, 0x54, 0xf5, 0x5a, 0x94, 0xcd);
DEFINE_GUID(PPM_IDLE_ACCOUNTING_EX_GUID, 0xd67abd39, 0x81f8, 0x4a5e, 0x81, 0x52,
            0x72, 0xe3, 0x1e, 0xc9, 0x12, 0xee);
DEFINE_GUID(PPM_THERMALCONSTRAINT_GUID, 0xa852c2c8, 0x1a4c, 0x423b, 0x8c, 0x2c,
            0xf3, 0x0d, 0x82, 0x93, 0x1a, 0x88);
DEFINE_GUID(PPM_PERFMON_PERFSTATE_GUID, 0x7fd18652, 0xcfe, 0x40d2, 0xb0, 0xa1,
            0xb, 0x6, 0x6a, 0x87, 0x75, 0x9e);
DEFINE_GUID(PPM_THERMAL_POLICY_CHANGE_GUID, 0x48f377b8, 0x6880, 0x4c7b, 0x8b,
            0xdc, 0x38, 0x1, 0x76, 0xc6, 0x65, 0x4d);
typedef struct {
  POWER_ACTION Action;
  DWORD Flags;
  DWORD EventCode;
...
NTSYSAPI VOID NTAPI __attribute__((__returns_twice__))
RtlCaptureContext(PCONTEXT ContextRecord);
NTSYSAPI SIZE_T NTAPI RtlCompareMemory(const VOID *Source1, const VOID *Source2,
                                       SIZE_T Length);
...
NTSYSAPI VOID NTAPI RtlGrowFunctionTable(PVOID DynamicTable,
                                         DWORD NewEntryCount);
...
NTSYSAPI BOOLEAN __cdecl RtlAddFunctionTable(PRUNTIME_FUNCTION FunctionTable,
                                             DWORD EntryCount,
                                             DWORD64 BaseAddress);
NTSYSAPI BOOLEAN __cdecl
RtlDeleteFunctionTable(PRUNTIME_FUNCTION FunctionTable);
NTSYSAPI BOOLEAN __cdecl
RtlInstallFunctionTableCallback(DWORD64 TableIdentifier, DWORD64 BaseAddress,
                                DWORD Length,
                                PGET_RUNTIME_FUNCTION_CALLBACK Callback,
                                PVOID Context, PCWSTR OutOfProcessCallbackDll);
NTSYSAPI VOID __cdecl __MINGW_ATTRIB_NORETURN
...
RtlDeleteFunctionTable(PRUNTIME_FUNCTION FunctionTable);
NTSYSAPI BOOLEAN __cdecl
RtlInstallFunctionTableCallback(DWORD TableIdentifier, DWORD BaseAddress,
                                DWORD Length,
                                PGET_RUNTIME_FUNCTION_CALLBACK Callback,
                                PVOID Context, PCWSTR OutOfProcessCallbackDll);
NTSYSAPI VOID __cdecl
RtlRestoreContext(PCONTEXT ContextRecord,
                  struct _EXCEPTION_RECORD *ExceptionRecord);
#endif
#if defined(__aarch64__)
...
RtlDeleteFunctionTable(PRUNTIME_FUNCTION FunctionTable);
NTSYSAPI BOOLEAN __cdecl
RtlInstallFunctionTableCallback(ULONG_PTR TableIdentifier,
                                ULONG_PTR BaseAddress, DWORD Length,
                                PGET_RUNTIME_FUNCTION_CALLBACK Callback,
                                PVOID Context, PCWSTR OutOfProcessCallbackDll);
NTSYSAPI VOID __cdecl
RtlRestoreContext(PCONTEXT ContextRecord,
...
#endif
#if defined(__ia64__)
NTSYSAPI BOOLEAN NTAPI RtlAddFunctionTable(PRUNTIME_FUNCTION FunctionTable,
                                           DWORD EntryCount,
                                           ULONGLONG BaseAddress,
                                           ULONGLONG TargetGp);
...
NTSYSAPI BOOLEAN NTAPI RtlInstallFunctionTableCallback(
    ...
    DWORD64 TargetGp, PGET_RUNTIME_FUNCTION_CALLBACK Callback, PVOID Context,
    PCWSTR OutOfProcessCallbackDll);
NTSYSAPI VOID NTAPI RtlRestoreContext(
    PCONTEXT ContextRecord, struct _EXCEPTION_RECORD *ExceptionRecord);
#endif
#endif
#if WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_APP)
...
NTSYSAPI PRUNTIME_FUNCTION NTAPI RtlLookupFunctionEntry(
    DWORD64 ControlPc, PDWORD64 ImageBase, PUNWIND_HISTORY_TABLE HistoryTable);
...
#if defined(__arm__)
NTSYSAPI PRUNTIME_FUNCTION NTAPI RtlLookupFunctionEntry(
    ULONG_PTR ControlPc, PDWORD ImageBase, PUNWIND_HISTORY_TABLE HistoryTable);
NTSYSAPI VOID NTAPI RtlUnwindEx(PVOID TargetFrame, PVOID TargetIp,
                                PEXCEPTION_RECORD ExceptionRecord,
                                PVOID ReturnValue, PCONTEXT ContextRecord,
                                PUNWIND_HISTORY_TABLE HistoryTable);
NTSYSAPI PEXCEPTION_ROUTINE NTAPI RtlVirtualUnwind(
    DWORD HandlerType, DWORD ImageBase, DWORD ControlPc,
    PRUNTIME_FUNCTION FunctionEntry, PCONTEXT ContextRecord, PVOID *HandlerData,
    PDWORD EstablisherFrame, PKNONVOLATILE_CONTEXT_POINTERS ContextPointers);
#endif
#if defined(__aarch64__)
NTSYSAPI PRUNTIME_FUNCTION NTAPI
RtlLookupFunctionEntry(ULONG_PTR ControlPc, PULONG_PTR ImageBase,
                       PUNWIND_HISTORY_TABLE HistoryTable);
NTSYSAPI VOID NTAPI RtlUnwindEx(PVOID TargetFrame, PVOID TargetIp,
                                PEXCEPTION_RECORD ExceptionRecord,
                                PVOID ReturnValue, PCONTEXT ContextRecord,
...
RtlVirtualUnwind(DWORD HandlerType, ULONG_PTR ImageBase, ULONG_PTR ControlPc,
                 PRUNTIME_FUNCTION FunctionEntry, PCONTEXT ContextRecord,
                 PVOID *HandlerData, PULONG_PTR EstablisherFrame,
                 PKNONVOLATILE_CONTEXT_POINTERS ContextPointers);
#endif
#if defined(__ia64__)
NTSYSAPI PRUNTIME_FUNCTION NTAPI RtlLookupFunctionEntry(ULONGLONG ControlPc,
                                                        PULONGLONG ImageBase,
                                                        PULONGLONG TargetGp);
NTSYSAPI VOID NTAPI RtlUnwindEx(FRAME_POINTERS TargetFrame, PVOID TargetIp,
                                PEXCEPTION_RECORD ExceptionRecord,
                                PVOID ReturnValue, PCONTEXT ContextRecord,
                                PUNWIND_HISTORY_TABLE HistoryTable);
NTSYSAPI ULONGLONG NTAPI
RtlVirtualUnwind(ULONGLONG ImageBase, ULONGLONG ControlPc,
                 PRUNTIME_FUNCTION FunctionEntry, PCONTEXT ContextRecord,
                 PBOOLEAN InFunction, PFRAME_POINTERS EstablisherFrame,
                 PKNONVOLATILE_CONTEXT_POINTERS ContextPointers);
#endif
#endif
#include <string.h>
...
NTSYSAPI PSLIST_ENTRY NTAPI
RtlInterlockedPushListSListEx(PSLIST_HEADER ListHead, PSLIST_ENTRY List,
                              PSLIST_ENTRY ListEnd, DWORD Count);
...
__CRT_INLINE PVOID __cdecl memcpy_inline(void *dst, const void *src,
                                         size_t size) {
...
#endif /* _DBG_MEMCPY_INLINE_ && !defined(_MEMCPY_INLINE_) &&                  \
          !defined(_CRTBLD) */
...
NTSYSAPI BOOLEAN NTAPI RtlGetProductInfo(DWORD OSMajorVersion,
...
typedef VOID NTAPI RTL_UMS_SCHEDULER_ENTRY_POINT(
    RTL_UMS_SCHEDULER_REASON Reason, ULONG_PTR ActivationPayload,
...
#if WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_DESKTOP)
NTSYSAPI DWORD NTAPI RtlCrc32(const void *Buffer, size_t Size,
                              DWORD InitialCrc);
NTSYSAPI ULONGLONG NTAPI RtlCrc64(const void *Buffer, size_t Size,
...
VOID NTAPI RtlApplicationVerifierStop(ULONG_PTR Code, PSTR Message,
                                      ULONG_PTR Param1, PSTR Description1,
                                      ULONG_PTR Param2, PSTR Description2,
                                      ULONG_PTR Param3, PSTR Description3,
                                      ULONG_PTR Param4, PSTR Description4);
NTSYSAPI LONG NTAPI RtlSetHeapInformation(
    PVOID HeapHandle, HEAP_INFORMATION_CLASS HeapInformationClass,
    PVOID HeapInformation, SIZE_T HeapInformationLength);
NTSYSAPI LONG NTAPI RtlQueryHeapInformation(
    PVOID HeapHandle, HEAP_INFORMATION_CLASS HeapInformationClass,
    PVOID HeapInformation, SIZE_T HeapInformationLength, PSIZE_T ReturnLength);
DWORD NTAPI RtlMultipleAllocateHeap(PVOID HeapHandle, DWORD Flags, SIZE_T Size,
                                    DWORD Count, PVOID *Array);
DWORD NTAPI RtlMultipleFreeHeap(PVOID HeapHandle, DWORD Flags, DWORD Count,
                                PVOID *Array);
...
#define CM_SERVICE_VALID_PROMOTION_MASK                                        \
  (CM_SERVICE_NETWORK_BOOT_LOAD | CM_SERVICE_VIRTUAL_DISK_BOOT_LOAD |          \
   CM_SERVICE_USB_DISK_BOOT_LOAD | CM_SERVICE_SD_DISK_BOOT_LOAD |              \
   CM_SERVICE_USB3_DISK_BOOT_LOAD | CM_SERVICE_MEASURED_BOOT_LOAD |            \
   CM_SERVICE_VERIFIER_BOOT_LOAD | CM_SERVICE_WINPE_BOOT_LOAD)
...
typedef VOID(NTAPI *PTP_SIMPLE_CALLBACK)(PTP_CALLBACK_INSTANCE Instance,
                                         PVOID Context);
...
typedef VOID(NTAPI *PTP_CLEANUP_GROUP_CANCEL_CALLBACK)(PVOID ObjectContext,
...
typedef VOID(NTAPI *PTP_WORK_CALLBACK)(PTP_CALLBACK_INSTANCE Instance,
                                       PVOID Context, PTP_WORK Work);
typedef struct _TP_TIMER TP_TIMER, *PTP_TIMER;
typedef VOID(NTAPI *PTP_TIMER_CALLBACK)(PTP_CALLBACK_INSTANCE Instance,
                                        PVOID Context, PTP_TIMER Timer);
typedef DWORD TP_WAIT_RESULT;
typedef struct _TP_WAIT TP_WAIT, *PTP_WAIT;
typedef VOID(NTAPI *PTP_WAIT_CALLBACK)(PTP_CALLBACK_INSTANCE Instance,
...
FORCEINLINE VOID TpSetCallbackThreadpool(PTP_CALLBACK_ENVIRON cbe,
                                         PTP_POOL pool) {
  cbe->Pool = pool;
}
...
FORCEINLINE VOID TpSetCallbackActivationContext(
    PTP_CALLBACK_ENVIRON cbe, struct _ACTIVATION_CONTEXT *actx) {
  cbe->ActivationContext = actx;
}
FORCEINLINE VOID TpSetCallbackNoActivationContext(PTP_CALLBACK_ENVIRON cbe) {
  cbe->ActivationContext = (struct _ACTIVATION_CONTEXT *)(LONG_PTR)-1;
}
FORCEINLINE VOID TpSetCallbackLongFunction(PTP_CALLBACK_ENVIRON cbe) {
  cbe->u.s.LongFunction = 1;
}
FORCEINLINE VOID TpSetCallbackRaceWithDll(PTP_CALLBACK_ENVIRON cbe, PVOID h) {
  cbe->RaceDll = h;
}
FORCEINLINE VOID TpSetCallbackFinalizationCallback(
    PTP_CALLBACK_ENVIRON cbe, PTP_SIMPLE_CALLBACK fini_cb) {
  cbe->FinalizationCallback = fini_cb;
}
#if _WIN32_WINNT >= 0x0601
FORCEINLINE VOID TpSetCallbackPriority(PTP_CALLBACK_ENVIRON cbe,
                                       TP_CALLBACK_PRIORITY prio) {
  cbe->CallbackPriority = prio;
}
#endif
FORCEINLINE VOID TpSetCallbackPersistent(PTP_CALLBACK_ENVIRON cbe) {
  cbe->u.s.Persistent = 1;
}
FORCEINLINE VOID TpDestroyCallbackEnviron(PTP_CALLBACK_ENVIRON cbe) {
  UNREFERENCED_PARAMETER(cbe);
}
#endif
#if !defined(__ia64__) && !defined(__WIDL__)
...
FORCEINLINE PVOID GetCurrentFiber(void) { return (PVOID)__readfsdword(0x10); }
#elif defined(__arm__)
FORCEINLINE struct _TEB *NtCurrentTeb(VOID) {
  struct _TEB *teb;
 ...
 * Constants -
 * http://packages.python.org/winappdbg/winappdbg.win32.context_i386-pysrc.html
 * WOW64_FLOATING_SAVE_AREA -
 * http://packages.python.org/winappdbg/winappdbg.win32.context_amd64.WOW64_FLOATING_SAVE_AREA-class.html
 * WOW64_CONTEXT -
 * http://packages.python.org/winappdbg/winappdbg.win32.context_amd64.WOW64_CONTEXT-class.html
 */
...
#define WOW64_CONTEXT_FLOATING_POINT                                           \
  (WOW64_CONTEXT_i386 | __MSABI_LONG(0x00000008))
#define WOW64_CONTEXT_DEBUG_REGISTERS                                          \
  (WOW64_CONTEXT_i386 | __MSABI_LONG(0x00000010))
#define WOW64_CONTEXT_EXTENDED_REGISTERS                                       \
  (WOW64_CONTEXT_i386 | __MSABI_LONG(0x00000020))
