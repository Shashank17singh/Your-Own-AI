...
typedef struct ICertExitVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ICertExit *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ICertExit *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ICertExit *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ICertExit *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *Initialize)(ICertExit *This, const BSTR strConfig,
                              LONG *pEventMask);
...
#endif
#endif
HRESULT WINAPI ICertExit_Initialize_Proxy(ICertExit *This, const BSTR strConfig,
                                          LONG *pEventMask);
void __RPC_STUB ICertExit_Initialize_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI ICertExit_Notify_Proxy(ICertExit *This, LONG ExitEvent,
                                      LONG Context);
void __RPC_STUB ICertExit_Notify_Stub(IRpcStubBuffer *This,
                                      IRpcChannelBuffer *_pRpcChannelBuffer,
                                      PRPC_MESSAGE _pRpcMessage,
                                      DWORD *_pdwStubPhase);
HRESULT WINAPI ICertExit_GetDescription_Proxy(ICertExit *This,
...
typedef struct ICertExit2Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ICertExit2 *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ICertExit2 *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ICertExit2 *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ICertExit2 *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *Initialize)(ICertExit2 *This, const BSTR strConfig,
                              LONG *pEventMask);
  ...
  HRESULT(WINAPI *GetManageModule)(ICertExit2 *This,
...
#define ICertExit2_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                    \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ICertExit2_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,          \
                                 rgDispId)                                     \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
...
#endif
HRESULT
    WINAPI ICertExit2_GetManageModule_Proxy(ICertExit2 *This,
                                            ICertManageModule **ppManageModule);
