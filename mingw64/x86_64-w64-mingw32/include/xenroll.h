...
public:
  virtual HRESULT WINAPI createFilePKCS10(BSTR DNName, BSTR Usage,
                                          BSTR wszPKCS10FileName) = 0;
  virtual HRESULT WINAPI acceptFilePKCS7(BSTR wszPKCS7FileName) = 0;
  virtual HRESULT WINAPI createPKCS10(BSTR DNName, BSTR Usage,
                                      BSTR *pPKCS10) = 0;
  virtual HRESULT WINAPI acceptPKCS7(BSTR PKCS7) = 0;
  virtual HRESULT WINAPI getCertFromPKCS7(BSTR wszPKCS7, BSTR *pbstrCert) = 0;
  virtual HRESULT WINAPI enumProviders(LONG dwIndex, LONG dwFlags,
...
typedef struct ICEnrollVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ICEnroll *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ICEnroll *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ICEnroll *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ICEnroll *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *createFilePKCS10)(ICEnroll *This, BSTR DNName, BSTR Usage,
                                    BSTR wszPKCS10FileName);
  HRESULT(WINAPI *acceptFilePKCS7)(ICEnroll *This, BSTR wszPKCS7FileName);
  HRESULT(WINAPI *createPKCS10)(ICEnroll *This, BSTR DNName, BSTR Usage,
                                BSTR *pPKCS10);
  HRESULT(WINAPI *acceptPKCS7)(ICEnroll *This, BSTR PKCS7);
  HRESULT(WINAPI *getCertFromPKCS7)(ICEnroll *This, BSTR wszPKCS7,
                                    BSTR *pbstrCert);
  HRESULT(WINAPI *enumProviders)(ICEnroll *This, LONG dwIndex, LONG dwFlags,
                                 BSTR *pbstrProvName);
  ...
  HRESULT(WINAPI *get_UseExistingKeySet)(ICEnroll *This,
                                         WINBOOL *fUseExistingKeys);
  HRESULT(WINAPI *put_UseExistingKeySet)(ICEnroll *This,
                                         WINBOOL fUseExistingKeys);
...
#define ICEnroll_Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,   \
...
#endif
#endif
HRESULT WINAPI ICEnroll_createFilePKCS10_Proxy(ICEnroll *This, BSTR DNName,
                                               BSTR Usage,
                                               BSTR wszPKCS10FileName);
...
HRESULT WINAPI ICEnroll_acceptFilePKCS7_Proxy(ICEnroll *This,
                                              BSTR wszPKCS7FileName);
void __RPC_STUB ICEnroll_acceptFilePKCS7_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll_createPKCS10_Proxy(ICEnroll *This, BSTR DNName,
                                           BSTR Usage, BSTR *pPKCS10);
void __RPC_STUB ICEnroll_createPKCS10_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll_acceptPKCS7_Proxy(ICEnroll *This, BSTR PKCS7);
void __RPC_STUB ICEnroll_acceptPKCS7_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll_getCertFromPKCS7_Proxy(ICEnroll *This, BSTR wszPKCS7,
                                               BSTR *pbstrCert);
void __RPC_STUB ICEnroll_getCertFromPKCS7_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll_enumProviders_Proxy(ICEnroll *This, LONG dwIndex,
                                            LONG dwFlags, BSTR *pbstrProvName);
void __RPC_STUB ICEnroll_enumProviders_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll_enumContainers_Proxy(ICEnroll *This, LONG dwIndex,
                                             BSTR *pbstr);
void __RPC_STUB ICEnroll_enumContainers_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll_freeRequestInfo_Proxy(ICEnroll *This,
                                              BSTR PKCS7OrPKCS10);
...
void __RPC_STUB ICEnroll_put_CAStoreFlags_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll_get_RootStoreName_Proxy(ICEnroll *This,
                                                BSTR *pbstrName);
...
void __RPC_STUB ICEnroll_put_RootStoreName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll_get_RootStoreType_Proxy(ICEnroll *This,
                                                BSTR *pbstrType);
...
void __RPC_STUB ICEnroll_put_RootStoreType_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll_get_RootStoreFlags_Proxy(ICEnroll *This,
                                                 LONG *pdwFlags);
...
void __RPC_STUB ICEnroll_put_RootStoreFlags_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll_get_RequestStoreName_Proxy(ICEnroll *This,
                                                   BSTR *pbstrName);
void __RPC_STUB ICEnroll_get_RequestStoreName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll_put_RequestStoreName_Proxy(ICEnroll *This,
                                                   BSTR bstrName);
void __RPC_STUB ICEnroll_put_RequestStoreName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll_get_RequestStoreType_Proxy(ICEnroll *This,
                                                   BSTR *pbstrType);
void __RPC_STUB ICEnroll_get_RequestStoreType_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll_put_RequestStoreType_Proxy(ICEnroll *This,
                                                   BSTR bstrType);
void __RPC_STUB ICEnroll_put_RequestStoreType_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll_get_RequestStoreFlags_Proxy(ICEnroll *This,
                                                    LONG *pdwFlags);
void __RPC_STUB ICEnroll_get_RequestStoreFlags_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll_put_RequestStoreFlags_Proxy(ICEnroll *This,
                                                    LONG dwFlags);
void __RPC_STUB ICEnroll_put_RequestStoreFlags_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll_get_ContainerName_Proxy(ICEnroll *This,
                                                BSTR *pbstrContainer);
void __RPC_STUB ICEnroll_get_ContainerName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll_put_ContainerName_Proxy(ICEnroll *This,
                                                BSTR bstrContainer);
void __RPC_STUB ICEnroll_put_ContainerName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll_get_ProviderName_Proxy(ICEnroll *This,
                                               BSTR *pbstrProvider);
void __RPC_STUB ICEnroll_get_ProviderName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll_put_ProviderName_Proxy(ICEnroll *This,
                                               BSTR bstrProvider);
...
void __RPC_STUB ICEnroll_get_KeySpec_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll_put_KeySpec_Proxy(ICEnroll *This, LONG dw);
void __RPC_STUB ICEnroll_put_KeySpec_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
...
void __RPC_STUB ICEnroll_put_ProviderFlags_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll_get_UseExistingKeySet_Proxy(ICEnroll *This,
                                                    WINBOOL *fUseExistingKeys);
void __RPC_STUB ICEnroll_get_UseExistingKeySet_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll_put_UseExistingKeySet_Proxy(ICEnroll *This,
                                                    WINBOOL fUseExistingKeys);
...
void __RPC_STUB ICEnroll_put_GenKeyFlags_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll_get_DeleteRequestCert_Proxy(ICEnroll *This,
                                                    WINBOOL *fDelete);
void __RPC_STUB ICEnroll_get_DeleteRequestCert_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll_put_DeleteRequestCert_Proxy(ICEnroll *This,
                                                    WINBOOL fDelete);
void __RPC_STUB ICEnroll_put_DeleteRequestCert_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll_get_WriteCertToCSP_Proxy(ICEnroll *This,
                                                 WINBOOL *fBool);
...
typedef struct ICEnroll2Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ICEnroll2 *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ICEnroll2 *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ICEnroll2 *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ICEnroll2 *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *createFilePKCS10)(ICEnroll2 *This, BSTR DNName, BSTR Usage,
                                    BSTR wszPKCS10FileName);
  HRESULT(WINAPI *acceptFilePKCS7)(ICEnroll2 *This, BSTR wszPKCS7FileName);
  HRESULT(WINAPI *createPKCS10)(ICEnroll2 *This, BSTR DNName, BSTR Usage,
                                BSTR *pPKCS10);
  HRESULT(WINAPI *acceptPKCS7)(ICEnroll2 *This, BSTR PKCS7);
  HRESULT(WINAPI *getCertFromPKCS7)(ICEnroll2 *This, BSTR wszPKCS7,
                                    BSTR *pbstrCert);
  HRESULT(WINAPI *enumProviders)(ICEnroll2 *This, LONG dwIndex, LONG dwFlags,
                                 BSTR *pbstrProvName);
  ...
  HRESULT(WINAPI *get_UseExistingKeySet)(ICEnroll2 *This,
                                         WINBOOL *fUseExistingKeys);
  HRESULT(WINAPI *put_UseExistingKeySet)(ICEnroll2 *This,
                                         WINBOOL fUseExistingKeys);
  ...
  HRESULT(WINAPI *addNameValuePairToSignature)(ICEnroll2 *This, BSTR Name,
                                               BSTR Value);
...
#define ICEnroll2_GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId) \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ICEnroll2_Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)                     \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI ICEnroll2_addCertTypeToRequest_Proxy(ICEnroll2 *This,
                                                    BSTR CertType);
void __RPC_STUB ICEnroll2_addCertTypeToRequest_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll2_addNameValuePairToSignature_Proxy(ICEnroll2 *This,
                                                           BSTR Name,
                                                           BSTR Value);
void __RPC_STUB ICEnroll2_addNameValuePairToSignature_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll2_get_WriteCertToUserDS_Proxy(ICEnroll2 *This,
                                                     WINBOOL *fBool);
void __RPC_STUB ICEnroll2_get_WriteCertToUserDS_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll2_put_WriteCertToUserDS_Proxy(ICEnroll2 *This,
                                                     WINBOOL fBool);
void __RPC_STUB ICEnroll2_put_WriteCertToUserDS_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll2_get_EnableT61DNEncoding_Proxy(ICEnroll2 *This,
                                                       WINBOOL *fBool);
void __RPC_STUB ICEnroll2_get_EnableT61DNEncoding_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll2_put_EnableT61DNEncoding_Proxy(ICEnroll2 *This,
                                                       WINBOOL fBool);
...
public:
  ...
  virtual HRESULT WINAPI GetKeyLen(WINBOOL fMin, WINBOOL fExchange,
                                   LONG *pdwKeySize) = 0;
  virtual HRESULT WINAPI EnumAlgs(LONG dwIndex, LONG algClass,
                                  LONG *pdwAlgID) = 0;
  virtual HRESULT WINAPI GetAlgName(LONG algID, BSTR *pbstr) = 0;
  virtual HRESULT WINAPI put_ReuseHardwareKeyIfUnableToGenNew(
      WINBOOL fReuseHardwareKeyIfUnableToGenNew) = 0;
  virtual HRESULT WINAPI get_ReuseHardwareKeyIfUnableToGenNew(
      WINBOOL *fReuseHardwareKeyIfUnableToGenNew) = 0;
  virtual HRESULT WINAPI put_HashAlgID(LONG hashAlgID) = 0;
  virtual HRESULT WINAPI get_HashAlgID(LONG *hashAlgID) = 0;
  virtual HRESULT WINAPI put_LimitExchangeKeyToEncipherment(
      WINBOOL fLimitExchangeKeyToEncipherment) = 0;
  virtual HRESULT WINAPI get_LimitExchangeKeyToEncipherment(
      WINBOOL *fLimitExchangeKeyToEncipherment) = 0;
  virtual HRESULT WINAPI
  put_EnableSMIMECapabilities(WINBOOL fEnableSMIMECapabilities) = 0;
  virtual HRESULT WINAPI
  get_EnableSMIMECapabilities(WINBOOL *fEnableSMIMECapabilities) = 0;
};
#ifdef __cplusplus
extern "C" {
#endif
...
typedef struct ICEnroll3Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ICEnroll3 *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ICEnroll3 *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ICEnroll3 *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ICEnroll3 *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *createFilePKCS10)(ICEnroll3 *This, BSTR DNName, BSTR Usage,
                                    BSTR wszPKCS10FileName);
  HRESULT(WINAPI *acceptFilePKCS7)(ICEnroll3 *This, BSTR wszPKCS7FileName);
  HRESULT(WINAPI *createPKCS10)(ICEnroll3 *This, BSTR DNName, BSTR Usage,
                                BSTR *pPKCS10);
  HRESULT(WINAPI *acceptPKCS7)(ICEnroll3 *This, BSTR PKCS7);
  HRESULT(WINAPI *getCertFromPKCS7)(ICEnroll3 *This, BSTR wszPKCS7,
                                    BSTR *pbstrCert);
  HRESULT(WINAPI *enumProviders)(ICEnroll3 *This, LONG dwIndex, LONG dwFlags,
                                 BSTR *pbstrProvName);
  ...
  HRESULT(WINAPI *get_UseExistingKeySet)(ICEnroll3 *This,
                                         WINBOOL *fUseExistingKeys);
  HRESULT(WINAPI *put_UseExistingKeySet)(ICEnroll3 *This,
                                         WINBOOL fUseExistingKeys);
  ...
  HRESULT(WINAPI *addNameValuePairToSignature)(ICEnroll3 *This, BSTR Name,
                                               BSTR Value);
  ...
  HRESULT(WINAPI *GetKeyLen)(ICEnroll3 *This, WINBOOL fMin, WINBOOL fExchange,
                             LONG *pdwKeySize);
  HRESULT(WINAPI *EnumAlgs)(ICEnroll3 *This, LONG dwIndex, LONG algClass,
                            LONG *pdwAlgID);
  HRESULT(WINAPI *GetAlgName)(ICEnroll3 *This, LONG algID, BSTR *pbstr);
  HRESULT(WINAPI *put_ReuseHardwareKeyIfUnableToGenNew)(
      ICEnroll3 *This, WINBOOL fReuseHardwareKeyIfUnableToGenNew);
  HRESULT(WINAPI *get_ReuseHardwareKeyIfUnableToGenNew)(
      ICEnroll3 *This, WINBOOL *fReuseHardwareKeyIfUnableToGenNew);
  HRESULT(WINAPI *put_HashAlgID)(ICEnroll3 *This, LONG hashAlgID);
  HRESULT(WINAPI *get_HashAlgID)(ICEnroll3 *This, LONG *hashAlgID);
  HRESULT(WINAPI *put_LimitExchangeKeyToEncipherment)(
      ICEnroll3 *This, WINBOOL fLimitExchangeKeyToEncipherment);
  HRESULT(WINAPI *get_LimitExchangeKeyToEncipherment)(
      ICEnroll3 *This, WINBOOL *fLimitExchangeKeyToEncipherment);
  HRESULT(WINAPI *put_EnableSMIMECapabilities)(
      ICEnroll3 *This, WINBOOL fEnableSMIMECapabilities);
  HRESULT(WINAPI *get_EnableSMIMECapabilities)(
      ICEnroll3 *This, WINBOOL *fEnableSMIMECapabilities);
  END_INTERFACE
} ICEnroll3Vtbl;
struct ICEnroll3 {
...
#define ICEnroll3_GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId) \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ICEnroll3_Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)                     \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#define ICEnroll3_put_ReuseHardwareKeyIfUnableToGenNew(                        \
    This, fReuseHardwareKeyIfUnableToGenNew)                                   \
  (This)->lpVtbl->put_ReuseHardwareKeyIfUnableToGenNew(                        \
      This, fReuseHardwareKeyIfUnableToGenNew)
#define ICEnroll3_get_ReuseHardwareKeyIfUnableToGenNew(                        \
    This, fReuseHardwareKeyIfUnableToGenNew)                                   \
  (This)->lpVtbl->get_ReuseHardwareKeyIfUnableToGenNew(                        \
      This, fReuseHardwareKeyIfUnableToGenNew)
...
#define ICEnroll3_put_LimitExchangeKeyToEncipherment(                          \
    This, fLimitExchangeKeyToEncipherment)                                     \
  (This)->lpVtbl->put_LimitExchangeKeyToEncipherment(                          \
      This, fLimitExchangeKeyToEncipherment)
#define ICEnroll3_get_LimitExchangeKeyToEncipherment(                          \
    This, fLimitExchangeKeyToEncipherment)                                     \
  (This)->lpVtbl->get_LimitExchangeKeyToEncipherment(                          \
      This, fLimitExchangeKeyToEncipherment)
...
void __RPC_STUB ICEnroll3_Reset_Stub(IRpcStubBuffer *This,
                                     IRpcChannelBuffer *_pRpcChannelBuffer,
                                     PRPC_MESSAGE _pRpcMessage,
                                     DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll3_GetSupportedKeySpec_Proxy(ICEnroll3 *This,
                                                   LONG *pdwKeySpec);
void __RPC_STUB ICEnroll3_GetSupportedKeySpec_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll3_GetKeyLen_Proxy(ICEnroll3 *This, WINBOOL fMin,
                                         WINBOOL fExchange, LONG *pdwKeySize);
void __RPC_STUB ICEnroll3_GetKeyLen_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll3_EnumAlgs_Proxy(ICEnroll3 *This, LONG dwIndex,
                                        LONG algClass, LONG *pdwAlgID);
void __RPC_STUB ICEnroll3_EnumAlgs_Stub(IRpcStubBuffer *This,
                                        IRpcChannelBuffer *_pRpcChannelBuffer,
                                        PRPC_MESSAGE _pRpcMessage,
                                        DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll3_GetAlgName_Proxy(ICEnroll3 *This, LONG algID,
                                          BSTR *pbstr);
void __RPC_STUB ICEnroll3_GetAlgName_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll3_put_ReuseHardwareKeyIfUnableToGenNew_Proxy(
    ICEnroll3 *This, WINBOOL fReuseHardwareKeyIfUnableToGenNew);
...
void __RPC_STUB ICEnroll3_put_LimitExchangeKeyToEncipherment_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll3_get_LimitExchangeKeyToEncipherment_Proxy(
    ICEnroll3 *This, WINBOOL *fLimitExchangeKeyToEncipherment);
void __RPC_STUB ICEnroll3_get_LimitExchangeKeyToEncipherment_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll3_put_EnableSMIMECapabilities_Proxy(
    ICEnroll3 *This, WINBOOL fEnableSMIMECapabilities);
void __RPC_STUB ICEnroll3_put_EnableSMIMECapabilities_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll3_get_EnableSMIMECapabilities_Proxy(
    ICEnroll3 *This, WINBOOL *fEnableSMIMECapabilities);
...
public:
  ...
  virtual HRESULT WINAPI binaryToString(LONG Flags, BSTR strBinary,
                                        BSTR *pstrEncoded) = 0;
  virtual HRESULT WINAPI stringToBinary(LONG Flags, BSTR strEncoded,
                                        BSTR *pstrBinary) = 0;
  virtual HRESULT WINAPI addExtensionToRequest(LONG Flags, BSTR strName,
                                               BSTR strValue) = 0;
  virtual HRESULT WINAPI addAttributeToRequest(LONG Flags, BSTR strName,
                                               BSTR strValue) = 0;
  virtual HRESULT WINAPI addNameValuePairToRequest(LONG Flags, BSTR strName,
                                                   BSTR strValue) = 0;
  virtual HRESULT WINAPI resetExtensions(void) = 0;
  virtual HRESULT WINAPI resetAttributes(void) = 0;
  virtual HRESULT WINAPI createRequest(LONG Flags, BSTR strDNName, BSTR Usage,
                                       BSTR *pstrRequest) = 0;
  virtual HRESULT WINAPI createFileRequest(LONG Flags, BSTR strDNName,
                                           BSTR strUsage,
                                           BSTR strRequestFileName) = 0;
  ...
  virtual HRESULT WINAPI getCertFromResponse(BSTR strResponse,
                                             BSTR *pstrCert) = 0;
  virtual HRESULT WINAPI getCertFromFileResponse(BSTR strResponseFileName,
                                                 BSTR *pstrCert) = 0;
  virtual HRESULT WINAPI createPFX(BSTR strPassword, BSTR *pstrPFX) = 0;
  virtual HRESULT WINAPI createFilePFX(BSTR strPassword,
                                       BSTR strPFXFileName) = 0;
  virtual HRESULT WINAPI setPendingRequestInfo(LONG lRequestID, BSTR strCADNS,
                                               BSTR strCAName,
                                               BSTR strFriendlyName) = 0;
  virtual HRESULT WINAPI enumPendingRequest(LONG lIndex, LONG lDesiredProperty,
                                            VARIANT *pvarProperty) = 0;
  virtual HRESULT WINAPI removePendingRequest(BSTR strThumbprint) = 0;
  virtual HRESULT WINAPI GetKeyLenEx(LONG lSizeSpec, LONG lKeySpec,
                                     LONG *pdwKeySize) = 0;
  virtual HRESULT WINAPI InstallPKCS7Ex(BSTR PKCS7, LONG *plCertInstalled) = 0;
  virtual HRESULT WINAPI addCertTypeToRequestEx(LONG lType, BSTR bstrOIDOrName,
                                                LONG lMajorVersion,
                                                WINBOOL fMinorVersion,
                                                LONG lMinorVersion) = 0;
  virtual HRESULT WINAPI getProviderType(BSTR strProvName,
                                         LONG *plProvType) = 0;
  ...
  virtual HRESULT WINAPI addBlobPropertyToCertificate(LONG lPropertyId,
                                                      LONG lReserved,
                                                      BSTR bstrProperty) = 0;
...
typedef struct ICEnroll4Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ICEnroll4 *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ICEnroll4 *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ICEnroll4 *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ICEnroll4 *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *createFilePKCS10)(ICEnroll4 *This, BSTR DNName, BSTR Usage,
                                    BSTR wszPKCS10FileName);
  HRESULT(WINAPI *acceptFilePKCS7)(ICEnroll4 *This, BSTR wszPKCS7FileName);
  HRESULT(WINAPI *createPKCS10)(ICEnroll4 *This, BSTR DNName, BSTR Usage,
                                BSTR *pPKCS10);
  HRESULT(WINAPI *acceptPKCS7)(ICEnroll4 *This, BSTR PKCS7);
  HRESULT(WINAPI *getCertFromPKCS7)(ICEnroll4 *This, BSTR wszPKCS7,
                                    BSTR *pbstrCert);
  HRESULT(WINAPI *enumProviders)(ICEnroll4 *This, LONG dwIndex, LONG dwFlags,
                                 BSTR *pbstrProvName);
  ...
  HRESULT(WINAPI *get_UseExistingKeySet)(ICEnroll4 *This,
                                         WINBOOL *fUseExistingKeys);
  HRESULT(WINAPI *put_UseExistingKeySet)(ICEnroll4 *This,
                                         WINBOOL fUseExistingKeys);
  ...
  HRESULT(WINAPI *addNameValuePairToSignature)(ICEnroll4 *This, BSTR Name,
                                               BSTR Value);
  ...
  HRESULT(WINAPI *GetKeyLen)(ICEnroll4 *This, WINBOOL fMin, WINBOOL fExchange,
                             LONG *pdwKeySize);
  HRESULT(WINAPI *EnumAlgs)(ICEnroll4 *This, LONG dwIndex, LONG algClass,
                            LONG *pdwAlgID);
  HRESULT(WINAPI *GetAlgName)(ICEnroll4 *This, LONG algID, BSTR *pbstr);
  HRESULT(WINAPI *put_ReuseHardwareKeyIfUnableToGenNew)(
      ICEnroll4 *This, WINBOOL fReuseHardwareKeyIfUnableToGenNew);
  HRESULT(WINAPI *get_ReuseHardwareKeyIfUnableToGenNew)(
      ICEnroll4 *This, WINBOOL *fReuseHardwareKeyIfUnableToGenNew);
  HRESULT(WINAPI *put_HashAlgID)(ICEnroll4 *This, LONG hashAlgID);
  HRESULT(WINAPI *get_HashAlgID)(ICEnroll4 *This, LONG *hashAlgID);
  HRESULT(WINAPI *put_LimitExchangeKeyToEncipherment)(
      ICEnroll4 *This, WINBOOL fLimitExchangeKeyToEncipherment);
  HRESULT(WINAPI *get_LimitExchangeKeyToEncipherment)(
      ICEnroll4 *This, WINBOOL *fLimitExchangeKeyToEncipherment);
  HRESULT(WINAPI *put_EnableSMIMECapabilities)(
      ICEnroll4 *This, WINBOOL fEnableSMIMECapabilities);
  HRESULT(WINAPI *get_EnableSMIMECapabilities)(
      ICEnroll4 *This, WINBOOL *fEnableSMIMECapabilities);
  HRESULT(WINAPI *put_PrivateKeyArchiveCertificate)(ICEnroll4 *This,
                                                    BSTR bstrCert);
  HRESULT(WINAPI *get_PrivateKeyArchiveCertificate)(ICEnroll4 *This,
                                                    BSTR *pbstrCert);
  ...
  HRESULT(WINAPI *binaryToString)(ICEnroll4 *This, LONG Flags, BSTR strBinary,
                                  BSTR *pstrEncoded);
  HRESULT(WINAPI *stringToBinary)(ICEnroll4 *This, LONG Flags, BSTR strEncoded,
                                  BSTR *pstrBinary);
  HRESULT(WINAPI *addExtensionToRequest)(ICEnroll4 *This, LONG Flags,
                                         BSTR strName, BSTR strValue);
  HRESULT(WINAPI *addAttributeToRequest)(ICEnroll4 *This, LONG Flags,
                                         BSTR strName, BSTR strValue);
  HRESULT(WINAPI *addNameValuePairToRequest)(ICEnroll4 *This, LONG Flags,
                                             BSTR strName, BSTR strValue);
  HRESULT(WINAPI *resetExtensions)(ICEnroll4 *This);
  HRESULT(WINAPI *resetAttributes)(ICEnroll4 *This);
  HRESULT(WINAPI *createRequest)(ICEnroll4 *This, LONG Flags, BSTR strDNName,
                                 BSTR Usage, BSTR *pstrRequest);
  HRESULT(WINAPI *createFileRequest)(ICEnroll4 *This, LONG Flags,
                                     BSTR strDNName, BSTR strUsage,
                                     BSTR strRequestFileName);
  HRESULT(WINAPI *acceptResponse)(ICEnroll4 *This, BSTR strResponse);
  HRESULT(WINAPI *acceptFileResponse)(ICEnroll4 *This,
                                      BSTR strResponseFileName);
  HRESULT(WINAPI *getCertFromResponse)(ICEnroll4 *This, BSTR strResponse,
                                       BSTR *pstrCert);
  HRESULT(WINAPI *getCertFromFileResponse)(ICEnroll4 *This,
                                           BSTR strResponseFileName,
                                           BSTR *pstrCert);
  HRESULT(WINAPI *createPFX)(ICEnroll4 *This, BSTR strPassword, BSTR *pstrPFX);
  HRESULT(WINAPI *createFilePFX)(ICEnroll4 *This, BSTR strPassword,
                                 BSTR strPFXFileName);
  HRESULT(WINAPI *setPendingRequestInfo)(ICEnroll4 *This, LONG lRequestID,
                                         BSTR strCADNS, BSTR strCAName,
                                         BSTR strFriendlyName);
  HRESULT(WINAPI *enumPendingRequest)(ICEnroll4 *This, LONG lIndex,
                                      LONG lDesiredProperty,
                                      VARIANT *pvarProperty);
  HRESULT(WINAPI *removePendingRequest)(ICEnroll4 *This, BSTR strThumbprint);
  HRESULT(WINAPI *GetKeyLenEx)(ICEnroll4 *This, LONG lSizeSpec, LONG lKeySpec,
                               LONG *pdwKeySize);
  HRESULT(WINAPI *InstallPKCS7Ex)(ICEnroll4 *This, BSTR PKCS7,
                                  LONG *plCertInstalled);
  HRESULT(WINAPI *addCertTypeToRequestEx)(ICEnroll4 *This, LONG lType,
                                          BSTR bstrOIDOrName,
                                          LONG lMajorVersion,
                                          WINBOOL fMinorVersion,
                                          LONG lMinorVersion);
  HRESULT(WINAPI *getProviderType)(ICEnroll4 *This, BSTR strProvName,
                                   LONG *plProvType);
  ...
  HRESULT(WINAPI *addBlobPropertyToCertificate)(ICEnroll4 *This,
                                                LONG lPropertyId,
                                                LONG lReserved,
                                                BSTR bstrProperty);
...
#define ICEnroll4_GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId) \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ICEnroll4_Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)                     \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#define ICEnroll4_GetAlgName(This, algID, pbstr)                               \
  (This)->lpVtbl->GetAlgName(This, algID, pbstr)
#define ICEnroll4_put_ReuseHardwareKeyIfUnableToGenNew(                        \
    This, fReuseHardwareKeyIfUnableToGenNew)                                   \
  (This)->lpVtbl->put_ReuseHardwareKeyIfUnableToGenNew(                        \
      This, fReuseHardwareKeyIfUnableToGenNew)
#define ICEnroll4_get_ReuseHardwareKeyIfUnableToGenNew(                        \
    This, fReuseHardwareKeyIfUnableToGenNew)                                   \
  (This)->lpVtbl->get_ReuseHardwareKeyIfUnableToGenNew(                        \
      This, fReuseHardwareKeyIfUnableToGenNew)
...
#define ICEnroll4_get_HashAlgID(This, hashAlgID)                               \
  (This)->lpVtbl->get_HashAlgID(This, hashAlgID)
#define ICEnroll4_put_LimitExchangeKeyToEncipherment(                          \
    This, fLimitExchangeKeyToEncipherment)                                     \
  (This)->lpVtbl->put_LimitExchangeKeyToEncipherment(                          \
      This, fLimitExchangeKeyToEncipherment)
#define ICEnroll4_get_LimitExchangeKeyToEncipherment(                          \
    This, fLimitExchangeKeyToEncipherment)                                     \
  (This)->lpVtbl->get_LimitExchangeKeyToEncipherment(                          \
      This, fLimitExchangeKeyToEncipherment)
...
#define ICEnroll4_createFileRequest(This, Flags, strDNName, strUsage,          \
                                    strRequestFileName)                        \
  (This)->lpVtbl->createFileRequest(This, Flags, strDNName, strUsage,          \
                                    strRequestFileName)
...
#define ICEnroll4_setPendingRequestInfo(This, lRequestID, strCADNS, strCAName, \
                                        strFriendlyName)                       \
  (This)->lpVtbl->setPendingRequestInfo(This, lRequestID, strCADNS, strCAName, \
                                        strFriendlyName)
#define ICEnroll4_enumPendingRequest(This, lIndex, lDesiredProperty,           \
                                     pvarProperty)                             \
  (This)->lpVtbl->enumPendingRequest(This, lIndex, lDesiredProperty,           \
                                     pvarProperty)
...
#define ICEnroll4_addCertTypeToRequestEx(                                      \
    This, lType, bstrOIDOrName, lMajorVersion, fMinorVersion, lMinorVersion)   \
  (This)->lpVtbl->addCertTypeToRequestEx(                                      \
      This, lType, bstrOIDOrName, lMajorVersion, fMinorVersion, lMinorVersion)
...
#define ICEnroll4_addBlobPropertyToCertificate(This, lPropertyId, lReserved,   \
                                               bstrProperty)                   \
  (This)->lpVtbl->addBlobPropertyToCertificate(This, lPropertyId, lReserved,   \
                                               bstrProperty)
...
#endif
#endif
HRESULT WINAPI ICEnroll4_put_PrivateKeyArchiveCertificate_Proxy(ICEnroll4 *This,
                                                                BSTR bstrCert);
...
HRESULT WINAPI ICEnroll4_get_PrivateKeyArchiveCertificate_Proxy(
    ICEnroll4 *This, BSTR *pbstrCert);
void __RPC_STUB ICEnroll4_get_PrivateKeyArchiveCertificate_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll4_put_ThumbPrint_Proxy(ICEnroll4 *This,
                                              BSTR bstrThumbPrint);
void __RPC_STUB ICEnroll4_put_ThumbPrint_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll4_get_ThumbPrint_Proxy(ICEnroll4 *This,
                                              BSTR *pbstrThumbPrint);
void __RPC_STUB ICEnroll4_get_ThumbPrint_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll4_binaryToString_Proxy(ICEnroll4 *This, LONG Flags,
                                              BSTR strBinary,
                                              BSTR *pstrEncoded);
void __RPC_STUB ICEnroll4_binaryToString_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll4_stringToBinary_Proxy(ICEnroll4 *This, LONG Flags,
                                              BSTR strEncoded,
                                              BSTR *pstrBinary);
void __RPC_STUB ICEnroll4_stringToBinary_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll4_addExtensionToRequest_Proxy(ICEnroll4 *This,
                                                     LONG Flags, BSTR strName,
                                                     BSTR strValue);
void __RPC_STUB ICEnroll4_addExtensionToRequest_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll4_addAttributeToRequest_Proxy(ICEnroll4 *This,
                                                     LONG Flags, BSTR strName,
                                                     BSTR strValue);
void __RPC_STUB ICEnroll4_addAttributeToRequest_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll4_addNameValuePairToRequest_Proxy(ICEnroll4 *This,
                                                         LONG Flags,
                                                         BSTR strName,
                                                         BSTR strValue);
...
void __RPC_STUB ICEnroll4_resetAttributes_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll4_createRequest_Proxy(ICEnroll4 *This, LONG Flags,
                                             BSTR strDNName, BSTR Usage,
                                             BSTR *pstrRequest);
void __RPC_STUB ICEnroll4_createRequest_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll4_createFileRequest_Proxy(ICEnroll4 *This, LONG Flags,
                                                 BSTR strDNName, BSTR strUsage,
                                                 BSTR strRequestFileName);
void __RPC_STUB ICEnroll4_createFileRequest_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll4_acceptResponse_Proxy(ICEnroll4 *This,
                                              BSTR strResponse);
void __RPC_STUB ICEnroll4_acceptResponse_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll4_acceptFileResponse_Proxy(ICEnroll4 *This,
                                                  BSTR strResponseFileName);
void __RPC_STUB ICEnroll4_acceptFileResponse_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll4_getCertFromResponse_Proxy(ICEnroll4 *This,
                                                   BSTR strResponse,
                                                   BSTR *pstrCert);
void __RPC_STUB ICEnroll4_getCertFromResponse_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll4_getCertFromFileResponse_Proxy(ICEnroll4 *This,
                                                       BSTR strResponseFileName,
                                                       BSTR *pstrCert);
void __RPC_STUB ICEnroll4_getCertFromFileResponse_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll4_createPFX_Proxy(ICEnroll4 *This, BSTR strPassword,
                                         BSTR *pstrPFX);
void __RPC_STUB ICEnroll4_createPFX_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll4_createFilePFX_Proxy(ICEnroll4 *This, BSTR strPassword,
                                             BSTR strPFXFileName);
void __RPC_STUB ICEnroll4_createFilePFX_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll4_setPendingRequestInfo_Proxy(ICEnroll4 *This,
                                                     LONG lRequestID,
                                                     BSTR strCADNS,
                                                     BSTR strCAName,
                                                     BSTR strFriendlyName);
void __RPC_STUB ICEnroll4_setPendingRequestInfo_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll4_enumPendingRequest_Proxy(ICEnroll4 *This, LONG lIndex,
                                                  LONG lDesiredProperty,
                                                  VARIANT *pvarProperty);
void __RPC_STUB ICEnroll4_enumPendingRequest_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll4_removePendingRequest_Proxy(ICEnroll4 *This,
                                                    BSTR strThumbprint);
void __RPC_STUB ICEnroll4_removePendingRequest_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll4_GetKeyLenEx_Proxy(ICEnroll4 *This, LONG lSizeSpec,
                                           LONG lKeySpec, LONG *pdwKeySize);
void __RPC_STUB ICEnroll4_GetKeyLenEx_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll4_InstallPKCS7Ex_Proxy(ICEnroll4 *This, BSTR PKCS7,
                                              LONG *plCertInstalled);
void __RPC_STUB ICEnroll4_InstallPKCS7Ex_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll4_addCertTypeToRequestEx_Proxy(
    ICEnroll4 *This, LONG lType, BSTR bstrOIDOrName, LONG lMajorVersion,
    WINBOOL fMinorVersion, LONG lMinorVersion);
void __RPC_STUB ICEnroll4_addCertTypeToRequestEx_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll4_getProviderType_Proxy(ICEnroll4 *This,
                                               BSTR strProvName,
                                               LONG *plProvType);
void __RPC_STUB ICEnroll4_getProviderType_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll4_put_SignerCertificate_Proxy(ICEnroll4 *This,
                                                     BSTR bstrCert);
...
void __RPC_STUB ICEnroll4_get_ClientId_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll4_addBlobPropertyToCertificate_Proxy(ICEnroll4 *This,
                                                            LONG lPropertyId,
                                                            LONG lReserved,
                                                            BSTR bstrProperty);
...
void __RPC_STUB ICEnroll4_resetBlobProperties_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll4_put_IncludeSubjectKeyID_Proxy(ICEnroll4 *This,
                                                       WINBOOL fInclude);
void __RPC_STUB ICEnroll4_put_IncludeSubjectKeyID_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICEnroll4_get_IncludeSubjectKeyID_Proxy(ICEnroll4 *This,
                                                       WINBOOL *pfInclude);
...
public:
  virtual HRESULT WINAPI createFilePKCS10WStr(LPCWSTR DNName, LPCWSTR Usage,
                                              LPCWSTR wszPKCS10FileName) = 0;
  virtual HRESULT WINAPI acceptFilePKCS7WStr(LPCWSTR wszPKCS7FileName) = 0;
  virtual HRESULT WINAPI createPKCS10WStr(LPCWSTR DNName, LPCWSTR Usage,
                                          PCRYPT_DATA_BLOB pPkcs10Blob) = 0;
  virtual HRESULT WINAPI acceptPKCS7Blob(PCRYPT_DATA_BLOB pBlobPKCS7) = 0;
  virtual PCCERT_CONTEXT WINAPI
  getCertContextFromPKCS7(PCRYPT_DATA_BLOB pBlobPKCS7) = 0;
  ...
  virtual HRESULT WINAPI enumProvidersWStr(LONG dwIndex, LONG dwFlags,
                                           LPWSTR *pbstrProvName) = 0;
  ...
  virtual HRESULT WINAPI
  get_RenewalCertificate(PCCERT_CONTEXT *ppCertContext) = 0;
  virtual HRESULT WINAPI
  put_RenewalCertificate(PCCERT_CONTEXT pCertContext) = 0;
  virtual HRESULT WINAPI AddCertTypeToRequestWStr(LPWSTR szw) = 0;
  virtual HRESULT WINAPI AddNameValuePairToSignatureWStr(LPWSTR Name,
                                                         LPWSTR Value) = 0;
  virtual HRESULT WINAPI
  AddExtensionsToRequest(PCERT_EXTENSIONS pCertExtensions) = 0;
  virtual HRESULT WINAPI
  AddAuthenticatedAttributesToPKCS7Request(PCRYPT_ATTRIBUTES pAttributes) = 0;
  virtual HRESULT WINAPI CreatePKCS7RequestFromRequest(
      PCRYPT_DATA_BLOB pRequest, PCCERT_CONTEXT pSigningCertContext,
      PCRYPT_DATA_BLOB pPkcs7Blob) = 0;
};
#ifdef __cplusplus
extern "C" {
#endif
...
typedef struct IEnrollVtbl {
  ...
  HRESULT(WINAPI *enumProvidersWStr)(IEnroll *This, LONG dwIndex, LONG dwFlags,
                                     LPWSTR *pbstrProvName);
  HRESULT(WINAPI *enumContainersWStr)(IEnroll *This, LONG dwIndex,
                                      LPWSTR *pbstr);
  HRESULT(WINAPI *freeRequestInfoBlob)(IEnroll *This,
  ...
  HRESULT(WINAPI *get_UseExistingKeySet)(IEnroll *This,
                                         WINBOOL *fUseExistingKeys);
  HRESULT(WINAPI *put_UseExistingKeySet)(IEnroll *This,
                                         WINBOOL fUseExistingKeys);
  ...
  HRESULT(WINAPI *get_RenewalCertificate)(IEnroll *This,
                                          PCCERT_CONTEXT *ppCertContext);
  HRESULT(WINAPI *put_RenewalCertificate)(IEnroll *This,
                                          PCCERT_CONTEXT pCertContext);
  HRESULT(WINAPI *AddCertTypeToRequestWStr)(IEnroll *This, LPWSTR szw);
  HRESULT(WINAPI *AddNameValuePairToSignatureWStr)(IEnroll *This, LPWSTR Name,
                                                   LPWSTR Value);
  HRESULT(WINAPI *AddExtensionsToRequest)(IEnroll *This,
                                          PCERT_EXTENSIONS pCertExtensions);
  HRESULT(WINAPI *AddAuthenticatedAttributesToPKCS7Request)(
      IEnroll *This, PCRYPT_ATTRIBUTES pAttributes);
  HRESULT(WINAPI *CreatePKCS7RequestFromRequest)(
      IEnroll *This, PCRYPT_DATA_BLOB pRequest,
      PCCERT_CONTEXT pSigningCertContext, PCRYPT_DATA_BLOB pPkcs7Blob);
  END_INTERFACE
} IEnrollVtbl;
struct IEnroll {
...
#define IEnroll_CreatePKCS7RequestFromRequest(This, pRequest,                  \
                                              pSigningCertContext, pPkcs7Blob) \
  (This)->lpVtbl->CreatePKCS7RequestFromRequest(                               \
      This, pRequest, pSigningCertContext, pPkcs7Blob)
#endif
#endif
HRESULT WINAPI IEnroll_createFilePKCS10WStr_Proxy(IEnroll *This, LPCWSTR DNName,
                                                  LPCWSTR Usage,
                                                  LPCWSTR wszPKCS10FileName);
void __RPC_STUB IEnroll_createFilePKCS10WStr_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll_acceptFilePKCS7WStr_Proxy(IEnroll *This,
                                                 LPCWSTR wszPKCS7FileName);
void __RPC_STUB IEnroll_acceptFilePKCS7WStr_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll_createPKCS10WStr_Proxy(IEnroll *This, LPCWSTR DNName,
                                              LPCWSTR Usage,
                                              PCRYPT_DATA_BLOB pPkcs10Blob);
void __RPC_STUB IEnroll_createPKCS10WStr_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll_acceptPKCS7Blob_Proxy(IEnroll *This,
                                             PCRYPT_DATA_BLOB pBlobPKCS7);
void __RPC_STUB IEnroll_acceptPKCS7Blob_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
PCCERT_CONTEXT WINAPI IEnroll_getCertContextFromPKCS7_Proxy(
    IEnroll *This, PCRYPT_DATA_BLOB pBlobPKCS7);
void __RPC_STUB IEnroll_getCertContextFromPKCS7_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HCERTSTORE WINAPI IEnroll_getMyStore_Proxy(IEnroll *This);
void __RPC_STUB IEnroll_getMyStore_Stub(IRpcStubBuffer *This,
                                        IRpcChannelBuffer *_pRpcChannelBuffer,
                                        PRPC_MESSAGE _pRpcMessage,
                                        DWORD *_pdwStubPhase);
HCERTSTORE WINAPI IEnroll_getCAStore_Proxy(IEnroll *This);
void __RPC_STUB IEnroll_getCAStore_Stub(IRpcStubBuffer *This,
                                        IRpcChannelBuffer *_pRpcChannelBuffer,
                                        PRPC_MESSAGE _pRpcMessage,
                                        DWORD *_pdwStubPhase);
...
void __RPC_STUB IEnroll_getROOTHStore_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll_enumProvidersWStr_Proxy(IEnroll *This, LONG dwIndex,
                                               LONG dwFlags,
                                               LPWSTR *pbstrProvName);
void __RPC_STUB IEnroll_enumProvidersWStr_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll_enumContainersWStr_Proxy(IEnroll *This, LONG dwIndex,
                                                LPWSTR *pbstr);
void __RPC_STUB IEnroll_enumContainersWStr_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll_freeRequestInfoBlob_Proxy(IEnroll *This,
                                                 CRYPT_DATA_BLOB pkcs7OrPkcs10);
void __RPC_STUB IEnroll_freeRequestInfoBlob_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll_get_MyStoreNameWStr_Proxy(IEnroll *This,
                                                 LPWSTR *szwName);
...
void __RPC_STUB IEnroll_put_MyStoreNameWStr_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll_get_MyStoreTypeWStr_Proxy(IEnroll *This,
                                                 LPWSTR *szwType);
...
void __RPC_STUB IEnroll_put_MyStoreFlags_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll_get_CAStoreNameWStr_Proxy(IEnroll *This,
                                                 LPWSTR *szwName);
...
void __RPC_STUB IEnroll_put_CAStoreNameWStr_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll_get_CAStoreTypeWStr_Proxy(IEnroll *This,
                                                 LPWSTR *szwType);
...
void __RPC_STUB IEnroll_put_CAStoreFlags_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll_get_RootStoreNameWStr_Proxy(IEnroll *This,
                                                   LPWSTR *szwName);
void __RPC_STUB IEnroll_get_RootStoreNameWStr_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll_put_RootStoreNameWStr_Proxy(IEnroll *This,
                                                   LPWSTR szwName);
void __RPC_STUB IEnroll_put_RootStoreNameWStr_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll_get_RootStoreTypeWStr_Proxy(IEnroll *This,
                                                   LPWSTR *szwType);
void __RPC_STUB IEnroll_get_RootStoreTypeWStr_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll_put_RootStoreTypeWStr_Proxy(IEnroll *This,
                                                   LPWSTR szwType);
...
void __RPC_STUB IEnroll_put_RootStoreFlags_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll_get_RequestStoreNameWStr_Proxy(IEnroll *This,
                                                      LPWSTR *szwName);
void __RPC_STUB IEnroll_get_RequestStoreNameWStr_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll_put_RequestStoreNameWStr_Proxy(IEnroll *This,
                                                      LPWSTR szwName);
void __RPC_STUB IEnroll_put_RequestStoreNameWStr_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll_get_RequestStoreTypeWStr_Proxy(IEnroll *This,
                                                      LPWSTR *szwType);
void __RPC_STUB IEnroll_get_RequestStoreTypeWStr_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll_put_RequestStoreTypeWStr_Proxy(IEnroll *This,
                                                      LPWSTR szwType);
void __RPC_STUB IEnroll_put_RequestStoreTypeWStr_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll_get_RequestStoreFlags_Proxy(IEnroll *This,
                                                   LONG *pdwFlags);
...
void __RPC_STUB IEnroll_put_RequestStoreFlags_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll_get_ContainerNameWStr_Proxy(IEnroll *This,
                                                   LPWSTR *szwContainer);
void __RPC_STUB IEnroll_get_ContainerNameWStr_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll_put_ContainerNameWStr_Proxy(IEnroll *This,
                                                   LPWSTR szwContainer);
void __RPC_STUB IEnroll_put_ContainerNameWStr_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll_get_ProviderNameWStr_Proxy(IEnroll *This,
                                                  LPWSTR *szwProvider);
void __RPC_STUB IEnroll_get_ProviderNameWStr_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll_put_ProviderNameWStr_Proxy(IEnroll *This,
                                                  LPWSTR szwProvider);
...
void __RPC_STUB IEnroll_get_KeySpec_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll_put_KeySpec_Proxy(IEnroll *This, LONG dw);
void __RPC_STUB IEnroll_put_KeySpec_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
...
void __RPC_STUB IEnroll_put_ProviderFlags_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll_get_UseExistingKeySet_Proxy(IEnroll *This,
                                                   WINBOOL *fUseExistingKeys);
void __RPC_STUB IEnroll_get_UseExistingKeySet_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll_put_UseExistingKeySet_Proxy(IEnroll *This,
                                                   WINBOOL fUseExistingKeys);
...
void __RPC_STUB IEnroll_put_GenKeyFlags_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll_get_DeleteRequestCert_Proxy(IEnroll *This,
                                                   WINBOOL *fDelete);
void __RPC_STUB IEnroll_get_DeleteRequestCert_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll_put_DeleteRequestCert_Proxy(IEnroll *This,
                                                   WINBOOL fDelete);
void __RPC_STUB IEnroll_put_DeleteRequestCert_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll_get_WriteCertToUserDS_Proxy(IEnroll *This,
                                                   WINBOOL *fBool);
void __RPC_STUB IEnroll_get_WriteCertToUserDS_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll_put_WriteCertToUserDS_Proxy(IEnroll *This,
                                                   WINBOOL fBool);
void __RPC_STUB IEnroll_put_WriteCertToUserDS_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll_get_EnableT61DNEncoding_Proxy(IEnroll *This,
                                                     WINBOOL *fBool);
void __RPC_STUB IEnroll_get_EnableT61DNEncoding_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll_put_EnableT61DNEncoding_Proxy(IEnroll *This,
                                                     WINBOOL fBool);
...
void __RPC_STUB IEnroll_put_HashAlgorithmWStr_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll_get_RenewalCertificate_Proxy(
    IEnroll *This, PCCERT_CONTEXT *ppCertContext);
void __RPC_STUB IEnroll_get_RenewalCertificate_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll_put_RenewalCertificate_Proxy(
    IEnroll *This, PCCERT_CONTEXT pCertContext);
void __RPC_STUB IEnroll_put_RenewalCertificate_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll_AddCertTypeToRequestWStr_Proxy(IEnroll *This,
                                                      LPWSTR szw);
void __RPC_STUB IEnroll_AddCertTypeToRequestWStr_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll_AddNameValuePairToSignatureWStr_Proxy(IEnroll *This,
                                                             LPWSTR Name,
                                                             LPWSTR Value);
void __RPC_STUB IEnroll_AddNameValuePairToSignatureWStr_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll_AddExtensionsToRequest_Proxy(
    IEnroll *This, PCERT_EXTENSIONS pCertExtensions);
void __RPC_STUB IEnroll_AddExtensionsToRequest_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll_AddAuthenticatedAttributesToPKCS7Request_Proxy(
    IEnroll *This, PCRYPT_ATTRIBUTES pAttributes);
void __RPC_STUB IEnroll_AddAuthenticatedAttributesToPKCS7Request_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll_CreatePKCS7RequestFromRequest_Proxy(
    IEnroll *This, PCRYPT_DATA_BLOB pRequest,
    PCCERT_CONTEXT pSigningCertContext, PCRYPT_DATA_BLOB pPkcs7Blob);
...
typedef struct IEnroll2Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IEnroll2 *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IEnroll2 *This);
  ULONG(WINAPI *Release)(IEnroll2 *This);
  HRESULT(WINAPI *createFilePKCS10WStr)(IEnroll2 *This, LPCWSTR DNName,
                                        LPCWSTR Usage,
                                        LPCWSTR wszPKCS10FileName);
  HRESULT(WINAPI *acceptFilePKCS7WStr)(IEnroll2 *This,
                                       LPCWSTR wszPKCS7FileName);
  HRESULT(WINAPI *createPKCS10WStr)(IEnroll2 *This, LPCWSTR DNName,
                                    LPCWSTR Usage,
                                    PCRYPT_DATA_BLOB pPkcs10Blob);
  HRESULT(WINAPI *acceptPKCS7Blob)(IEnroll2 *This, PCRYPT_DATA_BLOB pBlobPKCS7);
  PCCERT_CONTEXT(WINAPI *getCertContextFromPKCS7)(IEnroll2 *This,
                                                  PCRYPT_DATA_BLOB pBlobPKCS7);
  ...
  HRESULT(WINAPI *enumProvidersWStr)(IEnroll2 *This, LONG dwIndex, LONG dwFlags,
                                     LPWSTR *pbstrProvName);
  HRESULT(WINAPI *enumContainersWStr)(IEnroll2 *This, LONG dwIndex,
                                      LPWSTR *pbstr);
  HRESULT(WINAPI *freeRequestInfoBlob)(IEnroll2 *This,
                                       CRYPT_DATA_BLOB pkcs7OrPkcs10);
  ...
  HRESULT(WINAPI *get_UseExistingKeySet)(IEnroll2 *This,
                                         WINBOOL *fUseExistingKeys);
  HRESULT(WINAPI *put_UseExistingKeySet)(IEnroll2 *This,
                                         WINBOOL fUseExistingKeys);
  ...
  HRESULT(WINAPI *get_RenewalCertificate)(IEnroll2 *This,
                                          PCCERT_CONTEXT *ppCertContext);
  HRESULT(WINAPI *put_RenewalCertificate)(IEnroll2 *This,
                                          PCCERT_CONTEXT pCertContext);
  HRESULT(WINAPI *AddCertTypeToRequestWStr)(IEnroll2 *This, LPWSTR szw);
  HRESULT(WINAPI *AddNameValuePairToSignatureWStr)(IEnroll2 *This, LPWSTR Name,
                                                   LPWSTR Value);
  HRESULT(WINAPI *AddExtensionsToRequest)(IEnroll2 *This,
                                          PCERT_EXTENSIONS pCertExtensions);
  HRESULT(WINAPI *AddAuthenticatedAttributesToPKCS7Request)(
      IEnroll2 *This, PCRYPT_ATTRIBUTES pAttributes);
  HRESULT(WINAPI *CreatePKCS7RequestFromRequest)(
      IEnroll2 *This, PCRYPT_DATA_BLOB pRequest,
      PCCERT_CONTEXT pSigningCertContext, PCRYPT_DATA_BLOB pPkcs7Blob);
  HRESULT(WINAPI *InstallPKCS7Blob)(IEnroll2 *This,
                                    PCRYPT_DATA_BLOB pBlobPKCS7);
  HRESULT(WINAPI *Reset)(IEnroll2 *This);
  HRESULT(WINAPI *GetSupportedKeySpec)(IEnroll2 *This, LONG *pdwKeySpec);
  HRESULT(WINAPI *GetKeyLen)(IEnroll2 *This, WINBOOL fMin, WINBOOL fExchange,
                             LONG *pdwKeySize);
  HRESULT(WINAPI *EnumAlgs)(IEnroll2 *This, LONG dwIndex, LONG algClass,
                            LONG *pdwAlgID);
  HRESULT(WINAPI *GetAlgNameWStr)(IEnroll2 *This, LONG algID, LPWSTR *ppwsz);
  HRESULT(WINAPI *put_ReuseHardwareKeyIfUnableToGenNew)(
      IEnroll2 *This, WINBOOL fReuseHardwareKeyIfUnableToGenNew);
  HRESULT(WINAPI *get_ReuseHardwareKeyIfUnableToGenNew)(
      IEnroll2 *This, WINBOOL *fReuseHardwareKeyIfUnableToGenNew);
  ...
  HRESULT(WINAPI *put_LimitExchangeKeyToEncipherment)(
      IEnroll2 *This, WINBOOL fLimitExchangeKeyToEncipherment);
  HRESULT(WINAPI *get_LimitExchangeKeyToEncipherment)(
      IEnroll2 *This, WINBOOL *fLimitExchangeKeyToEncipherment);
  HRESULT(WINAPI *put_EnableSMIMECapabilities)(
      IEnroll2 *This, WINBOOL fEnableSMIMECapabilities);
  HRESULT(WINAPI *get_EnableSMIMECapabilities)(
      IEnroll2 *This, WINBOOL *fEnableSMIMECapabilities);
  END_INTERFACE
} IEnroll2Vtbl;
...
#define IEnroll2_AddAuthenticatedAttributesToPKCS7Request(This, pAttributes)   \
  (This)->lpVtbl->AddAuthenticatedAttributesToPKCS7Request(This, pAttributes)
#define IEnroll2_CreatePKCS7RequestFromRequest(                                \
    This, pRequest, pSigningCertContext, pPkcs7Blob)                           \
  (This)->lpVtbl->CreatePKCS7RequestFromRequest(                               \
      This, pRequest, pSigningCertContext, pPkcs7Blob)
...
#define IEnroll2_put_ReuseHardwareKeyIfUnableToGenNew(                         \
    This, fReuseHardwareKeyIfUnableToGenNew)                                   \
  (This)->lpVtbl->put_ReuseHardwareKeyIfUnableToGenNew(                        \
      This, fReuseHardwareKeyIfUnableToGenNew)
#define IEnroll2_get_ReuseHardwareKeyIfUnableToGenNew(                         \
    This, fReuseHardwareKeyIfUnableToGenNew)                                   \
  (This)->lpVtbl->get_ReuseHardwareKeyIfUnableToGenNew(                        \
      This, fReuseHardwareKeyIfUnableToGenNew)
...
#define IEnroll2_put_LimitExchangeKeyToEncipherment(                           \
    This, fLimitExchangeKeyToEncipherment)                                     \
  (This)->lpVtbl->put_LimitExchangeKeyToEncipherment(                          \
      This, fLimitExchangeKeyToEncipherment)
#define IEnroll2_get_LimitExchangeKeyToEncipherment(                           \
    This, fLimitExchangeKeyToEncipherment)                                     \
  (This)->lpVtbl->get_LimitExchangeKeyToEncipherment(                          \
      This, fLimitExchangeKeyToEncipherment)
...
#endif
#endif
HRESULT WINAPI IEnroll2_InstallPKCS7Blob_Proxy(IEnroll2 *This,
                                               PCRYPT_DATA_BLOB pBlobPKCS7);
void __RPC_STUB IEnroll2_InstallPKCS7Blob_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll2_Reset_Proxy(IEnroll2 *This);
void __RPC_STUB IEnroll2_Reset_Stub(IRpcStubBuffer *This,
                                    IRpcChannelBuffer *_pRpcChannelBuffer,
                                    PRPC_MESSAGE _pRpcMessage,
                                    DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll2_GetSupportedKeySpec_Proxy(IEnroll2 *This,
                                                  LONG *pdwKeySpec);
void __RPC_STUB IEnroll2_GetSupportedKeySpec_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll2_GetKeyLen_Proxy(IEnroll2 *This, WINBOOL fMin,
                                        WINBOOL fExchange, LONG *pdwKeySize);
void __RPC_STUB IEnroll2_GetKeyLen_Stub(IRpcStubBuffer *This,
                                        IRpcChannelBuffer *_pRpcChannelBuffer,
                                        PRPC_MESSAGE _pRpcMessage,
                                        DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll2_EnumAlgs_Proxy(IEnroll2 *This, LONG dwIndex,
                                       LONG algClass, LONG *pdwAlgID);
void __RPC_STUB IEnroll2_EnumAlgs_Stub(IRpcStubBuffer *This,
                                       IRpcChannelBuffer *_pRpcChannelBuffer,
                                       PRPC_MESSAGE _pRpcMessage,
                                       DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll2_GetAlgNameWStr_Proxy(IEnroll2 *This, LONG algID,
                                             LPWSTR *ppwsz);
void __RPC_STUB IEnroll2_GetAlgNameWStr_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll2_put_ReuseHardwareKeyIfUnableToGenNew_Proxy(
    IEnroll2 *This, WINBOOL fReuseHardwareKeyIfUnableToGenNew);
void __RPC_STUB IEnroll2_put_ReuseHardwareKeyIfUnableToGenNew_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll2_get_ReuseHardwareKeyIfUnableToGenNew_Proxy(
    IEnroll2 *This, WINBOOL *fReuseHardwareKeyIfUnableToGenNew);
...
void __RPC_STUB IEnroll2_SetHStoreMy_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll2_SetHStoreCA_Proxy(IEnroll2 *This, HCERTSTORE hStore);
void __RPC_STUB IEnroll2_SetHStoreCA_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
...
void __RPC_STUB IEnroll2_SetHStoreROOT_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll2_SetHStoreRequest_Proxy(IEnroll2 *This,
                                               HCERTSTORE hStore);
void __RPC_STUB IEnroll2_SetHStoreRequest_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll2_put_LimitExchangeKeyToEncipherment_Proxy(
    IEnroll2 *This, WINBOOL fLimitExchangeKeyToEncipherment);
void __RPC_STUB IEnroll2_put_LimitExchangeKeyToEncipherment_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll2_get_LimitExchangeKeyToEncipherment_Proxy(
    IEnroll2 *This, WINBOOL *fLimitExchangeKeyToEncipherment);
...
void __RPC_STUB IEnroll2_put_EnableSMIMECapabilities_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll2_get_EnableSMIMECapabilities_Proxy(
    IEnroll2 *This, WINBOOL *fEnableSMIMECapabilities);
...
public:
  ...
  virtual HRESULT WINAPI
  get_ThumbPrintWStr(PCRYPT_DATA_BLOB thumbPrintBlob) = 0;
  virtual HRESULT WINAPI
  SetPrivateKeyArchiveCertificate(PCCERT_CONTEXT pPrivateKeyArchiveCert) = 0;
  virtual PCCERT_CONTEXT WINAPI GetPrivateKeyArchiveCertificate(void) = 0;
  virtual HRESULT WINAPI binaryBlobToString(LONG Flags,
                                            PCRYPT_DATA_BLOB pblobBinary,
                                            LPWSTR *ppwszString) = 0;
  virtual HRESULT WINAPI stringToBinaryBlob(LONG Flags, LPCWSTR pwszString,
                                            PCRYPT_DATA_BLOB pblobBinary,
                                            LONG *pdwSkip, LONG *pdwFlags) = 0;
  virtual HRESULT WINAPI addExtensionToRequestWStr(
      LONG Flags, LPCWSTR pwszName, PCRYPT_DATA_BLOB pblobValue) = 0;
  virtual HRESULT WINAPI addAttributeToRequestWStr(
      LONG Flags, LPCWSTR pwszName, PCRYPT_DATA_BLOB pblobValue) = 0;
  virtual HRESULT WINAPI addNameValuePairToRequestWStr(LONG Flags,
                                                       LPCWSTR pwszName,
                                                       LPCWSTR pwszValue) = 0;
  virtual HRESULT WINAPI resetExtensions(void) = 0;
  virtual HRESULT WINAPI resetAttributes(void) = 0;
  virtual HRESULT WINAPI createRequestWStr(LONG Flags, LPCWSTR pwszDNName,
                                           LPCWSTR pwszUsage,
                                           PCRYPT_DATA_BLOB pblobRequest) = 0;
  virtual HRESULT WINAPI createFileRequestWStr(LONG Flags, LPCWSTR pwszDNName,
                                               LPCWSTR pwszUsage,
                                               LPCWSTR pwszRequestFileName) = 0;
  virtual HRESULT WINAPI acceptResponseBlob(PCRYPT_DATA_BLOB pblobResponse) = 0;
  virtual HRESULT WINAPI
  acceptFileResponseWStr(LPCWSTR pwszResponseFileName) = 0;
  virtual HRESULT WINAPI getCertContextFromResponseBlob(
      PCRYPT_DATA_BLOB pblobResponse, PCCERT_CONTEXT *ppCertContext) = 0;
  virtual HRESULT WINAPI getCertContextFromFileResponseWStr(
      LPCWSTR pwszResponseFileName, PCCERT_CONTEXT *ppCertContext) = 0;
  virtual HRESULT WINAPI createPFXWStr(LPCWSTR pwszPassword,
                                       PCRYPT_DATA_BLOB pblobPFX) = 0;
  virtual HRESULT WINAPI createFilePFXWStr(LPCWSTR pwszPassword,
                                           LPCWSTR pwszPFXFileName) = 0;
  virtual HRESULT WINAPI
  setPendingRequestInfoWStr(LONG lRequestID, LPCWSTR pwszCADNS,
                            LPCWSTR pwszCAName, LPCWSTR pwszFriendlyName) = 0;
  virtual HRESULT WINAPI enumPendingRequestWStr(LONG lIndex,
                                                LONG lDesiredProperty,
                                                LPVOID ppProperty) = 0;
  virtual HRESULT WINAPI
  removePendingRequestWStr(CRYPT_DATA_BLOB thumbPrintBlob) = 0;
  virtual HRESULT WINAPI GetKeyLenEx(LONG lSizeSpec, LONG lKeySpec,
                                     LONG *pdwKeySize) = 0;
  virtual HRESULT WINAPI InstallPKCS7BlobEx(PCRYPT_DATA_BLOB pBlobPKCS7,
                                            LONG *plCertInstalled) = 0;
  virtual HRESULT WINAPI AddCertTypeToRequestWStrEx(LONG lType,
                                                    LPCWSTR pwszOIDOrName,
                                                    LONG lMajorVersion,
                                                    WINBOOL fMinorVersion,
                                                    LONG lMinorVersion) = 0;
  virtual HRESULT WINAPI getProviderTypeWStr(LPCWSTR pwszProvName,
                                             LONG *plProvType) = 0;
  virtual HRESULT WINAPI addBlobPropertyToCertificateWStr(
      LONG lPropertyId, LONG lReserved, PCRYPT_DATA_BLOB pBlobProperty) = 0;
...
typedef struct IEnroll4Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IEnroll4 *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IEnroll4 *This);
  ULONG(WINAPI *Release)(IEnroll4 *This);
  HRESULT(WINAPI *createFilePKCS10WStr)(IEnroll4 *This, LPCWSTR DNName,
                                        LPCWSTR Usage,
                                        LPCWSTR wszPKCS10FileName);
  HRESULT(WINAPI *acceptFilePKCS7WStr)(IEnroll4 *This,
                                       LPCWSTR wszPKCS7FileName);
  HRESULT(WINAPI *createPKCS10WStr)(IEnroll4 *This, LPCWSTR DNName,
                                    LPCWSTR Usage,
                                    PCRYPT_DATA_BLOB pPkcs10Blob);
  HRESULT(WINAPI *acceptPKCS7Blob)(IEnroll4 *This, PCRYPT_DATA_BLOB pBlobPKCS7);
  PCCERT_CONTEXT(WINAPI *getCertContextFromPKCS7)(IEnroll4 *This,
                                                  PCRYPT_DATA_BLOB pBlobPKCS7);
  ...
  HRESULT(WINAPI *enumProvidersWStr)(IEnroll4 *This, LONG dwIndex, LONG dwFlags,
                                     LPWSTR *pbstrProvName);
  HRESULT(WINAPI *enumContainersWStr)(IEnroll4 *This, LONG dwIndex,
                                      LPWSTR *pbstr);
  HRESULT(WINAPI *freeRequestInfoBlob)(IEnroll4 *This,
                                       CRYPT_DATA_BLOB pkcs7OrPkcs10);
  ...
  HRESULT(WINAPI *get_UseExistingKeySet)(IEnroll4 *This,
                                         WINBOOL *fUseExistingKeys);
  HRESULT(WINAPI *put_UseExistingKeySet)(IEnroll4 *This,
                                         WINBOOL fUseExistingKeys);
  ...
  HRESULT(WINAPI *get_RenewalCertificate)(IEnroll4 *This,
                                          PCCERT_CONTEXT *ppCertContext);
  HRESULT(WINAPI *put_RenewalCertificate)(IEnroll4 *This,
                                          PCCERT_CONTEXT pCertContext);
  HRESULT(WINAPI *AddCertTypeToRequestWStr)(IEnroll4 *This, LPWSTR szw);
  HRESULT(WINAPI *AddNameValuePairToSignatureWStr)(IEnroll4 *This, LPWSTR Name,
                                                   LPWSTR Value);
  HRESULT(WINAPI *AddExtensionsToRequest)(IEnroll4 *This,
                                          PCERT_EXTENSIONS pCertExtensions);
  HRESULT(WINAPI *AddAuthenticatedAttributesToPKCS7Request)(
      IEnroll4 *This, PCRYPT_ATTRIBUTES pAttributes);
  HRESULT(WINAPI *CreatePKCS7RequestFromRequest)(
      IEnroll4 *This, PCRYPT_DATA_BLOB pRequest,
      PCCERT_CONTEXT pSigningCertContext, PCRYPT_DATA_BLOB pPkcs7Blob);
  HRESULT(WINAPI *InstallPKCS7Blob)(IEnroll4 *This,
                                    PCRYPT_DATA_BLOB pBlobPKCS7);
  HRESULT(WINAPI *Reset)(IEnroll4 *This);
  HRESULT(WINAPI *GetSupportedKeySpec)(IEnroll4 *This, LONG *pdwKeySpec);
  HRESULT(WINAPI *GetKeyLen)(IEnroll4 *This, WINBOOL fMin, WINBOOL fExchange,
                             LONG *pdwKeySize);
  HRESULT(WINAPI *EnumAlgs)(IEnroll4 *This, LONG dwIndex, LONG algClass,
                            LONG *pdwAlgID);
  HRESULT(WINAPI *GetAlgNameWStr)(IEnroll4 *This, LONG algID, LPWSTR *ppwsz);
  HRESULT(WINAPI *put_ReuseHardwareKeyIfUnableToGenNew)(
      IEnroll4 *This, WINBOOL fReuseHardwareKeyIfUnableToGenNew);
  HRESULT(WINAPI *get_ReuseHardwareKeyIfUnableToGenNew)(
      IEnroll4 *This, WINBOOL *fReuseHardwareKeyIfUnableToGenNew);
  ...
  HRESULT(WINAPI *put_LimitExchangeKeyToEncipherment)(
      IEnroll4 *This, WINBOOL fLimitExchangeKeyToEncipherment);
  HRESULT(WINAPI *get_LimitExchangeKeyToEncipherment)(
      IEnroll4 *This, WINBOOL *fLimitExchangeKeyToEncipherment);
  HRESULT(WINAPI *put_EnableSMIMECapabilities)(
      IEnroll4 *This, WINBOOL fEnableSMIMECapabilities);
  HRESULT(WINAPI *get_EnableSMIMECapabilities)(
      IEnroll4 *This, WINBOOL *fEnableSMIMECapabilities);
  HRESULT(WINAPI *put_ThumbPrintWStr)(IEnroll4 *This,
                                      CRYPT_DATA_BLOB thumbPrintBlob);
  HRESULT(WINAPI *get_ThumbPrintWStr)(IEnroll4 *This,
                                      PCRYPT_DATA_BLOB thumbPrintBlob);
  HRESULT(WINAPI *SetPrivateKeyArchiveCertificate)(
      IEnroll4 *This, PCCERT_CONTEXT pPrivateKeyArchiveCert);
  PCCERT_CONTEXT(WINAPI *GetPrivateKeyArchiveCertificate)(IEnroll4 *This);
  HRESULT(WINAPI *binaryBlobToString)(IEnroll4 *This, LONG Flags,
                                      PCRYPT_DATA_BLOB pblobBinary,
                                      LPWSTR *ppwszString);
  HRESULT(WINAPI *stringToBinaryBlob)(IEnroll4 *This, LONG Flags,
                                      LPCWSTR pwszString,
                                      PCRYPT_DATA_BLOB pblobBinary,
                                      LONG *pdwSkip, LONG *pdwFlags);
  HRESULT(WINAPI *addExtensionToRequestWStr)(IEnroll4 *This, LONG Flags,
                                             LPCWSTR pwszName,
                                             PCRYPT_DATA_BLOB pblobValue);
  HRESULT(WINAPI *addAttributeToRequestWStr)(IEnroll4 *This, LONG Flags,
                                             LPCWSTR pwszName,
                                             PCRYPT_DATA_BLOB pblobValue);
  HRESULT(WINAPI *addNameValuePairToRequestWStr)(IEnroll4 *This, LONG Flags,
                                                 LPCWSTR pwszName,
                                                 LPCWSTR pwszValue);
  HRESULT(WINAPI *resetExtensions)(IEnroll4 *This);
  HRESULT(WINAPI *resetAttributes)(IEnroll4 *This);
  HRESULT(WINAPI *createRequestWStr)(IEnroll4 *This, LONG Flags,
                                     LPCWSTR pwszDNName, LPCWSTR pwszUsage,
                                     PCRYPT_DATA_BLOB pblobRequest);
  HRESULT(WINAPI *createFileRequestWStr)(IEnroll4 *This, LONG Flags,
                                         LPCWSTR pwszDNName, LPCWSTR pwszUsage,
                                         LPCWSTR pwszRequestFileName);
  HRESULT(WINAPI *acceptResponseBlob)(IEnroll4 *This,
                                      PCRYPT_DATA_BLOB pblobResponse);
  HRESULT(WINAPI *acceptFileResponseWStr)(IEnroll4 *This,
                                          LPCWSTR pwszResponseFileName);
  HRESULT(WINAPI *getCertContextFromResponseBlob)(
      IEnroll4 *This, PCRYPT_DATA_BLOB pblobResponse,
      PCCERT_CONTEXT *ppCertContext);
  HRESULT(WINAPI *getCertContextFromFileResponseWStr)(
      IEnroll4 *This, LPCWSTR pwszResponseFileName,
      PCCERT_CONTEXT *ppCertContext);
  HRESULT(WINAPI *createPFXWStr)(IEnroll4 *This, LPCWSTR pwszPassword,
                                 PCRYPT_DATA_BLOB pblobPFX);
  HRESULT(WINAPI *createFilePFXWStr)(IEnroll4 *This, LPCWSTR pwszPassword,
                                     LPCWSTR pwszPFXFileName);
  HRESULT(WINAPI *setPendingRequestInfoWStr)(IEnroll4 *This, LONG lRequestID,
                                             LPCWSTR pwszCADNS,
                                             LPCWSTR pwszCAName,
                                             LPCWSTR pwszFriendlyName);
  HRESULT(WINAPI *enumPendingRequestWStr)(IEnroll4 *This, LONG lIndex,
                                          LONG lDesiredProperty,
                                          LPVOID ppProperty);
  HRESULT(WINAPI *removePendingRequestWStr)(IEnroll4 *This,
                                            CRYPT_DATA_BLOB thumbPrintBlob);
  HRESULT(WINAPI *GetKeyLenEx)(IEnroll4 *This, LONG lSizeSpec, LONG lKeySpec,
                               LONG *pdwKeySize);
  HRESULT(WINAPI *InstallPKCS7BlobEx)(IEnroll4 *This,
                                      PCRYPT_DATA_BLOB pBlobPKCS7,
                                      LONG *plCertInstalled);
  HRESULT(WINAPI *AddCertTypeToRequestWStrEx)(IEnroll4 *This, LONG lType,
                                              LPCWSTR pwszOIDOrName,
                                              LONG lMajorVersion,
                                              WINBOOL fMinorVersion,
                                              LONG lMinorVersion);
  HRESULT(WINAPI *getProviderTypeWStr)(IEnroll4 *This, LPCWSTR pwszProvName,
                                       LONG *plProvType);
  HRESULT(WINAPI *addBlobPropertyToCertificateWStr)(
      IEnroll4 *This, LONG lPropertyId, LONG lReserved,
      PCRYPT_DATA_BLOB pBlobProperty);
  HRESULT(WINAPI *SetSignerCertificate)(IEnroll4 *This,
...
#define IEnroll4_AddAuthenticatedAttributesToPKCS7Request(This, pAttributes)   \
  (This)->lpVtbl->AddAuthenticatedAttributesToPKCS7Request(This, pAttributes)
#define IEnroll4_CreatePKCS7RequestFromRequest(                                \
    This, pRequest, pSigningCertContext, pPkcs7Blob)                           \
  (This)->lpVtbl->CreatePKCS7RequestFromRequest(                               \
      This, pRequest, pSigningCertContext, pPkcs7Blob)
...
#define IEnroll4_GetAlgNameWStr(This, algID, ppwsz)                            \
  (This)->lpVtbl->GetAlgNameWStr(This, algID, ppwsz)
#define IEnroll4_put_ReuseHardwareKeyIfUnableToGenNew(                         \
    This, fReuseHardwareKeyIfUnableToGenNew)                                   \
  (This)->lpVtbl->put_ReuseHardwareKeyIfUnableToGenNew(                        \
      This, fReuseHardwareKeyIfUnableToGenNew)
#define IEnroll4_get_ReuseHardwareKeyIfUnableToGenNew(                         \
    This, fReuseHardwareKeyIfUnableToGenNew)                                   \
  (This)->lpVtbl->get_ReuseHardwareKeyIfUnableToGenNew(                        \
      This, fReuseHardwareKeyIfUnableToGenNew)
...
#define IEnroll4_SetHStoreRequest(This, hStore)                                \
  (This)->lpVtbl->SetHStoreRequest(This, hStore)
#define IEnroll4_put_LimitExchangeKeyToEncipherment(                           \
    This, fLimitExchangeKeyToEncipherment)                                     \
  (This)->lpVtbl->put_LimitExchangeKeyToEncipherment(                          \
      This, fLimitExchangeKeyToEncipherment)
#define IEnroll4_get_LimitExchangeKeyToEncipherment(                           \
    This, fLimitExchangeKeyToEncipherment)                                     \
  (This)->lpVtbl->get_LimitExchangeKeyToEncipherment(                          \
      This, fLimitExchangeKeyToEncipherment)
...
#define IEnroll4_stringToBinaryBlob(This, Flags, pwszString, pblobBinary,      \
                                    pdwSkip, pdwFlags)                         \
  (This)->lpVtbl->stringToBinaryBlob(This, Flags, pwszString, pblobBinary,     \
                                     pdwSkip, pdwFlags)
...
#define IEnroll4_addNameValuePairToRequestWStr(This, Flags, pwszName,          \
                                               pwszValue)                      \
  (This)->lpVtbl->addNameValuePairToRequestWStr(This, Flags, pwszName,         \
                                                pwszValue)
...
#define IEnroll4_createRequestWStr(This, Flags, pwszDNName, pwszUsage,         \
                                   pblobRequest)                               \
  (This)->lpVtbl->createRequestWStr(This, Flags, pwszDNName, pwszUsage,        \
                                    pblobRequest)
#define IEnroll4_createFileRequestWStr(This, Flags, pwszDNName, pwszUsage,     \
                                       pwszRequestFileName)                    \
  (This)->lpVtbl->createFileRequestWStr(This, Flags, pwszDNName, pwszUsage,    \
                                        pwszRequestFileName)
...
#define IEnroll4_getCertContextFromResponseBlob(This, pblobResponse,           \
                                                ppCertContext)                 \
  (This)->lpVtbl->getCertContextFromResponseBlob(This, pblobResponse,          \
                                                 ppCertContext)
#define IEnroll4_getCertContextFromFileResponseWStr(                           \
    This, pwszResponseFileName, ppCertContext)                                 \
  (This)->lpVtbl->getCertContextFromFileResponseWStr(                          \
      This, pwszResponseFileName, ppCertContext)
...
#define IEnroll4_setPendingRequestInfoWStr(This, lRequestID, pwszCADNS,        \
                                           pwszCAName, pwszFriendlyName)       \
  (This)->lpVtbl->setPendingRequestInfoWStr(This, lRequestID, pwszCADNS,       \
                                            pwszCAName, pwszFriendlyName)
#define IEnroll4_enumPendingRequestWStr(This, lIndex, lDesiredProperty,        \
                                        ppProperty)                            \
  (This)->lpVtbl->enumPendingRequestWStr(This, lIndex, lDesiredProperty,       \
                                         ppProperty)
...
#define IEnroll4_AddCertTypeToRequestWStrEx(                                   \
    This, lType, pwszOIDOrName, lMajorVersion, fMinorVersion, lMinorVersion)   \
  (This)->lpVtbl->AddCertTypeToRequestWStrEx(                                  \
      This, lType, pwszOIDOrName, lMajorVersion, fMinorVersion, lMinorVersion)
...
#define IEnroll4_addBlobPropertyToCertificateWStr(This, lPropertyId,           \
                                                  lReserved, pBlobProperty)    \
  (This)->lpVtbl->addBlobPropertyToCertificateWStr(This, lPropertyId,          \
                                                   lReserved, pBlobProperty)
...
#endif
HRESULT
    WINAPI IEnroll4_put_ThumbPrintWStr_Proxy(IEnroll4 *This,
                                             CRYPT_DATA_BLOB thumbPrintBlob);
void __RPC_STUB IEnroll4_put_ThumbPrintWStr_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll4_get_ThumbPrintWStr_Proxy(
    IEnroll4 *This, PCRYPT_DATA_BLOB thumbPrintBlob);
void __RPC_STUB IEnroll4_get_ThumbPrintWStr_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll4_SetPrivateKeyArchiveCertificate_Proxy(
    IEnroll4 *This, PCCERT_CONTEXT pPrivateKeyArchiveCert);
void __RPC_STUB IEnroll4_SetPrivateKeyArchiveCertificate_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
PCCERT_CONTEXT WINAPI
IEnroll4_GetPrivateKeyArchiveCertificate_Proxy(IEnroll4 *This);
void __RPC_STUB IEnroll4_GetPrivateKeyArchiveCertificate_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll4_binaryBlobToString_Proxy(IEnroll4 *This, LONG Flags,
                                                 PCRYPT_DATA_BLOB pblobBinary,
                                                 LPWSTR *ppwszString);
void __RPC_STUB IEnroll4_binaryBlobToString_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll4_stringToBinaryBlob_Proxy(IEnroll4 *This, LONG Flags,
                                                 LPCWSTR pwszString,
                                                 PCRYPT_DATA_BLOB pblobBinary,
                                                 LONG *pdwSkip, LONG *pdwFlags);
void __RPC_STUB IEnroll4_stringToBinaryBlob_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll4_addExtensionToRequestWStr_Proxy(
    IEnroll4 *This, LONG Flags, LPCWSTR pwszName, PCRYPT_DATA_BLOB pblobValue);
void __RPC_STUB IEnroll4_addExtensionToRequestWStr_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll4_addAttributeToRequestWStr_Proxy(
    IEnroll4 *This, LONG Flags, LPCWSTR pwszName, PCRYPT_DATA_BLOB pblobValue);
void __RPC_STUB IEnroll4_addAttributeToRequestWStr_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll4_addNameValuePairToRequestWStr_Proxy(IEnroll4 *This,
                                                            LONG Flags,
                                                            LPCWSTR pwszName,
                                                            LPCWSTR pwszValue);
...
void __RPC_STUB IEnroll4_resetAttributes_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll4_createRequestWStr_Proxy(IEnroll4 *This, LONG Flags,
                                                LPCWSTR pwszDNName,
                                                LPCWSTR pwszUsage,
                                                PCRYPT_DATA_BLOB pblobRequest);
void __RPC_STUB IEnroll4_createRequestWStr_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll4_createFileRequestWStr_Proxy(
    IEnroll4 *This, LONG Flags, LPCWSTR pwszDNName, LPCWSTR pwszUsage,
    LPCWSTR pwszRequestFileName);
void __RPC_STUB IEnroll4_createFileRequestWStr_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll4_acceptResponseBlob_Proxy(
    IEnroll4 *This, PCRYPT_DATA_BLOB pblobResponse);
void __RPC_STUB IEnroll4_acceptResponseBlob_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll4_acceptFileResponseWStr_Proxy(
    IEnroll4 *This, LPCWSTR pwszResponseFileName);
void __RPC_STUB IEnroll4_acceptFileResponseWStr_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll4_getCertContextFromResponseBlob_Proxy(
    IEnroll4 *This, PCRYPT_DATA_BLOB pblobResponse,
    PCCERT_CONTEXT *ppCertContext);
void __RPC_STUB IEnroll4_getCertContextFromResponseBlob_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll4_getCertContextFromFileResponseWStr_Proxy(
    IEnroll4 *This, LPCWSTR pwszResponseFileName,
    PCCERT_CONTEXT *ppCertContext);
void __RPC_STUB IEnroll4_getCertContextFromFileResponseWStr_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll4_createPFXWStr_Proxy(IEnroll4 *This,
                                            LPCWSTR pwszPassword,
                                            PCRYPT_DATA_BLOB pblobPFX);
void __RPC_STUB IEnroll4_createPFXWStr_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll4_createFilePFXWStr_Proxy(IEnroll4 *This,
                                                LPCWSTR pwszPassword,
                                                LPCWSTR pwszPFXFileName);
void __RPC_STUB IEnroll4_createFilePFXWStr_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll4_setPendingRequestInfoWStr_Proxy(
    IEnroll4 *This, LONG lRequestID, LPCWSTR pwszCADNS, LPCWSTR pwszCAName,
    LPCWSTR pwszFriendlyName);
void __RPC_STUB IEnroll4_setPendingRequestInfoWStr_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll4_enumPendingRequestWStr_Proxy(IEnroll4 *This,
                                                     LONG lIndex,
                                                     LONG lDesiredProperty,
                                                     LPVOID ppProperty);
...
HRESULT WINAPI IEnroll4_removePendingRequestWStr_Proxy(
    IEnroll4 *This, CRYPT_DATA_BLOB thumbPrintBlob);
void __RPC_STUB IEnroll4_removePendingRequestWStr_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll4_GetKeyLenEx_Proxy(IEnroll4 *This, LONG lSizeSpec,
                                          LONG lKeySpec, LONG *pdwKeySize);
void __RPC_STUB IEnroll4_GetKeyLenEx_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll4_InstallPKCS7BlobEx_Proxy(IEnroll4 *This,
                                                 PCRYPT_DATA_BLOB pBlobPKCS7,
                                                 LONG *plCertInstalled);
void __RPC_STUB IEnroll4_InstallPKCS7BlobEx_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll4_AddCertTypeToRequestWStrEx_Proxy(
    IEnroll4 *This, LONG lType, LPCWSTR pwszOIDOrName, LONG lMajorVersion,
    WINBOOL fMinorVersion, LONG lMinorVersion);
void __RPC_STUB IEnroll4_AddCertTypeToRequestWStrEx_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll4_getProviderTypeWStr_Proxy(IEnroll4 *This,
                                                  LPCWSTR pwszProvName,
                                                  LONG *plProvType);
void __RPC_STUB IEnroll4_getProviderTypeWStr_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll4_addBlobPropertyToCertificateWStr_Proxy(
    IEnroll4 *This, LONG lPropertyId, LONG lReserved,
    PCRYPT_DATA_BLOB pBlobProperty);
void __RPC_STUB IEnroll4_addBlobPropertyToCertificateWStr_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll4_SetSignerCertificate_Proxy(IEnroll4 *This,
                                                   PCCERT_CONTEXT pSignerCert);
...
void __RPC_STUB IEnroll4_get_ClientId_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll4_put_IncludeSubjectKeyID_Proxy(IEnroll4 *This,
                                                      WINBOOL fInclude);
void __RPC_STUB IEnroll4_put_IncludeSubjectKeyID_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnroll4_get_IncludeSubjectKeyID_Proxy(IEnroll4 *This,
                                                      WINBOOL *pfInclude);
