...
IKsControl : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE KsMethod(
      PKSMETHOD Method, ULONG MethodLength, void *MethodData, ULONG DataLength,
      ULONG *BytesReturned) = 0;
  virtual HRESULT STDMETHODCALLTYPE KsEvent(PKSEVENT Event, ULONG EventLength,
                                            void *EventData, ULONG DataLength,
                                            ULONG *BytesReturned) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IKsControl, 0x28f54685, 0x06fd, 0x11d2, 0xb2, 0x7a, 0x00, 0xa0,
                0xc9, 0x22, 0x31, 0x96)
#endif
#else
typedef struct IKsControlVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IKsControl *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IKsControl *This);
  ULONG(STDMETHODCALLTYPE *Release)(IKsControl *This);
  /*** IKsControl methods ***/
  HRESULT(STDMETHODCALLTYPE *KsProperty)(IKsControl *This, PKSPROPERTY Property,
                                         ULONG PropertyLength,
                                         void *PropertyData, ULONG DataLength,
                                         ULONG *BytesReturned);
  HRESULT(STDMETHODCALLTYPE *KsMethod)(IKsControl *This, PKSMETHOD Method,
                                       ULONG MethodLength, void *MethodData,
                                       ULONG DataLength, ULONG *BytesReturned);
  HRESULT(STDMETHODCALLTYPE *KsEvent)(IKsControl *This, PKSEVENT Event,
                                      ULONG EventLength, void *EventData,
                                      ULONG DataLength, ULONG *BytesReturned);
  END_INTERFACE
} IKsControlVtbl;
interface IKsControl { CONST_VTBL IKsControlVtbl *lpVtbl; };
#ifdef COBJMACROS
...
#define IKsControl_KsMethod(This, Method, MethodLength, MethodData,            \
                            DataLength, BytesReturned)                         \
  (This)->lpVtbl->KsMethod(This, Method, MethodLength, MethodData, DataLength, \
                           BytesReturned)
...
#else
/*** IUnknown methods ***/
static inline HRESULT IKsControl_QueryInterface(IKsControl *This, REFIID riid,
                                                void **ppvObject) {
...
IKsControl_KsProperty(IKsControl *This, PKSPROPERTY Property,
                      ULONG PropertyLength, void *PropertyData,
                      ULONG DataLength, ULONG *BytesReturned) {
  return This->lpVtbl->KsProperty(This, Property, PropertyLength, PropertyData,
                                  DataLength, BytesReturned);
}
static inline HRESULT IKsControl_KsMethod(IKsControl *This, PKSMETHOD Method,
                                          ULONG MethodLength, void *MethodData,
                                          ULONG DataLength,
                                          ULONG *BytesReturned) {
  return This->lpVtbl->KsMethod(This, Method, MethodLength, MethodData,
                                DataLength, BytesReturned);
}
static inline HRESULT IKsControl_KsEvent(IKsControl *This, PKSEVENT Event,
                                         ULONG EventLength, void *EventData,
                                         ULONG DataLength,
                                         ULONG *BytesReturned) {
  return This->lpVtbl->KsEvent(This, Event, EventLength, EventData, DataLength,
                               BytesReturned);
}
#endif
#endif
...
DEFINE_GUID(IID_IPerChannelDbLevel, 0xc2f8e001, 0xf205, 0x4bc9, 0x99, 0xbc,
            0xc1, 0x3b, 0x1e, 0x04, 0x8c, 0xcb);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("c2f8e001-f205-4bc9-99bc-c13b1e048ccb")
IPerChannelDbLevel : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetChannelCount(UINT * pcChannels) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetLevelRange(
      UINT nChannel, float *pfMinLevelDB, float *pfMaxLevelDB,
      float *pfStepping) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetLevel(UINT nChannel,
                                             float *pfLevelDB) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetLevel(UINT nChannel, float fLevelDB,
                                             LPCGUID pguidEventContext) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetLevelUniform(
      float fLevelDB, LPCGUID pguidEventContext) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetLevelAllChannels(
      float *aLevelsDB, ULONG cChannels, LPCGUID pguidEventContext) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IPerChannelDbLevel, 0xc2f8e001, 0xf205, 0x4bc9, 0x99, 0xbc,
                0xc1, 0x3b, 0x1e, 0x04, 0x8c, 0xcb)
#endif
#else
typedef struct IPerChannelDbLevelVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPerChannelDbLevel *This,
  ...
  HRESULT(STDMETHODCALLTYPE *GetChannelCount)(IPerChannelDbLevel *This,
                                              UINT *pcChannels);
  HRESULT(STDMETHODCALLTYPE *GetLevelRange)(IPerChannelDbLevel *This,
                                            UINT nChannel, float *pfMinLevelDB,
                                            float *pfMaxLevelDB,
                                            float *pfStepping);
  HRESULT(STDMETHODCALLTYPE *GetLevel)(IPerChannelDbLevel *This, UINT nChannel,
                                       float *pfLevelDB);
  HRESULT(STDMETHODCALLTYPE *SetLevel)(IPerChannelDbLevel *This, UINT nChannel,
                                       float fLevelDB,
                                       LPCGUID pguidEventContext);
  HRESULT(STDMETHODCALLTYPE *SetLevelUniform)(IPerChannelDbLevel *This,
                                              float fLevelDB,
                                              LPCGUID pguidEventContext);
  HRESULT(STDMETHODCALLTYPE *SetLevelAllChannels)(IPerChannelDbLevel *This,
                                                  float *aLevelsDB,
                                                  ULONG cChannels,
                                                  LPCGUID pguidEventContext);
  END_INTERFACE
} IPerChannelDbLevelVtbl;
interface IPerChannelDbLevel { CONST_VTBL IPerChannelDbLevelVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
IPerChannelDbLevel_QueryInterface(IPerChannelDbLevel *This, REFIID riid,
                                  void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IPerChannelDbLevel methods ***/
static inline HRESULT
IPerChannelDbLevel_GetChannelCount(IPerChannelDbLevel *This, UINT *pcChannels) {
  return This->lpVtbl->GetChannelCount(This, pcChannels);
}
static inline HRESULT IPerChannelDbLevel_GetLevelRange(IPerChannelDbLevel *This,
                                                       UINT nChannel,
                                                       float *pfMinLevelDB,
                                                       float *pfMaxLevelDB,
                                                       float *pfStepping) {
  return This->lpVtbl->GetLevelRange(This, nChannel, pfMinLevelDB, pfMaxLevelDB,
                                     pfStepping);
}
static inline HRESULT IPerChannelDbLevel_GetLevel(IPerChannelDbLevel *This,
                                                  UINT nChannel,
                                                  float *pfLevelDB) {
  return This->lpVtbl->GetLevel(This, nChannel, pfLevelDB);
}
static inline HRESULT IPerChannelDbLevel_SetLevel(IPerChannelDbLevel *This,
                                                  UINT nChannel, float fLevelDB,
                                                  LPCGUID pguidEventContext) {
  return This->lpVtbl->SetLevel(This, nChannel, fLevelDB, pguidEventContext);
}
static inline HRESULT
IPerChannelDbLevel_SetLevelUniform(IPerChannelDbLevel *This, float fLevelDB,
                                   LPCGUID pguidEventContext) {
  return This->lpVtbl->SetLevelUniform(This, fLevelDB, pguidEventContext);
}
static inline HRESULT
IPerChannelDbLevel_SetLevelAllChannels(IPerChannelDbLevel *This,
                                       float *aLevelsDB, ULONG cChannels,
                                       LPCGUID pguidEventContext) {
  return This->lpVtbl->SetLevelAllChannels(This, aLevelsDB, cChannels,
                                           pguidEventContext);
}
#endif
#endif
...
DEFINE_GUID(IID_IAudioVolumeLevel, 0x7fb7b48f, 0x531d, 0x44a2, 0xbc, 0xb3, 0x5a,
            0xd5, 0xa1, 0x34, 0xb3, 0xdc);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("7fb7b48f-531d-44a2-bcb3-5ad5a134b3dc")
IAudioVolumeLevel : public IPerChannelDbLevel{};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IAudioVolumeLevel, 0x7fb7b48f, 0x531d, 0x44a2, 0xbc, 0xb3, 0x5a,
                0xd5, 0xa1, 0x34, 0xb3, 0xdc)
#endif
#else
typedef struct IAudioVolumeLevelVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAudioVolumeLevel *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IAudioVolumeLevel *This);
  ULONG(STDMETHODCALLTYPE *Release)(IAudioVolumeLevel *This);
  /*** IPerChannelDbLevel methods ***/
  HRESULT(STDMETHODCALLTYPE *GetChannelCount)(IAudioVolumeLevel *This,
                                              UINT *pcChannels);
  HRESULT(STDMETHODCALLTYPE *GetLevelRange)(IAudioVolumeLevel *This,
                                            UINT nChannel, float *pfMinLevelDB,
                                            float *pfMaxLevelDB,
                                            float *pfStepping);
  HRESULT(STDMETHODCALLTYPE *GetLevel)(IAudioVolumeLevel *This, UINT nChannel,
                                       float *pfLevelDB);
  HRESULT(STDMETHODCALLTYPE *SetLevel)(IAudioVolumeLevel *This, UINT nChannel,
                                       float fLevelDB,
                                       LPCGUID pguidEventContext);
  HRESULT(STDMETHODCALLTYPE *SetLevelUniform)(IAudioVolumeLevel *This,
                                              float fLevelDB,
                                              LPCGUID pguidEventContext);
  HRESULT(STDMETHODCALLTYPE *SetLevelAllChannels)(IAudioVolumeLevel *This,
                                                  float *aLevelsDB,
                                                  ULONG cChannels,
                                                  LPCGUID pguidEventContext);
  END_INTERFACE
} IAudioVolumeLevelVtbl;
interface IAudioVolumeLevel { CONST_VTBL IAudioVolumeLevelVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IAudioVolumeLevel_QueryInterface(IAudioVolumeLevel *This,
                                                       REFIID riid,
                                                       void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IPerChannelDbLevel methods ***/
static inline HRESULT IAudioVolumeLevel_GetChannelCount(IAudioVolumeLevel *This,
                                                        UINT *pcChannels) {
  return This->lpVtbl->GetChannelCount(This, pcChannels);
}
static inline HRESULT IAudioVolumeLevel_GetLevelRange(IAudioVolumeLevel *This,
                                                      UINT nChannel,
                                                      float *pfMinLevelDB,
                                                      float *pfMaxLevelDB,
                                                      float *pfStepping) {
...
static inline HRESULT IAudioVolumeLevel_GetLevel(IAudioVolumeLevel *This,
                                                 UINT nChannel,
                                                 float *pfLevelDB) {
  return This->lpVtbl->GetLevel(This, nChannel, pfLevelDB);
}
static inline HRESULT IAudioVolumeLevel_SetLevel(IAudioVolumeLevel *This,
                                                 UINT nChannel, float fLevelDB,
                                                 LPCGUID pguidEventContext) {
  return This->lpVtbl->SetLevel(This, nChannel, fLevelDB, pguidEventContext);
}
static inline HRESULT
IAudioVolumeLevel_SetLevelUniform(IAudioVolumeLevel *This, float fLevelDB,
                                  LPCGUID pguidEventContext) {
  return This->lpVtbl->SetLevelUniform(This, fLevelDB, pguidEventContext);
}
static inline HRESULT
IAudioVolumeLevel_SetLevelAllChannels(IAudioVolumeLevel *This, float *aLevelsDB,
                                      ULONG cChannels,
                                      LPCGUID pguidEventContext) {
  return This->lpVtbl->SetLevelAllChannels(This, aLevelsDB, cChannels,
                                           pguidEventContext);
...
DEFINE_GUID(IID_IAudioChannelConfig, 0xbb11c46f, 0xec28, 0x493c, 0xb8, 0x8a,
            0x5d, 0xb8, 0x80, 0x62, 0xce, 0x98);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IAudioChannelConfig : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE SetChannelConfig(
      DWORD dwConfig, LPCGUID pguidEventContext) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetChannelConfig(DWORD dwConfig,
                                                     DWORD * pdwConfig) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IAudioChannelConfig, 0xbb11c46f, 0xec28, 0x493c, 0xb8, 0x8a,
                0x5d, 0xb8, 0x80, 0x62, 0xce, 0x98)
#endif
#else
typedef struct IAudioChannelConfigVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAudioChannelConfig *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *SetChannelConfig)(IAudioChannelConfig *This,
                                               DWORD dwConfig,
                                               LPCGUID pguidEventContext);
  HRESULT(STDMETHODCALLTYPE *GetChannelConfig)(IAudioChannelConfig *This,
                                               DWORD dwConfig,
                                               DWORD *pdwConfig);
  END_INTERFACE
} IAudioChannelConfigVtbl;
interface IAudioChannelConfig { CONST_VTBL IAudioChannelConfigVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define IAudioChannelConfig_GetChannelConfig(This, dwConfig, pdwConfig)        \
  (This)->lpVtbl->GetChannelConfig(This, dwConfig, pdwConfig)
#else
/*** IUnknown methods ***/
static inline HRESULT
IAudioChannelConfig_QueryInterface(IAudioChannelConfig *This, REFIID riid,
                                   void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IAudioChannelConfig methods ***/
static inline HRESULT
IAudioChannelConfig_SetChannelConfig(IAudioChannelConfig *This, DWORD dwConfig,
                                     LPCGUID pguidEventContext) {
  return This->lpVtbl->SetChannelConfig(This, dwConfig, pguidEventContext);
}
static inline HRESULT
IAudioChannelConfig_GetChannelConfig(IAudioChannelConfig *This, DWORD dwConfig,
                                     DWORD *pdwConfig) {
...
DEFINE_GUID(IID_IAudioLoudness, 0x7d8b1437, 0xdd53, 0x4350, 0x9c, 0x1b, 0x1e,
            0xe2, 0x89, 0x0b, 0xd9, 0x38);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("7d8b1437-dd53-4350-9c1b-1ee2890bd938")
IAudioLoudness : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetEnabled(WINBOOL * pbEnabled) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetEnabled(WINBOOL bEnabled,
                                               LPCGUID pguidEventContext) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IAudioLoudness, 0x7d8b1437, 0xdd53, 0x4350, 0x9c, 0x1b, 0x1e,
                0xe2, 0x89, 0x0b, 0xd9, 0x38)
#endif
#else
typedef struct IAudioLoudnessVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAudioLoudness *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetEnabled)(IAudioLoudness *This,
                                         WINBOOL *pbEnabled);
  HRESULT(STDMETHODCALLTYPE *SetEnabled)(IAudioLoudness *This, WINBOOL bEnabled,
                                         LPCGUID pguidEventContext);
  END_INTERFACE
} IAudioLoudnessVtbl;
interface IAudioLoudness { CONST_VTBL IAudioLoudnessVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define IAudioLoudness_SetEnabled(This, bEnabled, pguidEventContext)           \
  (This)->lpVtbl->SetEnabled(This, bEnabled, pguidEventContext)
#else
/*** IUnknown methods ***/
static inline HRESULT IAudioLoudness_QueryInterface(IAudioLoudness *This,
                                                    REFIID riid,
                                                    void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IAudioLoudness methods ***/
static inline HRESULT IAudioLoudness_GetEnabled(IAudioLoudness *This,
                                                WINBOOL *pbEnabled) {
  return This->lpVtbl->GetEnabled(This, pbEnabled);
}
static inline HRESULT IAudioLoudness_SetEnabled(IAudioLoudness *This,
                                                WINBOOL bEnabled,
                                                LPCGUID pguidEventContext) {
...
DEFINE_GUID(IID_IAudioInputSelector, 0x4f03dc02, 0x5e6e, 0x4653, 0x8f, 0x72,
            0xa0, 0x30, 0xc1, 0x23, 0xd5, 0x98);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("4f03dc02-5e6e-4653-8f72-a030c123d598")
IAudioInputSelector : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetSelection(UINT * pnIdSelected) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetSelection(UINT nIdSelect,
                                                 LPCGUID pguidEventContext) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IAudioInputSelector, 0x4f03dc02, 0x5e6e, 0x4653, 0x8f, 0x72,
                0xa0, 0x30, 0xc1, 0x23, 0xd5, 0x98)
#endif
#else
typedef struct IAudioInputSelectorVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAudioInputSelector *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetSelection)(IAudioInputSelector *This,
                                           UINT *pnIdSelected);
  HRESULT(STDMETHODCALLTYPE *SetSelection)(IAudioInputSelector *This,
                                           UINT nIdSelect,
                                           LPCGUID pguidEventContext);
  END_INTERFACE
} IAudioInputSelectorVtbl;
interface IAudioInputSelector { CONST_VTBL IAudioInputSelectorVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
IAudioInputSelector_QueryInterface(IAudioInputSelector *This, REFIID riid,
                                   void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IAudioInputSelector methods ***/
static inline HRESULT
IAudioInputSelector_GetSelection(IAudioInputSelector *This,
                                 UINT *pnIdSelected) {
  return This->lpVtbl->GetSelection(This, pnIdSelected);
}
static inline HRESULT
IAudioInputSelector_SetSelection(IAudioInputSelector *This, UINT nIdSelect,
                                 LPCGUID pguidEventContext) {
...
DEFINE_GUID(IID_IAudioOutputSelector, 0xbb515f69, 0x94a7, 0x429e, 0x8b, 0x9c,
            0x27, 0x1b, 0x3f, 0x11, 0xa3, 0xab);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IAudioOutputSelector, 0xbb515f69, 0x94a7, 0x429e, 0x8b, 0x9c,
                0x27, 0x1b, 0x3f, 0x11, 0xa3, 0xab)
#endif
#else
typedef struct IAudioOutputSelectorVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAudioOutputSelector *This,
                                             REFIID riid, void **ppvObject);
...
interface IAudioOutputSelector { CONST_VTBL IAudioOutputSelectorVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
IAudioOutputSelector_QueryInterface(IAudioOutputSelector *This, REFIID riid,
                                    void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IAudioOutputSelector methods ***/
static inline HRESULT
IAudioOutputSelector_GetSelection(IAudioOutputSelector *This,
                                  UINT *pnIdSelected) {
  return This->lpVtbl->GetSelection(This, pnIdSelected);
}
static inline HRESULT
IAudioOutputSelector_SetSelection(IAudioOutputSelector *This, UINT nIdSelect,
                                  LPCGUID pguidEventContext) {
  return This->lpVtbl->SetSelection(This, nIdSelect, pguidEventContext);
}
#endif
...
DEFINE_GUID(IID_IAudioMute, 0xdf45aeea, 0xb74a, 0x4b6b, 0xaf, 0xad, 0x23, 0x66,
            0xb6, 0xaa, 0x01, 0x2e);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("df45aeea-b74a-4b6b-afad-2366b6aa012e")
IAudioMute : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE SetMute(WINBOOL bMute,
                                            LPCGUID pguidEventContext) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetMute(WINBOOL * pbMute) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IAudioMute, 0xdf45aeea, 0xb74a, 0x4b6b, 0xaf, 0xad, 0x23, 0x66,
                0xb6, 0xaa, 0x01, 0x2e)
#endif
#else
typedef struct IAudioMuteVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAudioMute *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IAudioMute *This);
  ULONG(STDMETHODCALLTYPE *Release)(IAudioMute *This);
  /*** IAudioMute methods ***/
  HRESULT(STDMETHODCALLTYPE *SetMute)(IAudioMute *This, WINBOOL bMute,
                                      LPCGUID pguidEventContext);
  HRESULT(STDMETHODCALLTYPE *GetMute)(IAudioMute *This, WINBOOL *pbMute);
  END_INTERFACE
} IAudioMuteVtbl;
interface IAudioMute { CONST_VTBL IAudioMuteVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IAudioMute methods ***/
#define IAudioMute_SetMute(This, bMute, pguidEventContext)                     \
  (This)->lpVtbl->SetMute(This, bMute, pguidEventContext)
#define IAudioMute_GetMute(This, pbMute) (This)->lpVtbl->GetMute(This, pbMute)
#else
/*** IUnknown methods ***/
static inline HRESULT IAudioMute_QueryInterface(IAudioMute *This, REFIID riid,
                                                void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IAudioMute methods ***/
static inline HRESULT IAudioMute_SetMute(IAudioMute *This, WINBOOL bMute,
                                         LPCGUID pguidEventContext) {
...
DEFINE_GUID(IID_IAudioBass, 0xa2b1a1d9, 0x4db3, 0x425d, 0xa2, 0xb2, 0xbd, 0x33,
            0x5c, 0xb3, 0xe2, 0xe5);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("a2b1a1d9-4db3-425d-a2b2-bd335cb3e2e5")
IAudioBass : public IPerChannelDbLevel{};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IAudioBass, 0xa2b1a1d9, 0x4db3, 0x425d, 0xa2, 0xb2, 0xbd, 0x33,
                0x5c, 0xb3, 0xe2, 0xe5)
#endif
#else
typedef struct IAudioBassVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAudioBass *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IAudioBass *This);
  ULONG(STDMETHODCALLTYPE *Release)(IAudioBass *This);
  /*** IPerChannelDbLevel methods ***/
  HRESULT(STDMETHODCALLTYPE *GetChannelCount)(IAudioBass *This,
                                              UINT *pcChannels);
  HRESULT(STDMETHODCALLTYPE *GetLevelRange)(IAudioBass *This, UINT nChannel,
                                            float *pfMinLevelDB,
                                            float *pfMaxLevelDB,
                                            float *pfStepping);
  HRESULT(STDMETHODCALLTYPE *GetLevel)(IAudioBass *This, UINT nChannel,
                                       float *pfLevelDB);
  HRESULT(STDMETHODCALLTYPE *SetLevel)(IAudioBass *This, UINT nChannel,
                                       float fLevelDB,
                                       LPCGUID pguidEventContext);
  HRESULT(STDMETHODCALLTYPE *SetLevelUniform)(IAudioBass *This, float fLevelDB,
                                              LPCGUID pguidEventContext);
  HRESULT(STDMETHODCALLTYPE *SetLevelAllChannels)(IAudioBass *This,
                                                  float *aLevelsDB,
                                                  ULONG cChannels,
                                                  LPCGUID pguidEventContext);
  END_INTERFACE
} IAudioBassVtbl;
interface IAudioBass { CONST_VTBL IAudioBassVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IAudioBass_QueryInterface(IAudioBass *This, REFIID riid,
                                                void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IPerChannelDbLevel methods ***/
static inline HRESULT IAudioBass_GetChannelCount(IAudioBass *This,
                                                 UINT *pcChannels) {
  return This->lpVtbl->GetChannelCount(This, pcChannels);
}
static inline HRESULT IAudioBass_GetLevelRange(IAudioBass *This, UINT nChannel,
                                               float *pfMinLevelDB,
                                               float *pfMaxLevelDB,
                                               float *pfStepping) {
  return This->lpVtbl->GetLevelRange(This, nChannel, pfMinLevelDB, pfMaxLevelDB,
...
static inline HRESULT IAudioBass_GetLevel(IAudioBass *This, UINT nChannel,
                                          float *pfLevelDB) {
  return This->lpVtbl->GetLevel(This, nChannel, pfLevelDB);
}
static inline HRESULT IAudioBass_SetLevel(IAudioBass *This, UINT nChannel,
                                          float fLevelDB,
                                          LPCGUID pguidEventContext) {
  return This->lpVtbl->SetLevel(This, nChannel, fLevelDB, pguidEventContext);
}
static inline HRESULT IAudioBass_SetLevelUniform(IAudioBass *This,
                                                 float fLevelDB,
                                                 LPCGUID pguidEventContext) {
  return This->lpVtbl->SetLevelUniform(This, fLevelDB, pguidEventContext);
}
static inline HRESULT
IAudioBass_SetLevelAllChannels(IAudioBass *This, float *aLevelsDB,
                               ULONG cChannels, LPCGUID pguidEventContext) {
  return This->lpVtbl->SetLevelAllChannels(This, aLevelsDB, cChannels,
                                           pguidEventContext);
}
#endif
...
DEFINE_GUID(IID_IAudioMidRange, 0x5e54b6d7, 0xb44b, 0x40d9, 0x9a, 0x9e, 0xe6,
            0x91, 0xd9, 0xce, 0x6e, 0xdf);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("5e54b6d7-b44b-40d9-9a9e-e691d9ce6edf")
IAudioMidRange : public IPerChannelDbLevel{};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IAudioMidRange, 0x5e54b6d7, 0xb44b, 0x40d9, 0x9a, 0x9e, 0xe6,
                0x91, 0xd9, 0xce, 0x6e, 0xdf)
#endif
#else
typedef struct IAudioMidRangeVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAudioMidRange *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IAudioMidRange *This);
  ULONG(STDMETHODCALLTYPE *Release)(IAudioMidRange *This);
  /*** IPerChannelDbLevel methods ***/
  HRESULT(STDMETHODCALLTYPE *GetChannelCount)(IAudioMidRange *This,
                                              UINT *pcChannels);
  HRESULT(STDMETHODCALLTYPE *GetLevelRange)(IAudioMidRange *This, UINT nChannel,
                                            float *pfMinLevelDB,
                                            float *pfMaxLevelDB,
                                            float *pfStepping);
  HRESULT(STDMETHODCALLTYPE *GetLevel)(IAudioMidRange *This, UINT nChannel,
                                       float *pfLevelDB);
  HRESULT(STDMETHODCALLTYPE *SetLevel)(IAudioMidRange *This, UINT nChannel,
                                       float fLevelDB,
                                       LPCGUID pguidEventContext);
  HRESULT(STDMETHODCALLTYPE *SetLevelUniform)(IAudioMidRange *This,
                                              float fLevelDB,
                                              LPCGUID pguidEventContext);
  HRESULT(STDMETHODCALLTYPE *SetLevelAllChannels)(IAudioMidRange *This,
                                                  float *aLevelsDB,
                                                  ULONG cChannels,
                                                  LPCGUID pguidEventContext);
  END_INTERFACE
} IAudioMidRangeVtbl;
interface IAudioMidRange { CONST_VTBL IAudioMidRangeVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IAudioMidRange_QueryInterface(IAudioMidRange *This,
                                                    REFIID riid,
                                                    void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IPerChannelDbLevel methods ***/
static inline HRESULT IAudioMidRange_GetChannelCount(IAudioMidRange *This,
                                                     UINT *pcChannels) {
  return This->lpVtbl->GetChannelCount(This, pcChannels);
}
static inline HRESULT IAudioMidRange_GetLevelRange(IAudioMidRange *This,
                                                   UINT nChannel,
                                                   float *pfMinLevelDB,
                                                   float *pfMaxLevelDB,
                                                   float *pfStepping) {
...
static inline HRESULT IAudioMidRange_GetLevel(IAudioMidRange *This,
                                              UINT nChannel, float *pfLevelDB) {
  return This->lpVtbl->GetLevel(This, nChannel, pfLevelDB);
}
static inline HRESULT IAudioMidRange_SetLevel(IAudioMidRange *This,
                                              UINT nChannel, float fLevelDB,
                                              LPCGUID pguidEventContext) {
  return This->lpVtbl->SetLevel(This, nChannel, fLevelDB, pguidEventContext);
}
static inline HRESULT
IAudioMidRange_SetLevelUniform(IAudioMidRange *This, float fLevelDB,
                               LPCGUID pguidEventContext) {
  return This->lpVtbl->SetLevelUniform(This, fLevelDB, pguidEventContext);
}
static inline HRESULT
IAudioMidRange_SetLevelAllChannels(IAudioMidRange *This, float *aLevelsDB,
                                   ULONG cChannels, LPCGUID pguidEventContext) {
  return This->lpVtbl->SetLevelAllChannels(This, aLevelsDB, cChannels,
                                           pguidEventContext);
}
...
DEFINE_GUID(IID_IAudioTreble, 0x0a717812, 0x694e, 0x4907, 0xb7, 0x4b, 0xba,
            0xfa, 0x5c, 0xfd, 0xca, 0x7b);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("0a717812-694e-4907-b74b-bafa5cfdca7b")
IAudioTreble : public IPerChannelDbLevel{};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IAudioTreble, 0x0a717812, 0x694e, 0x4907, 0xb7, 0x4b, 0xba,
                0xfa, 0x5c, 0xfd, 0xca, 0x7b)
#endif
#else
typedef struct IAudioTrebleVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAudioTreble *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IAudioTreble *This);
  ULONG(STDMETHODCALLTYPE *Release)(IAudioTreble *This);
  /*** IPerChannelDbLevel methods ***/
  HRESULT(STDMETHODCALLTYPE *GetChannelCount)(IAudioTreble *This,
                                              UINT *pcChannels);
  HRESULT(STDMETHODCALLTYPE *GetLevelRange)(IAudioTreble *This, UINT nChannel,
                                            float *pfMinLevelDB,
                                            float *pfMaxLevelDB,
                                            float *pfStepping);
  HRESULT(STDMETHODCALLTYPE *GetLevel)(IAudioTreble *This, UINT nChannel,
                                       float *pfLevelDB);
  HRESULT(STDMETHODCALLTYPE *SetLevel)(IAudioTreble *This, UINT nChannel,
                                       float fLevelDB,
                                       LPCGUID pguidEventContext);
  HRESULT(STDMETHODCALLTYPE *SetLevelUniform)(IAudioTreble *This,
                                              float fLevelDB,
                                              LPCGUID pguidEventContext);
  HRESULT(STDMETHODCALLTYPE *SetLevelAllChannels)(IAudioTreble *This,
                                                  float *aLevelsDB,
                                                  ULONG cChannels,
                                                  LPCGUID pguidEventContext);
  END_INTERFACE
} IAudioTrebleVtbl;
interface IAudioTreble { CONST_VTBL IAudioTrebleVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
IAudioTreble_QueryInterface(IAudioTreble *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IPerChannelDbLevel methods ***/
static inline HRESULT IAudioTreble_GetChannelCount(IAudioTreble *This,
                                                   UINT *pcChannels) {
  return This->lpVtbl->GetChannelCount(This, pcChannels);
}
static inline HRESULT IAudioTreble_GetLevelRange(IAudioTreble *This,
                                                 UINT nChannel,
                                                 float *pfMinLevelDB,
                                                 float *pfMaxLevelDB,
                                                 float *pfStepping) {
...
static inline HRESULT IAudioTreble_GetLevel(IAudioTreble *This, UINT nChannel,
                                            float *pfLevelDB) {
  return This->lpVtbl->GetLevel(This, nChannel, pfLevelDB);
}
static inline HRESULT IAudioTreble_SetLevel(IAudioTreble *This, UINT nChannel,
                                            float fLevelDB,
                                            LPCGUID pguidEventContext) {
  return This->lpVtbl->SetLevel(This, nChannel, fLevelDB, pguidEventContext);
}
static inline HRESULT IAudioTreble_SetLevelUniform(IAudioTreble *This,
                                                   float fLevelDB,
                                                   LPCGUID pguidEventContext) {
  return This->lpVtbl->SetLevelUniform(This, fLevelDB, pguidEventContext);
}
static inline HRESULT
IAudioTreble_SetLevelAllChannels(IAudioTreble *This, float *aLevelsDB,
                                 ULONG cChannels, LPCGUID pguidEventContext) {
  return This->lpVtbl->SetLevelAllChannels(This, aLevelsDB, cChannels,
                                           pguidEventContext);
}
...
DEFINE_GUID(IID_IAudioAutoGainControl, 0x85401fd4, 0x6de4, 0x4b9d, 0x98, 0x69,
            0x2d, 0x67, 0x53, 0xa8, 0x2f, 0x3c);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("85401fd4-6de4-4b9d-9869-2d6753a82f3c")
IAudioAutoGainControl : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetEnabled(WINBOOL bEnabled,
                                               LPCGUID pguidEventContext) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetMute(WINBOOL * pbEnabled) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IAudioAutoGainControl, 0x85401fd4, 0x6de4, 0x4b9d, 0x98, 0x69,
                0x2d, 0x67, 0x53, 0xa8, 0x2f, 0x3c)
#endif
#else
typedef struct IAudioAutoGainControlVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAudioAutoGainControl *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetEnabled)(IAudioAutoGainControl *This,
                                         WINBOOL bEnabled,
                                         LPCGUID pguidEventContext);
  HRESULT(STDMETHODCALLTYPE *GetMute)(IAudioAutoGainControl *This,
                                      WINBOOL *pbEnabled);
  END_INTERFACE
...
/*** IAudioAutoGainControl methods ***/
#define IAudioAutoGainControl_GetEnabled(This, bEnabled, pguidEventContext)    \
  (This)->lpVtbl->GetEnabled(This, bEnabled, pguidEventContext)
#define IAudioAutoGainControl_GetMute(This, pbEnabled)                         \
  (This)->lpVtbl->GetMute(This, pbEnabled)
#else
/*** IUnknown methods ***/
static inline HRESULT
IAudioAutoGainControl_QueryInterface(IAudioAutoGainControl *This, REFIID riid,
                                     void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IAudioAutoGainControl methods ***/
static inline HRESULT
IAudioAutoGainControl_GetEnabled(IAudioAutoGainControl *This, WINBOOL bEnabled,
                                 LPCGUID pguidEventContext) {
  return This->lpVtbl->GetEnabled(This, bEnabled, pguidEventContext);
}
static inline HRESULT IAudioAutoGainControl_GetMute(IAudioAutoGainControl *This,
                                                    WINBOOL *pbEnabled) {
...
DEFINE_GUID(IID_IAudioPeakMeter, 0xdd79923c, 0x0599, 0x45e0, 0xb8, 0xb6, 0xc8,
            0xdf, 0x7d, 0xb6, 0xe7, 0x96);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("dd79923c-0599-45e0-b8b6-c8df7db6e796")
IAudioPeakMeter : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetChannelCount(UINT * pcChannels) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetLevel(UINT nChannel, float *pfLevel) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IAudioPeakMeter, 0xdd79923c, 0x0599, 0x45e0, 0xb8, 0xb6, 0xc8,
                0xdf, 0x7d, 0xb6, 0xe7, 0x96)
#endif
#else
typedef struct IAudioPeakMeterVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAudioPeakMeter *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetChannelCount)(IAudioPeakMeter *This,
                                              UINT *pcChannels);
  HRESULT(STDMETHODCALLTYPE *GetLevel)(IAudioPeakMeter *This, UINT nChannel,
                                       float *pfLevel);
  END_INTERFACE
} IAudioPeakMeterVtbl;
interface IAudioPeakMeter { CONST_VTBL IAudioPeakMeterVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IAudioPeakMeter_QueryInterface(IAudioPeakMeter *This,
                                                     REFIID riid,
                                                     void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IAudioPeakMeter methods ***/
static inline HRESULT IAudioPeakMeter_GetChannelCount(IAudioPeakMeter *This,
                                                      UINT *pcChannels) {
  return This->lpVtbl->GetChannelCount(This, pcChannels);
}
static inline HRESULT IAudioPeakMeter_GetLevel(IAudioPeakMeter *This,
                                               UINT nChannel, float *pfLevel) {
...
DEFINE_GUID(IID_IDeviceSpecificProperty, 0x3b22bcbf, 0x2586, 0x4af0, 0x85, 0x83,
            0x20, 0x5d, 0x39, 0x1b, 0x80, 0x7c);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("3b22bcbf-2586-4af0-8583-205d391b807c")
IDeviceSpecificProperty : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetType(VARTYPE * pVType) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetValue(VARTYPE * pvType,
                                             DWORD * pcbValue) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetValue(void *pvValue, DWORD cbValue,
                                             LPCGUID pguidEventContext) = 0;
  virtual HRESULT STDMETHODCALLTYPE Get4BRange(LONG * plMin, LONG * plMax,
                                               LONG * plStepping) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDeviceSpecificProperty, 0x3b22bcbf, 0x2586, 0x4af0, 0x85, 0x83,
                0x20, 0x5d, 0x39, 0x1b, 0x80, 0x7c)
#endif
#else
typedef struct IDeviceSpecificPropertyVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDeviceSpecificProperty *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetType)(IDeviceSpecificProperty *This,
                                      VARTYPE *pVType);
  HRESULT(STDMETHODCALLTYPE *GetValue)(IDeviceSpecificProperty *This,
                                       VARTYPE *pvType, DWORD *pcbValue);
  HRESULT(STDMETHODCALLTYPE *SetValue)(IDeviceSpecificProperty *This,
                                       void *pvValue, DWORD cbValue,
                                       LPCGUID pguidEventContext);
  HRESULT(STDMETHODCALLTYPE *Get4BRange)(IDeviceSpecificProperty *This,
                                         LONG *plMin, LONG *plMax,
                                         LONG *plStepping);
  END_INTERFACE
...
#define IDeviceSpecificProperty_GetValue(This, pvType, pcbValue)               \
  (This)->lpVtbl->GetValue(This, pvType, pcbValue)
...
/*** IUnknown methods ***/
static inline HRESULT
IDeviceSpecificProperty_QueryInterface(IDeviceSpecificProperty *This,
                                       REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IDeviceSpecificProperty_AddRef(IDeviceSpecificProperty *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IDeviceSpecificProperty_Release(IDeviceSpecificProperty *This) {
  return This->lpVtbl->Release(This);
}
/*** IDeviceSpecificProperty methods ***/
static inline HRESULT
IDeviceSpecificProperty_GetType(IDeviceSpecificProperty *This,
                                VARTYPE *pVType) {
  return This->lpVtbl->GetType(This, pVType);
}
static inline HRESULT
IDeviceSpecificProperty_GetValue(IDeviceSpecificProperty *This, VARTYPE *pvType,
                                 DWORD *pcbValue) {
  return This->lpVtbl->GetValue(This, pvType, pcbValue);
}
static inline HRESULT
IDeviceSpecificProperty_SetValue(IDeviceSpecificProperty *This, void *pvValue,
                                 DWORD cbValue, LPCGUID pguidEventContext) {
  return This->lpVtbl->SetValue(This, pvValue, cbValue, pguidEventContext);
}
static inline HRESULT
IDeviceSpecificProperty_Get4BRange(IDeviceSpecificProperty *This, LONG *plMin,
                                   LONG *plMax, LONG *plStepping) {
...
DEFINE_GUID(IID_IKsFormatSupport, 0x3cb4a69d, 0xbb6f, 0x4d2b, 0x95, 0xb7, 0x45,
            0x2d, 0x2c, 0x15, 0x5d, 0xb5);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("3cb4a69d-bb6f-4d2b-95b7-452d2c155db5")
IKsFormatSupport : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE IsFormatSupported(
      PKSDATAFORMAT pKsFormat, DWORD cbFormat, WINBOOL * pbSupported) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetDevicePreferredFormat(PKSDATAFORMAT *
                                                             ppKsFormat) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IKsFormatSupport, 0x3cb4a69d, 0xbb6f, 0x4d2b, 0x95, 0xb7, 0x45,
                0x2d, 0x2c, 0x15, 0x5d, 0xb5)
#endif
#else
typedef struct IKsFormatSupportVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IKsFormatSupport *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetDevicePreferredFormat)(
      IKsFormatSupport *This, PKSDATAFORMAT *ppKsFormat);
  END_INTERFACE
} IKsFormatSupportVtbl;
interface IKsFormatSupport { CONST_VTBL IKsFormatSupportVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IKsFormatSupport_QueryInterface(IKsFormatSupport *This,
                                                      REFIID riid,
                                                      void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IKsFormatSupport methods ***/
static inline HRESULT
IKsFormatSupport_IsFormatSupported(IKsFormatSupport *This,
                                   PKSDATAFORMAT pKsFormat, DWORD cbFormat,
                                   WINBOOL *pbSupported) {
  return This->lpVtbl->IsFormatSupported(This, pKsFormat, cbFormat,
                                         pbSupported);
}
static inline HRESULT
IKsFormatSupport_GetDevicePreferredFormat(IKsFormatSupport *This,
...
DEFINE_GUID(IID_IKsJackDescription, 0x4509f757, 0x2d46, 0x4637, 0x8e, 0x62,
            0xce, 0x7d, 0xb9, 0x44, 0xf5, 0x7b);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("4509f757-2d46-4637-8e62-ce7db944f57b")
IKsJackDescription : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetJackCount(UINT * pcJacks) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetJackDescription(
      UINT nJack, KSJACK_DESCRIPTION * pDescription) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IKsJackDescription, 0x4509f757, 0x2d46, 0x4637, 0x8e, 0x62,
                0xce, 0x7d, 0xb9, 0x44, 0xf5, 0x7b)
#endif
#else
typedef struct IKsJackDescriptionVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IKsJackDescription *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetJackCount)(IKsJackDescription *This,
                                           UINT *pcJacks);
  HRESULT(STDMETHODCALLTYPE *GetJackDescription)(
      IKsJackDescription *This, UINT nJack, KSJACK_DESCRIPTION *pDescription);
  END_INTERFACE
} IKsJackDescriptionVtbl;
interface IKsJackDescription { CONST_VTBL IKsJackDescriptionVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
IKsJackDescription_QueryInterface(IKsJackDescription *This, REFIID riid,
                                  void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IKsJackDescription methods ***/
static inline HRESULT IKsJackDescription_GetJackCount(IKsJackDescription *This,
                                                      UINT *pcJacks) {
  return This->lpVtbl->GetJackCount(This, pcJacks);
}
static inline HRESULT
IKsJackDescription_GetJackDescription(IKsJackDescription *This, UINT nJack,
...
DEFINE_GUID(IID_IKsJackDescription2, 0x478f3a9b, 0xe0c9, 0x4827, 0x92, 0x28,
            0x6f, 0x55, 0x05, 0xff, 0xe7, 0x6a);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IKsJackDescription2 : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE GetJackDescription2(
      UINT nJack, KSJACK_DESCRIPTION2 * pDescription2) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IKsJackDescription2, 0x478f3a9b, 0xe0c9, 0x4827, 0x92, 0x28,
                0x6f, 0x55, 0x05, 0xff, 0xe7, 0x6a)
#endif
#else
typedef struct IKsJackDescription2Vtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IKsJackDescription2 *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetJackCount)(IKsJackDescription2 *This,
                                           UINT *pcJacks);
  HRESULT(STDMETHODCALLTYPE *GetJackDescription2)(
      IKsJackDescription2 *This, UINT nJack,
      KSJACK_DESCRIPTION2 *pDescription2);
  END_INTERFACE
} IKsJackDescription2Vtbl;
interface IKsJackDescription2 { CONST_VTBL IKsJackDescription2Vtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
IKsJackDescription2_QueryInterface(IKsJackDescription2 *This, REFIID riid,
                                   void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IKsJackDescription2 methods ***/
static inline HRESULT
IKsJackDescription2_GetJackCount(IKsJackDescription2 *This, UINT *pcJacks) {
  return This->lpVtbl->GetJackCount(This, pcJacks);
}
static inline HRESULT
IKsJackDescription2_GetJackDescription2(IKsJackDescription2 *This, UINT nJack,
                                        KSJACK_DESCRIPTION2 *pDescription2) {
...
DEFINE_GUID(IID_IKsJackSinkInformation, 0xd9bd72ed, 0x290f, 0x4581, 0x9f, 0xf3,
            0x61, 0x02, 0x7a, 0x8f, 0xe5, 0x32);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IKsJackSinkInformation, 0xd9bd72ed, 0x290f, 0x4581, 0x9f, 0xf3,
                0x61, 0x02, 0x7a, 0x8f, 0xe5, 0x32)
#endif
#else
typedef struct IKsJackSinkInformationVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IKsJackSinkInformation *This,
                                             REFIID riid, void **ppvObject);
...
/*** IKsJackSinkInformation methods ***/
#define IKsJackSinkInformation_GetJackSinkInformation(This,                    \
                                                      pJackSinkInformation)    \
  (This)->lpVtbl->GetJackSinkInformation(This, pJackSinkInformation)
#else
/*** IUnknown methods ***/
static inline HRESULT
IKsJackSinkInformation_QueryInterface(IKsJackSinkInformation *This, REFIID riid,
                                      void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IKsJackSinkInformation_AddRef(IKsJackSinkInformation *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IKsJackSinkInformation_Release(IKsJackSinkInformation *This) {
  return This->lpVtbl->Release(This);
}
/*** IKsJackSinkInformation methods ***/
static inline HRESULT IKsJackSinkInformation_GetJackSinkInformation(
    IKsJackSinkInformation *This,
    KSJACK_SINK_INFORMATION *pJackSinkInformation) {
...
DEFINE_GUID(IID_IPartsList, 0x6daa848c, 0x5eb0, 0x45cc, 0xae, 0xa5, 0x99, 0x8a,
            0x2c, 0xda, 0x1f, 0xfb);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IPartsList : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE GetPart(UINT nIndex, IPart * *ppPart) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IPartsList, 0x6daa848c, 0x5eb0, 0x45cc, 0xae, 0xa5, 0x99, 0x8a,
                0x2c, 0xda, 0x1f, 0xfb)
#endif
#else
typedef struct IPartsListVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPartsList *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetPart)(IPartsList *This, UINT nIndex,
                                      IPart **ppPart);
  END_INTERFACE
} IPartsListVtbl;
interface IPartsList { CONST_VTBL IPartsListVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IPartsList_QueryInterface(IPartsList *This, REFIID riid,
                                                void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
static inline HRESULT IPartsList_GetPart(IPartsList *This, UINT nIndex,
                                         IPart **ppPart) {
...
DEFINE_GUID(IID_IPart, 0xae2de0e4, 0x5bca, 0x4f2d, 0xaa, 0x46, 0x5d, 0x13, 0xf8,
            0xfd, 0xb3, 0xa9);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IPart : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE GetGlobalId(LPWSTR * ppwstrGlobalId) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetControlInterfaceCount(UINT * pCount) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetControlInterface(
      UINT nIndex, IControlInterface * *ppInterfaceDesc) = 0;
  virtual HRESULT STDMETHODCALLTYPE EnumPartsIncoming(IPartsList *
                                                      *ppParts) = 0;
  virtual HRESULT STDMETHODCALLTYPE EnumPartsOutgoing(IPartsList *
                                                      *ppParts) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetTopologyObjects(IDeviceTopology *
                                                       *ppTopology) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE RegisterControlChangeCallback(
      REFGUID riid, IControlChangeNotify * pNotify) = 0;
  virtual HRESULT STDMETHODCALLTYPE UnregisterControlChangeCallback(
      IControlChangeNotify * pNotify) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IPart, 0xae2de0e4, 0x5bca, 0x4f2d, 0xaa, 0x46, 0x5d, 0x13, 0xf8,
                0xfd, 0xb3, 0xa9)
#endif
#else
typedef struct IPartVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPart *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetControlInterface)(
      IPart *This, UINT nIndex, IControlInterface **ppInterfaceDesc);
  HRESULT(STDMETHODCALLTYPE *EnumPartsIncoming)(IPart *This,
                                                IPartsList **ppParts);
  HRESULT(STDMETHODCALLTYPE *EnumPartsOutgoing)(IPart *This,
                                                IPartsList **ppParts);
  HRESULT(STDMETHODCALLTYPE *GetTopologyObjects)(IPart *This,
                                                 IDeviceTopology **ppTopology);
  HRESULT(STDMETHODCALLTYPE *Activate)(IPart *This, DWORD dwClsContext,
                                       REFIID refiid, void **ppvObject);
  HRESULT(STDMETHODCALLTYPE *RegisterControlChangeCallback)(
      IPart *This, REFGUID riid, IControlChangeNotify *pNotify);
  HRESULT(STDMETHODCALLTYPE *UnregisterControlChangeCallback)(
      IPart *This, IControlChangeNotify *pNotify);
  END_INTERFACE
} IPartVtbl;
interface IPart { CONST_VTBL IPartVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define IPart_GetTopologyObjects(This, ppTopology)                             \
  (This)->lpVtbl->GetTopologyObjects(This, ppTopology)
...
#else
/*** IUnknown methods ***/
static inline HRESULT IPart_QueryInterface(IPart *This, REFIID riid,
                                           void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
DEFINE_GUID(IID_IConnector, 0x9c2c4058, 0x23f5, 0x41de, 0x87, 0x7a, 0xdf, 0x3a,
            0xf2, 0x36, 0xa0, 0x9e);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IConnector : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE IsConnected(WINBOOL * pbConnected) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetDeviceIdConnectedTo(LPWSTR *
                                                           ppwstrDeviceId) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IConnector, 0x9c2c4058, 0x23f5, 0x41de, 0x87, 0x7a, 0xdf, 0x3a,
                0xf2, 0x36, 0xa0, 0x9e)
#endif
#else
typedef struct IConnectorVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IConnector *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *ConnectTo)(IConnector *This,
                                        IConnector *pConnectTo);
  HRESULT(STDMETHODCALLTYPE *Disconnect)(IConnector *This);
  HRESULT(STDMETHODCALLTYPE *IsConnected)(IConnector *This,
                                          WINBOOL *pbConnected);
  HRESULT(STDMETHODCALLTYPE *GetConnectedTo)(IConnector *This,
                                             IConnector **ppConTo);
  HRESULT(STDMETHODCALLTYPE *GetConnectorIdConnectedTo)(
      IConnector *This, LPWSTR *ppwstrConnectorId);
  HRESULT(STDMETHODCALLTYPE *GetDeviceIdConnectedTo)(IConnector *This,
                                                     LPWSTR *ppwstrDeviceId);
  END_INTERFACE
} IConnectorVtbl;
interface IConnector { CONST_VTBL IConnectorVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IConnector_QueryInterface(IConnector *This, REFIID riid,
                                                void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IConnector methods ***/
static inline HRESULT IConnector_GetType(IConnector *This,
                                         ConnectorType *pType) {
  return This->lpVtbl->GetType(This, pType);
}
static inline HRESULT IConnector_GetDataFlow(IConnector *This,
                                             DataFlow *pFlow) {
  return This->lpVtbl->GetDataFlow(This, pFlow);
}
static inline HRESULT IConnector_ConnectTo(IConnector *This,
                                           IConnector *pConnectTo) {
...
static inline HRESULT IConnector_IsConnected(IConnector *This,
                                             WINBOOL *pbConnected) {
  return This->lpVtbl->IsConnected(This, pbConnected);
}
static inline HRESULT IConnector_GetConnectedTo(IConnector *This,
                                                IConnector **ppConTo) {
  return This->lpVtbl->GetConnectedTo(This, ppConTo);
}
static inline HRESULT
IConnector_GetConnectorIdConnectedTo(IConnector *This,
                                     LPWSTR *ppwstrConnectorId) {
  return This->lpVtbl->GetConnectorIdConnectedTo(This, ppwstrConnectorId);
}
static inline HRESULT
IConnector_GetDeviceIdConnectedTo(IConnector *This, LPWSTR *ppwstrDeviceId) {
...
DEFINE_GUID(IID_ISubUnit, 0x82149a85, 0xdba6, 0x4487, 0x86, 0xbb, 0xea, 0x8f,
            0x7f, 0xef, 0xcc, 0x71);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("82149a85-dba6-4487-86bb-ea8f7fefcc71")
ISubUnit : public IUnknown{};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ISubUnit, 0x82149a85, 0xdba6, 0x4487, 0x86, 0xbb, 0xea, 0x8f,
                0x7f, 0xef, 0xcc, 0x71)
#endif
#else
typedef struct ISubUnitVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ISubUnit *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(ISubUnit *This);
  ULONG(STDMETHODCALLTYPE *Release)(ISubUnit *This);
  END_INTERFACE
} ISubUnitVtbl;
interface ISubUnit { CONST_VTBL ISubUnitVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT ISubUnit_QueryInterface(ISubUnit *This, REFIID riid,
                                              void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
DEFINE_GUID(IID_IControlInterface, 0x45d37c3f, 0x5140, 0x444a, 0xae, 0x24, 0x40,
            0x07, 0x89, 0xf3, 0xcb, 0xf3);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IControlInterface, 0x45d37c3f, 0x5140, 0x444a, 0xae, 0x24, 0x40,
                0x07, 0x89, 0xf3, 0xcb, 0xf3)
#endif
#else
typedef struct IControlInterfaceVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IControlInterface *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetName)(IControlInterface *This,
                                      LPWSTR *ppwstrName);
  HRESULT(STDMETHODCALLTYPE *GetIID)(IControlInterface *This, GUID *pIID);
  END_INTERFACE
} IControlInterfaceVtbl;
interface IControlInterface { CONST_VTBL IControlInterfaceVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IControlInterface_QueryInterface(IControlInterface *This,
                                                       REFIID riid,
                                                       void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IControlInterface methods ***/
static inline HRESULT IControlInterface_GetName(IControlInterface *This,
                                                LPWSTR *ppwstrName) {
  return This->lpVtbl->GetName(This, ppwstrName);
}
static inline HRESULT IControlInterface_GetIID(IControlInterface *This,
                                               GUID *pIID) {
...
DEFINE_GUID(IID_IControlChangeNotify, 0xa09513ed, 0xc709, 0x4d21, 0xbd, 0x7b,
            0x5f, 0x34, 0xc4, 0x7f, 0x39, 0x47);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IControlChangeNotify, 0xa09513ed, 0xc709, 0x4d21, 0xbd, 0x7b,
                0x5f, 0x34, 0xc4, 0x7f, 0x39, 0x47)
#endif
#else
typedef struct IControlChangeNotifyVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IControlChangeNotify *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *OnNotify)(IControlChangeNotify *This,
                                       DWORD dwSenderProcessId,
                                       LPCGUID ppguidEventContext);
  END_INTERFACE
} IControlChangeNotifyVtbl;
interface IControlChangeNotify { CONST_VTBL IControlChangeNotifyVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define IControlChangeNotify_OnNotify(This, dwSenderProcessId,                 \
                                      ppguidEventContext)                      \
  (This)->lpVtbl->OnNotify(This, dwSenderProcessId, ppguidEventContext)
#else
/*** IUnknown methods ***/
static inline HRESULT
IControlChangeNotify_QueryInterface(IControlChangeNotify *This, REFIID riid,
                                    void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IControlChangeNotify methods ***/
static inline HRESULT
IControlChangeNotify_OnNotify(IControlChangeNotify *This,
                              DWORD dwSenderProcessId,
                              LPCGUID ppguidEventContext) {
...
DEFINE_GUID(IID_IDeviceTopology, 0x2a07407e, 0x6497, 0x4a18, 0x97, 0x87, 0x32,
            0xf7, 0x9b, 0xd0, 0xd9, 0x8f);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("2a07407e-6497-4a18-9787-32f79bd0d98f")
IDeviceTopology : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetConnectorCount(UINT * pCount) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetConnector(UINT nIndex,
                                                 IConnector * *ppConnector) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetSubunitCount(UINT * pCount) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetSubunit(UINT nIndex,
                                               ISubUnit * *ppConnector) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetPartById(UINT nId, IPart * *ppPart) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetDeviceId(LPWSTR * ppwstrDeviceId) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetSignalPath(
      IPart * pIPartFrom, IPart * pIPartTo, WINBOOL bRejectMixedPaths,
      IPartsList * *ppParts) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDeviceTopology, 0x2a07407e, 0x6497, 0x4a18, 0x97, 0x87, 0x32,
                0xf7, 0x9b, 0xd0, 0xd9, 0x8f)
#endif
#else
typedef struct IDeviceTopologyVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDeviceTopology *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetConnectorCount)(IDeviceTopology *This,
                                                UINT *pCount);
  HRESULT(STDMETHODCALLTYPE *GetConnector)(IDeviceTopology *This, UINT nIndex,
                                           IConnector **ppConnector);
  HRESULT(STDMETHODCALLTYPE *GetSubunitCount)(IDeviceTopology *This,
                                              UINT *pCount);
  HRESULT(STDMETHODCALLTYPE *GetSubunit)(IDeviceTopology *This, UINT nIndex,
                                         ISubUnit **ppConnector);
  HRESULT(STDMETHODCALLTYPE *GetPartById)(IDeviceTopology *This, UINT nId,
                                          IPart **ppPart);
  HRESULT(STDMETHODCALLTYPE *GetDeviceId)(IDeviceTopology *This,
                                          LPWSTR *ppwstrDeviceId);
  HRESULT(STDMETHODCALLTYPE *GetSignalPath)(IDeviceTopology *This,
                                            IPart *pIPartFrom, IPart *pIPartTo,
                                            WINBOOL bRejectMixedPaths,
                                            IPartsList **ppParts);
  END_INTERFACE
} IDeviceTopologyVtbl;
interface IDeviceTopology { CONST_VTBL IDeviceTopologyVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define IDeviceTopology_GetSubunit(This, nIndex, ppConnector)                  \
  (This)->lpVtbl->GetSubunit(This, nIndex, ppConnector)
...
#define IDeviceTopology_GetSignalPath(This, pIPartFrom, pIPartTo,              \
  ...
  (This)->lpVtbl->GetSignalPath(This, pIPartFrom, pIPartTo, bRejectMixedPaths, \
                                ppParts)
#else
/*** IUnknown methods ***/
static inline HRESULT IDeviceTopology_QueryInterface(IDeviceTopology *This,
                                                     REFIID riid,
                                                     void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IDeviceTopology methods ***/
static inline HRESULT IDeviceTopology_GetConnectorCount(IDeviceTopology *This,
                                                        UINT *pCount) {
  return This->lpVtbl->GetConnectorCount(This, pCount);
}
static inline HRESULT IDeviceTopology_GetConnector(IDeviceTopology *This,
                                                   UINT nIndex,
                                                   IConnector **ppConnector) {
  return This->lpVtbl->GetConnector(This, nIndex, ppConnector);
}
static inline HRESULT IDeviceTopology_GetSubunitCount(IDeviceTopology *This,
                                                      UINT *pCount) {
  return This->lpVtbl->GetSubunitCount(This, pCount);
}
static inline HRESULT IDeviceTopology_GetSubunit(IDeviceTopology *This,
                                                 UINT nIndex,
                                                 ISubUnit **ppConnector) {
  return This->lpVtbl->GetSubunit(This, nIndex, ppConnector);
}
static inline HRESULT IDeviceTopology_GetPartById(IDeviceTopology *This,
                                                  UINT nId, IPart **ppPart) {
  return This->lpVtbl->GetPartById(This, nId, ppPart);
}
static inline HRESULT IDeviceTopology_GetDeviceId(IDeviceTopology *This,
                                                  LPWSTR *ppwstrDeviceId) {
  return This->lpVtbl->GetDeviceId(This, ppwstrDeviceId);
}
static inline HRESULT IDeviceTopology_GetSignalPath(IDeviceTopology *This,
                                                    IPart *pIPartFrom,
                                                    IPart *pIPartTo,
                                                    WINBOOL bRejectMixedPaths,
                                                    IPartsList **ppParts) {
  return This->lpVtbl->GetSignalPath(This, pIPartFrom, pIPartTo,
                                     bRejectMixedPaths, ppParts);
}
#endif
#endif
...
DEFINE_GUID(LIBID_DevTopologyLib, 0x51b9a01d, 0x8181, 0x4363, 0xb5, 0x9c, 0xe6,
            0x78, 0xf4, 0x76, 0xdd, 0x0e);
/*****************************************************************************
 * DeviceTopology coclass
 */
DEFINE_GUID(CLSID_DeviceTopology, 0x1df639d0, 0x5ec1, 0x47aa, 0x93, 0x79, 0x82,
            0x8d, 0xc1, 0xaa, 0x8c, 0x59);
#ifdef __cplusplus
class DECLSPEC_UUID("1df639d0-5ec1-47aa-9379-828dc1aa8c59") DeviceTopology;
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(DeviceTopology, 0x1df639d0, 0x5ec1, 0x47aa, 0x93, 0x79, 0x82,
                0x8d, 0xc1, 0xaa, 0x8c, 0x59)
#endif
#endif
