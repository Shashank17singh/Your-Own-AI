...
DECLARE_INTERFACE_(IFunctionDiscoveryNotification, IUnknown) {
  ...
  STDMETHOD_(HRESULT, OnUpdate)(THIS_ QueryUpdateAction enumQueryUpdateAction,
                                FDQUERYCONTEXT fdqcQueryContext,
                                IFunctionInstance * pIFunctionInstance) PURE;
  STDMETHOD_(HRESULT, OnError)(THIS_ HRESULT hr,
                               FDQUERYCONTEXT fdqcQueryContext,
                               const WCHAR *pszProvider) PURE;
  STDMETHOD_(HRESULT, OnEvent)(THIS_ DWORD dwEventID,
                               FDQUERYCONTEXT fdqcQueryContext,
                               const WCHAR *pszProvider) PURE;
  END_INTERFACE
};
...
#define IFunctionDiscoveryNotification_OnUpdate(                               \
    This, enumQueryUpdateAction, fdqcQueryContext, pIFunctionInstance)         \
  (This)->lpVtbl->OnUpdate(This, enumQueryUpdateAction, fdqcQueryContext,      \
                           pIFunctionInstance)
...
#define IFunctionDiscoveryNotification_OnEvent(This, dwEventID,                \
