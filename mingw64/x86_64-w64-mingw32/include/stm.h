...
typedef WINBOOL(WINAPI *PIS_SERVICE)(USHORT Type, PUCHAR Name,
...
typedef HANDLE(WINAPI *PCREATE_SERVICE_ENUMERATION_HANDLE)(
    DWORD ExclusionFlags, PIPX_SERVICE CriteriaService);
typedef DWORD(WINAPI *PENUMERATE_GET_NEXT_SERVICE)(HANDLE EnumerationHandle,
                                                   PIPX_SERVICE Service);
...
typedef DWORD(WINAPI *PCREATE_STATIC_SERVICE)(ULONG InterfaceIndex,
...
typedef DWORD(WINAPI *PGET_FIRST_ORDERED_SERVICE)(DWORD OrderingMethod,
                                                  DWORD ExclusionFlags,
                                                  PIPX_SERVICE Service);
typedef DWORD(WINAPI *PGET_NEXT_ORDERED_SERVICE)(DWORD OrderingMethod,
                                                 DWORD ExclusionFlags,
                                                 PIPX_SERVICE Service);
typedef DWORD(WINAPI *PDO_UPDATE_SERVICES)(ULONG InterfaceIndex);
typedef WINBOOL(WINAPI *PGET_SERVICE_ID)(USHORT Type, PUCHAR Name,
                                         PULONG ServiceID);
typedef WINBOOL(WINAPI *PGET_SERVICE_FROM_ID)(ULONG ServiceID,
                                              PIPX_SERVICE Service);
typedef DWORD(WINAPI *PGET_NEXT_SERVICE_FROM_ID)(ULONG ServiceID,
