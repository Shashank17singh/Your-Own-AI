...
#include <windows.h>
#include <windowsx.h>
DEFINE_GUID(CLSID_MQMailQueueType, 0x5eadc0d0, 0x7182, 0x11cf, 0xa8, 0xff, 0x00,
            0x20, 0xaf, 0xb8, 0xfb, 0x50);
...
STDAPI MQMailComposeBody(LPMQMailEMail pEMail, ULONG *pcbBuffer,
                         LPBYTE *ppbBuffer);
