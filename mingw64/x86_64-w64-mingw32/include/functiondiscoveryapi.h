...
DECLARE_INTERFACE_(IFunctionInstance, IUnknown) {
  ...
  STDMETHOD_(HRESULT, GetProviderInstanceID)(THIS_ WCHAR *
                                             *ppszCoMemProviderInstanceID) PURE;
  STDMETHOD_(HRESULT, OpenPropertyStore)(
      THIS_ DWORD dwStgAccess, IPropertyStore * *ppIPropertyStore) PURE;
  STDMETHOD_(HRESULT, GetCategory)(THIS_ WCHAR * *ppszCoMemCategory,
                                   WCHAR * *ppszCoMemSubCategory) PURE;
  STDMETHOD_(HRESULT, QueryService)(THIS_ REFGUID guidService, REFGUID riid,
                                    void **ppv) PURE;
...
#define IFunctionInstance_GetProviderInstanceID(This,                          \
                                                ppszCoMemProviderInstanceID)   \
  (This)->lpVtbl->GetProviderInstanceID(This, ppszCoMemProviderInstanceID)
#define IFunctionInstance_OpenPropertyStore(This, dwStgAccess,                 \
                                            ppIPropertyStore)                  \
  (This)->lpVtbl->OpenPropertyStore(This, dwStgAccess, ppIPropertyStore)
#define IFunctionInstance_GetCategory(This, ppszCoMemCategory,                 \
                                      ppszCoMemSubCategory)                    \
  (This)->lpVtbl->GetCategory(This, ppszCoMemCategory, ppszCoMemSubCategory)
#define IFunctionInstance_QueryService(This, guidService, riid, ppv)           \
...
DECLARE_INTERFACE_(IFunctionInstanceQuery, IUnknown) {
  ...
  STDMETHOD_(HRESULT, Execute)(THIS_ IFunctionInstance * *ppIFunctionInstance)
      PURE;
  END_INTERFACE
};
#ifdef COBJMACROS
...
DECLARE_INTERFACE_(IFunctionInstanceCollection, IUnknown) {
  ...
  STDMETHOD_(HRESULT, Get)(THIS_ const WCHAR *pszInstanceIdentity,
                           DWORD *pdwIndex,
                           IFunctionInstance **ppIFunctionInstance) PURE;
  STDMETHOD_(HRESULT, Item)(THIS_ DWORD dwIndex,
                            IFunctionInstance * *ppFunctionInstance) PURE;
  STDMETHOD_(HRESULT, Add)(THIS_ IFunctionInstance * pIFunctionInstance) PURE;
  STDMETHOD_(HRESULT, Remove)(THIS_ DWORD dwIndex,
                              IFunctionInstance * *ppIFunctionInstance) PURE;
...
#define IFunctionInstanceCollection_Get(This, pszInstanceIdentity, pdwIndex,   \
                                        ppIFunctionInstance)                   \
  (This)->lpVtbl->Get(This, pszInstanceIdentity, pdwIndex, ppIFunctionInstance)
#define IFunctionInstanceCollection_Item(This, dwIndex, ppFunctionInstance)    \
  (This)->lpVtbl->Item(This, dwIndex, ppFunctionInstance)
...
DECLARE_INTERFACE_(IFunctionInstanceCollectionQuery, IUnknown) {
  ...
  STDMETHOD_(HRESULT, AddQueryConstraint)(THIS_ const WCHAR *pszConstraintName,
                                          const WCHAR *pszConstraintValue) PURE;
  STDMETHOD_(HRESULT, AddPropertyConstraint)(
      THIS_ REFPROPERTYKEY Key, const PROPVARIANT *pv,
      PropertyConstraint enumPropertyConstraint) PURE;
  STDMETHOD_(HRESULT, Execute)(THIS_ IFunctionInstanceCollection *
                               *ppIFunctionInstanceCollection) PURE;
  END_INTERFACE
};
#ifdef COBJMACROS
...
#define IFunctionInstanceCollectionQuery_AddQueryConstraint(                   \
    This, pszConstraintName, pszConstraintValue)                               \
  (This)->lpVtbl->AddQueryConstraint(This, pszConstraintName,                  \
                                     pszConstraintValue)
#define IFunctionInstanceCollectionQuery_AddPropertyConstraint(                \
    This, Key, pv, enumPropertyConstraint)                                     \
  (This)->lpVtbl->AddPropertyConstraint(This, Key, pv, enumPropertyConstraint)
#define IFunctionInstanceCollectionQuery_Execute(                              \
    This, ppIFunctionInstanceCollection)                                       \
...
DECLARE_INTERFACE_(IFunctionDiscovery, IUnknown) {
  ...
  STDMETHOD_(HRESULT, GetInstanceCollection)(
      THIS_ const WCHAR *pszCategory, const WCHAR *pszSubCategory,
      WINBOOL fIncludeAllSubCategories,
      IFunctionInstanceCollection **ppIFunctionInstanceCollection) PURE;
  STDMETHOD_(HRESULT,
             GetInstance)(THIS_ const WCHAR *pszFunctionInstanceIdentity,
                          IFunctionInstance **ppIFunctionInstance) PURE;
  STDMETHOD_(HRESULT, CreateInstanceCollectionQuery)(
      THIS_ const WCHAR *pszCategory, const WCHAR *pszSubCategory,
      WINBOOL fIncludeAllSubCategories,
      ...
      PURE;
  STDMETHOD_(HRESULT, CreateInstanceQuery)(
      THIS_ const WCHAR *pszFunctionInstanceIdentity,
      IFunctionDiscoveryNotification *pIFunctionDiscoveryNotification,
      FDQUERYCONTEXT *pfdqcQueryContext,
      IFunctionInstanceQuery **ppIFunctionInstanceQuery) PURE;
  STDMETHOD_(HRESULT,
             AddInstance)(THIS_ SystemVisibilityFlags enumSystemVisibility,
                          const WCHAR *pszCategory, const WCHAR *pszSubCategory,
                          const WCHAR *pszCategoryIdentity,
                          IFunctionInstance **ppIFunctionInstance) PURE;
  STDMETHOD_(HRESULT, RemoveInstance)(
      THIS_ SystemVisibilityFlags enumSystemVisibility,
      const WCHAR *pszCategory, const WCHAR *pszSubCategory,
      const WCHAR *pszCategoryIdentity) PURE;
  END_INTERFACE
};
#ifdef COBJMACROS
...
#define IFunctionDiscovery_GetInstanceCollection(                              \
    This, pszCategory, pszSubCategory, fIncludeAllSubCategories,               \
    ppIFunctionInstanceCollection)                                             \
  (This)->lpVtbl->GetInstanceCollection(This, pszCategory, pszSubCategory,     \
                                        fIncludeAllSubCategories,              \
                                        ppIFunctionInstanceCollection)
#define IFunctionDiscovery_GetInstance(This, pszFunctionInstanceIdentity,      \
                                       ppIFunctionInstance)                    \
  (This)->lpVtbl->GetInstance(This, pszFunctionInstanceIdentity,               \
                              ppIFunctionInstance)
#define IFunctionDiscovery_CreateInstanceCollectionQuery(                      \
    This, pszCategory, pszSubCategory, fIncludeAllSubCategories,               \
    pIFunctionDiscoveryNotification, pfdqcQueryContext,                        \
    ppIFunctionInstanceCollectionQuery)                                        \
  (This)->lpVtbl->CreateInstanceCollectionQuery(                               \
      This, pszCategory, pszSubCategory, fIncludeAllSubCategories,             \
      pIFunctionDiscoveryNotification, pfdqcQueryContext,                      \
      ppIFunctionInstanceCollectionQuery)
#define IFunctionDiscovery_CreateInstanceQuery(                                \
    This, pszFunctionInstanceIdentity, pIFunctionDiscoveryNotification,        \
    pfdqcQueryContext, ppIFunctionInstanceQuery)                               \
  (This)->lpVtbl->CreateInstanceQuery(                                         \
      This, pszFunctionInstanceIdentity, pIFunctionDiscoveryNotification,      \
      pfdqcQueryContext, ppIFunctionInstanceQuery)
#define IFunctionDiscovery_AddInstance(                                        \
    This, enumSystemVisibility, pszCategory, pszSubCategory,                   \
    pszCategoryIdentity, ppIFunctionInstance)                                  \
  (This)->lpVtbl->AddInstance(This, enumSystemVisibility, pszCategory,         \
                              pszSubCategory, pszCategoryIdentity,             \
                              ppIFunctionInstance)
#define IFunctionDiscovery_RemoveInstance(This, enumSystemVisibility,          \
                                          pszCategory, pszSubCategory,         \
                                          pszCategoryIdentity)                 \
  (This)->lpVtbl->RemoveInstance(This, enumSystemVisibility, pszCategory,      \
                                 pszSubCategory, pszCategoryIdentity)
#endif /*COBJMACROS*/
