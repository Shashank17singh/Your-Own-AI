...
DEFINE_GUID(DSPROPSETID_DirectSoundDevice, 0x84624f82, 0x25ec, 0x11d1, 0xa4,
            0xd8, 0x00, 0xc0, 0x4f, 0xc2, 0x8a, 0xca);
typedef enum {
...
#define PDSPROPERTY_DIRECTSOUNDDEVICE_DESCRIPTION_DATA                         \
  PDSPROPERTY_DIRECTSOUNDDEVICE_DESCRIPTION_A_DATA
#endif
typedef WINBOOL(CALLBACK *LPFNDIRECTSOUNDDEVICEENUMERATECALLBACK1)(
    PDSPROPERTY_DIRECTSOUNDDEVICE_DESCRIPTION_1_DATA, LPVOID);
typedef WINBOOL(CALLBACK *LPFNDIRECTSOUNDDEVICEENUMERATECALLBACKA)(
    PDSPROPERTY_DIRECTSOUNDDEVICE_DESCRIPTION_A_DATA, LPVOID);
typedef WINBOOL(CALLBACK *LPFNDIRECTSOUNDDEVICEENUMERATECALLBACKW)(
