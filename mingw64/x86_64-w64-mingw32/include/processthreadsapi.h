...
WINBASEAPI HANDLE WINAPI OpenProcess(DWORD dwDesiredAccess,
                                     WINBOOL bInheritHandle, DWORD dwProcessId);
...
WINBASEAPI HANDLE WINAPI OpenThread(DWORD dwDesiredAccess,
                                    WINBOOL bInheritHandle, DWORD dwThreadId);
...
WINBASEAPI WINBOOL WINAPI GetProcessDefaultCpuSets(HANDLE Process,
                                                   PULONG CpuSetIds,
                                                   ULONG CpuSetIdCount,
                                                   PULONG RequiredIdCount);
WINBASEAPI WINBOOL WINAPI SetProcessDefaultCpuSets(HANDLE Process,
                                                   const ULONG *CpuSetIds,
                                                   ULONG CpuSetIdCount);
WINBASEAPI WINBOOL WINAPI GetThreadSelectedCpuSets(HANDLE Thread,
                                                   PULONG CpuSetIds,
                                                   ULONG CpuSetIdCount,
                                                   PULONG RequiredIdCount);
WINBASEAPI WINBOOL WINAPI SetThreadSelectedCpuSets(HANDLE Thread,
                                                   const ULONG *CpuSetIds,
                                                   ULONG CpuSetIdCount);
HRESULT WINAPI GetMachineTypeAttributes(
    USHORT Machine, MACHINE_ATTRIBUTES *MachineTypeAttributes);
#endif
#if _WIN32_WINNT >= _WIN32_WINNT_WIN10_FE
WINBASEAPI WINBOOL WINAPI
GetProcessDefaultCpuSetMasks(HANDLE Process, PGROUP_AFFINITY CpuSetMasks,
                             USHORT CpuSetMaskCount, PUSHORT RequiredMaskCount);
WINBASEAPI WINBOOL WINAPI SetProcessDefaultCpuSetMasks(
    HANDLE Process, PGROUP_AFFINITY CpuSetMasks, USHORT CpuSetMaskCount);
WINBASEAPI WINBOOL WINAPI
GetThreadSelectedCpuSetMasks(HANDLE Thread, PGROUP_AFFINITY CpuSetMasks,
                             USHORT CpuSetMaskCount, PUSHORT RequiredMaskCount);
WINBASEAPI WINBOOL WINAPI SetThreadSelectedCpuSetMasks(
    HANDLE Thread, PGROUP_AFFINITY CpuSetMasks, USHORT CpuSetMaskCount);
#endif
...
WINADVAPI WINBOOL WINAPI CreateProcessAsUserW(
...
WINBASEAPI WINBOOL WINAPI SetProcessAffinityUpdateMode(HANDLE hProcess,
                                                       DWORD dwFlags);
...
WINBASEAPI WINBOOL WINAPI
SetProcessMitigationPolicy(PROCESS_MITIGATION_POLICY MitigationPolicy,
...
#endif
#if _WIN32_WINNT >= _WIN32_WINNT_WIN10
WINBASEAPI WINBOOL WINAPI SetProtectedPolicy(LPCGUID PolicyGuid,
...
#if WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_APP)
#ifndef _APISET_EXPORTS_FILTER
WINBASEAPI WINBOOL WINAPI CreateProcessA(
...
WINBASEAPI WINBOOL WINAPI SetProcessDynamicEHContinuationTargets(
    HANDLE Process, USHORT NumberOfTargets,
...
WINBASEAPI WINBOOL WINAPI SetProcessDynamicEnforcedCetCompatibleRanges(
    HANDLE Process, USHORT NumberOfRanges,
...
#endif /* WINAPI_PARTITION_APP */
WINBASEAPI HRESULT WINAPI SetThreadDescription(HANDLE hThread,
                                               PCWSTR lpThreadDescription);
WINBASEAPI HRESULT WINAPI GetThreadDescription(HANDLE hThread,
