...
DWORD WINAPI GetClusterQuorumResource(HCLUSTER hCluster,
                                      LPWSTR lpszResourceName,
                                      LPDWORD lpcchResourceName,
                                      LPWSTR lpszDeviceName,
                                      LPDWORD lpcchDeviceName,
                                      LPDWORD lpdwMaxQuorumLogSize);
DWORD WINAPI SetClusterQuorumResource(HRESOURCE hResource,
                                      LPCWSTR lpszDeviceName,
                                      DWORD dwMaxQuoLogSize);
DWORD WINAPI BackupClusterDatabase(HCLUSTER hCluster, LPCWSTR lpszPathName);
DWORD WINAPI RestoreClusterDatabase(LPCWSTR lpszPathName, WINBOOL bForce,
                                    LPCWSTR lpszQuorumDriveLetter);
DWORD WINAPI SetClusterNetworkPriorityOrder(HCLUSTER hCluster,
                                            DWORD NetworkCount,
                                            HNETWORK NetworkList[]);
DWORD WINAPI SetClusterServiceAccountPassword(
    LPCWSTR lpszClusterName, LPCWSTR lpszNewPassword, DWORD dwFlags,
    PCLUSTER_SET_PASSWORD_STATUS lpReturnStatusBuffer,
    LPDWORD lpcbReturnStatusBufferSize);
DWORD WINAPI ClusterControl(HCLUSTER hCluster, HNODE hHostNode,
                            DWORD dwControlCode, LPVOID lpInBuffer,
...
typedef enum CLUSTER_CHANGE {
  ...
  CLUSTER_CHANGE_ALL =
      (CLUSTER_CHANGE_NODE_STATE | CLUSTER_CHANGE_NODE_DELETED |
...
#endif
HCHANGE WINAPI CreateClusterNotifyPort(HCHANGE hChange, HCLUSTER hCluster,
                                       DWORD dwFilter, DWORD_PTR dwNotifyKey);
DWORD WINAPI RegisterClusterNotify(HCHANGE hChange, DWORD dwFilterType,
                                   HANDLE hObject, DWORD_PTR dwNotifyKey);
DWORD WINAPI GetClusterNotify(HCHANGE hChange, DWORD_PTR *lpdwNotifyKey,
                              LPDWORD lpdwFilterType, LPWSTR lpszName,
                              LPDWORD lpcchName, DWORD dwMilliseconds);
...
typedef enum CLUSTER_ENUM {
  ...
  CLUSTER_ENUM_ALL =
      (CLUSTER_ENUM_NODE | CLUSTER_ENUM_RESTYPE | CLUSTER_ENUM_RESOURCE |
       CLUSTER_ENUM_GROUP | CLUSTER_ENUM_NETWORK | CLUSTER_ENUM_NETINTERFACE)
} CLUSTER_ENUM;
#endif
HCLUSENUM WINAPI ClusterOpenEnum(HCLUSTER hCluster, DWORD dwType);
DWORD WINAPI ClusterGetEnumCount(HCLUSENUM hEnum);
DWORD WINAPI ClusterEnum(HCLUSENUM hEnum, DWORD dwIndex, LPDWORD lpdwType,
                         LPWSTR lpszName, LPDWORD lpcchName);
...
DWORD WINAPI GetClusterNodeId(HNODE hNode, LPWSTR lpszNodeId,
                              LPDWORD lpcchName);
...
DWORD WINAPI ClusterNodeEnum(HNODEENUM hNodeEnum, DWORD dwIndex,
                             LPDWORD lpdwType, LPWSTR lpszName,
                             LPDWORD lpcchName);
DWORD WINAPI EvictClusterNodeEx(HNODE hNode, DWORD dwTimeOut,
                                HRESULT *phrCleanupStatus);
HKEY WINAPI GetClusterResourceTypeKey(HCLUSTER hCluster, LPCWSTR lpszTypeName,
                                      REGSAM samDesired);
#ifndef _CLUSTER_API_TYPES_
...
CLUSTER_GROUP_STATE WINAPI GetClusterGroupState(HGROUP hGroup,
                                                LPWSTR lpszNodeName,
                                                LPDWORD lpcchNodeName);
DWORD WINAPI SetClusterGroupName(HGROUP hGroup, LPCWSTR lpszGroupName);
DWORD WINAPI SetClusterGroupNodeList(HGROUP hGroup, DWORD NodeCount,
                                     HNODE NodeList[]);
...
DWORD WINAPI ClusterGroupEnum(HGROUPENUM hGroupEnum, DWORD dwIndex,
                              LPDWORD lpdwType, LPWSTR lpszResourceName,
                              LPDWORD lpcchName);
...
#endif
HRESOURCE WINAPI CreateClusterResource(HGROUP hGroup, LPCWSTR lpszResourceName,
                                       LPCWSTR lpszResourceType, DWORD dwFlags);
HRESOURCE WINAPI OpenClusterResource(HCLUSTER hCluster,
...
CLUSTER_RESOURCE_STATE WINAPI GetClusterResourceState(HRESOURCE hResource,
                                                      LPWSTR lpszNodeName,
                                                      LPDWORD lpcchNodeName,
                                                      LPWSTR lpszGroupName,
                                                      LPDWORD lpcchGroupName);
DWORD WINAPI SetClusterResourceName(HRESOURCE hResource,
                                    LPCWSTR lpszResourceName);
...
DWORD WINAPI RemoveClusterResourceDependency(HRESOURCE hResource,
                                             HRESOURCE hDependsOn);
WINBOOL WINAPI CanResourceBeDependent(HRESOURCE hResource,
                                      HRESOURCE hResourceDependent);
DWORD WINAPI ClusterResourceControl(HRESOURCE hResource, HNODE hHostNode,
                                    DWORD dwControlCode, LPVOID lpInBuffer,
                                    DWORD cbInBufferSize, LPVOID lpOutBuffer,
                                    DWORD cbOutBufferSize,
                                    LPDWORD lpBytesReturned);
DWORD WINAPI ClusterResourceTypeControl(
    HCLUSTER hCluster, LPCWSTR lpszResourceTypeName, HNODE hHostNode,
    DWORD dwControlCode, LPVOID lpInBuffer, DWORD nInBufferSize,
    LPVOID lpOutBuffer, DWORD nOutBufferSize, LPDWORD lpBytesReturned);
DWORD WINAPI ClusterGroupControl(HGROUP hGroup, HNODE hHostNode,
                                 DWORD dwControlCode, LPVOID lpInBuffer,
                                 DWORD nInBufferSize, LPVOID lpOutBuffer,
                                 DWORD nOutBufferSize, LPDWORD lpBytesReturned);
DWORD WINAPI ClusterNodeControl(HNODE hNode, HNODE hHostNode,
                                DWORD dwControlCode, LPVOID lpInBuffer,
                                DWORD nInBufferSize, LPVOID lpOutBuffer,
                                DWORD nOutBufferSize, LPDWORD lpBytesReturned);
WINBOOL WINAPI GetClusterResourceNetworkName(HRESOURCE hResource,
...
typedef enum CLUSTER_PROPERTY_SYNTAX {
  CLUSPROP_SYNTAX_ENDMARK =
      CLUSPROP_SYNTAX_VALUE(CLUSPROP_TYPE_ENDMARK, CLUSPROP_FORMAT_UNKNOWN),
  CLUSPROP_SYNTAX_NAME =
      CLUSPROP_SYNTAX_VALUE(CLUSPROP_TYPE_NAME, CLUSPROP_FORMAT_SZ),
  CLUSPROP_SYNTAX_RESCLASS =
      CLUSPROP_SYNTAX_VALUE(CLUSPROP_TYPE_RESCLASS, CLUSPROP_FORMAT_DWORD),
  ...
  CLUSPROP_SYNTAX_LIST_VALUE_EXPAND_SZ = CLUSPROP_SYNTAX_VALUE(
      CLUSPROP_TYPE_LIST_VALUE, CLUSPROP_FORMAT_EXPAND_SZ),
  ...
  CLUSPROP_SYNTAX_LIST_VALUE_MULTI_SZ =
      CLUSPROP_SYNTAX_VALUE(CLUSPROP_TYPE_LIST_VALUE, CLUSPROP_FORMAT_MULTI_SZ),
  ...
  CLUSPROP_SYNTAX_LIST_VALUE_SECURITY_DESCRIPTOR = CLUSPROP_SYNTAX_VALUE(
      CLUSPROP_TYPE_LIST_VALUE, CLUSPROP_FORMAT_SECURITY_DESCRIPTOR),
  CLUSPROP_SYNTAX_LIST_VALUE_LARGE_INTEGER = CLUSPROP_SYNTAX_VALUE(
      CLUSPROP_TYPE_LIST_VALUE, CLUSPROP_FORMAT_LARGE_INTEGER),
  CLUSPROP_SYNTAX_LIST_VALUE_ULARGE_INTEGER = CLUSPROP_SYNTAX_VALUE(
      CLUSPROP_TYPE_LIST_VALUE, CLUSPROP_FORMAT_ULARGE_INTEGER),
  CLUSPROP_SYNTAX_DISK_SIGNATURE =
      CLUSPROP_SYNTAX_VALUE(CLUSPROP_TYPE_SIGNATURE, CLUSPROP_FORMAT_DWORD),
  CLUSPROP_SYNTAX_SCSI_ADDRESS =
      CLUSPROP_SYNTAX_VALUE(CLUSPROP_TYPE_SCSI_ADDRESS, CLUSPROP_FORMAT_DWORD),
  CLUSPROP_SYNTAX_DISK_NUMBER =
      CLUSPROP_SYNTAX_VALUE(CLUSPROP_TYPE_DISK_NUMBER, CLUSPROP_FORMAT_DWORD),
  CLUSPROP_SYNTAX_PARTITION_INFO = CLUSPROP_SYNTAX_VALUE(
      CLUSPROP_TYPE_PARTITION_INFO, CLUSPROP_FORMAT_BINARY),
  CLUSPROP_SYNTAX_FTSET_INFO =
      CLUSPROP_SYNTAX_VALUE(CLUSPROP_TYPE_FTSET_INFO, CLUSPROP_FORMAT_BINARY),
  CLUSPROP_SYNTAX_DISK_SERIALNUMBER = CLUSPROP_SYNTAX_VALUE(
      CLUSPROP_TYPE_DISK_SERIALNUMBER, CLUSPROP_FORMAT_SZ),
  CLUSPROP_SYNTAX_DISK_GUID = CLUSPROP_SYNTAX_VALUE(
      CLUSPROP_TYPE_DISK_GUID, CLUSPROP_FORMAT_SZ), /*0x000b0003*/
  CLUSPROP_SYNTAX_DISK_SIZE = CLUSPROP_SYNTAX_VALUE(
      CLUSPROP_TYPE_DISK_SIZE, CLUSPROP_FORMAT_ULARGE_INTEGER), /*0x000c0006*/
  CLUSPROP_SYNTAX_PARTITION_INFO_EX = CLUSPROP_SYNTAX_VALUE(
      CLUSPROP_TYPE_PARTITION_INFO_EX, CLUSPROP_FORMAT_BINARY), /*0x000d0001*/
  CLUSPROP_SYNTAX_LIST_VALUE_FILETIME = CLUSPROP_SYNTAX_VALUE(
      CLUSPROP_TYPE_LIST_VALUE, CLUSPROP_FORMAT_FILETIME) /*0x0001000c*/
...
typedef enum CLCTL_CODES {
  ...
  CLCTL_GET_CHARACTERISTICS =
      CLCTL_EXTERNAL_CODE(1, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_GET_FLAGS = CLCTL_EXTERNAL_CODE(2, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_GET_CLASS_INFO =
      CLCTL_EXTERNAL_CODE(3, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_GET_REQUIRED_DEPENDENCIES =
      CLCTL_EXTERNAL_CODE(4, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_GET_ARB_TIMEOUT =
      CLCTL_EXTERNAL_CODE(5, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_GET_NAME = CLCTL_EXTERNAL_CODE(10, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_GET_RESOURCE_TYPE =
      CLCTL_EXTERNAL_CODE(11, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  ...
  CLCTL_GET_CLUSTER_SERVICE_ACCOUNT_NAME =
      CLCTL_EXTERNAL_CODE(16, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_CHECK_VOTER_EVICT =
      CLCTL_EXTERNAL_CODE(17, CLUS_ACCESS_READ, CLUS_NO_MODIFY), /*0x00000045*/
  CLCTL_CHECK_VOTER_DOWN =
      CLCTL_EXTERNAL_CODE(18, CLUS_ACCESS_READ, CLUS_NO_MODIFY), /*0x00000049*/
  CLCTL_SHUTDOWN =
      CLCTL_EXTERNAL_CODE(19, CLUS_ACCESS_READ, CLUS_NO_MODIFY), /*0x0000004d*/
  CLCTL_ENUM_COMMON_PROPERTIES =
      CLCTL_EXTERNAL_CODE(20, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_GET_RO_COMMON_PROPERTIES =
      CLCTL_EXTERNAL_CODE(21, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_GET_COMMON_PROPERTIES =
      CLCTL_EXTERNAL_CODE(22, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_SET_COMMON_PROPERTIES =
      CLCTL_EXTERNAL_CODE(23, CLUS_ACCESS_WRITE, CLUS_MODIFY),
  CLCTL_VALIDATE_COMMON_PROPERTIES =
      CLCTL_EXTERNAL_CODE(24, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_GET_COMMON_PROPERTY_FMTS =
      CLCTL_EXTERNAL_CODE(25, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_GET_COMMON_RESOURCE_PROPERTY_FMTS =
      CLCTL_EXTERNAL_CODE(26, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_ENUM_PRIVATE_PROPERTIES =
      CLCTL_EXTERNAL_CODE(30, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_GET_RO_PRIVATE_PROPERTIES =
      CLCTL_EXTERNAL_CODE(31, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_GET_PRIVATE_PROPERTIES =
      CLCTL_EXTERNAL_CODE(32, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_SET_PRIVATE_PROPERTIES =
      CLCTL_EXTERNAL_CODE(33, CLUS_ACCESS_WRITE, CLUS_MODIFY),
  CLCTL_VALIDATE_PRIVATE_PROPERTIES =
      CLCTL_EXTERNAL_CODE(34, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_GET_PRIVATE_PROPERTY_FMTS =
      CLCTL_EXTERNAL_CODE(35, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_GET_PRIVATE_RESOURCE_PROPERTY_FMTS =
      CLCTL_EXTERNAL_CODE(36, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_ADD_REGISTRY_CHECKPOINT =
      CLCTL_EXTERNAL_CODE(40, CLUS_ACCESS_WRITE, CLUS_MODIFY),
  CLCTL_DELETE_REGISTRY_CHECKPOINT =
      CLCTL_EXTERNAL_CODE(41, CLUS_ACCESS_WRITE, CLUS_MODIFY),
  CLCTL_GET_REGISTRY_CHECKPOINTS =
      CLCTL_EXTERNAL_CODE(42, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_ADD_CRYPTO_CHECKPOINT =
      CLCTL_EXTERNAL_CODE(43, CLUS_ACCESS_WRITE, CLUS_MODIFY),
  CLCTL_DELETE_CRYPTO_CHECKPOINT =
      CLCTL_EXTERNAL_CODE(44, CLUS_ACCESS_WRITE, CLUS_MODIFY),
  CLCTL_GET_CRYPTO_CHECKPOINTS =
      CLCTL_EXTERNAL_CODE(45, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_RESOURCE_UPGRADE_DLL =
      CLCTL_EXTERNAL_CODE(46, CLUS_ACCESS_WRITE, CLUS_MODIFY),
  CLCTL_ADD_REGISTRY_CHECKPOINT_64BIT =
      CLCTL_EXTERNAL_CODE(47, CLUS_ACCESS_WRITE, CLUS_MODIFY),
  CLCTL_ADD_REGISTRY_CHECKPOINT_32BIT =
      CLCTL_EXTERNAL_CODE(48, CLUS_ACCESS_WRITE, CLUS_MODIFY),
  CLCTL_GET_LOADBAL_PROCESS_LIST =
      CLCTL_EXTERNAL_CODE(50, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_GET_NETWORK_NAME =
      CLCTL_EXTERNAL_CODE(90, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_NETNAME_GET_VIRTUAL_SERVER_TOKEN =
      CLCTL_EXTERNAL_CODE(91, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_NETNAME_REGISTER_DNS_RECORDS =
      CLCTL_EXTERNAL_CODE(92, CLUS_ACCESS_WRITE, CLUS_NO_MODIFY),
  CLCTL_NETNAME_CREDS_UPDATED =
      (CLCTL_EXTERNAL_CODE(98, CLUS_ACCESS_WRITE, CLUS_MODIFY) |
       CLCTL_GLOBAL_MASK),
  CLCTL_STORAGE_GET_DISK_INFO =
      CLCTL_EXTERNAL_CODE(100, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_STORAGE_GET_AVAILABLE_DISKS =
      CLCTL_EXTERNAL_CODE(101, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_STORAGE_IS_PATH_VALID =
      CLCTL_EXTERNAL_CODE(102, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_STORAGE_GET_ALL_AVAILABLE_DISKS =
      (CLCTL_EXTERNAL_CODE(103, CLUS_ACCESS_READ, CLUS_NO_MODIFY) |
       CLCTL_GLOBAL_MASK),
  CLCTL_QUERY_DELETE =
      CLCTL_EXTERNAL_CODE(110, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_QUERY_MAINTENANCE_MODE =
      CLCTL_EXTERNAL_CODE(120, CLUS_ACCESS_READ, CLUS_NO_MODIFY),
  CLCTL_SET_MAINTENANCE_MODE =
      CLCTL_EXTERNAL_CODE(121, CLUS_ACCESS_WRITE, CLUS_MODIFY),
  CLCTL_STORAGE_SET_DRIVELETTER =
      CLCTL_EXTERNAL_CODE(122, CLUS_ACCESS_WRITE, CLUS_MODIFY), /*0x004001ea*/
  CLCTL_STORAGE_GET_DRIVELETTERS =
      CLCTL_EXTERNAL_CODE(123, CLUS_ACCESS_READ, CLUS_NO_MODIFY), /*0x000001ed*/
  CLCTL_STORAGE_GET_DISK_INFO_EX =
      CLCTL_EXTERNAL_CODE(124, CLUS_ACCESS_READ, CLUS_NO_MODIFY), /*0x000001f1*/
  CLCTL_STORAGE_GET_AVAILABLE_DISKS_EX =
      CLCTL_EXTERNAL_CODE(125, CLUS_ACCESS_READ, CLUS_NO_MODIFY), /*0x000001f5*/
  CLCTL_STORAGE_REMAP_DRIVELETTER = CLCTL_EXTERNAL_CODE(
      128, CLUS_ACCESS_READ, CLUS_NO_MODIFY), /*0x00000201,*/
  CLCTL_STORAGE_GET_DISKID =
      CLCTL_EXTERNAL_CODE(129, CLUS_ACCESS_READ, CLUS_NO_MODIFY), /*0x00000205*/
  CLCTL_STORAGE_IS_CLUSTERABLE =
      CLCTL_EXTERNAL_CODE(130, CLUS_ACCESS_READ, CLUS_NO_MODIFY), /*0x00000209*/
  CLCTL_STORAGE_REMOVE_VM_OWNERSHIP =
      CLCTL_EXTERNAL_CODE(131, CLUS_ACCESS_WRITE, CLUS_MODIFY), /*0x0040020e*/
  CLCTL_STORAGE_GET_MOUNTPOINTS =
      CLCTL_EXTERNAL_CODE(132, CLUS_ACCESS_READ, CLUS_NO_MODIFY), /*0x00000211*/
  CLCTL_STORAGE_CLUSTER_DISK =
      (CLCTL_EXTERNAL_CODE(132, CLUS_ACCESS_WRITE, CLUS_MODIFY) |
       CLCTL_GLOBAL_MASK), /*0x00c00212*/
  CLCTL_STORAGE_GET_DIRTY =
      CLCTL_EXTERNAL_CODE(134, CLUS_ACCESS_READ, CLUS_NO_MODIFY), /*0x00000219*/
  CLCTL_STORAGE_GET_SHARED_VOLUME_INFO = CLCTL_EXTERNAL_CODE(
      137, CLUS_ACCESS_READ, CLUS_NO_MODIFY), /* 0x00000225 */
  CLCTL_STORAGE_IS_CSV_FILE =
      CLCTL_EXTERNAL_CODE(138, CLUS_ACCESS_READ, CLUS_NO_MODIFY), /*0x00000229*/
  CLCTL_VALIDATE_PATH = CLCTL_EXTERNAL_CODE(140, CLUS_ACCESS_READ,
                                            CLUS_NO_MODIFY), /*0x00000231,*/
  CLCTL_VALIDATE_NETNAME =
      CLCTL_EXTERNAL_CODE(141, CLUS_ACCESS_READ, CLUS_NO_MODIFY), /*0x00000235*/
  CLCTL_VALIDATE_DIRECTORY =
      CLCTL_EXTERNAL_CODE(142, CLUS_ACCESS_READ, CLUS_NO_MODIFY), /*0x00000239*/
  CLCTL_BATCH_BLOCK_KEY = CLCTL_EXTERNAL_CODE(143, CLUS_ACCESS_WRITE,
                                              CLUS_NO_MODIFY), /*0x0000023e*/
  CLCTL_BATCH_UNBLOCK_KEY =
      CLCTL_EXTERNAL_CODE(144, CLUS_ACCESS_READ, CLUS_NO_MODIFY), /*0x00000241*/
  CLCTL_FILESERVER_SHARE_ADD =
      CLCTL_EXTERNAL_CODE(145, CLUS_ACCESS_READ, CLUS_NO_MODIFY), /*0x00400245*/
  CLCTL_FILESERVER_SHARE_DEL =
      CLCTL_EXTERNAL_CODE(146, CLUS_ACCESS_READ, CLUS_NO_MODIFY), /*0x00400249*/
  CLCTL_FILESERVER_SHARE_MODIFY =
      CLCTL_EXTERNAL_CODE(147, CLUS_ACCESS_READ, CLUS_NO_MODIFY), /*0x0040024d*/
  CLCTL_FILESERVER_SHARE_REPORT =
      CLCTL_EXTERNAL_CODE(148, CLUS_ACCESS_READ, CLUS_NO_MODIFY), /*0x00000251*/
  CLCTL_ENABLE_SHARED_VOLUME_DIRECTIO =
      CLCTL_EXTERNAL_CODE(162, CLUS_ACCESS_WRITE, CLUS_MODIFY), /*0x0040028a*/
  CLCTL_DISABLE_SHARED_VOLUME_DIRECTIO =
      CLCTL_EXTERNAL_CODE(163, CLUS_ACCESS_WRITE, CLUS_MODIFY), /*0x0040028e*/
  CLCTL_GET_SHARED_VOLUME_ID =
      CLCTL_EXTERNAL_CODE(164, CLUS_ACCESS_READ, CLUS_NO_MODIFY), /*0x00000291*/
  CLCTL_SET_CSV_MAINTENANCE_MODE =
      CLCTL_EXTERNAL_CODE(165, CLUS_ACCESS_WRITE, CLUS_MODIFY), /*0x00400296*/
  CLCTL_SET_SHARED_VOLUME_BACKUP_MODE =
      CLCTL_EXTERNAL_CODE(166, CLUS_ACCESS_WRITE, CLUS_MODIFY), /*0x0040029a,*/
  ...
  CLCTL_REMOVE_DEPENDENCY =
      CLCTL_INTERNAL_CODE(5, CLUS_ACCESS_WRITE, CLUS_MODIFY),
  ...
  CLCTL_CLUSTER_NAME_CHANGED =
      CLCTL_INTERNAL_CODE(10, CLUS_ACCESS_WRITE, CLUS_MODIFY),
  CLCTL_CLUSTER_VERSION_CHANGED =
      CLCTL_INTERNAL_CODE(11, CLUS_ACCESS_WRITE, CLUS_MODIFY),
  CLCTL_FIXUP_ON_UPGRADE =
      CLCTL_INTERNAL_CODE(12, CLUS_ACCESS_WRITE, CLUS_MODIFY),
  CLCTL_STARTING_PHASE1 =
      CLCTL_INTERNAL_CODE(13, CLUS_ACCESS_WRITE, CLUS_MODIFY),
  CLCTL_STARTING_PHASE2 =
      CLCTL_INTERNAL_CODE(14, CLUS_ACCESS_WRITE, CLUS_MODIFY),
  ...
  CLCTL_STATE_CHANGE_REASON =
      CLCTL_INTERNAL_CODE(19, CLUS_ACCESS_WRITE, CLUS_MODIFY),
  CLCTL_PROVIDER_STATE_CHANGE =
      CLCTL_INTERNAL_CODE(20, CLUS_ACCESS_WRITE, CLUS_MODIFY), /*0x00500052*/
  CLCTL_LEAVING_GROUP =
      CLCTL_INTERNAL_CODE(21, CLUS_ACCESS_WRITE, CLUS_MODIFY), /*0x00500056,*/
  CLCTL_JOINING_GROUP =
      CLCTL_INTERNAL_CODE(22, CLUS_ACCESS_WRITE, CLUS_MODIFY), /*0x0050005a*/
  CLCTL_FSWITNESS_GET_EPOCH_INFO =
      CLCTL_INTERNAL_CODE(23, CLUS_ACCESS_READ, CLUS_NO_MODIFY), /*0x0010005d*/
  CLCTL_FSWITNESS_SET_EPOCH_INFO =
      CLCTL_INTERNAL_CODE(24, CLUS_ACCESS_WRITE, CLUS_MODIFY), /*0x00500062*/
  CLCTL_FSWITNESS_RELEASE_LOCK =
      CLCTL_INTERNAL_CODE(25, CLUS_ACCESS_WRITE, CLUS_MODIFY), /*0x00500066,*/
  CLCTL_NETNAME_CREDS_NOTIFYCAM =
      CLCTL_INTERNAL_CODE(26, CLUS_ACCESS_WRITE, CLUS_MODIFY), /*0x0050006a*/
  CLCTL_STORAGE_GET_DISK_NUMBER =
      CLCTL_INTERNAL_CODE(27, CLUS_ACCESS_READ, CLUS_NO_MODIFY) /*0x0010006d */
} CLCTL_CODES;
#endif
...
#define CLUSCTL_USER_CODE(Function, Object)                                    \
  (((Object) << CLUSCTL_OBJECT_SHIFT) |                                        \
   ((CLCTL_USER_BASE + Function) << CLUSCTL_FUNCTION_SHIFT))
...
typedef enum CLUSCTL_RESOURCE_CODES {
  ...
  CLUSCTL_RESOURCE_STORAGE_SET_DRIVELETTER =
      CLUSCTL_RESOURCE_CODE(CLCTL_STORAGE_SET_DRIVELETTER), /*0x014001ea*/
  CLUSCTL_RESOURCE_STORAGE_GET_DISK_INFO_EX =
      CLUSCTL_RESOURCE_CODE(CLCTL_STORAGE_GET_DISK_INFO_EX), /*0x010001f1*/
  CLUSCTL_RESOURCE_FILESERVER_SHARE_ADD =
      CLUSCTL_RESOURCE_CODE(CLCTL_FILESERVER_SHARE_ADD), /*0x01400245*/
  CLUSCTL_RESOURCE_FILESERVER_SHARE_DEL =
      CLUSCTL_RESOURCE_CODE(CLCTL_FILESERVER_SHARE_DEL), /*0x01400249*/
  CLUSCTL_RESOURCE_FILESERVER_SHARE_MODIFY =
      CLUSCTL_RESOURCE_CODE(CLCTL_FILESERVER_SHARE_MODIFY), /*0x0140024d*/
  CLUSCTL_RESOURCE_FILESERVER_SHARE_REPORT =
      CLUSCTL_RESOURCE_CODE(CLCTL_FILESERVER_SHARE_REPORT), /*0x01000251*/
  CLUSCTL_RESOURCE_STORAGE_GET_MOUNTPOINTS =
      CLUSCTL_RESOURCE_CODE(CLCTL_STORAGE_GET_MOUNTPOINTS), /*0x01000211*/
  CLUSCTL_RESOURCE_STORAGE_CLUSTER_DISK =
      CLUSCTL_RESOURCE_CODE(CLCTL_STORAGE_CLUSTER_DISK), /*0x01c00212*/
  CLUSCTL_RESOURCE_STORAGE_GET_DIRTY =
      CLUSCTL_RESOURCE_CODE(CLCTL_STORAGE_GET_DIRTY), /*0x01000219*/
  ...
  CLUSCTL_RESOURCE_SET_CSV_MAINTENANCE_MODE =
      CLUSCTL_RESOURCE_CODE(CLCTL_SET_CSV_MAINTENANCE_MODE), /*0x00400296*/
  CLUSCTL_RESOURCE_ENABLE_SHARED_VOLUME_DIRECTIO =
      CLUSCTL_RESOURCE_CODE(CLCTL_ENABLE_SHARED_VOLUME_DIRECTIO), /*0x0140028a*/
  CLUSCTL_RESOURCE_DISABLE_SHARED_VOLUME_DIRECTIO = CLUSCTL_RESOURCE_CODE(
      CLCTL_DISABLE_SHARED_VOLUME_DIRECTIO), /*0x0140028e*/
  CLUSCTL_RESOURCE_SET_SHARED_VOLUME_BACKUP_MODE =
      CLUSCTL_RESOURCE_CODE(CLCTL_SET_SHARED_VOLUME_BACKUP_MODE), /*0x0140029a*/
  ...
  CLUSCTL_RESOURCE_PROVIDER_STATE_CHANGE =
      CLUSCTL_RESOURCE_CODE(CLCTL_PROVIDER_STATE_CHANGE), /*0x01500052*/
  CLUSCTL_RESOURCE_LEAVING_GROUP =
      CLUSCTL_RESOURCE_CODE(CLCTL_LEAVING_GROUP), /*0x01500056*/
  CLUSCTL_RESOURCE_JOINING_GROUP =
      CLUSCTL_RESOURCE_CODE(CLCTL_JOINING_GROUP), /*0x0150005a*/
  CLUSCTL_RESOURCE_FSWITNESS_GET_EPOCH_INFO =
      CLUSCTL_RESOURCE_CODE(CLCTL_FSWITNESS_GET_EPOCH_INFO), /*0x0110005d*/
  CLUSCTL_RESOURCE_FSWITNESS_SET_EPOCH_INFO =
      CLUSCTL_RESOURCE_CODE(CLCTL_FSWITNESS_SET_EPOCH_INFO), /*0x01500062*/
  CLUSCTL_RESOURCE_FSWITNESS_RELEASE_LOCK =
      CLUSCTL_RESOURCE_CODE(CLCTL_FSWITNESS_RELEASE_LOCK), /*0x01500066*/
  CLUSCTL_RESOURCE_NETNAME_CREDS_UPDATED =
      CLUSCTL_RESOURCE_CODE(CLCTL_NETNAME_CREDS_UPDATED) /*0x01c0018a */
...
typedef enum CLUSCTL_CLUSTER_CODES {
  ...
  CLUSCTL_CLUSTER_CHECK_VOTER_EVICT =
      CLUSCTL_CLUSTER_CODE(CLCTL_CHECK_VOTER_EVICT), /*0x07000045*/
  CLUSCTL_CLUSTER_CHECK_VOTER_DOWN =
      CLUSCTL_CLUSTER_CODE(CLCTL_CHECK_VOTER_DOWN), /*0x07000049*/
  CLUSCTL_CLUSTER_SHUTDOWN =
      CLUSCTL_CLUSTER_CODE(CLCTL_SHUTDOWN), /*0x0700004d*/
  CLUSCTL_CLUSTER_BATCH_BLOCK_KEY =
      CLUSCTL_CLUSTER_CODE(CLCTL_BATCH_BLOCK_KEY), /*0x0700023e*/
  CLUSCTL_CLUSTER_BATCH_UNBLOCK_KEY =
      CLUSCTL_CLUSTER_CODE(CLCTL_BATCH_UNBLOCK_KEY), /*0x07000241*/
  CLUSCTL_CLUSTER_GET_SHARED_VOLUME_ID =
      CLUSCTL_CLUSTER_CODE(CLCTL_GET_SHARED_VOLUME_ID), /*0x07000291*/
...
typedef enum CLUS_FLAGS { CLUS_FLAG_CORE = 0x00000001 } CLUS_FLAGS;
...
typedef enum CLUSTER_RESOURCE_ENUM {
  ...
  CLUSTER_RESOURCE_ENUM_ALL =
      (CLUSTER_RESOURCE_ENUM_DEPENDS | CLUSTER_RESOURCE_ENUM_PROVIDES |
...
typedef enum CLUSTER_RESOURCE_TYPE_ENUM {
  ...
  CLUSTER_RESOURCE_TYPE_ENUM_ALL =
      (CLUSTER_RESOURCE_TYPE_ENUM_NODES | CLUSTER_RESOURCE_TYPE_ENUM_RESOURCES)
...
DWORD WINAPI ClusterResourceEnum(HRESENUM hResEnum, DWORD dwIndex,
                                 LPDWORD lpdwType, LPWSTR lpszName,
                                 LPDWORD lpcchName);
DWORD WINAPI ClusterResourceCloseEnum(HRESENUM hResEnum);
DWORD WINAPI CreateClusterResourceType(HCLUSTER hCluster,
...
DWORD WINAPI DeleteClusterResourceType(HCLUSTER hCluster,
                                       LPCWSTR lpszResourceTypeName);
HRESTYPEENUM WINAPI ClusterResourceTypeOpenEnum(HCLUSTER hCluster,
                                                LPCWSTR lpszResourceTypeName,
                                                DWORD dwType);
DWORD WINAPI ClusterResourceTypeGetEnumCount(HRESTYPEENUM hResTypeEnum);
DWORD WINAPI ClusterResourceTypeEnum(HRESTYPEENUM hResTypeEnum, DWORD dwIndex,
                                     LPDWORD lpdwType, LPWSTR lpszName,
                                     LPDWORD lpcchName);
...
DWORD WINAPI ClusterNetworkEnum(HNETWORKENUM hNetworkEnum, DWORD dwIndex,
                                LPDWORD lpdwType, LPWSTR lpszName,
                                LPDWORD lpcchName);
...
DWORD WINAPI GetClusterNetworkId(HNETWORK hNetwork, LPWSTR lpszNetworkId,
                                 LPDWORD lpcchName);
DWORD WINAPI ClusterNetworkControl(HNETWORK hNetwork, HNODE hHostNode,
                                   DWORD dwControlCode, LPVOID lpInBuffer,
                                   DWORD nInBufferSize, LPVOID lpOutBuffer,
...
#endif
HNETINTERFACE WINAPI OpenClusterNetInterface(HCLUSTER hCluster,
                                             LPCWSTR lpszInterfaceName);
DWORD WINAPI GetClusterNetInterface(HCLUSTER hCluster, LPCWSTR lpszNodeName,
...
CLUSTER_NETINTERFACE_STATE WINAPI
GetClusterNetInterfaceState(HNETINTERFACE hNetInterface);
DWORD WINAPI ClusterNetInterfaceControl(HNETINTERFACE hNetInterface,
...
HKEY WINAPI GetClusterNetInterfaceKey(HNETINTERFACE hNetInterface,
                                      REGSAM samDesired);
LONG WINAPI ClusterRegCreateKey(HKEY hKey, LPCWSTR lpszSubKey, DWORD dwOptions,
                                REGSAM samDesired,
                                LPSECURITY_ATTRIBUTES lpSecurityAttributes,
                                PHKEY phkResult, LPDWORD lpdwDisposition);
LONG WINAPI ClusterRegOpenKey(HKEY hKey, LPCWSTR lpszSubKey, REGSAM samDesired,
                              PHKEY phkResult);
LONG WINAPI ClusterRegDeleteKey(HKEY hKey, LPCWSTR lpszSubKey);
LONG WINAPI ClusterRegCloseKey(HKEY hKey);
LONG WINAPI ClusterRegEnumKey(HKEY hKey, DWORD dwIndex, LPWSTR lpszName,
                              LPDWORD lpcchName, PFILETIME lpftLastWriteTime);
DWORD WINAPI ClusterRegSetValue(HKEY hKey, LPCWSTR lpszValueName, DWORD dwType,
                                CONST BYTE *lpData, DWORD cbData);
DWORD WINAPI ClusterRegDeleteValue(HKEY hKey, LPCWSTR lpszValueName);
LONG WINAPI ClusterRegQueryValue(HKEY hKey, LPCWSTR lpszValueName,
                                 LPDWORD lpdwValueType, LPBYTE lpData,
                                 LPDWORD lpcbData);
DWORD WINAPI ClusterRegEnumValue(HKEY hKey, DWORD dwIndex, LPWSTR lpszValueName,
                                 LPDWORD lpcchValueName, LPDWORD lpdwType,
                                 LPBYTE lpData, LPDWORD lpcbData);
LONG WINAPI ClusterRegQueryInfoKey(HKEY hKey, LPDWORD lpcSubKeys,
                                   LPDWORD lpcchMaxSubKeyLen, LPDWORD lpcValues,
                                   LPDWORD lpcchMaxValueNameLen,
                                   LPDWORD lpcbMaxValueLen,
                                   LPDWORD lpcbSecurityDescriptor,
                                   PFILETIME lpftLastWriteTime);
LONG WINAPI ClusterRegGetKeySecurity(HKEY hKey,
                                     SECURITY_INFORMATION RequestedInformation,
                                     PSECURITY_DESCRIPTOR pSecurityDescriptor,
                                     LPDWORD lpcbSecurityDescriptor);
LONG WINAPI ClusterRegSetKeySecurity(HKEY hKey,
...
LONG ClusterRegBatchAddCommand(HREGBATCH hRegBatch,
                               CLUSTER_REG_COMMAND dwCommand, LPCWSTR wzName,
                               DWORD dwOptions, VOID CONST *lpData,
                               DWORD cbData);
LONG WINAPI
ClusterRegBatchCloseNotification(HREGBATCHNOTIFICATION hBatchNotification);
LONG WINAPI ClusterRegBatchReadCommand(HREGBATCHNOTIFICATION hBatchNotification,
                                       CLUSTER_BATCH_COMMAND *pBatchCommand);
LONG WINAPI ClusterRegCloseBatch(HREGBATCH hRegBatch, WINBOOL bCommit,
                                 INT *failedCommandNumber);
LONG WINAPI ClusterRegCloseBatchNotifyPort(HREGBATCHPORT hBatchNotifyPort);
typedef LONG(WINAPI *PCLUSTER_REG_CREATE_BATCH)(HKEY hKey,
...
typedef LONG(WINAPI *PCLUSTER_REG_CREATE_BATCH_NOTIFY_PORT)(
    HKEY hKey, HREGBATCHPORT *phBatchNotifyPort);
LONG WINAPI ClusterRegCreateBatchNotifyPort(HKEY hKey,
                                            HREGBATCHPORT *phBatchNotifyPort);
typedef LONG(WINAPI *PCLUSTER_REG_GET_BATCH_NOTIFICATION)(
    HREGBATCHPORT hBatchNotify, HREGBATCHNOTIFICATION *phBatchNotification);
LONG WINAPI ClusterRegGetBatchNotification(
    HREGBATCHPORT hBatchNotify, HREGBATCHNOTIFICATION *phBatchNotification);
typedef WINBOOL(WINAPI *PCLUSTER_SETUP_PROGRESS_CALLBACK)(
    PVOID pvCallbackArg, CLUSTER_SETUP_PHASE eSetupPhase,
    CLUSTER_SETUP_PHASE_TYPE ePhaseType,
    CLUSTER_SETUP_PHASE_SEVERITY ePhaseSeverity, DWORD dwPercentComplete,
    PCWSTR lpszObjectName, DWORD dwStatus);
HNODE WINAPI AddClusterNode(
    HCLUSTER hCluster, PCWSTR lpszNodeName,
    PCLUSTER_SETUP_PROGRESS_CALLBACK pfnProgressCallback, PVOID pvCallbackArg);
DWORD WINAPI DestroyCluster(
    HCLUSTER hCluster, PCLUSTER_SETUP_PROGRESS_CALLBACK pfnProgressCallback,
    PVOID pvCallbackArg, WINBOOL fdeleteVirtualComputerObjects);
HCLUSTER WINAPI CreateCluster(
    PCREATE_CLUSTER_CONFIG pConfig,
    PCLUSTER_SETUP_PROGRESS_CALLBACK pfnProgressCallback, PVOID pvCallbackArg);
DWORD DestroyClusterGroup(HGROUP hGroup);
...
DWORD WINAPI GetClusterResourceDependencyExpression(
    HRESOURCE hResource, LPWSTR lpszDependencyExpression,
    LPDWORD lpcchDependencyExpression);
DWORD WINAPI SetClusterResourceDependencyExpression(
    HRESOURCE hResource, LPCWSTR lpszDependencyExpression);
