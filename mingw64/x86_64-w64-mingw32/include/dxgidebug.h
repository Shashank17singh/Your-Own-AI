...
DEFINE_GUID(DXGI_DEBUG_DXGI, 0x25cddaa4, 0xb1c6, 0x47e1, 0xac, 0x3e, 0x98, 0x87,
            0x5b, 0x5a, 0x2e, 0x2a);
DEFINE_GUID(DXGI_DEBUG_APP, 0x06cd6e01, 0x4219, 0x4ebd, 0x87, 0x09, 0x27, 0xed,
            0x23, 0x36, 0x0c, 0x62);
...
IDXGIInfoQueue : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE GetMessage(
      DXGI_DEBUG_ID producer, UINT64 index, DXGI_INFO_QUEUE_MESSAGE * message,
      SIZE_T * length) = 0;
  virtual UINT64 STDMETHODCALLTYPE
  GetNumStoredMessagesAllowedByRetrievalFilters(DXGI_DEBUG_ID producer) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE AddStorageFilterEntries(
      DXGI_DEBUG_ID producer, DXGI_INFO_QUEUE_FILTER * filter) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetStorageFilter(
      DXGI_DEBUG_ID producer, DXGI_INFO_QUEUE_FILTER * filter,
      SIZE_T * length) = 0;
  virtual void STDMETHODCALLTYPE ClearStorageFilter(DXGI_DEBUG_ID producer) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE PushStorageFilter(
      DXGI_DEBUG_ID producer, DXGI_INFO_QUEUE_FILTER * filter) = 0;
  virtual void STDMETHODCALLTYPE PopStorageFilter(DXGI_DEBUG_ID producer) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE PushRetrievalFilter(
      DXGI_DEBUG_ID producer, DXGI_INFO_QUEUE_FILTER * filter) = 0;
  virtual void STDMETHODCALLTYPE PopRetrievalFilter(DXGI_DEBUG_ID producer) = 0;
  virtual UINT STDMETHODCALLTYPE GetRetrievalFilterStackSize(
      DXGI_DEBUG_ID producer) = 0;
  virtual HRESULT STDMETHODCALLTYPE AddMessage(
      DXGI_DEBUG_ID producer, DXGI_INFO_QUEUE_MESSAGE_CATEGORY category,
  ...
  virtual HRESULT STDMETHODCALLTYPE AddApplicationMessage(
      DXGI_INFO_QUEUE_MESSAGE_SEVERITY severity, LPCSTR description) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetBreakOnCategory(
      DXGI_DEBUG_ID producer, DXGI_INFO_QUEUE_MESSAGE_CATEGORY category,
      WINBOOL enable) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetBreakOnSeverity(
      DXGI_DEBUG_ID producer, DXGI_INFO_QUEUE_MESSAGE_SEVERITY severity,
      WINBOOL enable) = 0;
  ...
  virtual WINBOOL STDMETHODCALLTYPE GetBreakOnCategory(
      DXGI_DEBUG_ID producer, DXGI_INFO_QUEUE_MESSAGE_CATEGORY category) = 0;
  virtual WINBOOL STDMETHODCALLTYPE GetBreakOnSeverity(
      DXGI_DEBUG_ID producer, DXGI_INFO_QUEUE_MESSAGE_SEVERITY severity) = 0;
  virtual WINBOOL STDMETHODCALLTYPE GetBreakOnID(
      DXGI_DEBUG_ID producer, DXGI_INFO_QUEUE_MESSAGE_ID id) = 0;
  virtual void STDMETHODCALLTYPE SetMuteDebugOutput(DXGI_DEBUG_ID producer,
                                                    WINBOOL mute) = 0;
  virtual WINBOOL STDMETHODCALLTYPE GetMuteDebugOutput(
      DXGI_DEBUG_ID producer) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDXGIInfoQueue, 0xd67441c7, 0x672a, 0x476f, 0x9e, 0x82, 0xcd,
                0x55, 0xb4, 0x49, 0x49, 0xce)
#endif
#else
typedef struct IDXGIInfoQueueVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDXGIInfoQueue *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *SetMessageCountLimit)(IDXGIInfoQueue *This,
                                                   DXGI_DEBUG_ID producer,
                                                   UINT64 limit);
  void(STDMETHODCALLTYPE *ClearStoredMessages)(IDXGIInfoQueue *This,
                                               DXGI_DEBUG_ID producer);
  HRESULT(STDMETHODCALLTYPE *GetMessage)(IDXGIInfoQueue *This,
                                         DXGI_DEBUG_ID producer, UINT64 index,
                                         DXGI_INFO_QUEUE_MESSAGE *message,
                                         SIZE_T *length);
  UINT64(STDMETHODCALLTYPE *GetNumStoredMessagesAllowedByRetrievalFilters)(
      IDXGIInfoQueue *This, DXGI_DEBUG_ID producer);
  UINT64(STDMETHODCALLTYPE *GetNumStoredMessages)(IDXGIInfoQueue *This,
                                                  DXGI_DEBUG_ID producer);
  UINT64(STDMETHODCALLTYPE *GetNumMessagesDiscardedByMessageCountLimit)(
      IDXGIInfoQueue *This, DXGI_DEBUG_ID producer);
  UINT64(STDMETHODCALLTYPE *GetMessageCountLimit)(IDXGIInfoQueue *This,
                                                  DXGI_DEBUG_ID producer);
  ...
  HRESULT(STDMETHODCALLTYPE *GetStorageFilter)(IDXGIInfoQueue *This,
                                               DXGI_DEBUG_ID producer,
                                               DXGI_INFO_QUEUE_FILTER *filter,
                                               SIZE_T *length);
  void(STDMETHODCALLTYPE *ClearStorageFilter)(IDXGIInfoQueue *This,
                                              DXGI_DEBUG_ID producer);
  HRESULT(STDMETHODCALLTYPE *PushEmptyStorageFilter)(IDXGIInfoQueue *This,
                                                     DXGI_DEBUG_ID producer);
  HRESULT(STDMETHODCALLTYPE *PushDenyAllStorageFilter)(IDXGIInfoQueue *This,
                                                       DXGI_DEBUG_ID producer);
  HRESULT(STDMETHODCALLTYPE *PushCopyOfStorageFilter)(IDXGIInfoQueue *This,
                                                      DXGI_DEBUG_ID producer);
  HRESULT(STDMETHODCALLTYPE *PushStorageFilter)(IDXGIInfoQueue *This,
                                                DXGI_DEBUG_ID producer,
                                                DXGI_INFO_QUEUE_FILTER *filter);
  ...
  HRESULT(STDMETHODCALLTYPE *AddRetrievalFilterEntries)(
      IDXGIInfoQueue *This, DXGI_DEBUG_ID producer,
      DXGI_INFO_QUEUE_FILTER *filter);
  HRESULT(STDMETHODCALLTYPE *GetRetrievalFilter)(IDXGIInfoQueue *This,
                                                 DXGI_DEBUG_ID producer,
                                                 DXGI_INFO_QUEUE_FILTER *filter,
                                                 SIZE_T *length);
  void(STDMETHODCALLTYPE *ClearRetrievalFilter)(IDXGIInfoQueue *This,
                                                DXGI_DEBUG_ID producer);
  HRESULT(STDMETHODCALLTYPE *PushEmptyRetrievalFilter)(IDXGIInfoQueue *This,
                                                       DXGI_DEBUG_ID producer);
  HRESULT(STDMETHODCALLTYPE *PushDenyAllRetrievalFilter)(
      IDXGIInfoQueue *This, DXGI_DEBUG_ID producer);
  HRESULT(STDMETHODCALLTYPE *PushCopyOfRetrievalFilter)(IDXGIInfoQueue *This,
                                                        DXGI_DEBUG_ID producer);
  ...
  HRESULT(STDMETHODCALLTYPE *AddApplicationMessage)(
      IDXGIInfoQueue *This, DXGI_INFO_QUEUE_MESSAGE_SEVERITY severity,
      LPCSTR description);
  HRESULT(STDMETHODCALLTYPE *SetBreakOnCategory)(
      IDXGIInfoQueue *This, DXGI_DEBUG_ID producer,
      DXGI_INFO_QUEUE_MESSAGE_CATEGORY category, WINBOOL enable);
  HRESULT(STDMETHODCALLTYPE *SetBreakOnSeverity)(
      IDXGIInfoQueue *This, DXGI_DEBUG_ID producer,
      DXGI_INFO_QUEUE_MESSAGE_SEVERITY severity, WINBOOL enable);
  HRESULT(STDMETHODCALLTYPE *SetBreakOnID)(IDXGIInfoQueue *This,
                                           DXGI_DEBUG_ID producer,
                                           DXGI_INFO_QUEUE_MESSAGE_ID id,
                                           WINBOOL enable);
  ...
  WINBOOL(STDMETHODCALLTYPE *GetBreakOnSeverity)(
      IDXGIInfoQueue *This, DXGI_DEBUG_ID producer,
      DXGI_INFO_QUEUE_MESSAGE_SEVERITY severity);
  WINBOOL(STDMETHODCALLTYPE *GetBreakOnID)(IDXGIInfoQueue *This,
                                           DXGI_DEBUG_ID producer,
                                           DXGI_INFO_QUEUE_MESSAGE_ID id);
  void(STDMETHODCALLTYPE *SetMuteDebugOutput)(IDXGIInfoQueue *This,
                                              DXGI_DEBUG_ID producer,
                                              WINBOOL mute);
  WINBOOL(STDMETHODCALLTYPE *GetMuteDebugOutput)(IDXGIInfoQueue *This,
                                                 DXGI_DEBUG_ID producer);
  END_INTERFACE
} IDXGIInfoQueueVtbl;
interface IDXGIInfoQueue { CONST_VTBL IDXGIInfoQueueVtbl *lpVtbl; };
#ifdef COBJMACROS
...
/*** IDXGIInfoQueue methods ***/
#define IDXGIInfoQueue_SetMessageCountLimit(This, producer, limit)             \
  (This)->lpVtbl->SetMessageCountLimit(This, producer, limit)
#define IDXGIInfoQueue_ClearStoredMessages(This, producer)                     \
  (This)->lpVtbl->ClearStoredMessages(This, producer)
#define IDXGIInfoQueue_GetMessage(This, producer, index, message, length)      \
  (This)->lpVtbl->GetMessage(This, producer, index, message, length)
...
#define IDXGIInfoQueue_AddStorageFilterEntries(This, producer, filter)         \
  (This)->lpVtbl->AddStorageFilterEntries(This, producer, filter)
#define IDXGIInfoQueue_GetStorageFilter(This, producer, filter, length)        \
...
#define IDXGIInfoQueue_PushStorageFilter(This, producer, filter)               \
  (This)->lpVtbl->PushStorageFilter(This, producer, filter)
...
#define IDXGIInfoQueue_AddRetrievalFilterEntries(This, producer, filter)       \
  (This)->lpVtbl->AddRetrievalFilterEntries(This, producer, filter)
#define IDXGIInfoQueue_GetRetrievalFilter(This, producer, filter, length)      \
...
#define IDXGIInfoQueue_PushRetrievalFilter(This, producer, filter)             \
  (This)->lpVtbl->PushRetrievalFilter(This, producer, filter)
...
#define IDXGIInfoQueue_AddMessage(This, producer, category, severity, id,      \
  ...
  (This)->lpVtbl->AddMessage(This, producer, category, severity, id,           \
                             description)
#define IDXGIInfoQueue_AddApplicationMessage(This, severity, description)      \
  (This)->lpVtbl->AddApplicationMessage(This, severity, description)
#define IDXGIInfoQueue_SetBreakOnCategory(This, producer, category, enable)    \
  (This)->lpVtbl->SetBreakOnCategory(This, producer, category, enable)
#define IDXGIInfoQueue_SetBreakOnSeverity(This, producer, severity, enable)    \
  (This)->lpVtbl->SetBreakOnSeverity(This, producer, severity, enable)
#define IDXGIInfoQueue_SetBreakOnID(This, producer, id, enable)                \
  (This)->lpVtbl->SetBreakOnID(This, producer, id, enable)
...
#define IDXGIInfoQueue_SetMuteDebugOutput(This, producer, mute)                \
...
#else
/*** IUnknown methods ***/
static inline HRESULT IDXGIInfoQueue_QueryInterface(IDXGIInfoQueue *This,
                                                    REFIID riid,
                                                    void **ppvObject) {
...
IDXGIInfoQueue_SetMessageCountLimit(IDXGIInfoQueue *This,
                                    DXGI_DEBUG_ID producer, UINT64 limit) {
  return This->lpVtbl->SetMessageCountLimit(This, producer, limit);
}
static inline void IDXGIInfoQueue_ClearStoredMessages(IDXGIInfoQueue *This,
                                                      DXGI_DEBUG_ID producer) {
  This->lpVtbl->ClearStoredMessages(This, producer);
}
static inline HRESULT
IDXGIInfoQueue_GetMessage(IDXGIInfoQueue *This, DXGI_DEBUG_ID producer,
                          UINT64 index, DXGI_INFO_QUEUE_MESSAGE *message,
                          SIZE_T *length) {
  return This->lpVtbl->GetMessage(This, producer, index, message, length);
}
static inline UINT64
IDXGIInfoQueue_GetNumStoredMessagesAllowedByRetrievalFilters(
    IDXGIInfoQueue *This, DXGI_DEBUG_ID producer) {
  return This->lpVtbl->GetNumStoredMessagesAllowedByRetrievalFilters(This,
                                                                     producer);
}
static inline UINT64
IDXGIInfoQueue_GetNumStoredMessages(IDXGIInfoQueue *This,
                                    DXGI_DEBUG_ID producer) {
  return This->lpVtbl->GetNumStoredMessages(This, producer);
}
static inline UINT64 IDXGIInfoQueue_GetNumMessagesDiscardedByMessageCountLimit(
    IDXGIInfoQueue *This, DXGI_DEBUG_ID producer) {
  return This->lpVtbl->GetNumMessagesDiscardedByMessageCountLimit(This,
                                                                  producer);
}
static inline UINT64
IDXGIInfoQueue_GetMessageCountLimit(IDXGIInfoQueue *This,
                                    DXGI_DEBUG_ID producer) {
  return This->lpVtbl->GetMessageCountLimit(This, producer);
}
static inline UINT64
IDXGIInfoQueue_GetNumMessagesAllowedByStorageFilter(IDXGIInfoQueue *This,
                                                    DXGI_DEBUG_ID producer) {
  return This->lpVtbl->GetNumMessagesAllowedByStorageFilter(This, producer);
}
static inline UINT64
IDXGIInfoQueue_GetNumMessagesDeniedByStorageFilter(IDXGIInfoQueue *This,
                                                   DXGI_DEBUG_ID producer) {
  return This->lpVtbl->GetNumMessagesDeniedByStorageFilter(This, producer);
}
static inline HRESULT
IDXGIInfoQueue_AddStorageFilterEntries(IDXGIInfoQueue *This,
                                       DXGI_DEBUG_ID producer,
                                       DXGI_INFO_QUEUE_FILTER *filter) {
  return This->lpVtbl->AddStorageFilterEntries(This, producer, filter);
}
static inline HRESULT
IDXGIInfoQueue_GetStorageFilter(IDXGIInfoQueue *This, DXGI_DEBUG_ID producer,
                                DXGI_INFO_QUEUE_FILTER *filter,
                                SIZE_T *length) {
  return This->lpVtbl->GetStorageFilter(This, producer, filter, length);
}
static inline void IDXGIInfoQueue_ClearStorageFilter(IDXGIInfoQueue *This,
                                                     DXGI_DEBUG_ID producer) {
  This->lpVtbl->ClearStorageFilter(This, producer);
}
static inline HRESULT
IDXGIInfoQueue_PushEmptyStorageFilter(IDXGIInfoQueue *This,
                                      DXGI_DEBUG_ID producer) {
  return This->lpVtbl->PushEmptyStorageFilter(This, producer);
}
static inline HRESULT
IDXGIInfoQueue_PushDenyAllStorageFilter(IDXGIInfoQueue *This,
                                        DXGI_DEBUG_ID producer) {
  return This->lpVtbl->PushDenyAllStorageFilter(This, producer);
}
static inline HRESULT
IDXGIInfoQueue_PushCopyOfStorageFilter(IDXGIInfoQueue *This,
                                       DXGI_DEBUG_ID producer) {
  return This->lpVtbl->PushCopyOfStorageFilter(This, producer);
}
static inline HRESULT
IDXGIInfoQueue_PushStorageFilter(IDXGIInfoQueue *This, DXGI_DEBUG_ID producer,
                                 DXGI_INFO_QUEUE_FILTER *filter) {
  return This->lpVtbl->PushStorageFilter(This, producer, filter);
}
static inline void IDXGIInfoQueue_PopStorageFilter(IDXGIInfoQueue *This,
                                                   DXGI_DEBUG_ID producer) {
  This->lpVtbl->PopStorageFilter(This, producer);
}
static inline UINT
IDXGIInfoQueue_GetStorageFilterStackSize(IDXGIInfoQueue *This,
                                         DXGI_DEBUG_ID producer) {
  return This->lpVtbl->GetStorageFilterStackSize(This, producer);
}
static inline HRESULT
IDXGIInfoQueue_AddRetrievalFilterEntries(IDXGIInfoQueue *This,
                                         DXGI_DEBUG_ID producer,
                                         DXGI_INFO_QUEUE_FILTER *filter) {
  return This->lpVtbl->AddRetrievalFilterEntries(This, producer, filter);
}
static inline HRESULT
IDXGIInfoQueue_GetRetrievalFilter(IDXGIInfoQueue *This, DXGI_DEBUG_ID producer,
                                  DXGI_INFO_QUEUE_FILTER *filter,
                                  SIZE_T *length) {
  return This->lpVtbl->GetRetrievalFilter(This, producer, filter, length);
}
static inline void IDXGIInfoQueue_ClearRetrievalFilter(IDXGIInfoQueue *This,
                                                       DXGI_DEBUG_ID producer) {
  This->lpVtbl->ClearRetrievalFilter(This, producer);
}
static inline HRESULT
IDXGIInfoQueue_PushEmptyRetrievalFilter(IDXGIInfoQueue *This,
                                        DXGI_DEBUG_ID producer) {
  return This->lpVtbl->PushEmptyRetrievalFilter(This, producer);
}
static inline HRESULT
IDXGIInfoQueue_PushDenyAllRetrievalFilter(IDXGIInfoQueue *This,
                                          DXGI_DEBUG_ID producer) {
  return This->lpVtbl->PushDenyAllRetrievalFilter(This, producer);
}
static inline HRESULT
IDXGIInfoQueue_PushCopyOfRetrievalFilter(IDXGIInfoQueue *This,
                                         DXGI_DEBUG_ID producer) {
  return This->lpVtbl->PushCopyOfRetrievalFilter(This, producer);
}
static inline HRESULT
IDXGIInfoQueue_PushRetrievalFilter(IDXGIInfoQueue *This, DXGI_DEBUG_ID producer,
                                   DXGI_INFO_QUEUE_FILTER *filter) {
  return This->lpVtbl->PushRetrievalFilter(This, producer, filter);
}
static inline void IDXGIInfoQueue_PopRetrievalFilter(IDXGIInfoQueue *This,
                                                     DXGI_DEBUG_ID producer) {
  This->lpVtbl->PopRetrievalFilter(This, producer);
}
static inline UINT
IDXGIInfoQueue_GetRetrievalFilterStackSize(IDXGIInfoQueue *This,
                                           DXGI_DEBUG_ID producer) {
  return This->lpVtbl->GetRetrievalFilterStackSize(This, producer);
}
static inline HRESULT
IDXGIInfoQueue_AddMessage(IDXGIInfoQueue *This, DXGI_DEBUG_ID producer,
                          DXGI_INFO_QUEUE_MESSAGE_CATEGORY category,
                          DXGI_INFO_QUEUE_MESSAGE_SEVERITY severity,
                          DXGI_INFO_QUEUE_MESSAGE_ID id, LPCSTR description) {
  return This->lpVtbl->AddMessage(This, producer, category, severity, id,
                                  description);
}
static inline HRESULT
IDXGIInfoQueue_AddApplicationMessage(IDXGIInfoQueue *This,
                                     DXGI_INFO_QUEUE_MESSAGE_SEVERITY severity,
                                     LPCSTR description) {
  return This->lpVtbl->AddApplicationMessage(This, severity, description);
}
static inline HRESULT
IDXGIInfoQueue_SetBreakOnCategory(IDXGIInfoQueue *This, DXGI_DEBUG_ID producer,
                                  DXGI_INFO_QUEUE_MESSAGE_CATEGORY category,
                                  WINBOOL enable) {
  return This->lpVtbl->SetBreakOnCategory(This, producer, category, enable);
}
static inline HRESULT
IDXGIInfoQueue_SetBreakOnSeverity(IDXGIInfoQueue *This, DXGI_DEBUG_ID producer,
                                  DXGI_INFO_QUEUE_MESSAGE_SEVERITY severity,
                                  WINBOOL enable) {
  return This->lpVtbl->SetBreakOnSeverity(This, producer, severity, enable);
}
static inline HRESULT IDXGIInfoQueue_SetBreakOnID(IDXGIInfoQueue *This,
                                                  DXGI_DEBUG_ID producer,
                                                  DXGI_INFO_QUEUE_MESSAGE_ID id,
                                                  WINBOOL enable) {
...
IDXGIInfoQueue_GetBreakOnCategory(IDXGIInfoQueue *This, DXGI_DEBUG_ID producer,
                                  DXGI_INFO_QUEUE_MESSAGE_CATEGORY category) {
  return This->lpVtbl->GetBreakOnCategory(This, producer, category);
}
static inline WINBOOL
IDXGIInfoQueue_GetBreakOnSeverity(IDXGIInfoQueue *This, DXGI_DEBUG_ID producer,
                                  DXGI_INFO_QUEUE_MESSAGE_SEVERITY severity) {
  return This->lpVtbl->GetBreakOnSeverity(This, producer, severity);
}
static inline WINBOOL
IDXGIInfoQueue_GetBreakOnID(IDXGIInfoQueue *This, DXGI_DEBUG_ID producer,
                            DXGI_INFO_QUEUE_MESSAGE_ID id) {
  return This->lpVtbl->GetBreakOnID(This, producer, id);
}
static inline void IDXGIInfoQueue_SetMuteDebugOutput(IDXGIInfoQueue *This,
                                                     DXGI_DEBUG_ID producer,
                                                     WINBOOL mute) {
  This->lpVtbl->SetMuteDebugOutput(This, producer, mute);
}
static inline WINBOOL
IDXGIInfoQueue_GetMuteDebugOutput(IDXGIInfoQueue *This,
                                  DXGI_DEBUG_ID producer) {
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDXGIDebug, 0x119e7452, 0xde9e, 0x40fe, 0x88, 0x06, 0x88, 0xf9,
                0x0c, 0x12, 0xb4, 0x41)
#endif
#else
typedef struct IDXGIDebugVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDXGIDebug *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IDXGIDebug *This);
  ULONG(STDMETHODCALLTYPE *Release)(IDXGIDebug *This);
  /*** IDXGIDebug methods ***/
  HRESULT(STDMETHODCALLTYPE *ReportLiveObjects)(IDXGIDebug *This, GUID apiid,
                                                DXGI_DEBUG_RLO_FLAGS flags);
  END_INTERFACE
} IDXGIDebugVtbl;
interface IDXGIDebug { CONST_VTBL IDXGIDebugVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IDXGIDebug_QueryInterface(IDXGIDebug *This, REFIID riid,
                                                void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IDXGIDebug methods ***/
static inline HRESULT IDXGIDebug_ReportLiveObjects(IDXGIDebug *This, GUID apiid,
                                                   DXGI_DEBUG_RLO_FLAGS flags) {
...
IDXGIDebug1 : public IDXGIDebug {
  virtual void STDMETHODCALLTYPE EnableLeakTrackingForThread() = 0;
  virtual void STDMETHODCALLTYPE DisableLeakTrackingForThread() = 0;
  virtual WINBOOL STDMETHODCALLTYPE IsLeakTrackingEnabledForThread() = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDXGIDebug1, 0xc5a05f0c, 0x16f2, 0x4adf, 0x9f, 0x4d, 0xa8, 0xc4,
                0xd5, 0x8a, 0xc5, 0x50)
#endif
#else
typedef struct IDXGIDebug1Vtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDXGIDebug1 *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IDXGIDebug1 *This);
  ULONG(STDMETHODCALLTYPE *Release)(IDXGIDebug1 *This);
  /*** IDXGIDebug methods ***/
  HRESULT(STDMETHODCALLTYPE *ReportLiveObjects)(IDXGIDebug1 *This, GUID apiid,
                                                DXGI_DEBUG_RLO_FLAGS flags);
  /*** IDXGIDebug1 methods ***/
  ...
  WINBOOL(STDMETHODCALLTYPE *IsLeakTrackingEnabledForThread)(IDXGIDebug1 *This);
  END_INTERFACE
} IDXGIDebug1Vtbl;
interface IDXGIDebug1 { CONST_VTBL IDXGIDebug1Vtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IDXGIDebug1_QueryInterface(IDXGIDebug1 *This, REFIID riid,
                                                 void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IDXGIDebug methods ***/
static inline HRESULT
IDXGIDebug1_ReportLiveObjects(IDXGIDebug1 *This, GUID apiid,
                              DXGI_DEBUG_RLO_FLAGS flags) {
  return This->lpVtbl->ReportLiveObjects(This, apiid, flags);
}
/*** IDXGIDebug1 methods ***/
...
static inline WINBOOL
IDXGIDebug1_IsLeakTrackingEnabledForThread(IDXGIDebug1 *This) {
