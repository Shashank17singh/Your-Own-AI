...
#define REGSTR_VAL_SHUTDOWN_IGNORE_PREDEFINED                                  \
  TEXT("ShutdownIgnorePredefinedReasons")
...
#define REGSTR_VAL_LOCATION_INFORMATION_OVERRIDE                               \
  TEXT("LocationInformationOverride")
...
#define REGSTR_PATH_SHELLSERVICEOBJECT                                         \
  TEXT("Software\\Microsoft\\Windows\\CurrentVersion\\ShellServiceObject")
#define REGSTR_PATH_SHELLSERVICEOBJECTDELAYED                                  \
  TEXT("Software\\Microsoft\\Windows\\CurrentVersion\\ShellServiceObjectDelay" \
       "Load")
...
#define REGSTR_PATH_CHKLASTCHECK                                               \
  TEXT("Software\\Microsoft\\Windows\\CurrentVersion\\Applets\\Check "         \
       "Drive\\LastCheck")
