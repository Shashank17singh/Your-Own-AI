/*** Autogenerated by WIDL 11.5 from include/windows.system.threading.idl - Do
 * not edit ***/
#ifdef _WIN32
...
typedef interface __x_ABI_CWindows_CSystem_CThreading_CIWorkItemHandler
    __x_ABI_CWindows_CSystem_CThreading_CIWorkItemHandler;
#ifdef __cplusplus
#define __x_ABI_CWindows_CSystem_CThreading_CIWorkItemHandler                  \
...
typedef interface __x_ABI_CWindows_CSystem_CThreading_CIThreadPoolStatics
    __x_ABI_CWindows_CSystem_CThreading_CIThreadPoolStatics;
#ifdef __cplusplus
#define __x_ABI_CWindows_CSystem_CThreading_CIThreadPoolStatics                \
...
#else
typedef struct __x_ABI_CWindows_CSystem_CThreading_CThreadPool
    __x_ABI_CWindows_CSystem_CThreading_CThreadPool;
#endif /* defined __cplusplus */
#endif /* defined                                                              \
          ____x_ABI_CWindows_CSystem_CThreading_CThreadPool_FWD_DEFINED__ */
...
#ifndef __cplusplus
typedef enum __x_ABI_CWindows_CSystem_CThreading_CWorkItemPriority
...
#endif /* WINDOWS_FOUNDATION_UNIVERSALAPICONTRACT_VERSION >= 0x10000 */
#ifndef __cplusplus
typedef enum __x_ABI_CWindows_CSystem_CThreading_CWorkItemOptions
    __x_ABI_CWindows_CSystem_CThreading_CWorkItemOptions;
#endif /* __cplusplus */
/*****************************************************************************
...
DEFINE_GUID(IID___x_ABI_CWindows_CSystem_CThreading_CIWorkItemHandler,
            0x1d1a8b8b, 0xfa66, 0x414f, 0x9c, 0xbd, 0xb6, 0x5f, 0xc9, 0x9d,
            0x17, 0xfa);
...
__CRT_UUID_DECL(__x_ABI_CWindows_CSystem_CThreading_CIWorkItemHandler,
                0x1d1a8b8b, 0xfa66, 0x414f, 0x9c, 0xbd, 0xb6, 0x5f, 0xc9, 0x9d,
                0x17, 0xfa)
#endif
#else
typedef struct __x_ABI_CWindows_CSystem_CThreading_CIWorkItemHandlerVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(
      __x_ABI_CWindows_CSystem_CThreading_CIWorkItemHandler *This, REFIID riid,
      void **ppvObject);
...
/*** IUnknown methods ***/
#define __x_ABI_CWindows_CSystem_CThreading_CIWorkItemHandler_QueryInterface(  \
    This, riid, ppvObject)                                                     \
...
static inline ULONG
__x_ABI_CWindows_CSystem_CThreading_CIWorkItemHandler_AddRef(
    __x_ABI_CWindows_CSystem_CThreading_CIWorkItemHandler *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
__x_ABI_CWindows_CSystem_CThreading_CIWorkItemHandler_Release(
    __x_ABI_CWindows_CSystem_CThreading_CIWorkItemHandler *This) {
  return This->lpVtbl->Release(This);
}
/*** IWorkItemHandler methods ***/
static inline HRESULT
__x_ABI_CWindows_CSystem_CThreading_CIWorkItemHandler_Invoke(
    __x_ABI_CWindows_CSystem_CThreading_CIWorkItemHandler *This,
    __x_ABI_CWindows_CFoundation_CIAsyncAction *operation) {
...
#endif
#ifdef WIDL_using_Windows_System_Threading
#define IID_IWorkItemHandler                                                   \
  IID___x_ABI_CWindows_CSystem_CThreading_CIWorkItemHandler
#define IWorkItemHandlerVtbl                                                   \
  __x_ABI_CWindows_CSystem_CThreading_CIWorkItemHandlerVtbl
#define IWorkItemHandler __x_ABI_CWindows_CSystem_CThreading_CIWorkItemHandler
#define IWorkItemHandler_QueryInterface                                        \
  __x_ABI_CWindows_CSystem_CThreading_CIWorkItemHandler_QueryInterface
#define IWorkItemHandler_AddRef                                                \
  __x_ABI_CWindows_CSystem_CThreading_CIWorkItemHandler_AddRef
#define IWorkItemHandler_Release                                               \
  __x_ABI_CWindows_CSystem_CThreading_CIWorkItemHandler_Release
#define IWorkItemHandler_Invoke                                                \
  __x_ABI_CWindows_CSystem_CThreading_CIWorkItemHandler_Invoke
#endif /* WIDL_using_Windows_System_Threading */
#endif
#endif
...
DEFINE_GUID(IID___x_ABI_CWindows_CSystem_CThreading_CIThreadPoolStatics,
            0xb6bf67dd, 0x84bd, 0x44f8, 0xac, 0x1c, 0x93, 0xeb, 0xcb, 0x9d,
            0xba, 0x91);
#if defined(__cplusplus) && !defined(CINTERFACE)
} /* extern "C" */
namespace ABI {
...
extern "C" {
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(__x_ABI_CWindows_CSystem_CThreading_CIThreadPoolStatics,
                0xb6bf67dd, 0x84bd, 0x44f8, 0xac, 0x1c, 0x93, 0xeb, 0xcb, 0x9d,
                0xba, 0x91)
#endif
#else
...
interface __x_ABI_CWindows_CSystem_CThreading_CIThreadPoolStatics {
  CONST_VTBL __x_ABI_CWindows_CSystem_CThreading_CIThreadPoolStaticsVtbl
      *lpVtbl;
};
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
#define __x_ABI_CWindows_CSystem_CThreading_CIThreadPoolStatics_QueryInterface( \
    This, riid, ppvObject)                                                      \
  (This)->lpVtbl->QueryInterface(This, riid, ppvObject)
...
#define __x_ABI_CWindows_CSystem_CThreading_CIThreadPoolStatics_Release(This)  \
  (This)->lpVtbl->Release(This)
/*** IInspectable methods ***/
#define __x_ABI_CWindows_CSystem_CThreading_CIThreadPoolStatics_GetIids(       \
    This, iidCount, iids)                                                      \
  (This)->lpVtbl->GetIids(This, iidCount, iids)
#define __x_ABI_CWindows_CSystem_CThreading_CIThreadPoolStatics_GetRuntimeClassName( \
    This, className)                                                                 \
  (This)->lpVtbl->GetRuntimeClassName(This, className)
#define __x_ABI_CWindows_CSystem_CThreading_CIThreadPoolStatics_GetTrustLevel( \
    This, trustLevel)                                                          \
  (This)->lpVtbl->GetTrustLevel(This, trustLevel)
/*** IThreadPoolStatics methods ***/
#define __x_ABI_CWindows_CSystem_CThreading_CIThreadPoolStatics_RunAsync(      \
    This, handler, operation)                                                  \
  (This)->lpVtbl->RunAsync(This, handler, operation)
#define __x_ABI_CWindows_CSystem_CThreading_CIThreadPoolStatics_RunWithPriorityAsync( \
    This, handler, priority, operation)                                               \
  (This)->lpVtbl->RunWithPriorityAsync(This, handler, priority, operation)
#define __x_ABI_CWindows_CSystem_CThreading_CIThreadPoolStatics_RunWithPriorityAndOptionsAsync( \
    This, handler, priority, options, operation)                                                \
  (This)->lpVtbl->RunWithPriorityAndOptionsAsync(This, handler, priority,                       \
                                                 options, operation)
#else
/*** IUnknown methods ***/
static inline HRESULT
__x_ABI_CWindows_CSystem_CThreading_CIThreadPoolStatics_QueryInterface(
    __x_ABI_CWindows_CSystem_CThreading_CIThreadPoolStatics *This, REFIID riid,
    void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
__x_ABI_CWindows_CSystem_CThreading_CIThreadPoolStatics_AddRef(
    __x_ABI_CWindows_CSystem_CThreading_CIThreadPoolStatics *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
__x_ABI_CWindows_CSystem_CThreading_CIThreadPoolStatics_Release(
    __x_ABI_CWindows_CSystem_CThreading_CIThreadPoolStatics *This) {
  return This->lpVtbl->Release(This);
}
/*** IInspectable methods ***/
static inline HRESULT
__x_ABI_CWindows_CSystem_CThreading_CIThreadPoolStatics_GetIids(
    __x_ABI_CWindows_CSystem_CThreading_CIThreadPoolStatics *This,
    ULONG *iidCount, IID **iids) {
  return This->lpVtbl->GetIids(This, iidCount, iids);
}
static inline HRESULT
__x_ABI_CWindows_CSystem_CThreading_CIThreadPoolStatics_GetRuntimeClassName(
    __x_ABI_CWindows_CSystem_CThreading_CIThreadPoolStatics *This,
    HSTRING *className) {
  return This->lpVtbl->GetRuntimeClassName(This, className);
}
static inline HRESULT
__x_ABI_CWindows_CSystem_CThreading_CIThreadPoolStatics_GetTrustLevel(
    __x_ABI_CWindows_CSystem_CThreading_CIThreadPoolStatics *This,
    TrustLevel *trustLevel) {
...
/*** IThreadPoolStatics methods ***/
static inline HRESULT
__x_ABI_CWindows_CSystem_CThreading_CIThreadPoolStatics_RunAsync(
    __x_ABI_CWindows_CSystem_CThreading_CIThreadPoolStatics *This,
    __x_ABI_CWindows_CSystem_CThreading_CIWorkItemHandler *handler,
    __x_ABI_CWindows_CFoundation_CIAsyncAction **operation) {
...
static inline HRESULT
__x_ABI_CWindows_CSystem_CThreading_CIThreadPoolStatics_RunWithPriorityAsync(
    __x_ABI_CWindows_CSystem_CThreading_CIThreadPoolStatics *This,
    __x_ABI_CWindows_CSystem_CThreading_CIWorkItemHandler *handler,
    __x_ABI_CWindows_CSystem_CThreading_CWorkItemPriority priority,
    __x_ABI_CWindows_CFoundation_CIAsyncAction **operation) {
...
static inline HRESULT
__x_ABI_CWindows_CSystem_CThreading_CIThreadPoolStatics_RunWithPriorityAndOptionsAsync(
    __x_ABI_CWindows_CSystem_CThreading_CIThreadPoolStatics *This,
    __x_ABI_CWindows_CSystem_CThreading_CIWorkItemHandler *handler,
    __x_ABI_CWindows_CSystem_CThreading_CWorkItemPriority priority,
    __x_ABI_CWindows_CSystem_CThreading_CWorkItemOptions options,
    __x_ABI_CWindows_CFoundation_CIAsyncAction **operation) {
  return This->lpVtbl->RunWithPriorityAndOptionsAsync(This, handler, priority,
                                                      options, operation);
}
#endif
#ifdef WIDL_using_Windows_System_Threading
#define IID_IThreadPoolStatics                                                 \
  IID___x_ABI_CWindows_CSystem_CThreading_CIThreadPoolStatics
#define IThreadPoolStaticsVtbl                                                 \
  __x_ABI_CWindows_CSystem_CThreading_CIThreadPoolStaticsVtbl
#define IThreadPoolStatics                                                     \
  __x_ABI_CWindows_CSystem_CThreading_CIThreadPoolStatics
#define IThreadPoolStatics_QueryInterface                                      \
  __x_ABI_CWindows_CSystem_CThreading_CIThreadPoolStatics_QueryInterface
#define IThreadPoolStatics_AddRef                                              \
  __x_ABI_CWindows_CSystem_CThreading_CIThreadPoolStatics_AddRef
#define IThreadPoolStatics_Release                                             \
  __x_ABI_CWindows_CSystem_CThreading_CIThreadPoolStatics_Release
#define IThreadPoolStatics_GetIids                                             \
  __x_ABI_CWindows_CSystem_CThreading_CIThreadPoolStatics_GetIids
#define IThreadPoolStatics_GetRuntimeClassName                                 \
  __x_ABI_CWindows_CSystem_CThreading_CIThreadPoolStatics_GetRuntimeClassName
#define IThreadPoolStatics_GetTrustLevel                                       \
  __x_ABI_CWindows_CSystem_CThreading_CIThreadPoolStatics_GetTrustLevel
#define IThreadPoolStatics_RunAsync                                            \
  __x_ABI_CWindows_CSystem_CThreading_CIThreadPoolStatics_RunAsync
#define IThreadPoolStatics_RunWithPriorityAsync                                \
  __x_ABI_CWindows_CSystem_CThreading_CIThreadPoolStatics_RunWithPriorityAsync
#define IThreadPoolStatics_RunWithPriorityAndOptionsAsync                      \
  __x_ABI_CWindows_CSystem_CThreading_CIThreadPoolStatics_RunWithPriorityAndOptionsAsync
#endif /* WIDL_using_Windows_System_Threading */
#endif
#endif
...
static const WCHAR RuntimeClass_Windows_System_Threading_ThreadPool[] = {
    'W', 'i', 'n', 'd', 'o', 'w', 's', '.', 'S', 'y', 's', 't',
    'e', 'm', '.', 'T', 'h', 'r', 'e', 'a', 'd', 'i', 'n', 'g',
    '.', 'T', 'h', 'r', 'e', 'a', 'd', 'P', 'o', 'o', 'l', 0};
