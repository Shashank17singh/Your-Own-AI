...
DEFINE_GUID(IID_IEnumSTATURL, 0x3c374a42, 0xbae4, 0x11cf, 0xbf, 0x7d, 0x00,
            0xaa, 0x00, 0x69, 0x46, 0xee);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("3c374a42-bae4-11cf-bf7d-00aa006946ee")
IEnumSTATURL : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE Next(ULONG celt, LPSTATURL rgelt,
                                         ULONG * pceltFetched) = 0;
  virtual HRESULT STDMETHODCALLTYPE Skip(ULONG celt) = 0;
  virtual HRESULT STDMETHODCALLTYPE Reset() = 0;
  virtual HRESULT STDMETHODCALLTYPE Clone(IEnumSTATURL * *ppenum) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetFilter(LPCOLESTR poszFilter,
                                              DWORD dwFlags) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IEnumSTATURL, 0x3c374a42, 0xbae4, 0x11cf, 0xbf, 0x7d, 0x00,
                0xaa, 0x00, 0x69, 0x46, 0xee)
#endif
#else
typedef struct IEnumSTATURLVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IEnumSTATURL *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IEnumSTATURL *This);
  ULONG(STDMETHODCALLTYPE *Release)(IEnumSTATURL *This);
  /*** IEnumSTATURL methods ***/
  HRESULT(STDMETHODCALLTYPE *Next)(IEnumSTATURL *This, ULONG celt,
                                   LPSTATURL rgelt, ULONG *pceltFetched);
  ...
  HRESULT(STDMETHODCALLTYPE *SetFilter)(IEnumSTATURL *This,
                                        LPCOLESTR poszFilter, DWORD dwFlags);
  END_INTERFACE
} IEnumSTATURLVtbl;
interface IEnumSTATURL { CONST_VTBL IEnumSTATURLVtbl *lpVtbl; };
#ifdef COBJMACROS
...
IEnumSTATURL_QueryInterface(IEnumSTATURL *This, REFIID riid, void **ppvObject) {
...
/*** IEnumSTATURL methods ***/
static inline HRESULT IEnumSTATURL_Next(IEnumSTATURL *This, ULONG celt,
                                        LPSTATURL rgelt, ULONG *pceltFetched) {
...
static inline HRESULT IEnumSTATURL_Clone(IEnumSTATURL *This,
                                         IEnumSTATURL **ppenum) {
  return This->lpVtbl->Clone(This, ppenum);
}
static inline HRESULT IEnumSTATURL_SetFilter(IEnumSTATURL *This,
...
DEFINE_GUID(IID_IUrlHistoryStg, 0x3c374a41, 0xbae4, 0x11cf, 0xbf, 0x7d, 0x00,
            0xaa, 0x00, 0x69, 0x46, 0xee);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IUrlHistoryStg : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE AddUrl(
      LPCOLESTR pocsUrl, LPCOLESTR pocsTitle, DWORD dwFlags) = 0;
  virtual HRESULT STDMETHODCALLTYPE DeleteUrl(LPCOLESTR pocsUrl,
                                              DWORD dwFlags) = 0;
  virtual HRESULT STDMETHODCALLTYPE QueryUrl(LPCOLESTR pocsUrl, DWORD dwFlags,
                                             LPSTATURL lpSTATURL) = 0;
  virtual HRESULT STDMETHODCALLTYPE BindToObject(LPCOLESTR pocsUrl, REFIID riid,
                                                 void **ppvOut) = 0;
  virtual HRESULT STDMETHODCALLTYPE EnumUrls(IEnumSTATURL * *ppEnum) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IUrlHistoryStg, 0x3c374a41, 0xbae4, 0x11cf, 0xbf, 0x7d, 0x00,
                0xaa, 0x00, 0x69, 0x46, 0xee)
#endif
#else
typedef struct IUrlHistoryStgVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IUrlHistoryStg *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *AddUrl)(IUrlHistoryStg *This, LPCOLESTR pocsUrl,
                                     LPCOLESTR pocsTitle, DWORD dwFlags);
  HRESULT(STDMETHODCALLTYPE *DeleteUrl)(IUrlHistoryStg *This, LPCOLESTR pocsUrl,
                                        DWORD dwFlags);
  HRESULT(STDMETHODCALLTYPE *QueryUrl)(IUrlHistoryStg *This, LPCOLESTR pocsUrl,
                                       DWORD dwFlags, LPSTATURL lpSTATURL);
  HRESULT(STDMETHODCALLTYPE *BindToObject)(IUrlHistoryStg *This,
                                           LPCOLESTR pocsUrl, REFIID riid,
                                           void **ppvOut);
  HRESULT(STDMETHODCALLTYPE *EnumUrls)(IUrlHistoryStg *This,
                                       IEnumSTATURL **ppEnum);
  END_INTERFACE
} IUrlHistoryStgVtbl;
interface IUrlHistoryStg { CONST_VTBL IUrlHistoryStgVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IUrlHistoryStg_QueryInterface(IUrlHistoryStg *This,
                                                    REFIID riid,
                                                    void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IUrlHistoryStg methods ***/
static inline HRESULT IUrlHistoryStg_AddUrl(IUrlHistoryStg *This,
                                            LPCOLESTR pocsUrl,
                                            LPCOLESTR pocsTitle,
                                            DWORD dwFlags) {
  return This->lpVtbl->AddUrl(This, pocsUrl, pocsTitle, dwFlags);
}
static inline HRESULT IUrlHistoryStg_DeleteUrl(IUrlHistoryStg *This,
                                               LPCOLESTR pocsUrl,
                                               DWORD dwFlags) {
  return This->lpVtbl->DeleteUrl(This, pocsUrl, dwFlags);
}
static inline HRESULT IUrlHistoryStg_QueryUrl(IUrlHistoryStg *This,
                                              LPCOLESTR pocsUrl, DWORD dwFlags,
                                              LPSTATURL lpSTATURL) {
  return This->lpVtbl->QueryUrl(This, pocsUrl, dwFlags, lpSTATURL);
}
static inline HRESULT IUrlHistoryStg_BindToObject(IUrlHistoryStg *This,
                                                  LPCOLESTR pocsUrl,
                                                  REFIID riid, void **ppvOut) {
  return This->lpVtbl->BindToObject(This, pocsUrl, riid, ppvOut);
}
static inline HRESULT IUrlHistoryStg_EnumUrls(IUrlHistoryStg *This,
                                              IEnumSTATURL **ppEnum) {
...
DEFINE_GUID(IID_IUrlHistoryStg2, 0xafa0dc11, 0xc313, 0x11d0, 0x83, 0x1a, 0x00,
            0xc0, 0x4f, 0xd5, 0xae, 0x38);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IUrlHistoryStg2 : public IUrlHistoryStg {
  virtual HRESULT STDMETHODCALLTYPE AddUrlAndNotify(
      LPCOLESTR pocsUrl, LPCOLESTR pocsTitle, DWORD dwFlags,
      WINBOOL fWriteHistory, IOleCommandTarget * poctNotify,
      IUnknown * punkISFolder) = 0;
  virtual HRESULT STDMETHODCALLTYPE ClearHistory() = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IUrlHistoryStg2, 0xafa0dc11, 0xc313, 0x11d0, 0x83, 0x1a, 0x00,
                0xc0, 0x4f, 0xd5, 0xae, 0x38)
#endif
#else
typedef struct IUrlHistoryStg2Vtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IUrlHistoryStg2 *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IUrlHistoryStg2 *This);
  ULONG(STDMETHODCALLTYPE *Release)(IUrlHistoryStg2 *This);
  /*** IUrlHistoryStg methods ***/
  HRESULT(STDMETHODCALLTYPE *AddUrl)(IUrlHistoryStg2 *This, LPCOLESTR pocsUrl,
                                     LPCOLESTR pocsTitle, DWORD dwFlags);
  HRESULT(STDMETHODCALLTYPE *DeleteUrl)(IUrlHistoryStg2 *This,
                                        LPCOLESTR pocsUrl, DWORD dwFlags);
  HRESULT(STDMETHODCALLTYPE *QueryUrl)(IUrlHistoryStg2 *This, LPCOLESTR pocsUrl,
                                       DWORD dwFlags, LPSTATURL lpSTATURL);
  HRESULT(STDMETHODCALLTYPE *BindToObject)(IUrlHistoryStg2 *This,
                                           LPCOLESTR pocsUrl, REFIID riid,
                                           void **ppvOut);
  HRESULT(STDMETHODCALLTYPE *EnumUrls)(IUrlHistoryStg2 *This,
                                       IEnumSTATURL **ppEnum);
  ...
  HRESULT(STDMETHODCALLTYPE *AddUrlAndNotify)(
      ...
      DWORD dwFlags, WINBOOL fWriteHistory, IOleCommandTarget *poctNotify,
      IUnknown *punkISFolder);
  HRESULT(STDMETHODCALLTYPE *ClearHistory)(IUrlHistoryStg2 *This);
  END_INTERFACE
} IUrlHistoryStg2Vtbl;
interface IUrlHistoryStg2 { CONST_VTBL IUrlHistoryStg2Vtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define IUrlHistoryStg2_EnumUrls(This, ppEnum)                                 \
  (This)->lpVtbl->EnumUrls(This, ppEnum)
/*** IUrlHistoryStg2 methods ***/
#define IUrlHistoryStg2_AddUrlAndNotify(This, pocsUrl, pocsTitle, dwFlags,     \
                                        fWriteHistory, poctNotify,             \
                                        punkISFolder)                          \
  (This)->lpVtbl->AddUrlAndNotify(This, pocsUrl, pocsTitle, dwFlags,           \
                                  fWriteHistory, poctNotify, punkISFolder)
#define IUrlHistoryStg2_ClearHistory(This) (This)->lpVtbl->ClearHistory(This)
#else
/*** IUnknown methods ***/
static inline HRESULT IUrlHistoryStg2_QueryInterface(IUrlHistoryStg2 *This,
                                                     REFIID riid,
                                                     void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IUrlHistoryStg methods ***/
static inline HRESULT IUrlHistoryStg2_AddUrl(IUrlHistoryStg2 *This,
                                             LPCOLESTR pocsUrl,
                                             LPCOLESTR pocsTitle,
                                             DWORD dwFlags) {
  return This->lpVtbl->AddUrl(This, pocsUrl, pocsTitle, dwFlags);
}
static inline HRESULT IUrlHistoryStg2_DeleteUrl(IUrlHistoryStg2 *This,
                                                LPCOLESTR pocsUrl,
                                                DWORD dwFlags) {
  return This->lpVtbl->DeleteUrl(This, pocsUrl, dwFlags);
}
static inline HRESULT IUrlHistoryStg2_QueryUrl(IUrlHistoryStg2 *This,
                                               LPCOLESTR pocsUrl, DWORD dwFlags,
                                               LPSTATURL lpSTATURL) {
  return This->lpVtbl->QueryUrl(This, pocsUrl, dwFlags, lpSTATURL);
}
static inline HRESULT IUrlHistoryStg2_BindToObject(IUrlHistoryStg2 *This,
                                                   LPCOLESTR pocsUrl,
                                                   REFIID riid, void **ppvOut) {
  return This->lpVtbl->BindToObject(This, pocsUrl, riid, ppvOut);
}
static inline HRESULT IUrlHistoryStg2_EnumUrls(IUrlHistoryStg2 *This,
                                               IEnumSTATURL **ppEnum) {
  return This->lpVtbl->EnumUrls(This, ppEnum);
}
/*** IUrlHistoryStg2 methods ***/
static inline HRESULT IUrlHistoryStg2_AddUrlAndNotify(
    IUrlHistoryStg2 *This, LPCOLESTR pocsUrl, LPCOLESTR pocsTitle,
    DWORD dwFlags, WINBOOL fWriteHistory, IOleCommandTarget *poctNotify,
    IUnknown *punkISFolder) {
  return This->lpVtbl->AddUrlAndNotify(This, pocsUrl, pocsTitle, dwFlags,
                                       fWriteHistory, poctNotify, punkISFolder);
}
...
DEFINE_GUID(IID_IUrlHistoryNotify, 0xbc40bec1, 0xc493, 0x11d0, 0x83, 0x1b, 0x00,
            0xc0, 0x4f, 0xd5, 0xae, 0x38);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("bc40bec1-c493-11d0-831b-00c04fd5ae38")
IUrlHistoryNotify : public IOleCommandTarget{};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IUrlHistoryNotify, 0xbc40bec1, 0xc493, 0x11d0, 0x83, 0x1b, 0x00,
                0xc0, 0x4f, 0xd5, 0xae, 0x38)
#endif
#else
typedef struct IUrlHistoryNotifyVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IUrlHistoryNotify *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IUrlHistoryNotify *This);
  ULONG(STDMETHODCALLTYPE *Release)(IUrlHistoryNotify *This);
  /*** IOleCommandTarget methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryStatus)(IUrlHistoryNotify *This,
                                          const GUID *pguidCmdGroup,
                                          ULONG cCmds, OLECMD prgCmds[],
                                          OLECMDTEXT *pCmdText);
  HRESULT(STDMETHODCALLTYPE *Exec)(IUrlHistoryNotify *This,
                                   const GUID *pguidCmdGroup, DWORD nCmdID,
                                   DWORD nCmdexecopt, VARIANT *pvaIn,
                                   VARIANT *pvaOut);
  END_INTERFACE
} IUrlHistoryNotifyVtbl;
interface IUrlHistoryNotify { CONST_VTBL IUrlHistoryNotifyVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IOleCommandTarget methods ***/
#define IUrlHistoryNotify_QueryStatus(This, pguidCmdGroup, cCmds, prgCmds,     \
                                      pCmdText)                                \
...
#else
/*** IUnknown methods ***/
static inline HRESULT IUrlHistoryNotify_QueryInterface(IUrlHistoryNotify *This,
                                                       REFIID riid,
                                                       void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IOleCommandTarget methods ***/
static inline HRESULT IUrlHistoryNotify_QueryStatus(IUrlHistoryNotify *This,
                                                    const GUID *pguidCmdGroup,
                                                    ULONG cCmds,
                                                    OLECMD prgCmds[],
                                                    OLECMDTEXT *pCmdText) {
...
static inline HRESULT IUrlHistoryNotify_Exec(IUrlHistoryNotify *This,
                                             const GUID *pguidCmdGroup,
