...
#define DEFINE_PCI_ROOT_BUS_DEVPKEY(_DPKNAME, _PID)                            \
  DEFINE_DEVPROPKEY((_DPKNAME), 0xd817fc28, 0x793e, 0x4b9e, 0x99, 0x70, 0x46,  \
                    0x9d, 0x8b, 0xe6, 0x30, 0x73, (_PID))
#define DEFINE_PCI_DEVICE_DEVPKEY(_DPKNAME, _PID)                              \
  DEFINE_DEVPROPKEY((_DPKNAME), 0x3ab22e31, 0x8264, 0x4b4e, 0x9a, 0xf5, 0xa8,  \
                    0xd2, 0xd8, 0xe3, 0x3e, 0x62, (_PID))
...
DEFINE_PCI_ROOT_BUS_DEVPKEY(DEVPKEY_PciRootBus_ExtendedPCIConfigOpRegionSupport,
                            7);
...
DEFINE_PCI_ROOT_BUS_DEVPKEY(DEVPKEY_PciRootBus_PCIExpressNativeHotPlugControl,
                            12);
...
#define DevProp_PciDevice_NonPrefetchable_MemoryBarCount(_PD)                  \
  (((_PD) >> 8) & 0xff)
#define DevProp_PciDevice_32BitPrefetchable_MemoryBarCount(_PD)                \
  (((_PD) >> 16) & 0xff)
#define DevProp_PciDevice_64BitPrefetchable_MemoryBarCount(_PD)                \
  (((_PD) >> 24) & 0xff)
