...
#define NTDDI_VISTASP1 0x6000100
    ...
    (defined(NTDDI_VERSION) && NTDDI_VERSION >= NTDDI_VISTA)
...
#define IPROPNAME_ENFORCE_UPGRADE_COMPONENT_RULES                              \
  TEXT("MSIENFORCEUPGRADECOMPONENTRULES")
#define IPROPNAME_MSINEWINSTANCE TEXT("MSINEWINSTANCE")
#define IPROPNAME_MSIINSTANCEGUID TEXT("MSIINSTANCEGUID")
#define IPROPNAME_MSIPACKAGEDOWNLOADLOCALCOPY                                  \
  TEXT("MSIPACKAGEDOWNLOADLOCALCOPY")
...
#define IPROPNAME_PRIMARYFOLDER_SPACEAVAILABLE                                 \
  TEXT("PrimaryVolumeSpaceAvailable")
#define IPROPNAME_PRIMARYFOLDER_SPACEREQUIRED TEXT("PrimaryVolumeSpaceRequired")
#define IPROPNAME_PRIMARYFOLDER_SPACEREMAINING                                 \
  TEXT("PrimaryVolumeSpaceRemaining")
...
#define IPROPNAME_NTSUITESMALLBUSINESSRESTRICTED                               \
  TEXT("MsiNTSuiteSmallBusinessRestricted")
...
enum msidbControlAttributes {
  ...
  msidbControlAttributesBiDi = msidbControlAttributesRTLRO |
      msidbControlAttributesRightAligned | msidbControlAttributesLeftScroll,
...
enum msidbDialogAttributes {
  ...
  msidbDialogAttributesBiDi = msidbDialogAttributesRTLRO |
      msidbDialogAttributesRightAligned | msidbDialogAttributesLeftScroll,
...
#if (_WIN32_MSI >= 110)
enum msidbClassAttributes { msidbClassAttributesRelativePath = 0x00000001 };
#endif
...
#if _WIN32_MSI >= 400
enum msirbRebootType { msirbRebootImmediate = 1, msirbRebootDeferred = 2 };
