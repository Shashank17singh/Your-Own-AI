...
#define WINHTTP_CALLBACK_FLAG_GETPROXYFORURL_COMPLETE                          \
...
extern "C" {
#endif
WINHTTPAPI WINBOOL WINAPI WinHttpAddRequestHeaders(HINTERNET, LPCWSTR, DWORD,
                                                   DWORD);
...
WINHTTPAPI HINTERNET WINAPI WinHttpConnect(HINTERNET, LPCWSTR, INTERNET_PORT,
                                           DWORD);
WINHTTPAPI WINBOOL WINAPI WinHttpCrackUrl(LPCWSTR, DWORD, DWORD,
                                          LPURL_COMPONENTS);
WINHTTPAPI DWORD WINAPI WinHttpCreateProxyResolver(HINTERNET, HINTERNET *);
WINHTTPAPI WINBOOL WINAPI WinHttpCreateUrl(LPURL_COMPONENTS, DWORD, LPWSTR,
                                           LPDWORD);
...
WINHTTPAPI WINBOOL WINAPI WinHttpGetProxyForUrl(HINTERNET, LPCWSTR,
                                                WINHTTP_AUTOPROXY_OPTIONS *,
                                                WINHTTP_PROXY_INFO *);
WINHTTPAPI DWORD WINAPI WinHttpGetProxyForUrlEx(HINTERNET, PCWSTR,
                                                WINHTTP_AUTOPROXY_OPTIONS *,
                                                DWORD_PTR);
WINHTTPAPI DWORD WINAPI WinHttpGetProxyForUrlEx2(HINTERNET, PCWSTR,
                                                 WINHTTP_AUTOPROXY_OPTIONS *,
                                                 DWORD, BYTE *, DWORD_PTR);
WINHTTPAPI DWORD WINAPI WinHttpGetProxyResult(HINTERNET,
                                              WINHTTP_PROXY_RESULT *);
WINHTTPAPI DWORD WINAPI WinHttpGetProxyResultEx(HINTERNET,
                                                WINHTTP_PROXY_RESULT_EX *);
WINHTTPAPI DWORD WINAPI WinHttpGetProxySettingsVersion(HINTERNET, DWORD *);
WINHTTPAPI DWORD WINAPI
WinHttpIsHostInProxyBypassList(const WINHTTP_PROXY_INFO *, PCWSTR,
                               INTERNET_SCHEME, INTERNET_PORT, WINBOOL *);
WINHTTPAPI HINTERNET WINAPI WinHttpOpen(LPCWSTR, DWORD, LPCWSTR, LPCWSTR,
                                        DWORD);
WINHTTPAPI HINTERNET WINAPI WinHttpOpenRequest(HINTERNET, LPCWSTR, LPCWSTR,
                                               LPCWSTR, LPCWSTR, LPCWSTR *,
                                               DWORD);
WINHTTPAPI WINBOOL WINAPI WinHttpQueryAuthParams(HINTERNET, DWORD, LPVOID *);
WINHTTPAPI WINBOOL WINAPI WinHttpQueryAuthSchemes(HINTERNET, LPDWORD, LPDWORD,
                                                  LPDWORD);
WINHTTPAPI WINBOOL WINAPI WinHttpQueryDataAvailable(HINTERNET, LPDWORD);
WINHTTPAPI WINBOOL WINAPI WinHttpQueryHeaders(HINTERNET, DWORD, LPCWSTR, LPVOID,
                                              LPDWORD, LPDWORD);
...
WINHTTPAPI DWORD WINAPI WinHttpReadProxySettings(HINTERNET, PCWSTR, WINBOOL,
                                                 WINBOOL, DWORD *, WINBOOL *,
...
WINHTTPAPI WINBOOL WINAPI WinHttpSendRequest(HINTERNET, LPCWSTR, DWORD, LPVOID,
                                             DWORD, DWORD, DWORD_PTR);
WINHTTPAPI WINBOOL WINAPI
WinHttpSetDefaultProxyConfiguration(WINHTTP_PROXY_INFO *);
WINHTTPAPI WINBOOL WINAPI WinHttpSetCredentials(HINTERNET, DWORD, DWORD,
...
WINHTTPAPI HINTERNET WINAPI WinHttpWebSocketCompleteUpgrade(HINTERNET,
                                                            DWORD_PTR);
WINHTTPAPI DWORD WINAPI WinHttpWebSocketQueryCloseStatus(HINTERNET, USHORT *,
                                                         void *, DWORD,
                                                         DWORD *);
WINHTTPAPI DWORD WINAPI WinHttpWebSocketReceive(
    HINTERNET, void *, DWORD, DWORD *, WINHTTP_WEB_SOCKET_BUFFER_TYPE *);
WINHTTPAPI DWORD WINAPI WinHttpWebSocketSend(HINTERNET,
                                             WINHTTP_WEB_SOCKET_BUFFER_TYPE,
                                             void *, DWORD);
WINHTTPAPI DWORD WINAPI WinHttpWebSocketShutdown(HINTERNET, USHORT, void *,
                                                 DWORD);
WINHTTPAPI WINBOOL WINAPI WinHttpWriteData(HINTERNET, LPCVOID, DWORD, LPDWORD);
WINHTTPAPI DWORD WINAPI WinHttpWriteProxySettings(HINTERNET, WINBOOL,
                                                  WINHTTP_PROXY_SETTINGS *);
#ifdef __cplusplus
}
#endif
