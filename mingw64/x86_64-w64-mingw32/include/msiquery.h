...
extern "C" {
#endif
UINT WINAPI MsiDatabaseOpenViewA(MSIHANDLE hDatabase, LPCSTR szQuery,
                                 MSIHANDLE *phView);
UINT WINAPI MsiDatabaseOpenViewW(MSIHANDLE hDatabase, LPCWSTR szQuery,
                                 MSIHANDLE *phView);
#define MsiDatabaseOpenView __MINGW_NAME_AW(MsiDatabaseOpenView)
MSIDBERROR WINAPI MsiViewGetErrorA(MSIHANDLE hView, LPSTR szColumnNameBuffer,
                                   DWORD *pcchBuf);
MSIDBERROR WINAPI MsiViewGetErrorW(MSIHANDLE hView, LPWSTR szColumnNameBuffer,
                                   DWORD *pcchBuf);
...
UINT WINAPI MsiViewModify(MSIHANDLE hView, MSIMODIFY eModifyMode,
                          MSIHANDLE hRecord);
UINT WINAPI MsiViewGetColumnInfo(MSIHANDLE hView, MSICOLINFO eColumnInfo,
                                 MSIHANDLE *phRecord);
UINT WINAPI MsiViewClose(MSIHANDLE hView);
UINT WINAPI MsiDatabaseGetPrimaryKeysA(MSIHANDLE hDatabase, LPCSTR szTableName,
                                       MSIHANDLE *phRecord);
UINT WINAPI MsiDatabaseGetPrimaryKeysW(MSIHANDLE hDatabase, LPCWSTR szTableName,
                                       MSIHANDLE *phRecord);
...
MSICONDITION WINAPI MsiDatabaseIsTablePersistentW(MSIHANDLE hDatabase,
                                                  LPCWSTR szTableName);
#define MsiDatabaseIsTablePersistent                                           \
  __MINGW_NAME_AW(MsiDatabaseIsTablePersistent)
UINT WINAPI MsiGetSummaryInformationA(MSIHANDLE hDatabase,
                                      LPCSTR szDatabasePath, UINT uiUpdateCount,
...
UINT WINAPI MsiSummaryInfoSetPropertyA(MSIHANDLE hSummaryInfo, UINT uiProperty,
                                       ...
                                       FILETIME *pftValue, LPCSTR szValue);
UINT WINAPI MsiSummaryInfoSetPropertyW(MSIHANDLE hSummaryInfo, UINT uiProperty,
                                       UINT uiDataType, INT iValue,
                                       FILETIME *pftValue, LPCWSTR szValue);
#define MsiSummaryInfoSetProperty __MINGW_NAME_AW(MsiSummaryInfoSetProperty)
UINT WINAPI MsiSummaryInfoGetPropertyA(MSIHANDLE hSummaryInfo, UINT uiProperty,
                                       UINT *puiDataType, INT *piValue,
                                       FILETIME *pftValue, LPSTR szValueBuf,
                                       DWORD *pcchValueBuf);
UINT WINAPI MsiSummaryInfoGetPropertyW(MSIHANDLE hSummaryInfo, UINT uiProperty,
                                       UINT *puiDataType, INT *piValue,
...
UINT WINAPI MsiOpenDatabaseA(LPCSTR szDatabasePath, LPCSTR szPersist,
                             MSIHANDLE *phDatabase);
UINT WINAPI MsiOpenDatabaseW(LPCWSTR szDatabasePath, LPCWSTR szPersist,
                             MSIHANDLE *phDatabase);
#define MsiOpenDatabase __MINGW_NAME_AW(MsiOpenDatabase)
UINT WINAPI MsiDatabaseImportA(MSIHANDLE hDatabase, LPCSTR szFolderPath,
                               LPCSTR szFileName);
UINT WINAPI MsiDatabaseImportW(MSIHANDLE hDatabase, LPCWSTR szFolderPath,
                               LPCWSTR szFileName);
#define MsiDatabaseImport __MINGW_NAME_AW(MsiDatabaseImport)
UINT WINAPI MsiDatabaseExportA(MSIHANDLE hDatabase, LPCSTR szTableName,
                               LPCSTR szFolderPath, LPCSTR szFileName);
UINT WINAPI MsiDatabaseExportW(MSIHANDLE hDatabase, LPCWSTR szTableName,
...
UINT WINAPI MsiDatabaseGenerateTransformW(MSIHANDLE hDatabase,
                                          ...
                                          int iReserved1, int iReserved2);
#define MsiDatabaseGenerateTransform                                           \
  __MINGW_NAME_AW(MsiDatabaseGenerateTransform)
...
UINT WINAPI MsiCreateTransformSummaryInfoW(MSIHANDLE hDatabase,
                                           ...
                                           int iErrorConditions,
                                           int iValidation);
#define MsiCreateTransformSummaryInfo                                          \
  __MINGW_NAME_AW(MsiCreateTransformSummaryInfo)
...
UINT WINAPI MsiRecordReadStream(MSIHANDLE hRecord, UINT iField, char *szDataBuf,
                                DWORD *pcbDataBuf);
...
UINT WINAPI MsiRecordSetStringW(MSIHANDLE hRecord, UINT iField,
                                LPCWSTR szValue);
...
UINT WINAPI MsiRecordGetStringA(MSIHANDLE hRecord, UINT iField,
                                LPSTR szValueBuf, DWORD *pcchValueBuf);
UINT WINAPI MsiRecordGetStringW(MSIHANDLE hRecord, UINT iField,
                                LPWSTR szValueBuf, DWORD *pcchValueBuf);
...
UINT WINAPI MsiGetPropertyA(MSIHANDLE hInstall, LPCSTR szName, LPSTR szValueBuf,
                            DWORD *pcchValueBuf);
...
UINT WINAPI MsiFormatRecordA(MSIHANDLE hInstall, MSIHANDLE hRecord,
                             LPSTR szResultBuf, DWORD *pcchResultBuf);
UINT WINAPI MsiFormatRecordW(MSIHANDLE hInstall, MSIHANDLE hRecord,
                             LPWSTR szResultBuf, DWORD *pcchResultBuf);
...
UINT WINAPI MsiSequenceW(MSIHANDLE hInstall, LPCWSTR szTable,
                         INT iSequenceMode);
...
#if (_WIN32_MSI >= 110)
UINT WINAPI MsiSetFeatureAttributesA(MSIHANDLE hInstall, LPCSTR szFeature,
                                     DWORD dwAttributes);
UINT WINAPI MsiSetFeatureAttributesW(MSIHANDLE hInstall, LPCWSTR szFeature,
                                     DWORD dwAttributes);
...
#if (_WIN32_MSI >= 150)
UINT WINAPI MsiEnumComponentCostsA(MSIHANDLE hInstall, LPCSTR szComponent,
                                   DWORD dwIndex, INSTALLSTATE iState,
                                   LPSTR szDriveBuf, DWORD *pcchDriveBuf,
                                   INT *piCost, INT *piTempCost);
UINT WINAPI MsiEnumComponentCostsW(MSIHANDLE hInstall, LPCWSTR szComponent,
                                   DWORD dwIndex, INSTALLSTATE iState,
                                   LPWSTR szDriveBuf, DWORD *pcchDriveBuf,
                                   INT *piCost, INT *piTempCost);
