...
#define DBFLAGS_DEFAULT                                                        \
  (DBFLAGS_LAZYFLUSH | DBFLAGS_MAXCACHESIZEX100 |                              \
   DBFLAGS_CHECKPOINTDEPTH60MB | DBFLAGS_LOGBUFFERSHUGE)
...
#define wszREGENABLEENROLLEEREQUESTEXTENSIONLIST                               \
  TEXT("EnableEnrolleeRequestExtensionList")
...
#define EDITF_DEFAULT_STANDALONE                                               \
  (EDITF_REQUESTEXTENSIONLIST | EDITF_DISABLEEXTENSIONLIST |                   \
   EDITF_ADDOLDKEYUSAGE | EDITF_ATTRIBUTEENDDATE |                             \
   EDITF_BASICCONSTRAINTSCRITICAL | EDITF_BASICCONSTRAINTSCA |                 \
   EDITF_ENABLEAKIKEYID | EDITF_ATTRIBUTECA | EDITF_ATTRIBUTEEKU)
#define EDITF_DEFAULT_ENTERPRISE                                               \
  (EDITF_REQUESTEXTENSIONLIST | EDITF_DISABLEEXTENSIONLIST |                   \
   EDITF_ADDOLDKEYUSAGE | EDITF_BASICCONSTRAINTSCRITICAL |                     \
...
#define wszMICROSOFTCERTMODULE_PREFIX                                          \
  TEXT("CertificateAuthority_MicrosoftDefault")
...
#define wszCERTMANAGEPOLICY_POSTFIX                                            \
  wszCERTPOLICYMODULE_POSTFIX wszCERTMANAGE_SUFFIX
#define wszCLASS_CERTMANAGEEXITMODULE                                          \
  wszMICROSOFTCERTMODULE_PREFIX wszCERTMANAGEEXIT_POSTFIX
#define wszCLASS_CERTMANAGEPOLICYMODULE                                        \
  wszMICROSOFTCERTMODULE_PREFIX wszCERTMANAGEPOLICY_POSTFIX
#define wszCLASS_CERTEXIT                                                      \
  wszMICROSOFTCERTMODULE_PREFIX wszCERTEXITMODULE_POSTFIX
#define wszCLASS_CERTPOLICY                                                    \
  wszMICROSOFTCERTMODULE_PREFIX wszCERTPOLICYMODULE_POSTFIX
...
#define wszINFSECTION_APPLICATIONPOLICYSTATEMENT                               \
  L"ApplicationPolicyStatementExtension"
...
#define wszINFSECTION_APPLICATIONPOLICYMAPPINGS                                \
  L"ApplicationPolicyMappingsExtension"
#define wszINFSECTION_POLICYCONSTRAINTS L"PolicyConstraintsExtension"
#define wszINFSECTION_APPLICATIONPOLICYCONSTRAINTS                             \
  L"ApplicationPolicyConstraintsExtension"
...
#define wszPROPSUBJECTUNSTRUCTUREDADDRESS                                      \
  wszPROPSUBJECTDOT wszPROPUNSTRUCTUREDADDRESS
#define wszPROPSUBJECTDEVICESERIALNUMBER                                       \
  wszPROPSUBJECTDOT wszPROPDEVICESERIALNUMBER
