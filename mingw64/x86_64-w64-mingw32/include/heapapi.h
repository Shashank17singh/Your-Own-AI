...
WINBASEAPI WINBOOL WINAPI HeapValidate(HANDLE hHeap, DWORD dwFlags,
                                       LPCVOID lpMem);
WINBOOL WINAPI HeapSummary(HANDLE hHeap, DWORD dwFlags,
...
WINBASEAPI WINBOOL WINAPI HeapQueryInformation(
...
WINBASEAPI LPVOID WINAPI HeapReAlloc(HANDLE hHeap, DWORD dwFlags, LPVOID lpMem,
                                     SIZE_T dwBytes);
...
WINBASEAPI WINBOOL WINAPI HeapSetInformation(
    HANDLE HeapHandle, HEAP_INFORMATION_CLASS HeapInformationClass,
