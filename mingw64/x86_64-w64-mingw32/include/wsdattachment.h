...
DEFINE_GUID(IID_IWSDAttachment, 0x5d55a616, 0x9df8, 0x4b09, 0xb1, 0x56, 0x9b,
            0xa3, 0x51, 0xa4, 0x8b, 0x76);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("5d55a616-9df8-4b09-b156-9ba351a48b76")
IWSDAttachment : public IUnknown{};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IWSDAttachment, 0x5d55a616, 0x9df8, 0x4b09, 0xb1, 0x56, 0x9b,
                0xa3, 0x51, 0xa4, 0x8b, 0x76)
#endif
#else
typedef struct IWSDAttachmentVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWSDAttachment *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IWSDAttachment *This);
  ULONG(STDMETHODCALLTYPE *Release)(IWSDAttachment *This);
  END_INTERFACE
} IWSDAttachmentVtbl;
interface IWSDAttachment { CONST_VTBL IWSDAttachmentVtbl *lpVtbl; };
#ifdef COBJMACROS
...
#else
/*** IUnknown methods ***/
static inline HRESULT IWSDAttachment_QueryInterface(IWSDAttachment *This,
                                                    REFIID riid,
                                                    void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG IWSDAttachment_AddRef(IWSDAttachment *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG IWSDAttachment_Release(IWSDAttachment *This) {
...
DEFINE_GUID(IID_IWSDInboundAttachment, 0x5bd6ca65, 0x233c, 0x4fb8, 0x9f, 0x7a,
            0x26, 0x41, 0x61, 0x96, 0x55, 0xc9);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("5bd6ca65-233c-4fb8-9f7a-2641619655c9")
IWSDInboundAttachment : public IWSDAttachment {
  virtual HRESULT STDMETHODCALLTYPE Read(BYTE * pBuffer, DWORD dwBytesToRead,
                                         LPDWORD pdwNumberOfBytesRead) = 0;
  virtual HRESULT STDMETHODCALLTYPE Close() = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IWSDInboundAttachment, 0x5bd6ca65, 0x233c, 0x4fb8, 0x9f, 0x7a,
                0x26, 0x41, 0x61, 0x96, 0x55, 0xc9)
#endif
#else
typedef struct IWSDInboundAttachmentVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWSDInboundAttachment *This,
  ...
  HRESULT(STDMETHODCALLTYPE *Read)(IWSDInboundAttachment *This, BYTE *pBuffer,
                                   DWORD dwBytesToRead,
...
/*** IWSDInboundAttachment methods ***/
#define IWSDInboundAttachment_Read(This, pBuffer, dwBytesToRead,               \
...
IWSDInboundAttachment_QueryInterface(IWSDInboundAttachment *This, REFIID riid,
                                     void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG IWSDInboundAttachment_AddRef(IWSDInboundAttachment *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG IWSDInboundAttachment_Release(IWSDInboundAttachment *This) {
  return This->lpVtbl->Release(This);
}
/*** IWSDInboundAttachment methods ***/
static inline HRESULT IWSDInboundAttachment_Read(IWSDInboundAttachment *This,
                                                 BYTE *pBuffer,
                                                 DWORD dwBytesToRead,
                                                 LPDWORD pdwNumberOfBytesRead) {
  return This->lpVtbl->Read(This, pBuffer, dwBytesToRead, pdwNumberOfBytesRead);
}
static inline HRESULT IWSDInboundAttachment_Close(IWSDInboundAttachment *This) {
...
DEFINE_GUID(IID_IWSDOutboundAttachment, 0xaa302f8d, 0x5a22, 0x4ba5, 0xb3, 0x92,
            0xaa, 0x84, 0x86, 0xf4, 0xc1, 0x5d);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("aa302f8d-5a22-4ba5-b392-aa8486f4c15d")
IWSDOutboundAttachment : public IWSDAttachment {
  virtual HRESULT STDMETHODCALLTYPE Write(const BYTE *pBuffer,
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IWSDOutboundAttachment, 0xaa302f8d, 0x5a22, 0x4ba5, 0xb3, 0x92,
                0xaa, 0x84, 0x86, 0xf4, 0xc1, 0x5d)
#endif
#else
typedef struct IWSDOutboundAttachmentVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWSDOutboundAttachment *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *Write)(IWSDOutboundAttachment *This,
                                    const BYTE *pBuffer, DWORD dwBytesToWrite,
...
/*** IWSDOutboundAttachment methods ***/
#define IWSDOutboundAttachment_Write(This, pBuffer, dwBytesToWrite,            \
...
/*** IUnknown methods ***/
static inline HRESULT
IWSDOutboundAttachment_QueryInterface(IWSDOutboundAttachment *This, REFIID riid,
                                      void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IWSDOutboundAttachment_AddRef(IWSDOutboundAttachment *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IWSDOutboundAttachment_Release(IWSDOutboundAttachment *This) {
  return This->lpVtbl->Release(This);
}
/*** IWSDOutboundAttachment methods ***/
static inline HRESULT
IWSDOutboundAttachment_Write(IWSDOutboundAttachment *This, const BYTE *pBuffer,
                             DWORD dwBytesToWrite,
                             LPDWORD pdwNumberOfBytesWritten) {
  return This->lpVtbl->Write(This, pBuffer, dwBytesToWrite,
                             pdwNumberOfBytesWritten);
}
static inline HRESULT
IWSDOutboundAttachment_Close(IWSDOutboundAttachment *This) {
  return This->lpVtbl->Close(This);
}
static inline HRESULT
IWSDOutboundAttachment_Abort(IWSDOutboundAttachment *This) {
...
HRESULT
    WINAPI WSDCreateOutboundAttachment(IWSDOutboundAttachment **ppAttachment);
#endif
