...
DEFINE_GUID(IID_IXpsRasterizerNotificationCallback, 0x9ab8fd0d, 0xcb94, 0x49c2,
            0x9c, 0xb0, 0x97, 0xec, 0x1d, 0x54, 0x69, 0xd2);
...
__CRT_UUID_DECL(IXpsRasterizerNotificationCallback, 0x9ab8fd0d, 0xcb94, 0x49c2,
                0x9c, 0xb0, 0x97, 0xec, 0x1d, 0x54, 0x69, 0xd2)
#endif
#else
typedef struct IXpsRasterizerNotificationCallbackVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(
      IXpsRasterizerNotificationCallback *This, REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IXpsRasterizerNotificationCallback *This);
  ULONG(STDMETHODCALLTYPE *Release)(IXpsRasterizerNotificationCallback *This);
...
/*** IUnknown methods ***/
#define IXpsRasterizerNotificationCallback_QueryInterface(This, riid,          \
                                                          ppvObject)           \
...
#else
/*** IUnknown methods ***/
static inline HRESULT IXpsRasterizerNotificationCallback_QueryInterface(
    IXpsRasterizerNotificationCallback *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG IXpsRasterizerNotificationCallback_AddRef(
    IXpsRasterizerNotificationCallback *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG IXpsRasterizerNotificationCallback_Release(
    IXpsRasterizerNotificationCallback *This) {
  return This->lpVtbl->Release(This);
}
/*** IXpsRasterizerNotificationCallback methods ***/
static inline HRESULT IXpsRasterizerNotificationCallback_Continue(
    IXpsRasterizerNotificationCallback *This) {
...
DEFINE_GUID(IID_IXpsRasterizer, 0x7567cfc8, 0xc156, 0x47a8, 0x9d, 0xac, 0x11,
            0xa2, 0xae, 0x5b, 0xdd, 0x6b);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IXpsRasterizer : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE RasterizeRect(
      ...
      IWICBitmap * *bitmap) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetMinimalLineWidth(INT width) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsRasterizer, 0x7567cfc8, 0xc156, 0x47a8, 0x9d, 0xac, 0x11,
                0xa2, 0xae, 0x5b, 0xdd, 0x6b)
#endif
#else
typedef struct IXpsRasterizerVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsRasterizer *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IXpsRasterizer *This);
  ULONG(STDMETHODCALLTYPE *Release)(IXpsRasterizer *This);
  /*** IXpsRasterizer methods ***/
  HRESULT(STDMETHODCALLTYPE *RasterizeRect)(
      IXpsRasterizer *This, INT x, INT y, INT width, INT height,
      IXpsRasterizerNotificationCallback *notificationCallback,
      IWICBitmap **bitmap);
  HRESULT(STDMETHODCALLTYPE *SetMinimalLineWidth)(IXpsRasterizer *This,
                                                  INT width);
  END_INTERFACE
} IXpsRasterizerVtbl;
interface IXpsRasterizer { CONST_VTBL IXpsRasterizerVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IXpsRasterizer methods ***/
#define IXpsRasterizer_RasterizeRect(This, x, y, width, height,                \
                                     notificationCallback, bitmap)             \
  (This)->lpVtbl->RasterizeRect(This, x, y, width, height,                     \
                                notificationCallback, bitmap)
#define IXpsRasterizer_SetMinimalLineWidth(This, width)                        \
  (This)->lpVtbl->SetMinimalLineWidth(This, width)
#else
/*** IUnknown methods ***/
static inline HRESULT IXpsRasterizer_QueryInterface(IXpsRasterizer *This,
                                                    REFIID riid,
                                                    void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IXpsRasterizer methods ***/
static inline HRESULT IXpsRasterizer_RasterizeRect(
    IXpsRasterizer *This, INT x, INT y, INT width, INT height,
    IXpsRasterizerNotificationCallback *notificationCallback,
    IWICBitmap **bitmap) {
  return This->lpVtbl->RasterizeRect(This, x, y, width, height,
                                     notificationCallback, bitmap);
}
static inline HRESULT IXpsRasterizer_SetMinimalLineWidth(IXpsRasterizer *This,
                                                         INT width) {
...
DEFINE_GUID(IID_IXpsRasterizationFactory, 0xe094808a, 0x24c6, 0x482b, 0xa3,
            0xa7, 0xc2, 0x1a, 0xc9, 0xb5, 0x5f, 0x17);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
typedef struct IXpsRasterizationFactoryVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsRasterizationFactory *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IXpsRasterizationFactory *This);
  ULONG(STDMETHODCALLTYPE *Release)(IXpsRasterizationFactory *This);
  /*** IXpsRasterizationFactory methods ***/
  HRESULT(STDMETHODCALLTYPE *CreateRasterizer)(
      IXpsRasterizationFactory *This, IXpsOMPage *xpsPage, FLOAT DPI,
      XPSRAS_RENDERING_MODE nonTextRenderingMode,
      XPSRAS_RENDERING_MODE textRenderingMode,
...
/*** IXpsRasterizationFactory methods ***/
#define IXpsRasterizationFactory_CreateRasterizer(                             \
    This, xpsPage, DPI, nonTextRenderingMode, textRenderingMode,               \
    ppIXPSRasterizer)                                                          \
  (This)->lpVtbl->CreateRasterizer(This, xpsPage, DPI, nonTextRenderingMode,   \
                                   textRenderingMode, ppIXPSRasterizer)
#else
/*** IUnknown methods ***/
static inline HRESULT
IXpsRasterizationFactory_QueryInterface(IXpsRasterizationFactory *This,
                                        REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IXpsRasterizationFactory_AddRef(IXpsRasterizationFactory *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IXpsRasterizationFactory_Release(IXpsRasterizationFactory *This) {
  return This->lpVtbl->Release(This);
}
/*** IXpsRasterizationFactory methods ***/
static inline HRESULT IXpsRasterizationFactory_CreateRasterizer(
    IXpsRasterizationFactory *This, IXpsOMPage *xpsPage, FLOAT DPI,
    XPSRAS_RENDERING_MODE nonTextRenderingMode,
    XPSRAS_RENDERING_MODE textRenderingMode,
    IXpsRasterizer **ppIXPSRasterizer) {
  return This->lpVtbl->CreateRasterizer(This, xpsPage, DPI,
                                        nonTextRenderingMode, textRenderingMode,
                                        ppIXPSRasterizer);
}
#endif
#endif
...
DEFINE_GUID(IID_IXpsRasterizationFactory1, 0x2d6e5f77, 0x6414, 0x4a1e, 0xa8,
            0xe0, 0xd4, 0x19, 0x4c, 0xe6, 0xa2, 0x6f);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IXpsRasterizationFactory1, 0x2d6e5f77, 0x6414, 0x4a1e, 0xa8,
                0xe0, 0xd4, 0x19, 0x4c, 0xe6, 0xa2, 0x6f)
#endif
#else
typedef struct IXpsRasterizationFactory1Vtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IXpsRasterizationFactory1 *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IXpsRasterizationFactory1 *This);
  ULONG(STDMETHODCALLTYPE *Release)(IXpsRasterizationFactory1 *This);
  /*** IXpsRasterizationFactory1 methods ***/
  HRESULT(STDMETHODCALLTYPE *CreateRasterizer)(
      IXpsRasterizationFactory1 *This, IXpsOMPage *xpsPage, FLOAT DPI,
      XPSRAS_RENDERING_MODE nonTextRenderingMode,
      XPSRAS_RENDERING_MODE textRenderingMode, XPSRAS_PIXEL_FORMAT pixelFormat,
      IXpsRasterizer **ppIXPSRasterizer);
  END_INTERFACE
...
#define IXpsRasterizationFactory1_CreateRasterizer(                            \
    ...
    ppIXPSRasterizer)                                                          \
  (This)->lpVtbl->CreateRasterizer(This, xpsPage, DPI, nonTextRenderingMode,   \
                                   textRenderingMode, pixelFormat,             \
                                   ppIXPSRasterizer)
#else
/*** IUnknown methods ***/
static inline HRESULT
IXpsRasterizationFactory1_QueryInterface(IXpsRasterizationFactory1 *This,
                                         REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IXpsRasterizationFactory1_AddRef(IXpsRasterizationFactory1 *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IXpsRasterizationFactory1_Release(IXpsRasterizationFactory1 *This) {
  return This->lpVtbl->Release(This);
}
/*** IXpsRasterizationFactory1 methods ***/
static inline HRESULT IXpsRasterizationFactory1_CreateRasterizer(
    IXpsRasterizationFactory1 *This, IXpsOMPage *xpsPage, FLOAT DPI,
    XPSRAS_RENDERING_MODE nonTextRenderingMode,
    XPSRAS_RENDERING_MODE textRenderingMode, XPSRAS_PIXEL_FORMAT pixelFormat,
    IXpsRasterizer **ppIXPSRasterizer) {
