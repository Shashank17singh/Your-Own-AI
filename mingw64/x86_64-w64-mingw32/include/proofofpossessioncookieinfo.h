/*** Autogenerated by WIDL 11.5 from include/proofofpossessioncookieinfo.idl -
 * Do not edit ***/
#ifdef _WIN32
...
typedef interface IProofOfPossessionCookieInfoManager
...
#ifdef __cplusplus
typedef class ProofOfPossessionCookieInfoManager
    ProofOfPossessionCookieInfoManager;
#else
typedef struct ProofOfPossessionCookieInfoManager
    ProofOfPossessionCookieInfoManager;
...
static inline void
FreeProofOfPossessionCookieInfoArray(ProofOfPossessionCookieInfo *cookie_info,
                                     DWORD count) {
  unsigned int i;
  for (i = 0; i < count; i++) {
...
DEFINE_GUID(IID_IProofOfPossessionCookieInfoManager, 0xcdaece56, 0x4edf, 0x43df,
...
IProofOfPossessionCookieInfoManager : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetCookieInfoForUri(
      LPCWSTR uri, DWORD * cookieInfoCount,
      ProofOfPossessionCookieInfo * *cookieInfo) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IProofOfPossessionCookieInfoManager, 0xcdaece56, 0x4edf, 0x43df,
                0xb1, 0x13, 0x88, 0xe4, 0x55, 0x6f, 0xa1, 0xbb)
#endif
#else
typedef struct IProofOfPossessionCookieInfoManagerVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(
      IProofOfPossessionCookieInfoManager *This, REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetCookieInfoForUri)(
      IProofOfPossessionCookieInfoManager *This, LPCWSTR uri,
      DWORD *cookieInfoCount, ProofOfPossessionCookieInfo **cookieInfo);
  END_INTERFACE
...
/*** IUnknown methods ***/
#define IProofOfPossessionCookieInfoManager_QueryInterface(This, riid,         \
                                                           ppvObject)          \
...
/*** IProofOfPossessionCookieInfoManager methods ***/
#define IProofOfPossessionCookieInfoManager_GetCookieInfoForUri(               \
    This, uri, cookieInfoCount, cookieInfo)                                    \
  (This)->lpVtbl->GetCookieInfoForUri(This, uri, cookieInfoCount, cookieInfo)
#else
/*** IUnknown methods ***/
static inline HRESULT IProofOfPossessionCookieInfoManager_QueryInterface(
    IProofOfPossessionCookieInfoManager *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG IProofOfPossessionCookieInfoManager_AddRef(
    IProofOfPossessionCookieInfoManager *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG IProofOfPossessionCookieInfoManager_Release(
    IProofOfPossessionCookieInfoManager *This) {
  return This->lpVtbl->Release(This);
}
/*** IProofOfPossessionCookieInfoManager methods ***/
static inline HRESULT IProofOfPossessionCookieInfoManager_GetCookieInfoForUri(
    IProofOfPossessionCookieInfoManager *This, LPCWSTR uri,
    DWORD *cookieInfoCount, ProofOfPossessionCookieInfo **cookieInfo) {
  return This->lpVtbl->GetCookieInfoForUri(This, uri, cookieInfoCount,
                                           cookieInfo);
}
#endif
#endif
...
DEFINE_GUID(LIBID_ProofOfPossessionCookieInfoManagerLib, 0x7681a019, 0x8f51,
            0x4594, 0x95, 0x07, 0xf2, 0x70, 0x40, 0xf7, 0x1f, 0x01);
/*****************************************************************************
 * ProofOfPossessionCookieInfoManager coclass
 */
DEFINE_GUID(CLSID_ProofOfPossessionCookieInfoManager, 0xa9927f85, 0xa304,
            0x4390, 0x8b, 0x23, 0xa7, 0x5f, 0x1c, 0x66, 0x86, 0x00);
#ifdef __cplusplus
class DECLSPEC_UUID("a9927f85-a304-4390-8b23-a75f1c668600")
    ProofOfPossessionCookieInfoManager;
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ProofOfPossessionCookieInfoManager, 0xa9927f85, 0xa304, 0x4390,
