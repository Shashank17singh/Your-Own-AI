...
DEFINE_GUID(IID_IAdvancedMediaCaptureInitializationSettings, 0x3de21209, 0x8ba6,
            0x4f2a, 0xa5, 0x77, 0x28, 0x19, 0xb5, 0x6f, 0xf1, 0x4d);
...
__CRT_UUID_DECL(IAdvancedMediaCaptureInitializationSettings, 0x3de21209, 0x8ba6,
                0x4f2a, 0xa5, 0x77, 0x28, 0x19, 0xb5, 0x6f, 0xf1, 0x4d)
#endif
#else
typedef struct IAdvancedMediaCaptureInitializationSettingsVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(
      IAdvancedMediaCaptureInitializationSettings *This, REFIID riid,
      void **ppvObject);
...
/*** IUnknown methods ***/
#define IAdvancedMediaCaptureInitializationSettings_QueryInterface(This, riid, \
                                                                   ppvObject)  \
...
/*** IAdvancedMediaCaptureInitializationSettings methods ***/
#define IAdvancedMediaCaptureInitializationSettings_SetDirectxDeviceManager(   \
    This, pManager)                                                            \
  (This)->lpVtbl->SetDirectxDeviceManager(This, pManager)
#else
/*** IUnknown methods ***/
static inline HRESULT
IAdvancedMediaCaptureInitializationSettings_QueryInterface(
    IAdvancedMediaCaptureInitializationSettings *This, REFIID riid,
    void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG IAdvancedMediaCaptureInitializationSettings_AddRef(
    IAdvancedMediaCaptureInitializationSettings *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG IAdvancedMediaCaptureInitializationSettings_Release(
    IAdvancedMediaCaptureInitializationSettings *This) {
  return This->lpVtbl->Release(This);
}
/*** IAdvancedMediaCaptureInitializationSettings methods ***/
static inline HRESULT
IAdvancedMediaCaptureInitializationSettings_SetDirectxDeviceManager(
    IAdvancedMediaCaptureInitializationSettings *This,
    IMFDXGIDeviceManager *pManager) {
...
DEFINE_GUID(IID_IAdvancedMediaCaptureSettings, 0x24e0485f, 0xa33e, 0x4aa1, 0xb5,
            0x64, 0x60, 0x19, 0xb1, 0xd1, 0x4f, 0x65);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IAdvancedMediaCaptureSettings, 0x24e0485f, 0xa33e, 0x4aa1, 0xb5,
                0x64, 0x60, 0x19, 0xb1, 0xd1, 0x4f, 0x65)
#endif
#else
typedef struct IAdvancedMediaCaptureSettingsVtbl {
  ...
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(
      IAdvancedMediaCaptureSettings *This, REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IAdvancedMediaCaptureSettings *This);
  ULONG(STDMETHODCALLTYPE *Release)(IAdvancedMediaCaptureSettings *This);
  /*** IAdvancedMediaCaptureSettings methods ***/
  HRESULT(STDMETHODCALLTYPE *GetDirectxDeviceManager)(
      IAdvancedMediaCaptureSettings *This, IMFDXGIDeviceManager **ppManager);
  END_INTERFACE
...
#define IAdvancedMediaCaptureSettings_Release(This)                            \
  (This)->lpVtbl->Release(This)
/*** IAdvancedMediaCaptureSettings methods ***/
#define IAdvancedMediaCaptureSettings_GetDirectxDeviceManager(This, ppManager) \
  (This)->lpVtbl->GetDirectxDeviceManager(This, ppManager)
#else
/*** IUnknown methods ***/
static inline HRESULT IAdvancedMediaCaptureSettings_QueryInterface(
    IAdvancedMediaCaptureSettings *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IAdvancedMediaCaptureSettings_AddRef(IAdvancedMediaCaptureSettings *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IAdvancedMediaCaptureSettings_Release(IAdvancedMediaCaptureSettings *This) {
  return This->lpVtbl->Release(This);
}
/*** IAdvancedMediaCaptureSettings methods ***/
...
DEFINE_GUID(IID_IAdvancedMediaCapture, 0xd0751585, 0xd216, 0x4344, 0xb5, 0xbf,
            0x46, 0x3b, 0x68, 0xf9, 0x77, 0xbb);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IAdvancedMediaCapture, 0xd0751585, 0xd216, 0x4344, 0xb5, 0xbf,
                0x46, 0x3b, 0x68, 0xf9, 0x77, 0xbb)
#endif
#else
typedef struct IAdvancedMediaCaptureVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAdvancedMediaCapture *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IAdvancedMediaCapture *This);
  ULONG(STDMETHODCALLTYPE *Release)(IAdvancedMediaCapture *This);
  /*** IAdvancedMediaCapture methods ***/
  HRESULT(STDMETHODCALLTYPE *GetAdvancedMediaCaptureSettings)(
      IAdvancedMediaCapture *This, IAdvancedMediaCaptureSettings **ppSettings);
  END_INTERFACE
...
/*** IAdvancedMediaCapture methods ***/
#define IAdvancedMediaCapture_GetAdvancedMediaCaptureSettings(This,            \
                                                              ppSettings)      \
  (This)->lpVtbl->GetAdvancedMediaCaptureSettings(This, ppSettings)
#else
/*** IUnknown methods ***/
static inline HRESULT
IAdvancedMediaCapture_QueryInterface(IAdvancedMediaCapture *This, REFIID riid,
                                     void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IAdvancedMediaCapture methods ***/
static inline HRESULT IAdvancedMediaCapture_GetAdvancedMediaCaptureSettings(
    IAdvancedMediaCapture *This, IAdvancedMediaCaptureSettings **ppSettings) {
