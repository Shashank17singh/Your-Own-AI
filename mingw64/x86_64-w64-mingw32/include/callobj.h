...
public:
  ...
  virtual HRESULT WINAPI GetNames(LPWSTR *pwszInterface,
                                  LPWSTR *pwszMethod) = 0;
  ...
  virtual HRESULT WINAPI GetParamInfo(ULONG iparam,
  ...
  virtual HRESULT WINAPI Copy(CALLFRAME_COPY copyControl,
                              ICallFrameWalker *pWalker,
                              ICallFrame **ppFrame) = 0;
  virtual HRESULT WINAPI Free(ICallFrame *pframeArgsDest,
                              ICallFrameWalker *pWalkerDestFree,
                              ICallFrameWalker *pWalkerCopy, DWORD freeFlags,
                              ICallFrameWalker *pWalkerFree,
                              DWORD nullFlags) = 0;
  virtual HRESULT WINAPI FreeParam(ULONG iparam, DWORD freeFlags,
                                   ICallFrameWalker *pWalkerFree,
                                   DWORD nullFlags) = 0;
  virtual HRESULT WINAPI WalkFrame(DWORD walkWhat,
                                   ICallFrameWalker *pWalker) = 0;
  virtual HRESULT WINAPI
  GetMarshalSizeMax(CALLFRAME_MARSHALCONTEXT *pmshlContext, MSHLFLAGS mshlflags,
                    ULONG *pcbBufferNeeded) = 0;
  virtual HRESULT WINAPI Marshal(CALLFRAME_MARSHALCONTEXT *pmshlContext,
                                 MSHLFLAGS mshlflags, PVOID pBuffer,
                                 ULONG cbBuffer, ULONG *pcbBufferUsed,
                                 RPCOLEDATAREP *pdataRep, ULONG *prpcFlags) = 0;
  virtual HRESULT WINAPI Unmarshal(PVOID pBuffer, ULONG cbBuffer,
                                   RPCOLEDATAREP dataRep,
                                   CALLFRAME_MARSHALCONTEXT *pcontext,
                                   ULONG *pcbUnmarshalled) = 0;
  virtual HRESULT WINAPI ReleaseMarshalData(
      PVOID pBuffer, ULONG cbBuffer, ULONG ibFirstRelease,
      RPCOLEDATAREP dataRep, CALLFRAME_MARSHALCONTEXT *pcontext) = 0;
  virtual HRESULT WINAPI Invoke(void *pvReceiver, ...) = 0;
};
#else
typedef struct ICallFrameVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ICallFrame *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetIIDAndMethod)(ICallFrame *This, IID *pIID,
                                   ULONG *piMethod);
  HRESULT(WINAPI *GetNames)(ICallFrame *This, LPWSTR *pwszInterface,
                            LPWSTR *pwszMethod);
  ...
  HRESULT(WINAPI *GetParamInfo)(ICallFrame *This, ULONG iparam,
  ...
  HRESULT(WINAPI *Copy)(ICallFrame *This, CALLFRAME_COPY copyControl,
                        ICallFrameWalker *pWalker, ICallFrame **ppFrame);
  HRESULT(WINAPI *Free)(ICallFrame *This, ICallFrame *pframeArgsDest,
                        ICallFrameWalker *pWalkerDestFree,
                        ICallFrameWalker *pWalkerCopy, DWORD freeFlags,
                        ICallFrameWalker *pWalkerFree, DWORD nullFlags);
  HRESULT(WINAPI *FreeParam)(ICallFrame *This, ULONG iparam, DWORD freeFlags,
                             ICallFrameWalker *pWalkerFree, DWORD nullFlags);
  HRESULT(WINAPI *WalkFrame)(ICallFrame *This, DWORD walkWhat,
                             ICallFrameWalker *pWalker);
  HRESULT(WINAPI *GetMarshalSizeMax)(ICallFrame *This,
                                     CALLFRAME_MARSHALCONTEXT *pmshlContext,
                                     MSHLFLAGS mshlflags,
                                     ULONG *pcbBufferNeeded);
  HRESULT(WINAPI *Marshal)(ICallFrame *This,
                           CALLFRAME_MARSHALCONTEXT *pmshlContext,
                           MSHLFLAGS mshlflags, PVOID pBuffer, ULONG cbBuffer,
                           ULONG *pcbBufferUsed, RPCOLEDATAREP *pdataRep,
                           ULONG *prpcFlags);
  HRESULT(WINAPI *Unmarshal)(ICallFrame *This, PVOID pBuffer, ULONG cbBuffer,
                             RPCOLEDATAREP dataRep,
                             CALLFRAME_MARSHALCONTEXT *pcontext,
                             ULONG *pcbUnmarshalled);
  HRESULT(WINAPI *ReleaseMarshalData)(ICallFrame *This, PVOID pBuffer,
                                      ULONG cbBuffer, ULONG ibFirstRelease,
                                      RPCOLEDATAREP dataRep,
                                      CALLFRAME_MARSHALCONTEXT *pcontext);
...
#define ICallFrame_Free(This, pframeArgsDest, pWalkerDestFree, pWalkerCopy,    \
                        freeFlags, pWalkerFree, nullFlags)                     \
  (This)->lpVtbl->Free(This, pframeArgsDest, pWalkerDestFree, pWalkerCopy,     \
                       freeFlags, pWalkerFree, nullFlags)
...
#define ICallFrame_GetMarshalSizeMax(This, pmshlContext, mshlflags,            \
                                     pcbBufferNeeded)                          \
  (This)->lpVtbl->GetMarshalSizeMax(This, pmshlContext, mshlflags,             \
                                    pcbBufferNeeded)
#define ICallFrame_Marshal(This, pmshlContext, mshlflags, pBuffer, cbBuffer,   \
                           pcbBufferUsed, pdataRep, prpcFlags)                 \
  (This)->lpVtbl->Marshal(This, pmshlContext, mshlflags, pBuffer, cbBuffer,    \
                          pcbBufferUsed, pdataRep, prpcFlags)
#define ICallFrame_Unmarshal(This, pBuffer, cbBuffer, dataRep, pcontext,       \
                             pcbUnmarshalled)                                  \
  (This)->lpVtbl->Unmarshal(This, pBuffer, cbBuffer, dataRep, pcontext,        \
                            pcbUnmarshalled)
#define ICallFrame_ReleaseMarshalData(This, pBuffer, cbBuffer, ibFirstRelease, \
                                      dataRep, pcontext)                       \
  (This)->lpVtbl->ReleaseMarshalData(This, pBuffer, cbBuffer, ibFirstRelease,  \
                                     dataRep, pcontext)
...
void __RPC_STUB ICallFrame_GetInfo_Stub(IRpcStubBuffer *This,
                                        IRpcChannelBuffer *_pRpcChannelBuffer,
                                        PRPC_MESSAGE _pRpcMessage,
                                        DWORD *_pdwStubPhase);
HRESULT WINAPI ICallFrame_GetIIDAndMethod_Proxy(ICallFrame *This, IID *pIID,
                                                ULONG *piMethod);
...
HRESULT WINAPI ICallFrame_GetNames_Proxy(ICallFrame *This,
                                         LPWSTR *pwszInterface,
                                         LPWSTR *pwszMethod);
void __RPC_STUB ICallFrame_GetNames_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
...
void __RPC_STUB ICallFrame_GetReturnValue_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICallFrame_GetParamInfo_Proxy(ICallFrame *This, ULONG iparam,
                                             CALLFRAMEPARAMINFO *pInfo);
void __RPC_STUB ICallFrame_GetParamInfo_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICallFrame_SetParam_Proxy(ICallFrame *This, ULONG iparam,
                                         VARIANT *pvar);
void __RPC_STUB ICallFrame_SetParam_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
HRESULT WINAPI ICallFrame_GetParam_Proxy(ICallFrame *This, ULONG iparam,
                                         VARIANT *pvar);
void __RPC_STUB ICallFrame_GetParam_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
HRESULT WINAPI ICallFrame_Copy_Proxy(ICallFrame *This,
                                     CALLFRAME_COPY copyControl,
                                     ICallFrameWalker *pWalker,
                                     ICallFrame **ppFrame);
void __RPC_STUB ICallFrame_Copy_Stub(IRpcStubBuffer *This,
                                     IRpcChannelBuffer *_pRpcChannelBuffer,
                                     PRPC_MESSAGE _pRpcMessage,
                                     DWORD *_pdwStubPhase);
HRESULT WINAPI ICallFrame_Free_Proxy(
    ICallFrame *This, ICallFrame *pframeArgsDest,
    ICallFrameWalker *pWalkerDestFree, ICallFrameWalker *pWalkerCopy,
    DWORD freeFlags, ICallFrameWalker *pWalkerFree, DWORD nullFlags);
void __RPC_STUB ICallFrame_Free_Stub(IRpcStubBuffer *This,
                                     IRpcChannelBuffer *_pRpcChannelBuffer,
                                     PRPC_MESSAGE _pRpcMessage,
                                     DWORD *_pdwStubPhase);
HRESULT WINAPI ICallFrame_FreeParam_Proxy(ICallFrame *This, ULONG iparam,
                                          DWORD freeFlags,
                                          ICallFrameWalker *pWalkerFree,
                                          DWORD nullFlags);
void __RPC_STUB ICallFrame_FreeParam_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI ICallFrame_WalkFrame_Proxy(ICallFrame *This, DWORD walkWhat,
                                          ICallFrameWalker *pWalker);
void __RPC_STUB ICallFrame_WalkFrame_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI ICallFrame_GetMarshalSizeMax_Proxy(
    ICallFrame *This, CALLFRAME_MARSHALCONTEXT *pmshlContext,
    MSHLFLAGS mshlflags, ULONG *pcbBufferNeeded);
void __RPC_STUB ICallFrame_GetMarshalSizeMax_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICallFrame_Marshal_Proxy(ICallFrame *This,
                                        CALLFRAME_MARSHALCONTEXT *pmshlContext,
                                        MSHLFLAGS mshlflags, PVOID pBuffer,
                                        ULONG cbBuffer, ULONG *pcbBufferUsed,
                                        RPCOLEDATAREP *pdataRep,
                                        ULONG *prpcFlags);
void __RPC_STUB ICallFrame_Marshal_Stub(IRpcStubBuffer *This,
                                        IRpcChannelBuffer *_pRpcChannelBuffer,
                                        PRPC_MESSAGE _pRpcMessage,
                                        DWORD *_pdwStubPhase);
HRESULT WINAPI ICallFrame_Unmarshal_Proxy(ICallFrame *This, PVOID pBuffer,
                                          ULONG cbBuffer, RPCOLEDATAREP dataRep,
                                          CALLFRAME_MARSHALCONTEXT *pcontext,
                                          ULONG *pcbUnmarshalled);
void __RPC_STUB ICallFrame_Unmarshal_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI ICallFrame_ReleaseMarshalData_Proxy(
    ICallFrame *This, PVOID pBuffer, ULONG cbBuffer, ULONG ibFirstRelease,
    RPCOLEDATAREP dataRep, CALLFRAME_MARSHALCONTEXT *pcontext);
void __RPC_STUB ICallFrame_ReleaseMarshalData_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICallFrame_Invoke_Proxy(ICallFrame *This, void *pvReceiver, ...);
void __RPC_STUB ICallFrame_Invoke_Stub(IRpcStubBuffer *This,
                                       IRpcChannelBuffer *_pRpcChannelBuffer,
                                       PRPC_MESSAGE _pRpcMessage,
                                       DWORD *_pdwStubPhase);
#endif
...
public:
  virtual HRESULT WINAPI CallIndirect(HRESULT *phrReturn, ULONG iMethod,
                                      void *pvArgs, ULONG *cbArgs) = 0;
  virtual HRESULT WINAPI GetMethodInfo(ULONG iMethod, CALLFRAMEINFO *pInfo,
                                       LPWSTR *pwszMethod) = 0;
  virtual HRESULT WINAPI GetStackSize(ULONG iMethod, ULONG *cbArgs) = 0;
  virtual HRESULT WINAPI GetIID(IID *piid, WINBOOL *pfDerivesFromIDispatch,
                                ULONG *pcMethod, LPWSTR *pwszInterface) = 0;
};
#else
typedef struct ICallIndirectVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ICallIndirect *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ICallIndirect *This);
  ULONG(WINAPI *Release)(ICallIndirect *This);
  HRESULT(WINAPI *CallIndirect)(ICallIndirect *This, HRESULT *phrReturn,
                                ULONG iMethod, void *pvArgs, ULONG *cbArgs);
  HRESULT(WINAPI *GetMethodInfo)(ICallIndirect *This, ULONG iMethod,
                                 CALLFRAMEINFO *pInfo, LPWSTR *pwszMethod);
  HRESULT(WINAPI *GetStackSize)(ICallIndirect *This, ULONG iMethod,
                                ULONG *cbArgs);
  HRESULT(WINAPI *GetIID)(ICallIndirect *This, IID *piid,
                          WINBOOL *pfDerivesFromIDispatch, ULONG *pcMethod,
                          LPWSTR *pwszInterface);
  END_INTERFACE
} ICallIndirectVtbl;
...
#define ICallIndirect_GetIID(This, piid, pfDerivesFromIDispatch, pcMethod,     \
                             pwszInterface)                                    \
  (This)->lpVtbl->GetIID(This, piid, pfDerivesFromIDispatch, pcMethod,         \
                         pwszInterface)
#endif
#endif
HRESULT WINAPI ICallIndirect_CallIndirect_Proxy(ICallIndirect *This,
                                                HRESULT *phrReturn,
                                                ULONG iMethod, void *pvArgs,
                                                ULONG *cbArgs);
void __RPC_STUB ICallIndirect_CallIndirect_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICallIndirect_GetMethodInfo_Proxy(ICallIndirect *This,
                                                 ULONG iMethod,
                                                 CALLFRAMEINFO *pInfo,
                                                 LPWSTR *pwszMethod);
void __RPC_STUB ICallIndirect_GetMethodInfo_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICallIndirect_GetStackSize_Proxy(ICallIndirect *This,
                                                ULONG iMethod, ULONG *cbArgs);
void __RPC_STUB ICallIndirect_GetStackSize_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICallIndirect_GetIID_Proxy(ICallIndirect *This, IID *piid,
                                          WINBOOL *pfDerivesFromIDispatch,
                                          ULONG *pcMethod,
                                          LPWSTR *pwszInterface);
void __RPC_STUB ICallIndirect_GetIID_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
#endif
...
typedef struct ICallInterceptorVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ICallInterceptor *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ICallInterceptor *This);
  ULONG(WINAPI *Release)(ICallInterceptor *This);
  HRESULT(WINAPI *CallIndirect)(ICallInterceptor *This, HRESULT *phrReturn,
                                ULONG iMethod, void *pvArgs, ULONG *cbArgs);
  HRESULT(WINAPI *GetMethodInfo)(ICallInterceptor *This, ULONG iMethod,
                                 CALLFRAMEINFO *pInfo, LPWSTR *pwszMethod);
  HRESULT(WINAPI *GetStackSize)(ICallInterceptor *This, ULONG iMethod,
                                ULONG *cbArgs);
  HRESULT(WINAPI *GetIID)(ICallInterceptor *This, IID *piid,
                          WINBOOL *pfDerivesFromIDispatch, ULONG *pcMethod,
                          LPWSTR *pwszInterface);
  HRESULT(WINAPI *RegisterSink)(ICallInterceptor *This,
                                ICallFrameEvents *psink);
  HRESULT(WINAPI *GetRegisteredSink)(ICallInterceptor *This,
...
#define ICallInterceptor_CallIndirect(This, phrReturn, iMethod, pvArgs,        \
                                      cbArgs)                                  \
  (This)->lpVtbl->CallIndirect(This, phrReturn, iMethod, pvArgs, cbArgs)
...
#define ICallInterceptor_GetStackSize(This, iMethod, cbArgs)                   \
  (This)->lpVtbl->GetStackSize(This, iMethod, cbArgs)
#define ICallInterceptor_GetIID(This, piid, pfDerivesFromIDispatch, pcMethod,  \
                                pwszInterface)                                 \
  (This)->lpVtbl->GetIID(This, piid, pfDerivesFromIDispatch, pcMethod,         \
                         pwszInterface)
...
#endif
#endif
HRESULT WINAPI ICallInterceptor_RegisterSink_Proxy(ICallInterceptor *This,
                                                   ICallFrameEvents *psink);
void __RPC_STUB ICallInterceptor_RegisterSink_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICallInterceptor_GetRegisteredSink_Proxy(
    ICallInterceptor *This, ICallFrameEvents **ppsink);
...
typedef struct ICallFrameEventsVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ICallFrameEvents *This, REFIID riid,
                                  void **ppvObject);
...
#endif
#endif
HRESULT WINAPI ICallFrameEvents_OnCall_Proxy(ICallFrameEvents *This,
                                             ICallFrame *pFrame);
...
public:
  virtual HRESULT WINAPI Unmarshal(ULONG iMethod, PVOID pBuffer, ULONG cbBuffer,
                                   WINBOOL fForceBufferCopy,
                                   RPCOLEDATAREP dataRep,
                                   CALLFRAME_MARSHALCONTEXT *pcontext,
                                   ULONG *pcbUnmarshalled,
                                   ICallFrame **ppFrame) = 0;
  virtual HRESULT WINAPI ReleaseMarshalData(
      ULONG iMethod, PVOID pBuffer, ULONG cbBuffer, ULONG ibFirstRelease,
      RPCOLEDATAREP dataRep, CALLFRAME_MARSHALCONTEXT *pcontext) = 0;
};
#else
typedef struct ICallUnmarshalVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ICallUnmarshal *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ICallUnmarshal *This);
  ULONG(WINAPI *Release)(ICallUnmarshal *This);
  HRESULT(WINAPI *Unmarshal)(ICallUnmarshal *This, ULONG iMethod, PVOID pBuffer,
                             ULONG cbBuffer, WINBOOL fForceBufferCopy,
                             RPCOLEDATAREP dataRep,
                             CALLFRAME_MARSHALCONTEXT *pcontext,
                             ULONG *pcbUnmarshalled, ICallFrame **ppFrame);
  HRESULT(WINAPI *ReleaseMarshalData)(ICallUnmarshal *This, ULONG iMethod,
                                      PVOID pBuffer, ULONG cbBuffer,
...
#define ICallUnmarshal_Unmarshal(This, iMethod, pBuffer, cbBuffer,             \
                                 fForceBufferCopy, dataRep, pcontext,          \
                                 pcbUnmarshalled, ppFrame)                     \
  (This)->lpVtbl->Unmarshal(This, iMethod, pBuffer, cbBuffer,                  \
                            fForceBufferCopy, dataRep, pcontext,               \
                            pcbUnmarshalled, ppFrame)
#define ICallUnmarshal_ReleaseMarshalData(This, iMethod, pBuffer, cbBuffer,    \
                                          ibFirstRelease, dataRep, pcontext)   \
  (This)->lpVtbl->ReleaseMarshalData(This, iMethod, pBuffer, cbBuffer,         \
                                     ibFirstRelease, dataRep, pcontext)
#endif
#endif
HRESULT WINAPI ICallUnmarshal_Unmarshal_Proxy(
    ICallUnmarshal *This, ULONG iMethod, PVOID pBuffer, ULONG cbBuffer,
    WINBOOL fForceBufferCopy, RPCOLEDATAREP dataRep,
    CALLFRAME_MARSHALCONTEXT *pcontext, ULONG *pcbUnmarshalled,
    ICallFrame **ppFrame);
void __RPC_STUB ICallUnmarshal_Unmarshal_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ICallUnmarshal_ReleaseMarshalData_Proxy(
    ICallUnmarshal *This, ULONG iMethod, PVOID pBuffer, ULONG cbBuffer,
    ULONG ibFirstRelease, RPCOLEDATAREP dataRep,
    CALLFRAME_MARSHALCONTEXT *pcontext);
...
public:
  virtual HRESULT WINAPI OnWalkInterface(REFIID iid, PVOID *ppvInterface,
                                         WINBOOL fIn, WINBOOL fOut) = 0;
};
#else
typedef struct ICallFrameWalkerVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ICallFrameWalker *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ICallFrameWalker *This);
  ULONG(WINAPI *Release)(ICallFrameWalker *This);
  HRESULT(WINAPI *OnWalkInterface)(ICallFrameWalker *This, REFIID iid,
                                   PVOID *ppvInterface, WINBOOL fIn,
                                   WINBOOL fOut);
  END_INTERFACE
...
#endif
#endif
HRESULT WINAPI ICallFrameWalker_OnWalkInterface_Proxy(ICallFrameWalker *This,
                                                      REFIID iid,
                                                      PVOID *ppvInterface,
                                                      WINBOOL fIn,
                                                      WINBOOL fOut);
...
typedef struct IInterfaceRelatedVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IInterfaceRelated *This, REFIID riid,
                                  void **ppvObject);
...
#endif
#endif
HRESULT WINAPI IInterfaceRelated_SetIID_Proxy(IInterfaceRelated *This,
                                              REFIID iid);
void __RPC_STUB IInterfaceRelated_SetIID_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IInterfaceRelated_GetIID_Proxy(IInterfaceRelated *This,
                                              IID *piid);
...
HRESULT WINAPI CoGetInterceptor(REFIID iidIntercepted, IUnknown *punkOuter,
                                REFIID iid, void **ppv);
HRESULT WINAPI CoGetInterceptorFromTypeInfo(REFIID iidIntercepted,
                                            IUnknown *punkOuter,
                                            ITypeInfo *typeInfo, REFIID iid,
                                            void **ppv);
