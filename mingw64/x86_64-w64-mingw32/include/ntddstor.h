...
DEFINE_GUID(GUID_DEVICEDUMP_STORAGE_DEVICE, 0xd8e2592f, 0x1aab, 0x4d56, 0xa7,
            0x46, 0x1f, 0x75, 0x85, 0xdf, 0x40, 0xf4);
DEFINE_GUID(GUID_DEVICEDUMP_DRIVER_STORAGE_PORT, 0xda82441d, 0x7142, 0x4bc1,
            0xb8, 0x44, 0x08, 0x07, 0xc5, 0xa4, 0xb6, 0x7f);
...
#define IsDsmActionNonDestructive(_Action)                                     \
  ((BOOLEAN)((_Action & DeviceDsmActionFlag_NonDestructive) != 0))
...
typedef enum _STORAGE_BUS_TYPE {
  ...
  BusTypeMaxReserved = 0x7F
    ...
    *PSTORAGE_BUS_TYPE;
#define SupportsDeviceSharing(type)                                            \
  (type == BusTypeScsi || type == BusTypeFibre || type == BusTypeiScsi ||      \
...
#define STORAGE_CRASH_TELEMETRY_REGKEY                                         \
  L"\\Registry\\Machine\\System\\CurrentControlSet\\Control\\CrashControl\\St" \
  L"orageTelemetry"
#define STORAGE_DEVICE_TELEMETRY_REGKEY                                        \
  L"\\Registry\\Machine\\System\\CurrentControlSet\\Control\\Storage\\Storage" \
  L"Telemetry"
...
#define STORAGE_EVENT_ALL                                                      \
  (STORAGE_EVENT_MEDIA_STATUS | STORAGE_EVENT_DEVICE_STATUS |                  \
