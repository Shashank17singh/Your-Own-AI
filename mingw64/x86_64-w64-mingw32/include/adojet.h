...
typedef DECLSPEC_UUID(
    "D2D139DF-B6CA-11d1-9F31-00C04FC29D52") enum ReplicaTypeEnum {
...
typedef DECLSPEC_UUID(
    "6877D21A-B6CE-11d1-9F31-00C04FC29D52") enum VisibilityEnum {
  jrRepVisibilityGlobal = 0x1,
  jrRepVisibilityLocal = 0x2,
  jrRepVisibilityAnon = 0x4
} VisibilityEnum;
typedef DECLSPEC_UUID(
    "B42FBFF6-B6CF-11d1-9F31-00C04FC29D52") enum UpdatabilityEnum {
  jrRepUpdFull = 0,
  jrRepUpdReadOnly = 0x2
} UpdatabilityEnum;
typedef DECLSPEC_UUID(
    "60C05416-B6D0-11d1-9F31-00C04FC29D52") enum SyncTypeEnum {
  jrSyncTypeExport = 0x1,
  jrSyncTypeImport = 0x2,
  jrSyncTypeImpExp = 0x3
} SyncTypeEnum;
typedef DECLSPEC_UUID(
    "5EBA3970-061E-11d2-BB77-00C04FAE22DA") enum SyncModeEnum {
  jrSyncModeIndirect = 0x1,
  jrSyncModeDirect = 0x2,
  jrSyncModeInternet = 0x3
} SyncModeEnum;
typedef DECLSPEC_UUID(
    "72769F94-BF78-11d1-AC4D-00C04FC29F8F") enum FilterTypeEnum {
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE get_ConflictTables(_Recordset *
                                                       *pprset) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE CreateReplica(
      BSTR replicaName, BSTR description,
      ReplicaTypeEnum replicaType = jrRepTypeFull,
      VisibilityEnum visibility = jrRepVisibilityGlobal, long priority = -1,
      UpdatabilityEnum updatability = jrRepUpdFull) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetObjectReplicability(
      BSTR objectName, BSTR objectType, VARIANT_BOOL * replicability) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetObjectReplicability(
      BSTR objectName, BSTR objectType, VARIANT_BOOL replicability) = 0;
  virtual HRESULT STDMETHODCALLTYPE MakeReplicable(
      BSTR connectionString = L"", VARIANT_BOOL columnTracking = -1) = 0;
  virtual HRESULT STDMETHODCALLTYPE PopulatePartial(BSTR FullReplica) = 0;
  virtual HRESULT STDMETHODCALLTYPE Synchronize(
      BSTR target, SyncTypeEnum syncType = jrSyncTypeImpExp,
      SyncModeEnum syncMode = jrSyncModeIndirect) = 0;
  virtual HRESULT STDMETHODCALLTYPE get_Filters(Filters * *ppFilters) = 0;
};
#else
typedef struct IReplicaVtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IReplica *This, REFIID riid,
  ...
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(IReplica *This, UINT iTInfo,
                                          LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(IReplica *This, REFIID riid,
                                            LPOLESTR *rgszNames, UINT cNames,
                                            LCID lcid, DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(IReplica *This, DISPID dispIdMember,
                                     REFIID riid, LCID lcid, WORD wFlags,
                                     DISPPARAMS *pDispParams,
                                     VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                                     UINT *puArgErr);
  HRESULT(STDMETHODCALLTYPE *putref_ActiveConnection)(IReplica *This,
                                                      IDispatch *pconn);
  HRESULT(STDMETHODCALLTYPE *put_ActiveConnection)(IReplica *This,
                                                   VARIANT vConn);
  HRESULT(STDMETHODCALLTYPE *get_ActiveConnection)(IReplica *This,
                                                   IDispatch **ppconn);
  ...
  HRESULT(STDMETHODCALLTYPE *get_ConflictTables)(IReplica *This,
                                                 _Recordset **pprset);
  ...
  HRESULT(STDMETHODCALLTYPE *get_ReplicaType)(IReplica *This,
                                              ReplicaTypeEnum *pl);
  ...
  HRESULT(STDMETHODCALLTYPE *get_Visibility)(IReplica *This,
                                             VisibilityEnum *pl);
  HRESULT(STDMETHODCALLTYPE *CreateReplica)(IReplica *This, BSTR replicaName,
                                            BSTR description,
...
#define IReplica_Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,   \
...
#define IReplica_CreateReplica(This, replicaName, description, replicaType,    \
                               visibility, priority, updatability)             \
  ((This)->lpVtbl->CreateReplica(This, replicaName, description, replicaType,  \
                                 visibility, priority, updatability))
#define IReplica_GetObjectReplicability(This, objectName, objectType,          \
                                        replicability)                         \
  ((This)->lpVtbl->GetObjectReplicability(This, objectName, objectType,        \
                                          replicability))
#define IReplica_SetObjectReplicability(This, objectName, objectType,          \
                                        replicability)                         \
  ((This)->lpVtbl->SetObjectReplicability(This, objectName, objectType,        \
                                          replicability))
...
typedef struct FilterVtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(Filter *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(Filter *This, UINT iTInfo, LCID lcid,
                                          ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(Filter *This, REFIID riid,
                                            LPOLESTR *rgszNames, UINT cNames,
                                            LCID lcid, DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(Filter *This, DISPID dispIdMember,
                                     REFIID riid, LCID lcid, WORD wFlags,
                                     DISPPARAMS *pDispParams,
                                     VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                                     UINT *puArgErr);
  HRESULT(STDMETHODCALLTYPE *get_TableName)(Filter *This, BSTR *pbstr);
  HRESULT(STDMETHODCALLTYPE *get_FilterType)(Filter *This,
                                             FilterTypeEnum *ptype);
  HRESULT(STDMETHODCALLTYPE *get_FilterCriteria)(Filter *This, BSTR *pbstr);
  END_INTERFACE
} FilterVtbl;
interface Filter { CONST_VTBL struct FilterVtbl *lpVtbl; };
#ifdef COBJMACROS
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE Append(
      BSTR tableName, FilterTypeEnum filterType, BSTR filterCriteria) = 0;
  virtual HRESULT STDMETHODCALLTYPE Delete(VARIANT Index) = 0;
};
#else
typedef struct FiltersVtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(Filters *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(Filters *This, UINT iTInfo, LCID lcid,
                                          ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(Filters *This, REFIID riid,
                                            LPOLESTR *rgszNames, UINT cNames,
                                            LCID lcid, DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(Filters *This, DISPID dispIdMember,
                                     REFIID riid, LCID lcid, WORD wFlags,
                                     DISPPARAMS *pDispParams,
                                     VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                                     UINT *puArgErr);
  ...
  HRESULT(STDMETHODCALLTYPE *get_Item)(Filters *This, VARIANT Index,
                                       Filter **ppvObject);
  HRESULT(STDMETHODCALLTYPE *Append)(Filters *This, BSTR tableName,
                                     FilterTypeEnum filterType,
                                     BSTR filterCriteria);
  HRESULT(STDMETHODCALLTYPE *Delete)(Filters *This, VARIANT Index);
  END_INTERFACE
} FiltersVtbl;
interface Filters { CONST_VTBL struct FiltersVtbl *lpVtbl; };
#ifdef COBJMACROS
...
public:
  virtual HRESULT STDMETHODCALLTYPE CompactDatabase(BSTR SourceConnection,
...
typedef struct IJetEngineVtbl {
  BEGIN_INTERFACE
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IJetEngine *This, REFIID riid,
                                             _COM_Outptr_ void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTypeInfo)(IJetEngine *This, UINT iTInfo,
                                          LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(STDMETHODCALLTYPE *GetIDsOfNames)(IJetEngine *This, REFIID riid,
                                            LPOLESTR *rgszNames, UINT cNames,
                                            LCID lcid, DISPID *rgDispId);
  HRESULT(STDMETHODCALLTYPE *Invoke)(IJetEngine *This, DISPID dispIdMember,
                                     REFIID riid, LCID lcid, WORD wFlags,
                                     DISPPARAMS *pDispParams,
                                     VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                                     UINT *puArgErr);
  HRESULT(STDMETHODCALLTYPE *CompactDatabase)(IJetEngine *This,
                                              BSTR SourceConnection,
                                              BSTR Destconnection);
  HRESULT(STDMETHODCALLTYPE *RefreshCache)(IJetEngine *This,
                                           _Connection *Connection);
  END_INTERFACE
} IJetEngineVtbl;
interface IJetEngine { CONST_VTBL struct IJetEngineVtbl *lpVtbl; };
#ifdef COBJMACROS
...
#define IJetEngine_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                    \
  ((This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo))
#define IJetEngine_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,          \
                                 rgDispId)                                     \
  ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId))
...
#ifdef __cplusplus
class DECLSPEC_UUID("D2D139E3-B6CA-11d1-9F31-00C04FC29D52") Replica;
#endif
EXTERN_C const CLSID CLSID_JetEngine;
#ifdef __cplusplus
class DECLSPEC_UUID("DE88C160-FF2C-11D1-BB6F-00C04FAE22DA") JetEngine;
#endif
#endif
#ifdef __cplusplus
}
