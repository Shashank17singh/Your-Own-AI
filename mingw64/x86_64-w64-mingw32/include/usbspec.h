...
typedef enum _USB_DEVICE_TYPE { Usb11Device = 0, Usb20Device } USB_DEVICE_TYPE;
...
DEFINE_GUID(GUID_USB_MSOS20_PLATFORM_CAPABILITY_ID, 0xD8DD60DF, 0x4589, 0x4CC7,
...
#define USB_ENDPOINT_DIRECTION_OUT(addr)                                       \
...
#define USB_30_ENDPOINT_TYPE_INTERRUPT_USAGE(bmAttr)                           \
...
#define USB_ENDPOINT_TYPE_ISOCHRONOUS_SYNCHRONIZATION(bmAttr)                  \
...
#define USB_ENDPOINT_TYPE_ISOCHRONOUS_USAGE(bmAttr)                            \
