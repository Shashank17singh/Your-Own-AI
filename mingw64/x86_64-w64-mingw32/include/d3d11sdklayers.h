...
#define D3D11_DEBUG_FEATURE_DISABLE_TILED_RESOURCE_MAPPING_TRACKING_AND_VALIDATION \
  (0x80)
DEFINE_GUID(DXGI_DEBUG_D3D11, 0x4b99317b, 0xac39, 0x4aa6, 0xbb, 0xb, 0xba, 0xa0,
            0x47, 0x84, 0x79, 0x8f);
...
ID3D11Debug : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE GetSwapChain(IDXGISwapChain *
                                                 *ppSwapChain) = 0;
  virtual HRESULT STDMETHODCALLTYPE ValidateContext(ID3D11DeviceContext *
                                                    pContext) = 0;
...
__CRT_UUID_DECL(ID3D11Debug, 0x79cf2233, 0x7536, 0x4948, 0x9d, 0x36, 0x1e, 0x46,
                0x92, 0xdc, 0x57, 0x60)
#endif
#else
typedef struct ID3D11DebugVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11Debug *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *SetPresentPerRenderOpDelay)(ID3D11Debug *This,
                                                         UINT Milliseconds);
  UINT(STDMETHODCALLTYPE *GetPresentPerRenderOpDelay)(ID3D11Debug *This);
  HRESULT(STDMETHODCALLTYPE *SetSwapChain)(ID3D11Debug *This,
                                           IDXGISwapChain *pSwapChain);
  HRESULT(STDMETHODCALLTYPE *GetSwapChain)(ID3D11Debug *This,
                                           IDXGISwapChain **ppSwapChain);
  HRESULT(STDMETHODCALLTYPE *ValidateContext)(ID3D11Debug *This,
                                              ID3D11DeviceContext *pContext);
  HRESULT(STDMETHODCALLTYPE *ReportLiveDeviceObjects)(ID3D11Debug *This,
                                                      D3D11_RLDO_FLAGS Flags);
  HRESULT(STDMETHODCALLTYPE *ValidateContextForDispatch)(
      ID3D11Debug *This, ID3D11DeviceContext *pContext);
  END_INTERFACE
} ID3D11DebugVtbl;
interface ID3D11Debug { CONST_VTBL ID3D11DebugVtbl *lpVtbl; };
#ifdef COBJMACROS
...
#else
/*** IUnknown methods ***/
static inline HRESULT ID3D11Debug_QueryInterface(ID3D11Debug *This, REFIID riid,
                                                 void **ppvObject) {
...
ID3D11Debug_SetPresentPerRenderOpDelay(ID3D11Debug *This, UINT Milliseconds) {
...
static inline HRESULT ID3D11Debug_SetSwapChain(ID3D11Debug *This,
                                               IDXGISwapChain *pSwapChain) {
  return This->lpVtbl->SetSwapChain(This, pSwapChain);
}
static inline HRESULT ID3D11Debug_GetSwapChain(ID3D11Debug *This,
                                               IDXGISwapChain **ppSwapChain) {
  return This->lpVtbl->GetSwapChain(This, ppSwapChain);
}
static inline HRESULT
ID3D11Debug_ValidateContext(ID3D11Debug *This, ID3D11DeviceContext *pContext) {
  return This->lpVtbl->ValidateContext(This, pContext);
}
static inline HRESULT
ID3D11Debug_ReportLiveDeviceObjects(ID3D11Debug *This, D3D11_RLDO_FLAGS Flags) {
  return This->lpVtbl->ReportLiveDeviceObjects(This, Flags);
}
static inline HRESULT
ID3D11Debug_ValidateContextForDispatch(ID3D11Debug *This,
                                       ID3D11DeviceContext *pContext) {
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D11SwitchToRef, 0x1ef337e3, 0x58e7, 0x4f83, 0xa6, 0x92, 0xdb,
                0x22, 0x1f, 0x5e, 0xd4, 0x7e)
#endif
#else
typedef struct ID3D11SwitchToRefVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11SwitchToRef *This,
  ...
  WINBOOL(STDMETHODCALLTYPE *SetUseRef)(ID3D11SwitchToRef *This,
                                        WINBOOL useref);
  WINBOOL(STDMETHODCALLTYPE *GetUseRef)(ID3D11SwitchToRef *This);
  END_INTERFACE
} ID3D11SwitchToRefVtbl;
interface ID3D11SwitchToRef { CONST_VTBL ID3D11SwitchToRefVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT ID3D11SwitchToRef_QueryInterface(ID3D11SwitchToRef *This,
                                                       REFIID riid,
                                                       void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ID3D11SwitchToRef methods ***/
static inline WINBOOL ID3D11SwitchToRef_SetUseRef(ID3D11SwitchToRef *This,
                                                  WINBOOL useref) {
...
ID3D11InfoQueue : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE GetStorageFilter(
      D3D11_INFO_QUEUE_FILTER * pFilter, SIZE_T * pFilterByteLength) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE PushStorageFilter(D3D11_INFO_QUEUE_FILTER *
                                                      pFilter) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE AddMessage(
      ...
      D3D11_MESSAGE_ID ID, LPCSTR pDescription) = 0;
  virtual HRESULT STDMETHODCALLTYPE AddApplicationMessage(
      D3D11_MESSAGE_SEVERITY Severity, LPCSTR pDescription) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetBreakOnCategory(
      D3D11_MESSAGE_CATEGORY Category, WINBOOL bEnable) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetBreakOnSeverity(
      D3D11_MESSAGE_SEVERITY Severity, WINBOOL bEnable) = 0;
  ...
  virtual WINBOOL STDMETHODCALLTYPE GetBreakOnID(D3D11_MESSAGE_ID ID) = 0;
  virtual void STDMETHODCALLTYPE SetMuteDebugOutput(WINBOOL bMute) = 0;
  virtual WINBOOL STDMETHODCALLTYPE GetMuteDebugOutput() = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D11InfoQueue, 0x6543dbb6, 0x1b48, 0x42f5, 0xab, 0x82, 0xe9,
                0x7e, 0xc7, 0x43, 0x26, 0xf6)
#endif
#else
typedef struct ID3D11InfoQueueVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D11InfoQueue *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *SetMessageCountLimit)(ID3D11InfoQueue *This,
  ...
  HRESULT(STDMETHODCALLTYPE *AddStorageFilterEntries)(
      ID3D11InfoQueue *This, D3D11_INFO_QUEUE_FILTER *pFilter);
  HRESULT(STDMETHODCALLTYPE *GetStorageFilter)(ID3D11InfoQueue *This,
  ...
  HRESULT(STDMETHODCALLTYPE *AddMessage)(ID3D11InfoQueue *This,
                                         D3D11_MESSAGE_CATEGORY Category,
                                         D3D11_MESSAGE_SEVERITY Severity,
                                         D3D11_MESSAGE_ID ID,
                                         LPCSTR pDescription);
  HRESULT(STDMETHODCALLTYPE *AddApplicationMessage)(
      ID3D11InfoQueue *This, D3D11_MESSAGE_SEVERITY Severity,
      LPCSTR pDescription);
  HRESULT(STDMETHODCALLTYPE *SetBreakOnCategory)(
      ID3D11InfoQueue *This, D3D11_MESSAGE_CATEGORY Category, WINBOOL bEnable);
  HRESULT(STDMETHODCALLTYPE *SetBreakOnSeverity)(
      ID3D11InfoQueue *This, D3D11_MESSAGE_SEVERITY Severity, WINBOOL bEnable);
  HRESULT(STDMETHODCALLTYPE *SetBreakOnID)(ID3D11InfoQueue *This,
                                           D3D11_MESSAGE_ID ID,
                                           WINBOOL bEnable);
  WINBOOL(STDMETHODCALLTYPE *GetBreakOnCategory)(
      ID3D11InfoQueue *This, D3D11_MESSAGE_CATEGORY Category);
  WINBOOL(STDMETHODCALLTYPE *GetBreakOnSeverity)(
      ID3D11InfoQueue *This, D3D11_MESSAGE_SEVERITY Severity);
  WINBOOL(STDMETHODCALLTYPE *GetBreakOnID)(ID3D11InfoQueue *This,
                                           D3D11_MESSAGE_ID ID);
  void(STDMETHODCALLTYPE *SetMuteDebugOutput)(ID3D11InfoQueue *This,
                                              WINBOOL bMute);
  WINBOOL(STDMETHODCALLTYPE *GetMuteDebugOutput)(ID3D11InfoQueue *This);
  END_INTERFACE
} ID3D11InfoQueueVtbl;
interface ID3D11InfoQueue { CONST_VTBL ID3D11InfoQueueVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT ID3D11InfoQueue_QueryInterface(ID3D11InfoQueue *This,
                                                     REFIID riid,
                                                     void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ID3D11InfoQueue methods ***/
static inline HRESULT
ID3D11InfoQueue_SetMessageCountLimit(ID3D11InfoQueue *This,
                                     UINT64 MessageCountLimit) {
...
static inline HRESULT ID3D11InfoQueue_GetMessage(ID3D11InfoQueue *This,
                                                 UINT64 MessageIndex,
                                                 D3D11_MESSAGE *pMessage,
                                                 SIZE_T *pMessageByteLength) {
  return This->lpVtbl->GetMessage(This, MessageIndex, pMessage,
                                  pMessageByteLength);
}
static inline UINT64
ID3D11InfoQueue_GetNumMessagesAllowedByStorageFilter(ID3D11InfoQueue *This) {
  return This->lpVtbl->GetNumMessagesAllowedByStorageFilter(This);
}
static inline UINT64
ID3D11InfoQueue_GetNumMessagesDeniedByStorageFilter(ID3D11InfoQueue *This) {
  return This->lpVtbl->GetNumMessagesDeniedByStorageFilter(This);
}
static inline UINT64
ID3D11InfoQueue_GetNumStoredMessages(ID3D11InfoQueue *This) {
...
static inline UINT64
ID3D11InfoQueue_GetMessageCountLimit(ID3D11InfoQueue *This) {
  return This->lpVtbl->GetMessageCountLimit(This);
}
static inline HRESULT
ID3D11InfoQueue_AddStorageFilterEntries(ID3D11InfoQueue *This,
                                        D3D11_INFO_QUEUE_FILTER *pFilter) {
  return This->lpVtbl->AddStorageFilterEntries(This, pFilter);
}
static inline HRESULT
ID3D11InfoQueue_GetStorageFilter(ID3D11InfoQueue *This,
                                 D3D11_INFO_QUEUE_FILTER *pFilter,
                                 SIZE_T *pFilterByteLength) {
...
static inline HRESULT
ID3D11InfoQueue_PushEmptyStorageFilter(ID3D11InfoQueue *This) {
  return This->lpVtbl->PushEmptyStorageFilter(This);
}
static inline HRESULT
ID3D11InfoQueue_PushCopyOfStorageFilter(ID3D11InfoQueue *This) {
  return This->lpVtbl->PushCopyOfStorageFilter(This);
}
static inline HRESULT
ID3D11InfoQueue_PushStorageFilter(ID3D11InfoQueue *This,
                                  D3D11_INFO_QUEUE_FILTER *pFilter) {
...
static inline UINT
ID3D11InfoQueue_GetStorageFilterStackSize(ID3D11InfoQueue *This) {
  return This->lpVtbl->GetStorageFilterStackSize(This);
}
static inline HRESULT
ID3D11InfoQueue_AddRetrievalFilterEntries(ID3D11InfoQueue *This,
                                          D3D11_INFO_QUEUE_FILTER *pFilter) {
  return This->lpVtbl->AddRetrievalFilterEntries(This, pFilter);
}
static inline HRESULT
ID3D11InfoQueue_GetRetrievalFilter(ID3D11InfoQueue *This,
                                   D3D11_INFO_QUEUE_FILTER *pFilter,
                                   SIZE_T *pFilterByteLength) {
...
static inline HRESULT
ID3D11InfoQueue_PushEmptyRetrievalFilter(ID3D11InfoQueue *This) {
  return This->lpVtbl->PushEmptyRetrievalFilter(This);
}
static inline HRESULT
ID3D11InfoQueue_PushCopyOfRetrievalFilter(ID3D11InfoQueue *This) {
  return This->lpVtbl->PushCopyOfRetrievalFilter(This);
}
static inline HRESULT
ID3D11InfoQueue_PushRetrievalFilter(ID3D11InfoQueue *This,
                                    D3D11_INFO_QUEUE_FILTER *pFilter) {
...
static inline UINT
ID3D11InfoQueue_GetRetrievalFilterStackSize(ID3D11InfoQueue *This) {
  return This->lpVtbl->GetRetrievalFilterStackSize(This);
}
static inline HRESULT ID3D11InfoQueue_AddMessage(
    ID3D11InfoQueue *This, D3D11_MESSAGE_CATEGORY Category,
    D3D11_MESSAGE_SEVERITY Severity, D3D11_MESSAGE_ID ID, LPCSTR pDescription) {
  return This->lpVtbl->AddMessage(This, Category, Severity, ID, pDescription);
}
static inline HRESULT
ID3D11InfoQueue_AddApplicationMessage(ID3D11InfoQueue *This,
                                      D3D11_MESSAGE_SEVERITY Severity,
                                      LPCSTR pDescription) {
  return This->lpVtbl->AddApplicationMessage(This, Severity, pDescription);
}
static inline HRESULT ID3D11InfoQueue_SetBreakOnCategory(
    ID3D11InfoQueue *This, D3D11_MESSAGE_CATEGORY Category, WINBOOL bEnable) {
  return This->lpVtbl->SetBreakOnCategory(This, Category, bEnable);
}
static inline HRESULT ID3D11InfoQueue_SetBreakOnSeverity(
    ID3D11InfoQueue *This, D3D11_MESSAGE_SEVERITY Severity, WINBOOL bEnable) {
  return This->lpVtbl->SetBreakOnSeverity(This, Severity, bEnable);
}
static inline HRESULT ID3D11InfoQueue_SetBreakOnID(ID3D11InfoQueue *This,
                                                   D3D11_MESSAGE_ID ID,
                                                   WINBOOL bEnable) {
  return This->lpVtbl->SetBreakOnID(This, ID, bEnable);
}
static inline WINBOOL
ID3D11InfoQueue_GetBreakOnCategory(ID3D11InfoQueue *This,
                                   D3D11_MESSAGE_CATEGORY Category) {
  return This->lpVtbl->GetBreakOnCategory(This, Category);
}
static inline WINBOOL
ID3D11InfoQueue_GetBreakOnSeverity(ID3D11InfoQueue *This,
                                   D3D11_MESSAGE_SEVERITY Severity) {
  return This->lpVtbl->GetBreakOnSeverity(This, Severity);
}
static inline WINBOOL ID3D11InfoQueue_GetBreakOnID(ID3D11InfoQueue *This,
                                                   D3D11_MESSAGE_ID ID) {
  return This->lpVtbl->GetBreakOnID(This, ID);
}
static inline void ID3D11InfoQueue_SetMuteDebugOutput(ID3D11InfoQueue *This,
                                                      WINBOOL bMute) {
  This->lpVtbl->SetMuteDebugOutput(This, bMute);
}
static inline WINBOOL
ID3D11InfoQueue_GetMuteDebugOutput(ID3D11InfoQueue *This) {
