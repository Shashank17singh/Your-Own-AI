...
public:
  virtual HRESULT WINAPI CreateTimer(ITimer *pReferenceTimer,
                                     ITimer **ppNewTimer) = 0;
  virtual HRESULT WINAPI GetNamedTimer(REFGUID rguidName, ITimer **ppTimer) = 0;
  virtual HRESULT WINAPI SetNamedTimerReference(REFGUID rguidName,
                                                ITimer *pReferenceTimer) = 0;
};
#else
typedef struct ITimerServiceVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITimerService *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ITimerService *This);
  ULONG(WINAPI *Release)(ITimerService *This);
  HRESULT(WINAPI *CreateTimer)(ITimerService *This, ITimer *pReferenceTimer,
                               ITimer **ppNewTimer);
  HRESULT(WINAPI *GetNamedTimer)(ITimerService *This, REFGUID rguidName,
                                 ITimer **ppTimer);
  HRESULT(WINAPI *SetNamedTimerReference)(ITimerService *This,
                                          REFGUID rguidName,
...
#endif
#endif
HRESULT WINAPI ITimerService_CreateTimer_Proxy(ITimerService *This,
                                               ITimer *pReferenceTimer,
                                               ITimer **ppNewTimer);
...
HRESULT WINAPI ITimerService_GetNamedTimer_Proxy(ITimerService *This,
                                                 REFGUID rguidName,
                                                 ITimer **ppTimer);
void __RPC_STUB ITimerService_GetNamedTimer_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITimerService_SetNamedTimerReference_Proxy(
    ITimerService *This, REFGUID rguidName, ITimer *pReferenceTimer);
...
public:
  virtual HRESULT WINAPI Advise(VARIANT vtimeMin, VARIANT vtimeMax,
                                VARIANT vtimeInterval, DWORD dwFlags,
                                ITimerSink *pTimerSink, DWORD *pdwCookie) = 0;
...
typedef struct ITimerVtbl {
  ...
  HRESULT(WINAPI *Advise)(ITimer *This, VARIANT vtimeMin, VARIANT vtimeMax,
                          VARIANT vtimeInterval, DWORD dwFlags,
                          ITimerSink *pTimerSink, DWORD *pdwCookie);
...
#define ITimer_Advise(This, vtimeMin, vtimeMax, vtimeInterval, dwFlags,        \
                      pTimerSink, pdwCookie)                                   \
  (This)->lpVtbl->Advise(This, vtimeMin, vtimeMax, vtimeInterval, dwFlags,     \
                         pTimerSink, pdwCookie)
...
#endif
#endif
HRESULT WINAPI ITimer_Advise_Proxy(ITimer *This, VARIANT vtimeMin,
                                   VARIANT vtimeMax, VARIANT vtimeInterval,
                                   DWORD dwFlags, ITimerSink *pTimerSink,
                                   DWORD *pdwCookie);
void __RPC_STUB ITimer_Advise_Stub(IRpcStubBuffer *This,
                                   IRpcChannelBuffer *_pRpcChannelBuffer,
                                   PRPC_MESSAGE _pRpcMessage,
                                   DWORD *_pdwStubPhase);
HRESULT WINAPI ITimer_Unadvise_Proxy(ITimer *This, DWORD dwCookie);
void __RPC_STUB ITimer_Unadvise_Stub(IRpcStubBuffer *This,
                                     IRpcChannelBuffer *_pRpcChannelBuffer,
                                     PRPC_MESSAGE _pRpcMessage,
                                     DWORD *_pdwStubPhase);
HRESULT WINAPI ITimer_Freeze_Proxy(ITimer *This, WINBOOL fFreeze);
void __RPC_STUB ITimer_Freeze_Stub(IRpcStubBuffer *This,
                                   IRpcChannelBuffer *_pRpcChannelBuffer,
                                   PRPC_MESSAGE _pRpcMessage,
                                   DWORD *_pdwStubPhase);
HRESULT WINAPI ITimer_GetTime_Proxy(ITimer *This, VARIANT *pvtime);
void __RPC_STUB ITimer_GetTime_Stub(IRpcStubBuffer *This,
                                    IRpcChannelBuffer *_pRpcChannelBuffer,
                                    PRPC_MESSAGE _pRpcMessage,
                                    DWORD *_pdwStubPhase);
#endif
...
typedef struct ITimerSinkVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITimerSink *This, REFIID riid,
                                  void **ppvObject);
...
void __RPC_STUB ITimerSink_OnTimer_Stub(IRpcStubBuffer *This,
                                        IRpcChannelBuffer *_pRpcChannelBuffer,
                                        PRPC_MESSAGE _pRpcMessage,
                                        DWORD *_pdwStubPhase);
#endif
...
public:
  ...
  virtual HRESULT WINAPI MapMIMEToCLSID(LPCOLESTR pszMIMEType,
                                        CLSID *pCLSID) = 0;
  virtual HRESULT WINAPI SetMapping(LPCOLESTR pszMIMEType, DWORD dwMapMode,
                                    REFCLSID clsid) = 0;
};
#else
typedef struct IMapMIMEToCLSIDVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMapMIMEToCLSID *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IMapMIMEToCLSID *This);
  ULONG(WINAPI *Release)(IMapMIMEToCLSID *This);
  HRESULT(WINAPI *EnableDefaultMappings)(IMapMIMEToCLSID *This,
                                         WINBOOL bEnable);
  HRESULT(WINAPI *MapMIMEToCLSID)(IMapMIMEToCLSID *This, LPCOLESTR pszMIMEType,
                                  CLSID *pCLSID);
  HRESULT(WINAPI *SetMapping)(IMapMIMEToCLSID *This, LPCOLESTR pszMIMEType,
                              DWORD dwMapMode, REFCLSID clsid);
  END_INTERFACE
} IMapMIMEToCLSIDVtbl;
...
#endif
HRESULT
    WINAPI IMapMIMEToCLSID_EnableDefaultMappings_Proxy(IMapMIMEToCLSID *This,
                                                       WINBOOL bEnable);
void __RPC_STUB IMapMIMEToCLSID_EnableDefaultMappings_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMapMIMEToCLSID_MapMIMEToCLSID_Proxy(IMapMIMEToCLSID *This,
                                                    LPCOLESTR pszMIMEType,
                                                    CLSID *pCLSID);
void __RPC_STUB IMapMIMEToCLSID_MapMIMEToCLSID_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMapMIMEToCLSID_SetMapping_Proxy(IMapMIMEToCLSID *This,
                                                LPCOLESTR pszMIMEType,
                                                DWORD dwMapMode,
                                                REFCLSID clsid);
...
typedef struct IImageDecodeFilterVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IImageDecodeFilter *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IImageDecodeFilter *This);
  ULONG(WINAPI *Release)(IImageDecodeFilter *This);
  HRESULT(WINAPI *Initialize)(IImageDecodeFilter *This,
...
#endif
#endif
HRESULT WINAPI IImageDecodeFilter_Initialize_Proxy(
    IImageDecodeFilter *This, IImageDecodeEventSink *pEventSink);
void __RPC_STUB IImageDecodeFilter_Initialize_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IImageDecodeFilter_Process_Proxy(IImageDecodeFilter *This,
                                                IStream *pStream);
void __RPC_STUB IImageDecodeFilter_Process_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IImageDecodeFilter_Terminate_Proxy(IImageDecodeFilter *This,
                                                  HRESULT hrStatus);
...
public:
  virtual HRESULT WINAPI GetSurface(LONG nWidth, LONG nHeight, REFGUID bfid,
                                    ULONG nPasses, DWORD dwHints,
                                    IUnknown **ppSurface) = 0;
  virtual HRESULT WINAPI OnBeginDecode(DWORD *pdwEvents, ULONG *pnFormats,
                                       BFID **ppFormats) = 0;
...
typedef struct IImageDecodeEventSinkVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IImageDecodeEventSink *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IImageDecodeEventSink *This);
  ULONG(WINAPI *Release)(IImageDecodeEventSink *This);
  HRESULT(WINAPI *GetSurface)(IImageDecodeEventSink *This, LONG nWidth,
                              LONG nHeight, REFGUID bfid, ULONG nPasses,
                              DWORD dwHints, IUnknown **ppSurface);
  HRESULT(WINAPI *OnBeginDecode)(IImageDecodeEventSink *This, DWORD *pdwEvents,
                                 ULONG *pnFormats, BFID **ppFormats);
  HRESULT(WINAPI *OnBitsComplete)(IImageDecodeEventSink *This);
  HRESULT(WINAPI *OnDecodeComplete)(IImageDecodeEventSink *This,
                                    HRESULT hrStatus);
  HRESULT(WINAPI *OnPalette)(IImageDecodeEventSink *This);
  HRESULT(WINAPI *OnProgress)(IImageDecodeEventSink *This, RECT *pBounds,
                              WINBOOL bComplete);
  END_INTERFACE
...
#define IImageDecodeEventSink_GetSurface(This, nWidth, nHeight, bfid, nPasses, \
                                         dwHints, ppSurface)                   \
  (This)->lpVtbl->GetSurface(This, nWidth, nHeight, bfid, nPasses, dwHints,    \
                             ppSurface)
#define IImageDecodeEventSink_OnBeginDecode(This, pdwEvents, pnFormats,        \
                                            ppFormats)                         \
...
#endif
#endif
HRESULT WINAPI IImageDecodeEventSink_GetSurface_Proxy(
    IImageDecodeEventSink *This, LONG nWidth, LONG nHeight, REFGUID bfid,
    ULONG nPasses, DWORD dwHints, IUnknown **ppSurface);
void __RPC_STUB IImageDecodeEventSink_GetSurface_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IImageDecodeEventSink_OnBeginDecode_Proxy(
    IImageDecodeEventSink *This, DWORD *pdwEvents, ULONG *pnFormats,
    BFID **ppFormats);
void __RPC_STUB IImageDecodeEventSink_OnBeginDecode_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
IImageDecodeEventSink_OnBitsComplete_Proxy(IImageDecodeEventSink *This);
void __RPC_STUB IImageDecodeEventSink_OnBitsComplete_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IImageDecodeEventSink_OnDecodeComplete_Proxy(
    IImageDecodeEventSink *This, HRESULT hrStatus);
void __RPC_STUB IImageDecodeEventSink_OnDecodeComplete_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
IImageDecodeEventSink_OnPalette_Proxy(IImageDecodeEventSink *This);
void __RPC_STUB IImageDecodeEventSink_OnPalette_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IImageDecodeEventSink_OnProgress_Proxy(
    IImageDecodeEventSink *This, RECT *pBounds, WINBOOL bComplete);
