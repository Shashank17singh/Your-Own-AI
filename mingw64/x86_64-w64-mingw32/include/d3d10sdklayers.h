...
ID3D10Debug : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE SetPresentPerRenderOpDelay(
      UINT milliseconds) = 0;
  virtual UINT STDMETHODCALLTYPE GetPresentPerRenderOpDelay() = 0;
  virtual HRESULT STDMETHODCALLTYPE SetSwapChain(IDXGISwapChain *
                                                 swapchain) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetSwapChain(IDXGISwapChain *
                                                 *swapchain) = 0;
  virtual HRESULT STDMETHODCALLTYPE Validate() = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D10Debug, 0x9b7e4e01, 0x342c, 0x4106, 0xa1, 0x9f, 0x4f, 0x27,
                0x04, 0xf6, 0x89, 0xf0)
#endif
#else
typedef struct ID3D10DebugVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D10Debug *This, REFIID riid,
                                             void **ppvObject);
...
interface ID3D10Debug { CONST_VTBL ID3D10DebugVtbl *lpVtbl; };
#ifdef COBJMACROS
...
#define ID3D10Debug_SetSwapChain(This, swapchain)                              \
  (This)->lpVtbl->SetSwapChain(This, swapchain)
#define ID3D10Debug_GetSwapChain(This, swapchain)                              \
  (This)->lpVtbl->GetSwapChain(This, swapchain)
#define ID3D10Debug_Validate(This) (This)->lpVtbl->Validate(This)
#else
/*** IUnknown methods ***/
static inline HRESULT ID3D10Debug_QueryInterface(ID3D10Debug *This, REFIID riid,
                                                 void **ppvObject) {
...
ID3D10Debug_SetPresentPerRenderOpDelay(ID3D10Debug *This, UINT milliseconds) {
...
static inline HRESULT ID3D10Debug_SetSwapChain(ID3D10Debug *This,
                                               IDXGISwapChain *swapchain) {
  return This->lpVtbl->SetSwapChain(This, swapchain);
}
static inline HRESULT ID3D10Debug_GetSwapChain(ID3D10Debug *This,
                                               IDXGISwapChain **swapchain) {
...
ID3D10SwitchToRef : public IUnknown {
  virtual WINBOOL STDMETHODCALLTYPE SetUseRef(WINBOOL useref) = 0;
  virtual WINBOOL STDMETHODCALLTYPE GetUseRef() = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D10SwitchToRef, 0x9b7e4e02, 0x342c, 0x4106, 0xa1, 0x9f, 0x4f,
                0x27, 0x04, 0xf6, 0x89, 0xf0)
#endif
#else
typedef struct ID3D10SwitchToRefVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D10SwitchToRef *This,
  ...
  WINBOOL(STDMETHODCALLTYPE *SetUseRef)(ID3D10SwitchToRef *This,
                                        WINBOOL useref);
  WINBOOL(STDMETHODCALLTYPE *GetUseRef)(ID3D10SwitchToRef *This);
  END_INTERFACE
} ID3D10SwitchToRefVtbl;
interface ID3D10SwitchToRef { CONST_VTBL ID3D10SwitchToRefVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT ID3D10SwitchToRef_QueryInterface(ID3D10SwitchToRef *This,
                                                       REFIID riid,
                                                       void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ID3D10SwitchToRef methods ***/
static inline WINBOOL ID3D10SwitchToRef_SetUseRef(ID3D10SwitchToRef *This,
                                                  WINBOOL useref) {
...
ID3D10InfoQueue : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE GetMessage(
      UINT64 message_idx, D3D10_MESSAGE * message, SIZE_T * message_size) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetStorageFilter(
      D3D10_INFO_QUEUE_FILTER * filter, SIZE_T * filter_size) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE PushStorageFilter(D3D10_INFO_QUEUE_FILTER *
                                                      filter) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetRetrievalFilter(
      D3D10_INFO_QUEUE_FILTER * filter, SIZE_T * filterbytelength) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE AddMessage(
      D3D10_MESSAGE_CATEGORY category, D3D10_MESSAGE_SEVERITY severity,
      D3D10_MESSAGE_ID id, const char *description) = 0;
  virtual HRESULT STDMETHODCALLTYPE AddApplicationMessage(
      D3D10_MESSAGE_SEVERITY severity, const char *description) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetBreakOnCategory(
      D3D10_MESSAGE_CATEGORY category, WINBOOL enable) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetBreakOnSeverity(
      D3D10_MESSAGE_SEVERITY severity, WINBOOL enable) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetBreakOnID(D3D10_MESSAGE_ID id,
                                                 WINBOOL enable) = 0;
  ...
  virtual WINBOOL STDMETHODCALLTYPE GetBreakOnID(D3D10_MESSAGE_ID id) = 0;
  virtual void STDMETHODCALLTYPE SetMuteDebugOutput(WINBOOL mute) = 0;
  virtual WINBOOL STDMETHODCALLTYPE GetMuteDebugOutput() = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D10InfoQueue, 0x1b940b17, 0x2642, 0x4d1f, 0xab, 0x1f, 0xb9,
                0x9b, 0xad, 0x0c, 0x39, 0x5f)
#endif
#else
typedef struct ID3D10InfoQueueVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D10InfoQueue *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *SetMessageCountLimit)(ID3D10InfoQueue *This,
                                                   UINT64 limit);
  void(STDMETHODCALLTYPE *ClearStoredMessages)(ID3D10InfoQueue *This);
  HRESULT(STDMETHODCALLTYPE *GetMessage)(ID3D10InfoQueue *This,
                                         UINT64 message_idx,
  ...
  HRESULT(STDMETHODCALLTYPE *AddStorageFilterEntries)(
      ID3D10InfoQueue *This, D3D10_INFO_QUEUE_FILTER *filter);
  HRESULT(STDMETHODCALLTYPE *GetStorageFilter)(ID3D10InfoQueue *This,
  ...
  HRESULT(STDMETHODCALLTYPE *AddMessage)(ID3D10InfoQueue *This,
                                         D3D10_MESSAGE_CATEGORY category,
                                         D3D10_MESSAGE_SEVERITY severity,
                                         D3D10_MESSAGE_ID id,
                                         const char *description);
  HRESULT(STDMETHODCALLTYPE *AddApplicationMessage)(
      ID3D10InfoQueue *This, D3D10_MESSAGE_SEVERITY severity,
      const char *description);
  HRESULT(STDMETHODCALLTYPE *SetBreakOnCategory)(
      ID3D10InfoQueue *This, D3D10_MESSAGE_CATEGORY category, WINBOOL enable);
  HRESULT(STDMETHODCALLTYPE *SetBreakOnSeverity)(
      ID3D10InfoQueue *This, D3D10_MESSAGE_SEVERITY severity, WINBOOL enable);
  HRESULT(STDMETHODCALLTYPE *SetBreakOnID)(ID3D10InfoQueue *This,
                                           D3D10_MESSAGE_ID id, WINBOOL enable);
  WINBOOL(STDMETHODCALLTYPE *GetBreakOnCategory)(
      ID3D10InfoQueue *This, D3D10_MESSAGE_CATEGORY category);
  WINBOOL(STDMETHODCALLTYPE *GetBreakOnSeverity)(
      ID3D10InfoQueue *This, D3D10_MESSAGE_SEVERITY severity);
  WINBOOL(STDMETHODCALLTYPE *GetBreakOnID)(ID3D10InfoQueue *This,
                                           D3D10_MESSAGE_ID id);
  void(STDMETHODCALLTYPE *SetMuteDebugOutput)(ID3D10InfoQueue *This,
                                              WINBOOL mute);
  WINBOOL(STDMETHODCALLTYPE *GetMuteDebugOutput)(ID3D10InfoQueue *This);
  END_INTERFACE
} ID3D10InfoQueueVtbl;
interface ID3D10InfoQueue { CONST_VTBL ID3D10InfoQueueVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** ID3D10InfoQueue methods ***/
#define ID3D10InfoQueue_SetMessageCountLimit(This, limit)                      \
...
#define ID3D10InfoQueue_GetMessage(This, message_idx, message, message_size)   \
  (This)->lpVtbl->GetMessage(This, message_idx, message, message_size)
...
#define ID3D10InfoQueue_AddStorageFilterEntries(This, filter)                  \
  (This)->lpVtbl->AddStorageFilterEntries(This, filter)
#define ID3D10InfoQueue_GetStorageFilter(This, filter, filter_size)            \
  (This)->lpVtbl->GetStorageFilter(This, filter, filter_size)
...
#define ID3D10InfoQueue_PushStorageFilter(This, filter)                        \
...
#define ID3D10InfoQueue_AddRetrievalFilterEntries(This, filter)                \
  (This)->lpVtbl->AddRetrievalFilterEntries(This, filter)
#define ID3D10InfoQueue_GetRetrievalFilter(This, filter, filterbytelength)     \
  (This)->lpVtbl->GetRetrievalFilter(This, filter, filterbytelength)
...
#define ID3D10InfoQueue_PushRetrievalFilter(This, filter)                      \
...
#define ID3D10InfoQueue_AddMessage(This, category, severity, id, description)  \
  (This)->lpVtbl->AddMessage(This, category, severity, id, description)
#define ID3D10InfoQueue_AddApplicationMessage(This, severity, description)     \
  (This)->lpVtbl->AddApplicationMessage(This, severity, description)
#define ID3D10InfoQueue_SetBreakOnCategory(This, category, enable)             \
  (This)->lpVtbl->SetBreakOnCategory(This, category, enable)
#define ID3D10InfoQueue_SetBreakOnSeverity(This, severity, enable)             \
  (This)->lpVtbl->SetBreakOnSeverity(This, severity, enable)
#define ID3D10InfoQueue_SetBreakOnID(This, id, enable)                         \
...
#define ID3D10InfoQueue_SetMuteDebugOutput(This, mute)                         \
...
#else
/*** IUnknown methods ***/
static inline HRESULT ID3D10InfoQueue_QueryInterface(ID3D10InfoQueue *This,
                                                     REFIID riid,
                                                     void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ID3D10InfoQueue methods ***/
static inline HRESULT
ID3D10InfoQueue_SetMessageCountLimit(ID3D10InfoQueue *This, UINT64 limit) {
...
static inline HRESULT ID3D10InfoQueue_GetMessage(ID3D10InfoQueue *This,
                                                 UINT64 message_idx,
                                                 D3D10_MESSAGE *message,
                                                 SIZE_T *message_size) {
...
ID3D10InfoQueue_GetNumMessagesAllowedByStorageFilter(ID3D10InfoQueue *This) {
  return This->lpVtbl->GetNumMessagesAllowedByStorageFilter(This);
}
static inline UINT64
ID3D10InfoQueue_GetNumMessagesDeniedByStorageFilter(ID3D10InfoQueue *This) {
  return This->lpVtbl->GetNumMessagesDeniedByStorageFilter(This);
}
static inline UINT64
ID3D10InfoQueue_GetNumStoredMessages(ID3D10InfoQueue *This) {
  return This->lpVtbl->GetNumStoredMessages(This);
}
static inline UINT64
ID3D10InfoQueue_GetNumStoredMessagesAllowedByRetrievalFilter(
    ID3D10InfoQueue *This) {
  return This->lpVtbl->GetNumStoredMessagesAllowedByRetrievalFilter(This);
}
static inline UINT64 ID3D10InfoQueue_GetNumMessagesDiscardedByMessageCountLimit(
    ID3D10InfoQueue *This) {
  return This->lpVtbl->GetNumMessagesDiscardedByMessageCountLimit(This);
}
static inline UINT64
ID3D10InfoQueue_GetMessageCountLimit(ID3D10InfoQueue *This) {
  return This->lpVtbl->GetMessageCountLimit(This);
}
static inline HRESULT
ID3D10InfoQueue_AddStorageFilterEntries(ID3D10InfoQueue *This,
                                        D3D10_INFO_QUEUE_FILTER *filter) {
  return This->lpVtbl->AddStorageFilterEntries(This, filter);
}
static inline HRESULT
ID3D10InfoQueue_GetStorageFilter(ID3D10InfoQueue *This,
                                 D3D10_INFO_QUEUE_FILTER *filter,
                                 SIZE_T *filter_size) {
...
static inline HRESULT
ID3D10InfoQueue_PushEmptyStorageFilter(ID3D10InfoQueue *This) {
  return This->lpVtbl->PushEmptyStorageFilter(This);
}
static inline HRESULT
ID3D10InfoQueue_PushCopyOfStorageFilter(ID3D10InfoQueue *This) {
  return This->lpVtbl->PushCopyOfStorageFilter(This);
}
static inline HRESULT
ID3D10InfoQueue_PushStorageFilter(ID3D10InfoQueue *This,
                                  D3D10_INFO_QUEUE_FILTER *filter) {
...
static inline UINT
ID3D10InfoQueue_GetStorageFilterStackSize(ID3D10InfoQueue *This) {
  return This->lpVtbl->GetStorageFilterStackSize(This);
}
static inline HRESULT
ID3D10InfoQueue_AddRetrievalFilterEntries(ID3D10InfoQueue *This,
                                          D3D10_INFO_QUEUE_FILTER *filter) {
  return This->lpVtbl->AddRetrievalFilterEntries(This, filter);
}
static inline HRESULT
ID3D10InfoQueue_GetRetrievalFilter(ID3D10InfoQueue *This,
                                   D3D10_INFO_QUEUE_FILTER *filter,
                                   SIZE_T *filterbytelength) {
...
static inline HRESULT
ID3D10InfoQueue_PushEmptyRetrievalFilter(ID3D10InfoQueue *This) {
  return This->lpVtbl->PushEmptyRetrievalFilter(This);
}
static inline HRESULT
ID3D10InfoQueue_PushCopyOfRetrievalFilter(ID3D10InfoQueue *This) {
  return This->lpVtbl->PushCopyOfRetrievalFilter(This);
}
static inline HRESULT
ID3D10InfoQueue_PushRetrievalFilter(ID3D10InfoQueue *This,
                                    D3D10_INFO_QUEUE_FILTER *filter) {
...
static inline UINT
ID3D10InfoQueue_GetRetrievalFilterStackSize(ID3D10InfoQueue *This) {
  return This->lpVtbl->GetRetrievalFilterStackSize(This);
}
static inline HRESULT
ID3D10InfoQueue_AddMessage(ID3D10InfoQueue *This,
                           D3D10_MESSAGE_CATEGORY category,
                           D3D10_MESSAGE_SEVERITY severity, D3D10_MESSAGE_ID id,
                           const char *description) {
  return This->lpVtbl->AddMessage(This, category, severity, id, description);
}
static inline HRESULT
ID3D10InfoQueue_AddApplicationMessage(ID3D10InfoQueue *This,
                                      D3D10_MESSAGE_SEVERITY severity,
                                      const char *description) {
  return This->lpVtbl->AddApplicationMessage(This, severity, description);
}
static inline HRESULT ID3D10InfoQueue_SetBreakOnCategory(
    ID3D10InfoQueue *This, D3D10_MESSAGE_CATEGORY category, WINBOOL enable) {
  return This->lpVtbl->SetBreakOnCategory(This, category, enable);
}
static inline HRESULT ID3D10InfoQueue_SetBreakOnSeverity(
    ID3D10InfoQueue *This, D3D10_MESSAGE_SEVERITY severity, WINBOOL enable) {
  return This->lpVtbl->SetBreakOnSeverity(This, severity, enable);
}
static inline HRESULT ID3D10InfoQueue_SetBreakOnID(ID3D10InfoQueue *This,
                                                   D3D10_MESSAGE_ID id,
                                                   WINBOOL enable) {
  return This->lpVtbl->SetBreakOnID(This, id, enable);
}
static inline WINBOOL
ID3D10InfoQueue_GetBreakOnCategory(ID3D10InfoQueue *This,
                                   D3D10_MESSAGE_CATEGORY category) {
  return This->lpVtbl->GetBreakOnCategory(This, category);
}
static inline WINBOOL
ID3D10InfoQueue_GetBreakOnSeverity(ID3D10InfoQueue *This,
                                   D3D10_MESSAGE_SEVERITY severity) {
  return This->lpVtbl->GetBreakOnSeverity(This, severity);
}
static inline WINBOOL ID3D10InfoQueue_GetBreakOnID(ID3D10InfoQueue *This,
                                                   D3D10_MESSAGE_ID id) {
  return This->lpVtbl->GetBreakOnID(This, id);
}
static inline void ID3D10InfoQueue_SetMuteDebugOutput(ID3D10InfoQueue *This,
                                                      WINBOOL mute) {
  This->lpVtbl->SetMuteDebugOutput(This, mute);
}
static inline WINBOOL
ID3D10InfoQueue_GetMuteDebugOutput(ID3D10InfoQueue *This) {
