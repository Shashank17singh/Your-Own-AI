...
_mktemp(char *_TemplateName) __MINGW_ATTRIB_DEPRECATED_SEC_WARN;
...
_CRTIMP intptr_t __cdecl _findfirst64i32(const char *_Filename,
...
_CRTIMP int __cdecl _findnext64(intptr_t _FindHandle,
                                struct __finddata64_t *_FindData);
_CRTIMP int __cdecl _findnext64i32(intptr_t _FindHandle,
                                   struct _finddata64i32_t *_FindData);
...
__mingw_bos_extern_ovr int _open(const char *__filename, int __flags, ...) {
  ...
  if (__builtin_va_arg_pack_len() < 1 &&
      __builtin_constant_p(__flags & _O_CREAT) && (__flags & _O_CREAT))
...
_CRTIMP int __cdecl
__mingw_call__sopen_warn_missing(const char *, int, int,
                                 ...) __MINGW_ASM_CRT_CALL(_sopen)
...
_CRTIMP int __cdecl
__mingw_call__wopen_warn_missing(const wchar_t *, int,
                                 ...) __MINGW_ASM_CRT_CALL(_wopen)
...
_CRTIMP int __cdecl
__mingw_call__wsopen_warn_missing(const wchar_t *, int, int,
                                  ...) __MINGW_ASM_CRT_CALL(_wsopen)
