...
#define URL_E_UNREGISTERED_PROTOCOL                                            \
  MAKE_SCODE(SEVERITY_ERROR, FACILITY_ITF, 0x1002)
...
#define IUniformResourceLocatorVtbl                                            \
  __MINGW_NAME_AW_EXT(IUniformResourceLocator, Vtbl)
...
INTSHCUTAPI HRESULT WINAPI URLAssociationDialogA(HWND hwndParent,
                                                 ...
                                                 PSTR pszAppBuf,
                                                 UINT ucAppBufLen);
INTSHCUTAPI HRESULT WINAPI
URLAssociationDialogW(HWND hwndParent, DWORD dwInFlags, PCWSTR pcszFile,
                      PCWSTR pcszURL, PWSTR pszAppBuf, UINT ucAppBufLen);
...
INTSHCUTAPI HRESULT WINAPI MIMEAssociationDialogA(
    HWND hwndParent, DWORD dwInFlags, PCSTR pcszFile, PCSTR pcszMIMEContentType,
    PSTR pszAppBuf, UINT ucAppBufLen);
INTSHCUTAPI HRESULT WINAPI MIMEAssociationDialogW(
    HWND hwndParent, DWORD dwInFlags, PCWSTR pcszFile,
