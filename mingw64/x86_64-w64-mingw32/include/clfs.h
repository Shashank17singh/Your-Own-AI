...
/* enum guessed from
 * http://msdn.microsoft.com/en-us/library/bb540336%28VS.85%29.aspx */
...
} CLFS_CONTAINER_INFORMATION, *PCLFS_CONTAINER_INFORMATION,
...
} CLFS_ARCHIVE_DESCRIPTOR, *PCLFS_ARCHIVE_DESCRIPTOR,
...
WINBOOL WINAPI LsnEqual(const CLFS_LSN *plsn1, const CLFS_LSN *plsn2);
WINBOOL WINAPI LsnGreater(const CLFS_LSN *plsn1, const CLFS_LSN *plsn2);
WINBOOL WINAPI LsnLess(const CLFS_LSN *plsn1, const CLFS_LSN *plsn2);
WINBOOL WINAPI LsnNull(const CLFS_LSN *plsn);
#ifdef __cplusplus
}
#endif
