...
STDAPI CreateURLMonikerEx(LPMONIKER pMkCtx, LPCWSTR szURL, LPMONIKER *ppmk,
                          DWORD dwFlags);
...
STDAPI CreateURLMonikerEx2(LPMONIKER pMkCtx, IUri *pUri, LPMONIKER *ppmk,
                           DWORD dwFlags);
#endif
STDAPI CreateAsyncBindCtxEx(IBindCtx *pbc, DWORD dwOptions,
                            IBindStatusCallback *pBSCb, IEnumFORMATETC *pEnum,
                            IBindCtx **ppBC, DWORD reserved);
STDAPI MkParseDisplayNameEx(IBindCtx *pbc, LPCWSTR szDisplayName,
...
STDAPI GetClassFileOrMime(LPBC pBC, LPCWSTR szFilename, LPVOID pBuffer,
                          DWORD cbSize, LPCWSTR szMime, DWORD dwReserved,
                          CLSID *pclsid);
STDAPI IsValidURL(LPBC pBC, LPCWSTR szURL, DWORD dwReserved);
STDAPI CoGetClassObjectFromURL(REFCLSID rCLASSID, LPCWSTR szCODE,
                               DWORD dwFileVersionMS, DWORD dwFileVersionLS,
                               LPCWSTR szTYPE, LPBINDCTX pBindCtx,
                               DWORD dwClsContext, LPVOID pvReserved,
                               REFIID riid, LPVOID *ppv);
STDAPI IEInstallScope(LPDWORD pdwScope);
STDAPI FaultInIEFeature(HWND hWnd, uCLSSPEC *pClassSpec, QUERYCONTEXT *pQuery,
                        DWORD dwFlags);
...
STDAPI RegisterMediaTypes(UINT ctypes, const LPCSTR *rgszTypes,
...
STDAPI RegisterFormatEnumerator(LPBC pBC, IEnumFORMATETC *pEFetc,
                                DWORD reserved);
STDAPI RevokeFormatEnumerator(LPBC pBC, IEnumFORMATETC *pEFetc);
STDAPI RegisterMediaTypeClass(LPBC pBC, UINT ctypes, const LPCSTR *rgszTypes,
                              CLSID *rgclsID, DWORD reserved);
STDAPI FindMediaTypeClass(LPBC pBC, LPCSTR szType, CLSID *pclsID,
                          DWORD reserved);
STDAPI UrlMkSetSessionOption(DWORD dwOption, LPVOID pBuffer,
                             DWORD dwBufferLength, DWORD dwReserved);
STDAPI UrlMkGetSessionOption(DWORD dwOption, LPVOID pBuffer,
                             DWORD dwBufferLength, DWORD *pdwBufferLengthOut,
                             DWORD dwReserved);
STDAPI FindMimeFromData(LPBC pBC, LPCWSTR pwzUrl, LPVOID pBuffer, DWORD cbSize,
                        LPCWSTR pwzMimeProposed, DWORD dwMimeFlags,
...
STDAPI CompareSecurityIds(BYTE *pbSecurityId1, DWORD dwLen1,
                          BYTE *pbSecurityId2, DWORD dwLen2, DWORD dwReserved);
STDAPI CompatFlagsFromClsid(CLSID *pclsid, LPDWORD pdwCompatFlags,
...
#define INET_E_AUTHENTICATION_REQUIRED                                         \
  _HRESULT_TYPEDEF_(__MSABI_LONG(0x800C0009))
...
#define INET_E_CANNOT_INSTANTIATE_OBJECT                                       \
  _HRESULT_TYPEDEF_(__MSABI_LONG(0x800C0010))
...
#define INET_E_CODE_INSTALL_BLOCKED_ARM                                        \
  _HRESULT_TYPEDEF_(__MSABI_LONG(0x800C0504))
#define INET_E_BLOCKED_PLUGGABLE_PROTOCOL                                      \
  _HRESULT_TYPEDEF_(__MSABI_LONG(0x800C0505))
...
DEFINE_GUID(IID_IPersistMoniker, 0x79eac9c9, 0xbaf9, 0x11ce, 0x8c, 0x82, 0x00,
...
IPersistMoniker : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE Load(WINBOOL fFullyAvailable,
                                         IMoniker * pimkName, LPBC pibc,
                                         DWORD grfMode) = 0;
  virtual HRESULT STDMETHODCALLTYPE Save(IMoniker * pimkName, LPBC pbc,
                                         WINBOOL fRemember) = 0;
  virtual HRESULT STDMETHODCALLTYPE SaveCompleted(IMoniker * pimkName,
                                                  LPBC pibc) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetCurMoniker(IMoniker * *ppimkName) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IPersistMoniker, 0x79eac9c9, 0xbaf9, 0x11ce, 0x8c, 0x82, 0x00,
                0xaa, 0x00, 0x4b, 0xa9, 0x0b)
#endif
#else
typedef struct IPersistMonikerVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IPersistMoniker *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetClassID)(IPersistMoniker *This,
                                         CLSID *pClassID);
  HRESULT(STDMETHODCALLTYPE *IsDirty)(IPersistMoniker *This);
  HRESULT(STDMETHODCALLTYPE *Load)(IPersistMoniker *This,
                                   WINBOOL fFullyAvailable, IMoniker *pimkName,
                                   LPBC pibc, DWORD grfMode);
  HRESULT(STDMETHODCALLTYPE *Save)(IPersistMoniker *This, IMoniker *pimkName,
                                   LPBC pbc, WINBOOL fRemember);
  HRESULT(STDMETHODCALLTYPE *SaveCompleted)(IPersistMoniker *This,
                                            IMoniker *pimkName, LPBC pibc);
  HRESULT(STDMETHODCALLTYPE *GetCurMoniker)(IPersistMoniker *This,
                                            IMoniker **ppimkName);
  END_INTERFACE
} IPersistMonikerVtbl;
interface IPersistMoniker { CONST_VTBL IPersistMonikerVtbl *lpVtbl; };
#ifdef COBJMACROS
...
#else
/*** IUnknown methods ***/
static inline HRESULT IPersistMoniker_QueryInterface(IPersistMoniker *This,
                                                     REFIID riid,
                                                     void **ppvObject) {
...
/*** IPersistMoniker methods ***/
static inline HRESULT IPersistMoniker_GetClassID(IPersistMoniker *This,
                                                 CLSID *pClassID) {
...
static inline HRESULT IPersistMoniker_Load(IPersistMoniker *This,
                                           WINBOOL fFullyAvailable,
                                           IMoniker *pimkName, LPBC pibc,
                                           DWORD grfMode) {
  return This->lpVtbl->Load(This, fFullyAvailable, pimkName, pibc, grfMode);
}
static inline HRESULT IPersistMoniker_Save(IPersistMoniker *This,
                                           IMoniker *pimkName, LPBC pbc,
                                           WINBOOL fRemember) {
  return This->lpVtbl->Save(This, pimkName, pbc, fRemember);
}
static inline HRESULT IPersistMoniker_SaveCompleted(IPersistMoniker *This,
                                                    IMoniker *pimkName,
                                                    LPBC pibc) {
  return This->lpVtbl->SaveCompleted(This, pimkName, pibc);
}
static inline HRESULT IPersistMoniker_GetCurMoniker(IPersistMoniker *This,
                                                    IMoniker **ppimkName) {
...
DEFINE_GUID(IID_IMonikerProp, 0xa5ca5f7f, 0x1847, 0x4d87, 0x9c, 0x5b, 0x91,
            0x85, 0x09, 0xf7, 0x51, 0x1d);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("a5ca5f7f-1847-4d87-9c5b-918509f7511d")
IMonikerProp : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE PutProperty(MONIKERPROPERTY mkp,
                                                LPCWSTR val) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IMonikerProp, 0xa5ca5f7f, 0x1847, 0x4d87, 0x9c, 0x5b, 0x91,
                0x85, 0x09, 0xf7, 0x51, 0x1d)
#endif
#else
typedef struct IMonikerPropVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IMonikerProp *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IMonikerProp *This);
  ULONG(STDMETHODCALLTYPE *Release)(IMonikerProp *This);
  /*** IMonikerProp methods ***/
  HRESULT(STDMETHODCALLTYPE *PutProperty)(IMonikerProp *This,
                                          MONIKERPROPERTY mkp, LPCWSTR val);
  END_INTERFACE
} IMonikerPropVtbl;
interface IMonikerProp { CONST_VTBL IMonikerPropVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
IMonikerProp_QueryInterface(IMonikerProp *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IMonikerProp methods ***/
static inline HRESULT
IMonikerProp_PutProperty(IMonikerProp *This, MONIKERPROPERTY mkp, LPCWSTR val) {
...
DEFINE_GUID(IID_IBindProtocol, 0x79eac9cd, 0xbaf9, 0x11ce, 0x8c, 0x82, 0x00,
            0xaa, 0x00, 0x4b, 0xa9, 0x0b);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("79eac9cd-baf9-11ce-8c82-00aa004ba90b")
IBindProtocol : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE CreateBinding(LPCWSTR szUrl, IBindCtx * pbc,
                                                  IBinding * *ppb) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IBindProtocol, 0x79eac9cd, 0xbaf9, 0x11ce, 0x8c, 0x82, 0x00,
                0xaa, 0x00, 0x4b, 0xa9, 0x0b)
#endif
#else
typedef struct IBindProtocolVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IBindProtocol *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IBindProtocol *This);
  ULONG(STDMETHODCALLTYPE *Release)(IBindProtocol *This);
  /*** IBindProtocol methods ***/
  HRESULT(STDMETHODCALLTYPE *CreateBinding)(IBindProtocol *This, LPCWSTR szUrl,
                                            IBindCtx *pbc, IBinding **ppb);
  END_INTERFACE
} IBindProtocolVtbl;
interface IBindProtocol { CONST_VTBL IBindProtocolVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IBindProtocol_QueryInterface(IBindProtocol *This,
                                                   REFIID riid,
                                                   void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IBindProtocol methods ***/
static inline HRESULT IBindProtocol_CreateBinding(IBindProtocol *This,
                                                  LPCWSTR szUrl, IBindCtx *pbc,
                                                  IBinding **ppb) {
...
DEFINE_GUID(IID_IBinding, 0x79eac9c0, 0xbaf9, 0x11ce, 0x8c, 0x82, 0x00, 0xaa,
            0x00, 0x4b, 0xa9, 0x0b);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IBinding : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE SetPriority(LONG nPriority) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetPriority(LONG * pnPriority) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetBindResult(
      CLSID * pclsidProtocol, DWORD * pdwResult, LPOLESTR * pszResult,
      DWORD * pdwReserved) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IBinding, 0x79eac9c0, 0xbaf9, 0x11ce, 0x8c, 0x82, 0x00, 0xaa,
                0x00, 0x4b, 0xa9, 0x0b)
#endif
#else
typedef struct IBindingVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IBinding *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetBindResult)(IBinding *This,
...
interface IBinding { CONST_VTBL IBindingVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define IBinding_GetBindResult(This, pclsidProtocol, pdwResult, pszResult,     \
                               pdwReserved)                                    \
  (This)->lpVtbl->GetBindResult(This, pclsidProtocol, pdwResult, pszResult,    \
                                pdwReserved)
#else
/*** IUnknown methods ***/
static inline HRESULT IBinding_QueryInterface(IBinding *This, REFIID riid,
                                              void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
static inline HRESULT
IBinding_GetBindResult(IBinding *This, CLSID *pclsidProtocol, DWORD *pdwResult,
                       LPOLESTR *pszResult, DWORD *pdwReserved) {
  return This->lpVtbl->GetBindResult(This, pclsidProtocol, pdwResult, pszResult,
                                     pdwReserved);
}
#endif
#endif
...
HRESULT STDMETHODCALLTYPE IBinding_RemoteGetBindResult_Proxy(
    IBinding *This, CLSID *pclsidProtocol, DWORD *pdwResult,
...
DEFINE_GUID(IID_IBindStatusCallback, 0x79eac9c1, 0xbaf9, 0x11ce, 0x8c, 0x82,
...
IBindStatusCallback : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE OnStartBinding(DWORD dwReserved,
                                                   IBinding * pib) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetPriority(LONG * pnPriority) = 0;
  virtual HRESULT STDMETHODCALLTYPE OnLowResource(DWORD reserved) = 0;
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IBindStatusCallback, 0x79eac9c1, 0xbaf9, 0x11ce, 0x8c, 0x82,
                0x00, 0xaa, 0x00, 0x4b, 0xa9, 0x0b)
#endif
#else
typedef struct IBindStatusCallbackVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IBindStatusCallback *This,
  ...
  HRESULT(STDMETHODCALLTYPE *OnStartBinding)(IBindStatusCallback *This,
                                             DWORD dwReserved, IBinding *pib);
  HRESULT(STDMETHODCALLTYPE *GetPriority)(IBindStatusCallback *This,
                                          LONG *pnPriority);
  HRESULT(STDMETHODCALLTYPE *OnLowResource)(IBindStatusCallback *This,
                                            DWORD reserved);
  HRESULT(STDMETHODCALLTYPE *OnProgress)(IBindStatusCallback *This,
                                         ULONG ulProgress, ULONG ulProgressMax,
                                         ULONG ulStatusCode,
                                         LPCWSTR szStatusText);
  HRESULT(STDMETHODCALLTYPE *OnStopBinding)(IBindStatusCallback *This,
                                            HRESULT hresult, LPCWSTR szError);
  HRESULT(STDMETHODCALLTYPE *GetBindInfo)(IBindStatusCallback *This,
                                          DWORD *grfBINDF, BINDINFO *pbindinfo);
  HRESULT(STDMETHODCALLTYPE *OnDataAvailable)(IBindStatusCallback *This,
                                              DWORD grfBSCF, DWORD dwSize,
                                              FORMATETC *pformatetc,
                                              STGMEDIUM *pstgmed);
  HRESULT(STDMETHODCALLTYPE *OnObjectAvailable)(IBindStatusCallback *This,
                                                REFIID riid, IUnknown *punk);
  END_INTERFACE
} IBindStatusCallbackVtbl;
interface IBindStatusCallback { CONST_VTBL IBindStatusCallbackVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define IBindStatusCallback_OnProgress(This, ulProgress, ulProgressMax,        \
                                       ulStatusCode, szStatusText)             \
  (This)->lpVtbl->OnProgress(This, ulProgress, ulProgressMax, ulStatusCode,    \
                             szStatusText)
...
#define IBindStatusCallback_OnDataAvailable(This, grfBSCF, dwSize, pformatetc, \
                                            pstgmed)                           \
...
/*** IUnknown methods ***/
static inline HRESULT
IBindStatusCallback_QueryInterface(IBindStatusCallback *This, REFIID riid,
                                   void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IBindStatusCallback methods ***/
static inline HRESULT
IBindStatusCallback_OnStartBinding(IBindStatusCallback *This, DWORD dwReserved,
                                   IBinding *pib) {
  return This->lpVtbl->OnStartBinding(This, dwReserved, pib);
}
static inline HRESULT IBindStatusCallback_GetPriority(IBindStatusCallback *This,
                                                      LONG *pnPriority) {
  return This->lpVtbl->GetPriority(This, pnPriority);
}
static inline HRESULT
IBindStatusCallback_OnLowResource(IBindStatusCallback *This, DWORD reserved) {
  return This->lpVtbl->OnLowResource(This, reserved);
}
static inline HRESULT IBindStatusCallback_OnProgress(IBindStatusCallback *This,
                                                     ULONG ulProgress,
                                                     ULONG ulProgressMax,
                                                     ULONG ulStatusCode,
                                                     LPCWSTR szStatusText) {
  return This->lpVtbl->OnProgress(This, ulProgress, ulProgressMax, ulStatusCode,
                                  szStatusText);
}
static inline HRESULT
IBindStatusCallback_OnStopBinding(IBindStatusCallback *This, HRESULT hresult,
                                  LPCWSTR szError) {
  return This->lpVtbl->OnStopBinding(This, hresult, szError);
}
static inline HRESULT IBindStatusCallback_GetBindInfo(IBindStatusCallback *This,
                                                      DWORD *grfBINDF,
                                                      BINDINFO *pbindinfo) {
  return This->lpVtbl->GetBindInfo(This, grfBINDF, pbindinfo);
}
static inline HRESULT
IBindStatusCallback_OnDataAvailable(IBindStatusCallback *This, DWORD grfBSCF,
                                    DWORD dwSize, FORMATETC *pformatetc,
                                    STGMEDIUM *pstgmed) {
  return This->lpVtbl->OnDataAvailable(This, grfBSCF, dwSize, pformatetc,
                                       pstgmed);
}
static inline HRESULT
IBindStatusCallback_OnObjectAvailable(IBindStatusCallback *This, REFIID riid,
                                      IUnknown *punk) {
...
HRESULT STDMETHODCALLTYPE IBindStatusCallback_RemoteGetBindInfo_Proxy(
    IBindStatusCallback *This, DWORD *grfBINDF, RemBINDINFO *pbindinfo,
...
DEFINE_GUID(IID_IBindStatusCallbackEx, 0xaaa74ef9, 0x8ee7, 0x4659, 0x88, 0xd9,
            0xf8, 0xc5, 0x04, 0xda, 0x73, 0xcc);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IBindStatusCallbackEx : public IBindStatusCallback {
  virtual HRESULT STDMETHODCALLTYPE GetBindInfoEx(
      DWORD * grfBINDF, BINDINFO * pbindinfo, DWORD * grfBINDF2,
      DWORD * pdwReserved) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IBindStatusCallbackEx, 0xaaa74ef9, 0x8ee7, 0x4659, 0x88, 0xd9,
                0xf8, 0xc5, 0x04, 0xda, 0x73, 0xcc)
#endif
#else
typedef struct IBindStatusCallbackExVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IBindStatusCallbackEx *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IBindStatusCallbackEx *This);
  ULONG(STDMETHODCALLTYPE *Release)(IBindStatusCallbackEx *This);
  /*** IBindStatusCallback methods ***/
  HRESULT(STDMETHODCALLTYPE *OnStartBinding)(IBindStatusCallbackEx *This,
                                             DWORD dwReserved, IBinding *pib);
  HRESULT(STDMETHODCALLTYPE *GetPriority)(IBindStatusCallbackEx *This,
                                          LONG *pnPriority);
  HRESULT(STDMETHODCALLTYPE *OnLowResource)(IBindStatusCallbackEx *This,
                                            DWORD reserved);
  HRESULT(STDMETHODCALLTYPE *OnProgress)(IBindStatusCallbackEx *This,
                                         ULONG ulProgress, ULONG ulProgressMax,
                                         ULONG ulStatusCode,
                                         LPCWSTR szStatusText);
  HRESULT(STDMETHODCALLTYPE *OnStopBinding)(IBindStatusCallbackEx *This,
                                            HRESULT hresult, LPCWSTR szError);
  HRESULT(STDMETHODCALLTYPE *GetBindInfo)(IBindStatusCallbackEx *This,
                                          DWORD *grfBINDF, BINDINFO *pbindinfo);
  HRESULT(STDMETHODCALLTYPE *OnDataAvailable)(IBindStatusCallbackEx *This,
                                              DWORD grfBSCF, DWORD dwSize,
                                              FORMATETC *pformatetc,
                                              STGMEDIUM *pstgmed);
  HRESULT(STDMETHODCALLTYPE *OnObjectAvailable)(IBindStatusCallbackEx *This,
                                                REFIID riid, IUnknown *punk);
  /*** IBindStatusCallbackEx methods ***/
  HRESULT(STDMETHODCALLTYPE *GetBindInfoEx)(IBindStatusCallbackEx *This,
                                            DWORD *grfBINDF,
                                            BINDINFO *pbindinfo,
                                            DWORD *grfBINDF2,
                                            DWORD *pdwReserved);
...
#define IBindStatusCallbackEx_OnLowResource(This, reserved)                    \
  (This)->lpVtbl->OnLowResource(This, reserved)
#define IBindStatusCallbackEx_OnProgress(This, ulProgress, ulProgressMax,      \
                                         ulStatusCode, szStatusText)           \
  (This)->lpVtbl->OnProgress(This, ulProgress, ulProgressMax, ulStatusCode,    \
                             szStatusText)
...
#define IBindStatusCallbackEx_GetBindInfo(This, grfBINDF, pbindinfo)           \
  (This)->lpVtbl->GetBindInfo(This, grfBINDF, pbindinfo)
#define IBindStatusCallbackEx_OnDataAvailable(This, grfBSCF, dwSize,           \
                                              pformatetc, pstgmed)             \
  (This)->lpVtbl->OnDataAvailable(This, grfBSCF, dwSize, pformatetc, pstgmed)
#define IBindStatusCallbackEx_OnObjectAvailable(This, riid, punk)              \
  (This)->lpVtbl->OnObjectAvailable(This, riid, punk)
/*** IBindStatusCallbackEx methods ***/
#define IBindStatusCallbackEx_GetBindInfoEx(This, grfBINDF, pbindinfo,         \
                                            grfBINDF2, pdwReserved)            \
  (This)->lpVtbl->GetBindInfoEx(This, grfBINDF, pbindinfo, grfBINDF2,          \
                                pdwReserved)
#else
/*** IUnknown methods ***/
static inline HRESULT
IBindStatusCallbackEx_QueryInterface(IBindStatusCallbackEx *This, REFIID riid,
                                     void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IBindStatusCallback methods ***/
static inline HRESULT
IBindStatusCallbackEx_OnStartBinding(IBindStatusCallbackEx *This,
                                     DWORD dwReserved, IBinding *pib) {
  return This->lpVtbl->OnStartBinding(This, dwReserved, pib);
}
static inline HRESULT
IBindStatusCallbackEx_GetPriority(IBindStatusCallbackEx *This,
                                  LONG *pnPriority) {
  return This->lpVtbl->GetPriority(This, pnPriority);
}
static inline HRESULT
IBindStatusCallbackEx_OnLowResource(IBindStatusCallbackEx *This,
                                    DWORD reserved) {
  return This->lpVtbl->OnLowResource(This, reserved);
}
static inline HRESULT
IBindStatusCallbackEx_OnProgress(IBindStatusCallbackEx *This, ULONG ulProgress,
...
static inline HRESULT
IBindStatusCallbackEx_OnStopBinding(IBindStatusCallbackEx *This,
                                    HRESULT hresult, LPCWSTR szError) {
  return This->lpVtbl->OnStopBinding(This, hresult, szError);
}
static inline HRESULT
IBindStatusCallbackEx_GetBindInfo(IBindStatusCallbackEx *This, DWORD *grfBINDF,
                                  BINDINFO *pbindinfo) {
  return This->lpVtbl->GetBindInfo(This, grfBINDF, pbindinfo);
}
static inline HRESULT IBindStatusCallbackEx_OnDataAvailable(
    IBindStatusCallbackEx *This, DWORD grfBSCF, DWORD dwSize,
    FORMATETC *pformatetc, STGMEDIUM *pstgmed) {
  return This->lpVtbl->OnDataAvailable(This, grfBSCF, dwSize, pformatetc,
                                       pstgmed);
}
static inline HRESULT
IBindStatusCallbackEx_OnObjectAvailable(IBindStatusCallbackEx *This,
                                        REFIID riid, IUnknown *punk) {
  return This->lpVtbl->OnObjectAvailable(This, riid, punk);
}
/*** IBindStatusCallbackEx methods ***/
static inline HRESULT
IBindStatusCallbackEx_GetBindInfoEx(IBindStatusCallbackEx *This,
                                    DWORD *grfBINDF, BINDINFO *pbindinfo,
                                    DWORD *grfBINDF2, DWORD *pdwReserved) {
  return This->lpVtbl->GetBindInfoEx(This, grfBINDF, pbindinfo, grfBINDF2,
                                     pdwReserved);
}
#endif
#endif
...
DEFINE_GUID(IID_IAuthenticate, 0x79eac9d0, 0xbaf9, 0x11ce, 0x8c, 0x82, 0x00,
            0xaa, 0x00, 0x4b, 0xa9, 0x0b);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("79eac9d0-baf9-11ce-8c82-00aa004ba90b")
IAuthenticate : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE Authenticate(
      HWND * phwnd, LPWSTR * pszUsername, LPWSTR * pszPassword) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IAuthenticate, 0x79eac9d0, 0xbaf9, 0x11ce, 0x8c, 0x82, 0x00,
                0xaa, 0x00, 0x4b, 0xa9, 0x0b)
#endif
#else
typedef struct IAuthenticateVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAuthenticate *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IAuthenticate *This);
  ULONG(STDMETHODCALLTYPE *Release)(IAuthenticate *This);
  /*** IAuthenticate methods ***/
  HRESULT(STDMETHODCALLTYPE *Authenticate)(IAuthenticate *This, HWND *phwnd,
                                           LPWSTR *pszUsername,
                                           LPWSTR *pszPassword);
  END_INTERFACE
} IAuthenticateVtbl;
interface IAuthenticate { CONST_VTBL IAuthenticateVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IAuthenticate_QueryInterface(IAuthenticate *This,
                                                   REFIID riid,
                                                   void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IAuthenticate methods ***/
static inline HRESULT IAuthenticate_Authenticate(IAuthenticate *This,
                                                 HWND *phwnd,
                                                 LPWSTR *pszUsername,
                                                 LPWSTR *pszPassword) {
...
DEFINE_GUID(IID_IAuthenticateEx, 0x2ad1edaf, 0xd83d, 0x48b5, 0x9a, 0xdf, 0x03,
            0xdb, 0xe1, 0x9f, 0x53, 0xbd);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IAuthenticateEx, 0x2ad1edaf, 0xd83d, 0x48b5, 0x9a, 0xdf, 0x03,
                0xdb, 0xe1, 0x9f, 0x53, 0xbd)
#endif
#else
typedef struct IAuthenticateExVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IAuthenticateEx *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IAuthenticateEx *This);
  ULONG(STDMETHODCALLTYPE *Release)(IAuthenticateEx *This);
  /*** IAuthenticate methods ***/
  HRESULT(STDMETHODCALLTYPE *Authenticate)(IAuthenticateEx *This, HWND *phwnd,
                                           LPWSTR *pszUsername,
                                           LPWSTR *pszPassword);
  /*** IAuthenticateEx methods ***/
  HRESULT(STDMETHODCALLTYPE *AuthenticateEx)(IAuthenticateEx *This, HWND *phwnd,
                                             LPWSTR *pszUsername,
                                             LPWSTR *pszPassword,
                                             AUTHENTICATEINFO *pauthinfo);
  END_INTERFACE
} IAuthenticateExVtbl;
interface IAuthenticateEx { CONST_VTBL IAuthenticateExVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define IAuthenticateEx_Authenticate(This, phwnd, pszUsername, pszPassword)    \
  (This)->lpVtbl->Authenticate(This, phwnd, pszUsername, pszPassword)
/*** IAuthenticateEx methods ***/
#define IAuthenticateEx_AuthenticateEx(This, phwnd, pszUsername, pszPassword,  \
                                       pauthinfo)                              \
  (This)->lpVtbl->AuthenticateEx(This, phwnd, pszUsername, pszPassword,        \
                                 pauthinfo)
#else
/*** IUnknown methods ***/
static inline HRESULT IAuthenticateEx_QueryInterface(IAuthenticateEx *This,
                                                     REFIID riid,
                                                     void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IAuthenticate methods ***/
static inline HRESULT IAuthenticateEx_Authenticate(IAuthenticateEx *This,
                                                   HWND *phwnd,
                                                   LPWSTR *pszUsername,
                                                   LPWSTR *pszPassword) {
  return This->lpVtbl->Authenticate(This, phwnd, pszUsername, pszPassword);
...
/*** IAuthenticateEx methods ***/
static inline HRESULT
IAuthenticateEx_AuthenticateEx(IAuthenticateEx *This, HWND *phwnd,
                               LPWSTR *pszUsername, LPWSTR *pszPassword,
                               AUTHENTICATEINFO *pauthinfo) {
  return This->lpVtbl->AuthenticateEx(This, phwnd, pszUsername, pszPassword,
                                      pauthinfo);
}
#endif
#endif
...
DEFINE_GUID(IID_IHttpNegotiate, 0x79eac9d2, 0xbaf9, 0x11ce, 0x8c, 0x82, 0x00,
            0xaa, 0x00, 0x4b, 0xa9, 0x0b);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("79eac9d2-baf9-11ce-8c82-00aa004ba90b")
IHttpNegotiate : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE BeginningTransaction(
      LPCWSTR szURL, LPCWSTR szHeaders, DWORD dwReserved,
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IHttpNegotiate, 0x79eac9d2, 0xbaf9, 0x11ce, 0x8c, 0x82, 0x00,
                0xaa, 0x00, 0x4b, 0xa9, 0x0b)
#endif
#else
typedef struct IHttpNegotiateVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IHttpNegotiate *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *BeginningTransaction)(
      IHttpNegotiate *This, LPCWSTR szURL, LPCWSTR szHeaders, DWORD dwReserved,
      LPWSTR *pszAdditionalHeaders);
  HRESULT(STDMETHODCALLTYPE *OnResponse)(IHttpNegotiate *This,
...
interface IHttpNegotiate { CONST_VTBL IHttpNegotiateVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IHttpNegotiate methods ***/
#define IHttpNegotiate_BeginningTransaction(This, szURL, szHeaders,            \
                                            dwReserved, pszAdditionalHeaders)  \
  (This)->lpVtbl->BeginningTransaction(This, szURL, szHeaders, dwReserved,     \
                                       pszAdditionalHeaders)
#define IHttpNegotiate_OnResponse(This, dwResponseCode, szResponseHeaders,     \
                                  szRequestHeaders,                            \
                                  pszAdditionalRequestHeaders)                 \
  (This)->lpVtbl->OnResponse(This, dwResponseCode, szResponseHeaders,          \
                             szRequestHeaders, pszAdditionalRequestHeaders)
#else
/*** IUnknown methods ***/
static inline HRESULT IHttpNegotiate_QueryInterface(IHttpNegotiate *This,
                                                    REFIID riid,
                                                    void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IHttpNegotiate methods ***/
static inline HRESULT
IHttpNegotiate_BeginningTransaction(IHttpNegotiate *This, LPCWSTR szURL,
                                    LPCWSTR szHeaders, DWORD dwReserved,
                                    LPWSTR *pszAdditionalHeaders) {
  return This->lpVtbl->BeginningTransaction(This, szURL, szHeaders, dwReserved,
                                            pszAdditionalHeaders);
}
static inline HRESULT
IHttpNegotiate_OnResponse(IHttpNegotiate *This, DWORD dwResponseCode,
                          LPCWSTR szResponseHeaders, LPCWSTR szRequestHeaders,
                          LPWSTR *pszAdditionalRequestHeaders) {
  return This->lpVtbl->OnResponse(This, dwResponseCode, szResponseHeaders,
                                  szRequestHeaders,
                                  pszAdditionalRequestHeaders);
}
#endif
...
DEFINE_GUID(IID_IHttpNegotiate2, 0x4f9f9fcb, 0xe0f4, 0x48eb, 0xb7, 0xab, 0xfa,
            0x2e, 0xa9, 0x36, 0x5c, 0xb4);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IHttpNegotiate2 : public IHttpNegotiate {
  virtual HRESULT STDMETHODCALLTYPE GetRootSecurityId(
      BYTE * pbSecurityId, DWORD * pcbSecurityId, DWORD_PTR dwReserved) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IHttpNegotiate2, 0x4f9f9fcb, 0xe0f4, 0x48eb, 0xb7, 0xab, 0xfa,
                0x2e, 0xa9, 0x36, 0x5c, 0xb4)
#endif
#else
typedef struct IHttpNegotiate2Vtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IHttpNegotiate2 *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IHttpNegotiate2 *This);
  ULONG(STDMETHODCALLTYPE *Release)(IHttpNegotiate2 *This);
  /*** IHttpNegotiate methods ***/
  HRESULT(STDMETHODCALLTYPE *BeginningTransaction)(
      IHttpNegotiate2 *This, LPCWSTR szURL, LPCWSTR szHeaders, DWORD dwReserved,
      LPWSTR *pszAdditionalHeaders);
  HRESULT(STDMETHODCALLTYPE *OnResponse)(IHttpNegotiate2 *This,
                                         DWORD dwResponseCode,
                                         LPCWSTR szResponseHeaders,
                                         LPCWSTR szRequestHeaders,
                                         LPWSTR *pszAdditionalRequestHeaders);
  /*** IHttpNegotiate2 methods ***/
  HRESULT(STDMETHODCALLTYPE *GetRootSecurityId)(IHttpNegotiate2 *This,
                                                BYTE *pbSecurityId,
                                                DWORD *pcbSecurityId,
                                                DWORD_PTR dwReserved);
  END_INTERFACE
} IHttpNegotiate2Vtbl;
interface IHttpNegotiate2 { CONST_VTBL IHttpNegotiate2Vtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IHttpNegotiate methods ***/
#define IHttpNegotiate2_BeginningTransaction(This, szURL, szHeaders,           \
                                             dwReserved, pszAdditionalHeaders) \
  (This)->lpVtbl->BeginningTransaction(This, szURL, szHeaders, dwReserved,     \
                                       pszAdditionalHeaders)
#define IHttpNegotiate2_OnResponse(This, dwResponseCode, szResponseHeaders,    \
                                   szRequestHeaders,                           \
                                   pszAdditionalRequestHeaders)                \
  (This)->lpVtbl->OnResponse(This, dwResponseCode, szResponseHeaders,          \
                             szRequestHeaders, pszAdditionalRequestHeaders)
/*** IHttpNegotiate2 methods ***/
#define IHttpNegotiate2_GetRootSecurityId(This, pbSecurityId, pcbSecurityId,   \
                                          dwReserved)                          \
  (This)->lpVtbl->GetRootSecurityId(This, pbSecurityId, pcbSecurityId,         \
                                    dwReserved)
#else
/*** IUnknown methods ***/
static inline HRESULT IHttpNegotiate2_QueryInterface(IHttpNegotiate2 *This,
                                                     REFIID riid,
                                                     void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IHttpNegotiate methods ***/
static inline HRESULT
IHttpNegotiate2_BeginningTransaction(IHttpNegotiate2 *This, LPCWSTR szURL,
                                     LPCWSTR szHeaders, DWORD dwReserved,
                                     LPWSTR *pszAdditionalHeaders) {
  return This->lpVtbl->BeginningTransaction(This, szURL, szHeaders, dwReserved,
                                            pszAdditionalHeaders);
...
static inline HRESULT
IHttpNegotiate2_OnResponse(IHttpNegotiate2 *This, DWORD dwResponseCode,
                           LPCWSTR szResponseHeaders, LPCWSTR szRequestHeaders,
                           LPWSTR *pszAdditionalRequestHeaders) {
  return This->lpVtbl->OnResponse(This, dwResponseCode, szResponseHeaders,
                                  szRequestHeaders,
...
/*** IHttpNegotiate2 methods ***/
static inline HRESULT IHttpNegotiate2_GetRootSecurityId(IHttpNegotiate2 *This,
                                                        BYTE *pbSecurityId,
                                                        DWORD *pcbSecurityId,
                                                        DWORD_PTR dwReserved) {
  return This->lpVtbl->GetRootSecurityId(This, pbSecurityId, pcbSecurityId,
                                         dwReserved);
}
#endif
#endif
...
DEFINE_GUID(IID_IHttpNegotiate3, 0x57b6c80a, 0x34c2, 0x4602, 0xbc, 0x26, 0x66,
            0xa0, 0x2f, 0xc5, 0x71, 0x53);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IHttpNegotiate3 : public IHttpNegotiate2 {
  virtual HRESULT STDMETHODCALLTYPE GetSerializedClientCertContext(
      BYTE * *ppbCert, DWORD * pcbCert) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IHttpNegotiate3, 0x57b6c80a, 0x34c2, 0x4602, 0xbc, 0x26, 0x66,
                0xa0, 0x2f, 0xc5, 0x71, 0x53)
#endif
#else
typedef struct IHttpNegotiate3Vtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IHttpNegotiate3 *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IHttpNegotiate3 *This);
  ULONG(STDMETHODCALLTYPE *Release)(IHttpNegotiate3 *This);
  /*** IHttpNegotiate methods ***/
  HRESULT(STDMETHODCALLTYPE *BeginningTransaction)(
      IHttpNegotiate3 *This, LPCWSTR szURL, LPCWSTR szHeaders, DWORD dwReserved,
      LPWSTR *pszAdditionalHeaders);
  HRESULT(STDMETHODCALLTYPE *OnResponse)(IHttpNegotiate3 *This,
                                         DWORD dwResponseCode,
                                         LPCWSTR szResponseHeaders,
                                         LPCWSTR szRequestHeaders,
                                         LPWSTR *pszAdditionalRequestHeaders);
  /*** IHttpNegotiate2 methods ***/
  HRESULT(STDMETHODCALLTYPE *GetRootSecurityId)(IHttpNegotiate3 *This,
                                                BYTE *pbSecurityId,
                                                DWORD *pcbSecurityId,
                                                DWORD_PTR dwReserved);
...
interface IHttpNegotiate3 { CONST_VTBL IHttpNegotiate3Vtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IHttpNegotiate methods ***/
#define IHttpNegotiate3_BeginningTransaction(This, szURL, szHeaders,           \
                                             dwReserved, pszAdditionalHeaders) \
  (This)->lpVtbl->BeginningTransaction(This, szURL, szHeaders, dwReserved,     \
                                       pszAdditionalHeaders)
#define IHttpNegotiate3_OnResponse(This, dwResponseCode, szResponseHeaders,    \
                                   szRequestHeaders,                           \
                                   pszAdditionalRequestHeaders)                \
  (This)->lpVtbl->OnResponse(This, dwResponseCode, szResponseHeaders,          \
                             szRequestHeaders, pszAdditionalRequestHeaders)
/*** IHttpNegotiate2 methods ***/
#define IHttpNegotiate3_GetRootSecurityId(This, pbSecurityId, pcbSecurityId,   \
                                          dwReserved)                          \
  (This)->lpVtbl->GetRootSecurityId(This, pbSecurityId, pcbSecurityId,         \
                                    dwReserved)
/*** IHttpNegotiate3 methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IHttpNegotiate3_QueryInterface(IHttpNegotiate3 *This,
                                                     REFIID riid,
                                                     void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IHttpNegotiate methods ***/
static inline HRESULT
IHttpNegotiate3_BeginningTransaction(IHttpNegotiate3 *This, LPCWSTR szURL,
                                     LPCWSTR szHeaders, DWORD dwReserved,
                                     LPWSTR *pszAdditionalHeaders) {
  return This->lpVtbl->BeginningTransaction(This, szURL, szHeaders, dwReserved,
                                            pszAdditionalHeaders);
...
static inline HRESULT
IHttpNegotiate3_OnResponse(IHttpNegotiate3 *This, DWORD dwResponseCode,
                           LPCWSTR szResponseHeaders, LPCWSTR szRequestHeaders,
                           LPWSTR *pszAdditionalRequestHeaders) {
  return This->lpVtbl->OnResponse(This, dwResponseCode, szResponseHeaders,
                                  szRequestHeaders,
...
/*** IHttpNegotiate2 methods ***/
static inline HRESULT IHttpNegotiate3_GetRootSecurityId(IHttpNegotiate3 *This,
                                                        BYTE *pbSecurityId,
                                                        DWORD *pcbSecurityId,
                                                        DWORD_PTR dwReserved) {
  return This->lpVtbl->GetRootSecurityId(This, pbSecurityId, pcbSecurityId,
...
/*** IHttpNegotiate3 methods ***/
static inline HRESULT
IHttpNegotiate3_GetSerializedClientCertContext(IHttpNegotiate3 *This,
                                               BYTE **ppbCert, DWORD *pcbCert) {
...
DEFINE_GUID(IID_IWinInetFileStream, 0xf134c4b7, 0xb1f8, 0x4e75, 0xb8, 0x86,
            0x74, 0xb9, 0x09, 0x43, 0xbe, 0xcb);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IWinInetFileStream : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE SetHandleForUnlock(
      DWORD_PTR hWinInetLockHandle, DWORD_PTR dwReserved) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetDeleteFile(DWORD_PTR dwReserved) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IWinInetFileStream, 0xf134c4b7, 0xb1f8, 0x4e75, 0xb8, 0x86,
                0x74, 0xb9, 0x09, 0x43, 0xbe, 0xcb)
#endif
#else
typedef struct IWinInetFileStreamVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWinInetFileStream *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *SetHandleForUnlock)(IWinInetFileStream *This,
                                                 DWORD_PTR hWinInetLockHandle,
                                                 DWORD_PTR dwReserved);
  HRESULT(STDMETHODCALLTYPE *SetDeleteFile)(IWinInetFileStream *This,
                                            DWORD_PTR dwReserved);
  END_INTERFACE
} IWinInetFileStreamVtbl;
interface IWinInetFileStream { CONST_VTBL IWinInetFileStreamVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IWinInetFileStream methods ***/
#define IWinInetFileStream_SetHandleForUnlock(This, hWinInetLockHandle,        \
                                              dwReserved)                      \
...
/*** IUnknown methods ***/
static inline HRESULT
IWinInetFileStream_QueryInterface(IWinInetFileStream *This, REFIID riid,
                                  void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IWinInetFileStream methods ***/
static inline HRESULT
IWinInetFileStream_SetHandleForUnlock(IWinInetFileStream *This,
                                      DWORD_PTR hWinInetLockHandle,
                                      DWORD_PTR dwReserved) {
  return This->lpVtbl->SetHandleForUnlock(This, hWinInetLockHandle, dwReserved);
}
static inline HRESULT IWinInetFileStream_SetDeleteFile(IWinInetFileStream *This,
                                                       DWORD_PTR dwReserved) {
...
DEFINE_GUID(IID_IWindowForBindingUI, 0x79eac9d5, 0xbafa, 0x11ce, 0x8c, 0x82,
            0x00, 0xaa, 0x00, 0x4b, 0xa9, 0x0b);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("79eac9d5-bafa-11ce-8c82-00aa004ba90b")
IWindowForBindingUI : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetWindow(REFGUID rguidReason,
                                              HWND * phwnd) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IWindowForBindingUI, 0x79eac9d5, 0xbafa, 0x11ce, 0x8c, 0x82,
                0x00, 0xaa, 0x00, 0x4b, 0xa9, 0x0b)
#endif
#else
typedef struct IWindowForBindingUIVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWindowForBindingUI *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IWindowForBindingUI *This);
  ULONG(STDMETHODCALLTYPE *Release)(IWindowForBindingUI *This);
  /*** IWindowForBindingUI methods ***/
  HRESULT(STDMETHODCALLTYPE *GetWindow)(IWindowForBindingUI *This,
                                        REFGUID rguidReason, HWND *phwnd);
  END_INTERFACE
} IWindowForBindingUIVtbl;
interface IWindowForBindingUI { CONST_VTBL IWindowForBindingUIVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
IWindowForBindingUI_QueryInterface(IWindowForBindingUI *This, REFIID riid,
                                   void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IWindowForBindingUI methods ***/
static inline HRESULT IWindowForBindingUI_GetWindow(IWindowForBindingUI *This,
                                                    REFGUID rguidReason,
                                                    HWND *phwnd) {
...
DEFINE_GUID(IID_ICodeInstall, 0x79eac9d1, 0xbaf9, 0x11ce, 0x8c, 0x82, 0x00,
            0xaa, 0x00, 0x4b, 0xa9, 0x0b);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
ICodeInstall : public IWindowForBindingUI {
  virtual HRESULT STDMETHODCALLTYPE OnCodeInstallProblem(
      ULONG ulStatusCode, LPCWSTR szDestination, LPCWSTR szSource,
      DWORD dwReserved) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ICodeInstall, 0x79eac9d1, 0xbaf9, 0x11ce, 0x8c, 0x82, 0x00,
                0xaa, 0x00, 0x4b, 0xa9, 0x0b)
#endif
#else
typedef struct ICodeInstallVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ICodeInstall *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(ICodeInstall *This);
  ULONG(STDMETHODCALLTYPE *Release)(ICodeInstall *This);
  /*** IWindowForBindingUI methods ***/
  HRESULT(STDMETHODCALLTYPE *GetWindow)(ICodeInstall *This, REFGUID rguidReason,
                                        HWND *phwnd);
  /*** ICodeInstall methods ***/
  HRESULT(STDMETHODCALLTYPE *OnCodeInstallProblem)(ICodeInstall *This,
                                                   ULONG ulStatusCode,
...
interface ICodeInstall { CONST_VTBL ICodeInstallVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define ICodeInstall_GetWindow(This, rguidReason, phwnd)                       \
  (This)->lpVtbl->GetWindow(This, rguidReason, phwnd)
/*** ICodeInstall methods ***/
#define ICodeInstall_OnCodeInstallProblem(This, ulStatusCode, szDestination,   \
                                          szSource, dwReserved)                \
  (This)->lpVtbl->OnCodeInstallProblem(This, ulStatusCode, szDestination,      \
                                       szSource, dwReserved)
#else
/*** IUnknown methods ***/
static inline HRESULT
ICodeInstall_QueryInterface(ICodeInstall *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IWindowForBindingUI methods ***/
static inline HRESULT ICodeInstall_GetWindow(ICodeInstall *This,
                                             REFGUID rguidReason, HWND *phwnd) {
  return This->lpVtbl->GetWindow(This, rguidReason, phwnd);
}
/*** ICodeInstall methods ***/
static inline HRESULT ICodeInstall_OnCodeInstallProblem(ICodeInstall *This,
                                                        ULONG ulStatusCode,
                                                        LPCWSTR szDestination,
                                                        LPCWSTR szSource,
                                                        DWORD dwReserved) {
  return This->lpVtbl->OnCodeInstallProblem(This, ulStatusCode, szDestination,
                                            szSource, dwReserved);
}
#endif
#endif
...
DEFINE_GUID(IID_IUri, 0xa39ee748, 0x6a27, 0x4817, 0xa6, 0xf2, 0x13, 0x91, 0x4b,
            0xef, 0x58, 0x90);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("a39ee748-6a27-4817-a6f2-13914bef5890")
IUri : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetPropertyBSTR(
      Uri_PROPERTY uriProp, BSTR * pbstrProperty, DWORD dwFlags) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetPropertyLength(
      Uri_PROPERTY uriProp, DWORD * pcchProperty, DWORD dwFlags) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetPropertyDWORD(
      Uri_PROPERTY uriProp, DWORD * pdwProperty, DWORD dwFlags) = 0;
  virtual HRESULT STDMETHODCALLTYPE HasProperty(Uri_PROPERTY uriProp,
  ...
  virtual HRESULT STDMETHODCALLTYPE GetDisplayUri(BSTR *
                                                  pbstrDisplayString) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetPathAndQuery(BSTR *
                                                    pbstrPathAndQuery) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE IsEqual(IUri * pUri, WINBOOL * pfEqual) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IUri, 0xa39ee748, 0x6a27, 0x4817, 0xa6, 0xf2, 0x13, 0x91, 0x4b,
                0xef, 0x58, 0x90)
#endif
#else
typedef struct IUriVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IUri *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IUri *This);
  ULONG(STDMETHODCALLTYPE *Release)(IUri *This);
  /*** IUri methods ***/
  HRESULT(STDMETHODCALLTYPE *GetPropertyBSTR)(IUri *This, Uri_PROPERTY uriProp,
                                              BSTR *pbstrProperty,
                                              DWORD dwFlags);
  HRESULT(STDMETHODCALLTYPE *GetPropertyLength)(IUri *This,
                                                Uri_PROPERTY uriProp,
                                                DWORD *pcchProperty,
                                                DWORD dwFlags);
  HRESULT(STDMETHODCALLTYPE *GetPropertyDWORD)(IUri *This, Uri_PROPERTY uriProp,
                                               DWORD *pdwProperty,
                                               DWORD dwFlags);
  HRESULT(STDMETHODCALLTYPE *HasProperty)(IUri *This, Uri_PROPERTY uriProp,
                                          WINBOOL *pfHasProperty);
  HRESULT(STDMETHODCALLTYPE *GetAbsoluteUri)(IUri *This,
                                             BSTR *pbstrAbsoluteUri);
  HRESULT(STDMETHODCALLTYPE *GetAuthority)(IUri *This, BSTR *pbstrAuthority);
  HRESULT(STDMETHODCALLTYPE *GetDisplayUri)(IUri *This,
  ...
  HRESULT(STDMETHODCALLTYPE *GetPathAndQuery)(IUri *This,
  ...
  HRESULT(STDMETHODCALLTYPE *IsEqual)(IUri *This, IUri *pUri, WINBOOL *pfEqual);
  END_INTERFACE
} IUriVtbl;
interface IUri { CONST_VTBL IUriVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IUri_QueryInterface(IUri *This, REFIID riid,
                                          void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IUri methods ***/
static inline HRESULT IUri_GetPropertyBSTR(IUri *This, Uri_PROPERTY uriProp,
                                           BSTR *pbstrProperty, DWORD dwFlags) {
  return This->lpVtbl->GetPropertyBSTR(This, uriProp, pbstrProperty, dwFlags);
}
static inline HRESULT IUri_GetPropertyLength(IUri *This, Uri_PROPERTY uriProp,
                                             DWORD *pcchProperty,
                                             DWORD dwFlags) {
  return This->lpVtbl->GetPropertyLength(This, uriProp, pcchProperty, dwFlags);
}
static inline HRESULT IUri_GetPropertyDWORD(IUri *This, Uri_PROPERTY uriProp,
                                            DWORD *pdwProperty, DWORD dwFlags) {
  return This->lpVtbl->GetPropertyDWORD(This, uriProp, pdwProperty, dwFlags);
}
static inline HRESULT IUri_HasProperty(IUri *This, Uri_PROPERTY uriProp,
                                       WINBOOL *pfHasProperty) {
...
static inline HRESULT IUri_GetPathAndQuery(IUri *This,
                                           BSTR *pbstrPathAndQuery) {
...
STDAPI CreateUri(LPCWSTR pwzURI, DWORD dwFlags, DWORD_PTR dwReserved,
                 IUri **ppURI);
STDAPI CreateUriWithFragment(LPCWSTR pwzURI, LPCWSTR pwzFragment, DWORD dwFlags,
                             DWORD_PTR dwReserved, IUri **ppURI);
#endif
#if WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_DESKTOP)
STDAPI CreateUriFromMultiByteString(LPCSTR pszANSIInputUri,
                                    DWORD dwEncodingFlags, DWORD dwCodePage,
                                    DWORD dwCreateFlags, DWORD_PTR dwReserved,
                                    IUri **ppUri);
#endif
#if WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_APP)
...
DEFINE_GUID(IID_IUriContainer, 0xa158a630, 0xed6f, 0x45fb, 0xb9, 0x87, 0xf6,
            0x86, 0x76, 0xf5, 0x77, 0x52);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IUriContainer, 0xa158a630, 0xed6f, 0x45fb, 0xb9, 0x87, 0xf6,
                0x86, 0x76, 0xf5, 0x77, 0x52)
#endif
#else
typedef struct IUriContainerVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IUriContainer *This, REFIID riid,
                                             void **ppvObject);
...
interface IUriContainer { CONST_VTBL IUriContainerVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IUriContainer_QueryInterface(IUriContainer *This,
                                                   REFIID riid,
                                                   void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IUriContainer methods ***/
static inline HRESULT IUriContainer_GetIUri(IUriContainer *This,
                                            IUri **ppIUri) {
...
DEFINE_GUID(IID_IUriBuilder, 0x4221b2e1, 0x8955, 0x46c0, 0xbd, 0x5b, 0xde, 0x98,
            0x97, 0x56, 0x5d, 0xe7);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IUriBuilder : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE CreateUriSimple(
      DWORD dwAllowEncodingPropertyMask, DWORD_PTR dwReserved,
      IUri * *ppIUri) = 0;
  virtual HRESULT STDMETHODCALLTYPE CreateUri(
      DWORD dwCreateFlags, DWORD dwAllowEncodingPropertyMask,
      DWORD_PTR dwReserved, IUri * *ppIUri) = 0;
  virtual HRESULT STDMETHODCALLTYPE CreateUriWithFlags(
      DWORD dwCreateFlags, DWORD dwUriBuilderFlags,
      DWORD dwAllowEncodingPropertyMask, DWORD_PTR dwReserved,
      IUri * *ppIUri) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetIUri(IUri * *ppIUri) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetIUri(IUri * pIUri) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetFragment(DWORD * pcchFragment,
                                                LPCWSTR * ppwzFragment) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetHost(DWORD * pcchHost,
                                            LPCWSTR * ppwzHost) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetPassword(DWORD * pcchPassword,
                                                LPCWSTR * ppwzPassword) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetPath(DWORD * pcchPath,
                                            LPCWSTR * ppwzPath) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetPort(WINBOOL * pfHasPort,
                                            DWORD * pdwPort) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetQuery(DWORD * pcchQuery,
                                             LPCWSTR * ppwzQuery) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetSchemeName(DWORD * pcchSchemeName,
                                                  LPCWSTR * ppwzSchemeName) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetUserName(DWORD * pcchUserName,
  ...
  virtual HRESULT STDMETHODCALLTYPE SetPort(WINBOOL fHasPort,
                                            DWORD dwNewValue) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE HasBeenModified(WINBOOL * pfModified) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IUriBuilder, 0x4221b2e1, 0x8955, 0x46c0, 0xbd, 0x5b, 0xde, 0x98,
                0x97, 0x56, 0x5d, 0xe7)
#endif
#else
typedef struct IUriBuilderVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IUriBuilder *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IUriBuilder *This);
  ULONG(STDMETHODCALLTYPE *Release)(IUriBuilder *This);
  /*** IUriBuilder methods ***/
  HRESULT(STDMETHODCALLTYPE *CreateUriSimple)(IUriBuilder *This,
                                              DWORD dwAllowEncodingPropertyMask,
                                              DWORD_PTR dwReserved,
                                              IUri **ppIUri);
  HRESULT(STDMETHODCALLTYPE *CreateUri)(IUriBuilder *This, DWORD dwCreateFlags,
                                        DWORD dwAllowEncodingPropertyMask,
                                        DWORD_PTR dwReserved, IUri **ppIUri);
  HRESULT(STDMETHODCALLTYPE *CreateUriWithFlags)(
      IUriBuilder *This, DWORD dwCreateFlags, DWORD dwUriBuilderFlags,
      DWORD dwAllowEncodingPropertyMask, DWORD_PTR dwReserved, IUri **ppIUri);
  ...
  HRESULT(STDMETHODCALLTYPE *GetFragment)(IUriBuilder *This,
                                          DWORD *pcchFragment,
                                          LPCWSTR *ppwzFragment);
  HRESULT(STDMETHODCALLTYPE *GetHost)(IUriBuilder *This, DWORD *pcchHost,
                                      LPCWSTR *ppwzHost);
  HRESULT(STDMETHODCALLTYPE *GetPassword)(IUriBuilder *This,
                                          DWORD *pcchPassword,
                                          LPCWSTR *ppwzPassword);
  HRESULT(STDMETHODCALLTYPE *GetPath)(IUriBuilder *This, DWORD *pcchPath,
                                      LPCWSTR *ppwzPath);
  HRESULT(STDMETHODCALLTYPE *GetPort)(IUriBuilder *This, WINBOOL *pfHasPort,
                                      DWORD *pdwPort);
  HRESULT(STDMETHODCALLTYPE *GetQuery)(IUriBuilder *This, DWORD *pcchQuery,
                                       LPCWSTR *ppwzQuery);
  HRESULT(STDMETHODCALLTYPE *GetSchemeName)(IUriBuilder *This,
                                            DWORD *pcchSchemeName,
                                            LPCWSTR *ppwzSchemeName);
  HRESULT(STDMETHODCALLTYPE *GetUserName)(IUriBuilder *This,
                                          DWORD *pcchUserName,
                                          LPCWSTR *ppwzUserName);
  HRESULT(STDMETHODCALLTYPE *SetFragment)(IUriBuilder *This,
                                          LPCWSTR pwzNewValue);
  HRESULT(STDMETHODCALLTYPE *SetHost)(IUriBuilder *This, LPCWSTR pwzNewValue);
  HRESULT(STDMETHODCALLTYPE *SetPassword)(IUriBuilder *This,
                                          LPCWSTR pwzNewValue);
  HRESULT(STDMETHODCALLTYPE *SetPath)(IUriBuilder *This, LPCWSTR pwzNewValue);
  HRESULT(STDMETHODCALLTYPE *SetPort)(IUriBuilder *This, WINBOOL fHasPort,
                                      DWORD dwNewValue);
  HRESULT(STDMETHODCALLTYPE *SetQuery)(IUriBuilder *This, LPCWSTR pwzNewValue);
  HRESULT(STDMETHODCALLTYPE *SetSchemeName)(IUriBuilder *This,
                                            LPCWSTR pwzNewValue);
  HRESULT(STDMETHODCALLTYPE *SetUserName)(IUriBuilder *This,
                                          LPCWSTR pwzNewValue);
  HRESULT(STDMETHODCALLTYPE *RemoveProperties)(IUriBuilder *This,
                                               DWORD dwPropertyMask);
  HRESULT(STDMETHODCALLTYPE *HasBeenModified)(IUriBuilder *This,
                                              WINBOOL *pfModified);
  END_INTERFACE
} IUriBuilderVtbl;
interface IUriBuilder { CONST_VTBL IUriBuilderVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IUriBuilder methods ***/
#define IUriBuilder_CreateUriSimple(This, dwAllowEncodingPropertyMask,         \
                                    dwReserved, ppIUri)                        \
  (This)->lpVtbl->CreateUriSimple(This, dwAllowEncodingPropertyMask,           \
                                  dwReserved, ppIUri)
#define IUriBuilder_CreateUri(This, dwCreateFlags,                             \
...
#else
/*** IUnknown methods ***/
static inline HRESULT IUriBuilder_QueryInterface(IUriBuilder *This, REFIID riid,
                                                 void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IUriBuilder methods ***/
static inline HRESULT
IUriBuilder_CreateUriSimple(IUriBuilder *This,
                            DWORD dwAllowEncodingPropertyMask,
                            DWORD_PTR dwReserved, IUri **ppIUri) {
  return This->lpVtbl->CreateUriSimple(This, dwAllowEncodingPropertyMask,
                                       dwReserved, ppIUri);
}
static inline HRESULT IUriBuilder_CreateUri(IUriBuilder *This,
                                            DWORD dwCreateFlags,
                                            DWORD dwAllowEncodingPropertyMask,
                                            DWORD_PTR dwReserved,
                                            IUri **ppIUri) {
  return This->lpVtbl->CreateUri(
      This, dwCreateFlags, dwAllowEncodingPropertyMask, dwReserved, ppIUri);
}
static inline HRESULT IUriBuilder_CreateUriWithFlags(
    IUriBuilder *This, DWORD dwCreateFlags, DWORD dwUriBuilderFlags,
    DWORD dwAllowEncodingPropertyMask, DWORD_PTR dwReserved, IUri **ppIUri) {
  return This->lpVtbl->CreateUriWithFlags(
      This, dwCreateFlags, dwUriBuilderFlags, dwAllowEncodingPropertyMask,
      dwReserved, ppIUri);
}
...
static inline HRESULT IUriBuilder_GetFragment(IUriBuilder *This,
                                              DWORD *pcchFragment,
                                              LPCWSTR *ppwzFragment) {
  return This->lpVtbl->GetFragment(This, pcchFragment, ppwzFragment);
}
static inline HRESULT IUriBuilder_GetHost(IUriBuilder *This, DWORD *pcchHost,
                                          LPCWSTR *ppwzHost) {
  return This->lpVtbl->GetHost(This, pcchHost, ppwzHost);
}
static inline HRESULT IUriBuilder_GetPassword(IUriBuilder *This,
                                              DWORD *pcchPassword,
                                              LPCWSTR *ppwzPassword) {
  return This->lpVtbl->GetPassword(This, pcchPassword, ppwzPassword);
}
static inline HRESULT IUriBuilder_GetPath(IUriBuilder *This, DWORD *pcchPath,
                                          LPCWSTR *ppwzPath) {
  return This->lpVtbl->GetPath(This, pcchPath, ppwzPath);
}
static inline HRESULT IUriBuilder_GetPort(IUriBuilder *This, WINBOOL *pfHasPort,
                                          DWORD *pdwPort) {
  return This->lpVtbl->GetPort(This, pfHasPort, pdwPort);
}
static inline HRESULT IUriBuilder_GetQuery(IUriBuilder *This, DWORD *pcchQuery,
                                           LPCWSTR *ppwzQuery) {
  return This->lpVtbl->GetQuery(This, pcchQuery, ppwzQuery);
}
static inline HRESULT IUriBuilder_GetSchemeName(IUriBuilder *This,
                                                DWORD *pcchSchemeName,
                                                LPCWSTR *ppwzSchemeName) {
  return This->lpVtbl->GetSchemeName(This, pcchSchemeName, ppwzSchemeName);
}
static inline HRESULT IUriBuilder_GetUserName(IUriBuilder *This,
                                              DWORD *pcchUserName,
                                              LPCWSTR *ppwzUserName) {
  return This->lpVtbl->GetUserName(This, pcchUserName, ppwzUserName);
}
static inline HRESULT IUriBuilder_SetFragment(IUriBuilder *This,
                                              LPCWSTR pwzNewValue) {
  return This->lpVtbl->SetFragment(This, pwzNewValue);
}
static inline HRESULT IUriBuilder_SetHost(IUriBuilder *This,
                                          LPCWSTR pwzNewValue) {
  return This->lpVtbl->SetHost(This, pwzNewValue);
}
static inline HRESULT IUriBuilder_SetPassword(IUriBuilder *This,
                                              LPCWSTR pwzNewValue) {
  return This->lpVtbl->SetPassword(This, pwzNewValue);
}
static inline HRESULT IUriBuilder_SetPath(IUriBuilder *This,
                                          LPCWSTR pwzNewValue) {
  return This->lpVtbl->SetPath(This, pwzNewValue);
}
static inline HRESULT IUriBuilder_SetPort(IUriBuilder *This, WINBOOL fHasPort,
                                          DWORD dwNewValue) {
  return This->lpVtbl->SetPort(This, fHasPort, dwNewValue);
}
static inline HRESULT IUriBuilder_SetQuery(IUriBuilder *This,
                                           LPCWSTR pwzNewValue) {
  return This->lpVtbl->SetQuery(This, pwzNewValue);
}
static inline HRESULT IUriBuilder_SetSchemeName(IUriBuilder *This,
                                                LPCWSTR pwzNewValue) {
  return This->lpVtbl->SetSchemeName(This, pwzNewValue);
}
static inline HRESULT IUriBuilder_SetUserName(IUriBuilder *This,
                                              LPCWSTR pwzNewValue) {
  return This->lpVtbl->SetUserName(This, pwzNewValue);
}
static inline HRESULT IUriBuilder_RemoveProperties(IUriBuilder *This,
                                                   DWORD dwPropertyMask) {
  return This->lpVtbl->RemoveProperties(This, dwPropertyMask);
}
static inline HRESULT IUriBuilder_HasBeenModified(IUriBuilder *This,
                                                  WINBOOL *pfModified) {
...
DEFINE_GUID(IID_IUriBuilderFactory, 0xe982ce48, 0x0b96, 0x440c, 0xbc, 0x37,
            0x0c, 0x86, 0x9b, 0x27, 0xa2, 0x9e);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IUriBuilderFactory : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE CreateIUriBuilder(
      DWORD dwFlags, DWORD_PTR dwReserved, IUriBuilder * *ppIUriBuilder) = 0;
  virtual HRESULT STDMETHODCALLTYPE CreateInitializedIUriBuilder(
      DWORD dwFlags, DWORD_PTR dwReserved, IUriBuilder * *ppIUriBuilder) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IUriBuilderFactory, 0xe982ce48, 0x0b96, 0x440c, 0xbc, 0x37,
                0x0c, 0x86, 0x9b, 0x27, 0xa2, 0x9e)
#endif
#else
typedef struct IUriBuilderFactoryVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IUriBuilderFactory *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *CreateIUriBuilder)(IUriBuilderFactory *This,
                                                DWORD dwFlags,
                                                DWORD_PTR dwReserved,
                                                IUriBuilder **ppIUriBuilder);
  HRESULT(STDMETHODCALLTYPE *CreateInitializedIUriBuilder)(
      IUriBuilderFactory *This, DWORD dwFlags, DWORD_PTR dwReserved,
      IUriBuilder **ppIUriBuilder);
  END_INTERFACE
} IUriBuilderFactoryVtbl;
interface IUriBuilderFactory { CONST_VTBL IUriBuilderFactoryVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IUriBuilderFactory methods ***/
#define IUriBuilderFactory_CreateIUriBuilder(This, dwFlags, dwReserved,        \
                                             ppIUriBuilder)                    \
...
#define IUriBuilderFactory_CreateInitializedIUriBuilder(                       \
  ...
  (This)->lpVtbl->CreateInitializedIUriBuilder(This, dwFlags, dwReserved,      \
                                               ppIUriBuilder)
#else
/*** IUnknown methods ***/
static inline HRESULT
IUriBuilderFactory_QueryInterface(IUriBuilderFactory *This, REFIID riid,
                                  void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IUriBuilderFactory methods ***/
static inline HRESULT
IUriBuilderFactory_CreateIUriBuilder(IUriBuilderFactory *This, DWORD dwFlags,
                                     DWORD_PTR dwReserved,
                                     IUriBuilder **ppIUriBuilder) {
  return This->lpVtbl->CreateIUriBuilder(This, dwFlags, dwReserved,
                                         ppIUriBuilder);
}
static inline HRESULT IUriBuilderFactory_CreateInitializedIUriBuilder(
    IUriBuilderFactory *This, DWORD dwFlags, DWORD_PTR dwReserved,
    IUriBuilder **ppIUriBuilder) {
  return This->lpVtbl->CreateInitializedIUriBuilder(This, dwFlags, dwReserved,
                                                    ppIUriBuilder);
}
#endif
#endif
...
STDAPI CreateIUriBuilder(IUri *pIUri, DWORD dwFlags, DWORD_PTR dwReserved,
                         IUriBuilder **ppIUriBuilder);
#endif
#endif
#if WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_DESKTOP)
...
DEFINE_GUID(IID_IWinInetInfo, 0x79eac9d6, 0xbafa, 0x11ce, 0x8c, 0x82, 0x00,
            0xaa, 0x00, 0x4b, 0xa9, 0x0b);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("79eac9d6-bafa-11ce-8c82-00aa004ba90b")
IWinInetInfo : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE QueryOption(DWORD dwOption, LPVOID pBuffer,
                                                DWORD * pcbBuf) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IWinInetInfo, 0x79eac9d6, 0xbafa, 0x11ce, 0x8c, 0x82, 0x00,
                0xaa, 0x00, 0x4b, 0xa9, 0x0b)
#endif
#else
typedef struct IWinInetInfoVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWinInetInfo *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IWinInetInfo *This);
  ULONG(STDMETHODCALLTYPE *Release)(IWinInetInfo *This);
  /*** IWinInetInfo methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryOption)(IWinInetInfo *This, DWORD dwOption,
                                          LPVOID pBuffer, DWORD *pcbBuf);
  END_INTERFACE
} IWinInetInfoVtbl;
interface IWinInetInfo { CONST_VTBL IWinInetInfoVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IUnknown methods ***/
static inline HRESULT
IWinInetInfo_QueryInterface(IWinInetInfo *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IWinInetInfo methods ***/
static inline HRESULT IWinInetInfo_QueryOption(IWinInetInfo *This,
                                               DWORD dwOption, LPVOID pBuffer,
                                               DWORD *pcbBuf) {
...
HRESULT STDMETHODCALLTYPE IWinInetInfo_RemoteQueryOption_Proxy(
    IWinInetInfo *This, DWORD dwOption, BYTE *pBuffer, DWORD *pcbBuf);
...
DEFINE_GUID(IID_IHttpSecurity, 0x79eac9d7, 0xbafa, 0x11ce, 0x8c, 0x82, 0x00,
            0xaa, 0x00, 0x4b, 0xa9, 0x0b);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IHttpSecurity, 0x79eac9d7, 0xbafa, 0x11ce, 0x8c, 0x82, 0x00,
                0xaa, 0x00, 0x4b, 0xa9, 0x0b)
#endif
#else
typedef struct IHttpSecurityVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IHttpSecurity *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IHttpSecurity *This);
  ULONG(STDMETHODCALLTYPE *Release)(IHttpSecurity *This);
  /*** IWindowForBindingUI methods ***/
  HRESULT(STDMETHODCALLTYPE *GetWindow)(IHttpSecurity *This,
                                        REFGUID rguidReason, HWND *phwnd);
  /*** IHttpSecurity methods ***/
  HRESULT(STDMETHODCALLTYPE *OnSecurityProblem)(IHttpSecurity *This,
                                                DWORD dwProblem);
  END_INTERFACE
} IHttpSecurityVtbl;
interface IHttpSecurity { CONST_VTBL IHttpSecurityVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IHttpSecurity_QueryInterface(IHttpSecurity *This,
                                                   REFIID riid,
                                                   void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IWindowForBindingUI methods ***/
static inline HRESULT
IHttpSecurity_GetWindow(IHttpSecurity *This, REFGUID rguidReason, HWND *phwnd) {
  return This->lpVtbl->GetWindow(This, rguidReason, phwnd);
}
/*** IHttpSecurity methods ***/
static inline HRESULT IHttpSecurity_OnSecurityProblem(IHttpSecurity *This,
                                                      DWORD dwProblem) {
...
DEFINE_GUID(IID_IWinInetHttpInfo, 0x79eac9d8, 0xbafa, 0x11ce, 0x8c, 0x82, 0x00,
            0xaa, 0x00, 0x4b, 0xa9, 0x0b);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("79eac9d8-bafa-11ce-8c82-00aa004ba90b")
IWinInetHttpInfo : public IWinInetInfo {
  virtual HRESULT STDMETHODCALLTYPE QueryInfo(DWORD dwOption, LPVOID pBuffer,
                                              DWORD * pcbBuf, DWORD * pdwFlags,
                                              DWORD * pdwReserved) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IWinInetHttpInfo, 0x79eac9d8, 0xbafa, 0x11ce, 0x8c, 0x82, 0x00,
                0xaa, 0x00, 0x4b, 0xa9, 0x0b)
#endif
#else
typedef struct IWinInetHttpInfoVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWinInetHttpInfo *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IWinInetHttpInfo *This);
  ULONG(STDMETHODCALLTYPE *Release)(IWinInetHttpInfo *This);
  /*** IWinInetInfo methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryOption)(IWinInetHttpInfo *This,
                                          DWORD dwOption, LPVOID pBuffer,
                                          DWORD *pcbBuf);
  /*** IWinInetHttpInfo methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInfo)(IWinInetHttpInfo *This, DWORD dwOption,
                                        LPVOID pBuffer, DWORD *pcbBuf,
                                        DWORD *pdwFlags, DWORD *pdwReserved);
  END_INTERFACE
} IWinInetHttpInfoVtbl;
interface IWinInetHttpInfo { CONST_VTBL IWinInetHttpInfoVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define IWinInetHttpInfo_QueryOption(This, dwOption, pBuffer, pcbBuf)          \
  (This)->lpVtbl->QueryOption(This, dwOption, pBuffer, pcbBuf)
/*** IWinInetHttpInfo methods ***/
#define IWinInetHttpInfo_QueryInfo(This, dwOption, pBuffer, pcbBuf, pdwFlags,  \
                                   pdwReserved)                                \
  (This)->lpVtbl->QueryInfo(This, dwOption, pBuffer, pcbBuf, pdwFlags,         \
                            pdwReserved)
#else
/*** IUnknown methods ***/
static inline HRESULT IWinInetHttpInfo_QueryInterface(IWinInetHttpInfo *This,
                                                      REFIID riid,
                                                      void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IWinInetInfo methods ***/
static inline HRESULT IWinInetHttpInfo_QueryOption(IWinInetHttpInfo *This,
                                                   DWORD dwOption,
                                                   LPVOID pBuffer,
                                                   DWORD *pcbBuf) {
  return This->lpVtbl->QueryOption(This, dwOption, pBuffer, pcbBuf);
...
/*** IWinInetHttpInfo methods ***/
static inline HRESULT IWinInetHttpInfo_QueryInfo(IWinInetHttpInfo *This,
                                                 DWORD dwOption, LPVOID pBuffer,
                                                 DWORD *pcbBuf, DWORD *pdwFlags,
                                                 DWORD *pdwReserved) {
  return This->lpVtbl->QueryInfo(This, dwOption, pBuffer, pcbBuf, pdwFlags,
                                 pdwReserved);
}
#endif
#endif
...
HRESULT STDMETHODCALLTYPE IWinInetHttpInfo_RemoteQueryInfo_Proxy(
    IWinInetHttpInfo *This, DWORD dwOption, BYTE *pBuffer, DWORD *pcbBuf,
    DWORD *pdwFlags, DWORD *pdwReserved);
...
DEFINE_GUID(IID_IWinInetHttpTimeouts, 0xf286fa56, 0xc1fd, 0x4270, 0x8e, 0x67,
            0xb3, 0xeb, 0x79, 0x0a, 0x81, 0xe8);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IWinInetHttpTimeouts : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetRequestTimeouts(
      DWORD * pdwConnectTimeout, DWORD * pdwSendTimeout,
      DWORD * pdwReceiveTimeout) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IWinInetHttpTimeouts, 0xf286fa56, 0xc1fd, 0x4270, 0x8e, 0x67,
                0xb3, 0xeb, 0x79, 0x0a, 0x81, 0xe8)
#endif
#else
typedef struct IWinInetHttpTimeoutsVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWinInetHttpTimeouts *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IWinInetHttpTimeouts *This);
  ULONG(STDMETHODCALLTYPE *Release)(IWinInetHttpTimeouts *This);
  /*** IWinInetHttpTimeouts methods ***/
  HRESULT(STDMETHODCALLTYPE *GetRequestTimeouts)(IWinInetHttpTimeouts *This,
                                                 DWORD *pdwConnectTimeout,
                                                 DWORD *pdwSendTimeout,
                                                 DWORD *pdwReceiveTimeout);
  END_INTERFACE
} IWinInetHttpTimeoutsVtbl;
interface IWinInetHttpTimeouts { CONST_VTBL IWinInetHttpTimeoutsVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IWinInetHttpTimeouts methods ***/
#define IWinInetHttpTimeouts_GetRequestTimeouts(                               \
...
/*** IUnknown methods ***/
static inline HRESULT
IWinInetHttpTimeouts_QueryInterface(IWinInetHttpTimeouts *This, REFIID riid,
                                    void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IWinInetHttpTimeouts methods ***/
static inline HRESULT IWinInetHttpTimeouts_GetRequestTimeouts(
    IWinInetHttpTimeouts *This, DWORD *pdwConnectTimeout, DWORD *pdwSendTimeout,
    DWORD *pdwReceiveTimeout) {
  return This->lpVtbl->GetRequestTimeouts(This, pdwConnectTimeout,
                                          pdwSendTimeout, pdwReceiveTimeout);
}
#endif
#endif
#endif
...
DEFINE_GUID(IID_IWinInetCacheHints, 0xdd1ec3b3, 0x8391, 0x4fdb, 0xa9, 0xe6,
            0x34, 0x7c, 0x3c, 0xaa, 0xa7, 0xdd);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IWinInetCacheHints : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE SetCacheExtension(
      LPCWSTR pwzExt, LPVOID pszCacheFile, DWORD * pcbCacheFile,
      DWORD * pdwWinInetError, DWORD * pdwReserved) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IWinInetCacheHints, 0xdd1ec3b3, 0x8391, 0x4fdb, 0xa9, 0xe6,
                0x34, 0x7c, 0x3c, 0xaa, 0xa7, 0xdd)
#endif
#else
typedef struct IWinInetCacheHintsVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWinInetCacheHints *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *SetCacheExtension)(
      IWinInetCacheHints *This, LPCWSTR pwzExt, LPVOID pszCacheFile,
      DWORD *pcbCacheFile, DWORD *pdwWinInetError, DWORD *pdwReserved);
  END_INTERFACE
} IWinInetCacheHintsVtbl;
interface IWinInetCacheHints { CONST_VTBL IWinInetCacheHintsVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IWinInetCacheHints methods ***/
#define IWinInetCacheHints_SetCacheExtension(                                  \
...
/*** IUnknown methods ***/
static inline HRESULT
IWinInetCacheHints_QueryInterface(IWinInetCacheHints *This, REFIID riid,
                                  void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IWinInetCacheHints methods ***/
static inline HRESULT IWinInetCacheHints_SetCacheExtension(
    IWinInetCacheHints *This, LPCWSTR pwzExt, LPVOID pszCacheFile,
    DWORD *pcbCacheFile, DWORD *pdwWinInetError, DWORD *pdwReserved) {
  return This->lpVtbl->SetCacheExtension(
      This, pwzExt, pszCacheFile, pcbCacheFile, pdwWinInetError, pdwReserved);
}
#endif
#endif
...
DEFINE_GUID(IID_IWinInetCacheHints2, 0x7857aeac, 0xd31f, 0x49bf, 0x88, 0x4e,
            0xdd, 0x46, 0xdf, 0x36, 0x78, 0x0a);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IWinInetCacheHints2 : public IWinInetCacheHints {
  virtual HRESULT STDMETHODCALLTYPE SetCacheExtension2(
      LPCWSTR pwzExt, WCHAR * pwzCacheFile, DWORD * pcchCacheFile,
      DWORD * pdwWinInetError, DWORD * pdwReserved) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IWinInetCacheHints2, 0x7857aeac, 0xd31f, 0x49bf, 0x88, 0x4e,
                0xdd, 0x46, 0xdf, 0x36, 0x78, 0x0a)
#endif
#else
typedef struct IWinInetCacheHints2Vtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWinInetCacheHints2 *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IWinInetCacheHints2 *This);
  ULONG(STDMETHODCALLTYPE *Release)(IWinInetCacheHints2 *This);
  /*** IWinInetCacheHints methods ***/
  HRESULT(STDMETHODCALLTYPE *SetCacheExtension)(
      IWinInetCacheHints2 *This, LPCWSTR pwzExt, LPVOID pszCacheFile,
      DWORD *pcbCacheFile, DWORD *pdwWinInetError, DWORD *pdwReserved);
  /*** IWinInetCacheHints2 methods ***/
  HRESULT(STDMETHODCALLTYPE *SetCacheExtension2)(
      IWinInetCacheHints2 *This, LPCWSTR pwzExt, WCHAR *pwzCacheFile,
      DWORD *pcchCacheFile, DWORD *pdwWinInetError, DWORD *pdwReserved);
  END_INTERFACE
} IWinInetCacheHints2Vtbl;
interface IWinInetCacheHints2 { CONST_VTBL IWinInetCacheHints2Vtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IWinInetCacheHints methods ***/
#define IWinInetCacheHints2_SetCacheExtension(                                 \
    This, pwzExt, pszCacheFile, pcbCacheFile, pdwWinInetError, pdwReserved)    \
  (This)->lpVtbl->SetCacheExtension(This, pwzExt, pszCacheFile, pcbCacheFile,  \
                                    pdwWinInetError, pdwReserved)
/*** IWinInetCacheHints2 methods ***/
#define IWinInetCacheHints2_SetCacheExtension2(                                \
  ...
  (This)->lpVtbl->SetCacheExtension2(                                          \
      This, pwzExt, pwzCacheFile, pcchCacheFile, pdwWinInetError, pdwReserved)
#else
/*** IUnknown methods ***/
static inline HRESULT
IWinInetCacheHints2_QueryInterface(IWinInetCacheHints2 *This, REFIID riid,
                                   void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IWinInetCacheHints methods ***/
static inline HRESULT IWinInetCacheHints2_SetCacheExtension(
    IWinInetCacheHints2 *This, LPCWSTR pwzExt, LPVOID pszCacheFile,
    DWORD *pcbCacheFile, DWORD *pdwWinInetError, DWORD *pdwReserved) {
  return This->lpVtbl->SetCacheExtension(
      This, pwzExt, pszCacheFile, pcbCacheFile, pdwWinInetError, pdwReserved);
...
static inline HRESULT IWinInetCacheHints2_SetCacheExtension2(
    IWinInetCacheHints2 *This, LPCWSTR pwzExt, WCHAR *pwzCacheFile,
    DWORD *pcchCacheFile, DWORD *pdwWinInetError, DWORD *pdwReserved) {
  return This->lpVtbl->SetCacheExtension2(
      This, pwzExt, pwzCacheFile, pcchCacheFile, pdwWinInetError, pdwReserved);
}
#endif
#endif
...
DEFINE_GUID(IID_IBindHost, 0xfc4801a1, 0x2ba9, 0x11cf, 0xa2, 0x29, 0x00, 0xaa,
            0x00, 0x3d, 0x73, 0x52);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IBindHost : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE CreateMoniker(
      LPOLESTR szName, IBindCtx * pBC, IMoniker * *ppmk, DWORD dwReserved) = 0;
  virtual HRESULT STDMETHODCALLTYPE MonikerBindToStorage(
      IMoniker * pMk, IBindCtx * pBC, IBindStatusCallback * pBSC, REFIID riid,
      void **ppvObj) = 0;
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IBindHost, 0xfc4801a1, 0x2ba9, 0x11cf, 0xa2, 0x29, 0x00, 0xaa,
                0x00, 0x3d, 0x73, 0x52)
#endif
#else
typedef struct IBindHostVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IBindHost *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IBindHost *This);
  ULONG(STDMETHODCALLTYPE *Release)(IBindHost *This);
  /*** IBindHost methods ***/
  HRESULT(STDMETHODCALLTYPE *CreateMoniker)(IBindHost *This, LPOLESTR szName,
                                            IBindCtx *pBC, IMoniker **ppmk,
                                            DWORD dwReserved);
  HRESULT(STDMETHODCALLTYPE *MonikerBindToStorage)(IBindHost *This,
                                                   IMoniker *pMk, IBindCtx *pBC,
                                                   IBindStatusCallback *pBSC,
                                                   REFIID riid, void **ppvObj);
  HRESULT(STDMETHODCALLTYPE *MonikerBindToObject)(IBindHost *This,
                                                  IMoniker *pMk, IBindCtx *pBC,
                                                  IBindStatusCallback *pBSC,
                                                  REFIID riid, void **ppvObj);
  END_INTERFACE
} IBindHostVtbl;
interface IBindHost { CONST_VTBL IBindHostVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IBindHost_QueryInterface(IBindHost *This, REFIID riid,
                                               void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IBindHost methods ***/
static inline HRESULT IBindHost_CreateMoniker(IBindHost *This, LPOLESTR szName,
                                              IBindCtx *pBC, IMoniker **ppmk,
                                              DWORD dwReserved) {
  return This->lpVtbl->CreateMoniker(This, szName, pBC, ppmk, dwReserved);
}
static inline HRESULT
IBindHost_MonikerBindToStorage(IBindHost *This, IMoniker *pMk, IBindCtx *pBC,
                               IBindStatusCallback *pBSC, REFIID riid,
                               void **ppvObj) {
  return This->lpVtbl->MonikerBindToStorage(This, pMk, pBC, pBSC, riid, ppvObj);
}
static inline HRESULT
IBindHost_MonikerBindToObject(IBindHost *This, IMoniker *pMk, IBindCtx *pBC,
                              IBindStatusCallback *pBSC, REFIID riid,
                              void **ppvObj) {
...
HRESULT STDMETHODCALLTYPE IBindHost_RemoteMonikerBindToStorage_Proxy(
    IBindHost *This, IMoniker *pMk, IBindCtx *pBC, IBindStatusCallback *pBSC,
...
STDAPI HlinkSimpleNavigateToString(LPCWSTR szTarget, LPCWSTR szLocation,
                                   LPCWSTR szTargetFrameName, IUnknown *pUnk,
                                   IBindCtx *pbc, IBindStatusCallback *,
                                   DWORD grfHLNF, DWORD dwReserved);
STDAPI HlinkSimpleNavigateToMoniker(IMoniker *pmkTarget, LPCWSTR szLocation,
                                    LPCWSTR szTargetFrameName, IUnknown *pUnk,
                                    IBindCtx *pbc, IBindStatusCallback *,
                                    DWORD grfHLNF, DWORD dwReserved);
...
STDAPI URLDownloadToFileA(LPUNKNOWN, LPCSTR, LPCSTR, DWORD,
                          LPBINDSTATUSCALLBACK);
STDAPI URLDownloadToFileW(LPUNKNOWN, LPCWSTR, LPCWSTR, DWORD,
                          LPBINDSTATUSCALLBACK);
STDAPI URLDownloadToCacheFileA(LPUNKNOWN, LPCSTR, LPSTR, DWORD, DWORD,
                               LPBINDSTATUSCALLBACK);
STDAPI URLDownloadToCacheFileW(LPUNKNOWN, LPCWSTR, LPWSTR, DWORD, DWORD,
                               LPBINDSTATUSCALLBACK);
STDAPI URLOpenBlockingStreamA(LPUNKNOWN, LPCSTR, LPSTREAM *, DWORD,
                              LPBINDSTATUSCALLBACK);
STDAPI URLOpenBlockingStreamW(LPUNKNOWN, LPCWSTR, LPSTREAM *, DWORD,
                              LPBINDSTATUSCALLBACK);
...
DEFINE_GUID(IID_IInternet, 0x79eac9e0, 0xbaf9, 0x11ce, 0x8c, 0x82, 0x00, 0xaa,
            0x00, 0x4b, 0xa9, 0x0b);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("79eac9e0-baf9-11ce-8c82-00aa004ba90b")
IInternet : public IUnknown{};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IInternet, 0x79eac9e0, 0xbaf9, 0x11ce, 0x8c, 0x82, 0x00, 0xaa,
                0x00, 0x4b, 0xa9, 0x0b)
#endif
#else
typedef struct IInternetVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IInternet *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IInternet *This);
  ULONG(STDMETHODCALLTYPE *Release)(IInternet *This);
  END_INTERFACE
} IInternetVtbl;
interface IInternet { CONST_VTBL IInternetVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IInternet_QueryInterface(IInternet *This, REFIID riid,
                                               void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
DEFINE_GUID(IID_IInternetBindInfo, 0x79eac9e1, 0xbaf9, 0x11ce, 0x8c, 0x82, 0x00,
            0xaa, 0x00, 0x4b, 0xa9, 0x0b);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IInternetBindInfo : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetBindInfo(DWORD * grfBINDF,
                                                BINDINFO * pbindinfo) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetBindString(ULONG ulStringType,
                                                  LPOLESTR * ppwzStr, ULONG cEl,
                                                  ULONG * pcElFetched) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IInternetBindInfo, 0x79eac9e1, 0xbaf9, 0x11ce, 0x8c, 0x82, 0x00,
                0xaa, 0x00, 0x4b, 0xa9, 0x0b)
#endif
#else
typedef struct IInternetBindInfoVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IInternetBindInfo *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetBindInfo)(IInternetBindInfo *This,
                                          DWORD *grfBINDF, BINDINFO *pbindinfo);
  HRESULT(STDMETHODCALLTYPE *GetBindString)(IInternetBindInfo *This,
                                            ULONG ulStringType,
                                            LPOLESTR *ppwzStr, ULONG cEl,
                                            ULONG *pcElFetched);
  END_INTERFACE
} IInternetBindInfoVtbl;
interface IInternetBindInfo { CONST_VTBL IInternetBindInfoVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define IInternetBindInfo_GetBindInfo(This, grfBINDF, pbindinfo)               \
  (This)->lpVtbl->GetBindInfo(This, grfBINDF, pbindinfo)
#define IInternetBindInfo_GetBindString(This, ulStringType, ppwzStr, cEl,      \
                                        pcElFetched)                           \
  (This)->lpVtbl->GetBindString(This, ulStringType, ppwzStr, cEl, pcElFetched)
#else
/*** IUnknown methods ***/
static inline HRESULT IInternetBindInfo_QueryInterface(IInternetBindInfo *This,
                                                       REFIID riid,
                                                       void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IInternetBindInfo methods ***/
static inline HRESULT IInternetBindInfo_GetBindInfo(IInternetBindInfo *This,
                                                    DWORD *grfBINDF,
                                                    BINDINFO *pbindinfo) {
  return This->lpVtbl->GetBindInfo(This, grfBINDF, pbindinfo);
}
static inline HRESULT IInternetBindInfo_GetBindString(IInternetBindInfo *This,
                                                      ULONG ulStringType,
                                                      LPOLESTR *ppwzStr,
                                                      ULONG cEl,
                                                      ULONG *pcElFetched) {
  return This->lpVtbl->GetBindString(This, ulStringType, ppwzStr, cEl,
                                     pcElFetched);
}
#endif
#endif
...
DEFINE_GUID(IID_IInternetBindInfoEx, 0xa3e015b7, 0xa82c, 0x4dcd, 0xa1, 0x50,
            0x56, 0x9a, 0xee, 0xed, 0x36, 0xab);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IInternetBindInfoEx, 0xa3e015b7, 0xa82c, 0x4dcd, 0xa1, 0x50,
                0x56, 0x9a, 0xee, 0xed, 0x36, 0xab)
#endif
#else
typedef struct IInternetBindInfoExVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IInternetBindInfoEx *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IInternetBindInfoEx *This);
  ULONG(STDMETHODCALLTYPE *Release)(IInternetBindInfoEx *This);
  /*** IInternetBindInfo methods ***/
  HRESULT(STDMETHODCALLTYPE *GetBindInfo)(IInternetBindInfoEx *This,
                                          DWORD *grfBINDF, BINDINFO *pbindinfo);
  HRESULT(STDMETHODCALLTYPE *GetBindString)(IInternetBindInfoEx *This,
                                            ULONG ulStringType,
                                            LPOLESTR *ppwzStr, ULONG cEl,
                                            ULONG *pcElFetched);
  /*** IInternetBindInfoEx methods ***/
  HRESULT(STDMETHODCALLTYPE *GetBindInfoEx)(IInternetBindInfoEx *This,
                                            DWORD *grfBINDF,
                                            BINDINFO *pbindinfo,
                                            DWORD *grfBINDF2,
                                            DWORD *pdwReserved);
...
interface IInternetBindInfoEx { CONST_VTBL IInternetBindInfoExVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define IInternetBindInfoEx_GetBindInfo(This, grfBINDF, pbindinfo)             \
  (This)->lpVtbl->GetBindInfo(This, grfBINDF, pbindinfo)
#define IInternetBindInfoEx_GetBindString(This, ulStringType, ppwzStr, cEl,    \
                                          pcElFetched)                         \
  (This)->lpVtbl->GetBindString(This, ulStringType, ppwzStr, cEl, pcElFetched)
/*** IInternetBindInfoEx methods ***/
#define IInternetBindInfoEx_GetBindInfoEx(This, grfBINDF, pbindinfo,           \
                                          grfBINDF2, pdwReserved)              \
  (This)->lpVtbl->GetBindInfoEx(This, grfBINDF, pbindinfo, grfBINDF2,          \
                                pdwReserved)
#else
/*** IUnknown methods ***/
static inline HRESULT
IInternetBindInfoEx_QueryInterface(IInternetBindInfoEx *This, REFIID riid,
                                   void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IInternetBindInfo methods ***/
static inline HRESULT IInternetBindInfoEx_GetBindInfo(IInternetBindInfoEx *This,
                                                      DWORD *grfBINDF,
                                                      BINDINFO *pbindinfo) {
  return This->lpVtbl->GetBindInfo(This, grfBINDF, pbindinfo);
}
static inline HRESULT
IInternetBindInfoEx_GetBindString(IInternetBindInfoEx *This, ULONG ulStringType,
                                  LPOLESTR *ppwzStr, ULONG cEl,
                                  ULONG *pcElFetched) {
  return This->lpVtbl->GetBindString(This, ulStringType, ppwzStr, cEl,
                                     pcElFetched);
...
/*** IInternetBindInfoEx methods ***/
static inline HRESULT
IInternetBindInfoEx_GetBindInfoEx(IInternetBindInfoEx *This, DWORD *grfBINDF,
                                  BINDINFO *pbindinfo, DWORD *grfBINDF2,
                                  DWORD *pdwReserved) {
  return This->lpVtbl->GetBindInfoEx(This, grfBINDF, pbindinfo, grfBINDF2,
                                     pdwReserved);
}
...
DEFINE_GUID(IID_IInternetProtocolRoot, 0x79eac9e3, 0xbaf9, 0x11ce, 0x8c, 0x82,
            0x00, 0xaa, 0x00, 0x4b, 0xa9, 0x0b);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IInternetProtocolRoot : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE Start(
      ...
      IInternetBindInfo * pOIBindInfo, DWORD grfPI, HANDLE_PTR dwReserved) = 0;
  virtual HRESULT STDMETHODCALLTYPE Continue(PROTOCOLDATA * pProtocolData) = 0;
  virtual HRESULT STDMETHODCALLTYPE Abort(HRESULT hrReason,
                                          DWORD dwOptions) = 0;
  virtual HRESULT STDMETHODCALLTYPE Terminate(DWORD dwOptions) = 0;
  virtual HRESULT STDMETHODCALLTYPE Suspend() = 0;
  virtual HRESULT STDMETHODCALLTYPE Resume() = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IInternetProtocolRoot, 0x79eac9e3, 0xbaf9, 0x11ce, 0x8c, 0x82,
                0x00, 0xaa, 0x00, 0x4b, 0xa9, 0x0b)
#endif
#else
typedef struct IInternetProtocolRootVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IInternetProtocolRoot *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *Start)(IInternetProtocolRoot *This, LPCWSTR szUrl,
                                    IInternetProtocolSink *pOIProtSink,
                                    IInternetBindInfo *pOIBindInfo, DWORD grfPI,
                                    HANDLE_PTR dwReserved);
  HRESULT(STDMETHODCALLTYPE *Continue)(IInternetProtocolRoot *This,
                                       PROTOCOLDATA *pProtocolData);
  HRESULT(STDMETHODCALLTYPE *Abort)(IInternetProtocolRoot *This,
                                    HRESULT hrReason, DWORD dwOptions);
  HRESULT(STDMETHODCALLTYPE *Terminate)(IInternetProtocolRoot *This,
                                        DWORD dwOptions);
...
/*** IInternetProtocolRoot methods ***/
#define IInternetProtocolRoot_Start(This, szUrl, pOIProtSink, pOIBindInfo,     \
                                    grfPI, dwReserved)                         \
  (This)->lpVtbl->Start(This, szUrl, pOIProtSink, pOIBindInfo, grfPI,          \
                        dwReserved)
...
/*** IUnknown methods ***/
static inline HRESULT
IInternetProtocolRoot_QueryInterface(IInternetProtocolRoot *This, REFIID riid,
                                     void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IInternetProtocolRoot methods ***/
static inline HRESULT
IInternetProtocolRoot_Start(IInternetProtocolRoot *This, LPCWSTR szUrl,
                            IInternetProtocolSink *pOIProtSink,
                            IInternetBindInfo *pOIBindInfo, DWORD grfPI,
                            HANDLE_PTR dwReserved) {
  return This->lpVtbl->Start(This, szUrl, pOIProtSink, pOIBindInfo, grfPI,
                             dwReserved);
}
static inline HRESULT
IInternetProtocolRoot_Continue(IInternetProtocolRoot *This,
                               PROTOCOLDATA *pProtocolData) {
  return This->lpVtbl->Continue(This, pProtocolData);
}
static inline HRESULT IInternetProtocolRoot_Abort(IInternetProtocolRoot *This,
                                                  HRESULT hrReason,
                                                  DWORD dwOptions) {
  return This->lpVtbl->Abort(This, hrReason, dwOptions);
}
static inline HRESULT
IInternetProtocolRoot_Terminate(IInternetProtocolRoot *This, DWORD dwOptions) {
  return This->lpVtbl->Terminate(This, dwOptions);
}
static inline HRESULT
IInternetProtocolRoot_Suspend(IInternetProtocolRoot *This) {
  return This->lpVtbl->Suspend(This);
}
static inline HRESULT
IInternetProtocolRoot_Resume(IInternetProtocolRoot *This) {
  return This->lpVtbl->Resume(This);
}
#endif
#endif
...
DEFINE_GUID(IID_IInternetProtocol, 0x79eac9e4, 0xbaf9, 0x11ce, 0x8c, 0x82, 0x00,
            0xaa, 0x00, 0x4b, 0xa9, 0x0b);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IInternetProtocol : public IInternetProtocolRoot {
  ...
  virtual HRESULT STDMETHODCALLTYPE LockRequest(DWORD dwOptions) = 0;
  virtual HRESULT STDMETHODCALLTYPE UnlockRequest() = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IInternetProtocol, 0x79eac9e4, 0xbaf9, 0x11ce, 0x8c, 0x82, 0x00,
                0xaa, 0x00, 0x4b, 0xa9, 0x0b)
#endif
#else
typedef struct IInternetProtocolVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IInternetProtocol *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IInternetProtocol *This);
  ULONG(STDMETHODCALLTYPE *Release)(IInternetProtocol *This);
  /*** IInternetProtocolRoot methods ***/
  HRESULT(STDMETHODCALLTYPE *Start)(IInternetProtocol *This, LPCWSTR szUrl,
                                    IInternetProtocolSink *pOIProtSink,
                                    IInternetBindInfo *pOIBindInfo, DWORD grfPI,
                                    HANDLE_PTR dwReserved);
  HRESULT(STDMETHODCALLTYPE *Continue)(IInternetProtocol *This,
                                       PROTOCOLDATA *pProtocolData);
  HRESULT(STDMETHODCALLTYPE *Abort)(IInternetProtocol *This, HRESULT hrReason,
                                    DWORD dwOptions);
  HRESULT(STDMETHODCALLTYPE *Terminate)(IInternetProtocol *This,
                                        DWORD dwOptions);
  HRESULT(STDMETHODCALLTYPE *Suspend)(IInternetProtocol *This);
  HRESULT(STDMETHODCALLTYPE *Resume)(IInternetProtocol *This);
  /*** IInternetProtocol methods ***/
  HRESULT(STDMETHODCALLTYPE *Read)(IInternetProtocol *This, void *pv, ULONG cb,
                                   ULONG *pcbRead);
  HRESULT(STDMETHODCALLTYPE *Seek)(IInternetProtocol *This,
                                   LARGE_INTEGER dlibMove, DWORD dwOrigin,
                                   ULARGE_INTEGER *plibNewPosition);
  HRESULT(STDMETHODCALLTYPE *LockRequest)(IInternetProtocol *This,
                                          DWORD dwOptions);
  HRESULT(STDMETHODCALLTYPE *UnlockRequest)(IInternetProtocol *This);
  END_INTERFACE
} IInternetProtocolVtbl;
interface IInternetProtocol { CONST_VTBL IInternetProtocolVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IInternetProtocolRoot methods ***/
#define IInternetProtocol_Start(This, szUrl, pOIProtSink, pOIBindInfo, grfPI,  \
                                dwReserved)                                    \
  (This)->lpVtbl->Start(This, szUrl, pOIProtSink, pOIBindInfo, grfPI,          \
                        dwReserved)
...
#else
/*** IUnknown methods ***/
static inline HRESULT IInternetProtocol_QueryInterface(IInternetProtocol *This,
                                                       REFIID riid,
                                                       void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IInternetProtocolRoot methods ***/
static inline HRESULT IInternetProtocol_Start(
    IInternetProtocol *This, LPCWSTR szUrl, IInternetProtocolSink *pOIProtSink,
    IInternetBindInfo *pOIBindInfo, DWORD grfPI, HANDLE_PTR dwReserved) {
  return This->lpVtbl->Start(This, szUrl, pOIProtSink, pOIBindInfo, grfPI,
                             dwReserved);
}
static inline HRESULT IInternetProtocol_Continue(IInternetProtocol *This,
                                                 PROTOCOLDATA *pProtocolData) {
  return This->lpVtbl->Continue(This, pProtocolData);
}
static inline HRESULT IInternetProtocol_Abort(IInternetProtocol *This,
                                              HRESULT hrReason,
                                              DWORD dwOptions) {
  return This->lpVtbl->Abort(This, hrReason, dwOptions);
}
static inline HRESULT IInternetProtocol_Terminate(IInternetProtocol *This,
                                                  DWORD dwOptions) {
  return This->lpVtbl->Terminate(This, dwOptions);
}
...
/*** IInternetProtocol methods ***/
static inline HRESULT IInternetProtocol_Read(IInternetProtocol *This, void *pv,
                                             ULONG cb, ULONG *pcbRead) {
  return This->lpVtbl->Read(This, pv, cb, pcbRead);
}
static inline HRESULT IInternetProtocol_Seek(IInternetProtocol *This,
                                             LARGE_INTEGER dlibMove,
                                             DWORD dwOrigin,
                                             ULARGE_INTEGER *plibNewPosition) {
  return This->lpVtbl->Seek(This, dlibMove, dwOrigin, plibNewPosition);
}
static inline HRESULT IInternetProtocol_LockRequest(IInternetProtocol *This,
                                                    DWORD dwOptions) {
...
DEFINE_GUID(IID_IInternetProtocolEx, 0xc7a98e66, 0x1010, 0x492c, 0xa1, 0xc8,
            0xc8, 0x09, 0xe1, 0xf7, 0x59, 0x05);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IInternetProtocolEx, 0xc7a98e66, 0x1010, 0x492c, 0xa1, 0xc8,
                0xc8, 0x09, 0xe1, 0xf7, 0x59, 0x05)
#endif
#else
typedef struct IInternetProtocolExVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IInternetProtocolEx *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IInternetProtocolEx *This);
  ULONG(STDMETHODCALLTYPE *Release)(IInternetProtocolEx *This);
  /*** IInternetProtocolRoot methods ***/
  HRESULT(STDMETHODCALLTYPE *Start)(IInternetProtocolEx *This, LPCWSTR szUrl,
                                    IInternetProtocolSink *pOIProtSink,
                                    IInternetBindInfo *pOIBindInfo, DWORD grfPI,
                                    HANDLE_PTR dwReserved);
  HRESULT(STDMETHODCALLTYPE *Continue)(IInternetProtocolEx *This,
                                       PROTOCOLDATA *pProtocolData);
  HRESULT(STDMETHODCALLTYPE *Abort)(IInternetProtocolEx *This, HRESULT hrReason,
                                    DWORD dwOptions);
  HRESULT(STDMETHODCALLTYPE *Terminate)(IInternetProtocolEx *This,
                                        DWORD dwOptions);
  HRESULT(STDMETHODCALLTYPE *Suspend)(IInternetProtocolEx *This);
  HRESULT(STDMETHODCALLTYPE *Resume)(IInternetProtocolEx *This);
  /*** IInternetProtocol methods ***/
  HRESULT(STDMETHODCALLTYPE *Read)(IInternetProtocolEx *This, void *pv,
                                   ULONG cb, ULONG *pcbRead);
  HRESULT(STDMETHODCALLTYPE *Seek)(IInternetProtocolEx *This,
                                   LARGE_INTEGER dlibMove, DWORD dwOrigin,
                                   ULARGE_INTEGER *plibNewPosition);
  HRESULT(STDMETHODCALLTYPE *LockRequest)(IInternetProtocolEx *This,
                                          DWORD dwOptions);
  HRESULT(STDMETHODCALLTYPE *UnlockRequest)(IInternetProtocolEx *This);
  /*** IInternetProtocolEx methods ***/
  HRESULT(STDMETHODCALLTYPE *StartEx)(IInternetProtocolEx *This, IUri *pUri,
                                      IInternetProtocolSink *pOIProtSink,
                                      IInternetBindInfo *pOIBindInfo,
                                      DWORD grfPI, HANDLE_PTR dwReserved);
  END_INTERFACE
} IInternetProtocolExVtbl;
interface IInternetProtocolEx { CONST_VTBL IInternetProtocolExVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IInternetProtocolRoot methods ***/
#define IInternetProtocolEx_Start(This, szUrl, pOIProtSink, pOIBindInfo,       \
                                  grfPI, dwReserved)                           \
  (This)->lpVtbl->Start(This, szUrl, pOIProtSink, pOIBindInfo, grfPI,          \
                        dwReserved)
...
#define IInternetProtocolEx_UnlockRequest(This)                                \
  (This)->lpVtbl->UnlockRequest(This)
/*** IInternetProtocolEx methods ***/
#define IInternetProtocolEx_StartEx(This, pUri, pOIProtSink, pOIBindInfo,      \
                                    grfPI, dwReserved)                         \
  (This)->lpVtbl->StartEx(This, pUri, pOIProtSink, pOIBindInfo, grfPI,         \
                          dwReserved)
#else
/*** IUnknown methods ***/
static inline HRESULT
IInternetProtocolEx_QueryInterface(IInternetProtocolEx *This, REFIID riid,
                                   void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IInternetProtocolRoot methods ***/
static inline HRESULT
IInternetProtocolEx_Start(IInternetProtocolEx *This, LPCWSTR szUrl,
                          IInternetProtocolSink *pOIProtSink,
                          IInternetBindInfo *pOIBindInfo, DWORD grfPI,
                          HANDLE_PTR dwReserved) {
  return This->lpVtbl->Start(This, szUrl, pOIProtSink, pOIBindInfo, grfPI,
...
static inline HRESULT
IInternetProtocolEx_Continue(IInternetProtocolEx *This,
                             PROTOCOLDATA *pProtocolData) {
  return This->lpVtbl->Continue(This, pProtocolData);
}
static inline HRESULT IInternetProtocolEx_Abort(IInternetProtocolEx *This,
                                                HRESULT hrReason,
                                                DWORD dwOptions) {
  return This->lpVtbl->Abort(This, hrReason, dwOptions);
}
static inline HRESULT IInternetProtocolEx_Terminate(IInternetProtocolEx *This,
                                                    DWORD dwOptions) {
  return This->lpVtbl->Terminate(This, dwOptions);
}
...
/*** IInternetProtocol methods ***/
static inline HRESULT IInternetProtocolEx_Read(IInternetProtocolEx *This,
                                               void *pv, ULONG cb,
                                               ULONG *pcbRead) {
  return This->lpVtbl->Read(This, pv, cb, pcbRead);
}
static inline HRESULT
IInternetProtocolEx_Seek(IInternetProtocolEx *This, LARGE_INTEGER dlibMove,
                         DWORD dwOrigin, ULARGE_INTEGER *plibNewPosition) {
  return This->lpVtbl->Seek(This, dlibMove, dwOrigin, plibNewPosition);
}
static inline HRESULT IInternetProtocolEx_LockRequest(IInternetProtocolEx *This,
                                                      DWORD dwOptions) {
  return This->lpVtbl->LockRequest(This, dwOptions);
}
static inline HRESULT
IInternetProtocolEx_UnlockRequest(IInternetProtocolEx *This) {
  return This->lpVtbl->UnlockRequest(This);
}
/*** IInternetProtocolEx methods ***/
static inline HRESULT IInternetProtocolEx_StartEx(
    IInternetProtocolEx *This, IUri *pUri, IInternetProtocolSink *pOIProtSink,
    IInternetBindInfo *pOIBindInfo, DWORD grfPI, HANDLE_PTR dwReserved) {
  return This->lpVtbl->StartEx(This, pUri, pOIProtSink, pOIBindInfo, grfPI,
                               dwReserved);
}
#endif
#endif
...
DEFINE_GUID(IID_IInternetProtocolSink, 0x79eac9e5, 0xbaf9, 0x11ce, 0x8c, 0x82,
            0x00, 0xaa, 0x00, 0x4b, 0xa9, 0x0b);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("79eac9e5-baf9-11ce-8c82-00aa004ba90b")
IInternetProtocolSink : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE Switch(PROTOCOLDATA * pProtocolData) = 0;
  virtual HRESULT STDMETHODCALLTYPE ReportProgress(ULONG ulStatusCode,
                                                   LPCWSTR szStatusText) = 0;
  virtual HRESULT STDMETHODCALLTYPE ReportData(DWORD grfBSCF, ULONG ulProgress,
                                               ULONG ulProgressMax) = 0;
  virtual HRESULT STDMETHODCALLTYPE ReportResult(
      HRESULT hrResult, DWORD dwError, LPCWSTR szResult) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IInternetProtocolSink, 0x79eac9e5, 0xbaf9, 0x11ce, 0x8c, 0x82,
                0x00, 0xaa, 0x00, 0x4b, 0xa9, 0x0b)
#endif
#else
typedef struct IInternetProtocolSinkVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IInternetProtocolSink *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IInternetProtocolSink *This);
  ULONG(STDMETHODCALLTYPE *Release)(IInternetProtocolSink *This);
  /*** IInternetProtocolSink methods ***/
  HRESULT(STDMETHODCALLTYPE *Switch)(IInternetProtocolSink *This,
                                     PROTOCOLDATA *pProtocolData);
  HRESULT(STDMETHODCALLTYPE *ReportProgress)(IInternetProtocolSink *This,
                                             ULONG ulStatusCode,
                                             LPCWSTR szStatusText);
  HRESULT(STDMETHODCALLTYPE *ReportData)(IInternetProtocolSink *This,
                                         DWORD grfBSCF, ULONG ulProgress,
                                         ULONG ulProgressMax);
  HRESULT(STDMETHODCALLTYPE *ReportResult)(IInternetProtocolSink *This,
                                           HRESULT hrResult, DWORD dwError,
                                           LPCWSTR szResult);
  END_INTERFACE
...
#define IInternetProtocolSink_ReportData(This, grfBSCF, ulProgress,            \
                                         ulProgressMax)                        \
...
/*** IUnknown methods ***/
static inline HRESULT
IInternetProtocolSink_QueryInterface(IInternetProtocolSink *This, REFIID riid,
                                     void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IInternetProtocolSink methods ***/
static inline HRESULT
IInternetProtocolSink_Switch(IInternetProtocolSink *This,
                             PROTOCOLDATA *pProtocolData) {
  return This->lpVtbl->Switch(This, pProtocolData);
}
static inline HRESULT
IInternetProtocolSink_ReportProgress(IInternetProtocolSink *This,
                                     ULONG ulStatusCode, LPCWSTR szStatusText) {
  return This->lpVtbl->ReportProgress(This, ulStatusCode, szStatusText);
}
static inline HRESULT
IInternetProtocolSink_ReportData(IInternetProtocolSink *This, DWORD grfBSCF,
                                 ULONG ulProgress, ULONG ulProgressMax) {
  return This->lpVtbl->ReportData(This, grfBSCF, ulProgress, ulProgressMax);
}
static inline HRESULT
IInternetProtocolSink_ReportResult(IInternetProtocolSink *This,
                                   HRESULT hrResult, DWORD dwError,
                                   LPCWSTR szResult) {
...
DEFINE_GUID(IID_IInternetProtocolSinkStackable, 0x79eac9f0, 0xbaf9, 0x11ce,
            0x8c, 0x82, 0x00, 0xaa, 0x00, 0x4b, 0xa9, 0x0b);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("79eac9f0-baf9-11ce-8c82-00aa004ba90b")
IInternetProtocolSinkStackable : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE SwitchSink(IInternetProtocolSink *
                                               pOIProtSink) = 0;
  virtual HRESULT STDMETHODCALLTYPE CommitSwitch() = 0;
  virtual HRESULT STDMETHODCALLTYPE RollbackSwitch() = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IInternetProtocolSinkStackable, 0x79eac9f0, 0xbaf9, 0x11ce,
                0x8c, 0x82, 0x00, 0xaa, 0x00, 0x4b, 0xa9, 0x0b)
#endif
#else
typedef struct IInternetProtocolSinkStackableVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *SwitchSink)(IInternetProtocolSinkStackable *This,
                                         IInternetProtocolSink *pOIProtSink);
...
#else
/*** IUnknown methods ***/
static inline HRESULT IInternetProtocolSinkStackable_QueryInterface(
    IInternetProtocolSinkStackable *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IInternetProtocolSinkStackable_AddRef(IInternetProtocolSinkStackable *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IInternetProtocolSinkStackable_Release(IInternetProtocolSinkStackable *This) {
  return This->lpVtbl->Release(This);
}
/*** IInternetProtocolSinkStackable methods ***/
static inline HRESULT
IInternetProtocolSinkStackable_SwitchSink(IInternetProtocolSinkStackable *This,
                                          IInternetProtocolSink *pOIProtSink) {
  return This->lpVtbl->SwitchSink(This, pOIProtSink);
}
static inline HRESULT IInternetProtocolSinkStackable_CommitSwitch(
    IInternetProtocolSinkStackable *This) {
  return This->lpVtbl->CommitSwitch(This);
}
static inline HRESULT IInternetProtocolSinkStackable_RollbackSwitch(
    IInternetProtocolSinkStackable *This) {
...
DEFINE_GUID(IID_IInternetSession, 0x79eac9e7, 0xbaf9, 0x11ce, 0x8c, 0x82, 0x00,
            0xaa, 0x00, 0x4b, 0xa9, 0x0b);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IInternetSession : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE RegisterNameSpace(
      IClassFactory * pCF, REFCLSID rclsid, LPCWSTR pwzProtocol,
      ULONG cPatterns, const LPCWSTR *ppwzPatterns, DWORD dwReserved) = 0;
  virtual HRESULT STDMETHODCALLTYPE UnregisterNameSpace(
      IClassFactory * pCF, LPCWSTR pszProtocol) = 0;
  virtual HRESULT STDMETHODCALLTYPE RegisterMimeFilter(
      IClassFactory * pCF, REFCLSID rclsid, LPCWSTR pwzType) = 0;
  virtual HRESULT STDMETHODCALLTYPE UnregisterMimeFilter(IClassFactory * pCF,
                                                         LPCWSTR pwzType) = 0;
  virtual HRESULT STDMETHODCALLTYPE CreateBinding(
      LPBC pBC, LPCWSTR szUrl, IUnknown * pUnkOuter, IUnknown * *ppUnk,
      IInternetProtocol * *ppOInetProt, DWORD dwOption) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetSessionOption(
      DWORD dwOption, LPVOID pBuffer, DWORD dwBufferLength,
      DWORD dwReserved) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetSessionOption(
      DWORD dwOption, LPVOID pBuffer, DWORD * pdwBufferLength,
      DWORD dwReserved) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IInternetSession, 0x79eac9e7, 0xbaf9, 0x11ce, 0x8c, 0x82, 0x00,
                0xaa, 0x00, 0x4b, 0xa9, 0x0b)
#endif
#else
typedef struct IInternetSessionVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IInternetSession *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *RegisterNameSpace)(
      IInternetSession *This, IClassFactory *pCF, REFCLSID rclsid,
      LPCWSTR pwzProtocol, ULONG cPatterns, const LPCWSTR *ppwzPatterns,
      DWORD dwReserved);
  HRESULT(STDMETHODCALLTYPE *UnregisterNameSpace)(IInternetSession *This,
                                                  IClassFactory *pCF,
                                                  LPCWSTR pszProtocol);
  HRESULT(STDMETHODCALLTYPE *RegisterMimeFilter)(IInternetSession *This,
                                                 IClassFactory *pCF,
                                                 REFCLSID rclsid,
                                                 LPCWSTR pwzType);
  HRESULT(STDMETHODCALLTYPE *UnregisterMimeFilter)(IInternetSession *This,
                                                   IClassFactory *pCF,
                                                   LPCWSTR pwzType);
  HRESULT(STDMETHODCALLTYPE *CreateBinding)(IInternetSession *This, LPBC pBC,
                                            LPCWSTR szUrl, IUnknown *pUnkOuter,
                                            IUnknown **ppUnk,
                                            IInternetProtocol **ppOInetProt,
                                            DWORD dwOption);
  HRESULT(STDMETHODCALLTYPE *SetSessionOption)(IInternetSession *This,
                                               DWORD dwOption, LPVOID pBuffer,
                                               DWORD dwBufferLength,
                                               DWORD dwReserved);
  HRESULT(STDMETHODCALLTYPE *GetSessionOption)(IInternetSession *This,
                                               DWORD dwOption, LPVOID pBuffer,
                                               DWORD *pdwBufferLength,
                                               DWORD dwReserved);
  END_INTERFACE
} IInternetSessionVtbl;
interface IInternetSession { CONST_VTBL IInternetSessionVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IInternetSession methods ***/
#define IInternetSession_RegisterNameSpace(                                    \
    This, pCF, rclsid, pwzProtocol, cPatterns, ppwzPatterns, dwReserved)       \
  (This)->lpVtbl->RegisterNameSpace(This, pCF, rclsid, pwzProtocol, cPatterns, \
...
#define IInternetSession_CreateBinding(This, pBC, szUrl, pUnkOuter, ppUnk,     \
                                       ppOInetProt, dwOption)                  \
  (This)->lpVtbl->CreateBinding(This, pBC, szUrl, pUnkOuter, ppUnk,            \
                                ppOInetProt, dwOption)
#define IInternetSession_SetSessionOption(This, dwOption, pBuffer,             \
                                          dwBufferLength, dwReserved)          \
  (This)->lpVtbl->SetSessionOption(This, dwOption, pBuffer, dwBufferLength,    \
                                   dwReserved)
#define IInternetSession_GetSessionOption(This, dwOption, pBuffer,             \
                                          pdwBufferLength, dwReserved)         \
  (This)->lpVtbl->GetSessionOption(This, dwOption, pBuffer, pdwBufferLength,   \
                                   dwReserved)
#else
/*** IUnknown methods ***/
static inline HRESULT IInternetSession_QueryInterface(IInternetSession *This,
                                                      REFIID riid,
                                                      void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IInternetSession methods ***/
static inline HRESULT
IInternetSession_RegisterNameSpace(IInternetSession *This, IClassFactory *pCF,
                                   REFCLSID rclsid, LPCWSTR pwzProtocol,
                                   ULONG cPatterns, const LPCWSTR *ppwzPatterns,
                                   DWORD dwReserved) {
  return This->lpVtbl->RegisterNameSpace(This, pCF, rclsid, pwzProtocol,
                                         cPatterns, ppwzPatterns, dwReserved);
}
static inline HRESULT
IInternetSession_UnregisterNameSpace(IInternetSession *This, IClassFactory *pCF,
                                     LPCWSTR pszProtocol) {
  return This->lpVtbl->UnregisterNameSpace(This, pCF, pszProtocol);
}
static inline HRESULT
IInternetSession_RegisterMimeFilter(IInternetSession *This, IClassFactory *pCF,
                                    REFCLSID rclsid, LPCWSTR pwzType) {
  return This->lpVtbl->RegisterMimeFilter(This, pCF, rclsid, pwzType);
}
static inline HRESULT
IInternetSession_UnregisterMimeFilter(IInternetSession *This,
...
static inline HRESULT IInternetSession_CreateBinding(
    IInternetSession *This, LPBC pBC, LPCWSTR szUrl, IUnknown *pUnkOuter,
    IUnknown **ppUnk, IInternetProtocol **ppOInetProt, DWORD dwOption) {
  return This->lpVtbl->CreateBinding(This, pBC, szUrl, pUnkOuter, ppUnk,
                                     ppOInetProt, dwOption);
}
static inline HRESULT IInternetSession_SetSessionOption(IInternetSession *This,
                                                        DWORD dwOption,
                                                        LPVOID pBuffer,
                                                        DWORD dwBufferLength,
                                                        DWORD dwReserved) {
  return This->lpVtbl->SetSessionOption(This, dwOption, pBuffer, dwBufferLength,
                                        dwReserved);
}
static inline HRESULT IInternetSession_GetSessionOption(IInternetSession *This,
                                                        DWORD dwOption,
                                                        LPVOID pBuffer,
                                                        DWORD *pdwBufferLength,
                                                        DWORD dwReserved) {
  return This->lpVtbl->GetSessionOption(This, dwOption, pBuffer,
                                        pdwBufferLength, dwReserved);
}
#endif
#endif
...
DEFINE_GUID(IID_IInternetThreadSwitch, 0x79eac9e8, 0xbaf9, 0x11ce, 0x8c, 0x82,
            0x00, 0xaa, 0x00, 0x4b, 0xa9, 0x0b);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("79eac9e8-baf9-11ce-8c82-00aa004ba90b")
IInternetThreadSwitch : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE Prepare() = 0;
  virtual HRESULT STDMETHODCALLTYPE Continue() = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IInternetThreadSwitch, 0x79eac9e8, 0xbaf9, 0x11ce, 0x8c, 0x82,
                0x00, 0xaa, 0x00, 0x4b, 0xa9, 0x0b)
#endif
#else
typedef struct IInternetThreadSwitchVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IInternetThreadSwitch *This,
                                             REFIID riid, void **ppvObject);
...
/*** IUnknown methods ***/
static inline HRESULT
IInternetThreadSwitch_QueryInterface(IInternetThreadSwitch *This, REFIID riid,
                                     void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IInternetThreadSwitch methods ***/
static inline HRESULT
IInternetThreadSwitch_Prepare(IInternetThreadSwitch *This) {
  return This->lpVtbl->Prepare(This);
}
static inline HRESULT
IInternetThreadSwitch_Continue(IInternetThreadSwitch *This) {
...
DEFINE_GUID(IID_IInternetPriority, 0x79eac9eb, 0xbaf9, 0x11ce, 0x8c, 0x82, 0x00,
            0xaa, 0x00, 0x4b, 0xa9, 0x0b);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IInternetPriority, 0x79eac9eb, 0xbaf9, 0x11ce, 0x8c, 0x82, 0x00,
                0xaa, 0x00, 0x4b, 0xa9, 0x0b)
#endif
#else
typedef struct IInternetPriorityVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IInternetPriority *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *SetPriority)(IInternetPriority *This,
                                          LONG nPriority);
  HRESULT(STDMETHODCALLTYPE *GetPriority)(IInternetPriority *This,
                                          LONG *pnPriority);
  END_INTERFACE
} IInternetPriorityVtbl;
interface IInternetPriority { CONST_VTBL IInternetPriorityVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IInternetPriority_QueryInterface(IInternetPriority *This,
                                                       REFIID riid,
                                                       void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IInternetPriority methods ***/
static inline HRESULT IInternetPriority_SetPriority(IInternetPriority *This,
                                                    LONG nPriority) {
  return This->lpVtbl->SetPriority(This, nPriority);
}
static inline HRESULT IInternetPriority_GetPriority(IInternetPriority *This,
                                                    LONG *pnPriority) {
  return This->lpVtbl->GetPriority(This, pnPriority);
}
#endif
...
DEFINE_GUID(IID_IInternetProtocolInfo, 0x79eac9ec, 0xbaf9, 0x11ce, 0x8c, 0x82,
            0x00, 0xaa, 0x00, 0x4b, 0xa9, 0x0b);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IInternetProtocolInfo : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE CombineUrl(
      ...
      LPWSTR pwzResult, DWORD cchResult, DWORD * pcchResult,
      DWORD dwReserved) = 0;
  virtual HRESULT STDMETHODCALLTYPE CompareUrl(LPCWSTR pwzUrl1, LPCWSTR pwzUrl2,
                                               DWORD dwCompareFlags) = 0;
  virtual HRESULT STDMETHODCALLTYPE QueryInfo(
      LPCWSTR pwzUrl, QUERYOPTION OueryOption, DWORD dwQueryFlags,
      LPVOID pBuffer, DWORD cbBuffer, DWORD * pcbBuf, DWORD dwReserved) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IInternetProtocolInfo, 0x79eac9ec, 0xbaf9, 0x11ce, 0x8c, 0x82,
                0x00, 0xaa, 0x00, 0x4b, 0xa9, 0x0b)
#endif
#else
typedef struct IInternetProtocolInfoVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IInternetProtocolInfo *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *ParseUrl)(IInternetProtocolInfo *This,
                                       LPCWSTR pwzUrl, PARSEACTION ParseAction,
                                       DWORD dwParseFlags, LPWSTR pwzResult,
                                       DWORD cchResult, DWORD *pcchResult,
                                       DWORD dwReserved);
  HRESULT(STDMETHODCALLTYPE *CombineUrl)(IInternetProtocolInfo *This,
                                         LPCWSTR pwzBaseUrl,
                                         LPCWSTR pwzRelativeUrl,
                                         DWORD dwCombineFlags, LPWSTR pwzResult,
                                         DWORD cchResult, DWORD *pcchResult,
                                         DWORD dwReserved);
  HRESULT(STDMETHODCALLTYPE *CompareUrl)(IInternetProtocolInfo *This,
                                         LPCWSTR pwzUrl1, LPCWSTR pwzUrl2,
                                         DWORD dwCompareFlags);
  HRESULT(STDMETHODCALLTYPE *QueryInfo)(IInternetProtocolInfo *This,
...
/*** IInternetProtocolInfo methods ***/
#define IInternetProtocolInfo_ParseUrl(This, pwzUrl, ParseAction,              \
                                       dwParseFlags, pwzResult, cchResult,     \
                                       pcchResult, dwReserved)                 \
  (This)->lpVtbl->ParseUrl(This, pwzUrl, ParseAction, dwParseFlags, pwzResult, \
                           cchResult, pcchResult, dwReserved)
#define IInternetProtocolInfo_CombineUrl(This, pwzBaseUrl, pwzRelativeUrl,     \
                                         dwCombineFlags, pwzResult, cchResult, \
                                         pcchResult, dwReserved)               \
  (This)->lpVtbl->CombineUrl(This, pwzBaseUrl, pwzRelativeUrl, dwCombineFlags, \
                             pwzResult, cchResult, pcchResult, dwReserved)
#define IInternetProtocolInfo_CompareUrl(This, pwzUrl1, pwzUrl2,               \
                                         dwCompareFlags)                       \
  (This)->lpVtbl->CompareUrl(This, pwzUrl1, pwzUrl2, dwCompareFlags)
#define IInternetProtocolInfo_QueryInfo(This, pwzUrl, OueryOption,             \
                                        dwQueryFlags, pBuffer, cbBuffer,       \
                                        pcbBuf, dwReserved)                    \
  (This)->lpVtbl->QueryInfo(This, pwzUrl, OueryOption, dwQueryFlags, pBuffer,  \
                            cbBuffer, pcbBuf, dwReserved)
#else
/*** IUnknown methods ***/
static inline HRESULT
IInternetProtocolInfo_QueryInterface(IInternetProtocolInfo *This, REFIID riid,
                                     void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IInternetProtocolInfo methods ***/
static inline HRESULT
IInternetProtocolInfo_ParseUrl(IInternetProtocolInfo *This, LPCWSTR pwzUrl,
                               PARSEACTION ParseAction, DWORD dwParseFlags,
                               LPWSTR pwzResult, DWORD cchResult,
                               DWORD *pcchResult, DWORD dwReserved) {
  return This->lpVtbl->ParseUrl(This, pwzUrl, ParseAction, dwParseFlags,
                                pwzResult, cchResult, pcchResult, dwReserved);
}
static inline HRESULT IInternetProtocolInfo_CombineUrl(
    IInternetProtocolInfo *This, LPCWSTR pwzBaseUrl, LPCWSTR pwzRelativeUrl,
    DWORD dwCombineFlags, LPWSTR pwzResult, DWORD cchResult, DWORD *pcchResult,
    DWORD dwReserved) {
  return This->lpVtbl->CombineUrl(This, pwzBaseUrl, pwzRelativeUrl,
                                  dwCombineFlags, pwzResult, cchResult,
                                  pcchResult, dwReserved);
}
static inline HRESULT
IInternetProtocolInfo_CompareUrl(IInternetProtocolInfo *This, LPCWSTR pwzUrl1,
                                 LPCWSTR pwzUrl2, DWORD dwCompareFlags) {
  return This->lpVtbl->CompareUrl(This, pwzUrl1, pwzUrl2, dwCompareFlags);
}
static inline HRESULT
IInternetProtocolInfo_QueryInfo(IInternetProtocolInfo *This, LPCWSTR pwzUrl,
                                QUERYOPTION OueryOption, DWORD dwQueryFlags,
                                LPVOID pBuffer, DWORD cbBuffer, DWORD *pcbBuf,
                                DWORD dwReserved) {
  return This->lpVtbl->QueryInfo(This, pwzUrl, OueryOption, dwQueryFlags,
...
STDAPI CoInternetParseUrl(LPCWSTR pwzUrl, PARSEACTION ParseAction,
                          DWORD dwFlags, LPWSTR pszResult, DWORD cchResult,
                          DWORD *pcchResult, DWORD dwReserved);
#if (_WIN32_IE >= _WIN32_IE_IE70)
STDAPI CoInternetParseIUri(IUri *pIUri, PARSEACTION ParseAction, DWORD dwFlags,
                           LPWSTR pwzResult, DWORD cchResult, DWORD *pcchResult,
                           DWORD_PTR dwReserved);
#endif
STDAPI CoInternetCombineUrl(LPCWSTR pwzBaseUrl, LPCWSTR pwzRelativeUrl,
                            DWORD dwCombineFlags, LPWSTR pszResult,
                            DWORD cchResult, DWORD *pcchResult,
                            DWORD dwReserved);
#if (_WIN32_IE >= _WIN32_IE_IE70)
STDAPI CoInternetCombineUrlEx(IUri *pBaseUri, LPCWSTR pwzRelativeUrl,
                              DWORD dwCombineFlags, IUri **ppCombinedUri,
                              DWORD_PTR dwReserved);
STDAPI CoInternetCombineIUri(IUri *pBaseUri, IUri *pRelativeUri,
                             DWORD dwCombineFlags, IUri **ppCombinedUri,
                             DWORD_PTR dwReserved);
#endif
STDAPI CoInternetCompareUrl(LPCWSTR pwzUrl1, LPCWSTR pwzUrl2, DWORD dwFlags);
STDAPI CoInternetGetProtocolFlags(LPCWSTR pwzUrl, DWORD *pdwFlags,
                                  DWORD dwReserved);
STDAPI CoInternetQueryInfo(LPCWSTR pwzUrl, QUERYOPTION QueryOptions,
                           DWORD dwQueryFlags, LPVOID pvBuffer, DWORD cbBuffer,
                           DWORD *pcbBuffer, DWORD dwReserved);
STDAPI CoInternetGetSession(DWORD dwSessionMode,
                            IInternetSession **ppIInternetSession,
                            DWORD dwReserved);
STDAPI CoInternetGetSecurityUrl(LPCWSTR pwszUrl, LPWSTR *ppwszSecUrl,
                                PSUACTION psuAction, DWORD dwReserved);
STDAPI AsyncInstallDistributionUnit(LPCWSTR szDistUnit, LPCWSTR szTYPE,
                                    LPCWSTR szExt, DWORD dwFileVersionMS,
                                    DWORD dwFileVersionLS, LPCWSTR szURL,
                                    IBindCtx *pbc, LPVOID pvReserved,
                                    DWORD flags);
#if (_WIN32_IE >= _WIN32_IE_IE70)
STDAPI CoInternetGetSecurityUrlEx(IUri *pUri, IUri **ppSecUri,
                                  PSUACTION psuAction, DWORD_PTR dwReserved);
#endif
#if (_WIN32_IE >= _WIN32_IE_IE60SP2)
...
#endif
STDAPI CoInternetSetFeatureEnabled(INTERNETFEATURELIST FeatureEntry,
                                   DWORD dwFlags, WINBOOL fEnable);
STDAPI CoInternetIsFeatureEnabled(INTERNETFEATURELIST FeatureEntry,
                                  DWORD dwFlags);
STDAPI CoInternetIsFeatureEnabledForUrl(INTERNETFEATURELIST FeatureEntry,
                                        DWORD dwFlags, LPCWSTR szURL,
                                        IInternetSecurityManager *pSecMgr);
STDAPI CoInternetIsFeatureEnabledForIUri(INTERNETFEATURELIST FeatureEntry,
                                         DWORD dwFlags, IUri *pIUri,
                                         IInternetSecurityManagerEx2 *pSecMgr);
STDAPI
CoInternetIsFeatureZoneElevationEnabled(LPCWSTR szFromURL, LPCWSTR szToURL,
                                        IInternetSecurityManager *pSecMgr,
                                        DWORD dwFlags);
#endif
...
#define INET_E_USE_DEFAULT_PROTOCOLHANDLER                                     \
  _HRESULT_TYPEDEF_(__MSABI_LONG(0x800C0011))
...
STDAPI CoInternetCreateSecurityManager(IServiceProvider *pSP,
                                       IInternetSecurityManager **ppSM,
                                       DWORD dwReserved);
STDAPI CoInternetCreateZoneManager(IServiceProvider *pSP,
...
DEFINE_GUID(IID_IInternetSecurityMgrSite, 0x79eac9ed, 0xbaf9, 0x11ce, 0x8c,
...
IInternetSecurityMgrSite : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetWindow(HWND * phwnd) = 0;
  virtual HRESULT STDMETHODCALLTYPE EnableModeless(WINBOOL fEnable) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IInternetSecurityMgrSite, 0x79eac9ed, 0xbaf9, 0x11ce, 0x8c,
                0x82, 0x00, 0xaa, 0x00, 0x4b, 0xa9, 0x0b)
#endif
#else
typedef struct IInternetSecurityMgrSiteVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IInternetSecurityMgrSite *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetWindow)(IInternetSecurityMgrSite *This,
                                        HWND *phwnd);
  HRESULT(STDMETHODCALLTYPE *EnableModeless)(IInternetSecurityMgrSite *This,
                                             WINBOOL fEnable);
  END_INTERFACE
...
/*** IUnknown methods ***/
static inline HRESULT
IInternetSecurityMgrSite_QueryInterface(IInternetSecurityMgrSite *This,
                                        REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IInternetSecurityMgrSite_AddRef(IInternetSecurityMgrSite *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IInternetSecurityMgrSite_Release(IInternetSecurityMgrSite *This) {
  return This->lpVtbl->Release(This);
}
/*** IInternetSecurityMgrSite methods ***/
static inline HRESULT
IInternetSecurityMgrSite_GetWindow(IInternetSecurityMgrSite *This,
                                   HWND *phwnd) {
  return This->lpVtbl->GetWindow(This, phwnd);
}
static inline HRESULT
IInternetSecurityMgrSite_EnableModeless(IInternetSecurityMgrSite *This,
                                        WINBOOL fEnable) {
...
DEFINE_GUID(IID_IInternetSecurityManager, 0x79eac9ee, 0xbaf9, 0x11ce, 0x8c,
            0x82, 0x00, 0xaa, 0x00, 0x4b, 0xa9, 0x0b);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("79eac9ee-baf9-11ce-8c82-00aa004ba90b")
IInternetSecurityManager : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE SetSecuritySite(IInternetSecurityMgrSite *
                                                    pSite) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetSecuritySite(IInternetSecurityMgrSite *
                                                    *ppSite) = 0;
  virtual HRESULT STDMETHODCALLTYPE MapUrlToZone(
      LPCWSTR pwszUrl, DWORD * pdwZone, DWORD dwFlags) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetSecurityId(
      LPCWSTR pwszUrl, BYTE * pbSecurityId, DWORD * pcbSecurityId,
      DWORD_PTR dwReserved) = 0;
  virtual HRESULT STDMETHODCALLTYPE ProcessUrlAction(
      LPCWSTR pwszUrl, DWORD dwAction, BYTE * pPolicy, DWORD cbPolicy,
      BYTE * pContext, DWORD cbContext, DWORD dwFlags, DWORD dwReserved) = 0;
  virtual HRESULT STDMETHODCALLTYPE QueryCustomPolicy(
      LPCWSTR pwszUrl, REFGUID guidKey, BYTE * *ppPolicy, DWORD * pcbPolicy,
      BYTE * pContext, DWORD cbContext, DWORD dwReserved) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetZoneMapping(
      DWORD dwZone, LPCWSTR lpszPattern, DWORD dwFlags) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetZoneMappings(
      DWORD dwZone, IEnumString * *ppenumString, DWORD dwFlags) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IInternetSecurityManager, 0x79eac9ee, 0xbaf9, 0x11ce, 0x8c,
                0x82, 0x00, 0xaa, 0x00, 0x4b, 0xa9, 0x0b)
#endif
#else
typedef struct IInternetSecurityManagerVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IInternetSecurityManager *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *SetSecuritySite)(IInternetSecurityManager *This,
                                              IInternetSecurityMgrSite *pSite);
  HRESULT(STDMETHODCALLTYPE *GetSecuritySite)(
      IInternetSecurityManager *This, IInternetSecurityMgrSite **ppSite);
  HRESULT(STDMETHODCALLTYPE *MapUrlToZone)(IInternetSecurityManager *This,
                                           LPCWSTR pwszUrl, DWORD *pdwZone,
                                           DWORD dwFlags);
  HRESULT(STDMETHODCALLTYPE *GetSecurityId)(IInternetSecurityManager *This,
                                            LPCWSTR pwszUrl, BYTE *pbSecurityId,
                                            DWORD *pcbSecurityId,
                                            DWORD_PTR dwReserved);
  HRESULT(STDMETHODCALLTYPE *ProcessUrlAction)(IInternetSecurityManager *This,
  ...
  HRESULT(STDMETHODCALLTYPE *QueryCustomPolicy)(
      IInternetSecurityManager *This, LPCWSTR pwszUrl, REFGUID guidKey,
      BYTE **ppPolicy, DWORD *pcbPolicy, BYTE *pContext, DWORD cbContext,
      DWORD dwReserved);
  HRESULT(STDMETHODCALLTYPE *SetZoneMapping)(IInternetSecurityManager *This,
                                             DWORD dwZone, LPCWSTR lpszPattern,
                                             DWORD dwFlags);
  HRESULT(STDMETHODCALLTYPE *GetZoneMappings)(IInternetSecurityManager *This,
                                              DWORD dwZone,
...
#define IInternetSecurityManager_GetSecurityId(This, pwszUrl, pbSecurityId,    \
                                               pcbSecurityId, dwReserved)      \
  (This)->lpVtbl->GetSecurityId(This, pwszUrl, pbSecurityId, pcbSecurityId,    \
                                dwReserved)
#define IInternetSecurityManager_ProcessUrlAction(                             \
    This, pwszUrl, dwAction, pPolicy, cbPolicy, pContext, cbContext, dwFlags,  \
    dwReserved)                                                                \
  (This)->lpVtbl->ProcessUrlAction(This, pwszUrl, dwAction, pPolicy, cbPolicy, \
                                   pContext, cbContext, dwFlags, dwReserved)
#define IInternetSecurityManager_QueryCustomPolicy(                            \
    This, pwszUrl, guidKey, ppPolicy, pcbPolicy, pContext, cbContext,          \
    dwReserved)                                                                \
  (This)->lpVtbl->QueryCustomPolicy(This, pwszUrl, guidKey, ppPolicy,          \
                                    pcbPolicy, pContext, cbContext,            \
                                    dwReserved)
#define IInternetSecurityManager_SetZoneMapping(This, dwZone, lpszPattern,     \
                                                dwFlags)                       \
  (This)->lpVtbl->SetZoneMapping(This, dwZone, lpszPattern, dwFlags)
#define IInternetSecurityManager_GetZoneMappings(This, dwZone, ppenumString,   \
                                                 dwFlags)                      \
  (This)->lpVtbl->GetZoneMappings(This, dwZone, ppenumString, dwFlags)
#else
/*** IUnknown methods ***/
static inline HRESULT
IInternetSecurityManager_QueryInterface(IInternetSecurityManager *This,
                                        REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IInternetSecurityManager_AddRef(IInternetSecurityManager *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IInternetSecurityManager_Release(IInternetSecurityManager *This) {
  return This->lpVtbl->Release(This);
}
/*** IInternetSecurityManager methods ***/
static inline HRESULT
IInternetSecurityManager_SetSecuritySite(IInternetSecurityManager *This,
                                         IInternetSecurityMgrSite *pSite) {
  return This->lpVtbl->SetSecuritySite(This, pSite);
}
static inline HRESULT
IInternetSecurityManager_GetSecuritySite(IInternetSecurityManager *This,
                                         IInternetSecurityMgrSite **ppSite) {
  return This->lpVtbl->GetSecuritySite(This, ppSite);
}
static inline HRESULT
IInternetSecurityManager_MapUrlToZone(IInternetSecurityManager *This,
                                      LPCWSTR pwszUrl, DWORD *pdwZone,
                                      DWORD dwFlags) {
  return This->lpVtbl->MapUrlToZone(This, pwszUrl, pdwZone, dwFlags);
}
static inline HRESULT IInternetSecurityManager_GetSecurityId(
    IInternetSecurityManager *This, LPCWSTR pwszUrl, BYTE *pbSecurityId,
    DWORD *pcbSecurityId, DWORD_PTR dwReserved) {
  return This->lpVtbl->GetSecurityId(This, pwszUrl, pbSecurityId, pcbSecurityId,
                                     dwReserved);
}
static inline HRESULT IInternetSecurityManager_ProcessUrlAction(
    IInternetSecurityManager *This, LPCWSTR pwszUrl, DWORD dwAction,
    BYTE *pPolicy, DWORD cbPolicy, BYTE *pContext, DWORD cbContext,
    DWORD dwFlags, DWORD dwReserved) {
  return This->lpVtbl->ProcessUrlAction(This, pwszUrl, dwAction, pPolicy,
                                        cbPolicy, pContext, cbContext, dwFlags,
                                        dwReserved);
}
static inline HRESULT IInternetSecurityManager_QueryCustomPolicy(
    IInternetSecurityManager *This, LPCWSTR pwszUrl, REFGUID guidKey,
    BYTE **ppPolicy, DWORD *pcbPolicy, BYTE *pContext, DWORD cbContext,
    DWORD dwReserved) {
  return This->lpVtbl->QueryCustomPolicy(This, pwszUrl, guidKey, ppPolicy,
                                         pcbPolicy, pContext, cbContext,
                                         dwReserved);
}
static inline HRESULT
IInternetSecurityManager_SetZoneMapping(IInternetSecurityManager *This,
                                        DWORD dwZone, LPCWSTR lpszPattern,
                                        DWORD dwFlags) {
  return This->lpVtbl->SetZoneMapping(This, dwZone, lpszPattern, dwFlags);
}
static inline HRESULT IInternetSecurityManager_GetZoneMappings(
    IInternetSecurityManager *This, DWORD dwZone, IEnumString **ppenumString,
    DWORD dwFlags) {
...
DEFINE_GUID(IID_IInternetSecurityManagerEx, 0xf164edf1, 0xcc7c, 0x4f0d, 0x9a,
            0x94, 0x34, 0x22, 0x26, 0x25, 0xc3, 0x93);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IInternetSecurityManagerEx, 0xf164edf1, 0xcc7c, 0x4f0d, 0x9a,
                0x94, 0x34, 0x22, 0x26, 0x25, 0xc3, 0x93)
#endif
#else
typedef struct IInternetSecurityManagerExVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IInternetSecurityManagerEx *This,
                                             REFIID riid, void **ppvObject);
  ...
  /*** IInternetSecurityManager methods ***/
  HRESULT(STDMETHODCALLTYPE *SetSecuritySite)(IInternetSecurityManagerEx *This,
                                              IInternetSecurityMgrSite *pSite);
  HRESULT(STDMETHODCALLTYPE *GetSecuritySite)(
      IInternetSecurityManagerEx *This, IInternetSecurityMgrSite **ppSite);
  HRESULT(STDMETHODCALLTYPE *MapUrlToZone)(IInternetSecurityManagerEx *This,
                                           LPCWSTR pwszUrl, DWORD *pdwZone,
                                           DWORD dwFlags);
  HRESULT(STDMETHODCALLTYPE *GetSecurityId)(IInternetSecurityManagerEx *This,
                                            LPCWSTR pwszUrl, BYTE *pbSecurityId,
                                            DWORD *pcbSecurityId,
                                            DWORD_PTR dwReserved);
  HRESULT(STDMETHODCALLTYPE *ProcessUrlAction)(IInternetSecurityManagerEx *This,
                                               LPCWSTR pwszUrl, DWORD dwAction,
                                               BYTE *pPolicy, DWORD cbPolicy,
                                               BYTE *pContext, DWORD cbContext,
                                               DWORD dwFlags, DWORD dwReserved);
  HRESULT(STDMETHODCALLTYPE *QueryCustomPolicy)(
      IInternetSecurityManagerEx *This, LPCWSTR pwszUrl, REFGUID guidKey,
      BYTE **ppPolicy, DWORD *pcbPolicy, BYTE *pContext, DWORD cbContext,
      DWORD dwReserved);
  HRESULT(STDMETHODCALLTYPE *SetZoneMapping)(IInternetSecurityManagerEx *This,
                                             DWORD dwZone, LPCWSTR lpszPattern,
                                             DWORD dwFlags);
  HRESULT(STDMETHODCALLTYPE *GetZoneMappings)(IInternetSecurityManagerEx *This,
                                              DWORD dwZone,
                                              IEnumString **ppenumString,
                                              DWORD dwFlags);
  /*** IInternetSecurityManagerEx methods ***/
  HRESULT(STDMETHODCALLTYPE *ProcessUrlActionEx)(
      IInternetSecurityManagerEx *This, LPCWSTR pwszUrl, DWORD dwAction,
      BYTE *pPolicy, DWORD cbPolicy, BYTE *pContext, DWORD cbContext,
...
#define IInternetSecurityManagerEx_GetSecuritySite(This, ppSite)               \
  (This)->lpVtbl->GetSecuritySite(This, ppSite)
#define IInternetSecurityManagerEx_MapUrlToZone(This, pwszUrl, pdwZone,        \
                                                dwFlags)                       \
  (This)->lpVtbl->MapUrlToZone(This, pwszUrl, pdwZone, dwFlags)
#define IInternetSecurityManagerEx_GetSecurityId(This, pwszUrl, pbSecurityId,  \
                                                 pcbSecurityId, dwReserved)    \
  (This)->lpVtbl->GetSecurityId(This, pwszUrl, pbSecurityId, pcbSecurityId,    \
                                dwReserved)
#define IInternetSecurityManagerEx_ProcessUrlAction(                           \
    This, pwszUrl, dwAction, pPolicy, cbPolicy, pContext, cbContext, dwFlags,  \
    dwReserved)                                                                \
  (This)->lpVtbl->ProcessUrlAction(This, pwszUrl, dwAction, pPolicy, cbPolicy, \
                                   pContext, cbContext, dwFlags, dwReserved)
#define IInternetSecurityManagerEx_QueryCustomPolicy(                          \
    This, pwszUrl, guidKey, ppPolicy, pcbPolicy, pContext, cbContext,          \
    dwReserved)                                                                \
  (This)->lpVtbl->QueryCustomPolicy(This, pwszUrl, guidKey, ppPolicy,          \
                                    pcbPolicy, pContext, cbContext,            \
                                    dwReserved)
#define IInternetSecurityManagerEx_SetZoneMapping(This, dwZone, lpszPattern,   \
                                                  dwFlags)                     \
  (This)->lpVtbl->SetZoneMapping(This, dwZone, lpszPattern, dwFlags)
#define IInternetSecurityManagerEx_GetZoneMappings(This, dwZone, ppenumString, \
                                                   dwFlags)                    \
  (This)->lpVtbl->GetZoneMappings(This, dwZone, ppenumString, dwFlags)
/*** IInternetSecurityManagerEx methods ***/
#define IInternetSecurityManagerEx_ProcessUrlActionEx(                         \
    This, pwszUrl, dwAction, pPolicy, cbPolicy, pContext, cbContext, dwFlags,  \
...
/*** IUnknown methods ***/
static inline HRESULT
IInternetSecurityManagerEx_QueryInterface(IInternetSecurityManagerEx *This,
                                          REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IInternetSecurityManagerEx_AddRef(IInternetSecurityManagerEx *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IInternetSecurityManagerEx_Release(IInternetSecurityManagerEx *This) {
  return This->lpVtbl->Release(This);
}
/*** IInternetSecurityManager methods ***/
static inline HRESULT
IInternetSecurityManagerEx_SetSecuritySite(IInternetSecurityManagerEx *This,
                                           IInternetSecurityMgrSite *pSite) {
  return This->lpVtbl->SetSecuritySite(This, pSite);
}
static inline HRESULT
IInternetSecurityManagerEx_GetSecuritySite(IInternetSecurityManagerEx *This,
                                           IInternetSecurityMgrSite **ppSite) {
  return This->lpVtbl->GetSecuritySite(This, ppSite);
}
static inline HRESULT
IInternetSecurityManagerEx_MapUrlToZone(IInternetSecurityManagerEx *This,
                                        LPCWSTR pwszUrl, DWORD *pdwZone,
                                        DWORD dwFlags) {
  return This->lpVtbl->MapUrlToZone(This, pwszUrl, pdwZone, dwFlags);
}
static inline HRESULT IInternetSecurityManagerEx_GetSecurityId(
    IInternetSecurityManagerEx *This, LPCWSTR pwszUrl, BYTE *pbSecurityId,
    DWORD *pcbSecurityId, DWORD_PTR dwReserved) {
  return This->lpVtbl->GetSecurityId(This, pwszUrl, pbSecurityId, pcbSecurityId,
                                     dwReserved);
}
static inline HRESULT IInternetSecurityManagerEx_ProcessUrlAction(
    IInternetSecurityManagerEx *This, LPCWSTR pwszUrl, DWORD dwAction,
    BYTE *pPolicy, DWORD cbPolicy, BYTE *pContext, DWORD cbContext,
    DWORD dwFlags, DWORD dwReserved) {
  return This->lpVtbl->ProcessUrlAction(This, pwszUrl, dwAction, pPolicy,
...
static inline HRESULT IInternetSecurityManagerEx_QueryCustomPolicy(
    IInternetSecurityManagerEx *This, LPCWSTR pwszUrl, REFGUID guidKey,
    BYTE **ppPolicy, DWORD *pcbPolicy, BYTE *pContext, DWORD cbContext,
    DWORD dwReserved) {
  return This->lpVtbl->QueryCustomPolicy(This, pwszUrl, guidKey, ppPolicy,
...
static inline HRESULT
IInternetSecurityManagerEx_SetZoneMapping(IInternetSecurityManagerEx *This,
                                          DWORD dwZone, LPCWSTR lpszPattern,
                                          DWORD dwFlags) {
  return This->lpVtbl->SetZoneMapping(This, dwZone, lpszPattern, dwFlags);
}
static inline HRESULT IInternetSecurityManagerEx_GetZoneMappings(
    IInternetSecurityManagerEx *This, DWORD dwZone, IEnumString **ppenumString,
    DWORD dwFlags) {
  return This->lpVtbl->GetZoneMappings(This, dwZone, ppenumString, dwFlags);
}
/*** IInternetSecurityManagerEx methods ***/
static inline HRESULT IInternetSecurityManagerEx_ProcessUrlActionEx(
    IInternetSecurityManagerEx *This, LPCWSTR pwszUrl, DWORD dwAction,
    BYTE *pPolicy, DWORD cbPolicy, BYTE *pContext, DWORD cbContext,
    DWORD dwFlags, DWORD dwReserved, DWORD *pdwOutFlags) {
...
DEFINE_GUID(IID_IInternetSecurityManagerEx2, 0xf1e50292, 0xa795, 0x4117, 0x8e,
            0x09, 0x2b, 0x56, 0x0a, 0x72, 0xac, 0x60);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IInternetSecurityManagerEx2 : public IInternetSecurityManagerEx {
  virtual HRESULT STDMETHODCALLTYPE MapUrlToZoneEx2(
      IUri * pUri, DWORD * pdwZone, DWORD dwFlags, LPWSTR * ppwszMappedUrl,
      DWORD * pdwOutFlags) = 0;
  virtual HRESULT STDMETHODCALLTYPE ProcessUrlActionEx2(
      IUri * pUri, DWORD dwAction, BYTE * pPolicy, DWORD cbPolicy,
      BYTE * pContext, DWORD cbContext, DWORD dwFlags, DWORD_PTR dwReserved,
      DWORD * pdwOutFlags) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetSecurityIdEx2(
      IUri * pUri, BYTE * pbSecurityId, DWORD * pcbSecurityId,
      DWORD_PTR dwReserved) = 0;
  virtual HRESULT STDMETHODCALLTYPE QueryCustomPolicyEx2(
      IUri * pUri, REFGUID guidKey, BYTE * *ppPolicy, DWORD * pcbPolicy,
      BYTE * pContext, DWORD cbContext, DWORD_PTR dwReserved) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IInternetSecurityManagerEx2, 0xf1e50292, 0xa795, 0x4117, 0x8e,
                0x09, 0x2b, 0x56, 0x0a, 0x72, 0xac, 0x60)
#endif
#else
typedef struct IInternetSecurityManagerEx2Vtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IInternetSecurityManagerEx2 *This,
                                             REFIID riid, void **ppvObject);
  ...
  /*** IInternetSecurityManager methods ***/
  HRESULT(STDMETHODCALLTYPE *SetSecuritySite)(IInternetSecurityManagerEx2 *This,
                                              IInternetSecurityMgrSite *pSite);
  HRESULT(STDMETHODCALLTYPE *GetSecuritySite)(
      IInternetSecurityManagerEx2 *This, IInternetSecurityMgrSite **ppSite);
  HRESULT(STDMETHODCALLTYPE *MapUrlToZone)(IInternetSecurityManagerEx2 *This,
                                           LPCWSTR pwszUrl, DWORD *pdwZone,
                                           DWORD dwFlags);
  HRESULT(STDMETHODCALLTYPE *GetSecurityId)(IInternetSecurityManagerEx2 *This,
                                            LPCWSTR pwszUrl, BYTE *pbSecurityId,
                                            DWORD *pcbSecurityId,
                                            DWORD_PTR dwReserved);
  HRESULT(STDMETHODCALLTYPE *ProcessUrlAction)(
      IInternetSecurityManagerEx2 *This, LPCWSTR pwszUrl, DWORD dwAction,
      BYTE *pPolicy, DWORD cbPolicy, BYTE *pContext, DWORD cbContext,
      DWORD dwFlags, DWORD dwReserved);
  HRESULT(STDMETHODCALLTYPE *QueryCustomPolicy)(
      IInternetSecurityManagerEx2 *This, LPCWSTR pwszUrl, REFGUID guidKey,
      BYTE **ppPolicy, DWORD *pcbPolicy, BYTE *pContext, DWORD cbContext,
      DWORD dwReserved);
  HRESULT(STDMETHODCALLTYPE *SetZoneMapping)(IInternetSecurityManagerEx2 *This,
                                             DWORD dwZone, LPCWSTR lpszPattern,
                                             DWORD dwFlags);
  HRESULT(STDMETHODCALLTYPE *GetZoneMappings)(IInternetSecurityManagerEx2 *This,
                                              DWORD dwZone,
                                              IEnumString **ppenumString,
                                              DWORD dwFlags);
  /*** IInternetSecurityManagerEx methods ***/
  ...
  HRESULT(STDMETHODCALLTYPE *MapUrlToZoneEx2)(IInternetSecurityManagerEx2 *This,
                                              IUri *pUri, DWORD *pdwZone,
                                              DWORD dwFlags,
                                              LPWSTR *ppwszMappedUrl,
                                              DWORD *pdwOutFlags);
  HRESULT(STDMETHODCALLTYPE *ProcessUrlActionEx2)(
      IInternetSecurityManagerEx2 *This, IUri *pUri, DWORD dwAction,
      BYTE *pPolicy, DWORD cbPolicy, BYTE *pContext, DWORD cbContext,
      DWORD dwFlags, DWORD_PTR dwReserved, DWORD *pdwOutFlags);
  HRESULT(STDMETHODCALLTYPE *GetSecurityIdEx2)(
      IInternetSecurityManagerEx2 *This, IUri *pUri, BYTE *pbSecurityId,
      DWORD *pcbSecurityId, DWORD_PTR dwReserved);
  HRESULT(STDMETHODCALLTYPE *QueryCustomPolicyEx2)(
      IInternetSecurityManagerEx2 *This, IUri *pUri, REFGUID guidKey,
      BYTE **ppPolicy, DWORD *pcbPolicy, BYTE *pContext, DWORD cbContext,
      DWORD_PTR dwReserved);
  END_INTERFACE
...
#define IInternetSecurityManagerEx2_GetSecuritySite(This, ppSite)              \
  (This)->lpVtbl->GetSecuritySite(This, ppSite)
#define IInternetSecurityManagerEx2_MapUrlToZone(This, pwszUrl, pdwZone,       \
                                                 dwFlags)                      \
  (This)->lpVtbl->MapUrlToZone(This, pwszUrl, pdwZone, dwFlags)
#define IInternetSecurityManagerEx2_GetSecurityId(This, pwszUrl, pbSecurityId, \
                                                  pcbSecurityId, dwReserved)   \
  (This)->lpVtbl->GetSecurityId(This, pwszUrl, pbSecurityId, pcbSecurityId,    \
                                dwReserved)
#define IInternetSecurityManagerEx2_ProcessUrlAction(                          \
    This, pwszUrl, dwAction, pPolicy, cbPolicy, pContext, cbContext, dwFlags,  \
    dwReserved)                                                                \
  (This)->lpVtbl->ProcessUrlAction(This, pwszUrl, dwAction, pPolicy, cbPolicy, \
                                   pContext, cbContext, dwFlags, dwReserved)
#define IInternetSecurityManagerEx2_QueryCustomPolicy(                         \
    This, pwszUrl, guidKey, ppPolicy, pcbPolicy, pContext, cbContext,          \
    dwReserved)                                                                \
  (This)->lpVtbl->QueryCustomPolicy(This, pwszUrl, guidKey, ppPolicy,          \
                                    pcbPolicy, pContext, cbContext,            \
                                    dwReserved)
#define IInternetSecurityManagerEx2_SetZoneMapping(This, dwZone, lpszPattern,  \
                                                   dwFlags)                    \
  (This)->lpVtbl->SetZoneMapping(This, dwZone, lpszPattern, dwFlags)
#define IInternetSecurityManagerEx2_GetZoneMappings(This, dwZone,              \
                                                    ppenumString, dwFlags)     \
  (This)->lpVtbl->GetZoneMappings(This, dwZone, ppenumString, dwFlags)
/*** IInternetSecurityManagerEx methods ***/
#define IInternetSecurityManagerEx2_ProcessUrlActionEx(                        \
    This, pwszUrl, dwAction, pPolicy, cbPolicy, pContext, cbContext, dwFlags,  \
    dwReserved, pdwOutFlags)                                                   \
  (This)->lpVtbl->ProcessUrlActionEx(This, pwszUrl, dwAction, pPolicy,         \
                                     cbPolicy, pContext, cbContext, dwFlags,   \
                                     dwReserved, pdwOutFlags)
/*** IInternetSecurityManagerEx2 methods ***/
#define IInternetSecurityManagerEx2_MapUrlToZoneEx2(                           \
    This, pUri, pdwZone, dwFlags, ppwszMappedUrl, pdwOutFlags)                 \
  (This)->lpVtbl->MapUrlToZoneEx2(This, pUri, pdwZone, dwFlags,                \
                                  ppwszMappedUrl, pdwOutFlags)
#define IInternetSecurityManagerEx2_ProcessUrlActionEx2(                       \
    This, pUri, dwAction, pPolicy, cbPolicy, pContext, cbContext, dwFlags,     \
    dwReserved, pdwOutFlags)                                                   \
  (This)->lpVtbl->ProcessUrlActionEx2(This, pUri, dwAction, pPolicy, cbPolicy, \
                                      pContext, cbContext, dwFlags,            \
                                      dwReserved, pdwOutFlags)
#define IInternetSecurityManagerEx2_GetSecurityIdEx2(                          \
    This, pUri, pbSecurityId, pcbSecurityId, dwReserved)                       \
  (This)->lpVtbl->GetSecurityIdEx2(This, pUri, pbSecurityId, pcbSecurityId,    \
                                   dwReserved)
#define IInternetSecurityManagerEx2_QueryCustomPolicyEx2(                      \
    This, pUri, guidKey, ppPolicy, pcbPolicy, pContext, cbContext, dwReserved) \
  (This)->lpVtbl->QueryCustomPolicyEx2(This, pUri, guidKey, ppPolicy,          \
                                       pcbPolicy, pContext, cbContext,         \
                                       dwReserved)
#else
/*** IUnknown methods ***/
static inline HRESULT
IInternetSecurityManagerEx2_QueryInterface(IInternetSecurityManagerEx2 *This,
                                           REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IInternetSecurityManagerEx2_AddRef(IInternetSecurityManagerEx2 *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IInternetSecurityManagerEx2_Release(IInternetSecurityManagerEx2 *This) {
  return This->lpVtbl->Release(This);
}
/*** IInternetSecurityManager methods ***/
static inline HRESULT
IInternetSecurityManagerEx2_SetSecuritySite(IInternetSecurityManagerEx2 *This,
                                            IInternetSecurityMgrSite *pSite) {
  return This->lpVtbl->SetSecuritySite(This, pSite);
}
static inline HRESULT
IInternetSecurityManagerEx2_GetSecuritySite(IInternetSecurityManagerEx2 *This,
                                            IInternetSecurityMgrSite **ppSite) {
  return This->lpVtbl->GetSecuritySite(This, ppSite);
}
static inline HRESULT
IInternetSecurityManagerEx2_MapUrlToZone(IInternetSecurityManagerEx2 *This,
                                         LPCWSTR pwszUrl, DWORD *pdwZone,
                                         DWORD dwFlags) {
  return This->lpVtbl->MapUrlToZone(This, pwszUrl, pdwZone, dwFlags);
}
static inline HRESULT IInternetSecurityManagerEx2_GetSecurityId(
    IInternetSecurityManagerEx2 *This, LPCWSTR pwszUrl, BYTE *pbSecurityId,
    DWORD *pcbSecurityId, DWORD_PTR dwReserved) {
  return This->lpVtbl->GetSecurityId(This, pwszUrl, pbSecurityId, pcbSecurityId,
                                     dwReserved);
}
static inline HRESULT IInternetSecurityManagerEx2_ProcessUrlAction(
    IInternetSecurityManagerEx2 *This, LPCWSTR pwszUrl, DWORD dwAction,
    BYTE *pPolicy, DWORD cbPolicy, BYTE *pContext, DWORD cbContext,
    DWORD dwFlags, DWORD dwReserved) {
  return This->lpVtbl->ProcessUrlAction(This, pwszUrl, dwAction, pPolicy,
...
static inline HRESULT IInternetSecurityManagerEx2_QueryCustomPolicy(
    IInternetSecurityManagerEx2 *This, LPCWSTR pwszUrl, REFGUID guidKey,
    BYTE **ppPolicy, DWORD *pcbPolicy, BYTE *pContext, DWORD cbContext,
    DWORD dwReserved) {
  return This->lpVtbl->QueryCustomPolicy(This, pwszUrl, guidKey, ppPolicy,
...
static inline HRESULT
IInternetSecurityManagerEx2_SetZoneMapping(IInternetSecurityManagerEx2 *This,
                                           DWORD dwZone, LPCWSTR lpszPattern,
                                           DWORD dwFlags) {
  return This->lpVtbl->SetZoneMapping(This, dwZone, lpszPattern, dwFlags);
}
static inline HRESULT IInternetSecurityManagerEx2_GetZoneMappings(
    IInternetSecurityManagerEx2 *This, DWORD dwZone, IEnumString **ppenumString,
    DWORD dwFlags) {
  return This->lpVtbl->GetZoneMappings(This, dwZone, ppenumString, dwFlags);
}
/*** IInternetSecurityManagerEx methods ***/
static inline HRESULT IInternetSecurityManagerEx2_ProcessUrlActionEx(
    IInternetSecurityManagerEx2 *This, LPCWSTR pwszUrl, DWORD dwAction,
    BYTE *pPolicy, DWORD cbPolicy, BYTE *pContext, DWORD cbContext,
    DWORD dwFlags, DWORD dwReserved, DWORD *pdwOutFlags) {
  return This->lpVtbl->ProcessUrlActionEx(This, pwszUrl, dwAction, pPolicy,
...
/*** IInternetSecurityManagerEx2 methods ***/
static inline HRESULT IInternetSecurityManagerEx2_MapUrlToZoneEx2(
    IInternetSecurityManagerEx2 *This, IUri *pUri, DWORD *pdwZone,
    DWORD dwFlags, LPWSTR *ppwszMappedUrl, DWORD *pdwOutFlags) {
  return This->lpVtbl->MapUrlToZoneEx2(This, pUri, pdwZone, dwFlags,
                                       ppwszMappedUrl, pdwOutFlags);
}
static inline HRESULT IInternetSecurityManagerEx2_ProcessUrlActionEx2(
    IInternetSecurityManagerEx2 *This, IUri *pUri, DWORD dwAction,
    BYTE *pPolicy, DWORD cbPolicy, BYTE *pContext, DWORD cbContext,
    DWORD dwFlags, DWORD_PTR dwReserved, DWORD *pdwOutFlags) {
  return This->lpVtbl->ProcessUrlActionEx2(This, pUri, dwAction, pPolicy,
                                           cbPolicy, pContext, cbContext,
                                           dwFlags, dwReserved, pdwOutFlags);
}
static inline HRESULT IInternetSecurityManagerEx2_GetSecurityIdEx2(
    IInternetSecurityManagerEx2 *This, IUri *pUri, BYTE *pbSecurityId,
    DWORD *pcbSecurityId, DWORD_PTR dwReserved) {
  return This->lpVtbl->GetSecurityIdEx2(This, pUri, pbSecurityId, pcbSecurityId,
                                        dwReserved);
}
static inline HRESULT IInternetSecurityManagerEx2_QueryCustomPolicyEx2(
    IInternetSecurityManagerEx2 *This, IUri *pUri, REFGUID guidKey,
    BYTE **ppPolicy, DWORD *pcbPolicy, BYTE *pContext, DWORD cbContext,
    DWORD_PTR dwReserved) {
  return This->lpVtbl->QueryCustomPolicyEx2(This, pUri, guidKey, ppPolicy,
                                            pcbPolicy, pContext, cbContext,
                                            dwReserved);
}
#endif
...
DEFINE_GUID(IID_IZoneIdentifier, 0xcd45f185, 0x1b21, 0x48e2, 0x96, 0x7b, 0xea,
            0xd7, 0x43, 0xa8, 0x91, 0x4e);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IZoneIdentifier, 0xcd45f185, 0x1b21, 0x48e2, 0x96, 0x7b, 0xea,
                0xd7, 0x43, 0xa8, 0x91, 0x4e)
#endif
#else
typedef struct IZoneIdentifierVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IZoneIdentifier *This, REFIID riid,
                                             void **ppvObject);
...
interface IZoneIdentifier { CONST_VTBL IZoneIdentifierVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IZoneIdentifier_QueryInterface(IZoneIdentifier *This,
                                                     REFIID riid,
                                                     void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IZoneIdentifier methods ***/
static inline HRESULT IZoneIdentifier_GetId(IZoneIdentifier *This,
                                            DWORD *pdwZone) {
  return This->lpVtbl->GetId(This, pdwZone);
}
static inline HRESULT IZoneIdentifier_SetId(IZoneIdentifier *This,
                                            DWORD dwZone) {
...
DEFINE_GUID(IID_IInternetHostSecurityManager, 0x3af280b6, 0xcb3f, 0x11d0, 0x89,
            0x1e, 0x00, 0xc0, 0x4f, 0xb6, 0xbf, 0xc4);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IInternetHostSecurityManager : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetSecurityId(
      BYTE * pbSecurityId, DWORD * pcbSecurityId, DWORD_PTR dwReserved) = 0;
  virtual HRESULT STDMETHODCALLTYPE ProcessUrlAction(
      DWORD dwAction, BYTE * pPolicy, DWORD cbPolicy, BYTE * pContext,
      DWORD cbContext, DWORD dwFlags, DWORD dwReserved) = 0;
  virtual HRESULT STDMETHODCALLTYPE QueryCustomPolicy(
      REFGUID guidKey, BYTE * *ppPolicy, DWORD * pcbPolicy, BYTE * pContext,
      DWORD cbContext, DWORD dwReserved) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IInternetHostSecurityManager, 0x3af280b6, 0xcb3f, 0x11d0, 0x89,
                0x1e, 0x00, 0xc0, 0x4f, 0xb6, 0xbf, 0xc4)
#endif
#else
typedef struct IInternetHostSecurityManagerVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IInternetHostSecurityManager *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetSecurityId)(IInternetHostSecurityManager *This,
                                            BYTE *pbSecurityId,
                                            DWORD *pcbSecurityId,
                                            DWORD_PTR dwReserved);
  HRESULT(STDMETHODCALLTYPE *ProcessUrlAction)(
      IInternetHostSecurityManager *This, DWORD dwAction, BYTE *pPolicy,
      DWORD cbPolicy, BYTE *pContext, DWORD cbContext, DWORD dwFlags,
      DWORD dwReserved);
  HRESULT(STDMETHODCALLTYPE *QueryCustomPolicy)(
      IInternetHostSecurityManager *This, REFGUID guidKey, BYTE **ppPolicy,
...
/*** IInternetHostSecurityManager methods ***/
#define IInternetHostSecurityManager_GetSecurityId(This, pbSecurityId,         \
                                                   pcbSecurityId, dwReserved)  \
  (This)->lpVtbl->GetSecurityId(This, pbSecurityId, pcbSecurityId, dwReserved)
#define IInternetHostSecurityManager_ProcessUrlAction(                         \
    This, dwAction, pPolicy, cbPolicy, pContext, cbContext, dwFlags,           \
    dwReserved)                                                                \
  (This)->lpVtbl->ProcessUrlAction(This, dwAction, pPolicy, cbPolicy,          \
                                   pContext, cbContext, dwFlags, dwReserved)
#define IInternetHostSecurityManager_QueryCustomPolicy(                        \
    This, guidKey, ppPolicy, pcbPolicy, pContext, cbContext, dwReserved)       \
  (This)->lpVtbl->QueryCustomPolicy(This, guidKey, ppPolicy, pcbPolicy,        \
                                    pContext, cbContext, dwReserved)
#else
/*** IUnknown methods ***/
static inline HRESULT
IInternetHostSecurityManager_QueryInterface(IInternetHostSecurityManager *This,
                                            REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IInternetHostSecurityManager_AddRef(IInternetHostSecurityManager *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IInternetHostSecurityManager_Release(IInternetHostSecurityManager *This) {
  return This->lpVtbl->Release(This);
}
/*** IInternetHostSecurityManager methods ***/
static inline HRESULT IInternetHostSecurityManager_GetSecurityId(
    IInternetHostSecurityManager *This, BYTE *pbSecurityId,
    DWORD *pcbSecurityId, DWORD_PTR dwReserved) {
  return This->lpVtbl->GetSecurityId(This, pbSecurityId, pcbSecurityId,
                                     dwReserved);
}
static inline HRESULT IInternetHostSecurityManager_ProcessUrlAction(
    IInternetHostSecurityManager *This, DWORD dwAction, BYTE *pPolicy,
    DWORD cbPolicy, BYTE *pContext, DWORD cbContext, DWORD dwFlags,
    DWORD dwReserved) {
  return This->lpVtbl->ProcessUrlAction(This, dwAction, pPolicy, cbPolicy,
                                        pContext, cbContext, dwFlags,
                                        dwReserved);
}
static inline HRESULT IInternetHostSecurityManager_QueryCustomPolicy(
    IInternetHostSecurityManager *This, REFGUID guidKey, BYTE **ppPolicy,
    DWORD *pcbPolicy, BYTE *pContext, DWORD cbContext, DWORD dwReserved) {
  return This->lpVtbl->QueryCustomPolicy(This, guidKey, ppPolicy, pcbPolicy,
                                         pContext, cbContext, dwReserved);
}
#endif
#endif
...
#define SetUrlPolicyPermissions(dw, dw2)                                       \
...
DEFINE_GUID(IID_IInternetZoneManager, 0x79eac9ef, 0xbaf9, 0x11ce, 0x8c, 0x82,
            0x00, 0xaa, 0x00, 0x4b, 0xa9, 0x0b);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IInternetZoneManager : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE PromptAction(
      DWORD dwAction, HWND hwndParent, LPCWSTR pwszUrl, LPCWSTR pwszText,
      DWORD dwPromptFlags) = 0;
  virtual HRESULT STDMETHODCALLTYPE LogAction(
      DWORD dwAction, LPCWSTR pwszUrl, LPCWSTR pwszText, DWORD dwLogFlags) = 0;
  virtual HRESULT STDMETHODCALLTYPE CreateZoneEnumerator(
      DWORD * pdwEnum, DWORD * pdwCount, DWORD dwFlags) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetZoneAt(DWORD dwEnum, DWORD dwIndex,
                                              DWORD * pdwZone) = 0;
  virtual HRESULT STDMETHODCALLTYPE DestroyZoneEnumerator(DWORD dwEnum) = 0;
  virtual HRESULT STDMETHODCALLTYPE CopyTemplatePoliciesToZone(
      DWORD dwTemplate, DWORD dwZone, DWORD dwReserved) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IInternetZoneManager, 0x79eac9ef, 0xbaf9, 0x11ce, 0x8c, 0x82,
                0x00, 0xaa, 0x00, 0x4b, 0xa9, 0x0b)
#endif
#else
typedef struct IInternetZoneManagerVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IInternetZoneManager *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetZoneAttributes)(
      IInternetZoneManager *This, DWORD dwZone,
      ZONEATTRIBUTES *pZoneAttributes);
  HRESULT(STDMETHODCALLTYPE *SetZoneAttributes)(
      IInternetZoneManager *This, DWORD dwZone,
      ZONEATTRIBUTES *pZoneAttributes);
  HRESULT(STDMETHODCALLTYPE *GetZoneCustomPolicy)(IInternetZoneManager *This,
                                                  DWORD dwZone, REFGUID guidKey,
                                                  BYTE **ppPolicy,
                                                  DWORD *pcbPolicy,
                                                  URLZONEREG urlZoneReg);
  HRESULT(STDMETHODCALLTYPE *SetZoneCustomPolicy)(IInternetZoneManager *This,
                                                  DWORD dwZone, REFGUID guidKey,
                                                  BYTE *pPolicy, DWORD cbPolicy,
                                                  URLZONEREG urlZoneReg);
  HRESULT(STDMETHODCALLTYPE *GetZoneActionPolicy)(IInternetZoneManager *This,
                                                  DWORD dwZone, DWORD dwAction,
                                                  BYTE *pPolicy, DWORD cbPolicy,
                                                  URLZONEREG urlZoneReg);
  HRESULT(STDMETHODCALLTYPE *SetZoneActionPolicy)(IInternetZoneManager *This,
                                                  DWORD dwZone, DWORD dwAction,
                                                  BYTE *pPolicy, DWORD cbPolicy,
                                                  URLZONEREG urlZoneReg);
  HRESULT(STDMETHODCALLTYPE *PromptAction)(IInternetZoneManager *This,
                                           DWORD dwAction, HWND hwndParent,
                                           LPCWSTR pwszUrl, LPCWSTR pwszText,
                                           DWORD dwPromptFlags);
  HRESULT(STDMETHODCALLTYPE *LogAction)(IInternetZoneManager *This,
                                        DWORD dwAction, LPCWSTR pwszUrl,
                                        LPCWSTR pwszText, DWORD dwLogFlags);
  HRESULT(STDMETHODCALLTYPE *CreateZoneEnumerator)(IInternetZoneManager *This,
                                                   DWORD *pdwEnum,
                                                   DWORD *pdwCount,
                                                   DWORD dwFlags);
  HRESULT(STDMETHODCALLTYPE *GetZoneAt)(IInternetZoneManager *This,
                                        DWORD dwEnum, DWORD dwIndex,
                                        DWORD *pdwZone);
  HRESULT(STDMETHODCALLTYPE *DestroyZoneEnumerator)(IInternetZoneManager *This,
                                                    DWORD dwEnum);
  HRESULT(STDMETHODCALLTYPE *CopyTemplatePoliciesToZone)(
      IInternetZoneManager *This, DWORD dwTemplate, DWORD dwZone,
      DWORD dwReserved);
  END_INTERFACE
} IInternetZoneManagerVtbl;
interface IInternetZoneManager { CONST_VTBL IInternetZoneManagerVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define IInternetZoneManager_GetZoneCustomPolicy(                              \
    This, dwZone, guidKey, ppPolicy, pcbPolicy, urlZoneReg)                    \
  (This)->lpVtbl->GetZoneCustomPolicy(This, dwZone, guidKey, ppPolicy,         \
                                      pcbPolicy, urlZoneReg)
#define IInternetZoneManager_SetZoneCustomPolicy(                              \
    This, dwZone, guidKey, pPolicy, cbPolicy, urlZoneReg)                      \
  (This)->lpVtbl->SetZoneCustomPolicy(This, dwZone, guidKey, pPolicy,          \
                                      cbPolicy, urlZoneReg)
#define IInternetZoneManager_GetZoneActionPolicy(                              \
    This, dwZone, dwAction, pPolicy, cbPolicy, urlZoneReg)                     \
  (This)->lpVtbl->GetZoneActionPolicy(This, dwZone, dwAction, pPolicy,         \
                                      cbPolicy, urlZoneReg)
#define IInternetZoneManager_SetZoneActionPolicy(                              \
    This, dwZone, dwAction, pPolicy, cbPolicy, urlZoneReg)                     \
  (This)->lpVtbl->SetZoneActionPolicy(This, dwZone, dwAction, pPolicy,         \
                                      cbPolicy, urlZoneReg)
#define IInternetZoneManager_PromptAction(This, dwAction, hwndParent, pwszUrl, \
                                          pwszText, dwPromptFlags)             \
  (This)->lpVtbl->PromptAction(This, dwAction, hwndParent, pwszUrl, pwszText,  \
                               dwPromptFlags)
#define IInternetZoneManager_LogAction(This, dwAction, pwszUrl, pwszText,      \
                                       dwLogFlags)                             \
  (This)->lpVtbl->LogAction(This, dwAction, pwszUrl, pwszText, dwLogFlags)
#define IInternetZoneManager_CreateZoneEnumerator(This, pdwEnum, pdwCount,     \
                                                  dwFlags)                     \
...
#define IInternetZoneManager_CopyTemplatePoliciesToZone(This, dwTemplate,      \
                                                        dwZone, dwReserved)    \
  (This)->lpVtbl->CopyTemplatePoliciesToZone(This, dwTemplate, dwZone,         \
                                             dwReserved)
#else
/*** IUnknown methods ***/
static inline HRESULT
IInternetZoneManager_QueryInterface(IInternetZoneManager *This, REFIID riid,
                                    void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IInternetZoneManager methods ***/
static inline HRESULT
IInternetZoneManager_GetZoneAttributes(IInternetZoneManager *This, DWORD dwZone,
                                       ZONEATTRIBUTES *pZoneAttributes) {
  return This->lpVtbl->GetZoneAttributes(This, dwZone, pZoneAttributes);
}
static inline HRESULT
IInternetZoneManager_SetZoneAttributes(IInternetZoneManager *This, DWORD dwZone,
                                       ZONEATTRIBUTES *pZoneAttributes) {
  return This->lpVtbl->SetZoneAttributes(This, dwZone, pZoneAttributes);
}
static inline HRESULT IInternetZoneManager_GetZoneCustomPolicy(
    IInternetZoneManager *This, DWORD dwZone, REFGUID guidKey, BYTE **ppPolicy,
    DWORD *pcbPolicy, URLZONEREG urlZoneReg) {
  return This->lpVtbl->GetZoneCustomPolicy(This, dwZone, guidKey, ppPolicy,
                                           pcbPolicy, urlZoneReg);
}
static inline HRESULT IInternetZoneManager_SetZoneCustomPolicy(
    IInternetZoneManager *This, DWORD dwZone, REFGUID guidKey, BYTE *pPolicy,
    DWORD cbPolicy, URLZONEREG urlZoneReg) {
  return This->lpVtbl->SetZoneCustomPolicy(This, dwZone, guidKey, pPolicy,
                                           cbPolicy, urlZoneReg);
}
static inline HRESULT IInternetZoneManager_GetZoneActionPolicy(
    IInternetZoneManager *This, DWORD dwZone, DWORD dwAction, BYTE *pPolicy,
    DWORD cbPolicy, URLZONEREG urlZoneReg) {
  return This->lpVtbl->GetZoneActionPolicy(This, dwZone, dwAction, pPolicy,
                                           cbPolicy, urlZoneReg);
}
static inline HRESULT IInternetZoneManager_SetZoneActionPolicy(
    IInternetZoneManager *This, DWORD dwZone, DWORD dwAction, BYTE *pPolicy,
    DWORD cbPolicy, URLZONEREG urlZoneReg) {
  return This->lpVtbl->SetZoneActionPolicy(This, dwZone, dwAction, pPolicy,
                                           cbPolicy, urlZoneReg);
}
static inline HRESULT
IInternetZoneManager_PromptAction(IInternetZoneManager *This, DWORD dwAction,
                                  HWND hwndParent, LPCWSTR pwszUrl,
                                  LPCWSTR pwszText, DWORD dwPromptFlags) {
  return This->lpVtbl->PromptAction(This, dwAction, hwndParent, pwszUrl,
                                    pwszText, dwPromptFlags);
}
static inline HRESULT IInternetZoneManager_LogAction(IInternetZoneManager *This,
                                                     DWORD dwAction,
                                                     LPCWSTR pwszUrl,
                                                     LPCWSTR pwszText,
                                                     DWORD dwLogFlags) {
...
static inline HRESULT
IInternetZoneManager_CreateZoneEnumerator(IInternetZoneManager *This,
                                          DWORD *pdwEnum, DWORD *pdwCount,
                                          DWORD dwFlags) {
  return This->lpVtbl->CreateZoneEnumerator(This, pdwEnum, pdwCount, dwFlags);
}
static inline HRESULT IInternetZoneManager_GetZoneAt(IInternetZoneManager *This,
                                                     DWORD dwEnum,
                                                     DWORD dwIndex,
                                                     DWORD *pdwZone) {
...
static inline HRESULT
IInternetZoneManager_DestroyZoneEnumerator(IInternetZoneManager *This,
                                           DWORD dwEnum) {
  return This->lpVtbl->DestroyZoneEnumerator(This, dwEnum);
}
static inline HRESULT
IInternetZoneManager_CopyTemplatePoliciesToZone(IInternetZoneManager *This,
                                                DWORD dwTemplate, DWORD dwZone,
                                                DWORD dwReserved) {
  return This->lpVtbl->CopyTemplatePoliciesToZone(This, dwTemplate, dwZone,
                                                  dwReserved);
}
#endif
#endif
...
DEFINE_GUID(IID_IInternetZoneManagerEx, 0xa4c23339, 0x8e06, 0x431e, 0x9b, 0xf4,
            0x7e, 0x71, 0x1c, 0x08, 0x56, 0x48);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IInternetZoneManagerEx : public IInternetZoneManager {
  virtual HRESULT STDMETHODCALLTYPE GetZoneActionPolicyEx(
      DWORD dwZone, DWORD dwAction, BYTE * pPolicy, DWORD cbPolicy,
      URLZONEREG urlZoneReg, DWORD dwFlags) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetZoneActionPolicyEx(
      DWORD dwZone, DWORD dwAction, BYTE * pPolicy, DWORD cbPolicy,
      URLZONEREG urlZoneReg, DWORD dwFlags) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IInternetZoneManagerEx, 0xa4c23339, 0x8e06, 0x431e, 0x9b, 0xf4,
                0x7e, 0x71, 0x1c, 0x08, 0x56, 0x48)
#endif
#else
typedef struct IInternetZoneManagerExVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IInternetZoneManagerEx *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IInternetZoneManagerEx *This);
  ULONG(STDMETHODCALLTYPE *Release)(IInternetZoneManagerEx *This);
  /*** IInternetZoneManager methods ***/
  HRESULT(STDMETHODCALLTYPE *GetZoneAttributes)(
      IInternetZoneManagerEx *This, DWORD dwZone,
      ZONEATTRIBUTES *pZoneAttributes);
  HRESULT(STDMETHODCALLTYPE *SetZoneAttributes)(
      IInternetZoneManagerEx *This, DWORD dwZone,
      ZONEATTRIBUTES *pZoneAttributes);
  HRESULT(STDMETHODCALLTYPE *GetZoneCustomPolicy)(IInternetZoneManagerEx *This,
                                                  DWORD dwZone, REFGUID guidKey,
                                                  BYTE **ppPolicy,
                                                  DWORD *pcbPolicy,
                                                  URLZONEREG urlZoneReg);
  HRESULT(STDMETHODCALLTYPE *SetZoneCustomPolicy)(IInternetZoneManagerEx *This,
                                                  DWORD dwZone, REFGUID guidKey,
                                                  BYTE *pPolicy, DWORD cbPolicy,
                                                  URLZONEREG urlZoneReg);
  HRESULT(STDMETHODCALLTYPE *GetZoneActionPolicy)(IInternetZoneManagerEx *This,
                                                  DWORD dwZone, DWORD dwAction,
                                                  BYTE *pPolicy, DWORD cbPolicy,
                                                  URLZONEREG urlZoneReg);
  HRESULT(STDMETHODCALLTYPE *SetZoneActionPolicy)(IInternetZoneManagerEx *This,
                                                  DWORD dwZone, DWORD dwAction,
                                                  BYTE *pPolicy, DWORD cbPolicy,
                                                  URLZONEREG urlZoneReg);
  HRESULT(STDMETHODCALLTYPE *PromptAction)(IInternetZoneManagerEx *This,
                                           DWORD dwAction, HWND hwndParent,
                                           LPCWSTR pwszUrl, LPCWSTR pwszText,
                                           DWORD dwPromptFlags);
  HRESULT(STDMETHODCALLTYPE *LogAction)(IInternetZoneManagerEx *This,
                                        DWORD dwAction, LPCWSTR pwszUrl,
                                        LPCWSTR pwszText, DWORD dwLogFlags);
  HRESULT(STDMETHODCALLTYPE *CreateZoneEnumerator)(IInternetZoneManagerEx *This,
                                                   DWORD *pdwEnum,
                                                   DWORD *pdwCount,
                                                   DWORD dwFlags);
  HRESULT(STDMETHODCALLTYPE *GetZoneAt)(IInternetZoneManagerEx *This,
                                        DWORD dwEnum, DWORD dwIndex,
                                        DWORD *pdwZone);
  HRESULT(STDMETHODCALLTYPE *DestroyZoneEnumerator)(
      IInternetZoneManagerEx *This, DWORD dwEnum);
  HRESULT(STDMETHODCALLTYPE *CopyTemplatePoliciesToZone)(
      IInternetZoneManagerEx *This, DWORD dwTemplate, DWORD dwZone,
      DWORD dwReserved);
  /*** IInternetZoneManagerEx methods ***/
  HRESULT(STDMETHODCALLTYPE *GetZoneActionPolicyEx)(
      IInternetZoneManagerEx *This, DWORD dwZone, DWORD dwAction, BYTE *pPolicy,
      DWORD cbPolicy, URLZONEREG urlZoneReg, DWORD dwFlags);
...
/*** IInternetZoneManager methods ***/
#define IInternetZoneManagerEx_GetZoneAttributes(This, dwZone,                 \
                                                 pZoneAttributes)              \
  (This)->lpVtbl->GetZoneAttributes(This, dwZone, pZoneAttributes)
#define IInternetZoneManagerEx_SetZoneAttributes(This, dwZone,                 \
                                                 pZoneAttributes)              \
  (This)->lpVtbl->SetZoneAttributes(This, dwZone, pZoneAttributes)
#define IInternetZoneManagerEx_GetZoneCustomPolicy(                            \
    This, dwZone, guidKey, ppPolicy, pcbPolicy, urlZoneReg)                    \
  (This)->lpVtbl->GetZoneCustomPolicy(This, dwZone, guidKey, ppPolicy,         \
                                      pcbPolicy, urlZoneReg)
#define IInternetZoneManagerEx_SetZoneCustomPolicy(                            \
    This, dwZone, guidKey, pPolicy, cbPolicy, urlZoneReg)                      \
  (This)->lpVtbl->SetZoneCustomPolicy(This, dwZone, guidKey, pPolicy,          \
                                      cbPolicy, urlZoneReg)
#define IInternetZoneManagerEx_GetZoneActionPolicy(                            \
    This, dwZone, dwAction, pPolicy, cbPolicy, urlZoneReg)                     \
  (This)->lpVtbl->GetZoneActionPolicy(This, dwZone, dwAction, pPolicy,         \
                                      cbPolicy, urlZoneReg)
#define IInternetZoneManagerEx_SetZoneActionPolicy(                            \
    This, dwZone, dwAction, pPolicy, cbPolicy, urlZoneReg)                     \
  (This)->lpVtbl->SetZoneActionPolicy(This, dwZone, dwAction, pPolicy,         \
                                      cbPolicy, urlZoneReg)
#define IInternetZoneManagerEx_PromptAction(This, dwAction, hwndParent,        \
                                            pwszUrl, pwszText, dwPromptFlags)  \
  (This)->lpVtbl->PromptAction(This, dwAction, hwndParent, pwszUrl, pwszText,  \
                               dwPromptFlags)
#define IInternetZoneManagerEx_LogAction(This, dwAction, pwszUrl, pwszText,    \
                                         dwLogFlags)                           \
  (This)->lpVtbl->LogAction(This, dwAction, pwszUrl, pwszText, dwLogFlags)
#define IInternetZoneManagerEx_CreateZoneEnumerator(This, pdwEnum, pdwCount,   \
                                                    dwFlags)                   \
  (This)->lpVtbl->CreateZoneEnumerator(This, pdwEnum, pdwCount, dwFlags)
...
#define IInternetZoneManagerEx_DestroyZoneEnumerator(This, dwEnum)             \
  (This)->lpVtbl->DestroyZoneEnumerator(This, dwEnum)
#define IInternetZoneManagerEx_CopyTemplatePoliciesToZone(This, dwTemplate,    \
                                                          dwZone, dwReserved)  \
  (This)->lpVtbl->CopyTemplatePoliciesToZone(This, dwTemplate, dwZone,         \
                                             dwReserved)
/*** IInternetZoneManagerEx methods ***/
#define IInternetZoneManagerEx_GetZoneActionPolicyEx(                          \
    This, dwZone, dwAction, pPolicy, cbPolicy, urlZoneReg, dwFlags)            \
  (This)->lpVtbl->GetZoneActionPolicyEx(This, dwZone, dwAction, pPolicy,       \
                                        cbPolicy, urlZoneReg, dwFlags)
#define IInternetZoneManagerEx_SetZoneActionPolicyEx(                          \
    This, dwZone, dwAction, pPolicy, cbPolicy, urlZoneReg, dwFlags)            \
  (This)->lpVtbl->SetZoneActionPolicyEx(This, dwZone, dwAction, pPolicy,       \
                                        cbPolicy, urlZoneReg, dwFlags)
#else
/*** IUnknown methods ***/
static inline HRESULT
IInternetZoneManagerEx_QueryInterface(IInternetZoneManagerEx *This, REFIID riid,
                                      void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IInternetZoneManagerEx_AddRef(IInternetZoneManagerEx *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IInternetZoneManagerEx_Release(IInternetZoneManagerEx *This) {
  return This->lpVtbl->Release(This);
}
/*** IInternetZoneManager methods ***/
static inline HRESULT
IInternetZoneManagerEx_GetZoneAttributes(IInternetZoneManagerEx *This,
                                         DWORD dwZone,
                                         ZONEATTRIBUTES *pZoneAttributes) {
  return This->lpVtbl->GetZoneAttributes(This, dwZone, pZoneAttributes);
}
static inline HRESULT
IInternetZoneManagerEx_SetZoneAttributes(IInternetZoneManagerEx *This,
                                         DWORD dwZone,
                                         ZONEATTRIBUTES *pZoneAttributes) {
  return This->lpVtbl->SetZoneAttributes(This, dwZone, pZoneAttributes);
}
static inline HRESULT IInternetZoneManagerEx_GetZoneCustomPolicy(
    IInternetZoneManagerEx *This, DWORD dwZone, REFGUID guidKey,
    BYTE **ppPolicy, DWORD *pcbPolicy, URLZONEREG urlZoneReg) {
  return This->lpVtbl->GetZoneCustomPolicy(This, dwZone, guidKey, ppPolicy,
                                           pcbPolicy, urlZoneReg);
}
static inline HRESULT IInternetZoneManagerEx_SetZoneCustomPolicy(
    IInternetZoneManagerEx *This, DWORD dwZone, REFGUID guidKey, BYTE *pPolicy,
    DWORD cbPolicy, URLZONEREG urlZoneReg) {
  return This->lpVtbl->SetZoneCustomPolicy(This, dwZone, guidKey, pPolicy,
                                           cbPolicy, urlZoneReg);
}
static inline HRESULT IInternetZoneManagerEx_GetZoneActionPolicy(
    IInternetZoneManagerEx *This, DWORD dwZone, DWORD dwAction, BYTE *pPolicy,
    DWORD cbPolicy, URLZONEREG urlZoneReg) {
  return This->lpVtbl->GetZoneActionPolicy(This, dwZone, dwAction, pPolicy,
                                           cbPolicy, urlZoneReg);
}
static inline HRESULT IInternetZoneManagerEx_SetZoneActionPolicy(
    IInternetZoneManagerEx *This, DWORD dwZone, DWORD dwAction, BYTE *pPolicy,
    DWORD cbPolicy, URLZONEREG urlZoneReg) {
  return This->lpVtbl->SetZoneActionPolicy(This, dwZone, dwAction, pPolicy,
                                           cbPolicy, urlZoneReg);
}
static inline HRESULT IInternetZoneManagerEx_PromptAction(
    IInternetZoneManagerEx *This, DWORD dwAction, HWND hwndParent,
    LPCWSTR pwszUrl, LPCWSTR pwszText, DWORD dwPromptFlags) {
  return This->lpVtbl->PromptAction(This, dwAction, hwndParent, pwszUrl,
                                    pwszText, dwPromptFlags);
}
static inline HRESULT
IInternetZoneManagerEx_LogAction(IInternetZoneManagerEx *This, DWORD dwAction,
                                 LPCWSTR pwszUrl, LPCWSTR pwszText,
                                 DWORD dwLogFlags) {
  return This->lpVtbl->LogAction(This, dwAction, pwszUrl, pwszText, dwLogFlags);
}
static inline HRESULT
IInternetZoneManagerEx_CreateZoneEnumerator(IInternetZoneManagerEx *This,
                                            DWORD *pdwEnum, DWORD *pdwCount,
                                            DWORD dwFlags) {
  return This->lpVtbl->CreateZoneEnumerator(This, pdwEnum, pdwCount, dwFlags);
}
static inline HRESULT
IInternetZoneManagerEx_GetZoneAt(IInternetZoneManagerEx *This, DWORD dwEnum,
                                 DWORD dwIndex, DWORD *pdwZone) {
  return This->lpVtbl->GetZoneAt(This, dwEnum, dwIndex, pdwZone);
}
static inline HRESULT
IInternetZoneManagerEx_DestroyZoneEnumerator(IInternetZoneManagerEx *This,
                                             DWORD dwEnum) {
  return This->lpVtbl->DestroyZoneEnumerator(This, dwEnum);
}
static inline HRESULT IInternetZoneManagerEx_CopyTemplatePoliciesToZone(
    IInternetZoneManagerEx *This, DWORD dwTemplate, DWORD dwZone,
    DWORD dwReserved) {
  return This->lpVtbl->CopyTemplatePoliciesToZone(This, dwTemplate, dwZone,
                                                  dwReserved);
...
/*** IInternetZoneManagerEx methods ***/
static inline HRESULT IInternetZoneManagerEx_GetZoneActionPolicyEx(
    IInternetZoneManagerEx *This, DWORD dwZone, DWORD dwAction, BYTE *pPolicy,
    DWORD cbPolicy, URLZONEREG urlZoneReg, DWORD dwFlags) {
  return This->lpVtbl->GetZoneActionPolicyEx(This, dwZone, dwAction, pPolicy,
                                             cbPolicy, urlZoneReg, dwFlags);
}
static inline HRESULT IInternetZoneManagerEx_SetZoneActionPolicyEx(
    IInternetZoneManagerEx *This, DWORD dwZone, DWORD dwAction, BYTE *pPolicy,
    DWORD cbPolicy, URLZONEREG urlZoneReg, DWORD dwFlags) {
  return This->lpVtbl->SetZoneActionPolicyEx(This, dwZone, dwAction, pPolicy,
                                             cbPolicy, urlZoneReg, dwFlags);
}
#endif
#endif
...
DEFINE_GUID(IID_IInternetZoneManagerEx2, 0xedc17559, 0xdd5d, 0x4846, 0x8e, 0xef,
            0x8b, 0xec, 0xba, 0x5a, 0x4a, 0xbf);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IInternetZoneManagerEx2 : public IInternetZoneManagerEx {
  virtual HRESULT STDMETHODCALLTYPE GetZoneAttributesEx(
      DWORD dwZone, ZONEATTRIBUTES * pZoneAttributes, DWORD dwFlags) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetIESecurityState(
      WINBOOL fRespectPolicy, LPDWORD pdwState, WINBOOL * pfPolicyEncountered,
      WINBOOL fNoCache) = 0;
  virtual HRESULT STDMETHODCALLTYPE FixUnsecureSettings() = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IInternetZoneManagerEx2, 0xedc17559, 0xdd5d, 0x4846, 0x8e, 0xef,
                0x8b, 0xec, 0xba, 0x5a, 0x4a, 0xbf)
#endif
#else
typedef struct IInternetZoneManagerEx2Vtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IInternetZoneManagerEx2 *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IInternetZoneManagerEx2 *This);
  ULONG(STDMETHODCALLTYPE *Release)(IInternetZoneManagerEx2 *This);
  /*** IInternetZoneManager methods ***/
  HRESULT(STDMETHODCALLTYPE *GetZoneAttributes)(
      IInternetZoneManagerEx2 *This, DWORD dwZone,
      ZONEATTRIBUTES *pZoneAttributes);
  HRESULT(STDMETHODCALLTYPE *SetZoneAttributes)(
      IInternetZoneManagerEx2 *This, DWORD dwZone,
      ZONEATTRIBUTES *pZoneAttributes);
  HRESULT(STDMETHODCALLTYPE *GetZoneCustomPolicy)(IInternetZoneManagerEx2 *This,
                                                  DWORD dwZone, REFGUID guidKey,
                                                  BYTE **ppPolicy,
                                                  DWORD *pcbPolicy,
                                                  URLZONEREG urlZoneReg);
  HRESULT(STDMETHODCALLTYPE *SetZoneCustomPolicy)(IInternetZoneManagerEx2 *This,
                                                  DWORD dwZone, REFGUID guidKey,
                                                  BYTE *pPolicy, DWORD cbPolicy,
                                                  URLZONEREG urlZoneReg);
  HRESULT(STDMETHODCALLTYPE *GetZoneActionPolicy)(IInternetZoneManagerEx2 *This,
                                                  DWORD dwZone, DWORD dwAction,
                                                  BYTE *pPolicy, DWORD cbPolicy,
                                                  URLZONEREG urlZoneReg);
  HRESULT(STDMETHODCALLTYPE *SetZoneActionPolicy)(IInternetZoneManagerEx2 *This,
                                                  DWORD dwZone, DWORD dwAction,
                                                  BYTE *pPolicy, DWORD cbPolicy,
                                                  URLZONEREG urlZoneReg);
  HRESULT(STDMETHODCALLTYPE *PromptAction)(IInternetZoneManagerEx2 *This,
                                           DWORD dwAction, HWND hwndParent,
                                           LPCWSTR pwszUrl, LPCWSTR pwszText,
                                           DWORD dwPromptFlags);
  HRESULT(STDMETHODCALLTYPE *LogAction)(IInternetZoneManagerEx2 *This,
                                        DWORD dwAction, LPCWSTR pwszUrl,
                                        LPCWSTR pwszText, DWORD dwLogFlags);
  HRESULT(STDMETHODCALLTYPE *CreateZoneEnumerator)(
      IInternetZoneManagerEx2 *This, DWORD *pdwEnum, DWORD *pdwCount,
      DWORD dwFlags);
  HRESULT(STDMETHODCALLTYPE *GetZoneAt)(IInternetZoneManagerEx2 *This,
                                        DWORD dwEnum, DWORD dwIndex,
                                        DWORD *pdwZone);
  HRESULT(STDMETHODCALLTYPE *DestroyZoneEnumerator)(
      IInternetZoneManagerEx2 *This, DWORD dwEnum);
  HRESULT(STDMETHODCALLTYPE *CopyTemplatePoliciesToZone)(
      IInternetZoneManagerEx2 *This, DWORD dwTemplate, DWORD dwZone,
      DWORD dwReserved);
  /*** IInternetZoneManagerEx methods ***/
  HRESULT(STDMETHODCALLTYPE *GetZoneActionPolicyEx)(
      IInternetZoneManagerEx2 *This, DWORD dwZone, DWORD dwAction,
      BYTE *pPolicy, DWORD cbPolicy, URLZONEREG urlZoneReg, DWORD dwFlags);
  HRESULT(STDMETHODCALLTYPE *SetZoneActionPolicyEx)(
      IInternetZoneManagerEx2 *This, DWORD dwZone, DWORD dwAction,
      BYTE *pPolicy, DWORD cbPolicy, URLZONEREG urlZoneReg, DWORD dwFlags);
  ...
  HRESULT(STDMETHODCALLTYPE *GetZoneAttributesEx)(
      IInternetZoneManagerEx2 *This, DWORD dwZone,
      ZONEATTRIBUTES *pZoneAttributes, DWORD dwFlags);
  HRESULT(STDMETHODCALLTYPE *GetZoneSecurityState)(
      IInternetZoneManagerEx2 *This, DWORD dwZoneIndex, WINBOOL fRespectPolicy,
      LPDWORD pdwState, WINBOOL *pfPolicyEncountered);
  HRESULT(STDMETHODCALLTYPE *GetIESecurityState)(IInternetZoneManagerEx2 *This,
...
/*** IInternetZoneManager methods ***/
#define IInternetZoneManagerEx2_GetZoneAttributes(This, dwZone,                \
                                                  pZoneAttributes)             \
  (This)->lpVtbl->GetZoneAttributes(This, dwZone, pZoneAttributes)
#define IInternetZoneManagerEx2_SetZoneAttributes(This, dwZone,                \
                                                  pZoneAttributes)             \
  (This)->lpVtbl->SetZoneAttributes(This, dwZone, pZoneAttributes)
#define IInternetZoneManagerEx2_GetZoneCustomPolicy(                           \
    This, dwZone, guidKey, ppPolicy, pcbPolicy, urlZoneReg)                    \
  (This)->lpVtbl->GetZoneCustomPolicy(This, dwZone, guidKey, ppPolicy,         \
                                      pcbPolicy, urlZoneReg)
#define IInternetZoneManagerEx2_SetZoneCustomPolicy(                           \
    This, dwZone, guidKey, pPolicy, cbPolicy, urlZoneReg)                      \
  (This)->lpVtbl->SetZoneCustomPolicy(This, dwZone, guidKey, pPolicy,          \
                                      cbPolicy, urlZoneReg)
#define IInternetZoneManagerEx2_GetZoneActionPolicy(                           \
    This, dwZone, dwAction, pPolicy, cbPolicy, urlZoneReg)                     \
  (This)->lpVtbl->GetZoneActionPolicy(This, dwZone, dwAction, pPolicy,         \
                                      cbPolicy, urlZoneReg)
#define IInternetZoneManagerEx2_SetZoneActionPolicy(                           \
    This, dwZone, dwAction, pPolicy, cbPolicy, urlZoneReg)                     \
  (This)->lpVtbl->SetZoneActionPolicy(This, dwZone, dwAction, pPolicy,         \
                                      cbPolicy, urlZoneReg)
#define IInternetZoneManagerEx2_PromptAction(This, dwAction, hwndParent,       \
                                             pwszUrl, pwszText, dwPromptFlags) \
  (This)->lpVtbl->PromptAction(This, dwAction, hwndParent, pwszUrl, pwszText,  \
                               dwPromptFlags)
#define IInternetZoneManagerEx2_LogAction(This, dwAction, pwszUrl, pwszText,   \
                                          dwLogFlags)                          \
  (This)->lpVtbl->LogAction(This, dwAction, pwszUrl, pwszText, dwLogFlags)
#define IInternetZoneManagerEx2_CreateZoneEnumerator(This, pdwEnum, pdwCount,  \
                                                     dwFlags)                  \
  (This)->lpVtbl->CreateZoneEnumerator(This, pdwEnum, pdwCount, dwFlags)
...
#define IInternetZoneManagerEx2_DestroyZoneEnumerator(This, dwEnum)            \
  (This)->lpVtbl->DestroyZoneEnumerator(This, dwEnum)
#define IInternetZoneManagerEx2_CopyTemplatePoliciesToZone(This, dwTemplate,   \
                                                           dwZone, dwReserved) \
  (This)->lpVtbl->CopyTemplatePoliciesToZone(This, dwTemplate, dwZone,         \
                                             dwReserved)
/*** IInternetZoneManagerEx methods ***/
#define IInternetZoneManagerEx2_GetZoneActionPolicyEx(                         \
    This, dwZone, dwAction, pPolicy, cbPolicy, urlZoneReg, dwFlags)            \
  (This)->lpVtbl->GetZoneActionPolicyEx(This, dwZone, dwAction, pPolicy,       \
                                        cbPolicy, urlZoneReg, dwFlags)
#define IInternetZoneManagerEx2_SetZoneActionPolicyEx(                         \
    This, dwZone, dwAction, pPolicy, cbPolicy, urlZoneReg, dwFlags)            \
  (This)->lpVtbl->SetZoneActionPolicyEx(This, dwZone, dwAction, pPolicy,       \
                                        cbPolicy, urlZoneReg, dwFlags)
/*** IInternetZoneManagerEx2 methods ***/
#define IInternetZoneManagerEx2_GetZoneAttributesEx(This, dwZone,              \
                                                    pZoneAttributes, dwFlags)  \
  (This)->lpVtbl->GetZoneAttributesEx(This, dwZone, pZoneAttributes, dwFlags)
#define IInternetZoneManagerEx2_GetZoneSecurityState(                          \
    This, dwZoneIndex, fRespectPolicy, pdwState, pfPolicyEncountered)          \
  (This)->lpVtbl->GetZoneSecurityState(This, dwZoneIndex, fRespectPolicy,      \
                                       pdwState, pfPolicyEncountered)
#define IInternetZoneManagerEx2_GetIESecurityState(                            \
    This, fRespectPolicy, pdwState, pfPolicyEncountered, fNoCache)             \
  (This)->lpVtbl->GetIESecurityState(This, fRespectPolicy, pdwState,           \
...
/*** IUnknown methods ***/
static inline HRESULT
IInternetZoneManagerEx2_QueryInterface(IInternetZoneManagerEx2 *This,
                                       REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IInternetZoneManagerEx2_AddRef(IInternetZoneManagerEx2 *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IInternetZoneManagerEx2_Release(IInternetZoneManagerEx2 *This) {
  return This->lpVtbl->Release(This);
}
/*** IInternetZoneManager methods ***/
static inline HRESULT
IInternetZoneManagerEx2_GetZoneAttributes(IInternetZoneManagerEx2 *This,
                                          DWORD dwZone,
                                          ZONEATTRIBUTES *pZoneAttributes) {
  return This->lpVtbl->GetZoneAttributes(This, dwZone, pZoneAttributes);
}
static inline HRESULT
IInternetZoneManagerEx2_SetZoneAttributes(IInternetZoneManagerEx2 *This,
                                          DWORD dwZone,
                                          ZONEATTRIBUTES *pZoneAttributes) {
  return This->lpVtbl->SetZoneAttributes(This, dwZone, pZoneAttributes);
}
static inline HRESULT IInternetZoneManagerEx2_GetZoneCustomPolicy(
    IInternetZoneManagerEx2 *This, DWORD dwZone, REFGUID guidKey,
    BYTE **ppPolicy, DWORD *pcbPolicy, URLZONEREG urlZoneReg) {
  return This->lpVtbl->GetZoneCustomPolicy(This, dwZone, guidKey, ppPolicy,
                                           pcbPolicy, urlZoneReg);
}
static inline HRESULT IInternetZoneManagerEx2_SetZoneCustomPolicy(
    IInternetZoneManagerEx2 *This, DWORD dwZone, REFGUID guidKey, BYTE *pPolicy,
    DWORD cbPolicy, URLZONEREG urlZoneReg) {
  return This->lpVtbl->SetZoneCustomPolicy(This, dwZone, guidKey, pPolicy,
                                           cbPolicy, urlZoneReg);
}
static inline HRESULT IInternetZoneManagerEx2_GetZoneActionPolicy(
    IInternetZoneManagerEx2 *This, DWORD dwZone, DWORD dwAction, BYTE *pPolicy,
    DWORD cbPolicy, URLZONEREG urlZoneReg) {
  return This->lpVtbl->GetZoneActionPolicy(This, dwZone, dwAction, pPolicy,
                                           cbPolicy, urlZoneReg);
}
static inline HRESULT IInternetZoneManagerEx2_SetZoneActionPolicy(
    IInternetZoneManagerEx2 *This, DWORD dwZone, DWORD dwAction, BYTE *pPolicy,
    DWORD cbPolicy, URLZONEREG urlZoneReg) {
  return This->lpVtbl->SetZoneActionPolicy(This, dwZone, dwAction, pPolicy,
                                           cbPolicy, urlZoneReg);
}
static inline HRESULT IInternetZoneManagerEx2_PromptAction(
    IInternetZoneManagerEx2 *This, DWORD dwAction, HWND hwndParent,
    LPCWSTR pwszUrl, LPCWSTR pwszText, DWORD dwPromptFlags) {
  return This->lpVtbl->PromptAction(This, dwAction, hwndParent, pwszUrl,
                                    pwszText, dwPromptFlags);
}
static inline HRESULT
IInternetZoneManagerEx2_LogAction(IInternetZoneManagerEx2 *This, DWORD dwAction,
                                  LPCWSTR pwszUrl, LPCWSTR pwszText,
                                  DWORD dwLogFlags) {
  return This->lpVtbl->LogAction(This, dwAction, pwszUrl, pwszText, dwLogFlags);
}
static inline HRESULT
IInternetZoneManagerEx2_CreateZoneEnumerator(IInternetZoneManagerEx2 *This,
                                             DWORD *pdwEnum, DWORD *pdwCount,
                                             DWORD dwFlags) {
  return This->lpVtbl->CreateZoneEnumerator(This, pdwEnum, pdwCount, dwFlags);
}
static inline HRESULT
IInternetZoneManagerEx2_GetZoneAt(IInternetZoneManagerEx2 *This, DWORD dwEnum,
                                  DWORD dwIndex, DWORD *pdwZone) {
  return This->lpVtbl->GetZoneAt(This, dwEnum, dwIndex, pdwZone);
}
static inline HRESULT
IInternetZoneManagerEx2_DestroyZoneEnumerator(IInternetZoneManagerEx2 *This,
                                              DWORD dwEnum) {
  return This->lpVtbl->DestroyZoneEnumerator(This, dwEnum);
}
static inline HRESULT IInternetZoneManagerEx2_CopyTemplatePoliciesToZone(
    IInternetZoneManagerEx2 *This, DWORD dwTemplate, DWORD dwZone,
    DWORD dwReserved) {
  return This->lpVtbl->CopyTemplatePoliciesToZone(This, dwTemplate, dwZone,
                                                  dwReserved);
...
/*** IInternetZoneManagerEx methods ***/
static inline HRESULT IInternetZoneManagerEx2_GetZoneActionPolicyEx(
    IInternetZoneManagerEx2 *This, DWORD dwZone, DWORD dwAction, BYTE *pPolicy,
    DWORD cbPolicy, URLZONEREG urlZoneReg, DWORD dwFlags) {
  return This->lpVtbl->GetZoneActionPolicyEx(This, dwZone, dwAction, pPolicy,
                                             cbPolicy, urlZoneReg, dwFlags);
}
static inline HRESULT IInternetZoneManagerEx2_SetZoneActionPolicyEx(
    IInternetZoneManagerEx2 *This, DWORD dwZone, DWORD dwAction, BYTE *pPolicy,
    DWORD cbPolicy, URLZONEREG urlZoneReg, DWORD dwFlags) {
  return This->lpVtbl->SetZoneActionPolicyEx(This, dwZone, dwAction, pPolicy,
                                             cbPolicy, urlZoneReg, dwFlags);
...
/*** IInternetZoneManagerEx2 methods ***/
static inline HRESULT IInternetZoneManagerEx2_GetZoneAttributesEx(
    IInternetZoneManagerEx2 *This, DWORD dwZone,
    ZONEATTRIBUTES *pZoneAttributes, DWORD dwFlags) {
  return This->lpVtbl->GetZoneAttributesEx(This, dwZone, pZoneAttributes,
                                           dwFlags);
}
static inline HRESULT IInternetZoneManagerEx2_GetZoneSecurityState(
    IInternetZoneManagerEx2 *This, DWORD dwZoneIndex, WINBOOL fRespectPolicy,
    LPDWORD pdwState, WINBOOL *pfPolicyEncountered) {
  return This->lpVtbl->GetZoneSecurityState(This, dwZoneIndex, fRespectPolicy,
                                            pdwState, pfPolicyEncountered);
}
static inline HRESULT IInternetZoneManagerEx2_GetIESecurityState(
    IInternetZoneManagerEx2 *This, WINBOOL fRespectPolicy, LPDWORD pdwState,
    WINBOOL *pfPolicyEncountered, WINBOOL fNoCache) {
  return This->lpVtbl->GetIESecurityState(This, fRespectPolicy, pdwState,
                                          pfPolicyEncountered, fNoCache);
}
static inline HRESULT
IInternetZoneManagerEx2_FixUnsecureSettings(IInternetZoneManagerEx2 *This) {
...
DEFINE_GUID(IID_ISoftDistExt, 0xb15b8dc1, 0xc7e1, 0x11d0, 0x86, 0x80, 0x00,
            0xaa, 0x00, 0xbd, 0xcb, 0x71);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
ISoftDistExt : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE ProcessSoftDist(
      LPCWSTR szCDFURL, IXMLElement * pSoftDistElement,
      LPSOFTDISTINFO lpsdi) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetFirstCodeBase(LPWSTR * szCodeBase,
                                                     LPDWORD dwMaxSize) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetNextCodeBase(LPWSTR * szCodeBase,
                                                    LPDWORD dwMaxSize) = 0;
  virtual HRESULT STDMETHODCALLTYPE AsyncInstallDistributionUnit(
      IBindCtx * pbc, LPVOID pvReserved, DWORD flags, LPCODEBASEHOLD lpcbh) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ISoftDistExt, 0xb15b8dc1, 0xc7e1, 0x11d0, 0x86, 0x80, 0x00,
                0xaa, 0x00, 0xbd, 0xcb, 0x71)
#endif
#else
typedef struct ISoftDistExtVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ISoftDistExt *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(ISoftDistExt *This);
  ULONG(STDMETHODCALLTYPE *Release)(ISoftDistExt *This);
  /*** ISoftDistExt methods ***/
  HRESULT(STDMETHODCALLTYPE *ProcessSoftDist)(ISoftDistExt *This,
                                              LPCWSTR szCDFURL,
                                              IXMLElement *pSoftDistElement,
                                              LPSOFTDISTINFO lpsdi);
  HRESULT(STDMETHODCALLTYPE *GetFirstCodeBase)(ISoftDistExt *This,
                                               LPWSTR *szCodeBase,
                                               LPDWORD dwMaxSize);
  HRESULT(STDMETHODCALLTYPE *GetNextCodeBase)(ISoftDistExt *This,
                                              LPWSTR *szCodeBase,
                                              LPDWORD dwMaxSize);
  HRESULT(STDMETHODCALLTYPE *AsyncInstallDistributionUnit)(
      ISoftDistExt *This, IBindCtx *pbc, LPVOID pvReserved, DWORD flags,
      LPCODEBASEHOLD lpcbh);
  END_INTERFACE
} ISoftDistExtVtbl;
interface ISoftDistExt { CONST_VTBL ISoftDistExtVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define ISoftDistExt_AsyncInstallDistributionUnit(This, pbc, pvReserved,       \
                                                  flags, lpcbh)                \
  (This)->lpVtbl->AsyncInstallDistributionUnit(This, pbc, pvReserved, flags,   \
                                               lpcbh)
#else
/*** IUnknown methods ***/
static inline HRESULT
ISoftDistExt_QueryInterface(ISoftDistExt *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ISoftDistExt methods ***/
static inline HRESULT
ISoftDistExt_ProcessSoftDist(ISoftDistExt *This, LPCWSTR szCDFURL,
                             IXMLElement *pSoftDistElement,
                             LPSOFTDISTINFO lpsdi) {
  return This->lpVtbl->ProcessSoftDist(This, szCDFURL, pSoftDistElement, lpsdi);
}
static inline HRESULT ISoftDistExt_GetFirstCodeBase(ISoftDistExt *This,
                                                    LPWSTR *szCodeBase,
                                                    LPDWORD dwMaxSize) {
  return This->lpVtbl->GetFirstCodeBase(This, szCodeBase, dwMaxSize);
}
static inline HRESULT ISoftDistExt_GetNextCodeBase(ISoftDistExt *This,
                                                   LPWSTR *szCodeBase,
                                                   LPDWORD dwMaxSize) {
  return This->lpVtbl->GetNextCodeBase(This, szCodeBase, dwMaxSize);
}
static inline HRESULT
ISoftDistExt_AsyncInstallDistributionUnit(ISoftDistExt *This, IBindCtx *pbc,
                                          LPVOID pvReserved, DWORD flags,
                                          LPCODEBASEHOLD lpcbh) {
  return This->lpVtbl->AsyncInstallDistributionUnit(This, pbc, pvReserved,
                                                    flags, lpcbh);
}
#endif
#endif
...
DEFINE_GUID(IID_ICatalogFileInfo, 0x711c7600, 0x6b48, 0x11d1, 0xb4, 0x03, 0x00,
            0xaa, 0x00, 0xb9, 0x2a, 0xf1);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("711c7600-6b48-11d1-b403-00aa00b92af1")
ICatalogFileInfo : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetCatalogFile(LPSTR * ppszCatalogFile) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetJavaTrust(void **ppJavaTrust) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ICatalogFileInfo, 0x711c7600, 0x6b48, 0x11d1, 0xb4, 0x03, 0x00,
                0xaa, 0x00, 0xb9, 0x2a, 0xf1)
#endif
#else
typedef struct ICatalogFileInfoVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ICatalogFileInfo *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetCatalogFile)(ICatalogFileInfo *This,
                                             LPSTR *ppszCatalogFile);
  HRESULT(STDMETHODCALLTYPE *GetJavaTrust)(ICatalogFileInfo *This,
                                           void **ppJavaTrust);
  END_INTERFACE
...
#else
/*** IUnknown methods ***/
static inline HRESULT ICatalogFileInfo_QueryInterface(ICatalogFileInfo *This,
                                                      REFIID riid,
                                                      void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ICatalogFileInfo methods ***/
static inline HRESULT ICatalogFileInfo_GetCatalogFile(ICatalogFileInfo *This,
                                                      LPSTR *ppszCatalogFile) {
  return This->lpVtbl->GetCatalogFile(This, ppszCatalogFile);
}
static inline HRESULT ICatalogFileInfo_GetJavaTrust(ICatalogFileInfo *This,
                                                    void **ppJavaTrust) {
...
DEFINE_GUID(IID_IDataFilter, 0x69d14c80, 0xc18e, 0x11d0, 0xa9, 0xce, 0x00, 0x60,
            0x97, 0x94, 0x23, 0x11);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("69d14c80-c18e-11d0-a9ce-006097942311")
IDataFilter : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE DoEncode(
      DWORD dwFlags, LONG lInBufferSize, BYTE * pbInBuffer, LONG lOutBufferSize,
      BYTE * pbOutBuffer, LONG lInBytesAvailable, LONG * plInBytesRead,
      LONG * plOutBytesWritten, DWORD dwReserved) = 0;
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDataFilter, 0x69d14c80, 0xc18e, 0x11d0, 0xa9, 0xce, 0x00, 0x60,
                0x97, 0x94, 0x23, 0x11)
#endif
#else
typedef struct IDataFilterVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDataFilter *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *DoEncode)(
      IDataFilter *This, DWORD dwFlags, LONG lInBufferSize, BYTE *pbInBuffer,
      LONG lOutBufferSize, BYTE *pbOutBuffer, LONG lInBytesAvailable,
      LONG *plInBytesRead, LONG *plOutBytesWritten, DWORD dwReserved);
  HRESULT(STDMETHODCALLTYPE *DoDecode)(
      IDataFilter *This, DWORD dwFlags, LONG lInBufferSize, BYTE *pbInBuffer,
      LONG lOutBufferSize, BYTE *pbOutBuffer, LONG lInBytesAvailable,
      LONG *plInBytesRead, LONG *plOutBytesWritten, DWORD dwReserved);
  HRESULT(STDMETHODCALLTYPE *SetEncodingLevel)(IDataFilter *This,
                                               DWORD dwEncLevel);
  END_INTERFACE
} IDataFilterVtbl;
interface IDataFilter { CONST_VTBL IDataFilterVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IDataFilter methods ***/
#define IDataFilter_DoEncode(This, dwFlags, lInBufferSize, pbInBuffer,         \
                             lOutBufferSize, pbOutBuffer, lInBytesAvailable,   \
                             plInBytesRead, plOutBytesWritten, dwReserved)     \
  (This)->lpVtbl->DoEncode(This, dwFlags, lInBufferSize, pbInBuffer,           \
                           lOutBufferSize, pbOutBuffer, lInBytesAvailable,     \
                           plInBytesRead, plOutBytesWritten, dwReserved)
#define IDataFilter_DoDecode(This, dwFlags, lInBufferSize, pbInBuffer,         \
                             lOutBufferSize, pbOutBuffer, lInBytesAvailable,   \
                             plInBytesRead, plOutBytesWritten, dwReserved)     \
  (This)->lpVtbl->DoDecode(This, dwFlags, lInBufferSize, pbInBuffer,           \
                           lOutBufferSize, pbOutBuffer, lInBytesAvailable,     \
                           plInBytesRead, plOutBytesWritten, dwReserved)
...
#else
/*** IUnknown methods ***/
static inline HRESULT IDataFilter_QueryInterface(IDataFilter *This, REFIID riid,
                                                 void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IDataFilter methods ***/
static inline HRESULT
IDataFilter_DoEncode(IDataFilter *This, DWORD dwFlags, LONG lInBufferSize,
                     BYTE *pbInBuffer, LONG lOutBufferSize, BYTE *pbOutBuffer,
                     LONG lInBytesAvailable, LONG *plInBytesRead,
                     LONG *plOutBytesWritten, DWORD dwReserved) {
  return This->lpVtbl->DoEncode(This, dwFlags, lInBufferSize, pbInBuffer,
                                lOutBufferSize, pbOutBuffer, lInBytesAvailable,
                                plInBytesRead, plOutBytesWritten, dwReserved);
}
static inline HRESULT
IDataFilter_DoDecode(IDataFilter *This, DWORD dwFlags, LONG lInBufferSize,
                     BYTE *pbInBuffer, LONG lOutBufferSize, BYTE *pbOutBuffer,
                     LONG lInBytesAvailable, LONG *plInBytesRead,
                     LONG *plOutBytesWritten, DWORD dwReserved) {
  return This->lpVtbl->DoDecode(This, dwFlags, lInBufferSize, pbInBuffer,
                                lOutBufferSize, pbOutBuffer, lInBytesAvailable,
                                plInBytesRead, plOutBytesWritten, dwReserved);
}
static inline HRESULT IDataFilter_SetEncodingLevel(IDataFilter *This,
                                                   DWORD dwEncLevel) {
...
DEFINE_GUID(IID_IEncodingFilterFactory, 0x70bdde00, 0xc18e, 0x11d0, 0xa9, 0xce,
            0x00, 0x60, 0x97, 0x94, 0x23, 0x11);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IEncodingFilterFactory : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE FindBestFilter(
      LPCWSTR pwzCodeIn, LPCWSTR pwzCodeOut, DATAINFO info,
      IDataFilter * *ppDF) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetDefaultFilter(
      LPCWSTR pwzCodeIn, LPCWSTR pwzCodeOut, IDataFilter * *ppDF) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IEncodingFilterFactory, 0x70bdde00, 0xc18e, 0x11d0, 0xa9, 0xce,
                0x00, 0x60, 0x97, 0x94, 0x23, 0x11)
#endif
#else
typedef struct IEncodingFilterFactoryVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IEncodingFilterFactory *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *FindBestFilter)(IEncodingFilterFactory *This,
                                             LPCWSTR pwzCodeIn,
                                             LPCWSTR pwzCodeOut, DATAINFO info,
                                             IDataFilter **ppDF);
  HRESULT(STDMETHODCALLTYPE *GetDefaultFilter)(IEncodingFilterFactory *This,
                                               LPCWSTR pwzCodeIn,
                                               LPCWSTR pwzCodeOut,
                                               IDataFilter **ppDF);
  END_INTERFACE
...
/*** IEncodingFilterFactory methods ***/
#define IEncodingFilterFactory_FindBestFilter(This, pwzCodeIn, pwzCodeOut,     \
                                              info, ppDF)                      \
  (This)->lpVtbl->FindBestFilter(This, pwzCodeIn, pwzCodeOut, info, ppDF)
#define IEncodingFilterFactory_GetDefaultFilter(This, pwzCodeIn, pwzCodeOut,   \
                                                ppDF)                          \
  (This)->lpVtbl->GetDefaultFilter(This, pwzCodeIn, pwzCodeOut, ppDF)
#else
/*** IUnknown methods ***/
static inline HRESULT
IEncodingFilterFactory_QueryInterface(IEncodingFilterFactory *This, REFIID riid,
                                      void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IEncodingFilterFactory_AddRef(IEncodingFilterFactory *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IEncodingFilterFactory_Release(IEncodingFilterFactory *This) {
  return This->lpVtbl->Release(This);
}
/*** IEncodingFilterFactory methods ***/
static inline HRESULT
IEncodingFilterFactory_FindBestFilter(IEncodingFilterFactory *This,
                                      LPCWSTR pwzCodeIn, LPCWSTR pwzCodeOut,
                                      DATAINFO info, IDataFilter **ppDF) {
  return This->lpVtbl->FindBestFilter(This, pwzCodeIn, pwzCodeOut, info, ppDF);
}
static inline HRESULT
IEncodingFilterFactory_GetDefaultFilter(IEncodingFilterFactory *This,
                                        LPCWSTR pwzCodeIn, LPCWSTR pwzCodeOut,
                                        IDataFilter **ppDF) {
...
DEFINE_GUID(IID_IWrappedProtocol, 0x53c84785, 0x8425, 0x4dc5, 0x97, 0x1b, 0xe5,
            0x8d, 0x9c, 0x19, 0xf9, 0xb6);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("53c84785-8425-4dc5-971b-e58d9c19f9b6")
IWrappedProtocol : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetWrapperCode(LONG * pnCode,
                                                   DWORD_PTR dwReserved) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IWrappedProtocol, 0x53c84785, 0x8425, 0x4dc5, 0x97, 0x1b, 0xe5,
                0x8d, 0x9c, 0x19, 0xf9, 0xb6)
#endif
#else
typedef struct IWrappedProtocolVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWrappedProtocol *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetWrapperCode)(IWrappedProtocol *This,
                                             LONG *pnCode,
                                             DWORD_PTR dwReserved);
  END_INTERFACE
} IWrappedProtocolVtbl;
interface IWrappedProtocol { CONST_VTBL IWrappedProtocolVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IWrappedProtocol_QueryInterface(IWrappedProtocol *This,
                                                      REFIID riid,
                                                      void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IWrappedProtocol methods ***/
static inline HRESULT IWrappedProtocol_GetWrapperCode(IWrappedProtocol *This,
                                                      LONG *pnCode,
                                                      DWORD_PTR dwReserved) {
...
DEFINE_GUID(IID_IGetBindHandle, 0xaf0ff408, 0x129d, 0x4b20, 0x91, 0xf0, 0x02,
            0xbd, 0x23, 0xd8, 0x83, 0x52);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IGetBindHandle : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetBindHandle(
      BINDHANDLETYPES enumRequestedHandle, HANDLE * pRetHandle) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IGetBindHandle, 0xaf0ff408, 0x129d, 0x4b20, 0x91, 0xf0, 0x02,
                0xbd, 0x23, 0xd8, 0x83, 0x52)
#endif
#else
typedef struct IGetBindHandleVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IGetBindHandle *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IGetBindHandle *This);
  ULONG(STDMETHODCALLTYPE *Release)(IGetBindHandle *This);
  /*** IGetBindHandle methods ***/
  HRESULT(STDMETHODCALLTYPE *GetBindHandle)(IGetBindHandle *This,
                                            BINDHANDLETYPES enumRequestedHandle,
                                            HANDLE *pRetHandle);
  END_INTERFACE
} IGetBindHandleVtbl;
interface IGetBindHandle { CONST_VTBL IGetBindHandleVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IGetBindHandle_QueryInterface(IGetBindHandle *This,
                                                    REFIID riid,
                                                    void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IGetBindHandle methods ***/
static inline HRESULT
IGetBindHandle_GetBindHandle(IGetBindHandle *This,
                             BINDHANDLETYPES enumRequestedHandle,
                             HANDLE *pRetHandle) {
...
DEFINE_GUID(IID_IBindCallbackRedirect, 0x11c81bc2, 0x121e, 0x4ed5, 0xb9, 0xc4,
            0xb4, 0x30, 0xbd, 0x54, 0xf2, 0xc0);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("11c81bc2-121e-4ed5-b9c4-b430bd54f2c0")
IBindCallbackRedirect : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE Redirect(LPCWSTR lpcUrl,
                                             VARIANT_BOOL * vbCancel) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IBindCallbackRedirect, 0x11c81bc2, 0x121e, 0x4ed5, 0xb9, 0xc4,
                0xb4, 0x30, 0xbd, 0x54, 0xf2, 0xc0)
#endif
#else
typedef struct IBindCallbackRedirectVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IBindCallbackRedirect *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IBindCallbackRedirect *This);
  ULONG(STDMETHODCALLTYPE *Release)(IBindCallbackRedirect *This);
  /*** IBindCallbackRedirect methods ***/
  HRESULT(STDMETHODCALLTYPE *Redirect)(IBindCallbackRedirect *This,
                                       LPCWSTR lpcUrl, VARIANT_BOOL *vbCancel);
  END_INTERFACE
...
/*** IUnknown methods ***/
static inline HRESULT
IBindCallbackRedirect_QueryInterface(IBindCallbackRedirect *This, REFIID riid,
                                     void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IBindCallbackRedirect methods ***/
static inline HRESULT
IBindCallbackRedirect_Redirect(IBindCallbackRedirect *This, LPCWSTR lpcUrl,
