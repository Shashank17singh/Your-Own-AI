...
#define TYPE_ENCODING_WSD_EVENTING_DELIVERY_MODE_PUSH                          \
  WSDXML_TYPE_ENCODING(29, 0)
...
typedef HRESULT (*WSD_STUB_FUNCTION)(IUnknown *server,
                                     IWSDServiceMessaging *session,
                                     WSD_EVENT *event);
typedef HRESULT (*PWSD_SOAP_MESSAGE_HANDLER)(IUnknown *thisUnknown,
                                             WSD_EVENT *event);
