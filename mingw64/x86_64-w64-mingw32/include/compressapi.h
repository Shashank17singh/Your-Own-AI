...
WINBOOL WINAPI Compress(COMPRESSOR_HANDLE CompressorHandle,
                        PVOID UncompressedData, SIZE_T UncompressedDataSize,
                        PVOID CompressedBuffer, SIZE_T CompressedBufferSize,
                        PSIZE_T CompressedDataSize);
WINBOOL WINAPI CreateCompressor(
    DWORD Algorithm, PCOMPRESS_ALLOCATION_ROUTINES AllocationRoutines,
    PCOMPRESSOR_HANDLE CompressorHandle);
WINBOOL WINAPI CreateDecompressor(
    DWORD Algorithm, PCOMPRESS_ALLOCATION_ROUTINES AllocationRoutines,
    PDECOMPRESSOR_HANDLE DecompressorHandle);
WINBOOL WINAPI Decompress(DECOMPRESSOR_HANDLE DecompressorHandle,
                          PVOID CompressedData, SIZE_T CompressedDataSize,
...
WINBOOL WINAPI QueryDecompressorInformation(
...
WINBOOL WINAPI SetCompressorInformation(
    COMPRESSOR_HANDLE CompressorHandle,
    COMPRESS_INFORMATION_CLASS CompressInformationClass,
    PVOID CompressInformation, SIZE_T CompressInformationSize);
WINBOOL WINAPI SetDecompressorInformation(
    DECOMPRESSOR_HANDLE DecompressorHandle,
    COMPRESS_INFORMATION_CLASS CompressInformationClass,
    PVOID CompressInformation, SIZE_T CompressInformationSize);
#ifdef __cplusplus
