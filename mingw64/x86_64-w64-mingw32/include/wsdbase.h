...
DEFINE_GUID(IID_IWSDAddress, 0xb9574c6c, 0x12a6, 0x4f74, 0x93, 0xa1, 0x33, 0x18,
            0xff, 0x60, 0x57, 0x59);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("b9574c6c-12a6-4f74-93a1-3318ff605759")
IWSDAddress : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE Serialize(LPWSTR pszBuffer, DWORD cchLength,
                                              WINBOOL fSafe) = 0;
  virtual HRESULT STDMETHODCALLTYPE Deserialize(LPCWSTR pszBuffer) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IWSDAddress, 0xb9574c6c, 0x12a6, 0x4f74, 0x93, 0xa1, 0x33, 0x18,
                0xff, 0x60, 0x57, 0x59)
#endif
#else
typedef struct IWSDAddressVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWSDAddress *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IWSDAddress *This);
  ULONG(STDMETHODCALLTYPE *Release)(IWSDAddress *This);
  /*** IWSDAddress methods ***/
  HRESULT(STDMETHODCALLTYPE *Serialize)(IWSDAddress *This, LPWSTR pszBuffer,
                                        DWORD cchLength, WINBOOL fSafe);
  HRESULT(STDMETHODCALLTYPE *Deserialize)(IWSDAddress *This, LPCWSTR pszBuffer);
  END_INTERFACE
} IWSDAddressVtbl;
interface IWSDAddress { CONST_VTBL IWSDAddressVtbl *lpVtbl; };
#ifdef COBJMACROS
...
#else
/*** IUnknown methods ***/
static inline HRESULT IWSDAddress_QueryInterface(IWSDAddress *This, REFIID riid,
                                                 void **ppvObject) {
...
/*** IWSDAddress methods ***/
static inline HRESULT IWSDAddress_Serialize(IWSDAddress *This, LPWSTR pszBuffer,
                                            DWORD cchLength, WINBOOL fSafe) {
  return This->lpVtbl->Serialize(This, pszBuffer, cchLength, fSafe);
}
static inline HRESULT IWSDAddress_Deserialize(IWSDAddress *This,
                                              LPCWSTR pszBuffer) {
...
DEFINE_GUID(IID_IWSDTransportAddress, 0x70d23498, 0x4ee6, 0x4340, 0xa3, 0xdf,
            0xd8, 0x45, 0xd2, 0x23, 0x54, 0x67);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("70d23498-4ee6-4340-a3df-d845d2235467")
IWSDTransportAddress : public IWSDAddress {
  virtual HRESULT STDMETHODCALLTYPE GetPort(WORD * pwPort) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetPort(WORD wPort) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetTransportAddress(LPCWSTR *
                                                        ppszAddress) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetTransportAddressEx(
      WINBOOL fSafe, LPCWSTR * ppszAddress) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetTransportAddress(LPCWSTR pszAddress) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IWSDTransportAddress, 0x70d23498, 0x4ee6, 0x4340, 0xa3, 0xdf,
                0xd8, 0x45, 0xd2, 0x23, 0x54, 0x67)
#endif
#else
typedef struct IWSDTransportAddressVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWSDTransportAddress *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IWSDTransportAddress *This);
  ULONG(STDMETHODCALLTYPE *Release)(IWSDTransportAddress *This);
  /*** IWSDAddress methods ***/
  HRESULT(STDMETHODCALLTYPE *Serialize)(IWSDTransportAddress *This,
                                        LPWSTR pszBuffer, DWORD cchLength,
                                        WINBOOL fSafe);
  HRESULT(STDMETHODCALLTYPE *Deserialize)(IWSDTransportAddress *This,
                                          LPCWSTR pszBuffer);
  ...
  HRESULT(STDMETHODCALLTYPE *GetTransportAddress)(IWSDTransportAddress *This,
                                                  LPCWSTR *ppszAddress);
  HRESULT(STDMETHODCALLTYPE *GetTransportAddressEx)(IWSDTransportAddress *This,
                                                    WINBOOL fSafe,
                                                    LPCWSTR *ppszAddress);
  HRESULT(STDMETHODCALLTYPE *SetTransportAddress)(IWSDTransportAddress *This,
                                                  LPCWSTR pszAddress);
  END_INTERFACE
} IWSDTransportAddressVtbl;
interface IWSDTransportAddress { CONST_VTBL IWSDTransportAddressVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
IWSDTransportAddress_QueryInterface(IWSDTransportAddress *This, REFIID riid,
                                    void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IWSDAddress methods ***/
static inline HRESULT IWSDTransportAddress_Serialize(IWSDTransportAddress *This,
                                                     LPWSTR pszBuffer,
                                                     DWORD cchLength,
                                                     WINBOOL fSafe) {
  return This->lpVtbl->Serialize(This, pszBuffer, cchLength, fSafe);
...
static inline HRESULT
IWSDTransportAddress_Deserialize(IWSDTransportAddress *This,
                                 LPCWSTR pszBuffer) {
  return This->lpVtbl->Deserialize(This, pszBuffer);
}
/*** IWSDTransportAddress methods ***/
static inline HRESULT IWSDTransportAddress_GetPort(IWSDTransportAddress *This,
                                                   WORD *pwPort) {
  return This->lpVtbl->GetPort(This, pwPort);
}
static inline HRESULT IWSDTransportAddress_SetPort(IWSDTransportAddress *This,
                                                   WORD wPort) {
  return This->lpVtbl->SetPort(This, wPort);
}
static inline HRESULT
IWSDTransportAddress_GetTransportAddress(IWSDTransportAddress *This,
                                         LPCWSTR *ppszAddress) {
  return This->lpVtbl->GetTransportAddress(This, ppszAddress);
}
static inline HRESULT IWSDTransportAddress_GetTransportAddressEx(
    IWSDTransportAddress *This, WINBOOL fSafe, LPCWSTR *ppszAddress) {
  return This->lpVtbl->GetTransportAddressEx(This, fSafe, ppszAddress);
}
static inline HRESULT
IWSDTransportAddress_SetTransportAddress(IWSDTransportAddress *This,
                                         LPCWSTR pszAddress) {
...
DEFINE_GUID(IID_IWSDMessageParameters, 0x1fafe8a2, 0xe6fc, 0x4b80, 0xb6, 0xcf,
            0xb7, 0xd4, 0x5c, 0x41, 0x6d, 0x7c);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("1fafe8a2-e6fc-4b80-b6cf-b7d45c416d7c")
IWSDMessageParameters : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetLocalAddress(IWSDAddress *
                                                    *ppAddress) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetLocalAddress(IWSDAddress * pAddress) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetRemoteAddress(IWSDAddress *
                                                     *ppAddress) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetRemoteAddress(IWSDAddress *
                                                     pAddress) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetLowerParameters(IWSDMessageParameters *
                                                       *ppTxParams) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IWSDMessageParameters, 0x1fafe8a2, 0xe6fc, 0x4b80, 0xb6, 0xcf,
                0xb7, 0xd4, 0x5c, 0x41, 0x6d, 0x7c)
#endif
#else
typedef struct IWSDMessageParametersVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWSDMessageParameters *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetLocalAddress)(IWSDMessageParameters *This,
                                              IWSDAddress **ppAddress);
  HRESULT(STDMETHODCALLTYPE *SetLocalAddress)(IWSDMessageParameters *This,
                                              IWSDAddress *pAddress);
  HRESULT(STDMETHODCALLTYPE *GetRemoteAddress)(IWSDMessageParameters *This,
                                               IWSDAddress **ppAddress);
  HRESULT(STDMETHODCALLTYPE *SetRemoteAddress)(IWSDMessageParameters *This,
                                               IWSDAddress *pAddress);
  HRESULT(STDMETHODCALLTYPE *GetLowerParameters)(
      IWSDMessageParameters *This, IWSDMessageParameters **ppTxParams);
  END_INTERFACE
...
/*** IUnknown methods ***/
static inline HRESULT
IWSDMessageParameters_QueryInterface(IWSDMessageParameters *This, REFIID riid,
                                     void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IWSDMessageParameters methods ***/
static inline HRESULT
IWSDMessageParameters_GetLocalAddress(IWSDMessageParameters *This,
                                      IWSDAddress **ppAddress) {
  return This->lpVtbl->GetLocalAddress(This, ppAddress);
}
static inline HRESULT
IWSDMessageParameters_SetLocalAddress(IWSDMessageParameters *This,
                                      IWSDAddress *pAddress) {
  return This->lpVtbl->SetLocalAddress(This, pAddress);
}
static inline HRESULT
IWSDMessageParameters_GetRemoteAddress(IWSDMessageParameters *This,
                                       IWSDAddress **ppAddress) {
  return This->lpVtbl->GetRemoteAddress(This, ppAddress);
}
static inline HRESULT
IWSDMessageParameters_SetRemoteAddress(IWSDMessageParameters *This,
                                       IWSDAddress *pAddress) {
  return This->lpVtbl->SetRemoteAddress(This, pAddress);
}
static inline HRESULT
IWSDMessageParameters_GetLowerParameters(IWSDMessageParameters *This,
...
HRESULT
    WINAPI WSDCreateUdpMessageParameters(IWSDUdpMessageParameters **ppTxParams);
...
DEFINE_GUID(IID_IWSDUdpMessageParameters, 0x9934149f, 0x8f0c, 0x447b, 0xaa,
            0x0b, 0x73, 0x12, 0x4b, 0x0c, 0xa7, 0xf0);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IWSDUdpMessageParameters : public IWSDMessageParameters {
  ...
  virtual HRESULT STDMETHODCALLTYPE GetRetransmitParams(WSDUdpRetransmitParams *
                                                        pParams) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IWSDUdpMessageParameters, 0x9934149f, 0x8f0c, 0x447b, 0xaa,
                0x0b, 0x73, 0x12, 0x4b, 0x0c, 0xa7, 0xf0)
#endif
#else
typedef struct IWSDUdpMessageParametersVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWSDUdpMessageParameters *This,
                                             REFIID riid, void **ppvObject);
  ...
  /*** IWSDMessageParameters methods ***/
  HRESULT(STDMETHODCALLTYPE *GetLocalAddress)(IWSDUdpMessageParameters *This,
                                              IWSDAddress **ppAddress);
  HRESULT(STDMETHODCALLTYPE *SetLocalAddress)(IWSDUdpMessageParameters *This,
                                              IWSDAddress *pAddress);
  HRESULT(STDMETHODCALLTYPE *GetRemoteAddress)(IWSDUdpMessageParameters *This,
                                               IWSDAddress **ppAddress);
  HRESULT(STDMETHODCALLTYPE *SetRemoteAddress)(IWSDUdpMessageParameters *This,
                                               IWSDAddress *pAddress);
  HRESULT(STDMETHODCALLTYPE *GetLowerParameters)(
      IWSDUdpMessageParameters *This, IWSDMessageParameters **ppTxParams);
  /*** IWSDUdpMessageParameters methods ***/
  HRESULT(STDMETHODCALLTYPE *SetRetransmitParams)(
      IWSDUdpMessageParameters *This, const WSDUdpRetransmitParams *pParams);
  HRESULT(STDMETHODCALLTYPE *GetRetransmitParams)(
      IWSDUdpMessageParameters *This, WSDUdpRetransmitParams *pParams);
  END_INTERFACE
...
/*** IUnknown methods ***/
static inline HRESULT
IWSDUdpMessageParameters_QueryInterface(IWSDUdpMessageParameters *This,
                                        REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IWSDUdpMessageParameters_AddRef(IWSDUdpMessageParameters *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IWSDUdpMessageParameters_Release(IWSDUdpMessageParameters *This) {
  return This->lpVtbl->Release(This);
}
/*** IWSDMessageParameters methods ***/
static inline HRESULT
IWSDUdpMessageParameters_GetLocalAddress(IWSDUdpMessageParameters *This,
                                         IWSDAddress **ppAddress) {
  return This->lpVtbl->GetLocalAddress(This, ppAddress);
}
static inline HRESULT
IWSDUdpMessageParameters_SetLocalAddress(IWSDUdpMessageParameters *This,
                                         IWSDAddress *pAddress) {
  return This->lpVtbl->SetLocalAddress(This, pAddress);
}
static inline HRESULT
IWSDUdpMessageParameters_GetRemoteAddress(IWSDUdpMessageParameters *This,
                                          IWSDAddress **ppAddress) {
  return This->lpVtbl->GetRemoteAddress(This, ppAddress);
}
static inline HRESULT
IWSDUdpMessageParameters_SetRemoteAddress(IWSDUdpMessageParameters *This,
                                          IWSDAddress *pAddress) {
  return This->lpVtbl->SetRemoteAddress(This, pAddress);
}
static inline HRESULT IWSDUdpMessageParameters_GetLowerParameters(
    IWSDUdpMessageParameters *This, IWSDMessageParameters **ppTxParams) {
  return This->lpVtbl->GetLowerParameters(This, ppTxParams);
}
/*** IWSDUdpMessageParameters methods ***/
static inline HRESULT IWSDUdpMessageParameters_SetRetransmitParams(
    IWSDUdpMessageParameters *This, const WSDUdpRetransmitParams *pParams) {
  return This->lpVtbl->SetRetransmitParams(This, pParams);
}
static inline HRESULT
IWSDUdpMessageParameters_GetRetransmitParams(IWSDUdpMessageParameters *This,
...
DEFINE_GUID(IID_IWSDUdpAddress, 0x74d6124a, 0xa441, 0x4f78, 0xa1, 0xeb, 0x97,
            0xa8, 0xd1, 0x99, 0x68, 0x93);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IWSDUdpAddress : public IWSDTransportAddress {
  ...
  virtual HRESULT STDMETHODCALLTYPE GetSockaddr(SOCKADDR_STORAGE *
                                                pSockAddr) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetExclusive(WINBOOL fExclusive) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetExclusive() = 0;
  virtual HRESULT STDMETHODCALLTYPE SetMessageType(
      WSDUdpMessageType messageType) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetMessageType(WSDUdpMessageType *
                                                   pMessageType) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetTTL(DWORD dwTTL) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetTTL(DWORD * pdwTTL) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetAlias(const GUID *pAlias) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetAlias(GUID * pAlias) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IWSDUdpAddress, 0x74d6124a, 0xa441, 0x4f78, 0xa1, 0xeb, 0x97,
                0xa8, 0xd1, 0x99, 0x68, 0x93)
#endif
#else
typedef struct IWSDUdpAddressVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWSDUdpAddress *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IWSDUdpAddress *This);
  ULONG(STDMETHODCALLTYPE *Release)(IWSDUdpAddress *This);
  /*** IWSDAddress methods ***/
  HRESULT(STDMETHODCALLTYPE *Serialize)(IWSDUdpAddress *This, LPWSTR pszBuffer,
                                        DWORD cchLength, WINBOOL fSafe);
  HRESULT(STDMETHODCALLTYPE *Deserialize)(IWSDUdpAddress *This,
                                          LPCWSTR pszBuffer);
  /*** IWSDTransportAddress methods ***/
  ...
  HRESULT(STDMETHODCALLTYPE *GetTransportAddress)(IWSDUdpAddress *This,
                                                  LPCWSTR *ppszAddress);
  HRESULT(STDMETHODCALLTYPE *GetTransportAddressEx)(IWSDUdpAddress *This,
                                                    WINBOOL fSafe,
                                                    LPCWSTR *ppszAddress);
  HRESULT(STDMETHODCALLTYPE *SetTransportAddress)(IWSDUdpAddress *This,
                                                  LPCWSTR pszAddress);
  /*** IWSDUdpAddress methods ***/
  HRESULT(STDMETHODCALLTYPE *SetSockaddr)(IWSDUdpAddress *This,
                                          const SOCKADDR_STORAGE *pSockAddr);
  HRESULT(STDMETHODCALLTYPE *GetSockaddr)(IWSDUdpAddress *This,
                                          SOCKADDR_STORAGE *pSockAddr);
  HRESULT(STDMETHODCALLTYPE *SetExclusive)(IWSDUdpAddress *This,
                                           WINBOOL fExclusive);
  HRESULT(STDMETHODCALLTYPE *GetExclusive)(IWSDUdpAddress *This);
  HRESULT(STDMETHODCALLTYPE *SetMessageType)(IWSDUdpAddress *This,
                                             WSDUdpMessageType messageType);
  HRESULT(STDMETHODCALLTYPE *GetMessageType)(IWSDUdpAddress *This,
  ...
  HRESULT(STDMETHODCALLTYPE *SetAlias)(IWSDUdpAddress *This,
                                       const GUID *pAlias);
  HRESULT(STDMETHODCALLTYPE *GetAlias)(IWSDUdpAddress *This, GUID *pAlias);
  END_INTERFACE
} IWSDUdpAddressVtbl;
interface IWSDUdpAddress { CONST_VTBL IWSDUdpAddressVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IWSDUdpAddress_QueryInterface(IWSDUdpAddress *This,
                                                    REFIID riid,
                                                    void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IWSDAddress methods ***/
static inline HRESULT IWSDUdpAddress_Serialize(IWSDUdpAddress *This,
                                               LPWSTR pszBuffer,
                                               DWORD cchLength, WINBOOL fSafe) {
  return This->lpVtbl->Serialize(This, pszBuffer, cchLength, fSafe);
}
static inline HRESULT IWSDUdpAddress_Deserialize(IWSDUdpAddress *This,
                                                 LPCWSTR pszBuffer) {
  return This->lpVtbl->Deserialize(This, pszBuffer);
}
/*** IWSDTransportAddress methods ***/
static inline HRESULT IWSDUdpAddress_GetPort(IWSDUdpAddress *This,
                                             WORD *pwPort) {
  return This->lpVtbl->GetPort(This, pwPort);
}
...
static inline HRESULT IWSDUdpAddress_GetTransportAddress(IWSDUdpAddress *This,
                                                         LPCWSTR *ppszAddress) {
  return This->lpVtbl->GetTransportAddress(This, ppszAddress);
}
static inline HRESULT
IWSDUdpAddress_GetTransportAddressEx(IWSDUdpAddress *This, WINBOOL fSafe,
                                     LPCWSTR *ppszAddress) {
  return This->lpVtbl->GetTransportAddressEx(This, fSafe, ppszAddress);
}
static inline HRESULT IWSDUdpAddress_SetTransportAddress(IWSDUdpAddress *This,
                                                         LPCWSTR pszAddress) {
  return This->lpVtbl->SetTransportAddress(This, pszAddress);
}
/*** IWSDUdpAddress methods ***/
static inline HRESULT
IWSDUdpAddress_SetSockaddr(IWSDUdpAddress *This,
                           const SOCKADDR_STORAGE *pSockAddr) {
  return This->lpVtbl->SetSockaddr(This, pSockAddr);
}
static inline HRESULT IWSDUdpAddress_GetSockaddr(IWSDUdpAddress *This,
                                                 SOCKADDR_STORAGE *pSockAddr) {
  return This->lpVtbl->GetSockaddr(This, pSockAddr);
}
static inline HRESULT IWSDUdpAddress_SetExclusive(IWSDUdpAddress *This,
                                                  WINBOOL fExclusive) {
...
static inline HRESULT
IWSDUdpAddress_SetMessageType(IWSDUdpAddress *This,
                              WSDUdpMessageType messageType) {
  return This->lpVtbl->SetMessageType(This, messageType);
}
static inline HRESULT
IWSDUdpAddress_GetMessageType(IWSDUdpAddress *This,
                              WSDUdpMessageType *pMessageType) {
...
static inline HRESULT IWSDUdpAddress_GetTTL(IWSDUdpAddress *This,
                                            DWORD *pdwTTL) {
  return This->lpVtbl->GetTTL(This, pdwTTL);
}
static inline HRESULT IWSDUdpAddress_SetAlias(IWSDUdpAddress *This,
                                              const GUID *pAlias) {
  return This->lpVtbl->SetAlias(This, pAlias);
}
static inline HRESULT IWSDUdpAddress_GetAlias(IWSDUdpAddress *This,
                                              GUID *pAlias) {
...
DEFINE_GUID(IID_IWSDHttpMessageParameters, 0x540bd122, 0x5c83, 0x4dec, 0xb3,
            0x96, 0xea, 0x62, 0xa2, 0x69, 0x7f, 0xdf);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IWSDHttpMessageParameters : public IWSDMessageParameters {
  ...
  virtual HRESULT STDMETHODCALLTYPE GetInboundHttpHeaders(LPCWSTR *
                                                          ppszHeaders) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetOutboundHttpHeaders(
      LPCWSTR pszHeaders) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetOutboundHttpHeaders(LPCWSTR *
                                                           ppszHeaders) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetID(LPCWSTR pszId) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetID(LPCWSTR * ppszId) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetContext(IUnknown * pContext) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetContext(IUnknown * *ppContext) = 0;
  virtual HRESULT STDMETHODCALLTYPE Clear() = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IWSDHttpMessageParameters, 0x540bd122, 0x5c83, 0x4dec, 0xb3,
                0x96, 0xea, 0x62, 0xa2, 0x69, 0x7f, 0xdf)
#endif
#else
typedef struct IWSDHttpMessageParametersVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWSDHttpMessageParameters *This,
                                             REFIID riid, void **ppvObject);
  ...
  /*** IWSDMessageParameters methods ***/
  HRESULT(STDMETHODCALLTYPE *GetLocalAddress)(IWSDHttpMessageParameters *This,
                                              IWSDAddress **ppAddress);
  HRESULT(STDMETHODCALLTYPE *SetLocalAddress)(IWSDHttpMessageParameters *This,
                                              IWSDAddress *pAddress);
  HRESULT(STDMETHODCALLTYPE *GetRemoteAddress)(IWSDHttpMessageParameters *This,
                                               IWSDAddress **ppAddress);
  HRESULT(STDMETHODCALLTYPE *SetRemoteAddress)(IWSDHttpMessageParameters *This,
                                               IWSDAddress *pAddress);
  HRESULT(STDMETHODCALLTYPE *GetLowerParameters)(
      IWSDHttpMessageParameters *This, IWSDMessageParameters **ppTxParams);
  ...
  HRESULT(STDMETHODCALLTYPE *GetOutboundHttpHeaders)(
      IWSDHttpMessageParameters *This, LPCWSTR *ppszHeaders);
  HRESULT(STDMETHODCALLTYPE *SetID)(IWSDHttpMessageParameters *This,
                                    LPCWSTR pszId);
  HRESULT(STDMETHODCALLTYPE *GetID)(IWSDHttpMessageParameters *This,
                                    LPCWSTR *ppszId);
  HRESULT(STDMETHODCALLTYPE *SetContext)(IWSDHttpMessageParameters *This,
                                         IUnknown *pContext);
  HRESULT(STDMETHODCALLTYPE *GetContext)(IWSDHttpMessageParameters *This,
                                         IUnknown **ppContext);
...
/*** IUnknown methods ***/
static inline HRESULT
IWSDHttpMessageParameters_QueryInterface(IWSDHttpMessageParameters *This,
                                         REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IWSDHttpMessageParameters_AddRef(IWSDHttpMessageParameters *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IWSDHttpMessageParameters_Release(IWSDHttpMessageParameters *This) {
  return This->lpVtbl->Release(This);
}
/*** IWSDMessageParameters methods ***/
static inline HRESULT
IWSDHttpMessageParameters_GetLocalAddress(IWSDHttpMessageParameters *This,
                                          IWSDAddress **ppAddress) {
  return This->lpVtbl->GetLocalAddress(This, ppAddress);
}
static inline HRESULT
IWSDHttpMessageParameters_SetLocalAddress(IWSDHttpMessageParameters *This,
                                          IWSDAddress *pAddress) {
  return This->lpVtbl->SetLocalAddress(This, pAddress);
}
static inline HRESULT
IWSDHttpMessageParameters_GetRemoteAddress(IWSDHttpMessageParameters *This,
                                           IWSDAddress **ppAddress) {
  return This->lpVtbl->GetRemoteAddress(This, ppAddress);
}
static inline HRESULT
IWSDHttpMessageParameters_SetRemoteAddress(IWSDHttpMessageParameters *This,
                                           IWSDAddress *pAddress) {
  return This->lpVtbl->SetRemoteAddress(This, pAddress);
}
static inline HRESULT IWSDHttpMessageParameters_GetLowerParameters(
    IWSDHttpMessageParameters *This, IWSDMessageParameters **ppTxParams) {
  return This->lpVtbl->GetLowerParameters(This, ppTxParams);
}
/*** IWSDHttpMessageParameters methods ***/
static inline HRESULT
IWSDHttpMessageParameters_SetInboundHttpHeaders(IWSDHttpMessageParameters *This,
                                                LPCWSTR pszHeaders) {
  return This->lpVtbl->SetInboundHttpHeaders(This, pszHeaders);
}
static inline HRESULT
IWSDHttpMessageParameters_GetInboundHttpHeaders(IWSDHttpMessageParameters *This,
                                                LPCWSTR *ppszHeaders) {
  return This->lpVtbl->GetInboundHttpHeaders(This, ppszHeaders);
}
static inline HRESULT IWSDHttpMessageParameters_SetOutboundHttpHeaders(
    IWSDHttpMessageParameters *This, LPCWSTR pszHeaders) {
  return This->lpVtbl->SetOutboundHttpHeaders(This, pszHeaders);
}
static inline HRESULT IWSDHttpMessageParameters_GetOutboundHttpHeaders(
    IWSDHttpMessageParameters *This, LPCWSTR *ppszHeaders) {
  return This->lpVtbl->GetOutboundHttpHeaders(This, ppszHeaders);
}
static inline HRESULT
IWSDHttpMessageParameters_SetID(IWSDHttpMessageParameters *This,
                                LPCWSTR pszId) {
  return This->lpVtbl->SetID(This, pszId);
}
static inline HRESULT
IWSDHttpMessageParameters_GetID(IWSDHttpMessageParameters *This,
                                LPCWSTR *ppszId) {
  return This->lpVtbl->GetID(This, ppszId);
}
static inline HRESULT
IWSDHttpMessageParameters_SetContext(IWSDHttpMessageParameters *This,
                                     IUnknown *pContext) {
  return This->lpVtbl->SetContext(This, pContext);
}
static inline HRESULT
IWSDHttpMessageParameters_GetContext(IWSDHttpMessageParameters *This,
                                     IUnknown **ppContext) {
  return This->lpVtbl->GetContext(This, ppContext);
}
static inline HRESULT
IWSDHttpMessageParameters_Clear(IWSDHttpMessageParameters *This) {
...
DEFINE_GUID(IID_IWSDHttpAddress, 0xd09ac7bd, 0x2a3e, 0x4b85, 0x86, 0x05, 0x27,
            0x37, 0xff, 0x3e, 0x4e, 0xa0);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("d09ac7bd-2a3e-4b85-8605-2737ff3e4ea0")
IWSDHttpAddress : public IWSDTransportAddress {
  virtual HRESULT STDMETHODCALLTYPE GetSecure() = 0;
  virtual HRESULT STDMETHODCALLTYPE SetSecure(WINBOOL fSecure) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetPath(LPCWSTR * ppszPath) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetPath(LPCWSTR pszPath) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IWSDHttpAddress, 0xd09ac7bd, 0x2a3e, 0x4b85, 0x86, 0x05, 0x27,
                0x37, 0xff, 0x3e, 0x4e, 0xa0)
#endif
#else
typedef struct IWSDHttpAddressVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWSDHttpAddress *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IWSDHttpAddress *This);
  ULONG(STDMETHODCALLTYPE *Release)(IWSDHttpAddress *This);
  /*** IWSDAddress methods ***/
  HRESULT(STDMETHODCALLTYPE *Serialize)(IWSDHttpAddress *This, LPWSTR pszBuffer,
                                        DWORD cchLength, WINBOOL fSafe);
  HRESULT(STDMETHODCALLTYPE *Deserialize)(IWSDHttpAddress *This,
                                          LPCWSTR pszBuffer);
  /*** IWSDTransportAddress methods ***/
  ...
  HRESULT(STDMETHODCALLTYPE *GetTransportAddress)(IWSDHttpAddress *This,
                                                  LPCWSTR *ppszAddress);
  HRESULT(STDMETHODCALLTYPE *GetTransportAddressEx)(IWSDHttpAddress *This,
                                                    WINBOOL fSafe,
                                                    LPCWSTR *ppszAddress);
  HRESULT(STDMETHODCALLTYPE *SetTransportAddress)(IWSDHttpAddress *This,
                                                  LPCWSTR pszAddress);
  /*** IWSDHttpAddress methods ***/
  HRESULT(STDMETHODCALLTYPE *GetSecure)(IWSDHttpAddress *This);
  HRESULT(STDMETHODCALLTYPE *SetSecure)(IWSDHttpAddress *This, WINBOOL fSecure);
...
interface IWSDHttpAddress { CONST_VTBL IWSDHttpAddressVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IWSDHttpAddress_QueryInterface(IWSDHttpAddress *This,
                                                     REFIID riid,
                                                     void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IWSDAddress methods ***/
static inline HRESULT IWSDHttpAddress_Serialize(IWSDHttpAddress *This,
                                                LPWSTR pszBuffer,
                                                DWORD cchLength,
                                                WINBOOL fSafe) {
  return This->lpVtbl->Serialize(This, pszBuffer, cchLength, fSafe);
}
static inline HRESULT IWSDHttpAddress_Deserialize(IWSDHttpAddress *This,
                                                  LPCWSTR pszBuffer) {
  return This->lpVtbl->Deserialize(This, pszBuffer);
}
/*** IWSDTransportAddress methods ***/
static inline HRESULT IWSDHttpAddress_GetPort(IWSDHttpAddress *This,
                                              WORD *pwPort) {
  return This->lpVtbl->GetPort(This, pwPort);
}
static inline HRESULT IWSDHttpAddress_SetPort(IWSDHttpAddress *This,
                                              WORD wPort) {
  return This->lpVtbl->SetPort(This, wPort);
}
static inline HRESULT
IWSDHttpAddress_GetTransportAddress(IWSDHttpAddress *This,
                                    LPCWSTR *ppszAddress) {
  return This->lpVtbl->GetTransportAddress(This, ppszAddress);
}
static inline HRESULT
IWSDHttpAddress_GetTransportAddressEx(IWSDHttpAddress *This, WINBOOL fSafe,
                                      LPCWSTR *ppszAddress) {
  return This->lpVtbl->GetTransportAddressEx(This, fSafe, ppszAddress);
}
static inline HRESULT IWSDHttpAddress_SetTransportAddress(IWSDHttpAddress *This,
                                                          LPCWSTR pszAddress) {
  return This->lpVtbl->SetTransportAddress(This, pszAddress);
}
/*** IWSDHttpAddress methods ***/
...
static inline HRESULT IWSDHttpAddress_SetSecure(IWSDHttpAddress *This,
                                                WINBOOL fSecure) {
  return This->lpVtbl->SetSecure(This, fSecure);
}
static inline HRESULT IWSDHttpAddress_GetPath(IWSDHttpAddress *This,
                                              LPCWSTR *ppszPath) {
  return This->lpVtbl->GetPath(This, ppszPath);
}
static inline HRESULT IWSDHttpAddress_SetPath(IWSDHttpAddress *This,
                                              LPCWSTR pszPath) {
...
DEFINE_GUID(IID_IWSDSSLClientCertificate, 0xde105e87, 0xa0da, 0x418e, 0x98,
            0xad, 0x27, 0xb9, 0xee, 0xd8, 0x7b, 0xdc);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("de105e87-a0da-418e-98ad-27b9eed87bdc")
IWSDSSLClientCertificate : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetClientCertificate(PCCERT_CONTEXT *
                                                         ppCertContext) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetMappedAccessToken(HANDLE * phToken) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IWSDSSLClientCertificate, 0xde105e87, 0xa0da, 0x418e, 0x98,
                0xad, 0x27, 0xb9, 0xee, 0xd8, 0x7b, 0xdc)
#endif
#else
typedef struct IWSDSSLClientCertificateVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWSDSSLClientCertificate *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetClientCertificate)(
      IWSDSSLClientCertificate *This, PCCERT_CONTEXT *ppCertContext);
  HRESULT(STDMETHODCALLTYPE *GetMappedAccessToken)(
      IWSDSSLClientCertificate *This, HANDLE *phToken);
  END_INTERFACE
...
/*** IUnknown methods ***/
static inline HRESULT
IWSDSSLClientCertificate_QueryInterface(IWSDSSLClientCertificate *This,
                                        REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IWSDSSLClientCertificate_AddRef(IWSDSSLClientCertificate *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IWSDSSLClientCertificate_Release(IWSDSSLClientCertificate *This) {
  return This->lpVtbl->Release(This);
}
/*** IWSDSSLClientCertificate methods ***/
static inline HRESULT
IWSDSSLClientCertificate_GetClientCertificate(IWSDSSLClientCertificate *This,
                                              PCCERT_CONTEXT *ppCertContext) {
  return This->lpVtbl->GetClientCertificate(This, ppCertContext);
}
static inline HRESULT
IWSDSSLClientCertificate_GetMappedAccessToken(IWSDSSLClientCertificate *This,
                                              HANDLE *phToken) {
...
DEFINE_GUID(IID_IWSDHttpAuthParameters, 0x0b476df0, 0x8dac, 0x480d, 0xb0, 0x5c,
            0x99, 0x78, 0x1a, 0x58, 0x84, 0xaa);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("0b476df0-8dac-480d-b05c-99781a5884aa")
IWSDHttpAuthParameters : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetClientAccessToken(HANDLE * phToken) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetAuthType(
      PWSD_SECURITY_HTTP_AUTH_SCHEMES pAuthType) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IWSDHttpAuthParameters, 0x0b476df0, 0x8dac, 0x480d, 0xb0, 0x5c,
                0x99, 0x78, 0x1a, 0x58, 0x84, 0xaa)
#endif
#else
typedef struct IWSDHttpAuthParametersVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWSDHttpAuthParameters *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IWSDHttpAuthParameters *This);
  ULONG(STDMETHODCALLTYPE *Release)(IWSDHttpAuthParameters *This);
  /*** IWSDHttpAuthParameters methods ***/
  HRESULT(STDMETHODCALLTYPE *GetClientAccessToken)(IWSDHttpAuthParameters *This,
                                                   HANDLE *phToken);
  HRESULT(STDMETHODCALLTYPE *GetAuthType)(
      IWSDHttpAuthParameters *This, PWSD_SECURITY_HTTP_AUTH_SCHEMES pAuthType);
  END_INTERFACE
...
/*** IUnknown methods ***/
static inline HRESULT
IWSDHttpAuthParameters_QueryInterface(IWSDHttpAuthParameters *This, REFIID riid,
                                      void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
IWSDHttpAuthParameters_AddRef(IWSDHttpAuthParameters *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
IWSDHttpAuthParameters_Release(IWSDHttpAuthParameters *This) {
  return This->lpVtbl->Release(This);
}
/*** IWSDHttpAuthParameters methods ***/
static inline HRESULT
IWSDHttpAuthParameters_GetClientAccessToken(IWSDHttpAuthParameters *This,
                                            HANDLE *phToken) {
  return This->lpVtbl->GetClientAccessToken(This, phToken);
}
static inline HRESULT
IWSDHttpAuthParameters_GetAuthType(IWSDHttpAuthParameters *This,
...
DEFINE_GUID(IID_IWSDSignatureProperty, 0x03ce20aa, 0x71c4, 0x45e2, 0xb3, 0x2e,
            0x37, 0x66, 0xc6, 0x1c, 0x79, 0x0f);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("03ce20aa-71c4-45e2-b32e-3766c61c790f")
IWSDSignatureProperty : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE IsMessageSigned(WINBOOL * pbSigned) = 0;
  virtual HRESULT STDMETHODCALLTYPE IsMessageSignatureTrusted(
      WINBOOL * pbSignatureTrusted) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetKeyInfo(BYTE * pbKeyInfo,
                                               DWORD * pdwKeyInfoSize) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetSignature(BYTE * pbSignature,
                                                 DWORD * pdwSignatureSize) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetSignedInfoHash(BYTE * pbSignedInfoHash,
                                                      DWORD * pdwHashSize) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IWSDSignatureProperty, 0x03ce20aa, 0x71c4, 0x45e2, 0xb3, 0x2e,
                0x37, 0x66, 0xc6, 0x1c, 0x79, 0x0f)
#endif
#else
typedef struct IWSDSignaturePropertyVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IWSDSignatureProperty *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *IsMessageSigned)(IWSDSignatureProperty *This,
                                              WINBOOL *pbSigned);
  HRESULT(STDMETHODCALLTYPE *IsMessageSignatureTrusted)(
      IWSDSignatureProperty *This, WINBOOL *pbSignatureTrusted);
  HRESULT(STDMETHODCALLTYPE *GetKeyInfo)(IWSDSignatureProperty *This,
                                         BYTE *pbKeyInfo,
                                         DWORD *pdwKeyInfoSize);
  HRESULT(STDMETHODCALLTYPE *GetSignature)(IWSDSignatureProperty *This,
                                           BYTE *pbSignature,
                                           DWORD *pdwSignatureSize);
  HRESULT(STDMETHODCALLTYPE *GetSignedInfoHash)(IWSDSignatureProperty *This,
...
#define IWSDSignatureProperty_IsMessageSignatureTrusted(This,                  \
                                                        pbSignatureTrusted)    \
...
#define IWSDSignatureProperty_GetSignature(This, pbSignature,                  \
                                           pdwSignatureSize)                   \
  (This)->lpVtbl->GetSignature(This, pbSignature, pdwSignatureSize)
#define IWSDSignatureProperty_GetSignedInfoHash(This, pbSignedInfoHash,        \
                                                pdwHashSize)                   \
  (This)->lpVtbl->GetSignedInfoHash(This, pbSignedInfoHash, pdwHashSize)
#else
/*** IUnknown methods ***/
static inline HRESULT
IWSDSignatureProperty_QueryInterface(IWSDSignatureProperty *This, REFIID riid,
                                     void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IWSDSignatureProperty methods ***/
static inline HRESULT
IWSDSignatureProperty_IsMessageSigned(IWSDSignatureProperty *This,
                                      WINBOOL *pbSigned) {
  return This->lpVtbl->IsMessageSigned(This, pbSigned);
}
static inline HRESULT
IWSDSignatureProperty_IsMessageSignatureTrusted(IWSDSignatureProperty *This,
                                                WINBOOL *pbSignatureTrusted) {
  return This->lpVtbl->IsMessageSignatureTrusted(This, pbSignatureTrusted);
}
static inline HRESULT
IWSDSignatureProperty_GetKeyInfo(IWSDSignatureProperty *This, BYTE *pbKeyInfo,
                                 DWORD *pdwKeyInfoSize) {
  return This->lpVtbl->GetKeyInfo(This, pbKeyInfo, pdwKeyInfoSize);
}
static inline HRESULT
IWSDSignatureProperty_GetSignature(IWSDSignatureProperty *This,
                                   BYTE *pbSignature, DWORD *pdwSignatureSize) {
  return This->lpVtbl->GetSignature(This, pbSignature, pdwSignatureSize);
}
static inline HRESULT IWSDSignatureProperty_GetSignedInfoHash(
    IWSDSignatureProperty *This, BYTE *pbSignedInfoHash, DWORD *pdwHashSize) {
