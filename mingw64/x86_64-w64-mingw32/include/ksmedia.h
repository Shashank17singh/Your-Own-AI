...
DEFINE_GUIDSTRUCT("00000008-0000-0010-8000-00aa00389b71",
...
DEFINE_GUIDSTRUCT("0000000b-0cea-0010-8000-00aa00389b71",
...
DEFINE_GUIDSTRUCT("0000000a-0cea-0010-8000-00aa00389b71",
...
DEFINE_GUIDSTRUCT("0000000c-0cea-0010-8000-00aa00389b71",
...
DEFINE_GUIDSTRUCT("E73FACE3-2880-4902-B799-88D0CD634E0F",
...
#define DEFINE_KSPROPERTY_ITEM_DISPLAY_ADAPTER_GUID(GetHandler)                \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_DISPLAY_ADAPTER_GUID, (GetHandler),        \
                         sizeof(KSPROPERTY), sizeof(GUID), NULL, NULL, 0,      \
                         NULL, NULL, 0)
#define DEFINE_KSPROPERTY_PREFERRED_CAPTURE_SURFACE(GetHandler)                \
  DEFINE_KSPROPERTY_ITEM(                                                      \
      KSPROPERTY_PREFERRED_CAPTURE_SURFACE, (GetHandler), sizeof(KSPROPERTY),  \
      sizeof(CAPTURE_MEMORY_ALLOCATION_FLAGS), NULL, NULL, 0, NULL, NULL, 0)
#define DEFINE_KSPROPERTY_CURRENT_CAPTURE_SURFACE(GetHandler, SetHandler)      \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_CURRENT_CAPTURE_SURFACE, (GetHandler),     \
                         sizeof(KSPROPERTY),                                   \
...
#define DEFINE_KSPROPERTY_MAP_CAPTURE_HANDLE_TO_VRAM_ADDRESS(GetHandler)       \
  DEFINE_KSPROPERTY_ITEM(KSPROPERTY_MAP_CAPTURE_HANDLE_TO_VRAM_ADDRESS,        \
                         (GetHandler), sizeof(VRAM_SURFACE_INFO_PROPERTY_S),   \
                         sizeof(DWORD), NULL, NULL, 0, NULL, NULL, 0)
typedef struct {
  UINT_PTR hSurface;
