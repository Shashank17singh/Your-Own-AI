...
#define SIZEOF_IFTABLE(X)                                                      \
  (FIELD_OFFSET(MIB_IFTABLE, table[0]) + ((X) * sizeof(MIB_IFROW)) + ALIGN_SIZE)
...
#define SIZEOF_UDPTABLE(X)                                                     \
  (FIELD_OFFSET(MIB_UDPTABLE, table[0]) + ((X) * sizeof(MIB_UDPROW)) +         \
   ALIGN_SIZE)
...
#define SIZEOF_TCPTABLE(X)                                                     \
  (FIELD_OFFSET(MIB_TCPTABLE, table[0]) + ((X) * sizeof(MIB_TCPROW)) +         \
   ALIGN_SIZE)
...
#define SIZEOF_IPADDRTABLE(X)                                                  \
  (FIELD_OFFSET(MIB_IPADDRTABLE, table[0]) + ((X) * sizeof(MIB_IPADDRROW)) +   \
   ALIGN_SIZE)
...
#define SIZEOF_IPNETTABLE(X)                                                   \
  (FIELD_OFFSET(MIB_IPNETTABLE, table[0]) + ((X) * sizeof(MIB_IPNETROW)) +     \
   ALIGN_SIZE)
...
#define SIZEOF_MCAST_IF_TABLE(X)                                               \
  (FIELD_OFFSET(MIB_IPMCAST_IF_TABLE, table[0]) +                              \
   ((X) * sizeof(MIB_IPMCAST_IF_ENTRY)) + ALIGN_SIZE)
...
#define SIZEOF_BOUNDARY_TABLE(X)                                               \
  (FIELD_OFFSET(MIB_IPMCAST_BOUNDARY_TABLE, table[0]) +                        \
   ((X) * sizeof(MIB_IPMCAST_BOUNDARY)) + ALIGN_SIZE)
typedef struct {
  DWORD dwGroupAddress;
  DWORD dwGroupMask;
