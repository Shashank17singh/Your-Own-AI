...
/* Approximate msg: A problem has been detected and ReactOS has been shut down
 * to prevent damage */
...
/* Approximate msg: If this is the first time you've seen this Stop error
 * screen, */
#define PSS_MESSAGE_INTRO ((ULONG)0x80000081)
/* MessageId  : 0x80000082 */
/* Approximate msg: Check to make sure any new hardware or software is properly
 * installed. */
...
/* Approximate msg: The bug code is undefined. Please use an existing code
 * instead. */
...
/* Approximate msg: The thread reaper was handed a thread to reap, but the
 * thread's process' */
...
/* Approximate msg: Check to be sure you have adequate disk space. If a driver
 * is */
...
/* Approximate msg: Run system diagnostics supplied by your hardware
 * manufacturer. */
...
/* Approximate msg: Check for viruses on your computer. Remove any newly
 * installed */
...
/* Approximate msg: Run a system diagnostic utility supplied by your hardware
 * manufacturer. */
...
/* Approximate msg: Inconsistency detected in the PCI Bus driver's internal
 * structures. */
#define PCI_BUS_DRIVER_INTERNAL ((ULONG)0x000000a1)
/* MessageId  : 0x000000a5 */
/* Approximate msg: The BIOS in this system is not fully ACPI compliant.  Please
 * contact your */
...
/* Approximate msg: The system is booting in safemode - Minimal Services with
 * Network */
#define BOOTING_IN_SAFEMODE_NETWORK ((ULONG)0x400000a9)
/* MessageId  : 0x400000aa */
/* Approximate msg: The system is booting in safemode - Directory Services
 * Repair */
#define BOOTING_IN_SAFEMODE_DSREPAIR ((ULONG)0x400000aa)
/* MessageId  : 0x000000ac */
/* Approximate msg: Allocate from NonPaged Pool failed for a HAL critical
 * allocation. */
...
/* Approximate msg: A wait operation, attach process, or yield was attempted
 * from a DPC routine. */
...
/* Approximate msg: A system file that is owned by ReactOS was replaced by an
 * application */
...
/* Approximate msg: A device driver attempting to corrupt the system has been
 * caught. */
#define DRIVER_CAUGHT_MODIFYING_FREED_POOL ((ULONG)0x000000c6)
/* MessageId  : 0x000000c8 */
/* Approximate msg: The processor's IRQL is not valid for the currently
 * executing context. */
#define IRQL_UNEXPECTED_VALUE ((ULONG)0x000000c8)
/* MessageId  : 0x000000ca */
/* Approximate msg: Plug and Play detected an error most likely caused by a
 * faulty driver. */
...
/* Approximate msg: The driver mistakenly marked a part of it's image pageable
 * instead of non-pageable. */
...
/* Approximate msg: If Parameter1 == 0, an executive worker item was found in
 * memory which */
...
/* Approximate msg: An executive worker thread is being terminated without
 * having gone through the worker thread rundown code. */
...
/* Approximate msg: The kernel attempted to ready a thread that was in an
 * incorrect state such as terminated. */
#define CRITICAL_PROCESS_DIED ((ULONG)0x000000ef)
/* MessageId  : 0x000000f4 */
/* Approximate msg: A process or thread crucial to system operation has
 * unexpectedly exited or been terminated. */
#define CRITICAL_OBJECT_TERMINATION ((ULONG)0x000000f4)
/* MessageId  : 0x000000f6 */
/* Approximate msg: The PCI driver has detected an error in a PCI device or BIOS
 * being verified. */
#define PCI_VERIFIER_DETECTED_VIOLATION ((ULONG)0x000000f6)
/* MessageId  : 0x000000f8 */
/* Approximate msg: An initialization failure occurred while attempting to boot
 * from the RAM disk. */
#define RAMDISK_BOOT_INITIALIZATION_FAILED ((ULONG)0x000000f8)
/* MessageId  : 0x000000fa */
/* Approximate msg: A worker thread is impersonating another process. The work
 * item forgot to */
