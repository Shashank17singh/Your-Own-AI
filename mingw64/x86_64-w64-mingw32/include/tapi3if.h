...
typedef struct ITPluggableTerminalSuperclassInfo
...
typedef enum ADDRESS_STATE { AS_INSERVICE = 0, AS_OUTOFSERVICE } ADDRESS_STATE;
...
typedef enum TERMINAL_STATE { TS_INUSE = 0, TS_NOTINUSE } TERMINAL_STATE;
...
typedef enum TERMINAL_TYPE { TT_STATIC = 0, TT_DYNAMIC } TERMINAL_TYPE;
typedef enum CALL_PRIVILEGE { CP_OWNER = 0, CP_MONITOR } CALL_PRIVILEGE;
...
typedef enum CALLHUB_STATE { CHS_ACTIVE = 0, CHS_IDLE } CALLHUB_STATE;
...
typedef enum FINISH_MODE { FM_ASTRANSFER = 0, FM_ASCONFERENCE } FINISH_MODE;
typedef enum PHONE_PRIVILEGE { PP_OWNER = 0, PP_MONITOR } PHONE_PRIVILEGE;
...
typedef enum PHONECAPS_BUFFER { PCB_DEVSPECIFICBUFFER = 0 } PHONECAPS_BUFFER;
...
public:
  ...
  virtual HRESULT WINAPI RegisterCallNotifications(ITAddress *pAddress,
                                                   VARIANT_BOOL fMonitor,
                                                   VARIANT_BOOL fOwner,
                                                   __LONG32 lMediaTypes,
                                                   __LONG32 lCallbackInstance,
                                                   __LONG32 *plRegister) = 0;
  ...
  virtual HRESULT WINAPI SetCallHubTracking(VARIANT pAddresses,
                                            VARIANT_BOOL bTracking) = 0;
  virtual HRESULT WINAPI
  EnumeratePrivateTAPIObjects(IEnumUnknown **ppEnumUnknown) = 0;
  virtual HRESULT WINAPI get_PrivateTAPIObjects(VARIANT *pVariant) = 0;
  virtual HRESULT WINAPI
  RegisterRequestRecipient(__LONG32 lRegistrationInstance,
                           __LONG32 lRequestMode, VARIANT_BOOL fEnable) = 0;
  virtual HRESULT WINAPI
  SetAssistedTelephonyPriority(BSTR pAppFilename, VARIANT_BOOL fPriority) = 0;
  virtual HRESULT WINAPI SetApplicationPriority(BSTR pAppFilename,
                                                __LONG32 lMediaType,
                                                VARIANT_BOOL fPriority) = 0;
...
typedef struct ITTAPIVtbl {
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITTAPI *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITTAPI *This, REFIID riid, LPOLESTR *rgszNames,
                                 UINT cNames, LCID lcid, DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITTAPI *This, DISPID dispIdMember, REFIID riid,
  ...
  HRESULT(WINAPI *EnumerateAddresses)(ITTAPI *This,
                                      IEnumAddress **ppEnumAddress);
  HRESULT(WINAPI *RegisterCallNotifications)(ITTAPI *This, ITAddress *pAddress,
                                             VARIANT_BOOL fMonitor,
                                             VARIANT_BOOL fOwner,
                                             __LONG32 lMediaTypes,
                                             __LONG32 lCallbackInstance,
  ...
  HRESULT(WINAPI *EnumerateCallHubs)(ITTAPI *This,
                                     IEnumCallHub **ppEnumCallHub);
  HRESULT(WINAPI *SetCallHubTracking)(ITTAPI *This, VARIANT pAddresses,
                                      VARIANT_BOOL bTracking);
  HRESULT(WINAPI *EnumeratePrivateTAPIObjects)(ITTAPI *This,
                                               IEnumUnknown **ppEnumUnknown);
  HRESULT(WINAPI *get_PrivateTAPIObjects)(ITTAPI *This, VARIANT *pVariant);
  HRESULT(WINAPI *RegisterRequestRecipient)(ITTAPI *This,
                                            __LONG32 lRegistrationInstance,
                                            __LONG32 lRequestMode,
                                            VARIANT_BOOL fEnable);
  HRESULT(WINAPI *SetAssistedTelephonyPriority)(ITTAPI *This, BSTR pAppFilename,
                                                VARIANT_BOOL fPriority);
  HRESULT(WINAPI *SetApplicationPriority)(ITTAPI *This, BSTR pAppFilename,
                                          __LONG32 lMediaType,
                                          VARIANT_BOOL fPriority);
...
#define ITTAPI_RegisterCallNotifications(This, pAddress, fMonitor, fOwner,     \
                                         lMediaTypes, lCallbackInstance,       \
                                         plRegister)                           \
  (This)->lpVtbl->RegisterCallNotifications(This, pAddress, fMonitor, fOwner,  \
                                            lMediaTypes, lCallbackInstance,    \
                                            plRegister)
...
#define ITTAPI_RegisterRequestRecipient(This, lRegistrationInstance,           \
                                        lRequestMode, fEnable)                 \
  (This)->lpVtbl->RegisterRequestRecipient(This, lRegistrationInstance,        \
                                           lRequestMode, fEnable)
...
#define ITTAPI_SetApplicationPriority(This, pAppFilename, lMediaType,          \
                                      fPriority)                               \
  (This)->lpVtbl->SetApplicationPriority(This, pAppFilename, lMediaType,       \
                                         fPriority)
...
void __RPC_STUB ITTAPI_Initialize_Stub(IRpcStubBuffer *This,
                                       IRpcChannelBuffer *_pRpcChannelBuffer,
                                       PRPC_MESSAGE _pRpcMessage,
                                       DWORD *_pdwStubPhase);
HRESULT WINAPI ITTAPI_Shutdown_Proxy(ITTAPI *This);
void __RPC_STUB ITTAPI_Shutdown_Stub(IRpcStubBuffer *This,
                                     IRpcChannelBuffer *_pRpcChannelBuffer,
                                     PRPC_MESSAGE _pRpcMessage,
                                     DWORD *_pdwStubPhase);
HRESULT WINAPI ITTAPI_get_Addresses_Proxy(ITTAPI *This, VARIANT *pVariant);
void __RPC_STUB ITTAPI_get_Addresses_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI ITTAPI_EnumerateAddresses_Proxy(ITTAPI *This,
                                               IEnumAddress **ppEnumAddress);
...
HRESULT WINAPI ITTAPI_RegisterCallNotifications_Proxy(
    ITTAPI *This, ITAddress *pAddress, VARIANT_BOOL fMonitor,
    VARIANT_BOOL fOwner, __LONG32 lMediaTypes, __LONG32 lCallbackInstance,
    __LONG32 *plRegister);
void __RPC_STUB ITTAPI_RegisterCallNotifications_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITTAPI_UnregisterNotifications_Proxy(ITTAPI *This,
                                                    __LONG32 lRegister);
void __RPC_STUB ITTAPI_UnregisterNotifications_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITTAPI_get_CallHubs_Proxy(ITTAPI *This, VARIANT *pVariant);
void __RPC_STUB ITTAPI_get_CallHubs_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
HRESULT WINAPI ITTAPI_EnumerateCallHubs_Proxy(ITTAPI *This,
                                              IEnumCallHub **ppEnumCallHub);
void __RPC_STUB ITTAPI_EnumerateCallHubs_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITTAPI_SetCallHubTracking_Proxy(ITTAPI *This, VARIANT pAddresses,
                                               VARIANT_BOOL bTracking);
void __RPC_STUB ITTAPI_SetCallHubTracking_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITTAPI_EnumeratePrivateTAPIObjects_Proxy(
    ITTAPI *This, IEnumUnknown **ppEnumUnknown);
void __RPC_STUB ITTAPI_EnumeratePrivateTAPIObjects_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITTAPI_get_PrivateTAPIObjects_Proxy(ITTAPI *This,
                                                   VARIANT *pVariant);
void __RPC_STUB ITTAPI_get_PrivateTAPIObjects_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITTAPI_RegisterRequestRecipient_Proxy(
    ITTAPI *This, __LONG32 lRegistrationInstance, __LONG32 lRequestMode,
    VARIANT_BOOL fEnable);
void __RPC_STUB ITTAPI_RegisterRequestRecipient_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITTAPI_SetAssistedTelephonyPriority_Proxy(
    ITTAPI *This, BSTR pAppFilename, VARIANT_BOOL fPriority);
void __RPC_STUB ITTAPI_SetAssistedTelephonyPriority_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITTAPI_SetApplicationPriority_Proxy(ITTAPI *This,
                                                   BSTR pAppFilename,
                                                   __LONG32 lMediaType,
                                                   VARIANT_BOOL fPriority);
...
void __RPC_STUB ITTAPI_put_EventFilter_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITTAPI_get_EventFilter_Proxy(ITTAPI *This,
                                            __LONG32 *plFilterMask);
...
public:
  ...
  virtual HRESULT WINAPI
  CreateEmptyCollectionObject(ITCollection2 **ppCollection) = 0;
};
#else
typedef struct ITTAPI2Vtbl {
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITTAPI2 *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITTAPI2 *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITTAPI2 *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  ...
  HRESULT(WINAPI *EnumerateAddresses)(ITTAPI2 *This,
                                      IEnumAddress **ppEnumAddress);
  HRESULT(WINAPI *RegisterCallNotifications)(ITTAPI2 *This, ITAddress *pAddress,
                                             VARIANT_BOOL fMonitor,
                                             VARIANT_BOOL fOwner,
                                             __LONG32 lMediaTypes,
                                             __LONG32 lCallbackInstance,
  ...
  HRESULT(WINAPI *EnumerateCallHubs)(ITTAPI2 *This,
                                     IEnumCallHub **ppEnumCallHub);
  HRESULT(WINAPI *SetCallHubTracking)(ITTAPI2 *This, VARIANT pAddresses,
                                      VARIANT_BOOL bTracking);
  HRESULT(WINAPI *EnumeratePrivateTAPIObjects)(ITTAPI2 *This,
                                               IEnumUnknown **ppEnumUnknown);
  HRESULT(WINAPI *get_PrivateTAPIObjects)(ITTAPI2 *This, VARIANT *pVariant);
  HRESULT(WINAPI *RegisterRequestRecipient)(ITTAPI2 *This,
                                            __LONG32 lRegistrationInstance,
                                            __LONG32 lRequestMode,
                                            VARIANT_BOOL fEnable);
  HRESULT(WINAPI *SetAssistedTelephonyPriority)(ITTAPI2 *This,
                                                BSTR pAppFilename,
                                                VARIANT_BOOL fPriority);
  HRESULT(WINAPI *SetApplicationPriority)(ITTAPI2 *This, BSTR pAppFilename,
                                          __LONG32 lMediaType,
                                          VARIANT_BOOL fPriority);
  ...
  HRESULT(WINAPI *CreateEmptyCollectionObject)(ITTAPI2 *This,
...
#define ITTAPI2_EnumerateAddresses(This, ppEnumAddress)                        \
  (This)->lpVtbl->EnumerateAddresses(This, ppEnumAddress)
#define ITTAPI2_RegisterCallNotifications(This, pAddress, fMonitor, fOwner,    \
                                          lMediaTypes, lCallbackInstance,      \
                                          plRegister)                          \
  (This)->lpVtbl->RegisterCallNotifications(This, pAddress, fMonitor, fOwner,  \
                                            lMediaTypes, lCallbackInstance,    \
...
#define ITTAPI2_get_PrivateTAPIObjects(This, pVariant)                         \
  (This)->lpVtbl->get_PrivateTAPIObjects(This, pVariant)
#define ITTAPI2_RegisterRequestRecipient(This, lRegistrationInstance,          \
                                         lRequestMode, fEnable)                \
  (This)->lpVtbl->RegisterRequestRecipient(This, lRegistrationInstance,        \
                                           lRequestMode, fEnable)
#define ITTAPI2_SetAssistedTelephonyPriority(This, pAppFilename, fPriority)    \
  (This)->lpVtbl->SetAssistedTelephonyPriority(This, pAppFilename, fPriority)
#define ITTAPI2_SetApplicationPriority(This, pAppFilename, lMediaType,         \
                                       fPriority)                              \
  (This)->lpVtbl->SetApplicationPriority(This, pAppFilename, lMediaType,       \
                                         fPriority)
...
void __RPC_STUB ITTAPI2_get_Phones_Stub(IRpcStubBuffer *This,
                                        IRpcChannelBuffer *_pRpcChannelBuffer,
                                        PRPC_MESSAGE _pRpcMessage,
                                        DWORD *_pdwStubPhase);
HRESULT WINAPI ITTAPI2_EnumeratePhones_Proxy(ITTAPI2 *This,
                                             IEnumPhone **ppEnumPhone);
void __RPC_STUB ITTAPI2_EnumeratePhones_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITTAPI2_CreateEmptyCollectionObject_Proxy(
    ITTAPI2 *This, ITCollection2 **ppCollection);
...
public:
  ...
  virtual HRESULT WINAPI QueryMediaType(__LONG32 lMediaType,
                                        VARIANT_BOOL *pfSupport) = 0;
};
#else
typedef struct ITMediaSupportVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITMediaSupport *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITMediaSupport *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITMediaSupport *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITMediaSupport *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *get_MediaTypes)(ITMediaSupport *This, __LONG32 *plMediaTypes);
  HRESULT(WINAPI *QueryMediaType)(ITMediaSupport *This, __LONG32 lMediaType,
...
#define ITMediaSupport_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITMediaSupport_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,      \
                                     rgDispId)                                 \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITMediaSupport_Invoke(This, dispIdMember, riid, lcid, wFlags,          \
...
#endif
#endif
HRESULT WINAPI ITMediaSupport_get_MediaTypes_Proxy(ITMediaSupport *This,
                                                   __LONG32 *plMediaTypes);
void __RPC_STUB ITMediaSupport_get_MediaTypes_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITMediaSupport_QueryMediaType_Proxy(ITMediaSupport *This,
                                                   __LONG32 lMediaType,
                                                   VARIANT_BOOL *pfSupport);
...
typedef struct ITPluggableTerminalClassInfoVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITPluggableTerminalClassInfo *This,
                                  REFIID riid, void **ppvObject);
  ULONG(WINAPI *AddRef)(ITPluggableTerminalClassInfo *This);
  ULONG(WINAPI *Release)(ITPluggableTerminalClassInfo *This);
  HRESULT(WINAPI *GetTypeInfoCount)(ITPluggableTerminalClassInfo *This,
                                    UINT *pctinfo);
  HRESULT(WINAPI *GetTypeInfo)(ITPluggableTerminalClassInfo *This, UINT iTInfo,
                               LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITPluggableTerminalClassInfo *This,
                                 REFIID riid, LPOLESTR *rgszNames, UINT cNames,
                                 LCID lcid, DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITPluggableTerminalClassInfo *This,
                          DISPID dispIdMember, REFIID riid, LCID lcid,
                          WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *get_Name)(ITPluggableTerminalClassInfo *This, BSTR *pName);
  HRESULT(WINAPI *get_Company)(ITPluggableTerminalClassInfo *This,
                               BSTR *pCompany);
  HRESULT(WINAPI *get_Version)(ITPluggableTerminalClassInfo *This,
                               BSTR *pVersion);
  HRESULT(WINAPI *get_TerminalClass)(ITPluggableTerminalClassInfo *This,
                                     BSTR *pTerminalClass);
  HRESULT(WINAPI *get_CLSID)(ITPluggableTerminalClassInfo *This, BSTR *pCLSID);
  HRESULT(WINAPI *get_Direction)(ITPluggableTerminalClassInfo *This,
                                 TERMINAL_DIRECTION *pDirection);
  HRESULT(WINAPI *get_MediaTypes)(ITPluggableTerminalClassInfo *This,
                                  __LONG32 *pMediaTypes);
  END_INTERFACE
...
#define ITPluggableTerminalClassInfo_GetTypeInfo(This, iTInfo, lcid, ppTInfo)  \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITPluggableTerminalClassInfo_GetIDsOfNames(This, riid, rgszNames,      \
                                                   cNames, lcid, rgDispId)     \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITPluggableTerminalClassInfo_Invoke(This, dispIdMember, riid, lcid,    \
...
#endif
#endif
HRESULT WINAPI ITPluggableTerminalClassInfo_get_Name_Proxy(
    ITPluggableTerminalClassInfo *This, BSTR *pName);
void __RPC_STUB ITPluggableTerminalClassInfo_get_Name_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPluggableTerminalClassInfo_get_Company_Proxy(
    ITPluggableTerminalClassInfo *This, BSTR *pCompany);
void __RPC_STUB ITPluggableTerminalClassInfo_get_Company_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPluggableTerminalClassInfo_get_Version_Proxy(
    ITPluggableTerminalClassInfo *This, BSTR *pVersion);
void __RPC_STUB ITPluggableTerminalClassInfo_get_Version_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPluggableTerminalClassInfo_get_TerminalClass_Proxy(
    ITPluggableTerminalClassInfo *This, BSTR *pTerminalClass);
void __RPC_STUB ITPluggableTerminalClassInfo_get_TerminalClass_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPluggableTerminalClassInfo_get_CLSID_Proxy(
    ITPluggableTerminalClassInfo *This, BSTR *pCLSID);
...
HRESULT WINAPI ITPluggableTerminalClassInfo_get_Direction_Proxy(
    ITPluggableTerminalClassInfo *This, TERMINAL_DIRECTION *pDirection);
void __RPC_STUB ITPluggableTerminalClassInfo_get_Direction_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPluggableTerminalClassInfo_get_MediaTypes_Proxy(
    ITPluggableTerminalClassInfo *This, __LONG32 *pMediaTypes);
...
typedef struct ITPluggableTerminalSuperclassInfoVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITPluggableTerminalSuperclassInfo *This,
                                  REFIID riid, void **ppvObject);
  ULONG(WINAPI *AddRef)(ITPluggableTerminalSuperclassInfo *This);
  ULONG(WINAPI *Release)(ITPluggableTerminalSuperclassInfo *This);
  HRESULT(WINAPI *GetTypeInfoCount)(ITPluggableTerminalSuperclassInfo *This,
                                    UINT *pctinfo);
  HRESULT(WINAPI *GetTypeInfo)(ITPluggableTerminalSuperclassInfo *This,
                               UINT iTInfo, LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITPluggableTerminalSuperclassInfo *This,
                                 REFIID riid, LPOLESTR *rgszNames, UINT cNames,
                                 LCID lcid, DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITPluggableTerminalSuperclassInfo *This,
                          DISPID dispIdMember, REFIID riid, LCID lcid,
                          WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *get_Name)(ITPluggableTerminalSuperclassInfo *This,
                            BSTR *pName);
  HRESULT(WINAPI *get_CLSID)(ITPluggableTerminalSuperclassInfo *This,
                             BSTR *pCLSID);
  END_INTERFACE
...
#ifdef COBJMACROS
#define ITPluggableTerminalSuperclassInfo_QueryInterface(This, riid,           \
                                                         ppvObject)            \
  (This)->lpVtbl->QueryInterface(This, riid, ppvObject)
...
#define ITPluggableTerminalSuperclassInfo_GetTypeInfoCount(This, pctinfo)      \
  (This)->lpVtbl->GetTypeInfoCount(This, pctinfo)
#define ITPluggableTerminalSuperclassInfo_GetTypeInfo(This, iTInfo, lcid,      \
                                                      ppTInfo)                 \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITPluggableTerminalSuperclassInfo_GetIDsOfNames(                       \
    This, riid, rgszNames, cNames, lcid, rgDispId)                             \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITPluggableTerminalSuperclassInfo_Invoke(                              \
...
#endif
#endif
HRESULT WINAPI ITPluggableTerminalSuperclassInfo_get_Name_Proxy(
    ITPluggableTerminalSuperclassInfo *This, BSTR *pName);
void __RPC_STUB ITPluggableTerminalSuperclassInfo_get_Name_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPluggableTerminalSuperclassInfo_get_CLSID_Proxy(
    ITPluggableTerminalSuperclassInfo *This, BSTR *pCLSID);
...
public:
  ...
  virtual HRESULT WINAPI
  EnumerateStaticTerminals(IEnumTerminal **ppTerminalEnumerator) = 0;
  virtual HRESULT WINAPI get_DynamicTerminalClasses(VARIANT *pVariant) = 0;
  virtual HRESULT WINAPI EnumerateDynamicTerminalClasses(
      IEnumTerminalClass **ppTerminalClassEnumerator) = 0;
  virtual HRESULT WINAPI CreateTerminal(BSTR pTerminalClass,
                                        __LONG32 lMediaType,
                                        TERMINAL_DIRECTION Direction,
                                        ITTerminal **ppTerminal) = 0;
  virtual HRESULT WINAPI GetDefaultStaticTerminal(__LONG32 lMediaType,
                                                  TERMINAL_DIRECTION Direction,
                                                  ITTerminal **ppTerminal) = 0;
};
#else
typedef struct ITTerminalSupportVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITTerminalSupport *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITTerminalSupport *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITTerminalSupport *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITTerminalSupport *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *get_StaticTerminals)(ITTerminalSupport *This,
                                       VARIANT *pVariant);
  HRESULT(WINAPI *EnumerateStaticTerminals)(
      ITTerminalSupport *This, IEnumTerminal **ppTerminalEnumerator);
  HRESULT(WINAPI *get_DynamicTerminalClasses)(ITTerminalSupport *This,
                                              VARIANT *pVariant);
  HRESULT(WINAPI *EnumerateDynamicTerminalClasses)(
      ITTerminalSupport *This, IEnumTerminalClass **ppTerminalClassEnumerator);
  HRESULT(WINAPI *CreateTerminal)(ITTerminalSupport *This, BSTR pTerminalClass,
                                  __LONG32 lMediaType,
                                  TERMINAL_DIRECTION Direction,
                                  ITTerminal **ppTerminal);
  HRESULT(WINAPI *GetDefaultStaticTerminal)(ITTerminalSupport *This,
                                            __LONG32 lMediaType,
                                            TERMINAL_DIRECTION Direction,
                                            ITTerminal **ppTerminal);
  END_INTERFACE
...
#define ITTerminalSupport_GetTypeInfo(This, iTInfo, lcid, ppTInfo)             \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITTerminalSupport_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,   \
                                        rgDispId)                              \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITTerminalSupport_Invoke(This, dispIdMember, riid, lcid, wFlags,       \
...
#define ITTerminalSupport_EnumerateDynamicTerminalClasses(                     \
    This, ppTerminalClassEnumerator)                                           \
  (This)->lpVtbl->EnumerateDynamicTerminalClasses(This,                        \
                                                  ppTerminalClassEnumerator)
#define ITTerminalSupport_CreateTerminal(This, pTerminalClass, lMediaType,     \
                                         Direction, ppTerminal)                \
  (This)->lpVtbl->CreateTerminal(This, pTerminalClass, lMediaType, Direction,  \
                                 ppTerminal)
#define ITTerminalSupport_GetDefaultStaticTerminal(This, lMediaType,           \
                                                   Direction, ppTerminal)      \
  (This)->lpVtbl->GetDefaultStaticTerminal(This, lMediaType, Direction,        \
                                           ppTerminal)
#endif
#endif
HRESULT
    WINAPI ITTerminalSupport_get_StaticTerminals_Proxy(ITTerminalSupport *This,
                                                       VARIANT *pVariant);
void __RPC_STUB ITTerminalSupport_get_StaticTerminals_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITTerminalSupport_EnumerateStaticTerminals_Proxy(
    ITTerminalSupport *This, IEnumTerminal **ppTerminalEnumerator);
void __RPC_STUB ITTerminalSupport_EnumerateStaticTerminals_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITTerminalSupport_get_DynamicTerminalClasses_Proxy(
    ITTerminalSupport *This, VARIANT *pVariant);
...
void __RPC_STUB ITTerminalSupport_EnumerateDynamicTerminalClasses_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITTerminalSupport_CreateTerminal_Proxy(
    ITTerminalSupport *This, BSTR pTerminalClass, __LONG32 lMediaType,
    TERMINAL_DIRECTION Direction, ITTerminal **ppTerminal);
void __RPC_STUB ITTerminalSupport_CreateTerminal_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITTerminalSupport_GetDefaultStaticTerminal_Proxy(
    ITTerminalSupport *This, __LONG32 lMediaType, TERMINAL_DIRECTION Direction,
    ITTerminal **ppTerminal);
...
public:
  ...
  virtual HRESULT WINAPI EnumeratePluggableSuperclasses(
      IEnumPluggableSuperclassInfo **ppSuperclassEnumerator) = 0;
  virtual HRESULT WINAPI get_PluggableTerminalClasses(
      BSTR bstrTerminalSuperclass, __LONG32 lMediaType, VARIANT *pVariant) = 0;
  virtual HRESULT WINAPI EnumeratePluggableTerminalClasses(
      CLSID iidTerminalSuperclass, __LONG32 lMediaType,
      IEnumPluggableTerminalClassInfo **ppClassEnumerator) = 0;
};
#else
typedef struct ITTerminalSupport2Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITTerminalSupport2 *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITTerminalSupport2 *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITTerminalSupport2 *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITTerminalSupport2 *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *get_StaticTerminals)(ITTerminalSupport2 *This,
                                       VARIANT *pVariant);
  HRESULT(WINAPI *EnumerateStaticTerminals)(
      ITTerminalSupport2 *This, IEnumTerminal **ppTerminalEnumerator);
  HRESULT(WINAPI *get_DynamicTerminalClasses)(ITTerminalSupport2 *This,
                                              VARIANT *pVariant);
  HRESULT(WINAPI *EnumerateDynamicTerminalClasses)(
      ITTerminalSupport2 *This, IEnumTerminalClass **ppTerminalClassEnumerator);
  HRESULT(WINAPI *CreateTerminal)(ITTerminalSupport2 *This, BSTR pTerminalClass,
                                  __LONG32 lMediaType,
                                  TERMINAL_DIRECTION Direction,
                                  ITTerminal **ppTerminal);
  HRESULT(WINAPI *GetDefaultStaticTerminal)(ITTerminalSupport2 *This,
                                            __LONG32 lMediaType,
                                            TERMINAL_DIRECTION Direction,
                                            ITTerminal **ppTerminal);
  HRESULT(WINAPI *get_PluggableSuperclasses)(ITTerminalSupport2 *This,
                                             VARIANT *pVariant);
  HRESULT(WINAPI *EnumeratePluggableSuperclasses)(
      ITTerminalSupport2 *This,
      IEnumPluggableSuperclassInfo **ppSuperclassEnumerator);
  HRESULT(WINAPI *get_PluggableTerminalClasses)(ITTerminalSupport2 *This,
                                                BSTR bstrTerminalSuperclass,
                                                __LONG32 lMediaType,
                                                VARIANT *pVariant);
  HRESULT(WINAPI *EnumeratePluggableTerminalClasses)(
      ITTerminalSupport2 *This, CLSID iidTerminalSuperclass,
      __LONG32 lMediaType, IEnumPluggableTerminalClassInfo **ppClassEnumerator);
  END_INTERFACE
...
#define ITTerminalSupport2_GetTypeInfo(This, iTInfo, lcid, ppTInfo)            \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITTerminalSupport2_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,  \
                                         rgDispId)                             \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITTerminalSupport2_Invoke(This, dispIdMember, riid, lcid, wFlags,      \
                                  pDispParams, pVarResult, pExcepInfo,         \
                                  puArgErr)                                    \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
#define ITTerminalSupport2_get_StaticTerminals(This, pVariant)                 \
  (This)->lpVtbl->get_StaticTerminals(This, pVariant)
#define ITTerminalSupport2_EnumerateStaticTerminals(This,                      \
                                                    ppTerminalEnumerator)      \
  (This)->lpVtbl->EnumerateStaticTerminals(This, ppTerminalEnumerator)
#define ITTerminalSupport2_get_DynamicTerminalClasses(This, pVariant)          \
  (This)->lpVtbl->get_DynamicTerminalClasses(This, pVariant)
#define ITTerminalSupport2_EnumerateDynamicTerminalClasses(                    \
    This, ppTerminalClassEnumerator)                                           \
  (This)->lpVtbl->EnumerateDynamicTerminalClasses(This,                        \
                                                  ppTerminalClassEnumerator)
#define ITTerminalSupport2_CreateTerminal(This, pTerminalClass, lMediaType,    \
                                          Direction, ppTerminal)               \
  (This)->lpVtbl->CreateTerminal(This, pTerminalClass, lMediaType, Direction,  \
                                 ppTerminal)
#define ITTerminalSupport2_GetDefaultStaticTerminal(This, lMediaType,          \
                                                    Direction, ppTerminal)     \
  (This)->lpVtbl->GetDefaultStaticTerminal(This, lMediaType, Direction,        \
                                           ppTerminal)
#define ITTerminalSupport2_get_PluggableSuperclasses(This, pVariant)           \
  (This)->lpVtbl->get_PluggableSuperclasses(This, pVariant)
#define ITTerminalSupport2_EnumeratePluggableSuperclasses(                     \
    This, ppSuperclassEnumerator)                                              \
  (This)->lpVtbl->EnumeratePluggableSuperclasses(This, ppSuperclassEnumerator)
#define ITTerminalSupport2_get_PluggableTerminalClasses(                       \
    This, bstrTerminalSuperclass, lMediaType, pVariant)                        \
  (This)->lpVtbl->get_PluggableTerminalClasses(This, bstrTerminalSuperclass,   \
                                               lMediaType, pVariant)
#define ITTerminalSupport2_EnumeratePluggableTerminalClasses(                  \
    This, iidTerminalSuperclass, lMediaType, ppClassEnumerator)                \
  (This)->lpVtbl->EnumeratePluggableTerminalClasses(                           \
      This, iidTerminalSuperclass, lMediaType, ppClassEnumerator)
#endif
#endif
HRESULT WINAPI ITTerminalSupport2_get_PluggableSuperclasses_Proxy(
    ITTerminalSupport2 *This, VARIANT *pVariant);
void __RPC_STUB ITTerminalSupport2_get_PluggableSuperclasses_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITTerminalSupport2_EnumeratePluggableSuperclasses_Proxy(
    ITTerminalSupport2 *This,
    IEnumPluggableSuperclassInfo **ppSuperclassEnumerator);
void __RPC_STUB ITTerminalSupport2_EnumeratePluggableSuperclasses_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITTerminalSupport2_get_PluggableTerminalClasses_Proxy(
    ITTerminalSupport2 *This, BSTR bstrTerminalSuperclass, __LONG32 lMediaType,
    VARIANT *pVariant);
void __RPC_STUB ITTerminalSupport2_get_PluggableTerminalClasses_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITTerminalSupport2_EnumeratePluggableTerminalClasses_Proxy(
    ITTerminalSupport2 *This, CLSID iidTerminalSuperclass, __LONG32 lMediaType,
...
public:
  ...
  virtual HRESULT WINAPI CreateCall(BSTR pDestAddress, __LONG32 lAddressType,
                                    __LONG32 lMediaTypes,
                                    ITBasicCallControl **ppCall) = 0;
  ...
  virtual HRESULT WINAPI
  CreateForwardInfoObject(ITForwardInformation **ppForwardInfo) = 0;
  virtual HRESULT WINAPI Forward(ITForwardInformation *pForwardInfo,
                                 ITBasicCallControl *pCall) = 0;
  virtual HRESULT WINAPI
  get_CurrentForwardInfo(ITForwardInformation **ppForwardInfo) = 0;
...
typedef struct ITAddressVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITAddress *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITAddress *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITAddress *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITAddress *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  ...
  HRESULT(WINAPI *CreateCall)(ITAddress *This, BSTR pDestAddress,
                              __LONG32 lAddressType, __LONG32 lMediaTypes,
  ...
  HRESULT(WINAPI *CreateForwardInfoObject)(
      ITAddress *This, ITForwardInformation **ppForwardInfo);
  HRESULT(WINAPI *Forward)(ITAddress *This, ITForwardInformation *pForwardInfo,
                           ITBasicCallControl *pCall);
  HRESULT(WINAPI *get_CurrentForwardInfo)(ITAddress *This,
                                          ITForwardInformation **ppForwardInfo);
  HRESULT(WINAPI *put_MessageWaiting)(ITAddress *This,
                                      VARIANT_BOOL fMessageWaiting);
  HRESULT(WINAPI *get_MessageWaiting)(ITAddress *This,
                                      VARIANT_BOOL *pfMessageWaiting);
  HRESULT(WINAPI *put_DoNotDisturb)(ITAddress *This,
                                    VARIANT_BOOL fDoNotDisturb);
  HRESULT(WINAPI *get_DoNotDisturb)(ITAddress *This,
...
#define ITAddress_CreateCall(This, pDestAddress, lAddressType, lMediaTypes,    \
                             ppCall)                                           \
  (This)->lpVtbl->CreateCall(This, pDestAddress, lAddressType, lMediaTypes,    \
                             ppCall)
...
#endif
#endif
HRESULT WINAPI ITAddress_get_State_Proxy(ITAddress *This,
                                         ADDRESS_STATE *pAddressState);
void __RPC_STUB ITAddress_get_State_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
...
void __RPC_STUB ITAddress_get_AddressName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAddress_get_ServiceProviderName_Proxy(ITAddress *This,
                                                       BSTR *ppName);
void __RPC_STUB ITAddress_get_ServiceProviderName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAddress_get_TAPIObject_Proxy(ITAddress *This,
                                              ITTAPI **ppTapiObject);
void __RPC_STUB ITAddress_get_TAPIObject_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAddress_CreateCall_Proxy(ITAddress *This, BSTR pDestAddress,
                                          __LONG32 lAddressType,
                                          __LONG32 lMediaTypes,
                                          ITBasicCallControl **ppCall);
void __RPC_STUB ITAddress_CreateCall_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI ITAddress_get_Calls_Proxy(ITAddress *This, VARIANT *pVariant);
void __RPC_STUB ITAddress_get_Calls_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
HRESULT WINAPI ITAddress_EnumerateCalls_Proxy(ITAddress *This,
                                              IEnumCall **ppCallEnum);
void __RPC_STUB ITAddress_EnumerateCalls_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAddress_get_DialableAddress_Proxy(ITAddress *This,
                                                   BSTR *pDialableAddress);
void __RPC_STUB ITAddress_get_DialableAddress_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAddress_CreateForwardInfoObject_Proxy(
    ITAddress *This, ITForwardInformation **ppForwardInfo);
void __RPC_STUB ITAddress_CreateForwardInfoObject_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAddress_Forward_Proxy(ITAddress *This,
                                       ITForwardInformation *pForwardInfo,
                                       ITBasicCallControl *pCall);
void __RPC_STUB ITAddress_Forward_Stub(IRpcStubBuffer *This,
                                       IRpcChannelBuffer *_pRpcChannelBuffer,
                                       PRPC_MESSAGE _pRpcMessage,
                                       DWORD *_pdwStubPhase);
HRESULT WINAPI ITAddress_get_CurrentForwardInfo_Proxy(
    ITAddress *This, ITForwardInformation **ppForwardInfo);
void __RPC_STUB ITAddress_get_CurrentForwardInfo_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAddress_put_MessageWaiting_Proxy(ITAddress *This,
                                                  VARIANT_BOOL fMessageWaiting);
void __RPC_STUB ITAddress_put_MessageWaiting_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAddress_get_MessageWaiting_Proxy(
    ITAddress *This, VARIANT_BOOL *pfMessageWaiting);
void __RPC_STUB ITAddress_get_MessageWaiting_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAddress_put_DoNotDisturb_Proxy(ITAddress *This,
                                                VARIANT_BOOL fDoNotDisturb);
void __RPC_STUB ITAddress_put_DoNotDisturb_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAddress_get_DoNotDisturb_Proxy(ITAddress *This,
                                                VARIANT_BOOL *pfDoNotDisturb);
...
public:
  virtual HRESULT WINAPI get_Phones(VARIANT *pPhones) = 0;
  virtual HRESULT WINAPI EnumeratePhones(IEnumPhone **ppEnumPhone) = 0;
  virtual HRESULT WINAPI GetPhoneFromTerminal(ITTerminal *pTerminal,
                                              ITPhone **ppPhone) = 0;
  ...
  virtual HRESULT WINAPI get_EventFilter(TAPI_EVENT TapiEvent,
                                         __LONG32 lSubEvent,
                                         VARIANT_BOOL *pEnable) = 0;
  virtual HRESULT WINAPI put_EventFilter(TAPI_EVENT TapiEvent,
                                         __LONG32 lSubEvent,
                                         VARIANT_BOOL bEnable) = 0;
  virtual HRESULT WINAPI DeviceSpecific(ITCallInfo *pCall, BYTE *pParams,
                                        DWORD dwSize) = 0;
  virtual HRESULT WINAPI
  DeviceSpecificVariant(ITCallInfo *pCall, VARIANT varDevSpecificByteArray) = 0;
  virtual HRESULT WINAPI NegotiateExtVersion(__LONG32 lLowVersion,
                                             __LONG32 lHighVersion,
                                             __LONG32 *plExtVersion) = 0;
};
#else
typedef struct ITAddress2Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITAddress2 *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITAddress2 *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITAddress2 *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITAddress2 *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  ...
  HRESULT(WINAPI *CreateCall)(ITAddress2 *This, BSTR pDestAddress,
                              __LONG32 lAddressType, __LONG32 lMediaTypes,
                              ITBasicCallControl **ppCall);
  ...
  HRESULT(WINAPI *get_DialableAddress)(ITAddress2 *This,
                                       BSTR *pDialableAddress);
  HRESULT(WINAPI *CreateForwardInfoObject)(
      ITAddress2 *This, ITForwardInformation **ppForwardInfo);
  HRESULT(WINAPI *Forward)(ITAddress2 *This, ITForwardInformation *pForwardInfo,
                           ITBasicCallControl *pCall);
  HRESULT(WINAPI *get_CurrentForwardInfo)(ITAddress2 *This,
                                          ITForwardInformation **ppForwardInfo);
  HRESULT(WINAPI *put_MessageWaiting)(ITAddress2 *This,
                                      VARIANT_BOOL fMessageWaiting);
  HRESULT(WINAPI *get_MessageWaiting)(ITAddress2 *This,
                                      VARIANT_BOOL *pfMessageWaiting);
  HRESULT(WINAPI *put_DoNotDisturb)(ITAddress2 *This,
                                    VARIANT_BOOL fDoNotDisturb);
  HRESULT(WINAPI *get_DoNotDisturb)(ITAddress2 *This,
                                    VARIANT_BOOL *pfDoNotDisturb);
  ...
  HRESULT(WINAPI *GetPhoneFromTerminal)(ITAddress2 *This, ITTerminal *pTerminal,
                                        ITPhone **ppPhone);
  HRESULT(WINAPI *get_PreferredPhones)(ITAddress2 *This, VARIANT *pPhones);
  HRESULT(WINAPI *EnumeratePreferredPhones)(ITAddress2 *This,
                                            IEnumPhone **ppEnumPhone);
  HRESULT(WINAPI *get_EventFilter)(ITAddress2 *This, TAPI_EVENT TapiEvent,
                                   __LONG32 lSubEvent, VARIANT_BOOL *pEnable);
  HRESULT(WINAPI *put_EventFilter)(ITAddress2 *This, TAPI_EVENT TapiEvent,
                                   __LONG32 lSubEvent, VARIANT_BOOL bEnable);
  HRESULT(WINAPI *DeviceSpecific)(ITAddress2 *This, ITCallInfo *pCall,
                                  BYTE *pParams, DWORD dwSize);
  HRESULT(WINAPI *DeviceSpecificVariant)(ITAddress2 *This, ITCallInfo *pCall,
                                         VARIANT varDevSpecificByteArray);
  HRESULT(WINAPI *NegotiateExtVersion)(ITAddress2 *This, __LONG32 lLowVersion,
                                       __LONG32 lHighVersion,
                                       __LONG32 *plExtVersion);
  END_INTERFACE
} ITAddress2Vtbl;
struct ITAddress2 {
...
#define ITAddress2_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                    \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITAddress2_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,          \
                                 rgDispId)                                     \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
...
#define ITAddress2_get_TAPIObject(This, ppTapiObject)                          \
  (This)->lpVtbl->get_TAPIObject(This, ppTapiObject)
#define ITAddress2_CreateCall(This, pDestAddress, lAddressType, lMediaTypes,   \
                              ppCall)                                          \
  (This)->lpVtbl->CreateCall(This, pDestAddress, lAddressType, lMediaTypes,    \
                             ppCall)
...
#define ITAddress2_NegotiateExtVersion(This, lLowVersion, lHighVersion,        \
                                       plExtVersion)                           \
  (This)->lpVtbl->NegotiateExtVersion(This, lLowVersion, lHighVersion,         \
                                      plExtVersion)
#endif
#endif
...
void __RPC_STUB ITAddress2_get_Phones_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAddress2_EnumeratePhones_Proxy(ITAddress2 *This,
                                                IEnumPhone **ppEnumPhone);
void __RPC_STUB ITAddress2_EnumeratePhones_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAddress2_GetPhoneFromTerminal_Proxy(ITAddress2 *This,
                                                     ITTerminal *pTerminal,
                                                     ITPhone **ppPhone);
void __RPC_STUB ITAddress2_GetPhoneFromTerminal_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAddress2_get_PreferredPhones_Proxy(ITAddress2 *This,
                                                    VARIANT *pPhones);
void __RPC_STUB ITAddress2_get_PreferredPhones_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAddress2_EnumeratePreferredPhones_Proxy(
    ITAddress2 *This, IEnumPhone **ppEnumPhone);
void __RPC_STUB ITAddress2_EnumeratePreferredPhones_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAddress2_get_EventFilter_Proxy(ITAddress2 *This,
...
void __RPC_STUB ITAddress2_get_EventFilter_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAddress2_put_EventFilter_Proxy(ITAddress2 *This,
                                                TAPI_EVENT TapiEvent,
                                                __LONG32 lSubEvent,
...
void __RPC_STUB ITAddress2_put_EventFilter_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAddress2_DeviceSpecific_Proxy(ITAddress2 *This,
                                               ITCallInfo *pCall, BYTE *pParams,
                                               DWORD dwSize);
void __RPC_STUB ITAddress2_DeviceSpecific_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAddress2_DeviceSpecificVariant_Proxy(
    ITAddress2 *This, ITCallInfo *pCall, VARIANT varDevSpecificByteArray);
void __RPC_STUB ITAddress2_DeviceSpecificVariant_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAddress2_NegotiateExtVersion_Proxy(ITAddress2 *This,
                                                    __LONG32 lLowVersion,
                                                    __LONG32 lHighVersion,
                                                    __LONG32 *plExtVersion);
...
public:
  virtual HRESULT WINAPI get_AddressCapability(ADDRESS_CAPABILITY AddressCap,
                                               __LONG32 *plCapability) = 0;
  virtual HRESULT WINAPI get_AddressCapabilityString(
      ADDRESS_CAPABILITY_STRING AddressCapString, BSTR *ppCapabilityString) = 0;
  virtual HRESULT WINAPI get_CallTreatments(VARIANT *pVariant) = 0;
  virtual HRESULT WINAPI
  EnumerateCallTreatments(IEnumBstr **ppEnumCallTreatment) = 0;
  virtual HRESULT WINAPI get_CompletionMessages(VARIANT *pVariant) = 0;
  virtual HRESULT WINAPI
  EnumerateCompletionMessages(IEnumBstr **ppEnumCompletionMessage) = 0;
  virtual HRESULT WINAPI get_DeviceClasses(VARIANT *pVariant) = 0;
  virtual HRESULT WINAPI
  EnumerateDeviceClasses(IEnumBstr **ppEnumDeviceClass) = 0;
};
#else
typedef struct ITAddressCapabilitiesVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITAddressCapabilities *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITAddressCapabilities *This, UINT iTInfo,
                               LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITAddressCapabilities *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITAddressCapabilities *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *get_AddressCapability)(ITAddressCapabilities *This,
                                         ADDRESS_CAPABILITY AddressCap,
                                         __LONG32 *plCapability);
  HRESULT(WINAPI *get_AddressCapabilityString)(
      ITAddressCapabilities *This, ADDRESS_CAPABILITY_STRING AddressCapString,
      BSTR *ppCapabilityString);
  HRESULT(WINAPI *get_CallTreatments)(ITAddressCapabilities *This,
                                      VARIANT *pVariant);
  HRESULT(WINAPI *EnumerateCallTreatments)(ITAddressCapabilities *This,
                                           IEnumBstr **ppEnumCallTreatment);
  HRESULT(WINAPI *get_CompletionMessages)(ITAddressCapabilities *This,
                                          VARIANT *pVariant);
  HRESULT(WINAPI *EnumerateCompletionMessages)(
      ITAddressCapabilities *This, IEnumBstr **ppEnumCompletionMessage);
  HRESULT(WINAPI *get_DeviceClasses)(ITAddressCapabilities *This,
                                     VARIANT *pVariant);
  HRESULT(WINAPI *EnumerateDeviceClasses)(ITAddressCapabilities *This,
                                          IEnumBstr **ppEnumDeviceClass);
  END_INTERFACE
...
#define ITAddressCapabilities_GetTypeInfo(This, iTInfo, lcid, ppTInfo)         \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITAddressCapabilities_GetIDsOfNames(This, riid, rgszNames, cNames,     \
                                            lcid, rgDispId)                    \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITAddressCapabilities_Invoke(This, dispIdMember, riid, lcid, wFlags,   \
                                     pDispParams, pVarResult, pExcepInfo,      \
                                     puArgErr)                                 \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
#define ITAddressCapabilities_get_AddressCapability(This, AddressCap,          \
                                                    plCapability)              \
  (This)->lpVtbl->get_AddressCapability(This, AddressCap, plCapability)
#define ITAddressCapabilities_get_AddressCapabilityString(                     \
    This, AddressCapString, ppCapabilityString)                                \
  (This)->lpVtbl->get_AddressCapabilityString(This, AddressCapString,          \
                                              ppCapabilityString)
#define ITAddressCapabilities_get_CallTreatments(This, pVariant)               \
  (This)->lpVtbl->get_CallTreatments(This, pVariant)
#define ITAddressCapabilities_EnumerateCallTreatments(This,                    \
                                                      ppEnumCallTreatment)     \
...
#define ITAddressCapabilities_EnumerateCompletionMessages(                     \
    This, ppEnumCompletionMessage)                                             \
...
HRESULT WINAPI ITAddressCapabilities_get_AddressCapability_Proxy(
    ITAddressCapabilities *This, ADDRESS_CAPABILITY AddressCap,
    __LONG32 *plCapability);
void __RPC_STUB ITAddressCapabilities_get_AddressCapability_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAddressCapabilities_get_AddressCapabilityString_Proxy(
    ITAddressCapabilities *This, ADDRESS_CAPABILITY_STRING AddressCapString,
    BSTR *ppCapabilityString);
void __RPC_STUB ITAddressCapabilities_get_AddressCapabilityString_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAddressCapabilities_get_CallTreatments_Proxy(
    ITAddressCapabilities *This, VARIANT *pVariant);
...
HRESULT WINAPI ITAddressCapabilities_EnumerateCallTreatments_Proxy(
    ITAddressCapabilities *This, IEnumBstr **ppEnumCallTreatment);
void __RPC_STUB ITAddressCapabilities_EnumerateCallTreatments_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAddressCapabilities_get_CompletionMessages_Proxy(
    ITAddressCapabilities *This, VARIANT *pVariant);
...
void __RPC_STUB ITAddressCapabilities_EnumerateCompletionMessages_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAddressCapabilities_get_DeviceClasses_Proxy(
    ITAddressCapabilities *This, VARIANT *pVariant);
void __RPC_STUB ITAddressCapabilities_get_DeviceClasses_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAddressCapabilities_EnumerateDeviceClasses_Proxy(
    ITAddressCapabilities *This, IEnumBstr **ppEnumDeviceClass);
...
public:
  ...
  virtual HRESULT WINAPI EnumerateAddresses(IEnumAddress **ppEnumAddress) = 0;
  virtual HRESULT WINAPI get_PhoneCapsLong(PHONECAPS_LONG pclCap,
                                           __LONG32 *plCapability) = 0;
  virtual HRESULT WINAPI get_PhoneCapsString(PHONECAPS_STRING pcsCap,
                                             BSTR *ppCapability) = 0;
  virtual HRESULT WINAPI get_Terminals(ITAddress *pAddress,
                                       VARIANT *pTerminals) = 0;
  virtual HRESULT WINAPI EnumerateTerminals(ITAddress *pAddress,
                                            IEnumTerminal **ppEnumTerminal) = 0;
  virtual HRESULT WINAPI get_ButtonMode(__LONG32 lButtonID,
                                        PHONE_BUTTON_MODE *pButtonMode) = 0;
  virtual HRESULT WINAPI put_ButtonMode(__LONG32 lButtonID,
                                        PHONE_BUTTON_MODE ButtonMode) = 0;
  virtual HRESULT WINAPI get_ButtonFunction(
      __LONG32 lButtonID, PHONE_BUTTON_FUNCTION *pButtonFunction) = 0;
  virtual HRESULT WINAPI put_ButtonFunction(
      __LONG32 lButtonID, PHONE_BUTTON_FUNCTION ButtonFunction) = 0;
  virtual HRESULT WINAPI get_ButtonText(__LONG32 lButtonID,
                                        BSTR *ppButtonText) = 0;
  virtual HRESULT WINAPI put_ButtonText(__LONG32 lButtonID,
                                        BSTR bstrButtonText) = 0;
  virtual HRESULT WINAPI get_ButtonState(__LONG32 lButtonID,
                                         PHONE_BUTTON_STATE *pButtonState) = 0;
  virtual HRESULT WINAPI
  get_HookSwitchState(PHONE_HOOK_SWITCH_DEVICE HookSwitchDevice,
                      PHONE_HOOK_SWITCH_STATE *pHookSwitchState) = 0;
  virtual HRESULT WINAPI
  put_HookSwitchState(PHONE_HOOK_SWITCH_DEVICE HookSwitchDevice,
                      PHONE_HOOK_SWITCH_STATE HookSwitchState) = 0;
  ...
  virtual HRESULT WINAPI GetPhoneCapsBuffer(PHONECAPS_BUFFER pcbCaps,
                                            DWORD *pdwSize,
                                            BYTE **ppPhoneCapsBuffer) = 0;
  virtual HRESULT WINAPI get_PhoneCapsBuffer(PHONECAPS_BUFFER pcbCaps,
                                             VARIANT *pVarBuffer) = 0;
  virtual HRESULT WINAPI get_LampMode(__LONG32 lLampID,
                                      PHONE_LAMP_MODE *pLampMode) = 0;
  virtual HRESULT WINAPI put_LampMode(__LONG32 lLampID,
                                      PHONE_LAMP_MODE LampMode) = 0;
  virtual HRESULT WINAPI get_Display(BSTR *pbstrDisplay) = 0;
  virtual HRESULT WINAPI SetDisplay(__LONG32 lRow, __LONG32 lColumn,
                                    BSTR bstrDisplay) = 0;
  virtual HRESULT WINAPI get_PreferredAddresses(VARIANT *pAddresses) = 0;
  virtual HRESULT WINAPI
  EnumeratePreferredAddresses(IEnumAddress **ppEnumAddress) = 0;
  virtual HRESULT WINAPI DeviceSpecific(BYTE *pParams, DWORD dwSize) = 0;
  virtual HRESULT WINAPI
  DeviceSpecificVariant(VARIANT varDevSpecificByteArray) = 0;
  virtual HRESULT WINAPI NegotiateExtVersion(__LONG32 lLowVersion,
                                             __LONG32 lHighVersion,
                                             __LONG32 *plExtVersion) = 0;
};
...
typedef struct ITPhoneVtbl {
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITPhone *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITPhone *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITPhone *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  ...
  HRESULT(WINAPI *EnumerateAddresses)(ITPhone *This,
                                      IEnumAddress **ppEnumAddress);
  HRESULT(WINAPI *get_PhoneCapsLong)(ITPhone *This, PHONECAPS_LONG pclCap,
                                     __LONG32 *plCapability);
  HRESULT(WINAPI *get_PhoneCapsString)(ITPhone *This, PHONECAPS_STRING pcsCap,
                                       BSTR *ppCapability);
  HRESULT(WINAPI *get_Terminals)(ITPhone *This, ITAddress *pAddress,
                                 VARIANT *pTerminals);
  HRESULT(WINAPI *EnumerateTerminals)(ITPhone *This, ITAddress *pAddress,
                                      IEnumTerminal **ppEnumTerminal);
  HRESULT(WINAPI *get_ButtonMode)(ITPhone *This, __LONG32 lButtonID,
                                  PHONE_BUTTON_MODE *pButtonMode);
  HRESULT(WINAPI *put_ButtonMode)(ITPhone *This, __LONG32 lButtonID,
                                  PHONE_BUTTON_MODE ButtonMode);
  HRESULT(WINAPI *get_ButtonFunction)(ITPhone *This, __LONG32 lButtonID,
                                      PHONE_BUTTON_FUNCTION *pButtonFunction);
  HRESULT(WINAPI *put_ButtonFunction)(ITPhone *This, __LONG32 lButtonID,
                                      PHONE_BUTTON_FUNCTION ButtonFunction);
  HRESULT(WINAPI *get_ButtonText)(ITPhone *This, __LONG32 lButtonID,
                                  BSTR *ppButtonText);
  HRESULT(WINAPI *put_ButtonText)(ITPhone *This, __LONG32 lButtonID,
                                  BSTR bstrButtonText);
  HRESULT(WINAPI *get_ButtonState)(ITPhone *This, __LONG32 lButtonID,
                                   PHONE_BUTTON_STATE *pButtonState);
  HRESULT(WINAPI *get_HookSwitchState)(
      ITPhone *This, PHONE_HOOK_SWITCH_DEVICE HookSwitchDevice,
      PHONE_HOOK_SWITCH_STATE *pHookSwitchState);
  HRESULT(WINAPI *put_HookSwitchState)(
      ITPhone *This, PHONE_HOOK_SWITCH_DEVICE HookSwitchDevice,
  ...
  HRESULT(WINAPI *GetPhoneCapsBuffer)(ITPhone *This, PHONECAPS_BUFFER pcbCaps,
                                      DWORD *pdwSize, BYTE **ppPhoneCapsBuffer);
  HRESULT(WINAPI *get_PhoneCapsBuffer)(ITPhone *This, PHONECAPS_BUFFER pcbCaps,
                                       VARIANT *pVarBuffer);
  HRESULT(WINAPI *get_LampMode)(ITPhone *This, __LONG32 lLampID,
                                PHONE_LAMP_MODE *pLampMode);
  HRESULT(WINAPI *put_LampMode)(ITPhone *This, __LONG32 lLampID,
                                PHONE_LAMP_MODE LampMode);
  HRESULT(WINAPI *get_Display)(ITPhone *This, BSTR *pbstrDisplay);
  HRESULT(WINAPI *SetDisplay)(ITPhone *This, __LONG32 lRow, __LONG32 lColumn,
                              BSTR bstrDisplay);
  HRESULT(WINAPI *get_PreferredAddresses)(ITPhone *This, VARIANT *pAddresses);
  HRESULT(WINAPI *EnumeratePreferredAddresses)(ITPhone *This,
                                               IEnumAddress **ppEnumAddress);
  HRESULT(WINAPI *DeviceSpecific)(ITPhone *This, BYTE *pParams, DWORD dwSize);
  HRESULT(WINAPI *DeviceSpecificVariant)(ITPhone *This,
                                         VARIANT varDevSpecificByteArray);
  HRESULT(WINAPI *NegotiateExtVersion)(ITPhone *This, __LONG32 lLowVersion,
                                       __LONG32 lHighVersion,
                                       __LONG32 *plExtVersion);
  END_INTERFACE
} ITPhoneVtbl;
...
#define ITPhone_GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)   \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITPhone_Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,    \
                       pVarResult, pExcepInfo, puArgErr)                       \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#define ITPhone_NegotiateExtVersion(This, lLowVersion, lHighVersion,           \
                                    plExtVersion)                              \
  (This)->lpVtbl->NegotiateExtVersion(This, lLowVersion, lHighVersion,         \
                                      plExtVersion)
#endif
...
void __RPC_STUB ITPhone_Open_Stub(IRpcStubBuffer *This,
                                  IRpcChannelBuffer *_pRpcChannelBuffer,
                                  PRPC_MESSAGE _pRpcMessage,
                                  DWORD *_pdwStubPhase);
HRESULT WINAPI ITPhone_Close_Proxy(ITPhone *This);
void __RPC_STUB ITPhone_Close_Stub(IRpcStubBuffer *This,
                                   IRpcChannelBuffer *_pRpcChannelBuffer,
                                   PRPC_MESSAGE _pRpcMessage,
                                   DWORD *_pdwStubPhase);
...
void __RPC_STUB ITPhone_get_Addresses_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPhone_EnumerateAddresses_Proxy(ITPhone *This,
                                                IEnumAddress **ppEnumAddress);
void __RPC_STUB ITPhone_EnumerateAddresses_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPhone_get_PhoneCapsLong_Proxy(ITPhone *This,
                                               PHONECAPS_LONG pclCap,
                                               __LONG32 *plCapability);
void __RPC_STUB ITPhone_get_PhoneCapsLong_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPhone_get_PhoneCapsString_Proxy(ITPhone *This,
                                                 PHONECAPS_STRING pcsCap,
                                                 BSTR *ppCapability);
void __RPC_STUB ITPhone_get_PhoneCapsString_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPhone_get_Terminals_Proxy(ITPhone *This, ITAddress *pAddress,
                                           VARIANT *pTerminals);
void __RPC_STUB ITPhone_get_Terminals_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPhone_EnumerateTerminals_Proxy(ITPhone *This,
                                                ITAddress *pAddress,
                                                IEnumTerminal **ppEnumTerminal);
void __RPC_STUB ITPhone_EnumerateTerminals_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPhone_get_ButtonMode_Proxy(ITPhone *This, __LONG32 lButtonID,
                                            PHONE_BUTTON_MODE *pButtonMode);
void __RPC_STUB ITPhone_get_ButtonMode_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPhone_put_ButtonMode_Proxy(ITPhone *This, __LONG32 lButtonID,
                                            PHONE_BUTTON_MODE ButtonMode);
void __RPC_STUB ITPhone_put_ButtonMode_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPhone_get_ButtonFunction_Proxy(
    ITPhone *This, __LONG32 lButtonID, PHONE_BUTTON_FUNCTION *pButtonFunction);
void __RPC_STUB ITPhone_get_ButtonFunction_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPhone_put_ButtonFunction_Proxy(
    ITPhone *This, __LONG32 lButtonID, PHONE_BUTTON_FUNCTION ButtonFunction);
void __RPC_STUB ITPhone_put_ButtonFunction_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPhone_get_ButtonText_Proxy(ITPhone *This, __LONG32 lButtonID,
                                            BSTR *ppButtonText);
void __RPC_STUB ITPhone_get_ButtonText_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPhone_put_ButtonText_Proxy(ITPhone *This, __LONG32 lButtonID,
                                            BSTR bstrButtonText);
void __RPC_STUB ITPhone_put_ButtonText_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPhone_get_ButtonState_Proxy(ITPhone *This, __LONG32 lButtonID,
                                             PHONE_BUTTON_STATE *pButtonState);
void __RPC_STUB ITPhone_get_ButtonState_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPhone_get_HookSwitchState_Proxy(
    ITPhone *This, PHONE_HOOK_SWITCH_DEVICE HookSwitchDevice,
    PHONE_HOOK_SWITCH_STATE *pHookSwitchState);
void __RPC_STUB ITPhone_get_HookSwitchState_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPhone_put_HookSwitchState_Proxy(
    ITPhone *This, PHONE_HOOK_SWITCH_DEVICE HookSwitchDevice,
    PHONE_HOOK_SWITCH_STATE HookSwitchState);
...
void __RPC_STUB ITPhone_put_RingMode_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI ITPhone_get_RingMode_Proxy(ITPhone *This, __LONG32 *plRingMode);
void __RPC_STUB ITPhone_get_RingMode_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI ITPhone_put_RingVolume_Proxy(ITPhone *This,
                                            __LONG32 lRingVolume);
void __RPC_STUB ITPhone_put_RingVolume_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPhone_get_RingVolume_Proxy(ITPhone *This,
                                            __LONG32 *plRingVolume);
void __RPC_STUB ITPhone_get_RingVolume_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPhone_get_Privilege_Proxy(ITPhone *This,
                                           PHONE_PRIVILEGE *pPrivilege);
void __RPC_STUB ITPhone_get_Privilege_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPhone_GetPhoneCapsBuffer_Proxy(ITPhone *This,
                                                PHONECAPS_BUFFER pcbCaps,
                                                DWORD *pdwSize,
                                                BYTE **ppPhoneCapsBuffer);
void __RPC_STUB ITPhone_GetPhoneCapsBuffer_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPhone_get_PhoneCapsBuffer_Proxy(ITPhone *This,
                                                 PHONECAPS_BUFFER pcbCaps,
                                                 VARIANT *pVarBuffer);
void __RPC_STUB ITPhone_get_PhoneCapsBuffer_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPhone_get_LampMode_Proxy(ITPhone *This, __LONG32 lLampID,
                                          PHONE_LAMP_MODE *pLampMode);
void __RPC_STUB ITPhone_get_LampMode_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI ITPhone_put_LampMode_Proxy(ITPhone *This, __LONG32 lLampID,
                                          PHONE_LAMP_MODE LampMode);
void __RPC_STUB ITPhone_put_LampMode_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI ITPhone_get_Display_Proxy(ITPhone *This, BSTR *pbstrDisplay);
void __RPC_STUB ITPhone_get_Display_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
HRESULT WINAPI ITPhone_SetDisplay_Proxy(ITPhone *This, __LONG32 lRow,
                                        __LONG32 lColumn, BSTR bstrDisplay);
void __RPC_STUB ITPhone_SetDisplay_Stub(IRpcStubBuffer *This,
                                        IRpcChannelBuffer *_pRpcChannelBuffer,
                                        PRPC_MESSAGE _pRpcMessage,
                                        DWORD *_pdwStubPhase);
HRESULT WINAPI ITPhone_get_PreferredAddresses_Proxy(ITPhone *This,
                                                    VARIANT *pAddresses);
void __RPC_STUB ITPhone_get_PreferredAddresses_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPhone_EnumeratePreferredAddresses_Proxy(
    ITPhone *This, IEnumAddress **ppEnumAddress);
void __RPC_STUB ITPhone_EnumeratePreferredAddresses_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPhone_DeviceSpecific_Proxy(ITPhone *This, BYTE *pParams,
                                            DWORD dwSize);
void __RPC_STUB ITPhone_DeviceSpecific_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPhone_DeviceSpecificVariant_Proxy(
    ITPhone *This, VARIANT varDevSpecificByteArray);
void __RPC_STUB ITPhone_DeviceSpecificVariant_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPhone_NegotiateExtVersion_Proxy(ITPhone *This,
                                                 __LONG32 lLowVersion,
                                                 __LONG32 lHighVersion,
                                                 __LONG32 *plExtVersion);
...
public:
  ...
  virtual HRESULT WINAPI StartRinger(__LONG32 lRingMode,
                                     __LONG32 lDuration) = 0;
  ...
  virtual HRESULT WINAPI
  put_AutoKeypadTonesMinimumDuration(__LONG32 lDuration) = 0;
  virtual HRESULT WINAPI
  get_AutoKeypadTonesMinimumDuration(__LONG32 *plDuration) = 0;
  ...
  virtual HRESULT WINAPI
  get_AutoVolumeControlRepeatDelay(__LONG32 *plDelay) = 0;
  virtual HRESULT WINAPI
  put_AutoVolumeControlRepeatPeriod(__LONG32 lPeriod) = 0;
  virtual HRESULT WINAPI
  get_AutoVolumeControlRepeatPeriod(__LONG32 *plPeriod) = 0;
  virtual HRESULT WINAPI SelectCall(ITCallInfo *pCall,
                                    VARIANT_BOOL fSelectDefaultTerminals) = 0;
...
typedef struct ITAutomatedPhoneControlVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITAutomatedPhoneControl *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ITAutomatedPhoneControl *This);
  ULONG(WINAPI *Release)(ITAutomatedPhoneControl *This);
  HRESULT(WINAPI *GetTypeInfoCount)(ITAutomatedPhoneControl *This,
                                    UINT *pctinfo);
  HRESULT(WINAPI *GetTypeInfo)(ITAutomatedPhoneControl *This, UINT iTInfo,
                               LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITAutomatedPhoneControl *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITAutomatedPhoneControl *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *StartTone)(ITAutomatedPhoneControl *This, PHONE_TONE Tone,
                             __LONG32 lDuration);
  ...
  HRESULT(WINAPI *StartRinger)(ITAutomatedPhoneControl *This,
                               __LONG32 lRingMode, __LONG32 lDuration);
  HRESULT(WINAPI *StopRinger)(ITAutomatedPhoneControl *This);
  HRESULT(WINAPI *get_Ringer)(ITAutomatedPhoneControl *This,
                              VARIANT_BOOL *pfRinging);
  HRESULT(WINAPI *put_PhoneHandlingEnabled)(ITAutomatedPhoneControl *This,
                                            VARIANT_BOOL fEnabled);
  HRESULT(WINAPI *get_PhoneHandlingEnabled)(ITAutomatedPhoneControl *This,
                                            VARIANT_BOOL *pfEnabled);
  HRESULT(WINAPI *put_AutoEndOfNumberTimeout)(ITAutomatedPhoneControl *This,
                                              __LONG32 lTimeout);
  HRESULT(WINAPI *get_AutoEndOfNumberTimeout)(ITAutomatedPhoneControl *This,
                                              __LONG32 *plTimeout);
  HRESULT(WINAPI *put_AutoDialtone)(ITAutomatedPhoneControl *This,
                                    VARIANT_BOOL fEnabled);
  HRESULT(WINAPI *get_AutoDialtone)(ITAutomatedPhoneControl *This,
                                    VARIANT_BOOL *pfEnabled);
  HRESULT(WINAPI *put_AutoStopTonesOnOnHook)(ITAutomatedPhoneControl *This,
                                             VARIANT_BOOL fEnabled);
  HRESULT(WINAPI *get_AutoStopTonesOnOnHook)(ITAutomatedPhoneControl *This,
                                             VARIANT_BOOL *pfEnabled);
  HRESULT(WINAPI *put_AutoStopRingOnOffHook)(ITAutomatedPhoneControl *This,
                                             VARIANT_BOOL fEnabled);
  HRESULT(WINAPI *get_AutoStopRingOnOffHook)(ITAutomatedPhoneControl *This,
                                             VARIANT_BOOL *pfEnabled);
  HRESULT(WINAPI *put_AutoKeypadTones)(ITAutomatedPhoneControl *This,
                                       VARIANT_BOOL fEnabled);
  HRESULT(WINAPI *get_AutoKeypadTones)(ITAutomatedPhoneControl *This,
                                       VARIANT_BOOL *pfEnabled);
  HRESULT(WINAPI *put_AutoKeypadTonesMinimumDuration)(
      ITAutomatedPhoneControl *This, __LONG32 lDuration);
  HRESULT(WINAPI *get_AutoKeypadTonesMinimumDuration)(
      ITAutomatedPhoneControl *This, __LONG32 *plDuration);
  HRESULT(WINAPI *put_AutoVolumeControl)(ITAutomatedPhoneControl *This,
                                         VARIANT_BOOL fEnabled);
  HRESULT(WINAPI *get_AutoVolumeControl)(ITAutomatedPhoneControl *This,
                                         VARIANT_BOOL *fEnabled);
  HRESULT(WINAPI *put_AutoVolumeControlStep)(ITAutomatedPhoneControl *This,
                                             __LONG32 lStepSize);
  HRESULT(WINAPI *get_AutoVolumeControlStep)(ITAutomatedPhoneControl *This,
                                             __LONG32 *plStepSize);
  HRESULT(WINAPI *put_AutoVolumeControlRepeatDelay)(
      ITAutomatedPhoneControl *This, __LONG32 lDelay);
  HRESULT(WINAPI *get_AutoVolumeControlRepeatDelay)(
      ITAutomatedPhoneControl *This, __LONG32 *plDelay);
  HRESULT(WINAPI *put_AutoVolumeControlRepeatPeriod)(
      ITAutomatedPhoneControl *This, __LONG32 lPeriod);
  HRESULT(WINAPI *get_AutoVolumeControlRepeatPeriod)(
      ITAutomatedPhoneControl *This, __LONG32 *plPeriod);
  HRESULT(WINAPI *SelectCall)(ITAutomatedPhoneControl *This, ITCallInfo *pCall,
                              VARIANT_BOOL fSelectDefaultTerminals);
  HRESULT(WINAPI *UnselectCall)(ITAutomatedPhoneControl *This,
                                ITCallInfo *pCall);
  HRESULT(WINAPI *EnumerateSelectedCalls)(ITAutomatedPhoneControl *This,
                                          IEnumCall **ppCallEnum);
  HRESULT(WINAPI *get_SelectedCalls)(ITAutomatedPhoneControl *This,
                                     VARIANT *pVariant);
  END_INTERFACE
...
#define ITAutomatedPhoneControl_GetTypeInfo(This, iTInfo, lcid, ppTInfo)       \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITAutomatedPhoneControl_GetIDsOfNames(This, riid, rgszNames, cNames,   \
                                              lcid, rgDispId)                  \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITAutomatedPhoneControl_Invoke(This, dispIdMember, riid, lcid, wFlags, \
                                       pDispParams, pVarResult, pExcepInfo,    \
                                       puArgErr)                               \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#define ITAutomatedPhoneControl_put_AutoKeypadTonesMinimumDuration(This,       \
                                                                   lDuration)  \
  (This)->lpVtbl->put_AutoKeypadTonesMinimumDuration(This, lDuration)
#define ITAutomatedPhoneControl_get_AutoKeypadTonesMinimumDuration(This,       \
                                                                   plDuration) \
...
#define ITAutomatedPhoneControl_get_AutoVolumeControlRepeatDelay(This,         \
                                                                 plDelay)      \
  (This)->lpVtbl->get_AutoVolumeControlRepeatDelay(This, plDelay)
#define ITAutomatedPhoneControl_put_AutoVolumeControlRepeatPeriod(This,        \
                                                                  lPeriod)     \
  (This)->lpVtbl->put_AutoVolumeControlRepeatPeriod(This, lPeriod)
#define ITAutomatedPhoneControl_get_AutoVolumeControlRepeatPeriod(This,        \
                                                                  plPeriod)    \
  (This)->lpVtbl->get_AutoVolumeControlRepeatPeriod(This, plPeriod)
#define ITAutomatedPhoneControl_SelectCall(This, pCall,                        \
...
#endif
#endif
HRESULT WINAPI ITAutomatedPhoneControl_StartTone_Proxy(
    ITAutomatedPhoneControl *This, PHONE_TONE Tone, __LONG32 lDuration);
void __RPC_STUB ITAutomatedPhoneControl_StartTone_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
ITAutomatedPhoneControl_StopTone_Proxy(ITAutomatedPhoneControl *This);
void __RPC_STUB ITAutomatedPhoneControl_StopTone_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAutomatedPhoneControl_get_Tone_Proxy(
    ITAutomatedPhoneControl *This, PHONE_TONE *pTone);
void __RPC_STUB ITAutomatedPhoneControl_get_Tone_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAutomatedPhoneControl_StartRinger_Proxy(
    ITAutomatedPhoneControl *This, __LONG32 lRingMode, __LONG32 lDuration);
void __RPC_STUB ITAutomatedPhoneControl_StartRinger_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
ITAutomatedPhoneControl_StopRinger_Proxy(ITAutomatedPhoneControl *This);
void __RPC_STUB ITAutomatedPhoneControl_StopRinger_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAutomatedPhoneControl_get_Ringer_Proxy(
    ITAutomatedPhoneControl *This, VARIANT_BOOL *pfRinging);
void __RPC_STUB ITAutomatedPhoneControl_get_Ringer_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAutomatedPhoneControl_put_PhoneHandlingEnabled_Proxy(
    ITAutomatedPhoneControl *This, VARIANT_BOOL fEnabled);
void __RPC_STUB ITAutomatedPhoneControl_put_PhoneHandlingEnabled_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAutomatedPhoneControl_get_PhoneHandlingEnabled_Proxy(
    ITAutomatedPhoneControl *This, VARIANT_BOOL *pfEnabled);
...
HRESULT WINAPI ITAutomatedPhoneControl_put_AutoEndOfNumberTimeout_Proxy(
    ITAutomatedPhoneControl *This, __LONG32 lTimeout);
void __RPC_STUB ITAutomatedPhoneControl_put_AutoEndOfNumberTimeout_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAutomatedPhoneControl_get_AutoEndOfNumberTimeout_Proxy(
    ITAutomatedPhoneControl *This, __LONG32 *plTimeout);
void __RPC_STUB ITAutomatedPhoneControl_get_AutoEndOfNumberTimeout_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAutomatedPhoneControl_put_AutoDialtone_Proxy(
    ITAutomatedPhoneControl *This, VARIANT_BOOL fEnabled);
...
void __RPC_STUB ITAutomatedPhoneControl_get_AutoDialtone_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAutomatedPhoneControl_put_AutoStopTonesOnOnHook_Proxy(
    ITAutomatedPhoneControl *This, VARIANT_BOOL fEnabled);
void __RPC_STUB ITAutomatedPhoneControl_put_AutoStopTonesOnOnHook_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAutomatedPhoneControl_get_AutoStopTonesOnOnHook_Proxy(
    ITAutomatedPhoneControl *This, VARIANT_BOOL *pfEnabled);
void __RPC_STUB ITAutomatedPhoneControl_get_AutoStopTonesOnOnHook_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAutomatedPhoneControl_put_AutoStopRingOnOffHook_Proxy(
    ITAutomatedPhoneControl *This, VARIANT_BOOL fEnabled);
void __RPC_STUB ITAutomatedPhoneControl_put_AutoStopRingOnOffHook_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAutomatedPhoneControl_get_AutoStopRingOnOffHook_Proxy(
    ITAutomatedPhoneControl *This, VARIANT_BOOL *pfEnabled);
void __RPC_STUB ITAutomatedPhoneControl_get_AutoStopRingOnOffHook_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAutomatedPhoneControl_put_AutoKeypadTones_Proxy(
    ITAutomatedPhoneControl *This, VARIANT_BOOL fEnabled);
...
void __RPC_STUB ITAutomatedPhoneControl_put_AutoKeypadTonesMinimumDuration_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAutomatedPhoneControl_get_AutoKeypadTonesMinimumDuration_Proxy(
    ITAutomatedPhoneControl *This, __LONG32 *plDuration);
void __RPC_STUB ITAutomatedPhoneControl_get_AutoKeypadTonesMinimumDuration_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAutomatedPhoneControl_put_AutoVolumeControl_Proxy(
    ITAutomatedPhoneControl *This, VARIANT_BOOL fEnabled);
void __RPC_STUB ITAutomatedPhoneControl_put_AutoVolumeControl_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAutomatedPhoneControl_get_AutoVolumeControl_Proxy(
    ITAutomatedPhoneControl *This, VARIANT_BOOL *fEnabled);
...
HRESULT WINAPI ITAutomatedPhoneControl_put_AutoVolumeControlStep_Proxy(
    ITAutomatedPhoneControl *This, __LONG32 lStepSize);
...
HRESULT WINAPI ITAutomatedPhoneControl_get_AutoVolumeControlStep_Proxy(
    ITAutomatedPhoneControl *This, __LONG32 *plStepSize);
...
void __RPC_STUB ITAutomatedPhoneControl_get_AutoVolumeControlRepeatDelay_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAutomatedPhoneControl_put_AutoVolumeControlRepeatPeriod_Proxy(
    ITAutomatedPhoneControl *This, __LONG32 lPeriod);
...
void __RPC_STUB ITAutomatedPhoneControl_get_AutoVolumeControlRepeatPeriod_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAutomatedPhoneControl_SelectCall_Proxy(
    ITAutomatedPhoneControl *This, ITCallInfo *pCall,
    VARIANT_BOOL fSelectDefaultTerminals);
void __RPC_STUB ITAutomatedPhoneControl_SelectCall_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAutomatedPhoneControl_UnselectCall_Proxy(
    ITAutomatedPhoneControl *This, ITCallInfo *pCall);
void __RPC_STUB ITAutomatedPhoneControl_UnselectCall_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAutomatedPhoneControl_EnumerateSelectedCalls_Proxy(
    ITAutomatedPhoneControl *This, IEnumCall **ppCallEnum);
void __RPC_STUB ITAutomatedPhoneControl_EnumerateSelectedCalls_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAutomatedPhoneControl_get_SelectedCalls_Proxy(
    ITAutomatedPhoneControl *This, VARIANT *pVariant);
...
public:
  ...
  virtual HRESULT WINAPI Conference(ITBasicCallControl *pCall,
                                    VARIANT_BOOL fSync) = 0;
  virtual HRESULT WINAPI Transfer(ITBasicCallControl *pCall,
                                  VARIANT_BOOL fSync) = 0;
  ...
  virtual HRESULT WINAPI SetQOS(__LONG32 lMediaType,
                                QOS_SERVICE_LEVEL ServiceLevel) = 0;
...
typedef struct ITBasicCallControlVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITBasicCallControl *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITBasicCallControl *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITBasicCallControl *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITBasicCallControl *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  ...
  HRESULT(WINAPI *HandoffDirect)(ITBasicCallControl *This,
                                 BSTR pApplicationName);
  HRESULT(WINAPI *HandoffIndirect)(ITBasicCallControl *This,
                                   __LONG32 lMediaType);
  HRESULT(WINAPI *Conference)(ITBasicCallControl *This,
                              ITBasicCallControl *pCall, VARIANT_BOOL fSync);
  HRESULT(WINAPI *Transfer)(ITBasicCallControl *This, ITBasicCallControl *pCall,
                            VARIANT_BOOL fSync);
  HRESULT(WINAPI *BlindTransfer)(ITBasicCallControl *This, BSTR pDestAddress);
  HRESULT(WINAPI *SwapHold)(ITBasicCallControl *This,
                            ITBasicCallControl *pCall);
  HRESULT(WINAPI *ParkDirect)(ITBasicCallControl *This, BSTR pParkAddress);
  HRESULT(WINAPI *ParkIndirect)(ITBasicCallControl *This,
                                BSTR *ppNonDirAddress);
  HRESULT(WINAPI *Unpark)(ITBasicCallControl *This);
  HRESULT(WINAPI *SetQOS)(ITBasicCallControl *This, __LONG32 lMediaType,
...
#define ITBasicCallControl_GetTypeInfo(This, iTInfo, lcid, ppTInfo)            \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITBasicCallControl_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,  \
                                         rgDispId)                             \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITBasicCallControl_Invoke(This, dispIdMember, riid, lcid, wFlags,      \
                                  pDispParams, pVarResult, pExcepInfo,         \
                                  puArgErr)                                    \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI ITBasicCallControl_Connect_Proxy(ITBasicCallControl *This,
                                                VARIANT_BOOL fSync);
...
void __RPC_STUB ITBasicCallControl_Answer_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITBasicCallControl_Disconnect_Proxy(ITBasicCallControl *This,
                                                   DISCONNECT_CODE code);
void __RPC_STUB ITBasicCallControl_Disconnect_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITBasicCallControl_Hold_Proxy(ITBasicCallControl *This,
                                             VARIANT_BOOL fHold);
void __RPC_STUB ITBasicCallControl_Hold_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITBasicCallControl_HandoffDirect_Proxy(ITBasicCallControl *This,
                                                      BSTR pApplicationName);
void __RPC_STUB ITBasicCallControl_HandoffDirect_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITBasicCallControl_HandoffIndirect_Proxy(
    ITBasicCallControl *This, __LONG32 lMediaType);
void __RPC_STUB ITBasicCallControl_HandoffIndirect_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITBasicCallControl_Conference_Proxy(ITBasicCallControl *This,
                                                   ITBasicCallControl *pCall,
                                                   VARIANT_BOOL fSync);
void __RPC_STUB ITBasicCallControl_Conference_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITBasicCallControl_Transfer_Proxy(ITBasicCallControl *This,
                                                 ITBasicCallControl *pCall,
                                                 VARIANT_BOOL fSync);
void __RPC_STUB ITBasicCallControl_Transfer_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITBasicCallControl_BlindTransfer_Proxy(ITBasicCallControl *This,
                                                      BSTR pDestAddress);
void __RPC_STUB ITBasicCallControl_BlindTransfer_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITBasicCallControl_SwapHold_Proxy(ITBasicCallControl *This,
                                                 ITBasicCallControl *pCall);
void __RPC_STUB ITBasicCallControl_SwapHold_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITBasicCallControl_ParkDirect_Proxy(ITBasicCallControl *This,
                                                   BSTR pParkAddress);
void __RPC_STUB ITBasicCallControl_ParkDirect_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITBasicCallControl_ParkIndirect_Proxy(ITBasicCallControl *This,
                                                     BSTR *ppNonDirAddress);
...
void __RPC_STUB ITBasicCallControl_Unpark_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITBasicCallControl_SetQOS_Proxy(ITBasicCallControl *This,
                                               __LONG32 lMediaType,
                                               QOS_SERVICE_LEVEL ServiceLevel);
void __RPC_STUB ITBasicCallControl_SetQOS_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITBasicCallControl_Pickup_Proxy(ITBasicCallControl *This,
                                               BSTR pGroupID);
void __RPC_STUB ITBasicCallControl_Pickup_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITBasicCallControl_Dial_Proxy(ITBasicCallControl *This,
                                             BSTR pDestAddress);
void __RPC_STUB ITBasicCallControl_Dial_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITBasicCallControl_Finish_Proxy(ITBasicCallControl *This,
                                               FINISH_MODE finishMode);
void __RPC_STUB ITBasicCallControl_Finish_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
ITBasicCallControl_RemoveFromConference_Proxy(ITBasicCallControl *This);
...
public:
  ...
  virtual HRESULT WINAPI get_CallInfoLong(CALLINFO_LONG CallInfoLong,
                                          __LONG32 *plCallInfoLongVal) = 0;
  virtual HRESULT WINAPI put_CallInfoLong(CALLINFO_LONG CallInfoLong,
                                          __LONG32 lCallInfoLongVal) = 0;
  virtual HRESULT WINAPI get_CallInfoString(CALLINFO_STRING CallInfoString,
                                            BSTR *ppCallInfoString) = 0;
  virtual HRESULT WINAPI put_CallInfoString(CALLINFO_STRING CallInfoString,
                                            BSTR pCallInfoString) = 0;
  virtual HRESULT WINAPI get_CallInfoBuffer(CALLINFO_BUFFER CallInfoBuffer,
                                            VARIANT *ppCallInfoBuffer) = 0;
  virtual HRESULT WINAPI put_CallInfoBuffer(CALLINFO_BUFFER CallInfoBuffer,
                                            VARIANT pCallInfoBuffer) = 0;
  virtual HRESULT WINAPI GetCallInfoBuffer(CALLINFO_BUFFER CallInfoBuffer,
                                           DWORD *pdwSize,
                                           BYTE **ppCallInfoBuffer) = 0;
  virtual HRESULT WINAPI SetCallInfoBuffer(CALLINFO_BUFFER CallInfoBuffer,
                                           DWORD dwSize,
                                           BYTE *pCallInfoBuffer) = 0;
  virtual HRESULT WINAPI ReleaseUserUserInfo(void) = 0;
};
#else
typedef struct ITCallInfoVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITCallInfo *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITCallInfo *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITCallInfo *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITCallInfo *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  ...
  HRESULT(WINAPI *get_CallInfoLong)(ITCallInfo *This,
                                    CALLINFO_LONG CallInfoLong,
                                    __LONG32 *plCallInfoLongVal);
  HRESULT(WINAPI *put_CallInfoLong)(ITCallInfo *This,
                                    CALLINFO_LONG CallInfoLong,
                                    __LONG32 lCallInfoLongVal);
  HRESULT(WINAPI *get_CallInfoString)(ITCallInfo *This,
                                      CALLINFO_STRING CallInfoString,
                                      BSTR *ppCallInfoString);
  HRESULT(WINAPI *put_CallInfoString)(ITCallInfo *This,
                                      CALLINFO_STRING CallInfoString,
                                      BSTR pCallInfoString);
  HRESULT(WINAPI *get_CallInfoBuffer)(ITCallInfo *This,
                                      CALLINFO_BUFFER CallInfoBuffer,
                                      VARIANT *ppCallInfoBuffer);
  HRESULT(WINAPI *put_CallInfoBuffer)(ITCallInfo *This,
                                      CALLINFO_BUFFER CallInfoBuffer,
                                      VARIANT pCallInfoBuffer);
  HRESULT(WINAPI *GetCallInfoBuffer)(ITCallInfo *This,
                                     CALLINFO_BUFFER CallInfoBuffer,
                                     DWORD *pdwSize, BYTE **ppCallInfoBuffer);
  HRESULT(WINAPI *SetCallInfoBuffer)(ITCallInfo *This,
                                     CALLINFO_BUFFER CallInfoBuffer,
                                     DWORD dwSize, BYTE *pCallInfoBuffer);
...
#define ITCallInfo_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                    \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITCallInfo_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,          \
                                 rgDispId)                                     \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
...
#define ITCallInfo_GetCallInfoBuffer(This, CallInfoBuffer, pdwSize,            \
                                     ppCallInfoBuffer)                         \
  (This)->lpVtbl->GetCallInfoBuffer(This, CallInfoBuffer, pdwSize,             \
                                    ppCallInfoBuffer)
#define ITCallInfo_SetCallInfoBuffer(This, CallInfoBuffer, dwSize,             \
                                     pCallInfoBuffer)                          \
  (This)->lpVtbl->SetCallInfoBuffer(This, CallInfoBuffer, dwSize,              \
                                    pCallInfoBuffer)
#define ITCallInfo_ReleaseUserUserInfo(This)                                   \
  (This)->lpVtbl->ReleaseUserUserInfo(This)
#endif
#endif
HRESULT WINAPI ITCallInfo_get_Address_Proxy(ITCallInfo *This,
                                            ITAddress **ppAddress);
void __RPC_STUB ITCallInfo_get_Address_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITCallInfo_get_CallState_Proxy(ITCallInfo *This,
                                              CALL_STATE *pCallState);
void __RPC_STUB ITCallInfo_get_CallState_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITCallInfo_get_Privilege_Proxy(ITCallInfo *This,
                                              CALL_PRIVILEGE *pPrivilege);
void __RPC_STUB ITCallInfo_get_Privilege_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITCallInfo_get_CallHub_Proxy(ITCallInfo *This,
                                            ITCallHub **ppCallHub);
void __RPC_STUB ITCallInfo_get_CallHub_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITCallInfo_get_CallInfoLong_Proxy(ITCallInfo *This,
                                                 CALLINFO_LONG CallInfoLong,
                                                 __LONG32 *plCallInfoLongVal);
void __RPC_STUB ITCallInfo_get_CallInfoLong_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITCallInfo_put_CallInfoLong_Proxy(ITCallInfo *This,
                                                 CALLINFO_LONG CallInfoLong,
                                                 __LONG32 lCallInfoLongVal);
void __RPC_STUB ITCallInfo_put_CallInfoLong_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITCallInfo_get_CallInfoString_Proxy(
    ITCallInfo *This, CALLINFO_STRING CallInfoString, BSTR *ppCallInfoString);
void __RPC_STUB ITCallInfo_get_CallInfoString_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITCallInfo_put_CallInfoString_Proxy(
    ITCallInfo *This, CALLINFO_STRING CallInfoString, BSTR pCallInfoString);
void __RPC_STUB ITCallInfo_put_CallInfoString_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITCallInfo_get_CallInfoBuffer_Proxy(
    ITCallInfo *This, CALLINFO_BUFFER CallInfoBuffer,
    VARIANT *ppCallInfoBuffer);
void __RPC_STUB ITCallInfo_get_CallInfoBuffer_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITCallInfo_put_CallInfoBuffer_Proxy(
    ITCallInfo *This, CALLINFO_BUFFER CallInfoBuffer, VARIANT pCallInfoBuffer);
void __RPC_STUB ITCallInfo_put_CallInfoBuffer_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITCallInfo_GetCallInfoBuffer_Proxy(
    ITCallInfo *This, CALLINFO_BUFFER CallInfoBuffer, DWORD *pdwSize,
    BYTE **ppCallInfoBuffer);
void __RPC_STUB ITCallInfo_GetCallInfoBuffer_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITCallInfo_SetCallInfoBuffer_Proxy(
    ITCallInfo *This, CALLINFO_BUFFER CallInfoBuffer, DWORD dwSize,
...
typedef struct ITCallInfo2Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITCallInfo2 *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITCallInfo2 *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITCallInfo2 *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITCallInfo2 *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  ...
  HRESULT(WINAPI *get_CallInfoLong)(ITCallInfo2 *This,
                                    CALLINFO_LONG CallInfoLong,
                                    __LONG32 *plCallInfoLongVal);
  HRESULT(WINAPI *put_CallInfoLong)(ITCallInfo2 *This,
                                    CALLINFO_LONG CallInfoLong,
                                    __LONG32 lCallInfoLongVal);
  HRESULT(WINAPI *get_CallInfoString)(ITCallInfo2 *This,
                                      CALLINFO_STRING CallInfoString,
                                      BSTR *ppCallInfoString);
  HRESULT(WINAPI *put_CallInfoString)(ITCallInfo2 *This,
                                      CALLINFO_STRING CallInfoString,
                                      BSTR pCallInfoString);
  HRESULT(WINAPI *get_CallInfoBuffer)(ITCallInfo2 *This,
                                      CALLINFO_BUFFER CallInfoBuffer,
                                      VARIANT *ppCallInfoBuffer);
  HRESULT(WINAPI *put_CallInfoBuffer)(ITCallInfo2 *This,
                                      CALLINFO_BUFFER CallInfoBuffer,
                                      VARIANT pCallInfoBuffer);
  HRESULT(WINAPI *GetCallInfoBuffer)(ITCallInfo2 *This,
                                     CALLINFO_BUFFER CallInfoBuffer,
                                     DWORD *pdwSize, BYTE **ppCallInfoBuffer);
  HRESULT(WINAPI *SetCallInfoBuffer)(ITCallInfo2 *This,
                                     CALLINFO_BUFFER CallInfoBuffer,
                                     DWORD dwSize, BYTE *pCallInfoBuffer);
  HRESULT(WINAPI *ReleaseUserUserInfo)(ITCallInfo2 *This);
  HRESULT(WINAPI *get_EventFilter)(ITCallInfo2 *This, TAPI_EVENT TapiEvent,
                                   __LONG32 lSubEvent, VARIANT_BOOL *pEnable);
  HRESULT(WINAPI *put_EventFilter)(ITCallInfo2 *This, TAPI_EVENT TapiEvent,
                                   __LONG32 lSubEvent, VARIANT_BOOL bEnable);
  END_INTERFACE
} ITCallInfo2Vtbl;
struct ITCallInfo2 {
...
#define ITCallInfo2_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                   \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITCallInfo2_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,         \
                                  rgDispId)                                    \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITCallInfo2_Invoke(This, dispIdMember, riid, lcid, wFlags,             \
                           pDispParams, pVarResult, pExcepInfo, puArgErr)      \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#define ITCallInfo2_put_CallInfoBuffer(This, CallInfoBuffer, pCallInfoBuffer)  \
  (This)->lpVtbl->put_CallInfoBuffer(This, CallInfoBuffer, pCallInfoBuffer)
#define ITCallInfo2_GetCallInfoBuffer(This, CallInfoBuffer, pdwSize,           \
                                      ppCallInfoBuffer)                        \
  (This)->lpVtbl->GetCallInfoBuffer(This, CallInfoBuffer, pdwSize,             \
                                    ppCallInfoBuffer)
#define ITCallInfo2_SetCallInfoBuffer(This, CallInfoBuffer, dwSize,            \
                                      pCallInfoBuffer)                         \
  (This)->lpVtbl->SetCallInfoBuffer(This, CallInfoBuffer, dwSize,              \
                                    pCallInfoBuffer)
...
#endif
#endif
HRESULT WINAPI ITCallInfo2_get_EventFilter_Proxy(ITCallInfo2 *This,
                                                 TAPI_EVENT TapiEvent,
                                                 __LONG32 lSubEvent,
                                                 VARIANT_BOOL *pEnable);
void __RPC_STUB ITCallInfo2_get_EventFilter_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITCallInfo2_put_EventFilter_Proxy(ITCallInfo2 *This,
                                                 TAPI_EVENT TapiEvent,
                                                 __LONG32 lSubEvent,
                                                 VARIANT_BOOL bEnable);
...
typedef struct ITTerminalVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITTerminal *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITTerminal *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITTerminal *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITTerminal *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  ...
  HRESULT(WINAPI *get_Direction)(ITTerminal *This,
                                 TERMINAL_DIRECTION *pDirection);
  END_INTERFACE
} ITTerminalVtbl;
struct ITTerminal {
...
#define ITTerminal_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                    \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITTerminal_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,          \
                                 rgDispId)                                     \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
...
void __RPC_STUB ITTerminal_get_Name_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
HRESULT WINAPI ITTerminal_get_State_Proxy(ITTerminal *This,
                                          TERMINAL_STATE *pTerminalState);
void __RPC_STUB ITTerminal_get_State_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI ITTerminal_get_TerminalType_Proxy(ITTerminal *This,
                                                 TERMINAL_TYPE *pType);
void __RPC_STUB ITTerminal_get_TerminalType_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITTerminal_get_TerminalClass_Proxy(ITTerminal *This,
                                                  BSTR *ppTerminalClass);
void __RPC_STUB ITTerminal_get_TerminalClass_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITTerminal_get_MediaType_Proxy(ITTerminal *This,
                                              __LONG32 *plMediaType);
void __RPC_STUB ITTerminal_get_MediaType_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITTerminal_get_Direction_Proxy(ITTerminal *This,
                                              TERMINAL_DIRECTION *pDirection);
...
public:
  ...
  virtual HRESULT WINAPI
  EnumerateTrackTerminals(IEnumTerminal **ppEnumTerminal) = 0;
  virtual HRESULT WINAPI
  CreateTrackTerminal(__LONG32 MediaType, TERMINAL_DIRECTION TerminalDirection,
                      ITTerminal **ppTerminal) = 0;
  virtual HRESULT WINAPI get_MediaTypesInUse(__LONG32 *plMediaTypesInUse) = 0;
  virtual HRESULT WINAPI
  get_DirectionsInUse(TERMINAL_DIRECTION *plDirectionsInUsed) = 0;
  virtual HRESULT WINAPI
  RemoveTrackTerminal(ITTerminal *pTrackTerminalToRemove) = 0;
};
#else
typedef struct ITMultiTrackTerminalVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITMultiTrackTerminal *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITMultiTrackTerminal *This, UINT iTInfo,
                               LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITMultiTrackTerminal *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITMultiTrackTerminal *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *get_TrackTerminals)(ITMultiTrackTerminal *This,
                                      VARIANT *pVariant);
  HRESULT(WINAPI *EnumerateTrackTerminals)(ITMultiTrackTerminal *This,
                                           IEnumTerminal **ppEnumTerminal);
  HRESULT(WINAPI *CreateTrackTerminal)(ITMultiTrackTerminal *This,
                                       __LONG32 MediaType,
                                       TERMINAL_DIRECTION TerminalDirection,
                                       ITTerminal **ppTerminal);
  HRESULT(WINAPI *get_MediaTypesInUse)(ITMultiTrackTerminal *This,
                                       __LONG32 *plMediaTypesInUse);
  HRESULT(WINAPI *get_DirectionsInUse)(ITMultiTrackTerminal *This,
                                       TERMINAL_DIRECTION *plDirectionsInUsed);
  HRESULT(WINAPI *RemoveTrackTerminal)(ITMultiTrackTerminal *This,
                                       ITTerminal *pTrackTerminalToRemove);
  END_INTERFACE
...
#define ITMultiTrackTerminal_GetTypeInfo(This, iTInfo, lcid, ppTInfo)          \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITMultiTrackTerminal_GetIDsOfNames(This, riid, rgszNames, cNames,      \
                                           lcid, rgDispId)                     \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITMultiTrackTerminal_Invoke(This, dispIdMember, riid, lcid, wFlags,    \
                                    pDispParams, pVarResult, pExcepInfo,       \
                                    puArgErr)                                  \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#define ITMultiTrackTerminal_CreateTrackTerminal(                              \
    This, MediaType, TerminalDirection, ppTerminal)                            \
  (This)->lpVtbl->CreateTrackTerminal(This, MediaType, TerminalDirection,      \
                                      ppTerminal)
...
#endif
#endif
HRESULT WINAPI ITMultiTrackTerminal_get_TrackTerminals_Proxy(
    ITMultiTrackTerminal *This, VARIANT *pVariant);
void __RPC_STUB ITMultiTrackTerminal_get_TrackTerminals_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITMultiTrackTerminal_EnumerateTrackTerminals_Proxy(
    ITMultiTrackTerminal *This, IEnumTerminal **ppEnumTerminal);
void __RPC_STUB ITMultiTrackTerminal_EnumerateTrackTerminals_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITMultiTrackTerminal_CreateTrackTerminal_Proxy(
    ITMultiTrackTerminal *This, __LONG32 MediaType,
    TERMINAL_DIRECTION TerminalDirection, ITTerminal **ppTerminal);
void __RPC_STUB ITMultiTrackTerminal_CreateTrackTerminal_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITMultiTrackTerminal_get_MediaTypesInUse_Proxy(
    ITMultiTrackTerminal *This, __LONG32 *plMediaTypesInUse);
void __RPC_STUB ITMultiTrackTerminal_get_MediaTypesInUse_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITMultiTrackTerminal_get_DirectionsInUse_Proxy(
    ITMultiTrackTerminal *This, TERMINAL_DIRECTION *plDirectionsInUsed);
void __RPC_STUB ITMultiTrackTerminal_get_DirectionsInUse_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITMultiTrackTerminal_RemoveTrackTerminal_Proxy(
    ITMultiTrackTerminal *This, ITTerminal *pTrackTerminalToRemove);
...
public:
  ...
  virtual HRESULT WINAPI
  get_ControllingTerminal(ITTerminal **ppControllingTerminal) = 0;
  virtual HRESULT WINAPI
  get_AudioFormatForScripting(ITScriptableAudioFormat **ppAudioFormat) = 0;
  virtual HRESULT WINAPI
  put_AudioFormatForScripting(ITScriptableAudioFormat *pAudioFormat) = 0;
  virtual HRESULT WINAPI
  get_EmptyAudioFormatForScripting(ITScriptableAudioFormat **ppAudioFormat) = 0;
};
#else
typedef struct ITFileTrackVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITFileTrack *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITFileTrack *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITFileTrack *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITFileTrack *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  ...
  HRESULT(WINAPI *get_ControllingTerminal)(ITFileTrack *This,
                                           ITTerminal **ppControllingTerminal);
  HRESULT(WINAPI *get_AudioFormatForScripting)(
      ITFileTrack *This, ITScriptableAudioFormat **ppAudioFormat);
  HRESULT(WINAPI *put_AudioFormatForScripting)(
      ITFileTrack *This, ITScriptableAudioFormat *pAudioFormat);
  HRESULT(WINAPI *get_EmptyAudioFormatForScripting)(
      ITFileTrack *This, ITScriptableAudioFormat **ppAudioFormat);
  END_INTERFACE
} ITFileTrackVtbl;
struct ITFileTrack {
...
#define ITFileTrack_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                   \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITFileTrack_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,         \
                                  rgDispId)                                    \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITFileTrack_Invoke(This, dispIdMember, riid, lcid, wFlags,             \
                           pDispParams, pVarResult, pExcepInfo, puArgErr)      \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI ITFileTrack_get_Format_Proxy(ITFileTrack *This,
                                            AM_MEDIA_TYPE **ppmt);
void __RPC_STUB ITFileTrack_get_Format_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITFileTrack_put_Format_Proxy(ITFileTrack *This,
                                            const AM_MEDIA_TYPE *pmt);
void __RPC_STUB ITFileTrack_put_Format_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITFileTrack_get_ControllingTerminal_Proxy(
    ITFileTrack *This, ITTerminal **ppControllingTerminal);
void __RPC_STUB ITFileTrack_get_ControllingTerminal_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITFileTrack_get_AudioFormatForScripting_Proxy(
    ITFileTrack *This, ITScriptableAudioFormat **ppAudioFormat);
void __RPC_STUB ITFileTrack_get_AudioFormatForScripting_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITFileTrack_put_AudioFormatForScripting_Proxy(
    ITFileTrack *This, ITScriptableAudioFormat *pAudioFormat);
void __RPC_STUB ITFileTrack_put_AudioFormatForScripting_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITFileTrack_get_EmptyAudioFormatForScripting_Proxy(
    ITFileTrack *This, ITScriptableAudioFormat **ppAudioFormat);
...
typedef struct ITMediaPlaybackVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITMediaPlayback *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITMediaPlayback *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITMediaPlayback *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITMediaPlayback *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *put_PlayList)(ITMediaPlayback *This,
                                VARIANTARG PlayListVariant);
  HRESULT(WINAPI *get_PlayList)(ITMediaPlayback *This,
                                VARIANTARG *pPlayListVariant);
  END_INTERFACE
} ITMediaPlaybackVtbl;
...
#define ITMediaPlayback_GetTypeInfo(This, iTInfo, lcid, ppTInfo)               \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITMediaPlayback_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,     \
                                      rgDispId)                                \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITMediaPlayback_Invoke(This, dispIdMember, riid, lcid, wFlags,         \
                               pDispParams, pVarResult, pExcepInfo, puArgErr)  \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI ITMediaPlayback_put_PlayList_Proxy(ITMediaPlayback *This,
                                                  VARIANTARG PlayListVariant);
void __RPC_STUB ITMediaPlayback_put_PlayList_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITMediaPlayback_get_PlayList_Proxy(ITMediaPlayback *This,
                                                  VARIANTARG *pPlayListVariant);
...
typedef struct ITMediaRecordVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITMediaRecord *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITMediaRecord *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITMediaRecord *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITMediaRecord *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
...
#define ITMediaRecord_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                 \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITMediaRecord_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,       \
                                    rgDispId)                                  \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITMediaRecord_Invoke(This, dispIdMember, riid, lcid, wFlags,           \
                             pDispParams, pVarResult, pExcepInfo, puArgErr)    \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI ITMediaRecord_put_FileName_Proxy(ITMediaRecord *This,
                                                BSTR bstrFileName);
void __RPC_STUB ITMediaRecord_put_FileName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITMediaRecord_get_FileName_Proxy(ITMediaRecord *This,
                                                BSTR *pbstrFileName);
...
public:
  ...
  virtual HRESULT WINAPI
  get_MediaState(TERMINAL_MEDIA_STATE *pTerminalMediaState) = 0;
};
#else
typedef struct ITMediaControlVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITMediaControl *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITMediaControl *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITMediaControl *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITMediaControl *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  ...
  HRESULT(WINAPI *get_MediaState)(ITMediaControl *This,
                                  TERMINAL_MEDIA_STATE *pTerminalMediaState);
  END_INTERFACE
} ITMediaControlVtbl;
...
#define ITMediaControl_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITMediaControl_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,      \
                                     rgDispId)                                 \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITMediaControl_Invoke(This, dispIdMember, riid, lcid, wFlags,          \
                              pDispParams, pVarResult, pExcepInfo, puArgErr)   \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
void __RPC_STUB ITMediaControl_Start_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI ITMediaControl_Stop_Proxy(ITMediaControl *This);
void __RPC_STUB ITMediaControl_Stop_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
HRESULT WINAPI ITMediaControl_Pause_Proxy(ITMediaControl *This);
void __RPC_STUB ITMediaControl_Pause_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI ITMediaControl_get_MediaState_Proxy(
    ITMediaControl *This, TERMINAL_MEDIA_STATE *pTerminalMediaState);
...
typedef struct ITBasicAudioTerminalVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITBasicAudioTerminal *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITBasicAudioTerminal *This, UINT iTInfo,
                               LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITBasicAudioTerminal *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITBasicAudioTerminal *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
...
#define ITBasicAudioTerminal_GetTypeInfo(This, iTInfo, lcid, ppTInfo)          \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITBasicAudioTerminal_GetIDsOfNames(This, riid, rgszNames, cNames,      \
                                           lcid, rgDispId)                     \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITBasicAudioTerminal_Invoke(This, dispIdMember, riid, lcid, wFlags,    \
                                    pDispParams, pVarResult, pExcepInfo,       \
                                    puArgErr)                                  \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI ITBasicAudioTerminal_put_Volume_Proxy(ITBasicAudioTerminal *This,
                                                     __LONG32 lVolume);
void __RPC_STUB ITBasicAudioTerminal_put_Volume_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITBasicAudioTerminal_get_Volume_Proxy(ITBasicAudioTerminal *This,
                                                     __LONG32 *plVolume);
void __RPC_STUB ITBasicAudioTerminal_get_Volume_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITBasicAudioTerminal_put_Balance_Proxy(
    ITBasicAudioTerminal *This, __LONG32 lBalance);
void __RPC_STUB ITBasicAudioTerminal_put_Balance_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITBasicAudioTerminal_get_Balance_Proxy(
    ITBasicAudioTerminal *This, __LONG32 *plBalance);
...
typedef struct ITStaticAudioTerminalVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITStaticAudioTerminal *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITStaticAudioTerminal *This, UINT iTInfo,
                               LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITStaticAudioTerminal *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITStaticAudioTerminal *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
...
#define ITStaticAudioTerminal_GetTypeInfo(This, iTInfo, lcid, ppTInfo)         \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITStaticAudioTerminal_GetIDsOfNames(This, riid, rgszNames, cNames,     \
                                            lcid, rgDispId)                    \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITStaticAudioTerminal_Invoke(This, dispIdMember, riid, lcid, wFlags,   \
                                     pDispParams, pVarResult, pExcepInfo,      \
                                     puArgErr)                                 \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
HRESULT
    WINAPI ITStaticAudioTerminal_get_WaveId_Proxy(ITStaticAudioTerminal *This,
                                                  __LONG32 *plWaveId);
...
typedef struct ITCallHubVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITCallHub *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITCallHub *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITCallHub *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITCallHub *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
...
void __RPC_STUB ITCallHub_Clear_Stub(IRpcStubBuffer *This,
                                     IRpcChannelBuffer *_pRpcChannelBuffer,
                                     PRPC_MESSAGE _pRpcMessage,
                                     DWORD *_pdwStubPhase);
HRESULT WINAPI ITCallHub_EnumerateCalls_Proxy(ITCallHub *This,
...
void __RPC_STUB ITCallHub_get_Calls_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
...
void __RPC_STUB ITCallHub_get_NumCalls_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITCallHub_get_State_Proxy(ITCallHub *This,
                                         CALLHUB_STATE *pState);
void __RPC_STUB ITCallHub_get_State_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
#endif
...
public:
  virtual HRESULT WINAPI GetID(BSTR pDeviceClass, DWORD *pdwSize,
                               BYTE **ppDeviceID) = 0;
  virtual HRESULT WINAPI GetDevConfig(BSTR pDeviceClass, DWORD *pdwSize,
                                      BYTE **ppDeviceConfig) = 0;
  virtual HRESULT WINAPI SetDevConfig(BSTR pDeviceClass, DWORD dwSize,
                                      BYTE *pDeviceConfig) = 0;
};
#else
typedef struct ITLegacyAddressMediaControlVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITLegacyAddressMediaControl *This,
                                  REFIID riid, void **ppvObject);
  ULONG(WINAPI *AddRef)(ITLegacyAddressMediaControl *This);
  ULONG(WINAPI *Release)(ITLegacyAddressMediaControl *This);
  HRESULT(WINAPI *GetID)(ITLegacyAddressMediaControl *This, BSTR pDeviceClass,
                         DWORD *pdwSize, BYTE **ppDeviceID);
  HRESULT(WINAPI *GetDevConfig)(ITLegacyAddressMediaControl *This,
                                BSTR pDeviceClass, DWORD *pdwSize,
                                BYTE **ppDeviceConfig);
  HRESULT(WINAPI *SetDevConfig)(ITLegacyAddressMediaControl *This,
                                BSTR pDeviceClass, DWORD dwSize,
                                BYTE *pDeviceConfig);
  END_INTERFACE
...
#define ITLegacyAddressMediaControl_GetID(This, pDeviceClass, pdwSize,         \
                                          ppDeviceID)                          \
  (This)->lpVtbl->GetID(This, pDeviceClass, pdwSize, ppDeviceID)
#define ITLegacyAddressMediaControl_GetDevConfig(This, pDeviceClass, pdwSize,  \
                                                 ppDeviceConfig)               \
  (This)->lpVtbl->GetDevConfig(This, pDeviceClass, pdwSize, ppDeviceConfig)
#define ITLegacyAddressMediaControl_SetDevConfig(This, pDeviceClass, dwSize,   \
                                                 pDeviceConfig)                \
  (This)->lpVtbl->SetDevConfig(This, pDeviceClass, dwSize, pDeviceConfig)
#endif
#endif
HRESULT WINAPI ITLegacyAddressMediaControl_GetID_Proxy(
    ITLegacyAddressMediaControl *This, BSTR pDeviceClass, DWORD *pdwSize,
    BYTE **ppDeviceID);
void __RPC_STUB ITLegacyAddressMediaControl_GetID_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITLegacyAddressMediaControl_GetDevConfig_Proxy(
    ITLegacyAddressMediaControl *This, BSTR pDeviceClass, DWORD *pdwSize,
    BYTE **ppDeviceConfig);
void __RPC_STUB ITLegacyAddressMediaControl_GetDevConfig_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITLegacyAddressMediaControl_SetDevConfig_Proxy(
    ITLegacyAddressMediaControl *This, BSTR pDeviceClass, DWORD dwSize,
    BYTE *pDeviceConfig);
...
typedef struct ITPrivateEventVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITPrivateEvent *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITPrivateEvent *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITPrivateEvent *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITPrivateEvent *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  ...
  HRESULT(WINAPI *get_EventInterface)(ITPrivateEvent *This,
...
#define ITPrivateEvent_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITPrivateEvent_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,      \
                                     rgDispId)                                 \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITPrivateEvent_Invoke(This, dispIdMember, riid, lcid, wFlags,          \
                              pDispParams, pVarResult, pExcepInfo, puArgErr)   \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI ITPrivateEvent_get_Address_Proxy(ITPrivateEvent *This,
                                                ITAddress **ppAddress);
void __RPC_STUB ITPrivateEvent_get_Address_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPrivateEvent_get_Call_Proxy(ITPrivateEvent *This,
                                             ITCallInfo **ppCallInfo);
void __RPC_STUB ITPrivateEvent_get_Call_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPrivateEvent_get_CallHub_Proxy(ITPrivateEvent *This,
                                                ITCallHub **ppCallHub);
void __RPC_STUB ITPrivateEvent_get_CallHub_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPrivateEvent_get_EventCode_Proxy(ITPrivateEvent *This,
                                                  __LONG32 *plEventCode);
void __RPC_STUB ITPrivateEvent_get_EventCode_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPrivateEvent_get_EventInterface_Proxy(
    ITPrivateEvent *This, IDispatch **pEventInterface);
...
public:
  ...
  virtual HRESULT WINAPI ConfigDialogEdit(HWND hwndOwner, BSTR pDeviceClass,
                                          DWORD dwSizeIn, BYTE *pDeviceConfigIn,
                                          DWORD *pdwSizeOut,
                                          BYTE **ppDeviceConfigOut) = 0;
};
#else
typedef struct ITLegacyAddressMediaControl2Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITLegacyAddressMediaControl2 *This,
                                  REFIID riid, void **ppvObject);
  ULONG(WINAPI *AddRef)(ITLegacyAddressMediaControl2 *This);
  ULONG(WINAPI *Release)(ITLegacyAddressMediaControl2 *This);
  HRESULT(WINAPI *GetID)(ITLegacyAddressMediaControl2 *This, BSTR pDeviceClass,
                         DWORD *pdwSize, BYTE **ppDeviceID);
  HRESULT(WINAPI *GetDevConfig)(ITLegacyAddressMediaControl2 *This,
                                BSTR pDeviceClass, DWORD *pdwSize,
                                BYTE **ppDeviceConfig);
  HRESULT(WINAPI *SetDevConfig)(ITLegacyAddressMediaControl2 *This,
                                BSTR pDeviceClass, DWORD dwSize,
                                BYTE *pDeviceConfig);
  HRESULT(WINAPI *ConfigDialog)(ITLegacyAddressMediaControl2 *This,
                                HWND hwndOwner, BSTR pDeviceClass);
  HRESULT(WINAPI *ConfigDialogEdit)(ITLegacyAddressMediaControl2 *This,
                                    HWND hwndOwner, BSTR pDeviceClass,
                                    DWORD dwSizeIn, BYTE *pDeviceConfigIn,
                                    DWORD *pdwSizeOut,
...
#define ITLegacyAddressMediaControl2_GetID(This, pDeviceClass, pdwSize,        \
                                           ppDeviceID)                         \
  (This)->lpVtbl->GetID(This, pDeviceClass, pdwSize, ppDeviceID)
#define ITLegacyAddressMediaControl2_GetDevConfig(This, pDeviceClass, pdwSize, \
                                                  ppDeviceConfig)              \
  (This)->lpVtbl->GetDevConfig(This, pDeviceClass, pdwSize, ppDeviceConfig)
#define ITLegacyAddressMediaControl2_SetDevConfig(This, pDeviceClass, dwSize,  \
                                                  pDeviceConfig)               \
  (This)->lpVtbl->SetDevConfig(This, pDeviceClass, dwSize, pDeviceConfig)
#define ITLegacyAddressMediaControl2_ConfigDialog(This, hwndOwner,             \
                                                  pDeviceClass)                \
  (This)->lpVtbl->ConfigDialog(This, hwndOwner, pDeviceClass)
#define ITLegacyAddressMediaControl2_ConfigDialogEdit(                         \
    This, hwndOwner, pDeviceClass, dwSizeIn, pDeviceConfigIn, pdwSizeOut,      \
    ppDeviceConfigOut)                                                         \
  (This)->lpVtbl->ConfigDialogEdit(This, hwndOwner, pDeviceClass, dwSizeIn,    \
                                   pDeviceConfigIn, pdwSizeOut,                \
                                   ppDeviceConfigOut)
#endif
#endif
HRESULT WINAPI ITLegacyAddressMediaControl2_ConfigDialog_Proxy(
    ITLegacyAddressMediaControl2 *This, HWND hwndOwner, BSTR pDeviceClass);
...
HRESULT WINAPI ITLegacyAddressMediaControl2_ConfigDialogEdit_Proxy(
    ITLegacyAddressMediaControl2 *This, HWND hwndOwner, BSTR pDeviceClass,
    DWORD dwSizeIn, BYTE *pDeviceConfigIn, DWORD *pdwSizeOut,
    BYTE **ppDeviceConfigOut);
...
public:
  ...
  virtual HRESULT WINAPI GenerateDigits(BSTR pDigits,
                                        TAPI_DIGITMODE DigitMode) = 0;
  virtual HRESULT WINAPI GetID(BSTR pDeviceClass, DWORD *pdwSize,
                               BYTE **ppDeviceID) = 0;
...
typedef struct ITLegacyCallMediaControlVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITLegacyCallMediaControl *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ITLegacyCallMediaControl *This);
  ULONG(WINAPI *Release)(ITLegacyCallMediaControl *This);
  HRESULT(WINAPI *GetTypeInfoCount)(ITLegacyCallMediaControl *This,
                                    UINT *pctinfo);
  HRESULT(WINAPI *GetTypeInfo)(ITLegacyCallMediaControl *This, UINT iTInfo,
                               LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITLegacyCallMediaControl *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITLegacyCallMediaControl *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *DetectDigits)(ITLegacyCallMediaControl *This,
                                TAPI_DIGITMODE DigitMode);
  HRESULT(WINAPI *GenerateDigits)(ITLegacyCallMediaControl *This, BSTR pDigits,
                                  TAPI_DIGITMODE DigitMode);
  HRESULT(WINAPI *GetID)(ITLegacyCallMediaControl *This, BSTR pDeviceClass,
                         DWORD *pdwSize, BYTE **ppDeviceID);
  HRESULT(WINAPI *SetMediaType)(ITLegacyCallMediaControl *This,
                                __LONG32 lMediaType);
  HRESULT(WINAPI *MonitorMedia)(ITLegacyCallMediaControl *This,
                                __LONG32 lMediaType);
  END_INTERFACE
...
#define ITLegacyCallMediaControl_GetTypeInfo(This, iTInfo, lcid, ppTInfo)      \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITLegacyCallMediaControl_GetIDsOfNames(This, riid, rgszNames, cNames,  \
                                               lcid, rgDispId)                 \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITLegacyCallMediaControl_Invoke(This, dispIdMember, riid, lcid,        \
                                        wFlags, pDispParams, pVarResult,       \
                                        pExcepInfo, puArgErr)                  \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#define ITLegacyCallMediaControl_GetID(This, pDeviceClass, pdwSize,            \
                                       ppDeviceID)                             \
  (This)->lpVtbl->GetID(This, pDeviceClass, pdwSize, ppDeviceID)
...
#endif
#endif
HRESULT WINAPI ITLegacyCallMediaControl_DetectDigits_Proxy(
    ITLegacyCallMediaControl *This, TAPI_DIGITMODE DigitMode);
void __RPC_STUB ITLegacyCallMediaControl_DetectDigits_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITLegacyCallMediaControl_GenerateDigits_Proxy(
    ITLegacyCallMediaControl *This, BSTR pDigits, TAPI_DIGITMODE DigitMode);
void __RPC_STUB ITLegacyCallMediaControl_GenerateDigits_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITLegacyCallMediaControl_GetID_Proxy(
    ITLegacyCallMediaControl *This, BSTR pDeviceClass, DWORD *pdwSize,
    BYTE **ppDeviceID);
void __RPC_STUB ITLegacyCallMediaControl_GetID_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITLegacyCallMediaControl_SetMediaType_Proxy(
    ITLegacyCallMediaControl *This, __LONG32 lMediaType);
...
public:
  virtual HRESULT WINAPI GenerateDigits2(BSTR pDigits, TAPI_DIGITMODE DigitMode,
                                         __LONG32 lDuration) = 0;
  virtual HRESULT WINAPI GatherDigits(TAPI_DIGITMODE DigitMode,
                                      __LONG32 lNumDigits,
                                      BSTR pTerminationDigits,
                                      __LONG32 lFirstDigitTimeout,
                                      __LONG32 lInterDigitTimeout) = 0;
  virtual HRESULT WINAPI DetectTones(TAPI_DETECTTONE *pToneList,
                                     __LONG32 lNumTones) = 0;
  virtual HRESULT WINAPI
  DetectTonesByCollection(ITCollection2 *pDetectToneCollection) = 0;
  virtual HRESULT WINAPI GenerateTone(TAPI_TONEMODE ToneMode,
                                      __LONG32 lDuration) = 0;
  virtual HRESULT WINAPI GenerateCustomTones(TAPI_CUSTOMTONE *pToneList,
                                             __LONG32 lNumTones,
                                             __LONG32 lDuration) = 0;
  virtual HRESULT WINAPI GenerateCustomTonesByCollection(
      ITCollection2 *pCustomToneCollection, __LONG32 lDuration) = 0;
  virtual HRESULT WINAPI
  CreateDetectToneObject(ITDetectTone **ppDetectTone) = 0;
  virtual HRESULT WINAPI
  CreateCustomToneObject(ITCustomTone **ppCustomTone) = 0;
  virtual HRESULT WINAPI GetIDAsVariant(BSTR bstrDeviceClass,
                                        VARIANT *pVarDeviceID) = 0;
};
#else
typedef struct ITLegacyCallMediaControl2Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITLegacyCallMediaControl2 *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ITLegacyCallMediaControl2 *This);
  ULONG(WINAPI *Release)(ITLegacyCallMediaControl2 *This);
  HRESULT(WINAPI *GetTypeInfoCount)(ITLegacyCallMediaControl2 *This,
                                    UINT *pctinfo);
  HRESULT(WINAPI *GetTypeInfo)(ITLegacyCallMediaControl2 *This, UINT iTInfo,
                               LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITLegacyCallMediaControl2 *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITLegacyCallMediaControl2 *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *DetectDigits)(ITLegacyCallMediaControl2 *This,
                                TAPI_DIGITMODE DigitMode);
  HRESULT(WINAPI *GenerateDigits)(ITLegacyCallMediaControl2 *This, BSTR pDigits,
                                  TAPI_DIGITMODE DigitMode);
  HRESULT(WINAPI *GetID)(ITLegacyCallMediaControl2 *This, BSTR pDeviceClass,
                         DWORD *pdwSize, BYTE **ppDeviceID);
  HRESULT(WINAPI *SetMediaType)(ITLegacyCallMediaControl2 *This,
                                __LONG32 lMediaType);
  HRESULT(WINAPI *MonitorMedia)(ITLegacyCallMediaControl2 *This,
                                __LONG32 lMediaType);
  HRESULT(WINAPI *GenerateDigits2)(ITLegacyCallMediaControl2 *This,
                                   BSTR pDigits, TAPI_DIGITMODE DigitMode,
                                   __LONG32 lDuration);
  HRESULT(WINAPI *GatherDigits)(ITLegacyCallMediaControl2 *This,
                                TAPI_DIGITMODE DigitMode, __LONG32 lNumDigits,
                                BSTR pTerminationDigits,
                                __LONG32 lFirstDigitTimeout,
                                __LONG32 lInterDigitTimeout);
  HRESULT(WINAPI *DetectTones)(ITLegacyCallMediaControl2 *This,
                               TAPI_DETECTTONE *pToneList, __LONG32 lNumTones);
  HRESULT(WINAPI *DetectTonesByCollection)(
      ITLegacyCallMediaControl2 *This, ITCollection2 *pDetectToneCollection);
  HRESULT(WINAPI *GenerateTone)(ITLegacyCallMediaControl2 *This,
                                TAPI_TONEMODE ToneMode, __LONG32 lDuration);
  HRESULT(WINAPI *GenerateCustomTones)(ITLegacyCallMediaControl2 *This,
                                       TAPI_CUSTOMTONE *pToneList,
                                       __LONG32 lNumTones, __LONG32 lDuration);
  HRESULT(WINAPI *GenerateCustomTonesByCollection)(
      ITLegacyCallMediaControl2 *This, ITCollection2 *pCustomToneCollection,
      __LONG32 lDuration);
  HRESULT(WINAPI *CreateDetectToneObject)(ITLegacyCallMediaControl2 *This,
                                          ITDetectTone **ppDetectTone);
  HRESULT(WINAPI *CreateCustomToneObject)(ITLegacyCallMediaControl2 *This,
                                          ITCustomTone **ppCustomTone);
  HRESULT(WINAPI *GetIDAsVariant)(ITLegacyCallMediaControl2 *This,
                                  BSTR bstrDeviceClass, VARIANT *pVarDeviceID);
  END_INTERFACE
...
#define ITLegacyCallMediaControl2_GetTypeInfo(This, iTInfo, lcid, ppTInfo)     \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITLegacyCallMediaControl2_GetIDsOfNames(This, riid, rgszNames, cNames, \
                                                lcid, rgDispId)                \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITLegacyCallMediaControl2_Invoke(This, dispIdMember, riid, lcid,       \
                                         wFlags, pDispParams, pVarResult,      \
                                         pExcepInfo, puArgErr)                 \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#define ITLegacyCallMediaControl2_GenerateDigits(This, pDigits, DigitMode)     \
  (This)->lpVtbl->GenerateDigits(This, pDigits, DigitMode)
#define ITLegacyCallMediaControl2_GetID(This, pDeviceClass, pdwSize,           \
                                        ppDeviceID)                            \
  (This)->lpVtbl->GetID(This, pDeviceClass, pdwSize, ppDeviceID)
...
#define ITLegacyCallMediaControl2_MonitorMedia(This, lMediaType)               \
  (This)->lpVtbl->MonitorMedia(This, lMediaType)
#define ITLegacyCallMediaControl2_GenerateDigits2(This, pDigits, DigitMode,    \
                                                  lDuration)                   \
  (This)->lpVtbl->GenerateDigits2(This, pDigits, DigitMode, lDuration)
#define ITLegacyCallMediaControl2_GatherDigits(                                \
    This, DigitMode, lNumDigits, pTerminationDigits, lFirstDigitTimeout,       \
    lInterDigitTimeout)                                                        \
  (This)->lpVtbl->GatherDigits(This, DigitMode, lNumDigits,                    \
                               pTerminationDigits, lFirstDigitTimeout,         \
                               lInterDigitTimeout)
#define ITLegacyCallMediaControl2_DetectTones(This, pToneList, lNumTones)      \
  (This)->lpVtbl->DetectTones(This, pToneList, lNumTones)
#define ITLegacyCallMediaControl2_DetectTonesByCollection(                     \
    This, pDetectToneCollection)                                               \
...
#define ITLegacyCallMediaControl2_GenerateCustomTones(This, pToneList,         \
                                                      lNumTones, lDuration)    \
  (This)->lpVtbl->GenerateCustomTones(This, pToneList, lNumTones, lDuration)
#define ITLegacyCallMediaControl2_GenerateCustomTonesByCollection(             \
    This, pCustomToneCollection, lDuration)                                    \
  (This)->lpVtbl->GenerateCustomTonesByCollection(This, pCustomToneCollection, \
                                                  lDuration)
...
#define ITLegacyCallMediaControl2_GetIDAsVariant(This, bstrDeviceClass,        \
                                                 pVarDeviceID)                 \
  (This)->lpVtbl->GetIDAsVariant(This, bstrDeviceClass, pVarDeviceID)
#endif
#endif
HRESULT WINAPI ITLegacyCallMediaControl2_GenerateDigits2_Proxy(
    ITLegacyCallMediaControl2 *This, BSTR pDigits, TAPI_DIGITMODE DigitMode,
    __LONG32 lDuration);
void __RPC_STUB ITLegacyCallMediaControl2_GenerateDigits2_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITLegacyCallMediaControl2_GatherDigits_Proxy(
    ITLegacyCallMediaControl2 *This, TAPI_DIGITMODE DigitMode,
    __LONG32 lNumDigits, BSTR pTerminationDigits, __LONG32 lFirstDigitTimeout,
    __LONG32 lInterDigitTimeout);
void __RPC_STUB ITLegacyCallMediaControl2_GatherDigits_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITLegacyCallMediaControl2_DetectTones_Proxy(
    ITLegacyCallMediaControl2 *This, TAPI_DETECTTONE *pToneList,
    __LONG32 lNumTones);
void __RPC_STUB ITLegacyCallMediaControl2_DetectTones_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITLegacyCallMediaControl2_DetectTonesByCollection_Proxy(
    ITLegacyCallMediaControl2 *This, ITCollection2 *pDetectToneCollection);
void __RPC_STUB ITLegacyCallMediaControl2_DetectTonesByCollection_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITLegacyCallMediaControl2_GenerateTone_Proxy(
    ITLegacyCallMediaControl2 *This, TAPI_TONEMODE ToneMode,
    __LONG32 lDuration);
void __RPC_STUB ITLegacyCallMediaControl2_GenerateTone_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITLegacyCallMediaControl2_GenerateCustomTones_Proxy(
    ITLegacyCallMediaControl2 *This, TAPI_CUSTOMTONE *pToneList,
    __LONG32 lNumTones, __LONG32 lDuration);
void __RPC_STUB ITLegacyCallMediaControl2_GenerateCustomTones_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITLegacyCallMediaControl2_GenerateCustomTonesByCollection_Proxy(
    ITLegacyCallMediaControl2 *This, ITCollection2 *pCustomToneCollection,
    __LONG32 lDuration);
void __RPC_STUB ITLegacyCallMediaControl2_GenerateCustomTonesByCollection_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITLegacyCallMediaControl2_CreateDetectToneObject_Proxy(
    ITLegacyCallMediaControl2 *This, ITDetectTone **ppDetectTone);
void __RPC_STUB ITLegacyCallMediaControl2_CreateDetectToneObject_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITLegacyCallMediaControl2_CreateCustomToneObject_Proxy(
    ITLegacyCallMediaControl2 *This, ITCustomTone **ppCustomTone);
void __RPC_STUB ITLegacyCallMediaControl2_CreateCustomToneObject_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITLegacyCallMediaControl2_GetIDAsVariant_Proxy(
    ITLegacyCallMediaControl2 *This, BSTR bstrDeviceClass,
    VARIANT *pVarDeviceID);
...
public:
  ...
  virtual HRESULT WINAPI get_Frequency(__LONG32 Index,
                                       __LONG32 *plFrequency) = 0;
  virtual HRESULT WINAPI put_Frequency(__LONG32 Index, __LONG32 lFrequency) = 0;
};
#else
typedef struct ITDetectToneVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITDetectTone *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITDetectTone *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITDetectTone *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITDetectTone *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  ...
  HRESULT(WINAPI *get_Frequency)(ITDetectTone *This, __LONG32 Index,
                                 __LONG32 *plFrequency);
  HRESULT(WINAPI *put_Frequency)(ITDetectTone *This, __LONG32 Index,
                                 __LONG32 lFrequency);
  END_INTERFACE
} ITDetectToneVtbl;
struct ITDetectTone {
...
#define ITDetectTone_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                  \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITDetectTone_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,        \
                                   rgDispId)                                   \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITDetectTone_Invoke(This, dispIdMember, riid, lcid, wFlags,            \
                            pDispParams, pVarResult, pExcepInfo, puArgErr)     \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI ITDetectTone_get_AppSpecific_Proxy(ITDetectTone *This,
                                                  __LONG32 *plAppSpecific);
void __RPC_STUB ITDetectTone_get_AppSpecific_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITDetectTone_put_AppSpecific_Proxy(ITDetectTone *This,
                                                  __LONG32 lAppSpecific);
void __RPC_STUB ITDetectTone_put_AppSpecific_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITDetectTone_get_Duration_Proxy(ITDetectTone *This,
                                               __LONG32 *plDuration);
void __RPC_STUB ITDetectTone_get_Duration_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITDetectTone_put_Duration_Proxy(ITDetectTone *This,
                                               __LONG32 lDuration);
void __RPC_STUB ITDetectTone_put_Duration_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITDetectTone_get_Frequency_Proxy(ITDetectTone *This,
                                                __LONG32 Index,
                                                __LONG32 *plFrequency);
void __RPC_STUB ITDetectTone_get_Frequency_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITDetectTone_put_Frequency_Proxy(ITDetectTone *This,
                                                __LONG32 Index,
                                                __LONG32 lFrequency);
...
typedef struct ITCustomToneVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITCustomTone *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITCustomTone *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITCustomTone *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITCustomTone *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
...
#define ITCustomTone_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                  \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITCustomTone_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,        \
                                   rgDispId)                                   \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITCustomTone_Invoke(This, dispIdMember, riid, lcid, wFlags,            \
                            pDispParams, pVarResult, pExcepInfo, puArgErr)     \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI ITCustomTone_get_Frequency_Proxy(ITCustomTone *This,
                                                __LONG32 *plFrequency);
void __RPC_STUB ITCustomTone_get_Frequency_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITCustomTone_put_Frequency_Proxy(ITCustomTone *This,
                                                __LONG32 lFrequency);
void __RPC_STUB ITCustomTone_put_Frequency_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITCustomTone_get_CadenceOn_Proxy(ITCustomTone *This,
                                                __LONG32 *plCadenceOn);
void __RPC_STUB ITCustomTone_get_CadenceOn_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITCustomTone_put_CadenceOn_Proxy(ITCustomTone *This,
                                                __LONG32 CadenceOn);
void __RPC_STUB ITCustomTone_put_CadenceOn_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITCustomTone_get_CadenceOff_Proxy(ITCustomTone *This,
                                                 __LONG32 *plCadenceOff);
void __RPC_STUB ITCustomTone_get_CadenceOff_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITCustomTone_put_CadenceOff_Proxy(ITCustomTone *This,
                                                 __LONG32 lCadenceOff);
void __RPC_STUB ITCustomTone_put_CadenceOff_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITCustomTone_get_Volume_Proxy(ITCustomTone *This,
                                             __LONG32 *plVolume);
void __RPC_STUB ITCustomTone_get_Volume_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITCustomTone_put_Volume_Proxy(ITCustomTone *This,
                                             __LONG32 lVolume);
...
public:
  virtual HRESULT WINAPI Next(ULONG celt, ITPhone **ppElements,
...
typedef struct IEnumPhoneVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IEnumPhone *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IEnumPhone *This);
  ULONG(WINAPI *Release)(IEnumPhone *This);
  HRESULT(WINAPI *Next)(IEnumPhone *This, ULONG celt, ITPhone **ppElements,
                        ULONG *pceltFetched);
...
#endif
#endif
HRESULT WINAPI IEnumPhone_Next_Proxy(IEnumPhone *This, ULONG celt,
                                     ITPhone **ppElements, ULONG *pceltFetched);
void __RPC_STUB IEnumPhone_Next_Stub(IRpcStubBuffer *This,
                                     IRpcChannelBuffer *_pRpcChannelBuffer,
                                     PRPC_MESSAGE _pRpcMessage,
                                     DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumPhone_Reset_Proxy(IEnumPhone *This);
void __RPC_STUB IEnumPhone_Reset_Stub(IRpcStubBuffer *This,
                                      IRpcChannelBuffer *_pRpcChannelBuffer,
                                      PRPC_MESSAGE _pRpcMessage,
                                      DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumPhone_Skip_Proxy(IEnumPhone *This, ULONG celt);
void __RPC_STUB IEnumPhone_Skip_Stub(IRpcStubBuffer *This,
                                     IRpcChannelBuffer *_pRpcChannelBuffer,
                                     PRPC_MESSAGE _pRpcMessage,
                                     DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumPhone_Clone_Proxy(IEnumPhone *This, IEnumPhone **ppEnum);
void __RPC_STUB IEnumPhone_Clone_Stub(IRpcStubBuffer *This,
                                      IRpcChannelBuffer *_pRpcChannelBuffer,
                                      PRPC_MESSAGE _pRpcMessage,
                                      DWORD *_pdwStubPhase);
#endif
...
public:
  virtual HRESULT WINAPI Next(ULONG celt, ITTerminal **ppElements,
                              ULONG *pceltFetched) = 0;
  virtual HRESULT WINAPI Reset(void) = 0;
  virtual HRESULT WINAPI Skip(ULONG celt) = 0;
...
typedef struct IEnumTerminalVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IEnumTerminal *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IEnumTerminal *This);
  ULONG(WINAPI *Release)(IEnumTerminal *This);
  HRESULT(WINAPI *Next)(IEnumTerminal *This, ULONG celt,
                        ITTerminal **ppElements, ULONG *pceltFetched);
...
#endif
#endif
HRESULT WINAPI IEnumTerminal_Next_Proxy(IEnumTerminal *This, ULONG celt,
                                        ITTerminal **ppElements,
                                        ULONG *pceltFetched);
void __RPC_STUB IEnumTerminal_Next_Stub(IRpcStubBuffer *This,
                                        IRpcChannelBuffer *_pRpcChannelBuffer,
                                        PRPC_MESSAGE _pRpcMessage,
                                        DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumTerminal_Reset_Proxy(IEnumTerminal *This);
void __RPC_STUB IEnumTerminal_Reset_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumTerminal_Skip_Proxy(IEnumTerminal *This, ULONG celt);
void __RPC_STUB IEnumTerminal_Skip_Stub(IRpcStubBuffer *This,
                                        IRpcChannelBuffer *_pRpcChannelBuffer,
                                        PRPC_MESSAGE _pRpcMessage,
                                        DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumTerminal_Clone_Proxy(IEnumTerminal *This,
                                         IEnumTerminal **ppEnum);
void __RPC_STUB IEnumTerminal_Clone_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
#endif
...
public:
  virtual HRESULT WINAPI Next(ULONG celt, GUID *pElements,
                              ULONG *pceltFetched) = 0;
  virtual HRESULT WINAPI Reset(void) = 0;
  virtual HRESULT WINAPI Skip(ULONG celt) = 0;
...
typedef struct IEnumTerminalClassVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IEnumTerminalClass *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IEnumTerminalClass *This);
  ULONG(WINAPI *Release)(IEnumTerminalClass *This);
  HRESULT(WINAPI *Next)(IEnumTerminalClass *This, ULONG celt, GUID *pElements,
                        ULONG *pceltFetched);
...
#endif
#endif
HRESULT WINAPI IEnumTerminalClass_Next_Proxy(IEnumTerminalClass *This,
                                             ULONG celt, GUID *pElements,
                                             ULONG *pceltFetched);
...
void __RPC_STUB IEnumTerminalClass_Reset_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumTerminalClass_Skip_Proxy(IEnumTerminalClass *This,
                                             ULONG celt);
void __RPC_STUB IEnumTerminalClass_Skip_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumTerminalClass_Clone_Proxy(IEnumTerminalClass *This,
...
public:
  virtual HRESULT WINAPI Next(ULONG celt, ITCallInfo **ppElements,
                              ULONG *pceltFetched) = 0;
  virtual HRESULT WINAPI Reset(void) = 0;
  virtual HRESULT WINAPI Skip(ULONG celt) = 0;
...
typedef struct IEnumCallVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IEnumCall *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IEnumCall *This);
  ULONG(WINAPI *Release)(IEnumCall *This);
  HRESULT(WINAPI *Next)(IEnumCall *This, ULONG celt, ITCallInfo **ppElements,
                        ULONG *pceltFetched);
...
#endif
#endif
HRESULT WINAPI IEnumCall_Next_Proxy(IEnumCall *This, ULONG celt,
                                    ITCallInfo **ppElements,
                                    ULONG *pceltFetched);
void __RPC_STUB IEnumCall_Next_Stub(IRpcStubBuffer *This,
                                    IRpcChannelBuffer *_pRpcChannelBuffer,
                                    PRPC_MESSAGE _pRpcMessage,
                                    DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumCall_Reset_Proxy(IEnumCall *This);
void __RPC_STUB IEnumCall_Reset_Stub(IRpcStubBuffer *This,
                                     IRpcChannelBuffer *_pRpcChannelBuffer,
                                     PRPC_MESSAGE _pRpcMessage,
                                     DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumCall_Skip_Proxy(IEnumCall *This, ULONG celt);
void __RPC_STUB IEnumCall_Skip_Stub(IRpcStubBuffer *This,
                                    IRpcChannelBuffer *_pRpcChannelBuffer,
                                    PRPC_MESSAGE _pRpcMessage,
                                    DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumCall_Clone_Proxy(IEnumCall *This, IEnumCall **ppEnum);
void __RPC_STUB IEnumCall_Clone_Stub(IRpcStubBuffer *This,
                                     IRpcChannelBuffer *_pRpcChannelBuffer,
                                     PRPC_MESSAGE _pRpcMessage,
                                     DWORD *_pdwStubPhase);
#endif
...
public:
  virtual HRESULT WINAPI Next(ULONG celt, ITAddress **ppElements,
                              ULONG *pceltFetched) = 0;
  virtual HRESULT WINAPI Reset(void) = 0;
  virtual HRESULT WINAPI Skip(ULONG celt) = 0;
...
typedef struct IEnumAddressVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IEnumAddress *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IEnumAddress *This);
  ULONG(WINAPI *Release)(IEnumAddress *This);
  HRESULT(WINAPI *Next)(IEnumAddress *This, ULONG celt, ITAddress **ppElements,
                        ULONG *pceltFetched);
...
#endif
#endif
HRESULT WINAPI IEnumAddress_Next_Proxy(IEnumAddress *This, ULONG celt,
                                       ITAddress **ppElements,
                                       ULONG *pceltFetched);
void __RPC_STUB IEnumAddress_Next_Stub(IRpcStubBuffer *This,
                                       IRpcChannelBuffer *_pRpcChannelBuffer,
                                       PRPC_MESSAGE _pRpcMessage,
                                       DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumAddress_Reset_Proxy(IEnumAddress *This);
void __RPC_STUB IEnumAddress_Reset_Stub(IRpcStubBuffer *This,
                                        IRpcChannelBuffer *_pRpcChannelBuffer,
                                        PRPC_MESSAGE _pRpcMessage,
                                        DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumAddress_Skip_Proxy(IEnumAddress *This, ULONG celt);
void __RPC_STUB IEnumAddress_Skip_Stub(IRpcStubBuffer *This,
                                       IRpcChannelBuffer *_pRpcChannelBuffer,
                                       PRPC_MESSAGE _pRpcMessage,
                                       DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumAddress_Clone_Proxy(IEnumAddress *This,
                                        IEnumAddress **ppEnum);
void __RPC_STUB IEnumAddress_Clone_Stub(IRpcStubBuffer *This,
                                        IRpcChannelBuffer *_pRpcChannelBuffer,
                                        PRPC_MESSAGE _pRpcMessage,
                                        DWORD *_pdwStubPhase);
#endif
...
public:
  virtual HRESULT WINAPI Next(ULONG celt, ITCallHub **ppElements,
                              ULONG *pceltFetched) = 0;
  virtual HRESULT WINAPI Reset(void) = 0;
  virtual HRESULT WINAPI Skip(ULONG celt) = 0;
...
typedef struct IEnumCallHubVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IEnumCallHub *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IEnumCallHub *This);
  ULONG(WINAPI *Release)(IEnumCallHub *This);
  HRESULT(WINAPI *Next)(IEnumCallHub *This, ULONG celt, ITCallHub **ppElements,
                        ULONG *pceltFetched);
...
#endif
#endif
HRESULT WINAPI IEnumCallHub_Next_Proxy(IEnumCallHub *This, ULONG celt,
                                       ITCallHub **ppElements,
                                       ULONG *pceltFetched);
void __RPC_STUB IEnumCallHub_Next_Stub(IRpcStubBuffer *This,
                                       IRpcChannelBuffer *_pRpcChannelBuffer,
                                       PRPC_MESSAGE _pRpcMessage,
                                       DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumCallHub_Reset_Proxy(IEnumCallHub *This);
void __RPC_STUB IEnumCallHub_Reset_Stub(IRpcStubBuffer *This,
                                        IRpcChannelBuffer *_pRpcChannelBuffer,
                                        PRPC_MESSAGE _pRpcMessage,
                                        DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumCallHub_Skip_Proxy(IEnumCallHub *This, ULONG celt);
void __RPC_STUB IEnumCallHub_Skip_Stub(IRpcStubBuffer *This,
                                       IRpcChannelBuffer *_pRpcChannelBuffer,
                                       PRPC_MESSAGE _pRpcMessage,
                                       DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumCallHub_Clone_Proxy(IEnumCallHub *This,
                                        IEnumCallHub **ppEnum);
void __RPC_STUB IEnumCallHub_Clone_Stub(IRpcStubBuffer *This,
                                        IRpcChannelBuffer *_pRpcChannelBuffer,
                                        PRPC_MESSAGE _pRpcMessage,
                                        DWORD *_pdwStubPhase);
#endif
...
public:
  virtual HRESULT WINAPI Next(ULONG celt, BSTR *ppStrings,
                              ULONG *pceltFetched) = 0;
  virtual HRESULT WINAPI Reset(void) = 0;
  virtual HRESULT WINAPI Skip(ULONG celt) = 0;
...
typedef struct IEnumBstrVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IEnumBstr *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IEnumBstr *This);
  ULONG(WINAPI *Release)(IEnumBstr *This);
  HRESULT(WINAPI *Next)(IEnumBstr *This, ULONG celt, BSTR *ppStrings,
                        ULONG *pceltFetched);
...
#endif
#endif
HRESULT WINAPI IEnumBstr_Next_Proxy(IEnumBstr *This, ULONG celt,
                                    BSTR *ppStrings, ULONG *pceltFetched);
void __RPC_STUB IEnumBstr_Next_Stub(IRpcStubBuffer *This,
                                    IRpcChannelBuffer *_pRpcChannelBuffer,
                                    PRPC_MESSAGE _pRpcMessage,
                                    DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumBstr_Reset_Proxy(IEnumBstr *This);
void __RPC_STUB IEnumBstr_Reset_Stub(IRpcStubBuffer *This,
                                     IRpcChannelBuffer *_pRpcChannelBuffer,
                                     PRPC_MESSAGE _pRpcMessage,
                                     DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumBstr_Skip_Proxy(IEnumBstr *This, ULONG celt);
void __RPC_STUB IEnumBstr_Skip_Stub(IRpcStubBuffer *This,
                                    IRpcChannelBuffer *_pRpcChannelBuffer,
                                    PRPC_MESSAGE _pRpcMessage,
                                    DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumBstr_Clone_Proxy(IEnumBstr *This, IEnumBstr **ppEnum);
void __RPC_STUB IEnumBstr_Clone_Stub(IRpcStubBuffer *This,
                                     IRpcChannelBuffer *_pRpcChannelBuffer,
                                     PRPC_MESSAGE _pRpcMessage,
                                     DWORD *_pdwStubPhase);
#endif
...
public:
  virtual HRESULT WINAPI Next(ULONG celt,
                              ITPluggableTerminalClassInfo **ppElements,
                              ULONG *pceltFetched) = 0;
  virtual HRESULT WINAPI Reset(void) = 0;
  virtual HRESULT WINAPI Skip(ULONG celt) = 0;
...
typedef struct IEnumPluggableTerminalClassInfoVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IEnumPluggableTerminalClassInfo *This,
                                  REFIID riid, void **ppvObject);
  ULONG(WINAPI *AddRef)(IEnumPluggableTerminalClassInfo *This);
  ULONG(WINAPI *Release)(IEnumPluggableTerminalClassInfo *This);
  HRESULT(WINAPI *Next)(IEnumPluggableTerminalClassInfo *This, ULONG celt,
                        ITPluggableTerminalClassInfo **ppElements,
                        ULONG *pceltFetched);
  ...
  HRESULT(WINAPI *Clone)(IEnumPluggableTerminalClassInfo *This,
                         IEnumPluggableTerminalClassInfo **ppEnum);
  END_INTERFACE
...
#define IEnumPluggableTerminalClassInfo_Release(This)                          \
  (This)->lpVtbl->Release(This)
#define IEnumPluggableTerminalClassInfo_Next(This, celt, ppElements,           \
                                             pceltFetched)                     \
  (This)->lpVtbl->Next(This, celt, ppElements, pceltFetched)
...
#endif
#endif
HRESULT WINAPI IEnumPluggableTerminalClassInfo_Next_Proxy(
    IEnumPluggableTerminalClassInfo *This, ULONG celt,
    ITPluggableTerminalClassInfo **ppElements, ULONG *pceltFetched);
void __RPC_STUB IEnumPluggableTerminalClassInfo_Next_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumPluggableTerminalClassInfo_Reset_Proxy(
    IEnumPluggableTerminalClassInfo *This);
void __RPC_STUB IEnumPluggableTerminalClassInfo_Reset_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumPluggableTerminalClassInfo_Skip_Proxy(
    IEnumPluggableTerminalClassInfo *This, ULONG celt);
void __RPC_STUB IEnumPluggableTerminalClassInfo_Skip_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumPluggableTerminalClassInfo_Clone_Proxy(
    IEnumPluggableTerminalClassInfo *This,
    IEnumPluggableTerminalClassInfo **ppEnum);
...
public:
  virtual HRESULT WINAPI Next(ULONG celt,
                              ITPluggableTerminalSuperclassInfo **ppElements,
                              ULONG *pceltFetched) = 0;
  virtual HRESULT WINAPI Reset(void) = 0;
  virtual HRESULT WINAPI Skip(ULONG celt) = 0;
...
#define IEnumPluggableSuperclassInfo_Next(This, celt, ppElements,              \
                                          pceltFetched)                        \
  (This)->lpVtbl->Next(This, celt, ppElements, pceltFetched)
...
#endif
#endif
HRESULT WINAPI IEnumPluggableSuperclassInfo_Next_Proxy(
    IEnumPluggableSuperclassInfo *This, ULONG celt,
    ITPluggableTerminalSuperclassInfo **ppElements, ULONG *pceltFetched);
void __RPC_STUB IEnumPluggableSuperclassInfo_Next_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
IEnumPluggableSuperclassInfo_Reset_Proxy(IEnumPluggableSuperclassInfo *This);
void __RPC_STUB IEnumPluggableSuperclassInfo_Reset_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumPluggableSuperclassInfo_Skip_Proxy(
    IEnumPluggableSuperclassInfo *This, ULONG celt);
void __RPC_STUB IEnumPluggableSuperclassInfo_Skip_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumPluggableSuperclassInfo_Clone_Proxy(
    IEnumPluggableSuperclassInfo *This, IEnumPluggableSuperclassInfo **ppEnum);
...
public:
  ...
  virtual HRESULT WINAPI
  get_HookSwitchState(PHONE_HOOK_SWITCH_STATE *pState) = 0;
  virtual HRESULT WINAPI
  get_HookSwitchDevice(PHONE_HOOK_SWITCH_DEVICE *pDevice) = 0;
  virtual HRESULT WINAPI get_RingMode(__LONG32 *plRingMode) = 0;
...
typedef struct ITPhoneEventVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITPhoneEvent *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITPhoneEvent *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITPhoneEvent *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITPhoneEvent *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *get_Phone)(ITPhoneEvent *This, ITPhone **ppPhone);
  HRESULT(WINAPI *get_Event)(ITPhoneEvent *This, PHONE_EVENT *pEvent);
  HRESULT(WINAPI *get_ButtonState)(ITPhoneEvent *This,
                                   PHONE_BUTTON_STATE *pState);
  HRESULT(WINAPI *get_HookSwitchState)(ITPhoneEvent *This,
                                       PHONE_HOOK_SWITCH_STATE *pState);
  HRESULT(WINAPI *get_HookSwitchDevice)(ITPhoneEvent *This,
                                        PHONE_HOOK_SWITCH_DEVICE *pDevice);
  HRESULT(WINAPI *get_RingMode)(ITPhoneEvent *This, __LONG32 *plRingMode);
  HRESULT(WINAPI *get_ButtonLampId)(ITPhoneEvent *This,
                                    __LONG32 *plButtonLampId);
...
#define ITPhoneEvent_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                  \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITPhoneEvent_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,        \
                                   rgDispId)                                   \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITPhoneEvent_Invoke(This, dispIdMember, riid, lcid, wFlags,            \
                            pDispParams, pVarResult, pExcepInfo, puArgErr)     \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI ITPhoneEvent_get_Phone_Proxy(ITPhoneEvent *This,
                                            ITPhone **ppPhone);
void __RPC_STUB ITPhoneEvent_get_Phone_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPhoneEvent_get_Event_Proxy(ITPhoneEvent *This,
                                            PHONE_EVENT *pEvent);
void __RPC_STUB ITPhoneEvent_get_Event_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPhoneEvent_get_ButtonState_Proxy(ITPhoneEvent *This,
                                                  PHONE_BUTTON_STATE *pState);
void __RPC_STUB ITPhoneEvent_get_ButtonState_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPhoneEvent_get_HookSwitchState_Proxy(
    ITPhoneEvent *This, PHONE_HOOK_SWITCH_STATE *pState);
void __RPC_STUB ITPhoneEvent_get_HookSwitchState_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPhoneEvent_get_HookSwitchDevice_Proxy(
    ITPhoneEvent *This, PHONE_HOOK_SWITCH_DEVICE *pDevice);
void __RPC_STUB ITPhoneEvent_get_HookSwitchDevice_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPhoneEvent_get_RingMode_Proxy(ITPhoneEvent *This,
                                               __LONG32 *plRingMode);
void __RPC_STUB ITPhoneEvent_get_RingMode_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPhoneEvent_get_ButtonLampId_Proxy(ITPhoneEvent *This,
                                                   __LONG32 *plButtonLampId);
void __RPC_STUB ITPhoneEvent_get_ButtonLampId_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPhoneEvent_get_NumberGathered_Proxy(ITPhoneEvent *This,
                                                     BSTR *ppNumber);
void __RPC_STUB ITPhoneEvent_get_NumberGathered_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPhoneEvent_get_Call_Proxy(ITPhoneEvent *This,
                                           ITCallInfo **ppCallInfo);
...
typedef struct ITCallStateEventVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITCallStateEvent *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITCallStateEvent *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITCallStateEvent *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITCallStateEvent *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  ...
  HRESULT(WINAPI *get_Cause)(ITCallStateEvent *This,
                             CALL_STATE_EVENT_CAUSE *pCEC);
  HRESULT(WINAPI *get_CallbackInstance)(ITCallStateEvent *This,
                                        __LONG32 *plCallbackInstance);
  END_INTERFACE
...
#define ITCallStateEvent_GetTypeInfo(This, iTInfo, lcid, ppTInfo)              \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITCallStateEvent_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,    \
                                       rgDispId)                               \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITCallStateEvent_Invoke(This, dispIdMember, riid, lcid, wFlags,        \
                                pDispParams, pVarResult, pExcepInfo, puArgErr) \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI ITCallStateEvent_get_Call_Proxy(ITCallStateEvent *This,
                                               ITCallInfo **ppCallInfo);
void __RPC_STUB ITCallStateEvent_get_Call_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITCallStateEvent_get_State_Proxy(ITCallStateEvent *This,
                                                CALL_STATE *pCallState);
void __RPC_STUB ITCallStateEvent_get_State_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITCallStateEvent_get_Cause_Proxy(ITCallStateEvent *This,
                                                CALL_STATE_EVENT_CAUSE *pCEC);
void __RPC_STUB ITCallStateEvent_get_Cause_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITCallStateEvent_get_CallbackInstance_Proxy(
    ITCallStateEvent *This, __LONG32 *plCallbackInstance);
...
typedef struct ITPhoneDeviceSpecificEventVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITPhoneDeviceSpecificEvent *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ITPhoneDeviceSpecificEvent *This);
  ULONG(WINAPI *Release)(ITPhoneDeviceSpecificEvent *This);
  HRESULT(WINAPI *GetTypeInfoCount)(ITPhoneDeviceSpecificEvent *This,
                                    UINT *pctinfo);
  HRESULT(WINAPI *GetTypeInfo)(ITPhoneDeviceSpecificEvent *This, UINT iTInfo,
                               LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITPhoneDeviceSpecificEvent *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITPhoneDeviceSpecificEvent *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *get_Phone)(ITPhoneDeviceSpecificEvent *This,
                             ITPhone **ppPhone);
  HRESULT(WINAPI *get_lParam1)(ITPhoneDeviceSpecificEvent *This,
                               __LONG32 *pParam1);
  HRESULT(WINAPI *get_lParam2)(ITPhoneDeviceSpecificEvent *This,
                               __LONG32 *pParam2);
  HRESULT(WINAPI *get_lParam3)(ITPhoneDeviceSpecificEvent *This,
                               __LONG32 *pParam3);
  END_INTERFACE
...
#define ITPhoneDeviceSpecificEvent_GetTypeInfo(This, iTInfo, lcid, ppTInfo)    \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITPhoneDeviceSpecificEvent_GetIDsOfNames(This, riid, rgszNames,        \
                                                 cNames, lcid, rgDispId)       \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITPhoneDeviceSpecificEvent_Invoke(This, dispIdMember, riid, lcid,      \
                                          wFlags, pDispParams, pVarResult,     \
                                          pExcepInfo, puArgErr)                \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI ITPhoneDeviceSpecificEvent_get_Phone_Proxy(
    ITPhoneDeviceSpecificEvent *This, ITPhone **ppPhone);
void __RPC_STUB ITPhoneDeviceSpecificEvent_get_Phone_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPhoneDeviceSpecificEvent_get_lParam1_Proxy(
    ITPhoneDeviceSpecificEvent *This, __LONG32 *pParam1);
void __RPC_STUB ITPhoneDeviceSpecificEvent_get_lParam1_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPhoneDeviceSpecificEvent_get_lParam2_Proxy(
    ITPhoneDeviceSpecificEvent *This, __LONG32 *pParam2);
void __RPC_STUB ITPhoneDeviceSpecificEvent_get_lParam2_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITPhoneDeviceSpecificEvent_get_lParam3_Proxy(
    ITPhoneDeviceSpecificEvent *This, __LONG32 *pParam3);
...
typedef struct ITCallMediaEventVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITCallMediaEvent *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITCallMediaEvent *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITCallMediaEvent *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITCallMediaEvent *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *get_Call)(ITCallMediaEvent *This, ITCallInfo **ppCallInfo);
  HRESULT(WINAPI *get_Event)(ITCallMediaEvent *This,
                             CALL_MEDIA_EVENT *pCallMediaEvent);
  HRESULT(WINAPI *get_Error)(ITCallMediaEvent *This, HRESULT *phrError);
  HRESULT(WINAPI *get_Terminal)(ITCallMediaEvent *This,
                                ITTerminal **ppTerminal);
  HRESULT(WINAPI *get_Stream)(ITCallMediaEvent *This, ITStream **ppStream);
  HRESULT(WINAPI *get_Cause)(ITCallMediaEvent *This,
                             CALL_MEDIA_EVENT_CAUSE *pCause);
  END_INTERFACE
...
#define ITCallMediaEvent_GetTypeInfo(This, iTInfo, lcid, ppTInfo)              \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITCallMediaEvent_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,    \
                                       rgDispId)                               \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITCallMediaEvent_Invoke(This, dispIdMember, riid, lcid, wFlags,        \
                                pDispParams, pVarResult, pExcepInfo, puArgErr) \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI ITCallMediaEvent_get_Call_Proxy(ITCallMediaEvent *This,
                                               ITCallInfo **ppCallInfo);
void __RPC_STUB ITCallMediaEvent_get_Call_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITCallMediaEvent_get_Event_Proxy(
    ITCallMediaEvent *This, CALL_MEDIA_EVENT *pCallMediaEvent);
void __RPC_STUB ITCallMediaEvent_get_Event_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITCallMediaEvent_get_Error_Proxy(ITCallMediaEvent *This,
                                                HRESULT *phrError);
void __RPC_STUB ITCallMediaEvent_get_Error_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITCallMediaEvent_get_Terminal_Proxy(ITCallMediaEvent *This,
                                                   ITTerminal **ppTerminal);
void __RPC_STUB ITCallMediaEvent_get_Terminal_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITCallMediaEvent_get_Stream_Proxy(ITCallMediaEvent *This,
                                                 ITStream **ppStream);
void __RPC_STUB ITCallMediaEvent_get_Stream_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITCallMediaEvent_get_Cause_Proxy(ITCallMediaEvent *This,
                                                CALL_MEDIA_EVENT_CAUSE *pCause);
...
typedef struct ITDigitDetectionEventVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITDigitDetectionEvent *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITDigitDetectionEvent *This, UINT iTInfo,
                               LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITDigitDetectionEvent *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITDigitDetectionEvent *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *get_Call)(ITDigitDetectionEvent *This,
                            ITCallInfo **ppCallInfo);
  HRESULT(WINAPI *get_Digit)(ITDigitDetectionEvent *This,
                             unsigned char *pucDigit);
  HRESULT(WINAPI *get_DigitMode)(ITDigitDetectionEvent *This,
                                 TAPI_DIGITMODE *pDigitMode);
  HRESULT(WINAPI *get_TickCount)(ITDigitDetectionEvent *This,
                                 __LONG32 *plTickCount);
  HRESULT(WINAPI *get_CallbackInstance)(ITDigitDetectionEvent *This,
                                        __LONG32 *plCallbackInstance);
  END_INTERFACE
...
#define ITDigitDetectionEvent_GetTypeInfo(This, iTInfo, lcid, ppTInfo)         \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITDigitDetectionEvent_GetIDsOfNames(This, riid, rgszNames, cNames,     \
                                            lcid, rgDispId)                    \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITDigitDetectionEvent_Invoke(This, dispIdMember, riid, lcid, wFlags,   \
                                     pDispParams, pVarResult, pExcepInfo,      \
                                     puArgErr)                                 \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI ITDigitDetectionEvent_get_Call_Proxy(ITDigitDetectionEvent *This,
                                                    ITCallInfo **ppCallInfo);
void __RPC_STUB ITDigitDetectionEvent_get_Call_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITDigitDetectionEvent_get_Digit_Proxy(
    ITDigitDetectionEvent *This, unsigned char *pucDigit);
void __RPC_STUB ITDigitDetectionEvent_get_Digit_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITDigitDetectionEvent_get_DigitMode_Proxy(
    ITDigitDetectionEvent *This, TAPI_DIGITMODE *pDigitMode);
void __RPC_STUB ITDigitDetectionEvent_get_DigitMode_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITDigitDetectionEvent_get_TickCount_Proxy(
    ITDigitDetectionEvent *This, __LONG32 *plTickCount);
void __RPC_STUB ITDigitDetectionEvent_get_TickCount_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITDigitDetectionEvent_get_CallbackInstance_Proxy(
    ITDigitDetectionEvent *This, __LONG32 *plCallbackInstance);
...
public:
  virtual HRESULT WINAPI get_Call(ITCallInfo **ppCallInfo) = 0;
  virtual HRESULT WINAPI
  get_GenerationTermination(__LONG32 *plGenerationTermination) = 0;
  virtual HRESULT WINAPI get_TickCount(__LONG32 *plTickCount) = 0;
  virtual HRESULT WINAPI get_CallbackInstance(__LONG32 *plCallbackInstance) = 0;
};
#else
typedef struct ITDigitGenerationEventVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITDigitGenerationEvent *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ITDigitGenerationEvent *This);
  ULONG(WINAPI *Release)(ITDigitGenerationEvent *This);
  HRESULT(WINAPI *GetTypeInfoCount)(ITDigitGenerationEvent *This,
                                    UINT *pctinfo);
  HRESULT(WINAPI *GetTypeInfo)(ITDigitGenerationEvent *This, UINT iTInfo,
                               LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITDigitGenerationEvent *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITDigitGenerationEvent *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *get_Call)(ITDigitGenerationEvent *This,
                            ITCallInfo **ppCallInfo);
  HRESULT(WINAPI *get_GenerationTermination)(ITDigitGenerationEvent *This,
                                             __LONG32 *plGenerationTermination);
  HRESULT(WINAPI *get_TickCount)(ITDigitGenerationEvent *This,
                                 __LONG32 *plTickCount);
  HRESULT(WINAPI *get_CallbackInstance)(ITDigitGenerationEvent *This,
                                        __LONG32 *plCallbackInstance);
  END_INTERFACE
...
#define ITDigitGenerationEvent_GetTypeInfo(This, iTInfo, lcid, ppTInfo)        \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITDigitGenerationEvent_GetIDsOfNames(This, riid, rgszNames, cNames,    \
                                             lcid, rgDispId)                   \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITDigitGenerationEvent_Invoke(This, dispIdMember, riid, lcid, wFlags,  \
                                      pDispParams, pVarResult, pExcepInfo,     \
                                      puArgErr)                                \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
#define ITDigitGenerationEvent_get_Call(This, ppCallInfo)                      \
  (This)->lpVtbl->get_Call(This, ppCallInfo)
#define ITDigitGenerationEvent_get_GenerationTermination(                      \
    This, plGenerationTermination)                                             \
...
#endif
HRESULT
    WINAPI ITDigitGenerationEvent_get_Call_Proxy(ITDigitGenerationEvent *This,
                                                 ITCallInfo **ppCallInfo);
void __RPC_STUB ITDigitGenerationEvent_get_Call_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITDigitGenerationEvent_get_GenerationTermination_Proxy(
    ITDigitGenerationEvent *This, __LONG32 *plGenerationTermination);
void __RPC_STUB ITDigitGenerationEvent_get_GenerationTermination_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITDigitGenerationEvent_get_TickCount_Proxy(
    ITDigitGenerationEvent *This, __LONG32 *plTickCount);
void __RPC_STUB ITDigitGenerationEvent_get_TickCount_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITDigitGenerationEvent_get_CallbackInstance_Proxy(
    ITDigitGenerationEvent *This, __LONG32 *plCallbackInstance);
...
public:
  ...
  virtual HRESULT WINAPI
  get_GatherTermination(TAPI_GATHERTERM *pGatherTermination) = 0;
  virtual HRESULT WINAPI get_TickCount(__LONG32 *plTickCount) = 0;
  virtual HRESULT WINAPI get_CallbackInstance(__LONG32 *plCallbackInstance) = 0;
};
#else
typedef struct ITDigitsGatheredEventVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITDigitsGatheredEvent *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITDigitsGatheredEvent *This, UINT iTInfo,
                               LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITDigitsGatheredEvent *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITDigitsGatheredEvent *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *get_Call)(ITDigitsGatheredEvent *This,
                            ITCallInfo **ppCallInfo);
  HRESULT(WINAPI *get_Digits)(ITDigitsGatheredEvent *This, BSTR *ppDigits);
  HRESULT(WINAPI *get_GatherTermination)(ITDigitsGatheredEvent *This,
                                         TAPI_GATHERTERM *pGatherTermination);
  HRESULT(WINAPI *get_TickCount)(ITDigitsGatheredEvent *This,
                                 __LONG32 *plTickCount);
  HRESULT(WINAPI *get_CallbackInstance)(ITDigitsGatheredEvent *This,
                                        __LONG32 *plCallbackInstance);
  END_INTERFACE
...
#define ITDigitsGatheredEvent_GetTypeInfo(This, iTInfo, lcid, ppTInfo)         \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITDigitsGatheredEvent_GetIDsOfNames(This, riid, rgszNames, cNames,     \
                                            lcid, rgDispId)                    \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITDigitsGatheredEvent_Invoke(This, dispIdMember, riid, lcid, wFlags,   \
                                     pDispParams, pVarResult, pExcepInfo,      \
                                     puArgErr)                                 \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI ITDigitsGatheredEvent_get_Call_Proxy(ITDigitsGatheredEvent *This,
                                                    ITCallInfo **ppCallInfo);
void __RPC_STUB ITDigitsGatheredEvent_get_Call_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITDigitsGatheredEvent_get_Digits_Proxy(
    ITDigitsGatheredEvent *This, BSTR *ppDigits);
void __RPC_STUB ITDigitsGatheredEvent_get_Digits_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITDigitsGatheredEvent_get_GatherTermination_Proxy(
    ITDigitsGatheredEvent *This, TAPI_GATHERTERM *pGatherTermination);
void __RPC_STUB ITDigitsGatheredEvent_get_GatherTermination_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITDigitsGatheredEvent_get_TickCount_Proxy(
    ITDigitsGatheredEvent *This, __LONG32 *plTickCount);
void __RPC_STUB ITDigitsGatheredEvent_get_TickCount_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITDigitsGatheredEvent_get_CallbackInstance_Proxy(
    ITDigitsGatheredEvent *This, __LONG32 *plCallbackInstance);
...
typedef struct ITToneDetectionEventVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITToneDetectionEvent *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITToneDetectionEvent *This, UINT iTInfo,
                               LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITToneDetectionEvent *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITToneDetectionEvent *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *get_Call)(ITToneDetectionEvent *This,
                            ITCallInfo **ppCallInfo);
  HRESULT(WINAPI *get_AppSpecific)(ITToneDetectionEvent *This,
                                   __LONG32 *plAppSpecific);
  HRESULT(WINAPI *get_TickCount)(ITToneDetectionEvent *This,
                                 __LONG32 *plTickCount);
  HRESULT(WINAPI *get_CallbackInstance)(ITToneDetectionEvent *This,
                                        __LONG32 *plCallbackInstance);
  END_INTERFACE
...
#define ITToneDetectionEvent_GetTypeInfo(This, iTInfo, lcid, ppTInfo)          \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITToneDetectionEvent_GetIDsOfNames(This, riid, rgszNames, cNames,      \
                                           lcid, rgDispId)                     \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITToneDetectionEvent_Invoke(This, dispIdMember, riid, lcid, wFlags,    \
                                    pDispParams, pVarResult, pExcepInfo,       \
                                    puArgErr)                                  \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI ITToneDetectionEvent_get_Call_Proxy(ITToneDetectionEvent *This,
                                                   ITCallInfo **ppCallInfo);
void __RPC_STUB ITToneDetectionEvent_get_Call_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITToneDetectionEvent_get_AppSpecific_Proxy(
    ITToneDetectionEvent *This, __LONG32 *plAppSpecific);
void __RPC_STUB ITToneDetectionEvent_get_AppSpecific_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITToneDetectionEvent_get_TickCount_Proxy(
    ITToneDetectionEvent *This, __LONG32 *plTickCount);
void __RPC_STUB ITToneDetectionEvent_get_TickCount_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITToneDetectionEvent_get_CallbackInstance_Proxy(
    ITToneDetectionEvent *This, __LONG32 *plCallbackInstance);
...
typedef struct ITTAPIObjectEventVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITTAPIObjectEvent *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITTAPIObjectEvent *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITTAPIObjectEvent *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITTAPIObjectEvent *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *get_TAPIObject)(ITTAPIObjectEvent *This,
                                  ITTAPI **ppTAPIObject);
  ...
  HRESULT(WINAPI *get_CallbackInstance)(ITTAPIObjectEvent *This,
                                        __LONG32 *plCallbackInstance);
  END_INTERFACE
...
#define ITTAPIObjectEvent_GetTypeInfo(This, iTInfo, lcid, ppTInfo)             \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITTAPIObjectEvent_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,   \
                                        rgDispId)                              \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITTAPIObjectEvent_Invoke(This, dispIdMember, riid, lcid, wFlags,       \
                                 pDispParams, pVarResult, pExcepInfo,          \
                                 puArgErr)                                     \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI ITTAPIObjectEvent_get_TAPIObject_Proxy(ITTAPIObjectEvent *This,
                                                      ITTAPI **ppTAPIObject);
void __RPC_STUB ITTAPIObjectEvent_get_TAPIObject_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITTAPIObjectEvent_get_Event_Proxy(ITTAPIObjectEvent *This,
                                                 TAPIOBJECT_EVENT *pEvent);
void __RPC_STUB ITTAPIObjectEvent_get_Event_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITTAPIObjectEvent_get_Address_Proxy(ITTAPIObjectEvent *This,
                                                   ITAddress **ppAddress);
void __RPC_STUB ITTAPIObjectEvent_get_Address_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITTAPIObjectEvent_get_CallbackInstance_Proxy(
    ITTAPIObjectEvent *This, __LONG32 *plCallbackInstance);
...
typedef struct ITTAPIObjectEvent2Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITTAPIObjectEvent2 *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITTAPIObjectEvent2 *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITTAPIObjectEvent2 *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITTAPIObjectEvent2 *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *get_TAPIObject)(ITTAPIObjectEvent2 *This,
                                  ITTAPI **ppTAPIObject);
  HRESULT(WINAPI *get_Event)(ITTAPIObjectEvent2 *This,
                             TAPIOBJECT_EVENT *pEvent);
  HRESULT(WINAPI *get_Address)(ITTAPIObjectEvent2 *This, ITAddress **ppAddress);
  HRESULT(WINAPI *get_CallbackInstance)(ITTAPIObjectEvent2 *This,
                                        __LONG32 *plCallbackInstance);
...
#define ITTAPIObjectEvent2_GetTypeInfo(This, iTInfo, lcid, ppTInfo)            \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITTAPIObjectEvent2_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,  \
                                         rgDispId)                             \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITTAPIObjectEvent2_Invoke(This, dispIdMember, riid, lcid, wFlags,      \
                                  pDispParams, pVarResult, pExcepInfo,         \
                                  puArgErr)                                    \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
typedef struct ITTAPIEventNotificationVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITTAPIEventNotification *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ITTAPIEventNotification *This);
  ULONG(WINAPI *Release)(ITTAPIEventNotification *This);
  HRESULT(WINAPI *Event)(ITTAPIEventNotification *This, TAPI_EVENT TapiEvent,
                         IDispatch *pEvent);
  END_INTERFACE
...
#endif
#endif
HRESULT WINAPI ITTAPIEventNotification_Event_Proxy(
    ITTAPIEventNotification *This, TAPI_EVENT TapiEvent, IDispatch *pEvent);
...
typedef struct ITCallHubEventVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITCallHubEvent *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITCallHubEvent *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITCallHubEvent *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITCallHubEvent *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
...
#define ITCallHubEvent_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITCallHubEvent_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,      \
                                     rgDispId)                                 \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITCallHubEvent_Invoke(This, dispIdMember, riid, lcid, wFlags,          \
                              pDispParams, pVarResult, pExcepInfo, puArgErr)   \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI ITCallHubEvent_get_Event_Proxy(ITCallHubEvent *This,
                                              CALLHUB_EVENT *pEvent);
void __RPC_STUB ITCallHubEvent_get_Event_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITCallHubEvent_get_CallHub_Proxy(ITCallHubEvent *This,
                                                ITCallHub **ppCallHub);
void __RPC_STUB ITCallHubEvent_get_CallHub_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITCallHubEvent_get_Call_Proxy(ITCallHubEvent *This,
                                             ITCallInfo **ppCall);
...
typedef struct ITAddressEventVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITAddressEvent *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITAddressEvent *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITAddressEvent *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITAddressEvent *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
...
#define ITAddressEvent_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITAddressEvent_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,      \
                                     rgDispId)                                 \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITAddressEvent_Invoke(This, dispIdMember, riid, lcid, wFlags,          \
                              pDispParams, pVarResult, pExcepInfo, puArgErr)   \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI ITAddressEvent_get_Address_Proxy(ITAddressEvent *This,
                                                ITAddress **ppAddress);
void __RPC_STUB ITAddressEvent_get_Address_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAddressEvent_get_Event_Proxy(ITAddressEvent *This,
                                              ADDRESS_EVENT *pEvent);
void __RPC_STUB ITAddressEvent_get_Event_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAddressEvent_get_Terminal_Proxy(ITAddressEvent *This,
                                                 ITTerminal **ppTerminal);
...
typedef struct ITAddressDeviceSpecificEventVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITAddressDeviceSpecificEvent *This,
                                  REFIID riid, void **ppvObject);
  ULONG(WINAPI *AddRef)(ITAddressDeviceSpecificEvent *This);
  ULONG(WINAPI *Release)(ITAddressDeviceSpecificEvent *This);
  HRESULT(WINAPI *GetTypeInfoCount)(ITAddressDeviceSpecificEvent *This,
                                    UINT *pctinfo);
  HRESULT(WINAPI *GetTypeInfo)(ITAddressDeviceSpecificEvent *This, UINT iTInfo,
                               LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITAddressDeviceSpecificEvent *This,
                                 REFIID riid, LPOLESTR *rgszNames, UINT cNames,
                                 LCID lcid, DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITAddressDeviceSpecificEvent *This,
                          DISPID dispIdMember, REFIID riid, LCID lcid,
                          WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *get_Address)(ITAddressDeviceSpecificEvent *This,
                               ITAddress **ppAddress);
  HRESULT(WINAPI *get_Call)(ITAddressDeviceSpecificEvent *This,
                            ITCallInfo **ppCall);
  HRESULT(WINAPI *get_lParam1)(ITAddressDeviceSpecificEvent *This,
                               __LONG32 *pParam1);
  HRESULT(WINAPI *get_lParam2)(ITAddressDeviceSpecificEvent *This,
                               __LONG32 *pParam2);
  HRESULT(WINAPI *get_lParam3)(ITAddressDeviceSpecificEvent *This,
                               __LONG32 *pParam3);
  END_INTERFACE
...
#define ITAddressDeviceSpecificEvent_GetTypeInfo(This, iTInfo, lcid, ppTInfo)  \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITAddressDeviceSpecificEvent_GetIDsOfNames(This, riid, rgszNames,      \
                                                   cNames, lcid, rgDispId)     \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITAddressDeviceSpecificEvent_Invoke(This, dispIdMember, riid, lcid,    \
                                            wFlags, pDispParams, pVarResult,   \
                                            pExcepInfo, puArgErr)              \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI ITAddressDeviceSpecificEvent_get_Address_Proxy(
    ITAddressDeviceSpecificEvent *This, ITAddress **ppAddress);
void __RPC_STUB ITAddressDeviceSpecificEvent_get_Address_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAddressDeviceSpecificEvent_get_Call_Proxy(
    ITAddressDeviceSpecificEvent *This, ITCallInfo **ppCall);
void __RPC_STUB ITAddressDeviceSpecificEvent_get_Call_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAddressDeviceSpecificEvent_get_lParam1_Proxy(
    ITAddressDeviceSpecificEvent *This, __LONG32 *pParam1);
void __RPC_STUB ITAddressDeviceSpecificEvent_get_lParam1_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAddressDeviceSpecificEvent_get_lParam2_Proxy(
    ITAddressDeviceSpecificEvent *This, __LONG32 *pParam2);
void __RPC_STUB ITAddressDeviceSpecificEvent_get_lParam2_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAddressDeviceSpecificEvent_get_lParam3_Proxy(
    ITAddressDeviceSpecificEvent *This, __LONG32 *pParam3);
...
typedef struct ITFileTerminalEventVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITFileTerminalEvent *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITFileTerminalEvent *This, UINT iTInfo,
                               LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITFileTerminalEvent *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITFileTerminalEvent *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *get_Terminal)(ITFileTerminalEvent *This,
                                ITTerminal **ppTerminal);
  HRESULT(WINAPI *get_Track)(ITFileTerminalEvent *This,
                             ITFileTrack **ppTrackTerminal);
  HRESULT(WINAPI *get_Call)(ITFileTerminalEvent *This, ITCallInfo **ppCall);
  HRESULT(WINAPI *get_State)(ITFileTerminalEvent *This,
                             TERMINAL_MEDIA_STATE *pState);
  HRESULT(WINAPI *get_Cause)(ITFileTerminalEvent *This,
                             FT_STATE_EVENT_CAUSE *pCause);
...
#define ITFileTerminalEvent_GetTypeInfo(This, iTInfo, lcid, ppTInfo)           \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITFileTerminalEvent_GetIDsOfNames(This, riid, rgszNames, cNames, lcid, \
                                          rgDispId)                            \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITFileTerminalEvent_Invoke(This, dispIdMember, riid, lcid, wFlags,     \
                                   pDispParams, pVarResult, pExcepInfo,        \
                                   puArgErr)                                   \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI ITFileTerminalEvent_get_Terminal_Proxy(ITFileTerminalEvent *This,
                                                      ITTerminal **ppTerminal);
void __RPC_STUB ITFileTerminalEvent_get_Terminal_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITFileTerminalEvent_get_Track_Proxy(
    ITFileTerminalEvent *This, ITFileTrack **ppTrackTerminal);
void __RPC_STUB ITFileTerminalEvent_get_Track_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITFileTerminalEvent_get_Call_Proxy(ITFileTerminalEvent *This,
                                                  ITCallInfo **ppCall);
void __RPC_STUB ITFileTerminalEvent_get_Call_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITFileTerminalEvent_get_State_Proxy(
    ITFileTerminalEvent *This, TERMINAL_MEDIA_STATE *pState);
void __RPC_STUB ITFileTerminalEvent_get_State_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITFileTerminalEvent_get_Cause_Proxy(
    ITFileTerminalEvent *This, FT_STATE_EVENT_CAUSE *pCause);
void __RPC_STUB ITFileTerminalEvent_get_Cause_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITFileTerminalEvent_get_Error_Proxy(ITFileTerminalEvent *This,
                                                   HRESULT *phrErrorCode);
...
typedef struct ITTTSTerminalEventVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITTTSTerminalEvent *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITTTSTerminalEvent *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITTTSTerminalEvent *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITTTSTerminalEvent *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *get_Terminal)(ITTTSTerminalEvent *This,
                                ITTerminal **ppTerminal);
...
#define ITTTSTerminalEvent_GetTypeInfo(This, iTInfo, lcid, ppTInfo)            \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITTTSTerminalEvent_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,  \
                                         rgDispId)                             \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITTTSTerminalEvent_Invoke(This, dispIdMember, riid, lcid, wFlags,      \
                                  pDispParams, pVarResult, pExcepInfo,         \
                                  puArgErr)                                    \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI ITTTSTerminalEvent_get_Terminal_Proxy(ITTTSTerminalEvent *This,
                                                     ITTerminal **ppTerminal);
void __RPC_STUB ITTTSTerminalEvent_get_Terminal_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITTTSTerminalEvent_get_Call_Proxy(ITTTSTerminalEvent *This,
                                                 ITCallInfo **ppCall);
void __RPC_STUB ITTTSTerminalEvent_get_Call_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITTTSTerminalEvent_get_Error_Proxy(ITTTSTerminalEvent *This,
                                                  HRESULT *phrErrorCode);
...
typedef struct ITASRTerminalEventVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITASRTerminalEvent *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITASRTerminalEvent *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITASRTerminalEvent *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITASRTerminalEvent *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *get_Terminal)(ITASRTerminalEvent *This,
                                ITTerminal **ppTerminal);
...
#define ITASRTerminalEvent_GetTypeInfo(This, iTInfo, lcid, ppTInfo)            \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITASRTerminalEvent_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,  \
                                         rgDispId)                             \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITASRTerminalEvent_Invoke(This, dispIdMember, riid, lcid, wFlags,      \
                                  pDispParams, pVarResult, pExcepInfo,         \
                                  puArgErr)                                    \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI ITASRTerminalEvent_get_Terminal_Proxy(ITASRTerminalEvent *This,
                                                     ITTerminal **ppTerminal);
void __RPC_STUB ITASRTerminalEvent_get_Terminal_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITASRTerminalEvent_get_Call_Proxy(ITASRTerminalEvent *This,
                                                 ITCallInfo **ppCall);
void __RPC_STUB ITASRTerminalEvent_get_Call_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITASRTerminalEvent_get_Error_Proxy(ITASRTerminalEvent *This,
                                                  HRESULT *phrErrorCode);
...
typedef struct ITToneTerminalEventVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITToneTerminalEvent *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITToneTerminalEvent *This, UINT iTInfo,
                               LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITToneTerminalEvent *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITToneTerminalEvent *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *get_Terminal)(ITToneTerminalEvent *This,
                                ITTerminal **ppTerminal);
...
#define ITToneTerminalEvent_GetTypeInfo(This, iTInfo, lcid, ppTInfo)           \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITToneTerminalEvent_GetIDsOfNames(This, riid, rgszNames, cNames, lcid, \
                                          rgDispId)                            \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITToneTerminalEvent_Invoke(This, dispIdMember, riid, lcid, wFlags,     \
                                   pDispParams, pVarResult, pExcepInfo,        \
                                   puArgErr)                                   \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI ITToneTerminalEvent_get_Terminal_Proxy(ITToneTerminalEvent *This,
                                                      ITTerminal **ppTerminal);
void __RPC_STUB ITToneTerminalEvent_get_Terminal_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITToneTerminalEvent_get_Call_Proxy(ITToneTerminalEvent *This,
                                                  ITCallInfo **ppCall);
...
typedef struct ITQOSEventVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITQOSEvent *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITQOSEvent *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITQOSEvent *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITQOSEvent *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
...
#define ITQOSEvent_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                    \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITQOSEvent_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,          \
                                 rgDispId)                                     \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
...
void __RPC_STUB ITQOSEvent_get_Call_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
HRESULT WINAPI ITQOSEvent_get_Event_Proxy(ITQOSEvent *This,
                                          QOS_EVENT *pQosEvent);
void __RPC_STUB ITQOSEvent_get_Event_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI ITQOSEvent_get_MediaType_Proxy(ITQOSEvent *This,
                                              __LONG32 *plMediaType);
...
typedef struct ITCallInfoChangeEventVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITCallInfoChangeEvent *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITCallInfoChangeEvent *This, UINT iTInfo,
                               LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITCallInfoChangeEvent *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITCallInfoChangeEvent *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *get_Call)(ITCallInfoChangeEvent *This, ITCallInfo **ppCall);
  HRESULT(WINAPI *get_Cause)(ITCallInfoChangeEvent *This,
                             CALLINFOCHANGE_CAUSE *pCIC);
  HRESULT(WINAPI *get_CallbackInstance)(ITCallInfoChangeEvent *This,
                                        __LONG32 *plCallbackInstance);
  END_INTERFACE
...
#define ITCallInfoChangeEvent_GetTypeInfo(This, iTInfo, lcid, ppTInfo)         \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITCallInfoChangeEvent_GetIDsOfNames(This, riid, rgszNames, cNames,     \
                                            lcid, rgDispId)                    \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITCallInfoChangeEvent_Invoke(This, dispIdMember, riid, lcid, wFlags,   \
                                     pDispParams, pVarResult, pExcepInfo,      \
                                     puArgErr)                                 \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI ITCallInfoChangeEvent_get_Call_Proxy(ITCallInfoChangeEvent *This,
                                                    ITCallInfo **ppCall);
void __RPC_STUB ITCallInfoChangeEvent_get_Call_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITCallInfoChangeEvent_get_Cause_Proxy(
    ITCallInfoChangeEvent *This, CALLINFOCHANGE_CAUSE *pCIC);
void __RPC_STUB ITCallInfoChangeEvent_get_Cause_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITCallInfoChangeEvent_get_CallbackInstance_Proxy(
    ITCallInfoChangeEvent *This, __LONG32 *plCallbackInstance);
...
public:
  virtual HRESULT WINAPI MakeCall(BSTR pDestAddress, BSTR pAppName,
                                  BSTR pCalledParty, BSTR pComment) = 0;
};
#else
typedef struct ITRequestVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITRequest *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITRequest *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITRequest *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITRequest *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *MakeCall)(ITRequest *This, BSTR pDestAddress, BSTR pAppName,
                            BSTR pCalledParty, BSTR pComment);
  END_INTERFACE
} ITRequestVtbl;
struct ITRequest {
...
#define ITRequest_Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
  ...
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
#define ITRequest_MakeCall(This, pDestAddress, pAppName, pCalledParty,         \
                           pComment)                                           \
  (This)->lpVtbl->MakeCall(This, pDestAddress, pAppName, pCalledParty, pComment)
#endif
#endif
HRESULT WINAPI ITRequest_MakeCall_Proxy(ITRequest *This, BSTR pDestAddress,
                                        BSTR pAppName, BSTR pCalledParty,
                                        BSTR pComment);
void __RPC_STUB ITRequest_MakeCall_Stub(IRpcStubBuffer *This,
                                        IRpcChannelBuffer *_pRpcChannelBuffer,
                                        PRPC_MESSAGE _pRpcMessage,
                                        DWORD *_pdwStubPhase);
#endif
...
public:
  virtual HRESULT WINAPI
  get_RegistrationInstance(__LONG32 *plRegistrationInstance) = 0;
...
typedef struct ITRequestEventVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITRequestEvent *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITRequestEvent *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITRequestEvent *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITRequestEvent *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *get_RegistrationInstance)(ITRequestEvent *This,
                                            __LONG32 *plRegistrationInstance);
  HRESULT(WINAPI *get_RequestMode)(ITRequestEvent *This,
                                   __LONG32 *plRequestMode);
...
#define ITRequestEvent_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITRequestEvent_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,      \
                                     rgDispId)                                 \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITRequestEvent_Invoke(This, dispIdMember, riid, lcid, wFlags,          \
                              pDispParams, pVarResult, pExcepInfo, puArgErr)   \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI ITRequestEvent_get_RegistrationInstance_Proxy(
    ITRequestEvent *This, __LONG32 *plRegistrationInstance);
void __RPC_STUB ITRequestEvent_get_RegistrationInstance_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITRequestEvent_get_RequestMode_Proxy(ITRequestEvent *This,
                                                    __LONG32 *plRequestMode);
void __RPC_STUB ITRequestEvent_get_RequestMode_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITRequestEvent_get_DestAddress_Proxy(ITRequestEvent *This,
                                                    BSTR *ppDestAddress);
void __RPC_STUB ITRequestEvent_get_DestAddress_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITRequestEvent_get_AppName_Proxy(ITRequestEvent *This,
                                                BSTR *ppAppName);
void __RPC_STUB ITRequestEvent_get_AppName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITRequestEvent_get_CalledParty_Proxy(ITRequestEvent *This,
                                                    BSTR *ppCalledParty);
void __RPC_STUB ITRequestEvent_get_CalledParty_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITRequestEvent_get_Comment_Proxy(ITRequestEvent *This,
                                                BSTR *ppComment);
...
typedef struct ITCollectionVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITCollection *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITCollection *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITCollection *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITCollection *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *get_Count)(ITCollection *This, __LONG32 *lCount);
  HRESULT(WINAPI *get_Item)(ITCollection *This, __LONG32 Index,
                            VARIANT *pVariant);
...
#define ITCollection_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                  \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITCollection_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,        \
                                   rgDispId)                                   \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITCollection_Invoke(This, dispIdMember, riid, lcid, wFlags,            \
                            pDispParams, pVarResult, pExcepInfo, puArgErr)     \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI ITCollection_get_Count_Proxy(ITCollection *This,
                                            __LONG32 *lCount);
void __RPC_STUB ITCollection_get_Count_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITCollection_get_Item_Proxy(ITCollection *This, __LONG32 Index,
                                           VARIANT *pVariant);
void __RPC_STUB ITCollection_get_Item_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITCollection_get__NewEnum_Proxy(ITCollection *This,
                                               IUnknown **ppNewEnum);
...
typedef struct ITCollection2Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITCollection2 *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITCollection2 *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITCollection2 *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITCollection2 *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  HRESULT(WINAPI *get_Count)(ITCollection2 *This, __LONG32 *lCount);
  HRESULT(WINAPI *get_Item)(ITCollection2 *This, __LONG32 Index,
                            VARIANT *pVariant);
...
#define ITCollection2_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                 \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITCollection2_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,       \
                                    rgDispId)                                  \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITCollection2_Invoke(This, dispIdMember, riid, lcid, wFlags,           \
                             pDispParams, pVarResult, pExcepInfo, puArgErr)    \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI ITCollection2_Add_Proxy(ITCollection2 *This, __LONG32 Index,
                                       VARIANT *pVariant);
void __RPC_STUB ITCollection2_Add_Stub(IRpcStubBuffer *This,
                                       IRpcChannelBuffer *_pRpcChannelBuffer,
                                       PRPC_MESSAGE _pRpcMessage,
                                       DWORD *_pdwStubPhase);
HRESULT WINAPI ITCollection2_Remove_Proxy(ITCollection2 *This, __LONG32 Index);
void __RPC_STUB ITCollection2_Remove_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
#endif
...
public:
  ...
  virtual HRESULT WINAPI SetForwardType(__LONG32 ForwardType, BSTR pDestAddress,
                                        BSTR pCallerAddress) = 0;
  virtual HRESULT WINAPI get_ForwardTypeDestination(__LONG32 ForwardType,
                                                    BSTR *ppDestAddress) = 0;
  virtual HRESULT WINAPI get_ForwardTypeCaller(__LONG32 Forwardtype,
                                               BSTR *ppCallerAddress) = 0;
  virtual HRESULT WINAPI GetForwardType(__LONG32 ForwardType,
...
typedef struct ITForwardInformationVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITForwardInformation *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITForwardInformation *This, UINT iTInfo,
                               LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITForwardInformation *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITForwardInformation *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *put_NumRingsNoAnswer)(ITForwardInformation *This,
                                        __LONG32 lNumRings);
  HRESULT(WINAPI *get_NumRingsNoAnswer)(ITForwardInformation *This,
                                        __LONG32 *plNumRings);
  HRESULT(WINAPI *SetForwardType)(ITForwardInformation *This,
                                  __LONG32 ForwardType, BSTR pDestAddress,
                                  BSTR pCallerAddress);
  HRESULT(WINAPI *get_ForwardTypeDestination)(ITForwardInformation *This,
                                              __LONG32 ForwardType,
                                              BSTR *ppDestAddress);
  HRESULT(WINAPI *get_ForwardTypeCaller)(ITForwardInformation *This,
                                         __LONG32 Forwardtype,
                                         BSTR *ppCallerAddress);
  HRESULT(WINAPI *GetForwardType)(ITForwardInformation *This,
                                  __LONG32 ForwardType,
                                  BSTR *ppDestinationAddress,
                                  BSTR *ppCallerAddress);
...
#define ITForwardInformation_GetTypeInfo(This, iTInfo, lcid, ppTInfo)          \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITForwardInformation_GetIDsOfNames(This, riid, rgszNames, cNames,      \
                                           lcid, rgDispId)                     \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITForwardInformation_Invoke(This, dispIdMember, riid, lcid, wFlags,    \
                                    pDispParams, pVarResult, pExcepInfo,       \
                                    puArgErr)                                  \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#define ITForwardInformation_SetForwardType(This, ForwardType, pDestAddress,   \
                                            pCallerAddress)                    \
  (This)->lpVtbl->SetForwardType(This, ForwardType, pDestAddress,              \
                                 pCallerAddress)
#define ITForwardInformation_get_ForwardTypeDestination(This, ForwardType,     \
                                                        ppDestAddress)         \
  (This)->lpVtbl->get_ForwardTypeDestination(This, ForwardType, ppDestAddress)
#define ITForwardInformation_get_ForwardTypeCaller(This, Forwardtype,          \
                                                   ppCallerAddress)            \
  (This)->lpVtbl->get_ForwardTypeCaller(This, Forwardtype, ppCallerAddress)
#define ITForwardInformation_GetForwardType(                                   \
    This, ForwardType, ppDestinationAddress, ppCallerAddress)                  \
  (This)->lpVtbl->GetForwardType(This, ForwardType, ppDestinationAddress,      \
                                 ppCallerAddress)
#define ITForwardInformation_Clear(This) (This)->lpVtbl->Clear(This)
#endif
#endif
HRESULT WINAPI ITForwardInformation_put_NumRingsNoAnswer_Proxy(
    ITForwardInformation *This, __LONG32 lNumRings);
void __RPC_STUB ITForwardInformation_put_NumRingsNoAnswer_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITForwardInformation_get_NumRingsNoAnswer_Proxy(
    ITForwardInformation *This, __LONG32 *plNumRings);
void __RPC_STUB ITForwardInformation_get_NumRingsNoAnswer_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITForwardInformation_SetForwardType_Proxy(
    ITForwardInformation *This, __LONG32 ForwardType, BSTR pDestAddress,
    BSTR pCallerAddress);
void __RPC_STUB ITForwardInformation_SetForwardType_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITForwardInformation_get_ForwardTypeDestination_Proxy(
    ITForwardInformation *This, __LONG32 ForwardType, BSTR *ppDestAddress);
void __RPC_STUB ITForwardInformation_get_ForwardTypeDestination_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITForwardInformation_get_ForwardTypeCaller_Proxy(
    ITForwardInformation *This, __LONG32 Forwardtype, BSTR *ppCallerAddress);
void __RPC_STUB ITForwardInformation_get_ForwardTypeCaller_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITForwardInformation_GetForwardType_Proxy(
    ITForwardInformation *This, __LONG32 ForwardType,
    BSTR *ppDestinationAddress, BSTR *ppCallerAddress);
...
public:
  virtual HRESULT WINAPI SetForwardType2(__LONG32 ForwardType,
                                         BSTR pDestAddress,
                                         __LONG32 DestAddressType,
                                         BSTR pCallerAddress,
                                         __LONG32 CallerAddressType) = 0;
  virtual HRESULT WINAPI GetForwardType2(__LONG32 ForwardType,
                                         BSTR *ppDestinationAddress,
                                         __LONG32 *pDestAddressType,
                                         BSTR *ppCallerAddress,
                                         __LONG32 *pCallerAddressType) = 0;
  virtual HRESULT WINAPI get_ForwardTypeDestinationAddressType(
      __LONG32 ForwardType, __LONG32 *pDestAddressType) = 0;
  virtual HRESULT WINAPI get_ForwardTypeCallerAddressType(
      __LONG32 Forwardtype, __LONG32 *pCallerAddressType) = 0;
};
#else
typedef struct ITForwardInformation2Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITForwardInformation2 *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITForwardInformation2 *This, UINT iTInfo,
                               LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITForwardInformation2 *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITForwardInformation2 *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *put_NumRingsNoAnswer)(ITForwardInformation2 *This,
                                        __LONG32 lNumRings);
  HRESULT(WINAPI *get_NumRingsNoAnswer)(ITForwardInformation2 *This,
                                        __LONG32 *plNumRings);
  HRESULT(WINAPI *SetForwardType)(ITForwardInformation2 *This,
                                  __LONG32 ForwardType, BSTR pDestAddress,
                                  BSTR pCallerAddress);
  HRESULT(WINAPI *get_ForwardTypeDestination)(ITForwardInformation2 *This,
                                              __LONG32 ForwardType,
                                              BSTR *ppDestAddress);
  HRESULT(WINAPI *get_ForwardTypeCaller)(ITForwardInformation2 *This,
                                         __LONG32 Forwardtype,
                                         BSTR *ppCallerAddress);
  HRESULT(WINAPI *GetForwardType)(ITForwardInformation2 *This,
                                  __LONG32 ForwardType,
                                  BSTR *ppDestinationAddress,
                                  BSTR *ppCallerAddress);
  HRESULT(WINAPI *Clear)(ITForwardInformation2 *This);
  HRESULT(WINAPI *SetForwardType2)(ITForwardInformation2 *This,
                                   __LONG32 ForwardType, BSTR pDestAddress,
                                   __LONG32 DestAddressType,
                                   BSTR pCallerAddress,
                                   __LONG32 CallerAddressType);
  HRESULT(WINAPI *GetForwardType2)(ITForwardInformation2 *This,
                                   __LONG32 ForwardType,
                                   BSTR *ppDestinationAddress,
                                   __LONG32 *pDestAddressType,
                                   BSTR *ppCallerAddress,
                                   __LONG32 *pCallerAddressType);
  HRESULT(WINAPI *get_ForwardTypeDestinationAddressType)(
      ITForwardInformation2 *This, __LONG32 ForwardType,
      __LONG32 *pDestAddressType);
  HRESULT(WINAPI *get_ForwardTypeCallerAddressType)(
      ITForwardInformation2 *This, __LONG32 Forwardtype,
      __LONG32 *pCallerAddressType);
  END_INTERFACE
...
#define ITForwardInformation2_GetTypeInfo(This, iTInfo, lcid, ppTInfo)         \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITForwardInformation2_GetIDsOfNames(This, riid, rgszNames, cNames,     \
                                            lcid, rgDispId)                    \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITForwardInformation2_Invoke(This, dispIdMember, riid, lcid, wFlags,   \
                                     pDispParams, pVarResult, pExcepInfo,      \
                                     puArgErr)                                 \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#define ITForwardInformation2_get_NumRingsNoAnswer(This, plNumRings)           \
  (This)->lpVtbl->get_NumRingsNoAnswer(This, plNumRings)
#define ITForwardInformation2_SetForwardType(This, ForwardType, pDestAddress,  \
                                             pCallerAddress)                   \
  (This)->lpVtbl->SetForwardType(This, ForwardType, pDestAddress,              \
                                 pCallerAddress)
#define ITForwardInformation2_get_ForwardTypeDestination(This, ForwardType,    \
                                                         ppDestAddress)        \
  (This)->lpVtbl->get_ForwardTypeDestination(This, ForwardType, ppDestAddress)
#define ITForwardInformation2_get_ForwardTypeCaller(This, Forwardtype,         \
                                                    ppCallerAddress)           \
  (This)->lpVtbl->get_ForwardTypeCaller(This, Forwardtype, ppCallerAddress)
#define ITForwardInformation2_GetForwardType(                                  \
    This, ForwardType, ppDestinationAddress, ppCallerAddress)                  \
  (This)->lpVtbl->GetForwardType(This, ForwardType, ppDestinationAddress,      \
                                 ppCallerAddress)
#define ITForwardInformation2_Clear(This) (This)->lpVtbl->Clear(This)
#define ITForwardInformation2_SetForwardType2(This, ForwardType, pDestAddress, \
                                              DestAddressType, pCallerAddress, \
                                              CallerAddressType)               \
  (This)->lpVtbl->SetForwardType2(This, ForwardType, pDestAddress,             \
                                  DestAddressType, pCallerAddress,             \
                                  CallerAddressType)
#define ITForwardInformation2_GetForwardType2(                                 \
    This, ForwardType, ppDestinationAddress, pDestAddressType,                 \
    ppCallerAddress, pCallerAddressType)                                       \
  (This)->lpVtbl->GetForwardType2(This, ForwardType, ppDestinationAddress,     \
                                  pDestAddressType, ppCallerAddress,           \
                                  pCallerAddressType)
#define ITForwardInformation2_get_ForwardTypeDestinationAddressType(           \
    This, ForwardType, pDestAddressType)                                       \
  (This)->lpVtbl->get_ForwardTypeDestinationAddressType(This, ForwardType,     \
                                                        pDestAddressType)
#define ITForwardInformation2_get_ForwardTypeCallerAddressType(                \
    This, Forwardtype, pCallerAddressType)                                     \
  (This)->lpVtbl->get_ForwardTypeCallerAddressType(This, Forwardtype,          \
                                                   pCallerAddressType)
#endif
#endif
HRESULT WINAPI ITForwardInformation2_SetForwardType2_Proxy(
    ITForwardInformation2 *This, __LONG32 ForwardType, BSTR pDestAddress,
    __LONG32 DestAddressType, BSTR pCallerAddress, __LONG32 CallerAddressType);
void __RPC_STUB ITForwardInformation2_SetForwardType2_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITForwardInformation2_GetForwardType2_Proxy(
    ITForwardInformation2 *This, __LONG32 ForwardType,
    BSTR *ppDestinationAddress, __LONG32 *pDestAddressType,
    BSTR *ppCallerAddress, __LONG32 *pCallerAddressType);
void __RPC_STUB ITForwardInformation2_GetForwardType2_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
ITForwardInformation2_get_ForwardTypeDestinationAddressType_Proxy(
    ITForwardInformation2 *This, __LONG32 ForwardType,
    __LONG32 *pDestAddressType);
void __RPC_STUB
ITForwardInformation2_get_ForwardTypeDestinationAddressType_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITForwardInformation2_get_ForwardTypeCallerAddressType_Proxy(
    ITForwardInformation2 *This, __LONG32 Forwardtype,
    __LONG32 *pCallerAddressType);
...
public:
  virtual HRESULT WINAPI TranslateAddress(
      BSTR pAddressToTranslate, __LONG32 lCard, __LONG32 lTranslateOptions,
      ITAddressTranslationInfo **ppTranslated) = 0;
  virtual HRESULT WINAPI TranslateDialog(TAPIHWND hwndOwner,
                                         BSTR pAddressIn) = 0;
  ...
  virtual HRESULT WINAPI
  EnumerateCallingCards(IEnumCallingCard **ppEnumCallingCard) = 0;
  virtual HRESULT WINAPI get_CallingCards(VARIANT *pVariant) = 0;
};
#else
typedef struct ITAddressTranslationVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITAddressTranslation *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITAddressTranslation *This, UINT iTInfo,
                               LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITAddressTranslation *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITAddressTranslation *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *TranslateAddress)(ITAddressTranslation *This,
                                    BSTR pAddressToTranslate, __LONG32 lCard,
                                    __LONG32 lTranslateOptions,
                                    ITAddressTranslationInfo **ppTranslated);
  HRESULT(WINAPI *TranslateDialog)(ITAddressTranslation *This,
                                   TAPIHWND hwndOwner, BSTR pAddressIn);
  HRESULT(WINAPI *EnumerateLocations)(ITAddressTranslation *This,
                                      IEnumLocation **ppEnumLocation);
  HRESULT(WINAPI *get_Locations)(ITAddressTranslation *This, VARIANT *pVariant);
  HRESULT(WINAPI *EnumerateCallingCards)(ITAddressTranslation *This,
                                         IEnumCallingCard **ppEnumCallingCard);
  HRESULT(WINAPI *get_CallingCards)(ITAddressTranslation *This,
                                    VARIANT *pVariant);
  END_INTERFACE
...
#define ITAddressTranslation_GetTypeInfo(This, iTInfo, lcid, ppTInfo)          \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITAddressTranslation_GetIDsOfNames(This, riid, rgszNames, cNames,      \
                                           lcid, rgDispId)                     \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITAddressTranslation_Invoke(This, dispIdMember, riid, lcid, wFlags,    \
                                    pDispParams, pVarResult, pExcepInfo,       \
                                    puArgErr)                                  \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
#define ITAddressTranslation_TranslateAddress(                                 \
    This, pAddressToTranslate, lCard, lTranslateOptions, ppTranslated)         \
  (This)->lpVtbl->TranslateAddress(This, pAddressToTranslate, lCard,           \
                                   lTranslateOptions, ppTranslated)
...
#endif
#endif
HRESULT WINAPI ITAddressTranslation_TranslateAddress_Proxy(
    ITAddressTranslation *This, BSTR pAddressToTranslate, __LONG32 lCard,
    __LONG32 lTranslateOptions, ITAddressTranslationInfo **ppTranslated);
void __RPC_STUB ITAddressTranslation_TranslateAddress_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAddressTranslation_TranslateDialog_Proxy(
    ITAddressTranslation *This, TAPIHWND hwndOwner, BSTR pAddressIn);
void __RPC_STUB ITAddressTranslation_TranslateDialog_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAddressTranslation_EnumerateLocations_Proxy(
    ITAddressTranslation *This, IEnumLocation **ppEnumLocation);
void __RPC_STUB ITAddressTranslation_EnumerateLocations_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAddressTranslation_get_Locations_Proxy(
    ITAddressTranslation *This, VARIANT *pVariant);
void __RPC_STUB ITAddressTranslation_get_Locations_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAddressTranslation_EnumerateCallingCards_Proxy(
    ITAddressTranslation *This, IEnumCallingCard **ppEnumCallingCard);
void __RPC_STUB ITAddressTranslation_EnumerateCallingCards_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAddressTranslation_get_CallingCards_Proxy(
    ITAddressTranslation *This, VARIANT *pVariant);
...
typedef struct ITAddressTranslationInfoVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITAddressTranslationInfo *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ITAddressTranslationInfo *This);
  ULONG(WINAPI *Release)(ITAddressTranslationInfo *This);
  HRESULT(WINAPI *GetTypeInfoCount)(ITAddressTranslationInfo *This,
                                    UINT *pctinfo);
  HRESULT(WINAPI *GetTypeInfo)(ITAddressTranslationInfo *This, UINT iTInfo,
                               LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITAddressTranslationInfo *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITAddressTranslationInfo *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *get_DialableString)(ITAddressTranslationInfo *This,
                                      BSTR *ppDialableString);
  HRESULT(WINAPI *get_DisplayableString)(ITAddressTranslationInfo *This,
                                         BSTR *ppDisplayableString);
  HRESULT(WINAPI *get_CurrentCountryCode)(ITAddressTranslationInfo *This,
                                          __LONG32 *CountryCode);
  HRESULT(WINAPI *get_DestinationCountryCode)(ITAddressTranslationInfo *This,
                                              __LONG32 *CountryCode);
  HRESULT(WINAPI *get_TranslationResults)(ITAddressTranslationInfo *This,
                                          __LONG32 *plResults);
  END_INTERFACE
...
#define ITAddressTranslationInfo_GetTypeInfo(This, iTInfo, lcid, ppTInfo)      \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITAddressTranslationInfo_GetIDsOfNames(This, riid, rgszNames, cNames,  \
                                               lcid, rgDispId)                 \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITAddressTranslationInfo_Invoke(This, dispIdMember, riid, lcid,        \
                                        wFlags, pDispParams, pVarResult,       \
                                        pExcepInfo, puArgErr)                  \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#define ITAddressTranslationInfo_get_DisplayableString(This,                   \
                                                       ppDisplayableString)    \
...
#endif
#endif
HRESULT WINAPI ITAddressTranslationInfo_get_DialableString_Proxy(
    ITAddressTranslationInfo *This, BSTR *ppDialableString);
void __RPC_STUB ITAddressTranslationInfo_get_DialableString_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAddressTranslationInfo_get_DisplayableString_Proxy(
    ITAddressTranslationInfo *This, BSTR *ppDisplayableString);
void __RPC_STUB ITAddressTranslationInfo_get_DisplayableString_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAddressTranslationInfo_get_CurrentCountryCode_Proxy(
    ITAddressTranslationInfo *This, __LONG32 *CountryCode);
void __RPC_STUB ITAddressTranslationInfo_get_CurrentCountryCode_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAddressTranslationInfo_get_DestinationCountryCode_Proxy(
    ITAddressTranslationInfo *This, __LONG32 *CountryCode);
void __RPC_STUB ITAddressTranslationInfo_get_DestinationCountryCode_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITAddressTranslationInfo_get_TranslationResults_Proxy(
    ITAddressTranslationInfo *This, __LONG32 *plResults);
...
typedef struct ITLocationInfoVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITLocationInfo *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITLocationInfo *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITLocationInfo *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITLocationInfo *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *get_PermanentLocationID)(ITLocationInfo *This,
                                           __LONG32 *plLocationID);
  HRESULT(WINAPI *get_CountryCode)(ITLocationInfo *This,
                                   __LONG32 *plCountryCode);
  ...
  HRESULT(WINAPI *get_PreferredCardID)(ITLocationInfo *This,
                                       __LONG32 *plCardID);
  ...
  HRESULT(WINAPI *get_LongDistanceAccessCode)(ITLocationInfo *This,
                                              BSTR *ppCode);
  HRESULT(WINAPI *get_TollPrefixList)(ITLocationInfo *This, BSTR *ppTollList);
  HRESULT(WINAPI *get_CancelCallWaitingCode)(ITLocationInfo *This,
                                             BSTR *ppCode);
  END_INTERFACE
} ITLocationInfoVtbl;
...
#define ITLocationInfo_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITLocationInfo_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,      \
                                     rgDispId)                                 \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITLocationInfo_Invoke(This, dispIdMember, riid, lcid, wFlags,          \
                              pDispParams, pVarResult, pExcepInfo, puArgErr)   \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
HRESULT
    WINAPI ITLocationInfo_get_PermanentLocationID_Proxy(ITLocationInfo *This,
                                                        __LONG32 *plLocationID);
void __RPC_STUB ITLocationInfo_get_PermanentLocationID_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITLocationInfo_get_CountryCode_Proxy(ITLocationInfo *This,
                                                    __LONG32 *plCountryCode);
void __RPC_STUB ITLocationInfo_get_CountryCode_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITLocationInfo_get_CountryID_Proxy(ITLocationInfo *This,
                                                  __LONG32 *plCountryID);
void __RPC_STUB ITLocationInfo_get_CountryID_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITLocationInfo_get_Options_Proxy(ITLocationInfo *This,
                                                __LONG32 *plOptions);
void __RPC_STUB ITLocationInfo_get_Options_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITLocationInfo_get_PreferredCardID_Proxy(ITLocationInfo *This,
                                                        __LONG32 *plCardID);
void __RPC_STUB ITLocationInfo_get_PreferredCardID_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITLocationInfo_get_LocationName_Proxy(ITLocationInfo *This,
                                                     BSTR *ppLocationName);
void __RPC_STUB ITLocationInfo_get_LocationName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITLocationInfo_get_CityCode_Proxy(ITLocationInfo *This,
                                                 BSTR *ppCode);
void __RPC_STUB ITLocationInfo_get_CityCode_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITLocationInfo_get_LocalAccessCode_Proxy(ITLocationInfo *This,
                                                        BSTR *ppCode);
void __RPC_STUB ITLocationInfo_get_LocalAccessCode_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITLocationInfo_get_LongDistanceAccessCode_Proxy(
    ITLocationInfo *This, BSTR *ppCode);
void __RPC_STUB ITLocationInfo_get_LongDistanceAccessCode_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITLocationInfo_get_TollPrefixList_Proxy(ITLocationInfo *This,
                                                       BSTR *ppTollList);
void __RPC_STUB ITLocationInfo_get_TollPrefixList_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITLocationInfo_get_CancelCallWaitingCode_Proxy(
    ITLocationInfo *This, BSTR *ppCode);
...
public:
  virtual HRESULT WINAPI Next(ULONG celt, ITLocationInfo **ppElements,
                              ULONG *pceltFetched) = 0;
  virtual HRESULT WINAPI Reset(void) = 0;
  virtual HRESULT WINAPI Skip(ULONG celt) = 0;
...
typedef struct IEnumLocationVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IEnumLocation *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IEnumLocation *This);
  ULONG(WINAPI *Release)(IEnumLocation *This);
  HRESULT(WINAPI *Next)(IEnumLocation *This, ULONG celt,
                        ITLocationInfo **ppElements, ULONG *pceltFetched);
...
#endif
#endif
HRESULT WINAPI IEnumLocation_Next_Proxy(IEnumLocation *This, ULONG celt,
                                        ITLocationInfo **ppElements,
                                        ULONG *pceltFetched);
void __RPC_STUB IEnumLocation_Next_Stub(IRpcStubBuffer *This,
                                        IRpcChannelBuffer *_pRpcChannelBuffer,
                                        PRPC_MESSAGE _pRpcMessage,
                                        DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumLocation_Reset_Proxy(IEnumLocation *This);
void __RPC_STUB IEnumLocation_Reset_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumLocation_Skip_Proxy(IEnumLocation *This, ULONG celt);
void __RPC_STUB IEnumLocation_Skip_Stub(IRpcStubBuffer *This,
                                        IRpcChannelBuffer *_pRpcChannelBuffer,
                                        PRPC_MESSAGE _pRpcMessage,
                                        DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumLocation_Clone_Proxy(IEnumLocation *This,
                                         IEnumLocation **ppEnum);
void __RPC_STUB IEnumLocation_Clone_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
#endif
...
typedef struct ITCallingCardVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITCallingCard *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITCallingCard *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITCallingCard *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITCallingCard *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  ...
  HRESULT(WINAPI *get_LongDistanceDialingRule)(ITCallingCard *This,
                                               BSTR *ppRule);
  HRESULT(WINAPI *get_InternationalDialingRule)(ITCallingCard *This,
                                                BSTR *ppRule);
  END_INTERFACE
} ITCallingCardVtbl;
...
#define ITCallingCard_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                 \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITCallingCard_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,       \
                                    rgDispId)                                  \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITCallingCard_Invoke(This, dispIdMember, riid, lcid, wFlags,           \
                             pDispParams, pVarResult, pExcepInfo, puArgErr)    \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI ITCallingCard_get_PermanentCardID_Proxy(ITCallingCard *This,
                                                       __LONG32 *plCardID);
void __RPC_STUB ITCallingCard_get_PermanentCardID_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITCallingCard_get_NumberOfDigits_Proxy(ITCallingCard *This,
                                                      __LONG32 *plDigits);
void __RPC_STUB ITCallingCard_get_NumberOfDigits_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITCallingCard_get_Options_Proxy(ITCallingCard *This,
                                               __LONG32 *plOptions);
void __RPC_STUB ITCallingCard_get_Options_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITCallingCard_get_CardName_Proxy(ITCallingCard *This,
                                                BSTR *ppCardName);
void __RPC_STUB ITCallingCard_get_CardName_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITCallingCard_get_SameAreaDialingRule_Proxy(ITCallingCard *This,
                                                           BSTR *ppRule);
void __RPC_STUB ITCallingCard_get_SameAreaDialingRule_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITCallingCard_get_LongDistanceDialingRule_Proxy(
    ITCallingCard *This, BSTR *ppRule);
void __RPC_STUB ITCallingCard_get_LongDistanceDialingRule_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITCallingCard_get_InternationalDialingRule_Proxy(
    ITCallingCard *This, BSTR *ppRule);
...
public:
  virtual HRESULT WINAPI Next(ULONG celt, ITCallingCard **ppElements,
                              ULONG *pceltFetched) = 0;
  virtual HRESULT WINAPI Reset(void) = 0;
  virtual HRESULT WINAPI Skip(ULONG celt) = 0;
...
typedef struct IEnumCallingCardVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IEnumCallingCard *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IEnumCallingCard *This);
  ULONG(WINAPI *Release)(IEnumCallingCard *This);
  HRESULT(WINAPI *Next)(IEnumCallingCard *This, ULONG celt,
                        ITCallingCard **ppElements, ULONG *pceltFetched);
...
#endif
#endif
HRESULT WINAPI IEnumCallingCard_Next_Proxy(IEnumCallingCard *This, ULONG celt,
                                           ITCallingCard **ppElements,
                                           ULONG *pceltFetched);
...
void __RPC_STUB IEnumCallingCard_Skip_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumCallingCard_Clone_Proxy(IEnumCallingCard *This,
                                            IEnumCallingCard **ppEnum);
...
public:
  virtual HRESULT WINAPI get_Call(ITCallInfo **ppCall) = 0;
  virtual HRESULT WINAPI
  get_Event(CALL_NOTIFICATION_EVENT *pCallNotificationEvent) = 0;
  virtual HRESULT WINAPI get_CallbackInstance(__LONG32 *plCallbackInstance) = 0;
};
#else
typedef struct ITCallNotificationEventVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITCallNotificationEvent *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ITCallNotificationEvent *This);
  ULONG(WINAPI *Release)(ITCallNotificationEvent *This);
  HRESULT(WINAPI *GetTypeInfoCount)(ITCallNotificationEvent *This,
                                    UINT *pctinfo);
  HRESULT(WINAPI *GetTypeInfo)(ITCallNotificationEvent *This, UINT iTInfo,
                               LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITCallNotificationEvent *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITCallNotificationEvent *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *get_Call)(ITCallNotificationEvent *This, ITCallInfo **ppCall);
  HRESULT(WINAPI *get_Event)(ITCallNotificationEvent *This,
                             CALL_NOTIFICATION_EVENT *pCallNotificationEvent);
  HRESULT(WINAPI *get_CallbackInstance)(ITCallNotificationEvent *This,
                                        __LONG32 *plCallbackInstance);
  END_INTERFACE
...
#define ITCallNotificationEvent_GetTypeInfo(This, iTInfo, lcid, ppTInfo)       \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITCallNotificationEvent_GetIDsOfNames(This, riid, rgszNames, cNames,   \
                                              lcid, rgDispId)                  \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITCallNotificationEvent_Invoke(This, dispIdMember, riid, lcid, wFlags, \
                                       pDispParams, pVarResult, pExcepInfo,    \
                                       puArgErr)                               \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
HRESULT
    WINAPI ITCallNotificationEvent_get_Call_Proxy(ITCallNotificationEvent *This,
                                                  ITCallInfo **ppCall);
void __RPC_STUB ITCallNotificationEvent_get_Call_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITCallNotificationEvent_get_Event_Proxy(
    ITCallNotificationEvent *This,
    CALL_NOTIFICATION_EVENT *pCallNotificationEvent);
void __RPC_STUB ITCallNotificationEvent_get_Event_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITCallNotificationEvent_get_CallbackInstance_Proxy(
    ITCallNotificationEvent *This, __LONG32 *plCallbackInstance);
...
public:
  virtual HRESULT WINAPI
  QueryDispatchInterface(BSTR pIID, IDispatch *pInterfaceToMap,
                         IDispatch **ppReturnedInterface) = 0;
};
#else
typedef struct ITDispatchMapperVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITDispatchMapper *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITDispatchMapper *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITDispatchMapper *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITDispatchMapper *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *QueryDispatchInterface)(ITDispatchMapper *This, BSTR pIID,
...
#define ITDispatchMapper_GetTypeInfo(This, iTInfo, lcid, ppTInfo)              \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITDispatchMapper_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,    \
                                       rgDispId)                               \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITDispatchMapper_Invoke(This, dispIdMember, riid, lcid, wFlags,        \
                                pDispParams, pVarResult, pExcepInfo, puArgErr) \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
#define ITDispatchMapper_QueryDispatchInterface(This, pIID, pInterfaceToMap,   \
                                                ppReturnedInterface)           \
  (This)->lpVtbl->QueryDispatchInterface(This, pIID, pInterfaceToMap,          \
                                         ppReturnedInterface)
#endif
#endif
HRESULT WINAPI ITDispatchMapper_QueryDispatchInterface_Proxy(
    ITDispatchMapper *This, BSTR pIID, IDispatch *pInterfaceToMap,
    IDispatch **ppReturnedInterface);
...
public:
  virtual HRESULT WINAPI CreateStream(__LONG32 lMediaType,
...
typedef struct ITStreamControlVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITStreamControl *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITStreamControl *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITStreamControl *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITStreamControl *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *CreateStream)(ITStreamControl *This, __LONG32 lMediaType,
                                TERMINAL_DIRECTION td, ITStream **ppStream);
  HRESULT(WINAPI *RemoveStream)(ITStreamControl *This, ITStream *pStream);
  HRESULT(WINAPI *EnumerateStreams)(ITStreamControl *This,
...
#define ITStreamControl_GetTypeInfo(This, iTInfo, lcid, ppTInfo)               \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITStreamControl_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,     \
                                      rgDispId)                                \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITStreamControl_Invoke(This, dispIdMember, riid, lcid, wFlags,         \
                               pDispParams, pVarResult, pExcepInfo, puArgErr)  \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI ITStreamControl_CreateStream_Proxy(ITStreamControl *This,
                                                  __LONG32 lMediaType,
                                                  TERMINAL_DIRECTION td,
                                                  ITStream **ppStream);
void __RPC_STUB ITStreamControl_CreateStream_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITStreamControl_RemoveStream_Proxy(ITStreamControl *This,
                                                  ITStream *pStream);
void __RPC_STUB ITStreamControl_RemoveStream_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITStreamControl_EnumerateStreams_Proxy(
    ITStreamControl *This, IEnumStream **ppEnumStream);
void __RPC_STUB ITStreamControl_EnumerateStreams_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITStreamControl_get_Streams_Proxy(ITStreamControl *This,
                                                 VARIANT *pVariant);
...
typedef struct ITStreamVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITStream *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITStream *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITStream *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITStream *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  ...
  HRESULT(WINAPI *EnumerateTerminals)(ITStream *This,
                                      IEnumTerminal **ppEnumTerminal);
...
#endif
#endif
HRESULT WINAPI ITStream_get_MediaType_Proxy(ITStream *This,
                                            __LONG32 *plMediaType);
void __RPC_STUB ITStream_get_MediaType_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITStream_get_Direction_Proxy(ITStream *This,
...
void __RPC_STUB ITStream_get_Name_Stub(IRpcStubBuffer *This,
                                       IRpcChannelBuffer *_pRpcChannelBuffer,
                                       PRPC_MESSAGE _pRpcMessage,
                                       DWORD *_pdwStubPhase);
HRESULT WINAPI ITStream_StartStream_Proxy(ITStream *This);
void __RPC_STUB ITStream_StartStream_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI ITStream_PauseStream_Proxy(ITStream *This);
void __RPC_STUB ITStream_PauseStream_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI ITStream_StopStream_Proxy(ITStream *This);
void __RPC_STUB ITStream_StopStream_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
HRESULT WINAPI ITStream_SelectTerminal_Proxy(ITStream *This,
                                             ITTerminal *pTerminal);
void __RPC_STUB ITStream_SelectTerminal_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITStream_UnselectTerminal_Proxy(ITStream *This,
                                               ITTerminal *pTerminal);
void __RPC_STUB ITStream_UnselectTerminal_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITStream_EnumerateTerminals_Proxy(
    ITStream *This, IEnumTerminal **ppEnumTerminal);
void __RPC_STUB ITStream_EnumerateTerminals_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITStream_get_Terminals_Proxy(ITStream *This,
                                            VARIANT *pTerminals);
...
public:
  virtual HRESULT WINAPI Next(ULONG celt, ITStream **ppElements,
                              ULONG *pceltFetched) = 0;
  virtual HRESULT WINAPI Reset(void) = 0;
  virtual HRESULT WINAPI Skip(ULONG celt) = 0;
...
typedef struct IEnumStreamVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IEnumStream *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IEnumStream *This);
  ULONG(WINAPI *Release)(IEnumStream *This);
  HRESULT(WINAPI *Next)(IEnumStream *This, ULONG celt, ITStream **ppElements,
                        ULONG *pceltFetched);
...
#endif
#endif
HRESULT WINAPI IEnumStream_Next_Proxy(IEnumStream *This, ULONG celt,
                                      ITStream **ppElements,
                                      ULONG *pceltFetched);
void __RPC_STUB IEnumStream_Next_Stub(IRpcStubBuffer *This,
                                      IRpcChannelBuffer *_pRpcChannelBuffer,
                                      PRPC_MESSAGE _pRpcMessage,
                                      DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumStream_Reset_Proxy(IEnumStream *This);
void __RPC_STUB IEnumStream_Reset_Stub(IRpcStubBuffer *This,
                                       IRpcChannelBuffer *_pRpcChannelBuffer,
                                       PRPC_MESSAGE _pRpcMessage,
                                       DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumStream_Skip_Proxy(IEnumStream *This, ULONG celt);
void __RPC_STUB IEnumStream_Skip_Stub(IRpcStubBuffer *This,
                                      IRpcChannelBuffer *_pRpcChannelBuffer,
                                      PRPC_MESSAGE _pRpcMessage,
                                      DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumStream_Clone_Proxy(IEnumStream *This, IEnumStream **ppEnum);
void __RPC_STUB IEnumStream_Clone_Stub(IRpcStubBuffer *This,
                                       IRpcChannelBuffer *_pRpcChannelBuffer,
                                       PRPC_MESSAGE _pRpcMessage,
                                       DWORD *_pdwStubPhase);
#endif
...
public:
  ...
  virtual HRESULT WINAPI
  EnumerateSubStreams(IEnumSubStream **ppEnumSubStream) = 0;
  virtual HRESULT WINAPI get_SubStreams(VARIANT *pVariant) = 0;
};
#else
typedef struct ITSubStreamControlVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITSubStreamControl *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITSubStreamControl *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITSubStreamControl *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITSubStreamControl *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *CreateSubStream)(ITSubStreamControl *This,
                                   ITSubStream **ppSubStream);
  HRESULT(WINAPI *RemoveSubStream)(ITSubStreamControl *This,
                                   ITSubStream *pSubStream);
  HRESULT(WINAPI *EnumerateSubStreams)(ITSubStreamControl *This,
                                       IEnumSubStream **ppEnumSubStream);
...
#define ITSubStreamControl_GetTypeInfo(This, iTInfo, lcid, ppTInfo)            \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITSubStreamControl_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,  \
                                         rgDispId)                             \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITSubStreamControl_Invoke(This, dispIdMember, riid, lcid, wFlags,      \
                                  pDispParams, pVarResult, pExcepInfo,         \
                                  puArgErr)                                    \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
HRESULT
    WINAPI ITSubStreamControl_CreateSubStream_Proxy(ITSubStreamControl *This,
                                                    ITSubStream **ppSubStream);
void __RPC_STUB ITSubStreamControl_CreateSubStream_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITSubStreamControl_RemoveSubStream_Proxy(
    ITSubStreamControl *This, ITSubStream *pSubStream);
void __RPC_STUB ITSubStreamControl_RemoveSubStream_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITSubStreamControl_EnumerateSubStreams_Proxy(
    ITSubStreamControl *This, IEnumSubStream **ppEnumSubStream);
void __RPC_STUB ITSubStreamControl_EnumerateSubStreams_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITSubStreamControl_get_SubStreams_Proxy(ITSubStreamControl *This,
                                                       VARIANT *pVariant);
...
typedef struct ITSubStreamVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITSubStream *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITSubStream *This, UINT iTInfo, LCID lcid,
                               ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITSubStream *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITSubStream *This, DISPID dispIdMember, REFIID riid,
                          LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
                          VARIANT *pVarResult, EXCEPINFO *pExcepInfo,
                          UINT *puArgErr);
  ...
  HRESULT(WINAPI *EnumerateTerminals)(ITSubStream *This,
                                      IEnumTerminal **ppEnumTerminal);
...
#define ITSubStream_GetTypeInfo(This, iTInfo, lcid, ppTInfo)                   \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITSubStream_GetIDsOfNames(This, riid, rgszNames, cNames, lcid,         \
                                  rgDispId)                                    \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITSubStream_Invoke(This, dispIdMember, riid, lcid, wFlags,             \
                           pDispParams, pVarResult, pExcepInfo, puArgErr)      \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
void __RPC_STUB ITSubStream_StopSubStream_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITSubStream_SelectTerminal_Proxy(ITSubStream *This,
                                                ITTerminal *pTerminal);
void __RPC_STUB ITSubStream_SelectTerminal_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITSubStream_UnselectTerminal_Proxy(ITSubStream *This,
                                                  ITTerminal *pTerminal);
void __RPC_STUB ITSubStream_UnselectTerminal_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITSubStream_EnumerateTerminals_Proxy(
    ITSubStream *This, IEnumTerminal **ppEnumTerminal);
void __RPC_STUB ITSubStream_EnumerateTerminals_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITSubStream_get_Terminals_Proxy(ITSubStream *This,
                                               VARIANT *pTerminals);
void __RPC_STUB ITSubStream_get_Terminals_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITSubStream_get_Stream_Proxy(ITSubStream *This,
                                            ITStream **ppITStream);
...
public:
  virtual HRESULT WINAPI Next(ULONG celt, ITSubStream **ppElements,
                              ULONG *pceltFetched) = 0;
  virtual HRESULT WINAPI Reset(void) = 0;
  virtual HRESULT WINAPI Skip(ULONG celt) = 0;
...
typedef struct IEnumSubStreamVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IEnumSubStream *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IEnumSubStream *This);
  ULONG(WINAPI *Release)(IEnumSubStream *This);
  HRESULT(WINAPI *Next)(IEnumSubStream *This, ULONG celt,
                        ITSubStream **ppElements, ULONG *pceltFetched);
...
#endif
#endif
HRESULT WINAPI IEnumSubStream_Next_Proxy(IEnumSubStream *This, ULONG celt,
                                         ITSubStream **ppElements,
                                         ULONG *pceltFetched);
void __RPC_STUB IEnumSubStream_Next_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumSubStream_Reset_Proxy(IEnumSubStream *This);
void __RPC_STUB IEnumSubStream_Reset_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumSubStream_Skip_Proxy(IEnumSubStream *This, ULONG celt);
void __RPC_STUB IEnumSubStream_Skip_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumSubStream_Clone_Proxy(IEnumSubStream *This,
                                          IEnumSubStream **ppEnum);
void __RPC_STUB IEnumSubStream_Clone_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
#endif
...
typedef struct ITLegacyWaveSupportVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITLegacyWaveSupport *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITLegacyWaveSupport *This, UINT iTInfo,
                               LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITLegacyWaveSupport *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITLegacyWaveSupport *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *IsFullDuplex)(ITLegacyWaveSupport *This,
...
#define ITLegacyWaveSupport_GetTypeInfo(This, iTInfo, lcid, ppTInfo)           \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITLegacyWaveSupport_GetIDsOfNames(This, riid, rgszNames, cNames, lcid, \
                                          rgDispId)                            \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITLegacyWaveSupport_Invoke(This, dispIdMember, riid, lcid, wFlags,     \
                                   pDispParams, pVarResult, pExcepInfo,        \
                                   puArgErr)                                   \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
HRESULT
    WINAPI ITLegacyWaveSupport_IsFullDuplex_Proxy(ITLegacyWaveSupport *This,
                                                  FULLDUPLEX_SUPPORT *pSupport);
...
public:
  virtual HRESULT WINAPI RequestTerminal(BSTR bstrTerminalClassGUID,
                                         __LONG32 lMediaType,
                                         TERMINAL_DIRECTION Direction,
                                         ITTerminal **ppTerminal) = 0;
...
typedef struct ITBasicCallControl2Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITBasicCallControl2 *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetTypeInfo)(ITBasicCallControl2 *This, UINT iTInfo,
                               LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITBasicCallControl2 *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITBasicCallControl2 *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  ...
  HRESULT(WINAPI *HandoffDirect)(ITBasicCallControl2 *This,
                                 BSTR pApplicationName);
  HRESULT(WINAPI *HandoffIndirect)(ITBasicCallControl2 *This,
                                   __LONG32 lMediaType);
  HRESULT(WINAPI *Conference)(ITBasicCallControl2 *This,
                              ITBasicCallControl *pCall, VARIANT_BOOL fSync);
  HRESULT(WINAPI *Transfer)(ITBasicCallControl2 *This,
                            ITBasicCallControl *pCall, VARIANT_BOOL fSync);
  HRESULT(WINAPI *BlindTransfer)(ITBasicCallControl2 *This, BSTR pDestAddress);
  HRESULT(WINAPI *SwapHold)(ITBasicCallControl2 *This,
                            ITBasicCallControl *pCall);
  HRESULT(WINAPI *ParkDirect)(ITBasicCallControl2 *This, BSTR pParkAddress);
  HRESULT(WINAPI *ParkIndirect)(ITBasicCallControl2 *This,
                                BSTR *ppNonDirAddress);
  HRESULT(WINAPI *Unpark)(ITBasicCallControl2 *This);
  HRESULT(WINAPI *SetQOS)(ITBasicCallControl2 *This, __LONG32 lMediaType,
                          QOS_SERVICE_LEVEL ServiceLevel);
  ...
  HRESULT(WINAPI *RequestTerminal)(ITBasicCallControl2 *This,
                                   BSTR bstrTerminalClassGUID,
                                   __LONG32 lMediaType,
                                   TERMINAL_DIRECTION Direction,
                                   ITTerminal **ppTerminal);
  HRESULT(WINAPI *SelectTerminalOnCall)(ITBasicCallControl2 *This,
                                        ITTerminal *pTerminal);
  HRESULT(WINAPI *UnselectTerminalOnCall)(ITBasicCallControl2 *This,
                                          ITTerminal *pTerminal);
  END_INTERFACE
...
#define ITBasicCallControl2_GetTypeInfo(This, iTInfo, lcid, ppTInfo)           \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITBasicCallControl2_GetIDsOfNames(This, riid, rgszNames, cNames, lcid, \
                                          rgDispId)                            \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITBasicCallControl2_Invoke(This, dispIdMember, riid, lcid, wFlags,     \
                                   pDispParams, pVarResult, pExcepInfo,        \
                                   puArgErr)                                   \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#define ITBasicCallControl2_RemoveFromConference(This)                         \
  (This)->lpVtbl->RemoveFromConference(This)
#define ITBasicCallControl2_RequestTerminal(This, bstrTerminalClassGUID,       \
                                            lMediaType, Direction, ppTerminal) \
  (This)->lpVtbl->RequestTerminal(This, bstrTerminalClassGUID, lMediaType,     \
                                  Direction, ppTerminal)
...
#endif
#endif
HRESULT WINAPI ITBasicCallControl2_RequestTerminal_Proxy(
    ITBasicCallControl2 *This, BSTR bstrTerminalClassGUID, __LONG32 lMediaType,
    TERMINAL_DIRECTION Direction, ITTerminal **ppTerminal);
void __RPC_STUB ITBasicCallControl2_RequestTerminal_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITBasicCallControl2_SelectTerminalOnCall_Proxy(
    ITBasicCallControl2 *This, ITTerminal *pTerminal);
void __RPC_STUB ITBasicCallControl2_SelectTerminalOnCall_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITBasicCallControl2_UnselectTerminalOnCall_Proxy(
    ITBasicCallControl2 *This, ITTerminal *pTerminal);
...
typedef struct ITScriptableAudioFormatVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ITScriptableAudioFormat *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ITScriptableAudioFormat *This);
  ULONG(WINAPI *Release)(ITScriptableAudioFormat *This);
  HRESULT(WINAPI *GetTypeInfoCount)(ITScriptableAudioFormat *This,
                                    UINT *pctinfo);
  HRESULT(WINAPI *GetTypeInfo)(ITScriptableAudioFormat *This, UINT iTInfo,
                               LCID lcid, ITypeInfo **ppTInfo);
  HRESULT(WINAPI *GetIDsOfNames)(ITScriptableAudioFormat *This, REFIID riid,
                                 LPOLESTR *rgszNames, UINT cNames, LCID lcid,
                                 DISPID *rgDispId);
  HRESULT(WINAPI *Invoke)(ITScriptableAudioFormat *This, DISPID dispIdMember,
                          REFIID riid, LCID lcid, WORD wFlags,
                          DISPPARAMS *pDispParams, VARIANT *pVarResult,
                          EXCEPINFO *pExcepInfo, UINT *puArgErr);
  HRESULT(WINAPI *get_Channels)(ITScriptableAudioFormat *This, __LONG32 *pVal);
  HRESULT(WINAPI *put_Channels)(ITScriptableAudioFormat *This,
                                const __LONG32 nNewVal);
  HRESULT(WINAPI *get_SamplesPerSec)(ITScriptableAudioFormat *This,
                                     __LONG32 *pVal);
  HRESULT(WINAPI *put_SamplesPerSec)(ITScriptableAudioFormat *This,
                                     const __LONG32 nNewVal);
  HRESULT(WINAPI *get_AvgBytesPerSec)(ITScriptableAudioFormat *This,
                                      __LONG32 *pVal);
  HRESULT(WINAPI *put_AvgBytesPerSec)(ITScriptableAudioFormat *This,
                                      const __LONG32 nNewVal);
  HRESULT(WINAPI *get_BlockAlign)(ITScriptableAudioFormat *This,
                                  __LONG32 *pVal);
  HRESULT(WINAPI *put_BlockAlign)(ITScriptableAudioFormat *This,
                                  const __LONG32 nNewVal);
  HRESULT(WINAPI *get_BitsPerSample)(ITScriptableAudioFormat *This,
                                     __LONG32 *pVal);
  HRESULT(WINAPI *put_BitsPerSample)(ITScriptableAudioFormat *This,
                                     const __LONG32 nNewVal);
  HRESULT(WINAPI *get_FormatTag)(ITScriptableAudioFormat *This, __LONG32 *pVal);
  HRESULT(WINAPI *put_FormatTag)(ITScriptableAudioFormat *This,
                                 const __LONG32 nNewVal);
  END_INTERFACE
...
#define ITScriptableAudioFormat_GetTypeInfo(This, iTInfo, lcid, ppTInfo)       \
  (This)->lpVtbl->GetTypeInfo(This, iTInfo, lcid, ppTInfo)
#define ITScriptableAudioFormat_GetIDsOfNames(This, riid, rgszNames, cNames,   \
                                              lcid, rgDispId)                  \
  (This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, rgDispId)
#define ITScriptableAudioFormat_Invoke(This, dispIdMember, riid, lcid, wFlags, \
                                       pDispParams, pVarResult, pExcepInfo,    \
                                       puArgErr)                               \
  (This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags, pDispParams,  \
                         pVarResult, pExcepInfo, puArgErr)
...
#endif
#endif
HRESULT WINAPI ITScriptableAudioFormat_get_Channels_Proxy(
    ITScriptableAudioFormat *This, __LONG32 *pVal);
void __RPC_STUB ITScriptableAudioFormat_get_Channels_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITScriptableAudioFormat_put_Channels_Proxy(
    ITScriptableAudioFormat *This, const __LONG32 nNewVal);
void __RPC_STUB ITScriptableAudioFormat_put_Channels_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITScriptableAudioFormat_get_SamplesPerSec_Proxy(
    ITScriptableAudioFormat *This, __LONG32 *pVal);
void __RPC_STUB ITScriptableAudioFormat_get_SamplesPerSec_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITScriptableAudioFormat_put_SamplesPerSec_Proxy(
    ITScriptableAudioFormat *This, const __LONG32 nNewVal);
void __RPC_STUB ITScriptableAudioFormat_put_SamplesPerSec_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITScriptableAudioFormat_get_AvgBytesPerSec_Proxy(
    ITScriptableAudioFormat *This, __LONG32 *pVal);
void __RPC_STUB ITScriptableAudioFormat_get_AvgBytesPerSec_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITScriptableAudioFormat_put_AvgBytesPerSec_Proxy(
    ITScriptableAudioFormat *This, const __LONG32 nNewVal);
void __RPC_STUB ITScriptableAudioFormat_put_AvgBytesPerSec_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITScriptableAudioFormat_get_BlockAlign_Proxy(
    ITScriptableAudioFormat *This, __LONG32 *pVal);
void __RPC_STUB ITScriptableAudioFormat_get_BlockAlign_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITScriptableAudioFormat_put_BlockAlign_Proxy(
    ITScriptableAudioFormat *This, const __LONG32 nNewVal);
void __RPC_STUB ITScriptableAudioFormat_put_BlockAlign_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITScriptableAudioFormat_get_BitsPerSample_Proxy(
    ITScriptableAudioFormat *This, __LONG32 *pVal);
void __RPC_STUB ITScriptableAudioFormat_get_BitsPerSample_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITScriptableAudioFormat_put_BitsPerSample_Proxy(
    ITScriptableAudioFormat *This, const __LONG32 nNewVal);
void __RPC_STUB ITScriptableAudioFormat_put_BitsPerSample_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITScriptableAudioFormat_get_FormatTag_Proxy(
    ITScriptableAudioFormat *This, __LONG32 *pVal);
void __RPC_STUB ITScriptableAudioFormat_get_FormatTag_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ITScriptableAudioFormat_put_FormatTag_Proxy(
    ITScriptableAudioFormat *This, const __LONG32 nNewVal);
...
unsigned char *__RPC_API VARIANT_UserMarshal(ULONG *, unsigned char *,
                                             VARIANT *);
