...
DEFINE_GUID(IID_IImgCtx, 0x3050f3d7, 0x98b5, 0x11cf, 0xbb, 0x82, 0x00, 0xaa,
            0x00, 0xbd, 0xce, 0x0b);
DECLARE_INTERFACE_(IImgCtx, IUnknown) {
  ...
  STDMETHOD(SelectChanges)(THIS_ ULONG ulChgOn, ULONG ulChgOff, WINBOOL fSignal)
      PURE;
  STDMETHOD(SetCallback)(THIS_ PFNIMGCTXCALLBACK pfn, void *pvPrivateData) PURE;
  STDMETHOD(Disconnect)(THIS) PURE;
  STDMETHOD(GetUpdateRects)(THIS_ struct tagRECT * prc, struct tagRECT * prcImg,
                            __LONG32 * pcrc) PURE;
  STDMETHOD(GetStateInfo)(THIS_ ULONG * pulState, struct tagSIZE * psize,
                          WINBOOL fClearChanges) PURE;
  STDMETHOD(GetPalette)(THIS_ HPALETTE * phpal) PURE;
  STDMETHOD(Draw)(THIS_ HDC hdc, struct tagRECT * prcBounds) PURE;
  STDMETHOD(Tile)(THIS_ HDC hdc, struct tagPOINT * pptBackOrg,
                  struct tagRECT * prcClip, struct tagSIZE * psize) PURE;
  STDMETHOD(StretchBlt)(THIS_ HDC hdc, int dstX, int dstY, int dstXE, int dstYE,
                        int srcX, int srcY, int srcXE, int srcYE, DWORD dwROP)
      PURE;
};
#ifdef COBJMACROS
...
#define IImgCtx_StretchBlt(This, hdc, dstX, dstY, dstXE, dstYE, srcX, srcY,    \
                           srcXE, srcYE, dwROP)                                \
  (This)->lpVtbl->StretchBlt(This, hdc, dstX, dstY, dstXE, dstYE, srcX, srcY,  \
                             srcXE, srcYE, dwROP)
#endif
DEFINE_GUID(CLSID_IImgCtx, 0x3050f3d6, 0x98b5, 0x11cf, 0xbb, 0x82, 0x00, 0xaa,
            0x00, 0xbd, 0xce, 0x0b);
#endif
