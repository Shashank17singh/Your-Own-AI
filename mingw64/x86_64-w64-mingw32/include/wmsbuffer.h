...
DEFINE_GUID(IID_INSSBuffer, 0xe1cd3524, 0x03d7, 0x11d2, 0x9e, 0xed, 0x00, 0x60,
            0x97, 0xd2, 0xd7, 0xcf);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("e1cd3524-03d7-11d2-9eed-006097d2d7cf")
INSSBuffer : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetLength(DWORD * pdwLength) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetLength(DWORD dwLength) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetMaxLength(DWORD * pdwLength) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetBuffer(BYTE * *ppdwBuffer) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetBufferAndLength(BYTE * *ppdwBuffer,
                                                       DWORD * pdwLength) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(INSSBuffer, 0xe1cd3524, 0x03d7, 0x11d2, 0x9e, 0xed, 0x00, 0x60,
                0x97, 0xd2, 0xd7, 0xcf)
#endif
#else
typedef struct INSSBufferVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INSSBuffer *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetBufferAndLength)(INSSBuffer *This,
                                                 BYTE **ppdwBuffer,
                                                 DWORD *pdwLength);
  END_INTERFACE
} INSSBufferVtbl;
interface INSSBuffer { CONST_VTBL INSSBufferVtbl *lpVtbl; };
#ifdef COBJMACROS
...
#else
/*** IUnknown methods ***/
static inline HRESULT INSSBuffer_QueryInterface(INSSBuffer *This, REFIID riid,
                                                void **ppvObject) {
...
static inline HRESULT INSSBuffer_GetMaxLength(INSSBuffer *This,
                                              DWORD *pdwLength) {
  return This->lpVtbl->GetMaxLength(This, pdwLength);
}
static inline HRESULT INSSBuffer_GetBuffer(INSSBuffer *This,
                                           BYTE **ppdwBuffer) {
  return This->lpVtbl->GetBuffer(This, ppdwBuffer);
}
static inline HRESULT INSSBuffer_GetBufferAndLength(INSSBuffer *This,
                                                    BYTE **ppdwBuffer,
                                                    DWORD *pdwLength) {
...
DEFINE_GUID(IID_INSSBuffer2, 0x4f528693, 0x1035, 0x43fe, 0xb4, 0x28, 0x75, 0x75,
            0x61, 0xad, 0x3a, 0x68);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("4f528693-1035-43fe-b428-757561ad3a68")
INSSBuffer2 : public INSSBuffer {
  virtual HRESULT STDMETHODCALLTYPE GetSampleProperties(DWORD size,
                                                        BYTE * props) = 0;
  virtual HRESULT STDMETHODCALLTYPE SetSampleProperties(DWORD size,
                                                        BYTE * props) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(INSSBuffer2, 0x4f528693, 0x1035, 0x43fe, 0xb4, 0x28, 0x75, 0x75,
                0x61, 0xad, 0x3a, 0x68)
#endif
#else
typedef struct INSSBuffer2Vtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INSSBuffer2 *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetBufferAndLength)(INSSBuffer2 *This,
                                                 BYTE **ppdwBuffer,
                                                 DWORD *pdwLength);
  /*** INSSBuffer2 methods ***/
  HRESULT(STDMETHODCALLTYPE *GetSampleProperties)(INSSBuffer2 *This, DWORD size,
                                                  BYTE *props);
  HRESULT(STDMETHODCALLTYPE *SetSampleProperties)(INSSBuffer2 *This, DWORD size,
                                                  BYTE *props);
  END_INTERFACE
} INSSBuffer2Vtbl;
interface INSSBuffer2 { CONST_VTBL INSSBuffer2Vtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define INSSBuffer2_GetBufferAndLength(This, ppdwBuffer, pdwLength)            \
  (This)->lpVtbl->GetBufferAndLength(This, ppdwBuffer, pdwLength)
/*** INSSBuffer2 methods ***/
#define INSSBuffer2_GetSampleProperties(This, size, props)                     \
  (This)->lpVtbl->GetSampleProperties(This, size, props)
#define INSSBuffer2_SetSampleProperties(This, size, props)                     \
  (This)->lpVtbl->SetSampleProperties(This, size, props)
#else
/*** IUnknown methods ***/
static inline HRESULT INSSBuffer2_QueryInterface(INSSBuffer2 *This, REFIID riid,
                                                 void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** INSSBuffer methods ***/
static inline HRESULT INSSBuffer2_GetLength(INSSBuffer2 *This,
                                            DWORD *pdwLength) {
  return This->lpVtbl->GetLength(This, pdwLength);
}
...
static inline HRESULT INSSBuffer2_GetMaxLength(INSSBuffer2 *This,
                                               DWORD *pdwLength) {
  return This->lpVtbl->GetMaxLength(This, pdwLength);
}
static inline HRESULT INSSBuffer2_GetBuffer(INSSBuffer2 *This,
                                            BYTE **ppdwBuffer) {
  return This->lpVtbl->GetBuffer(This, ppdwBuffer);
}
static inline HRESULT INSSBuffer2_GetBufferAndLength(INSSBuffer2 *This,
                                                     BYTE **ppdwBuffer,
                                                     DWORD *pdwLength) {
  return This->lpVtbl->GetBufferAndLength(This, ppdwBuffer, pdwLength);
}
/*** INSSBuffer2 methods ***/
static inline HRESULT INSSBuffer2_GetSampleProperties(INSSBuffer2 *This,
                                                      DWORD size, BYTE *props) {
  return This->lpVtbl->GetSampleProperties(This, size, props);
}
static inline HRESULT INSSBuffer2_SetSampleProperties(INSSBuffer2 *This,
                                                      DWORD size, BYTE *props) {
...
DEFINE_GUID(IID_INSSBuffer3, 0xc87ceaaf, 0x75be, 0x4bc4, 0x84, 0xeb, 0xac, 0x27,
            0x98, 0x50, 0x76, 0x72);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("c87ceaaf-75be-4bc4-84eb-ac2798507672")
INSSBuffer3 : public INSSBuffer2 {
  virtual HRESULT STDMETHODCALLTYPE SetProperty(GUID id, void *value,
                                                DWORD size) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetProperty(GUID id, void *value,
                                                DWORD *size) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(INSSBuffer3, 0xc87ceaaf, 0x75be, 0x4bc4, 0x84, 0xeb, 0xac, 0x27,
                0x98, 0x50, 0x76, 0x72)
#endif
#else
typedef struct INSSBuffer3Vtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INSSBuffer3 *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetBufferAndLength)(INSSBuffer3 *This,
                                                 BYTE **ppdwBuffer,
                                                 DWORD *pdwLength);
  /*** INSSBuffer2 methods ***/
  HRESULT(STDMETHODCALLTYPE *GetSampleProperties)(INSSBuffer3 *This, DWORD size,
                                                  BYTE *props);
  HRESULT(STDMETHODCALLTYPE *SetSampleProperties)(INSSBuffer3 *This, DWORD size,
                                                  BYTE *props);
  /*** INSSBuffer3 methods ***/
  HRESULT(STDMETHODCALLTYPE *SetProperty)(INSSBuffer3 *This, GUID id,
                                          void *value, DWORD size);
  HRESULT(STDMETHODCALLTYPE *GetProperty)(INSSBuffer3 *This, GUID id,
                                          void *value, DWORD *size);
  END_INTERFACE
} INSSBuffer3Vtbl;
interface INSSBuffer3 { CONST_VTBL INSSBuffer3Vtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define INSSBuffer3_GetBufferAndLength(This, ppdwBuffer, pdwLength)            \
  (This)->lpVtbl->GetBufferAndLength(This, ppdwBuffer, pdwLength)
/*** INSSBuffer2 methods ***/
#define INSSBuffer3_GetSampleProperties(This, size, props)                     \
  (This)->lpVtbl->GetSampleProperties(This, size, props)
#define INSSBuffer3_SetSampleProperties(This, size, props)                     \
  (This)->lpVtbl->SetSampleProperties(This, size, props)
/*** INSSBuffer3 methods ***/
#define INSSBuffer3_SetProperty(This, id, value, size)                         \
  (This)->lpVtbl->SetProperty(This, id, value, size)
#define INSSBuffer3_GetProperty(This, id, value, size)                         \
  (This)->lpVtbl->GetProperty(This, id, value, size)
#else
/*** IUnknown methods ***/
static inline HRESULT INSSBuffer3_QueryInterface(INSSBuffer3 *This, REFIID riid,
                                                 void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** INSSBuffer methods ***/
static inline HRESULT INSSBuffer3_GetLength(INSSBuffer3 *This,
                                            DWORD *pdwLength) {
  return This->lpVtbl->GetLength(This, pdwLength);
}
...
static inline HRESULT INSSBuffer3_GetMaxLength(INSSBuffer3 *This,
                                               DWORD *pdwLength) {
  return This->lpVtbl->GetMaxLength(This, pdwLength);
}
static inline HRESULT INSSBuffer3_GetBuffer(INSSBuffer3 *This,
                                            BYTE **ppdwBuffer) {
  return This->lpVtbl->GetBuffer(This, ppdwBuffer);
}
static inline HRESULT INSSBuffer3_GetBufferAndLength(INSSBuffer3 *This,
                                                     BYTE **ppdwBuffer,
                                                     DWORD *pdwLength) {
  return This->lpVtbl->GetBufferAndLength(This, ppdwBuffer, pdwLength);
}
/*** INSSBuffer2 methods ***/
static inline HRESULT INSSBuffer3_GetSampleProperties(INSSBuffer3 *This,
                                                      DWORD size, BYTE *props) {
  return This->lpVtbl->GetSampleProperties(This, size, props);
}
static inline HRESULT INSSBuffer3_SetSampleProperties(INSSBuffer3 *This,
                                                      DWORD size, BYTE *props) {
  return This->lpVtbl->SetSampleProperties(This, size, props);
}
/*** INSSBuffer3 methods ***/
static inline HRESULT INSSBuffer3_SetProperty(INSSBuffer3 *This, GUID id,
                                              void *value, DWORD size) {
  return This->lpVtbl->SetProperty(This, id, value, size);
}
static inline HRESULT INSSBuffer3_GetProperty(INSSBuffer3 *This, GUID id,
                                              void *value, DWORD *size) {
