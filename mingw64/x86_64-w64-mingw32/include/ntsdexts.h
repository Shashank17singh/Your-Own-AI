...
typedef VOID (*PNTSD_GET_SYMBOL)(ULONG_PTR offset, PUCHAR pchBuffer,
                                 ULONG_PTR *pDisplacement);
typedef DWORD (*PNTSD_DISASM)(ULONG_PTR *lpOffset, LPSTR lpBuffer,
...
typedef VOID (*PNTSD_EXTENSION_ROUTINE)(HANDLE hCurrentProcess,
