/*** Autogenerated by WIDL 11.5 from include/napservermanagement.idl - Do not
 * edit ***/
#ifdef _WIN32
...
DEFINE_GUID(IID_INapServerManagement, 0x9de543e7, 0x0f23, 0x47e0, 0xa8, 0xbc,
            0x97, 0x1a, 0x89, 0x4f, 0x86, 0xd4);
...
INapServerManagement : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE SetFailureCategoryMappings(
      SystemHealthEntityId id, const FailureCategoryMapping mapping) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(INapServerManagement, 0x9de543e7, 0x0f23, 0x47e0, 0xa8, 0xbc,
                0x97, 0x1a, 0x89, 0x4f, 0x86, 0xd4)
#endif
#else
typedef struct INapServerManagementVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INapServerManagement *This,
...
/*** INapServerManagement methods ***/
#define INapServerManagement_RegisterSystemHealthValidator(This, validator,    \
                                                           validatorClsid)     \
...
INapServerManagement_QueryInterface(INapServerManagement *This, REFIID riid,
                                    void **ppvObject) {
...
/*** INapServerManagement methods ***/
static inline HRESULT INapServerManagement_RegisterSystemHealthValidator(
    INapServerManagement *This, const NapComponentRegistrationInfo *validator,
    const CLSID *validatorClsid) {
  return This->lpVtbl->RegisterSystemHealthValidator(This, validator,
                                                     validatorClsid);
}
static inline HRESULT
INapServerManagement_UnregisterSystemHealthValidator(INapServerManagement *This,
                                                     SystemHealthEntityId id) {
  return This->lpVtbl->UnregisterSystemHealthValidator(This, id);
}
static inline HRESULT INapServerManagement_SetFailureCategoryMappings(
    INapServerManagement *This, SystemHealthEntityId id,
    const FailureCategoryMapping mapping) {
...
DEFINE_GUID(IID_INapServerInfo, 0x599f9021, 0x5643, 0x4965, 0x99, 0x49, 0xe8,
            0x89, 0x75, 0xef, 0xff, 0x0e);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
INapServerInfo : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetNapServerInfo(
      CountedString * *serverName, CountedString * *serverDescription,
  ...
  virtual HRESULT STDMETHODCALLTYPE GetRegisteredSystemHealthValidators(
      ...
      NapComponentRegistrationInfo * *validators, CLSID * *validatorClsids) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetFailureCategoryMappings(
      SystemHealthEntityId id, FailureCategoryMapping * mapping) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(INapServerInfo, 0x599f9021, 0x5643, 0x4965, 0x99, 0x49, 0xe8,
                0x89, 0x75, 0xef, 0xff, 0x0e)
#endif
#else
typedef struct INapServerInfoVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(INapServerInfo *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetNapServerInfo)(
      INapServerInfo *This, CountedString **serverName,
      CountedString **serverDescription, CountedString **protocolVersion);
  HRESULT(STDMETHODCALLTYPE *GetRegisteredSystemHealthValidators)(
      INapServerInfo *This, SystemHealthEntityCount *count,
      NapComponentRegistrationInfo **validators, CLSID **validatorClsids);
  HRESULT(STDMETHODCALLTYPE *GetFailureCategoryMappings)(
      INapServerInfo *This, SystemHealthEntityId id,
      FailureCategoryMapping *mapping);
  END_INTERFACE
} INapServerInfoVtbl;
interface INapServerInfo { CONST_VTBL INapServerInfoVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** INapServerInfo methods ***/
#define INapServerInfo_GetNapServerInfo(This, serverName, serverDescription,   \
                                        protocolVersion)                       \
  (This)->lpVtbl->GetNapServerInfo(This, serverName, serverDescription,        \
                                   protocolVersion)
#define INapServerInfo_GetRegisteredSystemHealthValidators(                    \
    This, count, validators, validatorClsids)                                  \
  (This)->lpVtbl->GetRegisteredSystemHealthValidators(This, count, validators, \
                                                      validatorClsids)
#define INapServerInfo_GetFailureCategoryMappings(This, id, mapping)           \
  (This)->lpVtbl->GetFailureCategoryMappings(This, id, mapping)
#else
/*** IUnknown methods ***/
static inline HRESULT INapServerInfo_QueryInterface(INapServerInfo *This,
                                                    REFIID riid,
                                                    void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** INapServerInfo methods ***/
static inline HRESULT INapServerInfo_GetNapServerInfo(
    INapServerInfo *This, CountedString **serverName,
    CountedString **serverDescription, CountedString **protocolVersion) {
  return This->lpVtbl->GetNapServerInfo(This, serverName, serverDescription,
                                        protocolVersion);
}
static inline HRESULT INapServerInfo_GetRegisteredSystemHealthValidators(
    INapServerInfo *This, SystemHealthEntityCount *count,
    NapComponentRegistrationInfo **validators, CLSID **validatorClsids) {
  return This->lpVtbl->GetRegisteredSystemHealthValidators(
      This, count, validators, validatorClsids);
}
static inline HRESULT
INapServerInfo_GetFailureCategoryMappings(INapServerInfo *This,
                                          SystemHealthEntityId id,
                                          FailureCategoryMapping *mapping) {
