...
#endif
#define IS_SPECIAL_DATAOBJECT(d)                                               \
  (((LONG_PTR)(d) >= SPECIAL_DOBJ_MIN) && ((LONG_PTR)(d) <= SPECIAL_DOBJ_MAX))
#define IS_SPECIAL_COOKIE(c)                                                   \
  (((c) >= SPECIAL_COOKIE_MIN) && ((c) <= SPECIAL_COOKIE_MAX))
...
public:
  ...
  virtual HRESULT WINAPI Notify(LPDATAOBJECT lpDataObject,
                                MMC_NOTIFY_TYPE event, LPARAM arg,
                                LPARAM param) = 0;
  virtual HRESULT WINAPI Destroy(void) = 0;
  virtual HRESULT WINAPI QueryDataObject(MMC_COOKIE cookie,
                                         DATA_OBJECT_TYPES type,
                                         LPDATAOBJECT *ppDataObject) = 0;
  virtual HRESULT WINAPI GetDisplayInfo(SCOPEDATAITEM *pScopeDataItem) = 0;
  virtual HRESULT WINAPI CompareObjects(LPDATAOBJECT lpDataObjectA,
                                        LPDATAOBJECT lpDataObjectB) = 0;
};
#else
typedef struct IComponentDataVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IComponentData *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *CreateComponent)(IComponentData *This,
                                   LPCOMPONENT *ppComponent);
  HRESULT(WINAPI *Notify)(IComponentData *This, LPDATAOBJECT lpDataObject,
                          MMC_NOTIFY_TYPE event, LPARAM arg, LPARAM param);
  HRESULT(WINAPI *Destroy)(IComponentData *This);
  HRESULT(WINAPI *QueryDataObject)(IComponentData *This, MMC_COOKIE cookie,
                                   DATA_OBJECT_TYPES type,
                                   LPDATAOBJECT *ppDataObject);
  HRESULT(WINAPI *GetDisplayInfo)(IComponentData *This,
                                  SCOPEDATAITEM *pScopeDataItem);
  HRESULT(WINAPI *CompareObjects)(IComponentData *This,
...
#endif
#endif
HRESULT WINAPI IComponentData_Initialize_Proxy(IComponentData *This,
                                               LPUNKNOWN pUnknown);
...
HRESULT WINAPI IComponentData_CreateComponent_Proxy(IComponentData *This,
                                                    LPCOMPONENT *ppComponent);
void __RPC_STUB IComponentData_CreateComponent_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IComponentData_Notify_Proxy(IComponentData *This,
...
void __RPC_STUB IComponentData_Destroy_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IComponentData_QueryDataObject_Proxy(IComponentData *This,
                                                    MMC_COOKIE cookie,
                                                    DATA_OBJECT_TYPES type,
                                                    LPDATAOBJECT *ppDataObject);
void __RPC_STUB IComponentData_QueryDataObject_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IComponentData_GetDisplayInfo_Proxy(
    IComponentData *This, SCOPEDATAITEM *pScopeDataItem);
void __RPC_STUB IComponentData_GetDisplayInfo_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IComponentData_CompareObjects_Proxy(IComponentData *This,
                                                   LPDATAOBJECT lpDataObjectA,
                                                   LPDATAOBJECT lpDataObjectB);
...
public:
  ...
  virtual HRESULT WINAPI QueryDataObject(MMC_COOKIE cookie,
                                         DATA_OBJECT_TYPES type,
                                         LPDATAOBJECT *ppDataObject) = 0;
  virtual HRESULT WINAPI GetResultViewType(MMC_COOKIE cookie,
                                           LPOLESTR *ppViewType,
                                           __LONG32 *pViewOptions) = 0;
...
typedef struct IComponentVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IComponent *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *Notify)(IComponent *This, LPDATAOBJECT lpDataObject,
                          MMC_NOTIFY_TYPE event, LPARAM arg, LPARAM param);
  HRESULT(WINAPI *Destroy)(IComponent *This, MMC_COOKIE cookie);
  HRESULT(WINAPI *QueryDataObject)(IComponent *This, MMC_COOKIE cookie,
                                   DATA_OBJECT_TYPES type,
                                   LPDATAOBJECT *ppDataObject);
  HRESULT(WINAPI *GetResultViewType)(IComponent *This, MMC_COOKIE cookie,
                                     LPOLESTR *ppViewType,
                                     __LONG32 *pViewOptions);
  HRESULT(WINAPI *GetDisplayInfo)(IComponent *This,
                                  RESULTDATAITEM *pResultDataItem);
  HRESULT(WINAPI *CompareObjects)(IComponent *This, LPDATAOBJECT lpDataObjectA,
                                  LPDATAOBJECT lpDataObjectB);
  END_INTERFACE
} IComponentVtbl;
struct IComponent {
...
#endif
#endif
HRESULT WINAPI IComponent_Initialize_Proxy(IComponent *This,
                                           LPCONSOLE lpConsole);
void __RPC_STUB IComponent_Initialize_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IComponent_Notify_Proxy(IComponent *This,
                                       LPDATAOBJECT lpDataObject,
                                       MMC_NOTIFY_TYPE event, LPARAM arg,
                                       LPARAM param);
void __RPC_STUB IComponent_Notify_Stub(IRpcStubBuffer *This,
                                       IRpcChannelBuffer *_pRpcChannelBuffer,
                                       PRPC_MESSAGE _pRpcMessage,
                                       DWORD *_pdwStubPhase);
HRESULT WINAPI IComponent_Destroy_Proxy(IComponent *This, MMC_COOKIE cookie);
void __RPC_STUB IComponent_Destroy_Stub(IRpcStubBuffer *This,
                                        IRpcChannelBuffer *_pRpcChannelBuffer,
                                        PRPC_MESSAGE _pRpcMessage,
                                        DWORD *_pdwStubPhase);
HRESULT WINAPI IComponent_QueryDataObject_Proxy(IComponent *This,
                                                MMC_COOKIE cookie,
                                                DATA_OBJECT_TYPES type,
                                                LPDATAOBJECT *ppDataObject);
void __RPC_STUB IComponent_QueryDataObject_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IComponent_GetResultViewType_Proxy(IComponent *This,
                                                  MMC_COOKIE cookie,
                                                  LPOLESTR *ppViewType,
                                                  __LONG32 *pViewOptions);
void __RPC_STUB IComponent_GetResultViewType_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IComponent_GetDisplayInfo_Proxy(IComponent *This,
                                               RESULTDATAITEM *pResultDataItem);
void __RPC_STUB IComponent_GetDisplayInfo_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IComponent_CompareObjects_Proxy(IComponent *This,
                                               LPDATAOBJECT lpDataObjectA,
                                               LPDATAOBJECT lpDataObjectB);
...
public:
  virtual HRESULT WINAPI Compare(LPARAM lUserParam, MMC_COOKIE cookieA,
                                 MMC_COOKIE cookieB, int *pnResult) = 0;
};
#else
typedef struct IResultDataCompareVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IResultDataCompare *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IResultDataCompare *This);
  ULONG(WINAPI *Release)(IResultDataCompare *This);
  HRESULT(WINAPI *Compare)(IResultDataCompare *This, LPARAM lUserParam,
                           MMC_COOKIE cookieA, MMC_COOKIE cookieB,
                           int *pnResult);
  END_INTERFACE
...
#define IResultDataCompare_Compare(This, lUserParam, cookieA, cookieB,         \
                                   pnResult)                                   \
  (This)->lpVtbl->Compare(This, lUserParam, cookieA, cookieB, pnResult)
#endif
#endif
HRESULT WINAPI IResultDataCompare_Compare_Proxy(IResultDataCompare *This,
                                                LPARAM lUserParam,
                                                MMC_COOKIE cookieA,
                                                MMC_COOKIE cookieB,
                                                int *pnResult);
...
public:
  virtual HRESULT WINAPI FindItem(LPRESULTFINDINFO pFindInfo,
                                  int *pnFoundIndex) = 0;
  virtual HRESULT WINAPI CacheHint(int nStartIndex, int nEndIndex) = 0;
  virtual HRESULT WINAPI SortItems(int nColumn, DWORD dwSortOptions,
                                   LPARAM lUserParam) = 0;
};
#else
typedef struct IResultOwnerDataVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IResultOwnerData *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IResultOwnerData *This);
  ULONG(WINAPI *Release)(IResultOwnerData *This);
  HRESULT(WINAPI *FindItem)(IResultOwnerData *This, LPRESULTFINDINFO pFindInfo,
                            int *pnFoundIndex);
  HRESULT(WINAPI *CacheHint)(IResultOwnerData *This, int nStartIndex,
                             int nEndIndex);
  HRESULT(WINAPI *SortItems)(IResultOwnerData *This, int nColumn,
...
#endif
#endif
HRESULT WINAPI IResultOwnerData_FindItem_Proxy(IResultOwnerData *This,
                                               LPRESULTFINDINFO pFindInfo,
                                               int *pnFoundIndex);
void __RPC_STUB IResultOwnerData_FindItem_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IResultOwnerData_CacheHint_Proxy(IResultOwnerData *This,
                                                int nStartIndex, int nEndIndex);
void __RPC_STUB IResultOwnerData_CacheHint_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IResultOwnerData_SortItems_Proxy(IResultOwnerData *This,
                                                int nColumn,
                                                DWORD dwSortOptions,
                                                LPARAM lUserParam);
...
public:
  ...
  virtual HRESULT WINAPI UpdateAllViews(LPDATAOBJECT lpDataObject, LPARAM data,
                                        LONG_PTR hint) = 0;
  virtual HRESULT WINAPI MessageBox(LPCWSTR lpszText, LPCWSTR lpszTitle,
                                    UINT fuStyle, int *piRetval) = 0;
  ...
  virtual HRESULT WINAPI NewWindow(HSCOPEITEM hScopeItem,
                                   unsigned __LONG32 lOptions) = 0;
};
#else
typedef struct IConsoleVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IConsole *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *QueryScopeImageList)(IConsole *This,
                                       LPIMAGELIST *ppImageList);
  HRESULT(WINAPI *QueryResultImageList)(IConsole *This,
                                        LPIMAGELIST *ppImageList);
  HRESULT(WINAPI *UpdateAllViews)(IConsole *This, LPDATAOBJECT lpDataObject,
                                  LPARAM data, LONG_PTR hint);
  HRESULT(WINAPI *MessageBox)(IConsole *This, LPCWSTR lpszText,
                              LPCWSTR lpszTitle, UINT fuStyle, int *piRetval);
  HRESULT(WINAPI *QueryConsoleVerb)(IConsole *This,
  ...
  HRESULT(WINAPI *NewWindow)(IConsole *This, HSCOPEITEM hScopeItem,
                             unsigned __LONG32 lOptions);
  END_INTERFACE
} IConsoleVtbl;
struct IConsole {
...
void __RPC_STUB IConsole_SetHeader_Stub(IRpcStubBuffer *This,
                                        IRpcChannelBuffer *_pRpcChannelBuffer,
                                        PRPC_MESSAGE _pRpcMessage,
                                        DWORD *_pdwStubPhase);
HRESULT WINAPI IConsole_SetToolbar_Proxy(IConsole *This, LPTOOLBAR pToolbar);
void __RPC_STUB IConsole_SetToolbar_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
HRESULT WINAPI IConsole_QueryResultView_Proxy(IConsole *This,
                                              LPUNKNOWN *pUnknown);
void __RPC_STUB IConsole_QueryResultView_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IConsole_QueryScopeImageList_Proxy(IConsole *This,
                                                  LPIMAGELIST *ppImageList);
void __RPC_STUB IConsole_QueryScopeImageList_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IConsole_QueryResultImageList_Proxy(IConsole *This,
                                                   LPIMAGELIST *ppImageList);
void __RPC_STUB IConsole_QueryResultImageList_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IConsole_UpdateAllViews_Proxy(IConsole *This,
                                             LPDATAOBJECT lpDataObject,
                                             LPARAM data, LONG_PTR hint);
void __RPC_STUB IConsole_UpdateAllViews_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IConsole_MessageBox_Proxy(IConsole *This, LPCWSTR lpszText,
                                         LPCWSTR lpszTitle, UINT fuStyle,
                                         int *piRetval);
void __RPC_STUB IConsole_MessageBox_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
HRESULT WINAPI IConsole_QueryConsoleVerb_Proxy(IConsole *This,
                                               LPCONSOLEVERB *ppConsoleVerb);
void __RPC_STUB IConsole_QueryConsoleVerb_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IConsole_SelectScopeItem_Proxy(IConsole *This,
...
void __RPC_STUB IConsole_GetMainWindow_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IConsole_NewWindow_Proxy(IConsole *This, HSCOPEITEM hScopeItem,
                                        unsigned __LONG32 lOptions);
void __RPC_STUB IConsole_NewWindow_Stub(IRpcStubBuffer *This,
                                        IRpcChannelBuffer *_pRpcChannelBuffer,
                                        PRPC_MESSAGE _pRpcMessage,
                                        DWORD *_pdwStubPhase);
#endif
...
public:
  virtual HRESULT WINAPI InsertColumn(int nCol, LPCWSTR title, int nFormat,
                                      int nWidth) = 0;
...
typedef struct IHeaderCtrlVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IHeaderCtrl *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IHeaderCtrl *This);
  ULONG(WINAPI *Release)(IHeaderCtrl *This);
  HRESULT(WINAPI *InsertColumn)(IHeaderCtrl *This, int nCol, LPCWSTR title,
...
#endif
#endif
HRESULT WINAPI IHeaderCtrl_InsertColumn_Proxy(IHeaderCtrl *This, int nCol,
                                              LPCWSTR title, int nFormat,
                                              int nWidth);
...
void __RPC_STUB IHeaderCtrl_DeleteColumn_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IHeaderCtrl_SetColumnText_Proxy(IHeaderCtrl *This, int nCol,
                                               LPCWSTR title);
void __RPC_STUB IHeaderCtrl_SetColumnText_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IHeaderCtrl_GetColumnText_Proxy(IHeaderCtrl *This, int nCol,
                                               LPOLESTR *pText);
void __RPC_STUB IHeaderCtrl_GetColumnText_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IHeaderCtrl_SetColumnWidth_Proxy(IHeaderCtrl *This, int nCol,
                                                int nWidth);
void __RPC_STUB IHeaderCtrl_SetColumnWidth_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IHeaderCtrl_GetColumnWidth_Proxy(IHeaderCtrl *This, int nCol,
                                                int *pWidth);
...
enum __MIDL___MIDL_itf_mmc_0121_0002 {
  CCM_INSERTIONALLOWED_TOP = 1 << (CCM_INSERTIONPOINTID_PRIMARY_TOP &
                                   CCM_INSERTIONPOINTID_MASK_FLAGINDEX),
  CCM_INSERTIONALLOWED_NEW = 1 << (CCM_INSERTIONPOINTID_PRIMARY_NEW &
                                   CCM_INSERTIONPOINTID_MASK_FLAGINDEX),
  CCM_INSERTIONALLOWED_TASK = 1 << (CCM_INSERTIONPOINTID_PRIMARY_TASK &
                                    CCM_INSERTIONPOINTID_MASK_FLAGINDEX),
  CCM_INSERTIONALLOWED_VIEW = 1 << (CCM_INSERTIONPOINTID_PRIMARY_VIEW &
                                    CCM_INSERTIONPOINTID_MASK_FLAGINDEX)
};
...
typedef struct IContextMenuCallbackVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IContextMenuCallback *This, REFIID riid,
                                  void **ppvObject);
...
#endif
#endif
HRESULT WINAPI IContextMenuCallback_AddItem_Proxy(IContextMenuCallback *This,
                                                  CONTEXTMENUITEM *pItem);
...
public:
  ...
  virtual HRESULT WINAPI AddPrimaryExtensionItems(
      LPUNKNOWN piExtension, LPDATAOBJECT piDataObject) = 0;
  virtual HRESULT WINAPI
  AddThirdPartyExtensionItems(LPDATAOBJECT piDataObject) = 0;
  virtual HRESULT WINAPI ShowContextMenu(HWND hwndParent, __LONG32 xPos,
                                         __LONG32 yPos,
                                         __LONG32 *plSelected) = 0;
};
#else
typedef struct IContextMenuProviderVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IContextMenuProvider *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *AddPrimaryExtensionItems)(IContextMenuProvider *This,
                                            LPUNKNOWN piExtension,
                                            LPDATAOBJECT piDataObject);
  HRESULT(WINAPI *AddThirdPartyExtensionItems)(IContextMenuProvider *This,
                                               LPDATAOBJECT piDataObject);
  HRESULT(WINAPI *ShowContextMenu)(IContextMenuProvider *This, HWND hwndParent,
                                   __LONG32 xPos, __LONG32 yPos,
                                   __LONG32 *plSelected);
  END_INTERFACE
...
#define IContextMenuProvider_AddPrimaryExtensionItems(This, piExtension,       \
                                                      piDataObject)            \
...
#define IContextMenuProvider_ShowContextMenu(This, hwndParent, xPos, yPos,     \
                                             plSelected)                       \
  (This)->lpVtbl->ShowContextMenu(This, hwndParent, xPos, yPos, plSelected)
#endif
#endif
HRESULT
    WINAPI IContextMenuProvider_EmptyMenuList_Proxy(IContextMenuProvider *This);
...
HRESULT WINAPI IContextMenuProvider_AddPrimaryExtensionItems_Proxy(
    IContextMenuProvider *This, LPUNKNOWN piExtension,
    LPDATAOBJECT piDataObject);
void __RPC_STUB IContextMenuProvider_AddPrimaryExtensionItems_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IContextMenuProvider_AddThirdPartyExtensionItems_Proxy(
    IContextMenuProvider *This, LPDATAOBJECT piDataObject);
void __RPC_STUB IContextMenuProvider_AddThirdPartyExtensionItems_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IContextMenuProvider_ShowContextMenu_Proxy(
    IContextMenuProvider *This, HWND hwndParent, __LONG32 xPos, __LONG32 yPos,
    __LONG32 *plSelected);
...
public:
  virtual HRESULT WINAPI AddMenuItems(LPDATAOBJECT piDataObject,
                                      LPCONTEXTMENUCALLBACK piCallback,
                                      __LONG32 *pInsertionAllowed) = 0;
  virtual HRESULT WINAPI Command(__LONG32 lCommandID,
                                 LPDATAOBJECT piDataObject) = 0;
};
#else
typedef struct IExtendContextMenuVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IExtendContextMenu *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IExtendContextMenu *This);
  ULONG(WINAPI *Release)(IExtendContextMenu *This);
  HRESULT(WINAPI *AddMenuItems)(IExtendContextMenu *This,
                                LPDATAOBJECT piDataObject,
                                LPCONTEXTMENUCALLBACK piCallback,
                                __LONG32 *pInsertionAllowed);
  HRESULT(WINAPI *Command)(IExtendContextMenu *This, __LONG32 lCommandID,
                           LPDATAOBJECT piDataObject);
  END_INTERFACE
...
#define IExtendContextMenu_AddMenuItems(This, piDataObject, piCallback,        \
                                        pInsertionAllowed)                     \
  (This)->lpVtbl->AddMenuItems(This, piDataObject, piCallback,                 \
                               pInsertionAllowed)
#define IExtendContextMenu_Command(This, lCommandID, piDataObject)             \
  (This)->lpVtbl->Command(This, lCommandID, piDataObject)
#endif
#endif
HRESULT WINAPI IExtendContextMenu_AddMenuItems_Proxy(
    IExtendContextMenu *This, LPDATAOBJECT piDataObject,
    LPCONTEXTMENUCALLBACK piCallback, __LONG32 *pInsertionAllowed);
void __RPC_STUB IExtendContextMenu_AddMenuItems_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IExtendContextMenu_Command_Proxy(IExtendContextMenu *This,
                                                __LONG32 lCommandID,
                                                LPDATAOBJECT piDataObject);
...
public:
  ...
  virtual HRESULT WINAPI ImageListSetStrip(LONG_PTR *pBMapSm, LONG_PTR *pBMapLg,
                                           __LONG32 nStartLoc,
                                           COLORREF cMask) = 0;
};
#else
typedef struct IImageListVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IImageList *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IImageList *This);
  ULONG(WINAPI *Release)(IImageList *This);
  HRESULT(WINAPI *ImageListSetIcon)(IImageList *This, LONG_PTR *pIcon,
                                    __LONG32 nLoc);
  HRESULT(WINAPI *ImageListSetStrip)(IImageList *This, LONG_PTR *pBMapSm,
                                     LONG_PTR *pBMapLg, __LONG32 nStartLoc,
                                     COLORREF cMask);
  END_INTERFACE
} IImageListVtbl;
struct IImageList {
...
#endif
#endif
HRESULT WINAPI IImageList_ImageListSetIcon_Proxy(IImageList *This,
                                                 LONG_PTR *pIcon,
                                                 __LONG32 nLoc);
void __RPC_STUB IImageList_ImageListSetIcon_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IImageList_ImageListSetStrip_Proxy(IImageList *This,
                                                  LONG_PTR *pBMapSm,
                                                  LONG_PTR *pBMapLg,
                                                  __LONG32 nStartLoc,
                                                  COLORREF cMask);
...
public:
  ...
  virtual HRESULT WINAPI FindItemByLParam(LPARAM lParam,
                                          HRESULTITEM *pItemID) = 0;
  ...
  virtual HRESULT WINAPI ModifyItemState(int nIndex, HRESULTITEM itemID,
                                         UINT uAdd, UINT uRemove) = 0;
  virtual HRESULT WINAPI ModifyViewStyle(MMC_RESULT_VIEW_STYLE add,
                                         MMC_RESULT_VIEW_STYLE remove) = 0;
  ...
  virtual HRESULT WINAPI Sort(int nColumn, DWORD dwSortOptions,
                              LPARAM lUserParam) = 0;
...
typedef struct IResultDataVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IResultData *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *FindItemByLParam)(IResultData *This, LPARAM lParam,
                                    HRESULTITEM *pItemID);
  ...
  HRESULT(WINAPI *ModifyItemState)(IResultData *This, int nIndex,
                                   HRESULTITEM itemID, UINT uAdd, UINT uRemove);
  HRESULT(WINAPI *ModifyViewStyle)(IResultData *This, MMC_RESULT_VIEW_STYLE add,
  ...
  HRESULT(WINAPI *Sort)(IResultData *This, int nColumn, DWORD dwSortOptions,
                        LPARAM lUserParam);
  HRESULT(WINAPI *SetDescBarText)(IResultData *This, LPOLESTR DescText);
  HRESULT(WINAPI *SetItemCount)(IResultData *This, int nItemCount,
                                DWORD dwOptions);
  END_INTERFACE
} IResultDataVtbl;
struct IResultData {
...
#endif
#endif
HRESULT WINAPI IResultData_InsertItem_Proxy(IResultData *This,
                                            LPRESULTDATAITEM item);
void __RPC_STUB IResultData_InsertItem_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IResultData_DeleteItem_Proxy(IResultData *This,
                                            HRESULTITEM itemID, int nCol);
void __RPC_STUB IResultData_DeleteItem_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IResultData_FindItemByLParam_Proxy(IResultData *This,
                                                  LPARAM lParam,
                                                  HRESULTITEM *pItemID);
...
void __RPC_STUB IResultData_DeleteAllRsltItems_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IResultData_SetItem_Proxy(IResultData *This,
                                         LPRESULTDATAITEM item);
void __RPC_STUB IResultData_SetItem_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
HRESULT WINAPI IResultData_GetItem_Proxy(IResultData *This,
                                         LPRESULTDATAITEM item);
void __RPC_STUB IResultData_GetItem_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
HRESULT WINAPI IResultData_GetNextItem_Proxy(IResultData *This,
                                             LPRESULTDATAITEM item);
void __RPC_STUB IResultData_GetNextItem_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IResultData_ModifyItemState_Proxy(IResultData *This, int nIndex,
                                                 HRESULTITEM itemID, UINT uAdd,
                                                 UINT uRemove);
void __RPC_STUB IResultData_ModifyItemState_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IResultData_ModifyViewStyle_Proxy(IResultData *This,
                                                 MMC_RESULT_VIEW_STYLE add,
                                                 MMC_RESULT_VIEW_STYLE remove);
void __RPC_STUB IResultData_ModifyViewStyle_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IResultData_SetViewMode_Proxy(IResultData *This,
                                             __LONG32 lViewMode);
void __RPC_STUB IResultData_SetViewMode_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IResultData_GetViewMode_Proxy(IResultData *This,
                                             __LONG32 *lViewMode);
void __RPC_STUB IResultData_GetViewMode_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IResultData_UpdateItem_Proxy(IResultData *This,
                                            HRESULTITEM itemID);
void __RPC_STUB IResultData_UpdateItem_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IResultData_Sort_Proxy(IResultData *This, int nColumn,
                                      DWORD dwSortOptions, LPARAM lUserParam);
void __RPC_STUB IResultData_Sort_Stub(IRpcStubBuffer *This,
                                      IRpcChannelBuffer *_pRpcChannelBuffer,
                                      PRPC_MESSAGE _pRpcMessage,
                                      DWORD *_pdwStubPhase);
HRESULT WINAPI IResultData_SetDescBarText_Proxy(IResultData *This,
                                                LPOLESTR DescText);
void __RPC_STUB IResultData_SetDescBarText_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IResultData_SetItemCount_Proxy(IResultData *This, int nItemCount,
                                              DWORD dwOptions);
...
public:
  ...
  virtual HRESULT WINAPI GetChildItem(HSCOPEITEM item, HSCOPEITEM *pItemChild,
                                      MMC_COOKIE *pCookie) = 0;
  virtual HRESULT WINAPI GetNextItem(HSCOPEITEM item, HSCOPEITEM *pItemNext,
                                     MMC_COOKIE *pCookie) = 0;
  virtual HRESULT WINAPI GetParentItem(HSCOPEITEM item, HSCOPEITEM *pItemParent,
                                       MMC_COOKIE *pCookie) = 0;
};
#else
typedef struct IConsoleNameSpaceVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IConsoleNameSpace *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *DeleteItem)(IConsoleNameSpace *This, HSCOPEITEM hItem,
                              __LONG32 fDeleteThis);
  ...
  HRESULT(WINAPI *GetChildItem)(IConsoleNameSpace *This, HSCOPEITEM item,
                                HSCOPEITEM *pItemChild, MMC_COOKIE *pCookie);
  HRESULT(WINAPI *GetNextItem)(IConsoleNameSpace *This, HSCOPEITEM item,
                               HSCOPEITEM *pItemNext, MMC_COOKIE *pCookie);
  HRESULT(WINAPI *GetParentItem)(IConsoleNameSpace *This, HSCOPEITEM item,
...
#endif
#endif
HRESULT WINAPI IConsoleNameSpace_InsertItem_Proxy(IConsoleNameSpace *This,
                                                  LPSCOPEDATAITEM item);
void __RPC_STUB IConsoleNameSpace_InsertItem_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IConsoleNameSpace_DeleteItem_Proxy(IConsoleNameSpace *This,
                                                  HSCOPEITEM hItem,
                                                  __LONG32 fDeleteThis);
void __RPC_STUB IConsoleNameSpace_DeleteItem_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IConsoleNameSpace_SetItem_Proxy(IConsoleNameSpace *This,
                                               LPSCOPEDATAITEM item);
void __RPC_STUB IConsoleNameSpace_SetItem_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IConsoleNameSpace_GetItem_Proxy(IConsoleNameSpace *This,
                                               LPSCOPEDATAITEM item);
void __RPC_STUB IConsoleNameSpace_GetItem_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IConsoleNameSpace_GetChildItem_Proxy(IConsoleNameSpace *This,
                                                    HSCOPEITEM item,
...
void __RPC_STUB IConsoleNameSpace_GetChildItem_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IConsoleNameSpace_GetNextItem_Proxy(IConsoleNameSpace *This,
                                                   HSCOPEITEM item,
...
void __RPC_STUB IConsoleNameSpace_GetNextItem_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IConsoleNameSpace_GetParentItem_Proxy(IConsoleNameSpace *This,
                                                     HSCOPEITEM item,
                                                     HSCOPEITEM *pItemParent,
                                                     MMC_COOKIE *pCookie);
...
typedef struct IConsoleNameSpace2Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IConsoleNameSpace2 *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *DeleteItem)(IConsoleNameSpace2 *This, HSCOPEITEM hItem,
                              __LONG32 fDeleteThis);
  ...
  HRESULT(WINAPI *GetChildItem)(IConsoleNameSpace2 *This, HSCOPEITEM item,
                                HSCOPEITEM *pItemChild, MMC_COOKIE *pCookie);
  HRESULT(WINAPI *GetNextItem)(IConsoleNameSpace2 *This, HSCOPEITEM item,
                               HSCOPEITEM *pItemNext, MMC_COOKIE *pCookie);
  HRESULT(WINAPI *GetParentItem)(IConsoleNameSpace2 *This, HSCOPEITEM item,
                                 HSCOPEITEM *pItemParent, MMC_COOKIE *pCookie);
  HRESULT(WINAPI *Expand)(IConsoleNameSpace2 *This, HSCOPEITEM hItem);
  HRESULT(WINAPI *AddExtension)(IConsoleNameSpace2 *This, HSCOPEITEM hItem,
                                LPCLSID lpClsid);
  END_INTERFACE
...
#endif
#endif
HRESULT WINAPI IConsoleNameSpace2_Expand_Proxy(IConsoleNameSpace2 *This,
                                               HSCOPEITEM hItem);
void __RPC_STUB IConsoleNameSpace2_Expand_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IConsoleNameSpace2_AddExtension_Proxy(IConsoleNameSpace2 *This,
                                                     HSCOPEITEM hItem,
                                                     LPCLSID lpClsid);
...
typedef struct IPropertySheetCallbackVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IPropertySheetCallback *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *RemovePage)(IPropertySheetCallback *This,
...
#endif
HRESULT
    WINAPI IPropertySheetCallback_AddPage_Proxy(IPropertySheetCallback *This,
                                                HPROPSHEETPAGE hPage);
void __RPC_STUB IPropertySheetCallback_AddPage_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IPropertySheetCallback_RemovePage_Proxy(
    IPropertySheetCallback *This, HPROPSHEETPAGE hPage);
...
public:
  virtual HRESULT WINAPI CreatePropertySheet(LPCWSTR title, boolean type,
                                             MMC_COOKIE cookie,
                                             LPDATAOBJECT pIDataObjectm,
                                             DWORD dwOptions) = 0;
  virtual HRESULT WINAPI FindPropertySheet(MMC_COOKIE cookie,
                                           LPCOMPONENT lpComponent,
                                           LPDATAOBJECT lpDataObject) = 0;
  virtual HRESULT WINAPI AddPrimaryPages(LPUNKNOWN lpUnknown,
                                         WINBOOL bCreateHandle,
                                         HWND hNotifyWindow,
                                         WINBOOL bScopePane) = 0;
...
typedef struct IPropertySheetProviderVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IPropertySheetProvider *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IPropertySheetProvider *This);
  ULONG(WINAPI *Release)(IPropertySheetProvider *This);
  HRESULT(WINAPI *CreatePropertySheet)(IPropertySheetProvider *This,
                                       LPCWSTR title, boolean type,
                                       MMC_COOKIE cookie,
                                       LPDATAOBJECT pIDataObjectm,
                                       DWORD dwOptions);
  HRESULT(WINAPI *FindPropertySheet)(IPropertySheetProvider *This,
                                     MMC_COOKIE cookie, LPCOMPONENT lpComponent,
                                     LPDATAOBJECT lpDataObject);
  HRESULT(WINAPI *AddPrimaryPages)(IPropertySheetProvider *This,
                                   LPUNKNOWN lpUnknown, WINBOOL bCreateHandle,
                                   HWND hNotifyWindow, WINBOOL bScopePane);
  HRESULT(WINAPI *AddExtensionPages)(IPropertySheetProvider *This);
  HRESULT(WINAPI *Show)(IPropertySheetProvider *This, LONG_PTR window,
                        int page);
  END_INTERFACE
...
#define IPropertySheetProvider_CreatePropertySheet(This, title, type, cookie,  \
                                                   pIDataObjectm, dwOptions)   \
  (This)->lpVtbl->CreatePropertySheet(This, title, type, cookie,               \
                                      pIDataObjectm, dwOptions)
#define IPropertySheetProvider_FindPropertySheet(This, cookie, lpComponent,    \
                                                 lpDataObject)                 \
  (This)->lpVtbl->FindPropertySheet(This, cookie, lpComponent, lpDataObject)
#define IPropertySheetProvider_AddPrimaryPages(This, lpUnknown, bCreateHandle, \
                                               hNotifyWindow, bScopePane)      \
  (This)->lpVtbl->AddPrimaryPages(This, lpUnknown, bCreateHandle,              \
                                  hNotifyWindow, bScopePane)
...
#endif
#endif
HRESULT WINAPI IPropertySheetProvider_CreatePropertySheet_Proxy(
    IPropertySheetProvider *This, LPCWSTR title, boolean type,
    MMC_COOKIE cookie, LPDATAOBJECT pIDataObjectm, DWORD dwOptions);
void __RPC_STUB IPropertySheetProvider_CreatePropertySheet_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IPropertySheetProvider_FindPropertySheet_Proxy(
    IPropertySheetProvider *This, MMC_COOKIE cookie, LPCOMPONENT lpComponent,
    LPDATAOBJECT lpDataObject);
void __RPC_STUB IPropertySheetProvider_FindPropertySheet_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IPropertySheetProvider_AddPrimaryPages_Proxy(
    IPropertySheetProvider *This, LPUNKNOWN lpUnknown, WINBOOL bCreateHandle,
    HWND hNotifyWindow, WINBOOL bScopePane);
void __RPC_STUB IPropertySheetProvider_AddPrimaryPages_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
IPropertySheetProvider_AddExtensionPages_Proxy(IPropertySheetProvider *This);
void __RPC_STUB IPropertySheetProvider_AddExtensionPages_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IPropertySheetProvider_Show_Proxy(IPropertySheetProvider *This,
                                                 LONG_PTR window, int page);
...
public:
  virtual HRESULT WINAPI CreatePropertyPages(LPPROPERTYSHEETCALLBACK lpProvider,
                                             LONG_PTR handle,
                                             LPDATAOBJECT lpIDataObject) = 0;
  virtual HRESULT WINAPI QueryPagesFor(LPDATAOBJECT lpDataObject) = 0;
};
#else
typedef struct IExtendPropertySheetVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IExtendPropertySheet *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IExtendPropertySheet *This);
  ULONG(WINAPI *Release)(IExtendPropertySheet *This);
  HRESULT(WINAPI *CreatePropertyPages)(IExtendPropertySheet *This,
                                       LPPROPERTYSHEETCALLBACK lpProvider,
                                       LONG_PTR handle,
                                       LPDATAOBJECT lpIDataObject);
  HRESULT(WINAPI *QueryPagesFor)(IExtendPropertySheet *This,
                                 LPDATAOBJECT lpDataObject);
  END_INTERFACE
...
#define IExtendPropertySheet_CreatePropertyPages(This, lpProvider, handle,     \
                                                 lpIDataObject)                \
...
#endif
#endif
HRESULT WINAPI IExtendPropertySheet_CreatePropertyPages_Proxy(
    IExtendPropertySheet *This, LPPROPERTYSHEETCALLBACK lpProvider,
    LONG_PTR handle, LPDATAOBJECT lpIDataObject);
void __RPC_STUB IExtendPropertySheet_CreatePropertyPages_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IExtendPropertySheet_QueryPagesFor_Proxy(
    IExtendPropertySheet *This, LPDATAOBJECT lpDataObject);
...
public:
  virtual HRESULT WINAPI Create(MMC_CONTROL_TYPE nType,
                                LPEXTENDCONTROLBAR pExtendControlbar,
                                LPUNKNOWN *ppUnknown) = 0;
  virtual HRESULT WINAPI Attach(MMC_CONTROL_TYPE nType,
...
typedef struct IControlbarVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IControlbar *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IControlbar *This);
  ULONG(WINAPI *Release)(IControlbar *This);
  HRESULT(WINAPI *Create)(IControlbar *This, MMC_CONTROL_TYPE nType,
                          LPEXTENDCONTROLBAR pExtendControlbar,
                          LPUNKNOWN *ppUnknown);
  HRESULT(WINAPI *Attach)(IControlbar *This, MMC_CONTROL_TYPE nType,
                          LPUNKNOWN lpUnknown);
...
#endif
#endif
HRESULT WINAPI IControlbar_Create_Proxy(IControlbar *This,
                                        MMC_CONTROL_TYPE nType,
                                        LPEXTENDCONTROLBAR pExtendControlbar,
                                        LPUNKNOWN *ppUnknown);
void __RPC_STUB IControlbar_Create_Stub(IRpcStubBuffer *This,
                                        IRpcChannelBuffer *_pRpcChannelBuffer,
                                        PRPC_MESSAGE _pRpcMessage,
                                        DWORD *_pdwStubPhase);
HRESULT WINAPI IControlbar_Attach_Proxy(IControlbar *This,
                                        MMC_CONTROL_TYPE nType,
                                        LPUNKNOWN lpUnknown);
void __RPC_STUB IControlbar_Attach_Stub(IRpcStubBuffer *This,
                                        IRpcChannelBuffer *_pRpcChannelBuffer,
                                        PRPC_MESSAGE _pRpcMessage,
                                        DWORD *_pdwStubPhase);
HRESULT WINAPI IControlbar_Detach_Proxy(IControlbar *This, LPUNKNOWN lpUnknown);
void __RPC_STUB IControlbar_Detach_Stub(IRpcStubBuffer *This,
                                        IRpcChannelBuffer *_pRpcChannelBuffer,
                                        PRPC_MESSAGE _pRpcMessage,
                                        DWORD *_pdwStubPhase);
#endif
...
public:
  ...
  virtual HRESULT WINAPI ControlbarNotify(MMC_NOTIFY_TYPE event, LPARAM arg,
                                          LPARAM param) = 0;
};
#else
typedef struct IExtendControlbarVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IExtendControlbar *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IExtendControlbar *This);
  ULONG(WINAPI *Release)(IExtendControlbar *This);
  HRESULT(WINAPI *SetControlbar)(IExtendControlbar *This,
                                 LPCONTROLBAR pControlbar);
  HRESULT(WINAPI *ControlbarNotify)(IExtendControlbar *This,
                                    MMC_NOTIFY_TYPE event, LPARAM arg,
                                    LPARAM param);
  END_INTERFACE
...
#endif
#endif
HRESULT WINAPI IExtendControlbar_SetControlbar_Proxy(IExtendControlbar *This,
                                                     LPCONTROLBAR pControlbar);
void __RPC_STUB IExtendControlbar_SetControlbar_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IExtendControlbar_ControlbarNotify_Proxy(IExtendControlbar *This,
...
public:
  virtual HRESULT WINAPI AddBitmap(int nImages, HBITMAP hbmp, int cxSize,
                                   int cySize, COLORREF crMask) = 0;
  ...
  virtual HRESULT WINAPI GetButtonState(int idCommand, MMC_BUTTON_STATE nState,
                                        WINBOOL *pState) = 0;
  virtual HRESULT WINAPI SetButtonState(int idCommand, MMC_BUTTON_STATE nState,
                                        WINBOOL bState) = 0;
};
#else
typedef struct IToolbarVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IToolbar *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IToolbar *This);
  ULONG(WINAPI *Release)(IToolbar *This);
  HRESULT(WINAPI *AddBitmap)(IToolbar *This, int nImages, HBITMAP hbmp,
                             int cxSize, int cySize, COLORREF crMask);
  HRESULT(WINAPI *AddButtons)(IToolbar *This, int nButtons,
                              LPMMCBUTTON lpButtons);
  HRESULT(WINAPI *InsertButton)(IToolbar *This, int nIndex,
                                LPMMCBUTTON lpButton);
  HRESULT(WINAPI *DeleteButton)(IToolbar *This, int nIndex);
  HRESULT(WINAPI *GetButtonState)(IToolbar *This, int idCommand,
                                  MMC_BUTTON_STATE nState, WINBOOL *pState);
  HRESULT(WINAPI *SetButtonState)(IToolbar *This, int idCommand,
                                  MMC_BUTTON_STATE nState, WINBOOL bState);
  END_INTERFACE
} IToolbarVtbl;
struct IToolbar {
...
#endif
#endif
HRESULT WINAPI IToolbar_AddBitmap_Proxy(IToolbar *This, int nImages,
                                        HBITMAP hbmp, int cxSize, int cySize,
                                        COLORREF crMask);
void __RPC_STUB IToolbar_AddBitmap_Stub(IRpcStubBuffer *This,
                                        IRpcChannelBuffer *_pRpcChannelBuffer,
                                        PRPC_MESSAGE _pRpcMessage,
                                        DWORD *_pdwStubPhase);
HRESULT WINAPI IToolbar_AddButtons_Proxy(IToolbar *This, int nButtons,
                                         LPMMCBUTTON lpButtons);
void __RPC_STUB IToolbar_AddButtons_Stub(IRpcStubBuffer *This,
                                         IRpcChannelBuffer *_pRpcChannelBuffer,
                                         PRPC_MESSAGE _pRpcMessage,
                                         DWORD *_pdwStubPhase);
HRESULT WINAPI IToolbar_InsertButton_Proxy(IToolbar *This, int nIndex,
                                           LPMMCBUTTON lpButton);
...
void __RPC_STUB IToolbar_DeleteButton_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IToolbar_GetButtonState_Proxy(IToolbar *This, int idCommand,
                                             MMC_BUTTON_STATE nState,
                                             WINBOOL *pState);
void __RPC_STUB IToolbar_GetButtonState_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IToolbar_SetButtonState_Proxy(IToolbar *This, int idCommand,
                                             MMC_BUTTON_STATE nState,
                                             WINBOOL bState);
...
public:
  virtual HRESULT WINAPI GetVerbState(MMC_CONSOLE_VERB eCmdID,
                                      MMC_BUTTON_STATE nState,
                                      WINBOOL *pState) = 0;
  virtual HRESULT WINAPI SetVerbState(MMC_CONSOLE_VERB eCmdID,
                                      MMC_BUTTON_STATE nState,
                                      WINBOOL bState) = 0;
...
typedef struct IConsoleVerbVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IConsoleVerb *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IConsoleVerb *This);
  ULONG(WINAPI *Release)(IConsoleVerb *This);
  HRESULT(WINAPI *GetVerbState)(IConsoleVerb *This, MMC_CONSOLE_VERB eCmdID,
                                MMC_BUTTON_STATE nState, WINBOOL *pState);
  HRESULT(WINAPI *SetVerbState)(IConsoleVerb *This, MMC_CONSOLE_VERB eCmdID,
                                MMC_BUTTON_STATE nState, WINBOOL bState);
  HRESULT(WINAPI *SetDefaultVerb)(IConsoleVerb *This, MMC_CONSOLE_VERB eCmdID);
  HRESULT(WINAPI *GetDefaultVerb)(IConsoleVerb *This,
...
#endif
#endif
HRESULT WINAPI IConsoleVerb_GetVerbState_Proxy(IConsoleVerb *This,
...
void __RPC_STUB IConsoleVerb_GetVerbState_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IConsoleVerb_SetVerbState_Proxy(IConsoleVerb *This,
                                               MMC_CONSOLE_VERB eCmdID,
                                               MMC_BUTTON_STATE nState,
                                               WINBOOL bState);
void __RPC_STUB IConsoleVerb_SetVerbState_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IConsoleVerb_SetDefaultVerb_Proxy(IConsoleVerb *This,
                                                 MMC_CONSOLE_VERB eCmdID);
void __RPC_STUB IConsoleVerb_SetDefaultVerb_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IConsoleVerb_GetDefaultVerb_Proxy(IConsoleVerb *This,
                                                 MMC_CONSOLE_VERB *peCmdID);
...
public:
  ...
  virtual HRESULT WINAPI GetStaticFolderImage(HBITMAP *hSmallImage,
...
typedef struct ISnapinAboutVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ISnapinAbout *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ISnapinAbout *This);
  ULONG(WINAPI *Release)(ISnapinAbout *This);
  HRESULT(WINAPI *GetSnapinDescription)(ISnapinAbout *This,
  ...
  HRESULT(WINAPI *GetStaticFolderImage)(ISnapinAbout *This,
                                        HBITMAP *hSmallImage,
                                        HBITMAP *hSmallImageOpen,
...
#define ISnapinAbout_GetStaticFolderImage(This, hSmallImage, hSmallImageOpen,  \
                                          hLargeImage, cMask)                  \
  (This)->lpVtbl->GetStaticFolderImage(This, hSmallImage, hSmallImageOpen,     \
                                       hLargeImage, cMask)
#endif
#endif
HRESULT WINAPI ISnapinAbout_GetSnapinDescription_Proxy(ISnapinAbout *This,
                                                       LPOLESTR *lpDescription);
void __RPC_STUB ISnapinAbout_GetSnapinDescription_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISnapinAbout_GetProvider_Proxy(ISnapinAbout *This,
                                              LPOLESTR *lpName);
void __RPC_STUB ISnapinAbout_GetProvider_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISnapinAbout_GetSnapinVersion_Proxy(ISnapinAbout *This,
                                                   LPOLESTR *lpVersion);
void __RPC_STUB ISnapinAbout_GetSnapinVersion_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISnapinAbout_GetSnapinImage_Proxy(ISnapinAbout *This,
                                                 HICON *hAppIcon);
void __RPC_STUB ISnapinAbout_GetSnapinImage_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI ISnapinAbout_GetStaticFolderImage_Proxy(ISnapinAbout *This,
                                                       HBITMAP *hSmallImage,
                                                       HBITMAP *hSmallImageOpen,
                                                       HBITMAP *hLargeImage,
                                                       COLORREF *cMask);
...
public:
  virtual HRESULT WINAPI AddButton(int idCommand, LPOLESTR lpButtonText,
                                   LPOLESTR lpTooltipText) = 0;
  virtual HRESULT WINAPI SetButton(int idCommand, LPOLESTR lpButtonText,
                                   LPOLESTR lpTooltipText) = 0;
  virtual HRESULT WINAPI SetButtonState(int idCommand, MMC_BUTTON_STATE nState,
                                        WINBOOL bState) = 0;
};
...
typedef struct IMenuButtonVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMenuButton *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IMenuButton *This);
  ULONG(WINAPI *Release)(IMenuButton *This);
  HRESULT(WINAPI *AddButton)(IMenuButton *This, int idCommand,
                             LPOLESTR lpButtonText, LPOLESTR lpTooltipText);
  HRESULT(WINAPI *SetButton)(IMenuButton *This, int idCommand,
                             LPOLESTR lpButtonText, LPOLESTR lpTooltipText);
  HRESULT(WINAPI *SetButtonState)(IMenuButton *This, int idCommand,
                                  MMC_BUTTON_STATE nState, WINBOOL bState);
  END_INTERFACE
} IMenuButtonVtbl;
struct IMenuButton {
...
#endif
#endif
HRESULT WINAPI IMenuButton_AddButton_Proxy(IMenuButton *This, int idCommand,
                                           LPOLESTR lpButtonText,
                                           LPOLESTR lpTooltipText);
void __RPC_STUB IMenuButton_AddButton_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMenuButton_SetButton_Proxy(IMenuButton *This, int idCommand,
                                           LPOLESTR lpButtonText,
                                           LPOLESTR lpTooltipText);
void __RPC_STUB IMenuButton_SetButton_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMenuButton_SetButtonState_Proxy(IMenuButton *This,
                                                int idCommand,
                                                MMC_BUTTON_STATE nState,
                                                WINBOOL bState);
...
typedef struct ISnapinHelpVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ISnapinHelp *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ISnapinHelp *This);
  ULONG(WINAPI *Release)(ISnapinHelp *This);
  HRESULT(WINAPI *GetHelpTopic)(ISnapinHelp *This,
...
#endif
#endif
HRESULT WINAPI ISnapinHelp_GetHelpTopic_Proxy(ISnapinHelp *This,
                                              LPOLESTR *lpCompiledHelpFile);
...
public:
  virtual HRESULT WINAPI GetWatermarks(LPDATAOBJECT lpIDataObject,
                                       HBITMAP *lphWatermark,
                                       HBITMAP *lphHeader, HPALETTE *lphPalette,
                                       WINBOOL *bStretch) = 0;
};
#else
typedef struct IExtendPropertySheet2Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IExtendPropertySheet2 *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IExtendPropertySheet2 *This);
  ULONG(WINAPI *Release)(IExtendPropertySheet2 *This);
  HRESULT(WINAPI *CreatePropertyPages)(IExtendPropertySheet2 *This,
                                       LPPROPERTYSHEETCALLBACK lpProvider,
                                       LONG_PTR handle,
                                       LPDATAOBJECT lpIDataObject);
  HRESULT(WINAPI *QueryPagesFor)(IExtendPropertySheet2 *This,
                                 LPDATAOBJECT lpDataObject);
  HRESULT(WINAPI *GetWatermarks)(IExtendPropertySheet2 *This,
                                 LPDATAOBJECT lpIDataObject,
                                 HBITMAP *lphWatermark, HBITMAP *lphHeader,
                                 HPALETTE *lphPalette, WINBOOL *bStretch);
  END_INTERFACE
...
#define IExtendPropertySheet2_CreatePropertyPages(This, lpProvider, handle,    \
                                                  lpIDataObject)               \
  (This)->lpVtbl->CreatePropertyPages(This, lpProvider, handle, lpIDataObject)
#define IExtendPropertySheet2_QueryPagesFor(This, lpDataObject)                \
  (This)->lpVtbl->QueryPagesFor(This, lpDataObject)
#define IExtendPropertySheet2_GetWatermarks(This, lpIDataObject, lphWatermark, \
                                            lphHeader, lphPalette, bStretch)   \
  (This)->lpVtbl->GetWatermarks(This, lpIDataObject, lphWatermark, lphHeader,  \
                                lphPalette, bStretch)
#endif
#endif
HRESULT WINAPI IExtendPropertySheet2_GetWatermarks_Proxy(
    IExtendPropertySheet2 *This, LPDATAOBJECT lpIDataObject,
    HBITMAP *lphWatermark, HBITMAP *lphHeader, HPALETTE *lphPalette,
    WINBOOL *bStretch);
...
public:
  ...
  virtual HRESULT WINAPI SetColumnFilter(UINT nColumn, DWORD dwType,
                                         MMC_FILTERDATA *pFilterData) = 0;
  virtual HRESULT WINAPI GetColumnFilter(UINT nColumn, LPDWORD pdwType,
                                         MMC_FILTERDATA *pFilterData) = 0;
};
#else
typedef struct IHeaderCtrl2Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IHeaderCtrl2 *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IHeaderCtrl2 *This);
  ULONG(WINAPI *Release)(IHeaderCtrl2 *This);
  HRESULT(WINAPI *InsertColumn)(IHeaderCtrl2 *This, int nCol, LPCWSTR title,
                                int nFormat, int nWidth);
  ...
  HRESULT(WINAPI *SetChangeTimeOut)(IHeaderCtrl2 *This,
                                    unsigned __LONG32 uTimeout);
  HRESULT(WINAPI *SetColumnFilter)(IHeaderCtrl2 *This, UINT nColumn,
                                   DWORD dwType, MMC_FILTERDATA *pFilterData);
  HRESULT(WINAPI *GetColumnFilter)(IHeaderCtrl2 *This, UINT nColumn,
                                   LPDWORD pdwType,
                                   MMC_FILTERDATA *pFilterData);
  END_INTERFACE
} IHeaderCtrl2Vtbl;
struct IHeaderCtrl2 {
...
#endif
#endif
HRESULT WINAPI IHeaderCtrl2_SetChangeTimeOut_Proxy(IHeaderCtrl2 *This,
                                                   unsigned __LONG32 uTimeout);
void __RPC_STUB IHeaderCtrl2_SetChangeTimeOut_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IHeaderCtrl2_SetColumnFilter_Proxy(IHeaderCtrl2 *This,
                                                  UINT nColumn, DWORD dwType,
                                                  MMC_FILTERDATA *pFilterData);
void __RPC_STUB IHeaderCtrl2_SetColumnFilter_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IHeaderCtrl2_GetColumnFilter_Proxy(IHeaderCtrl2 *This,
                                                  UINT nColumn, LPDWORD pdwType,
                                                  MMC_FILTERDATA *pFilterData);
...
typedef struct ISnapinHelp2Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(ISnapinHelp2 *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(ISnapinHelp2 *This);
  ULONG(WINAPI *Release)(ISnapinHelp2 *This);
  HRESULT(WINAPI *GetHelpTopic)(ISnapinHelp2 *This,
                                LPOLESTR *lpCompiledHelpFile);
  HRESULT(WINAPI *GetLinkedTopics)(ISnapinHelp2 *This,
...
#endif
HRESULT
    WINAPI ISnapinHelp2_GetLinkedTopics_Proxy(ISnapinHelp2 *This,
                                              LPOLESTR *lpCompiledHelpFiles);
...
public:
  virtual HRESULT WINAPI Next(ULONG celt, MMC_TASK *rgelt,
...
typedef struct IEnumTASKVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IEnumTASK *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IEnumTASK *This);
  ULONG(WINAPI *Release)(IEnumTASK *This);
  HRESULT(WINAPI *Next)(IEnumTASK *This, ULONG celt, MMC_TASK *rgelt,
                        ULONG *pceltFetched);
...
#endif
#endif
HRESULT WINAPI IEnumTASK_Next_Proxy(IEnumTASK *This, ULONG celt,
                                    MMC_TASK *rgelt, ULONG *pceltFetched);
void __RPC_STUB IEnumTASK_Next_Stub(IRpcStubBuffer *This,
                                    IRpcChannelBuffer *_pRpcChannelBuffer,
                                    PRPC_MESSAGE _pRpcMessage,
                                    DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumTASK_Skip_Proxy(IEnumTASK *This, ULONG celt);
void __RPC_STUB IEnumTASK_Skip_Stub(IRpcStubBuffer *This,
                                    IRpcChannelBuffer *_pRpcChannelBuffer,
                                    PRPC_MESSAGE _pRpcMessage,
                                    DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumTASK_Reset_Proxy(IEnumTASK *This);
void __RPC_STUB IEnumTASK_Reset_Stub(IRpcStubBuffer *This,
                                     IRpcChannelBuffer *_pRpcChannelBuffer,
                                     PRPC_MESSAGE _pRpcMessage,
                                     DWORD *_pdwStubPhase);
HRESULT WINAPI IEnumTASK_Clone_Proxy(IEnumTASK *This, IEnumTASK **ppenum);
void __RPC_STUB IEnumTASK_Clone_Stub(IRpcStubBuffer *This,
                                     IRpcChannelBuffer *_pRpcChannelBuffer,
                                     PRPC_MESSAGE _pRpcMessage,
                                     DWORD *_pdwStubPhase);
#endif
...
public:
  virtual HRESULT WINAPI TaskNotify(IDataObject *pdo, VARIANT *arg,
                                    VARIANT *param) = 0;
  virtual HRESULT WINAPI EnumTasks(IDataObject *pdo, LPOLESTR szTaskGroup,
                                   IEnumTASK **ppEnumTASK) = 0;
  virtual HRESULT WINAPI GetTitle(LPOLESTR pszGroup, LPOLESTR *pszTitle) = 0;
  virtual HRESULT WINAPI GetDescriptiveText(LPOLESTR pszGroup,
                                            LPOLESTR *pszDescriptiveText) = 0;
  virtual HRESULT WINAPI GetBackground(LPOLESTR pszGroup,
                                       MMC_TASK_DISPLAY_OBJECT *pTDO) = 0;
  virtual HRESULT WINAPI GetListPadInfo(LPOLESTR pszGroup,
                                        MMC_LISTPAD_INFO *lpListPadInfo) = 0;
};
#else
typedef struct IExtendTaskPadVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IExtendTaskPad *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IExtendTaskPad *This);
  ULONG(WINAPI *Release)(IExtendTaskPad *This);
  HRESULT(WINAPI *TaskNotify)(IExtendTaskPad *This, IDataObject *pdo,
                              VARIANT *arg, VARIANT *param);
  HRESULT(WINAPI *EnumTasks)(IExtendTaskPad *This, IDataObject *pdo,
                             LPOLESTR szTaskGroup, IEnumTASK **ppEnumTASK);
  HRESULT(WINAPI *GetTitle)(IExtendTaskPad *This, LPOLESTR pszGroup,
                            LPOLESTR *pszTitle);
  HRESULT(WINAPI *GetDescriptiveText)(IExtendTaskPad *This, LPOLESTR pszGroup,
                                      LPOLESTR *pszDescriptiveText);
  HRESULT(WINAPI *GetBackground)(IExtendTaskPad *This, LPOLESTR pszGroup,
                                 MMC_TASK_DISPLAY_OBJECT *pTDO);
  HRESULT(WINAPI *GetListPadInfo)(IExtendTaskPad *This, LPOLESTR pszGroup,
...
#endif
#endif
HRESULT WINAPI IExtendTaskPad_TaskNotify_Proxy(IExtendTaskPad *This,
                                               IDataObject *pdo, VARIANT *arg,
                                               VARIANT *param);
void __RPC_STUB IExtendTaskPad_TaskNotify_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IExtendTaskPad_EnumTasks_Proxy(IExtendTaskPad *This,
                                              IDataObject *pdo,
...
void __RPC_STUB IExtendTaskPad_EnumTasks_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IExtendTaskPad_GetTitle_Proxy(IExtendTaskPad *This,
                                             LPOLESTR pszGroup,
                                             LPOLESTR *pszTitle);
void __RPC_STUB IExtendTaskPad_GetTitle_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IExtendTaskPad_GetDescriptiveText_Proxy(
    IExtendTaskPad *This, LPOLESTR pszGroup, LPOLESTR *pszDescriptiveText);
void __RPC_STUB IExtendTaskPad_GetDescriptiveText_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IExtendTaskPad_GetBackground_Proxy(
    IExtendTaskPad *This, LPOLESTR pszGroup, MMC_TASK_DISPLAY_OBJECT *pTDO);
void __RPC_STUB IExtendTaskPad_GetBackground_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IExtendTaskPad_GetListPadInfo_Proxy(
    IExtendTaskPad *This, LPOLESTR pszGroup, MMC_LISTPAD_INFO *lpListPadInfo);
...
typedef struct IConsole2Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IConsole2 *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *QueryScopeImageList)(IConsole2 *This,
                                       LPIMAGELIST *ppImageList);
  HRESULT(WINAPI *QueryResultImageList)(IConsole2 *This,
                                        LPIMAGELIST *ppImageList);
  HRESULT(WINAPI *UpdateAllViews)(IConsole2 *This, LPDATAOBJECT lpDataObject,
                                  LPARAM data, LONG_PTR hint);
  HRESULT(WINAPI *MessageBox)(IConsole2 *This, LPCWSTR lpszText,
                              LPCWSTR lpszTitle, UINT fuStyle, int *piRetval);
  HRESULT(WINAPI *QueryConsoleVerb)(IConsole2 *This,
                                    LPCONSOLEVERB *ppConsoleVerb);
  ...
  HRESULT(WINAPI *NewWindow)(IConsole2 *This, HSCOPEITEM hScopeItem,
                             unsigned __LONG32 lOptions);
...
#endif
#endif
HRESULT WINAPI IConsole2_Expand_Proxy(IConsole2 *This, HSCOPEITEM hItem,
                                      WINBOOL bExpand);
void __RPC_STUB IConsole2_Expand_Stub(IRpcStubBuffer *This,
                                      IRpcChannelBuffer *_pRpcChannelBuffer,
                                      PRPC_MESSAGE _pRpcMessage,
                                      DWORD *_pdwStubPhase);
...
void __RPC_STUB IConsole2_IsTaskpadViewPreferred_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IConsole2_SetStatusText_Proxy(IConsole2 *This,
...
typedef struct IDisplayHelpVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IDisplayHelp *This, REFIID riid,
                                  void **ppvObject);
...
#endif
#endif
HRESULT WINAPI IDisplayHelp_ShowTopic_Proxy(IDisplayHelp *This,
...
typedef struct IRequiredExtensionsVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IRequiredExtensions *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *GetFirstExtension)(IRequiredExtensions *This,
                                     LPCLSID pExtCLSID);
  HRESULT(WINAPI *GetNextExtension)(IRequiredExtensions *This,
                                    LPCLSID pExtCLSID);
  END_INTERFACE
...
#endif
HRESULT WINAPI
IRequiredExtensions_EnableAllExtensions_Proxy(IRequiredExtensions *This);
void __RPC_STUB IRequiredExtensions_EnableAllExtensions_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IRequiredExtensions_GetFirstExtension_Proxy(
    IRequiredExtensions *This, LPCLSID pExtCLSID);
void __RPC_STUB IRequiredExtensions_GetFirstExtension_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IRequiredExtensions_GetNextExtension_Proxy(
    IRequiredExtensions *This, LPCLSID pExtCLSID);
...
public:
  virtual HRESULT WINAPI AddString(LPCOLESTR pszAdd,
                                   MMC_STRING_ID *pStringID) = 0;
  virtual HRESULT WINAPI GetString(MMC_STRING_ID StringID, ULONG cchBuffer,
                                   LPOLESTR lpBuffer, ULONG *pcchOut) = 0;
  virtual HRESULT WINAPI GetStringLength(MMC_STRING_ID StringID,
                                         ULONG *pcchString) = 0;
  virtual HRESULT WINAPI DeleteString(MMC_STRING_ID StringID) = 0;
  virtual HRESULT WINAPI DeleteAllStrings(void) = 0;
  virtual HRESULT WINAPI FindString(LPCOLESTR pszFind,
                                    MMC_STRING_ID *pStringID) = 0;
...
typedef struct IStringTableVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IStringTable *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IStringTable *This);
  ULONG(WINAPI *Release)(IStringTable *This);
  HRESULT(WINAPI *AddString)(IStringTable *This, LPCOLESTR pszAdd,
                             MMC_STRING_ID *pStringID);
  HRESULT(WINAPI *GetString)(IStringTable *This, MMC_STRING_ID StringID,
                             ULONG cchBuffer, LPOLESTR lpBuffer,
                             ULONG *pcchOut);
  HRESULT(WINAPI *GetStringLength)(IStringTable *This, MMC_STRING_ID StringID,
                                   ULONG *pcchString);
  HRESULT(WINAPI *DeleteString)(IStringTable *This, MMC_STRING_ID StringID);
  HRESULT(WINAPI *DeleteAllStrings)(IStringTable *This);
  HRESULT(WINAPI *FindString)(IStringTable *This, LPCOLESTR pszFind,
                              MMC_STRING_ID *pStringID);
...
#endif
#endif
HRESULT WINAPI IStringTable_AddString_Proxy(IStringTable *This,
                                            LPCOLESTR pszAdd,
                                            MMC_STRING_ID *pStringID);
void __RPC_STUB IStringTable_AddString_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IStringTable_GetString_Proxy(IStringTable *This,
...
void __RPC_STUB IStringTable_GetString_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IStringTable_GetStringLength_Proxy(IStringTable *This,
                                                  MMC_STRING_ID StringID,
                                                  ULONG *pcchString);
void __RPC_STUB IStringTable_GetStringLength_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IStringTable_DeleteString_Proxy(IStringTable *This,
                                               MMC_STRING_ID StringID);
...
void __RPC_STUB IStringTable_DeleteAllStrings_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IStringTable_FindString_Proxy(IStringTable *This,
                                             LPCOLESTR pszFind,
                                             MMC_STRING_ID *pStringID);
void __RPC_STUB IStringTable_FindString_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IStringTable_Enumerate_Proxy(IStringTable *This,
                                            IEnumString **ppEnum);
...
public:
  virtual HRESULT WINAPI SetColumnConfigData(
      SColumnSetID *pColID, MMC_COLUMN_SET_DATA *pColSetData) = 0;
  virtual HRESULT WINAPI GetColumnConfigData(
      SColumnSetID *pColID, MMC_COLUMN_SET_DATA **ppColSetData) = 0;
  virtual HRESULT WINAPI SetColumnSortData(SColumnSetID *pColID,
                                           MMC_SORT_SET_DATA *pColSortData) = 0;
  virtual HRESULT WINAPI GetColumnSortData(
      SColumnSetID *pColID, MMC_SORT_SET_DATA **ppColSortData) = 0;
};
#else
typedef struct IColumnDataVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IColumnData *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IColumnData *This);
  ULONG(WINAPI *Release)(IColumnData *This);
  HRESULT(WINAPI *SetColumnConfigData)(IColumnData *This, SColumnSetID *pColID,
                                       MMC_COLUMN_SET_DATA *pColSetData);
  HRESULT(WINAPI *GetColumnConfigData)(IColumnData *This, SColumnSetID *pColID,
                                       MMC_COLUMN_SET_DATA **ppColSetData);
  HRESULT(WINAPI *SetColumnSortData)(IColumnData *This, SColumnSetID *pColID,
                                     MMC_SORT_SET_DATA *pColSortData);
  HRESULT(WINAPI *GetColumnSortData)(IColumnData *This, SColumnSetID *pColID,
...
#endif
#endif
HRESULT WINAPI IColumnData_SetColumnConfigData_Proxy(
    IColumnData *This, SColumnSetID *pColID, MMC_COLUMN_SET_DATA *pColSetData);
void __RPC_STUB IColumnData_SetColumnConfigData_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
IColumnData_GetColumnConfigData_Proxy(IColumnData *This, SColumnSetID *pColID,
                                      MMC_COLUMN_SET_DATA **ppColSetData);
void __RPC_STUB IColumnData_GetColumnConfigData_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IColumnData_SetColumnSortData_Proxy(
    IColumnData *This, SColumnSetID *pColID, MMC_SORT_SET_DATA *pColSortData);
void __RPC_STUB IColumnData_SetColumnSortData_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IColumnData_GetColumnSortData_Proxy(
    IColumnData *This, SColumnSetID *pColID, MMC_SORT_SET_DATA **ppColSortData);
...
typedef struct IMessageViewVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMessageView *This, REFIID riid,
                                  void **ppvObject);
...
#endif
#endif
HRESULT WINAPI IMessageView_SetTitleText_Proxy(IMessageView *This,
                                               LPCOLESTR pszTitleText);
void __RPC_STUB IMessageView_SetTitleText_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMessageView_SetBodyText_Proxy(IMessageView *This,
                                              LPCOLESTR pszBodyText);
void __RPC_STUB IMessageView_SetBodyText_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IMessageView_SetIcon_Proxy(IMessageView *This,
                                          IconIdentifier id);
void __RPC_STUB IMessageView_SetIcon_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
HRESULT WINAPI IMessageView_Clear_Proxy(IMessageView *This);
void __RPC_STUB IMessageView_Clear_Stub(IRpcStubBuffer *This,
                                        IRpcChannelBuffer *_pRpcChannelBuffer,
                                        PRPC_MESSAGE _pRpcMessage,
                                        DWORD *_pdwStubPhase);
#endif
...
typedef struct IResultDataCompareExVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IResultDataCompareEx *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IResultDataCompareEx *This);
  ULONG(WINAPI *Release)(IResultDataCompareEx *This);
  HRESULT(WINAPI *Compare)(IResultDataCompareEx *This, RDCOMPARE *prdc,
                           int *pnResult);
  END_INTERFACE
...
#endif
#endif
HRESULT WINAPI IResultDataCompareEx_Compare_Proxy(IResultDataCompareEx *This,
                                                  RDCOMPARE *prdc,
                                                  int *pnResult);
...
public:
  virtual HRESULT WINAPI QueryDispatch(MMC_COOKIE cookie,
                                       DATA_OBJECT_TYPES type,
                                       LPDISPATCH *ppDispatch) = 0;
};
#else
typedef struct IComponentData2Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IComponentData2 *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *CreateComponent)(IComponentData2 *This,
                                   LPCOMPONENT *ppComponent);
  HRESULT(WINAPI *Notify)(IComponentData2 *This, LPDATAOBJECT lpDataObject,
                          MMC_NOTIFY_TYPE event, LPARAM arg, LPARAM param);
  HRESULT(WINAPI *Destroy)(IComponentData2 *This);
  HRESULT(WINAPI *QueryDataObject)(IComponentData2 *This, MMC_COOKIE cookie,
                                   DATA_OBJECT_TYPES type,
                                   LPDATAOBJECT *ppDataObject);
  HRESULT(WINAPI *GetDisplayInfo)(IComponentData2 *This,
                                  SCOPEDATAITEM *pScopeDataItem);
  HRESULT(WINAPI *CompareObjects)(IComponentData2 *This,
                                  LPDATAOBJECT lpDataObjectA,
                                  LPDATAOBJECT lpDataObjectB);
  HRESULT(WINAPI *QueryDispatch)(IComponentData2 *This, MMC_COOKIE cookie,
                                 DATA_OBJECT_TYPES type,
...
#endif
#endif
HRESULT WINAPI IComponentData2_QueryDispatch_Proxy(IComponentData2 *This,
                                                   MMC_COOKIE cookie,
                                                   DATA_OBJECT_TYPES type,
                                                   LPDISPATCH *ppDispatch);
...
public:
  virtual HRESULT WINAPI QueryDispatch(MMC_COOKIE cookie,
                                       DATA_OBJECT_TYPES type,
                                       LPDISPATCH *ppDispatch) = 0;
  virtual HRESULT WINAPI GetResultViewType2(
      MMC_COOKIE cookie, PRESULT_VIEW_TYPE_INFO pResultViewType) = 0;
  virtual HRESULT WINAPI RestoreResultView(
      MMC_COOKIE cookie, PRESULT_VIEW_TYPE_INFO pResultViewType) = 0;
};
#else
typedef struct IComponent2Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IComponent2 *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *Notify)(IComponent2 *This, LPDATAOBJECT lpDataObject,
                          MMC_NOTIFY_TYPE event, LPARAM arg, LPARAM param);
  HRESULT(WINAPI *Destroy)(IComponent2 *This, MMC_COOKIE cookie);
  HRESULT(WINAPI *QueryDataObject)(IComponent2 *This, MMC_COOKIE cookie,
                                   DATA_OBJECT_TYPES type,
                                   LPDATAOBJECT *ppDataObject);
  HRESULT(WINAPI *GetResultViewType)(IComponent2 *This, MMC_COOKIE cookie,
                                     LPOLESTR *ppViewType,
                                     __LONG32 *pViewOptions);
  HRESULT(WINAPI *GetDisplayInfo)(IComponent2 *This,
                                  RESULTDATAITEM *pResultDataItem);
  HRESULT(WINAPI *CompareObjects)(IComponent2 *This, LPDATAOBJECT lpDataObjectA,
                                  LPDATAOBJECT lpDataObjectB);
  HRESULT(WINAPI *QueryDispatch)(IComponent2 *This, MMC_COOKIE cookie,
                                 DATA_OBJECT_TYPES type,
                                 LPDISPATCH *ppDispatch);
  HRESULT(WINAPI *GetResultViewType2)(IComponent2 *This, MMC_COOKIE cookie,
                                      PRESULT_VIEW_TYPE_INFO pResultViewType);
  HRESULT(WINAPI *RestoreResultView)(IComponent2 *This, MMC_COOKIE cookie,
                                     PRESULT_VIEW_TYPE_INFO pResultViewType);
  END_INTERFACE
} IComponent2Vtbl;
struct IComponent2 {
...
#endif
#endif
HRESULT WINAPI IComponent2_QueryDispatch_Proxy(IComponent2 *This,
                                               MMC_COOKIE cookie,
                                               DATA_OBJECT_TYPES type,
                                               LPDISPATCH *ppDispatch);
void __RPC_STUB IComponent2_QueryDispatch_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
IComponent2_GetResultViewType2_Proxy(IComponent2 *This, MMC_COOKIE cookie,
                                     PRESULT_VIEW_TYPE_INFO pResultViewType);
void __RPC_STUB IComponent2_GetResultViewType2_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI
IComponent2_RestoreResultView_Proxy(IComponent2 *This, MMC_COOKIE cookie,
                                    PRESULT_VIEW_TYPE_INFO pResultViewType);
...
typedef struct IContextMenuCallback2Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IContextMenuCallback2 *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IContextMenuCallback2 *This);
  ULONG(WINAPI *Release)(IContextMenuCallback2 *This);
  HRESULT(WINAPI *AddItem)(IContextMenuCallback2 *This,
                           CONTEXTMENUITEM2 *pItem);
  END_INTERFACE
...
#endif
#endif
HRESULT WINAPI IContextMenuCallback2_AddItem_Proxy(IContextMenuCallback2 *This,
                                                   CONTEXTMENUITEM2 *pItem);
...
public:
  virtual HRESULT WINAPI GetMMCVersion(__LONG32 *pVersionMajor,
                                       __LONG32 *pVersionMinor) = 0;
};
#else
typedef struct IMMCVersionInfoVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IMMCVersionInfo *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IMMCVersionInfo *This);
  ULONG(WINAPI *Release)(IMMCVersionInfo *This);
  HRESULT(WINAPI *GetMMCVersion)(IMMCVersionInfo *This, __LONG32 *pVersionMajor,
                                 __LONG32 *pVersionMinor);
  END_INTERFACE
} IMMCVersionInfoVtbl;
...
#endif
#endif
HRESULT WINAPI IMMCVersionInfo_GetMMCVersion_Proxy(IMMCVersionInfo *This,
                                                   __LONG32 *pVersionMajor,
                                                   __LONG32 *pVersionMinor);
...
public:
  virtual HRESULT WINAPI
  GetViews(LPDATAOBJECT pDataObject,
           LPVIEWEXTENSIONCALLBACK pViewExtensionCallback) = 0;
};
#else
typedef struct IExtendViewVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IExtendView *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IExtendView *This);
  ULONG(WINAPI *Release)(IExtendView *This);
  HRESULT(WINAPI *GetViews)(IExtendView *This, LPDATAOBJECT pDataObject,
...
#endif
HRESULT WINAPI
IExtendView_GetViews_Proxy(IExtendView *This, LPDATAOBJECT pDataObject,
                           LPVIEWEXTENSIONCALLBACK pViewExtensionCallback);
void __RPC_STUB IExtendView_GetViews_Stub(IRpcStubBuffer *This,
                                          IRpcChannelBuffer *_pRpcChannelBuffer,
                                          PRPC_MESSAGE _pRpcMessage,
                                          DWORD *_pdwStubPhase);
#endif
...
typedef struct IViewExtensionCallbackVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IViewExtensionCallback *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IViewExtensionCallback *This);
  ULONG(WINAPI *Release)(IViewExtensionCallback *This);
  HRESULT(WINAPI *AddView)(IViewExtensionCallback *This,
                           PMMC_EXT_VIEW_DATA pExtViewData);
  END_INTERFACE
...
HRESULT WINAPI IViewExtensionCallback_AddView_Proxy(
    IViewExtensionCallback *This, PMMC_EXT_VIEW_DATA pExtViewData);
...
typedef struct IConsolePowerVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IConsolePower *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IConsolePower *This);
  ULONG(WINAPI *Release)(IConsolePower *This);
  HRESULT(WINAPI *SetExecutionState)(IConsolePower *This, DWORD dwAdd,
                                     DWORD dwRemove);
...
#endif
#endif
HRESULT WINAPI IConsolePower_SetExecutionState_Proxy(IConsolePower *This,
                                                     DWORD dwAdd,
                                                     DWORD dwRemove);
void __RPC_STUB IConsolePower_SetExecutionState_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IConsolePower_ResetIdleTimer_Proxy(IConsolePower *This,
                                                  DWORD dwFlags);
...
public:
  virtual HRESULT WINAPI OnPowerBroadcast(UINT nEvent, LPARAM lParam,
                                          LRESULT *plReturn) = 0;
};
#else
typedef struct IConsolePowerSinkVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IConsolePowerSink *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(IConsolePowerSink *This);
  ULONG(WINAPI *Release)(IConsolePowerSink *This);
  HRESULT(WINAPI *OnPowerBroadcast)(IConsolePowerSink *This, UINT nEvent,
                                    LPARAM lParam, LRESULT *plReturn);
  END_INTERFACE
...
#endif
#endif
HRESULT WINAPI IConsolePowerSink_OnPowerBroadcast_Proxy(IConsolePowerSink *This,
                                                        UINT nEvent,
                                                        LPARAM lParam,
                                                        LRESULT *plReturn);
...
public:
  virtual HRESULT WINAPI GetProperty(LPDATAOBJECT pDataObject,
                                     BSTR szPropertyName,
                                     PBSTR pbstrProperty) = 0;
};
#else
typedef struct INodePropertiesVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(INodeProperties *This, REFIID riid,
                                  void **ppvObject);
  ULONG(WINAPI *AddRef)(INodeProperties *This);
  ULONG(WINAPI *Release)(INodeProperties *This);
  HRESULT(WINAPI *GetProperty)(INodeProperties *This, LPDATAOBJECT pDataObject,
                               BSTR szPropertyName, PBSTR pbstrProperty);
  END_INTERFACE
} INodePropertiesVtbl;
...
#define INodeProperties_GetProperty(This, pDataObject, szPropertyName,         \
                                    pbstrProperty)                             \
  (This)->lpVtbl->GetProperty(This, pDataObject, szPropertyName, pbstrProperty)
#endif
#endif
HRESULT WINAPI INodeProperties_GetProperty_Proxy(INodeProperties *This,
...
typedef struct IConsole3Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IConsole3 *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *QueryScopeImageList)(IConsole3 *This,
                                       LPIMAGELIST *ppImageList);
  HRESULT(WINAPI *QueryResultImageList)(IConsole3 *This,
                                        LPIMAGELIST *ppImageList);
  HRESULT(WINAPI *UpdateAllViews)(IConsole3 *This, LPDATAOBJECT lpDataObject,
                                  LPARAM data, LONG_PTR hint);
  HRESULT(WINAPI *MessageBox)(IConsole3 *This, LPCWSTR lpszText,
                              LPCWSTR lpszTitle, UINT fuStyle, int *piRetval);
  HRESULT(WINAPI *QueryConsoleVerb)(IConsole3 *This,
                                    LPCONSOLEVERB *ppConsoleVerb);
  ...
  HRESULT(WINAPI *NewWindow)(IConsole3 *This, HSCOPEITEM hScopeItem,
                             unsigned __LONG32 lOptions);
...
#endif
#endif
HRESULT WINAPI IConsole3_RenameScopeItem_Proxy(IConsole3 *This,
                                               HSCOPEITEM hScopeItem);
...
typedef struct IResultData2Vtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IResultData2 *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *FindItemByLParam)(IResultData2 *This, LPARAM lParam,
                                    HRESULTITEM *pItemID);
  ...
  HRESULT(WINAPI *ModifyItemState)(IResultData2 *This, int nIndex,
                                   HRESULTITEM itemID, UINT uAdd, UINT uRemove);
  HRESULT(WINAPI *ModifyViewStyle)(IResultData2 *This,
                                   MMC_RESULT_VIEW_STYLE add,
                                   MMC_RESULT_VIEW_STYLE remove);
  ...
  HRESULT(WINAPI *Sort)(IResultData2 *This, int nColumn, DWORD dwSortOptions,
                        LPARAM lUserParam);
  HRESULT(WINAPI *SetDescBarText)(IResultData2 *This, LPOLESTR DescText);
  HRESULT(WINAPI *SetItemCount)(IResultData2 *This, int nItemCount,
                                DWORD dwOptions);
...
#endif
#endif
HRESULT WINAPI IResultData2_RenameResultItem_Proxy(IResultData2 *This,
                                                   HRESULTITEM itemID);
...
unsigned char *__RPC_API HBITMAP_UserMarshal(ULONG *, unsigned char *,
                                             HBITMAP *);
unsigned char *__RPC_API HBITMAP_UserUnmarshal(ULONG *, unsigned char *,
                                               HBITMAP *);
...
unsigned char *__RPC_API HPALETTE_UserMarshal(ULONG *, unsigned char *,
                                              HPALETTE *);
unsigned char *__RPC_API HPALETTE_UserUnmarshal(ULONG *, unsigned char *,
                                                HPALETTE *);
