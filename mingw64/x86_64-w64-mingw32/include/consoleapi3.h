...
GetNumberOfConsoleMouseButtons(LPDWORD number_of_mouse_buttons);
#if (_WIN32_WINNT >= 0x0500)
WINBASEAPI COORD WINAPI GetConsoleFontSize(HANDLE console_output, DWORD font);
WINBASEAPI WINBOOL WINAPI
GetCurrentConsoleFont(HANDLE console_output, WINBOOL maximum_window,
                      PCONSOLE_FONT_INFO console_current_font);
#ifndef NOGDI
...
WINBASEAPI WINBOOL WINAPI
GetCurrentConsoleFontEx(HANDLE console_output, WINBOOL maximum_window,
                        PCONSOLE_FONT_INFOEX console_current_font_ex);
WINBASEAPI WINBOOL WINAPI
SetCurrentConsoleFontEx(HANDLE console_output, WINBOOL maximum_window,
                        PCONSOLE_FONT_INFOEX console_current_font_ex);
#endif /* !NOGDI */
...
WINBASEAPI WINBOOL WINAPI
GetConsoleSelectionInfo(PCONSOLE_SELECTION_INFO console_selection_info);
...
WINBASEAPI WINBOOL WINAPI
GetConsoleHistoryInfo(PCONSOLE_HISTORY_INFO console_history_info);
WINBASEAPI WINBOOL WINAPI
SetConsoleHistoryInfo(PCONSOLE_HISTORY_INFO console_history_info);
...
WINBASEAPI
    WINBOOL APIENTRY SetConsoleDisplayMode(HANDLE console_output, DWORD flags,
                                           PCOORD new_screen_buffer_dimensions);
WINBASEAPI HWND APIENTRY GetConsoleWindow(void);
#endif /* _WIN32_WINNT >= 0x0500 */
#if (_WIN32_WINNT >= 0x0501)
WINBASEAPI WINBOOL APIENTRY AddConsoleAliasA(LPSTR source, LPSTR target,
                                             LPSTR exe_name);
...
WINBASEAPI DWORD APIENTRY GetConsoleAliasA(LPSTR source, LPSTR target_buffer,
                                           DWORD target_buffer_length,
                                           LPSTR exe_name);
WINBASEAPI DWORD APIENTRY GetConsoleAliasW(LPWSTR source, LPWSTR target_buffer,
                                           DWORD target_buffer_length,
                                           LPWSTR exe_name);
...
WINBASEAPI DWORD APIENTRY GetConsoleAliasesA(LPSTR alias_buffer,
                                             DWORD alias_buffer_length,
                                             LPSTR exe_name);
WINBASEAPI DWORD APIENTRY GetConsoleAliasesW(LPWSTR alias_buffer,
                                             DWORD alias_buffer_length,
                                             LPWSTR exe_name);
#define GetConsoleAliases __MINGW_NAME_AW(GetConsoleAliases)
WINBASEAPI DWORD APIENTRY GetConsoleAliasExesA(LPSTR exe_name_buffer,
                                               DWORD exe_name_buffer_length);
WINBASEAPI DWORD APIENTRY GetConsoleAliasExesW(LPWSTR exe_name_buffer,
                                               DWORD exe_name_buffer_length);
...
WINBASEAPI WINBOOL APIENTRY SetConsoleNumberOfCommandsA(DWORD number,
                                                        LPSTR exe_name);
WINBASEAPI WINBOOL APIENTRY SetConsoleNumberOfCommandsW(DWORD number,
                                                        LPWSTR exe_name);
...
WINBASEAPI DWORD APIENTRY GetConsoleCommandHistoryA(LPSTR commands,
                                                    DWORD command_buffer_length,
                                                    LPSTR exe_name);
WINBASEAPI DWORD APIENTRY GetConsoleCommandHistoryW(LPWSTR commands,
                                                    DWORD command_buffer_length,
                                                    LPWSTR exe_name);
#define GetConsoleCommandHistory __MINGW_NAME_AW(GetConsoleCommandHistory)
#if (_WIN32_WINNT >= 0x0501)
WINBASEAPI DWORD APIENTRY GetConsoleProcessList(LPDWORD process_list,
                                                DWORD process_count);
#endif /* _WIN32_WINNT >= 0x0501 */
