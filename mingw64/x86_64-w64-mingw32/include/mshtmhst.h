...
DEFINE_GUID(CGID_DocHostCommandHandler, 0xf38bc242, 0xb950, 0x11d1, 0x89, 0x18,
            0x00, 0xc0, 0x4f, 0xc2, 0xc8, 0x36);
...
SHOWHTMLDIALOGEXFN(HWND hwndParent, IMoniker *pmk, DWORD dwDialogFlags,
                   VARIANT *pvarArgIn, WCHAR *pchOptions, VARIANT *pvArgOut);
typedef HRESULT STDAPICALLTYPE
SHOWMODELESSHTMLDIALOGFN(HWND hwndParent, IMoniker *pmk, VARIANT *pvarArgIn,
                         VARIANT *pvarOptions, IHTMLWindow2 **ppWindow);
typedef HRESULT STDAPICALLTYPE IEREGISTERXMLNSFN(LPCWSTR lpszURI, GUID clsid,
                                                 BOOL fMachine);
typedef HRESULT STDAPICALLTYPE IEISXMLNSREGISTEREDFN(LPCWSTR lpszURI,
                                                     GUID *pCLSID);
STDAPI ShowHTMLDialog(HWND hwndParent, IMoniker *pMk, VARIANT *pvarArgIn,
                      LPWSTR pchOptions, VARIANT *pvarArgOut);
STDAPI ShowHTMLDialogEx(HWND hwndParent, IMoniker *pMk, DWORD dwDialogFlags,
                        VARIANT *pvarArgIn, LPWSTR pchOptions,
                        VARIANT *pvarArgOut);
STDAPI ShowModelessHTMLDialog(HWND hwndParent, IMoniker *pMk,
                              VARIANT *pvarArgIn, VARIANT *pvarOptions,
                              IHTMLWindow2 **ppWindow);
#if !defined(_ARM_) && !defined(__arm__)
STDAPI RunHTMLApplication(HINSTANCE hinst, HINSTANCE hPrevInst, LPSTR szCmdLine,
                          int nCmdShow);
#endif
...
STDAPI GetColorValueFromString(LPCWSTR lpszColor, BOOL fStrictCSS1,
                               BOOL fIsStandardsCSS, COLORREF *pColor);
...
DEFINE_GUID(IID_IHostDialogHelper, 0x53dec138, 0xa51e, 0x11d2, 0x86, 0x1e, 0x00,
...
IHostDialogHelper : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE ShowHTMLDialog(
      HWND hwndParent, IMoniker * pMk, VARIANT * pvarArgIn, WCHAR * pchOptions,
      VARIANT * pvarArgOut, IUnknown * punkHost) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IHostDialogHelper, 0x53dec138, 0xa51e, 0x11d2, 0x86, 0x1e, 0x00,
                0xc0, 0x4f, 0xa3, 0x5c, 0x89)
#endif
#else
typedef struct IHostDialogHelperVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IHostDialogHelper *This,
  ...
  HRESULT(STDMETHODCALLTYPE *ShowHTMLDialog)(IHostDialogHelper *This,
                                             HWND hwndParent, IMoniker *pMk,
                                             VARIANT *pvarArgIn,
                                             WCHAR *pchOptions,
                                             VARIANT *pvarArgOut,
                                             IUnknown *punkHost);
...
interface IHostDialogHelper { CONST_VTBL IHostDialogHelperVtbl *lpVtbl; };
#ifdef COBJMACROS
...
/*** IHostDialogHelper methods ***/
#define IHostDialogHelper_ShowHTMLDialog(This, hwndParent, pMk, pvarArgIn,     \
                                         pchOptions, pvarArgOut, punkHost)     \
  (This)->lpVtbl->ShowHTMLDialog(This, hwndParent, pMk, pvarArgIn, pchOptions, \
                                 pvarArgOut, punkHost)
#else
/*** IUnknown methods ***/
static inline HRESULT IHostDialogHelper_QueryInterface(IHostDialogHelper *This,
                                                       REFIID riid,
                                                       void **ppvObject) {
...
/*** IHostDialogHelper methods ***/
static inline HRESULT IHostDialogHelper_ShowHTMLDialog(
    IHostDialogHelper *This, HWND hwndParent, IMoniker *pMk, VARIANT *pvarArgIn,
    WCHAR *pchOptions, VARIANT *pvarArgOut, IUnknown *punkHost) {
  return This->lpVtbl->ShowHTMLDialog(This, hwndParent, pMk, pvarArgIn,
                                      pchOptions, pvarArgOut, punkHost);
}
#endif
#endif
 ...
 */
DEFINE_GUID(CLSID_HostDialogHelper, 0x429af92c, 0xa51f, 0x11d2, 0x86, 0x1e,
            0x00, 0xc0, 0x4f, 0xa3, 0x5c, 0x89);
#ifdef __cplusplus
class DECLSPEC_UUID("429af92c-a51f-11d2-861e-00c04fa35c89") HostDialogHelper;
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(HostDialogHelper, 0x429af92c, 0xa51f, 0x11d2, 0x86, 0x1e, 0x00,
                0xc0, 0x4f, 0xa3, 0x5c, 0x89)
#endif
#endif
/*****************************************************************************
...
DEFINE_GUID(IID_IDocHostUIHandler, 0xbd3f23c0, 0xd43e, 0x11cf, 0x89, 0x3b, 0x00,
...
IDocHostUIHandler : public IUnknown {
  ...
  virtual HRESULT STDMETHODCALLTYPE TranslateAccelerator(
      LPMSG lpMsg, const GUID *pguidCmdGroup, DWORD nCmdID) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetOptionKeyPath(LPOLESTR * pchKey,
                                                     DWORD dw) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetDropTarget(
      IDropTarget * pDropTarget, IDropTarget * *ppDropTarget) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetExternal(IDispatch * *ppDispatch) = 0;
  virtual HRESULT STDMETHODCALLTYPE TranslateUrl(
      DWORD dwTranslate, LPWSTR pchURLIn, LPWSTR * ppchURLOut) = 0;
  virtual HRESULT STDMETHODCALLTYPE FilterDataObject(
      IDataObject * pDO, IDataObject * *ppDORet) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDocHostUIHandler, 0xbd3f23c0, 0xd43e, 0x11cf, 0x89, 0x3b, 0x00,
                0xaa, 0x00, 0xbd, 0xce, 0x1a)
#endif
#else
typedef struct IDocHostUIHandlerVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDocHostUIHandler *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IDocHostUIHandler *This);
  ULONG(STDMETHODCALLTYPE *Release)(IDocHostUIHandler *This);
  /*** IDocHostUIHandler methods ***/
  HRESULT(STDMETHODCALLTYPE *ShowContextMenu)(IDocHostUIHandler *This,
                                              DWORD dwID, POINT *ppt,
                                              IUnknown *pcmdtReserved,
                                              IDispatch *pdispReserved);
  HRESULT(STDMETHODCALLTYPE *GetHostInfo)(IDocHostUIHandler *This,
                                          DOCHOSTUIINFO *pInfo);
  HRESULT(STDMETHODCALLTYPE *ShowUI)(IDocHostUIHandler *This, DWORD dwID,
  ...
  HRESULT(STDMETHODCALLTYPE *EnableModeless)(IDocHostUIHandler *This,
                                             WINBOOL fEnable);
  HRESULT(STDMETHODCALLTYPE *OnDocWindowActivate)(IDocHostUIHandler *This,
                                                  WINBOOL fActivate);
  HRESULT(STDMETHODCALLTYPE *OnFrameWindowActivate)(IDocHostUIHandler *This,
                                                    WINBOOL fActivate);
  HRESULT(STDMETHODCALLTYPE *ResizeBorder)(IDocHostUIHandler *This,
                                           LPCRECT prcBorder,
                                           IOleInPlaceUIWindow *pUIWindow,
                                           WINBOOL fRameWindow);
  HRESULT(STDMETHODCALLTYPE *TranslateAccelerator)(IDocHostUIHandler *This,
                                                   LPMSG lpMsg,
                                                   const GUID *pguidCmdGroup,
                                                   DWORD nCmdID);
  HRESULT(STDMETHODCALLTYPE *GetOptionKeyPath)(IDocHostUIHandler *This,
                                               LPOLESTR *pchKey, DWORD dw);
  HRESULT(STDMETHODCALLTYPE *GetDropTarget)(IDocHostUIHandler *This,
                                            IDropTarget *pDropTarget,
                                            IDropTarget **ppDropTarget);
  HRESULT(STDMETHODCALLTYPE *GetExternal)(IDocHostUIHandler *This,
                                          IDispatch **ppDispatch);
  HRESULT(STDMETHODCALLTYPE *TranslateUrl)(IDocHostUIHandler *This,
                                           DWORD dwTranslate, LPWSTR pchURLIn,
                                           LPWSTR *ppchURLOut);
  HRESULT(STDMETHODCALLTYPE *FilterDataObject)(IDocHostUIHandler *This,
                                               IDataObject *pDO,
                                               IDataObject **ppDORet);
  END_INTERFACE
} IDocHostUIHandlerVtbl;
interface IDocHostUIHandler { CONST_VTBL IDocHostUIHandlerVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IDocHostUIHandler methods ***/
#define IDocHostUIHandler_ShowContextMenu(This, dwID, ppt, pcmdtReserved,      \
                                          pdispReserved)                       \
...
#define IDocHostUIHandler_ShowUI(This, dwID, pActiveObject, pCommandTarget,    \
                                 pFrame, pDoc)                                 \
  (This)->lpVtbl->ShowUI(This, dwID, pActiveObject, pCommandTarget, pFrame,    \
                         pDoc)
...
#define IDocHostUIHandler_ResizeBorder(This, prcBorder, pUIWindow,             \
                                       fRameWindow)                            \
  (This)->lpVtbl->ResizeBorder(This, prcBorder, pUIWindow, fRameWindow)
#define IDocHostUIHandler_TranslateAccelerator(This, lpMsg, pguidCmdGroup,     \
                                               nCmdID)                         \
...
#define IDocHostUIHandler_TranslateUrl(This, dwTranslate, pchURLIn,            \
                                       ppchURLOut)                             \
...
#else
/*** IUnknown methods ***/
static inline HRESULT IDocHostUIHandler_QueryInterface(IDocHostUIHandler *This,
                                                       REFIID riid,
                                                       void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
IDocHostUIHandler_ShowContextMenu(IDocHostUIHandler *This, DWORD dwID,
                                  POINT *ppt, IUnknown *pcmdtReserved,
                                  IDispatch *pdispReserved) {
  return This->lpVtbl->ShowContextMenu(This, dwID, ppt, pcmdtReserved,
                                       pdispReserved);
}
static inline HRESULT IDocHostUIHandler_GetHostInfo(IDocHostUIHandler *This,
                                                    DOCHOSTUIINFO *pInfo) {
  return This->lpVtbl->GetHostInfo(This, pInfo);
}
static inline HRESULT
IDocHostUIHandler_ShowUI(IDocHostUIHandler *This, DWORD dwID,
                         IOleInPlaceActiveObject *pActiveObject,
                         IOleCommandTarget *pCommandTarget,
                         IOleInPlaceFrame *pFrame, IOleInPlaceUIWindow *pDoc) {
  return This->lpVtbl->ShowUI(This, dwID, pActiveObject, pCommandTarget, pFrame,
                              pDoc);
}
...
static inline HRESULT IDocHostUIHandler_EnableModeless(IDocHostUIHandler *This,
                                                       WINBOOL fEnable) {
  return This->lpVtbl->EnableModeless(This, fEnable);
}
static inline HRESULT
IDocHostUIHandler_OnDocWindowActivate(IDocHostUIHandler *This,
                                      WINBOOL fActivate) {
  return This->lpVtbl->OnDocWindowActivate(This, fActivate);
}
static inline HRESULT
IDocHostUIHandler_OnFrameWindowActivate(IDocHostUIHandler *This,
                                        WINBOOL fActivate) {
  return This->lpVtbl->OnFrameWindowActivate(This, fActivate);
}
static inline HRESULT
IDocHostUIHandler_ResizeBorder(IDocHostUIHandler *This, LPCRECT prcBorder,
                               IOleInPlaceUIWindow *pUIWindow,
                               WINBOOL fRameWindow) {
  return This->lpVtbl->ResizeBorder(This, prcBorder, pUIWindow, fRameWindow);
}
static inline HRESULT
IDocHostUIHandler_TranslateAccelerator(IDocHostUIHandler *This, LPMSG lpMsg,
                                       const GUID *pguidCmdGroup,
                                       DWORD nCmdID) {
  return This->lpVtbl->TranslateAccelerator(This, lpMsg, pguidCmdGroup, nCmdID);
}
static inline HRESULT
IDocHostUIHandler_GetOptionKeyPath(IDocHostUIHandler *This, LPOLESTR *pchKey,
                                   DWORD dw) {
  return This->lpVtbl->GetOptionKeyPath(This, pchKey, dw);
}
static inline HRESULT
IDocHostUIHandler_GetDropTarget(IDocHostUIHandler *This,
                                IDropTarget *pDropTarget,
                                IDropTarget **ppDropTarget) {
  return This->lpVtbl->GetDropTarget(This, pDropTarget, ppDropTarget);
}
static inline HRESULT IDocHostUIHandler_GetExternal(IDocHostUIHandler *This,
                                                    IDispatch **ppDispatch) {
  return This->lpVtbl->GetExternal(This, ppDispatch);
}
static inline HRESULT IDocHostUIHandler_TranslateUrl(IDocHostUIHandler *This,
                                                     DWORD dwTranslate,
                                                     LPWSTR pchURLIn,
                                                     LPWSTR *ppchURLOut) {
...
static inline HRESULT
IDocHostUIHandler_FilterDataObject(IDocHostUIHandler *This, IDataObject *pDO,
                                   IDataObject **ppDORet) {
...
DEFINE_GUID(IID_IDocHostUIHandler2, 0x3050f6d0, 0x98b5, 0x11cf, 0xbb, 0x82,
...
IDocHostUIHandler2 : public IDocHostUIHandler {
  virtual HRESULT STDMETHODCALLTYPE GetOverrideKeyPath(LPOLESTR * pchKey,
                                                       DWORD dw) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDocHostUIHandler2, 0x3050f6d0, 0x98b5, 0x11cf, 0xbb, 0x82,
                0x00, 0xaa, 0x00, 0xbd, 0xce, 0x0b)
#endif
#else
typedef struct IDocHostUIHandler2Vtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDocHostUIHandler2 *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IDocHostUIHandler2 *This);
  ULONG(STDMETHODCALLTYPE *Release)(IDocHostUIHandler2 *This);
  /*** IDocHostUIHandler methods ***/
  HRESULT(STDMETHODCALLTYPE *ShowContextMenu)(IDocHostUIHandler2 *This,
                                              DWORD dwID, POINT *ppt,
                                              IUnknown *pcmdtReserved,
                                              IDispatch *pdispReserved);
  HRESULT(STDMETHODCALLTYPE *GetHostInfo)(IDocHostUIHandler2 *This,
                                          DOCHOSTUIINFO *pInfo);
  HRESULT(STDMETHODCALLTYPE *ShowUI)(IDocHostUIHandler2 *This, DWORD dwID,
                                     IOleInPlaceActiveObject *pActiveObject,
                                     IOleCommandTarget *pCommandTarget,
                                     IOleInPlaceFrame *pFrame,
                                     IOleInPlaceUIWindow *pDoc);
  ...
  HRESULT(STDMETHODCALLTYPE *EnableModeless)(IDocHostUIHandler2 *This,
                                             WINBOOL fEnable);
  HRESULT(STDMETHODCALLTYPE *OnDocWindowActivate)(IDocHostUIHandler2 *This,
                                                  WINBOOL fActivate);
  HRESULT(STDMETHODCALLTYPE *OnFrameWindowActivate)(IDocHostUIHandler2 *This,
                                                    WINBOOL fActivate);
  HRESULT(STDMETHODCALLTYPE *ResizeBorder)(IDocHostUIHandler2 *This,
                                           LPCRECT prcBorder,
                                           IOleInPlaceUIWindow *pUIWindow,
                                           WINBOOL fRameWindow);
  HRESULT(STDMETHODCALLTYPE *TranslateAccelerator)(IDocHostUIHandler2 *This,
                                                   LPMSG lpMsg,
                                                   const GUID *pguidCmdGroup,
                                                   DWORD nCmdID);
  HRESULT(STDMETHODCALLTYPE *GetOptionKeyPath)(IDocHostUIHandler2 *This,
                                               LPOLESTR *pchKey, DWORD dw);
  HRESULT(STDMETHODCALLTYPE *GetDropTarget)(IDocHostUIHandler2 *This,
                                            IDropTarget *pDropTarget,
                                            IDropTarget **ppDropTarget);
  HRESULT(STDMETHODCALLTYPE *GetExternal)(IDocHostUIHandler2 *This,
                                          IDispatch **ppDispatch);
  HRESULT(STDMETHODCALLTYPE *TranslateUrl)(IDocHostUIHandler2 *This,
                                           DWORD dwTranslate, LPWSTR pchURLIn,
                                           LPWSTR *ppchURLOut);
  HRESULT(STDMETHODCALLTYPE *FilterDataObject)(IDocHostUIHandler2 *This,
                                               IDataObject *pDO,
                                               IDataObject **ppDORet);
  /*** IDocHostUIHandler2 methods ***/
  HRESULT(STDMETHODCALLTYPE *GetOverrideKeyPath)(IDocHostUIHandler2 *This,
                                                 LPOLESTR *pchKey, DWORD dw);
  END_INTERFACE
} IDocHostUIHandler2Vtbl;
interface IDocHostUIHandler2 { CONST_VTBL IDocHostUIHandler2Vtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IDocHostUIHandler methods ***/
#define IDocHostUIHandler2_ShowContextMenu(This, dwID, ppt, pcmdtReserved,     \
                                           pdispReserved)                      \
  (This)->lpVtbl->ShowContextMenu(This, dwID, ppt, pcmdtReserved, pdispReserved)
#define IDocHostUIHandler2_GetHostInfo(This, pInfo)                            \
  (This)->lpVtbl->GetHostInfo(This, pInfo)
#define IDocHostUIHandler2_ShowUI(This, dwID, pActiveObject, pCommandTarget,   \
                                  pFrame, pDoc)                                \
  (This)->lpVtbl->ShowUI(This, dwID, pActiveObject, pCommandTarget, pFrame,    \
                         pDoc)
...
#define IDocHostUIHandler2_OnFrameWindowActivate(This, fActivate)              \
  (This)->lpVtbl->OnFrameWindowActivate(This, fActivate)
#define IDocHostUIHandler2_ResizeBorder(This, prcBorder, pUIWindow,            \
                                        fRameWindow)                           \
  (This)->lpVtbl->ResizeBorder(This, prcBorder, pUIWindow, fRameWindow)
#define IDocHostUIHandler2_TranslateAccelerator(This, lpMsg, pguidCmdGroup,    \
                                                nCmdID)                        \
  (This)->lpVtbl->TranslateAccelerator(This, lpMsg, pguidCmdGroup, nCmdID)
...
#define IDocHostUIHandler2_GetExternal(This, ppDispatch)                       \
  (This)->lpVtbl->GetExternal(This, ppDispatch)
#define IDocHostUIHandler2_TranslateUrl(This, dwTranslate, pchURLIn,           \
                                        ppchURLOut)                            \
  (This)->lpVtbl->TranslateUrl(This, dwTranslate, pchURLIn, ppchURLOut)
...
/*** IUnknown methods ***/
static inline HRESULT
IDocHostUIHandler2_QueryInterface(IDocHostUIHandler2 *This, REFIID riid,
                                  void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IDocHostUIHandler methods ***/
static inline HRESULT
IDocHostUIHandler2_ShowContextMenu(IDocHostUIHandler2 *This, DWORD dwID,
                                   POINT *ppt, IUnknown *pcmdtReserved,
                                   IDispatch *pdispReserved) {
  return This->lpVtbl->ShowContextMenu(This, dwID, ppt, pcmdtReserved,
                                       pdispReserved);
}
static inline HRESULT IDocHostUIHandler2_GetHostInfo(IDocHostUIHandler2 *This,
                                                     DOCHOSTUIINFO *pInfo) {
  return This->lpVtbl->GetHostInfo(This, pInfo);
}
static inline HRESULT
IDocHostUIHandler2_ShowUI(IDocHostUIHandler2 *This, DWORD dwID,
                          IOleInPlaceActiveObject *pActiveObject,
                          IOleCommandTarget *pCommandTarget,
                          IOleInPlaceFrame *pFrame, IOleInPlaceUIWindow *pDoc) {
  return This->lpVtbl->ShowUI(This, dwID, pActiveObject, pCommandTarget, pFrame,
...
static inline HRESULT
IDocHostUIHandler2_EnableModeless(IDocHostUIHandler2 *This, WINBOOL fEnable) {
  return This->lpVtbl->EnableModeless(This, fEnable);
}
static inline HRESULT
IDocHostUIHandler2_OnDocWindowActivate(IDocHostUIHandler2 *This,
                                       WINBOOL fActivate) {
  return This->lpVtbl->OnDocWindowActivate(This, fActivate);
}
static inline HRESULT
IDocHostUIHandler2_OnFrameWindowActivate(IDocHostUIHandler2 *This,
                                         WINBOOL fActivate) {
  return This->lpVtbl->OnFrameWindowActivate(This, fActivate);
}
static inline HRESULT
IDocHostUIHandler2_ResizeBorder(IDocHostUIHandler2 *This, LPCRECT prcBorder,
                                IOleInPlaceUIWindow *pUIWindow,
                                WINBOOL fRameWindow) {
  return This->lpVtbl->ResizeBorder(This, prcBorder, pUIWindow, fRameWindow);
}
static inline HRESULT
IDocHostUIHandler2_TranslateAccelerator(IDocHostUIHandler2 *This, LPMSG lpMsg,
                                        const GUID *pguidCmdGroup,
                                        DWORD nCmdID) {
  return This->lpVtbl->TranslateAccelerator(This, lpMsg, pguidCmdGroup, nCmdID);
}
static inline HRESULT
IDocHostUIHandler2_GetOptionKeyPath(IDocHostUIHandler2 *This, LPOLESTR *pchKey,
                                    DWORD dw) {
  return This->lpVtbl->GetOptionKeyPath(This, pchKey, dw);
}
static inline HRESULT
IDocHostUIHandler2_GetDropTarget(IDocHostUIHandler2 *This,
                                 IDropTarget *pDropTarget,
                                 IDropTarget **ppDropTarget) {
  return This->lpVtbl->GetDropTarget(This, pDropTarget, ppDropTarget);
}
static inline HRESULT IDocHostUIHandler2_GetExternal(IDocHostUIHandler2 *This,
                                                     IDispatch **ppDispatch) {
  return This->lpVtbl->GetExternal(This, ppDispatch);
}
static inline HRESULT IDocHostUIHandler2_TranslateUrl(IDocHostUIHandler2 *This,
                                                      DWORD dwTranslate,
                                                      LPWSTR pchURLIn,
                                                      LPWSTR *ppchURLOut) {
  return This->lpVtbl->TranslateUrl(This, dwTranslate, pchURLIn, ppchURLOut);
...
static inline HRESULT
IDocHostUIHandler2_FilterDataObject(IDocHostUIHandler2 *This, IDataObject *pDO,
                                    IDataObject **ppDORet) {
  return This->lpVtbl->FilterDataObject(This, pDO, ppDORet);
}
/*** IDocHostUIHandler2 methods ***/
static inline HRESULT
IDocHostUIHandler2_GetOverrideKeyPath(IDocHostUIHandler2 *This,
                                      LPOLESTR *pchKey, DWORD dw) {
...
DEFINE_GUID(IID_ICustomDoc, 0x3050f3f0, 0x98b5, 0x11cf, 0xbb, 0x82, 0x00, 0xaa,
            0x00, 0xbd, 0xce, 0x0b);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("3050f3f0-98b5-11cf-bb82-00aa00bdce0b")
ICustomDoc : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE SetUIHandler(IDocHostUIHandler *
                                                 pUIHandler) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ICustomDoc, 0x3050f3f0, 0x98b5, 0x11cf, 0xbb, 0x82, 0x00, 0xaa,
                0x00, 0xbd, 0xce, 0x0b)
#endif
#else
typedef struct ICustomDocVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ICustomDoc *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(ICustomDoc *This);
  ULONG(STDMETHODCALLTYPE *Release)(ICustomDoc *This);
  /*** ICustomDoc methods ***/
  HRESULT(STDMETHODCALLTYPE *SetUIHandler)(ICustomDoc *This,
                                           IDocHostUIHandler *pUIHandler);
  END_INTERFACE
} ICustomDocVtbl;
interface ICustomDoc { CONST_VTBL ICustomDocVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT ICustomDoc_QueryInterface(ICustomDoc *This, REFIID riid,
                                                void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ICustomDoc methods ***/
static inline HRESULT ICustomDoc_SetUIHandler(ICustomDoc *This,
                                              IDocHostUIHandler *pUIHandler) {
...
DEFINE_GUID(IID_IDocHostShowUI, 0xc4d244b0, 0xd43e, 0x11cf, 0x89, 0x3b, 0x00,
            0xaa, 0x00, 0xbd, 0xce, 0x1a);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IDocHostShowUI : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE ShowMessage(
      ...
      LPOLESTR lpstrHelpFile, DWORD dwHelpContext, LRESULT * plResult) = 0;
  virtual HRESULT STDMETHODCALLTYPE ShowHelp(
      HWND hwnd, LPOLESTR pszHelpFile, UINT uCommand, DWORD dwData,
      POINT ptMouse, IDispatch * pDispatchObjectHit) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDocHostShowUI, 0xc4d244b0, 0xd43e, 0x11cf, 0x89, 0x3b, 0x00,
                0xaa, 0x00, 0xbd, 0xce, 0x1a)
#endif
#else
typedef struct IDocHostShowUIVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IDocHostShowUI *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *ShowMessage)(IDocHostShowUI *This, HWND hwnd,
                                          LPOLESTR lpstrText,
                                          LPOLESTR lpstrCaption, DWORD dwType,
                                          LPOLESTR lpstrHelpFile,
                                          DWORD dwHelpContext,
                                          LRESULT *plResult);
  HRESULT(STDMETHODCALLTYPE *ShowHelp)(IDocHostShowUI *This, HWND hwnd,
                                       LPOLESTR pszHelpFile, UINT uCommand,
                                       DWORD dwData, POINT ptMouse,
                                       IDispatch *pDispatchObjectHit);
  END_INTERFACE
} IDocHostShowUIVtbl;
interface IDocHostShowUI { CONST_VTBL IDocHostShowUIVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IDocHostShowUI methods ***/
#define IDocHostShowUI_ShowMessage(This, hwnd, lpstrText, lpstrCaption,        \
                                   dwType, lpstrHelpFile, dwHelpContext,       \
                                   plResult)                                   \
  (This)->lpVtbl->ShowMessage(This, hwnd, lpstrText, lpstrCaption, dwType,     \
                              lpstrHelpFile, dwHelpContext, plResult)
#define IDocHostShowUI_ShowHelp(This, hwnd, pszHelpFile, uCommand, dwData,     \
                                ptMouse, pDispatchObjectHit)                   \
  (This)->lpVtbl->ShowHelp(This, hwnd, pszHelpFile, uCommand, dwData, ptMouse, \
                           pDispatchObjectHit)
#else
/*** IUnknown methods ***/
static inline HRESULT IDocHostShowUI_QueryInterface(IDocHostShowUI *This,
                                                    REFIID riid,
                                                    void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IDocHostShowUI methods ***/
static inline HRESULT
IDocHostShowUI_ShowMessage(IDocHostShowUI *This, HWND hwnd, LPOLESTR lpstrText,
                           LPOLESTR lpstrCaption, DWORD dwType,
                           LPOLESTR lpstrHelpFile, DWORD dwHelpContext,
                           LRESULT *plResult) {
  return This->lpVtbl->ShowMessage(This, hwnd, lpstrText, lpstrCaption, dwType,
                                   lpstrHelpFile, dwHelpContext, plResult);
}
static inline HRESULT IDocHostShowUI_ShowHelp(IDocHostShowUI *This, HWND hwnd,
                                              LPOLESTR pszHelpFile,
                                              UINT uCommand, DWORD dwData,
                                              POINT ptMouse,
                                              IDispatch *pDispatchObjectHit) {
  return This->lpVtbl->ShowHelp(This, hwnd, pszHelpFile, uCommand, dwData,
                                ptMouse, pDispatchObjectHit);
}
#endif
#endif
...
DEFINE_GUID(IID_IClassFactoryEx, 0x342d1ea0, 0xae25, 0x11d1, 0x89, 0xc5, 0x00,
...
IClassFactoryEx : public IClassFactory {
  virtual HRESULT STDMETHODCALLTYPE CreateInstanceWithContext(
      IUnknown * punkContext, IUnknown * punkOuter, REFIID riid,
      void **ppv) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IClassFactoryEx, 0x342d1ea0, 0xae25, 0x11d1, 0x89, 0xc5, 0x00,
                0x60, 0x08, 0xc3, 0xfb, 0xfc)
#endif
#else
typedef struct IClassFactoryExVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IClassFactoryEx *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IClassFactoryEx *This);
  ULONG(STDMETHODCALLTYPE *Release)(IClassFactoryEx *This);
  /*** IClassFactory methods ***/
  HRESULT(STDMETHODCALLTYPE *CreateInstance)(IClassFactoryEx *This,
                                             IUnknown *pUnkOuter, REFIID riid,
                                             void **ppvObject);
  HRESULT(STDMETHODCALLTYPE *LockServer)(IClassFactoryEx *This, WINBOOL fLock);
  /*** IClassFactoryEx methods ***/
  HRESULT(STDMETHODCALLTYPE *CreateInstanceWithContext)(IClassFactoryEx *This,
...
interface IClassFactoryEx { CONST_VTBL IClassFactoryExVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** IClassFactoryEx methods ***/
#define IClassFactoryEx_CreateInstanceWithContext(This, punkContext,           \
                                                  punkOuter, riid, ppv)        \
  (This)->lpVtbl->CreateInstanceWithContext(This, punkContext, punkOuter,      \
                                            riid, ppv)
#else
/*** IUnknown methods ***/
static inline HRESULT IClassFactoryEx_QueryInterface(IClassFactoryEx *This,
                                                     REFIID riid,
                                                     void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IClassFactory methods ***/
static inline HRESULT IClassFactoryEx_CreateInstance(IClassFactoryEx *This,
                                                     IUnknown *pUnkOuter,
                                                     REFIID riid,
                                                     void **ppvObject) {
  return This->lpVtbl->CreateInstance(This, pUnkOuter, riid, ppvObject);
}
static inline HRESULT IClassFactoryEx_LockServer(IClassFactoryEx *This,
                                                 WINBOOL fLock) {
  return This->lpVtbl->LockServer(This, fLock);
}
/*** IClassFactoryEx methods ***/
static inline HRESULT IClassFactoryEx_CreateInstanceWithContext(
    IClassFactoryEx *This, IUnknown *punkContext, IUnknown *punkOuter,
    REFIID riid, void **ppv) {
  return This->lpVtbl->CreateInstanceWithContext(This, punkContext, punkOuter,
                                                 riid, ppv);
}
#endif
#endif
...
DEFINE_GUID(IID_IHTMLOMWindowServices, 0x3050f5fc, 0x98b5, 0x11cf, 0xbb, 0x82,
            0x00, 0xaa, 0x00, 0xbd, 0xce, 0x0b);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IHTMLOMWindowServices, 0x3050f5fc, 0x98b5, 0x11cf, 0xbb, 0x82,
                0x00, 0xaa, 0x00, 0xbd, 0xce, 0x0b)
#endif
#else
typedef struct IHTMLOMWindowServicesVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IHTMLOMWindowServices *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *moveTo)(IHTMLOMWindowServices *This, LONG x,
                                     LONG y);
  HRESULT(STDMETHODCALLTYPE *moveBy)(IHTMLOMWindowServices *This, LONG x,
                                     LONG y);
  HRESULT(STDMETHODCALLTYPE *resizeTo)(IHTMLOMWindowServices *This, LONG x,
                                       LONG y);
  HRESULT(STDMETHODCALLTYPE *resizeBy)(IHTMLOMWindowServices *This, LONG x,
                                       LONG y);
  END_INTERFACE
...
/*** IUnknown methods ***/
static inline HRESULT
IHTMLOMWindowServices_QueryInterface(IHTMLOMWindowServices *This, REFIID riid,
                                     void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IHTMLOMWindowServices methods ***/
static inline HRESULT IHTMLOMWindowServices_moveTo(IHTMLOMWindowServices *This,
                                                   LONG x, LONG y) {
  return This->lpVtbl->moveTo(This, x, y);
}
static inline HRESULT IHTMLOMWindowServices_moveBy(IHTMLOMWindowServices *This,
                                                   LONG x, LONG y) {
  return This->lpVtbl->moveBy(This, x, y);
}
static inline HRESULT
IHTMLOMWindowServices_resizeTo(IHTMLOMWindowServices *This, LONG x, LONG y) {
  return This->lpVtbl->resizeTo(This, x, y);
}
static inline HRESULT
IHTMLOMWindowServices_resizeBy(IHTMLOMWindowServices *This, LONG x, LONG y) {
