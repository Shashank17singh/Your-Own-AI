...
public:
  ...
  virtual HRESULT Init(HANDLE hAddress, CMSPCallBase *pMSPCall,
                       IMediaEvent *pGraph, DWORD dwMediaType,
  ...
  virtual HRESULT ProcessGraphEvent(__LONG32 lEventCode, LONG_PTR lParam1,
                                    LONG_PTR lParam2);
