...
DECLARE_INTERFACE_(IRdcFileWriter, IUnknown) {
  ...
  STDMETHOD_(HRESULT, Write)(THIS_ ULONGLONG offsetFileStart,
                             ULONG bytesToWrite, BYTE * buffer) PURE;
...
DECLARE_INTERFACE_(ISimilarityFileIdTable, IUnknown) {
  ...
  STDMETHOD_(HRESULT, CreateTable)(THIS_ wchar_t * path, WINBOOL truncate,
                                   BYTE * securityDescriptor, DWORD recordSize,
                                   RdcCreatedTables * isNew) PURE;
  STDMETHOD_(HRESULT, CreateTableIndirect)(THIS_ IRdcFileWriter * fileIdFile,
                                           WINBOOL truncate, DWORD recordSize,
                                           RdcCreatedTables * isNew) PURE;
  STDMETHOD_(HRESULT, CloseTable)(THIS_ WINBOOL isValid) PURE;
  STDMETHOD_(HRESULT, Append)(THIS_ SimilarityFileId * similarityFileId,
                              SimilarityFileIndexT * similarityFileIndex) PURE;
  STDMETHOD_(HRESULT, Lookup)(THIS_ SimilarityFileIndexT similarityFileIndex,
                              SimilarityFileId * similarityFileId) PURE;
  STDMETHOD_(HRESULT,
             Invalidate)(THIS_ SimilarityFileIndexT similarityFileIndex) PURE;
...
#define ISimilarityFileIdTable_CreateTable(                                    \
    This, path, truncate, securityDescriptor, recordSize, isNew)               \
  (This)->lpVtbl->CreateTable(This, path, truncate, securityDescriptor,        \
                              recordSize, isNew)
#define ISimilarityFileIdTable_CreateTableIndirect(This, fileIdFile, truncate, \
                                                   recordSize, isNew)          \
  (This)->lpVtbl->CreateTableIndirect(This, fileIdFile, truncate, recordSize,  \
                                      isNew)
#define ISimilarityFileIdTable_CloseTable(This, isValid)                       \
  (This)->lpVtbl->CloseTable(This, isValid)
#define ISimilarityFileIdTable_Append(This, similarityFileId,                  \
                                      similarityFileIndex)                     \
  (This)->lpVtbl->Append(This, similarityFileId, similarityFileIndex)
#define ISimilarityFileIdTable_Lookup(This, similarityFileIndex,               \
                                      similarityFileId)                        \
...
DECLARE_INTERFACE_(ISimilarityTraitsMappedView, IUnknown) {
  ...
  STDMETHOD_(HRESULT, Get)(THIS_ unsigned __int64 fileOffset, WINBOOL dirty,
                           DWORD numElements,
                           SimilarityMappedViewInfo *viewInfo) PURE;
  STDMETHOD(GetView)(THIS_ unsigned char const **mappedPageBegin,
                     unsigned char const **mappedPageEnd) PURE;
  END_INTERFACE
};
#ifdef COBJMACROS
...
#define ISimilarityTraitsMappedView_Get(This, fileOffset, dirty, numElements,  \
                                        viewInfo)                              \
  (This)->lpVtbl->Get(This, fileOffset, dirty, numElements, viewInfo)
#define ISimilarityTraitsMappedView_GetView(This, mappedPageBegin,             \
                                            mappedPageEnd)                     \
...
DECLARE_INTERFACE_(IFindSimilarResults, IUnknown) {
  ...
  STDMETHOD_(HRESULT, GetNextFileId)(THIS_ DWORD * numTraitsMatched,
                                     SimilarityFileId * similarityFileId) PURE;
  END_INTERFACE
};
#ifdef COBJMACROS
...
#define IFindSimilarResults_GetNextFileId(This, numTraitsMatched,              \
                                          similarityFileId)                    \
...
DECLARE_INTERFACE_(ISimilarityTraitsMapping, IUnknown) {
  ...
  STDMETHOD_(HRESULT, OpenMapping)(THIS_ RdcMappingAccessMode accessMode,
                                   unsigned __int64 begin, unsigned __int64 end,
                                   unsigned __int64 *actualEnd) PURE;
  STDMETHOD_(HRESULT, ResizeMapping)(
      THIS_ RdcMappingAccessMode accessMode, unsigned __int64 begin,
      unsigned __int64 end, unsigned __int64 *actualEnd) PURE;
  STDMETHOD(GetPageSize)(THIS_ DWORD * pageSize) PURE;
  STDMETHOD_(HRESULT, CreateView)(
      THIS_ DWORD minimumMappedPages, RdcMappingAccessMode accessMode,
      ISimilarityTraitsMappedView * *mappedView) PURE;
  END_INTERFACE
};
#ifdef COBJMACROS
...
#define ISimilarityTraitsMapping_CloseMapping()                                \
...
#define ISimilarityTraitsMapping_OpenMapping(This, accessMode, begin, end,     \
                                             actualEnd)                        \
  (This)->lpVtbl->OpenMapping(This, accessMode, begin, end, actualEnd)
#define ISimilarityTraitsMapping_ResizeMapping(This, accessMode, begin, end,   \
                                               actualEnd)                      \
...
#define ISimilarityTraitsMapping_CreateView(This, minimumMappedPages,          \
                                            accessMode, mappedView)            \
...
DECLARE_INTERFACE_(ISimilarity, IUnknown) {
  ...
  STDMETHOD_(HRESULT, CreateTable)(THIS_ wchar_t * path, WINBOOL truncate,
                                   BYTE * securityDescriptor, DWORD recordSize,
                                   RdcCreatedTables * isNew) PURE;
  STDMETHOD_(HRESULT, CreateTableIndirect)(
      THIS_ ISimilarityTraitsMapping * mapping, IRdcFileWriter * fileIdFile,
      WINBOOL truncate, DWORD recordSize, RdcCreatedTables * isNew) PURE;
  STDMETHOD_(HRESULT, CloseTable)(THIS_ WINBOOL isValid) PURE;
  STDMETHOD_(HRESULT, Append)(THIS_ SimilarityFileId * similarityFileId,
                              SimilarityData * similarityData) PURE;
  STDMETHOD_(HRESULT, FindSimilarFileId)(
      THIS_ SimilarityData * similarityData, DWORD resultsSize,
      IFindSimilarResults * *findSimilarResults) PURE;
...
#define ISimilarity_CreateTable(This, path, truncate, securityDescriptor,      \
                                recordSize, isNew)                             \
  (This)->lpVtbl->CreateTable(This, path, truncate, securityDescriptor,        \
                              recordSize, isNew)
#define ISimilarity_CreateTableIndirect(This, mapping, fileIdFile, truncate,   \
                                        recordSize, isNew)                     \
  (This)->lpVtbl->CreateTableIndirect(This, mapping, fileIdFile, truncate,     \
                                      recordSize, isNew)
...
#define ISimilarity_FindSimilarFileId(This, similarityData, resultsSize,       \
                                      findSimilarResults)                      \
  (This)->lpVtbl->FindSimilarFileId(This, similarityData, resultsSize,         \
                                    findSimilarResults)
#define ISimilarity_CopyAndSwap(This, reportProgress)                          \
  (This)->lpVtbl->CopyAndSwap(This, reportProgress)
