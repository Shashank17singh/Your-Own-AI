...
DEFINE_GUID(IID_IDirectDraw3, 0x618f8ad4, 0x8b7a, 0x11d0, 0x8f, 0xcc, 0x0, 0xc0,
            0x4f, 0xd9, 0x18, 0x9d);
...
typedef struct _DDCAPS_DX7      /* DirectX 7 version of caps struct */
{
  ...
  DWORD dwNLVBCaps;  /* driver specific capabilities for non-local->local vidmem
                        blts */
  DWORD dwNLVBCaps2; /* more driver specific capabilities non-local->local
                        vidmem blts */
  DWORD dwNLVBCKeyCaps; /* driver color key capabilities for non-local->local
                           vidmem blts */
...
/* the first 4 of these are now obsolete */
    ...
    0x700 /* FIXME: I'm not sure when this switch occurred */
...
typedef struct _DDSURFACEDESC {
  ...
  __GNU_EXTENSION union {
    ...
    DWORD dwRefreshRate;     /* 18:refresh rate (used when display mode is
                                described)*/
  } DUMMYUNIONNAME2;
  ...
  DDPIXELFORMAT
      ddpfPixelFormat; /* 48: pixel format description of the surface*/
...
#endif
typedef WINBOOL(CALLBACK *LPDDENUMCALLBACKEXA)(GUID *, LPSTR, LPSTR, LPVOID,
                                               HMONITOR);
typedef WINBOOL(CALLBACK *LPDDENUMCALLBACKEXW)(GUID *, LPWSTR, LPWSTR, LPVOID,
                                               HMONITOR);
...
typedef struct _DDBLTFX {
  ...
  DWORD
      dwZSrcConstBitDepth; /* Bit depth used to specify Z constant for source */
  __GNU_EXTENSION union {
...
DECLARE_INTERFACE_(IDirectDrawPalette, IUnknown) {
  ...
  STDMETHOD(GetEntries)(THIS_ DWORD dwFlags, DWORD dwBase, DWORD dwNumEntries,
...
DECLARE_INTERFACE_(IDirectDraw, IUnknown) {
  ...
  STDMETHOD(CreatePalette)(THIS_ DWORD dwFlags, LPPALETTEENTRY lpColorTable,
  ...
  STDMETHOD(SetDisplayMode)(THIS_ DWORD dwWidth, DWORD dwHeight, DWORD dwBPP)
      PURE;
...
DECLARE_INTERFACE_(IDirectDraw2, IUnknown) {
  /*** IUnknown methods ***/
  /*00*/ STDMETHOD_(HRESULT, QueryInterface)(THIS_ REFIID riid,
                                             void **ppvObject) PURE;
  /*04*/ STDMETHOD_(ULONG, AddRef)(THIS) PURE;
  /*08*/ STDMETHOD_(ULONG, Release)(THIS) PURE;
  /*** IDirectDraw2 methods ***/
  /*0c*/ STDMETHOD(Compact)(THIS) PURE;
  /*10*/ STDMETHOD(CreateClipper)(THIS_ DWORD dwFlags,
                                  LPDIRECTDRAWCLIPPER * lplpDDClipper,
                                  IUnknown * pUnkOuter) PURE;
  /*14*/ STDMETHOD(CreatePalette)(
      THIS_ DWORD dwFlags, LPPALETTEENTRY lpColorTable,
      LPDIRECTDRAWPALETTE * lplpDDPalette, IUnknown * pUnkOuter) PURE;
  /*18*/ STDMETHOD(CreateSurface)(THIS_ LPDDSURFACEDESC lpDDSurfaceDesc,
                                  LPDIRECTDRAWSURFACE * lplpDDSurface,
                                  IUnknown * pUnkOuter) PURE;
  /*1c*/ STDMETHOD(DuplicateSurface)(THIS_ LPDIRECTDRAWSURFACE lpDDSurface,
                                     LPDIRECTDRAWSURFACE * lplpDupDDSurface)
      PURE;
  /*20*/ STDMETHOD(EnumDisplayModes)(
      THIS_ DWORD dwFlags, LPDDSURFACEDESC lpDDSurfaceDesc, LPVOID lpContext,
      LPDDENUMMODESCALLBACK lpEnumModesCallback) PURE;
  /*24*/ STDMETHOD(EnumSurfaces)(
      THIS_ DWORD dwFlags, LPDDSURFACEDESC lpDDSD, LPVOID lpContext,
      LPDDENUMSURFACESCALLBACK lpEnumSurfacesCallback) PURE;
  /*28*/ STDMETHOD(FlipToGDISurface)(THIS) PURE;
  /*2c*/ STDMETHOD(GetCaps)(THIS_ LPDDCAPS lpDDDriverCaps, LPDDCAPS lpDDHELCaps)
      PURE;
  /*30*/ STDMETHOD(GetDisplayMode)(THIS_ LPDDSURFACEDESC lpDDSurfaceDesc) PURE;
  /*34*/ STDMETHOD(GetFourCCCodes)(THIS_ LPDWORD lpNumCodes, LPDWORD lpCodes)
      PURE;
  /*38*/ STDMETHOD(GetGDISurface)(THIS_ LPDIRECTDRAWSURFACE * lplpGDIDDSurface)
      PURE;
  ...
  /*54*/ STDMETHOD(SetDisplayMode)(THIS_ DWORD dwWidth, DWORD dwHeight,
                                   DWORD dwBPP, DWORD dwRefreshRate,
                                   DWORD dwFlags) PURE;
  /*58*/ STDMETHOD(WaitForVerticalBlank)(THIS_ DWORD dwFlags, HANDLE hEvent)
      PURE;
  /* added in v2 */
  /*5c*/ STDMETHOD(GetAvailableVidMem)(
      THIS_ LPDDSCAPS lpDDCaps, LPDWORD lpdwTotal, LPDWORD lpdwFree) PURE;
};
#undef INTERFACE
#if !defined(__cplusplus) || defined(CINTERFACE)
/*** IUnknown methods ***/
...
DECLARE_INTERFACE_(IDirectDraw3, IUnknown) {
  ...
  /*5c*/ STDMETHOD(GetAvailableVidMem)(
      THIS_ LPDDSCAPS lpDDCaps, LPDWORD lpdwTotal, LPDWORD lpdwFree) PURE;
  /* added in v3 */
  /*60*/ STDMETHOD(GetSurfaceFromDC)(THIS_ HDC hdc, LPDIRECTDRAWSURFACE * pSurf)
      PURE;
};
#undef INTERFACE
#if !defined(__cplusplus) || defined(CINTERFACE)
/*** IUnknown methods ***/
#define IDirectDraw3_QueryInterface(p, a, b)                                   \
  (p)->lpVtbl->QueryInterface(p, a, b)
...
#define IDirectDraw3_CreateClipper(p, a, b, c)                                 \
  (p)->lpVtbl->CreateClipper(p, a, b, c)
#define IDirectDraw3_CreatePalette(p, a, b, c, d)                              \
  (p)->lpVtbl->CreatePalette(p, a, b, c, d)
#define IDirectDraw3_CreateSurface(p, a, b, c)                                 \
  (p)->lpVtbl->CreateSurface(p, a, b, c)
#define IDirectDraw3_DuplicateSurface(p, a, b)                                 \
  (p)->lpVtbl->DuplicateSurface(p, a, b)
#define IDirectDraw3_EnumDisplayModes(p, a, b, c, d)                           \
  (p)->lpVtbl->EnumDisplayModes(p, a, b, c, d)
...
#define IDirectDraw3_GetFourCCCodes(p, a, b)                                   \
  (p)->lpVtbl->GetFourCCCodes(p, a, b)
#define IDirectDraw3_GetGDISurface(p, a) (p)->lpVtbl->GetGDISurface(p, a)
#define IDirectDraw3_GetMonitorFrequency(p, a)                                 \
  (p)->lpVtbl->GetMonitorFrequency(p, a)
#define IDirectDraw3_GetScanLine(p, a) (p)->lpVtbl->GetScanLine(p, a)
#define IDirectDraw3_GetVerticalBlankStatus(p, a)                              \
  (p)->lpVtbl->GetVerticalBlankStatus(p, a)
...
#define IDirectDraw3_SetCooperativeLevel(p, a, b)                              \
  (p)->lpVtbl->SetCooperativeLevel(p, a, b)
#define IDirectDraw3_SetDisplayMode(p, a, b, c, d, e)                          \
  (p)->lpVtbl->SetDisplayMode(p, a, b, c, d, e)
#define IDirectDraw3_WaitForVerticalBlank(p, a, b)                             \
  (p)->lpVtbl->WaitForVerticalBlank(p, a, b)
/*** IDirectDraw2 methods ***/
#define IDirectDraw3_GetAvailableVidMem(p, a, b, c)                            \
  (p)->lpVtbl->GetAvailableVidMem(p, a, b, c)
/*** IDirectDraw3 methods ***/
#define IDirectDraw3_GetSurfaceFromDC(p, a, b)                                 \
...
DECLARE_INTERFACE_(IDirectDraw4, IUnknown) {
  ...
  /*14*/ STDMETHOD(CreatePalette)(
      THIS_ DWORD dwFlags, LPPALETTEENTRY lpColorTable,
      LPDIRECTDRAWPALETTE * lplpDDPalette, IUnknown * pUnkOuter) PURE;
  /*18*/ STDMETHOD(CreateSurface)(THIS_ LPDDSURFACEDESC2 lpDDSurfaceDesc,
                                  LPDIRECTDRAWSURFACE4 * lplpDDSurface,
                                  IUnknown * pUnkOuter) PURE;
  /*1c*/ STDMETHOD(DuplicateSurface)(THIS_ LPDIRECTDRAWSURFACE4 lpDDSurface,
                                     LPDIRECTDRAWSURFACE4 * lplpDupDDSurface)
      PURE;
  /*20*/ STDMETHOD(EnumDisplayModes)(
      THIS_ DWORD dwFlags, LPDDSURFACEDESC2 lpDDSurfaceDesc, LPVOID lpContext,
      LPDDENUMMODESCALLBACK2 lpEnumModesCallback) PURE;
  /*24*/ STDMETHOD(EnumSurfaces)(
      THIS_ DWORD dwFlags, LPDDSURFACEDESC2 lpDDSD, LPVOID lpContext,
      LPDDENUMSURFACESCALLBACK2 lpEnumSurfacesCallback) PURE;
  /*28*/ STDMETHOD(FlipToGDISurface)(THIS) PURE;
  /*2c*/ STDMETHOD(GetCaps)(THIS_ LPDDCAPS lpDDDriverCaps, LPDDCAPS lpDDHELCaps)
      PURE;
  ...
  /*34*/ STDMETHOD(GetFourCCCodes)(THIS_ LPDWORD lpNumCodes, LPDWORD lpCodes)
      PURE;
  /*38*/ STDMETHOD(GetGDISurface)(THIS_ LPDIRECTDRAWSURFACE4 * lplpGDIDDSurface)
      PURE;
  /*3c*/ STDMETHOD(GetMonitorFrequency)(THIS_ LPDWORD lpdwFrequency) PURE;
  /*40*/ STDMETHOD(GetScanLine)(THIS_ LPDWORD lpdwScanLine) PURE;
  /*44*/ STDMETHOD(GetVerticalBlankStatus)(THIS_ WINBOOL * lpbIsInVB) PURE;
  ...
  /* added in v2 */
  /*5c*/ STDMETHOD(GetAvailableVidMem)(
      THIS_ LPDDSCAPS2 lpDDCaps, LPDWORD lpdwTotal, LPDWORD lpdwFree) PURE;
  /* added in v4 */
  /*60*/ STDMETHOD(GetSurfaceFromDC)(THIS_ HDC hdc,
                                     LPDIRECTDRAWSURFACE4 * pSurf) PURE;
  /*64*/ STDMETHOD(RestoreAllSurfaces)(THIS) PURE;
  /*68*/ STDMETHOD(TestCooperativeLevel)(THIS) PURE;
  /*6c*/ STDMETHOD(GetDeviceIdentifier)(THIS_ LPDDDEVICEIDENTIFIER pDDDI,
                                        DWORD dwFlags) PURE;
};
#undef INTERFACE
#if !defined(__cplusplus) || defined(CINTERFACE)
...
DECLARE_INTERFACE_(IDirectDraw7, IUnknown) {
  ...
  /*18*/ STDMETHOD(CreateSurface)(THIS_ LPDDSURFACEDESC2 lpDDSurfaceDesc,
                                  ...
                                  IUnknown * pUnkOuter) PURE;
  /*1c*/ STDMETHOD(DuplicateSurface)(THIS_ LPDIRECTDRAWSURFACE7 lpDDSurface,
  ...
  /*24*/ STDMETHOD(EnumSurfaces)(
      THIS_ DWORD dwFlags, LPDDSURFACEDESC2 lpDDSD, LPVOID lpContext,
      LPDDENUMSURFACESCALLBACK7 lpEnumSurfacesCallback) PURE;
  /*28*/ STDMETHOD(FlipToGDISurface)(THIS) PURE;
  /*2c*/ STDMETHOD(GetCaps)(THIS_ LPDDCAPS lpDDDriverCaps, LPDDCAPS lpDDHELCaps)
      PURE;
  /*30*/ STDMETHOD(GetDisplayMode)(THIS_ LPDDSURFACEDESC2 lpDDSurfaceDesc) PURE;
  /*34*/ STDMETHOD(GetFourCCCodes)(THIS_ LPDWORD lpNumCodes, LPDWORD lpCodes)
      PURE;
  /*38*/ STDMETHOD(GetGDISurface)(THIS_ LPDIRECTDRAWSURFACE7 * lplpGDIDDSurface)
      PURE;
  /*3c*/ STDMETHOD(GetMonitorFrequency)(THIS_ LPDWORD lpdwFrequency) PURE;
  /*40*/ STDMETHOD(GetScanLine)(THIS_ LPDWORD lpdwScanLine) PURE;
  /*44*/ STDMETHOD(GetVerticalBlankStatus)(THIS_ WINBOOL * lpbIsInVB) PURE;
  ...
  /* added in v4 */
  /*60*/ STDMETHOD(GetSurfaceFromDC)(THIS_ HDC hdc,
                                     LPDIRECTDRAWSURFACE7 * pSurf) PURE;
  /*64*/ STDMETHOD(RestoreAllSurfaces)(THIS) PURE;
  /*68*/ STDMETHOD(TestCooperativeLevel)(THIS) PURE;
  /*6c*/ STDMETHOD(GetDeviceIdentifier)(THIS_ LPDDDEVICEIDENTIFIER2 pDDDI,
                                        DWORD dwFlags) PURE;
  /* added in v7 */
  /*70*/ STDMETHOD(StartModeTest)(THIS_ LPSIZE pModes, DWORD dwNumModes,
                                  DWORD dwFlags) PURE;
...
DECLARE_INTERFACE_(IDirectDrawSurface, IUnknown) {
  ...
  /*0c*/ STDMETHOD(AddAttachedSurface)(
      THIS_ LPDIRECTDRAWSURFACE lpDDSAttachedSurface) PURE;
  /*10*/ STDMETHOD(AddOverlayDirtyRect)(THIS_ LPRECT lpRect) PURE;
  /*14*/ STDMETHOD(Blt)(THIS_ LPRECT lpDestRect,
                        LPDIRECTDRAWSURFACE lpDDSrcSurface, LPRECT lpSrcRect,
                        DWORD dwFlags, LPDDBLTFX lpDDBltFx) PURE;
  /*18*/ STDMETHOD(BltBatch)(THIS_ LPDDBLTBATCH lpDDBltBatch, DWORD dwCount,
                             DWORD dwFlags) PURE;
  /*1c*/ STDMETHOD(BltFast)(THIS_ DWORD dwX, DWORD dwY,
                            LPDIRECTDRAWSURFACE lpDDSrcSurface,
                            LPRECT lpSrcRect, DWORD dwTrans) PURE;
  /*20*/ STDMETHOD(DeleteAttachedSurface)(
      THIS_ DWORD dwFlags, LPDIRECTDRAWSURFACE lpDDSAttachedSurface) PURE;
  /*24*/ STDMETHOD(EnumAttachedSurfaces)(
      THIS_ LPVOID lpContext, LPDDENUMSURFACESCALLBACK lpEnumSurfacesCallback)
      PURE;
  /*28*/ STDMETHOD(EnumOverlayZOrders)(THIS_ DWORD dwFlags, LPVOID lpContext,
                                       LPDDENUMSURFACESCALLBACK lpfnCallback)
      PURE;
  /*2c*/ STDMETHOD(Flip)(THIS_ LPDIRECTDRAWSURFACE lpDDSurfaceTargetOverride,
                         DWORD dwFlags) PURE;
  /*30*/ STDMETHOD(GetAttachedSurface)(
      THIS_ LPDDSCAPS lpDDSCaps, LPDIRECTDRAWSURFACE * lplpDDAttachedSurface)
      PURE;
  ...
  /*40*/ STDMETHOD(GetColorKey)(THIS_ DWORD dwFlags, LPDDCOLORKEY lpDDColorKey)
      PURE;
  ...
  /*5c*/ STDMETHOD(Initialize)(THIS_ LPDIRECTDRAW lpDD,
                               LPDDSURFACEDESC lpDDSurfaceDesc) PURE;
  /*60*/ STDMETHOD(IsLost)(THIS) PURE;
  /*64*/ STDMETHOD(Lock)(THIS_ LPRECT lpDestRect,
  ...
  /*74*/ STDMETHOD(SetColorKey)(THIS_ DWORD dwFlags, LPDDCOLORKEY lpDDColorKey)
      PURE;
  ...
  /*84*/ STDMETHOD(UpdateOverlay)(
      THIS_ LPRECT lpSrcRect, LPDIRECTDRAWSURFACE lpDDDestSurface,
      LPRECT lpDestRect, DWORD dwFlags, LPDDOVERLAYFX lpDDOverlayFx) PURE;
  /*88*/ STDMETHOD(UpdateOverlayDisplay)(THIS_ DWORD dwFlags) PURE;
  /*8c*/ STDMETHOD(UpdateOverlayZOrder)(
      THIS_ DWORD dwFlags, LPDIRECTDRAWSURFACE lpDDSReference) PURE;
};
#undef INTERFACE
#if !defined(__cplusplus) || defined(CINTERFACE)
/*** IUnknown methods ***/
 ...
 */
/* Cannot inherit from IDirectDrawSurface because the LPDIRECTDRAWSURFACE
 * parameters have been converted to LPDIRECTDRAWSURFACE2.
 */
...
DECLARE_INTERFACE_(IDirectDrawSurface2, IUnknown) {
  ...
  STDMETHOD(AddAttachedSurface)(THIS_ LPDIRECTDRAWSURFACE2 lpDDSAttachedSurface)
      PURE;
  STDMETHOD(AddOverlayDirtyRect)(THIS_ LPRECT lpRect) PURE;
  STDMETHOD(Blt)(THIS_ LPRECT lpDestRect, LPDIRECTDRAWSURFACE2 lpDDSrcSurface,
                 LPRECT lpSrcRect, DWORD dwFlags, LPDDBLTFX lpDDBltFx) PURE;
  ...
  STDMETHOD(EnumOverlayZOrders)(THIS_ DWORD dwFlags, LPVOID lpContext,
                                LPDDENUMSURFACESCALLBACK lpfnCallback) PURE;
  ...
  STDMETHOD(Lock)(THIS_ LPRECT lpDestRect, LPDDSURFACEDESC lpDDSurfaceDesc,
                  DWORD dwFlags, HANDLE hEvent) PURE;
 ...
 */
/* Cannot inherit from IDirectDrawSurface2 because the LPDIRECTDRAWSURFACE2
 * parameters have been converted to LPDIRECTDRAWSURFACE3.
 */
...
DECLARE_INTERFACE_(IDirectDrawSurface3, IUnknown) {
  ...
  STDMETHOD(AddAttachedSurface)(THIS_ LPDIRECTDRAWSURFACE3 lpDDSAttachedSurface)
      PURE;
  STDMETHOD(AddOverlayDirtyRect)(THIS_ LPRECT lpRect) PURE;
  STDMETHOD(Blt)(THIS_ LPRECT lpDestRect, LPDIRECTDRAWSURFACE3 lpDDSrcSurface,
                 LPRECT lpSrcRect, DWORD dwFlags, LPDDBLTFX lpDDBltFx) PURE;
  STDMETHOD(BltBatch)(THIS_ LPDDBLTBATCH lpDDBltBatch, DWORD dwCount,
                      DWORD dwFlags) PURE;
  STDMETHOD(BltFast)(THIS_ DWORD dwX, DWORD dwY,
  ...
  STDMETHOD(Unlock)(THIS_ LPVOID lpSurfaceData) PURE;
  STDMETHOD(UpdateOverlay)(
      THIS_ LPRECT lpSrcRect, LPDIRECTDRAWSURFACE3 lpDDDestSurface,
      LPRECT lpDestRect, DWORD dwFlags, LPDDOVERLAYFX lpDDOverlayFx) PURE;
  STDMETHOD(UpdateOverlayDisplay)(THIS_ DWORD dwFlags) PURE;
  STDMETHOD(UpdateOverlayZOrder)(THIS_ DWORD dwFlags,
                                 LPDIRECTDRAWSURFACE3 lpDDSReference) PURE;
  /* added in v2 */
  STDMETHOD(GetDDInterface)(THIS_ LPVOID * lplpDD) PURE;
  STDMETHOD(PageLock)(THIS_ DWORD dwFlags) PURE;
  STDMETHOD(PageUnlock)(THIS_ DWORD dwFlags) PURE;
...
DECLARE_INTERFACE_(IDirectDrawSurface4, IUnknown) {
  ...
  STDMETHOD(AddAttachedSurface)(THIS_ LPDIRECTDRAWSURFACE4 lpDDSAttachedSurface)
      PURE;
  STDMETHOD(AddOverlayDirtyRect)(THIS_ LPRECT lpRect) PURE;
  STDMETHOD(Blt)(THIS_ LPRECT lpDestRect, LPDIRECTDRAWSURFACE4 lpDDSrcSurface,
                 LPRECT lpSrcRect, DWORD dwFlags, LPDDBLTFX lpDDBltFx) PURE;
  STDMETHOD(BltBatch)(THIS_ LPDDBLTBATCH lpDDBltBatch, DWORD dwCount,
                      DWORD dwFlags) PURE;
  STDMETHOD(BltFast)(THIS_ DWORD dwX, DWORD dwY,
  ...
  STDMETHOD(EnumAttachedSurfaces)(
      THIS_ LPVOID lpContext, LPDDENUMSURFACESCALLBACK2 lpEnumSurfacesCallback)
      PURE;
  STDMETHOD(EnumOverlayZOrders)(THIS_ DWORD dwFlags, LPVOID lpContext,
                                LPDDENUMSURFACESCALLBACK2 lpfnCallback) PURE;
  ...
  STDMETHOD(IsLost)(THIS) PURE;
  STDMETHOD(Lock)(THIS_ LPRECT lpDestRect, LPDDSURFACEDESC2 lpDDSurfaceDesc,
                  DWORD dwFlags, HANDLE hEvent) PURE;
  STDMETHOD(ReleaseDC)(THIS_ HDC hDC) PURE;
  STDMETHOD(Restore)(THIS) PURE;
  STDMETHOD(SetClipper)(THIS_ LPDIRECTDRAWCLIPPER lpDDClipper) PURE;
  ...
  STDMETHOD(UpdateOverlay)(
      THIS_ LPRECT lpSrcRect, LPDIRECTDRAWSURFACE4 lpDDDestSurface,
      LPRECT lpDestRect, DWORD dwFlags, LPDDOVERLAYFX lpDDOverlayFx) PURE;
  STDMETHOD(UpdateOverlayDisplay)(THIS_ DWORD dwFlags) PURE;
  STDMETHOD(UpdateOverlayZOrder)(THIS_ DWORD dwFlags,
                                 LPDIRECTDRAWSURFACE4 lpDDSReference) PURE;
  /* added in v2 */
  STDMETHOD(GetDDInterface)(THIS_ LPVOID * lplpDD) PURE;
  STDMETHOD(PageLock)(THIS_ DWORD dwFlags) PURE;
  STDMETHOD(PageUnlock)(THIS_ DWORD dwFlags) PURE;
  ...
  /* added in v4 */
  STDMETHOD(SetPrivateData)(THIS_ REFGUID tag, LPVOID pData, DWORD cbSize,
                            DWORD dwFlags) PURE;
  STDMETHOD(GetPrivateData)(THIS_ REFGUID tag, LPVOID pBuffer,
                            LPDWORD pcbBufferSize) PURE;
...
DECLARE_INTERFACE_(IDirectDrawSurface7, IUnknown) {
  ...
  STDMETHOD(AddAttachedSurface)(THIS_ LPDIRECTDRAWSURFACE7 lpDDSAttachedSurface)
      PURE;
  STDMETHOD(AddOverlayDirtyRect)(THIS_ LPRECT lpRect) PURE;
  STDMETHOD(Blt)(THIS_ LPRECT lpDestRect, LPDIRECTDRAWSURFACE7 lpDDSrcSurface,
                 LPRECT lpSrcRect, DWORD dwFlags, LPDDBLTFX lpDDBltFx) PURE;
  STDMETHOD(BltBatch)(THIS_ LPDDBLTBATCH lpDDBltBatch, DWORD dwCount,
                      DWORD dwFlags) PURE;
  STDMETHOD(BltFast)(THIS_ DWORD dwX, DWORD dwY,
  ...
  STDMETHOD(EnumAttachedSurfaces)(
      THIS_ LPVOID lpContext, LPDDENUMSURFACESCALLBACK7 lpEnumSurfacesCallback)
      PURE;
  STDMETHOD(EnumOverlayZOrders)(THIS_ DWORD dwFlags, LPVOID lpContext,
                                LPDDENUMSURFACESCALLBACK7 lpfnCallback) PURE;
  ...
  STDMETHOD(Unlock)(THIS_ LPRECT lpSurfaceData) PURE;
  STDMETHOD(UpdateOverlay)(
      THIS_ LPRECT lpSrcRect, LPDIRECTDRAWSURFACE7 lpDDDestSurface,
      LPRECT lpDestRect, DWORD dwFlags, LPDDOVERLAYFX lpDDOverlayFx) PURE;
  STDMETHOD(UpdateOverlayDisplay)(THIS_ DWORD dwFlags) PURE;
  STDMETHOD(UpdateOverlayZOrder)(THIS_ DWORD dwFlags,
                                 LPDIRECTDRAWSURFACE7 lpDDSReference) PURE;
  /* added in v2 */
  STDMETHOD(GetDDInterface)(THIS_ LPVOID * lplpDD) PURE;
  STDMETHOD(PageLock)(THIS_ DWORD dwFlags) PURE;
  STDMETHOD(PageUnlock)(THIS_ DWORD dwFlags) PURE;
