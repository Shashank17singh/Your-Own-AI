...
DEFINE_GUID(IID_IFilter, 0x89bcb740, 0x6119, 0x101a, 0xbc, 0xb7, 0x00, 0xdd,
            0x01, 0x06, 0x55, 0xaf);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("89bcb740-6119-101a-bcb7-00dd010655af")
IFilter : public IUnknown {
  virtual SCODE STDMETHODCALLTYPE Init(ULONG grfFlags, ULONG cAttributes,
  ...
  virtual SCODE STDMETHODCALLTYPE BindRegion(FILTERREGION origPos, REFIID riid,
                                             void **ppunk) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IFilter, 0x89bcb740, 0x6119, 0x101a, 0xbc, 0xb7, 0x00, 0xdd,
                0x01, 0x06, 0x55, 0xaf)
#endif
#else
typedef struct IFilterVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IFilter *This, REFIID riid,
                                             void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IFilter *This);
  ULONG(STDMETHODCALLTYPE *Release)(IFilter *This);
  /*** IFilter methods ***/
  SCODE(STDMETHODCALLTYPE *Init)(IFilter *This, ULONG grfFlags,
                                 ULONG cAttributes,
                                 const FULLPROPSPEC *aAttributes,
                                 ULONG *pFlags);
  SCODE(STDMETHODCALLTYPE *GetChunk)(IFilter *This, STAT_CHUNK *pStat);
  SCODE(STDMETHODCALLTYPE *GetText)(IFilter *This, ULONG *pcwcBuffer,
                                    WCHAR *awcBuffer);
  SCODE(STDMETHODCALLTYPE *GetValue)(IFilter *This, PROPVARIANT **ppPropValue);
  SCODE(STDMETHODCALLTYPE *BindRegion)(IFilter *This, FILTERREGION origPos,
                                       REFIID riid, void **ppunk);
  END_INTERFACE
} IFilterVtbl;
interface IFilter { CONST_VTBL IFilterVtbl *lpVtbl; };
#ifdef COBJMACROS
...
#else
/*** IUnknown methods ***/
static inline HRESULT IFilter_QueryInterface(IFilter *This, REFIID riid,
                                             void **ppvObject) {
...
/*** IFilter methods ***/
static inline SCODE IFilter_Init(IFilter *This, ULONG grfFlags,
                                 ULONG cAttributes,
                                 const FULLPROPSPEC *aAttributes,
                                 ULONG *pFlags) {
...
static inline SCODE IFilter_GetText(IFilter *This, ULONG *pcwcBuffer,
                                    WCHAR *awcBuffer) {
...
static inline SCODE IFilter_BindRegion(IFilter *This, FILTERREGION origPos,
                                       REFIID riid, void **ppunk) {
