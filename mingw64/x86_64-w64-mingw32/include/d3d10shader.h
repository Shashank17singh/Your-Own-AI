...
ID3D10ShaderReflectionType {
  BEGIN_INTERFACE
  virtual HRESULT STDMETHODCALLTYPE GetDesc(D3D10_SHADER_TYPE_DESC * desc) = 0;
...
__CRT_UUID_DECL(ID3D10ShaderReflectionType, 0xc530ad7d, 0x9b16, 0x4395, 0xa9,
                0x79, 0xba, 0x2e, 0xcf, 0xf8, 0x3a, 0xdd)
#endif
#else
...
/*** ID3D10ShaderReflectionType methods ***/
#define ID3D10ShaderReflectionType_GetDesc(This, desc)                         \
  (This)->lpVtbl->GetDesc(This, desc)
#define ID3D10ShaderReflectionType_GetMemberTypeByIndex(This, index)           \
  (This)->lpVtbl->GetMemberTypeByIndex(This, index)
#define ID3D10ShaderReflectionType_GetMemberTypeByName(This, name)             \
  (This)->lpVtbl->GetMemberTypeByName(This, name)
#define ID3D10ShaderReflectionType_GetMemberTypeName(This, index)              \
  (This)->lpVtbl->GetMemberTypeName(This, index)
#else
/*** ID3D10ShaderReflectionType methods ***/
static inline HRESULT
ID3D10ShaderReflectionType_GetDesc(ID3D10ShaderReflectionType *This,
                                   D3D10_SHADER_TYPE_DESC *desc) {
  return This->lpVtbl->GetDesc(This, desc);
}
static inline ID3D10ShaderReflectionType *
ID3D10ShaderReflectionType_GetMemberTypeByIndex(
    ID3D10ShaderReflectionType *This, UINT index) {
  return This->lpVtbl->GetMemberTypeByIndex(This, index);
}
static inline ID3D10ShaderReflectionType *
ID3D10ShaderReflectionType_GetMemberTypeByName(ID3D10ShaderReflectionType *This,
                                               const char *name) {
  return This->lpVtbl->GetMemberTypeByName(This, name);
}
static inline const char *
ID3D10ShaderReflectionType_GetMemberTypeName(ID3D10ShaderReflectionType *This,
                                             UINT index) {
...
ID3D10ShaderReflectionVariable {
  BEGIN_INTERFACE
  virtual HRESULT STDMETHODCALLTYPE GetDesc(D3D10_SHADER_VARIABLE_DESC *
                                            desc) = 0;
  virtual ID3D10ShaderReflectionType *STDMETHODCALLTYPE GetType() = 0;
  END_INTERFACE
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D10ShaderReflectionVariable, 0x1bf63c95, 0x2650, 0x405d,
                0x99, 0xc1, 0x36, 0x36, 0xbd, 0x1d, 0xa0, 0xa1)
#endif
#else
typedef struct ID3D10ShaderReflectionVariableVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *GetDesc)(ID3D10ShaderReflectionVariable *This,
...
#ifndef WIDL_C_INLINE_WRAPPERS
/*** ID3D10ShaderReflectionVariable methods ***/
#define ID3D10ShaderReflectionVariable_GetDesc(This, desc)                     \
  (This)->lpVtbl->GetDesc(This, desc)
#define ID3D10ShaderReflectionVariable_GetType(This)                           \
  (This)->lpVtbl->GetType(This)
#else
/*** ID3D10ShaderReflectionVariable methods ***/
static inline HRESULT
ID3D10ShaderReflectionVariable_GetDesc(ID3D10ShaderReflectionVariable *This,
                                       D3D10_SHADER_VARIABLE_DESC *desc) {
  return This->lpVtbl->GetDesc(This, desc);
}
static inline ID3D10ShaderReflectionType *
ID3D10ShaderReflectionVariable_GetType(ID3D10ShaderReflectionVariable *This) {
...
ID3D10ShaderReflectionConstantBuffer {
  BEGIN_INTERFACE
  virtual HRESULT STDMETHODCALLTYPE GetDesc(D3D10_SHADER_BUFFER_DESC *
                                            desc) = 0;
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D10ShaderReflectionConstantBuffer, 0x66c66a94, 0xdddd,
                0x4b62, 0xa6, 0x6a, 0xf0, 0xda, 0x33, 0xc2, 0xb4, 0xd0)
#endif
#else
typedef struct ID3D10ShaderReflectionConstantBufferVtbl {
  ...
  ID3D10ShaderReflectionVariable *(STDMETHODCALLTYPE *GetVariableByIndex)(
      ID3D10ShaderReflectionConstantBuffer *This, UINT index);
  ID3D10ShaderReflectionVariable *(STDMETHODCALLTYPE *GetVariableByName)(
      ID3D10ShaderReflectionConstantBuffer *This, const char *name);
  END_INTERFACE
...
#ifndef WIDL_C_INLINE_WRAPPERS
/*** ID3D10ShaderReflectionConstantBuffer methods ***/
#define ID3D10ShaderReflectionConstantBuffer_GetDesc(This, desc)               \
  (This)->lpVtbl->GetDesc(This, desc)
#define ID3D10ShaderReflectionConstantBuffer_GetVariableByIndex(This, index)   \
  (This)->lpVtbl->GetVariableByIndex(This, index)
#define ID3D10ShaderReflectionConstantBuffer_GetVariableByName(This, name)     \
  (This)->lpVtbl->GetVariableByName(This, name)
#else
/*** ID3D10ShaderReflectionConstantBuffer methods ***/
static inline HRESULT ID3D10ShaderReflectionConstantBuffer_GetDesc(
    ID3D10ShaderReflectionConstantBuffer *This,
    D3D10_SHADER_BUFFER_DESC *desc) {
  return This->lpVtbl->GetDesc(This, desc);
}
static inline ID3D10ShaderReflectionVariable *
ID3D10ShaderReflectionConstantBuffer_GetVariableByIndex(
    ID3D10ShaderReflectionConstantBuffer *This, UINT index) {
  return This->lpVtbl->GetVariableByIndex(This, index);
}
static inline ID3D10ShaderReflectionVariable *
ID3D10ShaderReflectionConstantBuffer_GetVariableByName(
    ID3D10ShaderReflectionConstantBuffer *This, const char *name) {
...
ID3D10ShaderReflection : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetDesc(D3D10_SHADER_DESC * desc) = 0;
  virtual ID3D10ShaderReflectionConstantBuffer *STDMETHODCALLTYPE
  ...
  virtual HRESULT STDMETHODCALLTYPE GetResourceBindingDesc(
      UINT index, D3D10_SHADER_INPUT_BIND_DESC * desc) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetInputParameterDesc(
      UINT index, D3D10_SIGNATURE_PARAMETER_DESC * desc) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetOutputParameterDesc(
      UINT index, D3D10_SIGNATURE_PARAMETER_DESC * desc) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D10ShaderReflection, 0xd40e20b6, 0xf8f7, 0x42ad, 0xab, 0x20,
                0x4b, 0xaf, 0x8f, 0x15, 0xdf, 0xaa)
#endif
#else
typedef struct ID3D10ShaderReflectionVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D10ShaderReflection *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(ID3D10ShaderReflection *This);
  ULONG(STDMETHODCALLTYPE *Release)(ID3D10ShaderReflection *This);
  /*** ID3D10ShaderReflection methods ***/
  HRESULT(STDMETHODCALLTYPE *GetDesc)(ID3D10ShaderReflection *This,
                                      D3D10_SHADER_DESC *desc);
  ID3D10ShaderReflectionConstantBuffer *(
      STDMETHODCALLTYPE *GetConstantBufferByIndex)(ID3D10ShaderReflection *This,
                                                   UINT index);
  ID3D10ShaderReflectionConstantBuffer *(
      STDMETHODCALLTYPE *GetConstantBufferByName)(ID3D10ShaderReflection *This,
                                                  const char *name);
  HRESULT(STDMETHODCALLTYPE *GetResourceBindingDesc)(
      ID3D10ShaderReflection *This, UINT index,
...
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
#define ID3D10ShaderReflection_QueryInterface(This, riid, ppvObject)           \
...
/*** ID3D10ShaderReflection methods ***/
#define ID3D10ShaderReflection_GetDesc(This, desc)                             \
  (This)->lpVtbl->GetDesc(This, desc)
#define ID3D10ShaderReflection_GetConstantBufferByIndex(This, index)           \
  (This)->lpVtbl->GetConstantBufferByIndex(This, index)
#define ID3D10ShaderReflection_GetConstantBufferByName(This, name)             \
  (This)->lpVtbl->GetConstantBufferByName(This, name)
#define ID3D10ShaderReflection_GetResourceBindingDesc(This, index, desc)       \
  (This)->lpVtbl->GetResourceBindingDesc(This, index, desc)
#define ID3D10ShaderReflection_GetInputParameterDesc(This, index, desc)        \
  (This)->lpVtbl->GetInputParameterDesc(This, index, desc)
#define ID3D10ShaderReflection_GetOutputParameterDesc(This, index, desc)       \
  (This)->lpVtbl->GetOutputParameterDesc(This, index, desc)
#else
/*** IUnknown methods ***/
static inline HRESULT
ID3D10ShaderReflection_QueryInterface(ID3D10ShaderReflection *This, REFIID riid,
                                      void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
ID3D10ShaderReflection_AddRef(ID3D10ShaderReflection *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
ID3D10ShaderReflection_Release(ID3D10ShaderReflection *This) {
  return This->lpVtbl->Release(This);
}
/*** ID3D10ShaderReflection methods ***/
static inline HRESULT
ID3D10ShaderReflection_GetDesc(ID3D10ShaderReflection *This,
                               D3D10_SHADER_DESC *desc) {
  return This->lpVtbl->GetDesc(This, desc);
}
static inline ID3D10ShaderReflectionConstantBuffer *
ID3D10ShaderReflection_GetConstantBufferByIndex(ID3D10ShaderReflection *This,
                                                UINT index) {
  return This->lpVtbl->GetConstantBufferByIndex(This, index);
}
static inline ID3D10ShaderReflectionConstantBuffer *
ID3D10ShaderReflection_GetConstantBufferByName(ID3D10ShaderReflection *This,
                                               const char *name) {
  return This->lpVtbl->GetConstantBufferByName(This, name);
}
static inline HRESULT ID3D10ShaderReflection_GetResourceBindingDesc(
    ID3D10ShaderReflection *This, UINT index,
    D3D10_SHADER_INPUT_BIND_DESC *desc) {
  return This->lpVtbl->GetResourceBindingDesc(This, index, desc);
}
static inline HRESULT ID3D10ShaderReflection_GetInputParameterDesc(
    ID3D10ShaderReflection *This, UINT index,
    D3D10_SIGNATURE_PARAMETER_DESC *desc) {
  return This->lpVtbl->GetInputParameterDesc(This, index, desc);
}
static inline HRESULT ID3D10ShaderReflection_GetOutputParameterDesc(
    ID3D10ShaderReflection *This, UINT index,
    D3D10_SIGNATURE_PARAMETER_DESC *desc) {
...
HRESULT __stdcall
D3D10CompileShader(const char *data, SIZE_T data_size, const char *filename,
                   const D3D10_SHADER_MACRO *defines, ID3D10Include *include,
                   const char *entrypoint, const char *profile, UINT flags,
                   ID3D10Blob **shader, ID3D10Blob **error_messages);
...
HRESULT __stdcall D3D10ReflectShader(const void *data, SIZE_T data_size,
                                     ID3D10ShaderReflection **reflector);
HRESULT __stdcall D3D10GetInputSignatureBlob(const void *data, SIZE_T data_size,
                                             ID3D10Blob **blob);
HRESULT __stdcall D3D10GetOutputSignatureBlob(const void *data,
                                              SIZE_T data_size,
                                              ID3D10Blob **blob);
HRESULT __stdcall D3D10GetInputAndOutputSignatureBlob(const void *data,
                                                      SIZE_T data_size,
                                                      ID3D10Blob **blob);
HRESULT __stdcall D3D10GetShaderDebugInfo(const void *data, SIZE_T data_size,
                                          ID3D10Blob **blob);
