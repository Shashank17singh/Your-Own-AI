...
typedef struct IPersistHistoryVtbl {
  BEGIN_INTERFACE
  HRESULT(WINAPI *QueryInterface)(IPersistHistory *This, REFIID riid,
                                  void **ppvObject);
  ...
  HRESULT(WINAPI *LoadHistory)(IPersistHistory *This, IStream *pStream,
                               IBindCtx *pbc);
  HRESULT(WINAPI *SaveHistory)(IPersistHistory *This, IStream *pStream);
  HRESULT(WINAPI *SetPositionCookie)(IPersistHistory *This,
                                     DWORD dwPositioncookie);
  HRESULT(WINAPI *GetPositionCookie)(IPersistHistory *This,
...
#endif
#endif
HRESULT WINAPI IPersistHistory_LoadHistory_Proxy(IPersistHistory *This,
                                                 IStream *pStream,
                                                 IBindCtx *pbc);
...
HRESULT WINAPI IPersistHistory_SaveHistory_Proxy(IPersistHistory *This,
                                                 IStream *pStream);
void __RPC_STUB IPersistHistory_SaveHistory_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IPersistHistory_SetPositionCookie_Proxy(IPersistHistory *This,
                                                       DWORD dwPositioncookie);
void __RPC_STUB IPersistHistory_SetPositionCookie_Stub(
    IRpcStubBuffer *This, IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage, DWORD *_pdwStubPhase);
HRESULT WINAPI IPersistHistory_GetPositionCookie_Proxy(
