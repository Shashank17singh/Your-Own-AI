...
typedef ULONG(WINAPI MAPIREADMAIL)(LHANDLE lhSession, ULONG_PTR ulUIParam,
                                   LPSTR lpszMessageID, FLAGS flFlags,
                                   ULONG ulReserved, lpMapiMessage *lppMessage);
typedef MAPIREADMAIL *LPMAPIREADMAIL;
MAPIREADMAIL MAPIReadMail;
typedef ULONG(WINAPI MAPISAVEMAIL)(LHANDLE lhSession, ULONG_PTR ulUIParam,
                                   lpMapiMessage lpMessage, FLAGS flFlags,
                                   ULONG ulReserved, LPSTR lpszMessageID);
typedef MAPISAVEMAIL *LPMAPISAVEMAIL;
MAPISAVEMAIL MAPISaveMail;
typedef ULONG(WINAPI MAPIDELETEMAIL)(LHANDLE lhSession, ULONG_PTR ulUIParam,
                                     LPSTR lpszMessageID, FLAGS flFlags,
                                     ULONG ulReserved);
...
typedef ULONG(WINAPI MAPIADDRESS)(LHANDLE lhSession, ULONG_PTR ulUIParam,
...
typedef ULONG(WINAPI MAPIDETAILS)(LHANDLE lhSession, ULONG_PTR ulUIParam,
                                  lpMapiRecipDesc lpRecip, FLAGS flFlags,
                                  ULONG ulReserved);
typedef MAPIDETAILS *LPMAPIDETAILS;
MAPIDETAILS MAPIDetails;
typedef ULONG(WINAPI MAPIRESOLVENAME)(LHANDLE lhSession, ULONG_PTR ulUIParam,
...
#ifdef MAPIX_H
STDMETHODIMP_(SCODE)
ScMAPIXFromSMAPI(LHANDLE lhSimpleSession, ULONG ulFlags, LPCIID lpInterface,
