...
__CRT_UUID_DECL(IKsClockPropertySet, 0x5c5cbd84, 0xe755, 0x11d0, 0xac, 0x18,
...
DECLARE_INTERFACE_(IKsClockPropertySet, IUnknown) {
  ...
  STDMETHOD(KsGetCorrelatedPhysicalTime)(THIS_ KSCORRELATED_TIME *
                                         CorrelatedTime) PURE;
  STDMETHOD(KsSetCorrelatedPhysicalTime)(THIS_ KSCORRELATED_TIME *
                                         CorrelatedTime) PURE;
...
struct IKsAllocator;
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IKsAllocator, 0x8da64899, 0xc0d9, 0x11d0, 0x84, 0x13, 0x00,
                0x00, 0xf8, 0x22, 0xfe, 0x8a);
#endif
#undef INTERFACE
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IKsAllocatorEx, 0x091bb63a, 0x603f, 0x11d1, 0xb0, 0x67, 0x00,
...
struct IKsPin;
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IKsPin, 0xb61178d1, 0xa2d9, 0x11cf, 0x9e, 0x53, 0x00, 0xaa,
                0x00, 0xa2, 0x16, 0xa1);
#endif
#undef INTERFACE
...
DECLARE_INTERFACE_(IKsPin, IUnknown) {
  ...
  STDMETHOD(KsCreateSinkPinHandle)(THIS_ KSPIN_INTERFACE & Interface,
  ...
  STDMETHOD(KsMediaSamplesCompleted)(THIS_ PKSSTREAM_SEGMENT StreamSegment)
      PURE;
  STDMETHOD_(IMemAllocator *, KsPeekAllocator)(THIS_ KSPEEKOPERATION Operation)
      PURE;
  ...
  STDMETHOD(KsQualityNotify)(THIS_ ULONG Proportion, REFERENCE_TIME TimeDelta)
      PURE;
};
struct IKsPinEx;
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IKsPinEx, 0x7bb38260, 0xd19c, 0x11d2, 0xb3, 0x8a, 0x00, 0xa0,
                0xc9, 0x5e, 0xc2, 0x2e);
#endif
#undef INTERFACE
...
struct IKsPinPipe;
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IKsPinPipe, 0xe539cd90, 0xa8b4, 0x11d1, 0x81, 0x89, 0x00, 0xa0,
                0xc9, 0x06, 0x28, 0x02);
#endif
#undef INTERFACE
#define INTERFACE IKsPinPipe
DECLARE_INTERFACE_(IKsPinPipe, IUnknown) {
  STDMETHOD(KsGetPinFramingCache)(THIS_ PKSALLOCATOR_FRAMING_EX * FramingEx,
                                  PFRAMING_PROP FramingProp,
                                  FRAMING_CACHE_OPS Option) PURE;
  STDMETHOD(KsSetPinFramingCache)(THIS_ PKSALLOCATOR_FRAMING_EX FramingEx,
                                  PFRAMING_PROP FramingProp,
                                  FRAMING_CACHE_OPS Option) PURE;
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IKsPinFactory, 0xcd5ebe6b, 0x8b6e, 0x11d1, 0x8a, 0xe0, 0x00,
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IKsDataTypeHandler, 0x5ffbaa02, 0x49a3, 0x11d0, 0x9f, 0x36,
...
DECLARE_INTERFACE_(IKsDataTypeHandler, IUnknown) {
  STDMETHOD(KsCompleteIoOperation)(
      THIS_ IMediaSample * Sample, PVOID StreamHeader,
      KSIOOPERATION IoOperation, WINBOOL Cancelled) PURE;
  STDMETHOD(KsIsMediaTypeInRanges)(THIS_ PVOID DataRanges) PURE;
  STDMETHOD(KsPrepareIoOperation)(THIS_ IMediaSample * Sample,
                                  PVOID StreamHeader, KSIOOPERATION IoOperation)
      PURE;
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IKsDataTypeCompletion, 0x827d1a0e, 0x0f73, 0x11d2, 0xb2, 0x7a,
                0x00, 0xa0, 0xc9, 0x22, 0x31, 0x96);
#endif
#undef INTERFACE
#define INTERFACE IKsDataTypeCompletion
DECLARE_INTERFACE_(IKsDataTypeCompletion, IUnknown) {
  STDMETHOD(KsCompleteMediaType)(THIS_ HANDLE FilterHandle, ULONG PinFactoryId,
                                 AM_MEDIA_TYPE * AmMediaType) PURE;
};
struct IKsInterfaceHandler;
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IKsInterfaceHandler, 0xd3abc7e0, 0x9a61, 0x11d0, 0xa4, 0x0d,
                0x00, 0xa0, 0xc9, 0x22, 0x31, 0x96);
#endif
#undef INTERFACE
...
DECLARE_INTERFACE_(IKsInterfaceHandler, IUnknown) {
  ...
  STDMETHOD(KsProcessMediaSamples)(THIS_ IKsDataTypeHandler * KsDataTypeHandler,
...
struct IKsObject;
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IKsObject, 0x423c13a2, 0x2070, 0x11d0, 0x9e, 0xf7, 0x00, 0xaa,
                0x00, 0xa2, 0x16, 0xa1);
#endif
#undef INTERFACE
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IKsQualityForwarder, 0x97ebaacb, 0x95bd, 0x11d0, 0xa3, 0xea,
                0x00, 0xa0, 0xc9, 0x22, 0x31, 0x96);
#endif
#undef INTERFACE
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IKsNotifyEvent, 0x412bd695, 0xf84b, 0x46c1, 0xac, 0x73, 0x54,
                0x19, 0x6d, 0xbc, 0x8f, 0xa7);
#endif
#undef INTERFACE
#define INTERFACE IKsNotifyEvent
DECLARE_INTERFACE_(IKsNotifyEvent, IUnknown) {
  STDMETHOD(KsNotifyEvent)(THIS_ ULONG Event, ULONG_PTR lParam1,
                           ULONG_PTR lParam2) PURE;
};
...
DECLARE_INTERFACE_(IKsPropertySet, IUnknown) {
  STDMETHOD(Set)(THIS_ REFGUID PropSet, ULONG Id, LPVOID InstanceData,
                 ULONG InstanceLength, LPVOID PropertyData, ULONG DataLength)
      PURE;
  STDMETHOD(Get)(THIS_ REFGUID PropSet, ULONG Id, LPVOID InstanceData,
                 ULONG InstanceLength, LPVOID PropertyData, ULONG DataLength,
                 ULONG * BytesReturned) PURE;
  STDMETHOD(QuerySupported)(THIS_ REFGUID PropSet, ULONG Id,
                            ULONG * TypeSupport) PURE;
};
...
DECLARE_INTERFACE_(IKsControl, IUnknown) {
  STDMETHOD(KsProperty)(THIS_ PKSPROPERTY Property, ULONG PropertyLength,
                        LPVOID PropertyData, ULONG DataLength,
                        ULONG * BytesReturned) PURE;
  STDMETHOD(KsMethod)(THIS_ PKSMETHOD Method, ULONG MethodLength,
...
DECLARE_INTERFACE_(IKsTopology, IUnknown) {
  STDMETHOD(CreateNodeInstance)(THIS_ ULONG NodeId, ULONG Flags,
                                ACCESS_MASK DesiredAccess, IUnknown * UnkOuter,
                                REFGUID InterfaceId, LPVOID * Interface) PURE;
};
#endif /* DECLARE_INTERFACE_ */
#endif /* _IKsTopology_ */
#ifdef __cplusplus
