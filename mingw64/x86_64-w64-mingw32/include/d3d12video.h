...
typedef enum D3D12_VIDEO_PROCESS_FILTER_FLAGS {
  ...
  D3D12_VIDEO_PROCESS_FILTER_FLAG_CONTRAST = 1
      << D3D12_VIDEO_PROCESS_FILTER_CONTRAST,
  D3D12_VIDEO_PROCESS_FILTER_FLAG_HUE = 1 << D3D12_VIDEO_PROCESS_FILTER_HUE,
  D3D12_VIDEO_PROCESS_FILTER_FLAG_SATURATION = 1
      << D3D12_VIDEO_PROCESS_FILTER_SATURATION,
  D3D12_VIDEO_PROCESS_FILTER_FLAG_NOISE_REDUCTION = 1
      << D3D12_VIDEO_PROCESS_FILTER_NOISE_REDUCTION,
  D3D12_VIDEO_PROCESS_FILTER_FLAG_EDGE_ENHANCEMENT = 1
...
DEFINE_GUID(IID_ID3D12VideoDecoderHeap, 0x0946b7c9, 0xebf6, 0x4047, 0xbb, 0x73,
...
#else
  virtual D3D12_VIDEO_DECODER_HEAP_DESC STDMETHODCALLTYPE GetDesc() = 0;
#endif
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D12VideoDecoderHeap, 0x0946b7c9, 0xebf6, 0x4047, 0xbb, 0x73,
                0x86, 0x83, 0xe2, 0x7d, 0xbb, 0x1f)
#endif
#else
typedef struct ID3D12VideoDecoderHeapVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D12VideoDecoderHeap *This,
  ...
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(ID3D12VideoDecoderHeap *This,
                                             REFGUID guid, UINT *data_size,
                                             void *data);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D12VideoDecoderHeap *This,
                                             REFGUID guid, UINT data_size,
                                             const void *data);
  HRESULT(STDMETHODCALLTYPE *SetPrivateDataInterface)(
      ID3D12VideoDecoderHeap *This, REFGUID guid, const IUnknown *data);
  HRESULT(STDMETHODCALLTYPE *SetName)(ID3D12VideoDecoderHeap *This,
                                      const WCHAR *name);
  /*** ID3D12DeviceChild methods ***/
  HRESULT(STDMETHODCALLTYPE *GetDevice)(ID3D12VideoDecoderHeap *This,
                                        REFIID riid, void **device);
  /*** ID3D12VideoDecoderHeap methods ***/
  D3D12_VIDEO_DECODER_HEAP_DESC *(STDMETHODCALLTYPE *GetDesc)(
      ID3D12VideoDecoderHeap *This, D3D12_VIDEO_DECODER_HEAP_DESC *__ret);
  END_INTERFACE
...
/*** ID3D12Object methods ***/
#define ID3D12VideoDecoderHeap_GetPrivateData(This, guid, data_size, data)     \
  (This)->lpVtbl->GetPrivateData(This, guid, data_size, data)
#define ID3D12VideoDecoderHeap_SetPrivateData(This, guid, data_size, data)     \
  (This)->lpVtbl->SetPrivateData(This, guid, data_size, data)
#define ID3D12VideoDecoderHeap_SetPrivateDataInterface(This, guid, data)       \
  (This)->lpVtbl->SetPrivateDataInterface(This, guid, data)
#define ID3D12VideoDecoderHeap_SetName(This, name)                             \
  (This)->lpVtbl->SetName(This, name)
/*** ID3D12DeviceChild methods ***/
#define ID3D12VideoDecoderHeap_GetDevice(This, riid, device)                   \
  (This)->lpVtbl->GetDevice(This, riid, device)
/*** ID3D12VideoDecoderHeap methods ***/
#define ID3D12VideoDecoderHeap_GetDesc(This)                                   \
  ID3D12VideoDecoderHeap_GetDesc_define_WIDL_C_INLINE_WRAPPERS_for_aggregate_return_support
#else
/*** IUnknown methods ***/
static inline HRESULT
ID3D12VideoDecoderHeap_QueryInterface(ID3D12VideoDecoderHeap *This, REFIID riid,
                                      void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
ID3D12VideoDecoderHeap_AddRef(ID3D12VideoDecoderHeap *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
ID3D12VideoDecoderHeap_Release(ID3D12VideoDecoderHeap *This) {
  return This->lpVtbl->Release(This);
}
/*** ID3D12Object methods ***/
static inline HRESULT ID3D12VideoDecoderHeap_GetPrivateData(
    ID3D12VideoDecoderHeap *This, REFGUID guid, UINT *data_size, void *data) {
  return This->lpVtbl->GetPrivateData(This, guid, data_size, data);
}
static inline HRESULT
ID3D12VideoDecoderHeap_SetPrivateData(ID3D12VideoDecoderHeap *This,
                                      REFGUID guid, UINT data_size,
                                      const void *data) {
  return This->lpVtbl->SetPrivateData(This, guid, data_size, data);
}
static inline HRESULT ID3D12VideoDecoderHeap_SetPrivateDataInterface(
    ID3D12VideoDecoderHeap *This, REFGUID guid, const IUnknown *data) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, data);
}
static inline HRESULT
ID3D12VideoDecoderHeap_SetName(ID3D12VideoDecoderHeap *This,
                               const WCHAR *name) {
  return This->lpVtbl->SetName(This, name);
}
/*** ID3D12DeviceChild methods ***/
static inline HRESULT
ID3D12VideoDecoderHeap_GetDevice(ID3D12VideoDecoderHeap *This, REFIID riid,
                                 void **device) {
  return This->lpVtbl->GetDevice(This, riid, device);
}
/*** ID3D12VideoDecoderHeap methods ***/
static inline D3D12_VIDEO_DECODER_HEAP_DESC
ID3D12VideoDecoderHeap_GetDesc(ID3D12VideoDecoderHeap *This) {
  D3D12_VIDEO_DECODER_HEAP_DESC __ret;
...
DEFINE_GUID(IID_ID3D12VideoDevice, 0x1f052807, 0x0b46, 0x4acc, 0x8a, 0x89, 0x36,
            0x4f, 0x79, 0x37, 0x18, 0xa4);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("1f052807-0b46-4acc-8a89-364f793718a4")
ID3D12VideoDevice : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE CheckFeatureSupport(
      D3D12_FEATURE_VIDEO feature_video, void *feature_support_data,
  ...
  virtual HRESULT STDMETHODCALLTYPE CreateVideoDecoderHeap(
      const D3D12_VIDEO_DECODER_HEAP_DESC *video_decoder_heap_desc, REFIID riid,
  ...
  virtual HRESULT STDMETHODCALLTYPE CreateVideoProcessor(
      ...
      REFIID riid, void **video_processor) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D12VideoDevice, 0x1f052807, 0x0b46, 0x4acc, 0x8a, 0x89, 0x36,
                0x4f, 0x79, 0x37, 0x18, 0xa4)
#endif
#else
typedef struct ID3D12VideoDeviceVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D12VideoDevice *This,
                                             REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *CheckFeatureSupport)(
      ID3D12VideoDevice *This, D3D12_FEATURE_VIDEO feature_video,
      void *feature_support_data, UINT feature_support_data_size);
  HRESULT(STDMETHODCALLTYPE *CreateVideoDecoder)(
      ID3D12VideoDevice *This, const D3D12_VIDEO_DECODER_DESC *desc,
      REFIID riid, void **video_decoder);
  HRESULT(STDMETHODCALLTYPE *CreateVideoDecoderHeap)(
      ID3D12VideoDevice *This,
      const D3D12_VIDEO_DECODER_HEAP_DESC *video_decoder_heap_desc, REFIID riid,
      void **video_decoder_heap);
  HRESULT(STDMETHODCALLTYPE *CreateVideoProcessor)(
      ID3D12VideoDevice *This, UINT node_mask,
      const D3D12_VIDEO_PROCESS_OUTPUT_STREAM_DESC *output_stream_desc,
      UINT input_stream_descs_count,
      const D3D12_VIDEO_PROCESS_INPUT_STREAM_DESC *input_stream_descs,
      REFIID riid, void **video_processor);
  END_INTERFACE
} ID3D12VideoDeviceVtbl;
interface ID3D12VideoDevice { CONST_VTBL ID3D12VideoDeviceVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** ID3D12VideoDevice methods ***/
#define ID3D12VideoDevice_CheckFeatureSupport(                                 \
    This, feature_video, feature_support_data, feature_support_data_size)      \
  (This)->lpVtbl->CheckFeatureSupport(                                         \
      This, feature_video, feature_support_data, feature_support_data_size)
#define ID3D12VideoDevice_CreateVideoDecoder(This, desc, riid, video_decoder)  \
  (This)->lpVtbl->CreateVideoDecoder(This, desc, riid, video_decoder)
#define ID3D12VideoDevice_CreateVideoDecoderHeap(                              \
    This, video_decoder_heap_desc, riid, video_decoder_heap)                   \
  (This)->lpVtbl->CreateVideoDecoderHeap(This, video_decoder_heap_desc, riid,  \
                                         video_decoder_heap)
#define ID3D12VideoDevice_CreateVideoProcessor(                                \
    This, node_mask, output_stream_desc, input_stream_descs_count,             \
    input_stream_descs, riid, video_processor)                                 \
  (This)->lpVtbl->CreateVideoProcessor(                                        \
      This, node_mask, output_stream_desc, input_stream_descs_count,           \
      input_stream_descs, riid, video_processor)
#else
/*** IUnknown methods ***/
static inline HRESULT ID3D12VideoDevice_QueryInterface(ID3D12VideoDevice *This,
                                                       REFIID riid,
                                                       void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ID3D12VideoDevice methods ***/
static inline HRESULT ID3D12VideoDevice_CheckFeatureSupport(
    ID3D12VideoDevice *This, D3D12_FEATURE_VIDEO feature_video,
    void *feature_support_data, UINT feature_support_data_size) {
  return This->lpVtbl->CheckFeatureSupport(
      This, feature_video, feature_support_data, feature_support_data_size);
}
static inline HRESULT
ID3D12VideoDevice_CreateVideoDecoder(ID3D12VideoDevice *This,
                                     const D3D12_VIDEO_DECODER_DESC *desc,
                                     REFIID riid, void **video_decoder) {
  return This->lpVtbl->CreateVideoDecoder(This, desc, riid, video_decoder);
}
static inline HRESULT ID3D12VideoDevice_CreateVideoDecoderHeap(
    ID3D12VideoDevice *This,
    const D3D12_VIDEO_DECODER_HEAP_DESC *video_decoder_heap_desc, REFIID riid,
    void **video_decoder_heap) {
  return This->lpVtbl->CreateVideoDecoderHeap(This, video_decoder_heap_desc,
                                              riid, video_decoder_heap);
}
static inline HRESULT ID3D12VideoDevice_CreateVideoProcessor(
    ID3D12VideoDevice *This, UINT node_mask,
    const D3D12_VIDEO_PROCESS_OUTPUT_STREAM_DESC *output_stream_desc,
    UINT input_stream_descs_count,
    const D3D12_VIDEO_PROCESS_INPUT_STREAM_DESC *input_stream_descs,
    REFIID riid, void **video_processor) {
  return This->lpVtbl->CreateVideoProcessor(
      This, node_mask, output_stream_desc, input_stream_descs_count,
      input_stream_descs, riid, video_processor);
}
#endif
...
DEFINE_GUID(IID_ID3D12VideoDecoder, 0xc59b6bdc, 0x7720, 0x4074, 0xa1, 0x36,
...
#else
  virtual D3D12_VIDEO_DECODER_DESC STDMETHODCALLTYPE GetDesc() = 0;
#endif
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D12VideoDecoder, 0xc59b6bdc, 0x7720, 0x4074, 0xa1, 0x36,
                0x17, 0xa1, 0x56, 0x03, 0x74, 0x70)
#endif
#else
typedef struct ID3D12VideoDecoderVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D12VideoDecoder *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(ID3D12VideoDecoder *This);
  ULONG(STDMETHODCALLTYPE *Release)(ID3D12VideoDecoder *This);
  /*** ID3D12Object methods ***/
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(ID3D12VideoDecoder *This,
                                             REFGUID guid, UINT *data_size,
                                             void *data);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D12VideoDecoder *This,
                                             REFGUID guid, UINT data_size,
                                             const void *data);
  HRESULT(STDMETHODCALLTYPE *SetPrivateDataInterface)(ID3D12VideoDecoder *This,
                                                      REFGUID guid,
                                                      const IUnknown *data);
  HRESULT(STDMETHODCALLTYPE *SetName)(ID3D12VideoDecoder *This,
                                      const WCHAR *name);
  /*** ID3D12DeviceChild methods ***/
  HRESULT(STDMETHODCALLTYPE *GetDevice)(ID3D12VideoDecoder *This, REFIID riid,
                                        void **device);
  /*** ID3D12VideoDecoder methods ***/
  D3D12_VIDEO_DECODER_DESC *(STDMETHODCALLTYPE *GetDesc)(
      ID3D12VideoDecoder *This, D3D12_VIDEO_DECODER_DESC *__ret);
  END_INTERFACE
} ID3D12VideoDecoderVtbl;
interface ID3D12VideoDecoder { CONST_VTBL ID3D12VideoDecoderVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** ID3D12Object methods ***/
#define ID3D12VideoDecoder_GetPrivateData(This, guid, data_size, data)         \
  (This)->lpVtbl->GetPrivateData(This, guid, data_size, data)
#define ID3D12VideoDecoder_SetPrivateData(This, guid, data_size, data)         \
  (This)->lpVtbl->SetPrivateData(This, guid, data_size, data)
#define ID3D12VideoDecoder_SetPrivateDataInterface(This, guid, data)           \
  (This)->lpVtbl->SetPrivateDataInterface(This, guid, data)
#define ID3D12VideoDecoder_SetName(This, name)                                 \
  (This)->lpVtbl->SetName(This, name)
/*** ID3D12DeviceChild methods ***/
#define ID3D12VideoDecoder_GetDevice(This, riid, device)                       \
  (This)->lpVtbl->GetDevice(This, riid, device)
/*** ID3D12VideoDecoder methods ***/
#define ID3D12VideoDecoder_GetDesc(This)                                       \
  ID3D12VideoDecoder_GetDesc_define_WIDL_C_INLINE_WRAPPERS_for_aggregate_return_support
#else
/*** IUnknown methods ***/
static inline HRESULT
ID3D12VideoDecoder_QueryInterface(ID3D12VideoDecoder *This, REFIID riid,
                                  void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ID3D12Object methods ***/
static inline HRESULT
ID3D12VideoDecoder_GetPrivateData(ID3D12VideoDecoder *This, REFGUID guid,
                                  UINT *data_size, void *data) {
  return This->lpVtbl->GetPrivateData(This, guid, data_size, data);
}
static inline HRESULT
ID3D12VideoDecoder_SetPrivateData(ID3D12VideoDecoder *This, REFGUID guid,
                                  UINT data_size, const void *data) {
  return This->lpVtbl->SetPrivateData(This, guid, data_size, data);
}
static inline HRESULT
ID3D12VideoDecoder_SetPrivateDataInterface(ID3D12VideoDecoder *This,
                                           REFGUID guid, const IUnknown *data) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, data);
}
static inline HRESULT ID3D12VideoDecoder_SetName(ID3D12VideoDecoder *This,
                                                 const WCHAR *name) {
  return This->lpVtbl->SetName(This, name);
}
/*** ID3D12DeviceChild methods ***/
static inline HRESULT ID3D12VideoDecoder_GetDevice(ID3D12VideoDecoder *This,
                                                   REFIID riid, void **device) {
  return This->lpVtbl->GetDevice(This, riid, device);
}
/*** ID3D12VideoDecoder methods ***/
static inline D3D12_VIDEO_DECODER_DESC
ID3D12VideoDecoder_GetDesc(ID3D12VideoDecoder *This) {
  D3D12_VIDEO_DECODER_DESC __ret;
  return *This->lpVtbl->GetDesc(This, &__ret);
}
#endif
...
DEFINE_GUID(IID_ID3D12VideoProcessor, 0x304fdb32, 0xbede, 0x410a, 0x85, 0x45,
...
ID3D12VideoProcessor : public ID3D12Pageable {
  ...
  virtual D3D12_VIDEO_PROCESS_OUTPUT_STREAM_DESC *STDMETHODCALLTYPE
      GetOutputStreamDesc(D3D12_VIDEO_PROCESS_OUTPUT_STREAM_DESC * __ret) = 0;
...
#else
  virtual D3D12_VIDEO_PROCESS_OUTPUT_STREAM_DESC STDMETHODCALLTYPE
  GetOutputStreamDesc() = 0;
#endif
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D12VideoProcessor, 0x304fdb32, 0xbede, 0x410a, 0x85, 0x45,
                0x94, 0x3a, 0xc6, 0xa4, 0x61, 0x38)
#endif
#else
typedef struct ID3D12VideoProcessorVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D12VideoProcessor *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(ID3D12VideoProcessor *This);
  ULONG(STDMETHODCALLTYPE *Release)(ID3D12VideoProcessor *This);
  /*** ID3D12Object methods ***/
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(ID3D12VideoProcessor *This,
                                             REFGUID guid, UINT *data_size,
                                             void *data);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D12VideoProcessor *This,
                                             REFGUID guid, UINT data_size,
                                             const void *data);
  HRESULT(STDMETHODCALLTYPE *SetPrivateDataInterface)(
      ID3D12VideoProcessor *This, REFGUID guid, const IUnknown *data);
  HRESULT(STDMETHODCALLTYPE *SetName)(ID3D12VideoProcessor *This,
                                      const WCHAR *name);
  /*** ID3D12DeviceChild methods ***/
  HRESULT(STDMETHODCALLTYPE *GetDevice)(ID3D12VideoProcessor *This, REFIID riid,
                                        void **device);
  ...
  HRESULT(STDMETHODCALLTYPE *GetInputStreamDescs)(
      ID3D12VideoProcessor *This, UINT num_input_stream_descs,
...
interface ID3D12VideoProcessor { CONST_VTBL ID3D12VideoProcessorVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** ID3D12Object methods ***/
#define ID3D12VideoProcessor_GetPrivateData(This, guid, data_size, data)       \
  (This)->lpVtbl->GetPrivateData(This, guid, data_size, data)
#define ID3D12VideoProcessor_SetPrivateData(This, guid, data_size, data)       \
  (This)->lpVtbl->SetPrivateData(This, guid, data_size, data)
#define ID3D12VideoProcessor_SetPrivateDataInterface(This, guid, data)         \
  (This)->lpVtbl->SetPrivateDataInterface(This, guid, data)
#define ID3D12VideoProcessor_SetName(This, name)                               \
  (This)->lpVtbl->SetName(This, name)
/*** ID3D12DeviceChild methods ***/
#define ID3D12VideoProcessor_GetDevice(This, riid, device)                     \
  (This)->lpVtbl->GetDevice(This, riid, device)
/*** ID3D12VideoProcessor methods ***/
...
#define ID3D12VideoProcessor_GetInputStreamDescs(This, num_input_stream_descs, \
                                                 input_stream_descs)           \
  (This)->lpVtbl->GetInputStreamDescs(This, num_input_stream_descs,            \
                                      input_stream_descs)
#define ID3D12VideoProcessor_GetOutputStreamDesc(This)                         \
  ID3D12VideoProcessor_GetOutputStreamDesc_define_WIDL_C_INLINE_WRAPPERS_for_aggregate_return_support
#else
/*** IUnknown methods ***/
static inline HRESULT
ID3D12VideoProcessor_QueryInterface(ID3D12VideoProcessor *This, REFIID riid,
                                    void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ID3D12Object methods ***/
static inline HRESULT
ID3D12VideoProcessor_GetPrivateData(ID3D12VideoProcessor *This, REFGUID guid,
                                    UINT *data_size, void *data) {
  return This->lpVtbl->GetPrivateData(This, guid, data_size, data);
}
static inline HRESULT
ID3D12VideoProcessor_SetPrivateData(ID3D12VideoProcessor *This, REFGUID guid,
                                    UINT data_size, const void *data) {
  return This->lpVtbl->SetPrivateData(This, guid, data_size, data);
}
static inline HRESULT ID3D12VideoProcessor_SetPrivateDataInterface(
    ID3D12VideoProcessor *This, REFGUID guid, const IUnknown *data) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, data);
}
static inline HRESULT ID3D12VideoProcessor_SetName(ID3D12VideoProcessor *This,
                                                   const WCHAR *name) {
  return This->lpVtbl->SetName(This, name);
}
/*** ID3D12DeviceChild methods ***/
static inline HRESULT ID3D12VideoProcessor_GetDevice(ID3D12VideoProcessor *This,
                                                     REFIID riid,
                                                     void **device) {
  return This->lpVtbl->GetDevice(This, riid, device);
}
/*** ID3D12VideoProcessor methods ***/
static inline UINT
ID3D12VideoProcessor_GetNodeMask(ID3D12VideoProcessor *This) {
  return This->lpVtbl->GetNodeMask(This);
}
static inline UINT
ID3D12VideoProcessor_GetNumInputStreamDescs(ID3D12VideoProcessor *This) {
  return This->lpVtbl->GetNumInputStreamDescs(This);
}
static inline HRESULT ID3D12VideoProcessor_GetInputStreamDescs(
    ID3D12VideoProcessor *This, UINT num_input_stream_descs,
    D3D12_VIDEO_PROCESS_INPUT_STREAM_DESC *input_stream_descs) {
  return This->lpVtbl->GetInputStreamDescs(This, num_input_stream_descs,
                                           input_stream_descs);
}
static inline D3D12_VIDEO_PROCESS_OUTPUT_STREAM_DESC
ID3D12VideoProcessor_GetOutputStreamDesc(ID3D12VideoProcessor *This) {
  D3D12_VIDEO_PROCESS_OUTPUT_STREAM_DESC __ret;
...
DEFINE_GUID(IID_ID3D12VideoDecodeCommandList, 0x3b60536e, 0xad29, 0x4e64, 0xa2,
...
ID3D12VideoDecodeCommandList : public ID3D12CommandList {
  ...
  virtual HRESULT STDMETHODCALLTYPE Reset(ID3D12CommandAllocator *
                                          allocator) = 0;
  virtual void STDMETHODCALLTYPE ClearState() = 0;
  virtual void STDMETHODCALLTYPE ResourceBarrier(
      UINT barriers_count, const D3D12_RESOURCE_BARRIER *barriers) = 0;
  virtual void STDMETHODCALLTYPE DiscardResource(
      ID3D12Resource * resource, const D3D12_DISCARD_REGION *region) = 0;
  virtual void STDMETHODCALLTYPE BeginQuery(
      ID3D12QueryHeap * query_heap, D3D12_QUERY_TYPE type, UINT index) = 0;
  ...
  virtual void STDMETHODCALLTYPE ResolveQueryData(
      ...
      UINT queries_count, ID3D12Resource * destination_buffer,
  ...
  virtual void STDMETHODCALLTYPE SetMarker(UINT metadata, const void *data,
                                           UINT size) = 0;
  virtual void STDMETHODCALLTYPE BeginEvent(UINT metadata, const void *data,
                                            UINT size) = 0;
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D12VideoDecodeCommandList, 0x3b60536e, 0xad29, 0x4e64, 0xa2,
                0x69, 0xf8, 0x53, 0x83, 0x7e, 0x5e, 0x53)
#endif
#else
typedef struct ID3D12VideoDecodeCommandListVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D12VideoDecodeCommandList *This,
                                             REFIID riid, void **ppvObject);
  ...
  /*** ID3D12Object methods ***/
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(ID3D12VideoDecodeCommandList *This,
                                             REFGUID guid, UINT *data_size,
                                             void *data);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D12VideoDecodeCommandList *This,
                                             REFGUID guid, UINT data_size,
                                             const void *data);
  HRESULT(STDMETHODCALLTYPE *SetPrivateDataInterface)(
      ID3D12VideoDecodeCommandList *This, REFGUID guid, const IUnknown *data);
  HRESULT(STDMETHODCALLTYPE *SetName)(ID3D12VideoDecodeCommandList *This,
                                      const WCHAR *name);
  /*** ID3D12DeviceChild methods ***/
  HRESULT(STDMETHODCALLTYPE *GetDevice)(ID3D12VideoDecodeCommandList *This,
                                        REFIID riid, void **device);
  ...
  HRESULT(STDMETHODCALLTYPE *Reset)(ID3D12VideoDecodeCommandList *This,
                                    ID3D12CommandAllocator *allocator);
  void(STDMETHODCALLTYPE *ClearState)(ID3D12VideoDecodeCommandList *This);
  void(STDMETHODCALLTYPE *ResourceBarrier)(
      ID3D12VideoDecodeCommandList *This, UINT barriers_count,
      const D3D12_RESOURCE_BARRIER *barriers);
  void(STDMETHODCALLTYPE *DiscardResource)(ID3D12VideoDecodeCommandList *This,
                                           ID3D12Resource *resource,
                                           const D3D12_DISCARD_REGION *region);
  void(STDMETHODCALLTYPE *BeginQuery)(ID3D12VideoDecodeCommandList *This,
                                      ID3D12QueryHeap *query_heap,
                                      D3D12_QUERY_TYPE type, UINT index);
  void(STDMETHODCALLTYPE *EndQuery)(ID3D12VideoDecodeCommandList *This,
                                    ID3D12QueryHeap *query_heap,
                                    D3D12_QUERY_TYPE type, UINT index);
  void(STDMETHODCALLTYPE *ResolveQueryData)(
      ID3D12VideoDecodeCommandList *This, ID3D12QueryHeap *query_heap,
      D3D12_QUERY_TYPE type, UINT start_index, UINT queries_count,
      ID3D12Resource *destination_buffer,
      UINT64 aligned_destination_buffer_offset);
  void(STDMETHODCALLTYPE *SetPredication)(ID3D12VideoDecodeCommandList *This,
                                          ID3D12Resource *buffer,
                                          UINT64 aligned_buffer_offset,
                                          D3D12_PREDICATION_OP operation);
  void(STDMETHODCALLTYPE *SetMarker)(ID3D12VideoDecodeCommandList *This,
                                     UINT metadata, const void *data,
                                     UINT size);
  void(STDMETHODCALLTYPE *BeginEvent)(ID3D12VideoDecodeCommandList *This,
                                      UINT metadata, const void *data,
                                      UINT size);
  void(STDMETHODCALLTYPE *EndEvent)(ID3D12VideoDecodeCommandList *This);
  void(STDMETHODCALLTYPE *DecodeFrame)(
      ID3D12VideoDecodeCommandList *This, ID3D12VideoDecoder *decoder,
      const D3D12_VIDEO_DECODE_OUTPUT_STREAM_ARGUMENTS *output_arguments,
      const D3D12_VIDEO_DECODE_INPUT_STREAM_ARGUMENTS *input_arguments);
  void(STDMETHODCALLTYPE *WriteBufferImmediate)(
      ID3D12VideoDecodeCommandList *This, UINT count,
...
/*** ID3D12Object methods ***/
#define ID3D12VideoDecodeCommandList_GetPrivateData(This, guid, data_size,     \
                                                    data)                      \
  (This)->lpVtbl->GetPrivateData(This, guid, data_size, data)
#define ID3D12VideoDecodeCommandList_SetPrivateData(This, guid, data_size,     \
                                                    data)                      \
  (This)->lpVtbl->SetPrivateData(This, guid, data_size, data)
#define ID3D12VideoDecodeCommandList_SetPrivateDataInterface(This, guid, data) \
  (This)->lpVtbl->SetPrivateDataInterface(This, guid, data)
#define ID3D12VideoDecodeCommandList_SetName(This, name)                       \
  (This)->lpVtbl->SetName(This, name)
/*** ID3D12DeviceChild methods ***/
#define ID3D12VideoDecodeCommandList_GetDevice(This, riid, device)             \
  (This)->lpVtbl->GetDevice(This, riid, device)
/*** ID3D12CommandList methods ***/
...
#define ID3D12VideoDecodeCommandList_Reset(This, allocator)                    \
  (This)->lpVtbl->Reset(This, allocator)
#define ID3D12VideoDecodeCommandList_ClearState(This)                          \
  (This)->lpVtbl->ClearState(This)
#define ID3D12VideoDecodeCommandList_ResourceBarrier(This, barriers_count,     \
                                                     barriers)                 \
  (This)->lpVtbl->ResourceBarrier(This, barriers_count, barriers)
#define ID3D12VideoDecodeCommandList_DiscardResource(This, resource, region)   \
  (This)->lpVtbl->DiscardResource(This, resource, region)
#define ID3D12VideoDecodeCommandList_BeginQuery(This, query_heap, type, index) \
  (This)->lpVtbl->BeginQuery(This, query_heap, type, index)
#define ID3D12VideoDecodeCommandList_EndQuery(This, query_heap, type, index)   \
  (This)->lpVtbl->EndQuery(This, query_heap, type, index)
#define ID3D12VideoDecodeCommandList_ResolveQueryData(                         \
    This, query_heap, type, start_index, queries_count, destination_buffer,    \
    aligned_destination_buffer_offset)                                         \
  (This)->lpVtbl->ResolveQueryData(This, query_heap, type, start_index,        \
                                   queries_count, destination_buffer,          \
                                   aligned_destination_buffer_offset)
#define ID3D12VideoDecodeCommandList_SetPredication(                           \
    This, buffer, aligned_buffer_offset, operation)                            \
  (This)->lpVtbl->SetPredication(This, buffer, aligned_buffer_offset, operation)
#define ID3D12VideoDecodeCommandList_SetMarker(This, metadata, data, size)     \
  (This)->lpVtbl->SetMarker(This, metadata, data, size)
#define ID3D12VideoDecodeCommandList_BeginEvent(This, metadata, data, size)    \
  (This)->lpVtbl->BeginEvent(This, metadata, data, size)
#define ID3D12VideoDecodeCommandList_EndEvent(This)                            \
  (This)->lpVtbl->EndEvent(This)
#define ID3D12VideoDecodeCommandList_DecodeFrame(                              \
    This, decoder, output_arguments, input_arguments)                          \
  (This)->lpVtbl->DecodeFrame(This, decoder, output_arguments, input_arguments)
#define ID3D12VideoDecodeCommandList_WriteBufferImmediate(This, count, params, \
                                                          modes)               \
  (This)->lpVtbl->WriteBufferImmediate(This, count, params, modes)
#else
/*** IUnknown methods ***/
static inline HRESULT
ID3D12VideoDecodeCommandList_QueryInterface(ID3D12VideoDecodeCommandList *This,
                                            REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
ID3D12VideoDecodeCommandList_AddRef(ID3D12VideoDecodeCommandList *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
ID3D12VideoDecodeCommandList_Release(ID3D12VideoDecodeCommandList *This) {
  return This->lpVtbl->Release(This);
}
/*** ID3D12Object methods ***/
static inline HRESULT
ID3D12VideoDecodeCommandList_GetPrivateData(ID3D12VideoDecodeCommandList *This,
                                            REFGUID guid, UINT *data_size,
                                            void *data) {
  return This->lpVtbl->GetPrivateData(This, guid, data_size, data);
}
static inline HRESULT
ID3D12VideoDecodeCommandList_SetPrivateData(ID3D12VideoDecodeCommandList *This,
                                            REFGUID guid, UINT data_size,
                                            const void *data) {
  return This->lpVtbl->SetPrivateData(This, guid, data_size, data);
}
static inline HRESULT ID3D12VideoDecodeCommandList_SetPrivateDataInterface(
    ID3D12VideoDecodeCommandList *This, REFGUID guid, const IUnknown *data) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, data);
}
static inline HRESULT
ID3D12VideoDecodeCommandList_SetName(ID3D12VideoDecodeCommandList *This,
                                     const WCHAR *name) {
  return This->lpVtbl->SetName(This, name);
}
/*** ID3D12DeviceChild methods ***/
static inline HRESULT
ID3D12VideoDecodeCommandList_GetDevice(ID3D12VideoDecodeCommandList *This,
                                       REFIID riid, void **device) {
  return This->lpVtbl->GetDevice(This, riid, device);
}
/*** ID3D12CommandList methods ***/
static inline D3D12_COMMAND_LIST_TYPE
ID3D12VideoDecodeCommandList_GetType(ID3D12VideoDecodeCommandList *This) {
  return This->lpVtbl->GetType(This);
}
/*** ID3D12VideoDecodeCommandList methods ***/
static inline HRESULT
ID3D12VideoDecodeCommandList_Close(ID3D12VideoDecodeCommandList *This) {
  return This->lpVtbl->Close(This);
}
static inline HRESULT
ID3D12VideoDecodeCommandList_Reset(ID3D12VideoDecodeCommandList *This,
                                   ID3D12CommandAllocator *allocator) {
  return This->lpVtbl->Reset(This, allocator);
}
static inline void
ID3D12VideoDecodeCommandList_ClearState(ID3D12VideoDecodeCommandList *This) {
  This->lpVtbl->ClearState(This);
}
static inline void ID3D12VideoDecodeCommandList_ResourceBarrier(
    ID3D12VideoDecodeCommandList *This, UINT barriers_count,
    const D3D12_RESOURCE_BARRIER *barriers) {
  This->lpVtbl->ResourceBarrier(This, barriers_count, barriers);
}
static inline void ID3D12VideoDecodeCommandList_DiscardResource(
    ID3D12VideoDecodeCommandList *This, ID3D12Resource *resource,
    const D3D12_DISCARD_REGION *region) {
  This->lpVtbl->DiscardResource(This, resource, region);
}
static inline void
ID3D12VideoDecodeCommandList_BeginQuery(ID3D12VideoDecodeCommandList *This,
                                        ID3D12QueryHeap *query_heap,
                                        D3D12_QUERY_TYPE type, UINT index) {
  This->lpVtbl->BeginQuery(This, query_heap, type, index);
}
static inline void
ID3D12VideoDecodeCommandList_EndQuery(ID3D12VideoDecodeCommandList *This,
                                      ID3D12QueryHeap *query_heap,
                                      D3D12_QUERY_TYPE type, UINT index) {
  This->lpVtbl->EndQuery(This, query_heap, type, index);
}
static inline void ID3D12VideoDecodeCommandList_ResolveQueryData(
    ID3D12VideoDecodeCommandList *This, ID3D12QueryHeap *query_heap,
    D3D12_QUERY_TYPE type, UINT start_index, UINT queries_count,
    ID3D12Resource *destination_buffer,
    UINT64 aligned_destination_buffer_offset) {
...
static inline void ID3D12VideoDecodeCommandList_SetPredication(
    ID3D12VideoDecodeCommandList *This, ID3D12Resource *buffer,
    UINT64 aligned_buffer_offset, D3D12_PREDICATION_OP operation) {
  This->lpVtbl->SetPredication(This, buffer, aligned_buffer_offset, operation);
}
static inline void
ID3D12VideoDecodeCommandList_SetMarker(ID3D12VideoDecodeCommandList *This,
                                       UINT metadata, const void *data,
                                       UINT size) {
  This->lpVtbl->SetMarker(This, metadata, data, size);
}
static inline void
ID3D12VideoDecodeCommandList_BeginEvent(ID3D12VideoDecodeCommandList *This,
                                        UINT metadata, const void *data,
                                        UINT size) {
  This->lpVtbl->BeginEvent(This, metadata, data, size);
}
static inline void
ID3D12VideoDecodeCommandList_EndEvent(ID3D12VideoDecodeCommandList *This) {
  This->lpVtbl->EndEvent(This);
}
...
static inline void ID3D12VideoDecodeCommandList_WriteBufferImmediate(
    ID3D12VideoDecodeCommandList *This, UINT count,
    const D3D12_WRITEBUFFERIMMEDIATE_PARAMETER *params,
    const D3D12_WRITEBUFFERIMMEDIATE_MODE *modes) {
  This->lpVtbl->WriteBufferImmediate(This, count, params, modes);
...
DEFINE_GUID(IID_ID3D12VideoProcessCommandList, 0xaeb2543a, 0x167f, 0x4682, 0xac,
            0xc8, 0xd1, 0x59, 0xed, 0x4a, 0x62, 0x09);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
ID3D12VideoProcessCommandList : public ID3D12CommandList {
  ...
  virtual void STDMETHODCALLTYPE ClearState() = 0;
  virtual void STDMETHODCALLTYPE ResourceBarrier(
      UINT num_barriers, const D3D12_RESOURCE_BARRIER *barriers) = 0;
  virtual void STDMETHODCALLTYPE DiscardResource(
      ID3D12Resource * resource, const D3D12_DISCARD_REGION *region) = 0;
  virtual void STDMETHODCALLTYPE BeginQuery(
      ID3D12QueryHeap * query_heap, D3D12_QUERY_TYPE type, UINT index) = 0;
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D12VideoProcessCommandList, 0xaeb2543a, 0x167f, 0x4682, 0xac,
                0xc8, 0xd1, 0x59, 0xed, 0x4a, 0x62, 0x09)
#endif
#else
typedef struct ID3D12VideoProcessCommandListVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(
      ID3D12VideoProcessCommandList *This, REFIID riid, void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(
      ID3D12VideoProcessCommandList *This, REFGUID guid, UINT *data_size,
      void *data);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(
      ID3D12VideoProcessCommandList *This, REFGUID guid, UINT data_size,
      const void *data);
  HRESULT(STDMETHODCALLTYPE *SetPrivateDataInterface)(
      ID3D12VideoProcessCommandList *This, REFGUID guid, const IUnknown *data);
  ...
  void(STDMETHODCALLTYPE *ResourceBarrier)(
      ID3D12VideoProcessCommandList *This, UINT num_barriers,
      const D3D12_RESOURCE_BARRIER *barriers);
  ...
  void(STDMETHODCALLTYPE *EndQuery)(ID3D12VideoProcessCommandList *This,
                                    ...
                                    D3D12_QUERY_TYPE type, UINT index);
  void(STDMETHODCALLTYPE *ResolveQueryData)(
      ID3D12VideoProcessCommandList *This, ID3D12QueryHeap *query_heap,
      D3D12_QUERY_TYPE type, UINT start_index, UINT num_queries,
      ID3D12Resource *destination_buffer,
      UINT64 aligned_destination_buffer_offset);
  ...
  void(STDMETHODCALLTYPE *WriteBufferImmediate)(
      ID3D12VideoProcessCommandList *This, UINT count,
      const D3D12_WRITEBUFFERIMMEDIATE_PARAMETER *params,
      const D3D12_WRITEBUFFERIMMEDIATE_MODE *modes);
  END_INTERFACE
...
/*** ID3D12Object methods ***/
#define ID3D12VideoProcessCommandList_GetPrivateData(This, guid, data_size,    \
                                                     data)                     \
  (This)->lpVtbl->GetPrivateData(This, guid, data_size, data)
#define ID3D12VideoProcessCommandList_SetPrivateData(This, guid, data_size,    \
                                                     data)                     \
  (This)->lpVtbl->SetPrivateData(This, guid, data_size, data)
#define ID3D12VideoProcessCommandList_SetPrivateDataInterface(This, guid,      \
                                                              data)            \
  (This)->lpVtbl->SetPrivateDataInterface(This, guid, data)
#define ID3D12VideoProcessCommandList_SetName(This, name)                      \
  (This)->lpVtbl->SetName(This, name)
/*** ID3D12DeviceChild methods ***/
#define ID3D12VideoProcessCommandList_GetDevice(This, riid, device)            \
  (This)->lpVtbl->GetDevice(This, riid, device)
/*** ID3D12CommandList methods ***/
...
#define ID3D12VideoProcessCommandList_Reset(This, allocator)                   \
  (This)->lpVtbl->Reset(This, allocator)
#define ID3D12VideoProcessCommandList_ClearState(This)                         \
  (This)->lpVtbl->ClearState(This)
#define ID3D12VideoProcessCommandList_ResourceBarrier(This, num_barriers,      \
                                                      barriers)                \
  (This)->lpVtbl->ResourceBarrier(This, num_barriers, barriers)
#define ID3D12VideoProcessCommandList_DiscardResource(This, resource, region)  \
  (This)->lpVtbl->DiscardResource(This, resource, region)
#define ID3D12VideoProcessCommandList_BeginQuery(This, query_heap, type,       \
                                                 index)                        \
  (This)->lpVtbl->BeginQuery(This, query_heap, type, index)
#define ID3D12VideoProcessCommandList_EndQuery(This, query_heap, type, index)  \
  (This)->lpVtbl->EndQuery(This, query_heap, type, index)
#define ID3D12VideoProcessCommandList_ResolveQueryData(                        \
    This, query_heap, type, start_index, num_queries, destination_buffer,      \
    aligned_destination_buffer_offset)                                         \
  (This)->lpVtbl->ResolveQueryData(This, query_heap, type, start_index,        \
                                   num_queries, destination_buffer,            \
                                   aligned_destination_buffer_offset)
#define ID3D12VideoProcessCommandList_SetPredication(                          \
    This, buffer, aligned_buffer_offset, operation)                            \
  (This)->lpVtbl->SetPredication(This, buffer, aligned_buffer_offset, operation)
#define ID3D12VideoProcessCommandList_SetMarker(This, metadata, data, size)    \
  (This)->lpVtbl->SetMarker(This, metadata, data, size)
#define ID3D12VideoProcessCommandList_BeginEvent(This, metadata, data, size)   \
  (This)->lpVtbl->BeginEvent(This, metadata, data, size)
#define ID3D12VideoProcessCommandList_EndEvent(This)                           \
  (This)->lpVtbl->EndEvent(This)
#define ID3D12VideoProcessCommandList_ProcessFrames(                           \
    This, video_processor, output_arguments, num_input_streams,                \
    input_arguments)                                                           \
  (This)->lpVtbl->ProcessFrames(This, video_processor, output_arguments,       \
                                num_input_streams, input_arguments)
#define ID3D12VideoProcessCommandList_WriteBufferImmediate(This, count,        \
                                                           params, modes)      \
  (This)->lpVtbl->WriteBufferImmediate(This, count, params, modes)
#else
/*** IUnknown methods ***/
static inline HRESULT ID3D12VideoProcessCommandList_QueryInterface(
    ID3D12VideoProcessCommandList *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
ID3D12VideoProcessCommandList_AddRef(ID3D12VideoProcessCommandList *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
ID3D12VideoProcessCommandList_Release(ID3D12VideoProcessCommandList *This) {
  return This->lpVtbl->Release(This);
}
/*** ID3D12Object methods ***/
static inline HRESULT ID3D12VideoProcessCommandList_GetPrivateData(
    ID3D12VideoProcessCommandList *This, REFGUID guid, UINT *data_size,
    void *data) {
  return This->lpVtbl->GetPrivateData(This, guid, data_size, data);
}
static inline HRESULT ID3D12VideoProcessCommandList_SetPrivateData(
    ID3D12VideoProcessCommandList *This, REFGUID guid, UINT data_size,
    const void *data) {
  return This->lpVtbl->SetPrivateData(This, guid, data_size, data);
}
static inline HRESULT ID3D12VideoProcessCommandList_SetPrivateDataInterface(
    ID3D12VideoProcessCommandList *This, REFGUID guid, const IUnknown *data) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, data);
}
static inline HRESULT
ID3D12VideoProcessCommandList_SetName(ID3D12VideoProcessCommandList *This,
                                      const WCHAR *name) {
  return This->lpVtbl->SetName(This, name);
}
/*** ID3D12DeviceChild methods ***/
static inline HRESULT
ID3D12VideoProcessCommandList_GetDevice(ID3D12VideoProcessCommandList *This,
                                        REFIID riid, void **device) {
  return This->lpVtbl->GetDevice(This, riid, device);
}
/*** ID3D12CommandList methods ***/
static inline D3D12_COMMAND_LIST_TYPE
ID3D12VideoProcessCommandList_GetType(ID3D12VideoProcessCommandList *This) {
  return This->lpVtbl->GetType(This);
}
/*** ID3D12VideoProcessCommandList methods ***/
static inline HRESULT
ID3D12VideoProcessCommandList_Close(ID3D12VideoProcessCommandList *This) {
  return This->lpVtbl->Close(This);
}
static inline HRESULT
ID3D12VideoProcessCommandList_Reset(ID3D12VideoProcessCommandList *This,
                                    ID3D12CommandAllocator *allocator) {
  return This->lpVtbl->Reset(This, allocator);
}
static inline void
ID3D12VideoProcessCommandList_ClearState(ID3D12VideoProcessCommandList *This) {
  This->lpVtbl->ClearState(This);
}
static inline void ID3D12VideoProcessCommandList_ResourceBarrier(
    ID3D12VideoProcessCommandList *This, UINT num_barriers,
    const D3D12_RESOURCE_BARRIER *barriers) {
  This->lpVtbl->ResourceBarrier(This, num_barriers, barriers);
}
static inline void ID3D12VideoProcessCommandList_DiscardResource(
    ID3D12VideoProcessCommandList *This, ID3D12Resource *resource,
    const D3D12_DISCARD_REGION *region) {
  This->lpVtbl->DiscardResource(This, resource, region);
}
static inline void
ID3D12VideoProcessCommandList_BeginQuery(ID3D12VideoProcessCommandList *This,
                                         ID3D12QueryHeap *query_heap,
                                         D3D12_QUERY_TYPE type, UINT index) {
  This->lpVtbl->BeginQuery(This, query_heap, type, index);
}
static inline void
ID3D12VideoProcessCommandList_EndQuery(ID3D12VideoProcessCommandList *This,
                                       ID3D12QueryHeap *query_heap,
                                       D3D12_QUERY_TYPE type, UINT index) {
  This->lpVtbl->EndQuery(This, query_heap, type, index);
}
static inline void ID3D12VideoProcessCommandList_ResolveQueryData(
    ID3D12VideoProcessCommandList *This, ID3D12QueryHeap *query_heap,
    D3D12_QUERY_TYPE type, UINT start_index, UINT num_queries,
    ID3D12Resource *destination_buffer,
    UINT64 aligned_destination_buffer_offset) {
...
static inline void ID3D12VideoProcessCommandList_SetPredication(
    ID3D12VideoProcessCommandList *This, ID3D12Resource *buffer,
    UINT64 aligned_buffer_offset, D3D12_PREDICATION_OP operation) {
  This->lpVtbl->SetPredication(This, buffer, aligned_buffer_offset, operation);
}
static inline void
ID3D12VideoProcessCommandList_SetMarker(ID3D12VideoProcessCommandList *This,
                                        UINT metadata, const void *data,
                                        UINT size) {
  This->lpVtbl->SetMarker(This, metadata, data, size);
}
static inline void
ID3D12VideoProcessCommandList_BeginEvent(ID3D12VideoProcessCommandList *This,
                                         UINT metadata, const void *data,
                                         UINT size) {
  This->lpVtbl->BeginEvent(This, metadata, data, size);
}
static inline void
ID3D12VideoProcessCommandList_EndEvent(ID3D12VideoProcessCommandList *This) {
  This->lpVtbl->EndEvent(This);
}
static inline void ID3D12VideoProcessCommandList_ProcessFrames(
    ID3D12VideoProcessCommandList *This, ID3D12VideoProcessor *video_processor,
    const D3D12_VIDEO_PROCESS_OUTPUT_STREAM_ARGUMENTS *output_arguments,
    UINT num_input_streams,
    const D3D12_VIDEO_PROCESS_INPUT_STREAM_ARGUMENTS *input_arguments) {
  This->lpVtbl->ProcessFrames(This, video_processor, output_arguments,
...
static inline void ID3D12VideoProcessCommandList_WriteBufferImmediate(
    ID3D12VideoProcessCommandList *This, UINT count,
    const D3D12_WRITEBUFFERIMMEDIATE_PARAMETER *params,
    const D3D12_WRITEBUFFERIMMEDIATE_MODE *modes) {
  This->lpVtbl->WriteBufferImmediate(This, count, params, modes);
...
DEFINE_GUID(IID_ID3D12VideoDecodeCommandList1, 0xd52f011b, 0xb56e, 0x453c, 0xa0,
            0x5a, 0xa7, 0xf3, 0x11, 0xc8, 0xf4, 0x72);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D12VideoDecodeCommandList1, 0xd52f011b, 0xb56e, 0x453c, 0xa0,
                0x5a, 0xa7, 0xf3, 0x11, 0xc8, 0xf4, 0x72)
#endif
#else
typedef struct ID3D12VideoDecodeCommandList1Vtbl {
  ...
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(
      ID3D12VideoDecodeCommandList1 *This, REFIID riid, void **ppvObject);
  ...
  /*** ID3D12Object methods ***/
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(
      ID3D12VideoDecodeCommandList1 *This, REFGUID guid, UINT *data_size,
      void *data);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(
      ID3D12VideoDecodeCommandList1 *This, REFGUID guid, UINT data_size,
      const void *data);
  HRESULT(STDMETHODCALLTYPE *SetPrivateDataInterface)(
      ID3D12VideoDecodeCommandList1 *This, REFGUID guid, const IUnknown *data);
  HRESULT(STDMETHODCALLTYPE *SetName)(ID3D12VideoDecodeCommandList1 *This,
                                      const WCHAR *name);
  /*** ID3D12DeviceChild methods ***/
  HRESULT(STDMETHODCALLTYPE *GetDevice)(ID3D12VideoDecodeCommandList1 *This,
                                        REFIID riid, void **device);
  /*** ID3D12CommandList methods ***/
  D3D12_COMMAND_LIST_TYPE(STDMETHODCALLTYPE *GetType)(
  ...
  HRESULT(STDMETHODCALLTYPE *Reset)(ID3D12VideoDecodeCommandList1 *This,
                                    ID3D12CommandAllocator *allocator);
  void(STDMETHODCALLTYPE *ClearState)(ID3D12VideoDecodeCommandList1 *This);
  void(STDMETHODCALLTYPE *ResourceBarrier)(
      ID3D12VideoDecodeCommandList1 *This, UINT barriers_count,
      const D3D12_RESOURCE_BARRIER *barriers);
  void(STDMETHODCALLTYPE *DiscardResource)(ID3D12VideoDecodeCommandList1 *This,
                                           ID3D12Resource *resource,
                                           const D3D12_DISCARD_REGION *region);
  void(STDMETHODCALLTYPE *BeginQuery)(ID3D12VideoDecodeCommandList1 *This,
                                      ID3D12QueryHeap *query_heap,
                                      D3D12_QUERY_TYPE type, UINT index);
  void(STDMETHODCALLTYPE *EndQuery)(ID3D12VideoDecodeCommandList1 *This,
                                    ID3D12QueryHeap *query_heap,
                                    D3D12_QUERY_TYPE type, UINT index);
  void(STDMETHODCALLTYPE *ResolveQueryData)(
      ID3D12VideoDecodeCommandList1 *This, ID3D12QueryHeap *query_heap,
      D3D12_QUERY_TYPE type, UINT start_index, UINT queries_count,
      ID3D12Resource *destination_buffer,
      UINT64 aligned_destination_buffer_offset);
  void(STDMETHODCALLTYPE *SetPredication)(ID3D12VideoDecodeCommandList1 *This,
                                          ID3D12Resource *buffer,
                                          UINT64 aligned_buffer_offset,
                                          D3D12_PREDICATION_OP operation);
  void(STDMETHODCALLTYPE *SetMarker)(ID3D12VideoDecodeCommandList1 *This,
                                     UINT metadata, const void *data,
                                     UINT size);
  void(STDMETHODCALLTYPE *BeginEvent)(ID3D12VideoDecodeCommandList1 *This,
                                      UINT metadata, const void *data,
                                      UINT size);
  void(STDMETHODCALLTYPE *EndEvent)(ID3D12VideoDecodeCommandList1 *This);
  void(STDMETHODCALLTYPE *DecodeFrame)(
      ID3D12VideoDecodeCommandList1 *This, ID3D12VideoDecoder *decoder,
      const D3D12_VIDEO_DECODE_OUTPUT_STREAM_ARGUMENTS *output_arguments,
      const D3D12_VIDEO_DECODE_INPUT_STREAM_ARGUMENTS *input_arguments);
  void(STDMETHODCALLTYPE *WriteBufferImmediate)(
      ID3D12VideoDecodeCommandList1 *This, UINT count,
      const D3D12_WRITEBUFFERIMMEDIATE_PARAMETER *params,
      const D3D12_WRITEBUFFERIMMEDIATE_MODE *modes);
...
#define ID3D12VideoDecodeCommandList1_Release(This)                            \
  (This)->lpVtbl->Release(This)
/*** ID3D12Object methods ***/
#define ID3D12VideoDecodeCommandList1_GetPrivateData(This, guid, data_size,    \
                                                     data)                     \
  (This)->lpVtbl->GetPrivateData(This, guid, data_size, data)
#define ID3D12VideoDecodeCommandList1_SetPrivateData(This, guid, data_size,    \
                                                     data)                     \
  (This)->lpVtbl->SetPrivateData(This, guid, data_size, data)
#define ID3D12VideoDecodeCommandList1_SetPrivateDataInterface(This, guid,      \
                                                              data)            \
  (This)->lpVtbl->SetPrivateDataInterface(This, guid, data)
#define ID3D12VideoDecodeCommandList1_SetName(This, name)                      \
  (This)->lpVtbl->SetName(This, name)
/*** ID3D12DeviceChild methods ***/
#define ID3D12VideoDecodeCommandList1_GetDevice(This, riid, device)            \
  (This)->lpVtbl->GetDevice(This, riid, device)
/*** ID3D12CommandList methods ***/
...
#define ID3D12VideoDecodeCommandList1_Reset(This, allocator)                   \
  (This)->lpVtbl->Reset(This, allocator)
#define ID3D12VideoDecodeCommandList1_ClearState(This)                         \
  (This)->lpVtbl->ClearState(This)
#define ID3D12VideoDecodeCommandList1_ResourceBarrier(This, barriers_count,    \
                                                      barriers)                \
  (This)->lpVtbl->ResourceBarrier(This, barriers_count, barriers)
#define ID3D12VideoDecodeCommandList1_DiscardResource(This, resource, region)  \
  (This)->lpVtbl->DiscardResource(This, resource, region)
#define ID3D12VideoDecodeCommandList1_BeginQuery(This, query_heap, type,       \
                                                 index)                        \
  (This)->lpVtbl->BeginQuery(This, query_heap, type, index)
#define ID3D12VideoDecodeCommandList1_EndQuery(This, query_heap, type, index)  \
  (This)->lpVtbl->EndQuery(This, query_heap, type, index)
#define ID3D12VideoDecodeCommandList1_ResolveQueryData(                        \
    This, query_heap, type, start_index, queries_count, destination_buffer,    \
    aligned_destination_buffer_offset)                                         \
  (This)->lpVtbl->ResolveQueryData(This, query_heap, type, start_index,        \
                                   queries_count, destination_buffer,          \
                                   aligned_destination_buffer_offset)
#define ID3D12VideoDecodeCommandList1_SetPredication(                          \
    This, buffer, aligned_buffer_offset, operation)                            \
  (This)->lpVtbl->SetPredication(This, buffer, aligned_buffer_offset, operation)
#define ID3D12VideoDecodeCommandList1_SetMarker(This, metadata, data, size)    \
  (This)->lpVtbl->SetMarker(This, metadata, data, size)
#define ID3D12VideoDecodeCommandList1_BeginEvent(This, metadata, data, size)   \
  (This)->lpVtbl->BeginEvent(This, metadata, data, size)
#define ID3D12VideoDecodeCommandList1_EndEvent(This)                           \
  (This)->lpVtbl->EndEvent(This)
#define ID3D12VideoDecodeCommandList1_DecodeFrame(                             \
    This, decoder, output_arguments, input_arguments)                          \
  (This)->lpVtbl->DecodeFrame(This, decoder, output_arguments, input_arguments)
#define ID3D12VideoDecodeCommandList1_WriteBufferImmediate(This, count,        \
                                                           params, modes)      \
  (This)->lpVtbl->WriteBufferImmediate(This, count, params, modes)
/*** ID3D12VideoDecodeCommandList1 methods ***/
#define ID3D12VideoDecodeCommandList1_DecodeFrame1(                            \
    This, decoder, output_arguments, input_arguments)                          \
  (This)->lpVtbl->DecodeFrame1(This, decoder, output_arguments, input_arguments)
#else
/*** IUnknown methods ***/
static inline HRESULT ID3D12VideoDecodeCommandList1_QueryInterface(
    ID3D12VideoDecodeCommandList1 *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
ID3D12VideoDecodeCommandList1_AddRef(ID3D12VideoDecodeCommandList1 *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
ID3D12VideoDecodeCommandList1_Release(ID3D12VideoDecodeCommandList1 *This) {
  return This->lpVtbl->Release(This);
}
/*** ID3D12Object methods ***/
static inline HRESULT ID3D12VideoDecodeCommandList1_GetPrivateData(
    ID3D12VideoDecodeCommandList1 *This, REFGUID guid, UINT *data_size,
    void *data) {
  return This->lpVtbl->GetPrivateData(This, guid, data_size, data);
}
static inline HRESULT ID3D12VideoDecodeCommandList1_SetPrivateData(
    ID3D12VideoDecodeCommandList1 *This, REFGUID guid, UINT data_size,
    const void *data) {
  return This->lpVtbl->SetPrivateData(This, guid, data_size, data);
}
static inline HRESULT ID3D12VideoDecodeCommandList1_SetPrivateDataInterface(
    ID3D12VideoDecodeCommandList1 *This, REFGUID guid, const IUnknown *data) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, data);
}
static inline HRESULT
ID3D12VideoDecodeCommandList1_SetName(ID3D12VideoDecodeCommandList1 *This,
                                      const WCHAR *name) {
  return This->lpVtbl->SetName(This, name);
}
/*** ID3D12DeviceChild methods ***/
static inline HRESULT
ID3D12VideoDecodeCommandList1_GetDevice(ID3D12VideoDecodeCommandList1 *This,
                                        REFIID riid, void **device) {
  return This->lpVtbl->GetDevice(This, riid, device);
}
/*** ID3D12CommandList methods ***/
static inline D3D12_COMMAND_LIST_TYPE
ID3D12VideoDecodeCommandList1_GetType(ID3D12VideoDecodeCommandList1 *This) {
  return This->lpVtbl->GetType(This);
}
/*** ID3D12VideoDecodeCommandList methods ***/
static inline HRESULT
ID3D12VideoDecodeCommandList1_Close(ID3D12VideoDecodeCommandList1 *This) {
  return This->lpVtbl->Close(This);
}
static inline HRESULT
ID3D12VideoDecodeCommandList1_Reset(ID3D12VideoDecodeCommandList1 *This,
                                    ID3D12CommandAllocator *allocator) {
  return This->lpVtbl->Reset(This, allocator);
}
static inline void
ID3D12VideoDecodeCommandList1_ClearState(ID3D12VideoDecodeCommandList1 *This) {
  This->lpVtbl->ClearState(This);
}
...
static inline void ID3D12VideoDecodeCommandList1_DiscardResource(
    ID3D12VideoDecodeCommandList1 *This, ID3D12Resource *resource,
    const D3D12_DISCARD_REGION *region) {
  This->lpVtbl->DiscardResource(This, resource, region);
}
static inline void
ID3D12VideoDecodeCommandList1_BeginQuery(ID3D12VideoDecodeCommandList1 *This,
                                         ID3D12QueryHeap *query_heap,
                                         D3D12_QUERY_TYPE type, UINT index) {
  This->lpVtbl->BeginQuery(This, query_heap, type, index);
}
static inline void
ID3D12VideoDecodeCommandList1_EndQuery(ID3D12VideoDecodeCommandList1 *This,
                                       ID3D12QueryHeap *query_heap,
                                       D3D12_QUERY_TYPE type, UINT index) {
  This->lpVtbl->EndQuery(This, query_heap, type, index);
}
static inline void ID3D12VideoDecodeCommandList1_ResolveQueryData(
    ID3D12VideoDecodeCommandList1 *This, ID3D12QueryHeap *query_heap,
    D3D12_QUERY_TYPE type, UINT start_index, UINT queries_count,
    ID3D12Resource *destination_buffer,
    UINT64 aligned_destination_buffer_offset) {
...
static inline void ID3D12VideoDecodeCommandList1_SetPredication(
    ID3D12VideoDecodeCommandList1 *This, ID3D12Resource *buffer,
    UINT64 aligned_buffer_offset, D3D12_PREDICATION_OP operation) {
  This->lpVtbl->SetPredication(This, buffer, aligned_buffer_offset, operation);
}
static inline void
ID3D12VideoDecodeCommandList1_SetMarker(ID3D12VideoDecodeCommandList1 *This,
                                        UINT metadata, const void *data,
                                        UINT size) {
  This->lpVtbl->SetMarker(This, metadata, data, size);
}
static inline void
ID3D12VideoDecodeCommandList1_BeginEvent(ID3D12VideoDecodeCommandList1 *This,
                                         UINT metadata, const void *data,
                                         UINT size) {
  This->lpVtbl->BeginEvent(This, metadata, data, size);
}
static inline void
ID3D12VideoDecodeCommandList1_EndEvent(ID3D12VideoDecodeCommandList1 *This) {
  This->lpVtbl->EndEvent(This);
}
static inline void ID3D12VideoDecodeCommandList1_DecodeFrame(
    ID3D12VideoDecodeCommandList1 *This, ID3D12VideoDecoder *decoder,
    const D3D12_VIDEO_DECODE_OUTPUT_STREAM_ARGUMENTS *output_arguments,
    const D3D12_VIDEO_DECODE_INPUT_STREAM_ARGUMENTS *input_arguments) {
  This->lpVtbl->DecodeFrame(This, decoder, output_arguments, input_arguments);
}
static inline void ID3D12VideoDecodeCommandList1_WriteBufferImmediate(
    ID3D12VideoDecodeCommandList1 *This, UINT count,
    const D3D12_WRITEBUFFERIMMEDIATE_PARAMETER *params,
    const D3D12_WRITEBUFFERIMMEDIATE_MODE *modes) {
  This->lpVtbl->WriteBufferImmediate(This, count, params, modes);
...
/*** ID3D12VideoDecodeCommandList1 methods ***/
static inline void ID3D12VideoDecodeCommandList1_DecodeFrame1(
    ID3D12VideoDecodeCommandList1 *This, ID3D12VideoDecoder *decoder,
    const D3D12_VIDEO_DECODE_OUTPUT_STREAM_ARGUMENTS1 *output_arguments,
    const D3D12_VIDEO_DECODE_INPUT_STREAM_ARGUMENTS *input_arguments) {
  This->lpVtbl->DecodeFrame1(This, decoder, output_arguments, input_arguments);
...
typedef enum D3D12_VIDEO_MOTION_ESTIMATOR_SEARCH_BLOCK_SIZE_FLAGS {
  ...
  D3D12_VIDEO_MOTION_ESTIMATOR_SEARCH_BLOCK_SIZE_FLAG_16X16 = 1
...
DEFINE_GUID(IID_ID3D12VideoMotionEstimator, 0x33fdae0e, 0x098b, 0x428f, 0x87,
...
#else
  virtual D3D12_VIDEO_MOTION_ESTIMATOR_DESC STDMETHODCALLTYPE GetDesc() = 0;
#endif
  virtual HRESULT STDMETHODCALLTYPE GetProtectedResourceSession(
      REFIID riid, void **protected_session) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D12VideoMotionEstimator, 0x33fdae0e, 0x098b, 0x428f, 0x87,
                0xbb, 0x34, 0xb6, 0x95, 0xde, 0x08, 0xf8)
#endif
#else
typedef struct ID3D12VideoMotionEstimatorVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D12VideoMotionEstimator *This,
                                             REFIID riid, void **ppvObject);
  ...
  /*** ID3D12Object methods ***/
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(ID3D12VideoMotionEstimator *This,
                                             REFGUID guid, UINT *data_size,
                                             void *data);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D12VideoMotionEstimator *This,
                                             REFGUID guid, UINT data_size,
                                             const void *data);
  HRESULT(STDMETHODCALLTYPE *SetPrivateDataInterface)(
      ID3D12VideoMotionEstimator *This, REFGUID guid, const IUnknown *data);
  HRESULT(STDMETHODCALLTYPE *SetName)(ID3D12VideoMotionEstimator *This,
                                      const WCHAR *name);
  /*** ID3D12DeviceChild methods ***/
  HRESULT(STDMETHODCALLTYPE *GetDevice)(ID3D12VideoMotionEstimator *This,
                                        REFIID riid, void **device);
  ...
  HRESULT(STDMETHODCALLTYPE *GetProtectedResourceSession)(
      ID3D12VideoMotionEstimator *This, REFIID riid, void **protected_session);
  END_INTERFACE
...
/*** ID3D12Object methods ***/
#define ID3D12VideoMotionEstimator_GetPrivateData(This, guid, data_size, data) \
  (This)->lpVtbl->GetPrivateData(This, guid, data_size, data)
#define ID3D12VideoMotionEstimator_SetPrivateData(This, guid, data_size, data) \
  (This)->lpVtbl->SetPrivateData(This, guid, data_size, data)
#define ID3D12VideoMotionEstimator_SetPrivateDataInterface(This, guid, data)   \
  (This)->lpVtbl->SetPrivateDataInterface(This, guid, data)
#define ID3D12VideoMotionEstimator_SetName(This, name)                         \
  (This)->lpVtbl->SetName(This, name)
/*** ID3D12DeviceChild methods ***/
#define ID3D12VideoMotionEstimator_GetDevice(This, riid, device)               \
  (This)->lpVtbl->GetDevice(This, riid, device)
/*** ID3D12VideoMotionEstimator methods ***/
#define ID3D12VideoMotionEstimator_GetDesc(This)                               \
  ID3D12VideoMotionEstimator_GetDesc_define_WIDL_C_INLINE_WRAPPERS_for_aggregate_return_support
#define ID3D12VideoMotionEstimator_GetProtectedResourceSession(                \
    This, riid, protected_session)                                             \
  (This)->lpVtbl->GetProtectedResourceSession(This, riid, protected_session)
#else
/*** IUnknown methods ***/
static inline HRESULT
ID3D12VideoMotionEstimator_QueryInterface(ID3D12VideoMotionEstimator *This,
                                          REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
ID3D12VideoMotionEstimator_AddRef(ID3D12VideoMotionEstimator *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
ID3D12VideoMotionEstimator_Release(ID3D12VideoMotionEstimator *This) {
  return This->lpVtbl->Release(This);
}
/*** ID3D12Object methods ***/
static inline HRESULT
ID3D12VideoMotionEstimator_GetPrivateData(ID3D12VideoMotionEstimator *This,
                                          REFGUID guid, UINT *data_size,
                                          void *data) {
  return This->lpVtbl->GetPrivateData(This, guid, data_size, data);
}
static inline HRESULT
ID3D12VideoMotionEstimator_SetPrivateData(ID3D12VideoMotionEstimator *This,
                                          REFGUID guid, UINT data_size,
                                          const void *data) {
  return This->lpVtbl->SetPrivateData(This, guid, data_size, data);
}
static inline HRESULT ID3D12VideoMotionEstimator_SetPrivateDataInterface(
    ID3D12VideoMotionEstimator *This, REFGUID guid, const IUnknown *data) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, data);
}
static inline HRESULT
ID3D12VideoMotionEstimator_SetName(ID3D12VideoMotionEstimator *This,
                                   const WCHAR *name) {
  return This->lpVtbl->SetName(This, name);
}
/*** ID3D12DeviceChild methods ***/
static inline HRESULT
ID3D12VideoMotionEstimator_GetDevice(ID3D12VideoMotionEstimator *This,
                                     REFIID riid, void **device) {
  return This->lpVtbl->GetDevice(This, riid, device);
}
/*** ID3D12VideoMotionEstimator methods ***/
static inline D3D12_VIDEO_MOTION_ESTIMATOR_DESC
ID3D12VideoMotionEstimator_GetDesc(ID3D12VideoMotionEstimator *This) {
  D3D12_VIDEO_MOTION_ESTIMATOR_DESC __ret;
  return *This->lpVtbl->GetDesc(This, &__ret);
}
static inline HRESULT ID3D12VideoMotionEstimator_GetProtectedResourceSession(
    ID3D12VideoMotionEstimator *This, REFIID riid, void **protected_session) {
  return This->lpVtbl->GetProtectedResourceSession(This, riid,
                                                   protected_session);
}
#endif
#endif
...
DEFINE_GUID(IID_ID3D12VideoMotionVectorHeap, 0x5be17987, 0x743a, 0x4061, 0x83,
...
#else
  virtual D3D12_VIDEO_MOTION_VECTOR_HEAP_DESC STDMETHODCALLTYPE GetDesc() = 0;
#endif
  virtual HRESULT STDMETHODCALLTYPE GetProtectedResourceSession(
      REFIID riid, void **protected_session) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D12VideoMotionVectorHeap, 0x5be17987, 0x743a, 0x4061, 0x83,
                0x4b, 0x23, 0xd2, 0x2d, 0xae, 0xa5, 0x05)
#endif
#else
typedef struct ID3D12VideoMotionVectorHeapVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D12VideoMotionVectorHeap *This,
                                             REFIID riid, void **ppvObject);
  ...
  /*** ID3D12Object methods ***/
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(ID3D12VideoMotionVectorHeap *This,
                                             REFGUID guid, UINT *data_size,
                                             void *data);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D12VideoMotionVectorHeap *This,
                                             REFGUID guid, UINT data_size,
                                             const void *data);
  HRESULT(STDMETHODCALLTYPE *SetPrivateDataInterface)(
      ID3D12VideoMotionVectorHeap *This, REFGUID guid, const IUnknown *data);
  HRESULT(STDMETHODCALLTYPE *SetName)(ID3D12VideoMotionVectorHeap *This,
                                      const WCHAR *name);
  /*** ID3D12DeviceChild methods ***/
  HRESULT(STDMETHODCALLTYPE *GetDevice)(ID3D12VideoMotionVectorHeap *This,
                                        REFIID riid, void **device);
  ...
  D3D12_VIDEO_MOTION_VECTOR_HEAP_DESC *(STDMETHODCALLTYPE *GetDesc)(
      ...
      D3D12_VIDEO_MOTION_VECTOR_HEAP_DESC *__ret);
  HRESULT(STDMETHODCALLTYPE *GetProtectedResourceSession)(
      ID3D12VideoMotionVectorHeap *This, REFIID riid, void **protected_session);
  END_INTERFACE
...
/*** ID3D12Object methods ***/
#define ID3D12VideoMotionVectorHeap_GetPrivateData(This, guid, data_size,      \
                                                   data)                       \
  (This)->lpVtbl->GetPrivateData(This, guid, data_size, data)
#define ID3D12VideoMotionVectorHeap_SetPrivateData(This, guid, data_size,      \
                                                   data)                       \
  (This)->lpVtbl->SetPrivateData(This, guid, data_size, data)
#define ID3D12VideoMotionVectorHeap_SetPrivateDataInterface(This, guid, data)  \
  (This)->lpVtbl->SetPrivateDataInterface(This, guid, data)
#define ID3D12VideoMotionVectorHeap_SetName(This, name)                        \
  (This)->lpVtbl->SetName(This, name)
/*** ID3D12DeviceChild methods ***/
#define ID3D12VideoMotionVectorHeap_GetDevice(This, riid, device)              \
  (This)->lpVtbl->GetDevice(This, riid, device)
/*** ID3D12VideoMotionVectorHeap methods ***/
#define ID3D12VideoMotionVectorHeap_GetDesc(This)                              \
  ID3D12VideoMotionVectorHeap_GetDesc_define_WIDL_C_INLINE_WRAPPERS_for_aggregate_return_support
#define ID3D12VideoMotionVectorHeap_GetProtectedResourceSession(               \
    This, riid, protected_session)                                             \
  (This)->lpVtbl->GetProtectedResourceSession(This, riid, protected_session)
#else
/*** IUnknown methods ***/
static inline HRESULT
ID3D12VideoMotionVectorHeap_QueryInterface(ID3D12VideoMotionVectorHeap *This,
                                           REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
ID3D12VideoMotionVectorHeap_AddRef(ID3D12VideoMotionVectorHeap *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
ID3D12VideoMotionVectorHeap_Release(ID3D12VideoMotionVectorHeap *This) {
  return This->lpVtbl->Release(This);
}
/*** ID3D12Object methods ***/
static inline HRESULT
ID3D12VideoMotionVectorHeap_GetPrivateData(ID3D12VideoMotionVectorHeap *This,
                                           REFGUID guid, UINT *data_size,
                                           void *data) {
  return This->lpVtbl->GetPrivateData(This, guid, data_size, data);
}
static inline HRESULT
ID3D12VideoMotionVectorHeap_SetPrivateData(ID3D12VideoMotionVectorHeap *This,
                                           REFGUID guid, UINT data_size,
                                           const void *data) {
  return This->lpVtbl->SetPrivateData(This, guid, data_size, data);
}
static inline HRESULT ID3D12VideoMotionVectorHeap_SetPrivateDataInterface(
    ID3D12VideoMotionVectorHeap *This, REFGUID guid, const IUnknown *data) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, data);
}
static inline HRESULT
ID3D12VideoMotionVectorHeap_SetName(ID3D12VideoMotionVectorHeap *This,
                                    const WCHAR *name) {
  return This->lpVtbl->SetName(This, name);
}
/*** ID3D12DeviceChild methods ***/
static inline HRESULT
ID3D12VideoMotionVectorHeap_GetDevice(ID3D12VideoMotionVectorHeap *This,
                                      REFIID riid, void **device) {
  return This->lpVtbl->GetDevice(This, riid, device);
}
/*** ID3D12VideoMotionVectorHeap methods ***/
static inline D3D12_VIDEO_MOTION_VECTOR_HEAP_DESC
ID3D12VideoMotionVectorHeap_GetDesc(ID3D12VideoMotionVectorHeap *This) {
  D3D12_VIDEO_MOTION_VECTOR_HEAP_DESC __ret;
  return *This->lpVtbl->GetDesc(This, &__ret);
}
static inline HRESULT ID3D12VideoMotionVectorHeap_GetProtectedResourceSession(
    ID3D12VideoMotionVectorHeap *This, REFIID riid, void **protected_session) {
  return This->lpVtbl->GetProtectedResourceSession(This, riid,
                                                   protected_session);
}
...
DEFINE_GUID(IID_ID3D12VideoDevice1, 0x981611ad, 0xa144, 0x4c83, 0x98, 0x90,
...
ID3D12VideoDevice1 : public ID3D12VideoDevice {
  virtual HRESULT STDMETHODCALLTYPE CreateVideoMotionEstimator(
      ...
      ID3D12ProtectedResourceSession *protected_resource_session, REFIID riid,
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D12VideoDevice1, 0x981611ad, 0xa144, 0x4c83, 0x98, 0x90,
                0xf3, 0x0e, 0x26, 0xd6, 0x58, 0xab)
#endif
#else
typedef struct ID3D12VideoDevice1Vtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D12VideoDevice1 *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(ID3D12VideoDevice1 *This);
  ULONG(STDMETHODCALLTYPE *Release)(ID3D12VideoDevice1 *This);
  /*** ID3D12VideoDevice methods ***/
  HRESULT(STDMETHODCALLTYPE *CheckFeatureSupport)(
      ID3D12VideoDevice1 *This, D3D12_FEATURE_VIDEO feature_video,
      void *feature_support_data, UINT feature_support_data_size);
  HRESULT(STDMETHODCALLTYPE *CreateVideoDecoder)(
  ...
  HRESULT(STDMETHODCALLTYPE *CreateVideoDecoderHeap)(
      ...
      void **video_decoder_heap);
  HRESULT(STDMETHODCALLTYPE *CreateVideoProcessor)(
      ID3D12VideoDevice1 *This, UINT node_mask,
      const D3D12_VIDEO_PROCESS_OUTPUT_STREAM_DESC *output_stream_desc,
      UINT input_stream_descs_count,
      const D3D12_VIDEO_PROCESS_INPUT_STREAM_DESC *input_stream_descs,
      REFIID riid, void **video_processor);
  ...
  HRESULT(STDMETHODCALLTYPE *CreateVideoMotionEstimator)(
      ID3D12VideoDevice1 *This, const D3D12_VIDEO_MOTION_ESTIMATOR_DESC *desc,
      ID3D12ProtectedResourceSession *protected_resource_session, REFIID riid,
      void **video_motion_estimator);
  HRESULT(STDMETHODCALLTYPE *CreateVideoMotionVectorHeap)(
      ID3D12VideoDevice1 *This, const D3D12_VIDEO_MOTION_VECTOR_HEAP_DESC *desc,
      ID3D12ProtectedResourceSession *protected_resource_session, REFIID riid,
      void **video_motion_vector_heap);
  END_INTERFACE
} ID3D12VideoDevice1Vtbl;
interface ID3D12VideoDevice1 { CONST_VTBL ID3D12VideoDevice1Vtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** ID3D12VideoDevice methods ***/
#define ID3D12VideoDevice1_CheckFeatureSupport(                                \
    This, feature_video, feature_support_data, feature_support_data_size)      \
  (This)->lpVtbl->CheckFeatureSupport(                                         \
      This, feature_video, feature_support_data, feature_support_data_size)
#define ID3D12VideoDevice1_CreateVideoDecoder(This, desc, riid, video_decoder) \
  (This)->lpVtbl->CreateVideoDecoder(This, desc, riid, video_decoder)
#define ID3D12VideoDevice1_CreateVideoDecoderHeap(                             \
    This, video_decoder_heap_desc, riid, video_decoder_heap)                   \
  (This)->lpVtbl->CreateVideoDecoderHeap(This, video_decoder_heap_desc, riid,  \
                                         video_decoder_heap)
#define ID3D12VideoDevice1_CreateVideoProcessor(                               \
    This, node_mask, output_stream_desc, input_stream_descs_count,             \
    input_stream_descs, riid, video_processor)                                 \
  (This)->lpVtbl->CreateVideoProcessor(                                        \
      This, node_mask, output_stream_desc, input_stream_descs_count,           \
      input_stream_descs, riid, video_processor)
/*** ID3D12VideoDevice1 methods ***/
#define ID3D12VideoDevice1_CreateVideoMotionEstimator(                         \
    This, desc, protected_resource_session, riid, video_motion_estimator)      \
  (This)->lpVtbl->CreateVideoMotionEstimator(                                  \
      This, desc, protected_resource_session, riid, video_motion_estimator)
#define ID3D12VideoDevice1_CreateVideoMotionVectorHeap(                        \
    This, desc, protected_resource_session, riid, video_motion_vector_heap)    \
  (This)->lpVtbl->CreateVideoMotionVectorHeap(                                 \
      This, desc, protected_resource_session, riid, video_motion_vector_heap)
#else
/*** IUnknown methods ***/
static inline HRESULT
ID3D12VideoDevice1_QueryInterface(ID3D12VideoDevice1 *This, REFIID riid,
                                  void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ID3D12VideoDevice methods ***/
static inline HRESULT ID3D12VideoDevice1_CheckFeatureSupport(
    ID3D12VideoDevice1 *This, D3D12_FEATURE_VIDEO feature_video,
    void *feature_support_data, UINT feature_support_data_size) {
  return This->lpVtbl->CheckFeatureSupport(
      This, feature_video, feature_support_data, feature_support_data_size);
...
static inline HRESULT
ID3D12VideoDevice1_CreateVideoDecoder(ID3D12VideoDevice1 *This,
                                      const D3D12_VIDEO_DECODER_DESC *desc,
                                      REFIID riid, void **video_decoder) {
  return This->lpVtbl->CreateVideoDecoder(This, desc, riid, video_decoder);
}
static inline HRESULT ID3D12VideoDevice1_CreateVideoDecoderHeap(
    ID3D12VideoDevice1 *This,
    const D3D12_VIDEO_DECODER_HEAP_DESC *video_decoder_heap_desc, REFIID riid,
    void **video_decoder_heap) {
  return This->lpVtbl->CreateVideoDecoderHeap(This, video_decoder_heap_desc,
...
static inline HRESULT ID3D12VideoDevice1_CreateVideoProcessor(
    ID3D12VideoDevice1 *This, UINT node_mask,
    const D3D12_VIDEO_PROCESS_OUTPUT_STREAM_DESC *output_stream_desc,
    UINT input_stream_descs_count,
    const D3D12_VIDEO_PROCESS_INPUT_STREAM_DESC *input_stream_descs,
...
/*** ID3D12VideoDevice1 methods ***/
static inline HRESULT ID3D12VideoDevice1_CreateVideoMotionEstimator(
    ID3D12VideoDevice1 *This, const D3D12_VIDEO_MOTION_ESTIMATOR_DESC *desc,
    ID3D12ProtectedResourceSession *protected_resource_session, REFIID riid,
    void **video_motion_estimator) {
  return This->lpVtbl->CreateVideoMotionEstimator(
      This, desc, protected_resource_session, riid, video_motion_estimator);
}
static inline HRESULT ID3D12VideoDevice1_CreateVideoMotionVectorHeap(
    ID3D12VideoDevice1 *This, const D3D12_VIDEO_MOTION_VECTOR_HEAP_DESC *desc,
    ID3D12ProtectedResourceSession *protected_resource_session, REFIID riid,
    void **video_motion_vector_heap) {
  return This->lpVtbl->CreateVideoMotionVectorHeap(
      This, desc, protected_resource_session, riid, video_motion_vector_heap);
}
#endif
#endif
...
DEFINE_GUID(IID_ID3D12VideoEncodeCommandList, 0x8455293a, 0x0cbd, 0x4831, 0x9b,
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D12VideoEncodeCommandList, 0x8455293a, 0x0cbd, 0x4831, 0x9b,
                0x39, 0xfb, 0xdb, 0xab, 0x72, 0x47, 0x23)
#endif
#else
typedef struct ID3D12VideoEncodeCommandListVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D12VideoEncodeCommandList *This,
                                             REFIID riid, void **ppvObject);
  ...
  /*** ID3D12Object methods ***/
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(ID3D12VideoEncodeCommandList *This,
                                             REFGUID guid, UINT *data_size,
                                             void *data);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D12VideoEncodeCommandList *This,
                                             REFGUID guid, UINT data_size,
                                             const void *data);
  HRESULT(STDMETHODCALLTYPE *SetPrivateDataInterface)(
      ID3D12VideoEncodeCommandList *This, REFGUID guid, const IUnknown *data);
  HRESULT(STDMETHODCALLTYPE *SetName)(ID3D12VideoEncodeCommandList *This,
                                      const WCHAR *name);
  /*** ID3D12DeviceChild methods ***/
  HRESULT(STDMETHODCALLTYPE *GetDevice)(ID3D12VideoEncodeCommandList *This,
                                        REFIID riid, void **device);
  /*** ID3D12CommandList methods ***/
  D3D12_COMMAND_LIST_TYPE(STDMETHODCALLTYPE *GetType)(
  ...
  HRESULT(STDMETHODCALLTYPE *Reset)(ID3D12VideoEncodeCommandList *This,
                                    ID3D12CommandAllocator *allocator);
  void(STDMETHODCALLTYPE *ClearState)(ID3D12VideoEncodeCommandList *This);
  void(STDMETHODCALLTYPE *ResourceBarrier)(
      ID3D12VideoEncodeCommandList *This, UINT barriers_count,
      const D3D12_RESOURCE_BARRIER *barriers);
  void(STDMETHODCALLTYPE *DiscardResource)(ID3D12VideoEncodeCommandList *This,
                                           ID3D12Resource *resource,
                                           const D3D12_DISCARD_REGION *region);
  void(STDMETHODCALLTYPE *BeginQuery)(ID3D12VideoEncodeCommandList *This,
                                      ID3D12QueryHeap *query_heap,
                                      D3D12_QUERY_TYPE type, UINT index);
  void(STDMETHODCALLTYPE *EndQuery)(ID3D12VideoEncodeCommandList *This,
                                    ID3D12QueryHeap *query_heap,
                                    D3D12_QUERY_TYPE type, UINT index);
  void(STDMETHODCALLTYPE *ResolveQueryData)(
      ID3D12VideoEncodeCommandList *This, ID3D12QueryHeap *query_heap,
      D3D12_QUERY_TYPE type, UINT start_index, UINT queries_count,
      ID3D12Resource *destination_buffer,
      UINT64 aligned_destination_buffer_offset);
  void(STDMETHODCALLTYPE *SetPredication)(ID3D12VideoEncodeCommandList *This,
                                          ID3D12Resource *buffer,
                                          UINT64 aligned_buffer_offset,
                                          D3D12_PREDICATION_OP operation);
  void(STDMETHODCALLTYPE *SetMarker)(ID3D12VideoEncodeCommandList *This,
                                     UINT metadata, const void *data,
                                     UINT size);
  void(STDMETHODCALLTYPE *BeginEvent)(ID3D12VideoEncodeCommandList *This,
                                      UINT metadata, const void *data,
                                      UINT size);
  ...
  void(STDMETHODCALLTYPE *WriteBufferImmediate)(
      ID3D12VideoEncodeCommandList *This, UINT count,
      const D3D12_WRITEBUFFERIMMEDIATE_PARAMETER *params,
      const D3D12_WRITEBUFFERIMMEDIATE_MODE *modes);
...
/*** ID3D12Object methods ***/
#define ID3D12VideoEncodeCommandList_GetPrivateData(This, guid, data_size,     \
                                                    data)                      \
  (This)->lpVtbl->GetPrivateData(This, guid, data_size, data)
#define ID3D12VideoEncodeCommandList_SetPrivateData(This, guid, data_size,     \
                                                    data)                      \
  (This)->lpVtbl->SetPrivateData(This, guid, data_size, data)
#define ID3D12VideoEncodeCommandList_SetPrivateDataInterface(This, guid, data) \
  (This)->lpVtbl->SetPrivateDataInterface(This, guid, data)
#define ID3D12VideoEncodeCommandList_SetName(This, name)                       \
  (This)->lpVtbl->SetName(This, name)
/*** ID3D12DeviceChild methods ***/
#define ID3D12VideoEncodeCommandList_GetDevice(This, riid, device)             \
  (This)->lpVtbl->GetDevice(This, riid, device)
/*** ID3D12CommandList methods ***/
...
#define ID3D12VideoEncodeCommandList_Reset(This, allocator)                    \
  (This)->lpVtbl->Reset(This, allocator)
#define ID3D12VideoEncodeCommandList_ClearState(This)                          \
  (This)->lpVtbl->ClearState(This)
#define ID3D12VideoEncodeCommandList_ResourceBarrier(This, barriers_count,     \
                                                     barriers)                 \
  (This)->lpVtbl->ResourceBarrier(This, barriers_count, barriers)
#define ID3D12VideoEncodeCommandList_DiscardResource(This, resource, region)   \
  (This)->lpVtbl->DiscardResource(This, resource, region)
#define ID3D12VideoEncodeCommandList_BeginQuery(This, query_heap, type, index) \
  (This)->lpVtbl->BeginQuery(This, query_heap, type, index)
#define ID3D12VideoEncodeCommandList_EndQuery(This, query_heap, type, index)   \
  (This)->lpVtbl->EndQuery(This, query_heap, type, index)
#define ID3D12VideoEncodeCommandList_ResolveQueryData(                         \
    This, query_heap, type, start_index, queries_count, destination_buffer,    \
    aligned_destination_buffer_offset)                                         \
  (This)->lpVtbl->ResolveQueryData(This, query_heap, type, start_index,        \
                                   queries_count, destination_buffer,          \
                                   aligned_destination_buffer_offset)
#define ID3D12VideoEncodeCommandList_SetPredication(                           \
    This, buffer, aligned_buffer_offset, operation)                            \
  (This)->lpVtbl->SetPredication(This, buffer, aligned_buffer_offset, operation)
#define ID3D12VideoEncodeCommandList_SetMarker(This, metadata, data, size)     \
  (This)->lpVtbl->SetMarker(This, metadata, data, size)
#define ID3D12VideoEncodeCommandList_BeginEvent(This, metadata, data, size)    \
  (This)->lpVtbl->BeginEvent(This, metadata, data, size)
#define ID3D12VideoEncodeCommandList_EndEvent(This)                            \
  (This)->lpVtbl->EndEvent(This)
#define ID3D12VideoEncodeCommandList_EstimateMotion(                           \
    This, motion_estimator, output_arguments, input_arguments)                 \
  (This)->lpVtbl->EstimateMotion(This, motion_estimator, output_arguments,     \
                                 input_arguments)
#define ID3D12VideoEncodeCommandList_ResolveMotionVectorHeap(                  \
    This, output_arguments, input_arguments)                                   \
  (This)->lpVtbl->ResolveMotionVectorHeap(This, output_arguments,              \
                                          input_arguments)
#define ID3D12VideoEncodeCommandList_WriteBufferImmediate(This, count, params, \
                                                          modes)               \
  (This)->lpVtbl->WriteBufferImmediate(This, count, params, modes)
#define ID3D12VideoEncodeCommandList_SetProtectedResourceSession(              \
    This, protected_resource_session)                                          \
  (This)->lpVtbl->SetProtectedResourceSession(This, protected_resource_session)
#else
/*** IUnknown methods ***/
static inline HRESULT
ID3D12VideoEncodeCommandList_QueryInterface(ID3D12VideoEncodeCommandList *This,
                                            REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
ID3D12VideoEncodeCommandList_AddRef(ID3D12VideoEncodeCommandList *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
ID3D12VideoEncodeCommandList_Release(ID3D12VideoEncodeCommandList *This) {
  return This->lpVtbl->Release(This);
}
/*** ID3D12Object methods ***/
static inline HRESULT
ID3D12VideoEncodeCommandList_GetPrivateData(ID3D12VideoEncodeCommandList *This,
                                            REFGUID guid, UINT *data_size,
                                            void *data) {
  return This->lpVtbl->GetPrivateData(This, guid, data_size, data);
}
static inline HRESULT
ID3D12VideoEncodeCommandList_SetPrivateData(ID3D12VideoEncodeCommandList *This,
                                            REFGUID guid, UINT data_size,
                                            const void *data) {
  return This->lpVtbl->SetPrivateData(This, guid, data_size, data);
}
static inline HRESULT ID3D12VideoEncodeCommandList_SetPrivateDataInterface(
    ID3D12VideoEncodeCommandList *This, REFGUID guid, const IUnknown *data) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, data);
}
static inline HRESULT
ID3D12VideoEncodeCommandList_SetName(ID3D12VideoEncodeCommandList *This,
                                     const WCHAR *name) {
  return This->lpVtbl->SetName(This, name);
}
/*** ID3D12DeviceChild methods ***/
static inline HRESULT
ID3D12VideoEncodeCommandList_GetDevice(ID3D12VideoEncodeCommandList *This,
                                       REFIID riid, void **device) {
  return This->lpVtbl->GetDevice(This, riid, device);
}
/*** ID3D12CommandList methods ***/
static inline D3D12_COMMAND_LIST_TYPE
ID3D12VideoEncodeCommandList_GetType(ID3D12VideoEncodeCommandList *This) {
  return This->lpVtbl->GetType(This);
}
/*** ID3D12VideoEncodeCommandList methods ***/
static inline HRESULT
ID3D12VideoEncodeCommandList_Close(ID3D12VideoEncodeCommandList *This) {
  return This->lpVtbl->Close(This);
}
static inline HRESULT
ID3D12VideoEncodeCommandList_Reset(ID3D12VideoEncodeCommandList *This,
                                   ID3D12CommandAllocator *allocator) {
  return This->lpVtbl->Reset(This, allocator);
}
static inline void
ID3D12VideoEncodeCommandList_ClearState(ID3D12VideoEncodeCommandList *This) {
  This->lpVtbl->ClearState(This);
}
...
static inline void ID3D12VideoEncodeCommandList_DiscardResource(
    ID3D12VideoEncodeCommandList *This, ID3D12Resource *resource,
    const D3D12_DISCARD_REGION *region) {
  This->lpVtbl->DiscardResource(This, resource, region);
}
static inline void
ID3D12VideoEncodeCommandList_BeginQuery(ID3D12VideoEncodeCommandList *This,
                                        ID3D12QueryHeap *query_heap,
                                        D3D12_QUERY_TYPE type, UINT index) {
  This->lpVtbl->BeginQuery(This, query_heap, type, index);
}
static inline void
ID3D12VideoEncodeCommandList_EndQuery(ID3D12VideoEncodeCommandList *This,
                                      ID3D12QueryHeap *query_heap,
                                      D3D12_QUERY_TYPE type, UINT index) {
  This->lpVtbl->EndQuery(This, query_heap, type, index);
}
static inline void ID3D12VideoEncodeCommandList_ResolveQueryData(
    ID3D12VideoEncodeCommandList *This, ID3D12QueryHeap *query_heap,
    D3D12_QUERY_TYPE type, UINT start_index, UINT queries_count,
    ID3D12Resource *destination_buffer,
    UINT64 aligned_destination_buffer_offset) {
...
static inline void ID3D12VideoEncodeCommandList_SetPredication(
    ID3D12VideoEncodeCommandList *This, ID3D12Resource *buffer,
    UINT64 aligned_buffer_offset, D3D12_PREDICATION_OP operation) {
  This->lpVtbl->SetPredication(This, buffer, aligned_buffer_offset, operation);
}
static inline void
ID3D12VideoEncodeCommandList_SetMarker(ID3D12VideoEncodeCommandList *This,
                                       UINT metadata, const void *data,
                                       UINT size) {
  This->lpVtbl->SetMarker(This, metadata, data, size);
}
static inline void
ID3D12VideoEncodeCommandList_BeginEvent(ID3D12VideoEncodeCommandList *This,
                                        UINT metadata, const void *data,
                                        UINT size) {
  This->lpVtbl->BeginEvent(This, metadata, data, size);
}
static inline void
ID3D12VideoEncodeCommandList_EndEvent(ID3D12VideoEncodeCommandList *This) {
  This->lpVtbl->EndEvent(This);
}
static inline void ID3D12VideoEncodeCommandList_EstimateMotion(
    ID3D12VideoEncodeCommandList *This,
    ID3D12VideoMotionEstimator *motion_estimator,
    const D3D12_VIDEO_MOTION_ESTIMATOR_OUTPUT *output_arguments,
    const D3D12_VIDEO_MOTION_ESTIMATOR_INPUT *input_arguments) {
...
static inline void ID3D12VideoEncodeCommandList_ResolveMotionVectorHeap(
    ID3D12VideoEncodeCommandList *This,
    const D3D12_RESOLVE_VIDEO_MOTION_VECTOR_HEAP_OUTPUT *output_arguments,
    const D3D12_RESOLVE_VIDEO_MOTION_VECTOR_HEAP_INPUT *input_arguments) {
  This->lpVtbl->ResolveMotionVectorHeap(This, output_arguments,
...
static inline void ID3D12VideoEncodeCommandList_WriteBufferImmediate(
    ID3D12VideoEncodeCommandList *This, UINT count,
    const D3D12_WRITEBUFFERIMMEDIATE_PARAMETER *params,
    const D3D12_WRITEBUFFERIMMEDIATE_MODE *modes) {
  This->lpVtbl->WriteBufferImmediate(This, count, params, modes);
}
static inline void ID3D12VideoEncodeCommandList_SetProtectedResourceSession(
    ID3D12VideoEncodeCommandList *This,
    ID3D12ProtectedResourceSession *protected_resource_session) {
  This->lpVtbl->SetProtectedResourceSession(This, protected_resource_session);
}
...
DEFINE_GUID(IID_ID3D12VideoExtensionCommand, 0x554e41e8, 0xae8e, 0x4a8c, 0xb7,
...
#else
  virtual D3D12_VIDEO_EXTENSION_COMMAND_DESC STDMETHODCALLTYPE GetDesc() = 0;
#endif
  virtual HRESULT STDMETHODCALLTYPE GetProtectedResourceSession(
      REFIID riid, void **protected_session) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D12VideoExtensionCommand, 0x554e41e8, 0xae8e, 0x4a8c, 0xb7,
                0xd2, 0x5b, 0x4f, 0x27, 0x4a, 0x30, 0xe4)
#endif
#else
typedef struct ID3D12VideoExtensionCommandVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D12VideoExtensionCommand *This,
                                             REFIID riid, void **ppvObject);
  ...
  /*** ID3D12Object methods ***/
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(ID3D12VideoExtensionCommand *This,
                                             REFGUID guid, UINT *data_size,
                                             void *data);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D12VideoExtensionCommand *This,
                                             REFGUID guid, UINT data_size,
                                             const void *data);
  HRESULT(STDMETHODCALLTYPE *SetPrivateDataInterface)(
      ID3D12VideoExtensionCommand *This, REFGUID guid, const IUnknown *data);
  HRESULT(STDMETHODCALLTYPE *SetName)(ID3D12VideoExtensionCommand *This,
                                      const WCHAR *name);
  /*** ID3D12DeviceChild methods ***/
  HRESULT(STDMETHODCALLTYPE *GetDevice)(ID3D12VideoExtensionCommand *This,
                                        REFIID riid, void **device);
  ...
  D3D12_VIDEO_EXTENSION_COMMAND_DESC *(STDMETHODCALLTYPE *GetDesc)(
      ...
      D3D12_VIDEO_EXTENSION_COMMAND_DESC *__ret);
  HRESULT(STDMETHODCALLTYPE *GetProtectedResourceSession)(
      ID3D12VideoExtensionCommand *This, REFIID riid, void **protected_session);
  END_INTERFACE
...
/*** ID3D12Object methods ***/
#define ID3D12VideoExtensionCommand_GetPrivateData(This, guid, data_size,      \
                                                   data)                       \
  (This)->lpVtbl->GetPrivateData(This, guid, data_size, data)
#define ID3D12VideoExtensionCommand_SetPrivateData(This, guid, data_size,      \
                                                   data)                       \
  (This)->lpVtbl->SetPrivateData(This, guid, data_size, data)
#define ID3D12VideoExtensionCommand_SetPrivateDataInterface(This, guid, data)  \
  (This)->lpVtbl->SetPrivateDataInterface(This, guid, data)
#define ID3D12VideoExtensionCommand_SetName(This, name)                        \
  (This)->lpVtbl->SetName(This, name)
/*** ID3D12DeviceChild methods ***/
#define ID3D12VideoExtensionCommand_GetDevice(This, riid, device)              \
  (This)->lpVtbl->GetDevice(This, riid, device)
/*** ID3D12VideoExtensionCommand methods ***/
#define ID3D12VideoExtensionCommand_GetDesc(This)                              \
  ID3D12VideoExtensionCommand_GetDesc_define_WIDL_C_INLINE_WRAPPERS_for_aggregate_return_support
#define ID3D12VideoExtensionCommand_GetProtectedResourceSession(               \
    This, riid, protected_session)                                             \
  (This)->lpVtbl->GetProtectedResourceSession(This, riid, protected_session)
#else
/*** IUnknown methods ***/
static inline HRESULT
ID3D12VideoExtensionCommand_QueryInterface(ID3D12VideoExtensionCommand *This,
                                           REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
ID3D12VideoExtensionCommand_AddRef(ID3D12VideoExtensionCommand *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
ID3D12VideoExtensionCommand_Release(ID3D12VideoExtensionCommand *This) {
  return This->lpVtbl->Release(This);
}
/*** ID3D12Object methods ***/
static inline HRESULT
ID3D12VideoExtensionCommand_GetPrivateData(ID3D12VideoExtensionCommand *This,
                                           REFGUID guid, UINT *data_size,
                                           void *data) {
  return This->lpVtbl->GetPrivateData(This, guid, data_size, data);
}
static inline HRESULT
ID3D12VideoExtensionCommand_SetPrivateData(ID3D12VideoExtensionCommand *This,
                                           REFGUID guid, UINT data_size,
                                           const void *data) {
  return This->lpVtbl->SetPrivateData(This, guid, data_size, data);
}
static inline HRESULT ID3D12VideoExtensionCommand_SetPrivateDataInterface(
    ID3D12VideoExtensionCommand *This, REFGUID guid, const IUnknown *data) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, data);
}
static inline HRESULT
ID3D12VideoExtensionCommand_SetName(ID3D12VideoExtensionCommand *This,
                                    const WCHAR *name) {
  return This->lpVtbl->SetName(This, name);
}
/*** ID3D12DeviceChild methods ***/
static inline HRESULT
ID3D12VideoExtensionCommand_GetDevice(ID3D12VideoExtensionCommand *This,
                                      REFIID riid, void **device) {
  return This->lpVtbl->GetDevice(This, riid, device);
}
/*** ID3D12VideoExtensionCommand methods ***/
static inline D3D12_VIDEO_EXTENSION_COMMAND_DESC
ID3D12VideoExtensionCommand_GetDesc(ID3D12VideoExtensionCommand *This) {
  D3D12_VIDEO_EXTENSION_COMMAND_DESC __ret;
  return *This->lpVtbl->GetDesc(This, &__ret);
}
static inline HRESULT ID3D12VideoExtensionCommand_GetProtectedResourceSession(
    ID3D12VideoExtensionCommand *This, REFIID riid, void **protected_session) {
  return This->lpVtbl->GetProtectedResourceSession(This, riid,
                                                   protected_session);
}
...
DEFINE_GUID(IID_ID3D12VideoDevice2, 0xf019ac49, 0xf838, 0x4a95, 0x9b, 0x17,
...
ID3D12VideoDevice2 : public ID3D12VideoDevice1 {
  ...
  virtual HRESULT STDMETHODCALLTYPE ExecuteExtensionCommand(
      ...
      SIZE_T execution_parameters_size_in_bytes, void *output_data,
      SIZE_T output_data_size_in_bytes) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D12VideoDevice2, 0xf019ac49, 0xf838, 0x4a95, 0x9b, 0x17,
                0x57, 0x94, 0x37, 0xc8, 0xf5, 0x13)
#endif
#else
typedef struct ID3D12VideoDevice2Vtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D12VideoDevice2 *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(ID3D12VideoDevice2 *This);
  ULONG(STDMETHODCALLTYPE *Release)(ID3D12VideoDevice2 *This);
  /*** ID3D12VideoDevice methods ***/
  HRESULT(STDMETHODCALLTYPE *CheckFeatureSupport)(
      ID3D12VideoDevice2 *This, D3D12_FEATURE_VIDEO feature_video,
      void *feature_support_data, UINT feature_support_data_size);
  HRESULT(STDMETHODCALLTYPE *CreateVideoDecoder)(
      ID3D12VideoDevice2 *This, const D3D12_VIDEO_DECODER_DESC *desc,
      REFIID riid, void **video_decoder);
  HRESULT(STDMETHODCALLTYPE *CreateVideoDecoderHeap)(
      ...
      void **video_decoder_heap);
  HRESULT(STDMETHODCALLTYPE *CreateVideoProcessor)(
      ID3D12VideoDevice2 *This, UINT node_mask,
      const D3D12_VIDEO_PROCESS_OUTPUT_STREAM_DESC *output_stream_desc,
      UINT input_stream_descs_count,
      const D3D12_VIDEO_PROCESS_INPUT_STREAM_DESC *input_stream_descs,
      REFIID riid, void **video_processor);
  /*** ID3D12VideoDevice1 methods ***/
  HRESULT(STDMETHODCALLTYPE *CreateVideoMotionEstimator)(
      ID3D12VideoDevice2 *This, const D3D12_VIDEO_MOTION_ESTIMATOR_DESC *desc,
      ID3D12ProtectedResourceSession *protected_resource_session, REFIID riid,
      void **video_motion_estimator);
  HRESULT(STDMETHODCALLTYPE *CreateVideoMotionVectorHeap)(
      ID3D12VideoDevice2 *This, const D3D12_VIDEO_MOTION_VECTOR_HEAP_DESC *desc,
      ID3D12ProtectedResourceSession *protected_resource_session, REFIID riid,
      void **video_motion_vector_heap);
  ...
  HRESULT(STDMETHODCALLTYPE *CreateVideoExtensionCommand)(
      ID3D12VideoDevice2 *This, const D3D12_VIDEO_EXTENSION_COMMAND_DESC *desc,
      const void *creation_parameters,
      SIZE_T creation_parameters_data_size_in_bytes,
      ID3D12ProtectedResourceSession *protected_resource_session, REFIID riid,
      void **video_extension_command);
  HRESULT(STDMETHODCALLTYPE *ExecuteExtensionCommand)(
      ID3D12VideoDevice2 *This, ID3D12VideoExtensionCommand *extension_command,
      const void *execution_parameters,
      SIZE_T execution_parameters_size_in_bytes, void *output_data,
      SIZE_T output_data_size_in_bytes);
  END_INTERFACE
} ID3D12VideoDevice2Vtbl;
interface ID3D12VideoDevice2 { CONST_VTBL ID3D12VideoDevice2Vtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** ID3D12VideoDevice methods ***/
#define ID3D12VideoDevice2_CheckFeatureSupport(                                \
    This, feature_video, feature_support_data, feature_support_data_size)      \
  (This)->lpVtbl->CheckFeatureSupport(                                         \
      This, feature_video, feature_support_data, feature_support_data_size)
#define ID3D12VideoDevice2_CreateVideoDecoder(This, desc, riid, video_decoder) \
  (This)->lpVtbl->CreateVideoDecoder(This, desc, riid, video_decoder)
#define ID3D12VideoDevice2_CreateVideoDecoderHeap(                             \
    This, video_decoder_heap_desc, riid, video_decoder_heap)                   \
  (This)->lpVtbl->CreateVideoDecoderHeap(This, video_decoder_heap_desc, riid,  \
                                         video_decoder_heap)
#define ID3D12VideoDevice2_CreateVideoProcessor(                               \
    This, node_mask, output_stream_desc, input_stream_descs_count,             \
    input_stream_descs, riid, video_processor)                                 \
  (This)->lpVtbl->CreateVideoProcessor(                                        \
      This, node_mask, output_stream_desc, input_stream_descs_count,           \
      input_stream_descs, riid, video_processor)
/*** ID3D12VideoDevice1 methods ***/
#define ID3D12VideoDevice2_CreateVideoMotionEstimator(                         \
    This, desc, protected_resource_session, riid, video_motion_estimator)      \
  (This)->lpVtbl->CreateVideoMotionEstimator(                                  \
      This, desc, protected_resource_session, riid, video_motion_estimator)
#define ID3D12VideoDevice2_CreateVideoMotionVectorHeap(                        \
    This, desc, protected_resource_session, riid, video_motion_vector_heap)    \
  (This)->lpVtbl->CreateVideoMotionVectorHeap(                                 \
      This, desc, protected_resource_session, riid, video_motion_vector_heap)
/*** ID3D12VideoDevice2 methods ***/
#define ID3D12VideoDevice2_CreateVideoDecoder1(                                \
    This, desc, protected_resource_session, riid, video_decoder)               \
  (This)->lpVtbl->CreateVideoDecoder1(This, desc, protected_resource_session,  \
                                      riid, video_decoder)
#define ID3D12VideoDevice2_CreateVideoDecoderHeap1(                            \
    This, video_decoder_heap_desc, protected_resource_session, riid,           \
    video_decoder_heap)                                                        \
  (This)->lpVtbl->CreateVideoDecoderHeap1(This, video_decoder_heap_desc,       \
                                          protected_resource_session, riid,    \
                                          video_decoder_heap)
#define ID3D12VideoDevice2_CreateVideoProcessor1(                              \
    This, node_mask, output_stream_desc, input_stream_descs_count,             \
    input_stream_descs, protected_resource_session, riid, video_processor)     \
  (This)->lpVtbl->CreateVideoProcessor1(                                       \
      This, node_mask, output_stream_desc, input_stream_descs_count,           \
      input_stream_descs, protected_resource_session, riid, video_processor)
#define ID3D12VideoDevice2_CreateVideoExtensionCommand(                        \
    This, desc, creation_parameters, creation_parameters_data_size_in_bytes,   \
    protected_resource_session, riid, video_extension_command)                 \
  (This)->lpVtbl->CreateVideoExtensionCommand(                                 \
      This, desc, creation_parameters, creation_parameters_data_size_in_bytes, \
      protected_resource_session, riid, video_extension_command)
#define ID3D12VideoDevice2_ExecuteExtensionCommand(                            \
    This, extension_command, execution_parameters,                             \
    execution_parameters_size_in_bytes, output_data,                           \
    output_data_size_in_bytes)                                                 \
  (This)->lpVtbl->ExecuteExtensionCommand(                                     \
      This, extension_command, execution_parameters,                           \
      execution_parameters_size_in_bytes, output_data,                         \
      output_data_size_in_bytes)
#else
/*** IUnknown methods ***/
static inline HRESULT
ID3D12VideoDevice2_QueryInterface(ID3D12VideoDevice2 *This, REFIID riid,
                                  void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ID3D12VideoDevice methods ***/
static inline HRESULT ID3D12VideoDevice2_CheckFeatureSupport(
    ID3D12VideoDevice2 *This, D3D12_FEATURE_VIDEO feature_video,
    void *feature_support_data, UINT feature_support_data_size) {
  return This->lpVtbl->CheckFeatureSupport(
      This, feature_video, feature_support_data, feature_support_data_size);
...
static inline HRESULT
ID3D12VideoDevice2_CreateVideoDecoder(ID3D12VideoDevice2 *This,
                                      const D3D12_VIDEO_DECODER_DESC *desc,
                                      REFIID riid, void **video_decoder) {
  return This->lpVtbl->CreateVideoDecoder(This, desc, riid, video_decoder);
}
static inline HRESULT ID3D12VideoDevice2_CreateVideoDecoderHeap(
    ID3D12VideoDevice2 *This,
    const D3D12_VIDEO_DECODER_HEAP_DESC *video_decoder_heap_desc, REFIID riid,
    void **video_decoder_heap) {
  return This->lpVtbl->CreateVideoDecoderHeap(This, video_decoder_heap_desc,
...
static inline HRESULT ID3D12VideoDevice2_CreateVideoProcessor(
    ID3D12VideoDevice2 *This, UINT node_mask,
    const D3D12_VIDEO_PROCESS_OUTPUT_STREAM_DESC *output_stream_desc,
    UINT input_stream_descs_count,
    const D3D12_VIDEO_PROCESS_INPUT_STREAM_DESC *input_stream_descs,
...
/*** ID3D12VideoDevice1 methods ***/
static inline HRESULT ID3D12VideoDevice2_CreateVideoMotionEstimator(
    ID3D12VideoDevice2 *This, const D3D12_VIDEO_MOTION_ESTIMATOR_DESC *desc,
    ID3D12ProtectedResourceSession *protected_resource_session, REFIID riid,
    void **video_motion_estimator) {
  return This->lpVtbl->CreateVideoMotionEstimator(
...
static inline HRESULT ID3D12VideoDevice2_CreateVideoMotionVectorHeap(
    ID3D12VideoDevice2 *This, const D3D12_VIDEO_MOTION_VECTOR_HEAP_DESC *desc,
    ID3D12ProtectedResourceSession *protected_resource_session, REFIID riid,
    void **video_motion_vector_heap) {
  return This->lpVtbl->CreateVideoMotionVectorHeap(
...
/*** ID3D12VideoDevice2 methods ***/
static inline HRESULT ID3D12VideoDevice2_CreateVideoDecoder1(
    ID3D12VideoDevice2 *This, const D3D12_VIDEO_DECODER_DESC *desc,
    ID3D12ProtectedResourceSession *protected_resource_session, REFIID riid,
    void **video_decoder) {
  return This->lpVtbl->CreateVideoDecoder1(
      This, desc, protected_resource_session, riid, video_decoder);
}
static inline HRESULT ID3D12VideoDevice2_CreateVideoDecoderHeap1(
    ID3D12VideoDevice2 *This,
    const D3D12_VIDEO_DECODER_HEAP_DESC *video_decoder_heap_desc,
    ID3D12ProtectedResourceSession *protected_resource_session, REFIID riid,
    void **video_decoder_heap) {
  return This->lpVtbl->CreateVideoDecoderHeap1(This, video_decoder_heap_desc,
                                               protected_resource_session, riid,
                                               video_decoder_heap);
}
static inline HRESULT ID3D12VideoDevice2_CreateVideoProcessor1(
    ...
    ID3D12ProtectedResourceSession *protected_resource_session, REFIID riid,
    void **video_processor) {
  return This->lpVtbl->CreateVideoProcessor1(
      This, node_mask, output_stream_desc, input_stream_descs_count,
      input_stream_descs, protected_resource_session, riid, video_processor);
}
static inline HRESULT ID3D12VideoDevice2_CreateVideoExtensionCommand(
    ID3D12VideoDevice2 *This, const D3D12_VIDEO_EXTENSION_COMMAND_DESC *desc,
    const void *creation_parameters,
    SIZE_T creation_parameters_data_size_in_bytes,
    ID3D12ProtectedResourceSession *protected_resource_session, REFIID riid,
    void **video_extension_command) {
  return This->lpVtbl->CreateVideoExtensionCommand(
      This, desc, creation_parameters, creation_parameters_data_size_in_bytes,
      protected_resource_session, riid, video_extension_command);
}
static inline HRESULT ID3D12VideoDevice2_ExecuteExtensionCommand(
    ID3D12VideoDevice2 *This, ID3D12VideoExtensionCommand *extension_command,
    const void *execution_parameters, SIZE_T execution_parameters_size_in_bytes,
    void *output_data, SIZE_T output_data_size_in_bytes) {
  return This->lpVtbl->ExecuteExtensionCommand(
      This, extension_command, execution_parameters,
      execution_parameters_size_in_bytes, output_data,
      output_data_size_in_bytes);
}
...
DEFINE_GUID(IID_ID3D12VideoEncodeCommandList1, 0x94971eca, 0x2bdb, 0x4769, 0x88,
            0xcf, 0x36, 0x75, 0xea, 0x75, 0x7e, 0xbc);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D12VideoEncodeCommandList1, 0x94971eca, 0x2bdb, 0x4769, 0x88,
                0xcf, 0x36, 0x75, 0xea, 0x75, 0x7e, 0xbc)
#endif
#else
typedef struct ID3D12VideoEncodeCommandList1Vtbl {
  ...
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(
      ID3D12VideoEncodeCommandList1 *This, REFIID riid, void **ppvObject);
  ...
  /*** ID3D12Object methods ***/
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(
      ID3D12VideoEncodeCommandList1 *This, REFGUID guid, UINT *data_size,
      void *data);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(
      ID3D12VideoEncodeCommandList1 *This, REFGUID guid, UINT data_size,
      const void *data);
  HRESULT(STDMETHODCALLTYPE *SetPrivateDataInterface)(
      ID3D12VideoEncodeCommandList1 *This, REFGUID guid, const IUnknown *data);
  HRESULT(STDMETHODCALLTYPE *SetName)(ID3D12VideoEncodeCommandList1 *This,
                                      const WCHAR *name);
  /*** ID3D12DeviceChild methods ***/
  HRESULT(STDMETHODCALLTYPE *GetDevice)(ID3D12VideoEncodeCommandList1 *This,
                                        REFIID riid, void **device);
  /*** ID3D12CommandList methods ***/
  D3D12_COMMAND_LIST_TYPE(STDMETHODCALLTYPE *GetType)(
  ...
  HRESULT(STDMETHODCALLTYPE *Reset)(ID3D12VideoEncodeCommandList1 *This,
                                    ID3D12CommandAllocator *allocator);
  void(STDMETHODCALLTYPE *ClearState)(ID3D12VideoEncodeCommandList1 *This);
  void(STDMETHODCALLTYPE *ResourceBarrier)(
      ID3D12VideoEncodeCommandList1 *This, UINT barriers_count,
      const D3D12_RESOURCE_BARRIER *barriers);
  void(STDMETHODCALLTYPE *DiscardResource)(ID3D12VideoEncodeCommandList1 *This,
                                           ID3D12Resource *resource,
                                           const D3D12_DISCARD_REGION *region);
  void(STDMETHODCALLTYPE *BeginQuery)(ID3D12VideoEncodeCommandList1 *This,
                                      ID3D12QueryHeap *query_heap,
                                      D3D12_QUERY_TYPE type, UINT index);
  void(STDMETHODCALLTYPE *EndQuery)(ID3D12VideoEncodeCommandList1 *This,
                                    ID3D12QueryHeap *query_heap,
                                    D3D12_QUERY_TYPE type, UINT index);
  void(STDMETHODCALLTYPE *ResolveQueryData)(
      ID3D12VideoEncodeCommandList1 *This, ID3D12QueryHeap *query_heap,
      D3D12_QUERY_TYPE type, UINT start_index, UINT queries_count,
      ID3D12Resource *destination_buffer,
      UINT64 aligned_destination_buffer_offset);
  void(STDMETHODCALLTYPE *SetPredication)(ID3D12VideoEncodeCommandList1 *This,
                                          ID3D12Resource *buffer,
                                          UINT64 aligned_buffer_offset,
                                          D3D12_PREDICATION_OP operation);
  void(STDMETHODCALLTYPE *SetMarker)(ID3D12VideoEncodeCommandList1 *This,
                                     UINT metadata, const void *data,
                                     UINT size);
  void(STDMETHODCALLTYPE *BeginEvent)(ID3D12VideoEncodeCommandList1 *This,
                                      UINT metadata, const void *data,
                                      UINT size);
  ...
  void(STDMETHODCALLTYPE *ResolveMotionVectorHeap)(
      ...
      const D3D12_RESOLVE_VIDEO_MOTION_VECTOR_HEAP_INPUT *input_arguments);
  void(STDMETHODCALLTYPE *WriteBufferImmediate)(
      ID3D12VideoEncodeCommandList1 *This, UINT count,
      const D3D12_WRITEBUFFERIMMEDIATE_PARAMETER *params,
      const D3D12_WRITEBUFFERIMMEDIATE_MODE *modes);
  void(STDMETHODCALLTYPE *SetProtectedResourceSession)(
      ID3D12VideoEncodeCommandList1 *This,
...
#define ID3D12VideoEncodeCommandList1_Release(This)                            \
  (This)->lpVtbl->Release(This)
/*** ID3D12Object methods ***/
#define ID3D12VideoEncodeCommandList1_GetPrivateData(This, guid, data_size,    \
                                                     data)                     \
  (This)->lpVtbl->GetPrivateData(This, guid, data_size, data)
#define ID3D12VideoEncodeCommandList1_SetPrivateData(This, guid, data_size,    \
                                                     data)                     \
  (This)->lpVtbl->SetPrivateData(This, guid, data_size, data)
#define ID3D12VideoEncodeCommandList1_SetPrivateDataInterface(This, guid,      \
                                                              data)            \
  (This)->lpVtbl->SetPrivateDataInterface(This, guid, data)
#define ID3D12VideoEncodeCommandList1_SetName(This, name)                      \
  (This)->lpVtbl->SetName(This, name)
/*** ID3D12DeviceChild methods ***/
#define ID3D12VideoEncodeCommandList1_GetDevice(This, riid, device)            \
  (This)->lpVtbl->GetDevice(This, riid, device)
/*** ID3D12CommandList methods ***/
...
#define ID3D12VideoEncodeCommandList1_Reset(This, allocator)                   \
  (This)->lpVtbl->Reset(This, allocator)
#define ID3D12VideoEncodeCommandList1_ClearState(This)                         \
  (This)->lpVtbl->ClearState(This)
#define ID3D12VideoEncodeCommandList1_ResourceBarrier(This, barriers_count,    \
                                                      barriers)                \
  (This)->lpVtbl->ResourceBarrier(This, barriers_count, barriers)
#define ID3D12VideoEncodeCommandList1_DiscardResource(This, resource, region)  \
  (This)->lpVtbl->DiscardResource(This, resource, region)
#define ID3D12VideoEncodeCommandList1_BeginQuery(This, query_heap, type,       \
                                                 index)                        \
  (This)->lpVtbl->BeginQuery(This, query_heap, type, index)
#define ID3D12VideoEncodeCommandList1_EndQuery(This, query_heap, type, index)  \
  (This)->lpVtbl->EndQuery(This, query_heap, type, index)
#define ID3D12VideoEncodeCommandList1_ResolveQueryData(                        \
  ...
  (This)->lpVtbl->ResolveQueryData(This, query_heap, type, start_index,        \
                                   queries_count, destination_buffer,          \
                                   aligned_destination_buffer_offset)
#define ID3D12VideoEncodeCommandList1_SetPredication(                          \
    This, buffer, aligned_buffer_offset, operation)                            \
  (This)->lpVtbl->SetPredication(This, buffer, aligned_buffer_offset, operation)
#define ID3D12VideoEncodeCommandList1_SetMarker(This, metadata, data, size)    \
  (This)->lpVtbl->SetMarker(This, metadata, data, size)
#define ID3D12VideoEncodeCommandList1_BeginEvent(This, metadata, data, size)   \
  (This)->lpVtbl->BeginEvent(This, metadata, data, size)
#define ID3D12VideoEncodeCommandList1_EndEvent(This)                           \
  (This)->lpVtbl->EndEvent(This)
#define ID3D12VideoEncodeCommandList1_EstimateMotion(                          \
    This, motion_estimator, output_arguments, input_arguments)                 \
  (This)->lpVtbl->EstimateMotion(This, motion_estimator, output_arguments,     \
                                 input_arguments)
#define ID3D12VideoEncodeCommandList1_ResolveMotionVectorHeap(                 \
    This, output_arguments, input_arguments)                                   \
  (This)->lpVtbl->ResolveMotionVectorHeap(This, output_arguments,              \
                                          input_arguments)
#define ID3D12VideoEncodeCommandList1_WriteBufferImmediate(This, count,        \
                                                           params, modes)      \
  (This)->lpVtbl->WriteBufferImmediate(This, count, params, modes)
#define ID3D12VideoEncodeCommandList1_SetProtectedResourceSession(             \
    This, protected_resource_session)                                          \
  (This)->lpVtbl->SetProtectedResourceSession(This, protected_resource_session)
/*** ID3D12VideoEncodeCommandList1 methods ***/
#define ID3D12VideoEncodeCommandList1_InitializeExtensionCommand(              \
    This, extension_command, initialization_parameters,                        \
    initialization_parameters_size_in_bytes)                                   \
  (This)->lpVtbl->InitializeExtensionCommand(                                  \
      This, extension_command, initialization_parameters,                      \
      initialization_parameters_size_in_bytes)
#define ID3D12VideoEncodeCommandList1_ExecuteExtensionCommand(                 \
    This, extension_command, execution_parameters,                             \
    execution_parameters_size_in_bytes)                                        \
  (This)->lpVtbl->ExecuteExtensionCommand(This, extension_command,             \
                                          execution_parameters,                \
                                          execution_parameters_size_in_bytes)
#else
/*** IUnknown methods ***/
static inline HRESULT ID3D12VideoEncodeCommandList1_QueryInterface(
    ID3D12VideoEncodeCommandList1 *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
ID3D12VideoEncodeCommandList1_AddRef(ID3D12VideoEncodeCommandList1 *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
ID3D12VideoEncodeCommandList1_Release(ID3D12VideoEncodeCommandList1 *This) {
  return This->lpVtbl->Release(This);
}
/*** ID3D12Object methods ***/
static inline HRESULT ID3D12VideoEncodeCommandList1_GetPrivateData(
    ID3D12VideoEncodeCommandList1 *This, REFGUID guid, UINT *data_size,
    void *data) {
  return This->lpVtbl->GetPrivateData(This, guid, data_size, data);
}
static inline HRESULT ID3D12VideoEncodeCommandList1_SetPrivateData(
    ID3D12VideoEncodeCommandList1 *This, REFGUID guid, UINT data_size,
    const void *data) {
  return This->lpVtbl->SetPrivateData(This, guid, data_size, data);
}
static inline HRESULT ID3D12VideoEncodeCommandList1_SetPrivateDataInterface(
    ID3D12VideoEncodeCommandList1 *This, REFGUID guid, const IUnknown *data) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, data);
}
static inline HRESULT
ID3D12VideoEncodeCommandList1_SetName(ID3D12VideoEncodeCommandList1 *This,
                                      const WCHAR *name) {
  return This->lpVtbl->SetName(This, name);
}
/*** ID3D12DeviceChild methods ***/
static inline HRESULT
ID3D12VideoEncodeCommandList1_GetDevice(ID3D12VideoEncodeCommandList1 *This,
                                        REFIID riid, void **device) {
  return This->lpVtbl->GetDevice(This, riid, device);
}
/*** ID3D12CommandList methods ***/
static inline D3D12_COMMAND_LIST_TYPE
ID3D12VideoEncodeCommandList1_GetType(ID3D12VideoEncodeCommandList1 *This) {
  return This->lpVtbl->GetType(This);
}
/*** ID3D12VideoEncodeCommandList methods ***/
static inline HRESULT
ID3D12VideoEncodeCommandList1_Close(ID3D12VideoEncodeCommandList1 *This) {
  return This->lpVtbl->Close(This);
}
static inline HRESULT
ID3D12VideoEncodeCommandList1_Reset(ID3D12VideoEncodeCommandList1 *This,
                                    ID3D12CommandAllocator *allocator) {
  return This->lpVtbl->Reset(This, allocator);
}
static inline void
ID3D12VideoEncodeCommandList1_ClearState(ID3D12VideoEncodeCommandList1 *This) {
  This->lpVtbl->ClearState(This);
}
static inline void ID3D12VideoEncodeCommandList1_ResourceBarrier(
    ID3D12VideoEncodeCommandList1 *This, UINT barriers_count,
    const D3D12_RESOURCE_BARRIER *barriers) {
  This->lpVtbl->ResourceBarrier(This, barriers_count, barriers);
}
static inline void ID3D12VideoEncodeCommandList1_DiscardResource(
    ID3D12VideoEncodeCommandList1 *This, ID3D12Resource *resource,
    const D3D12_DISCARD_REGION *region) {
  This->lpVtbl->DiscardResource(This, resource, region);
}
static inline void
ID3D12VideoEncodeCommandList1_BeginQuery(ID3D12VideoEncodeCommandList1 *This,
                                         ID3D12QueryHeap *query_heap,
                                         D3D12_QUERY_TYPE type, UINT index) {
  This->lpVtbl->BeginQuery(This, query_heap, type, index);
}
static inline void
ID3D12VideoEncodeCommandList1_EndQuery(ID3D12VideoEncodeCommandList1 *This,
                                       ID3D12QueryHeap *query_heap,
                                       D3D12_QUERY_TYPE type, UINT index) {
  This->lpVtbl->EndQuery(This, query_heap, type, index);
}
static inline void ID3D12VideoEncodeCommandList1_ResolveQueryData(
    ID3D12VideoEncodeCommandList1 *This, ID3D12QueryHeap *query_heap,
    D3D12_QUERY_TYPE type, UINT start_index, UINT queries_count,
    ID3D12Resource *destination_buffer,
    UINT64 aligned_destination_buffer_offset) {
...
static inline void ID3D12VideoEncodeCommandList1_SetPredication(
    ID3D12VideoEncodeCommandList1 *This, ID3D12Resource *buffer,
    UINT64 aligned_buffer_offset, D3D12_PREDICATION_OP operation) {
  This->lpVtbl->SetPredication(This, buffer, aligned_buffer_offset, operation);
}
static inline void
ID3D12VideoEncodeCommandList1_SetMarker(ID3D12VideoEncodeCommandList1 *This,
                                        UINT metadata, const void *data,
                                        UINT size) {
  This->lpVtbl->SetMarker(This, metadata, data, size);
}
static inline void
ID3D12VideoEncodeCommandList1_BeginEvent(ID3D12VideoEncodeCommandList1 *This,
                                         UINT metadata, const void *data,
                                         UINT size) {
  This->lpVtbl->BeginEvent(This, metadata, data, size);
}
static inline void
ID3D12VideoEncodeCommandList1_EndEvent(ID3D12VideoEncodeCommandList1 *This) {
  This->lpVtbl->EndEvent(This);
}
static inline void ID3D12VideoEncodeCommandList1_EstimateMotion(
    ID3D12VideoEncodeCommandList1 *This,
    ID3D12VideoMotionEstimator *motion_estimator,
    const D3D12_VIDEO_MOTION_ESTIMATOR_OUTPUT *output_arguments,
    const D3D12_VIDEO_MOTION_ESTIMATOR_INPUT *input_arguments) {
...
static inline void ID3D12VideoEncodeCommandList1_ResolveMotionVectorHeap(
    ID3D12VideoEncodeCommandList1 *This,
    const D3D12_RESOLVE_VIDEO_MOTION_VECTOR_HEAP_OUTPUT *output_arguments,
    const D3D12_RESOLVE_VIDEO_MOTION_VECTOR_HEAP_INPUT *input_arguments) {
  This->lpVtbl->ResolveMotionVectorHeap(This, output_arguments,
...
static inline void ID3D12VideoEncodeCommandList1_WriteBufferImmediate(
    ID3D12VideoEncodeCommandList1 *This, UINT count,
    const D3D12_WRITEBUFFERIMMEDIATE_PARAMETER *params,
    const D3D12_WRITEBUFFERIMMEDIATE_MODE *modes) {
  This->lpVtbl->WriteBufferImmediate(This, count, params, modes);
}
static inline void ID3D12VideoEncodeCommandList1_SetProtectedResourceSession(
    ID3D12VideoEncodeCommandList1 *This,
    ID3D12ProtectedResourceSession *protected_resource_session) {
  This->lpVtbl->SetProtectedResourceSession(This, protected_resource_session);
}
/*** ID3D12VideoEncodeCommandList1 methods ***/
static inline void ID3D12VideoEncodeCommandList1_InitializeExtensionCommand(
    ID3D12VideoEncodeCommandList1 *This,
    ID3D12VideoExtensionCommand *extension_command,
    const void *initialization_parameters,
    SIZE_T initialization_parameters_size_in_bytes) {
...
static inline void ID3D12VideoEncodeCommandList1_ExecuteExtensionCommand(
    ID3D12VideoEncodeCommandList1 *This,
    ID3D12VideoExtensionCommand *extension_command,
    const void *execution_parameters,
    SIZE_T execution_parameters_size_in_bytes) {
...
DEFINE_GUID(D3D12_VIDEO_DECODE_PROFILE_MPEG2, 0xee27417f, 0x5e28, 0x4e65, 0xbe,
            0xea, 0x1d, 0x26, 0xb5, 0x08, 0xad, 0xc9);
DEFINE_GUID(D3D12_VIDEO_DECODE_PROFILE_MPEG1_AND_MPEG2, 0x86695f12, 0x340e,
            0x4f04, 0x9f, 0xd3, 0x92, 0x53, 0xdd, 0x32, 0x74, 0x60);
DEFINE_GUID(D3D12_VIDEO_DECODE_PROFILE_H264, 0x1b81be68, 0xa0c7, 0x11d3, 0xb9,
            0x84, 0x00, 0xc0, 0x4f, 0x2e, 0x73, 0xc5);
DEFINE_GUID(D3D12_VIDEO_DECODE_PROFILE_H264_STEREO_PROGRESSIVE, 0xd79be8da,
            0x0cf1, 0x4c81, 0xb8, 0x2a, 0x69, 0xa4, 0xe2, 0x36, 0xf4, 0x3d);
DEFINE_GUID(D3D12_VIDEO_DECODE_PROFILE_H264_STEREO, 0xf9aaccbb, 0xc2b6, 0x4cfc,
            0x87, 0x79, 0x57, 0x07, 0xb1, 0x76, 0x05, 0x52);
DEFINE_GUID(D3D12_VIDEO_DECODE_PROFILE_H264_MULTIVIEW, 0x705b9d82, 0x76cf,
            0x49d6, 0xb7, 0xe6, 0xac, 0x88, 0x72, 0xdb, 0x01, 0x3c);
DEFINE_GUID(D3D12_VIDEO_DECODE_PROFILE_VC1, 0x1b81beA3, 0xa0c7, 0x11d3, 0xb9,
            0x84, 0x00, 0xc0, 0x4f, 0x2e, 0x73, 0xc5);
DEFINE_GUID(D3D12_VIDEO_DECODE_PROFILE_VC1_D2010, 0x1b81beA4, 0xa0c7, 0x11d3,
            0xb9, 0x84, 0x00, 0xc0, 0x4f, 0x2e, 0x73, 0xc5);
DEFINE_GUID(D3D12_VIDEO_DECODE_PROFILE_MPEG4PT2_SIMPLE, 0xefd64d74, 0xc9e8,
...
DEFINE_GUID(D3D12_VIDEO_DECODE_PROFILE_HEVC_MAIN, 0x5b11d51b, 0x2f4c, 0x4452,
            0xbc, 0xc3, 0x09, 0xf2, 0xa1, 0x16, 0x0c, 0xc0);
DEFINE_GUID(D3D12_VIDEO_DECODE_PROFILE_HEVC_MAIN10, 0x107af0e0, 0xef1a, 0x4d19,
            0xab, 0xa8, 0x67, 0xa1, 0x63, 0x07, 0x3d, 0x13);
DEFINE_GUID(D3D12_VIDEO_DECODE_PROFILE_VP9, 0x463707f8, 0xa1d0, 0x4585, 0x87,
            0x6d, 0x83, 0xaa, 0x6d, 0x60, 0xb8, 0x9e);
DEFINE_GUID(D3D12_VIDEO_DECODE_PROFILE_VP9_10BIT_PROFILE2, 0xa4c749ef, 0x6ecf,
            0x48aa, 0x84, 0x48, 0x50, 0xa7, 0xa1, 0x16, 0x5f, 0xf7);
DEFINE_GUID(D3D12_VIDEO_DECODE_PROFILE_VP8, 0x90b899ea, 0x3a62, 0x4705, 0x88,
            0xb3, 0x8d, 0xf0, 0x4b, 0x27, 0x44, 0xe7);
DEFINE_GUID(D3D12_VIDEO_DECODE_PROFILE_AV1_PROFILE0, 0xb8be4ccb, 0xcf53, 0x46ba,
            0x8d, 0x59, 0xd6, 0xb8, 0xa6, 0xda, 0x5d, 0x2a);
DEFINE_GUID(D3D12_VIDEO_DECODE_PROFILE_AV1_PROFILE1, 0x6936ff0f, 0x45b1, 0x4163,
            0x9c, 0xc1, 0x64, 0x6e, 0xf6, 0x94, 0x61, 0x08);
DEFINE_GUID(D3D12_VIDEO_DECODE_PROFILE_AV1_PROFILE2, 0x0c5f2aa1, 0xe541, 0x4089,
            0xbb, 0x7b, 0x98, 0x11, 0x0a, 0x19, 0xd7, 0xc8);
DEFINE_GUID(D3D12_VIDEO_DECODE_PROFILE_AV1_12BIT_PROFILE2, 0x17127009, 0xa00f,
            0x4ce1, 0x99, 0x4e, 0xbf, 0x40, 0x81, 0xf6, 0xf3, 0xf0);
DEFINE_GUID(D3D12_VIDEO_DECODE_PROFILE_AV1_12BIT_PROFILE2_420, 0x2d80bed6,
...
typedef enum D3D12_VIDEO_ENCODER_AV1_TX_MODE_FLAGS {
  ...
  D3D12_VIDEO_ENCODER_AV1_TX_MODE_FLAG_ONLY4x4 = 1
      << D3D12_VIDEO_ENCODER_AV1_TX_MODE_ONLY4x4,
  D3D12_VIDEO_ENCODER_AV1_TX_MODE_FLAG_LARGEST = 1
      << D3D12_VIDEO_ENCODER_AV1_TX_MODE_LARGEST,
  D3D12_VIDEO_ENCODER_AV1_TX_MODE_FLAG_SELECT = 1
...
typedef enum D3D12_VIDEO_ENCODER_AV1_INTERPOLATION_FILTERS_FLAGS {
  ...
  D3D12_VIDEO_ENCODER_AV1_INTERPOLATION_FILTERS_FLAG_EIGHTTAP_SMOOTH = 1
      << D3D12_VIDEO_ENCODER_AV1_INTERPOLATION_FILTERS_EIGHTTAP_SMOOTH,
  D3D12_VIDEO_ENCODER_AV1_INTERPOLATION_FILTERS_FLAG_EIGHTTAP_SHARP = 1
      << D3D12_VIDEO_ENCODER_AV1_INTERPOLATION_FILTERS_EIGHTTAP_SHARP,
  D3D12_VIDEO_ENCODER_AV1_INTERPOLATION_FILTERS_FLAG_BILINEAR = 1
      << D3D12_VIDEO_ENCODER_AV1_INTERPOLATION_FILTERS_BILINEAR,
  D3D12_VIDEO_ENCODER_AV1_INTERPOLATION_FILTERS_FLAG_SWITCHABLE = 1
...
typedef enum D3D12_VIDEO_ENCODER_AV1_SEGMENTATION_MODE_FLAGS {
  ...
  D3D12_VIDEO_ENCODER_AV1_SEGMENTATION_MODE_FLAG_DISABLED = 1
      << D3D12_VIDEO_ENCODER_AV1_SEGMENTATION_MODE_DISABLED,
  D3D12_VIDEO_ENCODER_AV1_SEGMENTATION_MODE_FLAG_ALT_Q = 1
      << D3D12_VIDEO_ENCODER_AV1_SEGMENTATION_MODE_ALT_Q,
  D3D12_VIDEO_ENCODER_AV1_SEGMENTATION_MODE_FLAG_ALT_LF_Y_V = 1
      << D3D12_VIDEO_ENCODER_AV1_SEGMENTATION_MODE_ALT_LF_Y_V,
  D3D12_VIDEO_ENCODER_AV1_SEGMENTATION_MODE_FLAG_ALT_LF_Y_H = 1
      << D3D12_VIDEO_ENCODER_AV1_SEGMENTATION_MODE_ALT_LF_Y_H,
  D3D12_VIDEO_ENCODER_AV1_SEGMENTATION_MODE_FLAG_ALT_LF_U = 1
      << D3D12_VIDEO_ENCODER_AV1_SEGMENTATION_MODE_ALT_LF_U,
  D3D12_VIDEO_ENCODER_AV1_SEGMENTATION_MODE_FLAG_ALT_LF_V = 1
      << D3D12_VIDEO_ENCODER_AV1_SEGMENTATION_MODE_ALT_LF_V,
  D3D12_VIDEO_ENCODER_AV1_SEGMENTATION_MODE_FLAG_REF_FRAME = 1
      << D3D12_VIDEO_ENCODER_AV1_SEGMENTATION_MODE_ALT_REF_FRAME,
  D3D12_VIDEO_ENCODER_AV1_SEGMENTATION_MODE_FLAG_ALT_SKIP = 1
      << D3D12_VIDEO_ENCODER_AV1_SEGMENTATION_MODE_ALT_SKIP,
  D3D12_VIDEO_ENCODER_AV1_SEGMENTATION_MODE_FLAG_ALT_GLOBALMV = 1
      << D3D12_VIDEO_ENCODER_AV1_SEGMENTATION_MODE_ALT_GLOBALMV
...
typedef enum D3D12_VIDEO_ENCODER_AV1_REFERENCE_WARPED_MOTION_TRANSFORMATION_FLAGS {
  ...
  D3D12_VIDEO_ENCODER_AV1_REFERENCE_WARPED_MOTION_TRANSFORMATION_FLAG_AFFINE = 1
...
typedef struct D3D12_VIDEO_ENCODER_AV1_CODEC_CONFIGURATION_SUPPORT {
  ...
  D3D12_VIDEO_ENCODER_AV1_RESTORATION_SUPPORT_FLAGS
      SupportedRestorationParams[3][3];
...
typedef enum D3D12_VIDEO_ENCODER_AV1_FRAME_TYPE_FLAGS {
  ...
  D3D12_VIDEO_ENCODER_AV1_FRAME_TYPE_FLAG_INTER_FRAME = 1
      << D3D12_VIDEO_ENCODER_AV1_FRAME_TYPE_INTER_FRAME,
  D3D12_VIDEO_ENCODER_AV1_FRAME_TYPE_FLAG_INTRA_ONLY_FRAME = 1
      << D3D12_VIDEO_ENCODER_AV1_FRAME_TYPE_INTRA_ONLY_FRAME,
  D3D12_VIDEO_ENCODER_AV1_FRAME_TYPE_FLAG_SWITCH_FRAME = 1
      << D3D12_VIDEO_ENCODER_AV1_FRAME_TYPE_SWITCH_FRAME
...
DEFINE_GUID(IID_ID3D12VideoEncoder, 0x2e0d212d, 0x8df9, 0x44a6, 0xa7, 0x70,
            0xbb, 0x28, 0x9b, 0x18, 0x27, 0x37);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("2e0d212d-8df9-44a6-a770-bb289b182737")
ID3D12VideoEncoder : public ID3D12Pageable {
  virtual UINT STDMETHODCALLTYPE GetNodeMask() = 0;
  virtual D3D12_VIDEO_ENCODER_FLAGS STDMETHODCALLTYPE GetEncoderFlags() = 0;
  virtual D3D12_VIDEO_ENCODER_CODEC STDMETHODCALLTYPE GetCodec() = 0;
  ...
  virtual DXGI_FORMAT STDMETHODCALLTYPE GetInputFormat() = 0;
  virtual D3D12_VIDEO_ENCODER_MOTION_ESTIMATION_PRECISION_MODE STDMETHODCALLTYPE
  GetMaxMotionEstimationPrecision() = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D12VideoEncoder, 0x2e0d212d, 0x8df9, 0x44a6, 0xa7, 0x70,
                0xbb, 0x28, 0x9b, 0x18, 0x27, 0x37)
#endif
#else
typedef struct ID3D12VideoEncoderVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D12VideoEncoder *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(ID3D12VideoEncoder *This);
  ULONG(STDMETHODCALLTYPE *Release)(ID3D12VideoEncoder *This);
  /*** ID3D12Object methods ***/
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(ID3D12VideoEncoder *This,
                                             REFGUID guid, UINT *data_size,
                                             void *data);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D12VideoEncoder *This,
                                             REFGUID guid, UINT data_size,
                                             const void *data);
  HRESULT(STDMETHODCALLTYPE *SetPrivateDataInterface)(ID3D12VideoEncoder *This,
                                                      REFGUID guid,
                                                      const IUnknown *data);
  HRESULT(STDMETHODCALLTYPE *SetName)(ID3D12VideoEncoder *This,
                                      const WCHAR *name);
  /*** ID3D12DeviceChild methods ***/
  HRESULT(STDMETHODCALLTYPE *GetDevice)(ID3D12VideoEncoder *This, REFIID riid,
                                        void **device);
  ...
  HRESULT(STDMETHODCALLTYPE *GetCodecProfile)(
      ID3D12VideoEncoder *This, D3D12_VIDEO_ENCODER_PROFILE_DESC dst_profile);
  ...
  D3D12_VIDEO_ENCODER_MOTION_ESTIMATION_PRECISION_MODE(
      STDMETHODCALLTYPE *GetMaxMotionEstimationPrecision)(
      ID3D12VideoEncoder *This);
  END_INTERFACE
} ID3D12VideoEncoderVtbl;
interface ID3D12VideoEncoder { CONST_VTBL ID3D12VideoEncoderVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
/*** ID3D12Object methods ***/
#define ID3D12VideoEncoder_GetPrivateData(This, guid, data_size, data)         \
  (This)->lpVtbl->GetPrivateData(This, guid, data_size, data)
#define ID3D12VideoEncoder_SetPrivateData(This, guid, data_size, data)         \
  (This)->lpVtbl->SetPrivateData(This, guid, data_size, data)
#define ID3D12VideoEncoder_SetPrivateDataInterface(This, guid, data)           \
  (This)->lpVtbl->SetPrivateDataInterface(This, guid, data)
#define ID3D12VideoEncoder_SetName(This, name)                                 \
  (This)->lpVtbl->SetName(This, name)
/*** ID3D12DeviceChild methods ***/
#define ID3D12VideoEncoder_GetDevice(This, riid, device)                       \
  (This)->lpVtbl->GetDevice(This, riid, device)
/*** ID3D12VideoEncoder methods ***/
...
#define ID3D12VideoEncoder_GetCodecProfile(This, dst_profile)                  \
  (This)->lpVtbl->GetCodecProfile(This, dst_profile)
#define ID3D12VideoEncoder_GetCodecConfiguration(This, dst_codec_config)       \
  (This)->lpVtbl->GetCodecConfiguration(This, dst_codec_config)
...
/*** IUnknown methods ***/
static inline HRESULT
ID3D12VideoEncoder_QueryInterface(ID3D12VideoEncoder *This, REFIID riid,
                                  void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ID3D12Object methods ***/
static inline HRESULT
ID3D12VideoEncoder_GetPrivateData(ID3D12VideoEncoder *This, REFGUID guid,
                                  UINT *data_size, void *data) {
  return This->lpVtbl->GetPrivateData(This, guid, data_size, data);
}
static inline HRESULT
ID3D12VideoEncoder_SetPrivateData(ID3D12VideoEncoder *This, REFGUID guid,
                                  UINT data_size, const void *data) {
  return This->lpVtbl->SetPrivateData(This, guid, data_size, data);
}
static inline HRESULT
ID3D12VideoEncoder_SetPrivateDataInterface(ID3D12VideoEncoder *This,
                                           REFGUID guid, const IUnknown *data) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, data);
}
static inline HRESULT ID3D12VideoEncoder_SetName(ID3D12VideoEncoder *This,
                                                 const WCHAR *name) {
  return This->lpVtbl->SetName(This, name);
}
/*** ID3D12DeviceChild methods ***/
static inline HRESULT ID3D12VideoEncoder_GetDevice(ID3D12VideoEncoder *This,
                                                   REFIID riid, void **device) {
  return This->lpVtbl->GetDevice(This, riid, device);
}
/*** ID3D12VideoEncoder methods ***/
...
static inline D3D12_VIDEO_ENCODER_FLAGS
ID3D12VideoEncoder_GetEncoderFlags(ID3D12VideoEncoder *This) {
  return This->lpVtbl->GetEncoderFlags(This);
}
static inline D3D12_VIDEO_ENCODER_CODEC
ID3D12VideoEncoder_GetCodec(ID3D12VideoEncoder *This) {
  return This->lpVtbl->GetCodec(This);
}
static inline HRESULT ID3D12VideoEncoder_GetCodecProfile(
    ID3D12VideoEncoder *This, D3D12_VIDEO_ENCODER_PROFILE_DESC dst_profile) {
  return This->lpVtbl->GetCodecProfile(This, dst_profile);
}
static inline HRESULT ID3D12VideoEncoder_GetCodecConfiguration(
    ID3D12VideoEncoder *This,
    D3D12_VIDEO_ENCODER_CODEC_CONFIGURATION dst_codec_config) {
  return This->lpVtbl->GetCodecConfiguration(This, dst_codec_config);
}
static inline DXGI_FORMAT
ID3D12VideoEncoder_GetInputFormat(ID3D12VideoEncoder *This) {
  return This->lpVtbl->GetInputFormat(This);
}
static inline D3D12_VIDEO_ENCODER_MOTION_ESTIMATION_PRECISION_MODE
ID3D12VideoEncoder_GetMaxMotionEstimationPrecision(ID3D12VideoEncoder *This) {
...
DEFINE_GUID(IID_ID3D12VideoEncoderHeap, 0x22b35d96, 0x876a, 0x44c0, 0xb2, 0x5e,
...
ID3D12VideoEncoderHeap : public ID3D12Pageable {
  virtual UINT STDMETHODCALLTYPE GetNodeMask() = 0;
  virtual D3D12_VIDEO_ENCODER_HEAP_FLAGS STDMETHODCALLTYPE
  GetEncoderHeapFlags() = 0;
  virtual D3D12_VIDEO_ENCODER_CODEC STDMETHODCALLTYPE GetCodec() = 0;
  virtual HRESULT STDMETHODCALLTYPE GetCodecProfile(
      D3D12_VIDEO_ENCODER_PROFILE_DESC dst_profile) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetCodecLevel(
      D3D12_VIDEO_ENCODER_LEVEL_SETTING dst_level) = 0;
  virtual UINT STDMETHODCALLTYPE GetResolutionListCount() = 0;
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D12VideoEncoderHeap, 0x22b35d96, 0x876a, 0x44c0, 0xb2, 0x5e,
                0xfb, 0x8c, 0x9c, 0x7f, 0x1c, 0x4a)
#endif
#else
typedef struct ID3D12VideoEncoderHeapVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D12VideoEncoderHeap *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(ID3D12VideoEncoderHeap *This);
  ULONG(STDMETHODCALLTYPE *Release)(ID3D12VideoEncoderHeap *This);
  /*** ID3D12Object methods ***/
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(ID3D12VideoEncoderHeap *This,
                                             REFGUID guid, UINT *data_size,
                                             void *data);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(ID3D12VideoEncoderHeap *This,
                                             REFGUID guid, UINT data_size,
                                             const void *data);
  HRESULT(STDMETHODCALLTYPE *SetPrivateDataInterface)(
      ID3D12VideoEncoderHeap *This, REFGUID guid, const IUnknown *data);
  HRESULT(STDMETHODCALLTYPE *SetName)(ID3D12VideoEncoderHeap *This,
                                      const WCHAR *name);
  /*** ID3D12DeviceChild methods ***/
  HRESULT(STDMETHODCALLTYPE *GetDevice)(ID3D12VideoEncoderHeap *This,
                                        REFIID riid, void **device);
  ...
  HRESULT(STDMETHODCALLTYPE *GetResolutionList)(
      ID3D12VideoEncoderHeap *This, const UINT resolutions_list_count,
...
/*** ID3D12Object methods ***/
#define ID3D12VideoEncoderHeap_GetPrivateData(This, guid, data_size, data)     \
  (This)->lpVtbl->GetPrivateData(This, guid, data_size, data)
#define ID3D12VideoEncoderHeap_SetPrivateData(This, guid, data_size, data)     \
  (This)->lpVtbl->SetPrivateData(This, guid, data_size, data)
#define ID3D12VideoEncoderHeap_SetPrivateDataInterface(This, guid, data)       \
  (This)->lpVtbl->SetPrivateDataInterface(This, guid, data)
#define ID3D12VideoEncoderHeap_SetName(This, name)                             \
  (This)->lpVtbl->SetName(This, name)
/*** ID3D12DeviceChild methods ***/
#define ID3D12VideoEncoderHeap_GetDevice(This, riid, device)                   \
  (This)->lpVtbl->GetDevice(This, riid, device)
/*** ID3D12VideoEncoderHeap methods ***/
...
#define ID3D12VideoEncoderHeap_GetCodecProfile(This, dst_profile)              \
  (This)->lpVtbl->GetCodecProfile(This, dst_profile)
#define ID3D12VideoEncoderHeap_GetCodecLevel(This, dst_level)                  \
  (This)->lpVtbl->GetCodecLevel(This, dst_level)
#define ID3D12VideoEncoderHeap_GetResolutionListCount(This)                    \
  (This)->lpVtbl->GetResolutionListCount(This)
#define ID3D12VideoEncoderHeap_GetResolutionList(This, resolutions_list_count, \
                                                 resolution_list)              \
  (This)->lpVtbl->GetResolutionList(This, resolutions_list_count,              \
                                    resolution_list)
#else
/*** IUnknown methods ***/
static inline HRESULT
ID3D12VideoEncoderHeap_QueryInterface(ID3D12VideoEncoderHeap *This, REFIID riid,
                                      void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
ID3D12VideoEncoderHeap_AddRef(ID3D12VideoEncoderHeap *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
ID3D12VideoEncoderHeap_Release(ID3D12VideoEncoderHeap *This) {
  return This->lpVtbl->Release(This);
}
/*** ID3D12Object methods ***/
static inline HRESULT ID3D12VideoEncoderHeap_GetPrivateData(
    ID3D12VideoEncoderHeap *This, REFGUID guid, UINT *data_size, void *data) {
  return This->lpVtbl->GetPrivateData(This, guid, data_size, data);
}
static inline HRESULT
ID3D12VideoEncoderHeap_SetPrivateData(ID3D12VideoEncoderHeap *This,
                                      REFGUID guid, UINT data_size,
                                      const void *data) {
  return This->lpVtbl->SetPrivateData(This, guid, data_size, data);
}
static inline HRESULT ID3D12VideoEncoderHeap_SetPrivateDataInterface(
    ID3D12VideoEncoderHeap *This, REFGUID guid, const IUnknown *data) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, data);
}
static inline HRESULT
ID3D12VideoEncoderHeap_SetName(ID3D12VideoEncoderHeap *This,
                               const WCHAR *name) {
  return This->lpVtbl->SetName(This, name);
}
/*** ID3D12DeviceChild methods ***/
static inline HRESULT
ID3D12VideoEncoderHeap_GetDevice(ID3D12VideoEncoderHeap *This, REFIID riid,
                                 void **device) {
  return This->lpVtbl->GetDevice(This, riid, device);
}
/*** ID3D12VideoEncoderHeap methods ***/
static inline UINT
ID3D12VideoEncoderHeap_GetNodeMask(ID3D12VideoEncoderHeap *This) {
  return This->lpVtbl->GetNodeMask(This);
}
static inline D3D12_VIDEO_ENCODER_HEAP_FLAGS
ID3D12VideoEncoderHeap_GetEncoderHeapFlags(ID3D12VideoEncoderHeap *This) {
  return This->lpVtbl->GetEncoderHeapFlags(This);
}
static inline D3D12_VIDEO_ENCODER_CODEC
ID3D12VideoEncoderHeap_GetCodec(ID3D12VideoEncoderHeap *This) {
  return This->lpVtbl->GetCodec(This);
}
static inline HRESULT ID3D12VideoEncoderHeap_GetCodecProfile(
    ID3D12VideoEncoderHeap *This,
    D3D12_VIDEO_ENCODER_PROFILE_DESC dst_profile) {
  return This->lpVtbl->GetCodecProfile(This, dst_profile);
}
static inline HRESULT ID3D12VideoEncoderHeap_GetCodecLevel(
    ID3D12VideoEncoderHeap *This, D3D12_VIDEO_ENCODER_LEVEL_SETTING dst_level) {
  return This->lpVtbl->GetCodecLevel(This, dst_level);
}
static inline UINT
ID3D12VideoEncoderHeap_GetResolutionListCount(ID3D12VideoEncoderHeap *This) {
  return This->lpVtbl->GetResolutionListCount(This);
}
static inline HRESULT ID3D12VideoEncoderHeap_GetResolutionList(
    ID3D12VideoEncoderHeap *This, const UINT resolutions_list_count,
    D3D12_VIDEO_ENCODER_PICTURE_RESOLUTION_DESC *resolution_list) {
  return This->lpVtbl->GetResolutionList(This, resolutions_list_count,
                                         resolution_list);
}
#endif
#endif
...
DEFINE_GUID(IID_ID3D12VideoDevice3, 0x4243adb4, 0x3a32, 0x4666, 0x97, 0x3c,
...
ID3D12VideoDevice3 : public ID3D12VideoDevice2 {
  virtual HRESULT STDMETHODCALLTYPE CreateVideoEncoder(
      const D3D12_VIDEO_ENCODER_DESC *desc, REFIID riid,
      void **video_encoder) = 0;
  virtual HRESULT STDMETHODCALLTYPE CreateVideoEncoderHeap(
      const D3D12_VIDEO_ENCODER_HEAP_DESC *desc, REFIID riid,
      void **video_encoder_heap) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D12VideoDevice3, 0x4243adb4, 0x3a32, 0x4666, 0x97, 0x3c,
                0x0c, 0xcc, 0x56, 0x25, 0xdc, 0x44)
#endif
#else
typedef struct ID3D12VideoDevice3Vtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(ID3D12VideoDevice3 *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(ID3D12VideoDevice3 *This);
  ULONG(STDMETHODCALLTYPE *Release)(ID3D12VideoDevice3 *This);
  /*** ID3D12VideoDevice methods ***/
  HRESULT(STDMETHODCALLTYPE *CheckFeatureSupport)(
      ID3D12VideoDevice3 *This, D3D12_FEATURE_VIDEO feature_video,
      void *feature_support_data, UINT feature_support_data_size);
  HRESULT(STDMETHODCALLTYPE *CreateVideoDecoder)(
      ID3D12VideoDevice3 *This, const D3D12_VIDEO_DECODER_DESC *desc,
      REFIID riid, void **video_decoder);
  HRESULT(STDMETHODCALLTYPE *CreateVideoDecoderHeap)(
      ...
      void **video_decoder_heap);
  HRESULT(STDMETHODCALLTYPE *CreateVideoProcessor)(
      ID3D12VideoDevice3 *This, UINT node_mask,
      const D3D12_VIDEO_PROCESS_OUTPUT_STREAM_DESC *output_stream_desc,
      UINT input_stream_descs_count,
      const D3D12_VIDEO_PROCESS_INPUT_STREAM_DESC *input_stream_descs,
      REFIID riid, void **video_processor);
  /*** ID3D12VideoDevice1 methods ***/
  HRESULT(STDMETHODCALLTYPE *CreateVideoMotionEstimator)(
      ID3D12VideoDevice3 *This, const D3D12_VIDEO_MOTION_ESTIMATOR_DESC *desc,
      ID3D12ProtectedResourceSession *protected_resource_session, REFIID riid,
      void **video_motion_estimator);
  HRESULT(STDMETHODCALLTYPE *CreateVideoMotionVectorHeap)(
      ID3D12VideoDevice3 *This, const D3D12_VIDEO_MOTION_VECTOR_HEAP_DESC *desc,
      ID3D12ProtectedResourceSession *protected_resource_session, REFIID riid,
      void **video_motion_vector_heap);
  /*** ID3D12VideoDevice2 methods ***/
  HRESULT(STDMETHODCALLTYPE *CreateVideoDecoder1)(
  ...
  HRESULT(STDMETHODCALLTYPE *CreateVideoProcessor1)(
      ...
      void **video_processor);
  HRESULT(STDMETHODCALLTYPE *CreateVideoExtensionCommand)(
      ID3D12VideoDevice3 *This, const D3D12_VIDEO_EXTENSION_COMMAND_DESC *desc,
      const void *creation_parameters,
      SIZE_T creation_parameters_data_size_in_bytes,
      ID3D12ProtectedResourceSession *protected_resource_session, REFIID riid,
      void **video_extension_command);
  HRESULT(STDMETHODCALLTYPE *ExecuteExtensionCommand)(
      ID3D12VideoDevice3 *This, ID3D12VideoExtensionCommand *extension_command,
      const void *execution_parameters,
      SIZE_T execution_parameters_size_in_bytes, void *output_data,
      SIZE_T output_data_size_in_bytes);
  /*** ID3D12VideoDevice3 methods ***/
  HRESULT(STDMETHODCALLTYPE *CreateVideoEncoder)(
      ID3D12VideoDevice3 *This, const D3D12_VIDEO_ENCODER_DESC *desc,
      REFIID riid, void **video_encoder);
  HRESULT(STDMETHODCALLTYPE *CreateVideoEncoderHeap)(
      ID3D12VideoDevice3 *This, const D3D12_VIDEO_ENCODER_HEAP_DESC *desc,
      REFIID riid, void **video_encoder_heap);
  END_INTERFACE
} ID3D12VideoDevice3Vtbl;
interface ID3D12VideoDevice3 { CONST_VTBL ID3D12VideoDevice3Vtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#define ID3D12VideoDevice3_CheckFeatureSupport(                                \
  ...
  (This)->lpVtbl->CheckFeatureSupport(                                         \
      This, feature_video, feature_support_data, feature_support_data_size)
#define ID3D12VideoDevice3_CreateVideoDecoder(This, desc, riid, video_decoder) \
  (This)->lpVtbl->CreateVideoDecoder(This, desc, riid, video_decoder)
#define ID3D12VideoDevice3_CreateVideoDecoderHeap(                             \
    This, video_decoder_heap_desc, riid, video_decoder_heap)                   \
  (This)->lpVtbl->CreateVideoDecoderHeap(This, video_decoder_heap_desc, riid,  \
                                         video_decoder_heap)
#define ID3D12VideoDevice3_CreateVideoProcessor(                               \
    This, node_mask, output_stream_desc, input_stream_descs_count,             \
    input_stream_descs, riid, video_processor)                                 \
  (This)->lpVtbl->CreateVideoProcessor(                                        \
      This, node_mask, output_stream_desc, input_stream_descs_count,           \
...
#define ID3D12VideoDevice3_CreateVideoMotionEstimator(                         \
  ...
  (This)->lpVtbl->CreateVideoMotionEstimator(                                  \
      This, desc, protected_resource_session, riid, video_motion_estimator)
#define ID3D12VideoDevice3_CreateVideoMotionVectorHeap(                        \
    This, desc, protected_resource_session, riid, video_motion_vector_heap)    \
  (This)->lpVtbl->CreateVideoMotionVectorHeap(                                 \
      This, desc, protected_resource_session, riid, video_motion_vector_heap)
/*** ID3D12VideoDevice2 methods ***/
#define ID3D12VideoDevice3_CreateVideoDecoder1(                                \
    This, desc, protected_resource_session, riid, video_decoder)               \
  (This)->lpVtbl->CreateVideoDecoder1(This, desc, protected_resource_session,  \
                                      riid, video_decoder)
#define ID3D12VideoDevice3_CreateVideoDecoderHeap1(                            \
    This, video_decoder_heap_desc, protected_resource_session, riid,           \
    video_decoder_heap)                                                        \
  (This)->lpVtbl->CreateVideoDecoderHeap1(This, video_decoder_heap_desc,       \
                                          protected_resource_session, riid,    \
                                          video_decoder_heap)
#define ID3D12VideoDevice3_CreateVideoProcessor1(                              \
    This, node_mask, output_stream_desc, input_stream_descs_count,             \
    input_stream_descs, protected_resource_session, riid, video_processor)     \
  (This)->lpVtbl->CreateVideoProcessor1(                                       \
      This, node_mask, output_stream_desc, input_stream_descs_count,           \
...
#define ID3D12VideoDevice3_CreateVideoExtensionCommand(                        \
  ...
  (This)->lpVtbl->CreateVideoExtensionCommand(                                 \
      This, desc, creation_parameters, creation_parameters_data_size_in_bytes, \
      protected_resource_session, riid, video_extension_command)
#define ID3D12VideoDevice3_ExecuteExtensionCommand(                            \
    This, extension_command, execution_parameters,                             \
    execution_parameters_size_in_bytes, output_data,                           \
    output_data_size_in_bytes)                                                 \
  (This)->lpVtbl->ExecuteExtensionCommand(                                     \
      ...
      output_data_size_in_bytes)
/*** ID3D12VideoDevice3 methods ***/
#define ID3D12VideoDevice3_CreateVideoEncoder(This, desc, riid, video_encoder) \
  (This)->lpVtbl->CreateVideoEncoder(This, desc, riid, video_encoder)
#define ID3D12VideoDevice3_CreateVideoEncoderHeap(This, desc, riid,            \
                                                  video_encoder_heap)          \
  (This)->lpVtbl->CreateVideoEncoderHeap(This, desc, riid, video_encoder_heap)
#else
/*** IUnknown methods ***/
static inline HRESULT
ID3D12VideoDevice3_QueryInterface(ID3D12VideoDevice3 *This, REFIID riid,
                                  void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** ID3D12VideoDevice methods ***/
static inline HRESULT ID3D12VideoDevice3_CheckFeatureSupport(
    ID3D12VideoDevice3 *This, D3D12_FEATURE_VIDEO feature_video,
    void *feature_support_data, UINT feature_support_data_size) {
  return This->lpVtbl->CheckFeatureSupport(
      This, feature_video, feature_support_data, feature_support_data_size);
...
static inline HRESULT
ID3D12VideoDevice3_CreateVideoDecoder(ID3D12VideoDevice3 *This,
                                      const D3D12_VIDEO_DECODER_DESC *desc,
                                      REFIID riid, void **video_decoder) {
  return This->lpVtbl->CreateVideoDecoder(This, desc, riid, video_decoder);
}
static inline HRESULT ID3D12VideoDevice3_CreateVideoDecoderHeap(
    ID3D12VideoDevice3 *This,
    const D3D12_VIDEO_DECODER_HEAP_DESC *video_decoder_heap_desc, REFIID riid,
    void **video_decoder_heap) {
  return This->lpVtbl->CreateVideoDecoderHeap(This, video_decoder_heap_desc,
...
static inline HRESULT ID3D12VideoDevice3_CreateVideoProcessor(
    ID3D12VideoDevice3 *This, UINT node_mask,
    const D3D12_VIDEO_PROCESS_OUTPUT_STREAM_DESC *output_stream_desc,
    UINT input_stream_descs_count,
    const D3D12_VIDEO_PROCESS_INPUT_STREAM_DESC *input_stream_descs,
...
/*** ID3D12VideoDevice1 methods ***/
static inline HRESULT ID3D12VideoDevice3_CreateVideoMotionEstimator(
    ID3D12VideoDevice3 *This, const D3D12_VIDEO_MOTION_ESTIMATOR_DESC *desc,
    ID3D12ProtectedResourceSession *protected_resource_session, REFIID riid,
    void **video_motion_estimator) {
  return This->lpVtbl->CreateVideoMotionEstimator(
...
static inline HRESULT ID3D12VideoDevice3_CreateVideoMotionVectorHeap(
    ID3D12VideoDevice3 *This, const D3D12_VIDEO_MOTION_VECTOR_HEAP_DESC *desc,
    ID3D12ProtectedResourceSession *protected_resource_session, REFIID riid,
    void **video_motion_vector_heap) {
  return This->lpVtbl->CreateVideoMotionVectorHeap(
...
/*** ID3D12VideoDevice2 methods ***/
static inline HRESULT ID3D12VideoDevice3_CreateVideoDecoder1(
    ID3D12VideoDevice3 *This, const D3D12_VIDEO_DECODER_DESC *desc,
    ID3D12ProtectedResourceSession *protected_resource_session, REFIID riid,
    void **video_decoder) {
  return This->lpVtbl->CreateVideoDecoder1(
...
static inline HRESULT ID3D12VideoDevice3_CreateVideoDecoderHeap1(
    ID3D12VideoDevice3 *This,
    const D3D12_VIDEO_DECODER_HEAP_DESC *video_decoder_heap_desc,
    ID3D12ProtectedResourceSession *protected_resource_session, REFIID riid,
    void **video_decoder_heap) {
...
static inline HRESULT ID3D12VideoDevice3_ExecuteExtensionCommand(
    ID3D12VideoDevice3 *This, ID3D12VideoExtensionCommand *extension_command,
    const void *execution_parameters, SIZE_T execution_parameters_size_in_bytes,
    void *output_data, SIZE_T output_data_size_in_bytes) {
  return This->lpVtbl->ExecuteExtensionCommand(
...
/*** ID3D12VideoDevice3 methods ***/
static inline HRESULT
ID3D12VideoDevice3_CreateVideoEncoder(ID3D12VideoDevice3 *This,
                                      const D3D12_VIDEO_ENCODER_DESC *desc,
                                      REFIID riid, void **video_encoder) {
  return This->lpVtbl->CreateVideoEncoder(This, desc, riid, video_encoder);
}
static inline HRESULT ID3D12VideoDevice3_CreateVideoEncoderHeap(
    ID3D12VideoDevice3 *This, const D3D12_VIDEO_ENCODER_HEAP_DESC *desc,
    REFIID riid, void **video_encoder_heap) {
  return This->lpVtbl->CreateVideoEncoderHeap(This, desc, riid,
                                              video_encoder_heap);
}
#endif
#endif
...
DEFINE_GUID(IID_ID3D12VideoEncodeCommandList2, 0x895491e2, 0xe701, 0x46a9, 0x9a,
            0x1f, 0x8d, 0x34, 0x80, 0xed, 0x86, 0x7a);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
ID3D12VideoEncodeCommandList2 : public ID3D12VideoEncodeCommandList1 {
  virtual void STDMETHODCALLTYPE EncodeFrame(
      ID3D12VideoEncoder * encoder, ID3D12VideoEncoderHeap * heap,
  ...
  virtual void STDMETHODCALLTYPE ResolveEncoderOutputMetadata(
      const D3D12_VIDEO_ENCODER_RESOLVE_METADATA_INPUT_ARGUMENTS
          *input_arguments,
      const D3D12_VIDEO_ENCODER_RESOLVE_METADATA_OUTPUT_ARGUMENTS
          *output_arguments) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ID3D12VideoEncodeCommandList2, 0x895491e2, 0xe701, 0x46a9, 0x9a,
                0x1f, 0x8d, 0x34, 0x80, 0xed, 0x86, 0x7a)
#endif
#else
typedef struct ID3D12VideoEncodeCommandList2Vtbl {
  ...
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(
      ID3D12VideoEncodeCommandList2 *This, REFIID riid, void **ppvObject);
  ...
  /*** ID3D12Object methods ***/
  HRESULT(STDMETHODCALLTYPE *GetPrivateData)(
      ID3D12VideoEncodeCommandList2 *This, REFGUID guid, UINT *data_size,
      void *data);
  HRESULT(STDMETHODCALLTYPE *SetPrivateData)(
      ID3D12VideoEncodeCommandList2 *This, REFGUID guid, UINT data_size,
      const void *data);
  HRESULT(STDMETHODCALLTYPE *SetPrivateDataInterface)(
      ID3D12VideoEncodeCommandList2 *This, REFGUID guid, const IUnknown *data);
  HRESULT(STDMETHODCALLTYPE *SetName)(ID3D12VideoEncodeCommandList2 *This,
                                      const WCHAR *name);
  /*** ID3D12DeviceChild methods ***/
  HRESULT(STDMETHODCALLTYPE *GetDevice)(ID3D12VideoEncodeCommandList2 *This,
                                        REFIID riid, void **device);
  /*** ID3D12CommandList methods ***/
  D3D12_COMMAND_LIST_TYPE(STDMETHODCALLTYPE *GetType)(
  ...
  HRESULT(STDMETHODCALLTYPE *Reset)(ID3D12VideoEncodeCommandList2 *This,
                                    ID3D12CommandAllocator *allocator);
  void(STDMETHODCALLTYPE *ClearState)(ID3D12VideoEncodeCommandList2 *This);
  void(STDMETHODCALLTYPE *ResourceBarrier)(
      ID3D12VideoEncodeCommandList2 *This, UINT barriers_count,
      const D3D12_RESOURCE_BARRIER *barriers);
  void(STDMETHODCALLTYPE *DiscardResource)(ID3D12VideoEncodeCommandList2 *This,
                                           ID3D12Resource *resource,
                                           const D3D12_DISCARD_REGION *region);
  void(STDMETHODCALLTYPE *BeginQuery)(ID3D12VideoEncodeCommandList2 *This,
                                      ID3D12QueryHeap *query_heap,
                                      D3D12_QUERY_TYPE type, UINT index);
  void(STDMETHODCALLTYPE *EndQuery)(ID3D12VideoEncodeCommandList2 *This,
                                    ID3D12QueryHeap *query_heap,
                                    D3D12_QUERY_TYPE type, UINT index);
  void(STDMETHODCALLTYPE *ResolveQueryData)(
      ID3D12VideoEncodeCommandList2 *This, ID3D12QueryHeap *query_heap,
      D3D12_QUERY_TYPE type, UINT start_index, UINT queries_count,
      ID3D12Resource *destination_buffer,
      UINT64 aligned_destination_buffer_offset);
  void(STDMETHODCALLTYPE *SetPredication)(ID3D12VideoEncodeCommandList2 *This,
                                          ID3D12Resource *buffer,
                                          UINT64 aligned_buffer_offset,
                                          D3D12_PREDICATION_OP operation);
  void(STDMETHODCALLTYPE *SetMarker)(ID3D12VideoEncodeCommandList2 *This,
                                     UINT metadata, const void *data,
                                     UINT size);
  void(STDMETHODCALLTYPE *BeginEvent)(ID3D12VideoEncodeCommandList2 *This,
                                      UINT metadata, const void *data,
                                      UINT size);
  ...
  void(STDMETHODCALLTYPE *ResolveMotionVectorHeap)(
      ...
      const D3D12_RESOLVE_VIDEO_MOTION_VECTOR_HEAP_INPUT *input_arguments);
  void(STDMETHODCALLTYPE *WriteBufferImmediate)(
      ID3D12VideoEncodeCommandList2 *This, UINT count,
      const D3D12_WRITEBUFFERIMMEDIATE_PARAMETER *params,
      const D3D12_WRITEBUFFERIMMEDIATE_MODE *modes);
  void(STDMETHODCALLTYPE *SetProtectedResourceSession)(
      ID3D12VideoEncodeCommandList2 *This,
  ...
  void(STDMETHODCALLTYPE *EncodeFrame)(
      ID3D12VideoEncodeCommandList2 *This, ID3D12VideoEncoder *encoder,
...
#define ID3D12VideoEncodeCommandList2_Release(This)                            \
  (This)->lpVtbl->Release(This)
/*** ID3D12Object methods ***/
#define ID3D12VideoEncodeCommandList2_GetPrivateData(This, guid, data_size,    \
                                                     data)                     \
  (This)->lpVtbl->GetPrivateData(This, guid, data_size, data)
#define ID3D12VideoEncodeCommandList2_SetPrivateData(This, guid, data_size,    \
                                                     data)                     \
  (This)->lpVtbl->SetPrivateData(This, guid, data_size, data)
#define ID3D12VideoEncodeCommandList2_SetPrivateDataInterface(This, guid,      \
                                                              data)            \
  (This)->lpVtbl->SetPrivateDataInterface(This, guid, data)
#define ID3D12VideoEncodeCommandList2_SetName(This, name)                      \
  (This)->lpVtbl->SetName(This, name)
/*** ID3D12DeviceChild methods ***/
#define ID3D12VideoEncodeCommandList2_GetDevice(This, riid, device)            \
  (This)->lpVtbl->GetDevice(This, riid, device)
/*** ID3D12CommandList methods ***/
...
#define ID3D12VideoEncodeCommandList2_Reset(This, allocator)                   \
  (This)->lpVtbl->Reset(This, allocator)
#define ID3D12VideoEncodeCommandList2_ClearState(This)                         \
  (This)->lpVtbl->ClearState(This)
#define ID3D12VideoEncodeCommandList2_ResourceBarrier(This, barriers_count,    \
                                                      barriers)                \
  (This)->lpVtbl->ResourceBarrier(This, barriers_count, barriers)
#define ID3D12VideoEncodeCommandList2_DiscardResource(This, resource, region)  \
  (This)->lpVtbl->DiscardResource(This, resource, region)
#define ID3D12VideoEncodeCommandList2_BeginQuery(This, query_heap, type,       \
                                                 index)                        \
  (This)->lpVtbl->BeginQuery(This, query_heap, type, index)
#define ID3D12VideoEncodeCommandList2_EndQuery(This, query_heap, type, index)  \
  (This)->lpVtbl->EndQuery(This, query_heap, type, index)
#define ID3D12VideoEncodeCommandList2_ResolveQueryData(                        \
    This, query_heap, type, start_index, queries_count, destination_buffer,    \
    aligned_destination_buffer_offset)                                         \
  (This)->lpVtbl->ResolveQueryData(This, query_heap, type, start_index,        \
                                   queries_count, destination_buffer,          \
                                   aligned_destination_buffer_offset)
#define ID3D12VideoEncodeCommandList2_SetPredication(                          \
    This, buffer, aligned_buffer_offset, operation)                            \
  (This)->lpVtbl->SetPredication(This, buffer, aligned_buffer_offset, operation)
#define ID3D12VideoEncodeCommandList2_SetMarker(This, metadata, data, size)    \
  (This)->lpVtbl->SetMarker(This, metadata, data, size)
#define ID3D12VideoEncodeCommandList2_BeginEvent(This, metadata, data, size)   \
  (This)->lpVtbl->BeginEvent(This, metadata, data, size)
#define ID3D12VideoEncodeCommandList2_EndEvent(This)                           \
  (This)->lpVtbl->EndEvent(This)
#define ID3D12VideoEncodeCommandList2_EstimateMotion(                          \
    This, motion_estimator, output_arguments, input_arguments)                 \
  (This)->lpVtbl->EstimateMotion(This, motion_estimator, output_arguments,     \
                                 input_arguments)
#define ID3D12VideoEncodeCommandList2_ResolveMotionVectorHeap(                 \
    This, output_arguments, input_arguments)                                   \
  (This)->lpVtbl->ResolveMotionVectorHeap(This, output_arguments,              \
                                          input_arguments)
#define ID3D12VideoEncodeCommandList2_WriteBufferImmediate(This, count,        \
                                                           params, modes)      \
  (This)->lpVtbl->WriteBufferImmediate(This, count, params, modes)
#define ID3D12VideoEncodeCommandList2_SetProtectedResourceSession(             \
    This, protected_resource_session)                                          \
  (This)->lpVtbl->SetProtectedResourceSession(This, protected_resource_session)
/*** ID3D12VideoEncodeCommandList1 methods ***/
#define ID3D12VideoEncodeCommandList2_InitializeExtensionCommand(              \
    This, extension_command, initialization_parameters,                        \
    initialization_parameters_size_in_bytes)                                   \
  (This)->lpVtbl->InitializeExtensionCommand(                                  \
      This, extension_command, initialization_parameters,                      \
      initialization_parameters_size_in_bytes)
#define ID3D12VideoEncodeCommandList2_ExecuteExtensionCommand(                 \
    This, extension_command, execution_parameters,                             \
    execution_parameters_size_in_bytes)                                        \
  (This)->lpVtbl->ExecuteExtensionCommand(This, extension_command,             \
                                          execution_parameters,                \
                                          execution_parameters_size_in_bytes)
/*** ID3D12VideoEncodeCommandList2 methods ***/
#define ID3D12VideoEncodeCommandList2_EncodeFrame(                             \
    This, encoder, heap, input_arguments, output_arguments)                    \
  (This)->lpVtbl->EncodeFrame(This, encoder, heap, input_arguments,            \
                              output_arguments)
#define ID3D12VideoEncodeCommandList2_ResolveEncoderOutputMetadata(            \
    This, input_arguments, output_arguments)                                   \
  (This)->lpVtbl->ResolveEncoderOutputMetadata(This, input_arguments,          \
                                               output_arguments)
#else
/*** IUnknown methods ***/
static inline HRESULT ID3D12VideoEncodeCommandList2_QueryInterface(
    ID3D12VideoEncodeCommandList2 *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
ID3D12VideoEncodeCommandList2_AddRef(ID3D12VideoEncodeCommandList2 *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
ID3D12VideoEncodeCommandList2_Release(ID3D12VideoEncodeCommandList2 *This) {
  return This->lpVtbl->Release(This);
}
/*** ID3D12Object methods ***/
static inline HRESULT ID3D12VideoEncodeCommandList2_GetPrivateData(
    ID3D12VideoEncodeCommandList2 *This, REFGUID guid, UINT *data_size,
    void *data) {
  return This->lpVtbl->GetPrivateData(This, guid, data_size, data);
}
static inline HRESULT ID3D12VideoEncodeCommandList2_SetPrivateData(
    ID3D12VideoEncodeCommandList2 *This, REFGUID guid, UINT data_size,
    const void *data) {
  return This->lpVtbl->SetPrivateData(This, guid, data_size, data);
}
static inline HRESULT ID3D12VideoEncodeCommandList2_SetPrivateDataInterface(
    ID3D12VideoEncodeCommandList2 *This, REFGUID guid, const IUnknown *data) {
  return This->lpVtbl->SetPrivateDataInterface(This, guid, data);
}
static inline HRESULT
ID3D12VideoEncodeCommandList2_SetName(ID3D12VideoEncodeCommandList2 *This,
                                      const WCHAR *name) {
  return This->lpVtbl->SetName(This, name);
}
/*** ID3D12DeviceChild methods ***/
static inline HRESULT
ID3D12VideoEncodeCommandList2_GetDevice(ID3D12VideoEncodeCommandList2 *This,
                                        REFIID riid, void **device) {
  return This->lpVtbl->GetDevice(This, riid, device);
}
/*** ID3D12CommandList methods ***/
static inline D3D12_COMMAND_LIST_TYPE
ID3D12VideoEncodeCommandList2_GetType(ID3D12VideoEncodeCommandList2 *This) {
  return This->lpVtbl->GetType(This);
}
/*** ID3D12VideoEncodeCommandList methods ***/
static inline HRESULT
ID3D12VideoEncodeCommandList2_Close(ID3D12VideoEncodeCommandList2 *This) {
  return This->lpVtbl->Close(This);
}
static inline HRESULT
ID3D12VideoEncodeCommandList2_Reset(ID3D12VideoEncodeCommandList2 *This,
                                    ID3D12CommandAllocator *allocator) {
  return This->lpVtbl->Reset(This, allocator);
}
static inline void
ID3D12VideoEncodeCommandList2_ClearState(ID3D12VideoEncodeCommandList2 *This) {
  This->lpVtbl->ClearState(This);
}
...
static inline void ID3D12VideoEncodeCommandList2_DiscardResource(
    ID3D12VideoEncodeCommandList2 *This, ID3D12Resource *resource,
    const D3D12_DISCARD_REGION *region) {
  This->lpVtbl->DiscardResource(This, resource, region);
}
static inline void
ID3D12VideoEncodeCommandList2_BeginQuery(ID3D12VideoEncodeCommandList2 *This,
                                         ID3D12QueryHeap *query_heap,
                                         D3D12_QUERY_TYPE type, UINT index) {
  This->lpVtbl->BeginQuery(This, query_heap, type, index);
}
static inline void
ID3D12VideoEncodeCommandList2_EndQuery(ID3D12VideoEncodeCommandList2 *This,
                                       ID3D12QueryHeap *query_heap,
                                       D3D12_QUERY_TYPE type, UINT index) {
  This->lpVtbl->EndQuery(This, query_heap, type, index);
}
static inline void ID3D12VideoEncodeCommandList2_ResolveQueryData(
    ID3D12VideoEncodeCommandList2 *This, ID3D12QueryHeap *query_heap,
    D3D12_QUERY_TYPE type, UINT start_index, UINT queries_count,
    ID3D12Resource *destination_buffer,
    UINT64 aligned_destination_buffer_offset) {
...
static inline void ID3D12VideoEncodeCommandList2_SetPredication(
    ID3D12VideoEncodeCommandList2 *This, ID3D12Resource *buffer,
    UINT64 aligned_buffer_offset, D3D12_PREDICATION_OP operation) {
  This->lpVtbl->SetPredication(This, buffer, aligned_buffer_offset, operation);
}
static inline void
ID3D12VideoEncodeCommandList2_SetMarker(ID3D12VideoEncodeCommandList2 *This,
                                        UINT metadata, const void *data,
                                        UINT size) {
  This->lpVtbl->SetMarker(This, metadata, data, size);
}
static inline void
ID3D12VideoEncodeCommandList2_BeginEvent(ID3D12VideoEncodeCommandList2 *This,
                                         UINT metadata, const void *data,
                                         UINT size) {
  This->lpVtbl->BeginEvent(This, metadata, data, size);
}
static inline void
ID3D12VideoEncodeCommandList2_EndEvent(ID3D12VideoEncodeCommandList2 *This) {
  This->lpVtbl->EndEvent(This);
}
static inline void ID3D12VideoEncodeCommandList2_EstimateMotion(
    ID3D12VideoEncodeCommandList2 *This,
    ID3D12VideoMotionEstimator *motion_estimator,
    const D3D12_VIDEO_MOTION_ESTIMATOR_OUTPUT *output_arguments,
    const D3D12_VIDEO_MOTION_ESTIMATOR_INPUT *input_arguments) {
...
static inline void ID3D12VideoEncodeCommandList2_ResolveMotionVectorHeap(
    ID3D12VideoEncodeCommandList2 *This,
    const D3D12_RESOLVE_VIDEO_MOTION_VECTOR_HEAP_OUTPUT *output_arguments,
    const D3D12_RESOLVE_VIDEO_MOTION_VECTOR_HEAP_INPUT *input_arguments) {
  This->lpVtbl->ResolveMotionVectorHeap(This, output_arguments,
...
static inline void ID3D12VideoEncodeCommandList2_WriteBufferImmediate(
    ID3D12VideoEncodeCommandList2 *This, UINT count,
    const D3D12_WRITEBUFFERIMMEDIATE_PARAMETER *params,
    const D3D12_WRITEBUFFERIMMEDIATE_MODE *modes) {
  This->lpVtbl->WriteBufferImmediate(This, count, params, modes);
}
static inline void ID3D12VideoEncodeCommandList2_SetProtectedResourceSession(
    ID3D12VideoEncodeCommandList2 *This,
    ID3D12ProtectedResourceSession *protected_resource_session) {
  This->lpVtbl->SetProtectedResourceSession(This, protected_resource_session);
}
/*** ID3D12VideoEncodeCommandList1 methods ***/
static inline void ID3D12VideoEncodeCommandList2_InitializeExtensionCommand(
    ID3D12VideoEncodeCommandList2 *This,
    ID3D12VideoExtensionCommand *extension_command,
    const void *initialization_parameters,
    SIZE_T initialization_parameters_size_in_bytes) {
...
static inline void ID3D12VideoEncodeCommandList2_ExecuteExtensionCommand(
    ID3D12VideoEncodeCommandList2 *This,
    ID3D12VideoExtensionCommand *extension_command,
    const void *execution_parameters,
    SIZE_T execution_parameters_size_in_bytes) {
...
/*** ID3D12VideoEncodeCommandList2 methods ***/
static inline void ID3D12VideoEncodeCommandList2_EncodeFrame(
    ID3D12VideoEncodeCommandList2 *This, ID3D12VideoEncoder *encoder,
    ID3D12VideoEncoderHeap *heap,
    const D3D12_VIDEO_ENCODER_ENCODEFRAME_INPUT_ARGUMENTS *input_arguments,
    const D3D12_VIDEO_ENCODER_ENCODEFRAME_OUTPUT_ARGUMENTS *output_arguments) {
...
static inline void ID3D12VideoEncodeCommandList2_ResolveEncoderOutputMetadata(
    ID3D12VideoEncodeCommandList2 *This,
