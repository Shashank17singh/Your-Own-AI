...
DECLARE_INTERFACE_(ID3DXFont, IUnknown) {
  ...
  STDMETHOD_(INT, DrawTextA)(THIS_ struct ID3DXSprite * sprite,
                             const char *string, INT count, RECT *rect,
                             DWORD format, D3DCOLOR color) PURE;
  STDMETHOD_(INT, DrawTextW)(THIS_ struct ID3DXSprite * sprite,
                             const WCHAR *string, INT count, RECT *rect,
                             DWORD format, D3DCOLOR color) PURE;
...
#define ID3DXFont_DrawTextA(p, a, b, c, d, e, f)                               \
  (p)->DrawTextA(a, b, c, d, e, f)
#define ID3DXFont_DrawTextW(p, a, b, c, d, e, f)                               \
  (p)->DrawTextW(a, b, c, d, e, f)
...
DECLARE_INTERFACE_(ID3DXLine, IUnknown) {
  ...
  STDMETHOD(Draw)(THIS_ const D3DXVECTOR2 *vertexlist, DWORD vertexlistcount,
                  D3DCOLOR color) PURE;
  STDMETHOD(DrawTransform)(THIS_ const D3DXVECTOR3 *vertexlist,
                           DWORD vertexlistcount, const D3DXMATRIX *transform,
                           D3DCOLOR color) PURE;
...
#define ID3DXLine_DrawTransform(p, a, b, c, d)                                 \
...
DECLARE_INTERFACE_(ID3DXRenderToEnvMap, IUnknown) {
  ...
  STDMETHOD(BeginHemisphere)(THIS_ struct IDirect3DTexture9 * texzpos,
                             struct IDirect3DTexture9 * texzneg) PURE;
  STDMETHOD(BeginParabolic)(THIS_ struct IDirect3DTexture9 * texzpos,
                            struct IDirect3DTexture9 * texzneg) PURE;
...
#if !defined(__cplusplus) || defined(CINTERFACE)
/*** IUnknown methods ***/
#define ID3DXRenderToEnvMap_QueryInterface(p, a, b)                            \
...
DECLARE_INTERFACE_(ID3DXRenderToSurface, IUnknown) {
  ...
  STDMETHOD(BeginScene)(THIS_ struct IDirect3DSurface9 * surface,
                        const D3DVIEWPORT9 *viewport) PURE;
...
#if !defined(__cplusplus) || defined(CINTERFACE)
/*** IUnknown methods ***/
#define ID3DXRenderToSurface_QueryInterface(p, a, b)                           \
  (p)->lpVtbl->QueryInterface(p, a, b)
...
DECLARE_INTERFACE_(ID3DXSprite, IUnknown) {
  ...
  STDMETHOD(SetWorldViewRH)(THIS_ const D3DXMATRIX *world,
                            const D3DXMATRIX *view) PURE;
  STDMETHOD(SetWorldViewLH)(THIS_ const D3DXMATRIX *world,
                            const D3DXMATRIX *view) PURE;
...
HRESULT WINAPI D3DXCreateFontA(struct IDirect3DDevice9 *device, INT height,
                               UINT width, UINT weight, UINT miplevels,
                               WINBOOL italic, DWORD charset, DWORD precision,
                               DWORD quality, DWORD pitchandfamily,
                               const char *facename, struct ID3DXFont **font);
HRESULT WINAPI D3DXCreateFontW(struct IDirect3DDevice9 *device, INT height,
                               UINT width, UINT weight, UINT miplevels,
                               WINBOOL italic, DWORD charset, DWORD precision,
                               DWORD quality, DWORD pitchandfamily,
...
HRESULT WINAPI D3DXCreateRenderToEnvMap(struct IDirect3DDevice9 *device,
                                        ...
                                        D3DFORMAT format, WINBOOL stencil,
