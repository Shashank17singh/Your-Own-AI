...
#define VCEXPORT
typedef VOID _stdcall CHANNEL_INIT_EVENT_FN(LPVOID pInitHandle, UINT event,
...
typedef VOID _stdcall CHANNEL_OPEN_EVENT_FN(DWORD openHandle, UINT event,
...
extern "C" {
#endif
typedef UINT _stdcall
VIRTUALCHANNELINIT(LPVOID *ppInitHandle, PCHANNEL_DEF pChannel,
                   INT channelCount, ULONG versionRequested,
                   PCHANNEL_INIT_EVENT_FN pChannelInitEventProc);
typedef VIRTUALCHANNELINIT *PVIRTUALCHANNELINIT;
typedef UINT _stdcall
VIRTUALCHANNELOPEN(LPVOID pInitHandle, LPDWORD pOpenHandle, PCHAR pChannelName,
...
typedef UINT _stdcall VIRTUALCHANNELWRITE(DWORD openHandle, LPVOID pData,
