...
NET_API_STATUS WINAPI NetReplGetInfo(LPCWSTR servername, DWORD level,
                                     LPBYTE *bufptr);
NET_API_STATUS WINAPI NetReplSetInfo(LPCWSTR servername, DWORD level,
                                     const LPBYTE buf, LPDWORD parm_err);
...
NET_API_STATUS WINAPI NetReplExportDirAdd(LPCWSTR servername, DWORD level,
                                          const LPBYTE buf, LPDWORD parm_err);
NET_API_STATUS WINAPI NetReplExportDirDel(LPCWSTR servername, LPCWSTR dirname);
NET_API_STATUS WINAPI NetReplExportDirEnum(LPCWSTR servername, DWORD level,
                                           LPBYTE *bufptr, DWORD prefmaxlen,
                                           LPDWORD entriesread,
                                           LPDWORD totalentries,
                                           LPDWORD resumehandle);
NET_API_STATUS WINAPI NetReplExportDirGetInfo(LPCWSTR servername,
                                              LPCWSTR dirname, DWORD level,
                                              LPBYTE *bufptr);
NET_API_STATUS WINAPI NetReplExportDirSetInfo(LPCWSTR servername,
                                              LPCWSTR dirname, DWORD level,
                                              const LPBYTE buf,
                                              LPDWORD parm_err);
NET_API_STATUS WINAPI NetReplExportDirLock(LPCWSTR servername, LPCWSTR dirname);
NET_API_STATUS WINAPI NetReplExportDirUnlock(LPCWSTR servername,
                                             LPCWSTR dirname,
                                             DWORD unlockforce);
...
NET_API_STATUS WINAPI NetReplImportDirAdd(LPCWSTR servername, DWORD level,
                                          const LPBYTE buf, LPDWORD parm_err);
NET_API_STATUS WINAPI NetReplImportDirDel(LPCWSTR servername, LPCWSTR dirname);
NET_API_STATUS WINAPI NetReplImportDirEnum(LPCWSTR servername, DWORD level,
                                           LPBYTE *bufptr, DWORD prefmaxlen,
                                           LPDWORD entriesread,
                                           LPDWORD totalentries,
                                           LPDWORD resumehandle);
NET_API_STATUS WINAPI NetReplImportDirGetInfo(LPCWSTR servername,
                                              LPCWSTR dirname, DWORD level,
                                              LPBYTE *bufptr);
NET_API_STATUS WINAPI NetReplImportDirLock(LPCWSTR servername, LPCWSTR dirname);
NET_API_STATUS WINAPI NetReplImportDirUnlock(LPCWSTR servername,
                                             LPCWSTR dirname,
                                             DWORD unlockforce);
