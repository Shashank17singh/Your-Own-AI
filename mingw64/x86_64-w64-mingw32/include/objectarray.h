...
DEFINE_GUID(IID_IObjectArray, 0x92ca9dcd, 0x5622, 0x4bba, 0xa8, 0x05, 0x5e,
            0x9f, 0x54, 0x1b, 0xd8, 0xc9);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("92ca9dcd-5622-4bba-a805-5e9f541bd8c9")
IObjectArray : public IUnknown {
  virtual HRESULT STDMETHODCALLTYPE GetCount(UINT * pcObjects) = 0;
  virtual HRESULT STDMETHODCALLTYPE GetAt(UINT uiIndex, REFIID riid,
                                          void **ppv) = 0;
};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IObjectArray, 0x92ca9dcd, 0x5622, 0x4bba, 0xa8, 0x05, 0x5e,
                0x9f, 0x54, 0x1b, 0xd8, 0xc9)
#endif
#else
typedef struct IObjectArrayVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IObjectArray *This, REFIID riid,
                                             void **ppvObject);
  ...
  HRESULT(STDMETHODCALLTYPE *GetAt)(IObjectArray *This, UINT uiIndex,
                                    REFIID riid, void **ppv);
  END_INTERFACE
} IObjectArrayVtbl;
interface IObjectArray { CONST_VTBL IObjectArrayVtbl *lpVtbl; };
#ifdef COBJMACROS
...
IObjectArray_QueryInterface(IObjectArray *This, REFIID riid, void **ppvObject) {
...
/*** IObjectArray methods ***/
static inline HRESULT IObjectArray_GetCount(IObjectArray *This,
                                            UINT *pcObjects) {
  return This->lpVtbl->GetCount(This, pcObjects);
}
static inline HRESULT IObjectArray_GetAt(IObjectArray *This, UINT uiIndex,
                                         REFIID riid, void **ppv) {
...
DEFINE_GUID(IID_IObjectCollection, 0x5632b1a4, 0xe38a, 0x400a, 0x92, 0x8a, 0xd4,
            0xcd, 0x63, 0x23, 0x02, 0x95);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IObjectCollection, 0x5632b1a4, 0xe38a, 0x400a, 0x92, 0x8a, 0xd4,
                0xcd, 0x63, 0x23, 0x02, 0x95)
#endif
#else
typedef struct IObjectCollectionVtbl {
  BEGIN_INTERFACE
  /*** IUnknown methods ***/
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(IObjectCollection *This,
                                             REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(IObjectCollection *This);
  ULONG(STDMETHODCALLTYPE *Release)(IObjectCollection *This);
  /*** IObjectArray methods ***/
  HRESULT(STDMETHODCALLTYPE *GetCount)(IObjectCollection *This,
                                       UINT *pcObjects);
  HRESULT(STDMETHODCALLTYPE *GetAt)(IObjectCollection *This, UINT uiIndex,
                                    REFIID riid, void **ppv);
  /*** IObjectCollection methods ***/
  HRESULT(STDMETHODCALLTYPE *AddObject)(IObjectCollection *This,
                                        IUnknown *punk);
  HRESULT(STDMETHODCALLTYPE *AddFromArray)(IObjectCollection *This,
                                           IObjectArray *poaSource);
  HRESULT(STDMETHODCALLTYPE *RemoveObjectAt)(IObjectCollection *This,
                                             UINT uiIndex);
  HRESULT(STDMETHODCALLTYPE *Clear)(IObjectCollection *This);
  END_INTERFACE
} IObjectCollectionVtbl;
interface IObjectCollection { CONST_VTBL IObjectCollectionVtbl *lpVtbl; };
#ifdef COBJMACROS
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IObjectCollection_QueryInterface(IObjectCollection *This,
                                                       REFIID riid,
                                                       void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
...
/*** IObjectArray methods ***/
static inline HRESULT IObjectCollection_GetCount(IObjectCollection *This,
                                                 UINT *pcObjects) {
  return This->lpVtbl->GetCount(This, pcObjects);
}
static inline HRESULT IObjectCollection_GetAt(IObjectCollection *This,
                                              UINT uiIndex, REFIID riid,
                                              void **ppv) {
  return This->lpVtbl->GetAt(This, uiIndex, riid, ppv);
}
/*** IObjectCollection methods ***/
static inline HRESULT IObjectCollection_AddObject(IObjectCollection *This,
                                                  IUnknown *punk) {
  return This->lpVtbl->AddObject(This, punk);
}
static inline HRESULT IObjectCollection_AddFromArray(IObjectCollection *This,
                                                     IObjectArray *poaSource) {
  return This->lpVtbl->AddFromArray(This, poaSource);
}
static inline HRESULT IObjectCollection_RemoveObjectAt(IObjectCollection *This,
                                                       UINT uiIndex) {
