...
#ifdef __cplusplus
#define __FIReference_1_UnderlineType                                          \
  ABI::Windows::Foundation::IReference<ABI::Windows::UI::Text::UnderlineType>
#endif /* __cplusplus */
#endif
...
#ifndef __cplusplus
typedef enum __x_ABI_CWindows_CUI_CText_CUnderlineType
    __x_ABI_CWindows_CUI_CText_CUnderlineType;
#endif /* __cplusplus */
#ifndef ____FIReference_1_UnderlineType_FWD_DEFINED__
#define ____FIReference_1_UnderlineType_FWD_DEFINED__
typedef interface __FIReference_1_UnderlineType __FIReference_1_UnderlineType;
...
DEFINE_GUID(IID___FIReference_1_UnderlineType, 0x1b63ec17, 0x7b2b, 0x59fe, 0xab,
            0x9d, 0xb6, 0x0e, 0xa4, 0xf9, 0xc9, 0xb8);
...
IReference<ABI::Windows::UI::Text::UnderlineType>
    : IReference_impl<ABI::Windows::UI::Text::UnderlineType>{};
}
} // namespace Windows
} // namespace ABI
extern "C" {
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(__FIReference_1_UnderlineType, 0x1b63ec17, 0x7b2b, 0x59fe, 0xab,
                0x9d, 0xb6, 0x0e, 0xa4, 0xf9, 0xc9, 0xb8)
#endif
#else
typedef struct __FIReference_1_UnderlineTypeVtbl {
  ...
  HRESULT(STDMETHODCALLTYPE *QueryInterface)(
      __FIReference_1_UnderlineType *This, REFIID riid, void **ppvObject);
  ULONG(STDMETHODCALLTYPE *AddRef)(__FIReference_1_UnderlineType *This);
  ULONG(STDMETHODCALLTYPE *Release)(__FIReference_1_UnderlineType *This);
  /*** IInspectable methods ***/
  HRESULT(STDMETHODCALLTYPE *GetIids)(__FIReference_1_UnderlineType *This,
                                      ULONG *iidCount, IID **iids);
  HRESULT(STDMETHODCALLTYPE *GetRuntimeClassName)(
      __FIReference_1_UnderlineType *This, HSTRING *className);
  HRESULT(STDMETHODCALLTYPE *GetTrustLevel)(__FIReference_1_UnderlineType *This,
...
/*** IUnknown methods ***/
#define __FIReference_1_UnderlineType_QueryInterface(This, riid, ppvObject)    \
  (This)->lpVtbl->QueryInterface(This, riid, ppvObject)
#define __FIReference_1_UnderlineType_AddRef(This) (This)->lpVtbl->AddRef(This)
#define __FIReference_1_UnderlineType_Release(This)                            \
  (This)->lpVtbl->Release(This)
/*** IInspectable methods ***/
#define __FIReference_1_UnderlineType_GetIids(This, iidCount, iids)            \
  (This)->lpVtbl->GetIids(This, iidCount, iids)
#define __FIReference_1_UnderlineType_GetRuntimeClassName(This, className)     \
  (This)->lpVtbl->GetRuntimeClassName(This, className)
#define __FIReference_1_UnderlineType_GetTrustLevel(This, trustLevel)          \
  (This)->lpVtbl->GetTrustLevel(This, trustLevel)
/*** IReference<ABI::Windows::UI::Text::UnderlineType > methods ***/
#define __FIReference_1_UnderlineType_get_Value(This, value)                   \
  (This)->lpVtbl->get_Value(This, value)
#else
/*** IUnknown methods ***/
static inline HRESULT __FIReference_1_UnderlineType_QueryInterface(
    __FIReference_1_UnderlineType *This, REFIID riid, void **ppvObject) {
  return This->lpVtbl->QueryInterface(This, riid, ppvObject);
}
static inline ULONG
__FIReference_1_UnderlineType_AddRef(__FIReference_1_UnderlineType *This) {
  return This->lpVtbl->AddRef(This);
}
static inline ULONG
__FIReference_1_UnderlineType_Release(__FIReference_1_UnderlineType *This) {
  return This->lpVtbl->Release(This);
}
/*** IInspectable methods ***/
static inline HRESULT
__FIReference_1_UnderlineType_GetIids(__FIReference_1_UnderlineType *This,
                                      ULONG *iidCount, IID **iids) {
  return This->lpVtbl->GetIids(This, iidCount, iids);
}
static inline HRESULT __FIReference_1_UnderlineType_GetRuntimeClassName(
    __FIReference_1_UnderlineType *This, HSTRING *className) {
  return This->lpVtbl->GetRuntimeClassName(This, className);
}
static inline HRESULT
__FIReference_1_UnderlineType_GetTrustLevel(__FIReference_1_UnderlineType *This,
                                            TrustLevel *trustLevel) {
  return This->lpVtbl->GetTrustLevel(This, trustLevel);
}
/*** IReference<ABI::Windows::UI::Text::UnderlineType > methods ***/
static inline HRESULT __FIReference_1_UnderlineType_get_Value(
    __FIReference_1_UnderlineType *This,
    __x_ABI_CWindows_CUI_CText_CUnderlineType *value) {
...
#define IReference_UnderlineType_QueryInterface                                \
  __FIReference_1_UnderlineType_QueryInterface
...
#define IReference_UnderlineType_GetRuntimeClassName                           \
  __FIReference_1_UnderlineType_GetRuntimeClassName
#define IReference_UnderlineType_GetTrustLevel                                 \
  __FIReference_1_UnderlineType_GetTrustLevel
#define IReference_UnderlineType_get_Value                                     \
  __FIReference_1_UnderlineType_get_Value
