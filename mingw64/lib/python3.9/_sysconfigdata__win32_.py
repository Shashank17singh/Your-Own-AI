...
build_time_vars = {
    ...
    "CONFINCLUDEDIR": ""
    + os.path.abspath(os.path.dirname(os.path.abspath(__file__)))
    + "/share/python/include",
    "CONFINCLUDEPY": ""
    + os.path.abspath(os.path.dirname(os.path.abspath(__file__)))
    + "/share/python/include/python3.9",
    "COREPYTHONPATH": "",
    ...
    ""
    + os.path.abspath(os.path.dirname(os.path.abspath(__file__)))
    + "/share/python/lib/python3.9/lib-dynload",
    "DESTLIB": ""
    + os.path.abspath(os.path.dirname(os.path.abspath(__file__)))
    + "/share/python/lib/python3.9",
    "DESTPATH": "",
    ...
    "LIBPC": ""
    + os.path.abspath(os.path.dirname(os.path.abspath(__file__)))
    + "/share/python/lib/pkgconfig",
    "LIBPL": ""
    + os.path.abspath(os.path.dirname(os.path.abspath(__file__)))
    + "/share/python/lib/python3.9/config-3.9",
    ...
    "VENVLAUNCHERDIR": ""
    + os.path.abspath(os.path.dirname(os.path.abspath(__file__)))
    + "/share/python/lib/python3.9/venv/scripts/nt",
    "VERSION": "3.9",
