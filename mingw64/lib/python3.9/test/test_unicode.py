...
class UnicodeTest(
    ...
    def test_maketrans_translate(self):
        ...
        self.assertEqual("[a]".translate(str.maketrans({"a": "\xe9"})), "[\xe9]")
        self.assertEqual(
            "axb".translate(str.maketrans({"a": None, "b": "123"})), "x123"
        )
        self.assertEqual(
            "axb".translate(str.maketrans({"a": None, "b": "\xe9"})), "x\xe9"
        )

        # test non-ASCII (don't take the fast-path)
        self.assertEqual("[a]".translate(str.maketrans({"a": "<\xe9>"})), "[<\xe9>]")
        self.assertEqual("[\xe9]".translate(str.maketrans({"\xe9": "a"})), "[a]")
        self.assertEqual("[\xe9]".translate(str.maketrans({"\xe9": None})), "[]")
        self.assertEqual("[\xe9]".translate(str.maketrans({"\xe9": "123"})), "[123]")
        self.assertEqual(
            "[a\xe9]".translate(str.maketrans({"a": "<\u20ac>"})), "[<\u20ac>\xe9]"
        )
    ...
    def test_isspace_invariant(self):
        for codepoint in range(sys.maxunicode + 1):
            ...
            self.assertEqual(
                char.isspace(), (bidirectional in ("WS", "B", "S") or category == "Zs")
            )
    ...
    def test_lower(self):
        ...
        self.assertEqual("\U00010427\U00010427".lower(), "\U0001044f\U0001044f")
        self.assertEqual("\U00010427\U0001044f".lower(), "\U0001044f\U0001044f")
        self.assertEqual("X\U00010427x\U0001044f".lower(), "x\U0001044fx\U0001044f")
    ...
    def test_upper(self):
        ...
        self.assertEqual("\U0001044f\U0001044f".upper(), "\U00010427\U00010427")
        self.assertEqual("\U00010427\U0001044f".upper(), "\U00010427\U00010427")
        self.assertEqual("X\U00010427x\U0001044f".upper(), "X\U00010427X\U00010427")
    ...
    def test_capitalize(self):
        ...
        self.assertEqual("\U0001044f\U0001044f".capitalize(), "\U00010427\U0001044f")
        self.assertEqual("\U00010427\U0001044f".capitalize(), "\U00010427\U0001044f")
        self.assertEqual("\U0001044f\U00010427".capitalize(), "\U00010427\U0001044f")
        self.assertEqual(
            "X\U00010427x\U0001044f".capitalize(), "X\U0001044fx\U0001044f"
        )
    ...
    def test_title(self):
        ...
        self.assertEqual("\U0001044f\U0001044f".title(), "\U00010427\U0001044f")
        self.assertEqual(
            "\U0001044f\U0001044f \U0001044f\U0001044f".title(),
            "\U00010427\U0001044f \U00010427\U0001044f",
        )
        self.assertEqual(
            "\U00010427\U0001044f \U00010427\U0001044f".title(),
            "\U00010427\U0001044f \U00010427\U0001044f",
        )
        self.assertEqual(
            "\U0001044f\U00010427 \U0001044f\U00010427".title(),
            "\U00010427\U0001044f \U00010427\U0001044f",
        )
        self.assertEqual(
            "X\U00010427x\U0001044f X\U00010427x\U0001044f".title(),
    ...
    def test_utf8_decode_invalid_sequences(self):
        ...
        invalid_start_bytes = (
            ...
            + [bytes([x]) for x in range(0xF7, 0x100)]
        )
        ...
        for sb in invalid_4B_seq_start_bytes:
            for cb1 in continuation_bytes[:3]:
                for cb3 in continuation_bytes[:3]:
                    self.assertRaises(
                        UnicodeDecodeError, (sb + cb1 + b"\x80" + cb3).decode, "utf-8"
                    )
    ...
    def assertCorrectUTF8Decoding(self, seq, res, err):
        ...
        self.assertEqual(seq.decode("utf-8", "replace"), res)
        self.assertEqual(
            (b"aaaa" + seq + b"bbbb").decode("utf-8", "replace"), "aaaa" + res + "bbbb"
        )
        res = res.replace("\ufffd", "")
    ...
    def test_ucs4(self):
        ...
        try:
            rb"\U11111111".decode("raw-unicode-escape")
...
class CAPITest(unittest.TestCase):
    ...
    def test_from_format(self):
        ...
        check_format("ascii\x7f=unicode\xe9", b"ascii\x7f=%U", "unicode\xe9")
        ...
        # test "%c"
        check_format("\uabcd", b"%c", c_int(0xABCD))
        check_format("\U0010ffff", b"%c", c_int(0x10FFFF))
        with self.assertRaises(OverflowError):
            PyUnicode_FromFormat(b"%c", c_int(0x110000))
        # Issue #18183
        check_format("\U00010000\U00100000", b"%c%c", c_int(0x10000), c_int(0x100000))
        ...
        check_format("123".rjust(10, "0"), b"%010x", c_int(0x123))
        check_format("123".rjust(100), b"%100x", c_int(0x123))
        check_format("123".rjust(100, "0"), b"%.100x", c_int(0x123))
        check_format("123".rjust(80, "0").rjust(100), b"%100.80x", c_int(0x123))

        # test %A
        check_format(
            r"%A:'abc\xe9\uabcd\U0010ffff'", b"%%A:%A", "abc\xe9\uabcd\U0010ffff"
        )
        ...
        for idx, from_ in enumerate(strings):
            ...
            for from_start in range(5):
                self.assertEqual(
                    ...
                    (from_[from_start : from_start + 5].ljust(5, "\0"), 5 - from_start),
                )
            for to_start in range(5):
                self.assertEqual(
                    unicode_copycharacters(from_, to_start, from_, to_start, 5),
                    (from_[to_start : to_start + 5].rjust(5, "\0"), 5 - to_start),
                )
            # narrow -> wide
    ...
    def test_encode_decimal(self):
        ...
        self.assertEqual(
            unicode_encodedecimal("\N{EM SPACE}3.14\N{EN SPACE}"), b" 3.14 "
        )
        self.assertRaises(
    ...
    def test_transform_decimal(self):
        ...
        self.assertEqual(
            transform_decimal("\N{EM SPACE}3.14\N{EN SPACE}"),
