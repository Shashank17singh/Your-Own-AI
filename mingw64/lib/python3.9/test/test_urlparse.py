...
class UrlParseTestCase(unittest.TestCase):
    ...
    def test_urlsplit_remove_unsafe_bytes(self):
        ...
        self.assertEqual(
            p.geturl(),
            "http://www.python.org/javascript:alert('msg')/?query=something#fragment",
        )
        ...
        self.assertEqual(
            p.geturl(),
            b"http://www.python.org/javascript:alert('msg')/?query=something#fragment",
        )
    ...
    def test_parse_qs_encoding(self):
        ...
        result = urllib.parse.parse_qs(
            "key=\u0141%E9-", encoding="ascii", errors="ignore"
        )
        self.assertEqual(result, {"key": ["\u0141-"]})
