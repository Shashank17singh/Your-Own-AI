    ...
    def test_return_null_without_error(self):
        ...
        if Py_DEBUG:
            ...
            self.assertRegex(
                ...
                rb"a function returned NULL "
                rb"without setting an error\n"
                rb"Python runtime state: initialized\n"
                rb"SystemError: <built-in function "
                rb"return_null_without_error> returned NULL "
                rb"without setting an error\n"
                rb"\n"
                rb"Current thread.*:\n"
                rb'  File .*", line 6 in <module>',
            )
        else:
    ...
    def test_return_result_with_error(self):
        ...
        if Py_DEBUG:
            ...
            self.assertRegex(
                err.replace(b"\r", b""),
                rb"Fatal Python error: _Py_CheckFunctionResult: "
                rb"a function returned a result "
                rb"with an error set\n"
                rb"Python runtime state: initialized\n"
                rb"ValueError\n"
                rb"\n"
                rb"The above exception was the direct cause "
                rb"of the following exception:\n"
                rb"\n"
                rb"SystemError: <built-in "
                rb"function return_result_with_error> "
                rb"returned a result with an error set\n"
                rb"\n"
                rb"Current thread.*:\n"
                rb"  File .*, line 6 in <module>",
            )
...
class PyMemDebugTests(unittest.TestCase):
    ...
    def check_malloc_without_gil(self, code):
        out = self.check(code)
        expected = (
            "Fatal Python error: _PyMem_DebugMalloc: "
