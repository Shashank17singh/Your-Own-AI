...
class KeywordOnly_TestCase(unittest.TestCase):
    ...
    def test_required_args(self):
        ...
        with self.assertRaisesRegex(
            TypeError, r"function missing required argument 'required' \(pos 1\)"
        ):
    ...
    def test_too_many_args(self):
        with self.assertRaisesRegex(
            TypeError, r"function takes at most 2 positional arguments \(3 given\)"
        ):
            getargs_keyword_only(1, 2, 3)

        with self.assertRaisesRegex(
            TypeError, r"function takes at most 3 arguments \(4 given\)"
        ):
...
class PositionalOnlyAndKeywords_TestCase(unittest.TestCase):
    ...
    def test_required_args(self):
        ...
        with self.assertRaisesRegex(
            TypeError, r"function takes at least 1 positional argument \(0 given\)"
        ):
            self.getargs()
...
class ParseTupleAndKeywords_Test(unittest.TestCase):
    ...
    def test_positional_only(self):
        ...
        parse((1, 2), {"a": 3}, "OOO", ["", "", "a"])
        with self.assertRaisesRegex(
            TypeError, r"function takes at least 2 positional arguments \(1 given\)"
        ):
            parse((1,), {"a": 3}, "OOO", ["", "", "a"])
        parse((1,), {}, "O|OO", ["", "", "a"])
        with self.assertRaisesRegex(
        ...
        with self.assertRaisesRegex(
            TypeError, r"function takes exactly 2 positional arguments \(1 given\)"
        ):
            parse((1,), {"a": 3}, "OO$O", ["", "", "a"])
        parse((1,), {}, "O|O$O", ["", "", "a"])
        with self.assertRaisesRegex(
