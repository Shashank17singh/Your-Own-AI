...
class TclTest(unittest.TestCase):
    ...
    def test_getint(self):
        ...
        self.assertRaises((TypeError, ValueError, TclError), tcl.getint, "42\0")
        self.assertRaises(
    ...
    def test_getdouble(self):
        ...
        self.assertRaises((TypeError, ValueError, TclError), tcl.getdouble, "42.5\0")
        self.assertRaises(
    ...
    def test_getboolean(self):
        ...
        self.assertRaises((TypeError, ValueError, TclError), tcl.getboolean, "on\0")
        self.assertRaises(
    ...
    def test_passing_values(self):
        ...
        self.assertEqual(passValue("str\x00ing\u20ac"), "str\x00ing\u20ac")
        self.assertEqual(passValue("str\x00ing\U0001f4bb"), "str\x00ing\U0001f4bb")
    ...
    def test_split(self):
        ...
        with warnings.catch_warnings():
            warnings.filterwarnings(
                "ignore", r"\bsplit\b.*\bsplitlist\b", DeprecationWarning
            )
