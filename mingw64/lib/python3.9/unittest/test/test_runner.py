...
class TestClassCleanup(unittest.TestCase):
    ...
    def test_debug_executes_classCleanUp(self):
        ...
        self.assertEqual(
            ordering, ["setUpClass", "test", "tearDownClass", "cleanup_exc"]
        )
...
class TestModuleCleanUp(unittest.TestCase):
    ...
    def test_run_module_cleanUp_without_teardown(self):
        ...
        self.assertEqual(
            ordering,
            ["setUpModule", "setUpClass", "test", "tearDownClass", "cleanup_good"],
        )
        self.assertEqual(unittest.case._module_cleanups, [])
    ...
    def test_debug_module_cleanUp_when_teardown_exception(self):
        ...
        self.assertEqual(
            ordering, ["setUpModule", "setUpClass", "test", "tearDownClass"]
        )
    ...
    def test_with_errors_in_addModuleCleanup_and_setUps(self):
        ...
        method_blow_up = False
        result = runTests(TestableTest)
        self.assertEqual(result.errors[0][1].splitlines()[-1], "Exception: ModuleExc")
        self.assertEqual(result.errors[1][1].splitlines()[-1], "Exception: CleanUpExc")
