...
extern void lhd_print_error_function(diagnostics::text_sink &, const char *,
...
#define LANG_HOOKS_OVERWRITE_DECL_ASSEMBLER_NAME                               \
...
#define LANG_HOOKS_OMP_EXTRACT_MAPPER_DIRECTIVE lhd_omp_extract_mapper_directive
