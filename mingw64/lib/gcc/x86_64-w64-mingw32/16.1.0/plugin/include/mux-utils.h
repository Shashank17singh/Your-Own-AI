...
template <typename T1, typename T2 = T1> class pointer_mux {
public:
  ...
  template <typename T> T as_a() const;
...
inline pointer_mux<T1, T2> pointer_mux<T1, T2>::first(T1 *ptr) {
  gcc_checking_assert(!(uintptr_t(ptr) & 1));
  return reinterpret_cast<char *>(ptr);
}

template <typename T1, typename T2>
inline pointer_mux<T1, T2> pointer_mux<T1, T2>::second(T2 *ptr) {
...
template <typename T1, typename T2>
inline T1 *pointer_mux<T1, T2>::first_or_null() const {
  return is_first() ? known_first() : nullptr;
}

template <typename T1, typename T2>
inline T2 *pointer_mux<T1, T2>::second_or_null() const {
...
template <typename T1, typename T2>
template <typename T>
inline bool pointer_mux<T1, T2>::is_a() const {
...
template <typename T1, typename T2>
template <typename T>
inline T pointer_mux<T1, T2>::as_a() const {
  static_assert(std::is_convertible<T1 *, T>::value !=
                    std::is_convertible<T2 *, T>::value,
                "Ambiguous pointer type");
  if (std::is_convertible<T2 *, T>::value) {
...
template <typename T1, typename T2>
template <typename T>
inline T pointer_mux<T1, T2>::dyn_cast() const {
  static_assert(std::is_convertible<T1 *, T>::value !=
                    std::is_convertible<T2 *, T>::value,
                "Ambiguous pointer type");
  if (std::is_convertible<T2 *, T>::value) {
