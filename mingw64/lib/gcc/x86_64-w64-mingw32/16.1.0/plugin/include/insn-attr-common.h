...
enum attr_avx_partial_xmm_update {
  AVX_PARTIAL_XMM_UPDATE_FALSE,
...
enum attr_athlon_decode {
  ...
  ATHLON_DECODE_DOUBLE
};
enum attr_amdfam10_decode {
  AMDFAM10_DECODE_DIRECT,
  AMDFAM10_DECODE_VECTOR,
  AMDFAM10_DECODE_DOUBLE
};
enum attr_bdver1_decode {
  BDVER1_DECODE_DIRECT,
  BDVER1_DECODE_VECTOR,
  BDVER1_DECODE_DOUBLE
};
enum attr_btver2_decode {
  BTVER2_DECODE_DIRECT,
  BTVER2_DECODE_VECTOR,
  BTVER2_DECODE_DOUBLE
};
enum attr_btver2_sse_attr {
  BTVER2_SSE_ATTR_OTHER,
  BTVER2_SSE_ATTR_RCP,
  BTVER2_SSE_ATTR_SQRT,
  BTVER2_SSE_ATTR_MAXMIN
};
enum attr_znver1_decode {
  ZNVER1_DECODE_DIRECT,
  ZNVER1_DECODE_VECTOR,
  ZNVER1_DECODE_DOUBLE
};
enum attr_znver4_decode {
  ZNVER4_DECODE_DIRECT,
  ZNVER4_DECODE_VECTOR,
  ZNVER4_DECODE_DOUBLE
};
enum attr_atom_unit {
  ATOM_UNIT_SISHUF,
  ATOM_UNIT_SIMUL,
...
enum attr_atom_sse_attr {
  ATOM_SSE_ATTR_RCP,
  ATOM_SSE_ATTR_MOVDUP,
  ATOM_SSE_ATTR_LFENCE,
  ATOM_SSE_ATTR_FENCE,
  ATOM_SSE_ATTR_PREFETCH,
  ATOM_SSE_ATTR_SQRT,
  ATOM_SSE_ATTR_MXCSR,
  ATOM_SSE_ATTR_OTHER
};
...
enum attr_round_saeonly_expand {
  ROUND_SAEONLY_EXPAND_NO,
  ROUND_SAEONLY_EXPAND_YES
};
...
enum attr_round_saeonly_scalar {
  ROUND_SAEONLY_SCALAR_NO,
  ROUND_SAEONLY_SCALAR_YES
};
