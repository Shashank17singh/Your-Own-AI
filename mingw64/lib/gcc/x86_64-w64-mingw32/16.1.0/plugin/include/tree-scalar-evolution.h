...
inline basic_block block_before_loop(loop_p loop) {
...
inline tree instantiate_parameters(class loop *loop, tree chrec) {
  return instantiate_scev(loop_preheader_edge(loop), loop, chrec);
}

/* Returns the loop of the polynomial chrec CHREC.  */

inline class loop *get_chrec_loop(const_tree chrec) {
