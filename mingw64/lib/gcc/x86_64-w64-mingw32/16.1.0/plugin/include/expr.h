...
extern rtx convert_modes(machine_mode mode, machine_mode oldmode, rtx x,
                         int unsignedp);
...
inline rtx emit_block_copy_via_libcall(rtx dst, rtx src, rtx size,
                                       bool tailcall = false) {
  return emit_block_op_via_libcall(BUILT_IN_MEMCPY, dst, src, size, tailcall);
}

inline rtx emit_block_move_via_libcall(rtx dst, rtx src, rtx size,
                                       bool tailcall = false) {
  return emit_block_op_via_libcall(BUILT_IN_MEMMOVE, dst, src, size, tailcall);
}

inline rtx emit_block_comp_via_libcall(rtx dst, rtx src, rtx size,
                                       bool tailcall = false) {
...
extern rtx emit_block_move(rtx, rtx, rtx, enum block_op_methods,
                           unsigned ctz_size = 0);
extern rtx
emit_block_move_hints(rtx, rtx, rtx, enum block_op_methods, unsigned int,
                      HOST_WIDE_INT, unsigned HOST_WIDE_INT,
                      unsigned HOST_WIDE_INT, unsigned HOST_WIDE_INT,
                      bool bail_out_libcall = false, bool *is_move_done = NULL,
                      bool might_overlap = false, unsigned ctz_size = 0);
...
/* Mark REG as holding a parameter for the next CALL_INSN.  */
inline void use_reg(rtx *fusage, rtx reg) {
  use_reg_mode(fusage, reg, VOIDmode);
}

/* Mark REG as clobbered by the call with FUSAGE as CALL_INSN_FUNCTION_USAGE. */
inline void clobber_reg(rtx *fusage, rtx reg) {
...
extern rtx clear_storage_hints(rtx, rtx, enum block_op_methods, unsigned int,
                               HOST_WIDE_INT, unsigned HOST_WIDE_INT,
                               unsigned HOST_WIDE_INT, unsigned HOST_WIDE_INT,
                               unsigned);
...
extern bool set_storage_via_setmem(rtx, rtx, rtx, unsigned int, unsigned int,
                                   HOST_WIDE_INT, unsigned HOST_WIDE_INT,
...
/* Return true if it is desirable to store LEN bytes generated by
   ...
   of a const string.  */
extern bool can_store_by_pieces(unsigned HOST_WIDE_INT, by_pieces_constfn,
...
extern bool try_store_by_multiple_pieces(rtx to, rtx len, unsigned int ctz_len,
...
extern bool emit_push_insn(rtx, machine_mode, tree, rtx, unsigned int, int, rtx,
                           poly_int64, rtx, rtx, int, rtx, bool);
...
extern rtx expand_expr_real(tree, rtx, machine_mode, enum expand_modifier,
                            rtx *, bool);
extern rtx expand_expr_real_1(tree, rtx, machine_mode, enum expand_modifier,
                              rtx *, bool);
...
inline rtx expand_expr(tree exp, rtx target, machine_mode mode,
                       enum expand_modifier modifier) {
  return expand_expr_real(exp, target, mode, modifier, NULL, false);
}

inline rtx expand_normal(tree exp) {
