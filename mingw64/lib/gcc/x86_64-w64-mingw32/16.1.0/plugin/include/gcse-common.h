...
extern void compute_transp(const_rtx, int, sbitmap *, bitmap, bitmap,
                           vec<modify_pair> *);
extern void record_last_mem_set_info_common(rtx_insn *, vec<rtx_insn *> *,
                                            vec<modify_pair> *, bitmap, bitmap);
