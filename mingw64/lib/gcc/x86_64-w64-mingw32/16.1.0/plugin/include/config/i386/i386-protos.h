...
extern bool ix86_expand_set_or_cpymem(rtx, rtx, rtx, rtx, rtx, rtx, rtx, rtx,
                                      rtx, rtx, bool);
...
extern rtx ix86_fixup_binary_operands(enum rtx_code, machine_mode, rtx[],
                                      bool = false);
extern void ix86_fixup_binary_operands_no_copy(enum rtx_code, machine_mode,
                                               rtx[], bool = false);
extern void ix86_expand_binary_operator(enum rtx_code, machine_mode, rtx[],
                                        bool = false);
extern bool ix86_binary_operator_ok(enum rtx_code, machine_mode, rtx[3],
                                    bool = false);
extern void ix86_expand_unary_operator(enum rtx_code, machine_mode, rtx[],
                                       bool = false);
extern bool ix86_unary_operator_ok(enum rtx_code, machine_mode, rtx[2],
                                   bool = false);
extern void ix86_expand_vector_logical_operator(enum rtx_code, machine_mode,
                                                rtx[]);
...
extern void ix86_expand_fp_absneg_operator(enum rtx_code, machine_mode, rtx[]);
extern void ix86_split_fp_absneg_operator(enum rtx_code, machine_mode, rtx[]);
...
extern void ix86_expand_atomic_fetch_op_loop(rtx, rtx, rtx, enum rtx_code, bool,
                                             bool);
extern void ix86_expand_cmpxchg_loop(rtx *, rtx, rtx, rtx, rtx, rtx, bool,
                                     rtx_code_label *);
extern rtx ix86_expand_fast_convert_bf_to_sf(rtx);
extern rtx ix86_gen_ccmp_first(rtx_insn **, rtx_insn **, enum rtx_code, tree,
                               tree);
extern rtx ix86_gen_ccmp_next(rtx_insn **, rtx_insn **, rtx, enum rtx_code,
                              tree, tree, enum rtx_code);
...
extern unsigned int ix86_local_alignment(tree, machine_mode, unsigned int,
                                         bool = false);
extern unsigned int ix86_minimum_alignment(tree, machine_mode, unsigned int);
extern tree ix86_handle_shared_attribute(tree *, tree, tree, int, bool *);
extern int x86_field_alignment(tree, int);
extern tree ix86_valid_target_attribute_tree(tree, tree, struct gcc_options *,
...
extern bool ix86_expand_vector_init_duplicate(bool, machine_mode, rtx, rtx);
extern bool ix86_expand_vector_init_one_nonzero(bool, machine_mode, rtx, rtx,
                                                int);
...
extern void i386_pe_asm_output_aligned_decl_common(FILE *, tree, const char *,
                                                   HOST_WIDE_INT,
                                                   HOST_WIDE_INT);
...
extern rtl_opt_pass *make_pass_insert_endbr_and_patchable_area(gcc::context *);
extern rtl_opt_pass *make_pass_remove_partial_avx_dependency(gcc::context *);
