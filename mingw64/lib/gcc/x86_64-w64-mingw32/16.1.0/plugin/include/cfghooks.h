...
struct cfg_hooks {
  ...
  void (*dump_bb_as_sarif_properties)(diagnostics::sarif_builder *,
...
inline void checking_verify_flow_info(void) {
...
extern bool cfg_hook_duplicate_loop_body_to_header_edge(
    class loop *loop, edge, unsigned int ndupl, sbitmap wont_exit, edge orig,
...
extern void copy_bbs(basic_block *, unsigned, basic_block *, edge *, unsigned,
                     edge *, class loop *, basic_block, bool);
