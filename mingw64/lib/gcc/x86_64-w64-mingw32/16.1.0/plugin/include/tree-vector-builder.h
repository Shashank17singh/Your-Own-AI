...
class tree_vector_builder
    : public vector_builder<tree, tree, tree_vector_builder> {
...
private:
  ...
  static poly_uint64 nelts_of(const_tree t) { return VECTOR_CST_NELTS(t); }
...
inline tree_vector_builder::tree_vector_builder(
    tree type, unsigned int npatterns, unsigned int nelts_per_pattern) {
...
inline bool tree_vector_builder::equal_p(const_tree elt1,
...
inline wide_int tree_vector_builder::step(const_tree elt1,
                                          const_tree elt2) const {
...
inline void tree_vector_builder::note_representative(tree *elt1_ptr,
                                                     tree elt2) {
