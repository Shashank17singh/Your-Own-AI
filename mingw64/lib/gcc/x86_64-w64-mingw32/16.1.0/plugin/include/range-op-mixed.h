...
bool minus_op1_op2_relation_effect(irange &lhs_range, tree type, const irange &,
                                   const irange &, relation_kind rel);

// Return TRUE if 0 is within [WMIN, WMAX].

inline bool wi_includes_zero_p(tree type, const wide_int &wmin,
                               const wide_int &wmax) {
...
inline bool wi_zero_p(tree type, const wide_int &wmin, const wide_int &wmax) {
...
inline bool empty_range_varying(vrange &r, tree type, const vrange &op1,
                                const vrange &op2) {
...
inline bool relop_early_resolve(irange &r, tree type, const vrange &op1,
...
public:
  ...
  bool fold_range(irange &r, tree type, const irange &op1, const irange &op2,
                  relation_trio = TRIO_VARYING) const final override;
  bool fold_range(irange &r, tree type, const prange &op1, const prange &op2,
                  relation_trio = TRIO_VARYING) const final override;
  bool fold_range(irange &r, tree type, const frange &op1, const frange &op2,
                  relation_trio = TRIO_VARYING) const final override;

  bool op1_range(irange &r, tree type, const irange &lhs, const irange &val,
                 relation_trio = TRIO_VARYING) const final override;
  bool op1_range(prange &r, tree type, const irange &lhs, const prange &val,
                 relation_trio = TRIO_VARYING) const final override;
  bool op1_range(frange &r, tree type, const irange &lhs, const frange &op2,
                 relation_trio = TRIO_VARYING) const final override;

  bool op2_range(irange &r, tree type, const irange &lhs, const irange &val,
                 relation_trio = TRIO_VARYING) const final override;
  bool op2_range(prange &r, tree type, const irange &lhs, const prange &val,
                 relation_trio = TRIO_VARYING) const final override;
  bool op2_range(frange &r, tree type, const irange &lhs, const frange &op1,
...
public:
  ...
  bool op1_range(irange &r, tree type, const irange &lhs, const irange &op2,
                 relation_trio = TRIO_VARYING) const final override;
  bool op1_range(prange &r, tree type, const irange &lhs, const prange &op2,
                 relation_trio = TRIO_VARYING) const final override;
  bool op1_range(frange &r, tree type, const irange &lhs, const frange &op2,
                 relation_trio = TRIO_VARYING) const final override;

  bool op2_range(irange &r, tree type, const irange &lhs, const irange &op1,
                 relation_trio = TRIO_VARYING) const final override;
  bool op2_range(prange &r, tree type, const irange &lhs, const prange &op1,
                 relation_trio = TRIO_VARYING) const final override;
  bool op2_range(frange &r, tree type, const irange &lhs, const frange &op1,
                 relation_trio = TRIO_VARYING) const final override;
...
public:
  ...
  bool fold_range(irange &r, tree type, const irange &op1, const irange &op2,
                  relation_trio rel = TRIO_VARYING) const final override;
  bool fold_range(prange &r, tree type, const prange &op1, const prange &op2,
                  relation_trio rel = TRIO_VARYING) const final override;
  bool fold_range(frange &r, tree type ATTRIBUTE_UNUSED, const frange &op1,
                  const frange &op2 ATTRIBUTE_UNUSED,
                  relation_trio = TRIO_VARYING) const final override;
  bool op1_range(irange &r, tree type, const irange &lhs, const irange &op2,
                 relation_trio rel = TRIO_VARYING) const final override;
  bool op1_range(prange &r, tree type, const prange &lhs, const prange &op2,
                 relation_trio rel = TRIO_VARYING) const final override;
  bool op1_range(frange &r, tree type ATTRIBUTE_UNUSED, const frange &lhs,
                 const frange &op2 ATTRIBUTE_UNUSED,
                 relation_trio = TRIO_VARYING) const final override;
  relation_kind lhs_op1_relation(const irange &lhs, const irange &op1,
                                 const irange &op2,
                                 relation_kind rel) const final override;
  relation_kind lhs_op1_relation(const prange &lhs, const prange &op1,
                                 const prange &op2,
                                 relation_kind rel) const final override;
};
...
public:
  ...
  bool fold_range(prange &r, tree type, const prange &op1, const prange &op2,
                  relation_trio rel = TRIO_VARYING) const final override;
  bool fold_range(frange &r, tree type, const frange &op1, const frange &op2,
                  relation_trio = TRIO_VARYING) const final override;
};
...
public:
  ...
  bool fold_range(prange &r, tree type, const prange &op1, const prange &op2,
                  relation_trio rel = TRIO_VARYING) const final override;
  bool fold_range(irange &r, tree type, const prange &op1, const irange &op2,
                  relation_trio rel = TRIO_VARYING) const final override;
  bool fold_range(prange &r, tree type, const irange &op1, const prange &op2,
                  relation_trio rel = TRIO_VARYING) const final override;
  bool fold_range(frange &r, tree type, const frange &op1, const frange &op2,
                  relation_trio = TRIO_VARYING) const final override;
  bool fold_range(irange &r, tree type, const frange &op1, const irange &op2,
                  relation_trio = TRIO_VARYING) const final override;
  bool fold_range(frange &r, tree type, const irange &op1, const frange &op2,
                  relation_trio = TRIO_VARYING) const final override;
  ...
  bool op1_range(prange &r, tree type, const prange &lhs, const prange &op2,
                 relation_trio rel = TRIO_VARYING) const final override;
  bool op1_range(irange &r, tree type, const prange &lhs, const irange &op2,
                 relation_trio rel = TRIO_VARYING) const final override;
  bool op1_range(prange &r, tree type, const irange &lhs, const prange &op2,
                 relation_trio rel = TRIO_VARYING) const final override;
  bool op1_range(frange &r, tree type, const frange &lhs, const frange &op2,
                 relation_trio = TRIO_VARYING) const final override;
  bool op1_range(frange &r, tree type, const irange &lhs, const frange &op2,
                 relation_trio = TRIO_VARYING) const final override;
  bool op1_range(irange &r, tree type, const frange &lhs, const irange &op2,
                 relation_trio = TRIO_VARYING) const final override;
  ...
  relation_kind lhs_op1_relation(const prange &lhs, const prange &op1,
                                 const prange &op2,
                                 relation_kind) const final override;
  relation_kind lhs_op1_relation(const prange &lhs, const irange &op1,
                                 const irange &op2,
                                 relation_kind) const final override;
  relation_kind lhs_op1_relation(const irange &lhs, const prange &op1,
                                 const prange &op2,
                                 relation_kind) const final override;
  void update_bitmask(irange &r, const irange &lh,
                      const irange &rh) const final override;
...
public:
  ...
  bool op2_range(irange &r, tree type, const irange &lhs, const irange &op1,
                 relation_trio) const final override;
  bool op2_range(frange &r, tree type, const frange &lhs, const frange &op1,
                 relation_trio = TRIO_VARYING) const final override;
...
private:
  ...
  void rv_fold(frange &r, tree type, const REAL_VALUE_TYPE &lh_lb,
               const REAL_VALUE_TYPE &lh_ub, const REAL_VALUE_TYPE &rh_lb,
...
public:
  ...
  using range_operator::op1_range;
  using range_operator::update_bitmask;
  bool fold_range(frange &r, tree type, const frange &op1, const frange &,
                  relation_trio = TRIO_VARYING) const final override;
...
public:
  ...
  bool op1_op2_relation_effect(irange &lhs_range, tree type,
                               const irange &op1_range, const irange &op2_range,
                               relation_kind rel) const final override;
  void update_bitmask(irange &r, const irange &lh,
                      const irange &rh) const final override;
...
public:
  virtual bool wi_op_overflows(wide_int &r, tree type, const wide_int &,
                               const wide_int &) const = 0;
  void wi_cross_product(irange &r, tree type, const wide_int &lh_lb,
                        const wide_int &lh_ub, const wide_int &rh_lb,
...
public:
  ...
  using range_operator::op1_range;
  using range_operator::update_bitmask;
  bool fold_range(irange &r, tree type, const irange &lh, const irange &rh,
                  relation_trio rel = TRIO_VARYING) const final override;
  bool op1_range(irange &r, tree type, const irange &lhs, const irange &op2,
                 relation_trio rel = TRIO_VARYING) const final override;
  void update_bitmask(irange &r, const irange &lh,
...
protected:
  ...
  void simple_op1_range_solver(irange &r, tree type, const irange &lhs,
