...
private:
  ...
  /* Align X to 8.  */
  static inline size_t align_eight(size_t x) { return (((x + 7) >> 3) << 3); }
...
public:
  ...
  inline void release() { m_allocator.release(); }

  inline void release_if_empty() { m_allocator.release_if_empty(); }
  ...
  inline void remove_raw(void *object) { m_allocator.remove(object); }

  inline size_t num_elts_current() { return m_allocator.num_elts_current(); }
