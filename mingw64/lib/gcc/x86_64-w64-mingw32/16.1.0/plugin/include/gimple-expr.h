...
inline bool types_compatible_p(tree type1, tree type2) {
...
inline bool is_gimple_reg_type(tree type) { return !AGGREGATE_TYPE_P(type); }

/* Return true if T is a variable.  */

inline bool is_gimple_variable(tree t) {
  return (VAR_P(t) || TREE_CODE(t) == PARM_DECL ||
          TREE_CODE(t) == RESULT_DECL || TREE_CODE(t) == SSA_NAME);
}

/*  Return true if T is a GIMPLE identifier (something with an address).  */

inline bool is_gimple_id(tree t) {
...
inline bool virtual_operand_p(tree op) {
...
inline bool is_gimple_addressable(tree t) {
...
inline bool is_gimple_constant(const_tree t) {
  switch (TREE_CODE(t)) {
  case INTEGER_CST:
  case POLY_INT_CST:
  case REAL_CST:
...
inline void extract_ops_from_tree(tree expr, enum tree_code *code, tree *op0,
                                  tree *op1) {
  tree op2;
...
inline tree gimple_call_addr_fndecl(const_tree fn) {
