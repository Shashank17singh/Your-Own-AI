...
inline tree_code code_helper::safe_as_tree_code() const {
...
inline combined_fn code_helper::safe_as_fn_code() const {
...
inline bool code_helper::is_internal_fn() const {
  return is_fn_code() && internal_fn_p(combined_fn(*this));
}

inline bool code_helper::is_builtin_fn() const {
...
#define MARK_TS_EXP(C)                                                         \
  (MARK_TS_TYPED(C), tree_contains_struct[C][TS_EXP] = true)
...
#define TREE_CHECK6(T, CODE1, CODE2, CODE3, CODE4, CODE5, CODE6)               \
  (tree_check6((T), __FILE__, __LINE__, __FUNCTION__, (CODE1), (CODE2),        \
               (CODE3), (CODE4), (CODE5), (CODE6)))

#define TREE_NOT_CHECK6(T, CODE1, CODE2, CODE3, CODE4, CODE5, CODE6)           \
  (tree_not_check6((T), __FILE__, __LINE__, __FUNCTION__, (CODE1), (CODE2),    \
                   (CODE3), (CODE4), (CODE5), (CODE6)))
...
extern void tree_not_class_check_failed(const_tree, const enum tree_code_class,
    ...
    ATTRIBUTE_NORETURN ATTRIBUTE_COLD;
extern void
tree_int_cst_elt_check_failed(int, int, const char *, int,
                              const char *) ATTRIBUTE_NORETURN ATTRIBUTE_COLD;
...
tree_operand_check_failed(int, const_tree, const char *, int,
                          const char *) ATTRIBUTE_NORETURN ATTRIBUTE_COLD;
extern void
omp_clause_check_failed(const_tree, const char *, int, const char *,
                        enum omp_clause_code) ATTRIBUTE_NORETURN ATTRIBUTE_COLD;
extern void
omp_clause_operand_check_failed(int, const_tree, const char *, int,
                                const char *) ATTRIBUTE_NORETURN ATTRIBUTE_COLD;
...
/* Label used to goto around artificial .DEFERRED_INIT code for
   ...
   v3 = .DEFERRED_INIT (...);
   lab:  */
#define VACUOUS_INIT_LABEL_P(NODE) (LABEL_DECL_CHECK(NODE)->base.nothrow_flag)
...
/* In a RAW_DATA_CST */
#define RAW_DATA_LENGTH(NODE) (RAW_DATA_CST_CHECK(NODE)->raw_data_cst.length)
#define RAW_DATA_POINTER(NODE) (RAW_DATA_CST_CHECK(NODE)->raw_data_cst.str)
#define RAW_DATA_OWNER(NODE) (RAW_DATA_CST_CHECK(NODE)->raw_data_cst.owner)
...
#define FOR_EACH_CONSTRUCTOR_VALUE(V, IX, VAL)                                 \
  for (IX = 0;                                                                 \
       (IX >= vec_safe_length(V)) ? false : ((VAL = (*(V))[IX].value), true);  \
       (IX)++)
...
#define FOR_EACH_CONSTRUCTOR_ELT(V, IX, INDEX, VAL)                            \
  for (IX = 0; (IX >= vec_safe_length(V)) ? false                              \
                                          : (((void)(VAL = (*V)[IX].value)),   \
...
#define CONSTRUCTOR_BITFIELD_P(NODE)                                           \
  (DECL_BIT_FIELD(FIELD_DECL_CHECK(NODE)) &&                                   \
   (DECL_MODE(NODE) != BLKmode || TREE_CODE(TREE_TYPE(NODE)) == BITINT_TYPE))
...
inline source_range get_expr_source_range(tree expr) {
...
#define OMP_INTEROP_CLAUSES(NODE) TREE_OPERAND(OMP_INTEROP_CHECK(NODE), 0)
...
#define OMP_METADIRECTIVE_VARIANT_SELECTOR(v) TREE_PURPOSE(v)
#define OMP_METADIRECTIVE_VARIANT_DIRECTIVE(v) TREE_PURPOSE(TREE_VALUE(v))
#define OMP_METADIRECTIVE_VARIANT_BODY(v) TREE_VALUE(TREE_VALUE(v))
...
#define OMP_CLAUSE_ITERATORS(NODE)                                             \
  OMP_CLAUSE_OPERAND(OMP_CLAUSE_RANGE_CHECK(OMP_CLAUSE_CHECK(NODE),            \
                                            OMP_CLAUSE_FROM, OMP_CLAUSE_MAP),  \
                     2)
...
#define OMP_ATOMIC_WEAK(NODE)                                                  \
  (TREE_RANGE_CHECK(NODE, OMP_ATOMIC, OMP_ATOMIC_CAPTURE_NEW)->base.public_flag)
...
#define OMP_CLAUSE_VECTOR_LENGTH_EXPR(NODE)                                    \
  OMP_CLAUSE_OPERAND(OMP_CLAUSE_SUBCODE_CHECK(NODE, OMP_CLAUSE_VECTOR_LENGTH), \
                     0)
...
#define OMP_CLAUSE_DOACROSS_KIND(NODE)                                         \
  (OMP_CLAUSE_SUBCODE_CHECK(NODE, OMP_CLAUSE_DOACROSS)                         \
...
#define OMP_CLAUSE_MOTION_PRESENT(NODE)                                        \
  (OMP_CLAUSE_RANGE_CHECK(NODE, OMP_CLAUSE_FROM, OMP_CLAUSE_TO)                \
...
#define OMP_CLAUSE_INIT_PREFER_TYPE(NODE)                                      \
  OMP_CLAUSE_OPERAND(OMP_CLAUSE_RANGE_CHECK(OMP_CLAUSE_CHECK(NODE),            \
                                            OMP_CLAUSE_INIT, OMP_CLAUSE_INIT), \
                     1)
...
#define OMP_CLAUSE_DEVICE_TYPE_KIND(NODE)                                      \
  (OMP_CLAUSE_SUBCODE_CHECK(NODE, OMP_CLAUSE_DEVICE_TYPE)                      \
...
#define OMP_CLAUSE_USES_ALLOCATORS_ALLOCATOR(NODE)                             \
  OMP_CLAUSE_OPERAND(                                                          \
      OMP_CLAUSE_SUBCODE_CHECK(NODE, OMP_CLAUSE_USES_ALLOCATORS), 0)

#define OMP_CLAUSE_USES_ALLOCATORS_MEMSPACE(NODE)                              \
  OMP_CLAUSE_OPERAND(                                                          \
      OMP_CLAUSE_SUBCODE_CHECK(NODE, OMP_CLAUSE_USES_ALLOCATORS), 1)

#define OMP_CLAUSE_USES_ALLOCATORS_TRAITS(NODE)                                \
  OMP_CLAUSE_OPERAND(                                                          \
      OMP_CLAUSE_SUBCODE_CHECK(NODE, OMP_CLAUSE_USES_ALLOCATORS), 2)
...
#define OMP_CLAUSE_DIST_SCHEDULE_CHUNK_EXPR(NODE)                              \
  OMP_CLAUSE_OPERAND(OMP_CLAUSE_SUBCODE_CHECK(NODE, OMP_CLAUSE_DIST_SCHEDULE), \
                     0)
...
#define OMP_CLAUSE_BIND_KIND(NODE)                                             \
  (OMP_CLAUSE_SUBCODE_CHECK(NODE, OMP_CLAUSE_BIND)                             \
       ->omp_clause.subcode.bind_kind)

#define OMP_CLAUSE_DYN_GROUPPRIVATE_EXPR(NODE)                                 \
  OMP_CLAUSE_OPERAND(                                                          \
      OMP_CLAUSE_SUBCODE_CHECK(NODE, OMP_CLAUSE_DYN_GROUPPRIVATE), 0)
#define OMP_CLAUSE_DYN_GROUPPRIVATE_KIND(NODE)                                 \
  (OMP_CLAUSE_SUBCODE_CHECK(NODE, OMP_CLAUSE_DYN_GROUPPRIVATE)                 \
...
#define OMP_CLAUSE__MAPPER_BINDING__ID(NODE)                                   \
  OMP_CLAUSE_OPERAND(                                                          \
      OMP_CLAUSE_SUBCODE_CHECK(NODE, OMP_CLAUSE__MAPPER_BINDING_), 0)

#define OMP_CLAUSE__MAPPER_BINDING__DECL(NODE)                                 \
  OMP_CLAUSE_OPERAND(                                                          \
      OMP_CLAUSE_SUBCODE_CHECK(NODE, OMP_CLAUSE__MAPPER_BINDING_), 1)

#define OMP_CLAUSE__MAPPER_BINDING__MAPPER(NODE)                               \
  OMP_CLAUSE_OPERAND(                                                          \
      OMP_CLAUSE_SUBCODE_CHECK(NODE, OMP_CLAUSE__MAPPER_BINDING_), 2)
...
#define OMP_ITERATOR_DECL_P(NODE)                                              \
  (TREE_CODE(NODE) == TREE_LIST && TREE_PURPOSE(NODE) &&                       \
...
#define TYPE_ALIGN(NODE)                                                       \
  (TYPE_ALIGN_RAW(NODE) ? ((unsigned)1) << (TYPE_ALIGN_RAW(NODE) - 1) : 0)
...
#define TYPE_WARN_IF_NOT_ALIGN(NODE)                                           \
  (TYPE_WARN_IF_NOT_ALIGN_RAW(NODE)                                            \
       ? ((unsigned)1) << (TYPE_WARN_IF_NOT_ALIGN_RAW(NODE) - 1)               \
       : 0)
...
#define DECL_ALIGN(NODE)                                                       \
  (DECL_ALIGN_RAW(NODE) ? ((unsigned)1) << (DECL_ALIGN_RAW(NODE) - 1) : 0)
...
#define DECL_WARN_IF_NOT_ALIGN(NODE)                                           \
  (DECL_WARN_IF_NOT_ALIGN_RAW(NODE)                                            \
       ? ((unsigned)1) << (DECL_WARN_IF_NOT_ALIGN_RAW(NODE) - 1)               \
       : 0)
...
inline void set_function_decl_type(tree decl, function_decl_type t, bool set) {
  if (set) {
...
inline tree tree_check6(tree __t, const char *__f, int __l, const char *__g,
                        enum tree_code __c1, enum tree_code __c2,
                        enum tree_code __c3, enum tree_code __c4,
                        enum tree_code __c5, enum tree_code __c6) {
  if (TREE_CODE(__t) != __c1 && TREE_CODE(__t) != __c2 &&
      TREE_CODE(__t) != __c3 && TREE_CODE(__t) != __c4 &&
      TREE_CODE(__t) != __c5 && TREE_CODE(__t) != __c6)
    tree_check_failed(__t, __f, __l, __g, __c1, __c2, __c3, __c4, __c5, __c6,
                      0);
  return __t;
}

inline tree tree_not_check6(tree __t, const char *__f, int __l, const char *__g,
                            enum tree_code __c1, enum tree_code __c2,
                            enum tree_code __c3, enum tree_code __c4,
                            enum tree_code __c5, enum tree_code __c6) {
  if (TREE_CODE(__t) == __c1 || TREE_CODE(__t) == __c2 ||
...
inline tree non_type_check(tree __t, const char *__f, int __l,
                           const char *__g) {
  if (TYPE_P(__t))
...
inline const_tree tree_check6(const_tree __t, const char *__f, int __l,
                              const char *__g, enum tree_code __c1,
                              enum tree_code __c2, enum tree_code __c3,
                              enum tree_code __c4, enum tree_code __c5,
                              enum tree_code __c6) {
...
inline const_tree tree_not_check6(const_tree __t, const char *__f, int __l,
                                  const char *__g, enum tree_code __c1,
                                  enum tree_code __c2, enum tree_code __c3,
                                  enum tree_code __c4, enum tree_code __c5,
                                  enum tree_code __c6) {
...
inline int tree_operand_length(const_tree node) {
...
inline bool valid_vector_subparts_p(poly_uint64 subparts) {
  unsigned HOST_WIDE_INT coeff0 = subparts.coeffs[0];
  if (!pow2p_hwi(coeff0))
    return false;
  if (NUM_POLY_INT_COEFFS == 2) {
...
inline built_in_function DECL_FUNCTION_CODE(const_tree decl) {
...
/* Return the target-specific built-in function that DECL represents,
   ...
   BUILT_IN_MD.  */
inline int DECL_MD_FUNCTION_CODE(const_tree decl) {
  const tree_function_decl &fndecl = FUNCTION_DECL_CHECK(decl)->function_decl;
...
/* Return the frontend-specific built-in function that DECL represents,
   given that it is known to be a FUNCTION_DECL with built-in class
   BUILT_IN_FRONTEND.  */
inline int DECL_FE_FUNCTION_CODE(const_tree decl) {
  const tree_function_decl &fndecl = FUNCTION_DECL_CHECK(decl)->function_decl;
...
/* Record that FUNCTION_DECL DECL represents built-in function FCODE of
   class FCLASS.  */
inline void set_decl_built_in_function(tree decl, built_in_class fclass,
                                       unsigned int fcode) {
...
inline void copy_decl_built_in_function(tree newdecl, const_tree olddecl) {
...
inline bool error_operand_p(const_tree t) {
...
inline tree build1_loc(location_t loc, enum tree_code code, tree type,
...
inline tree build2_loc(location_t loc, enum tree_code code, tree type,
...
inline tree build3_loc(location_t loc, enum tree_code code, tree type,
...
inline tree build4_loc(location_t loc, enum tree_code code, tree type,
...
inline tree build5_loc(location_t loc, enum tree_code code, tree type,
...
extern tree build_constructor(tree,
...
inline tree build_string_literal(tree t) {
  return build_string_literal(IDENTIFIER_LENGTH(t) + 1, IDENTIFIER_POINTER(t));
}
...
extern inline
    __attribute__((__gnu_inline__)) HOST_WIDE_INT tree_to_shwi(const_tree t) {
...
inline tree strip_array_types(tree type) {
...
inline const_tree strip_pointer_types(const_tree type) {
...
inline bool poly_int_tree_p(const_tree t, poly_int64 *value) {
...
inline bool poly_int_tree_p(const_tree t, poly_uint64 *value) {
...
inline bool handled_component_p(const_tree t) {
  switch (TREE_CODE(t)) {
  case COMPONENT_REF:
  case BIT_FIELD_REF:
  case ARRAY_REF:
...
inline bool reverse_storage_order_for_component_p(tree t) {
  /* The storage order only applies to scalar components.  */
  if (AGGREGATE_TYPE_P(TREE_TYPE(t)) || POINTER_TYPE_P(TREE_TYPE(t)) ||
...
inline bool storage_order_barrier_p(const_tree t) {
...
inline void function_args_iter_init(function_args_iterator *i,
                                    const_tree fntype) {
...
inline tree *function_args_iter_cond_ptr(function_args_iterator *i) {
...
inline tree function_args_iter_cond(function_args_iterator *i) {
  return (i->next) ? TREE_VALUE(i->next) : NULL_TREE;
}

/* Advance to the next argument.  */
inline void function_args_iter_next(function_args_iterator *i) {
...
inline bool inlined_function_outer_scope_p(const_tree block) {
...
inline bool is_typedef_decl(const_tree x) {
  return (x && TREE_CODE(x) == TYPE_DECL && DECL_ORIGINAL_TYPE(x) != NULL_TREE);
}

/* Returns true iff TYPE is a type variant created for a typedef. */

inline bool typedef_variant_p(const_tree type) {
...
inline int struct_ptr_eq(const void *a, const void *b) {
  const void *const *x = (const void *const *)a;
  const void *const *y = (const void *const *)b;
  return *x == *y;
}

inline hashval_t struct_ptr_hash(const void *a) {
  const void *const *x = (const void *const *)a;
  return (intptr_t)*x >> 4;
}
...
inline bool trunc_or_exact_div_p(tree_code code) {
  return code == TRUNC_DIV_EXPR || code == EXACT_DIV_EXPR;
}

/* Return nonzero if CODE is a tree code that represents a truth value.  */
inline bool truth_value_p(enum tree_code code) {
...
/* Return whether TYPE is a type suitable for an offset for
   a POINTER_PLUS_EXPR.  */
inline bool ptrofftype_p(tree type) {
...
/* Return true if the argument is a complete type or an array
   ...
   have complete type.  */
inline bool complete_or_array_type_p(const_tree type) {
...
inline hashval_t tree_decl_hash::hash(tree t) { return DECL_UID(t); }
...
inline hashval_t tree_type_hash::hash(tree t) { return TYPE_UID(t); }
...
inline hashval_t tree_hash::hash(tree t) { return TREE_HASH(t); }
...
struct decl_tree_cache_traits : simple_cache_map_traits<tree_decl_hash, tree> {
};
...
struct type_tree_cache_traits : simple_cache_map_traits<tree_type_hash, tree> {
};
...
struct decl_tree_traits : simple_hashmap_traits<tree_decl_hash, tree> {};
typedef hash_map<tree, tree, decl_tree_traits> decl_tree_map;

/* Initialize the abstract argument list iterator object ITER with the
   arguments from CALL_EXPR node EXP.  */
inline void init_call_expr_arg_iterator(tree exp,
...
inline tree next_call_expr_arg(call_expr_arg_iterator *iter) {
  tree result;
  if (iter->i >= iter->n)
    return NULL_TREE;
...
inline const_tree next_const_call_expr_arg(const_call_expr_arg_iterator *iter) {
  const_tree result;
  if (iter->i >= iter->n)
    return NULL_TREE;
  result = CALL_EXPR_ARG(iter->t, iter->i);
...
inline tree first_call_expr_arg(tree exp, call_expr_arg_iterator *iter) {
...
inline bool more_call_expr_args_p(const call_expr_arg_iterator *iter) {
...
inline bool is_lang_specific(const_tree t) {
...
inline tree builtin_decl_explicit(enum built_in_function fncode) {
...
inline tree builtin_decl_implicit(enum built_in_function fncode) {
...
inline void set_builtin_decl(enum built_in_function fncode, tree decl,
                             bool implicit_p) {
...
inline void set_builtin_decl_implicit_p(enum built_in_function fncode,
                                        bool implicit_p) {
  size_t uns_fncode = (size_t)fncode;
...
inline void set_builtin_decl_declared_p(enum built_in_function fncode,
                                        bool declared_p) {
  size_t uns_fncode = (size_t)fncode;
...
inline bool builtin_decl_implicit_p(enum built_in_function fncode) {
  size_t uns_fncode = (size_t)fncode;
...
inline bool builtin_decl_declared_p(enum built_in_function fncode) {
  size_t uns_fncode = (size_t)fncode;
...
inline bool maybe_special_function_p(const_tree fndecl) {
...
inline bool is_global_var(const_tree t) {
...
inline bool may_be_aliased(const_tree var) {
...
inline struct cl_optimization *opts_for_fn(const_tree fndecl) {
...
inline cl_target_option *target_opts_for_fn(const_tree fndecl) {
...
inline wi::tree_to_widest_ref wi::to_widest(const_tree t) { return t; }
...
inline wi::tree_to_offset_ref wi::to_offset(const_tree t) { return t; }
...
template <int N>
inline generic_wide_int<wi::extended_tree<N>>
wi::ints_for<generic_wide_int<wi::extended_tree<N>>, wi::CONST_PRECISION>::zero(
    const extended &x) {
  return build_zero_cst(TREE_TYPE(x.get_tree()));
}

inline generic_wide_int<wi::unextended_tree>
wi::ints_for<generic_wide_int<wi::unextended_tree>, wi::VAR_PRECISION>::zero(
    const unextended &x) {
  return build_zero_cst(TREE_TYPE(x.get_tree()));
}
...
extern tree get_inner_reference(tree, poly_int64 *, poly_int64 *, tree *,
...
inline bool desired_pro_or_demotion_p(const_tree to_type,
...
inline bool built_in_function_equal_p(built_in_function name0,
...
inline bool fndecl_built_in_p(const_tree node, unsigned int name,
...
template <typename... F>
inline bool fndecl_built_in_p(const_tree node, built_in_function name1,
                              F... names) {
  return (fndecl_built_in_p(node, BUILT_IN_NORMAL) &&
          built_in_function_equal_p(DECL_FUNCTION_CODE(node), name1, names...));
}

/* Returns true if the function decl NODE is an alloca. */
inline bool fndecl_builtin_alloc_p(const_tree node) {
