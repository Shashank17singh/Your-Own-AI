...
struct gphi_iterator : public gimple_stmt_iterator {
  ...
  gphi *phi() const { return as_a<gphi *>(ptr); }
};
...
inline gimple_stmt_iterator gsi_none(void) {
  gimple_stmt_iterator i;
  i.ptr = NULL;
  i.seq = NULL;
  i.bb = NULL;
...
inline gimple_stmt_iterator gsi_last(gimple_seq &seq) {
  gimple_stmt_iterator i;
...
inline gimple_stmt_iterator gsi_last_bb(basic_block bb) {
  gimple_stmt_iterator i;
  gimple_seq *seq;
...
inline gimple_stmt_iterator gsi_end(gimple_seq &seq) {
  gimple_stmt_iterator i;
...
inline gimple_stmt_iterator gsi_end_bb(basic_block bb) {
  gimple_stmt_iterator i;
  gimple_seq *seq;
...
inline bool gsi_end_p(gimple_stmt_iterator i) { return i.ptr == NULL; }

/* Return true if I is one statement before the end of its sequence.  */

inline bool gsi_one_before_end_p(gimple_stmt_iterator i) {
  return i.ptr != NULL && i.ptr->next == NULL;
}

/* Advance the iterator to the next gimple statement.  */

inline void gsi_next(gimple_stmt_iterator *i) { i->ptr = i->ptr->next; }

/* Advance the iterator to the previous gimple statement.  */

inline void gsi_prev(gimple_stmt_iterator *i) {
...
inline gimple *gsi_stmt(gimple_stmt_iterator i) { return i.ptr; }

/* Return a block statement iterator that points to the first
   non-label statement in block BB.  */

inline gimple_stmt_iterator gsi_after_labels(basic_block bb) {
...
inline gimple_stmt_iterator gsi_after_labels(gimple_seq &seq) {
...
inline void gsi_next_nondebug(gimple_stmt_iterator *i) {
  do {
    gsi_next(i);
...
inline void gsi_prev_nondebug(gimple_stmt_iterator *i) {
  do {
    gsi_prev(i);
  } while (!gsi_end_p(*i) && is_gimple_debug(gsi_stmt(*i)));
}
...
inline gimple_stmt_iterator gsi_start_nondebug(gimple_seq seq) {
  gimple_stmt_iterator gsi = gsi_start(seq);
...
inline gimple_stmt_iterator gsi_start_nondebug_bb(basic_block bb) {
...
inline gimple_stmt_iterator gsi_start_nondebug_after_labels_bb(basic_block bb) {
...
inline gimple_stmt_iterator gsi_last_nondebug_bb(basic_block bb) {
...
inline bool gsi_one_nondebug_before_end_p(gimple_stmt_iterator i) {
...
inline void gsi_next_nonvirtual_phi(gphi_iterator *i) {
  do {
    gsi_next(i);
...
inline gphi_iterator gsi_start_nonvirtual_phis(basic_block bb) {
...
inline basic_block gsi_bb(gimple_stmt_iterator i) { return i.bb; }

/* Return the sequence associated with this iterator.  */

inline gimple_seq gsi_seq(gimple_stmt_iterator i) { return *i.seq; }

/* Determine whether SEQ is a nondebug singleton.  */

inline bool gimple_seq_nondebug_singleton_p(gimple_seq seq) {
