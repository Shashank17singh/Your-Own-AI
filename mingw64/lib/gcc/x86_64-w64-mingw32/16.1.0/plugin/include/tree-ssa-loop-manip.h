...
inline void checking_verify_loop_closed_ssa(bool verify_ssa_p,
...
extern void standard_iv_increment_position(class loop *, gimple_stmt_iterator *,
                                           bool *);
extern bool gimple_duplicate_loop_body_to_header_edge(class loop *, edge,
