...
extern bool hook_bool_mode_reg_class_t_reg_class_t_false(machine_mode,
                                                         reg_class_t,
                                                         reg_class_t);
extern bool hook_bool_rtx_mode_int_int_intp_bool_false(rtx, machine_mode, int,
                                                       int, int *, bool);
...
extern tree hook_tree_treeptr_tree_tree_int_boolptr_null(tree *, tree, tree,
                                                         int, bool *);
...
extern const char *hook_constcharptr_const_tree_const_tree_null(const_tree,
                                                                const_tree);
