...
extern bool split_comparison(enum rtx_code, machine_mode, enum rtx_code *,
                             enum rtx_code *);
...
extern void do_compare_rtx_and_jump(rtx, rtx, enum rtx_code, int, machine_mode,
                                    rtx, rtx_code_label *, rtx_code_label *,
                                    profile_probability);
