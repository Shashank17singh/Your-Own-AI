...
static const char configuration_arguments[] =
    "../configure --prefix=/R/winlibs_staging_ucrt64/inst_gcc-16.1.0/share/gcc "
    "--build=x86_64-w64-mingw32 --host=x86_64-w64-mingw32 "
    "--enable-offload-targets=nvptx-none --with-pkgversion='MinGW-W64 "
    "x86_64-ucrt-posix-seh, built by Brecht Sanders, r3' --with-tune=generic "
    ...
    "--with-diagnostics-color=auto --enable-clocale=generic "
    "--enable-libgdiagnostics --with-libiconv --with-system-zlib "
    "--with-build-sysroot=/R/winlibs_staging_ucrt64/gcc-16.1.0/build_mingw/"
    "mingw-w64 "
