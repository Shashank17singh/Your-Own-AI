...
extern int native_encode_initializer(tree, unsigned char *, int, int off = -1,
                                     unsigned char * = nullptr);
extern int native_encode_wide_int(tree, const wide_int_ref &, unsigned char *,
                                  int, int off = -1);
...
extern enum tree_code fold_div_compare(enum tree_code, tree, tree, tree *,
                                       tree *, bool *);
...
extern bool poly_int_binop(poly_wide_int &res, enum tree_code, const_tree,
                           const_tree, signop, wi::overflow_type *);
...
extern bool fold_real_zero_addition_p(const_tree, const_tree, const_tree, int);
...
extern bool merge_ranges(int *, tree *, tree *, int, tree, tree, int, tree,
                         tree);
...
extern tree_code minmax_from_comparison(tree_code, tree, const widest_int,
                                        const widest_int);
extern tree_code minmax_from_comparison(tree_code, tree, tree, tree, tree);

extern tree make_bit_field_ref(location_t, tree, tree, tree, HOST_WIDE_INT,
                               poly_int64, int, int);
...
extern bool arith_overflowed_p(enum tree_code, const_tree, const_tree,
                               const_tree);
extern tree fold_truth_andor_for_ifcombine(enum tree_code, tree, location_t,
