...
extern char *get_source_text_between(diagnostics::file_cache &, location_t,
                                     location_t);

extern expanded_location expand_location_to_spelling_point(
    location_t, enum location_aspect aspect = location_aspect::caret);
...
inline int in_system_header_at(location_t loc) {
...
inline bool from_macro_expansion_at(location_t loc) {
