...
inline use_operand_p gimple_phi_arg_imm_use_ptr(gimple *gs, int i) {
  return &gimple_phi_arg(gs, i)->imm_use;
}

inline use_operand_p gimple_phi_arg_imm_use_ptr_from_edge(gimple *gs,
                                                          const_edge e) {
...
inline int phi_arg_index_from_use(use_operand_p use) {
...
inline edge phi_arg_edge_from_use(use_operand_p use) {
