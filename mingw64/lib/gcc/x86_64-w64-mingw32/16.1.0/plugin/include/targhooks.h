...
extern bool default_legitimize_address_displacement(rtx *, rtx *, poly_int64,
                                                    machine_mode);
...
extern machine_mode default_promote_function_mode(const_tree, machine_mode,
                                                  int *, const_tree, int);
extern machine_mode
default_promote_function_mode_always_promote(const_tree, machine_mode, int *,
                                             const_tree, int);
extern machine_mode default_promote_function_mode_sign_extend(const_tree,
                                                              machine_mode,
                                                              int *, const_tree,
                                                              int);
...
extern bool default_preferred_div_as_shifts_over_mult(const_tree);
...
extern bool hook_callee_copies_named(cumulative_args_t ca,
                                     const function_arg_info &);
...
extern bool default_builtin_support_vector_misalignment(machine_mode mode, int,
                                                        bool, bool);
extern machine_mode default_preferred_simd_mode(scalar_mode mode);
extern machine_mode default_split_reduction(machine_mode);
extern unsigned int default_autovectorize_vector_modes(vector_modes *, bool);
extern opt_machine_mode
    default_vectorize_related_mode(machine_mode, scalar_mode, poly_uint64);
...
extern bool hook_bool_CUMULATIVE_ARGS_arg_info_false(cumulative_args_t,
                                                     const function_arg_info &);
extern bool hook_bool_CUMULATIVE_ARGS_arg_info_true(cumulative_args_t,
                                                    const function_arg_info &);
extern int hook_int_CUMULATIVE_ARGS_arg_info_0(cumulative_args_t,
                                               const function_arg_info &);
...
extern const char *hook_invalid_arg_for_unprototyped_fn(const_tree, const_tree,
                                                        const_tree);
extern void default_function_arg_advance(cumulative_args_t,
                                         const function_arg_info &);
...
extern int default_callee_save_cost(spill_cost_type, unsigned int, machine_mode,
                                    unsigned int, int, const HARD_REG_SET &,
                                    bool);
extern int default_frame_allocation_cost(frame_cost_type, const HARD_REG_SET &);
...
extern void
default_print_patchable_function_entry(FILE *, unsigned HOST_WIDE_INT, bool);
...
extern bool can_use_doloop_if_innermost(const widest_int &, const widest_int &,
                                        unsigned int, bool);
