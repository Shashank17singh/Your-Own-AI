...
public:
  ...
  protected:
    extension(sink &sink_) : m_sink(sink_) {}
...
protected:
  sink(context &dc) : m_context(dc), m_printer(dc.clone_printer()) {}
...
extern void output_format_init(context &, const char *main_input_filename_,
