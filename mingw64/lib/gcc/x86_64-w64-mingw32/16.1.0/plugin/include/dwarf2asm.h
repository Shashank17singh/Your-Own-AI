...
extern void dw2_asm_output_vms_delta(int, const char *, const char *,
                                     const char *, ...) ATTRIBUTE_NULL_PRINTF_4;

extern void dw2_asm_output_offset(int, const char *, section *, const char *,
                                  ...) ATTRIBUTE_NULL_PRINTF_4;

extern void dw2_asm_output_offset(int, const char *, HOST_WIDE_INT, section *,
                                  const char *, ...) ATTRIBUTE_NULL_PRINTF_5;
...
extern void dw2_asm_output_data_sleb128(HOST_WIDE_INT, const char *,
                                        ...) ATTRIBUTE_NULL_PRINTF_2;

extern void dw2_asm_output_symname_uleb128(const char *, const char *,
                                           ...) ATTRIBUTE_NULL_PRINTF_2;
