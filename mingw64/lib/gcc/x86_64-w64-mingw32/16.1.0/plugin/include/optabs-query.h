...
inline enum insn_code convert_optab_handler(convert_optab op,
...
enum insn_code convert_optab_handler(convert_optab, machine_mode, machine_mode,
                                     optimization_type);
...
inline bool trapv_binoptab_p(optab binoptab) {
  return (binoptab == addv_optab || binoptab == subv_optab ||
...
inline enum insn_code get_vec_cmp_icode(machine_mode vmode,
                                        machine_mode mask_mode, bool uns) {
...
inline enum insn_code get_vec_cmp_eq_icode(machine_mode vmode,
...
inline enum insn_code get_vcond_mask_icode(machine_mode vmode,
                                           machine_mode mmode) {
...
bool get_best_mem_extraction_insn(extraction_insn *, enum extraction_pattern,
...
opt_machine_mode get_absneg_bit_mode(optab, machine_mode, scalar_float_mode,
                                     int *);
