...
template <typename T>
inline T GIMPLE_CHECK2(const gimple *gs,
...
template <typename T>
inline T GIMPLE_CHECK2(gimple *gs,
#if __GNUC__ > 4 || (__GNUC__ == 4 && __GNUC_MINOR__ >= 8)
                       const char *file = __builtin_FILE(),
                       int line = __builtin_LINE(),
                       const char *fun = __builtin_FUNCTION())
...
template <typename T> inline T GIMPLE_CHECK2(gimple *gs) { return as_a<T>(gs); }
template <typename T> inline T GIMPLE_CHECK2(const gimple *gs) {
  return as_a<T>(gs);
}
#endif
...
struct GTY((tag("GSS_EH_CTRL"))) geh_dispatch
...
/* GIMPLE_OMP_TARGET */
struct GTY((tag("GSS_OMP_TARGET"))) gomp_target
    : public gimple_statement_omp_parallel_layout {
...
struct GTY((tag("GSS_OMP_SINGLE_LAYOUT"))) gomp_scan
    : public gimple_statement_omp_single_layout {
  /* No extra fields; adds invariant:
...
struct GTY((tag("GSS_ASSUME"))) gimple_statement_assume : public gimple {
  /* [ WORD 1-6 ] : base class */
...
template <>
template <>
inline bool is_a_helper<const gdebug *>::test(const gimple *gs) {
  return gs->code == GIMPLE_DEBUG;
}
...
template <>
template <>
inline bool is_a_helper<const ggoto *>::test(const gimple *gs) {
  return gs->code == GIMPLE_GOTO;
}
...
template <>
template <>
inline bool is_a_helper<const glabel *>::test(const gimple *gs) {
  return gs->code == GIMPLE_LABEL;
}
...
template <>
template <>
inline bool is_a_helper<const geh_else *>::test(const gimple *gs) {
  return gs->code == GIMPLE_EH_ELSE;
}
...
template <>
template <>
inline bool is_a_helper<const geh_mnt *>::test(const gimple *gs) {
  return gs->code == GIMPLE_EH_MUST_NOT_THROW;
}
...
template <> template <> inline bool is_a_helper<gomp_scan *>::test(gimple *gs) {
...
template <>
template <>
inline bool is_a_helper<const gswitch *>::test(const gimple *gs) {
  return gs->code == GIMPLE_SWITCH;
}

template <>
template <>
inline bool is_a_helper<gimple_statement_assume *>::test(gimple *gs) {
...
template <>
template <>
inline bool is_a_helper<const gtry *>::test(const gimple *gs) {
  return gs->code == GIMPLE_TRY;
}
...
template <>
template <>
inline bool is_a_helper<const gomp_scan *>::test(const gimple *gs) {
  return gs->code == GIMPLE_OMP_SCAN;
}
...
template <>
template <>
inline bool is_a_helper<const greturn *>::test(const gimple *gs) {
  return gs->code == GIMPLE_RETURN;
}
...
extern void suppress_warning(gimple *, opt_code = all_warnings, bool = true)
    ATTRIBUTE_NONNULL(1);

/* Copy the warning disposition mapping from one statement to another.  */
extern void copy_warning(gimple *, const gimple *) ATTRIBUTE_NONNULL(1)
    ATTRIBUTE_NONNULL(2);
/* Copy the warning disposition mapping from an expression to a statement.  */
extern void copy_warning(gimple *, const_tree) ATTRIBUTE_NONNULL(1)
    ATTRIBUTE_NONNULL(2);
/* Copy the warning disposition mapping from a statement to an expression.  */
extern void copy_warning(tree, const gimple *) ATTRIBUTE_NONNULL(1)
    ATTRIBUTE_NONNULL(2);
...
inline unsigned int gimple_stmt_max_uid(struct function *fn) {
  return fn->last_stmt_uid;
}

/* Set the number of the next statement uid to be allocated.  */
inline void set_gimple_stmt_max_uid(struct function *fn, unsigned int maxid) {
  fn->last_stmt_uid = maxid;
}

/* Set the number of the next statement uid to be allocated.  */
inline unsigned int inc_gimple_stmt_max_uid(struct function *fn) {
  return fn->last_stmt_uid++;
}

/* Return the first node in GIMPLE sequence S.  */

inline gimple_seq_node gimple_seq_first(gimple_seq s) { return s; }

/* Return the first statement in GIMPLE sequence S.  */

inline gimple *gimple_seq_first_stmt(gimple_seq s) {
...
inline gbind *gimple_seq_first_stmt_as_a_bind(gimple_seq s) {
  gimple_seq_node n = gimple_seq_first(s);
  return as_a<gbind *>(n);
}
...
inline gimple_seq_node gimple_seq_last(gimple_seq s) {
  return s ? s->prev : NULL;
}

/* Return the last statement in GIMPLE sequence S.  */

inline gimple *gimple_seq_last_stmt(gimple_seq s) {
...
inline void gimple_seq_set_last(gimple_seq *ps, gimple_seq_node last) {
  (*ps)->prev = last;
}

/* Set the first node in GIMPLE sequence *PS to FIRST.  */

inline void gimple_seq_set_first(gimple_seq *ps, gimple_seq_node first) {
  *ps = first;
}

/* Return true if GIMPLE sequence S is empty.  */

inline bool gimple_seq_empty_p(gimple_seq s) { return s == NULL; }

/* Allocate a new sequence and initialize its first element with STMT.  */

inline gimple_seq gimple_seq_alloc_with_stmt(gimple *stmt) {
  gimple_seq seq = NULL;
...
inline gimple_seq bb_seq(const_basic_block bb) {
  return (!(bb->flags & BB_RTL)) ? bb->il.gimple.seq : NULL;
}

inline gimple_seq *bb_seq_addr(basic_block bb) {
  return (!(bb->flags & BB_RTL)) ? &bb->il.gimple.seq : NULL;
}

/* Sets the sequence of statements in BB to SEQ.  */

inline void set_bb_seq(basic_block bb, gimple_seq seq) {
...
inline bool gimple_has_substatements(gimple *g) {
...
inline basic_block gimple_bb(const gimple *g) { return g->bb; }

/* Return the lexical scope block holding statement G.  */

inline tree gimple_block(const gimple *g) {
...
inline void gimple_set_block(gimple *g, tree block) {
...
inline location_t gimple_location_safe(const gimple *g) {
  return g ? gimple_location(g) : UNKNOWN_LOCATION;
}

/* Set location information for statement G.  */

inline void gimple_set_location(gimple *g, location_t location) {
...
inline location_t *gimple_location_ptr(gimple *g) { return &g->location; }

/* Return true if G contains location information.  */

inline bool gimple_has_location(const gimple *g) {
  return LOCATION_LOCUS(gimple_location(g)) != UNKNOWN_LOCATION;
}

/* Return non-artificial location information for statement G.  */

inline location_t gimple_nonartificial_location(const gimple *g) {
...
inline bool gimple_no_warning_p(const gimple *stmt) { return stmt->no_warning; }

/* Set the no_warning flag of STMT to NO_WARNING.  */

inline void gimple_set_no_warning(gimple *stmt, bool no_warning) {
...
inline void gimple_set_visited(gimple *stmt, bool visited_p) {
...
inline bool gimple_visited_p(gimple *stmt) { return stmt->visited; }
...
inline void gimple_set_plf(gimple *stmt, enum plf_mask plf, bool val_p) {
  if (val_p)
...
inline unsigned int gimple_plf(gimple *stmt, enum plf_mask plf) {
...
inline void gimple_set_uid(gimple *g, unsigned uid) { g->uid = uid; }
...
inline unsigned gimple_uid(const gimple *g) { return g->uid; }

/* Make statement G a singleton sequence.  */

inline void gimple_init_singleton(gimple *g) {
  g->next = NULL;
  g->prev = g;
}
...
inline bool gimple_has_ops(const gimple *g) {
...
inline bool gimple_has_mem_ops(const gimple *g) {
...
inline struct use_optype_d *gimple_use_ops(const gimple *g) {
...
inline void gimple_set_use_ops(gimple *g, struct use_optype_d *use) {
...
inline tree gimple_vuse(const gimple *g) {
...
inline tree gimple_vdef(const gimple *g) {
  const gimple_statement_with_memory_ops *mem_ops_stmt =
      dyn_cast<const gimple_statement_with_memory_ops *>(g);
  if (!mem_ops_stmt)
    return NULL_TREE;
...
inline tree *gimple_vuse_ptr(gimple *g) {
...
inline tree *gimple_vdef_ptr(gimple *g) {
  gimple_statement_with_memory_ops *mem_ops_stmt =
      dyn_cast<gimple_statement_with_memory_ops *>(g);
  if (!mem_ops_stmt)
    return NULL;
...
inline void gimple_set_vuse(gimple *g, tree vuse) {
  gimple_statement_with_memory_ops *mem_ops_stmt =
...
inline void gimple_set_vdef(gimple *g, tree vdef) {
  gimple_statement_with_memory_ops *mem_ops_stmt =
      as_a<gimple_statement_with_memory_ops *>(g);
...
inline bool gimple_modified_p(const gimple *g) {
...
inline void gimple_set_modified(gimple *s, bool modifiedp) {
  if (gimple_has_ops(s))
...
inline bool gimple_has_volatile_ops(const gimple *stmt) {
...
inline void gimple_set_has_volatile_ops(gimple *stmt, bool volatilep) {
  if (gimple_has_mem_ops(stmt))
...
inline bool gimple_in_transaction(const gimple *stmt) {
  return bb_in_transaction(gimple_bb(stmt));
}

/* Return true if statement STMT may access memory.  */

inline bool gimple_references_memory_p(gimple *stmt) {
  return gimple_has_mem_ops(stmt) && gimple_vuse(stmt);
}

/* Return the subcode for OMP statement S.  */

inline unsigned gimple_omp_subcode(const gimple *s) {
...
inline void gimple_omp_set_subcode(gimple *s, unsigned int subcode) {
...
inline void gimple_omp_return_set_nowait(gimple *s) {
...
inline bool gimple_omp_return_nowait_p(const gimple *g) {
...
inline void gimple_omp_return_set_lhs(gimple *g, tree lhs) {
...
inline tree gimple_omp_return_lhs(const gimple *g) {
...
inline tree *gimple_omp_return_lhs_ptr(gimple *g) {
  gimple_statement_omp_return *omp_return_stmt =
      as_a<gimple_statement_omp_return *>(g);
  return &omp_return_stmt->val;
}
...
inline bool gimple_omp_section_last_p(const gimple *g) {
...
inline void gimple_omp_section_set_last(gimple *g) {
  GIMPLE_CHECK(g, GIMPLE_OMP_SECTION);
...
inline bool gimple_omp_ordered_standalone_p(const gimple *g) {
...
inline void gimple_omp_ordered_standalone(gimple *g) {
  GIMPLE_CHECK(g, GIMPLE_OMP_ORDERED);
...
inline bool gimple_omp_parallel_combined_p(const gimple *g) {
...
inline void gimple_omp_parallel_set_combined_p(gimple *g, bool combined_p) {
  GIMPLE_CHECK(g, GIMPLE_OMP_PARALLEL);
  if (combined_p)
...
inline bool gimple_omp_atomic_need_value_p(const gimple *g) {
...
inline void gimple_omp_atomic_set_need_value(gimple *g) {
  if (gimple_code(g) != GIMPLE_OMP_ATOMIC_LOAD)
    GIMPLE_CHECK(g, GIMPLE_OMP_ATOMIC_STORE);
...
inline bool gimple_omp_atomic_weak_p(const gimple *g) {
  if (gimple_code(g) != GIMPLE_OMP_ATOMIC_LOAD)
    GIMPLE_CHECK(g, GIMPLE_OMP_ATOMIC_STORE);
...
inline void gimple_omp_atomic_set_weak(gimple *g) {
  if (gimple_code(g) != GIMPLE_OMP_ATOMIC_LOAD)
    GIMPLE_CHECK(g, GIMPLE_OMP_ATOMIC_STORE);
...
inline enum omp_memory_order gimple_omp_atomic_memory_order(const gimple *g) {
  if (gimple_code(g) != GIMPLE_OMP_ATOMIC_LOAD)
    GIMPLE_CHECK(g, GIMPLE_OMP_ATOMIC_STORE);
...
inline void gimple_omp_atomic_set_memory_order(gimple *g,
...
inline unsigned gimple_num_ops(const gimple *gs) { return gs->num_ops; }

/* Set the number of operands for statement GS.  */

inline void gimple_set_num_ops(gimple *gs, unsigned num_ops) {
  gs->num_ops = num_ops;
}

/* Return the array of operands for statement GS.  */

inline tree *gimple_ops(gimple *gs) {
  size_t off;
...
inline tree gimple_op(const gimple *gs, unsigned i) {
...
inline tree *gimple_op_ptr(gimple *gs, unsigned i) {
  if (gimple_has_ops(gs)) {
    gcc_gimple_checking_assert(i < gimple_num_ops(gs));
...
inline void gimple_set_op(gimple *gs, unsigned i, tree op) {
...
inline bool is_gimple_assign(const gimple *gs) {
...
inline enum gimple_rhs_class get_gimple_rhs_class(enum tree_code code) {
  return (enum gimple_rhs_class)gimple_rhs_class_table[(int)code];
}

/* Return the LHS of assignment statement GS.  */

inline tree gimple_assign_lhs(const gassign *gs) { return gs->op[0]; }

inline tree gimple_assign_lhs(const gimple *gs) {
...
inline tree *gimple_assign_lhs_ptr(gassign *gs) { return &gs->op[0]; }

inline tree *gimple_assign_lhs_ptr(gimple *gs) {
...
inline void gimple_assign_set_lhs(gassign *gs, tree lhs) {
  gs->op[0] = lhs;
...
inline void gimple_assign_set_lhs(gimple *gs, tree lhs) {
  gassign *ass = GIMPLE_CHECK2<gassign *>(gs);
...
inline tree gimple_assign_rhs1(const gassign *gs) { return gs->op[1]; }

inline tree gimple_assign_rhs1(const gimple *gs) {
  const gassign *ass = GIMPLE_CHECK2<const gassign *>(gs);
...
inline tree *gimple_assign_rhs1_ptr(gassign *gs) { return &gs->op[1]; }

inline tree *gimple_assign_rhs1_ptr(gimple *gs) {
  gassign *ass = GIMPLE_CHECK2<gassign *>(gs);
...
inline void gimple_assign_set_rhs1(gassign *gs, tree rhs) { gs->op[1] = rhs; }

inline void gimple_assign_set_rhs1(gimple *gs, tree rhs) {
  gassign *ass = GIMPLE_CHECK2<gassign *>(gs);
...
inline tree gimple_assign_rhs2(const gassign *gs) {
...
inline tree gimple_assign_rhs2(const gimple *gs) {
  const gassign *ass = GIMPLE_CHECK2<const gassign *>(gs);
...
inline tree *gimple_assign_rhs2_ptr(gassign *gs) {
  gcc_gimple_checking_assert(gimple_num_ops(gs) >= 3);
  return &gs->op[2];
}

inline tree *gimple_assign_rhs2_ptr(gimple *gs) {
  gassign *ass = GIMPLE_CHECK2<gassign *>(gs);
...
inline void gimple_assign_set_rhs2(gassign *gs, tree rhs) {
  gcc_gimple_checking_assert(gimple_num_ops(gs) >= 3);
  gs->op[2] = rhs;
}

inline void gimple_assign_set_rhs2(gimple *gs, tree rhs) {
  gassign *ass = GIMPLE_CHECK2<gassign *>(gs);
...
inline tree gimple_assign_rhs3(const gassign *gs) {
...
inline tree gimple_assign_rhs3(const gimple *gs) {
  const gassign *ass = GIMPLE_CHECK2<const gassign *>(gs);
...
inline tree *gimple_assign_rhs3_ptr(gimple *gs) {
  gassign *ass = GIMPLE_CHECK2<gassign *>(gs);
...
inline void gimple_assign_set_rhs3(gassign *gs, tree rhs) {
  gcc_gimple_checking_assert(gimple_num_ops(gs) >= 4);
  gs->op[3] = rhs;
}

inline void gimple_assign_set_rhs3(gimple *gs, tree rhs) {
  gassign *ass = GIMPLE_CHECK2<gassign *>(gs);
...
inline void gimple_assign_set_rhs_with_ops(gimple_stmt_iterator *gsi,
...
inline bool gimple_assign_nontemporal_move_p(const gassign *gs) {
  return gs->nontemporal_move;
}

/* Sets nontemporal move flag of GS to NONTEMPORAL.  */

inline void gimple_assign_set_nontemporal_move(gimple *gs, bool nontemporal) {
...
inline enum tree_code gimple_assign_rhs_code(const gassign *gs) {
...
inline enum tree_code gimple_assign_rhs_code(const gimple *gs) {
  const gassign *ass = GIMPLE_CHECK2<const gassign *>(gs);
...
inline void gimple_assign_set_rhs_code(gimple *s, enum tree_code code) {
...
inline bool gimple_assign_single_p(const gimple *gs) {
...
inline bool gimple_store_p(const gimple *gs) {
...
inline bool gimple_assign_cast_p(const gimple *s) {
...
inline bool gimple_clobber_p(const gimple *s) {
  return gimple_assign_single_p(s) && TREE_CLOBBER_P(gimple_assign_rhs1(s));
}

/* Return true if S is a clobber statement.  */

inline bool gimple_clobber_p(const gimple *s, enum clobber_kind kind) {
  return gimple_clobber_p(s) && CLOBBER_KIND(gimple_assign_rhs1(s)) == kind;
}

/* Return true if GS is a GIMPLE_CALL.  */

inline bool is_gimple_call(const gimple *gs) {
  return gimple_code(gs) == GIMPLE_CALL;
}

/* Return the LHS of call statement GS.  */

inline tree gimple_call_lhs(const gcall *gs) { return gs->op[0]; }

inline tree gimple_call_lhs(const gimple *gs) {
...
inline tree *gimple_call_lhs_ptr(gcall *gs) { return &gs->op[0]; }

inline tree *gimple_call_lhs_ptr(gimple *gs) {
...
inline void gimple_call_set_lhs(gcall *gs, tree lhs) {
  gs->op[0] = lhs;
  if (lhs && TREE_CODE(lhs) == SSA_NAME)
    SSA_NAME_DEF_STMT(lhs) = gs;
}

inline void gimple_call_set_lhs(gimple *gs, tree lhs) {
  gcall *gc = GIMPLE_CHECK2<gcall *>(gs);
...
inline bool gimple_call_internal_p(const gcall *gs) {
  return (gs->subcode & GF_CALL_INTERNAL) != 0;
}

inline bool gimple_call_internal_p(const gimple *gs) {
  const gcall *gc = GIMPLE_CHECK2<const gcall *>(gs);
...
inline bool gimple_call_nocf_check_p(const gcall *gs) {
  return (gs->subcode & GF_CALL_NOCF_CHECK) != 0;
}

/* Mark statement GS as nocf_check call.  */

inline void gimple_call_set_nocf_check(gcall *gs, bool nocf_check) {
  if (nocf_check)
...
inline enum internal_fn gimple_call_internal_fn(const gcall *gs) {
  gcc_gimple_checking_assert(gimple_call_internal_p(gs));
  return gs->u.internal_fn;
}

inline enum internal_fn gimple_call_internal_fn(const gimple *gs) {
  const gcall *gc = GIMPLE_CHECK2<const gcall *>(gs);
...
inline bool gimple_call_internal_unique_p(const gcall *gs) {
  return gimple_call_internal_fn(gs) == IFN_UNIQUE;
}

inline bool gimple_call_internal_unique_p(const gimple *gs) {
  const gcall *gc = GIMPLE_CHECK2<const gcall *>(gs);
...
inline bool gimple_call_internal_p(const gimple *gs, internal_fn fn) {
...
inline void gimple_call_set_ctrl_altering(gcall *s, bool ctrl_altering_p) {
  if (ctrl_altering_p)
...
inline void gimple_call_set_ctrl_altering(gimple *s, bool ctrl_altering_p) {
...
inline bool gimple_call_ctrl_altering_p(const gcall *gs) {
  return (gs->subcode & GF_CALL_CTRL_ALTERING) != 0;
}

inline bool gimple_call_ctrl_altering_p(const gimple *gs) {
  const gcall *gc = GIMPLE_CHECK2<const gcall *>(gs);
...
inline tree gimple_call_fntype(const gcall *gs) {
  if (gimple_call_internal_p(gs))
    return NULL_TREE;
  return gs->u.fntype;
}

inline tree gimple_call_fntype(const gimple *gs) {
...
inline void gimple_call_set_fntype(gcall *call_stmt, tree fntype) {
...
inline tree gimple_call_fn(const gcall *gs) { return gs->op[1]; }

inline tree gimple_call_fn(const gimple *gs) {
  const gcall *gc = GIMPLE_CHECK2<const gcall *>(gs);
...
inline tree *gimple_call_fn_ptr(gcall *gs) { return &gs->op[1]; }

inline tree *gimple_call_fn_ptr(gimple *gs) {
  gcall *gc = GIMPLE_CHECK2<gcall *>(gs);
...
inline void gimple_call_set_fn(gcall *gs, tree fn) {
  gcc_gimple_checking_assert(!gimple_call_internal_p(gs));
  gs->op[1] = fn;
}
...
inline void gimple_call_set_fndecl(gcall *gs, tree decl) {
  gcc_gimple_checking_assert(!gimple_call_internal_p(gs));
  gs->op[1] = build1_loc(gimple_location(gs), ADDR_EXPR,
                         build_pointer_type(TREE_TYPE(decl)), decl);
}

inline void gimple_call_set_fndecl(gimple *gs, tree decl) {
  gcall *gc = GIMPLE_CHECK2<gcall *>(gs);
...
inline void gimple_call_set_internal_fn(gcall *call_stmt, enum internal_fn fn) {
  gcc_gimple_checking_assert(gimple_call_internal_p(call_stmt));
...
inline tree gimple_call_fndecl(const gcall *gs) {
  return gimple_call_addr_fndecl(gimple_call_fn(gs));
}

inline tree gimple_call_fndecl(const gimple *gs) {
  const gcall *gc = GIMPLE_CHECK2<const gcall *>(gs);
...
inline tree gimple_call_return_type(const gcall *gs) {
...
inline tree gimple_call_chain(const gcall *gs) { return gs->op[2]; }

inline tree gimple_call_chain(const gimple *gs) {
  const gcall *gc = GIMPLE_CHECK2<const gcall *>(gs);
...
inline tree *gimple_call_chain_ptr(gcall *call_stmt) {
  return &call_stmt->op[2];
}

/* Set CHAIN to be the static chain for call statement CALL_STMT.  */

inline void gimple_call_set_chain(gcall *call_stmt, tree chain) {
  call_stmt->op[2] = chain;
}

/* Return the number of arguments used by call statement GS.  */

inline unsigned gimple_call_num_args(const gcall *gs) {
  return gimple_num_ops(gs) - 3;
}

inline unsigned gimple_call_num_args(const gimple *gs) {
  const gcall *gc = GIMPLE_CHECK2<const gcall *>(gs);
...
inline tree gimple_call_arg(const gcall *gs, unsigned index) {
  gcc_gimple_checking_assert(gimple_num_ops(gs) > index + 3);
  return gs->op[index + 3];
}

inline tree gimple_call_arg(const gimple *gs, unsigned index) {
  const gcall *gc = GIMPLE_CHECK2<const gcall *>(gs);
...
inline tree *gimple_call_arg_ptr(gcall *gs, unsigned index) {
  gcc_gimple_checking_assert(gimple_num_ops(gs) > index + 3);
  return &gs->op[index + 3];
}

inline tree *gimple_call_arg_ptr(gimple *gs, unsigned index) {
  gcall *gc = GIMPLE_CHECK2<gcall *>(gs);
...
inline void gimple_call_set_tail(gcall *s, bool tail_p) {
  if (tail_p)
...
inline bool gimple_call_tail_p(const gcall *s) {
  return (s->subcode & GF_CALL_TAILCALL) != 0;
}

/* Mark (or clear) call statement S as requiring tail call optimization.  */

inline void gimple_call_set_must_tail(gcall *s, bool must_tail_p) {
  if (must_tail_p)
...
inline bool gimple_call_must_tail_p(const gcall *s) {
...
inline void gimple_call_set_return_slot_opt(gcall *s, bool return_slot_opt_p) {
...
inline bool gimple_call_return_slot_opt_p(const gcall *s) {
...
inline void gimple_call_set_from_thunk(gcall *s, bool from_thunk_p) {
  if (from_thunk_p)
...
inline bool gimple_call_from_thunk_p(gcall *s) {
...
inline void gimple_call_set_from_new_or_delete(gcall *s,
...
inline bool gimple_call_from_new_or_delete(const gcall *s) {
...
inline void gimple_call_set_va_arg_pack(gcall *s, bool pass_arg_pack_p) {
  if (pass_arg_pack_p)
...
inline bool gimple_call_va_arg_pack_p(const gcall *s) {
  return (s->subcode & GF_CALL_VA_ARG_PACK) != 0;
}

/* Return true if S is a noreturn call.  */

inline bool gimple_call_noreturn_p(const gcall *s) {
  return (gimple_call_flags(s) & ECF_NORETURN) != 0;
}

inline bool gimple_call_noreturn_p(const gimple *s) {
...
inline void gimple_call_set_nothrow(gcall *s, bool nothrow_p) {
  if (nothrow_p)
...
inline bool gimple_call_nothrow_p(const gcall *s) {
...
static inline void gimple_call_set_expected_throw(gcall *s,
...
static inline bool gimple_call_expected_throw_p(gcall *s) {
...
inline void gimple_call_set_alloca_for_var(gcall *s, bool for_var) {
  if (for_var)
...
inline bool gimple_call_alloca_for_var_p(gcall *s) {
  return (s->subcode & GF_CALL_ALLOCA_FOR_VAR) != 0;
}

inline bool gimple_call_alloca_for_var_p(gimple *s) {
...
inline void gimple_call_set_by_descriptor(gcall *s, bool by_descriptor_p) {
  if (by_descriptor_p)
...
inline bool gimple_call_by_descriptor_p(gcall *s) {
  return (s->subcode & GF_CALL_BY_DESCRIPTOR) != 0;
}

/* Copy all the GF_CALL_* flags from ORIG_CALL to DEST_CALL.  */

inline void gimple_call_copy_flags(gcall *dest_call, gcall *orig_call) {
...
inline struct pt_solution *gimple_call_use_set(gcall *call_stmt) {
  return &call_stmt->call_used;
}

/* As above, but const.  */

inline const pt_solution *gimple_call_use_set(const gcall *call_stmt) {
  return &call_stmt->call_used;
}
...
inline struct pt_solution *gimple_call_clobber_set(gcall *call_stmt) {
  return &call_stmt->call_clobbered;
}

/* As above, but const.  */

inline const pt_solution *gimple_call_clobber_set(const gcall *call_stmt) {
  return &call_stmt->call_clobbered;
}
...
inline bool gimple_has_lhs(const gimple *stmt) {
...
inline enum tree_code gimple_cond_code(const gcond *gs) {
  return (enum tree_code)gs->subcode;
}

inline enum tree_code gimple_cond_code(const gimple *gs) {
...
inline void gimple_cond_set_code(gcond *gs, enum tree_code code) {
...
inline tree gimple_cond_lhs(const gcond *gs) { return gs->op[0]; }

inline tree gimple_cond_lhs(const gimple *gs) {
  const gcond *gc = GIMPLE_CHECK2<const gcond *>(gs);
...
inline tree *gimple_cond_lhs_ptr(gcond *gs) { return &gs->op[0]; }

/* Set LHS to be the LHS operand of the predicate computed by
   conditional statement GS.  */

inline void gimple_cond_set_lhs(gcond *gs, tree lhs) { gs->op[0] = lhs; }

/* Return the RHS operand of the predicate computed by conditional GS.  */

inline tree gimple_cond_rhs(const gcond *gs) { return gs->op[1]; }

inline tree gimple_cond_rhs(const gimple *gs) {
  const gcond *gc = GIMPLE_CHECK2<const gcond *>(gs);
...
inline tree *gimple_cond_rhs_ptr(gcond *gs) { return &gs->op[1]; }

/* Set RHS to be the RHS operand of the predicate computed by
   conditional statement GS.  */

inline void gimple_cond_set_rhs(gcond *gs, tree rhs) { gs->op[1] = rhs; }

/* Return the label used by conditional statement GS when its
   predicate evaluates to true.  */

inline tree gimple_cond_true_label(const gcond *gs) { return gs->op[2]; }

/* Set LABEL to be the label used by conditional statement GS when its
   predicate evaluates to true.  */

inline void gimple_cond_set_true_label(gcond *gs, tree label) {
  gs->op[2] = label;
}
...
inline void gimple_cond_set_false_label(gcond *gs, tree label) {
  gs->op[3] = label;
}
...
inline tree gimple_cond_false_label(const gcond *gs) { return gs->op[3]; }

/* Set the conditional COND_STMT to be of the form 'if (0 != 0)'.  */

inline void gimple_cond_make_false(gcond *gs) {
...
inline void gimple_cond_make_true(gcond *gs) {
...
inline bool gimple_cond_true_p(const gcond *gs) {
...
inline bool gimple_cond_true_canonical_p(const gcond *gs) {
  tree lhs = gimple_cond_lhs(gs);
  tree rhs = gimple_cond_rhs(gs);
  tree_code code = gimple_cond_code(gs);
  if (code == NE_EXPR && lhs == boolean_true_node && rhs == boolean_false_node)
    return true;
  return false;
}
...
inline bool gimple_cond_false_p(const gcond *gs) {
  tree lhs = gimple_cond_lhs(gs);
  tree rhs = gimple_cond_rhs(gs);
  enum tree_code code = gimple_cond_code(gs);
...
inline bool gimple_cond_false_canonical_p(const gcond *gs) {
  tree lhs = gimple_cond_lhs(gs);
  tree rhs = gimple_cond_rhs(gs);
  tree_code code = gimple_cond_code(gs);
  if (code == NE_EXPR && lhs == boolean_false_node && rhs == boolean_false_node)
    return true;
  return false;
}
...
inline void gimple_cond_set_condition(gcond *stmt, enum tree_code code,
                                      tree lhs, tree rhs) {
...
inline enum tree_code gimple_expr_code(const gimple *stmt) {
...
inline tree gimple_label_label(const glabel *gs) { return gs->op[0]; }

/* Set LABEL to be the LABEL_DECL node used by GIMPLE_LABEL statement
   GS.  */

inline void gimple_label_set_label(glabel *gs, tree label) {
  gs->op[0] = label;
}

/* Return the destination of the unconditional jump GS.  */

inline tree gimple_goto_dest(const gimple *gs) {
...
inline void gimple_goto_set_dest(ggoto *gs, tree dest) { gs->op[0] = dest; }

/* Return the variables declared in the GIMPLE_BIND statement GS.  */

inline tree gimple_bind_vars(const gbind *bind_stmt) { return bind_stmt->vars; }

/* Set VARS to be the set of variables declared in the GIMPLE_BIND
   statement GS.  */

inline void gimple_bind_set_vars(gbind *bind_stmt, tree vars) {
  bind_stmt->vars = vars;
}
...
inline void gimple_bind_append_vars(gbind *bind_stmt, tree vars) {
  bind_stmt->vars = chainon(bind_stmt->vars, vars);
}

inline gimple_seq *gimple_bind_body_ptr(gbind *bind_stmt) {
  return &bind_stmt->body;
}

/* Return the GIMPLE sequence contained in the GIMPLE_BIND statement GS.  */

inline gimple_seq gimple_bind_body(const gbind *gs) {
...
inline void gimple_bind_set_body(gbind *bind_stmt, gimple_seq seq) {
  bind_stmt->body = seq;
}

/* Append a statement to the end of a GIMPLE_BIND's body.  */

inline void gimple_bind_add_stmt(gbind *bind_stmt, gimple *stmt) {
  gimple_seq_add_stmt(&bind_stmt->body, stmt);
}

/* Append a sequence of statements to the end of a GIMPLE_BIND's body.  */

inline void gimple_bind_add_seq(gbind *bind_stmt, gimple_seq seq) {
...
inline tree gimple_bind_block(const gbind *bind_stmt) {
...
inline void gimple_bind_set_block(gbind *bind_stmt, tree block) {
...
inline unsigned gimple_asm_ninputs(const gasm *asm_stmt) {
  return asm_stmt->ni;
}

/* Return the number of output operands for GIMPLE_ASM ASM_STMT.  */

inline unsigned gimple_asm_noutputs(const gasm *asm_stmt) {
  return asm_stmt->no;
}

/* Return the number of clobber operands for GIMPLE_ASM ASM_STMT.  */

inline unsigned gimple_asm_nclobbers(const gasm *asm_stmt) {
  return asm_stmt->nc;
}

/* Return the number of label operands for GIMPLE_ASM ASM_STMT.  */

inline unsigned gimple_asm_nlabels(const gasm *asm_stmt) {
  return asm_stmt->nl;
}

/* Return input operand INDEX of GIMPLE_ASM ASM_STMT.  */

inline tree gimple_asm_input_op(const gasm *asm_stmt, unsigned index) {
...
inline void gimple_asm_set_input_op(gasm *asm_stmt, unsigned index,
                                    tree in_op) {
  gcc_gimple_checking_assert(index < asm_stmt->ni &&
...
inline tree gimple_asm_output_op(const gasm *asm_stmt, unsigned index) {
...
inline void gimple_asm_set_output_op(gasm *asm_stmt, unsigned index,
                                     tree out_op) {
  gcc_gimple_checking_assert(index < asm_stmt->no &&
...
inline tree gimple_asm_clobber_op(const gasm *asm_stmt, unsigned index) {
...
inline void gimple_asm_set_clobber_op(gasm *asm_stmt, unsigned index,
                                      tree clobber_op) {
  gcc_gimple_checking_assert(index < asm_stmt->nc &&
...
inline tree gimple_asm_label_op(const gasm *asm_stmt, unsigned index) {
...
inline void gimple_asm_set_label_op(gasm *asm_stmt, unsigned index,
                                    tree label_op) {
  gcc_gimple_checking_assert(index < asm_stmt->nl &&
...
inline const char *gimple_asm_string(const gasm *asm_stmt) {
  return asm_stmt->string;
}

/* Return true if ASM_STMT is marked volatile.  */

inline bool gimple_asm_volatile_p(const gasm *asm_stmt) {
  return (asm_stmt->subcode & GF_ASM_VOLATILE) != 0;
}

/* If VOLATILE_P is true, mark asm statement ASM_STMT as volatile.  */

inline void gimple_asm_set_volatile(gasm *asm_stmt, bool volatile_p) {
  if (volatile_p)
...
inline bool gimple_asm_inline_p(const gasm *asm_stmt) {
  return (asm_stmt->subcode & GF_ASM_INLINE) != 0;
}

/* If INLINE_P is true, mark asm statement ASM_STMT as inline.  */

inline void gimple_asm_set_inline(gasm *asm_stmt, bool inline_p) {
  if (inline_p)
...
inline void gimple_asm_set_basic(gasm *asm_stmt, bool basic_p) {
  if (basic_p)
...
inline bool gimple_asm_basic_p(const gasm *asm_stmt) {
  return (asm_stmt->subcode & GF_ASM_BASIC) != 0;
}

/* Return the types handled by GIMPLE_CATCH statement CATCH_STMT.  */

inline tree gimple_catch_types(const gcatch *catch_stmt) {
...
inline tree *gimple_catch_types_ptr(gcatch *catch_stmt) {
  return &catch_stmt->types;
}
...
inline gimple_seq *gimple_catch_handler_ptr(gcatch *catch_stmt) {
...
inline gimple_seq gimple_catch_handler(const gcatch *catch_stmt) {
...
inline void gimple_catch_set_types(gcatch *catch_stmt, tree t) {
  catch_stmt->types = t;
}

/* Set HANDLER to be the body of GIMPLE_CATCH CATCH_STMT.  */

inline void gimple_catch_set_handler(gcatch *catch_stmt, gimple_seq handler) {
  catch_stmt->handler = handler;
}

/* Return the types handled by GIMPLE_EH_FILTER statement GS.  */

inline tree gimple_eh_filter_types(const gimple *gs) {
...
inline tree *gimple_eh_filter_types_ptr(gimple *gs) {
...
inline gimple_seq *gimple_eh_filter_failure_ptr(gimple *gs) {
  geh_filter *eh_filter_stmt = as_a<geh_filter *>(gs);
...
inline gimple_seq gimple_eh_filter_failure(const gimple *gs) {
...
inline void gimple_eh_filter_set_types(geh_filter *eh_filter_stmt, tree types) {
...
inline void gimple_eh_filter_set_failure(geh_filter *eh_filter_stmt,
                                         gimple_seq failure) {
...
inline tree gimple_eh_must_not_throw_fndecl(const geh_mnt *eh_mnt_stmt) {
  return eh_mnt_stmt->fndecl;
}

/* Set the function decl to be called by GS to DECL.  */

inline void gimple_eh_must_not_throw_set_fndecl(geh_mnt *eh_mnt_stmt,
                                                tree decl) {
...
inline gimple_seq *gimple_eh_else_n_body_ptr(geh_else *eh_else_stmt) {
  return &eh_else_stmt->n_body;
}

inline gimple_seq gimple_eh_else_n_body(const geh_else *eh_else_stmt) {
  return *gimple_eh_else_n_body_ptr(const_cast<geh_else *>(eh_else_stmt));
}

inline gimple_seq *gimple_eh_else_e_body_ptr(geh_else *eh_else_stmt) {
  return &eh_else_stmt->e_body;
}

inline gimple_seq gimple_eh_else_e_body(const geh_else *eh_else_stmt) {
  return *gimple_eh_else_e_body_ptr(const_cast<geh_else *>(eh_else_stmt));
}

inline void gimple_eh_else_set_n_body(geh_else *eh_else_stmt, gimple_seq seq) {
  eh_else_stmt->n_body = seq;
}

inline void gimple_eh_else_set_e_body(geh_else *eh_else_stmt, gimple_seq seq) {
...
inline enum gimple_try_flags gimple_try_kind(const gimple *gs) {
...
inline void gimple_try_set_kind(gtry *gs, enum gimple_try_flags kind) {
...
inline bool gimple_try_catch_is_cleanup(const gimple *gs) {
...
inline gimple_seq *gimple_try_eval_ptr(gimple *gs) {
...
inline gimple_seq gimple_try_eval(const gimple *gs) {
...
inline gimple_seq *gimple_try_cleanup_ptr(gimple *gs) {
  gtry *try_stmt = as_a<gtry *>(gs);
...
inline gimple_seq gimple_try_cleanup(const gimple *gs) {
  return *gimple_try_cleanup_ptr(const_cast<gimple *>(gs));
}

/* Set the GIMPLE_TRY_CATCH_IS_CLEANUP flag.  */

inline void gimple_try_set_catch_is_cleanup(gtry *g, bool catch_is_cleanup) {
...
inline void gimple_try_set_eval(gtry *try_stmt, gimple_seq eval) {
  try_stmt->eval = eval;
}
...
inline void gimple_try_set_cleanup(gtry *try_stmt, gimple_seq cleanup) {
  try_stmt->cleanup = cleanup;
}

/* Return a pointer to the cleanup sequence for cleanup statement GS.  */

inline gimple_seq *gimple_wce_cleanup_ptr(gimple *gs) {
...
inline gimple_seq gimple_wce_cleanup(gimple *gs) {
  return *gimple_wce_cleanup_ptr(gs);
}

/* Set CLEANUP to be the cleanup sequence for GS.  */

inline void gimple_wce_set_cleanup(gimple *gs, gimple_seq cleanup) {
  gimple_statement_wce *wce_stmt = as_a<gimple_statement_wce *>(gs);
...
inline bool gimple_wce_cleanup_eh_only(const gimple *gs) {
...
inline void gimple_wce_set_cleanup_eh_only(gimple *gs, bool eh_only_p) {
  GIMPLE_CHECK(gs, GIMPLE_WITH_CLEANUP_EXPR);
...
inline unsigned gimple_phi_capacity(const gimple *gs) {
...
inline unsigned gimple_phi_num_args(const gimple *gs) {
  const gphi *phi_stmt = as_a<const gphi *>(gs);
...
inline tree gimple_phi_result(const gphi *gs) { return gs->result; }

inline tree gimple_phi_result(const gimple *gs) {
  const gphi *phi_stmt = as_a<const gphi *>(gs);
...
inline tree *gimple_phi_result_ptr(gphi *gs) { return &gs->result; }

inline tree *gimple_phi_result_ptr(gimple *gs) {
...
inline void gimple_phi_set_result(gphi *phi, tree result) {
  phi->result = result;
...
inline struct phi_arg_d *gimple_phi_arg(gphi *gs, unsigned index) {
  gcc_gimple_checking_assert(index < gs->nargs);
  return &(gs->args[index]);
}

inline const phi_arg_d *gimple_phi_arg(const gphi *gs, unsigned index) {
  gcc_gimple_checking_assert(index < gs->nargs);
  return &(gs->args[index]);
}

inline const phi_arg_d *gimple_phi_arg(const gimple *gs, unsigned index) {
  const gphi *phi_stmt = as_a<const gphi *>(gs);
  return gimple_phi_arg(phi_stmt, index);
}

inline struct phi_arg_d *gimple_phi_arg(gimple *gs, unsigned index) {
  gphi *phi_stmt = as_a<gphi *>(gs);
  return gimple_phi_arg(phi_stmt, index);
}
...
inline void gimple_phi_set_arg(gphi *phi, unsigned index,
...
inline gimple_seq phi_nodes(const_basic_block bb) {
  gcc_checking_assert(!(bb->flags & BB_RTL));
...
inline gimple_seq *phi_nodes_ptr(basic_block bb) {
  gcc_checking_assert(!(bb->flags & BB_RTL));
  return &bb->il.gimple.phi_nodes;
}
...
inline tree gimple_phi_arg_def(const gphi *gs, size_t index) {
  return gimple_phi_arg(gs, index)->def;
}

inline tree gimple_phi_arg_def(const gimple *gs, size_t index) {
  return gimple_phi_arg(gs, index)->def;
}
...
inline tree gimple_phi_arg_def_from_edge(const gphi *gs, const_edge e) {
  gcc_checking_assert(e->dest == gimple_bb(gs));
  return gimple_phi_arg(gs, e->dest_idx)->def;
}

inline tree gimple_phi_arg_def_from_edge(const gimple *gs, const_edge e) {
  gcc_checking_assert(e->dest == gimple_bb(gs));
  return gimple_phi_arg(gs, e->dest_idx)->def;
}
...
inline tree gimple_arg(const gimple *gs, unsigned int i) {
  if (auto phi = dyn_cast<const gphi *>(gs))
...
inline tree *gimple_arg_ptr(gimple *gs, unsigned int i) {
...
inline int gimple_resx_region(const gresx *resx_stmt) {
  return resx_stmt->region;
}

/* Set REGION to be the region number for GIMPLE_RESX RESX_STMT.  */

inline void gimple_resx_set_region(gresx *resx_stmt, int region) {
  resx_stmt->region = region;
}

/* Return the region number for GIMPLE_EH_DISPATCH EH_DISPATCH_STMT.  */

inline int gimple_eh_dispatch_region(const geh_dispatch *eh_dispatch_stmt) {
...
inline void gimple_eh_dispatch_set_region(geh_dispatch *eh_dispatch_stmt,
                                          int region) {
...
inline unsigned gimple_switch_num_labels(const gswitch *gs) {
  unsigned num_ops;
...
inline void gimple_switch_set_num_labels(gswitch *g, unsigned nlabels) {
...
inline tree gimple_switch_index(const gswitch *gs) { return gs->op[0]; }

/* Return a pointer to the index variable for the switch statement GS.  */

inline tree *gimple_switch_index_ptr(gswitch *gs) { return &gs->op[0]; }

/* Set INDEX to be the index variable for switch statement GS.  */

inline void gimple_switch_set_index(gswitch *gs, tree index) {
...
inline tree gimple_switch_label(const gswitch *gs, unsigned index) {
...
inline void gimple_switch_set_label(gswitch *gs, unsigned index, tree label) {
...
inline tree gimple_switch_default_label(const gswitch *gs) {
...
inline void gimple_switch_set_default_label(gswitch *gs, tree label) {
  gcc_checking_assert(!CASE_LOW(label) && !CASE_HIGH(label));
...
inline bool is_gimple_debug(const gimple *gs) {
  return gimple_code(gs) == GIMPLE_DEBUG;
}

/* Return the first nondebug statement in GIMPLE sequence S.  */

inline gimple *gimple_seq_first_nondebug_stmt(gimple_seq s) {
  gimple_seq_node n = gimple_seq_first(s);
...
inline gimple *gimple_seq_last_nondebug_stmt(gimple_seq s) {
  gimple_seq_node n;
...
inline bool gimple_debug_bind_p(const gimple *s) {
...
inline tree gimple_debug_bind_get_var(const gimple *dbg) {
...
inline tree gimple_debug_bind_get_value(const gimple *dbg) {
  GIMPLE_CHECK(dbg, GIMPLE_DEBUG);
  gcc_gimple_checking_assert(gimple_debug_bind_p(dbg));
...
inline tree *gimple_debug_bind_get_value_ptr(gimple *dbg) {
  GIMPLE_CHECK(dbg, GIMPLE_DEBUG);
  gcc_gimple_checking_assert(gimple_debug_bind_p(dbg));
...
inline void gimple_debug_bind_set_var(gimple *dbg, tree var) {
  GIMPLE_CHECK(dbg, GIMPLE_DEBUG);
  gcc_gimple_checking_assert(gimple_debug_bind_p(dbg));
...
inline void gimple_debug_bind_set_value(gimple *dbg, tree value) {
  GIMPLE_CHECK(dbg, GIMPLE_DEBUG);
  gcc_gimple_checking_assert(gimple_debug_bind_p(dbg));
...
inline void gimple_debug_bind_reset_value(gimple *dbg) {
  GIMPLE_CHECK(dbg, GIMPLE_DEBUG);
  gcc_gimple_checking_assert(gimple_debug_bind_p(dbg));
...
inline bool gimple_debug_bind_has_value_p(gimple *dbg) {
  GIMPLE_CHECK(dbg, GIMPLE_DEBUG);
  gcc_gimple_checking_assert(gimple_debug_bind_p(dbg));
...
inline bool gimple_debug_source_bind_p(const gimple *s) {
  if (is_gimple_debug(s))
...
inline tree gimple_debug_source_bind_get_var(const gimple *dbg) {
  GIMPLE_CHECK(dbg, GIMPLE_DEBUG);
...
inline tree gimple_debug_source_bind_get_value(const gimple *dbg) {
  GIMPLE_CHECK(dbg, GIMPLE_DEBUG);
  gcc_gimple_checking_assert(gimple_debug_source_bind_p(dbg));
  return gimple_op(dbg, 1);
}
...
inline tree *gimple_debug_source_bind_get_value_ptr(gimple *dbg) {
  GIMPLE_CHECK(dbg, GIMPLE_DEBUG);
  gcc_gimple_checking_assert(gimple_debug_source_bind_p(dbg));
  return gimple_op_ptr(dbg, 1);
}
...
inline void gimple_debug_source_bind_set_var(gimple *dbg, tree var) {
  GIMPLE_CHECK(dbg, GIMPLE_DEBUG);
  gcc_gimple_checking_assert(gimple_debug_source_bind_p(dbg));
  gimple_set_op(dbg, 0, var);
}
...
inline void gimple_debug_source_bind_set_value(gimple *dbg, tree value) {
  GIMPLE_CHECK(dbg, GIMPLE_DEBUG);
  gcc_gimple_checking_assert(gimple_debug_source_bind_p(dbg));
  gimple_set_op(dbg, 1, value);
}
...
inline bool gimple_debug_begin_stmt_p(const gimple *s) {
  if (is_gimple_debug(s))
...
inline bool gimple_debug_inline_entry_p(const gimple *s) {
  if (is_gimple_debug(s))
...
inline bool gimple_debug_nonbind_marker_p(const gimple *s) {
  if (is_gimple_debug(s))
    return s->subcode == GIMPLE_DEBUG_BEGIN_STMT ||
...
inline int get_lineno(const gimple *stmt) {
  location_t loc;
...
inline tree *gimple_omp_critical_name_ptr(gomp_critical *crit_stmt) {
  return &crit_stmt->name;
}
...
inline void gimple_omp_critical_set_name(gomp_critical *crit_stmt, tree name) {
  crit_stmt->name = name;
}

/* Return the clauses associated with OMP_CRITICAL statement CRIT_STMT.  */

inline tree gimple_omp_critical_clauses(const gomp_critical *crit_stmt) {
...
inline tree *gimple_omp_critical_clauses_ptr(gomp_critical *crit_stmt) {
  return &crit_stmt->clauses;
}
...
inline void gimple_omp_critical_set_clauses(gomp_critical *crit_stmt,
                                            tree clauses) {
...
inline tree gimple_omp_ordered_clauses(const gomp_ordered *ord_stmt) {
...
inline tree *gimple_omp_ordered_clauses_ptr(gomp_ordered *ord_stmt) {
  return &ord_stmt->clauses;
}
...
inline void gimple_omp_ordered_set_clauses(gomp_ordered *ord_stmt,
                                           tree clauses) {
...
inline tree gimple_omp_scan_clauses(const gomp_scan *scan_stmt) {
...
inline tree *gimple_omp_scan_clauses_ptr(gomp_scan *scan_stmt) {
  return &scan_stmt->clauses;
}
...
inline void gimple_omp_scan_set_clauses(gomp_scan *scan_stmt, tree clauses) {
  scan_stmt->clauses = clauses;
}

/* Return the clauses associated with OMP_TASKGROUP statement GS.  */

inline tree gimple_omp_taskgroup_clauses(const gimple *gs) {
...
inline tree *gimple_omp_taskgroup_clauses_ptr(gimple *gs) {
  GIMPLE_CHECK(gs, GIMPLE_OMP_TASKGROUP);
...
inline void gimple_omp_taskgroup_set_clauses(gimple *gs, tree clauses) {
  GIMPLE_CHECK(gs, GIMPLE_OMP_TASKGROUP);
...
inline tree gimple_omp_masked_clauses(const gimple *gs) {
...
inline tree *gimple_omp_masked_clauses_ptr(gimple *gs) {
  GIMPLE_CHECK(gs, GIMPLE_OMP_MASKED);
  return &static_cast<gimple_statement_omp_single_layout *>(gs)->clauses;
}
...
inline void gimple_omp_masked_set_clauses(gimple *gs, tree clauses) {
  GIMPLE_CHECK(gs, GIMPLE_OMP_MASKED);
  static_cast<gimple_statement_omp_single_layout *>(gs)->clauses = clauses;
}
...
inline tree gimple_omp_scope_clauses(const gimple *gs) {
...
inline tree *gimple_omp_scope_clauses_ptr(gimple *gs) {
  GIMPLE_CHECK(gs, GIMPLE_OMP_SCOPE);
  return &static_cast<gimple_statement_omp_single_layout *>(gs)->clauses;
}
...
inline void gimple_omp_scope_set_clauses(gimple *gs, tree clauses) {
  GIMPLE_CHECK(gs, GIMPLE_OMP_SCOPE);
  static_cast<gimple_statement_omp_single_layout *>(gs)->clauses = clauses;
}
...
inline tree gimple_omp_dispatch_clauses(const gimple *gs) {
...
inline tree *gimple_omp_dispatch_clauses_ptr(gimple *gs) {
  GIMPLE_CHECK(gs, GIMPLE_OMP_DISPATCH);
  return &static_cast<gimple_statement_omp_single_layout *>(gs)->clauses;
}
...
inline void gimple_omp_dispatch_set_clauses(gimple *gs, tree clauses) {
  GIMPLE_CHECK(gs, GIMPLE_OMP_DISPATCH);
  static_cast<gimple_statement_omp_single_layout *>(gs)->clauses = clauses;
}
...
inline tree gimple_omp_interop_clauses(const gimple *gs) {
...
inline tree *gimple_omp_interop_clauses_ptr(gimple *gs) {
  GIMPLE_CHECK(gs, GIMPLE_OMP_INTEROP);
  return &static_cast<gimple_statement_omp_single_layout *>(gs)->clauses;
}
...
inline void gimple_omp_interop_set_clauses(gimple *gs, tree clauses) {
  GIMPLE_CHECK(gs, GIMPLE_OMP_INTEROP);
  static_cast<gimple_statement_omp_single_layout *>(gs)->clauses = clauses;
}
...
inline int gimple_omp_for_kind(const gimple *g) {
...
inline void gimple_omp_for_set_kind(gomp_for *g, int kind) {
  g->subcode =
...
inline bool gimple_omp_for_combined_p(const gimple *g) {
  GIMPLE_CHECK(g, GIMPLE_OMP_FOR);
...
inline void gimple_omp_for_set_combined_p(gomp_for *g, bool combined_p) {
  if (combined_p)
...
inline bool gimple_omp_for_combined_into_p(const gimple *g) {
  GIMPLE_CHECK(g, GIMPLE_OMP_FOR);
...
inline void gimple_omp_for_set_combined_into_p(gomp_for *g, bool combined_p) {
  if (combined_p)
...
inline tree gimple_omp_for_clauses(const gimple *gs) {
...
inline tree *gimple_omp_for_clauses_ptr(gimple *gs) {
...
inline void gimple_omp_for_set_clauses(gimple *gs, tree clauses) {
  gomp_for *omp_for_stmt = as_a<gomp_for *>(gs);
...
inline size_t gimple_omp_for_collapse(const gimple *gs) {
  const gomp_for *omp_for_stmt = as_a<const gomp_for *>(gs);
...
inline enum tree_code gimple_omp_for_cond(const gimple *gs, size_t i) {
  const gomp_for *omp_for_stmt = as_a<const gomp_for *>(gs);
...
inline void gimple_omp_for_set_cond(gimple *gs, size_t i, enum tree_code cond) {
  gomp_for *omp_for_stmt = as_a<gomp_for *>(gs);
...
inline tree gimple_omp_for_index(const gimple *gs, size_t i) {
  const gomp_for *omp_for_stmt = as_a<const gomp_for *>(gs);
  gcc_gimple_checking_assert(i < omp_for_stmt->collapse);
...
inline tree *gimple_omp_for_index_ptr(gimple *gs, size_t i) {
  gomp_for *omp_for_stmt = as_a<gomp_for *>(gs);
  gcc_gimple_checking_assert(i < omp_for_stmt->collapse);
  return &omp_for_stmt->iter[i].index;
}
...
inline void gimple_omp_for_set_index(gimple *gs, size_t i, tree index) {
  gomp_for *omp_for_stmt = as_a<gomp_for *>(gs);
  gcc_gimple_checking_assert(i < omp_for_stmt->collapse);
...
inline tree gimple_omp_for_initial(const gimple *gs, size_t i) {
  const gomp_for *omp_for_stmt = as_a<const gomp_for *>(gs);
  gcc_gimple_checking_assert(i < omp_for_stmt->collapse);
...
inline tree *gimple_omp_for_initial_ptr(gimple *gs, size_t i) {
  gomp_for *omp_for_stmt = as_a<gomp_for *>(gs);
  gcc_gimple_checking_assert(i < omp_for_stmt->collapse);
  return &omp_for_stmt->iter[i].initial;
}
...
inline void gimple_omp_for_set_initial(gimple *gs, size_t i, tree initial) {
  gomp_for *omp_for_stmt = as_a<gomp_for *>(gs);
  gcc_gimple_checking_assert(i < omp_for_stmt->collapse);
...
inline tree gimple_omp_for_final(const gimple *gs, size_t i) {
  const gomp_for *omp_for_stmt = as_a<const gomp_for *>(gs);
  gcc_gimple_checking_assert(i < omp_for_stmt->collapse);
...
inline tree *gimple_omp_for_final_ptr(gimple *gs, size_t i) {
  gomp_for *omp_for_stmt = as_a<gomp_for *>(gs);
  gcc_gimple_checking_assert(i < omp_for_stmt->collapse);
  return &omp_for_stmt->iter[i].final;
}
...
inline void gimple_omp_for_set_final(gimple *gs, size_t i, tree final) {
  gomp_for *omp_for_stmt = as_a<gomp_for *>(gs);
  gcc_gimple_checking_assert(i < omp_for_stmt->collapse);
...
inline tree gimple_omp_for_incr(const gimple *gs, size_t i) {
  const gomp_for *omp_for_stmt = as_a<const gomp_for *>(gs);
  gcc_gimple_checking_assert(i < omp_for_stmt->collapse);
...
inline tree *gimple_omp_for_incr_ptr(gimple *gs, size_t i) {
  gomp_for *omp_for_stmt = as_a<gomp_for *>(gs);
  gcc_gimple_checking_assert(i < omp_for_stmt->collapse);
  return &omp_for_stmt->iter[i].incr;
}
...
inline void gimple_omp_for_set_incr(gimple *gs, size_t i, tree incr) {
  gomp_for *omp_for_stmt = as_a<gomp_for *>(gs);
  gcc_gimple_checking_assert(i < omp_for_stmt->collapse);
...
inline gimple_seq *gimple_omp_for_pre_body_ptr(gimple *gs) {
  gomp_for *omp_for_stmt = as_a<gomp_for *>(gs);
...
inline gimple_seq gimple_omp_for_pre_body(const gimple *gs) {
...
inline void gimple_omp_for_set_pre_body(gimple *gs, gimple_seq pre_body) {
  gomp_for *omp_for_stmt = as_a<gomp_for *>(gs);
...
inline tree gimple_omp_parallel_clauses(const gimple *gs) {
...
inline tree *gimple_omp_parallel_clauses_ptr(gomp_parallel *omp_parallel_stmt) {
  return &omp_parallel_stmt->clauses;
}

/* Set CLAUSES to be the list of clauses associated with OMP_PARALLEL_STMT.  */

inline void gimple_omp_parallel_set_clauses(gomp_parallel *omp_parallel_stmt,
                                            tree clauses) {
...
inline void gimple_omp_parallel_set_child_fn(gomp_parallel *omp_parallel_stmt,
                                             tree child_fn) {
...
inline void gimple_omp_parallel_set_data_arg(gomp_parallel *omp_parallel_stmt,
                                             tree data_arg) {
...
inline tree gimple_omp_task_clauses(const gimple *gs) {
...
inline tree *gimple_omp_task_clauses_ptr(gimple *gs) {
...
inline void gimple_omp_task_set_clauses(gimple *gs, tree clauses) {
  gomp_task *omp_task_stmt = as_a<gomp_task *>(gs);
...
inline bool gimple_omp_task_taskloop_p(const gimple *g) {
...
inline void gimple_omp_task_set_taskloop_p(gimple *g, bool taskloop_p) {
  GIMPLE_CHECK(g, GIMPLE_OMP_TASK);
  if (taskloop_p)
...
inline bool gimple_omp_task_taskwait_p(const gimple *g) {
  GIMPLE_CHECK(g, GIMPLE_OMP_TASK);
...
inline void gimple_omp_task_set_taskwait_p(gimple *g, bool taskwait_p) {
  GIMPLE_CHECK(g, GIMPLE_OMP_TASK);
  if (taskwait_p)
...
inline tree gimple_omp_task_child_fn(const gimple *gs) {
  const gomp_task *omp_task_stmt = as_a<const gomp_task *>(gs);
...
inline tree *gimple_omp_task_child_fn_ptr(gimple *gs) {
  gomp_task *omp_task_stmt = as_a<gomp_task *>(gs);
  return &omp_task_stmt->child_fn;
}
...
inline void gimple_omp_task_set_child_fn(gimple *gs, tree child_fn) {
  gomp_task *omp_task_stmt = as_a<gomp_task *>(gs);
...
inline tree gimple_omp_task_data_arg(const gimple *gs) {
  const gomp_task *omp_task_stmt = as_a<const gomp_task *>(gs);
...
inline tree *gimple_omp_task_data_arg_ptr(gimple *gs) {
  gomp_task *omp_task_stmt = as_a<gomp_task *>(gs);
  return &omp_task_stmt->data_arg;
}
...
inline void gimple_omp_task_set_data_arg(gimple *gs, tree data_arg) {
  gomp_task *omp_task_stmt = as_a<gomp_task *>(gs);
...
inline tree gimple_omp_taskreg_clauses(const gimple *gs) {
...
inline tree *gimple_omp_taskreg_clauses_ptr(gimple *gs) {
...
inline void gimple_omp_taskreg_set_clauses(gimple *gs, tree clauses) {
  gimple_statement_omp_taskreg *omp_taskreg_stmt =
      as_a<gimple_statement_omp_taskreg *>(gs);
...
inline tree gimple_omp_taskreg_child_fn(const gimple *gs) {
  const gimple_statement_omp_taskreg *omp_taskreg_stmt =
      as_a<const gimple_statement_omp_taskreg *>(gs);
...
inline tree *gimple_omp_taskreg_child_fn_ptr(gimple *gs) {
  gimple_statement_omp_taskreg *omp_taskreg_stmt =
      as_a<gimple_statement_omp_taskreg *>(gs);
  return &omp_taskreg_stmt->child_fn;
}
...
inline void gimple_omp_taskreg_set_child_fn(gimple *gs, tree child_fn) {
  gimple_statement_omp_taskreg *omp_taskreg_stmt =
      as_a<gimple_statement_omp_taskreg *>(gs);
...
inline tree gimple_omp_taskreg_data_arg(const gimple *gs) {
  const gimple_statement_omp_taskreg *omp_taskreg_stmt =
      as_a<const gimple_statement_omp_taskreg *>(gs);
...
inline tree *gimple_omp_taskreg_data_arg_ptr(gimple *gs) {
  gimple_statement_omp_taskreg *omp_taskreg_stmt =
      as_a<gimple_statement_omp_taskreg *>(gs);
  return &omp_taskreg_stmt->data_arg;
}
...
inline void gimple_omp_taskreg_set_data_arg(gimple *gs, tree data_arg) {
  gimple_statement_omp_taskreg *omp_taskreg_stmt =
      as_a<gimple_statement_omp_taskreg *>(gs);
...
inline tree gimple_omp_task_copy_fn(const gimple *gs) {
  const gomp_task *omp_task_stmt = as_a<const gomp_task *>(gs);
...
inline tree *gimple_omp_task_copy_fn_ptr(gimple *gs) {
  gomp_task *omp_task_stmt = as_a<gomp_task *>(gs);
  return &omp_task_stmt->copy_fn;
}
...
inline void gimple_omp_task_set_copy_fn(gimple *gs, tree copy_fn) {
  gomp_task *omp_task_stmt = as_a<gomp_task *>(gs);
...
inline tree gimple_omp_task_arg_size(const gimple *gs) {
  const gomp_task *omp_task_stmt = as_a<const gomp_task *>(gs);
...
inline tree *gimple_omp_task_arg_size_ptr(gimple *gs) {
  gomp_task *omp_task_stmt = as_a<gomp_task *>(gs);
  return &omp_task_stmt->arg_size;
}
...
inline void gimple_omp_task_set_arg_size(gimple *gs, tree arg_size) {
  gomp_task *omp_task_stmt = as_a<gomp_task *>(gs);
...
inline tree gimple_omp_task_arg_align(const gimple *gs) {
  const gomp_task *omp_task_stmt = as_a<const gomp_task *>(gs);
...
inline tree *gimple_omp_task_arg_align_ptr(gimple *gs) {
  gomp_task *omp_task_stmt = as_a<gomp_task *>(gs);
  return &omp_task_stmt->arg_align;
}
...
inline void gimple_omp_task_set_arg_align(gimple *gs, tree arg_align) {
  gomp_task *omp_task_stmt = as_a<gomp_task *>(gs);
...
inline tree gimple_omp_single_clauses(const gimple *gs) {
...
inline tree *gimple_omp_single_clauses_ptr(gimple *gs) {
...
inline void gimple_omp_single_set_clauses(gomp_single *omp_single_stmt,
                                          tree clauses) {
...
inline tree gimple_omp_target_clauses(const gimple *gs) {
...
inline tree *gimple_omp_target_clauses_ptr(gimple *gs) {
...
inline void gimple_omp_target_set_clauses(gomp_target *omp_target_stmt,
                                          tree clauses) {
...
inline int gimple_omp_target_kind(const gimple *g) {
...
inline void gimple_omp_target_set_kind(gomp_target *g, int kind) {
...
inline tree gimple_omp_target_child_fn(const gomp_target *omp_target_stmt) {
...
inline tree *gimple_omp_target_child_fn_ptr(gomp_target *omp_target_stmt) {
  return &omp_target_stmt->child_fn;
}

/* Set CHILD_FN to be the child function for OMP_TARGET_STMT.  */

inline void gimple_omp_target_set_child_fn(gomp_target *omp_target_stmt,
                                           tree child_fn) {
...
inline tree gimple_omp_target_data_arg(const gomp_target *omp_target_stmt) {
  return omp_target_stmt->data_arg;
}

/* Return a pointer to the data argument for OMP_TARGET GS.  */

inline tree *gimple_omp_target_data_arg_ptr(gomp_target *omp_target_stmt) {
  return &omp_target_stmt->data_arg;
}

/* Set DATA_ARG to be the data argument for OMP_TARGET_STMT.  */

inline void gimple_omp_target_set_data_arg(gomp_target *omp_target_stmt,
                                           tree data_arg) {
...
inline gimple_seq *gimple_omp_target_iterator_loops_ptr(gimple *gs) {
  gomp_target *omp_target_stmt = as_a<gomp_target *>(gs);
  return &omp_target_stmt->iterator_loops;
}
...
inline void gimple_omp_target_set_iterator_loops(gomp_target *omp_target_stmt,
                                                 gimple_seq iterator_loops) {
...
inline tree gimple_omp_teams_clauses(const gimple *gs) {
...
inline tree *gimple_omp_teams_clauses_ptr(gimple *gs) {
...
inline void gimple_omp_teams_set_clauses(gomp_teams *omp_teams_stmt,
                                         tree clauses) {
...
inline tree gimple_omp_teams_child_fn(const gomp_teams *omp_teams_stmt) {
...
inline tree *gimple_omp_teams_child_fn_ptr(gomp_teams *omp_teams_stmt) {
  return &omp_teams_stmt->child_fn;
}

/* Set CHILD_FN to be the child function for OMP_TEAMS_STMT.  */

inline void gimple_omp_teams_set_child_fn(gomp_teams *omp_teams_stmt,
                                          tree child_fn) {
...
inline tree gimple_omp_teams_data_arg(const gomp_teams *omp_teams_stmt) {
  return omp_teams_stmt->data_arg;
}

/* Return a pointer to the data argument for OMP_TEAMS_STMT.  */

inline tree *gimple_omp_teams_data_arg_ptr(gomp_teams *omp_teams_stmt) {
  return &omp_teams_stmt->data_arg;
}

/* Set DATA_ARG to be the data argument for OMP_TEAMS_STMT.  */

inline void gimple_omp_teams_set_data_arg(gomp_teams *omp_teams_stmt,
                                          tree data_arg) {
...
inline bool gimple_omp_teams_host(const gomp_teams *omp_teams_stmt) {
  return (gimple_omp_subcode(omp_teams_stmt) & GF_OMP_TEAMS_HOST) != 0;
}

/* Set host flag of an OMP_TEAMS_STMT to VALUE.  */

inline void gimple_omp_teams_set_host(gomp_teams *omp_teams_stmt, bool value) {
  if (value)
...
inline tree gimple_omp_sections_clauses(const gimple *gs) {
...
inline tree *gimple_omp_sections_clauses_ptr(gimple *gs) {
...
inline void gimple_omp_sections_set_clauses(gimple *gs, tree clauses) {
  gomp_sections *omp_sections_stmt = as_a<gomp_sections *>(gs);
...
inline tree gimple_omp_sections_control(const gimple *gs) {
  const gomp_sections *omp_sections_stmt = as_a<const gomp_sections *>(gs);
...
inline tree *gimple_omp_sections_control_ptr(gimple *gs) {
  gomp_sections *omp_sections_stmt = as_a<gomp_sections *>(gs);
  return &omp_sections_stmt->control;
}
...
inline void gimple_omp_sections_set_control(gimple *gs, tree control) {
  gomp_sections *omp_sections_stmt = as_a<gomp_sections *>(gs);
...
inline void gimple_omp_atomic_store_set_val(gomp_atomic_store *store_stmt,
                                            tree val) {
  store_stmt->val = val;
}
...
inline tree gimple_omp_atomic_store_val(const gomp_atomic_store *store_stmt) {
  return store_stmt->val;
}

/* Return a pointer to the value being stored in an atomic store.  */

inline tree *gimple_omp_atomic_store_val_ptr(gomp_atomic_store *store_stmt) {
  return &store_stmt->val;
}

/* Set the LHS of an atomic load.  */

inline void gimple_omp_atomic_load_set_lhs(gomp_atomic_load *load_stmt,
                                           tree lhs) {
  load_stmt->lhs = lhs;
}
...
inline tree gimple_omp_atomic_load_lhs(const gomp_atomic_load *load_stmt) {
  return load_stmt->lhs;
}

/* Return a pointer to the LHS of an atomic load.  */

inline tree *gimple_omp_atomic_load_lhs_ptr(gomp_atomic_load *load_stmt) {
  return &load_stmt->lhs;
}

/* Set the RHS of an atomic load.  */

inline void gimple_omp_atomic_load_set_rhs(gomp_atomic_load *load_stmt,
                                           tree rhs) {
  load_stmt->rhs = rhs;
}
...
inline tree gimple_omp_atomic_load_rhs(const gomp_atomic_load *load_stmt) {
  return load_stmt->rhs;
}

/* Return a pointer to the RHS of an atomic load.  */

inline tree *gimple_omp_atomic_load_rhs_ptr(gomp_atomic_load *load_stmt) {
  return &load_stmt->rhs;
}

/* Get the definition of the control variable in a GIMPLE_OMP_CONTINUE.  */

inline tree gimple_omp_continue_control_def(const gomp_continue *cont_stmt) {
  return cont_stmt->control_def;
}

/* The same as above, but return the address.  */

inline tree *gimple_omp_continue_control_def_ptr(gomp_continue *cont_stmt) {
  return &cont_stmt->control_def;
}

/* Set the definition of the control variable in a GIMPLE_OMP_CONTINUE.  */

inline void gimple_omp_continue_set_control_def(gomp_continue *cont_stmt,
                                                tree def) {
...
inline tree gimple_omp_continue_control_use(const gomp_continue *cont_stmt) {
  return cont_stmt->control_use;
}

/* The same as above, but return the address.  */

inline tree *gimple_omp_continue_control_use_ptr(gomp_continue *cont_stmt) {
  return &cont_stmt->control_use;
}

/* Set the use of the control variable in a GIMPLE_OMP_CONTINUE.  */

inline void gimple_omp_continue_set_control_use(gomp_continue *cont_stmt,
                                                tree use) {
...
inline tree gimple_assume_guard(const gimple *gs) {
...
inline void gimple_assume_set_guard(gimple *gs, tree guard) {
  gimple_statement_assume *assume_stmt = as_a<gimple_statement_assume *>(gs);
  assume_stmt->guard = guard;
}

inline tree *gimple_assume_guard_ptr(gimple *gs) {
  gimple_statement_assume *assume_stmt = as_a<gimple_statement_assume *>(gs);
  return &assume_stmt->guard;
}
...
inline gimple_seq *gimple_assume_body_ptr(gimple *gs) {
  gimple_statement_assume *assume_stmt = as_a<gimple_statement_assume *>(gs);
...
inline gimple_seq gimple_assume_body(const gimple *gs) {
  const gimple_statement_assume *assume_stmt =
      as_a<const gimple_statement_assume *>(gs);
  return assume_stmt->body;
}
...
inline gimple_seq *gimple_transaction_body_ptr(gtransaction *transaction_stmt) {
...
inline tree *gimple_transaction_label_norm_ptr(gtransaction *transaction_stmt) {
  return &transaction_stmt->label_norm;
}
...
inline tree *gimple_transaction_label_over_ptr(gtransaction *transaction_stmt) {
  return &transaction_stmt->label_over;
}
...
inline void gimple_transaction_set_body(gtransaction *transaction_stmt,
                                        gimple_seq body) {
...
inline void gimple_transaction_set_label_norm(gtransaction *transaction_stmt,
                                              tree label) {
  transaction_stmt->label_norm = label;
}

inline void gimple_transaction_set_label_uninst(gtransaction *transaction_stmt,
                                                tree label) {
  transaction_stmt->label_uninst = label;
}

inline void gimple_transaction_set_label_over(gtransaction *transaction_stmt,
                                              tree label) {
...
inline void gimple_transaction_set_subcode(gtransaction *transaction_stmt,
...
inline tree *gimple_return_retval_ptr(greturn *gs) { return &gs->op[0]; }

/* Return the return value for GIMPLE_RETURN GS.  */

inline tree gimple_return_retval(const greturn *gs) { return gs->op[0]; }

/* Set RETVAL to be the return value for GIMPLE_RETURN GS.  */

inline void gimple_return_set_retval(greturn *gs, tree retval) {
  gs->op[0] = retval;
}
...
inline bool is_gimple_omp(const gimple *stmt) {
...
inline bool is_gimple_omp_oacc(const gimple *stmt) {
...
inline bool is_gimple_omp_offloaded(const gimple *stmt) {
  gcc_assert(is_gimple_omp(stmt));
  switch (gimple_code(stmt)) {
  case GIMPLE_OMP_TARGET:
    switch (gimple_omp_target_kind(stmt)) {
...
inline bool gimple_nop_p(const gimple *g) {
  return gimple_code(g) == GIMPLE_NOP;
}

/* Return true if GS is a GIMPLE_RESX.  */

inline bool is_gimple_resx(const gimple *gs) {
...
inline enum gimple_alloc_kind gimple_alloc_kind(enum gimple_code code) {
  switch (code) {
  case GIMPLE_ASSIGN:
...
inline bool gimple_do_not_emit_location_p(gimple *g) {
...
inline void gimple_set_do_not_emit_location(gimple *g) {
