...
inline bool real_isdenormal(const REAL_VALUE_TYPE *r, machine_mode mode) {
...
extern void real_to_decimal(char *, const REAL_VALUE_TYPE *, size_t, size_t,
                            int);
...
#define REAL_VALUE_TO_TARGET_LONG_DOUBLE(IN, OUT)                              \
  real_to_target(                                                              \
      OUT, &(IN),                                                              \
      float_mode_for_size(TYPE_PRECISION(long_double_type_node)).require())
...
#define REAL_VALUE_TO_TARGET_DECIMAL32(IN, OUT)                                \
  ((OUT) =                                                                     \
       real_to_target(NULL, &(IN), decimal_float_mode_for_size(32).require()))
