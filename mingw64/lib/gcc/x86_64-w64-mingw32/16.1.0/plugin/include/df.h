...
enum df_changeable_flags {
  ...
  DF_EQ_NOTES = 1
      << 2, /* Build chains with uses present in EQUIV/EQUAL notes. */
...
public:
  ...
  bitmap
      exit_block_uses; /* The set of hardware registers used in exit block.  */
...
extern bool can_move_insns_across(rtx_insn *, rtx_insn *, rtx_insn *,
                                  rtx_insn *, basic_block, regset, regset,
                                  rtx_insn **);
...
inline struct df_scan_bb_info *df_scan_get_bb_info(unsigned int index) {
...
inline class df_rd_bb_info *df_rd_get_bb_info(unsigned int index) {
...
inline class df_lr_bb_info *df_lr_get_bb_info(unsigned int index) {
...
inline class df_md_bb_info *df_md_get_bb_info(unsigned int index) {
...
inline class df_live_bb_info *df_live_get_bb_info(unsigned int index) {
...
inline class df_word_lr_bb_info *df_word_lr_get_bb_info(unsigned int index) {
...
inline class df_mir_bb_info *df_mir_get_bb_info(unsigned int index) {
...
inline bitmap df_get_live_out(basic_block bb) {
...
inline bitmap df_get_live_in(basic_block bb) {
  gcc_checking_assert(df_lr);
...
inline df_ref df_get_artificial_defs(unsigned int bb_index) {
  return df_scan_get_bb_info(bb_index)->artificial_defs;
}

/* Get the artificial uses for a basic block.  */

inline df_ref df_get_artificial_uses(unsigned int bb_index) {
...
inline df_ref df_single_def(const df_insn_info *info) {
...
inline df_ref df_single_use(const df_insn_info *info) {
