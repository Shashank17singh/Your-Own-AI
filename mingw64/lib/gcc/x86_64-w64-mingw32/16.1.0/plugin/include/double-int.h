...
inline HOST_WIDE_INT double_int::to_shwi() const { return (HOST_WIDE_INT)low; }

/* Returns value of CST as an unsigned number.  CST must satisfy
   double_int::fits_unsigned.  */

inline unsigned HOST_WIDE_INT double_int::to_uhwi() const { return low; }

/* Returns true if CST fits in unsigned HOST_WIDE_INT.  */

inline bool double_int::fits_uhwi() const { return high == 0; }
...
inline bool double_int::is_zero() const { return low == 0 && high == 0; }

/* Returns true if CST is one.  */

inline bool double_int::is_one() const { return low == 1 && high == 0; }
...
inline bool double_int::is_negative() const { return high < 0; }
