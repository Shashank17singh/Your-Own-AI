...
inline gimple_match_op::gimple_match_op(const gimple_match_cond &cond_in,
...
inline gimple_match_op::gimple_match_op(const gimple_match_cond &cond_in,
                                        ...
                                        tree op0, tree op1, tree op2, tree op3,
                                        tree op4, tree op5)
    : cond(cond_in), code(code_in), type(type_in), reverse(false), num_ops(6) {
  ops[0] = op0;
  ops[1] = op1;
  ops[2] = op2;
  ops[3] = op3;
...
inline gimple_match_op::gimple_match_op(const gimple_match_cond &cond_in,
    ...
    : cond(cond_in), code(code_in), type(type_in), reverse(false), num_ops(7) {
  ops[0] = op0;
  ops[1] = op1;
  ops[2] = op2;
  ops[3] = op3;
...
inline void gimple_match_op::set_op(code_helper code_in, tree type_in,
                                    unsigned int num_ops_in) {
  code = code_in;
  type = type_in;
  num_ops = num_ops_in;
...
inline void gimple_match_op::set_op(code_helper code_in, tree type_in, tree op0,
                                    tree op1, tree op2, bool reverse_in) {
  code = code_in;
  type = type_in;
  reverse = reverse_in;
  num_ops = 3;
...
bool gimple_simplify(gimple *, gimple_match_op *, gimple_seq *, tree (*)(tree),
                     tree (*)(tree));
