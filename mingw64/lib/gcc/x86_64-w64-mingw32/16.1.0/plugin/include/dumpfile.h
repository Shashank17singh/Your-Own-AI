...
enum dump_kind { DK_none, DK_lang, DK_tree, DK_rtl, DK_ipa };
...
inline dump_flags_t operator|(dump_flags_t lhs, dump_flags_t rhs) {
...
inline dump_flags_t operator~(dump_flags_t flags) {
...
inline optgroup_flags_t operator|(optgroup_flags_t lhs, optgroup_flags_t rhs) {
  return (optgroup_flags_t)((std::underlying_type<dump_flags_t>::type)lhs |
                            (std::underlying_type<dump_flags_t>::type)rhs);
}

inline optgroup_flags_t &operator|=(optgroup_flags_t &lhs,
...
public:
  ...
  location_t get_location_t() const { return m_user_location.get_location_t(); }
...
extern dump_flags_t parse_dump_option(const char *, const char **);
...
inline bool dump_enabled_p(void) { return dumps_are_enabled; }
...
extern void dump_printf_loc(const dump_metadata_t &,
                            const dump_user_location_t &, const char *, ...)
