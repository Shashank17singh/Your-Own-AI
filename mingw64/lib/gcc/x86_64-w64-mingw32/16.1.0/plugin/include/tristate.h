...
inline tristate operator!(tristate t) { return t.not_(); }

inline tristate operator||(tristate a, tristate b) { return a.or_(b); }

inline tristate operator&&(tristate a, tristate b) { return a.and_(b); }
