...
inline tree_stmt_iterator tsi_start(tree t) {
...
inline tree_stmt_iterator tsi_last(tree t) {
  tree_stmt_iterator i;
...
inline bool tsi_end_p(tree_stmt_iterator i) { return i.ptr == NULL; }

inline bool tsi_one_before_end_p(tree_stmt_iterator i) {
  return i.ptr != NULL && i.ptr->next == NULL;
}

inline void tsi_next(tree_stmt_iterator *i) { ++(*i); }

inline void tsi_prev(tree_stmt_iterator *i) { --(*i); }

inline tree *tsi_stmt_ptr(tree_stmt_iterator i) { return &(*i); }

inline tree tsi_stmt(tree_stmt_iterator i) { return *i; }
