...
extern const char *get_opt_url_suffix(int option_index, unsigned lang_mask);
...
extern bool common_handle_option(
    ...
    diagnostics::context *dc, void (*target_option_override_hook)(void));
...
extern void default_options_optimization(
    ...
    const struct cl_option_handlers *handlers, diagnostics::context *dc);
...
extern label_text get_option_url_suffix(int option_index, unsigned lang_mask);

extern const char *maybe_prepend_dump_dir_name(const gcc_options &opts);
