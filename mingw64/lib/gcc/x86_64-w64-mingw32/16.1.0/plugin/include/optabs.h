...
inline void create_expand_operand(class expand_operand *op,
                                  enum expand_operand_type type, rtx value,
...
inline void create_fixed_operand(class expand_operand *op, rtx x) {
...
inline void create_output_operand(class expand_operand *op, rtx x,
                                  machine_mode mode) {
...
inline void create_input_operand(class expand_operand *op, rtx value,
                                 machine_mode mode) {
...
inline void create_undefined_input_operand(class expand_operand *op,
                                           machine_mode mode) {
  create_expand_operand(op, EXPAND_UNDEFINED_INPUT, gen_rtx_SCRATCH(mode), mode,
                        false);
}
...
inline void create_convert_operand_to(class expand_operand *op, rtx value,
                                      machine_mode mode, bool unsigned_p) {
...
inline void create_convert_operand_from(class expand_operand *op, rtx value,
                                        machine_mode mode, bool unsigned_p) {
...
inline void create_address_operand(class expand_operand *op, rtx value) {
...
extern rtx expand_widen_pattern_expr(const struct separate_ops *, rtx, rtx, rtx,
                                     rtx, int);
extern rtx expand_ternary_op(machine_mode mode, optab ternary_optab, rtx op0,
                             rtx op1, rtx op2, rtx target, int unsignedp);
extern rtx simplify_expand_binop(machine_mode mode, optab binoptab, rtx op0,
...
extern rtx expand_simple_binop(machine_mode, enum rtx_code, rtx, rtx, rtx, int,
                               enum optab_methods);
...
extern rtx sign_expand_binop(machine_mode, optab, optab, rtx, rtx, rtx, int,
                             enum optab_methods);
...
enum can_compare_purpose { ccp_jump, ccp_store_flag };
...
extern rtx prepare_operand(enum insn_code, rtx, int, machine_mode, machine_mode,
                           int);
/* Emit a pair of rtl insns to compare two rtx's and to jump
   to a label if the comparison is true.  */
extern void emit_cmp_and_jump_insns(
    rtx, rtx, enum rtx_code, rtx, machine_mode, int, rtx,
    profile_probability prob = profile_probability::uninitialized());
extern void emit_cmp_and_jump_insns(
    rtx, rtx, enum rtx_code, rtx, machine_mode, int, tree, rtx,
    profile_probability prob = profile_probability::uninitialized());
...
rtx emit_conditional_neg_or_complement(rtx, rtx_code, machine_mode, rtx, rtx,
                                       rtx);

rtx emit_conditional_add(rtx, enum rtx_code, rtx, rtx, machine_mode, rtx, rtx,
                         machine_mode, int);
...
extern void create_convert_operand_from_type(class expand_operand *op,
                                             rtx value, tree type);
extern bool maybe_legitimize_operands(enum insn_code icode, unsigned int opno,
                                      unsigned int nops,
