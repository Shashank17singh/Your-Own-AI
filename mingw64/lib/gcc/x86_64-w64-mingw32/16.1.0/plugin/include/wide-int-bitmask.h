...
constexpr wide_int_bitmask::wide_int_bitmask() : low(0), high(0) {}

constexpr wide_int_bitmask::wide_int_bitmask(uint64_t l) : low(l), high(0) {}

constexpr wide_int_bitmask::wide_int_bitmask(uint64_t l, uint64_t h)
    : low(l), high(h) {}
