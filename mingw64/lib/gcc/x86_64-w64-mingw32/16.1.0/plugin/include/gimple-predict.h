...
inline enum br_predictor gimple_predict_predictor(const gimple *gs) {
...
inline void gimple_predict_set_predictor(gimple *gs,
...
inline enum prediction gimple_predict_outcome(const gimple *gs) {
  GIMPLE_CHECK(gs, GIMPLE_PREDICT);
...
inline void gimple_predict_set_outcome(gimple *gs, enum prediction outcome) {
  GIMPLE_CHECK(gs, GIMPLE_PREDICT);
  if (outcome == TAKEN)
...
inline gimple *gimple_build_predict(enum br_predictor predictor,
...
inline bool is_gimple_predict(const gimple *gs) {
