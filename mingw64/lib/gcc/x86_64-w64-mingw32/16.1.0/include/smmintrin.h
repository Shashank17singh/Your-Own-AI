...
extern __inline __m128d
    __attribute__((__gnu_inline__, __always_inline__,
                   __artificial__)) _mm_round_pd(__m128d __V, const int __M) {
...
extern __inline __m128
    __attribute__((__gnu_inline__, __always_inline__,
                   __artificial__)) _mm_round_ps(__m128 __V, const int __M) {
...
extern __inline int
    __attribute__((__gnu_inline__, __always_inline__,
                   __artificial__)) _mm_extract_ps(__m128 __X, const int __N) {
  union {
    int __i;
    float __f;
  } __tmp;
...
#define _mm_extract_ps(X, N)                                                   \
  (__extension__({                                                             \
    ...
    __tmp.__f = __builtin_ia32_vec_ext_v4sf((__v4sf)(__m128)(X), (int)(N));    \
    __tmp.__i;                                                                 \
  }))
#endif
