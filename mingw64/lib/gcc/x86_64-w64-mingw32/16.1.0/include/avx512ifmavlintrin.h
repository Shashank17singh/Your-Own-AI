...
#define _mm_madd52lo_epu64(A, B, C)                                            \
  ((__m128i)__builtin_ia32_vpmadd52luq128((__v2di)(A), (__v2di)(B),            \
                                          (__v2di)(C)))

#define _mm_madd52hi_epu64(A, B, C)                                            \
  ((__m128i)__builtin_ia32_vpmadd52huq128((__v2di)(A), (__v2di)(B),            \
                                          (__v2di)(C)))

#define _mm256_madd52lo_epu64(A, B, C)                                         \
  ((__m256i)__builtin_ia32_vpmadd52luq256((__v4di)(A), (__v4di)(B),            \
                                          (__v4di)(C)))

#define _mm256_madd52hi_epu64(A, B, C)                                         \
  ((__m256i)__builtin_ia32_vpmadd52huq256((__v4di)(A), (__v4di)(B),            \
                                          (__v4di)(C)))
