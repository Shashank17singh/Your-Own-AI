...
extern __inline __m256d
    __attribute__((__gnu_inline__, __always_inline__,
                   __artificial__)) _mm256_add_pd(__m256d __A, __m256d __B) {
...
#define _mm256_blend_ps(X, Y, M)                                               \
  ((__m256)__builtin_ia32_blendps256((__v8sf)(__m256)(X), (__v8sf)(__m256)(Y), \
                                     (int)(M)))
#endif
...
#define _mm256_dp_ps(X, Y, M)                                                  \
  ((__m256)__builtin_ia32_dpps256((__v8sf)(__m256)(X), (__v8sf)(__m256)(Y),    \
                                  (int)(M)))
#endif

extern __inline __m256d
    __attribute__((__gnu_inline__, __always_inline__,
                   __artificial__)) _mm256_hadd_pd(__m256d __X, __m256d __Y) {
...
extern __inline __m256d
    __attribute__((__gnu_inline__, __always_inline__,
                   __artificial__)) _mm256_sub_pd(__m256d __A, __m256d __B) {
  return (__m256d)((__v4df)__A - (__v4df)__B);
}
...
#define _mm256_cmp_ps(X, Y, P)                                                 \
  ((__m256)__builtin_ia32_cmpps256((__v8sf)(__m256)(X), (__v8sf)(__m256)(Y),   \
                                   (int)(P)))
#endif

extern __inline int
    __attribute__((__gnu_inline__, __always_inline__,
                   __artificial__)) _mm256_cvtsi256_si32(__m256i __A) {
...
#define _mm256_extractf128_ps(X, N)                                            \
  ((__m128)__builtin_ia32_vextractf128_ps256((__v8sf)(__m256)(X), (int)(N)))

#define _mm256_extractf128_si256(X, N)                                         \
  ((__m128i)__builtin_ia32_vextractf128_si256((__v8si)(__m256i)(X), (int)(N)))
...
extern __inline void __attribute__((__gnu_inline__, __always_inline__,
                                    __artificial__)) _mm256_zeroall(void) {
...
extern __inline __m128d
    __attribute__((__gnu_inline__, __always_inline__,
                   __artificial__)) _mm_permute_pd(__m128d __X, const int __C) {
...
extern __inline __m128
    __attribute__((__gnu_inline__, __always_inline__,
                   __artificial__)) _mm_broadcast_ss(float const *__X) {
...
extern __inline __m256d
    __attribute__((__gnu_inline__, __always_inline__,
                   __artificial__)) _mm256_load_pd(double const *__P) {
  return *(__m256d *)__P;
}
