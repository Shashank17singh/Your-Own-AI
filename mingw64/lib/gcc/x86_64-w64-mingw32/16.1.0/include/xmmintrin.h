...
extern __inline void
  ...
  __builtin_ia32_prefetch(__P, (__I & 0xC) >> 2, __I & 0x3, (__I & 0x10) >> 4);
}
#else
...
#define _mm_cmp_ps(X, Y, P)                                                    \
  ((__m128)__builtin_ia32_cmpps((__v4sf)(__m128)(X), (__v4sf)(__m128)(Y),      \
                                (int)(P)))

#define _mm_cmp_ss(X, Y, P)                                                    \
  ((__m128)__builtin_ia32_cmpss((__v4sf)(__m128)(X), (__v4sf)(__m128)(Y),      \
                                (int)(P)))
#endif
...
extern __inline __m64
    __attribute__((__gnu_inline__, __always_inline__,
                   __artificial__)) _mm_shuffle_pi16(__m64 __A, int const __N) {
