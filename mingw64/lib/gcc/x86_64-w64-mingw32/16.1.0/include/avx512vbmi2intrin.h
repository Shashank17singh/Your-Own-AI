...
#define _mm512_mask_shrdi_epi32(A, B, C, D, E)                                 \
  ((__m512i)__builtin_ia32_vpshrd_v16si_mask(                                  \
      (__v16si)(__m512i)(C), (__v16si)(__m512i)(D), (int)(E),                  \
      (__v16si)(__m512i)(A), (__mmask16)(B)))
#define _mm512_maskz_shrdi_epi32(A, B, C, D)                                   \
  ((__m512i)__builtin_ia32_vpshrd_v16si_mask(                                  \
      (__v16si)(__m512i)(B), (__v16si)(__m512i)(C), (int)(D),                  \
...
#define _mm512_mask_shrdi_epi64(A, B, C, D, E)                                 \
  ((__m512i)__builtin_ia32_vpshrd_v8di_mask(                                   \
      (__v8di)(__m512i)(C), (__v8di)(__m512i)(D), (int)(E),                    \
      (__v8di)(__m512i)(A), (__mmask8)(B)))
#define _mm512_maskz_shrdi_epi64(A, B, C, D)                                   \
  ((__m512i)__builtin_ia32_vpshrd_v8di_mask(                                   \
      (__v8di)(__m512i)(B), (__v8di)(__m512i)(C), (int)(D),                    \
...
#define _mm512_mask_shldi_epi32(A, B, C, D, E)                                 \
  ((__m512i)__builtin_ia32_vpshld_v16si_mask(                                  \
      (__v16si)(__m512i)(C), (__v16si)(__m512i)(D), (int)(E),                  \
      (__v16si)(__m512i)(A), (__mmask16)(B)))
...
#define _mm512_mask_shldi_epi64(A, B, C, D, E)                                 \
  ((__m512i)__builtin_ia32_vpshld_v8di_mask(                                   \
      (__v8di)(__m512i)(C), (__v8di)(__m512i)(D), (int)(E),                    \
      (__v8di)(__m512i)(A), (__mmask8)(B)))
...
#define _mm512_mask_shrdi_epi16(A, B, C, D, E)                                 \
  ((__m512i)__builtin_ia32_vpshrd_v32hi_mask(                                  \
      (__v32hi)(__m512i)(C), (__v32hi)(__m512i)(D), (int)(E),                  \
      (__v32hi)(__m512i)(A), (__mmask32)(B)))
#define _mm512_maskz_shrdi_epi16(A, B, C, D)                                   \
  ((__m512i)__builtin_ia32_vpshrd_v32hi_mask(                                  \
      (__v32hi)(__m512i)(B), (__v32hi)(__m512i)(C), (int)(D),                  \
