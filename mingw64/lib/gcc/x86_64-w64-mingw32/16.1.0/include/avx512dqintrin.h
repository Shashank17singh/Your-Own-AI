...
extern __inline __m128d
    ...
    _mm_maskz_reduce_round_sd(__mmask8 __U, __m128d __A, __m128d __B, int __C,
                              const int __R) {
  return (__m128d)__builtin_ia32_reducesd_mask_round(
      (__v2df)__A, (__v2df)__B, __C, (__v2df)_mm_avx512_setzero_pd(), __U, __R);
}
...
extern __inline __m128
  ...
  return (__m128)__builtin_ia32_reducess_mask_round(
      (__v4sf)__A, (__v4sf)__B, __C, (__v4sf)_mm_avx512_setzero_ps(),
      (__mmask8)-1, __R);
}
...
extern __inline __m128
    ...
    _mm_maskz_reduce_round_ss(__mmask8 __U, __m128 __A, __m128 __B, int __C,
                              const int __R) {
  return (__m128)__builtin_ia32_reducess_mask_round(
      (__v4sf)__A, (__v4sf)__B, __C, (__v4sf)_mm_avx512_setzero_ps(), __U, __R);
}
...
#define _mm_range_sd(A, B, C)                                                  \
  ((__m128d)__builtin_ia32_rangesd128_mask_round(                              \
...
#define _mm_range_ss(A, B, C)                                                  \
  ((__m128)__builtin_ia32_rangess128_mask_round(                               \
...
#define _mm_range_round_sd(A, B, C, R)                                         \
  ((__m128d)__builtin_ia32_rangesd128_mask_round(                              \
      (__v2df)(__m128d)(A), (__v2df)(__m128d)(B), (int)(C),                    \
      (__v2df)_mm_avx512_setzero_pd(), (__mmask8) - 1, (R)))
...
#define _mm_maskz_range_round_sd(U, A, B, C, R)                                \
  ((__m128d)__builtin_ia32_rangesd128_mask_round(                              \
      (__v2df)(__m128d)(A), (__v2df)(__m128d)(B), (int)(C),                    \
      (__v2df)_mm_avx512_setzero_pd(), (__mmask8)(U), (R)))

#define _mm_range_round_ss(A, B, C, R)                                         \
  ((__m128)__builtin_ia32_rangess128_mask_round(                               \
      (__v4sf)(__m128)(A), (__v4sf)(__m128)(B), (int)(C),                      \
      (__v4sf)_mm_avx512_setzero_ps(), (__mmask8) - 1, (R)))
...
#define _mm_maskz_range_round_ss(U, A, B, C, R)                                \
  ((__m128)__builtin_ia32_rangess128_mask_round(                               \
      (__v4sf)(__m128)(A), (__v4sf)(__m128)(B), (int)(C),                      \
      (__v4sf)_mm_avx512_setzero_ps(), (__mmask8)(U), (R)))

#define _mm_fpclass_ss_mask(X, C)                                              \
  ((__mmask8)__builtin_ia32_fpclassss_mask((__v4sf)(__m128)(X), (int)(C),      \
                                           (__mmask8)(-1)))

#define _mm_fpclass_sd_mask(X, C)                                              \
  ((__mmask8)__builtin_ia32_fpclasssd_mask((__v2df)(__m128d)(X), (int)(C),     \
                                           (__mmask8)(-1)))
...
#define _mm_reduce_round_sd(A, B, C, R)                                        \
  ((__m128d)__builtin_ia32_reducesd_mask_round(                                \
      (__v2df)(__m128d)(A), (__v2df)(__m128d)(B), (int)(C),                    \
...
#define _mm_reduce_round_ss(A, B, C, R)                                        \
  ((__m128)__builtin_ia32_reducess_mask_round(                                 \
      (__v4sf)(__m128)(A), (__v4sf)(__m128)(B), (int)(C),                      \
...
extern __inline __m512d
    __attribute__((__gnu_inline__, __always_inline__,
                   __artificial__)) _mm512_broadcast_f64x2(__m128d __A) {
...
extern __inline __m512d
  ...
  return (__m512d)__builtin_ia32_cvtqq2pd512_mask(
      (__v8di)__A, (__v8df)_mm512_setzero_pd(), (__mmask8)-1,
      _MM_FROUND_CUR_DIRECTION);
}
...
extern __inline __m512d
  ...
  return (__m512d)__builtin_ia32_cvtqq2pd512_mask(
      (__v8di)__A, (__v8df)__W, (__mmask8)__U, _MM_FROUND_CUR_DIRECTION);
}
...
extern __inline __m512d
  ...
  return (__m512d)__builtin_ia32_cvtqq2pd512_mask(
      (__v8di)__A, (__v8df)_mm512_setzero_pd(), (__mmask8)__U,
      _MM_FROUND_CUR_DIRECTION);
}
...
extern __inline __m512d
  ...
  return (__m512d)__builtin_ia32_rangepd512_mask(
      (__v8df)__A, (__v8df)__B, __C, (__v8df)_mm512_setzero_pd(), (__mmask8)-1,
      _MM_FROUND_CUR_DIRECTION);
}
...
#define _mm512_cvtt_roundpd_epi64(A, B)                                        \
  ((__m512i)__builtin_ia32_cvttpd2qq512_mask(                                  \
      (A), (__v8di)_mm512_setzero_si512(), -1, (B)))
...
#define _mm512_maskz_cvtt_roundpd_epi64(U, A, B)                               \
  ((__m512i)__builtin_ia32_cvttpd2qq512_mask(                                  \
      (A), (__v8di)_mm512_setzero_si512(), (U), (B)))
...
#define _mm512_cvt_roundepi64_ps(A, B)                                         \
  ((__m256)__builtin_ia32_cvtqq2ps512_mask(                                    \
      (__v8di)(A), (__v8sf)_mm256_setzero_ps(), -1, (B)))
...
#define _mm512_maskz_cvt_roundepi64_ps(U, A, B)                                \
  ((__m256)__builtin_ia32_cvtqq2ps512_mask(                                    \
      (__v8di)(A), (__v8sf)_mm256_setzero_ps(), (U), (B)))
...
#define _mm512_cvt_roundepi64_pd(A, B)                                         \
  ((__m512d)__builtin_ia32_cvtqq2pd512_mask(                                   \
      (__v8di)(A), (__v8df)_mm512_setzero_pd(), -1, (B)))
...
#define _mm512_maskz_cvt_roundepi64_pd(U, A, B)                                \
  ((__m512d)__builtin_ia32_cvtqq2pd512_mask(                                   \
      (__v8di)(A), (__v8df)_mm512_setzero_pd(), (U), (B)))
...
#define _mm512_reduce_round_pd(A, B, R)                                        \
  ((__m512d)__builtin_ia32_reducepd512_mask_round(                             \
...
#define _mm512_mask_reduce_round_pd(W, U, A, B, R)                             \
  ((__m512d)__builtin_ia32_reducepd512_mask_round(                             \
      (__v8df)(__m512d)(A), (int)(B), (__v8df)(__m512d)(W), (U), (R)))
...
#define _mm512_maskz_reduce_round_pd(U, A, B, R)                               \
  ((__m512d)__builtin_ia32_reducepd512_mask_round(                             \
      (__v8df)(__m512d)(A), (int)(B), (__v8df)_mm512_setzero_pd(), (U), (R)))
...
#define _mm512_reduce_round_ps(A, B, R)                                        \
  ((__m512)__builtin_ia32_reduceps512_mask_round(                              \
...
#define _mm512_mask_reduce_round_ps(W, U, A, B, R)                             \
  ((__m512)__builtin_ia32_reduceps512_mask_round(                              \
      (__v16sf)(__m512)(A), (int)(B), (__v16sf)(__m512)(W), (U), (R)))
...
#define _mm512_extractf32x8_ps(X, C)                                           \
  ((__m256)__builtin_ia32_extractf32x8_mask(                                   \
      (__v16sf)(__m512)(X), (int)(C), (__v8sf)(__m256)_mm256_setzero_ps(),     \
      (__mmask8) - 1))

#define _mm512_mask_extractf32x8_ps(W, U, X, C)                                \
  ((__m256)__builtin_ia32_extractf32x8_mask(                                   \
      (__v16sf)(__m512)(X), (int)(C), (__v8sf)(__m256)(W), (__mmask8)(U)))
...
#define _mm512_extractf64x2_pd(X, C)                                           \
  ((__m128d)__builtin_ia32_extractf64x2_512_mask(                              \
      (__v8df)(__m512d)(X), (int)(C), (__v2df)(__m128d)_mm_setzero_pd(),       \
      (__mmask8) - 1))

#define _mm512_mask_extractf64x2_pd(W, U, X, C)                                \
  ((__m128d)__builtin_ia32_extractf64x2_512_mask(                              \
      (__v8df)(__m512d)(X), (int)(C), (__v2df)(__m128d)(W), (__mmask8)(U)))
...
#define _mm512_extracti32x8_epi32(X, C)                                        \
  ((__m256i)__builtin_ia32_extracti32x8_mask(                                  \
      ...
      (__v8si)(__m256i)_mm256_setzero_si256(), (__mmask8) - 1))

#define _mm512_mask_extracti32x8_epi32(W, U, X, C)                             \
  ((__m256i)__builtin_ia32_extracti32x8_mask(                                  \
      (__v16si)(__m512i)(X), (int)(C), (__v8si)(__m256i)(W), (__mmask8)(U)))

#define _mm512_maskz_extracti32x8_epi32(U, X, C)                               \
  ((__m256i)__builtin_ia32_extracti32x8_mask(                                  \
      (__v16si)(__m512i)(X), (int)(C),                                         \
      (__v8si)(__m256i)_mm256_setzero_si256(), (__mmask8)(U)))

#define _mm512_extracti64x2_epi64(X, C)                                        \
  ((__m128i)__builtin_ia32_extracti64x2_512_mask(                              \
      (__v8di)(__m512i)(X), (int)(C), (__v2di)(__m128i)_mm_setzero_si128(),    \
      (__mmask8) - 1))

#define _mm512_mask_extracti64x2_epi64(W, U, X, C)                             \
  ((__m128i)__builtin_ia32_extracti64x2_512_mask(                              \
      (__v8di)(__m512i)(X), (int)(C), (__v2di)(__m128i)(W), (__mmask8)(U)))
...
#define _mm512_insertf64x2(X, Y, C)                                            \
  ((__m512d)__builtin_ia32_insertf64x2_512_mask(                               \
      (__v8df)(__m512d)(X), (__v2df)(__m128d)(Y), (int)(C),                    \
...
#define _mm512_inserti64x2(X, Y, C)                                            \
  ((__m512i)__builtin_ia32_inserti64x2_512_mask(                               \
      (__v8di)(__m512i)(X), (__v2di)(__m128i)(Y), (int)(C),                    \
      (__v8di)(__m512i)(X), (__mmask8) - 1))
...
#define _mm512_insertf32x8(X, Y, C)                                            \
  ((__m512)__builtin_ia32_insertf32x8_mask(                                    \
      (__v16sf)(__m512)(X), (__v8sf)(__m256)(Y), (int)(C),                     \
...
#define _mm512_inserti32x8(X, Y, C)                                            \
  ((__m512i)__builtin_ia32_inserti32x8_mask(                                   \
      (__v16si)(__m512i)(X), (__v8si)(__m256i)(Y), (int)(C),                   \
      (__v16si)(__m512i)_mm512_setzero_si512(), (__mmask16) - 1))
...
#define _mm512_mask_fpclass_pd_mask(u, X, C)                                   \
  ((__mmask8)__builtin_ia32_fpclasspd512_mask((__v8df)(__m512d)(X), (int)(C),  \
                                              (__mmask8)(u)))

#define _mm512_mask_fpclass_ps_mask(u, x, c)                                   \
  ((__mmask16)__builtin_ia32_fpclassps512_mask((__v16sf)(__m512)(x), (int)(c), \
                                               (__mmask16)(u)))
