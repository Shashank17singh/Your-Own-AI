...
extern __inline __m128i
  ...
  return (__m128i)__builtin_ia32_compressqi128_mask(
      (__v16qi)__B, (__v16qi)_mm_avx512_setzero_si128(), (__mmask16)__A);
}
...
extern __inline __m128i
  ...
  return (__m128i)__builtin_ia32_compresshi128_mask(
      (__v8hi)__B, (__v8hi)_mm_avx512_setzero_si128(), (__mmask8)__A);
}
...
extern __inline __m256i
  ...
  return (__m256i)__builtin_ia32_compresshi256_mask(
      (__v16hi)__B, (__v16hi)_mm256_avx512_setzero_si256(), (__mmask16)__A);
}
...
extern __inline __m128i
  ...
  return (__m128i)__builtin_ia32_expandloadqi128_maskz(
      (const __v16qi *)__B, (__v16qi)_mm_avx512_setzero_si128(),
      (__mmask16)__A);
}
...
extern __inline __m128i
  ...
  return (__m128i)__builtin_ia32_expandloadhi128_maskz(
      (const __v8hi *)__B, (__v8hi)_mm_avx512_setzero_si128(), (__mmask8)__A);
}
extern __inline __m256i
    __attribute__((__gnu_inline__, __always_inline__, __artificial__))
...
extern __inline __m256i
  ...
  return (__m256i)__builtin_ia32_expandloadhi256_maskz(
      (const __v16hi *)__B, (__v16hi)_mm256_avx512_setzero_si256(),
      (__mmask16)__A);
}
...
extern __inline __m256i
  ...
  return (__m256i)__builtin_ia32_vpshrd_v16hi_mask(
      (__v16hi)__B, (__v16hi)__C, __D, (__v16hi)_mm256_avx512_setzero_si256(),
      (__mmask16)__A);
}
...
extern __inline __m256i
  ...
  return (__m256i)__builtin_ia32_vpshrd_v8si_mask(
      (__v8si)__B, (__v8si)__C, __D, (__v8si)_mm256_avx512_setzero_si256(),
      (__mmask8)__A);
}
...
extern __inline __m256i
  ...
  return (__m256i)__builtin_ia32_vpshrd_v4di_mask(
      (__v4di)__B, (__v4di)__C, __D, (__v4di)_mm256_avx512_setzero_si256(),
      (__mmask8)__A);
}
...
extern __inline __m128i
  ...
  return (__m128i)__builtin_ia32_vpshrd_v8hi_mask(
      (__v8hi)__B, (__v8hi)__C, __D, (__v8hi)_mm_avx512_setzero_si128(),
      (__mmask8)__A);
}
...
extern __inline __m128i
  ...
  return (__m128i)__builtin_ia32_vpshrd_v4si_mask(
      (__v4si)__B, (__v4si)__C, __D, (__v4si)_mm_avx512_setzero_si128(),
      (__mmask8)__A);
}
...
extern __inline __m128i
  ...
  return (__m128i)__builtin_ia32_vpshrd_v2di_mask(
      (__v2di)__B, (__v2di)__C, __D, (__v2di)_mm_avx512_setzero_si128(),
      (__mmask8)__A);
}
...
extern __inline __m128i
  ...
  return (__m128i)__builtin_ia32_vpshld_v8hi_mask(
      (__v8hi)__B, (__v8hi)__C, __D, (__v8hi)_mm_avx512_setzero_si128(),
      (__mmask8)__A);
}
...
extern __inline __m128i
  ...
  return (__m128i)__builtin_ia32_vpshld_v4si_mask(
      (__v4si)__B, (__v4si)__C, __D, (__v4si)_mm_avx512_setzero_si128(),
      (__mmask8)__A);
}
...
extern __inline __m128i
  ...
  return (__m128i)__builtin_ia32_vpshld_v2di_mask(
      (__v2di)__B, (__v2di)__C, __D, (__v2di)_mm_avx512_setzero_si128(),
      (__mmask8)__A);
}
...
#define _mm256_mask_shrdi_epi16(A, B, C, D, E)                                 \
  ((__m256i)__builtin_ia32_vpshrd_v16hi_mask(                                  \
      (__v16hi)(__m256i)(C), (__v16hi)(__m256i)(D), (int)(E),                  \
      (__v16hi)(__m256i)(A), (__mmask16)(B)))
#define _mm256_maskz_shrdi_epi16(A, B, C, D)                                   \
  ((__m256i)__builtin_ia32_vpshrd_v16hi_mask(                                  \
      (__v16hi)(__m256i)(B), (__v16hi)(__m256i)(C), (int)(D),                  \
      (__v16hi)(__m256i)_mm256_avx512_setzero_si256(), (__mmask16)(A)))
...
#define _mm256_mask_shrdi_epi32(A, B, C, D, E)                                 \
  ((__m256i)__builtin_ia32_vpshrd_v8si_mask(                                   \
      (__v8si)(__m256i)(C), (__v8si)(__m256i)(D), (int)(E),                    \
      (__v8si)(__m256i)(A), (__mmask8)(B)))
#define _mm256_maskz_shrdi_epi32(A, B, C, D)                                   \
  ((__m256i)__builtin_ia32_vpshrd_v8si_mask(                                   \
      (__v8si)(__m256i)(B), (__v8si)(__m256i)(C), (int)(D),                    \
      (__v8si)(__m256i)_mm256_avx512_setzero_si256(), (__mmask8)(A)))
...
#define _mm256_mask_shrdi_epi64(A, B, C, D, E)                                 \
  ((__m256i)__builtin_ia32_vpshrd_v4di_mask(                                   \
      (__v4di)(__m256i)(C), (__v4di)(__m256i)(D), (int)(E),                    \
      (__v4di)(__m256i)(A), (__mmask8)(B)))
#define _mm256_maskz_shrdi_epi64(A, B, C, D)                                   \
  ((__m256i)__builtin_ia32_vpshrd_v4di_mask(                                   \
      (__v4di)(__m256i)(B), (__v4di)(__m256i)(C), (int)(D),                    \
      (__v4di)(__m256i)_mm256_avx512_setzero_si256(), (__mmask8)(A)))
...
#define _mm_mask_shrdi_epi16(A, B, C, D, E)                                    \
  ((__m128i)__builtin_ia32_vpshrd_v8hi_mask(                                   \
      (__v8hi)(__m128i)(C), (__v8hi)(__m128i)(D), (int)(E),                    \
      (__v8hi)(__m128i)(A), (__mmask8)(B)))
#define _mm_maskz_shrdi_epi16(A, B, C, D)                                      \
  ((__m128i)__builtin_ia32_vpshrd_v8hi_mask(                                   \
      (__v8hi)(__m128i)(B), (__v8hi)(__m128i)(C), (int)(D),                    \
      (__v8hi)(__m128i)_mm_avx512_setzero_si128(), (__mmask8)(A)))
...
#define _mm_mask_shrdi_epi32(A, B, C, D, E)                                    \
  ((__m128i)__builtin_ia32_vpshrd_v4si_mask(                                   \
      (__v4si)(__m128i)(C), (__v4si)(__m128i)(D), (int)(E),                    \
      (__v4si)(__m128i)(A), (__mmask8)(B)))
#define _mm_maskz_shrdi_epi32(A, B, C, D)                                      \
  ((__m128i)__builtin_ia32_vpshrd_v4si_mask(                                   \
      (__v4si)(__m128i)(B), (__v4si)(__m128i)(C), (int)(D),                    \
      (__v4si)(__m128i)_mm_avx512_setzero_si128(), (__mmask8)(A)))
...
#define _mm_mask_shrdi_epi64(A, B, C, D, E)                                    \
  ((__m128i)__builtin_ia32_vpshrd_v2di_mask(                                   \
      (__v2di)(__m128i)(C), (__v2di)(__m128i)(D), (int)(E),                    \
      (__v2di)(__m128i)(A), (__mmask8)(B)))
#define _mm_maskz_shrdi_epi64(A, B, C, D)                                      \
  ((__m128i)__builtin_ia32_vpshrd_v2di_mask(                                   \
      (__v2di)(__m128i)(B), (__v2di)(__m128i)(C), (int)(D),                    \
      (__v2di)(__m128i)_mm_avx512_setzero_si128(), (__mmask8)(A)))
...
#define _mm256_mask_shldi_epi16(A, B, C, D, E)                                 \
  ((__m256i)__builtin_ia32_vpshld_v16hi_mask(                                  \
      (__v16hi)(__m256i)(C), (__v16hi)(__m256i)(D), (int)(E),                  \
      (__v16hi)(__m256i)(A), (__mmask16)(B)))
...
#define _mm256_mask_shldi_epi32(A, B, C, D, E)                                 \
  ((__m256i)__builtin_ia32_vpshld_v8si_mask(                                   \
      (__v8si)(__m256i)(C), (__v8si)(__m256i)(D), (int)(E),                    \
      (__v8si)(__m256i)(A), (__mmask8)(B)))
...
#define _mm256_mask_shldi_epi64(A, B, C, D, E)                                 \
  ((__m256i)__builtin_ia32_vpshld_v4di_mask(                                   \
      (__v4di)(__m256i)(C), (__v4di)(__m256i)(D), (int)(E),                    \
      (__v4di)(__m256i)(A), (__mmask8)(B)))
...
#define _mm_mask_shldi_epi16(A, B, C, D, E)                                    \
  ((__m128i)__builtin_ia32_vpshld_v8hi_mask(                                   \
      (__v8hi)(__m128i)(C), (__v8hi)(__m128i)(D), (int)(E),                    \
      (__v8hi)(__m128i)(A), (__mmask8)(B)))
...
#define _mm_mask_shldi_epi32(A, B, C, D, E)                                    \
  ((__m128i)__builtin_ia32_vpshld_v4si_mask(                                   \
      (__v4si)(__m128i)(C), (__v4si)(__m128i)(D), (int)(E),                    \
      (__v4si)(__m128i)(A), (__mmask8)(B)))
...
#define _mm_mask_shldi_epi64(A, B, C, D, E)                                    \
  ((__m128i)__builtin_ia32_vpshld_v2di_mask(                                   \
      (__v2di)(__m128i)(C), (__v2di)(__m128i)(D), (int)(E),                    \
      (__v2di)(__m128i)(A), (__mmask8)(B)))
...
extern __inline __m256i
  ...
  return (__m256i)__builtin_ia32_compressqi256_mask(
      (__v32qi)__B, (__v32qi)_mm256_avx512_setzero_si256(), (__mmask32)__A);
}
...
extern __inline __m256i
  ...
  return (__m256i)__builtin_ia32_expandloadqi256_maskz(
      (const __v32qi *)__B, (__v32qi)_mm256_avx512_setzero_si256(),
      (__mmask32)__A);
}
