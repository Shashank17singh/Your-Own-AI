...
#error                                                                         \
    "Never use <avx512fp16vlintrin.h> directly; include <immintrin.h> instead."
#endif
...
extern __inline __m256h
  ...
  return (__m256h)_mm256_xor_epi32((__m256i)__A,
                                   _mm256_avx512_set1_epi32(1U << 31));
}
...
extern __inline __m256h
  ...
  return (__m256h)__builtin_ia32_movaps256_mask(
      (__v8sf)_mm256_conj_pch(__A), (__v8sf)_mm256_avx512_setzero_ps(),
      (__mmask8)__U);
}
...
extern __inline __mmask8
  ...
  return (__mmask8)__builtin_ia32_cmpph128_mask(__A, __B, __C, (__mmask8)-1);
}

extern __inline __mmask8 __attribute__((__gnu_inline__, __always_inline__,
                                        __artificial__))
_mm_mask_cmp_ph_mask(__mmask8 __A, __m128h __B, __m128h __C, const int __D) {
...
extern __inline __mmask16
  ...
  return (__mmask16)__builtin_ia32_cmpph256_mask(__A, __B, __C, (__mmask16)-1);
}

extern __inline __mmask16 __attribute__((__gnu_inline__, __always_inline__,
                                         __artificial__))
_mm_mask_cmp_ph_mask(__mmask16 __A, __m256h __B, __m256h __C, const int __D) {
  return (__mmask16)__builtin_ia32_cmpph256_mask(__B, __C, __D, __A);
}
...
extern __inline __m128h
    __attribute__((__gnu_inline__, __always_inline__,
                   __artificial__)) _mm_reduce_ph(__m128h __A, int __B) {
  return __builtin_ia32_reduceph128_mask(__A, __B, _mm_setzero_ph(),
                                         (__mmask8)-1);
}
...
extern __inline __m128h
  ...
  return __builtin_ia32_reduceph128_mask(__B, __C, _mm_setzero_ph(), __A);
}

extern __inline __m256h
    __attribute__((__gnu_inline__, __always_inline__, __artificial__))
    _mm256_reduce_ph(__m256h __A, int __B) {
  return __builtin_ia32_reduceph256_mask(__A, __B, _mm256_setzero_ph(),
                                         (__mmask16)-1);
}
...
extern __inline __m256h
  ...
  return __builtin_ia32_reduceph256_mask(__B, __C, _mm256_setzero_ph(), __A);
}

#else
#define _mm_reduce_ph(A, B)                                                    \
  (__builtin_ia32_reduceph128_mask((A), (B), _mm_setzero_ph(),                 \
                                   ((__mmask8) - 1)))
...
#define _mm256_reduce_ph(A, B)                                                 \
  (__builtin_ia32_reduceph256_mask((A), (B), _mm256_setzero_ph(),              \
                                   ((__mmask16) - 1)))
...
extern __inline __m128h
    __attribute__((__gnu_inline__, __always_inline__,
                   __artificial__)) _mm_roundscale_ph(__m128h __A, int __B) {
  return __builtin_ia32_rndscaleph128_mask(__A, __B, _mm_setzero_ph(),
                                           (__mmask8)-1);
}
...
extern __inline __m128h
  ...
  return __builtin_ia32_rndscaleph128_mask(__B, __C, _mm_setzero_ph(), __A);
}

extern __inline __m256h
    __attribute__((__gnu_inline__, __always_inline__, __artificial__))
    _mm256_roundscale_ph(__m256h __A, int __B) {
  return __builtin_ia32_rndscaleph256_mask(__A, __B, _mm256_setzero_ph(),
                                           (__mmask16)-1);
}

extern __inline __m256h __attribute__((__gnu_inline__, __always_inline__,
                                       __artificial__))
_mm256_mask_roundscale_ph(__m256h __A, __mmask16 __B, __m256h __C, int __D) {
...
extern __inline __m256h
  ...
  return __builtin_ia32_rndscaleph256_mask(__B, __C, _mm256_setzero_ph(), __A);
}
...
#define _mm256_roundscale_ph(A, B)                                             \
  (__builtin_ia32_rndscaleph256_mask((A), (B), _mm256_setzero_ph(),            \
                                     ((__mmask16) - 1)))
...
#define _mm256_maskz_roundscale_ph(A, B, C)                                    \
  (__builtin_ia32_rndscaleph256_mask((B), (C), _mm256_setzero_ph(), (A)))
...
extern __inline __mmask8
  ...
  return (__mmask8)__builtin_ia32_fpclassph128_mask((__v8hf)__A, __imm, __U);
}

extern __inline __mmask8
    __attribute__((__gnu_inline__, __always_inline__, __artificial__))
    _mm_fpclass_ph_mask(__m128h __A, const int __imm) {
  return (__mmask8)__builtin_ia32_fpclassph128_mask((__v8hf)__A, __imm,
                                                    (__mmask8)-1);
}
...
extern __inline __mmask16
  ...
  return (__mmask16)__builtin_ia32_fpclassph256_mask((__v16hf)__A, __imm, __U);
}

extern __inline __mmask16
    __attribute__((__gnu_inline__, __always_inline__, __artificial__))
    _mm256_fpclass_ph_mask(__m256h __A, const int __imm) {
  return (__mmask16)__builtin_ia32_fpclassph256_mask((__v16hf)__A, __imm,
                                                     (__mmask16)-1);
}

#else
#define _mm_fpclass_ph_mask(X, C)                                              \
  ((__mmask8)__builtin_ia32_fpclassph128_mask((__v8hf)(__m128h)(X), (int)(C),  \
                                              (__mmask8) - 1))
...
extern __inline __m256h
  ...
  return (__m256h)__builtin_ia32_getmantph256_mask(
      (__v16hf)__A, (__C << 2) | __B, (__v16hf)_mm256_setzero_ph(),
      (__mmask16)-1);
}
...
extern __inline __m256h
    ...
    _mm256_mask_getmant_ph(__m256h __W, __mmask16 __U, __m256h __A,
                           ...
                           _MM_MANTISSA_SIGN_ENUM __C) {
  return (__m256h)__builtin_ia32_getmantph256_mask(
      (__v16hf)__A, (__C << 2) | __B, (__v16hf)__W, (__mmask16)__U);
}
...
extern __inline __m128h
    ...
    _mm_getmant_ph(__m128h __A, _MM_MANTISSA_NORM_ENUM __B,
                   _MM_MANTISSA_SIGN_ENUM __C) {
  return (__m128h)__builtin_ia32_getmantph128_mask(
      (__v8hf)__A, (__C << 2) | __B, (__v8hf)_mm_setzero_ph(), (__mmask8)-1);
}
...
extern __inline __m128h
    ...
    _mm_mask_getmant_ph(__m128h __W, __mmask8 __U, __m128h __A,
                        ...
                        _MM_MANTISSA_SIGN_ENUM __C) {
  return (__m128h)__builtin_ia32_getmantph128_mask(
      (__v8hf)__A, (__C << 2) | __B, (__v8hf)__W, (__mmask8)__U);
}

extern __inline __m128h
    __attribute__((__gnu_inline__, __always_inline__, __artificial__))
    _mm_maskz_getmant_ph(__mmask8 __U, __m128h __A, _MM_MANTISSA_NORM_ENUM __B,
                         _MM_MANTISSA_SIGN_ENUM __C) {
  return (__m128h)__builtin_ia32_getmantph128_mask(
      (__v8hf)__A, (__C << 2) | __B, (__v8hf)_mm_setzero_ph(), (__mmask8)__U);
}

#else
#define _mm256_getmant_ph(X, B, C)                                             \
  ((__m256h)__builtin_ia32_getmantph256_mask(                                  \
      (__v16hf)(__m256h)(X), (int)(((C) << 2) | (B)),                          \
      (__v16hf)(__m256h)_mm256_setzero_ph(), (__mmask16) - 1))

#define _mm256_mask_getmant_ph(W, U, X, B, C)                                  \
  ((__m256h)__builtin_ia32_getmantph256_mask(                                  \
      (__v16hf)(__m256h)(X), (int)(((C) << 2) | (B)), (__v16hf)(__m256h)(W),   \
      (__mmask16)(U)))
...
extern __inline __m128i
  ...
  return (__m128i)__builtin_ia32_vcvtph2dq128_mask(
      __A, (__v4si)_mm_avx512_setzero_si128(), (__mmask8)-1);
}
...
extern __inline __m128i
  ...
  return (__m128i)__builtin_ia32_vcvtph2dq128_mask(
      __B, (__v4si)_mm_avx512_setzero_si128(), __A);
}
...
extern __inline __m256i
  ...
  return (__m256i)__builtin_ia32_vcvtph2dq256_mask(
      __A, (__v8si)_mm256_avx512_setzero_si256(), (__mmask8)-1);
}
...
extern __inline __m256i
  ...
  return (__m256i)__builtin_ia32_vcvtph2dq256_mask(
      __B, (__v8si)_mm256_avx512_setzero_si256(), __A);
}
...
extern __inline __m128i
  ...
  return __builtin_ia32_vcvtph2qq128_mask(__A, _mm_avx512_setzero_si128(),
                                          (__mmask8)-1);
}
...
extern __inline __m128i
  ...
  return __builtin_ia32_vcvtph2qq128_mask(__B, _mm_avx512_setzero_si128(), __A);
}

extern __inline __m256i
    __attribute__((__gnu_inline__, __always_inline__, __artificial__))
    _mm256_cvtph_epi64(__m128h __A) {
  return __builtin_ia32_vcvtph2qq256_mask(__A, _mm256_avx512_setzero_si256(),
                                          (__mmask8)-1);
}
...
extern __inline __m256i
  ...
  return __builtin_ia32_vcvtph2qq256_mask(__B, _mm256_avx512_setzero_si256(),
                                          __A);
}
...
extern __inline __m128i
  ...
  return __builtin_ia32_vcvtph2uqq128_mask(__A, _mm_avx512_setzero_si128(),
                                           (__mmask8)-1);
}
...
extern __inline __m128i
  ...
  return __builtin_ia32_vcvtph2uqq128_mask(__B, _mm_avx512_setzero_si128(),
                                           __A);
}
...
extern __inline __m256i
  ...
  return __builtin_ia32_vcvtph2uqq256_mask(__A, _mm256_avx512_setzero_si256(),
                                           (__mmask8)-1);
}
...
extern __inline __m256i
  ...
  return __builtin_ia32_vcvtph2uqq256_mask(__B, _mm256_avx512_setzero_si256(),
                                           __A);
}
...
extern __inline __m128i
  ...
  return __builtin_ia32_vcvttph2qq128_mask(__A, _mm_avx512_setzero_si128(),
                                           (__mmask8)-1);
}
...
extern __inline __m128i
  ...
  return __builtin_ia32_vcvttph2qq128_mask(__B, _mm_avx512_setzero_si128(),
                                           __A);
}
...
extern __inline __m256i
  ...
  return __builtin_ia32_vcvttph2qq256_mask(__A, _mm256_avx512_setzero_si256(),
                                           (__mmask8)-1);
}
...
extern __inline __m256i
  ...
  return __builtin_ia32_vcvttph2qq256_mask(__B, _mm256_avx512_setzero_si256(),
                                           __A);
}
...
extern __inline __m128i
  ...
  return __builtin_ia32_vcvttph2uqq128_mask(__A, _mm_avx512_setzero_si128(),
                                            (__mmask8)-1);
}
...
extern __inline __m128i
  ...
  return __builtin_ia32_vcvttph2uqq128_mask(__B, _mm_avx512_setzero_si128(),
                                            __A);
}
...
extern __inline __m256i
  ...
  return __builtin_ia32_vcvttph2uqq256_mask(__A, _mm256_avx512_setzero_si256(),
                                            (__mmask8)-1);
}
...
extern __inline __m256i
  ...
  return __builtin_ia32_vcvttph2uqq256_mask(__B, _mm256_avx512_setzero_si256(),
                                            __A);
}
...
extern __inline __m128i
  ...
  return (__m128i)__builtin_ia32_vcvtph2w128_mask(
      __A, (__v8hi)_mm_avx512_setzero_si128(), (__mmask8)-1);
}
...
extern __inline __m128i
  ...
  return (__m128i)__builtin_ia32_vcvtph2w128_mask(
      __B, (__v8hi)_mm_avx512_setzero_si128(), __A);
}
...
extern __inline __m256i
  ...
  return (__m256i)__builtin_ia32_vcvtph2w256_mask(
      __A, (__v16hi)_mm256_avx512_setzero_si256(), (__mmask16)-1);
}
...
extern __inline __m256i
  ...
  return (__m256i)__builtin_ia32_vcvtph2w256_mask(
      __B, (__v16hi)_mm256_avx512_setzero_si256(), __A);
}
...
extern __inline __m128d
  ...
  return __builtin_ia32_vcvtph2pd128_mask(__A, _mm_avx512_setzero_pd(),
                                          (__mmask8)-1);
}
...
extern __inline __m256d
  ...
  return __builtin_ia32_vcvtph2pd256_mask(__A, _mm256_avx512_setzero_pd(),
                                          (__mmask8)-1);
}
...
extern __inline __m256d
  ...
  return __builtin_ia32_vcvtph2pd256_mask(__B, _mm256_avx512_setzero_pd(), __A);
}
...
extern __inline __m128
  ...
  return __builtin_ia32_vcvtph2psx128_mask(__A, _mm_avx512_setzero_ps(),
                                           (__mmask8)-1);
}
...
extern __inline __m256
  ...
  return __builtin_ia32_vcvtph2psx256_mask(__A, _mm256_avx512_setzero_ps(),
                                           (__mmask8)-1);
}
...
extern __inline __m256
  ...
  return __builtin_ia32_vcvtph2psx256_mask(__B, _mm256_avx512_setzero_ps(),
                                           __A);
}
...
extern __inline _Float16
    __attribute__((__gnu_inline__, __always_inline__,
                   __artificial__)) _mm256_reduce_add_ph(__m256h __A) {
  _MM256_REDUCE_OP(+);
}
...
extern __inline _Float16
    __attribute__((__gnu_inline__, __always_inline__,
                   __artificial__)) _mm256_reduce_min_ph(__m256h __A) {
...
extern __inline _Float16
    __attribute__((__gnu_inline__, __always_inline__,
                   __artificial__)) _mm_reduce_add_ph(__m128h __A) {
  _MM_REDUCE_OP(+);
}
...
extern __inline _Float16
    __attribute__((__gnu_inline__, __always_inline__,
                   __artificial__)) _mm_reduce_min_ph(__m128h __A) {
