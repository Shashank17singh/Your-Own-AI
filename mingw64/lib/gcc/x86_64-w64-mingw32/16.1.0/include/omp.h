...
typedef struct {
  unsigned char _x[8] __attribute__((__aligned__(8)));
} omp_lock_t;

typedef struct {
  unsigned char _x[24] __attribute__((__aligned__(8)));
} omp_nest_lock_t;
#endif
...
typedef enum omp_proc_bind_t {
  ...
  omp_proc_bind_master __GOMP_DEPRECATED_5_1 = omp_proc_bind_primary,
...
extern void omp_init_lock_with_hint(omp_lock_t *,
                                    omp_sync_hint_t) __GOMP_NOTHROW;
...
extern void omp_init_nest_lock_with_hint(omp_nest_lock_t *,
                                         omp_sync_hint_t) __GOMP_NOTHROW;
...
extern int omp_target_memcpy(void *, const void *, __SIZE_TYPE__, __SIZE_TYPE__,
                             __SIZE_TYPE__, int, int) __GOMP_NOTHROW;
extern int
omp_target_memcpy_async(void *, const void *, __SIZE_TYPE__, __SIZE_TYPE__,
                        __SIZE_TYPE__, int, int, int,
                        omp_depend_t *__GOMP_DEFAULT_NULL) __GOMP_NOTHROW;
extern int omp_target_memcpy_rect(void *, const void *, __SIZE_TYPE__, int,
                                  const __SIZE_TYPE__ *, const __SIZE_TYPE__ *,
                                  const __SIZE_TYPE__ *, const __SIZE_TYPE__ *,
                                  const __SIZE_TYPE__ *, int,
                                  int) __GOMP_NOTHROW;
extern int
omp_target_memcpy_rect_async(void *, const void *, __SIZE_TYPE__, int,
                             const __SIZE_TYPE__ *, const __SIZE_TYPE__ *,
                             const __SIZE_TYPE__ *, const __SIZE_TYPE__ *,
...
extern void *
omp_target_memset_async(void *, int, __SIZE_TYPE__, int, int,
                        omp_depend_t *__GOMP_DEFAULT_NULL) __GOMP_NOTHROW;
...
extern int omp_target_is_accessible(const void *, __SIZE_TYPE__,
                                    int) __GOMP_NOTHROW;

extern void omp_set_affinity_format(const char *) __GOMP_NOTHROW;
extern __SIZE_TYPE__ omp_get_affinity_format(char *,
                                             __SIZE_TYPE__) __GOMP_NOTHROW;
extern void omp_display_affinity(const char *) __GOMP_NOTHROW;
extern __SIZE_TYPE__ omp_capture_affinity(char *, __SIZE_TYPE__,
                                          const char *) __GOMP_NOTHROW;
...
omp_init_allocator(omp_memspace_handle_t, int,
                   const omp_alloctrait_t[]) __GOMP_NOTHROW;
...
extern void
omp_free(void *,
         omp_allocator_handle_t __GOMP_DEFAULT_NULL_ALLOCATOR) __GOMP_NOTHROW;
extern void *
omp_alloc(__SIZE_TYPE__,
          omp_allocator_handle_t __GOMP_DEFAULT_NULL_ALLOCATOR) __GOMP_NOTHROW
...
extern omp_intptr_t
omp_get_interop_int(const omp_interop_t, omp_interop_property_t,
                    omp_interop_rc_t *__GOMP_DEFAULT_NULL) __GOMP_NOTHROW;

extern void *
omp_get_interop_ptr(const omp_interop_t, omp_interop_property_t,
                    omp_interop_rc_t *__GOMP_DEFAULT_NULL) __GOMP_NOTHROW;

extern const char *
omp_get_interop_str(const omp_interop_t, omp_interop_property_t,
                    omp_interop_rc_t *__GOMP_DEFAULT_NULL) __GOMP_NOTHROW;
...
extern const char *
omp_get_interop_type_desc(const omp_interop_t,
                          omp_interop_property_t) __GOMP_NOTHROW;
...
struct __allocator_templ {
  ...
  void deallocate(__T *__p, size_type) __GOMP_NOTHROW {
...
template <typename __T, omp_allocator_handle_t __Handle, typename __U,
          omp_allocator_handle_t __UHandle>
constexpr bool
operator==(const __allocator_templ<__T, __Handle> &,
...
struct null_allocator : __detail::__allocator_templ<__T, omp_null_allocator> {};

template <typename __T>
struct default_mem : __detail::__allocator_templ<__T, omp_default_mem_alloc> {};
...
template <typename __T>
struct const_mem : __detail::__allocator_templ<__T, omp_const_mem_alloc> {};

template <typename __T>
struct high_bw_mem : __detail::__allocator_templ<__T, omp_high_bw_mem_alloc> {};

template <typename __T>
struct low_lat_mem : __detail::__allocator_templ<__T, omp_low_lat_mem_alloc> {};

template <typename __T>
struct cgroup_mem : __detail::__allocator_templ<__T, omp_cgroup_mem_alloc> {};

template <typename __T>
struct pteam_mem : __detail::__allocator_templ<__T, omp_pteam_mem_alloc> {};

template <typename __T>
struct thread_mem : __detail::__allocator_templ<__T, omp_thread_mem_alloc> {};
