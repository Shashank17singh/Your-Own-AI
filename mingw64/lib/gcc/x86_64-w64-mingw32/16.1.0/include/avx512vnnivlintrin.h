...
#define _mm256_dpbusd_epi32(A, B, C)                                           \
  ((__m256i)__builtin_ia32_vpdpbusd_v8si((__v8si)(A), (__v8si)(B), (__v8si)(C)))
...
#define _mm_dpbusd_epi32(A, B, C)                                              \
  ((__m128i)__builtin_ia32_vpdpbusd_v4si((__v4si)(A), (__v4si)(B), (__v4si)(C)))
...
#define _mm256_dpbusds_epi32(A, B, C)                                          \
  ((__m256i)__builtin_ia32_vpdpbusds_v8si((__v8si)(A), (__v8si)(B),            \
                                          (__v8si)(C)))
...
#define _mm_dpbusds_epi32(A, B, C)                                             \
  ((__m128i)__builtin_ia32_vpdpbusds_v4si((__v4si)(A), (__v4si)(B),            \
                                          (__v4si)(C)))
...
#define _mm256_dpwssd_epi32(A, B, C)                                           \
  ((__m256i)__builtin_ia32_vpdpwssd_v8si((__v8si)(A), (__v8si)(B), (__v8si)(C)))
...
#define _mm_dpwssd_epi32(A, B, C)                                              \
  ((__m128i)__builtin_ia32_vpdpwssd_v4si((__v4si)(A), (__v4si)(B), (__v4si)(C)))
...
#define _mm256_dpwssds_epi32(A, B, C)                                          \
  ((__m256i)__builtin_ia32_vpdpwssds_v8si((__v8si)(A), (__v8si)(B),            \
                                          (__v8si)(C)))
...
#define _mm_dpwssds_epi32(A, B, C)                                             \
  ((__m128i)__builtin_ia32_vpdpwssds_v4si((__v4si)(A), (__v4si)(B),            \
                                          (__v4si)(C)))
