...
extern __inline __m512i
  ...
  return (__m512i)__builtin_ia32_vpermt2varhi512_mask(
      (__v32hi)__I
      /* idx */,
      (__v32hi)__A, (__v32hi)__B, (__mmask32)-1);
}
...
#define _mm512_mask_alignr_epi8(W, U, X, Y, N)                                 \
  ((__m512i)__builtin_ia32_palignr512_mask(                                    \
      (__v8di)(__m512i)(X), (__v8di)(__m512i)(Y), (int)((N) * 8),              \
      (__v8di)(__m512i)(W), (__mmask64)(U)))

#define _mm512_maskz_alignr_epi8(U, X, Y, N)                                   \
  ((__m512i)__builtin_ia32_palignr512_mask(                                    \
      (__v8di)(__m512i)(X), (__v8di)(__m512i)(Y), (int)((N) * 8),              \
      (__v8di)(__m512i)_mm512_setzero_si512(), (__mmask64)(U)))

#define _mm512_dbsad_epu8(X, Y, C)                                             \
  ((__m512i)__builtin_ia32_dbpsadbw512_mask(                                   \
      (__v64qi)(__m512i)(X), (__v64qi)(__m512i)(Y), (int)(C),                  \
      (__v32hi)(__m512i)_mm512_setzero_si512(), (__mmask32) - 1))
...
#define _mm512_maskz_dbsad_epu8(U, X, Y, C)                                    \
  ((__m512i)__builtin_ia32_dbpsadbw512_mask(                                   \
      (__v64qi)(__m512i)(X), (__v64qi)(__m512i)(Y), (int)(C),                  \
      (__v32hi)(__m512i)_mm512_setzero_si512(), (__mmask32)(U)))

#define _mm512_srli_epi16(A, B)                                                \
  ((__m512i)__builtin_ia32_psrlwi512_mask(                                     \
      (__v32hi)(__m512i)(A), (unsigned int)(B),                                \
      (__v32hi)_mm512_setzero_si512(), (__mmask32) - 1))

#define _mm512_mask_srli_epi16(W, U, A, B)                                     \
  ((__m512i)__builtin_ia32_psrlwi512_mask(                                     \
      (__v32hi)(__m512i)(A), (unsigned int)(B), (__v32hi)(__m512i)(W),         \
      (__mmask32)(U)))

#define _mm512_maskz_srli_epi16(U, A, B)                                       \
  ((__m512i)__builtin_ia32_psrlwi512_mask((__v32hi)(__m512i)(A), (int)(B),     \
                                          (__v32hi)_mm512_setzero_si512(),     \
                                          (__mmask32)(U)))

#define _mm512_slli_epi16(X, C)                                                \
  ((__m512i)__builtin_ia32_psllwi512_mask(                                     \
      (__v32hi)(__m512i)(X), (unsigned int)(C),                                \
      (__v32hi)(__m512i)_mm512_setzero_si512(), (__mmask32) - 1))

#define _mm512_mask_slli_epi16(W, U, X, C)                                     \
  ((__m512i)__builtin_ia32_psllwi512_mask(                                     \
      (__v32hi)(__m512i)(X), (unsigned int)(C), (__v32hi)(__m512i)(W),         \
      (__mmask32)(U)))
...
#define _mm512_shufflehi_epi16(A, B)                                           \
  ((__m512i)__builtin_ia32_pshufhw512_mask(                                    \
      (__v32hi)(__m512i)(A), (int)(B),                                         \
      (__v32hi)(__m512i)_mm512_setzero_si512(), (__mmask32) - 1))

#define _mm512_mask_shufflehi_epi16(W, U, A, B)                                \
  ((__m512i)__builtin_ia32_pshufhw512_mask(                                    \
      (__v32hi)(__m512i)(A), (int)(B), (__v32hi)(__m512i)(W), (__mmask32)(U)))
...
#define _mm512_shufflelo_epi16(A, B)                                           \
  ((__m512i)__builtin_ia32_pshuflw512_mask(                                    \
      (__v32hi)(__m512i)(A), (int)(B),                                         \
      (__v32hi)(__m512i)_mm512_setzero_si512(), (__mmask32) - 1))
...
#define _mm512_srai_epi16(A, B)                                                \
  ((__m512i)__builtin_ia32_psrawi512_mask(                                     \
      (__v32hi)(__m512i)(A), (unsigned int)(B),                                \
      (__v32hi)_mm512_setzero_si512(), (__mmask32) - 1))
...
#define _mm512_maskz_srai_epi16(U, A, B)                                       \
  ((__m512i)__builtin_ia32_psrawi512_mask(                                     \
      (__v32hi)(__m512i)(A), (unsigned int)(B),                                \
      (__v32hi)_mm512_setzero_si512(), (__mmask32)(U)))

#define _mm512_mask_blend_epi16(__U, __A, __W)                                 \
  ((__m512i)__builtin_ia32_blendmw_512_mask((__v32hi)(__A), (__v32hi)(__W),    \
                                            (__mmask32)(__U)))

#define _mm512_mask_blend_epi8(__U, __A, __W)                                  \
  ((__m512i)__builtin_ia32_blendmb_512_mask((__v64qi)(__A), (__v64qi)(__W),    \
                                            (__mmask64)(__U)))
...
#define _mm512_mask_cmp_epi16_mask(M, X, Y, P)                                 \
  ((__mmask32)__builtin_ia32_cmpw512_mask(                                     \
      (__v32hi)(__m512i)(X), (__v32hi)(__m512i)(Y), (int)(P), (__mmask32)(M)))

#define _mm512_mask_cmp_epi8_mask(M, X, Y, P)                                  \
  ((__mmask64)__builtin_ia32_cmpb512_mask(                                     \
      (__v64qi)(__m512i)(X), (__v64qi)(__m512i)(Y), (int)(P), (__mmask64)(M)))
