...
#error                                                                         \
    "Never use <avx512bf16vlintrin.h> directly; include <immintrin.h> instead."
#endif
...
extern __inline __bf16
  ...
  __v8bf __R = __builtin_ia32_cvtneps2bf16_v4sf_mask(
      (__v4sf)__V, (__v8bf)_mm_avx512_undefined_si128(), (__mmask8)-1);
  return __R[0];
}
